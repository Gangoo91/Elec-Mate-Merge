...
export default function EnvironmentalSustainabilityModule3Section2() {
  useSEO({
    ...
    description:
      'Embodied and operational carbon, carbon reduction in design, low carbon materials, transport emissions, carbon offsetting, and measuring and reporting carbon — PAS 2080, SECR, science-based targets.',
  });
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-emerald-500/5 border-l-2 border-emerald-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>UK average:</strong> ~5.5 tonnes CO2e per person per year
              </li>
              <li>
                <strong>Embodied carbon:</strong> Locked in at construction &mdash; cannot be
                reduced later
              </li>
              <li>
                <strong>Hierarchy:</strong> Avoid &rarr; Reduce &rarr; Substitute &rarr; Offset
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-emerald-500/5 border-l-2 border-emerald-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Cement:</strong> ~8% of global CO2 emissions
              </li>
              <li>
                <strong>PAS 2080:</strong> UK standard for carbon management in construction
              </li>
              <li>
                <strong>SECR:</strong> Mandatory carbon reporting for qualifying UK companies
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                expresses the impact of all greenhouse gases &mdash; including methane (CH4),
                nitrous oxide (N2O), and fluorinated gases &mdash; as a single figure relative to
                the warming potential of carbon dioxide.
              </p>

              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-emerald-400">CO2 Equivalent (CO2e):</strong> Different
                  greenhouse gases have different <strong>global warming potentials (GWP)</strong>.
                  For example, methane is approximately 28 times more potent than CO2 over a
                  100-year period, while nitrous oxide is approximately 265 times more potent. CO2e
                  converts all GHG emissions into a single comparable unit by multiplying the mass
                  of each gas by its GWP factor.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Personal footprint:</strong> Covers an
                      individual&rsquo;s direct emissions (home energy, personal transport) and
                      indirect emissions (food, goods, services consumed). The UK average is
                      approximately{' '}
                      <strong className="text-white">5.5 tonnes CO2e per person per year</strong>{' '}
                      &mdash; above the global average of ~4.7 tonnes
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Organisational footprint:</strong> Covers all
                      emissions from a company&rsquo;s operations, categorised into Scope 1 (direct
                      emissions from owned sources), Scope 2 (indirect emissions from purchased
                      energy), and Scope 3 (all other indirect emissions in the value chain)
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      The UK has a legally binding target to reach{' '}
                      <strong className="text-white">net zero by 2050</strong> under the Climate
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      <strong className="text-white">
                        25% of the UK&rsquo;s total carbon emissions
                      </strong>
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      To meet Paris Agreement targets, individual footprints need to fall to
                      approximately <strong className="text-white">2.3 tonnes CO2e by 2030</strong>
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Construction and demolition generates approximately{' '}
                      <strong className="text-white">60% of all UK waste</strong> by weight
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-emerald-400">On Site:</strong> As an electrical
                  professional, your work directly affects a building&rsquo;s operational carbon
                  through the efficiency of lighting, heating controls, and building services
                  installations. Your material choices and waste management also affect embodied
                  carbon. Understanding your role in the carbon picture is the first step to
                  reducing it.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                <strong>Embodied carbon</strong> refers to the greenhouse gas emissions associated
                with the non-operational phases of a building&rsquo;s lifecycle &mdash; the
                extraction, manufacture, transport, construction, maintenance, replacement, and
                eventual demolition and disposal of all materials and components. Unlike operational
                carbon, embodied carbon is{' '}
                <strong>&ldquo;locked in&rdquo; at the point of construction</strong> and cannot be
                reduced afterwards.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">A1&ndash;A3 (Product stage):</strong> Raw
                      material extraction, transport to factory, manufacturing
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">A4&ndash;A5 (Construction process):</strong>{' '}
                      Transport to site, construction and installation
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">B1&ndash;B7 (Use stage):</strong> Maintenance,
                      repair, replacement, refurbishment, and operational energy/water
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">C1&ndash;C4 (End of life):</strong>{' '}
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Module D (Beyond system boundary):</strong>{' '}
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      50&ndash;70% of upfront embodied carbon &mdash; foundations, frame, floors,
                      walls
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Fa&ccedil;ade and envelope:</strong>{' '}
                      15&ndash;25% &mdash; cladding, glazing, roofing
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Building services (MEP):</strong> 10&ndash;20%
                      &mdash; heating, ventilation, electrical, plumbing
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Fit-out and finishes:</strong> 5&ndash;15%
                      &mdash; floor coverings, ceilings, partitions
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  <strong className="text-white">
                    {' '}
                    proportion of total lifecycle emissions from embodied carbon increases
                  </strong>
                  . For a modern, highly insulated building, embodied carbon can represent{' '}
                  <strong className="text-white">50&ndash;70% of whole life carbon</strong>
                  over a 60-year lifespan. This makes reducing embodied carbon an increasingly
                  urgent priority.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                <strong>Operational carbon</strong> refers to the greenhouse gas emissions produced
                by the energy consumed during a building&rsquo;s occupation and use. This includes
                energy for{' '}
                <strong>
                  heating, cooling, hot water, lighting, ventilation, and electrical equipment
                </strong>{' '}
                (plug loads). Reducing operational carbon has been the primary focus of UK building
                regulations for decades, and significant progress has been made through increasingly
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Part L1A/L2A:</strong> New dwellings and new
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Part L1B/L2B:</strong> Existing dwellings and
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">2021 uplift:</strong> Reduced CO2 emissions
                      from new homes by ~31% compared to the previous standard
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Future Homes Standard (expected 2025):</strong>{' '}
                      Will require 75&ndash;80% reduction compared to 2013 Part L
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Minimum Energy Efficiency Standards (MEES): rented properties must achieve at
                      least EPC E
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  a very significant extent by energy from renewable sources produced on-site or
                  nearby. The UK&rsquo;s approach to NZEB is delivered through Part L and the Future
                  Homes/Buildings Standards, which will effectively require all new buildings to be
                  NZEB from 2025 onwards.
                </p>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The design stage offers the greatest opportunity to reduce a building&rsquo;s whole
                life carbon. Decisions made during early design &mdash; structural system, material
                selection, building form, and orientation &mdash; have the{' '}
                <strong>
                  largest impact on embodied carbon and set the baseline for operational energy
                  performance
                </strong>{' '}
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Timber:</strong> Lowest embodied carbon of the
                      three main structural materials. Stores carbon absorbed during growth
                      (biogenic carbon sequestration). CLT and glulam enable timber to be used for
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Steel:</strong> Higher embodied carbon than
                      timber, but highly recyclable. Using recycled steel (electric arc furnace)
                      reduces embodied carbon by ~60% compared to virgin steel (blast furnace)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Concrete:</strong> Portland cement production
                      generates ~8% of global CO2 emissions. Embodied carbon can be significantly
                      reduced through cement replacement (GGBS, PFA) and mix optimisation
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Right-sizing:</strong> Designing structural
                      elements to the correct size rather than over-specifying. Studies suggest
                      30&ndash;50% of steel in buildings is unnecessary
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Efficient floor grids:</strong> Optimising
                      column spacing and floor spans to minimise material use
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Lean foundations:</strong> Ground investigation
                      to avoid over-engineering foundations
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Building orientation:</strong> Orienting the
                      main glazing south to maximise winter solar gain and reduce heating demand.
                      Minimising west-facing glazing to reduce summer overheating
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Thermal mass:</strong> Using dense materials
                      (concrete, masonry, earth) to absorb heat during the day and release it at
                      night, smoothing temperature fluctuations and reducing heating/cooling demand
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Natural ventilation:</strong> Designing for
                      cross-ventilation and stack effect to reduce or eliminate the need for
                      mechanical cooling
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Daylighting:</strong> Maximising natural
                      daylight penetration to reduce artificial lighting demand (and associated
                      electrical load)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Fabric first:</strong> Prioritising insulation,
                      air tightness, and thermal bridging reduction over mechanical systems
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Selecting lower-carbon alternatives to conventional construction materials is one of
                the most effective ways to reduce embodied carbon. The following materials represent
                some of the most impactful substitutions available to the UK construction industry.
              </p>
              ...
              <div className="space-y-3">
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-1">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Engineered wood product made from layers of timber boards glued at right
                        angles
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Carbon benefit:</strong> Stores biogenic
                        carbon (approximately 1 tonne CO2 per cubic metre of timber) and has low
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Can be used for walls, floors, and roofs in buildings up to 18 storeys (with
                    ...
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        Must be from{' '}
                        <strong className="text-white">sustainably managed forests</strong> (FSC or
                        PEFC certified) to ensure carbon benefits are genuine
                      </span>
                    </li>
                  </ul>
                </div>
                  ...
                  <ul className="text-sm text-white space-y-1">
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        ...
                        <strong className="text-white">electric arc furnace (EAF)</strong> from
                        recycled scrap
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Carbon benefit:</strong> ~60% lower embodied
                        carbon than virgin steel from a blast furnace
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Steel is infinitely recyclable without loss of quality &mdash; UK structural
                        steel sections contain ~95% recycled content
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Further reductions possible through reuse of structural steel sections from
                        demolition
                      </span>
                    </li>
                  </ul>
                  ...
                  <ul className="text-sm text-white space-y-1">
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        ...
                        By-product of steel manufacturing that can replace up to 70&ndash;80% of
                        Portland cement in concrete, reducing embodied carbon by 40&ndash;60%
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">PFA (Pulverised Fuel Ash / fly ash):</strong>{' '}
                        By-product of coal-fired power stations that can replace up to 30&ndash;40%
                        of cement. Supply declining as coal power stations close
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Both improve long-term durability and chemical resistance of the concrete
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-1">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Sheep&rsquo;s wool:</strong> Natural
                        insulation with good thermal and acoustic performance, moisture buffering,
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Hemp fibre and hempcrete:</strong> Rapidly
                        renewable crop that sequesters carbon during growth. Hempcrete (hemp mixed
                        with lime) provides insulation, thermal mass, and moisture management
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Wood fibre:</strong> Manufactured from
                        sustainably sourced timber offcuts. Good thermal performance and hygroscopic
                        buffering
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Recycled cellulose:</strong> Made from
                        recycled newspaper, blown into cavities. Very low embodied carbon
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-white">
                    ...
                    respond to their regional context. Specifying materials from within{' '}
                    <strong className="text-white">50&ndash;100 miles of the site</strong> is a
                    common target for reducing transport carbon in sustainable projects.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Transport and logistics contribute significantly to the carbon footprint of
                construction projects. Materials must be transported from quarries, factories, and
                distribution centres to site, while operatives commute daily.{' '}
                <strong>
                  Construction transport accounts for approximately 6&ndash;8% of all UK road
                  freight
                </strong>
                , making it a meaningful area for carbon reduction.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Consolidation centres:</strong> Multiple
                      suppliers deliver to a central hub near the site, and goods are consolidated
                      into full loads for delivery &mdash; reducing the number of vehicle movements
                      by up to 70%
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Just-in-time delivery:</strong> Scheduling
                      deliveries to arrive when needed, reducing double handling, storage
                      requirements, and the risk of damage and waste
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Return load utilisation:</strong> Using
                      vehicles returning from deliveries to collect waste or materials from other
                      suppliers, rather than running empty
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Optimised routing software to minimise distance travelled and avoid congestion
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Driver training in eco-driving techniques (smooth acceleration, maintaining
                      tyre pressures, reducing idling)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Telematics systems to monitor fuel consumption, idling time, and route
                      compliance
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Electric vans:</strong> Increasingly viable for
                      electricians and other trades &mdash; zero tailpipe emissions, lower running
                      costs, and sufficient range for most daily use patterns
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Hybrid and electric HGVs:</strong> Emerging
                      technology for heavier construction vehicles &mdash; battery electric,
                      hydrogen fuel cell, and biomethane options
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Electric plant:</strong> Battery-powered tools,
                      telehandlers, and excavators are now available, eliminating on-site diesel
                      emissions
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="flex items-start gap-2 mb-2">
                  ...
                  <p className="text-sm text-white">
                    ...
                    <strong className="text-white">
                      {' '}
                      75% fewer CO2 emissions per tonne-kilometre
                    </strong>{' '}
                    than road freight. For bulk materials such as aggregates, steel, and timber
                    travelling long distances, shifting from road to rail can deliver significant
                    carbon savings. The UK government&rsquo;s Transport Decarbonisation Plan
                ...
                <ul className="text-sm text-white space-y-1 ml-7">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Water transport (canals, coastal shipping) offers even lower emissions per
                      tonne-km for suitable routes
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Cargo bikes and electric last-mile delivery for smaller items in urban areas
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-emerald-400">Local Sourcing:</strong> One of the simplest
                  and most effective strategies is to source materials locally, reducing transport
                  distance. Every kilometre saved reduces carbon, cost, and the risk of damage in
                  transit. For aggregates, concrete, and brickwork, specifying products from local
                  quarries and factories (within 50&ndash;100 miles) can significantly reduce the A4
                  transport carbon of a project.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                <strong>Carbon offsetting</strong> involves compensating for greenhouse gas
                emissions by funding an equivalent reduction or removal of CO2 elsewhere. While
                offsetting has a role in achieving net zero, it is{' '}
                <strong>not a substitute for direct emissions reduction</strong>
                and should only be used for <strong>residual emissions</strong> that cannot be
                eliminated through other measures.
              </p>
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Not a substitute:</strong> Offsetting without
                      first reducing emissions is considered greenwashing
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Additionality risk:</strong> Some offset
                      projects would have happened regardless of funding
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Permanence risk:</strong> Nature-based offsets
                      (e.g., tree planting) can be reversed by fire, disease, or land use change
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Double counting:</strong> The same emissions
                      reduction claimed by both the offset project and the buyer
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Verified Carbon Standard (VCS):</strong> The
                      world&rsquo;s most widely used voluntary carbon offset standard
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Gold Standard:</strong> Established by WWF,
                      requires co-benefits for sustainable development
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Woodland Carbon Code:</strong> UK-specific
                      standard for woodland creation carbon projects, managed by Scottish Forestry
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Peatland Code:</strong> UK standard for
                      peatland restoration projects that reduce emissions from degraded peatlands
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-2">
                  Tree Planting vs Technology Solutions
                </p>
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    <div className="mt-0.5 w-8 h-8 rounded-lg bg-emerald-500/20 border border-emerald-500/30 flex items-center justify-center flex-shrink-0">
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-emerald-400">Best Practice:</strong> Follow the carbon
                  reduction hierarchy &mdash;{' '}
                  <strong>avoid, reduce, substitute, then offset</strong>. Only offset residual
                  emissions that remain after all feasible reduction measures have been implemented.
                  When offsetting, use verified credits from recognised standards, and prefer
                  projects with high additionality and permanence guarantees.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="max-w-lg mx-auto space-y-3">
              ...
              <div className="relative">
                <div className="bg-emerald-500/20 border border-emerald-500/40 rounded-lg p-4 text-center">
                  <div className="flex items-center justify-center gap-2 mb-1">
                    <span className="w-6 h-6 rounded-full bg-emerald-500/30 border border-emerald-400/50 flex items-center justify-center text-xs font-bold text-emerald-300">
                      1
                    </span>
                  ...
                  <p className="text-[10px] text-emerald-400/60 mt-1 font-semibold">
                    HIGHEST IMPACT
                  </p>
                </div>
              </div>
              ...
              <div className="relative">
                <div className="bg-blue-500/15 border border-blue-500/35 rounded-lg p-4 text-center">
                  <div className="flex items-center justify-center gap-2 mb-1">
                    <span className="w-6 h-6 rounded-full bg-blue-500/30 border border-blue-400/50 flex items-center justify-center text-xs font-bold text-blue-300">
                      2
                    </span>
              ...
              <div className="relative">
                <div className="bg-purple-500/15 border border-purple-500/35 rounded-lg p-4 text-center">
                  <div className="flex items-center justify-center gap-2 mb-1">
                    <span className="w-6 h-6 rounded-full bg-purple-500/30 border border-purple-400/50 flex items-center justify-center text-xs font-bold text-purple-300">
                      3
                    </span>
              ...
              <div className="relative">
                <div className="bg-amber-500/15 border border-amber-500/35 rounded-lg p-4 text-center">
                  <div className="flex items-center justify-center gap-2 mb-1">
                    <span className="w-6 h-6 rounded-full bg-amber-500/30 border border-amber-400/50 flex items-center justify-center text-xs font-bold text-amber-300">
                      4
                    </span>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Effective carbon management requires robust measurement and transparent reporting.
                The principle of &ldquo;what gets measured gets managed&rdquo; is central to driving
                carbon reduction in the construction industry. Several key frameworks, standards,
                and regulatory requirements govern how organisations measure and report their carbon
                emissions in the UK.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Published by BSI &mdash; provides a whole value chain approach to carbon
                      management
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Applies to asset owners/managers, designers, contractors, and product/material
                      suppliers
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Requires{' '}
                      <strong className="text-white">
                        carbon baselines, targets, reduction plans, and monitoring
                      </strong>
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Not legally mandatory but increasingly required by public sector clients
                      (Highways England, Network Rail, HS2)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      2023 revision expanded scope from infrastructure only to include buildings
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">One Click LCA:</strong> Industry-leading
                      lifecycle assessment software widely used by UK designers and contractors
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">RICS Building Carbon Calculator:</strong>{' '}
                      Spreadsheet-based tool aligned with the RICS Professional Statement
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">IStructE Carbon Calculator:</strong> Free tool
                      specifically for structural engineers to estimate embodied carbon
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      ...
                      Standardised documents (EN 15804) providing verified carbon data for specific
                      products
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      The Science Based Targets initiative provides a framework for companies to set
                      emissions reduction targets consistent with Paris Agreement goals
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Targets must cover{' '}
                      <strong className="text-white">
                        Scope 1, Scope 2, and (for most companies) Scope 3
                      </strong>{' '}
                      emissions
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Near-term targets (5&ndash;10 years) must align with{' '}
                      <strong className="text-white">1.5&deg;C warming pathway</strong>
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Major UK contractors (Balfour Beatty, Skanska, Kier, Morgan Sindall) have
                      committed to SBTi targets
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Global non-profit that runs a disclosure system for companies, cities, and
                      regions
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Companies are scored A to D (plus F for non-disclosure) on their climate,
                      water, and forest disclosure
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Increasingly used by investors, clients, and supply chains as a measure of
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Major construction clients (e.g., government bodies) may require supply chain
                      partners to disclose through CDP
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Legal requirement</strong> for qualifying UK
                      companies (quoted companies, large unquoted companies, large LLPs)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Must report:{' '}
                      <strong className="text-white">
                        UK energy use, associated GHG emissions (Scope 1 &amp; 2 minimum), and at
                        least one intensity ratio
                      </strong>
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      <strong className="text-white">annual directors&rsquo; report</strong>
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Qualifying thresholds: &ge;250 employees, or &ge;&pound;36m turnover and
                      &ge;&pound;18m balance sheet
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-emerald-400">Why It Matters:</strong> Even if your
                  employer is too small for mandatory SECR reporting, understanding carbon
                  measurement and reporting is increasingly important. Major clients and principal
                  contractors are pushing carbon reporting requirements down through their supply
                  chains. Being able to measure, report, and reduce your organisation&rsquo;s carbon
                  footprint will become a competitive advantage &mdash; and eventually a baseline
                  requirement &mdash; for construction businesses of all sizes.
                </p>
              </div>
            </div>
          </div>
