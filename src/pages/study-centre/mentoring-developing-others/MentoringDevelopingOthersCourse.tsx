...
export default function MentoringDevelopingOthersCourse() {
  useSEO({
    title: 'Mentoring & Developing Others | Personal Development',
    description:
      'Complete mentoring course covering adult learning theory, coaching models, apprentice support, assessment, and professional growth for UK construction and electrical workers.',
  });
          ...
          <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-rose-500/10 via-rose-400/5 to-transparent border border-rose-500/15 p-5 sm:p-8">
            ...
            <div className="relative z-10">
              ...
              <p className="text-sm sm:text-base lg:text-lg text-muted-foreground mt-1 max-w-2xl">
                How people learn, giving feedback, supporting apprentices &mdash; based on ILM
                coaching and JIB apprenticeship standards
              </p>
            </div>
          </div>
