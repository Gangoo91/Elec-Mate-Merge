...
const quickCheckQuestions = [
  ...
  },
  {
    id: 'harmful-phrases',
    question:
      "A colleague tells you they've been diagnosed with depression. Which of the following responses would be MOST harmful?",
    options: [
...
const quizQuestions = [
  ...
  },
  {
    id: 3,
    question:
      'What is the FIRST thing a GP is likely to do when someone presents with depression or anxiety symptoms?',
    options: [
...
const MentalHealthModule2Section4 = () => {
  useSEO({
    ...
    description:
      'Learn how to apply the ALGEE action plan, what to say and what not to say, how to encourage professional help, and understand talking therapies, medication, and self-help strategies.',
  });
          ...
          <div className="rounded-lg p-4 bg-purple-500/5 border-l-2 border-purple-500/50">
            ...
            <ul className="text-white text-base space-y-1.5">
              <li className="flex items-start gap-2">
                ...
                <span>
                  <strong className="text-white">Approach:</strong> choose a private moment, ask
                  open questions, listen without judgement
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Language matters:</strong> supportive phrases build
                  trust; dismissive ones cause harm
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Professional help:</strong> GP assessment, NHS
                  Talking Therapies (self-referral available), medication
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Your role:</strong> listen, support, signpost
                  &mdash; do NOT diagnose or advise on medication
                </span>
              </li>
            </ul>
          </div>
          <div className="rounded-lg p-4 bg-purple-500/5 border-l-2 border-purple-500/50">
            ...
            <ul className="text-white text-base space-y-1.5">
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-purple-300">A</strong> &mdash; Approach, assess and assist
                  with any crisis
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-purple-300">L</strong> &mdash; Listen non-judgementally
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-purple-300">G</strong> &mdash; Give reassurance and
                  information
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-purple-300">E</strong> &mdash; Encourage appropriate
                  professional help
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-purple-300">E</strong> &mdash; Encourage other supports
                </span>
              </li>
            </ul>
          </div>
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                ...
                <strong className="text-white">specifically for depression and anxiety</strong> in a
                workplace context. Knowing the letters is not enough &mdash; what matters is how you
                put them into practice when a colleague is struggling.
              </p>
              ...
              <div className="bg-white/5 border border-purple-500/30 p-4 rounded-lg">
                ...
                <p className="text-white text-sm">
                  ...
                  their explicit permission. If you believe someone is at risk of harming themselves
                  or others, you may need to break confidentiality — but you should tell the person
                  what you are doing and why. On construction sites, privacy can be difficult to
                  find. Consider using a parked van, a quiet corner away from the main works, or
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                ...
                anxiety because they fear being judged, dismissed, or misunderstood. Your language
                can make the difference between someone seeking help and someone suffering in
                silence.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 sm:p-6 rounded-lg">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                      ...
                      {[
                        {
                          ...
                          why: 'Simple, powerful, shows presence without pressure',
                        },
                        {
                          phrase: '"That sounds really difficult."',
                          why: 'Validates their experience without trying to fix it',
                        },
                        {
                          phrase: '"It\'s OK to not be OK."',
                          why: 'Normalises struggle, reduces shame',
                        },
                        {
                          phrase: '"You don\'t have to go through this alone."',
                          why: 'Offers connection and support',
                        },
                        {
                          phrase: '"Thank you for telling me."',
                          why: 'Acknowledges their courage in opening up',
                        },
                        {
                          phrase: '"How can I best support you?"',
                          why: 'Empowers them to say what they need',
                        },
                        {
                          phrase: '"There\'s no rush — take your time."',
                          why: 'Removes pressure, gives space',
                        },
                      ].map(({ phrase, why }, idx) => (
                  ...
                  <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                    ...
                    <div className="space-y-3 text-sm">
                      {[
                        {
                          phrase: '"Just cheer up."',
                          why: 'Implies depression is a choice — it is not',
                        },
                        {
                          phrase: '"Everyone feels like that sometimes."',
                          why: 'Minimises a clinical condition to a normal emotion',
                        },
                        {
                          phrase: '"You don\'t look depressed."',
                          why: 'Invalidates their experience; many mask symptoms',
                        },
                        {
                          phrase: '"There are people worse off than you."',
                          why: 'Guilt-trips them; pain is not a competition',
                        },
                        {
                          phrase: '"Have you tried just not worrying about it?"',
                          why: 'Reduces anxiety disorder to a simple habit',
                        },
                        {
                          phrase: '"You just need to think positive."',
                          why: "Implies they're choosing to be ill",
                        },
                        {
                          phrase: '"Man up" / "Pull yourself together."',
                          why: 'Reinforces toxic stigma; extremely damaging',
                        },
                      ].map(({ phrase, why }, idx) => (
                        <div key={idx} className="flex items-start gap-2">
                ...
                <div className="mt-4 bg-purple-500/10 border border-purple-500/30 p-3 rounded-lg">
                  <p className="text-white text-sm text-center">
                    ...
                    prevents people from seeking help. Choosing your words carefully can literally
                    save lives.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-purple-500/30 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <strong className="text-white">Giving full attention</strong> — put your phone
                      away, face them, make appropriate eye contact
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-4 w-4 text-purple-400 mt-1 flex-shrink-0" />
                    <div>
                      <strong className="text-white">Reflecting back</strong> — &ldquo;It sounds
                      like you&rsquo;ve been feeling overwhelmed&rdquo;
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-4 w-4 text-purple-400 mt-1 flex-shrink-0" />
                    <div>
                      <strong className="text-white">Tolerating silence</strong> — do not rush to
                      fill gaps; silence gives space to process
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-4 w-4 text-purple-400 mt-1 flex-shrink-0" />
                    <div>
                      <strong className="text-white">Asking open questions</strong> — &ldquo;How
                      have you been feeling?&rdquo; not &ldquo;Are you OK?&rdquo;
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-4 w-4 text-purple-400 mt-1 flex-shrink-0" />
                    <div>
                      <strong className="text-white">Avoiding the &lsquo;fix-it&rsquo; urge</strong>{' '}
                      — your job is to listen, not to solve their problem
                    </div>
                  </li>
                </ul>
              </div>
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                ...
                the construction industry &mdash; the idea of speaking to a doctor about their
                mental health feels daunting, embarrassing, or unnecessary. Understanding the
                process and being able to explain it can help reduce fear.
              </p>
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white">
                  ...
                  <div className="flex items-start gap-3 mt-3">
                    ...
                    <div>
                      <strong className="text-white">
                        &ldquo;Have you thought about speaking to your GP?&rdquo;
                      </strong>{' '}
                      — a gentle, open question that plants the seed without pressure
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <strong className="text-white">
                        &ldquo;Your GP can help with exactly this kind of thing.&rdquo;
                      </strong>{' '}
                      — normalises seeking help for mental health as you would for a physical injury
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">
                        &ldquo;Would it help if I went with you, or sat with you while you
                        rang?&rdquo;
                      </strong>{' '}
                      — offers practical support that removes barriers
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">
                        &ldquo;You can also self-refer to talking therapy without needing to see a
                        GP.&rdquo;
                      </strong>{' '}
                      — gives an alternative route for those who resist seeing a doctor
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  {[
                    {
                      ...
                      detail:
                        "Request a standard or double appointment. Many surgeries allow you to specify 'mental health' when booking so the GP can prepare. Telephone and video consultations are also available.",
                    },
                    {
                      step: 2,
                      title: 'Describe your symptoms',
                      detail:
                        "The GP will ask about symptoms, how long they've lasted, and how they affect daily life. It can help to write symptoms down beforehand. Be as honest as possible — GPs are bound by strict confidentiality.",
                    },
                    {
                      step: 3,
                      title: 'Assessment',
                      detail:
                        'The GP may use validated screening tools: the PHQ-9 for depression (a 9-question scoring system) and the GAD-7 for anxiety (a 7-question scoring system). These help determine severity — mild, moderate, or severe.',
                    },
                    {
                      step: 4,
                      title: 'Treatment plan',
                      detail:
                        'Based on severity, the GP may recommend: guided self-help and lifestyle changes (mild), talking therapy such as CBT (mild–moderate), medication such as SSRIs (moderate–severe), or a combination. They may also refer to a Community Mental Health Team for severe cases.',
                    },
                    {
                      step: 5,
                      title: 'Follow-up',
                      detail:
                        'The GP will typically arrange a follow-up appointment in 2–4 weeks to review progress. If medication is prescribed, follow-up is essential as SSRIs take 2–4 weeks to take effect and side effects may need monitoring.',
                    },
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-2 text-sm">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Search &ldquo;NHS Talking Therapies&rdquo; online and find your local service
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-violet-400 flex-shrink-0" />
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                ...
                talking. Several different types of talking therapy are available on the NHS, each
                with a different approach. Understanding the basics of each can help you explain
                options to someone who is unsure about seeking help.
              </p>
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                ...
                <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                  ...
                  <p className="text-white text-sm mb-2">
                    ...
                    CBT is based on the idea that thoughts, feelings, and behaviours are
                  ...
                  <ul className="text-white space-y-1 text-sm">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Format:</strong> structured, goal-oriented,
                        includes &ldquo;homework&rdquo;
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                ...
                <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                  ...
                  <ul className="text-white space-y-1 text-sm">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Access:</strong> NHS, GP referral, charities,
                        or private
                      </span>
                    </li>
                  </ul>
                ...
                <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                  ...
                  <p className="text-white text-sm mb-2">
                    ...
                    IPT is based on the idea that mental health problems are closely linked to our
                  ...
                  <ul className="text-white space-y-1 text-sm">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Format:</strong> structured, focuses on 4 key
                        areas (grief, disputes, role transitions, isolation)
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                ...
                <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                  ...
                  <ul className="text-white space-y-1 text-sm">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Format:</strong> structured 8-phase protocol
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Access:</strong> NHS (for PTSD), GP referral,
                        or private
                      </span>
                    </li>
                  </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <h3 className="text-purple-400 font-medium mb-2">
                  Accessing Therapy: NHS vs Private
                </h3>
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                ...
                exclusively the role of doctors and pharmacists. However, understanding the basics
                of how antidepressants work helps you support someone who may be taking them,
                experiencing side effects, or anxious about starting medication.
              </p>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-white text-sm">
                  ...
                  Never recommend starting, stopping, increasing, decreasing, or changing
                  medication. Never suggest alternatives to prescribed medication. If someone
                  reports concerning side effects, encourage them to speak to their GP or pharmacist
                  — do not tell them to stop taking their medication.
                </p>
              </div>
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white">
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">How they work:</strong> SSRIs block the
                      reuptake (reabsorption) of serotonin by nerve cells in the brain. This means
                      more serotonin is available in the gap between nerve cells, which can improve
                      mood, sleep, and emotional regulation.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Onset:</strong> SSRIs typically take 2&ndash;4
                      weeks to start working. This is a difficult period for patients and is
                      important for a MHFA to understand — the person may feel no better (or even
                      slightly worse) initially.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Common side effects:</strong> nausea,
                      headaches, dizziness, drowsiness or insomnia, reduced appetite, increased
                      anxiety initially, sexual dysfunction. Most side effects reduce after
                      1&ndash;2 weeks.
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white">
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">How they work:</strong> block the reuptake of
                      both serotonin AND noradrenaline, increasing the availability of both
                      neurotransmitters in the brain. Noradrenaline affects alertness, energy, and
                      attention.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Side effects:</strong> similar to SSRIs, plus
                      potential for increased blood pressure and sweating. Regular monitoring by the
                      GP is important.
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-white/5 border border-purple-500/30 p-4 rounded-lg">
                ...
                <p className="text-white text-sm mb-3">
                  ...
                  after long-term use &mdash; can cause
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                ...
                Health First Aider, being able to signpost someone to evidence-based self-help
                options empowers them to take active steps towards improving their wellbeing.
              </p>
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white">
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">NHS recommendation:</strong> 150 minutes per
                      week of moderate-intensity exercise (brisk walking, cycling, swimming)
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">How it helps:</strong> increases endorphins,
                      serotonin, and noradrenaline &mdash; the same neurotransmitters targeted by
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Quick wins:</strong> even a 10-minute brisk
                      walk has measurable mood-boosting effects. Exercising outdoors (&ldquo;green
                      exercise&rdquo;) provides additional benefits
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">For construction workers:</strong> the physical
                      demands of the job help, but dedicated exercise outside of work &mdash;
                      particularly enjoyable, social activities &mdash; provides additional mental
                      health benefits
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-white/5 border border-purple-500/30 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-4 w-4 text-purple-400 mt-1 flex-shrink-0" />
                    <div>
                      <strong className="text-white">Consistent schedule:</strong> go to bed and
                  ...
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-4 w-4 text-purple-400 mt-1 flex-shrink-0" />
                    <div>
                      <strong className="text-white">Screen-free wind-down:</strong> avoid phones,
                      tablets, and laptops for at least 30 minutes before bed
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-4 w-4 text-purple-400 mt-1 flex-shrink-0" />
                    <div>
                      <strong className="text-white">Limit caffeine:</strong> avoid caffeine after
                      2pm (including tea and energy drinks common on site)
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-4 w-4 text-purple-400 mt-1 flex-shrink-0" />
                    <div>
                      <strong className="text-white">Cool, dark room:</strong> ideal sleeping
                      temperature is 16&ndash;18&deg;C with blackout curtains or an eye mask
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-4 w-4 text-purple-400 mt-1 flex-shrink-0" />
                    <div>
                      <strong className="text-white">Limit alcohol:</strong> alcohol disrupts sleep
                      quality even when it helps you fall asleep initially
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-purple-500/30 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white">
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">What it involves:</strong> paying deliberate,
                      non-judgemental attention to the present moment &mdash; noticing thoughts,
                      feelings, and physical sensations without trying to change them
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Getting started:</strong> guided meditation
                      apps (Calm, Headspace) offer 5&ndash;10 minute beginner sessions that can be
                      done anywhere, including on a break
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Evidence:</strong> reduces rumination
                      (repetitive negative thinking), lowers cortisol (stress hormone), and improves
                      sleep quality
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-white/5 border border-purple-500/30 p-4 rounded-lg">
                ...
                <p className="text-white text-sm mb-3">
                  ...
                  Lighthouse Construction Industry Charity and Mates in Mind.
                </p>
                <div className="grid sm:grid-cols-2 gap-3 text-sm">
                  <div className="bg-purple-500/10 border border-purple-500/20 p-3 rounded">
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                ...
                <p className="text-white text-sm">
                  ...
                  when they feel like withdrawing. This could be as simple as having lunch with a
                  colleague rather than eating alone, sending a text to a friend, attending a sports
                  club, or volunteering. On construction sites, small gestures matter enormously
                  &mdash; checking in on someone during a tea break, including them in conversation,
                  or simply asking &ldquo;How are you doing — really?&rdquo; can make a significant
                  difference.
                </p>
              </div>
            </div>
