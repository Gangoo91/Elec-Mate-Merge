              ...
              <div className="bg-white/5 border border-purple-500/30 p-4 rounded-lg">
                ...
                <div className="space-y-3 text-sm">
                  <div className="bg-white/5 p-3 rounded">
                    ...
                    <p className="text-white">&rarr; &ldquo;Seeing a GP about your mental health is exactly like seeing them about a bad back. It&rsquo;s just your brain that needs some support, not your spine.&rdquo;</p>
                  </div>
                  <div className="bg-white/5 p-3 rounded">
                    <p className="text-red-300 font-medium mb-1">&ldquo;I don&rsquo;t want to be put on medication.&rdquo;</p>
                    <p className="text-white">&rarr; &ldquo;The GP won&rsquo;t force medication on you. They&rsquo;ll talk through your options — therapy is often the first recommendation. You&rsquo;re always in control of your treatment.&rdquo;</p>
                  </div>
                  <div className="bg-white/5 p-3 rounded">
                    <p className="text-red-300 font-medium mb-1">&ldquo;I can&rsquo;t take time off work for appointments.&rdquo;</p>
                    <p className="text-white">&rarr; &ldquo;Many GP surgeries offer early morning, evening, or telephone appointments. NHS Talking Therapies also offer evening and weekend sessions. It&rsquo;s worth asking about flexible options.&rdquo;</p>
                  </div>
                </div>
              </div>
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                ...
                <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                  ...
                  <ul className="text-white space-y-1 text-sm">
                    <li className="flex items-start gap-2">
                      ...
                      <span><strong className="text-white">Duration:</strong> typically 6&ndash;20 sessions</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                      <span><strong className="text-white">Format:</strong> structured, goal-oriented, includes &ldquo;homework&rdquo;</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                      <span><strong className="text-white">Access:</strong> NHS Talking Therapies, GP referral, or private</span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                  ...
                  <ul className="text-white space-y-1 text-sm">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                      <span><strong className="text-white">Duration:</strong> typically 6&ndash;12 sessions</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                      <span><strong className="text-white">Format:</strong> person-centred, non-directive</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                      <span><strong className="text-white">Access:</strong> NHS, GP referral, charities, or private</span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                  ...
                  <ul className="text-white space-y-1 text-sm">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                      <span><strong className="text-white">Duration:</strong> typically 12&ndash;16 sessions</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                      <span><strong className="text-white">Format:</strong> structured, focuses on 4 key areas (grief, disputes, role transitions, isolation)</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                      <span><strong className="text-white">Access:</strong> NHS Talking Therapies or private</span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                  ...
                  <ul className="text-white space-y-1 text-sm">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                      <span><strong className="text-white">Duration:</strong> typically 8&ndash;12 sessions</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                      <span><strong className="text-white">Format:</strong> structured 8-phase protocol</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                      <span><strong className="text-white">Access:</strong> NHS (for PTSD), GP referral, or private</span>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-purple-500/30 p-4 rounded-lg">
                ...
                <div className="grid sm:grid-cols-3 gap-3 text-sm">
                  <div className="bg-purple-500/10 border border-purple-500/20 p-3 rounded">
                    ...
                    <p className="text-white">8&ndash;12 weekly sessions, typically 90 minutes each</p>
                  </div>
                  <div className="bg-purple-500/10 border border-purple-500/20 p-3 rounded">
                    <p className="text-purple-300 font-medium text-xs mb-1">Best for</p>
                    <p className="text-white">Social anxiety, depression, bereavement, anger management</p>
                  </div>
                  <div className="bg-purple-500/10 border border-purple-500/20 p-3 rounded">
                    <p className="text-purple-300 font-medium text-xs mb-1">Access</p>
                    <p className="text-white">NHS Talking Therapies, charities (Mind, SANE), or private</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-purple-500/30 p-4 rounded-lg">
                ...
                <div className="grid sm:grid-cols-2 gap-3 text-sm">
                  <div className="bg-purple-500/10 border border-purple-500/20 p-3 rounded">
                    ...
                    <p className="text-white">Mind local groups, Andy&rsquo;s Man Club (free, men-only), local IAPT groups</p>
                  </div>
                  <div className="bg-purple-500/10 border border-purple-500/20 p-3 rounded">
                    <p className="text-purple-300 font-medium text-xs mb-1">Online communities</p>
                    <p className="text-white">Mind Side by Side, Anxiety UK forums, Big White Wall (now Togetherall)</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-purple-500/30 p-4 rounded-lg">
                ...
                <div className="grid sm:grid-cols-2 gap-3 text-sm">
                  <div className="bg-purple-500/10 border border-purple-500/20 p-3 rounded">
                    ...
                    <p className="text-white">Guided meditation, sleep stories, breathing exercises. Free tier available.</p>
                  </div>
                  <div className="bg-purple-500/10 border border-purple-500/20 p-3 rounded">
                    <p className="text-purple-300 font-medium mb-1">Headspace</p>
                    <p className="text-white">Structured mindfulness courses, animations explaining mental health. Free basics.</p>
                  </div>
                  <div className="bg-purple-500/10 border border-purple-500/20 p-3 rounded">
                    <p className="text-purple-300 font-medium mb-1">NHS Every Mind Matters</p>
                    <p className="text-white">Free personalised action plan. Completely free, evidence-based, NHS-developed.</p>
                  </div>
                  <div className="bg-purple-500/10 border border-purple-500/20 p-3 rounded">
                    <p className="text-purple-300 font-medium mb-1">Togetherall</p>
                    <p className="text-white">Monitored peer support community with self-help courses. Free via many NHS trusts.</p>
                  </div>
                </div>
              </div>
