    ...
    <div className="overflow-x-hidden bg-[#1a1a1a]">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                ...
                <div className="grid sm:grid-cols-2 gap-3 mt-3">
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    ...
                    <p className="text-white text-xs">The way a person perceives and interprets themselves, other people, and events around them</p>
                  </div>
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    <p className="text-purple-300 font-medium text-sm mb-1">Emotional Responses</p>
                    <p className="text-white text-xs">The range, intensity, instability, and appropriateness of emotional reactions</p>
                  </div>
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    <p className="text-purple-300 font-medium text-sm mb-1">Interpersonal Functioning</p>
                    <p className="text-white text-xs">The ability to form and maintain relationships with other people</p>
                  </div>
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    <p className="text-purple-300 font-medium text-sm mb-1">Impulse Control</p>
                    <p className="text-white text-xs">The ability to manage urges, reactions, and behaviours in the moment</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-3">
                  <div className="bg-white/5 border border-purple-400/20 p-3 rounded-lg">
                    ...
                    <p className="text-white text-xs">Paranoid, schizoid, schizotypal personality disorders. Patterns of odd or eccentric thinking and behaviour.</p>
                  </div>
                  <div className="bg-white/5 border border-purple-400/20 p-3 rounded-lg">
                    <h4 className="text-purple-300 font-medium mb-1 text-sm">Cluster B &mdash; &lsquo;Emotional and Impulsive&rsquo;</h4>
                    <p className="text-white text-xs">Borderline (BPD/EUPD), antisocial, histrionic, narcissistic personality disorders. Patterns of dramatic, erratic behaviour and difficulty regulating emotions. BPD/EUPD is the most commonly encountered.</p>
                  </div>
                  <div className="bg-white/5 border border-purple-400/20 p-3 rounded-lg">
                    <h4 className="text-purple-300 font-medium mb-1 text-sm">Cluster C &mdash; &lsquo;Anxious&rsquo;</h4>
                    <p className="text-white text-xs">Avoidant, dependent, obsessive-compulsive personality disorders. Patterns of anxious, fearful thinking and behaviour.</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                ...
                <div className="grid sm:grid-cols-2 gap-4 mt-3">
                  <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg text-center">
                    ...
                    <p className="text-white text-lg font-bold">&ldquo;What&rsquo;s wrong with you?&rdquo;</p>
                    <p className="text-white text-xs mt-2">Blames the individual, focuses on deficit, implies the person is flawed</p>
                  </div>
                  <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg text-center">
                    ...
                    <p className="text-white text-lg font-bold">&ldquo;What happened to you?&rdquo;</p>
                    <p className="text-white text-xs mt-2">Seeks to understand experiences, recognises survival responses, focuses on compassion</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-purple-400/30 p-4 sm:p-6 rounded-lg">
                ...
                <div className="flex flex-col items-center">
                  <div className="bg-purple-500/20 border-2 border-purple-400/60 rounded-lg px-6 py-3 text-center mb-3 w-full max-w-md">
                    ...
                    <p className="text-white text-xs mt-1">Events occurring during childhood (ages 0&ndash;17)</p>
                  </div>
                  ...
                  <div className="bg-white/5 border border-purple-400/20 rounded-lg p-3 w-full max-w-lg text-center mb-3">
                    ...
                    <div className="flex flex-wrap justify-center gap-2">
                      <span className="bg-purple-500/20 border border-purple-400/30 rounded-full px-2.5 py-1 text-white text-[10px] sm:text-xs">Difficulty regulating emotions</span>
                      <span className="bg-purple-500/20 border border-purple-400/30 rounded-full px-2.5 py-1 text-white text-[10px] sm:text-xs">Insecure attachment</span>
                      <span className="bg-purple-500/20 border border-purple-400/30 rounded-full px-2.5 py-1 text-white text-[10px] sm:text-xs">Hypervigilance</span>
                      <span className="bg-purple-500/20 border border-purple-400/30 rounded-full px-2.5 py-1 text-white text-[10px] sm:text-xs">Low self-worth</span>
                      <span className="bg-purple-500/20 border border-purple-400/30 rounded-full px-2.5 py-1 text-white text-[10px] sm:text-xs">Difficulty trusting others</span>
                    </div>
                  </div>
            ...
            <div className="space-y-4 text-white">
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                ...
                <div className="grid sm:grid-cols-3 gap-3">
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg text-center">
                    ...
                    <p className="text-white text-xs">Emotions are felt at a much higher level than most people experience. Where someone might feel mildly annoyed, a person with dysregulation feels furious.</p>
                  </div>
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg text-center">
                    <p className="text-purple-300 font-bold text-2xl mb-1">Duration</p>
                    <p className="text-white text-xs">Emotional reactions last much longer. Recovery from an emotional event that might take minutes for most people can take hours or even days.</p>
                  </div>
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg text-center">
                    <p className="text-purple-300 font-bold text-2xl mb-1">Sensitivity</p>
                    <p className="text-white text-xs">Emotional reactions are triggered more easily. Events that others might not notice at all can trigger an intense emotional response.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="flex flex-wrap gap-2 mt-2">
                  <span className="bg-purple-500/20 border border-purple-400/30 rounded-full px-3 py-1.5 text-white text-xs">Perceived rejection</span>
                  <span className="bg-purple-500/20 border border-purple-400/30 rounded-full px-3 py-1.5 text-white text-xs">Feeling ignored</span>
                  <span className="bg-purple-500/20 border border-purple-400/30 rounded-full px-3 py-1.5 text-white text-xs">Change in plans</span>
                  <span className="bg-purple-500/20 border border-purple-400/30 rounded-full px-3 py-1.5 text-white text-xs">Criticism</span>
                  <span className="bg-purple-500/20 border border-purple-400/30 rounded-full px-3 py-1.5 text-white text-xs">Conflict</span>
                  <span className="bg-purple-500/20 border border-purple-400/30 rounded-full px-3 py-1.5 text-white text-xs">Being left out</span>
                  <span className="bg-purple-500/20 border border-purple-400/30 rounded-full px-3 py-1.5 text-white text-xs">Uncertainty</span>
                  <span className="bg-purple-500/20 border border-purple-400/30 rounded-full px-3 py-1.5 text-white text-xs">Feeling misunderstood</span>
                  <span className="bg-purple-500/20 border border-purple-400/30 rounded-full px-3 py-1.5 text-white text-xs">Reminders of past trauma</span>
                </div>
              </div>
        ...
        <nav className="flex flex-col-reverse sm:flex-row sm:justify-between gap-3 pt-8 border-t border-white/10">
          <Button variant="ghost" size="lg" className="w-full sm:w-auto min-h-[44px] text-white hover:text-white hover:bg-white/5 touch-manipulation active:scale-[0.98]" asChild>
            <Link to="../mental-health-module-4">
              <ArrowLeft className="w-4 h-4 mr-2" />
              Back to Module 4
            </Link>
