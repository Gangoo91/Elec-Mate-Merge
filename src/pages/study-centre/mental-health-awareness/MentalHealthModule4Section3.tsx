...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    question:
      'When supporting someone with BPD/EUPD who is in emotional distress, what is the SINGLE most important skill you can use?',
    options: [
...
const quizQuestions = [
  ...
  },
  {
    id: 2,
    question:
      'Which of the following is NOT a key feature of Borderline Personality Disorder / Emotionally Unstable Personality Disorder?',
    options: [
  ...
  },
  {
    id: 8,
    question:
      'A colleague with BPD/EUPD becomes very distressed when a team member leaves for a new job. What is the most likely underlying fear driving this reaction?',
    options: [
...
export default function MentalHealthModule4Section3() {
  useSEO({
    ...
    description:
      'Learn about personality disorders, BPD/EUPD, trauma-informed understanding, emotional dysregulation, validation skills, and avoiding stigma in mental health first aid.',
  });
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
            ...
            <div className="rounded-lg p-3 sm:p-4 bg-purple-500/10 border-l-2 border-l-purple-500/50 border border-purple-500/30">
              ...
              <ul className="text-base text-white space-y-1.5">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong>Personality disorders</strong> are deeply ingrained patterns of
                    behaviour &mdash; NOT a character flaw or a choice.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>BPD/EUPD</strong> is the most commonly encountered personality disorder,
                    affecting 1&ndash;2% of the population.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Trauma-informed care</strong> asks &ldquo;what happened to you?&rdquo;
                    rather than &ldquo;what&rsquo;s wrong with you?&rdquo;
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Validation</strong> is the single most important skill when supporting
                ...
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Recovery is possible:</strong> with the right support, people can and do
            ...
            <div className="rounded-lg p-3 sm:p-4 bg-purple-500/10 border-l-2 border-l-purple-500/50 border border-purple-500/30">
              ...
              <ul className="text-base text-white space-y-1.5">
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Consistency and reliability</strong> are essential &mdash; be someone
                    the person can depend on.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Clear boundaries</strong> protect both you and the person you are
                    supporting.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Don&rsquo;t take behaviours personally</strong> &mdash; they are often
                    driven by fear, not malice.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Use person-first language:</strong> &ldquo;person with BPD&rdquo; not
                    &ldquo;borderline&rdquo;.
                  </span>
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          ...
          <ul className="space-y-3 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                Define personality disorders and explain why they are not a character flaw
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-purple-400 mt-0.5 flex-shrink-0" />
            ...
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-purple-400 mt-0.5 flex-shrink-0" />
              <span>
                Explain the link between adverse childhood experiences (ACEs) and personality
                disorders
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-purple-400 mt-0.5 flex-shrink-0" />
              <span>
                Describe what emotional dysregulation means and why standard advice to &ldquo;calm
                down&rdquo; is ineffective
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-purple-400 mt-0.5 flex-shrink-0" />
            ...
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-purple-400 mt-0.5 flex-shrink-0" />
              <span>
                Apply person-first language and challenge stigma around personality disorders
              </span>
            </li>
          </ul>
        </section>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                A personality disorder is a mental health condition characterised by{' '}
                <strong>deeply ingrained patterns of behaviour</strong> that deviate markedly from
                cultural expectations and are pervasive across a broad range of personal and social
                situations. These patterns are inflexible, long-standing, and lead to significant
              ...
              <p>
                Personality disorders typically emerge during{' '}
                <strong>adolescence or early adulthood</strong>, the developmental period when
                personality consolidates and patterns of relating to the world become established.
                Whilst the roots often lie in childhood experiences, the recognisable patterns
                usually become apparent during the teenage years and early twenties.
              </p>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-white text-sm">
                  ...
                  . It is a recognised mental health condition. The behaviours associated with
                  personality disorders are often survival responses that developed in the context
                  of early adversity. The person is not &ldquo;being difficult&rdquo; &mdash; they
                  are experiencing genuine psychological distress. Understanding this distinction is
                  fundamental to providing effective, compassionate support.
                </p>
              </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                BPD/EUPD is the <strong>most commonly encountered personality disorder</strong> and
                the one you are most likely to come across in a mental health first aid context. It
                affects approximately <strong>1&ndash;2% of the population</strong> &mdash; roughly
                1 in 50 to 1 in 100 people. It is heavily stigmatised, even within mental health
                services, making it essential that mental health first aiders understand the
                condition and challenge misinformation.
              </p>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-white text-sm">
                          ...
                          sometimes called &ldquo;splitting&rdquo; &mdash; reflects the
                          person&rsquo;s intense emotional responses, not a deliberate manipulation.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-white text-sm">
                          ...
                          emotional response is intense and genuine.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-white text-sm">
                          ...
                          emotions are{' '}
                          <strong className="text-white">genuinely felt at full intensity</strong>.
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                ...
                <p className="text-white text-sm">
                  ...
                  <strong className="text-white">
                    {' '}
                    even within mental health services themselves
                  </strong>
                  . People with BPD/EUPD report being treated as &ldquo;attention-seeking&rdquo;,
                  being refused treatment, being labelled as &ldquo;manipulative&rdquo;, and being
                  told that their condition is &ldquo;untreatable&rdquo;. None of this is
                  acceptable. As a mental health first aider, you can challenge this stigma by
                  treating every person with compassion, dignity, and respect &mdash; regardless of
                  their diagnosis.
                </p>
              </div>
            </div>
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                ...
                <strong>
                  strong link between adverse childhood experiences (ACEs) and personality disorders
                </strong>
                . Many people who develop personality disorders have histories of childhood trauma,
                including physical abuse, emotional abuse, sexual abuse, neglect, domestic violence
                in the household, parental substance misuse, and parental mental illness.
                Understanding this link is essential for providing compassionate, effective support.
              </p>
              ...
              <p>
                A trauma-informed approach recognises that many behaviours associated with
                personality disorders are
                <strong> survival responses</strong> developed in the context of adversity. A child
                who grows up in an environment that is unpredictable, unsafe, or lacking in
                emotional attunement learns to adapt. Those adaptations &mdash; hypervigilance,
                emotional reactivity, difficulty trusting others, fear of abandonment &mdash; were
                once necessary for survival. In adulthood, these same adaptations cause distress and
                difficulty, but they were originally protective.
              </p>
                ...
                <div className="flex flex-col items-center">
                  ...
                  <div className="flex flex-col items-center mb-3">
                    ...
                    <div className="bg-purple-500/20 border border-purple-400/40 rounded-full px-4 py-1.5">
                      <p className="text-purple-300 text-[10px] sm:text-xs font-semibold text-center">
                        DISRUPTS HEALTHY DEVELOPMENT
                      </p>
                    </div>
                    <div className="h-5 w-0.5 bg-purple-400/40" />
                  </div>
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 w-full max-w-lg">
                    <div className="bg-purple-500/10 border border-purple-500/20 rounded-lg p-2 text-center">
                      <p className="text-purple-300 font-medium text-[10px] sm:text-xs">
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white text-sm space-y-2">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <strong className="text-white">It avoids retraumatisation.</strong> Without a
                      trauma-informed approach, well-meaning interventions can inadvertently mirror
                      the original trauma &mdash; for example, feeling powerless, being judged, or
                      being abandoned.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">It builds trust.</strong> People who have
                      experienced trauma often have profound difficulty trusting others. A
                      trauma-informed approach prioritises safety, consistency, and transparency.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">
                        It shifts blame away from the individual.
                      </strong>{' '}
                      Instead of asking &ldquo;why can&rsquo;t they just behave normally?&rdquo;, a
                      trauma-informed approach understands that their behaviour makes sense in the
                  ...
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">It promotes recovery.</strong> When people feel
                      understood rather than judged, they are more likely to engage with support and
                      make progress.
                    </div>
                  </li>
                </ul>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                Emotional dysregulation is the{' '}
                <strong>difficulty managing emotional responses</strong>. For people with
                personality disorders, particularly BPD/EUPD, emotions are experienced at a much
                higher intensity, for a longer duration, and with a slower return to baseline than
                for most people. This is not a choice or a lack of effort &mdash; it is a
                fundamental difference in how the emotional system functions.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-white text-sm mb-3">
                  ...
                  are{' '}
                  <strong className="text-white">
                    all standing, all shouting at once, and grabbing the steering wheel
                  </strong>
                  . The emotions are louder, more insistent, more overwhelming, and much harder to
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <ul className="text-white text-sm space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">It invalidates their experience.</strong> It
                      implies their reaction is wrong, excessive, or unreasonable.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">They already want to calm down.</strong> They
                      are already fighting to manage their emotions &mdash; telling them to do what
                      they are already desperately trying to do adds frustration.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">It typically escalates the situation.</strong>{' '}
                      The person feels unheard and dismissed, which intensifies their distress.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">It assumes voluntary control.</strong>{' '}
                      Emotional dysregulation means the person&rsquo;s emotional responses are
                      beyond simple voluntary control &mdash; like telling someone with a broken leg
                      to &ldquo;just walk normally&rdquo;.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                ...
                <ul className="text-white text-sm space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">TIPP:</strong> Temperature (cold water on
                      face), Intense exercise, Paced breathing, Progressive muscle relaxation
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Distraction:</strong> Activities that occupy
                      the mind until the emotional wave passes
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Self-soothing:</strong> Using the five senses
                      to ground and comfort oneself
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Radical acceptance:</strong> Accepting the
                      present moment without judgement &mdash; &ldquo;this is happening, and I can
                      survive it&rdquo;
                    </span>
                  </li>
                </ul>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                Supporting someone with a personality disorder requires a specific set of skills.
                The good news is that these skills are learnable, and even small acts of compassion
                and consistency can make a significant difference to someone who is struggling.
              </p>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-white text-sm">
                          ...
                          therapeutic for someone who has experienced unpredictability.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-white text-sm">
                          ...
                          to leave at 5pm today. I will be back tomorrow.&rdquo; Boundaries should
                          be{' '}
                          <strong className="text-white">
                            consistent, communicated clearly, and maintained with compassion
                          </strong>
                          .
                        </p>
                      </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-white text-sm">
                          ...
                          &mdash; not by a desire to hurt you. Try to see past the behaviour to the
                          distress beneath it. This is not easy, but it is essential.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-white text-sm">
                          ...
                          presence communicates safety and builds trust over time.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="grid sm:grid-cols-2 gap-3">
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    ...
                    <p className="text-white text-xs">
                      ...
                      researched treatment for BPD/EUPD.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    ...
                    <p className="text-white text-xs">
                      ...
                      Particularly effective for complex personality difficulties.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                The language we use matters enormously. Diagnostic labels can be helpful for
                accessing treatment and understanding patterns, but they can also be weaponised
                &mdash; used to dismiss, dehumanise, and exclude. As a mental health first aider,
                you have a responsibility to use language that upholds the dignity and humanity of
                every person.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-white text-sm mb-3">
                  ...
                  on this change in attitude, which confirms their deepest fear &mdash; that they
                  are fundamentally unlovable and will be abandoned. This creates a devastating
                  cycle:
                </p>
                  ...
                  <div className="flex flex-col items-center space-y-2">
                    <div className="bg-purple-500/20 border border-purple-400/40 rounded-lg px-4 py-2 text-center">
                      <p className="text-purple-300 text-xs font-medium">
                        Person expresses distress
                      </p>
                    </div>
                    <div className="h-3 w-0.5 bg-purple-400/40" />
                    <div className="bg-purple-500/20 border border-purple-400/40 rounded-lg px-4 py-2 text-center">
                      <p className="text-purple-300 text-xs font-medium">
                        Labelled as &ldquo;difficult&rdquo; or &ldquo;manipulative&rdquo;
                      </p>
                    </div>
                    <div className="h-3 w-0.5 bg-purple-400/40" />
                    <div className="bg-purple-500/20 border border-purple-400/40 rounded-lg px-4 py-2 text-center">
                      <p className="text-purple-300 text-xs font-medium">
                        Others become dismissive or avoidant
                      </p>
                    </div>
                    <div className="h-3 w-0.5 bg-purple-400/40" />
                    <div className="bg-purple-500/20 border border-purple-400/40 rounded-lg px-4 py-2 text-center">
                      <p className="text-purple-300 text-xs font-medium">
                        Person feels rejected &amp; abandoned
                      </p>
                    </div>
                    <div className="h-3 w-0.5 bg-purple-400/40" />
                    <div className="bg-purple-500/20 border border-purple-400/40 rounded-lg px-4 py-2 text-center">
                      <p className="text-purple-300 text-xs font-medium">
                        Distress intensifies &amp; behaviours escalate
                      </p>
                    </div>
                    <div className="h-3 w-0.5 bg-purple-400/40" />
                    <div className="bg-red-500/20 border border-red-400/40 rounded-lg px-4 py-2 text-center">
                      <p className="text-red-300 text-xs font-medium">
                        Cycle repeats &mdash; confirming the label
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                ...
                <ul className="text-white text-sm space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Many people with BPD/EUPD show{' '}
                      <strong className="text-white">significant improvement</strong> with
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      <strong className="text-white">no longer meet the diagnostic criteria</strong>{' '}
                      after sustained therapeutic input
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-green-400 flex-shrink-0" />
                    <span>
                      Recovery is not always linear &mdash; there may be setbacks &mdash; but the
                      trajectory can be{' '}
                      <strong className="text-white">overwhelmingly positive</strong>
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-green-400 flex-shrink-0" />
                    <span>
                      ...
                      <strong className="text-white">DBT and Schema Therapy</strong> have strong
                      outcomes data
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                ...
                <p className="text-white text-sm">
                  ...
                  . A personality disorder does not diminish someone&rsquo;s humanity or their right
                  to respectful care. As a mental health first aider, you may be the first person
                  who truly listens, validates, and treats someone with a personality disorder as a
                  <strong className="text-white"> whole person</strong> rather than a label. That
                  can be transformative. Never underestimate the impact of simply being kind,
