...
const faqs = [
  {
    question: 'What should I do if someone becomes very distressed during a conversation?',
    answer:
  ...
  {
    question: 'How do I start a conversation about mental health with a colleague on site?',
    answer:
  ...
  {
    question: 'What if someone asks me not to tell anyone about what they have shared?',
    answer:
  ...
  {
    question: 'How can I support a colleague whose first language is not English?',
    answer:
...
export default function MentalHealthModule1Section4() {
  useSEO({
    title: 'Communication Skills & Active Listening | Mental Health Module 1.4',
    description:
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-purple-500/5 border-l-2 border-purple-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Active listening:</strong> Fully focusing on the speaker &mdash; not just
                hearing
              </li>
              <li>
                <strong>SOLER:</strong> Sit squarely, Open posture, Lean in, Eye contact, Relax
              </li>
              <li>
                <strong>Non-judgemental:</strong> Accept feelings without trying to fix them
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-purple-500/5 border-l-2 border-purple-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Start with:</strong> &ldquo;I&rsquo;ve noticed&hellip;&rdquo; or
                &ldquo;I&rsquo;m a bit worried about you&rdquo;
              </li>
              <li>
                <strong>Use:</strong> Open questions &mdash; &ldquo;How&rdquo; and
                &ldquo;What&rdquo;
              </li>
              <li>
                <strong>Remember:</strong> Silence is OK &mdash; don&rsquo;t rush to fill gaps
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                A single conversation can change a life. Research by the Samaritans shows that the
                simple act of being listened to &mdash; truly listened to, without judgement or
                interruption &mdash; can reduce feelings of isolation, hopelessness, and suicidal
                ideation. In a mental health first aid context, the way you communicate is more
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  than the male national average (ONS, 2023). A culture of toughness, &ldquo;getting
                  on with it&rdquo;, and reluctance to discuss feelings creates significant barriers
                  to help-seeking. Breaking through these barriers starts with how we talk to each
                  other.
                </p>
              </div>

              <p>
                Common barriers to talking about mental health on construction sites include fear of
                being seen as weak, concern about job security, lack of privacy, banter culture that
                discourages vulnerability, and simply not knowing how to start the conversation. As
                a mental health first aider, your role is to create a space where someone feels safe
                enough to talk.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Builds trust:</strong> The person feels safe to
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Reduces isolation:</strong> Knowing someone
                      cares enough to listen can be profoundly powerful
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Encourages help-seeking:</strong> A supportive
                      conversation may be the first step towards professional support
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Prevents escalation:</strong> Early
                      conversations can prevent a crisis from developing
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  <strong className="text-white">show that you genuinely care</strong>. That alone
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Active listening is a conscious, deliberate effort to fully concentrate on what
                someone is saying, understand their message, and respond thoughtfully. It is
                fundamentally different from passive listening, where you hear words but your mind
                is elsewhere &mdash; thinking about what to say next, checking your phone, or
                waiting for a gap to offer advice.
              </p>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-3">Active vs Passive Listening</p>
              ...
              <div className="bg-gradient-to-br from-purple-500/10 to-violet-500/10 border border-purple-500/30 rounded-lg p-5 sm:p-6">
                ...
                <div className="grid gap-3">
                  ...
                  <div className="flex items-start gap-4 bg-white/5 border border-white/10 rounded-lg p-4">
                    <div className="flex items-center justify-center w-10 h-10 rounded-full bg-purple-500/20 border border-purple-500/40 flex-shrink-0">
                      <span className="text-lg font-bold text-purple-400">O</span>
                    </div>
                    <div>
              ...
              <p>
                Beyond body language, active listening involves three key verbal skills:{' '}
                <strong>paraphrasing</strong> (restating what the person has said in your own words
                to check understanding), <strong>reflecting feelings</strong> (naming the emotion
                you sense behind their words, e.g. &ldquo;It sounds like you are feeling really
                overwhelmed&rdquo;), and <strong>summarising</strong> (bringing together the key
                points of what they have shared to show you have been listening).
              </p>
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Minimal encouragers: &ldquo;Mm-hmm&rdquo;, &ldquo;Go on&rdquo;, &ldquo;I
                      see&rdquo;, &ldquo;Tell me more&rdquo;
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>Paraphrasing: &ldquo;So what I&rsquo;m hearing is&hellip;&rdquo;</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Reflecting: &ldquo;It sounds like that made you feel really angry&rdquo;
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Summarising: &ldquo;So overall, you&rsquo;ve been dealing with&hellip;&rdquo;
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                A non-judgemental approach means suspending your own opinions, beliefs, and
                assumptions so that you can fully accept the other person&rsquo;s experience as
                valid and real. It does not mean you have to agree with everything they say &mdash;
                it means you create a space where they feel safe to be honest without fear of
                criticism, dismissal, or being told they are wrong to feel the way they do.
              </p>
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  congruence). It means offering warmth, acceptance, and respect to a person
                  regardless of what they say, do, or feel. In mental health first aid, this means
                  valuing the person as a human being &mdash; even if their behaviour, choices, or
                  circumstances are difficult to understand.
                </p>
              </div>

              <p>
                Judgement often comes through unconsciously, in the words we choose and the tone we
                use. Even well-intentioned responses can be minimising or dismissive if we are not
                careful. The table below shows common judgemental phrases and their supportive
                alternatives.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 rounded-lg overflow-hidden">
                ...
                <div className="grid grid-cols-2 gap-0 border-b border-white/10 text-xs font-semibold">
                  <div className="p-2 sm:p-3 text-red-400">Avoid (Judgemental)</div>
                ...
                {[
                  ...
                  >
                    ...
                    <div className="p-2 sm:p-3 text-white border-l border-white/5">{row.use}</div>
                  </div>
                ))}
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Name the emotion:</strong> &ldquo;It sounds
                      like you&rsquo;re feeling really frustrated&rdquo;
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Acknowledge the context:</strong> &ldquo;Given
                      everything you&rsquo;ve been dealing with, it&rsquo;s completely
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Avoid the word &ldquo;but&rdquo;:</strong>{' '}
                      Saying &ldquo;I understand, but&hellip;&rdquo; negates everything before it.
                      Use &ldquo;and&rdquo; instead
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The questions you ask shape the conversation. Open questions invite the person to
                share their thoughts and feelings in their own words, while closed questions limit
                them to a &ldquo;yes&rdquo; or &ldquo;no&rdquo; response. In mental health
                conversations, open questions are almost always more useful because they encourage
                the person to explore and express what they are experiencing.
              </p>
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div className="bg-green-500/10 border border-green-500/20 p-4 rounded-lg">
                  ...
                  <ul className="text-xs text-white space-y-2">
                    ...
                    <li className="flex items-start gap-2">
                      <CheckCircle className="h-3.5 w-3.5 text-green-400 mt-0.5 flex-shrink-0" />
                      <span>&ldquo;What has been on your mind?&rdquo;</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle className="h-3.5 w-3.5 text-green-400 mt-0.5 flex-shrink-0" />
                      <span>&ldquo;Tell me more about what&rsquo;s been going on.&rdquo;</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle className="h-3.5 w-3.5 text-green-400 mt-0.5 flex-shrink-0" />
                      <span>&ldquo;What would be most helpful for you right now?&rdquo;</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle className="h-3.5 w-3.5 text-green-400 mt-0.5 flex-shrink-0" />
                      <span>&ldquo;How is this affecting your day-to-day life?&rdquo;</span>
                    </li>
                  </ul>
                </div>
                <div className="bg-red-500/10 border border-red-500/20 p-4 rounded-lg">
                  ...
                  <ul className="text-xs text-white space-y-2">
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        &ldquo;Are you OK?&rdquo; (likely answer: &ldquo;Yeah, fine&rdquo;)
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <AlertTriangle className="h-3.5 w-3.5 text-red-400 mt-0.5 flex-shrink-0" />
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  confrontational. Be cautious with{' '}
                  <strong className="text-white">&ldquo;Why&rdquo;</strong> questions (e.g.
                  &ldquo;Why do you feel like that?&rdquo;) as they can feel accusatory and put
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-2">
                  {[
                    {
                      step: '1. Broad',
                      example: '"How have things been going for you recently?"',
                    },
                    {
                      step: '2. Narrowing',
                      example:
                    ...
                    {
                      step: '3. Specific',
                      example: '"When did you first start noticing these feelings?"',
                    },
                    {
                      step: '4. Focused',
                      example: '"What kind of support do you think would help the most?"',
                    },
                  ].map((item, i) => (
                    <div key={i} className="flex items-start gap-3 bg-white/[0.03] p-3 rounded-lg">
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  confirming understanding (&ldquo;So what you&rsquo;re saying is&hellip; is that
                  right?&rdquo;). Use them purposefully, not as a default.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Starting a conversation about someone&rsquo;s mental health can feel daunting, but
                it is one of the most important things you can do as a mental health first aider.
                Most people who are struggling will not initiate the conversation themselves &mdash;
                they are waiting for someone to notice, to ask, and to show they care enough to
                listen.
              </p>
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      &ldquo;I&rsquo;ve noticed you&rsquo;ve seemed a bit quieter than usual &mdash;
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      &ldquo;I&rsquo;m concerned about you &mdash; I wanted to check in and see how
                      you are.&rdquo;
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      &ldquo;I care about you and I&rsquo;ve noticed something seems different
                      &mdash; is there anything you&rsquo;d like to talk about?&rdquo;
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      &ldquo;No pressure at all, but I&rsquo;m here if you ever want to chat.&rdquo;
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Thank them:</strong> &ldquo;Thank you for
                      telling me &mdash; I know that wasn&rsquo;t easy.&rdquo;
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Acknowledge:</strong> &ldquo;That sounds really
                      difficult.&rdquo;
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Reassure:</strong> &ldquo;You&rsquo;re not
                      alone in this &mdash; there is support available.&rdquo;
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Give space:</strong> &ldquo;Take your time
                      &mdash; there&rsquo;s no rush.&rdquo;
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Stay calm &mdash; your composure helps regulate their emotional state
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Do not try to stop them from crying &mdash; tears are a healthy release
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Use short, grounding phrases: &ldquo;I&rsquo;m right here&rdquo;,
                      &ldquo;You&rsquo;re safe&rdquo;, &ldquo;Take your time&rdquo;
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>Offer water and suggest slow breathing if they are hyperventilating</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Do not leave them alone unless they ask &mdash; and even then, stay nearby
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                      &ldquo;I know exactly how you feel&rdquo; &mdash; you do not, and this can
                      feel dismissive
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                      &ldquo;At least&hellip;&rdquo; &mdash; minimises their pain by comparing it to
                      something else
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                      &ldquo;You should&hellip;&rdquo; &mdash; unsolicited advice rarely helps and
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                      &ldquo;Snap out of it&rdquo; &mdash; implies the person is choosing to feel
                      this way
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                      &ldquo;Think positive&rdquo; &mdash; invalidates their experience and
                      oversimplifies recovery
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  something important, or simply organising their thoughts. Sit with the silence.
                  Maintain gentle eye contact. Let them know through your body language that you are
                  still there and that there is no rush. Some of the most powerful moments in a
                  conversation happen in the silences between words.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Reflecting their feelings: &ldquo;That must feel incredibly lonely&rdquo;
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>Using your tone of voice to convey warmth and care</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Matching their emotional register &mdash; do not be cheerful if they are in
                      pain
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Being genuine &mdash; people can sense when someone is going through the
                      motions
                    </span>
                  </li>
                </ul>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Mental health is experienced and expressed differently across cultures, communities,
                and individuals. What is considered a normal expression of distress in one culture
                may be unfamiliar in another. As a mental health first aider, cultural sensitivity
                means being aware of these differences and adapting your approach without making
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Somatic expressions:</strong> In many cultures,
                      emotional distress manifests as physical symptoms &mdash; headaches, stomach
                      pain, fatigue &mdash; rather than being described in psychological terms
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Stigma and shame:</strong> Some communities
                      carry deep stigma around mental illness, viewing it as a personal weakness, a
                      curse, or a source of family shame
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Emotional expression norms:</strong> Some
                      cultures encourage open emotional expression while others value stoicism and
                      restraint &mdash; neither is right or wrong
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Help-seeking behaviour:</strong> Some
                      communities prefer to seek support from religious leaders, elders, or family
                      members rather than from healthcare professionals
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  Check understanding regularly, use visual aids or translation tools if available,
                  and be patient. If possible and with consent, involve a bilingual colleague. The
                  effort you make to communicate across a language barrier is itself an act of care.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Respect their beliefs &mdash; do not dismiss spiritual explanations as
                      &ldquo;wrong&rdquo;
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Ask what would be most helpful for them &mdash; they may want both spiritual
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Be aware that some religious communities may discourage seeking professional
                ...
                <div className="bg-violet-500/10 border border-violet-500/20 p-4 rounded-lg">
                  ...
                  <ul className="text-xs text-white space-y-2">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        LGBTQ+ individuals are at higher risk of anxiety, depression, and suicidal
                        ideation due to discrimination and minority stress
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Use inclusive language and avoid assumptions about relationships or identity
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        The construction industry can be a particularly hostile environment &mdash;
                        be mindful of this context
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Respect pronouns and names &mdash; if unsure, ask: &ldquo;How would you like
                        me to refer to you?&rdquo;
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-violet-500/10 border border-violet-500/20 p-4 rounded-lg">
                  ...
                  <ul className="text-xs text-white space-y-2">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Autistic individuals, those with ADHD, dyslexia, or other neurodiverse
                        conditions may communicate and process emotions differently
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Eye contact may be uncomfortable &mdash; adapt the SOLER model accordingly
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Be clear and direct in your language &mdash; avoid figurative speech and
                        ambiguity
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>Allow extra processing time and do not rush responses</span>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  ask: &ldquo;Is there anything about your background or beliefs that it would be
                  helpful for me to know?&rdquo; or &ldquo;How can I best support you?&rdquo; Treat
                  each person as an individual. Their culture is part of their identity, not a
                  script that dictates their behaviour.
                </p>
              </div>
            </div>
          </div>
