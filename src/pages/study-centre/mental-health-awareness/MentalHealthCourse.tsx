...
export default function MentalHealthCourse() {
  useSEO({
    ...
    description:
      'Complete mental health awareness course for electricians and tradespeople. Based on MHFA England, Mates in Mind, and HSE stress management standards.',
  });
          ...
          <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-rose-500/10 via-rose-400/5 to-transparent border border-rose-500/15 p-5 sm:p-8">
            ...
            <div className="relative z-10">
              ...
              <p className="text-sm sm:text-base lg:text-lg text-white mt-1 max-w-2xl">
                Recognising signs, starting conversations, and supporting others — based on MHFA
                England and Mates in Mind frameworks
              </p>
            </div>
          </div>
