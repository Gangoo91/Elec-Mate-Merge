...
const quizQuestions = [
  ...
  },
  {
    id: 5,
    question:
      "When someone makes a stigmatising comment about mental health on site (for example, calling someone 'weak' for being stressed), the BEST response is to:",
    options: [
...
export default function MentalHealthModule5Section2() {
  useSEO({
    ...
    description:
      'Learn how to build a workplace culture where mental health is discussed openly, leaders model vulnerability, and stigma is actively challenged in construction.',
  });
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <header className="text-center mb-12">
          ...
          <p className="text-white text-sm sm:text-base max-w-2xl mx-auto">
            How to build a workplace where mental health is discussed openly, leaders model
            vulnerability, and stigma has nowhere to hide
          </p>
        </header>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-rose-500/5 border-l-2 border-rose-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Culture:</strong> People feel safe to talk about mental health
              </li>
              <li>
                <strong>Leaders:</strong> Model vulnerability and prioritise wellbeing
              </li>
              <li>
                <strong>Champions:</strong> Trained people who signpost and support
              </li>
              <li>
                <strong>Action:</strong> Challenge stigma actively, not passively
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-rose-500/5 border-l-2 border-rose-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Toolbox talks:</strong> Include mental health regularly
              </li>
              <li>
                <strong>Inductions:</strong> Introduce MH support from day one
              </li>
              <li>
                <strong>First Aiders:</strong> Visible, approachable, trained
              </li>
              <li>
                <strong>Culture shift:</strong> &ldquo;Looking out for your mates&rdquo; includes
                their mind
              </li>
            </ul>
          </div>
          ...
          <div className="border-l-2 border-rose-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                impossible and unrealistic. It is a culture where{' '}
                <strong>people feel safe to be honest about how they are feeling</strong>, where
                support is visible and accessible, and where mental health is treated with the same
                seriousness as physical health and safety.
              </p>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  The foundation of a mentally healthy culture is{' '}
                  <strong>psychological safety</strong> &mdash; a term coined by Harvard professor
                  Amy Edmondson. It means that people believe they will not be punished, humiliated,
                  or sidelined for speaking up about their mental health. On a construction site,
                  this means an electrician can tell their supervisor they are struggling without
                  fear that they will be seen as weak, moved off the job, or treated differently by
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-3">
                  Characteristics of a Mentally Healthy Culture
                </p>
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>People feel safe to talk</strong> &mdash; Not everyone will choose to
                      share personal details, and that is fine. But they know that IF they need to,
                      they can. There are no negative consequences for being honest.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Mental health is treated like physical health</strong> &mdash; Just as
                      nobody is judged for having a broken leg, nobody is judged for having
                      depression. If someone needs time off for their mental health, it is treated
                      with the same respect as time off for a physical injury.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Leaders model vulnerability</strong> &mdash; Senior people are visibly
                      open about their own mental health. They talk about the pressures they face,
                      the times they have struggled, and the support that helped them. This gives
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Support is visible and accessible</strong> &mdash; People know where
                      to go for help. Helpline numbers are displayed prominently. Mental health
                      first aiders are identifiable. The process for accessing support is simple and
                      well-known.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Stigma is actively challenged</strong> &mdash; When someone makes a
                      dismissive or stigmatising comment, it is addressed. Not aggressively, but
                      firmly and consistently. The culture does not tolerate attitudes that prevent
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>It is embedded in daily operations</strong> &mdash; Mental health is
                      not a box-ticking exercise or an annual awareness event. It is woven into site
                      inductions, toolbox talks, one-to-ones, risk assessments, and the everyday way
                      people interact. It is how business is done, not an add-on.
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-3">
                  What Leadership Role Modelling Looks Like
                </p>
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Sharing personal experiences</strong> &mdash; A managing director who
                      stands up at a company event and says &ldquo;I have struggled with anxiety,
                      and here is what helped me&rdquo; does more for culture change than any policy
                      document. It gives permission. It says: &ldquo;If someone at my level can be
                      open about this, so can you.&rdquo;
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Visible participation in training</strong> &mdash; When senior leaders
                      attend mental health training themselves &mdash; not just sign off on it for
                      others &mdash; it demonstrates that this is a priority, not just a compliance
                      exercise. If the site manager sits in the toolbox talk on mental health, it
                      sends a message.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Genuine check-ins</strong> &mdash; Not the cursory &ldquo;you alright,
                      mate?&rdquo; as you walk past, but actually stopping, making eye contact, and
                      listening to the answer. Learning the difference between someone who says
                      &ldquo;yeah, fine&rdquo; and means it, and someone who says it because they do
                      not feel safe being honest.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Admitting when they are struggling</strong> &mdash; Leaders who say
                      &ldquo;this has been a tough week for me&rdquo; or &ldquo;I did not sleep well
                      because I was worried about the project&rdquo; normalise the experience. It
                      shows that stress and difficulty are part of being human, not signs of
                      inadequacy.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Allocating budget and time</strong> &mdash; Talk is cheap. Real
                      commitment means allocating budget for training, allowing time in the
                      programme for toolbox talks on mental health, paying for MHFA training, and
                      investing in Employee Assistance Programmes. Resources follow priorities.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Walking the talk</strong> &mdash; The difference between lip service
                      and genuine culture change is consistency. A leader who talks about mental
                      health in a company presentation but never mentions it on site is not role
                      modelling &mdash; they are performing. Workers spot the difference instantly.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <p className="text-sm font-medium text-rose-400">
                    Walking the Talk vs Lip Service
                  </p>
                </div>
                <p className="text-sm text-white">
                  Construction workers are exceptionally good at spotting hypocrisy. If a company
                  puts up mental health posters but then pressures people to work excessive
                  overtime, the posters are meaningless. If a supervisor talks about openness but
                  then mocks someone for being stressed, the words are worse than worthless &mdash;
                  they actively damage trust. <strong>Authenticity is everything.</strong> It is
                  better to do a few things genuinely than to do many things superficially.
                </p>
              </div>
              ...
              <p>
                ...
                &mdash; to talk about it, to ask about it, to act on it, and to make it clear
                through their behaviour that people who seek help will be supported, not penalised.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                sites are <strong>Mental Health Champions</strong> and{' '}
                <strong>Mental Health First Aiders</strong>. While the names are sometimes used
                interchangeably, they are distinct roles with different levels of training and
                responsibility.
              </p>
                  ...
                  <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                    ...
                    <ul className="text-sm text-white space-y-1.5">
                      ...
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                        <span>
                          Use the ALGEE action plan (Approach, Listen, Give support, Encourage,
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-3">
                  Making Champions and First Aiders Effective
                </p>
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Visibility</strong> &mdash; People need to know who their champions
                      and first aiders are. Use lanyards, hard hat stickers, posters with photos and
                      names, and introduce them during inductions. If nobody knows they exist, they
                      cannot help.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Representation</strong> &mdash; Ideally, champions and first aiders
                      should come from different trades, levels, and backgrounds so that everyone
                      has someone they feel comfortable approaching. A fellow electrician may be
                      more approachable than someone from a different trade or from management.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Ongoing support</strong> &mdash; Champions and first aiders need
                      support too. The role can be emotionally demanding, especially when they are
                      supporting someone in crisis. Regular supervision, refresher training (at
                      least annually), and peer support for the supporters themselves are essential.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Numbers</strong> &mdash; MHFA England recommends at least one first
                      aider per 50 employees. On construction sites, consider the layout, shift
                      patterns, and subcontractor arrangements when deciding how many you need.
                      Having too few means people cannot access support when they need it.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Boundaries</strong> &mdash; Champions and first aiders must understand
                      their boundaries. They are NOT counsellors, therapists, or diagnosticians.
                      Their role is initial support and signposting. Trying to do more than they are
                      trained for can be harmful to both the supporter and the person being
                      supported.
                    </span>
                  </li>
                </ul>
            ...
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <p className="text-sm font-medium text-white">
                    Practical Ways to Normalise the Conversation
                  </p>
                </div>
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Toolbox talks on mental health</strong> &mdash; Include mental health
                      as a regular toolbox talk topic, not just during awareness weeks. Topics might
                      include recognising stress, how to support a colleague, where to find help,
                      coping with change, managing work-life balance, or dealing with financial
                      worries. Treat it with the same seriousness as a safety toolbox talk.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Site inductions</strong> &mdash; Include mental health in every site
                      induction. From their very first moment on site, every worker should know what
                      mental health support is available, who the mental health first aiders are,
                      and that this company takes mental health seriously. First impressions set
                      expectations.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Talk about it regularly</strong> &mdash; Do not save mental health for
                      one week a year (World Mental Health Day in October or Mental Health Awareness
                      Week in May). Mention it in team meetings, site briefings, and informal
                      conversations. The more it is discussed, the more normal it becomes.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Celebrate people who speak up</strong> &mdash; When someone has the
                      courage to talk about their mental health (with their permission), acknowledge
                      it. Recognise it as strength, not weakness. This encourages others to do the
                      same.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Use stories and testimonials</strong> &mdash; Real stories from real
                      construction workers are incredibly powerful. Videos, written testimonials, or
                      even just someone willing to share their experience during a toolbox talk can
                      have more impact than any amount of data or policy documents.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Peer support programmes</strong> &mdash; Formal peer support
                      programmes, where trained volunteers support colleagues through shared
                      experience, are growing in construction. They work because workers often find
                      it easier to talk to someone who truly understands their world &mdash; the
                      early starts, the travel, the physical demands, the job insecurity.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  engagement and resistance. Phrases like{' '}
                  <strong>&ldquo;looking out for your mates,&rdquo;</strong>{' '}
                  <strong>&ldquo;having each other&rsquo;s backs,&rdquo;</strong>
              ...
              <p>
                ...
                doing?&rdquo; is as natural as asking &ldquo;have you done your risk
                assessment?&rdquo; That takes time and persistence, but every conversation, every
                toolbox talk, and every moment of genuine connection moves the culture in the right
                direction.
              </p>
            </div>
          </div>
          ...
          <div className="border-l-2 border-amber-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                weakness. Changing this requires <strong>active, sustained effort</strong> &mdash;
                it will not happen on its own.
              </p>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-3">
                  How Stigma Shows Up on Construction Sites
                </p>
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Dismissive language</strong> &mdash; &ldquo;Man up,&rdquo;
                      &ldquo;toughen up,&rdquo; &ldquo;what have you got to be depressed
                      about?&rdquo; &ldquo;It&rsquo;s just stress, get on with it.&rdquo; These
                      phrases, often said casually and without malicious intent, are deeply damaging
                      because they shut down conversation and reinforce the idea that mental health
                      difficulties are not real or valid.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>&ldquo;Banter&rdquo; that crosses the line</strong> &mdash;
                      Construction sites are known for banter, and much of it is harmless and helps
                      build camaraderie. But when banter targets someone&rsquo;s mental health,
                      mocks vulnerability, or creates an environment where people are afraid to show
                      any weakness, it has crossed the line from bonding to bullying.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Assumptions about medication</strong> &mdash; Comments like
                      &ldquo;he&rsquo;s on happy pills&rdquo; or &ldquo;she&rsquo;s a bit
                      mental&rdquo; reduce complex health conditions to jokes. They make people less
                      likely to seek treatment or to be open about the treatment they are already
                      receiving.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Career fear</strong> &mdash; The belief that disclosing a mental
                      health difficulty will damage career prospects, lead to being passed over for
                      promotion, or result in being moved off a project. This fear is often
                      well-founded, which makes challenging it even more important.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-3">
                  Effective Approaches to Challenging Stigma
                </p>
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Be firm but respectful</strong> &mdash; The goal is to change
                      behaviour, not to humiliate people. When someone makes a stigmatising comment,
                      address it calmly: &ldquo;I get what you mean, but actually, depression is a
                      real illness &mdash; it can hit anyone, even the strongest people I
                      know.&rdquo; This challenges the behaviour without attacking the person.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Create allies, not enforcers</strong> &mdash; The aim is to bring
                      people along, not to police them. When you educate someone about why their
                      language matters, you are creating an ally who will spread the message
                      further. When you shame or punish them, you create resentment and resistance.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Educate older workers without alienating them</strong> &mdash; Many
                      experienced construction workers grew up in a culture where mental health was
                      never discussed. Telling them they have been &ldquo;doing it wrong&rdquo; for
                      30 years is counterproductive. Instead, frame it as: &ldquo;Things have
                      changed, and we understand more now. You have probably seen colleagues suffer
                      &mdash; let&rsquo;s make sure the next generation does not have to.&rdquo;
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Address it in the moment</strong> &mdash; Saving the challenge for a
                      formal setting loses the teachable moment. When you hear stigmatising
                      language, address it there and then &mdash; briefly, calmly, and without
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Use relatable examples</strong> &mdash; Connecting mental health to
                      experiences everyone can relate to is powerful. &ldquo;You know that feeling
                      when the whole project is going wrong and you cannot sleep? That is stress
                      affecting your mental health. Now imagine feeling like that every day for six
                      months. That is what depression can feel like.&rdquo;
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  There is a crucial distinction between awareness and culture change.{' '}
                  <strong>
                    Awareness is knowing that mental health matters. Culture change is doing
                    something about it, every day.
                  </strong>{' '}
                  Awareness is a poster on the welfare unit wall. Culture change is a supervisor who
                  genuinely checks in with their team every morning. Awareness is a one-off training
                  course. Culture change is mental health being part of every toolbox talk, every
                  induction, every conversation. Awareness is the starting point. Culture change is
                  the destination. And the distance between the two is measured in consistent, daily
                  action.
                </p>
              </div>
              ...
              <p>
                ...
                every time someone challenges stigma &mdash; every time someone says
                &ldquo;actually, that is not okay&rdquo; or &ldquo;there is no shame in asking for
                help&rdquo; &mdash; the culture shifts a little. And those small shifts, accumulated
                over time, create the transformation that saves lives.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-green-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                This section has explored how to create a workplace culture where mental health is
                openly discussed, visibly supported, and actively protected. Culture change is the
                hardest part of the mental health journey, but it is also the most important.
              </p>
              ...
              <ul className="text-sm text-white space-y-2">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong>Psychological safety</strong> is the foundation &mdash; people must feel
                    safe to talk without fear of negative consequences.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong>Leadership role modelling</strong> is essential &mdash; culture change
                    starts at the top. When leaders are open, it gives everyone permission.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong>Champions and First Aiders</strong> provide trained, visible support on
                    site &mdash; at least 1 per 50 workers (MHFA England recommendation).
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong>Normalising the conversation</strong> means weaving mental health into
                    daily site life &mdash; toolbox talks, inductions, team meetings, not just
                    awareness weeks.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong>Challenging stigma</strong> requires firm but respectful action &mdash;
                    creating allies, not enforcers. Every challenge shifts the culture.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong>Awareness is knowing; culture change is doing.</strong> The gap is
                    bridged by consistent, daily, visible action at every level.
                  </span>
                </li>
              </ul>
