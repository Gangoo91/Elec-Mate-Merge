...
const quizQuestions = [
  ...
  },
  {
    id: 2,
    question:
      'According to diagnostic criteria, to meet the threshold for major depressive disorder, symptoms must be present:',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      "For a diagnosis of major depressive disorder, symptoms must be present for at least two weeks, occurring most of the day, nearly every day. This duration criterion helps distinguish clinical depression from normal sadness or grief, which typically improve over days rather than persisting for weeks. However, you don't need to wait two weeks to seek help — if symptoms are severe, help should be sought immediately.",
  },
  {
    id: 3,
...
export default function MentalHealthModule2Section3() {
  useSEO({
    ...
    description:
      'Understand depression and anxiety as clinical conditions, how they manifest in construction workers and men, and the PHQ-9 and GAD-7 screening tools.',
  });
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <header className="text-center mb-12">
          ...
          <p className="text-white text-sm sm:text-base max-w-2xl mx-auto">
            Understanding these common mental health conditions and how they manifest in
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-rose-500/5 border-l-2 border-rose-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Depression and anxiety are medical conditions</strong> — not weakness
              </li>
              <li>
                <strong>Men express depression differently</strong> — often as anger, not sadness
              </li>
              <li>
                <strong>Anxiety is excessive, persistent worry</strong> — beyond normal concern
              </li>
              <li>
                <strong>Both are treatable</strong> — recovery is possible with proper support
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-rose-500/5 border-l-2 border-rose-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>50% of men with depression show anger</strong> — not 'classic' low mood
              </li>
              <li>
                <strong>Anxiety causes real physical symptoms</strong> — racing heart, shaking,
                nausea
              </li>
              <li>
                <strong>Duration matters</strong> — 2+ weeks of persistent symptoms is the threshold
              </li>
              <li>
                <strong>GPs have assessment tools</strong> — PHQ-9 and GAD-7 measure severity
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-rose-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Depression is one of the most common mental health problems in the UK — and one of
                the most misunderstood. It's not about being sad. It's not about having a bad day,
                week, or even month. <strong>Depression is a clinical condition</strong> that
                affects brain chemistry, thinking, mood, behaviour, and physical health.
                Understanding what depression actually is — and what it isn't — is the first step to
                recognising it in yourself or others.
              </p>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white mb-2">
                  Clinical depression (also called major depressive disorder) is a medical condition
                  characterised by:
                </p>
                <ul className="text-sm text-white space-y-1.5">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong>Persistent low mood or sadness</strong> — lasting most of the day,
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Loss of interest or pleasure</strong> (anhedonia) — things you used to
                      enjoy don't bring pleasure anymore
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Significant impact on functioning</strong> — affecting work,
                      relationships, self-care, daily activities
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Changes in brain chemistry</strong> — particularly affecting
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>A cluster of other symptoms</strong> — fatigue, sleep problems,
                      appetite changes, difficulty concentrating, feelings of worthlessness or
                      guilt, thoughts of death
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Normal sadness:</strong> Everyone feels sad sometimes — after loss,
                      disappointment, or setbacks. Normal sadness improves over days or weeks.
                      Depression persists for weeks or months and doesn't respond to positive
                      events.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>A sign of weakness:</strong> Depression is not about being 'soft',
                      'weak', or 'not tough enough'. It's a medical condition that can affect
                      anyone, regardless of strength, resilience, or character.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Something you can just 'snap out of':</strong> Telling someone with
                      depression to 'cheer up' or 'think positive' is like telling someone with a
                      broken leg to 'just walk it off'. The condition affects the brain's ability to
                      regulate mood.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Attention-seeking or being dramatic:</strong> Depression is profoundly
                      unpleasant. Nobody would choose to feel this way. It's a genuine health
                      problem, not performance.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Untreatable:</strong> Depression is highly treatable. Talking
                      therapies (especially CBT), antidepressant medication, lifestyle changes, and
                      social support are all effective. Most people who receive appropriate
                      treatment recover or significantly improve.
                    </span>
                  </li>
                </ul>
              </div>
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <p className="text-sm text-white">
                      The most common form. Characterised by persistent low mood and loss of
                      interest lasting at least two weeks, causing significant impairment. Can be
                      mild, moderate, or severe. Episodes can be recurrent (coming back multiple
                      times over life) or single episode.
                    </p>
                  </div>
                  <div>
                    <p className="text-white font-medium text-sm mb-1">
                    ...
                    <p className="text-sm text-white">
                      Chronic, lower-level depression lasting at least two years. It's less severe
                      than MDD but lasts much longer. People often describe it as 'I've felt like
                      this for so long, I don't remember what normal feels like.'
                    </p>
                  </div>
                  <div>
                    <p className="text-white font-medium text-sm mb-1">
                    ...
                    <p className="text-sm text-white">
                      Depression that follows a seasonal pattern, typically occurring in
                      autumn/winter and improving in spring/summer. Related to reduced sunlight
                      affecting brain chemistry. More common in northern latitudes. Treated with
                      light therapy, antidepressants, and talking therapy.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-3">
                  Duration Matters — When Sadness Becomes Depression
                </p>
                <p className="text-sm text-white mb-2">
                ...
                <ul className="text-sm text-white space-y-1.5">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Normal sadness or grief:</strong> Improves gradually over days to
                      weeks. You have good moments. Positive events still bring some pleasure. You
                      can still function (even if it's hard). You can still see hope for the future.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Clinical depression:</strong> Persists for weeks or months with no
                      improvement. Low mood is constant — there are no good moments. Nothing brings
                      pleasure — even things you used to love. Functioning becomes very difficult or
                      impossible. The future looks hopeless.
                    </span>
                  </li>
                </ul>
                <p className="text-sm text-white mt-3">
                  <strong>The two-week threshold:</strong> Diagnostic criteria require symptoms to
                  be present for at least two weeks. This helps distinguish depression from normal
                  sadness. However, you don't need to wait two weeks to seek help — if symptoms are
                  severe (especially suicidal thoughts), get help immediately.
                </p>
              </div>

              <p>
                Understanding depression as a medical condition — not a character flaw or a choice —
                is fundamental to reducing stigma, encouraging help-seeking, and supporting
                recovery. In construction, where there's still significant stigma around mental
                health, this understanding is particularly important.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Depression doesn't announce itself with a sign. On a construction site, where the
                culture values toughness and stoicism, people are often very good at hiding how
                they're really feeling. But there are observable signs — changes in behaviour,
                appearance, work quality, and mood — that can alert you that someone is struggling.
              </p>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-3">
                  Common Signs of Depression on a Construction Site
                </p>
                <div className="space-y-3">
                  <div>
                    <p className="text-white font-medium text-sm mb-1">
                      Persistent Withdrawal from Team and Social Activities
                    </p>
                    <ul className="text-sm text-white space-y-1">
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                        <span>
                          No longer joining the team for breaks — eating alone, staying in their van
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                        <span>
                          Not engaging in conversation — withdrawn, quiet, giving one-word answers
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                        <span>
                          Declining social invitations they would previously have accepted
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                  ...
                  <div>
                    ...
                    <ul className="text-sm text-white space-y-1">
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                        <span>
                          Someone who used to take pride in their work now seems apathetic — 'good
                  ...
                  <div>
                    ...
                    <ul className="text-sm text-white space-y-1">
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                        <span>
                          More frequent sick days, often for vague complaints (not feeling well,
                    ...
                    <p className="text-sm text-white mt-2">
                      Depression makes getting out of bed extremely difficult. What looks like
                      'skiving' or lack of commitment might actually be profound exhaustion and loss
                      of motivation caused by depression.
                    </p>
                  </div>

                  <div>
                    <p className="text-white font-medium text-sm mb-1">
                      Visible Fatigue and Low Energy
                    </p>
                    <ul className="text-sm text-white space-y-1">
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                        <span>
                          Looking exhausted despite adequate sleep (or claiming they slept but still
                          being exhausted)
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                        <span>
                          Moving slowly, slowed speech and reactions (psychomotor retardation)
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                      ...
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                        <span>
                          Frequent comments about being tired, exhausted, having no energy
                        </span>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div>
                    <p className="text-white font-medium text-sm mb-1">
                      Irritability and Short Temper (Especially in Men)
                    </p>
                    <ul className="text-sm text-white space-y-1">
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    ...
                    <p className="text-sm text-white mt-2">
                      This is particularly important: for many men, depression manifests as anger
                      rather than sadness. Persistent irritability — especially when it represents a
                      change — can be a sign of underlying depression.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="text-sm text-white space-y-1">
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                        <span>
                          Looking unkempt or dishevelled when they're usually well-presented
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                  ...
                  <div>
                    <p className="text-white font-medium text-sm mb-1">
                      Comments Indicating Hopelessness or Worthlessness
                    </p>
                    <ul className="text-sm text-white space-y-1">
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                      ...
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                        <span>
                          'Everyone would be better off without me' (CRITICAL — this is a suicide
                          warning sign)
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                    ...
                    <p className="text-sm text-white mt-2">
                      These comments reveal how depression distorts thinking. Take them seriously.
                      They're not just 'having a moan' — they're expressions of genuine despair.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  You're not looking for someone who's naturally quiet, or who's having one bad day.
                  You're looking for
                  <strong> persistent changes from their normal behaviour</strong> over a period of
                  weeks. Someone who's usually chatty becoming withdrawn. Someone who takes pride in
                  their work becoming apathetic. Someone who's usually patient becoming irritable.
                  It's the change — and its persistence — that matters.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Everyone experiences anxiety. It's a normal, healthy response to threat or challenge
                — the feeling of nervousness before an important task, the worry when something
                could go wrong, the alertness in a dangerous situation.{' '}
                <strong>Anxiety becomes a problem</strong> when it's excessive, persistent,
                disproportionate to the actual threat, and significantly impairs your ability to
                function.
              </p>
                  ...
                  <div className="bg-green-500/10 border border-green-500/30 p-3 rounded-lg">
                    ...
                    <ul className="text-sm text-white space-y-1.5">
                      ...
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-green-400 flex-shrink-0" />
                        <span>
                          Example: Nervousness before a test that helps you focus and prepare
                        </span>
                      </li>
                    </ul>
                  </div>
                  <div className="bg-red-500/10 border border-red-500/30 p-3 rounded-lg">
                    ...
                    <ul className="text-sm text-white space-y-1.5">
                      ...
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                        <span>
                          Example: Constant, uncontrollable worry about everything, with physical
                          symptoms, preventing normal functioning
                        </span>
                      </li>
                    </ul>
                  </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white mb-3">
                  Understanding the body's stress response helps explain why anxiety causes such
                  intense physical symptoms. When you perceive a threat (real or imagined), your
                  amygdala (the brain's alarm system) triggers the sympathetic nervous system,
                  causing:
                </p>
                <ul className="text-sm text-white space-y-1.5">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Adrenaline and cortisol release</strong> — stress hormones flood your
                      system
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Increased heart rate</strong> — pumping blood to major muscles
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Rapid breathing</strong> — getting more oxygen
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Muscle tension</strong> — preparing to fight or run
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Heightened senses</strong> — better able to detect threats
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Digestive system slows</strong> — blood diverted from non-essential
                      functions (causing nausea, butterflies)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Sweating</strong> — cooling the body for action
                    </span>
                  </li>
                </ul>
                <p className="text-sm text-white mt-3">
                  <strong>This is completely normal and adaptive.</strong> If you're facing a real
                  threat (fire, electrical hazard, falling object), this response could save your
                  life. The problem in anxiety disorders is that this response is triggered by
                  situations that aren't genuinely dangerous, or stays activated long after the
                  threat has passed. The body is constantly in 'threat mode', which is exhausting
                  and debilitating.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <p className="text-sm text-white">
                      Excessive, uncontrollable worry about many different things (work, health,
                      family, finances, etc.) lasting at least six months. The worry is difficult to
                      control, causes significant distress, and affects daily functioning. Physical
                      symptoms include restlessness, fatigue, difficulty concentrating,
                      irritability, muscle tension, and sleep disturbance. GAD is the 'constant,
                      free-floating anxiety about everything' disorder.
                    </p>
                  </div>
                  <div>
                    <p className="text-white font-medium text-sm mb-1">
                    ...
                    <p className="text-sm text-white">
                      Panic attacks are sudden episodes of intense fear with severe physical
                      symptoms: racing heart, chest pain, sweating, shaking, shortness of breath,
                      dizziness, nausea, feelings of unreality or detachment, and fear of dying or
                      losing control. They peak within minutes and are terrifying. Panic disorder is
                      when panic attacks become recurrent and you develop persistent fear of having
                      another attack (anticipatory anxiety). This can lead to avoidance of
                      situations where attacks have occurred. Important: panic attacks feel like
                      heart attacks — if someone is experiencing these symptoms for the first time,
                      seek medical assessment to rule out physical causes.
                    </p>
                  </div>
                  <div>
                    ...
                    <p className="text-sm text-white">
                      ...
                      humiliated. This goes beyond normal shyness — it's fear so severe that it
                      causes avoidance of social situations (meetings, toolbox talks, eating with
                      colleagues) and significantly affects work and relationships. Physical
                      symptoms include blushing, sweating, trembling, nausea, and difficulty
                      speaking.
                    </p>
                  </div>
                  <div>
                    ...
                    <p className="text-sm text-white">
                      ...
                      Constantly checking for symptoms, repeatedly visiting doctors, or conversely
                      avoiding medical appointments for fear of finding something wrong. The anxiety
                      about illness becomes a problem in itself.
                    </p>
                  </div>
                  <div>
                    <p className="text-white font-medium text-sm mb-1">Specific Phobias</p>
                    <p className="text-sm text-white">
                      Intense, irrational fear of a specific object or situation. In construction,
                      relevant phobias include: heights (acrophobia), confined spaces
                      (claustrophobia), electricity, blood/injury. The fear is disproportionate to
                      actual danger and causes significant avoidance or extreme distress. Treatment
              ...
              <p>
                Anxiety disorders are the most common mental health problems in the UK — affecting
                around 1 in 10 people at any time. They're highly treatable with Cognitive
                Behavioural Therapy (CBT), medication, or both. The problem is that many people
                don't seek help because they think anxiety is 'just part of life' or they're
                embarrassed. Understanding what anxiety disorders are helps people recognise when
                their anxiety has crossed the line from normal to clinical — and when treatment
                could help.
              </p>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Anxiety on a construction site can look different from textbook descriptions. People
                might not say 'I'm feeling anxious' — but their behaviour, physical symptoms, and
                work patterns reveal what's happening. Here's what to look for:
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-3">
                  <div>
                    <p className="text-white font-medium text-sm mb-1">
                      Excessive Worry About Tasks and Safety
                    </p>
                    <ul className="text-sm text-white space-y-1">
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                        <span>
                          Worrying excessively about routine tasks they've done hundreds of times
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                        <span>
                          Catastrophising: 'What if I get this wrong? What if something terrible
                          happens?'
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                        <span>
                          Persistent worry about things that might go wrong, even when precautions
                          are in place
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                        <span>
                          Unable to reassure themselves even when safety measures are explained
                        </span>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div>
                    <p className="text-white font-medium text-sm mb-1">
                      Avoidance of Certain Work or Situations
                    </p>
                    <ul className="text-sm text-white space-y-1">
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                        <span>
                          Avoiding tasks that trigger anxiety (heights, confined spaces, working
                          alone, public speaking at toolbox talks)
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                      ...
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                        <span>
                          Procrastination — putting off tasks because thinking about them causes
                          anxiety
                        </span>
                      </li>
                    </ul>
                    <p className="text-sm text-white mt-2">
                      Avoidance provides short-term relief but makes anxiety worse long-term. It
                      also limits what work someone can do, affecting their career.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="text-sm text-white space-y-1">
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                        <span>
                          Repeatedly asking supervisors or colleagues if they're doing something
                          right
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                      ...
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                        <span>
                          Unable to trust their own judgement — always needing external validation
                        </span>
                      </li>
                    </ul>
                  </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1.5">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Shaking or trembling</strong> — particularly in hands, making fine
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Sweating</strong> — disproportionate to temperature or exertion
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Looking pale or flushed</strong>
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Rapid breathing or hyperventilation</strong>
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Nausea or stomach problems</strong> — frequent trips to toilet,
                      feeling sick
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Tense muscles, particularly neck, shoulders, jaw</strong>
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Rapid heartbeat</strong> — might mention chest tightness or heart
                      racing
                    </span>
                  </li>
                </ul>
                <p className="text-sm text-white mt-3">
                  These physical symptoms are genuinely distressing. Someone experiencing them isn't
                  being 'dramatic' — their body is in fight-flight mode even though there's no
                  immediate physical danger. If someone mentions chest pain or difficulty breathing,
                  always take it seriously — it could be anxiety, but it could also be a medical
                  emergency. When in doubt, seek medical assessment.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1.5">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Difficulty concentrating</strong> — mind is consumed by worry, can't
                      focus on tasks
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Perfectionism and slowness</strong> — taking much longer because of
                      excessive checking and fear of mistakes
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Increased errors</strong> — paradoxically, anxiety about making
                      mistakes leads to more mistakes due to impaired concentration
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Procrastination</strong> — avoiding starting tasks because thinking
                      about them causes anxiety
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Absenteeism</strong> — calling in sick when anxiety becomes
                      overwhelming, especially for tasks that trigger anxiety
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white mb-2">
                  If someone has a panic attack on site, it's terrifying for them and alarming to
                  witness. Signs include:
                </p>
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                ...
                <p className="text-sm text-white mt-3">
                  <strong>What to do:</strong> (1) Stay calm and reassuring, (2) Move them somewhere
                  safe and quiet if possible, (3) Encourage slow, deep breathing, (4) Reassure them
                  it will pass (panic attacks peak in 10 minutes), (5) Don't leave them alone, (6)
                  If it's their first time or symptoms are severe, seek medical assessment — chest
                  pain and breathing difficulty need to be checked. Once the attack passes, suggest
                  they see their GP — panic attacks are treatable.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-amber-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                You're not expected to diagnose depression or anxiety — that's the job of doctors
                and mental health professionals. However, it's useful to know about the tools that
                GPs use to assess symptoms. This helps demystify the process and can make it easier
                to encourage someone to seek help.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white mb-3">
                  The PHQ-9 is a validated questionnaire used to screen for and assess the severity
                  of depression. It asks 9 questions about symptoms experienced over the past two
                  weeks:
                </p>
                <div className="bg-white/5 border border-white/10 p-3 rounded-lg mb-3">
                  ...
                  <ul className="text-sm text-white space-y-1">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                      <span>
                        Moving or speaking so slowly that others have noticed, or being so fidgety
                        or restless that you've been moving around more than usual
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white mb-3">
                  The GAD-7 is a validated questionnaire used to screen for and assess the severity
                  of generalised anxiety disorder. It asks 7 questions about symptoms over the past
                  two weeks:
                </p>
                <div className="bg-white/5 border border-white/10 p-3 rounded-lg mb-3">
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white mb-2">
                  You're not using these tools to diagnose colleagues. But knowing they exist is
                  valuable because:
                </p>
                <ul className="text-sm text-white space-y-1.5">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>It demystifies the GP visit:</strong> You can reassure someone that
                      'the doctor will ask you some questions to understand how you've been feeling
                      — it's just to work out how best to help you'. This makes seeking help less
                      scary.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>It shows that mental health can be measured:</strong> Depression and
                      anxiety aren't just vague feelings — they're measurable conditions with
                      validated assessment tools. This helps counter stigma.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>It helps you understand severity:</strong> Recognising that depression
                      and anxiety exist on a spectrum (mild to severe) helps you understand that not
                      all cases look the same.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>It reinforces that you're not diagnosing:</strong> These are
                      professional tools. Your role is to notice, check in, listen, and signpost —
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-green-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                You now understand depression and anxiety as clinical conditions, how they manifest
                in construction workers (particularly men), and the tools used to assess them. Key
                points:
              </p>
              ...
              <ul className="text-sm text-white space-y-2">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong>Depression is a medical condition</strong> affecting brain chemistry,
                    not just sadness. It's characterised by persistent low mood, loss of interest,
                    and significant impairment lasting at least two weeks.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong>Men often express depression differently</strong> — as anger,
                    irritability, aggression, and risk-taking rather than 'classic' sadness.
                    Recognising this is crucial in construction.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong>Signs of depression on site</strong> include withdrawal, loss of
                    interest in work, increased absence, fatigue, irritability, changes in
                    appearance, and comments about hopelessness.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong>Anxiety disorders involve excessive, persistent worry</strong> that's
                    disproportionate to actual threat and significantly impairs functioning. Normal
                    anxiety is proportionate and time-limited.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong>The fight-flight-freeze response</strong> explains why anxiety causes
                    intense physical symptoms. This is the body's normal threat response — in
                    anxiety disorders, it's triggered inappropriately.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong>Signs of anxiety on site</strong> include excessive worry, avoidance,
                    constant reassurance-seeking, physical symptoms (shaking, sweating, nausea),
                    difficulty concentrating, and inability to relax.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong>PHQ-9 and GAD-7</strong> are validated questionnaires that GPs use to
                    assess severity of depression and anxiety. Knowing these exist helps demystify
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-rose-400">Next:</strong> In Section 4 (the final section
                  of Module 2), we'll address the most difficult topic: crisis situations, suicidal
                  thoughts, and self-harm. This section will teach you how to recognise warning
                  signs of suicidal intent, what to do if you're concerned, and how to respond with
                  compassion and confidence. This could genuinely save a life.
                </p>
              </div>
            </div>
          </div>
