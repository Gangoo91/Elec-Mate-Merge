                ...
                <div className="p-4">
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                    ...
                    <div className="bg-gradient-to-br from-red-500/10 to-red-500/5 border border-red-500/20 rounded-xl p-4 text-center">
                      ...
                      <p className="text-xs text-white">Workload, work patterns, work environment</p>
                    </div>
                    {/* Standard 2: Control */}
                    <div className="bg-gradient-to-br from-amber-500/10 to-amber-500/5 border border-amber-500/20 rounded-xl p-4 text-center">
                      ...
                      <p className="text-xs text-white">How much say a person has in the way they work</p>
                    </div>
                    {/* Standard 3: Support */}
                    <div className="bg-gradient-to-br from-green-500/10 to-green-500/5 border border-green-500/20 rounded-xl p-4 text-center">
                      ...
                      <p className="text-xs text-white">Encouragement, resources and sponsorship from the organisation</p>
                    </div>
                    ...
                    <div className="bg-gradient-to-br from-blue-500/10 to-blue-500/5 border border-blue-500/20 rounded-xl p-4 text-center">
                      ...
                      <p className="text-xs text-white">Positive working to avoid conflict and bullying</p>
                    </div>
                    {/* Standard 5: Role */}
                    <div className="bg-gradient-to-br from-violet-500/10 to-violet-500/5 border border-violet-500/20 rounded-xl p-4 text-center">
                      ...
                      <p className="text-xs text-white">Understanding of role and no conflicting responsibilities</p>
                    </div>
                    {/* Standard 6: Change */}
                    <div className="bg-gradient-to-br from-purple-500/10 to-purple-500/5 border border-purple-500/20 rounded-xl p-4 text-center">
                      ...
                      <p className="text-xs text-white">How organisational change is managed and communicated</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 rounded-lg overflow-hidden">
                ...
                <div className="p-4 border-b border-white/5">
                  ...
                  <div className="grid md:grid-cols-2 gap-3">
                    <div className="bg-green-500/5 border border-green-500/15 rounded-lg p-3">
                      ...
                      <p className="text-xs text-white">Realistic deadlines, workload matched to capability, adequate staffing levels, achievable targets</p>
                    </div>
                    <div className="bg-red-500/5 border border-red-500/15 rounded-lg p-3">
                      <p className="text-xs font-medium text-red-400 mb-1">Poor Practice</p>
                      <p className="text-xs text-white">Excessive hours, unrealistic deadlines, constant time pressure, inability to take breaks, understaffing</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-4 border-b border-white/5">
                  ...
                  <div className="grid md:grid-cols-2 gap-3">
                    <div className="bg-green-500/5 border border-green-500/15 rounded-lg p-3">
                      <p className="text-xs font-medium text-green-400 mb-1">Good Practice</p>
                      <p className="text-xs text-white">Workers have input on how they do their work, can take breaks when needed, have some say over shift patterns</p>
                    </div>
                    <div className="bg-red-500/5 border border-red-500/15 rounded-lg p-3">
                      <p className="text-xs font-medium text-red-400 mb-1">Poor Practice</p>
                      <p className="text-xs text-white">Micromanagement, no flexibility, rigid schedules with no input, no autonomy over work methods</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-4 border-b border-white/5">
                  ...
                  <div className="grid md:grid-cols-2 gap-3">
                    <div className="bg-green-500/5 border border-green-500/15 rounded-lg p-3">
                      <p className="text-xs font-medium text-green-400 mb-1">Good Practice</p>
                      <p className="text-xs text-white">Line managers trained to have supportive conversations, EAP available, peer support, regular check-ins</p>
                    </div>
                    <div className="bg-red-500/5 border border-red-500/15 rounded-lg p-3">
                      <p className="text-xs font-medium text-red-400 mb-1">Poor Practice</p>
                      <p className="text-xs text-white">No support systems, &ldquo;just get on with it&rdquo; culture, no access to occupational health, workers feel they cannot ask for help</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-4 border-b border-white/5">
                  ...
                  <div className="grid md:grid-cols-2 gap-3">
                    <div className="bg-green-500/5 border border-green-500/15 rounded-lg p-3">
                      <p className="text-xs font-medium text-green-400 mb-1">Good Practice</p>
                      <p className="text-xs text-white">Clear anti-bullying policies, positive workplace culture, effective conflict resolution, mutual respect</p>
                    </div>
                    <div className="bg-red-500/5 border border-red-500/15 rounded-lg p-3">
                      <p className="text-xs font-medium text-red-400 mb-1">Poor Practice</p>
                      <p className="text-xs text-white">Tolerated bullying, &ldquo;banter&rdquo; that is actually harassment, unresolved conflicts, intimidation, isolation of workers</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-4 border-b border-white/5">
                  ...
                  <div className="grid md:grid-cols-2 gap-3">
                    <div className="bg-green-500/5 border border-green-500/15 rounded-lg p-3">
                      <p className="text-xs font-medium text-green-400 mb-1">Good Practice</p>
                      <p className="text-xs text-white">Clear job descriptions, workers understand their responsibilities, no conflicting instructions from different managers</p>
                    </div>
                    <div className="bg-red-500/5 border border-red-500/15 rounded-lg p-3">
                      <p className="text-xs font-medium text-red-400 mb-1">Poor Practice</p>
                      <p className="text-xs text-white">Vague responsibilities, conflicting demands from multiple supervisors, asked to do tasks outside competence without training</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-4">
                  ...
                  <div className="grid md:grid-cols-2 gap-3">
                    <div className="bg-green-500/5 border border-green-500/15 rounded-lg p-3">
                      <p className="text-xs font-medium text-green-400 mb-1">Good Practice</p>
                      <p className="text-xs text-white">Changes communicated clearly and in advance, workers consulted, adequate time to adjust, support during transitions</p>
                    </div>
                    <div className="bg-red-500/5 border border-red-500/15 rounded-lg p-3">
                      <p className="text-xs font-medium text-red-400 mb-1">Poor Practice</p>
                      <p className="text-xs text-white">Sudden changes with no warning, no consultation, constant restructuring, job insecurity with no communication</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                ...
                <p className="text-xs text-white mb-3">These standards are recommended for every employer, regardless of size or sector:</p>
                <div className="space-y-2">
                  {[
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                ...
                <p className="text-xs text-white mb-3">In addition to the 6 core standards, larger organisations should also:</p>
                <div className="space-y-2">
                  {[
