        ...
        <div className="max-w-3xl mx-auto">
          <div className="mb-8">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-green-500/10 border border-green-500/20 mb-3">
              <span className="text-green-400 text-xs font-semibold">MODULE 6</span>
          ...
          <Card className="border-green-500/20 bg-white/[0.02] mb-6">
            <CardContent className="p-5 sm:p-6">
              ...
              <div className="space-y-3">
                {examFeatures.map((feature) => (
                  ...
                  >
                    <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-green-500/10 flex-shrink-0 mt-0.5">
          ...
          <div className="mb-8">
            <Button
              asChild
              size="lg"
              className="w-full bg-green-500 hover:bg-green-500/90 text-white font-bold py-4 text-base min-h-[52px] rounded-xl touch-manipulation active:scale-[0.98] shadow-lg shadow-green-500/20"
            >
              <Link to="../cscs-card-mock-exam">
              ...
              <div className="space-y-4">
                {preparationTips.map((tip, index) => (
                  <div key={index} className="flex items-start gap-3">
                    <div className="flex h-6 w-6 items-center justify-center rounded-full bg-green-500/10 border border-green-500/20 flex-shrink-0 mt-0.5">
                      <span className="text-[10px] font-bold text-green-400">{index + 1}</span>
                    </div>
                    <div className="min-w-0">
