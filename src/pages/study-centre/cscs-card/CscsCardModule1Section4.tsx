...
const quickCheckQuestions = [
  {
    ...
    question: 'What is the correct way to book the CITB HS&E test?',
    options: [
...
const quizQuestions = [
  ...
  {
    id: 2,
    question: 'How many forms of ID must you bring to the HS&E test, and what is required?',
    options: [
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-green-500/5 border-l-2 border-green-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Book:</strong> CITB website or phone &mdash; Pearson VUE centres
              </li>
              <li>
                <strong>Cost:</strong> ~&pound;21 + VAT (test) &mdash; ~&pound;36 (card)
              </li>
              <li>
                <strong>ID:</strong> Two forms, one must be photo ID
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-green-500/5 border-l-2 border-green-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Arrive:</strong> 15 minutes early minimum
              </li>
              <li>
                <strong>Format:</strong> 50 questions in 45 minutes
              </li>
              <li>
                <strong>After:</strong> Result valid for 2 years
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The HS&amp;E test is booked through the <strong>CITB website</strong> or{' '}
                <strong>by phone</strong>. Tests are available at{' '}
                <strong>Pearson VUE centres</strong> throughout the UK, giving you a wide choice of
                location regardless of where you live or work. The cost is approximately
                <strong> &pound;21 + VAT</strong> for Operatives and Specialists, or{' '}
                <strong>&pound;21 + VAT</strong> for Managers.
              </p>

              <p>
                You choose your <strong>preferred date, time, and test centre</strong> when booking.
                Bookings can be made up to <strong>a year in advance</strong>, which is useful if
                you want to secure a specific date at a popular centre. Same-day or next-day slots
                may be available depending on demand, so last-minute bookings are sometimes possible
                if you need to sit the test urgently.
              </p>
              ...
              <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  before your test without charge. If you cancel with less notice, you will forfeit
                  your booking fee and need to pay again to rebook. Always allow enough buffer when
                  booking in case of unexpected changes to your schedule.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Book through <strong className="text-white">CITB website or by phone</strong>
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      Tests held at <strong className="text-white">Pearson VUE centres</strong>{' '}
                      across the UK
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      Cost: approximately <strong className="text-white">&pound;21 + VAT</strong>
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      Book up to <strong className="text-white">1 year in advance</strong>
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      ...
                      <strong className="text-white">3+ clear working days</strong> before without
                      charge
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Preparation for test day starts with making sure you have the right documents.
                Without the correct identification, you will{' '}
                <strong>not be allowed to sit the test</strong> and will lose your booking fee. The
                rules are strict and consistently enforced at all Pearson VUE centres.
              </p>
              ...
              <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  match the name used when booking the test. Expired ID will not be accepted.
                </p>
              </div>

              <p>
                Arrive at the test centre at least <strong>15 minutes early</strong>. This allows
                time for the sign-in process, ID verification, and familiarisation with the test
                environment. If you arrive late, the centre may refuse entry.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">No personal items</strong> allowed in the test
                      room &mdash; bags, phones, watches, and notes are stored in a locker
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">No food or drink</strong> in the test room
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      You may receive a{' '}
                      <strong className="text-white">wipeable board and marker</strong> for notes
                      during the test
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      The test centre provides{' '}
                      <strong className="text-white">everything else</strong> you need &mdash; the
                      computer, headphones (for video questions), and instructions
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      Talking, looking at other screens, or communicating with other candidates is{' '}
                      <strong className="text-white">not permitted</strong>
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Preparing for the HS&amp;E test does not require months of study, but it does
                require
                <strong> structured, focused preparation</strong>. The test is designed to be
                passable with adequate study, and the vast majority of candidates who prepare
                properly pass on their first attempt.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      Use the <strong className="text-white">official CITB publications</strong>{' '}
                      &mdash; the &ldquo;yellow book&rdquo; (GE700 Health, Safety and Environment
                      Information) is the primary study resource
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      Take <strong className="text-white">practice tests</strong> regularly &mdash;
                      the CITB app and official online practice tests replicate the real test format
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      Study in{' '}
                      <strong className="text-white">
                        short focused sessions (30&ndash;45 minutes)
                      </strong>{' '}
                      rather than long cramming sessions &mdash; retention is far better with
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Focus on{' '}
                      <strong className="text-white">
                        understanding concepts, not memorising answers
                      </strong>{' '}
                      &mdash; the question bank changes regularly, so rote memorisation is
                      unreliable
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      <strong className="text-white">behavioural case studies</strong> &mdash; these
                      questions require judgement and cannot be answered by memorising facts alone
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Study with a friend or colleague</strong> to
                      discuss scenarios &mdash; talking through situations helps build deeper
                      understanding
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      Use this <strong className="text-white">Elec-Mate course</strong> to cover all
                      the key topics in a structured, comprehensive way
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  study questions. The behavioural questions test your{' '}
                  <strong className="text-white">judgement in real workplace scenarios</strong> and
                  require genuine understanding, not memorisation.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Based on analysis of the HS&amp;E test, certain topic areas carry significantly more
                weight than others. While you should study all topics, focusing your revision on
                these high-priority areas will give you the best chance of passing.
              </p>
              ...
              <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Health and Safety at Work Act 1974</strong>{' '}
                      (HASAWA) &mdash; the foundational UK health and safety law
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      ...
                      (CDM) &mdash; duties for all construction project participants
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      ...
                      (COSHH) &mdash; managing chemical and biological hazards
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      ...
                      &mdash; preventing falls from height
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      ...
                      &mdash; safe lifting and carrying
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      ...
                      &mdash; electrical safety in the workplace
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  one is the
                  <strong className="text-white"> MOST appropriate</strong> response. These
                  questions test whether you would prioritise safety, follow correct procedures, and
                  take the right action in the right order. Always think: &ldquo;What would a
                  competent, safety-conscious worker do?&rdquo;
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Practice tests are one of the most effective preparation tools available. They
                familiarise you with the test format, help you identify knowledge gaps, and build
                confidence. However, they must be used <strong>correctly</strong> to be truly
                effective.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      Take the <strong className="text-white">official CITB practice tests</strong>{' '}
                      before booking your real test &mdash; these most closely match the actual exam
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Track which topics you get wrong</strong> and
                      focus your revision on those areas specifically
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      Practice under <strong className="text-white">timed conditions</strong> to
                      build comfort with the 45-minute time limit
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      Aim for <strong className="text-white">consistently scoring above 90%</strong>{' '}
                      on practice tests before booking the real exam
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      Use the{' '}
                      <strong className="text-white">
                        &ldquo;flag and review&rdquo; technique
                      </strong>{' '}
                      &mdash; flag any question you are uncertain about and review them at the end
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  include questions you have not seen in practice, and test-day nerves can affect
                  performance. A 90%+ practice score means you have genuine understanding of the
                  material, not just familiarity with specific practice questions.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">CITB HS&amp;E test app</strong> &mdash;
                      official mobile app with practice questions
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">CITB online practice tests</strong> &mdash;
                      web-based tests that replicate the real format
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">GE700 revision questions</strong> &mdash;
                      end-of-chapter questions in the yellow book
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Elec-Mate section quizzes</strong> &mdash;
                      topic-by-topic knowledge checks throughout this course
                    </span>
                  </li>
                </ul>
              </div>
          ...
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                practical tips will help you perform at your best and avoid common mistakes that
                cost marks.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      Read each question carefully &mdash; look for keywords like{' '}
                      <strong className="text-white">&ldquo;MOST appropriate&rdquo;</strong>,{' '}
                      <strong className="text-white">&ldquo;FIRST thing&rdquo;</strong>,{' '}
                      <strong className="text-white">&ldquo;ALWAYS&rdquo;</strong>, and{' '}
                      <strong className="text-white">&ldquo;NEVER&rdquo;</strong>
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      These qualifier words change the meaning entirely &mdash; several answers
                      might be acceptable, but only one is the{' '}
                      <strong className="text-white">most correct</strong>
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      For behavioural questions, think about what a{' '}
                      <strong className="text-white">competent, safety-conscious worker</strong>{' '}
                      would do in that exact situation
                    </span>
                  </li>
                </ul>
              </div>
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      to improve your odds &mdash; even removing one option significantly increases
                      your chances
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Don&rsquo;t change answers</strong> unless you
                      have a clear reason &mdash; your first instinct is usually right
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      Use the <strong className="text-white">flag feature</strong> for questions you
                      want to revisit &mdash; don&rsquo;t get stuck on any single question
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      Always <strong className="text-white">select an answer</strong> before
                      flagging and moving on &mdash; you may run out of time to come back
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  find they have time to spare, but if you get stuck on a question, flag it and move
                  on. It is far better to answer all 50 questions and come back to flagged ones than
                  to run out of time with unanswered questions.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      The test is <strong className="text-white">designed to be passable</strong>{' '}
                      with adequate preparation &mdash; it is not meant to trick you
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      If you have prepared well and scored above 90% on practice tests, you are{' '}
                      <strong className="text-white">well positioned to pass</strong>
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      Take a deep breath before starting &mdash; a calm, focused approach produces
                  ...
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      Remember that you do <strong className="text-white">not need 100%</strong> to
                      pass &mdash; you are allowed to get some questions wrong
                    </span>
                  </li>
                </ul>
              </div>
            ...
            <div className="text-white space-y-4 leading-relaxed">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      <strong className="text-white">2 clear working days</strong> before re-sitting
                      the test
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      Identify which areas you scored poorly on &mdash; the{' '}
                      <strong className="text-white">results screen shows broad categories</strong>{' '}
                      of performance
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      Spend focused time revising those{' '}
                      <strong className="text-white">specific topics</strong> rather than
                      re-studying everything
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      ...
                      <strong className="text-white">
                        different study materials or approaches
                      </strong>{' '}
                      &mdash; if your current method didn&rsquo;t work, change it
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Re-sit fees apply</strong> at the same rate as
                      the original test (~&pound;21 + VAT)
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  support before their first attempt. These courses cover all key topics in a
                  structured classroom environment with an instructor who can answer questions and
                  explain difficult concepts. They typically cost between &pound;100 and &pound;200.
                </p>
              </div>
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Insufficient preparation &mdash; underestimating the test difficulty
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-amber-400" />
                  ...
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-amber-400" />
                    <span>
                      Language barriers &mdash; if English is not your first language, additional
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Once you pass the HS&amp;E test, your result is stored on the{' '}
                <strong>CITB system for 2 years</strong>. You must apply for your CSCS card within
                this 2-year window. If you do not apply in time, your test result expires and you
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">HS&amp;E test pass</strong> &mdash; linked to
                      your name and date of birth on the CITB system
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Proof of relevant qualification</strong>{' '}
                      &mdash; NVQ, SVQ, or equivalent registered on the Construction Training
                      Register (CTR)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Valid photo ID</strong> &mdash; passport,
                      driving licence, or equivalent
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Passport-style photograph</strong> &mdash;
                      digital photo meeting CSCS specification
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Payment</strong> &mdash; approximately
                      &pound;36 including VAT
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  <strong className="text-white">registered address</strong>. If you need a card
                  urgently for site access, check whether a digital card or temporary confirmation
                  of application is available through the CSCS system.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      HS&amp;E test result valid for <strong className="text-white">2 years</strong>{' '}
                      &mdash; apply within this window
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      Card processing takes approximately{' '}
                      <strong className="text-white">10 working days</strong>
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      Most CSCS cards are valid for <strong className="text-white">5 years</strong>{' '}
                      from issue
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      You must <strong className="text-white">renew before expiry</strong> to
                      maintain site access &mdash; renewal requires a new HS&amp;E test pass
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 sm:p-6 rounded-lg">
                <p className="text-sm font-medium text-green-400 mb-4 text-center">
                  Suggested Study Plan &mdash; 4 Weeks to Test Day
                </p>
                  ...
                  <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-4">
                    ...
                    <ul className="text-xs text-white/80 space-y-1.5 ml-10">
                      ...
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                        <span>
                          Light revision only on test eve &mdash; get a good night&rsquo;s sleep
                        </span>
                      </li>
                    </ul>
                  </div>
              ...
              <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  with your photograph. Starting the application promptly gives you time to resolve
                  any issues without risking your test result expiring.
                </p>
              </div>
            </div>
          </div>
