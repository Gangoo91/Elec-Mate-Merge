...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    question:
      'What is the daily exposure action value (EAV) for hand-arm vibration under the Control of Vibration at Work Regulations 2005?',
...
const faqs = [
  ...
  {
    question:
      'What is the difference between Hand-Arm Vibration Syndrome (HAVS) and Whole-Body Vibration (WBV)?',
    answer:
...
const quizQuestions = [
  ...
  {
    id: 6,
    question: 'Which hierarchy of control should be applied first when reducing noise exposure?',
    options: [
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-green-500/5 border-l-2 border-green-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>80 dB(A):</strong> Lower action value &mdash; assess, inform, make PPE
                available
              </li>
              <li>
                <strong>85 dB(A):</strong> Upper action value &mdash; PPE mandatory, hearing zones
              </li>
              <li>
                <strong>HAV EAV:</strong> 2.5 m/s&sup2; A(8) &mdash; action required
              </li>
              <li>
                <strong>NIHL is permanent</strong> &mdash; prevention is the only cure
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-green-500/5 border-l-2 border-green-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Noise Regulations 2005:</strong> Control of Noise at Work
              </li>
              <li>
                <strong>Vibration Regulations 2005:</strong> Control of Vibration at Work
              </li>
              <li>
                <strong>MHSW 1999:</strong> Management of Health &amp; Safety at Work
              </li>
              <li>
                <strong>PPE Regulations 2022:</strong> Provision of hearing protection
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6">
            <h2 className="text-lg sm:text-xl font-bold text-white flex items-center gap-3 mb-4">
              <span className="flex items-center justify-center w-8 h-8 rounded-lg bg-green-500/10 text-green-400 text-sm font-bold border border-green-500/20">
                01
              </span>
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Construction is one of the noisiest industries in the United Kingdom. Workers are
                routinely exposed to hazardous noise levels from a wide variety of tools, equipment,
                and processes. <strong>Noise-induced hearing loss (NIHL)</strong> is the most common
                occupational disease in the UK construction sector, and it is entirely preventable.
                The critical point to understand is that once hearing is lost through noise
                exposure, <strong>it is permanent and irreversible</strong> &mdash; there is no
                medical treatment, surgery, or hearing aid that can restore it.
              </p>
              ...
              <ul className="space-y-2 text-sm text-white">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong>Angle grinders</strong> &mdash; typically produce 95&ndash;105 dB(A)
                    depending on the disc type and material being cut. Cutting and grinding metal
                    generates particularly high noise levels due to the friction and impact between
                    the abrasive disc and the workpiece
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                  <span>
                    <strong>Hammer drills and rotary percussion drills</strong> &mdash; produce
                    95&ndash;110 dB(A). The percussive action generates impulsive noise that is
                    particularly damaging to hearing because the ear does not have time to activate
                    its protective reflex between impacts
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                  <span>
                    <strong>Concrete saws and disc cutters</strong> &mdash; produce 100&ndash;115
                    dB(A). These are among the loudest tools commonly used on construction sites,
                    and even brief exposure without hearing protection can cause immediate,
                    permanent damage
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                  <span>
                    <strong>Generators and compressors</strong> &mdash; produce 85&ndash;100 dB(A).
                    Although individual units may not seem extremely loud, they often run
                    continuously throughout the working day, creating a high cumulative dose of
                    noise exposure
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                  <span>
                    <strong>Pile drivers</strong> &mdash; produce 100&ndash;120 dB(A) or more.
                    Impact piling generates extremely high peak noise levels that can cause
                    immediate acoustic trauma. Pile-driving operations typically require extensive
                    noise control measures and exclusion zones
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                  <span>
                    <strong>Other common sources:</strong> chop saws, nail guns, pneumatic drills,
                    circular saws, demolition activities, and even raised voices in an already noisy
                    environment. Noise from multiple sources combines to create overall levels that
                    may be significantly higher than any single source
                  </span>
                </li>
              </ul>

              <p>
                <strong>How noise damages hearing:</strong> Sound waves enter the ear canal and
                cause the eardrum (tympanic membrane) to vibrate. These vibrations are transmitted
                through the three small bones of the middle ear (the ossicles) to the cochlea in the
                inner ear. The cochlea is a fluid-filled, snail-shaped structure lined with
                thousands of tiny <strong>hair cells</strong>. These hair cells convert the
                mechanical vibrations into electrical signals that travel along the auditory nerve
                to the brain. Excessive noise exposure damages and destroys these hair cells. Unlike
                many cells in the body, the hair cells of the human cochlea{' '}
                <strong>do not regenerate</strong>. Once destroyed, they are gone permanently. The
                damage is cumulative &mdash; each episode of excessive exposure adds to the total
                damage already sustained, gradually eroding the worker&rsquo;s ability to hear.
              </p>
              ...
              <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                <div className="flex items-start gap-2">
                  ...
                  <p className="text-sm text-white">
                    <strong className="text-green-400">Key Fact:</strong> Noise-induced hearing loss
                    typically develops gradually over months and years of exposure, which means
                    workers often do not notice the damage until it is severe. Early signs include
                    difficulty hearing conversations in noisy environments, needing to turn up the
                    television volume, and <strong>tinnitus</strong> (persistent ringing, buzzing,
                    or hissing in the ears). Tinnitus can be debilitating, affecting sleep,
                    concentration, and mental health. Like NIHL itself, tinnitus caused by noise
                    exposure is usually permanent.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The <strong>Control of Noise at Work Regulations 2005</strong> implement EU Physical
                Agents (Noise) Directive 2003/10/EC into UK law. They place duties on employers to
                protect workers from the risks of noise exposure in the workplace. The regulations
                establish <strong>three action levels</strong> based on daily or weekly average
                noise exposure and peak sound pressure, each triggering specific duties on the
                employer.
              </p>

              <p>The three action levels are:</p>
              ...
              <div className="bg-gradient-to-br from-green-500/10 to-green-400/5 border border-green-500/20 rounded-xl p-4 sm:p-6">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <p className="text-sm font-medium text-green-400">
                    Noise Action Levels &amp; Employer Duties
                  </p>
                </div>
                  ...
                  <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-4">
                    ...
                    <ul className="space-y-1 text-xs text-white">
                      ...
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-red-400" />
                        <span>
                          If exceeded, take immediate action to reduce exposure below the limit
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-red-400" />
              ...
              <p>
                Employers have a general duty under the regulations to reduce noise exposure to the{' '}
                <strong>lowest level reasonably practicable</strong>, regardless of whether the
                action values are reached. The regulations also require employers to ensure that any
                personal hearing protectors provided are properly used, maintained, and stored, and
                that workers receive adequate information, instruction, and training on the risks of
                noise exposure and the control measures in place.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                A <strong>noise assessment</strong> must be carried out by a competent person
                whenever workers are likely to be exposed at or above the lower exposure action
                value of 80 dB(A). On construction sites, this threshold is exceeded in the vast
                majority of work activities involving power tools, plant, or machinery. The noise
                assessment should identify who is at risk, what the noise sources are, what the
                exposure levels are, and what control measures are needed.
              </p>

              <p>
                The assessment is typically carried out using{' '}
                <strong>calibrated sound level meters</strong> (to measure area noise levels) and{' '}
                <strong>personal noise dosimeters</strong> (small devices worn by the worker
                throughout the day to measure individual cumulative exposure). The results are used
                to determine whether action values are being reached and to prioritise control
                measures.
              </p>

              <p>
                <strong>The hierarchy of noise controls</strong> must be applied in the following
                order. The employer must always consider higher-level controls before resorting to
                lower-level ones:
              </p>
              ...
              <ul className="space-y-2 text-sm text-white">
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                  <span>
                    <strong>Eliminate</strong> &mdash; remove the noise source entirely. For
                    example, use pre-fabricated components instead of cutting and grinding on site,
                    or use bolted connections instead of impact fixing. Elimination is always the
                    most effective control because it removes the hazard completely
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                  <span>
                    <strong>Substitute</strong> &mdash; replace the noisy tool or process with a
                    quieter alternative. For example, use electric tools instead of pneumatic tools
                    (which are typically louder), use diamond wire cutting instead of disc cutting,
                    or use hydraulic breakers instead of pneumatic breakers. Always check the
                    manufacturer&rsquo;s noise data when selecting equipment
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                  <span>
                    <strong>Engineering controls</strong> &mdash; use physical measures to reduce
                    noise at source or along the transmission path. Examples include acoustic
                    enclosures around noisy machinery, noise barriers between the source and
                    workers, vibration-damping mounts to reduce structure-borne noise, and silencers
                    on exhaust systems. Moving noisy equipment further away from workers (increasing
                    the distance) also reduces exposure, as sound intensity decreases with the
                ...
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                  <span>
                    <strong>Administrative controls</strong> &mdash; organise work to reduce
                    exposure. Examples include limiting the time each worker spends on noisy tasks,
                    rotating workers between noisy and quiet jobs, scheduling noisy activities when
                    fewer people are nearby, and ensuring regular maintenance of tools and equipment
                    (poorly maintained tools often generate more noise)
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                  <span>
                    <strong>Personal hearing protection</strong> &mdash; the last resort in the
                    hierarchy. Hearing protection (ear plugs, ear defenders) should only be relied
                    upon when the above measures have been implemented and exposure still reaches
                    the action values. Hearing protection must be suitable for the noise levels,
                    correctly fitted, and consistently worn. It is never an acceptable substitute
                    for proper noise control at source
                  </span>
                </li>
              </ul>
              ...
              <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-green-400">Noise Assessment Records:</strong> The noise
                  assessment must be recorded and kept as part of the overall risk assessment
                  documentation. It should be reviewed regularly and updated whenever there are
                  significant changes to work practices, equipment, or the workplace environment. On
                  construction sites, the assessment may need to be updated as different phases of
                  the project introduce different noise sources.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                When noise exposure cannot be adequately controlled through elimination,
                substitution, engineering, or administrative measures,{' '}
                <strong>personal hearing protection</strong> must be provided. There are two main
                types of hearing protection used on construction sites, each with advantages and
                limitations.
              </p>
              ...
              <p>
                <strong>Selecting correct hearing protection using the SNR:</strong> The{' '}
                <strong>Single Number Rating (SNR)</strong> is a measure of the average noise
                attenuation (reduction) provided by a hearing protector, expressed in decibels. To
                estimate the noise level at the ear when wearing hearing protection, use the
                HSE&rsquo;s &ldquo;SNR minus 4 dB&rdquo; method: subtract the SNR from the ambient
                noise level and add 4 dB to account for real-world performance. For example, in a
                100 dB(A) environment with an SNR 25 protector: 100 &minus; 25 + 4 = 79 dB(A) at the
                ear.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  hazard in itself. The aim is to reduce the noise at the ear to between 70 and 80
                  dB(A) &mdash; below the lower action value but not so low that situational
              ...
              <ul className="space-y-2 text-sm text-white">
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                  <span>
                    <strong>Fitting:</strong> Foam ear plugs must be rolled into a tight cylinder
                    with clean hands, inserted into the ear canal, and held in place until they
                    expand to form a seal. Ear defenders must be adjusted so the headband provides
                    even pressure and the cushion seals fully around the ear with no gaps caused by
                    spectacles, hair, or PPE straps
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                  <span>
                    <strong>Maintenance:</strong> Reusable ear plugs must be washed regularly and
                    replaced when they lose their flexibility. Ear defender cushions degrade over
                    time (typically replaced every 6&ndash;12 months) and must be inspected
                    regularly for cracks, hardening, or loss of seal. Headbands lose tension with
                    age and should be replaced when they no longer hold the cups firmly
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                  <span>
                    <strong>Hearing protection zones:</strong> Areas where noise levels reach or
                    exceed the upper exposure action value of 85 dB(A) must be designated as hearing
                    protection zones. These zones must be marked with the mandatory hearing
                    protection sign (blue circle, white ear defenders symbol) and demarcated where
                    reasonably practicable.{' '}
                    <strong>
                      Everyone entering a hearing protection zone must wear hearing protection
                    </strong>{' '}
                    &mdash; this includes supervisors, visitors, and anyone passing through, not
                    just the workers generating the noise
                  </span>
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                <strong>Hand-arm vibration (HAV)</strong> is vibration transmitted from work
                processes into workers&rsquo; hands and arms. It is caused by the regular and
                frequent use of handheld vibrating tools, vibrating machinery held against a
                workpiece, or workpieces held against vibrating machinery. Prolonged exposure to HAV
                causes <strong>Hand-Arm Vibration Syndrome (HAVS)</strong>, a serious and disabling
                condition that affects the blood vessels, nerves, muscles, and joints of the hands,
              ...
              <ul className="space-y-2 text-sm text-white">
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                  <span>
                    <strong>Angle grinders and disc cutters</strong> &mdash; high vibration from the
                    spinning disc and impact with the material
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                  <span>
                    <strong>Hammer drills and rotary percussion drills</strong> &mdash; the
                    percussive action generates significant hand-arm vibration
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                  <span>
                    <strong>Concrete breakers and demolition hammers</strong> &mdash; among the
                    highest vibration tools on construction sites, capable of reaching the exposure
                    limit value in under 30 minutes of use
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                  <span>
                    <strong>Sanders and polishers</strong> &mdash; orbital and random-orbit sanders
                    produce continuous vibration during surface preparation work
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                  <span>
                    <strong>Chipping hammers, needle guns, and rivet busters</strong> &mdash; impact
                    tools that generate high levels of impulsive vibration
                  </span>
                </li>
              </ul>
              ...
              <ul className="space-y-2 text-sm text-white">
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                  <span>
                    <strong>Vascular symptoms (vibration white finger)</strong> &mdash; the fingers
                    turn white (blanch) when exposed to cold or damp conditions. The blanching
                    starts at the tips and works down towards the knuckle. The affected fingers feel
                    cold, numb, and painful. As blood flow returns, the fingers turn red, throb, and
                    tingle painfully. Episodes can last from minutes to hours and are triggered by
                    cold exposure
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                  <span>
                    <strong>Neurological symptoms</strong> &mdash; numbness and tingling
                    (paraesthesia) in the fingers, loss of sensation (particularly in the
                    fingertips), reduced ability to detect temperature or texture, and difficulty
                    with fine manipulative tasks such as picking up small objects, doing up buttons,
                    or handling coins
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                  <span>
                    <strong>Musculoskeletal symptoms</strong> &mdash; reduced grip strength, joint
                    pain and stiffness in the hands and wrists, muscle weakness, and difficulty
                    gripping tools or objects firmly. In advanced cases, this can significantly
                    impair the worker&rsquo;s ability to perform their job and carry out everyday
                    activities
                  </span>
                </li>
              </ul>
                  ...
                  <div className="bg-white/5 border border-white/10 rounded-lg p-4">
                    ...
                    <ul className="space-y-1 text-xs text-white">
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-yellow-400" />
                        <span>
                          Occasional tingling in fingertips, usually after using vibrating tools
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-yellow-400" />
                        <span>
                          Occasional blanching of one or two fingertips in cold conditions
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-yellow-400" />
                  ...
                  <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-4">
                    ...
                    <ul className="space-y-1 text-xs text-white">
                      ...
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-red-400" />
                        <span>
                          Severe loss of sensation &mdash; risk of burns and injuries unnoticed
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-red-400" />
                        <span>
                          Significant disability: unable to perform manual work, tissue damage
                          possible
                        </span>
                      </li>
                    </ul>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The <strong>Control of Vibration at Work Regulations 2005</strong> implement EU
                Physical Agents (Vibration) Directive 2002/44/EC into UK law. They establish
                exposure action values and exposure limit values for both hand-arm vibration (HAV)
                and whole-body vibration (WBV), and place duties on employers to assess, control,
                and monitor vibration exposure.
              </p>
              ...
              <p>
                <strong>
                  Employer duties when the exposure action value is reached or exceeded:
                </strong>
              </p>
              ...
              <ul className="space-y-2 text-sm text-white">
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                  <span>
                    <strong>Introduce a programme of measures</strong> to reduce vibration exposure
                    to as low a level as is reasonably practicable. This may include changing tools,
                    limiting exposure times, introducing job rotation, and improving tool
                    maintenance
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                  <span>
                    <strong>Provide information and training</strong> to workers on the health risks
                    of vibration exposure, the symptoms of HAVS, the exposure limits, the control
                    measures in place, and the importance of reporting symptoms early
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                  <span>
                    <strong>Place exposed workers under health surveillance</strong> &mdash; this is
                    a legal requirement when the EAV is reached. Health surveillance for HAVS
                    includes regular questionnaires and clinical assessments to detect early signs
                    of the condition
                  </span>
                </li>
              </ul>
              ...
              <p>
                <strong>
                  Employer duties when the exposure limit value is reached or exceeded:
                </strong>
              </p>
              ...
              <ul className="space-y-2 text-sm text-white">
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                  <span>
                    <strong>Take immediate action</strong> to reduce exposure below the limit value.
                    This may mean stopping the work activity, replacing the tool, or removing the
                    worker from the task
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                  <span>
                    <strong>Identify the reason</strong> for the limit being exceeded and take
                    measures to prevent it happening again. The risk assessment and control measures
              ...
              <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-green-400">General Duty:</strong> As with noise, employers
                  have a general duty to reduce vibration exposure to the lowest level reasonably
                  practicable, even if the action values are not reached. This is particularly
                  important because HAVS can develop at exposure levels below the EAV if exposure is
        ...
        <section className="mb-10">
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Reducing vibration risk requires a combination of technical, organisational, and
                individual measures. Unlike hearing protection for noise, there is{' '}
                <strong>no effective personal protective equipment for vibration</strong> &mdash;
                so-called &ldquo;anti-vibration gloves&rdquo; provide minimal reduction in the
                vibration frequencies most harmful to the hands. Effective control must focus on the
              ...
              <ul className="space-y-2 text-sm text-white">
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                  <span>
                    <strong>Select lower-vibration tools</strong> &mdash; when purchasing or hiring
                    tools, compare the vibration magnitudes declared by manufacturers. Choose tools
                    with the lowest vibration output that can still perform the task. Modern tools
                    are increasingly designed with vibration reduction in mind. For example, a
                    hydraulic concrete breaker typically produces less vibration than a pneumatic
                ...
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                  <span>
                    <strong>Use anti-vibration handles and damping systems</strong> &mdash; many
                    modern power tools are available with anti-vibration handles, spring-mounted
                    grips, or internal damping mechanisms that reduce the vibration transmitted to
                    the hands. Retrofitting anti-vibration handles to existing tools can also be
                    effective. Always ensure that the anti-vibration features are in good condition
                ...
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                  <span>
                    <strong>Limit exposure time</strong> &mdash; calculate the &ldquo;trigger
                    time&rdquo; for each tool: the maximum daily usage time before the EAV or ELV is
                    reached. For high-vibration tools such as concrete breakers, the trigger time
                    may be surprisingly short &mdash; as little as 15&ndash;30 minutes per day to
                    reach the EAV. Plan work schedules around these trigger times to prevent
                    overexposure
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                  <span>
                    <strong>Job rotation</strong> &mdash; rotate workers between vibration-intensive
                    tasks and non-vibrating tasks throughout the day. This spreads the exposure
                    across more workers rather than concentrating it on a few individuals. However,
                    job rotation must be properly planned &mdash; simply sharing the same tool
                    between workers does not reduce anyone&rsquo;s individual exposure unless each
                    person&rsquo;s total trigger time is managed
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                  <span>
                    <strong>Keep hands warm and dry</strong> &mdash; cold conditions constrict blood
                    vessels and significantly worsen the vascular symptoms of HAVS. Workers should
                    be provided with warm, waterproof gloves (not anti-vibration gloves, which offer
                    no meaningful protection), heated rest areas during breaks, and warm beverages.
                    Work involving vibrating tools should be minimised or avoided in very cold
                ...
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                  <span>
                    <strong>Regular tool maintenance</strong> &mdash; poorly maintained tools
                    generate significantly more vibration than well-maintained ones. Blunt cutting
                    edges, worn bearings, damaged damping mounts, and loose components all increase
                    vibration output. Establish a programme of regular maintenance, inspection, and
                    replacement of worn parts. Replace tools that can no longer be maintained to an
                    acceptable standard
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                  <span>
                    <strong>Use the HSE Vibration Calculator</strong> &mdash; the HSE provides a
                    free online <strong>Hand-Arm Vibration Exposure Calculator</strong> that allows
                    employers and workers to input tool vibration magnitudes and daily usage times
                    to calculate the eight-hour time-weighted average exposure A(8). This helps
                    determine whether action values are being reached and assists in planning
                    trigger times and job rotation schedules. The calculator is available on the HSE
                    website and is an invaluable tool for compliance
                  </span>
                </li>
              </ul>
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-white">
                      ...
                      the tool unnecessarily &mdash; tools should be balanced and supported by their
                      own handles, jigs, or counterbalance systems where possible. This is
                      particularly important for heavy tools such as concrete breakers and large
                      grinders.
                    </p>
                  </div>
                </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                <strong>Health surveillance</strong> is the systematic monitoring of workers&rsquo;
                health to detect early signs of work-related disease. For noise and vibration,
                health surveillance serves two critical purposes: it identifies individuals who are
                developing hearing loss or HAVS at an early stage (when intervention can prevent
                further damage), and it provides feedback on the effectiveness of the control
                measures in place. Health surveillance is a legal requirement under both the noise
                and vibration regulations when workers are exposed at or above the relevant action
                values.
              </p>
              ...
              <ul className="space-y-2 text-sm text-white">
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                  <span>
                    <strong>Audiometric testing (audiometry)</strong> is the primary form of health
                    surveillance for noise-exposed workers. It involves measuring the
                    individual&rsquo;s hearing threshold at various frequencies using an audiometer
                    &mdash; a device that plays tones at different pitches and volumes through
                    headphones, and the individual indicates when they can hear the tone. The
                ...
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                  <span>
                    <strong>Baseline audiogram:</strong> A baseline hearing test should be carried
                    out before or soon after the worker begins exposure to noise (ideally within the
                    first few weeks). This establishes the individual&rsquo;s starting hearing level
                    against which future tests are compared
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                  <span>
                    <strong>Follow-up testing:</strong> Audiometric tests should be repeated
                    annually for the first two years, then every three years if no significant
                    changes are detected. If deterioration is found, the frequency of testing should
                    increase and the cause investigated
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                  <span>
                    <strong>Categorisation:</strong> Audiometric results are typically categorised
                    (e.g., Category 1 = acceptable hearing, Category 2 = mild hearing loss, Category
                    3 = poor hearing, Category 4 = rapid deterioration). Workers in higher
                    categories may require referral to a specialist, review of their exposure, or
                    redeployment to quieter work
                  </span>
                </li>
              </ul>
              ...
              <ul className="space-y-2 text-sm text-white">
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                  <span>
                    <strong>Tier 1 &mdash; Screening questionnaire:</strong> All workers exposed to
                    vibration at or above the EAV complete a simple questionnaire asking about
                    symptoms such as tingling, numbness, white finger, pain, and grip problems. This
                    is typically administered annually and can be carried out by a trained
                    non-medical person. Workers reporting symptoms are referred to Tier 2
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                  <span>
                    <strong>Tier 2 &mdash; Assessment by a trained assessor:</strong> A more
                    detailed interview and examination by someone trained in HAVS assessment (such
                    as an occupational health nurse). This includes a standardised symptom history
                    and a basic clinical examination of the hands. Workers with confirmed or
                    suspected HAVS are referred to Tier 3
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                  <span>
                    <strong>Tier 3 &mdash; Clinical assessment by a doctor:</strong> A formal
                    diagnosis by an occupational health physician, including standardised clinical
                    tests for vascular function (cold provocation tests), neurological function
                    (nerve conduction studies, thermal threshold testing), and musculoskeletal
                    assessment. The doctor stages the condition using the Stockholm Workshop Scale
                    and makes recommendations regarding fitness for continued vibration exposure
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                  <span>
                    <strong>Tier 4 &mdash; Specialist referral:</strong> In complex or severe cases,
                    the worker is referred to a specialist occupational medicine consultant or
                    vascular surgeon for further investigation and management
                  </span>
                </li>
              </ul>
              ...
              <div className="grid sm:grid-cols-2 gap-3">
                <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-4">
                  ...
                  <p className="text-xs text-white">
                    ...
                    and employers have a legal duty to report diagnosed cases. Workers may also be
                    entitled to claim Industrial Injuries Disablement Benefit (IIDB) for prescribed
                    diseases including HAVS (PDA11) and occupational deafness (PDD1).
                  </p>
                </div>
                <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-4">
                  ...
                  <p className="text-xs text-white">
                    ...
                    moderate to severe cases, the worker may need to be permanently removed from
                    vibration-exposed work. These decisions must balance the worker&rsquo;s health
                    with their employment, and should involve discussion with the worker, their GP,
                    and the employer.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                <div className="flex items-start gap-2">
                  ...
                  <p className="text-sm text-white">
                    <strong className="text-green-400">Record Keeping:</strong> Health surveillance
                    records must be kept for at least <strong>40 years</strong> from the date of the
                    last entry. This extended retention period reflects the long latency of
                    noise-induced hearing loss and HAVS &mdash; symptoms may not become apparent or
                    worsen until years or decades after the exposure has ceased. Records must
                    include the name and date of birth of the worker, the date and outcome of each
                    health surveillance assessment, and the identity of the person carrying out the
                    assessment. Individual workers are entitled to see their own health records upon
                    request.
                  </p>
                </div>
              </div>
