...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    correctIndex: 2,
    explanation:
      "A blue circle with a white symbol is a mandatory sign — it tells you something you must do. For example, a blue circle with a hard hat symbol means 'hard hats must be worn'. Prohibition signs are red circles, warning signs are yellow triangles, and safe condition signs are green rectangles.",
  },
  {
    id: 'occupational-health',
    question:
      'An electrician notices white patches on their hands after regularly handling cement without gloves. What condition is most likely developing?',
    options: [
...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'Yellow triangles with a black border and black symbol are warning signs. They alert you to a hazard in the area. Examples include warnings for electrical danger, overhead loads, slippery surfaces, and hazardous substances.',
  },
  {
    id: 4,
    question:
      'What is the primary purpose of separating pedestrians and vehicles on a construction site?',
    options: [
...
const CscsCardModule2Section3 = () => {
  useSEO({
    ...
    description:
      'Learn about welfare facilities, site inductions, housekeeping, safety signs, traffic management, site security, occupational health, and emergency procedures for the CSCS HS&E test.',
  });
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <section className="mb-10">
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                The Construction (Design and Management) Regulations 2015 (CDM 2015), Schedule 2,
                sets out the minimum welfare facilities that must be provided on every construction
                site before work begins. These are not optional extras — they are legal
                requirements. The <strong>principal contractor</strong> is responsible for ensuring
                these facilities are in place, maintained, and accessible to all workers on site.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-1.5 text-sm">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong>Principal contractor:</strong> Primary duty to provide and maintain
                      all welfare facilities on multi-contractor sites
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>Contractors:</strong> Must cooperate with the principal contractor and
                      report any welfare deficiencies
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>Client:</strong> Must ensure that the principal contractor has
                      adequate arrangements in place before work starts
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>Workers:</strong> Must use the facilities properly and report damage,
                      deficiencies, or cleanliness issues
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-green-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  operate a construction site without adequate welfare provisions. This applies
                  regardless of the size of the site or the duration of the work.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                Every person who enters a construction site for the first time must receive a
                site-specific induction before commencing any work. This applies to everyone — not
                just manual workers — including visitors, delivery drivers, and client
                representatives. The induction is the principal contractor's responsibility, though
                the task is often delegated to the site safety officer or supervisor.
              </p>
              ...
              <div className="bg-white/5 border border-green-500/30 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-1.5 text-sm">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>Emergency procedures:</strong> Fire alarm sound, evacuation routes,
                      assembly points, and what to do if you discover an emergency
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>First aid:</strong> Location of first aid points, identity of first
                      aiders and appointed persons, how to summon help
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>Welfare facilities:</strong> Location of toilets, washing facilities,
                      rest areas, drinking water, drying rooms, and changing rooms
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>Site rules:</strong> Working hours, smoking areas, mobile phone
                      policy, speed limits, parking, permits to work
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>PPE requirements:</strong> Minimum PPE for general site access,
                  ...
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>Hazard locations:</strong> Live services, excavations, overhead
                      hazards, confined spaces, asbestos-containing materials, fragile surfaces
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>Reporting procedures:</strong> How to report accidents, near misses,
                      unsafe conditions, and defective equipment
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>Key personnel:</strong> Site manager, safety officer, first aiders,
                      fire marshals, and their contact details
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-1.5 text-sm">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>Attendance records:</strong> Every induction must be recorded with the
                      person's name, employer, date, and signature. These records must be kept for
                  ...
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>Refresher inductions:</strong> Required when site conditions change
                      significantly, after a serious incident, or at regular intervals on long-term
                      projects (typically every 6-12 months).
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>Returning workers:</strong> Anyone absent for a prolonged period
                      should receive a refresher covering any changes since their last attendance.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  risk and is a breach of site safety rules. Increasingly, induction records are
                  checked during site audits, and workers without records can be removed from site.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                Poor housekeeping is one of the leading causes of accidents on construction sites.
                Slips, trips, and falls account for a significant proportion of all injuries, and
                the majority of these are caused by untidy work areas, poor storage, and cluttered
                access routes. Keeping your work area clean and orderly is not just good practice —
                it is a legal requirement under CDM 2015 and the Workplace (Health, Safety and
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-1.5 text-sm">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>Clear access routes:</strong> Corridors, stairways, and escape routes
                      must be kept free from materials, tools, waste, and trailing cables at all
                      times
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>Waste management:</strong> Remove waste regularly. Use designated
                      skips and waste segregation areas. Never allow waste to accumulate in work
                      areas
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>Material storage:</strong> Store materials safely — stacked securely,
                      on level ground, away from edges, and protected from weather where necessary
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>Trip hazards:</strong> Immediately deal with trailing cables, loose
                      fixings, offcuts, packaging, and any item that could cause someone to trip or
                      fall
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>Spill management:</strong> Clean up spills (water, oil, chemicals)
                      immediately or cordon off the area until they can be dealt with safely
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-green-500/30 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-1.5 text-sm">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      Route temporary power cables overhead where possible, using cable hangers or
                      catenary wire
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      Where floor-level routing is unavoidable, use cable protectors (yellow ramps)
                      across walkways
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      Keep cable offcuts contained — never leave lengths of cable lying on the floor
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      Coil and secure any temporary extension leads when not in active use
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      Route cables away from heat sources, sharp edges, and areas where they could
                      be damaged by plant or traffic
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <p>
                Good housekeeping is everyone's responsibility — not just the site labourer's. The
                principle of "clean as you go" means that each trade is expected to tidy up after
                completing their work in an area. If you strip cable, collect the offcuts. If you
                drill holes, sweep up the dust. If you open packaging, dispose of it properly.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                The Health and Safety (Safety Signs and Signals) Regulations 1996 require employers
                to provide safety signs where there is a significant risk that cannot be avoided or
                reduced by other means. Construction sites use five main types of safety sign, each
                with a distinct shape, colour, and meaning. You must be able to recognise all five
                types instantly.
              </p>
                  ...
                  <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-lg p-3">
                    <div className="flex items-center gap-2 mb-2">
                      <div className="w-0 h-0 border-l-[20px] border-r-[20px] border-b-[35px] border-l-transparent border-r-transparent border-b-yellow-500 relative">
                        <span className="absolute -bottom-[28px] left-1/2 -translate-x-1/2 text-black font-bold text-sm">
                          !
                        </span>
                      </div>
                      <div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm mb-3">
                  ...
                  vehicles, and excavator movements.
                </p>
                <ul className="text-white space-y-1.5 text-sm">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>Start / Attention:</strong> Both arms extended horizontally, palms
                      facing forward
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>Stop:</strong> Right arm raised, palm facing forward — the universal
                      halt signal
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>Emergency stop:</strong> Both arms raised and waved vigorously above
                      the head
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>Raise / Hoist up:</strong> Right arm extended upward, circling slowly
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>Lower:</strong> Right arm extended downward, circling slowly
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>Move towards me:</strong> Both arms bent, palms facing inward,
                      beckoning towards the body
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>Move away:</strong> Both arms bent, palms facing outward, pushing away
                      from the body
                    </span>
                  </li>
                </ul>
              ...
              <p>
                All banksmen must be trained and competent. On most sites, they must hold a
                recognised qualification (such as a CPCS or CSCS card with the banksman/slinger
                endorsement). High-visibility clothing is essential so that plant operators can
                clearly see the signaller at all times.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                Being struck by a moving vehicle is one of the most common causes of fatal accidents
                on construction sites in the UK. An effective traffic management plan is essential
                on any site where vehicles and pedestrians share space. The plan must be prepared
                before work starts and communicated to all workers through the site induction.
              </p>
              ...
              <div className="bg-white/5 border border-green-500/30 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-1.5 text-sm">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>Separation:</strong> Physical barriers, fencing, or clearly marked
                      routes separating vehicle traffic from pedestrian walkways wherever possible
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>One-way systems:</strong> Reducing or eliminating the need for
                      vehicles to reverse by implementing one-way traffic flows around the site
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>Speed limits:</strong> Typically 5-10 mph on site. Enforced through
                      signage, speed bumps, and monitoring by site management
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>Reversing vehicles:</strong> Minimised wherever possible. Where
                      unavoidable, a trained banksman must guide the vehicle. Reversing alarms and
                      cameras should be fitted
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>Designated crossing points:</strong> Where pedestrians need to cross
                      vehicle routes, marked crossing points with clear sightlines must be provided
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>Visibility:</strong> All pedestrians in traffic areas must wear
                      high-visibility clothing. Vehicles must have working lights, mirrors, and
                      warning devices
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-1.5 text-sm">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      Guiding reversing vehicles in areas where rear visibility is limited
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                  ...
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      Stopping pedestrian traffic at crossing points when vehicles are moving
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      Managing temporary traffic diversions when work affects vehicle routes
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  require high-visibility clothing at all times as a general site rule, but it is
                  especially critical near vehicle movements where being seen is the difference
        ...
        <section className="mb-10">
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                Construction sites present significant hazards to the public, particularly to
                children who may be attracted to the site as a place to explore. The principal
                contractor has a duty to prevent unauthorised access and protect anyone who might be
                affected by site activities. This duty extends beyond the site boundary — activities
                such as crane operations, deliveries, and scaffolding work can all affect people on
                adjacent land and highways.
              </p>
              ...
              <div className="bg-white/5 border border-green-500/30 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-1.5 text-sm">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>Hoarding:</strong> Solid timber or metal hoarding around the site
                      perimeter, typically 2.4m high minimum, to prevent access and shield the
                      public from site activities
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>Fencing:</strong> Heras-type mesh fencing for less hazardous areas or
                      temporary works. Must be stable, complete, and properly maintained
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>Secure gates:</strong> Locked when the site is unattended. Manned
                      during working hours with sign-in procedures for all visitors and deliveries
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>Warning signs:</strong> "Construction Site — Keep Out", "Danger — Hard
                      Hat Area", "Unauthorised Persons Must Not Enter" displayed prominently on all
                      access points
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>CCTV and lighting:</strong> Security cameras and adequate lighting to
                      deter trespassers during non-working hours
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-1.5 text-sm">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      A licence from the local authority is required for any hoarding or scaffolding
                  ...
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      Adequate lighting must be provided on hoarding and scaffolding adjacent to the
                  ...
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      Pedestrian walkways must be provided if the pavement is obstructed, with
                      barriers and appropriate signage
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      Materials must not be deposited on the highway without authorisation, and any
                      spillage must be cleaned immediately
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      Vehicles leaving site must not deposit mud or debris on the public road —
                      wheel-washing facilities may be required
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <p>
                Protecting the public is not solely the site manager's concern. Every worker has a
                responsibility to ensure that site security is not compromised. This means closing
                gates after yourself, not leaving gaps in fencing, reporting any damage to hoarding,
                and ensuring that materials or equipment are not left where they could fall onto
                public areas.
              </p>
            </div>
          </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                Occupational health hazards are often called the "silent killers" of the
                construction industry. Unlike accidents, which happen suddenly, occupational
                diseases develop gradually over months or years of exposure. By the time symptoms
                appear, irreversible damage may already have occurred. Understanding these hazards
                and taking preventive action is essential for every construction worker.
              </p>

              <div className="bg-white/5 border border-green-500/30 p-4 rounded-lg">
                <h3 className="text-green-400 font-medium mb-3">
                  Common Occupational Health Conditions in Construction
                </h3>
                  ...
                  <div className="border-b border-white/10 pb-3">
                    ...
                    <ul className="text-white/80 text-xs space-y-1">
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                        <span>
                          <strong>Symptoms:</strong> Redness, itching, cracking, blistering, dry
                          scaly skin
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                        <span>
                          <strong>Prevention:</strong> Wear appropriate gloves, use barrier creams,
                          wash hands properly, avoid skin contact with irritants
                        </span>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="border-b border-white/10 pb-3">
                    ...
                    <ul className="text-white/80 text-xs space-y-1">
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                        <span>
                          <strong>Symptoms:</strong> Wheezing, coughing, chest tightness,
                          breathlessness — often worse during or after work
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                        <span>
                          <strong>Prevention:</strong> Use dust extraction, wear RPE, minimise
                          exposure, ensure adequate ventilation
                        </span>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="border-b border-white/10 pb-3">
                    ...
                    <ul className="text-white/80 text-xs space-y-1">
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                        <span>
                          <strong>Symptoms:</strong> Tingling, numbness, pain in fingers, loss of
                          grip, white finger (blanching of fingertips in cold)
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                        <span>
                          <strong>Prevention:</strong> Limit exposure time, use low-vibration tools,
                          take regular breaks, keep hands warm
                        </span>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="border-b border-white/10 pb-3">
                    ...
                    <ul className="text-white/80 text-xs space-y-1">
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                        <span>
                          <strong>Action levels:</strong> Lower exposure action value: 80 dB(A)
                          daily average. Upper value: 85 dB(A). Exposure limit: 87 dB(A)
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                        <span>
                          <strong>Prevention:</strong> Wear hearing protection, reduce exposure
                          time, use quieter tools and methods where available
                        </span>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="border-b border-white/10 pb-3">
                    ...
                    <ul className="text-white/80 text-xs space-y-1">
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                        <span>
                          <strong>Symptoms:</strong> Back pain, shoulder and neck pain, tendonitis,
                      ...
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                        <span>
                          <strong>Prevention:</strong> Use correct manual handling techniques, take
                          breaks, use mechanical aids, vary work activities
                        </span>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="text-white/80 text-xs space-y-1">
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                        <span>
                          <strong>Signs:</strong> Fatigue, irritability, difficulty concentrating,
                          increased absence, withdrawal from colleagues
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                        <span>
                          <strong>Support:</strong> Speak to your supervisor, contact your
                          employer's EAP, or call the Construction Industry Helpline
                        </span>
                      </li>
                    </ul>
                  </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <h3 className="text-green-400 font-medium mb-2">
                  Health Surveillance & Pre-Employment Medicals
                </h3>
                <ul className="text-white space-y-1.5 text-sm">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>Health surveillance:</strong> Regular monitoring required where
                      workers are exposed to specific hazards (noise, vibration, hazardous
                      substances, dust). Identifies early signs of disease before irreversible
                      damage occurs
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>Pre-employment medicals:</strong> Some employers and principal
                      contractors require a health assessment before starting work. Establishes a
                      baseline and identifies any pre-existing conditions
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>Skin checks:</strong> Regular self-inspection of hands and forearms
                      for signs of dermatitis, particularly if you handle cement, solvents, or
                      chemical products
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>Audiometry:</strong> Hearing tests for workers regularly exposed to
                      high noise levels — typically at baseline and then at regular intervals
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>HAVS tier assessment:</strong> Questionnaire-based screening followed
                      by clinical assessment if symptoms are reported. Uses the Stockholm Workshop
              ...
              <div className="bg-white/5 border border-green-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  intervention can prevent mild symptoms from becoming permanent disability.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                Every construction site must have a written emergency plan that covers fire, medical
                emergencies, structural collapse, chemical spills, gas leaks, and any other
                foreseeable emergency scenario. The plan must be communicated to all workers through
                the site induction and displayed prominently in rest areas, site offices, and at key
                locations around the site.
              </p>

              <div className="bg-white/5 border border-green-500/30 p-4 rounded-lg">
                <h3 className="text-green-400 font-medium mb-2">
                  Site Emergency Plan — Key Components
                </h3>
                <ul className="text-white space-y-1.5 text-sm">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>Alarm systems:</strong> The type of alarm (continuous siren, air horn,
                      tannoy announcement), what it sounds like, and what action to take when you
                      hear it
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>Evacuation routes:</strong> Primary and secondary routes from all
                      parts of the site. Routes must be kept clear, well-lit, and clearly signed
                      with green safe-condition signs
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>Assembly points:</strong> Designated muster points away from buildings
                      and hazards. You must go directly to the assembly point — do not return to
                      collect belongings
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>Roll call:</strong> Fire marshals or supervisors conduct a headcount
                      at the assembly point. You must remain at the assembly point until the
                      all-clear is given
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>Emergency contacts:</strong> Site manager, safety officer, emergency
                      services, and utility companies (gas, electric, water) for service strikes
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-1.5 text-sm">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>On hearing the alarm:</strong> Stop work immediately. Make safe any
                      work in progress (isolate electrical supplies, turn off gas torches)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>Evacuate:</strong> Leave by the nearest safe route. Do not use lifts.
                      If a route is blocked by smoke or fire, use an alternative
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>Close doors:</strong> Close doors behind you as you leave to slow the
                  ...
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>Report:</strong> At the assembly point, report to your roll-call
                      marshal and inform them of any people unaccounted for or anyone who may still
                      be in the building
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>Do not re-enter:</strong> Never go back into the site until the fire
                      service or site manager gives the all-clear
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-1.5 text-sm">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>First aiders:</strong> Hold a valid first aid at work (FAW) or
                      emergency first aid at work (EFAW) certificate. Trained to provide treatment
                  ...
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>Appointed persons:</strong> Take charge of first aid arrangements.
                      Call emergency services, maintain the first aid box, and manage the situation
                      — but not necessarily trained to treat
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>First aid boxes:</strong> Stocked with appropriate supplies, regularly
                      checked, and located where they are easily accessible. Contents should be
                      suitable for the risks on site
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>Information:</strong> The names and locations of first aiders must be
                      displayed on the site noticeboard and communicated during the site induction
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-green-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  the alarm sounds like, and where the nearest fire extinguisher is located. Do not
                  wait for an emergency to find out — by then it will be too late. This information
                  should all be covered in the site induction, but take the time to physically walk
                  the routes yourself.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-orange-500/30 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-1.5 text-sm">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>Electric shock:</strong> Do not touch the casualty until the circuit
                      is isolated. Use an insulating material to separate them from the source if
                      you cannot isolate
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>Electrical fire:</strong> Isolate the supply if safe to do so. Use a
                      CO2 or dry powder extinguisher — never water on a live electrical fire
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>Cable strike:</strong> If you strike a buried cable, move away
                      immediately, warn others, isolate the area, and report to the site manager and
                      utility company
                    </span>
                  </li>
                </ul>
        ...
        {/* Quiz Section */}
        <div className="mt-12">
          <Quiz title="Workplace Welfare & Site Safety Quiz" questions={quizQuestions} />
        </div>
