    ...
    <div className="overflow-x-hidden bg-[#1a1a1a]">
      ...
      <main className="px-4 sm:px-8 lg:px-12 pb-12">
        <div className="max-w-5xl mx-auto space-y-6 sm:space-y-8">
          {/* Course Header */}
          <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-green-500/10 via-green-400/5 to-transparent border border-green-500/15 p-5 sm:p-8">
            <div className="absolute top-0 right-0 w-48 h-48 bg-green-500/5 rounded-full blur-3xl -translate-y-1/2 translate-x-1/4" />
            <div className="relative z-10">
              <div className="flex items-center gap-3 mb-3">
                <div className="p-2.5 rounded-xl bg-gradient-to-br from-green-500/20 to-green-400/20 border border-green-500/20">
              ...
              <p className="text-sm sm:text-base lg:text-lg text-muted-foreground mt-1 max-w-2xl">
                Health, safety, and environment test preparation for CSCS card applications
              </p>
            </div>
          </div>
