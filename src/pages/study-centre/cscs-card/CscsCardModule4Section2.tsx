...
const faqs = [
  {
    question: "I'm an electrician — why do I need to know about asbestos?",
    answer:
  ...
  {
    question: 'Can I tell whether a material contains asbestos just by looking at it?',
    answer:
  ...
  {
    question: "Is it true that asbestos is only dangerous if it's disturbed?",
    answer:
...
const quizQuestions = [
  ...
  {
    id: 3,
    question: 'Which of the following diseases is ONLY caused by asbestos exposure?',
    options: [
      'Lung cancer',
          ...
          <div className="rounded-lg p-4 bg-green-500/5 border-l-2 border-green-500/50">
            ...
            <ul className="text-white/80 text-base space-y-1.5">
              <li className="flex items-start gap-2">
                ...
                <span>
                  <strong className="text-white">Three types:</strong> chrysotile (white), amosite
              ...
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Banned:</strong> fully prohibited in the UK since
                  1999 — still present in older buildings
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Fatal diseases:</strong> mesothelioma, asbestosis,
                  lung cancer — no safe exposure level
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">~5,000 deaths/year:</strong> asbestos is the
                  biggest cause of work-related death in the UK
                </span>
              </li>
            </ul>
          </div>
          <div className="rounded-lg p-4 bg-green-500/5 border-l-2 border-green-500/50">
            ...
            <ul className="text-white/80 text-base space-y-1.5">
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Check the register:</strong> always check the
              ...
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">If in doubt:</strong> STOP work, do NOT disturb,
                  leave the area, report immediately
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Assume the worst:</strong> treat suspect material
                  as asbestos until confirmed otherwise
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Never remove:</strong> only licensed or trained
                  contractors may remove ACMs
                </span>
              </li>
            </ul>
          </div>
          ...
          <div className="border-l-2 border-green-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                to 1999. Valued for its exceptional resistance to heat, fire, chemicals, and
                electrical current, asbestos was incorporated into thousands of building products.
                It was cheap, readily available, and extraordinarily versatile — which made it one
                of the most widely used construction materials of the twentieth century.
              </p>

              <p>
                Asbestos was used in roofing, insulation, flooring, wall coatings, pipe lagging,
                gaskets, electrical components, and many other applications. It is estimated that
                asbestos can be found in approximately{' '}
                <strong className="text-white">500,000 non-domestic buildings</strong> and millions
                of domestic properties across the UK. Any building constructed or refurbished before{' '}
                <strong className="text-white">2000</strong> may contain asbestos-containing
                materials (ACMs).
              </p>
              ...
              <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                ...
                <ul className="text-white/80 text-sm space-y-1.5">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">1985:</strong> Blue (crocidolite) and brown
                      (amosite) asbestos banned in the UK
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">1999:</strong> White (chrysotile) asbestos
                      banned — completing the full ban on all forms of asbestos in the UK
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">2012:</strong> Current legislation — the
                      Control of Asbestos Regulations 2012 (CAR 2012) came into force
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="my-6">
                  ...
                  <div className="bg-white/5 border border-white/10 rounded-lg p-4">
                    <div className="flex items-start gap-4">
                      <div className="w-12 h-12 rounded-lg bg-gray-200/10 border border-gray-300/20 flex items-center justify-center flex-shrink-0">
                        <span className="text-gray-300 text-xs font-bold">WHITE</span>
                      </div>
                      <div>
                        ...
                        <ul className="text-white/60 text-sm space-y-1">
                          <li className="flex items-start gap-2">
                            <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                            <span>
                              Most commonly used type — accounts for approximately 90% of asbestos
                              used worldwide
                            </span>
                          </li>
                          <li className="flex items-start gap-2">
                            <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                            <span>
                              Curly, serpentine fibres — found in cement products, textured
                              coatings, floor tiles, roofing materials
                            </span>
                          </li>
                          <li className="flex items-start gap-2">
                            <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                            <span>Banned in the UK in 1999 — the last type to be prohibited</span>
                          </li>
                        </ul>
                      </div>
                    </div>
                  ...
                  <div className="bg-white/5 border border-white/10 rounded-lg p-4">
                    <div className="flex items-start gap-4">
                      <div className="w-12 h-12 rounded-lg bg-amber-800/20 border border-amber-600/20 flex items-center justify-center flex-shrink-0">
                        <span className="text-amber-400 text-xs font-bold">BROWN</span>
                      </div>
                      <div>
                        ...
                        <ul className="text-white/60 text-sm space-y-1">
                          <li className="flex items-start gap-2">
                            <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                            <span>
                              Second most commonly used type — straight, needle-like fibres
                            </span>
                          </li>
                          <li className="flex items-start gap-2">
                            <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                            <span>
                              Commonly found in insulation boards (AIB), ceiling tiles, thermal
                              insulation, and pipe lagging
                            </span>
                          </li>
                          <li className="flex items-start gap-2">
                            <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                            <span>More hazardous than chrysotile — banned in the UK in 1985</span>
                          </li>
                        </ul>
                      </div>
                    </div>
                  ...
                  <div className="bg-white/5 border border-white/10 rounded-lg p-4">
                    <div className="flex items-start gap-4">
                      <div className="w-12 h-12 rounded-lg bg-blue-800/20 border border-blue-600/20 flex items-center justify-center flex-shrink-0">
                        <span className="text-blue-400 text-xs font-bold">BLUE</span>
                      </div>
                      <div>
                        ...
                        <ul className="text-white/60 text-sm space-y-1">
                          <li className="flex items-start gap-2">
                            <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                            <span>
                              The most hazardous type — very fine, sharp, needle-like fibres that
                          ...
                          <li className="flex items-start gap-2">
                            <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                            <span>
                              Found in sprayed coatings, pipe insulation, and some cement products
                            </span>
                          </li>
                          <li className="flex items-start gap-2">
                            <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                            <span>
                              Banned in the UK in 1985 alongside amosite — particularly associated
                              with mesothelioma
                            </span>
                          </li>
                        </ul>
                ...
                <div className="mt-4 bg-white/5 border border-green-500/30 rounded-lg p-3">
                  <p className="text-green-300 text-xs sm:text-sm font-medium">
                    ...
                    <strong className="text-white">equally dangerous</strong> in practice. There is
                    no safe type of asbestos and no safe level of exposure. Never assume that white
                    asbestos is &ldquo;less harmful&rdquo; — any asbestos fibre inhaled into the
                    lungs can cause fatal disease.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                low-level exposure can lead to disease. The health effects of asbestos are made
                particularly devastating by the extremely long{' '}
                <strong className="text-white">latency period</strong> — the time between exposure
                and the appearance of symptoms. This period is typically{' '}
                <strong className="text-white">15 to 60 years</strong>, meaning that workers exposed
                today may not become ill until decades later.
              </p>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/70 text-sm">
                  ...
                  in the United Kingdom. Around 2,500 people die from mesothelioma each year, with a
                  similar number dying from asbestos-related lung cancer and asbestosis. More people
                  die from asbestos-related diseases each year than in road traffic accidents.
                </p>
              </div>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <h3 className="text-red-300 font-medium mb-3">Asbestos-Related Diseases</h3>
                <div className="space-y-3 text-sm">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/60">
                        ...
                        Asbestos-related lung cancer is indistinguishable from lung cancer caused by
                        other factors.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-orange-500/20 border border-orange-400/30 flex items-center justify-center flex-shrink-0 mt-0.5">
                      <span className="text-orange-300 text-xs font-bold">5</span>
                    </div>
                    <div>
              ...
              <div className="bg-white/5 border border-green-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/70 text-sm">
                  ...
                  people dying from asbestos-related diseases today were exposed in the 1970s and
                  1980s — and that anyone exposed now may not develop symptoms until the 2050s or
                  beyond. There are no early warning signs and no screening test that can detect
                  asbestos-related disease before symptoms appear.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-amber-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                between. As an electrician, you are particularly at risk because your work takes you
                into ceiling voids, behind panels, under floors, and inside switch rooms where ACMs
              ...
              <div className="bg-white/5 border border-amber-400/30 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-2 text-sm">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Textured coatings (Artex):</strong> widely
                      applied to ceilings and walls — very common in residential and commercial
                      properties built before 2000. Contains chrysotile (white asbestos)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Floor tiles:</strong> thermoplastic floor tiles
                      (especially 9-inch/228mm square tiles) and the bitumen adhesive used to fix
                      them frequently contain asbestos
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Asbestos cement roof sheets:</strong>{' '}
                      corrugated and flat sheets used on roofs, walls, and outbuildings. Very common
                      in industrial, agricultural, and garage buildings
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Asbestos insulating board (AIB):</strong> used
                      for fire protection in ceiling tiles, partition walls, column casings,
                      soffits, and around structural steelwork. Higher risk than cement products
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Pipe lagging:</strong> thermal insulation on
                      heating pipes, boilers, and ductwork. Often contains amosite or crocidolite —
                      high risk if damaged or disturbed
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Gaskets and rope seals:</strong> found in
                      boilers, flue pipes, and heating equipment. Braided asbestos rope was used as
                      a seal in many appliances
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Flue pipes:</strong> asbestos cement was
                      commonly used for flue pipes serving boilers and heating systems
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Water tanks and cisterns:</strong> asbestos
                      cement was used to manufacture cold water storage tanks, particularly in
                      domestic loft spaces
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Soffits and fascia boards:</strong> asbestos
                      cement boards were widely used as soffits under roof eaves and as fascia
                      boards on the exterior of buildings
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                ...
                <ul className="text-white/70 text-sm space-y-1.5">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Fuse boxes and consumer units:</strong> older
                      fuse boxes often have asbestos flash guards or asbestos backing boards.
                      Consumer units manufactured before the mid-1980s may contain asbestos
                      components
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Ceiling voids and risers:</strong> cable routes
                      frequently pass through areas where ACMs are present — including AIB panels,
                      pipe lagging, and sprayed coatings
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Heater storage cupboards:</strong> asbestos
                      insulating board was commonly used to line storage heater cupboards and
                      immersion heater enclosures
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Behind electrical accessories:</strong>{' '}
                      asbestos-containing boards may be present behind sockets, switches, and
                      distribution boards mounted on walls containing AIB
                    </span>
                  </li>
                </ul>
              </div>
          ...
          <div className="border-l-2 border-teal-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                asbestos in non-domestic premises. This regulation applies to the person who has
                responsibility for the maintenance or repair of the building — known as the{' '}
                <strong className="text-white">duty holder</strong>. In practice, this is usually
                the building owner, landlord, managing agent, or facilities manager.
              </p>
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/60">
                        ...
                        trade that may come into contact with ACMs.
                      </p>
                    </div>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-green-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/70 text-sm">
                  ...
                  work, ask to see the asbestos register and check whether there are any ACMs in or
                  near your work area. If no register exists, or if the register does not cover your
                  work area, raise this with the duty holder or your supervisor before starting
                  work. <strong className="text-white">Never start work without checking.</strong>
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                <strong className="text-white">STOP, do not disturb, and report</strong>. Never
                attempt to remove, sample, or test suspected ACMs yourself. Always assume a suspect
                material contains asbestos until it has been confirmed safe by a competent analyst.
              </p>
              ...
              <div className="my-6">
                  ...
                  <div className="bg-orange-500/15 border border-orange-400/30 rounded-lg p-4">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-full bg-orange-500/30 border-2 border-orange-400/50 flex items-center justify-center flex-shrink-0">
                        <span className="text-orange-300 text-sm font-bold">2</span>
                      </div>
                      <div>
                  ...
                  <div className="bg-green-500/15 border border-green-400/30 rounded-lg p-4">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-full bg-green-500/30 border-2 border-green-400/50 flex items-center justify-center flex-shrink-0">
                        <span className="text-green-300 text-sm font-bold">5</span>
                      </div>
                      <div>
                ...
                <div className="mt-4 bg-white/5 border border-red-500/30 rounded-lg p-3">
                  <p className="text-red-300 text-xs sm:text-sm font-medium">
                    This sequence applies <strong className="text-white">every single time</strong>{' '}
                    you encounter a suspect material — whether it is the first time or the
                    hundredth. Never become complacent. The consequences of getting it wrong are
                    irreversible.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-2 text-sm">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Never try to remove ACMs yourself</strong> —
                      even small amounts. Removal must be carried out by trained or licensed
                      contractors
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Never take a sample yourself</strong> —
                      sampling must be carried out by a competent person using proper equipment and
                      precautions
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      — a standard vacuum cleaner will spread fibres into the air. Only
                      HEPA-filtered vacuums are suitable for asbestos
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Never ignore it and carry on</strong> — the
                      fact that you cannot see the fibres does not mean they are not being released
                      into the air
                    </span>
                  </li>
                </ul>
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                notification, and supervision required. Understanding these categories is essential
                for identifying who is permitted to carry out different types of asbestos work.
              </p>

              <div className="bg-white/5 border border-purple-400/30 p-4 rounded-lg">
                <h3 className="text-purple-300 font-medium mb-3">The Three Categories</h3>
                    ...
                    <ul className="text-white/70 space-y-1.5">
                      <li className="flex items-start gap-2">
                        ...
                        <span>
                          ...
                          <strong className="text-white">HSE-licensed contractor</strong> — a
                          company holding a current licence from the Health and Safety Executive
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                        <span>
                          The HSE must be <strong className="text-white">notified</strong> at least
                          14 days before the work starts
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                        <span>
                          Includes removal of asbestos insulation, asbestos lagging, sprayed
                          asbestos coatings, and asbestos insulating board (AIB) where the risk
                          assessment indicates significant fibre release
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                        <span>
                          Requires full enclosure, negative pressure, air monitoring, medical
                          surveillance, and decontamination units
                        </span>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="bg-orange-500/10 border border-orange-500/20 rounded-lg p-3">
                    ...
                    <ul className="text-white/70 space-y-1.5">
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                        <span>
                          The <strong className="text-white">middle ground</strong> — work that does
                          not require a licence but has additional requirements beyond standard
                          non-licensed work
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                        <span>
                          Must be <strong className="text-white">notified to the HSE</strong> before
                          the work starts, and workers must be under medical surveillance
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                        <span>
                          Examples include removal of AIB in certain circumstances, and some
                          maintenance work involving ACMs where sporadic and low-intensity exposure
                      ...
                      <li className="flex items-start gap-2">
                        ...
                        <span>
                          ...
                          <strong className="text-white">non-licensed asbestos training</strong>{' '}
                          (Category B)
                        </span>
                      </li>
                    </ul>
                    ...
                    <ul className="text-white/70 space-y-1.5">
                      <li className="flex items-start gap-2">
                        ...
                        <span>
                          ...
                          <strong className="text-white">sporadic and of low intensity</strong> and
                          the control limit is not expected to be exceeded
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                        <span>
                          Examples include removing asbestos cement sheets, removing floor tiles,
                          removing textured coatings in small areas, and minor maintenance that may
                          briefly disturb ACMs
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                        <span>
                          Does not need an HSE licence or notification, but workers must be{' '}
                      ...
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                        <span>
                          HSE Asbestos Essentials (HSG210) provides task sheets for common
                          non-licensed asbestos tasks
                        </span>
                      </li>
                    </ul>
                  </div>
              ...
              <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  <strong className="text-white">stop, report, and wait</strong>. The duty holder is
                  responsible for arranging the appropriate level of asbestos management or removal.
                  Your Asbestos Awareness training (Category A) qualifies you to recognise suspect
                  materials and take the correct action — it does{' '}
                  <strong className="text-white">not</strong> qualify you to work with or remove
                  ACMs.
                </p>
              </div>
            </div>
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                <strong className="text-white">risk assessment</strong> must be carried out. For
                electricians, this begins with the most fundamental step:{' '}
                <strong className="text-white">checking the asbestos register</strong> before you
                start work.
              </p>
              ...
              <div className="bg-white/5 border border-cyan-400/30 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-2 text-sm">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Check the asbestos register:</strong> review
                      the building's asbestos register for your specific work area. Identify any
                      ACMs that are located in, near, or along the route of your planned work
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Check the survey type:</strong> confirm whether
                      a management survey or a refurbishment and demolition (R&D) survey has been
                      carried out. For significant electrical work (rewiring, new circuits, major
                  ...
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Carry out a risk assessment:</strong> assess
                      whether your planned work could disturb any ACMs. Consider cable routes,
                      drilling locations, fixings, and access points
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Prepare a method statement:</strong> if your
                      work will take place near ACMs, prepare a method statement that describes how
                      you will avoid disturbing them — including alternative cable routes, methods
                      of fixing that avoid drilling into ACMs, and safe access procedures
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <h3 className="text-cyan-300 font-medium mb-3">Encapsulation vs Removal</h3>
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/60">
                        ...
                        work) contractors with appropriate equipment and controls.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-white/5 border border-green-500/30 p-4 rounded-lg">
                ...
                <ul className="text-white/70 text-sm space-y-1.5">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      Plan cable routes to <strong className="text-white">avoid ACMs</strong>{' '}
                      wherever possible — use alternative routes
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      Do not drill, cut, or fix into materials identified as containing asbestos or
                  ...
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      Use surface-mounted trunking instead of chasing into walls that may contain
                      ACMs
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      If you must work near lagged pipes, do not lean on, push against, or pull
                      cables across the lagging
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      Report any damaged or deteriorating ACMs you encounter, even if they are not
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                depends on the nature of the work and the likelihood of disturbing ACMs. Training
                must be <strong className="text-white">refreshed annually</strong>.
              </p>

              <div className="bg-white/5 border border-emerald-400/30 p-4 rounded-lg">
                <h3 className="text-emerald-300 font-medium mb-3">Training Categories</h3>
                <div className="space-y-4 text-sm">
                  {/* Category A */}
                  <div className="bg-green-500/10 border border-green-500/20 rounded-lg p-3">
                    ...
                    <ul className="text-white/70 space-y-1.5">
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                        <span>
                          Required for <strong className="text-white">ALL workers</strong> who work
                          in buildings that may contain asbestos — including electricians, plumbers,
                          joiners, painters, and general maintenance workers
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                        <span>
                          Covers: what asbestos is, where it is found, health effects, how to avoid
                          disturbing ACMs, what to do if you find suspect materials
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                        <span>
                          Does <strong className="text-white">NOT</strong> qualify you to work with
                          or remove ACMs — only to recognise and avoid them
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                        <span>
                          Must be refreshed <strong className="text-white">annually</strong>
                        </span>
                      </li>
                    </ul>
                  </div>
                    ...
                    <ul className="text-white/70 space-y-1.5">
                      <li className="flex items-start gap-2">
                        ...
                        <span>
                          ...
                          <strong className="text-white">disturb ACMs</strong> as part of their work
                          — for example, removing asbestos cement sheets, removing floor tiles, or
                          carrying out maintenance that involves contact with ACMs
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                        <span>
                          Covers everything in Category A plus: safe working procedures, equipment
                          selection, RPE/PPE use, decontamination, waste handling, and emergency
                          procedures
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                        <span>
                          Qualifies workers to carry out non-licensed and NNLW asbestos tasks (but
                          NOT licensed work)
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                    ...
                    <ul className="text-white/70 space-y-1.5">
                      <li className="flex items-start gap-2">
                        ...
                        <span>
                          ...
                          <strong className="text-white">HSE-licensed contractors</strong> who carry
                      ...
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                        <span>
                          Comprehensive training covering all aspects of licensed work: enclosures,
                          negative pressure, air monitoring, decontamination units, medical
                      ...
                      <li className="flex items-start gap-2">
                        ...
                        <span>
                          ...
                          <strong className="text-white">medical surveillance</strong> including
                          lung function tests
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
              ...
              <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  training is to ensure that workers maintain their knowledge and awareness,
                  particularly as guidance and legislation may be updated. If your training has
                  lapsed, you are not legally permitted to carry out work that could expose you to
                  asbestos until you have completed a refresher course.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-green-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/70 text-sm">
                  ...
                  to know the types of asbestos, the health effects, where ACMs are found, the duty
                  to manage, and the correct actions to take when you encounter suspect materials.
                  This section covers all of those topics.
                </p>
              </div>
            </div>
          </div>
