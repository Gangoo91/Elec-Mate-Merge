...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['200mm', '500mm', '1 metre', '2 metres'],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    id: 3,
    question:
      'Which regulation of the Electricity at Work Regulations 1989 deals with the duty holder?',
    options: ['Regulation 3', 'Regulation 4', 'Regulation 12', 'Regulation 14'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    id: 7,
    question:
      'What rating of RCD protection is required for socket outlets on a construction site distribution board?',
  ...
  },
  {
    id: 8,
    question:
      'If someone is receiving an electric shock from a live source, what should you do FIRST?',
    options: [
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-green-500/5 border-l-2 border-green-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Electricity kills</strong> &mdash; ventricular fibrillation at as little as
                50mA
              </li>
              <li>
                <strong>110V CTE</strong> is the standard on UK construction sites (max 55V to
                earth)
              </li>
              <li>
                <strong>Never work live</strong> unless it is unreasonable to make the equipment
                dead
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-green-500/5 border-l-2 border-green-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              ...
              <li>
                <strong>PAT testing:</strong> visual check every use, formal test every 3 months on
                site
              </li>
              <li>
          ...
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                must rely on safe systems of work, proper equipment, and vigilance to protect
              ...
              <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  ...
                  approximately 10&ndash;15 construction workers per year in the UK and causes many
                  more serious injuries including severe burns. Contact with overhead power lines
                  and underground cables accounts for a significant proportion of electrical
                  fatalities on construction sites.
                </p>
              </div>

              <p>The five main electrical hazards on construction sites are:</p>
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      through the body. Even a brief contact can cause involuntary muscle
                      contraction, loss of consciousness, cardiac arrest, or death. The heart is
                      particularly vulnerable &mdash; ventricular fibrillation (uncoordinated
                      quivering of the heart muscle) can occur at currents as low as 50mA
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Electrical burns</strong> &mdash; current
                      flowing through body tissue generates intense heat, causing deep tissue burns
                      that are often far more severe than they appear on the surface. Entry and exit
                      wound burns can cause permanent damage to muscles, nerves, and internal organs
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      ...
                      flash incidents can cause severe burns, blindness, and hearing damage even
                  ...
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Fire</strong> &mdash; faulty electrical
                      equipment, overloaded cables, poor connections, and damaged insulation can all
                      ignite surrounding materials. Electrical fires on construction sites are
                      particularly dangerous due to the presence of combustible materials, solvents,
                      and limited escape routes in partially completed structures
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Explosion</strong> &mdash; electrical sparks in
                      the presence of flammable gases, vapours, or dust can cause catastrophic
                      explosions. This is a particular risk in confined spaces, near fuel stores,
                      and during work involving solvents or gas supplies
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Current magnitude</strong> &mdash; the amount
                      of current flowing through the body. As little as 50mA (0.05A) can cause
                      ventricular fibrillation. Higher currents cause respiratory arrest, severe
                      burns, and cardiac arrest. Current is determined by voltage and resistance (I
                      = V/R) &mdash; wet skin, cuts, or metal jewellery reduce resistance and
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      flowing hand-to-hand or hand-to-foot passes through the chest and across the
                      heart, which is the most dangerous path. A current path that avoids the heart
                      (e.g., finger to the same hand) is less likely to be fatal but can still cause
                  ...
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Duration of exposure</strong> &mdash; the
                      longer the current flows through the body, the greater the damage. Muscular
                      contraction (&ldquo;cannot let go&rdquo; effect) can prevent the victim from
                      releasing the live conductor, prolonging exposure. This is why fast-acting
                      protective devices (RCDs, fuses, circuit breakers) are so important
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The Electricity at Work Regulations 1989 (EAWR) are the primary legislation
                governing electrical safety in the workplace. They apply to all work activities
                involving electrical systems and equipment, from low-voltage battery systems to
                high-voltage power lines. The regulations place duties on employers, the
                self-employed, and employees to prevent danger from electricity.
              </p>

              <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-green-400">Key Principle:</strong> The overarching
                  principle of the EAWR is that electrical systems must be constructed, maintained,
                  and used so as to prevent danger. &ldquo;Danger&rdquo; is defined as the risk of
                  injury from electric shock, burn, fire, or explosion arising from the use of
                  electricity.
                </p>
              </div>
                ...
                <div className="space-y-3">
                  <div className="p-3 rounded-lg bg-green-500/5 border border-green-500/20">
                    ...
                    <p className="text-sm text-white/80">
                      ...
                      not place themselves or others at risk). Every person at work has a
                      responsibility to comply so far as it relates to matters within their control.
                    </p>
                  </div>
                  ...
                  <div className="p-3 rounded-lg bg-green-500/5 border border-green-500/20">
                    ...
                    <p className="text-sm text-white/80">
                      ...
                      on or near electrical systems must be carried out in a manner that does not
                      give rise to danger. This regulation underpins all other electrical safety
                      requirements.
                    </p>
                  </div>
                  ...
                  <div className="p-3 rounded-lg bg-red-500/5 border border-red-500/20">
                    ...
                    <p className="text-sm text-white/80">
                      ...
                      for it to be dead, it is reasonable in all the circumstances for the person to
                      be at work on or near it whilst live, and suitable precautions (including the
                      provision of protective equipment) have been taken to prevent injury. All
                      three conditions must be met. The default is always:{' '}
                      <strong className="text-white">make it dead first</strong>.
                    </p>
                  </div>
                  ...
                  <div className="p-3 rounded-lg bg-green-500/5 border border-green-500/20">
                    ...
                    <p className="text-sm text-white/80">
                      ...
                      difficult-to-access electrical equipment significantly increases the risk of
              ...
              <p>
                The EAWR applies to all workplaces and all voltages. On construction sites,
                compliance is particularly important because temporary electrical installations,
                portable equipment, and the harsh environment all increase the risk. The Health and
                Safety Executive (HSE) can prosecute under these regulations, and failure to comply
                is a criminal offence. The HSE publishes guidance in the form of the Memorandum of
                Guidance on the Electricity at Work Regulations (HSR25) which provides detailed
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-green-400">Why 110V CTE?</strong> In a 110V CTE system,
                  the secondary winding of the step-down transformer has its centre point connected
                  to earth. This means the maximum voltage between any single conductor and earth is
                  only 55V &mdash; far less than the 230V that exists in a standard domestic supply.
                  At 55V, the current that can flow through the human body (given typical skin
                  resistance) is well below the level that causes ventricular fibrillation,
                  dramatically reducing the risk of death from electric shock.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Yellow connectors and equipment</strong>{' '}
                      &mdash; all 110V plugs, sockets, extension leads, and equipment casings are
                      coloured yellow for instant identification. Blue identifies 230V and red
                      identifies 415V three-phase
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      ...
                      from traffic and weather, and regularly inspected. The earth connection must
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      centre tap earthed, the highest voltage that can exist between any conductor
                      and earth is 55V. This is the key safety feature. Even if a fault develops and
                      a worker touches a live conductor whilst standing on earth, the voltage
                      driving current through their body is limited to 55V
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">When 230V is still used on site</strong>{' '}
                      &mdash; 230V may be present for fixed installations such as site offices,
                      canteens, drying rooms, and welfare facilities. These must be installed by a
                      competent electrician, protected by 30mA RCDs, and clearly identified.
                      Battery-powered cordless tools are increasingly common and avoid the voltage
                      risk entirely
                    </span>
                  </li>
                </ul>
          ...
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                construction sites, where equipment is subjected to rough handling, dust, moisture,
                and impact damage, regular PAT testing is essential to prevent electrical accidents.
              </p>

              <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-green-400">Two-Stage Process:</strong> PAT involves two
                  levels of checking: (1) a{' '}
                  <strong>visual inspection by the user before every use</strong>, and (2) a{' '}
                  <strong>formal PAT inspection and test</strong> at regular intervals (typically
                  every 3 months on construction sites). The user check is the first line of defence
                  and catches the majority of dangerous faults.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Cable condition</strong> &mdash; check for
                      cuts, abrasion, kinks, exposed inner conductors, taped-up repairs (never
                      acceptable on site), and damage near the plug or equipment entry point where
                      flexing causes the most wear
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Plug condition</strong> &mdash; check for
                      cracks, burn marks, bent or damaged pins, loose cable grip, and that the plug
                      casing is intact with no parts missing. The cable should be firmly secured in
                      the plug with no inner conductors visible
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Equipment body</strong> &mdash; check for
                      cracks, dents, missing parts, signs of overheating (discolouration, melted
                      plastic), water ingress, and that all guards and covers are in place. Any tool
                      that shows signs of internal damage or has been dropped heavily should be
                      withdrawn from use
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      next test due date. If the label is missing, expired, or shows a
                      &ldquo;fail&rdquo; result, do not use the equipment
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Every 3 months (typically)</strong> for
                      portable tools used on the construction site. This frequency reflects the
                      harsh conditions and rough handling that site equipment experiences
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                  ...
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">After any incident</strong> that may have
                      damaged the equipment, such as being dropped, run over, immersed in water, or
                      involved in a trip or short circuit
                    </span>
                  </li>
                </ul>
              </div>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white/80 space-y-1">
                    ...
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                      <span>
                        If a live conductor touches the metal casing, current flows to earth and
                        trips the protective device
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                      <span>
                        PAT test includes earth continuity test, insulation resistance test, and
                        functional check
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white/80 space-y-1">
                    ...
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                      <span>
                        PAT test includes insulation resistance test and functional check (no earth
                        continuity test)
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
          ...
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                construction sites. Contact with overhead lines &mdash; whether by cranes,
                scaffolding, tipper lorries, excavator booms, or even long materials being carried
                &mdash; has caused numerous fatalities. Electricity can arc across gaps without
                direct contact, meaning it is not necessary to touch the line itself to receive a
                fatal shock.
              </p>

              <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-green-400">Fatal Statistics:</strong> Contact with
                  overhead power lines accounts for a significant number of electrical deaths in the
                  construction and agricultural industries each year. Many of these fatalities
                  involve crane or plant operations where the boom or jib contacts or comes too
                  close to an overhead line. HSE guidance GS6 provides detailed advice on avoiding
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      physical height restrictors (goal posts) should be erected on access routes
                      passing under or near overhead lines. These prevent tall vehicles and plant
                      from entering the danger zone. The crossbar must be set at a safe height below
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      should be appointed to monitor clearances. Crane slew and height limiters may
                      be needed
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Warning signs and markings</strong> &mdash;
                      clear warning signs must be displayed at all points where vehicles or plant
                      could approach overhead lines. Ground markings may be used to indicate
                      exclusion zones
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">HSE guidance GS6</strong> &mdash;
                      &ldquo;Avoiding Danger from Overhead Power Lines&rdquo; provides detailed
                      guidance on risk assessment, safe clearance distances, protective measures,
                      and emergency procedures. It is the primary reference document for work near
                      overhead lines
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Diversion or disconnection</strong> &mdash;
                      where possible, the power company should be asked to divert the line
                      underground or temporarily disconnect and earth it for the duration of the
                      works. This eliminates the risk entirely and is always the preferred option
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-red-400">Emergency:</strong> If a vehicle or piece of
                  plant contacts an overhead power line, the operator must stay in the cab, warn
                  others to stay clear, and call the emergency services. Do not attempt to leave the
                  vehicle unless it is on fire &mdash; in which case, jump well clear (do not step
                  down, as this creates a path to earth). Anyone on the ground near the contact
                  point is at risk of electrocution from step potential (voltage gradients in the
                  ground).
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Underground cables present a serious hazard during any excavation work on
                construction sites. Striking an underground electricity cable with a mechanical
                excavator, hand tool, or even a fence post can result in fatal electrocution, severe
                burns, or explosion. The HSE publication HSG47 (&ldquo;Avoiding Danger from
                Underground Services&rdquo;) provides comprehensive guidance on safe excavation
                practices.
              </p>

              <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-green-400">Key Principle:</strong> Before any excavation
                  work begins, the location of all underground services must be established. This
                  involves three steps: (1) obtaining up-to-date plans from utility companies, (2)
                  using cable locating equipment (CAT and Genny) to scan the area, and (3) hand
                  digging trial holes to confirm locations before using mechanical plant.
                </p>
              </div>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-3">
                  Cable Detection &mdash; CAT and Genny
                </p>
                <div className="space-y-3">
                  <div className="p-3 rounded-lg bg-blue-500/5 border border-blue-500/20">
                    ...
                    <p className="text-sm text-white/80">
                      ...
                      (detects 50Hz signals from live mains cables),{' '}
                      <strong className="text-white">Radio mode</strong> (detects radio frequency
                      signals re-radiated by long metallic services), and{' '}
                      <strong className="text-white">Genny mode</strong> (detects the specific
                      signal applied by a paired signal generator). The CAT should always be used in
                      all three modes for a thorough survey.
                    </p>
                  </div>
                  ...
                  <div className="p-3 rounded-lg bg-amber-500/5 border border-amber-500/20">
                    ...
                    <p className="text-sm text-white/80">
                      ...
                      together gives the most accurate results because the Genny signal is specific
                      to the targeted service, allowing it to be traced individually even where
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-3">
                  Underground Service Colour Coding
                </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  ...
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Dig alongside, not directly above</strong>{' '}
                      &mdash; wherever possible, approach cables from the side rather than from
                      directly above to reduce the risk of striking them with a downward blow
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      ...
                      pneumatic picks, breakers, and other percussive power tools must not be used
                      near known cable routes. These can easily puncture cable insulation
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Support exposed cables</strong> &mdash; any
                      cables exposed during excavation must be properly supported to prevent damage
                      from sagging, being stood on, or having spoil heaps placed on them. Cable
                      supports (sandbags, timber cradles) should be used
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
          ...
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                equipment, lighting, welfare facilities, and site offices. These installations must
                be designed, installed, maintained, and used with the same care as permanent
                installations &mdash; the temporary nature of the work does not reduce the safety
                requirements. BS 7671 (IET Wiring Regulations) Section 704 covers the specific
                requirements for construction and demolition site installations.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Main distribution board</strong> &mdash;
                      receives the incoming supply from the utility company or on-site generator.
                      Contains the main isolator and distribution equipment. Must be locked and
                      access restricted to competent persons only
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Sub-distribution boards</strong> &mdash; fed
                      from the main board and positioned around the site to provide power where it
                      is needed. Each sub-board should have its own isolator and protective devices
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      ...
                      step-down transformers fed from the distribution system provide 110V CTE
                      supplies for portable tools and equipment via yellow socket outlets
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">30mA RCD protection</strong> is required for
                      all socket outlets up to 32A on construction site distribution boards. This
                      provides additional protection against electric shock and will disconnect the
                      supply within approximately 40 milliseconds if a fault current of 30mA or more
                      flows to earth
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      distribution boards should be tested at regular intervals using the built-in
                      test button. Formal testing with calibrated instruments should be carried out
                      as part of the periodic inspection schedule. A failed RCD must be replaced
                      immediately
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">IP44 minimum</strong> for distribution boards
                      and equipment exposed to weather &mdash; protected against objects greater
                      than 1mm and splashing water from any direction
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      Overhead routing on catenary wires, buried in ducts, or protected by
                      heavy-duty cable covers (ramps) are all acceptable methods
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Cable protection</strong> &mdash; cables must
                      not be run across roadways without protection, draped over sharp edges, or
                      left in standing water. Damaged cables must be replaced, not repaired with
                      tape
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      only competent persons (qualified electricians) should make or break
                      connections to the site electrical system. All connections must be made using
                      proper connectors &mdash; never by twisting bare wires together. Isolation
                      procedures must be followed before any work on the distribution system
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-green-400">Inspection Schedule:</strong> Temporary
                  electrical installations on construction sites should be inspected and tested at
                  intervals not exceeding 3 months. This is more frequent than for permanent
                  installations because of the harsher conditions and greater risk of damage.
                  Records of all inspections and tests must be kept on site and available for
                  examination by the HSE, client, or principal contractor.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                source &mdash; can result in the rescuer also becoming a casualty. Speed is
                critical, but safety must come first.
              </p>

              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-red-400">Critical Warning:</strong> Do NOT touch a person
                  who is receiving an electric shock or who is in contact with a live conductor. If
                  you touch them, the current will flow through you as well. This is one of the most
                  common causes of multiple casualties in electrical incidents.
                </p>
              </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="p-3 rounded-lg bg-orange-500/5 border border-orange-500/20">
                    ...
                    <p className="text-sm text-white/80">
                      ...
                      do not approach &mdash; call the emergency services and the electricity
                      company immediately.
                    </p>
                  </div>
                  ...
                  <div className="p-3 rounded-lg bg-yellow-500/5 border border-yellow-500/20">
                    ...
                    <p className="text-sm text-white/80">
                      ...
                      non-conductive surface. Do not use anything wet, metallic, or damp.
                    </p>
                  </div>
                  ...
                  <div className="p-3 rounded-lg bg-green-500/5 border border-green-500/20">
                    ...
                    <p className="text-sm text-white/80">
                      ...
                      they must be assessed by paramedics as cardiac complications can develop
                      later.
                    </p>
                  </div>
                  ...
                  <div className="p-3 rounded-lg bg-blue-500/5 border border-blue-500/20">
                    ...
                    <p className="text-sm text-white/80">
                      ...
                      Defibrillator). Place the casualty in the recovery position if they are
                      breathing but unconscious. Treat any burns by cooling with clean water (do not
                      apply creams, lotions, or adhesive dressings directly to electrical burns).
                    </p>
                  </div>
                </div>
              </div>
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      around an electrical incident should be secured and preserved as far as
                      possible for investigation. Do not disturb equipment, tools, or cables unless
                      it is necessary to make the area safe or to administer first aid
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      ...
                      employer, principal contractor, and (in serious cases) the HSE will
                      investigate the incident. The investigation will examine the root cause,
                      whether safe systems of work were in place and followed, whether equipment was
                      properly maintained and tested, and whether competent persons were supervising
                      the work. Findings will inform corrective actions to prevent recurrence
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Recording and lessons learnt</strong> &mdash;
                      all electrical incidents, including near misses, should be recorded in the
                      site accident book and discussed at the next toolbox talk or site safety
                      meeting. Near misses are particularly valuable as learning opportunities
                      because they highlight weaknesses in the system before someone is hurt
                    </span>
                  </li>
                </ul>
              </div>
