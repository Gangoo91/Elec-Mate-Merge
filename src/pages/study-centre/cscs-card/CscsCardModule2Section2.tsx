...
const faqs = [
  ...
  {
    question: 'Can an employer charge employees for PPE?',
    answer:
  ...
  {
    question: 'What is the difference between CE marking and UKCA marking on PPE?',
    answer:
...
const quizQuestions = [
  ...
  {
    id: 8,
    question: "What is the employer's duty regarding PPE training?",
    options: [
...
const CscsCardModule2Section2 = () => {
  useSEO({
    title: 'Personal Protective Equipment | CSCS Card Module 2.2',
    description:
          ...
          <div className="rounded-lg p-4 bg-green-500/5 border-l-2 border-green-500/50">
            ...
            <ul className="text-white/80 text-base space-y-1.5">
              <li className="flex items-start gap-2">
                ...
                <span>
                  <strong className="text-white">PPE:</strong> equipment that protects the wearer
              ...
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Last resort:</strong> only after elimination,
              ...
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Employer duty:</strong> provide free, suitable PPE
                  and train workers to use it
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Employee duty:</strong> wear it correctly, report
                  defects, store it properly
                </span>
              </li>
            </ul>
          </div>
          <div className="rounded-lg p-4 bg-green-500/5 border-l-2 border-green-500/50">
            ...
            <ul className="text-white/80 text-base space-y-1.5">
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Check PPE:</strong> before every use — look for
                  damage, wear, and contamination
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Right PPE:</strong> for the right task — one size
                  does not fit all hazards
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Report defects:</strong> do not use damaged PPE —
              ...
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Face-fit:</strong> tight-fitting RPE must be
                  face-fit tested to each wearer
                </span>
              </li>
            </ul>
          </div>
          ...
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                (as amended 2022) as all equipment (including clothing affording protection against
                the weather) which is intended to be worn or held by a person at work and which
                protects the person against one or more risks to their health or safety.
              </p>
              ...
              <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  protection, hearing protection, and respiratory protective equipment (RPE).
                </p>
              </div>

              <p>
                The 2022 amendment extended PPE duties to cover{' '}
                <strong className="text-white">limb (b) workers</strong> — workers who are not
                employees but who work under similar arrangements (such as agency workers and casual
                workers). This means more people are now protected by the Regulations.
              </p>
              ...
              <div className="bg-white/5 border border-green-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/70 text-sm">
                  ...
                  <strong className="text-white">elimination</strong> (remove the hazard entirely),{' '}
                  <strong className="text-white">substitution</strong> (replace with something less
                  hazardous), <strong className="text-white">engineering controls</strong> (isolate
                  people from the hazard),{' '}
                  <strong className="text-white">administrative controls</strong> (change the way
                  people work), and only then <strong className="text-white">PPE</strong> (protect
                  the individual). PPE only protects the person wearing it, and only if it is worn
          ...
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                contact with electrical hazards all pose risks to the head.{' '}
                <strong className="text-white">Hard hats</strong> (industrial safety helmets) are
                the primary form of head protection on construction sites.
              </p>
              ...
              <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  absorption, resistance to penetration, flame resistance, and the performance of
                  the chin strap anchorage points. Optional requirements include resistance to very
                  low temperatures (-20&deg;C or -30&deg;C), resistance to molten metal splash,
                  lateral deformation, and electrical insulation.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-2 text-sm">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Hard hats (EN 397):</strong> full-brim or
                      peaked helmets designed to protect against falling objects, impact with fixed
                      objects, and (optionally) electrical contact. Required on most construction
                      sites
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Bump caps:</strong> lightweight caps that
                      protect against bumps and scrapes from fixed objects in confined spaces. They
                      do NOT protect against falling objects and are NOT suitable for construction
                      site use where there is a risk of objects falling from height
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Chin straps:</strong> must be used when there
                      is a risk of the helmet being dislodged — for example, when working at height,
                      in windy conditions, or near rotating machinery
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <p>
                Hard hats must be inspected before each use. Look for cracks, dents, UV degradation
                (chalky or faded appearance), damaged cradles, and frayed or damaged headbands. A
                hard hat must be{' '}
                <strong className="text-white">
                  replaced immediately after any significant impact
                </strong>
                , even if no visible damage is apparent — the internal structure may be compromised.
                Most manufacturers recommend replacement every{' '}
                <strong className="text-white">3 to 5 years</strong>, depending on conditions of
                use.
              </p>
          ...
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                or face protection must be selected based on the specific hazard.
              </p>
              ...
              <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  protection: <strong className="text-white">S</strong> (increased robustness),{' '}
                  <strong className="text-white">F</strong> (low-energy impact),{' '}
                  <strong className="text-white">B</strong> (medium-energy impact), and{' '}
                  <strong className="text-white">A</strong> (high-energy impact). The marking also
                  indicates protection against liquids (3), dust (4), gas (5), and short-circuit
                  electric arc (8).
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-2 text-sm">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Safety spectacles:</strong> lightweight glasses
                      with side shields. Suitable for low-energy impact hazards such as light
                      grinding, drilling, and general site work. Must have impact-resistant lenses
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Safety goggles:</strong> close-fitting eye
                      protection with a seal around the eyes. Required for protection against
                      chemical splash, dust, and fine particles. Available with direct or indirect
                      ventilation
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Face shields/visors:</strong> protect the
                      entire face from splash, spray, and medium-energy impact. Used for tasks such
                      as cutting, heavy grinding, and working with chemicals. A face shield alone
                      may not provide adequate eye protection — it should often be worn with safety
                      goggles underneath
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Welding filters:</strong> specialised
                      protection against intense light and UV/IR radiation from welding arcs.
                      Available as fixed shade or auto-darkening filters. The shade number must
                      match the welding process and amperage
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <strong className="text-white">Impact (flying particles):</strong> safety
                      spectacles (F-rated) or goggles (B-rated) depending on energy level
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-green-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Chemical splash:</strong> chemical-splash
                      goggles (sealed, indirect ventilation) or face shield with goggles
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-green-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Dust:</strong> dust-tight goggles (4-rated)
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-green-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">UV/welding arc:</strong> welding filter of
                      appropriate shade number for the process
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                sites are among the noisiest workplaces, with activities such as breaking out
                concrete, angle grinding, hammering, and operating heavy plant regularly exceeding
                safe noise levels. The{' '}
                <strong className="text-white">Control of Noise at Work Regulations 2005</strong>{' '}
                set out the legal duties for managing noise exposure.
              </p>

              <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                <h3 className="font-semibold mb-3 text-green-400">Noise Exposure Action Levels</h3>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-2 text-sm">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Disposable ear plugs:</strong> foam plugs that
                      expand to fill the ear canal. Single-use, cost-effective, and widely
                      available. Must be inserted correctly (rolled, inserted, and held until
                      expanded) to be effective. Typical SNR: 25–37 dB
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Reusable ear plugs:</strong> pre-moulded or
                      custom-moulded plugs that can be washed and reused. More comfortable for
                      extended wear but must be cleaned regularly to prevent ear infections
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Ear defenders (muffs):</strong> cups that fit
                      over the entire outer ear, held in place by a headband. Easier to fit
                      correctly than ear plugs, readily visible (supervisors can see they are being
                      worn), and available in helmet-mounted versions. Typical SNR: 20–35 dB
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Dual protection:</strong> combining ear plugs
                      and ear defenders for very high noise environments. Note: dual protection does
                      not double the attenuation — the combined effect is typically the higher SNR
                      plus an additional 5–6 dB
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  level. However, real-world protection is typically lower than the laboratory SNR,
                  so the HSE recommends applying a{' '}
                  <strong className="text-white">real-world reduction factor</strong> of
                  approximately 4 dB less than the SNR for ear defenders and approximately 4 dB less
                  for well-fitted ear plugs. Always select hearing protection that reduces the noise
                  at the ear to below 85 dB(A), ideally to between 70 and 80 dB(A). Over-protection
                  should be avoided as it can isolate the wearer and create different safety risks.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                proportion of all reported injuries. Selecting the correct type of glove for the
                task is essential — there is no single glove that protects against all hazards.
              </p>
              ...
              <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  <strong className="text-white">puncture</strong> (0–4). The 2016 revision added an{' '}
                  <strong className="text-white">ISO cut level</strong> (A–F) and optional{' '}
                  <strong className="text-white">impact protection</strong> (P). Higher numbers and
                  later letters indicate better performance.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-2 text-sm">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Rigger gloves:</strong> heavy-duty leather or
                      synthetic gloves for general handling, lifting, and carrying. Good abrasion
                      resistance but limited cut protection. Commonly used for handling timber,
                      scaffolding tubes, and building materials
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Nitrile-coated gloves:</strong> lightweight
                      gloves with a nitrile coating on the palm and fingers. Good grip in wet and
                      oily conditions, good dexterity, and moderate cut resistance. Suitable for
                      handling sheet metal, fixings, and light assembly work
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Chemical-resistant gloves:</strong> made from
                      materials such as nitrile, neoprene, PVC, or butyl rubber to resist permeation
                      by specific chemicals. Must be selected based on the exact chemicals in use —
                      no single material resists all chemicals. Check the safety data sheet (SDS)
                      for the substance being handled
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Cut-resistant gloves:</strong> reinforced with
                      materials such as HPPE (high-performance polyethylene), Kevlar, or steel
                      fibres. Essential for handling sharp materials such as glass, sheet metal, and
                  ...
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Insulated gloves:</strong> electrically
                      insulating gloves rated for specific voltage classes (Class 00 to Class 4)
                      under EN 60903. Essential for live electrical work. Must be tested at regular
                      intervals and inspected before every use. Often worn with leather over-gloves
              ...
              <div className="bg-white/5 border border-green-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/70 text-sm">
                  ...
                  the machine, causing severe injury. Always check the risk assessment and machine
          ...
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                screws, glass), slips, and chemical contact.{' '}
                <strong className="text-white">Safety boots</strong> must comply with{' '}
                <strong className="text-white">EN ISO 20345</strong>, the European standard for
                safety footwear.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-2 text-sm">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Steel toe caps:</strong> traditional, very
                      strong, and cost-effective. Heavier than composite alternatives. Conduct heat
                      and cold, which can be uncomfortable in extreme temperatures. May trigger
                      metal detectors at security-sensitive sites
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Composite toe caps:</strong> made from
                      materials such as fibreglass, carbon fibre, or Kevlar. Lighter than steel,
                      non-metallic (do not trigger metal detectors), and do not conduct heat or
                      cold. Increasingly popular on modern construction sites. Meet the same 200J
                      impact standard as steel
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <p>
                Safety boots should be replaced when the sole tread is worn smooth (reducing slip
                resistance), when the toe cap is exposed or damaged, when the boot no longer
                provides adequate ankle support, or when the waterproofing has failed. Always lace
                boots fully to provide proper ankle support and prevent the boot from coming off
                during slips or trips.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                harmful substances — including dust, fumes, vapours, gases, and biological agents.
                On construction sites, RPE is commonly required for tasks involving silica dust,
                wood dust, welding fumes, paint spraying, and asbestos work.
              </p>
              ...
              <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  airways). RPE has additional legal requirements under the{' '}
                  <strong className="text-white">
                    Control of Substances Hazardous to Health Regulations (COSHH)
                  </strong>{' '}
                  and the{' '}
                  <strong className="text-white">Control of Asbestos Regulations 2012</strong>,
                  including the requirement for{' '}
                  <strong className="text-white">face-fit testing</strong> of tight-fitting
                  facepieces.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-2 text-sm">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Half-face respirators:</strong> cover the nose
                      and mouth. Use replaceable filter cartridges for particles, gases, or combined
                      hazards. More cost-effective than disposable masks for regular use. Assigned
                      Protection Factor up to 10 (particle filters) or 10 (gas/vapour filters)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Full-face respirators:</strong> cover the
                      entire face, providing eye protection as well as respiratory protection.
                      Higher Assigned Protection Factor (up to 20 for particle filters, 20 for
                      gas/vapour). Used for higher-risk exposures and where eye protection is also
                      needed
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      battery-powered units that draw air through a filter and deliver it to a hood,
                      helmet, or visor. Do not require a tight face seal, making them suitable for
                      workers with facial hair or who cannot achieve a satisfactory face fit. Higher
              ...
              <div className="bg-white/5 border border-green-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/70 text-sm mb-3">
                  ...
                  A face-fit test checks that the facepiece makes an adequate seal against the
                ...
                <ul className="text-white/70 space-y-1.5 text-sm">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Qualitative test:</strong> uses a bitter or
                      sweet aerosol to check for leakage — if the wearer can taste the aerosol, the
                      fit is inadequate
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Quantitative test:</strong> uses a particle
                      counter to measure the ratio of particles inside and outside the facepiece,
                      giving a numerical fit factor
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      Under the{' '}
                      <strong className="text-white">Control of Asbestos Regulations 2012</strong>,
                      face-fit testing is <strong className="text-white">mandatory</strong> for all
                  ...
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      Facial hair (bears, stubble) prevents a proper seal — workers with facial hair
                      must use <strong className="text-white">loose-fitting RPE</strong> (such as
                      powered hoods) instead
                    </span>
                  </li>
                </ul>
              </div>
          ...
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                conspicuous to vehicle and plant operators, reducing the risk of being struck.
                Hi-vis clothing must comply with{' '}
                <strong className="text-white">EN ISO 20471</strong>.
              </p>

              <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                <h3 className="font-semibold mb-3 text-green-400">EN ISO 20471 — Hi-Vis Classes</h3>
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-yellow-500/20 border border-yellow-400/30 flex items-center justify-center flex-shrink-0 mt-0.5">
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-2 text-sm">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Fall protection harnesses:</strong> full-body
                      harnesses with lanyards and energy absorbers used when working at height where
                      collective protection (guard rails, safety nets) is not practicable. Must be
                      inspected every 6 months by a competent person and replaced after any fall
                      arrest event
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Knee pads:</strong> protect the knees from
                      prolonged kneeling on hard surfaces. Essential for trades that involve
                      floor-level work such as tiling, cable routing, and under-floor installations.
                      Help prevent bursitis (swollen knee joints)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Weather protection:</strong> waterproof
                      jackets, thermal layers, and sun protection (hats, sunscreen) for outdoor
                      work. The PPE at Work Regulations include clothing that protects against the
                  ...
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Skin protection:</strong> barrier creams, sun
                      cream (SPF 30+), and after-work moisturisers to protect against dermatitis and
                      skin cancer — particularly for outdoor workers exposed to UV
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-2 text-sm">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Maintenance:</strong> employers must ensure PPE
                      is maintained in good working order. This includes cleaning, inspection,
                      repair, and replacement of worn or damaged items. Manufacturer&rsquo;s
                  ...
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Storage:</strong> PPE must be stored in a
                      clean, dry, designated area when not in use. It must not be left on the
                      ground, exposed to sunlight (which degrades plastics), or stored near
                      chemicals that could contaminate or damage it. Individual storage lockers or
                  ...
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Training:</strong> the employer must provide
                      information, instruction, and training on why the PPE is needed, how to use it
                      correctly, how to check it before use, how to maintain and store it, and its
                      limitations. Training should be refreshed when new PPE is introduced or when
                      there are changes to risk assessments
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Record keeping:</strong> employers should keep
                      records of PPE issued, face-fit test results, training provided, and
                      inspection and maintenance schedules. This provides evidence of compliance and
                      helps track replacement needs
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  <strong className="text-white">UKCA marking</strong> (UK Conformity Assessed)
                  confirms compliance with the equivalent UK regulations. During the transition
                  period, both marks are accepted in Great Britain. Always check that PPE carries
                  the correct mark and that it is genuine — counterfeit PPE is a serious and growing
                  problem. Look for the mark on the product itself (not just the packaging), along
                  with the relevant standard number, the manufacturer&rsquo;s name, and the notified
                ...
                <div className="space-y-2 text-sm text-white/70">
                  ...
                  <ul className="space-y-1.5">
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                      <span>
                        <strong className="text-white">Category I (Simple):</strong> protects
                        against minimal risks — e.g., gardening gloves, sunglasses.
                    ...
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                      <span>
                        <strong className="text-white">Category II (Intermediate):</strong> protects
                        against medium risks — e.g., safety glasses, hi-vis clothing, safety boots.
                        Requires EU/UK type examination by a notified body
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                      <span>
                        <strong className="text-white">Category III (Complex):</strong> protects
                        against fatal or irreversible risks — e.g., RPE, fall protection harnesses,
                        chemical suits. Requires EU/UK type examination PLUS ongoing conformity
