...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'The correct ratio for a leaning ladder is 1:4. For every four units of height, the base of the ladder should be one unit away from the structure. This gives an angle of approximately 75 degrees and provides the best balance between stability and usability.',
  },
  {
  ...
  },
  {
    ...
    question:
      'Which training accreditation is the industry standard for operating Mobile Elevating Work Platforms (MEWPs)?',
    options: ['PASMA', 'CSCS', 'IPAF', 'NASC'],
    correctIndex: 2,
    explanation:
      'IPAF (International Powered Access Federation) is the recognised industry standard for MEWP operator training. PASMA covers mobile access towers. Operators must hold the correct IPAF category licence for the type of MEWP they are using.',
  },
];
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Immediately stop using the equipment and take it out of service. Report the defect to your supervisor or site manager. Attach a clear 'Do Not Use' label or tag. Record the defect in the site defect log. Never attempt to repair access equipment yourself unless you are trained and authorised to do so. Defective equipment must not be used under any circumstances until it has been repaired and re-inspected by a competent person.",
  },
];
...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      "PASMA (Prefabricated Access Suppliers' and Manufacturers' Association) training is the industry-recognised standard for the safe assembly, alteration, and dismantling of mobile access towers. Untrained persons must not assemble or dismantle towers.",
  },
  {
    id: 3,
    question:
      'What is the maximum height-to-base ratio for an indoor mobile access tower without outriggers?',
    options: ['2.5:1', '3:1', '3.5:1', '4:1'],
    correctAnswer: 2,
    explanation:
      'For indoor use, the maximum height-to-base ratio is 3.5:1 without outriggers. For outdoor use, this reduces to 3:1 due to the additional wind loading. Outriggers or stabilisers must be used if these ratios would otherwise be exceeded.',
  },
  {
    id: 4,
  ...
  },
  {
    id: 5,
    question:
      'Which of the following is a key component of scaffolding that provides diagonal bracing?',
    options: ['Standards', 'Ledgers', 'Transoms', 'Braces'],
    correctAnswer: 3,
    explanation:
      'Braces are the diagonal tubes that provide rigidity and prevent the scaffold from swaying or racking. Standards are the vertical poles, ledgers are the horizontal tubes running along the length, and transoms are the horizontal tubes running across the width.',
  },
  {
    id: 6,
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      "Roof ladders and crawling boards are used on pitched roofs to provide a safe working position, and on fragile roofs to distribute the worker's weight and prevent them from falling through the roofing material. They must be properly secured at the ridge.",
  },
  {
    id: 8,
    ...
    correctAnswer: 1,
    explanation:
      'The hierarchy of control requires you to first consider whether work at height can be avoided altogether. Only if the task cannot be carried out from ground level should you proceed to select the most appropriate access equipment for the job.',
  },
];
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-green-500/5 border-l-2 border-green-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Selection:</strong> Match equipment to height, duration, task &amp;
                conditions
              </li>
              <li>
                <strong>Principle:</strong> Collective protection before personal protection
              </li>
              <li>
                <strong>Training:</strong> PASMA for towers, IPAF for MEWPs, competent for all
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-green-500/5 border-l-2 border-green-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Before:</strong> Risk assess, check equipment, verify training
              </li>
              <li>
                <strong>During:</strong> Inspect before each use, follow safe systems of work
              </li>
              <li>
                <strong>Always:</strong> Report defects, never use damaged equipment
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Selecting the correct access equipment is one of the most important decisions you
                will make when planning work at height. The wrong choice can lead to instability,
                falls, and serious injuries. HSE guidance document INDG401 provides a practical
                framework for making this decision, and your selection must always follow the
                hierarchy of control established by the Work at Height Regulations 2005.
              </p>

              <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-green-400">Key Principle:</strong> Always prefer
                  collective protection (guardrails, scaffolding, towers) over personal protection
                  (harnesses, lanyards). Collective measures protect everyone in the area without
                  requiring individual action, whereas personal protection only works if used
                  correctly every time.
                </p>
              </div>

              <p>
                Before selecting any equipment, you must consider six critical factors. Each one
                influences which type of access is appropriate, and ignoring any of them can result
                in an unsafe system of work.
              </p>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-3">
                  Six Factors for Equipment Selection
                </p>
              ...
              <div className="bg-[#111] border border-green-500/20 rounded-lg p-4 sm:p-6">
                <p className="text-sm font-semibold text-green-400 mb-4 text-centre">
                  Equipment Selection Flowchart
                </p>
                <div className="space-y-3 text-sm">
                    ...
                    <div className="text-centre">
                      ...
                      <div className="bg-green-500/20 border border-green-500/40 rounded px-3 py-1.5">
                        <p className="text-white text-xs">
                          Use long-reach tools / work at ground level
                        </p>
                      </div>
                    </div>
                    <div className="text-centre">
                      ...
                      <div className="bg-white/5 border border-white/10 rounded px-3 py-1.5">
                        <p className="text-white text-xs">
                          Is the task short (&lt;30 min), light, low height?
                        </p>
                      </div>
                    </div>
                  </div>
                  <div
                    className="flex justify-centre gap-4 sm:gap-8 ml-auto"
                  ...
                  >
                    ...
                    <div className="text-centre">
                      ...
                      <div className="bg-white/5 border border-white/10 rounded px-3 py-1.5">
                        <p className="text-white text-xs">
                          Is the work area fixed or does it move?
                        </p>
                      </div>
                    </div>
                  </div>
                  <div
                    className="flex justify-centre gap-4 sm:gap-8 ml-auto"
                    style={{ maxWidth: '55%', marginLeft: 'auto' }}
                  >
                    <div className="text-centre">
              ...
              <ul className="text-sm text-white/80 space-y-1.5">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    Always start with the hierarchy: avoid height, then prevent falls, then mitigate
                    consequences
                  </span>
                </li>
                <li className="flex items-start gap-2">
                ...
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                  <span>
                    Consider whether the equipment is suitable for the specific site conditions, not
                    just the task
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                  <span>
                    Ensure all operatives are trained and competent to use the selected equipment
                  </span>
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Ladders and stepladders are among the most commonly used — and most commonly misused
                — pieces of access equipment on construction sites. The HSE does not ban ladder use,
                but their guidance document INDG401 sets clear limits on when ladders are
                appropriate. A ladder should only ever be the last resort for work at height, used
                when more stable equipment is not reasonably practicable.
              </p>
              ...
              <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1.5">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Short duration</strong> — the task will take no
                      longer than 30 minutes in one position
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Light work only</strong> — you can maintain
                  ...
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Low risk</strong> — the risk assessment
                      confirms a ladder is the most suitable option
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">No heavy loads</strong> — you should not carry
                      loads that prevent you from gripping the ladder
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-[#111] border border-green-500/20 rounded-lg p-4 sm:p-6">
                <p className="text-sm font-semibold text-green-400 mb-4 text-centre">
                  Ladder Setup Diagram — 1:4 Ratio
                </p>
                <div className="flex items-end gap-2 sm:gap-4 justify-centre">
                  ...
                  {/* Ground distance */}
                  <div
                    className="flex flex-col items-centre justify-end"
                    style={{ height: '170px' }}
                  >
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white/80 space-y-1.5">
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                      <span>
                        Set at a 1:4 ratio (75-degree angle) — one unit out for every four units up
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                      <span>
                        Secure at the top with a tie or, if not possible, secure at the base
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                      <span>
                        Extend at least 3 rungs (approximately 1 metre) above the landing point
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                      <span>
                        Rest on a firm, level surface — never on loose materials or unstable ground
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white/80 space-y-1.5">
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                      <span>
                        <strong className="text-white">Class 1 (Industrial)</strong> — rated for
                        heavy-duty trade use, 175 kg maximum load
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                      <span>
                        <strong className="text-white">EN 131 Professional</strong> — meets the
                        European standard for professional/trade use
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                      <span>
                        <strong className="text-white">EN 131 Non-Professional</strong> — domestic
                        use only, NOT suitable for site work
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                      <span>
                        Always check the duty rating label before using any ladder on site
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  ladders are fully engaged. If any defect is found, the ladder must be taken out of
                  service immediately and labelled as defective.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Mobile access towers (also called mobile scaffold towers) provide a stable, guarded
                working platform and are one of the most commonly used forms of access equipment in
                the construction industry. They are particularly suited to tasks that require a
                stable platform at height for extended periods, such as electrical installation,
                painting, and plastering.
              </p>

              <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-green-400">PASMA Training Required:</strong> Only persons
                  who have completed PASMA (Prefabricated Access Suppliers' and Manufacturers'
                  Association) training should assemble, alter, or dismantle mobile access towers.
                  This is the industry-recognised standard and is a requirement on most construction
                  sites. PASMA training covers the 3T method (Through the Trap) and the AGR method
                  (Advance Guard Rail) for safe assembly.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1.5">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      Always follow the manufacturer's instruction manual — never improvise
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      Assemble on firm, level ground using base plates and sole boards where needed
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      Use the 3T (Through the Trap) or AGR (Advance Guard Rail) method as trained
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      Build from the ground up, platform by platform, following the correct sequence
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                  ...
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      Dismantle in reverse order, never from the top down without protection
                    </span>
                  </li>
                </ul>
              </div>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white/80 space-y-1.5">
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                      <span>
                        <strong className="text-white">Indoors:</strong> 3.5:1 without
                    ...
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                      <span>
                        <strong className="text-white">Outdoors:</strong> 3:1 without
                        outriggers/stabilisers
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                      <span>
                        Outriggers increase the effective base size and allow greater heights
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white/80 space-y-1.5">
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                      <span>
                        Lock all castors before climbing — never move a tower with people on it
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                      <span>
                        Deploy outriggers and stabilisers when required by the configuration
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    ...
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                      <span>
                        Check for overhead obstructions before moving the tower to a new position
                      </span>
                    </li>
                  </ul>
                </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Scaffolding is the most common form of access equipment on construction sites. It
                provides a large, stable working area at height and is suitable for prolonged tasks,
                heavy loads, and multiple workers. Scaffolding must be designed, erected, and
                dismantled by competent persons, and it must comply with NASC (National Access and
                Scaffolding Confederation) standards, particularly TG20 for tube-and-fitting
                scaffolds.
              </p>
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-white/80">
                      ...
                      putlogs can be embedded in the wall.
                    </p>
                  </div>
                  <div>
                ...
                <div className="grid sm:grid-cols-2 gap-2 text-sm text-white/80">
                  <div>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                      <span>
                        <strong className="text-white">Standards</strong> — vertical tubes that
                        carry the load to the ground
                      </span>
                    </li>
                    ...
                    <li className="flex items-start gap-2 mt-1.5">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                      <span>
                        <strong className="text-white">Braces</strong> — diagonal tubes that prevent
                        racking and sway
                      </span>
                    </li>
                  </div>
                  <div>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                      <span>
                        <strong className="text-white">Toe Boards</strong> — minimum 150mm high,
                    ...
                    <li className="flex items-start gap-2 mt-1.5">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                      <span>
                        <strong className="text-white">Guard Rails</strong> — top rail at minimum
                        950mm above platform
                      </span>
                    </li>
                    <li className="flex items-start gap-2 mt-1.5">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                      <span>
                        <strong className="text-white">Base Plates</strong> — spread the load at the
                        bottom of each standard
                      </span>
                    </li>
                    <li className="flex items-start gap-2 mt-1.5">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                      <span>
                        <strong className="text-white">Sole Boards</strong> — timber boards under
                        base plates on soft ground
                      </span>
                    </li>
                  </div>
                </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1.5">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      TG20 provides design guidance for standard tube-and-fitting scaffolds — if a
                      scaffold falls outside TG20 parameters, it must be individually designed by a
                      scaffold designer
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      Scaffolds must be inspected before first use, after any alteration, after
                      adverse weather, and at intervals not exceeding 7 days
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      Inspections must be carried out by a competent person and formally recorded
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      Records must be kept on site until the scaffold is dismantled, then retained
                      for 3 months
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      Never use a scaffold without checking the tag — if there is no tag, treat it
                      as a red tag and do not use it
                    </span>
                  </li>
                </ul>
              </div>
          ...
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                platforms that can be raised, lowered, and in some cases extended to reach working
                positions at height. They offer excellent access for tasks that require frequent
                repositioning or reaching multiple heights. IPAF (International Powered Access
                Federation) training is the recognised industry standard for MEWP operators.
              </p>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white/80 space-y-1.5">
                    ...
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                      <span>
                        Deploy outriggers fully on firm ground before operating boom lifts
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                      <span>
                        Establish exclusion zones to prevent people entering the work area
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  equipment is available (e.g. ground-level controls, secondary MEWP), and how
                  emergency services will be contacted. The rescue must be achievable within a
                  reasonable timeframe to prevent suspension trauma.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Podium steps and hop-ups are designed for low-level access, typically where the
                working height is below 2 metres. They bridge the gap between a simple stepladder
                and a full mobile access tower, providing a more stable and safer working platform
                for tasks that do not justify larger equipment. Their popularity has grown
                significantly as the industry has moved away from using stepladders for tasks where
                a more stable platform is reasonably practicable.
              </p>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white/80 space-y-1.5">
                    ...
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                      <span>
                        Include guardrails on all sides of the platform for fall prevention
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white/80 space-y-1.5">
                    ...
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                      <span>
                        Suitable for very low-level access tasks such as light switch installation
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    ...
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                      <span>
                        Never use makeshift hop-ups (crates, buckets, pallets are not suitable)
                      </span>
                    </li>
                  </ul>
                </div>
              ...
              <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-green-400">Advantages Over Stepladders:</strong> Podium
                  steps provide a significantly larger and more stable working platform than
                  stepladders. The guardrails mean the user is protected from falls on all sides.
                  Both hands are free for the task as there is no need to hold on for balance. The
                  wider base makes them inherently more stable, and they are less likely to tip when
                  reaching sideways. For any low-level task lasting more than a few minutes, podium
                  steps should be the default choice over a stepladder.
                </p>
              </div>
          ...
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                sloping roofs and fragile roofing surfaces. They distribute the user's weight across
                a larger area and provide a secure working position on surfaces where standing
                unaided would be extremely dangerous. They are always used in combination with other
                protective measures, never as the sole means of fall prevention.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1.5">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Pitched roofs</strong> — where the slope angle
                      makes standing or walking unsafe without support
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Fragile roofing materials</strong> — cement
                      fibre sheets, skylights, glass panels, and aged roofing felt that cannot
                  ...
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Inspection and repair tasks</strong> — where
                      the work area is limited and short-duration access is required
                    </span>
                  </li>
                </ul>
              </div>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white/80 space-y-1.5">
                    ...
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                      <span>
                        The ridge hook must bear on the opposite slope, not just the ridge tile
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    ...
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                      <span>
                        Never rest a roof ladder on guttering — it cannot support the load
                      </span>
                    </li>
                  </ul>
                </div>
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white/80 space-y-1.5">
                    ...
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                      <span>
                        Must span at least three purlins or rafters to properly distribute weight
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                      <span>
                        Used on fragile roofs where the roofing material cannot bear point loads
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                      <span>
                        Always used with additional fall protection (nets, harnesses, or both)
                      </span>
                    </li>
                  </ul>
                </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  confirmed otherwise by a competent person. Warning notices reading "FRAGILE ROOF"
                  must be displayed at all access points to fragile roofs. Roof ladders and crawling
                  boards alone are not sufficient protection — they must be combined with additional
                  measures such as safety nets, harnesses, or underneath platforms.
                </p>
              </div>
              ...
              <ul className="text-sm text-white/80 space-y-1.5">
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                  <span>
                    Never walk directly on fragile roofing materials, even if they appear sound
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                  <span>
                    Combine roof ladders or crawling boards with edge protection at the eaves
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                  <span>
                    Carry out a risk assessment specific to the roof type and condition before
                    starting
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                  <span>
                    Consider whether the task can be done from underneath using a MEWP or internal
                    platform
                  </span>
                </li>
              </ul>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Every piece of access equipment must be regularly inspected and properly maintained
                to ensure it remains safe for use. Inspection requirements fall into two categories:
                informal pre-use checks carried out by the user before each use, and formal
                inspections carried out by a competent person at defined intervals. Both are
                essential, and failure to carry out either is a breach of the Work at Height
                Regulations.
              </p>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white/80 space-y-1.5">
                    ...
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                      <span>
                        Ensure all parts are present — no missing rungs, pins, clips, or boards
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                      <span>
                        Test locking mechanisms, catches, and hinges for correct operation
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    ...
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                      <span>
                        Check labels and markings are legible (load rating, manufacturer, standards)
                      </span>
                    </li>
                  </ul>
                </div>
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white/80 space-y-1.5">
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                      <span>
                        <strong className="text-white">Scaffolds &amp; towers:</strong> before first
                        use, after alteration, every 7 days, and after any adverse event
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                      <span>
                        <strong className="text-white">MEWPs:</strong> 6-monthly thorough
                        examination under LOLER 1998, daily pre-use checks
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                      <span>
                        <strong className="text-white">Ladders:</strong> regular inspection schedule
                        set by the employer (frequency based on use)
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                      <span>
                        <strong className="text-white">Harnesses &amp; lanyards:</strong> 6-monthly
                    ...
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                      <span>
                        Must be carried out by a competent person (not necessarily the user)
                      </span>
                    </li>
                  </ul>
                </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1.5">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Stop immediately</strong> — cease using the
                      equipment as soon as a defect is identified
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Isolate the equipment</strong> — attach a "Do
                      Not Use" or "Defective" tag to prevent others from using it
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Report to supervisor</strong> — inform your
                      immediate supervisor or site manager verbally and in writing
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Record the defect</strong> — enter details in
                      the site defect log including the date, equipment ID, and nature of the defect
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Remove from service</strong> — move defective
                      equipment to a quarantine area where possible, away from usable stock
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Do not repair</strong> — never attempt to
                      repair access equipment unless you are trained, authorised, and using approved
                      parts
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  inspection records must be kept on site until the scaffold is dismantled, then
                  retained for a minimum of 3 months. LOLER examination reports for MEWPs must be
                  kept until the next examination is due. Good record keeping demonstrates
                  compliance and provides evidence of your duty of care.
                </p>
              </div>
            </div>
          </div>
