      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-green-500/5 border-l-2 border-green-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Confined Spaces Regulations 1997</strong> &mdash; substantially enclosed +
                foreseeable risk
              </li>
              <li>
          ...
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                place that is <strong>substantially (but not necessarily entirely) enclosed</strong>{' '}
                and where there is a <strong>reasonably foreseeable risk of serious injury</strong>{' '}
                from hazardous conditions within the space or from substances or conditions within
                it. Both elements must be present for a space to be classified as confined.
              </p>

              <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-green-400">Critical Point:</strong> Size alone does not
                  determine whether a space is confined. A large underground chamber can be a
                  confined space, and a small cupboard may not be. The key test is whether the space
                  is substantially enclosed AND presents a foreseeable risk of serious injury from
                  hazardous conditions such as toxic gas, oxygen depletion, flooding, or engulfment.
                </p>
              </div>

              <p>
                Confined spaces are found throughout construction sites and are not always
                immediately obvious. Workers must be trained to recognise confined spaces and to
                understand that entry should only occur when absolutely necessary and with a proper
                ...
                <div className="grid sm:grid-cols-2 gap-2">
                  <ul className="text-sm text-white space-y-2">
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        <strong className="text-white">Tanks and vessels</strong> &mdash; water
                        tanks, fuel storage tanks, chemical vessels
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                      <span>
                        <strong className="text-white">Manholes and inspection chambers</strong>{' '}
                        &mdash; drainage, sewerage, and utility access points
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                  ...
                  <ul className="text-sm text-white space-y-2">
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                      <span>
                        <strong className="text-white">Ceiling voids and roof spaces</strong>{' '}
                        &mdash; particularly in refurbishment and retrofit work
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
              ...
              <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  ...
                  system of work and adequate emergency arrangements in place. The associated
                  Approved Code of Practice (ACOP L101) provides detailed guidance on compliance.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Confined spaces present a range of serious and often fatal hazards. These hazards
                may exist before entry, may develop during the work, or may arise from the work
                activities themselves. The enclosed nature of the space means that hazardous
                conditions can develop rapidly and without warning, making confined spaces one of
                the most dangerous environments on any construction site.
              </p>
          ...
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                optional &mdash; it is a legal requirement enforceable under the Health and Safety
              ...
              <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-green-400">
                    Regulation 4 &mdash; Avoidance of Entry:
                  </strong>{' '}
                  ...
                  entry. This means employers must first explore every alternative before permitting
                  entry.
                </p>
              </div>
              ...
              <ul className="text-sm text-white space-y-2">
                ...
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                  <span>
                    <strong className="text-white">Atmospheric monitoring</strong> &mdash;
                    continuous monitoring of oxygen, flammable gas, and toxic gas levels before and
                    throughout the entry using calibrated multi-gas detectors
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                ...
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    ...
                    two-way communication between the entrant and the top person (attendant), which
                    may include radios, hard-wired intercoms, or visual signals
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                ...
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    ...
                    pipework, electrical supplies, mechanical equipment, and other services
                    connected to the confined space must be physically isolated and locked off to
                    prevent accidental energisation, flooding, or release of substances
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                  <span>
                    ...
                    mechanical ventilation should be provided to maintain a safe atmosphere,
                    ensuring clean air is supplied and contaminated air is extracted
                  </span>
                </li>
              </ul>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Regulation 5 of the Confined Spaces Regulations 1997 requires that adequate
                emergency arrangements must be in place <strong>before</strong> any person enters a
                confined space. The rescue plan must never be an afterthought &mdash; it is an
                integral part of the safe system of work and must be rehearsed and ready before the
                permit is issued.
              </p>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  ...
                  dangerous response to a confined space emergency is for untrained persons to rush
                  in to help. This instinctive reaction has killed more people than the original
                  incident in many cases. Always follow the pre-planned rescue procedure.
                </p>
              </div>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-2">
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                      <span>
                        Uses a <strong className="text-white">tripod and winch system</strong>{' '}
                        positioned over the entry point
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                      <span>
                        The entrant wears a{' '}
                        <strong className="text-white">full-body harness</strong> connected to the
                        winch line before entry
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                      <span>
                        In an emergency, the casualty can be winched out from above without anyone
                        else entering the hazardous atmosphere
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                      <span>This is the safest method as it eliminates the risk to rescuers</span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-2">
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        Only carried out by{' '}
                        <strong className="text-white">trained rescue teams</strong> wearing
              ...
              <p>
                ...
                provide the exact location, the nature of the confined space, the number of
                casualties, and any known atmospheric hazards.
              </p>
              ...
              <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  ...
                  can pool in the legs due to the harness straps compressing the veins. This can
                  lead to suspension intolerance (orthostatic shock), which can be fatal within 30
                  minutes. Rescue must be carried out as quickly as possible, and once the casualty
                  is recovered, they should not be laid flat immediately but placed in a
                  semi-upright position to prevent reflow syndrome.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Construction sites are classified as <strong>high-risk environments</strong> for
                fire. The combination of combustible materials, ignition sources, temporary
                electrical installations, and incomplete fire protection systems means that fires on
                construction sites can develop quickly and spread rapidly. The Regulatory Reform
                (Fire Safety) Order 2005 applies to all workplaces including construction sites, and
                places a duty on the responsible person to carry out a fire risk assessment and
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      grinding, soldering, and brazing produce sparks and intense heat that can
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      circuits, damaged cables, poor connections, and temporary wiring are all
                      common on construction sites and can cause electrical fires
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      ...
                      and matches are a significant ignition source, particularly near stored
                      materials
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      of waste materials, packaging, offcuts, and general debris provides fuel for
                      fires and allows them to spread rapidly
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  ...
                  elements to start and sustain itself &mdash; <strong>heat</strong> (ignition
                  source), <strong>fuel</strong> (combustible material), and <strong>oxygen</strong>{' '}
                  (present in air at approximately 21%). Remove any one element and the fire cannot
                  exist. Fire prevention focuses on keeping these elements apart; fire-fighting
                  works by removing one or more of them.
                </p>
              </div>

              {/* Fire Triangle Diagram */}
              <div className="bg-white/5 border border-white/10 p-4 sm:p-6 rounded-lg">
                <p className="text-sm font-medium text-white mb-4 text-center">The Fire Triangle</p>
              ...
              <p>
                ...
                doors, fire-stopping, compartmentation) are often incomplete during the build.
                Escape routes may not yet be fully formed, alarm systems may not be operational, and
                large quantities of combustible materials (timber, insulation, packaging, solvents)
                are present throughout the site. The Joint Code of Practice on the Protection from
                Fire of Construction Sites (developed by the FPA and the Construction Confederation)
                provides industry guidance on managing fire risk during construction.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                A comprehensive approach to fire safety on construction sites involves multiple
                layers of protection. The responsible person (typically the principal contractor or
                site manager) must ensure that a fire risk assessment has been carried out and that
                appropriate measures are in place to prevent fire, detect fire, warn people, and
              ...
              <ul className="text-sm text-white space-y-2">
                ...
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    ...
                    and sufficient fire extinguishers must be provided throughout the site. The type
                    and number of extinguishers depends on the fire risk assessment and the
                    materials present. Extinguishers must be regularly inspected and maintained
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                ...
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                  <span>
                    <strong className="text-white">Hot works permits</strong> &mdash; formal written
                    authorisation required for any work involving heat sources, open flames, or
              ...
              <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  ...
                  start hours after hot work has finished, when smouldering material finally
                  ignites. The fire watch person must have a suitable fire extinguisher and know how
                  to use it.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                In the UK, all fire extinguishers have a <strong>red body</strong> (to BS EN 3) with
                a <strong>coloured band</strong> indicating the type of extinguishing agent.
                Selecting the correct extinguisher for the type of fire is critical &mdash; using
                the wrong type can be ineffective or, worse, can spread the fire or endanger the
                user.
              </p>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-1">
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                      <span>
                        Effective on Class A fires (solids: wood, paper, textiles, plastics)
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    ...
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                      <span>
                        <strong className="text-red-400">NEVER</strong> use on electrical fires,
                        flammable liquid fires, or cooking oil fires
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-1">
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                      <span>
                        Effective on Class A (solids) and Class B (flammable liquids) fires
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                      <span>
                        Works by smothering the fire with a foam blanket that seals the surface and
                    ...
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                      <span>
                        <strong className="text-red-400">NEVER</strong> use on live electrical
                        equipment or cooking oil fires
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-1">
                    ...
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                      <span>
                        Works by displacing oxygen around the fire &mdash; leaves no residue
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                      <span>
                        <strong className="text-amber-400">Caution:</strong> the horn becomes
                        extremely cold during use &mdash; do not hold. Risk of re-ignition as CO2
                        dissipates quickly
                      </span>
                    </li>
                  </ul>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-1">
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                      <span>
                        Multi-purpose &mdash; effective on Class A, B, and C fires, and safe on
                        electrical fires
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                      <span>
                        Works by smothering the fire with a chemical powder that interrupts the
                        chemical reaction
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                      <span>
                        <strong className="text-amber-400">Caution:</strong> creates a cloud of
                        powder that reduces visibility and can cause breathing difficulties &mdash;
                        not recommended for enclosed spaces. Does not cool the fire, so re-ignition
                        is possible
                      </span>
                    </li>
                  </ul>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-1">
                    ...
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                      <span>
                        Works by saponification &mdash; creates a soapy layer on the surface that
                        seals the oil and prevents re-ignition
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                      <span>
                        Also effective on Class A fires (solids) as a secondary capability
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                      <span>
                        Commonly found in site canteens and kitchen areas on construction sites
                      </span>
                    </li>
                  </ul>
                </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-red-400">When NOT to Fight a Fire:</strong> Only attempt
                  to fight a fire if it is small and contained, you have the correct extinguisher,
                  you have a clear escape route behind you, and you have been trained in fire
                  extinguisher use. If the fire is large, spreading, producing thick smoke, or
                  involves hazardous materials, <strong>do not attempt to fight it</strong>. Raise
                  the alarm, evacuate immediately, and call 999. Your safety is always the priority
                  &mdash; no piece of equipment or property is worth risking your life.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                site induction and reinforced through regular fire drills. Construction sites
                present unique evacuation challenges compared to completed buildings, including
                incomplete escape routes, missing fire doors, temporary stairways, and multiple
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Know your escape routes</strong> &mdash;
                      familiarise yourself with at least two escape routes from your work area
                      during induction. Escape routes on construction sites change as the build
                      progresses, so stay updated
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      ...
                      immediately. Make your area safe if you can do so quickly (turn off equipment,
                      close gas valves). Leave the area by the nearest safe escape route
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Assembly points</strong> &mdash; proceed
                      directly to the designated assembly point for your area of the site. Assembly
                      points are clearly signed and located at a safe distance from the building
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Roll calls</strong> &mdash; report to the fire
                      warden at the assembly point for a roll call. This is essential to confirm
                      that everyone has been safely evacuated. Do not leave the assembly point until
                  ...
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Fire warden duties</strong> &mdash; fire
                      wardens are responsible for sweeping their designated area to check for
                      remaining personnel, closing fire doors (where fitted), conducting the roll
                      call at the assembly point, and liaising with the emergency services on
                      arrival
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Do NOT use lifts</strong> &mdash; lifts may
                      fail, fill with smoke, or stop at the fire floor. Always use stairways for
                      evacuation
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Do NOT re-enter</strong> &mdash; never re-enter
                      the building until the fire warden or emergency services confirm it is safe.
                      Even if you believe the fire is out, there may be structural damage, toxic
                      fumes, or hidden hotspots that could re-ignite
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong className="text-white">Calling emergency services</strong> &mdash;
                      call 999 immediately if you discover a fire. Provide the exact site address,
                      the location of the fire within the site, what is burning, and whether anyone
              ...
              <p>
                Regular fire drills must be conducted on construction sites to ensure that all
                workers are familiar with the alarm, escape routes, and assembly procedures. New
                workers arriving on site between drills must receive specific fire safety
                information during their site induction. Records of all fire drills and training
                must be kept on site.
              </p>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-3">If You Discover a Fire</p>
