...
const quizQuestions = [
  ...
  {
    id: 3,
    question: 'Who needs to hold a CSCS card on a construction site?',
    options: [
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-green-500/5 border-l-2 border-green-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Established:</strong> 1995 &mdash; over 2.1 million cards in circulation
              </li>
              <li>
                <strong>Purpose:</strong> Verifies qualifications and training for construction
                workers
              </li>
              <li>
                <strong>Required by:</strong> Most major clients, tier 1 &amp; 2 contractors
              </li>
              <li>
                <strong>Validity:</strong> 5 years for most card types
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-green-500/5 border-l-2 border-green-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Apprentice:</strong> Green Labourer card during training
              </li>
              <li>
                <strong>Qualified:</strong> Blue Skilled Worker (Electrotechnical) with NVQ L3
              </li>
              <li>
                <strong>Advanced:</strong> Gold Advanced Craft for additional qualifications
              </li>
              <li>
                <strong>JIB/ECS:</strong> Your ECS card IS your CSCS card
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                Kingdom&rsquo;s leading card scheme for the construction industry. Established in{' '}
                <strong>1995</strong>, it was created with a clear purpose: to verify that workers
                on construction sites have the required qualifications and training for the type of
                work they carry out. In the decades since its creation, the scheme has grown to
                become the industry standard for demonstrating competence on site.
              </p>
              ...
              <p>
                ...
                electricians, plumbers, bricklayers, carpenters, plant operators, scaffolders, and
                dozens of other occupations are all covered by the scheme or its partner card
                schemes.
              </p>

              <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-green-400">Key Principle:</strong> The CSCS card does not
                  replace qualifications &mdash; it <strong>confirms</strong> them. When a site
                  manager checks your CSCS card, they are verifying that an independent body has
                  confirmed you hold the qualifications and training appropriate for your role. It
                  is a portable, verifiable proof of competence.
                </p>
              </div>

              <p>
                Most major construction sites and clients in the UK now require all workers to hold
                a valid CSCS card before being allowed on site. This requirement is enforced at site
                gates and turnstiles, typically using the <strong>CSCS Smart Check</strong> app
                which allows site managers to verify a card&rsquo;s validity in real time. Without a
                valid card, you will be turned away &mdash; regardless of your actual skill level or
                experience.
              </p>
              ...
              <p>
                ...
                test requirement, the development of partner card schemes for specialist sectors,
                and the move to smart card technology have all strengthened the scheme&rsquo;s
                ability to verify genuine competence and reduce the risk of unqualified or untrained
                workers being present on construction sites.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  Without it, your qualifications, experience, and skills are effectively invisible
                  to the industry. This section gives you the complete picture of what the scheme
                  is, how it works, and how it applies specifically to electricians.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                one. But the reasons behind that requirement run deeper than simple site access. The
                CSCS card has become the industry&rsquo;s primary mechanism for ensuring that
              ...
              <div className="bg-green-500/10 border border-green-500/30 p-4 sm:p-6 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong>Network Rail</strong> &mdash; all rail infrastructure projects require
                      CSCS or partner scheme cards
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>Highways England (National Highways)</strong> &mdash; mandatory for
                      all road and motorway projects
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>HS2</strong> &mdash; the UK&rsquo;s largest infrastructure project
                      requires CSCS across the board
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>Crossrail (Elizabeth Line)</strong> &mdash; all workers required to
                      hold valid CSCS cards
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>Tideway (Thames Tideway Tunnel)</strong> &mdash; CSCS mandatory for
                      all site personnel
                    </span>
                  </li>
                </ul>
              ...
              <p>
                Beyond these headline clients, the <strong>Build UK Code of Conduct</strong>{' '}
                requires all operatives working for Build UK member companies to hold a CSCS card.
                Build UK represents the vast majority of the UK&rsquo;s largest contractors, so this
                requirement effectively covers most significant construction projects in the
                country.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>Insurance requirements:</strong> Many employers&rsquo; liability and
                      public liability insurance policies specify that workers must hold CSCS cards.
                      Using unregistered workers could invalidate your insurance cover.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>Tender requirements:</strong> Many tenders and contracts require
                      evidence that all operatives hold valid CSCS cards. Without them, you cannot
                      bid for work.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>Demonstrates competence:</strong> A CSCS card provides independent
                      verification that you have the qualifications and training for your role,
                      giving clients and contractors confidence.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>Commitment to safety:</strong> Holding a CSCS card shows you take
                      health and safety seriously. The HS&E test component ensures a baseline level
                      of safety knowledge.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>Industry recognition:</strong> The card is universally recognised
                      across the UK construction industry. It is the single most widely accepted
                      proof of construction competence.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  self-employed electricians, not having a card can mean being excluded from the
                  commercial construction market entirely. The card is effectively your passport to
              ...
              <p>
                ...
                offence to work on a construction site without a CSCS card, the practical reality is
                that you will not get on site without one. The requirement comes from clients,
                principal contractors, and industry bodies rather than from statute &mdash; but the
                effect is the same. No card, no work on most sites.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The straightforward answer is: <strong>everyone</strong> who works on a construction
                site should hold an appropriate card. The CSCS scheme is not limited to a particular
                trade, role, or level of seniority. It covers the full spectrum of people who may be
                present on a construction site, from the most junior labourer to the most senior
                project director.
              </p>
                ...
                <div className="space-y-3">
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white leading-relaxed">
                      ...
                      the most common entry-level card in the scheme.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    <p className="text-sm font-medium text-white mb-1">
                    ...
                    <p className="text-xs text-white leading-relaxed">
                      ...
                      passed the appropriate HS&E test.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white leading-relaxed">
                      ...
                      HS&E test and holding a relevant NVQ/SVQ at Level 2 or Level 3, depending on
                      the occupation.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
              ...
              <p>
                ...
                and qualification levels. You must hold the card that is{' '}
                <strong>appropriate for the work you are actually doing</strong>. Holding a Green
                Labourer card does not entitle you to carry out skilled electrical work, and holding
                a Blue Skilled Worker card for one trade does not cover you for a different trade.
                The card must match the role.
              </p>
          ...
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                and understand where your card fits within the wider framework. The scheme is not a
                single monolithic organisation &mdash; it is a carefully structured system involving
                multiple bodies, each with a defined role.
              </p>

              {/* CSCS Scheme Overview Diagram */}
              <div className="bg-green-500/10 border border-green-500/30 p-4 sm:p-6 rounded-lg">
                <p className="text-sm font-medium text-green-400 mb-4 text-center">
                  CSCS Scheme Overview
                </p>
              ...
              <p>
                ...
                jointly by the <strong>CITB (Construction Industry Training Board)</strong> and the{' '}
                <strong>Construction Leadership Council</strong>. CITB plays a particularly
                important role as it also operates the HS&E test that is a requirement for most CSCS
                cards.
              </p>

              <p>
                The scheme is endorsed by several major industry bodies, including{' '}
                <strong>Build UK</strong>, the{' '}
                <strong>Civil Engineering Contractors Association (CECA)</strong>, and the{' '}
                <strong>Home Builders Federation (HBF)</strong>. This endorsement is what gives the
                scheme its industry-wide authority &mdash; when these organisations require CSCS
                cards, their member companies follow.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  you apply for a CSCS card, your qualifications are checked against the CTR. If
                  your qualifications are not registered on the CTR, your application may be delayed
                  or rejected. It is important to ensure your awarding body has registered your
                  qualifications on the CTR before you apply.
                </p>
              </div>
              ...
              <p>
                ...
                All partner scheme cards carry the CSCS logo and are recognised on sites that
                require &ldquo;a CSCS card.&rdquo; This is a crucial point for electricians, as the
                JIB/ECS card is a partner scheme card.
              </p>

              <p>
                The CSCS scheme is part of the wider{' '}
                <strong>Construction Skills Certification Scheme</strong> which encompasses both the
                directly-issued CSCS cards and the partner scheme cards. Together, these schemes aim
                to ensure that every person on every construction site holds a card that verifies
                their qualifications and competence for their specific role.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                schemes is important because their cards carry the CSCS logo and are fully
                recognised on sites that require &ldquo;a CSCS card.&rdquo;
              </p>
                ...
                <div className="space-y-3">
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white leading-relaxed">
                      ...
                      both a technical test and an NVQ/SVQ requirement for the full (blue)
                      competence card.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white leading-relaxed">
                      ...
                      of specific CISRS training courses and relevant NVQ/SVQ qualifications. All
                      CISRS cards carry the CSCS logo.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    <p className="text-sm font-medium text-white mb-1">
              ...
              <p>
                ...
                framework is designed to be comprehensive &mdash; whatever your role in
                construction, there should be a card available that covers your occupation and
                qualifications.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  date, and matches the holder&rsquo;s identity. The app checks against the CSCS
                  central database in real time, so expired, cancelled, or fraudulent cards will be
                  flagged immediately.
                </p>
              </div>
            </div>
            ...
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="bg-green-500/10 border border-green-500/30 p-4 sm:p-6 rounded-lg">
                <p className="text-sm font-medium text-green-400 mb-3">
                  General Requirements for Most CSCS Cards
                </p>
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    <span className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-green-500/20 text-green-400 text-sm font-bold flex-shrink-0">
                      1
                    </span>
                    <div>
                      ...
                      <p className="text-xs text-white mt-1 leading-relaxed">
                        ...
                        levels: Operatives (for labourer and skilled worker cards), Specialists (for
                        certain specialist roles), and Managers and Professionals (for supervisory,
                        management, and professional cards). The test must be booked and taken at an
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-white mt-1 leading-relaxed">
                        ...
                        qualifications (Level 4+) are required. Your qualification must be
                        registered on the Construction Training Register (CTR) for CSCS to verify
                        it.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-white mt-1 leading-relaxed">
                        ...
                        photograph. Online applications are faster and typically processed within 5
                        to 10 working days.
                      </p>
                    </div>
                  </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      Pass the <strong>Operatives HS&E test</strong>
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      Complete, be registered for, or have applied for a{' '}
                      <strong>Level 1 qualification</strong> relevant to your role
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      Pass the <strong>appropriate HS&E test</strong> for your occupation
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      Hold the <strong>relevant NVQ/SVQ at the correct level</strong> (typically
                      Level 2 or Level 3 depending on the trade)
                    </span>
                  </li>
                </ul>
                <p className="text-sm text-white mt-2">
              ...
              <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-green-400">Top Tip:</strong> Before applying, check that
                  your qualifications are registered on the Construction Training Register (CTR). If
                  they are not, contact your awarding body to arrange registration. Applying before
                  your qualifications are on the CTR is one of the most common causes of delays and
                  rejections.
                </p>
              </div>
            </div>
            ...
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>Current HS&E test pass:</strong> If your previous HS&E test was taken
                      more than 2 years ago, you will need to pass a new test before your card can
                      be renewed. Plan for this — test centres can be busy.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>Current qualifications:</strong> Your qualifications must still be
                      valid and relevant. If you have gained additional qualifications since your
                      last card was issued, you may be eligible for a higher-level card.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>Application and payment:</strong> Complete the renewal application
                      (online or by post) and pay the renewal fee. The process is similar to a new
                      application.
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  You will be turned away from site, and your employer or client may face compliance
                  issues. Most sites now use the CSCS Smart Check app, which flags expired cards
                  automatically at the gate. Do not assume that being &ldquo;a few days&rdquo; past
                  expiry will be overlooked &mdash; it will not.
                </p>
              </div>
              ...
              <p>
                ...
                significant experience but may not yet hold a formal NVQ/SVQ) typically have shorter
                validity periods and may require the holder to complete their NVQ/SVQ within the
                card&rsquo;s validity period in order to renew.
              </p>

              <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-green-400">Best Practice:</strong> Set a reminder on your
                  phone or calendar for <strong>3 months before your card expires</strong>. This
                  gives you enough time to book and pass a new HS&E test (if needed), gather your
                  documents, submit your application, and receive your new card before the old one
                  expires. Leaving it until the last week is a recipe for being unable to work.
                </p>
              </div>
          ...
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                industry&rsquo;s own registration and certification framework. Understanding how
                these two systems relate to each other is essential for navigating your career in
                the electrical trade on construction sites.
              </p>

              <div className="bg-green-500/10 border border-green-500/30 p-4 sm:p-6 rounded-lg">
                <p className="text-sm font-medium text-green-400 mb-4 text-center">
                  Electrician&rsquo;s CSCS Card Progression
                </p>
                <div className="space-y-3">
                  <div className="bg-green-600/10 border border-green-600/30 rounded-lg p-4">
                    <div className="flex items-start gap-3">
                      <span className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-green-600/20 text-green-400 text-lg font-bold flex-shrink-0">
                        1
                      </span>
                      <div>
                  ...
                  <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
                    <div className="flex items-start gap-3">
                      <span className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-blue-500/20 text-blue-400 text-lg font-bold flex-shrink-0">
                        2
                      </span>
                      <div>
                        ...
                        <p className="text-sm text-white leading-relaxed">
                          ...
                          eligible for the Blue Skilled Worker card. This is the standard card for
                          qualified electricians. You will need to pass the appropriate HS&E test
                          and have your NVQ registered on the CTR. This card confirms you are a
                  ...
                  <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-lg p-4">
                    <div className="flex items-start gap-3">
                      <span className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-yellow-500/20 text-yellow-400 text-lg font-bold flex-shrink-0">
                        3
                      </span>
                      <div>
              ...
              <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white leading-relaxed">
                  ...
                  JIB/ECS card <strong>IS</strong> your CSCS card for electrical work on
                  construction sites. You do not need a separate CSCS card in addition to your ECS
                  card.
                </p>
              </div>
              ...
              <p>
                ...
                range of roles from Electrical Labourer through to Electrical Technician, Approved
                Electrician, and Electrical Manager.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>ECS Labourer (Green):</strong> For those working as electrical
                      labourers or assistants during apprenticeship, with a Level 1 qualification
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>ECS Electrician (Blue):</strong> For qualified electricians holding
                      NVQ Level 3 in Electrical Installation or Electrotechnical Technology
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>ECS Approved Electrician (Gold):</strong> For those with additional
                      experience, qualifications, and JIB Approved Electrician status
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>ECS Technician:</strong> For electrical technicians with appropriate
                  ...
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>ECS Installation Electrician:</strong> For electricians who are
                      registered with a competent person scheme (e.g., NICEIC, NAPIT) and carry out
              ...
              <p>
                ...
                scheme cards. As long as your card is in date and matches your identity, you will be
                allowed on site.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  major contractors and clients. It carries the CSCS logo and provides
                  CSCS-equivalent access to construction sites. Applying directly to CSCS for a
                  standard card is possible but unnecessary if you qualify for an ECS card &mdash;
                  and the ECS card provides clearer identification of your specific electrical
                  qualifications and competence level.
                </p>
              </div>

              <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-green-400">Key Takeaway:</strong> For electricians in the
                  UK, the path is clear: obtain your Green Labourer/ECS card during your
                  ...
                  test. Your JIB/ECS card is your CSCS card &mdash; it gets you through the gate on
                  any construction site in the country. Keep it in date, keep it on you, and plan
                  your renewals early.
                </p>
              </div>
            </div>
