...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    question: 'What are the two types of question that appear in the HS&E test?',
    options: [
...
const faqs = [
  ...
  {
    question:
      'What is the difference between knowledge questions and behavioural case study questions?',
    answer:
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The CITB <strong>Health, Safety and Environment (HS&amp;E) test</strong> is the exam
                all workers must pass to obtain a CSCS card. It is delivered at{' '}
              ...
              <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  The HS&amp;E test is a computer-based examination administered by CITB and
                  delivered through the Pearson VUE network. It is the mandatory entry requirement
                  for all CSCS card applications. Without a valid HS&amp;E test pass, you cannot
                  apply for a CSCS card &mdash; and without a CSCS card, you cannot access the vast
                  majority of UK construction sites.
                </p>
              </div>
                ...
                <ul className="text-sm text-white/80 space-y-1.5">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      <strong>baseline understanding</strong> of health, safety, and environmental
                      risks
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      To reduce <strong>accidents, injuries, and fatalities</strong> in the
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                There are three main versions of the HS&amp;E test. The version you need depends on
                the CSCS card you are applying for, which in turn depends on your role and
                qualifications. Each version draws questions from a large bank, so{' '}
                <strong>every sitting is different</strong> &mdash; you will not get the same
                questions as another candidate.
              </p>
                  ...
                  <div className="grid md:grid-cols-[180px_1fr] gap-3">
                    ...
                    <div>
                      <p className="text-sm text-white/80 mb-2">
                        ...
                        addition to general safety topics. Required for <strong>Black</strong> and{' '}
                        <strong>White</strong> CSCS cards.
                      </p>
                      <div className="grid grid-cols-3 gap-2">
                        <div className="bg-black/30 rounded-lg p-2 text-center">
              ...
              <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  topics covered. Simply memorising answers from a practice app is not a reliable
                  strategy.
                </p>
              </div>
            </div>
          ...
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                difference between them is crucial for effective preparation, because each type
              ...
              <div className="bg-white/5 border border-white/10 rounded-lg overflow-hidden">
                <div className="bg-green-500/20 border-b border-green-500/30 px-4 py-3">
                  <p className="text-sm font-semibold text-green-300">Question Types Comparison</p>
                </div>
                  ...
                  <div className="p-4 border-b md:border-b-0 md:border-r border-white/5">
                    ...
                    <ul className="text-sm text-white/80 space-y-1.5">
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                        <span>
                          Standard multiple choice with <strong>one correct answer</strong> from
                          four options
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                        <span>
                          Cover <strong>factual knowledge</strong> about regulations, procedures,
                      ...
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                        <span>
                          Test <strong>recall and understanding</strong> of specific rules and
                          requirements
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                        <span>
                          Example: &ldquo;What colour is the prohibition sign used on construction
                          sites?&rdquo;
                        </span>
                      </li>
                    </ul>
                  ...
                  <div className="p-4">
                    ...
                    <ul className="text-sm text-white/80 space-y-1.5">
                      <li className="flex items-start gap-2">
                        ...
                        <span>
                          Scenario-based questions presenting a <strong>workplace situation</strong>{' '}
                          (sometimes with images)
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-amber-400" />
                        <span>
                          You must choose the <strong>most appropriate action</strong> from four
                          options
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-amber-400" />
                        <span>
                          Test <strong>judgement and decision-making</strong>, not just knowledge
                          recall
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-amber-400" />
                        <span>
                          Example: &ldquo;You notice a colleague not wearing a harness at height.
                          What should you do?&rdquo;
                        </span>
                      </li>
                    </ul>
                  </div>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  action, not just a correct-sounding one. Pay close attention to words like
                  &ldquo;MOST appropriate&rdquo;, &ldquo;FIRST thing you should do&rdquo;, and
                  &ldquo;BEST course of action&rdquo;.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1.5">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>Read the entire scenario carefully</strong> &mdash; do not skim.
                      Details in the scenario often determine the correct answer
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>Consider safety first</strong> &mdash; the correct answer almost
                      always prioritises preventing harm over continuing work
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>Look for the &ldquo;stop and report&rdquo; option</strong> &mdash; if
                      a serious hazard is described, the correct action usually involves stopping
                      work and reporting it
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>Eliminate obviously wrong answers</strong> &mdash; options like
                      &ldquo;carry on working&rdquo; or &ldquo;ignore it&rdquo; are almost always
                      incorrect
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>Think about what a competent, responsible worker would do</strong>{' '}
                      &mdash; not what might happen in reality on a busy site
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The HS&amp;E test is taken on a <strong>touch-screen computer</strong> at a Pearson
                VUE test centre. The test cannot be taken online or remotely &mdash; you must attend
                a registered centre in person. Pearson VUE centres are located in towns and cities
                across the UK, and you book your test slot in advance.
              </p>
              ...
              <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1.5">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      Arrive at least <strong>15 minutes early</strong> to complete registration
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      Personal belongings (phone, bag, watch) must be stored in a{' '}
                  ...
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      A <strong>practice tutorial</strong> is provided before the test begins so you
                      can familiarise yourself with the touch-screen interface
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  or a translated version of the test in certain languages. Contact CITB before
                  booking to discuss your needs and arrange appropriate support.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                <strong>45 out of 50</strong>. This is a high threshold &mdash; you can only afford
                to get around 5 questions wrong.
              </p>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  question blank. With four options, a guess gives you a 25% chance &mdash; leaving
                  it blank gives you 0%.
                </p>
              </div>
              ...
              <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  all the questions you are confident about first, then return to the flagged ones
                  with your remaining time. This strategy ensures you do not miss easy marks at the
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The HS&amp;E test covers a broad range of health, safety, and environmental topics.
                The exact mix of questions varies between sittings, but all the following topic
                areas may appear. You need a solid understanding of <strong>all</strong> these areas
                &mdash; not just the ones you encounter most in your daily work.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  discovering an unsafe condition, witnessing a colleague taking a shortcut,
                  encountering an unknown substance, or deciding whether to proceed with a task when
                  conditions change. These questions can relate to <strong>any</strong> of the topic
                  areas above.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-3">Top Reasons Candidates Fail</p>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1.5">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong>
                        &ldquo;I&apos;ve worked on sites for years &mdash; I don&apos;t need to
                        revise&rdquo;
                      </strong>{' '}
                      &mdash; Experience helps, but the test covers regulations and procedures that
                      many experienced workers have never formally studied
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-orange-400" />
                    <span>
                      <strong>&ldquo;It&apos;s just common sense&rdquo;</strong> &mdash; Many
                      questions test specific knowledge of regulations, not general common sense.
                      You need to know specific rules, numbers, and procedures
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-orange-400" />
                    <span>
                      <strong>&ldquo;A practice app is all I need&rdquo;</strong> &mdash; Practice
                      apps are helpful, but the real test draws from a much larger question bank.
                      Apps give you familiarity with the format, not coverage of all possible
                      questions
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-orange-400" />
                    <span>
                      <strong>&ldquo;If I fail, I can just re-sit tomorrow&rdquo;</strong> &mdash;
                      You must wait at least 2 clear working days, and you will need to pay again.
              ...
              <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  materials, and practise both knowledge questions and behavioural scenarios. The
                  90% pass mark means you have very little margin for error &mdash; thorough
            ...
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  removed or answers that are no longer correct due to legislative changes. Always
                  check that your revision materials are based on the{' '}
                  <strong>most current version</strong> of the HS&amp;E test. The CITB website and
                  the official CITB revision materials are the most reliable sources.
                </p>
              </div>
              ...
              <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1.5">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>CITB website</strong> &mdash; Check the official CITB HS&amp;E test
                      pages for announcements about changes to the test format or content
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                  ...
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>Check publication dates</strong> &mdash; When using any third-party
                      revision book or app, check when it was last updated. Avoid anything more than
                      12 months old
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>HSE website</strong> &mdash; Changes to health and safety legislation
                      are published on the HSE website. Major legislative changes are typically
                      reflected in the HS&amp;E test within 6&ndash;12 months
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  CSCS card after several years, you should <strong>revise afresh</strong> using the
                  latest materials rather than relying on what you learned for your previous test.
                </p>
              </div>
            </div>
          </div>
