...
export default function EmergingTechIndex() {
  useSEO({
    title: 'Emerging Tech | Study Centre',
        ...
        <div className="max-w-3xl mx-auto space-y-6">
          <div className="space-y-1">
            ...
            <p className="text-sm sm:text-base text-muted-foreground">
              AI, IoT, robotics, and the future of the electrical industry
            </p>
          </div>

          <div className="flex flex-col items-center justify-center py-16 text-center">
            <div className="p-4 rounded-2xl bg-fuchsia-500/10 border border-fuchsia-500/20 mb-4">
