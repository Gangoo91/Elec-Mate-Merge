    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Put your time management and organisation knowledge to the test under timed exam
        ...
        <Link to="../tmo-mock-exam" className="block touch-manipulation focus:outline-none">
