...
export default function TMOModule6() {
  useSEO({
    title: 'Module 6: Mock Exam | Time Management & Organisation',
    description:
      'Time Management & Organisation mock examination — 20 random questions from a 200-question bank, 30-minute timer, 80% pass mark.',
  });
