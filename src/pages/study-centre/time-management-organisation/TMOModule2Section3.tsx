...
const quickCheckQuestions = [
  {
    ...
    options: [
      'Break the job into sub-tasks, time each, total, add 10-15% contingency',
      'Keep quoting 2 days but work faster to meet the original estimate',
      'Ask the client how long they think the rewire should take',
      'Always double every estimate regardless of the type of job',
    ],
    correctIndex: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Good customer service — always say yes to keep the client happy',
      'Efficient scheduling — combining several jobs into a single visit',
      'Scope creep — extra work requested after the job was quoted and agreed',
      'Cross-selling — proactively offering additional paid services',
    ],
    correctIndex: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      '4 hours — because that is what they have always quoted before',
      '8 hours — to be safe, simply double the original estimate',
      'Whatever the client is willing to pay, ignoring the actual time',
      'The 5.8-hour average plus 10-15% contingency, roughly 6.5-7 hours',
    ],
    correctIndex: 3,
    explanation:
...
const quizQuestions = [
  {
    ...
    options: [
      'Guessing the duration based purely on experience and gut feel',
      'Asking another electrician how long they reckon it would take',
      'Breaking it into sub-tasks, timing each, totalling, adding contingency',
      "Reusing the time estimate from the client's previous electrician",
    ],
    correctAnswer: 2,
    explanation:
      'Bottom-up estimation — breaking a job into its component sub-tasks and assigning a reference time to each — produces the most accurate results because it forces you to think through every stage of the work. Gut-feel estimation is subject to the planning fallacy: you imagine the best case and forget the transitions, complications, and setup time. Sub-task estimation reveals hidden time costs that holistic estimation misses.',
  },
  {
    id: 2,
    question: 'A quoting framework for electrical work should include:',
    options: [
      'Materials, labour hours times rate, travel, plus 10-15% contingency',
      'Materials cost only, with labour given free as a favour to win the job',
      'Whatever the nearest competitor charges, then knock off 10%',
      'A fixed price set by whatever the client says they can afford',
    ],
    correctAnswer: 0,
    explanation:
      'A professional quoting framework accounts for all real costs: materials (with a reasonable markup for sourcing, storage, and warranty risk), labour hours (estimated via sub-task breakdown, multiplied by a sustainable hourly rate), travel costs, and a contingency of 10-15% for unforeseen complications. Quoting only materials means you are working for free; competitor-based pricing ignores your actual costs; and client-affordability pricing is charity, not business.',
  },
  {
    id: 3,
    question: 'The "false economy of underquoting" refers to:',
    options: [
      'Charging too much for a job and losing it to a competitor',
      'Quoting accurately but the client still choosing a cheaper rival',
      'Adding far too much contingency to an otherwise sound quote',
      'Winning a job at a price below your true costs, leading to loss',
    ],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: [
      'The electrician adds extra work without telling the client first',
      'The client requests work beyond the quoted scope ("while you\'re here...")',
      'The job is completed in noticeably less time than expected',
      'The electrician fits higher-quality materials than were quoted',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Recording how long each job took and comparing it to your estimate',
      "Comparing your quote to the competitor's quote for the same job",
      'Tracking the total number of hours you work in a typical week',
      'Asking each client how long they expected the job to take',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'A national IET standard stating how long every job type should take',
      'Your own record of how long each job type actually takes you',
      'A current price list of components from your materials supplier',
      'A spreadsheet of competitor pricing across your local area',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Only ever necessary on very large commercial fit-out projects',
      'A sneaky way of tricking clients into paying more than needed',
      'A realistic allowance for complications that are statistically inevitable',
    ],
    correctAnswer: 3,
    explanation:
