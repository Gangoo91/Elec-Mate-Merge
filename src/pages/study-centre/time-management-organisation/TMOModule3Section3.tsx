...
const quizQuestions = [
  {
    ...
    options: [
      'Grouping similar tasks and doing them in one dedicated session',
      'Completing tasks in the order they arrive, regardless of their type',
      'Working on several different types of task at the same time',
      'Delegating large batches of work to external subcontractors',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Because it takes real physical effort to move your body between tasks',
      'Because switching tasks breaches the terms of most employment contracts',
      'Because each switch makes your brain reload the new task, adding overhead',
      'Because the brain can only switch tasks a maximum of five times per day',
    ],
    correctAnswer: 2,
    explanation:
      'Every time you switch between different types of tasks, your brain must disengage from the previous context and load the new one. This means remembering different processes, accessing different tools or systems, and establishing a different mindset. This cognitive overhead is invisible but significant.',
  },
  {
    id: 4,
    ...
    options: [
      ...
      'That they should only work 20% of the week and rest for the other 80%',
      'That 80% of the wiring regulations apply to just 20% of installations',
      'That 80% of their income comes from roughly 20% of clients or job types',
    ],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: [
      'You will run out of work entirely and have nothing left to do',
      'Your clients will notice and complain about the inconsistent service',
      'You will breach tax regulations by failing to track your high-value clients',
      'You will over-invest in low-value work and neglect the high-value 20%',
    ],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Monday morning, to start the working week off with paperwork',
      'Sunday evening, planning the week with no site interruptions',
      'Friday afternoon, to end the week \u2014 but often skipped through fatigue',
      'There is no best time \u2014 just do the admin whenever you feel like it',
    ],
    correctAnswer: 1,
    explanation:
