...
const quickCheckQuestions = [
  ...
  {
    id: 'mewp-rescue-plan',
    question: 'Why is a rescue plan required before using a MEWP?',
    options: [
...
const quizQuestions = [
  ...
  {
    id: 6,
    question: 'Which pre-use check is specific to MEWPs with outriggers?',
    options: [
          ...
          <div className="rounded-lg p-4 bg-amber-500/5 border-l-2 border-amber-500/50">
            ...
            <ul className="text-white/80 text-base space-y-1.5 leading-relaxed">
              <li className="flex items-start gap-2">
                ...
                <span>
                  <strong className="text-white">4 main types:</strong> scissor lift, articulated
                  boom, telescopic boom, vertical mast
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                <span>
                  <strong className="text-white">IPAF training:</strong> 1a/1b static, 3a/3b mobile
              ...
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                <span>
                  <strong className="text-white">LOLER:</strong> thorough examination every 6 months
                  (carries people)
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                <span>
                  <strong className="text-white">Rescue plan:</strong> always required — what if the
                  platform won't come down?
                </span>
              </li>
            </ul>
          </div>
          ...
          <div className="rounded-lg p-4 bg-amber-500/5 border-l-2 border-amber-500/50">
            ...
            <ul className="text-white/80 text-base space-y-1.5 leading-relaxed">
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                <span>
                  <strong className="text-white">Pre-use checks:</strong> controls, emergency
                  lowering, guardrails, hydraulics, SWL
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                <span>
                  <strong className="text-white">Exclusion zone:</strong> set up barriers to keep
                  pedestrians and vehicles clear
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                <span>
                  <strong className="text-white">Ground conditions:</strong> firm, level, no voids —
                  use spreader mats if needed
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                <span>
                  <strong className="text-white">Harness on booms:</strong> short lanyard attached
                  to platform anchor point
                </span>
              </li>
            </ul>
          </div>
          ...
          <div className="border-l-2 border-amber-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80 leading-relaxed">
              <p>
                ...
                MEWPs provide a stable, enclosed working platform at height — a significant safety
                improvement over ladders for many tasks. The four main categories are:
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="bg-white/5 border border-amber-400/30 p-4 rounded-lg">
                  ...
                  <ul className="text-white/60 text-sm space-y-1">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>
                        Large platform area — can accommodate multiple operatives and materials
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Electric (indoor) or diesel/hybrid (outdoor) models</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Ideal for ceiling work, cable tray installation, lighting</span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-white/5 border border-amber-400/30 p-4 rounded-lg">
                  ...
                  <ul className="text-white/60 text-sm space-y-1">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>
                        Can reach over parapets, around structures, into awkward positions
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Sometimes called a "cherry picker" or "knuckle boom"</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Harness and short lanyard required — risk of ejection</span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-white/5 border border-amber-400/30 p-4 rounded-lg">
                  ...
                  <ul className="text-white/60 text-sm space-y-1">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Maximum horizontal outreach of all MEWP types</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Cannot reach over obstacles — straight-line only</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Harness always required — significant catapult risk</span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-white/5 border border-amber-400/30 p-4 rounded-lg">
                  ...
                  <ul className="text-white/60 text-sm space-y-1">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Fits through standard single doorways</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Usually electric — suitable for indoor use (no emissions)</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Excellent for warehouse racking, retail fit-outs</span>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="space-y-4 text-white/80 leading-relaxed">
              ...
              <div className="space-y-3">
                {[
                  ...
                  <div key={i} className="bg-white/5 border border-purple-400/30 rounded-lg p-3">
              ...
              <div className="bg-[#111] border border-white/10 rounded-xl p-5 sm:p-6">
                  ...
                  <table className="w-full text-sm text-left min-w-[500px]">
                    ...
                    <tbody className="text-white/70">
                      ...
                      <tr className="border-b border-white/5">
                        ...
                        <td className="py-2 pr-3 text-center text-red-400">No</td>
                        <td className="py-2 pr-3 text-center text-green-400">Best</td>
                        <td className="py-2 pr-3 text-center text-amber-400">Limited</td>
                        <td className="py-2 text-center text-red-400">No</td>
                      </tr>
                      <tr className="border-b border-white/5">
                        <td className="py-2 pr-3">Maximum height</td>
                        <td className="py-2 pr-3 text-center text-amber-400">18m</td>
                        <td className="py-2 pr-3 text-center text-green-400">40m+</td>
                        <td className="py-2 pr-3 text-center text-green-400">50m+</td>
                        <td className="py-2 text-center text-amber-400">12m</td>
                      </tr>
                      <tr className="border-b border-white/5">
                        <td className="py-2 pr-3">Maximum outreach</td>
                        <td className="py-2 pr-3 text-center text-red-400">None</td>
                        <td className="py-2 pr-3 text-center text-green-400">15m+</td>
                        <td className="py-2 pr-3 text-center text-green-400">25m+</td>
                        <td className="py-2 text-center text-red-400">None</td>
                      </tr>
                      <tr className="border-b border-white/5">
                        <td className="py-2 pr-3">Confined spaces</td>
                        <td className="py-2 pr-3 text-center text-amber-400">Some</td>
                        <td className="py-2 pr-3 text-center text-red-400">No</td>
                        <td className="py-2 pr-3 text-center text-red-400">No</td>
                        <td className="py-2 text-center text-green-400">Best</td>
                      </tr>
                      <tr className="border-b border-white/5">
                        <td className="py-2 pr-3">Platform capacity</td>
                        <td className="py-2 pr-3 text-center text-green-400">Largest</td>
                        <td className="py-2 pr-3 text-center text-amber-400">1–2 persons</td>
                        <td className="py-2 pr-3 text-center text-amber-400">1–2 persons</td>
                        <td className="py-2 text-center text-amber-400">1 person</td>
                      </tr>
                      <tr>
                        <td className="py-2 pr-3">Indoor suitability</td>
                        <td className="py-2 pr-3 text-center text-green-400">Excellent</td>
                        <td className="py-2 pr-3 text-center text-red-400">Poor</td>
                        <td className="py-2 pr-3 text-center text-red-400">Poor</td>
                        <td className="py-2 text-center text-green-400">Excellent</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
                ...
                <div className="mt-4 bg-amber-500/10 border border-amber-500/20 rounded-lg p-3">
                  ...
                  <p className="text-white/60 text-xs leading-relaxed">
                    ...
                    articulated boom.{' '}
                    <strong className="text-white">Maximum reach in a straight line?</strong> Use a
                    telescopic boom.
                  </p>
                </div>
              </div>
          ...
          <div className="border-l-2 border-teal-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80 leading-relaxed">
              <p>
                ...
                is the globally recognised training scheme for MEWP operators. In the UK, IPAF
                Powered Access Licence (PAL) cards are the standard proof of competence. Training is
                category-based — you must hold the correct category for the machine you intend to
                operate.
              </p>
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm leading-relaxed">
                  ...
                  fixed position before elevating. Mobile machines can drive while the platform is
                  raised. The letter indicates the platform type:{' '}
                  <strong className="text-white">a = vertical</strong> (scissor),{' '}
                  <strong className="text-white">b = boom</strong>.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="bg-white/5 border border-teal-400/30 p-4 rounded-lg">
                  ...
                  <ul className="text-white/70 space-y-1 text-sm">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Must be positioned and set up before raising</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Example: trailer-mounted scissor lift with outriggers</span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-white/5 border border-teal-400/30 p-4 rounded-lg">
                  ...
                  <ul className="text-white/70 space-y-1 text-sm">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>
                        Boom lift that <strong className="text-white">cannot travel</strong> while
                        elevated
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Positioned on outriggers or stabilisers before use</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Example: truck-mounted or trailer-mounted cherry picker</span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-white/5 border border-teal-400/30 p-4 rounded-lg">
                  ...
                  <ul className="text-white/70 space-y-1 text-sm">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>The most common MEWP type on commercial/industrial sites</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Example: electric self-propelled scissor lift for warehouse use</span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-white/5 border border-teal-400/30 p-4 rounded-lg">
                  ...
                  <ul className="text-white/70 space-y-1 text-sm">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Covers both articulated and telescopic self-propelled booms</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Harness always required when operating from the platform</span>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  ...
                  before expiry. Operators must carry the card at all times when operating a MEWP.
                  Most hire companies will not release a MEWP without seeing a valid PAL card.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80 leading-relaxed">
              <p>
                ...
                not a substitute for the 6-monthly LOLER thorough examination — it is an additional
                daily requirement. Pre-use checks take 10–15 minutes and can prevent serious
                incidents.
              </p>
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80 leading-relaxed">
              <p>
                ...
                struck by the machine, by falling objects, or by the machine overturning.
              </p>
              ...
              <div className="bg-white/5 border border-cyan-400/30 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-2 text-sm">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      The zone must extend beyond the maximum swing radius of the boom (for boom
                      lifts)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      For scissor lifts, the zone should extend at least 2 metres from the machine
                      base
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      Consider falling object risk — tools and materials could fall from the
                      platform
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>A banksman may be needed to control traffic and pedestrian movement</span>
                  </li>
                </ul>
              </div>

              <h3 className="text-white font-semibold text-base mt-4">Ground Conditions</h3>

              <p>
                Ground conditions directly affect MEWP stability. The machine exerts significant
                point loads — particularly when outriggers are deployed. Ground failure under an
                outrigger can cause the machine to overturn instantly.
              </p>
            ...
            <div className="space-y-4 text-white/80 leading-relaxed">
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/70 text-sm mb-3 leading-relaxed">
                  ...
                  <em>
                    "What happens if the platform fails to lower and the operative is stranded at
                    height?"
                  </em>
                </p>
