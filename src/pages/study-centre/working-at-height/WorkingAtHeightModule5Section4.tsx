...
const faqs = [
  {
    question: 'What is the difference between a pre-use check and a thorough examination?',
    answer:
  ...
  {
    question: 'Who can carry out a LOLER thorough examination?',
    answer:
  ...
  {
    question: 'What happens if a thorough examination finds a defect?',
    answer:
  ...
  {
    question: 'Can inspection records be kept digitally instead of on paper?',
    answer:
...
const quizQuestions = [
  ...
  {
    id: 3,
    question: 'Who should carry out a pre-use visual inspection of a ladder?',
    options: [
...
export default function WorkingAtHeightModule5Section4() {
  useSEO({
    title: 'Inspection Regimes & Record Keeping | Module 5 | Working at Height',
    description:
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="bg-amber-500/10 border border-amber-500/30 rounded-xl p-5 mb-6">
          ...
          <p className="text-white/80 text-base leading-relaxed">
            ...
            produces records that must be retained for specific periods. An equipment register
            tracks each item from first use to withdrawal. Without records, you cannot prove
            compliance — and in the event of an accident, missing records will count heavily against
            the employer.
          </p>
        </div>
        ...
        <div className="bg-blue-500/10 border border-blue-500/30 rounded-xl p-5 mb-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm text-white/70">
            <div className="flex items-start gap-2">
              ...
              <span>
                <strong className="text-white">WAH Regs 2005, Schedule 7</strong> — 7-day scaffold
            ...
            <div className="flex items-start gap-2">
              <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
              <span>
                <strong className="text-white">LOLER 1998</strong> — thorough examination of lifting
                equipment (6-monthly for person-carrying)
              </span>
            </div>
            <div className="flex items-start gap-2">
              <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
              <span>
                <strong className="text-white">PUWER 1998</strong> — general requirement to maintain
                work equipment in safe condition
              </span>
            </div>
            <div className="flex items-start gap-2">
              <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
              <span>
                <strong className="text-white">Management Regs 1999</strong> — general duty to
          ...
          <div className="border-l-2 border-amber-500/40 pl-4 sm:pl-6 space-y-4">
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 rounded-lg p-4">
                ...
                <ul className="space-y-1.5 text-sm text-white/70">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      Labels legible — manufacturer, model, date of manufacture, CE/UKCA mark
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      NOT previously deployed in a fall (energy absorber indicators checked)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 rounded-lg p-4">
                ...
                <ul className="space-y-1.5 text-sm text-white/70">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      Current LOLER thorough examination certificate displayed or available
                    </span>
                  </li>
                </ul>
              </div>
            ...
            <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-4">
              ...
              <p className="text-white/70 text-sm leading-relaxed">
                ...
                re-inspected by a competent person.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="border-l-2 border-blue-500/40 pl-4 sm:pl-6 space-y-4">
              ...
              <ul className="space-y-2 text-sm text-white/70">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    ...
                    erection, before anyone works from it
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">After any alteration</strong> — any change to the
                    scaffold structure
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    ...
                    — adverse weather, impact from a vehicle or load, ground disturbance
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">At intervals not exceeding 7 days</strong> — from
            ...
            <div className="bg-white/5 border border-white/10 rounded-lg p-4">
              ...
              <p className="text-white/70 text-sm leading-relaxed">
                ...
                of any matters that could give rise to a risk, and the name, signature, and position
                of the person who carried out the inspection. The report must be kept on site while
          ...
          <div className="border-l-2 border-green-500/40 pl-4 sm:pl-6 space-y-4">
            ...
            <div className="bg-white/5 border border-white/10 rounded-lg p-4">
              ...
              <ul className="space-y-2 text-sm text-white/70">
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    Visual inspection of all components for wear, damage, corrosion, and deformation
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    Functional testing of all safety systems (limit switches, emergency stops,
                    overload protection)
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    Measurement of critical dimensions (webbing width, wire rope diameter)
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    Non-destructive testing where required (ultrasonic, magnetic particle)
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
            ...
            <div className="bg-white/5 border border-white/10 rounded-lg p-4">
              ...
              <p className="text-white/70 text-sm leading-relaxed">
                ...
                any defects found, whether the defect is or could become dangerous, and the
                examiner's recommendation (safe to use, repair required, or withdraw from service).
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="bg-orange-500/10 border border-orange-500/30 rounded-xl p-5">
              ...
              <ul className="space-y-2 text-sm text-white/70">
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Unique identification number</strong> — each item
                    must have a unique ID (engraved, tagged, or labelled)
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Description</strong> — type, manufacturer, model,
                    serial number
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Date of manufacture</strong> — from the
                ...
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Date of first use</strong> — when the item was
                ...
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Inspection history</strong> — dates and results
                    of all pre-use checks and inspections
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Thorough examination dates</strong> — dates,
                    results, and next due dates for LOLER examinations
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Maintenance records</strong> — any repairs,
                ...
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Withdrawal from service</strong> — date and
                    reason (end of life, irreparable damage, obsolescence)
                  </span>
                </li>
              </ul>
            </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div className="flex items-start gap-2 text-sm text-white/70">
                  ...
                  <span>
                    ...
                    date/time/GPS stamps provide irrefutable evidence of condition at the time of
                    inspection
                  </span>
                </div>
                <div className="flex items-start gap-2 text-sm text-white/70">
                ...
                <div className="flex items-start gap-2 text-sm text-white/70">
                  ...
                  <span>
                    ...
                    inspection status across multiple sites from anywhere
                  </span>
                </div>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="bg-amber-500/10 border border-amber-500/30 rounded-xl p-5 space-y-3">
            <p className="text-white/80 text-sm leading-relaxed">
              ...
              also asks to see the LOLER thorough examination report for a MEWP being used on site.
              The operator says "the hire company sorts all that" and has no documentation.
            </p>
            <div className="bg-black/20 rounded-lg p-4">
              ...
              <ul className="space-y-2 text-sm text-white/70">
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Scaffold records:</strong> Schedule 7 requires
                    the inspection report to be kept <em>on site</em> while the scaffold is in use.
                    "In the office" is not compliant if the office is not on site.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">LOLER report:</strong> The employer (not the hire
                    company) has the duty to ensure a valid thorough examination is in place. If the
                    report cannot be produced, the MEWP should not be in use.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Likely outcome:</strong> Prohibition notice on
                    the MEWP (stop use immediately), improvement notice for the scaffold records,
                    and potential prosecution if the situation is repeated.
                  </span>
                </li>
              </ul>
            </div>
        ...
        {/*  Quiz                                                         */}
        {/* ------------------------------------------------------------ */}
        <Quiz title="Section 4 — Inspection Regimes & Record Keeping" questions={quizQuestions} />
