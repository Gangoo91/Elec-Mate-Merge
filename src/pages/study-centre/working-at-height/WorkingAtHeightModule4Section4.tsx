...
const faqs = [
  {
    question: 'Can an anemometer reading alone determine whether to stop work at height?',
    answer:
  ...
  {
    question: 'Are there specific regulations about working at height in hot weather?',
    answer:
  ...
  {
    question: 'What are goal posts and when are they used near overhead power lines?',
    answer:
...
export default function WorkingAtHeightModule4Section4() {
  useSEO({
    title: 'Weather, Environment & Site Conditions | Working at Height Module 4.4',
    description:
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
          ...
          <div className="border-l-2 border-amber-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                <strong>Beaufort scale</strong> provides a standard way of classifying wind speed
                and its effects. For work at height, specific Beaufort Force levels act as trigger
                points for restricting or stopping different types of work.
              </p>

              <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                <p className="text-sm text-white leading-relaxed">
                  <strong className="text-amber-400">Key Point:</strong> Wind speed increases with
                  height. A Force 4 breeze at ground level may be Force 5 or higher at the top of a
                  scaffold. The competent person must consider the wind speed at the working height,
                  not just at ground level. If in doubt, use an anemometer at the working position.
                </p>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Rain affects work at height in multiple ways. It is not simply a matter of comfort
                &mdash; wet conditions create genuine hazards that significantly increase the risk
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white">
                  <p>
                    ...
                    slippery when wet. Aluminium ladder rungs are particularly hazardous in rain.
                    Anti-slip surfaces help but do not eliminate the risk.
                  </p>
                  <p>
                    <strong className="text-white">Reduced grip:</strong> Wet hands have reduced
                    grip strength. This affects the ability to hold tools, materials, and handrails.
                    Wet gloves can also reduce grip rather than improve it, depending on the glove
                    type and material being handled.
                  </p>
                  <p>
                    <strong className="text-white">Impaired visibility:</strong> Rain on safety
                    glasses or face shields obscures vision. Persistent rain reduces visibility of
                    the work area and of other site activities. This is particularly dangerous when
                    working near edges or openings.
                  </p>
                  <p>
                    <strong className="text-white">Tool handling:</strong> Wet tools are more
                    difficult to handle and more likely to be dropped. Dropped tools from height can
                    cause serious injuries to people below. Tool lanyards become even more important
                    in wet conditions.
                  </p>
                  <p>
                    <strong className="text-white">Cold stress and fatigue:</strong> Persistent rain
                    soaking through clothing causes body temperature to drop, leading to shivering,
                    loss of concentration, reduced dexterity, and increased fatigue. All of these
                    increase fall risk.
                  </p>
                  <p>
                    <strong className="text-white">Electrical risk:</strong> For electrical work at
                    height, wet conditions create additional electrocution risks. Water is a
                    conductor. Electrical testing or live work should not be carried out in rain
                    without specific controls and waterproof equipment.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                <p className="text-sm text-white leading-relaxed">
                  <strong className="text-amber-400">Key Point:</strong> There is no specific wind
                  speed equivalent for rain &mdash; it is a judgement call by the competent person
                  based on the intensity of the rain, the type of work, and the condition of the
                  working surfaces. Light drizzle may be acceptable for some tasks; heavy,
                  persistent rain may require all WAH to stop until conditions improve.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Ice and frost on working surfaces create an <strong>extreme slip hazard</strong>.
                Ladders, scaffold boards, MEWP platforms, and roof surfaces all become extremely
                dangerous when covered in ice or frost. Falls due to icy surfaces are a particular
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white">
                  <p>
                    ...
                    hours after air temperature rises above freezing, particularly on shaded
                    surfaces or metal scaffold boards. Workers may not see it until they slip.
                  </p>
                  <p>
                    <strong className="text-white">Frost on boards:</strong> Frost on scaffold
                    boards or ladder rungs dramatically reduces friction. A worker stepping onto a
                    frosty board can lose their footing instantly, particularly if they are carrying
                    tools or materials.
                  </p>
                  <p>
                    <strong className="text-white">Frozen mechanisms:</strong> Ice can freeze
                    scaffold fittings, MEWP controls, harness buckles, and ladder locking
                    mechanisms. These may appear functional but fail under load. All equipment must
                    be inspected and tested after freezing conditions.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong>Inspect before use:</strong> every morning following a cold night,
                      inspect all scaffold boards, ladder rungs, and platforms for ice or frost
                      before anyone accesses the equipment
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong>De-ice:</strong> use salt, grit, or warm water to remove ice. Allow
                      time for surfaces to dry before use. Check that de-icing does not create a
                      slip hazard from residual water
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong>Delay start:</strong> consider delaying the start of WAH until the
                      temperature has risen sufficiently for ice to melt and surfaces to dry
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong>Anti-slip measures:</strong> use non-slip mat overlays on scaffold
                      boards or specify boards with enhanced grip surfaces
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Lightning is one of the most dangerous weather hazards for work at height. Workers
                on scaffolding, MEWPs, ladders, roofs, and any elevated metallic structure are at
                extreme risk of being struck. Lightning kills between 1 and 3 people per year in the
                UK and injures many more.
              </p>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white">
                  <p>
                    ...
                    , you are within strike range. Stop all outdoor work at height immediately and
                    take shelter in a substantial building or fully enclosed vehicle.
                  </p>
                  <p>
                    <strong className="text-white">Second 30:</strong> Wait at least{' '}
                    <strong>30 minutes</strong> after the last observed lightning flash or thunder
                    before resuming any outdoor work at height. Lightning can strike from clear sky
                    up to 10 miles from the storm centre.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>Descend from all elevated positions immediately</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      Do not shelter under isolated trees, scaffold towers, or temporary structures
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      Seek shelter in a substantial building or a fully enclosed hard-topped vehicle
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      Do not touch metallic structures, scaffold, or fencing during a storm
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      Monitor weather forecasts for thunderstorm warnings throughout the day
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white leading-relaxed">
                  ...
                  also be lethal to anyone standing on wet ground near the strike point.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Both cold and hot conditions affect the safety of work at height. While UK
                regulations do not specify maximum or minimum working temperatures, the employer has
                a duty to assess the risks from temperature extremes and implement appropriate
                controls.
              </p>
                ...
                <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-4">
                  ...
                  <ul className="text-sm text-white space-y-1.5">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>
                        Reduced hand dexterity and grip strength &mdash; increased risk of losing
                        grip on rungs and handrails
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Numbness in fingers and toes &mdash; may not detect grip failure</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Increased fatigue and slower reaction times</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Ice formation on surfaces (see Section 03)</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>
                        <strong>Controls:</strong> warm clothing, regular breaks in heated shelter,
                        hot drinks, shorter shift rotations
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-orange-500/10 border border-orange-500/20 rounded-lg p-4">
                  ...
                  <ul className="text-sm text-white space-y-1.5">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>
                        Dehydration &mdash; reduces concentration and increases dizziness, a
                        critical risk at height
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Heat stress &mdash; confusion, nausea, and potential collapse</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>
                        Sunburn and UV exposure &mdash; particularly on scaffold platforms with no
                        shade
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Sweaty hands reducing grip on tools and handrails</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>
                        <strong>Controls:</strong> water, shade breaks, sunscreen, schedule heavy
                        work for cooler hours, monitor for heat stress symptoms
                      </span>
                    </li>
                  </ul>
                </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-green-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The stability of work at height equipment depends entirely on the stability of the
                ground it stands on. Scaffold, ladders, MEWPs, and mobile towers all transmit their
                load (including the weight of workers and materials) through their base to the
                ground. If the ground cannot support this load, the equipment can sink, tilt, or
                overturn.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white">
                  <p>
                    ...
                    base plates, ladder feet, or MEWP outriggers. The equipment can sink gradually
                    during use, which may not be noticed until it has tilted significantly.
                  </p>
                  <p>
                    <strong className="text-white">Slopes:</strong> Setting up scaffold, ladders, or
                    MEWPs on sloping ground creates an inherent instability. The equipment may
                    slide, tip, or overturn. Adjustable base plates, leg extensions, or levelling
                    jacks may be needed, but only within the manufacturer&rsquo;s specified limits.
                  </p>
                  <p>
                    <strong className="text-white">Uneven surfaces:</strong> Potholes, rubble,
                    uncompacted fill, and broken paving can prevent equipment from being set up
                    level. An unlevel scaffold or MEWP is an unstable scaffold or MEWP.
                  </p>
                  <p>
                    <strong className="text-white">Proximity to excavations:</strong> Setting up
                    equipment near the edge of an excavation (trench, pit, or foundation) creates a
                    risk of the ground collapsing under the load. The edge of an excavation is
                    inherently weakened ground. A safe distance (typically at least equal to the
                    depth of the excavation) must be maintained.
                  </p>
                  <p>
                    <strong className="text-white">Recently backfilled ground:</strong> Trenches
                    that have been recently backfilled may appear solid but have not consolidated.
                    They can collapse under point loads from outriggers or base plates.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                <p className="text-sm text-white leading-relaxed">
                  <strong className="text-amber-400">Key Point:</strong> Ground conditions must be
                  assessed before equipment is positioned. Remedial measures include ground mats,
                  sole plates (timber or steel), compaction, or relocating to a suitable area. The
                  competent person must verify that the ground can support the total load of the
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-amber-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Overhead power lines represent one of the most lethal hazards for work at height.
                Contact with or close approach to an overhead power line is almost always fatal. The
                voltages carried by overhead lines range from 230V (domestic supply) to 400,000V
                (National Grid transmission lines). At higher voltages, a fatal electric arc can
                jump across an air gap without physical contact.
              </p>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white leading-relaxed">
                  ...
                  current flows through the equipment and through the worker to ground, causing
                  electrocution and often fatal burns.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white">
                  ...
                  <p>
                    ...
                    erected on either side of access routes passing beneath overhead lines. They act
                    as height limiters to prevent tall vehicles or raised equipment from encroaching
                    on the safe clearance. Made from non-conductive materials.
                  </p>
                  <p>
                    <strong className="text-white">Banksman:</strong> A designated person stationed
                    near the overhead lines to guide vehicles, MEWPs, and cranes, ensuring they do
                    not approach within the exclusion zone. The banksman must have clear line of
                    sight to both the equipment and the power lines.
                  </p>
                  <p>
                    <strong className="text-white">Consult the DNO:</strong> Before any work at
                    height near overhead power lines, contact the distribution network operator.
                    They can advise on the voltage, the required clearances, and whether the line
                    can be diverted, insulated, or temporarily de-energised.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white leading-relaxed">
                  ...
                  boots, and insulated tools provide <strong>NO</strong> protection against overhead
                  line voltages.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                When work at height takes place in or near areas where members of the public are
                present (high streets, residential areas, schools, hospitals), additional measures
                must be implemented to protect the public from falling materials, tools, debris, and
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white">
                  <p>
                    ...
                    public from entering the area directly below or adjacent to the work at height.
                    The size of the zone depends on the height, the type of work, and the potential
                    for materials to bounce or roll after landing.
                  </p>
                  <p>
                    <strong className="text-white">Barriers and hoarding:</strong> Solid hoarding or
                    scaffolding fans/birdcages that physically prevent materials from falling onto
                    public areas. Scaffold fans (projecting platforms covered with boarding) are
                    commonly used over public footpaths adjacent to scaffolded buildings.
                  </p>
                  <p>
                    <strong className="text-white">Signage:</strong> Clear warning signs informing
                    the public that work at height is in progress and that there is a risk of
                    falling objects. Signs should be in plain language and visible from all approach
                    directions.
                  </p>
                  <p>
                    <strong className="text-white">Falling materials protection:</strong> Debris
                    netting on scaffold, brick guards at working levels, toe boards to prevent
                    materials sliding off platforms, and tool lanyards to prevent dropped tools.
                  </p>
                  <p>
                    <strong className="text-white">Banksmen/marshals:</strong> Designated personnel
                    stationed at ground level to manage public movement, redirect pedestrians, and
                    prevent people from entering exclusion zones. Essential during critical
                    operations such as lifting, scaffold erection/dismantling, and material
                    handling.
                  </p>
                  <p>
                    <strong className="text-white">Pedestrian management:</strong> Temporary
                    footpath diversions, covered walkways (pedestrian tunnels), and managed crossing
                    points to maintain safe public access while work is in progress.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                <p className="text-sm text-white leading-relaxed">
                  <strong className="text-amber-400">Key Point:</strong> The duty to protect the
                  public applies even when the work is on private property. If materials, tools, or
                  debris could fall onto a public highway, footpath, or adjacent property,
                  appropriate protection must be provided. Failure to do so can result in
                  prosecution under the Health and Safety at Work etc. Act 1974 Section 3 (duty to
                  persons not in employment) and potential civil liability for injury.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      A scaffold licence may be required from the local highway authority if
                      scaffold is erected on a public footpath or road
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      Road closures or traffic management may be needed if work overhangs a
                      carriageway
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      Schools, hospitals, and care homes in the vicinity must be notified if there
                      is any risk to vulnerable people
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      Residents of adjacent properties should be informed of the duration and nature
                      of the work
                    </span>
                  </li>
                </ul>
