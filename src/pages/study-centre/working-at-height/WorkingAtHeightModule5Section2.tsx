...
const faqs = [
  ...
  {
    question: 'What is the difference between a near miss and a dangerous occurrence?',
    answer:
  ...
  {
    question: 'Can a worker be blamed or disciplined for reporting a near miss?',
    answer:
...
const quizQuestions = [
  ...
  {
    id: 4,
    question: 'What is the primary purpose of root cause analysis after an incident?',
    options: [
  ...
  {
    id: 6,
    question: 'Which of the following is NOT a dangerous occurrence reportable under RIDDOR 2013?',
    options: [
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="bg-amber-500/10 border border-amber-500/30 rounded-xl p-5 mb-6">
          ...
          <p className="text-white text-base leading-relaxed">
            ...
            blame individuals. Near-miss reporting is equally important: every near miss is a free
            lesson that could prevent a future fatality.
          </p>
        </div>
        ...
        <div className="bg-red-500/10 border border-red-500/30 rounded-xl p-5 mb-8">
          ...
          <p className="text-white text-base leading-relaxed">
            ...
            the same accidents from recurring.
          </p>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-amber-500/40 pl-4 sm:pl-6 space-y-4">
            <p className="text-white text-sm leading-relaxed">
              ...
              (RIDDOR) require employers, the self-employed, and people in control of work premises
              to report certain serious workplace incidents to the Health and Safety Executive
            ...
            <div className="bg-white/5 border border-white/10 rounded-lg p-4">
              ...
              <ul className="space-y-2 text-sm text-white">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    RIDDOR replaced the earlier 1995 Regulations and simplified the reporting
                    categories
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    The "over-3-day" reporting threshold was changed to "over-7-day" in 2013
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    Reports are made to the HSE, not the local authority (for most workplaces)
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
            ...
            <div className="bg-orange-500/10 border border-orange-500/30 rounded-xl p-5">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm text-white mb-3">
                ...
                <div className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    Burns covering more than 10% of the body or causing significant damage to eyes,
            ...
            <div className="bg-purple-500/10 border border-purple-500/30 rounded-xl p-5">
              ...
              <ul className="space-y-2 text-sm text-white">
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Scaffold collapse</strong> — any substantial
                    collapse of a scaffold more than 5 metres high
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">MEWP overturning</strong> — any overturning of
                    lifting equipment designed to carry persons
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Structural collapse</strong> — unintended
                    collapse of a building, floor, wall, or structure under construction
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Electrical incidents</strong> — contact with
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
                ...
                <p className="text-white text-xs leading-relaxed">
                  ...
                  hours, the duty officer can be reached through the same number for fatalities.
                </p>
              </div>
              <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/40 pl-4 sm:pl-6 space-y-4">
            <p className="text-white text-sm leading-relaxed">
              ...
              conditions existed that allowed the fall to happen.
            </p>
            <div className="bg-purple-500/10 border border-purple-500/30 rounded-xl p-5">
              <h4 className="font-semibold text-white text-sm mb-3">
            ...
            <div className="bg-white/5 border border-white/10 rounded-lg p-4">
              ...
              <ul className="space-y-2 text-sm text-white">
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Inadequate training</strong> — workers did not
                    know what they were supposed to do or the risks involved
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Poor planning</strong> — the work was not
                    properly planned, risk-assessed, or method-statemented
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Defective equipment</strong> — equipment was
                    damaged, not maintained, or not fit for purpose
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Inadequate supervision</strong> — no one was
                    checking that procedures were being followed
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Organisational culture</strong> — safety was not
                    prioritised, shortcuts were tolerated, or time pressure overrode safety
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Communication failures</strong> — information was
                    not passed between shifts, trades, or management levels
                  </span>
                </li>
              </ul>
            </div>
          ...
          <div className="border-l-2 border-teal-500/40 pl-4 sm:pl-6 space-y-4">
            ...
            <div className="bg-white/5 border border-white/10 rounded-lg p-4">
              ...
              <ul className="space-y-2 text-sm text-white">
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Easy to report</strong> — simple forms, apps, or
                    verbal reports to a supervisor; remove barriers
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">No punishment</strong> — reporters are thanked,
                    not disciplined (unless deliberate recklessness)
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Visible action</strong> — management must be seen
                    to act on reports; if nothing changes, people stop reporting
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Feedback loop</strong> — tell the reporter what
                    action was taken; this closes the loop and encourages further reporting
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Confidential option</strong> — allow anonymous
                    reporting for those who prefer it
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-amber-500/10 border border-amber-500/30 rounded-lg p-4">
              ...
              <p className="text-white text-sm leading-relaxed">
                ...
                procedure updated — they are far more likely to continue reporting. The
                best-performing sites in terms of safety are invariably those with the highest
        ...
        {/*  Quiz                                                         */}
        {/* ------------------------------------------------------------ */}
        <Quiz title="Section 2 — Incident Reporting & Investigation" questions={quizQuestions} />
