...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'Assembling cable tray at ground level and then lifting it into position is an example of avoiding work at height — the assembly work is done safely at ground level rather than at height. This is the highest and most preferred level of the hierarchy.',
  },
  {
    id: 3,
    ...
    correctAnswer: 1,
    explanation:
      'Safety harnesses and lanyards are personal fall protection — they protect only the individual wearing them and depend on correct use. Collective protection measures (guardrails, toe boards, working platforms, scaffolds) protect everyone in the work area automatically.',
  },
  {
    id: 4,
    question:
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'A guardrail is a prevention measure — it physically prevents the worker from falling over the edge. Safety nets and airbags are mitigation measures — they do not prevent the fall, but reduce its consequences.',
  },
  {
    id: 7,
    question:
      'An electrician needs to install 50 metres of cable tray along a warehouse ceiling at 4 metres height. The task will take two full days. What is the most appropriate access equipment?',
    options: [
      'An extension ladder',
      'A stepladder',
...
export default function WorkingAtHeightModule1Section4() {
  useSEO({
    ...
    description:
      'Avoid, prevent, mitigate — the hierarchy of controls for working at height. Collective vs personal protection, practical examples for electricians, and the control pyramid.',
  });
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-amber-500/5 border-l-2 border-amber-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Level 1:</strong> AVOID &mdash; eliminate the need to work at height
              </li>
              <li>
                <strong>Level 2:</strong> PREVENT &mdash; stop falls with collective protection
              </li>
              <li>
                <strong>Level 3:</strong> MITIGATE &mdash; reduce fall consequences
              </li>
              <li>
                <strong>Rule:</strong> Collective protection always before personal
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-amber-500/5 border-l-2 border-amber-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Avoid:</strong> Pre-wire at ground level, use extendable tools
              </li>
              <li>
                <strong>Prevent:</strong> Tower scaffolds, MEWPs, guardrails
              </li>
              <li>
                <strong>Mitigate:</strong> Harnesses, safety nets, soft landing systems
              </li>
              <li>
                <strong>Always:</strong> Plan rescue before starting
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-green-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The most effective way to eliminate the risk of a fall is to{' '}
                <strong>not work at height at all</strong>. This is the first and highest level of
                the hierarchy, and it should always be considered before any other option. The
                question to ask is:
                <em>
                  {' '}
                  &ldquo;Is there a way to carry out this work without anyone going to
                  height?&rdquo;
                </em>
              </p>

              <p>
                For electricians, there are often more opportunities to avoid working at height than
                you might think. Many tasks can be redesigned, re-sequenced, or completed using
                ground-level techniques and tools.
              </p>
              ...
              <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Pre-fabrication at ground level</strong>{' '}
                      &mdash; assemble cable tray runs, containment sections, and modular wiring
                      systems at ground level and lift them into position as complete units using a
                      crane, hoist, or MEWP. This minimises the time anyone spends at height.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-green-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Extendable tools</strong> &mdash; use
                      telescopic pole systems for testing smoke detectors, changing lamps, and
                      inspecting high-level equipment from ground level. Specialist tools exist for
                      many routine maintenance tasks.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-green-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Design changes</strong> &mdash; work with the
                      designer to relocate distribution boards, isolators, and control equipment to
                      accessible heights. Position cable routes at lower levels where feasible.
                      Specify luminaires with ground-level lowering mechanisms (winch systems).
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-green-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Pre-wired modular systems</strong> &mdash;
                      specify factory-wired lighting, power, and data systems that plug together
                      rather than requiring termination at height. Systems like plug-and-play
                      modular wiring reduce both time at height and the complexity of work done at
                      height.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-green-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Ground-level access</strong> &mdash; where
                      equipment requires regular maintenance (e.g. luminaire drivers, emergency
                      lighting batteries), specify equipment with ground-level access for the
            ...
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  <strong className="text-white">passively and automatically</strong>. A guardrail
                  protects every person who works near that edge, regardless of whether they are
                  wearing a harness, have been trained, or are paying attention. Personal protection
                  depends entirely on the individual &mdash; it must be worn correctly, inspected
                  regularly, and connected to a suitable anchor. Any failure in this chain renders
                  it ineffective.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-4 text-sm text-white/80">
                  <div>
                    ...
                    <p className="mb-2">
                      The most common form of collective protection. Required at any edge where a
                      person could fall 2 metres or more (or less if there is a particular risk).
                      Must include:
                    </p>
                    <ul className="space-y-1.5">
                      <li className="flex items-start gap-2">
                        ...
                        <span>
                          <strong className="text-white">Top rail</strong> at a minimum height of
                          950mm (ideally 1100mm)
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                        <span>
                          <strong className="text-white">Mid rail</strong> (or suitable infill) to
                      ...
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                        <span>
                          <strong className="text-white">Toe board</strong> at least 150mm high to
                          prevent tools and materials falling from the edge
                        </span>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="mb-2">
                      A stable, level surface from which work at height is carried out. Must be:
                    </p>
                    <ul className="space-y-1.5">
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                        <span>
                          Wide enough for the work being carried out (minimum 600mm for passage,
                          wider for work)
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                      ...
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                        <span>
                          Free from tripping hazards and not overloaded beyond its rated capacity
                        </span>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="mb-2">
                      Fixed scaffolds, mobile tower scaffolds, and system scaffolds all provide
                      working platforms with edge protection:
                    </p>
                    <ul className="space-y-1.5">
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                        <span>
                          <strong className="text-white">Fixed scaffolding</strong> &mdash; erected
                          by trained scaffolders, inspected before use and at 7-day intervals (or
                          after adverse weather). Must display a scaffold inspection tag.
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                        <span>
                          <strong className="text-white">Mobile tower scaffolds</strong> &mdash;
                          must be erected and used by persons with PASMA training.
                          Outriggers/stabilisers must be deployed. Never move a tower with anyone on
                          it.
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                        <span>
                          <strong className="text-white">Podium steps</strong> &mdash; a low-level
                          enclosed platform with guardrails, ideal for short-duration electrician
                          tasks up to approximately 2.5m working height.
                        </span>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="mb-2">
                      Include cherry pickers (boom lifts), scissor lifts, and truck-mounted
                      platforms:
                    </p>
                    <ul className="space-y-1.5">
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                        <span>
                          Operators must hold IPAF or equivalent certification for the category of
                          MEWP
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                        <span>
                          MEWPs must be thoroughly examined under LOLER 1998 every 6 months
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                        <span>
                          Ground conditions must be firm, level, and able to support the
                          machine&rsquo;s weight
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                        <span>
                          A harness must be worn inside a boom-type MEWP (to prevent ejection); not
                          typically required in scissor lifts unless specified by the risk
                          assessment
                        </span>
                      </li>
                    </ul>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The third and final level of the hierarchy applies when working at height cannot be
                avoided and falls cannot be entirely prevented. In this case, the goal is to
                <strong> minimise the distance and consequences</strong> of any fall that does
                occur. This is mitigation &mdash; accepting that a fall may happen and ensuring that
                the outcome is as least harmful as possible.
              </p>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  be used when avoidance and prevention are not reasonably practicable, and they
                  must always be accompanied by a{' '}
                  <strong className="text-white">rescue plan</strong>.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-4 text-sm text-white/80">
                  <div>
                    ...
                    <ul className="space-y-1.5">
                      ...
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                        <span>
                          Must be installed as close as possible below the work level (maximum 2
                          metres recommended)
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                        <span>
                          Must be installed and inspected by competent persons to BS EN 1263
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                        <span>
                          Preferred over personal fall protection because they protect everyone
                          (collective measure)
                        </span>
                      </li>
                    </ul>
                  ...
                  <div>
                    ...
                    <ul className="space-y-1.5">
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                        <span>
                          Inflatable airbag systems or bean-bag-style soft landing systems
                      ...
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                        <span>
                          Useful for low-level work (typically up to 3-4 metres) where nets are not
                          practical
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                        <span>
                          Must not be used as a substitute for guardrails where guardrails are
                  ...
                  <div>
                    <p className="text-red-400 font-medium mb-1">
                      Personal Fall Protection (Harnesses, Lanyards, SRLs)
                    </p>
                    <ul className="space-y-1.5">
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                        <span>
                          <strong className="text-white">Full body harness</strong> (BS EN 361) with
                          dorsal attachment point &mdash; distributes arrest forces across the body
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                        <span>
                          <strong className="text-white">Energy-absorbing lanyard</strong> (BS EN
                          354/355) &mdash; limits arrest force to a maximum of 6 kN
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                        <span>
                          <strong className="text-white">Self-retracting lifeline (SRL)</strong> (BS
                          EN 360) &mdash; automatically takes up slack and locks in a fall
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                        <span>
                          <strong className="text-white">Anchor point</strong> (BS EN 795) &mdash;
                          must be rated for at least 12 kN and positioned to minimise fall distance
                          and avoid a pendulum swing
                        </span>
                      </li>
                    </ul>
                  </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="bg-white/5 border border-white/10 rounded-lg p-3 space-y-2 text-sm text-white/80">
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Lanyard length:</strong> up to 2.0 metres
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Energy absorber deployment:</strong> up to 1.75
                      metres
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Harness stretch:</strong> approximately 0.5
                      metres
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Height of person below D-ring:</strong>{' '}
                  ...
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Safety clearance:</strong> minimum 1.0 metre
                    </span>
                  </div>
                  <div className="border-t border-white/10 pt-2 mt-2">
                    <p className="text-amber-400 font-semibold">
                      Total minimum clearance: approximately 6.75 metres
                    </p>
                  </div>
                </div>
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                requirement of Regulation 4 of the Work at Height Regulations 2005. The rescue plan
                must ensure that a fallen worker can be reached, stabilised, and lowered to safety
                within <strong>minutes</strong>, not hours.
              </p>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1.5">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      The leg straps of the harness compress the femoral veins in the thighs
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                      Loss of consciousness can occur within{' '}
                      <strong className="text-white">5&ndash;15 minutes</strong>
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                      Death can follow within{' '}
                      <strong className="text-white">15&ndash;30 minutes</strong> if not rescued
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                      Even after rescue, rapid lowering to a flat position can cause cardiac arrest
                      (reflow syndrome)
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Rescue method</strong> &mdash; how will a
                      suspended worker be reached? Options include a MEWP, a rescue winch system, a
                      trained rescue team on standby, or a self-rescue device.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Rescue equipment</strong> &mdash; is all
                      necessary rescue equipment available on site, in working order, and
                      accessible?
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Trained personnel</strong> &mdash; who on site
                      is trained in the rescue procedure? Is there always at least one trained
                      rescuer present while work at height is ongoing?
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Time to rescue</strong> &mdash; can the rescue
                      be completed within minutes? The target should be to begin rescue within 5
                      minutes and complete it within 15 minutes.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Emergency services</strong> &mdash; is the work
                      area accessible to the emergency services? Have they been notified if the
                      location is remote or difficult to access?
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Post-rescue care</strong> &mdash; do rescuers
                      know to place the casualty in a semi-seated position (not flat) to prevent
                      reflow syndrome?
                    </span>
                  </li>
                </ul>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-amber-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg overflow-x-auto">
                ...
                <div className="min-w-[500px]">
                  <div className="grid grid-cols-4 gap-1 text-xs">
                    ...
                    <div className="p-2 bg-green-500/10 rounded font-medium text-green-400">
                      Avoid?
                    </div>
                    <div className="p-2 bg-amber-500/10 rounded font-medium text-amber-400">
                      Prevent
                    </div>
                    <div className="p-2 bg-red-500/10 rounded font-medium text-red-400">
                      Mitigate
                    </div>
              ...
              <p>
                The key message is that the hierarchy is not just a theoretical framework &mdash; it
                is a practical decision-making tool that must be applied to every task, every day.
                Before you reach for a ladder, ask yourself:{' '}
                <em>
                  &ldquo;Can this work be done without going to height? If not, what is the safest
                  way to prevent a fall?&rdquo;
                </em>
              </p>
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1.5">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      The task is <strong className="text-white">short duration</strong> (typically
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      The task is <strong className="text-white">light duty</strong> (no heavy
                      loads, no complex work requiring both hands)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      Three points of contact can be{' '}
                      <strong className="text-white">maintained at all times</strong>
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      The ladder can be <strong className="text-white">securely positioned</strong>{' '}
                      (tied, footed, or stabilised)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      ...
                      <strong className="text-white">not reasonably practicable</strong>
                    </span>
                  </li>
                </ul>
              </div>
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <ul className="text-sm text-white/80 space-y-2">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong className="text-white">Hierarchy:</strong> Avoid &rarr; Prevent &rarr;
                    Mitigate. Always start at the top and only move down when the level above is not
                    reasonably practicable.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Avoidance:</strong> Pre-fabrication, extendable
                    tools, design changes, ground-level access, and modular systems can all
                ...
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Prevention:</strong> Collective protection
                    (guardrails, platforms, scaffolds, MEWPs) is always preferred. It protects
                ...
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Mitigation:</strong> Safety nets, airbags, and
                    harness systems are the last resort. They minimise consequences but do not
                    prevent falls.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Rescue:</strong> A credible rescue plan is
                    mandatory whenever harnesses are used. Suspension trauma can kill within
                    15&ndash;30 minutes.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Ladders:</strong> Only appropriate for
                    short-duration, light-duty tasks where more suitable equipment is not reasonably
                    practicable.
                  </span>
                </li>
              </ul>
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  ...
                  height, the legal framework, risk assessment, and the hierarchy of controls. In
                  Module 2, we will move on to the practical use of specific equipment: ladders,
                  stepladders, tower scaffolds, and other access equipment that electricians use
                  every day.
                </p>
              </div>
            </div>
