...
const faqs = [
  ...
  {
    question: 'How often should PASMA training be refreshed?',
    answer:
  ...
  {
    question: 'Can an employer delegate their health and safety duties to someone else?',
    answer:
  ...
  {
    question: 'What are toolbox talks and are they a legal requirement?',
    answer:
...
export default function WorkingAtHeightModule5Section3() {
  useSEO({
    title: 'Roles, Responsibilities & Competence | Module 5 | Working at Height',
    description:
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="bg-amber-500/10 border border-amber-500/30 rounded-xl p-5 mb-6">
          ...
          <p className="text-white/80 text-base leading-relaxed">
            ...
            appoint a principal designer and principal contractor. A competent person has the right
            combination of training, experience, and knowledge for the specific task. Key
            qualifications include PASMA, IPAF, CISRS, and harness training — all requiring regular
            refreshers.
          </p>
        </div>
        ...
        <div className="bg-blue-500/10 border border-blue-500/30 rounded-xl p-5 mb-8">
          ...
          <p className="text-white/80 text-base leading-relaxed">
            ...
            Regulations 2005 (specific work-at-height requirements), and the Construction (Design
            and Management) Regulations 2015 (construction-specific duties for clients, designers,
            and contractors).
          </p>
        </div>
          ...
          <div className="border-l-2 border-amber-500/40 pl-4 sm:pl-6 space-y-4">
              ...
              <ul className="space-y-2 text-sm text-white/70">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    ...
                    practicable — can the task be done from the ground instead?
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Provide a safe system of work</strong> — risk
                    assessments, method statements, permits to work where required
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Select suitable equipment</strong> — the right
                    type of access equipment for the task, environment, and duration
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Provide training</strong> — appropriate to the
                    equipment and tasks, including emergency procedures
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    ...
                    proportionate to the risk, competence of workers, and complexity of the task
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Maintain equipment</strong> — ensure inspection,
                    maintenance, and thorough examination schedules are followed
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Plan for emergencies</strong> — rescue plans,
                    trained rescuers, and rescue equipment must be in place before work begins
                  </span>
                </li>
              </ul>
            </div>
            <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-4">
              ...
              <p className="text-white/70 text-sm leading-relaxed">
                ...
                individual managers and directors can be personally prosecuted under the Corporate
                Manslaughter and Corporate Homicide Act 2007 or gross negligence manslaughter.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="border-l-2 border-blue-500/40 pl-4 sm:pl-6 space-y-4">
            ...
            <div className="bg-blue-500/10 border border-blue-500/30 rounded-xl p-5">
              <ul className="space-y-3 text-sm text-white/70">
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Take reasonable care</strong> for their own
                    health and safety and that of other persons who may be affected by their acts or
                    omissions at work
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Cooperate with the employer</strong> to enable
                    them to comply with health and safety duties — attend training, follow
                    procedures, wear PPE as instructed
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Not misuse or interfere</strong> with anything
                    provided for health and safety purposes — this includes guardrails, harnesses,
                ...
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Report defects and hazards</strong> to their
                    employer or supervisor — including damaged equipment, missing guardrails, and
                    unsafe conditions
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Use equipment properly</strong> in accordance
                    with their training and the manufacturer's instructions
                  </span>
                </li>
              </ul>
            </div>
            <div className="bg-white/5 border border-white/10 rounded-lg p-4">
              ...
              <p className="text-white/70 text-sm leading-relaxed">
                ...
                harness, or misusing access equipment are all prosecutable offences.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="bg-orange-500/10 border border-orange-500/30 rounded-xl p-5">
              ...
              <ul className="space-y-2 text-sm text-white/70">
                ...
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    Not start work unless satisfied that adequate welfare facilities are available
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    Ensure workers under their control are competent for the tasks assigned
                  </span>
                </li>
              </ul>
            </div>
          ...
          <div className="border-l-2 border-purple-500/40 pl-4 sm:pl-6 space-y-4">
            ...
            <div className="bg-purple-500/10 border border-purple-500/30 rounded-xl p-5">
              ...
              <ul className="space-y-2 text-sm text-white/70">
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Appoint a principal designer</strong> (for
                    projects with more than one contractor) — responsible for planning, managing,
                    and coordinating health and safety during the pre-construction phase
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Appoint a principal contractor</strong> (for
                    projects with more than one contractor) — responsible for planning, managing,
                    and coordinating health and safety during the construction phase
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Ensure adequate arrangements</strong> are made
                    for managing the project — including welfare, time, and resources
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    ...
                    information about the site, existing structures, hazards, and previous surveys
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Allow adequate time</strong> — not set
                    unrealistic deadlines that compromise safety
                  </span>
                </li>
              </ul>
            </div>
            <div className="bg-white/5 border border-white/10 rounded-lg p-4">
              ...
              <p className="text-white/70 text-sm leading-relaxed">
                ...
                the principal contractor (multiple contractors). However, domestic clients can still
                be held responsible if they make specific arrangements that compromise safety.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-indigo-500/40 pl-4 sm:pl-6 space-y-4">
              ...
              <div className="bg-indigo-500/10 border border-indigo-500/30 rounded-lg p-4">
                ...
                <ul className="space-y-1.5 text-sm text-white/70">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      Towers for Users — the standard course for assembling and using mobile access
                      towers
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      Refresher recommended every 5 years (many clients require more frequent)
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-indigo-500/10 border border-indigo-500/30 rounded-lg p-4">
                ...
                <ul className="space-y-1.5 text-sm text-white/70">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      Emergency First Aid at Work (EFAW) — 1-day course, valid for 3 years
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
            ...
            {/* Refresher Summary */}
            <div className="bg-white/5 border border-white/10 rounded-lg p-4">
              <h4 className="font-semibold text-white text-sm mb-2">Refresher Training Summary</h4>
            ...
            <div className="bg-cyan-500/10 border border-cyan-500/30 rounded-lg p-4">
              ...
              <ul className="space-y-2 text-sm text-white/70">
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Keep them short</strong> — 10-15 minutes maximum;
                    longer and attention drops
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Make them relevant</strong> — cover topics
                    directly related to today's work (not a generic presentation)
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Be interactive</strong> — ask questions, invite
                    feedback, discuss recent near misses
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Record attendance</strong> — sign-in sheets
                    provide evidence of information delivery
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Vary the topics</strong> — rotate through
                    different hazards, procedures, and lessons learned
                  </span>
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="bg-gradient-to-br from-amber-500/5 to-purple-500/5 border border-amber-500/20 rounded-xl p-5">
            <p className="text-white/60 text-xs mb-4">
              ...
              &middot; <strong className="text-purple-400">I</strong> = Informed (kept up to date)
            </p>
            ...
            <div className="overflow-x-auto -mx-2 px-2">
              <div className="min-w-[500px]">
                ...
                {[
                  ...
                  <div key={i} className={`grid grid-cols-5 gap-1 mb-1 ${i % 2 === 0 ? '' : ''}`}>
                    <div className="bg-white/5 rounded-lg p-2">
                      <span className="text-white text-[10px] font-medium">{row.task}</span>
                    </div>
        ...
        {/*  Quiz                                                         */}
        {/* ------------------------------------------------------------ */}
        <Quiz title="Section 3 — Roles, Responsibilities & Competence" questions={quizQuestions} />
