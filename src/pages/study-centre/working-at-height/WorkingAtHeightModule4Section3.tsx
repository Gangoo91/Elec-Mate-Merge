...
const faqs = [
  {
    question: 'Is a method statement the same as a risk assessment?',
    answer:
  ...
  {
    question: 'Can the emergency services be relied upon as the sole rescue plan?',
    answer:
  ...
  {
    question: 'How often should rescue plans be rehearsed?',
    answer:
  ...
  {
    question: 'What are trauma straps and when should they be used?',
    answer:
...
const quizQuestions = [
  ...
  {
    id: 6,
    question: 'A method statement should be prepared for which of the following?',
    options: [
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
          ...
          <div className="p-4 rounded-lg bg-amber-500/5 border-l-2 border-amber-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li className="flex items-start gap-2">
                ...
                <span>
                  <strong>Method statement:</strong> step-by-step safe system of work
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                <span>
                  <strong>Rescue plan:</strong> required by Reg 4(1), must exist before work starts
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                <span>
                  <strong>Suspension trauma:</strong> unconsciousness in 15&ndash;30 minutes
                </span>
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-amber-500/5 border-l-2 border-amber-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                <span>
                  <strong>Before:</strong> write method statement, prepare rescue plan, rehearse
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
          ...
          <div className="border-l-2 border-amber-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                <strong>safe system of work (SSOW)</strong> &mdash; is a document that describes
                exactly how a work activity will be carried out safely. For work at height, it
                translates the findings of the risk assessment into a practical, step-by-step plan
                that workers can follow on site.
              </p>

              <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                <p className="text-sm text-white leading-relaxed">
                  <strong className="text-amber-400">Key Point:</strong> A method statement is not a
                  risk assessment. The risk assessment identifies what could go wrong and how likely
                  it is. The method statement describes how the work will be done safely,
                  incorporating the controls identified in the risk assessment. Together they form
                  the RAMS (Risk Assessment and Method Statement) package.
                </p>
              </div>

              <p>
                A well-written method statement for work at height serves three critical functions.
                First, it forces the planner to think through every step of the task and identify
                the hazards at each stage. Second, it provides a clear reference for workers on site
                so they know exactly what is expected. Third, it provides evidence that the work was
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white/80">
                  ...
                  <p>
                    ...
                    order in which the work will be carried out. This includes setting up access
                    equipment, carrying out the work task itself, and dismantling/removing equipment
                    after completion.
                  </p>
                  <p>
                    <strong className="text-white">Hazards and controls at each stage:</strong> For
                    each step in the sequence, the specific hazards that exist and the specific
                    controls that will be applied. This is where the risk assessment findings are
                    translated into practical actions.
                  </p>
                  <p>
                    <strong className="text-white">Equipment required:</strong> All access
                    equipment, PPE, tools, and materials needed for the task. Include specific
                    requirements such as harness type, lanyard length, scaffold configuration, or
                    MEWP specification.
                  </p>
                  <p>
                    <strong className="text-white">Competence requirements:</strong> The
                    qualifications, training, and experience required for each role in the task. For
                    example, PASMA trained for scaffold towers, IPAF licensed for MEWPs, harness
                    training for fall arrest systems.
                  </p>
                  <p>
                    <strong className="text-white">Emergency procedures:</strong> The rescue plan,
                    first aid arrangements, emergency contact numbers, and evacuation route. This
                    section should reference or include the full rescue plan.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                A method statement should be prepared for{' '}
                <strong>all non-trivial work at height tasks</strong>. The level of detail should be
                proportionate to the risk &mdash; a complex scaffold erection will require a far
                more detailed method statement than a short-duration task on a podium step.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>Work near leading edges, openings, or fragile surfaces</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>Any task requiring a harness or fall arrest system</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>Roof work of any type (flat, pitched, or industrial)</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>Tasks requiring coordination between multiple trades</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>Work near overhead power lines or other environmental hazards</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>Any task lasting more than 30 minutes at height</span>
                  </li>
                </ul>
              </div>

              <p>
                For routine, low-risk tasks (such as a brief ladder task by a competent worker in a
                controlled environment), a verbal briefing based on the risk assessment may be
                sufficient. However, even for these tasks, having a standard method statement that
                covers the typical risks and controls is good practice.
              </p>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80 leading-relaxed">
                  ...
                  reads. A method statement must be specific to the work being done and must be
                  communicated to the workers before the task begins.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                <strong>Regulation 4(1) of the Work at Height Regulations 2005</strong> requires
                that the planning of work at height includes{' '}
                <strong>emergency procedures, including rescue</strong>. This is not a
                recommendation &mdash; it is a legal duty. A rescue plan must be in place before any
                person goes to height. It must not be improvised after an incident has occurred.
              </p>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80 leading-relaxed">
                  ...
                  <em>
                    ...
                    planned; (b) appropriately supervised; and (c) carried out in a manner which is
                    so far as is reasonably practicable safe; and that its planning includes
                    selection of work equipment&hellip; and planning for emergencies and
                    rescue.&rdquo;
                  </em>
                </p>
              </div>
              ...
              <p>
                The rescue plan must be specific to the work being carried out. A generic rescue
                plan that says &ldquo;call 999&rdquo; is not adequate for work where a person could
                be suspended in a harness. The plan must identify the type of rescue that will be
                used, the equipment available, the trained personnel on site, and the expected time
                from alarm to rescue.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>What rescue equipment is needed and where is it located?</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>Who on site is trained to carry out the rescue?</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>How will the alarm be raised? (radio, phone, shout, horn)</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>How long will rescue take from alarm to ground level?</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>What first aid provision is available? Who is the first aider?</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>How will the emergency services access the location?</span>
                  </li>
                </ul>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-teal-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Rescue plans for work at height must consider three types of rescue. The appropriate
                type depends on the nature of the work, the height involved, the equipment being
                used, and the availability of trained rescue personnel on site.
              </p>
              ...
              <div className="space-y-4">
                <div className="bg-green-500/10 border border-green-500/20 rounded-lg p-4">
                  ...
                  <ul className="text-sm text-white/80 space-y-1">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>
                        Using a personal rescue device to lower yourself after a fall into a harness
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Deploying trauma straps while awaiting further assistance</span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-4">
                  ...
                  <ul className="text-sm text-white/80 space-y-1">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>
                        A colleague uses a rescue pole to bring a suspended person to a platform
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Operating a rescue descent device to lower the casualty</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Using a MEWP to reach and retrieve a suspended person</span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-purple-500/10 border border-purple-500/20 rounded-lg p-4">
                  ...
                  <ul className="text-sm text-white/80 space-y-1">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Specialist rope access rescue teams</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Air ambulance (for remote locations or complex casualties)</span>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80 leading-relaxed">
                  ...
                  20&ndash;30 minutes or more. Suspension trauma can cause unconsciousness within
                  15&ndash;30 minutes. For harness-based work, on-site assisted rescue capability is
                  normally essential.
                </p>
              </div>
            </div>
          ...
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                or <strong>orthostatic intolerance</strong>) is a potentially fatal condition that
                occurs when a person is suspended motionless in a harness after a fall. It is one of
                the most critical factors in rescue planning for any work at height that involves
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white/80">
                  <p>
                    ...
                    limbs. The heart receives less blood with each beat, reducing blood pressure and
                    oxygen delivery to the brain.
                  </p>
                  <p>
                    <strong className="text-white">Within 5&ndash;10 minutes:</strong> The person
                    may begin to feel dizzy, nauseous, and breathless. Vision may blur and cognitive
                    function begins to deteriorate.
                  </p>
                  <p>
                    <strong className="text-white">Within 15&ndash;30 minutes:</strong> The person
                    may lose consciousness due to insufficient blood supply to the brain. Once
                    unconscious, they cannot deploy trauma straps or assist in their own rescue.
                  </p>
                  <p>
                    <strong className="text-white">Beyond 30 minutes:</strong> Cardiac arrest and
                    death can occur. Even if the person is rescued alive, a sudden release from the
                    harness can cause &ldquo;rescue death&rdquo; &mdash; a flood of pooled,
                    deoxygenated blood returning to the heart, which can trigger fatal cardiac
                    arrhythmia.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                <p className="text-sm text-white leading-relaxed">
                  <strong className="text-amber-400">Key Point:</strong> After rescue, a person who
                  has been suspended for any significant period must <strong>not</strong> be laid
                  flat on their back immediately. They should be placed in a seated or
                  semi-recumbent position (the &ldquo;W position&rdquo; &mdash; knees raised) and
                  monitored until medical professionals arrive. Laying them flat can cause the
                  pooled blood to return to the heart too quickly, risking cardiac arrest.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>Injuries that prevent movement (broken limbs)</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>Cold weather (blood vessels constrict, worsening pooling)</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>Dehydration or existing cardiovascular conditions</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>Poor harness fit (tight straps increase compression)</span>
                  </li>
                </ul>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The rescue plan must specify the rescue equipment that will be available on site and
                confirm that the rescue team is trained in its use. Equipment must be readily
                accessible &mdash; a rescue device locked in a store room 200 metres from the work
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-3 text-sm text-white/80">
                  <p>
                    ...
                    typically attach to the casualty&rsquo;s harness dorsal attachment point and use
                    a friction-based or ratchet mechanism to control the descent speed. The rescuer
                    operates from above or from ground level depending on the device type.
                  </p>
                  <p>
                    <strong className="text-white">Trauma straps:</strong> Loops of webbing that
                    attach to the harness and allow the suspended person to stand in them, using leg
                    muscle movement to pump blood back towards the heart. They delay the onset of
                    suspension trauma but are not a substitute for rescue. Every harness should have
                    trauma straps fitted.
                  </p>
                  <p>
                    <strong className="text-white">Rescue poles:</strong> Telescopic poles that can
                    reach a suspended person and either connect to their harness for positioning or
                    provide a means to bring them within reach of a rescue platform. Used where the
                    casualty is out of direct arm&rsquo;s reach.
                  </p>
                  <p>
                    <strong className="text-white">Lowering systems:</strong> Rope-based systems
                    with braking devices that allow a rescuer to lower a casualty in a controlled
                    manner. These may be pre-rigged (set up before work begins) or deployed during
                    the rescue.
                  </p>
                  <p>
                    <strong className="text-white">Rescue stretchers:</strong> For casualties with
                    potential spinal or serious injuries, a rescue stretcher allows the person to be
                    lowered horizontally. These are typically used by specialist rescue teams or
                    emergency services.
                  </p>
                </div>
              </div>
              ...
              <p>
                All rescue equipment must be inspected before each use, maintained in accordance
                with the manufacturer&rsquo;s instructions, and subjected to periodic thorough
                examination. Rescue equipment that is defective, damaged, or past its inspection
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-green-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                A rescue plan that has never been practised is an untested theory. It may contain
                assumptions that do not hold in reality &mdash; the equipment may not reach the
                casualty, the rescue team may not know where the kit is stored, the process may take
                longer than the critical window for suspension trauma, or the communication chain
                may fail under pressure.
              </p>

              <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                <p className="text-sm text-white leading-relaxed">
                  <strong className="text-amber-400">Key Point:</strong> Rescue plans must be
                  rehearsed, not just written. A drill does not need to involve dropping a person
                  from height &mdash; it can use a weighted dummy or a volunteer in a harness at low
                  level. The purpose is to test the process: raising the alarm, locating the
                  equipment, reaching the casualty, and completing the rescue within the required
                  time.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      Can the rescue team locate and deploy the equipment within 5 minutes?
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>Can the casualty be reached from the rescue position?</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      Can the rescue be completed within 15 minutes (before suspension trauma
                      becomes critical)?
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>Does every team member know their role?</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>Is the post-rescue care (W-position, first aid) understood?</span>
                  </li>
                </ul>
              </div>

              <p>
                Document every drill: the date, the scenario, the participants, the time taken, any
                problems identified, and the corrective actions. If a drill reveals a problem (such
                as the rescue taking too long), the plan must be revised and the drill repeated
                until the process works within the required time.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-amber-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The following decision tree helps determine the appropriate type of rescue for a
                given work at height scenario. Use this during the planning stage to ensure the
                rescue plan matches the work.
              </p>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    ...
                    <div className="space-y-3">
                      <div className="text-center">
                        <span className="text-xs text-green-400 font-semibold">YES</span>
                      </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The rescue plan should not be a separate, standalone document that is filed away
                from the method statement. It should be{' '}
                <strong>integrated into the method statement</strong> as the emergency procedures
                section. This ensures that the rescue arrangements are specific to the actual work
                being carried out and are reviewed every time the method statement is briefed to the
                workforce.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      Include the rescue plan as Section X of the method statement (typically the
                      last section before sign-off)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      Reference the specific equipment being used for the task and how rescue would
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      Name the rescue-trained personnel who will be on site during the work
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>Specify the location of rescue equipment relative to the work area</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>Include emergency contact numbers and the nearest A&amp;E location</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>Record the date of the last rescue drill and any issues identified</span>
                  </li>
                </ul>
              </div>

              <p>
                When the method statement is briefed to the workforce, the rescue plan section must
                be covered explicitly. Workers must be asked to confirm that they understand the
                rescue procedure, know where the equipment is, and know how to raise the alarm. This
                is not optional &mdash; it is part of the legal requirement to plan for emergencies.
              </p>
            </div>
          </div>
        </section>
