...
const faqs = [
  ...
  {
    question: 'What is suspension trauma and why does it affect harness users?',
    answer:
  ...
  {
    question: 'Is a chest-only harness acceptable for fall arrest?',
    answer:
...
const quizQuestions = [
  ...
  {
    id: 3,
    question: 'What does EN 355 specify?',
    options: [
      'Full body harnesses',
...
export default function WorkingAtHeightModule3Section2() {
  useSEO({
    title: 'Personal Fall Protection Systems | Module 3 Section 2 | Working at Height',
    description:
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
          ...
          <div className="border-l-2 border-amber-500/30 pl-4 sm:pl-6 space-y-4">
            ...
            <div className="rounded-xl border border-white/10 bg-white/[0.02] p-4">
              ...
              <p className="text-white text-sm leading-relaxed">
                ...
                hang syndrome). You cannot rely on the emergency services for this — the rescue plan
            ...
            <p className="text-white text-sm sm:text-base leading-relaxed">
              ...
              from MEWPs where an anchor point on the platform requires the operator to wear a
              harness.
            </p>
          </div>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="border-l-2 border-blue-500/30 pl-4 sm:pl-6 space-y-4">
            ...
            <h3 className="text-white font-semibold text-base mt-4 mb-3">Component Functions</h3>
            <div className="space-y-3">
              {[
                {
        ...
        <section className="mb-12">
          ...
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6 space-y-4">
            ...
            <p className="text-white text-sm sm:text-base leading-relaxed">
              ...
              This controlled tearing extends the deceleration time and limits the peak force on the
              body to the EN 355 maximum of 6 kN.
            </p>
            <div className="space-y-2">
              {[
            ...
            <p className="text-white text-sm sm:text-base leading-relaxed">
              ...
              traversing along a structure or when anchor points need to be changed frequently.
            </p>
          </div>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="border-l-2 border-purple-500/30 pl-4 sm:pl-6 space-y-4">
            <p className="text-white text-sm sm:text-base leading-relaxed">
              ...
              and the extraction speed exceeds a set threshold, an internal braking mechanism locks
        ...
        <section className="mb-12">
          ...
          <div className="border-l-2 border-cyan-500/30 pl-4 sm:pl-6 space-y-4">
            ...
            <div className="rounded-xl border border-amber-500/20 bg-amber-500/5 p-4 mt-4">
              <h4 className="text-amber-400 text-sm font-semibold mb-2">Minimum Anchor Strength</h4>
              <div className="space-y-2">
                {[
        ...
        <section className="mb-12">
          ...
          <div className="border-l-2 border-amber-500/30 pl-4 sm:pl-6 space-y-4">
            <p className="text-white text-sm sm:text-base leading-relaxed">
              ...
              ground or any obstruction during or after a fall.
            </p>
            ...
            <div className="my-6 rounded-xl border border-white/10 bg-[#111] p-5 sm:p-6">
              ...
              <div className="max-w-md mx-auto space-y-3">
                ...
                <div className="flex items-center justify-between pt-1">
                  <span className="text-white font-semibold text-sm">TOTAL CLEARANCE REQUIRED</span>
