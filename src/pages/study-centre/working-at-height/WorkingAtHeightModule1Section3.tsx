...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 2,
    explanation:
      'The first step is to identify the hazards — walk the site, examine the task, and identify anything that could cause harm. For work at height, this means identifying fall hazards, fragile surfaces, overhead services, unprotected edges, and anything that could contribute to a fall.',
  },
  {
    id: 'wah-dynamic-ra',
    ...
    correctIndex: 1,
    explanation:
      'A dynamic risk assessment is an ongoing, real-time process of assessing changing conditions as they arise. If the weather changes, an unexpected hazard is discovered, or conditions on site are different from what was planned, workers must reassess the risks and adapt their controls accordingly. It supplements — but does not replace — the formal written risk assessment.',
  },
  {
    ...
    correctIndex: 2,
    explanation:
      "As a general guideline, most work at height should be stopped when sustained wind speeds exceed approximately 23 mph (Force 5 on the Beaufort scale — a fresh/strong breeze). However, some equipment manufacturers specify lower wind speed limits (e.g. many MEWPs must not be used above 28 mph / 12.5 m/s). Always check the manufacturer's operating instructions and apply the lowest applicable limit.",
  },
];
...
const quizQuestions = [
  {
    ...
    correctAnswer: 2,
    explanation:
      'The HSE recommends a five-step risk assessment process: (1) Identify the hazards, (2) Decide who might be harmed and how, (3) Evaluate the risks and decide on precautions, (4) Record your significant findings, (5) Review your assessment and update if necessary.',
  },
  {
    id: 2,
    question:
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      "A 'suitable and sufficient' risk assessment is one that identifies the significant risks and the steps needed to manage them. It does not need to cover every trivial risk or be excessively detailed, but it must be thorough enough to address the real hazards and ensure that effective controls are in place.",
  },
  {
    id: 4,
  ...
  },
  {
    id: 6,
    question:
      'When recording the findings of a risk assessment, which of the following must be included?',
    options: [
...
export default function WorkingAtHeightModule1Section3() {
  useSEO({
    ...
    description:
      'The five-step risk assessment process, site-specific and task-specific factors, dynamic risk assessment, weather considerations, and recording findings for work at height.',
  });
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-amber-500/5 border-l-2 border-amber-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Required by:</strong> Management Regs 1999 &amp; WAH Regs 2005
              </li>
              <li>
                <strong>Process:</strong> 5 steps &mdash; identify, assess, evaluate, record, review
              </li>
              <li>
                <strong>Must cover:</strong> Site-specific and task-specific factors
              </li>
              <li>
                <strong>Dynamic RA:</strong> Ongoing reassessment when conditions change
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-amber-500/5 border-l-2 border-amber-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Weather:</strong> Wind, rain, ice, lightning, visibility
              </li>
              <li>
                <strong>Ground:</strong> Soft, uneven, sloping, contaminated
              </li>
              <li>
                <strong>Overhead:</strong> Power lines, pipes, structural elements
              </li>
              <li>
                <strong>People:</strong> Competence, experience, supervision needed
              </li>
            </ul>
          </div>
        </div>
            ...
            <div className="max-w-sm mx-auto space-y-2">
              ...
              <div className="bg-amber-500/15 border-2 border-amber-500/40 rounded-xl p-4">
                <div className="flex items-center gap-3">
                  <div className="flex items-center justify-center w-8 h-8 rounded-full bg-amber-500/30 text-amber-400 font-bold text-sm flex-shrink-0">
                    1
                  </div>
                  <div>
              ...
              <div className="bg-blue-500/15 border-2 border-blue-500/40 rounded-xl p-4">
                <div className="flex items-center gap-3">
                  <div className="flex items-center justify-center w-8 h-8 rounded-full bg-blue-500/30 text-blue-400 font-bold text-sm flex-shrink-0">
                    2
                  </div>
                  <div>
              ...
              <div className="bg-purple-500/15 border-2 border-purple-500/40 rounded-xl p-4">
                <div className="flex items-center gap-3">
                  <div className="flex items-center justify-center w-8 h-8 rounded-full bg-purple-500/30 text-purple-400 font-bold text-sm flex-shrink-0">
                    3
                  </div>
                  <div>
              ...
              <div className="bg-green-500/15 border-2 border-green-500/40 rounded-xl p-4">
                <div className="flex items-center gap-3">
                  <div className="flex items-center justify-center w-8 h-8 rounded-full bg-green-500/30 text-green-400 font-bold text-sm flex-shrink-0">
                    4
                  </div>
                  <div>
              ...
              <div className="bg-red-500/15 border-2 border-red-500/40 rounded-xl p-4">
                <div className="flex items-center gap-3">
                  <div className="flex items-center justify-center w-8 h-8 rounded-full bg-red-500/30 text-red-400 font-bold text-sm flex-shrink-0">
                    5
                  </div>
                  <div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-amber-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <p>
                To identify hazards effectively, you need to{' '}
                <strong>physically visit the work area</strong> (or carry out a thorough desk-top
                assessment using plans, photographs, and existing surveys where a site visit is not
                yet possible). Walk the route to and from the work position, examine the working
                area itself, look above, below, and around the work area, and speak to people who
                know the site.
              </p>
                  ...
                  <div>
                    ...
                    <ul className="space-y-1.5">
                      ...
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                        <span>
                          Fragile surfaces (roof lights, fibre cement, suspended ceilings)
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                        <span>
                          Unstable access equipment (damaged ladders, poorly erected scaffolds)
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                        <span>
                          Slippery surfaces (wet, oily, or contaminated floors and roof surfaces)
                        </span>
                      </li>
                    </ul>
                  </div>
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  height? Is the access route itself at height (e.g. external ladders, scaffold
                  stairways, temporary access hatches)? Every part of the journey &mdash; from
                  ground level to the work position and back &mdash; must be assessed.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">The worker at height</strong> &mdash; the
                      electrician or operative carrying out the task (fall risk, struck by falling
                      object)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Other workers on site</strong> &mdash; other
                      trades working below, on adjacent scaffolds, or in the same area (struck by
                      falling tools, materials, or persons)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Apprentices and trainees</strong> &mdash; may
                      be less experienced, require additional supervision, and may not yet be
                      competent to assess risks independently
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Members of the public</strong> &mdash;
                      pedestrians, building occupants, visitors, or residents who may pass below or
                      near the work area
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Vulnerable groups</strong> &mdash; workers with
                      health conditions that may be affected by working at height (vertigo, balance
              ...
              <p>
                ...
                precautions needed. For each hazard, ask:{' '}
                <em>Is the existing control adequate, or do I need to do more?</em> Apply the
                hierarchy of control from the Work at Height Regulations:{' '}
                <strong>avoid &rarr; prevent &rarr; mitigate</strong>.
              </p>
                ...
                <div className="overflow-x-auto">
                  <div className="min-w-[300px]">
                    <div className="grid grid-cols-4 gap-1 text-center text-xs">
                      ...
                      <div className="p-2 bg-red-500/20 border border-red-500/30 rounded text-red-400 font-medium">
                        HIGH
                      </div>
                      ...
                      <div className="p-2 bg-red-500/20 border border-red-500/30 rounded text-red-400 font-bold">
                        CRITICAL
                      </div>
                    </div>
                  </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Ground conditions</strong> &mdash; is the
                      ground firm, level, and stable enough to support access equipment? Soft
                      ground, slopes, uneven surfaces, and waterlogged areas can destabilise
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Weather and exposure</strong> &mdash; is the
                      work area exposed to wind, rain, ice, or direct sunlight? What are the
                      forecast conditions for the duration of the task? At what point will work be
                      stopped?
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Overhead services</strong> &mdash; are there
                      overhead power lines, pipes, or structural elements that could be struck by
                      access equipment or that pose an electrocution hazard?
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Fragile surfaces</strong> &mdash; does the work
                      area include or adjoin any fragile surfaces (roof lights, fibre cement,
                      asbestos cement, liner panels, suspended ceilings)?
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Public access</strong> &mdash; can members of
                      the public walk below or near the work area? Is the work near a road,
                      footpath, school, hospital, or shop entrance?
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Other site activities</strong> &mdash; is there
                      other construction work happening in the area? Are cranes, vehicles, or heavy
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Lighting</strong> &mdash; is the work area
                      adequately lit? Will the task extend into dusk or darkness? Is temporary
                      lighting needed?
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Duration</strong> &mdash; how long will the
                      worker be at height? A 2-minute lamp change has very different requirements
                      from a full day installing cable tray. Longer tasks require more stable,
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Complexity</strong> &mdash; does the task
                      require both hands free? Does it involve heavy or bulky materials? Is
                      precision work required (e.g. terminating cables)?
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Equipment needed</strong> &mdash; what type of
                      access equipment is appropriate? Ladder, tower scaffold, podium step, MEWP, or
                      full scaffold? The choice depends on all the other factors.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Competence required</strong> &mdash; is the
                      worker trained and experienced in the equipment being used? Do they hold
                      PASMA, IPAF, or scaffold inspection qualifications where required?
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Tools and materials</strong> &mdash; what tools
                      and materials need to be taken to height? How will they be transported safely?
                      Are tool lanyards or material hoists needed?
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Emergency and rescue</strong> &mdash; if a
                      worker falls or is suspended in a harness, how will they be rescued? What is
                      the plan for medical emergencies at height?
                    </span>
                  </li>
                </ul>
              </div>
            ...
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1.5">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                      Weather conditions deteriorate (wind picks up, rain starts, temperature drops)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                      An unexpected hazard is discovered (fragile surface, overhead cable,
                      contamination)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                      Site conditions are different from what was planned (ground is softer, access
                      route is blocked)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                      Equipment develops a defect or becomes unsuitable for the conditions
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                      Other work activities nearby create new risks (crane movements, concrete
                      pours, excavation)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                      A worker feels unwell, fatigued, or otherwise unable to work safely at height
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                <p className="text-sm font-medium text-amber-500 mb-3">
                  The STAR Process for Dynamic Risk Assessment
                </p>
                <div className="grid sm:grid-cols-2 gap-3 text-sm">
              ...
              <p>
                ...
                assessment. If you arrive at a work area and the conditions are not as described in
                the risk assessment, or if conditions change during the work, you must stop and
                reassess.{' '}
                <strong>Never continue working at height if you believe it is unsafe</strong>, even
                if it means delaying the job or asking for additional resources.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-green-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                <strong>Step 4</strong> of the risk assessment process requires you to record your
                significant findings. Under the Management of Health and Safety at Work Regulations
                1999, employers with <strong>5 or more employees</strong> must record the
                significant findings of their risk assessments in writing.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">The significant hazards identified</strong>{' '}
                      &mdash; each hazard relating to the work at height task
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Who is at risk</strong> &mdash; the groups of
                      people who could be harmed (workers, public, other trades)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Existing control measures</strong> &mdash; what
                      is already in place to manage the risks
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Additional controls needed</strong> &mdash; any
                      further measures required to reduce risk to an acceptable level
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Who is responsible</strong> &mdash; the named
                      person responsible for implementing each control measure
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Completion date</strong> &mdash; when
                      additional controls will be in place
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Review date</strong> &mdash; when the
                      assessment will next be reviewed
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <p>
                ...
                affected by the risks. This includes all workers who will carry out the task, their
                supervisors, and anyone else who may be in the work area. Communication can take
                many forms: toolbox talks, method statement briefings, site inductions, or
                one-to-one briefings. The key point is that every worker must understand the risks
                they face and the controls that are in place.
              </p>
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  the step-by-step procedure for carrying out the work safely, including the
                  sequence of operations, the equipment to be used, the competences required, and
                  the emergency procedures. Together, the risk assessment and method statement are
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <ul className="text-sm text-white/80 space-y-2">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong className="text-white">Five steps:</strong> Identify hazards &rarr;
                    decide who is at risk &rarr; evaluate and control &rarr; record findings &rarr;
                    review and update
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Site factors:</strong> Ground conditions,
                    weather, overhead services, fragile surfaces, public access, other site
                    activities, lighting
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Task factors:</strong> Duration, complexity,
                    equipment needed, competence, tools and materials, emergency/rescue plan
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Dynamic RA:</strong> Continuous reassessment when
                    conditions change &mdash; STAR: Stop, Think, Act, Review
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Weather:</strong> Wind above 23 mph, rain, ice,
                    and lightning all require work at height to be stopped or suspended
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Recording:</strong> Must document hazards, people
                    at risk, controls, responsibilities, and review dates. Communicate to all
                    affected workers.
                  </span>
                </li>
              </ul>
