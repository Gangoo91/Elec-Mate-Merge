...
const faqs = [
  {
    question: 'Who is responsible for planning work at height — the employer or the worker?',
    answer:
  ...
  {
    question: 'Can a competent person be someone without formal qualifications?',
    answer:
  ...
  {
    question: 'How detailed does a rescue plan need to be for simple ladder work?',
    answer:
  ...
  {
    question: 'What should happen if weather conditions deteriorate during work at height?',
    answer:
...
const quizQuestions = [
  ...
  {
    id: 7,
    question: 'Why is the level of supervision proportional to the level of risk?',
    options: [
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-amber-500/5 border-l-2 border-amber-500/50">
            <p className="text-amber-400 text-base font-medium mb-2">In 30 Seconds</p>
            <ul className="text-base text-white space-y-1.5">
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                <span>
                  <strong>Legal duty:</strong> planning WAH is a requirement under Reg 4
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                <span>
                  <strong>Competent person:</strong> trained, experienced, knowledgeable
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
          ...
          <div className="p-4 rounded-lg bg-amber-500/5 border-l-2 border-amber-500/50">
            <p className="text-amber-400/90 text-base font-medium mb-2">On Site</p>
            <ul className="text-base text-white space-y-1.5">
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                <span>
                  <strong>Before:</strong> check weather, verify equipment, brief team
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                <span>
                  <strong>During:</strong> supervise proportionally, monitor conditions
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-amber-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Under <strong>Regulation 4 of the Work at Height Regulations 2005</strong>, every
                employer must ensure that work at height is <strong>properly planned</strong>,{' '}
                <strong>appropriately supervised</strong>, and carried out in a manner that is, so
                far as is reasonably practicable, safe. This is not guidance &mdash; it is a legal
                duty enforced by the Health and Safety Executive.
              </p>

              <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                <p className="text-sm text-white leading-relaxed">
                  <strong className="text-amber-400">Key Point:</strong> Planning is not optional.
                  Every single instance of work at height &mdash; from using a stepladder to change
                  a light fitting to erecting a scaffold on a high-rise construction site &mdash;
                  must be planned. The depth and detail of the plan must be proportionate to the
                  risk.
                </p>
              </div>

              <p>
                The regulations apply to all work at height where there is a risk of a fall liable
                to cause personal injury. This includes work above ground level, work at ground
                level adjacent to an excavation or opening, and work where a person could fall from
                an edge, through a fragile surface, or through an opening. It applies in all
                industries, not just construction.
              </p>

              <p>
                A proper plan for work at height must address the following elements as a minimum:
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      The <strong>nature of the work</strong> — what is being done, where, for how
                      long, and by whom
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      The <strong>hazards identified</strong> — what could go wrong and what could
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      The <strong>control measures</strong> — what equipment, barriers, procedures,
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      The <strong>equipment selected</strong> — and why it is the most suitable for
                      the task
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      The <strong>emergency arrangements</strong> — how a person will be rescued if
                      they fall
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      The <strong>weather conditions</strong> — current and forecasted, with trigger
                      points for stopping work
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <p>
                Failing to plan work at height is one of the most commonly cited regulatory breaches
                following falls from height. In HSE enforcement actions, the absence of a plan is
                treated as a fundamental failing of the duty holder, not a minor oversight.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                <strong>competent person</strong>. It also requires that the work is supervised by a
                competent person and that the people carrying out the work are competent (or are
                being supervised by someone who is). The regulations do not define competence by a
                specific qualification &mdash; instead, they define it by four attributes.
              </p>
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                ...
                <div className="space-y-3 text-sm text-white">
                  <p>
                    ...
                    This could be formal training (such as PASMA, IPAF, or harness training) or
                    structured on-the-job training. The training must be current and regularly
                    refreshed.
                  </p>
                  <p>
                    <strong className="text-white">2. Practical Experience:</strong> The person has
                    hands-on experience of the type of work being planned. A newly qualified person
                    may have the training but lack the experience to deal with unexpected
                    situations. Experience builds the judgement needed to plan for real-world
                    conditions.
                  </p>
                  <p>
                    <strong className="text-white">3. Relevant Knowledge:</strong> The person
                    understands the regulations, the equipment, the hazards, and the control
                    measures applicable to the work. This includes knowledge of the specific site
                    conditions and the limitations of the equipment being used.
                  </p>
                  <p>
                    <strong className="text-white">
                      4. Ability to Recognise Hazards and Limitations:
                    </strong>{' '}
                    Perhaps the most critical attribute. The person must be able to identify hazards
                    that are not immediately obvious, recognise when a situation is outside their
                    competence, and know when to seek specialist advice. A truly competent person
                    knows what they <em>do not</em> know.
                  </p>
                </div>
              </div>

              <p>
                A competent person for planning work at height is not necessarily the most senior
                person on site. They are the person best qualified by training and experience to
                understand the specific hazards and to select the appropriate controls. For example,
                a scaffold supervisor may be competent to plan scaffold work but not competent to
                plan rope access operations.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>Select the most appropriate access equipment for the task</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>Prepare or approve the method statement and rescue plan</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>Brief the workforce on the plan, hazards, and emergency procedures</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>Monitor conditions and stop work if circumstances change</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>Ensure equipment is inspected and maintained in safe condition</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white leading-relaxed">
                  ...
                  that does not meet current standards must be challenged and changed.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-teal-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Regulation 4(3) of the WAH Regs 2005 requires that work at height does not take
                place when <strong>weather conditions could jeopardise the health or safety</strong>{' '}
                of the workers. This is not a vague suggestion &mdash; it is a specific legal
                requirement. The competent person must assess weather conditions before work begins
                and monitor them continuously throughout the working day.
              </p>
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                ...
                <div className="space-y-3 text-sm text-white">
                  <div className="p-3 bg-white/5 rounded-lg">
                    ...
                    <p>
                      Stop most scaffold and ladder work. At this speed, small trees sway, handling
                      materials becomes dangerous, and worker stability is compromised. Large
                      sheeting and panel work should stop even earlier at Force 4 (13&ndash;18 mph).
                    </p>
                  </div>
                  <div className="p-3 bg-white/5 rounded-lg">
                    <p className="font-medium text-white mb-1">Ice &amp; Frost</p>
                    <p>
                      Do not use ladders, scaffold, or any working platform until surfaces have been
                      de-iced and inspected. Ice on rungs, boards, or platform surfaces creates an
                      extreme slip hazard. Early morning starts in winter are particularly dangerous
                      &mdash; surfaces that appear dry may have a thin layer of black ice.
                    </p>
                  </div>
                  <div className="p-3 bg-white/5 rounded-lg">
                    <p className="font-medium text-white mb-1">Lightning</p>
                    <p>
                      Stop <strong>all</strong> outdoor work at height during thunderstorms. Workers
                      on scaffold, MEWP platforms, ladders, and any elevated metallic structure are
                      at extreme risk of lightning strike. Apply the 30/30 rule: if the time between
                      seeing lightning and hearing thunder is less than 30 seconds, stop all work
                      and take shelter. Wait at least 30 minutes after the last observed flash
                      before resuming work.
                    </p>
                  </div>
                  <div className="p-3 bg-white/5 rounded-lg">
                    <p className="font-medium text-white mb-1">Heavy Rain</p>
                    <p>
                      Assess grip and visibility. Heavy rain reduces grip on ladders, scaffold
                      boards, and hand tools. It impairs visibility through safety glasses and face
                      shields. Water pooling on platforms creates a slip hazard. Persistent rain
                      soaks into clothing, causing cold stress and fatigue. Electrical work at
                      height in rain creates additional electrocution risks.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <p>
                The competent person should check the weather forecast at the start of each working
                day and have pre-agreed trigger points for stopping work. An anemometer (wind speed
                meter) should be available on site for any work where wind is a critical factor.
                Many MEWP operators carry a handheld anemometer as standard practice.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong>Force 4:</strong> Dust and loose paper raised; small branches moving
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong>Force 5:</strong> Small trees in leaf begin to sway; crested wavelets
                      on inland waters
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong>Force 6:</strong> Large branches moving; difficulty using an umbrella;
                      whistling in overhead wires
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong>Force 7:</strong> Whole trees in motion; difficulty walking against
                      the wind
                    </span>
                  </li>
                </ul>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The expected duration of the task is a critical factor in selecting the correct
                access equipment. HSE guidance is clear that{' '}
                <strong>
                  a ladder should only be used as a working platform for tasks lasting up to 30
                  minutes
                </strong>{' '}
                in one position. This is not an arbitrary limit &mdash; it reflects the physical
                demands of maintaining balance and grip on a ladder for extended periods.
              </p>
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white">
                  <p>
                    ...
                    still be planned and risk assessed.
                  </p>
                  <p>
                    <strong className="text-white">Up to 30 minutes:</strong> A leaning ladder may
                    be suitable if the task is light and does not require both hands. A podium step
                    is preferable as it provides a platform to stand on.
                  </p>
                  <p>
                    <strong className="text-white">30 minutes to 2 hours:</strong> Scaffold, MEWP,
                    or podium steps with guardrails should be used. Ladders are not suitable as
                    working platforms for this duration.
                  </p>
                  <p>
                    <strong className="text-white">Over 2 hours:</strong> Full scaffold or MEWP is
                    required. The platform must provide adequate space for tools, materials, and
                    comfortable working posture. Welfare facilities (particularly access to drinking
                    water and toilet facilities) become a consideration for extended work at height.
                  </p>
                </div>
              </div>

              <p>
                When assessing duration, the competent person must consider the realistic time for
                the task &mdash; not the optimistic estimate. Tasks routinely overrun due to
                unforeseen problems, material shortages, or changes in scope. If there is any doubt,
                select the more robust equipment option. Using a scaffold for a task that
                &ldquo;might only take 20 minutes&rdquo; is far safer than using a ladder for a task
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>Waiting for materials, tools, or additional personnel</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>Poor weather causing delays and repeated start/stop cycles</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>Changes to the scope of work once the task area is accessed</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>Fatigue &mdash; the same task takes longer when the worker is tired</span>
                  </li>
                </ul>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                <strong>Regulation 4(1) of the WAH Regs 2005</strong> requires that the plan for
                work at height includes <strong>emergency procedures, including rescue</strong>.
                This is not an afterthought &mdash; the rescue plan is part of the planning process
                and must be in place before any person goes to height.
              </p>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white leading-relaxed">
                  ...
                  There is no time to create a plan after the event. The plan, the equipment, and
                  the trained personnel must all be in place beforehand.
                </p>
              </div>

              <p>
                The rescue plan must be proportionate to the risk. For simple, low-level work, the
                plan may involve ensuring a colleague is nearby who can assist and that the
                emergency services can access the location. For complex or high-level work, the plan
                may require dedicated rescue equipment on site, specifically trained rescue
                personnel, and a rehearsed rescue procedure.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong>Type of rescue:</strong> self-rescue, assisted rescue, or emergency
                      services
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong>Rescue equipment:</strong> what is available and where it is located
                      on site
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong>Trained personnel:</strong> who on site is trained in rescue
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong>Communication:</strong> how the alarm is raised and who is contacted
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong>Access for emergency services:</strong> route, gate codes, escort
                      arrangements
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong>First aid:</strong> first aider location, first aid kit location,
              ...
              <p>
                The rescue plan must be communicated to every person involved in the work at height.
                Every worker must know what to do if they or a colleague falls. They must know where
                the rescue equipment is, how to raise the alarm, and who to contact. A plan that
                exists only on paper in the site office is not an effective plan.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                <strong>appropriately supervised</strong>. The word &ldquo;appropriately&rdquo; is
                deliberate &mdash; the level of supervision must be proportional to the level of
                risk. Low-risk tasks carried out by experienced, competent workers may require only
                periodic checks. High-risk tasks, inexperienced workers, or complex operations
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white">
                  <p>
                    ...
                    immediately. Required for trainee workers, high-risk tasks (leading edge work,
                    fragile surfaces), and first-time operations.
                  </p>
                  <p>
                    <strong className="text-white">Periodic supervision:</strong> The supervisor
                    visits regularly (e.g. every 30&ndash;60 minutes), checks that the plan is being
                    followed, and is available to provide guidance. Suitable for competent workers
                    on routine, lower-risk tasks.
                  </p>
                  <p>
                    <strong className="text-white">Remote oversight:</strong> The competent person
                    is available by phone or radio but is not physically present. Only appropriate
                    for highly experienced workers doing very low-risk, routine tasks. The worker
                    must know how to contact the supervisor and must stop work if conditions change.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white leading-relaxed">
                  ...
                  do&rdquo; is not a defence if supervision was inadequate for the level of risk.
                </p>
              </div>

              <p>
                The supervisor must have the authority to stop work. A supervisor who identifies an
                unsafe practice but lacks the authority to halt operations is not an effective
                supervisor. The supervisor must also be competent for the type of work being
                overseen &mdash; a general site supervisor may not be competent to supervise
                specialist rope access operations.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-green-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The planning process must include the selection of the most suitable equipment for
                the task and verification that the equipment is in safe, working condition. Under
                the hierarchy established by Schedule 1 of the WAH Regs, the first consideration is
                always whether work at height can be avoided entirely. If it cannot, the regulations
                require the use of collective protection (guard rails, barriers) before personal
                protection (harnesses, fall arrest).
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong>Height of the working position</strong> &mdash; ladders are limited in
                      height, scaffolds and MEWPs offer greater reach
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong>Duration of the task</strong> &mdash; as covered in Section 04 above
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong>Nature of the work</strong> &mdash; does it require both hands, heavy
                      tools, or materials at height?
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong>Ground conditions</strong> &mdash; is the ground level, firm, and
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong>Access restrictions</strong> &mdash; can the equipment be delivered
                      and positioned at the work location?
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong>Environmental hazards</strong> &mdash; overhead power lines, adjacent
                      traffic, public proximity
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <p>
                ...
                <strong>Regulation 12</strong> requires that all equipment used for work at height
                is inspected at the place it is to be used, before being put into use on each
                occasion. The inspection must verify that the equipment is the correct type, that it
                is in good condition with no visible defects, and that it has been maintained and
                tested within the required period.
              </p>

              <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                <p className="text-sm text-white leading-relaxed">
                  <strong className="text-amber-400">Key Point:</strong> A visual inspection before
                  each use is the absolute minimum. Scaffolds require a formal inspection recorded
                  in a register every 7 days and after any event that could affect stability. MEWPs
                  require pre-use checks and periodic thorough examinations (every 6 months for
                  hired equipment, 12 months for owned equipment under LOLER). Ladders must be
                  inspected before each use for defects to stiles, rungs, feet, and locking
                  mechanisms.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-amber-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                A plan that is not communicated to the workforce is not an effective plan. The
                competent person must ensure that every person involved in the work at height has
                been briefed on the plan, the hazards, the control measures, and the emergency
                procedures before work begins. This is typically done through a combination of site
                inductions, method statement briefings, and toolbox talks.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong>What</strong> work is being done and <strong>where</strong> on site
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong>Hazards</strong> identified and the <strong>controls</strong> in place
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong>Stop authority</strong> &mdash; every worker has the right to stop if
                      they feel unsafe
                    </span>
                  </li>
                </ul>
              ...
              <p>
                The briefing should be documented. At a minimum, record the date, time, topic,
                content covered, and the names of all attendees. Attendance records serve as
                evidence that workers were informed of the plan and the hazards. If an incident
                occurs, the briefing record will be one of the first documents the HSE asks to see.
              </p>

              <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                <p className="text-sm text-white leading-relaxed">
                  <strong className="text-amber-400">Key Point:</strong> A toolbox talk is not a
                  one-way lecture. Workers must be encouraged to ask questions, raise concerns, and
                  share their own observations about the conditions. A briefing where nobody speaks
                  up may indicate that workers do not feel safe to raise concerns &mdash; this is
                  itself a safety culture issue that must be addressed.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-amber-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The following checklist summarises the key areas that must be addressed when
                planning any work at height. Use this as a cross-check before work begins to ensure
