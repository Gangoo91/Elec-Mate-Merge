...
const faqs = [
  ...
  {
    question: 'How quickly must rescue begin after a fall where the person is left suspended?',
    answer:
  ...
  {
    question: 'What is the W-position and why is it used for suspension trauma casualties?',
    answer:
  ...
  {
    question: 'Does every site need a written emergency action plan for work at height?',
    answer:
...
const quizQuestions = [
  ...
  {
    id: 4,
    question: 'What is the correct post-rescue position for a suspension trauma casualty?',
    options: [
  ...
  {
    id: 8,
    question: 'What equipment for rescue must be available on site before work at height begins?',
    options: [
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="bg-amber-500/10 border border-amber-500/30 rounded-xl p-5 mb-6">
          ...
          <p className="text-white/80 text-base leading-relaxed">
            ...
            flat; use the W-position (knees raised) for at least 30 minutes to prevent rescue death.
            Every site must have a written emergency action plan, practised rescue procedures, and
            trained rescuers before work at height begins.
          </p>
        </div>
        ...
        <div className="bg-red-500/10 border border-red-500/30 rounded-xl p-5 mb-8">
          ...
          <p className="text-white/80 text-base leading-relaxed">
            ...
            heart. Knowing the correct post-rescue position is as important as the rescue itself.
          </p>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-amber-500/40 pl-4 sm:pl-6 space-y-4">
            ...
            <p className="text-white/80 text-sm leading-relaxed">
              ...
              person is suspended motionless in a harness, this pump stops working. Gravity causes
              blood to accumulate in the lower extremities, and the harness leg straps can further
              restrict venous return by compressing the femoral veins.
            </p>
            <div className="bg-amber-500/10 border border-amber-500/30 rounded-lg p-4">
              ...
              <ul className="space-y-2 text-sm text-white/70">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong className="text-white">Blood pools in the legs</strong> — up to 600ml of
                    blood can accumulate in the lower extremities within minutes
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Reduced venous return</strong> — less blood
                    reaches the heart, reducing cardiac output
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Blood pressure drops</strong> — the brain and
                    vital organs receive less oxygenated blood
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Heart rate increases</strong> — the body attempts
                    to compensate but cannot sustain this
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Unconsciousness</strong> — reduced blood flow to
                ...
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Renal failure and death</strong> — without
                    rescue, the progressive circulatory collapse is fatal
                  </span>
                </li>
              </ul>
            </div>
                ...
                <div className="bg-amber-500/10 border border-amber-500/30 rounded-lg p-4">
                  ...
                  <ul className="space-y-1.5 text-sm text-white/70">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>
                        Discomfort from harness straps — particularly in the groin and thighs
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>
                        If conscious, the casualty should pump their legs to activate the muscle
                        pump
                      </span>
                    </li>
                  </ul>
                  ...
                  <ul className="space-y-1.5 text-sm text-white/70">
                    ...
                    <li className="flex items-start gap-2">
                      ...
                      <span className="font-semibold text-red-300">
                        Death is imminent without rescue
                      </span>
                    </li>
                  </ul>
                </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-orange-500/40 pl-4 sm:pl-6 space-y-4">
            <p className="text-white/80 text-sm leading-relaxed">
              ...
              . Average ambulance response times in the UK are 7-15 minutes for life-threatening
              calls. For suspension trauma, this delay can be the difference between life and death.
            </p>
            <div className="bg-orange-500/10 border border-orange-500/30 rounded-lg p-4">
              <h4 className="font-semibold text-white text-sm mb-2">
              ...
              <ul className="space-y-2 text-sm text-white/70">
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    Suspension trauma progresses rapidly — symptoms can become life-threatening
                    within 15 minutes
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    Emergency services may not have the specialist equipment to access the casualty
                    at height (rope access, MEWP)
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    The fire brigade has the highest capability for rescue at height, but their
                    response time is typically 10-20 minutes
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    A conscious casualty may become unconscious during the wait, making rescue
            ...
            <div className="bg-white/5 border border-white/10 rounded-lg p-4">
              ...
              <ul className="space-y-2 text-sm text-white/70">
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Trained rescuers</strong> — at least one person
                    on site who has been trained in the specific rescue method for the equipment in
                    use
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Rescue equipment</strong> — rescue kits (lowering
                    devices, rescue harnesses, cutting tools if needed) readily accessible, not
                    locked in a van
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Practised rescue plan</strong> — the plan must
                    have been walked through or drilled, not just written on paper
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Communication</strong> — reliable means to raise
                    the alarm and call 999 from the work location (mobile signal, radios)
                  </span>
                </li>
              </ul>
            </div>
            <p className="text-white/70 text-sm leading-relaxed">
              ...
              assessment that identifies the need for harness use but does not include a rescue plan
                ...
                <div className="bg-black/20 rounded-lg p-4">
                  ...
                  <ul className="space-y-1.5 text-sm text-white/70">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>
                        Is the airway clear? Look for obstructions (blood, vomit, broken teeth,
                        foreign objects)
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>
                        If spinal injury is NOT suspected, use the head-tilt chin-lift to open the
                        airway
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>
                        If spinal injury IS suspected, use the jaw-thrust manoeuvre without tilting
                        the head
                      </span>
                    </li>
                  </ul>
                ...
                <div className="bg-black/20 rounded-lg p-4">
                  ...
                  <ul className="space-y-1.5 text-sm text-white/70">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>
                        Look for chest movement, listen for breath sounds, feel for air on your
                        cheek
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>
                        Note the rate and quality of breathing — rapid shallow breaths indicate
                        shock
                      </span>
                    </li>
                  </ul>
                ...
                <div className="bg-black/20 rounded-lg p-4">
                  ...
                  <ul className="space-y-1.5 text-sm text-white/70">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>
                        Check for severe bleeding — apply direct pressure with a clean dressing
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>
                        Check skin colour and temperature — pale, cold, clammy skin indicates shock
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>
                        If no pulse is detected and not breathing, begin CPR and use AED if
                        available
                      </span>
                    </li>
                  </ul>
            ...
            <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-4">
              ...
              <ul className="space-y-2 text-sm text-white/70">
                ...
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    Manually stabilise the head and neck in the position found — do not attempt to
                    straighten or align
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    Tell the casualty to stay still — reassure them that help is on the way
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    Keep the casualty warm with blankets or coats, placed over them without moving
                    them
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    Wait for paramedics with spinal immobilisation equipment (scoop stretcher,
            ...
            <div className="bg-white/5 border border-white/10 rounded-lg p-4">
              ...
              <ul className="space-y-2 text-sm text-white/70">
                ...
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    Lay the casualty down and raise their legs (if no spinal injury suspected)
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-red-500/40 pl-4 sm:pl-6 space-y-4">
            <p className="text-white/80 text-sm leading-relaxed">
              ...
              This applies even if they appear to have recovered, are talking, or insist they feel
              fine.
            </p>
            <div className="bg-red-500/10 border border-red-500/30 rounded-xl p-5">
              ...
              <ul className="space-y-2 text-sm text-white/70">
                ...
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    The high levels of potassium in the returning blood (hyperkalaemia), which can
                ...
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    The acidic pH of the deoxygenated blood, which further disrupts cardiac rhythm
                  </span>
                </li>
              </ul>
              <p className="text-red-300 text-sm font-semibold mt-3">
                The result can be fatal cardiac arrest — even in a casualty who appeared to be
                recovering. This is "rescue death."
              </p>
            </div>
            ...
            <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-5">
              ...
              <ul className="space-y-2 text-sm text-white/70">
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    Position the casualty seated with their back against a wall or supported, and
                ...
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    This slows the return of pooled blood, allowing the heart to gradually readjust
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    Maintain this position for at least 30 minutes, even if the casualty feels
                    better
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    Monitor continuously — check breathing, pulse, and level of consciousness
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    If the casualty loses consciousness and stops breathing, begin CPR — at this
                    point, laying flat is necessary for chest compressions
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-amber-500/10 border border-amber-500/30 rounded-lg p-4">
              ...
              <p className="text-white/70 text-sm leading-relaxed">
                ...
                (automated external defibrillator) should be used as soon as available.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="space-y-3">
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
                ...
                <p className="text-white/70 text-sm leading-relaxed pl-10">
                  ...
                  any subsequent HSE investigation.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="bg-purple-500/10 border border-purple-500/30 rounded-lg p-4">
              ...
              <ul className="space-y-2 text-sm text-white/70">
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">All workers at height</strong> — must know the
                    emergency plan, how to raise the alarm, and basic first-aid actions
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Designated rescuers</strong> — must be trained in
                    the specific rescue method for the equipment in use (e.g., harness rescue, MEWP
                    recovery)
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">First aiders</strong> — must hold a current
                    first-aid qualification and understand suspension trauma and the W-position
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Supervisors</strong> — must understand the plan,
                    ensure it is communicated, and verify that rescue equipment is available and
                    maintained
                  </span>
                </li>
              </ul>
            ...
            <div className="bg-white/5 border border-white/10 rounded-lg p-4">
              ...
              <ul className="space-y-2 text-sm text-white/70">
                ...
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    Training must cover suspension trauma awareness, including the W-position
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                ...
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    Refresher training should be provided at least annually or when equipment
                    changes
                  </span>
                </li>
              </ul>
        ...
        <section className="mb-10">
          ...
          <div className="bg-amber-500/10 border border-amber-500/30 rounded-xl p-5 space-y-3">
            <p className="text-white/80 text-sm leading-relaxed">
              ...
              1 metre. The electrician is thrown from the basket but the harness arrests the fall.
              He is now suspended 7 metres above ground, conscious but winded, and his legs are
              dangling with no foothold.
            </p>
            <div className="bg-black/20 rounded-lg p-4">
              ...
              <ul className="space-y-2 text-sm text-white/70">
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Immediate:</strong> Raise the alarm — shout,
                    radio, phone. Someone must call 999.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Talk to the casualty:</strong> Tell him to pump
                    his legs (flex and extend) to keep blood circulating. Reassure him rescue is
                    coming.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Activate rescue plan:</strong> Use the on-site
                    rescue equipment (second MEWP, rescue descent device, or ground-based lowering
                    system) to bring him to the ground. Do NOT wait for the fire brigade.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">On the ground:</strong> Place him in the
                    W-position. Do NOT lay him flat. Monitor ABC. Keep warm. Wait for paramedics.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Preserve the scene:</strong> The faulty MEWP must
                    not be moved or repaired until investigated. Take photographs. Get witness
                    statements.
                  </span>
                </li>
              </ul>
        ...
        {/*  Quiz                                                         */}
        {/* ------------------------------------------------------------ */}
        <Quiz title="Section 1 — Emergency Procedures & Rescue" questions={quizQuestions} />
