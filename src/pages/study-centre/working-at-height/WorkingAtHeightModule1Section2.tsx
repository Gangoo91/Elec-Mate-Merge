...
const quickCheckQuestions = [
  {
    ...
    question:
      'What is the correct order of the hierarchy of control required by the Work at Height Regulations 2005?',
    options: [
    ...
    correctIndex: 2,
    explanation:
      'The correct hierarchy is Avoid > Prevent > Mitigate. First, avoid working at height wherever reasonably practicable. If it cannot be avoided, prevent falls using collective protection measures. If falls cannot be entirely prevented, mitigate the distance and consequences of any fall.',
  },
  {
    id: 'wah-hasawa-duty',
    question:
      'Under the Health and Safety at Work Act 1974, what is the general duty of an employer?',
    options: [
    ...
    correctIndex: 1,
    explanation:
      'Section 2(1) of the Health and Safety at Work Act 1974 places a general duty on every employer to ensure, so far as is reasonably practicable, the health, safety, and welfare at work of all their employees. This is the overarching duty from which all other health and safety obligations flow.',
  },
  {
    id: 'wah-cdm-duty',
    question:
      'Under CDM 2015, which duty holder must ensure that designs avoid foreseeable risks where possible, including risks from working at height?',
    options: ['The client', 'The principal contractor', 'The principal designer', 'The designer'],
    correctIndex: 3,
    explanation:
      'Under CDM 2015, designers have a specific duty to avoid foreseeable risks in their designs, including risks from working at height. This means designing out the need for work at height wherever possible — for example, specifying pre-wired modular lighting systems that can be assembled at ground level.',
  },
];
...
const faqs = [
  {
    question:
      'What is the difference between the Work at Height Regulations 2005 and the Health and Safety at Work Act 1974?',
    answer:
      'The Health and Safety at Work Act 1974 is primary legislation — it sets out the overarching legal framework for all workplace health and safety in Great Britain. It establishes general duties on employers, employees, and the self-employed. The Work at Height Regulations 2005 are secondary legislation (regulations) made under the Act — they provide specific, detailed requirements for the particular hazard of working at height. The WAH Regulations sit within the framework established by the Act, and breaching either can result in prosecution.',
  },
  {
    question: 'Do the Work at Height Regulations apply to self-employed workers?',
    answer:
      'Yes. The Work at Height Regulations 2005 apply to all work at height where there is a risk of a fall liable to cause personal injury. This includes self-employed workers. A self-employed electrician working on their own must comply with the regulations just as an employed electrician must. The duties to plan, assess, avoid where possible, and use appropriate equipment apply equally to the self-employed.',
  },
  {
    question: 'What are Approved Codes of Practice (ACOPs) and are they legally binding?',
    answer:
      'Approved Codes of Practice are documents approved by the Health and Safety Executive under Section 16 of the Health and Safety at Work Act 1974. They give practical guidance on how to comply with the law. ACOPs are not directly legally binding in the same way as regulations, but they have a special legal status: if you are prosecuted for a breach of health and safety law and it is shown that you did not follow the relevant ACOP, a court will find you at fault unless you can demonstrate that you complied with the law in some other equally effective way.',
  },
  {
    question: 'What is LOLER 1998 and when does it apply to working at height?',
    answer:
      'LOLER (the Lifting Operations and Lifting Equipment Regulations 1998) applies whenever lifting equipment is used to lift people as well as loads. In the context of working at height, LOLER applies to mobile elevating work platforms (MEWPs), mast climbers, suspended access platforms, and other equipment used to raise or lower people. LOLER requires that such equipment is thoroughly examined by a competent person at specified intervals — every 6 months for equipment used to lift people, and every 12 months for other lifting equipment.',
  },
];
...
const quizQuestions = [
  {
    ...
    correctAnswer: 1,
    explanation:
      'The Work at Height Regulations 2005 (SI 2005/735) are secondary legislation — regulations made under the Health and Safety at Work Act 1974. They provide specific, detailed requirements for the hazard of working at height.',
  },
  {
    id: 2,
    question:
      'Which Act of Parliament provides the overarching legal framework for workplace health and safety in Great Britain?',
    options: [
    ...
    correctAnswer: 2,
    explanation:
      'The Health and Safety at Work Act 1974 (HASAWA) is the primary legislation that provides the overarching legal framework for all workplace health and safety in England, Wales, and Scotland. All other health and safety regulations are made under this Act.',
  },
  {
    id: 3,
  ...
  },
  {
    ...
    options: ['Safety harnesses', 'Scaffold boards', 'Ladders and stepladders', 'Safety nets'],
    correctAnswer: 2,
    explanation:
      'BS EN 131 is the British and European standard for ladders and stepladders. It covers design, construction, testing, and labelling requirements. Ladders used at work should comply with BS EN 131 and carry the appropriate markings.',
  },
  {
    id: 8,
    question:
      'Which of the following correctly describes the legislation hierarchy from highest to lowest authority?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'The correct hierarchy is: Acts of Parliament (primary legislation, e.g. HASAWA 1974) > Regulations (secondary legislation, e.g. WAH Regs 2005) > Approved Codes of Practice (ACOPs, which have special legal status) > HSE Guidance (which provides practical advice but is not legally binding in itself).',
  },
];
...
export default function WorkingAtHeightModule1Section2() {
  useSEO({
    ...
    description:
      'WAH Regulations 2005, HASAWA 1974, CDM 2015, LOLER 1998, PUWER 1998, BS EN standards, and the hierarchy of legislation for working at height in the UK.',
  });
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-amber-500/5 border-l-2 border-amber-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Primary law:</strong> Health and Safety at Work Act 1974
              </li>
              <li>
                <strong>Key regs:</strong> WAH Regs 2005, CDM 2015, LOLER 1998, PUWER 1998
              </li>
              <li>
                <strong>Risk assessment:</strong> Required by Management Regs 1999
              </li>
              <li>
          ...
          <div className="p-4 rounded-lg bg-amber-500/5 border-l-2 border-amber-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>BS EN 131:</strong> Ladders and stepladders
              </li>
              <li>
                <strong>BS EN 361:</strong> Full body harnesses
              </li>
              <li>
                <strong>BS EN 354/355:</strong> Lanyards and energy absorbers
              </li>
              <li>
                <strong>BS EN 795:</strong> Anchor devices
              </li>
            </ul>
          </div>
        </div>
            ...
            <div className="max-w-md mx-auto space-y-3">
              ...
              <div className="bg-blue-500/15 border-2 border-blue-500/40 rounded-xl p-4 text-center">
                <p className="text-xs font-bold text-blue-400 mb-1">
                  LEVEL 2 &mdash; SECONDARY LEGISLATION
                </p>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-amber-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The <strong>Health and Safety at Work etc. Act 1974</strong> (HASAWA or HSWA) is the
                primary piece of legislation governing workplace health and safety in England,
                Wales, and Scotland. It is an Act of Parliament &mdash; the highest form of UK law
                &mdash; and it provides the overarching framework within which all other health and
                safety regulations operate.
              </p>
              ...
              <p>
                ...
                that applies to{' '}
                <strong>
                  all work activities, all employers, all employees, and all workplaces
                </strong>
                . It operates on the principle that those who create workplace risks are best placed
                to manage them.
              </p>
                ...
                <div className="space-y-3 text-sm text-white">
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        ...
                        safety, and welfare at work of all their employees. This includes providing
                        safe systems of work, safe equipment, and adequate training for working at
                        height.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        Every employer must conduct their undertaking in such a way as to ensure, so
                        far as is reasonably practicable, that persons not in their employment are
                        not exposed to risks. This covers members of the public, visitors, and other
                        contractors on shared sites.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        Every employee has a duty to take reasonable care for their own health and
                        safety and that of others who may be affected by their acts or omissions.
                        They must also cooperate with their employer on health and safety matters.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        It is a criminal offence to fail to comply with the Act or any regulations
                        made under it. Penalties include unlimited fines and up to 2 years&rsquo;
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white leading-relaxed">
                  ...
                  needed to eliminate or reduce that risk. If the risk is significant and the cost
                  of prevention is reasonable, then the prevention measures must be taken. The
                  burden of proof falls on the employer to demonstrate that it was not reasonably
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The <strong>Work at Height Regulations 2005</strong> (SI 2005/735) are the principal
                regulations governing all work at height activities. They came into force on 6 April
                2005 and replaced a number of older regulations, including parts of the Construction
                (Health, Safety and Welfare) Regulations 1996.
              </p>

              <p>
                The regulations apply to <strong>all work at height</strong> where there is a risk
                of a fall liable to cause personal injury, regardless of the industry or the type of
                work being carried out. They apply equally to a roofer on a new build, an
                electrician on a stepladder, a window cleaner on an access platform, or a warehouse
                worker on a forklift truck.
              </p>
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                ...
                <div className="space-y-3 text-sm text-white">
                  <div>
                    ...
                    <p>
                      All work at height must be properly planned by a competent person,
                      appropriately supervised, and carried out in a manner that is, so far as is
                      reasonably practicable, safe. The plan must include weather considerations,
                      emergency and rescue procedures, and selection of appropriate work equipment.
                    </p>
                  </div>
                  <div>
                    <p className="text-white font-medium">Regulation 5 &mdash; Competence</p>
                    <p>
                      No person shall engage in any activity related to work at height (including
                      organisation, planning, and supervision) unless they are competent to do so,
                      or, if being trained, they are supervised by a competent person.
                    </p>
                  </div>
                  <div>
                    <p className="text-white font-medium">
                      Regulation 6 &mdash; Avoidance of Risks from Work at Height
                    </p>
                    <p>
                      The duty holder must: (a) avoid work at height where reasonably practicable;
                      (b) where work at height cannot be avoided, use work equipment or other
                      measures to prevent falls; (c) where the risk of a fall cannot be entirely
                      eliminated, use work equipment or other measures to minimise the distance and
                      consequences of any fall.
                    </p>
                  </div>
                  <div>
                    <p className="text-white font-medium">
                      Regulation 7 &mdash; Selection of Work Equipment
                    </p>
                    <p>
                      The duty holder must select work equipment for working at height that gives
                      collective protection priority over personal protection, and takes account of
                      the working conditions, the risks to safety, the distance and consequences of
                      any potential fall, the duration and frequency of use, and the need for easy
                      and timely evacuation in an emergency.
                    </p>
                  </div>
                  <div>
                    <p className="text-white font-medium">
                      Regulation 8 &mdash; Requirements for Particular Work Equipment
                    </p>
                    <p>
                      Schedules 1 to 6 of the regulations set detailed requirements for specific
                      types of work equipment: existing places of work and means of access (Schedule
                      1), guardrails and toe boards (Schedule 2), working platforms (Schedule 3),
                      ladders (Schedule 4), scaffolding (Schedule 5), and rope access (Schedule 6).
                    </p>
                  </div>
                  <div>
                    <p className="text-white font-medium">Regulation 9 &mdash; Fragile Surfaces</p>
                    <p>
                      No person shall pass across, near, or work on, from, or near a fragile surface
                      unless that is the only reasonably practicable way of carrying out the work,
                      and suitable and sufficient platforms, coverings, or other means of support
                      are provided. Warning notices must be displayed at approaches to fragile
                      surfaces.
                    </p>
                  </div>
                  <div>
                    ...
                    <p>
                      Suitable and sufficient steps must be taken to prevent any person being struck
                      by a falling object, including securing tools and materials, providing toe
                      boards, and establishing exclusion zones below work at height.
                    </p>
                  </div>
                  <div>
                    <p className="text-white font-medium">
                      Regulation 12 &mdash; Inspection of Work Equipment
                    </p>
                    <p>
                      Work equipment from which a person could fall 2 metres or more must be
                      inspected after assembly in any position, at suitable intervals, and after
                      exceptional circumstances (e.g. severe weather). Inspection results must be
                      recorded.
                    </p>
                  </div>
                </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The Work at Height Regulations 2005 do not operate in isolation. Several other sets
                of regulations interact with and support the WAH Regs, creating a comprehensive
                legal framework. Understanding these supporting regulations is essential for full
                compliance.
              </p>
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      risks to employees and others affected by their undertaking. For work at
                      height, this means a specific risk assessment for every task involving a risk
                      of falling.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      Employers must implement preventive and protective measures based on the
                      general principles of prevention set out in Schedule 1 (which mirrors the
                      hierarchy: avoid, combat risks at source, collective over individual, etc.).
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      ...
                      tasks to them. Employees must receive adequate health and safety training,
                      including specific training for work at height.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Thorough examination:</strong> Equipment used
                      to lift people must be thoroughly examined by a competent person at least
                      every <strong className="text-white">6 months</strong>
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Planning:</strong> Every lifting operation must
                      be properly planned, appropriately supervised, and carried out safely
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Reports:</strong> A current report of thorough
                      examination must be available before the equipment is used
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Suitability:</strong> Equipment must be
                      suitable for its intended purpose and the conditions in which it will be used
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Maintenance:</strong> Equipment must be
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Information and training:</strong> Users must
                      receive adequate information, instruction, and training in the safe use of the
                      equipment
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Inspection:</strong> Equipment must be
                      inspected at suitable intervals and after exceptional circumstances
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-green-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                In addition to the legislation and regulations, a range of{' '}
                <strong>British and European Standards</strong> (BS EN standards) set technical
                requirements for the design, manufacture, testing, and use of work at height
                equipment. While standards are not legislation in themselves, they are referenced in
                guidance and ACOPs, and compliance with relevant standards is strong evidence of
                ...
                <div className="space-y-3 text-sm text-white">
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    ...
                    <p className="text-xs text-white">
                      ...
                      industrial/professional use weighing up to 150kg).
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    <p className="text-amber-400 font-semibold text-xs mb-1">
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  ...
                  markings, the relevant BS EN standard number, the date of manufacture, and the
                  serial number. Equipment without these markings should not be used. Harnesses and
                  lanyards also have a limited service life (typically 5&ndash;10 years from first
                  use, depending on manufacturer guidance) and must be withdrawn from service at the
                  appropriate time.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-amber-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The legal framework places duties on multiple parties. It is important to understand
                that health and safety is not solely the employer&rsquo;s responsibility &mdash;
                employees and the self-employed also have significant legal obligations.
              </p>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  of HASAWA 1974. &ldquo;My boss told me to do it&rdquo; is not a defence if you
                  knowingly carried out unsafe work.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <ul className="text-sm text-white space-y-2">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong className="text-white">HASAWA 1974:</strong> The overarching Act sets
                    general duties on employers (S.2), duties to non-employees (S.3), and duties on
                    employees (S.7)
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">WAH Regs 2005:</strong> The principal regulations
                    for all work at height &mdash; plan, avoid, prevent, mitigate
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Management Regs 1999:</strong> Require risk
                    assessment and the application of preventive principles
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">CDM 2015:</strong> Creates duties on clients,
                    designers, principal designers, and principal contractors to manage work at
                    height on construction projects
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">LOLER 1998:</strong> Requires thorough
                    examination every 6 months for equipment used to lift people (MEWPs, mast
                    climbers)
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">PUWER 1998:</strong> Requires all work equipment
                    to be suitable, maintained, and inspected
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">BS EN Standards:</strong> Technical standards for
                    ladders (131), harnesses (361), lanyards (354/355), SRLs (360), and anchors
                    (795)
                  </span>
                </li>
              </ul>
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-amber-500">Next:</strong> In Section 3, we will put the
                  legal framework into practice by examining the risk assessment process for working
                  at height &mdash; how to identify hazards, evaluate risks, and record your
                  findings.
                </p>
              </div>
            </div>
