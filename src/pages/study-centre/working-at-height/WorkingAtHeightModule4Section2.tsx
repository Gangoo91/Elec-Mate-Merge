...
const quickCheckQuestions = [
  {
    ...
    options: [
      'To confirm hazards are controlled before high-risk work begins',
      'To generate paperwork for the site safety file',
      'To transfer legal responsibility from the employer to the worker',
      'To satisfy the insurance requirements set by contractors',
    ],
    correctIndex: 0,
    explanation:
...
const faqs = [
  {
    question: 'Does every work at height task require a permit-to-work?',
    answer:
  ...
  {
    question: 'Can the same person be both the permit issuer and the permit holder?',
    answer:
  ...
  {
    question: 'What happens if a permit is issued but conditions change after work starts?',
    answer:
  ...
  {
    question: 'How long should completed permits-to-work be retained?',
    answer:
...
const quizQuestions = [
  {
    ...
    options: [
      'A formal safety system confirming controls before high-risk work',
      'A form that lets any worker carry out any task on the site',
      'An insurance document that is required by the client',
  ...
  {
    id: 2,
    question: 'Which of the following WAH tasks would typically require a permit-to-work?',
    options: [
  ...
  {
    id: 3,
    question: "What is the role of the 'permit issuer' (authorising authority)?",
    options: [
  ...
  },
  {
    ...
    options: [
      'Work continues regardless because the permit is valid until 16:00',
      'The workers put on waterproof clothing and carry on as before',
      'The permit is automatically extended to allow for the rain delay',
      'Work stops and the issuer reassesses conditions before any restart',
    ],
    correctAnswer: 3,
    explanation:
  ...
  {
    id: 5,
    question: 'What information must be included on a permit-to-work for work at height?',
    options: [
      'The work, location, hazards, precautions, duration and signatures',
      'Only the names of the workers and the date of the work',
      'Only the serial numbers of the equipment being used',
      'The full weather forecast for the next seven days',
    ],
    correctAnswer: 0,
    explanation:
  ...
  {
    id: 6,
    question: "Which step comes immediately after 'Work Proceeds' in the permit lifecycle?",
    options: [
      'Permit Request',
      'Hazard Assessment',
  ...
  {
    id: 7,
    question: 'Why must permits-to-work be cross-referenced with other active permits on site?',
    options: [
      'To reduce the overall amount of paperwork held on site',
      'To check that all active permits share the same expiry time',
      'To verify that the same person has not been issued two permits',
      'To ensure no conflicting activities overlap, such as hot work below WAH',
    ],
    correctAnswer: 3,
    explanation:
  ...
  {
    id: 8,
    question: 'Which of the following is a common failure in permit-to-work systems?',
    options: [
      'Conducting a thorough hazard assessment before issuing the permit',
      'Permits being treated as a formality rather than a live safety document',
      'Requiring signatures from both the permit issuer and the permit holder',
      'Recording the completion time once all the work has been finished',
    ],
    correctAnswer: 1,
    explanation:
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
          ...
          <div className="p-4 rounded-lg bg-amber-500/5 border-l-2 border-amber-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li className="flex items-start gap-2">
                ...
                <span>
                  <strong>Not just a form:</strong> a live safety management system
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                <span>
                  <strong>Issuer &ne; Holder:</strong> separation of roles is essential
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
          ...
          <div className="p-4 rounded-lg bg-amber-500/5 border-l-2 border-amber-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              ...
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                <span>
                  <strong>Issue:</strong> verify hazards, controls, and competence
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
          ...
          <div className="border-l-2 border-amber-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                <strong>formal, documented safety management system</strong>. It is not simply a
                form to be filled in and filed. It is a live process that ensures high-risk work
                does not begin until all hazards have been identified, all necessary precautions are
                in place, all relevant parties have been informed, and a competent person has
                authorised the work to proceed.
              </p>

              <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                <p className="text-sm text-white leading-relaxed">
                  <strong className="text-amber-400">Key Point:</strong> A permit-to-work is a
                  safety system, not a piece of paper. The document is the physical record of the
                  system in operation. If the document exists but the checks, verifications, and
                  communications do not actually take place, the system has failed — regardless of
                  what is written on the form.
                </p>
              </div>

              <p>
                The concept originates from high-hazard industries such as oil and gas, chemical
                processing, and nuclear power, where the consequences of uncontrolled work are
                catastrophic. It has been adopted across construction and maintenance work for any
                task where the risk is sufficiently high that a standard risk assessment and method
                statement alone are not considered adequate control.
              </p>

              <p>
                A PTW provides a structured framework for communication between the people who
                authorise the work (the permit issuer) and the people who carry it out (the permit
                holder). It creates a clear, signed agreement that specific conditions have been met
                and specific precautions are in place. When the work is completed, the permit is
                formally returned and closed, confirming that the area is safe.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      A <strong>structured assessment</strong> of hazards specific to the task and
                      location
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      An <strong>independent check</strong> by a competent authorising person
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong>Time-limited authority</strong> — the permit has a defined validity
                      period
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      A <strong>formal close-out</strong> process confirming work is complete and
                      the area is safe
                    </span>
                  </li>
                </ul>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Not every work at height task requires a permit-to-work. Permits are reserved for{' '}
                <strong>higher-risk activities</strong> where the standard risk assessment and
                method statement process alone is not considered sufficient to control the risk. The
                employer&rsquo;s safety management system should define which tasks trigger the
                permit requirement.
              </p>
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white">
                  <p>
                    ...
                    the single largest cause of fatal falls from height in the UK construction
                    industry.
                  </p>
                  <p>
                    <strong className="text-white">Work near leading edges:</strong> Any work within
                    2 metres of an unprotected edge from which a person could fall. This includes
                    floor openings, stairwell voids, and lift shaft openings during construction.
                  </p>
                  <p>
                    <strong className="text-white">Work above fragile surfaces:</strong> Fragile
                    roof materials (such as fibre cement sheets, roof lights, or corroded metal
                    decking) that would not support a person&rsquo;s weight. Falls through fragile
                    surfaces account for a significant proportion of fatal falls.
                  </p>
                  <p>
                    <strong className="text-white">Complex scaffold operations:</strong> Erection,
                    modification, or dismantling of complex scaffold configurations, including
                    scaffold handover inspections and scaffold modifications after handover.
                  </p>
                  <p>
                    <strong className="text-white">MEWP work near overhead power lines:</strong>{' '}
                    Operating a mobile elevating work platform within the approach distance of
                    overhead power lines, where contact could cause electrocution.
                  </p>
                  <p>
                    <strong className="text-white">Steel erection and structural work:</strong>{' '}
                    Erecting structural steelwork at height where workers are exposed to fall risks
                    during connection and bolting operations.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white leading-relaxed">
                  ...
                  be used regardless of whether it is technically &ldquo;required&rdquo;. The duty
                  is to reduce risk so far as is reasonably practicable.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-teal-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                A permit-to-work document for work at height must contain sufficient information to
                clearly define what work is authorised, where it is taking place, what the hazards
                are, what precautions are required, and who is responsible. Incomplete or vague
                permits undermine the entire system.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white">
                  <p>
                    ...
                    &ldquo;replacement of three damaged ridge tiles on the north elevation of
                    Building C, requiring access to the roof slope via a scaffold&rdquo;.
                  </p>
                  <p>
                    <strong className="text-white">Location:</strong> The precise location where the
                    work will take place. Include the building, elevation, floor level, grid
                    references if applicable, and any adjacent areas that may be affected.
                  </p>
                  <p>
                    <strong className="text-white">Hazards identified:</strong> All hazards specific
                    to the task and location — fall from edge, fall through fragile surface, falling
                    materials, weather, overhead power lines, other trades working below, public
                    access.
                  </p>
                  <p>
                    <strong className="text-white">Precautions required:</strong> The specific
                    control measures that must be in place — edge protection, harness system,
                    exclusion zones, netting, tool lanyards, weather monitoring, banksman.
                  </p>
                  <p>
                    <strong className="text-white">Equipment needed:</strong> All access equipment
                    and PPE required for the task, including rescue equipment.
                  </p>
                  <p>
                    <strong className="text-white">Duration/validity:</strong> The start time, end
                    time, and maximum duration of the permit. Permits are typically issued for a
                    single shift or a defined period (e.g. 08:00 to 17:00 on a specific date). The
                    permit is invalid outside this period.
                  </p>
                  <p>
                    <strong className="text-white">Emergency arrangements:</strong> The rescue plan,
                    first aid provision, emergency contact numbers, and evacuation procedures.
                  </p>
                  <p>
                    <strong className="text-white">Signatures:</strong> Signatures of the permit
                    issuer and the permit holder, confirming they have read, understood, and agreed
                    to the conditions. Additional signatures may be required from the performing
                    authority and from any cross-referenced permit holders.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                <p className="text-sm text-white leading-relaxed">
                  <strong className="text-amber-400">Key Point:</strong> The permit must be
                  displayed at or near the work location so that it is visible to all persons
                  involved. It should not be locked in the site office. Anyone approaching the work
                  area should be able to see that a permit is in force and read the conditions.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                responsibilities. The separation of these roles is fundamental to the integrity of
                the system &mdash; the person authorising the work must not be the same person
                carrying it out.
              </p>
                ...
                <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-4">
                  ...
                  <ul className="text-sm text-white space-y-1.5">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>
                        Competent person trained in the PTW system and the type of work being
                        authorised
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Assesses that all preconditions are met before issuing</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Visits the work location to verify conditions in person</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Signs the permit to confirm authorisation</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Has authority to suspend or cancel the permit at any time</span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-green-500/10 border border-green-500/20 rounded-lg p-4">
                  ...
                  <ul className="text-sm text-white space-y-1.5">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>
                        Responsible for ensuring all conditions on the permit are maintained
                        throughout the work
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Briefs the workforce on the permit conditions</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Stops work if conditions change or are no longer met</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Returns the permit to the issuer on completion</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>
                        Must remain at or near the work location while the permit is active
                      </span>
                    </li>
                  </ul>
                </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white leading-relaxed">
                  ...
                  performing authority must be briefed on the permit conditions, must comply with
                  all stated precautions, and must report any problems to the permit holder.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                A permit-to-work follows a defined lifecycle from initial request through to formal
                closure. Each stage must be completed in sequence. Skipping stages or rushing
                through the process undermines the safety controls the system is designed to
                provide.
              </p>
              ...
              <p>
                If work is not completed within the permit validity period, the permit expires and a
                new permit must be issued. The existing permit cannot simply be extended by altering
                the time. The issuer must revisit the location, reassess conditions, and issue a
                fresh permit if it is safe to continue.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                On busy construction sites, multiple permit-to-work activities may be taking place
                simultaneously. A critical element of the permit system is ensuring that{' '}
                <strong>no conflicts exist between active permits</strong>. The permit issuer must
                check all other active permits before issuing a new one.
              </p>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white">
                  <p>
                    ...
                    sparks and hot metal can reach the workers above. Molten materials can also
                    damage ropes, harnesses, and nets.
                  </p>
                  <p>
                    <strong className="text-white">Electrical isolation:</strong> If an electrical
                    isolation permit has been issued that affects lighting or power in the area
                    where WAH is taking place, workers at height may lose lighting or power to their
                    equipment.
                  </p>
                  <p>
                    <strong className="text-white">Confined space entry:</strong> If confined space
                    work is taking place below or adjacent to the WAH area, there may be
                    ventilation, gas monitoring, or emergency access conflicts.
                  </p>
                  <p>
                    <strong className="text-white">Crane operations:</strong> If a crane is
                    operating in the vicinity, loads may swing over the WAH area, creating struck-by
                    hazards. Crane slew radius must be checked against the WAH location.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                <p className="text-sm text-white leading-relaxed">
                  <strong className="text-amber-400">Key Point:</strong> A permit-to-work register
                  (physical board or electronic system) must be maintained showing all active
                  permits. The register should display the permit number, location, type of work,
                  validity period, and holder. Before issuing a new permit, the issuer must review
                  the register for potential conflicts.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-green-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Both permit issuers and permit holders must be trained in the organisation&rsquo;s
                permit-to-work system. This is not a generic safety induction &mdash; it is specific
                training on how the PTW system operates, what the roles and responsibilities are,
                and how to deal with changes and emergencies.
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-1">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Hazard identification skills for the work being authorised</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Knowledge of the hierarchy of controls for WAH</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>How to cross-reference with other active permits</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Suspension and cancellation procedures</span>
                    </li>
                  </ul>
                </div>
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-1">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Responsibilities during the work period</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>What to do if conditions change or a hazard arises</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>How to properly return/close the permit</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Emergency and escalation procedures</span>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <p>
                Training should be refreshed regularly (typically annually) and whenever the PTW
                system is changed. Records of who has been trained and when must be maintained. A
                person who has not received the organisation&rsquo;s PTW training must not issue or
                hold a permit.
              </p>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Investigations into incidents where a permit-to-work system was in place but failed
                to prevent harm consistently identify the same underlying problems. Understanding
                these failures helps you recognise when a system is being undermined.
              </p>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <div className="space-y-3 text-sm text-white">
                  <p>
                    ...
                    location, the holder signs without reading the conditions, and the permit
                    becomes a meaningless piece of paper that creates a false sense of security.
                  </p>
                  <p>
                    <strong className="text-white">Expired permits:</strong> Work continues beyond
                    the validity period. Workers assume the permit covers the task, not a time
                    period. Supervisors fail to check expiry times. The result is uncontrolled work
                    that is no longer being managed by the permit system.
                  </p>
                  <p>
                    <strong className="text-white">Work outside permitted scope:</strong> The permit
                    authorises specific work in a specific location. Workers extend the scope
                    (&ldquo;while we&rsquo;re up here, let&rsquo;s do that too&rdquo;) without
                    requesting an amendment or new permit. The additional work has not been assessed
                    and the controls may not be adequate.
                  </p>
                  <p>
                    <strong className="text-white">No formal close-out:</strong> The permit is
                    issued and work proceeds, but the permit is never formally returned and closed.
                    This means the issuer does not know whether the work is complete, whether the
                    area is safe, or whether the permit is still active.
                  </p>
                  <p>
                    <strong className="text-white">Inadequate cross-referencing:</strong> Multiple
                    permits are active in the same area but the issuers have not checked for
                    conflicts. Hot work below work at height, crane operations overlapping with
                    scaffold work, or electrical isolation affecting lighting for WAH.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white leading-relaxed">
                  ...
                  work if the permit conditions are not being met. Report the issue to your
                  supervisor and, if necessary, to the site safety team.
                </p>
              </div>
            </div>
          </div>
