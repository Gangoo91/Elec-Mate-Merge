...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    question: 'You arrive at a scaffold and the tag displayed is RED. What does this mean?',
    options: [
  ...
  },
  {
    ...
    question: 'What is the minimum width for a working platform on a scaffold?',
    options: ['400mm', '500mm', '600mm', '800mm'],
    correctIndex: 2,
    explanation:
...
const quizQuestions = [
  {
    id: 1,
    question: 'What are the vertical tubes in a scaffold structure called?',
  ...
  {
    id: 5,
    question: 'At what minimum height must guard rails be fitted on a scaffold working platform?',
    options: [
  ...
  {
    id: 6,
    question: 'Who is permitted to erect, alter, or dismantle scaffolding?',
    options: [
          ...
          <div className="rounded-lg p-4 bg-amber-500/5 border-l-2 border-amber-500/50">
            ...
            <ul className="text-white text-base space-y-1.5 leading-relaxed">
              <li className="flex items-start gap-2">
                ...
                <span>
                  <strong className="text-white">4 main types:</strong> independent tied, putlog,
                  system scaffold, mobile tower
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                <span>
                  <strong className="text-white">Key components:</strong> standards, ledgers,
                  transoms, braces, toe boards, guard rails
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                <span>
                  <strong className="text-white">Inspect every 7 days:</strong> before first use,
                  weekly, after weather or modifications
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                <span>
                  <strong className="text-white">CISRS card:</strong> required for anyone erecting
          ...
          <div className="rounded-lg p-4 bg-amber-500/5 border-l-2 border-amber-500/50">
            ...
            <ul className="text-white text-base space-y-1.5 leading-relaxed">
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                <span>
                  <strong className="text-white">Check the tag:</strong> green = safe, amber =
                  caution, red = do not use
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                <span>
                  <strong className="text-white">Platform minimum:</strong> 600mm wide, no gaps
                  &gt;25mm between boards
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                <span>
                  <strong className="text-white">Guard rails:</strong> 950mm minimum height, with
                  intermediate rail
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                <span>
                  <strong className="text-white">Never modify:</strong> only competent CISRS card
                  holders may alter scaffolds
                </span>
              </li>
            </ul>
          </div>
          ...
          <div className="border-l-2 border-amber-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white leading-relaxed">
              <p>
                ...
                designed to support operatives, tools, and materials. There are four principal types
              ...
              <div className="space-y-4">
                <div className="bg-white/5 border border-amber-400/30 p-4 rounded-lg">
                  ...
                  <p className="text-white text-sm mb-2 leading-relaxed">
                    ...
                    scaffold is structurally independent (it stands on its own) but is{' '}
                  ...
                  <ul className="text-white text-sm space-y-1">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Does not depend on the building structure for support</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>
                        Ties prevent the scaffold pulling away from or pushing into the building
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Suitable for all trades including electrical work</span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-white/5 border border-amber-400/30 p-4 rounded-lg">
                  ...
                  <ul className="text-white text-sm space-y-1">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>
                        Cannot be used on existing buildings (no fresh mortar joints to insert
                        putlogs)
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Less common now — most sites prefer independent tied scaffolds</span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="bg-white/5 border border-amber-400/30 p-4 rounded-lg">
                    ...
                    <ul className="text-white text-sm space-y-1">
                      ...
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                        <span>Common brands: Layher, HAKI, Cuplok, Ringscaff</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                        <span>Increasingly the default choice on major sites</span>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="bg-white/5 border border-amber-400/30 p-4 rounded-lg">
                    ...
                    <ul className="text-white text-sm space-y-1">
                      ...
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                        <span>Mounted on castors for repositioning (brakes on during use)</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      ...
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                        <span>Ideal for short-duration tasks needing frequent repositioning</span>
                      </li>
                    </ul>
                  </div>
                </div>
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white leading-relaxed">
              <p>
                ...
                scaffolders on site. The following are the primary components of a tube-and-fitting
                scaffold:
              </p>
          ...
          <div className="border-l-2 border-teal-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white leading-relaxed">
              <p>
                ...
                sets out mandatory inspection requirements for scaffolding. Scaffolds must be
                inspected by a competent person, and the results recorded in writing. The inspection
                report must be kept on site and available for review by the HSE.
              </p>
              ...
              <div className="bg-white/5 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-white text-sm leading-relaxed">
                  ...
                  Reports must be kept for at least 3 months (or until the next inspection,
                  whichever is later). The HSE can request to see these records at any time.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white leading-relaxed">
              <p>
                ...
                . It provides standardised guidance for tube-and-fitting scaffolding that falls
                within defined parameters. If a scaffold meets TG20 requirements, it can be erected
                using the published guidance without individual engineering calculations.
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="bg-white/5 border border-green-400/30 p-4 rounded-lg">
                  ...
                  <ul className="text-white space-y-2 text-sm">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>No individual design calculations required</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>TG20 compliance sheet generated from eGuide software</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Covers the majority of straightforward scaffolds</span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-white/5 border border-red-400/30 p-4 rounded-lg">
                  ...
                  <ul className="text-white space-y-2 text-sm">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Requires specific structural calculations by a competent engineer</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Design drawings and calculations must be on site</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>
                        Examples: heavy-duty loading bays, cantilever scaffolds, unusual
                        configurations
                      </span>
                    </li>
                  </ul>
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                ...
                <p className="text-white text-sm leading-relaxed">
                  ...
                  placing heavy equipment or materials on a scaffold platform. If you need to load a
                  scaffold with unusually heavy items (such as a distribution board or large cable
                  drums), inform the site manager — the scaffold may need engineering review.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white leading-relaxed">
              <p>
                ...
                stairway entrance) so anyone approaching the scaffold can see the status before
                getting on.
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg text-center">
                  ...
                  <p className="text-green-200/70 text-xs leading-relaxed">
                    Scaffold inspected and <strong>safe to use</strong>. The inspection date and
                    next inspection due date are shown.
                  </p>
                </div>
                ...
                <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg text-center">
                  ...
                  <p className="text-amber-200/70 text-xs leading-relaxed">
                    <strong>Caution — restrictions apply.</strong> The scaffold may have loading
                    limitations, incomplete areas, or other conditions noted on the tag.
                  </p>
                </div>
                ...
                <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg text-center">
                  ...
                  <p className="text-red-200/70 text-xs leading-relaxed">
                    <strong>DO NOT USE.</strong> The scaffold is incomplete, under modification,
                    failed inspection, or has been condemned.
                  </p>
                </div>
              </div>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <h3 className="text-amber-400 font-medium mb-2">What the Tag Should Show</h3>
              ...
              <div className="bg-white/5 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-white text-sm leading-relaxed">
                  ...
                  finished but may be missing critical ties, braces, or guard rails.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-amber-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white leading-relaxed">
              <p>
                ...
                scaffolding work is demonstrated through the{' '}
                <strong className="text-white">
              ...
              <div className="bg-white/5 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-white text-sm leading-relaxed">
                  ...
                  fall or compromise the scaffold structure. If the scaffold does not suit your
                  needs, request a modification through the site manager who will arrange for the
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white leading-relaxed">
              <p>
                ...
                Platform standards are strict and non-negotiable.
              </p>
