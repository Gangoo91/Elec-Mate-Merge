...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    correctIndex: 3,
    explanation:
      'The majority of fatal falls at work occur from below 2 metres. This is a critically important statistic because it demonstrates that even low-level falls can be deadly. A fall from standing height onto a hard surface, or a fall from a short stepladder, can cause fatal head injuries.',
  },
  {
...
const faqs = [
  {
    ...
    answer:
      'Yes. The Work at Height Regulations 2005 apply to any place from which a person could fall a distance liable to cause personal injury. This explicitly includes excavations, shafts, pits, and sunken areas. An electrician working in a cable trench, service pit, or below-ground plant room is working at height under the regulations if there is a risk of falling.',
  },
  {
    question: 'Is standing on a chair or desk to change a light bulb considered working at height?',
    answer:
      'Yes. Standing on any improvised platform — including chairs, desks, upturned buckets, or stacked materials — constitutes working at height because there is a risk of falling. Improvised platforms are also extremely dangerous because they are not designed to be stood on and may be unstable, have no edge protection, or collapse under load. A proper stepladder or step stool should always be used instead.',
  },
  {
    question: 'Are most fatal falls from great heights?',
    answer:
      'No. Most fatal falls at work occur from relatively low heights — below 2 metres. Falls from ladders, stepladders, and low-level working platforms account for a disproportionately large number of fatalities and serious injuries. A fall from standing height onto a hard surface can cause fatal head injuries. This is why the regulations apply regardless of the height involved.',
  },
  {
    question: 'What should I do if I am asked to work at height but have not received training?',
    answer:
      'You should not carry out the work. Under the Work at Height Regulations 2005 and the Management of Health and Safety at Work Regulations 1999, your employer has a legal duty to ensure that anyone who works at height is competent to do so, or is being supervised by a competent person. You have the right to refuse unsafe work, and your employer cannot discipline you for doing so. Raise your concern with your supervisor, site manager, or health and safety representative.',
  },
];
...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Installing cable tray at ceiling height from a tower scaffold is a common working at height scenario for electricians. The other options involve work at ground level with no risk of falling.',
  },
  {
    id: 7,
    question:
      'Which of the following surfaces is specifically highlighted as a working at height hazard?',
    options: [
      'Concrete floors',
      'Tarmac car parks',
    ...
    correctAnswer: 2,
    explanation:
      'Fragile surfaces — including roof lights, fibre cement sheets, liner panels, and deteriorated asbestos cement — are specifically highlighted as a major working at height hazard. Workers can fall through fragile surfaces without warning, often with fatal consequences.',
  },
  {
    id: 8,
    question:
      'What does the Work at Height Regulations 2005 say about the minimum height that triggers the regulations?',
    options: [
    ...
    correctAnswer: 3,
    explanation:
      'There is no minimum height threshold in the Work at Height Regulations 2005. The regulations apply to any place where a person could fall a distance liable to cause personal injury. Even a fall from standing height can be fatal.',
  },
];
...
export default function WorkingAtHeightModule1Section1() {
  useSEO({
    ...
    description:
      'WAH Regulations 2005 definition, common scenarios for electricians, fatal fall statistics, and what counts as working at height in the UK.',
  });
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-amber-500/5 border-l-2 border-amber-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Definition:</strong> Any place where a person could fall a distance liable
                to cause personal injury
              </li>
              <li>
                <strong>Includes:</strong> Ladders, scaffolds, roofs, excavations, loading bays,
                fragile surfaces
              </li>
              <li>
                <strong>Deaths:</strong> ~40 per year in the UK from falls at height
              </li>
              <li>
                <strong>Key fact:</strong> Most fatal falls are from below 2 metres
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-amber-500/5 border-l-2 border-amber-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Cable tray:</strong> Ceiling-level installation from towers/scaffolds
              </li>
              <li>
                <strong>Lighting:</strong> Luminaire installation and maintenance at height
              </li>
              <li>
                <strong>Distribution:</strong> High-level DB access, busbar trunking
              </li>
              <li>
                <strong>Rooftops:</strong> Plant room access, PV array wiring, containment
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="border-l-2 border-amber-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <p>
                ...
                <strong> no minimum height threshold</strong> in the regulations &mdash; a fall from
                standing height onto a concrete floor can cause a fatal head injury just as surely
                as a fall from a scaffold.
              </p>

              <p>
                The regulations apply to{' '}
                <strong>
                  all employers, the self-employed, and anyone who controls the work of others
                </strong>{' '}
                (such as building owners, facilities managers, or principal contractors). They cover
                all work activities, not just construction &mdash; maintenance, cleaning,
                installation, inspection, and routine access are all within scope.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Working above ground or floor level</strong>{' '}
                      &mdash; on ladders, stepladders, scaffolds, tower scaffolds, mobile elevating
                      work platforms (MEWPs), roofs, false ceilings, or any elevated structure.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">
                        Working at ground level near an opening or edge
                      </strong>{' '}
                      &mdash; adjacent to an unprotected excavation, pit, shaft, loading bay, open
                      manhole, or floor opening.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Working on or near fragile surfaces</strong>{' '}
                      &mdash; roof lights, fibre cement sheets, corroded metal decking, liner
                      panels, and any surface that could give way under a person&rsquo;s weight.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Working on or from a moving vehicle</strong>{' '}
                      &mdash; where there is a risk of falling from the vehicle platform (e.g.
                      working from the back of a flatbed lorry).
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Accessing or egressing a workplace</strong>{' '}
                      &mdash; climbing stairs without handrails, using a ladder to access a roof, or
                      walking across a scaffold to reach a work position.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Working below ground level</strong> &mdash;
                      inside excavations, trenches, pits, or shafts where a person could fall
                      further or be injured by falling into the excavation.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Walking on a permanent, level floor with no openings, edges, or fragile
                      surfaces
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Working at a wall-mounted distribution board where the floor is solid and
                      level beneath you
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  access a ceiling void is working at height. Walking along an unprotected edge of a
                  first-floor slab is working at height. Leaning over an unguarded loading bay at
                  ground level is working at height.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                <strong>single largest cause of workplace fatality</strong> in the UK construction
                industry and one of the leading causes of death across all industries. The numbers
                are stark and sobering, and they demonstrate why working at height is treated as a
                high-risk activity that demands rigorous planning, competent personnel, and
                appropriate equipment.
              </p>

              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                <p className="text-sm font-medium text-red-400 mb-3">
                  UK Falls from Height &mdash; Key Statistics
                </p>
              ...
              <p>
                ...
                across all industries, and around <strong>
                  50% of fatalities in construction
                </strong>{' '}
                specifically. This makes falls the number one killer on building sites year after
                year.
              </p>

              <p>
                Beyond fatalities, falls from height cause over{' '}
                <strong>5,000 major injuries</strong>
              ...
              <div className="bg-white/5 border border-white/10 p-4 sm:p-6 rounded-lg">
                <p className="text-sm font-medium text-white mb-4">
                  Fatal Falls by Height Band (Approximate Annual Distribution)
                </p>
                ...
                <div className="mt-4 p-3 bg-red-500/10 border border-red-500/20 rounded-lg">
                  <div className="flex items-start gap-2">
                    ...
                    <p className="text-xs text-white">
                      ...
                      for short-duration, low-level tasks, which is precisely when most accidents
                      happen.
                    </p>
                  </div>
                </div>
              ...
              <p>
                ...
                dangerous at extreme elevations. In practice, the most dangerous scenario is often a
                tradesperson standing on an unsecured stepladder or working from an unguarded
                platform at a relatively modest height. The combination of a hard landing surface,
                an awkward fall position, and the absence of head protection means that even a fall
                of one metre can be fatal.
              </p>
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Head injuries</strong> &mdash; a fall from
                      standing height onto concrete can cause fatal skull fractures and traumatic
                      brain injuries
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">No time to react</strong> &mdash; in a fall
                      from below 2 metres, there is virtually no time to adopt a protective posture
                      or break the fall
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Complacency</strong> &mdash; workers tend to
                      take fewer precautions for short-duration, low-level tasks, increasing the
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Hard surfaces</strong> &mdash; construction
                      sites typically have concrete, steel, or compacted earth surfaces with zero
                      energy absorption
                    </span>
                  </li>
                </ul>
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                electrical installations are located at ceiling level, on rooftops, or in areas that
                require access equipment. Understanding which of your daily tasks constitute working
                at height is essential for complying with the law and staying safe.
              </p>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1.5">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Roof lights and skylights</strong> &mdash; both
                      plastic dome types and glass panels, often impossible to see when covered in
                      dirt or algae
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Fibre cement sheets</strong> &mdash; commonly
                      found on industrial roofs, these deteriorate with age and become increasingly
                      fragile
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Liner panels</strong> &mdash; the inner sheet
                      of a profiled metal roof system, not designed to support a person&rsquo;s
                      weight
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Suspended ceiling tiles</strong> &mdash;
                      mineral fibre tiles in a grid system will collapse immediately if stepped on
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Asbestos cement sheets</strong> &mdash; found
                      on older buildings, these become more fragile with age and are also an
                      asbestos hazard
                    </span>
                  </li>
                </ul>
              ...
              <p>
                Falls through fragile surfaces are a particularly deadly category. The HSE reports
                that falls through fragile roofs account for a significant proportion of fatal falls
                at work each year. In many cases, the worker was not even aware that the surface was
                fragile, or walked onto a roof light that was obscured by dirt, moss, or accumulated
                debris. The rule is simple:{' '}
                <strong>
                  if you cannot confirm that a surface will support your weight, treat it as fragile
                </strong>
                .
              </p>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Understanding the precise scope of the Work at Height Regulations 2005 is essential
                for compliance. The regulations are not limited to construction &mdash; they apply
                to all work at height in all industries, including maintenance, facilities
                management, telecommunications, arboriculture, entertainment, agriculture, and any
                other sector where work at height occurs.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Construction work</strong> &mdash; new builds,
                      extensions, refurbishments, demolition, and civil engineering projects
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Maintenance and repair</strong> &mdash; roof
                      repairs, gutter clearing, painting, window cleaning, lamp replacement,
                      equipment servicing
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Inspection and surveying</strong> &mdash;
                      building surveys, condition assessments, pre-purchase inspections, periodic
                      testing
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Installation</strong> &mdash; fitting
                      electrical systems, mechanical plant, signage, telecommunications equipment,
                      solar panels
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Access and egress</strong> &mdash; the journey
                      to and from a work position at height (e.g. climbing a ladder to access a
                      roof)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Passing near an opening or edge</strong>{' '}
                      &mdash; even walking past an unprotected edge or opening constitutes being at
                      risk from a fall
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                ...
                <ol className="text-sm text-white space-y-2 list-decimal list-inside">
                  ...
                  <li className="leading-relaxed">
                    <strong className="text-white">Prevent</strong> falls by using the right type of
                    work equipment and safety measures where work at height cannot be avoided
                  </li>
                  <li className="leading-relaxed">
                    <strong className="text-white">Mitigate</strong> the distance and consequences
                    of a fall, if the risk of falling cannot be entirely eliminated
                  </li>
                  <li className="leading-relaxed">
                    Ensure all work at height is{' '}
                    <strong className="text-white">
                      properly planned, appropriately supervised, and carried out by competent
                      persons
                    </strong>
                  </li>
                  <li className="leading-relaxed">
                    Ensure that work equipment for working at height is{' '}
                    <strong className="text-white">
                      inspected, maintained, and used correctly
                    </strong>
                  </li>
                  <li className="leading-relaxed">
                    Take account of <strong className="text-white">weather conditions</strong> that
                    could jeopardise safety
                  </li>
                  <li className="leading-relaxed">
                    Ensure that the place where work at height is carried out is{' '}
                    <strong className="text-white">
                      safe and has appropriate edge protection, guardrails, or other safeguards
                    </strong>
                  </li>
                </ol>
              </div>
              ...
              <p>
                ...
                complied with &ldquo;so far as is reasonably practicable&rdquo;). The hierarchy of
                avoid &rarr; prevent &rarr; mitigate is a core principle of the regulations and will
                be covered in detail in Section 4 of this module.
              </p>
          ...
          <div className="border-l-2 border-amber-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                managed. Each case involves an electrician or electrical contractor and demonstrates
                the very real consequences of failing to follow the regulations.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  seen as &ldquo;too simple&rdquo; to warrant formal planning.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white mb-2">
                  ...
                  fix the next clip. On one occasion, the ladder slipped sideways and he fell
                ...
                <p className="text-sm text-white">
                  ...
                  had not received specific training on ladder use. Supervision was inadequate.
                </p>
              </div>
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  ...
                  assessment was not carried out. Working at height must never be treated as a minor
                  or routine matter &mdash; regardless of how simple the task may appear.
                </p>
              </div>

              <p>
                The HSE investigates every workplace death and many serious injuries. Employers and
                individuals who are found to have breached the Work at Height Regulations face
                prosecution, unlimited fines, and in the most serious cases, imprisonment for up to
                two years under the Health and Safety at Work Act 1974. Company directors can also
                face personal prosecution under the Corporate Manslaughter and Corporate Homicide
                Act 2007.
              </p>
          ...
          <div className="border-l-2 border-green-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                height means, why it matters, and how it applies to the daily work of electricians.
              ...
              <ul className="text-sm text-white space-y-2">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong className="text-white">Definition:</strong> Working at height means any
                    place where a person could fall a distance liable to cause personal injury
                    &mdash; there is no minimum height
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Scope:</strong> The regulations cover ladders,
                    scaffolds, roofs, MEWPs, excavations, loading bays, fragile surfaces, and
                ...
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Statistics:</strong> Approximately 40 deaths and
                    5,000+ major injuries per year &mdash; most fatal falls are from below 2 metres
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Electrician relevance:</strong> Cable tray,
                    lighting, distribution, rooftop plant, and solar PV work all routinely involve
                    working at height
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Fragile surfaces:</strong> Roof lights, fibre
                    cement sheets, and suspended ceilings are deadly &mdash; always assume they are
                    fragile unless confirmed otherwise
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Enforcement:</strong> Breaching the regulations
                    can result in unlimited fines, imprisonment, and prohibition notices
                  </span>
                </li>
              </ul>
