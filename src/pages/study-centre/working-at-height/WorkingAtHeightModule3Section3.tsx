...
const quickCheckQuestions = [
  ...
  {
    id: 'qc3',
    question: 'Which HSE publication provides specific guidance on safety in roof work?',
...
const faqs = [
  {
    question: 'How can I tell if a roof surface is fragile?',
    answer:
  ...
  {
    question: 'Are modern polycarbonate roof lights fragile?',
    answer:
  ...
  {
    question: 'Can I walk on a metal profile roof if it looks in good condition?',
    answer:
  ...
  {
    question: 'What electrical work commonly takes place on roofs?',
    answer:
...
const quizQuestions = [
  ...
  {
    id: 3,
    question: 'What is the function of running boards/staging on a fragile roof?',
    options: [
      'To provide edge protection at the eaves',
...
export default function WorkingAtHeightModule3Section3() {
  useSEO({
    title: 'Fragile Surfaces & Roof Work | Module 3 Section 3 | Working at Height',
    description:
    ...
    <div className="overflow-x-hidden bg-[#1a1a1a]">
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <section className="mb-12">
          ...
          <div className="border-l-2 border-amber-500/30 pl-4 sm:pl-6 space-y-4">
            ...
            <p className="text-white text-sm sm:text-base leading-relaxed">
              ...
              immediately — if it would crack, deform, or give way under sustained or repeated
              loading, it is fragile.
            </p>
            ...
            <div className="rounded-xl border border-white/10 bg-white/[0.02] p-4">
              ...
              <p className="text-white text-sm leading-relaxed">
                ...
                Age, weathering, and UV exposure weaken materials over time, turning once-adequate
                surfaces into fragile ones.{' '}
                <strong className="text-white">
                  You cannot determine fragility by visual inspection alone.
                </strong>
              </p>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="rounded-xl border border-red-500/20 bg-red-500/5 p-4">
                ...
                <p className="text-white text-sm leading-relaxed">
                  ...
                  biggest cause of fatal falls through roofs.
                </p>
              </div>
              <div className="rounded-xl border border-red-500/20 bg-red-500/5 p-4">
        ...
        <section className="mb-12">
          ...
          <div className="border-l-2 border-purple-500/30 pl-4 sm:pl-6 space-y-4">
            <p className="text-white text-sm sm:text-base leading-relaxed">
              ...
              the Work at Height Regulations 2005 and the Construction (Design and Management)
              Regulations 2015.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="rounded-xl border border-cyan-500/20 bg-cyan-500/5 p-4">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h4 className="text-cyan-400 text-sm font-semibold">Solar PV Installation</h4>
                </div>
                <div className="space-y-2">
                  {[
              ...
              <div className="rounded-xl border border-cyan-500/20 bg-cyan-500/5 p-4">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h4 className="text-cyan-400 text-sm font-semibold">External Lighting & CCTV</h4>
                </div>
                <div className="space-y-2">
                  {[
            ...
            <div className="max-w-lg mx-auto space-y-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1 flex items-center gap-1">
                  ...
                  <span className="text-[10px] text-yellow-400/70">DANGER — FRAGILE ROOF</span>
                </div>
        ...
        <section className="mb-12 rounded-xl border border-white/10 bg-white/[0.02] p-5 sm:p-6">
          <Quiz questions={quizQuestions} title="Section 3 Quiz — Fragile Surfaces & Roof Work" />
        </section>
