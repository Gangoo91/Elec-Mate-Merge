...
const faqs = [
  {
    question: 'Who can carry out the 6-monthly thorough examination?',
    answer:
  ...
  {
    question: 'What is the typical service life of a harness?',
    answer:
  ...
  {
    question: 'Can I repair a damaged harness myself?',
    answer:
  ...
  {
    question: 'How should lanyards and SRLs be stored when not in use?',
    answer:
...
const quizQuestions = [
  ...
  {
    id: 3,
    question: 'What should you check on the shock absorber indicator during a pre-use inspection?',
    options: [
...
function FAQItem({ question, answer }: { question: string; answer: string }) {
  ...
  return (
    <div className="border border-white/10 rounded-xl overflow-hidden">
      ...
      >
        <span className="text-sm sm:text-base font-medium leading-relaxed flex-1">{question}</span>
        {open ? (
...
export default function WorkingAtHeightModule3Section4() {
  useSEO({
    title: 'Harness Inspection & Equipment Checks | Module 3 Section 4 | Working at Height',
    description:
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <section className="mb-12">
          ...
          <div className="border-l-2 border-amber-500/30 pl-4 sm:pl-6 space-y-4">
            ...
            <h3 className="text-white font-semibold text-base mt-4 mb-3">Webbing Inspection</h3>
            ...
            <h3 className="text-white font-semibold text-base mt-6 mb-3">Stitching Inspection</h3>
            <div className="space-y-2">
              {[
            ...
            <h3 className="text-white font-semibold text-base mt-6 mb-3">Hardware Inspection</h3>
            <div className="space-y-2">
              {[
            ...
            <h3 className="text-white font-semibold text-base mt-6 mb-3">Labels & Markings</h3>
            <div className="space-y-2">
              {[
        ...
        <section className="mb-12">
          ...
          <div className="border-l-2 border-blue-500/30 pl-4 sm:pl-6 space-y-4">
            <p className="text-white/80 text-sm sm:text-base leading-relaxed">
              ...
              <strong className="text-white">competent person</strong> at intervals not exceeding 6
              months. This is a legal obligation on the employer — non-compliance is a criminal
              offence.
            </p>
            ...
            <div className="rounded-xl border border-white/10 bg-white/[0.02] p-4">
              ...
              <p className="text-white/70 text-sm leading-relaxed">
                ...
                equipment misses its examination date, it must not be used until the examination has
                been completed.
              </p>
            </div>
          </div>
        ...
        <section className="mb-12">
          ...
          <div className="border-l-2 border-red-500/30 pl-4 sm:pl-6 space-y-4">
            <p className="text-white/80 text-sm sm:text-base leading-relaxed">
              ...
              from service should be clearly marked &ldquo;DO NOT USE&rdquo; or physically destroyed
        ...
        <section className="mb-12">
          ...
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6 space-y-4">
            ...
            <div className="rounded-xl border border-green-500/20 bg-green-500/5 p-4">
              <h4 className="text-green-400 text-sm font-semibold mb-3">Storage Requirements</h4>
              <div className="space-y-2">
                {[
            ...
            <div className="rounded-xl border border-white/10 bg-white/[0.02] p-4">
              ...
              <p className="text-white/70 text-sm leading-relaxed">
                ...
                leave the harness loose on the van floor where it can be contaminated by oils,
                tools, or cable offcuts.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="border-l-2 border-purple-500/30 pl-4 sm:pl-6 space-y-4">
            <h3 className="text-white font-semibold text-base mb-3">Webbing Lanyard Inspection</h3>
            <div className="space-y-2">
              {[
          ...
          <div className="border-l-2 border-cyan-500/30 pl-4 sm:pl-6 space-y-4">
            ...
            <div className="rounded-xl border border-white/10 bg-white/[0.02] p-4">
              ...
              <p className="text-white/70 text-sm leading-relaxed">
                ...
                under the dynamic forces of a fall arrest event (up to 6 kN or more). Only connect
                to purpose- installed, tested, and certified anchor devices.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="border-l-2 border-amber-500/30 pl-4 sm:pl-6 space-y-4">
            ...
            <div className="rounded-xl border border-amber-500/20 bg-amber-500/5 p-4">
              <h4 className="text-amber-400 text-sm font-semibold mb-3">What Must Be Recorded</h4>
              <div className="space-y-2">
                {[
            ...
            <div className="rounded-xl border border-white/10 bg-white/[0.02] p-4">
              ...
              <p className="text-white/70 text-sm leading-relaxed">
                ...
                faster and eliminates the risk of paper records being lost. If your employer uses
                such a system, make sure you know how to use it.
              </p>
            </div>
          </div>
        </section>
