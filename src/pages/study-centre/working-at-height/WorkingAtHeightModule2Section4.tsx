...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    question: 'What is the maximum platform height for a hop-up?',
    options: ['300mm', '600mm', '1000mm', '1500mm'],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  {
    id: 1,
    question: 'What is the maximum platform height of a hop-up?',
  ...
  {
    id: 2,
    question: 'What is the key difference between a podium step and a standard stepladder?',
    options: [
  ...
  {
    id: 5,
    question: 'What is the maximum unsupported span for a scaffold board on a trestle platform?',
          ...
          <div className="rounded-lg p-4 bg-amber-500/5 border-l-2 border-amber-500/50">
            ...
            <ul className="text-white text-base space-y-1.5 leading-relaxed">
              <li className="flex items-start gap-2">
                ...
                <span>
                  <strong className="text-white">Podium steps:</strong> safer alternative to
                  stepladders — enclosed guardrails, large platform
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                <span>
                  <strong className="text-white">Hop-ups:</strong> max 600mm platform height, very
                  short tasks only
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                <span>
                  <strong className="text-white">Roof ladders:</strong> distribute weight on fragile
                  roofs, ridge hook securing
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                <span>
                  <strong className="text-white">Safety nets:</strong> max 6m fall distance, EN 1263
                  standard
                </span>
              </li>
            </ul>
          ...
          <div className="rounded-lg p-4 bg-amber-500/5 border-l-2 border-amber-500/50">
            ...
            <ul className="text-white text-base space-y-1.5 leading-relaxed">
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                <span>
                  <strong className="text-white">Selection:</strong> consider duration, height, task
                  type, then match equipment
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                <span>
                  <strong className="text-white">Trestle platforms:</strong> boards supported at
                  1.2m max span, 600mm min width
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                <span>
                  <strong className="text-white">Edge protection:</strong> free-standing
                  counterweighted systems — no drilling required
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                <span>
                  <strong className="text-white">Always risk-assess:</strong> match the equipment to
                  the actual task, not the other way round
                </span>
              </li>
            </ul>
          </div>
          ...
          <div className="border-l-2 border-amber-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white leading-relaxed">
              <p>
                ...
                buildings, and facilities. Many principal contractors now{' '}
                <strong className="text-white">ban stepladders entirely</strong>, requiring podium
                steps as the minimum standard.
              </p>
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                ...
                <p className="text-white text-sm leading-relaxed">
                  ...
                  height is at least 950mm above the platform. Podium steps comply with{' '}
                  <strong className="text-white">BS 8620:2022</strong> (specification for low-level
                  work platforms).
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="bg-white/5 border border-amber-400/30 p-4 rounded-lg">
                  ...
                  <ul className="text-white space-y-2 text-sm">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Larger, flat platform — both feet on a comfortable surface</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>User can work with both hands free (no need to hold on)</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>More stable base — wider footprint than stepladders</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Self-closing gate at the access point</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                ...
                <div className="bg-white/5 border border-amber-400/30 p-4 rounded-lg">
                  ...
                  <ul className="text-white space-y-2 text-sm">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Platform size: typically 500mm &times; 500mm minimum</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Guard rail height: 950mm above platform (minimum)</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Weight capacity: typically 150kg per platform</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Folds flat for transport and storage</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Aluminium or fibreglass (GRP) construction</span>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="space-y-4 text-white leading-relaxed">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="bg-white/5 border border-purple-400/30 p-4 rounded-lg">
                  ...
                  <ul className="text-white space-y-2 text-sm">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Light work requiring a small height boost only</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Maximum platform height: 600mm</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Risk assessment confirms the risk is low</span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-white/5 border border-purple-400/30 p-4 rounded-lg">
                  ...
                  <ul className="text-white space-y-2 text-sm">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Small platform area limits working space</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Banned on many construction sites due to lack of fall protection</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Must not be used on uneven or slippery surfaces</span>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-white text-sm leading-relaxed">
                  ...
                  can collapse, tip, or slide — causing falls, crush injuries, or worse. Only
          ...
          <div className="border-l-2 border-teal-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white leading-relaxed">
              <p>
                ...
                with scaffold boards laid across them to create a low-level working platform. They
                are used for tasks at modest heights where a simple, stable platform is needed —
                such as plastering, painting, or running cable containment along a wall.
              </p>
              ...
              <div className="bg-white/5 border border-teal-400/30 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-2 text-sm">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Board support:</strong> scaffold boards must be
                      supported at maximum <strong className="text-white">1.2m</strong> intervals
                      (same as scaffolding)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Minimum platform width:</strong> 600mm (3
                      boards) for a working platform
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Board overhang:</strong> not more than 4 times
                      the board thickness from the trestle support
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Guard rails:</strong> required if the platform
                      is above 2 metres (guard rails at 950mm + toe boards at 150mm)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Boards:</strong> must be BS 2482 graded,
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Trestles:</strong> must be fully opened, legs
                      locked, and placed on firm, level ground
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-orange-500/30 p-4 rounded-lg">
                ...
                <ul className="text-white text-sm space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      Boards not secured — they can slide off the trestle if kicked or caught by
                      wind
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      Excessive overhang creating a tipping hazard when the user stands near the
                      board end
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>Using damaged or sub-standard boards that could break under load</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>No guard rails on platforms above 2m — a common and serious breach</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white leading-relaxed">
              <p>
                ...
                <strong className="text-white">fragile roof materials</strong>. Their primary
                purpose is to distribute the user's weight over a larger area of the roof surface,
                preventing falls through fragile materials.
              </p>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-white text-sm leading-relaxed">
                  ...
                  plastic rooflights, old asbestos cement sheets, corroded metal decking, and glass
                  panels — may not support a person's weight. A roof ladder or crawling board is
                  essential, but it is{' '}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="bg-white/5 border border-red-400/30 p-4 rounded-lg">
                  ...
                  <ul className="text-white space-y-2 text-sm">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>
                        A ladder with a <strong className="text-white">ridge hook</strong> at the
                        top that hooks over the roof ridge
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Distributes the user's weight along the length of the ladder</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>The ridge hook must be securely engaged before the user climbs on</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>
                        Always position the ladder so the rungs face upwards (bearing surface down)
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Used on sloped tiled, slated, or sheeted roofs</span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-white/5 border border-red-400/30 p-4 rounded-lg">
                  ...
                  <ul className="text-white space-y-2 text-sm">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Minimum 600mm wide with cross battens at intervals</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Used on fragile or low-load-capacity roof surfaces</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Must span at least 3 purlins or support members</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Secured at the ridge to prevent sliding</span>
                    </li>
                  </ul>
                </div>
              </div>
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white leading-relaxed">
              <p>
                ...
                everyone working in the area above, not just individual users. Nets are installed
                below the working area to catch anyone who falls, arresting the fall before the
                person hits the ground or a lower level.
              </p>
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                ...
                <p className="text-white text-sm leading-relaxed">
                  ...
                  The standard defines mesh size, cord diameter, breaking strength, energy
                  absorption, and installation methods.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-cyan-400/30 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-2 text-sm">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Maximum fall distance: 6 metres</strong> —
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      Nets must be installed as close below the working area as possible — the
                      closer the better
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>Must be installed by a competent person following EN 1263-2</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      Regular inspection for damage, UV degradation, chemical contamination
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>Debris and tools must be regularly cleared from nets</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      After catching a person, the net and its fixings must be inspected before
                      reuse
                    </span>
                  </li>
                </ul>
              ...
              <p>
                Safety nets are commonly used in steelwork erection, roof construction, and bridge
                building — situations where other forms of edge protection or platform access are
                impractical. They are particularly effective because they protect the entire area
                below the work zone, not just individual operatives.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="border-l-2 border-amber-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white leading-relaxed">
              ...
              <p>
                ...
                depth in <strong className="text-white">Module 3</strong>. However, it is important
                to understand where harnesses fit in the hierarchy at this stage:
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white text-sm space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      Harnesses are <strong className="text-white">personal</strong> fall protection
                      — they protect only the individual wearing them
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      Collective measures (guard rails, nets, scaffolding) are preferred — they
                      protect everyone
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      Harnesses are used when collective protection is not reasonably practicable
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      A rescue plan is always required when harnesses are in use — suspension trauma
                      can be fatal within 30 minutes
                    </span>
                  </li>
                </ul>
              </div>

              <h3 className="text-white font-semibold text-base mt-6">Temporary Edge Protection</h3>
              <p>
                Temporary edge protection systems provide guard rails at unprotected edges — flat
                roofs, floor openings, mezzanines, loading bays, and incomplete stairwells.
                Free-standing systems are particularly useful because they require{' '}
                <strong className="text-white">no drilling, bolting, or fixings</strong> to the
                surface.
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="bg-white/5 border border-amber-400/30 p-4 rounded-lg">
                  ...
                  <ul className="text-white space-y-2 text-sm">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Modular design — can be configured to any edge length</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Quick to install and remove — typically under 1 hour</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Guard rail at 950mm minimum, intermediate rail, and toe board</span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-white/5 border border-amber-400/30 p-4 rounded-lg">
                  ...
                  <ul className="text-white space-y-2 text-sm">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Clamp-on systems:</strong> clamp to steel
                        beams or concrete edges
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Socket-based systems:</strong> uprights
                        inserted into floor sockets cast into the slab
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Parapet clamp systems:</strong> clamp onto
                        existing parapet walls to raise the effective height
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>All types must meet the 950mm guard rail height requirement</span>
                    </li>
                  </ul>
                </div>
              </div>
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white leading-relaxed">
              <p>
                ...
                option. The following flowchart covers the most common scenarios:
              </p>
                ...
                <div className="space-y-4 max-w-lg mx-auto">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="bg-white/5 border border-white/10 rounded-lg p-2 text-center">
                      <p className="text-white text-xs font-medium">Under 5 mins</p>
                    ...
                    <div className="bg-white/5 border border-white/10 rounded-lg p-2 text-center">
                      <p className="text-white text-xs font-medium">Over 5 mins</p>
                      <ArrowDown className="h-3 w-3 text-amber-400/50 mx-auto my-1" />
                      <p className="text-amber-400/80 text-[10px]">Continue to Step 2</p>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
                    <div className="bg-white/5 border border-white/10 rounded-lg p-2 text-center">
                      <p className="text-white text-xs font-medium">Under 1m platform</p>
                      <ArrowDown className="h-3 w-3 text-amber-400/50 mx-auto my-1" />
                      <p className="text-green-400 text-[10px] font-medium">Podium step</p>
                    </div>
                    <div className="bg-white/5 border border-white/10 rounded-lg p-2 text-center">
                      <p className="text-white text-xs font-medium">1m to 6m platform</p>
                      <ArrowDown className="h-3 w-3 text-amber-400/50 mx-auto my-1" />
                      <p className="text-amber-400/80 text-[10px]">Continue to Step 3</p>
                    </div>
                    <div className="bg-white/5 border border-white/10 rounded-lg p-2 text-center">
                      <p className="text-white text-xs font-medium">Above 6m platform</p>
                      <ArrowDown className="h-3 w-3 text-amber-400/50 mx-auto my-1" />
                      <p className="text-green-400 text-[10px] font-medium">Scaffold or MEWP</p>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                    <div className="bg-white/5 border border-white/10 rounded-lg p-2 text-center">
                      <p className="text-white text-xs font-medium">Light work, one position</p>
                      <ArrowDown className="h-3 w-3 text-amber-400/50 mx-auto my-1" />
                    ...
                    <div className="bg-white/5 border border-white/10 rounded-lg p-2 text-center">
                      <p className="text-white text-xs font-medium">Long-run, multiple positions</p>
                      <ArrowDown className="h-3 w-3 text-amber-400/50 mx-auto my-1" />
                      <p className="text-green-400 text-[10px] font-medium">
                ...
                <div className="space-y-2 text-sm">
                  {[
                    ...
                    },
                    {
                      ...
                      equipment: 'Temporary edge protection + access ladder',
                    },
                    {
                      scenario: 'Working on a fragile cement sheet roof',
                      equipment: 'Crawling boards + safety net below + harness',
                    },
                    {
                    ...
                    {
                      scenario: 'Installing high-bay warehouse lighting at 12m',
                      equipment: 'Scissor lift (3a) or articulated boom (3b)',
                    },
              ...
              <div className="bg-white/5 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-white text-sm leading-relaxed">
                  ...
                  scaffold. Always select based on the task requirements identified in your risk
                  assessment — not based on convenience, cost, or availability.
                </p>
              </div>
            </div>
          </div>
