...
const quickCheckQuestions = [
  {
    ...
    options: ['0.5 metres', '1 metre', '2 metres', '4 metres'],
    correctIndex: 1,
    explanation:
...
const faqs = [
  ...
  {
    question: 'Do I need formal training to use a ladder on a construction site?',
    answer:
...
const quizQuestions = [
  ...
  {
    id: 2,
    question: 'Which of the following is NOT an acceptable method for securing a ladder?',
    options: [
  ...
  {
    id: 4,
    question: 'What is the maximum recommended duration for continuous work from a ladder?',
          ...
          <div className="rounded-lg p-4 bg-amber-500/5 border-l-2 border-amber-500/50">
            ...
            <ul className="text-white text-base space-y-1.5 leading-relaxed">
              <li className="flex items-start gap-2">
                ...
                <span>
                  <strong className="text-white">Short duration:</strong> ladders suit tasks under
                  30 minutes with light work
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                <span>
                  <strong className="text-white">1-in-4 rule:</strong> base 1 unit out for every 4
                  units up (75&deg;)
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                <span>
                  <strong className="text-white">3 points of contact:</strong> always — two hands +
                  one foot, or two feet + one hand
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                <span>
                  <strong className="text-white">BS EN 131:</strong> Class 1 industrial, Class 3
                  domestic — always use Class 1 on site
                </span>
              </li>
            </ul>
          </div>
          ...
          <div className="rounded-lg p-4 bg-amber-500/5 border-l-2 border-amber-500/50">
            ...
            <ul className="text-white text-base space-y-1.5 leading-relaxed">
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                <span>
                  <strong className="text-white">Inspect before use:</strong> stiles, rungs, feet,
                  locking mechanisms
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                <span>
                  <strong className="text-white">Secure the ladder:</strong> tie at top, foot at
                  bottom, prevent slipping
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                <span>
                  <strong className="text-white">3 rungs above:</strong> ladder must extend 1&nbsp;m
              ...
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                <span>
                  <strong className="text-white">Remove if defective:</strong> tag and take out of
                  service immediately
                </span>
              </li>
            </ul>
          ...
          <div className="border-l-2 border-amber-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white leading-relaxed">
              <p>
                ...
                equipment (such as scaffolding or a MEWP) is not reasonably practicable, or where
                the risk is already low. Ladders are <em>not</em> banned, but they sit near the
                bottom of the access equipment hierarchy.
              </p>
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                ...
                <p className="text-white text-sm leading-relaxed">
                  ...
                  is low-risk, short-duration, and light work.
                </p>
              </div>

              <p>
                In practice, ladders and stepladders are widely used in the electrical trade — for
                accessing distribution boards at height, changing luminaires, running short cable
                drops, and accessing roofs or scaffold platforms. The key is that the task must meet
              ...
              <p>
                If any of these criteria cannot be met, a ladder is not the correct access equipment
                for the task, and an alternative must be selected. This decision should be recorded
              ...
              <div className="bg-white/5 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-white text-sm leading-relaxed">
                  ...
                  tools, the task has outgrown the ladder. Stop and arrange proper access equipment.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white leading-relaxed">
              <p>
                ...
                wrong type is a frequent cause of incidents.
              </p>

              {/* Leaning ladder types */}
              <h3 className="text-white font-semibold text-base">Leaning Ladders</h3>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="bg-white/5 border border-purple-400/30 p-4 rounded-lg">
                  ...
                  <ul className="text-white space-y-2 text-sm">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Typically up to 6 metres in length</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Simple, lightweight, and easy to transport</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Best for short-reach access at a fixed height</span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-white/5 border border-purple-400/30 p-4 rounded-lg">
                  ...
                  <ul className="text-white space-y-2 text-sm">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Reaches greater heights — up to 12 metres when fully extended</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>
                        Locking catches or rope-and-pulley system to hold sections in place
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Sections must overlap by at least 3 rungs when extended</span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-white/5 border border-purple-400/30 p-4 rounded-lg sm:col-span-2">
                  ...
                  <ul className="text-white space-y-2 text-sm">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>
                        Multi-purpose — converts between leaning ladder, stepladder, and stairwell
                        mode
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Adjustable hinge points allow multiple configurations</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Popular with electricians for versatility on varied tasks</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>
                        Must check locking mechanisms are fully engaged in each configuration
                      </span>
                    </li>
                  </ul>
                </div>
              ...
              {/* Stepladder types */}
              <h3 className="text-white font-semibold text-base mt-6">Stepladders</h3>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="bg-white/5 border border-purple-400/30 p-4 rounded-lg">
                  ...
                  <ul className="text-white space-y-2 text-sm">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Usually has a handrail above the platform for stability</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>More comfortable for tasks lasting a few minutes</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Freestanding — does not need to lean against a surface</span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-white/5 border border-purple-400/30 p-4 rounded-lg">
                  ...
                  <ul className="text-white space-y-2 text-sm">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>No platform — the top is a pointed cap, not for standing</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>User must not stand on the top 2 treads</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Lighter and more compact than platform stepladders</span>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-white text-sm leading-relaxed">
                  ...
                  platform is the intended standing point — but even then, only stand on the
                  platform, not on any part above it.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-teal-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white leading-relaxed">
              <p>
                ...
                between the ladder and the ground — approximately{' '}
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                ...
                <p className="text-white text-sm leading-relaxed">
                  ...
                  the ladder rests against the wall at a height of 4 metres, the base must be 1
                  metre from the wall. At 8 metres, the base must be 2 metres out.
                </p>
              </div>

              <p>Getting the angle wrong has serious consequences:</p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                  ...
                  <ul className="text-white space-y-2 text-sm">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Sideways movement becomes more likely</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Very difficult to climb safely</span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                  ...
                  <ul className="text-white space-y-2 text-sm">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Increased loading on the ladder's rungs and stiles</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>The ladder can buckle or collapse under load</span>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="bg-[#111] border border-white/10 rounded-xl p-5 sm:p-6">
                ...
                <div className="flex justify-center">
                  <div className="relative w-[280px] sm:w-[340px] h-[360px] sm:h-[420px]">
                    ...
                    {/* Rung marks */}
                    {[0.15, 0.28, 0.41, 0.54, 0.67, 0.8, 0.89, 0.95].map((pos, i) => (
                      <div
                        key={i}
              ...
              <p>
                A quick on-site method to check the angle: stand at the base of the ladder with your
                toes touching the stiles and extend your arms straight out — if your palms rest
                comfortably on the rung at shoulder height, the angle is approximately correct.
                However, this is only a rough guide — always measure when in doubt.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white leading-relaxed">
              <p>
                ...
                ladders must be prevented from slipping during use. There are three primary methods:
              </p>
                ...
                <div className="bg-white/5 border border-red-400/30 p-4 rounded-lg">
                  ...
                  <ul className="text-white space-y-2 text-sm">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>
                        Tie both stiles (not the rungs) to a secure anchor point at the top
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>
                        Use proprietary ladder ties, ratchet straps, or lashing — never bungee cords
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Prevents both outward sliding at the base and lateral movement</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>
                        The anchor point must be structural — not a gutter, drainpipe, or loose
                        fitting
                      </span>
                    </li>
                  </ul>
                ...
                <div className="bg-white/5 border border-red-400/30 p-4 rounded-lg">
                  ...
                  <ul className="text-white space-y-2 text-sm">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>
                        A competent person stands at the base, gripping both stiles with hands and
                        bracing feet against the ladder feet
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>The footer must face the ladder, not away from it</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>
                        Footing is a temporary measure — not a substitute for tying at the top when
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>
                        The footer must remain in position for the entire duration of ladder use
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-white/5 border border-red-400/30 p-4 rounded-lg">
                  ...
                  <ul className="text-white space-y-2 text-sm">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>
                        Use a ladder stabiliser or stand-off device to widen the base footprint
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>
                        On soft ground, use a board under the feet to prevent sinking (never dig the
                        feet in)
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>
                        Anti-slip feet (rubber or pivoting) must be in good condition and in contact
                        with the surface
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>On smooth floors, use a ladder mat or anti-slip device</span>
                    </li>
                  </ul>
                </div>
              </div>
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white leading-relaxed">
              <p>
                ...
                performance requirements that all portable ladders must meet. The standard was
                significantly updated in 2018 (BS EN 131-1:2015+A1:2019 and BS EN
                131-2:2010+A2:2017).
              </p>
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                ...
                <p className="text-white text-sm leading-relaxed">
                  ...
                  professional) and <strong className="text-white">Class 3</strong> (domestic).
                  There is also a Class 2 (commercial) but this is less commonly referenced on
                  construction sites.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="bg-white/5 border border-green-400/30 p-4 rounded-lg">
                  ...
                  <ul className="text-white space-y-2 text-sm">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>
                        Maximum user load typically 175&nbsp;kg (user + carried equipment)
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>
                        Must be used on all construction sites and in professional trade
                        environments
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>
                        Tested to more rigorous strength, stiffness, and durability standards
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-white/5 border border-red-400/30 p-4 rounded-lg">
                  ...
                  <ul className="text-white space-y-2 text-sm">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>Lower maximum load rating than Class 1</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>
                        <strong className="text-red-300">
                          NOT suitable for any professional, trade, or construction use
                        </strong>
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>
                        Often significantly cheaper — which is why they sometimes appear on sites
                        incorrectly
                      </span>
                    </li>
                  </ul>
              ...
              <p>
                The BS EN 131 marking is typically found on a label or sticker on the stile of the
                ladder. It will state the class, the maximum load rating, the standard reference (BS
                EN 131-2), and the manufacturer's information. If the label is missing or illegible,
                the ladder should not be used.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="border-l-2 border-amber-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white leading-relaxed">
              <p>
                ...
                responsibility — even if the ladder passed a formal inspection the previous day,
                conditions may have changed. Pre-use inspections take only a few minutes but can
              ...
              <div className="bg-white/5 border border-orange-500/30 p-4 rounded-lg">
                ...
                <ul className="text-white text-sm space-y-1">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      Attach a clear <strong className="text-white">"DO NOT USE"</strong> tag or
                      label
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>Report the defect to your supervisor or site manager</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      Never attempt to repair a damaged ladder yourself — repairs must be carried
                      out by the manufacturer or authorised repairer
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <p>
                Formal inspections (documented with records) should also be carried out at regular
                intervals as defined by your employer's policy — typically monthly or quarterly.
                These are in addition to the daily pre-use check carried out by the individual user.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white leading-relaxed">
              <p>
                ...
                <strong className="text-white">3 rungs (approximately 1 metre)</strong> above the
                landing point. This provides a secure handhold for the person stepping on and off
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                ...
                <p className="text-white text-sm leading-relaxed">
                  ...
                  transition from ladder to platform. This is one of the most critical rules for
                  ladder safety and one of the most commonly ignored on site.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white text-sm space-y-2">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      Position so the work is directly in front — never work from the side
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>Never stand on the top 2 treads of a swing-back stepladder</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      Do not use a stepladder as a leaning ladder unless it is a combination type
                      designed for that configuration
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>All four feet must be in contact with the ground at all times</span>
                  </li>
                </ul>
              </div>
            </div>
