...
const faqs = [
  {
    question: 'Why is collective protection always preferred over personal protection?',
    answer:
  ...
  {
    question: 'How often should safety nets be inspected once installed on site?',
    answer:
  ...
  {
    question: 'Are airbag fall arrest systems suitable for all types of work at height?',
    answer:
...
const quizQuestions = [
  ...
  {
    id: 2,
    question: 'What is the required height of the toe board on a guard rail system?',
    options: ['At least 50 mm', 'At least 100 mm', 'At least 150 mm', 'At least 200 mm'],
    correctAnswer: 2,
    explanation:
...
export default function WorkingAtHeightModule3Section1() {
  useSEO({
    title: 'Collective Fall Prevention | Module 3 Section 1 | Working at Height',
    description:
    ...
    <div className="overflow-x-hidden bg-[#1a1a1a]">
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <section className="mb-12">
          ...
          <div className="border-l-2 border-amber-500/30 pl-4 sm:pl-6 space-y-4">
            ...
            <p className="text-white text-sm sm:text-base leading-relaxed">
              ...
              accounts for a significant proportion of fall-from-height incidents.
            </p>
            ...
            <div className="rounded-xl border border-white/10 bg-white/[0.02] p-4">
              ...
              <p className="text-white text-sm leading-relaxed">
                ...
                reasonably practicable&rdquo; does not mean inconvenient or expensive; it means the
                cost, time, and effort of collective measures would be grossly disproportionate to
        ...
        <section className="mb-12">
          ...
          <div className="border-l-2 border-blue-500/30 pl-4 sm:pl-6 space-y-4">
            <p className="text-white text-sm sm:text-base leading-relaxed">
              ...
              slope of the working surface and the forces the system must withstand.
            </p>
            ...
            <p className="text-white text-sm sm:text-base leading-relaxed">
              ...
              ensuring nobody can slip between the rails.
            </p>
          </div>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="border-l-2 border-green-500/30 pl-4 sm:pl-6 space-y-4">
            ...
            <div className="space-y-4 mt-3">
              <div className="rounded-xl border border-white/10 bg-white/[0.02] p-4">
                <h4 className="text-white font-semibold text-sm mb-2">Free-Standing Systems</h4>
                <div className="space-y-2">
                  {[
        ...
        <section className="mb-12">
          ...
          <div className="border-l-2 border-purple-500/30 pl-4 sm:pl-6 space-y-4">
            <p className="text-white text-sm sm:text-base leading-relaxed">
              ...
              the fall through controlled deformation of the net mesh.
            </p>
        ...
        <section className="mb-12">
          ...
          <div className="border-l-2 border-cyan-500/30 pl-4 sm:pl-6 space-y-4">
            <p className="text-white text-sm sm:text-base leading-relaxed">
              ...
              slabs have not yet been cast or where services penetrations create fall hazards.
            </p>
            ...
            <div className="rounded-xl border border-cyan-500/20 bg-cyan-500/5 p-4">
              ...
              <p className="text-white text-sm leading-relaxed">
                ...
                work, you may encounter safety decking when running containment above suspended
                ceilings or pulling cables through floor voids in new-build projects.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6 space-y-4">
            ...
            <p className="text-white text-sm sm:text-base leading-relaxed">
              ...
              commonly used in steel erection and industrial roof work where safety netting may be
              impractical.
            </p>

            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="rounded-xl border border-rose-500/20 bg-rose-500/5 p-4">
                <h4 className="text-rose-400 text-sm font-semibold mb-2">Advantages</h4>
                <div className="space-y-2">
                  {[
              ...
              <div className="rounded-xl border border-rose-500/20 bg-rose-500/5 p-4">
                <h4 className="text-rose-400 text-sm font-semibold mb-2">Limitations</h4>
                <div className="space-y-2">
                  {[
        ...
        <section className="mb-12">
          ...
          <div className="border-l-2 border-amber-500/30 pl-4 sm:pl-6 space-y-4">
            <p className="text-white text-sm sm:text-base leading-relaxed">
              ...
              multiple trades to work safely at the same level without any personal fall protection
              equipment.
            </p>
        ...
        <section className="mb-12 rounded-xl border border-white/10 bg-white/[0.02] p-5 sm:p-6">
          <Quiz questions={quizQuestions} title="Section 1 Quiz — Collective Fall Prevention" />
        </section>
