...
const faqs = [
  {
    question: 'Will asking someone about suicide put the idea in their head?',
    answer:
  ...
  {
    question: 'How is a safety plan different from a crisis plan or a no-suicide contract?',
    answer:
  ...
  {
    question: 'What if I try to help someone and say the wrong thing?',
    answer:
...
const quizQuestions = [
  ...
  {
    id: 4,
    question: 'Which of the following scenarios would require an immediate 999 call?',
    options: [
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-white/80">
                ...
                <strong className="text-white">116 123</strong> (free to call). You can also text
                SHOUT to <strong className="text-white">85258</strong>. Take breaks as needed.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-purple-500/5 border-l-2 border-purple-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Ask directly:</strong> &ldquo;Are you thinking about suicide?&rdquo; &mdash;
                this saves lives
              </li>
              <li>
              ...
              <li>
                <strong>999:</strong> Active attempt, means + intent, or loss of consciousness
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-purple-500/5 border-l-2 border-purple-500/50">
            <p className="text-purple-400/90 text-base font-medium mb-2">Key Numbers</p>
            <ul className="text-base text-white space-y-1.5">
              <li>
              ...
              <li>
                <strong>Lighthouse Club:</strong> 0345 605 1956 (construction)
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                One of the most powerful things you can do as a mental health first aider is to ask
                someone directly if they are thinking about suicide. For many people, this feels
                terrifying &mdash; you may worry about making things worse, saying the wrong thing,
                or &ldquo;planting the idea&rdquo; in someone&rsquo;s head. But decades of research
                have consistently shown that{' '}
                <strong>
                  asking about suicide does not increase the risk of suicidal behaviour
                </strong>
                . In fact, it often has the opposite effect &mdash; it brings relief, reduces
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80 mb-3">
                  ...
                  asking about suicide causes or worsens suicidal thoughts. The World Health
                ...
                <p className="text-sm text-white/80">
                  ...
                  &ldquo;I see you. I take this seriously. You can talk to me.&rdquo;
                </p>
              </div>
                ...
                <div className="grid sm:grid-cols-2 gap-3">
                  <div className="bg-green-500/10 border border-green-500/30 p-3 rounded-lg">
                    ...
                    <ul className="text-xs text-white/80 space-y-1.5">
                      ...
                      <li className="flex items-start gap-2">
                        <span className="mt-1 w-1 h-1 rounded-full bg-green-400 flex-shrink-0" />
                        <span>&ldquo;Are you having thoughts of ending your life?&rdquo;</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1 w-1 h-1 rounded-full bg-green-400 flex-shrink-0" />
                        <span>&ldquo;Are you thinking about killing yourself?&rdquo;</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1 w-1 h-1 rounded-full bg-green-400 flex-shrink-0" />
                        <span>
                          &ldquo;Sometimes when people feel like this, they think about suicide. Is
                          that happening for you?&rdquo;
                        </span>
                      </li>
                    </ul>
                  </div>
                  <div className="bg-red-500/10 border border-red-500/30 p-3 rounded-lg">
                    ...
                    <ul className="text-xs text-white/80 space-y-1.5">
                      <li className="flex items-start gap-2">
                        ...
                        <span>
                          &ldquo;You&rsquo;re not thinking of doing anything silly, are you?&rdquo;
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                        <span>&ldquo;You wouldn&rsquo;t do anything stupid, would you?&rdquo;</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                        <span>&ldquo;You don&rsquo;t want to hurt yourself, do you?&rdquo;</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                        <span>
                          &ldquo;You&rsquo;re not thinking of checking out, are you?&rdquo;
                        </span>
                      </li>
                    </ul>
                  </div>
              ...
              <p>
                Euphemisms are problematic for several reasons. They <strong>minimise</strong> the
                seriousness of the person&rsquo;s experience (&ldquo;silly&rdquo; and
                &ldquo;stupid&rdquo; carry judgement). They are <strong>ambiguous</strong> &mdash;
                the person may not realise you are actually asking about suicide. And they{' '}
                <strong>lead the answer</strong> &mdash; phrasing a question as &ldquo;You
                wouldn&rsquo;t... would you?&rdquo; pressures the person to say &ldquo;no&rdquo;
                even when the answer is &ldquo;yes&rdquo;.
              </p>
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1.5 mb-3">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Making things worse (you won&rsquo;t &mdash; research confirms this)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      Not knowing what to say if they answer &ldquo;yes&rdquo; (listen, stay calm,
                      follow TASC)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      Getting it wrong (an imperfect question asked with care is infinitely better
                      than silence)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      Being responsible for the outcome (you are not &mdash; your role is to
                      support, not to fix)
                    </span>
                  </li>
                </ul>
                <p className="text-sm text-white/80">
                  ...
                  position than someone who has been asked directly and given the chance to talk.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The <strong>TASC model</strong> provides a clear, memorable framework for responding
                when you believe someone may be suicidal. It gives you a structured sequence of
                steps so that even under pressure, you know what to do next. TASC stands for:{' '}
                <strong>Tell</strong>, <strong>Ask</strong>, <strong>Safety plan</strong>,{' '}
                <strong>Call</strong>.
              </p>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                  ...
                  <div className="bg-black/30 rounded-lg p-3">
                    ...
                    <ul className="text-xs text-white/70 space-y-1">
                      ...
                      <li>
                        &ldquo;You mentioned feeling like a burden last week, and I haven&rsquo;t
                        stopped thinking about it.&rdquo;
                      </li>
                      <li>
                        &ldquo;I can see you&rsquo;re going through a really tough time. I want to
                        check in with you.&rdquo;
                      </li>
                    </ul>
                  </div>
                </div>
                ...
                <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-white/80 mb-3">
                    ...
                    things, and do not minimise what they are feeling.
                  </p>
                  <div className="bg-black/30 rounded-lg p-3">
                    ...
                    <ul className="text-xs text-white/70 space-y-1">
                      ...
                      <li>
                        &ldquo;I&rsquo;m glad you told me. You don&rsquo;t have to go through this
                        alone.&rdquo;
                      </li>
                      <li>Listen. Do not rush to solutions. Let them talk.</li>
                    </ul>
                  </div>
                </div>
                ...
                <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-white/80">
                    ...
                    practical steps they can take when suicidal thoughts return.
                  </p>
                </div>
                ...
                <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-white/80 mb-3">
                    ...
                    number. Offer to sit with them while they call, or ask permission to call on
                    their behalf.
                  </p>
                  <div className="bg-black/30 rounded-lg p-3">
                    ...
                    <ul className="text-xs text-white/70 space-y-1">
                      ...
                      <li>&ldquo;Can I help you make an appointment with your GP?&rdquo;</li>
                      <li>
                        &ldquo;I think we should call 999 together &mdash; I&rsquo;ll stay right
                        here with you.&rdquo;
                      </li>
                    </ul>
                  </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                A <strong>safety plan</strong> is a personalised, written document that a person at
                risk of suicide creates collaboratively with support from a trained helper. It
                identifies warning signs, coping strategies, and resources that the person can use
                when suicidal thoughts return. Unlike a &ldquo;no-suicide contract&rdquo; (which
                research has shown to be ineffective), a safety plan is a practical, evidence-based
                tool that empowers the person to take specific actions during a crisis.
              </p>
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1.5">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      They are created <strong className="text-white">with</strong> the person, not{' '}
                      <strong className="text-white">for</strong> them &mdash; this builds ownership
                      and agency
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      They provide concrete, actionable steps for a moment of crisis when thinking
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      They follow a stepped approach, starting with self-help and escalating to
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      Research published in <em>JAMA Psychiatry</em> shows that safety planning
                      reduces suicide attempts by approximately 43%
                    </span>
                  </li>
                </ul>
              </div>
                ...
                <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white/80 space-y-1.5">
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        Keep a physical copy in an easily accessible place (wallet, bedside table)
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-green-400 flex-shrink-0" />
                      <span>Save a digital copy on the person&rsquo;s phone</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-green-400 flex-shrink-0" />
                      <span>Share a copy with a trusted person if the individual consents</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-green-400 flex-shrink-0" />
                      <span>
                        The plan must be available at the moment of crisis &mdash; not locked away
                      </span>
                    </li>
                  </ul>
                </div>
                <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white/80 space-y-1.5">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                      <span>
                        Review after any crisis episode &mdash; what worked? What didn&rsquo;t?
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                      <span>
                        Update as circumstances change (new contacts, new coping strategies)
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                      <span>Review regularly even when things are going well</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                      <span>A safety plan is a living document, not a one-off exercise</span>
                    </li>
                  </ul>
                </div>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Not every suicidal crisis requires an immediate 999 call, but there are clear
                situations where calling emergency services is essential and should not be delayed.
                Understanding when to escalate to 999 is a critical skill for any mental health
                first aider. When in doubt, always err on the side of calling &mdash; it is better
                to call and find it was not needed than to hesitate and lose a life.
              </p>

              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                <div className="flex items-center gap-2 mb-3">
                  <AlertTriangle className="h-5 w-5 text-red-400" />
                  <p className="text-sm font-medium text-red-400">Call 999 Immediately If:</p>
                </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1.5">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Do not leave them alone</strong> while waiting
                      for emergency services. Your presence is protective.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Stay calm and speak in a steady, reassuring tone. Your calmness will help
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      If safe to do so, gently remove or distance any means of harm (e.g., move
                      tablets away, close windows).
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      If the person has taken an overdose, try to identify what they took, how much,
                      and when &mdash; the paramedics will need this information.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Keep the 999 operator on the line if possible &mdash; they can provide
                      real-time guidance until the ambulance arrives.
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Knowing the key helplines and resources is essential for any mental health first
                aider. You should be able to recall these numbers confidently and share them without
                hesitation. The following are the most important UK crisis support services relevant
                to the construction and electrical trades.
              </p>
              ...
              <div className="space-y-3">
                ...
                <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                  <div className="flex items-center justify-between mb-2">
                    <p className="text-sm font-semibold text-green-400">Samaritans</p>
                ...
                <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                  <div className="flex items-center justify-between mb-2">
                    <p className="text-sm font-semibold text-blue-400">SHOUT Crisis Text Line</p>
                ...
                <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                  <div className="flex items-center justify-between mb-2">
                    <p className="text-sm font-semibold text-amber-400">Papyrus HOPELINEUK</p>
                ...
                <div className="space-y-3">
                  <div className="bg-black/30 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70">
                      ...
                      physical demands, job insecurity, and the culture of &ldquo;getting on with
                      it&rdquo;.
                    </p>
                  </div>
                  <div className="bg-black/30 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70">
                      ...
                      related trades. Their website offers free resources for both individuals and
                      employers.
                    </p>
                  </div>
                </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Supporting someone through a suicidal crisis is one of the most emotionally intense
                experiences a person can have. After the immediate crisis has passed, two important
                things need attention: following up with the person you supported, and looking after
                your own wellbeing as the first aider.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1.5">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Check in within 24&ndash;48 hours</strong>{' '}
                      &mdash; a brief, low-pressure message: &ldquo;Just wanted to check in.
                      I&rsquo;m here if you need anything.&rdquo;
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Respect their boundaries</strong> &mdash; if
                      they do not want to talk about it, do not force the conversation. Simply let
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Do not treat them differently</strong> &mdash;
                      avoid walking on eggshells or constantly asking if they are OK. Treat them
                      normally whilst remaining available and attentive.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Maintain confidentiality</strong> &mdash; do
                      not discuss the person&rsquo;s crisis with colleagues or others unless it is
                      necessary for their safety or agreed with the person.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Gently encourage professional support</strong>{' '}
                      &mdash; ask if they have been able to contact their GP, a counsellor, or a
                      helpline. Offer practical help: &ldquo;Would you like me to come with you to
                      the appointment?&rdquo;
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1.5">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>Emotional numbness or feeling disconnected from others</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>Difficulty concentrating on work or daily tasks</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>Physical symptoms: headaches, stomach problems, muscle tension</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                ...
                <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white/80 space-y-1.5">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-green-400 flex-shrink-0" />
                      <span>
                        Speak to your line manager, MHFA coordinator, or occupational health team
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-green-400 flex-shrink-0" />
                      <span>Request a formal debrief if one is not offered automatically</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-green-400 flex-shrink-0" />
                      <span>
                        Use your organisation&rsquo;s Employee Assistance Programme (EAP) if
                        available
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-green-400 flex-shrink-0" />
                      <span>
                        Consider peer support &mdash; talking with another trained MHFA about the
                ...
                <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white/80 space-y-1.5">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                      <span>
                        It is OK to be affected &mdash; this does not mean you are not cut out for
                        the role
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                      <span>
                        Talk to someone you trust about how you feel (without breaching
                        confidentiality)
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                      <span>
                        Maintain your routine &mdash; eat, sleep, exercise, connect with people you
                        care about
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                      <span>
                        Remember: helplines are for helpers too. Call Samaritans on 116 123 if you
                        need to talk.
                      </span>
                    </li>
                  </ul>
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  &mdash; it is a sign that you take your role seriously and understand that looking
                  after yourself is essential to being able to look after others. You are not
                  responsible for another person&rsquo;s choices or outcomes. Your role is to
                  listen, to care, to connect them with support, and to be there. That is enough.
