...
const faqs = [
  ...
  {
    question: 'How often should Mental Health First Aiders receive supervision?',
    answer:
  ...
  {
    question: 'Can I step back from the MHFA role if it is affecting my own mental health?',
    answer:
...
const quizQuestions = [
  ...
  {
    id: 6,
    question: 'The five dimensions of the self-care wheel are:',
    options: [
...
export default function MentalHealthModule5Section4() {
  useSEO({
    title: 'Self-Care for the Mental Health First Aider | Mental Health Module 5.4',
    description:
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-purple-500/5 border-l-2 border-purple-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Self-care:</strong> Not selfish &mdash; it is essential for effective,
                sustainable support
              </li>
              <li>
                <strong>Compassion fatigue:</strong> Emotional exhaustion from repeated exposure to
                others&rsquo; distress
              </li>
              <li>
                <strong>Boundaries:</strong> Know your limits, say no without guilt, signpost to
                24/7 services
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-purple-500/5 border-l-2 border-purple-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Supervision:</strong> Regular, ideally monthly, with additional sessions
                after difficult conversations
              </li>
              <li>
                <strong>Reflective practice:</strong> What went well, what could improve, what did I
                learn
              </li>
              <li>
                <strong>Self-care wheel:</strong> Physical, emotional, social, professional,
                spiritual
              </li>
            </ul>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                There is a well-known analogy in aviation: in the event of an emergency, you must
                put on your own oxygen mask before helping others. The same principle applies to
                Mental Health First Aiders. You cannot effectively support others if you are running
                on empty yourself. Self-care is not a luxury or a sign of weakness &mdash; it is a{' '}
                <strong>professional responsibility</strong> that directly affects the quality and
                sustainability of the support you provide.
              </p>

              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-purple-400">The Oxygen Mask Analogy:</strong> You cannot
                  pour from an empty cup. If you neglect your own mental health, physical health,
                  and emotional wellbeing, you will eventually have nothing left to give. This is
                  not theory &mdash; it is a well-documented reality in all helping professions,
                  from counsellors and therapists to paramedics and social workers. Mental Health
                  First Aiders are no exception.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">MHFAs are not immune:</strong> Mental Health
                      First Aiders are human beings with their own mental health, their own
                      stresses, and their own vulnerabilities. Having the training and the title
                      does not make you invulnerable to the conditions you support others with.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Emotional toll:</strong> Listening to
                      colleagues&rsquo; distress, hearing disclosures of suicidal thoughts, abuse,
                      or trauma, and carrying the weight of others&rsquo; pain takes a genuine
                      emotional toll. Over time, this cumulative exposure can erode your own
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Preventing burnout:</strong> Without active
                      self-care, MHFAs are at significant risk of compassion fatigue, vicarious
                      trauma, and burnout. When this happens, the MHFA cannot function effectively
                      in the role, and the people who rely on them lose their primary source of
                      workplace support.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Dual role challenge:</strong> Most MHFAs carry
                      the MHFA responsibility on top of their normal job role. They are
                      electricians, engineers, site managers, or office workers first &mdash; and
                      MHFAs second. Balancing both demands requires deliberate self-care strategies.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-violet-400">Remember:</strong> Self-care is not selfish.
                  An MHFA who looks after themselves is not being self-indulgent &mdash; they are
                  protecting their ability to be there for others. If you burn out, you help nobody.
                  If you maintain your wellbeing, you can sustain your support for years to come.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                <strong>secondary traumatic stress</strong>. It is the emotional and physical
                exhaustion that develops from the cumulative effect of supporting others through
                their distress and traumatic experiences. Unlike general burnout, compassion fatigue
                is specifically linked to the empathetic helping relationship &mdash; it is the cost
                of caring.
              </p>
                  ...
                  <div className="bg-purple-500/5 border border-purple-500/20 p-3 rounded-lg">
                    ...
                    <ul className="text-xs text-white space-y-1.5">
                      ...
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          Reduced empathy &mdash; difficulty feeling compassion for those you
                          support
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                <strong>Vicarious trauma</strong> is the trauma experienced through exposure to
                other people&rsquo;s traumatic experiences. When an MHFA listens to detailed
                disclosures of suicide attempts, abuse, self-harm, or traumatic incidents, their
                brain processes elements of those experiences as though they were happening to them.
                Over time, this can fundamentally alter how the MHFA sees the world.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Changed worldview:</strong> After hearing
                      multiple accounts of suffering, MHFAs may develop a bleaker, more pessimistic
                      view of the world and of human nature. The world may start to feel less safe
                      than it did before.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Reduced sense of safety:</strong> Hearing about
                      others&rsquo; traumatic experiences can make the MHFA feel more vulnerable,
                      anxious, or hypervigilant in their own life. They may become overly protective
                      of their family or fearful of situations they previously felt comfortable in.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Intrusive thoughts:</strong> Images, sounds, or
                      details from others&rsquo; disclosures may intrude into the MHFA&rsquo;s
                      thoughts uninvited, particularly at night or during quiet moments.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Disrupted trust:</strong> Repeated exposure to
                      stories of harm, abuse, and exploitation can erode the MHFA&rsquo;s trust in
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Cumulative effect:</strong> Vicarious trauma is
                      cumulative. Each disclosure adds to the emotional burden. A single
                      conversation may not cause lasting harm, but the accumulation of many
                      conversations over months and years can have a profound impact.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-purple-400">Key Point:</strong> Vicarious trauma does not
                  mean you are weak or unsuited to the MHFA role. It means you are a empathetic
                  human being who has been exposed to the pain of others. Recognising it, naming it,
                  and seeking support for it is a sign of strength and self-awareness, not failure.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Boundaries are not walls &mdash; they are the sustainable limits that allow you to
                continue supporting others without destroying yourself in the process. Setting
                boundaries is one of the most important self-care skills an MHFA can develop.
              ...
              <div className="bg-white/5 border border-white/10 p-4 sm:p-6 rounded-lg">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <p className="text-sm font-medium text-purple-400">Boundary-Setting Strategies</p>
                </div>
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-violet-400">Remember:</strong> Boundaries protect both you
                  and the people you support. An MHFA who has no boundaries will eventually have
                  nothing left to give. An MHFA who maintains healthy boundaries can sustain their
                  role for years, providing consistent, high-quality support to many people over
                  time. Boundaries are an act of care, not an act of selfishness.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Supervision is not just for therapists. If you are in a role where you regularly
                support people through mental health difficulties, you need a structured system to
                process your experiences, reflect on your practice, and identify when you need
                additional support. Regular supervision is one of the most effective protective
                factors against compassion fatigue and vicarious trauma.
              </p>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <div className="flex items-center gap-2 mb-4">
                  <Users className="h-5 w-5 text-purple-400" />
                  <p className="text-sm font-medium text-purple-400">Types of Support for MHFAs</p>
                </div>
                <div className="space-y-3">
                  <div className="bg-purple-500/10 border border-purple-500/30 p-3 rounded-lg">
                    ...
                    <p className="text-sm text-white">
                      ...
                      challenging situations, and receive guidance. It is not performance management
                      &mdash; it is professional support.
                    </p>
                  </div>
                  <div className="bg-purple-500/10 border border-purple-500/30 p-3 rounded-lg">
                    ...
                    <p className="text-sm text-white">
                      ...
                      workplace has multiple MHFAs, regular group meetings are invaluable.
                    </p>
                  </div>
                  <div className="bg-purple-500/10 border border-purple-500/30 p-3 rounded-lg">
                    <p className="text-sm font-medium text-purple-400 mb-1">
                    ...
                    <p className="text-sm text-white">
                      ...
                      possible after the event and should cover both the practical aspects (what
                      happened, what actions were taken) and the emotional impact (how did it affect
                      you, what support do you need).
                    </p>
                  </div>
                  <div className="bg-purple-500/10 border border-purple-500/30 p-3 rounded-lg">
                    <p className="text-sm font-medium text-purple-400 mb-1">
                    ...
                    <p className="text-sm text-white">
                      ...
                      it is a sign that you are taking your wellbeing seriously and modelling good
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  programme that appoints people but provides no ongoing support is setting those
                  individuals up to fail &mdash; and potentially causing them harm.
                </p>
              </div>

              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-purple-400">Key Principle:</strong> Supervision is not
                  optional. It is not a sign of weakness or incompetence. Professional counsellors,
                  psychologists, and therapists all receive regular supervision throughout their
                  careers. If trained mental health professionals need supervision, Mental Health
                  First Aiders certainly do too.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Personal resilience is not about being tough or never struggling. It is about having
                the self-awareness, strategies, and support networks to navigate difficult
                experiences, recover from setbacks, and continue to function effectively. For MHFAs,
                building and maintaining personal resilience is an ongoing, active process &mdash;
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-3">Practical Self-Care Tools</p>
                <div className="grid sm:grid-cols-2 gap-3">
                  <div className="bg-purple-500/5 border border-purple-500/20 p-3 rounded-lg">
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  trauma that are not improving with self-care and supervision; dreading the role
                  rather than finding it meaningful; negative impact on your personal relationships,
                  physical health, or work performance; or significant personal life events that
                  require your full emotional capacity. Stepping back is not failure &mdash; it is
