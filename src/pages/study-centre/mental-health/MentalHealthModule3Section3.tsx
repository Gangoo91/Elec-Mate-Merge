...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    question: 'Which of the following is the single strongest predictor of future suicide?',
    options: [
...
const faqs = [
  {
    question: 'Should I ask someone directly if they are thinking about suicide?',
    answer:
  ...
  {
    question: 'What should I do if a colleague on site tells me they are having suicidal thoughts?',
    answer:
  ...
  {
    question: 'What is means restriction and why is it important in suicide prevention?',
    answer:
  ...
  {
    question: 'What helplines are available for someone in suicidal crisis in the UK?',
    answer:
...
const quizQuestions = [
  ...
  {
    id: 5,
    question: "The myth that 'talking about suicide encourages it' is:",
    options: [
...
export default function MentalHealthModule3Section3() {
  useSEO({
    title: 'Suicide Awareness & Prevention | Mental Health Module 3.3',
    description:
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-white/80">
                ...
                <strong className="text-purple-300">116 123</strong> (24/7) or text{' '}
                <strong className="text-purple-300">SHOUT</strong> to{' '}
                <strong className="text-purple-300">85258</strong>.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-purple-500/5 border-l-2 border-purple-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>~6,000</strong> suicides per year in the UK (ONS data)
              </li>
              <li>
                <strong>3 in 4</strong> suicides are male &mdash; highest rate in men aged
                45&ndash;49
              </li>
              <li>
                <strong>Construction:</strong> 3.7&times; the national average suicide rate for men
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-purple-500/5 border-l-2 border-purple-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Ask directly:</strong> &ldquo;Are you thinking about suicide?&rdquo; saves
                lives
              </li>
              <li>
                <strong>Means restriction:</strong> control access to heights, substances, tools
              </li>
              <li>
                <strong>Connect:</strong> check in on mates &mdash; social connection is protective
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Suicide is a significant public health issue in the United Kingdom. Understanding
                the scale and patterns of suicide is essential for anyone working in a Mental Health
                First Aid role, particularly in high-risk industries such as construction.
              </p>
              ...
              <div className="bg-red-500/10 border-2 border-red-500/40 p-5 rounded-lg">
                ...
                <p className="text-sm text-white/80 mb-4">
                  ...
                  <strong className="text-white">3.7 times more likely to die by suicide</strong>{' '}
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-purple-400">Why This Matters for You:</strong> As someone
                  working in the construction industry and training in Mental Health First Aid, you
                  are in a uniquely important position. You work alongside the demographic group
                  most affected by suicide. Your awareness, your willingness to have difficult
                  conversations, and your ability to spot warning signs could genuinely save a life.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Risk factors are characteristics or circumstances that increase the likelihood of
                suicidal behaviour. No single risk factor causes suicide — it is usually a
                combination of factors that overwhelms a person&rsquo;s capacity to cope.
                Understanding these factors helps the MHFA identify people who may be at elevated
                risk and offer early support.
              </p>
                  ...
                  {[
                    ...
                    <div
                      ...
                      className={`flex items-start gap-3 p-2 rounded-lg ${
                        item.highlight ? 'bg-red-500/10 border border-red-500/30' : ''
                      }`}
                    >
                      <span
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-purple-400">Important:</strong> Risk factors are not a
                  checklist. A person may have several risk factors and never become suicidal.
                  Equally, a person may have few obvious risk factors and still be at risk. Risk
                  factors help you be more aware, but they do not replace the importance of actually
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Protective factors are characteristics and circumstances that reduce the likelihood
                of suicidal behaviour. While risk factors increase vulnerability, protective factors
                build resilience. As a Mental Health First Aider, strengthening protective factors
                is just as important as identifying risk factors.
              </p>
              ...
              <div className="grid sm:grid-cols-2 gap-3">
                {[
                  ...
                  <div key={i} className={`${item.bg} border ${item.border} p-4 rounded-lg`}>
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-purple-400">Your Role as MHFA:</strong> Every time you
                  check in on a colleague, include someone in a conversation, or foster a sense of
                  team belonging on site, you are strengthening protective factors. These everyday
                  interactions are genuine suicide prevention — they keep people connected and
                  reduce the isolation that is so dangerous.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Warning signs are observable changes in behaviour, speech, or mood that may indicate
                someone is considering suicide. Not everyone who is suicidal will show warning
                signs, but most people do give some indication — the key is knowing what to look for
              ...
              <div className="bg-red-500/10 border-2 border-red-500/40 p-5 rounded-lg">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <p className="text-base font-bold text-red-400">Warning Signs to Watch For</p>
                </div>
                  ...
                  {[
                    ...
                    >
                      ...
                      <div>
                        <p
                          className={`text-sm font-medium ${
                            item.severity === 'high' ? 'text-red-300' : 'text-white'
                          }`}
                        >
                          {item.sign}
                        </p>
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-purple-400">Critical Point:</strong> Be particularly alert
                  to <strong>sudden calmness after a period of depression</strong>. This can
                  indicate that the person has made a decision and feels a sense of relief — not
                  that they are &ldquo;getting better.&rdquo; It can be the most dangerous phase. If
                  a colleague who has been visibly struggling suddenly appears peaceful and
                  resolved, do not assume the crisis has passed — check in with them directly.
                </p>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Myths and misconceptions about suicide are widespread and dangerous. They prevent
                people from seeking help, discourage others from intervening, and contribute to the
                stigma that surrounds suicidal distress. As a Mental Health First Aider, you must be
                able to challenge these myths with evidence-based facts.
              </p>
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-purple-400">Key Takeaway:</strong> The single most
                  important myth to challenge is the belief that talking about suicide encourages
                  it. This myth stops people from having the conversations that could save lives.
                  The evidence is clear:{' '}
                  <strong>
                    asking someone directly about suicidal thoughts is one of the most important
                    things you can do
                  </strong>
                  . It shows the person that someone has noticed, someone cares, and someone is
                  willing to listen.
                </p>
              </div>
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-red-300">
                        &ldquo;Only people with mental health conditions die by suicide&rdquo;
                      </strong>{' '}
                      &mdash; FALSE. While mental health conditions are a risk factor, many people
                      who die by suicide do not have a diagnosed condition. Life events such as
                      relationship breakdown, financial crisis, or bereavement can trigger suicidal
                      thoughts in anyone.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-red-300">
                        &ldquo;Suicide only affects certain types of people&rdquo;
                      </strong>{' '}
                      &mdash; FALSE. Suicide affects people of all ages, backgrounds, ethnicities,
                      and socioeconomic groups. It can affect your colleague, your friend, your
                      family member, or you.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <Ban className="h-4 w-4 text-red-400 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong className="text-red-300">
                        &ldquo;If someone is going to do it, they will find a way regardless&rdquo;
                      </strong>{' '}
                      &mdash; FALSE. Most suicidal crises last minutes to hours. If the person
                      cannot access a lethal method during that window, the crisis often passes.
                      This is why means restriction is so effective.
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                <strong>Means restriction</strong> is the strategy of reducing access to the methods
                by which people die by suicide. It is one of the most effective and evidence-based
                suicide prevention strategies available. The principle is straightforward: if a
                person in suicidal crisis cannot access a lethal method, the crisis frequently
                passes without a suicide attempt.
              </p>
              ...
              <div className="bg-green-500/10 border-2 border-green-500/40 p-5 rounded-lg">
                ...
                <div className="text-sm text-white/80 space-y-3">
                  <p>
                    ...
                    acute suicidal intent often lasts only minutes to hours. During this window, the
                    person may act impulsively — but if the means are not readily available, the
                    impulse frequently passes.
                  </p>
                  <p>
                    Studies of survivors of serious suicide attempts consistently show that many
                    people <strong className="text-white">do not go on to die by suicide</strong>.
                    The crisis was temporary, even though it felt permanent at the time. Restricting
                    access to means during the critical window saves lives.
                  </p>
                  <p>
                    Critically, when access to one method is restricted, people generally{' '}
                    <strong className="text-white">do not simply switch to another method</strong>.
                    This &ldquo;method substitution&rdquo; is far less common than many people
                    assume.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <div className="text-sm text-white/80 space-y-3">
                  <p>
                    ...
                    substances. As an MHFA, you should be aware of the following:
                  </p>
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                ...
                <div className="text-sm text-white/80 space-y-2">
                  <p>
                    ...
                    awareness and encouraging site management to consider suicide prevention as part
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-violet-400">Remember:</strong> Means restriction is not
                  about eliminating every possible risk — that would be impossible on a construction
                  site. It is about making it harder for a person to act on a suicidal impulse
                  during the brief window of acute crisis. Even small barriers — a locked gate, a
                  secured store, edge protection left in place overnight — can be the difference
