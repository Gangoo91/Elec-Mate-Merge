...
export default function MentalHealthModule5Section3() {
  useSEO({
    title: 'Building a Mentally Healthy Workplace | Mental Health Module 5.3',
    description:
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-purple-500/5 border-l-2 border-purple-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Five Ways:</strong> Connect, Be Active, Take Notice, Keep Learning, Give
              </li>
              <li>
                <strong>Policy:</strong> Every workplace needs a written mental health policy
              </li>
              <li>
                <strong>Toolbox Talks:</strong> Frame mental health as a safety issue, not a
                weakness
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-purple-500/5 border-l-2 border-purple-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Presenteeism:</strong> Costs 1.5&ndash;2x more than absenteeism
              </li>
              <li>
                <strong>Exercise:</strong> 30&ndash;45 mins, 3&ndash;5x per week improves mood
              </li>
              <li>
                <strong>Equality Act:</strong> Mental health conditions can be disabilities
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The <strong>Five Ways to Wellbeing</strong> is an evidence-based framework developed
                by the <strong>New Economics Foundation (NEF)</strong> as part of the UK
                Government&rsquo;s Foresight Project on Mental Capital and Wellbeing. It identifies
                five simple, evidence-based actions that individuals can take every day to improve
                their mental wellbeing. When adopted at a workplace level, these five actions form
                the foundation of a mentally healthy work environment.
              </p>
              ...
              <div className="space-y-3">
                ...
                <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-white/80 mb-2">
                    ...
                    can improve mental wellbeing and help people respond more effectively to stress.
                  </p>
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    <p className="text-xs font-medium text-white mb-1.5">Workplace Examples:</p>
                    <ul className="text-xs text-white/70 space-y-1">
                ...
                <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-white/80 mb-2">
                    ...
                    simply reading about a topic of interest all count.
                  </p>
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    <p className="text-xs font-medium text-white mb-1.5">Workplace Examples:</p>
                    <ul className="text-xs text-white/70 space-y-1">
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-purple-400">Why It Works:</strong> The Five Ways to
                  Wellbeing are based on robust evidence from across the behavioural sciences. Each
                  of the five actions has been shown to improve subjective wellbeing independently.
                  When combined, they create a powerful framework for building and maintaining good
                  mental health. Importantly, they are free, accessible, and can be practised by
                  anyone, regardless of their starting point.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Every workplace should have a written <strong>mental health policy</strong>. Just as
                organisations have policies for physical health and safety, a mental health policy
                sets out the organisation&rsquo;s commitment to supporting the mental wellbeing of
                its employees. It provides a framework for prevention, early intervention, and
                support, and ensures consistency in how mental health issues are handled across the
                organisation.
              </p>
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-purple-400">Important:</strong> A mental health policy is
                  only as good as its implementation. Writing a policy and filing it away achieves
                  nothing. Senior leaders must champion it, line managers must be trained to use it,
                  and employees must know it exists and how to access it. The policy should be a
                  living document that drives genuine cultural change, not a tick-box exercise.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Toolbox talks are short, focused safety briefings that are already a familiar part
                of construction site culture. They are typically delivered at the start of a shift
                and last 10&ndash;15 minutes. Adapting this well-established format for mental
                health topics is one of the most effective ways to normalise conversations about
                mental wellbeing in male-dominated construction environments.
              </p>

              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                <div className="flex items-center gap-2 mb-3">
                  <MessageSquare className="h-5 w-5 text-purple-400" />
                  <p className="text-sm font-medium text-purple-400">Example Toolbox Talk Topics</p>
                </div>
                <div className="grid sm:grid-cols-2 gap-2">
                  {[
                    {
                      ...
                      detail:
                        'Recognising the signs of stress in yourself and others, the difference between pressure and stress, practical coping strategies',
                    },
                    {
                      topic: 'Suicide Prevention',
                      detail:
                        "Construction suicide statistics, warning signs, how to have a conversation if you're worried about someone, helpline numbers",
                    },
                    {
                      topic: 'Substance Misuse',
                      detail:
                        'Alcohol and drugs as coping mechanisms, the impact on mental health and safety, where to get confidential help',
                    },
                    {
                      topic: 'Where to Get Help',
                      detail:
                        'GP, EAP, Samaritans (116 123), Shout (text SHOUT to 85258), Mates in Mind, Lighthouse Charity',
                    },
                    {
                      topic: 'Sleep and Mental Health',
                      detail:
                        'How poor sleep affects mood and concentration, sleep hygiene tips, the safety risk of fatigue on site',
                    },
                    {
                      topic: 'Financial Wellbeing',
                      detail:
                        'Money worries and mental health, budgeting basics, free debt advice services, avoiding loan sharks',
                    },
                  ].map((item, i) => (
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                ...
                <div className="text-sm text-white/80 space-y-2">
                  <p>
                    ...
                    weakness, self-reliance &mdash; can create significant barriers to talking about
                    mental health. Overcoming this requires a considered approach:
                  </p>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Creating a workplace culture where people feel safe to talk about mental health is
                essential. Openness does not mean forcing people to share their personal
                difficulties &mdash; it means creating an environment where they{' '}
                <strong>can</strong> if they choose to, without fear of judgement, discrimination,
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                ...
                <div className="text-sm text-white/80 space-y-2">
                  <p>
                    ...
                    their own experiences &mdash; it sends a powerful signal that mental health is
                    taken seriously.
                  </p>
                  <ul className="space-y-1.5">
                    {[
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="text-sm text-white/80 space-y-2">
                  <p>
                    ...
                    health challenge, it shows others that they are not alone and that it is
                    possible to recover and thrive.
                  </p>
                  <div className="bg-amber-500/10 border border-amber-500/30 p-3 rounded-lg">
                    <p className="text-sm text-white">
                      <strong className="text-amber-400">Consent is Essential:</strong> Stories
                      should only ever be shared with the full, informed consent of the person
                      involved. They should have control over what is shared, with whom, and in what
                      format. No one should ever feel pressured to share their story, and they
                      should be able to withdraw consent at any time.
                    </p>
                  </div>
                </div>
              </div>
                    ...
                    {[
                      {
                        ...
                        detail:
                          'Global awareness day set by the WHO — a chance to highlight workplace mental health initiatives',
                      },
                      {
                        event: 'Time to Talk Day',
                        date: 'First Thursday in February',
                        detail:
                          'Run by Time to Change / Mind — encourages people to have a conversation about mental health',
                      },
                      {
                        event: 'Mental Health Awareness Week',
                        date: 'May each year (set by the Mental Health Foundation)',
                        detail:
                          'A full week of awareness activities — workplaces can run events, toolbox talks, and campaigns',
                      },
                      {
                        event: 'Movember',
                        date: 'November',
                        detail:
                          "Focuses on men's mental health and suicide prevention — particularly relevant in construction",
                      },
                    ].map((item, i) => (
                      <div key={i} className="bg-white/5 border border-white/10 p-3 rounded-lg">
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-purple-400">Normalising Conversations:</strong> The
                  ultimate goal is to make asking &ldquo;How are you doing &mdash; really?&rdquo; as
                  natural as asking &ldquo;Have you done your risk assessment?&rdquo;. Mental health
                  should not be treated as a special topic that requires a special event &mdash; it
                  should be woven into everyday workplace culture through regular conversations,
                  visible support, and consistent messaging that it is acceptable to not be
                  acceptable.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                <strong>Presenteeism</strong> is the practice of attending work while unwell &mdash;
                physically or mentally &mdash; resulting in reduced productivity and increased risk.
                Research consistently shows that presenteeism costs UK employers significantly more
                than absenteeism, yet it receives far less attention because the employee is
                physically present.
              </p>
              ...
              <div className="bg-red-500/10 border-2 border-red-500/40 p-5 rounded-lg">
                ...
                <p className="text-sm text-white/80 mt-3">
                  ...
                  presenteeism goes largely unmeasured and unaddressed.
                </p>
              </div>
                  ...
                  {[
                    {
                      ...
                      detail:
                        'Where possible, offer flexible start and finish times, part-time arrangements, or the ability to work from home for office-based tasks. For site-based workers, consider flexible shift patterns or shorter days during recovery periods.',
                    },
                    {
                      strategy: 'Phased Return to Work',
                      detail:
                        'After a period of absence, allow employees to return gradually — starting with reduced hours and building up over weeks. This is more effective than an immediate full-time return and reduces the risk of relapse.',
                    },
                    {
                      strategy: 'Reasonable Adjustments Under the Equality Act 2010',
                      detail:
                        'For employees with mental health conditions that qualify as disabilities (substantial, long-term effect on daily activities), employers have a legal duty to make reasonable adjustments. This may include modified duties, altered working hours, additional breaks, or changes to the work environment.',
                    },
                    {
                      strategy: 'Line Manager Training',
                      detail:
                        'Train line managers to recognise the signs of presenteeism, have supportive conversations, and take action early. Managers are the most important link between policy and practice.',
                    },
                    {
                      strategy: 'Early Intervention',
                      detail:
                        "Address problems early before they escalate. Regular check-ins, access to occupational health, and a culture where it is acceptable to say 'I'm not coping' all contribute to catching issues before they become crises.",
                    },
                  ].map((item, i) => (
                    <div key={i} className="bg-white/5 border border-white/10 p-3 rounded-lg">
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-purple-400">Construction Context:</strong> Presenteeism is
                  particularly dangerous in construction because the work is physically demanding
                  and often involves working at height, with electricity, or with heavy machinery.
                  An electrician who is distracted by depression, exhausted from insomnia, or
                  impaired by anxiety is a safety risk to themselves and to everyone around them.
                  Encouraging people to take time to recover properly is not a luxury &mdash; it is
                  a safety measure.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Physical and mental health are deeply interconnected. Physical health problems
                increase the risk of mental health difficulties, and mental health problems increase
                the risk of physical illness. This <strong>whole-person approach</strong> recognises
                that you cannot effectively address one without considering the other, and that
                workplace health initiatives should encompass both.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="text-sm text-white/80 space-y-2">
                  <p>
                    ...
                    workers due to the physical demands of the trade &mdash; musculoskeletal
                    injuries, back pain, and joint problems are widespread.
                  </p>
                  <ul className="space-y-1.5">
                    {[
                    ...
                    {[
                      {
                        ...
                        examples:
                          'Exercise facilities or gym discounts, healthy eating options in canteens, manual handling training, ergonomic assessments',
                        colour: 'text-green-400',
                        bg: 'bg-green-500/10',
                        border: 'border-green-500/30',
                      },
                      {
                        area: 'Mental Health',
                        examples:
                          'EAP access, Mental Health First Aiders, stress management training, resilience workshops, manager training',
                        colour: 'text-purple-400',
                        bg: 'bg-purple-500/10',
                        border: 'border-purple-500/30',
                      },
                      {
                        ...
                        examples:
                          'Team events, buddy systems, mentoring programmes, inclusive workplace culture, recognition and appreciation',
                        colour: 'text-blue-400',
                        bg: 'bg-blue-500/10',
                        border: 'border-blue-500/30',
                      },
                      {
                        ...
                        examples:
                          'Flexible working where possible, realistic workload management, proper breaks enforced, annual leave encouraged, travel time considered',
                        colour: 'text-amber-400',
                        bg: 'bg-amber-500/10',
                        border: 'border-amber-500/30',
                      },
                  ...
                  {[
                    {
                      ...
                      detail:
                        'Subsidised gym memberships, on-site fitness equipment, lunchtime walking groups, or workplace sports teams. Even simple measures like providing a secure place to store bikes encourage active commuting.',
                    },
                    {
                      initiative: 'Healthy Eating Options',
                      detail:
                        'Healthy options in canteens and vending machines, free fruit in welfare facilities, access to clean drinking water, and reducing reliance on sugary drinks and processed snacks common on construction sites.',
                    },
                    {
                      initiative: 'Sleep Hygiene Education',
                      detail:
                        'Toolbox talks on the importance of sleep, practical tips for improving sleep quality, awareness of the impact of shift patterns and early starts on sleep, and consideration of travel time when planning shift schedules.',
                    },
                    {
                      initiative: 'Substance Awareness Programmes',
                      detail:
                        'Education about the mental health impact of alcohol and drug use, confidential support for those struggling with substance misuse, clear referral pathways to specialist services, and a non-punitive approach that encourages help-seeking.',
                    },
                    {
                      initiative: 'Health Checks and Screening',
                      detail:
                        'On-site health checks (blood pressure, BMI, cholesterol), mental health screening tools, occupational health assessments, and referral pathways to GPs for identified health concerns.',
                    },
                  ].map((item, i) => (
                    <div
                      key={i}
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-purple-400">The Business Case:</strong> Research by
                  Deloitte found that for every &pound;1 spent on workplace mental health
                  interventions, employers receive an average return of &pound;5.30 in reduced
                  absence, presenteeism, and staff turnover. Investing in employee wellbeing is not
                  just the right thing to do &mdash; it makes clear business sense. The most
                  effective employers understand that a healthy workforce is a productive workforce,
                  and that physical and mental health are inseparable.
                </p>
              </div>
            </div>
          </div>
