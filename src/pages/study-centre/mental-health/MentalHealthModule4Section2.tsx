...
const faqs = [
  ...
  {
    question: 'What is BEAT and how can they help?',
    answer:
  ...
  {
    question: 'How should I respond if a colleague tells me they have an eating disorder?',
    answer:
  ...
  {
    question: 'Are eating disorders really common in men who work in construction?',
    answer:
  ...
  {
    question: 'What is the difference between normal dieting and an eating disorder?',
    answer:
...
const quizQuestions = [
  ...
  {
    id: 3,
    question: 'Approximately what percentage of people with eating disorders in the UK are male?',
    options: ['5%', '10%', '25%', '50%'],
    correctAnswer: 2,
    explanation:
  ...
  {
    id: 7,
    question: 'Which of the following physical health risks is associated with eating disorders?',
    options: [
...
export default function MentalHealthModule4Section2() {
  useSEO({
    title: 'Eating Disorders | Mental Health First Aid Module 4.2',
    description:
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-purple-500/5 border-l-2 border-purple-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Serious illness:</strong> Highest mortality rate of any mental health
                condition
              </li>
              <li>
                <strong>Not a choice:</strong> Complex mental illness, not a lifestyle decision
              </li>
              <li>
                <strong>Anyone affected:</strong> 1.25 million people in UK, 25% are male
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-purple-500/5 border-l-2 border-purple-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Recognise:</strong> Avoiding meals, excessive exercise, weight changes,
                fatigue
              </li>
              <li>
                <strong>Approach:</strong> Private, non-judgemental &mdash; focus on wellbeing, not
                weight
              </li>
              <li>
                <strong>Support:</strong> BEAT helpline 0808 801 0677, GP referral
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Eating disorders are <strong>serious mental illnesses</strong> characterised by a
                persistent disturbance of eating behaviour and the associated distressing thoughts
                and emotions. They are <strong>not a lifestyle choice</strong>, a phase, a diet gone
                too far, or a bid for attention. They are complex conditions with biological,
                psychological, and social contributing factors that require specialist treatment.
              </p>
              ...
              <div className="bg-red-500/10 border-2 border-red-500/40 p-5 rounded-lg">
                ...
                <p className="text-sm text-white mb-3">
                  ...
                  . Deaths result from the direct physical consequences of malnutrition and
                  starvation (cardiac arrest, organ failure, electrolyte imbalances) and from
                  suicide, as people with eating disorders have a significantly elevated risk of
                ...
                <p className="text-sm text-white">
                  ...
                  eating disorder. The true figure is likely higher due to the secrecy and shame
                  that surround these conditions, meaning many people never seek help or receive a
                  diagnosis.
                </p>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                There are several clinically recognised eating disorders, each with distinct
                features, though they share common themes of distress around food, eating, body
                weight, and body shape. It is important to understand the differences, as the
                support and treatment approaches vary.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="text-sm text-white space-y-3">
                  <p>
                    ...
                    distorted body image where the person perceives themselves as larger than they
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="text-sm text-white space-y-3">
                  <p>
                    ...
                    is typically carried out in secret, and the person often feels intense shame and
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="text-sm text-white space-y-3">
                  <p>
                    ...
                    similar time period, accompanied by a sense of loss of control. Unlike Bulimia,
                    the person does not regularly purge after bingeing.
                  </p>
                  <ul className="space-y-1.5">
                    {[
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Eating disorders have historically been stereotyped as a &ldquo;female
                disorder,&rdquo; but this is a dangerous myth that leads to widespread
                under-recognition and delayed help-seeking in men. In male-dominated industries like
                construction, the problem is compounded by workplace culture, physical job demands,
                and the stigma around discussing mental health.
              </p>
              ...
              <div className="bg-purple-500/10 border-2 border-purple-500/40 p-5 rounded-lg">
                ...
                <p className="text-sm text-white mb-3">
                  ...
                  . However, experts believe this is a significant underestimate. Men are less
                  likely to recognise their symptoms as an eating disorder, less likely to seek
                ...
                <p className="text-sm text-white">
                  ...
                  disorders among men and boys in recent years.
                </p>
              </div>
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-purple-400">Breaking the Stigma:</strong> If you are a man
                  struggling with your relationship with food, exercise, or your body, you are not
                  alone and you are not weak. Eating disorders are mental illnesses that require
                  treatment, not willpower. The BEAT helpline (0808 801 0677) is available to
                  everyone regardless of gender, and their website has specific resources for men
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Eating disorders can cause devastating damage to virtually every organ system in the
                body. Many of these complications are directly life-threatening. Understanding these
                risks helps to reinforce that eating disorders are serious medical conditions, not
                trivial concerns about food and weight.
              </p>
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-purple-400">Refeeding Syndrome:</strong> When someone who
                  has been severely malnourished begins to eat again, there is a risk of{' '}
                  <strong className="text-white">refeeding syndrome</strong> &mdash; a potentially
                  fatal condition caused by rapid shifts in electrolytes (particularly phosphate) as
                  the body transitions from a catabolic to an anabolic state. This is why refeeding
                  must be done gradually and under medical supervision. You should{' '}
                  <strong className="text-white">never</strong> try to force someone with a
                  suspected eating disorder to eat.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                People with eating disorders are often very skilled at hiding their condition.
                However, there are behavioural and physical signs that may indicate a colleague is
                struggling. It is important to remember that no single sign is diagnostic &mdash; it
                is a <strong>pattern of changes</strong> over time that should raise concern.
              </p>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  to carry loads safely or maintain grip. Poor concentration from low blood sugar
                  increases the risk of errors and accidents. If you notice a colleague showing
                  signs of physical impairment that may be related to an eating disorder, there is a
                  duty of care to address the situation &mdash; their safety and the safety of
                  others is at stake.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  several signs occurring together or a noticeable{' '}
                  <strong className="text-white">change</strong> from someone's normal behaviour
                  over time. If you are concerned, the appropriate response is a gentle, private
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                If you are concerned about a colleague, approaching them with care, empathy, and
                sensitivity can make a significant difference. Many people with eating disorders
                feel trapped and alone, and a compassionate conversation can be the first step
                towards seeking help. How you approach the conversation matters enormously.
              </p>
                ...
                <div className="p-4 space-y-3">
                  ...
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    ...
                    <p className="text-sm text-white">
                      ...
                      service as early as possible &mdash; early intervention significantly improves
                      outcomes.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    ...
                    <p className="text-sm text-white">
                      ...
                      Specialist Supportive Clinical Management (SSCM), or family-based therapy.
                      NICE guidelines recommend that treatment should be delivered by professionals
                      with eating disorder expertise.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    ...
                    <ul className="text-sm text-white space-y-1">
                      <li className="flex items-start gap-2">
                        ...
                        <span>
                          ...
                          &mdash; for anyone in emotional distress
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong className="text-white">Men Get Eating Disorders Too:</strong>{' '}
                          mengetedstoo.co.uk &mdash; resources specifically for men
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong className="text-white">Mind:</strong> mind.org.uk &mdash;
                          comprehensive information on eating disorders and mental health
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong className="text-white">Mates in Mind:</strong> matesinmind.org
                          &mdash; mental health support specifically for the construction industry
                        </span>
                      </li>
                    </ul>
                  </div>
              ...
              <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  , even after many years of illness. Recovery is a process that takes time,
                  professional support, and patience. It is not a straight line &mdash; there will
                  be setbacks. But with the right treatment and support, people do recover and go on
                  to live full, healthy lives. As a mental health first aider, holding on to this
                  hope and communicating it to others is one of the most valuable things you can do.
                </p>
              </div>

              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-purple-400">NICE Guidelines:</strong> The National
                  Institute for Health and Care Excellence (NICE) publishes evidence-based
                  guidelines for the recognition and treatment of eating disorders (NG69). Key
                  recommendations include: do not use BMI alone to determine the severity of an
                  eating disorder; refer to specialist eating disorder services as early as
                  possible; offer evidence-based psychological therapies delivered by eating
                  disorder specialists; and monitor physical health throughout treatment. People
                  with eating disorders should not be required to reach a certain weight or BMI
                  threshold before receiving treatment.
                </p>
              </div>
            </div>
          </div>
