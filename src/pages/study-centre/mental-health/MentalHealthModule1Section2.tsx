...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    question: 'Under what circumstances can a Mental Health First Aider break confidentiality?',
    options: [
...
const faqs = [
  ...
  {
    question: 'What is the difference between an Employee Assistance Programme (EAP) and an MHFA?',
    answer:
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-purple-500/5 border-l-2 border-purple-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>MHFA:</strong> Spot signs, provide initial support, guide to professional
                help
              </li>
              <li>
                <strong>ALGEE:</strong> Approach, Listen, Give reassurance, Encourage professional
                help, Encourage other supports
              </li>
              <li>
                <strong>Not a therapist:</strong> Do not diagnose, treat, or counsel
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-purple-500/5 border-l-2 border-purple-500/50">
            <p className="text-purple-400/90 text-base font-medium mb-2">Key Boundaries</p>
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Confidential:</strong> Only break when there is immediate risk of serious
                harm
              </li>
              <li>
                <strong>Voluntary:</strong> No specific UK legislation governs the MHFA role
              </li>
              <li>
                <strong>Refer:</strong> GP, EAP, Samaritans (116 123), crisis services
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                A Mental Health First Aider (MHFA) is someone who has completed a training course
                approved by <strong>MHFA England</strong> &mdash; the national authority for Mental
                Health First Aid in England. The concept originated in Australia in 2000, created by
                Betty Kitchener and Professor Tony Jorm, and was introduced to England in 2007.
              </p>

              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-purple-400">MHFA England Definition:</strong> A Mental
                  Health First Aider is trained to{' '}
                  <strong>spot the early signs and symptoms</strong> of mental ill health,{' '}
                  <strong>provide initial support</strong> through non-judgemental listening and
                  reassurance, and{' '}
              ...
              <p>
                The role is analogous to a physical first aider. Just as a workplace first aider is
                not a doctor or paramedic, a Mental Health First Aider is{' '}
                <strong>not a therapist, counsellor, psychologist, or psychiatrist</strong>. They
                provide the crucial first response &mdash; a bridge between noticing that someone is
                struggling and connecting them with the professional support they need.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Spot the signs</strong> &mdash; Recognise
                      changes in behaviour, mood, or performance that may indicate mental ill
                      health. This includes withdrawal from social interaction, changes in
                      appearance, increased absence, irritability, or uncharacteristic behaviour.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-0.5 w-6 h-6 rounded-full bg-purple-500/20 border border-purple-500/40 flex items-center justify-center flex-shrink-0 text-xs font-bold text-purple-400">
                    ...
                    <span>
                      <strong className="text-white">Provide initial support</strong> &mdash; Have a
                      supportive, non-judgemental conversation. Offer reassurance, reduce stigma,
                      and let the person know they are not alone. Provide practical information
                      about mental health and available support.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-0.5 w-6 h-6 rounded-full bg-purple-500/20 border border-purple-500/40 flex items-center justify-center flex-shrink-0 text-xs font-bold text-purple-400">
                    ...
                    <span>
                      <strong className="text-white">Guide towards help</strong> &mdash; Encourage
                      the person to seek professional support. Signpost to their GP, Employee
                      Assistance Programme (EAP), Samaritans, Mind, or other relevant services.
                      Support them in taking that first step.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  than the male national average. Electricians and other trades workers often face
                  long hours, job insecurity, physically demanding work, time away from family, and
                  a culture where discussing mental health is still stigmatised. Having trained
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The <strong>ALGEE action plan</strong> is the core framework taught on the MHFA
                England course. It provides a structured, step-by-step approach for responding when
                you believe someone may be experiencing a mental health issue or crisis. The acronym
                stands for:
              </p>

              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-purple-400">Key Principle:</strong> ALGEE is not a rigid
                  sequence that must always be followed in strict order. In a crisis (e.g. active
                  suicidal intent), you may need to start with &lsquo;A&rsquo; and stay there. In a
                  non-crisis situation, you might move through all five steps across several
                  conversations. Use your judgement and adapt to the situation.
                </p>
              </div>
              ...
              <div className="space-y-3">
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-1">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>Are they experiencing a panic attack or acute distress?</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>Are they at risk of harm from themselves or others?</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-1">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Use open body language &mdash; face them, maintain appropriate eye contact,
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Use minimal encouragers: &ldquo;I see&rdquo;, &ldquo;Go on&rdquo;,
                    ...
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        ...
                        &nbsp;interrupt, give advice, share your own stories, or say &ldquo;I know
                        how you feel&rdquo;
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Reflect back what they have said to show you have heard them: &ldquo;It
                        sounds like you&rsquo;ve been feeling overwhelmed for a while&rdquo;
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-1">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Validate their feelings: &ldquo;It takes courage to talk about this, and
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Share factual information: &ldquo;1 in 4 people in the UK will experience a
                        mental health problem each year&rdquo;
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Challenge myths: &ldquo;Mental health conditions are treatable &mdash;
                        recovery is possible with the right support&rdquo;
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Do not</strong>
                        &nbsp;minimise: never say &ldquo;cheer up&rdquo;, &ldquo;just think
                        positive&rdquo;, or &ldquo;others have it worse&rdquo;
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-1">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">GP:</strong> The primary point of contact for
                        mental health support in the UK. Can refer to talking therapies, prescribe
                        medication, or make specialist referrals.
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">EAP:</strong> Many employers provide a free,
                        confidential Employee Assistance Programme with counselling and support.
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">NHS Talking Therapies:</strong> Self-referral
                        is available in England for anxiety and depression via NHS Talking Therapies
                        (formerly IAPT).
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Crisis services:</strong> Samaritans (116
                        123), Crisis Text Line (text SHOUT to 85258), or 999 if in immediate danger.
                      </span>
                    </li>
                  </ul>
                  <p className="text-sm text-white mt-2">
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-1">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Physical activity &mdash; even short walks can significantly improve mood
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Maintaining social connections with friends, family, and colleagues
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>Peer support groups (Mind, SANE, Rethink Mental Illness)</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Workplace adjustments &mdash; phased return, flexible hours, reduced
                        workload (with consent)
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Construction-specific support: Mates in Mind, the Lighthouse Club,
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Understanding the boundaries of the MHFA role is essential. Well-intentioned but
                poorly boundaried support can cause harm &mdash; to the person you are supporting,
                and to yourself. The MHFA role is defined as much by what it is <strong>not</strong>{' '}
                as by what it is.
              </p>
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-purple-400">Recognising Your Own Limitations:</strong>{' '}
                  MHFAs must know when to step back. If you feel out of your depth, if the
                  person&rsquo;s needs exceed your training, or if supporting them is affecting your
                  own mental health, it is appropriate &mdash; and responsible &mdash; to refer to a
                  professional and seek support for yourself. You cannot pour from an empty cup.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Access regular supervision or debriefing with another MHFA or a line manager
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Set clear time boundaries for conversations &mdash; you are not available 24/7
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Use the EAP or Samaritans yourself if you need to debrief after a difficult
                      conversation
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Recognise the signs of compassion fatigue and vicarious trauma in yourself
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Remember: the outcome is not your responsibility &mdash; you can only offer
                      support, not force someone to accept it
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Confidentiality is the foundation of trust between a Mental Health First Aider and
                the person they are supporting. Without confidence that their disclosure will be
                treated with respect and privacy, people will not open up. Breaking confidentiality
                without justification can cause serious harm and destroy trust in the MHFA programme
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  applies even if you believe sharing would be helpful.
                </p>
              </div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      If you believe the person is at imminent risk of ending their life or
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Risk of harm to others:</strong> If the person
                      discloses plans to harm another person
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Safeguarding concerns:</strong> If the
                      disclosure involves abuse, neglect, or exploitation of children or vulnerable
                      adults
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Terrorism or serious crime:</strong> If the
                      person discloses information relating to terrorism or a serious criminal
                      offence
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Only record what is strictly necessary &mdash; date, brief summary of concern,
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Store any notes securely &mdash; locked cabinet or encrypted digital storage,
                      not loose paper on a desk
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Do not retain records longer than necessary &mdash; follow your
                      organisation&rsquo;s retention policy
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Never share information by text message, WhatsApp, or unsecured email
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      If asked by a manager for details, explain that you can only confirm that a
                      conversation took place if the individual consents
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-purple-400">Sharing with Managers (With Consent):</strong>{' '}
                  If the person agrees, you can share a summary with their manager to facilitate
                  workplace adjustments (e.g. reduced workload, flexible hours, time off for
                  appointments). Always get explicit verbal consent, ideally confirmed in writing.
                  The person chooses what is shared and what is not. They may want their manager to
                  know they are &ldquo;having a difficult time&rdquo; without disclosing the
                  details.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                There is an important distinction between an employer&rsquo;s legal duty of care and
                the MHFA&rsquo;s moral and practical responsibility to refer someone to professional
                help. Understanding this distinction protects both you and the people you support.
              </p>
              ...
              <div className="space-y-3">
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-white mb-2">
                    ...
                    , employers have a general duty to ensure, so far as is reasonably practicable,
                  ...
                  <ul className="text-sm text-white space-y-1">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Conducting risk assessments that include psychosocial hazards (stress,
                        bullying, excessive workload)
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Providing a safe working environment, both physically and psychologically
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    ...
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        ...
                        require employers to assess all risks, including work-related stress
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-1">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Recognising when a situation is beyond your training and referring to
                        professional help
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Not attempting to provide ongoing support in place of a qualified
                        professional
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Escalating to emergency services (999) if there is immediate risk to life
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Following your organisation&rsquo;s escalation procedures and policies
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-1">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">GP:</strong> Primary referral point &mdash;
                        can assess, prescribe, refer to talking therapies or specialist secondary
                        care
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">EAP:</strong> Employer -funded, confidential,
                        often available 24/7, typically offers 6&ndash;8 counselling sessions
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">NHS Talking Therapies:</strong> Self-referral
                        for anxiety and depression without needing a GP appointment
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Crisis services:</strong> 999, Samaritans
                        (116 123), Crisis Text Line (text SHOUT to 85258), local crisis teams
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Industry-specific:</strong> Mates in Mind,
                        Lighthouse Club (construction helpline: 0345 605 1956), Electrical
                        Industries Charity
                      </span>
                    </li>
                  </ul>
                ...
                <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-white">
                    ...
                    trail, and can help demonstrate that the organisation is meeting its duty of
                    care. Store records securely in accordance with your organisation&rsquo;s data
                    protection policy. Never include unnecessary personal details.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                A common concern for those considering the MHFA role is legal liability: &ldquo;What
                if I say the wrong thing? Could I be sued?&rdquo; Understanding the legal position
                provides reassurance and clarity.
              </p>

              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-purple-400">Key Point:</strong> There is no specific UK
                  legislation that governs, regulates, or mandates the Mental Health First Aider
                  role. It is an entirely <strong>voluntary</strong> role. You are not a registered
                  professional, and you are not held to the same standards as a psychiatrist,
                  psychologist, or counsellor. The legal framework relies on general principles of
                  negligence law and specific protective legislation.
                </p>
              </div>
              ...
              <div className="space-y-3">
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-white">
                    ...
                    consistently held that a person who voluntarily offers assistance in an
                    emergency, without being reckless or grossly negligent, is unlikely to face
                    legal liability. The standard applied is whether the person acted as a{' '}
                    <strong className="text-white">reasonable person</strong> would in the same
                    circumstances.
                  </p>
                </div>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-white mb-2">
                    ...
                    (commonly known as the SARAH Act) was introduced specifically to protect
                  ...
                  <ul className="text-sm text-white space-y-1">
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        ...
                        <strong className="text-white">for the benefit of society</strong> or any of
                        its members
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        ...
                        <strong className="text-white">predominantly responsible approach</strong>{' '}
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        The person was acting <strong className="text-white">heroically</strong> by
                  ...
                  <p className="text-sm text-white mt-2">
                    ...
                    good faith, this provides significant protection.
                  </p>
                </div>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-1">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Vicarious liability:</strong> An employer can
                        be held vicariously liable for the actions of employees carried out during
                        the course of their employment &mdash; this includes the MHFA role
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Adequate training:</strong> Employers must
                        ensure MHFAs receive proper, accredited training (MHFA England two-day
                        course) and regular refresher training
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Support and supervision:</strong> Employers
                        should provide ongoing supervision, peer support, and access to debriefing
                        for MHFAs
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Clear policies:</strong> The organisation
                        should have a clear mental health policy, escalation procedures, and defined
                        scope for the MHFA role
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Insurance:</strong> Employers should ensure
                        their liability insurance covers the activities of MHFAs
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                  <p className="text-sm text-white">
                    <strong className="text-purple-400">In Summary:</strong> As a Mental Health
                    First Aider, the risk of personal legal liability is extremely low, provided you
                    act within the boundaries of your training, in good faith, and do not attempt to
                    diagnose, treat, or provide therapy. The SARAH Act 2015 provides additional
                    reassurance. Your employer holds the primary duty of care and should provide the
                    training, support, and policies needed for you to perform the role safely.
                  </p>
                </div>
              </div>
            </div>
