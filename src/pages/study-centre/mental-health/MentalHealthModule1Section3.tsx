...
const faqs = [
  {
    ...
    answer:
      "There is currently no specific legal requirement for employers to appoint Mental Health First Aiders (MHFAiders). However, employers do have a general duty under HASAWA 1974 to protect employees' health, which includes mental health. The HSE recommends that organisations consider mental health as part of their first aid needs assessment. Many employers now appoint MHFAiders as best practice, particularly since the Stevenson/Farmer 'Thriving at Work' review recommended it as a core standard.",
  },
  {
    question: 'Can an employer dismiss someone for having a mental health condition?',
    answer:
      'If the mental health condition qualifies as a disability under the Equality Act 2010 (substantial and long-term), dismissal purely on the grounds of that condition would likely constitute disability discrimination. Employers must first consider and implement reasonable adjustments. Dismissal could only be lawful if the employer can demonstrate that all reasonable adjustments have been made and the person still cannot fulfil the essential requirements of the role, and even then, proper procedures must be followed.',
  },
  {
    question:
      'What is the difference between the HSE Management Standards and a legal requirement?',
    answer:
      "The HSE Management Standards are not themselves legally enforceable regulations. They are a framework and recommended approach for managing work-related stress. However, employers do have legal duties under HASAWA 1974 and the Management of Health and Safety at Work Regulations 1999 to assess and manage risks to health, including stress. The Management Standards provide a practical methodology for meeting those legal duties. If an employer fails to manage stress risks and an employee suffers harm, the Standards would be used as evidence of what 'reasonably practicable' steps should have been taken.",
  },
  {
...
const quizQuestions = [
  ...
  },
  {
    id: 3,
    question:
      "Under the Equality Act 2010, what does 'long-term' mean when determining whether a mental health condition is a disability?",
    options: [
  ...
  },
  {
    id: 5,
    question:
      "Which of these is an example of a 'reasonable adjustment' under the Equality Act for an electrician with depression?",
    options: [
  ...
  },
  {
    id: 8,
    question:
      'Which construction-specific initiative focuses on improving mental health and wellbeing across the UK building industry?',
    options: [
      'CSCS Card Scheme',
      'Mates in Mind',
...
export default function MentalHealthModule1Section3() {
  useSEO({
    ...
    description:
      'UK workplace mental health legislation and frameworks: HASAWA 1974, HSE Management Standards, Equality Act 2010, Thriving at Work review, and construction industry context for Mental Health First Aiders.',
  });
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-purple-500/5 border-l-2 border-purple-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>HASAWA 1974:</strong> Employer duty of care includes mental health
              </li>
              <li>
                <strong>HSE Standards:</strong> 6 areas &mdash; Demands, Control, Support,
                Relationships, Role, Change
              </li>
              <li>
                <strong>Equality Act 2010:</strong> Mental health conditions can be a protected
                disability
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-purple-500/5 border-l-2 border-purple-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Assess:</strong> Psychological risks alongside physical hazards
              </li>
              <li>
                <strong>Adjust:</strong> Reasonable adjustments for workers with mental health
                conditions
              </li>
              <li>
                <strong>Support:</strong> Integrate MHFA into existing H&amp;S systems
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The <strong>Health &amp; Safety at Work Act 1974</strong> (HASAWA) is the primary
                piece of legislation covering occupational health and safety in the United Kingdom.
                It places a broad, overarching duty on employers to protect the health, safety and
                welfare of their employees &mdash; and this duty explicitly includes{' '}
                <strong>mental health</strong>.
              </p>

              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                <p className="text-sm font-medium text-purple-400 mb-3">
                  Key Definition &mdash; Section 2: General Duty of Employers
                </p>
                <p className="text-sm text-white">
                  Section 2(1) states: &ldquo;It shall be the duty of every employer to ensure, so
                  far as is reasonably practicable, the health, safety and welfare at work of all
                  his employees.&rdquo; The courts have interpreted &lsquo;health&rsquo; to
                  encompass <strong>both physical and mental health</strong>. This means employers
                  cannot lawfully ignore psychological hazards in the workplace.
                </p>
              </div>

              <p>
                The Act does not prescribe exactly what employers must do for mental health.
                Instead, it sets a broad standard of{' '}
                <strong>&ldquo;reasonably practicable&rdquo;</strong> measures. What is reasonably
                practicable depends on the size and nature of the organisation, the risks involved,
                and the resources available. For a construction company sending electricians to
                remote sites for long shifts, what is reasonably practicable will differ from what
                is expected of an office-based firm.
              </p>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-3">
                  Key Provisions Relevant to Mental Health
                </p>
                  ...
                  {[
                    {
                      ...
                      detail:
                        'General duty to ensure health, safety and welfare of employees — includes mental health',
                    },
                    {
                      provision: 'Section 2(2)(a)',
                      detail:
                        'Provision and maintenance of safe systems of work — workload and shift patterns affect mental health',
                    },
                    {
                      provision: 'Section 2(2)(c)',
                      detail:
                        'Provision of information, instruction, training and supervision — includes mental health awareness training',
                    },
                    {
                      provision: 'Section 2(2)(e)',
                      detail:
                        'Provision and maintenance of a safe working environment — includes psychosocial environment (bullying, harassment, isolation)',
                    },
                    {
                      provision: 'Section 2(3)',
                      detail:
                        'Employers must prepare a written health & safety policy — should reference mental health',
                    },
                    {
                      provision: 'Section 3',
                      detail:
                        'Duty to non-employees — employers must also consider the mental health impact of their operations on contractors and visitors',
                    },
                  ].map((item, i) => (
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  employees&apos; health &mdash; including psychological hazards such as excessive
                  workload, bullying, poor management, lack of control, and isolation. The
                  assessment must be reviewed regularly and updated whenever there are significant
                  changes to working practices. For employers with 5 or more employees, the
                  significant findings of the risk assessment must be recorded in writing.
                </p>
              </div>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  directors and managers can also be personally liable under Section 37. Fines are
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The HSE developed the <strong>Management Standards</strong> approach to help
                employers manage the causes of work-related stress. They define the characteristics
                of an organisation where stress risks are being effectively managed. The Standards
                cover <strong>six key areas</strong> that, if not properly managed, are associated
                with poor health, lower productivity, and increased sickness absence.
              </p>

              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                <p className="text-sm font-medium text-purple-400 mb-3">
                  Key Definition &mdash; Management Standards
                </p>
                <p className="text-sm text-white">
                  The HSE Management Standards are not legally binding regulations in themselves.
                  They represent a set of conditions that, if present, reflect{' '}
                  <strong>good management practice</strong> and a healthy working environment. They
                  provide a framework that employers can use to demonstrate they are meeting their
                  legal duties under HASAWA 1974 and the Management Regulations 1999.
                </p>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The <strong>Equality Act 2010</strong> is the primary UK legislation protecting
                individuals from discrimination. Under the Act, mental health conditions can qualify
                as a<strong> disability</strong> &mdash; giving the affected person significant
                legal protections in the workplace.
              </p>

              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                <p className="text-sm font-medium text-purple-400 mb-3">
                  Key Definition &mdash; Disability Under the Equality Act
                </p>
                <p className="text-sm text-white">
                  A person has a disability if they have a physical or mental impairment that has a
                  <strong> substantial</strong> and <strong>long-term</strong> adverse effect on
                  their ability to carry out <strong>normal day-to-day activities</strong>.
                  &lsquo;Substantial&rsquo; means more than minor or trivial.
                  &lsquo;Long-term&rsquo; means lasting or likely to last 12 months or more, or for
                  the rest of the person&apos;s life. Recurring conditions (such as episodes of
                  depression) are treated as continuing even during periods of remission.
                </p>
              </div>
              ...
              <p>
                ...
                <strong> schizophrenia</strong> can all meet this definition. Importantly, the
                person does not need a formal diagnosis for the Act to apply &mdash; the test is
                functional (what effect does the condition have on their daily life?), not
                diagnostic.
              </p>
                ...
                <div className="space-y-3">
                  <div className="bg-black/30 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70">
                      ...
                      disproportionately disadvantages people with mental health conditions), and
                      discrimination arising from disability (treating someone unfavourably because
                      of something connected to their disability, such as sickness absence).
                    </p>
                  </div>
                  <div className="bg-black/30 rounded-lg p-3">
                    <p className="text-xs font-medium text-purple-400 mb-1">
                    ...
                    <p className="text-xs text-white/70">
                      ...
                      providing a quiet workspace, allowing regular breaks, or adjusting workload
                      during difficult periods. The duty applies even if the employer does not know
                      about the condition, if they ought reasonably to have known.
                    </p>
                  </div>
                  <div className="bg-black/30 rounded-lg p-3">
                    <p className="text-xs font-medium text-purple-400 mb-1">
                    ...
                    <p className="text-xs text-white/70">
                      ...
                      health condition that meets the disability definition is protected regardless
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="grid sm:grid-cols-2 gap-3">
                  {[
                    {
                      adjustment: 'Flexible working hours',
                      detail:
                        'Allowing later start times for employees whose medication affects morning alertness or sleep patterns',
                    },
                    {
                      adjustment: 'Modified duties',
                      detail:
                        'Temporarily reducing workload or complexity of tasks during periods of acute difficulty',
                    },
                    {
                      adjustment: 'Regular check-ins',
                      detail:
                        'Scheduling brief, private conversations with a supervisor to monitor wellbeing',
                    },
                    {
                      adjustment: 'Quiet workspace',
                      detail:
                        'Providing access to a calm area for breaks — particularly important on busy, noisy construction sites',
                    },
                    {
                      adjustment: 'Time off for appointments',
                      detail:
                        'Allowing paid or unpaid time off for therapy, counselling, or psychiatric appointments',
                    },
                    {
                      adjustment: 'Adjusted absence triggers',
                      detail:
                        'Discounting disability-related absence from disciplinary procedures and attendance targets',
                    },
                    {
                      adjustment: 'Buddy system',
                      detail:
                        'Pairing the worker with a supportive colleague, especially on remote sites or during night shifts',
                    },
                    {
                      adjustment: 'Phased return to work',
                      detail:
                        'Allowing a gradual increase in hours and responsibilities after a period of mental health-related absence',
                    },
                  ].map((item, i) => (
                    <div key={i} className="bg-black/30 rounded-lg p-3">
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  of distress, has frequent absences, or their performance has deteriorated
                  significantly, a tribunal may find the employer had &ldquo;constructive
                  knowledge&rdquo; of the condition &mdash; even if the worker never disclosed it.
                  This is why Mental Health First Aiders and line managers must be trained to
                  recognise the signs.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                In 2017, the UK Government commissioned Lord Dennis Stevenson and Paul Farmer (CEO
                of Mind) to conduct an independent review of mental health and employers. The
                resulting report,
                <strong> &ldquo;Thriving at Work&rdquo;</strong>, set out a framework of standards
                that all UK employers should adopt. It was a landmark moment for workplace mental
                health policy.
              </p>
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                ...
                <div className="space-y-2">
                  {[
                    {
                      num: '1',
                      standard: 'Produce, implement and communicate a mental health at work plan',
                    },
                    {
                      num: '2',
                      standard:
                    ...
                    },
                    {
                      num: '4',
                      standard:
                        'Provide good working conditions that ensure employees have a healthy work-life balance and opportunities for development',
                    },
                    {
                      num: '5',
                      standard:
                        'Promote effective people management through line managers and supervisors, ensuring they have the training to have supportive conversations',
                    },
                    {
                      num: '6',
                      standard:
                        'Routinely monitor employee mental health and wellbeing by collecting and analysing data on absence, presenteeism and employee feedback',
                    },
                  ].map((item) => (
                  ...
                  {[
                    {
                      num: '1',
                      standard:
                        'Increase transparency and accountability through internal and external reporting on mental health',
                    },
                    {
                      num: '2',
                      standard:
                        "Demonstrate accountability by nominating a senior leader as the 'mental health champion' at board level",
                    },
                    {
                      num: '3',
                      standard:
                        'Improve the disclosure process to make it easier for employees to talk about mental health without fear of discrimination',
                    },
                    {
                      num: '4',
                      standard:
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1.5">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong>Mental health plan:</strong> Even small electrical firms should have a
                      written plan addressing how they support workers&apos; mental health, who to
                      go to for help, and what resources are available
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong>Open conversation culture:</strong> The construction industry&apos;s
                      traditional &ldquo;tough it out&rdquo; mentality must be actively challenged
                      &mdash; toolbox talks on mental health are a practical way to start
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong>Supervisor training:</strong> Site supervisors and gang leaders should
                      receive training in how to recognise signs of poor mental health and have
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong>Working conditions:</strong> Long hours, excessive travel, uncertain
                      contracts, and working away from home all affect mental health &mdash;
                      employers should address these proactively
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong>Data monitoring:</strong> Track sickness absence patterns, staff
                      turnover, and survey feedback to identify emerging mental health issues before
                      they become crises
                    </span>
                  </li>
                </ul>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Just as employers must conduct a <strong>first aid needs assessment</strong> for
                physical first aid (under the Health &amp; Safety (First-Aid) Regulations 1981), a
                growing body of guidance recommends applying the same principle to{' '}
                <strong>mental health first aid</strong>. The goal is to integrate MHFA provision
                into your existing health and safety framework, not to treat it as a separate
                initiative.
              </p>
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  the names and photographs of MHFAiders alongside physical first aiders on site
                  notice boards.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="grid sm:grid-cols-2 gap-3">
                  {[
                    {
                      factor: 'Workforce size',
                      detail:
                        'Larger workforces need more MHFAiders to ensure coverage across shifts and locations',
                    },
                    {
                      factor: 'Working patterns',
                      detail:
                        'Shift work, night work, and weekend work all require MHFAider availability at those times',
                    },
                    {
                      factor: 'Remote or isolated sites',
                      detail:
                        'Workers on remote sites may have limited access to external support — on-site MHFAiders are critical',
                    },
                    {
                      factor: 'Nature of work',
                      detail:
                        'High-risk trades, physically demanding work, and jobs with exposure to traumatic events increase the need',
                    },
                    {
                      factor: 'Known risk factors',
                      detail:
                        'If your workforce has high absence rates, high turnover, or previous incidents of mental ill health, increase provision',
                    },
                    {
                      factor: 'Holiday and absence cover',
                      detail:
                        'Ensure cover is maintained when MHFAiders are on leave, sick, or have left the organisation',
                    },
                  ].map((item, i) => (
                    <div key={i} className="bg-black/30 rounded-lg p-3">
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  attention. The results can inform your mental health plan, guide MHFAider training
                  priorities, and provide baseline data to measure improvement over time. For
                  construction sites, consider supplementing the survey with informal toolbox talks
                  and one-to-one conversations, as not all workers will feel comfortable completing
                  a written survey.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The construction industry faces <strong>unique mental health challenges</strong>.
                Workers in construction are significantly more likely to experience poor mental
                health and to die by suicide than the general working population. Understanding
                these industry-specific factors is essential for any Mental Health First Aider
                working in the electrical or construction trades.
              </p>

              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                <p className="text-sm font-medium text-purple-400 mb-3">Key Statistic</p>
                <p className="text-sm text-white">
                  Male construction workers in the UK are{' '}
                  <strong>3 times more likely to die by suicide</strong> than men in the general
                  population (ONS). The construction sector also has among the highest rates of
                  work-related stress, depression, and anxiety of any UK industry. These figures
                  make a compelling case for proactive mental health support on every construction
                  site.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-3">
                  Construction-Specific Mental Health Challenges
                </p>
                <div className="grid sm:grid-cols-2 gap-3">
                  {[
                    {
                      challenge: 'Transient workforce',
                      detail:
                        'Workers move between sites and employers frequently, making it difficult to build relationships, access consistent support, or feel a sense of belonging',
                    },
                    {
                      challenge: 'Long and unsociable hours',
                      detail:
                        'Early starts, late finishes, weekend work, and overtime culture disrupt sleep, family life, and social connections — all protective factors for mental health',
                    },
                    {
                      challenge: 'Physical demands',
                      detail:
                        'Heavy physical work, working at height, and exposure to weather extremes are physically exhausting and contribute to mental fatigue and low mood',
                    },
                    {
                      challenge: 'Job insecurity',
                      detail:
                        "Short-term contracts, self-employment, and 'feast or famine' workloads create chronic financial anxiety and uncertainty about the future",
                    },
                    {
                      challenge: 'Remote and isolated sites',
                      detail:
                        'Working away from home for extended periods, living in temporary accommodation, and being separated from family and friends',
                    },
                    {
                      challenge: 'Macho culture',
                      detail:
                        "A traditional culture of 'toughness' discourages workers from talking about their feelings or seeking help, leading to suffering in silence",
                    },
                    {
                      challenge: 'Substance misuse',
                      detail:
                        'Higher-than-average rates of alcohol and drug use in the industry, often as a coping mechanism for stress, pain, or low mood',
                    },
                    {
                      challenge: 'Financial pressures',
                      detail:
                        'Self-employed workers receive no sick pay, so taking time off for mental health feels financially impossible — leading to presenteeism',
                    },
                  ].map((item, i) => (
                    <div key={i} className="bg-black/30 rounded-lg p-3">
                ...
                <div className="space-y-3">
                  <div className="bg-black/30 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70">
                      ...
                      industries, and associated trades. It is endorsed by Build UK, the CITB, and
                      major contractors. Mates in Mind offers a structured approach: Awareness
                      (general workforce), Advocate (site champions), and Manage (line managers and
                      supervisors).
                    </p>
                  </div>
                  <div className="bg-black/30 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70">
                      ...
                      environment where people feel able to talk about their mental health. It
                      provides practical toolkits, template policies, and example toolbox talks for
                      use on site.
                    </p>
                  </div>
                  <div className="bg-black/30 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70">
                      ...
                      charity also provides emergency financial assistance and counselling
                      referrals.
                    </p>
                  </div>
                  <div className="bg-black/30 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70">
                      ...
                      improvements in health and wellbeing standards. Together, they champion the
                      message that mental health must be treated with the same priority as physical
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1.5">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Many workers will never have spoken about their mental health before &mdash;
                      approach conversations with patience and without judgement
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      Consider cultural backgrounds &mdash; attitudes to mental health vary
                      significantly across different communities
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      Self-employed workers may have no access to employer-provided support &mdash;
                      know the free resources available (Lighthouse Club helpline, Samaritans, NHS
                      crisis services)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      If someone is working at height or with live electricity and you believe they
                      are in acute mental distress, the immediate physical safety risk must be
                      managed first
                    </span>
                  </li>
                </ul>
