...
const faqs = [
  ...
  {
    question: 'Why does construction have such a high rate of mental health problems?',
    answer:
  ...
  {
    question: 'Can you fully recover from a mental health condition?',
    answer:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['£12 billion', '£28 billion', '£56 billion', '£90 billion'],
    correctAnswer: 2,
    explanation:
  ...
  {
    id: 7,
    question: 'Which of the following is NOT a type of stigma associated with mental health?',
    options: [
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-purple-500/5 border-l-2 border-purple-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Spectrum:</strong> Mental health is a continuum, not binary
              </li>
              <li>
                <strong>Prevalence:</strong> 1 in 4 UK adults affected each year
              </li>
              <li>
                <strong>Construction:</strong> Highest suicide rate of any UK industry
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-purple-500/5 border-l-2 border-purple-500/50">
            <p className="text-purple-400/90 text-base font-medium mb-2">In Practice</p>
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Recognise:</strong> Everyone has mental health &mdash; check in regularly
              </li>
              <li>
                <strong>Challenge:</strong> Myths and stigma that prevent help-seeking
              </li>
              <li>
                <strong>Normalise:</strong> Open conversations about mental health on site
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Mental health is a fundamental part of our overall health and wellbeing. Just as we
                all have physical health, we all have mental health &mdash; and it affects how we
                think, feel, and act. It influences how we handle stress, relate to others, and make
                decisions. Mental health is important at every stage of life, from childhood through
                to adulthood.
              </p>

              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-purple-400">WHO Definition:</strong> The World Health
                  Organisation defines mental health as{' '}
                  <em>
                    &ldquo;a state of wellbeing in which every individual realises their own
                    potential, can cope with the normal stresses of life, can work productively and
                    fruitfully, and is able to make a contribution to their community.&rdquo;
                  </em>{' '}
                  This definition makes clear that mental health is far more than the absence of
                  mental illness.
                </p>
              </div>

              <p>
                A critical concept for any Mental Health First Aider to understand is that mental
                health is <strong>not binary</strong>. It is not a case of &ldquo;well&rdquo; or
                &ldquo;unwell&rdquo;. Instead, mental health exists on a <strong>spectrum</strong>{' '}
                (or continuum) that everyone moves along throughout their life. Your position on
                this spectrum can shift depending on what is happening in your life, the stresses
                you are facing, the support you have available, and your own coping resources.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Everyone has mental health</strong> &mdash; it
                      is not something only some people have
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Fluctuations are normal</strong> &mdash; we all
                      move along the spectrum depending on circumstances
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400/60 flex-shrink-0" />
                    <span>
                      ...
                      &mdash; you can have poor mental health without a diagnosis
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">It affects everything</strong> &mdash; our
                      thoughts, emotions, behaviour, relationships, and work performance
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400/60 flex-shrink-0" />
              ...
              <p>
                As a Mental Health First Aider, understanding this foundation is essential. Your
                role is not to diagnose or treat &mdash; it is to recognise the signs that someone
                may be moving along the continuum towards difficulty, and to provide initial support
                and signposting. Just as a physical first aider does not perform surgery, an MHFA
                does not provide therapy &mdash; but they can make a life-changing difference
                through early recognition and compassionate support.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The Mental Health Continuum is a widely used model that represents mental health as
                a spectrum with four broad zones. Everyone sits somewhere on this continuum at any
                given time, and our position shifts in response to life events, stressors, coping
                strategies, and the support we receive. Understanding this model helps you recognise
                when someone &mdash; including yourself &mdash; may be moving from one zone to
                another.
              </p>
              ...
              <p>
                It is important to understand that movement along this continuum is{' '}
                <strong>fluid and normal</strong>. A person who is generally thriving might move to
                surviving during a period of high workload or personal difficulty, and then move
                back to thriving once the situation improves. Equally, someone who is struggling can
                move back towards thriving with the right support and intervention.
              </p>
              ...
              <p>
                As a Mental Health First Aider, your ability to recognise which zone someone is in
                &mdash; and crucially, whether they are moving in the wrong direction &mdash; is one
                of the most valuable skills you will develop. Early recognition and a simple,
                empathetic conversation can prevent someone from sliding further along the continuum
                towards crisis.
              </p>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Mental health conditions are among the most common health challenges in the United
                Kingdom. Understanding the scale of the problem is essential for any Mental Health
                First Aider &mdash; it reinforces why this work matters and helps challenge the
                misconception that mental health problems are rare or only affect a small number of
                people.
              </p>

              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                <p className="text-sm font-medium text-purple-400 mb-3">Key UK Statistics</p>
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      <strong className="text-red-300">highest suicide rate</strong> of any UK
                      industry (Office for National Statistics)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400/60 flex-shrink-0" />
                    <span>
                      ...
                      <strong className="text-red-300">three times more likely</strong> to die by
                      suicide than the national male average
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400/60 flex-shrink-0" />
                    <span>
                      In an average year, more construction workers die by suicide than from falls
                      from height, the industry&rsquo;s leading cause of workplace fatality
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400/60 flex-shrink-0" />
                    <span>
                      Risk factors include long hours, time away from family, job insecurity,
                      physical demands, and a culture that discourages vulnerability
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <p>
                These statistics demonstrate that mental health is not a niche issue &mdash; it is a
                workplace health priority on par with physical safety. For those working in
                construction and the electrical trades, the need for Mental Health First Aiders is
                particularly acute. The Deloitte (2022) research also found that for every &pound;1
                invested in mental health support by employers, there is an average return of
                &pound;5.30 through reduced absence, increased productivity, and improved retention.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Presenteeism</strong> (working while unwell)
                      &mdash; accounts for the largest share of costs
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Absenteeism</strong> (sickness absence) &mdash;
                      70 million working days lost per year
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Staff turnover</strong> &mdash; recruitment and
                      training costs when employees leave due to poor wellbeing
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                One of the most important roles of a Mental Health First Aider is to challenge myths
                and misconceptions that prevent people from understanding mental health and seeking
                help. These myths are deeply embedded in society and contribute directly to stigma.
              ...
              <div className="space-y-4">
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <p className="text-sm text-white">
                      ...
                      affected, even if they have not told you.
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  <div className="flex items-start gap-3 mb-2">
                    <XCircle className="h-5 w-5 text-red-400 mt-0.5 flex-shrink-0" />
                    <p className="text-sm font-medium text-red-400">
                      Myth: &ldquo;They only affect certain types of people&rdquo;
                    </p>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-green-400 mt-0.5 flex-shrink-0" />
                    <p className="text-sm text-white">
                      ...
                      susceptible as an apprentice. Wealth and success do not provide immunity.
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  <div className="flex items-start gap-3 mb-2">
                    <XCircle className="h-5 w-5 text-red-400 mt-0.5 flex-shrink-0" />
                    <p className="text-sm font-medium text-red-400">
                      Myth: &ldquo;People with mental health problems are dangerous&rdquo;
                    </p>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-green-400 mt-0.5 flex-shrink-0" />
                    <p className="text-sm text-white">
                      ...
                      <strong>victims</strong> of violence than perpetrators. Research consistently
                      shows that only a very small percentage of violent incidents involve people
                      with mental illness, and these are often linked to other factors such as
                      substance misuse.
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  <div className="flex items-start gap-3 mb-2">
                    <XCircle className="h-5 w-5 text-red-400 mt-0.5 flex-shrink-0" />
                    <p className="text-sm font-medium text-red-400">
                      Myth: &ldquo;It&rsquo;s just a phase &mdash; they&rsquo;ll snap out of
                      it&rdquo;
                    </p>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <p className="text-sm text-white">
                      ...
                      unhelpful as telling someone with a broken leg to &ldquo;walk it off&rdquo;.
                      Many conditions require professional support, therapy, or medication &mdash;
                      and early intervention significantly improves outcomes.
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  <div className="flex items-start gap-3 mb-2">
                    <XCircle className="h-5 w-5 text-red-400 mt-0.5 flex-shrink-0" />
                    <p className="text-sm font-medium text-red-400">
                      Myth: &ldquo;You can&rsquo;t recover from mental illness&rdquo;
                    </p>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-green-400 mt-0.5 flex-shrink-0" />
                    <p className="text-sm text-white">
                      ...
                      linear &mdash; there may be setbacks &mdash; but with the right support,
                      including professional help, self-care, and social connection, people can and
                      do recover. This myth is one of the most damaging barriers to help-seeking.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-purple-400">Why Myths Matter:</strong> These
                  misconceptions do real harm. They stop people from talking about their struggles,
                  delay help-seeking, reinforce stigma, and can lead to discrimination. As an MHFA,
                  you are in a unique position to challenge these myths whenever you encounter them
                  &mdash; in conversations, in toolbox talks, and through your own behaviour and
                  attitudes.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Stigma is one of the biggest barriers to people seeking help for mental health
                difficulties. In the workplace, stigma can mean the difference between someone
                getting support early and someone suffering in silence until they reach crisis
                point. Understanding the different types of stigma and how they operate is essential
                for any Mental Health First Aider.
              </p>

              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                <p className="text-sm font-medium text-purple-400 mb-3">Three Types of Stigma</p>
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-white">
                        ...
                        discrimination in employment, housing, relationships, and access to
                        services.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-white">
                        ...
                        person experiencing self-stigma might think &ldquo;I should be able to
                        handle this on my own&rdquo; or &ldquo;What will people think of me?&rdquo;
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-white">
                        ...
                        having wellbeing conversations, and workplace cultures that punish
                        vulnerability.
                      </p>
                    </div>
                  </div>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">&ldquo;Macho&rdquo; culture</strong> &mdash; an
                      expectation to be tough, stoic, and self-reliant. Showing vulnerability is
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">&ldquo;Man up&rdquo; mentality</strong> &mdash;
                      dismissive phrases that shut down conversations about feelings and discourage
                      help-seeking
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Predominantly male workforce</strong> &mdash;
                      men are statistically less likely to seek help for mental health and more
                      likely to use unhealthy coping mechanisms such as alcohol
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Transient workforce</strong> &mdash; frequent
                      changes of site and team make it harder to build trusting relationships where
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Fear of consequences</strong> &mdash; worry
                      that disclosing mental health difficulties could lead to loss of work,
                      especially for self-employed tradespeople
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <p className="text-sm font-medium text-red-400">Consequences of Stigma</p>
                </div>
                <div className="grid sm:grid-cols-2 gap-3">
                  <div>
                    ...
                    <ul className="text-sm text-white space-y-1">
                      ...
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>Increased risk of crisis, self-harm, or suicide</span>
                      </li>
                    </ul>
                  </div>
                  <div>
                    ...
                    <ul className="text-sm text-white space-y-1">
                      ...
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>Safety risks from distracted or unwell workers</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
              ...
              <p>
                Stigma creates a vicious cycle: people do not talk about mental health because of
                stigma, and the silence reinforces the stigma. Breaking this cycle requires active
                effort &mdash; and as a Mental Health First Aider, you are at the forefront of that
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Reducing stigma is not just about changing attitudes &mdash; it is about creating an
                environment where people feel safe to talk about their mental health, seek help
                early, and support one another. As a Mental Health First Aider, you have a direct
                role in making this happen in your workplace.
              </p>
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white mt-3">
                  ...
                  language humanises the individual and reduces stigma.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Talk about it</strong> &mdash; Include mental
                      health in regular conversations, toolbox talks, and team meetings. The more it
                      is discussed, the less taboo it becomes
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Lead by example</strong> &mdash; If you feel
                      comfortable doing so, share your own experiences. When leaders and respected
                      colleagues talk openly, it gives others permission to do the same
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Ask &ldquo;How are you, really?&rdquo;</strong>{' '}
                      &mdash; Go beyond the superficial. A genuine follow-up question shows you
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Challenge inappropriate comments</strong>{' '}
                      &mdash; When you hear stigmatising language or jokes, calmly address it. You
                      do not need to lecture &mdash; sometimes a simple &ldquo;that&rsquo;s not
                      helpful&rdquo; is enough
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Be visible</strong> &mdash; As an MHFA, make
                      sure people know you are there and approachable. Display your MHFA status,
                      remind people in inductions and meetings
                    </span>
                  </li>
                </ul>
              </div>
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-white">
                      ...
                      construction industry and their families.
                    </p>
                  </div>
                  <div>
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Be a visible, approachable point of contact for anyone experiencing mental
                      health difficulties
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-purple-400 mt-0.5 flex-shrink-0" />
                    <span>
                      Initiate and support mental health awareness activities on site (e.g. Time to
                      Talk Day, Mental Health Awareness Week)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-purple-400 mt-0.5 flex-shrink-0" />
                    <span>
                      Signpost colleagues to appropriate professional help and support services
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-purple-400 mt-0.5 flex-shrink-0" />
                    <span>
                      Challenge stigmatising language and behaviour when it occurs, in a calm and
                  ...
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-purple-400 mt-0.5 flex-shrink-0" />
                    <span>
                      Share information and resources to improve understanding across the team
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-purple-400 mt-0.5 flex-shrink-0" />
                    <span>
                      Encourage the organisation to develop and implement mental health policies and
                      training
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-purple-400 mt-0.5 flex-shrink-0" />
                    <span>
                      Model healthy behaviours &mdash; taking breaks, managing workload, talking
                      about wellbeing
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-purple-400">Remember:</strong> You do not need to have all
                  the answers. The most powerful thing you can do as a Mental Health First Aider is
                  simply be there &mdash; to listen without judgement, to show that you care, and to
                  help someone take the first step towards getting the support they need. That alone
