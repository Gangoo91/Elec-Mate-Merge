import { ArrowLeft, Wine, CheckCircle, AlertTriangle, Shield, Heart, Users } from 'lucide-react';
...
const faqs = [
  {
    question: 'Is alcoholism a disease or a choice?',
    answer:
  ...
  {
    question: 'Can you become addicted to prescription medication?',
    answer:
  ...
  {
    question: 'What should I do if I find drugs on a construction site?',
    answer:
  ...
  {
    question: 'How do I know if someone is self-medicating with alcohol or drugs?',
    answer:
...
const quizQuestions = [
  ...
  {
    id: 2,
    question: 'What constitutes binge drinking in the UK?',
    options: [
...
export default function MentalHealthModule3Section1() {
  useSEO({
    title: 'Substance Misuse & Addiction | Mental Health Module 3.1',
    description:
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-purple-500/5 border-l-2 border-purple-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>UK guidelines:</strong> Max 14 units/week for all adults
              </li>
              <li>
                <strong>Dual diagnosis:</strong> Mental health + substance misuse together
              </li>
              <li>
                <strong>ALGEE:</strong> Approach, Listen, Give info, Encourage help, Encourage
                self-help
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-purple-500/5 border-l-2 border-purple-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Safety-critical:</strong> Impairment on site can be fatal
              </li>
              <li>
                <strong>Signs:</strong> Absenteeism, erratic behaviour, accidents, mood swings
              </li>
              <li>
                <strong>Your role:</strong> Support &amp; signpost &mdash; not discipline or
                diagnose
              </li>
            </ul>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Substance misuse is a major public health issue in the UK and a significant concern
                within the construction industry. To respond effectively as a Mental Health First
                Aider, you need to understand the difference between <strong>use</strong>,{' '}
                <strong>misuse</strong>, and <strong>dependency</strong> &mdash; and recognise that
                substance use exists on a <strong>spectrum</strong>, not as a simple binary of
                &ldquo;addicted&rdquo; or &ldquo;not addicted&rdquo;.
              </p>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-3">Key Definitions</p>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-white/80">
                        ...
                        using recreational drugs that impair functioning.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-white/80">
                        ...
                        negative consequences, and prioritise the substance over other aspects of
                        their life.
                      </p>
                    </div>
                  </div>
              ...
              <div className="bg-white/5 border border-white/10 rounded-lg overflow-hidden">
                ...
                <div className="bg-purple-500/5 border-t border-purple-500/20 px-4 py-3">
                  <p className="text-xs sm:text-sm text-white/60">
                    ...
                    misuse stage is significantly more effective than waiting until dependency or
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-purple-400">Novel Psychoactive Substances (NPS):</strong>{' '}
                  Formerly known as &ldquo;legal highs&rdquo;, these substances were made illegal
                  under the Psychoactive Substances Act 2016. They include synthetic cannabinoids
                  (such as &ldquo;Spice&rdquo;), synthetic cathinones (&ldquo;bath salts&rdquo;),
                  and various other compounds designed to mimic the effects of illegal drugs.
                  Despite being illegal, they remain in circulation and are particularly dangerous
                  because their chemical composition is often unknown and inconsistent, making
                  overdose and unpredictable reactions common.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Alcohol is the most widely consumed psychoactive substance in the UK and the most
                commonly misused. It is legal, socially normalised, and deeply embedded in workplace
                culture &mdash; particularly in the construction industry, where after-work drinking
                has historically been part of the social fabric. This normalisation makes it harder
                to recognise when use has crossed into misuse or dependency.
              </p>
                ...
                <div className="p-4 space-y-3">
                  <div className="grid sm:grid-cols-2 gap-4">
                    ...
                    <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                      <p className="text-2xl font-bold text-violet-400 mb-1">1 unit</p>
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  . This equates to roughly 3 pints of 4% beer or a bottle of wine. Binge drinking
                  significantly increases the risk of accidents, alcohol poisoning, risky behaviour,
                  and cardiovascular events &mdash; even in people who do not drink regularly.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      Difficulty controlling the amount consumed once drinking has started &mdash;
                      inability to &ldquo;just have one&rdquo;
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Withdrawal symptoms</strong> when not drinking
                      &mdash; tremors (shaking hands), sweating, nausea, anxiety, insomnia, and in
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Tolerance</strong> &mdash; needing increasing
                      amounts of alcohol to achieve the same effect
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      Neglecting responsibilities, relationships, or interests in favour of drinking
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      Continuing to drink despite awareness of the harm it is causing to health,
                ...
                <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white/80 space-y-2">
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        <strong className="text-white">Liver:</strong> Fatty liver, alcoholic
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Brain:</strong> Memory loss, cognitive
                        impairment, Wernicke-Korsakoff syndrome, increased dementia risk
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Heart:</strong> High blood pressure,
                        cardiomyopathy, increased stroke risk
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Cancer:</strong> Mouth, throat, oesophagus,
                        liver, bowel, and breast cancer
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white/80 space-y-2">
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        <strong className="text-white">Depression:</strong> Alcohol is a central
                        nervous system depressant that worsens low mood over time
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Anxiety:</strong> Withdrawal and rebound
                        effects increase anxiety significantly
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Psychosis:</strong> Heavy, prolonged use can
                        cause alcoholic hallucinations and paranoia
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Suicide risk:</strong> Alcohol is a factor in
                        approximately 25&ndash;50% of suicides in the UK
                      </span>
                    </li>
                  </ul>
                </div>
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  ...
                  Historically, heavy drinking has been normalised in construction culture &mdash;
                  after-work pints, Friday sessions, and drinking to &ldquo;wind down&rdquo; from
                  physically demanding work. Research shows that construction workers are
                  significantly more likely than the general population to drink at hazardous or
                  harmful levels. The industry is increasingly recognising this as a serious welfare
                  and safety issue, with organisations like the Lighthouse Club, Mates in Mind, and
                  the Considerate Constructors Scheme promoting awareness and support. For further
                  information, resources are available at{' '}
                  <strong className="text-white">Drinkaware</strong> (drinkaware.co.uk), which
                  provides tools for tracking consumption, understanding risk, and finding support.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Drug misuse in the workplace is a growing concern across all industries, but it
                carries particular risk in construction where safety-critical work is carried out
                daily. Understanding the common substances involved, their effects, and the signs of
                misuse enables you to recognise when a colleague may need support.
              </p>
              ...
              <div className="space-y-3">
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-white/80 mb-2">
                    ...
                    &mdash; particularly in those with a predisposition to mental health conditions.
                    Cannabis impairs coordination and reaction time for up to 24 hours after use,
                    making it a significant safety risk on construction sites even when used the
                    evening before work.
                  </p>
                </div>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-white/80 mb-2">
                    ...
                    and blood pressure, overconfidence and risk-taking behaviour, agitation and
                    aggression, and impaired judgement. The crash after use causes fatigue,
                    depression, irritability, and poor concentration &mdash; all dangerous on a
                    construction site. Regular use leads to dependency, cardiovascular damage, nasal
                    septum perforation, and severe mental health deterioration.
                  </p>
                </div>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-white/80 mb-2">
                    ...
                    opioid misuse occurs when medication is taken at higher doses than prescribed,
                    for longer than recommended, obtained from non-medical sources, or used for
                    emotional rather than physical pain management. Dependency can develop within{' '}
                    <strong className="text-white">as little as 2&ndash;4 weeks</strong> of regular
                    use.
                  </p>
                </div>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-white/80 mb-2">
                    ...
                    within <strong className="text-white">2&ndash;4 weeks</strong> of daily use.
                    Withdrawal from benzodiazepines can be medically dangerous and must be managed
                    gradually under medical supervision. Combining benzodiazepines with alcohol is
                    extremely dangerous and can cause fatal respiratory depression.
                  </p>
                </div>
              </div>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-3">Signs of Drug Misuse at Work</p>
                <div className="grid sm:grid-cols-2 gap-x-6 gap-y-2">
                  {[
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  judgement. They may work at height with slowed reaction times, fail to follow
                  safety procedures, misjudge risks, or cause accidents that injure others. Even{' '}
                  <strong className="text-white">residual impairment</strong> from substances used
                  the previous evening can significantly affect performance. This is not just about
                  the individual &mdash; it is about the safety of every person on that site.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                <strong>Dual diagnosis</strong> (also called co-occurring disorders or comorbidity)
                refers to having both a mental health condition and a substance misuse problem at
                the same time. This is extremely common &mdash; research consistently shows that
                people with mental health conditions are significantly more likely to misuse
                substances, and people who misuse substances are significantly more likely to
                  ...
                  <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6">
                    ...
                    <div className="flex flex-col items-center gap-1">
                      <div className="flex items-center gap-1">
                        ...
                        <span className="text-purple-400 text-lg sm:text-xl">&rarr;</span>
                      </div>
                      <div className="flex items-center gap-1">
                        <span className="text-purple-400 text-lg sm:text-xl">&larr;</span>
                        <span className="text-xs text-purple-400 hidden sm:block">
                          Substance-induced
                        </span>
                      </div>
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      A person develops depression or anxiety first and begins using alcohol or
                      drugs to cope with their symptoms (self-medication). The substance provides
                      temporary relief but worsens the underlying condition over time.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      A person&rsquo;s substance use causes or triggers a mental health condition.
                      For example, heavy cannabis use triggering psychosis, or chronic alcohol use
                      causing depression through neurochemical changes.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-purple-400">Shared root causes:</strong> Both
                      conditions may stem from the same underlying factors &mdash; childhood trauma,
                      adverse life events, genetic predisposition, or chronic stress &mdash; and
                      develop in parallel.
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Alcohol</strong> to numb emotional pain, reduce
                      anxiety, or aid sleep
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Cannabis</strong> to reduce anxiety, relax, or
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Cocaine</strong> to counteract low mood,
                      increase energy, or feel confident
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Prescription opioids</strong> to manage both
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Each condition worsens the other &mdash; creating a vicious cycle that is
                      difficult to break
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      Symptoms overlap and can be difficult to distinguish &mdash; is the low mood
                      caused by depression or by alcohol withdrawal?
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      Treatment services have historically been separated &mdash; mental health
                      services and substance misuse services operating independently
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      Some mental health services refuse to engage until the person is
                      &ldquo;clean&rdquo;, while substance misuse services may not address the
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      that addresses both conditions simultaneously, delivered by a team experienced
                      in dual diagnosis
                    </span>
                  </li>
                </ul>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Approaching someone about suspected substance misuse is one of the most challenging
                conversations you may have as a Mental Health First Aider. The person may be
                defensive, in denial, ashamed, or frightened. Your approach matters enormously
                &mdash; a confrontational, accusatory conversation will almost certainly fail, while
                a compassionate, non-judgemental approach can open the door to change.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Use &ldquo;I&rdquo; statements:</strong>{' '}
                      &ldquo;I&rsquo;m worried about you&rdquo; rather than &ldquo;You have a
                      drinking problem&rdquo;
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Describe observations, not judgements:</strong>{' '}
                      &ldquo;I&rsquo;ve noticed you&rsquo;ve been missing Mondays quite a lot
                      recently&rdquo; rather than &ldquo;You&rsquo;re always hungover on
                      Mondays&rdquo;
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Choose the right time and place:</strong>{' '}
                      Private, calm, and when the person is sober &mdash; never approach someone
                      when they are intoxicated or in front of others
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Be prepared for denial:</strong> Many people
                      are not ready to acknowledge their substance use as a problem. Do not argue
                      &mdash; plant the seed, let them know you are there when they are ready, and
                      follow up later
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Respect boundaries:</strong> You cannot force
                      someone to accept help. Your role is to open the door &mdash; they must choose
                      to walk through it
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <p className="text-sm font-medium text-violet-400">Referral Options</p>
                </div>
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-purple-400">The Role of the MHFA:</strong> As a Mental
                  Health First Aider, your role is to <strong>recognise</strong> the signs of
                  substance misuse, <strong>approach</strong> the person with compassion,{' '}
                  <strong>listen</strong> without judgement, <strong>signpost</strong> to
                  professional help, and <strong>support</strong> them while they seek treatment.
                  You are <strong>not</strong> a counsellor, therapist, or disciplinary authority.
                  You are a bridge between suffering in silence and getting professional help. That
                  bridge can save a life.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Every construction site should have a clear drug and alcohol policy. As an MHFA, you
                should be familiar with your site&rsquo;s policy so you can signpost colleagues
                appropriately and understand the framework within which you are operating. The best
                policies balance <strong>safety enforcement</strong> with{' '}
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Clear rules:</strong> What substances are
                      prohibited on site, including alcohol, illegal drugs, and the misuse of
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Testing procedures:</strong> Whether the site
                      conducts random, for-cause, or post-incident drug and alcohol testing, and
                      what methods are used (urine, oral fluid, breathalyser)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Fitness for work assessments:</strong>{' '}
                      Supervisors and managers should be trained to assess whether a worker appears
                      fit to carry out their duties safely, regardless of test results
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Consequences:</strong> What happens if someone
                      tests positive or is found to be impaired &mdash; this may range from
                      immediate removal from site to a formal disciplinary process
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Support pathways:</strong> How the employer
                      supports workers with substance misuse problems &mdash; occupational health
                      referrals, employee assistance programmes (EAPs), and return-to-work
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Confidentiality:</strong> How personal health
                      information is handled, who has access to test results, and the worker&rsquo;s
                      right to privacy
                    </span>
                  </li>
                </ul>
              ...
              <div className="grid md:grid-cols-2 gap-4 sm:gap-6">
                <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white/80 space-y-2">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                      <span>Offering occupational health referral and EAP access</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                      <span>Allowing time off for treatment and recovery</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                      <span>A structured return-to-work plan with ongoing support</span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white/80 space-y-2">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                      <span>Formal investigation and disciplinary process</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                      <span>Potential dismissal for repeated or gross violations</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                      <span>Reporting to relevant professional bodies if applicable</span>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  misuse. Workers also have a duty not to put themselves or others at risk. On
                  construction sites, where work is{' '}
                  <strong className="text-white">safety-critical</strong>, the consequences of
                  substance-related impairment can be catastrophic &mdash; falls from height,
                  machinery accidents, electrical incidents, and vehicle collisions. The policy must
                  balance the need to protect everyone on site with the duty to support individuals
                  who are struggling.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>Recommend reasonable adjustments or temporary changes to duties</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>Facilitate access to treatment programmes</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      Provide a confidential, non-judgemental assessment separate from the
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      Support a structured return to work after treatment, including monitoring and
                      follow-up
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-purple-400">Remember:</strong> A substance misuse policy
                  should not be purely punitive. Workers who feel they will be immediately sacked if
                  they disclose a problem are far less likely to seek help &mdash; and far more
                  likely to hide their impairment, increasing the risk to themselves and everyone
                  around them. The most effective policies create an environment where workers feel
                  safe to ask for help, while maintaining clear, non-negotiable safety standards. As
                  an MHFA, you can play a crucial role in encouraging this culture &mdash; by being
                  someone people trust to talk to without fear of immediate consequences.
                </p>
              </div>
            </div>
          </div>
