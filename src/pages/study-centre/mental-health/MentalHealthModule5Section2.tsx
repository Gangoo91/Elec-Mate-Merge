...
const faqs = [
  ...
  {
    question: 'What should I do if someone does not want to contact any service I suggest?',
    answer:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['GAD-7', 'PHQ-9', 'AUDIT-C', 'CAGE'],
    correctAnswer: 1,
    explanation:
...
export default function MentalHealthModule5Section2() {
  useSEO({
    title: 'Signposting & Support Services | Mental Health First Aid Module 5.2',
    description:
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-purple-500/5 border-l-2 border-purple-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>NHS Talking Therapies:</strong> Self-refer for anxiety, depression, OCD,
                PTSD &mdash; no GP needed
              </li>
              <li>
                <strong>Crisis:</strong> 999 for immediate danger, NHS 111 option 2 for urgent
                mental health
              </li>
              <li>
                <strong>Text support:</strong> Text SHOUT to 85258 for 24/7 crisis text line
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-purple-500/5 border-l-2 border-purple-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Construction helpline:</strong> Lighthouse Club 0345 605 1956 &mdash;
                emotional, financial &amp; legal support
              </li>
              <li>
                <strong>EAP:</strong> Most employers provide free, confidential counselling &mdash;
                ask HR
              </li>
              <li>
                <strong>Samaritans:</strong> 116 123, free, 24/7, for anyone struggling
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The NHS provides a wide range of mental health services, from talking therapies for
                common conditions like anxiety and depression through to specialist inpatient care
                for severe mental illness. Understanding the structure of these services helps you
                signpost people to the right place, reducing frustration and delays.
              </p>
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 sm:p-6 rounded-lg">
                ...
                <div className="text-sm text-white space-y-3">
                  <p>
                    ...
                    mental health conditions. It provides evidence-based talking therapies including{' '}
                    <strong className="text-white">cognitive behavioural therapy (CBT)</strong>,
                    counselling, interpersonal therapy, and guided self-help.
                  </p>
                  <p>
                    <strong className="text-purple-400">Self-referral is available:</strong> Anyone
                    aged 18 or over in England can refer themselves directly to their local NHS
                    Talking Therapies service without needing a GP referral. This is done online
                    through the NHS website or by contacting the local service directly. This is one
                    of the most important facts for an MHFA to know, because many people believe
                    they must see their GP first.
                  </p>
                  <p>
                    <strong className="text-white">Conditions treated:</strong> Depression,
                    generalised anxiety disorder (GAD), social anxiety, panic disorder, OCD, PTSD,
                    phobias, health anxiety, and body dysmorphic disorder.
                  </p>
                  <p>
                    <strong className="text-white">Waiting times:</strong> The NHS Constitution sets
                    a target of 6 weeks from referral to first treatment, with a maximum wait of 18
                    weeks. However, waits vary significantly by area. If the wait is long, people
                    can explore other options in parallel (voluntary sector, EAP, private therapy)
                    while remaining on the NHS waiting list.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-3">
                  {[
                    ...
                    {
                      service: 'Crisis Resolution and Home Treatment Teams (CRHTTs)',
                      detail:
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-purple-400">Navigating NHS Waiting Times:</strong> Waiting
                  for NHS mental health treatment can be frustrating and demoralising. As an MHFA,
                  you can help by reassuring the person that being on a waiting list{' '}
                  <strong>does not</strong> mean their condition is not being taken seriously,
                  encouraging them to access voluntary sector support or their EAP while they wait,
                  and reminding them they can contact NHS 111 (option 2) if their condition worsens.
                  If someone is deteriorating while waiting, their GP can request an urgent or
                  priority assessment.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                For many people, the GP (general practitioner) is the first point of contact for
                mental health concerns. GPs act as gatekeepers to most NHS mental health services
                and can provide direct treatment for common conditions. Understanding what happens
                at a GP mental health appointment can help you prepare someone and reduce their
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                ...
                <div className="text-sm text-white space-y-2">
                  <p>
                    ...
                    medication they do not want, worry about it affecting their job, and not feeling
                    &ldquo;ill enough&rdquo; to warrant a GP visit.
                  </p>
                  <p>
                    As an MHFA, you can help by normalising the visit (&ldquo;GPs see people for
                    mental health every day &mdash; it is one of the most common reasons for
                    appointments&rdquo;), explaining what will happen (reducing uncertainty),
                    reassuring them about confidentiality, and offering practical support
                    (&ldquo;Would it help if I sat with you while you made the call?&rdquo;). Never
                    promise outcomes or give medical advice.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="text-sm text-white space-y-2">
                  <p>
                    ...
                    mental health. The fit note has two options: &ldquo;not fit for work&rdquo; or
                    &ldquo;may be fit for work&rdquo; with recommended adjustments.
                  </p>
                  <p>
                    Common adjustments for mental health include phased return to work, amended
                    duties, altered hours, workplace support, and regular check-ins with a manager.
                    Under the Equality Act 2010, employers have a duty to make reasonable
                    adjustments for employees with disabilities, which can include long-term mental
                    health conditions.
                  </p>
                </div>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Knowing which service to contact in a mental health crisis &mdash; and in what order
                of priority &mdash; is one of the most critical skills for a Mental Health First
                Aider. Different situations require different responses, and using the right service
                ensures the fastest and most appropriate help.
              </p>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 sm:p-6 rounded-lg">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <p className="text-lg font-semibold text-red-400">Crisis Services Priority</p>
                </div>
                <div className="space-y-3">
                  {[
                    {
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="text-sm text-white space-y-2">
                  <p>
                    ...
                    place of safety if they appear to be suffering from a mental disorder and are in
                    immediate need of care or control. The purpose is protective &mdash; it ensures
                    the person receives a mental health assessment within 24 hours.
                  </p>
                  <p>
                    The place of safety is usually a designated suite in a hospital (a
                    &ldquo;Section 136 suite&rdquo;), not a police cell. If police attend a mental
                    health incident on site, they are there to help and to ensure safety &mdash; not
                    to arrest or criminalise the person. Understanding this helps you reassure
                    colleagues who may be frightened by police involvement during a crisis.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  spaces, often open in the evenings and at weekends, where people experiencing a
                  mental health crisis can walk in without an appointment or referral. They are
                  staffed by trained mental health workers and provide a calm, supportive
                  environment as an alternative to A&amp;E. Check your local area for availability
                  &mdash; the NHS website and local Mind branches can help you find what is
                  available near you.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The voluntary sector provides a vital safety net alongside NHS services. Many of
                these organisations offer immediate, free, confidential support without waiting
                lists or referrals. As an MHFA, knowing the key organisations and their contact
                details by heart is essential &mdash; you may need to signpost someone in a moment
                when they cannot easily search for information themselves.
              </p>
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 sm:p-6 rounded-lg">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <p className="text-lg font-semibold text-purple-400">Key Helplines Directory</p>
                </div>
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-purple-400">Tip for MHFAs:</strong> Consider keeping a
                  small card or note in your wallet with the key helpline numbers. In a crisis, you
                  may not have time to search online. At minimum, memorise{' '}
                  <strong>Samaritans (116 123)</strong> and <strong>SHOUT (text 85258)</strong>{' '}
                  &mdash; these two cover phone and text support, both available 24/7.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The construction industry has one of the highest rates of suicide of any sector in
                the UK &mdash; approximately two construction workers take their own lives every
                working day. Recognising this crisis, several organisations provide services
                specifically tailored to the needs of construction workers and their families.
              </p>
                ...
                <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-2">
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        A leading UK charity raising awareness and addressing the stigma of poor
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Provides training, resources, and a framework for organisations to improve
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Partners with major construction firms and trade bodies to create systemic
                        change
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Focuses on awareness, understanding, and creating cultures where people feel
                        able to talk about mental health
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-2">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        The construction industry&rsquo;s dedicated charity, operating a{' '}
                        <strong className="text-white">24/7 helpline (0345 605 1956)</strong>
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Provides free, confidential emotional, financial, and legal support to
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Can help with financial hardship, debt advice, bereavement, family
                        breakdown, and mental health support
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Also offers emergency financial grants for construction workers facing
                        crisis
                      </span>
                    </li>
                  </ul>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-2">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        A practical framework for managing mental health on construction projects,
                        developed by the Construction Leadership Council
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Provides clear, free guidance on identifying and supporting workers with
                        mental health needs
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Includes toolbox talk resources, posters, and an online assessment tool for
                        organisations
                      </span>
                    </li>
                  </ul>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-2">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        The Construction Industry Training Board (CITB) provides mental health
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Offers funded training courses including mental health awareness for
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        The Construction Industry Helpline provides support for a range of personal
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-purple-400">Why Construction-Specific Matters:</strong>{' '}
                  Construction workers are more likely to engage with services that understand their
                  industry. The culture of construction &mdash; long hours, physical demands, job
                  insecurity, time away from home, and a traditionally stoic &ldquo;get on with
                  it&rdquo; attitude &mdash; creates unique pressures. Services like the Lighthouse
                  Club and Mates in Mind understand these pressures and tailor their support
                  accordingly. As an MHFA on a construction site, always mention these alongside
                  generic services.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Employee Assistance Programmes (EAPs) are one of the most underused resources in the
                workplace. Most medium and large employers provide one, but research consistently
                shows that the majority of employees either do not know their organisation has an
                EAP, or do not understand what it offers. As an MHFA, actively signposting to EAPs
                is one of the most practical things you can do.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-3">How EAPs Work</p>
                <div className="space-y-2">
                  {[
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="text-sm text-white space-y-2">
                  <p>
                    ...
                    is often the fastest route to professional support because there is typically no
                    waiting list and no referral process.
                  </p>
                  <p>
                    <strong className="text-white">Practical steps you can take:</strong> Find out
                    your organisation&rsquo;s EAP details and keep them to hand. When signposting,
                    explain what the EAP is, reassure about confidentiality, and offer practical
                    support (&ldquo;Would you like me to find the number for you?&rdquo;). Include
                    EAP details on any wellbeing notice boards or toolbox talk handouts. Normalise
                    usage by mentioning the EAP routinely, not just when someone is in crisis.
                  </p>
                </div>
              </div>
            </div>
