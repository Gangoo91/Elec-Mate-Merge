...
const faqs = [
  {
    question: 'Is stress always bad? I thought some stress was good for you?',
    answer:
  ...
  {
    question: 'Can stress actually cause physical illness, or is it all in your head?',
    answer:
  ...
  {
    question: 'Are employers legally required to do stress risk assessments?',
    answer:
  ...
  {
    question: 'What should I do if I recognise signs of stress in a colleague on site?',
    answer:
...
const MentalHealthModule2Section3 = () => {
  useSEO({
    title: 'Stress & Burnout | Mental Health Module 2 Section 3',
    description:
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="bg-white/5 border border-purple-500/30 rounded-lg p-4 sm:p-6 mb-10">
          ...
          <ul className="space-y-2 text-sm text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                Define workplace stress using the HSE definition and explain the difference between
                pressure and stress
              </span>
            </li>
            <li className="flex items-start gap-3">
              <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0" />
              <span>
                Distinguish between acute and chronic stress and explain how prolonged cortisol
                exposure damages health
              </span>
            </li>
            <li className="flex items-start gap-3">
              <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0" />
              <span>
                Describe the three dimensions of the Maslach Burnout Model and identify signs of
                each
              </span>
            </li>
            <li className="flex items-start gap-3">
              <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0" />
              <span>
                Identify construction-specific stressors and explain why the industry has elevated
                rates of work-related stress
              </span>
            </li>
            <li className="flex items-start gap-3">
              <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0" />
              <span>List and explain the six HSE Management Standards for work-related stress</span>
            </li>
            <li className="flex items-start gap-3">
              <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0" />
              <span>
                Recognise physical, emotional, behavioural, and cognitive signs of stress in
                yourself and others
              </span>
            </li>
          </ul>
          ...
          <div className={`border-l-2 ${borderColours[0]} pl-4 sm:pl-6`}>
            ...
            <div className="space-y-4 text-white">
              <p>
                ...
                <strong>
                  &ldquo;the adverse reaction people have to excessive pressures or other types of
                  demand placed upon them.&rdquo;
                </strong>{' '}
                This definition is important because it makes clear that stress is a{' '}
                <em>reaction</em> &mdash; it is the body and mind&rsquo;s response to demands, not
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  Left unmanaged, it becomes a pathway to serious health conditions including
                  cardiovascular disease, depression, and anxiety disorders.
                </p>
              </div>
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  ...
                  <div className="bg-red-500/10 border border-red-400/30 rounded-lg p-4">
                    ...
                    <ul className="text-white/80 text-xs space-y-2">
                      ...
                      <li className="flex items-start gap-2">
                        <div className="w-1.5 h-1.5 rounded-full bg-red-400 mt-1.5 flex-shrink-0" />
                        <span>Feels overwhelming, uncontrollable, and relentless</span>
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm mb-3">
                  ...
                  people in the same role can respond very differently to the same workload: their
        ...
        <section className="mb-10">
          <div className={`border-l-2 ${borderColours[1]} pl-4 sm:pl-6`}>
            ...
            <div className="space-y-4 text-white">
              <p>
                Understanding the difference between acute and chronic stress is essential because
                they have very different causes, durations, and health consequences. Both involve
                the same physiological stress response, but the timeline and cumulative impact
                differ dramatically.
              </p>
                ...
                <div className="bg-violet-500/10 border border-violet-400/30 rounded-lg p-4">
                  ...
                  <ul className="text-white/70 text-xs space-y-1.5">
                    ...
                    <li className="flex items-start gap-2">
                      <div className="w-1.5 h-1.5 rounded-full bg-violet-400 mt-1.5 flex-shrink-0" />
                      <span>
                        Examples: near-miss on site, client confrontation, inspection deadline
                      </span>
                    </li>
                  </ul>
                </div>
                <div className="bg-red-500/10 border border-red-400/30 rounded-lg p-4">
                  ...
                  <ul className="text-white/70 text-xs space-y-1.5">
                    ...
                    <li className="flex items-start gap-2">
                      <div className="w-1.5 h-1.5 rounded-full bg-red-400 mt-1.5 flex-shrink-0" />
                      <span>
                        Examples: ongoing job insecurity, persistent bullying, unmanageable workload
                        over months
                      </span>
                    </li>
                  </ul>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                <div className="flex items-start gap-2 mb-2">
                  ...
                  <h3 className="font-semibold text-red-300">How Chronic Stress Damages Health</h3>
                </div>
        ...
        <section className="mb-10">
          <div className={`border-l-2 ${borderColours[2]} pl-4 sm:pl-6`}>
            ...
            <div className="space-y-4 text-white">
              <p>
                Burnout is the end-stage of chronic, unmanaged workplace stress. The most widely
                used and researched framework for understanding burnout is the{' '}
                <strong>Maslach Burnout Inventory (MBI)</strong>, developed by Christina Maslach and
                Susan Jackson in 1981. It identifies three interconnected dimensions that, together,
              ...
              <div className="bg-white/5 border border-purple-400/30 rounded-lg p-4 sm:p-6">
                        ...
                        <div key={dim.dimension} className="relative">
                          ...
                          >
                            <div className="flex items-center gap-2 mb-2">
                              ...
                              <span className={`font-semibold text-xs sm:text-sm ${dim.textClass}`}>
                                {dim.dimension}
                              </span>
                            </div>
                            <p className="text-white/70 text-xs leading-relaxed">
                ...
                <div className="space-y-4">
                  {burnoutDimensions.map((dim) => (
                    ...
                    >
                      <h4 className={`${dim.textClass} font-semibold text-sm mb-3`}>
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  managed. It develops gradually and often goes unrecognised until the person
                  reaches crisis point. Early recognition of the warning signs in each dimension is
        ...
        <section className="mb-10">
          <div className={`border-l-2 ${borderColours[3]} pl-4 sm:pl-6`}>
            ...
            <div className="space-y-4 text-white">
              <p>
                The construction industry has specific characteristics that make it a high-risk
                environment for work-related stress. While all industries face stress challenges,
                construction workers are exposed to a unique combination of physical, environmental,
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                ...
                <ul className="text-white/80 text-sm space-y-3">
                  <li className="flex items-start gap-3">
                    ...
                    <span>
                      According to HSE data, stress, depression, and anxiety account for a
                      significant proportion of all work-related ill health cases in the
                      construction sector
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-400 mt-2 flex-shrink-0" />
                    <span>
                      The construction industry consistently reports high rates of working days lost
                      to stress compared to other sectors
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-400 mt-2 flex-shrink-0" />
                    <span>
                      ...
                      <strong>significantly elevated risk of suicide</strong> compared to the
                      general male population &mdash; the ONS reports that male construction workers
                      have one of the highest suicide rates of any occupational group in England and
                      Wales
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-400 mt-2 flex-shrink-0" />
                    <span>
                      Presenteeism (working while unwell) is widespread in construction, masking the
                      true scale of stress-related illness and reducing productivity further
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  change the culture around mental health in construction. As a Mental Health First
                  Aider, you can contribute by modelling openness, checking in on colleagues, and
        ...
        <section className="mb-10">
          <div className={`border-l-2 ${borderColours[4]} pl-4 sm:pl-6`}>
            ...
            <div className="space-y-4 text-white">
              <p>
                The HSE has developed a comprehensive framework for assessing and managing
                work-related stress. At its core are the <strong>six Management Standards</strong>{' '}
                &mdash; areas of work design that, if not properly managed, are associated with poor
                ...
                <ul className="text-white space-y-3 text-sm">
                  <li className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-violet-400/20 border border-violet-400/40 flex items-center justify-center flex-shrink-0 mt-0.5">
                      <span className="text-violet-300 text-xs font-mono font-bold">1</span>
                    </div>
                    <div>
                      <strong>Identify the hazards:</strong> Use the six Management Standards as
                      your framework. Gather data through surveys, focus groups, sickness absence
                      records, and one-to-one conversations
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-violet-400/20 border border-violet-400/40 flex items-center justify-center flex-shrink-0 mt-0.5">
                      <span className="text-violet-300 text-xs font-mono font-bold">2</span>
                    </div>
                    <div>
                      <strong>Decide who might be harmed and how:</strong> Consider all workers,
                      including those on temporary contracts, agency workers, apprentices, and lone
                      workers. Some groups may be at higher risk
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-violet-400/20 border border-violet-400/40 flex items-center justify-center flex-shrink-0 mt-0.5">
                      <span className="text-violet-300 text-xs font-mono font-bold">3</span>
                    </div>
                    <div>
                      <strong>Evaluate the risks:</strong> Compare your findings against the
                      Management Standards. Are current controls adequate? What more needs to be
                      done?
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-violet-400/20 border border-violet-400/40 flex items-center justify-center flex-shrink-0 mt-0.5">
                      <span className="text-violet-300 text-xs font-mono font-bold">4</span>
                    </div>
                    <div>
                      <strong>Record and implement findings:</strong> Document identified risks and
                      the actions you will take. Assign responsibility and set timescales for
                      implementation
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-violet-400/20 border border-violet-400/40 flex items-center justify-center flex-shrink-0 mt-0.5">
                      <span className="text-violet-300 text-xs font-mono font-bold">5</span>
                    </div>
                    <div>
                      <strong>Review and update regularly:</strong> Stress risks change as projects,
                      teams, and circumstances evolve. Review your assessment at least annually, or
              ...
              <div className="bg-white/5 border border-purple-500/30 p-4 rounded-lg">
                ...
                <ul className="text-white/80 text-sm space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0" />
                    <span>
                      Results can be benchmarked against national data to see how your organisation
                      compares
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0" />
                    <span>
                      Identifies which of the six standards need the most attention in your
                      workplace
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0" />
                    <span>
                      It is an <strong>organisational-level tool</strong> &mdash; it assesses
                      working conditions, not individual vulnerability
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0" />
                    <span>
                      Available free from the HSE website and can be administered online or on paper
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          <div className={`border-l-2 ${borderColours[5]} pl-4 sm:pl-6`}>
            ...
            <div className="space-y-4 text-white">
              <p>
                Stress manifests across four domains: physical, emotional, behavioural, and
                cognitive. Learning to recognise these signs &mdash; in yourself and in the people
                around you &mdash; is one of the most important skills a Mental Health First Aider
                can develop. Early recognition allows early intervention, before problems escalate
                to crisis point.
              </p>
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                ...
                <ul className="text-white/80 text-sm space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong>Look for change:</strong> A previously punctual worker arriving late.
                      A sociable person becoming withdrawn. A careful electrician making unusual
                      mistakes
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-violet-400 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong>Notice clusters:</strong> One bad day is normal. Multiple signs across
                      different domains (physical + behavioural + emotional) sustained over weeks is
                      a warning
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-violet-400 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong>Trust your instinct:</strong> If someone &ldquo;doesn&rsquo;t seem
                      right,&rdquo; they probably aren&rsquo;t. A gentle, private conversation can
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  error, or fail to follow safety procedures. The HSE recognises that work-related
                  stress is a contributing factor in many workplace incidents. Managing stress is
        ...
        {/* -------------------------------------------------------- */}
        <div className="mt-12">
          <Quiz title="Stress & Burnout Quiz" questions={quizQuestions} />
        </div>
