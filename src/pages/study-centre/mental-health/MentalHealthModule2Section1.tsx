...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    question:
      'In the NICE stepped care model for depression, what is typically the first intervention offered at Step 1?',
    options: [
    ...
    correctIndex: 2,
    explanation:
      'Step 1 of the NICE stepped care model involves recognition, assessment, and active monitoring. For mild depression, this includes guided self-help, psychoeducation (helping the person understand their condition), sleep hygiene advice, and lifestyle changes such as exercise. Medication is typically introduced at Step 2 or above if symptoms persist or worsen.',
  },
];
...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      "Persistent Depressive Disorder (formerly called dysthymia) is a chronic form of depression where symptoms are present most days for at least 2 years. While the symptoms may be less severe than Major Depressive Disorder, the long duration means it can be equally disabling over time. People with dysthymia may experience periods of major depression on top of their chronic symptoms (known as 'double depression').",
  },
  {
    id: 4,
    question:
  ...
  },
  {
    id: 5,
    question:
      'In the NICE stepped care model, at which step are antidepressant medications typically first introduced?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'NICE guidelines recommend that antidepressants (typically SSRIs such as sertraline or fluoxetine) may be considered at Step 2 for persistent sub-threshold depressive symptoms or mild to moderate depression that has not responded to initial interventions. At Step 3, antidepressants are more routinely offered alongside psychological therapy for moderate to severe depression. Step 1 focuses on active monitoring and self-help, while Step 4 is for severe, complex, or treatment-resistant cases.',
  },
  {
    id: 6,
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      "Seasonal Affective Disorder (SAD) is a form of depression that follows a seasonal pattern, most commonly beginning in autumn and persisting through winter. It is linked to reduced sunlight exposure, which affects the body's production of melatonin (sleep hormone) and serotonin (mood-regulating neurotransmitter). Symptoms include low mood, fatigue, oversleeping, carbohydrate cravings, and social withdrawal. Treatment includes light therapy, CBT, and sometimes antidepressants.",
  },
  {
    id: 8,
    question:
      'According to UK guidelines, what is the recommended first point of contact for someone who thinks they may be experiencing depression?',
    options: [
    ...
    correctAnswer: 2,
    explanation:
      'The GP is the recommended first point of contact for anyone experiencing symptoms of depression. The GP can carry out an initial assessment (often using tools like the PHQ-9 questionnaire), rule out physical causes, discuss treatment options, and refer to talking therapies (via IAPT/NHS Talking Therapies) or specialist mental health services if needed. The GP acts as the gatekeeper to the NHS stepped care model for depression.',
  },
];
...
export default function MentalHealthModule2Section1() {
  useSEO({
    ...
    description:
      'Learn about clinical depression versus low mood, types of depression, symptoms across four categories, risk factors including construction-specific factors, workplace impact, and NICE guidelines for treatment.',
  });
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
            ...
            <div className="rounded-lg p-3 sm:p-4 bg-purple-500/10 border-l-2 border-l-purple-500/50 border border-purple-500/30">
              ...
              <ul className="text-base text-white space-y-1.5">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong>Not the same as sadness:</strong> Clinical depression is a medical
                    condition, not a character weakness.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Duration matters:</strong> Symptoms must persist for at least 2 weeks,
                ...
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Four symptom types:</strong> Emotional, physical, cognitive, and
                    behavioural.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>GP first:</strong> The GP is the gateway to NHS treatment via the
                    stepped care model.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Recovery is possible:</strong> With the right support, most people
            ...
            <div className="rounded-lg p-3 sm:p-4 bg-purple-500/10 border-l-2 border-l-purple-500/50 border border-purple-500/30">
              ...
              <ul className="text-base text-white space-y-1.5">
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Construction high-risk:</strong> Male construction workers are 3x more
                    likely to die by suicide than the national average.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Hidden condition:</strong> Depression is often invisible &mdash;
                    colleagues may mask symptoms on site.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Safety critical:</strong> Depression impairs concentration,
                ...
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Start a conversation:</strong> Asking &ldquo;Are you OK?&rdquo; can be
                    the first step to saving a life.
                  </span>
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          ...
          <ul className="space-y-3 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                Distinguish between normal low mood and clinical depression using diagnostic
                criteria
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-purple-400 mt-0.5 flex-shrink-0" />
              <span>
                Identify the main types of depression: MDD, dysthymia, SAD, postnatal, and bipolar
                depression
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-purple-400 mt-0.5 flex-shrink-0" />
              <span>
                Recognise symptoms of depression across four categories: emotional, physical,
            ...
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-purple-400 mt-0.5 flex-shrink-0" />
              <span>
                Explain risk factors for depression, including those specific to construction and
                electrical trades
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-purple-400 mt-0.5 flex-shrink-0" />
              <span>
                Describe how depression affects workplace safety, productivity, and colleague
                relationships
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-purple-400 mt-0.5 flex-shrink-0" />
              <span>
                Outline the NICE stepped care model and the main treatment options available through
                the NHS
              </span>
            </li>
          </ul>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                Everyone experiences periods of low mood. Feeling sad after a bereavement, stressed
                before a deadline, or down after a setback is a normal part of being human. These
                feelings are usually proportionate to the situation, temporary, and manageable with
                everyday coping strategies such as talking to friends, exercising, or simply waiting
                for the feeling to pass.
              </p>

              <p>
                <strong>Clinical depression</strong> (also known as Major Depressive Disorder) is
                fundamentally different. It is a recognised medical condition with specific
                diagnostic criteria, not a sign of weakness or something you can simply &ldquo;snap
                out of&rdquo;. Depression affects the brain&rsquo;s chemistry, particularly the
                neurotransmitters serotonin, noradrenaline, and dopamine, and produces symptoms that
                are persistent, pervasive, and disabling.
              </p>
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  <strong className="text-white">2 weeks</strong>, present{' '}
                  <strong className="text-white">most of the day, nearly every day</strong>, and
                  causing significant impairment in social, occupational, or other important areas
                  of functioning. Diagnosis is based on criteria set out in the ICD-11
                  (International Classification of Diseases) used in UK clinical practice.
                </p>
              </div>
                  ...
                  <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                    ...
                    <ul className="text-white/80 text-sm space-y-2">
                      ...
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                        <span>
                          Loss of interest or pleasure in things you normally enjoy (anhedonia)
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  someone with depression to cheer up is as unhelpful as telling someone with a
                  broken leg to walk it off. This myth is particularly prevalent in male-dominated
                  industries like construction, where it prevents people from seeking the help they
                  need.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                Depression is not a single condition &mdash; it encompasses several related
                disorders, each with distinct characteristics. Understanding the different types
                helps Mental Health First Aiders recognise that depression can present in many ways
                and that treatment approaches may vary.
              </p>
              ...
              <div className="bg-white/5 border border-purple-400/30 p-4 sm:p-6 rounded-lg overflow-x-auto">
                <h3 className="text-purple-400 font-medium mb-4 text-center text-sm uppercase tracking-wider">
                  Types of Depression &mdash; Comparison
                </h3>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                Depression affects the whole person &mdash; not just their mood. Symptoms are
                typically grouped into four categories. As a Mental Health First Aider,
                understanding all four categories helps you recognise depression even when someone
                is not obviously &ldquo;sad&rdquo;. Many people with depression present primarily
                with physical or behavioural symptoms, particularly men in workplace settings.
              </p>
                  ...
                  <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                    ...
                    <ul className="text-white/80 text-sm space-y-1.5">
                      ...
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                        <span>
                          Unexplained aches and pains (headaches, backache, stomach problems)
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  idea &mdash; it gives the person permission to talk. If there is an immediate
                  risk, stay with them and call 999. Samaritans are available 24/7 on{' '}
                  <strong className="text-white">116 123</strong> (free from any phone). Module 3
                  covers suicide awareness and intervention in detail.
                </p>
              </div>
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  <strong className="text-white">
                    irritability, anger, aggression, risk-taking behaviour, and increased alcohol
                    use
                  </strong>
                  . Physical symptoms such as headaches, digestive problems, and chronic pain may
                  dominate. Men are less likely to seek help and more likely to use substances as a
                  coping mechanism. In the construction industry, the culture of &ldquo;getting on
                  with it&rdquo; means many men suffer in silence. Recognising these atypical
                  presentations is crucial for Mental Health First Aiders.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                Depression rarely has a single cause. It typically results from a combination of
                biological, psychological, and social factors. Understanding risk factors helps
                Mental Health First Aiders identify people who may be more vulnerable and recognise
                situations that may trigger or worsen depression.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <strong>Family history:</strong> Having a first-degree relative (parent,
                      sibling) with depression increases your risk by 2&ndash;3 times. Depression
                      has a significant genetic component, though no single gene is responsible.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Brain chemistry:</strong> Imbalances in neurotransmitters (serotonin,
                      noradrenaline, dopamine) play a role in depression. This is the basis for
                  ...
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Chronic physical health conditions:</strong> Long-term conditions such
                      as chronic pain, heart disease, diabetes, and neurological conditions
                  ...
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Hormonal changes:</strong> Postnatal hormonal shifts, thyroid
                      disorders, and menopause can trigger or contribute to depression.
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Negative thinking patterns:</strong> Habitual self-criticism,
                      catastrophising, and black-and-white thinking create a cognitive vulnerability
                      to depression. CBT specifically targets these patterns.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Childhood trauma or abuse:</strong> Adverse childhood experiences
                      (ACEs) such as neglect, physical or sexual abuse, and parental mental illness
                      are strong predictors of adult depression.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Personality traits:</strong> Perfectionism, low self-esteem, and
                      excessive self-reliance (difficulty asking for help) increase vulnerability.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Previous episodes:</strong> Having had one episode of depression
                      significantly increases the risk of future episodes. After two episodes, the
                      recurrence rate exceeds 70%.
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Social isolation and loneliness:</strong> Lack of meaningful social
                      connections is one of the strongest social risk factors for depression,
                      particularly for those who work away from home.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Relationship breakdown:</strong> Divorce, separation, and family
                      conflict are significant triggers.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Bereavement:</strong> While grief is normal, prolonged or complicated
                      grief can develop into clinical depression. Losing someone to suicide is a
                  ...
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Financial problems:</strong> Debt, poverty, and financial insecurity
                      are consistently linked to higher rates of depression.
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                ...
                <ul className="text-white/80 text-sm space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Job insecurity:</strong> Short-term contracts,
                      agency work, and the &ldquo;feast or famine&rdquo; cycle of construction work
                      create chronic uncertainty
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Long and unpredictable hours:</strong> Early
                      starts, overtime pressure, and weekend work disrupt sleep, family life, and
                      social connections
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Working away from home:</strong> Staying in
                      digs or hotels, away from family and friends, increases isolation
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Macho culture:</strong> A prevailing attitude
                      that discourages emotional expression and help-seeking. &ldquo;Man up&rdquo;
                      and &ldquo;get on with it&rdquo; remain common responses
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Bullying and harassment:</strong> Workplace
                      bullying is a significant but under-reported problem in construction
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Physical demands and chronic pain:</strong>{' '}
                      Musculoskeletal problems from manual work can contribute to depression through
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Exposure to traumatic incidents:</strong>{' '}
                      Witnessing accidents or fatalities on site can trigger depression and PTSD
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                Depression is the leading cause of disability worldwide (WHO) and one of the most
                common reasons for long-term sickness absence in the UK. In construction and
                electrical trades, the impact of depression extends beyond lost productivity &mdash;
                it directly affects safety. Understanding how depression manifests in the workplace
                helps Mental Health First Aiders identify colleagues who may be struggling and take
                appropriate action.
              </p>
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  <div className="bg-purple-500/10 border border-purple-500/30 p-3 rounded-lg">
                    ...
                    <p className="text-white/80 text-sm">
                      ...
                      accidents. Research suggests presenteeism from depression costs UK employers
                      <strong className="text-white"> 1.5 to 2 times more</strong> than absenteeism
                      because it is invisible and prolonged.
                    </p>
                  </div>
                  <div className="bg-violet-500/10 border border-violet-500/30 p-3 rounded-lg">
                    ...
                    <p className="text-white/80 text-sm">
                      ...
                      <strong className="text-white">
                        17.1 million working days lost per year
                      </strong>{' '}
                      (HSE, 2023/24). Many depressed workers do not disclose the true reason for
                      absence, citing physical illnesses instead due to stigma. This under-reporting
                      makes the true scale of the problem difficult to measure.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <strong>Impaired concentration:</strong> Missing critical safety checks,
                      misreading wiring diagrams, or overlooking hazards
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-red-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Slowed reaction time:</strong> Delayed response to dangerous
                      situations such as a flash or unexpected energisation
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-red-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Poor decision-making:</strong> Taking shortcuts, failing to follow
                      safe systems of work, or forgetting to isolate circuits
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-red-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Fatigue:</strong> Depression-related fatigue compounds the physical
                      demands of site work, increasing the risk of slips, trips, and falls
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white/80 text-sm space-y-1.5">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      Increased irritability, anger, or short temper (particularly in men)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      Eating alone, avoiding the tea break, or isolating themselves on site
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      Talking about feeling hopeless, worthless, or &ldquo;not seeing the
                      point&rdquo;
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  compensate, or self-medicate with alcohol. The result is that colleagues,
                  supervisors, and even family members may have no idea someone is suffering. This
                  is why the construction sector has one of the highest suicide rates of any UK
                  industry &mdash; by the time depression becomes visible, it has often reached
                  crisis point. Creating a workplace culture where it is safe to talk about mental
                  health is not a &ldquo;nice to have&rdquo; &mdash; it saves lives.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                The National Institute for Health and Care Excellence (NICE) publishes the clinical
                guidelines for the treatment of depression in the UK. The current guidelines
                (CG90/CG91, updated 2022) recommend a<strong> stepped care model</strong> &mdash; a
                framework that matches the intensity of treatment to the severity of depression.
                This ensures that people receive the least intrusive, most effective treatment
                first, with more intensive options available if needed.
              </p>
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  asks nine questions about depressive symptoms over the past two weeks. The GP can
                  diagnose depression, rule out physical causes (such as thyroid disorders or
                  anaemia), and refer to appropriate treatment. As a Mental Health First Aider, your
                  role is to encourage people to see their GP &mdash; not to diagnose or treat.
                </p>
              </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-white/80 text-sm">
                          ...
                          previous steps or who are at significant risk of harm.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-white/80 text-sm">
                          ...
                          Therapy), behavioural activation, or couples therapy.{' '}
                          <strong className="text-white">Antidepressant medication</strong> (SSRIs
                          as first line) offered alongside or as an alternative. Combination therapy
                          (medication + talking therapy) is often most effective at this stage.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-white/80 text-sm">
                          ...
                          <strong className="text-white">NHS Talking Therapies</strong> (formerly
                          IAPT) provides these services. Antidepressants may be considered,
                          particularly <strong className="text-white">SSRIs</strong> (e.g.
                          sertraline, fluoxetine) if the person prefers medication or psychological
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-white/80 text-sm">
                          ...
                          reducing alcohol), and active monitoring (reviewing symptoms at 2-week
                          intervals). For sub-threshold symptoms, watchful waiting may be
                          appropriate.
                        </p>
                      </div>
                    </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>SSRIs (Selective Serotonin Reuptake Inhibitors)</strong> are the
                      first-line medication for depression. Common examples include sertraline,
                      fluoxetine, citalopram, and escitalopram. They work by increasing serotonin
                      levels in the brain.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>SNRIs (Serotonin and Noradrenaline Reuptake Inhibitors)</strong> such
                      as venlafaxine and duloxetine may be offered if SSRIs are not effective. They
                      target both serotonin and noradrenaline.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Timeline:</strong> Antidepressants typically take{' '}
                      <strong>2&ndash;4 weeks</strong> to show benefit. Side effects (nausea,
                      headache, sleep disturbance) often settle within 1&ndash;2 weeks. Treatment
                      should continue for at least <strong>6 months after remission</strong> to
                      reduce relapse risk.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Never stop suddenly:</strong> Antidepressants should be tapered
                      gradually under GP supervision to avoid discontinuation symptoms (dizziness,
                      nausea, anxiety, flu-like sensations).
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <strong>CBT (Cognitive Behavioural Therapy):</strong> The most extensively
                      evidenced talking therapy for depression. Focuses on identifying and changing
                      negative thought patterns and behaviours. Typically 12&ndash;20 sessions.
                      Available through NHS Talking Therapies (self-referral in most areas).
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Counselling:</strong> Person-centred approach that provides a safe
                      space to explore feelings and experiences. Often preferred by people who find
                      CBT too structured. Usually 6&ndash;12 sessions.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>IPT (Interpersonal Therapy):</strong> Focuses on improving
                      relationships and communication patterns that may be contributing to
                      depression. Particularly effective for depression triggered by relationship
                      difficulties, role transitions, or bereavement. Usually 12&ndash;16 sessions.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Behavioural Activation:</strong> Focuses on gradually increasing
                      engagement in meaningful activities to break the cycle of withdrawal and low
                      mood. Can be particularly accessible and practical for people who struggle
                      with the cognitive focus of CBT.
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  . Recovery rates with appropriate treatment are high: approximately 50% of people
                  recover from a first episode within 6 months, and the combination of medication
                  and psychological therapy is the most effective approach for moderate to severe
                  depression. Recovery is not always linear &mdash; there may be setbacks &mdash;
                  but with persistence and the right support, most people return to full
                  functioning. As a Mental Health First Aider, one of the most important things you
                  can communicate to someone experiencing depression is that
