...
const faqs = [
  {
    question: 'Is self-harm always a sign that someone wants to end their life?',
    answer:
  ...
  {
    question: 'Is it true that talking about self-harm can encourage people to start doing it?',
    answer:
  ...
  {
    question: 'What is the harm minimisation approach, and is it appropriate?',
    answer:
...
const quizQuestions = [
  ...
  {
    id: 2,
    question: 'Which of the following is recognised as a form of self-harm?',
    options: [
      'Only cutting',
  ...
  {
    id: 3,
    question: 'A colleague discloses that they self-harm. Which response follows MHFA principles?',
    options: [
  ...
  },
  {
    ...
    options: ['Mind', 'Samaritans', 'Papyrus (HOPELINEUK)', 'Rethink Mental Illness'],
    correctAnswer: 2,
    explanation:
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-white leading-relaxed">
                ...
                out to the <strong className="text-white">Samaritans</strong> on{' '}
                <strong className="text-white">116 123</strong> (free, 24/7) or text{' '}
                <strong className="text-white">SHOUT</strong> to{' '}
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-purple-500/5 border-l-2 border-purple-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Self-harm:</strong> Deliberate injury to oneself &mdash; NOT always a
                suicide attempt
              </li>
              <li>
                <strong>Response:</strong> Non-judgemental listening, validate feelings, use ALGEE
              </li>
              <li>
                <strong>First aid:</strong> Treat injuries, call 999 for overdose or deep wounds
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-purple-500/5 border-l-2 border-purple-500/50">
            <p className="text-purple-400/90 text-base font-medium mb-2">Key Principle</p>
            <ul className="text-base text-white space-y-1.5">
              <li>
              ...
              <li>
                <strong>DO</strong> ask what they need and encourage professional help
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Self-harm is the deliberate act of injuring oneself. It is sometimes called{' '}
                <strong>non-suicidal self-injury (NSSI)</strong> when the intention is not to end
                one&rsquo;s life. It is important to understand from the outset that{' '}
                <strong className="text-purple-400">
                  self-harm is not always a suicide attempt
                </strong>
                . While self-harm and suicide are related &mdash; and people who self-harm are at
                higher statistical risk of suicide &mdash; the motivations behind self-harm are
                often quite different from suicidal intent.
              </p>

              <p>
                For many people, self-harm is a <strong>coping mechanism</strong> for overwhelming
                emotional pain. When feelings become too intense to bear &mdash; grief, anxiety,
                shame, anger, numbness, or trauma &mdash; some individuals find that physical pain
                provides a temporary release or sense of control. Understanding this is essential
                for anyone providing Mental Health First Aid, because it shapes how we respond.
              </p>

              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-purple-400">Prevalence:</strong> Research suggests that
                  approximately <strong>1 in 4 young people</strong> in the UK have self-harmed at
                  some point. However, self-harm is not limited to young people &mdash; it affects{' '}
                  <strong>all ages, genders, and backgrounds</strong>. There is increasing
                  recognition that self-harm in adults, particularly adult males, is significantly
                  under-reported. In the construction industry, where mental health stigma remains
                  high and emotional expression is often discouraged, the true prevalence may be
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Self-harm is <strong className="text-white">not attention-seeking</strong>{' '}
                      &mdash; most people who self-harm go to great lengths to hide it. Many feel
                      deep shame about their behaviour
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      Self-harm is a{' '}
                      <strong className="text-white">sign of emotional distress</strong>, not a
                      character flaw, moral failing, or choice made for drama
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      ...
                      <strong className="text-white">highest rates of self-harm in Europe</strong>,
                      with hospital admissions for self-harm injuries rising in recent years
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      ...
                      <strong className="text-white">never present to hospital</strong> &mdash; they
                      treat their injuries privately, meaning the true scale is much larger than
                      official figures
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Recovery is possible</strong> &mdash; with the
                      right support, people can and do find healthier ways to cope with emotional
                      pain
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  person someone trusts enough to tell. Your response in that moment can make a
                  significant difference to their willingness to seek help.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                When people think of self-harm, they most commonly think of cutting. However, the
                range of self-harming behaviours is{' '}
                <strong>much broader than many people realise</strong>. As a Mental Health First
                Aider, it is important to recognise the full spectrum so that you do not overlook
                signs that someone may be hurting themselves.
              </p>
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-purple-400">Important:</strong> Some of these behaviours
                  &mdash; such as excessive exercise, substance misuse, or reckless behaviour
                  &mdash; may not be immediately recognised as self-harm by the person doing them,
                  or by those around them. On a construction site, a worker who is deliberately
                  taking unnecessary risks or consistently ignoring safety procedures may be
                  engaging in a form of self-harm. This does not mean every risk-taker is
                  self-harming, but it is worth considering as a possibility, particularly if
                  combined with other signs of emotional distress.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Understanding <em>why</em> someone self-harms is essential for responding with
                empathy rather than judgement. There is no single reason &mdash; people self-harm
                for many different reasons, and an individual may have more than one motivation.
              ...
              <div className="space-y-3">
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-white">
                    ...
                    something physical that I can deal with.&rdquo; The body also releases
                    endorphins in response to physical injury, which can create a brief period of
                    calm.
                  </p>
                </div>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-white">
                    ...
                    attempt to make internal pain visible and understood.
                  </p>
                </div>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-white">
                    ...
                    stress, financial pressure, relationship breakdown, or other circumstances
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-white">
                    ...
                    moment. This is particularly associated with experiences of trauma or
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-purple-400">Every Reason is Valid:</strong> As a Mental
                  Health First Aider, you do not need to fully understand <em>why</em> someone is
                  self-harming in order to help them. What matters most is that you accept their
                  experience without judgement, acknowledge their pain as real, and support them
                  towards professional help. Never dismiss or minimise someone&rsquo;s reasons for
                  self-harming.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                How you respond when someone discloses self-harm can have a profound impact on
                whether they seek help or withdraw further into isolation. Your reaction in that
                moment matters enormously. The following principles should guide your response as a
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      &mdash; even if you are shocked, keep your expression and tone calm. An
                      extreme reaction can cause shame and make the person regret telling you
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Do NOT insist they stop immediately</strong>{' '}
                      &mdash; demanding that someone stop self-harming removes their coping
                      mechanism without offering an alternative, which can increase distress and
                      risk
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Do NOT minimise or dismiss</strong> &mdash;
                      avoid saying things like &ldquo;it could be worse&rdquo;, &ldquo;just think
                      positive&rdquo;, or &ldquo;other people have real problems&rdquo;
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Do NOT make promises you cannot keep</strong>{' '}
                      &mdash; do not promise complete confidentiality if you believe there is a risk
                      to life, as you may need to involve emergency services
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Do NOT try to be their therapist</strong>{' '}
                      &mdash; your role is to provide initial support, not ongoing treatment.
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Stay calm</strong> &mdash; your calm, measured
                      response signals safety. Take a breath before you speak
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Thank them for trusting you</strong> &mdash;
                      acknowledge the courage it took to disclose. &ldquo;Thank you for telling me.
                      That must have been difficult.&rdquo;
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Listen without judgement</strong> &mdash; give
                      them space to talk at their own pace. Do not interrupt, interrogate, or
                      cross-examine. Use open questions: &ldquo;Can you tell me more about
                      what&rsquo;s been happening?&rdquo;
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Validate their feelings</strong> &mdash;
                      &ldquo;It sounds like you&rsquo;ve been dealing with a lot. Your feelings are
                      completely valid.&rdquo;
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Ask what they need</strong> &mdash; &ldquo;What
                      would be most helpful for you right now?&rdquo; This empowers the person and
                      avoids assumptions
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Gently ask about safety</strong> &mdash;
                      &ldquo;Are you having any thoughts of ending your life?&rdquo; This direct
                      question is important. Asking about suicide does NOT increase risk &mdash; it
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-purple-400">Practical First Aid for Injuries:</strong> If
                  someone has self-harm injuries that need attention, provide physical first aid
                  calmly and without judgement. Treat the wounds as you would any other injury. The
                  person may feel embarrassed &mdash; your matter-of-fact, caring approach to wound
                  care will help reduce their shame.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                As a Mental Health First Aider, you may encounter situations where someone has
                self-harm injuries that need physical first aid. Treat these injuries with the same
                care and professionalism you would apply to any wound, while being mindful of the
                emotional context.
              </p>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-2">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                      <span>
                        Wear <strong className="text-white">nitrile gloves</strong> before touching
                        any wound
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Clean the wound</strong> gently under running
                        tap water
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Apply pressure</strong> with a clean sterile
                    ...
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        ...
                        <strong className="text-white">sterile dressing</strong> once bleeding is
                        controlled
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                      <span>For minor cuts, wound closure strips may be appropriate</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                      <span>
                        Advise the person to see a GP if the wound shows signs of infection
                ...
                <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-2">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Deep wounds</strong> that will not stop
                        bleeding, or wounds that expose muscle, fat, or bone
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Overdose</strong> of any medication or
                        substance &mdash; even if the person appears well
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Unconsciousness</strong> or reduced level of
                        consciousness
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Difficulty breathing</strong> or any signs of
                        anaphylaxis
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                      <span>
                        The person expresses <strong className="text-white">suicidal intent</strong>{' '}
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Burns</strong> that are larger than the
                        person&rsquo;s hand or on the face, hands, feet, or joints
                      </span>
                    </li>
                  </ul>
                </div>
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Do NOT induce vomiting</strong> &mdash; this
                      can cause additional harm, particularly with corrosive substances
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Keep the packaging</strong> &mdash; save any
                      containers, packaging, or remaining tablets to give to paramedics. Note the
                      time of ingestion and the estimated amount taken
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      ...
                      <strong className="text-white">unconscious but breathing</strong>, place them
                      in the <strong className="text-white">recovery position</strong> to protect
                      their airway
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      <strong className="text-white">CPR</strong> and continue until paramedics
                      arrive
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Stay with the person</strong> at all times
                      &mdash; do not leave them alone
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-purple-400">A Note on Tone:</strong> When providing first
                  aid for self-harm injuries, be calm, gentle, and matter-of-fact. Avoid making
                  comments about the injuries themselves (such as &ldquo;why would you do this to
                  yourself?&rdquo;). Focus on treating the wound and ensuring the person&rsquo;s
                  physical safety. Your compassionate, non-judgemental approach to their injuries is
                  itself a form of mental health support &mdash; it demonstrates that they are
                  worthy of care.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Mental Health First Aid is initial support &mdash; the first response, not the
                ongoing treatment. Once you have provided immediate support, it is important to
                guide the person towards professional services that can provide the sustained help
                they need. The following pathways are available in the UK.
              </p>
              ...
              <div className="space-y-3">
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-white">
                    ...
                    and arrange urgent psychiatric assessment if needed. Encourage the person to be
                    honest with their GP about the self-harm &mdash; GPs are trained to respond
                    sensitively.
                  </p>
                </div>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-white">
                    ...
                    without needing a hospital admission. A&amp;E departments also have mental
                    health liaison teams available around the clock for people in acute crisis.
                  </p>
                </div>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-white">
                    ...
                    condition; conducting a psychosocial assessment before discharge from hospital;
                    offering therapeutic interventions tailored to the individual; and involving the
                    person in decisions about their care. NICE emphasises that people who self-harm
                    must be treated with compassion, dignity, and respect at every stage.
                  </p>
                </div>
                  ...
                  <div className="space-y-2">
                    <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                      ...
                      <p className="text-xs text-white">
                        ...
                        effective for reducing self-harming behaviour.
                      </p>
                    </div>
                    <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                      <p className="text-sm font-medium text-violet-400 mb-0.5">
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-white">
                    ...
                    self-harm while the person works towards recovery. This may include wound care
                    education, safer alternatives during moments of crisis (such as holding ice
                    cubes, snapping a rubber band, or drawing on the skin with a red pen), and
                    developing a personal safety plan. This approach is supported by several NHS
              ...
              <div className="bg-gradient-to-br from-purple-500/10 to-violet-500/10 border border-purple-500/30 p-5 rounded-xl">
                ...
                <div className="grid sm:grid-cols-2 gap-3">
                  ...
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    <p className="text-sm font-medium text-white">Self-Injury Support</p>
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-purple-400">Supporting Recovery Without Enabling:</strong>{' '}
                  Supporting someone who self-harms means being consistent, compassionate, and
                  patient. It does <strong>not</strong> mean taking responsibility for their
                  behaviour, covering for them, or becoming their sole source of support. Maintain
                  your own boundaries, look after your own wellbeing, and encourage the person
                  towards professional services. Recovery from self-harm takes time &mdash; setbacks
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  or use one of the helplines listed above. You cannot pour from an empty cup. As a
                  Mental Health First Aider, looking after yourself is not optional &mdash; it is
                  essential.
                </p>
              </div>
            </div>
