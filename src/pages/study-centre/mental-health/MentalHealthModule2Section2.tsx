...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['Serotonin', 'Insulin', 'Adrenaline (epinephrine)', 'Melatonin'],
    correctIndex: 2,
    explanation:
  ...
  },
  {
    ...
    question: 'What is the typical duration of a panic attack?',
    options: ['Less than 1 minute', '5 to 20 minutes', '1 to 2 hours', '24 hours or more'],
    correctIndex: 1,
    explanation:
...
const faqs = [
  {
    question: 'What is the difference between feeling anxious and having an anxiety disorder?',
    answer:
  ...
  {
    question: 'Can anxiety cause physical symptoms that feel like a heart attack?',
    answer:
  ...
  {
    question: 'Is Generalised Anxiety Disorder (GAD) the same as just being a worrier?',
    answer:
  ...
  {
    question: 'How should I help someone who is having a panic attack?',
    answer:
  ...
  {
    question: 'Can someone have more than one anxiety disorder at the same time?',
    answer:
  ...
  {
    question: 'Is OCD really an anxiety disorder?',
    answer:
...
const quizQuestions = [
  ...
  {
    id: 5,
    question: 'What is the recommended first aid technique for someone having a panic attack?',
    options: [
...
export default function MentalHealthModule2Section2() {
  useSEO({
    title: 'Anxiety Disorders | Mental Health First Aid Module 2 Section 2',
    description:
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-purple-500/5 border-l-2 border-purple-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Prevalence:</strong> 8 million people in the UK have an anxiety disorder
              </li>
              <li>
                <strong>Core feature:</strong> Persistent, excessive worry that interferes with
                daily life
              </li>
              <li>
                <strong>Key response:</strong> Fight-flight-freeze &mdash; adrenaline &amp; cortisol
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-purple-500/5 border-l-2 border-purple-500/50">
            <p className="text-purple-400/90 text-base font-medium mb-2">Key Facts</p>
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Most common:</strong> GAD is the most prevalent anxiety disorder in the UK
              </li>
              <li>
                <strong>Panic attacks:</strong> Typically last 5&ndash;20 minutes, always
                self-limiting
              </li>
              <li>
                <strong>Co-occurrence:</strong> ~60% of people with anxiety also have depression
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Anxiety is a <strong>normal, healthy human emotion</strong>. It is the feeling of
                unease, worry, or fear that we all experience when facing something uncertain,
                challenging, or potentially threatening &mdash; an exam, a job interview, a visit to
                the dentist, or walking down a dark street at night. In these situations, anxiety
                serves a useful purpose: it sharpens our attention, motivates us to prepare, and
                helps us stay alert to danger.
              </p>
              ...
              <ul className="space-y-2 text-white">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong>Persistent</strong> &mdash; lasting weeks, months, or years rather than
                    resolving once the situation has passed
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-purple-400 flex-shrink-0" />
                  <span>
                    <strong>Excessive and disproportionate</strong> &mdash; the level of fear or
                    worry is far greater than the actual threat warrants
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-purple-400 flex-shrink-0" />
                  <span>
                    <strong>Difficult to control</strong> &mdash; the person cannot simply
                    &ldquo;switch off&rdquo; the worry, even when they recognise it is irrational
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-purple-400 flex-shrink-0" />
                  <span>
                    <strong>Interferes with daily life</strong> &mdash; causing significant problems
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-purple-400">UK Prevalence:</strong> Approximately{' '}
                  <strong>8 million people</strong> in the United Kingdom are living with a
                  diagnosable anxiety disorder at any given time. Anxiety disorders are the most
                  common group of mental health conditions, affecting around{' '}
                  <strong>1 in 6 adults</strong> every week (NHS Digital, Adult Psychiatric
                  Morbidity Survey). Women are roughly twice as likely as men to be diagnosed with
                  an anxiety disorder, though this may partly reflect differences in help-seeking
                  behaviour.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Genetics</strong> &mdash; anxiety disorders
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Childhood experiences</strong> &mdash; trauma,
                      abuse, neglect, or prolonged adversity in early life
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Life events</strong> &mdash; bereavement,
                      redundancy, divorce, financial problems, or major illness
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Personality traits</strong> &mdash;
                      perfectionism, a tendency to catastrophise, or low self-esteem
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Chronic stress</strong> &mdash; ongoing
                      workplace pressure, caring responsibilities, or relationship difficulties
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Substance use</strong> &mdash; alcohol,
                      caffeine, cannabis, and stimulants can trigger or worsen anxiety
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                There are several distinct types of anxiety disorder, each with its own pattern of
                symptoms and triggers. Understanding the differences is important for mental health
                first aiders so that you can recognise what someone may be experiencing and offer
                appropriate support.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 rounded-lg p-4 sm:p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="relative bg-red-500/10 border-2 border-red-500/30 rounded-lg p-4">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <h5 className="font-bold text-red-300 text-sm">Panic Disorder</h5>
                    </div>
                    <div className="grid sm:grid-cols-3 gap-3 text-sm">
                      <div>
                  ...
                  <div className="relative bg-violet-500/10 border-2 border-violet-500/30 rounded-lg p-4">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <h5 className="font-bold text-violet-300 text-sm">Social Anxiety Disorder</h5>
                    </div>
                    <div className="grid sm:grid-cols-3 gap-3 text-sm">
                      <div>
                  ...
                  <div className="relative bg-amber-500/10 border-2 border-amber-500/30 rounded-lg p-4">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <h5 className="font-bold text-amber-300 text-sm">Specific Phobias</h5>
                    </div>
                    <div className="grid sm:grid-cols-3 gap-3 text-sm">
                      <div>
                  ...
                  <div className="relative bg-teal-500/10 border-2 border-teal-500/30 rounded-lg p-4">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <h5 className="font-bold text-teal-300 text-sm">Agoraphobia</h5>
                    </div>
                    <div className="grid sm:grid-cols-3 gap-3 text-sm">
                      <div>
                ...
                <div className="mt-4 bg-purple-500/10 border border-purple-500/30 rounded-lg p-3 text-center">
                  <p className="text-purple-300 text-xs sm:text-sm font-semibold">
                    Anxiety disorders frequently co-occur &mdash; a person may have more than one
              ...
              <p>
                ...
                <strong>Generalised Anxiety Disorder (GAD)</strong>. It is characterised by
                persistent, excessive worry about a broad range of topics &mdash; health, work,
                finances, relationships &mdash; that the person finds very difficult to control.
                Physical symptoms include restlessness, fatigue, difficulty concentrating,
                irritability, muscle tension, and sleep disturbance. NICE guidelines recommend
                stepped care, beginning with guided self-help and Cognitive Behavioural Therapy
                (CBT), progressing to medication (usually SSRIs) for moderate-to-severe cases.
              </p>

              <p>
                <strong>Social Anxiety Disorder</strong> (sometimes called social phobia) is the
                third most common mental health condition in the world. People with social anxiety
                experience an intense fear of social situations where they might be observed,
                judged, or embarrassed &mdash; meetings, presentations, eating in public, using the
                telephone, or even walking into a room. This goes far beyond normal shyness and can
                severely limit a person&rsquo;s education, career, and personal relationships.
              </p>

              <p>
                <strong>Agoraphobia</strong> is widely misunderstood. It is not simply a &ldquo;fear
                of open spaces&rdquo; but a fear of being in situations where escape might be
                difficult or help might not be available &mdash; particularly if a panic attack
                occurs. Crowded shopping centres, public transport, queues, and bridges are common
                triggers. In severe cases, the person may become unable to leave their home.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The <strong>fight-flight-freeze response</strong> is an automatic, involuntary
                survival mechanism that has evolved over millions of years to protect humans from
                physical danger. When the brain perceives a threat &mdash; whether a predator, a
                fire, or (in modern life) a confrontation with a manager or a packed train carriage
                &mdash; the <strong>amygdala</strong> (the brain&rsquo;s threat-detection centre)
                triggers an instant cascade of physiological changes designed to prepare the body to{' '}
                <strong>fight</strong> the threat, <strong>flee</strong> from it, or{' '}
                  ...
                  {[
                    {
                      ...
                      detail: 'Pumps blood faster to muscles, preparing for physical action',
                    },
                    {
                      label: 'Breathing becomes rapid and shallow',
                      detail: 'Increases oxygen intake to fuel muscles and brain',
                    },
                    {
                      label: 'Muscles tense',
                      detail: 'Prepares for explosive movement — running or striking',
                    },
                    {
                      label: 'Pupils dilate',
                      detail: 'Allows more light in to improve visual awareness of surroundings',
                    },
                    {
                    ...
                    },
                    {
                      ...
                      detail: 'Cools the body in preparation for physical exertion',
                    },
                    {
                      label: 'Blood sugar rises',
                      detail: 'Cortisol releases stored glucose for immediate energy',
                    },
                    {
                      label: 'Non-essential functions suppress',
                      detail: 'Digestion, immune function, and reproductive processes slow down',
                    },
                  ].map((item, idx) => (
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-2">The Three Responses</p>
                <div className="space-y-3">
                  ...
                  <div className="flex items-start gap-3">
                    <div className="flex-shrink-0 w-8 h-8 rounded-full bg-amber-500/20 border border-amber-500/40 flex items-center justify-center">
                      <span className="text-xs font-bold text-amber-400">F</span>
                    </div>
                    <div>
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-white leading-relaxed">
                      ...
                      danger passed. In anxiety disorders, the brain&rsquo;s threat-detection system
                      becomes <strong>oversensitive</strong>, triggering the same intense
                      physiological response in response to non-life-threatening situations &mdash;
                      a meeting, a phone call, a crowded supermarket. The body is flooded with
                      adrenaline and cortisol repeatedly, leading to chronic physical symptoms,
                      exhaustion, and a constant state of &ldquo;high alert&rdquo; that the person
                      cannot switch off.
                    </p>
                  </div>
                </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                One of the most important things for a mental health first aider to understand is
                that anxiety is <strong>not just a mental experience</strong> &mdash; it produces
                very real, often frightening, physical symptoms. These symptoms are a direct result
                of the fight-flight-freeze response described above. Many people with anxiety
                disorders present to their GP or A&amp;E department believing they have a physical
                illness, because the symptoms can be so intense and alarming.
              </p>
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-white leading-relaxed">
                      ...
                      dizziness may prompt investigations for neurological conditions. As a mental
                      health first aider, being aware that these symptoms{' '}
                      <strong>can be caused by anxiety</strong> is valuable &mdash; but{' '}
                      <strong>always</strong> encourage the person to see their GP to rule out
                      physical causes first. Never diagnose &mdash; that is the GP&rsquo;s role.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <p>
                It is also worth noting that chronic anxiety can lead to genuine, long-term physical
                health problems. Sustained elevated cortisol levels are associated with high blood
                pressure, weakened immune function, digestive disorders (such as irritable bowel
                syndrome), chronic pain, and an increased risk of cardiovascular disease. This is
                why treating anxiety is not just about mental wellbeing &mdash; it is about physical
                health too.
              </p>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                A <strong>panic attack</strong> is a sudden, intense episode of overwhelming fear
                and anxiety that reaches its peak within minutes. Panic attacks are among the most
                frightening experiences a person can have &mdash; many people genuinely believe they
                are dying, having a heart attack, or losing their mind during an attack.
              </p>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-3">Symptoms of a Panic Attack</p>
                <div className="grid sm:grid-cols-2 gap-2">
                  {[
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-purple-400">Duration:</strong> Panic attacks typically
                  peak within <strong>5 to 10 minutes</strong> and usually last between{' '}
                  <strong>5 and 20 minutes</strong> in total, although some residual symptoms
                  (shakiness, fatigue, emotional exhaustion) may persist for an hour or more.
                  Crucially, panic attacks are <strong>self-limiting</strong> &mdash; they will
                  always pass, even without intervention.
                </p>
              </div>
              ...
              <div className="bg-green-500/10 border-2 border-green-500/40 p-4 sm:p-5 rounded-lg">
                <div className="flex items-start gap-2 mb-3">
                  ...
                  <h3 className="font-bold text-green-300 text-base">Panic Attack First Aid</h3>
                </div>
                <div className="space-y-3">
                  {[
                    {
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-3">
                  Panic Attack vs Heart Attack &mdash; How to Tell the Difference
                </p>
                  ...
                  <div className="bg-purple-500/10 border border-purple-500/30 p-3 rounded-lg">
                    ...
                    <ul className="text-sm text-white space-y-1.5">
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                        <span>
                          Symptoms peak within <strong>5-10 minutes</strong> then gradually ease
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                        <span>
                          Chest pain is usually a <strong>sharp, stabbing</strong> sensation
                      ...
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                        <span>
                          Tingling and numbness often in <strong>hands, feet, and face</strong>
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                        <span>
                          Usually resolves within <strong>20 minutes</strong>
                        </span>
                      </li>
                    </ul>
                  </div>
                  <div className="bg-red-500/10 border border-red-500/30 p-3 rounded-lg">
                    ...
                    <ul className="text-sm text-white space-y-1.5">
                      <li className="flex items-start gap-2">
                        ...
                        <span>
                          Pain is <strong>constant and worsening</strong>, does not ease with time
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                        <span>
                          Chest pain is a <strong>crushing, squeezing</strong> pressure that may
                      ...
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                        <span>
                          May cause <strong>cold, clammy skin</strong> with a grey complexion
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                        <span>
                          <strong>Life-threatening emergency</strong> &mdash; call 999 immediately
                        </span>
                      </li>
                    </ul>
                  </div>
                ...
                <div className="mt-3 bg-red-500/10 border border-red-500/30 p-3 rounded-lg">
                  <p className="text-sm text-white leading-relaxed">
                    <strong className="text-red-300">Important:</strong> If there is{' '}
                    <strong>any doubt</strong> whether someone is having a panic attack or a heart
                    attack, <strong>always call 999</strong> and treat the situation as a cardiac
                    emergency until confirmed otherwise. It is always better to be cautious.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Although modern diagnostic systems now classify Obsessive-Compulsive Disorder (OCD)
                and Post-Traumatic Stress Disorder (PTSD) separately from anxiety disorders, anxiety
                is a core feature of both conditions. As a mental health first aider, it is helpful
                to understand the basics of these conditions and recognise their link to anxiety.
              </p>
                ...
                <div className="bg-violet-500/10 border-2 border-violet-500/40 p-4 rounded-lg">
                  ...
                  <div className="space-y-3 text-sm text-white">
                    <div>
                      ...
                      <p>
                        Persistent, unwanted, intrusive thoughts, images, or urges that cause
                        significant anxiety. Common obsessions include fear of contamination, fear
                        of harming others, need for symmetry or exactness, and intrusive violent or
                        sexual thoughts. The person recognises these thoughts are irrational but
                        cannot stop them.
                      </p>
                    </div>
                    <div>
                      <p className="text-violet-400/80 text-xs font-medium mb-1">COMPULSIONS</p>
                      <p>
                        Repetitive behaviours or mental acts performed to reduce the anxiety caused
                        by the obsession. Common compulsions include excessive hand washing,
                        checking (doors, locks, appliances), counting, ordering, seeking
                        reassurance, and mental rituals. The relief is temporary &mdash; the cycle
                        repeats.
                      </p>
                    </div>
                    <div>
                      <p className="text-violet-400/80 text-xs font-medium mb-1">THE CYCLE</p>
                      <p>
                        Obsession &rarr; Anxiety &rarr; Compulsion &rarr; Temporary relief &rarr;
                        Obsession returns. This cycle can consume hours of a person&rsquo;s day and
                        severely impair their ability to work, socialise, and maintain
                        relationships.
                      </p>
                    </div>
                    <div className="bg-violet-500/10 border border-violet-500/30 p-3 rounded-lg">
                      <p className="text-xs text-white leading-relaxed">
                        <strong className="text-violet-300">Myth vs Reality:</strong> OCD is often
                        trivialised in popular culture (&ldquo;I&rsquo;m so OCD about my
                        desk&rdquo;). In reality, OCD is a serious, distressing condition. It is
                        treated with specialised CBT (Exposure and Response Prevention) and
                        sometimes SSRI medication. Approximately 750,000 people in the UK live with
                        OCD.
                      </p>
                    </div>
                  </div>
                ...
                <div className="bg-purple-500/10 border-2 border-purple-500/40 p-4 rounded-lg">
                  ...
                  <div className="space-y-3 text-sm text-white">
                    <div>
                      ...
                      <p>
                        PTSD develops after experiencing or witnessing a traumatic event &mdash;
                        serious accidents, physical or sexual assault, war, natural disasters, or
                        sudden bereavement. Not everyone who experiences trauma develops PTSD; it
                        depends on the nature of the event, personal vulnerability, and available
                        support.
                      </p>
                    </div>
                    <div>
                      <p className="text-purple-400/80 text-xs font-medium mb-1">KEY SYMPTOMS</p>
                      <ul className="space-y-1.5">
                        <li className="flex items-start gap-2">
                          <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                          <span>
                            <strong className="text-white">Re-experiencing</strong> &mdash;
                        ...
                        <li className="flex items-start gap-2">
                          <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                          <span>
                            <strong className="text-white">Avoidance</strong> &mdash; avoiding
                            reminders of the trauma (places, people, activities)
                          </span>
                        </li>
                        <li className="flex items-start gap-2">
                          <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                          <span>
                            <strong className="text-white">Hyperarousal</strong> &mdash; being
                            constantly on edge, startling easily, difficulty sleeping, irritability
                          </span>
                        </li>
                        <li className="flex items-start gap-2">
                          <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                          <span>
                            <strong className="text-white">Emotional numbing</strong> &mdash;
                            feeling detached, inability to experience positive emotions
                          </span>
                        </li>
                      </ul>
                    </div>
                    <div>
                      ...
                      <p>
                        Construction workers, including electricians, are at higher risk of PTSD due
                        to workplace incidents, witnessing accidents, or discovering deceased
                        persons. PTSD is covered in more detail in <strong>Module 4</strong> of this
                        course.
                      </p>
                    </div>
                    <div className="bg-purple-500/10 border border-purple-500/30 p-3 rounded-lg">
                      <p className="text-xs text-white leading-relaxed">
                        <strong className="text-purple-300">Treatment:</strong> NICE-recommended
                        treatments for PTSD include trauma-focused CBT and Eye Movement
                        Desensitisation and Reprocessing (EMDR). Symptoms must persist for more than
                        one month after the traumatic event for a PTSD diagnosis. Early support and
                        psychological first aid after a traumatic event can reduce the risk of
                        developing PTSD.
                      </p>
                    </div>
                  </div>
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                <p className="text-sm text-white leading-relaxed">
                  <strong className="text-purple-300">The Common Thread &mdash; Anxiety:</strong>{' '}
                  Both OCD and PTSD share anxiety as a central feature. In OCD, the obsessive
                  thoughts create intense anxiety that drives the compulsive behaviours. In PTSD,
                  the hyperarousal symptoms are essentially a chronic activation of the
                  fight-flight-freeze response, triggered by reminders of the trauma. Understanding
                  this shared mechanism helps mental health first aiders recognise when someone may
        ...
        {/* ── End-of-Section Quiz ────────────────────────────── */}
        <Quiz title="Anxiety Disorders &mdash; Knowledge Check" questions={quizQuestions} />
