...
const faqs = [
  {
    question: 'Do Mental Health First Aiders need to be formally qualified or certified?',
    answer:
  ...
  {
    question: 'How is an MHFA programme different from an Employee Assistance Programme (EAP)?',
    answer:
  ...
  {
    question: 'What if management are not supportive of implementing an MHFA programme?',
    answer:
  ...
  {
    question: 'How should an MHFA programme be adapted for construction sites specifically?',
    answer:
  ...
  {
    question: 'What KPIs should we track to measure whether the programme is working?',
    answer:
...
const quizQuestions = [
  ...
  {
    id: 2,
    question: 'MHFA England recommends a starting ratio of how many trained MHFAs per employees?',
    options: [
      '1 per 50 employees',
      '1 per 100 employees',
      '1 per 10 employees',
...
export default function MentalHealthModule5Section1() {
  useSEO({
    title: 'Implementing MHFA in the Workplace | Mental Health Module 5.1',
    description:
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-purple-500/5 border-l-2 border-purple-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>ROI:</strong> &pound;5 return for every &pound;1 invested (Deloitte 2020)
              </li>
              <li>
                <strong>Ratio:</strong> 1 MHFA per 10 employees as a starting point
              </li>
              <li>
                <strong>Standards:</strong> 6 Thriving at Work core standards for all employers
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-purple-500/5 border-l-2 border-purple-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Visibility:</strong> Lanyards, badges, posters, toolbox talks
              </li>
              <li>
                <strong>Integration:</strong> Add mental health to risk assessments &amp; inductions
              </li>
              <li>
                <strong>Measure:</strong> Absence, EAP usage, surveys, retention rates
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Implementing a Mental Health First Aid programme is not simply a matter of sending a
                few people on a training course. A successful programme requires careful planning,
                organisational commitment, adequate resources, and a clear strategy for embedding
                mental health support into the culture of the workplace. Without these foundations,
                even the best-trained MHFAs will struggle to make an impact.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-3">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">1. Secure management buy-in</strong> &mdash;
                      without visible support from senior leadership, the programme will lack
                      credibility, funding, and organisational priority. Present the business case,
                      reference the legal duty of care under the Health and Safety at Work etc. Act
                      1974, and highlight the Deloitte ROI evidence
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">2. Identify the need</strong> &mdash; conduct a
                      baseline assessment of mental health in the workplace. Review sickness absence
                      data, staff survey results, EAP usage, and turnover rates. Identify specific
                      risk factors in your workforce (e.g. shift work, isolation, high-pressure
                      deadlines, physical demands)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">3. Select and train MHFAs</strong> &mdash;
                      choose individuals who are genuinely interested, approachable, trusted by
                      colleagues, and representative of the workforce in terms of age, gender, and
                      background. Ensure they attend the full two-day MHFA England course with a
                      licensed instructor
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">4. Promote the programme</strong> &mdash;
                      ensure every employee knows that the programme exists, who the MHFAs are, and
                      how to access support. Use inductions, toolbox talks, posters, the intranet,
                      email communications, and team meetings to spread the message
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">5. Maintain and review</strong> &mdash; the
                      programme is not a one-off initiative. It requires ongoing support, refresher
                      training for MHFAs, regular supervision sessions, data collection, and at
                      least an annual review to assess effectiveness and make improvements
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                ...
                <div className="text-sm text-white space-y-3">
                  <p>
                    ...
                    <em>
                      &lsquo;Mental Health and Employers: Refreshing the Case for Investment&rsquo;
                    </em>{' '}
                    found that:
                  </p>
                  ...
                  <p>
                    ...
                    <strong className="text-white">reduced absenteeism</strong> (fewer sick days),{' '}
                    <strong className="text-white">reduced presenteeism</strong> (employees present
                    but not functioning at full capacity),{' '}
                    <strong className="text-white">lower staff turnover</strong> (retaining
                    experienced workers saves recruitment and training costs), and{' '}
                    <strong className="text-white">fewer workplace incidents</strong> (poor mental
                    health is linked to reduced concentration and higher accident risk).
                  </p>
                </div>
              </div>
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-violet-400">Construction Context:</strong> In the
                  construction industry, where male suicide rates are disproportionately high and
                  the culture has historically discouraged talking about feelings, an MHFA programme
                  sends a powerful signal that mental health matters. Organisations like Mates in
                  Mind, the Lighthouse Club, and CALM provide construction-specific resources to
                  support implementation. The &lsquo;hard hat and hi-vis&rsquo; environment does not
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Determining the right number of Mental Health First Aiders is not a
                one-size-fits-all calculation. MHFA England provides a starting guideline, but the
                actual number must be tailored to the specific characteristics and risks of each
                workplace.
              </p>
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  <strong className="text-white">minimum guideline</strong>, not a maximum &mdash;
                  many workplaces will need more, depending on their specific circumstances.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Shift patterns</strong> &mdash; if the
                      workforce operates across multiple shifts, there must be at least one MHFA
                      available on every shift. A single MHFA who works 9&ndash;5 provides no
                      coverage for night shift workers
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Multi-site working</strong> &mdash;
                      organisations with multiple locations must have MHFAs at each site.
                      Centralised MHFAs at head office do not help a worker on a remote construction
                      site
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Remote workers</strong> &mdash; home workers
                      and lone workers may need access to MHFAs via phone or video call. Consider
                      training MHFAs in remote support techniques
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Nature of the work</strong> &mdash;
                      high-stress, high-risk, or emotionally demanding work may require a higher
                      ratio of MHFAs. Construction, emergency services, and healthcare are examples
                      of sectors where higher ratios are advisable
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Workforce demographics</strong> &mdash; a
                      predominantly young male workforce (common in construction) may have different
                      mental health risk factors and engagement preferences compared to a mixed
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">MHFA availability</strong> &mdash; account for
                      annual leave, sickness, and staff turnover. Having exactly the minimum number
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1.5">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      At least one trained MHFA on every active site, regardless of the headcount on
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      Encourage subcontractors to train their own MHFAs as a condition of working on
                      major projects
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      Consider training supervisors and foremen, as they have regular contact with
                      all workers and can spot changes in behaviour early
                    </span>
                  </li>
                </ul>
              </div>
                ...
                <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-2">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                      <span>
                        Trained to recognise signs of mental ill health and apply the ALGEE action
                        plan
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                      <span>Can provide initial support and guide towards professional help</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                      <span>Certificate valid for 3 years, refresher training required</span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-2">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                      <span>
                        Equipped to raise awareness, reduce stigma, and encourage open conversations
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                      <span>
                        Valuable alongside MHFAs to create a broader culture of understanding
                      </span>
                    </li>
                  </ul>
                </div>
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-purple-400">Best Practice:</strong> The most effective
                  approach combines both &mdash; a core group of fully trained MHFAs (at the 1:10
                  ratio or higher) supported by a wider network of Mental Health Champions across
                  the organisation. This creates multiple layers of awareness and support. Champions
                  can identify issues early and signpost to MHFAs, who can then provide the trained
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                An MHFA programme can only be effective if employees know it exists, know who the
                MHFAs are, and feel comfortable approaching them. Visibility and accessibility are
                not optional extras &mdash; they are fundamental to the success of the programme.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">MHFA lanyards and badges</strong> &mdash; the
                      green MHFA England badge or lanyard is instantly recognisable and signals that
                      the wearer is a trained Mental Health First Aider. On construction sites, hard
                      hat stickers and hi-vis identifiers serve the same purpose
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Posters and notice boards</strong> &mdash;
                      display the names, photos, and contact details of MHFAs in communal areas:
                      canteens, welfare units, changing rooms, corridors, and site cabins. Include
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Intranet and digital channels</strong> &mdash;
                      a dedicated mental health page on the company intranet listing all MHFAs with
                      their contact details, availability, and location. Regular features in
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Toolbox talks and team briefings</strong>{' '}
                      &mdash; MHFAs should introduce themselves at toolbox talks and be present at
                      site inductions for new starters. Regular reminders during team meetings keep
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Drop-in availability</strong> &mdash; where
                      possible, establish regular drop-in times and a quiet space where employees
                      can speak to an MHFA without needing to make a formal appointment or attract
                      attention
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      Being open and non-judgemental in all interactions, not just when acting in
                      the MHFA role
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      Making time for people &mdash; not appearing too busy or rushed to talk
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      Being discreet and maintaining confidentiality, so that people trust them with
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      Proactively checking in with colleagues, rather than waiting to be approached
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  . A young apprentice may feel more comfortable speaking to a peer than to a senior
                  manager. Conversely, a manager may prefer to speak to someone at a similar level.
                  Having a diverse MHFA team increases the likelihood that every employee can find
                  someone they feel comfortable approaching.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Mental health should not exist as a standalone initiative, disconnected from the
                organisation&rsquo;s wider health and safety arrangements. The most effective
                approach is to embed mental health into the existing health and safety framework,
                ensuring it receives the same attention, governance, and systematic management as
                physical safety.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-3">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Risk assessments</strong> &mdash; add
                      psychosocial hazards to existing risk assessments. Identify stressors such as
                      excessive workload, lack of control, poor relationships, role ambiguity,
                      change management, and inadequate support. The HSE Management Standards
                      provide a framework for assessing these hazards
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">H&amp;S committee involvement</strong> &mdash;
                      make mental health a standing item on the health and safety committee agenda.
                      Include MHFA programme updates, mental health incident data (anonymised), and
                      planned initiatives
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Inductions</strong> &mdash; include mental
                      health support information in all new starter inductions, just as you include
                      fire safety, first aid, and emergency procedures. Introduce MHFAs by name and
                      explain how to access support
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Toolbox talks and site briefings</strong>{' '}
                      &mdash; incorporate mental health topics into the regular toolbox talk
                      schedule. Aim for at least one mental health toolbox talk per quarter,
                      covering topics such as stress awareness, the five signs, and how to support a
                      colleague
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Reporting and monitoring</strong> &mdash;
                      establish a confidential reporting mechanism for mental health concerns,
                      similar to near-miss reporting for physical safety. Track trends, hotspots,
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="grid sm:grid-cols-2 gap-2">
                  {[
                    ...
                    {
                      title: 'Control',
                      desc: 'How much say a person has in the way they do their work',
                    },
                    {
                      title: 'Support',
                      desc: 'Encouragement, sponsorship, and resources provided by the organisation and colleagues',
                    },
                    {
                      title: 'Relationships',
                      desc: 'Promoting positive working, avoiding conflict and dealing with unacceptable behaviour',
                    },
                    {
                      title: 'Role',
                      desc: 'Whether people understand their role and whether the organisation avoids conflicting roles',
                    },
                    {
                      title: 'Change',
                      desc: 'How organisational change is managed and communicated',
                    },
                  ].map((standard, i) => (
                    <div
                      key={i}
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  health, safety, and welfare of their employees. &lsquo;Health&rsquo; includes
                  mental health. The{' '}
                  <strong className="text-white">
                    Management of Health and Safety at Work Regulations 1999
                  </strong>{' '}
                  require employers to assess all risks to health &mdash; again, including mental
                  health. Integrating mental health into existing H&amp;S systems is not just good
                  practice; it is a legal requirement.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                resulting report, <em>&lsquo;Thriving at Work&rsquo;</em>, set out a framework of
                core standards that all employers &mdash; regardless of size or sector &mdash;
                should implement as a minimum.
              </p>

              <p>
                The 6 core standards are designed to be achievable by every employer and form the
                foundation upon which more advanced (&lsquo;enhanced&rsquo;) standards can be built.
                For any organisation implementing an MHFA programme, these standards provide the
                strategic framework within which that programme should sit.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1.5">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      Increasing transparency and accountability through internal and external
                      reporting
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      Demonstrating accountability by nominating a health and wellbeing lead at
                      board or senior leadership level
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      Improving the disclosure process to make it easier for employees to share
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      Ensuring provision of tailored in-house mental health support and signposting
                      to clinical help
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-purple-400">Key Point:</strong> The 6 core standards are
                  intended as a <strong>minimum starting point</strong>, not a ceiling. The review
                  emphasised that employers should aspire to go beyond the core standards as their
                  programmes mature. An MHFA programme is one of the most tangible ways an employer
                  can demonstrate commitment to standards 2, 3, and 6 in particular &mdash;
                  developing awareness, encouraging conversations, and providing signposting to
                  support.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Any programme requires measurement to demonstrate its value, identify areas for
                improvement, and secure continued investment. Measuring the impact of a mental
                health programme requires a combination of quantitative data (numbers) and
              ...
              <div className="bg-white/5 border border-white/10 rounded-lg overflow-hidden">
                <div className="bg-purple-500/10 border-b border-purple-500/20 px-4 py-2">
                  <div className="flex items-center gap-2">
                    ...
                    <p className="text-sm font-semibold text-purple-400">Quantitative KPIs</p>
                  </div>
                </div>
                <div className="p-4">
                  <div className="grid sm:grid-cols-2 gap-3">
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Feedback from MHFAs</strong> &mdash; what
                      themes are emerging from conversations? What barriers are people reporting?
                      What support is missing? MHFAs have a unique window into the lived experience
                      of the workforce
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Manager observations</strong> &mdash; are
                      managers noticing changes in team morale, openness, and willingness to seek
                      support? Are conversations about mental health becoming more normalised?
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Anonymised case studies</strong> &mdash; with
                      appropriate consent and anonymisation, real stories of how the MHFA programme
                      helped an individual can be powerful evidence of impact and can encourage
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Focus groups</strong> &mdash; facilitated
                      discussions with employees about their experience of the programme, what is
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      Analysis of all quantitative KPIs compared to baseline and previous years
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>Review of qualitative feedback from MHFAs, managers, and employees</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      Assessment of MHFA coverage &mdash; are there enough MHFAs? Are they
                      distributed appropriately across sites, shifts, and departments?
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      MHFA wellbeing check &mdash; are the MHFAs themselves receiving adequate
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      Identification of gaps in support and action plan for the following year
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>Progress against the Thriving at Work core standards</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  one. It means employees feel safe enough to come forward, which is the whole point
                  of the programme. Similarly, an increase in EAP referrals or MHFA interactions in
                  the first year suggests the programme is reaching people who previously had no
                  support. Over time, as the programme matures, you should see improvements in
                  absence rates, survey scores, and retention &mdash; but this may take 18 to 24
                  months to become visible in the data.
                </p>
              </div>
