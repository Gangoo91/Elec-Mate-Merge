...
const faqs = [
  {
    question: 'What is the most common type of scaffold accident in the UK construction industry?',
    answer:
  ...
  {
    question: 'How can falling objects be prevented when working on scaffolding?',
    answer:
  ...
  {
    question: 'What should you do if you notice an unauthorised modification to a scaffold?',
    answer:
...
const quizQuestions = [
  ...
  {
    id: 2,
    question: 'During which activity are scaffold operatives at the greatest risk of a fall?',
    options: [
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-slate-500/5 border-l-2 border-slate-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Leading cause:</strong> Falls from scaffold platforms &mdash; missing guard
                rails and board gaps
              </li>
              <li>
                <strong>Most dangerous phase:</strong> Erection and dismantling &mdash; incomplete
                edge protection
              </li>
              <li>
                <strong>Hidden killer:</strong> Scaffold collapse from unauthorised tie removal
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-slate-500/5 border-l-2 border-slate-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Before access:</strong> Check scaffold tag, guard rails, boards, and
                toeboards
              </li>
              <li>
                <strong>During work:</strong> Never modify, overload, or remove any scaffold
                component
              </li>
              <li>
                <strong>Report immediately:</strong> Any damage, missing parts, or unauthorised
                changes
              </li>
            </ul>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-slate-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Falls from scaffold platforms are the single largest category of scaffold-related
                injuries and fatalities in the United Kingdom. They account for approximately 38% of
                all reportable scaffold incidents and are responsible for more deaths than any other
                scaffold hazard. The tragedy is that virtually every one of these falls is
                preventable through correct scaffold design, proper erection, and disciplined use.
              </p>
              ...
              <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Missing or incomplete guard rails:</strong>{' '}
                      Guard rails must be fitted on all open sides of every working platform at a
                      height of at least 950mm. A top rail alone is insufficient &mdash; an
                      intermediate rail (or equivalent) and a toeboard are also required to prevent
                      a person falling through the gap
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Gaps in platform boards:</strong> Platform
                      boards must be close-butted with no gap exceeding 25mm. Gaps wider than this
                      allow feet to pass through, causing trips, twisted ankles, and in the worst
                      cases, falls to the level below. Boards must also be properly supported and
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Incomplete platforms:</strong> Platforms that
                      are not fully boarded across their entire width leave open voids through which
                      operatives can fall. A platform must be at least 600mm wide (three boards) for
                      a working platform and must extend to within 150mm of the building face where
                      practicable
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Unsecured or damaged boards:</strong> Boards
                      that are not clipped, wired, or otherwise secured can tilt when stepped on at
                      the edge, catapulting the operative off the platform. Boards with splits,
                      knots, rot, or excessive deflection must be replaced immediately
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Access to unfinished lifts:</strong> Operatives
                      climbing to lifts that are not yet fully boarded or protected is a major cause
                      of falls. &ldquo;Advance guard rail&rdquo; systems exist precisely to prevent
                      this by providing edge protection before the operative reaches the unprotected
                      level
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  attempt to &ldquo;work carefully&rdquo; on an unprotected platform &mdash; report
                  it, stop work, and wait for the scaffolder to make it safe.
                </p>
              </div>

              <p>
                The Work at Height Regulations 2005, Schedule 3, Part 1 sets out the minimum
                requirements for guard rails on scaffolding. The top guard rail must be at least
                950mm above the platform surface. Toeboards must be at least 150mm high. The gap
                between the top rail and any intermediate guard rail (or the toeboard and the
                intermediate guard rail) must not exceed 470mm. These are legal minimums, not
                guidelines, and failure to comply is a criminal offence.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Erection and dismantling are universally recognised as the most dangerous phases of
                scaffold work. During erection, guard rails, platforms, and toeboards are
                progressively added as the scaffold grows &mdash; meaning that the scaffolder is
                working at height on an incomplete structure for the entirety of the build. During
                dismantling, the process is reversed and edge protection is systematically removed,
                exposing the scaffolder to unprotected edges.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Advance guard rail systems:</strong> These
                      allow guard rails to be installed from the level below, providing edge
                      protection before the scaffolder steps onto the unprotected platform. NASC
                      guidance SG4 details the approved methods
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Personal fall protection:</strong> Where
                      advance guard rails are not practicable, harnesses with suitable anchorage
                      points must be used. The anchorage must be capable of supporting the arrest
                      forces without the scaffold itself failing
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Exclusion zones at ground level:</strong> The
                      area directly below the erection or dismantling zone must be barriered off to
                      prevent ground-level workers from being struck by dropped components
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Competent supervision:</strong> A competent
                      scaffold supervisor must be present throughout the erection and dismantling
                      process to ensure the correct sequence of operations is followed and no
                      shortcuts are taken
                    </span>
                  </li>
                </ul>
              ...
              <p>
                NASC guidance note SG4 sets out the industry-agreed safe methods for erection and
                dismantling of tube and fitting, system, and proprietary scaffolds. Following SG4 is
                considered best practice and is frequently referenced by the HSE during
                investigations. Any departure from SG4 methods must be justified by a specific risk
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-amber-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Objects falling from scaffolding pose a serious risk to workers at lower levels,
                pedestrians, and members of the public. The kinetic energy of even a small object
                falling from scaffold height is sufficient to cause fatal injuries. A standard
                scaffold fitting weighing just 1.5 kg falling from 30 metres will strike the ground
                at approximately 88 km/h, generating an impact force equivalent to hundreds of
                kilogrammes.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Tools and hand equipment:</strong> Hammers,
                      spanners, spirit levels, drills, and other hand tools dropped or knocked from
                      the platform edge. Tool lanyards are the primary control measure
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Construction materials:</strong> Bricks,
                      blocks, mortar, fixings, offcuts, and packaging. Must be stored away from the
                      edge and secured against wind displacement
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Scaffold boards and components:</strong> Boards
                      dislodged by wind, impact, or careless handling. Loose fittings left on
                      ledgers or transoms after alterations
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Waste and debris:</strong> Rubble, broken
                      materials, food waste, and packaging blown or kicked off the edge. Good
              ...
              <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Toeboards:</strong> Minimum 150mm high on all
                      working platforms to prevent objects rolling or sliding off the edge
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Brick guards:</strong> Wire mesh panels fitted
                      between the guard rail and toeboard to contain materials stacked higher than
                      the toeboard
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Debris netting and sheeting:</strong> Fitted to
                      the outside face of the scaffold to catch small items. Essential on scaffolds
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Fans and catch platforms:</strong> Projecting
                      scaffold platforms or purpose-built catch fans installed at lower levels to
                      intercept falling objects
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Tool lanyards:</strong> All hand tools must be
                      tethered to the operative or to the scaffold structure using suitable lanyards
                      rated for the tool weight
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Ground-level exclusion zones:</strong> Where
                      falling objects cannot be fully contained, the area beneath the scaffold must
                      be barriered off with suitable signage
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  the scaffold face. Failure to protect the public is treated with particular
                  severity by the HSE and can result in immediate prohibition notices and
                  prosecution.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Scaffold collapse is one of the most catastrophic events that can occur on a
                construction site. When a scaffold fails, the consequences are almost always severe
                &mdash; multiple casualties, fatalities, extensive property damage, and prosecution
                of those responsible. Understanding the causes of scaffold collapse is essential for
                every person who works on or around scaffolding.
              </p>
              ...
              <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Premature or unauthorised tie removal:</strong>{' '}
                      This is the most common cause of scaffold collapse in the UK. Ties connect the
                      scaffold to the building and resist lateral forces. When trades remove ties to
                      gain access for their work without consulting the scaffolder, the scaffold can
                      become critically unstable and collapse without warning
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Overloading:</strong> Exceeding the rated bay
                      load causes excessive deflection in ledgers and transoms, which transmits
                      abnormal forces to the standards and couplers. Progressive overloading can
                      cause a cascading failure where one component fails and transfers its load to
                      adjacent components, which in turn fail
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Inadequate foundations:</strong> Scaffold
                      standards must bear on a surface capable of supporting the total applied load
                      without settlement or failure. Placing standards on soft ground, uncompacted
                      fill, drains, cellars, or sloping surfaces without adequate sole boards and
                      base plates is a common cause of foundation failure leading to collapse
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Wind loading:</strong> Wind applies lateral
                      forces to the scaffold that increase dramatically when sheeting, netting, or
                      banners are fitted. If the tie pattern and scaffold design do not account for
                      the additional wind loading from cladding, the scaffold can be blown over or
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Incorrect erection:</strong> Using the wrong
                      components, omitting bracing, incorrect tie spacing, mixing incompatible
                      system components, or departing from the design without authorisation can all
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  capacity, they can fail in sequence. Only a competent scaffolder, following a
                  specific method statement, may temporarily remove and replace ties. No other trade
                  should ever interfere with scaffold ties under any circumstances.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  Multiple workers were injured and one pedestrian was killed. The investigation
                  found that no permit-to-alter system was in place, the tie removal was not
                  communicated to the scaffolding contractor, and the principal contractor had no
                  system for monitoring scaffold integrity. Multiple parties were prosecuted, with
                  combined fines exceeding &pound;1 million.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Electrocution is one of the most immediately lethal scaffold hazards. Contact
                between a scaffold and live overhead power lines, or between scaffold components and
                concealed cables within the building fabric, can cause instant death. Electricity
                can also arc across an air gap &mdash; direct contact is not always necessary for a
                fatal outcome.
              </p>
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Overhead power lines:</strong> Scaffold tubes,
                      gin wheels, and materials being lifted can contact or approach overhead lines.
                      Steel scaffolding is an excellent conductor, and the entire scaffold can
                      become live instantaneously
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Underground cables:</strong> Driving scaffold
                      stakes, pins, or adjustable base plates into the ground can penetrate buried
                      cables. A cable survey and cable avoidance tool (CAT) scan must be carried out
                      before any ground penetration
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Live cables in the building fabric:</strong>{' '}
                      When scaffolding is tied to a building, the tie fixings may drill into walls
                      that contain live electrical cables. Cable detection equipment must be used
                      before drilling
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Temporary site electrics:</strong> Cables
                      draped over or run through scaffolding that become damaged by scaffold
                      components, foot traffic, or abrasion
                    </span>
                  </li>
                </ul>
              </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  {[
                    ...
                    >
                      ...
                      <div>
                        <p className="text-xs font-medium text-blue-400">{item.voltage}</p>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  arrange with the electricity distributor for the line to be diverted, made dead,
                  or protected with insulating sleeves fitted by their authorised operatives.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Slips and trips on scaffold platforms may appear to be a relatively minor hazard
                compared with falls from height or scaffold collapse, but in practice they are a
                significant source of injuries including fractures, sprains, head injuries, and back
                injuries. On a scaffold platform, a slip or trip that would cause only a stumble at
                ground level can propel the operative into the guard rail, over the guard rail, or
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Wet or icy platforms:</strong> Rain, frost,
                      ice, and morning dew make timber and steel platforms extremely slippery.
                      Anti-slip coatings, grit application, and waiting for conditions to improve
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Debris and waste on platforms:</strong>{' '}
                      Off-cuts, packaging, mortar droppings, cables, and tools left on platforms
                      create trip hazards. Platforms must be kept clear at all times through regular
                      housekeeping
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Uneven or damaged boards:</strong> Warped,
                      split, or protruding boards catch feet and cause stumbles. Board ends that are
                      not flush or that project above adjacent boards are a frequent trip hazard
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Cables and hoses:</strong> Power cables, air
                      hoses, and water pipes run across platforms create trip hazards. They should
                      be routed along the scaffold structure or through dedicated cable runs, never
                      left trailing across walkways
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Poor lighting:</strong> Inadequate lighting on
                      scaffold platforms, especially during winter months, early morning, and late
                      afternoon working, means hazards are not seen until it is too late
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Inappropriate footwear:</strong> Safety boots
                      with worn tread or inappropriate sole patterns provide insufficient grip on
                      scaffold platforms. Footwear should have deep-tread, oil-resistant soles
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-slate-400">Key Point:</strong> Good housekeeping is the
                  single most effective control measure for slips and trips on scaffold platforms.
                  Every operative who works on the scaffold has a personal responsibility to keep
                  their working area clean, tidy, and free of obstructions. The &ldquo;clean as you
                  go&rdquo; principle should be enforced rigorously at all times.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Crushing and trapping injuries occur when scaffold components fall onto or trap
                operatives during erection, alteration, or dismantling. These injuries predominantly
                affect ground-level workers and those immediately below the working level. A single
                scaffold tube weighing approximately 20 kg falling from even a modest height can
                cause devastating injuries including skull fractures, spinal injuries, and crush
                injuries to limbs.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Exclusion zones:</strong> Barrier off the area
                      directly beneath the erection or dismantling zone. No one except the erection
                      gang should enter this zone during operations
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Communication systems:</strong> Clear verbal
                      communication or radio contact between the scaffolders at the working level
                      and ground-level operatives. No component should be passed or lowered until
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Mechanical lifting:</strong> Where practicable,
                      use mechanical means (hoists, gin wheels with proper guards, or crane
                      assistance) to lift scaffold components rather than manual handling
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">PPE:</strong> Hard hats (EN 397), safety boots
                      with metatarsal protection where appropriate, and scaffold-specific gloves.
                      PPE is the last line of defence and must not be relied upon as the primary
                      control
                    </span>
                  </li>
                </ul>
              ...
              <p>
                The hierarchy of control applies to crushing hazards just as it does to every other
                workplace risk. Elimination (can the task be done differently?), engineering
                controls (exclusion zones, catch fans), administrative controls (safe systems of
                work, permits), and finally PPE. Too often on construction sites, PPE is treated as
                the primary control, when in fact it should be the last resort.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-slate-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                An unauthorised modification is any change to a scaffold structure that is made
                without the knowledge and approval of the scaffolding contractor or the competent
                person responsible for the scaffold design. Unauthorised modifications are one of
                the most persistent and dangerous problems on construction sites, and they are
                frequently the underlying cause of scaffold collapse, falls, and other serious
                incidents.
              </p>
              ...
              <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Removing guard rails:</strong> Trades remove
                      guard rails to pass materials through, to gain access to the building face, or
                      simply because they are &ldquo;in the way.&rdquo; This is the most common
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Removing ties:</strong> Cladding contractors,
                      window installers, and other facade trades remove ties to access the building.
                      As discussed in Section 04, this can cause catastrophic scaffold collapse
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Removing or repositioning boards:</strong>{' '}
                      Operatives remove boards to create openings for material hoisting, to access
                      the level below, or to use the boards elsewhere. This creates fall-through
                      hazards and reduces the platform&rsquo;s structural capacity
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Removing bracing:</strong> Diagonal and ledger
                      bracing is removed to create access openings or because it obstructs the work.
                      Bracing provides structural stability, and its removal can cause the scaffold
                      to buckle
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Adding extra lifts or loading bays:</strong>{' '}
                      Operatives or site managers ask for additional lifts, cantilevers, or loading
                      bays to be added by unskilled persons rather than the scaffolding contractor.
                      The structural design of the scaffold may not accommodate these additions
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      ...
                      Fitting sheeting, advertising banners, or large signs to a scaffold without
                      redesigning the tie pattern and bracing to account for the increased wind load
                      is an unauthorised modification that significantly increases the risk of
                      collapse
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  unauthorised modification commits a criminal offence. The individual who made the
                  modification, the trade contractor who instructed them to do it, and the principal
                  contractor who failed to prevent it can all be prosecuted.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Scaffold tagging systems:</strong> Use a
                      green/amber/red tag system to show the scaffold status. Green = safe to use.
                      Red = do not use. Tags must be checked before every access
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Permit-to-alter systems:</strong> No
                      modification, however minor, may be made without a written permit signed by
                      the scaffolding contractor and the site manager. The permit must specify what
                      is being altered, why, and what alternative protection is in place
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Site induction:</strong> Every person who
                      enters the site must be told during induction that interfering with
                      scaffolding is prohibited and is a criminal offence. The consequence of
                      non-compliance (removal from site, disciplinary action) must be made clear
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Regular scaffold inspections:</strong> Frequent
                      inspections by the scaffolding contractor will identify unauthorised
                      modifications early, before they lead to an incident. Spot checks at random
                      times are more effective than scheduled inspections alone
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Clear reporting culture:</strong> Operatives
                      must feel confident reporting unauthorised modifications without fear of
                      reprisal. A just culture that encourages reporting and addresses the root
                      cause (rather than blaming individuals) is far more effective than a punitive
                      approach
                    </span>
                  </li>
                </ul>
              ...
              <p>
                The most effective way to prevent unauthorised modifications is to ensure that every
                person on site understands why the scaffold is designed the way it is. When trades
                understand that removing a tie could collapse the entire structure, they are far
                less likely to do it. Education, communication, and a genuine safety culture are
                more powerful than rules and regulations alone.
              </p>
            </div>
          </div>
        </section>
