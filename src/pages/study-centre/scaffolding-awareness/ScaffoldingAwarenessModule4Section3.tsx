...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    question:
      'You arrive at a scaffold and there is no tag displayed at the access point. What is the correct course of action?',
    options: [
...
const faqs = [
  {
    question:
      'Who is responsible for attaching scaffold tags and can anyone remove or change them?',
    answer:
  ...
  {
    question:
      'What is the difference between the NASC/CISRS Scafftag system and a site-specific tagging system?',
    answer:
  ...
  {
    question:
      'Can a scaffold with a green tag ever be unsafe, and should I still check it before use?',
    answer:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Green', 'Blue', 'Yellow (Amber)', 'Red'],
    correctAnswer: 2,
    explanation:
  ...
  {
    id: 3,
    question: 'What is the ONLY correct action when you encounter a scaffold with a RED tag?',
    options: [
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-slate-500/5 border-l-2 border-slate-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>GREEN tag:</strong> Safe to use &mdash; inspected, complete, no restrictions
              </li>
              <li>
                <strong>YELLOW tag:</strong> Restrictions apply &mdash; read tag, avoid restricted
                areas
              </li>
              <li>
                <strong>RED tag:</strong> Do NOT use &mdash; unsafe, under erection or dismantling
              </li>
              <li>
                <strong>No tag:</strong> Do NOT use &mdash; treat as unsafe, report immediately
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-slate-500/5 border-l-2 border-slate-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>NASC/CISRS Scafftag:</strong> Industry-standard tagging system
              </li>
              <li>
                <strong>Work at Height Regs 2005:</strong> Inspection &amp; tag requirements
              </li>
              <li>
                <strong>BS 5975:2019:</strong> Code of practice for temporary works
              </li>
              <li>
                <strong>CDM Regulations 2015:</strong> Inspection record duties
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-slate-500/30 pl-4 sm:pl-6">
            <h2 className="text-lg sm:text-xl font-bold text-white flex items-center gap-3 mb-4">
              <span className="flex items-center justify-center w-8 h-8 rounded-lg bg-slate-500/10 text-slate-400 text-sm font-bold border border-slate-500/20">
                01
              </span>
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The <strong>scaffold tag system</strong> is a colour-coded visual communication
                system used on construction sites throughout the United Kingdom to indicate the
                current status of a scaffold. Its purpose is simple but critical: to ensure that{' '}
                <strong>
                  every person approaching a scaffold can immediately determine whether it is safe
                  to use
                </strong>
                , whether restrictions apply, or whether it must not be accessed at all. The tag
                system is the primary interface between the scaffolding contractor (who erects,
                inspects, and maintains the scaffold) and the trade workers, site personnel, and
                visitors who need to use it.
              </p>

              <p>
                Without a clear, standardised tagging system, workers would have no reliable way of
                knowing whether a scaffold has been inspected, whether it is complete, or whether it
                is in the process of being erected or dismantled. This lack of information creates
                an unacceptable risk of <strong>falls from height</strong> &mdash; the single
                largest cause of fatal and serious injuries in the UK construction industry. The
                Health and Safety Executive (HSE) reports that falls from height account for
                approximately 40% of all fatal injuries in construction, and a significant
                proportion of these involve scaffolds.
              </p>

              <p>
                The scaffold tag system uses three colours, each with a clear, unambiguous meaning
              ...
              <ul className="space-y-2 text-sm text-white/70">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong>GREEN</strong> &mdash; the scaffold has been inspected, is complete,
                    complies with the design specification, and is safe to use without restriction.
                    A green tag is a positive confirmation that the scaffold meets all applicable
                    standards at the time of the most recent inspection
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                  <span>
                    <strong>YELLOW (AMBER)</strong> &mdash; the scaffold is partially complete, or
                    has specific restrictions on use. Certain areas, lifts, bays, or features may
                    not be used. The tag will specify exactly what the restrictions are. Workers
                    must read the tag carefully and only access permitted areas
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                  <span>
                    <strong>RED</strong> &mdash; the scaffold is unsafe and must not be used by any
                    person for any reason. The scaffold may be under erection, under dismantling,
                    damaged, condemned, or otherwise unfit for use. No exceptions apply
                  </span>
                </li>
              </ul>
              ...
              <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                <div className="flex items-start gap-2">
                  ...
                  <p className="text-sm text-white">
                    <strong className="text-slate-400">Critical Rule:</strong> If there is{' '}
                    <strong>no tag</strong> displayed at the access point of a scaffold, you must
                    treat it as if it has a <strong>red tag</strong>. Do NOT use the scaffold.
                    Report the absence of the tag to your supervisor, site manager, or the
                    scaffolding contractor immediately. A scaffold without a tag is a scaffold of
                    unknown status, and using it puts your life at risk.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-slate-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                A <strong>green scaffold tag</strong> is the positive confirmation that a scaffold
                has been inspected by a competent person and found to be safe for use without
                restriction. When you see a green tag at the access point, it tells you that at the
              ...
              <ul className="space-y-2 text-sm text-white/70">
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                  <span>
                    <strong>Fully erected and complete</strong> &mdash; all lifts, bays, platforms,
                    guardrails, toe boards, bracing, and ties have been installed in accordance with
                    the scaffold design specification. No components are missing, incomplete, or
                    temporarily absent
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                  <span>
                    <strong>Inspected by a competent person</strong> &mdash; a person with the
                    appropriate qualifications, training, knowledge, and experience (typically
                    CISRS-qualified) has carried out a thorough inspection and confirmed compliance
                    with the design and with the Work at Height Regulations 2005
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                  <span>
                    <strong>Structurally sound</strong> &mdash; foundations are adequate, standards
                    are plumb, ledgers are level, bracing is correctly installed, ties are secure
                    and at the correct spacing, and the scaffold is capable of supporting the
                    intended loads
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                  <span>
                    <strong>Safe access and egress</strong> &mdash; access ladders are correctly
                    positioned, secured at the top, and extend at least 1 metre above the landing
                    platform. Access points are clear and unobstructed
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                  <span>
                    <strong>Compliant with regulations</strong> &mdash; the scaffold meets the
                    requirements of the Work at Height Regulations 2005, BS EN 12811-1 (temporary
                    works equipment), BS 5975:2019 (code of practice for temporary works
                    procedures), and any site-specific requirements
                  </span>
                </li>
              </ul>

              <p>
                Even with a green tag displayed,{' '}
                <strong>every user has a personal responsibility</strong> to carry out a brief
                visual check before each use. This is not a formal inspection — it is a quick,
                common-sense assessment to confirm that nothing has changed since the tag was
                issued. Check that the tag date is current (within seven days), platforms are fully
                boarded, guardrails and toe boards are in place, ladders are secure, and there is no
                visible damage, debris, or overloading. If anything appears wrong, do not use the
                scaffold — report it immediately.
              </p>
              ...
              <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                <div className="flex items-start gap-2">
                  ...
                  <p className="text-sm text-white">
                    <strong className="text-green-400">Green Tag Summary:</strong> Inspected,
                    complete, compliant, safe to use without restriction. The green tag is valid
                    from the date of inspection until the next scheduled inspection (maximum seven
                    days) or until an event occurs that could affect the scaffold&rsquo;s stability
                    (such as high winds, impact, or alteration).
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-slate-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                A <strong>yellow (amber) scaffold tag</strong> indicates that the scaffold is
                available for use but with <strong>specific restrictions</strong>. This is perhaps
                the most misunderstood tag colour because it requires workers to read and understand
                the restrictions stated on the tag before deciding whether they can safely access
                the scaffold. A yellow tag does not mean the scaffold is unsafe — it means that
                certain areas, levels, or configurations are not available for use, and the
                permitted areas are defined on the tag.
              </p>
              ...
              <ul className="space-y-2 text-sm text-white/70">
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                  <span>
                    <strong>Partial scaffold erection</strong> &mdash; the lower lifts of the
                    scaffold have been completed and inspected, but the upper lifts are still under
                    construction. The yellow tag will specify which levels are safe to use and which
                    must not be accessed because they are incomplete
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                  <span>
                    <strong>Partial dismantling (striking)</strong> &mdash; part of the scaffold has
                    been removed (for example, an upper lift has been struck while the lower lifts
                    remain in use). The yellow tag will identify the remaining usable areas and the
                    areas that no longer exist or are no longer safe
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                  <span>
                    <strong>Loading restrictions</strong> &mdash; the scaffold has been designed or
                    inspected for a specific loading class, and the yellow tag states the maximum
                    permitted load. For example, the scaffold may be suitable for inspection use
                    only (Light Duty, Loading Class 2 — maximum 1.5 kN/m&sup2;) but not for heavy
                    material storage (Heavy Duty, Loading Class 4 — maximum 3.0 kN/m&sup2;)
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                  <span>
                    <strong>Access restrictions</strong> &mdash; certain access points may not be
                    used, or access may be restricted to specific trades or personnel. For example,
                    a scaffold may have one face that is too close to live overhead power lines, and
                    the yellow tag will prohibit access to that face
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                  <span>
                    <strong>Temporary modifications</strong> &mdash; a section of guardrail may have
                    been temporarily removed to allow material loading, or a platform may be
                    incomplete in a specific bay. The yellow tag will identify the affected areas
                    and any additional precautions required (such as the use of a safety harness in
                    the modified area)
                  </span>
                </li>
              </ul>
              ...
              <div className="bg-yellow-500/10 border border-yellow-500/30 p-4 rounded-lg">
                <div className="flex items-start gap-2">
                  ...
                  <p className="text-sm text-white">
                    <strong className="text-yellow-400">Yellow Tag Rule:</strong> You{' '}
                    <strong>must</strong> read the yellow tag in full before stepping onto the
                    scaffold. If the tag does not clearly state which areas are available, or if you
                    do not understand the restrictions, do not use the scaffold. Ask the scaffolding
                    contractor, site supervisor, or scaffold coordinator for clarification.{' '}
                    <strong>
                      Never assume that an area is safe simply because it looks complete.
                    </strong>{' '}
                    Restricted areas on a yellow-tagged scaffold may have hidden deficiencies such
                    as missing ties, inadequate bracing, or unboarded platforms that are not visible
        ...
        <section className="mb-10">
          <div className="border-l-2 border-slate-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                A <strong>red scaffold tag</strong> is the most serious status indicator. It means
                the scaffold is{' '}
                <strong>unsafe and must not be used by any person for any reason</strong>. There are
                no exceptions, no qualifications, and no circumstances in which it is acceptable to
                access a red-tagged scaffold. The red tag is a clear, absolute prohibition.
              </p>
              ...
              <ul className="space-y-2 text-sm text-white/70">
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                  <span>
                    <strong>Scaffold under erection</strong> &mdash; the scaffold is currently being
                    built. Scaffolders are working at height to install standards, ledgers, braces,
                    ties, and platforms. The scaffold is incomplete and does not have the safety
                    features (guardrails, toe boards, full boarding) required for safe use by
                    non-scaffolding personnel. Only trained scaffolders working under a safe system
                    of work are permitted on the scaffold during erection
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                  <span>
                    <strong>Scaffold under dismantling</strong> &mdash; the scaffold is being taken
                    down. Components are being removed from the top down, and at any point during
                    dismantling, the scaffold may lack guardrails, platforms, bracing, or ties. The
                    structural integrity of the scaffold changes continuously during dismantling,
                    and it is not safe for anyone other than the scaffolding gang to be on or near
                    the scaffold
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                  <span>
                    <strong>Significant structural defect</strong> &mdash; an inspection has
                    revealed a defect that renders the scaffold unsafe. This could include
                    settlement or failure of foundations, buckled or damaged standards, missing or
                    inadequate ties, broken or absent bracing, overloading, or any other condition
                    that compromises the scaffold&rsquo;s ability to support its intended loads
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                  <span>
                    <strong>Damage from external event</strong> &mdash; the scaffold has been
                    damaged by a vehicle impact, falling materials, ground movement, or any other
                    external force. Even if the damage appears minor, the scaffold must be treated
                    as unsafe until it has been inspected by a competent person
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                  <span>
                    <strong>Condemned scaffold</strong> &mdash; the scaffold has been formally
                    condemned by an inspector (internal or HSE) and must not be used until the
                    identified deficiencies have been rectified and the scaffold has been
                    re-inspected and re-tagged by a competent person
                  </span>
                </li>
              </ul>
              ...
              <p>
                ...
                unauthorised access. These include <strong>removing the access ladders</strong>,{' '}
                <strong>installing physical barriers</strong> across access points, and displaying{' '}
                <strong>warning signs</strong> (in addition to the red tag) that clearly state the
                scaffold must not be used. On larger sites, the red-tagged scaffold may be fenced
                off entirely to create an exclusion zone.
              </p>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                <div className="flex items-start gap-2">
                  ...
                  <p className="text-sm text-white">
                    <strong className="text-red-400">Absolute Rule:</strong> If you see a red tag,{' '}
                    <strong>walk away</strong>. Do not climb onto the scaffold for any reason. Do
                    not assume that the red tag is a mistake or that the scaffold &ldquo;looks
                    fine&rdquo;. Structural deficiencies that render a scaffold unsafe are often
                    invisible to the untrained eye &mdash; missing ties, inadequate bracing, or
                    compromised foundations may not be apparent from the ground or the access point.
                    Using a red-tagged scaffold is a dismissible offence on most construction sites
        ...
        <section className="mb-10">
          <div className="border-l-2 border-slate-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The effectiveness of the scaffold tag system depends entirely on whether workers can{' '}
                <strong>see and read the tag before they step onto the scaffold</strong>. A tag that
                is missing, hidden, illegible, or placed in an obscure location is worse than
                useless &mdash; it may give a false sense that no tagging system is in operation and
                encourage workers to use the scaffold without checking its status.
              </p>
              ...
              <ul className="space-y-2 text-sm text-white/70">
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                  <span>
                    <strong>At every access point</strong> &mdash; a scaffold tag must be displayed
                    at every point where a person could access the scaffold. This includes every
                    ground-level ladder access, every internal ladder access between lifts (where
                    the scaffold connects to a building and workers could step onto it from inside),
                    every loading bay, every bridge or link to an adjacent scaffold, and every
                    access point from an adjacent structure. On a large scaffold, there may be
                    numerous access points, and every one must be tagged
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                  <span>
                    <strong>At or near eye level</strong> &mdash; the tag must be positioned where
                    it is easily visible and can be read without having to climb, reach, or move
                    other objects. Typically, this means attaching the tag to a standard, ledger, or
                    dedicated tag holder at approximately 1.5 to 1.8 metres above the access point
                    &mdash; the natural eye level of a person about to step onto the scaffold
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                  <span>
                    <strong>Before the point of no return</strong> &mdash; the tag must be visible
                    before the worker steps onto the scaffold or begins to climb the access ladder.
                    The worker must be able to read the tag and make a decision about whether to
                    proceed while still standing on safe ground. A tag placed halfway up a ladder or
                    on an upper platform is too late &mdash; the worker is already on the scaffold
                    before they see it
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                  <span>
                    <strong>Securely attached</strong> &mdash; the tag must be fixed firmly so that
                    it cannot be blown away by wind, knocked off by passing workers or materials, or
                    accidentally dislodged. Tags should be attached using cable ties, clips, or
                    dedicated tag holders that keep them secure in all weather conditions. Loose
                    tags that fall off create a dangerous situation where the scaffold appears
                    untagged
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                  <span>
                    <strong>Protected from weather</strong> &mdash; tags must remain legible
                    throughout their validity period (up to seven days between inspections). They
                    must be weather-resistant or protected from rain, snow, and UV degradation. The
                    NASC/CISRS Scafftag system uses plastic holders and inserts specifically
                    designed for outdoor use. Handwritten tags on paper or card are particularly
                    vulnerable to weather damage and should be laminated or placed in waterproof
                    holders
                  </span>
                </li>
              </ul>
              ...
              <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-slate-400">Multiple Tags:</strong> Every access point must
                  display its own tag. It is not acceptable to tag only the &ldquo;main&rdquo;
                  access point and assume that workers will walk around to check it before using a
                  different access point. Each tag must be identical in information and status
                  &mdash; a scaffold cannot be green at one access point and yellow at another (the
                  overall status applies to the whole scaffold, with restrictions detailed on the
                  yellow tag).
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-slate-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                A scaffold tag is not simply a coloured card. It must contain{' '}
                <strong>specific, detailed information</strong> that allows any person to understand
                the scaffold&rsquo;s status, verify when it was last inspected, confirm who
                inspected it, and determine when the next inspection is due. The information on the
                tag forms part of the inspection record trail and may be examined by HSE inspectors
                during site visits.
              </p>
                ...
                <div className="space-y-3">
                  ...
                  <div className="bg-white/5 border border-white/10 rounded-lg p-4">
                    ...
                    <p className="text-xs text-white/70">
                      ...
                      as overdue for inspection and should not be used until re-inspected.
                    </p>
                  </div>
                  ...
                  <div className="bg-white/5 border border-white/10 rounded-lg p-4">
                    ...
                    <p className="text-xs text-white/70">
                      ...
                      back to a specific individual with verified competence.
                    </p>
                  </div>
                  ...
                  <div className="bg-white/5 border border-white/10 rounded-lg p-4">
                    ...
                    <p className="text-xs text-white/70">
                      ...
                      period. If the current date exceeds the next inspection due date, the scaffold
                      must not be used.
                    </p>
                  </div>
                  ...
                  <div className="bg-white/5 border border-white/10 rounded-lg p-4">
                    ...
                    <p className="text-xs text-white/70">
                      ...
                      1&ndash;3 safe to use. Lift 4 under construction &mdash; DO NOT ACCESS.&rdquo;
                    </p>
                  </div>
                  ...
                  <div className="bg-white/5 border border-white/10 rounded-lg p-4">
                    ...
                    <p className="text-xs text-white/70">
                      ...
                      scaffold duty classification (e.g., Light Duty, General Purpose, Heavy Duty,
                      Special Duty) and emergency contact details.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <p>
                The <strong>quality and completeness of the tag information</strong> is not
                optional. A tag that only shows a colour without supporting information provides
                insufficient assurance. Workers need to be able to verify the date, the inspector,
                and the next inspection due date to have confidence that the tag is current and
                valid. A tag dated more than seven days ago is expired and the scaffold should not
                be used. A tag with no inspector name provides no accountability. A yellow tag with
                no description of restrictions is useless because the worker has no way of knowing
                which areas are safe.
              </p>

              <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-slate-400">Legibility:</strong> All information on the tag
                  must be clearly legible. If the tag has been damaged by weather, handling, or UV
                  exposure to the point where any field is unreadable, the tag must be replaced
                  immediately. An illegible tag is functionally equivalent to no tag at all &mdash;
                  the scaffold should not be used until a new, legible tag is attached following a
                  fresh inspection.
                </p>
              </div>
            </div>
              ...
              <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-4">
                ...
                <ul className="space-y-1 text-xs text-white/70 ml-13">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Scaffold has been inspected by a competent person and found compliant
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      All components installed, all platforms fully boarded, all guardrails in place
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                    <span>
                      <strong>Your action:</strong> Carry out a brief visual check, then proceed to
                      use the scaffold
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-lg p-4">
                ...
                <ul className="space-y-1 text-xs text-white/70 ml-13">
                  ...
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-yellow-400" />
                    <span>
                      Tag details which areas are available and which must not be accessed
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-yellow-400" />
                    <span>
                      <strong>Your action:</strong> Read the tag carefully. Only access permitted
                      areas. If unsure, ask
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-4">
                ...
                <ul className="space-y-1 text-xs text-white/70 ml-13">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Scaffold is unsafe, incomplete, damaged, or being erected/dismantled
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-red-400" />
                    <span>
                      No exceptions — not for urgent work, not with a harness, not briefly
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-red-400" />
                    <span>
                      <strong>Your action:</strong> Walk away. Report to your supervisor. Find an
                      alternative
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-white/20 rounded-lg p-4">
                ...
                <ul className="space-y-1 text-xs text-white/70 ml-13">
                  ...
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-white/50" />
                    <span>
                      Never assume it is safe because it was previously tagged or looks fine
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-white/50" />
                    <span>
                      <strong>Your action:</strong> Do NOT use. Report the missing tag immediately
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-slate-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The <strong>NASC/CISRS Scafftag system</strong> is the industry-standard scaffold
                tagging system used throughout the United Kingdom. It was developed jointly by the{' '}
                <strong>National Access and Scaffolding Confederation (NASC)</strong> &mdash; the UK
                trade body for scaffolding contractors &mdash; and the{' '}
                <strong>Construction Industry Scaffolders Record Scheme (CISRS)</strong> &mdash; the
                industry-recognised training and card scheme for scaffolders. The Scafftag system is
                endorsed by the Health and Safety Executive (HSE) as a best-practice approach to
                scaffold status communication and is now mandated by many principal contractors in
                their site rules.
              </p>
              ...
              <ul className="space-y-2 text-sm text-white/70">
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                  <span>
                    <strong>Durable tag holders</strong> &mdash; the system uses robust,
                    weather-resistant plastic tag holders that are designed for outdoor use on
                    construction sites. The holders protect the tag inserts from rain, snow, UV
                    exposure, dust, and physical damage. They are designed to remain legible for
                    extended periods even in harsh weather conditions
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                  <span>
                    <strong>Interchangeable colour-coded inserts</strong> &mdash; the tag holder
                    accepts colour-coded insert cards (green, yellow/amber, red) that can be swapped
                    quickly when the scaffold&rsquo;s status changes. This means the tag holder
                    stays in place at the access point, and only the insert is changed when a new
                    inspection is carried out or the status changes. This is faster and more
                    reliable than removing and replacing an entire tag
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                  <span>
                    <strong>Structured information format</strong> &mdash; the insert cards have
                    pre-printed fields for all required information: inspection date, inspector
                    name, CISRS card number, inspector signature, next inspection due date, scaffold
                    location/reference, scaffolding contractor name, maximum permitted loading,
                    restrictions (for yellow tags), and a unique tag serial number. This
                    standardised format ensures that no critical information is omitted
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                  <span>
                    <strong>Unique serial numbers</strong> &mdash; every Scafftag insert carries a
                    unique serial number that provides full traceability. The serial number links
                    the tag at the access point to the inspection record held by the scaffolding
                    contractor and/or the principal contractor. This means that every inspection can
                    be traced back to a specific tag, a specific inspector, and a specific date.
                    Serial numbers are also useful for auditing tag management and detecting
                    tampering or unauthorised tag changes
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                  <span>
                    <strong>Universal recognition</strong> &mdash; because the NASC/CISRS Scafftag
                    system is used across the UK construction industry, workers moving between sites
                    can immediately recognise and understand the tagging system. This consistency
                    reduces the risk of confusion or misinterpretation that can occur with
                    site-specific bespoke systems
                  </span>
                </li>
              </ul>
                ...
                <div className="bg-slate-500/10 border border-slate-500/30 rounded-lg p-4">
                  ...
                  <ul className="space-y-1 text-xs text-white/70">
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                      <span>
                        Endorsed by the HSE as best-practice scaffold status communication
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    ...
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                      <span>
                        Integrated with CISRS card scheme for inspector competence verification
                      </span>
                    </li>
                  </ul>
                </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-slate-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The <strong>advanced scaffolding inspection scheme</strong> refers to the formal,
                structured approach to scaffold inspection that goes beyond the basic visual check
                carried out by everyday users. It is the inspection regime required by the{' '}
                <strong>Work at Height Regulations 2005</strong> (Schedule 7) and the{' '}
                <strong>Construction (Design and Management) Regulations 2015</strong>, and it must
                be carried out by a <strong>competent person</strong> with specific training,
                knowledge, and experience in scaffold inspection.
              </p>
              ...
              <p>
                The regulations require the inspector to be a &ldquo;competent person&rdquo; &mdash;
                someone with sufficient training, practical experience, knowledge, and other
                qualities to carry out the inspection properly. In the UK scaffolding industry, this
              ...
              <ul className="space-y-2 text-sm text-white/70">
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                  <span>
                    <strong>CISRS Scaffolding Inspector</strong> &mdash; the primary qualification
                    for scaffold inspection. Holders have completed a dedicated scaffold inspection
                    training course covering structural principles, inspection methodology, defect
                    identification, reporting requirements, and the relevant legislation and
                    standards. This is the most appropriate qualification for carrying out statutory
                ...
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                  <span>
                    <strong>CISRS Advanced Scaffolder</strong> &mdash; advanced scaffolders who have
                    completed additional training in scaffold inspection may also carry out
                    inspections. Their advanced training covers complex scaffold configurations,
                    design interpretation, and structural assessment, which provides the knowledge
                    base needed for thorough inspections
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                  <span>
                    <strong>Equivalent qualifications</strong> &mdash; persons with equivalent
                    qualifications and demonstrable competence may also be accepted, but they must
                    be able to demonstrate that their training, knowledge, and experience are
                    sufficient for the type of scaffold being inspected. A generic construction
                    qualification (such as a standard CSCS card) is not sufficient on its own
                  </span>
                </li>
              </ul>
              ...
              <p>
                The advanced inspection is a systematic, thorough examination of every component and
                aspect of the scaffold. It is not a quick walk-around — it requires the inspector to
                physically access all parts of the scaffold, check every element, and record the
              ...
              <ul className="space-y-2 text-sm text-white/70">
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                  <span>
                    <strong>Foundations and base plates</strong> &mdash; adequacy of the ground
                    conditions, sole boards (if required), base plates correctly positioned and in
                    good condition, standards centrally located on base plates, no settlement or
                    movement
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                  <span>
                    <strong>Standards (uprights)</strong> &mdash; plumb, correctly spaced, in good
                    condition (not bent, cracked, or corroded), couplers tight, joints correctly
                    staggered, vertical alignment maintained throughout the full height
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                  <span>
                    <strong>Ledgers (horizontal tubes)</strong> &mdash; level, correctly coupled to
                    standards, at the correct spacing and heights, not bent or damaged
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                  <span>
                    <strong>Bracing</strong> &mdash; diagonal and plan bracing in place in
                    accordance with the design, couplers tight, bracing continuous and not
                    interrupted by missing sections
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                  <span>
                    <strong>Ties</strong> &mdash; correct type, spacing, and number as specified in
                    the design. Ties secure, not loose or missing. Tie fixings into the building
                    adequate and not pulling out. Tie tubes correctly positioned and coupled
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                  <span>
                    <strong>Platforms and boarding</strong> &mdash; fully boarded, boards in good
                    condition (not split, warped, or weakened), boards correctly supported and
                    secured, no gaps exceeding 25 mm, boards extending beyond the supporting ledger
                    by at least 50 mm but no more than four times the board thickness
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                  <span>
                    <strong>Guardrails and toe boards</strong> &mdash; guardrails at the correct
                    height (minimum 950 mm above the working platform), intermediate guardrails or
                    brick guards in place to prevent falls through the gap, toe boards at least 150
                    mm high, all components secure and not damaged
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                  <span>
                    <strong>Access and egress</strong> &mdash; ladders correctly positioned, secured
                    at the top, extending at least 1 metre above the landing platform, access gates
                    or trap doors functioning correctly, internal stairways or ladder access safe
                    and unobstructed
                  </span>
                </li>
              </ul>
              ...
              <p>
                Following the inspection, the competent person must{' '}
                <strong>issue a written inspection report</strong> within 24 hours. This report
                becomes part of the statutory inspection record and must be kept on site until the
                scaffold is dismantled, then retained by the employer for a minimum of three months
                after that. The report must identify any defects found, the action taken or
                recommended, and must be provided to the person on whose behalf the inspection was
                carried out (typically the principal contractor). If the scaffold passes the
                inspection, the appropriate tag (green or yellow) is attached at every access point.
                If the scaffold fails, a red tag is attached and the scaffold must not be used until
                the defects are rectified and a re-inspection is carried out.
              </p>
              ...
              <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                <div className="flex items-start gap-2">
                  <AlertTriangle className="h-5 w-5 text-slate-400 flex-shrink-0 mt-0.5" />
                  <p className="text-sm text-white">
                    <strong className="text-slate-400">What To Do If There Is No Tag:</strong> If
                    you arrive at a scaffold and there is no tag displayed at the access point, you
                    must <strong>NOT use the scaffold</strong>. Treat it exactly as you would a
                    red-tagged scaffold. Do not assume the tag has blown off, that someone forgot to
                    put it up, or that the scaffold is safe because it was tagged yesterday. Report
                    the missing tag to your supervisor, site manager, or scaffolding contractor
                    immediately. The scaffold must be inspected by a competent person and a valid
                    tag attached before anyone is permitted to use it. Using an untagged scaffold is
                    a disciplinary offence on most sites and a serious risk to your life.
                  </p>
                </div>
              </div>
            </div>
