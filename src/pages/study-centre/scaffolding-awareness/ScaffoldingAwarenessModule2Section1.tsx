...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['Every 7 days', 'Every 14 days', 'Every 28 days', 'Monthly'],
    correctIndex: 0,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['470 mm', '500 mm', '600 mm', '300 mm'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['Regulation 8', 'Regulation 10', 'Regulation 12', 'Regulation 14'],
    correctAnswer: 2,
    explanation:
...
const inspectionTimeline = [
  ...
  },
  {
    ...
    detail:
      'At intervals not exceeding 7 days while the scaffold remains erected on a construction site',
    icon: 'calendar',
  },
  {
    trigger: 'After Adverse Weather',
    detail:
      'Following exposure to conditions likely to have affected strength or stability (e.g. high winds, heavy rain, frost)',
    icon: 'weather',
  },
  {
  ...
  },
  {
    ...
    detail:
      'Following any event likely to have affected the stability or structural integrity of the scaffold',
    icon: 'impact',
  },
];
...
const ScaffoldingAwarenessModule2Section1 = () => {
  useSEO({
    title: 'Work at Height Regulations 2005 | Scaffolding Awareness Module 2 Section 1',
    description:
      ...
      <article className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6 text-xs sm:text-sm text-white">
            <div className="rounded-lg p-3 sm:p-4 bg-slate-500/10 border-l-2 border-l-slate-500/50 border border-slate-500/30">
              ...
              <ul className="text-base text-white space-y-1.5">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    The <strong>Work at Height Regulations 2005 (SI 2005/735)</strong> are the
                    primary UK regulations governing all work at height.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                  <span>
                    They apply to <strong>all scaffolding work</strong> &mdash; erection, use,
                ...
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                  <span>
                    <strong>No minimum height threshold</strong> &mdash; if there is a risk of a
                    fall liable to cause personal injury, the regulations apply.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                  <span>
                    Made under the <strong>Health and Safety at Work etc. Act 1974</strong> and
                    implement EU Directive 2001/45/EC on temporary work at height.
                  </span>
                </li>
              </ul>
            </div>
            <div className="rounded-lg p-3 sm:p-4 bg-slate-500/10 border-l-2 border-l-slate-500/50 border border-slate-500/30">
              <p className="font-semibold text-base text-slate-400 mb-2">
                Why It Matters for Scaffolding
              </p>
              <ul className="text-base text-white space-y-1.5">
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                  <span>
                    Falls from scaffolds remain one of the{' '}
                    <strong>leading causes of workplace death and serious injury</strong> in the UK
                ...
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                  <span>
                    The regulations set out <strong>specific Schedule requirements</strong> for
                    guard rails, toe boards, and working platforms on scaffolds.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                  <span>
                    <strong>Regulation 12</strong> mandates 7-day inspections by a competent person
                    for scaffolds on construction sites.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                  <span>
                    Breach of these regulations can result in{' '}
                    <strong>HSE enforcement action</strong>, including prohibition notices,
        ...
        <section className="mb-10">
          ...
          <ul className="space-y-3 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                Explain the scope and purpose of the Work at Height Regulations 2005 as they apply
                to scaffolding
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-slate-400 mt-0.5 flex-shrink-0" />
              <span>
                Describe the requirements of Schedule 1 (existing places of work at height),
                Schedule 2 (guard rails and toe boards), and Schedule 3 (working platforms)
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-slate-400 mt-0.5 flex-shrink-0" />
              <span>
                State the inspection requirements under Regulation 12, including frequency,
                triggers, and record-keeping
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-slate-400 mt-0.5 flex-shrink-0" />
              <span>
                Define what constitutes a competent person for scaffold inspection and explain their
                duties
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-slate-400 mt-0.5 flex-shrink-0" />
              <span>
                Apply the hierarchy of control measures, with collective protection taking priority
          ...
          <div className="border-l-2 border-slate-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                ...
                requirements for scaffold structures. These Schedules translate the general duty to
                provide safe work-at-height equipment into measurable, enforceable standards. Every
                scaffold must comply with all three.
              </p>
              ...
              <div className="bg-white/5 border border-slate-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  guard rails or additional intermediate rails. Always check the scaffold design and
                  the site-specific requirements before assuming the statutory minimums are
                  sufficient.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-slate-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                Schedule 1 of the Work at Height Regulations sets out the conditions that must be
                met for any existing place of work at height, including a scaffold that has already
                been erected and is in use. The requirements apply throughout the life of the
                scaffold, not just at the point of erection.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0" />
                    <div>
                      <strong>Stability:</strong> The scaffold must be stable at all times. This
                      means adequate ties to the building, properly seated base plates and sole
                      boards, and bracing that has not been removed or displaced.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0" />
                    <div>
                      <strong>Strength and rigidity:</strong> The scaffold must have sufficient
                      strength and rigidity for its intended purpose. Loading must not exceed the
                      design capacity, and components must not be damaged, corroded, or bent beyond
                      acceptable limits.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0" />
                    <div>
                      <strong>Safe condition:</strong> The scaffold must be maintained so that it
                      does not present a risk to the health or safety of any person. Boards must be
                      secure, fittings tightened, and access routes kept clear.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0" />
                    <div>
                      <strong>Surface conditions:</strong> The surface of every working platform,
                      access route, and ladder must not give rise to a risk of any person slipping,
                      tripping, or being caught between any moving part and a fixed structure.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0" />
                    <div>
                      <strong>Weather conditions:</strong> The scaffold must not be used in weather
                      conditions that could endanger the health or safety of any person. High winds,
                      ice, heavy rain, and snow can all affect scaffold stability and the safety of
                      those using it.
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  scaffold does not meet these requirements, you must{' '}
                  <strong className="text-white">not use it</strong> and{' '}
                  <strong className="text-white">report the defect immediately</strong> to the site
                  supervisor or scaffold coordinator. Never assume someone else has already reported
                  it.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-slate-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                Schedule 2 provides the detailed technical requirements for edge protection on
                scaffolds. Guard rails, intermediate rails, and toe boards form the primary
                collective fall protection system. These requirements apply to every scaffold
                working platform where there is a risk of a person or materials falling.
              </p>
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <strong>950 mm</strong> above the edge of the working platform. This is the
                      primary barrier preventing a person from falling off the scaffold.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0" />
                    <div>
                      <strong>Intermediate guard rail:</strong> Where the gap between the top guard
                      rail and the toe board (or platform surface) exceeds 470 mm, an intermediate
                      guard rail must be fitted. This prevents a person from slipping or rolling
                      through the gap beneath the top rail.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0" />
                    <div>
                      <strong>470 mm rule:</strong> No unprotected gap in the edge protection may
                      exceed 470 mm. This applies to the gap between the top rail and the
                      intermediate rail, and the gap between the intermediate rail and the toe board
                      or platform.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0" />
                    <div>
                      <strong>Strength:</strong> Guard rails must be of sufficient strength and
                      rigidity to prevent any person from falling and to withstand the forces likely
                      to be applied to them, including a person leaning against or bumping into the
                      rail.
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0" />
                    <div>
                      <strong>Minimum height:</strong> Toe boards must be at least{' '}
                      <strong>150 mm</strong> in height, measured from the surface of the working
                      platform.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0" />
                    <div>
                      <strong>Purpose:</strong> Toe boards prevent tools, materials, and debris from
                      falling from the scaffold platform onto persons below. They also provide a
                      visual and physical boundary at the edge of the platform.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0" />
                    <div>
                      <strong>Continuous protection:</strong> Toe boards must be fitted along the
                      full length of any open edge of the platform. Gaps at corners, returns, and
                      ladder access points must be minimised and controlled.
                    </div>
                  </div>
                </div>
              </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-slate-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                Schedule 3 sets out the requirements for working platforms, including scaffold
                platforms. While Schedule 2 focuses on what happens at the edge, Schedule 3 focuses
                on the platform itself &mdash; its dimensions, surface, structural adequacy, and
                suitability for the work being carried out.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0" />
                    <div>
                      <strong>Suitable and sufficient:</strong> The platform must be suitable and
                      sufficient for the purpose for which it is intended. A platform used for
                      bricklaying, for example, must accommodate the materials, the mortar, and the
                      working space needed by the bricklayer, as well as safe passage along its
                      length.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0" />
                    <div>
                      <strong>Dimensions:</strong> The platform must be wide enough for safe passage
                      of persons and for the safe use of any equipment or materials. For a
                      general-purpose scaffold, a minimum of 600 mm clear width is typically
                      required, but wider platforms are needed where materials are stacked or where
                      specific trades require additional space.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0" />
                    <div>
                      <strong>No dangerous gaps:</strong> Boards must be close-butted or arranged so
                      that no gap exists through which a person could fall or through which tools
                      and materials could drop onto those below. The maximum gap between boards is
                      generally accepted as 25 mm.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0" />
                    <div>
                      <strong>Surface condition:</strong> The platform surface must not give rise to
                      a risk of any person slipping, tripping, or being caught. Boards must be in
                      good condition, free from excessive bowing, splits, or projecting nails.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0" />
                    <div>
                      <strong>Load-bearing capacity:</strong> The platform must be capable of
                      bearing the loads imposed on it, including the static weight of persons and
                      materials and any dynamic loading from movement, stacking, or impact. The
                      design load must be clearly communicated (often via scaffold signage or the
                      scaffold register).
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-white/5 border border-slate-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  a maximum of 150 mm for a standard 38 mm board). Excessive overhang creates a
                  tipping hazard when a person steps near the unsupported end. Boards must also be
                  secured against uplift by wind or displacement by movement.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-slate-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                Regulation 12 is one of the most critical regulations for scaffolding on
                construction sites. It establishes when scaffolds must be inspected, who may carry
                out the inspection, and what must be recorded. Failure to comply with Regulation 12
                is one of the most common breaches found by HSE inspectors during site visits.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0" />
                    <div>
                      <strong>Foundations:</strong> Base plates seated properly on firm ground or
                      sole boards; no settlement, undermining, or displacement.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0" />
                    <div>
                      <strong>Standards (uprights):</strong> Plumb, adequately braced, spigot joints
                      properly engaged, and free from visible damage or deformation.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0" />
                    <div>
                      <strong>Ledgers and transoms:</strong> Level, properly connected with correct
                      fittings, and capable of supporting the platform boards and imposed loads.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0" />
                    <div>
                      <strong>Bracing:</strong> Diagonal and plan bracing in place as per the
                      design; not removed, displaced, or damaged.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0" />
                    <div>
                      <strong>Ties:</strong> All ties to the structure present and secure; tie
                      pattern matching the design requirements; reveal ties, through ties, or
                      proprietary ties in good condition.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0" />
                    <div>
                      <strong>Platforms:</strong> Boards in good condition, fully supported,
                      close-butted, not overhanging excessively, and secured against displacement.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0" />
                    <div>
                      <strong>Edge protection:</strong> Guard rails, intermediate rails, and toe
                      boards all in place and meeting Schedule 2 requirements.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0" />
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0" />
                    <div>
                      Details of any matter identified that could give rise to a risk to health or
                      safety
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  <strong className="text-white">
                    reports not signed or not available on site
                  </strong>
                  , and{' '}
                  <strong className="text-white">defects identified but not acted upon</strong>. Any
                  of these can result in enforcement action. The inspection report must be available
                  on site for the HSE inspector to view at any time.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-slate-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                The Work at Height Regulations place significant emphasis on two overarching
                principles: that work at height must be supervised and inspected by a{' '}
                <strong>competent person</strong>, and that <strong>collective protection</strong>{' '}
                must always be prioritised over personal protection. Both principles are central to
                scaffold safety.
              </p>
                ...
                <div className="space-y-3 text-sm">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      inspection, typically demonstrated by holding a CISRS Scaffold Inspection
                      Training Scheme (SITS) card or equivalent.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0" />
                    <div>
                      <strong>Practical experience:</strong> Hands-on experience of scaffold
                      erection, use, and inspection in a variety of situations and configurations.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0" />
                    <div>
                      <strong>Theoretical knowledge:</strong> Understanding of the relevant
                      regulations, standards (TG20, BS EN 12811), structural behaviour, loading, and
                      the types of defects that can occur.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0" />
                    <div>
                      <strong>Ability to detect defects:</strong> The person must be capable of
                      identifying defects and assessing whether the scaffold is safe to use,
                      requires remedial work, or must be taken out of service.
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0" />
                    <div>
                      Carry out inspections at the required intervals (before first use, every 7
                      days, and after triggering events)
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0" />
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0" />
                    <div>
                      Provide the report to the person on whose behalf the inspection was carried
                      out within 24 hours
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0" />
                    <div>
                      Identify and record any defect that could give rise to a risk to health or
                      safety
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0" />
                    <div>
                      Recommend that the scaffold be taken out of service if it is unsafe to use
                      until defects are remedied
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="bg-green-500/10 border border-green-500/30 p-3 rounded-lg">
                    <div className="flex items-center gap-3">
                      <span className="w-7 h-7 rounded-full bg-green-500/20 border border-green-500/40 flex items-center justify-center text-green-400 text-xs font-bold flex-shrink-0">
                        1
                      </span>
                      <div>
                  ...
                  <div className="bg-blue-500/10 border border-blue-500/30 p-3 rounded-lg">
                    <div className="flex items-center gap-3">
                      <span className="w-7 h-7 rounded-full bg-blue-500/20 border border-blue-500/40 flex items-center justify-center text-blue-400 text-xs font-bold flex-shrink-0">
                        2
                      </span>
                      <div>
                  ...
                  <div className="bg-amber-500/10 border border-amber-500/30 p-3 rounded-lg">
                    <div className="flex items-center gap-3">
                      <span className="w-7 h-7 rounded-full bg-amber-500/20 border border-amber-500/40 flex items-center justify-center text-amber-400 text-xs font-bold flex-shrink-0">
                        3
                      </span>
                      <div>
              ...
              <div className="bg-white/5 border border-slate-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  on each individual wearing and correctly using their own equipment. A guard rail
                  works whether you are paying attention or not. A harness only works if it is
                  correctly fitted, attached to a suitable anchor, inspected, and the wearer does
                  not detach it. In scaffolding terms, this means the scaffold itself &mdash; with
                  its platforms, guard rails, and toe boards &mdash; is the primary fall protection
                  system. Harnesses are only needed during erection and dismantling (the
                  &ldquo;leading edge&rdquo;) before collective protection is fully in place.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-slate-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                Proper record keeping is a legal requirement under the Work at Height Regulations
                and is essential for demonstrating compliance. Records also provide vital evidence
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0" />
                    <div>
                      <strong>Inspection reports:</strong> Must be prepared for every inspection and
                      kept until the next inspection report is made, or for 3 months after the
                      inspection date, whichever is the later (Regulation 12(6)).
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0" />
                    <div>
                      <strong>Availability:</strong> A copy of the most recent inspection report
                      must be kept at the site where the scaffold is erected and be available for
                      inspection by any person on whose behalf an inspection was carried out, or by
                      an HSE or local authority inspector.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0" />
                    <div>
                      <strong>24-hour rule:</strong> The competent person must provide the
                      inspection report to the person on whose behalf the inspection was carried out
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      Regulations, most sites maintain a scaffold register that records every
                      scaffold on site, its inspection status, permitted loading, and any
                      restrictions. This is considered best practice and is often a principal
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0" />
                    <div>
                      <strong>Best practice retention:</strong> Although the regulations require
                      retention for 3 months or until the next report, best practice is to keep all
                      records for the duration of the project and for at least 6 years afterwards.
                      If an accident occurs, having the full inspection history will be essential
                      evidence.
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                <ul className="text-white space-y-3 text-sm">
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-slate-400 mt-0.5 flex-shrink-0" />
                    <span>
                      The <strong>Work at Height Regulations 2005</strong> are the primary UK law
                      governing scaffold safety. There is no minimum height &mdash; they apply
                      wherever there is a risk of a fall liable to cause personal injury.
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-slate-400 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong>Schedule 1</strong> requires scaffolds to be stable, strong, and
                      maintained in a safe condition throughout their life.
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-slate-400 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong>Schedule 2</strong> sets minimum dimensions for edge protection: 950
                      mm top guard rail, 470 mm maximum unprotected gap, 150 mm toe board height.
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-slate-400 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong>Schedule 3</strong> requires working platforms to be suitable,
                      sufficient, free from dangerous gaps, and capable of bearing the imposed
                      loads.
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-slate-400 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong>Regulation 12</strong> mandates scaffold inspections before first use,
                      every 7 days, and after triggering events, carried out by a competent person
                  ...
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-slate-400 mt-0.5 flex-shrink-0" />
                    <span>
                      The <strong>hierarchy of control</strong> requires avoiding work at height
                      first, then collective protection, then personal protection as a last resort.
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-slate-400 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong>Inspection reports</strong> must be delivered within 24 hours,
                      retained for at least 3 months (best practice: 6+ years), and available on
                      site for HSE inspection.
                    </span>
                  </li>
                </ul>
              </div>
        ...
        {/* ─── Quiz ─── */}
        <div className="mt-12">
          <Quiz title="Work at Height Regulations 2005 Quiz" questions={quizQuestions} />
        </div>
