...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    question: 'What is differential settlement and why is it dangerous for scaffolding?',
    options: [
...
const faqs = [
  {
    question: 'Can scaffold be erected directly on tarmac or concrete without sole boards?',
    answer:
  ...
  {
    question: 'What happens if a scaffold is erected near an excavation?',
    answer:
  ...
  {
    question: 'How do you use adjustable base plates on sloping ground?',
    answer:
  ...
  {
    question: 'What is the difference between bearing capacity and bearing pressure?',
    answer:
...
const quizQuestions = [
  ...
  {
    id: 3,
    question: 'What is the minimum base plate size for a standard tube-and-fitting scaffold?',
    options: ['100mm square', '125mm square', '150mm square', '200mm square'],
    correctAnswer: 2,
    explanation:
  ...
  {
    id: 7,
    question: 'Which of the following is a sign of differential settlement in a scaffold?',
    options: [
...
export default function ScaffoldingAwarenessModule3Section2() {
  useSEO({
    title: 'Base Plates, Sole Boards & Foundations | Scaffolding Awareness Module 3.2',
    description:
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-slate-500/5 border-l-2 border-slate-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Base plates:</strong> Minimum 150mm square &mdash; distributes standard load
                onto sole board
              </li>
              <li>
                <strong>Sole boards:</strong> Minimum 1000mm long for a single standard &mdash;
                spreads load onto ground
              </li>
              <li>
                <strong>Ground check:</strong> Always assess bearing capacity before erection begins
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-slate-500/5 border-l-2 border-slate-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Settlement:</strong> Prevent by spreading loads with adequate sole boards
              </li>
              <li>
                <strong>Excavations:</strong> Keep foundations outside the 45&deg; zone of influence
              </li>
              <li>
                <strong>Slopes:</strong> Use adjustable bases &mdash; max 300mm extension typical
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-slate-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Before any scaffold is erected, the{' '}
                <strong>ground conditions at the base must be assessed</strong> to determine whether
                they can safely support the loads that the scaffold will impose. This is one of the
                most critical steps in scaffold erection and is frequently the point at which
                problems originate. A scaffold that is perfectly designed and correctly assembled
                will still fail if the ground beneath it cannot take the load.
              </p>
              ...
              <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  ...
                  ultimate foundation of every scaffold. Every load &mdash; from self-weight,
                  working platforms, materials, operatives, wind, and any other imposed load &mdash;
                  must eventually pass through the standards, base plates, and sole boards into the
                  ground. If the ground cannot support these loads, the scaffold will settle, tilt,
                  or collapse.
                </p>
              </div>
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      paving slabs, grass, bare earth, or artificial surface? Assess the thickness
                      and condition of any hard surface
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Underground services:</strong> Are there
                      drains, culverts, inspection chambers, cellars, vaults, or other voids beneath
                      the surface that could collapse under scaffold loads?
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  <strong className="text-white">
                    Always carry out a ground assessment before erection
                  </strong>{' '}
                  and raise concerns with the scaffold supervisor or designer if conditions appear
                  unsuitable.
                </p>
              </div>
            </div>
          ...
          <div className="border-l-2 border-slate-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                right. These two concepts explain why some scaffolds settle and others do not, and
                why sole board size matters so much.
              </p>
              ...
              <div className="space-y-3">
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white/80 space-y-1">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Sound rock:</strong> 1000+ kN/m&sup2; &mdash;
                        excellent support
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Stiff clay:</strong> 150&ndash;300 kN/m&sup2;
                        &mdash; good when dry, weakens when wet
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Soft clay:</strong> 50&ndash;100 kN/m&sup2;
                        &mdash; marginal, requires larger sole boards
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    ...
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        ...
                        Highly variable &mdash; treat with extreme caution, may need engineer
                        assessment
                      </span>
                    </li>
                  </ul>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-white/80 mb-3">
                    ...
                    standard by the contact area of the sole board or base plate in contact with the
                    ground.
                  </p>
              ...
              <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  ...
                  the{' '}
                  <strong>bearing pressure must always be less than the bearing capacity</strong> of
                  the ground. If the bearing pressure exceeds the ground&rsquo;s bearing capacity,
                  the ground will fail beneath the scaffold, causing settlement, tilting, or
                  collapse. The simplest way to reduce bearing pressure is to{' '}
                  <strong>increase the contact area</strong> by using larger sole boards.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-slate-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                from the standard tube over a wider area of the sole board or bearing surface.
                Without a base plate, the tube would bear on a very small area (the cross-section of
                the tube itself &mdash; approximately 48.3mm diameter), which would punch through
                timber sole boards and create extreme point loads on any surface.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Minimum size:</strong> 150mm x 150mm square for
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-red-400 flex-shrink-0" />
                    <span>Severely corroded plates with reduced thickness</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-red-400 flex-shrink-0" />
                    <span>Missing, bent, or damaged spigots or locating pins</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-red-400 flex-shrink-0" />
                    <span>Cracked welds on adjustable base plate stems</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-red-400 flex-shrink-0" />
                    <span>Stripped or damaged threads on adjustable (screw jack) bases</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="border-l-2 border-slate-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                Without adequate sole boards, even large base plates will concentrate loads too
                heavily and the scaffold will sink into all but the hardest surfaces.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Width:</strong> At least the full width of a
                      scaffold board (225mm minimum) &mdash; wider sole boards may be needed on soft
                      ground (two boards side-by-side or purpose-made timber pads)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">
                        Two standards (e.g. inner and outer row):
                      </strong>{' '}
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Soft ground:</strong> The scaffold designer may
                      specify larger sole boards, double-thickness boards, or purpose-made timber
                      grillage pads to achieve the required load-spreading area
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-slate-500/30 rounded-xl p-6 sm:p-8">
                ...
                <div className="mt-10 bg-slate-500/10 border border-slate-500/30 rounded-lg p-3 text-center">
                  <span className="text-xs sm:text-sm text-slate-300">
                    Load passes from standard &rarr; through base plate &rarr; spread across sole
                    board &rarr; into ground
                  </span>
                </div>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-slate-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Scaffolding frequently needs to be erected on <strong>sloping ground</strong>{' '}
                &mdash; building facades on hillsides, sites with gradient changes, driveways, and
                car parks with falls. Adjustable base plates (screw jacks) allow the scaffolders to
                set each standard to the correct vertical position while the base sits on sloping or
                uneven ground.
              </p>
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      required height by{' '}
                      <strong className="text-white">rotating the adjustment nut</strong>
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      This allows the{' '}
                      <strong className="text-white">bottom lift to be set level</strong> even
                      though the ground slopes
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      The first ledger level is then horizontal, and the entire scaffold above is
                      plumb and level
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Typical maximum extension:</strong> 300mm of
                      exposed thread (or as specified by the manufacturer)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                      Excessive extension creates a{' '}
                      <strong className="text-white">long unsupported length</strong> of thread that
                      can bend, buckle, or introduce eccentric loading
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                      If the slope requires more than 300mm adjustment,{' '}
                      <strong className="text-white">
                        stepped sole boards, raking foundations, or a purpose-designed foundation
                      </strong>{' '}
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Always ensure the{' '}
                      <strong className="text-white">sole board beneath is firmly bedded</strong>{' '}
                      against the slope and cannot slide downhill
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-slate-400">On Site:</strong> On steep slopes, it is common
                  to see <strong>stepped foundations</strong> where timber sole boards are cut into
                  the slope at different levels, each one level and firmly bedded. Each standard
                  then sits on its own level platform with minimal screw jack extension. This
                  approach is far safer than trying to compensate for a large slope entirely through
                  screw jack adjustment. On very steep sites, the scaffold designer may specify
                  concrete pads, driven posts, or other engineered foundation solutions.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="text-white space-y-4 leading-relaxed">
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white/80 space-y-1">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Sole boards are always required</strong> on
                        soft ground &mdash; no exceptions
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        Sole boards must be{' '}
                        <strong className="text-white">
                          large enough to reduce the bearing pressure below the ground&rsquo;s
                          bearing capacity
                        </strong>
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        ...
                        <strong className="text-white">
                          standard sole boards may not be sufficient
                        </strong>{' '}
              ...
              <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  ...
                  procedure, regardless of whether the ground appears firm. This eliminates judgment
                  errors and provides a consistent, safe foundation for every scaffold. If in doubt
                  about whether sole boards are needed, always fit them &mdash; it is far better to
                  have sole boards that were not strictly necessary than to omit them and have the
                  scaffold settle.
                </p>
              </div>
            </div>
          ...
          <div className="border-l-2 border-slate-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                into the ground. Understanding{' '}
                <strong>how loads travel through the scaffold</strong> and how to{' '}
                <strong>spread them at the base</strong> is essential for preventing settlement.
              </p>
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      equipment) act on the{' '}
                      <strong className="text-white">working platforms</strong>
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      Platform boards transfer loads to the{' '}
                      <strong className="text-white">transoms or putlogs</strong> that support them
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <p className="text-sm text-white/80">
                      ...
                      instability &mdash; the scaffold remains plumb and level relative to itself.
                      However, it changes the relationship with the building (e.g. ties may become
                      overstressed) and must be corrected.
                    </p>
                  </div>
                  <div>
                    <p className="text-sm text-white mb-1">
                    ...
                    <p className="text-sm text-white/80">
                      ...
                      abnormal stress on couplers, and can lead to progressive collapse.
                      Differential settlement is the more common and more dangerous form of
                      settlement on site.
                    </p>
                  </div>
                </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-red-400 flex-shrink-0" />
                    <span>Scaffold leaning or tilting away from the building</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-red-400 flex-shrink-0" />
                    <span>Ties becoming tight, loose, or pulling out of the building</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-red-400 flex-shrink-0" />
                    <span>Standing water pooling around the base of the scaffold</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Use adequately sized sole boards</strong> to
                      spread loads so that bearing pressure stays below the ground&rsquo;s bearing
                      capacity
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Manage drainage</strong> &mdash; divert water
                      away from the scaffold base, do not allow puddles to form around sole boards
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      ...
                      signs of settlement during every scaffold inspection, particularly after heavy
                      rain or load changes
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-slate-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Erecting scaffolding near{' '}
                <strong>
                  trenches, foundation digs, basement excavations, or other open ground
                </strong>{' '}
                requires careful consideration of the effect that the excavation has on the bearing
                capacity of the adjacent ground. This is a common scenario on construction sites and
                is a frequent cause of scaffold incidents when not properly managed.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80 mb-3">
                  ...
                  excavation where the ground has significantly reduced bearing capacity and is at
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      <strong className="text-white">
                        45 degrees from the bottom of the excavation
                      </strong>{' '}
                      outward to the ground surface
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      For a 2-metre deep trench, the zone of influence extends approximately 2
                      metres back from the edge of the trench at ground level
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">
                        Scaffold loads within the zone of influence can cause the ground to collapse
                      </strong>{' '}
                      into the excavation, undermining the scaffold foundations
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">
                        Never place scaffold foundations within the zone of influence
                      </strong>{' '}
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      zone, the excavation must be properly{' '}
                      <strong className="text-white">
                        shored, sheet-piled, or otherwise supported
                      </strong>{' '}
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      A{' '}
                      <strong className="text-white">
                        structural engineer or scaffold designer
                      </strong>{' '}
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      that was stable when the scaffold was erected may deteriorate over time due to
                      weather, dewatering, additional excavation, or removal of temporary supports
                      &mdash; regular monitoring is essential
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
              ...
              <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  ...
                  construction site is dynamic &mdash; trenches are opened, backfilled, and reopened
                  as work progresses. A scaffold that was safely positioned one day may find itself
                  within the zone of influence of a new excavation the next. Always{' '}
                  <strong>communicate with the site team</strong> about planned excavation work near
                  scaffold positions and <strong>reassess scaffold foundations</strong> whenever the
                  ground conditions around the base change.
                </p>
              </div>
            </div>
          </div>
