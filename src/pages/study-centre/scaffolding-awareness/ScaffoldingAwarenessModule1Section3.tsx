...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    question: 'Why are diagonal braces essential to the structural integrity of a scaffold?',
    options: [
...
const faqs = [
  {
    question: 'What is the difference between a transom and a putlog?',
    answer:
  ...
  {
    question: 'What are sole boards and why are they so important for scaffold foundations?',
    answer:
...
const quizQuestions = [
  ...
  {
    id: 3,
    question: 'What do transoms support on a scaffold?',
    options: [
  ...
  {
    id: 4,
    question: 'What is the minimum height for a toe board on a scaffold working platform?',
  ...
  {
    id: 6,
    question: 'What is the purpose of base plates in a scaffold system?',
    options: [
  ...
  {
    id: 7,
    question: 'Which type of coupler is used to connect diagonal braces to standards?',
    options: ['Right-angle coupler', 'Putlog coupler', 'Sleeve coupler', 'Swivel coupler'],
    correctAnswer: 3,
    explanation:
  ...
  {
    id: 8,
    question: 'What is the maximum permitted overhang of a scaffold board beyond its end support?',
    options: [
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-slate-500/5 border-l-2 border-slate-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Standards:</strong> Vertical tubes carrying load to ground
              </li>
              <li>
                <strong>Ledgers &amp; transoms:</strong> Horizontal tubes &mdash; length &amp; width
              </li>
              <li>
                <strong>Braces:</strong> Diagonal tubes preventing collapse
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-slate-500/5 border-l-2 border-slate-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Guard rails:</strong> Min 950 mm &mdash; collective fall prevention
              </li>
              <li>
                <strong>Toe boards:</strong> Min 150 mm &mdash; prevent falling objects
              </li>
              <li>
                <strong>Couplers:</strong> Right-angle, swivel, putlog, sleeve &amp; more
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="border-l-2 border-slate-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                <strong> vertical tubes</strong> that form the backbone of every tube-and-fitting
                scaffold. They carry the scaffold&rsquo;s entire load vertically downward to the
                ground: the self-weight of the scaffold structure, the weight of the working
                platforms (boards), all stored materials, and every worker standing on the scaffold
                at any given time. Without standards, there is no scaffold.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong>Inner standards</strong> run along the building face (the side nearest
                      the structure being worked on). <strong>Outer standards</strong> run along the
                      outside edge of the scaffold, furthest from the building.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      Standards must be <strong>plumb</strong> (truly vertical). A standard that
                      leans introduces an eccentric load that increases bending stress in the tube
                      and can cause buckling under load. Plumbness is checked during erection using
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      scaffold &mdash; commonly <strong>2.1 m (7 bays) or 2.7 m</strong>{' '}
                      centre-to-centre, depending on the scaffold&rsquo;s duty classification and
                      design loading. Closer spacing increases load capacity; wider spacing reduces
                      it.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      Every standard must rest on a <strong>base plate</strong>, which in turn sits
                      on a<strong> sole board</strong> (on soft or unfinished ground). This
                      distributes the concentrated point load from the bottom of the standard over a
                      larger area so the ground can support it without settlement.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      Standards are joined together vertically using{' '}
                      <strong>sleeve couplers</strong> (also called joint pins or spigots) when the
                      scaffold height exceeds the length of a single tube. These joints must be
                      staggered &mdash; adjacent standards must not have their joints at the same
                      level &mdash; to maintain structural integrity.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      Standard scaffold tube is <strong>48.3 mm outside diameter</strong> (nominal
                      bore: 1.5 inches), made from steel (Grade S235 or S355 to BS EN 39) or
                      aluminium alloy (to BS EN 74). Steel tubes have a wall thickness of
                      approximately 3.2 mm or 4.0 mm.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  plus environmental loads (wind, snow). Differential settlement &mdash; where one
                  standard sinks more than its neighbours &mdash; is one of the most common causes
                  of scaffold collapse and is almost always due to inadequate ground preparation.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-slate-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Ledgers are <strong>horizontal tubes</strong> that run along the{' '}
                <strong>length</strong> of the scaffold (the longitudinal direction), connecting one
                standard to the next along each row. They are one of the three primary structural
                members of a scaffold, alongside standards and transoms.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      Ledgers <strong>tie the scaffold together longitudinally</strong> &mdash; they
                      prevent the standards from spreading apart or moving independently along the
                      length of the scaffold. Without ledgers, the standards would be free-standing
                      vertical tubes with no connection to one another.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      There are <strong>inner ledgers</strong> (running along the building face,
                      connecting the inner standards) and <strong>outer ledgers</strong> (running
                      along the outside edge, connecting the outer standards). Both must be present
                      at each lift height.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      Ledgers are connected to the standards using{' '}
                      <strong>right-angle couplers</strong>
                      (because they meet the standards at 90°). The coupler must be fully tightened
                      to the correct torque to ensure a secure connection that can resist both
                      vertical slip loads and horizontal forces.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      The vertical spacing between ledgers defines the <strong>lift height</strong>{' '}
                      &mdash; the distance between successive working platform levels. Typical lift
                      heights are
                      <strong> 2.0 m</strong> (the most common) or <strong>2.7 m</strong>, depending
                      on the scaffold design and the clearance required for the type of work.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      Ledgers also serve as <strong>support points for transoms</strong>. The
                      transoms sit on top of the inner and outer ledgers (connected by right-angle
                      couplers) and in turn support the scaffold boards that form the working
                      platform.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      Where a ledger needs to be longer than a single tube length, two tubes can be
                      joined using a <strong>sleeve coupler</strong>. The joint should be positioned
                      near a standard (not in the middle of a bay) and joints in adjacent ledgers
                      must be staggered to maintain structural integrity.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  structural integrity. Also check that ledger joints are staggered and not aligned
                  at the same standard on adjacent lifts.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-slate-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Transoms are <strong>horizontal tubes</strong> that run across the{' '}
                <strong>width</strong> of the scaffold, connecting the inner and outer standards (or
                more precisely, the inner and outer ledgers). Their primary function is to{' '}
                <strong>support the working platforms</strong>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      Transoms must be <strong>level</strong> (horizontal) to provide a flat, even
                      surface for the scaffold boards. A sloping transom creates a sloping platform,
                      which is both a tripping hazard and a risk of materials sliding off the edge.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      In an <strong>independent scaffold</strong>, transoms are connected to both
                      the inner and outer ledgers using <strong>right-angle couplers</strong>. They
                      span the full width of the scaffold and are supported at both ends, making
                      them structurally independent of the building.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      Transoms are positioned at each pair of standards (these are called{' '}
                      <strong>main transoms</strong> or <strong>ledger transoms</strong>) and may
                      also be placed at intermediate positions between standards (called{' '}
                      <strong>intermediate transoms</strong>) to provide additional support for the
                      scaffold boards and prevent excessive board deflection.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      The spacing of transoms determines the{' '}
                      <strong>span of the scaffold boards</strong>. If transoms are too far apart,
                      the boards will deflect excessively under load, creating a bouncy,
                      uncomfortable working surface and potentially exceeding the board&rsquo;s safe
                      bending capacity.
                    </span>
                  </li>
                </ul>
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      <strong> putlog scaffolding</strong> (also known as bricklayer&rsquo;s
                      scaffolding). Instead of connecting to an inner ledger, the putlog has a{' '}
                      <strong>flattened end</strong> (called a blade) that slots into the horizontal
                      mortar joint of the brickwork at the building face.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      ...
                      <strong> putlog coupler</strong>. This means the scaffold relies on the
                      building wall for support on one side &mdash; it is not independent.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      Putlog scaffolds are only suitable for{' '}
                      <strong>new brickwork construction</strong>
                      where mortar joints are available to receive the putlog blade. They must not
                      be used on buildings with cavity wall construction where the inner leaf might
                      not be strong enough to support the putlog load.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      Putlog scaffolds have <strong>only a single row of standards</strong> (the
                      outer row), making them quicker and cheaper to erect than independent
                      scaffolds, but they are limited to lighter duties and are dependent on the
                      building&rsquo;s structural integrity.
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-slate-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Braces are <strong>diagonal tubes</strong> that provide <strong>rigidity</strong> to
                the scaffold structure and prevent it from <strong>racking</strong> (distorting from
                a rectangle into a parallelogram under lateral force). Without braces, a scaffold is
                nothing more than a collection of vertical and horizontal tubes that can fold flat
                under the slightest lateral load &mdash;{' '}
                <strong>a scaffold without braces will collapse</strong>.
              </p>
                  ...
                  <div className="bg-black/30 rounded-lg p-4">
                    ...
                    <ul className="text-xs text-white/70 space-y-1.5">
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                        <span>
                          Run diagonally <strong>in the plane of the scaffold face</strong> (the
                          vertical plane)
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                        <span>
                          Connect a standard at one lift level to a standard at the next lift level,
                          crossing diagonally across one or more bays
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                      ...
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                        <span>
                          Usually arranged in a zigzag pattern up the face of the scaffold
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                        <span>
                          Connected to standards using <strong>swivel couplers</strong> (because
                          they meet at an angle, not 90°)
                        </span>
                      </li>
                    </ul>
                  </div>
                  <div className="bg-black/30 rounded-lg p-4">
                    ...
                    <ul className="text-xs text-white/70 space-y-1.5">
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                        <span>
                          Run diagonally <strong>in the horizontal plane</strong>, at platform level
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                        <span>
                          Connect the inner ledger to the outer ledger at an angle, typically across
                          one or more bays
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                        <span>
                          Prevent the scaffold from <strong>twisting</strong> or distorting in plan
                          view
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                        <span>
                          Particularly important for <strong>freestanding scaffolds</strong> and
                          scaffolds with returns (corners)
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                        <span>
                          Also connected using <strong>swivel couplers</strong>
                        </span>
                      </li>
                    </ul>
                  </div>
              ...
              <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  workers pushing and pulling during their work &mdash; will cause the unbraced
                  scaffold to rack and collapse. Braces must be installed{' '}
                  <strong>during erection</strong> as the scaffold goes up, not left until the
                  scaffold is complete. The scaffold designer specifies the bracing pattern, and the
                  scaffolder must follow this exactly. Removing braces to create access openings
                  without the designer&rsquo;s approval is extremely dangerous and has caused
                  fatalities.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80 mb-3">
                  ...
                  leans over. But a triangle cannot be distorted without changing the length of one
                  of its sides, which the rigid steel tube prevents. By adding a diagonal brace
                  across the rectangle, you create two triangles within it, making the entire frame
                  rigid.
                </p>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-slate-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Guard rails, mid rails, and toe boards together form the{' '}
                <strong>collective fall prevention system</strong> on a scaffold working platform.
                They protect workers from falling from the platform edge and prevent materials,
                tools, and debris from falling onto people below. These are{' '}
                <strong>not optional extras</strong> &mdash; they are legally required by the Work
                at Height Regulations 2005 (Schedule 3).
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      Guard rails must be positioned at a <strong>minimum height of 950 mm</strong>{' '}
                      above the working platform surface. This is the absolute minimum &mdash; a
                      height of 1,000 mm or more is preferred where practicable.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      The guard rail must be a scaffold tube (or equivalent rigid barrier) capable
                      of withstanding the forces specified in BS EN 12811-1 &mdash; typically a
                      horizontal point load of at least 0.3 kN applied at any point along its
                      length.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      Guard rails are required on <strong>all open edges</strong> of the working
                      platform where a person could fall 2 metres or more. In practice, this means
                      the outer edge and both ends of every working platform, plus any internal
                      openings (such as ladder access points) that are not fitted with trap doors.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      Mid rails are required to fill the gap between the top guard rail and the toe
                      board. The Work at Height Regulations specify that there must be
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      positioned approximately halfway (at about 470&ndash;500 mm above the
                      platform) ensures no gap exceeds the 470 mm maximum.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      Without a mid rail, a worker who trips, stumbles, or is struck by an object
                      could fall <strong>through the 800 mm gap</strong> between the guard rail and
                      the toe board &mdash; particularly if they are bending down or in a crouching
                      position.
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      Toe boards must be a <strong>minimum of 150 mm high</strong>, measured from
                      the surface of the working platform. They are positioned at the outer edge of
                      the platform, tight against the scaffold boards.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      ...
                      <strong>materials, tools, and debris</strong>
                      from being kicked, knocked, or rolling off the platform edge and falling onto
                      people below. A falling brick or hammer can cause fatal injuries to a person
                      at ground level, even from a modest height.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong>Brick guards</strong> (also called scaffold fans or debris netting
                      panels) are additional protection fitted above the toe boards, extending
                      upward to the guard rail height. They are required where there is a risk of
                      materials falling through the gap between the toe board and the guard rail
                      &mdash; for example, on scaffolds used for brickwork, where loose bricks,
                      mortar, and tools are present at platform level.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      Brick guards are typically wire mesh panels or proprietary expanding metal
                      panels that clip to the inside of the standards between the toe board and the
                      guard rail. They allow air flow and visibility while preventing objects from
                      passing through.
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  action from the individual worker. They are higher in the hierarchy of control
                  than personal fall protection (harnesses and lanyards) because they do not depend
                  on the worker remembering to clip on, wearing equipment correctly, or maintaining
                  their PPE. Collective measures are always preferred over personal measures under
            ...
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      Base plates are flat <strong>steel plates</strong> (typically 150 mm &times;
                      150 mm or larger) with a central spigot that the bottom of the standard tube
                      sits over. They spread the concentrated point load from the standard over a
                      larger area.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      Every standard must have a base plate &mdash; <strong>no exceptions</strong>.
                      Placing a standard directly on the ground without a base plate concentrates
                      the load on the small cross-sectional area of the tube end (approximately 580
                      mm&sup2; for a 48.3 mm tube with 4 mm wall), which would punch into almost any
                      ground surface.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong>Adjustable base plates</strong> (screw jacks) incorporate a threaded
                      stem that allows the height to be adjusted. These are essential on{' '}
                      <strong>uneven ground</strong> where the ground surface is not level. The
                      screw jack allows each standard to be set to the correct height so that the
                      first lift of ledgers is level, without packing materials or shims (which can
                      shift or crush under load).
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      ...
                      extension &mdash; typically <strong>300 mm to 600 mm</strong>. Over-extension
                      reduces the effective load capacity and creates a buckling risk in the
                      threaded stem.
                    </span>
                  </li>
                </ul>
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      timber) placed on the ground beneath the base plates to distribute the load
                      over a still larger area of ground. They are essential on{' '}
                      <strong>soft, unfinished, or unpaved ground</strong> where the base plate
                      alone would not spread the load sufficiently.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      The sole board must be large enough to reduce the{' '}
                      <strong>bearing pressure</strong>
                      (load per unit area) to a level the ground can safely support. On firm,
                      compacted ground, a single scaffold board beneath the base plate may suffice.
                      On soft, wet, or recently backfilled ground, much larger sole boards (or even
                      concrete pads) may be required.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      Sole boards must be placed <strong>level</strong>. They must{' '}
                      <strong>not be stacked</strong> (one on top of another) to make up height
                      differences &mdash; stacked boards can slide apart under load. If the ground
                      is uneven, the ground should be levelled first, or adjustable base plates
                      should be used.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      On some sites, a continuous sole board runs beneath two or more adjacent
                      standards. This provides additional stability and prevents differential
                      settlement between neighbouring standards.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  stored materials on the platforms; all workers (live load); wind loads transmitted
                  through the scaffold; and any dynamic loads from hoisting or materials handling.
                  For a heavily loaded scaffold, the load at the base of a single standard can be{' '}
                  <strong>several tonnes</strong>. This is why ground conditions must be assessed
                  before erection begins, and the foundation design must be adequate for the
                  specific ground conditions encountered.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-slate-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                together. Every joint in a tube-and-fitting scaffold is made using a coupler, and
                the type of coupler used at each connection is critical to the scaffold&rsquo;s
                structural performance. Using the wrong coupler, or failing to tighten a coupler
                correctly, can lead to joint failure and scaffold collapse.
              </p>
              ...
              <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  concentrations) or strip the bolt threads. The standard tightening torque for
                  scaffold couplers is typically
                  <strong> 40&ndash;50 Nm</strong>. Site operatives should use a torque wrench or at
                  the very least a scaffold spanner of the correct length (which limits the applied
                  torque by the leverage available). A simple test is that the coupler should be
                  tight enough that it cannot be turned by hand, but should not require excessive
            ...
            <div className="text-white space-y-4 leading-relaxed">
                  ...
                  <div className="bg-black/30 rounded-lg p-4">
                    ...
                    <ul className="text-xs text-white/70 space-y-1.5">
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                        <span>
                          Standard thickness: <strong>38 mm</strong> (nominal)
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                        <span>
                          Standard width: <strong>225 mm</strong> (nominal)
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                  ...
                  <div className="bg-black/30 rounded-lg p-4">
                    ...
                    <ul className="text-xs text-white/70 space-y-1.5">
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                        <span>
                          Maximum unsupported span: <strong>3.9 m</strong>
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                        <span>
                          Boards must rest on at least <strong>3 supports</strong> if spanning more
                          than 1.2 m
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                        <span>
                          Minimum overlap on supports: <strong>50 mm</strong>
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                        <span>
                          Maximum gap between boards: <strong>25 mm</strong>
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80 mb-3">
                  ...
                  equals 152 mm, so the governing limit is <strong>150 mm</strong>.
                </p>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div className="bg-black/30 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70">
                      ...
                      throwing the worker off or creating a trip hazard for others. This see-saw
                      effect has caused serious falls.
                    </p>
                  </div>
                  <div className="bg-black/30 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70">
                      ...
                      transom and hold the board down securely. Board clips are essential on all
                      working platforms, particularly at exposed and elevated positions.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong>Internal ladders</strong> are the most common form of access between
                      scaffold lifts. They must extend at least{' '}
                      <strong>1 metre above the platform level</strong>
                      they serve (to provide a handhold when stepping off), be set at the correct
                      angle (approximately 75° or 4:1 ratio), and be securely tied or clipped to
                      prevent slipping.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong>Trap doors</strong> (also called access hatches) are openings in the
                      working platform through which ladders pass. The trap door is a hinged section
                      of the platform that can be opened to climb through and then closed to
                      complete the platform and prevent falls through the opening. Self-closing trap
                      doors are preferred because they close automatically when released.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong>Internal stairways</strong> (scaffold staircases) provide a safer and
                      more ergonomic alternative to ladders, particularly for scaffolds that will be
                      in use for extended periods or where workers need to carry materials up to the
                      working platform. Stairways are wider, have handrails on both sides, and allow
                      workers to maintain three points of contact while ascending and descending.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong>Ladder beams</strong> are proprietary aluminium beams with integral
                      rungs that serve as both a structural beam (replacing a transom) and a means
                      of access. They are commonly used in system scaffolding where the ladder beam
                      spans between two standards and provides both platform support and a built-in
                      ladder.
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      A <strong>hop-up</strong> is a small, portable working platform used to
                      provide additional height within a scaffold bay &mdash; typically when the
                      worker needs to reach slightly higher than the main working platform allows
                      without raising the entire platform to the next lift level.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      Hop-ups must be stable, level, and have a platform area large enough for the
                      worker to stand on safely. They must not be improvised from stacked materials
                      (bricks, blocks, buckets) &mdash; only purpose-designed hop-up brackets or
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      approximately <strong>600 mm</strong>. If the required working height is
                      greater than this, the scaffold design should be adjusted (e.g. by adding an
                      intermediate lift) rather than using increasingly tall hop-ups.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  <strong>
                    {' '}
                    split, cracked, warped, twisted, excessively knotted, rotted, or has been
                    painted
                  </strong>{' '}
                  (paint conceals defects). Check that the metal end bands are intact and securely
                  fixed &mdash; a board without end bands is liable to split lengthways under load.
                  Boards must be stored flat and off the ground to prevent warping and moisture
                  damage. Damaged boards must be removed from service immediately and marked for
                  disposal or repair.
                </p>
              </div>
            </div>
          ...
          <div className="bg-white/5 border border-white/10 rounded-xl p-4 sm:p-6 overflow-hidden">
            ...
            <div className="relative mx-auto max-w-4xl">
              <div className="relative border-2 border-slate-500/40 rounded-lg bg-gradient-to-b from-slate-500/5 to-transparent">
                ...
                <div className="border-b border-dashed border-slate-500/20 p-3 sm:p-4">
                  <p className="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-3">
                    Top Lift &mdash; Edge Protection &amp; Working Platform
                  </p>
                ...
                <div className="border-b border-dashed border-slate-500/20 p-3 sm:p-4">
                  <p className="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-3">
                    Main Structure &mdash; Primary Members
                  </p>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                    <div className="flex items-start gap-2">
                      <span className="flex-shrink-0 w-5 h-5 rounded-full bg-slate-500/20 border border-slate-500/40 flex items-center justify-center text-[10px] font-bold text-slate-400">
