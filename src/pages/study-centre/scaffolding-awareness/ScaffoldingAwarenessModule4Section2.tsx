...
const faqs = [
  {
    question: 'Can I carry out a scaffold inspection myself, or does it have to be a scaffolder?',
    answer:
  ...
  {
    question: 'What is the difference between a pre-use check and a formal inspection?',
    answer:
  ...
  {
    question: 'How do I know if a coupler is tight enough during an inspection?',
    answer:
...
const quizQuestions = [
  ...
  {
    id: 2,
    question: 'What is the minimum height for a guardrail above the working platform surface?',
    options: ['750mm', '900mm', '950mm', '1000mm'],
    correctAnswer: 2,
    explanation:
  ...
  {
    id: 4,
    question: 'What is the maximum permissible gap between scaffold boards on a working platform?',
    options: ['10mm', '25mm', '35mm', '50mm'],
    correctAnswer: 1,
    explanation:
          ...
          <div className="rounded-lg p-4 bg-slate-500/5 border-l-2 border-slate-500/50">
            ...
            <ul className="text-white/80 text-base space-y-1.5">
              <li className="flex items-start gap-2">
                ...
                <span>
                  <strong className="text-white">Bottom to top:</strong> always inspect from
                  foundations upward — ground, base plates, standards, ledgers, transoms, bracing,
                  ties, platforms, guardrails, access
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                <span>
                  <strong className="text-white">Guardrails:</strong> minimum 950mm, mid-rails
                  fitted, toe boards in place, no gaps exceeding 470mm
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                <span>
                  <strong className="text-white">Boards:</strong> no gaps exceeding 25mm, boards in
                  good condition, fully supported
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                <span>
                  <strong className="text-white">Ties:</strong> every tie must be present, tight,
                  and not removed — missing ties can cause collapse
                </span>
              </li>
            </ul>
          </div>
          <div className="rounded-lg p-4 bg-slate-500/5 border-l-2 border-slate-500/50">
            ...
            <ul className="text-white/80 text-base space-y-1.5">
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                <span>
                  <strong className="text-white">Use a checklist:</strong> never rely on memory — a
                  structured checklist ensures every element is checked in order
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                <span>
                  <strong className="text-white">Record findings:</strong> write down what you find
                  — both defects and confirmations that elements are satisfactory
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                <span>
                  <strong className="text-white">Defects found:</strong> tag the scaffold
                  immediately and report to the scaffold contractor — do not allow use until
                  rectified
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                <span>
                  <strong className="text-white">Check the tag:</strong> before using any scaffold,
                  always check the scaffold tag — green means safe, red means do not use
                </span>
              </li>
            </ul>
          </div>
          ...
          <div className="border-l-2 border-slate-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                logical sequence, checking every structural element in order, so that nothing is
                missed. The universally accepted method is to inspect from the{' '}
              ...
              <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  on the requirements of the Work at Height Regulations 2005 (Schedule 7). The
                  checklist should be completed on site during the inspection — not filled in
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <strong className="text-white">Step 1 — Foundations:</strong> ground
                      conditions, sole boards, base plates, adjustable legs
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Step 2 — Standards:</strong> plumb, spacing,
                      splices, condition of tubes
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Step 3 — Ledgers:</strong> level, couplers
                      tight, no missing ledgers
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Step 4 — Transoms:</strong> spacing correct,
                      couplers tight, supporting boards properly
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Step 5 — Bracing:</strong> complete as per
                      design, couplers tight, not removed
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Step 6 — Ties:</strong> all present, tight,
                      anchored correctly, not removed by trades
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Step 7 — Platforms:</strong> boards complete,
                      in good condition, no gaps exceeding 25mm
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Step 8 — Guardrails:</strong> minimum 950mm,
                      mid-rails, toe boards in place
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Step 9 — Access:</strong> ladders secured, trap
                      doors operational, stairways clear
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Step 10 — Loading:</strong> within design
                      limits, no excessive storage of materials
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Step 11 — Overall condition:</strong> general
                      appearance, signage, hazard proximity, public protection
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div className="my-6">
                ...
                <div className="mt-4 bg-white/5 border border-slate-500/30 rounded-lg p-3">
                  <p className="text-slate-300 text-xs sm:text-sm font-medium">
                    ...
                    everything above is compromised — there is no point checking guardrails if the
                    scaffold is sinking into the ground.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="border-l-2 border-amber-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                conditions, sole boards, base plates, and any adjustable legs. Every standard
                (upright) must be properly supported and transferring its load safely to the ground.
              </p>
              ...
              <div className="bg-white/5 border border-amber-400/30 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-3 text-sm">
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Ground conditions:</strong> is the ground firm,
                      level, and capable of supporting the scaffold load? Look for signs of
                      waterlogging, soft spots, recent excavation, or underground voids. Ground
                      conditions can change after heavy rain — what was firm last week may be soft
                      today
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Sole boards:</strong> are sole boards in place
                      under every base plate? Are they of adequate size and thickness to spread the
                      load? Are they level, not cracked or split, and sitting flat on the ground
                      with no rocking? Sole boards must be timber (not bricks, blocks, or other
                      makeshift packing)
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Base plates:</strong> is every standard sitting
                      on a base plate? Are the base plates centred on the sole boards? Are they flat
                      and not bent or damaged? Is the standard located centrally in the base plate
                      spigot?
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Settlement:</strong> is there any visible
                      settlement of base plates or sole boards into the ground? Even small amounts
                      of settlement can cause standards to go out of plumb. Look for base plates
                      that appear lower than adjacent ones or sole boards that have sunk into soft
                      ground
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Adjustable base plates:</strong> if the
                      scaffold uses adjustable (screw-jack) base plates, check that they are not
                      extended beyond the maximum permitted extension (typically 300mm for standard
                      base plates) and that the locking nuts are tight
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Drainage:</strong> is water pooling around the
                      base of the scaffold? Standing water can soften the ground and undermine sole
                      boards. Check that site drainage directs water away from scaffold foundations
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-slate-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/70 text-sm">
                  ...
                  plates should be used on proper sole boards — not bricks stacked up to make up the
                  difference. If you see makeshift packing during an inspection, the scaffold must
                  not be used until the foundations have been properly rectified by a competent
                  scaffolder.
                </p>
              </div>
            </div>
          ...
          <div className="border-l-2 border-slate-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                standard is out of plumb, damaged, or improperly spliced, the structural integrity
                of the entire scaffold bay is affected.
              </p>
              ...
              <div className="bg-white/5 border border-slate-400/30 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-3 text-sm">
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Plumb (vertical):</strong> standards must be
                      vertical. A leaning standard is a sign of foundation settlement, loose
                      couplers, or structural distortion. Use a spirit level or plumb line if there
                      is any doubt — visual assessment alone can be misleading on tall scaffolds
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Spacing:</strong> standards must be spaced
                      according to the scaffold design. For a general-purpose scaffold, standard
                      spacing is typically between 1.8m and 2.4m along the length. Check that no
                      bays are wider than the design permits
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Splices:</strong> where two tubes are joined to
                      form one standard, the splice must be made with a proper sleeve coupler or
                      external joint pin. Splices in adjacent standards must be{' '}
                      <strong className="text-white">staggered</strong> — never at the same lift.
                      Check that the splice is positioned within the middle third of the lift height
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Tube condition:</strong> check for bent tubes,
                      deep corrosion, dents, or cracks. Scaffold tubes that are significantly
                      corroded lose wall thickness and therefore load-carrying capacity. Bent tubes
                      must be replaced, not straightened and re-used
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Continuity:</strong> every standard must run
                      continuously from the base plate to the top of the scaffold. There must be no
                      breaks or missing sections in any standard
                    </div>
                  </li>
                </ul>
              </div>
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                forces. Each has a distinct structural role, and each must be inspected for correct
                installation, tight couplers, and good condition.
              </p>
              ...
              <div className="bg-white/5 border border-blue-400/30 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Level:</strong> ledgers must be horizontal. A
                      ledger that dips or rises between standards indicates that the standards are
                      at different heights or the couplers have slipped
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Couplers tight:</strong> check every coupler
                      connecting ledgers to standards. Apply hand pressure — there should be no
                      movement. Look for couplers that have slipped down the standard or have
                      visibly loose T-bolts
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">No missing ledgers:</strong> every
                      standard-to-standard connection must have a ledger at each lift height on both
                      the inner and outer rows. Missing ledgers reduce the structural capacity of
                      the scaffold
                    </div>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-blue-400/30 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Spacing:</strong> transoms must be spaced
                      according to the scaffold design — typically at every standard position plus
                      intermediate transoms as needed to support the boards. No scaffold board
                      should span more than four transoms or be unsupported at any point
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Couplers tight:</strong> transoms are connected
                      to ledgers using right-angle couplers or putlog couplers. Check that all
                      couplers are tight and that the transoms have not rotated or moved out of
                      position
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Board support:</strong> check that every
                      scaffold board is supported by at least three transoms. Boards must overhang
                      their end transoms by at least 50mm but no more than four times the board
                      thickness (typically no more than 150mm for a 38mm board)
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-blue-400/30 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Complete as per design:</strong> check that all
                      bracing shown on the scaffold design drawing is in place. This includes facade
                      bracing (on the outside face), ledger bracing (connecting inner and outer
                      standards diagonally in plan), and any additional bracing specified for the
                  ...
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Couplers tight:</strong> bracing is typically
                      connected using swivel couplers, which allow the brace to be fixed at any
                      angle. Check that all swivel couplers are tight — loose bracing provides no
                      structural benefit
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Not removed:</strong> bracing is sometimes
                      removed by workers to gain access or to allow materials to be loaded. This is
                      extremely dangerous — removing bracing can cause the scaffold to collapse
                      under wind loading or eccentric loading. All bracing must remain in place
                      unless a competent scaffolder redesigns the scaffold to account for the
                      modification
                    </div>
                  </li>
                </ul>
          ...
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                scaffold — and one of the most commonly interfered with by other trades. Missing
                ties are a leading cause of scaffold collapse in the UK.
              </p>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/70 text-sm">
                  ...
                  scaffold collapses where the primary cause was ties that had been removed by other
                  trades and not replaced.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-red-400/30 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-3 text-sm">
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">All ties present:</strong> compare the number
                      and location of ties to the scaffold design drawing. Every tie shown on the
                      design must be in place. Count them — do not assume they are all there because
                      the scaffold &ldquo;looks right&rdquo;
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Tight and secure:</strong> check that every tie
                      is tight — there should be no slack or play in the tie. Apply hand pressure to
                      each tie to verify it is firmly connected at both ends (the scaffold and the
                      building)
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Properly anchored:</strong> the building end of
                      the tie must be fixed to a structurally sound anchorage point — typically a
                      through-tie through a window opening or a ring bolt fixed into solid masonry.
                      Ties should not be fixed to window frames, rainwater pipes, fascia boards, or
                  ...
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Not removed by trades:</strong> trades
                      sometimes remove ties to gain access for cladding, rendering, painting, or
                      window installation. If any ties have been removed, the scaffold must not be
                      used until they have been replaced by a competent scaffolder. Check with site
                      management whether any ties have been temporarily removed
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Tie pattern:</strong> ties must follow the
                      pattern specified in the scaffold design — typically at every other standard
                      at every other lift (a staggered pattern), but this varies depending on the
                      scaffold height, configuration, and wind loading requirements
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  their work. Establish a system where trades must notify the scaffold contractor
                  before removing any tie — and the scaffold contractor must install temporary
                  alternative ties before the permanent tie is removed.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-green-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                that is incomplete, has large gaps, or lacks proper edge protection is a
                fall-from-height hazard that can be fatal.
              </p>
              ...
              <div className="bg-white/5 border border-green-400/30 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-3 text-sm">
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Boards complete:</strong> every working
                      platform must be fully boarded across its full width. There should be no
                      missing boards. A platform with a missing board is a fall-through hazard — a
                      person can fall through the gap or step into it and lose their balance
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Gaps no greater than 25mm:</strong> check the
                      gaps between adjacent boards. Gaps must not exceed 25mm. Use a tape measure if
                      there is any doubt. Gaps that are too wide are a trip hazard and allow small
                      tools or debris to fall through to people below
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Board condition:</strong> check every board for
                      cracks, splits, warping, rot, excessive wear, or damage. Boards that are
                      cracked or split can break under load. Boards that are warped do not sit flat
                      and create a trip hazard. Boards with excessive knots or defects in the timber
                      must be replaced
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Board overhang:</strong> boards must overhang
                      the end transom by at least 50mm but no more than four times the board
                      thickness (typically no more than 150mm for a 38mm thick board). Boards that
                      overhang too far become a tipping hazard when a worker steps on the
                      unsupported end
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Boards secured:</strong> boards must be secured
                      against displacement by wind uplift or accidental movement. This is typically
                      achieved using board retaining clips or by nailing boards to transoms. Check
                      that clips are in place and that boards cannot be lifted or slid out of
                      position
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Clear of debris:</strong> platforms must be
                      free from loose materials, tools, brick rubble, mortar droppings, and standing
                      water. A cluttered platform is a trip hazard and can obstruct emergency escape
                      routes
                    </div>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-green-400/30 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-3 text-sm">
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Height — minimum 950mm:</strong> the top
                      guardrail must be at least 950mm above the working platform surface. Measure
                      from the top of the board to the top of the guardrail tube. There is no
                      tolerance — 950mm means 950mm
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Mid-rail:</strong> a mid-rail must be fitted so
                      that the unprotected gap between the guardrail and the toe board (or platform
                      surface) does not exceed 470mm. The mid-rail prevents a person from rolling or
                      sliding under the top guardrail
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Toe boards:</strong> toe boards must be fitted
                      at every working platform edge to a minimum height of 150mm above the platform
                      surface. They prevent materials, tools, and debris from being kicked off the
                      edge of the platform onto people below. Check that toe boards are in place,
                  ...
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Continuous protection:</strong> guardrails,
                      mid-rails, and toe boards must be continuous around all open sides of the
                      working platform. There should be no gaps or unprotected sections. Check
                      particularly at corners, returns, and loading bay openings
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Securely fixed:</strong> guardrail tubes must
                      be securely fixed to the standards using right-angle couplers. Apply hand
                      pressure — the guardrail should not move or flex excessively. A guardrail that
                      gives way under pressure will not stop a person from falling
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                <h3 className="font-semibold mb-2 text-slate-400">Key Measurements to Remember</h3>
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                scaffold that is overloaded can fail catastrophically, and the signs of overloading
                are often visible during an inspection.
              </p>
              ...
              <div className="bg-white/5 border border-purple-400/30 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-3 text-sm">
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Ladders secured:</strong> access ladders must
                      be securely fixed at the top to prevent them from slipping or falling. The
                      ladder must extend at least 1 metre above the platform it serves (or have an
                      equivalent handhold) to give the user something to hold while stepping on and
                      off the ladder
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Ladder condition:</strong> check that ladder
                      stiles and rungs are not cracked, bent, corroded, or missing. Damaged ladders
                      must be removed from service immediately — not repaired on site
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Trap doors:</strong> where ladders pass through
                      working platforms, a trap door (hatch) must be fitted. The trap door must open
                      and close freely and must be kept closed when not in use to maintain the
                      integrity of the platform edge protection. A jammed or missing trap door is a
                      fall hazard through the platform opening
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Internal stairways:</strong> on larger
                      scaffolds, internal stairway towers may be provided instead of ladders. Check
                      that stairways are clear, handrails are in place, and the stairway structure
                      is securely connected to the main scaffold
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Access not obstructed:</strong> check that
                      access routes are clear of stored materials, tools, rubble, and waste. Workers
                      must be able to access and leave the scaffold quickly in an emergency
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-purple-400/30 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-3 text-sm">
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Within design limits:</strong> every scaffold
                      has a designed load capacity, expressed as a duty rating. A general-purpose
                      scaffold is typically rated for 2.0 kN/m&sup2; (approximately 200 kg per
                      square metre) of distributed load. Check that the actual loading on the
                      platform does not obviously exceed the design capacity
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      ...
                      materials stored on scaffold platforms should not be stacked higher than the
                      guardrails. Materials stacked above guardrail height can fall off the edge,
                      and the additional weight at height increases the overturning moment on the
                      scaffold
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Signs of overloading:</strong> look for visible
                      deflection (sagging) of scaffold boards under the weight of stored materials.
                      Listen for creaking sounds when walking on the platform. Look for standards
                      that appear to be bowing or bending under load. These are signs that the
                      scaffold may be approaching or exceeding its design capacity
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Load notices displayed:</strong> check that the
                      scaffold has a load notice prominently displayed, stating the maximum
                      permitted loading. Workers must be aware of the load limits and must not
                      exceed them
                    </div>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-slate-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/70 text-sm">
                  ...
                  cumulatively, they can push the scaffold well beyond its design capacity. Unlike a
                  vehicle that warns you when it is overloaded, a scaffold gives no warning before
                  it fails. The first sign of overloading is often a sudden, catastrophic collapse.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                and look for common defects that may not fall neatly into a single category. The
                following visual guide summarises the most frequently encountered defects and their
                significance.
              </p>
                  ...
                  <div className="rounded-lg bg-red-500/10 border border-red-500/30 p-3 sm:p-4">
                    ...
                    <ul className="text-white/70 space-y-2 text-sm ml-5">
                      <li className="flex items-start gap-3">
                        <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                        <span>
                          Missing or removed ties — scaffold at risk of overturning in wind
                        </span>
                      </li>
                      <li className="flex items-start gap-3">
                        <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                        <span>
                          Foundation settlement causing standards to lean visibly out of plumb
                        </span>
                      </li>
                      <li className="flex items-start gap-3">
                        <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                        <span>
                          Missing guardrails on a working platform — unprotected fall edge
                        </span>
                      </li>
                      <li className="flex items-start gap-3">
                        <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                      ...
                      <li className="flex items-start gap-3">
                        <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                        <span>
                          Obvious severe overloading — boards visibly sagging under materials
                        </span>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="rounded-lg bg-amber-500/10 border border-amber-500/30 p-3 sm:p-4">
                    ...
                    <ul className="text-white/70 space-y-2 text-sm ml-5">
                      <li className="flex items-start gap-3">
                        <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                        <span>
                          Guardrail at less than 950mm but scaffold otherwise safe — restrict until
                          corrected
                        </span>
                      </li>
                      <li className="flex items-start gap-3">
                      ...
                      <li className="flex items-start gap-3">
                        <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                        <span>
                          Board gaps between 25mm and 35mm — trip hazard, materials can fall through
                        </span>
                      </li>
                      <li className="flex items-start gap-3">
                        <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                        <span>
                          Loose couplers that can be moved by hand — joints not providing full
                          restraint
                        </span>
                      </li>
                      <li className="flex items-start gap-3">
                        <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                        <span>
                          Trap door jammed open — platform opening unprotected when not in use
                        </span>
                      </li>
                      <li className="flex items-start gap-3">
                        <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                  ...
                  <div className="rounded-lg bg-blue-500/10 border border-blue-500/30 p-3 sm:p-4">
                    ...
                    <ul className="text-white/70 space-y-2 text-sm ml-5">
                      <li className="flex items-start gap-3">
                        <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                        <span>
                          Debris or materials cluttering the platform — housekeeping issue, clear
                          before use
                        </span>
                      </li>
                      <li className="flex items-start gap-3">
                      ...
                      <li className="flex items-start gap-3">
                        <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                        <span>
                          Scaffold tag faded but still legible — replace at next opportunity
                        </span>
                      </li>
                      <li className="flex items-start gap-3">
                        <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                      ...
                      <li className="flex items-start gap-3">
                        <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                        <span>
                          Standing water on platform after rain — sweep off before use to prevent
                          slips
                        </span>
                      </li>
                    </ul>
              ...
              <div className="bg-white/5 border border-cyan-400/30 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">General appearance:</strong> does the scaffold
                      look straight, level, and well-maintained? Or does it look crooked, patched,
                      or neglected? General appearance is a useful indicator of how well the
                      scaffold has been maintained
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Signage:</strong> is the scaffold tag in place
                      and current? Are load notices displayed? Are warning signs visible where the
                      scaffold is close to overhead power lines, public areas, or other hazards?
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Proximity hazards:</strong> check for overhead
                      power lines, nearby excavations, vehicle movements, crane operations, or other
                      site activities that could affect the scaffold. Has the exclusion zone been
                      maintained?
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Public protection:</strong> if the scaffold is
                      adjacent to a public footpath, road, or occupied building, check that fans,
                      netting, brick guards, or other protection is in place to prevent materials
                      from falling onto the public. Check that pedestrian walkways are properly lit,
                  ...
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Unauthorised alterations:</strong> look for
                      signs that the scaffold has been altered by anyone other than a competent
                      scaffolder — missing components, additional boards wedged in, ropes or straps
                      used instead of couplers, or components from different scaffold systems mixed
                      together. Any unauthorised alteration is a defect
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Sheeting and netting:</strong> if the scaffold
                      is sheeted or netted, check that the sheeting is securely fixed and not torn.
                      Sheeting significantly increases the wind loading on a scaffold — the tie
                      pattern must account for this additional load. Torn sheeting that is flapping
                      in the wind creates dynamic forces that are worse than static wind loading
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/70 text-sm">
                  ...
                  be present and it is your job to find them. Every element must actively pass your
                  inspection. If you cannot confirm that an element is satisfactory, treat it as a
                  defect until proven otherwise. It is always better to tag a scaffold unnecessarily
                  than to allow workers to use a defective one.
                </p>
              </div>
            </div>
          </div>
