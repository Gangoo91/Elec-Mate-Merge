...
const faqs = [
  ...
  {
    question: 'Can mobile scaffold towers be used outdoors in windy conditions?',
    answer:
  ...
  {
    question: 'What is the difference between a cantilever scaffold and a truss-out scaffold?',
    answer:
  ...
  {
    question: 'Does birdcage scaffolding need to be designed by a structural engineer?',
    answer:
...
const quizQuestions = [
  {
    id: 1,
    question: 'Independent scaffolding is defined by which key structural feature?',
    options: [
  ...
  {
    id: 7,
    question: 'Birdcage scaffolding is best described as which of the following?',
    options: [
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-slate-500/5 border-l-2 border-slate-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Independent &amp; putlog:</strong> Traditional tube-and-fitting types
              </li>
              <li>
                <strong>System:</strong> Pre-engineered modular (Layher, HAKI, Cuplok)
              </li>
              <li>
                <strong>Mobile towers:</strong> Aluminium on castors &mdash; PASMA trained
              </li>
              <li>
                <strong>Specialist:</strong> Cantilever, suspended, birdcage, and more
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-slate-500/5 border-l-2 border-slate-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>CISRS:</strong> Required for tube-and-fitting &amp; system scaffold erection
              </li>
              <li>
              ...
              <li>
                <strong>Design:</strong> Non-standard scaffolds need specific design
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-slate-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Independent scaffolding is the most widely used scaffold type on new-build
                construction sites in the UK. It consists of <strong>two rows of standards</strong>{' '}
                &mdash; an inner row (closest to the building) and an outer row &mdash; connected
                horizontally by <strong>ledgers</strong> (running along the length of the scaffold)
                and <strong>transoms</strong> (running across the width, between the inner and outer
                standards).
              </p>

              <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-slate-400">Key Feature:</strong> Independent scaffolding
                  does <strong>not rely on the building for support</strong>. The entire structure
                  is self-supporting. This is critical on new-build sites where the building walls
                  may not yet be strong enough to accept putlogs, or where the building fabric must
                  not be penetrated.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Two rows of standards:</strong> Inner and outer
                      rows, typically at 2.1&thinsp;m to 2.4&thinsp;m centres along the length
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Ledgers:</strong> Horizontal tubes running
                      along the scaffold at each lift height, connecting standards longitudinally
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Transoms:</strong> Horizontal tubes running
                      across the scaffold between inner and outer standards, supporting the scaffold
                      boards
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Bracing:</strong> Diagonal braces (facade
                      bracing and ledger bracing) to prevent racking and provide lateral stability
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Ties:</strong> Connected to the building at
                      specified intervals to prevent the scaffold from pulling away or overturning
                      in wind
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  ...
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      Renovation or refurbishment of completed buildings where the facade must not
                      be penetrated
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      Any application requiring a fully self-supporting structure that does not load
                      the building
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      Multi-trade access &mdash; providing working platforms for bricklayers,
                      electricians, cladding installers, painters, and others
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <p>
                Independent scaffolding uses more material than putlog scaffolding because it
                requires a full outer and inner row of standards and transoms. However, this
                additional material provides a stronger, more versatile structure that is suitable
                for a wider range of applications and does not depend on the building for any part
                of its support.
              </p>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-slate-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Putlog scaffolding uses a <strong>single row of standards</strong> set away from the
                building face, with horizontal members called <strong>putlogs</strong> extending
                from the outer ledger into the bed joints of the brickwork being laid. The inner end
                of each putlog is flattened (a &ldquo;blade&rdquo;) so it can sit in the mortar bed
                between courses of bricks.
              </p>

              <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-slate-400">Key Limitation:</strong> Putlog scaffolding can{' '}
                  <strong>only be used during bricklaying or masonry work</strong>. Because the
                  putlogs are inserted into the bed joints as the wall is built up, the scaffold
                  depends on the wall for support. Once the wall is complete, putlog scaffolding
                  cannot be used because the putlogs cannot be inserted without disturbing the
                  finished brickwork.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Single row of standards:</strong> Only the
                      outer row is erected &mdash; no inner row of standards
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Putlogs:</strong> Horizontal tubes with a
                      flattened blade end inserted into the brickwork bed joints at each lift
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Ledgers:</strong> Horizontal tubes along the
                      outer face connecting the standards
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Less material:</strong> Uses approximately 40%
                      less tube and fitting than independent scaffolding for the same facade area
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      Putlogs must be properly inserted into the bed joints with the blade sitting
                      flat and fully supported by the mortar
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      The wall must be strong enough to support the putlog loads &mdash; fresh
                      brickwork needs time to gain strength
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      Putlogs must not be removed before the scaffold above them has been dismantled
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      The scaffold must still be tied to the building at the required intervals for
                      stability
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  scaffold accidents involving putlog systems. Always ensure putlogs are correctly
                  bedded and the mortar has sufficient strength before loading the platform.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-slate-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                <strong>pre-engineered components</strong> that slot, clip, or wedge together at
                fixed node points on the standards. Unlike traditional tube-and-fitting scaffolding
                where every connection requires a separate coupler, system scaffold components are
                designed to connect directly to each other.
              </p>

              <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-slate-400">Common Systems:</strong> The most widely used
                  system scaffolds in the UK include <strong>Layher Allround</strong>,{' '}
                  <strong>HAKI Universal</strong>, <strong>Cuplok (SGB/BRAND)</strong>, and{' '}
                  <strong>Kwikstage</strong>. Each system has its own connection method &mdash;
                  rosette (Layher), cup-and-blade (Cuplok), wedge (Kwikstage) &mdash; but the
                  principle is the same: faster, more consistent assembly with fewer loose fittings.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Faster erection:</strong> Components slot
                      together without individual couplers, reducing erection time by up to 50%
                      compared to tube-and-fitting
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Consistent quality:</strong> Fixed node points
                      mean components always connect at the correct spacing &mdash; reducing errors
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Fewer loose components:</strong> No loose
                      couplers to drop, lose, or incorrectly tighten
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Higher load capacity:</strong> Node-point
                      connections typically give higher load ratings than individual couplers
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Versatility:</strong> System scaffolds can form
                      straight runs, corners, circular shapes, and complex geometries using standard
                      components
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  . CISRS (Construction Industry Scaffolders Record Scheme) training covers system
                  scaffolding, and most manufacturers also provide specific product training.
                  Untrained workers must never attempt to erect, alter, or dismantle system
                  scaffolding.
                </p>
              </div>

              <p>
                System scaffolding is now the dominant type on large commercial, industrial, and
                infrastructure projects in the UK. It is increasingly common on housing sites as
                well, particularly for multi-storey developments. Traditional tube-and-fitting
                remains important for bespoke or complex configurations that do not suit standard
                modular components.
              </p>
            </div>
          </div>
          ...
          <div className="border-l-2 border-slate-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                <strong>aluminium-framed structures on lockable castors</strong> (wheels). They are
                designed for short-duration work at height where a full scaffold is not justified.
                They are widely used by electricians, painters, decorators, M&amp;E installers, and
                maintenance teams.
              </p>

              <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-slate-400">Training Requirement:</strong>{' '}
                  <strong>PASMA</strong> (Prefabricated Access Suppliers&rsquo; and
                  Manufacturers&rsquo; Association) training is the industry-recognised standard for
                  assembling, using, inspecting, and dismantling mobile scaffold towers. PASMA
                  training covers the 3T method (Through the Trap) or Advance Guard Rail (AGR)
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Lock all castors:</strong> All four castors
                      must be locked before anyone climbs or works on the platform
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Height-to-base ratio:</strong> Maximum 3.5:1
                      outdoors and 3:1 indoors (unless stabilisers or outriggers are used) &mdash;
                      always follow the manufacturer&rsquo;s specific instructions
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Outriggers/stabilisers:</strong> Required for
                      taller configurations to increase the effective base width and prevent
                      overturning
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Never move while occupied:</strong> The tower
                      must never be moved with anyone on the platform or with tools and materials on
                      the platform
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Level ground:</strong> The tower must be
                      erected on firm, level ground &mdash; adjustable legs can compensate for minor
                      slopes
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Wind conditions:</strong> Do not use outdoors
                      in high winds &mdash; typically above 17&thinsp;mph (Beaufort force 4) for
                      standard towers
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      Electrical installation and maintenance &mdash; cable tray, containment,
                      lighting, fire alarms
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>Painting and decorating at height in rooms and corridors</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      Building maintenance &mdash; changing lights, accessing services, inspecting
                      ceilings
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      Short-duration external work where a full scaffold is not proportionate
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-slate-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Cantilever scaffolding <strong>projects outward</strong> from the building face,
                supported by horizontal beams called <strong>needles</strong> that pass through the
                building wall (or window openings), or by cantilever frames attached to the main
                scaffold structure. The projecting platform is supported from below by the needles
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      Over public footpaths or roads where ground-level standards cannot be placed
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      At building overhangs, set-backs, or projections where the scaffold line
                      changes
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>For loading bays that need to project beyond the main scaffold line</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      Where restricted ground access prevents a standard scaffold from being erected
                      at ground level
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Requires specific design:</strong> Cantilever
                      scaffolds are non-standard and must be designed by a competent person for each
                      application
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Needle support:</strong> The inner end of the
                      needle must be adequately counterweighted or anchored to prevent the
                      cantilever from tipping
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Wall strength:</strong> The building wall or
                      structure must be capable of supporting the needle loads without damage or
                      failure
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Load limits:</strong> Cantilever platforms have
                      strict load limits that must be clearly marked and communicated to all users
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  compliance sheets for basic independent scaffolds) and requires a{' '}
                  <strong className="text-white">scaffold-specific design</strong> produced by a
                  competent designer. The design must be available on site, and the scaffold must be
                  erected strictly in accordance with it.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-slate-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                <strong>platforms hung from the roof or structure above</strong> by wire ropes or
                chains. The platform can be raised and lowered to provide access to the building
                facade at any height without requiring a ground-based scaffold structure. It is
                commonly used for building maintenance, window cleaning at height, and work on tall
                structures.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Cradles:</strong> Enclosed or semi-enclosed
                      platforms for one or more workers, suspended from davit arms or outrigger
                      beams on the roof
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Bosun&rsquo;s chairs:</strong> Single-person
                      seats suspended by rope for lightweight inspection or maintenance tasks
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Powered platforms:</strong> Motorised cradles
                      with electric or hydraulic hoists for raising and lowering
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Manual platforms:</strong> Hand-operated hoists
                      &mdash; now less common due to the effort and safety concerns
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-slate-400">LOLER Compliance:</strong> Suspended
                  scaffolding is classified as <strong>lifting equipment</strong> under the Lifting
                  Operations and Lifting Equipment Regulations 1998 (LOLER). This means it requires:{' '}
                  <strong>thorough examination by a competent person every 6 months</strong>{' '}
                  (because it lifts persons), a <strong>written scheme of examination</strong>, and
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Roof anchor points:</strong> Davit arms or
                      outrigger beams must be rated for the intended load and properly secured to
                      the roof structure
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Wire ropes:</strong> Must be inspected before
                      each use for damage, wear, or corrosion &mdash; and replaced at specified
                      intervals
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Secondary safety ropes:</strong> Independent
                      safety lines with fall arresters are required as a backup in case the primary
                      suspension fails
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Personal fall protection:</strong> Workers must
                      wear harnesses clipped to independent anchorage points
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Wind restrictions:</strong> Suspended platforms
                      must not be used in high winds &mdash; the risk of swinging, collision with
                      the building face, and loss of control increases significantly
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <p>
                Suspended scaffolding is particularly common on high-rise buildings where erecting a
                full ground-based scaffold to the entire height would be impractical or uneconomic.
                It is also the standard method for routine facade maintenance and window cleaning on
                commercial buildings with permanently installed davit systems on the roof.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-slate-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Birdcage scaffolding is a <strong>freestanding scaffold structure</strong> that
                provides access to ceilings, soffits, or overhead areas over a{' '}
                <strong>large internal area</strong>. It consists of multiple rows of standards
                arranged in a grid pattern, all supporting a working platform at the top. The name
                comes from its appearance &mdash; a forest of vertical standards resembling the bars
                of a birdcage.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Multiple rows of standards:</strong> Arranged
                      in a grid pattern covering the entire work area below the ceiling
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Single working platform:</strong> The platform
                      is at the top level only, close to the ceiling or soffit being accessed
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Ledgers:</strong> Horizontal tubes connecting
                      standards in both directions at each lift
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Bracing:</strong> Diagonal braces in both
                      directions to prevent racking &mdash; critical for stability in a freestanding
                      structure
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Access:</strong> Internal ladders or stair
                      towers provide access from ground level to the working platform
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      Ceiling work &mdash; plastering, painting, installing suspended ceilings
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      M&amp;E (mechanical and electrical) installation &mdash; cable trays,
                      containment, lighting, HVAC ductwork, fire suppression systems
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      Church and heritage building restoration &mdash; accessing ornate ceilings,
                      stained glass, or roof structures
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      Warehouse and industrial facility maintenance &mdash; accessing high-level
                      services and roof structures
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  Without proper bracing, the entire structure can collapse progressively. The
                  scaffold must also be designed for the specific loads it will carry &mdash;
                  including the weight of workers, tools, and materials on the platform.
                </p>
              </div>

              <p>
                Birdcage scaffolding is particularly useful where the entire ceiling area needs to
                be accessed simultaneously by multiple trades. It provides a large, continuous
                working platform that allows workers to move freely across the full area. However,
                it uses a considerable amount of material and takes up significant floor space,
                which must be planned for in the project programme.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="border-l-2 border-slate-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                <strong>specialist scaffold structures</strong> are used on UK construction sites
                for specific purposes. These are typically built into or onto the main scaffold and
                require dedicated design from a competent person.
              </p>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white/80 space-y-1">
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                      <span>
                        Projecting platforms supported by triangulated truss frames attached to the
                        main scaffold
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                      <span>
                        Used where the scaffold line needs to extend beyond the main structure
                        &mdash; for example, at building set-backs or over obstructions
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                      <span>
                        The truss transfers the load back into the main scaffold rather than through
                        the building wall (unlike cantilever needles)
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white/80 space-y-1">
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                      <span>
                        Reinforced platforms within the scaffold designed for receiving and
                        distributing materials at height
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                      <span>
                        Fitted with loading gates that open inward &mdash; never outward &mdash; to
                    ...
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                      <span>
                        Maximum safe working load (SWL) must be clearly marked and never exceeded
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                      <span>
                        The scaffold beneath a loading bay must be designed to carry the
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white/80 space-y-1">
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                      <span>
                        Angled platforms (typically at 45 degrees) that project outward from the
                        scaffold to catch falling debris
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                      <span>
                        Positioned above public areas, pedestrian routes, or adjacent properties to
                    ...
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                      <span>
                        Typically boarded with scaffold boards or plywood and fitted with a brick
                        guard along the outer edge
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white/80 space-y-1">
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                      <span>
                        Scaffold-supported structures providing weather protection during
                    ...
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                      <span>
                        Sheeted with tarpaulins or purpose-made covers to keep rain, snow, and wind
                        off the work area
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                      <span>
                        Commonly used during roof replacements, heritage restoration, and work where
                    ...
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                      <span>
                        Must be designed for wind loading &mdash; a temporary roof significantly
                        increases the wind load on the scaffold
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white/80 space-y-1">
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                      <span>
                        <strong className="text-white">Offshore:</strong> Scaffolding on oil rigs,
                        wind turbine platforms, and marine structures &mdash; subject to additional
                    ...
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                      <span>
                        <strong className="text-white">Industrial:</strong> Scaffolding in
                        refineries, power stations, and processing plants &mdash; often involving
                        high temperatures, chemical exposure, or confined spaces
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                      <span>
                        <strong className="text-white">Events:</strong> Temporary structures for
                        stages, seating, lighting rigs, and crowd barriers &mdash; subject to
                        specific structural and fire safety requirements
                      </span>
                    </li>
                  </ul>
                </div>
              ...
              <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-slate-400">Common Thread:</strong> All specialist scaffold
                  structures require <strong>specific design by a competent person</strong>. They
                  fall outside the scope of standard scaffold solutions (such as TG20 compliance
                  sheets) and must have a design drawing or specification available on site before
                  erection begins. The erectors must be briefed on the design and must follow it
                  precisely.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
            ...
            <div className="bg-white/5 border border-slate-500/30 rounded-xl overflow-hidden">
              ...
              <div className="px-4 py-4 space-y-3">
                ...
                <ul className="text-[11px] text-white/70 space-y-1">
                  ...
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>Putlog blade sits in brickwork bed joint</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
          ...
          <div className="mt-4 bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
            <p className="text-sm text-white">
              <strong className="text-slate-400">Key Comparison:</strong> Independent scaffolding
              uses approximately <strong>60% more material</strong> than putlog scaffolding for the
              same facade area because it requires a full inner row of standards and transoms.
              However, independent scaffolding is far more versatile &mdash; it works on any
              building type, does not depend on the wall for support, and can be used for all
              trades, not just bricklaying. Putlog scaffolding is limited to masonry work during
              construction.
            </p>
          </div>
        </section>
