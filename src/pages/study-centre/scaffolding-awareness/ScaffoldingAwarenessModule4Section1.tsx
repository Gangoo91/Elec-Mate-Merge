...
const quickCheckQuestions = [
  {
    ...
    question:
      'Under Regulation 12 of the Work at Height Regulations 2005, how frequently must a scaffold that is in continuous use be inspected as a minimum?',
    options: ['Every 24 hours', 'Every 7 days', 'Every 14 days', 'Every 28 days'],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    question:
      'Within what time period must a scaffold inspection report be completed after the inspection has taken place?',
    options: [
...
const faqs = [
  {
    question:
      'Can the scaffold user (e.g. a bricklayer or electrician) carry out the 7-day scaffold inspection, or must it be a scaffolder?',
    answer:
  ...
  {
    question:
      "What constitutes a 'substantial alteration' that triggers an inspection before the scaffold can be used again?",
    answer:
  ...
  {
    question:
      'What wind speed is considered significant enough to trigger a post-event scaffold inspection?',
    answer:
  ...
  {
    question:
      'Is there a specific form that must be used for scaffold inspection reports, or can a company use its own format?',
    answer:
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-slate-500/5 border-l-2 border-slate-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Law:</strong> WAH Regulations 2005, Regulation 12
              </li>
              <li>
                <strong>Before first use:</strong> After erection or substantial alteration
              </li>
              <li>
                <strong>Periodic:</strong> At least every 7 days while in use
              </li>
              <li>
                <strong>After events:</strong> Winds, rain, impact, subsidence
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-slate-500/5 border-l-2 border-slate-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Who inspects:</strong> A competent person (trained + experienced)
              </li>
              <li>
                <strong>Report deadline:</strong> Within 24 hours of inspection
              </li>
              <li>
                <strong>Keep reports:</strong> On site until work complete, then 3 months
              </li>
              <li>
                <strong>Never use:</strong> An uninspected or tagged-out scaffold
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-slate-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The legal requirement to inspect scaffolds before use and at regular intervals is
                set out in
                <strong> Regulation 12</strong> of the{' '}
                <strong>Work at Height Regulations 2005</strong> (SI 2005/735). These regulations
                apply throughout England, Wales, and Scotland and are enforced by the Health and
                Safety Executive (HSE) and local authorities. Regulation 12 specifically addresses
                the <strong>inspection of work equipment</strong> used for work at height, including
                all types of scaffolding &mdash; tube and fitting, system scaffolds, birdcage
                scaffolds, independent tied scaffolds, putlog scaffolds, and mobile tower scaffolds.
              </p>

              <p>
                The purpose of Regulation 12 is to ensure that scaffolds are inspected at critical
                points in their lifecycle so that defects, damage, and deterioration are detected
                before they can lead to a collapse, partial failure, or any other event that could
                endanger the safety of workers or members of the public. Scaffold failures remain
                one of the leading causes of serious injuries and fatalities in the UK construction
                industry. The HSE&rsquo;s analysis of scaffold incidents consistently identifies{' '}
                <strong>failure to inspect</strong> or <strong>inadequate inspection</strong> as
                contributing factors in a significant proportion of scaffold-related accidents.
              </p>

              <p>
                Regulation 12 does not exist in isolation. It operates alongside other important
              ...
              <ul className="space-y-2 text-sm text-white/70">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong>The Health and Safety at Work etc. Act 1974</strong> &mdash; the
                    overarching duty on employers to ensure, so far as is reasonably practicable,
                    the health, safety, and welfare of employees and others affected by work
                    activities
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    ...
                    &mdash; the requirement for suitable and sufficient risk assessment and
                ...
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    ...
                    &mdash; the duty on principal contractors to plan, manage, and monitor
                    construction work, including the management of scaffolding
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                  <span>
                    ...
                    &mdash; the duty to ensure work equipment is maintained in an efficient state,
              ...
              <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-slate-400">Key Legal Point:</strong> Failure to comply
                  with Regulation 12 is a criminal offence. Employers, scaffold contractors, and
                  individuals responsible for scaffold management can be prosecuted by the HSE.
                  Penalties include unlimited fines and, in cases involving serious injury or death,
                  custodial sentences. In 2024, the Sentencing Council guidelines for health and
                  safety offences mean that even medium-sized companies can face fines of hundreds
                  of thousands of pounds for scaffold inspection failures.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-slate-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Regulation 12 of the Work at Height Regulations 2005 establishes{' '}
                <strong>four distinct circumstances</strong> in which a scaffold must be inspected
                by a competent person before it can be used for work. Each trigger serves a specific
                purpose in the scaffold safety lifecycle:
              </p>
              ...
              <div className="bg-slate-500/10 border border-slate-500/30 p-4 sm:p-6 rounded-lg">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <p className="text-sm font-medium text-slate-400">
                    The Four Mandatory Inspection Triggers
                  </p>
                </div>
                <div className="space-y-3">
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      with the design specification, that all components are correctly positioned
                      and secured, that the foundations are adequate, that the working platforms are
                      fully boarded and fitted with guard rails and toe boards, and that the
                      scaffold is safe for its intended use. The scaffold must not be used by any
                      trade until this initial inspection has been completed and the scaffold has
                      been signed off as safe.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    <p className="text-sm font-medium text-white mb-1">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      dismantled and rebuilt in a different configuration &mdash; it must be
                      inspected again before anyone uses it. The alteration may have changed the
                      structural behaviour of the scaffold, introduced new loading patterns, or
                      affected the tie arrangement. A fresh inspection ensures that the altered
                  ...
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      detect progressive deterioration, unauthorised modifications by scaffold
                      users, damage caused by construction activities (loading, impact from
                      materials handling), loosening of couplers through vibration, and changes in
                      ground conditions. The 7-day cycle runs continuously from the date of the
                  ...
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      impact from vehicles or plant, impact from falling objects or materials,
                      subsidence or movement of the ground beneath the scaffold, fire or heat
                      exposure near the scaffold, and any other occurrence that could have
                      compromised the structural integrity. The scaffold must not be used again
                      until the post-event inspection has been completed and the competent person
              ...
              <div className="my-6 p-4 sm:p-6 rounded-xl bg-white/[0.02] border border-slate-500/20">
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    <div className="flex-shrink-0 w-20 text-xs text-slate-400 font-mono pt-0.5">
                      Day 1
                    </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  &ldquo;Do Not Use&rdquo;, access ladders removed or blocked) until a competent
                  person has carried out a full inspection and confirmed the scaffold is safe.
                  Allowing workers to use an uninspected scaffold is a serious breach of the
                  regulations and can result in prosecution.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-slate-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The initial inspection is arguably the most important inspection in the
                scaffold&rsquo;s lifecycle. It takes place{' '}
                <strong>after the scaffold has been fully erected</strong> (or after a substantial
                alteration) and <strong>before any person uses it for work</strong>. The purpose is
                to verify that the scaffold has been built correctly, in accordance with the design,
                and that it is safe for its intended purpose.
              </p>
              ...
              <ul className="space-y-2 text-sm text-white/70">
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                  <span>
                    <strong>Foundations</strong> &mdash; sole boards are in place and of adequate
                    size, base plates are correctly positioned on the sole boards, the ground is
                    firm and level, there is no evidence of subsidence or instability, and any base
                    jacks are within their safe extension range
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                  <span>
                    <strong>Standards (vertical tubes)</strong> &mdash; plumb (within acceptable
                    tolerance), correctly spaced according to the design, correctly joined at
                    couplers, free from visible damage (bends, dents, excessive corrosion), and
                    resting securely on base plates
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                  <span>
                    <strong>Ledgers (horizontal tubes)</strong> &mdash; level, correctly spaced at
                    the specified lift heights, connected to standards with right-angle couplers at
                    the correct torque, and continuous or correctly joined with sleeve couplers
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                  <span>
                    <strong>Transoms and putlogs</strong> &mdash; correctly spaced to support the
                    platform boards without excessive deflection, securely connected with the
                    correct coupler type, and at the correct level relative to the ledgers
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                  <span>
                    <strong>Bracing</strong> &mdash; ledger bracing, plan bracing, and facade
                    bracing installed in accordance with the design, all couplers tight, and the
                    bracing pattern providing adequate rigidity in all directions
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                  <span>
                    <strong>Ties</strong> &mdash; installed at the correct spacing and pattern as
                    specified in the design, each tie tested for effectiveness (push/pull test), tie
                    tubes correctly connected to the scaffold and to the building, and all tie
                    fixings into the building structure are secure and into competent material
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                  <span>
                    <strong>Working platforms</strong> &mdash; fully boarded with no gaps exceeding
                    25 mm, boards in good condition (no splits, excessive warping, or decay), boards
                    secured with board clips, platform width adequate for the intended use (minimum
                    600 mm for access, 800 mm for working), and no tripping hazards
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                  <span>
                    <strong>Guard rails and toe boards</strong> &mdash; top guard rail at minimum
                    950 mm above the working platform, intermediate guard rail fitted to reduce the
                    unprotected gap to no more than 470 mm, toe boards at minimum 150 mm height, and
                    all guard rails and toe boards securely fixed and continuous
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                  <span>
                    <strong>Access</strong> &mdash; safe access and egress provided at each working
                    level (internal ladders, staircase towers, or ladder access bays), ladders
                    secured and extending at least 1 metre above the platform landing, self-closing
                    gates fitted at access points, and ladder traps in position
                  </span>
                </li>
              </ul>
              ...
              <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-slate-400">Handover Procedure:</strong> On most
                  construction sites, the scaffold contractor will carry out the initial inspection
                  as part of the handover process. The scaffolding contractor hands the scaffold
                  over to the principal contractor (or the scaffold user) with a completed
                  inspection report and a scaffolding permit or tag indicating that the scaffold has
                  been inspected and is safe for use. The scaffold tag system (typically green for
                  &ldquo;safe to use&rdquo;, red for &ldquo;do not use&rdquo;, and amber for
                  &ldquo;incomplete / under construction&rdquo;) is the visible, on-scaffold
                  confirmation that the inspection status is current.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-slate-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Regulation 12(4) requires an inspection after{' '}
                <strong>any event likely to have affected the strength or stability</strong> of the
                scaffold. This is one of the most important inspection triggers because it addresses
                unplanned situations that could have compromised the scaffold&rsquo;s structural
                integrity between regular inspections. The range of events that can affect a
                scaffold&rsquo;s stability is broad, and site managers and scaffold users must be
                trained to recognise when an additional inspection is required.
              </p>
              ...
              <div className="bg-slate-500/10 border border-slate-500/30 p-4 sm:p-6 rounded-lg">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <p className="text-sm font-medium text-slate-400">
                    Common Events Triggering Post-Event Inspection
                  </p>
                </div>
                <div className="space-y-3">
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      increases wind loading on the scaffold), bend or buckle bracing members, pull
                      ties out of the building structure, cause the scaffold to sway and fatigue
                      components, and in extreme cases cause partial or total collapse. Industry
                      guidance (TG20, NASC) generally recommends inspections after sustained wind
                      speeds exceeding approximately 30 mph or gusts exceeding approximately 40 mph,
                      though site-specific trigger points should be established in the scaffold
                      management plan.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      undermine the bearing capacity of the foundations. On sloping ground, surface
                      water run-off can cause differential settlement. Flooding can submerge the
                      lower portion of the scaffold, potentially displacing sole boards and base
                      plates entirely. After heavy rain, the competent person should pay particular
                      attention to foundations, sole board condition, ground firmness, and any signs
                      of settlement or tilting.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    <p className="text-sm font-medium text-white mb-1">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      couplers, displace ties, and transfer shock loads through the scaffold
                      structure in ways that are not immediately visible from ground level. Vehicle
                      impact to the lower portion of a scaffold can compromise the load path from
                      the foundations upwards, potentially affecting the stability of the entire
                      structure. Any impact, regardless of how minor it appears, should trigger an
                      inspection.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      table &mdash; can cause differential settlement of the scaffold base. This can
                      lead to the scaffold leaning, standards going out of plumb, couplers being
                      overstressed, and ties being loaded in unintended directions. Excavation work
                      within the zone of influence of the scaffold foundations (typically a
                      45-degree angle from the base of the scaffold) is particularly hazardous and
                      should always trigger an inspection.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      access ladders. Freeze-thaw cycles can affect ground conditions beneath the
                      scaffold, causing heave and subsequent settlement. After any period of snow,
                      ice, or prolonged frost, the scaffold should be inspected with particular
                      attention to loading, platform condition, access routes, and foundation
                      integrity.
                    </p>
                  </div>
                </div>
              ...
              <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-slate-400">Important:</strong> The list above is not
                  exhaustive. The overarching principle is that{' '}
                  <strong>
                    any occurrence that could reasonably be expected to have affected the
                    scaffold&rsquo;s strength or stability
                  </strong>{' '}
                  triggers the requirement for an inspection. If there is any doubt about whether an
                  event requires an inspection, the prudent and legally correct approach is to carry
                  out the inspection. The cost and time of an inspection are negligible compared to
                  the consequences of a scaffold failure.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-slate-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                A <strong>substantial alteration</strong> is any change to the scaffold that could
                affect its structural integrity, stability, or the safety of the persons using it.
                Whenever a scaffold is substantially altered, it must be inspected by a competent
                person before it is used again. This inspection requirement exists because
                alterations change the way the scaffold behaves structurally and may introduce new
                risks that were not present in the original design.
              </p>

              <p>
                The following types of changes are generally considered substantial alterations that
              ...
              <ul className="space-y-2 text-sm text-white/70">
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                  <span>
                    <strong>Adding or removing lifts</strong> &mdash; increasing the height of the
                    scaffold by adding one or more additional lifts (working levels) changes the
                    wind loading, the dead weight, the tie requirements, and the overall stability.
                    Removing lifts (partial dismantling from the top) also constitutes a substantial
                    alteration as it changes the structural configuration
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                  <span>
                    <strong>Adding or removing bays</strong> &mdash; extending the scaffold
                    horizontally or reducing its length changes the number and distribution of
                    foundations, affects the bracing pattern, and alters the tie arrangement
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                  <span>
                    <strong>Changing or removing ties</strong> &mdash; ties are critical to scaffold
                    stability. Any change to the tie arrangement (repositioning, removing, or adding
                    ties) directly affects the scaffold&rsquo;s resistance to overturning, and the
                    inspection must confirm that the revised tie pattern still provides adequate
                    restraint
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                  <span>
                    <strong>Installing loading bays</strong> &mdash; loading bays impose
                    concentrated point loads on the scaffold that may exceed the design loads for
                    the original scaffold. The scaffold structure in the vicinity of the loading bay
                    may need to be strengthened with additional standards, transoms, or bracing
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                  <span>
                    <strong>Installing hoist towers or gin wheels</strong> &mdash; these impose
                    dynamic loading (loads that change rapidly as materials are hoisted) which
                    creates different stresses on the scaffold compared to static loading
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                  <span>
                    <strong>Altering the foundation arrangement</strong> &mdash; changing sole
                    boards, base plates, or adjustable bases, or carrying out groundwork near the
                    scaffold foundations that could affect the bearing capacity or drainage
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                  <span>
                    <strong>Adding sheeting, netting, or cladding</strong> &mdash; enclosing a
                    scaffold with sheeting or cladding dramatically increases the wind loading on
                    the structure. The scaffold design must account for this increased loading, and
                    the tie pattern may need to be revised
                  </span>
                </li>
              </ul>
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  handling, removing guard rails or toe boards to &ldquo;make more room&rdquo;,
                  removing ties because they are &ldquo;in the way&rdquo; of the building work, and
                  adding materials or equipment that overload the platform beyond its design
                  capacity. Unauthorised modifications are extremely dangerous and are a serious
                  breach of the regulations. Any unauthorised modification discovered during an
                  inspection should be immediately rectified, and the scaffold should be taken out
                  of service until it has been restored to its correct configuration and
                  re-inspected.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  tightening a loose coupler, replacing a missing board clip, or replacing a single
                  damaged toe board. However, even for these minor repairs, the work should be
                  carried out by a competent person and a record should be kept. If there is any
                  doubt about whether a change constitutes a substantial alteration, it should be
                  treated as one and an inspection carried out.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-slate-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Regulation 12 requires that scaffold inspections are carried out by a{' '}
                <strong>competent person</strong>. The Work at Height Regulations 2005 define a
                competent person as a person who has{' '}
                <em>
                  &ldquo;such practical and theoretical knowledge and experience of the equipment to
                  be inspected as will enable them to detect defects or weaknesses and to assess
                  their importance in relation to the safety of the equipment.&rdquo;
                </em>
              </p>

              <p>
                This definition is <strong>functional</strong> rather than prescriptive &mdash; it
                focuses on what the person can do (detect and assess defects) rather than mandating
                a specific qualification or job title. However, in practice, meeting this definition
                requires a substantial combination of training, knowledge, and hands-on experience
                with scaffolding.
              </p>
              ...
              <p>
                In practice, the following categories of people are generally considered competent
                to inspect scaffolds, provided they meet the combined requirements of training,
              ...
              <ul className="space-y-2 text-sm text-white/70">
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                  <span>
                    <strong>CISRS Advanced Scaffolders</strong> &mdash; holders of a current CISRS
                    Advanced Scaffolder card have undergone extensive training in scaffold erection,
                    alteration, and dismantling, and inspection is a core part of their training
                    programme. They are widely accepted as competent to carry out scaffold
                    inspections
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                  <span>
                    <strong>CISRS Scaffolders</strong> &mdash; holders of a current CISRS Scaffolder
                    card (as distinct from Advanced Scaffolder) are trained in basic scaffold
                    erection and are generally competent to inspect basic scaffolds within the scope
                    of their training. For complex or non-standard scaffolds, an Advanced Scaffolder
                    or scaffold design engineer may be more appropriate
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                  <span>
                    <strong>SITS card holders</strong> &mdash; non-scaffolders (site managers,
                    supervisors, safety officers) who have completed the CISRS Scaffold Inspection
                    Training Scheme and hold a current SITS card are recognised as competent to
                    inspect scaffolds within the scope of their training
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                  <span>
                    <strong>Scaffold design engineers</strong> &mdash; qualified structural or
                    scaffold design engineers with relevant experience may also be competent to
                    carry out inspections, particularly for complex or non-standard scaffold
                    structures
                  </span>
                </li>
              </ul>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  purposes of Regulation 12, regardless of their job title, seniority, or length of
                  service in construction. A general labourer, an untrained operative, or a manager
                  with no scaffold-specific training should never carry out formal scaffold
                  inspections. Appointing an incompetent person to carry out inspections provides a
                  false sense of security and can itself lead to prosecution if an incident occurs.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-slate-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The <strong>Construction Industry Scaffolders Record Scheme (CISRS)</strong> is the
                UK&rsquo;s industry-recognised training and competence scheme for scaffolders and
                scaffold inspectors. CISRS is managed by the{' '}
                <strong>National Access and Scaffolding Confederation (NASC)</strong>
                and the <strong>Construction Industry Training Board (CITB)</strong>. It provides a
                structured training pathway from trainee scaffolder through to advanced scaffolder,
                and also offers specific inspection training for both scaffolders and
                non-scaffolders.
              </p>
              ...
              <div className="bg-slate-500/10 border border-slate-500/30 p-4 sm:p-6 rounded-lg">
                <div className="flex items-center gap-2 mb-4">
                  <Award className="h-5 w-5 text-slate-400" />
                  <p className="text-sm font-medium text-slate-400">
                    CISRS Inspection Training Pathway
                  </p>
                </div>
                <div className="space-y-3">
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      other construction professionals. The course typically runs over 2 days and
                      covers: the legal framework for scaffold inspection (WAH Regulations 2005, CDM
                      2015), types of scaffold and their components, how to identify common defects
                      and hazards, how to assess whether a scaffold is safe for use, how to complete
                      inspection reports in accordance with Schedule 7, the scaffold tag system, and
                      practical exercises involving the inspection of real scaffolds. Successful
                      completion leads to the issue of a CISRS SITS card, which is valid for 5
                      years.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      (minimum 6 months&rsquo; on-site experience plus assessment), Scaffolder (Part
                      1, typically after 12&ndash;18 months plus further assessment), and Advanced
                      Scaffolder (Part 2, after further experience and a 2-week advanced course plus
                      assessment). At each level, inspection skills are developed and assessed, with
                      the Advanced Scaffolder qualification providing the highest level of
                      inspection competence within the CISRS framework.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    <p className="text-sm font-medium text-white mb-1">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      inspection. Both the CISRS SITS and CITB courses are accepted by principal
                      contractors, the HSE, and the wider construction industry as evidence that the
                      holder has received appropriate scaffold inspection training.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <p>
                ...
                <strong>
                  holding a SITS card or a CISRS scaffolder card alone does not make a person
                  competent
                </strong>
                . The card is evidence of training, which is one of the three pillars of competence.
                The card holder must also have relevant practical experience and up-to-date
                knowledge. A person who completed a SITS course 4 years ago but has not inspected a
                scaffold since is unlikely to be genuinely competent, even though their card may
                still be valid. Competence must be maintained through regular practice and
              ...
              <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  non-scaffolders) or a current CISRS Scaffolder / Advanced Scaffolder card (for
                  scaffolders). Some principal contractors also require inspectors to demonstrate
                  ongoing CPD and to attend refresher training at specified intervals. The scaffold
                  management plan for the site should clearly identify who is responsible for
                  carrying out inspections and what evidence of competence they hold.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-slate-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                A scaffold inspection under Regulation 12 must be carried out{' '}
                <strong>within the working day</strong> &mdash; that is, during normal working hours
                when the scaffold can be properly accessed and examined in adequate light
                conditions. The inspection must be completed before work commences on the scaffold,
                or at the very latest before the end of the working day on which it is due. The
                purpose of this requirement is to ensure that the inspection is thorough, that the
                inspector can physically access all parts of the scaffold, and that any defects can
                be identified and addressed before workers are placed at risk.
              </p>
                ...
                <div className="space-y-3">
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      any changes or damage that occurred overnight (weather, unauthorised access,
                      vandalism) can be detected before workers are exposed to risk; and if defects
                      are found, there is time to rectify them before the working day begins,
                      minimising disruption to the site programme. On sites with multiple scaffolds,
                      the inspection programme should be planned so that all scaffolds are inspected
                      within their 7-day cycle without causing bottlenecks at the start of the day.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    <p className="text-sm font-medium text-white mb-1">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      should be taken out of service (red-tagged) until the inspection is complete.
                      Workers must not be permitted to access the scaffold until the competent
                      person has confirmed it is safe. This may require the competent person to
                      attend site at short notice, and the scaffold management plan should include
                  ...
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      findings into a properly structured report that meets the requirements of
                      Schedule 7. Many inspectors now use digital inspection apps on tablets or
                      smartphones, which allow the report to be completed in real time as the
                      inspection progresses, with photographs attached as evidence. This approach
                      ensures the report is completed immediately and provides a more comprehensive
                      record than a hand-written report completed from memory later in the day.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <p>
                In addition to the formal 7-day inspection required by Regulation 12, many sites
                implement a system of <strong>daily pre-use visual checks</strong>. These are not
                formal inspections under the regulations, but they provide an additional layer of
                protection by detecting obvious defects (missing boards, damaged guard rails,
                displaced ties, overloaded platforms) at the start of each working day. The daily
                check is typically carried out by the scaffold user&rsquo;s supervisor or foreman
                and recorded in a simple checklist format. If the daily check reveals any concerns,
                the scaffold should be taken out of service and a formal inspection carried out by a
                competent person before it is used again.
              </p>
              ...
              <div className="bg-slate-500/10 border border-slate-500/30 p-4 sm:p-6 rounded-lg">
                ...
                <ul className="space-y-2 text-sm text-white/70">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong>Name and address</strong> of the person for whom the inspection was
                      carried out
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong>Location and description</strong> of the workplace or work equipment
                      inspected (sufficient to identify the specific scaffold)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong>Date and time</strong> of the inspection
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong>Details of any matters identified</strong> that could give rise to a
                  ...
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong>Details of any action taken</strong> as a result of the matters
                  ...
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong>Details of any further action considered necessary</strong> &mdash;
                      actions that could not be completed immediately and require follow-up
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong>Name and position</strong> of the person who carried out the
                      inspection
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  person for whom the inspection was carried out for a further period of{' '}
                  <strong>3 months</strong>. In practice, many companies retain inspection reports
                  for much longer than the statutory minimum &mdash; typically for the duration of
                  the project plus several years &mdash; as they may be required as evidence in the
                  event of a future legal claim or investigation.
                </p>
              </div>

              <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-slate-400">Key Takeaway:</strong> Scaffold inspection is
                  not a tick-box exercise. It is a critical safety function that requires a
                  competent person to physically examine the scaffold, identify defects, assess
                  their significance, and take appropriate action. The legal framework &mdash;
                  Regulation 12, Schedule 7, and the competent person definition &mdash; exists to
                  ensure that inspections are carried out properly, at the right times, by the right
                  people, and that the results are formally recorded and retained. Every person who
                  works on or near a scaffold has a right to know that it has been properly
                  inspected and is safe for use.
                </p>
              </div>
            </div>
          </div>
