...
const TITLE = 'Tubes, Couplers & Fittings – Scaffolding Awareness Module 3 Section 1';
const DESCRIPTION =
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Swivel coupler', 'Right-angle coupler', 'Putlog coupler', 'Sleeve coupler'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['30 Nm (22 lbf·ft)', '40 Nm (30 lbf·ft)', '50 Nm (37 lbf·ft)', '60 Nm (44 lbf·ft)'],
    correctAnswer: 2,
    explanation:
...
const faqs = [
  {
    question: 'Why is galvanised finish used on scaffold tubes and couplers?',
    answer:
  ...
  {
    question: 'What is the difference between a girder coupler and a beam coupler?',
    answer:
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <section className="mb-10">
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6 text-xs sm:text-sm text-white">
            <div className="rounded-lg p-3 sm:p-4 bg-slate-500/10 border-l-2 border-l-slate-400/50 border border-slate-500/30">
              <p className="font-semibold text-slate-400 mb-2 text-base">In 30 Seconds</p>
              <ul className="text-base text-white space-y-1.5">
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                  <span>
                    <strong>Steel Tube:</strong> EN 39, 48.3 mm OD, 4 mm wall, galvanised finish.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                  <span>
                    <strong>Aluminium Tube:</strong> Lighter, lower stiffness, never mix with steel.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                  <span>
                    <strong>Couplers:</strong> Right-angle, swivel, putlog, sleeve, band-and-plate,
                    girder, beam.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                  <span>
                    <strong>Standard:</strong> BS EN 74 for couplers, BS EN 39 for tubes.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                  <span>
                    <strong>Torque:</strong> 50 Nm on all coupler bolts — calibrated spanner
                    required.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                  <span>
                    <strong>Defects:</strong> Bent, cracked, corroded, or damaged — reject
                    immediately.
                  </span>
                </li>
              </ul>
            ...
            <div className="rounded-lg p-3 sm:p-4 bg-slate-500/10 border-l-2 border-l-slate-400/50 border border-slate-500/30">
              <p className="font-semibold text-slate-400 mb-2 text-base">On Site</p>
              <ul className="text-base text-white space-y-1.5">
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                  <span>
                    <strong>Spot:</strong> Every tube-and-fitting scaffold on site — independent,
                    putlog, birdcage, and loading bay structures.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                  <span>
                    <strong>Use:</strong> Pre-erection checks, weekly inspections, coupler torque
                    verification, tube and fitting stocktakes.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                  <span>
                    <strong>Apply:</strong> Correct coupler selection for every connection, proper
                    torque, visual inspection before use, reject-and-replace procedure for defective
                    items.
                  </span>
                </li>
              </ul>
        ...
        <section className="mb-10">
          ...
          <ul className="space-y-3 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                Describe the properties and dimensions of standard steel scaffold tube to BS EN 39
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-slate-400 mt-0.5 flex-shrink-0" />
              <span>
                Explain the differences between steel and aluminium scaffold tube and why they must
                not be mixed
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-slate-400 mt-0.5 flex-shrink-0" />
              <span>
                Identify the seven main coupler types and state their correct applications
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-slate-400 mt-0.5 flex-shrink-0" />
              <span>
                State the safe working loads of each coupler type and the required bolt torque
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-slate-400 mt-0.5 flex-shrink-0" />
              <span>
                Carry out a visual inspection of tubes and couplers and identify common defects
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-slate-400 mt-0.5 flex-shrink-0" />
              <span>
                Apply the correct procedure for rejecting defective fittings and removing them from
                service
              </span>
            </li>
          </ul>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-slate-400/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                The standard scaffold tube used across the United Kingdom is manufactured to BS EN
                39. This standard specifies the dimensions, mechanical properties, and surface
                finish of circular steel tubes intended for use in tube-and-fitting scaffolding.
              </p>

              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-white">Key Dimensions & Properties</h3>
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  <ul className="text-white space-y-2 text-sm">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>Outside Diameter (OD):</strong> 48.3 mm — this is the universal
                        dimension that all couplers are designed to grip
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>Wall Thickness:</strong> 4.0 mm nominal (minimum 3.2 mm for Type 4
                        lightweight tube)
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>Weight:</strong> Approximately 4.37 kg per metre for 4 mm wall (3.56
                        kg/m for 3.2 mm wall)
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>Steel Grade:</strong> S235 or S355 (yield strengths of 235 N/mm² and
                        355 N/mm² respectively)
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>Finish:</strong> Hot-dip galvanised to prevent corrosion — zinc
                        coating protects the underlying steel
                      </span>
                    </li>
                  </ul>
                </div>
              ...
              <div className="grid md:grid-cols-2 gap-4 sm:gap-6">
                <div className="space-y-4">
                  <h3 className="text-lg font-semibold text-white">Standard Tube Lengths</h3>
                  <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                    <ul className="text-white space-y-1 text-sm">
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                        <span>
                          <strong>6.4 m (21 ft):</strong> The most common standard length
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                        <span>
                          <strong>4.8 m (16 ft):</strong> Used for shorter spans and standards
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                        <span>
                          <strong>3.9 m (13 ft):</strong> Common for transoms and short ledgers
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                        <span>
                          <strong>3.0 m (10 ft):</strong> Used for braces and short tubes
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                        <span>
                          <strong>2.4 m (8 ft):</strong> For guardrails, short braces, and infill
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                        <span>
                          <strong>Cut tubes:</strong> Various shorter lengths for specific
                          applications
                        </span>
                      </li>
                    </ul>
                ...
                <div className="space-y-4">
                  <h3 className="text-lg font-semibold text-white">Tube Markings</h3>
                  <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                    ...
                    <ul className="text-white space-y-1 text-sm">
                      ...
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                        <span>Standard reference (EN 39 or BS EN 39)</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                        <span>Steel grade (e.g. S235 or S355)</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                      ...
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                        <span>
                          Tubes without legible markings should be treated with caution and verified
                          before use
                        </span>
                      </li>
                    </ul>
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-white">Aluminium Scaffold Tube</h3>
                <div className="bg-white/5 border border-slate-400/30 p-4 rounded-lg">
                  <p className="text-white text-sm mb-3">
                    Aluminium tubes are available for lightweight applications and where reduced
                    weight is beneficial — for example, in confined spaces, on fragile roofs (with
                    spreader boards), or where manual handling limits are a concern. They share the
                  ...
                  <ul className="text-white space-y-2 text-sm">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>Weight:</strong> Approximately one-third the weight of steel (about
                        1.68 kg/m)
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>Stiffness:</strong> Young's modulus is approximately one-third that
                        of steel — aluminium tubes deflect more under the same load
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>Strength:</strong> Lower yield strength than steel — design spans
                        and loadings must be recalculated
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>Corrosion:</strong> Naturally forms a protective oxide layer, but
                        galvanic corrosion occurs at steel–aluminium contact points
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-red-500/20 border border-red-400/50 p-4 rounded-lg">
                  ...
                  <ul className="text-white space-y-2 text-sm">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        Steel and aluminium tubes must never be used in the same scaffold structure
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        Different stiffness values create unpredictable load distribution between
                        members
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        Galvanic corrosion accelerates at contact points between dissimilar metals
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        Different thermal expansion rates cause joint loosening in temperature
                        changes
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        If aluminium is specified, the entire scaffold must be designed as an
                        aluminium structure
                      </span>
                    </li>
                  </ul>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-slate-400/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                Every tube must be visually inspected before it is incorporated into a scaffold.
                Defective tubes compromise the structural integrity of the entire structure. A
                single bent standard can reduce the load capacity of a scaffold bay by more than
                50%.
              </p>
                    ...
                    <div className="space-y-2">
                      <div className="flex items-start gap-3 bg-white/5 p-3 rounded-lg border border-white/10">
                        ...
                        <div className="text-sm">
                          <strong>Straightness:</strong> Sight along the tube from one end — any
                          visible bend, bow, or kink means reject
                        </div>
                      </div>
                      <div className="flex items-start gap-3 bg-white/5 p-3 rounded-lg border border-white/10">
                        <div className="w-6 h-6 rounded-full bg-red-500/20 border border-red-400/40 flex items-center justify-center flex-shrink-0 text-red-300 text-xs font-bold">
                        ...
                        <div className="text-sm">
                          <strong>Corrosion:</strong> Check for rust, deep pitting, or areas where
                          galvanising has worn through exposing bare steel
                        </div>
                      </div>
                      <div className="flex items-start gap-3 bg-white/5 p-3 rounded-lg border border-white/10">
                        <div className="w-6 h-6 rounded-full bg-red-500/20 border border-red-400/40 flex items-center justify-center flex-shrink-0 text-red-300 text-xs font-bold">
                        ...
                        <div className="text-sm">
                          <strong>Dents & Crushing:</strong> Run your hand along the tube — feel for
                          dents, flat spots, or crushing that reduce the cross-section
                        </div>
                      </div>
                      <div className="flex items-start gap-3 bg-white/5 p-3 rounded-lg border border-white/10">
                        <div className="w-6 h-6 rounded-full bg-red-500/20 border border-red-400/40 flex items-center justify-center flex-shrink-0 text-red-300 text-xs font-bold">
                        ...
                        <div className="text-sm">
                          <strong>Cracks:</strong> Inspect tube ends and any area that has been
                          subjected to impact for visible cracks
                        </div>
                      </div>
                    </div>
                  </div>
                  <div className="space-y-3">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-start gap-3 bg-white/5 p-3 rounded-lg border border-white/10">
                        ...
                        <div className="text-sm">
                          <strong>Ends:</strong> Tube ends must not be split, burred, or mushroomed
                          from hammering — they must seat properly in couplers
                        </div>
                      </div>
                      <div className="flex items-start gap-3 bg-white/5 p-3 rounded-lg border border-white/10">
                        <div className="w-6 h-6 rounded-full bg-red-500/20 border border-red-400/40 flex items-center justify-center flex-shrink-0 text-red-300 text-xs font-bold">
                        ...
                        <div className="text-sm">
                          <strong>Markings:</strong> Confirm the tube carries legible EN 39 markings
                          and the correct steel grade
                        </div>
                      </div>
                      <div className="flex items-start gap-3 bg-white/5 p-3 rounded-lg border border-white/10">
                        <div className="w-6 h-6 rounded-full bg-red-500/20 border border-red-400/40 flex items-center justify-center flex-shrink-0 text-red-300 text-xs font-bold">
                        ...
                        <div className="text-sm">
                          <strong>Foreign Matter:</strong> Check for concrete, paint, or debris that
                          could prevent the coupler from seating correctly
                        </div>
                      </div>
                      <div className="flex items-start gap-3 bg-white/5 p-3 rounded-lg border border-white/10">
                        <div className="w-6 h-6 rounded-full bg-red-500/20 border border-red-400/40 flex items-center justify-center flex-shrink-0 text-red-300 text-xs font-bold">
                        ...
                        <div className="text-sm">
                          <strong>Wall Thickness:</strong> If corrosion is suspected to have reduced
                          wall thickness, the tube should be ultrasonically tested or rejected
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="bg-red-500/20 border border-red-400/50 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-2 text-sm">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong>Visible bend or bow:</strong> Any tube that is not straight when
                      sighted from the end must be rejected
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong>Deep corrosion or pitting:</strong> Surface rust alone may be
                      acceptable, but any pitting that has reduced the wall thickness is cause for
                      rejection
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong>Dents greater than 10% of the tube diameter:</strong> Any dent that
                      visibly deforms the circular cross-section
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong>Cracks or splits:</strong> Any visible crack, particularly at tube
                      ends or weld lines
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong>Mushroomed or burred ends:</strong> Prevent proper coupler seating and
                      indicate impact damage
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong>No identification markings:</strong> Tubes of unknown origin or grade
                      must not be used
                    </span>
                  </li>
                </ul>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-slate-400/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                Couplers are the components that connect scaffold tubes to one another. The correct
                coupler must be used for every connection — using the wrong type compromises the
                structural integrity of the scaffold and can lead to collapse. All couplers used in
                the UK must comply with BS EN 74.
              </p>
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                  ...
                  <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                    ...
                    <ul className="text-xs space-y-1 text-white">
                      ...
                      <li className="flex items-start gap-1.5">
                        <span className="mt-1 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                        <span>Use: Ledger-to-standard, transom-to-ledger</span>
                      </li>
                      <li className="flex items-start gap-1.5">
                        <span className="mt-1 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                  ...
                  <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                    ...
                    <ul className="text-xs space-y-1 text-white">
                      ...
                      <li className="flex items-start gap-1.5">
                        <span className="mt-1 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                        <span>Use: Putlog scaffolds, board bearers</span>
                      </li>
                      <li className="flex items-start gap-1.5">
                        <span className="mt-1 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                  ...
                  <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                    ...
                    <ul className="text-xs space-y-1 text-white">
                      ...
                      <li className="flex items-start gap-1.5">
                        <span className="mt-1 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                        <span>Use: Extending standards and ledgers</span>
                      </li>
                      <li className="flex items-start gap-1.5">
                        <span className="mt-1 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                  ...
                  <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                    ...
                    <ul className="text-xs space-y-1 text-white">
                      ...
                      <li className="flex items-start gap-1.5">
                        <span className="mt-1 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                        <span>Use: Fixing scaffold to structural steel, sign boards</span>
                      </li>
                      <li className="flex items-start gap-1.5">
                        <span className="mt-1 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                  ...
                  <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                    ...
                    <ul className="text-xs space-y-1 text-white">
                      ...
                      <li className="flex items-start gap-1.5">
                        <span className="mt-1 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                        <span>Use: Tying scaffold to structural steelwork</span>
                      </li>
                      <li className="flex items-start gap-1.5">
                        <span className="mt-1 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                    ...
                    <div className="grid sm:grid-cols-2 gap-3">
                      <ul className="text-xs space-y-1 text-white">
                        <li className="flex items-start gap-1.5">
                          <span className="mt-1 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                          <span>
                            Similar to girder coupler but designed for specific beam profiles or
                            loading directions
                          </span>
                        </li>
                        <li className="flex items-start gap-1.5">
                      ...
                      <ul className="text-xs space-y-1 text-white">
                        <li className="flex items-start gap-1.5">
                          <span className="mt-1 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                          <span>
                            Use: Suspension scaffolds, loading bays supported from beams, temporary
                            works tied to steel frames
                          </span>
                        </li>
                        <li className="flex items-start gap-1.5">
                          <span className="mt-1 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                          <span>
                            Must match the beam flange thickness — using the wrong size causes
                            slippage
                          </span>
                        </li>
                      </ul>
              ...
              {/* SWL Summary Table */}
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <h3 className="font-semibold mb-3 text-slate-400">Safe Working Loads — Summary</h3>
                <div className="overflow-x-auto -mx-2 px-2">
                  <div className="space-y-2 text-sm min-w-0">
                    <div className="flex justify-between items-center py-2 border-b border-white/10">
                      <span className="text-white font-medium">Right-Angle Coupler</span>
                      <span className="text-slate-400 font-semibold">6.25 kN (~635 kg)</span>
                    </div>
                    <div className="flex justify-between items-center py-2 border-b border-white/10">
                      <span className="text-white font-medium">Swivel Coupler</span>
                      <span className="text-slate-400 font-semibold">6.25 kN (~635 kg)</span>
                    </div>
                    <div className="flex justify-between items-center py-2 border-b border-white/10">
                      <span className="text-white font-medium">Sleeve Coupler</span>
                      <span className="text-slate-400 font-semibold">6.25 kN (~635 kg)</span>
                    </div>
                    <div className="flex justify-between items-center py-2 border-b border-white/10">
                      <span className="text-white font-medium">Putlog Coupler</span>
                      <span className="text-slate-400 font-semibold">0.56 kN (~57 kg)</span>
                    </div>
                    <div className="flex justify-between items-center py-2 border-b border-white/10">
                      <span className="text-white font-medium">Band-and-Plate Coupler</span>
                      <span className="text-slate-400 font-semibold">Varies by design</span>
                    </div>
                    <div className="flex justify-between items-center py-2 border-b border-white/10">
                      <span className="text-white font-medium">Girder Coupler</span>
                      <span className="text-slate-400 font-semibold">Varies by flange</span>
                    </div>
                    <div className="flex justify-between items-center py-2">
                      <span className="text-white font-medium">Beam Coupler</span>
                      <span className="text-slate-400 font-semibold">Varies by design</span>
                    </div>
                  </div>
                </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-slate-400/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                BS EN 74 is the European standard that specifies the requirements for couplers,
                loose spigots, and base plates used in working scaffolds and falsework made of
                circular steel tubes. It covers design, materials, manufacturing, testing, and
                marking. Every coupler on a UK scaffold must comply with this standard.
              </p>

              <div className="grid md:grid-cols-2 gap-4 sm:gap-6">
                <div className="space-y-4">
                  <h3 className="text-lg font-semibold text-white">What BS EN 74 Requires</h3>
                  <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                    <ul className="text-white space-y-2 text-sm">
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                        <span>
                          <strong>Material:</strong> Couplers must be manufactured from ductile
                          iron, pressed steel, or forged steel to specified grades
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                        <span>
                          <strong>Testing:</strong> Type-tested for slip load, ultimate load, and
                      ...
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                        <span>
                          <strong>Marking:</strong> Each coupler must be permanently marked with the
                          manufacturer's name, standard reference, and class
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                        <span>
                          <strong>Finish:</strong> Must be protected against corrosion — typically
                      ...
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                        <span>
                          <strong>Bolt Thread:</strong> Must not strip or fail before the coupler
                          reaches its rated slip load
                        </span>
                      </li>
                    </ul>
                  </div>
                ...
                <div className="space-y-4">
                  <h3 className="text-lg font-semibold text-white">Coupler Classes</h3>
                  <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                    <ul className="text-white space-y-2 text-sm">
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                        <span>
                          <strong>Class A:</strong> Highest performance — suitable for all scaffold
                          designs. Minimum slip load of 6.25 kN for right-angle and swivel couplers
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                        <span>
                          <strong>Class B:</strong> Lower performance — suitable only where the
                          scaffold design specifically permits Class B couplers
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                        <span>
                          <strong>TG20 Compliance:</strong> TG20 designs assume Class A couplers
                          throughout — never substitute Class B unless the design explicitly states
                          otherwise
                        </span>
                      </li>
                    </ul>
              ...
              <div className="bg-slate-500/10 border border-slate-400/30 p-4 rounded-lg">
                <h3 className="font-semibold mb-3 text-slate-400">Torque Requirements</h3>
                <div className="space-y-3 text-sm">
                  <div className="bg-[#1a1a1a] border border-white/10 p-3 rounded font-mono text-sm text-slate-400">
                    Required torque: 50 Nm (37 lbf·ft) — every coupler, every bolt, every time
                  </div>
                  <ul className="text-white space-y-2">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>Under-torqued couplers</strong> have reduced friction grip and lower
                        safe working loads — the coupler may slip under design load
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>Over-torqued couplers</strong> risk stripped threads, cracked
                        castings, distorted tubes, and premature bolt failure
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>Calibrated torque spanner</strong> must be used — hand-tightening or
                        using a standard ratchet does not achieve consistent, measurable torque
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>Torque checks during inspections:</strong> Use a torque spanner set
                        to 50 Nm and apply to a sample of couplers — if any are loose, check the
                        full scaffold
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>Spanner calibration:</strong> Torque spanners must be calibrated
                        regularly (typically annually) and the calibration certificate kept on
                        record
                      </span>
                    </li>
                  </ul>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                Coupler inspection is as critical as tube inspection. A defective coupler can fail
                without warning, releasing the tube it holds and potentially causing a progressive
                collapse. Every coupler must be inspected before use and during every scaffold
                inspection thereafter.
              </p>

              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-white">Coupler Inspection Points</h3>
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  <ul className="text-white space-y-2 text-sm">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>Casting Integrity:</strong> Check the body for cracks, chips, or
                        fractures — particularly around the bolt hole and where the two halves meet
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>Bolt & Nut:</strong> Ensure the T-bolt is straight, the thread is
                        clean and undamaged, and the nut runs freely along the full thread length
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>Hinge Pin:</strong> On hinged couplers (e.g. right-angle), verify
                        the pin is secure and the hinge operates smoothly without excessive play
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>Jaw Faces:</strong> The internal faces that grip the tube must not
                        be worn smooth — the serrations or knurling pattern provides friction grip
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>Corrosion:</strong> Light surface rust is acceptable, but deep
                        corrosion that has reduced wall thickness or weakened the casting must be
                        rejected
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>Markings:</strong> Confirm the coupler carries its BS EN 74 marking,
                        class designation, and manufacturer's identification
                      </span>
                    </li>
                  </ul>
                </div>
              ...
              <div className="grid md:grid-cols-2 gap-4 sm:gap-6">
                <div className="space-y-4">
                  ...
                  <div className="bg-white/5 border border-red-400/30 p-4 rounded-lg">
                    <ul className="text-white space-y-2 text-sm">
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                        <span>Cracked or fractured casting — anywhere on the body</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                        <span>Bent, cross-threaded, or damaged T-bolt</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                        <span>Nut does not run freely on the bolt thread</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                        <span>Worn or smooth jaw faces (reduced grip)</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                        <span>Excessive corrosion reducing wall thickness of casting</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                        <span>Hinge pin loose, missing, or seized</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                        <span>Missing or illegible BS EN 74 markings</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                        <span>Coupler does not close fully around the tube</span>
                      </li>
                    </ul>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <h3 className="text-lg font-semibold text-white">Rejection Procedure</h3>
                  <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                    <ol className="space-y-3 text-sm">
                      <li className="flex items-start gap-3">
                        ...
                        <div>
                          <strong>Remove</strong> the defective fitting from the scaffold
                          immediately
                        </div>
                      </li>
                      <li className="flex items-start gap-3">
                        ...
                        <div>
                          <strong>Tag</strong> or mark the fitting clearly as "DEFECTIVE — DO NOT
                          USE"
                        </div>
                      </li>
                      <li className="flex items-start gap-3">
                        ...
                        <div>
                          <strong>Segregate</strong> the fitting in a designated quarantine area or
                          container — separate from serviceable stock
                        </div>
                      </li>
                      <li className="flex items-start gap-3">
                        <div className="w-6 h-6 rounded-full bg-slate-500/20 border border-slate-400/40 flex items-center justify-center flex-shrink-0 text-slate-400 text-xs font-bold">
                        ...
                        <div>
                          <strong>Replace</strong> immediately with a serviceable fitting of the
                      ...
                      <li className="flex items-start gap-3">
                        ...
                        <div>
                          <strong>Record</strong> the defect in the scaffold inspection register,
                          noting the type, location, and nature of the defect
                        </div>
                      </li>
                      <li className="flex items-start gap-3">
                        <div className="w-6 h-6 rounded-full bg-slate-500/20 border border-slate-400/40 flex items-center justify-center flex-shrink-0 text-slate-400 text-xs font-bold">
                        ...
                        <div>
                          <strong>Report</strong> to the scaffold supervisor or site manager —
                          multiple defective fittings may indicate a batch problem or inadequate
                          storage
                        </div>
                      </li>
                    </ol>
              ...
              <div className="bg-red-500/20 border border-red-400/50 p-4 rounded-lg">
                ...
                <p className="text-white text-sm mb-2">
                  Couplers are safety-critical components that have been type-tested as complete
                  units. Site repairs — such as welding cracked castings, replacing bolts with
                  non-standard fixings, or bending casting halves back into shape — are strictly
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4 text-white">
            <p>
              Correct storage of tubes and fittings extends their service life, prevents damage, and
              makes inspection easier. A well-organised scaffold yard is a safer scaffold yard.
            </p>

            <div className="grid md:grid-cols-2 gap-4 sm:gap-6">
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-white">Tube Storage</h3>
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  <ul className="text-white space-y-2 text-sm">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        Store tubes horizontally on level timber bearers — never directly on the
                        ground
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        Support at regular intervals to prevent sagging and permanent bowing
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        Separate by length — store different lengths in designated racks or bays
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        Keep steel and aluminium tubes in separate areas, clearly labelled
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        Defective or rejected tubes must be stored in a segregated quarantine area
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        Stack heights should allow safe manual handling — avoid climbing on tube
                        stacks
                      </span>
                    </li>
                  </ul>
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-white">Coupler Storage</h3>
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  <ul className="text-white space-y-2 text-sm">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>Store couplers in dedicated containers or bins, separated by type</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        Protect from moisture — cover bins or store under shelter to minimise
                        corrosion
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        Keep bolts and nuts engaged (finger-tight) to prevent loss and
                        cross-contamination
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        Apply light oil to bolt threads if couplers will be stored for extended
                        periods
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        Defective couplers must be stored in a separate, clearly marked quarantine
                        container
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        Never dump couplers loose — this damages castings, bends bolts, and makes
            ...
            <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
              <h3 className="font-semibold mb-3 text-slate-400">On-Site Quick Reference</h3>
                ...
                <div>
                  ...
                  <ul className="space-y-1 text-white">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Wall:</strong> 4.0 mm standard
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Weight:</strong> ~4.37 kg/m (steel)
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Standard:</strong> BS EN 39
                      </span>
                    </li>
                  </ul>
                </div>
                <div>
                  ...
                  <ul className="space-y-1 text-white">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Standard:</strong> BS EN 74
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Torque:</strong> 50 Nm (37 lbf·ft)
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong className="text-white">RA/SW/SL SWL:</strong> 6.25 kN
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Putlog SWL:</strong> 0.56 kN
                      </span>
                    </li>
                  </ul>
                </div>
        ...
        {/* Quiz Section */}
        <div className="mt-12">
          <Quiz title="Tubes, Couplers & Fittings Quiz" questions={quizQuestions} />
        </div>
