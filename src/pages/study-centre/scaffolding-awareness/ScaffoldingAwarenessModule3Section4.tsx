...
const TITLE =
  'Bracing, Ties & Stability – Scaffold Components & Assembly (Scaffolding Awareness Module 3 Section 4)';
const DESCRIPTION =
...
const faqs = [
  {
    question: 'What is the difference between a box tie and a through tie?',
    answer:
  ...
  {
    question: 'How are scaffold ties tested and what is the minimum load?',
    answer:
  ...
  {
    question: 'Why is bracing so important if the scaffold already has ties?',
    answer:
  ...
  {
    question: 'Can I use reveal ties instead of box ties?',
    answer:
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
          ...
          <div className="p-4 rounded-lg bg-slate-500/5 border-l-2 border-slate-400/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li className="flex items-start gap-2">
                ...
                <span>
                  <strong>Bracing:</strong> Triangulates the scaffold to prevent racking
                  (parallelogram collapse)
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                <span>
                  <strong>Ties:</strong> Anchor the scaffold to the building — push and pull
                  restraint
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                <span>
                  <strong>Pattern:</strong> Every other standard at every other lift (general rule)
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                <span>
                  <strong>Testing:</strong> Minimum 6.25 kN proof-load for tube and fitting ties
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                <span>
                  <strong>Sheeting:</strong> Massively increases wind load — closer ties needed
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                <span>
                  <strong>Buttresses:</strong> Used when ties to the building are not possible
                </span>
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-slate-500/5 border-l-2 border-slate-400/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                <span>
                  <strong>Spot:</strong> Diagonal tubes across the scaffold face (ledger bracing)
                  and between inner/outer rows (plan bracing)
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                <span>
                  <strong>Identify:</strong> Tie tubes running from the scaffold into the building
              ...
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                <span>
                  <strong>Never:</strong> Remove a tie or brace without authorisation from the
                  scaffold supervisor
                </span>
              </li>
            </ul>
            ...
            <div className="bg-red-500/20 border border-red-400/50 p-4 rounded-lg">
              ...
              <ul className="text-white space-y-2 text-sm">
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                  <span>
                    <strong>Progressive failure:</strong> Racking starts slowly but accelerates — by
                    the time anyone notices, collapse is imminent
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                  <span>
                    <strong>Wind is the main cause:</strong> Even moderate wind applies sustained
                    lateral force across the full height of the scaffold
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                  <span>
                    <strong>Loading matters:</strong> A loaded scaffold with materials on the
                    platforms is heavier and generates greater racking force
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                  <span>
                    <strong>Missing braces:</strong> Removing even one brace can create a weak point
                    that allows the entire scaffold to rack
                  </span>
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-slate-400/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                There are three principal types of bracing used in tube and fitting scaffolds. Each
                resists forces in a different plane and all three may be needed on a given scaffold
                depending on its height, loading, and exposure.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-2 text-sm">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong>Position:</strong> Runs diagonally across the face of the scaffold
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong>Connection:</strong> Connects a standard at one lift to the next
                      standard at the lift above (or below)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong>Resists:</strong> Lateral movement along the length of the scaffold
                      (prevents the face from racking)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong>Pattern:</strong> Continuous zigzag across the face, typically in
                      every other bay or as the design requires
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong>Coupler:</strong> Fixed with swivel couplers to the standards at each
                      end
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-2 text-sm">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong>Position:</strong> Runs diagonally in the horizontal plane (the plan
                      view), between inner and outer standards
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong>Connection:</strong> Connects the inner standard of one bay to the
                      outer standard of the next bay at the same lift level
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong>Resists:</strong> Twisting and lateral forces acting across the width
                      of the scaffold
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong>Where needed:</strong> At the top and bottom of the scaffold as a
                      minimum, and at intermediate levels on taller scaffolds
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong>Note:</strong> Plan bracing is installed at ledger level and can
                      obstruct the working platform, so its placement must be coordinated with
                      access requirements
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-2 text-sm">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong>Zigzag pattern:</strong> The most common — a continuous diagonal that
                      reverses direction at each lift, creating a zigzag across the full height of
                      each braced bay
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong>Cross bracing (X-bracing):</strong> Two diagonals crossing in the same
                      bay — provides the strongest resistance but uses more tube and can obstruct
                      access
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong>N-bracing:</strong> A single diagonal per bay in the same direction —
                      weaker than zigzag but used where obstructions prevent alternating diagonals
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong>Full-face coverage:</strong> Bracing must be continuous from the base
                      to the top of the scaffold without gaps — a missing section creates a hinge
                      point
                    </span>
                  </li>
                </ul>
          ...
          <div className="border-l-2 border-slate-400/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                ...
                against the building) and <strong>pull restraint</strong> (preventing it from
                pulling away). Different tie types achieve this in different ways.
              </p>
              ...
              <div className="grid md:grid-cols-2 gap-4 sm:gap-6">
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-white space-y-2 text-sm">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>How it works:</strong> A short cross tube is placed inside a window
                        or door opening, bearing against the inner faces of both reveals
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>Connection:</strong> A tie tube connects the cross tube back to the
                        nearest scaffold standard or ledger using right-angle couplers
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>Restraint:</strong> Provides both push and pull restraint — the
                        cross tube prevents the scaffold moving in either direction
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>Advantage:</strong> No penetration of the building fabric required
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>Limitation:</strong> Requires a suitable opening (window, door) with
                        adequate reveals
                      </span>
                    </li>
                  </ul>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-white space-y-2 text-sm">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>How it works:</strong> A reveal pin or screw jack is extended
                        between the internal faces of a window reveal, gripping by friction
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>Connection:</strong> A tie tube runs from the reveal pin back to the
                        scaffold standard
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>Restraint:</strong> Primarily pull restraint only — a separate
                        arrangement is often needed for push restraint
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>Advantage:</strong> Quick to install, no drilling required
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>Limitation:</strong> Only as strong as the reveal material — can
                        fail if mortar is weak or the reveal crumbles
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-white space-y-2 text-sm">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>How it works:</strong> A bolt, tube, or anchor passes completely
                        through the wall and is secured on the internal face with a plate, washer,
                        and nut
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>Connection:</strong> The external end connects to the scaffold via a
                        tie tube and right-angle coupler
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>Restraint:</strong> Provides very strong push and pull restraint —
                        the most reliable tie type
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>Advantage:</strong> Strongest tie type with predictable load
                        capacity
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>Limitation:</strong> Requires drilling through the wall, which may
                        not be acceptable on heritage or finished buildings
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  <h3 className="font-semibold mb-3 text-slate-300">
                    Reveal Ties (Cast-In / Anchor Bolt)
                  </h3>
                  <ul className="text-white space-y-2 text-sm">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>How it works:</strong> A chemical or mechanical anchor bolt is
                        drilled into the facade and a ring bolt or eye bolt is fixed flush to the
                        wall
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>Connection:</strong> A tie tube or wire connects the anchor point to
                        the scaffold standard
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>Restraint:</strong> Provides pull restraint; a separate packing tube
                        against the wall provides push restraint
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>Advantage:</strong> Can be positioned exactly where needed — not
                        dependent on openings
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>Limitation:</strong> Requires drilling into the facade and the
                        anchor must be tested to confirm pull-out resistance in the specific
                        substrate
                      </span>
                    </li>
                  </ul>
            ...
            <div className="space-y-4 text-white">
              ...
              <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white mb-3">
                  ...
                  so that no two ties are directly above each other.
                </p>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-4 sm:gap-6">
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  <h3 className="font-semibold mb-2 text-slate-300">
                    When Closer Spacing Is Required
                  </h3>
                  <ul className="text-white space-y-2 text-sm">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>Sheeted or netted scaffolds:</strong> Every standard at every lift
                        (or as designed)
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>Loaded scaffolds:</strong> Heavy-duty scaffolds carrying materials
                        or masonry
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>Tall scaffolds:</strong> Greater height means greater wind force at
                        the top
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>Exposed locations:</strong> Coastal sites, hilltop sites, or open
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>Cantilever scaffolds:</strong> Where the scaffold extends beyond the
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-white space-y-2 text-sm">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>First tie:</strong> Must be positioned as close to the base as
                        practicable — typically at lift 2
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>Top tie:</strong> The top lift must always have ties — the top of a
                        scaffold experiences the greatest wind force
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>Return ties:</strong> At each end of the scaffold and at any change
                        of direction
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>Never remove:</strong> Ties must not be removed without
                        authorisation and an alternative restraint being provided
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>Marked:</strong> Tie positions should be clearly marked on the
                        scaffold design drawing
                      </span>
                    </li>
                  </ul>
                </div>
            ...
            <div className="space-y-4 text-white">
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-2 text-sm">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong>Minimum load:</strong> 6.25 kN (approximately 625 kg) for tube and
                      fitting scaffolds — this is the TG20 standard
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong>Testing equipment:</strong> A calibrated scaffold tie tester
                      (pull-test device) is attached to the tie tube
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong>Method:</strong> A controlled pulling force is applied gradually and
                      increased to the proof-load value
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong>Pass criteria:</strong> The tie must resist the full proof-load
                      without any movement, slip, or failure at the anchor point
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong>Fail action:</strong> If a tie fails the test, it must be repositioned
                      or an alternative anchor method used
                    </span>
                  </li>
                </ul>
              </div>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-white space-y-2 text-sm">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>At installation:</strong> Every tie should be tested when first
                        fixed
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>After disturbance:</strong> If building work near the tie has
                        disturbed the anchor (e.g. pointing, rendering, demolition)
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>After weather events:</strong> Storms or sustained high winds may
                        have stressed the ties
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>Periodic checks:</strong> As part of the regular scaffold inspection
                        regime
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>Doubt:</strong> Whenever there is any reason to question the
                        integrity of a tie
                      </span>
                    </li>
                  </ul>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-white space-y-2 text-sm">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>Dense concrete:</strong> Generally provides the strongest anchor —
                        chemical or expansion bolts can achieve high pull-out values
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>Engineering brickwork:</strong> Strong substrate — test to confirm,
                        as mortar quality varies
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>Common brickwork:</strong> Variable — older lime mortar joints can
                        be very weak
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>Blockwork:</strong> Hollow blocks are unreliable — anchors may pull
                        through
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>Cladding / render:</strong> Never anchor to cladding panels or
                        render alone — always fix into the structural substrate beneath
                      </span>
                    </li>
                  </ul>
                </div>
              ...
              <div className="bg-red-500/20 border border-red-400/50 p-4 rounded-lg">
                ...
                <p className="text-white text-sm">
                  An untested tie is an unknown quantity. It may hold 10 kN or it may fail at 1 kN.
                  Many scaffold collapses have been traced back to ties that looked correct but were
                  anchored into weak mortar, hollow blockwork, or deteriorated concrete. Testing is
                  the only way to confirm a tie will perform when it matters. On a sheeted scaffold
                  in a storm, every single tie is under serious load — and one failure can cascade
                  into total collapse.
                </p>
              </div>
            </div>
          ...
          <div className="border-l-2 border-slate-400/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                ...
                sheeting, debris netting, or brick guards are added, the scaffold becomes a giant
                sail. The increase in wind loading is dramatic and must be accounted for in the
                scaffold design.
              </p>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-white space-y-2 text-sm">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>Polythene sheeting:</strong> Highest wind load — virtually solid
                        surface, no air passes through
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>Monarflex / shrink-wrap:</strong> Similar to polythene — creates a
                        sealed face
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>Debris netting (fine mesh):</strong> High wind load — most of the
                        wind is caught by the mesh
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>Debris netting (coarse mesh):</strong> Moderate wind load — some air
                        passes through but significant force remains
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>Brick guards:</strong> Lower wind load individually but cumulatively
                        significant across a large scaffold
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-white space-y-2 text-sm">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>More ties:</strong> Tie spacing is typically halved — from every
                        other standard to every standard
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>Stronger ties:</strong> Higher proof-load requirements may apply
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>Additional bracing:</strong> Extra ledger bracing and plan bracing
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>Foundation loading:</strong> The overturning force on the base
                        increases — sole boards and base plates must be adequate
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>Wind action plan:</strong> A specific plan for high-wind events —
                        who removes the sheeting and when
                      </span>
                    </li>
                  </ul>
                </div>
              ...
              <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white mb-3">
                  ...
                  solidity ratio approaching 1.0. This means the wind force on a sheeted scaffold
                  can be <strong>three to five times</strong> greater than on the same scaffold
                  without sheeting.
                </p>
            ...
            <div className="space-y-4 text-white">
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-2 text-sm">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong>Raker tubes:</strong> Angled tubes running from the top of the
                      scaffold (or high-level ledger) down to a sole board or concrete base at
                      ground level
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong>Angle:</strong> Typically at 45 degrees to the ground — steeper angles
                      reduce the effectiveness of the raker
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong>Base fixing:</strong> The foot of the raker must be secured against a
                      fixed point (e.g. a kentledge block, ground anchor, or substantial base plate
                      on a sole board)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong>Top connection:</strong> Fixed to the scaffold standard or ledger with
                      right-angle or swivel couplers
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong>Bracing:</strong> The raker frame itself must be braced to prevent it
                      from buckling or racking
                    </span>
                  </li>
                </ul>
              </div>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-white space-y-2 text-sm">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>New-build steel frame:</strong> Before cladding is installed, there
                        is nothing to tie to
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>Heritage buildings:</strong> Drilling or fixing to the facade is
                        prohibited
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>Freestanding scaffolds:</strong> No adjacent building exists (e.g.
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>Weak facade:</strong> The building fabric is too weak to accept ties
                        (e.g. timber cladding, curtain walling)
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-white space-y-2 text-sm">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>Space:</strong> Rakers extend outward from the scaffold, occupying
                        ground-level space that may obstruct pedestrians or traffic
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>Ground conditions:</strong> The base of the raker must bear on firm
                        ground — soft or sloping ground may require additional foundations
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>Height limit:</strong> Buttressing becomes impractical for very tall
                        scaffolds as the rakers would extend too far from the base
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong>Design required:</strong> A buttressed scaffold is a designed
                        scaffold — it must be designed by a competent scaffold designer, not left to
                        site judgement
                      </span>
                    </li>
                  </ul>
              ...
              <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  load. The weight of kentledge required is calculated by the scaffold designer
                  based on the expected wind load and the geometry of the raker. Kentledge must be
                  securely restrained so it cannot be knocked off or displaced, and must not be used
                  for any other purpose while supporting the scaffold.
                </p>
              </div>
            </div>
          </div>
              ...
              <div>
                ...
                <ul className="space-y-1 text-white">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Ledger (face):</strong> Diagonal across the
                      face — prevents racking along the scaffold
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Plan:</strong> Diagonal in horizontal plane —
                      prevents twisting across the width
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Cross (X):</strong> Two diagonals per bay —
              ...
              <div>
                ...
                <ul className="space-y-1 text-white">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Box tie:</strong> Cross tube in opening — push
                      and pull
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Lip (reveal) tie:</strong> Pin in reveal —
                      mainly pull only
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Through tie:</strong> Bolt through wall —
                      strongest type
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Anchor bolt:</strong> Drilled into facade —
              ...
              <div>
                ...
                <ul className="space-y-1 text-white">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Minimum:</strong> 6.25 kN proof-load (tube &
                      fitting)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">When:</strong> At installation, after
                      disturbance, after storms
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Tool:</strong> Calibrated pull-test device
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-1 text-white">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Standard:</strong> Every other standard, every
                      other lift (staggered)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Sheeted:</strong> Closer spacing — every
                      standard at every lift
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Top lift:</strong> Always tied
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">First tie:</strong> As low as practicable (lift
                      2)
                    </span>
                  </li>
                </ul>
              ...
              <div>
                ...
                <ul className="space-y-1 text-white">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Polythene:</strong> 3-5x wind load increase
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Debris netting:</strong> 2-3x wind load
                      increase
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Action:</strong> More ties, more bracing,
              ...
              <div>
                ...
                <ul className="space-y-1 text-white">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">When:</strong> No ties possible (new-build,
                      heritage, freestanding)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Angle:</strong> 45 degrees to the ground
                      (ideal)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Base:</strong> Kentledge or ground anchors to
                      prevent sliding
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Design:</strong> Must be designed by a
                      competent person
                    </span>
                  </li>
                </ul>
        ...
        {/* Quiz Section */}
        <div className="mt-12">
          <Quiz title="Bracing, Ties & Stability Quiz" questions={quizQuestions} />
        </div>
