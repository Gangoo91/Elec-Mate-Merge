...
const faqs = [
  ...
  {
    question:
      'Who is responsible if a scaffold collapse injures a worker — the scaffolder, the inspector, or the principal contractor?',
    answer:
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-slate-500/5 border-l-2 border-slate-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Scaffolder:</strong> CISRS-trained, erects &amp; dismantles
              </li>
              <li>
                <strong>Inspector:</strong> Competent person, 7-day checks
              </li>
              <li>
                <strong>Designer:</strong> Non-standard scaffold calculations
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-slate-500/5 border-l-2 border-slate-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>User:</strong> Check before use, never modify
              </li>
              <li>
                <strong>TWC:</strong> Oversees all temporary works
              </li>
              <li>
                <strong>Principal Contractor:</strong> Overall site scaffold safety
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-slate-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The scaffolder is the skilled operative responsible for the{' '}
                <strong>safe erection, alteration, and dismantling</strong> of scaffolding
                structures on construction sites. In the United Kingdom, scaffolders must be trained
                and certificated through the{' '}
                <strong>Construction Industry Scaffolders Record Scheme (CISRS)</strong>, which is
                the industry-recognised competence framework managed by CISRS Ltd in partnership
                with the National Access and Scaffolding Confederation (NASC).
              </p>

              <p>
                CISRS certification is not merely a recommendation &mdash; it is the accepted
                standard across the UK construction industry. Most principal contractors, local
                authorities, and commercial clients will not allow scaffolders on site without a
                valid CISRS card. The scheme provides a structured progression from trainee level
                through to advanced scaffolder, with each level unlocking additional capabilities
              ...
              <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">CISRS Labourer Card</strong> &mdash; for
                      scaffold labourers who assist scaffolders but do not erect scaffold structures
                      themselves; requires CISRS scaffold labourer training and a valid CITB
                      HS&amp;E test pass
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">CISRS Trainee Scaffolder Card</strong> &mdash;
                      for individuals who have completed Part 1 scaffolder training; allows them to
                      work under direct supervision of a qualified scaffolder while gaining site
                      experience towards their Part 2 assessment
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">CISRS Scaffolder Card</strong> &mdash; for
                      operatives who have completed Part 1 and Part 2 scaffolder training plus the
                      required on-site experience and NVQ Level 2 in Accessing Operations and
                      Rigging (Scaffolding); qualified to erect, alter, and dismantle standard
                      scaffolds within the scope of TG20
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">CISRS Advanced Scaffolder Card</strong> &mdash;
                      for experienced scaffolders who have completed advanced training and hold NVQ
                      Level 3; qualified to erect complex and non-standard scaffolds including
                      system scaffolds, suspended scaffolds, and bespoke structures
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <p>
                Regardless of card level, every scaffolder must <strong>follow the design</strong>{' '}
                when erecting a scaffold. For standard scaffolds within TG20 scope, this means
                following the relevant TG20 compliance sheet. For non-standard scaffolds, the
                scaffolder must follow the bespoke design drawings and calculations provided by the
                scaffold designer. Deviating from the design without authorisation is a serious
                safety breach.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      Erect, alter, and dismantle scaffolds{' '}
                      <strong className="text-white">
                        safely and in accordance with the design
                      </strong>{' '}
                      or TG20 compliance sheets
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      Ensure all{' '}
                      <strong className="text-white">components are in good condition</strong>{' '}
                      before use &mdash; reject damaged tubes, fittings, or boards
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      ...
                      as required to prevent falls and falling objects
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      Install{' '}
                      <strong className="text-white">
                        ties at the specified pattern and intervals
                      </strong>{' '}
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      <strong className="text-white">method statement and risk assessment</strong>{' '}
                      for the scaffold erection
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      Participate in the <strong className="text-white">handover process</strong>{' '}
                      &mdash; confirm the scaffold is complete and safe before handing over to users
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      Report any{' '}
                      <strong className="text-white">
                        site conditions that prevent safe erection
                      </strong>{' '}
                      &mdash; such as poor ground, obstructions, or overhead hazards
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 sm:p-6 rounded-lg">
                <p className="text-sm font-medium text-slate-400 mb-4 text-center">
                  CISRS Card Levels &mdash; Trainee Through Advanced
                </p>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-slate-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The scaffold inspector is the <strong>competent person</strong> responsible for
                carrying out formal inspections of scaffolds as required by the{' '}
                <strong>Work at Height Regulations 2005</strong>. The regulations specify that
                scaffolds must be inspected by a competent person before first use, at intervals not
                exceeding 7 days during continued use, and after any event likely to have affected
                the scaffold's strength or stability.
              </p>

              <p>
                The term &ldquo;competent person&rdquo; is not defined by a specific qualification
                in the regulations, but industry guidance from the NASC and HSE makes clear that the
                inspector must have <strong>sufficient training, experience, and knowledge</strong>{' '}
                to identify defects and assess whether a scaffold is safe for use. In practice, this
                means the inspector should hold a recognised scaffold inspection qualification.
              </p>
              ...
              <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Before first use</strong> &mdash; after initial
                      erection is complete, before any tradesperson accesses the scaffold
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      ...
                      &mdash; measured from the date of the last inspection, not from the day the
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      &mdash; severe weather (high winds, heavy rain, snow, ice), accidental impact
                      (vehicle strikes, crane contact), significant alteration, or any other event
                      that could compromise the scaffold
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <p>
                Each inspection must result in a <strong>written inspection report</strong> prepared
                on the same day as the inspection. The report must include the date, location,
                description of the scaffold, name and position of the inspector, details of any
                defects found, and confirmation of whether the scaffold is safe for use. These
                reports must be retained on site and made available to the HSE on request.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-green-400">Green tag</strong> &mdash; scaffold is safe
                      to use; includes the date of inspection and the next inspection due date
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-amber-400" />
                    <span>
                      <strong className="text-amber-400">Amber/yellow tag</strong> &mdash; scaffold
                      has restrictions; may be usable with specific limitations (e.g., reduced
                      loading, restricted areas); details of restrictions must be clearly stated on
                      the tag
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-red-400">Red tag</strong> &mdash; scaffold is NOT safe
                      to use; do not access under any circumstances; scaffold requires remedial work
                      by a competent scaffolder before re-inspection
                    </span>
                  </li>
                </ul>
              </div>
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      &mdash; the industry-standard course specifically for scaffold inspectors,
                      covering inspection methodology, defect identification, and report writing
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">CISRS Advanced Scaffold Inspection</strong>{' '}
                      &mdash; for inspectors dealing with complex or non-standard scaffolds
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Relevant experience</strong> &mdash; the
                      inspector should have practical understanding of scaffold construction, common
                      defects, and loading requirements
                    </span>
                  </li>
                </ul>
              </div>
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      covering foundations, standards, ledgers, braces, ties, platforms, guard
                      rails, toe boards, and access points
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      Prepare a <strong className="text-white">written inspection report</strong> on
                      the same working day as the inspection
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      Apply the <strong className="text-white">appropriate scaffold tag</strong>{' '}
                      (green, amber, or red) based on findings
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      Communicate{' '}
                      <strong className="text-white">defects to the responsible person</strong> so
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Ensure{' '}
                      <strong className="text-white">
                        unsafe scaffolds are taken out of service
                      </strong>{' '}
                      immediately by applying a red tag and informing site management
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-slate-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The scaffold designer is required when a scaffold falls{' '}
                <strong>outside the scope of TG20</strong> &mdash; meaning it cannot be covered by a
                standard TG20 compliance sheet. TG20 (published by the NASC) provides pre-calculated
                solutions for common tube and fitting scaffold configurations up to certain heights,
                with standard loading and tie arrangements. Any scaffold that exceeds these
                parameters requires a bespoke design.
              </p>

              <p>
                Scaffold designers are typically <strong>structural engineers</strong> or
                individuals who hold <strong>NASC-recognised scaffold design qualifications</strong>
                . They have specialist knowledge of structural analysis, load calculations, wind
                loading, and the behaviour of scaffold systems under various conditions. Their work
                is essential for ensuring that non-standard scaffolds are structurally adequate and
                safe.
              </p>
              ...
              <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Height exceeding TG20 limits</strong> &mdash;
                      scaffolds above the maximum height covered by TG20 compliance sheets for the
                  ...
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Heavy or concentrated loads</strong> &mdash;
                      such as masonry loading bays, materials hoists, crane landing platforms, or
                      scaffolds supporting formwork
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Unusual geometry</strong> &mdash; curved
                      scaffolds, scaffolds on sloping ground, scaffolds bridging gaps, or scaffolds
                  ...
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Complex tie arrangements</strong> &mdash; where
                      standard tie patterns cannot be achieved due to building features, openings,
                      or cladding
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Cantilever or suspended scaffolds</strong>{' '}
                      &mdash; scaffolds that are not supported from the ground in the conventional
                      manner
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Temporary roofs or encapsulation</strong>{' '}
                      &mdash; scaffold structures supporting sheeting or temporary roof systems that
                      create additional wind loading
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Design drawings</strong> &mdash; detailed
                      drawings showing the scaffold layout, dimensions, lift heights, bay lengths,
                      bracing arrangement, and all components
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Structural calculations</strong> &mdash;
                      demonstrating that the scaffold can safely support all applied loads including
                      self-weight, imposed loads, wind loads, and any special loads
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Tie pattern specification</strong> &mdash; the
                      precise location, type, and capacity of ties required to resist horizontal
                      forces and provide lateral stability
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Foundation requirements</strong> &mdash;
                      specifying sole board sizes, base plate types, and any special foundation
                      requirements based on ground conditions
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Loading schedule</strong> &mdash; clearly
                      stating the maximum permitted loads on each platform level and any load
                      restrictions
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Special instructions</strong> &mdash; any
                      specific requirements for erection sequence, material specification, or
                      limitations on use
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  for complex or high-risk scaffolds. The Temporary Works Coordinator is responsible
                  for ensuring the design check is carried out before erection begins. Any design
                  changes during erection must be referred back to the designer for approval.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-slate-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The scaffold user is{' '}
                <strong>every tradesperson who works on or from a scaffold</strong> &mdash;
                bricklayers, electricians, painters, plumbers, cladders, window fitters, and any
                other operative who accesses a scaffolded area to carry out their work. Although
                scaffold users do not erect or formally inspect scaffolds, they have critical
                responsibilities that directly affect their own safety and the safety of everyone on
                site.
              </p>

              <p>
                The single most important rule for scaffold users is:{' '}
                <strong>you must NEVER modify the scaffold</strong>. Removing a guard rail, moving
                boards, removing ties, adding unauthorised loads, or making any other change to the
                scaffold structure is strictly prohibited. Only a competent, CISRS-trained
                scaffolder may alter a scaffold. Unauthorised modifications are one of the leading
                causes of scaffold-related accidents and fatalities in the UK.
              </p>
              ...
              <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Green tag displayed and in date</strong>{' '}
                      &mdash; confirm the scaffold has been inspected within the last 7 days and the
                      tag shows it is safe to use
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Platform condition</strong> &mdash; boards are
                      complete with no gaps exceeding 25mm, boards are not damaged, split, or bowed,
                      and the platform is free of debris and trip hazards
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Guard rails in place</strong> &mdash; main
                      guard rail at approximately 950mm, intermediate guard rail (or equivalent
                      protection), and toe boards at platform edge
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Safe access</strong> &mdash; ladders are tied,
                      access gates are functioning, and the access route is clear
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">No visible damage</strong> &mdash; no bent
                      tubes, missing fittings, damaged bracing, or signs of impact damage
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">No obvious overloading</strong> &mdash; no
                      excessive materials stacked on platforms beyond what is needed for the
                      immediate task
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  ...
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-amber-400" />
                    <span>
                      Using the scaffold for purposes it was not designed for (e.g., as a crane base
                      or for vehicle access)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-amber-400" />
                  ...
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-amber-400" />
                    <span>
                      Climbing the outside of the scaffold instead of using the designated access
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Stop work immediately</strong> and leave the
                      scaffold if the defect presents an immediate danger
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Report the defect</strong> to their supervisor,
                      the site manager, or the scaffolding contractor as soon as possible
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Warn others</strong> &mdash; alert colleagues
                      who may also be using or about to use the scaffold
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Do not attempt to fix the defect</strong>{' '}
                      &mdash; only a competent scaffolder should carry out repairs or modifications
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Do not return to the scaffold</strong> until
                      the defect has been remedied by a competent scaffolder and the scaffold has
                      been re-inspected
                    </span>
                  </li>
                </ul>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-slate-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The Temporary Works Coordinator (TWC) is a role established under{' '}
                <strong>CDM 2015</strong> and described in detail in{' '}
                <strong>BS 5975 (Code of Practice for Temporary Works)</strong>. The TWC oversees{' '}
                <strong>all temporary works on a construction project</strong>, which includes
                scaffolding, formwork, falsework, shoring, propping, temporary hoarding, and any
                other structure that is needed during construction but does not form part of the
                permanent works.
              </p>

              <p>
                The TWC is a <strong>management and coordination role</strong>, not an operative
                role. They do not physically erect scaffolds, carry out inspections, or produce
                designs. Instead, they ensure that the correct processes are followed throughout the
                lifecycle of every temporary works item &mdash; from initial design briefing through
                to final dismantling and removal.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">
                        Ensure designs are produced and checked
                      </strong>{' '}
                      &mdash; for non-standard scaffolds, the TWC ensures a bespoke design is
                      prepared by a competent designer and subjected to an independent design check
                  ...
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Review erection sequence</strong> &mdash; the
                      TWC reviews method statements for scaffold erection to ensure the proposed
                      sequence is safe and practical, particularly for complex scaffolds where the
                  ...
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Manage the permit process</strong> &mdash; the
                      TWC oversees scaffold permits, ensuring that scaffolds are formally handed
                      over from the scaffolder to the user, and that any load permits are in place
                  ...
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Maintain the temporary works register</strong>{' '}
                      &mdash; a formal log of all temporary works on site, including scaffolds,
                      their current status, design references, inspection dates, and any permits
                      issued
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Manage design changes</strong> &mdash; if site
                      conditions require changes to a scaffold design, the TWC ensures these are
                      referred back to the designer for approval rather than being made ad hoc on
                      site
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Oversee dismantling</strong> &mdash; the TWC
                      ensures scaffolds are dismantled safely and in the correct sequence,
                      particularly where early removal could affect other temporary or permanent
                      works
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  records: scaffold reference number, location, type, design reference (TG20 sheet
                  or bespoke design number), date of erection, handover date, inspection dates and
                  results, any permits issued, date of dismantling, and current status. The register
                  provides a single point of reference for the status of all scaffolding on site and
                  is essential for demonstrating compliance during audits or HSE inspections.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-slate-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Under <strong>CDM 2015</strong>, the principal contractor has{' '}
                <strong>overall responsibility for scaffold safety on site</strong>. This does not
                mean the principal contractor must personally erect, inspect, or design scaffolds
                &mdash; but they must ensure that effective management systems are in place so that
                all scaffolding work is carried out safely and in compliance with the law.
              </p>

              <p>
                The principal contractor&rsquo;s role is one of{' '}
                <strong>coordination, management, and enforcement</strong>. They must ensure that
                different contractors working on site do not create risks for each other, and that
                scaffold safety is integrated into the overall site management system. On large
                projects with multiple scaffolding contractors, this coordination role is
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Ensure scaffolds are inspected</strong> at the
                      intervals required by the Work at Height Regulations 2005 (before first use,
                      every 7 days, and after events affecting stability)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Manage scaffold permit and tag systems</strong>{' '}
                      &mdash; implement and enforce a scaffold tagging regime so that all site
                      personnel can immediately see whether a scaffold is safe to use
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">
                        Ensure only competent scaffolders erect scaffolds
                      </strong>{' '}
                      &mdash; verify that all scaffolders hold valid CISRS cards at the appropriate
                      level for the work being undertaken
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Coordinate between trades</strong> &mdash;
                      manage the interface between scaffolding operations and other site activities
                      to prevent conflicts, such as ensuring scaffolders are not working above
                      unprotected operatives
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      ...
                      &mdash; ensure all workers who use scaffolds have received appropriate
                      scaffold awareness training, typically through site inductions and toolbox
                      talks
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Monitor compliance</strong> &mdash; carry out
                      regular checks to verify that scaffold management procedures are being
                      followed, that inspection reports are up to date, and that tags are current
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Take enforcement action</strong> &mdash; stop
                      work, issue warnings, or remove individuals from site if scaffold safety rules
                      are breached
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  <strong className="text-white">non-delegable duty</strong> to plan, manage, and
                  monitor construction work to ensure it is carried out safely. This means they
                  cannot simply pass responsibility to a scaffolding subcontractor and claim
                  ignorance if something goes wrong. The principal contractor must actively manage
                  and oversee scaffold safety as part of their overall site management duties.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-slate-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Under <strong>CDM 2015</strong>, the client is the organisation or individual for
                whom the construction project is being carried out. The client has specific legal
                duties that apply to scaffolding, even though they are unlikely to be directly
                involved in scaffold erection or inspection. These duties are{' '}
                <strong>management and procurement duties</strong> &mdash; ensuring the right
                conditions exist for scaffolding to be done safely.
              </p>

              <p>
                Many clients, particularly those who do not regularly commission construction work,
                are unaware of their duties under CDM 2015. However, ignorance is not a defence. The
                regulations place clear responsibilities on the client, and failure to meet these
                duties can result in enforcement action by the HSE.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Allow adequate time</strong> for scaffold
                      design and erection &mdash; compressed programmes that do not allow sufficient
                      time for proper scaffold design, procurement, and erection create pressure
                      that leads to shortcuts and unsafe practices
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Allocate adequate resources</strong> &mdash;
                      the client must ensure sufficient budget is available for safe scaffolding,
                      including design fees, competent scaffolders, quality materials, and proper
                      inspection regimes
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Appoint competent contractors</strong> &mdash;
                      the client must take reasonable steps to ensure that the scaffolding
                      contractor is competent, which in practice means checking CISRS registration,
                      NASC membership, insurance, and track record
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      ...
                      &mdash; the client must ensure that relevant information is provided to the
                      principal designer and principal contractor, including details that affect
                      scaffold requirements such as building condition, underground services, access
                      restrictions, and any known hazards
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Make suitable arrangements</strong> for
                      managing the project &mdash; this includes ensuring appropriate management
                      structures are in place for scaffold safety, not just relying on the cheapest
                      tender
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  their{' '}
                  <strong className="text-white">
                    procurement decisions do not compromise safety
                  </strong>
                  . This means evaluating scaffold tenders on competence, quality, and safety record
                  &mdash; not just price. The HSE has specifically highlighted client pressure on
                  costs as a contributing factor in scaffold incidents.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Building structure and condition</strong>{' '}
                      &mdash; information about the fa&ccedil;ade, wall ties, structural integrity,
                      and suitability for scaffold ties
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Ground conditions</strong> &mdash; soil type,
                      underground services, drainage runs, and any ground contamination that affects
                  ...
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Access restrictions</strong> &mdash; site
                      boundaries, neighbouring properties, public footpaths, road closures required
                  ...
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Overhead hazards</strong> &mdash; power lines,
                      overhead cables, crane paths, and any other above-ground obstructions
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Previous scaffold arrangements</strong> &mdash;
                      if the building has been scaffolded before, information about what worked and
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-slate-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Effective communication between all scaffold roles is{' '}
                <strong>essential for preventing incidents</strong>. Scaffold accidents frequently
                occur not because individuals lack competence in their own role, but because
                information fails to flow between roles. A scaffolder who does not communicate a
                limitation, a designer whose instructions are not passed to the erection team, or a
                user who does not report a defect &mdash; each represents a communication failure
              ...
              <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Verbal handover</strong> &mdash; the scaffolder
                      (or scaffold supervisor) briefs the user (or their supervisor) on the
                      scaffold&rsquo;s configuration, any limitations, maximum loading per platform,
                      access arrangements, and any special conditions
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Written handover</strong> &mdash; a handover
                      certificate or form is completed and signed by both the scaffolder and the
                      receiving party, confirming the scaffold is complete, safe, and fit for its
                      intended purpose
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Scaffold register entry</strong> &mdash; the
                      scaffold is entered into the site scaffold register with all relevant details
                      including reference number, location, type, design reference, handover date,
                      and intended use
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Tag applied</strong> &mdash; following the
                      initial inspection, a green tag is applied to confirm the scaffold is safe for
                      use
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      The permit specifies the <strong className="text-white">maximum load</strong>{' '}
                      that may be placed on each platform level
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      It defines <strong className="text-white">what types of materials</strong> may
                      be stored on the scaffold
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      It states{' '}
                      <strong className="text-white">how materials should be distributed</strong>{' '}
                      across the platform to avoid concentrated point loads
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      Loading beyond the permitted limit requires a{' '}
                      <strong className="text-white">
                        new design check or scaffold modification
                      </strong>{' '}
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">All users must be notified</strong> before the
                      alteration begins &mdash; they must vacate the scaffold during the
                      modification work
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      The scaffold must be <strong className="text-white">re-tagged as red</strong>{' '}
                      (unsafe) during the alteration to prevent access by non-scaffold workers
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      Once the alteration is complete, the scaffold must be{' '}
                      <strong className="text-white">re-inspected</strong> by a competent person
                      before users can return
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      A <strong className="text-white">new handover</strong> must take place
                      covering the altered scaffold, including any changes to loading, access, or
                      limitations
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      The <strong className="text-white">scaffold register must be updated</strong>{' '}
                      to reflect the alteration, new inspection date, and revised handover
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Scheduling scaffold access</strong> to prevent
                      overcrowding and overloading &mdash; not all trades should be on the same
                      scaffold level simultaneously
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Coordinating scaffold modifications</strong>{' '}
                      with trade requirements &mdash; ensuring scaffolders alter the scaffold to
                      suit the next phase of work before the new trade arrives
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Preventing conflicting operations</strong>{' '}
                      &mdash; for example, scaffolders should not be dismantling scaffold above a
                      level where other trades are working
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Regular communication meetings</strong> &mdash;
                      toolbox talks, coordination meetings, and daily briefings that include
                      scaffold status updates so all trades are aware of the current situation
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-slate-400" />
                    <span>
                      <strong className="text-white">Clear reporting channels</strong> &mdash; every
                      worker on site must know who to report scaffold concerns to and be confident
                      that reports will be acted upon promptly
                    </span>
                  </li>
                </ul>
              </div>
