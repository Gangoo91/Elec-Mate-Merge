...
const faqs = [
  {
    question: 'Can I use scaffold boards that have been cut to a shorter length?',
    answer:
  ...
  {
    question: 'Is it acceptable to have a small gap between scaffold boards on a working platform?',
    answer:
...
const quizQuestions = [
  ...
  {
    id: 2,
    question: 'What are the standard dimensions of a scaffold board used in the UK?',
    options: [
  ...
  {
    id: 3,
    question: 'What is the maximum unsupported span for a 38 mm thick scaffold board?',
  ...
  {
    id: 8,
    question: 'When must a working platform be fully completed before it can be used?',
    options: [
...
export default function ScaffoldingAwarenessModule3Section3() {
  useSEO({
    title: 'Platforms, Guard Rails & Toe Boards | Scaffolding Awareness Module 3.3',
    description:
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          ...
          <div className="p-4 rounded-lg bg-slate-500/5 border-l-2 border-slate-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Before:</strong> Check platform is fully complete before use
              </li>
              <li>
                <strong>Boards:</strong> Secured with clips, overhang max 150 mm
              </li>
              <li>
                <strong>Width:</strong> Minimum 600 mm for light work, 800 mm with materials
              </li>
              <li>
          ...
          <div className="border-l-2 border-slate-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                <strong>Schedule 3</strong>, set out the requirements for working platforms used on
                scaffolding and other temporary structures. These requirements exist because falls
                from working platforms remain one of the most common causes of serious injury and
                death in construction. Every element of a working platform &mdash; its width, its
                boards, its edge protection &mdash; is specified to prevent falls and protect people
                both on and below the scaffold.
              </p>
                ...
                <div className="space-y-2 text-sm text-white">
                  <div className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      <strong className="text-white">suitable and sufficient</strong> for the work
                      to be carried out and the loads to be imposed
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <span>
                      Platforms must have{' '}
                      <strong className="text-white">
                        suitable and sufficient guard rails, toe boards, and barriers
                      </strong>{' '}
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      <strong className="text-white">not liable to give way or buckle</strong> when
                      any person or equipment is on it
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      ...
                      <strong className="text-white">collapse or deformation</strong> that could
                      affect safety
                    </span>
                  </div>
                </div>
              ...
              <p>
                In plain terms, a scaffold working platform must be wide enough for the task, strong
                enough for the loads, fully boarded with no dangerous gaps, and fitted with edge
                protection on all open sides. These are not best-practice suggestions &mdash; they
                are <strong>legal requirements</strong>.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  is carried out must ensure that working platforms comply with Schedule 3. This
                  includes the scaffolding contractor who erects the platform, the principal
                  contractor who manages the site, and any employer whose workers use the scaffold.
                  If you are an operative using a scaffold platform, you have a duty to report any
                  defects immediately.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-slate-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The width of a working platform depends on the type of work being carried out. Wider
                platforms are needed when materials must be stored or when operatives need room to
                move freely. The widths below are <strong>minimums</strong> &mdash; platforms should
                always be as wide as reasonably practicable for the task.
              </p>
              ...
              <p>
                In practice, a domestic scaffold for painters might be three or four boards wide
                (approximately 600&ndash;800 mm), while a bricklayer's scaffold carrying materials
                will typically be five boards wide (approximately 1050&ndash;1200 mm) or more. The
                key principle is that the platform must always be wide enough for the operative to
                work safely <strong>without</strong> having to lean over or reach beyond the edge
                protection.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  cabling cannot safely work from a single-board platform. If the platform is not
                  wide enough for the task,{' '}
                  <strong className="text-white">stop work and request a wider platform</strong>{' '}
                  before continuing.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-slate-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Scaffold boards are the structural elements that form the walking and working
                surface of a scaffold platform. They are manufactured to <strong>BS 2482</strong>{' '}
                and must meet specific requirements for dimensions, strength, and condition. Using
                boards that are damaged, undersized, or incorrectly supported is a direct cause of
                platform collapses and falls.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white">
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">38 mm boards:</strong> Maximum unsupported span
                      of <strong className="text-white">3.9 m</strong> (this is for light-duty use;
                      for general-purpose scaffolds the practical span is typically 1.2 m to 1.5 m
                      between transoms)
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">50 mm boards:</strong> Used where heavier loads
                      are expected or where longer spans are required; maximum span depends on the
                      load class
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Maximum overhang:</strong> The board must not
                      project more than{' '}
                      <strong className="text-white">4 times the board thickness</strong> beyond the
                      supporting transom, with an absolute maximum of{' '}
                  ...
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Minimum bearing:</strong> Each board must rest
                      on its supporting transom by at least{' '}
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  . A defective board can snap under load without warning. Boards that have been
                  used as formwork and have concrete residue stuck to them should also be rejected
                  &mdash; the concrete can mask underlying damage and affect the grip surface.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-slate-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                <strong>Board clips</strong> (also called board retaining clips or scaffold board
                clips) are metal fittings that secure scaffold boards to the supporting transoms.
                They prevent boards from lifting in wind, sliding under foot traffic, or being
                displaced by impacts from materials and equipment. Every board on a working platform
                should be secured with board clips.
              </p>
              ...
              <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white">
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      Clips are fitted at <strong className="text-white">each end</strong> of every
                  ...
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      Board clips are <strong className="text-white">not optional</strong> &mdash;
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      <strong className="text-white">scaffold defect</strong> and rectified before
              ...
              <p>
                <strong>Platform gaps</strong> are the spaces between adjacent scaffold boards. The{' '}
                <strong>maximum permissible gap is 25 mm</strong>. Gaps wider than this create a
                risk of tools, fixings, and debris falling through onto people below, and a trip
                hazard on the platform surface. Boards should be laid as close together as possible,
                with gaps minimised by careful placement.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  Where gaps cannot be reduced below 25 mm due to the scaffold configuration,
                  additional measures such as{' '}
                  <strong className="text-white">plywood sheeting or infill boards</strong> must be
              ...
              <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  <strong className="text-white">do not use the scaffold</strong>. Report the defect
                  immediately so it can be rectified by a competent scaffolder.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-slate-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Guard rails are the primary means of preventing falls from the open edges of
                scaffold platforms. Under the{' '}
                <strong>Work at Height Regulations 2005 (Schedule 3)</strong>, guard rails must be
                fitted to <strong>every open side of a working platform</strong> from which a person
                could fall. This includes the outer edge (facing away from the building), the ends
                of the scaffold, and any inner edge where there is a gap between the platform and
                the building facade.
              </p>
              ...
              <p>
                The 950 mm minimum height is a critical dimension. Below this height, the rail is at
                or below the centre of gravity for most adults, meaning a person could topple over
                the rail rather than being stopped by it. The guard rail must be a{' '}
                <strong>rigid horizontal tube</strong> &mdash; it must not be formed from warning
                tape, bunting, rope, or any material that would deform when a person falls against
                it.
              </p>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  must be carried out by a competent scaffolder under a controlled system, and the
                  rail must be replaced immediately after. Operatives must never remove guard rails
                  themselves.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-slate-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                A top guard rail alone is not sufficient edge protection. The gap between the top
                rail and the platform surface would be large enough for a person to slide or roll
                under the rail, or for materials to fall from the platform. This is why{' '}
                <strong>mid rails and toe boards</strong> are essential components of every scaffold
                platform.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white">
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Purpose:</strong> Fill the gap between the top
                      guard rail and the toe board so that no opening exceeds 470 mm
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Position:</strong> Typically fitted at
                      approximately mid-height between the top rail and the platform. The exact
                      height is determined by the 470 mm maximum gap rule
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Material:</strong> Standard scaffold tube (48.3
                      mm OD) fixed with right-angle couplers to the standards, matching the top
                      guard rail
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Multiple mid rails:</strong> If a single mid
                      rail cannot reduce all gaps to 470 mm or less (for instance, on a very tall
                      guard rail system), additional intermediate rails must be added
                    </span>
                  </div>
                </div>
              </div>
                ...
                <div className="space-y-2 text-sm text-white">
                  <div className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      <strong className="text-white">150 mm</strong> above the platform surface
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Purpose:</strong> Prevent tools, materials, and
                      debris from being kicked, rolling, or sliding off the platform edge onto
                      people below
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Secondary purpose:</strong> Prevent a
                      person&rsquo;s foot from slipping under the guard rail and off the platform
                      edge
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Material:</strong> Typically timber toe boards
                      or metal toe board clips with boards. Must be securely fixed so they cannot be
                  ...
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Fitted on:</strong> Every open side of the
                      platform where guard rails are required, including the inner edge if there is
                      a gap to the building facade
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white">
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Purpose:</strong> Provide a physical barrier
                      across the full height of the edge protection to prevent materials and objects
                  ...
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">When required:</strong> Scaffolds over public
                      footpaths, adjacent to occupied buildings, where brickwork or blockwork is
                      being laid at height, and wherever the risk assessment identifies a risk of
                      falling objects
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Specification:</strong> Mesh panels must be
                      fine enough to prevent small items passing through. Brick guards are typically
                      steel mesh panels attached to the guard rails, filling the gap from the toe
                      board to the top rail
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">SG4 guidance:</strong> The NASC SG4 guidance
                      note covers the use of brick guards and debris netting on scaffolds, including
                      when they are required and how they should be fitted
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="relative mx-auto max-w-lg">
                ...
                <div className="border-2 border-white/30 rounded-lg bg-[#1a1a1a] p-3 sm:p-4">
                  ...
                  <div className="relative min-h-[280px] sm:min-h-[340px]">
                    ...
                    <div
                      className="absolute right-10 sm:right-14 top-4 flex flex-col items-center"
                      style={{ height: 'calc(45% - 8px)' }}
                    >
                    ...
                    <div
                      className="absolute left-0 sm:left-2 right-0 sm:right-2"
                      style={{ top: '45%' }}
                    >
              ...
              <div className="relative mx-auto max-w-lg">
                <div className="border-2 border-white/30 rounded-lg bg-[#1a1a1a] p-3 sm:p-4">
                  <div className="relative min-h-[260px] sm:min-h-[300px]">
                    ...
                    <div
                      className="absolute left-1/2 -translate-x-1/2 top-[30px] flex flex-col items-center"
                      style={{ height: '70px' }}
                    >
                    ...
                    <div
                      className="absolute left-1/2 -translate-x-1/2 top-[130px] flex flex-col items-center"
                      style={{ height: '60px' }}
                    >
                      <div className="w-0 flex-1 border-l border-dashed border-red-400/60" />
                      <div className="bg-red-500/20 border border-red-500/40 rounded px-2 py-0.5 my-1">
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-slate-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                In many situations, guard rails, mid rails, and toe boards alone are not sufficient
                to prevent all falling-object risks. Where there is a risk of{' '}
                <strong>materials, tools, or debris falling</strong> from a scaffold platform,
                additional protection in the form of{' '}
                <strong>mesh panels, brick guards, debris netting, or sheeting</strong> must be
                provided.
              </p>
                ...
                <div className="space-y-3">
                  <div className="bg-white/5 rounded-lg p-3">
                    ...
                    <p className="text-white text-xs">
                      ...
                      to prevent the smallest item on the platform from falling through.
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-lg p-3">
                    ...
                    <p className="text-white text-xs">
                      ...
                      &mdash; it is an additional measure to protect people below the scaffold.
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-lg p-3">
                    <p className="text-base font-bold text-slate-400">
                    ...
                    <p className="text-white text-xs">
                      ...
                      and bracing are typically required.
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-lg p-3">
                    ...
                    <p className="text-white text-xs">
                      ...
                      be installed by a competent scaffolder.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  forces once sheeting or netting is attached. This must be accounted for in the
                  scaffold design, and additional ties and bracing may be needed. Never attach
                  sheeting or netting to a scaffold unless it has been designed to accept the
                  additional load.
                </p>
              </div>
            </div>
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  regardless of height, perceived urgency, or any other factor. The Work at Height
                  Regulations 2005 are clear: no person shall use a working platform unless it has
                  been constructed, inspected, and certified as safe for use.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white">
                  <div className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">All boards in place</strong> &mdash; no missing
                      boards, no gaps exceeding 25 mm, no damaged or defective boards
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Board clips fitted</strong> &mdash; every board
                      secured to the transoms at both ends
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Top guard rails at min 950 mm</strong> &mdash;
                  ...
                  <div className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Mid rails fitted</strong> &mdash; no gap
                      between any two horizontal elements exceeds 470 mm
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Toe boards at min 150 mm</strong> &mdash; on
                      all open sides, securely fixed
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Brick guards or mesh panels</strong> &mdash;
                      fitted where required by the risk assessment
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Scaffold tag displayed</strong> &mdash; a
                      scaffold tag or inspection record at the access point confirming the scaffold
                      has been inspected and is safe for use
                    </span>
                  </div>
                </div>
              </div>
              ...
              <p>
                The scaffold must be <strong>inspected by a competent person</strong> before first
                use, after any alteration, after any event likely to have affected its stability
                (such as high winds or impact damage), and at intervals not exceeding{' '}
                <strong>7 days</strong>. The results of each inspection must be recorded in writing
              ...
              <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white">
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-green-400">Green tag:</strong> Scaffold has been
                      inspected and is safe for use. Check the date &mdash; it must have been
                      inspected within the last 7 days
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-amber-400">Amber tag:</strong> Scaffold is incomplete
                      or has restrictions on use. Read the tag carefully to understand what
                      limitations apply
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-red-400">Red tag:</strong> Scaffold is not safe for
                      use. Do not access under any circumstances. Report to the site manager
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">No tag:</strong> Treat as unsafe. Do not use.
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  Before stepping onto any scaffold platform, look for the scaffold tag, check that
                  all boards are in place and clipped, confirm that guard rails, mid rails, and toe
                  boards are present and secure, and report any defects you find. If something does
                  not look right, <strong className="text-white">do not use the scaffold</strong>{' '}
