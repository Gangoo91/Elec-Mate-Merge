...
const faqs = [
  {
    question: 'Is there a specific wind speed at which all scaffold work must legally stop?',
    answer:
  ...
  {
    question: 'How does the scaffold design affect the wind speed at which work must stop?',
    answer:
  ...
  {
    question: 'What records should be kept regarding weather-related scaffold decisions?',
    answer:
...
export default function ScaffoldingAwarenessModule5Section3() {
  useSEO({
    title: 'Weather & Environmental Conditions | Module 5 | Scaffolding Awareness',
    description:
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="bg-slate-500/10 border border-slate-500/30 rounded-xl p-5 mb-6">
          ...
          <p className="text-white/80 text-base leading-relaxed">
            ...
            intervention. Ice, frost, rain, lightning, extreme temperatures, and snow all create
            additional hazards. A competent person must inspect the scaffold after any significant
            weather event before it is used again.
          </p>
        </div>
        ...
        <div className="bg-slate-400/10 border border-slate-400/30 rounded-xl p-5 mb-8">
          ...
          <p className="text-white/80 text-base leading-relaxed">
            ...
            base? Are ties secure? If conditions have changed since the last inspection, a competent
            person must re-inspect before anyone climbs.
          </p>
        </div>
          ...
          <div className="border-l-2 border-slate-500/40 pl-5 space-y-4">
            ...
            <div className="bg-slate-500/10 border border-slate-500/30 rounded-lg p-4">
              ...
              <ul className="space-y-2 text-sm text-white/70">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong className="text-white">Lateral loading on the structure</strong> — wind
                    pushes the scaffold sideways, transferring force through the ties into the
                    building. If ties are inadequate or the building connection is weak, the
                    scaffold can pull away or collapse
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Uplift on platforms and boards</strong> — wind
                    passing over and under platforms creates lift forces that can dislodge boards,
                    especially if they are not properly secured with board clips or wedges
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Gust effects versus mean wind speed</strong> —
                    gusts can be 50% or more above the mean wind speed and create sudden, violent
                    forces. A mean speed of 20 mph may produce gusts of 30+ mph
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Funnelling and turbulence</strong> — gaps between
                    buildings, corners, and elevated locations can accelerate wind speeds
                    significantly above the general wind speed. A scaffold in a gap between two tall
                    buildings may experience much higher wind than one in an open field
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Effect on workers</strong> — wind buffeting
                    reduces stability and balance, making falls more likely. Workers handling loose
                    materials or scaffold components become vulnerable as the wind catches flat
                    surfaces
                  </span>
                </li>
              </ul>
            ...
            <div className="bg-amber-500/10 border border-amber-500/30 rounded-lg p-4">
              ...
              <p className="text-white/70 text-sm leading-relaxed">
                ...
                dangerous very quickly as wind speed increases.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/40 pl-5 space-y-4">
            <p className="text-white/80 text-sm leading-relaxed">
              ...
              a dynamic risk assessment must be carried out for each situation.
            </p>
              ...
              <div className="space-y-2">
                ...
                <div className="bg-red-500/10 border border-red-500/20 rounded-lg p-3">
                  ...
                  <p className="text-white/70 text-xs mt-2">
                    ...
                    General scaffold work may continue with caution subject to dynamic risk
                    assessment. Sheeted/netted scaffolds may need to stop earlier.
                  </p>
                </div>
                ...
                <div className="bg-red-500/10 border border-red-500/20 rounded-lg p-3">
                  ...
                  <p className="text-white/70 text-xs mt-2">
                    ...
                    General scaffold use should be reviewed — strongly consider evacuation.
                  </p>
                </div>
                ...
                <div className="bg-red-500/15 border border-red-500/30 rounded-lg p-3">
                  ...
                  <p className="text-white/70 text-xs mt-2">
                    ...
                    Check ties, bracing, boards, and sheeting.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-lg p-4">
              ...
              <p className="text-white/70 text-sm leading-relaxed">
                ...
                walking against the wind is difficult. Site-specific factors such as building
                funnelling, elevation, and open exposure can significantly increase local wind speed
                above the general forecast. Weather forecasts from the Met Office provide both mean
                wind speeds and gust speeds — always check both.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="border-l-2 border-purple-500/40 pl-5 space-y-4">
            ...
            <div className="bg-purple-500/10 border border-purple-500/30 rounded-lg p-4">
              ...
              <ul className="space-y-2 text-sm text-white/70">
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Fully sheeted scaffolds</strong> can experience
                    wind loads <strong className="text-white">three to five times greater</strong>{' '}
                    than an equivalent open scaffold, depending on the material and attachment
                    method
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Debris netting</strong> typically has around 50%
                    porosity (allowing some air through) but still significantly increases wind
                    loading compared to an open scaffold
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Additional ties and bracing</strong> are required
                    to resist the increased wind forces. The scaffold designer must specify these in
                ...
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Stop-work wind speeds may be lower</strong> than
                    the general 23 mph guideline for erection/dismantling. The scaffold design
                    documentation may specify a lower threshold
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Torn or damaged sheeting/netting</strong> creates
                    unpredictable aerodynamic effects and must be repaired or removed before wind
                    conditions worsen
                  </span>
                </li>
              </ul>
            ...
            <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-4">
              ...
              <p className="text-white/70 text-sm leading-relaxed">
                ...
                some cases, sheeting was added after the scaffold was erected without recalculating
                the tie and bracing requirements. This is extremely dangerous — sheeting must never
                be added to a scaffold unless the design specifically allows for it.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="border-l-2 border-cyan-500/40 pl-5 space-y-4">
            ...
            <div className="bg-cyan-500/10 border border-cyan-500/30 rounded-lg p-4">
              ...
              <ul className="space-y-2 text-sm text-white/70">
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Inspect before use every morning</strong> —
                    during cold weather, visually check all platforms, ladder rungs, toe boards, and
                    access routes for ice before anyone climbs the scaffold
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Clear ice before allowing access</strong> — use
                    scrapers, brushes, or grit/salt to remove ice and treat surfaces. Do not use hot
                    water — it can refreeze and create a worse hazard
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Check throughout the day</strong> — shaded areas
                    of the scaffold may retain ice long after sunny areas have thawed. Frost can
                    form during the afternoon if temperatures drop
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                  <span>
                    ...
                    — steel tubes, couplers, and ladder rungs become extremely slippery when frozen.
                    Guardrails may also be too cold to grip effectively
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Consider postponing work</strong> — if ice cannot
                    be adequately cleared, or if conditions are so severe that ice reforms rapidly,
                    scaffold work should be postponed until conditions improve
                  </span>
                </li>
              </ul>
            </div>
            <div className="bg-amber-500/10 border border-amber-500/30 rounded-lg p-4">
              ...
              <p className="text-white/70 text-sm leading-relaxed">
                ...
                compromise the scaffold's structural integrity. After any prolonged freeze, check
                ground conditions at the base of the scaffold as part of the inspection.
              </p>
            </div>
          </div>
        </section>
              ...
              <ul className="space-y-2 text-sm text-white/70">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    ...
                    metal tubes, and ladder rungs become significantly more slippery. Boards
                    contaminated with algae, moss, cement dust, or paint are especially dangerous
                    when wet
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Reduced visibility</strong> — heavy rain impairs
                    visibility, making it harder to see hazards, other workers, and overhead
                    obstructions. Driving rain into the face is disorienting and distracting
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Water pooling on platforms</strong> — standing
                    water adds weight and indicates blocked drainage, sagging boards, or structural
                    deflection. A 1-metre square platform with 50mm of standing water holds 50
                    litres — that is 50 kg of additional load
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Ground softening and erosion</strong> — prolonged
                    rain softens the ground beneath sole plates, potentially causing the scaffold to
                    settle or lean. Surface water can wash away backfill around foundations
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Electrical hazards</strong> — rain combined with
                    scaffold metalwork increases the risk of electrical hazards if power cables or
                    equipment are in proximity. Wet conditions reduce electrical resistance
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Worker welfare</strong> — prolonged exposure to
                    rain in cold conditions increases the risk of hypothermia, reduces dexterity,
                    and affects concentration — all of which increase the likelihood of accidents
                  </span>
                </li>
              </ul>
            </div>
          ...
          <div className="border-l-2 border-amber-500/40 pl-5 space-y-4">
            ...
            <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-4">
              ...
              <ul className="space-y-2 text-sm text-white/70">
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Stop all scaffold work immediately</strong> when
                    lightning is observed or thunder is heard — do not wait for the storm to arrive
                    overhead
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Evacuate the scaffold immediately</strong> — all
                    workers must descend and move away from the scaffold structure. Do not shelter
                    under or beside the scaffold
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                  <span>
                    ...
                    — not in site cabins with metal roofs or near other tall metal structures
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">The 30/30 rule</strong> — if the time between
                    seeing lightning and hearing thunder is 30 seconds or less, seek shelter. Do not
                    return to the scaffold until 30 minutes after the last thunder is heard
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Inspect after the storm</strong> — a lightning
                    strike can damage scaffold components, weaken joints, and cause electrical
                    damage to connected equipment. A competent person must inspect the scaffold
            ...
            <div className="bg-white/5 border border-white/10 rounded-lg p-4">
              ...
              <p className="text-white/70 text-sm leading-relaxed">
                ...
                conduction path, and the electrical energy travels through every metal component —
                tubes, fittings, boards clips, and ties. Anyone touching any part of the scaffold
                structure is at extreme risk of electrocution. Even a nearby lightning strike can
                induce dangerous voltages in the scaffold through electromagnetic induction.
              </p>
            </div>
          </div>
        </section>
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
                ...
                <ul className="space-y-2 text-sm text-white/70">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      Metal components contract in cold — fittings may loosen, joints may lose
                      clamping force
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      Timber boards become brittle — more prone to cracking or splitting, especially
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      Reduced worker dexterity — cold hands cannot grip effectively, making falls
                      more likely during climbing
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      Hypothermia risk — especially for workers exposed to wind chill at height for
                      prolonged periods
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      Ground freezing — frost heave can shift sole plates and base plates,
                      compromising scaffold stability
                    </span>
                  </li>
                </ul>
              </div>
              <div className="bg-orange-500/10 border border-orange-500/30 rounded-lg p-4">
                ...
                <ul className="space-y-2 text-sm text-white/70">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      Metal components expand — this can create internal stresses in long runs of
                      scaffold, particularly where movement is restrained
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      Hot metal surfaces — steel tubes in direct sunlight can cause burns on
                      contact. Guardrails, couplers, and ladder rungs become painfully hot
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      Heat exhaustion and heat stroke — workers at height are fully exposed to sun
                      with limited shade, increasing the risk of heat-related illness
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      Dehydration — reduces concentration and reaction time, increasing accident
                      risk. Ensure drinking water is accessible at platform level
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      UV exposure — workers on scaffolds are exposed to significant ultraviolet
                      radiation, especially at height where there is less atmospheric filtering
                    </span>
                  </li>
                </ul>
              </div>
            ...
            <div className="bg-cyan-500/10 border border-cyan-500/30 rounded-lg p-4">
              ...
              <ul className="space-y-2 text-sm text-white/70">
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Snow is heavy</strong> — fresh snow weighs
                    approximately 50-100 kg per cubic metre; compacted or wet snow can weigh 200-500
                    kg per cubic metre. Even a modest layer of snow across multiple platform levels
                ...
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Drifting increases loading</strong> — wind can
                    cause snow to drift and accumulate unevenly, creating concentrated loads on some
                    areas of the scaffold while leaving others clear
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Concealed hazards</strong> — snow hides damaged
                    boards, missing toe boards, gaps in platforms, debris, and trip hazards. It can
                    also conceal missing guardrails at platform edges
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Falling snow and ice</strong> — snow and ice
                    sliding off higher scaffold levels or the building itself can strike workers
                    below. Establish exclusion zones when snow is present at height
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Clear before use</strong> — snow must be cleared
                    from scaffold platforms before use, starting from the top and working down to
                    prevent overloading lower levels. Check for ice beneath the snow
                  </span>
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-slate-500/40 pl-5 space-y-4">
            <p className="text-white/80 text-sm leading-relaxed">
              ...
              carried out the inspection and confirmed it is safe.
            </p>
                ...
                <div className="bg-black/20 rounded-lg p-3">
                  ...
                  <ul className="space-y-1 text-xs text-white/70">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        Check all ties are secure and have not pulled out from the building
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>Check bracing is intact and fittings are tight</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>Check scaffold is plumb and level — look for any lean or twist</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        Check boards are in place and secured — wind can displace or lift unsecured
                        boards
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>Check sheeting/netting for tears, detachment, or ballooning</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>Check for debris blown onto or into the scaffold</span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-black/20 rounded-lg p-3">
                  ...
                  <ul className="space-y-1 text-xs text-white/70">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        Check ground conditions at the base — soft ground, erosion around sole
                        plates, standing water
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        Check for scaffold settlement — are standards still plumb and level?
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        Remove standing water from platforms and investigate the cause of pooling
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        Check that sole plates have not been undermined or moved by water flow
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-black/20 rounded-lg p-3">
                  ...
                  <ul className="space-y-1 text-xs text-white/70">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        Clear all snow from platforms before allowing access (start from the top)
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        Check for ice on all surfaces — platforms, ladder rungs, toe boards,
                        guardrails
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>Check ground conditions for frost heave or thaw settlement</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        Check fittings for looseness caused by thermal contraction and expansion
                        cycles
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        Inspect timber boards for splitting, warping, or damage from freeze-thaw
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-black/20 rounded-lg p-3">
                  ...
                  <ul className="space-y-1 text-xs text-white/70">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        Inspect the full scaffold for heat damage, fused fittings, or burnt
                        components
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        Check ties into the building — the strike force may have loosened fixings
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>Check all electrical equipment connected to or near the scaffold</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        A scaffold engineer may need to carry out a full structural assessment
                      </span>
                    </li>
                  </ul>
                </div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-lg p-4">
              ...
              <p className="text-white/70 text-sm leading-relaxed">
                ...
                competent person who carried out the inspection. The scaffold tag or status notice
                should be updated accordingly — if the scaffold fails inspection, it must be tagged
                as unsafe and access prevented until remedial work is complete.
              </p>
            </div>
            ...
            <div className="bg-amber-500/10 border border-amber-500/30 rounded-lg p-4">
              ...
              <p className="text-white/70 text-sm leading-relaxed">
                ...
                prosecution. The HSE specifically checks for post-weather inspection records during
                investigations.
              </p>
            </div>
          </div>
        ...
        {/*  Quiz                                                         */}
        {/* ------------------------------------------------------------ */}
        <Quiz title="Section 3 — Weather & Environmental Conditions" questions={quizQuestions} />
