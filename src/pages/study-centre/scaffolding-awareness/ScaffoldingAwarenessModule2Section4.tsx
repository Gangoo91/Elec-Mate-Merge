...
const faqs = [
  ...
  {
    question: 'Can a scaffold be altered by someone other than the original erector?',
    answer:
...
const quizQuestions = [
  ...
  {
    id: 2,
    question: 'A scaffold is classified as which type of works under CDM 2015 and BS 5975?',
    options: ['Permanent works', 'Temporary works', 'Enabling works', 'Substructure works'],
    correctAnswer: 1,
    explanation:
...
export default function ScaffoldingAwarenessModule2Section4() {
  useSEO({
    title: 'CDM 2015 & Scaffold Design | Scaffolding Awareness Module 2 Section 4',
    description:
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-slate-500/5 border-l-2 border-slate-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>CDM 2015:</strong> Legal framework for managing health and safety on
                construction projects
              </li>
              <li>
                <strong>Scaffold = Temporary Works:</strong> Must follow BS 5975 procedures
              </li>
              <li>
                <strong>Design:</strong> Must be produced, independently checked, and approved
                before erection
              </li>
              <li>
                <strong>Handover:</strong> Inspect, certify, register, then permit to use
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-slate-500/5 border-l-2 border-slate-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Always:</strong> Check the scaffold tag before stepping onto any scaffold
              </li>
              <li>
                <strong>Never:</strong> Alter a scaffold without authorisation through the TW
                procedure
              </li>
              <li>
                <strong>Report:</strong> Any defects, damage, or missing components immediately
              </li>
              <li>
                <strong>Know:</strong> Your duty-holder role and what CDM 2015 requires of you
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="border-l-2 border-slate-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                2015) are the main set of regulations for managing the health, safety, and welfare
                of construction projects in Great Britain. They replaced CDM 2007 and came into
                force on 6 April 2015. CDM 2015 applies to
                <strong> all construction work</strong>, regardless of size, duration, or number of
                workers &mdash; from a small domestic scaffold for a window replacement through to a
                multi-storey tower-block refurbishment.
              </p>

              <p>
                The regulations are built on a simple principle:
                <strong> those who create the risks are best placed to manage them</strong>. CDM
                2015 places duties on five categories of duty holder, each with specific
                responsibilities for ensuring that construction work &mdash; including scaffolding
                &mdash; is planned, designed, managed, and carried out safely.
              </p>
              ...
              <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Client</strong> &mdash; the person or
                      organisation for whom the construction work is carried out
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Principal Designer</strong> &mdash; the
                      designer appointed by the client to plan, manage, and coordinate health and
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Principal Contractor</strong> &mdash; the
                      contractor appointed by the client to plan, manage, and coordinate health and
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Designers</strong> &mdash; anyone who prepares
                      or modifies a design for a building, product, or system relating to
                      construction work (includes scaffold designers)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Contractors</strong> &mdash; anyone who carries
                      out or manages construction work (includes scaffolding contractors and
                      individual scaffolders)
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <p>
                Every person involved in a scaffolding operation falls into at least one of these
                duty-holder categories. Understanding which category you fall into &mdash; and what
                duties that category carries &mdash; is essential for compliance and, more
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-slate-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The <strong>client</strong> is the person or organisation for whom the construction
                work is carried out. Under CDM 2015, the client has overarching duties that set the
                framework within which all other duty holders operate. A client who fails to fulfil
                their duties can make it impossible for scaffolding to be planned, designed, and
                erected safely.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-3 text-sm text-white">
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="text-white font-medium">Make Suitable Arrangements (Reg. 4)</p>
                      <p>
                        The client must ensure that the project is managed so that health and safety
                        risks are controlled. For scaffolding, this means ensuring that scaffolding
                        needs are identified early, that competent contractors are appointed, and
                        that scaffold work is integrated into the overall project programme.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="text-white font-medium">Allow Sufficient Time and Resources</p>
                      <p>
                        The client must allow enough time for the scaffolding contractor to plan,
                        design, procure materials, and erect the scaffold properly. Rushing scaffold
                        erection is one of the most common causes of scaffold-related incidents. The
                        client must also ensure that adequate financial resources are allocated so
                        that the scaffolding specification is not reduced to save money.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="text-white font-medium">Appoint in Writing (Reg. 5)</p>
                      <p>
                        Where more than one contractor is involved, the client must appoint a
                        principal designer (PD) and a principal contractor (PC) in writing. These
                        appointments must be made as early as is practical. On single-contractor
                        projects, the contractor automatically assumes the PC duties and the
                        designer assumes the PD duties.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        The client must provide relevant information about the site and the existing
                        structure to designers and contractors. For scaffolding, this includes
                        ground conditions, underground services, overhead power lines, adjacent
                        structures, access restrictions, and any existing temporary works on site.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-slate-400">Key Point:</strong> A domestic client (a
                  householder having work done on their own home) still has client duties under CDM
                  2015, but these are normally transferred to the contractor or principal contractor
                  by a written agreement or, if no agreement exists, they pass automatically to the
                  contractor in control of the work.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-slate-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Under CDM 2015, a <strong>designer</strong> is anyone who prepares or modifies a
                design for a building, product, or system relating to construction work. A scaffold
                designer &mdash; whether an in-house designer employed by the scaffolding
                contractor, an independent engineering practice, or a system scaffold manufacturer
                &mdash; is a<strong> designer under CDM 2015</strong> and carries the duties set out
                in Regulation 9.
              </p>

              <p>
                Scaffolding is classified as <strong>temporary works</strong> &mdash; structures
                that are essential during the construction process but do not form part of the
                finished building. Other examples of temporary works include formwork, falsework,
                propping, shoring, and temporary access roads. The management of temporary works in
                the UK is governed by{' '}
                <strong>
                  BS 5975:2019 &mdash; Code of Practice for Temporary Works Procedures and the
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Eliminate foreseeable risks</strong> &mdash;
                      the scaffold designer must, so far as is reasonably practicable, eliminate
                      risks to anyone who might be affected by the scaffold. For example, designing
                      a scaffold that avoids the need for operatives to work above fragile surfaces,
                      or specifying system scaffold with integrated guardrails that eliminate the
                      need for unprotected edges during erection.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Reduce risks that cannot be eliminated</strong>{' '}
                      &mdash; where a risk cannot be designed out, the designer must reduce it. For
                      example, if a cantilever section cannot be avoided, the designer must specify
                      the minimum safe projections, adequate ties, and any additional bracing
                      needed.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      &mdash; the designer must communicate any risks that remain after elimination
                      and reduction. This information is typically included in a design risk
                      register, a designer&rsquo;s risk assessment, or design notes issued alongside
                      the scaffold drawings and calculations.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">General arrangement drawings</strong> &mdash;
                      plan and elevation views showing the scaffold layout, dimensions, bay sizes,
                      lift heights, and relationship to the permanent structure
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Detail drawings</strong> &mdash; tie
                      arrangements, base plate details, bracing layout, cantilever details, loading
                      bay details, and any special features
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      ...
                      demonstrating that the scaffold can safely support the intended loads
                      (imposed, wind, self-weight, and any special loads) in accordance with
                      TG20:21, BS EN 12811, or BS 5975 as appropriate
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Design risk assessment</strong> &mdash;
                      identifying residual risks and the control measures required during erection,
                      use, and dismantling
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Method statement / erection sequence</strong>{' '}
                      &mdash; step-by-step instructions for building and dismantling the scaffold
                      (required for complex scaffolds)
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  TG20 parameters &mdash; unusual heights, heavy duty loads, complex geometries,
                  cantilevers, or where wind exposure is above normal &mdash; a bespoke design with
                  full structural calculations is required.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-slate-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The <strong>principal contractor</strong> (PC) is appointed by the client to plan,
                manage, monitor, and coordinate health and safety during the construction phase. On
                most projects, the PC is the main contractor who controls the site. Their duties
                under CDM 2015 Regulation 12 have a direct impact on how scaffolding is managed.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Construction phase plan</strong> &mdash; the PC
                      must prepare, review, and maintain the construction phase plan (CPP). This
                      plan must identify how scaffolding will be managed, including the temporary
                      works procedure, inspection regime, and the names and roles of the TWC and
                      TWS.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Coordination</strong> &mdash; the PC must
                      coordinate scaffold erection and dismantling with all other site activities.
                      This includes ensuring that the scaffold is available when needed by other
                      trades, that exclusion zones are in place during erection and dismantling, and
                      that scaffold alterations are managed through a controlled process.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Scaffold register</strong> &mdash; the PC (or
                      the TWC acting on behalf of the PC) must maintain a scaffold register listing
                      every scaffold on site, its current status, and its inspection history.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Preventing unauthorised alterations</strong>{' '}
                      &mdash; the PC must take steps to prevent anyone other than authorised,
                      competent persons from altering scaffolds. This includes site rules,
                      inductions, scaffold tags, and disciplinary procedures for unauthorised
                      interference.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Site induction and information</strong> &mdash;
                      the PC must ensure that all workers on site receive a site induction that
                      covers scaffold rules, including how to check the scaffold tag, what to do if
                      a scaffold is damaged, and who to report defects to.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-slate-400">Electricians &amp; Other Users:</strong> As an
                  electrician using a scaffold erected by a scaffolding contractor, you are a{' '}
                  <strong>worker</strong> under CDM 2015 and a <strong>user</strong> of the scaffold
                  under the Work at Height Regulations 2005. You must check the scaffold tag before
                  use, report any defects, and never alter the scaffold yourself. If the scaffold
                  does not have a valid tag or you notice missing guardrails, boards, or ties, do
                  not use it &mdash; report it to the site manager or TWC immediately.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-slate-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                <strong> Temporary Works Supervisor (TWS)</strong> for the management of all
                temporary works on a project, including scaffolding. These roles are critical to
                ensuring that the scaffold follows the correct procedure from initial design request
                ...
                <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-2">
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        Manages the{' '}
                        <strong className="text-white">entire temporary works procedure</strong> on
                        the project
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        ...
                        <strong className="text-white">approved</strong> before erection begins
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        Issues the <strong className="text-white">permit to load</strong>{' '}
                        (authorisation for the scaffold to be used) after satisfactory inspection
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        Maintains the{' '}
                        <strong className="text-white">temporary works register</strong> (which
                        includes the scaffold register)
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        Authorises controlled <strong className="text-white">dismantling</strong>{' '}
                ...
                <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-2">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        <strong className="text-white">On-site role</strong> &mdash; physically
                        present during scaffold erection and dismantling
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        ...
                        <strong className="text-white">in accordance with the design</strong>
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        Checks that{' '}
                        <strong className="text-white">materials are serviceable</strong> (no bent
                        tubes, cracked fittings, or damaged boards)
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                      <span>
                        Reports <strong className="text-white">completion</strong> to the TWC so
                        that the handover inspection can take place
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
              ...
              <p>
                The TWC and TWS roles may be held by the same person on smaller projects, but on
                larger projects they are almost always separate appointments. The TWC is usually a
                member of the principal contractor&rsquo;s management team (such as a project
                manager or site agent with temporary works training), while the TWS is typically the
                scaffolding contractor&rsquo;s site supervisor.
              </p>

              <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-slate-400">Why These Roles Matter:</strong> Without a TWC
                  and TWS, there is no formal process to ensure that scaffold designs are checked,
                  that erection follows the design, or that the scaffold is inspected and approved
                  before use. The temporary works procedure is the scaffold&rsquo;s quality
                  assurance system &mdash; it is what separates a properly managed scaffold from one
                  that has been thrown up with no oversight.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-slate-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                BS 5975:2019 sets out a step-by-step procedure for managing temporary works. Every
                scaffold on a project should follow this process, from the initial request through
                to final removal. The process ensures that nothing is missed and that each stage is
                formally signed off before the next stage begins.
              </p>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-white">
                        ...
                        register is updated to show the scaffold has been removed.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  <strong className="text-white"> serious safety failures</strong> that can have
                  fatal consequences. If you are aware that any step has been missed, report it
                  immediately to the TWC or site manager.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-slate-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                For <strong>complex, unusual, or high-risk scaffolds</strong>, the design must
                include an <strong>erection sequence drawing</strong> (or a detailed method
                statement with step-by-step build instructions). The erection sequence defines the
                order in which the scaffold is built, ensuring that the partially-completed
                structure is stable at every stage of the build.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Cantilever scaffolds</strong> &mdash; where the
                      scaffold extends beyond its base supports and the loading sequence during
                      erection is critical to stability
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Birdcage scaffolds</strong> &mdash; large
                      internal scaffolds where the temporary stability during erection depends on
                      the order in which lifts and bracing are added
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Heavily loaded scaffolds</strong> &mdash;
                      scaffolds designed to support heavy materials, plant, or equipment where the
                      sequence of tying and loading must be carefully controlled
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      ...
                      &mdash; where the consequences of a collapse during erection would be severe
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Suspended scaffolds</strong> &mdash; where the
                      rigging, counterweights, and wire-rope installation must follow a precise
                      sequence to prevent catastrophic failure
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Any non-standard configuration</strong> &mdash;
                      where the scaffold cannot be safely erected by simply working upwards from the
                      base in a standard manner
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <p>
                Once the scaffold has been erected in accordance with the approved design and the
                TWS has confirmed completion, the scaffold must be{' '}
                <strong>formally inspected and handed over</strong> before it can be used. This is
                the handover certification process.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Scaffold location</strong> &mdash; a clear
                      description or reference number so the scaffold can be identified
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Design reference</strong> &mdash; which design
                      drawing the scaffold has been built to
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Maximum permitted loads</strong> &mdash; the
                      duty class (light, general, or heavy duty) and any specific load restrictions
                      (e.g., maximum number of loaded lifts)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Date of inspection</strong> and the name and
                      signature of the competent person who carried out the inspection
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Confirmation of compliance</strong> &mdash; a
                      statement that the scaffold has been erected in accordance with the approved
                      design and is fit for its intended purpose
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Any conditions or restrictions</strong> &mdash;
                      for example, &ldquo;not to be used in wind speeds exceeding 40 mph&rdquo; or
                      &ldquo;sheeting must not be added without consulting the designer&rdquo;
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-slate-400">Scaffold Tags:</strong> On most construction
                  sites, the handover certification takes the form of a{' '}
                  <strong>scaffold tag</strong> (usually a laminated card attached to the scaffold
                  at each access point). The tag shows whether the scaffold is{' '}
                  <strong className="text-green-400">&ldquo;Safe to Use&rdquo;</strong> (green),{' '}
                  <strong className="text-red-400">&ldquo;Do Not Use&rdquo;</strong> (red), or{' '}
                  <strong className="text-yellow-400">
                    &ldquo;Under Construction / Alteration&rdquo;
                  </strong>{' '}
                  (amber/yellow). Always check the tag colour and date before stepping onto any
                  scaffold.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-slate-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The <strong>scaffold register</strong> is a comprehensive document that records
                every scaffold on the project. It is maintained by the principal contractor (or the
                TWC on the PC&rsquo;s behalf) and is a key part of both the temporary works
                procedure and the inspection regime required by the Work at Height Regulations 2005.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Unique scaffold reference</strong> &mdash; an
                      identification number or code for each scaffold on site (e.g.,
                      &ldquo;SCAF-001&rdquo;, &ldquo;Block A North Elevation&rdquo;)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Location</strong> &mdash; where the scaffold is
                      on site, described clearly enough for anyone to find it
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Type of scaffold</strong> &mdash; independent,
                      putlog, system, mobile tower, birdcage, cantilever, etc.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Design reference</strong> &mdash; the drawing
                      number or TG20 compliance sheet reference
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Scaffolding contractor</strong> &mdash; the
                      company that erected the scaffold
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Date of erection</strong> and the name of the
                      TWS who supervised the build
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Handover date and inspector</strong> &mdash;
                      when the scaffold was inspected and by whom
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Current status</strong> &mdash; in use, under
                      alteration, awaiting inspection, dismantled, etc.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Inspection history</strong> &mdash; dates of
                      all 7-day inspections, post-event inspections, and the results of each
                      inspection
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Alterations and modifications</strong> &mdash;
                      any changes made to the scaffold after the initial handover, including the
                      reason, the revised design reference, and the re-inspection date
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Date of dismantling</strong> &mdash; when the
                      scaffold was removed and the register entry closed out
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <p>
                ...
                <strong> management tool</strong> for the TWC and PC, allowing them to see at a
                glance which scaffolds are on site, which are due for inspection, and which are
                awaiting action. It is a<strong> legal record</strong> that demonstrates compliance
                with the Work at Height Regulations 2005 (Schedule 7, which requires inspection
                results to be recorded and kept on site until the work is completed, and kept by the
                person carrying out the inspection for three months after that). And it is a
                <strong> safety document</strong> that prevents scaffolds from being forgotten,
                missed during inspections, or left on site after they are no longer needed.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-3 text-sm text-white">
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="text-white font-medium">Scaffolds not recorded</p>
                      <p>
                        Small or temporary scaffolds (e.g., a single-bay tower erected for one day)
                        are sometimes not entered in the register. Every scaffold must be recorded,
                  ...
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="text-white font-medium">Inspections not recorded</p>
                      <p>
                        Inspections happen but the results are not entered in the register. An
                        unrecorded inspection is, from a legal standpoint, an inspection that did
                        not happen.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="text-white font-medium">Alterations not updated</p>
                      <p>
                        A scaffold is altered (e.g., a lift removed to allow crane access) but the
                        register still shows the original configuration. This means the next
                        inspection may be carried out against the wrong design.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="text-white font-medium">Dismantled scaffolds not closed out</p>
                      <p>
                        A scaffold is removed but the register still shows it as &ldquo;in
                        use&rdquo;. This creates confusion and can lead to resources being wasted
                        inspecting a scaffold that no longer exists.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-slate-400">Digital Scaffold Registers:</strong> Many
                  principal contractors now use digital scaffold management systems (e.g., SMART
                  Scaffolder, ScaffTag, or bespoke platforms) that allow scaffolds to be registered,
                  inspections to be recorded via tablet or smartphone, and scaffold tags to include
                  QR codes linking to the digital record. Digital systems reduce paperwork errors,
                  make it easier to track inspection due dates, and provide real-time visibility of
                  the scaffold status across the project.
                </p>
              </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  <strong className="text-white">prohibition notices</strong> (stopping scaffold use
                  until the register is brought up to date), or{' '}
                  <strong className="text-white">prosecution</strong> in serious cases. Maintaining
                  the register is not optional &mdash; it is a legal requirement and a fundamental
                  part of scaffold safety management.
                </p>
              </div>
            </div>
          </div>
