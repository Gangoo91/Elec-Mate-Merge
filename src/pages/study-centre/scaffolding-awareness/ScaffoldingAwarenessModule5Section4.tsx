...
const faqs = [
  {
    question: 'How do I find out the maximum load for the scaffold I am working on?',
    answer:
  ...
  {
    question: 'What should I do if I see someone climbing the outside face of a scaffold?',
    answer:
  ...
  {
    question: 'Can I temporarily remove a guard rail to get a large item onto the scaffold?',
    answer:
...
const quizQuestions = [
  ...
  {
    id: 2,
    question: 'Materials stored on a scaffold platform must follow which of the following rules?',
    options: [
  ...
  {
    id: 6,
    question: 'What information must be displayed on a scaffold load notice?',
    options: [
...
const ScaffoldingAwarenessModule5Section4 = () => {
  useSEO({
    title: 'Loading, Storage & Prohibited Actions | Scaffolding Awareness Module 5 Section 4',
    description:
      ...
      <article className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4 text-white">
            <p>
              Every scaffold is designed and erected to carry a specific maximum load. The European
              standard <strong>BS EN 12811-1</strong> defines six load classes for service
              scaffolds. Each class specifies the maximum uniformly distributed load (in kg/m&sup2;)
              that the scaffold platform can safely support. Knowing your scaffold&rsquo;s load
              class is essential &mdash; exceeding it can cause catastrophic failure.
            </p>
                ...
                <div className="min-w-[480px]">
                  ...
                  <div className="grid grid-cols-4 gap-px bg-white/5 rounded-t-lg overflow-hidden">
                    <div className="bg-slate-500/20 border-b border-slate-500/30 px-3 py-2.5">
                      <p className="text-slate-300 font-semibold text-xs sm:text-sm">Load Class</p>
                    </div>
                    ...
                    <div className="bg-slate-500/20 border-b border-slate-500/30 px-3 py-2.5">
                      <p className="text-slate-300 font-semibold text-xs sm:text-sm">Typical Use</p>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-4 gap-px">
                    <div className="bg-white/5 px-3 py-2.5 border-b border-white/5">
                      <p className="text-white text-xs sm:text-sm font-medium">Class 1</p>
                    </div>
                  ...
                  <div className="grid grid-cols-4 gap-px">
                    <div className="bg-white/[0.03] px-3 py-2.5 border-b border-white/5">
                      <p className="text-white text-xs sm:text-sm font-medium">Class 2</p>
                    </div>
                  ...
                  <div className="grid grid-cols-4 gap-px">
                    <div className="bg-slate-500/15 px-3 py-2.5 border-b border-white/5 border-l-2 border-l-slate-400">
                      <p className="text-slate-300 text-xs sm:text-sm font-bold">Class 3</p>
                    </div>
                    ...
                    <div className="bg-slate-500/15 px-3 py-2.5 text-center border-b border-white/5">
                      <span className="text-slate-300 text-xs sm:text-sm">1.5 kN</span>
                    </div>
                  ...
                  <div className="grid grid-cols-4 gap-px">
                    <div className="bg-white/[0.03] px-3 py-2.5 border-b border-white/5">
                      <p className="text-white text-xs sm:text-sm font-medium">Class 4</p>
                    </div>
                    <div className="bg-white/[0.03] px-3 py-2.5 text-center border-b border-white/5">
                  ...
                  <div className="grid grid-cols-4 gap-px">
                    <div className="bg-white/5 px-3 py-2.5 border-b border-white/5">
                      <p className="text-white text-xs sm:text-sm font-medium">Class 5</p>
                    </div>
                    <div className="bg-white/5 px-3 py-2.5 text-center border-b border-white/5">
                  ...
                  <div className="grid grid-cols-4 gap-px">
                    <div className="bg-white/[0.03] px-3 py-2.5 rounded-bl-lg">
                      <p className="text-white text-xs sm:text-sm font-medium">Class 6</p>
                    </div>
            ...
            <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
              ...
              <p className="text-white/80 text-sm">
                ...
                material storage. If your work requires heavier loads &mdash; for example, masonry
                with heavy stone or large quantities of stored materials &mdash; a higher-class
                scaffold must be specifically designed and erected. Never assume a scaffold can take
                more than its rated class allows.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-slate-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                The maximum bay load is the total weight that can be safely supported by one bay
                (one lift) of scaffolding. It depends on the scaffold&rsquo;s load class, the bay
                length, the board width, and the design of the supporting structure. This
                information <strong>must</strong> be displayed on the scaffold load notice at the
                point of access.
              </p>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <h3 className="text-slate-400 font-medium mb-3">Calculating Maximum Bay Load</h3>
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      &mdash; for a typical 2.4 m &times; 1.3 m bay at Class 3: 200 &times; 3.12 =
                      624 kg maximum
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>This includes people AND materials</strong> &mdash; the combined
                      weight of all operatives, tools, equipment, and stored materials on that bay
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Each lift is independent</strong> &mdash; the load on one lift does
                      not compensate for a lighter load on another; each bay at each lift must be
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>The load notice is a legal requirement</strong> &mdash; if there is no
                      load notice displayed, do not use the scaffold until one is provided
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-4 sm:gap-6">
                <div className="rounded-lg p-3 sm:p-4 bg-slate-500/10 border-l-2 border-l-slate-500/50 border border-slate-500/30">
                  ...
                  <p className="text-sm text-white/80">
                    ...
                    any materials being stored. It is easy to exceed the limit without realising,
                    especially when multiple trades are working on the same bay simultaneously.
                  </p>
                </div>
                <div className="rounded-lg p-3 sm:p-4 bg-slate-500/10 border-l-2 border-l-slate-500/50 border border-slate-500/30">
                  ...
                  <p className="text-sm text-white/80">
                    ...
                    <strong className="text-white">evacuate the scaffold immediately</strong> and
        ...
        <section className="mb-10">
          <div className="border-l-2 border-slate-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                The way a load is placed on a scaffold platform is just as important as the total
                weight. A load spread evenly across the full bay area is far safer than the same
                weight concentrated in one spot. Understanding the difference between distributed
                loads and point loads is critical to preventing scaffold platform failure.
              </p>
              ...
              <div className="grid md:grid-cols-2 gap-4 sm:gap-6">
                ...
                <div className="rounded-xl border-2 border-green-500/50 bg-green-500/5 overflow-hidden">
                  <div className="bg-green-500/20 border-b border-green-500/30 px-4 py-3 text-center">
                    <p className="text-green-400 font-bold text-base">Distributed Load (Safe)</p>
                  </div>
                ...
                <div className="rounded-xl border-2 border-red-500/50 bg-red-500/5 overflow-hidden">
                  <div className="bg-red-500/20 border-b border-red-500/30 px-4 py-3 text-center">
                    <p className="text-red-400 font-bold text-base">Point Load (Dangerous)</p>
                  </div>
                  <div className="p-4 space-y-3 text-sm">
                    <div className="flex items-start gap-3">
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  the middle of a 624 kg bay, those two boards are carrying nearly the entire load.
                  They will deflect, may crack, and could fail completely &mdash; even though the
                  total weight is within the bay&rsquo;s rated capacity. Always{' '}
        ...
        <section className="mb-10">
          <div className="border-l-2 border-slate-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                Scaffolds are working platforms, not warehouses. Materials may be stored on scaffold
                platforms, but only in accordance with strict rules designed to prevent overloading,
                maintain safe access, and reduce the risk of materials falling from height.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Distribute materials evenly</strong> across the full bay area &mdash;
                      never pile or concentrate materials in one spot
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Never exceed the maximum bay load</strong> &mdash; check the load
                      notice and calculate the combined weight of people, tools, and stored
                      materials
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Never block access or egress routes</strong> &mdash; ladders, stair
                      towers, trap doors, and walkways must remain clear at all times
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Materials must not project beyond the platform edge</strong> &mdash;
                      anything overhanging the edge can fall and injure people below
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Secure loose materials</strong> against wind &mdash; sheeting,
                      lightweight panels, and packaging can blow off the scaffold in even moderate
                      wind
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Do not lean materials against guard rails</strong> &mdash; guard rails
                      are designed to resist a person leaning on them, not to support stacked
                      materials which could push them outward
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Only store what you need for the immediate task</strong> &mdash; do
                      not use the scaffold as long-term storage; keep surplus materials at ground
                      level
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Remove all materials at the end of each shift</strong> where
                      practicable &mdash; this prevents overnight wind damage and keeps the scaffold
                      within its load limit
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  of items falling from height, and add unnecessary weight to the platform. A clean
                  scaffold is a safe scaffold. Every user is responsible for maintaining good
                  housekeeping on the platforms they use.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-slate-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                A loading bay is a specially designed section of the scaffold that provides a safe,
                designated area for hoisting materials up to the working platform. It is the{' '}
                <strong>correct method</strong> for getting heavy or bulky materials onto a scaffold
                &mdash; never lift materials over guard rails or through gaps in the platform.
              </p>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <h3 className="text-slate-400 font-medium mb-3">Loading Bay Requirements</h3>
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Must be designed into the scaffold</strong> &mdash; loading bays
                      cannot be improvised; they must be included in the scaffold design and erected
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Fitted with self-closing gates</strong> &mdash; the gate must close
                      automatically after materials have been loaded, preventing falls from the open
                      edge
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Adequate load capacity</strong> &mdash; the loading bay must be
                      designed to support the weight of the materials being hoisted, including
                      dynamic loads from the hoisting process
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Not used as a storage area</strong> &mdash; loading bays are for
                      receiving materials only; once unloaded, materials must be moved to the
                      working platform and the bay kept clear
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Gin wheels, hoists, or cranes</strong> may be used to lift materials
                      to the loading bay &mdash; the lifting equipment must be properly rated and
                      inspected
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  get materials to the platform, speak to your supervisor or the scaffold contractor
                  about providing one.{' '}
                  <strong className="text-white">Never improvise your own solution.</strong>
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                ...
                <strong>you must NEVER modify, alter, or remove any part of a scaffold</strong>.
                Only a competent scaffolder is authorised to make changes to a scaffold structure.
                Unauthorised modifications are a leading cause of scaffold-related fatalities in the
                United Kingdom.
              </p>
              ...
              <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  and the scaffold must be{' '}
                  <strong className="text-white">re-inspected and the scaffold tag updated</strong>{' '}
                  before anyone uses it again. Unauthorised modification of a scaffold can result in
                  criminal prosecution under the Work at Height Regulations 2005.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-slate-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                Overloading is one of the most common and most dangerous scaffold-related hazards.
                It can lead to individual board failure, structural collapse of the scaffold frame,
                and fatal falls or crushing injuries. Every scaffold user has a responsibility to
                monitor loading and report any concerns immediately.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Stop work immediately</strong> and move to a safe location &mdash; do
                      not wait to finish the current task
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Warn other operatives</strong> on or near the scaffold to evacuate the
                      affected area
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Report to your supervisor or scaffold coordinator</strong> immediately
                      &mdash; describe what you have observed (deflection, sounds, visible damage)
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Prevent access</strong> to the overloaded area until a competent
                      person has inspected the scaffold and confirmed it is safe to use
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Do not attempt to remove materials yourself</strong> if the scaffold
                      is showing signs of distress &mdash; the act of walking onto the platform or
              ...
              <div className="grid md:grid-cols-2 gap-4 sm:gap-6">
                <div className="rounded-lg p-3 sm:p-4 bg-red-500/10 border-l-2 border-l-red-500/50 border border-red-500/30">
                  ...
                  <div className="space-y-2 text-sm text-white/80">
                    ...
                    <div className="flex items-start gap-3">
                      <div className="w-2 h-2 rounded-full bg-red-400 mt-2 flex-shrink-0"></div>
                      <span>Fittings slipping, loosening, or failing</span>
                    </div>
                  </div>
                </div>
                <div className="rounded-lg p-3 sm:p-4 bg-slate-500/10 border-l-2 border-l-slate-500/50 border border-slate-500/30">
                  ...
                  <div className="space-y-2 text-sm text-white/80">
                    ...
                    <div className="flex items-start gap-3">
                      <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                      <span>Not checking the load notice before adding materials</span>
                    </div>
                    <div className="flex items-start gap-3">
                      <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                      <span>Using a Class 3 scaffold for Class 4/5 work</span>
                    </div>
                    <div className="flex items-start gap-3">
                      <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                      <span>Placing concentrated point loads instead of distributing</span>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-slate-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                As a scaffold user &mdash; whether you are an electrician, plumber, painter,
                bricklayer, or any other trade &mdash; you have specific responsibilities every time
                you step onto a scaffold. These responsibilities exist to protect you, your
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Check the scaffold tag before use</strong> &mdash; the tag should
                      confirm the scaffold has been inspected and is safe to use; a red or &ldquo;do
                      not use&rdquo; tag means the scaffold is incomplete or unsafe
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Carry out a visual inspection before each use</strong> &mdash; look
                      for missing boards, guard rails, toe boards, damaged or corroded components,
                      and any signs of instability
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Check the load notice</strong> &mdash; know the maximum bay load and
                      ensure your work will not exceed it
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Use the correct access and egress points</strong> &mdash; internal
                      ladders, stair towers, or hoists only; never climb the scaffold face
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Maintain three points of contact</strong> when climbing ladders
                      &mdash; two hands and one foot, or two feet and one hand at all times
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Keep platforms clean and tidy</strong> &mdash; remove debris, offcuts,
                      packaging, and spilt materials promptly
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Report defects immediately</strong> &mdash; any missing, damaged, or
                      modified components must be reported to your supervisor or scaffold
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Never modify the scaffold</strong> &mdash; do not remove, move, or
                      alter any scaffold component for any reason
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Do not overload the platform</strong> &mdash; distribute materials
                      evenly and keep within the rated bay load at all times
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-slate-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Wear appropriate PPE</strong> &mdash; hard hat, hi-vis vest, safety
                      boots with ankle support, and any additional PPE specified for your task
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-slate-500/10 border-2 border-slate-500/40 p-5 rounded-lg">
                ...
                <p className="text-white text-sm leading-relaxed">
                  The scaffold contractor is responsible for providing a safe scaffold. Your
                  employer is responsible for ensuring you are trained and competent to use it. But
                  once you step onto the scaffold,{' '}
                  <strong>you are responsible for using it safely</strong>. If something does not
                  look right, does not feel right, or does not match what you were told in your
                  briefing &mdash; <strong>stop, get off the scaffold, and report it</strong>. No
                  task is so urgent that it justifies working on an unsafe scaffold. Every fatality
                  investigation starts with someone who noticed something wrong but carried on
                  regardless.
                </p>
              </div>
            </div>
        ...
        {/* ─── Quiz ─── */}
        <div className="mt-12">
          <Quiz title="Loading, Storage & Prohibited Actions Quiz" questions={quizQuestions} />
        </div>
