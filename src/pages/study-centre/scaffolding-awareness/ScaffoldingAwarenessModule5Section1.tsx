...
const quickCheckQuestions = [
  {
    ...
    question: 'What THREE checks should you carry out before starting work on a scaffold?',
    options: [
...
const faqs = [
  ...
  {
    question: 'Am I allowed to move or remove scaffold boards to create a materials hoist opening?',
    answer:
  ...
  {
    question: 'What is the safest way to get tools and materials up to a scaffold platform?',
    answer:
...
export default function ScaffoldingAwarenessModule5Section1() {
  useSEO({
    title: 'Safe Working on Scaffolds | Scaffolding Awareness Module 5.1',
    description:
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-slate-500/5 border-l-2 border-slate-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Before you start:</strong> Check tag, visual inspection, confirm access
              </li>
              <li>
                <strong>3 points of contact:</strong> Always when climbing or descending ladders
              </li>
              <li>
                <strong>Tool lanyards:</strong> Attach every tool to prevent dropped-object injuries
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-slate-500/5 border-l-2 border-slate-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Housekeeping:</strong> Keep platforms clear of debris, waste, and loose
                materials
              </li>
              <li>
                <strong>No overreaching:</strong> Reposition the scaffold instead of leaning out
              </li>
              <li>
                <strong>Coordination:</strong> Communicate with all teams sharing the scaffold
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-slate-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Every person who is about to work on a scaffold must carry out{' '}
                <strong>three essential checks</strong> before stepping onto the platform. These
                checks take only a few minutes but can prevent catastrophic falls, structural
                failures, and serious injuries.
              </p>
                  ...
                  <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-4">
                    ...
                    <ul className="text-sm text-white space-y-1 ml-11">
                      <li className="flex items-start gap-2">
                        ...
                        <span>
                          Confirm the tag is <strong className="text-white">green</strong> (safe to
                          use)
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                        <span>
                          Read the <strong className="text-white">date of last inspection</strong>{' '}
                          &mdash; it must be within 7 days
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                        <span>
                          Check for any <strong className="text-white">written restrictions</strong>{' '}
                          on the tag
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                        <span>
                          If the tag is <strong className="text-white">yellow</strong>, read the
                          restrictions carefully and comply with them
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                        <span>
                          If the tag is <strong className="text-white">red or missing</strong>{' '}
                          &mdash; do NOT use the scaffold
                        </span>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
                    ...
                    <ul className="text-sm text-white space-y-1 ml-11">
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                        <span>
                          Platform boards are <strong className="text-white">fully boarded</strong>{' '}
                          with no gaps exceeding 25 mm
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                        <span>
                          <strong className="text-white">Guardrails</strong> are in place at the
                          correct height (minimum 950 mm)
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                        <span>
                          <strong className="text-white">Toe boards</strong> are fitted (minimum 150
                          mm high)
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                        <span>
                          <strong className="text-white">Intermediate guardrails</strong> or brick
                      ...
                      <li className="flex items-start gap-2">
                        ...
                        <span>
                          ...
                          <strong className="text-white">
                            damage, corrosion, or missing components
                          </strong>
                        </span>
                      </li>
                    </ul>
                  ...
                  <div className="bg-purple-500/10 border border-purple-500/30 rounded-lg p-4">
                    ...
                    <ul className="text-sm text-white space-y-1 ml-11">
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                        <span>
                          <strong className="text-white">Internal ladders</strong> are in position
                      ...
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                        <span>
                          Ladder <strong className="text-white">trap doors</strong> open and close
                          freely
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        ...
                        <span>
                          Access route is{' '}
                          <strong className="text-white">clear of obstructions</strong> (no stored
                          materials blocking the way)
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                        <span>
                          You can <strong className="text-white">reach and leave</strong> the
                          platform safely in an emergency
                        </span>
                      </li>
                    </ul>
                  </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  &mdash; they protect your life. If anything looks wrong or feels wrong, do not use
                  the scaffold. Report it immediately.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-slate-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Getting on and off a scaffold safely is just as important as working on it. A
                significant proportion of scaffold-related falls occur during{' '}
                <strong>access and egress</strong> &mdash; climbing up, climbing down, and stepping
                onto or off platforms.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      Internal ladders are the{' '}
                      <strong className="text-white">preferred method</strong> of access on most
                      scaffolds
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      They are fitted{' '}
                      <strong className="text-white">within the scaffold structure</strong> and pass
                      through trap doors in each platform
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      The ladder must be <strong className="text-white">securely fixed</strong> and
                      must not move, rock, or slide during use
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      Trap doors must{' '}
                      <strong className="text-white">close after you pass through</strong> to
                      maintain the integrity of the platform above or below
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      External ladders must be{' '}
                      <strong className="text-white">tied or clamped</strong> to the scaffold at the
                      top and bottom
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      They must extend at least{' '}
                      <strong className="text-white">1 metre (5 rungs) above</strong> the
                      stepping-off point
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      <strong className="text-white">75 degrees</strong> (a 4:1 ratio of height to
                      base)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      The base must rest on a{' '}
                      <strong className="text-white">firm, level surface</strong> &mdash; never on
                      loose material, mud, or uneven ground
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      Stair towers provide the{' '}
                      <strong className="text-white">safest form of access</strong> and are
                      preferred on larger scaffolds
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      They allow you to <strong className="text-white">face forwards</strong> while
                      ascending and descending, rather than backwards as on a ladder
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      Stairways have <strong className="text-white">handrails</strong> on both sides
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      They are easier to use when carrying{' '}
                      <strong className="text-white">small items</strong>, though a gin wheel or
                      hoist is still preferred for heavy loads
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  <strong className="text-white">leading causes of fatal falls</strong> from
                  scaffolds. If the designated access has been removed or is unsafe, do not use the
                  scaffold. Report it and wait for a competent scaffolder to reinstate the correct
                  access.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-slate-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The three-points-of-contact rule is one of the most important safety techniques you
                will use when working on scaffolds. It applies every time you climb or descend a
                ladder, and it is <strong>simple, effective, and non-negotiable</strong>.
              </p>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      <strong className="text-white">two hands and one foot</strong> or{' '}
                      <strong className="text-white">two feet and one hand</strong> in contact with
                      the ladder
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      Move <strong className="text-white">one limb at a time</strong> &mdash; the
                      other three remain securely in place
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Face the ladder</strong> at all times when
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Grip the rungs</strong>, not the side rails
                      (stiles), for a more secure hold
                    </span>
                  </li>
                </ul>
              </div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      You{' '}
                      <strong className="text-white">
                        cannot carry tools, materials, or equipment
                      </strong>{' '}
                      in your hands while climbing
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      Tools must be raised and lowered using a{' '}
                      <strong className="text-white">
                        gin wheel, tool belt, or bucket and rope
                      </strong>
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Never rush</strong> up or down a ladder &mdash;
                      take your time and place each foot deliberately
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      If your boots are <strong className="text-white">wet, muddy, or icy</strong>,
                      clean them before climbing to prevent slipping
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-slate-400">Why It Matters:</strong> If one point of
                  contact slips, the other two still support you and give you a chance to recover.
                  With only two points of contact, a single slip means you have nothing left to hold
                  onto. The three-points-of-contact rule is your primary defence against falling
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-slate-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                A cluttered scaffold platform is a dangerous scaffold platform. Poor housekeeping is
                a contributing factor in a large proportion of scaffold-related incidents, including
              ...
              <div className="bg-slate-500/10 border-2 border-slate-500/30 rounded-xl p-5 sm:p-6">
                <div className="flex items-center gap-3 mb-4">
                  <ShieldCheck className="h-5 w-5 text-slate-400" />
                  <p className="text-base font-semibold text-white">Platform Housekeeping Guide</p>
                </div>
                  ...
                  <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-4">
                    ...
                    <ul className="text-sm text-white space-y-1.5">
                      <li className="flex items-start gap-2">
                        ...
                        <span>
                          Clear all debris, offcuts, and waste{' '}
                          <strong className="text-white">at least twice per shift</strong>
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                        <span>
                          Stack materials{' '}
                          <strong className="text-white">neatly and securely</strong> away from the
                          platform edge
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                        <span>
                          Use <strong className="text-white">waste bags or skips</strong> to collect
                          and remove rubbish
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                        <span>
                          Keep <strong className="text-white">walkways and access points</strong>{' '}
                      ...
                      <li className="flex items-start gap-2">
                        <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                        <span>
                          Lower unused materials to the ground using a{' '}
                          <strong className="text-white">gin wheel or hoist</strong>
                        </span>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-4">
                    ...
                    <ul className="text-sm text-white space-y-1.5">
                      <li className="flex items-start gap-2">
                        ...
                        <span>
                          Leave{' '}
                          <strong className="text-white">loose materials near the edge</strong>{' '}
                          &mdash; they can blow or fall off
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <AlertTriangle className="h-4 w-4 text-red-400 mt-0.5 flex-shrink-0" />
                        <span>
                          Allow <strong className="text-white">water, ice, or mud</strong> to
                      ...
                      <li className="flex items-start gap-2">
                        <AlertTriangle className="h-4 w-4 text-red-400 mt-0.5 flex-shrink-0" />
                        <span>
                          Stack materials so high they{' '}
                          <strong className="text-white">obstruct guardrails</strong> or block
                          sightlines
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        ...
                        <span>
                          Throw{' '}
                          <strong className="text-white">waste or debris off the scaffold</strong>{' '}
                          &mdash; use proper lowering methods
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <AlertTriangle className="h-4 w-4 text-red-400 mt-0.5 flex-shrink-0" />
                        <span>
                          Leave <strong className="text-white">trailing cables or hoses</strong>{' '}
                          across the platform as trip hazards
                        </span>
                      </li>
                    </ul>
                  </div>
              ...
              <p>
                Good housekeeping is not just about comfort or appearance. Debris on a platform
                creates <strong>trip hazards</strong> that can cause falls within the platform or
                against guardrails. Materials left near the edge can be knocked off by wind or
                vibration and become <strong>falling objects</strong>. Excessive materials on the
                platform can also <strong>overload the scaffold</strong> beyond its designed
                capacity.
              </p>

              <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-slate-400">Best Practice:</strong> Adopt a &ldquo;clean as
                  you go&rdquo; approach. At the end of every task, take two minutes to clear your
                  immediate work area. At the end of every shift, carry out a thorough tidy-up and
                  remove all waste from the platform. Leave the scaffold in a condition you would be
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-slate-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Overreaching from a scaffold platform is one of the most common causes of falls from
                height in the UK construction industry. It happens when a worker leans, stretches,
                or extends their body <strong>beyond the safe working area</strong> of the platform
                to access work that is just out of comfortable reach.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      It shifts your <strong className="text-white">centre of gravity</strong>{' '}
                      towards or beyond the edge of the platform
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      A guardrail at 950 mm is roughly{' '}
                      <strong className="text-white">waist height</strong> &mdash; it is easy to tip
                      over it if leaning
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      Overreaching while using <strong className="text-white">power tools</strong>{' '}
                      is especially dangerous because the tool&rsquo;s weight and vibration add to
                      the imbalance
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Reposition yourself</strong> so the work is
                      directly in front of you at a comfortable arm&rsquo;s length
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      ...
                      <strong className="text-white">scaffold be moved or extended</strong> by a
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Keep your belt buckle</strong> (navel) within
                      the footprint of the platform at all times &mdash; this is a useful
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Never stand on{' '}
                      <strong className="text-white">
                        guardrails, toe boards, or intermediate rails
                      </strong>{' '}
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  the scaffold or walking to a different bay takes a few minutes. Falling from the
                  scaffold takes a fraction of a second and can change your life forever. The few
                  minutes it takes to reposition are always worth it.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-slate-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                A scaffold platform is a <strong>purpose-designed working surface</strong>. It is
                engineered to support specific loads, provide a safe working area at height, and
                integrate with the guardrail and access systems. Using it correctly is fundamental
                to scaffold safety.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Walk, do not run</strong> &mdash; running on a
                      scaffold platform can cause you to trip over obstacles, lose your footing, or
                      create excessive dynamic loads
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Stay within the guardrailed area</strong> at
                      all times &mdash; never lean over, sit on, or stand on the guardrails
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Do not jump</strong> between platforms, between
                      bays, or from the platform to adjacent structures
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">
                        Do not use ladders, stepladders, or hop-ups
                      </strong>{' '}
                      on the platform to gain extra height
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Respect the maximum load</strong> displayed on
                      the scaffold tag &mdash; never exceed it
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      The platform must be <strong className="text-white">fully boarded</strong>{' '}
                      &mdash; gaps between boards must not exceed 25 mm
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      Boards must <strong className="text-white">not overhang</strong> the
                      supporting ledger by more than 150 mm (four times the board thickness is the
                      general rule)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Boards that are{' '}
                      <strong className="text-white">cracked, split, warped, or rotten</strong> must
                      be replaced immediately by a competent scaffolder
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Never remove boards</strong> yourself &mdash;
                      this is the scaffolder&rsquo;s job
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-slate-400">Key Point:</strong> The scaffold platform is a
                  controlled working environment. It has been designed, erected, and inspected to
                  provide a safe place to work. Altering it, overloading it, or misusing it
                  undermines every safety measure that has been put in place. Treat the platform
                  with the same respect you would give to any other piece of safety-critical
                  equipment.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-slate-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Dropped tools are a <strong>significant hazard on every scaffold</strong>. Even a
                small tool falling from a relatively low height can cause serious or fatal injuries
                to people below. Tool lanyards are a simple, low-cost control measure that every
                scaffold user should employ.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      A <strong className="text-white">500 g hammer</strong> dropped from 10 metres
                      strikes the ground at approximately{' '}
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      A <strong className="text-white">1 kg spanner</strong> dropped from 6 metres
                      hits at approximately <strong className="text-white">39 km/h</strong> &mdash;
                      enough force to be fatal
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      Even a <strong className="text-white">small bolt or fitting</strong> can cause
                      serious head injuries when dropped from scaffold height
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      ...
                      <strong className="text-white">not designed to absorb the full impact</strong>{' '}
                      of a heavy falling tool
                    </span>
                  </li>
                </ul>
              </div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      <strong className="text-white">tool&rsquo;s lanyard point</strong> (most
                      modern hand tools have a dedicated hole or ring)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      ...
                      <strong className="text-white">
                        wrist strap, tool belt, or a secure anchor point
                      </strong>{' '}
                      on the scaffold
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Check the{' '}
                      <strong className="text-white">lanyard&rsquo;s weight rating</strong> &mdash;
                      it must be suitable for the weight of the tool
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      ...
                      <strong className="text-white">fraying, cuts, or damage</strong> before each
                      use and replace if defective
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      When not in active use, place tools in a{' '}
                      <strong className="text-white">secure tool bag or bucket</strong> on the
                      platform &mdash; never leave them loose near the edge
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Toe boards</strong> (minimum 150 mm) prevent
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Brick guards</strong> or debris netting catch
                      falling materials and small items
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Fans (scaffold protection canopies)</strong>{' '}
                      deflect falling objects away from pedestrians and lower-level workers
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Exclusion zones</strong> at ground level
                      beneath the scaffold prevent pedestrians from entering the drop zone
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-slate-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Scaffolds are shared working environments. It is common for multiple trades &mdash;
                electricians, plumbers, bricklayers, painters &mdash; to be working on the same
                scaffold at different levels or in adjacent bays at the same time. This creates{' '}
                <strong>coordination requirements</strong> that every scaffold user must understand
                and follow.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Communicate</strong> before starting work
                      &mdash; find out who else is on the scaffold, where they are working, and what
                      they are doing
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Never work directly above another team</strong>{' '}
                      unless specific falling-object protection (fans, netting, exclusion) is in
                      place
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Warn others</strong> before moving heavy
                      materials, using power tools that generate vibration, or carrying out any
                      activity that could affect people on other levels
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Avoid overcrowding</strong> &mdash; too many
                      people on one platform can exceed the maximum load and creates congestion
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Report conflicts</strong> to your supervisor
                      &mdash; if two activities cannot be carried out safely at the same time, one
                      must be rescheduled
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      Never store <strong className="text-white">materials, tools, or waste</strong>{' '}
                      on or next to ladders, stair landings, or trap door openings
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      Do not route <strong className="text-white">cables, hoses, or leads</strong>{' '}
                      across access routes where they could trip someone
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      In an <strong className="text-white">emergency evacuation</strong>, a blocked
                      access point could prevent people from leaving the scaffold quickly and safely
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      If you find an access point{' '}
                      <strong className="text-white">
                        blocked by another trade&rsquo;s materials
                      </strong>
                      , do not move them yourself unless it is safe to do so &mdash; ask the other
                      team to clear them
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  missing ladders, or materials stored on stair landings can turn a controlled
                  evacuation into a fatal delay. Keeping access points clear is not optional &mdash;
                  it is a <strong className="text-white">life-safety requirement</strong>.
                </p>
              </div>

              <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-slate-400">Shared Responsibility:</strong> Every person
                  who uses a scaffold has a responsibility to maintain it in a safe condition. This
                  is not just the scaffolder&rsquo;s job or the site manager&rsquo;s job &mdash; it
                  is everyone&rsquo;s job. If you see something wrong, report it. If you can fix it
                  safely (such as clearing your own debris or picking up a tool someone has left
                  behind), do so. The scaffold is only as safe as the behaviour of the people using
                  it.
                </p>
              </div>
            </div>
