...
const faqs = [
  ...
  {
    question:
      'How long should scaffold inspection records be retained on a large, multi-phase construction project?',
    answer:
...
export default function ScaffoldingAwarenessModule4Section4() {
  useSEO({
    title: 'Inspection Records & Reporting | Scaffolding Awareness Module 4.4',
    description:
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-slate-500/5 border-l-2 border-slate-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Schedule 7:</strong> Prescribes exact content of inspection reports
              </li>
              <li>
                <strong>Report within:</strong> 24 hours of the inspection
              </li>
              <li>
                <strong>Retain for:</strong> Next inspection or 3 months (whichever is later)
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-slate-500/5 border-l-2 border-slate-500/50">
            <p className="text-slate-400/90 text-base font-medium mb-2">Key Facts</p>
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>HSE access:</strong> Records must be producible on demand
              </li>
              <li>
                <strong>Scaffold register:</strong> Track every scaffold on site
              </li>
              <li>
                <strong>Digital records:</strong> Fully accepted if they meet Schedule&nbsp;7
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-slate-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The <strong>Work at Height Regulations 2005, Schedule&nbsp;7</strong> sets out the
                prescribed content that every scaffold inspection report must include. A vague
                statement such as &ldquo;scaffold checked &mdash; OK&rdquo; does not satisfy the
                legal requirement. The report must be a detailed, structured record providing
                evidence that a competent person carried out a thorough inspection and documented
                what was found.
              </p>

              <p>
                The purpose of these requirements is to create a{' '}
                <strong>defensible audit trail</strong>. If an incident occurs, the inspection
                report is among the first documents the HSE will request. It must demonstrate what
                was inspected, what condition was found, what defects were identified, and what
                action was taken.
              </p>
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      &mdash; This is the employer, principal contractor, or site occupier who has
                      the duty to ensure inspections take place. Not the scaffolding subcontractor
                      (unless they are the duty holder).
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      ...
                      &mdash; Sufficient to identify the specific scaffold. Include the building or
                      area reference, scaffold type (independent tied, putlog, birdcage, system
                      scaffold), height, number of lifts, number of bays, and any distinguishing
                      features.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Date and time of the inspection</strong>{' '}
                      &mdash; The actual date the inspection was carried out, not &ldquo;week
                      commencing&rdquo; or an approximate date. The time should also be recorded,
                      particularly where multiple inspections occur on the same day.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Condition found</strong> &mdash; A description
                      of the general condition of the scaffold. This should confirm what was
                      examined (foundations, standards, ledgers, transoms, bracing, ties, platforms,
                      guardrails, toe boards, access) and the overall condition observed.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Details of any defects identified</strong>{' '}
                      &mdash; Specific defects must be described in sufficient detail to identify
                      them. &ldquo;Missing guardrail&rdquo; is not sufficient &mdash; the report
                      should state &ldquo;guardrail missing from bay 3, second lift, south
                      elevation&rdquo; so the defect can be located and rectified.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Actions taken as a result of findings</strong>{' '}
                      &mdash; What was done to address each defect. For example: &ldquo;replacement
                      guardrail fitted from stock&rdquo;, &ldquo;scaffold red-tagged and taken out
                      of service pending repair&rdquo;, or &ldquo;loose base plate re-seated on sole
                      board&rdquo;.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      &mdash; The person who carried out the inspection must be identifiable.
                      Include their name, job title or position, their employer, and a signature
                      (handwritten or electronic). An anonymous or unsigned report has no evidential
                      value.
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-slate-400">Remember:</strong> The written report must be
                  completed <strong>within 24 hours</strong> of the inspection being carried out.
                  Ideally, it should be written at the scaffold immediately after the inspection to
                  ensure accuracy. Reports written from memory days later are unreliable and may not
                  withstand scrutiny.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-slate-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The Work at Height Regulations specify how long scaffold inspection records must be
                retained. The rule is straightforward but frequently misunderstood: records must be
                kept{' '}
                <strong>
                  until the next inspection of the scaffold or for 3 months from the date of the
              ...
              <p>
                In practice, this means that for a scaffold inspected every 7&nbsp;days, the 3-month
                rule almost always applies because the next inspection (7&nbsp;days later) is much
                earlier than 3&nbsp;months. The record from the 7-day inspection must therefore be
                retained for a minimum of 3&nbsp;months regardless of whether later inspections have
                taken place.
              </p>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-3">Statutory Retention Periods</p>
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-[1fr,auto] gap-2 text-sm">
                    <span className="text-white">Scaffold register / equipment log</span>
                    <span className="text-slate-400 font-semibold">
                  ...
                  <hr className="border-white/5" />
                  <div className="grid grid-cols-[1fr,auto] gap-2 text-sm">
                    <span className="text-white">Risk assessments for scaffold work</span>
                    <span className="text-slate-400 font-semibold">
                  ...
                  <hr className="border-white/5" />
                  <div className="grid grid-cols-[1fr,auto] gap-2 text-sm">
                    <span className="text-white">RIDDOR reports (scaffold-related incidents)</span>
                    <span className="text-slate-400 font-semibold">Minimum 3 years</span>
                  </div>
                  <hr className="border-white/5" />
                  <div className="grid grid-cols-[1fr,auto] gap-2 text-sm">
                    <span className="text-white">Training records (scaffolding competence)</span>
                    <span className="text-slate-400 font-semibold">
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Full project duration</strong> &mdash; Retain
                      all scaffold inspection records until the project is complete and the scaffold
                      has been dismantled
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">3&ndash;6 years post-project</strong> &mdash;
                      Personal injury claims under the Limitation Act 1980 can be brought up to 3
                      years after the date of injury; retaining records beyond this provides
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Company policy</strong> &mdash; Many principal
                      contractors require all inspection records to be retained for 6 years as
                      standard, regardless of the statutory minimum
                    </span>
                  </li>
                </ul>
              </div>
            ...
            <div className="bg-[#111] border-2 border-slate-500/40 rounded-xl p-4 sm:p-6 overflow-x-auto">
              ...
              <div className="relative min-w-[320px]">
                ...
                <div className="mt-5 flex items-center justify-center gap-2">
                  ...
                  <span className="text-[9px] text-amber-400 font-semibold whitespace-nowrap">
                    17 Jan (next inspection) vs 10 Apr (3 months) &rarr; 10 Apr is later &rarr; keep
                    until 10 Apr minimum
                  </span>
                  <div className="h-[1px] flex-1 max-w-[80px] bg-amber-400/40" />
                </div>
              </div>
              ...
              <div className="mt-4 bg-slate-500/10 border border-slate-500/30 rounded-lg p-3 text-center">
                <p className="text-[10px] sm:text-xs text-slate-300 font-medium">
                  The 3-month retention period almost always applies because the next 7-day
                  inspection is always earlier than 3 months
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="border-l-2 border-slate-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                It is not sufficient simply to create and retain inspection records. The regulations
                require that records are <strong>accessible and available</strong> to the people who
                need them, when they need them. There are several groups who have a right or a need
                to see scaffold inspection reports.
              </p>
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      &mdash; Must receive a copy of the report within 24 hours of the inspection.
                      This enables them to review findings, monitor compliance, and take action on
                      defects identified.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Site management</strong> &mdash; The site
                      manager or construction manager needs access to inspection records to manage
                      scaffolding across the project, prioritise remedial works, and ensure
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Scaffold users</strong> &mdash; While
                      individual scaffold users do not receive copies of the report, the current
                      inspection status should be visible at the scaffold via the tag system (green,
                      yellow, or red). A copy of the most recent report should be available at the
                      scaffold base or in the site office for anyone who needs to check.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">HSE inspectors</strong> &mdash; An HSE
                      inspector can request scaffold inspection records at any time during a site
                      visit. Records must be producible promptly &mdash; within minutes, not hours
                      or days. Inability to produce records may result in enforcement action.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Trade union safety representatives</strong>{' '}
                      &mdash; Under the Safety Representatives and Safety Committees Regulations
                      1977, appointed trade union safety representatives have the right to inspect
                      documents relating to workplace health and safety, which includes scaffold
                      inspection records.
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">At the scaffold</strong> &mdash; Keep the most
                      recent inspection report at the scaffold base in a weatherproof wallet or
                      document holder attached to the scaffold
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Site office file</strong> &mdash; Maintain a
                      central file of all scaffold inspection records, organised by scaffold
                      identifier and date
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Digital backup</strong> &mdash; If using paper
                      forms, scan or photograph records and store them digitally as a safeguard
                      against loss or damage from site conditions
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-slate-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                A <strong>scaffold register</strong> (also called a scaffold log) is a central
                document that lists every scaffold on site and tracks its current status. While the
                WAH Regs do not explicitly require a separate register, it is considered{' '}
                <strong>industry best practice</strong> and is often mandated by principal
                contractors as a condition of working on their sites. On large sites with dozens or
                even hundreds of scaffolds, a register is the only practical way to ensure nothing
                is missed.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Unique scaffold identifier</strong> &mdash; A
                      tag number, reference number, or colour code that uniquely identifies each
                      scaffold on site
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Location</strong> &mdash; Building, elevation,
                      floor, grid reference, or other positional reference
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Scaffold type and configuration</strong>{' '}
                      &mdash; Independent, putlog, birdcage, system scaffold; height, number of
                      lifts, number of bays, loading class
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Date of erection</strong> &mdash; When the
                      scaffold was erected and who erected it (scaffolding contractor name)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Handover date</strong> &mdash; The date the
                      scaffold was formally handed over to the user by the scaffolding contractor,
                      confirming it was complete and safe
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Last inspection date</strong> &mdash; The date
                      of the most recent formal inspection
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Next inspection due</strong> &mdash; The date
                      by which the next 7-day inspection must be completed
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Current tag status</strong> &mdash; Green
                      (safe), yellow (restricted), or red (do not use)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Responsible person</strong> &mdash; The named
                      person or contractor responsible for the scaffold
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-slate-400">Tip:</strong> On large sites, use a
                  colour-coded status system in the register:{' '}
                  ...
                  red = overdue or out of service. This provides an at-a-glance overview of
                  compliance across the whole site.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="border-l-2 border-slate-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The competent person who inspects the scaffold is responsible for producing the
                inspection report, but the{' '}
                <strong>information must flow to site management promptly</strong> so that decisions
                can be made and action can be taken on any defects identified.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Immediate verbal report</strong> &mdash; If any
                      serious defect is found that makes the scaffold unsafe, the inspector must
                      immediately notify the site manager or principal contractor&rsquo;s
                      representative. The scaffold must be taken out of service (red-tagged) without
                      delay.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Written report within 24 hours</strong> &mdash;
                      The formal written report must be completed and provided to the duty holder
                      within 24 hours of the inspection. This applies whether the inspection found
                      defects or not.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Defect tracking</strong> &mdash; Defects
                      identified in inspection reports should be entered into a defect tracking
                      system (which may be part of the scaffold register) to ensure they are
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Management review</strong> &mdash; Site
                      management should review all scaffold inspection reports regularly (at least
                      weekly) to identify trends, recurring defects, and scaffolds that may need
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  scaffold must be{' '}
                  <strong className="text-white">taken out of service immediately</strong> and
                  red-tagged. The inspector must not wait until the written report is completed to
                  take this action. Verbal notification to the site manager must happen at the time
                  the defect is found. Work from the scaffold must stop until the defect is
                  rectified and the scaffold is re-inspected and cleared for use.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-slate-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                <strong>broad powers to inspect, investigate, and enforce</strong> health and safety
                legislation on construction sites, including the Work at Height Regulations.
                Scaffold inspection records are a key part of any HSE site visit or investigation.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Right of access</strong> &mdash; HSE inspectors
                      can enter any workplace at any reasonable time without prior notice. They can
                      request to see scaffold inspection records, scaffold registers, risk
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      &mdash; Under Section 20 of the Health and Safety at Work etc. Act 1974, an
                      inspector can require any person to produce any document which they have power
                      to examine, and to take copies.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Improvement Notices</strong> &mdash; If
                      inspection records are incomplete, inadequate, or not being maintained, the
                      inspector can issue an Improvement Notice requiring the duty holder to put the
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Prohibition Notices</strong> &mdash; If the
                      inspector believes there is a risk of serious personal injury and scaffolds
                      are being used without adequate inspection or records, they can issue a
                      Prohibition Notice stopping all work from the scaffold immediately.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Prosecution</strong> &mdash; Persistent or
                      serious failures to inspect scaffolds and maintain records can lead to
                      prosecution under the Health and Safety at Work etc. Act 1974 and/or the Work
                      at Height Regulations 2005. Penalties include unlimited fines and, in the most
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  , this is treated as a failure to comply with the regulations. The duty holder
                  cannot claim that inspections were carried out if there is no written evidence. In
                  the event of an accident, the absence of records is treated as strong evidence
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      The scaffolding contractor&rsquo;s erection records and handover documentation
                    </span>
                  </li>
                </ul>
              </div>
          ...
          <div className="border-l-2 border-slate-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                <strong>&ldquo;written report&rdquo;</strong> but do not prescribe paper. Digital
                inspection records created using specialist software or apps are{' '}
                <strong>fully acceptable</strong> provided they contain all the information
                prescribed by Schedule&nbsp;7 and can be{' '}
                <strong>produced as a hard copy on demand</strong>.
              </p>

              <p>
                Digital record-keeping is becoming increasingly common across the construction
                industry. Several purpose-built platforms exist for scaffold inspection records, and
                many principal contractors now require or encourage digital reporting.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Automatic backup</strong> &mdash; Cloud-based
                      storage means records are backed up automatically. Paper records at the
                      scaffold base can be damaged by rain, wind, or general site conditions;
                      digital records are protected against this.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Photo evidence</strong> &mdash; Digital apps
                      allow photographs of defects, scaffold configuration, and site conditions to
                      be attached directly to the inspection record. This provides powerful visual
                      evidence that is not available with paper forms.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">GPS and time-stamping</strong> &mdash; Digital
                      entries are automatically tagged with the geographic location and exact time
                      of the inspection. This confirms where and when the inspection was carried
                      out, which cannot be retrospectively altered.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Structured checklists</strong> &mdash; Apps
                      guide the inspector through a structured checklist covering all required
                      inspection points, reducing the risk of items being missed or fields left
                      blank.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Instant sharing</strong> &mdash; Completed
                      reports can be shared instantly with site management, the principal
                      contractor, and the duty holder via email or a shared platform. No need to
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Automated reminders</strong> &mdash; The system
                      can alert the inspector and site management when the next 7-day inspection is
                      due, reducing the risk of overdue inspections.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Report generation</strong> &mdash; Digital
                      platforms can generate PDF reports that meet Schedule&nbsp;7 requirements and
                      can be printed as hard copies if required by an HSE inspector.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">ScaffTag Inspection Manager</strong> &mdash;
                      Purpose-built scaffold inspection app linked to the ScaffTag scaffold tagging
                      system
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">SMART Scaffolder</strong> &mdash; Digital
                      scaffold management platform covering design, inspection, and handover
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">iAuditor / SafetyCulture</strong> &mdash;
                      General inspection platform that can be configured with scaffold-specific
                      templates
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Bespoke company systems</strong> &mdash; Large
                      contractors often develop or commission their own digital inspection platforms
                      integrated with site management software
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-slate-400">Important:</strong> Digital records must still
                  contain <strong>all the prescribed Schedule&nbsp;7 information</strong>. Using a
                  digital app does not reduce the content requirements. The app must also work
                  offline on site (with synchronisation when connectivity is available) because many
                  construction sites have poor or no mobile data coverage.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-slate-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Even with the best systems in place, record-keeping can fall short if practical
                mistakes are made. The following guidance addresses the most common issues
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Vague findings</strong> &mdash; &ldquo;Scaffold
                      OK&rdquo; or &ldquo;No issues&rdquo; without confirming what was actually
                      checked. Even a clean inspection should confirm that foundations, standards,
                      ledgers, bracing, ties, platforms, guardrails, and access were all examined
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Missing or approximate dates</strong> &mdash;
                      &ldquo;Week commencing 6 January&rdquo; does not satisfy the requirement for
                      the actual date of inspection. The report must state the specific date and
                      time.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">No inspector identification</strong> &mdash; An
                      unsigned or anonymous report has no evidential value. The report must identify
                      who carried out the inspection, their position, and their employer.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Retrospective completion</strong> &mdash;
                      Writing up inspection reports from memory days later introduces errors and
                      omissions. Reports should be completed at the scaffold or immediately
                      afterwards.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Actions not recorded</strong> &mdash; Finding a
                      defect but not recording the corrective action suggests the defect was
                      identified and then ignored. This is potentially more damaging than not
                      inspecting at all, because it shows the hazard was known about.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Choose a recording method</strong> (paper or
                      digital) and standardise it across the entire site &mdash; do not mix methods
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-0.5 w-5 h-5 rounded-full bg-slate-500/20 border border-slate-500/40 flex items-center justify-center flex-shrink-0 text-[10px] font-bold text-slate-400">
                    ...
                    <span>
                      <strong className="text-white">Create a scaffold register</strong> before the
                      first scaffold arrives on site, and assign unique identifiers
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-0.5 w-5 h-5 rounded-full bg-slate-500/20 border border-slate-500/40 flex items-center justify-center flex-shrink-0 text-[10px] font-bold text-slate-400">
                    ...
                    <span>
                      <strong className="text-white">Train all inspectors</strong> in how to
                      complete inspection records correctly, including what level of detail is
                      expected
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Designate a responsible person</strong> for
                      managing scaffold documentation &mdash; collecting reports, updating the
                      register, and filing records
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-0.5 w-5 h-5 rounded-full bg-slate-500/20 border border-slate-500/40 flex items-center justify-center flex-shrink-0 text-[10px] font-bold text-slate-400">
                    ...
                    <span>
                      <strong className="text-white">Set up a review schedule</strong> where site
                      management reviews all inspection reports at least weekly to identify trends
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Establish a backup system</strong> &mdash; keep
                      copies both at the scaffold and in the site office; if paper, scan and store
                      digitally as well
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-slate-500/10 border border-slate-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-slate-400">HSE Inspector Visits:</strong> Be able to
                  produce all scaffold inspection records <strong>within minutes</strong>. Keep the
                  scaffold register up to date and accessible at all times. Ensure the competent
                  person who carried out each inspection can be identified from the record. Have
                  copies of scaffolding competence certificates available for all inspectors.
                </p>
              </div>
            </div>
          </div>
