...
const quickCheckQuestions = [
  ...
  {
    id: 'mh-vacuum-lifter',
    question: 'For which type of load are vacuum lifters specifically designed?',
    options: [
...
const faqs = [
  {
    question: 'Why do workers sometimes avoid using mechanical aids even when they are available?',
    answer:
  ...
  {
    question: 'Do I need training to use a manual pallet truck?',
    answer:
  ...
  {
    question: 'Can I use a cable drum jack on any size of cable drum?',
    answer:
  ...
  {
    question: 'What is the difference between a cable winch and a cable capstan?',
    answer:
...
const quizQuestions = [
  ...
  {
    id: 6,
    question: 'What type of conveyor works by gravity alone, without any power source?',
    options: [
      'Belt conveyor',
...
export default function ManualHandlingModule3Section3() {
  useSEO({
    title: 'Mechanical Aids & Equipment | Manual Handling Module 3.3',
    description:
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
          ...
          <div className="p-4 rounded-lg bg-emerald-500/5 border-l-2 border-emerald-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li className="flex items-start gap-2">
                ...
                <span>
                  <strong>Trolleys:</strong> platform, cage, sack trucks, stair-climbing
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
              ...
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                <span>
                  <strong>Cable-specific:</strong> drum jacks, winches, capstans, reel dispensers
                </span>
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-emerald-500/5 border-l-2 border-emerald-500/50">
            <p className="text-emerald-400 text-base font-medium mb-2">Key Principles</p>
            <ul className="text-base text-white space-y-1.5">
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                <span>
                  <strong>Match:</strong> the aid to the actual task and conditions
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                <span>
                  <strong>Inspect:</strong> before every use and at regular planned intervals
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Trolleys and sack trucks are the most commonly used mechanical aids on electrical
                installation sites. They are relatively inexpensive, versatile, and can dramatically
                reduce the physical effort of moving materials across a site.
              </p>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-1.5">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                      <span>
                        Best on smooth, level floors &mdash; poor on rough ground or steps
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-1.5">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                      <span>
                        Ideal for multiple boxes of accessories, switches, sockets, and fittings
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-1.5">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                      <span>
                        Excellent for single heavy items: consumer units, distribution boards, cable
                        drums
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-1.5">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                      <span>
                        Feature tri-wheel or tracked mechanism for ascending and descending stairs
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                      <span>
                        Particularly valuable for multi-storey domestic and commercial work
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Pallet trucks are essential for moving palletised loads of cable, containment,
                switchgear, and bulk materials. They are used extensively in warehouses, stores, and
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  difficult. Always check the route is clear, the floor is suitable, and the load is
                  stable on the forks before moving.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                For heavier items that cannot safely be moved by trolleys or pallet trucks, hoists,
                cranes, and conveyor systems provide the mechanical power needed. These are commonly
                encountered on larger electrical projects involving transformers, switchgear,
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-1.5">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                      <span>
                        Used for lifting transformers, switchgear panels, and heavy plant into
                        position
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                      <span>
                        Some plant rooms have permanent overhead lifting points specifically for
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-1.5">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                      <span>
                        Mobile cranes used for positioning heavy equipment at ground level or on
                        rooftops
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                      <span>
                        Chain blocks are portable manual hoists that can be attached to any suitable
                        anchor point
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                      <span>
                        All lifting operations must comply with LOLER (Lifting Operations and
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                      <span>
                        Must be thoroughly examined at least every 12 months (6 months if used for
                        lifting persons)
                      </span>
                    </li>
                  </ul>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-1.5">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Roller conveyors:</strong> freely rotating
                        rollers for moving items along a route, powered or gravity-fed
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Belt conveyors:</strong> continuous belt
                        surface for smaller items or irregular shapes
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Gravity conveyors:</strong> use a slight
                        slope to move items by gravity alone, no power required
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                      <span>
                        Useful for unloading delivery vehicles and moving materials along
                        distribution routes
                      </span>
                    </li>
                  </ul>
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-emerald-500">Vacuum Lifters:</strong> For glass panels,
                  sheet materials, plasterboard, and other smooth flat surfaces, vacuum lifters use
                  suction cups to grip the material securely. They are commonly seen in glazing work
                  but are also useful for electricians handling large flat items such as
                  glass-fronted distribution boards or sheet metal enclosures. The surface must be
                  smooth, non-porous, and clean for the vacuum seal to work reliably.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Cable installation presents unique manual handling challenges due to the weight of
                cable drums, the forces involved in pulling cable, and the repetitive nature of
                cable preparation. Several specialised pieces of equipment are designed specifically
                for these tasks.
              </p>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-1.5">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                      <span>
                        Available in various sizes from small stands for lightweight reels to
                        heavy-duty hydraulic jacks for large drums
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                      <span>
                        Must be rated for the weight of the drum being supported (check SWL)
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-1.5">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Winches:</strong> wrap the pulling rope
                        around a drum, providing mechanical advantage. Limited by drum capacity.
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Capstans:</strong> rotating bollard around
                        which rope is wrapped. The rope feeds through continuously, ideal for long
                        pulls.
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                      <span>
                        Both require secure anchoring, correct rope selection, and proper training
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                      <span>
                        Pulling force must not exceed the cable manufacturer&rsquo;s maximum pulling
                        tension
                      </span>
                    </li>
                  </ul>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-1.5">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                      <span>
                        Spring tension provides controlled dispensing, preventing cable from
                        uncoiling too quickly
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
          ...
          <div className="overflow-x-auto -mx-4 px-4">
            <div className="bg-white/5 border border-emerald-500/30 rounded-xl overflow-hidden min-w-[600px]">
              ...
              <div className="grid grid-cols-4 bg-emerald-500/10 border-b border-emerald-500/30">
                ...
                <div className="px-3 py-2 text-xs font-bold text-emerald-400">Notes</div>
              </div>
              {/* Data Rows */}
              {[
                {
                ...
                <div
                  key={index}
                  className={`grid grid-cols-4 ${index % 2 === 0 ? 'bg-white/[0.02]' : ''} ${
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Selecting the right mechanical aid and keeping it properly maintained are critical
                for ensuring it actually reduces risk rather than creating new hazards. A poorly
                chosen or badly maintained aid will not be used by workers, defeating its purpose.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Load compatibility:</strong> Can the aid handle
                      the type, weight, size, and shape of the loads involved?
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Route suitability:</strong> Will it fit through
                      doors, corridors, and around corners? Can it handle the floor surface, slopes,
                      and steps?
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Frequency of use:</strong> Is this a one-off
                      move or a daily task? Higher frequency justifies investment in better
                      equipment.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Storage and transport:</strong> Can the aid be
                      stored on site or transported in the work vehicle? Folding and compact designs
                      improve uptake.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Worker acceptance:</strong> Involve workers in
                      the selection process. They will use equipment they helped choose. They will
                      avoid equipment imposed upon them that does not suit the real conditions.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Pre-use check:</strong> Visual inspection
                      before every use &mdash; wheels, tyres, handles, frame, lifting mechanism,
                      brakes, capacity label
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Planned inspections:</strong> Regular
                      inspections at intervals based on manufacturer guidance and intensity of use
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">LOLER examinations:</strong> Lifting equipment
                      (hoists, chain blocks, cranes) must be thoroughly examined at least every 12
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Defect reporting:</strong> Any defect found
                      must be reported immediately and the equipment taken out of service until
                      repaired
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  cause serious injury. If the load exceeds the SWL of available equipment, use a
                  higher-rated aid or break the load into smaller units.
                </p>
              </div>
            </div>
          </div>
