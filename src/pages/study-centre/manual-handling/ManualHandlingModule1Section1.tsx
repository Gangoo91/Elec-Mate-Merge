...
const quickCheckQuestions = [
  ...
  },
  {
    id: 'mh-injury-stats',
    question:
      'Approximately what percentage of workplace injuries reported in the UK are related to manual handling?',
    options: ['Around 10%', 'Around 20%', 'Around 30%', 'Around 50%'],
    correctIndex: 2,
    explanation:
      'Approximately 30% of all workplace injuries reported to the HSE are related to manual handling. This makes musculoskeletal disorders (MSDs) from manual handling one of the single largest categories of workplace injury in the UK, accounting for around 500,000 affected workers each year.',
  },
  {
...
const quizQuestions = [
  ...
  },
  {
    id: 2,
    question:
      'Approximately how many UK workers suffer from musculoskeletal disorders related to manual handling each year?',
    options: ['Around 50,000', 'Around 150,000', 'Around 500,000', 'Around 1,000,000'],
    correctAnswer: 2,
    explanation:
      'Approximately 500,000 UK workers suffer from work-related musculoskeletal disorders each year, with manual handling being a leading cause. This results in millions of lost working days and significant costs to individuals, employers, and the economy.',
  },
  {
    id: 3,
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'Pressing a button to operate a hoist does not involve transporting or supporting a load by hand or bodily force — the mechanical equipment does the work. All the other options involve the application of bodily force to move or support a load and therefore constitute manual handling.',
  },
  {
    id: 5,
    question:
      'The HSE guideline figure of 25 kg for a man lifting close to the body at waist height is:',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'The HSE guideline figures are filters, not legal limits. They help identify manual handling tasks that need a more detailed risk assessment. A load below the guideline figure is not automatically safe, and a load above it is not automatically prohibited. The actual risk depends on all the TILE factors — Task, Individual, Load, and Environment.',
  },
  {
    id: 6,
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'Most musculoskeletal disorders develop gradually from repeated manual handling over time — cumulative strain from poor posture, repetitive lifting, sustained awkward positions, and vibration exposure. Acute injuries from a single event do occur, but gradual onset is far more common.',
  },
  {
    id: 8,
    question:
...
export default function ManualHandlingModule1Section1() {
  useSEO({
    ...
    description:
      'MHOR 1992 definition, UK injury statistics, common electrician manual handling tasks, and musculoskeletal disorder risk factors.',
  });
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-emerald-500/5 border-l-2 border-emerald-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Definition:</strong> Transporting or supporting a load by hand or bodily
                force
              </li>
              <li>
                <strong>Includes:</strong> Lifting, lowering, pushing, pulling, carrying, moving
              </li>
              <li>
                <strong>Scale:</strong> ~500,000 UK workers affected by MSDs each year
              </li>
              <li>
                <strong>Key fact:</strong> ~30% of all workplace injuries are manual handling
                related
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-emerald-500/5 border-l-2 border-emerald-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Cable drums:</strong> Heavy drums (25&ndash;80 kg+) requiring team lifts
              </li>
              <li>
                <strong>Distribution boards:</strong> Awkward shape, overhead installation
              </li>
              <li>
                <strong>Cable pulling:</strong> Sustained force through conduit and trunking
              </li>
              <li>
                <strong>Tools &amp; ladders:</strong> Repeated carrying across large sites
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The <strong>Manual Handling Operations Regulations 1992</strong> (MHOR 1992, as
                amended 2002) provide the legal framework for managing manual handling risks in all
                UK workplaces. These regulations were made under the Health and Safety at Work Act
                1974 and implement European Council Directive 90/269/EEC on manual handling of
                loads.
              </p>
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                ...
                <p className="text-base text-white leading-relaxed">
                  <strong>&ldquo;Manual handling operations&rdquo;</strong> means any transporting
              ...
              <p>
                ...
                something up and putting it down. It covers{' '}
                <strong>six distinct types of activity</strong>, each of which carries its own
                pattern of risk:
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm text-white">
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    ...
                    <p>
                      Raising a load from a lower level to a higher level. Examples include picking
                      up a toolbox from the floor, lifting a distribution board onto a wall bracket,
                      or raising a cable drum onto a stand.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    <p className="text-white font-medium mb-1">2. Lowering</p>
                    <p>
                      Moving a load from a higher level to a lower level in a controlled manner.
                      Examples include lowering a luminaire from a ceiling, placing a heavy tool bag
                      on the floor, or lowering materials from a scaffold platform.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    <p className="text-white font-medium mb-1">3. Pushing</p>
                    <p>
                      Applying force to move a load away from the body. Examples include pushing a
                      loaded trolley, pushing cable trunking into position, or pushing a heavy door
                      open while carrying tools.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    <p className="text-white font-medium mb-1">4. Pulling</p>
                    <p>
                      Applying force to move a load towards the body or along a path. Examples
                      include pulling cables through conduit, pulling a cable drum on a trolley, or
                      hauling a rope to raise materials.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    <p className="text-white font-medium mb-1">5. Carrying</p>
                    <p>
                      Transporting a load from one place to another while supporting its weight.
                      Examples include carrying lengths of conduit or trunking, transporting tool
                      bags across site, or carrying cable drums between work areas.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    <p className="text-white font-medium mb-1">6. Moving</p>
                    <p>
                      Changing the position or orientation of a load. This is a catch-all that
                      covers activities like sliding, rolling, tilting, turning, or repositioning a
                      load. Examples include rolling a cable drum, tilting a distribution board, or
                      sliding a panel into position.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <p>
                A critical point is that there is <strong>no minimum weight threshold</strong> in
                the regulations. A load of any weight can present a manual handling risk if the task
                involves awkward postures, repetitive movements, long carrying distances, or poor
                environmental conditions. The definition focuses on the <strong>activity</strong>{' '}
                (transporting or supporting by bodily force), not on the weight of the load.
              </p>
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  guideline filter figures to help identify tasks that need a detailed risk
                  assessment, but these are not legal limits. A task involving a 10 kg load can be
                  high-risk if it involves twisting, reaching overhead, or being repeated hundreds
                  of times a day. Conversely, a single lift of 30 kg in ideal conditions may be
                  acceptable.
                </p>
              </div>
              ...
              <p>
                ...
                movable object. This includes inanimate objects (tools, materials, equipment),
                living things (a person being assisted or rescued), and anything being held in
                position or restrained (such as holding a fitting against a ceiling while fixing
                it). Even a person &mdash; for example, an injured colleague being moved &mdash; is
                a load under the regulations.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Manual handling injuries represent one of the{' '}
                <strong>largest categories of workplace ill health</strong> in the United Kingdom.
                The numbers are substantial and persistent, demonstrating that despite decades of
                legislation and guidance, manual handling remains a major occupational health
                challenge.
              </p>

              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                <p className="text-sm font-medium text-red-400 mb-3">
                  UK Manual Handling &mdash; Key Statistics
                </p>
              ...
              <p>
                According to the Health and Safety Executive (HSE), musculoskeletal disorders (MSDs)
                are the <strong>most common type of occupational ill health</strong> in the UK. Each
                year, approximately 500,000 workers report suffering from a work-related
                musculoskeletal condition &mdash; affecting the back, neck, shoulders, arms, wrists,
                hips, knees, or other joints and soft tissues.
              </p>

              <p>
                Of all injuries reported under RIDDOR (Reporting of Injuries, Diseases and Dangerous
                Occurrences Regulations), manual handling accounts for approximately{' '}
                <strong>30% of all reported injuries</strong>. This proportion has remained broadly
                consistent over many years, indicating that the problem is deeply embedded in the
                way work is organised and carried out across all industries.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 sm:p-6 rounded-lg">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <p className="text-sm font-medium text-white">
                    Manual Handling Injury Statistics &mdash; By Body Region
                  </p>
                </div>
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="h-6 sm:h-8 bg-white/5 rounded-full overflow-hidden">
                      <div
                        ...
                        style={{ width: '40%' }}
                      >
                        <span className="text-[10px] font-bold text-white hidden sm:inline">
                          MOST COMMON
                        </span>
                      </div>
                    </div>
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-1">
                      <span className="text-sm text-white">
                        Other (neck, abdomen, multiple regions)
                      </span>
                ...
                <div className="mt-4 p-3 bg-red-500/10 border border-red-500/20 rounded-lg">
                  <div className="flex items-start gap-2">
                    ...
                    <p className="text-xs text-white">
                      ...
                      compressive and shear forces during lifting, bending, and twisting. This is
                      why correct lifting technique and task design are so critical.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <p>
                The <strong>construction industry</strong>, including electrical installation, has
                one of the highest rates of musculoskeletal disorders of any sector. The physical
                nature of the work &mdash; lifting heavy materials, working in confined spaces,
                adopting awkward postures, and performing repetitive tasks &mdash; means that
                electricians are at particularly high risk. HSE data shows that construction workers
                are approximately twice as likely to develop a work-related MSD compared to the
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  serious MSDs are forced to change career, take early retirement, or live with
                  chronic pain and reduced mobility. The personal, financial, and emotional cost is
                  immense &mdash; and in most cases, the injury was entirely preventable.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Electricians perform a wide range of manual handling tasks on a daily basis. Many of
                these are so routine that they may not even be recognised as manual handling
              ...
              <p>
                ...
                a load, and therefore falls within the definition of a manual handling operation.
                The specific risks will vary depending on the weight, shape, and size of the load;
                the distance it must be moved; the posture required; the frequency of the task; and
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Containment installation</strong> &mdash;
                      lifting and fixing cable tray, basket, and trunking at ceiling height, often
                      requiring overhead reaching and sustained arm elevation
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Trench work</strong> &mdash; bending, kneeling,
                      and lifting in confined trenches when laying underground cables and ducts
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Ceiling void work</strong> &mdash; crawling,
                      twisting, and manoeuvring in restricted spaces above suspended ceilings
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Switchgear installation</strong> &mdash;
                      manoeuvring heavy switchgear panels (100 kg+) into plant rooms, often through
                      narrow doorways
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Repetitive wiring</strong> &mdash; sustained
                      gripping, pulling, and twisting of cables during termination and connection
                      work
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  (ceiling voids, risers, ducts, under-floor zones),{' '}
                  <strong className="text-white">repetitive movements</strong> (cable stripping,
                  terminating, pulling), and
                  <strong className="text-white"> asymmetric loads</strong> (long lengths of
                  conduit, oddly shaped fittings, flexible cables). These factors significantly
                  increase the risk of musculoskeletal injury compared to straightforward lifting of
                  compact, symmetrical loads.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                <strong>Musculoskeletal disorders (MSDs)</strong> are conditions that affect the
                muscles, joints, tendons, ligaments, nerves, and intervertebral discs. They range
                from mild aches and stiffness to severe, disabling conditions that prevent a person
                from working. MSDs from manual handling can be <strong>acute</strong> (resulting
                from a single event) or <strong>chronic</strong> (developing gradually over time).
              </p>
                  ...
                  <div>
                    ...
                    <ul className="text-sm text-white space-y-1.5">
                      ...
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                        <span>
                          Sudden onset of pain, often with a clear &ldquo;mechanism&rdquo;
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                        <span>
                          Example: disc prolapse from lifting a heavy load with a twisted spine
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                  ...
                  <div>
                    ...
                    <ul className="text-sm text-white space-y-1.5">
                      ...
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                        <span>
                          Example: chronic low back pain from years of poor lifting posture
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                        <span>
                          Example: carpal tunnel syndrome from repetitive cable termination
                        </span>
                      </li>
                    </ul>
                  </div>
              ...
              <p>
                ...
                <strong>majority of MSDs are cumulative</strong>
                ...
                and environmental factors involved in manual handling tasks. An electrician who
                lifts moderate loads dozens of times per day, in awkward positions, over months and
                years, is at very high risk of developing a chronic MSD &mdash; even if no single
                lift seems particularly demanding.
              </p>
            ...
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Heavy loads</strong> &mdash; the greater the
                      weight, the greater the compressive force on the spine and the strain on
                      muscles and ligaments. Cable drums, switchgear panels, and bundles of conduit
                      can all be extremely heavy.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Awkward postures</strong> &mdash; bending,
                      twisting, reaching overhead, stooping, and kneeling all increase spinal
                      loading and muscle fatigue. Electricians frequently adopt these postures when
                      working in confined spaces, ceiling voids, and at floor level.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Repetitive handling</strong> &mdash; performing
                      the same manual handling movement repeatedly causes cumulative micro-damage to
                      muscles, tendons, and discs. Even light loads become hazardous when handled
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Long carrying distances</strong> &mdash;
                      carrying loads over long distances increases fatigue, changes gait patterns,
                      and prolongs the duration of spinal loading. Large construction sites can
                      require materials to be carried hundreds of metres.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Unstable or unpredictable loads</strong>{' '}
                      &mdash; loads that shift, swing, or change shape during handling (such as
                      coiled cables or liquid-filled containers) create sudden, unexpected forces
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Poor grip</strong> &mdash; smooth, slippery, or
                      awkwardly shaped loads that are difficult to grip securely increase the risk
                      of dropping the load or compensating with excessive muscular effort.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Environmental factors</strong> &mdash; slippery
                      floors, uneven surfaces, poor lighting, extreme temperatures, confined spaces,
                      and obstacles in the path all increase manual handling risk.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Individual factors</strong> &mdash; age,
                      fitness, existing health conditions, fatigue, pregnancy, and experience all
                      affect an individual&rsquo;s capacity for manual handling. These must be
                      considered in every risk assessment.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  ...
                  risk. A moderate-weight load lifted in an ideal posture, on a flat surface, once
                  per day, is low-risk. The same load lifted in a twisted posture, on an uneven
                  surface, 50 times per day, is high-risk. Effective risk assessment must consider
                  all factors together, not just the weight of the load.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <ul className="text-sm text-white space-y-2">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong className="text-white">Definition:</strong> Manual handling means
                    transporting or supporting a load by hand or bodily force &mdash; including
                    lifting, lowering, pushing, pulling, carrying, and moving
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">No weight limit:</strong> There is no legal
                    maximum weight &mdash; risk depends on the combination of task, individual,
                ...
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Statistics:</strong> ~500,000 workers affected,
                    ~30% of all injuries, ~7.3 million working days lost, over &pound;5 billion
                    annual cost
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Back injuries dominate:</strong> The lower back
                    accounts for ~40% of all manual handling injuries
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Electrician relevance:</strong> Cable drums,
                    distribution boards, cable pulling, containment, tools, and ladders are all
                ...
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Cumulative damage:</strong> Most MSDs develop
                    gradually from repeated handling, not from a single incident
                  </span>
                </li>
              </ul>
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  ...
                  1992, the Health and Safety at Work Act 1974, employer and employee duties, and
