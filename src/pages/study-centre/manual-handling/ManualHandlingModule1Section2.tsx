...
const quickCheckQuestions = [
  ...
  },
  {
    id: 'mh-employer-duty',
    question:
      'Which of the following is an employer duty under the Manual Handling Operations Regulations 1992?',
    options: [
...
const quizQuestions = [
  {
    ...
    correctAnswer: 1,
    explanation:
      'The MHOR 1992 are secondary legislation — regulations (a Statutory Instrument) made under the Health and Safety at Work Act 1974. They provide specific, legally binding requirements for managing manual handling risks.',
  },
  {
    id: 2,
    question:
      'Which Regulation of the MHOR 1992 requires employers to avoid hazardous manual handling so far as is reasonably practicable?',
    options: ['Regulation 2', 'Regulation 3', 'Regulation 4(1)(a)', 'Regulation 5'],
    correctAnswer: 2,
    explanation:
      'Regulation 4(1)(a) of the MHOR 1992 requires each employer to avoid the need for their employees to undertake any manual handling operations at work which involve a risk of their being injured, so far as is reasonably practicable.',
  },
  {
    id: 3,
    question:
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Employees have a duty under Regulation 5 of the MHOR 1992 to make full and proper use of any system of work provided by their employer. Under Section 7 of HASAWA 1974, they must take reasonable care for their own safety, cooperate with their employer, and use equipment in accordance with training.',
  },
  {
    id: 6,
...
export default function ManualHandlingModule1Section2() {
  useSEO({
    ...
    description:
      'MHOR 1992, HASAWA 1974, Management Regulations 1999, employer and employee duties, and the hierarchy of control for manual handling.',
  });
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <header className="text-center mb-12">
          ...
          <p className="text-white text-sm sm:text-base max-w-2xl mx-auto">
            The regulations, duties, and hierarchy of control that govern manual handling in UK
            workplaces
          </p>
        </header>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-emerald-500/5 border-l-2 border-emerald-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Key regs:</strong> MHOR 1992, HASAWA 1974, Management Regs 1999
              </li>
              <li>
                <strong>Hierarchy:</strong> Avoid &rarr; Assess &rarr; Reduce &rarr; Inform
              </li>
              <li>
                <strong>Employer:</strong> Must avoid, assess, and reduce MH risks
              </li>
              <li>
                <strong>Employee:</strong> Must use equipment provided, follow training, report
                problems
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-emerald-500/5 border-l-2 border-emerald-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Reg 4(1)(a):</strong> Avoid hazardous MH where practicable
              </li>
              <li>
                <strong>Reg 4(1)(b)(i):</strong> Assess unavoidable MH operations
              </li>
              <li>
                <strong>Reg 4(1)(b)(ii):</strong> Reduce risk of injury SFAIRP
              </li>
              <li>
                <strong>Reg 4(1)(b)(iii):</strong> Provide weight and load information
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="bg-white/5 border border-white/10 p-4 sm:p-6 rounded-lg">
            <p className="text-sm text-white mb-6 text-center">
              The regulations establish a clear hierarchy that must be followed in order
            </p>
            ...
            <div className="max-w-md mx-auto space-y-3">
              ...
              <div className="bg-emerald-500/20 border-2 border-emerald-500/50 rounded-xl p-4 text-center">
                ...
                <p className="text-[10px] text-white mt-0.5">
                  Use mechanical aids, redesign the task, eliminate the need to handle the load
                </p>
              </div>
              ...
              <div className="bg-blue-500/15 border-2 border-blue-500/40 rounded-xl p-4 text-center">
                <p className="text-xs font-bold text-blue-400 mb-1">
                  STEP 2 &mdash; REGULATION 4(1)(b)(i)
                </p>
                <p className="text-sm font-semibold text-white">ASSESS</p>
                <p className="text-xs text-white mt-1">
                  Make a suitable and sufficient assessment of any remaining hazardous operations
                </p>
                <p className="text-[10px] text-white mt-0.5">
                  Use the TILE framework: Task, Individual, Load, Environment
                </p>
              </div>
              ...
              <div className="bg-amber-500/15 border-2 border-amber-500/40 rounded-xl p-4 text-center">
                <p className="text-xs font-bold text-amber-400 mb-1">
                  STEP 3 &mdash; REGULATION 4(1)(b)(ii)
                </p>
                ...
                <p className="text-[10px] text-white mt-0.5">
                  Reduce load weight, improve posture, provide training, use team lifts, modify the
                  task
                </p>
              </div>
              ...
              <div className="bg-purple-500/15 border-2 border-purple-500/40 rounded-xl p-4 text-center">
                <p className="text-xs font-bold text-purple-400 mb-1">
                  STEP 4 &mdash; REGULATION 4(1)(b)(iii)
                </p>
                <p className="text-sm font-semibold text-white">INFORM</p>
                <p className="text-xs text-white mt-1">
                  Provide general indications and, where practicable, precise information on load
                  weight and centre of gravity
                </p>
                <p className="text-[10px] text-white mt-0.5">
                  Label loads, brief workers, mark heaviest side of asymmetric loads
                </p>
              </div>
            </div>

            <p className="text-center text-white text-xs mt-4">
              Each step must be fully considered before moving to the next &mdash; avoidance takes
              priority over assessment, which takes priority over reduction
            </p>
          </div>
        </section>
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                amended 2002) are the principal regulations governing manual handling in all UK
                workplaces. They were made under the Health and Safety at Work Act 1974 and
                implement European Council Directive 90/269/EEC. The regulations apply to{' '}
                <strong>all employers, employees, and self-employed persons</strong> across every
                industry.
              </p>

              <p>
                The core of the regulations is contained in <strong>Regulations 2 through 5</strong>
                , which establish definitions, duties on employers, the assessment process, and
                duties on employees.
              </p>
                ...
                <div className="space-y-3 text-sm text-white">
                  <div>
                    <p className="text-white font-medium">
                      Regulation 2 &mdash; Interpretation (Definitions)
                    </p>
                    <p>
                      Defines key terms including &ldquo;manual handling operations&rdquo;
                      (transporting or supporting a load by hand or bodily force),
                      &ldquo;load&rdquo; (any discrete movable object, including a person and an
                      animal), and &ldquo;injury&rdquo; (injury to any part of the body, not limited
                      to the back). These definitions establish the scope of the regulations.
                    </p>
                  </div>
                  <div>
                    <p className="text-white font-medium">
                      Regulation 3 &mdash; Disapplication of Regulations
                    </p>
                    <p>
                      Provides limited exemptions. The regulations do not apply to or in relation to
                      the master or crew of a sea-going ship. In all other workplaces and
                      industries, the regulations apply in full.
                    </p>
                  </div>
                  <div>
                    <p className="text-white font-medium">
                      Regulation 4 &mdash; Duties of Employers
                    </p>
                    <p>
                      The central provision. Establishes the four-step hierarchy that employers must
                      follow: (a) avoid hazardous manual handling so far as is reasonably
                      practicable; (b)(i) where avoidance is not possible, assess the risk; (b)(ii)
                      take appropriate steps to reduce the risk; (b)(iii) provide information on
                      load weight and characteristics. Regulation 4(2) requires employers to review
                      assessments when there is reason to suspect they are no longer valid.
                    </p>
                  </div>
                  <div>
                    <p className="text-white font-medium">
                      Regulation 5 &mdash; Duties of Employees
                    </p>
                    <p>
                      Requires each employee, while at work, to make full and proper use of any
                      system of work provided for their use by their employer in compliance with
                      Regulation 4. This means employees must follow safe systems of work, use
                      mechanical aids when provided, apply correct lifting techniques, and cooperate
                      with their employer.
                    </p>
                  </div>
                </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-2">
                  Schedule 1 &mdash; Factors for Assessment
                </p>
                <p className="text-sm text-white leading-relaxed mb-3">
                  Schedule 1 of the MHOR 1992 lists the factors that must be considered when
                  carrying out a manual handling assessment. These form the basis of the TILE
                  framework:
                </p>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    ...
                    <p className="text-white text-xs">
                      Does it involve holding or manipulating loads at a distance from the trunk?
                      Twisting, stooping, or reaching upwards? Large vertical movement? Long
                      carrying distances? Strenuous pushing or pulling? Repetitive handling?
                  ...
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    ...
                    <p className="text-white text-xs">
                      Does the task require unusual strength or height? Does it create a hazard for
                      those with a health problem or physical limitation? Does it require special
                      knowledge or training? Is the individual pregnant, recovering from injury, or
                  ...
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    ...
                    <p className="text-white text-xs">
                      Is it heavy, bulky, difficult to grasp, unstable, or with contents likely to
                      shift? Is it sharp, hot, or otherwise potentially damaging? Is the heaviest
                      side not readily identifiable?
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    <p className="text-emerald-400 font-semibold text-xs mb-1">The Environment</p>
                    <p className="text-white text-xs">
                      Are there space constraints? Is the floor uneven, slippery, or unstable? Are
                      there variations in floor level or working surface? Are temperature, humidity,
                      or ventilation unsuitable? Are lighting conditions poor?
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  (SFAIRP) appears throughout the regulations and is crucial to understanding how
                  the duties work. It means that the employer must weigh the risk of injury against
                  the sacrifice (in cost, time, and effort) needed to eliminate or reduce that risk.
                  If the risk is significant and the measures to prevent it are reasonable and
                  proportionate, those measures must be implemented. The burden of proof is on the
                  employer to show that it was not reasonably practicable to do more.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                legislation governing all workplace health and safety in England, Wales, and
                Scotland. It is the foundation upon which the MHOR 1992 and all other health and
                safety regulations are built. Two sections are particularly relevant to manual
                handling.
              </p>
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                ...
                <div className="space-y-3 text-sm text-white">
                  <div className="flex gap-3">
                    <span className="flex items-center justify-center min-w-[60px] h-7 rounded-full bg-blue-500/20 text-blue-400 text-xs font-bold flex-shrink-0">
                      S.2
                    </span>
                    <div>
                      ...
                      <p>
                        ...
                        handling, this includes providing safe systems of work, safe plant and
                        equipment, adequate information, instruction, training, and supervision, and
                  ...
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        Every employee must: (a) take reasonable care for their own health and
                        safety and that of other persons who may be affected by their acts or
                        omissions at work; and (b) cooperate with their employer so far as is
                        necessary to enable the employer to comply with any duty or requirement
                        imposed on them by health and safety law. For manual handling, this means
                        following safe lifting procedures, using mechanical aids when available,
                        reporting hazards and injuries, and not taking unnecessary risks.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <p>
                ...
                requires employers to prepare a written health and safety policy where they employ
                five or more people (Section 2(3)), and makes it a criminal offence to fail to
                comply with any duty under the Act or regulations made under it (Section 33).
                Penalties include unlimited fines and up to two years&rsquo; imprisonment.
              </p>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-2">
                  What Section 2 Means for Manual Handling
                </p>
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Safe systems of work:</strong> Employers must
                      establish and enforce safe manual handling procedures, including method
                      statements and risk assessments for specific tasks
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Safe equipment:</strong> Employers must provide
                      suitable mechanical aids (trolleys, hoists, cable rollers, lifting equipment)
                      to reduce manual handling where practicable
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Information and training:</strong> Employers
                      must provide adequate manual handling training, including proper lifting
                      techniques and the use of mechanical aids
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Safe working environment:</strong> The
                      workplace must be maintained so that manual handling can be carried out safely
                      &mdash; clear walkways, good lighting, non-slip floors
                    </span>
                  </li>
                </ul>
              </div>
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Regulation 3 &mdash; Risk Assessment:</strong>{' '}
                      Every employer must carry out a suitable and sufficient assessment of the
                      risks to the health and safety of their employees and of anyone else affected
                      by their undertaking. For manual handling, this means assessing every task
                      that involves a risk of injury.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">
                        Regulation 4 &mdash; Principles of Prevention:
                      </strong>{' '}
                      Employers must implement preventive measures based on the general principles
                      of prevention &mdash; avoiding risks, combating risks at source, adapting work
                      to the individual, and giving priority to collective protective measures.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">
                        Regulation 5 &mdash; Health and Safety Arrangements:
                      </strong>{' '}
                      Employers must have effective arrangements in place for planning,
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">
                        Regulation 10 &mdash; Information for Employees:
                      </strong>{' '}
                      Employers must provide employees with comprehensible and relevant information
                      on the risks to their health and safety, and on the preventive and protective
                      measures in place.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">
                        Regulation 13 &mdash; Capabilities and Training:
                      </strong>{' '}
                      Employers must take into account the capabilities of employees when entrusting
                      tasks to them, and provide adequate health and safety training, including
                      training on manual handling techniques and the use of mechanical aids.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">
                        Regulation 16 &mdash; Risk Assessment for New or Expectant Mothers:
                      </strong>{' '}
                      Where an employer employs women of childbearing age and the work could pose a
                      risk to a new or expectant mother, the risk assessment must include specific
              ...
              <p>
                ...
                which the specific manual handling assessment required by MHOR 1992 Regulation 4
                sits. In practice, a manual handling risk assessment will satisfy both the
                requirements of MHOR 1992 Regulation 4(1)(b)(i) and the general risk assessment
                requirements of Management Regulations 1999 Regulation 3, provided it is suitable
                and sufficient.
              </p>
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  ...
                  harmed, evaluate risks, record findings, review and update) applies to manual
                  handling just as it does to all other workplace hazards. The TILE framework
                  (covered in Section 3) provides the structured approach for evaluating manual
                  handling risks specifically.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-amber-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The legal framework places clear and specific duties on both employers and
                employees. Health and safety is a shared responsibility &mdash; employers must
                create safe systems and employees must follow them.
              </p>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  Both employers and employees can face criminal prosecution for breaching health
                  and safety law. An employee who deliberately ignores safe manual handling
                  procedures, refuses to use mechanical aids that have been provided, or takes
                  unnecessary risks can be personally prosecuted under Section 7 of HASAWA 1974. The
                  employer remains responsible for providing the safe system of work, but the
                  employee is equally responsible for following it.
                </p>
              </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
                  <div className="bg-white/5 rounded-lg p-3">
                    ...
                    <p className="text-white text-xs">
                      ...
                      timeframe. Failure to comply is a criminal offence.
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-lg p-3">
                    <p className="text-emerald-400 font-semibold text-xs mb-1">
                    ...
                    <p className="text-white text-xs">
                      Immediately stops a work activity that poses a risk of serious personal
                      injury. Takes effect immediately or on a specified date.
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-lg p-3">
                    <p className="text-red-400 font-semibold text-xs mb-1">Prosecution</p>
                    <p className="text-white text-xs">
                      Unlimited fines for organisations. Up to 2 years&rsquo; imprisonment and
                      unlimited fines for individuals.
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-lg p-3">
                    ...
                    <p className="text-white text-xs">
                      HSE charges &pound;163/hour for all time spent investigating a material breach
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
                  ...
                  <div className="bg-emerald-500/10 border border-emerald-500/30 rounded-lg p-3">
                    ...
                    <ul className="space-y-1">
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                        <span>
                          Have cable drums delivered to the point of use, not the car park
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                  ...
                  <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-3">
                    ...
                    <ul className="space-y-1">
                      ...
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                        <span>
                          Survey the route &mdash; check for obstacles, slopes, stairs, narrow
                          passages
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                  ...
                  <div className="bg-amber-500/10 border border-amber-500/30 rounded-lg p-3">
                    ...
                    <ul className="space-y-1">
                      ...
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                        <span>
                          Arrange team lifts with clear communication and a designated leader
                        </span>
                      </li>
                    </ul>
                  </div>
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-emerald-500">Remember:</strong> The hierarchy is not
                  optional &mdash; it is a legal requirement. You must first consider whether the
                  manual handling task can be avoided entirely before assessing how to do it more
                  safely. Many electricians habitually carry loads that could easily be moved with a
                  trolley, or manually pull cables that could be drawn with a cable winch.
                  Challenging &ldquo;the way it&rsquo;s always been done&rdquo; is an important part
                  of compliance.
                </p>
              </div>
            </div>
            ...
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <ul className="text-sm text-white space-y-2">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong className="text-white">MHOR 1992:</strong> The principal regulations
                    &mdash; Regs 2&ndash;5 establish definitions, employer duties (avoid, assess,
                    reduce, inform), and employee duties
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">HASAWA 1974:</strong> Sections 2 and 7 establish
                    the overarching duties on employers and employees respectively
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Management Regs 1999:</strong> Require suitable
                    and sufficient risk assessment and the application of preventive principles
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Hierarchy:</strong> Avoid &rarr; Assess &rarr;
                    Reduce &rarr; Inform must be followed in order
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Employer duties:</strong> Avoid hazardous MH,
                    assess, reduce risk, provide mechanical aids, train workers, provide load
                    information
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Employee duties:</strong> Use equipment provided,
                    follow training, report problems, cooperate with employer
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Enforcement:</strong> Unlimited fines,
                    imprisonment, improvement and prohibition notices
                  </span>
                </li>
              </ul>
