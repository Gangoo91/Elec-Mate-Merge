...
const quickCheckQuestions = [
  {
    ...
    question: 'Which of the following is a Task factor in the TILE framework?',
    options: [
...
const faqs = [
  {
    question: 'Are the HSE guideline weights (25 kg men, 16 kg women) legal limits?',
    answer:
  ...
  {
    question: 'How do the four TILE factors interact with each other?',
    answer:
  ...
  {
    question: 'What clothing and PPE issues should be considered under Individual factors?',
    answer:
  ...
  {
    question: 'How does the Environment factor apply to outdoor electrical work?',
    answer:
...
const quizQuestions = [
  ...
  {
    id: 5,
    question: 'Which Individual factor relates to the loosening of ligaments during pregnancy?',
    options: ['Physical capability', 'Hormonal changes', 'Disability', 'Knowledge and training'],
    correctAnswer: 1,
    explanation:
  ...
  {
    id: 8,
    question: 'According to the TILE framework, what effect does repetitive lifting have on risk?',
    options: [
...
export default function ManualHandlingModule3Section1() {
  useSEO({
    title: 'The TILE Framework in Depth | Manual Handling Module 3.1',
    description:
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
          ...
          <div className="p-4 rounded-lg bg-emerald-500/5 border-l-2 border-emerald-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              ...
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                <span>
                  <strong>HSE guidelines:</strong> 25 kg (men) / 16 kg (women) at waist height close
                  to body
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                <span>
                  <strong>Factors interact:</strong> poor posture + heavy load + slippery floor =
                  compounding risk
                </span>
              </li>
            </ul>
          ...
          <div className="p-4 rounded-lg bg-emerald-500/5 border-l-2 border-emerald-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                <span>
                  <strong>Assess:</strong> every manual handling task using TILE before starting
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                <span>
                  <strong>Reduce:</strong> risk in whichever factor(s) present the greatest concern
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                <span>
                  <strong>Record:</strong> your assessment &mdash; it is a legal requirement
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                <span>
                  <strong>Review:</strong> whenever the task, people, loads, or conditions change
                </span>
              </li>
            </ul>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The TILE framework is the standard method used in the UK for assessing manual
                handling risks. It is based on the requirements of the{' '}
                <strong>Manual Handling Operations Regulations 1992 (as amended)</strong> and the
                accompanying HSE guidance document L23. TILE provides a structured way to consider
                all of the factors that contribute to the risk of musculoskeletal injury during
                manual handling operations.
              </p>

              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-emerald-500">Key Principle:</strong> A TILE assessment
                  considers the whole picture. A load that is safe to lift in one set of
                  circumstances may be dangerous in another. The <strong>combination</strong> of
                  Task, Individual, Load, and Environment determines the overall level of risk.
                </p>
              </div>

              <p>
                Every employer has a legal duty under Regulation 4 of the Manual Handling Operations
                Regulations to: (1) avoid hazardous manual handling operations so far as is
                reasonably practicable; (2) assess the risk of injury from any hazardous manual
                handling that cannot be avoided; and (3) reduce the risk of injury so far as is
                reasonably practicable. The TILE framework is the tool used to fulfil duty (2)
                &mdash; the assessment.
              </p>

              <p>
                For electricians, manual handling is a daily occurrence. Lifting cable drums,
                carrying distribution boards, positioning trunking and containment, pulling cables
                through conduit, and moving tools and test equipment all involve manual handling. A
                thorough understanding of the TILE framework enables you to assess these tasks
                quickly and effectively, identifying where risk can be reduced before injury occurs.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Task factors relate to <strong>how the work is done</strong> &mdash; the physical
                demands of the operation itself, the postures required, the movements involved, and
                the frequency and duration of the activity. Poor task design is one of the most
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Holding load away from body:</strong> Increases
                      spinal loading by up to five times. The further the load from the trunk, the
                      greater the lever arm and the more force the back muscles must generate.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Twisting:</strong> Rotating the trunk while
                      lifting or carrying places asymmetric loads on the spinal discs and muscles,
                      significantly increasing injury risk. Common when passing loads sideways or
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Stooping:</strong> Bending forward increases
                      the compressive force on the lower spine. Lifting from floor level with a bent
                      back is one of the highest-risk postures in manual handling.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Reaching upward:</strong> Lifting above
                      shoulder height reduces the strength available and forces the handler into an
                      unstable posture. The guideline weight is significantly reduced for overhead
                      lifts.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Repetition and frequency:</strong> Repeated
                      lifts cause cumulative fatigue in muscles, tendons, and ligaments. HSE
                      guideline weights are significantly reduced when lifting frequency increases
                      &mdash; a load acceptable for a single lift may need to be halved or more for
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Distance carried:</strong> Longer carrying
                      distances increase the duration of loading on the body and the cumulative
                      effect on muscles. Carrying over 10 metres warrants additional consideration.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Pushing and pulling:</strong> Starting force
                      (to get a load moving) is typically much higher than the sustained force
                      needed to keep it moving. Pushing is generally safer than pulling because it
                      allows the handler to use body weight.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Unpredictable movement:</strong> Loads that can
                      shift, swing, or move unexpectedly (such as liquids in containers, live
                      animals, or long flexible items) require additional muscle effort to control
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-emerald-500">Electrician Example:</strong> Pulling cable
                  through conduit involves sustained pulling force, often while in a stooped or
                  twisted posture. The cable may move unpredictably if it snags and then releases
                  suddenly. If this is done repeatedly over a shift, the cumulative Task risk is
                  substantial, even though the force for each individual pull may seem modest.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Individual factors relate to the <strong>person performing the task</strong>. Not
                everyone has the same physical capabilities, and what is safe for one person may be
                hazardous for another. The assessment must consider the specific individuals who
                will actually be carrying out the manual handling operation.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Physical capability:</strong> Strength,
                      fitness, and physical build vary significantly between individuals. A task
                      that is comfortable for a strong, fit worker may be hazardous for a smaller or
                      less physically capable colleague.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Age:</strong> Both younger and older workers
                      have specific considerations. Younger workers (apprentices) may lack
                      experience and technique. Older workers may have reduced strength,
                      flexibility, and recovery rates, and a higher prevalence of existing
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Pregnancy:</strong> Affects balance (changing
                      centre of gravity), reach (growing bump increases distance to loads), grip
                      strength (may be reduced), and ligament stability (the hormone relaxin loosens
                      ligaments throughout the body, not just the pelvis, increasing susceptibility
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Disability:</strong> A wide range of physical
                      and sensory disabilities may affect manual handling capability. Reasonable
                      adjustments must be made under the Equality Act 2010 to enable workers with
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Existing injuries:</strong> Previous or current
                      musculoskeletal injuries (particularly back, shoulder, knee, and wrist
                      injuries) significantly increase the risk of re-injury. Workers returning from
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Knowledge and training:</strong> Workers who
                      have received proper manual handling training are better able to assess risk,
                      adopt good postures, and use mechanical aids appropriately. Untrained workers
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Clothing and PPE:</strong> Bulky PPE restricts
                      movement, reduces visibility, and adds weight. Gloves can reduce grip.
                      Steel-capped boots are heavier and reduce ankle flexibility. All PPE effects
                      on manual handling must be considered.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  account in risk assessments and make reasonable adjustments to ensure all workers
                  can carry out manual handling tasks safely. Ignoring Individual factors is both a
                  health and safety failing and a potential discrimination issue.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                <strong>characteristics of the object being handled</strong>. Weight is the most
                obvious factor, but many other load properties significantly affect the risk of
                injury.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Weight:</strong> The most fundamental load
                      factor. Heavier loads require more muscle force and place greater stress on
                      the spine, joints, and soft tissues. HSE guideline weights apply at specific
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Size:</strong> Large, bulky loads force the
                      handler to hold the load further from the body, increasing the lever arm and
                      spinal loading. They also obscure vision and restrict movement.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Shape:</strong> Irregular or awkward shapes
                      make it difficult to get a secure grip and maintain a balanced hold. Round,
                      cylindrical, or irregular objects are harder to control than rectangular
                      boxes.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Grip difficulty:</strong> Smooth, slippery,
                      wet, oily, or contaminated surfaces make it hard to maintain a secure grip.
                      Loads without handles or grip points are harder to hold. A lost grip can cause
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Centre of gravity:</strong> If the centre of
                      gravity is not in the middle of the load, the weight distribution is uneven.
                      This forces the handler to adopt asymmetric postures to compensate, increasing
                      injury risk. Contents that shift (liquids, loose items) create a moving centre
                      of gravity.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Stability:</strong> Loads that are unstable,
                      floppy, or liable to shift during handling require constant muscular
                      adjustment. Cable drums that can roll, long flexible cable trays, and stacked
                      items that may topple are all examples.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Hot, cold, or sharp:</strong> Loads that are
                      hot, cold, sharp, or have rough edges pose additional hazards. The handler may
                      reflexively release the load if they receive a burn, cut, or cold burn,
                      causing the load to fall. Gloves that protect against these hazards may reduce
                      grip.
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-emerald-500">Electrician Example:</strong> A 100-metre
                  drum of 6 mm twin and earth cable weighs approximately 15 kg. However, its shape
                  (cylindrical), tendency to roll (stability), size (forces arms wide), and the need
                  to lift it from floor level (Task interaction) make it significantly more
                  hazardous than a 15 kg rectangular box with handles at waist height.
                </p>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Environment factors relate to <strong>where the work is being carried out</strong>.
                The physical conditions of the workplace can either support safe manual handling or
                make it significantly more hazardous.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Space constraints:</strong> Cramped spaces
                      prevent the handler from adopting good posture. Low ceilings force stooping,
                      narrow corridors prevent team lifts, and cluttered areas obstruct movement.
                      Plant rooms, riser cupboards, and ceiling voids are common examples for
                      electricians.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Floor surface:</strong> Wet, oily, dusty,
                      uneven, or damaged floors increase slip and trip risk during manual handling.
                      Carrying a heavy load on an uneven surface is significantly more hazardous
                      than on a smooth, level floor.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Slopes and stairs:</strong> Slopes alter
                      balance and increase the effort required. Stairs add the complexity of
                      stepping while loaded and significantly increase cardiovascular demand.
                      Handrails may not be available when hands are occupied by loads.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Temperature:</strong> Cold environments reduce
                      muscle flexibility, grip strength, and manual dexterity. Hot environments
                      cause fatigue, sweating (reducing grip), and dehydration. Both extremes
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Humidity:</strong> High humidity combined with
                      heat accelerates fatigue. It also makes surfaces and loads more slippery due
                      to condensation and perspiration.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Lighting:</strong> Poor lighting makes it
                      harder to see trip hazards, judge distances, and identify potential problems
                      with the load or route. Glare can be equally problematic.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Wind:</strong> Outdoor work introduces wind as
                      a significant factor, especially with large flat items (cable trays, trunking,
                      sheet materials) that act as sails. Gusts can make loads unpredictable and
                      uncontrollable.
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  <strong className="text-white">actually is</strong> at the time of the task, not
                  as it was during planning.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="mt-4 bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg text-center">
            <p className="text-sm text-white">
              <strong className="text-emerald-400">All four factors interact.</strong> A high-risk
              score in any single category may be acceptable if the other three are favourable. A
              moderate risk in all four categories simultaneously creates a{' '}
              <strong className="text-white">compounding effect</strong> that may be more dangerous
              than a single high-risk factor alone.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The real value of the TILE framework comes from considering all four categories
                together. Each factor modifies the others, and the overall risk is determined by
                their combined effect. A systematic approach ensures nothing is missed.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ol className="text-sm text-white/80 space-y-3">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Describe the task</strong> &mdash; what is
                      being moved, from where, to where, how often, and by whom?
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-0.5 w-6 h-6 rounded-full bg-emerald-500/20 border border-emerald-500/40 flex items-center justify-center flex-shrink-0 text-xs font-bold text-emerald-400">
                    ...
                    <span>
                      <strong className="text-white">Assess each TILE factor</strong> &mdash; work
                      through Task, Individual, Load, and Environment systematically, noting all
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Consider interactions</strong> &mdash; how do
                      the factors combine? A moderate load becomes high-risk on a slippery slope
                      with a tired worker.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Identify controls</strong> &mdash; for each
                      risk factor, determine what can be done to reduce it. Target the highest-risk
                      factors first.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Record and communicate</strong> &mdash;
                      document the assessment and ensure all workers involved understand the risks
                      and controls.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Review regularly</strong> &mdash; reassess
                      whenever the task, people, loads, or environment change. A change in any one
                      factor can alter the overall risk level.
                    </span>
                  </li>
                </ol>
              </div>
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-emerald-500">Worked Example:</strong> Moving a 20 kg
                  consumer unit from a delivery van to a first-floor flat. <strong>Task:</strong>{' '}
                  carrying up stairs, team lift possible. <strong>Individual:</strong> two fit,
                  trained electricians. <strong>Load:</strong> 20 kg, rectangular, handles on
                  packaging, stable contents. <strong>Environment:</strong> narrow stairwell, carpet
                  in good condition, adequate lighting. Controls: two-person carry, one leads
                  walking backwards (has clear view), rest on landing if needed, cleared route
                  before starting.
                </p>
              </div>
            </div>
