...
const quickCheckQuestions = [
  {
    ...
    options: [
      'Strength does not protect the spine from poor technique',
  ...
  },
  {
    ...
    options: [
      ...
      'The Management of Health and Safety at Work Regulations 1999, alongside the MHOR 1992',
  ...
  },
  {
    ...
    options: [
      'Provide energy drinks throughout the shift to keep workers alert',
      'Plan rest breaks, rotate tasks, and schedule heavy lifting early in the shift',
      'Schedule the heaviest manual handling tasks for the end of the shift',
      'Have workers skip manual handling training to free up more working time',
    ],
    correctIndex: 1,
    explanation:
...
const faqs = [
  ...
  {
    question: 'I am over 50 and have noticed I cannot lift as easily as I used to. Is this normal?',
    answer:
  ...
  {
    question: 'Does taking painkillers before manual handling make the task safer?',
    answer:
  ...
  {
    question: 'How should new or young workers be supervised during manual handling tasks?',
    answer:
...
const quizQuestions = [
  {
    id: 1,
    question: 'Why does physical fitness alone NOT eliminate manual handling injury risk?',
    options: [
      'Because strength does not protect the discs from poor technique',
      'Because physical fitness has no impact on manual handling at all',
      'Because only young workers benefit from being physically fit',
  ...
  {
    id: 2,
    question: 'What happens to intervertebral discs as a person ages from their 30s onwards?',
    options: [
      'They become stronger and more resilient to compressive load',
      'They are completely replaced by new disc tissue every ten years',
      'There is no change — the discs remain the same throughout life',
      'They lose water content and elasticity, reducing shock absorption',
    ],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: [
      'It makes the muscles stronger and more resistant to strain',
      'It increases bone density across the spine and pelvis',
      'It loosens ligaments, reducing joint stability and raising injury risk',
      'It has no effect on the musculoskeletal system during pregnancy',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Painkillers have no effect on manual handling injury risk',
      'The painkillers mask warning pain, so damaged tissue is overstressed',
      'Painkillers make the worker physically stronger under load',
  ...
  {
    id: 5,
    question: 'Which factor MOST increases fatigue-related manual handling injury risk?',
    options: [
      'Working outdoors in mild, warm summer weather',
      'Wearing steel-toe-capped safety boots on site',
      'Long shifts without rest breaks, combined with poor sleep',
      'Listening to music through earphones while working',
    ],
    correctAnswer: 2,
    explanation:
  ...
  {
    id: 6,
    question: 'Why are new and young workers at greater risk of manual handling injury?',
    options: [
      'Less experience recognising risk and a tendency to take shortcuts',
      'They are always physically weaker than more experienced workers',
      'They are not required to follow manual handling procedures on site',
  ...
  },
  {
    ...
    options: [
      'Only if the worker requests the assessment in writing',
      'Only after the worker has already been injured at work',
      'As soon as the employer is informed of the pregnancy',
      'Only during the final month of the pregnancy',
    ],
    correctAnswer: 2,
    explanation:
  ...
  {
    id: 8,
    question: 'What is the relationship between hydration and manual handling injury risk?',
    options: [
      'Hydration has no measurable effect on manual handling capacity',
      'Drinking water only helps when the weather is hot or humid',
      'Workers should avoid drinking on shift to reduce toilet breaks',
      'Dehydration cuts muscle performance and concentration, raising risk',
    ],
    correctAnswer: 3,
    explanation:
...
export default function ManualHandlingModule5Section2() {
  useSEO({
    title: 'Fitness, Fatigue & Personal Factors | Manual Handling Module 5.2',
    description:
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
          ...
          <div className="p-4 rounded-lg bg-emerald-500/5 border-l-2 border-emerald-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li className="flex items-start gap-2">
                ...
                <span>
                  <strong>Strength &ne; safety:</strong> strong workers still need good technique
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                <span>
                  <strong>Disc degeneration</strong> begins naturally from the 30s
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                <span>
                  <strong>Pregnancy:</strong> specific MH assessment legally required
                </span>
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-emerald-500/5 border-l-2 border-emerald-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                <span>
                  <strong>Painkillers</strong> mask warning pain &mdash; increasing risk
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                <span>
                  <strong>Fatigue:</strong> reduces grip strength, impairs judgement
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Physical fitness undeniably improves a worker&rsquo;s capacity for manual handling.
                Stronger muscles, better cardiovascular endurance, and greater flexibility all
                contribute to an increased ability to perform physical tasks. However, there is a
                critical misconception that needs to be addressed:{' '}
                <strong>
                  physical strength does NOT protect you from spinal injury caused by poor technique
                </strong>
                .
              </p>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  <strong className="text-white">correct spinal alignment</strong> to distribute
                  forces safely. No amount of strength compensates for poor technique.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Endurance:</strong> fitter workers can sustain
                      physical work for longer before fatigue sets in
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Recovery:</strong> fitter workers recover more
                      quickly between tasks and between shifts
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Core stability:</strong> strong core muscles
                      support the spine during lifting (but only when good technique is used)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Flexibility:</strong> allows the body to move
                      through the correct range of motion without strain
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-emerald-400">Key Principle:</strong> Fitness{' '}
                  <strong>supports</strong> safe manual handling but does not{' '}
                  <strong>replace</strong> good technique, proper planning, or the use of mechanical
                  aids. The hierarchy of controls under the MHOR 1992 remains the same regardless of
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The body&rsquo;s capacity for manual handling changes throughout a person&rsquo;s
                working life. Understanding these changes is essential for both workers and
                employers when assessing manual handling risks.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Disc degeneration from 30s:</strong>{' '}
                      intervertebral discs lose water content and elasticity naturally from the
                      early 30s, reducing shock absorption
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Reduced muscle mass:</strong> sarcopenia
                      (age-related muscle loss) begins from approximately age 40 and accelerates
                      from 60
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Reduced flexibility:</strong> tendons and
                      ligaments become stiffer with age, reducing range of motion
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Slower recovery:</strong> older workers take
                      longer to recover from physical exertion and minor injuries
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Reduced bone density:</strong> bones become
                      more brittle, increasing fracture risk
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-emerald-400">Experience vs Capability:</strong> Older
                  workers bring invaluable experience &mdash; they are often better at assessing
                  risks, planning lifts, and using correct technique. However, experience does not
                  change the physical reality of age-related degeneration. The best approach is to
                  combine the experience of older workers with appropriate mechanical aids and task
                  modifications.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Pregnancy creates <strong>specific and significant changes</strong> to the body that
                directly affect manual handling capacity. These changes require a dedicated risk
                assessment under the MHOR 1992 and the Management of Health and Safety at Work
                Regulations 1999 (Regulation 16).
              </p>
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Relaxin hormone:</strong> loosens ligaments
                      throughout the body (not just the pelvis), reducing stability in the spine,
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Changed centre of gravity:</strong> the growing
                      abdomen shifts the centre of gravity forward, increasing the load on the
                      lumbar spine and affecting balance
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Reduced abdominal muscle support:</strong> the
                      abdominal muscles stretch as the pregnancy progresses, reducing the core
                      stability needed for safe lifting
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Increased fatigue:</strong> pregnancy increases
                      metabolic demands, leading to earlier onset of fatigue
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  as soon as the employer is informed of the pregnancy. This assessment must
                  consider manual handling risks and be{' '}
                  <strong className="text-white">reviewed as the pregnancy progresses</strong>{' '}
                  because the worker&rsquo;s physical capabilities change throughout each trimester.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                <strong>significantly greater risk</strong> of injury during manual handling. The
                MHOR 1992 explicitly requires that individual capability &mdash; including
                pre-existing conditions &mdash; is considered as part of the risk assessment.
              </p>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  ...
                  <div className="flex items-start gap-2 text-sm text-white">
                    ...
                    <span>
                      ...
                      increases the risk of fractures under load
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-emerald-400">Duty to Disclose:</strong> Workers have a
                  responsibility to inform their employer of any pre-existing condition that may
                  affect their ability to carry out manual handling safely. This is not about
                  discrimination &mdash; it is about ensuring that the right adjustments are made to
                  protect the worker&rsquo;s health.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Medication can have a <strong>significant and often underestimated impact</strong>{' '}
                on manual handling safety. Both prescription and over-the-counter medications can
                affect a worker&rsquo;s ability to carry out manual handling safely.
              </p>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                      The worker may lift loads they would otherwise recognise as too heavy
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Drowsiness:</strong> many medications
                      (antihistamines, some painkillers, muscle relaxants) cause drowsiness and
                      reduced alertness
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Reduced coordination:</strong> some medications
                      affect balance and fine motor control
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Dizziness:</strong> blood pressure medications
                      can cause dizziness, particularly when standing from a crouched position
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Muscle weakness:</strong> some medications
                      (statins, for example) can cause muscle weakness or pain
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Fatigue is one of the most significant — and most underestimated — risk factors for
                manual handling injury. A fatigued worker is a <strong>dangerous worker</strong>,
                not because of any personal failing, but because fatigue fundamentally impairs the
                body&rsquo;s ability to perform physical tasks safely.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Reduced grip strength:</strong> tired hands are
                      weaker — loads are more likely to slip
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Poor posture:</strong> muscles tire and workers
                      adopt poor lifting postures to compensate
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Impaired concentration:</strong> workers make
                      poor decisions about loads, routes, and techniques
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Slower reaction times:</strong> less able to
                      respond to shifting loads or unexpected hazards
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Shortcut-taking:</strong> fatigue increases the
                      temptation to skip proper procedure to &ldquo;get it done&rdquo;
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Shift patterns:</strong> avoid scheduling the
                      heaviest manual handling at the end of long shifts
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-emerald-400 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Rest breaks:</strong> regular breaks are
                      essential &mdash; short, frequent breaks are more effective than one long
                      break
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-emerald-400 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Hydration:</strong> even mild dehydration (2%
                      body weight loss) reduces muscle performance by up to 20%
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-emerald-400 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Sleep quality:</strong> workers should be
                      encouraged to maintain good sleep hygiene &mdash; 7&ndash;9 hours per night
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-emerald-400 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Task rotation:</strong> rotate between heavy
                      and light tasks to allow muscle recovery
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                New and young workers (under 18, or new to the industry) are statistically at{' '}
                <strong>greater risk</strong> of manual handling injury. This is not simply about
                physical strength &mdash; it is about experience, awareness, and workplace culture.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Less experience:</strong> they cannot
                      &ldquo;read&rdquo; a load or a task the way an experienced worker can
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Poor risk recognition:</strong> they may not
                      recognise an unstable load, an awkward route, or a task that requires a team
                      lift
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Desire to prove themselves:</strong> may take
                      on loads that are too heavy rather than ask for help
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">More likely to take shortcuts:</strong> less
                      ingrained safety habits and a tendency towards speed over safety
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Reluctance to report:</strong> may not report
                      symptoms or difficulties for fear of appearing incapable
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-emerald-400">Supervision Requirement:</strong> New and
                  young workers must receive closer supervision during manual handling tasks. This
                  includes direct observation, pairing with experienced colleagues, clear
                  instruction on when to ask for help, and regular feedback on technique.
                  Supervision should be gradually reduced as competence is demonstrated, not removed
                  on day one.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The &ldquo;I&rdquo; in the <strong>TILE assessment</strong> stands for{' '}
                <strong>Individual capability</strong>. This is not a tick-box exercise &mdash; it
                requires genuine consideration of the specific worker who will be carrying out each
