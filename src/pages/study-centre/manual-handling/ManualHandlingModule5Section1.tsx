...
const quickCheckQuestions = [
  {
    id: 'msd-definition',
    question: 'Which of the following is NOT classified as a musculoskeletal disorder?',
    options: [
...
const faqs = [
  {
    question: 'What is the difference between an acute MSD and a chronic MSD?',
    answer:
  ...
  {
    question: 'Can MSDs from manual handling be permanently disabling?',
    answer:
  ...
  {
    question: 'What is the role of physiotherapy in treating workplace MSDs?',
    answer:
...
const quizQuestions = [
  ...
  {
    id: 2,
    question: "What is the medical term for the condition commonly known as 'tennis elbow'?",
    options: [
      'Carpal tunnel syndrome',
      'Rotator cuff tear',
  ...
  {
    id: 4,
    question: 'Lower back pain from manual handling most commonly involves which spinal structure?',
    options: [
  ...
  {
    id: 6,
    question: 'Which of the following is a key component of a phased return-to-work programme?',
    options: [
...
export default function ManualHandlingModule5Section1() {
  useSEO({
    title: 'Musculoskeletal Disorders | Manual Handling Module 5.1',
    description:
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
          ...
          <div className="p-4 rounded-lg bg-emerald-500/5 border-l-2 border-emerald-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li className="flex items-start gap-2">
                ...
                <span>
                  <strong>MSDs</strong> affect muscles, tendons, ligaments, nerves, joints,
              ...
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                <span>
                  <strong>Early reporting</strong> = better outcomes and faster recovery
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                <span>
                  <strong>Treatment:</strong> rest, physio, medication &mdash; surgery only as last
                  resort
                </span>
              </li>
            </ul>
          ...
          <div className="p-4 rounded-lg bg-emerald-500/5 border-l-2 border-emerald-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                <span>
                  <strong>Back pain</strong> is the #1 cause of long-term sickness in construction
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                <span>
                  <strong>Phased return:</strong> gradual increase in duties over weeks
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                <span>
                  <strong>Untreated MSDs</strong> can lead to permanent disability
                </span>
              </li>
            </ul>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Musculoskeletal disorders (MSDs) are injuries or conditions that affect the{' '}
                <strong>
                  muscles, tendons, ligaments, nerves, joints, cartilage, and spinal discs
                </strong>
                . They are the most common type of workplace injury in the UK, accounting for a
                significant proportion of all work-related ill-health cases reported to the HSE each
                year.
              </p>

              <p>
                In the context of manual handling, MSDs typically develop through two mechanisms:{' '}
                <strong>acute injury</strong> (a sudden event such as a muscle tear from lifting too
                heavy a load) or <strong>cumulative strain</strong> (gradual damage from repetitive
                movements, sustained awkward postures, or long-term overloading of the body).
              </p>
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm text-white">
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Muscles</strong> &mdash; strains, tears,
                      chronic fatigue
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Tendons</strong> &mdash; tendinitis,
                  ...
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Ligaments</strong> &mdash; sprains,
                      instability, chronic laxity
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Nerves</strong> &mdash; compression,
                  ...
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Joints</strong> &mdash; inflammation,
                  ...
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Cartilage</strong> &mdash; wear, degeneration,
                      meniscal tears
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Spinal discs</strong> &mdash; bulging,
              ...
              <p>
                ...
                <strong>broad category of disorders</strong> that range from mild, temporary
                discomfort to severe, permanent disability. The earlier they are identified and
                managed, the better the outcome.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The following are the most common musculoskeletal disorders associated with manual
                handling activities in the electrical and construction industries.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Disc bulge:</strong> disc wall weakens and
                      bulges outward, pressing on nerves
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Disc herniation:</strong> disc wall ruptures
                      and the gel-like nucleus pushes out, compressing the spinal nerve root
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Sciatica:</strong> pain radiating down the leg
                      from nerve compression &mdash; often caused by disc herniation at L4/L5 or
                      L5/S1
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Difficulty gripping objects &mdash; turning door handles, using tools
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Bursitis:</strong> inflammation of the
                      fluid-filled sacs that cushion the knee
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Meniscal tears:</strong> damage to the
                      cartilage from twisting under load
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Ligament strain:</strong> from sudden movements
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Recognising the early symptoms of an MSD is critical. Many workers dismiss early
                warning signs as &ldquo;just a bit of ache&rdquo; or &ldquo;normal for the
                job.&rdquo; This attitude allows conditions to progress from treatable to chronic
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Sudden severe pain during lifting &mdash; possible disc rupture or muscle tear
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                      Loss of bladder or bowel control &mdash; cauda equina syndrome (medical
                      emergency)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Early reporting is the single most important factor in achieving a good outcome from
                an MSD. <strong>Early intervention = better outcomes</strong>. This is not just a
                health and safety slogan &mdash; it is backed by extensive medical evidence.
              </p>
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Prevents progression:</strong> mild symptoms
                      can be managed before they become chronic
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Enables workplace adjustments:</strong> your
                      employer can modify tasks, provide mechanical aids, or rotate duties
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Faster access to treatment:</strong>{' '}
                      occupational health referral and physiotherapy can begin promptly
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Protects your long-term health:</strong> avoids
                      permanent damage that could end your career
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Creates a record:</strong> documented reports
                      support any future claims and help identify workplace trends
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-amber-400">Common Barriers to Reporting:</strong> Many
                  workers avoid reporting MSD symptoms because they fear being seen as
                  &ldquo;weak,&rdquo; worry about losing overtime or being moved off a job, or
                  believe the pain is &ldquo;normal&rdquo; for the trade. These barriers are
                  dangerous. A culture where reporting is encouraged and acted upon without penalty
                  is essential for preventing serious injury.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Treatment for MSDs follows a <strong>stepped approach</strong>, starting with the
                least invasive options and progressing only if necessary. Surgery is always a{' '}
                ...
                <div className="bg-emerald-500/10 border border-emerald-500/30 rounded-lg p-4">
                  ...
                  <ul className="text-sm text-white space-y-1">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                      <span>
                        Short-term rest &mdash; but NOT prolonged bed rest (this can worsen back
                        pain)
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                ...
                <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-4">
                  ...
                  <ul className="text-sm text-white space-y-1">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                      <span>
                        Only considered when conservative treatment has failed over months
                      </span>
                    </li>
                  </ul>
                </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                After an MSD-related absence, a <strong>phased return-to-work programme</strong> is
                the gold standard for getting workers back to full duties safely and sustainably.
                Rushing back too quickly risks re-injury and longer-term absence.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Gradual increase in hours:</strong> start with
                      reduced hours and build up over 2&ndash;6 weeks
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-emerald-400 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Modified duties:</strong> lighter tasks
                      initially, avoiding the specific movements that caused the MSD
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-emerald-400 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Workplace adjustments:</strong> provision of
                      mechanical aids, ergonomic equipment, or task rotation
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-emerald-400 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Regular review meetings:</strong> with the
                      worker, supervisor, and occupational health
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-emerald-400 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Ongoing physiotherapy:</strong> continued
                      rehabilitation exercises alongside work
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-emerald-400">The Goal:</strong> A phased return aims for a{' '}
                  <strong>sustainable return to full duties</strong> &mdash; not the fastest
                  possible return. Workers who return too quickly often suffer re-injury and end up
                  absent for even longer. A well-managed phased return protects both the worker and
                  the employer.
                </p>
              </div>
            </div>
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                <strong>ongoing management</strong> even after the initial treatment phase is
                complete. Long-term management is about maintaining function, preventing recurrence,
                and adapting work practices for the future.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Continued exercise:</strong> maintaining the
                      strengthening and flexibility exercises prescribed during rehabilitation
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Technique awareness:</strong> consistently
                      applying correct manual handling technique to prevent re-injury
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Workplace modifications:</strong> permanent
                      changes to tasks, equipment, or working patterns where necessary
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Regular health monitoring:</strong> periodic
                      occupational health reviews for workers with a history of MSDs
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Weight management:</strong> maintaining a
                      healthy weight reduces load on the spine and joints
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Prompt reporting of flare-ups:</strong> any
                      return of symptoms should be reported immediately to prevent a full relapse
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-emerald-400">Remember:</strong> An MSD that has occurred
                  once is more likely to recur. The tissue that was damaged is often weaker than
                  before, even after full recovery. Long-term management is not about living in fear
                  &mdash; it is about being <strong>informed and proactive</strong> so you can
                  continue working safely throughout your career.
                </p>
              </div>
            </div>
          </div>
