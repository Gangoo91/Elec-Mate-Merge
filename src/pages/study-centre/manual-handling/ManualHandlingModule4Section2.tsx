...
const quickCheckQuestions = [
  ...
  {
    id: 'mh-m4s2-ppe-grip',
    question: 'By how much can standard safety gloves reduce grip strength compared to bare hands?',
    options: [
...
const faqs = [
  ...
  {
    question: 'What adaptations should be made for manual handling on scaffold platforms?',
    answer:
  ...
  {
    question: 'How does cold weather affect manual handling beyond making surfaces slippery?',
    answer:
...
export default function ManualHandlingModule4Section2() {
  useSEO({
    title: 'Working in Construction Environments | Manual Handling Module 4.2',
    description:
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
          ...
          <div className="p-4 rounded-lg bg-emerald-500/5 border-l-2 border-emerald-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li className="flex items-start gap-2">
                ...
                <span>
                  <strong>Ground:</strong> uneven terrain doubles trip risk when loaded
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
              ...
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                <span>
                  <strong>Weather:</strong> wet, cold, and wind all increase handling risk
                </span>
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-emerald-500/5 border-l-2 border-emerald-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                <span>
                  <strong>Before:</strong> walk the route, check conditions, plan delivery
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                <span>
                  <strong>During:</strong> shorter steps, clear routes, team coordination
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Construction sites rarely have smooth, level floors. Excavations, backfilled
                trenches, loose rubble, temporary ramps, and unpaved areas create surfaces that are
                fundamentally different from the flat floors assumed in standard manual handling
                training. When carrying a load across uneven ground, the risk of tripping or losing
                balance is <strong>significantly increased</strong> because the body must constantly
                adjust posture to maintain stability.
              </p>

              <p>
                On a flat surface, a person carrying a load can predict where each step will land.
                On uneven ground, each step is slightly different &mdash; higher, lower, softer, or
                angled. This constant adjustment engages core muscles that are already under load
                from carrying, accelerating fatigue. If the foot lands unexpectedly on an uneven
                surface, the resulting jolt is transmitted through the spine while it is already
                loaded, increasing the risk of disc injury.
              </p>

              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                <p className="text-sm text-white leading-relaxed">
                  <strong className="text-emerald-400">Key Point:</strong> Always walk the carrying
                  route before lifting the load. Identify trip hazards, soft spots, and level
                  changes. Clear or mark obstacles. On slopes, always carry the load uphill rather
                  than downhill where possible &mdash; walking downhill with a load puts
                  significantly more strain on the knees and increases the risk of losing control.
                  If the load must go downhill, take very short steps and consider using a trolley
                  or chute.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      Assess the route before every carry &mdash; conditions change daily on
                      construction sites
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      Use temporary walkways, boards, or compacted stone paths for regular carrying
                      routes
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      Reduce load weight on uneven ground &mdash; the safe weight is lower than on
                      flat floors
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      Take shorter steps to keep your centre of gravity over your feet at all times
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      Use wheeled equipment (sack trucks, trolleys) on firm ground but not on loose
                      or very soft surfaces
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                On busy construction sites, multiple trades often work in the same area
                simultaneously. Plumbers, plasterers, carpenters, and electricians may all need
                access to the same corridor, room, or ceiling void. This congestion creates manual
                handling risks that do not exist when working alone: <strong>blocked routes</strong>
                , <strong>restricted space</strong> for adopting correct postures,{' '}
                <strong>collision risk</strong> between workers carrying loads, and{' '}
                <strong>unexpected obstructions</strong> from other trades&rsquo; materials and
                equipment.
              </p>

              <p>
                The most dangerous scenario is when two workers carrying loads meet in a narrow
                corridor with no room to pass. Neither can easily put their load down, and both are
                under strain. The result is often an awkward sideways shuffle past each other, with
                loads at arm&rsquo;s length in poor posture. This is entirely preventable with
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      One-way traffic systems in narrow corridors during material delivery periods
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      Time-slot material deliveries so trades are not competing for the same space
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      Verbal warnings before moving long or heavy loads through occupied areas
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-teal-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Weather is a constantly changing environmental factor that directly affects every
                aspect of manual handling on construction sites. Unlike indoor work, outdoor and
                partially enclosed construction environments expose workers to conditions that can
                transform a routine handling task into a high-risk operation within minutes.
              </p>
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                ...
                <div className="space-y-3 text-sm text-white">
                  <div className="p-3 bg-white/5 rounded-lg">
                    ...
                    <p>
                      Rain makes surfaces slippery &mdash; concrete, steel plates, scaffold boards,
                      and ramps all become significantly more hazardous. Wet loads are harder to
                      grip. Wet cardboard packaging weakens and can fail, causing the contents to
                      drop. Visibility is reduced through safety glasses. Wet clothing adds weight
                      and restricts movement. Standing water on platforms creates a hydroplaning
                      effect under foot.
                    </p>
                  </div>
                  <div className="p-3 bg-white/5 rounded-lg">
                    <p className="font-medium text-white mb-1">Cold Conditions</p>
                    <p>
                      Cold reduces grip strength by restricting blood flow to the hands and fingers.
                      Reduced dexterity makes it harder to secure a firm hold on loads. Cold muscles
                      are stiffer, less flexible, and more prone to strain &mdash; the risk of a
                      muscle pull is higher in the first hour of a cold morning shift. Cold metal
                      and plastic surfaces draw heat from the hands rapidly, causing the grip to
                      weaken further.
                    </p>
                  </div>
                  <div className="p-3 bg-white/5 rounded-lg">
                    <p className="font-medium text-white mb-1">Wind</p>
                    <p>
                      Wind affects the stability of both the worker and the load. Large flat items
                      (plasterboard, plywood, sheet metal) act as sails and can be ripped from the
                      handler&rsquo;s grip or push the handler off balance. Even smaller items can
                      be affected in strong gusts. At{' '}
                      <strong>Beaufort Force 4 (13&ndash;18 mph)</strong>, large sheet handling
                      should be reviewed. At <strong>Force 5 (19&ndash;24 mph)</strong>, most
                      outdoor manual handling of oversized items should stop.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <p>
                Weather assessment must be part of the daily site start-up procedure. Check the
                forecast, observe current conditions, and set trigger points for reviewing or
                stopping manual handling activities. Conditions can change rapidly &mdash; a dry
                morning can become a wet afternoon, and a calm start can give way to gusty winds by
                midday.
              </p>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Personal protective equipment (PPE) is essential on construction sites, but it
                creates secondary effects that impact manual handling capability. PPE is designed to
                protect against specific hazards (impact, cuts, eye injuries), but it also{' '}
                <strong>restricts movement, reduces sensitivity, and limits vision</strong>. These
                effects must be factored into manual handling risk assessments.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white">
                  <p>
                    ...
                    20&ndash;30% compared to bare hands. They also reduce tactile feedback &mdash;
                    the ability to feel whether a load is slipping. This means loads that feel
                    secure may be closer to the slip threshold than the handler realises.
                    Grip-enhanced gloves with textured palms reduce but do not eliminate this
                    effect.
                  </p>
                  <p>
                    <strong className="text-white">Hard hats (limited upward vision):</strong> The
                    brim and peak of a hard hat restrict the field of vision, particularly when
                    looking upward. When lifting items above shoulder height, mounting cable tray to
                    a ceiling, or positioning items on high shelves, the handler cannot see the
                    target clearly without tilting the head back uncomfortably. This neck
                    hyperextension while lifting is a compounding risk.
                  </p>
                  <p>
                    <strong className="text-white">
                      Safety boots (reduced ankle flexibility):
                    </strong>{' '}
                    Safety boots with rigid soles and ankle reinforcement reduce the natural range
                    of motion in the ankle and foot. This makes it harder to achieve a proper squat
                    lifting position and reduces balance on uneven surfaces. The added weight of
                    steel toe caps (approximately 200&ndash;400 g per boot) also increases energy
                    expenditure over a full working day.
                  </p>
                  <p>
                    <strong className="text-white">Hi-vis clothing (heat retention):</strong> In
                    warm weather, hi-vis jackets and vests add a layer of insulation that increases
                    the rate of heat build-up and sweating. Excessive sweating reduces grip on
                    smooth surfaces and accelerates fatigue. In hot conditions, additional rest
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white leading-relaxed">
                  ...
                  hands to cuts, abrasions, and chemical contact.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Scaffold platforms present a unique combination of manual handling challenges:{' '}
                <strong>limited space</strong>, <strong>potential board gaps</strong>,{' '}
                <strong>height exposure</strong>, and{' '}
                <strong>restricted access for materials</strong>. Working on a scaffold platform
                means handling materials in an environment that is fundamentally more constrained
                and hazardous than ground level.
              </p>

              <p>
                Materials should be lifted to scaffold level using mechanical means &mdash; a gin
                wheel (pulley), material hoist, or crane. Workers must{' '}
                <strong>never carry loads up scaffold ladders</strong> because safe ladder use
                requires three points of contact. A worker carrying a load on a ladder has, at best,
                two points of contact, and the load shifts their centre of gravity away from the
                ladder, dramatically increasing fall risk.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      Lift materials to platform level mechanically, not by carrying up ladders
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      Keep loads small and manageable on platforms &mdash; there is no room to
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      Never stack materials above guard rail height &mdash; they can topple over the
                      edge
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>Maintain a clear walkway on the platform at all times</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      Check board condition &mdash; warped, cracked, or wet boards are a slip and
                      trip hazard
                    </span>
                  </li>
                </ul>
          ...
          <div className="border-l-2 border-amber-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                <strong>primary manual handling control measure</strong>. A tidy site with clear
                walkways, organised storage, and prompt waste removal directly reduces the risk of
                trips, slips, and falls during manual handling operations. Conversely, a cluttered
                site forces workers to step over obstacles, squeeze through gaps, and adopt awkward
                postures to navigate around obstructions while carrying loads.
              </p>

              <p>
                The HSE identifies poor housekeeping as a contributing factor in a significant
                proportion of manual handling incidents on construction sites. Common culprits
                include offcuts of cable and conduit on the floor, trailing temporary power leads,
                packaging materials left in walkways, tools and equipment stored at ankle-trip
                height, and materials leaning against walls where they can slide and fall.
              </p>

              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                <p className="text-sm text-white leading-relaxed">
                  <strong className="text-emerald-400">Key Point:</strong> Housekeeping is
                  everyone&rsquo;s responsibility, not just the labourer&rsquo;s. The CDM
                  Regulations 2015 require the principal contractor to maintain a tidy and safe
                  site, but every worker has a duty to clean up after their own work and to report
                  hazards they cannot address themselves. A 30-second tidy-up after each task
                  prevents a trip hazard for the next person carrying a load through the area.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-rose-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                One of the most effective but often overlooked manual handling controls is{' '}
                <strong>delivery coordination</strong> &mdash; planning where materials are
                delivered to minimise the distance and difficulty of on-site handling. The principle
                is simple: every metre a load needs to be carried manually is a metre of manual
                handling risk. Reducing the carrying distance reduces the exposure.
              </p>

              <p>
                Effective delivery coordination involves working with the supplier to arrange
                delivery to the closest practical point to the point of use. On multi-storey
                buildings, this may mean arranging crane lifts to specific floors, using goods
                lifts, or timing deliveries to coincide with periods when the hoist is available. It
                also means arranging for materials to arrive in manageable quantities rather than
                bulk drops that then require redistribution across the site.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      Arrange delivery to the nearest accessible point (floor, room, or zone)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      Order in quantities that match the capacity to store and handle safely
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      Coordinate with other trades so deliveries do not all arrive simultaneously
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      Confirm access routes, lifting equipment availability, and storage areas
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The following diagram illustrates the typical manual handling risk zones found on a
                construction site. Each zone presents different hazards that must be assessed and
                controlled.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 rounded-xl p-4 sm:p-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-4">
                    ...
                    <ul className="text-sm text-white space-y-1.5">
                      ...
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                        <span>Tailgate height &mdash; loads above shoulder when unloading</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                        <span>Congestion from multiple deliveries at peak times</span>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="bg-amber-500/10 border border-amber-500/20 rounded-lg p-4">
                    ...
                    <ul className="text-sm text-white space-y-1.5">
                      ...
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                        <span>Floor-level storage &mdash; bending/stooping to retrieve items</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                        <span>Weather exposure &mdash; uncovered storage makes items wet/icy</span>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="bg-red-500/10 border border-red-500/20 rounded-lg p-4">
                    ...
                    <ul className="text-sm text-white space-y-1.5">
                      ...
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                        <span>Narrow doorways requiring load rotation</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                        <span>Stairs &mdash; no lift available during build phase</span>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="bg-emerald-500/10 border border-emerald-500/20 rounded-lg p-4">
                    ...
                    <ul className="text-sm text-white space-y-1.5">
                      ...
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                        <span>Scaffold and MEWP platforms &mdash; restricted space</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                        <span>
                          Overhead work &mdash; materials at height, above shoulder handling
                        </span>
                      </li>
                    </ul>
                  </div>
                ...
                <div className="mt-4 p-3 bg-emerald-500/10 border border-emerald-500/20 rounded-lg">
                  <p className="text-xs text-white leading-relaxed">
                    ...
                    route and the controls at each stage.
                  </p>
                </div>
              </div>
            </div>
