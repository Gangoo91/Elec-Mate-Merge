...
const faqs = [
  {
    question: 'Should I refuse to handle a cable drum that weighs more than 25 kg on my own?',
    answer:
  ...
  {
    question: 'What is the best way to carry long lengths of cable tray through a building?',
    answer:
  ...
  {
    question: 'Are capstan winches mandatory for cable pulling, or can we pull by hand?',
    answer:
  ...
  {
    question: 'How should I handle heavy transformers that need to be positioned in plant rooms?',
    answer:
...
const quizQuestions = [
  {
    ...
    options: ['10-15 kg', '25-35 kg', '55-75 kg', '120-150 kg'],
    correctAnswer: 2,
    explanation:
  ...
  {
    id: 7,
    question: "How heavy can a fully loaded electrician's tool bag typically weigh?",
    options: ['1-3 kg', '5-8 kg', '10-20 kg', '40-50 kg'],
    correctAnswer: 2,
    explanation:
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
          ...
          <div className="p-4 rounded-lg bg-emerald-500/5 border-l-2 border-emerald-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li className="flex items-start gap-2">
                ...
                <span>
                  <strong>Cable drums:</strong> 20 kg to 500 kg+ &mdash; roll, never solo-lift
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                <span>
                  <strong>Long loads:</strong> cable tray needs two-person team carry
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
          ...
          <div className="p-4 rounded-lg bg-emerald-500/5 border-l-2 border-emerald-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                <span>
                  <strong>Before:</strong> check weights, plan route, gather aids
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                <span>
                  <strong>During:</strong> use drum jacks, team lifts, capstan winches
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                <span>
                  <strong>After:</strong> secure drums, tidy cable offcuts, store safely
                </span>
              </li>
            </ul>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Cable drums are one of the most commonly handled heavy items on an electrical
                installation. They range from small drums of data cable weighing around{' '}
                <strong>20 kg</strong> to large drums of armoured power cable that can exceed{' '}
                <strong>500 kg</strong>. The weight depends on the cable type, cross-sectional area,
                and the length on the drum. Even &ldquo;small&rdquo; drums of domestic twin and
                earth cable can weigh 40&ndash;70 kg for a 100-metre length in 6 mm&sup2; or 10
                mm&sup2; sizes.
              </p>

              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                <p className="text-sm text-white leading-relaxed">
                  <strong className="text-emerald-400">Key Point:</strong> The single most important
                  rule with cable drums is{' '}
                  <strong>never attempt to lift a loaded drum manually</strong>. Even drums that
                  appear manageable are deceptively heavy because the weight is concentrated and the
                  shape makes it impossible to hold the load close to the body. Rolling, drum jacks,
                  and mechanical lifting are the safe options.
                </p>
              </div>

              <p>
                <strong>Manual vs mechanical handling thresholds:</strong> For drums under
                approximately 25 kg (typically small data cable or short lengths of flex), a single
                person may be able to lift and position the drum onto a stand. For anything above 25
                kg, the drum should be rolled into position on the ground, or lifted onto a stand
                using a drum jack or two-person team lift. For drums above 50 kg, mechanical
                handling (forklift, pallet truck, or crane) should be used for any vertical lifting.
              </p>

              <p>
                <strong>Drum jacks and stands:</strong> A drum jack is a purpose-built frame that
                supports a horizontal bar (spindle) through the centre of the drum. The drum sits on
                the bar and can rotate freely, allowing cable to be paid off in a smooth, controlled
                manner. Before using a drum jack, you must check that the jack is rated for the
                weight of the loaded drum, that the spindle bar is the correct diameter for the
                drum&rsquo;s centre hole, and that the ground beneath the jack is firm, level, and
                stable.
              </p>

              <p>
                <strong>Rolling techniques:</strong> When rolling a cable drum along the ground,
                push rather than pull wherever possible. Keep your hands on the drum flanges (the
                flat circular sides), not on the cable. Roll on firm, level ground only &mdash;
                rolling on soft ground, gravel, or slopes requires additional control measures such
                as chocks, ropes, or a second person. On a slope, always position yourself uphill of
                the drum so it cannot roll towards you. Use chocks (wedges) to prevent the drum
                rolling when it is stationary.
              </p>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white leading-relaxed">
                  ...
                  slips, the drum drops unpredictably. Always use the drum&rsquo;s spindle hole with
                  a proper bar, or use the drum flanges for rolling only.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-teal-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                <strong>3 metres</strong>. While individual lengths are not excessively heavy
                (typically 3&ndash;12 kg depending on width and material), their{' '}
                <strong>length and rigidity</strong> make them awkward to handle. The primary risks
                are striking other workers, hitting door frames and walls during manoeuvring, and
                the leverage effect of a 3-metre length being held at one end.
              </p>

              <p>
                <strong>Team handling:</strong> Two people should carry each length, one at each
                end. This distributes the weight, controls the direction of travel, and allows the
                leading person to check for obstructions ahead. Communicate clearly and continuously
                &mdash; the person at the rear cannot see what is ahead.
              </p>

              <p>
                <strong>Carrying through doorways:</strong> A 3-metre length cannot pass straight
                through a standard 800 mm door opening without angling. Stop before the doorway,
                plan the pivot, and ensure nobody is on the other side. The trailing end swings
                outward during the turn, creating a sweep zone that can strike bystanders. One
                person should go through first, then guide the load through with the second person
                feeding it from behind.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      Consider cutting to shorter lengths before carrying if the route is complex
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      Use a shoulder carry for long straight corridors to distribute weight along
                      the forearm
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      Wear gloves &mdash; cut edges on metal tray are sharp enough to cause
                      lacerations
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      Check overhead clearance &mdash; the leading end can catch on ceiling
                      fixtures, sprinkler heads, or low beams
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      Stack tray neatly at the work area &mdash; loose lengths leaning against walls
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Distribution boards and consumer units range from small domestic units weighing{' '}
                <strong>2&ndash;5 kg</strong> to large three-phase distribution boards weighing{' '}
                <strong>15&ndash;40 kg</strong> or more when populated with MCBs, RCBOs, and
                busbars. The weight itself may not be extreme, but the{' '}
                <strong>installation posture</strong> creates the primary manual handling risk.
              </p>

              <p>
                Wall mounting a distribution board typically requires holding the board in position
                at chest height or above while simultaneously marking, drilling, and fixing. This
                creates a <strong>static hold at arm&rsquo;s length</strong> &mdash; one of the most
                demanding manual handling postures. Holding even 5 kg at arm&rsquo;s length
                generates forces equivalent to 15&ndash;20 kg at the shoulder joint due to the lever
                effect.
              </p>

              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                <p className="text-sm text-white leading-relaxed">
                  <strong className="text-emerald-400">Key Point:</strong> Use a temporary support
                  bracket. Screw a short length of timber or metal angle to the wall at the bottom
                  edge of the planned board position. Rest the board on this bracket while making
                  the fixings. Alternatively, have a second person hold the board in position while
                  the first person drills and fixes. Never attempt to hold a board with one hand and
                  drill with the other.
                </p>
              </div>

              <p>
                For large three-phase boards, the weight may require the board to be lifted into
                position using a small hoist, a scaffold lift, or a purpose-made mounting rig. Plan
                the mounting method before the board arrives on site &mdash; discovering that a 35
                kg board needs to be mounted at 1.8 metres with no plan for getting it there safely
                is a foreseeable failure.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Transformers are among the heaviest items an electrician will encounter. Even a
                small single-phase site transformer (110V) typically weighs{' '}
                <strong>25&ndash;50 kg</strong>. Three-phase distribution transformers range from{' '}
                <strong>200 kg to several tonnes</strong>. Oil-filled transformers are particularly
                heavy due to the combined weight of the copper windings, iron core, and insulating
                oil.
              </p>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white leading-relaxed">
                  ...
                  cranes, forklifts, or specialist rigging equipment with a detailed lift plan
                  prepared by a competent person.
                </p>
              </div>

              <p>
                When positioning transformers in plant rooms, check the floor loading capacity,
                ensure the route is clear and wide enough for the transport equipment, and verify
                that any ramps or thresholds can support the combined weight of the transformer and
                the handling equipment. For oil-filled transformers, also consider spill containment
                &mdash; a bund tray must be in position before the transformer is placed.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Electrical switchgear panels, motor control centres (MCCs), and main switch panels
                are large, heavy items that are typically delivered to site as assembled units. A
                standard floor-standing switchboard panel can weigh from{' '}
                <strong>100 kg to over 500 kg</strong> depending on its size and the equipment
                fitted within it. These items are <strong>never</strong> suitable for manual
                handling.
              </p>

              <p>
                Switchgear is typically moved using a combination of forklifts, pallet trucks,
                skates (roller platforms), and jacks. The delivery plan should include the route
                from the delivery vehicle to the final position, including any doorways, corridors,
                ramps, or lifts the panel must pass through. Verify that all openings are wide
                enough and that floor loading is adequate along the entire route.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>Survey the route from delivery point to final position</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>Check floor loading capacity at the final position</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>Arrange mechanical handling equipment rated for the load</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>Ensure the panel is secured and cannot topple once positioned</span>
                  </li>
                </ul>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-amber-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The <strong>cumulative weight of tool bags</strong> is one of the most overlooked
                manual handling risks for electricians. A fully loaded tool bag commonly weighs
                between <strong>10 and 20 kg</strong>. Carrying this repeatedly &mdash; from the van
                to the work area, up and down stairs, across construction sites, and back again
                &mdash; creates significant cumulative spinal loading over the course of a day, a
                week, and a career.
              </p>

              <p>
                In addition to the main tool bag, electricians frequently carry a test instrument
                case (multifunction tester: approximately 3&ndash;5 kg), a drill case (approximately
                3&ndash;6 kg), and consumables such as fixings, cable ties, and tape. The combined
                weight of all items carried in a single trip can easily exceed 30 kg &mdash; well
                above the safe single-person limit.
              </p>

              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                <p className="text-sm text-white leading-relaxed">
                  <strong className="text-emerald-400">Key Point:</strong> Only carry the tools you
                  need for the immediate task. Leave the rest in the vehicle or in a secure storage
                  point on site. Use a wheeled tool case or trolley for van-to-site transport. A
                  tool belt distributes weight across the hips rather than loading one shoulder, but
                  should be limited to lightweight items (screwdrivers, pliers, tape) rather than
                  heavy tools.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      Split into task-specific kits (first fix kit, second fix kit, testing kit)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>Use two smaller bags rather than one heavy bag to balance the load</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      Use a rucksack-style tool bag to distribute weight across both shoulders
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-rose-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Cable pulling &mdash; drawing cable through conduit, trunking, or underground ducts
                &mdash; is one of the most physically demanding manual handling tasks in electrical
                installation. The pulling force depends on the cable weight, the length of the run,
                the number of bends, and the friction between the cable sheath and the containment.
              </p>

              <p>
                <strong>Capstan winches:</strong> A capstan winch is a motorised drum that pulls a
                rope attached to the cable via a pulling eye or pulling grip. Capstan winches should
                be used for any pull where the required force exceeds what a person can safely and
                sustainably exert. As a practical guide, if the cable cannot be pulled with one hand
                using a smooth, steady motion, a capstan winch should be used.
              </p>

              <p>
                <strong>Cable lubricant:</strong> Applying cable-pulling lubricant (pulling
                compound) to the cable before and during the pull reduces friction between the cable
                sheath and the conduit or duct wall. This can reduce the pulling force by{' '}
                <strong>40&ndash;60%</strong> on long runs with bends. Lubricant is cheap, readily
                available, and one of the simplest controls for reducing manual handling risk during
                cable pulling.
              </p>

              <p>
                <strong>Pulling eyes and grips:</strong> A pulling eye is a fitting attached to the
                end of the cable that allows a pulling rope to be connected securely. Never pull
                cable by gripping the conductor or sheath directly &mdash; this damages the cable
                insulation and creates a grip-failure hazard where the cable can suddenly slip from
                the hands under tension.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      Calculate the expected pulling force before starting &mdash; cable
                      manufacturers provide friction coefficients
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      Position the drum on jacks at the feed end so cable pays off smoothly without
                      snagging
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      Use intermediate rollers at bends and edges to guide the cable and reduce
                      friction
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      Communicate between the pulling end and the feeding end &mdash; use radios on
                      long runs
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      Never stand in the line of a taut pulling rope &mdash; if it snaps, it whips
                      back with severe force
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The following table provides typical weight ranges for common electrical materials.
                Use this as a planning reference when assessing manual handling requirements for
                upcoming tasks.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 rounded-xl p-4 sm:p-6">
                  ...
                  <div className="bg-emerald-500/10 border border-emerald-500/20 rounded-lg p-4">
                    ...
                    <ul className="text-sm text-white space-y-1.5">
                      ...
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                        <span>
                          2.5 mm&sup2; T&amp;E (100 m): <strong>25&ndash;35 kg</strong>
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                        <span>
                          6 mm&sup2; T&amp;E (100 m): <strong>40&ndash;55 kg</strong>
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                        <span>
                          10 mm&sup2; T&amp;E (100 m): <strong>55&ndash;75 kg</strong>
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                        <span>
                          4-core SWA 25 mm&sup2; (100 m): <strong>180&ndash;250 kg</strong>
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                        <span>
                          Large armoured power cable: <strong>300&ndash;500+ kg</strong>
                        </span>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-4">
                    ...
                    <ul className="text-sm text-white space-y-1.5">
                      ...
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                        <span>
                          300 mm cable tray (steel): <strong>5&ndash;9 kg</strong>
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                        <span>
                          450 mm cable tray (steel): <strong>7&ndash;12 kg</strong>
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                  ...
                  <div className="bg-purple-500/10 border border-purple-500/20 rounded-lg p-4">
                    ...
                    <ul className="text-sm text-white space-y-1.5">
                      ...
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                        <span>
                          3-phase DB (populated): <strong>15&ndash;40 kg</strong>
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                        <span>
                          Floor-standing panel: <strong>100&ndash;500+ kg</strong>
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                  ...
                  <div className="bg-amber-500/10 border border-amber-500/20 rounded-lg p-4">
                    ...
                    <ul className="text-sm text-white space-y-1.5">
                      ...
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                        <span>
                          3-phase distribution TX: <strong>200&ndash;2,000+ kg</strong>
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                ...
                <div className="mt-4 p-3 bg-emerald-500/10 border border-emerald-500/20 rounded-lg">
                  <p className="text-xs text-white leading-relaxed">
                    ...
                    operation. If in doubt, treat the item as heavier than expected and use
                    mechanical aids.
                  </p>
                </div>
              </div>
