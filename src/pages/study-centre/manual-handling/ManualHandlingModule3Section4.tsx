...
const faqs = [
  {
    question: 'Is it always possible to eliminate manual handling entirely?',
    answer:
  ...
  {
    question: 'What is the difference between automation and mechanisation?',
    answer:
  ...
  {
    question: 'How can delivery planning reduce manual handling risk?',
    answer:
...
const quizQuestions = [
  ...
  {
    id: 5,
    question: 'Why should heavy items NOT be stored at floor level?',
    options: [
...
export default function ManualHandlingModule3Section4() {
  useSEO({
    title: 'Designing Out Manual Handling | Manual Handling Module 3.4',
    description:
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
          ...
          <div className="p-4 rounded-lg bg-emerald-500/5 border-l-2 border-emerald-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              ...
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                <span>
                  <strong>Substitute:</strong> lighter materials, smaller packages, pre-cut lengths
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
              ...
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                <span>
                  <strong>Improve:</strong> storage, delivery, workstation, packaging design
                </span>
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-emerald-500/5 border-l-2 border-emerald-500/50">
            <p className="text-emerald-400 text-base font-medium mb-2">Key Principle</p>
            <ul className="text-base text-white space-y-1.5">
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                <span>
              ...
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                <span>
                  <strong>Training</strong> alone is never sufficient &mdash; redesign the task
                  first
                </span>
              </li>
              <li className="flex items-start gap-2">
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Elimination is the <strong>most effective</strong> level of the hierarchy because it
                completely removes the manual handling risk. If the task no longer exists, no injury
                can occur from it. The question to ask is:{' '}
                <strong>&ldquo;Can this manual handling task be removed entirely?&rdquo;</strong>
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Redesigning the process</strong> so that the
                      load does not need to be moved at all &mdash; for example, locating a
                      distribution board adjacent to the cable entry point rather than across the
                      room, eliminating the need to carry the board.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Using pipework instead of cable</strong> in
                      certain applications, where the piped service eliminates the need to manually
                      pull heavy cable runs.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Prefabrication off site</strong> &mdash;
                      assembling cable looms, distribution boards, or control panels in a workshop
                      environment (where lifting aids are readily available) rather than assembling
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Remote or wireless systems</strong> &mdash;
                      wireless sensors, remote monitoring, and wireless lighting controls can reduce
                      the need for extensive cable installation in some applications.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-emerald-500">Key Point:</strong> Elimination requires
                  thinking about manual handling at the <strong>design and planning stage</strong>,
                  not after the problem has already been created. Once materials have been delivered
                  to the wrong location or equipment has been specified that requires heavy manual
                  handling, the opportunity for elimination has passed.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Where the manual handling task cannot be eliminated, the next step is to ask:{' '}
                <strong>
                  &ldquo;Can the load be made lighter, smaller, or easier to handle?&rdquo;
                </strong>{' '}
                Substitution replaces a more hazardous handling operation with a less hazardous one.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Lighter materials:</strong> Aluminium cable
                      tray instead of steel, plastic conduit instead of metal, lighter composite
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Smaller packages:</strong> Ordering 50-metre
                      cable drums instead of 100-metre drums reduces the weight by half. Requesting
                      that bulk materials are packed in smaller boxes rather than one large
                      container.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Pre-cut lengths:</strong> Ordering cable,
                      trunking, or conduit pre-cut to the required lengths eliminates the need to
                      handle full-length stock (which may be long, heavy, and unwieldy) and reduces
                      waste.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Concentrated products:</strong> Where chemical
                      products are used (for cleaning, sealing, or fire-stopping), concentrated
                      versions that are diluted on site reduce the weight of material that must be
                      transported.
                    </span>
                  </li>
                </ul>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Where the task cannot be eliminated or fully substituted, the next level is to use
                powered equipment to perform or assist with the handling.{' '}
                <strong>Automation</strong> removes the human from the handling entirely;{' '}
                <strong>mechanisation</strong> provides powered assistance while the human retains
                control.
              </p>
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  &mdash; otherwise the control measure is not effective.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Delivery planning is one of the most powerful and cost-effective methods of reducing
                manual handling. By controlling <strong>where, when, and how</strong> materials
                arrive on site, you can eliminate entire handling operations.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Direct to point of use:</strong> Specify that
                      materials be delivered as close as possible to where they will be installed.
                      Cable drums delivered to the riser room, distribution boards delivered to the
                      floor they will serve, containment delivered to the area where it will be
                      fixed.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Appropriate vehicle access:</strong> Ensure
                      delivery vehicles can get close to the unloading area. A lorry with a tail
                      lift parked next to the building entrance is far better than one parked 100
                      metres away across rough ground.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Timed deliveries:</strong> Schedule deliveries
                      to match the work programme so materials arrive when they are needed. This
                      avoids double-handling into and out of temporary storage.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Pallet-friendly delivery:</strong> Request that
                      heavy items are palletised in a way that allows pallet truck access. Specify
                      pallet dimensions compatible with doorway and corridor widths.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-emerald-500">Electrician Example:</strong> On a
                  multi-storey building project, arranging for cable drums to be craned directly
                  onto each floor through the building facade before it is closed in eliminates the
                  need to carry 100+ kg drums up stairwells. This requires planning during the
                  construction programme but saves enormous manual handling effort later.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                How and where materials are stored has a direct impact on the manual handling
                required to access them. Good storage design reduces bending, reaching, and carrying
                distances.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Heavy items at waist height:</strong> Store the
                      heaviest and most frequently accessed items between waist and shoulder height
                      (the &ldquo;power zone&rdquo;). This eliminates stooping and overhead reaching
                      for the items that pose the greatest risk.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Light items higher or lower:</strong> Lighter,
                      less frequently used items can be stored at higher or lower levels where the
                      reduced lifting capacity is acceptable.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">No floor storage of heavy items:</strong> Avoid
                      placing heavy items directly on the floor. Use racking, pallet positions, or
                      raised platforms to keep heavy items above knee height.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Clear access routes:</strong> Ensure aisles are
                      wide enough for trolleys and pallet trucks. Remove trip hazards. Maintain
                      clear routes from storage to work areas.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Labelling and organisation:</strong> Clear
                      labelling prevents workers from having to move multiple items to find what
                      they need. Good organisation reduces unnecessary handling.
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Workstation design focuses on organising the immediate work area to minimise harmful
                postures. For electricians, the &ldquo;workstation&rdquo; may be a bench in a
                workshop, a position at a distribution board, or a section of containment route.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Adjustable height:</strong> Work surfaces that
                      can be adjusted to suit each worker and each task. This eliminates bending and
                      stooping for shorter workers and overhead reaching for taller workers.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Reduce reaching:</strong> Position tools and
                      materials within easy arm&rsquo;s reach. Frequently used items closest,
                      occasionally used items further away. Avoid layouts that require twisting or
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Turntables and tilting devices:</strong>{' '}
                      Turntables allow the worker to rotate the workpiece rather than twisting their
                      body. Tilting stands bring the work face towards the worker, reducing bending.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Anti-fatigue matting:</strong> For workers who
                      stand for extended periods, anti-fatigue mats reduce leg and back fatigue,
                      improving comfort and reducing the cumulative strain of standing.
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                How a load is packaged directly affects how easy and safe it is to handle. Improving
                packaging is a practical, cost-effective method of reducing manual handling risk.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Handles and grip points:</strong> Adding
                      handles, hand holes, or textured grip surfaces allows the handler to maintain
                      a secure grip and keep the load close to the body. This alone can reduce
                      spinal loading by up to five times.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Smaller units:</strong> Breaking bulk supplies
                      into smaller, lighter packages reduces the weight per lift. Five boxes of 20
                      kg are generally safer than one box of 100 kg, even though the total weight is
                      the same.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Weight marking:</strong> Clearly marking the
                      weight of each package allows handlers to assess the risk before lifting and
                      decide whether assistance or a mechanical aid is needed.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Stable shape:</strong> Packaging that creates a
                      regular, stable shape with a central centre of gravity is easier and safer to
                      handle than irregular or asymmetric packaging.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Protection from hazards:</strong> Packaging
                      that protects the handler from sharp edges, rough surfaces, splinters, or
                      temperature extremes allows secure handling without the risk of reflexive
                      release.
                    </span>
                  </li>
                </ul>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Designing out manual handling is not a one-time activity. It is an ongoing process
                that should be embedded into project planning, procurement, site logistics, and
                daily work practices. Every decision &mdash; from which materials to specify, to
                where storage areas are located, to how deliveries are scheduled &mdash; either
                creates or prevents manual handling risk.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-emerald-500/70 mt-0.5 flex-shrink-0" />
                    <span>
                      Can this manual handling task be eliminated entirely by redesigning the
                      process?
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-emerald-500/70 mt-0.5 flex-shrink-0" />
                    <span>
                      Can lighter materials, smaller packages, or pre-cut lengths be substituted?
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-emerald-500/70 mt-0.5 flex-shrink-0" />
                  ...
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-emerald-500/70 mt-0.5 flex-shrink-0" />
                    <span>
                      Is the workstation designed to reduce reaching, bending, and twisting?
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-emerald-500/70 mt-0.5 flex-shrink-0" />
                    <span>
                      Does the packaging have handles, weight markings, and a stable shape?
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-emerald-500/70 mt-0.5 flex-shrink-0" />
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  approach is to design the risk out of the task first, then train workers in the
                  correct use of the controls that have been implemented. Training supplements good
                  design &mdash; it does not replace it.
                </p>
              </div>
            </div>
          </div>
