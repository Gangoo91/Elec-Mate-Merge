...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Twisting the trunk while lifting is a Task risk factor — it relates to what is being done (the physical demands and movements involved). The load weight is a Load factor, the pre-existing condition is an Individual factor, and the wet floor is an Environment factor.',
  },
  {
    id: 3,
    question:
      "Under the 'Individual' element of TILE, which of the following should be considered?",
    options: [
    ...
    correctAnswer: 2,
    explanation:
      'The Individual element considers factors specific to the person carrying out the task — including pregnancy, health conditions, physical capability, age, experience, fatigue, and whether they have received appropriate training.',
  },
  {
    id: 4,
    ...
    correctAnswer: 1,
    explanation:
      "The HSE's five-step process is: (1) Identify the hazards; (2) Decide who might be harmed and how; (3) Evaluate the risks and decide on precautions; (4) Record your significant findings; (5) Review your assessment and update if necessary.",
  },
  {
    id: 5,
    ...
    correctAnswer: 2,
    explanation:
      'In the MAC tool, RED indicates a high level of risk and that prompt action is needed to reduce the risk. GREEN indicates low risk, AMBER indicates medium risk requiring closer examination, and PURPLE indicates very high risk requiring immediate action.',
  },
  {
    id: 6,
    ...
    correctAnswer: 3,
    explanation:
      'A confined workspace with limited room to manoeuvre is an Environment risk factor — it relates to where the task is being carried out. Space constraints force workers into awkward postures and limit their ability to use proper lifting techniques.',
  },
  {
    id: 7,
...
export default function ManualHandlingModule1Section3() {
  useSEO({
    ...
    description:
      'TILE framework, five-step risk assessment process, HSE MAC tool, guideline filter figures, and recording manual handling assessment findings.',
  });
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-emerald-500/5 border-l-2 border-emerald-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Framework:</strong> TILE &mdash; Task, Individual, Load, Environment
              </li>
              <li>
                <strong>Process:</strong> Identify &rarr; Who &rarr; Evaluate &rarr; Record &rarr;
                Review
              </li>
              <li>
                <strong>MAC tool:</strong> Colour-coded scoring (green/amber/red/purple)
              </li>
              <li>
                <strong>Guideline:</strong> 25 kg for men at waist height (filter, not limit)
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-emerald-500/5 border-l-2 border-emerald-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>MAC:</strong> Manual Handling Assessment Charts (lift/carry/team)
              </li>
              <li>
                <strong>RAPP:</strong> Risk Assessment of Pushing and Pulling
              </li>
              <li>
                <strong>ART:</strong> Assessment of Repetitive Tasks
              </li>
              <li>
                <strong>V-MAC:</strong> Variable Manual Handling Assessment Charts
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The <strong>TILE framework</strong> is derived from Schedule 1 of the Manual
                Handling Operations Regulations 1992. It provides a structured, systematic approach
                to identifying all the risk factors associated with a manual handling operation.
                Each letter represents a category of risk factor, and all four must be assessed for
                every task.
              </p>
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1.5">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      Does it require reaching above shoulder height or below knee height?
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      Is there large vertical movement (e.g. lifting from floor to shoulder)?
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1.5">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      Does the person have any pre-existing health conditions (back problems, joint
                      conditions, hernias)?
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1.5">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      How heavy is the load? (Check packaging labels, delivery notes, or weigh it)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      Could the load cause harm if dropped (sharp edges, hazardous substances)?
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1.5">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      Is the temperature extreme (very hot causing sweat/fatigue, very cold reducing
                      grip)?
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      Are there obstacles, obstructions, or other hazards in the carrying route?
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-3 text-sm text-white/80">
                  <div className="bg-emerald-500/10 border border-emerald-500/30 rounded-lg p-3">
                    ...
                    <p>
                      Walk the workplace and observe all manual handling activities. Identify every
                      task that involves transporting or supporting a load by bodily force. Talk to
                      workers &mdash; they know which tasks cause pain, discomfort, or difficulty.
                      Check accident records and near-miss reports for manual handling incidents.
                    </p>
                  </div>
                  <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-3">
                    ...
                    <p>
                      Consider all workers who carry out each manual handling task. Include new
                      workers, young workers, pregnant workers, workers with existing health
                      conditions, agency staff, and contractors. Consider both immediate injury
                      (acute strains, fractures) and long-term harm (cumulative MSDs).
                    </p>
                  </div>
                  <div className="bg-amber-500/10 border border-amber-500/30 rounded-lg p-3">
                    ...
                    <p>
                      Use the TILE framework to evaluate each risk factor. Apply the hierarchy: can
                      the task be avoided? If not, what controls will reduce the risk? Use the HSE
                      MAC tool or other assessment methods to quantify risk where appropriate.
                      Prioritise actions based on the level of risk.
                    </p>
                  </div>
                  <div className="bg-purple-500/10 border border-purple-500/30 rounded-lg p-3">
                    ...
                    <p>
                      Document the hazards identified, the people at risk, the existing controls,
                      and any additional actions required. If you employ five or more people, you
                      must record the significant findings in writing. Use the HSE assessment forms
                      or your organisation&rsquo;s standard templates.
                    </p>
                  </div>
                  <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-3">
                    ...
                    <p>
                      Revisit the assessment whenever conditions change &mdash; new tasks, new
                      equipment, new workers, changes in the working environment, or following an
                      injury or near miss. Even without changes, review assessments at regular
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                risk assessment method developed by the HSE. It provides a structured,
                semi-quantitative approach to assessing the risk of manual handling operations using
                a colour-coded scoring system that makes it easy to identify high-risk tasks and
                prioritise improvements.
              </p>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-3">
                  MAC Tool &mdash; Colour-Coded Risk Levels
                </p>
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  ...
                  provides guideline filter figures to help identify tasks that need detailed
                  assessment. For a man lifting close to the body at waist height (elbow to knuckle
                  zone), the filter figure is <strong>25 kg</strong>. For a woman in the same
                  position, it is
                  <strong> 16 kg</strong>. These reduce significantly when the load is held away
                  from the body, when lifting above shoulder or below knee height, or when the task
                  involves twisting. These figures are <strong>filters, not safe limits</strong>{' '}
                  &mdash; loads below these figures can still be hazardous if other TILE factors are
                  unfavourable.
                </p>
              </div>
            </div>
            ...
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Task description:</strong> What manual handling
                      operation is being assessed? Be specific &mdash; &ldquo;lifting cable drums
                      from pallet to cable stand&rdquo; rather than just &ldquo;handling
                      cables&rdquo;
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">TILE risk factors:</strong> Record the specific
                      risk factors identified in each TILE category
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Who is at risk:</strong> Name the roles, not
                      just &ldquo;all workers&rdquo; &mdash; e.g. &ldquo;electricians, apprentices,
                      labourers involved in cable installation&rdquo;
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Existing controls:</strong> What measures are
                      already in place? (e.g. cable drum trolleys, team lift policy, manual handling
                      training)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Additional actions:</strong> What further
                      measures are needed? Who is responsible? By when?
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Risk rating:</strong> Overall risk level (using
                      MAC colour codes or a risk matrix)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Date and assessor:</strong> When the assessment
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Review date:</strong> When the assessment will
                      next be reviewed
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                      When the working environment changes (new site, different layout, new floor
                      surface)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                      When new workers are assigned to the task (especially young workers, pregnant
                      workers, or those with health conditions)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                      At regular intervals (annually as a minimum, or more frequently on dynamic
                      construction sites)
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  have altered, or new trades are working in the same area. Dynamic risk assessment
                  &mdash; briefly reassessing the task and conditions before each handling operation
                  &mdash; should become an automatic habit for all site workers.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <ul className="text-sm text-white/80 space-y-2">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong className="text-white">TILE framework:</strong> Task (what), Individual
                    (who), Load (what is handled), Environment (where) &mdash; all four must be
                    assessed
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Five-step process:</strong> Identify hazards
                    &rarr; Who is at risk &rarr; Evaluate and control &rarr; Record findings &rarr;
                    Review and update
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">MAC tool:</strong> Colour-coded scoring
                    (green/amber/red/purple) for lifting, carrying, and team handling operations
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Guideline figures:</strong> 25 kg for men, 16 kg
                    for women at waist height &mdash; filters, not legal limits
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Record and review:</strong> Document findings,
                    assign actions, and review whenever conditions change or after incidents
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Dynamic assessment:</strong> On construction
                    sites, briefly reassess before each handling operation as conditions change
                    frequently
                  </span>
                </li>
              </ul>
