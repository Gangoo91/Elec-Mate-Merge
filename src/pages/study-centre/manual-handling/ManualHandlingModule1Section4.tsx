...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 3,
    explanation:
      'The human spinal column consists of 33 vertebrae arranged in five regions: 7 cervical (neck), 12 thoracic (mid-back), 5 lumbar (lower back), 5 sacral (fused into the sacrum), and 4 coccygeal (fused into the coccyx/tailbone). The lumbar region bears the greatest load during manual handling.',
  },
  {
...
const quizQuestions = [
  {
    ...
    correctAnswer: 1,
    explanation:
      'The spinal column consists of 33 vertebrae in 5 regions: 7 cervical (C1-C7), 12 thoracic (T1-T12), 5 lumbar (L1-L5), 5 sacral (fused into the sacrum), and 4 coccygeal (fused into the coccyx).',
  },
  {
    id: 2,
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Disc herniation occurs when the tough outer ring (annulus fibrosus) tears or weakens, allowing the gel-like centre (nucleus pulposus) to bulge outward or extrude through the tear. This herniated material can compress adjacent spinal nerves, causing pain, numbness, and weakness.',
  },
  {
    id: 4,
    question: 'Which region of the spine bears the greatest compressive load during lifting?',
    options: ['Cervical (neck)', 'Thoracic (mid-back)', 'Lumbar (lower back)', 'Sacral (pelvis)'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    id: 5,
    question:
      'Which vertebral segments are most commonly affected by disc herniation from manual handling?',
    options: [
...
export default function ManualHandlingModule1Section4() {
  useSEO({
    ...
    description:
      'Spinal anatomy, intervertebral disc structure, disc herniation mechanisms, the S-curve, lumbar vulnerability, and common manual handling injuries.',
  });
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-emerald-500/5 border-l-2 border-emerald-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Vertebrae:</strong> 33 total across 5 regions of the spine
              </li>
              <li>
                <strong>Discs:</strong> Annulus fibrosus (outer ring) + nucleus pulposus (gel
                centre)
              </li>
              <li>
                <strong>S-curve:</strong> Natural shape distributes load evenly
              </li>
              <li>
                <strong>Most vulnerable:</strong> L4/L5 and L5/S1 (lowest lumbar segments)
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-emerald-500/5 border-l-2 border-emerald-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Disc prolapse:</strong> Nucleus pushes through torn annulus
              </li>
              <li>
                <strong>Muscle strain:</strong> Overstretched or torn muscle fibres
              </li>
              <li>
                <strong>Ligament sprain:</strong> Overstretched or torn spinal ligaments
              </li>
              <li>
                <strong>Sciatica:</strong> Nerve compression causing leg pain/numbness
              </li>
            </ul>
          </div>
        </div>
              ...
              <div className="bg-red-500/20 border-2 border-red-500/50 rounded-xl p-3">
                ...
                <div className="mt-2 p-2 bg-red-500/10 rounded-lg">
                  <p className="text-[10px] text-red-400 font-semibold text-center">
                    L4/L5 and L5/S1 &mdash; highest injury rate from manual handling
                  </p>
                </div>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
                ...
                <div className="space-y-3 text-sm text-white">
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        The neck region. The smallest and most mobile vertebrae. Supports the weight
                        of the head (~5 kg) and allows the widest range of head movement. C1 (atlas)
                        and C2 (axis) have unique shapes that allow nodding and rotation.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    <span className="flex items-center justify-center min-w-[50px] h-7 rounded-full bg-purple-500/20 text-purple-400 text-xs font-bold flex-shrink-0">
                      T1&ndash;T12
                    </span>
                    <div>
                      <p className="text-white font-medium">Thoracic (12 vertebrae)</p>
                      <p>
                        The mid-back region. Each thoracic vertebra articulates with a pair of ribs,
                        forming the ribcage. This rib attachment severely limits mobility but
                        provides excellent structural stability and protection for the heart and
                        lungs.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    <span className="flex items-center justify-center min-w-[50px] h-7 rounded-full bg-red-500/20 text-red-400 text-xs font-bold flex-shrink-0">
                      L1&ndash;L5
                    </span>
                    <div>
                      <p className="text-white font-medium">Lumbar (5 vertebrae)</p>
                      <p>
                        The lower back region. The largest and strongest vertebrae, because they
                        must bear the entire weight of the upper body. The lumbar region has
                        significant mobility (flexion, extension, lateral bending) but is the most
                        vulnerable to injury from manual handling because of the enormous forces it
                        must absorb.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    <span className="flex items-center justify-center min-w-[50px] h-7 rounded-full bg-amber-500/20 text-amber-400 text-xs font-bold flex-shrink-0">
                      S1&ndash;S5
                    </span>
                    <div>
                      <p className="text-white font-medium">Sacral (5 fused vertebrae)</p>
                      <p>
                        Five vertebrae fused into a single triangular bone called the sacrum. The
                        sacrum connects the spine to the pelvis via the sacroiliac joints. It
                        transmits the weight of the upper body to the legs.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    <span className="flex items-center justify-center min-w-[50px] h-7 rounded-full bg-emerald-500/20 text-emerald-400 text-xs font-bold flex-shrink-0">
                      Co1&ndash;4
                    </span>
                    <div>
                      <p className="text-white font-medium">Coccygeal (4 fused vertebrae)</p>
                      <p>
                        Four small vertebrae fused into the coccyx (tailbone). A vestigial structure
                        that provides attachment points for pelvic floor muscles and ligaments.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <p>
                The spine serves three critical functions: it{' '}
                <strong>supports the body&rsquo;s weight</strong>, it{' '}
                <strong>protects the spinal cord</strong> (the main nerve pathway between the brain
                and the body), and it <strong>allows movement</strong> (bending, twisting, and
                turning). These functions are in constant tension &mdash; the spine must be strong
                enough to bear heavy loads, flexible enough to allow a wide range of movement, and
                precise enough to protect the delicate nerve tissue within it.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Between each pair of vertebrae (except between C1 and C2, and in the fused sacral
                and coccygeal regions) sits an <strong>intervertebral disc</strong>. There are 23
                discs in total, and they perform a critical role: they act as{' '}
                <strong>shock absorbers</strong>, distribute compressive forces, and allow
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                ...
                <div className="space-y-3 text-sm text-white">
                  <div>
                    ...
                    <p>
                      A tough, multi-layered ring of fibrous tissue that forms the outer wall of the
                      disc. It consists of 15&ndash;25 concentric layers (lamellae) of collagen
                      fibres, arranged in alternating diagonal orientations. This criss-cross
                      pattern gives the annulus its remarkable strength and resilience. The annulus
                      contains the nucleus pulposus and resists the tensile, shear, and torsional
                      forces generated during spinal movement.
                    </p>
                  </div>
                  <div>
                    <p className="text-white font-medium">Nucleus Pulposus (Gel Centre)</p>
                    <p>
                      A soft, gelatinous mass located in the centre of the disc. It is composed of
                      approximately 80% water (in a young, healthy disc), along with collagen and
                      proteoglycans. The nucleus acts as a{' '}
                      <strong className="text-white">hydraulic shock absorber</strong> &mdash; when
                      the spine is compressed (as during lifting), the nucleus distributes the force
                      evenly across the disc surface. With age and degeneration, the nucleus loses
                      water content and becomes less effective.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1.5">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Cervical lordosis</strong> &mdash; the neck
                      curves inward (towards the front of the body)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Thoracic kyphosis</strong> &mdash; the mid-back
                      curves outward (away from the front)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Lumbar lordosis</strong> &mdash; the lower back
                      curves inward
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Sacral kyphosis</strong> &mdash; the sacrum
                      curves outward
                    </span>
                  </li>
                </ul>
                <p className="text-sm text-white leading-relaxed mt-3">
                  ...
                  mechanical forces along the length of the spine. A straight column would transmit
                  forces directly and be far more prone to failure. The S-curve gives the spine
                  approximately <strong>10 times more resilience</strong>
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  This is the disc&rsquo;s strongest configuration. When you bend forward (losing
                  the lumbar lordosis and flexing the spine), the compressive force concentrates on
                  the
                  <strong className="text-white"> front of the disc</strong>, and the
                  <strong className="text-white"> back of the annulus fibrosus</strong> is placed
                  under high tensile stress. This is exactly the condition that leads to posterior
                  disc herniation &mdash; the most common type of manual handling disc injury.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <div className="space-y-3 text-sm text-white">
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    ...
                    <p className="text-xs">
                      When the spine bends forward (flexion), the front of the vertebral bodies move
                      closer together, compressing the anterior part of the disc. The nucleus
                      pulposus is squeezed backwards like toothpaste in a tube.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    <p className="text-white font-medium text-xs mb-1">
                      Step 2: Posterior Annular Stress
                    </p>
                    <p className="text-xs">
                      As the nucleus migrates posteriorly, the posterior (back) portion of the
                  ...
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    ...
                    <p className="text-xs">
                      Under sustained or repeated loading &mdash; especially with simultaneous
                      flexion and rotation (bending and twisting) &mdash; the fibres of the
                      posterior annulus begin to tear. Tears may occur suddenly from a single heavy
                      load, or progressively from repeated micro-tears over months or years.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    <p className="text-white font-medium text-xs mb-1">Step 4: Nucleus Extrusion</p>
                    <p className="text-xs">
                      Once the annulus is breached, the nucleus pulposus bulges or extrudes through
                      the tear into the spinal canal. This herniated material can compress adjacent
                      spinal nerve roots, causing pain, numbness, tingling, and weakness in the back
                      and legs (sciatica).
                    </p>
                  </div>
                </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Flexion + compression</strong> &mdash; bending
                      forward while lifting a heavy load. This is the classic mechanism for
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Flexion + rotation + compression</strong>{' '}
                      &mdash; bending forward AND twisting while lifting. This is the single most
                      dangerous combination, halving the effective strength of the annulus and
                      concentrating force on a small area of the posterior-lateral disc.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Sustained flexion</strong> &mdash; holding the
                      spine in a bent-forward position for prolonged periods causes the posterior
                      annulus to &ldquo;creep&rdquo; (gradually stretch under constant load),
                      increasing vulnerability to subsequent loading.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Repetitive flexion</strong> &mdash; repeatedly
                      bending and straightening causes cumulative micro-damage to the annular
                      fibres. Research shows that even moderate loads can cause disc failure after
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white mb-3">
                  ...
                  from the body, the back muscles must generate enormous force to counterbalance it:
                </p>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  force on L5/S1 by approximately 50%. This is why the TILE assessment considers
                  hand distance from the lower back as a critical risk factor, and why correct
                  technique emphasises keeping the load as close to the centre of gravity as
                  possible.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-amber-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Manual handling can cause a range of injuries to the musculoskeletal system. The
                type and severity of injury depends on the forces involved, the tissues affected,
                and whether the injury is acute (sudden) or cumulative (gradual).
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-3 text-sm text-white">
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    ...
                    <p className="text-xs">
                      The nucleus pulposus extrudes through a tear in the annulus fibrosus,
                      potentially compressing adjacent nerve roots. Causes severe back pain, often
                      with radiating leg pain (sciatica), numbness, tingling, and weakness. The most
                      serious common injury from manual handling. May require surgery in severe
                      cases.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    ...
                    <p className="text-xs">
                      Overstretching or tearing of muscle fibres, usually the erector spinae (back
                      muscles) or the muscles of the shoulders and arms. Causes localised pain,
                      stiffness, and reduced range of movement. Usually heals within days to weeks,
                      but severe strains can take months.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    <div className="flex items-center gap-2 mb-1">
                    ...
                    <p className="text-xs">
                      Overstretching or tearing of the ligaments that stabilise the spinal joints
                      (supraspinous, interspinous, and posterior longitudinal ligaments). Causes
                      deep, aching pain that worsens with movement. Ligaments have a poor blood
                      supply and heal slowly &mdash; recovery can take weeks to months.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    <div className="flex items-center gap-2 mb-1">
                    ...
                    <p className="text-xs">
                      Compression of spinal nerve roots (usually by a herniated disc or bone spur)
                      causes pain that radiates along the nerve pathway. Sciatica &mdash;
                      ...
                      to the foot. Can be severely disabling.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    <div className="flex items-center gap-2 mb-1">
                    ...
                    <p className="text-xs">
                      Injury or degeneration of the small facet joints at the back of each vertebra.
                      These joints guide spinal movement and can be damaged by excessive extension
                      (arching back) or rotation under load. Causes localised back pain that worsens
                      with extension and twisting movements.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Greatest compressive load:</strong> The lowest
                      lumbar segments bear the cumulative weight of everything above them &mdash;
                      head, arms, trunk, plus any external load. L5/S1 bears the greatest
                      compressive force of any spinal segment.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Transition zone:</strong> L5/S1 is the junction
                      between the mobile lumbar spine and the fixed sacrum. This transition creates
                      a concentration of mechanical stress &mdash; the mobile segment above must
                      absorb forces that the rigid segment below cannot accommodate.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Wide range of motion:</strong> The L4/L5 and
                      L5/S1 segments have the greatest range of flexion (forward bending) in the
                      lower spine, which means the discs at these levels experience the greatest
                      changes in loading during lifting and bending.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Shear forces:</strong> The lumbosacral angle
                      (the angle at which L5 sits on the sacrum) creates a natural shear force that
                      tends to slide L5 forward on the sacrum. This shear force is amplified during
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Thinnest posterior annulus:</strong> The
                      posterior part of the annulus fibrosus is naturally thinner at L4/L5 and L5/S1
                      than at higher levels, making it the weakest point of the disc and the most
                      common location for herniation.
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-green-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                This section has explained the anatomical and biomechanical basis for manual
                handling injuries. Understanding how the spine works &mdash; and how it fails
                &mdash; is essential for appreciating why correct technique and risk assessment are
                so important.
              </p>
              ...
              <ul className="text-sm text-white space-y-2">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong className="text-white">33 vertebrae:</strong> Arranged in 5 regions
                    &mdash; cervical (7), thoracic (12), lumbar (5), sacral (5 fused), coccygeal (4
                    fused)
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Disc structure:</strong> Annulus fibrosus (tough
                    outer ring) + nucleus pulposus (gel centre) &mdash; acts as a hydraulic shock
                    absorber
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">S-curve:</strong> The natural alternating curves
                    distribute forces evenly and provide 10x more resilience than a straight column
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Herniation mechanism:</strong> Flexion +
                    compression squeezes nucleus posteriorly; adding rotation halves annular
                    strength &mdash; the most dangerous combination
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">L4/L5 and L5/S1:</strong> Most vulnerable due to
                    greatest load, transition zone, wide range of motion, shear forces, and thinnest
                    posterior annulus
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Common injuries:</strong> Disc prolapse, muscle
                    strain, ligament sprain, nerve compression/sciatica, facet joint dysfunction
                  </span>
                </li>
              </ul>
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-emerald-500">Module 1 Complete:</strong> You have now
                  covered the four foundation sections of Manual Handling Module 1 &mdash; what
                  manual handling is, the legal framework, risk assessment, and anatomy. In Module
                  2, we will build on this knowledge with practical lifting techniques, mechanical
                  aids, and workplace control measures.
                </p>
              </div>
            </div>
          </div>
