...
const faqs = [
  {
    question: 'What is the maximum weight I should handle while kneeling in a restricted space?',
    answer:
  ...
  {
    question: 'Should I work alone in a loft, ceiling void, or under-floor space?',
    answer:
  ...
  {
    question: 'How should I pass materials through a loft hatch?',
    answer:
  ...
  {
    question: 'Is it safe to use a ladder while handling materials in a restricted space?',
    answer:
...
export default function ManualHandlingModule4Section3() {
  useSEO({
    title: 'Handling in Confined & Restricted Spaces | Manual Handling Module 4.3',
    description:
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
          ...
          <div className="p-4 rounded-lg bg-emerald-500/5 border-l-2 border-emerald-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li className="flex items-start gap-2">
                ...
                <span>
                  <strong>Posture:</strong> restricted space = reduced lifting capacity (50%+)
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                <span>
                  <strong>Weight:</strong> keep loads under 10 kg for kneeling work
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                <span>
                  <strong>Vertical:</strong> use rope/pulley for riser shafts, never throw
                </span>
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-emerald-500/5 border-l-2 border-emerald-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                <span>
                  <strong>Before:</strong> measure the space, plan material sizes, buddy system
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                <span>
                  <strong>During:</strong> small loads, frequent breaks, knee pads, lighting
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                <span>
                  <strong>After:</strong> stretch, report any discomfort, limit repeat exposure
                </span>
              </li>
            </ul>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Loft spaces under pitched roofs are among the most common restricted environments
                where electricians work. Typical domestic lofts have headroom ranging from{' '}
                <strong>
                  0.6 metres at the eaves to approximately 1.8&ndash;2.2 metres at the ridge
                </strong>
                . This means that a large proportion of the space does not allow the worker to stand
                upright. The worker is forced to <strong>kneel, crouch, crawl, or shuffle</strong>{' '}
                while handling cables, junction boxes, lighting components, and insulation.
              </p>

              <p>
                When the body cannot stand upright, the normal lifting technique is impossible. The
                spine is held in a flexed (bent forward) position, which places significantly more
                stress on the lumbar discs than a neutral standing posture. A person who can safely
                lift 25 kg while standing upright with correct technique may only be able to safely
                manage <strong>5&ndash;10 kg</strong> while kneeling in a loft space. This dramatic
                reduction in capacity must be reflected in the planning of what materials are taken
                into the loft and how they are handled.
              </p>

              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                <p className="text-sm text-white leading-relaxed">
                  <strong className="text-emerald-400">Key Point:</strong>{' '}
                  <strong>Crawling with materials</strong> is a high-risk activity. The body weight
                  plus any carried load is concentrated on the knees against hard timber joists. The
                  joists are narrow (38&ndash;50 mm), creating intense point pressure on the
                  kneecaps. Knee pads are essential, but they only reduce &mdash; they do not
                  eliminate &mdash; the risk. Loft boarding across the joists provides a wider, more
                  comfortable surface to kneel on and prevents the risk of stepping between joists
                  and going through the ceiling below.
                </p>
              </div>

              <p>
                <strong>Insulation handling:</strong> Loft insulation rolls are lightweight but
                bulky. Mineral wool insulation is also an irritant &mdash; fibres can irritate the
                skin, eyes, and respiratory system. Handling insulation in a confined loft space
                with poor ventilation and restricted movement compounds these risks. Wear long
                sleeves, gloves, eye protection, and an FFP2 dust mask when handling mineral wool
                insulation. Take regular breaks outside the loft space to clear the lungs and cool
                down, as loft temperatures can be extremely high in summer and extremely cold in
                winter.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      Install loft boarding before starting work &mdash; provides a stable kneeling
                      surface
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>Use a head torch to keep both hands free for handling</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      Pass items through the hatch in small quantities &mdash; under 10 kg per item
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      Wear knee pads &mdash; essential for any work requiring kneeling on joists
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      Take breaks every 20&ndash;30 minutes &mdash; restricted postures cause
                      fatigue faster
                    </span>
                  </li>
                </ul>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Working above suspended ceilings &mdash; in the void between the ceiling grid and
                the structural soffit above &mdash; is a daily task for many electricians installing
                or maintaining lighting, data cabling, and fire alarm systems. The void typically
                ranges from <strong>300 mm to 800 mm</strong> in depth, and the worker accesses it
                by removing ceiling tiles and reaching up from a step ladder, podium, or scaffold
                platform below.
              </p>

              <p>
                The primary manual handling challenge is that{' '}
                <strong>all work is above head height</strong>. The worker is reaching upward with
                arms extended, handling materials in the weakest part of the lifting zone (above
                shoulder and above head). Visibility is poor because the head is often below the
                ceiling line while the hands are in the void. The worker cannot see what they are
                handling, leading to &ldquo;blind&rdquo; positioning of cables, containment, and
                fixings.
              </p>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white leading-relaxed">
                  ...
                  Suspended ceiling grids are designed to support only the weight of the tiles and
                  lightweight fixtures. They will collapse under the weight of a person, causing a
                  fall that can result in serious injury or death. All body weight must remain on
                  the access equipment (ladder, podium, scaffold) at all times.
                </p>
              </div>

              <p>
                Materials placed in the ceiling void must be supported by the building structure
                &mdash; independent brackets fixed to the structural soffit, threaded rod hangers,
                or structural beams. The ceiling grid itself must never be used to support cable
                tray, heavy cables, or equipment. Even a relatively small concentrated load on a
                ceiling grid runner can cause the grid to deflect, sag, or collapse.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      Use a podium or scaffold rather than a step ladder for extended ceiling void
                      work
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      Keep items small and light &mdash; pass individual components, not assembled
                      units
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>Use a task light or head torch to improve visibility in the void</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      Take frequent breaks from overhead work &mdash; sustained above-head posture
                      causes rapid shoulder fatigue
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-teal-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Under-floor crawl spaces are among the most restrictive environments an electrician
                encounters. Typical clearances range from <strong>300 mm to 600 mm</strong> between
                the ground and the underside of the floor above. In some older properties, the
                clearance may be even less. The worker must lie flat, crawl on their front or back,
                and push or pull materials alongside them.
              </p>

              <p>
                In this environment, <strong>normal lifting technique is impossible</strong>. There
                is no room to squat, bend, or use any standard posture. Materials must be slid,
                dragged, or pushed along the ground. The spine is either flexed (lying on the front)
                or extended (lying on the back looking up), neither of which is a safe position for
                handling weight. The maximum load is effectively whatever can be pushed along the
                ground with one hand while lying down &mdash; typically just a few kilograms.
              </p>

              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                <p className="text-sm text-white leading-relaxed">
                  <strong className="text-emerald-400">Key Point:</strong> Break materials down into
                  the smallest practical sizes before entering the crawl space. Carry cable in short
                  pre-cut lengths, not on a drum. Take individual junction boxes, not a bag of ten.
                  Use a small tray or bucket that can slide alongside you for fixings and small
                  components. The goal is to minimise the number of trips in and out of the space by
                  preparing everything in advance, while keeping each individual load very light.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      Check for hazards before entering: standing water, vermin, asbestos, sharp
                      objects
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      Use a ground sheet or crawler board to protect clothing and provide a smoother
                      surface
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      Buddy system &mdash; a second person at the access point to pass materials and
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      Limit time in the crawl space &mdash; come out every 15&ndash;20 minutes to
                      stretch and recover
                    </span>
                  </li>
                </ul>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Electrical risers and service shafts are vertical spaces within buildings that house
                cables, busbars, and containment running between floors. They are typically narrow
                (often less than 1 metre wide), congested with existing services, and require
                materials to be moved <strong>vertically</strong> &mdash; either up from a lower
                floor or down from above.
              </p>

              <p>
                Vertical handling in a riser requires a fundamentally different approach from
                horizontal carrying. Materials must be raised or lowered in a controlled manner
                using a{' '}
                <strong>
                  rope and pulley system, small electric hoist, or dedicated shaft lift
                </strong>
                . The shaft opening at each floor level must be secured with a gate, barrier, or
                temporary cover when not in active use, to prevent materials (or people) from
                falling through.
              </p>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white leading-relaxed">
                  ...
                  static weight. It can seriously injure anyone below, damage existing services, and
                  create debris that blocks the shaft. All vertical material movement must be
                  controlled.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong>Rope and pulley:</strong> simple, portable, suited for loads up to
                      approximately 25 kg
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong>Small electric hoist:</strong> reduces manual effort, suited for
                      heavier or repetitive lifts
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong>Shaft lift/platform:</strong> purpose-built for multi-floor material
                      movement in larger risers
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong>Communication:</strong> person at each floor level communicating by
                      radio or shouting &ldquo;clear below&rdquo; before any movement
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Plant rooms house heavy mechanical and electrical equipment &mdash; boilers,
                chillers, pumps, switchgear, transformers, and UPS systems &mdash; in spaces that
                are often <strong>tightly packed with narrow aisles</strong> between equipment.
                Installing, maintaining, or replacing electrical components in plant rooms requires
                handling materials in spaces where there is very little room to manoeuvre.
              </p>

              <p>
                The primary challenge is that{' '}
                <strong>
                  the route from the door to the work position may be narrow and tortuous
                </strong>
                , with 90-degree turns around equipment, low overhead pipes, and raised cable runs
                to step over. A load that is easy to carry in a straight line down a corridor
                becomes extremely difficult to navigate around these obstacles. The handler must
                often turn their body sideways, lift the load over obstructions, and make precise
                positioning movements &mdash; all in a space that provides no margin for error.
              </p>

              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                <p className="text-sm text-white leading-relaxed">
                  <strong className="text-emerald-400">Key Point:</strong> Plan the handling
                  operation in detail before starting. Walk the route from the door to the
                  positioning point. Measure the narrowest gap, the lowest overhead obstruction, and
                  the tightest turn. Confirm that the item will physically fit through every point
                  on the route. If it does not, the item may need to be partially disassembled, or
                  temporary removal of obstructions may be required (with isolation and
                  reinstatement).
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      Use skates (roller platforms), jacks, and small trolleys designed for tight
                      spaces
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>Ensure adequate lighting &mdash; plant rooms are often poorly lit</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      Check for hot surfaces (pipes, equipment) that could cause burns during
                      handling
                    </span>
                  </li>
                </ul>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-amber-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Handling materials while standing on access equipment (ladders, podiums, scaffold,
                MEWPs) adds a layer of risk because the handler is on an elevated, limited platform.
                Any fumble, imbalance, or unexpected load shift that would be harmless at ground
                level can cause a fall from height when on access equipment.
              </p>

              <p>
                <strong>Ladders should be avoided</strong> for material handling wherever possible.
                A ladder requires three-point contact, leaving only one hand available for work.
                Handling any load of significant weight on a ladder means the worker has only one
                hand on the ladder and one on the load &mdash; a fall is one fumble away. Podium
                steps, low-level scaffold, or MEWPs are strongly preferred because they provide a
                stable platform, free both hands, and include guard rails.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong>Ladder:</strong> avoid for handling &mdash; only acceptable for very
                      light items (under 3 kg) for under 5 minutes
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong>Podium steps:</strong> good for ceiling void work &mdash; stable
                      platform, both hands free
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong>Low-level scaffold:</strong> best for sustained work above head height
                      with materials
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong>MEWP:</strong> excellent for heavy items at height &mdash; items can
                      be placed on the platform floor
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-rose-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Restricted spaces often appear to be &ldquo;one-person&rdquo; environments because
                there is physically only room for one worker inside. However, this does not mean the
                handling task should be a solo operation. A <strong>buddy system</strong> &mdash;
                with one person in the restricted space and a second person at the access point
                &mdash; is the recommended approach for most restricted-space handling tasks.
              </p>

              <p>
                The person at the access point serves multiple functions: they pass materials into
                the space in manageable quantities, they receive materials being passed out, they
                maintain communication with the person inside, and they are ready to raise the alarm
                if the person inside becomes injured or unwell. This division of labour also means
                the person inside the restricted space does not need to repeatedly enter and exit to
                collect materials, which reduces their exposure to the awkward postures.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white">
                  <p>
                    ...
                    a single cable through a ceiling void or checking a junction box in a loft. The
                    worker should inform a colleague of their location and expected return time.
                  </p>
                  <p>
                    <strong className="text-white">Buddy system (standard approach):</strong> One
                    person in the space, one at the access point. Used for any task over 15 minutes,
                    any task involving multiple items, or any space where the risk of injury or
                    entrapment exists. This is the recommended default approach.
                  </p>
                  <p>
                    <strong className="text-white">Full team (complex or high-risk):</strong>{' '}
                    Multiple people at various positions (inside, access point, material supply,
                    supervision). Used for riser installations, plant room equipment moves, or any
                    task requiring multiple handling operations in sequence.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The following comparison grid summarises the handling solutions for each type of
                restricted space commonly encountered by electricians.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 rounded-xl p-4 sm:p-6">
                ...
                <div className="mt-4 p-3 bg-emerald-500/10 border border-emerald-500/20 rounded-lg">
                  <p className="text-xs text-white leading-relaxed">
                    ...
                    specific space and posture before determining safe load limits.
                  </p>
                </div>
              </div>
            </div>
