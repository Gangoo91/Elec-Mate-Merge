...
const quickCheckQuestions = [
  ...
  {
    id: 'mh-mac-tool-red',
    question: 'In the HSE MAC tool, what does a RED risk band indicate?',
    options: [
...
const faqs = [
  ...
  {
    question: 'Can I use the MAC tool for pushing and pulling tasks?',
    answer:
...
const quizQuestions = [
  {
    id: 1,
    question: 'What is the first step in identifying manual handling hazards in a workplace?',
    options: [
  ...
  {
    id: 8,
    question: 'A purple rating on the MAC tool means:',
    options: [
...
export default function ManualHandlingModule3Section2() {
  useSEO({
    title: 'Identifying Manual Handling Hazards | Manual Handling Module 3.2',
    description:
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
          ...
          <div className="p-4 rounded-lg bg-emerald-500/5 border-l-2 border-emerald-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li className="flex items-start gap-2">
                ...
                <span>
                  <strong>Observe:</strong> watch workers doing actual tasks in real conditions
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                <span>
                  <strong>Analyse:</strong> review injury data and sickness absence patterns
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                <span>
                  <strong>Consult:</strong> ask the workers &mdash; they know the problems best
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                <span>
                  <strong>Assess:</strong> use HSE tools (MAC, RAPP, ART) for structured evaluation
                </span>
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-emerald-500/5 border-l-2 border-emerald-500/50">
            <p className="text-emerald-400 text-base font-medium mb-2">HSE Tools</p>
            <ul className="text-base text-white space-y-1.5">
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                <span>
                  <strong>MAC:</strong> Manual Handling Assessment Charts (lifting, lowering, team
                  handling)
                </span>
              </li>
              <li className="flex items-start gap-2">
              ...
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                <span>
                  <strong>ART:</strong> Assessment of Repetitive Tasks (upper limb)
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Workplace observation is the foundation of manual handling hazard identification. It
                involves{' '}
                <strong>watching workers perform actual tasks in real working conditions</strong>,
                rather than relying on written procedures or assumptions about how work is done.
                There is often a significant gap between the planned method of work and what
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Poor postures:</strong> Stooping, twisting,
                      overreaching, bending sideways, reaching behind the body, lifting with a
                      rounded back, working in a crouched position
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Rushing:</strong> Workers hurrying manual
                      handling tasks, skipping preparation steps, carrying too many items at once,
                      taking shortcuts
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Signs of discomfort:</strong> Rubbing backs,
                      stretching, grimacing, pausing to rest frequently, shifting grip repeatedly,
                      favouring one side
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      Trolleys, sack trucks, or hoists that are present but workers are carrying by
                      hand &mdash; find out why they are not being used
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Environmental conditions:</strong> Cluttered
                      walkways, wet floors, poor lighting, restricted space, temperature extremes,
                      steps or slopes on the route
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Improvised methods:</strong> Workers developing
                      their own techniques or workarounds (which may introduce new risks) because
                      the planned method does not work in practice
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-emerald-500">Observation Tip:</strong> Observe at
                  different times &mdash; start of shift (when workers are fresh), end of shift
                  (when fatigued), during peak workload (when time pressure is highest), and during
                  deliveries (when unplanned handling may occur). The hazards you see may be very
                  different at each time.
                </p>
              </div>

              <p>
                Task analysis takes observation further by systematically breaking down each manual
                handling task into its component steps and assessing the risk at each stage. This is
                particularly valuable for complex or multi-stage tasks where the hazards may not be
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ol className="text-sm text-white/80 space-y-2">
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Determine whether any steps can be eliminated, modified, or mechanised
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-0.5 w-5 h-5 rounded-full bg-emerald-500/20 border border-emerald-500/40 flex items-center justify-center flex-shrink-0 text-[10px] font-bold text-emerald-400">
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Reviewing historical injury data and sickness absence records is a powerful way to
                identify manual handling hazards that are already causing harm. Patterns in the data
                reveal which tasks, areas, or conditions are most problematic.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Accident/incident reports:</strong> Look for
                      reports involving strains, sprains, back pain, shoulder injuries, and other
                      musculoskeletal problems. Note the task being performed, the body part
                      affected, and the circumstances.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Sickness absence records:</strong>{' '}
                      Musculoskeletal-related absences are a strong indicator of ongoing manual
                      handling problems. Look for patterns by department, job role, time of year, or
                      specific tasks.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Near-miss reports:</strong> Near misses
                      (dropped loads, stumbles while carrying, loads that nearly fell) are early
                      warnings of future injuries. They indicate hazards that have not yet caused
                      harm but easily could.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">RIDDOR reports:</strong> Any manual handling
                      injury that results in over-seven-day absence must be reported under RIDDOR.
                      These reports indicate serious hazards that require urgent attention.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Occupational health records:</strong>{' '}
                      Pre-employment and periodic health assessments may reveal trends in
                      musculoskeletal health across the workforce.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  or the same type of load indicate a{' '}
                  <strong className="text-white">systemic hazard</strong> that requires redesign,
                  not just a reminder to &ldquo;lift properly.&rdquo;
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The people who perform manual handling tasks every day are your single best source
                of information about the hazards involved. Workers know which tasks cause them
                discomfort, which workarounds they have developed, which mechanical aids are
                impractical, and where the real problems lie. Consulting them is not just good
                practice &mdash; it is a <strong>legal requirement</strong> under the Safety
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Informal conversations:</strong> Talk to
                      workers during their tasks. Ask &ldquo;Which parts of this job are hardest on
                      your body?&rdquo; and &ldquo;If you could change one thing about this task,
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Structured interviews:</strong> Use a prepared
                      questionnaire covering each TILE factor to ensure nothing is missed. Include
                      questions about pain, discomfort, fatigue, and any workarounds workers have
                      developed.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Body mapping:</strong> Ask workers to mark on a
                      body diagram where they experience pain or discomfort after performing
                      specific tasks. This reveals patterns that link injuries to particular
                      operations.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Toolbox talks and team meetings:</strong> Raise
                      manual handling as a topic and invite workers to share their experiences and
                      suggestions in a group setting.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Anonymous reporting:</strong> Some workers may
                      be reluctant to raise concerns directly. Providing an anonymous reporting
                      mechanism (suggestion box, online form) can capture issues that would
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-emerald-500">Key Point:</strong> Consultation must be
                  genuine, not a tick-box exercise. Workers can tell when their input is not valued,
                  and they will stop reporting concerns. Act on the information you receive, feed
                  back the results, and explain what has been changed as a result of their input.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The Health and Safety Executive (HSE) has published several practical assessment
                tools that provide a structured, repeatable method for evaluating manual handling
                risks. These tools are freely available and do not require specialist training to
                use, though training improves accuracy.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1.5 mb-3">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Lifting operations:</strong> Individual workers
                      lifting, lowering, or carrying loads
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Carrying operations:</strong> Transporting
                      loads over a distance
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Team handling operations:</strong> Two or more
                      workers lifting together
                    </span>
                  </li>
                </ul>
                <p className="text-sm text-white/80">
        ...
        <section className="mb-10">
              ...
              <div className="flex flex-col sm:flex-row">
                ...
                <div className="px-4 py-3 flex-1">
                  ...
                  <p className="text-sm text-white/80">
                    ...
                    eliminated before work continues.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="mt-4 bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
            <p className="text-sm text-white">
              <strong className="text-emerald-400">Using the colour bands:</strong> Each risk factor
              in the MAC assessment is individually colour-coded. The overall risk score is the sum
              of the individual numerical scores. A single purple or red factor can make an
              otherwise &ldquo;green&rdquo; task high-risk &mdash; the highest individual rating
              should drive the urgency of action.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The HSE assessment tools are most effective when used as part of a systematic
                approach to hazard identification, rather than in isolation. The recommended
                workflow combines observation, consultation, and data review with structured
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ol className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Walk the workplace</strong> and observe all
                      manual handling tasks currently being performed
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-0.5 w-5 h-5 rounded-full bg-emerald-500/20 border border-emerald-500/40 flex items-center justify-center flex-shrink-0 text-[10px] font-bold text-emerald-400">
                    ...
                    <span>
                      <strong className="text-white">Consult workers</strong> about which tasks
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Review injury data</strong> to identify tasks
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Prioritise</strong> the highest-risk tasks for
                      detailed assessment
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Apply the correct HSE tool</strong> (MAC for
                      lifting, RAPP for push/pull, ART for repetitive)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-0.5 w-5 h-5 rounded-full bg-emerald-500/20 border border-emerald-500/40 flex items-center justify-center flex-shrink-0 text-[10px] font-bold text-emerald-400">
                    ...
                    <span>
                      <strong className="text-white">Record, implement, and review</strong> the
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  become accustomed to. The combination of all methods provides the most complete
                  picture.
                </p>
              </div>
            </div>
