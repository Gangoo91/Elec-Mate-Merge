...
const faqs = [
  ...
  {
    question: 'Who is responsible for reporting a RIDDOR-reportable manual handling injury?',
    answer:
  ...
  {
    question: 'Can I be disciplined for reporting a manual handling injury or near miss?',
    answer:
...
const quizQuestions = [
  ...
  {
    id: 2,
    question: 'Which form is used to report a RIDDOR-reportable workplace injury to the HSE?',
    options: ['Form F2508', 'Form HSE-01', 'Form RIDDOR-7', 'Form BI-510'],
    correctAnswer: 0,
    explanation:
...
export default function ManualHandlingModule5Section3() {
  useSEO({
    title: 'Incident Reporting & Investigation | Manual Handling Module 5.3',
    description:
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
          ...
          <div className="p-4 rounded-lg bg-emerald-500/5 border-l-2 border-emerald-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li className="flex items-start gap-2">
                ...
                <span>
                  <strong>RIDDOR:</strong> over-7-day incapacitation is the most common MH reporting
                  category
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                <span>
                  <strong>Report:</strong> online F2508 or telephone for serious incidents
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                <span>
                  <strong>Investigate:</strong> what happened, why, root cause, corrective actions
                </span>
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-emerald-500/5 border-l-2 border-emerald-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              ...
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                <span>
                  <strong>Near misses</strong> are free lessons &mdash; report every one
                </span>
              </li>
            </ul>
          </div>
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                (RIDDOR) requires employers to report certain workplace injuries to the HSE. Manual
                handling injuries feature prominently in RIDDOR statistics &mdash;{' '}
                <strong>over-7-day incapacitation is the most common reportable category</strong>{' '}
                for manual handling.
              </p>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Reporting a RIDDOR-notifiable injury involves a specific process depending on the
                severity of the incident. The employer (not the injured worker) is responsible for
                making the RIDDOR report.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Online (F2508):</strong> the standard method
                      for most reports &mdash; submitted through the HSE&rsquo;s online reporting
                      system
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Telephone:</strong> required for the most
                      serious incidents (fatalities and specified injuries) &mdash; call the HSE
                      Incident Contact Centre immediately
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                In addition to RIDDOR reporting (which only applies to the most serious injuries),
                employers have internal reporting requirements that apply to{' '}
                <strong>ALL workplace injuries and near misses</strong>, regardless of severity.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      A worker feels a sharp pain while lifting but the pain quickly subsides
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Every manual handling injury and significant near miss should be investigated. The
                purpose is <strong>not to blame</strong> but to understand what happened, why it
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <p className="text-sm font-medium text-white">The Investigation Framework</p>
                </div>
                <div className="space-y-3">
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Root causes are the underlying <strong>systemic or management failures</strong> that
                create the conditions for injuries to occur. They are not the immediate trigger (the
                &ldquo;how&rdquo;) but the deeper reason (the &ldquo;why&rdquo;) the conditions
                existed.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Inadequate risk assessment:</strong> the task
                      was not assessed at all, or the assessment was generic and did not reflect the
                      actual conditions
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <AlertTriangle className="h-4 w-4 text-red-400 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong className="text-white">No training provided:</strong> workers had not
                      received manual handling training, or training was out of date
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <AlertTriangle className="h-4 w-4 text-red-400 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong className="text-white">No mechanical aids available:</strong> the
                      assessment identified the need for trolleys, hoists, or other aids, but they
                      were not provided or were out of service
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <AlertTriangle className="h-4 w-4 text-red-400 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Time pressure:</strong> production targets or
                      deadlines pressured workers into taking shortcuts &mdash; skipping
                      assessments, not using aids, lifting alone
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <AlertTriangle className="h-4 w-4 text-red-400 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Poor planning:</strong> materials delivered to
                      the wrong location, requiring unnecessary manual handling to reposition them
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <AlertTriangle className="h-4 w-4 text-red-400 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Inadequate supervision:</strong> workers not
                      monitored to ensure safe practices were being followed
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <AlertTriangle className="h-4 w-4 text-red-400 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Poor workplace layout:</strong> narrow access
                      routes, uneven floors, poor lighting, obstructed pathways
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Trend analysis involves reviewing incident and near-miss data over time to identify{' '}
                <strong>patterns and recurring themes</strong>. This is one of the most powerful
                tools available for preventing manual handling injuries at an organisational level.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Repeat tasks:</strong> a specific task causes a
                      disproportionate number of injuries &mdash; the task needs redesigning
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Repeat locations:</strong> a particular area
                      has a high injury rate &mdash; environmental factors may need addressing
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Time patterns:</strong> injuries clustering at
                      end of shifts or on specific days &mdash; fatigue management may be inadequate
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Worker groups:</strong> new workers, agency
                      staff, or specific trades having higher rates &mdash; training or supervision
                      may be inadequate
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Equipment failures:</strong> repeated incidents
                      involving specific mechanical aids &mdash; maintenance programme may be
                      failing
                    </span>
                  </li>
                </ul>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                A near-miss culture is one where workers actively report incidents that{' '}
                <strong>could have</strong> caused injury but did not. Research consistently shows
                that for every serious injury, there are typically{' '}
                <strong>hundreds of near misses</strong>. Each near miss is a{' '}
                <strong>free lesson</strong> &mdash; an opportunity to fix a problem before someone
                gets hurt.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Make reporting easy:</strong> simple forms,
                      digital reporting, or verbal reports to supervisors
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-emerald-400 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong className="text-white">No blame:</strong> workers must feel safe to
                      report without fear of criticism or punishment
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-emerald-400 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Visible action:</strong> workers must see that
                      their reports lead to real changes &mdash; otherwise they stop reporting
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-emerald-400 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Positive reinforcement:</strong> thank and
                      acknowledge workers who report near misses
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-emerald-400 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Share the lessons:</strong> communicate the
                      outcomes of near-miss reports through toolbox talks and site briefings
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-emerald-400">Remember:</strong> A high number of near-miss
                  reports is a <strong>positive sign</strong> &mdash; it means workers are engaged
                  and the organisation is identifying hazards before they cause harm. A low number
                  of near-miss reports is a warning sign that problems are going unreported.
                </p>
              </div>
            </div>
          </div>
