...
const quickCheckQuestions = [
  {
    id: 'car2012-scope',
    question: 'The Control of Asbestos Regulations 2012 apply to which types of workplace?',
    options: [
...
const faqs = [
  {
    question: 'Do the Control of Asbestos Regulations 2012 apply to domestic premises?',
    answer:
  ...
  {
    question: 'What is the difference between CAR 2006 and CAR 2012?',
    answer:
  ...
  {
    question: 'Who is responsible for enforcing the Control of Asbestos Regulations?',
    answer:
  ...
  {
    question: 'How often must asbestos awareness training be refreshed?',
    answer:
...
const quizQuestions = [
  {
    id: 1,
    question: 'When did the Control of Asbestos Regulations 2012 come into force?',
    options: ['1 January 2012', '6 April 2012', '6 April 2006', '1 October 2012'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['Regulation 10', 'Regulation 8', 'Regulation 4', 'Regulation 22'],
    correctAnswer: 2,
    explanation:
  ...
  {
    id: 4,
    question: 'Which of the following is an example of notifiable non-licensed work (NNLW)?',
    options: [
  ...
  {
    id: 5,
    question: 'What is the short-term exposure limit for airborne asbestos fibres under CAR 2012?',
    options: [
...
const AsbestosModule2Section1 = () => {
  useSEO({
    title: 'Control of Asbestos Regulations 2012 | Asbestos Awareness Module 2 Section 1',
    description:
      ...
      <article className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
            ...
            <div className="rounded-lg p-3 sm:p-4 bg-orange-500/10 border-l-2 border-l-orange-500/50 border border-orange-500/30">
              ...
              <ul className="text-base text-white space-y-1.5">
                ...
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    Consolidates and updates all previous asbestos regulations into one
                ...
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    Implements <strong>EU Directive 2009/148/EC</strong> on asbestos exposure at
                    work.
                  </span>
                </li>
              </ul>
            ...
            <div className="rounded-lg p-3 sm:p-4 bg-orange-500/10 border-l-2 border-l-orange-500/50 border border-orange-500/30">
              ...
              <ul className="text-base text-white space-y-1.5">
                ...
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    Approved Code of Practice: <strong>L143</strong> &ldquo;Managing and working
                    with asbestos&rdquo;.
                  </span>
                </li>
              </ul>
        ...
        <section className="mb-10">
          ...
          <ul className="space-y-3 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>Explain the purpose and scope of the Control of Asbestos Regulations 2012</span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-orange-500 mt-0.5 flex-shrink-0" />
              <span>
            ...
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-orange-500 mt-0.5 flex-shrink-0" />
              <span>
                Distinguish between licensed work, notifiable non-licensed work, and non-licensed
                work
              </span>
            </li>
            <li className="flex items-start gap-3">
            ...
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-orange-500 mt-0.5 flex-shrink-0" />
              <span>
                Describe the training requirements under Regulation 10, including who must be
            ...
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-orange-500 mt-0.5 flex-shrink-0" />
              <span>
                Outline the HSE&rsquo;s enforcement powers, including improvement notices,
        ...
        <section className="mb-10">
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                CAR 2012 contains a comprehensive set of regulations that cover every aspect of
                managing and working with asbestos. Below are the key regulations that you need to
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <strong>Regulation 4:</strong> Duty to manage asbestos in non-domestic
                      premises &mdash; the duty holder must find, assess, and manage ACMs.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-orange-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Regulation 5:</strong> Identification of asbestos &mdash; if you
                      cannot confirm a material is asbestos-free, you must <em>presume</em> it
                      contains asbestos (the presumption approach).
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-orange-500 mt-2 flex-shrink-0"></div>
                    <div>
                      ...
                      suitable and sufficient assessment must be carried out before any work that
                      may disturb ACMs.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <h3 className="text-orange-400 font-medium mb-3">
                  Licensing, Notification &amp; Training
                </h3>
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-3 text-sm">
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-orange-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Regulation 19:</strong> Health records and medical surveillance
                      &mdash; required for licensed and NNLW workers.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-orange-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Regulation 20:</strong> Washing and changing facilities &mdash; must
                      be provided where there is a risk of asbestos contamination.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-orange-400 mt-2 flex-shrink-0"></div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                CAR 2012 divides all work with asbestos-containing materials into three categories.
                The category determines the level of regulatory control, notification, medical
                surveillance, and training required. Getting the classification right is critical
                &mdash; carrying out licensed work without a licence is a criminal offence.
              </p>
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <ul className="text-white space-y-2">
                    ...
                    <li className="flex items-start gap-3">
                      <div className="w-2 h-2 rounded-full bg-amber-400 mt-2 flex-shrink-0"></div>
                      <div>
                        <strong>Health records kept for 40 years</strong> from the date of last
                        entry
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
                    ...
                    <li className="flex items-start gap-3">
                      <div className="w-2 h-2 rounded-full bg-amber-400 mt-2 flex-shrink-0"></div>
                      <div>
                        No HSE licence required, but adequate{' '}
                        <strong>training and competence</strong> essential
                      </div>
                    </li>
                  </ul>
                  <p className="text-white mt-2 text-xs">
        ...
        <section className="mb-10">
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                The control limit is the maximum permissible concentration of asbestos fibres in the
                air. It is set at a level intended to limit exposure, but it is{' '}
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-white text-sm">
                  ...
                  control limit is a legal maximum &mdash; work must be planned and carried out to
                  keep exposure{' '}
                  <strong className="text-white">
                    as far below the control limit as is reasonably practicable
                  </strong>
                  . Any exposure to asbestos fibres carries some risk.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-2 text-sm">
                  ...
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-orange-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Air monitoring:</strong> May be required to demonstrate that the
                      control limit is not being exceeded, particularly during licensed and NNLW
                      activities.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
        ...
        <section className="mb-10">
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                Regulation 10 of CAR 2012 requires every employer to ensure that employees who are,
                or who are liable to be, exposed to asbestos receive adequate information,
                instruction, and training. This is one of the most important requirements of the
                regulations &mdash; workers who do not know what asbestos looks like, or what to do
                when they encounter it, are at significantly greater risk.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-2 text-sm">
                  ...
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-orange-500 mt-2 flex-shrink-0"></div>
                    <div>
                      The correct use of <strong>PPE and RPE</strong> (personal/respiratory
                  ...
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-orange-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Emergency procedures</strong> in the event of uncontrolled fibre
                      release
                    </div>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-orange-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Asbestos awareness:</strong> Recommended annually for anyone whose
                      work may disturb ACMs &mdash; this is the training you are completing now.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-orange-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Detailed refresher (NNLW/licensed):</strong> Full refresher
                      recommended every 3 years, with annual top-up awareness sessions in between.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-orange-500 mt-2 flex-shrink-0"></div>
            ...
            <div className="space-y-4 text-white">
              ...
              <div className="space-y-3">
                <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                  ...
                  <p className="text-white text-sm">
                    ...
                    to remedy a breach of the regulations. Failure to comply with an improvement
                    notice is itself a criminal offence. The notice will set out clearly what needs
                ...
                <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                  ...
                  <p className="text-white text-sm">
                    ...
                    injury. Work cannot resume until the notice is complied with. Prohibition
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-2 text-sm">
                  ...
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-orange-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Local authority powers:</strong> Local authorities also have
                      enforcement powers in certain premises such as shops, offices, hotels, leisure
              ...
              <div className="bg-white/5 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-white text-sm">
                  ...
                  workers to asbestos without proper controls. Even small businesses and sole
                  traders can be prosecuted. Ignorance of the regulations is not a defence &mdash;
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                <ul className="text-white space-y-3 text-sm">
                  ...
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-orange-500 mt-0.5 flex-shrink-0" />
                    <span>
                      Asbestos work falls into <strong>three categories</strong>: licensed,
                      notifiable non-licensed (NNLW), and non-licensed &mdash; each with different
                      requirements.
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
        ...
        {/* ─── Quiz ─── */}
        <div className="mt-12">
          <Quiz title="Control of Asbestos Regulations 2012 Quiz" questions={quizQuestions} />
        </div>
