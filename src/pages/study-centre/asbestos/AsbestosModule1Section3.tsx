...
const quickCheckQuestions = [
  {
    ...
    question:
      'What is the fundamental assumption that underpins UK asbestos management in buildings?',
    options: [
    ...
    correctIndex: 0,
    explanation:
      'The fundamental assumption is that any building constructed or refurbished before the year 2000 may contain asbestos-containing materials. The total ban on asbestos in the UK came into force on 24 November 1999, so buildings from all eras before this date are potentially affected. This includes domestic, commercial, and industrial properties.',
  },
  {
  ...
  },
  {
    ...
    question:
      'What must an electrician do before carrying out work on any pre-2000 electrical installation?',
    options: [
...
const quizQuestions = [
  {
    ...
    options: ['1 January 1990', '24 November 1999', '31 December 2000', '1 April 1985'],
    correctAnswer: 1,
    explanation:
      'The Asbestos (Prohibitions) (Amendment) Regulations 1999 brought a total ban on the import, supply, and use of all forms of asbestos in the UK, effective from 24 November 1999. This is why buildings constructed or refurbished before the year 2000 are assumed to potentially contain ACMs.',
  },
  {
    id: 2,
    question:
  ...
  },
  {
    id: 5,
    question:
      'Which building type saw extensive use of AIB in ceilings, walls, and heater cupboards?',
    options: [
...
export default function AsbestosModule1Section3() {
  useSEO({
    ...
    description:
      'Common locations of asbestos-containing materials in buildings: roofs, walls, floors, services, electrical installations, domestic properties, and high-risk building types. Pre-2000 building assumption explained.',
  });
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-orange-500/5 border-l-2 border-orange-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Pre-2000:</strong> Any building built or refurbished before 2000 may contain
                ACMs
              </li>
              <li>
                <strong>500,000+</strong> non-domestic UK buildings contain asbestos
              </li>
              <li>
                <strong>Everywhere:</strong> Roofs, walls, floors, services, electrics, domestic
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-orange-500/5 border-l-2 border-orange-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Assume:</strong> ACMs present until proven otherwise in pre-2000 buildings
              </li>
              <li>
                <strong>Check:</strong> The asbestos register before starting any work
              </li>
              <li>
                <strong>Stop:</strong> If you encounter suspected ACMs &mdash; do not disturb
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The single most important principle in UK asbestos management is this:{' '}
                <strong>
                  any building constructed or refurbished before the year 2000 may contain asbestos
                </strong>
                . This is the fundamental assumption that guides every asbestos survey, risk
                assessment, and work decision in the UK.
              </p>

              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                <p className="text-sm font-medium text-orange-400 mb-3">
                  Key Definition &mdash; The Pre-2000 Assumption
                </p>
                <p className="text-sm text-white">
                  Because the total ban on the import, supply, and use of all forms of asbestos did
                  not come into force until <strong>24 November 1999</strong>, any building from any
                  era before this date may contain asbestos-containing materials (ACMs). This
                  includes Victorian buildings, post-war construction, 1960s system builds, 1970s
                  office blocks, 1980s housing estates, and 1990s commercial properties.
                </p>
              </div>

              <p>
                The ban came through the{' '}
                <strong>Asbestos (Prohibitions) (Amendment) Regulations 1999</strong>. Before this,
                different types of asbestos were banned at different times &mdash; blue asbestos
                (crocidolite) and brown asbestos (amosite) were banned in 1985, but white asbestos
                (chrysotile) remained legal and widely used until 1999. This means buildings
                refurbished as recently as 1998 may contain chrysotile products.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="grid sm:grid-cols-2 gap-3">
                  {[
                    {
                      point: 'All eras affected',
                      detail:
                        'Buildings from the 1930s through to 1999 commonly contain ACMs — not just older industrial buildings',
                    },
                    {
                      point: 'Refurbishment risk',
                      detail:
                        'Even buildings refurbished after 2000 may contain legacy ACMs that were not removed during the works',
                    },
                    {
                      point: 'Scale of the problem',
                      detail:
                        'An estimated 500,000+ non-domestic buildings in the UK still contain ACMs today',
                    },
                    {
                      point: 'Domestic properties',
                      detail:
                        'Homes built from the 1930s to 1999 commonly contain ACMs in multiple locations — textured coatings, floor tiles, soffits, and more',
                    },
                  ].map((item, i) => (
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  plumber, electrician, builder, or decorator &mdash; the assumption applies to
                  every job in every pre-2000 property. You must check the asbestos register (or
                  arrange a survey) before starting work.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Roofs are one of the most common locations for asbestos-containing materials,
                particularly in industrial, agricultural, and domestic outbuildings. Asbestos cement
                (AC) products were widely used in roofing due to their durability, weather
                resistance, and fire-resistant properties.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="grid sm:grid-cols-2 gap-3">
                  {[
                    {
                      location: 'Corrugated roof sheets',
                      detail:
                        'Asbestos cement sheets — extremely common on garages, industrial units, farm buildings, and sheds',
                    },
                    {
                      location: 'Roof slates',
                      detail:
                        'Asbestos cement slates — visually similar to natural slate but lighter and more uniform in appearance',
                    },
                    {
                      location: 'Soffits and fascia boards',
                      detail:
                        'AIB (asbestos-insulating board) or AC panels fitted beneath roof overhangs and along eaves',
                    },
                    {
                      location: 'Guttering and downpipes',
                      detail:
                        'Asbestos cement guttering — lightweight, grey, often with a smooth finish',
                    },
                    {
                      location: 'Flat roof felt',
                      detail:
                        'Some older bituminous roof felts and weathering materials contain asbestos fibres',
                    },
                    {
                      location: 'Roof-void insulation',
                      detail:
                        'Loose-fill or sprayed insulation materials in loft spaces — may contain asbestos',
                    },
                  ].map((item, i) => (
                    <div key={i} className="bg-black/30 rounded-lg p-3">
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  <strong>broken, drilled, cut, or weathered</strong>. Moss growth and weathering
                  over decades can weaken the cement matrix, making the material more friable. Never
                  walk on asbestos cement roofs &mdash; they are fragile and can shatter without
                  warning.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Walls are another major location for ACMs. Asbestos was used in wall construction
                and decoration for its fire resistance, thermal insulation, and durability.
                Wall-based ACMs range from low-risk asbestos cement cladding to higher-risk AIB
                partitions and textured coatings.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-3">
                  {[
                    {
                      location: 'Asbestos-insulating board (AIB) partition walls',
                      detail:
                        'AIB was widely used to create internal partition walls and linings, particularly in commercial and industrial buildings. It is denser than sprayed coatings but more friable than cement products.',
                    },
                    {
                      location: 'Textured decorative coatings (Artex)',
                      detail:
                        'Artex and similar products applied to ceilings and walls typically contain chrysotile at 1-5%. Extremely common in properties from the 1960s to 1980s. Low risk when intact, high risk when sanded or scraped.',
                    },
                    {
                      location: 'External asbestos cement wall cladding',
                      detail:
                        'Flat or profiled AC sheets used as external cladding on commercial and industrial buildings. Similar risk profile to AC roof sheets — low risk when intact, higher risk when cut or weathered.',
                    },
                    {
                      location: 'Window panels beneath windows (AIB)',
                      detail:
                        'AIB panels were commonly fitted beneath windows as infill panels, particularly in system-built schools and offices. Often painted and may not be immediately obvious.',
                    },
                    {
                      location: 'Window putty and sealant',
                      detail:
                        'Some window putties and mastics from the pre-2000 era contain chrysotile fibres. This is often overlooked during building surveys.',
                    },
                    {
                      location: 'Internal wall linings and firebreaks',
                      detail:
                        'AIB was used to line walls in corridors, stairwells, and service risers for fire-resistance purposes.',
                    },
                    {
                      location: 'Fire-resistant wall panels',
                      detail:
                        'Corridors, stairwells, and escape routes in commercial buildings often have AIB panels providing fire compartmentation.',
                    },
                  ].map((item, i) => (
                    <div key={i} className="bg-black/30 rounded-lg p-3">
                      <p className="text-xs font-medium text-orange-400 mb-1">{item.location}</p>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  <strong>sanding, scraping, drilling, or removing</strong> textured coatings
                  releases asbestos fibres into the air. Always assume pre-1990s textured coatings
                  contain asbestos until proven otherwise by laboratory testing.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Floor materials containing asbestos are extremely common in pre-2000 buildings. The
                two most significant ACMs found in floors are{' '}
                <strong>thermoplastic floor tiles</strong> and the
                <strong> black bitumen-based adhesive</strong> used to stick them down. Both must be
                treated as potential ACMs.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="grid sm:grid-cols-2 gap-3">
                  {[
                    {
                      location: 'Thermoplastic floor tiles',
                      detail:
                        'Typically 25x25cm (9") or 30x30cm (12"), often dark-coloured (brown, dark red, black). Contain chrysotile fibres bound in a resin matrix.',
                    },
                    {
                      location: 'Bitumen-based tile adhesive',
                      detail:
                        'The black adhesive layer beneath old tiles frequently contains asbestos. This is often overlooked — removing tiles exposes and disturbs this adhesive layer.',
                    },
                    {
                      location: 'Floor linoleum backing',
                      detail:
                        'The hessian or felt backing of some older linoleum floor coverings may contain asbestos fibres.',
                    },
                    {
                      location: 'Resin-based flooring',
                      detail:
                        'Some poured resin and composite flooring materials from the pre-2000 era contain asbestos.',
                    },
                    {
                      location: 'Floor ducts and cable channels',
                      detail:
                        'Asbestos cement or AIB was used to form floor-level ducts for cables and services, particularly in offices and commercial buildings.',
                    },
                  ].map((item, i) => (
                    <div key={i} className="bg-black/30 rounded-lg p-3">
                      <p className="text-xs font-medium text-orange-400 mb-1">{item.location}</p>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  tiles and the adhesive must be sampled and tested. Never use power tools, sanders,
                  or grinding equipment to remove old floor tiles or adhesive until asbestos has
                  been ruled out.
                </p>
              </div>
            </div>
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                <strong> highest-risk locations</strong> for asbestos in buildings. Asbestos was
                prized for its heat resistance, making it the insulation material of choice for
                pipes, boilers, and hot-water systems throughout the 20th century.
              </p>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  or
                  <strong> crocidolite (blue asbestos)</strong> — the two most dangerous fibre types
                  — and releases fibres readily when disturbed. Even minor contact, vibration, or
                  water damage can cause fibre release. Pipe lagging removal is{' '}
                  <strong>licensed asbestos work</strong> that must be carried out by an
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-3">
                  Services &amp; Mechanical ACMs
                </p>
                <div className="space-y-3">
                  {[
                    {
                      location: 'Pipe lagging and insulation',
                      risk: 'HIGH',
                      detail:
                        'Often amosite or crocidolite. Very friable. Found on heating pipes, hot-water pipes, and steam pipes throughout buildings.',
                    },
                    {
                      location: 'Boiler and calorifier insulation',
                      risk: 'HIGH',
                      detail:
                        'Boilers, calorifiers, and hot-water cylinders were commonly insulated with asbestos-containing materials — often amosite lagging.',
                    },
                    {
                      location: 'Rope seals and gaskets',
                      risk: 'MEDIUM',
                      detail:
                        'Woven asbestos rope was used to seal boiler doors, flue joints, and pipe connections. Still commonly found in older heating systems.',
                    },
                    {
                      location: 'Flue pipes',
                      risk: 'MEDIUM',
                      detail:
                        'Asbestos cement flue pipes were standard for gas boilers and fires. Found in domestic and commercial properties.',
                    },
                    {
                      location: 'Water tanks and cisterns',
                      risk: 'LOW',
                      detail:
                        'Asbestos cement water tanks and toilet cisterns were widely used. Low risk when intact but must not be drilled or broken.',
                    },
                    {
                      location: 'Fire blankets (older types)',
                      risk: 'MEDIUM',
                      detail:
                        'Some older fire blankets were made from woven asbestos cloth. Modern fire blankets are fibreglass.',
                    },
                  ].map((item, i) => (
                    <div key={i} className="bg-black/30 rounded-lg p-3">
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Electrical installations are a particularly important area of concern for
                electricians. Asbestos was used in electrical components for its excellent
                insulating and fire-resistant properties. Many of these ACMs are concealed within
                enclosures and are not immediately visible during routine inspection.
              </p>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  This is not optional. Before opening consumer units, removing distribution boards,
                  chasing walls, lifting floor ducts, or drilling into surfaces in pre-2000
                  buildings, you must check the asbestos register (for non-domestic premises) or
                  assess the risk of encountering ACMs. Failure to do so puts you and others at risk
                  of fibre exposure and breaches the Control of Asbestos Regulations 2012.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="grid sm:grid-cols-2 gap-3">
                  {[
                    {
                      location: 'Consumer unit / distribution board flash guards',
                      detail:
                        'AIB panels fitted inside consumer units to act as arc barriers between fuse carriers. Very common in pre-2000 domestic and commercial installations.',
                    },
                    {
                      location: 'Fuse carriers and arc shields',
                      detail:
                        'Some older fuse carriers and arc shields within switchgear contain asbestos-based insulating materials.',
                    },
                    {
                      location: 'Cable trenching and floor ducts',
                      detail:
                        'Asbestos cement or AIB was used to form floor-level and below-ground cable ducts and trenches.',
                    },
                    {
                      location: 'Electrical backing boards',
                      detail:
                        'AIB boards mounted on walls behind switchgear, distribution boards, and meter cupboards to provide fire resistance.',
                    },
                    {
                      location: 'Heater storage bricks',
                      detail:
                        'Older electric storage heaters may contain asbestos in the insulation bricks and internal linings.',
                    },
                    {
                      location: 'Switchroom linings',
                      detail:
                        'Walls and ceilings in electrical switchrooms were often lined with AIB for fire protection.',
                    },
                  ].map((item, i) => (
                    <div key={i} className="bg-black/30 rounded-lg p-3">
                      <p className="text-xs font-medium text-orange-400 mb-1">{item.location}</p>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  break, cut, drill, or remove it. Close the unit, inform the customer, and arrange
                  for the material to be sampled. If confirmed as AIB, its removal must follow the
                  correct asbestos work procedures — either licensed or notifiable non-licensed work
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                asbestos-containing materials. Unlike non-domestic buildings, there is no legal duty
                to maintain an asbestos register for private homes. This means homeowners and
                tradespeople must be particularly vigilant when working in domestic settings.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="grid sm:grid-cols-2 gap-3">
                  {[
                    {
                      location: 'Artex / textured coatings',
                      detail:
                        'Ceilings and walls — very common in 1960s-1980s properties. Chrysotile at 1-5%.',
                    },
                    {
                      location: 'Garage roofs',
                      detail:
                        'Corrugated AC sheets on garage and shed roofs. Extremely common in pre-2000 housing.',
                    },
                    {
                      location: 'Exterior soffits and fascia',
                      detail: 'AC or AIB panels beneath roof overhangs and along eaves.',
                    },
                    {
                      location: 'Floor tiles',
                      detail:
                        'Thermoplastic tiles in kitchens, bathrooms, and hallways — often 25x25cm, dark-coloured.',
                    },
                    {
                      location: 'Boiler cupboard insulation',
                      detail:
                        'Asbestos insulation around boilers, hot-water cylinders, and flue pipes in airing cupboards.',
                    },
                    {
                      location: 'Bath panels',
                      detail:
                        'AIB panels fitted around baths — often painted and not immediately recognisable.',
                    },
                    {
                      location: 'Airing cupboard insulation',
                      detail:
                        'Pipe lagging and cylinder insulation within airing cupboards — may be amosite.',
                    },
                    {
                      location: 'Window sills and panels',
                      detail:
                        'AIB panels beneath windows and as window board linings, particularly in system-built houses.',
                    },
                    {
                      location: 'Old fuse boxes',
                      detail:
                        'AIB flash guards, backing boards, and arc shields within pre-2000 consumer units.',
                    },
                  ].map((item, i) => (
                    <div key={i} className="bg-black/30 rounded-lg p-3">
                      <p className="text-xs font-medium text-orange-400 mb-1">{item.location}</p>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  or builder working in a domestic property, <strong>you</strong> have a duty under
                  the Health and Safety at Work Act 1974 and the Control of Asbestos Regulations
                  2012 to ensure you do not expose yourself or others to asbestos fibres. If you
                  suspect ACMs, stop work and arrange for testing. The duty to manage asbestos risk
                  applies to your own work activities regardless of what the homeowner knows or does
                  not know.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                While ACMs can be found in virtually any pre-2000 building, certain building types
                are recognised as <strong>particularly high-risk</strong> due to the extent and type
                of asbestos used during their construction. Workers entering these buildings must be
                especially vigilant and should always consult the asbestos management plan before
                beginning any work.
              </p>
                  ...
                  <div className="grid md:grid-cols-[180px_1fr] gap-3">
                    ...
                    <div>
                      <p className="text-sm text-white">
                        ...
                        (Department for Education) estimates that the majority of schools built
                        before 2000 contain some form of ACM. Any maintenance, refurbishment, or
                        electrical work in schools requires thorough asbestos checks.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="grid md:grid-cols-[180px_1fr] gap-3">
                    ...
                    <div>
                      <p className="text-sm text-white">
                        ...
                        frequent refurbishment makes hospitals particularly challenging to manage
                        for asbestos.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="grid md:grid-cols-[180px_1fr] gap-3">
                    ...
                    <div>
                      <p className="text-sm text-white">
                        ...
                        wall cladding). Sprayed asbestos coatings on structural steelwork are among
                        the highest-risk ACMs encountered.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="grid md:grid-cols-[180px_1fr] gap-3">
                    ...
                    <div>
                      <p className="text-sm text-white">
                        ...
                        significant quantities of ACMs. Social housing providers maintain asbestos
                        registers and management plans for these properties.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="grid md:grid-cols-[180px_1fr] gap-3">
                    ...
                    <div>
                      <p className="text-sm text-white">
                        ...
                        materials are found throughout. Decommissioning and demolition of these
                        facilities requires specialist licensed asbestos removal.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="grid md:grid-cols-[180px_1fr] gap-3">
                    ...
                    <div>
                      <p className="text-sm text-white">
                        ...
                        Mesothelioma rates remain elevated in former dockyard towns such as
                        Plymouth, Barrow, and the Clyde.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="grid md:grid-cols-[180px_1fr] gap-3">
                    ...
                    <div>
                      <p className="text-sm text-white">
                        ...
                        carriages used asbestos in brakes, insulation, and electrical components.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  likely to contain significant quantities of asbestos. However, even a simple
                  domestic property can contain multiple ACMs.{' '}
                  <strong>Never assume a building is asbestos-free</strong> based on its appearance
                  or age alone — always check the records or arrange a survey.
                </p>
              </div>
            </div>
          </div>
