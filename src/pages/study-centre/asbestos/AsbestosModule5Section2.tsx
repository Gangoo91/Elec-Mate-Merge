...
const faqs = [
  ...
  {
    question: 'What is the difference between a red asbestos waste bag and the clear outer bag?',
    answer:
  ...
  {
    question: 'How long must consignment notes for asbestos waste be kept, and why?',
    answer:
  ...
  {
    question: 'What happens if asbestos waste is mixed with general construction waste?',
    answer:
...
export default function AsbestosModule5Section2() {
  useSEO({
    title: 'Decontamination & Waste Disposal | Asbestos Awareness Module 5.2',
    description:
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-orange-500/5 border-l-2 border-orange-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>RPE last:</strong> Always the final item removed during decontamination
              </li>
              <li>
                <strong>Double-bag:</strong> Red inner bag + clear outer bag with warning stripe
              </li>
              <li>
                <strong>Hazardous waste:</strong> Consignment notes, licensed carriers, licensed
                landfill
              </li>
              <li>
                <strong>Fly-tipping:</strong> Unlimited fine + up to 5 years imprisonment
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-orange-500/5 border-l-2 border-orange-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Decontaminate:</strong> Worker first, then tools, then area
              </li>
              <li>
                <strong>Bag waste:</strong> No more than 2/3 full, goose-neck seal
              </li>
              <li>
                <strong>Never mix:</strong> Asbestos waste with general waste &mdash; it&rsquo;s an
                offence
              </li>
              <li>
                <strong>Keep records:</strong> Consignment notes for at least 3 years
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Decontamination of the worker is <strong>critical</strong> to prevent continued
                exposure and secondary contamination. Every person who has been working in an area
                where asbestos fibres may have been released must follow a strict decontamination
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-3 text-sm text-white/80">
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="text-white font-medium">Damp-Wipe the Suit</p>
                      <p>
                        Using damp disposable cloths, wipe down the entire surface of the coverall
                        to remove loose fibres and dust before removal begins.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="text-white font-medium">Remove Boot Covers</p>
                      <p>
                        Peel off boot covers carefully, rolling them inwards to contain any
                        contamination on the outer surface.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="text-white font-medium">Remove Outer Gloves</p>
                      <p>
                        Peel off the outer pair of gloves, turning them inside-out as they are
                        removed to trap contamination.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="text-white font-medium">Peel Off Coverall Inside-Out</p>
                      <p>
                        Unzip the coverall and peel it off by rolling it downwards and inside-out,
                        so the contaminated outer surface is folded inwards. Do not pull it over
                        your head.
                      </p>
                    </div>
                  </div>
                    ...
                    <div>
                      ...
                      <p>
                        <strong className="text-white">
                          RPE is ALWAYS the last item of protection to be removed.
                        </strong>{' '}
                        This ensures you continue breathing filtered air whilst all other
                        contaminated items are being taken off.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="text-white font-medium">Remove Inner Gloves</p>
                      <p>Finally, remove the inner pair of gloves, turning them inside-out.</p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    <span className="flex items-center justify-center min-w-[28px] h-7 rounded-full bg-orange-500/20 text-orange-400 text-xs font-bold flex-shrink-0">
                    ...
                    <div>
                      <p className="text-white font-medium">Bag All Waste</p>
                      <p>
                        Place all removed PPE into a red asbestos waste bag immediately. Do not
                        leave contaminated items lying around.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      &mdash; they must be bagged and disposed of as asbestos waste, or laundered by
                      a specialist laundry
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-red-400 font-bold mt-0.5 flex-shrink-0">&times;</span>
                    <span>
                      ...
                      &mdash; ingestion of asbestos fibres is a route of exposure
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-orange-500">After PPE Removal:</strong> Wash hands, arms,
                  and face thoroughly with soap and water. Shower as soon as practicable &mdash; for
                  licensed work, an on-site shower facility must be provided as part of the
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                All surfaces in the work area must be <strong>decontaminated</strong> after asbestos
                work is complete. The goal is to remove all traces of asbestos debris and dust so
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Damp-wipe</strong> all accessible surfaces with
                      disposable cloths &mdash; floors, walls, ledges, window sills, and all
                      equipment
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">HEPA vacuum (Type H)</strong> all surfaces
                      thoroughly &mdash; a standard domestic or commercial vacuum must NEVER be used
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Visual inspection:</strong> no visible debris,
                      dust, or residue should remain on any surface
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      The area must <strong className="text-white">not be reoccupied</strong> until
                      clearance is given
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white/80">
                  <div className="flex gap-3">
                    ...
                    <p>
                      <strong className="text-white">Preliminary check by the supervisor</strong>{' '}
                      &mdash; visual inspection to confirm all visible ACMs have been removed and
                  ...
                  <div className="flex gap-3">
                    ...
                    <p>
                      ...
                      &mdash; a qualified analyst checks the area is free of all visible debris,
                  ...
                  <div className="flex gap-3">
                    ...
                    <p>
                      <strong className="text-white">Air monitoring (clearance air test)</strong>{' '}
                      &mdash; must achieve less than{' '}
                      <strong className="text-orange-400">0.01 fibres/cm&sup3;</strong> (ten times
                      lower than the workplace control limit)
                    </p>
                  </div>
                  <div className="flex gap-3">
                    <span className="flex items-center justify-center min-w-[28px] h-7 rounded-full bg-orange-500/20 text-orange-400 text-xs font-bold flex-shrink-0">
                    ...
                    <p>
                      <strong className="text-white">Site clearance certificate issued</strong>{' '}
                      &mdash; the certificate of reoccupation confirms the area is safe and work
                      enclosures can be dismantled
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  . For licensed work, this means the 4-stage clearance procedure must be completed
                  and a site clearance certificate issued. For non-licensed work, a thorough visual
                  inspection and clean must be completed and documented before anyone re-enters the
                  area.
                </p>
              </div>
            </div>
          ...
          <div className="bg-white/5 border border-orange-500/30 rounded-xl p-4 sm:p-6 overflow-x-auto">
            <div className="min-w-[300px] max-w-lg mx-auto space-y-3">
                  ...
                  <div className="border-2 border-red-500/60 rounded-lg bg-red-500/15 p-3 sm:p-4">
                    ...
                    <div className="bg-red-500/20 border border-red-500/40 rounded p-2 mb-3">
                      <p className="text-[9px] sm:text-[10px] text-red-300 font-medium text-centre leading-relaxed">
                        DANGER &mdash; Contains asbestos. Breathing asbestos dust is dangerous to
                        health. Follow safety instructions.
                      </p>
                    </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-3 text-centre">
                <p className="text-xs sm:text-sm font-medium text-red-400">
                  All asbestos waste is classified as <strong>HAZARDOUS WASTE</strong> &mdash;
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 rounded-lg p-3">
                <p className="text-xs sm:text-sm text-white/80">
                  ...
                  an airtight seal. Bags filled to no more than 2/3 capacity.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                All asbestos waste is classified as <strong>hazardous waste</strong> (previously
                referred to as &ldquo;special waste&rdquo;). This classification carries specific
                legal requirements for packaging, documentation, transport, and disposal that go
                beyond those for ordinary construction waste.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Consignment notes</strong> must accompany every
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Pre-notification</strong> to the Environment
                      Agency before the first consignment
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      Use of <strong className="text-white">registered waste carriers</strong> only
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  If asbestos waste is mixed with general construction waste, the entire load
                  becomes classified as hazardous waste. The person responsible faces prosecution,
                  an unlimited fine, and potentially imprisonment. Always segregate asbestos waste
                  completely.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                All asbestos waste must be <strong>double-bagged</strong> using the correct
                materials and sealing method. The double-bag system provides two independent layers
                of containment to prevent fibre release during handling, storage, and transport.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Red polythene asbestos waste sack</strong>
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                      Minimum <strong className="text-white">250 gauge</strong> thickness (standard
                      waste)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                      Minimum <strong className="text-white">1000 gauge</strong> for sharp or
                      abrasive materials
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                      Filled to <strong className="text-white">no more than 2/3 full</strong> to
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Sealed with a{' '}
                      <strong className="text-white">goose-neck twist and tape</strong> (creating an
                      airtight seal)
                    </span>
                  </li>
                </ul>
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      <strong className="text-white">danger warning text</strong>
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      Sealed in the <strong className="text-white">same manner</strong> (goose-neck
                      twist and tape)
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  in <strong className="text-white">rigid containers</strong> designed for the
                  purpose. All wrapping must carry the standard asbestos warning labels.
                </p>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                A <strong>hazardous waste consignment note</strong> must accompany every load of
                asbestos waste from the point of collection to the point of disposal. This legal
                document creates a complete audit trail showing where the waste came from, who
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="grid sm:grid-cols-2 gap-2 text-sm text-white/80">
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Waste producer</strong> &mdash; name, address,
                      and premises code
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Waste description</strong> &mdash; type of
                      asbestos waste
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">EWC code</strong> &mdash; 17 06 01 or 17 06 05
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Quantity</strong> &mdash; weight or volume of
                      waste
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Waste carrier details</strong> &mdash; name,
                      licence number
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Destination</strong> &mdash; licensed hazardous
                      waste landfill
                    </span>
                  </div>
                </div>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  less than 500&nbsp;kg of hazardous waste per year may register as{' '}
                  <strong className="text-white">exempt from pre-notification</strong>, but must
                  still use consignment notes for every load.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  regulatory investigation. Many organisations retain them indefinitely as part of
                  their permanent compliance records.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Asbestos waste can <strong>ONLY be transported by a licensed waste carrier</strong>.
                The waste carrier licence is issued by the Environment Agency in England (SEPA in
                Scotland, NRW in Wales). It is a legal requirement &mdash; not a recommendation.
              </p>
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      <strong className="text-white">legal duty of care</strong> to check the
                      carrier&rsquo;s licence before handing over any waste
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      ...
                      <strong className="text-white">licensed hazardous waste landfill site</strong>
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      ...
                      <strong className="text-white">current, valid licence</strong> &mdash; check
                      registration numbers online via the Environment Agency public register
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white/80">
                  ...
                  <div className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-orange-500/70 mt-0.5 flex-shrink-0" />
                    <span>
                      Completed <strong className="text-white">consignment notes</strong> for every
                      load
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-orange-500/70 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Waste transfer notes</strong> confirming
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  Penalties include an <strong className="text-white">unlimited fine</strong> and{' '}
                  <strong className="text-white">up to 5 years imprisonment</strong>. In addition to
                  criminal sanctions, the offender is liable for the full cost of clean-up,
                  environmental remediation, and any health consequences. Always use a licensed
                  carrier and a licensed disposal site &mdash; there are no shortcuts with asbestos
                  waste.
                </p>
              </div>
            </div>
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                <strong>thoroughly decontaminated</strong> before leaving the work area.
                Contaminated tools can carry asbestos fibres to other locations and expose other
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Damp-wipe or HEPA-vacuum</strong> all tool
                      surfaces before removing them from the work area
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Disposable tools</strong> should be bagged and
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Type H vacuums:</strong> external surfaces
                      damp-wiped; filters changed (old filters disposed of as asbestos waste)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Reusable RPE:</strong> cleaned according to the
                      manufacturer&rsquo;s instructions; filters replaced and old filters disposed
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Items that{' '}
                      <strong className="text-white">cannot be adequately decontaminated</strong>{' '}
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-orange-500">Key Principle:</strong> If you cannot be
                  certain that a tool or piece of equipment is completely free of asbestos
                  contamination, it must either be re-cleaned until it is demonstrably clean, or
                  disposed of as asbestos waste. The default position is always to err on the side
                  of caution.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white/80">
                  <div className="flex gap-3">
                    ...
                    <p>
                      <strong className="text-white">Decontaminate the worker</strong> &mdash;
                      7-step sequence, RPE last
                    </p>
                  </div>
                  <div className="flex gap-3">
                    <span className="flex items-center justify-center min-w-[28px] h-7 rounded-full bg-orange-500/20 text-orange-400 text-xs font-bold flex-shrink-0">
                    ...
                    <p>
                      <strong className="text-white">Decontaminate tools and equipment</strong>{' '}
                  ...
                  <div className="flex gap-3">
                    ...
                    <p>
                      <strong className="text-white">Decontaminate the work area</strong> &mdash;
                      damp-wipe, HEPA vacuum, visual inspection
                    </p>
                  </div>
                  <div className="flex gap-3">
                    <span className="flex items-center justify-center min-w-[28px] h-7 rounded-full bg-orange-500/20 text-orange-400 text-xs font-bold flex-shrink-0">
                    ...
                    <p>
                      <strong className="text-white">Bag and dispose of all waste</strong> &mdash;
                      double-bagged, consignment notes, licensed carrier
                    </p>
                  </div>
                </div>
              </div>
