...
const quickCheckQuestions = [
  {
    ...
    question: 'When is face-fit testing MANDATORY for respiratory protective equipment?',
    options: [
...
const faqs = [
  {
    question: 'Can I reuse an FFP3 disposable mask if it still looks clean?',
    answer:
  ...
  {
    question: 'What is the difference between qualitative and quantitative face-fit testing?',
    answer:
  ...
  {
    question: 'Why are Type 5 coveralls required instead of ordinary work overalls?',
    answer:
  ...
  {
    question: 'What should I do if my RPE fails during a face-fit test?',
    answer:
...
const quizQuestions = [
  {
    id: 1,
    question: 'What does APF stand for in relation to respiratory protective equipment?',
    options: [
  ...
  {
    id: 4,
    question: 'What type of disposable coverall is required for licensed asbestos work?',
    options: [
      'Type 1 Category I',
      'Type 3 Category II',
      'Type 5 Category III',
  ...
  {
    id: 5,
    question: 'In the 7-step decontamination sequence, what is the correct order for removing PPE?',
    options: [
...
export default function AsbestosModule4Section3() {
  useSEO({
    title: 'RPE & PPE Selection | Asbestos Awareness Module 4.3',
    description:
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-orange-500/5 border-l-2 border-orange-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>RPE:</strong> Last line of defence &mdash; engineering controls come first
              </li>
              <li>
                <strong>Face-fit:</strong> Mandatory for all tight-fitting RPE
              </li>
              <li>
                <strong>PPE:</strong> Type 5 coveralls, gloves, boot covers, eye protection
              </li>
              <li>
                <strong>Decontamination:</strong> RPE is always the LAST item removed
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-orange-500/5 border-l-2 border-orange-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              ...
              <li>
                <strong>Always:</strong> Follow the 7-step decontamination sequence
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Respiratory protective equipment (RPE) is designed to protect the wearer from
                inhaling airborne hazardous substances, including asbestos fibres. However, RPE is
                always the <strong>last line of defence</strong> in the hierarchy of controls.
                Engineering controls &mdash; such as enclosures, local exhaust ventilation, wet
                methods, and restricting access &mdash; must always be applied first to reduce fibre
                concentrations as far as reasonably practicable. RPE is then used to protect against
                the <strong>residual risk</strong> that remains after those controls are in place.
              </p>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  is inadequate. The hierarchy of controls must be followed for every asbestos task.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Adequate and suitable:</strong> The RPE must be
                      appropriate for the task and provide the required level of protection for the
                      expected fibre concentration
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Assigned Protection Factor (APF):</strong> Each
                      type of RPE has an APF rating that indicates how much it reduces exposure. The
                      APF must be sufficient for the task
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Face-fit testing:</strong> MANDATORY for all
                      tight-fitting RPE (FFP3, half-mask, full-face). Without a successful face-fit
                      test, the RPE cannot be relied upon
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Facial hair:</strong> Workers with beards or
                      stubble in the seal area <strong className="text-red-400">cannot</strong> use
                      tight-fitting RPE &mdash; they must use powered air or air-fed devices with
                      loose-fitting hoods
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Maintenance and storage:</strong> Reusable RPE
                      must be properly cleaned, maintained, inspected, and stored after each use
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <p>
                The Control of Asbestos Regulations 2012 (CAR 2012) and the HSE Approved Code of
                Practice (L143) set out the requirements for RPE selection and use. Employers must
                ensure that RPE is provided free of charge, that workers are trained in its correct
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Several types of RPE are used in asbestos work, each with a different Assigned
                Protection Factor (APF) and suitability for different work categories. Understanding
                which RPE is appropriate for each task is essential for adequate protection.
              </p>

              {/* FFP3 Disposable */}
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-1">FFP3 Disposable Mask</p>
                ...
                <ul className="text-sm text-white space-y-1.5">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      Single-use disposable filtering facepiece with a P3-rated filter built into
                      the mask body
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      Suitable for non-licensed asbestos work and some NNLW (notifiable non-licensed
                      work)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>Must be face-fit tested for each individual wearer</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                      <strong className="text-red-300">Cannot be reused</strong> &mdash; must be
                      disposed of as asbestos waste after each use
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1.5">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      Reusable rubber or silicone facepiece with replaceable P3 particulate filters
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>Suitable for non-licensed work and NNLW</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      Filter cartridges must be replaced according to manufacturer&rsquo;s
                      instructions and after each work session
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>Must be face-fit tested, cleaned, and inspected before each use</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1.5">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      Full-face respirator covering eyes, nose, and mouth with replaceable P3
                      filters
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      Provides eye protection as well as respiratory protection &mdash; no separate
                      goggles required
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>Suitable for all work categories including some licensed work</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      Must be face-fit tested &mdash; quantitative testing (PortaCount) is required
                      for full-face masks
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1.5">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      Battery-powered fan draws air through a P3 filter and delivers clean air
                      inside a loose-fitting hood or helmet
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      No face-fit test needed for loose-fitting versions &mdash; positive pressure
                      inside the hood prevents contaminated air from entering
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Suitable for workers with facial hair</strong>{' '}
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      More comfortable for extended wear &mdash; reduced breathing resistance
                      compared to non-powered RPE
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1.5">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      Supplied clean, breathable air from an external compressor or cylinder via a
                      hose
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      Used in full enclosures for licensed asbestos removal work where fibre
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      Provides the highest level of respiratory protection available for asbestos
                      work
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>Air supply must meet breathing air quality standards (BS EN 12021)</span>
                  </li>
                </ul>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="bg-white/5 border border-white/10 rounded-xl overflow-hidden">
            <div className="bg-orange-500/20 border-b border-orange-500/30 px-4 py-3">
              <p className="text-sm font-semibold text-orange-400">Matching RPE to Work Category</p>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Face-fit testing is <strong>mandatory for all tight-fitting RPE</strong> used in
                asbestos work. This includes FFP3 disposable masks, half-mask respirators, and
                full-face respirators. The test confirms that the specific RPE model and size
                creates an adequate seal against the wearer&rsquo;s face, preventing contaminated
                air from leaking past the face seal.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-3 text-sm text-white">
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="text-white font-medium">Qualitative (Taste Test)</p>
                      <p>
                        A bitter (bitrex) or sweet (saccharin) aerosol is sprayed into a hood placed
                        over the wearer&rsquo;s head while they perform a series of exercises
                        (talking, bending, turning). If the wearer can taste the aerosol, the RPE
                        has <strong className="text-red-300">failed</strong>. Simple pass/fail
                        result. Suitable for FFP3 and half-mask respirators.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="text-white font-medium">Quantitative (Machine-Measured)</p>
                      <p>
                        A machine (typically a PortaCount) measures particle concentrations inside
                        and outside the mask to calculate a numerical fit factor. More accurate and
                        reliable than qualitative testing.{' '}
                        <strong className="text-white">Required for full-face masks</strong>, as the
                        higher APF requires a higher level of testing confidence.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <ul className="text-sm text-white space-y-2">
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      loss, dental work, scarring, or other facial changes)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>When a different type of tight-fitting RPE is selected</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Records must be kept</strong> of all face-fit
                      tests, including the wearer&rsquo;s name, RPE make and model, date, and test
                      result
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      A <strong className="text-red-300">failed</strong> face-fit test means that
                      RPE model and size cannot be used by that wearer &mdash; try a different size
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Workers must be{' '}
                      <strong className="text-white">clean-shaven in the seal area</strong> when
                      wearing tight-fitting RPE &mdash; even a day&rsquo;s stubble can compromise
                      the seal
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  allowing contaminated air to bypass the filter. These workers must use a
                  loose-fitting powered air (PAPR) or air-fed device with a hood or helmet instead.
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                In addition to RPE, asbestos work requires a full set of personal protective
                equipment (PPE) designed to prevent fibres from contaminating your skin, hair, and
                clothing. All PPE used in asbestos work must be{' '}
                <strong>disposed of as asbestos waste</strong> after use &mdash; it cannot be
                laundered or reused (with the exception of dedicated boots that can be
                decontaminated).
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Disposable coveralls:</strong> Type 5 Category
                      III for licensed work, Type 5/6 for non-licensed work. Must be full-body with
                      hood, elasticated wrists and ankles, and front zip
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Boot covers</strong> or dedicated boots that
                      can be fully decontaminated (wiped down or washed)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Gloves:</strong> Single-use latex or nitrile
                      gloves. Double-gloving is recommended for licensed work
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Eye protection:</strong> Safety goggles if not
                      using full-face RPE (full-face masks and PAPR hoods provide built-in eye
                      protection)
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      Must have a <strong className="text-white">hood</strong> to protect hair from
                      fibre contamination
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Elasticated wrists and ankles</strong> to
                      minimise entry points for fibres
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Front zip</strong> with a self-adhesive flap or
                      storm flap to prevent fibre entry through the zip
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      Made from non-woven material that blocks the passage of microscopic fibres
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  through the zip or cuffs during work. If you must wear clothing underneath, it
                  should be minimal and must be treated as potentially contaminated. Contaminated
                  work clothes must never be taken home &mdash; this is a major cause of{' '}
                  <strong className="text-white">secondary exposure</strong> to family members.
                </p>
              </div>

              <p>
                All used PPE must be placed in <strong>labelled asbestos waste bags</strong>{' '}
                (red-striped or marked with the asbestos warning label) and disposed of at a
                licensed hazardous waste facility. PPE must never be placed in general waste, taken
                home, or reused.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white/5 border border-white/10 rounded-xl overflow-hidden">
            ...
            <div className="mx-4 sm:mx-6 mb-4 sm:mb-6 bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
              ...
              <p className="text-sm text-white">
                ...
                While the coverall and other PPE are being removed, fibres can become airborne. If
                your RPE has already been removed, you will inhale these fibres. This is one of the
                most common and dangerous mistakes in asbestos work.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Reusable RPE (half-mask and full-face respirators, PAPRs) must be properly
                maintained, cleaned, and stored to ensure it continues to provide the stated level
                of protection. Poorly maintained RPE can give a false sense of security &mdash; the
                wearer believes they are protected when in reality the equipment is compromised.
              </p>
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      must be thoroughly cleaned and disinfected after every work session, following
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Replace P3 filters:</strong> Filter cartridges
                      must be replaced according to the manufacturer&rsquo;s schedule and after each
                      asbestos work session. Used filters are asbestos waste
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Store properly:</strong> RPE must be stored in
                      a clean, dry place, away from contamination, sunlight, and extreme
                      temperatures. Ideally in a sealed bag or container
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      ...
                      facepiece, straps, valves, filters, and seals for damage, wear, or
                      deterioration before every use
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Remove damaged equipment:</strong> Any RPE that
                      is damaged, has worn seals, cracked facepieces, or defective valves must be
                      taken out of service immediately and replaced
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Keep records:</strong> Records of all
                      maintenance, inspection, and filter replacement must be kept. This provides an
                      audit trail demonstrating that RPE has been properly maintained
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-orange-500">PAPR Batteries:</strong> Powered air-purifying
                  respirators rely on battery power to drive the fan. Batteries must be fully
                  charged before each use and the fan must be checked for adequate airflow. A PAPR
                  with a flat or weak battery will not maintain positive pressure inside the hood,
                  reducing its protective performance to a dangerous level.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                mistakes has resulted in unnecessary asbestos exposure on real job sites. Many are
                made by workers who believe they are protected when they are not.
              </p>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-orange-500">Key Message:</strong> Every one of these
                  mistakes is avoidable. Proper training, correct equipment selection, face-fit
                  testing, and following the decontamination sequence every single time are the
                  foundations of safe asbestos work. Cutting corners with PPE and RPE is gambling
                  with your health and the health of those around you.
                </p>
              </div>
            </div>
          </div>
