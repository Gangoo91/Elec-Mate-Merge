...
const quickCheckQuestions = [
  ...
  {
    id: 'ac-friability',
    question: 'When does asbestos cement (AC) become friable and release fibres?',
    options: [
  ...
  },
  {
    ...
    question: 'What should you do FIRST if you encounter a suspected board or sheet ACM on site?',
    options: [
...
const faqs = [
  {
    question: 'Can I tell the difference between AIB and AC just by looking at them?',
    answer:
  ...
  {
    question: 'Is it safe to handle intact asbestos cement sheets without any precautions?',
    answer:
  ...
  {
    question: 'Where am I most likely to encounter asbestos boards and sheets as an electrician?',
    answer:
...
export default function AsbestosModule3Section1() {
  useSEO({
    title: 'Common ACMs \u2014 Boards & Sheets | Asbestos Awareness Module 3.1',
    description:
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-orange-500/5 border-l-2 border-orange-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Two main types:</strong> AIB (high risk, friable) and AC (lower risk when
                intact)
              </li>
              <li>
                <strong>AIB:</strong> 25&ndash;40% asbestos &mdash; licensed removal required
              </li>
              <li>
                <strong>AC:</strong> 10&ndash;15% asbestos &mdash; non-friable when intact
              </li>
              <li>
          ...
          <div className="p-4 rounded-lg bg-orange-500/5 border-l-2 border-orange-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Never:</strong> Drill, cut, sand, or disturb suspect boards/sheets
              </li>
              <li>
              ...
              <li>
                <strong>Report:</strong> Stop work and inform your supervisor immediately
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                When electricians, plumbers, joiners, and other tradespeople encounter
                asbestos-containing materials (ACMs) in board or sheet form, the material will
                almost always fall into one of two categories:{' '}
                <strong>Asbestos Insulating Board (AIB)</strong> or{' '}
                <strong>Asbestos Cement (AC)</strong>. Understanding the difference between these
                two is critical for determining the correct work procedures, the level of risk, and
                the type of controls required.
              </p>

              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-orange-500">Key Distinction:</strong> AIB has a{' '}
                  <strong>high asbestos content</strong> (25&ndash;40%) and is{' '}
                  <strong>friable</strong> &mdash; it releases fibres easily when damaged or
                  disturbed, making it <strong>higher risk</strong>. AC has a{' '}
                  <strong>lower asbestos content</strong> (10&ndash;15%) and is{' '}
                  <strong>non-friable when intact</strong> because the fibres are locked in a cement
                  matrix, making it <strong>lower risk</strong> &mdash; but only while it remains
                  undamaged.
                </p>
              </div>
              ...
              <p>
                Both materials were{' '}
                <strong>extremely common in UK buildings from the 1950s to the 1990s</strong>. They
                were used in a vast range of applications across domestic, commercial, industrial,
                and public buildings. Any building constructed or refurbished before the year 2000
                may contain one or both of these materials, and tradespeople routinely encounter
                them during maintenance, refurbishment, and installation work.
              </p>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-3">At a Glance</p>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  presume the higher-risk material (AIB) and stop work until the material has been
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Asbestos Insulating Board (AIB) is one of the most commonly encountered{' '}
                <strong>high-risk</strong> ACMs in UK buildings. It was manufactured from the 1950s
                through to the mid-1980s and was used extensively in commercial, public, and
                domestic buildings for fire protection, thermal insulation, and sound insulation.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Asbestos content:</strong> 25&ndash;40%
                      asbestos, typically amosite (brown), sometimes chrysotile (white) or
                      crocidolite (blue)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Composition:</strong> Asbestos fibres mixed
                      with calcium silicate or calcium compounds
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Texture:</strong> Relatively soft &mdash; can
                      be indented with a thumbnail or screwdriver
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Colour:</strong> Light to mid-grey, though can
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      <strong className="text-red-400">HIGH</strong> &mdash; releases fibres easily
                      when damaged, drilled, cut, or disturbed
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Density:</strong> Relatively low
                      (~700&ndash;1,000 kg/m&sup3;)
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  . It is illegal to remove AIB without a licence. Licensed removal involves a full
                  plan of work, a decontamination unit (DCU), continuous air monitoring, and
                  operatives trained and equipped for work with high-risk ACMs. As a tradesperson,
                  you must <strong className="text-white">never</strong> attempt to remove, cut,
                  drill, or disturb AIB yourself.
                </p>
              </div>

              <p>
                AIB is one of the materials that electricians are most likely to encounter,
                particularly when working behind ceiling tiles, routing cables through partition
                walls, or working on installations behind heater cupboard linings. Even small
                disturbances &mdash; such as pushing a cable through an AIB ceiling tile &mdash; can
                release dangerous quantities of asbestos fibres.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-amber-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Asbestos cement is by far the most common asbestos-containing material in the UK by
                volume. Massive quantities were installed across the country &mdash; millions of
                square metres of cement roofing alone &mdash; making it the ACM that tradespeople
                are most likely to encounter during their working lives.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Asbestos content:</strong> 10&ndash;15%
                      chrysotile asbestos bound in Portland cement
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Texture:</strong> Very hard and dense &mdash;
                      cannot be indented with a fingernail
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Colour:</strong> Grey, similar to ordinary
                      concrete or cement
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Friability:</strong> Non-friable when intact
                      (fibres locked in cement matrix).
                      <strong className="text-amber-400"> BECOMES friable</strong> when weathered,
                      broken, drilled, cut, or machined
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Density:</strong> High (~1,500&ndash;2,000
                      kg/m&sup3;)
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Corrugated roof sheets (garages, outbuildings, industrial units, farm
                      buildings)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
              ...
              <p>
                Although asbestos cement is classified as lower risk than AIB when intact, it can be
                handled with lower-level controls <strong>only</strong> if the material is in good
                condition and is not being cut, drilled, or machined. The moment power tools are
                used on asbestos cement, the cement matrix is broken up and asbestos fibres are
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  workers, and the keeping of a work register. Even though it does not require a
                  full HSE licence, NNLW is still regulated work with strict legal requirements.
                </p>
              </div>

              <p>
                The sheer volume of asbestos cement installed across the UK means it remains a
                significant concern. Millions of corrugated roof sheets on garages, agricultural
                buildings, and industrial units are reaching the end of their service life and
                becoming weathered and damaged. As these materials deteriorate, the risk of fibre
                release increases. Any work on or near weathered asbestos cement must be approached
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                While laboratory analysis is the only definitive way to confirm whether a material
                contains asbestos and what type it is, there are physical characteristics that can
                help distinguish between AIB and AC on site. However, these are{' '}
                <strong>indicative only</strong> and must never be relied upon as a substitute for
                proper analysis.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-3 text-sm text-white">
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="text-white font-medium">Thumbnail Test</p>
                      <p>
                        AIB can be indented with a thumbnail; AC cannot. However,{' '}
                        <strong className="text-red-300">
                          DO NOT perform this test without RPE and appropriate training
                        </strong>
                  ...
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="text-white font-medium">Relative Heaviness</p>
                      <p>
                        AC is significantly heavier than AIB due to its higher density
                        (~1,500&ndash;2,000 kg/m&sup3; vs ~700&ndash;1,000 kg/m&sup3;). A sheet of
                        AC will feel noticeably heavy for its size.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        AC sounds solid and dense when tapped. AIB sounds more hollow and produces a
                        duller, lighter sound.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="text-white font-medium">Surface Texture</p>
                      <p>
                        AIB tends to be smoother with a more uniform surface. AC has a cement-like
                        grainy texture, similar to concrete.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="text-white font-medium">Location Clues</p>
                      <p>
                        Ceiling tiles and internal partition walls are more likely AIB. Roof sheets,
                        gutters, and external cladding are more likely AC. However, exceptions
                        exist.
                      </p>
                    </div>
                  </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  Materials may be painted, coated, weathered, or mixed in ways that make physical
                  assessment misleading. The only reliable confirmation is analysis by a
                  UKAS-accredited laboratory. When in doubt,{' '}
                  <strong className="text-white">
                    ALWAYS presume the higher-risk material (AIB) until proven otherwise
                  </strong>
                  .
                </p>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Beyond AIB and AC, several other asbestos-containing board and sheet products were
                used in UK buildings and industrial settings. While less common than the main two
                types, these materials can still be encountered during refurbishment, demolition, or
                maintenance work, and all require proper assessment and management.
              </p>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-1">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Used for insulation, gaskets, and protective lining behind heat sources
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>High asbestos content &mdash; can be very friable</span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-1">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Used for insulation wrapping around pipes, ducts, and electrical components
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-1">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Gaskets, washers, and packing materials used in flanges and pipework
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Often found in boiler rooms, heating systems, and industrial plant
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-1">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Braided chrysotile rope used for sealing, packing glands, and gasket
                        purposes
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>Found around boiler doors, flue pipe joints, and valve stems</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>Can be very friable, especially when old and dried out</span>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-orange-500">Key Point:</strong> All of these materials
                  have varying asbestos content and friability. They all require proper assessment
                  and appropriate management under CAR 2012. If you encounter any material that you
                  suspect may contain asbestos, regardless of its form or thickness, the same rules
                  apply: stop work, do not disturb it, and report it.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                If you encounter a material during your work that you suspect may be an
                asbestos-containing board or sheet, the following procedure must be followed without
                exception. The actions you take in the first few moments are critical for protecting
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ol className="text-sm text-white space-y-3">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">STOP work immediately</strong> &mdash; cease
                      all activities that are disturbing or may disturb the material. Put down
                      tools.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      &mdash; any further disturbance will release more fibres into the air.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-0.5 w-6 h-6 rounded-full bg-red-500/20 border border-red-500/40 flex items-center justify-center flex-shrink-0 text-xs font-bold text-red-400">
                    ...
                    <span>
                      ...
                      &mdash; they are responsible for managing asbestos in the building and
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Check the asbestos register</strong> for the
                      building &mdash; the register should identify known ACMs and their locations.
                      If the material is already recorded, follow the management plan.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-0.5 w-6 h-6 rounded-full bg-red-500/20 border border-red-500/40 flex items-center justify-center flex-shrink-0 text-xs font-bold text-red-400">
                    ...
                    <span>
                      <strong className="text-white">If the material is not on the register</strong>
                      , presume it is asbestos and treat it accordingly. Do not attempt to sample or
                      assess it yourself.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Do not resume work</strong> until the material
                      has been assessed or sampled by a competent person and you have been given the
                      all-clear.
                    </span>
                  </li>
                </ol>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  in Module 5). In brief: <strong>Stop</strong> what you are doing,{' '}
                  <strong>Seal</strong> off the area, <strong>Supervise</strong> (prevent others
                  from entering), and <strong>Seek</strong> professional help immediately. Do not
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-orange-500">Remember:</strong> The decision to stop work
                  is always the right decision. No job is worth risking your health or the health of
                  those around you. If you are ever pressured to continue working in the presence of
                  suspected asbestos, you have the legal right to refuse and to report the
                  situation. Your employer has a legal duty to protect you from asbestos exposure
                  under the Control of Asbestos Regulations 2012 and the Health and Safety at Work
                  etc. Act 1974.
                </p>
              </div>
            </div>
