...
const quickCheckQuestions = [
  {
    ...
    question:
      'What is the primary method of identifying asbestos-containing materials in buildings?',
    options: [
    ...
    correctIndex: 0,
    explanation:
      'Asbestos surveys carried out by competent persons (ideally from UKAS-accredited organisations) are the primary and most reliable method of identifying ACMs in buildings. Visual inspection alone cannot confirm the presence of asbestos — laboratory analysis of samples is required.',
  },
  {
...
const quizQuestions = [
  {
    ...
    correctAnswer: 1,
    explanation:
      "HSG264 'Asbestos: The survey guide' is the authoritative HSE guidance on how asbestos surveys should be carried out. It replaced the earlier MDHS100 guidance and provides detailed requirements for both management surveys and refurbishment and demolition surveys.",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      'A management survey does NOT look behind walls, above ceilings without access, or in hidden voids unless specifically instructed. It covers accessible areas and surface materials. This is a key limitation — any areas not surveyed must be presumed to contain asbestos until proven otherwise.',
  },
  {
    id: 4,
    question:
      'What accreditation standard does the HSE recommend for asbestos surveying organisations?',
    options: [
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'A fully intrusive survey means the surveyor may need to carry out destructive inspection — opening up walls, lifting floors, removing ceiling panels, and accessing voids — to locate ALL asbestos-containing materials in the work area. This is why the building or area may need to be vacated during the survey.',
  },
  {
    id: 6,
    question:
      'Can a refurbishment and demolition survey be carried out progressively as work proceeds?',
    options: [
    ...
    correctAnswer: 2,
    explanation:
      'A refurbishment and demolition survey MUST be completed before any work that will disturb the building fabric begins. It cannot be done progressively during the work. This is a fundamental requirement — all ACMs must be identified and, where necessary, removed before refurbishment or demolition commences.',
  },
  {
    id: 7,
...
export default function AsbestosModule2Section3() {
  useSEO({
    ...
    description:
      'Management surveys and refurbishment & demolition surveys — when each is required, what they cover, surveyor qualifications, limitations, and what happens after the survey.',
  });
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-orange-500/5 border-l-2 border-orange-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>What:</strong> Systematic inspections to find asbestos-containing materials
              </li>
              <li>
                <strong>Two types:</strong> Management survey &amp; refurbishment/demolition survey
              </li>
              <li>
                <strong>Who:</strong> Competent surveyors from UKAS-accredited organisations
              </li>
              <li>
                <strong>Guidance:</strong> HSG264 &mdash; Asbestos: The survey guide
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-orange-500/5 border-l-2 border-orange-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Before routine work:</strong> A management survey must be in place
              </li>
              <li>
                <strong>Before refurb/demolition:</strong> A R&amp;D survey is mandatory
              </li>
              <li>
                <strong>No survey?</strong> Presume materials contain asbestos
              </li>
              <li>
                <strong>Always check:</strong> The asbestos register before starting any work
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Asbestos surveys are the{' '}
                <strong>primary method of identifying asbestos-containing materials (ACMs)</strong>{' '}
                in buildings. Without a survey, the dutyholder and anyone working in or on the
                building has no reliable way of knowing what materials contain asbestos and where
                those materials are located. This lack of information creates a serious risk to
                health every time maintenance, refurbishment, or demolition work is carried out.
              </p>
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">
                        Regulation 4 of the Control of Asbestos Regulations 2012 (CAR 2012)
                      </strong>{' '}
                      &mdash; the &ldquo;Duty to Manage&rdquo; requires the dutyholder to take
                      reasonable steps to find out whether a building contains ACMs. Commissioning
                      an asbestos survey is the primary way of fulfilling this duty. If a survey has
                      not been carried out, the dutyholder must
                      <strong> presume that materials contain asbestos</strong> until proven
                      otherwise.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      &mdash; before any refurbishment or demolition work, the client must provide
                      pre-construction information that includes details of any ACMs present. A
                      refurbishment and demolition survey is the standard method of obtaining this
                      information.
                    </span>
                  </li>
                </ul>
              ...
              <p>
                Surveys should be carried out by <strong>competent persons</strong>. The HSE
                strongly recommends using surveyors from{' '}
                <strong>UKAS-accredited surveying organisations</strong>, as this provides assurance
                that the surveyor has the necessary training, experience, equipment, and quality
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  ...
                  guidance on asbestos surveys is{' '}
                  <strong>HSG264 &ldquo;Asbestos: The survey guide&rdquo;</strong>. This document
                  sets out the standards for both management surveys and refurbishment and
                  demolition surveys. It replaced the earlier MDHS100 guidance and should be
                  followed by all surveyors and dutyholders.
                </p>
              </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  that no maintenance, refurbishment, or demolition work should be carried out on
                  any material that has not been surveyed or sampled, unless it is treated as if it
                  contains asbestos with all the associated precautions and controls.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                premises. Its purpose is to{' '}
                <strong>
                  locate asbestos-containing materials that could be disturbed or damaged during
                  normal occupation
                </strong>
                , including routine maintenance work, and to assess their condition so they can be
                managed safely over time.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Purpose:</strong> Locate ACMs and assess their
                      condition so they can be managed during normal occupation
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Scope:</strong> Covers the entire building or
                      specific areas as agreed with the dutyholder
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Method:</strong> Visual inspection combined
                      with sampling of suspected ACMs for laboratory analysis. Where sampling is not
                      possible or practical, materials may be <strong>presumed</strong> to contain
                      asbestos
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">When required:</strong> For all non-domestic
                      premises where the dutyholder has a duty to manage asbestos. Should be in
                      place before any routine maintenance work is carried out
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">What it covers:</strong> Accessible areas,
                      surface materials, and materials that can be reached without destructive
                      investigation &mdash; such as lifting ceiling tiles, opening inspection
                      hatches, and entering service risers
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <p>
                The management survey is designed to be <strong>non-destructive</strong>. The
                surveyor will inspect all accessible areas and take representative samples of
                materials that are suspected of containing asbestos. These samples are sent to an
                accredited laboratory for analysis. The survey report will list all ACMs found (or
                presumed), their location, condition, and a risk rating based on a material
                assessment.
              </p>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  areas not accessed must be clearly recorded in the survey report, and the
                  materials in those areas must be presumed to contain asbestos.
                </p>
              </div>

              <p>
                The condition of identified ACMs should be{' '}
                <strong>re-assessed at regular intervals</strong> &mdash; typically annually &mdash;
                to ensure that any deterioration or damage is identified promptly and appropriate
                action is taken. The management survey is not a one-off exercise; it forms the basis
                of an ongoing management process.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The refurbishment and demolition (R&amp;D) survey is a{' '}
                <strong>fully intrusive survey</strong> designed to locate{' '}
                <strong>ALL asbestos-containing materials</strong> in the area where work will take
                place. Unlike the management survey, which only covers accessible areas, the R&amp;D
                survey involves opening up the building structure to find hidden ACMs that would be
                disturbed by the planned work.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Purpose:</strong> Locate ALL ACMs in the area
                      where refurbishment or demolition work will take place, including hidden
                      materials
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Scope:</strong> The specific area where
                      refurbishment or demolition is planned &mdash; not necessarily the entire
                      building
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Method:</strong> Fully intrusive &mdash; may
                      involve destructive inspection such as opening up walls, lifting floors,
                      removing ceiling panels, and accessing voids
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">When required:</strong> BEFORE any work that
                      will disturb the building fabric &mdash; refurbishment, demolition, or major
                      maintenance work
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">What it covers:</strong> All materials in the
                      work area, including hidden and difficult-to-access materials in walls,
                      floors, ceilings, voids, and service risers
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <p>
                ...
                <strong>
                  {' '}
                  building or the specific area being surveyed may need to be vacated
                </strong>{' '}
                during the survey. This is to protect the health of building occupants and to allow
                the surveyor to carry out destructive inspection safely.
              </p>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  identified before the refurbishment or demolition contractor starts work, so that
                  appropriate arrangements can be made for removal or management of the asbestos
                  before the main work commences.
                </p>
              </div>

              <p>
                The outcome of the R&amp;D survey is a{' '}
                <strong>comprehensive list of ALL ACMs</strong> in the work area, with their exact
                locations, types, and quantities. This information is used to plan the asbestos
                removal work that must take place before the refurbishment or demolition can
                proceed. The survey provides critical information for the refurbishment/demolition
                contractor, the asbestos removal contractor, and the project manager.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The reliability of an asbestos survey depends entirely on the competence of the
                person carrying it out. A survey performed by someone who lacks the necessary
                training, knowledge, or experience could miss ACMs, leading to workers being
                unknowingly exposed to asbestos fibres. For this reason, the law requires that
                surveys are carried out by
                <strong> competent persons</strong>.
              </p>

              <p>
                Competence in this context means having the right combination of{' '}
                <strong>training, knowledge, experience, and practical ability</strong> to carry out
                the specific type of survey being undertaken. A surveyor must understand asbestos
                materials, their appearance, their typical locations in different types of
                buildings, and the correct sampling and assessment techniques.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">UKAS accreditation</strong> &mdash; the HSE
                      strongly recommends using surveyors from UKAS-accredited organisations. UKAS
                      accreditation to <strong>ISO 17020</strong> applies to inspection bodies
                      (surveyors), whilst
                      <strong> ISO 17025</strong> applies to testing laboratories (analysts who
                      examine the samples taken during the survey).
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      ...
                      surveyor should hold the <strong>BOHS P402</strong> qualification (Building
                      Surveys and Bulk Sampling for Asbestos), which is the recognised industry
                      standard for asbestos surveyors. Additional qualifications may include BOHS
                      P401 (Identification of Asbestos in Bulk Samples) and BOHS P403 (Asbestos in
                      Soils).
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Appropriate insurance</strong> &mdash;
                      surveyors must carry professional indemnity insurance and public liability
                      insurance. This protects the client in the event that the survey is
                      negligently carried out and ACMs are missed.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Experience and track record</strong> &mdash;
                      the surveyor should have demonstrable experience in surveying the type of
                      building being assessed. Experience with a range of building types and ages is
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                <strong>
                  no survey can guarantee 100% identification of all asbestos-containing materials
                </strong>{' '}
                in a building. Even the most thorough and competent survey has inherent limitations,
                and these must be understood by the dutyholder and anyone relying on the survey
                findings.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">
                        Management surveys do not cover hidden areas
                      </strong>{' '}
                      &mdash; they are limited to accessible locations and materials that can be
                      reached without destructive investigation. ACMs in walls, behind fixed panels,
                      under floors, and in sealed voids will not be identified unless a
                      refurbishment and demolition survey is carried out.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">
                        Survey reports should clearly state limitations
                      </strong>{' '}
                      &mdash; any areas not accessed, materials not sampled, and reasons for
                      exclusions must be documented in the report. The dutyholder must read and
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Presumed materials</strong> &mdash; where areas
                      were not surveyed or materials were not sampled, they must be{' '}
                      <strong>presumed to contain asbestos</strong> until they are properly
                      analysed. This presumption has practical consequences for anyone working on or
                      near those materials.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Post-survey changes</strong> &mdash; any
                      changes to the building after the survey may introduce new ACMs (for example,
                      from reclaimed materials) or disturb existing ones. The survey reflects the
                      condition of the building at the time it was carried out and must be kept up
                      to date.
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  <strong>living document</strong> that reflects the current state of the building.
                  If new areas are opened up, if ACMs are removed or encapsulated, or if the
                  building undergoes significant changes, the survey must be updated accordingly.
                </p>
              </div>
            </div>
          </div>
                ...
                <div className="space-y-3 text-sm text-white">
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        The surveyor provides a detailed report listing all ACMs found (or
                        presumed), their location, type, condition, and extent. The report will
                        include floor plans showing ACM locations and photographs where appropriate.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="text-white font-medium">
                        Results Feed Into the Asbestos Register
                      </p>
                      <p>
                        The survey findings form the basis of the asbestos register &mdash; the
                        central record of all known and presumed ACMs in the building. The register
                  ...
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        Each ACM is assessed for both its current condition (material assessment)
                        and the likelihood that it will be disturbed (priority assessment).
                        Together, these determine what management action is needed &mdash; from
                        simple monitoring through to urgent removal.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        Based on the survey findings and risk assessments, a written management plan
                        is produced. This sets out how each ACM will be managed &mdash; whether it
                        will be left in situ and monitored, encapsulated, sealed, labelled, or
                        removed.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        The location and condition of ACMs must be communicated to all relevant
                        parties &mdash; building managers, maintenance staff, contractors, and
                        anyone else who may work in or on the building. This is typically done by
                        making the asbestos register available and providing information at the
                        point of work.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        A schedule for periodic re-inspection of ACMs is set up &mdash; typically
                        annually. The purpose is to monitor the condition of ACMs over time and
                        identify any deterioration or damage that requires action.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        If the survey identifies any ACMs in poor condition that pose an immediate
                        risk &mdash; such as damaged sprayed coatings or deteriorating pipe lagging
                        in occupied areas &mdash; urgent action must be taken. This may include
                        restricting access, emergency encapsulation, or immediate removal by a
