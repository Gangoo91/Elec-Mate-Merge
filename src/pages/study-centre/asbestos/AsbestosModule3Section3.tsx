...
const quickCheckQuestions = [
  {
    ...
    question:
      'What material was most commonly used for flash guards inside pre-2000 consumer units and distribution boards?',
    options: [
    ...
    correctIndex: 0,
    explanation:
      'Flash guards and arc barriers inside consumer units and distribution boards were typically made from asbestos insulating board (AIB) containing amosite (brown asbestos). AIB was chosen for its excellent fire resistance and electrical insulation properties.',
  },
  {
...
const quizQuestions = [
  ...
  },
  {
    id: 2,
    question:
      'What was the primary purpose of AIB flash guards inside consumer units and distribution boards?',
    options: [
    ...
    correctAnswer: 2,
    explanation:
      'AIB flash guards were installed as arc barriers between busbars inside consumer units and distribution boards. Their purpose was to prevent arcing (electrical flashover) between live conductors and to provide fire resistance within the enclosure.',
  },
  {
    id: 3,
    question:
      'Which of the following activities could disturb asbestos flash guards in a consumer unit?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'Opening a pre-2000 consumer unit for board changes, circuit modifications, fuse replacement, or inspection and testing can disturb asbestos flash guards inside. Activities that only involve the external surface of the board (reading labels, switching MCBs) are less likely to cause disturbance, but a check should still be made before opening any pre-2000 board.',
  },
  {
    id: 4,
    question:
      'Asbestos cement cable trench covers are most commonly found in which type of building?',
    options: [
  ...
  },
  {
    id: 5,
    question:
      'What type of asbestos product might you find used as a backing board behind electrical switchgear?',
    options: [
  ...
  },
  {
    id: 8,
    question:
      'If you discover a suspected ACM during electrical work, what is the correct sequence of actions?',
    options: [
    ...
    correctAnswer: 2,
    explanation:
      'The correct sequence is: STOP work immediately, do NOT disturb the material further, leave the area, prevent others from entering, and report to your supervisor and the dutyholder immediately. Do not attempt to sample, remove, or work around suspected ACMs. Work must not resume until the material has been assessed by a competent person.',
  },
];
...
export default function AsbestosModule3Section3() {
  useSEO({
    ...
    description:
      'Flash guards, backing boards, cable trenching, switchgear, fuse carriers, and pre-work checks for electricians working in pre-2000 buildings.',
  });
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-orange-500/5 border-l-2 border-orange-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Who:</strong> Electricians are among the trades MOST at risk
              </li>
              <li>
                <strong>Where:</strong> Consumer units, backing boards, cable ducts, switchgear
              </li>
              <li>
                <strong>When:</strong> Any pre-2000 electrical installation
              </li>
              <li>
                <strong>Rule:</strong> Always check the asbestos register before starting work
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-orange-500/5 border-l-2 border-orange-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Before:</strong> Check the register &mdash; ask the dutyholder
              </li>
              <li>
                <strong>During:</strong> If you suspect ACMs &mdash; STOP immediately
              </li>
              <li>
                <strong>Never:</strong> Drill, chase, or cut through suspected ACMs
              </li>
              <li>
                <strong>Report:</strong> Every suspected ACM &mdash; it could save lives
              </li>
            </ul>
          </div>
        </div>
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  out electrical work in buildings constructed or refurbished before the year 2000.
                  This section is specifically written for you.
                </p>
              </div>

              <p>
                Electrical work frequently involves{' '}
                <strong>
                  drilling into walls, chasing cables, lifting floorboards, working in ceiling
                  voids, and accessing confined spaces
                </strong>{' '}
                &mdash; all activities that carry a high risk of disturbing hidden
                asbestos-containing materials. Unlike some trades where contact with building fabric
                is occasional, electricians interact with the structure of a building on almost
                every job.
              </p>

              <p>
                Pre-2000 electrical installations commonly used asbestos-containing components.
                Flash guards inside consumer units, backing boards behind distribution boards, cable
                trench covers, and switchgear arc shields were all routinely manufactured using
                asbestos insulating board (AIB) or asbestos cement (AC). Many of these components
                remain in service today, hidden inside enclosures and behind panels where they are
                not immediately visible.
              </p>

              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-orange-500">JIB Guidance:</strong> The Joint Industry
                  Board (JIB) emphasises that all electrical workers must hold asbestos awareness
                  training and understand the specific risks relevant to their trade. The JIB
                  recognises that electricians have historically been one of the most heavily
                  exposed groups, and that ongoing vigilance is essential to prevent further harm.
                </p>
              </div>

              <p>
                Many electricians have historically been exposed to asbestos fibres without knowing
                it. Opening old fuse boards, drilling into AIB backing boards, pulling cables
                through asbestos-lined ducts &mdash; these were routine activities that no one
                thought twice about before the risks were widely understood. This historical
                exposure is a significant contributor to the{' '}
                <strong>approximately 5,000 asbestos-related deaths</strong> that occur in the UK
                every year.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  This is not optional. It is not something you do only on large commercial jobs. It
                  applies to every rewire, every board change, every socket addition, every
                  inspection and test &mdash; in every building built or refurbished before 2000. No
                  exceptions.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Asbestos insulating board (AIB) was widely used as <strong>flash guards</strong>{' '}
                (also called arc barriers) inside consumer units and distribution boards. These thin
                panels of AIB were positioned between busbars and other live components to prevent
                electrical arcing and to provide fire resistance within the enclosure.
              </p>
              ...
              <p>
                ...
                <strong> older MCB boards</strong>, and <strong>distribution boards</strong> in
                commercial and industrial buildings. They are typically thin, flat panels slotted
                between busbars or fixed to internal partitions within the enclosure. Because they
                sit inside the board, they are not visible from the outside &mdash; you only
                encounter them when you open the cover.
              </p>

              <p>
                These flash guards can be disturbed during a range of common electrical activities:
                <strong> board changes</strong> (removing the old board),{' '}
                <strong>circuit modifications</strong>
                (accessing the busbars), <strong>fuse replacement</strong> (particularly in
                rewireable boards), and <strong>inspection and testing</strong> (opening the board
                for visual inspection). Any of these activities can crack, break, or abrade the AIB,
                releasing asbestos fibres into the air within the enclosed space of the board
                &mdash; and directly into the breathing zone of the electrician.
              </p>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  been assessed,{' '}
                  <strong className="text-white">presume that AIB may be present</strong> and do not
                  proceed until the material has been identified by a competent person.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ol className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">STOP work</strong> &mdash; do not attempt to
                      remove the flash guards
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-0.5 w-6 h-6 rounded-full bg-red-500/20 border border-red-500/40 flex items-center justify-center flex-shrink-0 text-xs font-bold text-red-400">
                    ...
                    <span>
                      <strong className="text-white">Close the board</strong> carefully to prevent
                      further disturbance
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Report</strong> to your supervisor and the
                      dutyholder immediately
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-0.5 w-6 h-6 rounded-full bg-red-500/20 border border-red-500/40 flex items-center justify-center flex-shrink-0 text-xs font-bold text-red-400">
                    ...
                    <span>
                      <strong className="text-white">Arrange removal</strong> by a licensed
                      contractor (may be licensed work depending on condition)
                    </span>
                  </li>
                </ol>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white/5 border border-white/10 rounded-lg p-4 sm:p-6">
              <p className="text-sm font-medium text-orange-400 mb-4 text-centre">
                Consumer Unit / Distribution Board &mdash; Cutaway View
              </p>
                ...
                <div className="border-2 border-white/30 rounded-lg bg-[#1a1a1a] p-3 sm:p-4">
                  ...
                  <div className="flex gap-1 sm:gap-2 items-stretch min-h-[180px] sm:min-h-[220px]">
                    ...
                    <div className="w-6 sm:w-8 border-2 border-orange-500 rounded bg-orange-500/20 flex items-center justify-center relative">
                      <span
                        className="text-[8px] sm:text-[9px] text-orange-400 font-bold writing-mode-vertical rotate-180"
                    ...
                    <div className="w-6 sm:w-8 border-2 border-orange-500 rounded bg-orange-500/20 flex items-center justify-center relative">
                      <span
                        className="text-[8px] sm:text-[9px] text-orange-400 font-bold"
                        style={{ writingMode: 'vertical-rl', textOrientation: 'mixed' }}
                      >
                        AIB FLASH GUARD
                      </span>
                  ...
                  <div className="mt-3 border-2 border-dashed border-orange-400/50 rounded bg-orange-500/10 p-2 text-center">
                    <span className="text-[10px] sm:text-xs text-orange-400 font-medium">
                      &#8595; Possible AIB backing board behind unit (mounted on wall) &#8595;
                    </span>
                  </div>
                </div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-lg p-4 sm:p-6">
              <p className="text-sm font-medium text-orange-400 mb-4 text-centre">
                Cable Routes &mdash; Potential ACM Locations
              </p>
              <div className="relative mx-auto max-w-lg space-y-2">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-1.5">
                      ...
                      <span className="text-[10px] text-orange-400">
                        Possible sprayed coatings or AIB
                      </span>
                    </div>
                  </div>
                ...
                <div className="flex gap-2 items-stretch min-h-[60px]">
                  ...
                  <div className="w-8 border-2 border-orange-500 rounded bg-orange-500/20 flex items-center justify-center">
                    <span
                      className="text-[8px] text-orange-400 font-bold"
                      style={{ writingMode: 'vertical-rl', textOrientation: 'mixed' }}
                    >
                      AIB WALL
                    </span>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Asbestos insulating board (AIB) was extensively used as{' '}
                <strong>backing boards</strong> for switchgear, distribution boards, and electrical
                equipment. These boards were mounted on walls behind electrical installations to
                provide fire resistance and a stable, insulating surface for mounting equipment.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="grid sm:grid-cols-2 gap-2 text-sm text-white/80">
                  <div className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Commercial premises</strong> &mdash; behind
                      main switch panels and distribution boards
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Industrial buildings</strong> &mdash; behind
                  ...
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Schools &amp; hospitals</strong> &mdash; behind
                      distribution boards and sub-main panels
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Plant rooms</strong> &mdash; behind control
              ...
              <p>
                Backing boards can be <strong>large panels</strong> &mdash; 1 metre by 2 metres or
                more in some cases. They are often <strong>painted</strong> and may not be
                immediately obvious as asbestos. A painted AIB backing board can look identical to
                standard fibreboard, plywood, or even plasterboard. You cannot tell the difference
                by appearance alone.
              </p>

              <p>
                These boards are disturbed during common electrical activities:{' '}
                <strong>mounting new equipment</strong> (drilling fixings into the board),{' '}
                <strong>replacing distribution boards</strong> (removing the old board exposes the
                backing), <strong>chasing cables</strong>
                (running new cable routes behind or through the board), and{' '}
                <strong>drilling fixings</strong>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  ...
                  condition may require <strong>licensed removal</strong> under the Control of
                  Asbestos Regulations 2012. Even boards in good condition must only be removed by a
                  competent contractor following appropriate controls. An electrician with awareness
                  training alone is not qualified to remove these materials.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                <strong> floor duct systems</strong>. These heavy grey sheets provided
                fire-resistant protection for cable routes running beneath floors, through risers,
                and across service corridors.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Industrial buildings</strong> &mdash; cable
                      runs across factory floors and between switchrooms
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Power stations</strong> &mdash; extensive cable
                      duct systems throughout the plant
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Commercial premises</strong> &mdash; floor
                      ducts in older office buildings and retail units
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Older office buildings</strong> &mdash; hidden
                      under raised floors or carpet tiles
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <p>
                AC cable trench covers are typically <strong>heavy grey sheets</strong>, often with
                a slightly rough or textured surface. They may be flush with the floor surface or
                recessed into channels. Over time they may become painted, covered with adhesive
                from floor tiles, or obscured by raised flooring systems &mdash; making them
                difficult to identify.
              </p>

              <p>
                In addition to AC covers, you may find{' '}
                <strong>AIB used as duct linings or separators</strong>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  modification, and <strong className="text-white">modifying cable routes</strong>.
                  Lifting, sliding, or breaking AC covers can release asbestos fibres. Floor ducts
                  hidden under raised floors or carpet tiles may be encountered unexpectedly during
                  electrical work.
                </p>
              </div>
            </div>
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                electrical arcs and prevent fire spread. These components are found in a range of
                electrical equipment from domestic fuse carriers to high-voltage industrial
                switchgear.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">BS 3036 rewireable fuse carriers</strong>{' '}
                      &mdash; some contain asbestos linings within the fuse carrier body, designed
                      to contain the arc when a fuse blows
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">High-voltage switchgear</strong> &mdash; in
                      industrial and commercial buildings, HV switchgear may contain asbestos arc
                      chutes designed to extinguish the arc when the switch opens
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Transformer insulation</strong> &mdash; older
                      transformers may include asbestos materials in their insulation systems and
                      terminal bushings
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Motor insulation</strong> &mdash; older motors
                      may have asbestos insulation in their windings and terminal boxes
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <p>
                These components are often <strong>small</strong> but can release significant
                quantities of fibres when handled, broken, or damaged. A cracked fuse carrier, a
                deteriorating arc shield, or a damaged transformer bushing can all generate airborne
                asbestos fibres. The confined spaces inside switchgear enclosures mean that any
                fibres released are concentrated in the breathing zone of the person working on the
                equipment.
              </p>

              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-orange-500">Important:</strong> If you encounter old BS
                  3036 rewireable fuse boards, do not assume the fuse carriers are safe to handle.
                  Some carriers contain asbestos linings. If you are carrying out a board upgrade
                  and need to remove old fuse carriers, check whether they contain asbestos before
                  proceeding. When in doubt, treat them as ACMs and seek professional assessment.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Asbestos was widely used in <strong>electrical heating equipment</strong> for its
                outstanding thermal insulation properties. Several types of electrical heating
                appliance may contain asbestos components, and electricians are frequently called
                upon to disconnect, replace, or remove these items.
              </p>
                ...
                <div className="grid sm:grid-cols-2 gap-3 text-sm">
                  ...
                  <div className="flex items-start gap-2 text-white/80">
                    ...
                    <span>
                      ...
                      electric fires may contain asbestos components in the surround and backing
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  may deteriorate over time, especially if the heater has been damaged or moved.
                  When called to disconnect or remove an old storage heater,{' '}
                  <strong className="text-white">always check whether it contains asbestos</strong>{' '}
                  before attempting any work. Some manufacturers have published lists of models that
                  contain asbestos &mdash; check these before proceeding. If in doubt, presume
                  asbestos is present.
                </p>
              </div>
              ...
              <p>
                <strong>
                  Always check before disconnecting or removing old electric heating equipment.
                </strong>{' '}
                This applies to any heating appliance manufactured before 2000. The presence of
                asbestos may not be obvious from the outside of the appliance &mdash; it may only
                become apparent when the unit is opened, dismantled, or moved.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  &mdash; they apply to domestic rewires, socket additions, board changes, and every
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ol className="text-sm text-white/80 space-y-3">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">
                        Ask the dutyholder/client about the asbestos register
                      </strong>{' '}
                      &mdash; every non-domestic building should have one under Regulation 4 of CAR
                      2012. For domestic properties, ask the homeowner about any known asbestos
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-0.5 w-7 h-7 rounded-full bg-orange-500/20 border border-orange-500/40 flex items-center justify-center flex-shrink-0 text-xs font-bold text-orange-400">
                    ...
                    <span>
                      <strong className="text-white">
                        Check if a management survey has been carried out
                      </strong>{' '}
                      &mdash; this should identify and record the location, condition, and type of
                      all known or presumed ACMs in the building
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-0.5 w-7 h-7 rounded-full bg-orange-500/20 border border-orange-500/40 flex items-center justify-center flex-shrink-0 text-xs font-bold text-orange-400">
                    ...
                    <span>
                      <strong className="text-white">
                        If no register exists, presume that ACMs may be present
                      </strong>{' '}
                      &mdash; the absence of information is not evidence of absence. Treat every
                      suspect material as asbestos until proven otherwise
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-0.5 w-7 h-7 rounded-full bg-orange-500/20 border border-orange-500/40 flex items-center justify-center flex-shrink-0 text-xs font-bold text-orange-400">
                    ...
                    <span>
                      ...
                      &mdash; look for textured coatings, board materials, pipe lagging, ceiling
                      tiles, and any materials that match ACM descriptions from your training
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-0.5 w-7 h-7 rounded-full bg-orange-500/20 border border-orange-500/40 flex items-center justify-center flex-shrink-0 text-xs font-bold text-orange-400">
                    ...
                    <span>
                      <strong className="text-white">
                        Check behind boards, inside ducts, and in ceiling voids
                      </strong>{' '}
                      &mdash; before working in these concealed areas, visually inspect for ACMs. Do
                      not reach into or disturb materials without first checking
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-0.5 w-7 h-7 rounded-full bg-orange-500/20 border border-orange-500/40 flex items-center justify-center flex-shrink-0 text-xs font-bold text-orange-400">
                    ...
                    <span>
                      <strong className="text-white">
                        If ANY suspected ACM is found &mdash; STOP work immediately
                      </strong>{' '}
                      &mdash; do not continue. Do not attempt to identify or sample the material
                      yourself
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Report to supervisor and dutyholder</strong>{' '}
                      &mdash; inform them of the suspected ACM, its location, and condition. Leave
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">
                        Do NOT resume work until the material has been assessed
                      </strong>{' '}
                      &mdash; a competent person must identify the material before work can
                      continue. This may involve laboratory analysis
                    </span>
                  </li>
                </ol>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Permit-to-work systems</strong> should be in
                      place for any work near known ACMs. The permit should detail the ACM location,
                      condition, and the controls required
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Dynamic risk assessment:</strong> if you
                      encounter anything unexpected during work &mdash; an unfamiliar board
                      material, a suspect coating, dust in a ceiling void &mdash; STOP immediately
                      and reassess
                    </span>
                  </li>
                </ul>
                ...
                <div className="space-y-2">
                  <div className="flex items-start gap-2 text-sm text-white/80">
                    ...
                    <span>
                      ...
                      &mdash; drilling generates dust that can contain millions of asbestos fibres
                  ...
                  <div className="flex items-start gap-2 text-sm text-white/80">
                    ...
                    <span>
                      <strong className="text-white">
                        Never chase cables through suspected AIB panels
                      </strong>{' '}
                      &mdash; chasing creates large volumes of dust and debris from the entire
                      length of the chase
                    </span>
                  </div>
                  <div className="flex items-start gap-2 text-sm text-white/80">
                    ...
                    <span>
                      <strong className="text-white">
                        Never break or cut suspected asbestos materials
                      </strong>{' '}
                  ...
                  <div className="flex items-start gap-2 text-sm text-white/80">
                    ...
                    <span>
                      <strong className="text-white">
                        Never sweep up asbestos debris with a normal vacuum or broom
                      </strong>{' '}
                      &mdash; this spreads fibres further. Only a Type H (HEPA) vacuum approved for
                  ...
                  <div className="flex items-start gap-2 text-sm text-white/80">
                    ...
                    <span>
                      <strong className="text-white">
                        Never remove suspected asbestos flash guards or backing boards yourself
                      </strong>{' '}
                      &mdash; removal of AIB is controlled work and may require a licensed
                      contractor
                    </span>
                  </div>
                  <div className="flex items-start gap-2 text-sm text-white/80">
                    ...
                    <span>
                      <strong className="text-white">
                        Never assume a material is safe because it &ldquo;doesn&rsquo;t look like
                        asbestos&rdquo;
                      </strong>{' '}
                      &mdash; asbestos is often hidden, painted, or mixed with other materials.
                  ...
                  <div className="flex items-start gap-2 text-sm text-white/80">
                    ...
                    <span>
                      <strong className="text-white">
                        Never work in a ceiling void without checking for sprayed coatings or AIB
                      </strong>{' '}
                      &mdash; ceiling voids are one of the most common locations for hidden ACMs,
                      including sprayed asbestos coatings
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-start gap-2 text-sm text-white/80">
                    ...
                    <span>
                      <strong className="text-white">
                        Always report &mdash; it could save your life and your colleagues&rsquo;
                        lives
                      </strong>
                    </span>
                  </div>
