...
const quickCheckQuestions = [
  {
    ...
    question:
      'Under CAR 2012 Regulation 5, what must a dutyholder do if a material cannot be identified?',
    options: [
    ...
    correctIndex: 0,
    explanation:
      'Under Regulation 5 of CAR 2012, if a material cannot be identified, it MUST be presumed to contain asbestos. This is the default legal position — presume asbestos until sampling and analysis prove otherwise. Presuming means treating the material as if it contains asbestos and applying appropriate controls.',
  },
  {
    id: 'who-can-sample',
    question:
...
const quizQuestions = [
  ...
  },
  {
    id: 6,
    question:
      'Which method is used for air monitoring during and after asbestos work to count airborne fibres?',
    options: [
      'Polarised Light Microscopy (PLM)',
  ...
  },
  {
    id: 8,
    question:
      "A laboratory result states 'No asbestos detected' for a single bulk sample. What does this mean in practice?",
    options: [
...
export default function AsbestosModule3Section4() {
  useSEO({
    ...
    description:
      'The presumption approach under CAR 2012, when sampling is justified, who can sample, PLM analysis, bulk sampling vs air monitoring, sampling procedure, and interpreting laboratory results.',
  });
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-orange-500/5 border-l-2 border-orange-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Default position:</strong> Presume asbestos until proven otherwise (CAR 2012
                Reg 5)
              </li>
              <li>
                <strong>Sampling:</strong> Only by competent persons with BOHS P402
              </li>
              <li>
                <strong>Analysis:</strong> PLM by UKAS-accredited laboratory
              </li>
              <li>
                <strong>Guidance:</strong> HSG248 &mdash; Asbestos: The analysts&rsquo; guide
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-orange-500/5 border-l-2 border-orange-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Not sure?</strong> Presume it&rsquo;s asbestos &mdash; this is the law
              </li>
              <li>
                <strong>Never sample yourself:</strong> Only competent persons with RPE
              </li>
              <li>
                <strong>One negative result</strong> does not clear the whole area
              </li>
              <li>
                <strong>Always update</strong> the asbestos register with results
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Under{' '}
                <strong>Regulation 5 of the Control of Asbestos Regulations 2012 (CAR 2012)</strong>
                , if materials in a building cannot be identified, they{' '}
                <strong>MUST be presumed to contain asbestos</strong>. This is not a suggestion or a
                best-practice recommendation &mdash; it is a<strong> legal requirement</strong>. The
                default position is always: presume asbestos until sampling and laboratory analysis
                prove otherwise.
              </p>

              <p>
                Presuming means treating the material <strong>as if it contains asbestos</strong>{' '}
                and applying all of the appropriate controls. This includes recording it in the
                asbestos register, including it in the management plan, labelling or marking it
                where appropriate, and ensuring that anyone who may disturb the material is informed
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white mb-3">
                  ...
                  in its own right. Many dutyholders actively choose to presume rather than sample.
                </p>
                  ...
                  <div>
                    ...
                    <ul className="text-sm text-white space-y-1.5">
                      ...
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-green-400 flex-shrink-0" />
                        <span>
                          Simplifies the management process for materials that will not be disturbed
                        </span>
                      </li>
                    </ul>
                  </div>
                  <div>
                    ...
                    <ul className="text-sm text-white space-y-1.5">
                      ...
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                        <span>
                          Higher costs for work near presumed ACMs (extra precautions, specialist
                          contractors)
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                        <span>
                          Does not identify the type of asbestos, which may affect risk assessment
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                        <span>
                          May create confusion if multiple materials are all &ldquo;presumed&rdquo;
                        </span>
                      </li>
                    </ul>
                  </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  appropriate controls &mdash; is a breach of the Control of Asbestos Regulations
                  2012 and could result in enforcement action by the HSE, including prosecution.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                <strong> sampling is justified</strong> and may be the more practical course of
                action. The decision to sample should always weigh the{' '}
                <strong>risk of disturbance</strong> during the sampling process against the{' '}
                <strong>benefit of obtaining a definitive answer</strong>.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      The presumption approach is creating{' '}
                      <strong className="text-white">disproportionate restrictions</strong> on
                      planned or routine work
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      A <strong className="text-white">definitive answer</strong> is needed for
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      The dutyholder needs to determine the{' '}
                      <strong className="text-white">type of asbestos</strong> (chrysotile, amosite,
                      crocidolite) for risk assessment purposes
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      ...
                      <strong className="text-white">classified for waste disposal</strong> purposes
                      &mdash; asbestos waste must be disposed of at licensed facilities
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  ...
                  <strong> ONLY be carried out by a competent person</strong>. Under no
                  circumstances should an electrician, maintenance worker, or other tradesperson
                  attempt to take their own samples. Improper sampling can release asbestos fibres
                  into the air, putting the sampler and anyone else in the area at serious risk. If
                  you suspect a material contains asbestos &mdash;{' '}
                  <strong>stop work and report it</strong>.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white/5 border border-orange-500/30 rounded-xl p-4 sm:p-6 overflow-x-auto">
            <div className="min-w-[320px] space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3 sm:gap-6">
                ...
                <div className="grid grid-cols-2 gap-2 sm:gap-3">
                  ...
                  <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-3 text-center">
                    ...
                    <p className="text-white text-xs sm:text-sm font-medium">
                      PRESUME asbestos until surveyed
                    </p>
                  </div>
                </div>
              </div>
                  ...
                  <div className="grid gap-2">
                    <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-2.5">
                      <p className="text-xs text-white">
                        <strong className="text-red-400">Listed as ACM</strong> &rarr; Follow
                        management plan controls
                      </p>
                    </div>
                    <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-2.5">
                      <p className="text-xs text-white">
                        <strong className="text-green-400">Listed as non-asbestos</strong> &rarr;
                        Proceed with caution &mdash; report if different from description
                      </p>
                    </div>
                    <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-2.5">
                      <p className="text-xs text-white">
                        <strong className="text-red-400">Not listed</strong> &rarr; STOP &mdash; may
                        have been missed. Presume asbestos.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-2 gap-3 sm:gap-6">
                ...
                <div className="space-y-2">
                  <p className="text-xs text-orange-400 font-medium text-center">
                    If Not Surveyed &mdash; Your Options:
                  </p>
                  <div className="grid gap-2">
                    <div className="bg-orange-500/10 border border-orange-500/30 rounded-lg p-2.5">
                      <p className="text-xs text-white">
                        <strong className="text-orange-400">Option 1:</strong> Presume and manage
                        accordingly
                      </p>
                    </div>
                    <div className="bg-orange-500/10 border border-orange-500/30 rounded-lg p-2.5">
                      <p className="text-xs text-white">
                        <strong className="text-orange-400">Option 2:</strong> Commission
                        survey/sampling by competent person
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                <strong> competent person</strong>. In this context, competence means the person
                must be
                <strong> trained, experienced, properly equipped, and insured</strong> to carry out
                the work safely without putting themselves or others at risk.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Qualification:</strong> BOHS P402 (Building
                      Surveys and Bulk Sampling for Asbestos) or equivalent &mdash; the recognised
                      industry standard
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Organisation:</strong> Typically a surveyor
                      from a UKAS-accredited organisation, providing assurance of quality and
                      competence
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">RPE:</strong> Minimum FFP3 disposable
                      respirator (face-fit tested) must be worn during sampling
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">PPE:</strong> Disposable coveralls (Type 5/6),
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Technique:</strong> Sampling must minimise
                      fibre release &mdash; wet methods, controlled techniques, and minimal
                      disturbance
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Insurance:</strong> Professional indemnity and
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Chain of custody:</strong> Must be maintained
                      from the moment of sampling through to laboratory analysis and reporting
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  proper controls and equipment can release thousands of microscopic fibres into the
                  air. If you suspect a material contains asbestos,
                  <strong> stop work, leave the area, and report it</strong> to your supervisor or
                  the dutyholder so that a competent person can be appointed to investigate.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                <strong>Polarised Light Microscopy (PLM)</strong> is the standard analytical method
                used to identify asbestos in bulk samples. When a sample of suspected material
                arrives at the laboratory, PLM is the technique used to determine whether asbestos
                fibres are present and, if so, which type(s).
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      Uses <strong className="text-white">polarised light</strong> passed through
                      the sample to identify asbestos fibres by their unique optical properties
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      Properties examined include:{' '}
                      <strong className="text-white">
                        colour, refractive index, birefringence, and extinction angle
                      </strong>
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Can identify{' '}
                      <strong className="text-white">all six regulated types of asbestos</strong>{' '}
                      &mdash; chrysotile (white), amosite (brown), crocidolite (blue), tremolite,
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Determines both{' '}
                      <strong className="text-white">whether asbestos is present</strong> and{' '}
                      <strong className="text-white">which type(s)</strong>
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      Analysis must be carried out by a{' '}
                      <strong className="text-white">UKAS-accredited laboratory</strong> (accredited
                      to ISO 17025)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      The analytical procedures are set out in{' '}
                      <strong className="text-white">
                        HSG248 &ldquo;Asbestos: The analysts&rsquo; guide&rdquo;
                      </strong>
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Turnaround time:</strong> Typically 2&ndash;5
                      working days (rush/priority service available at extra cost)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Cost:</strong> Approximately
                      &pound;20&ndash;&pound;40 per sample (varies by laboratory and urgency)
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  ...
                  samples tells you <strong>what the material is made of</strong>. It does NOT tell
                  you whether fibres are being released into the air. For that, you need air
                  monitoring &mdash; a different process covered in the next section.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                It is important to understand the difference between <strong>bulk sampling</strong>{' '}
                and
                <strong> air monitoring</strong>, as they serve completely different purposes in
                asbestos management.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  air monitoring, but it is not routinely used due to the higher cost and longer
                  turnaround time.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white">
                  <div className="flex gap-3">
                    ...
                    <p>
                      <strong className="text-white">Preliminary check</strong> &mdash; visual
                      inspection to confirm all visible ACMs have been removed
                    </p>
                  </div>
                  <div className="flex gap-3">
                    <span className="flex items-center justify-center min-w-[28px] h-7 rounded-full bg-orange-500/20 text-orange-400 text-xs font-bold flex-shrink-0">
                    ...
                    <p>
                      <strong className="text-white">Visual inspection</strong> &mdash; thorough
                      visual check by the analyst to confirm the area is clean and free of debris
                    </p>
                  </div>
                  <div className="flex gap-3">
                    <span className="flex items-center justify-center min-w-[28px] h-7 rounded-full bg-orange-500/20 text-orange-400 text-xs font-bold flex-shrink-0">
                    ...
                    <p>
                      <strong className="text-white">Air monitoring</strong> &mdash; air samples
                      taken and analysed to confirm fibre levels are below the clearance indicator
                      (0.01 fibres/cm&sup3;)
                    </p>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <p>
                      <strong className="text-white">Site clearance certificate</strong> &mdash;
                      certificate of reoccupation issued confirming the area is safe
                    </p>
                  </div>
                </div>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                When a competent person carries out sampling, they must follow a strict procedure
                designed to <strong>minimise fibre release</strong> and maintain the integrity of
                the sample for laboratory analysis. The following steps represent the standard
                sampling procedure:
              </p>
                ...
                <div className="space-y-3 text-sm text-white">
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        Consider the type of material, its condition, the location, and who else may
                        be in the area. Ensure appropriate controls are in place before sampling
                        begins.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        Minimum FFP3 disposable respirator (face-fit tested) and disposable
                        coveralls. Gloves and overshoes should also be worn.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        Wet the material before sampling to suppress fibre release. Use a plant
                        spray or similar to apply water gently without disturbing the material
                        excessively.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        Remove a small piece of the material, typically 2&ndash;3 cm&sup2;. The
                        sample must be representative of the material being tested.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        Place the sample in a sealed, labelled container immediately. Do not leave
                        samples loose or uncontained.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        The hole or mark left by sampling must be sealed to prevent any ongoing
                        fibre release. Label the sampling point for identification.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        Wipe down the immediate area around the sampling point to remove any debris
                        or dust generated during sampling.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        Place the sealed container inside a second sealed bag for transport. This
                        double-containment prevents cross-contamination.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        Record the sample location, date, time, sampler details, and unique sample
                        reference. This document tracks the sample from collection to laboratory.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        The sample must be sent to a laboratory accredited to ISO 17025 for PLM
                        analysis. Maintain records of all sampling activities.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-orange-500">Why This Matters to Electricians:</strong> You
                  will never be expected to carry out sampling yourself. However, understanding the
                  procedure helps you recognise when sampling is being done properly and when it is
                  not. If you see someone taking samples without RPE, without dampening the
                  material, or without proper containment, this should raise serious concerns
                  &mdash; report it to your supervisor immediately.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                When laboratory results are returned, they must be properly interpreted and acted
                upon. Understanding what the results mean &mdash; and, crucially, what they do
                <strong> not</strong> mean &mdash; is essential for effective asbestos management.
              </p>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-orange-400 mb-3">
                  Common Result Types &amp; What They Mean
                </p>
                <div className="space-y-3">
                  <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-3">
                    ...
                    <p className="text-xs sm:text-sm text-white">
                      ...
                      requires appropriate precautions and may require a licensed contractor
                      depending on the type and scope of work.
                    </p>
                  </div>
                  <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-3">
                    <p className="text-sm font-medium text-red-400 mb-1">
                    ...
                    <p className="text-xs sm:text-sm text-white">
                      ...
                      &mdash; these are amphibole fibres and are considered higher risk than
                      chrysotile. Stricter controls are required. Most work involving these fibre
                      types will require a licensed asbestos removal contractor.
                    </p>
                  </div>
                  <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-3">
                    ...
                    <p className="text-xs sm:text-sm text-white">
                      ...
                      the entire area, room, or building is asbestos-free. Other materials,
                      different layers, or patchwork repairs may still contain asbestos.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Record in the asbestos register</strong>{' '}
                      &mdash; all results, whether positive or negative, must be recorded and the
                      register updated
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Update the management plan</strong> &mdash; if
                      asbestos is confirmed, the management plan must be updated to reflect the
                      type, location, and required controls
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Communicate the results</strong> &mdash; inform
                      all relevant parties, including maintenance staff, contractors, and building
                      occupants
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Retain laboratory certificates</strong> &mdash;
                      keep all analytical certificates as part of the asbestos management records
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  Materials can vary within the same building, room, or even the same wall.
                  Different batches of artex, different layers of floor tiles, or patchwork repairs
                  using different materials can mean that one sample is negative whilst another from
                  the same general area is positive. If in doubt, presume asbestos until further
