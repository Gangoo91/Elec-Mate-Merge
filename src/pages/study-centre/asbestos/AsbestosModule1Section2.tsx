...
const quickCheckQuestions = [
  ...
  },
  {
    id: 'amosite-products',
    question:
      'Amosite (brown asbestos) is most commonly found in which of the following UK building products?',
    options: [
...
const quizQuestions = [
  {
    ...
    correctAnswer: 2,
    explanation:
      'Six types of asbestos are recognised and regulated: chrysotile (white), amosite (brown), crocidolite (blue), tremolite, actinolite, and anthophyllite. All six are classified as Group 1 carcinogens and are banned in the UK. The first three were used commercially; the latter three occur as contaminants.',
  },
  {
    id: 2,
    question:
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Serpentine asbestos (chrysotile) has curly, layered, flexible fibres. Amphibole asbestos (amosite, crocidolite, tremolite, actinolite, anthophyllite) has straight, needle-like, brittle fibres. This structural difference affects how the fibres behave in the lungs, though all types are carcinogenic.',
  },
  {
    id: 4,
    question: 'When were amosite and crocidolite banned in the UK?',
    options: ['1975', '1985', '1999', '2006'],
    correctAnswer: 1,
    explanation:
      'Amosite (brown) and crocidolite (blue) were banned in the UK in 1985. They were recognised as particularly dangerous due to their straight, needle-like fibres. Chrysotile (white) was not banned until 1999, making the UK one of the later countries to achieve a complete ban on all asbestos types.',
  },
  {
    id: 5,
  ...
  },
  {
    id: 7,
    question:
      'Under CAR 2012, if you cannot confirm the type of asbestos in a material, what must you do?',
    options: [
...
export default function AsbestosModule1Section2() {
  useSEO({
    ...
    description:
      'The six regulated types of asbestos: chrysotile (white), amosite (brown), crocidolite (blue), tremolite, actinolite, and anthophyllite. Fibre families, properties, UK ban dates, common products, and why all types are dangerous.',
  });
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-orange-500/5 border-l-2 border-orange-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>6 types:</strong> Chrysotile, amosite, crocidolite, tremolite, actinolite,
                anthophyllite
              </li>
              <li>
                <strong>2 families:</strong> Serpentine (curly) and amphibole (straight,
                needle-like)
              </li>
              <li>
                <strong>ALL are carcinogenic:</strong> No &ldquo;safe&rdquo; type exists
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-orange-500/5 border-l-2 border-orange-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Chrysotile:</strong> ~90% of UK use &mdash; banned 1999
              </li>
              <li>
                <strong>Amosite &amp; crocidolite:</strong> ~5% each &mdash; banned 1985
              </li>
              <li>
                <strong>Identification:</strong> Lab analysis only &mdash; never by sight alone
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Asbestos is not a single mineral. It is a commercial term applied to six naturally
                occurring silicate minerals that share a common characteristic: they form long,
                thin, fibrous crystals. These six minerals are divided into two distinct families
                based on their crystal structure.
              </p>

              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-orange-400">Key Distinction:</strong> The two families
                  &mdash; serpentine and amphibole &mdash; have fundamentally different fibre
                  structures. This distinction matters for identification, risk assessment, and
                  understanding how the fibres behave in the lungs. However, the critical point is
                  that <strong>all six types are classified as carcinogens</strong> and there is no
                  &ldquo;safe&rdquo; type.
                </p>
              </div>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white/80 space-y-1">
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        Contains only one commercially used type:{' '}
                        <strong className="text-white">chrysotile (white asbestos)</strong>
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Fibres are{' '}
                        <strong className="text-white">curly, flexible, and layered</strong> &mdash;
                        like a rolled-up sheet of paper
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white/80 space-y-1">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Contains five regulated types:{' '}
                        <strong className="text-white">
                          amosite (brown), crocidolite (blue), tremolite, actinolite, anthophyllite
                        </strong>
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        Fibres are{' '}
                        <strong className="text-white">straight, rigid, and needle-like</strong>{' '}
                        &mdash; like tiny splinters
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Amphibole fibres are generally more brittle and break into shorter, sharper
                        fragments
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Amosite and crocidolite were used commercially; tremolite, actinolite, and
                        anthophyllite occur as contaminants
                      </span>
                    </li>
                  </ul>
                </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  HSE confirms there is{' '}
                  <strong className="text-white">no safe exposure level</strong> for any type.
                  Industry claims that chrysotile is &ldquo;safer&rdquo; than amphibole types are
                  rejected by UK legislation. The same legal controls apply to all fibre types under
                  CAR 2012.
                </p>
              </div>
            </div>
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                <strong> 90% of all asbestos used worldwide</strong>. It is the sole commercially
                used member of the serpentine mineral family. Its name comes from the Greek words{' '}
                <em>chrysos</em> (gold) and <em>tilos</em> (fibre), though the raw mineral is
                typically white or grey-white in colour.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Fibre shape:</strong> Curly, flexible, layered
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Colour:</strong> White to grey-white when raw
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Flexibility:</strong> Most flexible of all
                      asbestos types &mdash; can be woven into textiles
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Heat resistance:</strong> Excellent &mdash; one
                      reason for its widespread industrial use
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Asbestos cement products (roof sheets, gutters, downpipes, flue pipes)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  Chrysotile causes all four asbestos-related diseases: mesothelioma,
                  asbestos-related lung cancer, asbestosis, and diffuse pleural thickening. It was
                  the last type to be banned in the UK (1999) and is still mined and used in some
                  countries, but the HSE, WHO, and IARC are clear:
                  <strong className="text-white">
                    {' '}
                    there is no safe type or safe level of exposure
                  </strong>
                  .
                </p>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Amosite is the second most commonly encountered type of asbestos in UK buildings. It
                is an amphibole mineral with straight, harsh, needle-like fibres. The name
                &ldquo;amosite&rdquo; is an acronym derived from <strong>A</strong>sbestos{' '}
                <strong>M</strong>ines <strong>o</strong>f <strong>S</strong>outh <strong>A</strong>
                frica (AMOSA), where the mineral was extensively mined. Its proper mineralogical
                name is grunerite.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Fibre shape:</strong> Straight, rigid, spiky
                      (amphibole structure)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Colour:</strong> Brown to dark grey when raw
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Flexibility:</strong> Brittle &mdash; breaks
                      into sharp fragments when disturbed
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Friability:</strong> More friable (crumbly)
                      than chrysotile products &mdash; releases fibres more readily when damaged
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Asbestos insulating board (AIB) &mdash; widely used for fire protection,
                      partitions, ceiling tiles, and soffits
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Thermal insulation &mdash; boiler and pipe lagging in industrial and domestic
                      settings
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-orange-400">On Site:</strong> Amosite products are often
                  more friable (easily crumbled) than chrysotile cement products. This means they
                  release fibres more readily when disturbed, damaged, or deteriorated. Asbestos
                  insulating board (AIB) is one of the most commonly encountered high-risk materials
                  in UK buildings. If you suspect AIB, stop work immediately, do not disturb the
                  material, and follow your site&rsquo;s asbestos emergency procedure.
                </p>
              </div>

              <p>
                Amosite was banned in the UK in 1985, alongside crocidolite. It was recognised as
                significantly more hazardous than chrysotile due to its straight, needle-like fibres
                which penetrate deeper into lung tissue and are more resistant to the body&rsquo;s
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Crocidolite is widely considered the most dangerous type of asbestos. It is an
                amphibole mineral with extremely fine, needle-like fibres that can penetrate deepest
                into lung tissue. Its name comes from the Greek word <em>krokys</em> (nap of cloth),
                referring to its fibrous appearance. Its proper mineralogical name is riebeckite.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Fibre shape:</strong> Very fine, straight,
                      needle-like (the thinnest of all asbestos fibres)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Colour:</strong> Blue to dark blue when raw
                      (can appear grey when mixed into products)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Flexibility:</strong> Very brittle &mdash;
                      shatters into extremely fine fragments
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Fibre diameter:</strong> Finest of all asbestos
                      types &mdash; individual fibres can be thinner than a human hair by a factor
                      of 1,000
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Sprayed coatings (limpet asbestos) on structural steelwork for fire protection
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  body&rsquo;s clearance mechanisms.{' '}
                  <strong className="text-white">
                    Even very short exposures to crocidolite are considered hazardous.
                  </strong>{' '}
                  It was banned in the UK in 1985 alongside amosite.
                </p>
              </div>

              <p>
                Sprayed crocidolite (sometimes called &ldquo;limpet asbestos&rdquo;) was widely used
                as fire protection on structural steelwork in the 1950s&ndash;1970s. It is one of
                the most dangerous materials a worker can encounter on site because it is highly
                friable and releases vast quantities of fibres when disturbed. Removal of sprayed
                coatings is licensed work under CAR 2012 and must only be carried out by
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Three additional types of asbestos are regulated under UK law, even though they were
                never used commercially in their own right. These are <strong>tremolite</strong>,{' '}
                <strong>actinolite</strong>, and <strong>anthophyllite</strong>. All three are
                amphibole minerals, and all three are classified as carcinogenic.
              </p>

              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-orange-400">Why They Matter:</strong> Although these
                  minerals were not manufactured into products intentionally, they occur naturally
                  as contaminants in other minerals. This means they can be present in building
                  products where the raw source material was contaminated &mdash; without anyone
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white/80 space-y-1">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Commonly found as a contaminant in chrysotile deposits, talc, and
                        vermiculite
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Has been found in consumer products (talcum powder, for example) due to
                        contaminated source minerals
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Named after the Tremola valley in the Swiss Alps, where it was first
                        identified
                      </span>
                    </li>
                  </ul>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white/80 space-y-1">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Found as a contaminant in vermiculite and some chrysotile deposits
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Can occur in a variety of forms, from fibrous (asbestiform) to non-fibrous
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white/80 space-y-1">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Was mined in small quantities in Finland but never widely used commercially
                      </span>
                    </li>
                  </ul>
                </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  contain tremolite or actinolite as contaminants from the source mine. This can
                  change the risk assessment and the control measures required.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                <strong>all six types of asbestos cause cancer</strong>. There is no safe type, no
                safe level of exposure, and no threshold below which risk disappears entirely.
              </p>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <div className="text-sm text-white/80 space-y-2">
                  <p>
                    ...
                    , and the{' '}
                    <strong className="text-white">Health and Safety Executive (HSE)</strong> all
                    classify every form of asbestos as a Group 1 carcinogen &mdash; the highest
                    classification, meaning there is{' '}
                    <strong className="text-white">sufficient evidence</strong> that they cause
                    cancer in humans.
                  </p>
                  <p>
                    No safe exposure level exists. A single fibre exposure can theoretically
                    initiate the process that leads to mesothelioma decades later. This is why the
                    legal control limit under CAR 2012 is set as low as practically measurable (0.1
                    fibres per cubic centimetre of air, averaged over 4 hours) &mdash; but this is a{' '}
                    <strong className="text-white">control limit, not a safe limit</strong>.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Some countries and industries still argue that chrysotile can be used
                      &ldquo;safely&rdquo; under controlled conditions
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      The UK government, the HSE, and the WHO reject this argument completely
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      The UK banned{' '}
                      <strong className="text-white">all asbestos types by 1999</strong> &mdash; no
                      exceptions, no exemptions for chrysotile
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      The same legal controls under <strong className="text-white">CAR 2012</strong>{' '}
                      apply regardless of fibre type
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                A common misconception is that you can identify asbestos type by looking at it
                &mdash; &ldquo;white means chrysotile, brown means amosite, blue means
                crocidolite.&rdquo; This is <strong>unreliable and potentially dangerous</strong>.
              </p>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <div className="text-sm text-white/80 space-y-2">
                  <p>
                    You{' '}
                    <strong className="text-white">
                      CANNOT reliably identify asbestos type by visual inspection alone
                    </strong>
                    . The reasons include:
                  </p>
                  <ul className="space-y-1">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Colour is misleading:</strong> Products are
                        often painted, stained, weathered, or discoloured with age
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Mixed products:</strong> Many materials
                        contain more than one type of asbestos fibre
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Binders and fillers:</strong> Asbestos is
                        mixed with cement, resins, or other materials that change its appearance
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Contaminants:</strong> A chrysotile product
                        may contain tremolite or actinolite that is invisible to the naked eye
                      </span>
                    </li>
                  </ul>
                </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Polarised Light Microscopy (PLM)</strong> is
                      the standard method for identifying asbestos type in bulk samples
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Transmission Electron Microscopy (TEM)</strong>{' '}
                      can be used for more detailed analysis or air samples
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Samples must only be taken by trained and competent persons (or licensed
                      analysts for certain work)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-orange-400">
                    The Presumption Approach (CAR 2012 Regulation 5):
                  </strong>{' '}
                  If you encounter a material that you suspect may contain asbestos and you cannot
                  confirm what it is, <strong>you must presume the worst case</strong>. Treat the
                  material as if it contains the most hazardous fibre type. Do not disturb it. Stop
                  work, report it, and ensure a competent person carries out an assessment. This
                  presumption approach is a legal requirement under the Control of Asbestos
                  Regulations 2012.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ol className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Stop work immediately</strong> &mdash; do not
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Do not attempt to sample it</strong> &mdash;
                      you are not trained or equipped to do so safely
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-0.5 w-6 h-6 rounded-full bg-orange-500/20 border border-orange-500/40 flex items-center justify-center flex-shrink-0 text-xs font-bold text-orange-400">
                    ...
                    <span>
                      <strong className="text-white">Leave the area</strong> and prevent others from
                      entering
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Report immediately</strong> to your supervisor,
                      site manager, or duty holder
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-0.5 w-6 h-6 rounded-full bg-orange-500/20 border border-orange-500/40 flex items-center justify-center flex-shrink-0 text-xs font-bold text-orange-400">
                    ...
                    <span>
                      <strong className="text-white">Presume the worst</strong> &mdash; treat it as
                      the most hazardous type until proven otherwise
                    </span>
                  </li>
                </ol>
              </div>
