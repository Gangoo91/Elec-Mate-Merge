...
const quickCheckQuestions = [
  {
    ...
    question: 'What is the FIRST step in the hierarchy of controls when planning asbestos work?',
    options: [
...
const faqs = [
  {
    question: 'Do I need a separate RAMS for every asbestos task, or can I use a generic one?',
    answer:
  ...
  {
    question: 'Where can I find HSE Asbestos Essentials task sheets?',
    answer:
  ...
  {
    question: 'Can conditions on site change after the RAMS has been written?',
    answer:
...
const quizQuestions = [
  ...
  {
    id: 2,
    question: 'In the hierarchy of controls, which level comes AFTER engineering controls?',
    options: ['Elimination', 'Substitution', 'Administrative controls', 'PPE/RPE'],
    correctAnswer: 2,
    explanation:
  ...
  {
    id: 3,
    question: 'Which of the following is an example of an engineering control for asbestos work?',
    options: [
  ...
  {
    id: 5,
    question: 'What does HSE Asbestos Essentials (HSG210) provide?',
    options: [
          ...
          <div className="rounded-lg p-4 bg-orange-500/5 border-l-2 border-orange-500/50">
            ...
            <ul className="text-white text-base space-y-1.5">
              <li className="flex items-start gap-2">
                ...
                <span>
                  <strong className="text-white">RAMS:</strong> risk assessment + method statement
                  required for ALL asbestos work
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Hierarchy:</strong> eliminate first, PPE last —
              ...
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Task-specific:</strong> every RAMS must be tailored
                  to the specific job and site
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Dynamic:</strong> reassess continuously — stop if
                  conditions change
                </span>
              </li>
            </ul>
          ...
          <div className="rounded-lg p-4 bg-orange-500/5 border-l-2 border-orange-500/50">
            ...
            <ul className="text-white text-base space-y-1.5">
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Before starting:</strong> read and understand the
                  RAMS — ask if unclear
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Controls:</strong> check all controls are in place
                  before work begins
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Unexpected ACMs:</strong> STOP immediately, do not
                  disturb, report at once
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">HSG210:</strong> use HSE task sheets as your guide
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                ...
                licensed, notifiable non-licensed (NNLW), or non-licensed. This is not optional; it
                is a legal requirement under{' '}
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <strong className="text-white">Task-specific:</strong> the RAMS must relate to
                      the specific task being carried out — not a generic document covering
                      &ldquo;asbestos work in general&rdquo;
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-orange-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Site-specific:</strong> the RAMS must consider
                      the conditions at the specific site where the work will take place — including
                      building occupancy, access, ventilation, and adjacent activities
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-orange-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Reviewed and updated:</strong> the RAMS must be
                      reviewed and updated if conditions change — for example, if the ACM is found
                      to be in worse condition than expected, if weather conditions change, or if
                      additional ACMs are discovered
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-orange-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Briefed to workers:</strong> all workers must
                      be briefed on the RAMS before work begins — they must understand the risks,
                      the controls, and the safe system of work
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-white text-sm">
                  ...
                  after. The assessment must identify the type of asbestos involved, the nature and
                  degree of exposure, and the steps to be taken to prevent or reduce exposure.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-amber-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                ...
                <strong className="text-white">most effective first</strong>. You must always start
                at the top of the hierarchy and only move down to less effective controls when
                higher-level controls are not reasonably practicable.
              </p>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <h3 className="text-amber-300 font-medium mb-3">The Five Levels</h3>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white">
                        ...
                        of power tools) to reduce fibre release.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white">
                        ...
                        control because it only protects the individual wearing it, and only if it
                        is worn correctly.
                      </p>
                    </div>
                  </div>
              ...
              <div className="my-6">
                ...
                <div className="mt-4 bg-white/5 border border-orange-500/30 rounded-lg p-3">
                  <p className="text-orange-300 text-xs sm:text-sm font-medium">
                    ...
                    <strong className="text-white">LAST</strong> resort, not the first choice. In
                    practice, most asbestos work requires a combination of controls from multiple
          ...
          <div className="border-l-2 border-teal-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                ...
                &ldquo;asbestos work&rdquo; in broad terms is not acceptable. The assessment must
                address the specific ACM, the specific work method, and the specific conditions at
                the site. The following questions must be answered:
              </p>
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                ...
                work will take place. Site conditions can significantly affect the level of risk and
              ...
              <div className="bg-white/5 border border-purple-400/30 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-3 text-sm">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <strong className="text-white">Building occupancy:</strong> will the area need
                      to be evacuated? Are there vulnerable occupants (e.g. in schools or hospitals)
                  ...
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Access and egress routes:</strong> plan routes
                      for workers and waste that avoid occupied areas. Do not carry asbestos waste
                      through communal corridors, reception areas, or public spaces.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Ventilation:</strong> assess both natural and
                      mechanical ventilation. HVAC systems and open windows can spread airborne
                      fibres to other parts of the building. Ventilation systems may need to be
                      isolated or sealed.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Adjacent work:</strong> are other trades
                      working nearby? They may need to be informed, excluded from the area, or
                      rescheduled to avoid exposure.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Services:</strong> identify live electrical,
                      gas, and water services that may need to be isolated before work begins.
                      Cutting through a live cable while removing ACMs creates additional serious
                      hazards.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Weather conditions:</strong> for outdoor work —
                      wind can disperse asbestos fibres over a wide area; rain can affect enclosures
                      and equipment. Work may need to be suspended in adverse conditions.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Ground conditions:</strong> relevant for
                      scaffolding, access platforms, and ground-level enclosures. Unstable or uneven
                      ground must be assessed and managed.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Emergency access:</strong> fire escape routes
                      must remain clear and accessible throughout the work. Do not block fire exits
                      with enclosures, equipment, or waste.
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-white text-sm">
                  ...
                  area, check the asbestos register on site, identify access points, and speak to
                  the building manager about occupancy, services, and any local conditions that
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                ...
                matter how thorough the pre-work RAMS, conditions on site can change — and workers
                must be prepared to stop, reassess, and adapt.
              </p>
              ...
              <div className="bg-white/5 border border-cyan-400/30 p-4 rounded-lg">
                ...
                <p className="text-white text-sm">
                  ...
                  worse condition than expected, unexpected materials behind panels or above
                  ceilings, equipment failure, changes in weather (wind picking up during outdoor
                  work), other trades entering the restricted area, or any situation that does not
                  match what the RAMS anticipated.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-white text-sm">
                  ...
                  &ldquo;work through&rdquo; uncertainty. The cost of stopping is a delay. The cost
                  of continuing could be a fatal disease.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-4 text-white">
              ...
              <div className="bg-white/5 border border-emerald-400/30 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <strong className="text-white">Task sheets:</strong> step-by-step guidance for
                      common non-licensed tasks such as removing textured coatings (Artex), asbestos
                      cement roof sheets, floor tiles, and insulating board
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-emerald-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Task sheet content:</strong> each task sheet
                      specifies the equipment needed, preparation steps, the working method,
                      clearance procedures, and waste disposal requirements
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-emerald-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Equipment and method sheets:</strong> detailed
                      guidance on specific controls such as HEPA vacuums, polythene enclosures,
                      glove bags, wet working, and decontamination
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-emerald-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Free access:</strong> available free from the
                      HSE website — no cost to download or use
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-white text-sm">
                  ...
                  as the removal of asbestos insulation, lagging, or sprayed coatings — separate HSE
                  guidance and a licence from the HSE are required for that category of work.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-white text-sm">
                  ...
                  risk assessment — the task sheet provides the general method, but you need to
                  adapt it to the specific conditions at your site. The task sheet is a guide, not a
          ...
          <div className="border-l-2 border-rose-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                ...
                step-by-step safe system of work that every worker must understand and follow. A
                well-written method statement leaves nothing to guesswork.
              </p>
              ...
              <div className="bg-white/5 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-white text-sm">
                  ...
                  does not understand any part of the method statement, they must ask for
                  clarification — not guess. The method statement should be available on site
                  throughout the work for reference.
                </p>
              </div>
