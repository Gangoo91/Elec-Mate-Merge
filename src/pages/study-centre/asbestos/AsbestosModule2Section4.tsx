...
const quickCheckQuestions = [
  {
    ...
    question:
      'Under which regulation is the duty holder required to maintain an asbestos register?',
    options: [
    ...
    correctIndex: 0,
    explanation:
      "Regulation 4 of the Control of Asbestos Regulations 2012 (the 'duty to manage') requires the person responsible for maintenance of non-domestic premises to identify ACMs, assess their condition, and maintain a written record — the asbestos register.",
  },
  {
...
const quizQuestions = [
  ...
  },
  {
    id: 3,
    question:
      'Which of the following is NOT a management option listed in a typical asbestos management plan?',
    options: ['Leave in situ and manage', 'Encapsulate', 'Bury on site', 'Remove'],
    correctAnswer: 2,
    explanation:
      'The four recognised management options are: leave in situ and manage, encapsulate, enclose, and remove. Burying asbestos on site is not a management option — asbestos waste must be disposed of at a licensed waste facility in accordance with hazardous waste regulations.',
  },
  {
    id: 4,
    ...
    correctAnswer: 1,
    explanation:
      'Encapsulation means applying a sealant to the surface of the ACM (surface sealing) or using a penetrating sealant that binds the fibres together within the material. This prevents fibre release without removing or enclosing the ACM. It is suitable for ACMs in reasonable condition where disturbance is unlikely.',
  },
  {
    id: 5,
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'The management plan must be reviewed when the condition of ACMs changes, when work is planned that might disturb ACMs, after any incident involving ACMs, when the building use changes, when new information becomes available, at regular intervals (typically annually), and when responsible personnel change.',
  },
  {
    id: 8,
    question:
...
export default function AsbestosModule2Section4() {
  useSEO({
    ...
    description:
      'How the asbestos register records ACMs, material and priority assessment scoring, the management plan, management options, review triggers, and communicating the register to contractors and staff.',
  });
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-orange-500/5 border-l-2 border-orange-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Register:</strong> Written record of all known/presumed ACMs
              </li>
              <li>
                <strong>Assessment:</strong> Material + priority scores determine risk
              </li>
              <li>
                <strong>Plan:</strong> Manage, encapsulate, enclose, or remove each ACM
              </li>
              <li>
                <strong>Review:</strong> Triggered by damage, works, or change of use
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-orange-500/5 border-l-2 border-orange-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Always:</strong> Check the asbestos register before starting work
              </li>
              <li>
                <strong>Ask:</strong> The client or duty holder to show you the register
              </li>
              <li>
                <strong>Never:</strong> Start work without knowing where ACMs are
              </li>
              <li>
                <strong>Report:</strong> Any damage to ACMs immediately
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The asbestos register is a{' '}
                <strong>
                  written record of all known or presumed asbestos-containing materials (ACMs)
                </strong>{' '}
                in a building. It is the cornerstone of asbestos management &mdash; without it,
                nobody working in or on the building can know where ACMs are located or what
                precautions are needed.
              </p>

              <p>
                The requirement to maintain an asbestos register comes from{' '}
                <strong>Regulation 4 of the Control of Asbestos Regulations 2012</strong> (CAR
                2012), commonly known as the &ldquo;duty to manage&rdquo;. This regulation places a
                legal obligation on the person responsible for the maintenance and repair of
                non-domestic premises &mdash; the
                <strong> duty holder</strong> &mdash; to find out whether the building contains
                asbestos, to record the findings, and to manage the risk.
              </p>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Location of each ACM</strong> &mdash; described
                      clearly enough for anyone to find it (e.g., &ldquo;boiler room, pipe lagging
                      on main hot water pipe, west wall&rdquo;)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Type of asbestos</strong> &mdash; if known from
                      laboratory analysis (chrysotile, amosite, crocidolite) or presumed based on
                      the survey type
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Condition assessment</strong> &mdash; the
                      current state of the material (good condition, minor damage, significant
                      damage, severely damaged/delaminating)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Risk score</strong> &mdash; derived from the
                      material assessment and priority assessment (covered in Sections 02 and 03
                      below)
                    </span>
                  </li>
                </ul>
              ...
              <p>
                The register should also include <strong>floor plans or drawings</strong> showing
                the locations of ACMs wherever practical. Visual records make it far easier for
                contractors and maintenance staff to understand exactly where asbestos is located,
                particularly in large or complex buildings with multiple floors, plant rooms, and
                service voids.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1 mt-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Contractors</strong> &mdash; before they start
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Maintenance staff</strong> &mdash; so they know
                      which areas contain ACMs
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Emergency services</strong> &mdash; so
                      firefighters and paramedics know where asbestos hazards exist
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Building occupants</strong> &mdash; employees,
                      tenants, or anyone else who may be affected
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  If the duty holder cannot produce a register or tells you that no survey has been
                  carried out, do not proceed with work that could disturb building materials.
                  Inform your supervisor and request that the register be made available or that a
                  survey be carried out before work begins.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The material assessment is a{' '}
                <strong>
                  scoring system used to assess the risk posed by each ACM based on its inherent
                  properties
                </strong>
                . It answers the question:{' '}
                <em>
                  &ldquo;How likely is this material to release asbestos fibres in its current
                  state?&rdquo;
                </em>
              </p>

              <p>
                The assessment uses <strong>four variables</strong>, each of which is scored. The
                scores are added together to give a total material assessment score. A higher total
                indicates a material that is more likely to release fibres and therefore poses a
                greater risk.
              </p>
                ...
                <div className="space-y-3 text-sm text-white">
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        What form is the ACM in? Sprayed coatings are the most friable (easiest to
                        release fibres), while cement products are the most tightly bound.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        What condition is the ACM in? Ranges from good condition (no visible damage)
                        through to high damage with delaminating or crumbling material.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        Is the ACM sealed, enclosed, or exposed? A material that is painted, sealed
                        in a matrix, or boxed in is less likely to release fibres than one that is
                        exposed and damaged.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        Which type of asbestos fibre is present? Crocidolite (blue) is the most
                        hazardous, followed by amosite (brown), then chrysotile (white).
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  ...
                  (12) in medium damage condition (2), exposed and damaged (3), containing amosite
                  (2) would score <strong>12 + 2 + 3 + 2 = 19</strong> &mdash; placing it firmly in
                  the
                  <strong className="text-red-400"> high risk</strong> category. This ACM would
                  require urgent management action, most likely removal by a licensed contractor.
                </p>
              </div>

              <p>
                The material assessment score helps to rank ACMs by their inherent danger. However,
                it does not tell the whole story. A high-scoring ACM in a locked, unoccupied plant
                room poses a different practical risk than a medium-scoring ACM in a busy corridor.
                That is why the priority assessment is also needed.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                While the material assessment focuses on the ACM itself, the priority assessment
                looks at the <strong>building context</strong>. It assesses the{' '}
                <strong>likelihood of the ACM being disturbed</strong> based on how the building is
                used, who occupies it, and what maintenance activities take place near it.
              </p>
                ...
                <div className="space-y-4 text-sm text-white">
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        How is the area used? Is it a rarely accessed plant room, a storage area, an
                        office, or a high-traffic corridor or reception? The more activity in the
                        area, the higher the likelihood of accidental disturbance.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        How likely is the ACM to be knocked, scraped, drilled into, or otherwise
                        physically disturbed? A ceiling tile above a busy workspace is more likely
                        to be disturbed than pipe lagging in a sealed riser cupboard.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        How many people use the area, how frequently, and for how long? A boiler
                        room visited weekly by one person is very different from a school classroom
                        occupied by 30 children for six hours a day.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        How often is maintenance work carried out near the ACM? Areas where
                        electricians, plumbers, or other tradespeople regularly work are at higher
                        risk of accidental disturbance than areas that are never maintained.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <p>
                The priority assessment score is{' '}
                <strong>combined with the material assessment score</strong> to determine the{' '}
                <strong>overall risk rating</strong> and the
                <strong> priority for management action</strong>. An ACM with a high material score
                <em>and</em> a high priority score demands the most urgent response. An ACM with a
                low material score and a low priority score may be safely left in situ and
                monitored.
              </p>

              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-orange-500">Key Point:</strong> Higher priority = needs
                  action sooner. The combination of material and priority assessments ensures that
                  management decisions are proportionate &mdash; focusing resources on the ACMs that
                  pose the greatest actual risk to the people in the building.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The asbestos management plan is a{' '}
                <strong>
                  written document that sets out how each identified ACM will be managed
                </strong>
                . It turns the information in the register and the assessment scores into practical
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">The asbestos register</strong> &mdash; the
                      complete record of all identified or presumed ACMs
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Assessment results</strong> &mdash; material
                      and priority assessment scores for each ACM
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Management decisions</strong> &mdash; what
                      action has been decided for each ACM (leave, encapsulate, enclose, or remove)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Monitoring schedule</strong> &mdash; how often
                      each ACM will be re-inspected and by whom
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Procedures for work near ACMs</strong> &mdash;
                      what controls, permits, and precautions are required when any work is carried
                      out near or on ACMs
                    </span>
                  </li>
                </ul>
              ...
              <p>
                For each ACM, the management plan must specify one of{' '}
                <strong>four management options</strong>:
              </p>
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-white mb-2">
                    ...
                    ACMs in good condition that are unlikely to be disturbed.
                  </p>
                  <p className="text-xs text-green-300/70">
                    Suitable for: Good-condition ACMs in low-traffic areas
                  </p>
                </div>
                <div className="bg-yellow-500/10 border border-yellow-500/30 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-white mb-2">
                    ...
                    within the material). The ACM remains in place but is less likely to release
                    fibres.
                  </p>
                  <p className="text-xs text-yellow-300/70">
                    Suitable for: ACMs in reasonable condition with minor surface damage
                  </p>
                </div>
                <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-white mb-2">
                    ...
                    over AIB. The ACM remains in place behind the enclosure.
                  </p>
                  <p className="text-xs text-orange-300/70">
                    Suitable for: ACMs that need protection from accidental disturbance
                  </p>
                </div>
                <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-white mb-2">
                    ...
                    <strong className="text-white">most expensive option</strong> but it permanently
                    eliminates the hazard. Removal generates asbestos waste that must be disposed of
                    at a licensed facility.
                  </p>
                  <p className="text-xs text-red-300/70">
                    Suitable for: High-risk ACMs, planned refurbishment, or demolition
                  </p>
                </div>
              </div>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-orange-500">Proportionate Response:</strong> The
                  management plan must be proportionate to the level of risk. Not every ACM needs to
                  be removed. In many cases, the safest and most cost-effective approach is to leave
                  well-conditioned ACMs in place and manage them through regular monitoring,
                  labelling, and information sharing. Unnecessary removal can actually create{' '}
                  <em>more</em> risk by disturbing materials that were previously stable.
                </p>
              </div>

              <p>
                The plan must be <strong>reviewed and updated regularly</strong>. It is not a
                one-off document &mdash; it is a living management tool that must reflect the
                current condition and circumstances of every ACM in the building.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white">
                  <div className="flex items-start gap-3">
                    ...
                    <span>
                      <strong className="text-white">Condition change</strong> &mdash; when the
                      condition of any ACM changes due to damage, deterioration, water ingress,
                      accidental impact, or any other cause
                    </span>
                  </div>
                  <div className="flex items-start gap-3">
                    <span className="flex items-center justify-center min-w-[24px] h-6 rounded bg-orange-500/20 text-orange-400 text-xs font-bold flex-shrink-0">
                    ...
                    <span>
                      <strong className="text-white">Planned work</strong> &mdash; when any work is
                      planned that might disturb ACMs, including maintenance, refurbishment,
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <span>
                      <strong className="text-white">Incident</strong> &mdash; after any incident
                      involving ACMs, such as accidental damage, fibre release, or an unplanned
                      disturbance
                    </span>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <span>
                      <strong className="text-white">Change of use</strong> &mdash; when the
                      building use changes (e.g., an office converted to a school, a warehouse
                      repurposed as a gym)
                    </span>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <span>
                      <strong className="text-white">New information</strong> &mdash; when new
                      information becomes available, such as results from a refurbishment/demolition
                      survey, or analysis confirming the type of asbestos in a presumed ACM
                    </span>
                  </div>
                  <div className="flex items-start gap-3">
                    <span className="flex items-center justify-center min-w-[24px] h-6 rounded bg-orange-500/20 text-orange-400 text-xs font-bold flex-shrink-0">
                    ...
                    <span>
                      <strong className="text-white">Regular interval</strong> &mdash; at least
                      annually as part of a scheduled condition re-inspection, even if no trigger
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <span>
                      <strong className="text-white">Personnel change</strong> &mdash; when the
                      people with asbestos management responsibilities change (e.g., new building
                      manager, new facilities team)
                    </span>
                  </div>
                  <div className="flex items-start gap-3">
                    <span className="flex items-center justify-center min-w-[24px] h-6 rounded bg-orange-500/20 text-orange-400 text-xs font-bold flex-shrink-0">
                    ...
                    <span>
                      <strong className="text-white">Change of occupancy</strong> &mdash; when the
                      building is sold, leased, or transferred to new occupants who need to be
                      informed of the asbestos situation
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  condition of ACMs, workers may rely on it and unknowingly disturb materials that
                  have deteriorated since the last inspection. If you are shown a register that
                  appears old or incomplete, raise this concern with the duty holder before
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                A register that nobody knows about or cannot access is worthless. The duty holder
                has a legal obligation to ensure that the register and management plan are
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Contractors</strong> &mdash; must be shown
                      relevant sections of the register{' '}
                      <strong className="text-white">BEFORE starting work</strong>. This is not
                      optional &mdash; it is a legal requirement. Contractors should sign to confirm
                      they have seen and understood the register.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Maintenance staff</strong> &mdash; must know
                      where ACMs are located so they can avoid disturbing them during routine work.
                      Regular briefings and induction training should cover the register.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Emergency services</strong> &mdash; should be
                      informed of ACM locations so that firefighters, paramedics, and other
                      responders can take appropriate precautions during emergencies.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Building occupants</strong> &mdash; employees,
                      tenants, and others who use the building should be made aware of asbestos
                      locations, particularly if ACMs are in areas they can access.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Labels and stickers</strong> &mdash; apply
                      warning labels directly to or near ACMs where appropriate (e.g.,
                      &ldquo;CAUTION &mdash; Contains Asbestos &mdash; Do Not Disturb&rdquo;). These
                      provide an immediate visual warning to anyone in the area.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Permit-to-work systems</strong> &mdash; the
                      permit-to-work system should reference the asbestos register. No work permit
                      should be issued for areas containing ACMs without confirming that the
                      register has been consulted and appropriate precautions are in place.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Digital systems</strong> &mdash; building
                      management systems (BMS), computerised maintenance management systems (CMMS),
                      and cloud-based platforms can make the register accessible in real time from
                      tablets and smartphones on site.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Site induction</strong> &mdash; every person
                      entering the building to carry out work should receive an induction that
                      covers the asbestos register and the locations of known ACMs.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  holder refuses or fails to provide this information, you should{' '}
                  <strong className="text-white">not proceed with the work</strong>. Report the
                  situation to your supervisor, your employer, and, if necessary, the Health and
                  Safety Executive (HSE). Your safety is more important than any deadline.
                </p>
              </div>
            </div>
          </div>
