...
const quickCheckQuestions = [
  {
    ...
    question: 'How often must licensed asbestos workers undergo a mandatory medical examination?',
    options: [
...
const faqs = [
  {
    question: 'I was exposed to asbestos years ago but never told my GP. Is it too late?',
    answer:
  ...
  {
    question: 'Does health surveillance mean I am safe from asbestos-related disease?',
    answer:
  ...
  {
    question: 'What compensation is available if I am diagnosed with an asbestos-related disease?',
    answer:
  ...
  {
    question: 'What happens to my health records if my employer goes out of business?',
    answer:
...
const quizQuestions = [
  ...
  {
    id: 4,
    question: 'For how long must health records for asbestos-exposed workers be retained?',
    options: [
      '10 years from the date of last exposure',
...
const AsbestosModule5Section3 = () => {
  useSEO({
    title: 'Health Surveillance & Medical Monitoring | Asbestos Awareness Module 5 Section 3',
    description:
      ...
      <article className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4 text-white">
            <p>
              Health surveillance is a legal requirement for certain categories of asbestos workers.
              Its purpose is <strong>early detection</strong> of asbestos-related disease &mdash; it
              cannot prevent disease, but it can detect it sooner, leading to earlier treatment,
              better symptom management, and timely access to support and compensation.
            </p>
              ...
              <div className="rounded-lg p-3 sm:p-4 bg-orange-500/10 border-l-2 border-l-orange-500/50 border border-orange-500/30">
                ...
                <ul className="text-base text-white space-y-1.5">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong>Mandatory medical examination every 2 years</strong> as required by
                      Regulation 22 of CAR 2012
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Examination must be by an <strong>HSE-appointed doctor</strong> (EMAS) or a
                      doctor experienced in asbestos-related disease
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong>Employers must arrange and pay</strong> for health surveillance where
                      required
                    </span>
                  </li>
                </ul>
              ...
              <div className="rounded-lg p-3 sm:p-4 bg-orange-500/10 border-l-2 border-l-orange-500/50 border border-orange-500/30">
                ...
                <ul className="text-base text-white space-y-1.5">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      NNLW workers: <strong>health records must be kept for 40 years</strong> and
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Anyone with <strong>past significant exposure</strong> should inform their GP
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Asbestos-related diseases can take <strong>15 to 60 years</strong> to develop
                      &mdash; past exposure is always relevant
                    </span>
                  </li>
                </ul>
              </div>
            ...
            <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
              ...
              <p className="text-white/80 text-sm">
                ...
                <strong className="text-white">
                  avoiding exposure to asbestos fibres in the first place
                </strong>
                .
              </p>
            </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                A medical examination for asbestos-exposed workers follows a structured process. The
                examining doctor must be an <strong>HSE-appointed doctor</strong> or a doctor with
                experience in asbestos-related disease. Results are <strong>confidential</strong>{' '}
                &mdash; the employer receives a certificate of fitness or unfitness, not the medical
                details.
              </p>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <h3 className="text-orange-400 font-medium mb-3">Components of the Examination</h3>
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-orange-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Respiratory questionnaire:</strong> history of asbestos exposure,
                      smoking history, current respiratory symptoms, and occupational history
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-orange-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Physical examination:</strong> chest examination, checking for finger
                      clubbing (a sign of lung disease), respiratory rate, and general fitness
                      assessment
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-orange-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Lung function tests (spirometry):</strong> measuring FEV1 (forced
                      expiratory volume in 1 second) and FVC (forced vital capacity) to assess lung
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-orange-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Chest X-ray or CT scan:</strong> may be requested if the initial
                      assessment indicates concern or if the worker has a significant exposure
                      history
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  . The employer receives only a certificate stating whether the worker is fit or
                  unfit to continue asbestos work. The employer does{' '}
                  <strong className="text-white">not</strong> receive the detailed medical findings.
                  This confidentiality encourages workers to participate openly without fear of
        ...
        <section className="mb-10">
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                Screening aims to detect asbestos-related diseases as early as possible. Different
                screening approaches are used for different diseases, but the{' '}
                <strong>key message</strong> is that screening detects disease early &mdash; it{' '}
                <strong>CANNOT prevent it</strong>. The only prevention is avoiding exposure.
              </p>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <h3 className="text-orange-400 font-medium mb-3">Screening by Disease Type</h3>
                <div className="space-y-4 text-sm">
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-red-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Mesothelioma:</strong> no reliable screening test currently exists
                      &mdash; diagnosis is usually based on symptoms (breathlessness, chest pain,
                      weight loss). Research into blood-based biomarkers is ongoing but not yet
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <strong>Lung cancer:</strong> low-dose CT scanning may be offered to high-risk
                      individuals (those with significant asbestos exposure and/or a smoking
                      history). Combined exposure to asbestos and smoking increases lung cancer risk
                      dramatically.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-orange-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Asbestosis:</strong> detected through spirometry (lung function tests)
                      and chest imaging. Progressive reduction in lung function over time may
                      indicate developing asbestosis.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-orange-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Pleural changes:</strong> chest X-ray can detect pleural plaques and
                      thickening. These are markers of past exposure and may be identified during
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  <strong className="text-white">
                    persistent cough, breathlessness, chest pain, and unexplained weight loss
                  </strong>
                  . Early reporting leads to earlier investigation and potentially better outcomes.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                Anyone who has been exposed to asbestos &mdash; even decades ago &mdash; should{' '}
                <strong>inform their GP</strong>. This is one of the most important steps a worker
                can take to protect their long-term health.
              </p>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <h3 className="text-orange-400 font-medium mb-3">Why GP Notification Matters</h3>
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-orange-500 mt-2 flex-shrink-0"></div>
                    <div>
                      The GP should <strong>record the exposure</strong> in the patient&apos;s
                      medical notes &mdash; this ensures that any future symptoms are investigated
                      with asbestos exposure in mind
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-orange-500 mt-2 flex-shrink-0"></div>
                    <div>
                      The GP can arrange <strong>baseline lung function tests</strong> and chest
                      imaging to establish a reference point for future comparison
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-orange-500 mt-2 flex-shrink-0"></div>
                    <div>
                      Some areas have <strong>specialist asbestos disease clinics</strong> that the
                      GP can refer patients to for expert monitoring and support
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-orange-500 mt-2 flex-shrink-0"></div>
                    <div>
                      Early notification helps with <strong>early diagnosis</strong> and timely
                      access to treatment, support services, and compensation
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-orange-500 mt-2 flex-shrink-0"></div>
                    <div>
                      It is <strong>never too late</strong> to inform your GP &mdash;
                      asbestos-related diseases can develop 15 to 60 years after exposure, so even
                      distant past exposure is clinically significant
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  <strong className="text-white">what type</strong> of asbestos or ACM (if known),{' '}
                  <strong className="text-white">how long</strong> the exposure lasted, and{' '}
                  <strong className="text-white">what controls</strong> were (or were not) in place.
                  This information helps the GP assess your risk and plan appropriate monitoring.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                ...
                <strong>40 years from the date of the last entry</strong>. This extremely long
                retention period reflects the fact that asbestos-related diseases can take decades
                to develop after exposure.
              </p>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <h3 className="text-orange-400 font-medium mb-3">What Records Must Include</h3>
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-orange-500 mt-2 flex-shrink-0"></div>
                    <div>
                      Worker&apos;s{' '}
                      <strong>name, date of birth, and National Insurance number</strong>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-orange-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Dates of exposure</strong> and the type of asbestos work carried out
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-orange-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Results of medical examinations</strong> (fitness certificates and
                      clinical findings)
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-orange-500 mt-2 flex-shrink-0"></div>
                    <div>
                      Details of the <strong>type of work</strong>, the ACMs involved, and the
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <h3 className="text-orange-400 font-medium mb-3">Why Records Matter</h3>
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    <CheckCircle className="h-4 w-4 text-orange-500 mt-0.5 flex-shrink-0" />
                    <div>
                      <strong>Monitoring health over time:</strong> records allow changes in lung
                      function and health status to be tracked across years and decades
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle className="h-4 w-4 text-orange-500 mt-0.5 flex-shrink-0" />
                    <div>
                      <strong>Supporting compensation claims:</strong> detailed exposure records are
                      essential evidence for IIDB claims, civil claims, and DMPS applications
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle className="h-4 w-4 text-orange-500 mt-0.5 flex-shrink-0" />
                    <div>
                      <strong>Demonstrating legal compliance:</strong> employers must be able to
                      show that health surveillance was carried out as required by CAR 2012
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  right to access their own health records at any time, and it is good practice to
                  keep personal copies. Digital records are acceptable but must be{' '}
                  <strong className="text-white">securely stored and backed up</strong>.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                Workers diagnosed with asbestos-related diseases have several routes to claim
                compensation. The available options depend on the circumstances of the exposure and
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/80 text-sm">
                        ...
                        <strong className="text-white">3 years of diagnosis</strong>, though
                        exceptions exist and courts can exercise discretion.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/80 text-sm">
                        ...
                        used asbestos heavily have since ceased trading.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/80 text-sm">
                        ...
                        is no financial risk to the claimant. Time limitations apply to most claims,
                        so seeking advice promptly after diagnosis is important.
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                A range of organisations provide support, information, and advocacy for workers
                affected by asbestos-related diseases. Accessing these services early can make a
                significant difference to outcomes and quality of life.
              </p>
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  record-keeping, and legal rights even before a diagnosis is made. Early engagement
                ...
                <ul className="text-white space-y-3 text-sm">
                  <li className="flex items-start gap-3">
                    ...
                    <span>
                      ...
                      <strong>medical examination every 2 years</strong> under Regulation 22 of CAR
                      2012. NNLW workers also require medical surveillance and health records kept
                      for 40 years.
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <span>
                      ...
                      <strong>
                        respiratory questionnaire, physical examination, and spirometry
                      </strong>
                      . Results are confidential &mdash; the employer receives only a fitness
                      certificate.
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <span>
                      Health surveillance{' '}
                      <strong>detects disease early but cannot prevent it</strong>. The only true
                      prevention is avoiding asbestos exposure.
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-orange-500 mt-0.5 flex-shrink-0" />
                    <span>
                      Anyone with <strong>past asbestos exposure should inform their GP</strong>,
                  ...
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-orange-500 mt-0.5 flex-shrink-0" />
                    <span>
                      Health records must be kept for <strong>40 years</strong> and transferred to
                      the HSE if the employer ceases trading.
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-orange-500 mt-0.5 flex-shrink-0" />
                    <span>
                      Compensation routes include <strong>IIDB, civil claims, and the DMPS</strong>.
                      Specialist solicitors and support organisations can help navigate the process.
                    </span>
                  </li>
                </ul>
              </div>
        ...
        {/* ─── Quiz ─── */}
        <div className="mt-12">
          <Quiz title="Health Surveillance & Medical Monitoring Quiz" questions={quizQuestions} />
        </div>
