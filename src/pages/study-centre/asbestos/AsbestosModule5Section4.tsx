...
const faqs = [
  {
    question: "Can I be personally fined for an asbestos offence, even if I'm not the employer?",
    answer:
  ...
  {
    question: 'How often should asbestos awareness training be refreshed?',
    answer:
  ...
  {
    question: 'Am I protected if I report my employer to the HSE for poor asbestos management?',
    answer:
...
const quizQuestions = [
  ...
  {
    id: 4,
    question: 'Which of the following is NOT an employee duty in relation to asbestos?',
    options: [
...
const AsbestosModule5Section4 = () => {
  useSEO({
    title: 'Roles, Responsibilities & Your Legal Duties | Asbestos Awareness Module 5 Section 4',
    description:
      ...
      <article className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4 text-white">
            <p>
              Employers have extensive legal duties under the Control of Asbestos Regulations 2012,
              the Health and Safety at Work etc. Act 1974, and other supporting legislation. Failure
              to meet these duties can result in prosecution, unlimited fines, and imprisonment.
            </p>

            <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
              <h3 className="text-orange-400 font-medium mb-3">Key Employer Obligations</h3>
              <div className="space-y-3 text-sm">
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 rounded-full bg-orange-500 mt-2 flex-shrink-0"></div>
                  <div>
                    <strong>Provide adequate information, instruction, and training</strong> on
                    asbestos (Regulation 10) &mdash; this includes initial training and ongoing
                    refreshers
                  </div>
                </div>
                <div className="flex items-start gap-3">
                ...
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 rounded-full bg-orange-500 mt-2 flex-shrink-0"></div>
                  <div>
                    <strong>Carry out risk assessments</strong> for work that may expose workers to
                    asbestos (Regulation 6) &mdash; before any work begins
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 rounded-full bg-orange-500 mt-2 flex-shrink-0"></div>
                  <div>
                    <strong>Provide suitable RPE and PPE</strong> (Regulations 14, 15) &mdash;
                    properly fitted, maintained, and replaced as needed
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 rounded-full bg-orange-500 mt-2 flex-shrink-0"></div>
                  <div>
                    <strong>Arrange health surveillance</strong> where required (Regulation 22)
                    &mdash; including medical examinations for licensed and NNLW workers
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 rounded-full bg-orange-500 mt-2 flex-shrink-0"></div>
                ...
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 rounded-full bg-orange-500 mt-2 flex-shrink-0"></div>
                  <div>
                    <strong>Provide adequate supervision</strong> &mdash; especially for higher-risk
                    work categories
                  </div>
                </div>
                <div className="flex items-start gap-3">
                ...
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 rounded-full bg-orange-500 mt-2 flex-shrink-0"></div>
                  <div>
                    <strong>Report incidents and dangerous occurrences</strong> under RIDDOR &mdash;
                    including accidental releases of asbestos fibres
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 rounded-full bg-orange-500 mt-2 flex-shrink-0"></div>
            ...
            <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
              ...
              <p className="text-white/80 text-sm">
                ...
                ensuring the work is done safely. Directors and senior managers can be held{' '}
                <strong className="text-white">personally liable</strong> if an offence was
        ...
        <section className="mb-10">
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                As an employee, you have your own set of legal duties under the Health and Safety at
                Work etc. Act 1974 and the Control of Asbestos Regulations 2012. These are{' '}
                <strong>personal responsibilities</strong> &mdash; you cannot pass them to someone
                else.
              </p>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <h3 className="text-orange-400 font-medium mb-3">Your Duties as an Employee</h3>
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-orange-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Follow safe systems of work and method statements</strong> &mdash;
                      these exist to protect you and others
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-orange-500 mt-2 flex-shrink-0"></div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <strong>
                        Report any suspected ACMs or accidental disturbances IMMEDIATELY
                      </strong>{' '}
                      &mdash; do not attempt to clean up or manage the situation yourself
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-orange-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Do not interfere with or misuse safety equipment or controls</strong>{' '}
                      &mdash; this is a criminal offence under Section 8 of HSWA 1974
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-orange-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Attend and engage with training provided</strong> &mdash; including
                      refresher training at the required intervals
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-orange-500 mt-2 flex-shrink-0"></div>
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-orange-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Report any health concerns</strong> that might affect your fitness for
                      asbestos work &mdash; including respiratory symptoms
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-orange-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Not undertake asbestos work for which you are not trained</strong>{' '}
                      &mdash; if asked to do work beyond your training, refuse and report it
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-orange-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Check the asbestos register before starting work</strong> in pre-2000
                      buildings &mdash; this should become an automatic habit
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  health and safety concerns. Report the situation to your supervisor, safety
                  representative, or the HSE. Your safety &mdash; and the safety of those around you
                  &mdash; must always come first.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="min-w-[560px]">
              ...
              <div className="grid grid-cols-5 gap-px">
                ...
                <div className="bg-orange-500/10 px-3 py-2.5 text-center border-b border-white/5">
                  ...
                  <span className="inline-block px-2 py-0.5 rounded text-xs font-semibold bg-blue-500/20 text-blue-300">
                    A
                  </span>
                </div>
              ...
              <div className="grid grid-cols-5 gap-px">
                ...
                <div className="bg-purple-500/5 px-3 py-2.5 text-center border-b border-white/5">
                  <span className="inline-block px-2 py-0.5 rounded text-xs font-semibold bg-purple-500/20 text-purple-300">
                    C
                  </span>
                </div>
                <div className="bg-green-500/5 px-3 py-2.5 text-center border-b border-white/5">
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                ...
                <strong>duty to manage asbestos</strong> &mdash; were covered in detail in Module 2.
                Here is a recap of the key points, with emphasis on how the dutyholder&rsquo;s role
                relates to employers and employees.
              </p>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <h3 className="text-orange-400 font-medium mb-3">Key Dutyholder Obligations</h3>
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-orange-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Find ACMs</strong> &mdash; through surveys and inspection of the
                      premises
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-orange-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Assess condition</strong> &mdash; determine the risk posed by each ACM
                      found
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-orange-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Create and maintain the asbestos register</strong> &mdash; recording
                      location, type, condition, and extent of all ACMs
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-orange-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Write a management plan</strong> &mdash; setting out how ACMs will be
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-orange-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Monitor and review</strong> &mdash; the condition of ACMs must be
                      checked regularly and the management plan updated
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  maintenance or repair of non-domestic premises, or who controls access to them. In
                  a multi-occupied building, there may be{' '}
                  <strong className="text-white">multiple dutyholders</strong> &mdash; for example,
                  a landlord for common areas and individual tenants for their own spaces. All
                  dutyholders must cooperate with employers and contractors working in the building.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                ...
                the <strong>client</strong> &mdash; the person or organisation commissioning
                construction work. These duties are particularly relevant when refurbishment or
                demolition work is planned in buildings that may contain asbestos.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-orange-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Provide pre-construction information</strong> including asbestos
                      survey reports, the asbestos register, and details of any known or suspected
                      ACMs
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-orange-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Ensure a Refurbishment &amp; Demolition survey</strong> is carried out
                      before work that will disturb the building fabric &mdash; this is more
                      intrusive than a management survey and is designed to find all ACMs in the
                      area of work
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-orange-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Not allow construction work to start</strong> until satisfied that
                      asbestos risks have been properly identified and addressed
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-orange-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Appoint competent contractors</strong> who understand asbestos risks
                      and have the appropriate training, equipment, and licences
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  <strong className="text-white">transfer automatically to the contractor</strong>{' '}
                  (or the principal contractor if there are multiple contractors). This means the
                  contractor takes on responsibility for ensuring asbestos risks are managed on
                  domestic projects.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                The Health and Safety Executive (HSE) is the primary enforcing authority for
                asbestos legislation in the United Kingdom. The HSE has a range of enforcement tools
                at its disposal, from informal advice through to criminal prosecution.
              </p>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <h3 className="text-orange-400 font-medium mb-3">Enforcement Tools</h3>
                <div className="space-y-4 text-sm">
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-green-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Advice and guidance</strong> &mdash; an informal approach used for
                      minor issues where the inspector believes education will resolve the problem
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-amber-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Improvement notice</strong> &mdash; requires specific action to be
                      taken within a specified timeframe (typically 21 days). The dutyholder must
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      straight away and cannot be appealed before complying
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-red-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Prosecution</strong> &mdash; for serious breaches, repeat offenders,
                      or situations where someone has been harmed or placed at serious risk
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="space-y-2 text-sm text-white/80">
                  <div className="flex items-start gap-3">
                    ...
                    <span>
                      ...
                      convicted of asbestos offences
                    </span>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-red-400 mt-2 flex-shrink-0"></div>
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-red-400 mt-2 flex-shrink-0"></div>
                    <span>
                      <strong className="text-white">Imprisonment for up to 2 years</strong> for the
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-red-400 mt-2 flex-shrink-0"></div>
                    <span>
                      <strong className="text-white">Adverse publicity</strong> and reputational
                      damage &mdash; convictions are published by the HSE
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-4 sm:gap-6">
                <div className="rounded-lg p-3 sm:p-4 bg-orange-500/10 border-l-2 border-l-orange-500/50 border border-orange-500/30">
                  ...
                  <p className="text-sm text-white/80">
                    ...
                    premises, examine documents (including the asbestos register, risk assessments,
                    training records, and health surveillance records), take samples, and interview
                    employees.
                  </p>
                </div>
                <div className="rounded-lg p-3 sm:p-4 bg-orange-500/10 border-l-2 border-l-orange-500/50 border border-orange-500/30">
                  ...
                  <p className="text-sm text-white/80">
                    ...
                    investigating. This charge applies from the point the breach is identified and
                    is in addition to any fines or enforcement action that follows.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                If you believe your employer or a dutyholder is not managing asbestos properly, you
                have the <strong>right and the duty</strong> to raise your concerns. Staying silent
                when you know asbestos is being mismanaged puts lives at risk &mdash; including your
                own.
              </p>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <h3 className="text-orange-400 font-medium mb-3">Who You Can Report Concerns To</h3>
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-orange-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Your employer</strong> &mdash; through your line manager, supervisor,
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-orange-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Your safety representative</strong> &mdash; if one has been appointed
                      for your workplace
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-orange-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>The HSE</strong> &mdash; reports can be made anonymously via the HSE
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-orange-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Your trade union</strong> &mdash; union representatives can raise
              ...
              <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white/80">
                  <p>
                    ...
                    protects employees who make protected disclosures about health and safety
                    concerns:
                  </p>
                  <ul className="space-y-2 ml-1">
                    <li className="flex items-start gap-3">
                      ...
                      <span>
                        You <strong className="text-white">cannot be dismissed</strong> or treated
                        unfairly for raising genuine health and safety concerns
                      </span>
                    </li>
                    <li className="flex items-start gap-3">
                      <div className="w-1.5 h-1.5 rounded-full bg-green-400 mt-2 flex-shrink-0"></div>
                    ...
                    <li className="flex items-start gap-3">
                      <div className="w-1.5 h-1.5 rounded-full bg-green-400 mt-2 flex-shrink-0"></div>
                      <span>
                        If you are treated unfairly as a result of whistleblowing, you can bring a
                        claim to an <strong className="text-white">employment tribunal</strong>
                      </span>
                    </li>
                  </ul>
                </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                Asbestos training is not a one-off event. The law requires ongoing refresher
                training to ensure workers remain competent and up to date with current guidance and
                legislation. Failure to provide refresher training is a breach of Regulation 10.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-orange-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Changes in legislation</strong> &mdash; any updates to regulations,
                      approved codes of practice, or HSE guidance
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-orange-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>New guidance</strong> &mdash; including updated task sheets, best
                      practice notes, and industry standards
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-orange-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Lessons from incidents</strong> &mdash; real-world examples of what
                      went wrong and how to prevent similar incidents
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-orange-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Site-specific issues</strong> &mdash; any changes to the asbestos
                      register, new ACMs found, or changes to the management plan
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  that workers have received up-to-date training, they are in breach of the
                  regulations and face enforcement action.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                This is the final content section of the asbestos awareness course. Before you move
                on to the mock exam, take a moment to reflect on your{' '}
                <strong>personal responsibility</strong> to protect yourself and others from
                asbestos exposure. The knowledge you have gained in this course could save your
                life.
              </p>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                <ul className="text-white space-y-3 text-sm">
                  <li className="flex items-start gap-3">
                    ...
                    <span>
                      You have a <strong>personal responsibility</strong> to protect yourself and
                      others from asbestos exposure &mdash; this is not just your employer&rsquo;s
                      job
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                  ...
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-orange-500 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong>Wear RPE/PPE as directed</strong> and follow safe systems of work
                      without exception
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-orange-500 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong>Report any accidental disturbance immediately</strong> &mdash; do not
                      try to clean up or contain the situation yourself
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-orange-500 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong>Record any exposure</strong> for your health records &mdash; this
                      information may be critical decades from now
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-orange-500 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong>Inform your GP</strong> of any past asbestos exposure &mdash; they can
              ...
              <div className="bg-red-500/10 border-2 border-red-500/40 p-5 rounded-lg">
                ...
                <p className="text-white text-sm leading-relaxed">
                  ...
                  Mesothelioma has no cure. Asbestosis is progressive and irreversible. The diseases
                  caused by asbestos exposure can take 15 to 60 years to develop, meaning the
                  consequences of a shortcut taken today may not become apparent for decades. By
                  then, it is too late.{' '}
                  <strong>
                    The controls, procedures, and regulations exist because people have died.
                  </strong>{' '}
                  Every rule you follow, every check you make, and every piece of PPE you wear is
                  protecting a life &mdash; yours, your colleagues&rsquo;, and your family&rsquo;s.
                </p>
              </div>
            </div>
          </div>
        ...
        {/* ─── Quiz ─── */}
        <div className="mt-12">
          <Quiz title="Roles, Responsibilities & Legal Duties Quiz" questions={quizQuestions} />
        </div>
