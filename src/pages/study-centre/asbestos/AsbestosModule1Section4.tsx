...
const quizQuestions = [
  {
    ...
    correctAnswer: 1,
    explanation:
      'Once asbestos fibres are embedded in lung tissue, the body cannot break them down or expel them. The fibres remain permanently in the tissue, causing chronic inflammation, progressive scarring, and DNA damage over decades. This is what makes asbestos so dangerous — a single exposure event can lead to disease many years later because the fibres never leave the body.',
  },
  {
    id: 2,
    question: 'Approximately how many people die from mesothelioma in the UK each year?',
    options: ['Around 500', 'Around 1,200', 'Around 2,700', 'Around 5,000'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    id: 5,
    question:
      'What is the most common sign of past asbestos exposure, often found incidentally on chest X-rays?',
    options: ['Lung cancer tumours', 'Pleural plaques', 'Asbestosis scarring', 'Pleural effusion'],
    correctAnswer: 1,
    explanation:
      'Pleural plaques are the most common sign of past asbestos exposure. They are areas of calcified thickening on the pleura (the membrane surrounding the lungs) and are usually found incidentally during chest X-rays taken for other reasons. Pleural plaques usually cause no symptoms and are not pre-cancerous, but they confirm definite past exposure to asbestos and indicate that the individual should be on an asbestos-related disease screening programme.',
  },
  {
    id: 6,
  ...
  },
  {
    id: 8,
    question:
      'What effect does the combination of asbestos exposure AND smoking have on lung cancer risk?',
    options: [
    ...
    correctAnswer: 2,
    explanation:
      'Asbestos exposure and smoking have a synergistic (multiplicative) rather than additive effect on lung cancer risk. Asbestos alone increases risk approximately 5 times, smoking alone approximately 10 times, but combined they produce approximately 50 times the risk of lung cancer compared to a non-exposed non-smoker. This makes smoking cessation critically important for anyone with past asbestos exposure.',
  },
];
...
export default function AsbestosModule1Section4() {
  useSEO({
    ...
    description:
      'Mesothelioma, asbestos-related lung cancer, asbestosis, pleural thickening, latency periods, the single-fibre theory, and who is most at risk from asbestos exposure in the UK.',
  });
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-orange-500/5 border-l-2 border-orange-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Mesothelioma:</strong> Always fatal &mdash; ~2,700 UK deaths/year
              </li>
              <li>
                <strong>Lung cancer:</strong> 50&times; risk if combined with smoking
              </li>
              <li>
                <strong>Latency:</strong> 15&ndash;60 years before symptoms appear
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-orange-500/5 border-l-2 border-orange-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>No safe level:</strong> A single fibre could initiate disease
              </li>
              <li>
                <strong>Most at risk:</strong> Electricians, plumbers, joiners, roofers
              </li>
              <li>
                <strong>20 tradespeople</strong> die every week in the UK
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The primary route of asbestos exposure is <strong>inhalation</strong>. When
                asbestos-containing materials are disturbed &mdash; by drilling, cutting, sanding,
                breaking, or even simply handling deteriorated material &mdash; microscopic fibres
                are released into the air. A single asbestos fibre is up to{' '}
                <strong>700 times thinner than a human hair</strong>, making them completely
                invisible to the naked eye.
              </p>

              <p>
                Once inhaled, the fibres travel through the airways &mdash; from the trachea through
                the bronchi and bronchioles &mdash; and into the alveoli (the tiny air sacs where
                gas exchange occurs). Some fibres can penetrate through the alveoli into the{' '}
                <strong>pleura</strong>, the membrane surrounding the lungs. Once embedded in lung
                tissue, the body
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  Critically, fibres carried home on clothing, hair, and skin pose a{' '}
                  <strong className="text-white">secondary exposure risk to family members</strong>.
                  Cases of mesothelioma have been recorded in spouses and children of asbestos
                  workers who never entered a workplace themselves.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 sm:p-6 rounded-lg">
                <p className="text-sm font-medium text-orange-400 mb-4 text-center">
                  Respiratory System &mdash; Path of Asbestos Fibres
                </p>
                  ...
                  <div className="w-full bg-orange-500/20 border border-orange-500/50 rounded-lg p-3 text-center">
                    ...
                    <div className="mt-2 inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-orange-500/20 border border-orange-500/30">
                      <span className="text-[10px] text-orange-300 font-medium">
                        ASBESTOSIS &mdash; fibrosis throughout lung tissue
                      </span>
                    </div>
                  </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Mesothelioma is a cancer of the mesothelial cells that line the{' '}
                <strong>pleura</strong> (lungs),
                <strong> peritoneum</strong> (abdomen), or <strong>pericardium</strong> (heart). It
                is
                <strong> almost exclusively caused by asbestos exposure</strong> and is considered
                the &ldquo;signature&rdquo; asbestos disease.
              </p>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  at an advanced stage because early symptoms (breathlessness, chest pain, fatigue)
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Approximately <strong className="text-white">2,700 deaths per year</strong> in
                      the UK &mdash; the highest rate in the world per capita
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Can be caused by{' '}
                      <strong className="text-white">very short, low-level exposure</strong> &mdash;
                      unlike asbestosis, it does not require prolonged heavy exposure
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Latency period typically{' '}
                      <strong className="text-white">30&ndash;50 years</strong> (can be as short as
                      15 years)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Symptoms include: breathlessness, chest pain, weight loss, fatigue, and fluid
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      The UK has the highest mesothelioma death rate in the world due to extensive
                      historical use of asbestos in construction, shipbuilding, and industry
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Asbestos exposure causes lung cancer that is{' '}
                <strong>clinically indistinguishable</strong> from lung cancer caused by smoking or
                other factors. The risk is dose-related &mdash; higher exposure means higher risk
                &mdash; and all types of asbestos (white, brown, and blue) can cause lung cancer.
              </p>
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      <strong className="text-white">2,500+ UK deaths per year</strong> attributable
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Latency period typically{' '}
                      <strong className="text-white">20&ndash;40 years</strong>
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      All types of asbestos cause lung cancer &mdash; chrysotile (white), amosite
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Smoking cessation is critically important for anyone with a history of
                      asbestos exposure
                    </span>
                  </li>
                </ul>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Asbestosis is a progressive <strong>fibrosis (scarring) of the lung tissue</strong>{' '}
                caused by heavy, prolonged exposure to asbestos fibres. The inhaled fibres cause
                chronic inflammation, and over time scar tissue builds up throughout the lungs,
                causing them to lose elasticity. The lungs become stiff and cannot expand properly,
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  diagnosed by chest X-ray or CT scan showing diffuse fibrosis, combined with a
                  confirmed history of asbestos exposure.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Caused by <strong className="text-white">heavy, prolonged exposure</strong>{' '}
                      &mdash; not short-term low-level contact
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Typically seen in workers with years of heavy exposure: laggers, shipyard
                      workers, power station workers
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Latency period typically{' '}
                      <strong className="text-white">15&ndash;30 years</strong>
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The pleura is the thin membrane surrounding the lungs. Asbestos fibres that reach
                the pleura can cause two distinct conditions: <strong>pleural plaques</strong> and
                ...
                <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-2">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Most common</strong> sign of past asbestos
                        exposure
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Usually cause <strong className="text-white">no symptoms</strong> &mdash;
                        found incidentally on chest X-rays
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                ...
                <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-2">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Can <strong className="text-white">restrict lung expansion</strong>
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  <strong className="text-white">
                    asbestos-related disease screening programme
                  </strong>{' '}
                  with regular health surveillance, because the presence of these conditions means
                  the person has been exposed and is at increased risk of developing more serious
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                <strong> no known safe level of asbestos exposure</strong>. Unlike many other
                hazardous substances where a safe threshold can be established, asbestos has no such
                threshold.
              </p>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  This is why even brief, apparently minor disturbance of asbestos-containing
                  materials must be taken seriously.
                </p>
              </div>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  represents the highest concentration of airborne asbestos fibres that is permitted
                  during controlled work activities. Any exposure below this limit still carries
                  risk. This is precisely why the hierarchy of controls prioritises{' '}
                  <strong className="text-white">elimination and avoidance</strong> above all other
                  control measures.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      If asbestos can be left undisturbed and safely managed in place, that is
                      always preferable to disturbing it
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Any work that may disturb ACMs must be properly planned, risk-assessed, and
                      controlled
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      RPE and other controls reduce exposure but never eliminate it entirely
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      &ldquo;It&rsquo;s only a small amount&rdquo; is never a valid reason to take
                      shortcuts &mdash; even minimal exposure carries risk
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Today, the people most at risk from asbestos exposure are{' '}
                <strong>
                  tradespeople who disturb asbestos-containing materials (ACMs) during maintenance,
                  refurbishment, or demolition work
                </strong>
                . Asbestos manufacturing has been banned since 1999, but the material remains
                present in hundreds of thousands of buildings across the UK.
              </p>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  work-related death in the UK, far exceeding deaths from workplace accidents.
                </p>
              </div>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  those who washed contaminated clothes &mdash; inhaled these fibres during routine
                  domestic tasks. Cases of mesothelioma have been diagnosed in spouses and children
                  of asbestos workers who never set foot in an asbestos workplace. Modern
                  regulations require decontamination procedures and prohibit workers from taking
