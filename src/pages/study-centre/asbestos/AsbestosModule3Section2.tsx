...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 0,
    explanation:
      'Asbestos pipe lagging typically contains amosite and/or crocidolite and is highly friable, meaning it crumbles easily and releases large quantities of fibres when disturbed. It ALWAYS requires licensed removal by an HSE-licensed contractor working within a full enclosure under the Control of Asbestos Regulations 2012.',
  },
  {
    id: 'artex-risk',
...
const quizQuestions = [
  ...
  },
  {
    id: 2,
    question:
      'Sprayed asbestos coatings (limpet asbestos) can contain up to what percentage of asbestos?',
    options: ['5%', '25%', '50%', '85%'],
    correctAnswer: 3,
    explanation:
      "Sprayed asbestos coatings can contain up to 85% asbestos, typically crocidolite or amosite. This extremely high fibre content, combined with the material's friable nature, makes sprayed coatings the HIGHEST RISK ACM. Surface fibres can be released by air currents alone, and any disturbance releases massive fibre counts.",
  },
  {
    id: 3,
    question:
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'Asbestos rope seals and gaskets were used for high-temperature sealing applications — boiler doors, flue joints, pipe flanges, valve glands, and pump seals. They are typically made from braided chrysotile and are still encountered in older heating systems, industrial plant, and some domestic boilers.',
  },
  {
    id: 6,
    question:
  ...
  },
  {
    id: 7,
    question:
      'After what year were textured decorative coatings (Artex) manufactured without asbestos?',
    options: ['1985', '1990', '1999', '2000'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    id: 8,
    question:
      'What should you do if you find insulation material in a pre-2000 building and are unsure whether it contains asbestos?',
    options: [
...
export default function AsbestosModule3Section2() {
  useSEO({
    ...
    description:
      'Pipe lagging, sprayed coatings, textured decorative coatings (Artex), rope seals, gaskets, millboard, fire blankets, and key identification tips for insulation and coating ACMs.',
  });
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-orange-500/5 border-l-2 border-orange-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Pipe lagging:</strong> Highest risk &mdash; amosite/crocidolite, licensed
                removal only
              </li>
              <li>
                <strong>Sprayed coatings:</strong> Up to 85% asbestos &mdash; fibres released by air
                currents
              </li>
              <li>
                <strong>Artex:</strong> 1-5% chrysotile &mdash; low risk when undisturbed
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-orange-500/5 border-l-2 border-orange-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Identification:</strong> Lab analysis only &mdash; never by sight
              </li>
              <li>
                <strong>Pre-2000 rule:</strong> Presume asbestos until proven otherwise
              </li>
              <li>
                <strong>If in doubt:</strong> STOP &mdash; do not disturb &mdash; report
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Asbestos pipe lagging is widely regarded as the <strong>highest-risk ACM</strong>{' '}
                encountered in UK buildings. It was applied to pipes, boilers, calorifiers, vessels,
                and ductwork to provide thermal insulation and fire protection. It typically
                contains{' '}
                <strong>amosite (brown asbestos) and/or crocidolite (blue asbestos)</strong> &mdash;
                the two most dangerous commercially used fibre types.
              </p>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  <strong className="text-white">ALWAYS requires licensed removal</strong> by an
                  HSE-licensed contractor. Do NOT touch, disturb, or attempt to remove asbestos pipe
                  lagging under any circumstances.
                </p>
              </div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      <strong className="text-white">
                        thick layer of grey, brown, or white insulation
                      </strong>{' '}
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      <strong className="text-white">canvas or hessian outer layer</strong>,
                      sometimes painted
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      May have an{' '}
                      <strong className="text-white">aluminium foil or metal jacket</strong> outer
                      casing
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Insulation layer typically{' '}
                      <strong className="text-white">50&ndash;100mm thick</strong>
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Found on pipes, boilers, calorifiers, vessels, and ductwork in pre-2000
                      buildings
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Industrial buildings, schools, hospitals, and public buildings built before
                      2000
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
              ...
              <div className="bg-white/5 border border-orange-500/30 rounded-xl p-6 sm:p-8">
                ...
                <div className="flex justify-center">
                  <div className="relative w-[280px] h-[280px] sm:w-[340px] sm:h-[340px]">
                    ...
                    <div className="absolute inset-0 rounded-full bg-gray-400/20 border-2 border-gray-400/40 flex items-center justify-center"></div>
                    {/* Layer 3 — Outer wrapping */}
                    <div className="absolute inset-[28px] sm:inset-[34px] rounded-full bg-amber-700/25 border-2 border-amber-600/40"></div>
                    {/* Layer 2 — Asbestos insulation */}
                    <div className="absolute inset-[56px] sm:inset-[68px] rounded-full bg-amber-900/40 border-2 border-red-500/50"></div>
                    {/* Layer 1 — Pipe (centre) */}
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Sprayed asbestos coatings &mdash; commonly known as <strong>limpet asbestos</strong>{' '}
                &mdash; were created by mixing asbestos fibre with cement or calcium compounds and
                spraying the mixture onto surfaces. This technique was used for{' '}
                <strong>
                  fireproofing structural steelwork, thermal insulation, and acoustic treatment
                </strong>{' '}
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  <strong className="text-white">extremely friable</strong>: surface fibres can be
                  released by <strong className="text-white">air currents alone</strong>, without
                  any physical contact or disturbance. Any work that disturbs sprayed coatings
                  releases massive fibre counts into the air. This is considered the{' '}
                  <strong className="text-white">highest-risk ACM</strong> you can encounter.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Appearance:</strong> Rough, textured surface —
                      grey or off-white
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Asbestos content:</strong> Up to 85% — often
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Friability:</strong> Extremely friable — the
                      most dangerous ACM for fibre release
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Removal:</strong> ALWAYS licensed removal in a
                      full enclosure
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Steel-framed buildings &mdash; structural steelwork coated for fire protection
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-orange-400">On Site:</strong> If you are working in a
                  ceiling void, above suspended ceilings, or near structural steelwork in a building
                  from the 1950s&ndash;1970s, be alert for sprayed coatings. Check the asbestos
                  register before any work. If you see a rough, grey, textured coating on steelwork
                  or ceilings, <strong>do NOT touch it</strong>. Stop work immediately, leave the
                  area, and report to your supervisor.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The brand name <strong>&ldquo;Artex&rdquo;</strong> is commonly used as a generic
                term for textured decorative coatings applied to ceilings and sometimes walls. These
                coatings were extremely popular in UK properties from the{' '}
                <strong>1960s to the late 1990s</strong> and typically contain{' '}
                <strong>1&ndash;5% chrysotile asbestos</strong> (white asbestos).
              </p>

              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-orange-400">Important:</strong> Artex manufactured after
                  <strong> 2000 does not contain asbestos</strong>. However, you cannot determine
                  the manufacturing date or asbestos content by visual inspection alone &mdash; the
                  coating
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Low risk when intact:</strong> Fibres are bound
                      within the coating matrix &mdash; undisturbed Artex poses minimal risk
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">BECOMES a risk when:</strong> Sanded, scraped,
                      drilled into, or removed dry
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Wet scraping or steaming:</strong> May be
                      non-licensed work (with appropriate controls)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Power tool removal:</strong> Classified as
                      notifiable non-licensed work (NNLW)
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Drilling into Artex:</strong> Drilling holes
                      for light fittings, junction boxes, or cable routes through Artex ceilings
                      will release fibres &mdash; always check the asbestos register first
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Chasing walls:</strong> If textured coating is
                      present on walls, chasing through it will release fibres
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Domestic properties:</strong> Very common in UK
                      homes from the 1960s&ndash;1990s &mdash; always assume textured coatings may
                      contain asbestos in pre-2000 properties
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  (1&ndash;5%) coatings release significant fibre counts when mechanically broken
                  up. If you need to work on a surface with textured coatings in a pre-2000
                  property,{' '}
                  <strong className="text-white">stop and get the material tested first</strong>.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Asbestos was widely used in rope seals, gaskets, and packing materials because of
                its exceptional heat resistance and ability to form tight seals at high
                temperatures. These components are{' '}
                <strong>
                  still encountered in older heating systems, industrial plant, and some domestic
                  boilers
                </strong>
                .
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Braided rope:</strong> Chrysotile rope used for
                      sealing boiler doors, flue joints, and pipe flanges &mdash; appears as woven
                      or braided cord, often grey-white
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Gaskets:</strong> Compressed asbestos fibre
                      sheets cut to shape for high-temperature joints in pipework, flanges, and
                      equipment
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Packing materials:</strong> Used in valve
                      glands and pump seals to prevent leakage around rotating or sliding components
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Typically <strong className="text-white">chrysotile</strong>, sometimes mixed
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Can become friable when{' '}
                      <strong className="text-white">old, dried out, or disturbed</strong>
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Usually <strong className="text-white">non-licensed or NNLW</strong> depending
                      on condition and method of removal
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Must be removed by a competent person following appropriate procedures
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-orange-400">On Site:</strong> If you are working on older
                  heating systems or industrial plant and encounter rope seals, gaskets, or packing
                  materials, do not assume they are non-asbestos. In pre-2000 installations, these
                  materials should be treated as suspected asbestos until confirmed otherwise. Do
                  not cut, pull, or remove them without checking the asbestos register and
                  confirming the material type.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                <strong> overlooked during surveys and site work</strong> because they are hidden,
                thin, or do not look like &ldquo;typical&rdquo; asbestos products. These include
                millboard, asbestos paper, and various bituminous products.
              </p>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-1">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Thin asbestos board, typically{' '}
                        <strong className="text-white">2&ndash;6mm thick</strong>
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Used for insulation, lining behind radiators and boilers, and fire
                        protection
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Can look similar to thick cardboard &mdash; easily mistaken for
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-1">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Very thin sheets used for{' '}
                        <strong className="text-white">
                          insulation wrapping and cable insulation
                        </strong>
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-1">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Roof felt:</strong> Bitumen-based roofing
                        felt often contained asbestos for reinforcement
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Damp-proof courses:</strong> Some older DPCs
                        contain asbestos in the bituminous layer
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Floor tile adhesive (black mastic):</strong>{' '}
                        Black bitumen-based adhesive under floor tiles{' '}
                        <strong className="text-white">commonly contains asbestos</strong> &mdash;
                        one of the most frequently overlooked ACMs
                      </span>
                    </li>
                  </ul>
                </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  &ldquo;typical&rdquo; asbestos. Black mastic (floor tile adhesive) is particularly
                  important &mdash; when removing old floor tiles in pre-2000 buildings,{' '}
                  <strong className="text-white">
                    always consider that the adhesive may contain asbestos
                  </strong>{' '}
                  and have it tested before disturbing it.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Before modern heat-resistant materials were available,{' '}
                <strong>woven asbestos fabric</strong>
                was used to manufacture fire blankets, welding blankets, heat shields, protective
                gloves and aprons, and theatre fire curtains. These textiles typically contain{' '}
                <strong>chrysotile woven into fabric</strong>.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Fire blankets (pre-2000):</strong> May contain
                      woven asbestos fabric &mdash; found in kitchens, workshops, and plant rooms of
                      older buildings
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Welding blankets and heat shields:</strong>{' '}
                      Used in industrial settings to protect against sparks, splatter, and radiant
                      heat
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Gloves and aprons:</strong> Used in foundries,
                      glass works, and other high-temperature environments
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Theatre curtains (fire curtains):</strong>{' '}
                      Older theatres, cinemas, and assembly halls may have asbestos fire curtains
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-orange-400">Action Required:</strong> All asbestos
                  textiles should be <strong>replaced with modern non-asbestos alternatives</strong>
                  . Do not use, shake, fold, or handle old asbestos textiles &mdash; worn or
                  deteriorating fabric can release fibres. If you find an older fire blanket or
                  welding blanket in a pre-2000 building, report it and arrange for safe removal and
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  <strong className="text-white">treated as a suspected ACM</strong>. Do not place
                  it in general waste. It must be double-bagged, labelled as asbestos waste, and
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The single most important rule when dealing with insulation and coatings in older
                buildings is this:{' '}
                <strong>you CANNOT identify asbestos by visual inspection alone</strong>. Always get
                laboratory confirmation before disturbing any suspect material.
              </p>
                ...
                <div className="text-sm text-white space-y-2">
                  <ol className="space-y-2">
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        <strong className="text-white">Never identify by sight alone</strong>{' '}
                        &mdash; visual inspection cannot confirm or rule out asbestos
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-0.5 w-6 h-6 rounded-full bg-red-500/20 border border-red-500/40 flex items-center justify-center flex-shrink-0 text-xs font-bold text-red-400">
                      ...
                      <span>
                        <strong className="text-white">
                          Location and age are strong indicators
                        </strong>{' '}
                        &mdash; any insulation in a pre-2000 building should be presumed asbestos
                    ...
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        <strong className="text-white">Always get laboratory confirmation</strong>{' '}
                        &mdash; Polarised Light Microscopy (PLM) by a UKAS-accredited lab
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-0.5 w-6 h-6 rounded-full bg-red-500/20 border border-red-500/40 flex items-center justify-center flex-shrink-0 text-xs font-bold text-red-400">
                      ...
                      <span>
                        <strong className="text-white">Look for signs of damage</strong> &mdash;
                        deterioration, cracking, flaking, or previous disturbance increase fibre
                        release risk
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        <strong className="text-white">Check the asbestos register</strong> &mdash;
                        always review the register before starting any work in a non-domestic
                        building
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        <strong className="text-white">If in doubt &mdash; STOP and report</strong>{' '}
                        &mdash; do not disturb the material, leave the area, and inform your
                        supervisor
                      </span>
                    </li>
                  </ol>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-2">
                  Quick Reference: Insulation &amp; Coatings Risk Summary
                </p>
                  ...
                  <table className="w-full text-sm">
                    ...
                    <tbody className="text-white">
                      <tr className="border-b border-white/5">
                        ...
                        <td className="py-2">
                          <span className="text-red-400 font-semibold">Licensed</span>
                        </td>
                      </tr>
                      <tr className="border-b border-white/5">
                      ...
                      <tr className="border-b border-white/5">
                        ...
                        <td className="py-2">
                          <span className="text-orange-400 font-semibold">Non-licensed / NNLW</span>
                        </td>
                      </tr>
                      <tr className="border-b border-white/5">
                      ...
                      <tr className="border-b border-white/5">
                        ...
                        <td className="py-2">
                          <span className="text-orange-400 font-semibold">Varies</span>
                        </td>
                      </tr>
                      <tr className="border-b border-white/5">
                      ...
                      <tr>
                        ...
                        <td className="py-2 pr-3">Chrysotile</td>
                        <td className="py-2">
                          <span className="text-orange-400 font-semibold">Non-licensed</span>
                        </td>
                      </tr>
                    </tbody>
                  </table>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-orange-400">Remember:</strong> The removal type depends on
                  the condition of the material, the fibre type, and the method of work &mdash; not
                  just the product type. A material that is normally non-licensed work can become
                  licensed work if it is in very poor condition and highly friable. Always follow
                  the risk assessment and the specific guidance in HSE publication HSG264 (Asbestos:
                  The Survey Guide).
                </p>
              </div>
            </div>
