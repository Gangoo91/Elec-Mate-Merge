...
const DESCRIPTION =
  'Reverberation time, Approved Document E requirements, noise rating curves, CIBSE acoustic criteria, and plant room acoustics for HNC Building Services Engineering.';
...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: [
      ...
      'Airborne and impact sound between dwellings',
      'HVAC duct noise',
    ],
    correctIndex: 2,
    explanation:
      "Part E focuses on sound insulation between dwellings - both airborne (DnT,w + Ctr) and impact (L'nT,w) transmission.",
  },
  {
    id: 'qc4',
...
const quizQuestions = [
  ...
  },
  {
    id: 'q2',
    question:
      'For speech intelligibility in a lecture theatre, what reverberation time range is typically recommended?',
    options: ['0.2 - 0.4 seconds', '0.6 - 1.0 seconds', '1.5 - 2.0 seconds', '2.5 - 3.0 seconds'],
    correctAnswer: '0.6 - 1.0 seconds',
    explanation:
      "Lecture theatres need 0.6-1.0 s for clear speech. Shorter times sound 'dead', longer times reduce clarity.",
  },
  {
    id: 'q3',
    ...
    explanation:
      'Ctr adjusts for low-frequency spectrum typical of road traffic and music. DnT,w + Ctr gives more realistic rating.',
  },
  {
    id: 'q4',
    question:
    ...
    explanation:
      'Part E requires DnT,w + Ctr ≥ 45 dB for walls and floors between new-build dwellings. Robust Details can demonstrate compliance.',
  },
  {
    id: 'q5',
  ...
  },
  {
    ...
    explanation:
      'Plant rooms typically allow NR 65-70 with hearing protection for limited occupancy. Adjacent occupied spaces need proper isolation.',
  },
  {
    id: 'q7',
    question:
      'A material has α = 0.7 at 1 kHz. If 10 m² of this material is installed, the absorption added is:',
    options: ['0.7 m² sabins', '7 m² sabins', '10 m² sabins', '70 m² sabins'],
    correctAnswer: '7 m² sabins',
    explanation:
      'Absorption A = S × α = 10 × 0.7 = 7 m² sabins. The sabin is the unit of sound absorption.',
  },
  {
    id: 'q8',
    ...
    explanation:
      'Flanking paths include floor/ceiling connections, external walls, and service penetrations that bypass the main partition.',
  },
  {
    id: 'q9',
  ...
  },
  {
    ...
    options: [
      ...
      'A UKAS-accredited testing body or registered tester',
      'The building control officer',
    ],
    correctAnswer: 'A UKAS-accredited testing body or registered tester',
    explanation:
      'Pre-completion testing requires UKAS accreditation or registration with an approved scheme to ensure competent, independent assessment.',
  },
];
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'Robust Details (robustdetails.com) are pre-tested separating wall and floor constructions that consistently achieve Part E standards. Using registered Robust Details with proper workmanship inspection avoids the need for pre-completion sound testing, saving time and cost while ensuring compliance.',
  },
  {
    question: 'Why might a room have acceptable dB(A) levels but still receive noise complaints?',
    answer:
      'The dB(A) weighting combines all frequencies into one number, potentially masking tonal issues. A low-frequency rumble from a chiller or high-frequency whine from a fan might seem acceptable in dB(A) but exceeds NR curves at specific frequencies. NR assessment reveals these spectral imbalances.',
  },
  {
    question: 'What acoustic considerations apply to building services penetrations?',
    answer:
      'Service penetrations through separating elements create flanking paths. Pipes, ducts, and cables must be fire-stopped with acoustic sealant. Rigid connections should be avoided - use flexible couplings and acoustic lagging. Back-to-back socket outlets should be offset by 150mm minimum and sealed.',
  },
  {
    question: 'How does floating floor construction improve impact sound insulation?',
    answer:
      "Floating floors decouple the walking surface from the structural floor using a resilient layer (mineral wool, rubber). This breaks the direct transmission path for impact energy. Combined with adequate mass in the floating screed, improvements of 15-25 dB in L'nT,w are achievable.",
  },
  {
    question: 'What is the acoustic difference between absorption and insulation?',
    answer:
      "Absorption reduces sound energy within a space (controlling reverberation and internal noise levels). Insulation prevents sound transmission between spaces. Soft materials absorb but don't insulate; dense materials insulate but don't absorb. Good acoustic design uses both appropriately.",
  },
];
        ...
        <div className="container mx-auto px-4 py-4">
          <Link to="../h-n-c-module2-section4">
            <Button
              variant="ghost"
              size="sm"
              className="text-purple-300 hover:text-purple-100 -ml-2 mb-2"
            >
      ...
      <div className="container mx-auto px-4 py-6 max-w-4xl">
        <div className="space-y-8">
          ...
          <section className="space-y-4">
            ...
            <div className="bg-[#242424] rounded-lg p-4 space-y-4">
              <p className="text-gray-300">
                Reverberation time (RT or T₆₀) is the time for sound to decay by 60 dB after the
                source stops. It fundamentally affects speech intelligibility, music quality, and
                acoustic comfort in occupied spaces.
              </p>
              ...
              <div className="bg-purple-900/20 border border-purple-500/30 rounded-lg p-4">
                ...
                <p className="text-gray-300 text-sm mt-2">
                  Where: T₆₀ = reverberation time (seconds), V = room volume (m³), A = total
                  absorption (m² sabins)
                </p>
                <p className="text-gray-400 text-sm mt-2">
                  Total absorption A = Σ(Sᵢ × αᵢ) where S = surface area and α = absorption
                  coefficient (0-1)
                </p>
              </div>
              ...
              <div className="bg-[#1a1a1a] rounded-lg p-4">
                <h4 className="font-semibold text-gray-200 mb-2">
                  Absorption Coefficients (α at 1 kHz)
                </h4>
                <div className="grid grid-cols-2 gap-4 text-sm">
                  <div className="space-y-1">
                    <p className="text-gray-300">
                      Acoustic ceiling tile: <span className="text-purple-300">0.7 - 0.9</span>
                    </p>
                    <p className="text-gray-300">
                      Heavy curtains: <span className="text-purple-300">0.5 - 0.7</span>
                    </p>
                    <p className="text-gray-300">
                      Carpet on underlay: <span className="text-purple-300">0.3 - 0.5</span>
                    </p>
                  </div>
                  <div className="space-y-1">
                    <p className="text-gray-300">
                      Painted plaster: <span className="text-purple-300">0.02 - 0.04</span>
                    </p>
                    <p className="text-gray-300">
                      Glass: <span className="text-purple-300">0.03 - 0.05</span>
                    </p>
                    <p className="text-gray-300">
                      Concrete floor: <span className="text-purple-300">0.01 - 0.02</span>
                    </p>
                  </div>
                </div>
              </div>
          ...
          <section className="space-y-4">
            ...
            <div className="bg-[#242424] rounded-lg p-4 space-y-4">
              <p className="text-gray-300">
                Approved Document E of the Building Regulations sets minimum standards for sound
                insulation between dwellings. Pre-completion testing or use of Robust Details
                demonstrates compliance.
              </p>

              <div className="bg-yellow-900/20 border border-yellow-500/30 rounded-lg p-4">
                <h4 className="font-semibold text-yellow-300 mb-3">
                  Part E Minimum Performance Standards
                </h4>
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between items-center py-2">
                    <span className="text-gray-300">
                      Internal walls within dwellings (to bedrooms)
                    </span>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="bg-[#1a1a1a] rounded-lg p-4">
                  ...
                  <ul className="space-y-2 text-sm text-gray-300">
                    <li>
                      <strong className="text-purple-300">DnT,w:</strong> Standardised weighted
                      level difference (field airborne)
                    </li>
                    <li>
                      <strong className="text-purple-300">Ctr:</strong> Spectrum adaptation term for
                      low frequencies
                    </li>
                    <li>
                      <strong className="text-purple-300">L'nT,w:</strong> Standardised weighted
                      impact sound level
                    </li>
                    <li>
                      <strong className="text-purple-300">Rw:</strong> Laboratory weighted sound
                      reduction index
                    </li>
                  </ul>
                </div>
              ...
              <div className="bg-blue-900/20 border border-blue-500/30 rounded-lg p-4">
                ...
                <p className="text-gray-300 text-sm">
                  Sound bypassing the separating element via connected structure significantly
                  affects field performance. Common flanking paths include: continuous floor
                  screeds, rigid wall ties, back-to-back services, and unbroken external wall
                  leaves. Robust Details specify junction requirements to control flanking.
                </p>
              </div>
            </div>
          ...
          <section className="space-y-4">
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-lg font-semibold text-purple-400">
                Noise Rating Curves and CIBSE Criteria
              </h2>
            </div>

            <div className="bg-[#242424] rounded-lg p-4 space-y-4">
              <p className="text-gray-300">
                Noise Rating (NR) curves assess the frequency spectrum of background noise from
                building services. Unlike dB(A), NR values reveal tonal imbalances that cause
                annoyance even at moderate overall levels.
              </p>
              ...
              <div className="bg-orange-900/20 border border-orange-500/30 rounded-lg p-4">
                ...
                <p className="text-gray-300 text-sm">
                  A ventilation system producing 42 dB(A) might seem acceptable for an office.
                  However, if measured octave bands show NR 50 at 125 Hz due to fan rumble,
                  occupants will complain of intrusive low-frequency noise. NR analysis identifies
                  the problem frequency for targeted treatment.
                </p>
              </div>
            </div>
          ...
          <section className="space-y-4">
            ...
            <div className="bg-[#242424] rounded-lg p-4 space-y-4">
              <p className="text-gray-300">
                Plant rooms containing chillers, boilers, pumps, and air handling units generate
                significant noise requiring careful acoustic design to protect adjacent occupied
                spaces and meet environmental limits.
              </p>
              ...
              <div className="bg-green-900/20 border border-green-500/30 rounded-lg p-4">
                <h4 className="font-semibold text-green-300 mb-3">
                  Worked Example: Plant Room Wall Specification
                </h4>
                <div className="space-y-2 text-sm text-gray-300">
                  <p>
                    <strong>Requirement:</strong> Plant room adjacent to office requiring NR 35
                  </p>
                  <p>
                    <strong>Plant room noise:</strong> 85 dB(A) (NR 80)
                  </p>
                  <p>
                    <strong>Required reduction:</strong> NR 80 - NR 35 = 45 dB minimum
                  </p>
                  <p>
                  ...
                  <p className="mt-2 text-green-300">
                    Provides adequate margin accounting for flanking and real-world performance.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-red-900/20 border border-red-500/30 rounded-lg p-4">
                <h4 className="font-semibold text-red-300 mb-2">
                  Common Plant Room Acoustic Failures
                </h4>
                <ul className="space-y-2 text-sm text-gray-300">
                  <li>
                    • <strong>Rigid pipe connections</strong> transmitting pump vibration throughout
                    building
                  </li>
                  <li>
                    • <strong>Unsealed penetrations</strong> for services negating wall performance
                  </li>
                  <li>
                    • <strong>Undersized attenuators</strong> on ductwork breakout paths
                  </li>
                  <li>
                    • <strong>Lightweight doors</strong> creating weak link in acoustic envelope
                  </li>
                  <li>
                    • <strong>Poor isolator selection</strong> - wrong frequency match to equipment
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-[#1a1a1a] rounded-lg p-4">
                ...
                <ul className="text-sm text-gray-300 space-y-1">
                  <li>
                    • <strong>Approved Document E:</strong> Resistance to sound passage
                  </li>
                  <li>
                    • <strong>CIBSE Guide A:</strong> Environmental design criteria including NR
                    values
                  </li>
                  <li>
                    • <strong>CIBSE Guide B5:</strong> Noise and vibration control for building
                    services
                  </li>
                  <li>
                    • <strong>BB93:</strong> Acoustic design of schools
                  </li>
                  <li>
                    • <strong>HTM 08-01:</strong> Acoustics for healthcare premises
                  </li>
                  <li>
                    • <strong>BS 8233:</strong> Guidance on sound insulation and noise reduction
                  </li>
                </ul>
              </div>
            </div>
