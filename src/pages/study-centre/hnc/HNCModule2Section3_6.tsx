...
const DESCRIPTION =
  'Air handling unit processes, mixed air calculations, economiser cycles, reheat systems, and building services design for HVAC applications.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 2,
    explanation:
      'Economiser cycles use cool outdoor air to provide free cooling when ambient conditions are favourable, significantly reducing mechanical cooling energy consumption.',
  },
  {
    ...
    correctIndex: 3,
    explanation:
      'The lever rule locates the mixed air condition on a straight line between return and outdoor air states, positioned inversely proportional to the mass flow rates.',
  },
  {
    ...
    correctIndex: 0,
    explanation:
      'Reheat warms air that has been cooled below the required supply temperature to achieve dehumidification while delivering air at the correct temperature for sensible cooling.',
  },
  {
    question: 'What minimum outdoor air percentage is typically required for ventilation?',
    options: ['0%', '10-25%', '5-10%', '50-75%'],
    correctIndex: 1,
    explanation:
      'Building regulations and CIBSE guidance typically require 10-25% minimum outdoor air for adequate ventilation, depending on occupancy and activity levels.',
  },
];
...
const quizQuestions = [
  {
    question:
      'An AHU mixes 2 kg/s of outdoor air at 5°C with 8 kg/s of return air at 22°C. What is the mixed air temperature?',
    options: ['15.0°C', '13.5°C', '18.6°C', '20.1°C'],
    correctIndex: 2,
    explanation:
      'Mixed temperature = (2×5 + 8×22)/(2+8) = (10 + 176)/10 = 186/10 = 18.6°C. The lever rule shows 20% outdoor air reduces return temperature by 20% of the difference.',
  },
  {
    ...
    correctIndex: 3,
    explanation:
      'Enthalpy-based economiser control is more accurate than temperature alone, switching to mechanical cooling when outdoor enthalpy exceeds return air enthalpy.',
  },
  {
    question:
      'In a reheat system supplying air at 13°C, the cooling coil outlet is 10°C. What is the reheat load for 5 kg/s airflow?',
    options: ['15 kW', '10 kW', '20 kW', '25 kW'],
    correctIndex: 0,
    explanation:
      'Reheat load = ṁ × cp × ΔT = 5 × 1.0 × (13 - 10) = 5 × 3 = 15 kW. This represents energy wasted but necessary for humidity control.',
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'VAV systems typically supply air at 12-14°C, allowing variable volume control to match zone loads while maintaining adequate temperature differential.',
  },
  {
    question:
      'A building requires 2.5 m³/s total supply air with 15% minimum outdoor air. What is the minimum fresh air rate?',
    options: ['0.25 m³/s', '0.50 m³/s', '0.375 m³/s', '0.625 m³/s'],
    correctIndex: 2,
    explanation:
      'Minimum outdoor air = 2.5 × 0.15 = 0.375 m³/s. This ensures adequate ventilation for occupants regardless of economiser operation.',
  },
  {
    ...
    correctIndex: 3,
    explanation:
      'Mixing dampers (outdoor air, return air, and exhaust dampers) modulate to control the proportion of outdoor and return air entering the AHU.',
  },
  {
    ...
    correctIndex: 0,
    explanation:
      'Increasing bypass allows more air to avoid the coil, reducing the effective heat transfer and moderating the supply air temperature for part-load control.',
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'Preheat coils raise cold outdoor air temperature to prevent freezing of filters, cooling coils, and humidifiers, particularly in climates with sub-zero winters.',
  },
  {
    question:
      'An economiser saves 150 kWh per day during 180 suitable days per year. At £0.15/kWh, what is the annual saving?',
    options: ['£2,700', '£5,400', '£4,050', '£6,750'],
    correctIndex: 2,
    explanation:
      'Annual saving = 150 × 180 × 0.15 = 27,000 × 0.15 = £4,050. Economiser cycles provide significant energy savings in temperate climates.',
  },
  {
    ...
    correctIndex: 3,
    explanation:
      'Return air at 22-24°C reflects typical room conditions in comfort applications, with the supply-return differential indicating the sensible cooling provided.',
  },
  {
    question:
      'In a 100% outdoor air system, what additional component is essential compared to recirculation systems?',
    options: [
    ...
    correctIndex: 0,
    explanation:
      'Heat recovery (run-around coils, plate exchangers, or thermal wheels) is essential in 100% OA systems to recover energy from exhaust air and reduce heating/cooling loads.',
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'Dedicated Outdoor Air Systems handle ventilation air separately from room sensible loads, allowing optimised dehumidification and heat recovery.',
  },
];
      ...
      <main className="max-w-4xl mx-auto px-4 py-6 space-y-8">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="bg-purple-500/10 border border-purple-500/30 rounded-xl p-4">
            ...
            <p className="text-xs text-gray-400">
              Mixing, heating, cooling, humidification sequences
            </p>
          </div>
        ...
        <section className="space-y-4">
          <div className="flex items-center gap-3">
            <span className="flex items-center justify-center w-8 h-8 rounded-lg bg-purple-500/20 text-purple-400 font-bold">
              1
            </span>
          ...
          <div className="bg-white/5 border border-white/10 rounded-xl p-5 space-y-4">
            <p className="text-gray-300">
              Air handling units (AHUs) combine multiple psychrometric processes in sequence to
              condition air from outdoor and return air sources to the required supply conditions.
              Understanding the sequence and interaction of these processes is essential for
              effective HVAC design.
            </p>

            <div className="bg-purple-500/10 border border-purple-500/30 rounded-lg p-4">
              <h4 className="font-semibold text-white mb-3">
                Typical AHU Process Sequence (Summer Cooling)
              </h4>
              <div className="space-y-2 text-sm text-gray-300">
                <p>
                  <span className="text-purple-400 font-medium">1. Mixing:</span> Outdoor air
                  combines with return air at mixing dampers
                </p>
                <p>
                  <span className="text-purple-400 font-medium">2. Filtration:</span> Particulate
                  removal (minimal psychrometric change, slight heating from fan)
                </p>
                <p>
                  <span className="text-purple-400 font-medium">3. Cooling:</span> Cooling coil
                  reduces temperature and dehumidifies
                </p>
                <p>
                  <span className="text-purple-400 font-medium">4. Reheat:</span> Optional reheat
                  for precise temperature control
                </p>
                <p>
                  <span className="text-purple-400 font-medium">5. Supply:</span> Fan adds small
                  temperature rise (1-2°C typically)
                </p>
              </div>
            </div>
            ...
            <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
              ...
              <div className="space-y-2 text-sm text-gray-300">
                <p>
                  <span className="text-blue-400 font-medium">1. Preheat:</span> Prevents coil
                  freezing in cold climates (raises air to ~5°C minimum)
                </p>
                <p>
                  <span className="text-blue-400 font-medium">2. Mixing:</span> Warm return air
                  reduces heating load
                </p>
                <p>
                  <span className="text-blue-400 font-medium">3. Filtration:</span> Standard
                  particulate removal
                </p>
                <p>
                  <span className="text-blue-400 font-medium">4. Main heating:</span> Heating coil
                  raises temperature to supply setpoint
                </p>
                <p>
                  <span className="text-blue-400 font-medium">5. Humidification:</span> Steam or
                  evaporative humidifier adds moisture if required
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="bg-white/5 border border-white/10 rounded-lg p-4">
                ...
                <div className="space-y-1 text-sm text-gray-300">
                  ...
                  <p className="font-mono bg-black/30 px-2 py-1 rounded">
                    ΔT = (P × (1-η)) / (ṁ × cp)
                  </p>
          ...
          <InlineCheck
            ...
            correctAnswer="Reheat raises the supply air temperature after the cooling coil has overcooled the air for dehumidification, allowing precise temperature control while maintaining humidity requirements."
          />
        </section>
        ...
        <section className="space-y-4">
          <div className="flex items-center gap-3">
            <span className="flex items-center justify-center w-8 h-8 rounded-lg bg-blue-500/20 text-blue-400 font-bold">
              2
            </span>
          ...
          <div className="bg-white/5 border border-white/10 rounded-xl p-5 space-y-4">
            <p className="text-gray-300">
              When outdoor air and return air mix in an AHU, the resulting mixed air condition lies
              on a straight line between the two states on the psychrometric chart. The lever rule
              determines the exact position based on the mass flow ratio.
            </p>
            ...
            <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-4">
              ...
              <p className="text-sm text-gray-300 mb-3">
                On the psychrometric chart, the mixed air point M divides the line between outdoor
                air (O) and return air (R) inversely proportional to the mass flows:
              </p>
            ...
            <div className="bg-amber-500/10 border border-amber-500/30 rounded-lg p-4">
              <h4 className="font-semibold text-white mb-3">
                Worked Example: Mixed Air Calculation
              </h4>
              <div className="space-y-2 text-sm text-gray-300">
                <p>
                  <strong>Given:</strong>
                ...
                <p>
                  t_mix = (1.5 × 32 + 4.5 × 24) / 6.0 = (48 + 108) / 6.0 ={' '}
                  <span className="text-green-400 font-medium">26°C</span>
                </p>
                <p>
                  g_mix = (1.5 × 15.5 + 4.5 × 9.4) / 6.0 = (23.25 + 42.3) / 6.0 ={' '}
                  <span className="text-green-400 font-medium">10.9 g/kg</span>
                </p>
                <p>
                  h_mix = (1.5 × 72 + 4.5 × 48) / 6.0 = (108 + 216) / 6.0 ={' '}
                  <span className="text-green-400 font-medium">54 kJ/kg</span>
                </p>
              </div>
            </div>
          ...
          <InlineCheck
            ...
            correctAnswer="Most comfort systems use 15-30% outdoor air, meaning 70-85% is return air. The lever rule positions the mixed point inversely to flow rates, so higher return air flow places the mix point closer to return air conditions."
          />
        </section>
        ...
        <section className="space-y-4">
          <div className="flex items-center gap-3">
            <span className="flex items-center justify-center w-8 h-8 rounded-lg bg-green-500/20 text-green-400 font-bold">
              3
            </span>
          ...
          <div className="bg-white/5 border border-white/10 rounded-xl p-5 space-y-4">
            <p className="text-gray-300">
              Economiser cycles use outdoor air for "free cooling" when ambient conditions are
              favourable, reducing or eliminating mechanical cooling requirements. This is
              particularly effective in temperate climates like the UK where outdoor conditions
              frequently suit direct cooling.
            </p>
              ...
              <div className="space-y-3">
                <div className="bg-black/30 rounded-lg p-3">
                  <p className="text-sm font-medium text-green-400">
                    Temperature-Based Control (Dry Bulb)
                  </p>
                  <p className="text-sm text-gray-300 mt-1">
                    Enable economiser when: t_outdoor {'<'} t_return - 2°C
                  </p>
                  <p className="text-xs text-gray-400 mt-1">
                    Simple but ignores humidity effects. Best for dry climates.
                  </p>
                </div>
                <div className="bg-black/30 rounded-lg p-3">
                  <p className="text-sm font-medium text-green-400">Enthalpy-Based Control</p>
                  <p className="text-sm text-gray-300 mt-1">
                    Enable economiser when: h_outdoor {'<'} h_return
                  </p>
                  <p className="text-xs text-gray-400 mt-1">
                    More accurate, accounts for latent loads. Preferred for humid climates.
                  </p>
                </div>
                <div className="bg-black/30 rounded-lg p-3">
                  <p className="text-sm font-medium text-green-400">
                    Differential Enthalpy with Limits
                  </p>
                  <p className="text-sm text-gray-300 mt-1">
                    Enable when: h_outdoor {'<'} h_return AND t_outdoor {'<'} 24°C AND RH_outdoor{' '}
                    {'<'} 80%
                  </p>
                  <p className="text-xs text-gray-400 mt-1">
                    Prevents issues with sensor drift and extreme conditions.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-4">
              ...
              <ul className="space-y-1 text-sm text-gray-300">
                <li>
                  • High outdoor humidity can increase latent loads even at moderate temperatures
                </li>
                ...
                <li>
                  • Not suitable for spaces with strict humidity control (museums, data centres)
                </li>
              </ul>
            </div>
          </div>
          ...
          <InlineCheck
            ...
            correctAnswer="The UK has variable humidity levels. Enthalpy control accounts for both sensible and latent heat, preventing situations where cool but humid outdoor air increases the total cooling load compared to drier return air."
          />
        </section>
        ...
        <section className="space-y-4">
          <div className="flex items-center gap-3">
            <span className="flex items-center justify-center w-8 h-8 rounded-lg bg-amber-500/20 text-amber-400 font-bold">
              4
            </span>
          ...
          <div className="bg-white/5 border border-white/10 rounded-xl p-5 space-y-4">
            <p className="text-gray-300">
              Reheat systems intentionally overcool air to achieve dehumidification, then reheat to
              the required supply temperature. While energy-intensive, reheat remains essential for
              precise humidity control in many applications.
            </p>
            ...
            <div className="bg-amber-500/10 border border-amber-500/30 rounded-lg p-4">
              ...
              <div className="space-y-2 text-sm text-gray-300">
                <p>
                  <span className="text-amber-400 font-medium">High Latent Loads:</span> Spaces with
                  high occupancy or moisture sources requiring dehumidification beyond sensible
                  cooling needs
                </p>
                <p>
                  <span className="text-amber-400 font-medium">VAV Systems at Part Load:</span> When
                  reduced airflow cannot meet sensible load at normal supply temperature
                </p>
                <p>
                  <span className="text-amber-400 font-medium">Zone Diversity:</span> Different
                  zones requiring different supply temperatures from a central AHU
                </p>
                <p>
                  <span className="text-amber-400 font-medium">Critical Humidity Control:</span>{' '}
                  Laboratories, museums, operating theatres with strict RH requirements
                </p>
              </div>
            </div>
            ...
            <div className="bg-purple-500/10 border border-purple-500/30 rounded-lg p-4">
              ...
              <div className="space-y-3">
                <div className="bg-black/30 rounded-lg p-3">
                  ...
                  <p className="font-mono text-white">
                    Q_reheat = ṁ × cp × (t_supply - t_coil_off)
                  </p>
                </div>
                <div className="text-sm text-gray-300">
                  <p>
                    <strong>Example:</strong> Supply air required at 16°C, cooling coil leaves air
                    at 11°C
                  </p>
                  <p>
                    For 3 kg/s airflow: Q = 3 × 1.0 × (16 - 11) ={' '}
                    <span className="text-green-400 font-medium">15 kW reheat</span>
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-4">
              <h4 className="font-semibold text-white mb-3">
                Energy-Efficient Alternatives to Reheat
              </h4>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                <div className="bg-black/30 rounded-lg p-3">
                  <p className="text-sm font-medium text-green-400">Heat Recovery Reheat</p>
                  <p className="text-xs text-gray-300 mt-1">
                    Use condenser heat or extract air heat via run-around coil to provide reheat
                    energy
                  </p>
                </div>
                <div className="bg-black/30 rounded-lg p-3">
                  ...
                  <p className="text-xs text-gray-300 mt-1">
                    Bypass portion of air around cooling coil to raise mixed supply temperature
                  </p>
                </div>
                <div className="bg-black/30 rounded-lg p-3">
                  <p className="text-sm font-medium text-green-400">Desiccant Systems</p>
                  <p className="text-xs text-gray-300 mt-1">
                    Remove moisture without overcooling, reducing or eliminating reheat need
                  </p>
                </div>
                <div className="bg-black/30 rounded-lg p-3">
                  <p className="text-sm font-medium text-green-400">DOAS + Radiant</p>
                  <p className="text-xs text-gray-300 mt-1">
                    Dedicated system handles latent loads; radiant panels provide sensible cooling
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
              ...
              <div className="space-y-2 text-sm text-gray-300">
                <p>
                  <span className="text-blue-400 font-medium">1. Load Calculation:</span> Determine
                  sensible and latent loads for each zone (CIBSE Guide A)
                </p>
                <p>
                  <span className="text-blue-400 font-medium">2. Airflow Selection:</span> Size for
                  peak sensible load considering supply-room ΔT
                </p>
                <p>
                  <span className="text-blue-400 font-medium">3. Supply Conditions:</span> Plot
                  required supply state on psychrometric chart
                </p>
                <p>
                  <span className="text-blue-400 font-medium">4. Coil Selection:</span> Size cooling
                  coil for total load including outdoor air
                </p>
                <p>
                  <span className="text-blue-400 font-medium">5. Economiser Strategy:</span>{' '}
                  Determine control sequence and sensor requirements
                </p>
                <p>
                  <span className="text-blue-400 font-medium">6. Part Load Analysis:</span> Verify
                  performance at 25%, 50%, 75% load conditions
                </p>
              </div>
            </div>
          ...
          <InlineCheck
            ...
            correctAnswer="Heat recovery reheat uses waste heat from the cooling system's condenser or exhaust air, energy that would otherwise be rejected. Electric or hot water reheat requires additional primary energy input, making the overall system less efficient."
          />
        </section>
          ...
          <div className="bg-white/5 border border-white/10 rounded-xl p-5 space-y-4">
            <div className="bg-purple-500/10 border border-purple-500/30 rounded-lg p-4">
              ...
              <div className="space-y-2 text-sm text-gray-300">
                ...
                <p className="ml-4">
                  ṁ = Q_sensible / (cp × ΔT) = 37.5 / (1.0 × 10) = 3.75 kg/s ≈ 3.2 m³/s
                </p>
                ...
                <p className="ml-4 text-green-400 font-medium">
                  Total: 37.5 + 2.5 + 3.6 + 2.4 = 46 kW cooling coil duty
                </p>
              </div>
            </div>
            ...
            <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
              ...
              <div className="space-y-2 text-sm text-gray-300">
                ...
                <p className="ml-4 text-green-400 font-medium">
                  Annual saving = 8,000 × £0.20 = £1,600/year
                </p>
              </div>
            </div>
          </div>
        ...
        {/* Quiz */}
        <Quiz title="Section 3.6 Knowledge Check" questions={quizQuestions} />
        ...
        <div className="flex justify-between items-center pt-6 border-t border-white/10">
          <Link to="../h-n-c-module2-section3-5">
            <Button
              variant="outline"
              className="border-white/20 text-black bg-white/90 hover:bg-white"
            >
