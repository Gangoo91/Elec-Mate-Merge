...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    question:
      'At what approximate oxygen concentration does fire become unable to sustain combustion?',
    options: [
...
const faqs = [
  ...
  {
    question:
      'How does understanding the fire triangle help with fire prevention in electrical work?',
    answer:
...
const quizQuestions = [
  {
    id: 1,
    question: 'Which of the following is NOT one of the three elements of the fire triangle?',
    options: [
  ...
  {
    id: 5,
    question: 'The fire tetrahedron model includes heat, fuel, oxygen, and which fourth element?',
    options: [
  ...
  {
    id: 7,
    question: 'Which firefighting strategy works by removing the OXYGEN side of the fire triangle?',
    options: [
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-rose-500/5 border-l-2 border-rose-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Fire Triangle:</strong> Heat + Fuel + Oxygen = Fire
              </li>
              <li>
                <strong>Remove one:</strong> The fire cannot start or sustain
              </li>
              <li>
                <strong>Tetrahedron:</strong> Adds the chemical chain reaction as a 4th element
              </li>
              <li>
                <strong>Key insight:</strong> All fire prevention targets at least one side
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-rose-500/5 border-l-2 border-rose-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Heat:</strong> Arcing, overloaded circuits, loose connections
              </li>
              <li>
                <strong>Fuel:</strong> PVC sheathing, timber, insulation, stored materials
              </li>
              <li>
                <strong>Oxygen:</strong> Normal air; enrichment near compressed gases
              </li>
              <li>
                <strong>Prevention:</strong> Correct cable sizing, torquing, AFDDs, firestopping
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The <strong>fire triangle</strong> (also known as the{' '}
                <strong>combustion triangle</strong>) is the most fundamental model in fire science.
                It has been the cornerstone of fire safety training for over a century, and despite
                advances in our understanding of combustion chemistry, it remains the essential
                framework for understanding how fires start, how they sustain themselves, and
                &mdash; critically &mdash; how they can be prevented and extinguished.
              </p>
              ...
              <p>
                <strong>Remove any one of these three elements and the fire cannot exist.</strong>{' '}
                This is not merely an academic principle &mdash; it is the practical basis of every
                fire prevention measure, every firefighting technique, and every fire safety
                regulation in force in the United Kingdom today. When you install a fire barrier to
                prevent flame spread through a cable penetration, you are removing fuel from the
                fire&rsquo;s path. When a fire extinguisher cools a burning surface, it is removing
                heat. When a CO&#8322; extinguisher displaces the air around a fire, it is removing
                oxygen.
              </p>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  ...
                  measure and every firefighting action targets at least one side of the fire
                  triangle. Understanding which side you are addressing &mdash; and which sides
                  remain uncontrolled &mdash; is essential for effective fire safety. A measure that
                  removes the ignition source (heat) is ineffective if another ignition source is
                  introduced later and the fuel and oxygen remain present.
                </p>
              </div>

              <p>
                The fire triangle is not just a theoretical model. It is a practical tool used daily
                by fire risk assessors, fire marshals, firefighters, and building designers across
                the UK. Under the <strong>Regulatory Reform (Fire Safety) Order 2005</strong> (the
                &ldquo;Fire Safety Order&rdquo; or &ldquo;FSO&rdquo;), the responsible person for
                any non-domestic premises must carry out a fire risk assessment. That assessment is
                fundamentally an exercise in examining each side of the fire triangle: what are the
                ignition sources? What are the fuel sources? Where is the oxygen? And are the
                existing control measures sufficient to keep these three elements apart?
              </p>

              <p>
                For electricians and electrical workers, the fire triangle has particular
                significance. Electrical installations are one of the most common sources of fire
                ignition in the United Kingdom. According to Home Office fire statistics, electrical
                faults and misuse of electrical equipment together account for a significant
                proportion of accidental dwelling fires each year. Understanding the fire triangle
                equips you to recognise fire risks in every installation you work on and to take
                practical steps to reduce those risks as part of your everyday work.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  expanded <strong>fire tetrahedron</strong> model, which we shall cover in Section
                  05 of this unit.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The first side of the fire triangle is <strong>heat</strong>. In fire science
                terminology, the heat source is more precisely called the{' '}
                <strong>ignition source</strong> &mdash; it is the energy input that raises a
                combustible material to its ignition temperature, initiating the combustion
                reaction. Without a source of ignition, fuel and oxygen can coexist indefinitely
                without producing fire.
              </p>

              <p>
                Fire risk assessments under the Regulatory Reform (Fire Safety) Order 2005 require
                the responsible person to identify all potential ignition sources in the workplace.
                For construction sites and electrical installations, the range of potential ignition
                sources is wide and varied:
              </p>
                ...
                <div className="space-y-3">
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      deteriorated insulation barrier &mdash; generating temperatures that can
                      exceed 3,000&deg;C.
                      <strong> Overloaded circuits</strong> cause conductors to overheat beyond
                      their rated current-carrying capacity, degrading insulation and potentially
                      igniting surrounding combustible materials. <strong>Loose connections</strong>{' '}
                      create high-resistance joints that generate localised heat, often undetected
                      until insulation failure occurs. <strong>Short circuits</strong> and{' '}
                      <strong>earth faults</strong> can release enormous amounts of energy in
                      fractions of a second.
                      <strong>Tracking</strong> occurs when carbonised pathways form across
                      contaminated insulation surfaces, allowing current to flow where it should
                      not.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      (oxy-acetylene, plasma, disc cutting) produces sparks that can travel several
                      metres.
                  ...
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      ferrous metal (for example, a steel tool dropped onto a steel floor) can
                  ...
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      materials, self-heating of oily rags (due to the oxidation of unsaturated oils
                      such as linseed oil), and the decomposition of certain unstable chemicals. On
                      construction sites, the mixing of incompatible chemicals (such as oxidisers
                      with organic solvents) can produce violent exothermic reactions.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      In electrical work, transformers and high-current busbars can produce
                      significant radiant heat during normal operation.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      This is a particular hazard when handling flammable liquids (fuel filling,
                      solvent use), in environments with combustible dust (grain, flour, wood dust),
                      and when handling plastic films or synthetic materials. Bonding and earthing
                      of equipment and containers is the primary control measure.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      largest cause of fires in non-domestic premises in the UK. Site security,
                      perimeter fencing, removal of combustible waste, and controlled access all
                      contribute to reducing arson risk on construction sites.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  installation. AFDDs are designed to detect dangerous arcing faults &mdash; both
                  series arcs (caused by loose or damaged conductors) and parallel arcs (caused by
                  insulation breakdown) &mdash; and disconnect the circuit before the arc can ignite
                  surrounding materials. They directly address the &ldquo;heat&rdquo; side of the
                  fire triangle by eliminating one of the most dangerous electrical ignition
                  sources. Regulation 421.1.7 recommends AFDDs for locations with sleeping
                  accommodation, premises constructed with combustible materials, locations
                  containing irreplaceable goods, and locations with combustible materials being
                  processed or stored.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The second side of the fire triangle is <strong>fuel</strong>. In fire science, a
                fuel is any material that can undergo combustion &mdash; that is, any substance that
                can react with an oxidising agent (typically oxygen) in an exothermic reaction that
                ...
                <div className="space-y-3">
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      sheathing, trunking, conduit, containment systems, insulation boards,
                      packaging),
                      <strong> rubber</strong> (seals, gaskets, floor coverings), and{' '}
                      <strong>insulation materials</strong> (some foam insulation boards, fibrous
                      insulation if contaminated with combustible substances). Solid fuels generally
                      need to be heated to produce flammable vapours (pyrolysis) before they can
                      ignite. The surface area to mass ratio matters: thin materials and finely
                      divided materials (sawdust, wood shavings, fabric fibres) ignite far more
                      easily than solid blocks of the same material.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      <strong> cable-pulling lubricants</strong> (some formulations are
                      combustible).
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      (liquefied petroleum gas &mdash; propane and butane, heavier than air,
                      commonly used on construction sites for temporary heating and cooking),{' '}
                      <strong>acetylene</strong> (used in oxy-acetylene welding and cutting,
                      extremely flammable with a very wide flammable range), and{' '}
                      <strong>hydrogen</strong> (increasingly encountered as energy systems evolve,
                      extremely flammable with a very wide flammable range and very low ignition
                      energy).
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-3 text-sm text-white/80">
                  <div>
                    ...
                    <p>
                      ...
                      an ignitable mixture with air near its surface. At the flash point, the vapour
                      will ignite momentarily if an external ignition source is applied, but
                      sustained combustion may not occur. The lower the flash point, the more
                      dangerous the liquid at ambient temperatures. Petrol has a flash point of
                      approximately &minus;43&deg;C, meaning it gives off ignitable vapour at all
                  ...
                  <div>
                    ...
                    <p>
                      The lowest temperature at which a substance will ignite spontaneously in
                      normal atmospheric air without any external ignition source (no spark, flame,
                      or hot surface required). The auto-ignition temperature is a property of the
                      substance itself. For example, paper auto-ignites at approximately 233&deg;C,
                      wood at approximately 300&deg;C (varies by species), and petrol vapour at
                      approximately 280&deg;C. This is particularly relevant to electrical work:
                      sustained overheating of a cable can raise the temperature of surrounding
                      materials above their auto-ignition temperature without any spark or arc being
                      necessary.
                    </p>
                  </div>
                </div>
              ...
              <p>
                ...
                component of fire prevention. Under the Dangerous Substances and Explosive
                Atmospheres Regulations 2002 (DSEAR) and the associated Approved Code of Practice,
                employers must identify dangerous substances present in the workplace, carry out a
              ...
              <ul className="space-y-2 text-sm text-white/70">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    Storing flammable liquids in purpose-built, ventilated stores away from ignition
                    sources
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    Separating flammable gas cylinders (LPG, acetylene) from oxygen cylinders by at
                    least 3 metres or a fire-resistant barrier
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    Keeping only minimum working quantities of flammable substances at the point of
                    use
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    Removing combustible waste materials regularly (good housekeeping) to reduce
                    fuel loading
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    Using non-combustible or fire-retardant materials wherever reasonably
                    practicable
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    Installing firestopping where cables, pipes, or ducts penetrate fire-resistant
                    barriers to prevent fire spread through concealed spaces
                  </span>
                </li>
              </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  gas). LSZH (Low Smoke Zero Halogen) cables are specified in certain applications
                  &mdash; particularly escape routes, public buildings, and underground railways
                  &mdash; because they produce significantly less smoke and no halogenated gases
                  when they burn. Understanding that cable sheathing itself is a fuel source is
                  important for electricians: a cable fault that generates sustained heat does not
                  need any other fuel source to start a fire &mdash; the cable&rsquo;s own sheathing
                  and insulation can be the fuel.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                <strong> oxidising agent</strong>. Combustion is an oxidation reaction &mdash; the
                fuel reacts with an oxidiser, releasing energy in the form of heat and light. In the
                vast majority of fire situations, the oxidiser is the oxygen present in normal
                atmospheric air.
              </p>

              <div className="bg-rose-500/10 border border-rose-500/30 p-4 sm:p-6 rounded-lg">
                <p className="text-sm font-medium text-rose-400 mb-4 text-center">
                  Oxygen Concentration &amp; Fire Behaviour
                </p>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <ul className="space-y-2 text-sm text-white/70 mt-3">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Materials that are normally difficult or impossible to ignite can catch fire
                      easily
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-red-400" />
                    <span>
                      The rate of burning increases dramatically &mdash; fires burn hotter, faster,
                      and more fiercely
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
              ...
              <ul className="space-y-2 text-sm text-white/70">
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Compressed oxygen cylinders</strong> &mdash; used in oxy-acetylene
                    welding and cutting, medical applications, and some industrial processes. A
                    leaking regulator or open valve can quickly enrich the surrounding atmosphere
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Piped oxygen systems</strong> &mdash; found in hospitals, laboratories,
                    dental surgeries, and some manufacturing processes. Leaking joints, damaged
                    pipework, or improper maintenance can lead to localised oxygen enrichment
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Oxidising chemicals</strong> &mdash; substances that release oxygen when
                    they decompose or react. Examples include hydrogen peroxide, potassium
                    permanganate, and sodium hypochlorite (bleach). These can sustain combustion
                    even in otherwise oxygen-depleted environments
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Leaking equipment</strong> &mdash; oxygen can leak from damaged hoses,
                    poorly maintained regulators, or cracked fittings on oxy-fuel equipment. Because
                    oxygen is odourless and colourless, leaks can go undetected without atmospheric
                    monitoring
                  </span>
                </li>
              </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  replacing a light fitting or installing a socket outlet &mdash; can become
                  extremely hazardous if the atmosphere is oxygen-enriched due to a nearby leak.
                  Even the small arc produced by operating a light switch can be sufficient to
                  ignite clothing in an oxygen-enriched atmosphere. If you suspect oxygen
                  enrichment, evacuate the area immediately, ventilate the space, and do not operate
                  any electrical equipment until the atmosphere has been tested and confirmed safe.
                </p>
              </div>

              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-rose-400">Critical Safety Rule:</strong> Never use oxygen
                  to &ldquo;freshen&rdquo; the air in a confined or poorly ventilated space. This is
                  a known cause of fatal fires. Oxygen cylinders must only be used for their
                  intended purpose. If a space needs ventilation, use mechanical ventilation with
                  normal atmospheric air. Compressed oxygen must never be used as a substitute for
                  compressed air in any application &mdash; including pneumatic tools, tyre
                  inflation, or dust blowing.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                While the fire triangle is an excellent model for understanding the basic
                requirements of fire, modern fire science has identified a fourth element that is
                necessary for sustained flaming combustion: the{' '}
                <strong>chemical chain reaction</strong>. This expanded model is known as the{' '}
                <strong>fire tetrahedron</strong> (a tetrahedron is a four-sided solid, like a
                pyramid with a triangular base).
              </p>

              <div className="bg-rose-500/10 border border-rose-500/30 p-4 sm:p-6 rounded-lg">
                <p className="text-sm font-medium text-rose-400 mb-4 text-center">
                  The Fire Tetrahedron: Four Elements
                </p>
              ...
              <p>
                The <strong>chemical chain reaction</strong> (more precisely, the{' '}
                <strong>uninhibited free radical chain reaction</strong>) is the self-sustaining
                process that occurs at the molecular level during combustion. When fuel is heated in
                the presence of oxygen, it breaks down into highly reactive molecular fragments
                called <strong>free radicals</strong>. These free radicals react with oxygen and
                with other fuel molecules, producing more free radicals in a branching chain
                reaction. Each reaction releases energy (heat), which sustains the breakdown of more
                fuel molecules, producing more free radicals, and so the cycle continues.
              </p>

              <p>
                For flaming combustion to be sustained, this chain reaction must be uninhibited
                &mdash; that is, the free radicals must be free to react and propagate. If the chain
                reaction is interrupted (by removing or neutralising the free radicals), the
                combustion process collapses even though heat, fuel, and oxygen may still be
                present.
              </p>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  ...
                  mechanism of action of agents that do not primarily work by cooling (removing
                  heat), smothering (removing oxygen), or starvation (removing fuel). These agents
                  work by chemically interrupting the chain reaction &mdash; a mechanism that the
                  fire triangle alone cannot explain.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 sm:p-6 rounded-lg">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <p className="text-sm font-medium text-rose-400">
                    Agents That Interrupt the Chain Reaction
                  </p>
                </div>
                <div className="space-y-3">
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      the flame to release halogen atoms (bromine, fluorine) that react with and
                      neutralise the free radicals sustaining combustion. Halon was banned from
                      general use under the Montreal Protocol due to its severe ozone-depleting
                      properties. It is now only permitted in critical applications where no
                      effective alternative exists (certain military, aviation, and nuclear
                      applications).
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      The fine powder particles decompose in the flame, releasing chemical species
                      that react with and neutralise the free radicals. Dry powder also provides
                      some smothering effect and some cooling effect, but chain reaction
                      interruption is the dominant mechanism. This is why dry powder can suppress
                      fires that are difficult to extinguish by cooling or smothering alone &mdash;
                      including gas fires and certain chemical fires.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    <p className="text-sm font-medium text-white mb-1">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      IG-55/Argonite). Halocarbon agents work partly by chain reaction interruption
                      and partly by heat absorption. Inert gas systems work primarily by oxygen
                      dilution (reducing the oxygen concentration below the level needed to sustain
                      combustion). Clean agent systems are commonly installed to protect electrical
                      and electronic equipment, server rooms, data centres, and telecommunications
                      facilities where water-based suppression would cause unacceptable damage.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  programmes. The fire tetrahedron is used when a more complete understanding of
                  combustion chemistry is required &mdash; for example, when selecting suppression
                  systems, understanding why certain extinguishing agents work on particular fire
                  types, or when studying fire science at a more advanced level. Both models are
                  correct; the tetrahedron is simply more comprehensive.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                decision-making tool. Every fire prevention measure and every firefighting action
                can be understood in terms of which side (or sides) of the triangle it addresses. By
                systematically considering all three sides, you can develop a comprehensive approach
                to fire safety in any environment.
              </p>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 sm:p-6 rounded-lg">
                <p className="text-sm font-medium text-rose-400 mb-4">
                  Firefighting Strategies by Triangle Side
                </p>
                  ...
                  <div className="bg-white/5 border border-white/10 rounded-lg p-4">
                    ...
                    <ul className="space-y-2 text-sm text-white/70">
                      <li className="flex items-start gap-2">
                        ...
                        <span>
                          <strong>Water</strong> &mdash; the most effective cooling agent. Water
                          absorbs enormous amounts of heat as it evaporates (latent heat of
                          vaporisation: 2,260 kJ/kg). Applied as a jet, spray, or mist
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-blue-400" />
                        <span>
                          <strong>Foam</strong> &mdash; cools the fuel surface while also providing
                          an oxygen-excluding blanket
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-blue-400" />
                        <span>
                          <strong>Water mist systems</strong> &mdash; fine water droplets maximise
                          the cooling effect with minimal water volume, reducing water damage
                        </span>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="bg-white/5 border border-white/10 rounded-lg p-4">
                    ...
                    <ul className="space-y-2 text-sm text-white/70">
                      <li className="flex items-start gap-2">
                        ...
                        <span>
                          <strong>Removing combustible materials</strong> from the path of an
                          advancing fire (creating a firebreak)
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-amber-400" />
                        <span>
                          <strong>Shutting off gas supply</strong> to a gas fire (turning off the
                          valve removes the fuel)
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-amber-400" />
                        <span>
                          <strong>Draining flammable liquids</strong> away from the fire area
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-amber-400" />
                        <span>
                          <strong>Fire compartmentation</strong> in buildings (fire-resistant walls,
                          floors, doors, and firestopping) prevents fire spread by isolating fuel
                          into compartments
                        </span>
                      </li>
                    </ul>
                  ...
                  <div className="bg-white/5 border border-white/10 rounded-lg p-4">
                    ...
                    <ul className="space-y-2 text-sm text-white/70">
                      <li className="flex items-start gap-2">
                        ...
                        <span>
                          <strong>Fire blankets</strong> &mdash; physically cover the fire,
                          excluding air. Suitable for small fires, particularly cooking oil fires
                          and clothing fires
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                        <span>
                          <strong>CO&#8322; (carbon dioxide) extinguishers</strong> &mdash; displace
                          oxygen by flooding the area with inert CO&#8322; gas. Particularly
                          suitable for electrical fires as CO&#8322; is non-conductive and leaves no
                          residue
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                        <span>
                          <strong>Foam extinguishers</strong> &mdash; the foam blanket floats on
                          burning liquid surfaces, excluding air (also provides cooling)
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-green-400" />
                        <span>
                          <strong>Inert gas flooding systems</strong> &mdash; fixed systems that
                          flood an enclosed space with inert gas (nitrogen, argon, or mixtures) to
                          reduce oxygen below 16%
                        </span>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="bg-white/5 border border-white/10 rounded-lg p-4">
                    ...
                    <ul className="space-y-2 text-sm text-white/70">
                      <li className="flex items-start gap-2">
                        ...
                        <span>
                          <strong>Dry powder extinguishers</strong> &mdash; the primary mechanism is
                          chain reaction interruption by neutralising free radicals
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-purple-400" />
                        <span>
                          <strong>Clean agent systems</strong> &mdash; halocarbon agents (FM-200,
                          Novec 1230) partially work by chain reaction interruption
                        </span>
                      </li>
                    </ul>
                  </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="space-y-2 text-sm text-white/70">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong>Controlling heat:</strong> Correctly sizing cables for their load
                      current (prevents overheating), torquing terminations to manufacturer
                      specifications (prevents high-resistance joints), installing AFDDs (detects
                      and interrupts arcing faults), regular thermographic inspection (identifies
                      hotspots before they cause fires)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong>Controlling fuel:</strong> Installing firestopping at all cable
                      penetrations through fire-resistant barriers, using LSZH cables in high-risk
                      locations, maintaining separation between electrical equipment and stored
                      combustible materials, good housekeeping in distribution boards and risers
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong>Controlling oxygen:</strong> Being aware of oxygen enrichment risks
                      (compressed gas storage areas, medical facilities), not storing combustible
                      materials near oxygen cylinder stores, ensuring adequate ventilation in
                      enclosed electrical plant rooms
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong>Emergency response:</strong> Knowing which extinguisher to use for an
                      electrical fire (CO&#8322; for live equipment, dry powder as alternative),
                      knowing to isolate the electrical supply before attempting to fight an
                      electrical fire where possible, understanding that water must never be used on
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  ...
                  systematic approach to fire risk is exactly what the Regulatory Reform (Fire
                  Safety) Order 2005 requires of every person who has responsibilities for fire
