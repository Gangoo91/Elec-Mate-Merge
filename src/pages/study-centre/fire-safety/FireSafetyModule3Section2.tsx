...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    question:
      'Which BS 5839 Part 1 category provides full life safety detection coverage throughout all areas?',
    options: ['Category P1', 'Category L3', 'Category L1', 'Category M'],
    correctIndex: 2,
    explanation:
      "Category L1 provides the highest level of life safety protection. It requires automatic fire detection throughout all areas of the building, including roof voids, ceiling voids, and floor voids. L1 is typically specified for sleeping risk premises such as care homes, hospitals, and HMOs (houses in multiple occupation) where early detection in any area is critical to protect life. The 'L' stands for Life safety, and L1 represents full coverage.",
  },
  {
...
const faqs = [
  {
    ...
    answer:
      'Category L2 provides automatic fire detection in escape routes plus any rooms or areas that present a high fire risk or open onto escape routes. It goes beyond just protecting escape routes by also covering specific high-risk areas identified in the fire risk assessment — such as kitchens, plant rooms, or storage areas containing flammable materials. Category L3 provides detection only within escape routes themselves (corridors, stairwells, lobbies) to warn occupants that their escape route may be compromised. L3 does not detect fires in rooms until smoke has spread into the escape route. The choice between L2 and L3 depends on the fire risk assessment: L3 may be adequate where room fires are unlikely to grow quickly, but L2 is required where high-risk areas could produce a fast-developing fire that needs early detection before it reaches the escape route.',
  },
  {
...
export default function FireSafetyModule3Section2() {
  useSEO({
    ...
    description:
      'Conventional, addressable, and analogue-addressable fire detection systems. Detector types, BS 5839 Part 1 categories, design, installation, commissioning, maintenance and testing regimes.',
  });
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-rose-500/5 border-l-2 border-rose-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Early detection</strong> is critical &mdash; smoke fills a room in 2&ndash;3
                minutes
              </li>
              <li>
                <strong>Analogue-addressable</strong> is the industry standard for new installations
              </li>
              <li>
                <strong>BS 5839 Part 1</strong> governs non-domestic fire detection and alarm
                systems
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-rose-500/5 border-l-2 border-rose-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>L1:</strong> Full life safety coverage &mdash; all areas including voids
              </li>
              <li>
                <strong>Weekly test:</strong> Different call point each week, records kept
              </li>
              <li>
                <strong>Fire-resistant cabling:</strong> Mandatory under BS 5839 Part 1
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="bg-white/5 border border-rose-500/30 rounded-xl p-6 sm:p-8">
            ...
            <div className="mt-6 bg-rose-500/10 border border-rose-500/30 rounded-lg p-3 text-center">
              <span className="text-xs sm:text-sm text-rose-300">
                Analogue-addressable systems offer the <strong>lowest false alarm rate</strong> and
                the <strong>best diagnostic capability</strong> &mdash; they are the standard for
                all new non-domestic installations
              </span>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Early detection saves lives. The purpose of a fire detection system is to identify a
                fire at the earliest possible stage and raise an alarm to enable{' '}
                <strong>safe evacuation of occupants</strong>,
                <strong> summoning of the fire service</strong>, and where possible,{' '}
                <strong>intervention to control or extinguish the fire</strong> before it becomes
                unmanageable.
              </p>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  time &mdash; time for occupants to escape, for fire doors to contain the spread,
                  and for the fire service to respond. Without automatic detection, a fire in an
                  unoccupied room may go unnoticed until it has grown beyond control.
                </p>
              </div>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-2">
                  The Detection &rarr; Alarm &rarr; Evacuation Chain
                </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Automatic detection:</strong> Smoke detectors,
                      heat detectors, flame detectors, and aspirating systems that detect fire
                      products without human intervention &mdash; essential for unoccupied areas and
                  ...
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Manual detection:</strong> Manual call points
                      (break glass units) positioned at exits and on escape routes allow anyone
                      discovering a fire to raise the alarm immediately &mdash; every fire alarm
                      system includes manual call points regardless of the level of automatic
                      detection
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-rose-400">The Governing Standard:</strong>{' '}
                  <strong>BS 5839 Part 1</strong> is the code of practice for the design,
                  installation, commissioning, and maintenance of fire detection and fire alarm
                  systems in non-domestic premises. It provides the framework for system categories,
                  detector selection, siting, cabling, and the ongoing testing regime. Compliance
                  with BS 5839 Part 1 is expected by enforcing authorities and insurers.
                </p>
              </div>

              <p>
                Fire detection forms a critical part of the overall <strong>fire strategy</strong>{' '}
                for a building. It works alongside passive fire protection (compartmentation, fire
                doors, fire stopping), active fire suppression (sprinklers), means of escape
                provisions, and the fire risk assessment to create a layered approach to life safety
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Conventional fire alarm systems are the simplest and oldest type of automatic fire
                detection. They divide the building into <strong>zones</strong>, with each zone
                protected by a dedicated two-wire circuit (loop) connecting a group of detectors and
                manual call points in parallel.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Zone circuits:</strong> Each zone has its own
                      pair of conductors running from the control panel. Detectors are connected in
                      parallel across the zone circuit. When any detector activates, the circuit
                      resistance changes, and the panel identifies that zone as being in alarm.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Zone identification only:</strong> The panel
                      displays which zone is in alarm, but cannot identify which specific detector
                      within that zone has activated. Fire wardens must physically search the zone
                      to locate the fire.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Zone plans:</strong> A zone plan (map showing
                      the physical area covered by each zone) must be displayed adjacent to the
                      control panel so that responding personnel can quickly identify where to
                      investigate.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">End-of-line device:</strong> Each zone circuit
                      terminates with an end-of-line resistor that allows the panel to monitor
                      circuit integrity. If a cable is broken (open circuit), the panel registers a
                      fault.
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-rose-400">Practical Note:</strong> Conventional systems
                  are still found in many existing buildings and smaller premises. As an
                  electrician, you must understand how they work for maintenance and modification
                  purposes, even though new installations predominantly use addressable or
                  analogue-addressable technology.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Addressable fire alarm systems represent a significant advancement over conventional
                systems. The key innovation is that{' '}
                <strong>every device on the loop has a unique digital address</strong>, allowing the
                control panel to identify exactly which detector or call point has activated.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Unique addresses:</strong> Each detector, call
                      point, sounder, and module on the loop is programmed with a unique address
                      (typically a number). The control panel continuously polls each device in
                      sequence, checking its status.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Exact device identification:</strong> When a
                      detector activates, the panel displays the specific device address and its
                      programmed location text (e.g. &ldquo;Detector 47 &mdash; 2nd Floor Server
                      Room&rdquo;), allowing immediate identification of the fire location without
                      physical searching.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Loop wiring:</strong> Devices are connected on
                      a loop circuit. A single loop can typically support 100&ndash;250 devices
                      depending on the manufacturer. The loop may be wired as a single path or a
                      dual path (Class A) for enhanced resilience &mdash; if a dual-path loop is
                      broken at any point, all devices remain operational via the alternate path.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Fault identification:</strong> The panel can
                      identify exactly which device has a fault, which device is removed, and the
                      nature of the fault &mdash; dramatically reducing maintenance time compared to
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-rose-400">Key Advantage:</strong> The ability to pinpoint
                  the exact location of a fire or fault means faster response times, more efficient
                  maintenance, and reduced investigation time. For medium to large buildings,
                  addressable systems provide significantly better management of the fire alarm
                  system compared to conventional technology.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Analogue-addressable systems are the most advanced and are now the{' '}
                <strong>industry standard for all new non-domestic fire alarm installations</strong>
                . They build upon the addressable concept by having each detector continuously
                report its <strong>analogue sensing value</strong> to the control panel, rather than
                simply reporting an on/off alarm state.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Continuous analogue reporting:</strong> Each
                      detector sends its analogue value (smoke density percentage, temperature
                      reading) to the panel continuously. The panel &mdash; not the detector &mdash;
                      makes the alarm decision based on sophisticated algorithms.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Algorithm-based thresholds:</strong> The panel
                      analyses trends in the analogue data. A gradual increase in smoke density may
                      indicate a real fire developing, whilst a sudden spike may indicate a
                      transient condition (cooking, steam). The panel can distinguish between these
                      patterns to reduce false alarms.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Pre-alarm warnings:</strong> Before reaching
                      the full alarm threshold, the panel can issue pre-alarm (or
                      &ldquo;advisory&rdquo;) signals. This allows staff to investigate a potential
                      developing situation before it reaches alarm level, potentially preventing
                      false alarms and catching real fires even earlier.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Drift compensation:</strong> As detectors age,
                      dust and contamination build up in the sensing chamber, causing the baseline
                      reading to &ldquo;drift&rdquo; upward. The panel automatically compensates for
                      this drift, maintaining consistent sensitivity. When drift exceeds the
                      compensation range, the panel signals that the detector requires cleaning
                      &mdash; a major maintenance advantage.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Day/night sensitivity:</strong> The panel can
                      be programmed with different alarm thresholds for different times of day. For
                      example, a higher sensitivity (lower threshold) at night when the building is
                      unoccupied, and a lower sensitivity (higher threshold) during the day when
                      cooking or industrial processes may generate background smoke.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  <strong className="text-white"> significantly fewer false alarms</strong> than any
                  other system type. False alarms waste fire service resources, cause alarm fatigue
                  (occupants ignoring alarms), and disrupt business operations. Reducing false
                  alarms is a key priority for building managers, insurers, and the fire service.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Different fire scenarios produce different fire signatures &mdash; some fires
                produce large volumes of visible smoke, others produce primarily heat, and some
                produce flames with little initial smoke. Selecting the correct detector type for
                each environment is critical to ensuring reliable detection whilst minimising false
                alarms.
              </p>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-1.5">
                    ...
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                      <span>
                        Under normal conditions, the light does not reach the photodiode sensor
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                      <span>
                        When smoke enters, particles scatter the light onto the photodiode,
                    ...
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                      <span>
                        Particularly effective at detecting slow-smouldering fires with large
                    ...
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                      <span>
                        <strong className="text-white">Best suited for:</strong> Offices, corridors,
                        bedrooms, storage areas, escape routes
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-1.5">
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        Contain a small{' '}
                        <strong className="text-white">radioactive source (Americium-241)</strong>{' '}
                        that ionises air in the sensing chamber
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    ...
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                      <span>
                        <strong className="text-white">Now rarely used:</strong> Prone to false
                        alarms from cooking, steam, and dust; radioactive disposal issues; less
                        effective for smouldering fires; effectively replaced by optical and
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-1.5">
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                      <span>
                        <strong className="text-white">Fixed temperature:</strong> Activate when the
                        ambient temperature reaches a predetermined threshold (typically 57&deg;C or
                        90&deg;C). Reliable and false-alarm resistant, but slower to respond than
                        smoke detectors.
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                      <span>
                        <strong className="text-white">Rate-of-rise:</strong> Activate when the
                        temperature rises faster than a set rate (typically 8&ndash;10&deg;C per
                        minute), regardless of the absolute temperature. Faster response than fixed
                        temperature for developing fires.
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                      <span>
                        <strong className="text-white">Best suited for:</strong> Kitchens, boiler
                        rooms, garages, workshops, dusty/dirty environments where smoke detectors
                        would false alarm
                      </span>
                    </li>
                  </ul>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-1.5">
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        Combine{' '}
                        <strong className="text-white">optical smoke and heat sensing</strong> in a
                    ...
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                      <span>
                        The combined data provides more reliable detection across a wider range of
                        fire types
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                      <span>
                        Significantly reduces false alarms compared to single-sensor detectors
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                      <span>
                        <strong className="text-white">Increasingly specified</strong> as the
                        default detector type in new analogue-addressable installations
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-2">
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                      <span>
                        <strong className="text-white">Beam detectors:</strong> Use a projected
                        infrared beam between a transmitter and receiver. When smoke obscures the
                        beam, the alarm triggers. Ideal for large open areas with high ceilings
                        (warehouses, atriums, churches) where point detectors would be impractical
                        due to height and access.
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                      <span>
                        <strong className="text-white">Aspirating systems (VESDA):</strong> Very
                        Early Smoke Detection Apparatus. Draws air through a network of sampling
                        pipes into a highly sensitive laser detection chamber. Detects smoke at
                        extremely low concentrations &mdash; used in data centres, server rooms,
                        clean rooms, heritage buildings, and cold stores.
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                      <span>
                        <strong className="text-white">Flame detectors:</strong> Detect the infrared
                        (IR) and/or ultraviolet (UV) radiation emitted by flames. Used in outdoor
                        environments, fuel storage areas, and industrial processes where smoke may
                        be dispersed by wind before reaching a conventional detector.
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                      <span>
                        <strong className="text-white">Linear heat detection:</strong> A
                        heat-sensitive cable that detects temperature rise along its entire length.
                        Used in cable tunnels, conveyor systems, car parks, and areas where the fire
                        location cannot be predicted. The cable can span hundreds of metres,
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-rose-400">Detector Selection:</strong> The choice of
                  detector type for each location must be based on the <strong>environment</strong>{' '}
                  (dusty, steamy, clean, outdoor), the <strong>expected fire type</strong>{' '}
                  (smouldering, flaming, fast-developing), the <strong>ceiling height</strong>, and
                  the <strong>risk of false alarms</strong>. The fire risk assessment and the system
                  designer determine the appropriate detector type for each area.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                BS 5839 Part 1 defines a system of <strong>categories</strong> that describe the
                extent of fire detection coverage in a building. The categories are divided into
                three groups:
                <strong> L (Life safety)</strong>, <strong>P (Property protection)</strong>, and
                <strong> M (Manual only)</strong>. The fire risk assessment determines which
                category is appropriate for a given building.
              </p>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-3">
                  L Categories &mdash; Life Safety
                </p>
                <div className="space-y-3">
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-3">
                  P Categories &mdash; Property Protection
                </p>
                <div className="space-y-3">
                  <div className="bg-amber-500/5 border border-amber-500/20 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white mt-1">
                      ...
                      objective is property rather than life.
                    </p>
                  </div>
                  <div className="bg-amber-500/5 border border-amber-500/20 rounded-lg p-3">
                    <p className="text-sm font-semibold text-amber-300">
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                  ...
                  <p className="text-xs text-white mt-1">
                    ...
                    not required by the risk assessment &mdash; typically small, simple,
                    single-storey premises with good visibility and low fire loading.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-rose-400">How the Category is Determined:</strong> The
                  fire risk assessment (required under the Regulatory Reform (Fire Safety) Order
                  2005) determines the appropriate system category. Factors include the building
                  use, occupancy type (sleeping vs non-sleeping), occupant vulnerability, building
                  size and complexity, escape route design, fire loading, and compartmentation. The
                  responsible person (duty holder) must ensure the system category meets the level
                  identified in the fire risk assessment. Insurers may require higher categories for
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The design and installation of a fire detection system must comply with{' '}
                <strong>BS 5839 Part 1</strong> and the cabling must also comply with{' '}
                <strong>BS 7671</strong> (the IET Wiring Regulations). Correct siting of detectors,
                appropriate cabling, and thorough commissioning are all essential to ensure the
                system performs reliably when needed.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Ceiling mounting:</strong> Detectors should be
                      mounted on the ceiling, as smoke and heat rise and accumulate at the highest
                      point. Wall mounting is only acceptable in specific circumstances and with
                  ...
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Spacing:</strong> Maximum spacing depends on
                      room height and detector type. For flat ceilings up to 10.5m, optical smoke
                      detectors are typically spaced at a maximum of 7.5m centres, giving a maximum
                      coverage area of 100m&sup2; per detector. Higher ceilings require closer
                      spacing or specialist detectors.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Dead spots:</strong> Avoid positioning
                      detectors near corners, junctions of walls and ceilings, or close to beams
                      where air movement is restricted and smoke may not reach the detector. A
                      minimum distance of 500mm from any wall or obstruction is the general rule.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Air movement:</strong> Avoid siting detectors
                      directly adjacent to air conditioning outlets, ventilation diffusers, or
                      extract grilles where air movement may dilute or deflect smoke away from the
                      sensing element.
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Fire-resistant cables:</strong> BS 5839 Part 1
                      requires fire alarm cables to maintain circuit integrity during a fire. This
                      means fire-resistant cable must be used &mdash; either mineral insulated
                      copper cable (MICC) or cables meeting enhanced fire resistance standards (e.g.
                      BS 8434-2 Category 2).
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Cable segregation:</strong> Fire alarm cables
                      must be segregated from mains power cables. Where they must cross, they should
                      do so at right angles. Fire alarm cables should not share trunking, conduit,
                      or containment with mains power unless the containment provides adequate
                      segregation.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Fire stopping:</strong> Where fire alarm cables
                      pass through fire-rated walls, floors, or compartment boundaries, the
                      penetration must be fire-stopped to maintain the fire resistance of the
                      barrier.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Mains supply:</strong> The fire alarm panel
                      must be supplied from a dedicated circuit at the main distribution board,
                      protected by a fuse or MCB that is clearly labelled and provided with a
                      lock-off facility to prevent accidental disconnection.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Functional test:</strong> Every detector, call
                      point, sounder, and interface module is tested individually to confirm it
                      communicates with the panel and is correctly addressed and labelled.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Cause-and-effect testing:</strong> Verifies
                      that every input (detector, call point) produces the correct programmed
                      outputs (sounders, door releases, ventilation shutdown, lift recall,
                      monitoring centre signal). Results are documented in the cause-and-effect
                      matrix.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Sound level verification:</strong> Alarm
                      sounder levels must achieve a minimum of 65 dB(A) throughout the building, or
                      75 dB(A) at bedhead level in sleeping risk premises, exceeding ambient noise
                      by at least 5 dB(A).
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Documentation and handover:</strong>{' '}
                      Comprehensive as-installed drawings, zone plans, cause-and-effect
                      documentation, operating instructions, and a fire alarm log book are handed to
                      the responsible person. Training on system operation is provided.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-rose-400">Handover to Responsible Person:</strong> Upon
                  commissioning, the system is formally handed over to the responsible person (the
                  duty holder under the Regulatory Reform (Fire Safety) Order 2005). From this
                  point, the responsible person is accountable for ensuring the system is
                  maintained, tested, and kept in working order. A commissioning certificate is
                  issued confirming compliance with BS 5839 Part 1.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="text-white space-y-4 leading-relaxed">
                ...
                <div className="space-y-3">
                  <div className="bg-rose-500/5 border border-rose-500/20 rounded-lg p-3">
                    <div className="flex items-start gap-3">
                      <span className="text-xs font-bold text-rose-400 mt-0.5 flex-shrink-0 w-20">
                        Weekly
                      </span>
                      <div className="flex-1">
                        ...
                        <p className="text-xs text-white mt-0.5">
                          ...
                          , rotating through all call points over the course of a year. Confirm the
                          panel receives the signal and sounders activate. Test at a consistent time
                          each week so occupants recognise it as a test. Record the call point
                          tested and the result in the fire alarm log book.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-xs text-white mt-0.5">
                          ...
                          any outstanding faults. Record findings in the log book.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-xs text-white mt-0.5">
                          ...
                          smoke or test heat to each detector and confirming the panel receives the
                          correct signal. Check backup battery condition and charger operation.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-xs text-white mt-0.5">
                          ...
                          all interfaces (door releases, ventilation shutdown, lift recall,
                          monitoring centre) verified. Battery load test. Cable inspection where
                          accessible. Full written report produced.
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  enforcing officers, and insurers. Failure to maintain adequate records is a breach
                  of fire safety legislation and may result in enforcement action, fines, or
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Weekly tests:</strong> Can be carried out by a
                      trained member of staff (the responsible person or their delegate) &mdash;
                      they do not require a specialist fire alarm engineer.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Quarterly and annual maintenance:</strong>{' '}
                      Should be carried out by a{' '}
                      <strong className="text-white">competent fire alarm servicing company</strong>
                      , ideally one certificated by BAFE SP203-1 or an equivalent third-party
                      certification scheme. The engineer should hold relevant qualifications (FIA,
                      EAL, or equivalent).
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Fault rectification:</strong> Any faults
                      identified during testing must be rectified promptly. Critical faults
                      (affecting detection capability) should be treated as urgent. A temporary risk
                      assessment may be needed if the system is impaired whilst repairs are carried
                      out.
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-rose-400">Key Point for Electricians:</strong> As a
                  qualified electrician, understanding the fire alarm maintenance regime is
                  essential whether you are carrying out the maintenance yourself (with appropriate
                  fire alarm qualifications) or coordinating with specialist fire alarm engineers.
                  Never isolate or disable any part of a fire alarm system without following the
                  site&rsquo;s impairment procedure, informing the responsible person, and
                  implementing alternative fire safety measures for the duration.
                </p>
              </div>
            </div>
          </div>
                ...
                <tbody className="text-white">
                  ...
                  <tr className="border-b border-white/5">
                    ...
                    <td className="py-2 pr-3">
                      25% of detectors functionally tested, battery check
                    </td>
                  ...
                  <tr>
                    ...
                    <td className="py-2 pr-3">
                      All detectors tested, full system check, written report
                    </td>
                    <td className="py-2">Competent fire alarm engineer</td>
                  </tr>
                </tbody>
