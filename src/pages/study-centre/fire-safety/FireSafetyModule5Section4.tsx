...
const quizQuestions = [
  ...
  {
    id: 2,
    question: 'When must the insurer be notified after a fire?',
    options: [
  ...
  {
    id: 4,
    question: 'What standard must the electrical installation be re-certified to after a fire?',
    options: ['BS 5839', 'BS 7671 (IET Wiring Regulations)', 'BS 5266', 'BS 9999'],
    correctAnswer: 1,
    explanation:
  ...
  {
    id: 8,
    question: "What is meant by 'chain of custody' in relation to fire investigation evidence?",
    options: [
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-rose-500/5 border-l-2 border-rose-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Welfare first:</strong> Account for all persons, shelter, first aid
              </li>
              <li>
                <strong>Scene preservation:</strong> Cordon, guard, do not disturb evidence
              </li>
              <li>
                <strong>Notify insurer:</strong> Immediately, as per policy conditions
              </li>
              <li>
                <strong>Review FRA:</strong> Mandatory after any fire incident
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-rose-500/5 border-l-2 border-rose-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>RRFSO:</strong> Mandatory FRA review after fire
              </li>
              <li>
                <strong>BS 7671:</strong> Electrical re-certification
              </li>
              <li>
                <strong>BS 5839:</strong> Fire alarm reinstatement
              </li>
              <li>
                <strong>BS 5266:</strong> Emergency lighting restoration
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The period immediately following a fire is critical. Even after the fire itself has
                been extinguished, there are significant hazards and urgent responsibilities that
                the <strong>responsible person</strong> and their team must address. The first
                minutes and hours after an incident set the tone for the entire recovery process and
                can have lasting legal, financial, and human consequences.
              </p>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 sm:p-6 rounded-lg">
                ...
                <ul className="space-y-2 text-sm text-white">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong>Establishing a cordon</strong> around the affected area using barrier
                      tape, fencing, or other physical barriers to prevent unauthorised access
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong>Posting guards</strong> at entry points to ensure no one enters the
                      cordoned area without authorisation from the fire investigation officer
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong>Preventing re-entry</strong> to the building or affected area until
                      the fire service has given an explicit all-clear &mdash; this is essential for
                      safety (structural instability, toxic gases, re-ignition risk) and for
                  ...
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong>Isolating utilities</strong> &mdash; ensuring gas, electricity, and
                      water supplies are isolated where necessary to prevent secondary hazards
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 sm:p-6 rounded-lg">
                ...
                <ul className="space-y-2 text-sm text-white">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong>Accounting for all persons</strong> &mdash; a thorough roll call must
                      be conducted at the assembly point, cross-referenced with signing-in records,
                      visitor logs, and contractor registers
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong>Shelter from weather</strong> &mdash; in cold, wet, or extreme
                      conditions, evacuees may need to be moved to a nearby sheltered location such
                      as a neighbouring building, community hall, or temporary structure
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong>First aid</strong> &mdash; immediate medical attention for any
                      injuries, burns, or smoke inhalation; paramedic services should be requested
                  ...
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong>Emotional support</strong> &mdash; a fire can be a traumatic
                      experience; trained first aiders and managers should provide immediate
                  ...
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong>Communication</strong> &mdash; evacuees need information about what
                      has happened, what is being done, and when they can expect updates; they also
                      need to be able to contact family members
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  particular concern, the location of hazardous materials, and any structural
                  concerns known before the fire. This communication should be clear, factual, and
                  ongoing throughout the incident response phase. A single point of contact should
                  be established to avoid conflicting information being given to different emergency
                  service personnel.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Scene preservation is one of the most important post-incident responsibilities. The
                fire scene is, in effect, a <strong>crime scene</strong> until the cause of the fire
                has been determined. Even if arson is not suspected, the scene must be treated with
                the same rigour, because the investigation may reveal evidence of criminal activity,
                negligence, or regulatory breaches that were not initially apparent.
              </p>
                ...
                <div className="space-y-3">
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white leading-relaxed">
                      ...
                      authorise. No employee, manager, or building owner should enter the scene
                      without explicit authorisation from the investigating officer.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white leading-relaxed">
                      ...
                      insignificant debris to a layperson may be a critical piece of evidence to an
                      investigator &mdash; for example, the remains of an electrical fitting at the
                      point of origin, or residues of accelerant.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white leading-relaxed">
                      ...
                      from multiple angles. These images form part of the evidence base for
                      insurance claims and may be required in legal proceedings. Date-stamped
                      photographs with a scale reference are best practice.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white leading-relaxed">
                      ...
                      broken chain of custody can render evidence inadmissible in court. Evidence
                      bags must be sealed, labelled, and stored securely. The chain of custody
                      record accompanies the evidence throughout its lifecycle.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  whether criminal activity is suspected, and the extent of the damage. For a minor
                  incident, this may be a matter of hours. For a serious fire, particularly one
                  involving fatalities or suspected arson, the scene may be held for days or weeks.
                  The fire investigation officer will issue a formal scene release notice when their
        ...
        <section className="mb-10">
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Effective liaison with the fire and rescue service is essential both during and
                after a fire incident. The responsible person (or their nominated representative)
                serves as the primary point of contact, and the quality of information provided can
                significantly affect the outcome of the incident response and subsequent
                investigation.
              </p>
                  ...
                  {[
                    {
                      ...
                      desc: 'Floor plans showing layout, fire compartments, escape routes, and structural features',
                    },
                    {
                      label: 'Hazardous materials',
                      desc: 'Location and type of any hazardous substances stored on the premises (COSHH data)',
                    },
                    {
                      label: 'Key holder access',
                      desc: 'Details of key holders for locked areas, security codes, and access procedures',
                    },
                    {
                      label: 'Utility isolation points',
                      desc: 'Location of gas, electricity, and water shut-off points and any specialist systems',
                    },
                    {
                      label: 'Occupancy information',
                      desc: 'Number of persons normally present, shift patterns, and any unaccounted individuals',
                    },
                    {
                      label: 'Fire protection systems',
                      desc: 'Location and type of fire alarm panels, sprinkler controls, suppression systems, and risers',
                    },
                  ].map((item, i) => (
              ...
              <p>
                Following the initial emergency response, the fire service will conduct a{' '}
                <strong>fire investigation</strong> to determine the cause and origin of the fire.
                The responsible person should cooperate fully with this investigation, providing
                access to records, maintenance logs, fire risk assessments, and any other
              ...
              <ul className="space-y-2 text-sm text-white">
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Structural engineer assessment</strong> &mdash; the fire service may
                    request a structural engineer to assess the building's stability before
                    firefighters can enter or continue operations. The responsible person should
                    have a structural engineer on retainer or access to one through the insurer
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Post-investigation debriefing</strong> &mdash; once the investigation is
                    complete, the fire service may offer a debrief to the responsible person,
                    explaining the findings and any recommendations. This is a valuable learning
                    opportunity
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Fire investigation report</strong> &mdash; the fire service will produce
                    a report on the cause and origin of the fire. This report may be shared with the
                    responsible person and will be essential evidence for insurance claims and any
                    legal proceedings
                  </span>
                </li>
              </ul>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Insurance is a critical element of post-incident recovery. The relationship between
                the policyholder and the insurer is governed by the terms and conditions of the
                insurance policy, and{' '}
                <strong>
                  failure to comply with policy conditions can jeopardise or void the entire claim
                </strong>
                . The responsible person must understand and follow the notification and claims
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 sm:p-6 rounded-lg">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <p className="text-sm font-medium text-rose-400">
                    Insurer Notification &amp; Claims Process
                  </p>
                </div>
                <div className="space-y-3">
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white leading-relaxed">
                      ...
                      day as the fire. Failure to notify promptly can give the insurer grounds to
                      refuse the claim entirely. The notification should include the date, time, and
                      location, a brief description of the incident, the emergency services
                      involved, and any immediate actions taken.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white leading-relaxed">
                      ...
                      claim against the policy terms, and agree the settlement amount. The
                      policyholder may also appoint their own loss assessor to act on their behalf,
                      particularly for large or complex claims.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white leading-relaxed">
                      ...
                      their approximate values, copies of purchase receipts or invoices where
                      available, records of any temporary measures taken (boarding-up,
                      weatherproofing, emergency repairs), and expert reports (structural engineer,
                      electrical contractor, fire alarm specialist).
                    </p>
                  </div>
                </div>
              </div>
              ...
              <ul className="space-y-2 text-sm text-white">
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Interim measures</strong> &mdash; the insurer will typically authorise
                    emergency interim measures such as boarding-up openings, temporary
                    weatherproofing, emergency power supply, and security guarding. These costs are
                    usually covered by the policy, but authorisation should be obtained before
                ...
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Business continuity</strong> &mdash; business interruption insurance
                    covers the loss of income and additional costs incurred while the business is
                    unable to operate normally. The loss adjuster will assess the business
                    interruption claim separately from the property damage claim
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Salvage operations</strong> &mdash; where possible, damaged stock,
                    equipment, and materials should be salvaged rather than disposed of. The insurer
                    will want to inspect salvageable items before disposal, as their residual value
                    affects the claim settlement. Premature disposal of items can reduce the claim
                    amount
                  </span>
                </li>
              </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  post-incident condition until inspected, not admitting liability to any third
                  party, providing full and accurate information, and allowing the insurer access to
                  the premises. Breach of any condition precedent can entitle the insurer to refuse
                  the claim, regardless of the merits of the loss itself. It is strongly recommended
                  that the responsible person familiarises themselves with these conditions{' '}
                  <em>before</em> an incident occurs.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Reinstatement &mdash; the process of restoring the building and its systems to a
                safe, functional condition &mdash; is a complex, multi-phase undertaking that
                requires careful planning, coordination, and professional expertise. Reinstatement
                cannot begin until the fire investigation officer has released the scene and the
                insurer's loss adjuster has completed their initial assessment.
              </p>
                ...
                <div className="space-y-3">
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white leading-relaxed">
                      ...
                      (explosive surface flaking due to moisture within the concrete), crack
                      masonry, and compromise foundations. The structural assessment will determine
                      whether the building can be repaired or whether partial or complete demolition
                      is required. This assessment is essential before anyone enters the building
                  ...
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white leading-relaxed">
                      ...
                      operations causes immediate damage to electrical systems, plaster, timber, and
                      furnishings, and creates long-term risks of mould growth. Professional
                      remediation involves: initial decontamination and deodorisation, removal of
                      water-damaged materials (plasterboard, insulation, carpet), industrial drying
                      using dehumidifiers and air movers, and mould treatment if necessary.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    <p className="text-sm font-medium text-white mb-1">
                    ...
                    <p className="text-xs text-white leading-relaxed">
                      ...
                      without visible damage, and water ingress causes corrosion and insulation
                      breakdown. A competent electrician must carry out full inspection and testing
                      including: insulation resistance tests, earth fault loop impedance tests, RCD
                      tests, continuity of protective conductors, and polarity checks. All damaged
                      or degraded components must be replaced. An Electrical Installation
                      Certificate (EIC) or Electrical Installation Condition Report (EICR) must be
                      issued.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white leading-relaxed">
                      ...
                      be recommissioned and a commissioning certificate issued. If the fire revealed
                      deficiencies in the detection coverage or alarm audibility, the system should
                      be upgraded as part of the reinstatement. Cause and effect programming must be
                      verified to ensure all devices operate correctly.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    <p className="text-sm font-medium text-white mb-1">
                    ...
                    <p className="text-xs text-white leading-relaxed">
                      ...
                      performance). The system must provide the required illumination levels on
                      escape routes (minimum 1 lux at floor level) and in open areas (minimum 0.5
                      lux). A full 3-hour duration test must be conducted after reinstatement.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white leading-relaxed">
                      ...
                      certified, fire protection systems (alarm, detection, emergency lighting,
                      signage, extinguishers) are in place and tested, escape routes are clear and
                      compliant, and the fire risk assessment has been updated. A formal handover
                      meeting should be held with all stakeholders before re-occupation commences.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Under the <strong>Regulatory Reform (Fire Safety) Order 2005</strong>, the fire risk
                assessment must be reviewed after any fire incident. This is not discretionary
                &mdash; it is a <strong>mandatory legal requirement</strong>. A fire incident is
                definitive evidence that the existing control measures were insufficient to prevent
                the fire from occurring or from developing to the extent that it did.
              </p>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 sm:p-6 rounded-lg">
                ...
                <div className="space-y-3">
                  {[
                    {
                      label: 'Identifying what failed',
                      desc: 'Systematically analyse which control measures failed or were inadequate. Did the fire start because of a hazard that was not identified? Did the detection system respond quickly enough? Did compartmentation hold? Were evacuation procedures effective?',
                    },
                    {
                      label: 'Updating the hazard register',
                      desc: 'Add any new hazards identified as a result of the fire. Update the risk ratings for existing hazards based on the evidence from the incident. Remove any hazards that no longer exist due to changes made during reinstatement.',
                    },
                    {
                      label: 'Revising control measures',
                      desc: 'For every inadequacy identified, specify new or improved control measures. These might include: additional detection, upgraded compartmentation, improved housekeeping procedures, additional training, revised evacuation procedures, or new equipment.',
                    },
                    {
                      label: 'Action plan with timescales',
                      desc: 'Each revised control measure must have a clear action plan: what needs to be done, who is responsible, the timescale for completion, and how completion will be verified. High-priority actions should have short timescales; lower-priority improvements can be programmed over a longer period.',
                    },
                    {
                      label: 'Communicating changes',
                      desc: 'All changes to the fire risk assessment and emergency procedures must be communicated to every person affected. This includes staff, contractors, visitors (through updated signage and induction), and any other relevant persons. Training may be required on revised procedures.',
                    },
                  ].map((item, i) => (
                    <div key={i} className="bg-white/5 border border-white/10 rounded-lg p-3">
                      <p className="text-sm font-medium text-white">{item.label}</p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  was carried out by an external fire risk assessor, they should be engaged to
                  conduct the post-incident review. The reviewer should have access to the fire
                  investigation report, the incident records, and any recommendations made by the
                  fire service. In complex cases, it may be appropriate to engage a specialist fire
                  safety consultant or engineer.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The fire risk assessment review will almost certainly result in changes to the{' '}
                <strong>emergency plan</strong>. The emergency plan is a living document that must
                be updated whenever circumstances change, and a fire incident is one of the most
                compelling reasons for a thorough review and revision.
              </p>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 sm:p-6 rounded-lg">
                ...
                <ul className="space-y-3 text-sm text-white">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong>Revised evacuation procedures</strong> &mdash; if the fire revealed
                      weaknesses in the evacuation procedure (slow response times, confusion about
                      routes, congestion at exits), the procedure must be revised. This may involve
                      changing evacuation routes, adding additional exits, modifying the alarm
                      system, or changing the evacuation strategy entirely
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong>Additional training requirements</strong> &mdash; the incident may
                      have revealed gaps in staff knowledge or competence. Additional training
                      should be identified and delivered, including: fire marshal refresher
                      training, updated induction for new starters, specific training on revised
                      procedures, and practical training on any new equipment
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong>Equipment replacement or upgrade</strong> &mdash; damaged fire safety
                      equipment must be replaced, but the incident review may also identify
                      opportunities for improvement. For example, upgrading from a conventional to
                      an addressable fire alarm system, adding additional extinguishers, installing
                      sprinklers, or providing evacuation chairs
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong>Assembly point review</strong> &mdash; was the assembly point
                      appropriate? Was it far enough from the building? Did it become congested? Was
                      there adequate shelter? Could the roll call be conducted effectively? If the
                      assembly point was found wanting, an alternative must be identified
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong>Communication improvements</strong> &mdash; the incident may have
                      revealed communication failures: fire marshals unable to communicate with each
                      other, the control point lacking information about the developing situation,
                      evacuees not receiving timely updates. Solutions may include two-way radios
                      for fire marshals, a dedicated incident communication channel, improved public
                      address systems, or digital communication tools
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  revised procedures and verify that they work as intended. The drill results should
                  be carefully evaluated and any further adjustments made before the procedures are
                  considered finalised. Staff confidence in the revised procedures is important for
                  their effectiveness, and a well-run drill helps build that confidence.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The psychological impact of a fire can be profound and long-lasting, affecting not
                only those who were directly involved but also witnesses, colleagues, and even
                family members. Employers have a <strong>legal duty of care</strong> under the
                Health and Safety at Work etc. Act 1974 and the Management of Health and Safety at
                Work Regulations 1999 to protect the mental health and wellbeing of their employees,
                and this duty extends to the aftermath of a traumatic incident.
              </p>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 sm:p-6 rounded-lg">
                ...
                <div className="grid sm:grid-cols-2 gap-3">
                  {[
                    {
                      label: 'Acute stress reactions',
                      desc: 'Anxiety, confusion, difficulty concentrating, sleep disturbance, irritability, and hypervigilance in the hours and days following the incident',
                    },
                    {
                      label: 'Avoidance behaviour',
                      desc: 'Reluctance to return to the workplace, particularly to the area where the fire occurred; avoidance of fire safety activities such as drills',
                    },
                    {
                      label: 'Flashbacks and intrusion',
                      desc: 'Involuntary, vivid recollections of the fire, triggered by sensory stimuli such as smoke smell, alarms, or visual cues similar to the incident',
                    },
                    {
                      label: 'Physical symptoms',
                      desc: 'Headaches, fatigue, nausea, muscle tension, and other somatic complaints that may be stress-related rather than directly caused by the fire',
                    },
                  ].map((item, i) => (
                    <div key={i} className="bg-white/5 border border-white/10 rounded-lg p-3">
                      <p className="text-sm font-medium text-white">{item.label}</p>
                ...
                <div className="space-y-3">
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white leading-relaxed">
                      ...
                      they felt, and what they are experiencing. The debrief should be led by a
                      trained facilitator (occupational health professional, counsellor, or
                      specially trained manager) and should normalise the range of reactions people
                      may be experiencing. Participation should be encouraged but not mandatory.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    <p className="text-sm font-medium text-white mb-1">
                    ...
                    <p className="text-xs text-white leading-relaxed">
                      ...
                      actively communicated to all staff &mdash; not just mentioned in passing, but
                      proactively promoted with clear information about how to access the service.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white leading-relaxed">
                      ...
                      with a manager, and flexibility to attend counselling appointments. Managers
                      should be trained to recognise signs that an employee is struggling and to
                      respond sensitively.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white leading-relaxed">
                      ...
                      among managers and colleagues, ongoing access to counselling services, and
                      referral to occupational health or specialist mental health services if
                      symptoms persist or worsen. Early intervention significantly improves
                      outcomes.
                    </p>
                  </div>
                </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  &mdash; and "health" includes mental health. The Management of Health and Safety
                  at Work Regulations 1999 require employers to assess risks to health, including
                  psychological risks. Failure to provide adequate support after a traumatic
                  incident could result in civil claims for negligence, constructive dismissal
                  claims, and regulatory enforcement action. The cost of providing proactive support
                  is a fraction of the cost of defending such claims and replacing experienced staff
                  lost to stress-related absence.
                </p>
              </div>
            </div>
          </div>
