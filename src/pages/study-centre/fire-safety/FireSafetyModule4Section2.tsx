...
const quickCheckQuestions = [
  {
    ...
    options: ['9 metres', '18 metres', '25 metres', '45 metres'],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    question: 'Which evacuation strategy is most commonly used in hospitals and care homes?',
    options: [
...
const faqs = [
  ...
  {
    question: 'Has the stay-put (defend-in-place) strategy changed since the Grenfell Tower fire?',
    answer:
  ...
  {
    question: 'In which direction must doors on escape routes open, and are there exceptions?',
    answer:
  ...
  {
    question: 'Can lifts be used for evacuation during a fire?',
    answer:
...
const quizQuestions = [
  ...
  {
    id: 4,
    question: 'Which of the following must be recorded following a fire drill?',
    options: [
  ...
  {
    id: 6,
    question: 'In which direction must doors on escape routes open?',
    options: [
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <header className="text-center mb-12">
          ...
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-rose-500/10 border border-rose-500/20 mb-3 mx-auto">
            <span className="text-rose-500 text-xs font-semibold">MODULE 4 &middot; SECTION 2</span>
          </div>
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-rose-500/5 border-l-2 border-rose-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Strategies:</strong> Simultaneous, phased, progressive horizontal,
                defend-in-place
              </li>
              <li>
                <strong>Travel distances:</strong> 18m (high risk, single direction) to 45m (low
                risk with sprinklers)
              </li>
              <li>
                <strong>Fire drills:</strong> Minimum annually, 6-monthly recommended
              </li>
              <li>
                <strong>Disability:</strong> PEEPs and GEEPs required under Equality Act 2010
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-rose-500/5 border-l-2 border-rose-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              ...
              <li>
                <strong>Doors:</strong> Must open in direction of escape with panic hardware
              </li>
              <li>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The choice of evacuation strategy is one of the most important decisions in fire
                safety planning. It determines how occupants will be moved to safety in the event of
                a fire and directly influences the design of the fire alarm system, the building
                layout, and the level of structural fire protection required. There are{' '}
                <strong>four principal evacuation strategies</strong> recognised in UK fire safety
                guidance.
              </p>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-rose-400 mb-3">The Four Main Strategies</p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Building type and use</strong> &mdash; offices,
                      hospitals, residential, retail, industrial, or mixed-use
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Occupancy profile</strong> &mdash; ambulant vs
                      non-ambulant, sleeping vs awake, familiar vs unfamiliar with the building
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Building height and number of floors</strong>{' '}
                      &mdash; tall buildings require different strategies to low-rise premises
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Fire detection and alarm system</strong>{' '}
                      &mdash; simultaneous requires a simple system, phased requires an addressable
                      zoned system
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      compartmentation standards, fire door ratings, and protected stairways
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Simultaneous evacuation is the <strong>most common evacuation strategy</strong> in
                the UK. On hearing the fire alarm,{' '}
                <strong>all occupants leave the building immediately</strong> via the nearest
                available escape route and proceed to the designated assembly point. It is simple to
                understand, simple to manage, and requires the least sophisticated fire alarm
                system.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Alarm type:</strong> Single-stage continuous
                      sounder throughout the building &mdash; one alarm signal means &ldquo;evacuate
                      now&rdquo;
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Suitable for:</strong> Small to medium premises
                      &mdash; offices, shops, restaurants, warehouses, workshops, schools
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Target time:</strong> The building should be
                      fully evacuated within{' '}
                      <strong className="text-white">2.5 to 3 minutes</strong> of the alarm sounding
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Simplicity:</strong> No need for phased
                      sounders, zone panels, or voice alarm systems &mdash; a conventional fire
                  ...
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Limitation:</strong> Not suitable for very
                      large or tall buildings where stairways would become overcrowded if all floors
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-rose-500">Fire Marshal Role:</strong> During a
                  simultaneous evacuation, fire marshals on each floor or area carry out a sweep of
                  their zone to confirm that all occupants have left, check that fire doors are
                  closed, and report to the assembly point. They do not investigate the fire &mdash;
                  their role is to facilitate a swift and orderly evacuation and account for all
          ...
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                <strong>taller buildings</strong> where simultaneous evacuation would overwhelm the
                stairways. Instead of evacuating the entire building at once, the{' '}
                <strong>fire floor is evacuated first</strong>, followed by adjacent floors, and
                then the remainder of the building in a controlled sequence.
              </p>
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      system must be able to identify the zone or floor of origin and control alarm
                      signals independently on different floors
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Two-stage alarm:</strong> The first stage is an{' '}
                      <strong className="text-white">alert signal</strong> (intermittent tone or
                      voice message) on the fire floor and the floor above, telling occupants to
                      prepare to leave. The second stage is the{' '}
                      <strong className="text-white">evacuate signal</strong> (continuous tone or
                      voice command) instructing those floors to evacuate via the stairs
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Voice alarm recommended:</strong> Voice alarm
                      systems (BS 5839 Part 8) are strongly recommended because they can deliver
                      specific instructions to each zone, reducing confusion and improving response
                      times
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Compartmentation:</strong> A minimum of{' '}
                      <strong className="text-white">60 minutes&rsquo; fire resistance</strong> is
                      required for the floor structures and compartment walls to allow occupants on
                      non-fire floors to remain safely in place while the fire floor evacuates
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Protected stairways:</strong> Stairways must be
                      enclosed in fire-resisting construction and kept clear of smoke by appropriate
                      ventilation or smoke control measures
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-2">
                  {[
                    {
                      phase: 'Phase 1',
                      desc: 'Fire floor &mdash; immediate evacuation on alert signal',
                    },
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-rose-500">Critical Point:</strong> If the fire is not
                  controlled or the compartmentation is breached, the phased evacuation must
                  escalate to a full simultaneous evacuation. The fire alarm system must have the
                  capability to switch from phased to simultaneous mode, and all fire marshals and
                  management must be trained in the escalation procedure.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                <strong>vertical evacuation via stairs is difficult or impossible</strong> for a
                significant proportion of occupants, or where the building design relies on robust
                compartmentation to protect occupants in place.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">How it works:</strong> Occupants are moved{' '}
                      <strong className="text-white">horizontally through fire doors</strong> into
                      an adjacent fire compartment on the{' '}
                      <strong className="text-white">same floor</strong>, away from the fire. They
                      do not use stairs unless absolutely necessary.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Common in:</strong> Hospitals, care homes,
                      nursing homes, and premises with non-ambulant occupants who cannot use stairs
                      independently
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Compartmentation:</strong> Each compartment
                      must provide a minimum of{' '}
                      <strong className="text-white">60 minutes&rsquo; fire resistance</strong> and
                      must have its own independent escape route for further evacuation if the fire
                      spreads
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Staff training:</strong> Staff must be trained
                      to move patients and residents quickly and safely, including the use of
                      evacuation sheets, ski pads, and other transfer aids
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Vertical evacuation as last resort:</strong>{' '}
                      Full vertical evacuation is only initiated if the fire is not contained and
                      the adjacent compartment is also compromised
                    </span>
                  </li>
                </ul>
              </div>
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      <strong className="text-white">remain in their own compartment</strong> (flat,
                      room, or dwelling) unless the fire directly affects their compartment or they
                      are instructed to leave by the fire service
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Common in:</strong> Purpose-built blocks of
                      flats with robust compartmentation between individual dwellings
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Relies on:</strong> Effective compartmentation
                      (walls, floors, fire doors, and service penetration seals) containing the fire
                      to the flat of origin while the fire service extinguishes it
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Fire alarm:</strong> In many stay-put
                      buildings, the fire alarm only sounds in the common areas and the flat of
                      origin &mdash; there is no building-wide alarm
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  stay-put strategy relied upon. The Grenfell Tower Inquiry recommended that all
                  high-rise residential buildings must have a clear{' '}
                  <strong className="text-white">
                    trigger point for switching from stay-put to full evacuation
                  </strong>
                  , an effective <strong className="text-white">evacuation alert system</strong> to
                  communicate the change of strategy to all residents, and a{' '}
                  <strong className="text-white">building evacuation plan</strong> that is regularly
                  reviewed and tested. The{' '}
                  <strong className="text-white">Fire Safety Act 2021</strong> and the{' '}
                  <strong className="text-white">Building Safety Act 2022</strong> implemented many
                  of these recommendations into law.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                <strong>RRFSO Article 14</strong> requires the responsible person to ensure that
                routes to emergency exits and the exits themselves are kept clear at all times.
                Escape routes must be <strong>adequate for the number of persons</strong> likely to
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="overflow-x-auto -mx-2 px-2">
                  <div className="space-y-2 min-w-[280px]">
                    {[
                      {
                        risk: 'High risk &mdash; single direction',
                        dist: '18 m',
                        sprinkler: '27 m',
                      },
                      {
                        risk: 'High risk &mdash; alternative routes',
                        dist: '25 m',
                        sprinkler: '32 m',
                      },
                      {
                        risk: 'Normal risk &mdash; single direction',
                        dist: '25 m',
                        sprinkler: '32 m',
                      },
                      {
                        risk: 'Normal risk &mdash; alternative routes',
                        dist: '35 m',
                        sprinkler: '45 m',
                      },
                      {
                        risk: 'Low risk &mdash; single direction',
                        dist: '32 m',
                        sprinkler: '40 m',
                      },
                      {
                        risk: 'Low risk &mdash; alternative routes',
                        dist: '45 m',
                        sprinkler: '60 m*',
                      },
                    ].map((row, i) => (
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Minimum 750 mm:</strong> For routes serving
                      very small numbers of persons (fewer than 60 in certain circumstances)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Minimum 850 mm:</strong> Standard baseline for
                      most escape routes serving up to approximately 220 persons
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Minimum 1050 mm:</strong> For routes serving
                      more than 220 persons
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Width calculation:</strong> The total escape
                      width must be calculated based on the maximum number of occupants, and the
                      widest single exit must be discounted (to account for one exit being blocked
                      by fire)
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Direction:</strong> Doors on escape routes must
                      open <strong className="text-white">in the direction of escape</strong>{' '}
                      (outward towards the final exit). This prevents a crowd pressing against a
                      door from being unable to open it.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Panic hardware:</strong> Push-bars or
                      touch-bars complying with <strong className="text-white">BS EN 1125</strong>{' '}
                      (panic exit devices) must be fitted to doors on escape routes in premises open
                      to the public. BS EN 179 covers emergency exit devices for premises where
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      doors must be openable without a key, without special knowledge, and with a
                      single action (one hand, one movement)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      ...
                      <strong className="text-white">and</strong> on failure of the power supply
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                <strong>RRFSO Article 15</strong> requires the responsible person to establish and,
                where necessary, give effect to appropriate procedures, including safety drills, to
                be followed in the event of serious and imminent danger. Fire drills test the
                effectiveness of the evacuation plan and identify any weaknesses that need to be
                addressed.
              </p>
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      <strong className="text-white">annually</strong>. Government guidance
                      recommends <strong className="text-white">6-monthly</strong> drills as best
                  ...
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Shift coverage:</strong> In premises with shift
                      patterns, drills must be scheduled so that all shifts are covered over the
                      course of a year
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">New starters:</strong> Fire safety induction
                      must be given on the first day of employment, and new starters should
                      participate in the next scheduled fire drill
                    </span>
                  </li>
                </ul>
              </div>
                  ...
                  <div className="bg-rose-500/10 border border-rose-500/30 rounded-lg p-3">
                    ...
                    <ul className="text-sm text-white/80 space-y-1.5">
                      ...
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                        <span>
                          Recommended as the standard approach once initial drills are complete
                        </span>
                      </li>
                    </ul>
                  </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  ...
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Total evacuation time</strong> &mdash; from
                      alarm activation to confirmation that all areas are clear
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Number of occupants</strong> evacuated and
                      accounted for
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Problems identified</strong> &mdash; blocked
                      exits, poor alarm audibility, persons unaccounted for, confusion about routes
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Corrective actions</strong> taken or planned,
                      with responsibilities and target dates
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Debrief:</strong> A post-drill meeting with
                      fire marshals and management to review performance, share observations, and
                      agree improvements
                    </span>
                  </li>
                </ul>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The <strong>Equality Act 2010</strong> requires employers and service providers to
                make reasonable adjustments to ensure that persons with disabilities are not placed
                at a substantial disadvantage. In the context of fire safety, this means that the
                evacuation plan must account for the needs of every individual who may have
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">What is a PEEP?</strong> An individual plan
                      tailored to a specific person&rsquo;s needs, taking into account their
                      disability or condition and the specific building layout
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Contents:</strong> The designated escape route,
                      the assistance required (physical support, wheelchair transfer, guidance), the
                      buddy or support arrangements, any equipment needed (evacuation chair, ski
                  ...
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Review:</strong> PEEPs must be reviewed
                      regularly, whenever the person&rsquo;s condition changes, or whenever the
                      building layout or use changes
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Confidentiality:</strong> The PEEP should be
                      shared only with those who need to know &mdash; the individual, their buddy,
                      and the fire safety manager
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Post-Grenfell requirement:</strong> GEEPs were
                      recommended by the Grenfell Tower Inquiry for residential buildings where
                      individual PEEPs may not be practical for every resident
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Purpose:</strong> A general plan that covers
                      the evacuation needs of visitors, temporary residents, or any person whose
                      individual needs are not known in advance
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Approach:</strong> Identifies available
                      refuges, evacuation equipment locations, and the general procedures for
                      assisting a person with unknown needs
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Refuges:</strong> A designated area within a
                      protected stairway or a fire-protected lobby where a person can wait safely
                      for assistance. Refuges must have a communication system (typically an
                      intercom or two-way radio) linking to the main fire control point
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Evacuation chairs:</strong> Lightweight chairs
                      designed to carry a person down stairs. Must be stored in accessible locations
                      and staff must be trained in their use
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Buddy systems:</strong> A designated colleague
                      is assigned to assist a specific person during evacuation. At least two
                      buddies should be identified to cover absence
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      ...
                      persons who are deaf or hard of hearing, visual alarm devices (flashing
                      beacons) and vibrating pagers or pillow pads must be provided as part of the
                      fire alarm system
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  <strong className="text-white">RRFSO</strong>. The responsible person must
                  proactively identify persons who may need assistance and engage with them to
                  develop an appropriate plan &mdash; it is not sufficient to wait for the
                  individual to request one.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Construction sites present unique evacuation challenges. The building is incomplete,
                escape routes change as the structure develops, and multiple contractors may be
                working on site simultaneously. The{' '}
                <strong>Construction (Design and Management) Regulations 2015 (CDM 2015)</strong>{' '}
                require the principal contractor to plan, manage, and coordinate fire safety
                arrangements for the entire site.
              </p>
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      employers on site means multiple workforces who must all understand and follow
                      the same evacuation plan. The principal contractor is responsible for
                      coordination
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Temporary alarm systems:</strong>{' '}
                      Purpose-designed temporary fire alarm systems (air horns, electric sirens, or
                      temporary sounder circuits) must be installed. The system must be audible in
                      all areas where work is being carried out, including noisy environments
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Changing escape routes:</strong> As the
                      building progresses, stairways may be incomplete, corridors may be blocked,
                      and temporary scaffolding or hoarding may obstruct routes. Escape routes must
                  ...
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Working at height:</strong> Workers on upper
                      floors, scaffolding, or in excavations require specific evacuation procedures,
                      including designated escape ladders and safe access points
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Hot works:</strong> Activities involving naked
                      flames, welding, cutting, or grinding create additional fire risk and require
                      specific fire watch procedures and dedicated extinguishers
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Construction phase plan:</strong> Must include
                      a site-specific fire safety plan covering alarm arrangements, escape routes,
                      assembly points, fire extinguisher locations, and responsibilities
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Site induction:</strong> Every person entering
                      the site must receive a fire safety induction covering the alarm signal,
                      escape routes, assembly point, and what to do on discovering a fire
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Roll call:</strong> A signing-in and
                      signing-out system must be maintained so that all persons on site can be
                  ...
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Regular review:</strong> The fire safety plan
                      must be reviewed and updated as the site develops and the building layout
                      changes
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  second fix, ensure that the temporary system remains fully operational until the
                  permanent system is commissioned and handed over. Never disconnect or disable any
                  part of the temporary alarm without the principal contractor&rsquo;s written
                  authorisation.
                </p>
              </div>
            </div>
            ...
            <div className="min-w-[320px] space-y-4">
              ...
              <div className="flex justify-center">
                <div className="bg-rose-500/20 border-2 border-rose-500/50 rounded-xl px-5 py-3 text-center">
                  <p className="text-sm font-semibold text-rose-400">EVACUATION STRATEGY</p>
              ...
              <div className="flex justify-center">
                <div className="flex flex-col items-center">
                  ...
                  <span className="text-xs font-bold text-rose-400 mb-1">BUILDING TYPE</span>
              ...
              <div className="flex justify-center">
                <div className="flex flex-col items-center">
                  <div className="w-0.5 h-6 bg-rose-500/40" />
                  <span className="text-xs font-bold text-rose-400 mb-1">OCCUPANT MOBILITY</span>
                  <div className="w-0.5 h-4 bg-rose-500/40" />
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-2 sm:gap-4">
                <div className="bg-white/5 border border-white/10 rounded-lg p-3 text-center">
                  <p className="text-xs font-bold text-rose-400 mb-1">SIMULTANEOUS</p>
              ...
              <div className="flex justify-center">
                <div className="flex flex-col items-center">
                  <div className="w-0.5 h-6 bg-rose-500/40" />
                  <span className="text-xs font-bold text-rose-400 mb-1">KEY REQUIREMENTS</span>
                  <div className="w-0.5 h-4 bg-rose-500/40" />
                </div>
              </div>
