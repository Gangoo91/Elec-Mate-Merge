...
const quickCheckQuestions = [
  {
    ...
    options: ['BS EN 3', 'BS EN 1869', 'BS EN 671-1', 'BS 5306-1'],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    question:
      'What is the minimum time a fire blanket should be left in place over a fire after deployment?',
...
const quizQuestions = [
  ...
  {
    id: 6,
    question: 'How often should hose reels receive a visual inspection?',
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-rose-500/5 border-l-2 border-rose-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Fire blankets:</strong> BS EN 1869, woven glass fibre, three sizes
              </li>
              <li>
                <strong>Smothering action</strong> removes oxygen to extinguish fire
              </li>
              <li>
                <strong>Hose reels:</strong> BS EN 671-1, Class A fires only
              </li>
              <li>
                <strong>Fixed systems:</strong> Sprinklers, gas suppression, water mist
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-rose-500/5 border-l-2 border-rose-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>BS EN 1869:</strong> Fire blankets — requirements and tests
              </li>
              <li>
                <strong>BS EN 671-1:</strong> Fixed hose reels with semi-rigid hose
              </li>
              <li>
                <strong>BS 5306-1:</strong> Maintenance of portable fire extinguishers &amp; hose
                reels
              </li>
              <li>
                <strong>BS EN 12845:</strong> Automatic sprinkler systems
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Fire blankets are simple but highly effective pieces of first-aid firefighting
                equipment designed to <strong>smother small fires</strong> by cutting off the oxygen
                supply. They are governed by <strong>BS EN 1869</strong>, which specifies the
                materials, construction, performance requirements, and testing procedures for fire
                blankets intended for use in extinguishing small fires in their early stages.
              </p>

              <p>
                Fire blankets are constructed from <strong>woven glass fibre</strong>, which is
                inherently non-combustible and can withstand extremely high temperatures without
                melting, burning, or producing toxic fumes. Many modern fire blankets also
                incorporate a <strong>silicone coating</strong> on one or both sides, which enhances
                the blanket&rsquo;s resistance to heat transfer, provides a degree of waterproofing,
                and improves the seal when the blanket is placed over a fire, preventing oxygen from
                reaching the fuel.
              </p>
                ...
                <div className="space-y-3">
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      found size in domestic kitchens.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    <div className="flex justify-between items-center mb-1">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      heavy-duty size is preferred for this purpose.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    <div className="flex justify-between items-center mb-1">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      wrap fully around an adult. Required in most commercial kitchen environments.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <p>
                Fire blankets are supplied in a{' '}
                <strong>wall-mounted quick-release container</strong>, typically a rigid or
                semi-rigid casing with pull-down tabs at the bottom. The container protects the
                blanket from dust, moisture, and damage during storage, and the pull-tab design
                enables rapid one-motion deployment. The container is designed so that pulling the
                tabs downward simultaneously releases the blanket and unfolds it, ready for
                immediate use.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  The fire risk assessment should determine the appropriate blanket size based on
                  the maximum foreseeable fire size in the specific location. When in doubt, select
                  the next size up.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Fire blankets work by <strong>smothering</strong> &mdash; they physically remove the
                oxygen element from the fire triangle. When a fire blanket is placed over a fire and
                sealed against the surface, it prevents fresh air from reaching the fuel. Without
                oxygen, combustion cannot continue, and the fire is extinguished. This is the same
                principle as placing a lid on a burning pan.
              </p>

              <p>
                Fire blankets are specifically designed for use on{' '}
                <strong>small fires in their early stages</strong>. They are most effective in the
                following scenarios:
              </p>
              ...
              <ul className="space-y-2 text-sm text-white/70">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong>Clothing fires</strong> &mdash; wrapping the blanket around a person
                    whose clothing is on fire is one of the most important uses. The blanket
                    smothers the flames against the body without the risks associated with using an
                    extinguisher on a person (frostbite from CO2, chemical irritation from powder)
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Small cooking fires</strong> &mdash; chip pan fires, frying pan fires,
                    and other small cooking fires where the fire is contained in a vessel. Place the
                    blanket over the vessel to seal off the oxygen supply. This is safer than
                    attempting to move a burning pan or using water on hot oil
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Small liquid spill fires</strong> &mdash; where a small quantity of
                    flammable liquid has spilled and ignited, and the fire is smaller than the
                    blanket. The blanket can smother the fire by covering the entire spill area
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Waste bin fires</strong> &mdash; small fires in waste containers where
                    the blanket can be placed over the top to cut off the air supply
                  </span>
                </li>
              </ul>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  fire will continue to burn around the edges. In this situation, do not attempt to
                  use the blanket &mdash; use a suitable fire extinguisher if trained to do so, or
                  evacuate immediately and call the fire and rescue service.
                </p>
              </div>

              <p>
                Fire blankets can also be used as a <strong>heat shield during escape</strong>. If
                you need to pass through an area of radiant heat (for example, passing close to a
                fire to reach an exit), holding a fire blanket in front of your body can provide a
                degree of protection from radiant heat. This is a secondary use and should only be
                considered when no alternative escape route exists.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="space-y-2 text-sm text-white/70">
                  ...
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      Deep-fat fryer fires in commercial kitchens (use wet chemical extinguisher)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      Situations where you cannot safely approach within arm&rsquo;s reach of the
                      fire
                    </span>
                  </li>
                </ul>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Correct technique is essential when deploying a fire blanket. An incorrectly
                deployed blanket can be ineffective or, worse, can worsen the situation by fanning
                the flames or splashing burning liquid. The following procedure should be followed
                precisely.
              </p>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-white/70 leading-relaxed">
                        ...
                        Ensure the blanket covers the entire fire with overlap on all sides.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-white/70 leading-relaxed">
                        ...
                        still-hot fuel, which can cause the fire to reflash violently.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <ul className="space-y-2 text-sm text-white/70">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong>STOP</strong> &mdash; prevent the person from running (running fans
                      the flames, accelerating the fire and drawing it towards the face)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong>DROP</strong> &mdash; get the person to the ground (prevents flames
                      rising to the face and airways; lying down also reduces the surface area
                      exposed to upward flame travel)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong>ROLL</strong> &mdash; roll the person on the ground to smother as much
                      flame as possible
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong>BLANKET</strong> &mdash; wrap the fire blanket around the person,
                      covering the burning area completely. Press firmly to exclude air. Do not
                      remove until the fire is fully extinguished
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  another fire. After any use on an actual fire, dispose of the blanket safely
                  (allow it to cool completely) and replace it with a new one immediately.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The correct placement of fire blankets is just as important as knowing how to use
                them. A fire blanket that cannot be reached quickly in an emergency is effectively
                useless. Placement should be determined by the <strong>fire risk assessment</strong>{' '}
                and should prioritise locations where small fires are most likely to occur.
              </p>
                ...
                <div className="space-y-3">
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      area. Do not mount it directly above or immediately beside a cooker hob.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 sm:p-6 rounded-lg">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <p className="text-sm font-medium text-rose-400">
                    Mounting &amp; Maintenance Requirements
                  </p>
                </div>
                  ...
                  {[
                    {
                      ...
                      desc: 'Approximately 1.5 m from the floor to the top of the container',
                    },
                    {
                      label: 'Monthly visual check',
                      desc: 'Container intact and undamaged, pull tabs accessible and visible',
                    },
                    {
                      label: 'Annual inspection',
                      desc: 'Remove blanket from container, inspect for damage, check condition',
                    },
                    {
                      label: 'Replace after use',
                      desc: 'Single-use item — replace immediately after any fire deployment',
                    },
                    {
                      label: 'Clear signage',
                      desc: 'BS 5499 / ISO 7010 fire safety sign positioned above the container',
                    },
                    {
                      label: 'Shelf life',
                      desc: 'Typically 7 years from manufacture (check manufacturer guidance)',
                    },
                  ].map((item, i) => (
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  by stored items, furniture, or equipment; and the blanket has not been used (pull
                  tabs intact). Record the check in the fire safety log book. If the blanket has
                  been removed from its container (for example, by vandalism or accidental
        ...
        <section className="mb-10">
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Fixed hose reels are <strong>permanently installed firefighting systems</strong>{' '}
                governed by <strong>BS EN 671-1</strong> (Fixed firefighting systems &mdash; Hose
                systems &mdash; Part 1: Hose reels with semi-rigid hose). Unlike portable fire
                extinguishers, which contain a finite amount of extinguishing agent, hose reels are
                connected directly to the building&rsquo;s water supply, providing a{' '}
                <strong>continuous and virtually unlimited supply of water</strong> for
                firefighting.
              </p>
                ...
                <div className="space-y-3">
                  ...
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      larger industrial or commercial premises.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    <div className="flex justify-between items-center mb-1">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      manual (requires the operator to open it before use).
                    </p>
                  </div>
                </div>
              </div>
              ...
              <p>
                Hose reels are typically located in <strong>common areas on escape routes</strong>,
                such as corridors, staircase lobbies, and near exits. They are positioned to provide
                maximum coverage of the building with a minimum number of installations. Each hose
                reel is housed in a wall-mounted or recessed cabinet with a clear glass or
                break-glass door, and is clearly signed in accordance with fire safety signage
                standards.
              </p>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  requires knowledge of the correct operation procedure, an understanding of the
                  water supply system, and awareness of which fire classes the water jet is suitable
                  for. Incorrect use of a hose reel — particularly on electrical, liquid, or cooking
                  oil fires — can be extremely dangerous. Fire marshal training should include
                  practical hose reel operation.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Operating a hose reel correctly requires a systematic approach. The following
                procedure should be followed in sequence to ensure safe and effective use.
              </p>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-white/70">
                        ...
                        fires; use a spray pattern for wider coverage and some protection from
                        radiant heat.
                      </p>
                    </div>
                  </div>
                ...
                <div className="bg-rose-500/10 border border-rose-500/30 rounded-lg p-4">
                  ...
                  <ul className="space-y-2 text-sm text-white/70">
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                      <span>
                        <strong>Unlimited water supply</strong> &mdash; unlike extinguishers which
                        last 10&ndash;60 seconds, hose reels provide continuous water
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                      <span>
                        <strong>Greater reach</strong> &mdash; 30 m of hose provides far greater
                        range than any portable extinguisher
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                      <span>
                        <strong>Sustained firefighting</strong> &mdash; can continue to apply water
                    ...
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                      <span>
                        <strong>Variable spray patterns</strong> &mdash; jet for penetration, spray
                        for wider coverage
                      </span>
                    </li>
                  </ul>
                ...
                <div className="bg-rose-500/10 border border-rose-500/30 rounded-lg p-4">
                  ...
                  <ul className="space-y-2 text-sm text-white/70">
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                      <span>
                        <strong>Class A fires only</strong> &mdash; not suitable for electrical,
                        liquid, oil, or metal fires
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                      <span>
                        <strong>Water supply dependent</strong> &mdash; requires adequate water
                        pressure and flow
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                      <span>
                        <strong>Training required</strong> &mdash; incorrect use can create
                        additional hazards
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                      <span>
                        <strong>Water damage</strong> &mdash; significant water damage to property
                        and equipment
                      </span>
                    </li>
                  </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  <strong>
                    never use a hose reel until the electrical supply has been confirmed as isolated
                  </strong>{' '}
                  by a competent person. Even after isolation, residual stored energy in capacitors,
                  batteries, or uninterruptible power supplies (UPS) may still present a risk. When
                  installing or maintaining electrical equipment near hose reel locations, ensure
                  that switchgear and distribution boards are not positioned where they could be
                  accidentally sprayed during hose reel use.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Like all fire safety equipment, hose reels must be{' '}
                <strong>regularly inspected, tested, and maintained</strong> to ensure they will
                function correctly when needed. A hose reel that has not been tested may have a
                seized valve, a perished hose, or no water supply &mdash; rendering it completely
                useless in an emergency. Maintenance requirements are set out in{' '}
                <strong>BS 5306-1</strong>.
              </p>
                  ...
                  {[
                    {
                      ...
                      desc: 'Check for cracking, perishing, kinking, abrasion, or other visible damage',
                    },
                    {
                      label: 'Nozzle',
                      desc: 'Present, securely attached, and operating mechanism functional',
                    },
                    {
                      label: 'Reel mechanism',
                      desc: 'Reel rotates freely, hose unreels and rewinds smoothly without jamming',
                    },
                    {
                      label: 'Water supply valve',
                      desc: 'Confirm valve is in the open position (handle parallel to pipe)',
                    },
                    {
                      label: 'Access',
                      desc: 'Hose reel cabinet is unobstructed and accessible; break-glass intact if fitted',
                    },
                    {
                      label: 'Signage',
                      desc: 'Location sign is visible, legible, and correctly positioned',
                    },
                  ].map((item, i) => (
                    <div key={i} className="bg-white/5 border border-white/10 rounded-lg p-3">
                      <p className="text-sm font-medium text-white">{item.label}</p>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 sm:p-6 rounded-lg">
                ...
                <ul className="space-y-2 text-sm text-white/70">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong>Full flow test</strong> &mdash; the hose is fully unreeled and the
                      water supply is activated to verify that water flows freely at an adequate
                      rate and pressure through the full length of hose
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong>Pressure test</strong> &mdash; the system is checked to ensure it
                      delivers the required minimum pressure at the nozzle (typically 2 bar minimum)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong>Hose inspection</strong> &mdash; the full length of hose is inspected
                      for damage, and the connections are checked for leaks
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong>Valve operation</strong> &mdash; both the supply valve and the nozzle
                      valve are operated and checked for smooth, leak-free operation
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong>Reel mechanism</strong> &mdash; the reel bearing and swivel joint are
                      inspected and lubricated if necessary
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  findings (satisfactory or defects noted); any remedial action required; and
                  confirmation that remedial actions have been completed. These records must be
                  available for inspection by the fire and rescue service or enforcing authority.
                  Under the RRFSO, the responsible person must ensure that fire safety equipment is
        ...
        <section className="mb-10">
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Beyond portable extinguishers, fire blankets, and hose reels, many buildings are
                protected by <strong>fixed firefighting systems</strong> that activate automatically
                or can be triggered manually. Understanding these systems is important for fire
                marshals and particularly relevant for electricians, who may need to work around or
                maintain the electrical components of these systems.
              </p>
                ...
                <div className="space-y-3">
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      (typically 57&deg;C to 68&deg;C for standard response heads). When the element
                      breaks, water is discharged from that individual head only &mdash; not from
                      all heads simultaneously. This targeted response minimises water damage while
                      controlling the fire at its point of origin. Sprinkler systems are extremely
                      effective: statistics show they control or extinguish fires in over 99% of
                      activations.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      blends (IG-55, IG-541). These agents extinguish fire by either chemically
                      inhibiting combustion or reducing the oxygen concentration below the level
                      required to sustain a flame (typically to around 12&ndash;14% O2). They leave
                      no residue, making them ideal for protecting sensitive electronic equipment.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      blankets the surface of the burning liquid, separating the fuel from the
                      oxygen and cooling the surface. Foam can be applied through fixed nozzles,
                      foam pourers, or foam monitors.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      the fire. Water mist systems use significantly less water than conventional
                      sprinklers, reducing water damage. They are increasingly used in heritage
                      buildings, hotels, and residential properties where minimising water damage is
                      important.
                    </p>
                  </div>
                </div>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <ul className="space-y-2 text-sm text-white/70">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong>Do not obstruct sprinkler heads</strong> &mdash; maintain a minimum
                      clearance of 500 mm below sprinkler deflectors. Never hang cables, cable
                      trays, conduit, or light fittings from sprinkler pipework or within the
                      clearance zone
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong>Gas suppression zones</strong> &mdash; before working in a
                      gas-protected room, ensure the system is in a safe state. Accidental
                      activation of a gas suppression system while you are in the room can be
                      dangerous (inert gas systems reduce oxygen levels). Follow the permit-to-work
                      procedure
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong>Isolation procedures</strong> &mdash; if your work could generate
                      heat, dust, or fumes that might trigger fire detection or suppression systems,
                      coordinate with the building&rsquo;s fire safety manager to arrange temporary
                      isolation of the affected zone (with appropriate risk mitigation measures in
                      place)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong>Electrical connections</strong> &mdash; many fixed systems have
                      electrical components: control panels, detection circuits, valve actuators,
                      pump controllers, and alarm interfaces. Do not disconnect or interfere with
                      any fire system wiring without proper authorisation and competence
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  intervention &mdash; critical during unoccupied periods or when a fire starts in a
                  concealed location. Portable equipment (extinguishers, fire blankets, hose reels)
                  provides <strong>first-aid firefighting capability</strong> for trained occupants
                  to tackle small fires in their very early stages, before the fixed system
                  activates or in areas not covered by fixed systems. A comprehensive fire
                  protection strategy includes both: fixed systems as the primary defence, with
                  portable equipment as a supplementary first-response capability.
                </p>
              </div>
            </div>
          </div>
