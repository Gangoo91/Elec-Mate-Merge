...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    question:
      'What is the maximum travel distance to the nearest fire extinguisher in a workplace?',
...
const faqs = [
  ...
  {
    question:
      'When should you attempt to fight a fire with an extinguisher, and when should you simply evacuate?',
    answer:
...
const quizQuestions = [
  ...
  {
    id: 2,
    question: 'What do the letters in the PASS technique stand for?',
    options: [
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-rose-500/5 border-l-2 border-rose-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Five types:</strong> Water, Foam, CO&#8322;, Powder, Wet Chemical
              </li>
              <li>
                <strong>BS EN 3</strong> colour coding &mdash; red body with colour band
              </li>
              <li>
                <strong>PASS technique:</strong> Pull, Aim, Squeeze, Sweep
              </li>
              <li>
                <strong>30m maximum</strong> travel distance to nearest extinguisher
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-rose-500/5 border-l-2 border-rose-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>BS EN 3:</strong> Portable fire extinguishers (colour coding)
              </li>
              <li>
                <strong>BS 5306-8:</strong> Selection, installation &amp; maintenance
              </li>
              <li>
                <strong>BS 5306-3:</strong> Commissioning &amp; maintenance
              </li>
              <li>
                <strong>RRFSO Art. 13:</strong> Duty to provide firefighting equipment
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            <h2 className="text-lg sm:text-xl font-bold text-white flex items-center gap-3 mb-4">
              <span className="flex items-center justify-center w-8 h-8 rounded-lg bg-rose-500/10 text-rose-400 text-sm font-bold border border-rose-500/20">
                01
              </span>
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Portable fire extinguishers are the first line of defence for{' '}
                <strong>first-aid firefighting</strong> &mdash; tackling a fire in its earliest
                stages before the fire and rescue service arrives. Under{' '}
                <strong>Article 13 of the Regulatory Reform (Fire Safety) Order 2005</strong>{' '}
                (RRFSO), the Responsible Person has a legal duty to ensure that the premises are
                equipped with appropriate firefighting equipment, including portable fire
                extinguishers, and that this equipment is placed to be readily accessible.
              </p>

              <p>
                In the UK, portable fire extinguishers conform to <strong>BS EN 3</strong>, which
                specifies the colour coding system. Since 1997, all portable fire extinguishers must
                have a <strong>red body</strong> with a <strong>colour band</strong> (covering at
                least 5% of the body area) that identifies the extinguisher type. Prior to this,
                extinguishers were colour-coded across the entire body &mdash; you may still
                encounter these older models in some premises, but they should be replaced at their
                next service date.
              </p>
              ...
              <ul className="space-y-2 text-sm text-white">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong>Portable extinguishers</strong> &mdash; hand-held units designed to be
                    carried to the fire and operated by one person. These are the most common type
                    and range from 1kg to 9kg (or 1L to 9L for liquid agents)
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Wheeled extinguishers</strong> &mdash; larger units (typically 25kg,
                    45kg, or 50L) mounted on a trolley for transport to the fire. These are used in
                    high-risk environments such as industrial sites, fuel storage areas, and
                    aircraft hangars where larger quantities of extinguishing agent may be needed
                  </span>
                </li>
              </ul>

              <p>
                The placement and siting of fire extinguishers is governed by{' '}
                <strong>BS 5306-8</strong> and reinforced by fire safety guidance documents. Key
              ...
              <ul className="space-y-2 text-sm text-white">
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Visible and accessible</strong> &mdash; extinguishers must be clearly
                    visible or indicated by signage, and must not be obstructed by furniture, stock,
                    or equipment
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>On escape routes</strong> &mdash; preferably near exits and at the same
                    location on each floor for consistency
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Near specific hazards</strong> &mdash; additional extinguishers of the
                    appropriate type should be placed near identified fire hazards (e.g., a wet
                    chemical extinguisher near a commercial kitchen)
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Maximum 30-metre travel distance</strong> &mdash; no person should have
                    to travel more than 30 metres to reach the nearest fire extinguisher. This is
                    the single most important placement rule and is derived from BS 5306-8
                  </span>
                </li>
              </ul>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  ...
                  Person must ensure that the premises are equipped with appropriate fire-fighting
                  equipment and with fire detectors and alarms. Any non-automatic fire-fighting
                  equipment must be easily accessible, simple to use, and indicated by signs. The
                  equipment must be appropriate to the risks identified in the fire risk assessment.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Water extinguishers are identified by an <strong>all-red body</strong> (or a red
                colour band on newer models, though in practice most water extinguishers remain
                fully red as the band colour is the same as the body). They are one of the oldest
                and most straightforward types of fire extinguisher, working on the simple principle
                of <strong>cooling</strong>.
              </p>
              ...
              <p>
                Water extinguishers work by <strong>absorbing heat</strong> from the burning
                material, reducing its temperature below the ignition point. Water has an
                exceptionally high specific heat capacity (4,200 J/kg&middot;K) and latent heat of
                vaporisation (2,260 kJ/kg), making it an extremely effective cooling agent for solid
                materials.
              </p>
              ...
              <ul className="space-y-2 text-sm text-white">
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Jet water extinguishers</strong> &mdash; discharge a solid stream of
                    water that can be directed precisely at the seat of the fire. They have a longer
                    throw distance but cover a smaller area
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Spray water extinguishers</strong> &mdash; discharge water as a fine
                    spray, covering a larger area and improving cooling efficiency. The spray
                    pattern also reduces the risk of spreading burning liquids if accidentally used
                    near a liquid fire
                  </span>
                </li>
              </ul>
              ...
              <p>
                <strong>Additive water extinguishers</strong> contain a surfactant additive that
                reduces the surface tension of the water, allowing it to penetrate burning materials
                more effectively. This enhances performance and can allow a smaller extinguisher
                (e.g., 3L with additive) to achieve the same fire rating as a larger standard water
                extinguisher (e.g., 6L without additive). Some additive water extinguishers may also
                have limited effectiveness on Class B fires, though this is not their primary
                purpose.
              </p>

              <p>
                Standard water extinguishers are available in <strong>6L and 9L</strong> sizes.
                Freeze protection may be needed for unheated environments &mdash; antifreeze
                additive versions are available for locations where temperatures may drop below
                0&deg;C.
              </p>

              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-red-400">Critical Warning:</strong> NEVER use water on
                  electrical fires (risk of electrocution), flammable liquid fires (water sinks
                  below the liquid and boils violently, causing the burning liquid to erupt),
                  cooking oil fires (water causes an explosive steam eruption throwing burning oil
                  into the air), or metal fires (many metals react violently with water, producing
        ...
        <section className="mb-10">
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Foam extinguishers are identified by a <strong>cream colour band</strong> on a red
                body. They are one of the most versatile extinguisher types, suitable for both{' '}
                <strong>Class A</strong> (solid combustibles) and <strong>Class B</strong>{' '}
                (flammable liquids) fires. Their dual capability makes them an excellent
                general-purpose choice for offices, workshops, and commercial premises.
              </p>

              <p>
                The most common type is the <strong>AFFF (Aqueous Film-Forming Foam)</strong>{' '}
                extinguisher. AFFF works through a combination of{' '}
              ...
              <ul className="space-y-2 text-sm text-white">
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>On Class A fires</strong> &mdash; the water content cools the burning
                    material below its ignition temperature, while the foam blanket prevents
                    re-ignition by excluding oxygen
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>On Class B fires</strong> &mdash; the foam forms a thin aqueous film
                    across the surface of the burning liquid, smothering the fire by cutting off the
                    oxygen supply and sealing in flammable vapours. This film-forming action is what
                    makes AFFF so effective on liquid fires
                  </span>
                </li>
              </ul>

              <p>
                <strong>Spray foam extinguishers</strong> deliver the foam in a spray pattern rather
                than a jet, providing better coverage and reducing the risk of splashing burning
                liquids. When using foam on a liquid fire, the foam should be directed at a nearby
                vertical surface or the inside edge of the container so that it flows gently across
                the liquid surface &mdash; <strong>never aim directly into the liquid</strong>, as
                this can splash burning fuel.
              </p>

              <p>
                Foam extinguishers are available in <strong>6L and 9L</strong> sizes. Key
              ...
              <ul className="space-y-2 text-sm text-white">
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Not for electrical fires</strong> (unless di-electrically tested to 35kV
                    &mdash; check the label). Standard foam contains water and conducts electricity,
                ...
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Not for cooking oil fires (Class F)</strong> &mdash; the water content
                    in foam can cause a violent eruption when it contacts oil at extremely high
                    temperatures
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Not for metal fires (Class D)</strong> &mdash; foam is water-based and
                    many metals react dangerously with water
                  </span>
                </li>
              </ul>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-rose-400">Key Point:</strong> Foam extinguishers are often
                  considered the best &ldquo;general purpose&rdquo; extinguisher for premises with
                  mixed fire risks. Their ability to handle both Class A and Class B fires means
                  they can address the majority of fire scenarios encountered in typical workplaces.
                  Many fire risk assessors recommend foam as the primary extinguisher type,
                  supplemented by specialist types (CO&#8322; for electrical areas, wet chemical for
        ...
        <section className="mb-10">
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Carbon dioxide (CO&#8322;) extinguishers are identified by a{' '}
                <strong>black colour band</strong> on a red body. They have a distinctive appearance
                with a <strong>flared horn</strong> instead of a hose nozzle. CO&#8322;
                extinguishers are suitable for <strong>Class B</strong> (flammable liquid) fires and
                fires involving <strong>live electrical equipment</strong>.
              </p>

              <p>
                CO&#8322; works by <strong>displacing oxygen</strong> around the fire. The
                extinguisher contains liquid carbon dioxide under high pressure (approximately 55
                bar at 20&deg;C). When discharged, the liquid CO&#8322; expands rapidly into a gas,
                displacing the oxygen in the immediate vicinity of the fire and suffocating the
                flames. Because CO&#8322; is a gas, it leaves <strong>absolutely no residue</strong>
                , making it the preferred choice for fires involving sensitive electrical and
                electronic equipment such as server rooms, control panels, and laboratory
                instruments.
              </p>
              ...
              <p>
                The <strong>discharge temperature of &minus;78&deg;C</strong> presents a significant
                safety hazard. As the liquid CO&#8322; expands into gas, it cools dramatically, and
                the horn can reach temperatures cold enough to cause severe frostbite on contact.
                For this reason, CO&#8322; extinguisher horns must be made from{' '}
                <strong>non-conductive, frost-resistant material</strong>. Users must{' '}
                <strong>never hold the horn</strong> during discharge &mdash; only grip the handle
                and the designated holding point on the horn assembly.
              </p>

              <p>
                CO&#8322; extinguishers are available in <strong>2kg and 5kg</strong> sizes. The 2kg
                size is commonly placed next to individual workstations, server racks, or electrical
                panels. The 5kg size provides a longer discharge time and is suitable for larger
                risk areas.
              </p>

              <p>
                A critical limitation is the <strong>lack of any cooling effect</strong>. CO&#8322;
                suppresses the fire by removing oxygen, but once the gas dissipates (which can
                happen very quickly, especially in ventilated or outdoor environments), oxygen
                returns and the hot material or liquid may re-ignite. This means CO&#8322;
                extinguishers are <strong>not suitable for Class A fires</strong>, where deep-seated
                smouldering in solid materials will persist and re-ignite once the CO&#8322;
                disperses.
              </p>

              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-rose-400">Practical Tip:</strong> In offices and
                  commercial premises, CO&#8322; extinguishers are typically paired with foam or
                  water extinguishers. The CO&#8322; handles electrical risks (computers, printers,
                  switchboards), while the foam or water handles the Class A risks (paper,
                  furniture, textiles). This combination provides comprehensive coverage for the
                  most common workplace fire scenarios.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Dry powder extinguishers are identified by a <strong>blue colour band</strong> on a
                red body. The standard <strong>ABC powder</strong> extinguisher is the most
                versatile type in terms of fire class coverage, being rated for{' '}
                <strong>Class A</strong> (solids), <strong>Class B</strong> (flammable liquids), and{' '}
                <strong>Class C</strong> (flammable gases). They are also safe for use on fires
                involving <strong>live electrical equipment</strong>.
              </p>

              <p>
                Dry powder works by <strong>interrupting the chemical chain reaction</strong> of
                combustion. The fine powder particles interfere with the free radicals that sustain
                the flame, effectively breaking the fire triangle at the chemical reaction level
                rather than by removing heat, oxygen, or fuel. This gives powder extinguishers their
                wide-ranging effectiveness across multiple fire classes.
              </p>

              <p>
                Despite their versatility, dry powder extinguishers have{' '}
                <strong>serious limitations</strong> that make them{' '}
              ...
              <ul className="space-y-2 text-sm text-white">
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Severe visibility reduction</strong> &mdash; the discharged powder
                    creates a dense cloud that can completely obscure vision, making it impossible
                    to see exits, escape routes, or the fire itself. This is extremely dangerous in
                    enclosed spaces
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Inhalation hazard</strong> &mdash; the fine powder particles can cause
                    serious respiratory distress, particularly for individuals with asthma, COPD, or
                    other respiratory conditions. In confined spaces, this can be life-threatening
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>No cooling effect</strong> &mdash; like CO&#8322;, powder does not cool
                    the burning material, so there is a significant risk of re-ignition once the
                    powder settles and oxygen returns
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Messy cleanup</strong> &mdash; the powder contaminates everything it
                    contacts and is extremely difficult to clean up. It can penetrate and corrode
                    sensitive electronic equipment, often causing more damage than the fire itself
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Corrosive to electronics</strong> &mdash; the powder is hygroscopic
                    (absorbs moisture) and can cause corrosion damage to circuit boards, relays, and
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-orange-400">Indoor Use Warning:</strong> Current UK fire
                  safety guidance <strong>strongly recommends against</strong> the use of dry powder
                  extinguishers in buildings, offices, and enclosed spaces. The visibility reduction
                  and inhalation hazards are considered too great a risk to occupants. Powder
                  extinguishers should be reserved for <strong>outdoor environments</strong> such as
                  forecourts, construction sites, vehicle fires, and industrial yards.
                </p>
              </div>

              <p>
                In addition to standard ABC powder, there are{' '}
                <strong>specialist powder extinguishers</strong> designed for{' '}
                <strong>Class D (metal) fires</strong>. These use specific powder agents tailored to
                particular metals:
              </p>
              ...
              <ul className="space-y-2 text-sm text-white">
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>M28 powder</strong> &mdash; designed for lithium fires, commonly
                    encountered with lithium battery incidents in industrial and automotive settings
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>L2 powder</strong> &mdash; designed for fires involving other
                    combustible metals such as magnesium, titanium, and sodium. These metals burn at
                    extremely high temperatures and react violently with water and many conventional
              ...
              <p>
                Dry powder extinguishers are available in sizes from <strong>1kg to 9kg</strong>.
                The smaller 1kg and 2kg sizes are commonly found in vehicles. Specialist Class D
                powder extinguishers are typically 9kg to provide sufficient agent for metal fires,
                which are particularly difficult to extinguish.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Wet chemical extinguishers are identified by a <strong>yellow colour band</strong>{' '}
                on a red body. They are <strong>specifically designed for Class F fires</strong>{' '}
                &mdash; fires involving cooking oils and fats, such as those in deep fat fryers,
                woks, and large cooking vessels. They are the{' '}
                <strong>only extinguisher type specifically designed</strong> for these extremely
                dangerous fires.
              </p>

              <p>
                Wet chemical extinguishers work through a unique process called{' '}
                <strong>saponification</strong>. The wet chemical agent (typically a solution of
                potassium acetate, potassium carbonate, or potassium citrate) reacts chemically with
                the burning cooking oil to create a{' '}
                <strong>non-combustible soap-like substance</strong> (a &ldquo;saponified&rdquo;
                layer) on the surface of the oil. This process achieves two critical effects
                simultaneously:
              </p>
              ...
              <ul className="space-y-2 text-sm text-white">
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Smothering</strong> &mdash; the soap-like film seals the surface of the
                    oil, preventing flammable vapours from escaping and cutting off the oxygen
                    supply to the fire
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Cooling</strong> &mdash; the wet chemical agent cools the oil below its
                    auto-ignition temperature (typically around 340&deg;C for vegetable oil),
                    preventing re-ignition. This is critical because cooking oils have very high
                    auto-ignition temperatures and can re-ignite spontaneously if not cooled
                    sufficiently
                  </span>
                </li>
              </ul>
              ...
              <p>
                The agent is delivered as a <strong>fine spray or mist</strong>, which is gentle
                enough not to disturb the surface of the burning oil. This is essential &mdash; a
                forceful jet could splash burning oil out of the fryer or cooking vessel, spreading
                the fire and causing severe burns to the operator.
              </p>

              <p>
                In addition to Class F, wet chemical extinguishers are also{' '}
                <strong>rated for Class A fires</strong> (solid combustibles), making them useful in
                kitchen environments where both risks are present. Some models carry an additional{' '}
                <strong>Class B rating</strong>, but this is not universal &mdash; always check the
                specific extinguisher&rsquo;s label and fire rating.
              </p>

              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-rose-400">
                    Why Only Wet Chemical for Deep Fat Fryers?
                  </strong>{' '}
                  Cooking oil fires are exceptionally dangerous because the oil temperature
                  typically exceeds 300&deg;C. Water causes an explosive steam eruption that throws
                  burning oil into the air (a &ldquo;fireball&rdquo;). Foam behaves similarly due to
                  its water content. CO&#8322; can splash the oil without cooling it. Standard
                  powder does not cool the oil sufficiently. Only wet chemical extinguishers provide
                  the combined smothering and cooling action needed to safely suppress a cooking oil
                  fire. The saponification reaction is unique to wet chemical agents and cannot be
                  replicated by any other extinguisher type.
                </p>
              </div>

              <p>
                Wet chemical extinguishers are typically available in{' '}
                <strong>2L, 3L, and 6L</strong> sizes. They should be sited within easy reach of
                commercial kitchen areas and are a mandatory requirement for any premises with deep
                fat frying equipment. Under the RRFSO fire risk assessment, any commercial kitchen
                must have appropriate Class F firefighting provision.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The <strong>PASS technique</strong> is the universal method for operating a portable
                fire extinguisher. Regardless of the extinguisher type, the basic operation follows
              ...
              <ul className="space-y-2 text-sm text-white">
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Wind direction</strong> &mdash; always approach the fire with the wind
                    at your back (outdoors) so that the extinguishing agent is carried towards the
                    fire rather than blown back at you. Indoors, be aware of draughts from open
                    windows or ventilation systems
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Safe distance</strong> &mdash; maintain a safe distance from the fire
                    (typically 1&ndash;2 metres for water and foam, 1 metre minimum for CO&#8322;).
                    Move closer only as the fire diminishes. Too close and you risk heat exposure;
                    too far and the agent may not reach the fire effectively
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Escape route</strong> &mdash; always keep a clear escape route BEHIND
                    you. Never allow the fire to come between you and your exit. If the fire grows
                    or you cannot control it, you must be able to evacuate immediately
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Aim at the base</strong> &mdash; this is the most common mistake. The
                    base of the fire is where the fuel is burning; the visible flames are the
                    result, not the cause. Directing the agent at the base addresses the fuel source
                    directly
                  </span>
                </li>
              </ul>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  Do NOT attempt to use an extinguisher if: the fire is <strong>too large</strong>{' '}
                  (bigger than a wastepaper bin); the fire is <strong>spreading rapidly</strong> or
                  has reached the ceiling; there is <strong>heavy smoke</strong> reducing
                  visibility; you have <strong>no training</strong> in extinguisher use; you do{' '}
                  <strong>not have the correct type</strong> of extinguisher; there is{' '}
                  <strong>no clear escape route</strong> behind you; or you have{' '}
                  <strong>any doubt</strong> about your ability to control the fire. In any of these
                  situations, evacuate immediately, close doors behind you, and wait for the fire
                  and rescue service.
                </p>
              </div>

              <p>
                Remember that portable fire extinguishers contain a{' '}
                <strong>limited quantity of agent</strong> &mdash; most provide only{' '}
                <strong>20 to 60 seconds of discharge time</strong>. They are designed for first-aid
                firefighting in the incipient stage of a fire only. If the fire cannot be controlled
                quickly, stop, evacuate, and leave firefighting to the professionals.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Fire extinguisher maintenance is governed by <strong>BS 5306-3</strong> and is a
                legal requirement under the RRFSO. Article 17 requires the Responsible Person to
                ensure that firefighting equipment is maintained in an efficient state, in efficient
                working order, and in good repair. Failure to maintain extinguishers properly can
                result in prosecution and, more importantly, could mean an extinguisher fails to
                operate when needed.
              </p>
                ...
                <div className="bg-rose-500/10 border border-rose-500/30 rounded-lg p-4">
                  ...
                  <ul className="space-y-1.5 text-xs text-white">
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                      <span>
                        Confirm the extinguisher is in its designated location and has not been
                        moved
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                    ...
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                      <span>
                        Ensure the operating instructions are legible and the ID label is in place
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                      <span>
                        Confirm access is not obstructed by furniture, stock, or equipment
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-rose-500/10 border border-rose-500/30 rounded-lg p-4">
                  ...
                  <ul className="space-y-1.5 text-xs text-white">
                    ...
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                      <span>
                        Verifying the pressure (gauge or cartridge) is within specification
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    ...
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                      <span>
                        Attaching a service label showing the date of service, next service due, and
                        engineer details
                      </span>
                    </li>
                  </ul>
                ...
                <div className="bg-rose-500/10 border border-rose-500/30 rounded-lg p-4">
                  ...
                  <ul className="space-y-1.5 text-xs text-white">
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                      <span>
                        <strong>Water, foam, and wet chemical:</strong> Extended service every 5
                        years &mdash; includes discharge test, internal inspection, and refill with
                        fresh agent
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                      <span>
                        <strong>CO&#8322;:</strong> Hydraulic pressure test every 10 years &mdash;
                        the cylinder is pressure-tested to verify structural integrity (CO&#8322;
                        cylinders operate at very high pressures)
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                      <span>
                        <strong>Dry powder:</strong> Extended service every 5 years with full
                        discharge and refill every 10 years &mdash; powder can compact over time and
              ...
              <p>
                <strong>Record keeping</strong> is essential. All maintenance activities,
                inspections, and services must be documented and records retained. These records may
                be requested during a fire safety audit or inspection by the fire and rescue
                service. Many organisations use a fire safety log book or digital maintenance
                management system to track extinguisher servicing.
              </p>

              <p>
                <strong>Signage</strong> must comply with the Health and Safety (Safety Signs and
                Signals) Regulations 1996 and BS 5499. Each extinguisher location should be
                indicated by a fire extinguisher identification sign showing the type of
                extinguisher and, ideally, the fire classes it is suitable for. In areas where
                extinguishers may not be immediately visible, additional directional signs should
                guide occupants to the nearest extinguisher.
              </p>

              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-rose-400">Fire Marshal Responsibility:</strong> As a fire
                  marshal, you should be familiar with the locations of all extinguishers in your
                  area, the types available, and how to carry out the monthly visual inspection. You
                  should also know how to verify that the annual service has been completed (check
                  the service label) and report any issues such as missing extinguishers, obstructed
                  access, damaged units, or overdue servicing to the Responsible Person immediately.
                </p>
              </div>
            </div>
          </div>
