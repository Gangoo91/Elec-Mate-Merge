...
const quickCheckQuestions = [
  {
    ...
    question: 'What is the single largest cause of commercial fires in the UK?',
    options: [
      'Electrical faults',
      'Smoking materials',
...
const faqs = [
  ...
  {
    question: 'Can an electrician be held personally responsible for a fire caused by their work?',
    answer:
  ...
  {
    question: 'What is spontaneous combustion and how does it relate to workplace fires?',
    answer:
...
const quizQuestions = [
  ...
  {
    id: 3,
    question: 'What percentage of commercial fires in the UK are caused by arson?',
    options: ['Approximately 15%', 'Approximately 25%', 'Approximately 45%', 'Approximately 70%'],
    correctAnswer: 2,
    explanation:
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-rose-500/5 border-l-2 border-rose-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>~14,000 electrical fires/year</strong> in the UK (~25% of accidental
                dwelling fires)
              </li>
              <li>
              ...
              <li>
                <strong>Hot work sparks</strong> can travel 10+ metres and smoulder for 30+ minutes
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-rose-500/5 border-l-2 border-rose-500/50">
            <p className="text-rose-400/90 text-base font-medium mb-2">Key Principle</p>
            <ul className="text-base text-white space-y-1.5">
              <li>
              ...
              <li>
                <strong>Electricians</strong> are both at risk and a line of defence
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Electrical faults are one of the leading causes of accidental fire in the United
                Kingdom. Home Office fire statistics indicate that electrical faults cause
                approximately <strong>14,000 fires per year</strong>, representing roughly{' '}
                <strong>25% of all accidental dwelling fires</strong>. For electricians, this
                statistic carries a dual significance: it underscores the importance of quality
                workmanship in preventing fires, and it highlights the specific risks faced when
                working on electrical installations.
              </p>

              <p>
                The mechanisms by which electrical faults cause fire are well understood. Each
                involves the conversion of electrical energy into heat energy at a rate that exceeds
                the ability of the surrounding materials to dissipate that heat, ultimately raising
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Hot works refers to any process that generates flames, sparks, or significant heat
                that could ignite nearby combustible materials. This includes welding (MIG, TIG,
                MMA/stick, oxy-fuel), thermal cutting, brazing, soldering, grinding, use of
                blowtorches, and any other operation that produces open flames or hot particles. Hot
                works are a significant cause of fire on construction sites and in commercial and
                industrial premises.
              </p>

              <p>
                The primary danger of hot works is the production of{' '}
                <strong>sparks and hot metal particles</strong> that can travel significant
                distances from the work area. Sparks from grinding and cutting operations can travel{' '}
                <strong>10 metres or more</strong>, passing through gaps in floors, walls, and
                ceilings, and lodging in combustible materials where they can smoulder undetected
                for extended periods before developing into a visible fire.
              </p>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  performed, the precautions required, and the fire watch period. It must be
                  authorised by a competent person who has inspected the area and confirmed all
                  control measures are in place. The permit is typically valid for a single shift
                  only.
                </p>
              </div>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-3">Hot Work Control Measures</p>
                <ul className="space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span className="text-sm text-white">
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span className="text-sm text-white">
                      ...
                      and during the fire watch period
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  The fire watch person must remain in the work area with suitable extinguishing
                  equipment, checking for any signs of smouldering, smoke, unusual heat, or
                  discolouration. They must check above, below, and on the opposite side of any
                  partition walls or floors where sparks may have penetrated. A significant number
                  of hot work fires occur hours after the work has been completed &mdash; sparks can
                  smoulder in insulation or within wall cavities for extended periods before
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Arson is the{' '}
                <strong>largest single cause of commercial fires in the United Kingdom</strong>,
                accounting for approximately <strong>45%</strong> of all fires in commercial
                premises. It is also a significant cause of fire on construction sites, in schools,
                and in unoccupied buildings. Unlike other fire causes, arson is a criminal act
                &mdash; deliberate fire-setting with the intent to damage property, make an
                insurance claim, conceal another crime, or simply for the thrill of watching a fire.
              </p>

              <p>
                The impact of arson extends far beyond the direct fire damage. Arson fires tend to
                be more severe than accidental fires because the arsonist may use accelerants
                (petrol, paraffin, lighter fluid) and deliberately target areas that will promote
                rapid fire spread. Arson also tends to occur when premises are unoccupied &mdash;
                nights, weekends, and holidays &mdash; meaning the fire may burn for a considerable
                time before detection and fire service response.
              </p>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-3">Arson Risk Factors</p>
                <ul className="space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span className="text-sm text-white">
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Discarded cigarettes and other smoking materials remain a significant cause of fire
                in both domestic and workplace settings. A lit cigarette tip can reach temperatures
                of approximately <strong>700&deg;C</strong> &mdash; more than sufficient to ignite
                paper, dry grass, textiles, timber offcuts, plastic packaging, and many other common
                combustible materials found on construction sites and in commercial premises.
              </p>

              <p>
                The introduction of <strong>self-extinguishing cigarettes</strong> (also known as
                reduced ignition propensity cigarettes or RIP cigarettes) became mandatory across
                the European Union in <strong>November 2011</strong>. These cigarettes are designed
                to self-extinguish if not actively smoked, reducing the risk from carelessly
                discarded cigarettes. While this regulation has contributed to a reduction in
                smoking-related fires, it has not eliminated the risk entirely &mdash; particularly
                during the period when the cigarette is being actively smoked and immediately after
                disposal.
              </p>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-3">Workplace Smoking Controls</p>
                <ul className="space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span className="text-sm text-white">
                      ...
                      suitable non-combustible ashtrays or disposal containers
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Heating equipment &mdash; particularly portable and temporary heaters &mdash; is a
                well-documented cause of workplace and domestic fire. The risk is greatest during
                winter months when temporary heating is frequently used on construction sites, in
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  This is one of the most common causes of heating-related fires, both domestically
                  and on construction sites. Wet clothing draped over or placed near a heater will
                  dry out, then continue to heat until it reaches ignition temperature. Many of
                  these fires occur overnight or during breaks when the heater is left running
                  unattended.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Poor housekeeping is one of the most significant &mdash; and most preventable
                &mdash; contributors to workplace fire risk. The accumulation of combustible waste
                provides fuel. Blocked fire exits prevent evacuation. Propped-open fire doors
                destroy compartmentation. Storage in corridors and escape routes impedes both
                evacuation and fire service access. Each of these failures is a breach of the
                Regulatory Reform (Fire Safety) Order 2005 and each is routinely identified during
                fire risk assessments.
              </p>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-3">Key Housekeeping Fire Risks</p>
                <ul className="space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span className="text-sm text-white">
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span className="text-sm text-white">
                      ...
                      resistance. Smoke and fire will spread freely through the opening, destroying
                      the compartmentation strategy that protects escape routes and allows staged
                      evacuation
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span className="text-sm text-white">
                      ...
                      heat, and the crumpled mass insulates against heat loss. Over hours, the
                      temperature rises to ignition point without any external flame or spark
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span className="text-sm text-white">
                      ...
                      burning contents, potentially igniting surrounding waste
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <div className="grid sm:grid-cols-5 gap-2">
                  {[
                    ...
                    {
                      s: 'Set in Order',
                      desc: 'Organise remaining items so everything has a designated place',
                    },
                    { s: 'Shine', desc: 'Clean the area regularly; remove dust, oil, and debris' },
                    {
                      s: 'Standardise',
                      desc: 'Create consistent housekeeping procedures and checklists',
                    },
                    {
                      s: 'Sustain',
                      desc: 'Maintain discipline through regular audits and inspections',
                    },
                  ].map((item, i) => (
              ...
              <p>
                Regular housekeeping inspections &mdash; whether formal documented inspections or
                informal daily walkthroughs &mdash; are essential. The fire risk assessment should
                specify the frequency of housekeeping inspections and the standards to be
                maintained. On construction sites, the site manager or principal contractor has a
                duty under CDM 2015 to ensure that the site is kept in good order and that
                combustible waste is regularly removed.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Many workplaces store and use substances that are flammable, highly flammable,
                extremely flammable, explosive, or oxidising. These substances &mdash; ranging from
                common cleaning solvents and paints to industrial chemicals and compressed gases
                &mdash; present specific fire and explosion risks that must be managed under the{' '}
                <strong>
                  Dangerous Substances and Explosive Atmospheres Regulations (DSEAR) 2002
                </strong>{' '}
                and the{' '}
                <strong>Control of Substances Hazardous to Health (COSHH) Regulations 2002</strong>.
              </p>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Understanding UK fire statistics and learning from major incidents is essential for
                every fire safety professional. The Home Office publishes annual fire statistics for
                England, with equivalent data published by the devolved administrations for
                Scotland, Wales, and Northern Ireland. These statistics reveal the scale of the
                problem, the most common causes, and the long-term trends that inform fire safety
              ...
              <div className="bg-white/5 border border-white/10 rounded-lg overflow-hidden">
                ...
                <div className="p-4 space-y-3">
                  <p className="text-sm text-white">
                    ...
                    Kensington, London. The fire started in a fourth-floor flat due to a faulty
                  ...
                  <p className="text-sm text-white">
                    ...
                    <strong>
                      aluminium composite material (ACM) panels with a polyethylene (PE) core
                    </strong>{' '}
                    &mdash; a material that is combustible and, once ignited, burns rapidly and with
                    intense heat. The cladding system acted as a chimney, spreading fire vertically
                  ...
                  <p className="text-sm text-white">
                    ...
                    <strong>stay-put policy</strong> &mdash; which advises residents to remain in
                    their flats during a fire, relying on compartmentation to protect them &mdash;
                    became untenable. Residents who followed the stay-put advice were trapped by
                    fire entering from the exterior. The London Fire Brigade delayed the decision to
                    move to a simultaneous evacuation, a decision that the Grenfell Tower Inquiry
                  ...
                  <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-3">
                    ...
                    <ul className="text-xs text-white space-y-1.5">
                      <li className="flex items-start gap-2">
                        ...
                        <span>
                          Combustible cladding can cause catastrophic external fire spread,
                          completely bypassing internal fire protection measures
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-red-400" />
                        <span>
                          Compartmentation is only effective if it is maintained and if fire cannot
                          bypass it from the outside
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-red-400" />
                        <span>
                          Stay-put policies rely entirely on effective compartmentation &mdash; when
                          compartmentation fails, the policy must be immediately abandoned
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-red-400" />
                        <span>
                          Building safety regulation required fundamental reform &mdash; leading to
                          the Building Safety Act 2022 and the establishment of the Building Safety
                          Regulator
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-red-400" />
                        <span>
                          A small kitchen fire caused by a faulty appliance became the UK&rsquo;s
                          worst residential fire disaster &mdash; demonstrating how building design
                          failures can amplify a minor incident into a major catastrophe
                        </span>
                      </li>
                    </ul>
                  </div>
              ...
              <div className="bg-white/5 border border-white/10 rounded-lg overflow-hidden">
                ...
                <div className="p-4 space-y-3">
                  <p className="text-sm text-white">
                    ...
                    non-fire-rated panels that had been used to replace original asbestos-containing
                  ...
                  <p className="text-sm text-white">
                    ...
                    Approved Document B (fire safety) of the Building Regulations &mdash; a
                    recommendation that was not fully acted upon before the Grenfell Tower fire
                    eight years later.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 rounded-lg overflow-hidden">
                ...
                <div className="p-4 space-y-3">
                  <p className="text-sm text-white">
                    ...
                    production platform. The initial leak occurred because a pump that had been
                    taken out of service for maintenance was inadvertently brought back online
                  ...
                  <p className="text-sm text-white">
                    ...
                    <strong>permit-to-work systems and isolation procedures</strong> are critical
                    fire prevention measures, and a failure in communication about the status of
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  normalise risk through repeated safe experience. As an electrician and fire safety
                  professional, your role is to recognise these patterns, challenge complacency, and
                  ensure that fire prevention measures are maintained to the required standard
                  &mdash; because the consequences of failure are measured in human lives.
                </p>
              </div>
            </div>
          </div>
