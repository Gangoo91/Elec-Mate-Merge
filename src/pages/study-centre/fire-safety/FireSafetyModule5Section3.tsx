...
const quizQuestions = [
  ...
  {
    id: 3,
    question: 'What is the primary purpose of preserving a fire scene after an incident?',
    options: [
  ...
  {
    id: 4,
    question: "In root cause analysis, what does the '5 Whys' technique involve?",
    options: [
  ...
  {
    id: 6,
    question: 'What should happen with the lessons learned from a fire investigation?',
    options: [
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-rose-500/5 border-l-2 border-rose-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>RIDDOR</strong> requires reporting of serious fire incidents
              </li>
              <li>
                <strong>Scene preservation</strong> is critical for investigation
              </li>
              <li>
                <strong>Root cause analysis</strong> prevents recurrence
              </li>
              <li>
                <strong>Record keeping</strong> demonstrates compliance and aids learning
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-rose-500/5 border-l-2 border-rose-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              ...
              <li>
                <strong>RRFSO 2005:</strong> Responsible person&rsquo;s duties
              </li>
              <li>
                <strong>Fire and Rescue Services Act 2004:</strong> Investigation powers
              </li>
              <li>
                <strong>HSWA 1974:</strong> General duties for workplace safety
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                (RIDDOR) impose a legal duty on employers, the self-employed, and persons in control
                of premises to report certain workplace incidents to the Health and Safety Executive
                (HSE). While RIDDOR covers all types of workplace incident, fires have specific
                reporting triggers that every responsible person and fire marshal must understand.
              </p>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 sm:p-6 rounded-lg">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <p className="text-sm font-medium text-rose-400">
                    When a Fire Must Be Reported to RIDDOR
                  </p>
                </div>
                <div className="space-y-3">
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      Deaths occurring within one year and one day of the incident must also be
                      reported if the fire is believed to have contributed to the death.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      more than 24 hours, loss of consciousness caused by head injury or asphyxia,
                      and any injury likely to result in permanent loss of sight. Burns and smoke
                      inhalation are particularly common fire-related specified injuries.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      reported. Incapacitation means the worker is unable to carry out their normal
                      duties. This category applies only to workers, not to members of the public.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      fire{' '}
                      <strong>
                        affects or is liable to affect any occupied area of the premises
                      </strong>{' '}
                      or <strong>any escape route</strong>. This is a particularly important
                      category because it captures serious fires even where no injuries occur
                      &mdash; the potential for harm is sufficient to trigger the reporting duty.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  responsible person under RIDDOR is typically the employer or, for non-employees,
                  the person in control of the premises. Failure to report a RIDDOR-notifiable
                  incident is a criminal offence that can result in prosecution and an unlimited
                  fine.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                RIDDOR reports can be submitted through two channels, depending on the severity of
                the incident. Understanding which method to use and the associated timeframes is
                ...
                <div className="space-y-3">
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      <strong>10 days</strong>. The telephone line operates Monday to Friday
                      08:30&ndash;17:00; outside these hours, report the next working day.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    <div className="flex justify-between items-center mb-1">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      incapacitation starts from the day after the incident, but the 15-day
                      reporting window starts from the date of the incident itself.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    <div className="flex justify-between items-center mb-1">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      occupied areas. If the dangerous occurrence also involves a fatality or
                      specified injury, it must be reported by telephone immediately.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <p>
                The <strong>responsible person</strong> for making the RIDDOR report is typically
                the employer or, if the affected person is not an employee, the person in control of
                the premises where the incident occurred. In practice, this duty is often delegated
                to a health and safety manager, but the legal responsibility remains with the
                employer.
              </p>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 sm:p-6 rounded-lg">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <p className="text-sm font-medium text-rose-400">
                    Information Required for a RIDDOR Report
                  </p>
                </div>
                  ...
                  {[
                    {
                      ...
                      desc: 'Exact details of when and where the incident occurred',
                    },
                    {
                      label: 'Details of the injured person',
                      desc: 'Name, occupation, employer, nature of injury',
                    },
                    {
                      label: 'Description of the incident',
                      desc: 'What happened, how the fire started, how it developed',
                    },
                    {
                      label: 'Immediate actions taken',
                      desc: 'Evacuation, fire-fighting attempts, first aid administered',
                    },
                    {
                      label: 'Notifier details',
                      desc: 'Name, position, and contact details of the person making the report',
                    },
                    {
                      label: 'Premises details',
                      desc: 'Nature of the premises, activities carried on, fire safety measures in place',
                    },
                  ].map((item, i) => (
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  automatically generates a reference number and stores the report, but the
                  responsible person should also retain their own copy as part of the premises fire
                  safety records.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Beyond the statutory RIDDOR requirements, every organisation needs robust{' '}
                <strong>internal fire incident reporting procedures</strong>. These procedures
                capture incidents that may not reach the RIDDOR threshold but are still vital for
                fire safety management, learning, and continuous improvement.
              </p>
                ...
                <div className="space-y-3">
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      reported using a simple, accessible reporting form (paper or digital). A
                      no-blame culture is essential: employees must feel safe reporting near-misses
                      without fear of disciplinary action. Near-miss data is one of the most
                      valuable tools for preventing actual fires.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      dates and results, fire safety equipment testing and maintenance, fire safety
                      training delivered, and any fire safety inspections or audits. The log book
                      may be physical or electronic but must be readily accessible and kept up to
                      date.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      senior management &rarr; HR (if injuries) &rarr; legal/compliance (if
                      RIDDOR-reportable). Each level should have defined response timeframes and
                      responsibilities. Out-of-hours contacts must be established.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <p>
                Several external parties may also need to be notified following a fire incident,
              ...
              <ul className="space-y-2 text-sm text-white/70">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong>Insurance company</strong> &mdash; notify the insurer as soon as
                    practicable after any fire, regardless of the apparent severity. Failure to
                    notify promptly may invalidate the insurance policy or prejudice a claim. The
                    insurer may wish to appoint their own loss adjuster or fire investigator
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Landlord or managing agent</strong> &mdash; if the premises are leased
                    or part of a multi-occupied building, the landlord or managing agent must be
                    informed. They have responsibilities for common parts, shared fire safety
                    systems, and the building&rsquo;s overall fire risk assessment
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Staff and occupants</strong> &mdash; communicate factual information to
                    all staff about what happened, any temporary arrangements (relocated assembly
                    points, alternative exits), and any interim fire safety measures in place. Avoid
                    speculation about the cause until the investigation is complete
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Utility providers</strong> &mdash; if the fire has affected gas,
                    electricity, or water supplies, the relevant utility companies should be
                    contacted to make the supplies safe and arrange reinstatement
                  </span>
                </li>
              </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  blame or speculating on the cause before the investigation is complete; explain
                  any temporary fire safety arrangements; reassure staff that a thorough
                  investigation is under way; and invite staff to contribute any information they
                  may have about the incident. A formal staff briefing, followed by a written
                  communication, is good practice for any significant fire incident.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                , <strong>origin</strong>, and <strong>development</strong> of the fire.
                Understanding why a fire occurred is the foundation for preventing recurrence. The
                investigation process follows a structured methodology, beginning with scene
                preservation and ending with a formal report.
              </p>
                ...
                <div className="space-y-3">
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      authorised personnel should be allowed within the cordon. Appoint a person to
                      maintain the cordon log, recording anyone who enters or leaves the scene.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      such as covering a damaged roof or boarding up windows &mdash; can disturb
                      critical evidence. The scene should remain in the condition the fire service
                      left it after extinguishing the fire.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="space-y-3">
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      emergency services personnel, and anyone in the building at the time.
                      Statements should cover what the witness saw, heard, and smelt; the sequence
                      of events; the behaviour of the fire alarm; and any actions they took.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      show the origin, development, and spread of the fire, as well as the movements
                      of persons before, during, and after the incident.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      through the building. Also preserve any logs from sprinkler systems, smoke
                      control systems, access control systems, and building management systems.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      extinguisher service records, and any recent repair or installation work.
                      These records may reveal whether equipment failure or inadequate maintenance
                  ...
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      close-up views of specific items of interest. Physical evidence &mdash; such
                      as damaged electrical equipment, remnants of ignition sources, or samples of
                      materials involved in the fire &mdash; should be collected, labelled, and
                      stored securely for later examination.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <p>
                ...
                Using the evidence gathered &mdash; witness statements, CCTV footage, alarm logs,
                and physical evidence &mdash; the investigator builds a detailed timeline from the
                earliest indication of a problem through to the fire being extinguished. This
                timeline helps identify the point of origin, the cause of ignition, and the factors
                that contributed to fire growth and spread.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Identifying the <strong>immediate cause</strong> of a fire &mdash; the physical
                ignition mechanism &mdash; is only the first step. A thorough investigation must
                also identify the <strong>root cause</strong> (the underlying systemic failure) and
                any <strong>contributing factors</strong> that allowed the fire to occur, develop,
                or cause harm. Without addressing the root cause, the conditions for another fire
                remain in place.
              </p>
                ...
                <div className="space-y-3">
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      happened&rdquo; of the incident.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      failed to identify the hazard. This is the &ldquo;why it was allowed to
                      happen&rdquo; of the incident.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      fire alarm that delayed detection, inadequate training that resulted in
                      incorrect use of a fire extinguisher. Addressing contributing factors is
                      essential for a comprehensive prevention strategy.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 sm:p-6 rounded-lg">
                <p className="text-sm font-medium text-rose-400 mb-4 text-center">
                  The 5 Whys Technique &mdash; Example Fire Investigation
                </p>
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    <div className="flex items-center justify-center w-8 h-8 rounded-full bg-rose-500/20 border border-rose-500/40 text-rose-400 text-sm font-bold flex-shrink-0">
                      1
                    </div>
                    <div>
              ...
              <ul className="space-y-2 text-sm text-white/70">
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Fishbone (Ishikawa) diagram</strong> &mdash; a visual tool that
                    categorises potential causes into groups such as People, Procedures, Equipment,
                    Environment, Materials, and Management. The &ldquo;head&rdquo; of the fish
                    represents the fire, and the &ldquo;bones&rdquo; branch out into contributing
                    factors. This technique is particularly useful for complex incidents with
                ...
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Fault tree analysis</strong> &mdash; a top-down, deductive analysis that
                    starts with the fire (the &ldquo;top event&rdquo;) and works backwards through a
                    logical tree of events and conditions that could have caused it. Each branch
                    represents a different causal pathway, connected by logical AND/OR gates. Fault
                    tree analysis is more formal and is often used for complex industrial incidents
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Bow-tie analysis</strong> &mdash; combines a fault tree (showing causes)
                    with an event tree (showing consequences) around a central &ldquo;top
                    event&rdquo; (the fire). The left side shows preventive barriers that failed,
                    and the right side shows mitigating barriers that either worked or failed. This
                    provides a comprehensive view of both prevention and mitigation
                  </span>
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The ultimate purpose of any fire investigation is not merely to determine what
                happened, but to <strong>prevent it from happening again</strong>. The lessons
                learned process translates investigation findings into practical improvements that
                strengthen fire safety across the organisation.
              </p>
                ...
                <div className="space-y-3">
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      root cause and contributing factors, not just the immediate cause. For
                      example: &ldquo;Implement a mandatory electrical capacity review process for
                      all office layout changes, to be completed before any equipment is relocated.
                  ...
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      fire, whether the control measures were adequate, whether new hazards have
                      been created (damaged fire protection, compromised escape routes), and what
                      additional control measures are needed to prevent recurrence. The updated
                      assessment must be recorded and communicated to all relevant persons.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      requirements, introducing additional fire safety checks, and incorporating the
                      incident as a case study in fire safety training. Changed procedures must be
                      communicated to all affected staff and, where appropriate, practised through
                      fire drills.
                    </p>
                  </div>
                </div>
              ...
              <p>
                <strong>Communicating findings</strong> is essential for organisational learning.
              ...
              <ul className="space-y-2 text-sm text-white/70">
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Staff briefings</strong> &mdash; present the key findings and new
                    procedures to all staff in a clear, accessible format. Focus on what has changed
                    and why, not on blame
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Safety bulletins</strong> &mdash; circulate written safety alerts or
                    bulletins summarising the incident and the lessons learned, particularly if the
                ...
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Training updates</strong> &mdash; incorporate the incident as a case
                    study in fire safety training programmes so that the learning reaches all new
                    starters as well as existing staff
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Industry sharing</strong> &mdash; consider sharing anonymised lessons
                    with industry bodies, trade associations, and fire authority publications. The
                    fire and rescue service publishes investigation summaries; trade bodies
                    circulate safety alerts; and organisations such as the Institution of Fire
                    Engineers share learning through their professional networks
                  </span>
                </li>
              </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  deadlines, tracks progress, and provides evidence of completion. The responsible
                  person should review the tracker regularly and escalate any overdue actions.
                  Completion of corrective actions should be verified through inspection or audit,
                  not simply accepted as done.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The <strong>Fire and Rescue Services Act 2004</strong> gives fire and rescue
                authorities extensive powers to investigate the cause and origin of fires.
                Understanding these powers and the cooperation requirements placed on the
                responsible person is essential for fire marshals and building managers.
              </p>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 sm:p-6 rounded-lg">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <p className="text-sm font-medium text-rose-400">
                    Fire Investigation Officers&rsquo; Powers
                  </p>
                </div>
                <div className="space-y-3">
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      carry out any examination or investigation necessary to determine the cause
                      and origin of the fire. They do not require the permission of the occupier or
                      owner to enter, although they must produce identification if requested.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      the production of any documents, records, or other items relevant to the
                      investigation. Obstruction of a fire investigation officer exercising these
                  ...
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      specialists, or representatives of other agencies. The information gathered
                      may be shared with other investigating bodies (police, HSE) where appropriate.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="space-y-3">
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      investigation, with the fire investigator focusing on the technical cause and
                      origin, and the police focusing on identifying suspects, motives, and
                      gathering evidence for prosecution. The scene becomes a crime scene and is
                      subject to the more stringent rules of criminal evidence handling.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    <p className="text-sm font-medium text-white mb-1">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      Safety at Work etc. Act 1974. The HSE&rsquo;s focus is on whether the employer
                      complied with their duties under health and safety legislation and the RRFSO.
                      The fire service and HSE will coordinate their investigations to avoid
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  and records; making relevant staff available for interview; not interfering with
                  or concealing evidence; and facilitating the investigation in every reasonable
                  way. Failure to cooperate can constitute a criminal offence and may also result in
                  adverse inferences being drawn during any subsequent enforcement or prosecution
                  proceedings.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Comprehensive fire safety record keeping is not merely good practice &mdash; it is a{' '}
                <strong>legal requirement</strong> under the RRFSO and a critical element of
                demonstrating compliance. Records provide the evidence base for the fire risk
                assessment, document the effectiveness of fire safety measures, and create an audit
                trail that is invaluable during inspections, investigations, and enforcement
                proceedings.
              </p>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 sm:p-6 rounded-lg">
                ...
                <div className="grid sm:grid-cols-2 gap-3">
                  {[
                    {
                      label: 'Fire alarm activations',
                      desc: 'Every activation: date, time, zone, cause (genuine alarm, false alarm, testing)',
                    },
                    {
                      label: 'False alarms',
                      desc: 'Recorded separately to identify patterns and reduce unwanted alarms — a high false alarm rate can lead to complacency',
                    },
                    {
                      label: 'Fire drills',
                      desc: 'Date, time, evacuation time, number of occupants, observations, fire marshal performance, corrective actions',
                    },
                    {
                      label: 'Equipment maintenance',
                      desc: 'Extinguisher servicing, alarm system maintenance, emergency lighting testing, sprinkler inspections, fire door checks',
                    },
                    {
                      label: 'Training records',
                      desc: 'Who was trained, when, by whom, on what topics, assessment results, refresher dates',
                    },
                    {
                      label: 'Fire incidents',
                      desc: 'All incidents regardless of severity, including near-misses: date, time, location, description, persons involved, actions taken',
                    },
                    {
                      label: 'Investigation reports',
                      desc: 'Formal investigation findings, root cause analysis, recommendations, corrective actions, and evidence of implementation',
                    },
                    {
                      label: 'Fire risk assessment',
                      desc: 'The current assessment plus all previous versions, showing the review history and how risks have been managed over time',
                    },
                  ].map((item, i) => (
                    <div key={i} className="bg-white/5 border border-white/10 rounded-lg p-3">
                      <p className="text-sm font-medium text-white">{item.label}</p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  the power to require the production of any documents or records kept under the
                  Order. Failure to produce records when requested can result in enforcement action.
                  Records should be well-organised, clearly indexed, and stored in a known and
                  accessible location. If electronic, ensure they are backed up and can be produced
                  in a printable format. A fire safety records management system &mdash; whether a
                  simple filing cabinet or a digital platform &mdash; should be established and
                  maintained by a designated person.
                </p>
              </div>
            </div>
          </div>
