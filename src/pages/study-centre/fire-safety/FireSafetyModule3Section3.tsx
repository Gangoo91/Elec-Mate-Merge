...
const quizQuestions = [
  {
    id: 1,
    question:
      'At what height above floor level should manual call points be mounted according to BS 5839 Part 1?',
    options: ['1.0 m', '1.2 m', '1.4 m', '1.8 m'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['500 m²', '1,000 m²', '2,000 m²', '5,000 m²'],
    correctAnswer: 2,
    explanation:
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-rose-500/5 border-l-2 border-rose-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Control panel:</strong> The brain of the system &mdash; receives, processes,
                outputs
              </li>
              <li>
          ...
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                <strong>warn all occupants to evacuate</strong> in the event of a fire. A
                well-designed fire alarm system detects fire at the earliest possible stage, raises
                the alarm throughout the building, and provides clear indication of the location of
                the fire to aid fire-fighting operations. The design, installation, commissioning,
                and maintenance of fire alarm systems in the UK is governed by{' '}
                <strong>
                  BS 5839 Part 1: Fire detection and fire alarm systems for buildings &mdash; Code
                  of practice for design, installation, commissioning and maintenance of systems in
              ...
              <p>
                A fire alarm system comprises several interconnected components, each with a
                specific role. The reliability of the entire system depends on every component
                functioning correctly. Understanding each component and its purpose is essential for
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      The &ldquo;brain&rdquo; of the system &mdash; receives signals from detectors
                      and call points, processes them, and activates the appropriate outputs
                      (sounders, VADs, door releases, etc.)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Manual call points:</strong> Break-glass
                      devices that allow any person discovering a fire to raise the alarm manually
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Automatic detectors:</strong> Smoke detectors,
                      heat detectors, flame detectors, and multi-sensor detectors that detect fire
                  ...
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Alarm sounders:</strong> Devices that produce
                      audible warnings &mdash; bells, electronic sounders, or voice alarm speakers
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Visual alarm devices (VADs):</strong> Red
                      beacons that provide a visual warning for hearing-impaired persons or noisy
                      environments
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Cabling:</strong> Fire-resistant cables
                      connecting all devices to the control panel, designed to maintain circuit
                  ...
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Power supplies:</strong> Mains supply with
                      battery backup (minimum 24 hours standby plus 30 minutes in alarm condition)
                      to ensure the system operates during a mains failure
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-rose-400">BS 5839 Part 1:</strong> This is the primary
                  British Standard for fire detection and alarm systems in non-domestic premises. It
                  covers system categories (L1 to L5 for life protection, M for manual systems,
                  P1/P2 for property protection), system design, device selection and siting,
                  installation, commissioning, maintenance, and false alarm management. Every fire
                  alarm system should be designed, installed, and maintained in accordance with this
                  standard.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Manual call points (MCPs) &mdash; commonly known as{' '}
                <strong>break-glass units</strong> &mdash; are the most familiar component of a fire
                alarm system. They allow any person who discovers a fire to raise the alarm
                immediately by pressing or breaking the front element of the device. The break-glass
                type is the most common type in the UK, identified by its red colour and the
                instruction &ldquo;BREAK GLASS &mdash; PRESS HERE&rdquo;.
              </p>
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  an emergency). It is essential that building occupants understand the difference.
                  The two types should never be sited immediately adjacent to each other, and clear
                  signage must distinguish their purposes. Activating a green break-seal releases a
                  door lock; activating a red break-glass raises the fire alarm. Confusion between
                  the two can delay evacuation or cause unnecessary alarm activations.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Fire alarm sounders are the audible warning devices that alert building occupants to
                evacuate. The type of sounder, its location, and its sound level are all critical to
                ensuring that every person in the building hears the alarm and understands that they
                must evacuate. Visual alarm devices (VADs) provide an additional visual warning for
                persons who are hearing-impaired or who are in environments where ambient noise may
                mask the audible alarm.
              </p>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">General areas:</strong> Minimum 75 dB, or 5 dB
                      above the ambient background noise level, whichever is greater
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Sleeping areas (no closed door):</strong>{' '}
                      Minimum 65 dB at bed head
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">
                        Sleeping areas (closed door between sounder and bed):
                      </strong>{' '}
                      Minimum 75 dB at bed head
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Background noise consideration:</strong> The
                      alarm must always be at least 5 dB above the typical background noise in the
                      area to be clearly distinguishable
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="text-sm text-white/80 space-y-3">
                  <p>
                    ...
                    able to hear audible sounders. They use{' '}
                    <strong className="text-white">red</strong> flashing or pulsating beacons to
                    provide a visual fire warning. BS 5839 Part 1 provides guidance on their
                  ...
                  <ul className="space-y-1.5">
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                      <span>
                        <strong className="text-white">Pulsating:</strong> Flashing beacons are more
                        attention-grabbing and are the standard type for fire alarm VADs
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                      <span>
                        <strong className="text-white">Red colour:</strong> Red is reserved
                        exclusively for fire alarm beacons to avoid confusion with other visual
                        signals
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                      <span>
                        <strong className="text-white">Wall-mounted:</strong> Positioned to be
                        visible from all areas of the room, typically at high level
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                      <span>
                        <strong className="text-white">Ceiling-mounted:</strong> Used where wall
                        mounting is not practical, or in open-plan spaces to achieve wide coverage
                      </span>
                    </li>
                  </ul>
                </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The fire alarm control and indicating equipment (CIE) &mdash; commonly referred to
                as the fire alarm control panel &mdash; is the central hub of the fire alarm system.
                It receives signals from all detection and manual activation devices, processes
                those signals according to pre-programmed logic, and activates the appropriate
                outputs. The panel also provides indications to building management and the fire and
                rescue service about the status of the system and the location of any fire
                condition.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Fire:</strong> A detector or call point has
                      been activated. The panel identifies the zone and (on addressable systems) the
                      specific device. Red LED or display indication.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Fault:</strong> A wiring fault, device failure,
                      or communication problem has been detected. Amber/yellow LED indication.
                  ...
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Disable:</strong> A zone, device, or output has
                      been deliberately disabled (e.g. during maintenance or building works). Must
                      be recorded in the log book and reversed as soon as possible.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Test:</strong> The system or a zone is in test
                      mode (walk test). Prevents full alarm activation during testing.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-white/80">
                    ...
                    <strong className="text-white">Mimic panels</strong> display a graphical
                    representation of the building showing the location of each zone and indicating
                    which zones are in alarm. Zone plans at the panel location help fire-fighters
                    quickly identify where in the building the alarm has originated.
                  </p>
                </div>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-white/80">
                    ...
                    <strong className="text-white">EN 54-21</strong>. Remote monitoring ensures that
                    fire alarm activations and fault conditions are reported to a manned centre even
                    when the building is unoccupied. The ARC can then alert the fire and rescue
                    service, the responsible person, or a keyholder as appropriate.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  systems shut down, which lifts recall to the ground floor, and which suppression
                  systems activate. This programming is unique to each building and must be designed
                  by a competent fire alarm engineer. It is documented in a{' '}
                  <strong className="text-white">cause-and-effect matrix</strong> that forms a key
                  part of the system commissioning documentation.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Fire alarm zoning divides a building into smaller, identifiable areas so that when a
                detector or call point activates, the control panel can indicate{' '}
                <strong>where</strong> in the building the fire has been detected. Without zoning,
                the fire brigade would know only that there was an alarm somewhere in the building,
                making it much harder to locate and fight the fire quickly.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Zone size limit:</strong> The search area for a
                      single zone must not exceed <strong className="text-white">2,000 m²</strong>,
                      ensuring the fire can be located quickly
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Floor-by-floor:</strong> Each floor of a
                      multi-storey building should generally be a separate zone (or multiple zones
                      if the floor area is large)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Zone plans:</strong> Clear zone plans must be
                      displayed at the fire alarm control panel location, showing the extent of each
                      zone and the position of detection devices within it
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Detection vs sounder zones:</strong> Detection
                      zones identify where the fire is; sounder zones define where the alarm sounds.
                      In a simple system, all sounders activate simultaneously. In a phased system,
                      only certain sounder zones activate initially
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <div className="text-sm text-white/80 space-y-3">
                  <p>
                    ...
                    strategies are used to manage evacuation more effectively:
                  </p>
                  <div className="grid sm:grid-cols-2 gap-3">
                    <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                      ...
                      <p className="text-xs text-white/80">
                        ...
                        service to use dedicated fire-fighting lifts and lobbies without being
                        impeded by large numbers of evacuating occupants.
                      </p>
                    </div>
                    <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                      ...
                      <p className="text-xs text-white/80">
                        ...
                        approach reduces unnecessary evacuations caused by false alarms while
                        maintaining safety.
                      </p>
                    </div>
                  </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                False alarms are one of the most significant problems in fire safety management.
                They desensitise building occupants, who begin to ignore or respond slowly to alarm
                activations. They waste fire and rescue service time and resources, diverting
                appliances from genuine emergencies. Persistent false alarms can result in the fire
                service charging the responsible person for attendance, and in extreme cases, the
                fire service may decide not to respond automatically to repeat offender premises.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Appropriate detector selection:</strong> Use
                      heat detectors in kitchens and dusty environments where smoke detectors would
                      cause false alarms. Use multi-sensor detectors for better discrimination.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Correct siting:</strong> Ensure detectors are
                      positioned away from cooking appliances, steam sources, ventilation outlets,
                      and other potential false alarm sources.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Analogue-addressable sensitivity:</strong>{' '}
                      Modern analogue-addressable systems allow individual detector sensitivity to
                      be adjusted. Detectors in areas prone to false alarms can have their threshold
                      increased (with careful risk assessment).
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Investigation delays:</strong> A programmed
                      delay at the control panel gives staff time to investigate before the full
                      alarm sounds. This must be supported by a formal risk assessment and trained
                      staff.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Call point covers:</strong> Transparent hinged
                      covers over manual call points deter accidental or malicious activation while
                      still allowing genuine use.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Management protocols:</strong> Formal
                      procedures for managing alarm activations, investigation, and recording in the
                      fire alarm log book. Regular review of false alarm data to identify patterns
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-rose-400">Log Book:</strong> Every fire alarm activation
                  &mdash; whether genuine or false &mdash; must be recorded in the fire alarm log
                  book. The log should include the date, time, zone, device, cause (if known),
                  action taken, and who investigated. This data is invaluable for identifying
                  patterns, tracking repeat problem areas, and demonstrating compliance during fire
                  safety audits. The log book forms part of the premises&rsquo; fire safety records
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Voice alarm systems use spoken messages &mdash; either pre-recorded or delivered
                live via a microphone &mdash; instead of or alongside conventional alarm sounders.
                They are governed by <strong>BS 5839 Part 8</strong> and must meet the voice
                intelligibility requirements of <strong>BS 7443</strong>. Voice alarm systems are
                increasingly specified in complex buildings where conventional sounders alone would
                not provide sufficiently clear guidance to occupants.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Pre-recorded messages:</strong> Standardised
                      evacuation instructions that play automatically when the alarm activates.
                      Messages are typically recorded by a professional voice artist for clarity and
                      authority.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Live microphone capability:</strong> Allows
                      trained staff or the fire service to make live announcements, providing
                      real-time instructions that adapt to the developing situation.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Phased evacuation messaging:</strong> Different
                      messages can be sent to different zones simultaneously &mdash; essential for
                      tall buildings using phased evacuation. The fire floor receives an
                      &ldquo;evacuate now&rdquo; message while other floors receive an &ldquo;alert
                      &mdash; await further instruction&rdquo; message.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Multi-language support:</strong> In buildings
                      with occupants who speak different languages, messages can be delivered in
                      multiple languages sequentially.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-rose-400">BS 7443 &mdash; Voice Intelligibility:</strong>{' '}
                  It is not enough for a voice alarm message to be loud enough. It must also be{' '}
                  <strong>intelligible</strong> &mdash; the words must be clearly understood by the
                  listener. BS 7443 sets out methods for measuring and verifying voice
                  intelligibility in buildings. Factors that affect intelligibility include
                  reverberation, background noise, speaker placement, and the frequency response of
                  the speaker system. Voice intelligibility must be tested during commissioning and
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                A fire alarm system does not operate in isolation. In modern buildings, the fire
                alarm system integrates with a range of other building systems to ensure a
                co-ordinated and effective response to a fire. These interfaces are defined in the{' '}
                <strong>cause-and-effect matrix</strong> and must be designed, installed, and
                commissioned by competent persons. Failures in system integration can have serious
                consequences &mdash; a fire door that does not release, a ventilation system that
                continues to spread smoke, or a lift that does not recall to the ground floor.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Door hold-open devices:</strong>{' '}
                      Electromagnetic devices that hold fire doors open during normal use. On alarm
                      activation, the magnets de-energise, releasing the doors to close under their
                      self-closing mechanism. This compartmentalises the building and prevents the
                  ...
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Smoke control systems:</strong> Smoke
                      ventilation systems, pressurisation systems, and smoke curtains that activate
                      on alarm to control the movement of smoke and maintain tenable conditions on
                      escape routes.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">HVAC shutdown:</strong> Heating, ventilation,
                      and air conditioning systems are shut down on alarm to prevent the spread of
                      smoke through ductwork. Dampers close to compartmentalise the duct system.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Security and access control:</strong>{' '}
                      Security-locked doors on escape routes must unlock automatically on alarm to
                      allow free egress. Turnstiles and barriers must fail-safe to the open
                      position.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Lift recall:</strong> Lifts are recalled to the
                      ground floor (or a designated level) and taken out of service on alarm. This
                      prevents occupants from using lifts during a fire and ensures the lifts are
                      available for fire service use if required.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong className="text-white">Suppression systems:</strong> In some
                      installations, the fire alarm system interfaces with automatic suppression
                      systems (sprinklers, gas suppression, water mist) to provide co-ordinated
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1.5">
                  ...
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      Specific sounders, VADs, door releases, HVAC, lifts, and suppression for each
                      scenario
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  must be thoroughly tested during commissioning, with each cause-and-effect
                  scenario verified. The commissioning certificate and the cause-and-effect matrix
                  must be retained as part of the building&rsquo;s fire safety documentation. Any
                  subsequent changes to the building, its use, or its systems must be reflected in
                  an updated cause-and-effect matrix.
                </p>
              </div>
            </div>
          </div>
