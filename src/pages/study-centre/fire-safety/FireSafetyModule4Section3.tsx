...
const faqs = [
  ...
  {
    question:
      'How do you manage assembly and roll call for a building with hundreds or thousands of occupants?',
    answer:
...
const quizQuestions = [
  ...
  {
    id: 3,
    question: 'Who is responsible for ensuring visitors are accounted for during an evacuation?',
    options: [
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-rose-500/5 border-l-2 border-rose-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Assembly points:</strong> Safe gathering location, 15-20m minimum distance
              </li>
              <li>
                <strong>Roll call:</strong> Pre-prepared lists, zone-based accounting
              </li>
              <li>
                <strong>Visitors:</strong> Sign-in system essential for accountability
              </li>
              <li>
                <strong>No re-entry</strong> until all-clear from fire service or RP
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-rose-500/5 border-l-2 border-rose-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>RRFSO Art. 15:</strong> Procedures for serious and imminent danger
              </li>
              <li>
                <strong>BS ISO 7010:</strong> Assembly point signage standard
              </li>
              <li>
                <strong>Fire &amp; Rescue Services Act 2004:</strong> Authority to prevent re-entry
              </li>
              <li>
                <strong>CDM 2015:</strong> Construction site fire safety coordination
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                An <strong>assembly point</strong> is a designated safe location where all building
                occupants gather following an evacuation. It is far more than simply a place to
                stand &mdash; it serves several critical safety functions that are fundamental to
                the emergency procedures required under the Regulatory Reform (Fire Safety) Order
                2005 (RRFSO).
              </p>
              ...
              <ul className="space-y-2 text-sm text-white/70">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong>Safe gathering location</strong> &mdash; provides a place of safety at a
                    sufficient distance from the building where evacuees are protected from the
                    effects of fire, including radiant heat, smoke, falling debris, and potential
                    structural collapse
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Confirming all persons are accounted for</strong> &mdash; enables roll
                    call to be conducted so that any missing persons can be identified and reported
                    to the fire and rescue service for search and rescue
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Providing information to the fire service</strong> &mdash; the assembly
                    point is where the fire and rescue service receives critical information about
                    the number of people evacuated, missing persons, the suspected fire location,
                    and any hazardous materials or persons requiring rescue assistance
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Preventing re-entry</strong> &mdash; by gathering everyone at a single
                    controlled location, it is easier to prevent individuals from re-entering the
                    building before the all-clear has been given
                  </span>
                </li>
              </ul>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-rose-400">Legal Basis:</strong> Article 15 of the RRFSO
                  requires the Responsible Person to establish and, where necessary, implement
                  procedures for serious and imminent danger. This includes nominating a sufficient
                  number of competent persons to implement those procedures insofar as they relate
                  to evacuation, and ensuring that persons are informed of arrangements. The
                  designation and management of assembly points is a fundamental part of these
                  procedures. Failure to establish adequate assembly point arrangements is a breach
                  of Article 15 and may result in enforcement action by the fire and rescue
                  authority.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The selection of an assembly point is a critical decision that must be made as part
                of the fire risk assessment. A poorly chosen assembly point can compromise the
                safety of evacuees, obstruct the fire service, or become untenable due to smoke or
                heat exposure. The following criteria must be considered:
              </p>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 sm:p-6 rounded-lg">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <p className="text-sm font-medium text-rose-400">
                    Assembly Point Selection Criteria
                  </p>
                </div>
                <div className="space-y-3">
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      buildings or those storing flammable materials may require a greater distance.
                      The assembly point must be far enough away that evacuees are not exposed to
                      dangerous levels of heat radiation, which can cause burns at surprisingly long
                      distances from a fully developed fire.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      frontage. An assembly point that blocks these access routes could delay the
                      fire service response and endanger both evacuees and firefighters.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      with mobility impairments. The surface must be level and free from trip
                      hazards.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      to specific assembly areas. The capacity calculation should account for peak
                      occupancy plus visitors and contractors.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      designated for use when conditions make the primary assembly point untenable.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      location. Signs must be positioned at the assembly point itself and along
                      evacuation routes directing people towards it. The signs must be visible in
                      all lighting conditions, including darkness (photoluminescent or illuminated).
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  primary assembly area, a fire affecting the route to the primary point, or
                  construction works blocking access. The alternative assembly point must meet the
                  same selection criteria as the primary point. All occupants must be informed of
                  both the primary and alternative locations, and signage must be provided for both.
                  The fire evacuation procedure should specify who has the authority to redirect
                  evacuees to the alternative point and how this decision is communicated during an
                  active evacuation.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                An assembly point is only effective if it is properly managed during an evacuation.
                Without a designated person in charge and the right equipment, roll call cannot be
                conducted, information cannot be relayed to the fire service, and chaos can
              ...
              <ul className="space-y-2 text-sm text-white/70">
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Designated assembly point controller</strong> &mdash; a trained person
                    (typically a senior fire marshal or a specifically appointed individual) who
                    takes charge at the assembly point, oversees roll call, receives reports from
                    fire marshals, and acts as the primary point of contact for the fire and rescue
                    service. A deputy must also be designated in case the primary controller is
                    absent, off-site, or incapacitated
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Equipment: clipboard and roll call list</strong> &mdash; a pre-prepared
                    list of all persons expected to be in the building. This list must be{' '}
                    <strong>updated daily</strong> (or per shift) to reflect staff absences,
                    visitors, and contractors. The list should be stored in a known location (grab
                    bag) near the exit used to reach the assembly point, so it can be collected
                    quickly during an evacuation
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>High-visibility vest or tabard</strong> &mdash; the assembly point
                    controller and fire marshals should wear high-visibility vests or tabards
                    clearly marked with their role (e.g., &ldquo;Fire Marshal&rdquo;,
                    &ldquo;Assembly Point Controller&rdquo;). This makes them easily identifiable by
                    evacuees, other marshals, and the fire service, especially in large crowds or
                ...
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Radio or communication device</strong> &mdash; a two-way radio or mobile
                    phone is essential for communication between the assembly point controller, fire
                    marshals who may still be completing their sweep of the building, and the
                    incident controller. Radio protocol should be agreed in advance, using clear,
                    concise language and avoiding jargon
                  </span>
                </li>
              </ul>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-rose-400">Zone/Floor Segregation:</strong> For buildings
                  with multiple floors or zones, the assembly point should be organised into clearly
                  marked sections corresponding to the building zones. People from Floor 1 gather in
                  the Floor 1 area, Floor 2 in the Floor 2 area, and so on. This dramatically speeds
                  up the roll call process because each fire marshal can conduct their roll call
                  within a defined area rather than searching through an unorganised crowd. Zone
                  markers can be simple signs on posts, cones with labels, or designated areas
        ...
        <section className="mb-10">
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The roll call is the process by which the assembly point coordinator confirms that
                all persons known to be in the building have been accounted for at the assembly
                point. It is one of the most critical aspects of the emergency procedure, because
                the information gathered during roll call directly determines whether the fire and
                rescue service needs to conduct a search and rescue operation inside the burning
                building.
              </p>

              <p>
                <strong>Pre-prepared lists</strong> are the foundation of an effective roll call.
                These lists must be:
              </p>
              ...
              <ul className="space-y-2 text-sm text-white/70">
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Updated daily</strong> &mdash; reflecting staff who are present, absent,
                    on leave, working from home, or on different shifts. An outdated list will
                    produce inaccurate results, potentially leading to unnecessary search and rescue
                    operations or, worse, failing to identify a genuinely missing person
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Organised by zone or floor</strong> &mdash; so that each fire marshal
                    has a list relevant to their area of responsibility, rather than a single list
                ...
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Inclusive of visitors and contractors</strong> &mdash; the visitor
                    sign-in record and contractor register must be incorporated into the roll call
                    process
                  </span>
                </li>
              </ul>
              ...
              <p>
                Each <strong>fire marshal reports their zone-clear status</strong> to the assembly
                point coordinator. The report should state clearly: &ldquo;Floor 3 &mdash; all
                accounted for&rdquo; or &ldquo;Floor 3 &mdash; two persons unaccounted for:
                [names]&rdquo;. Any <strong>missing persons must be reported immediately</strong> to
                the coordinator, who will relay this information to the fire and rescue service. The
                fire service will then prioritise a search of the relevant area.
              </p>

              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-rose-400">Critical Rule:</strong> Under no circumstances
                  should anyone re-enter the building to search for a missing person. This is the
                  responsibility of the trained and equipped fire and rescue service. Re-entry by
                  untrained persons has resulted in numerous deaths and is one of the most dangerous
                  actions that can be taken during a fire emergency.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Visitors and contractors present a particular challenge for fire safety because they
                are typically unfamiliar with the building layout, the evacuation procedure, and the
                location of the assembly point. They may not know where the nearest exit is, may not
                recognise the fire alarm, and will not appear on the standard staff roll call list
                unless specific arrangements are in place.
              </p>

              <p>
                A <strong>visitor sign-in system</strong> is essential. This is not merely an
                administrative convenience &mdash; it is a fire safety requirement under Article 15
                of the RRFSO, which mandates that procedures for serious and imminent danger must
              ...
              <ul className="space-y-2 text-sm text-white/70">
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Visitor sign-in must record:</strong> the visitor&rsquo;s name, company
                    (if applicable), the person they are visiting (the host), the time of arrival,
                    and a visitor badge or pass number. A visitor badge is also helpful for
                    identification at the assembly point
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Host responsibility:</strong> the person being visited (the host) is
                    responsible for their visitor&rsquo;s safety. The host should brief the visitor
                    on the fire evacuation procedure, point out the nearest exit and the assembly
                    point location, and accompany the visitor to the assembly point during an
                    evacuation
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Sign-out on departure:</strong> visitors must sign out when they leave.
                    This is critical because a visitor who has left the building but not signed out
                    will appear as a missing person during roll call, potentially triggering an
                    unnecessary and dangerous search and rescue operation by the fire service
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Electronic visitor management systems</strong> &mdash; many modern
                    buildings use electronic sign-in systems (tablets, kiosks) that automatically
                    generate a real-time list of visitors currently on the premises. These systems
                    can be integrated with the access control system and can generate visitor lists
                    at the touch of a button for use at the assembly point
                  </span>
                </li>
              </ul>
              ...
              <ul className="space-y-2 text-sm text-white/70">
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Contractor permits and induction:</strong> all contractors should
                    receive a fire safety induction before starting work, covering the fire alarm,
                    evacuation routes, and assembly point. This should be documented as part of the
                ...
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Contractor register:</strong> a separate register of all contractors on
                    site, maintained by the facilities team or the contractor&rsquo;s supervisor.
                    The register must be available at the assembly point for roll call purposes
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Construction sites &mdash; contractor muster points:</strong> on
                    construction sites, each principal contractor may have their own muster point.
                    The overall site fire safety plan must coordinate these to ensure a complete
                    roll call across all contractors. This is covered in more detail in Section 08
                  </span>
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Effective communication during an emergency assembly is critical. The fire and
                rescue service needs accurate, consolidated information as quickly as possible to
                make operational decisions &mdash; particularly whether anyone is unaccounted for
                and may be trapped inside the building. A structured{' '}
                <strong>communication chain</strong> ensures information flows reliably and is not
                lost, duplicated, or contradicted.
              </p>

              <p>The communication chain operates as follows:</p>
              ...
              <p>
                <strong>Radio protocol</strong> should be established in advance. Communications
                should be:
              </p>
              ...
              <ul className="space-y-2 text-sm text-white/70">
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Clear and concise</strong> &mdash; use plain language, avoid jargon or
                    abbreviations that may not be understood by all parties
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Structured</strong> &mdash; follow a standard format: identify yourself,
                    state the zone/floor, state the status (all clear or unaccounted persons), then
                ...
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Confirmed</strong> &mdash; the receiving party should repeat back key
                    information (especially the number of missing persons and their names) to avoid
                    miscommunication
                  </span>
                </li>
              </ul>
              ...
              <ul className="space-y-2 text-sm text-white/70">
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Numbers evacuated</strong> &mdash; total headcount at the assembly
                    point, broken down by zone if possible
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Missing persons</strong> &mdash; names, last known locations, and any
                    relevant details (e.g., mobility impairments, hearing impairments)
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Fire location</strong> &mdash; the suspected location and nature of the
                    fire, if known (e.g., &ldquo;fire in the kitchen on the second floor&rdquo;)
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Hazardous substances</strong> &mdash; the presence and location of any
                    hazardous materials, chemicals, compressed gases, or radioactive sources that
                ...
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Disabled persons awaiting rescue</strong> &mdash; the names and
                    locations of any persons who are waiting in a place of relative safety (refuge
                    area) and require the fire service to assist with their evacuation
                  </span>
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Preventing re-entry to the building is one of the most important safety controls
                during a fire evacuation. People may attempt to re-enter for a variety of reasons:
                to retrieve personal belongings (laptop, car keys, wallet), to search for a
                colleague or family member, to attempt to fight the fire themselves, or simply
                because they believe the alarm is false and the emergency is over. Every one of
                these reasons is insufficient justification for the potentially fatal risk of
                re-entering a building that may be on fire.
              </p>

              <p>
                Re-entry is not permitted until the <strong>all-clear</strong> has been given. The
              ...
              <ul className="space-y-2 text-sm text-white/70">
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>The fire and rescue service</strong> &mdash; if they have attended the
                    scene. The incident commander will confirm when the building is safe for
                    re-occupation. Under the <strong>Fire and Rescue Services Act 2004</strong>{' '}
                    (Section 44), the fire service has the legal authority to take charge of the
                    scene, establish cordons, and prohibit entry to buildings
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>The Responsible Person (RP)</strong> &mdash; if the fire service has not
                    attended (for example, after a confirmed false alarm). The RP must be satisfied
                    that there is no risk before authorising re-entry
                  </span>
                </li>
              </ul>
              ...
              <ul className="space-y-2 text-sm text-white/70">
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Physical barriers</strong> &mdash; fire doors with electromagnetic locks
                    that engage when the alarm sounds, preventing the door from being opened from
                    the outside. Barrier tape or cones may be deployed at entrances by fire marshals
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Fire marshals stationed at entrances</strong> &mdash; designated fire
                    marshals should be positioned at all building entrances to physically prevent
                    anyone from re-entering. This is one of the most effective methods because it
                    provides a human presence who can explain why re-entry is prohibited and report
                    any attempts
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Clear communication</strong> &mdash; the assembly point coordinator
                    should announce that the building is closed and re-entry is prohibited. This
                    should be repeated periodically, especially if the evacuation is prolonged
                  </span>
                </li>
              </ul>
                ...
                <div className="flex items-start gap-2">
                  ...
                  <p className="text-sm text-white">
                    <strong className="text-rose-400">
                      Fire and Rescue Services Act 2004 &mdash; Section 44:
                    </strong>{' '}
                    This section gives fire and rescue authority employees (firefighters) the power
                    to do anything they reasonably believe to be necessary for the purpose of
                    extinguishing fires, protecting life, or protecting property. This includes
                    establishing cordons, closing roads, and prohibiting entry to buildings.
                    Obstructing or impeding a firefighter exercising these powers is a criminal
                    offence under Section 49 of the Act.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Construction sites present unique challenges for assembly point management and roll
                call. The workforce changes daily, the site layout evolves continuously as
                construction progresses, and multiple contractors and sub-contractors may be working
                simultaneously with limited coordination between them. Fire safety on construction
                sites is governed by the RRFSO (which applies to all workplaces) and the
                Construction (Design and Management) Regulations 2015 (CDM 2015), which place
              ...
              <ul className="space-y-2 text-sm text-white/70">
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Multi-contractor coordination</strong> &mdash; a large construction site
                    may have dozens of contractors and sub-contractors, each with their own workers.
                    The principal contractor is responsible for coordinating the fire safety
                    arrangements across all contractors, including establishing a unified evacuation
                    procedure and assembly point system
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Individual contractor roll calls</strong> &mdash; each
                    contractor&rsquo;s site supervisor is responsible for maintaining a daily
                    register of their workers on site and conducting a roll call of their own team
                    at the assembly point. The results of each contractor&rsquo;s roll call are then
                    reported to the principal contractor&rsquo;s site safety coordinator, who
                    compiles the overall site status
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Site induction</strong> &mdash; every person entering the construction
                    site for the first time must receive a fire safety induction covering the fire
                    alarm type (which on construction sites may be a manually operated siren, air
                    horn, or tannoy rather than a conventional fire alarm system), the evacuation
                    routes (which change as the site develops), and the location of the assembly
                    point(s)
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Temporary signage</strong> &mdash; because the site layout changes
                    frequently, evacuation route signage and assembly point signs must be regularly
                    reviewed and repositioned. This is the responsibility of the principal
                    contractor and should be included in the site fire safety plan. Temporary signs
                    must still comply with BS ISO 7010 and be visible in all conditions
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Multiple assembly points for large sites</strong> &mdash; large
                    construction sites may require multiple assembly points, particularly where the
                    site covers a large area or where different parts of the site have different
                    access routes. Each assembly point must be clearly identified, adequately
                    separated from the hazard area, and have a designated controller
                  </span>
                </li>
              </ul>
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-white/80">
                      ...
                      drill, and the results should be recorded by the principal contractor. Common
                      issues identified during construction site fire drills include: blocked
                      evacuation routes due to materials or equipment, assembly point locations that
                      have become unsuitable due to site development, workers who did not hear the
                      alarm due to noise from machinery, and contractors who were not informed of
                      the drill and failed to evacuate.
                    </p>
                  </div>
                </div>
              </div>
