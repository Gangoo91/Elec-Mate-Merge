...
const quickCheckQuestions = [
  {
    ...
    question:
      'What is the minimum number of buddies that should be assigned to each person who needs a PEEP?',
    options: ['1 buddy', '2 buddies', '3 buddies', '4 buddies'],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    question:
      'How often should Personal Emergency Evacuation Plans (PEEPs) be reviewed as a minimum?',
    options: [
      'Monthly',
      'Quarterly',
      'Six-monthly',
...
const faqs = [
  ...
  {
    question:
      'Are refuges a final destination during an evacuation, or is further rescue required?',
    answer:
  ...
  {
    question:
      'What are the legal consequences if an employer fails to provide PEEPs for employees who need them?',
    answer:
...
const quizQuestions = [
  ...
  {
    id: 6,
    question: 'What are GEEPs and why were they introduced?',
    options: [
  ...
  {
    id: 7,
    question: 'How often should a PEEP be reviewed as a minimum?',
    options: [
      'Every month',
      'Every three months',
      'Every six months',
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-rose-500/5 border-l-2 border-rose-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>PEEP:</strong> Individual plan for anyone who cannot self-evacuate
              </li>
              <li>
                <strong>Minimum 2 buddies</strong> per person to cover absences
              </li>
              <li>
                <strong>Refuges:</strong> 30-min fire resistance with communication
              </li>
              <li>
                <strong>Review:</strong> At least annually and on any change of circumstances
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-rose-500/5 border-l-2 border-rose-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>RRFSO Art. 14 &amp; 15:</strong> Emergency routes and procedures
              </li>
              <li>
                <strong>Equality Act 2010:</strong> Reasonable adjustments for disabled persons
              </li>
              <li>
                <strong>Fire Safety (England) Regulations 2022:</strong> GEEPs for residential
              </li>
              <li>
                <strong>Building Regulations:</strong> Refuge and access requirements
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                A <strong>Personal Emergency Evacuation Plan (PEEP)</strong> is an individual,
                tailored plan developed for any person who cannot self-evacuate from a building
                without assistance during an emergency. The word &ldquo;personal&rdquo; is key
                &mdash; each PEEP is unique to the specific individual, taking into account their
                particular impairment or condition, the building they occupy, the resources
                available, and the escape routes they will use.
              </p>

              <p>
                PEEPs are not a new concept, but they have become increasingly important as
                awareness of inclusive fire safety has grown. The legal basis for PEEPs comes from
              ...
              <p>
                A common misconception is that PEEPs are only for wheelchair users. In reality, a
                PEEP is required for <strong>any person</strong> who may have difficulty evacuating
                without assistance. This includes people with mobility impairments, sensory
                impairments (visual or hearing), cognitive or learning disabilities, mental health
                conditions, and temporary impairments such as a broken leg or late-stage pregnancy.
                The scope is deliberately broad to ensure no one is overlooked.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  an unacceptable failure of fire safety management. PEEPs must be proactive, not
                  reactive.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Any person who may need assistance to evacuate safely requires a PEEP. The range of
                conditions and situations that may necessitate a PEEP is broader than many people
                realise. It is the responsible person&rsquo;s duty to identify these individuals
                through the fire risk assessment, occupational health processes, employee
                self-declaration, and line management awareness.
              </p>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 sm:p-6 rounded-lg">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <p className="text-sm font-medium text-rose-400">
                    Categories of Persons Who May Need a PEEP
                  </p>
                </div>
                <div className="space-y-3">
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      required for a safe evacuation. This is the most commonly recognised category,
                  ...
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      for everyone, but for a person with an existing visual impairment, even light
                      smoke can make navigation impossible.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    <div className="flex items-center gap-2 mb-1">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      or a buddy who is assigned to alert them personally. In sleeping
                      accommodation, bed or pillow vibrating devices may be required.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    <div className="flex items-center gap-2 mb-1">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      They may need clear, simple, repeated instructions and a buddy to guide them
                      through each step of the evacuation.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    <div className="flex items-center gap-2 mb-1">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      PEEP must be put in place for the duration of the temporary condition.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    <div className="flex items-center gap-2 mb-1">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      and support them, including calm communication techniques and a pre-agreed
                      safe route.
                    </p>
                  </div>
                </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  staff buddy, briefing the visitor on the nearest refuge and escape route &mdash;
                  should be activated for the duration of the visit. For buildings that regularly
                  receive visitors with disabilities, a Generic Emergency Evacuation Plan (GEEP)
                  should cover general arrangements.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                A well-constructed PEEP is a detailed, practical document that provides all the
                information needed to evacuate a specific individual safely. It is not a generic
                form to be ticked &mdash; it must be tailored to the person, the building, and the
                available resources. The PEEP should be developed in{' '}
                <strong>consultation with the individual concerned</strong>, as they are the expert
                on their own capabilities and needs.
              </p>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 sm:p-6 rounded-lg">
                ...
                <div className="grid sm:grid-cols-2 gap-3">
                  {[
                    {
                      label: "Person's name and usual location",
                      desc: 'Full name, department, floor, room number, and usual working area or desk location',
                    },
                    {
                      label: 'Nature of impairment',
                      desc: "Clear description of the condition and how it affects evacuation ability (with the person's consent)",
                    },
                    {
                      label: 'Assistance needed',
                      desc: 'Specific help required — physical support, guidance, verbal reassurance, equipment operation',
                    },
                    {
                      label: 'Nominated buddies',
                      desc: 'Names and contact details of minimum 2 trained buddies, including backup arrangements',
                    },
                    {
                      label: 'Escape route(s)',
                      desc: 'The specific route the person will use, which may differ from the standard route for other occupants',
                    },
                    {
                      label: 'Refuge location',
                      desc: 'If applicable, the designated refuge where the person will wait for further assistance',
                    },
                    {
                      label: 'Equipment needed',
                      desc: 'Evacuation chair, ski pad, carry chair, or other specialist equipment — and its storage location',
                    },
                    {
                      label: 'Alarm awareness method',
                      desc: 'How the person will be made aware of the alarm — audible, visual beacon, vibrating pager, buddy alert',
                    },
                    {
                      label: 'Assembly point arrangements',
                      desc: 'How the person will reach and be accounted for at the assembly point, including any transport needs',
                    },
                    {
                      label: 'Review date',
                      desc: 'The next scheduled review date — minimum annually, sooner if circumstances change',
                    },
                  ].map((item, i) => (
              ...
              <p>
                The PEEP must be a <strong>living document</strong>. It should be reviewed at
                regular intervals, tested during fire drills, and updated whenever the
                individual&rsquo;s circumstances change. A PEEP that sits in a filing cabinet unread
                and untested is worthless &mdash; it must be a practical, working plan that all
              ...
              <ul className="space-y-2 text-sm text-white/70">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    The individual should be involved in developing their PEEP and should agree with
                    the plan before it is finalised
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    Buddies should be briefed on the PEEP contents and should practise the
                ...
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    Fire marshals should know who has a PEEP in their area and the key details of
                    the plan
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    A copy of the PEEP (or a summary) should be available at the fire panel or
                    reception for the fire and rescue service
                  </span>
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The buddy system is the practical mechanism by which a PEEP is executed during an
                emergency. A <strong>buddy</strong> is a nominated colleague who is trained and
                assigned to assist a specific person during an evacuation. The buddy system is
                fundamental to PEEP effectiveness &mdash; without trained, available buddies, a PEEP
                ...
                <div className="space-y-3">
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      patterns or where significant physical assistance is required, 3 or more
                      buddies may be necessary. The key principle is that there must{' '}
                      <strong>always</strong> be at least one trained buddy available whenever the
                      individual is in the building.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      pads); communication techniques appropriate to the individual; and the
                      location of refuges and how to use communication systems. Training must be
                      refreshed regularly and practised during fire drills.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      difficult to manoeuvre around a corner, or a communication system that is hard
                      to use under pressure. The individual and their buddies should participate in
                      at least one fire drill per year.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="space-y-2 text-sm text-white/70">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong>During evacuation:</strong> Go immediately to the individual&rsquo;s
                      location, assist them along the agreed escape route, operate any required
                      equipment, communicate with fire marshals about the individual&rsquo;s status
                      and location, and if using a refuge, activate the communication system and
                      wait for rescue
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong>At the assembly point:</strong> Ensure the individual is accounted for
                      during roll call, report to the fire marshal that the individual has been
                      evacuated and their current condition, and remain with the individual until
                      the all-clear is given or the fire and rescue service takes over
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong>If the buddy is absent:</strong> The backup buddy must be aware that
                      they are now the primary buddy for the day. A system must be in place to
                      confirm buddy availability each day &mdash; for example, a check during the
                      morning handover or a digital check-in system
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                A <strong>refuge</strong> (sometimes called a &ldquo;refuge area&rdquo; or
                &ldquo;area of rescue assistance&rdquo;) is a protected waiting area within a
                building where a person who cannot use stairs can wait safely for assistance during
                an evacuation. Refuges are a critical component of the evacuation strategy for
                multi-storey buildings, and their provision is addressed in the Building Regulations
                (Approved Document B and Approved Document M) as well as BS 9999.
              </p>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 sm:p-6 rounded-lg">
                ...
                <div className="grid sm:grid-cols-2 gap-3">
                  {[
                    {
                      label: 'Minimum 30-minute fire resistance',
                      desc: 'The refuge must be within a fire-resistant enclosure providing at least 30 minutes of protection. Some designs require 60 minutes.',
                    },
                    {
                      label: 'Communication system',
                      desc: 'A two-way voice intercom, emergency telephone, or similar system connecting to the fire panel, control room, or fire service.',
                    },
                    {
                      label: 'Signage',
                      desc: 'Clear signage indicating the refuge location, conforming to BS 5499 / ISO 7010 standards, with the international symbol of accessibility.',
                    },
                    {
                      label: 'Wheelchair accessible',
                      desc: 'Large enough to accommodate a wheelchair without obstructing the escape route for other occupants (minimum 900mm x 1400mm clear space).',
                    },
                    {
                      label: 'Located on escape routes',
                      desc: 'Typically within protected stairways or protected lobbies adjacent to staircases, on each floor above or below ground level.',
                    },
                    {
                      label: 'Not a final destination',
                      desc: 'The refuge is a temporary waiting area only. Rescue by the fire service or trained personnel using evacuation equipment must follow.',
                    },
                  ].map((item, i) => (
                    <div key={i} className="bg-white/5 border border-white/10 rounded-lg p-3">
                      <p className="text-sm font-medium text-white">{item.label}</p>
              ...
              <p>
                The communication system is arguably the most critical feature of a refuge. Without
                it, a person waiting in the refuge has no way of informing anyone of their presence.
                If the fire and rescue service arrives and is not aware that someone is waiting in a
                refuge, the rescue may be delayed or overlooked entirely. The communication system
              ...
              <ul className="space-y-2 text-sm text-white/70">
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Building Regulations requirement:</strong> Approved Document M requires
                    that all new non-domestic buildings provide wheelchair-accessible refuges in
                    protected stairways where the building has more than one storey
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Existing buildings:</strong> The provision of refuges in existing
                    buildings may be required as a reasonable adjustment under the Equality Act
                    2010, depending on what is practicable
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Maintenance:</strong> Refuges must be kept clear of storage, equipment,
                    and obstructions at all times. Regular checks should confirm that the
                    communication system is operational and the signage is in good condition
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Fire marshal awareness:</strong> All fire marshals must know the
                    location of refuges on their floor and must check them during an evacuation to
                    confirm whether anyone is waiting
                  </span>
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Specialist evacuation equipment is often essential for executing PEEPs, particularly
                in multi-storey buildings where the person cannot use stairs. The type of equipment
                required depends on the individual&rsquo;s needs, the building&rsquo;s staircase
                design, and the number of trained operators available. The equipment must be
                specified in the individual&rsquo;s PEEP and its location clearly documented.
              </p>
                ...
                <div className="space-y-3">
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      models require two). Positioned at strategic locations, usually at the top of
                      protected staircases on each floor. Examples include the Evac+Chair,
                      Escape-Carry Chair, and similar products. The person is transferred from their
                      wheelchair to the evacuation chair before descending.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    <p className="text-sm font-medium text-white mb-1">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      one or two operators. Particularly useful for bedridden patients or persons
                      who cannot sit in an evacuation chair. Lightweight and can be stored under
                      mattresses or in stairwell cupboards.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      or where the person&rsquo;s condition makes transfer to a tracked chair
                      difficult. Less commonly used in workplace settings but still found in some
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="space-y-2 text-sm text-white/70">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong>Training is mandatory:</strong> An untrained person attempting to use
                      an evacuation chair is a danger to themselves and the person being evacuated.
                      All operators must be trained by the equipment manufacturer or an accredited
                      trainer
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong>Regular inspection and maintenance:</strong> Equipment must be
                      inspected at regular intervals (typically six-monthly) to ensure it is in good
                      working order. Worn tracks, faulty brakes, or damaged harnesses must be
                  ...
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong>Location and access:</strong> Equipment must be stored in accessible,
                      clearly signed locations close to the refuge or protected stairway where it
                      will be used. It must not be locked away where operators cannot reach it
                      quickly
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong>Practice during drills:</strong> Equipment should be used during fire
                      drills (with the individual&rsquo;s consent) to ensure operators are
                      proficient and to identify any practical difficulties with the route or
                      staircase
                    </span>
                  </li>
                </ul>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The concept of <strong>Generic Emergency Evacuation Plans (GEEPs)</strong> emerged
                from the Grenfell Tower Inquiry as a solution to a fundamental problem: in{' '}
                <strong>residential buildings</strong>, the building owner or manager often does not
                know the identity or specific needs of every resident who may need assistance to
                evacuate. Unlike a workplace, where the employer knows their employees and can
                develop individual PEEPs, a residential building manager cannot require residents to
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 sm:p-6 rounded-lg">
                ...
                <p className="text-sm text-white/80 mb-3">
                  ...
                  containing two or more sets of domestic premises) and impose specific duties on
                ...
                <div className="space-y-3">
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      evacuation equipment positions, and escape routes; the types of equipment
                      available (evacuation chairs, ski pads) and their locations; the general
                      procedure for assisting persons with different types of impairment; the
                      communication systems available; and the arrangements for informing the fire
                      and rescue service about persons who may need assistance.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      not self-evacuate. The Grenfell Tower Inquiry Phase 1 Report recommended that
                      building owners and managers of high-rise residential buildings be required to
                      prepare Personal Emergency Evacuation Plans for all residents who would have
                      difficulty self-evacuating. The government opted for GEEPs as a more
                      proportionate and privacy-respecting approach, while still encouraging
              ...
              <ul className="space-y-2 text-sm text-white/70">
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Floor-level plans</strong> should show the precise location of refuges,
                    evacuation equipment, escape routes suitable for wheelchair users, and any areas
                    where assistance may be needed (e.g., steps, narrow corridors)
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Premises information box:</strong> High-rise residential buildings (over
                    18 metres / 7 storeys) must have a premises information box containing the GEEP,
                    floor plans, and other key information for the fire and rescue service
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Individual PEEPs alongside GEEPs:</strong> Where a resident voluntarily
                    discloses their needs, the responsible person should develop an individual PEEP
                    that works in conjunction with the building&rsquo;s GEEP
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                  <span>
                    <strong>Regular review:</strong> GEEPs must be reviewed regularly (at least
                    annually) and updated whenever the building layout, equipment, or escape routes
                    change
                  </span>
                </li>
              </ul>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-rose-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Effective communication is essential throughout the PEEP process &mdash; from
                initial identification of need, through development and testing, to execution during
                an emergency. Equally important are the requirements for regular review and the duty
                to handle personal information with appropriate confidentiality and sensitivity.
              </p>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 sm:p-6 rounded-lg">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <p className="text-sm font-medium text-rose-400">
                    Communication Methods for Persons with Hearing Impairments
                  </p>
                </div>
                <div className="grid sm:grid-cols-2 gap-3">
                  {[
                    {
                      label: 'Visual alarms (flashing beacons)',
                      desc: 'Bright flashing lights (typically red or white) synchronised with the fire alarm system. Installed in all areas where deaf or hard-of-hearing persons may be present.',
                    },
                    {
                      label: 'Vibrating pagers / wristbands',
                      desc: 'Personal devices that vibrate when the fire alarm is triggered. Particularly useful for persons who move around the building and may not always be near a visual alarm.',
                    },
                    {
                      label: 'Text / SMS alerts',
                      desc: 'Automated text messages sent to registered mobile phones when the fire alarm activates. Useful as a backup to other methods.',
                    },
                    {
                      label: 'Buddy alert',
                      desc: 'A designated buddy is assigned to physically alert the individual when the alarm sounds. Simple and effective, but requires the buddy to be available and nearby.',
                    },
                  ].map((item, i) => (
                    <div key={i} className="bg-white/5 border border-white/10 rounded-lg p-3">
                      <p className="text-sm font-medium text-white">{item.label}</p>
                ...
                <div className="space-y-3">
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      appropriate, the escape route is still suitable, and any equipment is still
                      available and in good condition. The review should be documented with the date
                  ...
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      to a different floor, office, or work area; building works affect the escape
                      route, refuge, or equipment location; assigned buddies leave the organisation
                      or change roles; a fire drill reveals that the plan does not work as intended;
                      or new evacuation equipment becomes available.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 sm:p-6 rounded-lg">
                ...
                <ul className="space-y-2 text-sm text-white/70">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong>Need-to-know basis:</strong> Only share information that buddies and
                      fire marshals need to fulfil their role. A buddy needs to know what assistance
                      is required, but does not necessarily need a detailed medical diagnosis
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong>Consent:</strong> The individual should consent to the sharing of
                      their information with buddies and fire marshals. Discuss with the individual
                      what level of detail they are comfortable sharing
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong>Secure storage:</strong> PEEPs should be stored securely, whether in
                      paper or electronic form. Access should be restricted to authorised personnel
                      only
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong>Fire service access:</strong> A summary of relevant information
                      (person&rsquo;s name, floor, type of assistance needed) should be available at
                      the fire panel or reception for the fire and rescue service, but detailed
                      medical information should not be included unless the individual has consented
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-rose-400" />
                    <span>
                      <strong>Retention:</strong> When a PEEP is no longer needed (the individual
                      leaves the organisation or recovers from a temporary condition), the plan
                      should be archived or securely destroyed in accordance with the
                      organisation&rsquo;s data retention policy
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  ensure the person&rsquo;s safety. For example, a buddy needs to know that their
                  colleague uses a wheelchair and requires assistance via the evacuation chair on
                  the west staircase. The buddy does not need to know the medical diagnosis that
                  caused the wheelchair use. The individual should always be involved in deciding
