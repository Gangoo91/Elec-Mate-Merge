...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      'Regulation 12(2) requires the construction phase plan to include a description of the project, the management of the project (including the management structure and responsibilities), the arrangements for monitoring compliance, and the health and safety arrangements and site rules. The plan must cover how health and safety will be managed throughout the construction phase.',
  },
  {
    id: 3,
    question:
  ...
  },
  {
    id: 4,
    question:
      'Which of the following is NOT typically part of the management arrangements section of a CPP?',
    options: [
...
export default function CdmRegulationsModule3Section2() {
  useSEO({
    ...
    description:
      'The construction phase plan under CDM 2015 Regulation 12: what it is, when it must be prepared, required content, site rules, specific risk procedures, proportionate approach, and review requirements.',
  });
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-blue-500/5 border-l-2 border-blue-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Regulation 12:</strong> Legal basis for the CPP
              </li>
              <li>
                <strong>Who:</strong> Principal contractor (or sole contractor)
              </li>
              <li>
                <strong>When:</strong> Before the construction phase begins
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-blue-500/5 border-l-2 border-blue-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Scope:</strong> Required for ALL construction projects
              </li>
              <li>
                <strong>Living document:</strong> Must be updated throughout the project
              </li>
              <li>
                <strong>Proportionate:</strong> Level of detail matches the project risk
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The construction phase plan (CPP) is the <strong>central document</strong> that sets
                out how health and safety will be managed during the construction phase of a
                project. It is required under{' '}
                <strong>
                  Regulation 12 of the Construction (Design and Management) Regulations 2015
                </strong>{' '}
                (CDM 2015) and applies to <strong>every construction project</strong>, regardless of
                size.
              </p>
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  projects with only one contractor (where no principal contractor is appointed),
                  the <strong className="text-white">sole contractor</strong> must prepare the plan.
                </p>
              </div>

              <p>
                The CPP is not simply a risk assessment or method statement &mdash; it is a{' '}
                <strong>comprehensive management document</strong> that brings together all the
                health and safety arrangements for the project. It draws on information from the
                pre-construction information pack, the client&rsquo;s requirements, and the
                principal contractor&rsquo;s own assessment of the risks and management arrangements
                needed.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      A <strong className="text-white">description of the project</strong> &mdash;
                      what work is being carried out, where, and the key phases
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      The <strong className="text-white">management structure</strong> &mdash; who
                      is responsible for what, and how the project will be coordinated
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      The <strong className="text-white">health and safety arrangements</strong>{' '}
                      &mdash; how risks will be managed on a day-to-day basis
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      The <strong className="text-white">site rules</strong> &mdash; the standards
                      everyone on site must follow
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Specific risk procedures</strong> &mdash; how
                      particular hazards (fire, working at height, confined spaces etc.) will be
                      dealt with
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-blue-400">Important:</strong> The CPP is not a one-off
                  document filed away and forgotten. It is a <strong>living document</strong> that
                  must be reviewed, revised, and updated as the project progresses and circumstances
                  change. Everyone working on the project should have access to the relevant parts
                  of the plan.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The timing of the construction phase plan is critical. CDM 2015 requires that the
                CPP must be in place <strong>before the construction phase begins</strong>. This
                means no construction work should start until a suitable plan has been prepared.
              </p>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  HSE, including improvement or prohibition notices and potential prosecution.
                </p>
              </div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      <strong className="text-white">
                        not need to be complete in every detail
                      </strong>{' '}
                      before work starts
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      It must contain{' '}
                      <strong className="text-white">
                        sufficient information to manage the initial phases safely
                      </strong>
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      As the project develops, the plan must be{' '}
                      <strong className="text-white">expanded and updated</strong> to cover
                      subsequent phases
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Each new phase of work should be covered{' '}
                      <strong className="text-white">before it begins</strong>
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <p>
                In practice, the principal contractor will start developing the CPP as soon as they
                are appointed, using the <strong>pre-construction information</strong> provided by
                the client and principal designer. The plan should be developed in consultation with
                the contractors who will carry out the work, as they will have detailed knowledge of
                the risks and controls associated with their specific activities.
              </p>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Regulation 12(2) sets out the minimum content that must be included in the
                construction phase plan. The plan must be{' '}
                <strong>tailored to the specific project</strong> &mdash; a generic, copy-and-paste
                document does not satisfy the legal requirements.
              </p>
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  <strong className="text-white">
                    {' '}
                    arrangements for securing health and safety
                  </strong>{' '}
                  during the construction phase. As a minimum, it must address the following areas.
                </p>
              </div>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-1">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        The site location, access arrangements, and surrounding environment
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Existing site conditions and any known hazards (from pre-construction
                        information)
                      </span>
                    </li>
                  </ul>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-1">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Welfare arrangements (toilets, washing facilities, rest areas, drinking
                        water)
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-1">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Procedures for managing fire risk, temporary works, lifting operations
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Any other activities requiring particular procedures identified in the risk
                        assessment
                      </span>
                    </li>
                  </ul>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-1">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        How compliance with health and safety arrangements will be monitored
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  HSE will expect to see a plan that clearly relates to the actual project, its
                  specific risks, and the arrangements put in place to manage them. Copy-and-paste
                  plans are a common enforcement target.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The management arrangements section of the CPP sets out{' '}
                <strong>how the project team will work together</strong> to manage health and
                safety. This is not simply a list of names &mdash; it must describe the practical
                systems and processes that will be used to coordinate activities and ensure that
                health and safety is actively managed.
              </p>
                  ...
                  <ul className="text-sm text-white space-y-1">
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        ...
                        <strong className="text-white">
                          client, principal designer, principal contractor, all contractors, and
                          site managers
                        </strong>
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Organisational chart showing{' '}
                        <strong className="text-white">reporting lines and responsibilities</strong>
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Details of the{' '}
                        <strong className="text-white">site health and safety adviser</strong> (if
                        appointed)
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Named <strong className="text-white">first aiders and fire wardens</strong>
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-1">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        How health and safety information will be{' '}
                        <strong className="text-white">
                          shared between contractors and workers
                        </strong>
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Site <strong className="text-white">induction procedures</strong> &mdash;
                        what will be covered and who will deliver them
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Regular <strong className="text-white">toolbox talks and briefings</strong>
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Notice boards</strong> and information points
                        on site
                      </span>
                    </li>
                  </ul>
                  ...
                  <ul className="text-sm text-white space-y-1">
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        How workers will be{' '}
                        <strong className="text-white">
                          consulted on health and safety matters
                        </strong>
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        Arrangements for{' '}
                        <strong className="text-white">
                          safety representatives or safety committees
                        </strong>{' '}
                        (where applicable)
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        How workers can{' '}
                        <strong className="text-white">raise health and safety concerns</strong>{' '}
                  ...
                  <ul className="text-sm text-white space-y-1">
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        How the work of{' '}
                        <strong className="text-white">
                          different contractors will be coordinated
                        </strong>{' '}
                        to prevent clashes and ensure safe interfaces
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Permit-to-work systems</strong> for high-risk
                        activities
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-1">
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        Planned{' '}
                        <strong className="text-white">health and safety inspections</strong>{' '}
                        (frequency, who will carry them out)
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Audit arrangements</strong> for contractor
                        compliance
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Accident and incident investigation</strong>{' '}
                        procedures
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        How <strong className="text-white">lessons learned</strong> will be fed back
                        into the plan
                      </span>
                    </li>
                  </ul>
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                contractors and workers, regardless of their employer. The rules must be
                communicated to all workers during the site induction and enforced throughout the
                project.
              </p>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-1">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Designated <strong className="text-white">entry and exit points</strong> for
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Sign-in and sign-out procedures</strong> for
                        tracking who is on site
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Visitor management</strong> &mdash; escorts,
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Restricted zones</strong> &mdash; areas
                        requiring specific authorisation or permits
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-1">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Minimum PPE standards</strong> for all site
                        areas (typically hard hat, hi-vis, safety boots)
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Task-specific PPE</strong> requirements (eye
                        protection, hearing protection, RPE, gloves)
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">PPE zones</strong> &mdash; areas with
                  ...
                  <ul className="text-sm text-white space-y-1">
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        ...
                        <strong className="text-white">permit to work</strong> (hot works, confined
                        spaces, electrical isolation, excavations)
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        The <strong className="text-white">permit process</strong> &mdash; who can
                        issue, who can authorise, who holds the permit
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Permit close-out</strong> procedures
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-1">
                    ...
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        <strong className="text-white">
                          Speed limits, one-way systems, and designated routes
                        </strong>
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Banksman/signaller</strong> requirements for
                        reversing vehicles
                      </span>
                    </li>
                  </ul>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-1">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Housekeeping standards</strong> &mdash;
                        keeping areas clean and clear, material storage, waste management
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Welfare facilities</strong> &mdash; location
                        and standards for toilets, washing, rest areas, drinking water
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        ...
                        alarm, evacuation routes, assembly points, emergency contacts
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Smoking and alcohol/drugs policy</strong>
                      </span>
                    </li>
                  </ul>
                </div>
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  ...
                  <strong> clearly displayed</strong> in the site office, welfare facilities, and at
                  the site entrance. All workers must be briefed on the site rules during their
                  induction before they start work. The principal contractor is responsible for
                  ensuring the rules are followed and for taking action when they are breached.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                go beyond the general site rules and set out exactly how each high-risk activity
                will be managed, who is competent to carry it out, and what controls must be in
                place.
              </p>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-1">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Permit-to-work requirements for welding, cutting, grinding, brazing
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-1">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Underground services identification (CAT and Genny, service plans)
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-1">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Safe isolation procedures (lock-off, prove dead, post warning notices)
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Permit-to-work for electrical work on live or previously live systems
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Competency requirements (qualified electricians, Electricity at Work
                        Regulations 1989)
                      </span>
                    </li>
                  </ul>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-1">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Procedure for unexpected discovery of suspected asbestos-containing
                        materials
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Stop work &rarr; evacuate &rarr; report &rarr; assess &rarr; specialist
                        removal
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Reference to the Refurbishment/Demolition Survey and asbestos register
                      </span>
                    </li>
                  </ul>
                </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  specific risks, the controls that will be applied, the competency standards
                  required, and the emergency arrangements. Workers carrying out these activities
                  must be briefed on the procedure before they start work and must confirm they
                  understand and will follow it.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                One of the most important principles in CDM 2015 is that the construction phase plan
                must be <strong>proportionate</strong> to the size, complexity, and risk profile of
                the project. The goal is to manage real risks effectively &mdash;{' '}
                <strong>not to generate paperwork for its own sake</strong>.
              </p>
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  <strong className="text-white">Complex project = detailed plan.</strong> A large
                  project with multiple contractors, significant hazards, and complex coordination
                  needs a comprehensive plan with detailed procedures. The test is whether the plan
                  <strong className="text-white"> effectively manages the actual risks</strong>, not
                  whether it meets a minimum page count.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      A 50-page plan for a two-day domestic job is{' '}
                      <strong className="text-white">disproportionate and unhelpful</strong>
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      A two-page plan for a multi-million-pound hospital build is{' '}
                      <strong className="text-white">dangerously inadequate</strong>
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      The plan must{' '}
                      <strong className="text-white">focus on managing real risks</strong>, not
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      A <strong className="text-white">short, well-thought-out plan</strong> is far
                      more effective than a long, generic one
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-blue-400">Key Test:</strong> Ask yourself &mdash; if an
                  HSE inspector arrived on site today, would this plan demonstrate that you have{' '}
                  <strong>
                    identified the real risks and put sensible arrangements in place to manage them?
                  </strong>{' '}
                  That is the standard. Length and format are secondary to whether the plan actually
                  works as a management tool for the specific project.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The construction phase plan is a <strong>living document</strong>. It must be
                reviewed and updated throughout the project to ensure it remains relevant and
                effective. A plan that was accurate at the start of the project may become
                inadequate as circumstances change &mdash; new contractors arrive, the scope
                evolves, or unexpected hazards are discovered.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">New contractor mobilising to site</strong>{' '}
                      &mdash; new risks, new interfaces, new personnel
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Significant change in project scope</strong>{' '}
                      &mdash; additional work, changed programme, new phases
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Incident, accident, or near miss</strong>{' '}
                      &mdash; lessons learned and revised procedures
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Discovery of an unexpected hazard</strong>{' '}
                      &mdash; asbestos, contaminated ground, structural instability
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Change to the management structure</strong>{' '}
                      &mdash; new site manager, new H&amp;S adviser
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Feedback from inspections or audits</strong>{' '}
                      &mdash; identified improvements or gaps
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Seasonal changes</strong> &mdash; winter
                      working, adverse weather procedures
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Each revision should be{' '}
                      <strong className="text-white">clearly numbered and dated</strong> (e.g.,
                      Version 3.0 &mdash; 15/01/2025)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      A <strong className="text-white">revision log</strong> should record what was
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Superseded versions should be{' '}
                      <strong className="text-white">clearly marked as obsolete</strong> and removed
                      from active use
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      <strong className="text-white">archived for record purposes</strong>
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      The current version of the CPP must be{' '}
                      <strong className="text-white">accessible on site at all times</strong>
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      It can be kept as a{' '}
                      <strong className="text-white">physical document in the site office</strong>{' '}
                      or accessed digitally
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Workers should know{' '}
                      <strong className="text-white">where to find the plan</strong> and have access
                      to the parts relevant to their work
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Key elements (site rules, emergency procedures) should be{' '}
                      <strong className="text-white">displayed prominently</strong> in common areas
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-blue-400">Remember:</strong> A construction phase plan
                  that was written on day one and never updated is{' '}
                  <strong>not a living document</strong> &mdash; it is a dead document. The value of
                  the CPP lies in its role as an active management tool that evolves with the
                  project. Regular review, updating, and communication of changes are essential to
