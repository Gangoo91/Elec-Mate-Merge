...
const faqs = [
  {
    question: 'Does the 30-day / 20-worker threshold include weekends and bank holidays?',
    answer:
  ...
  {
    question: 'Can the F10 be submitted after the construction phase has already started?',
    answer:
  ...
  {
    question: 'Is there a fee for submitting the F10 notification to HSE?',
    answer:
...
export default function CdmRegulationsModule3Section4() {
  useSEO({
    title: 'Notification to HSE (F10) | CDM Regulations Module 3.4',
    description:
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <header className="text-center mb-12">
          ...
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-500/10 border border-blue-500/20 mb-3 mx-auto">
            <span className="text-blue-500 text-xs font-semibold">MODULE 3 &middot; SECTION 4</span>
          </div>
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-blue-500/5 border-l-2 border-blue-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Threshold:</strong> &gt;30 working days with &gt;20 simultaneous workers OR
                &gt;500 person-days
              </li>
              <li>
              ...
              <li>
                <strong>Duty holder:</strong> The client must ensure notification
              </li>
              <li>
          ...
          <div className="p-4 rounded-lg bg-blue-500/5 border-l-2 border-blue-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>F10 must be displayed</strong> in the site office or at the main entrance
              </li>
              <li>
                <strong>Keep it up to date</strong> &mdash; resubmit when details change
              </li>
              <li>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                <strong>
                  Regulation 6 of the Construction (Design and Management) Regulations 2015
                </strong>{' '}
                requires that certain construction projects must be notified to the Health and
                Safety Executive (HSE) before the construction phase begins. The purpose of
                notification is to ensure HSE is aware of significant construction projects so it
                can plan inspections and allocate resources effectively.
              </p>

              <p>
                Not every construction project needs to be notified. The duty to notify only applies
                when a project crosses one of two specific thresholds. These thresholds are designed
                to capture larger, longer, or more complex projects where the risks to workers are
                greatest.
              </p>
                ...
                <div className="space-y-4">
                  <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
                    ...
                    <p className="text-sm text-white/80">
                      ...
                      at any point during the project. Both conditions must be met &mdash; 30 days
                  ...
                  <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
                    ...
                    <p className="text-sm text-white/80">
                      ...
                      captures projects that may not have large numbers of simultaneous workers but
              ...
              <p>
                If <strong>either</strong> threshold is expected to be exceeded, the project is
                notifiable and the client must ensure that an F10 notification is submitted to HSE.
                The notification must be submitted{' '}
                <strong>as soon as is practicable before the construction phase begins</strong>.
                Waiting until work has started, or failing to notify at all, is a breach of the
                Regulations.
              </p>

              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-blue-500">Key Point:</strong> The thresholds are based on{' '}
                  <strong>planned or expected</strong> figures, not actual figures. If a project is
                  expected to exceed the thresholds at the planning stage, it must be notified
                  before work begins &mdash; even if the actual numbers later turn out to be lower.
                  Conversely, if a project crosses the thresholds unexpectedly during work,
                  notification must be made as soon as the client becomes aware.
                </p>
              </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  workers. A project lasting 50 working days with only 10 workers at peak does not
                  meet this threshold. However, always check the 500 person-day threshold as well
                  &mdash; the same project may still be notifiable if total person-days exceed 500.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The <strong>F10</strong> is the official notification form used to inform HSE about
                a notifiable construction project. It is submitted <strong>online</strong> through
                the HSE website. There is no paper version &mdash; all F10 notifications must be
                submitted electronically.
              </p>

              <p>
                The form is straightforward and collects the essential information HSE needs to
                understand the nature, scale, and duration of the project, and to identify the key
                duty holders responsible for managing health and safety.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Project details</strong> &mdash; the address or
                      location of the construction site and a brief description of the project
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Client details</strong> &mdash; name and
                      address of the client (the person or organisation for whom the project is
                      being carried out)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Principal designer (PD) details</strong>{' '}
                      &mdash; name, address, and contact details of the appointed principal designer
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Principal contractor (PC) details</strong>{' '}
                      &mdash; name, address, and contact details of the appointed principal
                      contractor
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Planned start date</strong> &mdash; the date
                      the construction phase is expected to begin
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Expected duration</strong> &mdash; how long the
                      construction phase is planned to last
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Estimated peak number of workers</strong>{' '}
                      &mdash; the maximum number of workers expected on site at any one time
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Brief description of the work</strong> &mdash;
                      a short summary of the nature of the construction work being undertaken
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-blue-500">Important:</strong> The F10 does NOT require
                  detailed construction phase plans, method statements, risk assessments, or
                  financial information. It is a notification, not an application for approval. HSE
                  does not approve or reject construction projects based on the F10 &mdash; it
                  simply records the information for inspection planning purposes.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Under CDM 2015, the <strong>legal duty to notify HSE</strong> rests with the{' '}
                <strong>client</strong>. The client is the person or organisation for whom the
                construction project is being carried out. This is a non-delegable duty &mdash; even
                if someone else physically submits the form, the client remains legally responsible
                for ensuring it is done.
              </p>

              <p>
                In practice, the client often instructs the <strong>principal designer (PD)</strong>{' '}
                or the <strong>principal contractor (PC)</strong> to complete and submit the F10 on
                their behalf. This is perfectly acceptable, and indeed common, but it does not
                transfer the legal responsibility. If the F10 is not submitted, it is the{' '}
                <strong>client</strong> who is in breach of Regulation 6 &mdash; not the PD or PC.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      There is no specific number of days or weeks required &mdash; the test is{' '}
                      <strong className="text-white">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      In practice, submission should happen once the key details are known (client,
                      PD, PC, planned dates, workforce estimates) and{' '}
                      <strong className="text-white">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      If a PD or PC has not yet been appointed at the time of notification, the F10
                      can be submitted with this information to follow, and{' '}
                      <strong className="text-white">updated once appointments are made</strong>
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  projects). This is because domestic clients cannot reasonably be expected to
                  understand CDM duties. The contractor effectively takes on the client&rsquo;s
                  notification responsibilities for domestic projects.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                <strong>Regulation 6(3)</strong> requires that the F10 notification, or a copy of
                it, must be{' '}
                <strong>
                  displayed in a readable condition in a position where it can be read by every
                  worker engaged in the construction work
                </strong>
                . This is not optional &mdash; it is a specific legal requirement with a clear
                purpose.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Location:</strong> The F10 or a copy must be
                      displayed in the{' '}
                      <strong className="text-white">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Condition:</strong> It must be in a{' '}
                      <strong className="text-white">readable condition</strong> &mdash; legible,
                      not faded, torn, or obscured
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Visibility:</strong> Every worker on the
                      project must be able to see and read it
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Currency:</strong> The displayed copy must be{' '}
                      <strong className="text-white">kept up to date</strong> &mdash; if the F10 is
                      amended, the displayed copy must be replaced with the updated version
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <p>
                The purpose of displaying the F10 is transparency. It tells every worker on site
                that the project has been notified to HSE, who the client is, who the principal
                designer and principal contractor are, and the basic details of the project. This
                information empowers workers to raise concerns through the correct channels and to
                verify that the project is being managed in accordance with CDM 2015.
              </p>

              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-blue-500">Practical Tip for Electricians:</strong> When
                  you arrive on a notifiable construction site, check whether the F10 is displayed.
                  If you cannot find it, this may indicate that the project has not been notified to
                  HSE, or that the site management is not meeting its CDM obligations. You are
                  entitled to ask to see the F10, and its absence should prompt you to raise a
                  concern with your supervisor or the principal contractor.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The F10 is not a &ldquo;submit and forget&rdquo; document. When key details of the
                project change, the notification must be <strong>updated</strong> to reflect the
                current position. The duty to ensure the F10 is kept up to date rests with the{' '}
                <strong>client</strong>, although in practice the principal contractor or principal
                designer often manages the update process.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Change of principal contractor</strong> &mdash;
                      if the PC is replaced or a new one is appointed, the F10 must be updated with
                      the new PC&rsquo;s details
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Change of principal designer</strong> &mdash;
                      similarly, a new PD appointment requires an update
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Extended duration</strong> &mdash; if the
                      construction phase is expected to last significantly longer than originally
                      notified
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Significant increase in workforce</strong>{' '}
                      &mdash; if peak worker numbers increase substantially beyond the original
                      estimate
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Change of client details</strong> &mdash; if
                      the client changes (for example, a property sale during construction)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      ...
                      &mdash; for example, if the scope changes from refurbishment to demolition and
                      rebuild
                    </span>
                  </li>
                </ul>
              ...
              <p>
                Updates are submitted through the same HSE online system used for the original
                notification. The updated F10 replaces the previous version, and the copy displayed
                on site must also be replaced with the updated version. There is no charge for
                submitting updates.
              </p>

              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-blue-500">Key Point:</strong> Keeping the F10 up to date
                  is not merely good practice &mdash; it is a legal requirement. An outdated F10
                  that lists a principal contractor who is no longer on the project, or a duration
                  that has long been exceeded, undermines the purpose of the notification system and
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Large construction developments are frequently delivered in <strong>phases</strong>{' '}
                &mdash; for example, a housing estate built in three stages, or a commercial
                development where the shell is completed first and the fit-out follows later. The
                question of how to handle notification for phased projects is one of the most common
                areas of confusion under CDM 2015.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Single project:</strong> If all phases are
                      managed as one continuous project under the same client, PD, and PC, a single
                      F10 may cover the entire project &mdash; assessed against the thresholds as a
                      whole
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Separate projects:</strong> If phases involve
                      different contractors, different timescales, or significant gaps between
                      phases, each phase should be assessed individually against the notification
                      thresholds
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Linked projects:</strong> Where projects on the
                      same site are linked (sharing access, welfare, or management arrangements),
                      consider whether they should be treated as one project for notification
                      purposes
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  treat it as a single project. This would be viewed as a deliberate attempt to
                  circumvent the Regulations and could result in enforcement action.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The F10 notification is not simply filed away and forgotten. HSE{' '}
                <strong>actively uses</strong> the data submitted on F10 notifications to inform its
                regulatory activities. Understanding how HSE uses this information helps explain why
                accurate and timely notification matters.
              </p>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-blue-400 mb-3">How HSE Uses F10 Data</p>
                <div className="space-y-3">
                  <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-3">
                    ...
                    <p className="text-xs sm:text-sm text-white/80">
                      ...
                      to receive a visit. Without the F10, HSE would not know the site exists.
                    </p>
                  </div>
                  <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-3">
                    ...
                    <p className="text-xs sm:text-sm text-white/80">
                      ...
                      intelligence helps HSE understand trends and identify emerging risks in the
                      construction sector.
                    </p>
                  </div>
                  <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-3">
                    ...
                    <p className="text-xs sm:text-sm text-white/80">
                      ...
                      notification data, resource planning would be based on guesswork.
                    </p>
                  </div>
                  <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-3">
                    <p className="text-sm font-medium text-blue-400 mb-1">
                    ...
                    <p className="text-xs sm:text-sm text-white/80">
                      ...
                      decisions and help justify regulatory interventions.
                    </p>
                  </div>
                  <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-3">
                    <p className="text-sm font-medium text-blue-400 mb-1">
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-blue-500">Key Point:</strong> Submitting an F10 does{' '}
                  <strong>not</strong> mean HSE has approved the project or reviewed the health and
                  safety arrangements. The F10 is a notification, not an application. HSE does not
                  issue approvals or permits for construction projects. The responsibility for
                  managing health and safety remains entirely with the duty holders (client, PD, PC,
                  and contractors).
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Failure to notify HSE of a notifiable project is a <strong>criminal offence</strong>{' '}
                under the Construction (Design and Management) Regulations 2015. It is not a civil
                matter or an administrative oversight &mdash; it is a breach of health and safety
                law that can result in prosecution, fines, and enforcement action.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Criminal prosecution:</strong> HSE can
                      prosecute the client (or the contractor for domestic projects) for failing to
                      notify. Prosecution is brought under the Health and Safety at Work etc. Act
                      1974 for breach of the CDM Regulations
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Unlimited fines:</strong> The courts can impose
                      an <strong className="text-white">unlimited fine</strong> for
                      non-notification. The level of fine depends on the seriousness of the offence,
                      the size and turnover of the organisation, and any aggravating factors
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Personal prosecution:</strong> In serious
                      cases, individual directors, managers, or company officers can be personally
                      prosecuted if the failure to notify was due to their consent, connivance, or
                      neglect
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Improvement notices:</strong> HSE can serve an
                      improvement notice requiring the client to submit the F10 within a specified
                      period
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Prohibition notices:</strong> In more serious
                      cases, HSE can serve a prohibition notice stopping work on site until the
                      breach is rectified
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Proactive inspections:</strong> HSE inspectors
                      visit construction sites as part of their routine work. If they visit a site
                      that should have been notified but was not, this will be identified
                      immediately
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Reactive investigations:</strong> If an
                      accident or dangerous occurrence happens on a site that should have been
                      notified, the failure to notify will be discovered during the investigation
                      and will be treated as an aggravating factor
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Worker complaints:</strong> Workers, trade
                      unions, or members of the public can report concerns to HSE, including the
                      absence of an F10 on a large construction site
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Cross-referencing data:</strong> HSE may
                      cross-reference planning applications, building control notifications, and
                      other public records against its F10 database to identify projects that should
                      have been notified
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  to comply with basic regulatory requirements, and the failure to notify suggests a
                  wider disregard for health and safety obligations. This typically results in a
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-blue-500">Bottom Line for Electricians:</strong> You will
                  rarely be the person responsible for submitting the F10 &mdash; that is the
                  client&rsquo;s duty. However, you should understand the notification requirements
                  so you can recognise when a project should have been notified. If you are working
                  on a large construction site and there is no F10 displayed, this is a red flag. It
                  may mean that CDM duties are not being properly managed, which could affect your
                  safety. Raise the concern with your supervisor or the principal contractor.
                </p>
              </div>
            </div>
          </div>
