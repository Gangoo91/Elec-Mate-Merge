...
const faqs = [
  ...
  {
    question: 'How far into the future must designers consider maintainability under CDM 2015?',
    answer:
          ...
          <div className="rounded-lg p-4 bg-blue-500/5 border-l-2 border-blue-500/50">
            ...
            <ul className="text-white text-base space-y-1.5">
              <li className="flex items-start gap-2">
                ...
                <span>
                  <strong className="text-white">Buildability:</strong> design for HOW it will be
                  built, not just what it looks like when finished
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Whole-life approach:</strong> CDM 2015 requires
                  designers to consider construction, maintenance, cleaning, refurbishment, and
                  demolition
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Eliminate first:</strong> design out hazardous work
                  before relying on protective measures or PPE
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">H&amp;S File:</strong> all buildability and
                  maintainability information must be recorded for future users
                </span>
              </li>
            </ul>
          </div>
          <div className="rounded-lg p-4 bg-blue-500/5 border-l-2 border-blue-500/50">
            ...
            <ul className="text-white text-base space-y-1.5">
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">CDM 2015 Reg 9:</strong> designers must eliminate,
                  reduce, and inform &mdash; in that order
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">BS 8213-1:</strong> guidance on designing windows
                  for safe cleaning
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">BS 6187:</strong> code of practice for demolition
                  &mdash; designers must consider end-of-life
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">CIRIA (1983):</strong> first formal definition of
                  buildability in the UK construction industry
                </span>
              </li>
            </ul>
          </div>
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                ...
                first formally defined by the{' '}
                <strong className="text-white">
                  Construction Industry Research and Information Association (CIRIA)
                </strong>{' '}
                in 1983 as{' '}
                <em>
                  &ldquo;the extent to which the design of a building facilitates ease of
                  construction, subject to the overall requirements for the completed
                  building.&rdquo;
                </em>{' '}
                This definition recognised that a design must be evaluated not only on its aesthetic
                and functional merit, but on how practically and safely it can be constructed.
              </p>

              <p>
                Under <strong className="text-white">CDM 2015 Regulation 9</strong>, buildability is
                not a discretionary design aspiration &mdash; it is a legal obligation. Designers
                must take into account the{' '}
                <strong className="text-white">general principles of prevention</strong> (set out in
                Schedule 1 of CDM 2015) when preparing or modifying a design. They must eliminate
                foreseeable risks to the health and safety of any person carrying out or affected by
                construction work so far as is reasonably practicable, and where risks cannot be
                eliminated, reduce them and provide information about the remaining risks.
              </p>

              <p>
                In practice, this means every design decision must be evaluated for its impact on
                the safety of the people who will build the structure. A design that requires
                extensive work at height, complex temporary works in confined spaces, or the lifting
                of heavy precast elements where there is no crane access has poor buildability.
                These are not merely practical inconveniences &mdash; they are foreseeable hazards
                that the designer has a legal duty to address.
              </p>
                ...
                <ul className="text-white space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      specifying large precast concrete panels for a site surrounded by existing
                      buildings with no room for a mobile crane to operate safely
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Deep excavations adjacent to highways:</strong>{' '}
                      designing foundations that require deep excavations immediately next to a busy
                      road without considering the temporary works needed to protect both workers
                      and the public
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Confined spaces with no safe access:</strong>{' '}
                      designing plant rooms, risers, or ductwork spaces that are too small for
                      workers to enter safely or that lack adequate ventilation, lighting, and
                      emergency egress
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Complex in-situ connections at height:</strong>{' '}
                      designing structural connections that require extensive welding, bolting, or
                      formwork at high level when the same structural performance could be achieved
                      with simpler, ground-level assembly
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <div className="flex items-start gap-2">
                  ...
                  <p className="text-white text-sm">
                    ...
                    most impressive building in the world is a failure if people are killed or
                    seriously injured building it because the designer did not consider how it would
                    be constructed.
                  </p>
                </div>
              </div>
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                ...
                Before CDM, many designers focused exclusively on the finished building &mdash; how
                it would look, how it would perform, and how much it would cost. The construction
                process was considered the contractor&rsquo;s problem, and maintenance, cleaning,
                and demolition were rarely given any thought at the design stage.
              </p>

              <p>
                Under <strong className="text-white">CDM 2015 Regulation 9(3)(a)</strong>, designers
                must take account of the general principles of prevention when preparing or
                modifying a design. These principles, set out in Schedule 1, include{' '}
                <em>&ldquo;adapting the work to the individual&rdquo;</em>,{' '}
                <em>&ldquo;adapting to technical progress&rdquo;</em>, and{' '}
                <em>
                  &ldquo;giving collective protective measures priority over individual protective
                  measures&rdquo;
                </em>
                . The whole-life concept means considering every person who will interact with the
                structure from groundbreaking to demolition:
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Construction workers:</strong> all trades
                      involved in building the structure &mdash; groundworkers, steelworkers,
                      bricklayers, electricians, plumbers, roofers, glaziers, decorators
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Maintenance personnel:</strong> building
                      services engineers, electricians, plumbers, HVAC technicians, lift engineers,
                      fire alarm technicians, BMS specialists
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Cleaning staff:</strong> window cleaners,
                      facade cleaning operatives, internal cleaning teams, specialist cleaning
                      contractors for atriums and high-level glazing
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Refurbishment workers:</strong> future
                      tradespeople who will alter, extend, or refurbish the building, potentially
                      decades after it was originally constructed
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Demolition workers:</strong> those who will
                      eventually dismantle or demolish the structure at the end of its useful life
                      &mdash; potentially 50&ndash;100 years in the future
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <p>
                The whole-life approach is not an abstract concept &mdash; it has direct, practical
                implications for every design decision. A designer who specifies a complex curtain
                wall facade must consider not only how it will be installed during construction, but
                how it will be cleaned every few months for the next 60 years, how individual panels
                will be replaced when they fail, and how the entire facade system will be removed
                during eventual demolition. Each of these activities involves people whose safety
                depends on the decisions the designer makes today.
              </p>
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                ...
                <ol className="text-white space-y-2 text-sm list-decimal list-inside">
                  ...
                  <li>
                    <strong className="text-white">Reduce</strong> &mdash; where elimination is not
                    reasonably practicable, reduce the risk through design measures
                  </li>
                  <li>
                    <strong className="text-white">Inform</strong> &mdash; provide information about
                    remaining (residual) risks to those who need it
                  </li>
                </ol>
              </div>
            </div>
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                ...
                The most effective intervention is at the top of the hierarchy:{' '}
                <strong className="text-white">
                  eliminate the need for hazardous work through design
                </strong>
                . If a hazard cannot be eliminated, the design should reduce it so far as is
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0"></div>
                    <div>
                      Factory conditions provide controlled lighting, ventilation, temperature, and
                      noise levels &mdash; unlike a live construction site exposed to weather
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0"></div>
                    <div>
                      Work is carried out at bench height or on fixed platforms, eliminating work at
                      height and reducing manual handling strain
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0"></div>
                    <div>
                      Fewer workers spend less time on site, reducing overall risk exposure and
                      congestion from multiple trades working in close proximity
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0"></div>
                    <div>
                      Quality control is improved, reducing the risk of defects that could create
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-white text-sm">
                  ...
                  configuration on every level. Repeating structural connection details means
                  steelworkers perform the same safe operation at each joint rather than adapting to
                  unique details that increase the risk of error. Standardised M&amp;E containment
                  brackets and fixings mean electricians use the same tools and techniques
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0"></div>
                    <div>
                      Specify ground-level pre-assembly of components that would otherwise require
                  ...
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0"></div>
                    <div>
                      Design connections that can be made from below rather than requiring access to
                      the top of beams or columns
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0"></div>
                    <div>
                      Include permanent edge protection in the structural design (e.g. upstand beams
                      at floor edges that act as both structure and fall prevention during
                      construction)
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0"></div>
                    <div>
                      Consider the construction sequence and ensure that each stage provides a safe
              ...
              <p>
                Temporary works must also be considered at the design stage. The designer&rsquo;s
                choices directly influence the type and extent of temporary works required &mdash;
                formwork, propping, shoring, scaffolding, and temporary bracing. A design that
                requires minimal temporary works is inherently safer because it reduces the number
                of activities that must be planned, erected, monitored, and removed before the
                permanent structure is complete.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                ...
                &mdash; lasts 50 to 60 years or more. This means that maintenance activities will be
                carried out <strong className="text-white">hundreds or thousands of times</strong>{' '}
                over the building&rsquo;s life, often by workers who had no involvement in the
                original design or construction. The designer&rsquo;s decisions about access,
                layout, and specification directly determine whether these activities can be carried
                out safely.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Plant rooms:</strong> adequate floor space for
                      equipment removal and replacement, minimum door widths for the largest
                      component, adequate lighting, ventilation, and emergency egress
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Roof areas:</strong> internal staircase access
                      (not ladders) to roof level, guardrailed walkways between the access point and
                      rooftop plant, non-fragile roof coverings on maintenance routes
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Facades:</strong> designed-in access for
                      inspection, repair, and replacement of cladding panels, sealant joints, and
                  ...
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Building services:</strong> accessible
                      isolation points, adequate space around switchgear (as required by BS 7671 and
                      the Electricity at Work Regulations 1989), removable ceiling panels for access
                      to above-ceiling services
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Anchor points:</strong> designed and certified
                      anchor points for fall arrest harnesses, cast into parapets or fixed to
                      structural steelwork, with test certification documented in the Health and
                      Safety File
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Guardrail fixings:</strong> sockets or base
                      plates cast into parapets and roof edges to accept temporary or permanent
                      guardrail systems without the need for drilling or clamping
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Permanent guardrails:</strong> where
                      maintenance access is frequent (e.g. rooftop plant accessed quarterly),
                      permanent guardrail systems compliant with BS EN 13374 should be specified as
              ...
              <p>
                <strong className="text-white">Window cleaning considerations</strong> are addressed
                by <strong className="text-white">BS 8213-1</strong> (Windows, doors and rooflights
                &mdash; Design for safety in use and during cleaning of windows). This standard
                requires designers to consider how every window in the building will be cleaned
                throughout its operational life. Reversible windows, tilt-and- turn mechanisms, and
                accessible openable casements allow external glass surfaces to be cleaned safely
                from inside the building, eliminating the need for external access at height.
              </p>
              ...
              <p>
                ...
                are the means by which the designer communicates safe maintenance information to
                future building owners and maintenance teams. The Health and Safety File must
                include details of all designed-in safe access provisions, the maintenance
                requirements for each building element, the safe systems of work that should be
                followed, and the location and type of any fall protection systems.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                ...
                regular window cleaning throughout its operational life, and the frequency of this
                cleaning depends on the building&rsquo;s location, use, and appearance standards. A
                commercial office building in a city centre may require external glazing to be
                cleaned monthly; a school or hospital typically every three to six months. Over a
                60-year building life, this represents hundreds of cleaning cycles, each of which
                exposes workers to the risk of falls from height if the design does not provide safe
                access.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Reversible windows:</strong> window designs
                      that allow the external face to be rotated or reversed so that it can be
                      cleaned safely from inside the building, eliminating the need for external
                      access at height
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Tilt-and-turn mechanisms:</strong> windows that
                      tilt inwards at the top for ventilation and turn fully inwards for cleaning,
                      allowing both glass surfaces to be reached from inside
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Maximum reach considerations:</strong> the
                      standard specifies maximum distances from the cleaning position to the
                      furthest point of glass that must be reached, ensuring that cleaners do not
                      need to lean out dangerously
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Building maintenance units (BMUs):</strong>{' '}
                      permanently installed cradle systems, typically mounted on the roof, that
                      allow cleaning operatives to access the full height and width of the facade
                      safely
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Davit systems:</strong> permanently fixed davit
                      arms at roof level that support suspended cradles or bosun&rsquo;s chairs for
                      facade access
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Monorail systems:</strong> permanent tracks
                      installed at roof level to which cradles or other access equipment can be
                      attached and traversed along the building perimeter
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Self-cleaning coatings:</strong> specialist
                      glass coatings (hydrophilic or photocatalytic) that use sunlight and rainwater
                      to break down organic dirt, reducing the frequency of manual cleaning and thus
              ...
              <p>
                ...
                <strong className="text-white">internal and external cleaning access</strong>.
                High-level internal glazing &mdash; such as atrium walls, clerestory windows, and
                internal balustrade glazing &mdash; also requires safe cleaning access.
                Purpose-built gantries, access hatches, and anchor points for internal cleaning
                should be designed into the building from the outset, not left for the facilities
                management team to improvise.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                ...
                to consider the health and safety of all persons affected by the design throughout
                the <strong className="text-white">entire lifecycle</strong> of the structure
                &mdash; and that lifecycle includes eventual demolition or decommissioning, which
                may occur 50 to 100 years in the future.
              </p>

              <p>
                Design decisions made today can have profound health and safety implications for
                demolition workers decades from now. The structural system, the materials used, the
                connections between elements, and the presence of hazardous substances all influence
                the methods available for safe demolition.{' '}
                <strong className="text-white">BS 6187</strong> (Code of practice for full and
                partial demolition) provides comprehensive guidance on demolition planning and
                execution, and emphasises the critical importance of having accurate information
                about the building&rsquo;s structure, materials, and construction methods.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Asbestos and hazardous materials:</strong>{' '}
                      designers who specify materials that may become hazardous waste (or that
                      contain hazardous components) must record this information in the Health and
                      Safety File. This includes asbestos-containing products, lead paint, certain
                      insulation materials, PCB-containing electrical equipment, and structural
                      adhesives
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      the designer must record sufficient information about the structural system
                      &mdash; load paths, connection types, pre-stressed or post-tensioned elements
                      &mdash; so that future demolition engineers can plan a safe demolition
                      sequence that maintains stability throughout the process
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Design for disassembly:</strong> where
                      reasonably practicable, designers should use mechanical fixings (bolts,
                      screws, clips) rather than permanent adhesives or welds, allowing controlled
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      these elements store enormous amounts of energy and require specialist
                      demolition techniques. The designer must record full details of tendon
                      locations, stressing forces, and anchorage positions in the Health and Safety
                      File
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Recording information:</strong> BS 6187
                      emphasises that the most dangerous demolition situations arise when
                      information about the building&rsquo;s structure is lost or incomplete. The
                      Health and Safety File is the primary mechanism for preserving this
                      information for future demolition teams
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                <div className="flex items-start gap-2">
                  ...
                  <p className="text-white text-sm">
                    ...
                    occurred during the demolition of pre-stressed structures where the demolition
                    team did not have accurate information about the tendon layout. Designers must
                    ensure this information is recorded in the Health and Safety File.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                ...
                to future building owners, occupiers, and maintenance teams. Required by{' '}
                <strong className="text-white">CDM 2015 Regulation 12</strong>, the file contains
                information likely to be needed to ensure the health and safety of any person
                carrying out subsequent construction work on the structure &mdash; including
                maintenance, repair, cleaning, refurbishment, alteration, and demolition.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">As-built drawings:</strong> accurate drawings
                      showing the actual construction, which may differ from the original design due
                      to site variations, value engineering, or construction-phase changes
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Material information:</strong> details of all
                      materials used, with particular attention to hazardous materials such as
                      asbestos-containing products, lead-based paints, resin-based adhesives, and
                      any materials that may produce hazardous dust or fumes when cut, drilled, or
                      demolished
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Structural systems:</strong> details of the
                      structural system including load paths, connection types, pre-stressed or
                      post-tensioned elements, composite construction details, and any structural
                      interdependencies
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Services routing:</strong> the location,
                      routing, and specification of all building services &mdash; electrical
                      distribution, mechanical services, plumbing, drainage, fire protection,
                      communications &mdash; including isolation points, valve locations, and
                      emergency shut-off positions
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Safe access provisions:</strong> details of all
                      designed-in safe access features &mdash; roof anchor points, cradle tracks,
                      maintenance walkways, access hatches, guardrail fixing sockets, and any
                  ...
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Residual hazard information:</strong> details
                      of any hazards that could not be eliminated through design, the risk reduction
                      measures incorporated, and any specific safe working procedures that should be
                      followed
                    </div>
                  </li>
                </ul>
              ...
              <p>
                The <strong className="text-white">principal designer</strong> has the duty to
                prepare, review, and update the Health and Safety File during the project, and to
                hand it to the client at the end of the construction phase. The client must then
                keep the file available for inspection by anyone who needs to carry out future work
                on the structure. If the building is sold, the file must transfer to the new owner.
                If the building is leased, the file must be made available to the
                leaseholder&rsquo;s maintenance team.
              </p>
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                ...
                <p className="text-white text-sm">
                  ...
                  are made to the building. If a new roof-mounted plant installation is added, the
                  file must be updated with the new access arrangements, structural loading
                  information, and maintenance requirements. If asbestos is discovered and removed
                  during refurbishment, the file must be updated to reflect the current status. The
                  file&rsquo;s value depends entirely on its accuracy and completeness.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                ...
                and poor practice, and the lessons that designers should take from them.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white mb-3">
                  ...
                  common but dangerous arrangement that would require maintenance personnel to climb
                ...
                <ul className="space-y-1.5 text-sm text-white">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      The principal designer raised a CDM design risk issue: the vertical ladder
                      provided no fall protection and would require repeated climbing by multiple
                      maintenance trades throughout the school&rsquo;s 60-year design life
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-blue-400" />
                    <span>
                      The design was revised to include an internal staircase rising from the top
                      floor to a penthouse access lobby at roof level, with a secure door opening
                      onto a guardrailed maintenance walkway
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-blue-400" />
                    <span>
                      Guardrailed walkways were routed between the access point and all rooftop
                      plant, with non-slip surfaces and anchor points at plant locations
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-blue-400" />
                    <span>
                      The additional construction cost was approximately &pound;18,000 &mdash; a
                      fraction of the 60-year scaffolding or cherry-picker hire cost that the
                ...
                <p className="text-xs text-white mt-3">
                  ...
                  through design, not to transfer the risk to maintenance contractors.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white mb-3">
                  ...
                  rope access (industrial abseiling) for window cleaning. This would have meant
                ...
                <ul className="space-y-1.5 text-sm text-white">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-blue-400" />
                    <span>
                      The CDM adviser identified that relying on rope access as the primary cleaning
                      method was contrary to the hierarchy of risk control &mdash; rope access is a
                      high-risk activity that should only be used where no other method is
                      reasonably practicable
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-blue-400" />
                    <span>
                      A building maintenance unit (BMU) was specified instead &mdash; a permanent
                      roof-mounted cradle system that could traverse the full perimeter of the
                      building, providing safe, enclosed access for cleaning operatives
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-blue-400" />
                    <span>
                      Self-cleaning glass coatings were specified for the upper floors (above the
                      8th floor) to reduce the frequency of manual cleaning at the highest levels
                    </span>
                  </li>
                </ul>
                <p className="text-xs text-white mt-3">
                  ...
                  weight and dynamic loads, which is significantly more expensive and disruptive
                  than designing it in from the outset.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white mb-3">
                  ...
                  the minimum space to maximise the lettable warehouse floor area. The electrical
                  designer raised a CDM concern because the proposed layout left{' '}
                  <strong>only 0.9m clear depth</strong> in front of the switchboard &mdash; barely
                ...
                <ul className="space-y-1.5 text-sm text-white">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-blue-400" />
                    <span>
                      The plant room was enlarged to 5.0m &times; 4.0m, providing adequate working
                      space in front of the switchboard (1.2m clear depth), circulation space for
                      two persons, and room for equipment removal and replacement
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-blue-400" />
                    <span>
                      Mechanical ventilation was upgraded to handle the combined heat output of all
                      equipment, and emergency lighting on a separate circuit was added
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-blue-400" />
                    <span>
                      The access door was widened to 1.2m and re-hung to open outwards, allowing
                      emergency egress and equipment replacement access
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-blue-400" />
                    <span>
                      A clear maintenance access zone was marked on the floor plan and recorded in
                      the Health and Safety File, with a note that the zone must not be used for
                      storage
                    </span>
                  </li>
                </ul>
                <p className="text-xs text-white mt-3">
                  ...
                  requirements that protect electricians throughout the building&rsquo;s operational
                  life. Once a building is constructed, enlarging a plant room is extremely
        ...
        <section className="mb-10">
          ...
          <div className="mt-4 bg-white/5 border border-white/10 rounded-lg p-3 max-w-2xl mx-auto">
            <p className="text-white text-xs text-center">
              ...
              lifecycle. Information from the design phase flows through to the Health and Safety
              File, which serves every subsequent phase.
            </p>
          </div>
        </section>
