...
const TITLE = 'Pre-Construction Information – CDM Regulations Module 3 Section 1';
const DESCRIPTION =
...
const quizQuestions = [
  {
    id: 1,
    question: 'Under CDM 2015, who has the duty to provide pre-construction information?',
    options: [
...
const faqs = [
  ...
  {
    question: 'Is pre-construction information only required for notifiable projects?',
    answer:
  ...
  {
    question: 'How does pre-construction information differ from the health and safety file?',
    answer:
  ...
  {
    question: "Can an electrician refuse to start work if they haven't received adequate PCI?",
    answer:
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <section className="mb-10">
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6 text-xs sm:text-sm text-white">
            <div className="rounded-lg p-3 sm:p-4 bg-blue-500/10 border-l-2 border-l-blue-400/50 border border-blue-500/30">
              <p className="font-semibold text-blue-400 mb-2 text-base">In 30 Seconds</p>
              <ul className="text-base text-white space-y-1.5">
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                  <span>
                    <strong>Legal Basis:</strong> Regulation 4(4) of CDM 2015 places a duty on the
                    client to provide PCI.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                  <span>
                    <strong>Purpose:</strong> Enables designers and contractors to plan their work
                    safely before the construction phase begins.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                  <span>
                    <strong>Recipients:</strong> Every designer and contractor appointed to, or
                ...
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                  <span>
                    <strong>Timing:</strong> As soon as is practicable — the earlier, the better.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                  <span>
                    <strong>Scope:</strong> Information about the project, the site, existing
                    structures, and known hazards that could affect the work.
                  </span>
                </li>
              </ul>
            </div>
            <div className="rounded-lg p-3 sm:p-4 bg-blue-500/10 border-l-2 border-l-blue-400/50 border border-blue-500/30">
              <p className="font-semibold text-blue-400 mb-2 text-base">Why It Matters</p>
              <ul className="text-base text-white space-y-1.5">
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                  <span>
                    <strong>Safe Design:</strong> Designers cannot eliminate or reduce risks if they
                    do not know about existing hazards such as asbestos, structural instability, or
                    buried services.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                  <span>
                    <strong>Safe Planning:</strong> Contractors cannot produce adequate method
                    statements, risk assessments, or the construction phase plan without knowing
                    what conditions they will face.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                  <span>
                    <strong>Pricing:</strong> Contractors need PCI to price work accurately —
                    unknown hazards lead to unexpected costs, delays, and disputes.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                  <span>
                    <strong>Legal Compliance:</strong> Failure to provide PCI is a breach of CDM
                    2015. The HSE can take enforcement action against clients who fail in this duty.
                  </span>
                </li>
              </ul>
            </div>
          ...
          <div className="mt-6 space-y-4 text-white">
            <p>
              Pre-construction information (PCI) is all the information about the project that is
              relevant to the health and safety of the construction work. It is the foundation upon
              which safe design and safe planning are built. Without it, designers and contractors
              are working blind — and that is precisely the situation CDM 2015 was designed to
              prevent.
            </p>
            <p>
              Regulation 4(4) states that a client must provide pre-construction information as soon
              as is practicable to every designer and contractor appointed, or being considered for
              appointment, to the project. The information must be in a convenient form, clearly
              organised, and proportionate to the scale and complexity of the work. There is no
              prescribed format — it can be a single document, a pack of reports and drawings, or a
              digital information system — but it must be accessible and usable by those who receive
              it.
            </p>
            <p>
              The concept behind PCI is straightforward: the client knows more about their building,
              their site, and their project than anyone else at the outset. By sharing that
              knowledge with the design and construction team, risks can be identified early,
              designed out where possible, and managed effectively where they cannot be eliminated.
              This upstream approach — addressing hazards before work begins rather than reacting to
              them on site — is at the heart of the CDM philosophy.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-blue-400/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                CDM 2015 does not prescribe a rigid list of what PCI must contain, because the
                information will vary depending on the type, size, and complexity of the project.
                However, HSE guidance (L153) and industry best practice establish a clear framework.
                PCI should include any information that is reasonably obtainable and relevant to the
                health and safety of the construction work.
              </p>
              ...
              <p>
                The depth of information should be proportionate to the project. A small domestic
                rewire might require only an asbestos survey, existing drawings (if available), and
                a note on access restrictions. A major commercial refurbishment would require
                comprehensive structural surveys, full asbestos R&D surveys, detailed services
                information, geotechnical data, and the previous health and safety file from the
                original construction.
              </p>
              <p>
                The key principle is this: if information exists and it is relevant to the safe
                planning or execution of the construction work, it should be included in the PCI.
                Withholding known information is not acceptable, even if the client considers it
        ...
        <section className="mb-10">
          <div className="border-l-2 border-blue-400/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                The duty to provide pre-construction information rests squarely with the client.
                This is one of the core client duties under CDM 2015 and it cannot be delegated. The
                client may appoint others to gather and compile the information — a surveyor, the
                principal designer, a project manager — but the legal responsibility remains with
                the client throughout.
              </p>

              <div className="bg-blue-500/10 border border-blue-400/30 p-4 sm:p-5 rounded-lg">
                <h3 className="text-lg font-semibold text-blue-400 mb-3">The Client Must:</h3>
                <div className="space-y-3">
                  <div className="flex items-start gap-3 bg-white/5 p-3 rounded-lg border border-white/10">
                    ...
                    <div className="text-sm">
                      <strong>Provide PCI as soon as is practicable</strong> to every designer and
                      contractor appointed or being considered for appointment — not just after the
                      contract is signed
                    </div>
                  </div>
                  <div className="flex items-start gap-3 bg-white/5 p-3 rounded-lg border border-white/10">
                    ...
                    <div className="text-sm">
                      <strong>Make reasonable enquiries</strong> to obtain information they do not
                      currently hold — commissioning surveys, requesting records from previous
                  ...
                  <div className="flex items-start gap-3 bg-white/5 p-3 rounded-lg border border-white/10">
                    ...
                    <div className="text-sm">
                      <strong>Ensure PCI is in a convenient form</strong> — clearly organised,
                      proportionate, and usable by the recipients. A box of unsorted papers dumped
                      on a contractor's desk does not meet this requirement.
                    </div>
                  </div>
                  <div className="flex items-start gap-3 bg-white/5 p-3 rounded-lg border border-white/10">
                    <div className="w-6 h-6 rounded-full bg-blue-500/20 border border-blue-400/40 flex items-center justify-center flex-shrink-0 text-blue-300 text-xs font-bold">
                    ...
                    <div className="text-sm">
                      <strong>Update PCI during the project</strong> if new information becomes
                      available — for example, an unexpected asbestos find during strip-out, or a
              ...
              <div className="bg-amber-500/10 border border-amber-400/30 p-4 rounded-lg">
                ...
                <div className="space-y-3 text-sm">
                  <p>
                    It is common for clients — particularly on refurbishment projects — to lack some
                    or all of the information needed. This does not excuse them from the duty. CDM
                    2015 requires the client to make <strong>reasonable enquiries</strong> to obtain
                  ...
                  <ul className="space-y-2">
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        <strong>No asbestos survey?</strong> Commission a management survey (or R&D
                        survey if refurbishment or demolition is planned).
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>
                        <strong>No structural drawings?</strong> Commission a structural survey or
                        appoint a structural engineer to carry out a desk study and site inspection.
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>
                        <strong>No services records?</strong> Arrange utility searches (electricity,
                        gas, water, telecoms) and underground service detection surveys.
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>
                        <strong>No ground data?</strong> Commission a ground investigation with bore
                        holes and trial pits as appropriate.
                      </span>
                    </li>
                  </ul>
                  <p>
                    Where information genuinely cannot be obtained despite reasonable enquiries,
                    this gap must be clearly documented so that designers and contractors can factor
              ...
              <p>
                The client may appoint the principal designer or another competent person to gather
                and compile PCI on their behalf. This is common practice and is strongly encouraged
                by the HSE. However, the legal duty does not transfer — if the appointed person
                fails to gather the information, it is still the client who is in breach of
                Regulation 4(4).
              </p>
            </div>
          </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-blue-400/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                Existing buildings present the greatest challenge for pre-construction information
                because there is inherent uncertainty about what lies behind walls, above ceilings,
                beneath floors, and within the fabric of the structure. This is precisely why PCI is
                so critical for refurbishment and alteration work — the unknown hazards are often
                more dangerous than those on a greenfield new-build site.
              </p>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-red-500/20 border border-red-400/50 p-4 rounded-lg">
                  ...
                  <ul className="text-white space-y-2 text-sm">
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        <strong>Management Survey:</strong> Required for all commercial buildings
                        constructed before 2000. Identifies the presence, location, and condition of
                        asbestos-containing materials (ACMs) that could be disturbed during normal
                        occupation or maintenance.
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                      <span>
                        <strong>Refurbishment & Demolition (R&D) Survey:</strong> Required before
                        any refurbishment, alteration, or demolition work. This is more intrusive
                        than a management survey and aims to identify all ACMs in the areas where
                        work will take place, including those behind panels, above ceilings, and
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                      <span>
                        <strong>For electricians:</strong> Rewiring, cable routing, socket
                        installation, and consumer unit replacement all involve drilling, chasing,
                        lifting floorboards, and accessing ceiling voids — all high-risk activities
                        for disturbing ACMs. The asbestos survey is your most important piece of
                        PCI.
                      </span>
                    </li>
                  </ul>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  <h4 className="font-semibold mb-3 text-blue-400">Structural Condition</h4>
                  <ul className="text-white space-y-2 text-sm">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                      <span>
                        Structural condition reports identifying load-bearing elements, known
                        defects, previous repairs, and any areas of structural concern
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                      <span>
                        Identification of pre-stressed or post-tensioned concrete elements that must
                        not be drilled into or cut
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                      <span>
                        Information about temporary propping or structural support that may be
                        needed during the works
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-white space-y-2 text-sm">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                      <span>
                        <strong>Lead paint:</strong> Common in buildings constructed before the
                        1970s. Sanding, scraping, or burning off lead paint generates hazardous dust
                        and fumes.
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                      <span>
                        <strong>PCBs (Polychlorinated biphenyls):</strong> Found in some older
                        fluorescent light ballasts, sealants, and paints. PCBs are toxic and
                        carcinogenic.
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                      <span>
                        <strong>Man-made mineral fibre (MMMF):</strong> Older insulation materials
                        that can cause skin and respiratory irritation during disturbance.
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  <h4 className="font-semibold mb-3 text-blue-400">Services Records & Access</h4>
                  <ul className="text-white space-y-2 text-sm">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                      <span>
                        Existing electrical installation schematics, distribution board schedules,
                        and as-installed wiring diagrams
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                      <span>
                        Mechanical services routes — heating pipework, gas runs, ventilation
                        ductwork that may conflict with proposed cable routes
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                      <span>
                        Access limitations — restricted areas, occupied spaces, working hours
                        constraints, permit-to-work requirements
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                      <span>
                        Fire compartment boundaries that must be maintained or reinstated after
                        cable penetrations
                      </span>
                    </li>
                  </ul>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-blue-400/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                New-build projects present a different set of PCI challenges. There is no existing
                structure to survey for asbestos or structural defects, but there are site-specific
                hazards and conditions that must be understood before design and construction can
                proceed safely.
              </p>
              ...
              <div className="bg-blue-500/10 border border-blue-400/30 p-4 sm:p-5 rounded-lg">
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3 bg-white/5 p-3 rounded-lg border border-white/10">
                    ...
                    <div className="text-sm">
                      <strong>Ground Investigation Reports:</strong> Bore-hole logs, trial pit
                      records, soil classification, bearing capacity data, and water table levels.
                      Essential for foundation design, excavation planning, and understanding ground
                      stability risks.
                    </div>
                  </div>
                  <div className="flex items-start gap-3 bg-white/5 p-3 rounded-lg border border-white/10">
                    ...
                    <div className="text-sm">
                      <strong>Contamination Assessments:</strong> Phase 1 desk study and Phase 2
                      intrusive investigation results. Previous land use (industrial, agricultural,
                      landfill) may have left contaminants that pose risks to workers during
                  ...
                  <div className="flex items-start gap-3 bg-white/5 p-3 rounded-lg border border-white/10">
                    ...
                    <div className="text-sm">
                      <strong>Ecological Surveys:</strong> Protected species (great crested newts,
                      bats, nesting birds), habitat assessments, and any ecological constraints that
                      affect site access, working times, or construction methods.
                    </div>
                  </div>
                  <div className="flex items-start gap-3 bg-white/5 p-3 rounded-lg border border-white/10">
                    <div className="w-6 h-6 rounded-full bg-blue-500/20 border border-blue-400/40 flex items-center justify-center flex-shrink-0 text-blue-300 text-xs font-bold">
                    ...
                    <div className="text-sm">
                      <strong>Flood Risk Assessment:</strong> Flood zone classification, surface
                      water drainage considerations, and any mitigation measures required. Affects
                      site welfare facilities location, material storage, and emergency planning.
                    </div>
                  </div>
                  <div className="flex items-start gap-3 bg-white/5 p-3 rounded-lg border border-white/10">
                    <div className="w-6 h-6 rounded-full bg-blue-500/20 border border-blue-400/40 flex items-center justify-center flex-shrink-0 text-blue-300 text-xs font-bold">
                    ...
                    <div className="text-sm">
                      <strong>Utility Searches:</strong> Underground service records from utility
                      providers (electricity, gas, water, telecoms, fibre). Critical for safe
                      excavation and avoiding cable and pipe strikes. CAT and Genny survey results
                      where available.
                    </div>
                  </div>
                  <div className="flex items-start gap-3 bg-white/5 p-3 rounded-lg border border-white/10">
                    ...
                    <div className="text-sm">
                      <strong>Planning Conditions:</strong> Any planning conditions that affect
                      construction methods, working hours, noise limits, dust suppression
                      requirements, or access routes. These can significantly constrain how and when
                      work is carried out.
                    </div>
                  </div>
                </div>
              ...
              <p>
                For electricians working on new-build projects, the most relevant PCI typically
                includes utility search records (to understand where existing services enter the
                site and where temporary supplies will be routed), the site layout plan showing
                access routes and welfare facilities, and any planning conditions that restrict
                working hours or methods. Understanding the overall site layout and phasing is also
                important so that electrical first-fix and second-fix activities are coordinated
                safely with other trades.
              </p>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <h3 className="font-semibold mb-3 text-blue-400">Brownfield vs Greenfield</h3>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-blue-400/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                Gathering PCI is only half the duty — it must also reach the right people at the
                right time. CDM 2015 establishes a clear distribution chain for notifiable projects,
                and good practice extends a similar approach to non-notifiable projects.
              </p>
              ...
              <div className="bg-blue-500/10 border border-blue-400/30 p-4 sm:p-5 rounded-lg">
                ...
                <div className="mt-4 bg-white/5 border border-white/10 p-3 rounded-lg text-sm text-white/80">
                  ...
                  distribution chain is simpler but the duty is the same.
                </div>
              </div>

              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-white">Timing of Distribution</h3>
                <ul className="space-y-2 text-sm">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Pre-tender:</strong> PCI should be included in
                      tender documentation so that contractors can price the work with full
                      knowledge of the risks and constraints. This avoids "ambush" hazards
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Pre-design:</strong> Designers must receive PCI
                      before commencing detailed design, so they can take existing hazards into
                      account in their design decisions.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Pre-construction:</strong> The principal
                      contractor must have PCI before producing the construction phase plan. All
                      contractors must have relevant PCI before they begin planning or carrying out
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Ongoing:</strong> PCI is not a one-off
                      exercise. As new information emerges during the project (unexpected ground
                      conditions, additional asbestos finds, changes in scope), it must be
                      distributed promptly to all affected parties.
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-blue-400/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                A PCI register is a management tool — not a legal requirement in itself, but
                strongly recommended as best practice for demonstrating compliance with Regulation
                4(4). It provides an auditable record of what information has been gathered, what
                has been distributed, what gaps remain, and what assumptions have been made.
              </p>
              ...
              <div className="bg-blue-500/10 border border-blue-400/30 p-4 sm:p-5 rounded-lg">
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3 bg-white/5 p-3 rounded-lg border border-white/10">
                    ...
                    <div className="text-sm">
                      <strong>Document inventory:</strong> A list of all PCI documents and reports
                      that have been gathered — asbestos surveys, structural reports, utility
                      searches, ground investigations, existing drawings, previous H&S file
                    </div>
                  </div>
                  <div className="flex items-start gap-3 bg-white/5 p-3 rounded-lg border border-white/10">
                    <div className="w-6 h-6 rounded-full bg-blue-500/20 border border-blue-400/40 flex items-center justify-center flex-shrink-0 text-blue-300 text-xs font-bold">
                    ...
                    <div className="text-sm">
                      <strong>Date received and source:</strong> When each document was received and
                      from whom — this establishes the timeline and chain of custody
                    </div>
                  </div>
                  <div className="flex items-start gap-3 bg-white/5 p-3 rounded-lg border border-white/10">
                    <div className="w-6 h-6 rounded-full bg-blue-500/20 border border-blue-400/40 flex items-center justify-center flex-shrink-0 text-blue-300 text-xs font-bold">
                    ...
                    <div className="text-sm">
                      <strong>Distribution record:</strong> Who received each piece of PCI and when
                      — confirms that the distribution duty has been fulfilled
                    </div>
                  </div>
                  <div className="flex items-start gap-3 bg-white/5 p-3 rounded-lg border border-white/10">
                    <div className="w-6 h-6 rounded-full bg-blue-500/20 border border-blue-400/40 flex items-center justify-center flex-shrink-0 text-blue-300 text-xs font-bold">
                    ...
                    <div className="text-sm">
                      <strong>Information gaps:</strong> Clearly identified gaps where information
                      was sought but not available — for example, "no as-built drawings exist for
                      the 1960s extension"
                    </div>
                  </div>
                  <div className="flex items-start gap-3 bg-white/5 p-3 rounded-lg border border-white/10">
                    ...
                    <div className="text-sm">
                      <strong>Assumptions made:</strong> Where gaps exist, record the assumptions
                      that designers and contractors are working under — for example, "assumed floor
                      void depth is 300 mm based on typical construction of the era"
                    </div>
                  </div>
                  <div className="flex items-start gap-3 bg-white/5 p-3 rounded-lg border border-white/10">
                    <div className="w-6 h-6 rounded-full bg-blue-500/20 border border-blue-400/40 flex items-center justify-center flex-shrink-0 text-blue-300 text-xs font-bold">
                    ...
                    <div className="text-sm">
                      <strong>Updates and revisions:</strong> As new information becomes available
                      during the project, record the update, the date, and who was notified
                    </div>
                  </div>
                </div>
              </div>
              ...
              <p>
                The PCI register is typically maintained by the principal designer on notifiable
                projects, as part of their duty to coordinate health and safety during the
                pre-construction phase. On smaller projects, the designer or contractor may maintain
                a simpler version. The format can be a spreadsheet, a document, or part of a project
                information management system — the key is that it exists, is kept up to date, and
                can be produced as evidence of compliance if required.
              </p>
              ...
              <div className="bg-amber-500/10 border border-amber-400/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80 mb-3">
                  ...
                  assumption, understand why the decision was made, and adjust their approach.
                ...
                <p className="text-sm text-white/80">
                  ...
                  exists and no one can demonstrate what information was available or how decisions
                  were made.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-blue-400/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-6 text-white">
              <p>
                To bring the theory to life, here are three practical scenarios showing how
                pre-construction information works in real-world situations that electricians are
                likely to encounter.
              </p>
              ...
              <div className="bg-blue-500/10 border border-blue-400/30 p-4 sm:p-5 rounded-lg">
                ...
                <div className="space-y-3 text-sm">
                  <p>
                    <strong>Project:</strong> Full rewire of a 1970s three-storey office building.
                    The building is occupied on the ground floor (the client's reception and admin
                    team) and vacant on the upper floors.
                  </p>
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    ...
                    <ul className="space-y-2 text-white/80">
                      <li className="flex items-start gap-2">
                        ...
                        <span>
                          <strong className="text-white">Asbestos R&D Survey:</strong> Identified
                          asbestos insulating board (AIB) in ceiling tiles on the first floor and
                          asbestos cement flue in the plant room. Licensed removal required before
                      ...
                      <li className="flex items-start gap-2">
                        <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                        <span>
                          <strong className="text-white">Existing Drawings:</strong> As-built
                          electrical layout from the 1990s rewire of the ground floor only. No
                          drawings exist for the upper floors — noted as a gap in the PCI register.
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                        <span>
                          <strong className="text-white">Access Restrictions:</strong> Ground floor
                          occupied during office hours (08:00–18:00). Electrical work on the ground
                          floor must be carried out outside these hours. Upper floors accessible at
                          all times.
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                        <span>
                          <strong className="text-white">Structural Information:</strong> Structural
                          engineer's report confirming that the first-floor slab is post-tensioned
                          concrete — no drilling or chasing into the soffit is permitted. Cable
                          routes must use surface trunking or be routed through the ceiling void.
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                        <span>
                          <strong className="text-white">Fire Compartmentation:</strong> Fire
                          strategy drawing showing compartment walls and fire-rated floors. All
                          cable penetrations through these elements must be fire-stopped to maintain
                          the rated integrity.
                        </span>
                      </li>
                    </ul>
              ...
              <div className="bg-blue-500/10 border border-blue-400/30 p-4 sm:p-5 rounded-lg">
                ...
                <div className="space-y-3 text-sm">
                  <p>
                    <strong>Project:</strong> Phase 2 of a 120-unit housing development on a former
                    industrial estate (brownfield site).
                  </p>
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    ...
                    <ul className="space-y-2 text-white/80">
                      <li className="flex items-start gap-2">
                        <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                        <span>
                          <strong className="text-white">Ground Investigation:</strong> Bore-hole
                          logs showing made ground (fill material) to 2.5 m depth, high water table,
                          and clay subsoil. Implications for excavation support and dewatering.
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                        <span>
                          <strong className="text-white">Contamination Assessment:</strong> Phase 2
                          report identifying hydrocarbon contamination in the south-west corner of
                          the site from the former fuel storage area. PPE requirements for
                          groundworks in this area.
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                        <span>
                          <strong className="text-white">Utility Records:</strong> 11 kV underground
                          electricity cable crossing the south boundary of the site. 150 mm gas main
                          running along the western access road. Both require exclusion zones during
                          excavation.
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                        <span>
                          <strong className="text-white">Phase 1 H&S File:</strong> Records from
                          Phase 1 showing underground drainage routes, temporary road construction
                          details, and lessons learnt regarding winter working conditions on the
                          clay subsoil.
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                        <span>
                          <strong className="text-white">Planning Conditions:</strong> Working hours
                          restricted to 07:30–18:00 weekdays and 08:00–13:00 Saturdays. No working
                          on Sundays or public holidays. Noise limit of 65 dB(A) at the nearest
              ...
              <div className="bg-blue-500/10 border border-blue-400/30 p-4 sm:p-5 rounded-lg">
                ...
                <div className="space-y-3 text-sm">
                  <p>
                    <strong>Project:</strong> Electrical upgrade to a 1950s primary school during
                    the summer holidays. New distribution boards, LED lighting throughout,
                    additional socket outlets in classrooms, and new fire alarm system.
                  </p>
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    ...
                    <ul className="space-y-2 text-white/80">
                      <li className="flex items-start gap-2">
                        ...
                        <span>
                          ...
                          Asbestos cement roof sheets on the original 1950s building. Asbestos
                          insulation on heating pipework in the corridor ceiling voids. Vinyl floor
                          tiles in the hall (presumed to contain asbestos).
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                        <span>
                          ...
                          Partial — some distribution board schedules exist from a 2005 modification
                          but do not cover the original circuits. PCI register notes this gap and
                          the assumption that a full survey of existing circuits will be required on
                          site.
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                        <span>
                          <strong className="text-white">Access Programme:</strong> School closes
                          for summer on 18 July. Caretaker on site weekdays only. Holiday clubs
                          using the hall from 9 am to 3 pm on Tuesdays and Thursdays — the hall
                      ...
                      <li className="flex items-start gap-2">
                        <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                        <span>
                          <strong className="text-white">Structural Note:</strong> Original block
                          walls are single-skin in places. Chase depth limited to 15 mm to avoid
                          compromising structural integrity. Surface-mounted trunking preferred
                          where possible.
                        </span>
                      </li>
                    </ul>
                  ...
                  <p className="text-white/70 italic">
                    ...
                    dictate the programme. The structural note changes the installation method for
                    cable containment.
                  </p>
                </div>
              </div>
        ...
        {/* Quiz Section */}
        <div className="mt-12">
          <Quiz title="Pre-Construction Information Quiz" questions={quizQuestions} />
        </div>
