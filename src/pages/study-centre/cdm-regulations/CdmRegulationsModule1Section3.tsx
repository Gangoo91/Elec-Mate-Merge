...
const faqs = [
  {
    question: "Is painting a room considered 'construction work' under CDM 2015?",
    answer:
  ...
  {
    question: 'Does CDM 2015 apply when an electrician rewires a house for a homeowner?',
    answer:
  ...
  {
    question: 'Does fitting a new kitchen count as construction work under CDM?',
    answer:
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <header className="text-center mb-12">
          ...
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-500/10 border border-blue-500/20 mb-3 mx-auto">
            <span className="text-blue-400 text-xs font-semibold">MODULE 1 &middot; SECTION 3</span>
          </div>
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-blue-500/5 border-l-2 border-blue-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Regulation 2</strong> defines &ldquo;construction work&rdquo; very broadly
              </li>
              <li>
                <strong>6 key roles:</strong> client, contractor, designer, PD, PC, worker
              </li>
              <li>
                <strong>Domestic clients</strong> have duties that transfer automatically
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-blue-500/5 border-l-2 border-blue-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Threshold:</strong> &gt;30 days &amp; &gt;20 workers, or &gt;500 person-days
              </li>
              <li>
                <strong>Notify:</strong> F10 form to the HSE before work starts
              </li>
              <li>
                <strong>Scope:</strong> Includes fitting out, maintenance, demolition &amp; more
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                <strong>Regulation 2 of CDM 2015</strong> and is deliberately very broad.
                Understanding precisely what qualifies as &ldquo;construction work&rdquo; is
                essential because it determines whether CDM duties apply to an activity. If an
                activity falls within this definition, every person involved in that activity
                &mdash; client, designer, contractor, worker &mdash; has legal duties under CDM.
              </p>
              ...
              <p>
                This list is not exhaustive. The HSE takes the view that if an activity involves
                working on or in connection with a structure, it is likely to be construction work
                under CDM. The inclusion of <strong>redecoration</strong> and{' '}
                <strong>maintenance</strong> means that even routine activities such as painting,
                replacing a roof tile, or servicing an electrical installation are construction
                work. This is a deliberately wide net &mdash; the purpose is to ensure that health
                and safety duties apply to all activities where construction risks exist.
              </p>
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  The scale of duties is proportionate to the risk, but the duties always exist.
                  Even a simple socket change in a domestic property is technically construction
                  work.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The definition of <strong>structure</strong> in CDM 2015 extends far beyond
                conventional buildings. It is critical to understand this definition because CDM
                applies to all construction work relating to a &ldquo;structure&rdquo; &mdash; and
                the wider the definition, the wider the application of CDM duties.
              </p>
                ...
                <div className="grid sm:grid-cols-2 gap-3">
                  {[
                    ...
                    },
                    {
                      ...
                      examples: 'Railway lines and sidings, tramway lines, roads, airfields',
                    },
                    {
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  &ldquo;structure&rdquo; under CDM. If you are carrying out electrical work on any
                  of these structures, CDM duties apply. This includes, for example, installing
                  power supplies to scaffolding hoists, wiring temporary site accommodation, or
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The term <strong>design</strong> in CDM 2015 is much broader than most people
                expect. It is not limited to architectural drawings or structural calculations. CDM
                defines design as any activity that involves preparing or modifying a design for a
              ...
              <p>
                ...
                <strong>anyone who makes design decisions is a designer under CDM</strong>,
                regardless of their job title. This can include architects, engineers, interior
                designers, building services consultants, quantity surveyors (who specify
                materials), and even contractors who decide on methods of work or materials to be
                used on site.
              </p>
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  health and safety implications of their design decisions &mdash; for example, can
                  the containment be installed safely without working at height? Are the specified
                  cable routes accessible for future maintenance? Will the distribution board
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                CDM 2015 defines <strong>six key duty-holder roles</strong>. Every person involved
                in a construction project holds at least one of these roles, and each role carries
                specific legal duties. On small projects, a single person or organisation may hold
                  ...
                  <div className="grid md:grid-cols-[180px_1fr] gap-3">
                    ...
                    <div>
                      <p className="text-sm text-white">
                        ...
                        sufficient time and resources are allocated, appointing designers and
                        contractors with the right skills, knowledge, and experience, and ensuring
                        relevant information is provided to the project team.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="grid md:grid-cols-[180px_1fr] gap-3">
                    ...
                    <div>
                      <p className="text-sm text-white">
                        ...
                        information about remaining risks to those who need it. This duty applies to
                        anyone who makes design decisions &mdash; not just architects and engineers.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="grid md:grid-cols-[180px_1fr] gap-3">
                    ...
                    <div>
                      <p className="text-sm text-white">
                        ...
                        work to ensure it is carried out safely, and must ensure that workers have
                        the information, instruction, training, and supervision they need.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="grid md:grid-cols-[180px_1fr] gap-3">
                    ...
                    <div>
                      <p className="text-sm text-white">
                        ...
                        comply with their CDM duties, and they prepare and maintain the health and
                        safety file. The PD must be a designer (or an organisation employing
                        designers) with the skills, knowledge, and experience necessary for the
                        role.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="grid md:grid-cols-[180px_1fr] gap-3">
                    ...
                    <div>
                      <p className="text-sm text-white">
                        ...
                        contractors comply with their duties, manage site access, and coordinate
                        welfare provisions. The PC must be a contractor &mdash; you cannot appoint a
                        non-contractor (such as a designer) as PC.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="grid md:grid-cols-[180px_1fr] gap-3">
                    ...
                    <div>
                      <p className="text-sm text-white">
                        ...
                        provided for their health, safety, or welfare. Workers must also be
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  installation), <strong>contractor</strong> (carrying out the construction work),
                  and <strong>worker</strong> (physically doing the work). They may also hold the
                  client&rsquo;s transferred duties if the homeowner is a domestic client. Each role
                  carries its own duties, and all must be fulfilled.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                A <strong>domestic client</strong> is a person who lives, or will live, in the
                premises where construction work is carried out, and who commissions the work for
                purposes not connected with a business. This definition covers homeowners
                commissioning extensions, renovations, rewires, new kitchens, loft conversions, and
                similar residential work.
              </p>
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  must fulfil the client duties that the homeowner would otherwise hold. This means
                  contractors working for domestic clients carry a greater burden of responsibility
                  under CDM than many realise &mdash; particularly on projects involving multiple
                  trades.
                </p>
              </div>

              <p>
                A person is <strong>not</strong> a domestic client if the work relates to a property
                they own but do not live in (e.g. a buy-to-let landlord commissioning work on a
                rental property). Landlords commissioning work on rental properties are commercial
                clients with full CDM client duties.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                CDM 2015 <strong>Regulation 6</strong> sets out the thresholds for when a
                construction project must be notified to the Health and Safety Executive (HSE).
                Notification is a formal process that alerts the HSE to significant construction
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  formally notified to the HSE via the F10 form. A project below the threshold still
                  has all CDM duties &mdash; the client, designers, contractors, and workers must
                  all fulfil their responsibilities.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                While the scope of CDM 2015 is deliberately broad, there are specific activities and
                sectors that fall <strong>outside</strong> the definition of construction work or
                are covered by separate, dedicated legislation. Understanding these boundaries is
                important to avoid both over-application and under-application of CDM duties.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-3">
                  {[
                    ...
                    {
                      exclusion: 'Offshore installations (exploration & extraction)',
                      reason:
                    ...
                    {
                      exclusion: 'Construction work covered by CDM (Northern Ireland)',
                      reason:
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  legislation), but the <strong>installation</strong> of those components on site is
                  construction work. Similarly, <strong>routine cleaning</strong> of a building is
                  generally not construction work, but cleaning that involves working on the fabric
                  of the structure (such as pressure washing or repointing) may be. When in doubt,
                  the HSE advises applying CDM duties on a proportionate basis.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Despite the breadth of the CDM definitions, there are genuine grey areas where it is
                not immediately obvious whether an activity constitutes construction work. The HSE
                recognises this and advocates a <strong>proportionate approach</strong> &mdash;
                applying CDM duties in a way that is appropriate to the level of risk, rather than
                applying the full weight of CDM paperwork to every minor task.
              </p>
                  ...
                  <div className="grid md:grid-cols-[180px_1fr] gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-white">
                        ...
                        decorator, the CDM duties are minimal and largely amount to the contractor
                        managing their own health and safety competently (risk assessment, safe use
                        of access equipment, ventilation for solvent-based products).
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="grid md:grid-cols-[180px_1fr] gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-white">
                        ...
                        construction work. The electrician carries CDM contractor and designer
                        duties. If working for a homeowner, the domestic client duties transfer to
                        the electrician.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="grid md:grid-cols-[180px_1fr] gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-white">
                        ...
                        altering drainage), the CDM design duties also become significant. A simple
                        like-for-like unit replacement with no plumbing or electrical changes might
                        sit on the boundary.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="grid md:grid-cols-[180px_1fr] gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-white">
                        ...
                        minimal. The proportionate approach means the contractor should manage the
                        obvious risks (working at height, isolation, competence) without needing
                        extensive CDM documentation.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="grid md:grid-cols-[180px_1fr] gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-white">
                        ...
                        However, cleaning that involves scaffolding, abseil access, or work on the
                        building fabric (such as cleaning stonework with specialist equipment) may
                        cross into construction work territory.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="grid md:grid-cols-[180px_1fr] gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-white">
                        ...
                        Installing a large shelving system that is fixed to the structure and
                        requires structural assessment is more clearly construction work. The HSE
                        guidance states that CDM should be applied proportionately &mdash; common
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  enforcement action, personal liability in the event of an incident) are far more
                  serious than the minor administrative effort of applying CDM to a borderline
                  activity. The HSE&rsquo;s guidance document L153 and the CDM 2015 regulations
                  themselves are freely available on the HSE website.
                </p>
              </div>
            </div>
          </div>
