...
const quickCheckQuestions = [
  {
    ...
    question: 'Under which CDM 2015 regulation is the health and safety file required?',
    options: [
...
const faqs = [
  {
    question: 'Is a health and safety file required for every construction project?',
    answer:
  ...
  {
    question: 'Can the health and safety file be electronic or does it have to be on paper?',
    answer:
  ...
  {
    question: 'What happens to the health and safety file when a building is sold?',
    answer:
...
export default function CdmRegulationsModule3Section3() {
  useSEO({
    title: 'Health & Safety File | CDM Regulations Module 3.3',
    description:
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <header className="text-center mb-12">
          ...
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-500/10 border border-blue-500/20 mb-3 mx-auto">
            <span className="text-blue-500 text-xs font-semibold">MODULE 3 &middot; SECTION 3</span>
          </div>
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-blue-500/5 border-l-2 border-blue-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>What:</strong> Document containing info for future construction work
              </li>
              <li>
                <strong>Who:</strong> PD prepares it; client retains it
              </li>
              <li>
                <strong>When:</strong> Compiled during the project, handed over at the end
              </li>
              <li>
                <strong>Why:</strong> Protects anyone working on the structure in the future
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-blue-500/5 border-l-2 border-blue-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              ...
              <li>
                <strong>Electrical:</strong> Board schedules, cable routes, test certs
              </li>
              <li>
                <strong>Handover:</strong> PD passes file to client at project end
              </li>
              <li>
                <strong>Retention:</strong> Client keeps it for the life of the structure
              </li>
            </ul>
          </div>
        </div>
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  it outlives the project and serves future workers who may carry out maintenance,
                  cleaning, refurbishment, or demolition.
                </p>
              </div>

              <p>
                The H&S file is not a record of what happened during the construction phase. It is
                not a daily diary, an accident log, or a contract document. Its sole purpose is to
                provide{' '}
                <strong>
                  information that future designers, contractors, and building managers will need
                </strong>{' '}
              ...
              <p>
                Think of it as a{' '}
                <strong>user manual for the building&rsquo;s health and safety</strong>. Just as a
                car comes with a handbook explaining how to maintain it safely, a completed
                construction project should come with a health and safety file explaining what
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="grid sm:grid-cols-2 gap-2 text-sm text-white">
                  <div className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Maintenance</strong> &mdash; routine servicing,
                      inspection, repair
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Cleaning</strong> &mdash; window cleaning,
                      facade access, confined spaces
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Refurbishment</strong> &mdash; alterations,
                      fit-out, conversion
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Demolition</strong> &mdash; partial or full
              ...
              <p>
                The file is required under <strong>Regulation 12(5) of CDM 2015</strong>. It applies
                to all projects where a principal designer is appointed (i.e. projects with more
                than one contractor). Even on smaller projects, it is good practice to compile
                relevant health and safety information for future reference.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The <strong>principal designer (PD)</strong> is responsible for the health and
                safety file. This responsibility begins during the pre-construction phase and
                continues throughout the construction phase until the file is handed over to the
                client.
              </p>
                ...
                <ol className="text-sm text-white space-y-3">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      &mdash; establish the structure and begin populating it with relevant design
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Review and update during construction</strong>{' '}
                      &mdash; as the project progresses, update the file with as-built information,
                      any design changes, and contractor contributions
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-0.5 w-7 h-7 rounded-full bg-blue-500/20 border border-blue-500/40 flex items-center justify-center flex-shrink-0 text-xs font-bold text-blue-400">
                    ...
                    <span>
                      <strong className="text-white">Revise as necessary</strong> &mdash; if
                      significant changes occur during construction that affect the as-built
                      condition, the file must be revised to reflect reality
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-0.5 w-7 h-7 rounded-full bg-blue-500/20 border border-blue-500/40 flex items-center justify-center flex-shrink-0 text-xs font-bold text-blue-400">
                    ...
                    <span>
                      ...
                      &mdash; the completed file must be handed over to the client, who then becomes
                      the dutyholder responsible for its retention
                    </span>
                  </li>
                </ol>
              </div>
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-blue-500">Important:</strong> The principal designer does
                  not have to write every part of the file themselves. They must{' '}
                  <strong>ensure</strong> the file is prepared &mdash; this means gathering
                  information from designers, contractors, and specialist subcontractors. The PD
                  co-ordinates the contributions and ensures the file is complete, accurate, and
                  useful.
                </p>
              </div>

              <p>
                Contractors and subcontractors have a duty to co-operate with the PD and provide
                information for the file. For electrical installations, the electrical contractor
                should provide as-built drawings, test certificates, cable route information, and
                details of any residual hazards. This information should be provided in good time,
                not rushed at the end of the project.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  up to date if further work is carried out on the structure. The client&rsquo;s
                  duty does not end when the contractor leaves site.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The content of the health and safety file should be <strong>proportionate</strong>{' '}
                to the nature and scale of the project. A small domestic extension will require a
                simpler file than a major commercial development. However, the information must
                always be <strong>specific to the actual project</strong> &mdash; generic
                boilerplate content is not acceptable.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-3 text-sm text-white">
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">As-built drawings</strong> &mdash; showing the
                      actual constructed condition, not just the original design intent. These must
                      reflect any changes made during construction
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Design criteria</strong> &mdash; the basis on
                      which the design was developed, including assumptions, load calculations, and
                  ...
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">General structure details</strong> &mdash;
                      structural form, foundations, load-bearing elements, pre-stressed or
                  ...
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Building services details</strong> &mdash;
                      electrical, mechanical, and plumbing systems including their layout, capacity,
                  ...
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Materials used</strong> &mdash; particularly
                      any hazardous materials (asbestos, lead paint, treated timber) and their
                  ...
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Maintenance procedures</strong> &mdash; details
                      of how building elements and services should be safely maintained, accessed,
                      and serviced
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Residual hazards and risks</strong> &mdash; any
                      hazards that could not be designed out and remain in the completed structure,
                      including information on how they have been managed
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-blue-500">The Proportionality Principle:</strong> The file
                  should contain only information that is <strong>useful</strong> for future health
                  and safety. It is not a dumping ground for every project document. A
                  well-organised, concise file that contains relevant information is far more
                  valuable than a bulky file packed with irrelevant paperwork that no one will ever
                  read.
                </p>
              </div>

              <p>
                For electrical installations, the building services section is particularly
                important. Future electricians carrying out maintenance, alterations, or
                fault-finding will need accurate, up-to-date information about the electrical
                systems. This is covered in detail in the next section.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  installation to work safely. Incomplete or missing electrical information in the
              ...
              <p>
                Hidden or embedded cables are a particular concern. When cables are buried within
                walls, cast into concrete floors, or run through inaccessible voids, there is no way
                for future workers to know where they are without accurate records. A future
                electrician drilling into a wall to install a new socket could strike a concealed
                cable if its route is not recorded in the H&S file.
              </p>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  file can prevent these incidents. As an electrical contractor, you have a duty to
                  provide this information for inclusion in the file.
                </p>
              </div>

              <p>
                Isolation procedures are equally important. Complex electrical systems &mdash;
                particularly in commercial and industrial buildings &mdash; may have multiple
                sources of supply, interlocks, standby generators, and UPS systems. A future
                electrician needs to know the <strong>complete isolation procedure</strong> for each
                part of the installation, not just the location of the main switch.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Not every project requires a principal designer. Under CDM 2015, a PD is only
                required when there is <strong>more than one contractor</strong> working on the
                project. On <strong>single-contractor projects</strong>, the duties that would
                normally fall to the PD are either absorbed by the contractor or, in some cases, by
                the client.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white">
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Contractor takes on PD file duties</strong>{' '}
                      &mdash; the contractor must ensure the health and safety file is prepared if
                  ...
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Proportionate approach</strong> &mdash; the
                      file should be proportionate to the scale and nature of the work. A small
                      domestic rewire does not need the same level of documentation as a hospital
                      refurbishment
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Not always required</strong> &mdash; if there
                      is no information that would be useful for future construction work, a file
                      may not be necessary. But consider carefully before deciding a file is not
                      needed
                    </span>
                  </div>
                </div>
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  ...
                  A sole-trader electrician carrying out a full domestic rewire is a
                  single-contractor project. Even without a PD, it would be good practice to provide
                  the homeowner with a simple H&S file containing as-built cable route drawings,
                  distribution board schedules, test certificates, and details of any concealed
                  wiring. This information could be invaluable to any future electrician working on
                  the property.
                </p>
              </div>
              ...
              <p>
                ...
                <strong>
                  &ldquo;Is there information about this project that someone carrying out future
                  work would need to know to do so safely?&rdquo;
                </strong>{' '}
                If the answer is yes, a health and safety file (or at least the relevant
                information) should be compiled and passed to the client, regardless of whether a PD
                was appointed.
              </p>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                CDM 2015 does not prescribe a specific format for the health and safety file. It can
                be <strong>paper, electronic, or a combination</strong>. The format should be chosen
                based on what will be most accessible and useful for future users of the
                information.
              </p>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-3">Format Options</p>
                <div className="grid sm:grid-cols-2 gap-3 text-sm">
                  <div className="bg-white/5 rounded-lg p-3">
              ...
              <p>
                Regardless of format, the file must be <strong>clearly indexed</strong> so that
                future users can quickly find the information they need. A poorly organised file
                &mdash; even one containing excellent information &mdash; is of limited value if
                nobody can find what they are looking for.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Clear indexing</strong> &mdash; logical
                      sections, table of contents, labelled drawings
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Version control</strong> &mdash; clearly dated
                      revisions so users know they are looking at the most current information
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Accessible to future users</strong> &mdash;
                      stored in a known location, formats that remain readable over time, backup
                      copies maintained
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Usable without specialist knowledge</strong>{' '}
                      &mdash; the file should be understandable to a competent person, not just the
                      original designer
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-blue-500">BIM Note:</strong> On projects using Building
                  Information Modelling, the H&S file information can be embedded within the model
                  as metadata attached to building elements. This allows future users to click on an
                  element (such as a distribution board or cable route) and access the relevant H&S
                  information directly. This is increasingly common on larger projects and is
                  considered best practice where BIM is being used.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Once the principal designer has handed over the completed health and safety file,
                the <strong>client becomes the dutyholder</strong>. The client&rsquo;s
                responsibilities regarding the file are ongoing &mdash; they do not end when the
                project is finished.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ol className="text-sm text-white space-y-3">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Retain the file</strong> &mdash; the client
                      must keep the health and safety file in a safe, accessible location for the
                      life of the structure. There is no expiry date
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-0.5 w-7 h-7 rounded-full bg-blue-500/20 border border-blue-500/40 flex items-center justify-center flex-shrink-0 text-xs font-bold text-blue-400">
                    ...
                    <span>
                      ...
                      &mdash; future designers, contractors, building managers, and anyone carrying
                      out construction work on the structure must be given access to the file
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-0.5 w-7 h-7 rounded-full bg-blue-500/20 border border-blue-500/40 flex items-center justify-center flex-shrink-0 text-xs font-bold text-blue-400">
                    ...
                    <span>
                      <strong className="text-white">Keep it updated</strong> &mdash; when further
                      construction work is carried out on the structure, the file must be updated to
                      reflect the changes. New information must be added and outdated information
                      revised
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      &mdash; the file must be passed to the new owner, who then becomes the new
                      dutyholder. This applies whether the property is sold, leased, or otherwise
                      transferred
                    </span>
                  </li>
                </ol>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  <strong className="text-white">explain these duties clearly</strong> when handing
                  over the file. It is good practice to include a cover letter or front page in the
                  file itself that explains what the file is, why it matters, and what the client
                  must do with it.
                </p>
              </div>

              <p>
                The obligation to make the file available is particularly important for electrical
                work. If a future electrician is called to carry out work on the building, they
                should be able to request the H&S file and obtain information about the existing
                electrical installation &mdash; cable routes, isolation procedures, distribution
                board schedules, and any residual hazards. A client who cannot provide this
                information is failing in their legal duty.
              </p>

              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-blue-500">Property Transfers:</strong> When a building
                  changes hands, the H&S file should be treated as part of the property
                  documentation &mdash; like title deeds, planning consents, and building control
                  certificates. Solicitors and conveyancers should be made aware of the file&rsquo;s
                  existence and ensure it is transferred as part of the sale process. In practice,
                  this is an area where many files are lost.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
                ...
                <div className="space-y-2">
                  <div className="flex items-start gap-2 text-sm text-white">
                    ...
                    <span>
                      ...
                      many projects, no health and safety file is compiled, despite the legal
                      requirement. The file is often seen as a low priority compared to programme
                      and cost
                    </span>
                  </div>
                  <div className="flex items-start gap-2 text-sm text-white">
                    ...
                    <span>
                      ...
                      that contain irrelevant information, manufacturer brochures, or padded-out
                  ...
                  <div className="flex items-start gap-2 text-sm text-white">
                    ...
                    <span>
                      ...
                      that are compiled but never formally handed over to the client, or handed over
                  ...
                  <div className="flex items-start gap-2 text-sm text-white">
                    ...
                    <span>
                      ...
                      are accurate at handover but never updated when subsequent work is carried out
                      on the structure
                    </span>
                  </div>
                  <div className="flex items-start gap-2 text-sm text-white">
                    ...
                    <span>
                      ...
                      &mdash; boilerplate templates filled in with generic information that could
                  ...
                  <div className="flex items-start gap-2 text-sm text-white">
                    ...
                    <span>
                      ...
                      files that are not passed on when a property is sold or transferred, leaving
                      the new owner (and future workers) without critical safety information
                    </span>
                  </div>
                </div>
              </div>
                ...
                <div className="space-y-2">
                  <div className="flex items-start gap-2 text-sm text-white">
                    ...
                    <span>
                      ...
                      compiling information during the design phase, not as an afterthought at the
                      end of the project
                    </span>
                  </div>
                  <div className="flex items-start gap-2 text-sm text-white">
                    ...
                    <span>
                      ...
                      piece of information in the file should relate directly to the actual
                  ...
                  <div className="flex items-start gap-2 text-sm text-white">
                    ...
                    <span>
                      ...
                      designs change during construction. The file must reflect what was actually
                  ...
                  <div className="flex items-start gap-2 text-sm text-white">
                    ...
                    <span>
                      ...
                      client understands what the file is and what they must do with it. Document
                      the handover
                    </span>
                  </div>
                  <div className="flex items-start gap-2 text-sm text-white">
                    ...
                    <span>
                      ...
                      ask yourself: &ldquo;If I were an electrician coming to this building in 20
                      years, what would I need to know?&rdquo;
                    </span>
                  </div>
                </div>
              </div>
              ...
              <p>
                The health and safety file is often described as the most neglected document in
                construction. This is a significant failing because the file is the one document
                that is specifically designed to protect workers who have not yet arrived on site
                &mdash; people who may not even be in the industry yet. Getting the file right is an
                investment in <strong>future safety</strong>.
              </p>
            </div>
          </div>
        </section>
