...
const quizQuestions = [
  ...
  {
    id: 3,
    question: 'What happens when a prohibition notice is appealed to an Employment Tribunal?',
    options: [
...
const faqs = [
  ...
  {
    question: 'How does the Fee for Intervention (FFI) work, and is it possible to challenge it?',
    answer:
...
export default function CdmRegulationsModule5Section4() {
  useSEO({
    title: 'Monitoring, Review & Enforcement | CDM Regulations Module 5.4',
    description:
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="bg-blue-500/10 border border-blue-500/30 rounded-xl p-5 mb-6">
          ...
          <p className="text-white text-base leading-relaxed">
            ...
            21 days to comply), prohibition notices (immediate stop), and prosecution (unlimited
            fines, up to 2 years&apos; imprisonment). The most serious cases may involve corporate
            manslaughter charges. Duty holders must also report incidents under RIDDOR 2013 and
            maintain ongoing active and reactive monitoring to ensure continued compliance
        ...
        <div className="bg-blue-400/10 border border-blue-400/30 rounded-xl p-5 mb-8">
          ...
          <p className="text-white text-base leading-relaxed">
            ...
            Understand that monitoring is everyone&apos;s responsibility: report hazards, attend
            toolbox talks, and never ignore a near miss. A site that monitors proactively is far
            less likely to face enforcement action than one that only reacts after something goes
            wrong.
          </p>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/40 pl-5 space-y-4">
            <p className="text-white text-sm leading-relaxed">
              ...
              promotes good health and safety practice through guidance, education, and industry
              engagement, and it enforces the law through inspections, investigations, and
              prosecution where necessary. The HSE is not a government department — it is a
              non-departmental public body that operates independently to ensure impartiality in its
            ...
            <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
              ...
              <ul className="space-y-2 text-sm text-white">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong className="text-white">Construction Division</strong> — a specialist
                    division within the HSE dedicated to the construction industry. Employs
                    inspectors with specific construction knowledge and experience. Leads the
                    HSE&apos;s strategy for reducing death, injury, and ill health in construction
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-blue-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Inspectors</strong> — HSE inspectors are
                    warranted officers with legal powers under HASAWA 1974. They carry out planned
                    inspections, investigate complaints and incidents, and take enforcement action
                    where necessary. Construction inspectors typically have engineering, building,
                    or health and safety qualifications and significant industry experience
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-blue-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Specialist Teams</strong> — the HSE has
                    specialist teams covering areas such as occupational health, major hazards, and
                    workplace transport. These teams can be called upon to support construction
                    inspections where specialist knowledge is required (e.g., asbestos, structural
                    collapse, chemical exposure)
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-blue-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Proactive Inspection Programmes</strong> — the
                    HSE runs targeted inspection programmes focused on high-risk sectors and
                    activities. In construction, these often target work at height, refurbishment,
                    small contractors, and specific trades (such as roofing and demolition). Sites
                    may be inspected without prior notice as part of these programmes
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-amber-500/10 border border-amber-500/30 rounded-lg p-4">
              ...
              <p className="text-white text-sm leading-relaxed">
                ...
                writing to the duty holder — the duty holder must pay the HSE&apos;s costs. The
                current rate is <strong className="text-white">&pound;171 per hour</strong>. This
                covers all time spent by the HSE dealing with the breach: the inspection itself,
                follow-up investigations, correspondence, and any enforcement action. FFI invoices
                can accumulate rapidly — a single site visit involving multiple breaches can cost
                thousands of pounds before any fine or enforcement notice is even considered. FFI is
                separate from and additional to any fines imposed by the courts.
              </p>
            </div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-lg p-4">
              ...
              <p className="text-white text-sm leading-relaxed">
                ...
                consistent — similar situations should be treated similarly; enforcement should be
                targeted at those with primary responsibility; and enforcement decisions should be
                transparent — duty holders should understand what is expected of them and why action
                has been taken. The HSE uses an Enforcement Management Model (EMM) to guide
                inspectors in making consistent enforcement decisions.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/40 pl-5 space-y-4">
            <p className="text-white text-sm leading-relaxed">
              ...
              offence under Section 33 of HASAWA 1974 to intentionally obstruct an inspector in the
              exercise of their powers, or to fail to comply with a requirement made by an
              inspector.
            </p>
            <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
              <h4 className="font-semibold text-white text-sm mb-3 flex items-center gap-2">
              ...
              <ul className="space-y-2 text-sm text-white">
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-blue-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Right of entry</strong> — an inspector may enter
                    any premises at any reasonable time, or at any time if they have reasonable
                    cause to believe a dangerous situation exists. No appointment or permission is
                    required. The inspector must produce their warrant of appointment if asked to do
                    so
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-blue-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Inspect and examine</strong> — the power to carry
                    out any examination and investigation that the inspector considers necessary.
                    This includes inspecting plant, equipment, substances, working methods, and
                    documentation
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    ...
                    — the inspector may take any measurements, photographs, or recordings they
                    consider necessary. They may take samples of any articles or substances found on
                    the premises
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-blue-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Require documents</strong> — the inspector may
                    require the production of, inspect, and take copies of any books, documents, or
                    records (including those kept electronically) that they consider relevant. This
                    includes risk assessments, method statements, the construction phase plan,
                    training records, and any other documentation relating to health and safety
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-blue-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Interview under caution</strong> — the inspector
                    may require any person to answer questions and sign a declaration of the truth
                    of their answers. In cases where criminal proceedings may follow, interviews are
                    conducted under caution in accordance with PACE (Police and Criminal Evidence
                    Act 1984) procedures
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-blue-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Seize and render harmless</strong> — where the
                    inspector considers that any article or substance is a cause of imminent danger
                    of serious personal injury, they may seize it and cause it to be rendered
            ...
            <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-4">
              ...
              <p className="text-white text-sm leading-relaxed">
                ...
                investigation. Intentional obstruction of an inspector — including refusing entry,
                hiding documents, providing false information, or instructing workers not to speak
                to the inspector — is a criminal offence punishable by a fine and, in some cases,
                imprisonment. Even where an investigation may lead to prosecution, the duty to
                cooperate remains, subject to the privilege against self-incrimination (which is why
                formal interviews are conducted under PACE caution).
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/40 pl-5 space-y-4">
            <p className="text-white text-sm leading-relaxed">
              ...
              will continue or be repeated. The improvement notice is the most common formal
              enforcement tool used by the HSE on construction sites.
            </p>
            <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
              <h4 className="font-semibold text-white text-sm mb-3 flex items-center gap-2">
              ...
              <ul className="space-y-2 text-sm text-white">
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-blue-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">When issued</strong> — the inspector believes
                    there is a contravention of health and safety law that is occurring or is likely
                    to recur. The contravention must be capable of being remedied
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-blue-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Content</strong> — the notice must state the
                    inspector&apos;s opinion, specify the statutory provision being contravened,
                    give reasons for the opinion, and require the person to remedy the contravention
                    (or the matters giving rise to it) within a specified period
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-blue-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Compliance period</strong> — minimum 21 days from
                    the date of service. The inspector may allow a longer period if the remedial
                    work is complex or requires time to arrange
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-blue-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Appeal</strong> — the recipient can appeal to an
                    Employment Tribunal within 21 days of service. Crucially,{' '}
                    <strong className="text-white">
                      the improvement notice is suspended during the appeal
                    </strong>{' '}
                    — the duty holder does not have to comply until the appeal is determined
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-blue-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Failure to comply</strong> — failing to comply
                    with an improvement notice within the specified period is a criminal offence. On
                    conviction in the magistrates&apos; court or Crown Court, the offender faces an
                    unlimited fine and potentially imprisonment
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-lg p-4">
              ...
              <p className="text-white text-sm leading-relaxed">
                ...
                protection or scaffolding standards, poor housekeeping creating trip or fire
                hazards, lack of worker training records, and failure to properly manage
                asbestos-containing materials during refurbishment. The notice will specify exactly
                what is wrong and what must be done to comply, giving the duty holder a clear path
                to remediation.
              </p>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-red-500/40 pl-5 space-y-4">
            <p className="text-white text-sm leading-relaxed">
              ...
              risk of serious personal injury. The prohibition notice is a powerful instrument
              because it takes immediate effect and requires the dangerous activity to stop.
            </p>
            <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-4">
              <h4 className="font-semibold text-white text-sm mb-3 flex items-center gap-2">
              ...
              <ul className="space-y-2 text-sm text-white">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong className="text-white">When issued</strong> — the inspector believes
                    there is a risk of serious personal injury from the activity being carried on
                    (or about to be carried on). A contravention need not have already occurred —
                ...
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-red-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Immediate or deferred effect</strong> — most
                    prohibition notices take immediate effect, meaning the activity must stop at
                    once. However, an inspector may issue a deferred prohibition notice that takes
                    effect at a specified future time, allowing a brief period to make the area safe
                    before the full stoppage begins
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-red-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">The activity must cease</strong> — the prohibited
                    activity cannot resume until the matters specified in the notice have been
                    remedied. This can have significant consequences for a construction project: a
                    prohibition notice stopping scaffolding work can halt an entire building phase
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-red-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Appeal does NOT suspend the notice</strong> —
                    unlike an improvement notice, appealing a prohibition notice does NOT
                    automatically suspend it. The activity must remain stopped unless the Employment
                    Tribunal specifically orders that the notice be suspended. This reflects the
                ...
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-red-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">More serious than improvement notices</strong> —
                    prohibition notices indicate a higher level of risk and are a stronger indicator
                    of management failure. Receiving a prohibition notice is a significant event for
                    any construction company and should trigger an immediate management review
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-amber-500/10 border border-amber-500/30 rounded-lg p-4">
              ...
              <p className="text-white text-sm leading-relaxed">
                ...
                methods, lack of segregation between vehicles and pedestrians, live electrical work
                without adequate precautions, and structural instability where there is a risk of
                collapse. In each case, the inspector has concluded that someone could be seriously
                injured or killed if the activity continues.
              </p>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-red-500/40 pl-5 space-y-4">
            <p className="text-white text-sm leading-relaxed">
              ...
              flagrant disregard for the law, where there has been a failure to comply with an
              enforcement notice, or where the duty holder has a history of non-compliance. However,
              prosecution does not require an actual injury — the offence is the failure to comply
            ...
            <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-4">
              ...
              <ul className="space-y-2 text-sm text-white">
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-red-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Magistrates&apos; Court</strong> — for less
                    serious offences (summary offences).{' '}
                    <strong className="text-white">Unlimited fines</strong> (since the Legal Aid,
                    Sentencing and Punishment of Offenders Act 2012 removed the cap on
                    magistrates&apos; fines for health and safety offences) and up to{' '}
                    <strong className="text-white">6 months&apos; imprisonment</strong> for
                    individuals convicted of certain offences
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-red-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Crown Court</strong> — for more serious offences
                    tried on indictment. <strong className="text-white">Unlimited fines</strong> and
                    up to <strong className="text-white">2 years&apos; imprisonment</strong> for
                    individuals. The most serious construction cases are typically heard in the
                    Crown Court
                  </span>
                </li>
              </ul>
            ...
            <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
              ...
              <ul className="space-y-2 text-sm text-white">
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-blue-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Turnover-based fines</strong> — the 2016
                    Sentencing Council guidelines introduced a framework that uses the
                    organisation&apos;s annual turnover as the basis for calculating fines.
                    Organisations are classified as micro (&pound;2m or less), small (&pound;2m
                    {'\u2013'}&pound;10m), medium (&pound;10m{'\u2013'}&pound;50m), or large
                    (&pound;50m+)
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-blue-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Culpability</strong> — assessed on a four-point
                    scale: low, medium, high, and very high. Very high culpability indicates a
                    deliberate breach or flagrant disregard for the law
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-blue-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Harm categories (1{'\u2013'}4)</strong> — ranging
                    from Category 1 (death or physical injury equivalent to GBH) to Category 4 (low
                    risk of harm). The seriousness of actual or potential harm is a key driver of
                    the fine level
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-blue-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Aggravating and mitigating factors</strong> —
                    aggravating factors include previous convictions, cost- cutting motivation, and
                    failure to respond to advice. Mitigating factors include good safety record,
                    prompt remedial action, and cooperation with the investigation. These adjust the
                    fine from its starting point
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-4">
              ...
              <p className="text-white text-sm leading-relaxed">
                ...
                organised causes a person&apos;s death, and that management or organisation amounts
                to a gross breach of a relevant duty of care. A substantial element of the breach
                must be in the way activities were managed by senior management. Sanctions include:{' '}
                <strong className="text-white">unlimited fines</strong> (which in practice have
                reached tens of millions of pounds),{' '}
                <strong className="text-white">publicity orders</strong> (requiring the organisation
                to publicise its conviction and the details of the offence), and{' '}
                <strong className="text-white">remedial orders</strong> (requiring the organisation
                to take specific steps to address the management failures). The Act applies to
                organisations only — individuals cannot be convicted of corporate manslaughter, but
                they can still face prosecution under HASAWA 1974.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/40 pl-5 space-y-4">
            <p className="text-white text-sm leading-relaxed">
              ...
              for learning from incidents. Failure to report a RIDDOR event is itself a criminal
              offence.
            </p>
            <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
              <h4 className="font-semibold text-white text-sm mb-3 flex items-center gap-2">
              ...
              <ul className="space-y-2 text-sm text-white">
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-blue-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Fatal injuries</strong> — any death of a worker
                    or non-worker arising from a work-related accident. Must be reported immediately
                    by the quickest practicable means (telephone), followed by a written report
                    within 10 days
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-blue-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Specified injuries (Regulation 4)</strong> —
                    fractures (other than to fingers, thumbs, or toes), amputations, any injury
                    likely to lead to permanent loss of sight, crush injuries leading to internal
                    organ damage, scalping, any burn covering more than 10% of the body or causing
                    significant damage to the eyes, respiratory system, or internal organs, loss of
                    consciousness caused by head injury or asphyxia, and hypothermia, heat-induced
                    illness, or unconsciousness requiring resuscitation or hospital admission for
                    more than 24 hours
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-blue-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Over-7-day injuries</strong> — where a worker is
                    incapacitated for more than 7 consecutive days (not counting the day of the
                    incident) as a result of a workplace injury. Must be reported within 15 days of
                    the incident
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-blue-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Dangerous occurrences (Schedule 2)</strong> —
                    specific near-miss events listed in Schedule 2 of RIDDOR, including: collapse,
                    overturning, or failure of load-bearing parts of lifts and lifting equipment;
                    collapse of scaffolding over 5 metres in height; collapse or partial collapse of
                    a building or structure under construction; unintended collapse of a wall or
                    floor in a place of work; and an explosion or fire causing work stoppage for
                    more than 24 hours
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-blue-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Occupational diseases</strong> — certain diseases
                    linked to specific work activities must be reported when diagnosed by a doctor
                    and the worker&apos;s current job involves the associated exposure.
                    Construction- relevant examples include: carpal tunnel syndrome, hand-arm
                    vibration syndrome (HAVS), occupational dermatitis, and occupational asthma
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-amber-500/10 border border-amber-500/30 rounded-lg p-4">
              ...
              <p className="text-white text-sm leading-relaxed">
                ...
                and reported, even if the injured worker is employed by a subcontractor. For fatal
                and specified injuries to non- workers (such as members of the public), the person
                in control of the premises — typically the principal contractor — is responsible for
                reporting. Clear reporting procedures should be set out in the construction phase
                plan to avoid any incident going unreported.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/40 pl-5 space-y-4">
            <p className="text-white text-sm leading-relaxed">
              ...
              statements must be living documents that are monitored, reviewed, and updated as work
              progresses and circumstances change. Effective monitoring is a core element of the
              principal contractor&apos;s duty under Regulation 13.
            </p>
            <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
              <h4 className="font-semibold text-white text-sm mb-3 flex items-center gap-2">
              ...
              <ul className="space-y-2 text-sm text-white">
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-blue-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Safety inspections</strong> — regular planned
                    inspections of the workplace, equipment, and working practices. Frequency should
                    be proportionate to the risk — high-risk activities may require daily
                ...
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-blue-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Compliance audits</strong> — systematic reviews
                    of whether the arrangements set out in the construction phase plan, risk
                    assessments, and method statements are being followed in practice. Are workers
                    actually using the PPE specified? Are exclusion zones being maintained? Are
                    permits to work being properly managed?
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-blue-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Behavioural observations</strong> — observing how
                    workers actually carry out tasks, looking for unsafe behaviours, shortcuts, and
                    deviations from the agreed safe system of work. Behavioural safety programmes
                    use structured observation to identify and address at-risk behaviours before
                ...
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-blue-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Statutory inspections</strong> — certain
                    equipment and work arrangements require inspection at prescribed intervals:
                    scaffolding (every 7 days and after adverse weather), lifting equipment (per
                    LOLER 1998), and excavations (per CDM 2015 Regulation 22). Records must be kept
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-blue-400/10 border border-blue-400/30 rounded-lg p-4">
              ...
              <ul className="space-y-2 text-sm text-white">
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-blue-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Incident investigation</strong> — thorough
                    investigation of accidents, injuries, and ill health to identify root causes and
                    prevent recurrence. Investigation should go beyond the immediate cause to
                ...
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-blue-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Near-miss analysis</strong> — investigating near
                    misses is critical because they reveal hazards and control failures that could
                    cause serious harm in different circumstances. A culture that reports and
                    investigates near misses is far more effective at preventing serious incidents
                    than one that only investigates after someone is hurt
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-blue-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Enforcement response</strong> — if the HSE issues
                    an enforcement notice or provides advice following an inspection, the response
                    should include not only complying with the specific requirements but also
                    reviewing whether similar issues exist elsewhere on the site and updating the
                    construction phase plan accordingly
                  </span>
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/40 pl-5 space-y-4">
            <p className="text-white text-sm leading-relaxed">
              ...
              difference between an organisation that does the legal minimum and one where workers
              actively look out for each other, report hazards without hesitation, and take pride in
              a safe workplace. Research consistently shows that organisations with strong safety
              cultures have fewer incidents, lower costs, and better overall performance.
            </p>
            <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
              <h4 className="font-semibold text-white text-sm mb-3 flex items-center gap-2">
              ...
              <ul className="space-y-2 text-sm text-white">
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-blue-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Leadership commitment</strong> — senior
                    management must visibly demonstrate commitment to health and safety. This means
                    allocating adequate resources, attending site safety meetings, responding
                    promptly to safety concerns, and never pressuring workers to take shortcuts.
                    When leadership takes safety seriously, the rest of the organisation follows
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-blue-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Worker engagement</strong> — workers are the
                    people closest to the risks. Engaging them in risk assessment, planning safe
                    systems of work, and reviewing incidents gives them ownership of safety.
                    Effective worker consultation (required under CDM 2015 Regulation 14) means
                    genuinely listening to concerns and acting on them, not just holding meetings to
                ...
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-blue-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Continuous improvement</strong> — a compliance
                    culture does not stand still. Regular reviews of safety performance, lessons
                    learned from incidents and near misses, benchmarking against industry standards,
                    and adopting new and better working practices drive ongoing improvement. The
                    Plan-Do-Check-Act cycle (as promoted by HSG65 &ldquo;Managing for Health and
                    Safety&rdquo;) provides a framework for this
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-blue-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Sharing good practice</strong> — organisations
                    that share what works — and what does not — contribute to raising standards
                    across the industry. Sharing can be internal (between projects and teams) or
                    external (through industry bodies, conferences, and publications)
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-blue-400/10 border border-blue-400/30 rounded-lg p-4">
              ...
              <ul className="space-y-2 text-sm text-white">
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-blue-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Considerate Constructors Scheme (CCS)</strong> —
                    a voluntary scheme that promotes best practice beyond the legal minimum.
                    Registered sites are assessed against a code of considerate practice covering
                    community, safety, environment, workforce, and appearance. CCS membership is
                ...
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    ...
                    — provides training, qualifications, and standards that support CDM compliance,
                    including the CITB Health, Safety and Environment (HS&E) Test, the Site
                    Management Safety Training Scheme (SMSTS), and Site Supervisor Safety Training
                    Scheme (SSSTS)
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    ...
                    — the CSCS card scheme demonstrates that workers have the required training and
                    qualifications for their role. While CSCS cards are not a legal requirement
                    under CDM 2015, they are widely used as evidence of competence and are required
            ...
            <div className="bg-white/5 border border-white/10 rounded-lg p-4">
              ...
              <p className="text-white text-sm leading-relaxed">
                ...
                increasingly use safety performance as a pre-qualification criterion. Avoiding
                prosecution and enforcement notices protects the company&apos;s reputation and
                avoids the substantial legal and administrative costs associated with enforcement.
                Good safety performance also improves worker morale and retention — skilled workers
                choose to work for employers who look after them. In a competitive construction
                labour market, a strong safety culture is a genuine commercial advantage.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="bg-gradient-to-br from-white/5 to-white/[0.02] border border-white/10 rounded-xl p-5">
            ...
            <div className="flex items-center justify-between mt-4 px-2">
              <span className="text-blue-400 text-xs font-semibold">Least Severe</span>
              <div className="flex-1 mx-3 h-1 rounded-full bg-gradient-to-r from-blue-500 via-amber-500 to-red-600" />
              <span className="text-red-400 text-xs font-semibold">Most Severe</span>
            </div>
          </div>
        </section>
        ...
        {/*  Quiz                                                         */}
        {/* ------------------------------------------------------------ */}
        <Quiz title="Section 4 — Monitoring, Review & Enforcement" questions={quizQuestions} />
