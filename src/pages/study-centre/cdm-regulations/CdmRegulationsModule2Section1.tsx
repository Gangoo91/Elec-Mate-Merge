...
const faqs = [
  {
    question: 'Can the client delegate their CDM duties to a project manager or consultant?',
    answer:
...
const clientDutiesChecklist = [
  {
    ...
    regulation: 'Reg 4(1)',
    detail:
      'Manage the project with suitable arrangements proportionate to the risks, including allocating sufficient time and resources',
    icon: 'clipboard',
  },
  {
  ...
  },
  {
    ...
    regulation: 'Reg 4(4)',
    detail:
      'Provide all relevant health and safety information to designers and contractors as soon as practicable',
    icon: 'file',
  },
  {
    ...
    regulation: 'Reg 4(8)',
    detail:
      'Ensure welfare facilities (toilets, washing, rest, changing) are provided before construction begins',
    icon: 'building',
  },
  {
    ...
    regulation: 'Reg 5',
    detail:
      'Appoint a principal designer and principal contractor in writing before the construction phase begins',
    icon: 'users',
  },
  {
    ...
    regulation: 'Reg 8',
    detail:
      'Be satisfied that appointees have the skills, knowledge, experience, and organisational capability to carry out their roles',
    icon: 'shield',
  },
  {
    ...
    regulation: 'Reg 12(1)',
    detail:
      'Ensure the principal contractor draws up a construction phase plan before the construction phase begins',
    icon: 'plan',
  },
  {
    ...
    regulation: 'Reg 12(5)',
    detail:
      'Ensure the principal designer prepares, reviews, updates, and revises the health and safety file and that it is handed over at the end of the project',
    icon: 'folder',
  },
];
...
const clientComparison = [
  {
    aspect: 'Definition',
    commercial:
      'Any client that is not a domestic client — includes businesses, public bodies, developers, housing associations, charities',
    domestic:
      "A person for whom construction work is done on their own home (or a family member's home), not in connection with any business",
  },
  {
    aspect: 'CDM duties apply?',
    commercial: 'Yes — full client duties under Regulations 4, 5, 6, and 8 apply directly',
    domestic:
      'Yes — but duties transfer automatically to the contractor (single) or principal contractor (multiple), unless the client elects in writing to appoint a PD to take them on',
  },
  {
    aspect: 'Appointments required?',
    commercial:
      'Must appoint PD and PC in writing before construction phase begins (multi-contractor projects)',
    domestic:
      'No obligation to appoint PD or PC themselves — duties transfer automatically. May appoint PD in writing if they choose',
  },
  {
    aspect: 'Pre-construction information',
    commercial: 'Must proactively provide PCI to all designers and contractors',
    domestic:
      'Duty transfers to the contractor/PC, but the homeowner should provide what they know (surveys, asbestos information) when asked',
  },
  {
    aspect: 'Welfare facilities',
    commercial: 'Must ensure welfare facilities are in place before construction begins',
    domestic:
      'Duty transfers to the contractor/PC — they must arrange welfare (often existing household facilities or temporary provision)',
  },
  {
    aspect: 'HSE enforcement',
    commercial:
      'Directly enforceable against the commercial client — improvement notices, prohibition notices, prosecution',
    domestic:
      'Duties sit with the contractor/PC, so enforcement action would be directed at them, not the homeowner (unless the homeowner has elected to retain duties)',
  },
];
...
export default function CdmRegulationsModule2Section1() {
  useSEO({
    title: 'The Client | CDM Regulations Module 2 Section 1',
    description:
      ...
      <article className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
            ...
            <div className="rounded-lg p-3 sm:p-4 bg-blue-500/10 border-l-2 border-l-blue-500/50 border border-blue-500/30">
              ...
              <ul className="text-base text-white space-y-1.5">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    The <strong>client</strong> is defined as any person for whom a{' '}
                    <strong>construction project is carried out</strong>.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-blue-400 flex-shrink-0" />
                  <span>
                    This is a <strong>broad definition</strong> &mdash; it includes anyone who
                    commissions construction work, regardless of their construction knowledge or
                    experience.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-blue-400 flex-shrink-0" />
                  <span>
                    There is <strong>no minimum project size or value</strong> &mdash; even a small
                    refurbishment has a client.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-blue-400 flex-shrink-0" />
            ...
            <div className="rounded-lg p-3 sm:p-4 bg-blue-500/10 border-l-2 border-l-blue-500/50 border border-blue-500/30">
              ...
              <ul className="text-base text-white space-y-1.5">
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-blue-400 flex-shrink-0" />
                  <span>
                    <strong>Individual:</strong> A private homeowner commissioning an extension, a
                    landlord commissioning repairs, a sole trader fitting out premises
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-blue-400 flex-shrink-0" />
                  <span>
                    <strong>Company:</strong> A business commissioning office refurbishment, a
                    retail chain fitting out new stores, a factory owner building an extension
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-blue-400 flex-shrink-0" />
                  <span>
                    <strong>Public body:</strong> A local authority, NHS trust, government
                    department, school, or university commissioning building work
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-blue-400 flex-shrink-0" />
                  <span>
                    <strong>Developer:</strong> A property developer commissioning the construction
                    of new housing, commercial, or mixed-use developments
                  </span>
                </li>
              </ul>
            </div>
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p className="leading-relaxed">
                Regulation 4 sets out the core duties of the commercial client. These duties apply
                to every client that is not a domestic client &mdash; meaning any business, public
                body, developer, charity, housing association, or other organisation that
                commissions construction work. The client&rsquo;s duties are strategic and
                overarching: they set the conditions within which the entire project team operates.
              </p>
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <h3 className="text-blue-400 font-medium">
                    Regulation 4 &mdash; Core Client Duties
                  </h3>
                </div>
                <div className="space-y-4 text-sm">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <strong>Make suitable arrangements (Reg 4(1)):</strong> The client must make
                      suitable arrangements for managing the project, including the allocation of
                      sufficient time and other resources. &ldquo;Suitable arrangements&rdquo; means
                      arrangements that are proportionate to the risks and complexity of the project
                      &mdash; a major new-build hospital requires far more elaborate arrangements
                      than a small office refurbishment.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0" />
                    <div>
                      <strong>Maintain and review (Reg 4(2)):</strong> The arrangements must be
                      maintained and reviewed throughout the life of the project. A plan made at the
                      outset but never revisited is not compliant. As the project evolves &mdash;
                      scope changes, new risks emerge, contractors change &mdash; the arrangements
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0" />
                    <div>
                      <strong>Ensure welfare facilities (Reg 4(8)):</strong> The client must ensure
                      that welfare facilities are provided before any construction work begins. This
                      means toilets, washing facilities, rest areas, changing facilities, and
                      drinking water must be in place on or accessible from the site from the very
                      first day of construction. Schedule 2 of the regulations sets out the minimum
                      standards.
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-white/5 border border-blue-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm leading-relaxed">
                  ...
                  timescales that do not compress health and safety planning, providing a
                  proportionate budget for health and safety measures, establishing clear lines of
                  responsibility, and ensuring cooperation between all parties. A client who simply
                  appoints the cheapest contractor and leaves everything to them has{' '}
                  <strong className="text-white">not</strong> made suitable arrangements.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p className="leading-relaxed">
                Regulation 4(4) requires the client to provide pre-construction information (PCI) as
                soon as is practicable to every designer and contractor appointed, or being
                considered for appointment, to the project. The PCI is one of the most important
                documents in the CDM framework &mdash; it allows designers and contractors to
                understand the risks before they start work.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0" />
                    <div>
                      <strong>Existing health and safety information:</strong> Any information the
                      client holds about the existing site or structure that is relevant to health
                      and safety. This includes the structural condition of buildings, known
                      contamination, underground services, and any other hazards.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0" />
                    <div>
                      <strong>Surveys and reports:</strong> Structural surveys, geotechnical
                      surveys, contamination surveys, condition surveys, ecological surveys, and any
                      other investigations that have been carried out on the site or structure.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0" />
                    <div>
                      <strong>Asbestos register and management plan:</strong> Under the Control of
                      Asbestos Regulations 2012, the duty holder for non-domestic premises must
                      maintain an asbestos register and management plan. This information is
                      critical PCI &mdash; contractors must know where asbestos-containing materials
                      are located before they start work.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0" />
                    <div>
                      <strong>Previous health and safety file:</strong> If the building or structure
                      already has a health and safety file from previous CDM projects, this must be
                      made available. The file contains information about how the building was
                      constructed, what materials were used, and any residual risks for future
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0" />
                    <div>
                      <strong>Information about existing services:</strong> Details of electrical,
                      gas, water, drainage, telecommunications, and other services on and adjacent
                      to the site, including underground services drawings and records.
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm leading-relaxed">
                  ...
                  <strong className="text-white">could reasonably find out</strong>. This means the
                  client cannot simply claim ignorance. If a reasonable client in their position
                  would have commissioned a survey or obtained certain records, then the failure to
                  do so is itself a breach. For example, a client refurbishing a 1970s office block
                  cannot claim they did not know about asbestos &mdash; a reasonable client would
                  have commissioned an asbestos survey before any work began.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p className="leading-relaxed">
                One of the client&rsquo;s most important duties under the CDM Regulations is
                appointing the right people to manage design and construction. Regulation 5 requires
                the client to appoint a <strong>principal designer (PD)</strong> and a{' '}
                <strong>principal contractor (PC)</strong> for any project involving more than one
                contractor.
              </p>
                ...
                <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                  ...
                  <ul className="text-white space-y-2 text-sm">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-blue-400 flex-shrink-0" />
                      <span>
                        Must be a designer (an organisation or individual) with{' '}
                        <strong>control over the pre-construction phase</strong>
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-blue-400 flex-shrink-0" />
                      <span>
                        Coordinates health and safety matters during the{' '}
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-blue-400 flex-shrink-0" />
                      <span>
                        Must be appointed <strong>in writing</strong> before the construction phase
                        begins
                      </span>
                    </li>
                  </ul>
                ...
                <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                  ...
                  <ul className="text-white space-y-2 text-sm">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-blue-400 flex-shrink-0" />
                      <span>
                        Must be a contractor with{' '}
                        <strong>control over the construction phase</strong>
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-blue-400 flex-shrink-0" />
                      <span>
                        Plans, manages, monitors, and coordinates the{' '}
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <h3 className="text-blue-400 font-medium mb-3">
                  Ensuring Skills, Knowledge &amp; Experience
                </h3>
                <div className="space-y-3 text-sm">
                  <p className="leading-relaxed">
                    Regulation 8(1) requires the client (and anyone else making an appointment) to
                    take reasonable steps to satisfy themselves that the appointee has the
                    necessary:
                  </p>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0" />
                    <div>
                      <strong>Skills:</strong> The technical abilities needed to carry out the
                      specific role on the specific project &mdash; not just generic construction
                      skills.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0" />
                    <div>
                      <strong>Knowledge:</strong> Understanding of the relevant legislation,
                      standards, and industry guidance, as well as the specific risks and challenges
                      of the project.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0" />
                    <div>
                      <strong>Experience:</strong> A track record of successfully carrying out
                      similar roles on projects of comparable size, complexity, and risk.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0" />
                    <div>
                      <strong>Organisational capability:</strong> The resources, management systems,
                      and organisational structure to deliver the role effectively &mdash; not just
                      the right individuals, but the right infrastructure to support them.
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-blue-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm leading-relaxed">
                  ...
                  being appointed to, the scope of the appointment, and the date from which it takes
                  effect. In the event of an incident, the HSE will ask to see the written
                  appointment &mdash; if it does not exist, the client has breached Regulation 5.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p className="leading-relaxed">
                ...
                important but frequently overlooked aspects of CDM 2015. The HSE has consistently
                identified unrealistic timescales and inadequate budgets as root causes of
                construction health and safety failures.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h3 className="text-blue-400 font-medium">
                    Time &amp; Resources &mdash; What the Client Must Do
                  </h3>
                </div>
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      compressed to the point where designers cannot properly consider health and
                      safety risks. Rushing the design inevitably leads to incomplete risk
                      management, inadequate buildability reviews, and hazards being designed into
                      the project.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0" />
                    <div>
                      <strong>Allow adequate time for planning:</strong> The principal contractor
                      needs sufficient time to develop the construction phase plan, coordinate with
                      subcontractors, carry out site-specific risk assessments, and brief the
                      workforce before construction begins.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0" />
                    <div>
                      <strong>Not squeeze timelines:</strong> Imposing unrealistic deadlines or
                      accelerating the programme in a way that compromises health and safety
                      planning is a breach of Regulation 4(1). The client cannot demand that
                      contractors &ldquo;make it work&rdquo; within a timeframe that does not allow
                      for safe working.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0" />
                    <div>
                      <strong>Provide adequate budget:</strong> The client must allocate sufficient
                      financial resources for health and safety measures. This includes welfare
                      facilities, temporary works, protective equipment, traffic management, dust
                      suppression, noise control, and any other health and safety measures
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0" />
                    <div>
                      <strong>Recognise cost pressures:</strong> The HSE understands that
                      construction operates in a competitive market, but this does not excuse
                      cutting health and safety budgets. A client who selects the cheapest tender
                      knowing that it does not include adequate provision for health and safety has
                      not made suitable arrangements.
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm leading-relaxed">
                  ...
                  safety barriers, working excessive hours, and failing to follow method statements.
                  The client who created that pressure bears a significant share of the
                  responsibility. The HSE has prosecuted clients specifically for failing to allow
                  sufficient time for safe project delivery.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p className="leading-relaxed">
                Regulation 4(8) places a specific duty on the client to ensure that welfare
                facilities are provided before any construction work begins. This is a non-delegable
                duty &mdash; while the principal contractor will typically arrange the physical
                provision of welfare facilities, the <strong>client</strong> must ensure they are
                actually in place before work starts.
              </p>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm leading-relaxed">
                  ...
                  Workers must have access to toilets, washing, rest, and changing facilities from
                  the very first day of construction activity. It is not acceptable to start
                  demolition or groundworks and arrange welfare a few days later. The HSE has issued
                  prohibition notices where construction has started without welfare facilities in
                  place. On smaller projects, the client and contractor should agree before work
                  starts how welfare will be provided &mdash; whether through temporary cabins,
                  nearby premises, or existing facilities.
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-5 rounded-lg">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h3 className="text-blue-300 font-semibold">
                    CDM 2015 &mdash; Client Duties at a Glance
                  </h3>
                </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p className="leading-relaxed">
                A domestic client is a person for whom construction work is done on their own home
                (or the home of a family member), where the work is{' '}
                <strong>not done in connection with any business</strong>. The CDM Regulations 2015
                apply in full to domestic projects, but a special mechanism ensures that a competent
                construction professional always holds the client duties &mdash; rather than leaving
                them with a homeowner who may have no construction knowledge.
              </p>
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                ...
                <div className="space-y-4 text-sm">
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0" />
                    <div>
                      <strong>Single contractor:</strong> Where only one contractor is carrying out
                      the work, the client duties under Regulations 4(1)&ndash;(7) and Regulation 6
                      transfer automatically to that contractor. The contractor becomes responsible
                      for managing the project, providing pre-construction information, and ensuring
                      welfare.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0" />
                    <div>
                      <strong>Multiple contractors:</strong> Where more than one contractor is
                      involved, the client duties transfer automatically to the{' '}
                      <strong>principal contractor</strong>. The PC takes on the full burden of the
                      client&rsquo;s duties in addition to their own PC duties.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0" />
                    <div>
                      <strong>Optional written appointment:</strong> Alternatively, a domestic
                      client may appoint a{' '}
                      <strong>designer or principal designer in writing</strong> to take on their
                      client duties. This is entirely voluntary &mdash; the domestic client is not
                      required to do this, but it gives them the option of placing the duties with a
                      design professional they trust.
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0" />
                    <div>
                      If you are the <strong>sole contractor</strong> on a domestic project (e.g. a
                      full rewire of a house), the homeowner&rsquo;s client duties transfer to you
                      automatically. You become responsible for managing the project safely,
                      ensuring welfare, and providing relevant health and safety information.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0" />
                    <div>
                      If you are <strong>one of several contractors</strong> on a domestic project
                      (e.g. working alongside a builder and a plumber), the client duties transfer
                      to whoever has been appointed as principal contractor. If no one has been
                      formally appointed, the contractor in control of the construction phase is
                      likely to be treated as the de facto PC.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0" />
                    <div>
                      Even though the homeowner&rsquo;s duties transfer, you should still ask them
                      for any relevant information they hold &mdash; asbestos surveys, electrical
                      installation certificates, building plans, and information about any known
                      hazards.
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-white/5 border border-blue-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm leading-relaxed">
                  ...
                  connection with their business of letting property. This means the full commercial
                  client duties apply. The domestic client provisions only apply where the homeowner
                  commissions work on their own home (or a family member&rsquo;s home) and the work
                  is not connected to any business activity.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p className="leading-relaxed">
                The CDM Regulations 2015 made a deliberate shift towards greater client
                accountability. The HSE expects clients to be actively engaged in health and safety
                management, not passive bystanders who leave everything to the contractor. Clients
                who fail to fulfil their duties face serious consequences.
              </p>
              ...
              <div className="space-y-3">
                <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                  ...
                  <div className="space-y-2 text-sm text-white/80">
                    <div className="flex items-start gap-3">
                      ...
                      <span>
                        Clients must take an <strong className="text-white">active role</strong> in
                        ensuring health and safety &mdash; not simply sign documents and leave
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <span>
                        ...
                        <strong className="text-white">
                          &ldquo;What did the client do to satisfy themselves that the arrangements
                          were suitable?&rdquo;
                        </strong>
                      </span>
                    </div>
                    <div className="flex items-start gap-3">
                      <div className="w-2 h-2 rounded-full bg-amber-400 mt-2 flex-shrink-0" />
                      <span>
                        Ignorance is not a defence &mdash; clients are expected to{' '}
                        <strong className="text-white">understand their duties</strong> and seek
                        competent advice where needed
                      </span>
                    </div>
                    <div className="flex items-start gap-3">
                      <div className="w-2 h-2 rounded-full bg-amber-400 mt-2 flex-shrink-0" />
                      <span>
                        The HSE publishes sector-specific guidance on client duties and expects
                        clients to be familiar with it
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                  ...
                  <div className="space-y-3 text-sm text-white/80">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <span>
                        <strong className="text-white">Failure to appoint:</strong> Clients
                        prosecuted for failing to appoint a PD or PC before the construction phase
                        began, leaving no one in overall control of health and safety on
                    ...
                    <div className="flex items-start gap-3">
                      <div className="w-2 h-2 rounded-full bg-red-400 mt-2 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Failure to provide PCI:</strong> Clients
                        prosecuted for not providing information about asbestos, underground
                        services, or structural conditions, leading to workers being exposed to
                        serious risks they were unaware of.
                      </span>
                    </div>
                    <div className="flex items-start gap-3">
                      <div className="w-2 h-2 rounded-full bg-red-400 mt-2 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Unrealistic timescales:</strong> Clients
                        prosecuted where their insistence on compressed programmes directly
                        contributed to unsafe working practices and serious injuries.
                      </span>
                    </div>
                    <div className="flex items-start gap-3">
                      <div className="w-2 h-2 rounded-full bg-red-400 mt-2 flex-shrink-0" />
                      <span>
                        <strong className="text-white">No welfare facilities:</strong> Clients
                        prosecuted for allowing construction work to start without adequate welfare
                        provision &mdash; one of the most straightforward CDM breaches to identify
                        and enforce.
                      </span>
                    </div>
                  </div>
                ...
                <div className="bg-red-500/15 border border-red-500/40 p-4 rounded-lg">
                  ...
                  <p className="text-white/80 text-sm leading-relaxed mb-3">
                    ...
                    entity. However,{' '}
                    <strong className="text-white">
                      individual directors, partners, and officers
                    </strong>{' '}
                    can be personally prosecuted under Section 37 of the Health and Safety at Work
                    etc. Act 1974 where a breach is attributable to their consent, connivance, or
                    neglect.
                  </p>
                  <ul className="text-white space-y-2 text-sm">
                    <li className="flex items-start gap-3">
                      <div className="w-2 h-2 rounded-full bg-red-400 mt-2 flex-shrink-0" />
                      <div>
                        <strong>Unlimited fines</strong> for organisations under the Sentencing
                        Council guidelines, linked to turnover and culpability.
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
                      <div className="w-2 h-2 rounded-full bg-red-400 mt-2 flex-shrink-0" />
                      <div>
                        <strong>Up to 2 years&rsquo; imprisonment</strong> for individuals convicted
                    ...
                    <li className="flex items-start gap-3">
                      <div className="w-2 h-2 rounded-full bg-red-400 mt-2 flex-shrink-0" />
                      <div>
                        <strong>Corporate manslaughter</strong> charges under the Corporate
                        Manslaughter and Corporate Homicide Act 2007 where a gross management
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm leading-relaxed">
                  ...
                  welfare, and maintaining active oversight &mdash; the project is far more likely
                  to be delivered safely. If the client is disengaged, uninformed, or cost-cutting,
                  the risks cascade down through the supply chain.{' '}
                  <strong className="text-white">Every construction professional</strong>, including
                  electricians, should understand client duties so they can recognise when a client
                  is (or is not) fulfilling their obligations.
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                <ul className="text-white space-y-3 text-sm">
                  <li className="flex items-start gap-3">
                    ...
                    <span>
                      The <strong>client</strong> is any person for whom a construction project is
                      carried out &mdash; individuals, companies, public bodies, and developers all
                      qualify.
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-blue-500 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong>Regulation 4</strong> requires the client to make suitable
                      arrangements for managing the project, maintain and review them, and ensure
                      welfare facilities before construction begins.
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-blue-500 mt-0.5 flex-shrink-0" />
                    <span>
                      The client must provide <strong>pre-construction information</strong> (Reg
                      4(4)) including existing H&amp;S information, surveys, asbestos register, and
                      previous H&amp;S file.
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                  ...
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-blue-500 mt-0.5 flex-shrink-0" />
                    <span>
                      Clients must allow <strong>adequate time and resources</strong> &mdash;
                      compressing programmes or cutting budgets that compromise safety is a breach
                      of Regulation 4.
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-blue-500 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong>Welfare facilities</strong> (toilets, washing, rest, changing) must be
                      in place before construction work begins (Reg 4(8), Schedule 2).
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-blue-500 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong>Domestic client</strong> duties transfer automatically to the
                      contractor (single) or PC (multiple), or the client can appoint a PD in
                      writing to take them on.
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-blue-500 mt-0.5 flex-shrink-0" />
                    <span>
                      ...
                      unlimited fines, director personal liability, and prosecution for
                      non-compliance.
                    </span>
                  </li>
                </ul>
        ...
        {/* ─── Quiz ─── */}
        <div className="mt-12">
          <Quiz title="The Client — CDM Regulations Quiz" questions={quizQuestions} />
        </div>
