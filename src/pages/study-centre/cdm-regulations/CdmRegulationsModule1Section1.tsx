...
const quickCheckQuestions = [
  ...
  {
    id: 'cdm-duty-holders',
    question: 'How many key duty holder roles are defined under the CDM Regulations 2015?',
...
const faqs = [
  ...
  {
    question: 'What is the difference between CDM 2015 and the previous CDM 2007 Regulations?',
    answer:
  ...
  {
    question: 'Is there a minimum project size or value below which CDM does not apply?',
    answer:
...
const quizQuestions = [
  ...
  {
    id: 4,
    question: "Under CDM 2015, which of the following activities counts as 'construction work'?",
    options: [
...
export default function CdmRegulationsModule1Section1() {
  useSEO({
    title: 'What Are the CDM Regulations? | CDM Regulations Awareness Module 1.1',
    description:
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <header className="text-center mb-12">
          ...
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-500/10 border border-blue-500/20 mb-3 mx-auto">
            <span className="text-blue-400 text-xs font-semibold">MODULE 1 &middot; SECTION 1</span>
          </div>
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-blue-500/5 border-l-2 border-blue-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>What:</strong> Construction (Design and Management) Regulations 2015
              </li>
              <li>
              ...
              <li>
                <strong>Applies to:</strong> All construction work in Great Britain
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-blue-500/5 border-l-2 border-blue-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Key idea:</strong> Manage risks from design through to completion
              </li>
              <li>
                <strong>Five duty holders:</strong> Client, PD, PC, designers, contractors
              </li>
              <li>
                <strong>No threshold:</strong> Applies to all projects regardless of size
              </li>
              <li>
                <strong>Deaths:</strong> ~30&ndash;40 construction fatalities per year
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The <strong>Construction (Design and Management) Regulations 2015</strong>, commonly
                referred to as <strong>CDM 2015</strong>, are the primary set of regulations
                governing health and safety management on construction projects in Great Britain.
                They were enacted as <strong>Statutory Instrument 2015 No. 51 (SI 2015/51)</strong>{' '}
                and came into force on <strong>6 April 2015</strong>, replacing the earlier
                Construction (Design and Management) Regulations 2007.
              </p>

              <p>
                CDM 2015 is made under the powers of the{' '}
                <strong>Health and Safety at Work etc. Act 1974</strong> (HASAWA), which is the
                overarching piece of legislation that provides the legal framework for workplace
                health and safety in Great Britain. Section 15 of HASAWA gives the Secretary of
                State the power to make regulations, and CDM 2015 is one of the most important sets
                of regulations made under this power. It is enforced by the{' '}
                <strong>Health and Safety Executive (HSE)</strong>.
              </p>

              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-blue-400">Legal Reference:</strong> The full title is
                  &ldquo;The Construction (Design and Management) Regulations 2015&rdquo;, Statutory
                  Instrument 2015 No. 51. The regulations are arranged in five parts: Part 1
                  (Commencement, interpretation, and application), Part 2 (Client duties), Part 3
                  (Health and safety duties and roles), Part 4 (General requirements for all
                  construction sites), and Part 5 (General). A supporting document,{' '}
                  <strong>L153 &ldquo;Managing health and safety in construction&rdquo;</strong>,
                  provides guidance on how to comply with the regulations.
                </p>
              </div>

              <p>
                CDM 2015 replaced the CDM 2007 Regulations following an extensive review led by
                Professor Ragnar L&ouml;fstedt in 2011. The L&ouml;fstedt Review recommended that
                CDM be simplified, that the role of CDM co-ordinator be abolished, and that the
                regulations be extended to cover domestic projects. These recommendations were
                largely adopted, resulting in a streamlined framework that placed greater emphasis
                on <strong>duty holder cooperation</strong>,{' '}
                <strong>design-stage risk management</strong>, and{' '}
                <strong>proportionate application</strong> across all project types and sizes.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  of regulations. This simplification was a deliberate effort to reduce regulatory
                  burden whilst maintaining or improving standards of protection.
                </p>
              </div>

              <p>
                The regulations apply to the{' '}
                <strong>entire lifecycle of a construction project</strong>: from initial concept
                and design, through procurement and construction, to handover and use. This
                lifecycle approach is fundamental to CDM &mdash; it recognises that many of the most
                effective ways to reduce health and safety risks involve making good decisions
                early, particularly at the design stage, rather than trying to manage hazards once
          ...
          <div className="border-l-2 border-blue-400/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                <strong>improve health and safety in the construction industry</strong> by ensuring
                that health and safety risks are properly considered and managed at every stage of a
                construction project. Construction is one of the most dangerous industries in Great
                Britain, and CDM exists because the evidence shows that many deaths, injuries, and
                cases of ill health can be prevented through better planning, design, and
                management.
              </p>
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      &mdash; make health and safety a core consideration in every project
                      management decision, not a bolt-on afterthought
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-blue-400" />
                    <span>
                      ...
                      &mdash; address hazards at the earliest possible stage, particularly through
                      design decisions that eliminate or reduce risks before construction begins
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-blue-400" />
                    <span>
                      ...
                      &mdash; ensure that everyone involved in a project understands their legal
                      duties and is held accountable for discharging them
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-blue-400" />
                    <span>
                      <strong className="text-white">Promote cooperation and coordination</strong>{' '}
                      &mdash; require all duty holders to work together, share information, and
                      coordinate their activities to manage risk effectively
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-blue-400" />
                    <span>
                      ...
                      &mdash; require that people carrying out construction work have the right
                      skills, knowledge, experience, and training, and that workers are consulted on
                  ...
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-blue-400" />
                    <span>
                      <strong className="text-white">Apply proportionately to all projects</strong>{' '}
                      &mdash; the level of planning and documentation required should be
                      proportionate to the scale and complexity of the project, avoiding unnecessary
                      bureaucracy on smaller works
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <p>
                A central theme of CDM 2015 is that <strong>prevention is better than cure</strong>.
                The regulations place a strong emphasis on{' '}
                <strong>eliminating hazards at the design stage</strong> wherever possible. This is
                because it is far more effective and far less expensive to design out a hazard
                before construction begins than to manage it on site through protective measures,
                safe systems of work, or personal protective equipment. For example, a designer who
                specifies ground-level maintenance access for building services has eliminated the
                need for work at height &mdash; one of the leading causes of fatal injury in
                construction.
              </p>

              <p>
                CDM 2015 also recognises that construction health and safety is not just about
                preventing traumatic injuries from falls, collapses, and struck-by incidents. It
                extends to <strong>occupational health</strong> &mdash; protecting workers from
                long-term health conditions caused by exposure to dust, noise, vibration, hazardous
                substances, manual handling, and other health hazards. Occupational ill health in
                construction kills far more people each year than workplace accidents.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  linked to past exposures &mdash; far exceeding the 30&ndash;40 who die from
                  traumatic workplace injuries. CDM 2015 addresses both categories of harm.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                CDM 2015 applies to{' '}
                <strong>all construction projects carried out in Great Britain</strong> &mdash; that
                is, England, Scotland, and Wales. It does <strong>not</strong> apply in Northern
                Ireland, which has its own separate legislation: the Construction (Design and
                Management) Regulations (Northern Ireland) 2016, commonly known as CDM (NI) 2016.
                The Northern Irish regulations largely mirror CDM 2015 but are enforced by the
                Health and Safety Executive for Northern Ireland (HSENI).
              </p>

              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                <p className="text-sm font-medium text-blue-400 mb-3">Scope of Application</p>
              ...
              <p>
                One of the most significant changes introduced by CDM 2015 was the{' '}
                <strong>extension of coverage to domestic projects</strong>. Under the previous CDM
                2007 Regulations, domestic work was largely excluded. CDM 2015 brought all domestic
                construction work within scope, recognising that the hazards on a domestic building
                site are no less dangerous than those on a commercial site. A fall from a scaffold
                on a house extension is just as likely to be fatal as a fall on a commercial
                development.
              </p>

              <p>
                However, the regulations recognise that domestic clients (homeowners) cannot
                reasonably be expected to manage CDM duties in the same way as a commercial client.
                Therefore, on domestic projects, the duties of the client are{' '}
              ...
              <ul className="text-white/80 space-y-2">
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-blue-400" />
                  <span>
                    On projects with a <strong className="text-white">single contractor</strong>,
                    the client duties transfer to that contractor
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-blue-400" />
                  <span>
                    On projects with{' '}
                    <strong className="text-white">more than one contractor</strong>, the client
                    duties transfer to the principal contractor (for managing the construction
                    phase) and the principal designer (for managing the pre-construction phase)
                  </span>
                </li>
              </ul>

              <p>
                This means that if you are a contractor carrying out a domestic rewire, extension,
                or bathroom fit, you may be taking on the client duties under CDM 2015 in addition
                to your own contractor duties. Understanding this is essential for every
                tradesperson working on domestic projects.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  if it will last{' '}
                  <strong>
                    longer than 30 working days and have more than 20 workers working simultaneously
                    at any point
                  </strong>
                  , or if it will <strong>exceed 500 person-days</strong> of construction work. The
                  notification must be made by the client (or the principal designer on their
                  behalf) as soon as practicable before the construction phase begins.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-400/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The definition of <strong>&ldquo;construction work&rdquo;</strong> is set out in{' '}
                <strong>Regulation 2</strong> of CDM 2015. It is deliberately broad and covers a
                wide range of activities. If your work falls within this definition, CDM applies.
              </p>
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      The{' '}
                      <strong className="text-white">
                        construction, alteration, conversion, fitting out, commissioning,
                      ...
                      pressure, or the use of corrosive or toxic substances) of any building or
                      structure
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-blue-400" />
                    <span>
                      The <strong className="text-white">demolition or dismantling</strong> of any
                      building or structure, including any part thereof
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-blue-400" />
                    <span>
                      The{' '}
                      <strong className="text-white">preparation for an intended structure</strong>,
                      including site clearance, exploration, investigation (but not site survey),
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      to form, or which form part of, a structure
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-blue-400" />
                    <span>
                      The{' '}
                      <strong className="text-white">
                        removal of any structure or part of a structure, or any product or waste
              ...
              <p>
                The definition also includes <strong>temporary works</strong> that are essential to
                the construction process: scaffolding, formwork, falsework, shoring, temporary
                support structures, and site hoarding. These are all construction work in their own
                right.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-blue-400" />
                    <span>
                      <strong className="text-white">Installing a new consumer unit</strong> &mdash;
                      construction work (installation of electrical services fixed within a
                      structure)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-blue-400" />
                    <span>
                      <strong className="text-white">Rewiring a house</strong> &mdash; construction
                      work (maintenance and repair of electrical services)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-blue-400" />
                    <span>
                      <strong className="text-white">Chasing walls for cables</strong> &mdash;
                      construction work (alteration of a structure)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-blue-400" />
                    <span>
                      <strong className="text-white">Installing temporary site lighting</strong>{' '}
                      &mdash; construction work (temporary works normally fixed within a structure)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-blue-400" />
                    <span>
                      <strong className="text-white">Periodic inspection and testing (EICR)</strong>{' '}
                      &mdash; generally <em>not</em> construction work if no physical work to the
                      installation is carried out; however, if remedial work is undertaken as a
                      result, that remedial work is construction work
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <p>
                The Regulation 2 definition of &ldquo;structure&rdquo; is also broad. It includes
                any building, timber, masonry, metal, or reinforced concrete structure; any railway
                line or siding, tramway line, dock, harbour, inland navigation, tunnel, shaft,
                bridge, viaduct, waterworks, reservoir, pipe or pipeline, cable, aqueduct, sewer,
                sewage works, or gasholder. It also includes any fixed plant that requires
                installation or dismantling before or after use, and any formwork, falsework,
                scaffold, or other temporary structure designed to support a permanent structure
                during construction.
              </p>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                CDM 2015 is built on a set of fundamental principles that underpin every duty and
                requirement in the regulations. Understanding these principles is essential for
                applying CDM correctly and proportionately in practice.
              </p>

              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                <p className="text-sm font-medium text-blue-400 mb-3">The Five Key Principles</p>
                <div className="space-y-4">
                  <div className="bg-white/5 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 ml-5">
                      ...
                      protect construction workers because it addresses hazards before anyone sets
                      foot on site.
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 ml-5">
                      ...
                      designer and principal contractor have specific duties to facilitate this
                      cooperation.
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 ml-5">
                      ...
                      competence, and organisations must ensure their workers are properly trained
                      and supervised.
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-lg p-3">
                  ...
                  <div className="bg-white/5 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 ml-5">
                      ...
                      is about managing real risks, not generating bureaucracy.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <p>
                These principles work together. A designer who eliminates a work at height risk
                through their design (Principle 1) reduces the need for complex safety systems on
                site. A principal contractor who consults workers about sequencing risks (Principle
                4) is better placed to coordinate activities safely (Principle 2). A client who
                appoints competent duty holders (Principle 3) sets the foundation for effective risk
                management throughout the project.
              </p>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-blue-400">The General Principles of Prevention:</strong>{' '}
                  CDM 2015 (via Schedule 1 of the Management of Health and Safety at Work
                  Regulations 1999) requires that risks are managed in accordance with the general
                  principles of prevention. These are, in order of priority: (a) avoid risks, (b)
                  evaluate risks that cannot be avoided, (c) combat risks at source, (d) adapt the
                  work to the individual, (e) adapt to technical progress, (f) replace the dangerous
                  with the non-dangerous or less dangerous, (g) develop a coherent overall
                  prevention policy, (h) give collective protective measures priority over
                  individual measures, and (i) give appropriate instructions to employees.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-400/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                CDM 2015 defines <strong>five key duty holder roles</strong>. Each role carries
                specific legal responsibilities. The detailed duties of each role will be explored
                in depth in Module 2, but this section provides an overview of who the duty holders
                are and their primary functions.
              </p>
              ...
              <div className="space-y-3">
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-white/80">
                    ...
                    responsibility for making suitable arrangements for managing a project,
                    including allocating sufficient time and resources. The client must appoint the
                    principal designer and principal contractor on projects involving more than one
                    contractor.
                  </p>
                </div>
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-white/80">
                    ...
                    between designers, and prepare the health and safety file. This role replaced
                    the CDM co-ordinator from the 2007 Regulations.
                  </p>
                </div>
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-white/80">
                    ...
                    cooperation between contractors, ensure suitable site inductions are provided,
                    and take reasonable steps to prevent unauthorised access to the site.
                  </p>
                </div>
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-white/80">
                    ...
                    design decisions (such as an electrician designing a circuit layout). Designers
                    must eliminate foreseeable risks where possible, reduce risks that cannot be
                    eliminated, and provide information about remaining risks.
                  </p>
                </div>
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-white/80">
                    ...
                    carried out safely. They must provide workers with appropriate information,
                    instruction, training, and supervision. On single-contractor domestic projects,
                    the contractor also takes on the client duties.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-blue-400">Important:</strong> A single person or
                  organisation can hold more than one duty holder role. For example, a
                  design-and-build contractor could be both the principal designer and the principal
                  contractor. The duties of each role still apply in full regardless of whether they
                  are held by the same or different parties.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                CDM 2015 does not exist in isolation. It is one part of a comprehensive framework of
                health and safety legislation that applies to construction work in Great Britain.
                Understanding how CDM sits alongside other regulations is essential for compliance.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 sm:p-6 rounded-lg">
                ...
                <div className="flex justify-center mb-3">
                  <div className="bg-blue-500/25 border-2 border-blue-500/50 rounded-lg p-3 w-full max-w-md text-center">
                    <p className="text-xs font-bold text-blue-300">OVERARCHING ACT</p>
                ...
                <div className="flex justify-center mb-3">
                  <div className="bg-blue-400/20 border-2 border-blue-400/50 rounded-lg p-3 w-full max-w-sm text-center">
                    <p className="text-xs font-bold text-blue-300">CONSTRUCTION-SPECIFIC</p>
                    <p className="text-sm font-bold text-white">CDM 2015 (SI 2015/51)</p>
                  </div>
                </div>
                <div className="flex justify-center mb-3">
              ...
              <div className="space-y-3">
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-white/80">
                    ...
                    duties of the self-employed. CDM 2015 is a set of regulations made under HASAWA.
                    A breach of CDM is also potentially a breach of HASAWA.
                  </p>
                </div>
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  <p className="text-sm font-medium text-white mb-1">
                  ...
                  <p className="text-sm text-white/80">
                    ...
                    cooperate with other employers sharing a workplace. CDM 2015 builds on these
                    general duties by adding construction-specific requirements.
                  </p>
                </div>
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  <p className="text-sm font-medium text-white mb-1">
                  ...
                  <p className="text-sm text-white/80">
                    ...
                    fatalities each year. WAHR requires that work at height is properly planned,
                    supervised, and carried out by competent persons, with appropriate equipment
                    selected using a hierarchy of controls.
                  </p>
                </div>
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  <p className="text-sm font-medium text-white mb-1">
                  ...
                  <p className="text-sm text-white/80">
                    ...
                    competent persons, and that lifting equipment is regularly examined and
                    inspected.
                  </p>
                </div>
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-white/80">
                    ...
                    instruction, and training. On construction sites, this covers everything from
                    power tools and cutting equipment to plant and machinery.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-blue-400">Key Point:</strong> These regulations do not
                  replace each other &mdash; they all apply <strong>concurrently</strong>. A
                  construction project must comply with CDM 2015 <em>and</em> HASAWA 1974{' '}
                  <em>and</em> the Management Regulations 1999 <em>and</em> WAHR 2005 <em>and</em>{' '}
                  LOLER 1998 <em>and</em> PUWER 1998, along with any other regulations that apply to
                  the specific activities being carried out. CDM does not provide an exemption from
                  any other health and safety legislation.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-400/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The construction industry remains one of the most dangerous sectors in Great
                Britain. Despite significant improvements over the past few decades, the statistics
                paint a stark picture of the ongoing risks faced by construction workers every day.
              </p>
              ...
              <p>
                ...
                <strong>25&ndash;30% of all workplace fatal injuries</strong> in Great Britain,
                despite employing only around 5% of the workforce. This disproportionate share
                demonstrates why the sector requires its own dedicated health and safety regulations
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-blue-400" />
                    <span>
                      <strong className="text-white">Falls from height</strong> &mdash; consistently
                      the number one killer, accounting for approximately 40&ndash;50% of all
                      construction fatalities. Falls from ladders, scaffolds, roofs, and through
                      fragile surfaces are the most common scenarios.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-blue-400" />
                    <span>
                      <strong className="text-white">Struck by a moving vehicle or object</strong>{' '}
                      &mdash; including being hit by plant, vehicles, falling materials, and
                      collapsing structures. This accounts for approximately 15&ndash;20% of
                      fatalities.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      &mdash; including trench collapses, structural collapses, and overturning
                      plant. Approximately 10&ndash;15% of fatalities.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-blue-400" />
                    <span>
                      <strong className="text-white">Contact with electricity</strong> &mdash;
                      contact with overhead power lines, underground cables, and live electrical
                      systems remains a significant cause of both fatal and non-fatal injuries.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <p>
                Beyond traumatic injuries, the construction industry also has a significant{' '}
                <strong>occupational health burden</strong>. The HSE estimates that around{' '}
                <strong>82,000 construction workers</strong> are suffering from work-related ill
              ...
              <ul className="text-white/80 space-y-2">
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-blue-400" />
                  <span>
                    <strong className="text-white">Musculoskeletal disorders</strong> &mdash; back
                    pain, joint problems, and repetitive strain injuries from manual handling and
                ...
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-blue-400" />
                  <span>
                    <strong className="text-white">Respiratory diseases</strong> &mdash; silicosis,
                    asbestosis, occupational asthma, and chronic obstructive pulmonary disease
                    (COPD) caused by exposure to dusts and fumes
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-blue-400" />
                  <span>
                    <strong className="text-white">Noise-induced hearing loss</strong> &mdash;
                    irreversible hearing damage from prolonged exposure to high noise levels from
                    power tools, plant, and machinery
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-blue-400" />
                  <span>
                    ...
                    &mdash; nerve and blood vessel damage in the hands and arms from prolonged use
                    of vibrating tools
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-blue-400" />
                  <span>
                    <strong className="text-white">Occupational cancers</strong> &mdash; lung
                    cancer, mesothelioma, and other cancers linked to asbestos, silica dust, diesel
                    exhaust, and other carcinogenic substances
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-blue-400" />
                  <span>
                    <strong className="text-white">Stress, depression, and anxiety</strong> &mdash;
                    mental health conditions linked to workplace pressures, long hours, job
                    insecurity, and time away from home
                  </span>
                </li>
              </ul>
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-blue-400" />
                    <span>
                      <strong className="text-white">Improvement notices</strong> &mdash; requiring
                      a duty holder to remedy a contravention within a specified period
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-blue-400" />
                    <span>
                      <strong className="text-white">Prohibition notices</strong> &mdash; requiring
                      work to stop immediately where there is a risk of serious personal injury
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-blue-400" />
                    <span>
                      <strong className="text-white">Criminal prosecution</strong> &mdash; for
                      serious breaches, the HSE can prosecute duty holders in the criminal courts.
                      Penalties can include unlimited fines and, in the most serious cases,
                      imprisonment
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-blue-400" />
                    <span>
                      <strong className="text-white">Fee for intervention (FFI)</strong> &mdash;
                      where the HSE identifies a material breach, the duty holder must pay
                      &pound;163 per hour (2024/25 rate) for the time the HSE spends investigating
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-3">The Economic Cost</p>
                <div className="grid sm:grid-cols-2 gap-3 text-sm">
                  <div className="bg-white/5 rounded-lg p-3">
              ...
              <p>
                These statistics make a compelling case for why the CDM Regulations exist and why
                compliance matters. Every duty holder &mdash; from the client who commissions a
                project, to the designer who shapes it, to the contractor who builds it &mdash; has
                a role to play in reducing these numbers. CDM 2015 provides the legal framework to
                ensure that health and safety is not an afterthought but an integral part of every
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  identified, assessed, and managed at every stage of every project. Compliance is
                  not just a legal obligation &mdash; it is a moral one.
                </p>
              </div>
            </div>
          </div>
