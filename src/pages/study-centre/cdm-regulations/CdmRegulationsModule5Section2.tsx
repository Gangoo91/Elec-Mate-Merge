...
const faqs = [
  {
    question: 'Can a worker who does not hold a CSCS card still work on a construction site?',
    answer:
  ...
  {
    question: 'What should a site induction cover, and how long should it last?',
    answer:
...
const quizQuestions = [
  ...
  {
    id: 4,
    question: 'Under CDM 2015, when is enhanced supervision of workers required?',
    options: [
...
export default function CdmRegulationsModule5Section2() {
  useSEO({
    title: 'Site Inductions & Competence | CDM Regulations Module 5.2',
    description:
      ...
      <article className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4 sm:p-5">
            ...
            <ul className="space-y-2 text-white text-sm">
              <li className="flex items-start gap-2">
                ...
                <span>
                  Explain the legal basis for competence under CDM 2015 Regulation 15 and the shift
                  from &ldquo;competence&rdquo; to SKTE
                </span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="h-4 w-4 text-blue-400 mt-0.5 flex-shrink-0" />
                <span>
                  Describe the content and purpose of an effective site-specific induction
                </span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="h-4 w-4 text-blue-400 mt-0.5 flex-shrink-0" />
                <span>
                  Understand the CSCS card scheme, its role in supporting CDM compliance, and
              ...
              <li className="flex items-start gap-2">
                <CheckCircle className="h-4 w-4 text-blue-400 mt-0.5 flex-shrink-0" />
                <span>
                  Distinguish between statutory training requirements and industry best-practice
                  standards
                </span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="h-4 w-4 text-blue-400 mt-0.5 flex-shrink-0" />
                <span>
                  Identify when enhanced supervision is required and the role of SSSTS and SMSTS
                </span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="h-4 w-4 text-blue-400 mt-0.5 flex-shrink-0" />
                <span>
                  Explain how to assess the competence of both individuals and organisations
                </span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="h-4 w-4 text-blue-400 mt-0.5 flex-shrink-0" />
                <span>
                  Recognise common competence failures and their consequences in enforcement and
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6 text-white">
              ...
              <ul className="text-base text-white space-y-1.5">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    ...
                    relation to a project unless they possess the necessary{' '}
                    <strong>skills, knowledge, training, and experience</strong> (SKTE) to carry out
                    that work in a manner that secures the health and safety of any person working
                    on or affected by the project.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-blue-400 flex-shrink-0" />
                  <span>
                    Alternatively, a person may carry out work if they are{' '}
                    <strong>under the supervision</strong> of a person who has the necessary SKTE.
                    This provision allows apprentices, trainees, and less experienced workers to
                    work on site provided they are appropriately supervised.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-blue-400 flex-shrink-0" />
                  <span>
                    ...
                    appointee has the necessary SKTE. This duty applies at every level of the supply
                    chain &mdash; clients, principal contractors, contractors, and anyone else who
                    appoints others to carry out construction work.
                  </span>
                </li>
              </ul>
            </div>
            <div className="rounded-lg p-3 sm:p-4 bg-blue-500/10 border-l-2 border-l-blue-500/50 border border-blue-500/30">
              <p className="font-semibold text-base text-blue-400 mb-2">
                The Shift from Competence to SKTE
              </p>
              <ul className="text-base text-white space-y-1.5">
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-blue-400 flex-shrink-0" />
                  <span>
                    ...
                    word &ldquo;competence&rdquo;. This led to an industry where competence
                    assessment became excessively bureaucratic, paper-driven, and focused on
                    collecting accreditations rather than assessing actual ability.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-blue-400 flex-shrink-0" />
                  <span>
                    ...
                    competence assessment process. CDM 2015 responded by replacing the single
                    concept of &ldquo;competence&rdquo; with the four elements of SKTE, and by
                    abolishing the Approved Code of Practice on competence assessment (previously
                    Appendix 4 of L144).
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    ...
                    employers in meeting their health and safety duties. When read alongside CDM
                    2015 Regulation 15, this creates a comprehensive framework for ensuring that
                    everyone involved in a construction project has the capability to carry out
                    their role safely.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-blue-400 flex-shrink-0" />
                  <span>
                    The HSE&rsquo;s guidance document <strong>L153</strong> (Managing Health and
                    Safety in Construction) emphasises that competence assessment should be{' '}
                    <strong>proportionate</strong> to the risks involved &mdash; a simple check for
                    low-risk work, a more thorough assessment for high-risk or complex activities.
                  </span>
                </li>
              </ul>
            </div>
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                ...
                sufficient &mdash; the induction must be tailored to the specific project and site
                conditions.
              </p>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <h3 className="text-blue-400 font-medium mb-3">
                  Content of an Effective Induction
                </h3>
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0" />
                    <div>
                      <strong>Project overview:</strong> A brief description of the project, the
                      client, the principal contractor, and the current phase of work. This gives
                      workers context for the activities taking place around them and helps them
                      understand how their work fits into the wider project.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0" />
                    <div>
                      <strong>Site layout and access:</strong> How to enter and leave the site
                      safely, pedestrian routes, vehicle routes, restricted areas, laydown areas,
                      and the location of the site office. Workers should be shown the site layout
                      plan and, where practicable, given a physical tour of the key areas.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0" />
                    <div>
                      <strong>Emergency procedures:</strong> The fire evacuation plan, the location
                      of fire assembly points, the alarm signal (siren, horn, or other), the
                      location of fire extinguishers and first aid stations, and the names and
                      locations of first aiders and fire wardens. Workers must know what to do in an
                      emergency from the moment they step onto the site.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0" />
                    <div>
                      <strong>Welfare facilities:</strong> The location of toilets, washing
                      facilities, rest areas, drinking water, changing rooms, and drying rooms.
                      Schedule 2 of CDM 2015 sets out the minimum welfare requirements that must be
                      in place.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0" />
                    <div>
                      <strong>Site rules and PPE:</strong> The site&rsquo;s mandatory PPE
                      requirements (hard hat, hi-vis, safety boots, eye protection, gloves),
                      prohibited activities (smoking areas, mobile phone use, drug and alcohol
                      policy), speed limits, and any other site-specific rules that all workers must
                      follow.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0" />
                    <div>
                      <strong>Specific hazards:</strong> Any hazards specific to the site that
                      workers need to be aware of, such as asbestos-containing materials, overhead
                      power lines, underground services, contaminated ground, adjacent occupied
                      buildings, nearby railways, or any other hazard identified in the
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0" />
                    <div>
                      <strong>Reporting procedures:</strong> How to report accidents, incidents,
                      near misses, unsafe conditions, and concerns. Workers must understand the
                      reporting process and feel confident that reports will be taken seriously. The
                      induction should emphasise that reporting near misses and concerns is
                      encouraged and will not result in negative consequences.
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <h3 className="text-blue-400 font-medium mb-3">
                  Who Must Be Inducted &amp; Recording
                </h3>
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0" />
                    <div>
                      <strong>Who must be inducted:</strong> Every person who enters the
                      construction site must receive an appropriate induction. This includes all
                      workers, supervisors, managers, visitors, delivery drivers entering the site
                      compound, and client representatives. The depth and detail of the induction
                      may vary depending on the person&rsquo;s role &mdash; a brief visitor
                      induction covering emergency procedures, escort requirements, and PPE may be
                      sufficient for a short-term visitor, but a full induction is required for
                      anyone who will be carrying out work on the project.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0" />
                    <div>
                      ...
                      tour, and question-and-answer session. The key requirement is that the
                      inductee understands the information provided &mdash; simply signing an
                      attendance sheet is not sufficient.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0" />
                    <div>
                      <strong>Recording:</strong> The principal contractor must keep a record of
                      every induction, including the inductee&rsquo;s name, employer, CSCS card
                      number, date of induction, the name of the person who delivered the induction,
                      and confirmation that the inductee understood the content. These records are
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  induction is understood. This may include providing induction materials in
                  multiple languages, using interpreters, employing bilingual supervisors, or using
                  visual/pictorial safety briefings. Simply delivering an induction in English to a
                  worker who does not understand English does not constitute an effective induction
                  and would not satisfy CDM 2015 requirements.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                ...
                industry. While not a legal requirement, CSCS has become the de facto standard for
                demonstrating competence on construction sites.
              </p>
                ...
                <div className="space-y-3 text-sm">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      Level 2 or equivalent in their trade and have passed the relevant HS&amp;E
                      test. This is the most commonly held CSCS card and covers a wide range of
                      trades including bricklaying, carpentry, plastering, plumbing, and electrical
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0" />
                    <div>
                      <strong>Gold card (Advanced Craft / Supervisor):</strong> For workers holding
                      an NVQ/SVQ Level 3 or equivalent, and for those in supervisory roles who hold
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0" />
                    <div>
                      <strong>Black card (Manager):</strong> For those in site management roles who
                      hold an NVQ/SVQ Level 4 or above, together with SMSTS or an equivalent
                      management-level health and safety qualification. Valid for 5 years.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0" />
                    <div>
                      <strong>White card (Professional/Technical):</strong> For construction
                      professionals such as architects, engineers, surveyors, and other technical
                      specialists who hold membership of a recognised professional body and have
                      passed the managers and professionals HS&amp;E test. Valid for 5 years.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0" />
                    <div>
                      <strong>Red card (Trainee/Provisional):</strong> A temporary card for those
                      who are registered for or working towards a qualification. Typically valid for
                      1&ndash;3 years, and the holder must be working under supervision. The red
                      card confirms that the individual has passed the HS&amp;E test and is on a
                      pathway to a full qualification.
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <h3 className="text-blue-400 font-medium mb-3">
                  The HS&amp;E Test, Build UK &amp; Alternatives
                </h3>
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0" />
                    <div>
                      <strong>The HS&amp;E test:</strong> To obtain a CSCS card, the applicant must
                      pass the Health, Safety and Environment (HS&amp;E) test. This is a
                      computer-based, multiple-choice test covering core health and safety topics
                      relevant to the construction industry. Different test versions exist for
                      different card levels (operatives, specialists, managers, professionals). The
                      test is delivered at Pearson Vue centres across the UK and must be retaken
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0" />
                    <div>
                      <strong>The Build UK commitment:</strong> Build UK (formerly the UK
                      Contractors Group / Major Contractors Group) requires all member organisations
                      to implement a &ldquo;no card, no start&rdquo; policy on their sites. Since
                      Build UK members include the vast majority of tier-one contractors in the UK,
                      this effectively means that a valid CSCS card is required for site access on
                      most significant construction projects. This industry commitment has been
                      instrumental in driving up training and qualification levels across the
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      recognised by the construction industry. Other schemes that are aligned with
                      the Construction Skills Card Standard include: <strong>CPCS</strong>{' '}
                      (Construction Plant Competence Scheme &mdash; for plant operators),{' '}
                      <strong>NPORS</strong>
                      (National Plant Operators Registration Scheme), <strong>IPAF</strong>
                      (International Powered Access Federation &mdash; for MEWP operators), and{' '}
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  . Holding a valid card confirms that the holder has passed the relevant HS&amp;E
                  test and holds a recognised qualification, but it does not guarantee that the
                  individual will work safely in practice. The principal contractor must still
                  verify that workers are competent for the specific tasks they will carry out,
                  through induction, RAMS review, supervision, and ongoing monitoring.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <h3 className="text-blue-400 font-medium mb-3">
                  Industry-Specific &amp; Task-Specific Training
                </h3>
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0" />
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      Users certificate. PASMA training covers tower assembly, stability, safe use,
                      inspection, and the requirements of the Work at Height Regulations 2005.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0" />
                    <div>
                      ...
                      This includes hazard recognition, atmospheric monitoring, use of RPE,
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0" />
                    <div>
                      <strong>Harness and fall arrest:</strong> Workers who use harnesses and
                      personal fall protection systems must be trained in the correct fitting, use,
                      inspection, and limitations of the equipment. Training should cover pre-use
                      inspection, anchor point selection, fall clearance calculations, and rescue
                      planning.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0" />
                    <div>
                      <strong>Scaffold inspection:</strong> Under the Work at Height Regulations
                      2005, scaffolds must be inspected by a competent person before first use, at
                      intervals not exceeding 7 days, and after any event likely to affect
                      stability. Scaffold inspectors must hold an appropriate qualification (such as
                      CISRS Scaffold Inspection Training Scheme) and have sufficient experience to
                      identify defects and assess structural integrity.
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      project. These should include: the worker&rsquo;s name and employer; their
                      CSCS card number, type, and expiry date; copies of relevant certificates and
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                ...
                involves planning, instructing, monitoring, and intervening when necessary to ensure
                that work is carried out safely.
              </p>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <h3 className="text-blue-400 font-medium mb-3">
                  When Enhanced Supervision Is Required
                </h3>
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0" />
                    <div>
                      <strong>Young workers (under 18):</strong> Under Regulation 19 of the
                      Management of Health and Safety at Work Regulations 1999, employers must carry
                      out a specific risk assessment for young workers that accounts for their
                      inexperience, lack of awareness of risks, and physical and psychological
                      immaturity. Young workers must receive close, direct supervision until their
                      competence has been assessed and confirmed.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0" />
                    <div>
                      ...
                      and training safely in practice. Holding a qualification does not
                      automatically mean a worker can perform safely without guidance &mdash;
                      practical experience under supervision is essential.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0" />
                    <div>
                      <strong>Workers new to the site:</strong> Even experienced workers need
                      enhanced supervision during their initial period on a new site. They are
                      unfamiliar with the site layout, specific hazards, procedures, and the work of
                      other trades around them. The first few days on a new site represent a period
                      of elevated risk.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      CITB course designed for first-line supervisors, charge-hands, and gang
                      leaders. SSSTS covers the supervisor&rsquo;s legal responsibilities, risk
                      assessment, method statements, toolbox talks, monitoring work activities,
                      accident reporting, and dealing with unsafe behaviour. The qualification is
                      valid for 5 years and must be renewed through a one-day refresher course. Most
                      principal contractors require site supervisors to hold a current SSSTS
                      certificate.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      personnel. SMSTS covers a broader range of topics including CDM 2015 duties in
                      detail, construction phase planning, managing subcontractors, accident
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      when to stop work. Holding SSSTS or SMSTS is an important element of
                      supervisor competence, but it must be combined with relevant trade knowledge
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  <strong className="text-white">primary contributing factor</strong>. A common
                  pattern is that an experienced worker is asked to supervise others in addition to
                  carrying out their own work, with the result that neither task is done
                  effectively. Dedicated supervision &mdash; where the supervisor&rsquo;s primary
                  role is to oversee the work of others, not to carry out productive work themselves
                  &mdash; is essential for high-risk activities.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                Toolbox talks are short, focused safety briefings delivered to workers on site. They
                are a vital part of the ongoing safety communication programme and serve to
                ...
                <div className="space-y-3 text-sm">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      to begin, a toolbox talk on working at height, edge protection, fragile
                      surfaces, and weather-related risks would be appropriate. If a near miss
                      involving an excavation collapse occurred the previous week, a toolbox talk on
                      excavation safety would reinforce the lessons learned. Generic, repetitive
                      toolbox talks that bear no relation to current site activities quickly lose
                      their impact.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      records demonstrate that ongoing safety communication is taking place and are
                      valuable evidence during HSE inspections and incident investigations.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0" />
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                ...
                knowledge, training, and experience. This applies not only to individual workers but
                also to organisations as a whole. Assessing organisational competence is
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      Available Specification 91) provides a standardised framework of
                      pre-qualification questions covering health, safety, and environmental
                      capability. Using PAS 91 ensures a consistent, proportionate assessment and
                      avoids the proliferation of different questionnaires from different clients.
                      PAS 91 is structured in modules, allowing the assessment to be tailored to the
                      type and risk level of the work being procured.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0" />
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      training its workforce, maintains up-to-date training records, and ensures
                      that workers hold the appropriate qualifications and certifications for the
                      work they carry out. An organisation that cannot produce training records when
                      asked is unlikely to be managing competence effectively.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0" />
                    <div>
                      ...
                      However, accreditations should supplement, not replace, a direct assessment of
                      the organisation&rsquo;s capability for the specific work being procured.
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <h3 className="text-blue-400 font-medium mb-3">
                  Individual vs Organisational Competence
                </h3>
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0" />
                    <div>
                      ...
                      through qualifications, CSCS cards, training records, and practical
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      be proportionate to the nature and risk of the work. A straightforward
                      assessment may be sufficient for low-risk work by a well-known contractor. A
                      more thorough assessment &mdash; including site visits, interviews, and
                      detailed document review &mdash; is appropriate for high-risk, complex, or
                      novel work, or where the contractor is unknown to the appointing party.
                    </div>
                  </div>
                </div>
              </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      their own work to provide effective oversight. The tragic deaths of
                      apprentices on UK construction sites have led to renewed focus on the
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0" />
                    <div>
                      <strong>Language barriers:</strong> Workers who do not fully understand
                      English may not comprehend safety instructions, warning signs, RAMS, toolbox
                      talks, or verbal instructions from supervisors. HSE investigations have
                      identified cases where workers were exposed to serious risks because they did
                      not understand the safety briefing they received. The duty to ensure
                      understanding rests with the employer and the principal contractor, not with
                      the worker.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      suspicion of fraud should be reported to CSCS and the individual should not be
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <h3 className="text-blue-400 font-medium mb-3">
                  HSE Enforcement and What Inspectors Look For
                </h3>
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0" />
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0" />
                    <div>
                      <strong>Common enforcement triggers:</strong> Workers found operating plant or
                      machinery without appropriate training or certification; workers at height
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      improvement notices, prohibition notices (stopping work immediately),
                      prosecution, and unlimited fines under the sentencing guidelines introduced in
                      2016. In cases involving fatalities, individuals can be prosecuted for gross
                      negligence manslaughter. The reputational damage to organisations found to
                      have failed in their competence management duties can be severe and
                      long-lasting.
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  not received a site-specific induction, his CSCS card had expired, he had received
                  no working-at-height training, and there was no competent supervisor overseeing
                  the work. The court heard that the principal contractor had a written induction
                  procedure but had{' '}
                  <strong className="text-white">failed to implement it in practice</strong>. The
                  judge emphasised that paper systems are worthless if they are not followed &mdash;
                  what matters is what actually happens on site.
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                <ul className="text-white space-y-3 text-sm">
                  ...
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-blue-400 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong>CSCS cards</strong> are the industry standard for evidencing
                      competence but are not a legal requirement. The Build UK &ldquo;no card, no
                      start&rdquo; policy makes them a de facto requirement on most major projects.
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-blue-400 mt-0.5 flex-shrink-0" />
                  ...
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-blue-400 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong>Enhanced supervision</strong> is required for young workers,
                      inexperienced workers, workers new to the site, and high-risk activities.
                      SSSTS and SMSTS are the industry-standard supervisory qualifications.
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-blue-400 mt-0.5 flex-shrink-0" />
                  ...
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-blue-400 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong>Common competence failures</strong> involve young/new workers,
                      language barriers, agency workers, and fraudulent cards. The HSE actively
                      enforces competence requirements during inspections and investigations.
                    </span>
                  </li>
                </ul>
              </div>
        ...
        {/* ─── Quiz ─── */}
        <div className="mt-12">
          <Quiz title="Site Inductions & Competence Quiz" questions={quizQuestions} />
        </div>
