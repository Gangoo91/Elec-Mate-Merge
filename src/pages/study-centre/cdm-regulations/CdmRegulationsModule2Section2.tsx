import { ArrowLeft, BookOpen, CheckCircle, AlertTriangle, PenTool } from 'lucide-react';
...
const faqs = [
  {
    question: 'Can the client appoint themselves as the Principal Designer?',
    answer:
  ...
  {
    question: 'What happens if no Principal Designer is appointed on a multi-contractor project?',
    answer:
  ...
  {
    question: 'How does the Principal Designer role differ from a project architect?',
    answer:
  ...
  {
    question: 'Can the Principal Designer role be transferred during a project?',
    answer:
...
const quizQuestions = [
  ...
  {
    id: 2,
    question: "Which regulation in CDM 2015 sets out the Principal Designer's duties?",
    options: [
  ...
  {
    id: 8,
    question: 'What competence standard is required for a Principal Designer under CDM 2015?',
    options: [
...
const CdmRegulationsModule2Section2 = () => {
  useSEO({
    title: 'Principal Designer | CDM Regulations Module 2.2',
    description:
          ...
          <div className="rounded-lg p-4 bg-blue-500/5 border-l-2 border-blue-500/50">
            ...
            <ul className="text-white text-base space-y-1.5">
              <li className="flex items-start gap-2">
                ...
                <span>
                  <strong className="text-white">Appointed by:</strong> the client, on projects with
              ...
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Must be:</strong> a designer with control over the
              ...
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Core duty:</strong> plan, manage, monitor, and
                  coordinate H&S in design
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Key output:</strong> the Health & Safety File
          ...
          <div className="rounded-lg p-4 bg-blue-500/5 border-l-2 border-blue-500/50">
            ...
            <ul className="text-white text-base space-y-1.5">
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Before construction:</strong> PD coordinates all
              ...
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Design reviews:</strong> ensure risks are
                  eliminated or reduced through design
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">H&S File:</strong> compile as-built info,
                  materials, maintenance procedures
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Handover:</strong> pass the completed H&S File to
                  the client at project end
                </span>
              </li>
            </ul>
          </div>
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                ...
                <strong className="text-white">pre-construction phase</strong> of a project. Under
                CDM 2015, the client must appoint a PD on any project that involves, or is likely to
                involve, <strong className="text-white">more than one contractor</strong>.
              </p>
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                ...
                <p className="text-white text-sm">
                  ...
                  safety during the pre-construction phase. The PD must have the skills, knowledge,
                  experience, and organisational capability to fulfil the role.
                </p>
              </div>

              <p>
                The PD role was introduced by CDM 2015 to replace the former CDM Coordinator role
                from CDM 2007. The critical difference is that the PD{' '}
                <strong className="text-white">must be a designer</strong> — someone who actually
                carries out design work and can therefore influence design decisions directly. In
                practice, the PD is typically:
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <strong className="text-white">Architect</strong> — the most common
                      appointment, particularly on building projects where the architect leads the
                      design team
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Consulting engineer</strong> — structural,
                      civil, or building services engineer on engineering-led projects
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Multi-disciplinary design practice</strong> — a
                      firm that employs designers across multiple disciplines
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Design-and-build contractor</strong> — where
                      the contractor also carries out design, they may take on the PD role
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-blue-500/30 p-4 rounded-lg">
                ...
                <p className="text-white text-sm">
                  ...
                  PD&rsquo;s ability to influence design and eliminate hazards. Ideally, the PD
                  should be appointed at the concept or feasibility stage so they can shape the
                  design from the outset.
                </p>
              </div>

              <p>
                If the client fails to appoint a PD when one is required, the PD duties{' '}
                <strong className="text-white">fall on the client by default</strong>. This can
                create serious legal exposure for clients who are not designers and lack the
                competence to fulfil the role.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="border-l-2 border-sky-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                ...
                health and safety during the pre-construction phase — this is not an advisory or
              ...
              <div className="bg-white/5 border border-sky-400/30 p-4 rounded-lg">
                <h3 className="text-sky-300 font-medium mb-3">Regulation 11 — Core Duties</h3>
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                ...
                <p className="text-white text-sm">
                  ...
                  plan, manage, coordinate, and ensure. This is a deliberate shift from the former
                  CDM Coordinator role, which was often criticised for being too advisory and
          ...
          <div className="border-l-2 border-teal-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                ...
                PD&rsquo;s primary area of responsibility and the window during which design
                decisions can have the greatest impact on construction safety.
              </p>
              ...
              <div className="bg-white/5 border border-teal-400/30 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <strong className="text-white">Identify risks:</strong> work with the design
                      team to identify foreseeable health and safety risks arising from the design
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-teal-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Eliminate risks through design:</strong> where
                      possible, change the design to remove hazards entirely — for example,
                      specifying pre-fabricated components to reduce work at height
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-teal-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Reduce remaining risks:</strong> where
                      elimination is not possible, reduce risks through design choices — such as
                      positioning heavy plant at ground level instead of on upper floors
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-teal-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Prepare pre-construction information:</strong>{' '}
                      compile and distribute information relevant to the project including existing
                      surveys, site conditions, hazardous materials, and previous H&S files
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-teal-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Coordinate design work:</strong> manage the
                      interfaces between different design disciplines (architecture, structural,
                      mechanical, electrical) to ensure no conflicts create safety risks
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <p>
                The pre-construction information is critical because it forms the basis on which the{' '}
                <strong className="text-white">
                  principal contractor prepares the construction phase plan
                </strong>
                . Poor or incomplete pre-construction information leads to poor planning, which
                leads to unsafe construction.
              </p>
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                ...
                <p className="text-white text-sm">
                  ...
                  the services away from the ACMs where possible, and ensures that the
                  pre-construction information provided to the principal contractor clearly
                  identifies the remaining ACM locations so a licensed asbestos removal contractor
                  can be appointed before the M&E installation begins.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-indigo-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                ...
                identifying hazards that arise from the design and either eliminating them or
                reducing the associated risks. CDM 2015 requires the PD (and all designers) to apply
                the <strong className="text-white">General Principles of Prevention</strong> set out
              ...
              <div className="bg-white/5 border border-indigo-400/30 p-4 rounded-lg">
                ...
                <div className="space-y-3 text-sm">
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-indigo-500/20 border border-indigo-400/30 flex items-center justify-center flex-shrink-0 mt-0.5">
                      <span className="text-indigo-300 text-xs font-bold">b</span>
                    </div>
                    <div>
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-indigo-500/20 border border-indigo-400/30 flex items-center justify-center flex-shrink-0 mt-0.5">
                      <span className="text-indigo-300 text-xs font-bold">c</span>
                    </div>
                    <div>
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-indigo-500/20 border border-indigo-400/30 flex items-center justify-center flex-shrink-0 mt-0.5">
                      <span className="text-indigo-300 text-xs font-bold">d</span>
                    </div>
                    <div>
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-indigo-500/20 border border-indigo-400/30 flex items-center justify-center flex-shrink-0 mt-0.5">
                      <span className="text-indigo-300 text-xs font-bold">f</span>
                    </div>
                    <div>
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-indigo-500/20 border border-indigo-400/30 flex items-center justify-center flex-shrink-0 mt-0.5">
                      <span className="text-indigo-300 text-xs font-bold">h</span>
                    </div>
                    <div>
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-indigo-500/20 border border-indigo-400/30 flex items-center justify-center flex-shrink-0 mt-0.5">
                      <span className="text-indigo-300 text-xs font-bold">i</span>
                    </div>
                    <div>
                      <p className="text-white font-medium">
              ...
              <p>
                Designers must not simply identify risks and pass them to the contractor to manage.
                The expectation is that the PD and all designers will make{' '}
                <strong className="text-white">genuine design decisions</strong> that improve
                safety, not produce paperwork that transfers responsibility.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                ...
                one designer meets or affects the work of another. The PD is responsible for
                managing these interfaces to ensure they do not create health and safety risks.
              </p>
              ...
              <div className="bg-white/5 border border-violet-400/30 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <strong className="text-white">Design review meetings:</strong> regular
                      meetings where all designers present their work and the PD identifies
                      potential conflicts, overlaps, or safety issues arising from the combined
                      design
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Risk registers:</strong> a project-wide
                      register maintained by the PD that records all identified design risks, the
                      designer responsible, the action taken (eliminate, reduce, inform), and the
                      current status
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Design risk assessments:</strong> each designer
                      produces risk assessments for their discipline, and the PD reviews them to
                  ...
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Cooperation protocols:</strong> the PD ensures
                      all designers cooperate with each other and with the principal contractor,
                  ...
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">BIM coordination:</strong> on projects using
                      Building Information Modelling, the PD can use clash detection software to
                      identify physical conflicts between different design disciplines before
                      construction
                    </div>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-blue-500/30 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-1.5 text-sm">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Structural steelwork clashing with M&E service routes, forcing workers to work
                      in confined or awkward positions
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Cladding fixings specified in locations where there is no safe means of access
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Different designers specifying incompatible fire protection systems that leave
                      gaps in coverage
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Drainage and foundation designs conflicting, creating excavation stability
                      risks
                    </span>
                  </li>
                </ul>
              ...
              <p>
                The PD does not need to check every line of every drawing, but they must establish{' '}
                <strong className="text-white">systems and processes</strong> that identify and
                resolve design interface issues before they reach the construction phase. Prevention
                through design coordination is always preferable to resolution on site.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                ...
                documents) that contains information about the completed structure which will be
                needed for any future construction work, maintenance, cleaning, refurbishment, or
                demolition.
              </p>
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                ...
                <p className="text-white text-sm">
                  ...
                  as-built drawings, specifications, details of hazardous materials, structural
                  arrangements, maintenance procedures, and residual design risks.
                </p>
              </div>

              <div className="bg-white/5 border border-emerald-400/30 p-4 rounded-lg">
                <h3 className="text-emerald-300 font-medium mb-3">H&S File Contents</h3>
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
              ...
              <div className="bg-white/5 border border-blue-500/30 p-4 rounded-lg">
                ...
                <p className="text-white text-sm">
                  ...
                  the file must be handed to the principal contractor who will continue to develop
                  it. The client must then retain the H&S File and make it available to anyone who
                  needs it for future work on the structure. When a building is sold, the H&S File
                  should be passed to the new owner.
                </p>
              </div>

              <p>
                A well-prepared H&S File is invaluable — it provides future designers, contractors,
                and maintenance teams with the information they need to work safely on the structure
                for the rest of its life. A poor or missing H&S File forces future workers to
                proceed without critical safety information.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="border-l-2 border-amber-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                ...
                <strong className="text-white">Principal Designer</strong> role. While both roles
                address pre-construction health and safety, the PD role represents a significant
                shift in approach.
              </p>
                  ...
                  <div className="min-w-[600px]">
                    ...
                    <div className="grid grid-cols-3 gap-px bg-white/10 rounded-t-lg overflow-hidden">
                      <div className="bg-blue-500/20 p-3">
                        <p className="text-blue-300 font-semibold text-sm">Aspect</p>
                      </div>
                      <div className="bg-blue-500/20 p-3">
                    ...
                    {[
                      {
                        ...
                        cdm2007: 'Any competent person — did not need to be a designer',
                        cdm2015:
                      ...
                      },
                      {
                        ...
                        cdm2007: 'Advised designers of their duties — no direct enforcement power',
                        cdm2015:
                          'Must ensure designers comply with their duties under Regulation 9',
                      },
                      {
                        aspect: 'Health & Safety File',
                        cdm2007: 'CDM-C prepared the H&S File',
                        cdm2015:
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                ...
                <p className="text-white text-sm">
                  ...
                  someone with real influence over design safety. Many CDM-Cs were not designers and
                  could not effectively challenge or change design decisions. CDM 2015 addressed
                  this by requiring the PD to be a designer, giving them direct control over design
                  health and safety, and making the role less about paperwork and more about{' '}
                  <strong className="text-white">genuine risk reduction through design</strong>.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-amber-500/30 p-4 rounded-lg">
                ...
                <p className="text-white text-sm">
                  ...
                  designers may continue to provide H&S advisory services but cannot be appointed as
                  Principal Designers.
                </p>
              </div>
            </div>
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                ...
                to fulfil the role. The client must make a reasonable assessment of the PD&rsquo;s
                competence before making the appointment.
              </p>

              <div className="bg-white/5 border border-cyan-400/30 p-4 rounded-lg">
                <h3 className="text-cyan-300 font-medium mb-3">Competence Framework</h3>
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-cyan-500/20 border border-cyan-400/30 flex items-center justify-center flex-shrink-0 mt-0.5">
                      <span className="text-cyan-300 text-xs font-bold">S</span>
                    </div>
                    <div>
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-cyan-500/20 border border-cyan-400/30 flex items-center justify-center flex-shrink-0 mt-0.5">
                      <span className="text-cyan-300 text-xs font-bold">K</span>
                    </div>
                    <div>
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-cyan-500/20 border border-cyan-400/30 flex items-center justify-center flex-shrink-0 mt-0.5">
                      <span className="text-cyan-300 text-xs font-bold">O</span>
                    </div>
                    <div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">RIBA</strong> — Royal Institute of British
                      Architects: professional standards for architects, including CDM awareness
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">ICE</strong> — Institution of Civil Engineers:
                      professional standards for civil and structural engineers
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">CIOB</strong> — Chartered Institute of
                      Building: professional standards for construction managers and
                  ...
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">CIBSE</strong> — Chartered Institution of
                      Building Services Engineers: relevant for M&E-led projects
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">APS</strong> — Association for Project Safety:
                      offers specific training and certification for CDM professionals
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                ...
                <p className="text-white text-sm">
                  ...
                  requires a PD with basic CDM knowledge and design risk management skills. A major
                  infrastructure project requires a PD (or PD organisation) with extensive
                  experience of managing complex, multi-disciplinary design teams and high-risk
              ...
              <div className="bg-white/5 border border-blue-500/30 p-4 rounded-lg">
                ...
                <p className="text-white text-sm">
                  ...
                  take reasonable steps, such as checking qualifications, reviewing past project
                  experience, asking for references, and assessing organisational resources. Simply
                  appointing the cheapest designer without checking competence is a breach of the
                  client&rsquo;s duty under Regulation 5.
                </p>
              </div>
            </div>
          </div>
