...
const faqs = [
  {
    question: 'Do all designers have to produce a formal design risk assessment under CDM 2015?',
    answer:
  ...
  {
    question: 'What information should a designer provide to a contractor about residual risks?',
    answer:
  ...
  {
    question: 'How does the 5×5 risk matrix work in design risk assessment?',
    answer:
...
const quizQuestions = [
  ...
  {
    id: 3,
    question: 'In the Edwards v National Coal Board [1949] case, the court established that:',
    options: [
  ...
  {
    id: 4,
    question: 'A design risk register should be maintained through which stages of a project?',
    options: [
  ...
  },
  {
    ...
    options: ['9 — medium risk', '15 — high risk', '20 — very high risk', '25 — very high risk'],
    correctAnswer: 2,
    explanation:
...
const CdmRegulationsModule4Section2 = () => {
  useSEO({
    title: 'Risk Assessment in Design | CDM Regulations Module 4.2',
    description:
          ...
          <div className="rounded-lg p-4 bg-blue-500/5 border-l-2 border-blue-500/50">
            ...
            <ul className="text-white/80 text-base space-y-1.5">
              <li className="flex items-start gap-2">
                ...
                <span>
                  <strong className="text-white">Design risk assessment:</strong> systematic process
                  for identifying and managing hazards created by design decisions
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">SFAIRP:</strong> risks must be reduced so far as is
                  reasonably practicable &mdash; cost must be grossly disproportionate to justify
                  inaction
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Risk register:</strong> living document maintained
                  through all RIBA stages
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Information flow:</strong> designers need PCI from
                  clients and must communicate residual risks to contractors
                </span>
              </li>
            </ul>
          </div>
          <div className="rounded-lg p-4 bg-blue-500/5 border-l-2 border-blue-500/50">
            ...
            <ul className="text-white/80 text-base space-y-1.5">
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Eliminate first:</strong> design out hazards before
              ...
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Record everything:</strong> use a design risk
                  register aligned to RIBA stages
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Communicate residual risks:</strong> provide clear,
                  specific information to contractors
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Review at every stage:</strong> update the risk
                  register as the design develops
                </span>
              </li>
            </ul>
          </div>
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                design decisions, evaluate the associated risks, and take steps to eliminate or
                reduce them. Under <strong className="text-white">CDM 2015 Regulation 9</strong>,
                every designer has a duty to consider the health and safety implications of their
                work &mdash; not just during construction, but through the entire lifecycle of the
                building, including maintenance, refurbishment, and eventual demolition.
              </p>
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  . For example, specifying a fragile roofing material creates a fall-through risk
                  for anyone who accesses the roof during its lifetime. A{' '}
                  <strong className="text-white">construction risk assessment</strong>, by contrast,
                  focuses on hazards arising from the construction process itself &mdash; such as
                  crane operations, excavation methods, or temporary works. Both are required under
                  CDM 2015, but they serve different purposes and are produced by different duty
                  holders.
                </p>
              </div>
              ...
              <p>
                ...
                <strong className="text-white">proactive, not reactive</strong>. It begins at the
                earliest stage of design, when decisions have the greatest influence on safety
                outcomes. A change to the structural form at concept stage is far simpler and
                cheaper than retrofitting safety measures during construction. Designers who leave
                risk assessment until the detailed design stage have already missed the window for
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <strong className="text-white">Designers shape the risks:</strong> research
                      consistently shows that a significant proportion of construction accidents can
                      be traced back to design decisions or the absence of design consideration
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Early intervention is most effective:</strong>{' '}
                      the cost and difficulty of eliminating hazards increases exponentially as the
                      project progresses through design to construction
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Legal obligation:</strong> CDM 2015 Regulation
                      9 places a specific, non-delegable duty on designers to consider safety in
                      their work
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Whole-life thinking:</strong> design decisions
                      affect safety not just during construction but for the entire operational life
                      and eventual demolition of the structure
                    </div>
                  </li>
                </ul>
              </div>
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                maintenance, and demolition &mdash; as a direct or indirect consequence of their
                design decisions. Several techniques are available:
              </p>
              ...
              <div className="bg-white/5 border border-cyan-400/30 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-2 text-sm">
                  ...
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-cyan-400 mt-2 flex-shrink-0"></div>
                    <div>
                      Involve contractors early to benefit from their practical construction
                      experience
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-cyan-400 mt-2 flex-shrink-0"></div>
                    <div>Record all identified hazards and actions in the design risk register</div>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-cyan-400/30 p-4 rounded-lg">
                ...
                <p className="text-white/70 text-sm">
                  ...
                  any unusual or complex construction challenges. These reviews are particularly
                  valuable when the design team includes members with limited site experience.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-cyan-400/30 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-cyan-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">HAZOP (Hazard and Operability Study):</strong>{' '}
                      uses guide words to systematically examine each design element for potential
                  ...
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-cyan-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">HAZID (Hazard Identification Study):</strong> a
                      broader review that identifies hazards across all aspects of the project,
                      often used at the concept or feasibility stage before detailed design begins
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  registers from similar projects to identify recurring hazards. The HSE publishes
                  investigation reports and safety alerts that highlight design-related failures.
                  Many professional bodies maintain databases of design-related incidents that their
                  members can access.
                </p>
              </div>
            </div>
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                evaluation allows designers to prioritise their response &mdash; focusing effort on
                the hazards that pose the greatest threat to health and safety.
              </p>
              ...
              <div className="bg-white/5 border border-purple-400/30 p-4 rounded-lg">
                ...
                <p className="text-white/70 text-sm mb-3">
                  ...
                  the consequences be?). Each factor is scored on a scale &mdash; typically 1 to 5
                  &mdash; and the scores are multiplied to give a{' '}
                  ...
                  <div>
                    ...
                    <ul className="text-white/70 space-y-1">
                      ...
                      <li className="flex items-center gap-2">
                        ...
                        Likely &mdash; will probably happen in most circumstances
                      </li>
                      <li className="flex items-center gap-2">
              ...
              <p>
                ...
                <strong className="text-white">very high</strong> bands demand a design response.
                Ideally, the designer should eliminate the hazard entirely. Where elimination is not
                reasonably practicable, the design should reduce the risk and the residual hazard
                must be clearly communicated to contractors and, where relevant, to building users.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="border-l-2 border-teal-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                the hazards identified, the risk evaluation, the control measures adopted, and any
                residual risks that remain after the design response.
              </p>
              ...
              <div className="bg-white/5 border border-teal-400/30 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <strong className="text-white">Hazard description:</strong> a clear, specific
                      description of the hazard and the design element that creates or influences it
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-teal-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Risk evaluation:</strong> the likelihood,
                      severity, and overall risk score before any design intervention
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-teal-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Design response:</strong> what the designer has
                      done to eliminate or reduce the risk &mdash; the specific design change or
                      mitigation
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-teal-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Residual risk:</strong> the risk that remains
                      after the design response, with a revised risk score
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-teal-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Information for others:</strong> notes on
                      residual risks that must be communicated to contractors, the CDM co-ordinator,
                      or building users
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-teal-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Status &amp; owner:</strong> who is responsible
                      for the action and whether it is open, in progress, or closed
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-teal-500/10 border border-teal-500/30 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-teal-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Stage 0–1:</strong> Strategic Definition &amp;
                      Preparation &mdash; identify site-wide and project-level hazards
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-teal-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Stage 2:</strong> Concept Design &mdash; assess
                      hazards arising from structural form, massing, and material choices
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-teal-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Stage 3:</strong> Spatial Coordination &mdash;
                      detailed assessment of interfaces, services routes, and construction
                      sequencing
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-teal-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Stage 4:</strong> Technical Design &mdash;
                      final risk assessment of detailed design, specifications, and construction
                      information
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-teal-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Stage 5–7:</strong> Construction, Handover
                      &amp; Use &mdash; verify that residual risks have been communicated and
                      captured in the health and safety file
                    </div>
                  </li>
                </ul>
              </div>
          ...
          <div className="border-l-2 border-amber-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                (SFAIRP). This phrase has a precise legal meaning, established through case law over
                many decades. Understanding it is essential for every designer.
              </p>
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  likelihood of harm) against the <strong className="text-white">sacrifice</strong>{' '}
                  (in money, time, or trouble) needed to avert or reduce that risk. If the sacrifice
                  is <strong className="text-white">grossly disproportionate</strong> to the risk,
                  the duty holder is not required to take further action.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-amber-400/30 p-4 rounded-lg">
                ...
                <blockquote className="border-l-2 border-amber-400/40 pl-4 italic text-white/60 text-sm">
                  ...
                  necessary for averting the risk (whether in money, time or trouble) is placed on
                ...
                <p className="text-white/70 text-sm mt-3">
                  ...
                  injured party to prove otherwise.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <strong className="text-white">High-risk hazards:</strong> where the risk of
                      death or serious injury is significant, a very substantial expenditure is
                      expected before the duty is discharged
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-amber-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Good practice:</strong> established industry
                      good practice (e.g. HSE guidance, British Standards, industry codes) is
                      generally considered reasonably practicable &mdash; departing from it requires
                      justification
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-amber-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Cost alone is not sufficient:</strong> the test
                      requires &ldquo;gross disproportion&rdquo; &mdash; simply being expensive or
                      inconvenient does not satisfy the test if the risk is serious
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-amber-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Document your reasoning:</strong> record why a
                      particular design decision was made, including the alternatives considered and
                      rejected, to demonstrate that the SFAIRP test was applied
                    </div>
                  </li>
                </ul>
              </div>
          ...
          <div className="border-l-2 border-sky-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                <strong className="text-white">contractor</strong>. CDM 2015 creates a structured
                information chain that ensures each duty holder has what they need to fulfil their
                obligations.
              </p>
              ...
              <div className="bg-white/5 border border-sky-400/30 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <strong className="text-white">Existing structures:</strong> as-built
                      drawings, structural surveys, asbestos management surveys and
                  ...
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-sky-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Ground conditions:</strong> site investigation
                      reports, contamination assessments, groundwater levels
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-sky-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Buried services:</strong> utility records,
                      service drawings, previous excavation records
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-sky-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Hazardous materials:</strong> known asbestos
                      locations, lead paint, contaminated land, PCBs in existing electrical
                      equipment
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-sky-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Access &amp; restrictions:</strong> site access
                      limitations, neighbouring properties, working-hours restrictions, live
              ...
              <div className="bg-white/5 border border-sky-400/30 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-sky-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Specific:</strong> focused on the particular,
                      project-related hazards arising from the design &mdash; not generic lists of
                      obvious risks
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-sky-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Proportionate:</strong> significant or unusual
                      risks warrant detailed notes; routine risks that any competent contractor
                      would manage need only brief mention
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-sky-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Clear:</strong> written in plain language,
                      located on relevant drawings or in a stand-alone hazard schedule
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-sky-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Timely:</strong> provided early enough for the
                      contractor to plan their work safely &mdash; not handed over at the last
                      minute
                    </div>
                  </li>
                </ul>
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  . The client provides PCI to designers. Designers use it to inform their risk
                  assessment and then pass residual risk information to contractors. Contractors use
                  this information to plan safe working methods. Finally, the residual risks and
                  as-built information are captured in the health and safety file for the
                  building&rsquo;s future owners and occupiers.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-indigo-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                the project, the available technology, and the design team&rsquo;s preferred
                methods.
              </p>
              ...
              <div className="bg-white/5 border border-indigo-400/30 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-2 text-sm">
                  ...
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-indigo-400 mt-2 flex-shrink-0"></div>
                    <div>
                      Hazard description and affected phase (construction / maintenance /
                      demolition)
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-indigo-400 mt-2 flex-shrink-0"></div>
                    <div>Risk evaluation (likelihood &times; severity)</div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-indigo-400 mt-2 flex-shrink-0"></div>
                    <div>Designer&rsquo;s action (eliminate / reduce / inform)</div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-indigo-400 mt-2 flex-shrink-0"></div>
                    <div>Residual risk information for contractors</div>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-indigo-400/30 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-indigo-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Hazard tagging:</strong> individual elements
                      can be tagged with associated hazards and residual risk notes, visible to all
                  ...
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-indigo-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">4D sequencing:</strong> time-linked models
                      allow designers and contractors to visualise the construction sequence and
                      identify clashes, access problems, and temporary works requirements
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-indigo-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Clash detection:</strong> automated clash
                      detection identifies spatial conflicts between structural, architectural, and
                      M&E elements before they become problems on site
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-indigo-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Health &amp; safety file:</strong> the BIM
                      model can form the backbone of the health and safety file, ensuring that
                      residual risk information travels with the building throughout its life
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-indigo-400/30 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    ...
                    <span>
                      Can work at height be avoided by designing services accessible from ground or
                      floor level?
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-4 w-4 text-indigo-400/60 mt-0.5 flex-shrink-0" />
                    <span>Can fragile materials be replaced with non-fragile alternatives?</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-4 w-4 text-indigo-400/60 mt-0.5 flex-shrink-0" />
                    <span>
                      Can heavy elements be designed for mechanical handling rather than manual
                      lifting?
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-4 w-4 text-indigo-400/60 mt-0.5 flex-shrink-0" />
                    <span>
                      Can confined space entry be eliminated by relocating equipment or providing
                  ...
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-4 w-4 text-indigo-400/60 mt-0.5 flex-shrink-0" />
                    <span>
                      Can the need for live electrical working be designed out through
                      isolation-friendly layouts?
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-indigo-500/10 border border-indigo-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  , and the <strong className="text-white">APS CDM Designers&rsquo; Guide</strong>.
                  These resources help designers integrate safety considerations into every stage of
                  the design process without creating excessive bureaucracy.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-rose-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                assessment efforts effectively.
              </p>
              ...
              <div className="bg-white/5 border border-rose-400/30 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <strong className="text-white">Temporary works:</strong> the design of the
                      permanent structure significantly influences the temporary works required
                      during construction &mdash; propping, shoring, formwork, falsework. A design
                      that is stable only in its completed form may be dangerously unstable during
                      construction.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-rose-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Heavy lifting:</strong> specifying large, heavy
                      structural elements (such as precast beams or steel sections) creates risks
                      associated with crane operations, rigging, and manual handling. Designers
                      should consider element weights and lifting access in their design.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-rose-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Demolition sequence:</strong> structural
                      designs should consider how the building will eventually be demolished,
                      ensuring that a safe dismantling sequence exists.
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-rose-400/30 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-rose-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Fragile surfaces:</strong> specifying fragile
                      roofing or ceiling materials creates a fall-through risk for anyone accessing
                      the roof during construction or future maintenance. Designers should specify
                      non-fragile alternatives wherever reasonably practicable.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-rose-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Glazing at height:</strong> large glazed
                      facades, atria, and rooflights create risks during installation, cleaning, and
                      replacement. Designers should consider how glazing will be accessed safely
                      throughout the building&rsquo;s life.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-rose-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Maintenance access:</strong> every element of
                      the building will eventually need maintenance or replacement. Designers should
                      provide permanent, safe access provisions &mdash; such as parapets, anchor
                      points, walkways, and access hatches &mdash; rather than assuming that
                      temporary measures will suffice.
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-rose-400/30 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-rose-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Confined spaces:</strong> routing services
                      through ceiling voids, risers, underground chambers, or other restricted
                      spaces creates significant risks during installation and maintenance.
                      Designers should consider accessibility and emergency egress.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-rose-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Live working:</strong> electrical designs that
                      require work on or near live equipment create a risk of electrocution.
                      Designers should specify isolation-friendly layouts that allow circuits to be
                      worked on dead, with clearly identified isolation points and adequate working
                      space.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-rose-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Asbestos proximity:</strong> in refurbishment
                      projects, M&E services often run through or adjacent to areas containing
                      asbestos- containing materials (ACMs). Designers must check the asbestos
                      survey, identify affected areas, and design service routes that avoid
                      disturbing ACMs wherever possible.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-rose-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Heavy equipment:</strong> plant rooms often
                      contain heavy equipment (chillers, boilers, transformers) that requires
                      mechanical handling for installation and eventual replacement. Designers
                      should ensure adequate access routes, lifting provisions, and structural
                      support.
                    </div>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-rose-400/30 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-rose-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Excavations:</strong> deep excavations,
                      basement construction, and foundation works create risks of collapse,
                      flooding, and contact with buried services. Designers should consider ground
                      conditions, water table levels, and the proximity of existing structures.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-rose-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Buried services:</strong> striking underground
                      gas mains, electricity cables, water mains, or telecommunications cables
                      during excavation is one of the most common causes of construction incidents.
                      Designers must identify all buried services and, where possible, design
                      foundations and drainage to avoid them.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-rose-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Working near traffic:</strong> civil
                      engineering works adjacent to live roads, railways, or waterways expose
                      workers to collision and drowning risks. Designers should consider traffic
                      management requirements and, where possible, design works to minimise
                      exposure.
                    </div>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/70 text-sm">
                  ...
                  before communicating any residual risks. Simply writing &ldquo;contractor to
                  ensure safe system of work&rdquo; on a drawing is not acceptable &mdash; designers
                  must demonstrate that they have applied the hierarchy of risk control to their own
                  design decisions.
                </p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-2 gap-4 max-w-2xl mx-auto mb-3">
            ...
            <div className="flex flex-col items-center gap-2">
              <div className="bg-white/5 border border-green-400/30 rounded-lg px-3 py-2 text-center w-full">
                <p className="text-green-300 font-medium text-xs">Yes &mdash; Eliminate</p>
              </div>
            ...
            <div className="flex flex-col items-center gap-2">
              <div className="bg-white/5 border border-amber-400/30 rounded-lg px-3 py-2 text-center w-full">
                <p className="text-amber-300 font-medium text-xs">No &mdash; Reduce &amp; Inform</p>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="mt-4 bg-white/5 border border-white/10 rounded-lg p-3 max-w-2xl mx-auto">
            <p className="text-white/60 text-xs text-center">
              ...
              residual risk. Risks scoring 5&ndash;9 (medium) should be reviewed and reduced where
              reasonably practicable. Low risks (1&ndash;4) should be recorded but may not require
