...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    question: 'Under CDM 2007, at what threshold was a project required to be notified to the HSE?',
    options: [
  ...
  },
  {
    ...
    question: 'CDM 2015 replaced the CDM coordinator with which new role?',
    options: ['Planning supervisor', 'Principal designer', 'Design risk manager', 'Client adviser'],
    correctIndex: 1,
    explanation:
...
const faqs = [
  ...
  {
    question: 'What was wrong with the planning supervisor role under CDM 1994?',
    answer:
  ...
  {
    question: 'Did CDM 2015 change the notification threshold for projects?',
    answer:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Principal contractors', 'Commercial clients', 'Domestic clients', 'Designers'],
    correctAnswer: 2,
    explanation:
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-blue-500/5 border-l-2 border-blue-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>3 versions:</strong> CDM 1994 &rarr; CDM 2007 &rarr; CDM 2015 (current)
              </li>
              <li>
                <strong>EU origin:</strong> Directive 92/57/EEC required UK implementation
              </li>
              <li>
                <strong>Key shift:</strong> Planning supervisor &rarr; CDM coordinator &rarr;
                principal designer
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-blue-500/5 border-l-2 border-blue-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>CDM 2015:</strong> Current regulations &mdash; in force since 6 April 2015
              </li>
              <li>
                <strong>Domestic clients:</strong> Brought into scope for the first time in 2015
              </li>
              <li>
                <strong>ACoP:</strong> L153 replaced L144 as the approved code of practice
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Before the CDM Regulations existed, UK construction health and safety was governed
                by a patchwork of older legislation that was not specifically designed for the
                modern, multi-party nature of construction projects.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Factories Act 1961</strong> &mdash; Provided
                      basic safety requirements for factory and construction workplaces, including
                      provisions for scaffolding, hoists, and excavations. It was prescriptive but
                      narrow, focusing on physical conditions rather than management systems.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400/60 flex-shrink-0" />
                    <span>
                      ...
                      &mdash; Made under the Factories Act, these regulations set out specific
                      requirements for construction sites including safe access, scaffolding
                      standards, and excavation support. They dealt with physical safeguards but did
                      not address design, planning, or management coordination.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400/60 flex-shrink-0" />
                    <span>
                      ...
                      &mdash; The landmark Act that established the modern framework of health and
                      safety law in the UK. It placed general duties on employers, employees, and
                      the self-employed. However, HSWA was a general Act applying to all industries
                      and did not specifically address construction&rsquo;s unique multi-employer,
                      multi-phase risks.
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  legislation focused on physical site conditions but failed to address the root
                  causes of construction accidents:
                  <strong className="text-white">
                    {' '}
                    poor design decisions, lack of coordination between parties, inadequate
                    planning, and unclear responsibilities
                  </strong>
                  . It was clear that a fundamentally different regulatory approach was needed.
                </p>
              </div>

              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-blue-400">The Gap:</strong> The pre-CDM legislation placed
                  duties on contractors and employers on site, but it did not place any specific
                  duties on
                  <strong> clients</strong> who commissioned construction work or on{' '}
                  <strong>designers</strong>
                  whose decisions could create or eliminate risks. There was no legal requirement
                  for coordination between the multiple parties involved in a construction project.
                  CDM was designed to fill this gap.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                <strong> Council Directive 92/57/EEC</strong> on the implementation of minimum
                health and safety requirements at temporary or mobile construction sites. This
                Directive was the eighth individual Directive within the meaning of Article 16(1) of
                Directive 89/391/EEC (the &ldquo;Framework Directive&rdquo;).
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">
                        Coordination during design and planning
                      </strong>{' '}
                      &mdash; Member states were required to ensure that health and safety was
                      considered during the design and planning stages, not just during
                      construction.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Appointment of coordinators</strong> &mdash;
                      The Directive required the appointment of a coordinator for health and safety
                      during both the project preparation stage and the project execution stage.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Health and safety plans</strong> &mdash; A
                      health and safety plan was required before the construction site was set up.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Prior notification</strong> &mdash; Certain
                      projects (based on size and duration thresholds) had to be notified to the
                      competent authority before work commenced.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Minimum requirements</strong> &mdash; The
                      Directive set minimum standards; member states were free to implement stricter
                      provisions.
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-blue-400">UK Implementation Obligation:</strong> As a
                  member state of the EU, the UK was legally required to transpose the Directive
                  into national law. The UK fulfilled this obligation by introducing the{' '}
                  <strong>Construction (Design and Management) Regulations 1994</strong>, which came
                  into force on 31 March 1995. The UK chose to go beyond the minimum requirements of
                  the Directive in several areas, reflecting the particularly poor safety record of
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The Construction (Design and Management) Regulations 1994 (CDM 1994) came into force
                on 31 March 1995. They represented a fundamental shift in UK construction health and
                safety law by placing duties on parties who had previously had no specific legal
                obligations in relation to construction safety:{' '}
                <strong>clients and designers</strong>.
              </p>
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      responsible for coordinating health and safety during the design phase,
                      ensuring designers complied with their duties, preparing the pre-tender health
                      and safety plan, and developing the health and safety file.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400/60 flex-shrink-0" />
                    <span>
                      ...
                      contractor appointed by the client to manage the construction phase, develop
                      and implement the construction phase health and safety plan, and coordinate
                      the activities of all contractors on site.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Health and safety plan</strong> &mdash;
                      Required in two stages: a pre-tender plan (prepared by the planning
                      supervisor) containing information about risks and site conditions, and a
                      construction phase plan (developed by the principal contractor) setting out
                      how the work would be managed safely.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Health and safety file</strong> &mdash; A
                      document compiled during the project containing information about the
                      completed structure that would be needed for future maintenance, cleaning,
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Competence and resources</strong> &mdash;
                      Clients were required to be reasonably satisfied that all appointees (planning
                      supervisor, designers, principal contractor, contractors) were competent and
                      had adequate resources for health and safety.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  ...
                  groundbreaking. For the first time in the UK, <strong>clients</strong> had legal
                  duties relating to construction health and safety, and <strong>designers</strong>{' '}
                  were required to consider how their designs could be constructed, maintained, and
                  eventually demolished safely. The principle of &ldquo;designing out risk&rdquo;
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Despite its groundbreaking intentions, CDM 1994 was widely criticised in practice.
                The HSE conducted a major review of the regulations and found significant problems
                with how they were being implemented across the industry.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Bureaucracy</strong> &mdash; The regulations
                      were perceived as creating vast amounts of paperwork without delivering
                      proportionate safety improvements. Health and safety plans often ran to
                      hundreds of pages of generic text with little practical value.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Paper exercise perception</strong> &mdash; Many
                      in the industry viewed CDM as a &ldquo;tick-box&rdquo; exercise. The focus was
                      on producing documents (plans, files, risk assessments) rather than on
                      genuinely managing risk through better design and coordination.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Planning supervisor role confusion</strong>{' '}
                      &mdash; The title &ldquo;planning supervisor&rdquo; was misleading. Many
                      assumed it was a site-based supervisory role, when in fact it was a
                      design-phase coordination role. There was no requirement for the planning
                      supervisor to be a designer, so the role was frequently filled by health and
                      safety consultants who had no influence over design decisions.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">ACoP complexity</strong> &mdash; The Approved
                      Code of Practice accompanying CDM 1994 was considered complex and difficult to
                      understand, particularly for smaller businesses and those new to the
                      regulations.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Small project exemptions</strong> &mdash; CDM
                      1994 contained exemptions for smaller projects (fewer than 5 workers), which
                      meant many construction projects fell outside the regulations entirely. This
                      was problematic because small sites are not inherently safer than large ones.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  &ldquo;postbox&rdquo; for collecting and distributing information, rather than
                  actively influencing design and construction to be safer.{' '}
                  <strong className="text-white">
                    The regulations had the right principles but the wrong implementation.
                  </strong>
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The Construction (Design and Management) Regulations 2007 (CDM 2007) came into force
                on 6 April 2007, replacing CDM 1994 and also revoking the Construction (Health,
                Safety and Welfare) Regulations 1996, consolidating construction health and safety
                into a single set of regulations.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">
                        CDM coordinator replaced planning supervisor
                      </strong>
                      &mdash; The planning supervisor role was abolished and replaced by the CDM
                      coordinator. The new title was intended to better reflect the coordination
                      function of the role and avoid the &ldquo;supervisor&rdquo; confusion.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">New ACoP (L144)</strong> &mdash; A new Approved
                      Code of Practice, L144 &ldquo;Managing Health and Safety in
                      Construction&rdquo;, replaced the CDM 1994 ACoP. L144 was intended to be
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Notification threshold</strong> &mdash;
                      Projects had to be notified to the HSE if they lasted more than 30
                      construction days or exceeded 500 person-days of construction work.
                      Notification was made on the F10 form.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400/60 flex-shrink-0" />
                    <span>
                      ...
                      together the management requirements of CDM 1994 with the site welfare and
                      safety requirements of the Construction (Health, Safety and Welfare)
                      Regulations 1996 into one set of regulations. This simplified compliance by
                      having a single reference point.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400/60 flex-shrink-0" />
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-blue-400">On Competence:</strong> CDM 2007 introduced a
                  detailed competence assessment framework. Clients had to take reasonable steps to
                  ensure that all appointees were competent. This included assessing experience,
                  training, qualifications, track record, and the resources available for health and
                  safety. In practice, this led to extensive pre-qualification questionnaires (PQQs)
                  that became another source of bureaucratic complaint.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">CDM coordinator role still problematic</strong>{' '}
                      &mdash; Despite the name change, the CDM coordinator role suffered many of the
                      same problems as the planning supervisor. There was still no requirement for
                      the CDM coordinator to be a designer. The role was frequently outsourced to
                      health and safety consultants who had no design influence. Many CDM
                      coordinators focused on producing documents rather than influencing design
                      decisions.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Cost versus value debate</strong> &mdash; Many
                      clients and contractors questioned whether the cost of appointing a CDM
                      coordinator and complying with the administrative requirements delivered
                      proportionate safety benefits. The perception of CDM as a &ldquo;cost without
                      value&rdquo; persisted.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Design risk management not embedded</strong>{' '}
                      &mdash; Designers were still not fully engaging with their CDM duties. The
                      concept of &ldquo;designing out risk&rdquo; was accepted in principle but
                      inconsistently applied in practice. Many designers treated risk assessment as
                      a separate paperwork exercise rather than an integral part of the design
                      process.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Client duties still unclear</strong> &mdash;
                      Many clients, particularly those who were not regular commissioners of
                      construction work, did not understand their duties under CDM 2007. The
                      distinction between commercial clients and domestic clients created confusion,
                      and domestic clients were largely exempt from the regulations.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  and ensure the regulations focused on genuine risk management rather than
                  paperwork. Lofstedt specifically recommended{' '}
                  <strong className="text-white">
                    replacing the CDM coordinator role with a requirement that the coordination
                    function be carried out by someone with design expertise
                  </strong>
                  . This recommendation directly influenced CDM 2015.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The Construction (Design and Management) Regulations 2015 (CDM 2015) came into force
                on 6 April 2015. They are the current regulations governing health and safety
                management on construction projects in Great Britain and represent the most
                significant revision since CDM was first introduced.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">
                        Principal designer replaced CDM coordinator
                      </strong>
                      &mdash; The most significant change. The principal designer must be a designer
                      (an organisation or individual that carries out design work). This ensures the
                      person coordinating pre-construction health and safety has genuine design
                      competence and influence over design decisions.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Domestic clients brought into scope</strong>{' '}
                      &mdash; For the first time, domestic clients (people having construction work
                      done on their own home) are within the scope of CDM. However, their duties are
                      automatically transferred to the contractor (for single-contractor projects)
                      or principal contractor (for multi-contractor projects), so domestic clients
                      do not have to take active steps unless they choose to appoint a principal
                      designer or principal contractor themselves.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Notification threshold retained</strong>{' '}
                      &mdash; The same threshold applies: projects lasting more than 30 working days
                      with more than 20 workers simultaneously at any point, or exceeding 500
                      person-days. The F10 form is still used for notification.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Simpler structure</strong> &mdash; CDM 2015 has
                      a simpler, more logical structure than its predecessors. It is organised
                      around the five duty-holder roles: client, principal designer, designer,
                      principal contractor, and contractor. Each role has clear, specific duties.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400/60 flex-shrink-0" />
                    <span>
                      ...
                      anything they see that is likely to endanger their own or others&rsquo;
                      safety, and must cooperate with their employer and other duty holders.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">L153 guidance</strong> &mdash; CDM 2015 is
                      accompanied by L153, &ldquo;Managing Health and Safety in Construction&rdquo;.
                      L153 is the Approved Code of Practice and provides practical guidance. It
                      replaced L144 (which accompanied CDM 2007). L153 has special legal status:
                      failure to follow it can be used as evidence in court proceedings.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">
                        Competence replaced by skills, knowledge, experience, and organisational
                        capability
                      </strong>{' '}
                      &mdash; The formal &ldquo;competence assessment&rdquo; requirement of CDM 2007
                      was replaced by a requirement to ensure appointees have the skills, knowledge,
                      experience, and (for organisations) organisational capability to carry out the
                      work safely.
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-blue-400">Still in Force:</strong> CDM 2015 remains the
                  current legislation. There have been no amendments or replacements since it came
                  into force. All construction projects in Great Britain (England, Scotland, and
                  Wales) must comply with CDM 2015. Northern Ireland has its own equivalent
                  legislation, the Construction (Design and Management) Regulations (Northern
                  Ireland) 2016.
                </p>
              </div>
            </div>
            ...
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="overflow-hidden rounded-xl border border-white/10">
                <div className="bg-blue-500/10 border-b border-white/10 px-4 py-3">
                  <p className="text-sm font-semibold text-blue-400">
                    CDM 2007 vs CDM 2015 &mdash; Key Changes
                  </p>
                </div>
                <div className="divide-y divide-white/5">
                  {[
                    ...
                    },
                    {
                      ...
                      cdm2015:
                        'Brought into scope; duties transfer to contractor/principal contractor',
                    },
                    {
                      area: 'Worker duties',
                    ...
                    },
                    {
                      ...
                      cdm2015:
                        'Clearer, more prominent client duties including ensuring appointments are made',
                    },
                  ].map((row, i) => (
                    <div
                      key={i}
                      className="grid grid-cols-1 sm:grid-cols-3 gap-1 sm:gap-4 px-4 py-3"
                    >
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400/60 flex-shrink-0" />
                    <span>
                      The <strong className="text-white">CDM coordinator</strong> did not need to be
                      a designer. The role was often filled by health and safety consultants who
                      lacked design expertise and had no direct influence over design decisions.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400/60 flex-shrink-0" />
                    <span>
                      The <strong className="text-white">principal designer</strong> must be a
                      designer &mdash; an organisation or individual that prepares or modifies
                      designs, drawings, specifications, or bills of quantities relating to a
                      structure. This is a fundamental requirement.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400/60 flex-shrink-0" />
                    <span>
                      ...
                      pre-construction phase has{' '}
                      <strong className="text-white">
                        genuine design competence and the ability to influence design decisions
                      </strong>{' '}
                      to eliminate or reduce risk at source.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400/60 flex-shrink-0" />
                    <span>
                      The principal designer&rsquo;s duties include planning, managing, monitoring,
                      and coordinating health and safety in the pre-construction phase, and ensuring
                      that all designers comply with their duties under CDM 2015.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  ...
                  principal contractor (for construction phase duties) and the principal designer
                  (for pre-construction duties). A domestic client can choose to appoint a principal
          ...
          <div className="space-y-0">
            ...
            <div className="relative pl-8 pb-8 border-l-2 border-white/10 ml-3">
              ...
              <div className="bg-blue-500/5 border border-blue-500/20 rounded-xl p-4">
                ...
                <div className="mt-2 flex flex-wrap gap-1">
                  <span className="text-[10px] px-2 py-0.5 rounded-full bg-blue-500/20 text-blue-300/70">
                    CDM coordinator
                  </span>
                  <span className="text-[10px] px-2 py-0.5 rounded-full bg-blue-500/20 text-blue-300/70">
                    L144 ACoP
            ...
            <div className="relative pl-8 ml-3">
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 rounded-xl p-4">
                ...
                <div className="mt-2 flex flex-wrap gap-1">
                  <span className="text-[10px] px-2 py-0.5 rounded-full bg-blue-500/30 text-blue-200/80">
                    Principal designer
                  </span>
                  <span className="text-[10px] px-2 py-0.5 rounded-full bg-blue-500/30 text-blue-200/80">
                    Domestic clients
        ...
        <section className="mb-10">
          ...
          <div className="overflow-hidden rounded-xl border border-white/10">
            <div className="bg-blue-500/10 border-b border-white/10 px-4 py-3">
              <p className="text-sm font-semibold text-blue-400">
                How Key Roles Changed: 1994 &rarr; 2007 &rarr; 2015
              </p>
            </div>
            <div className="divide-y divide-white/5">
              {[
