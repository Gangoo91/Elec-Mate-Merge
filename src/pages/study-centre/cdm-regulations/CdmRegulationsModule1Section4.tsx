...
const faqs = [
  ...
  {
    question: 'Can a verbal appointment of a principal designer be considered valid?',
    answer:
  ...
  {
    question: 'As an electrician, do I need to worry about CDM if I am just a subcontractor?',
    answer:
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-blue-500/5 border-l-2 border-blue-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>CDM applies to ALL projects</strong> &mdash; no minimum size
              </li>
              <li>
                <strong>&gt;1 contractor:</strong> Must appoint PD + PC in writing
              </li>
              <li>
                <strong>Notifiable:</strong> &gt;30 days/20 workers OR &gt;500 person-days
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-blue-500/5 border-l-2 border-blue-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Domestic:</strong> Client duties transfer to contractor/PC
              </li>
              <li>
                <strong>Electrical:</strong> Rewires, new installs &amp; maintenance all count
              </li>
              <li>
                <strong>F10 form:</strong> Notify HSE &amp; display on site
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                <strong> every construction project</strong>, without exception. There is no minimum
                size, no minimum duration, no minimum number of workers, and no minimum cost. From
                hanging a single door to building a skyscraper, CDM applies.
              </p>

              <p>
                This is a deliberate design principle of the 2015 regulations. The previous CDM 2007
                regulations had a notification threshold but still applied to all projects &mdash;
                CDM 2015 simply made this explicit and removed any ambiguity. The regulations are
                intended to be applied <strong>proportionately</strong>, meaning the level of
                planning, management, and documentation expected is scaled to match the size,
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  light fitting in a small office still requires CDM awareness, but the
                  &ldquo;plan&rdquo; may simply be the electrician&rsquo;s own mental assessment of
                  the risks and the steps to control them.
                  <strong className="text-white">
                    {' '}
                    The regulations never require disproportionate bureaucracy for low-risk work.
                  </strong>
                </p>
              </div>
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  <em>
                    &ldquo;What level of CDM compliance is proportionate to this project?&rdquo;
                  </em>
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The simplest CDM scenario is a project where only <strong>one contractor</strong>{' '}
                carries out the construction work. This is common in electrical work &mdash; a
                single electrical contractor engaged to rewire a property, install a new
                distribution board, or carry out periodic testing and maintenance.
              </p>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-3">
                  Single Contractor Project Structure
                </p>
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Plan, manage, and monitor the construction work to ensure it is carried out
                      safely
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      <strong className="text-white">construction phase plan</strong> (CPP) before
                      work begins
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
              ...
              <p>
                Because there is only one contractor, there is no need to appoint a principal
                designer or principal contractor &mdash; those roles only exist to coordinate
                multiple duty holders. The single contractor effectively absorbs the coordination
                responsibilities.
              </p>
            </div>
          </div>
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                interface risks &mdash; one contractor&rsquo;s work can create hazards for another.
                CDM 2015 addresses this by requiring the client to appoint two key coordination
                roles.
              </p>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  . A verbal appointment is not valid.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 sm:p-6 rounded-lg">
                <p className="text-sm font-medium text-blue-400 mb-4 text-center">
                  Multi-Contractor Project Structure
                </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      PD and PC must be appointed <strong className="text-white">in writing</strong>{' '}
                      &mdash; verbal appointments are not valid
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      The PD must be an organisation or individual with{' '}
                      <strong className="text-white">
                        sufficient knowledge, experience, and ability
                      </strong>{' '}
                      for the role
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      The PC must have{' '}
                      <strong className="text-white">
                        the skills, knowledge, experience, and organisational capability
                      </strong>{' '}
                      to manage the construction phase safely
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      All contractors must <strong className="text-white">cooperate</strong> with
                      the PC and comply with site rules
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Certain larger projects must be{' '}
                <strong>notified to the Health and Safety Executive (HSE)</strong> before the
                construction phase begins. Notification is triggered when the project exceeds
                specific thresholds for duration and workforce size.
              </p>
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  <div className="bg-white/5 border border-white/10 p-4 rounded-lg text-center">
                    ...
                    <p className="text-sm text-white mt-2">
                      More than <strong>30 working days</strong> with more than{' '}
                      <strong>20 workers</strong> working simultaneously at any one time
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 p-4 rounded-lg text-center">
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      3 workers for 80 days = 240 person-days (not notifiable under this threshold)
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  and safety notice board where all workers can see it. The F10 can now be submitted
                  electronically via the HSE website.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                A <strong>domestic client</strong> is anyone who has construction work carried out
                on their own home (or the home of a family member) and who does not do so in
                connection with a business. Most homeowners commissioning electrical work are
                domestic clients. CDM 2015 still applies to domestic projects, but the regulations
                recognise that homeowners cannot reasonably be expected to understand and fulfil
                complex CDM duties.
              </p>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  planning, managing, and monitoring the work safely. You should still communicate
                  risks to the homeowner and ensure they understand any restrictions during the work
                  (e.g. areas of the house that must not be accessed). You are also responsible for
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Electrical installation, maintenance, and repair work falls squarely within the CDM
                definition of &ldquo;construction work&rdquo;. This means virtually every task an
                  ...
                  <div className="bg-blue-500/5 border border-blue-500/20 p-3 rounded-lg">
                    ...
                    <ul className="text-sm text-white/80 space-y-1">
                      ...
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          If you are the sole contractor: no PD/PC needed, but you hold all
                          contractor duties plus transferred client duties (if domestic)
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          If other trades are involved (plasterer, decorator): PD and PC must be
                  ...
                  <div className="bg-blue-500/5 border border-blue-500/20 p-3 rounded-lg">
                    ...
                    <ul className="text-sm text-white/80 space-y-1">
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          Typically part of a multi-contractor project (new build, extension,
                          refurbishment)
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                      ...
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          As a contractor, you must cooperate with the PC and follow site rules
                        </span>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="bg-blue-500/5 border border-blue-500/20 p-3 rounded-lg">
                    ...
                    <ul className="text-sm text-white/80 space-y-1">
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          Maintenance of electrical systems IS construction work under CDM
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          Periodic inspection and testing: CDM applies, but proportionately &mdash;
                          a brief risk assessment and safe system of work is usually sufficient
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          Ongoing maintenance contracts: each site visit is assessed individually
                        </span>
                      </li>
                    </ul>
                  </div>
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                <p className="text-sm font-medium text-blue-400 mb-3">
                  When Are PD/PC Appointments Needed for Electrical Work?
                </p>
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                projects. The following worked examples illustrate how CDM 2015 applies to a range
                of common scenarios that electricians encounter.
              </p>
                  ...
                  <div className="bg-blue-500/5 border border-blue-500/20 p-3 rounded-lg space-y-2">
                    ...
                    <div className="flex items-start gap-2 text-sm text-white/80">
                      ...
                      <span>
                        ...
                        days but only 15 workers (needs &gt;20 for threshold 1), and 15 &times; 40 =
                        600 person-days &mdash; wait, this IS notifiable under threshold 2 (&gt;500
                        person-days)
                      </span>
                    </div>
                    <div className="flex items-start gap-2 text-sm text-white/80">
                      ...
                      <span>
                        ...
                        writing, submits F10 to HSE, PC prepares construction phase plan, F10
                        displayed on site
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="bg-blue-500/5 border border-blue-500/20 p-3 rounded-lg space-y-2">
                    ...
                    <div className="flex items-start gap-2 text-sm text-white/80">
                      ...
                      <span>
                        ...
                        days and 5 workers (5 &times; 30 = 150 person-days)
                      </span>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="bg-blue-500/5 border border-blue-500/20 p-3 rounded-lg space-y-2">
                    ...
                    <div className="flex items-start gap-2 text-sm text-white/80">
                      ...
                      <span>
                        ...
                        safety file maintained, detailed construction phase plan, site inductions
                        for all workers
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="bg-blue-500/5 border border-blue-500/20 p-3 rounded-lg space-y-2">
                    ...
                    <div className="flex items-start gap-2 text-sm text-white/80">
                      ...
                      <span>
                        ...
                        system of work, pre-construction information from each client
                      </span>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="bg-blue-500/5 border border-blue-500/20 p-3 rounded-lg space-y-2">
                    ...
                    <div className="flex items-start gap-2 text-sm text-white/80">
                      ...
                      <span>
                        ...
                        CDM obligations &mdash; safety must not be compromised because the work is
                        &ldquo;urgent&rdquo;
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="bg-blue-500/5 border border-blue-500/20 p-3 rounded-lg space-y-2">
                    ...
                    <div className="flex items-start gap-2 text-sm text-white/80">
                      ...
                      <span>
                        ...
                        detailed planning, sequencing, and a construction phase plan that
                        specifically addresses the demolition methodology and service disconnections
                      </span>
                    </div>
                  </div>
                </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Despite CDM 2015 being in force for over a decade, many of the same mistakes are
                repeated across the construction industry. Understanding these common pitfalls helps
                you avoid them and ensure genuine compliance rather than a tick-box approach.
              </p>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-white/80">
                    ...
                    valid. The appointment must be a clear, written document identifying the role,
                    the appointee, and the scope. Without written appointments, duties default back
                    to the client, who often has no idea they are carrying them.
                  </p>
                </div>
                ...
                <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-white/80">
                    ...
                    HSE inspector visits &mdash; is a breach. The PD needs to be involved during the
                    design phase to influence design decisions and coordinate pre-construction
                    information. Appointing them after design is complete defeats the purpose.
                  </p>
                </div>
                ...
                <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-white/80">
                    ...
                    large commercial projects or projects that are notifiable. The proportionate
                    approach means small jobs need less paperwork, but the fundamental duties still
                    apply. Even replacing a single socket in a commercial property triggers CDM
                    &mdash; the compliance is simply proportionate to the risk.
                  </p>
                </div>
                ...
                <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-white/80">
                    ...
                    count all contractors and subcontractors towards the worker threshold, and not
                    updating the F10 when project details change (e.g. the PC is replaced, or the
                ...
                <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-white/80">
                    ...
                    in a folder, a health and safety file that nobody reads, and PD/PC appointments
                    that are made but never acted upon provides no real protection. CDM is about{' '}
                    <strong className="text-white">actively managing risks</strong> &mdash; the
                    documents should reflect real planning, real communication, and real
                    coordination. An inspector will quickly identify whether compliance is genuine
                    or merely documentary.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 rounded-lg overflow-hidden">
                <div className="bg-blue-500/10 border-b border-white/10 p-3">
                  <div className="flex items-center gap-2">
                    <ClipboardList className="h-5 w-5 text-blue-400" />
                    <p className="text-sm font-medium text-blue-400">
                      Project Type Requirements Comparison
                    </p>
                  </div>
                </div>
                ...
                {[
                  ...
                  {
                    item: 'Construction phase plan',
                    single: 'Yes*',
                    multi: 'Yes',
                    notifiable: 'Yes (detailed)',
                  },
                  {
                    item: 'F10 notification to HSE',
                    single: 'No',
                    multi: 'Only if thresholds met',
                    notifiable: 'Yes',
                  },
                  {
                    item: 'F10 displayed on site',
                    single: 'No',
                    multi: 'Only if notifiable',
                    notifiable: 'Yes',
                  },
                  {
                    item: 'Health and safety file',
                    single: 'No**',
                    multi: 'Yes (PD maintains)',
                    notifiable: 'Yes (PD maintains)',
                  },
                  {
                    item: 'Pre-construction information',
                    single: 'Yes',
                    multi: 'Yes',
                    notifiable: 'Yes',
                  },
