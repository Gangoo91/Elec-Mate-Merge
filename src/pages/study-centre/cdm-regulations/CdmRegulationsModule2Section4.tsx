...
export default function CdmRegulationsModule2Section4() {
  useSEO({
    ...
    description:
      'Designer duties under Regulation 9, contractor duties under Regulation 15, worker duties under Regulation 14(2), electricians as designers, multiple CDM roles, competence and training under CDM 2015.',
  });
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-blue-500/5 border-l-2 border-blue-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Designer:</strong> Anyone who prepares or modifies a design
              </li>
              <li>
                <strong>Contractor:</strong> Anyone who carries out or manages construction work
              </li>
              <li>
                <strong>Worker:</strong> Must cooperate, report hazards, take care
              </li>
              <li>
                <strong>Multiple roles:</strong> One person can hold several CDM roles
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-blue-500/5 border-l-2 border-blue-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Know your role:</strong> You may be a designer without realising it
              </li>
              <li>
                <strong>Plan first:</strong> Never start construction work without a plan
              </li>
              <li>
                <strong>Speak up:</strong> Report unsafe conditions immediately
              </li>
              <li>
                <strong>Competence:</strong> Ensure you have the skills for the task
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                CDM 2015 defines a designer very broadly. A{' '}
                <strong>
                  designer is any person (including a client, contractor, or other person referred
                  to in the regulations) who in the course of a business prepares or modifies a
                  design relating to a structure
                </strong>
                , or who arranges for or instructs any person under their control to do so.
              </p>

              <p>
                The word &ldquo;design&rdquo; in the regulations includes{' '}
                <strong>drawings, design details, specifications, and bills of quantities</strong>{' '}
                (including the specification of articles or substances) relating to a structure.
                This is deliberately wide &mdash; it captures far more people than just architects
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Architects</strong> &mdash; who design the
                      overall building layout and form
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Structural engineers</strong> &mdash; who
                      design foundations, steelwork, and load-bearing elements
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Building services engineers</strong> &mdash;
                      who design heating, ventilation, electrical, and plumbing systems
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Electricians</strong> &mdash; who specify cable
                      routes, equipment layouts, and distribution board configurations
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Interior designers</strong> &mdash; who specify
                      materials, finishes, and layouts that affect the structure
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Quantity surveyors</strong> &mdash; when they
                      specify particular materials or products in bills of quantities
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Temporary works coordinators</strong> &mdash;
                      who design scaffolding, formwork, and temporary supports
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <p>
                The key test is whether a person{' '}
                <strong>makes decisions about a design that could affect health and safety</strong>.
                It does not matter whether &ldquo;designer&rdquo; appears in their job title. A
                tradesperson who decides where to run a cable, which fixings to use, or how to
                configure a system is making design decisions &mdash; and CDM treats them as a
                designer.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 rounded-lg overflow-hidden">
                <div className="bg-blue-500/20 border-b border-blue-500/30 px-4 py-3">
                  <p className="text-sm font-semibold text-blue-400">
                    Designer Decision Flowchart &mdash; Am I a Designer?
                  </p>
                </div>
                <div className="p-4 space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="text-sm text-white">
                      ...
                      <p className="mt-1">
                        If <strong className="text-green-400">YES</strong> &rarr; proceed to step 2.
                        If <strong className="text-red-400">NO</strong> &rarr; you are probably not
                        a designer.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div className="text-sm text-white">
                      ...
                      <p className="mt-1">
                        If <strong className="text-green-400">YES</strong> &rarr; proceed to step 3.
                        If <strong className="text-red-400">NO</strong> &rarr; CDM does not apply.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div className="text-sm text-white">
                      ...
                      <p className="mt-1">
                        If <strong className="text-green-400">YES</strong> &rarr; proceed to step 4.
                        If <strong className="text-red-400">NO</strong> &rarr; you are not a
                        designer under CDM.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div className="text-sm text-white">
                      ...
                      <p className="mt-1">
                        If <strong className="text-green-400">YES</strong> &rarr;{' '}
                        <strong className="text-blue-400">
                          You are a designer under CDM 2015.
                        </strong>{' '}
                        Regulation 9 duties apply to you.
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                <strong>Regulation 9</strong> sets out the duties of designers. The core principle
                is that designers must take account of the{' '}
                <strong>general principles of prevention</strong> when preparing or modifying a
                design. This means thinking about health and safety from the very start &mdash; not
                ...
                <div className="space-y-4 text-sm text-white">
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        ...
                        <strong className="text-white">eliminate hazards</strong> that could give
                        rise to risks to health and safety. This is always the first and best
                        option. Can the design be changed so the hazard does not exist at all?
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        ...
                        <strong className="text-white">reduce them</strong> so far as is reasonably
                        practicable by incorporating features or measures into the design. For
                        example, specifying pre-fabricated components that reduce the amount of work
                        at height.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        Where risks cannot be eliminated or adequately reduced by design alone,{' '}
                        <strong className="text-white">provide information</strong> to other duty
                        holders (the client, principal designer, contractors) about the remaining
                        risks so they can plan appropriate control measures.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <p>
                ...
                means thinking about health and safety not only during construction but also during
                the <strong>future use and maintenance</strong> of the building.
              </p>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  reducing it. A design that requires working at height is not automatically a
                  failure &mdash; but a design that requires working at height when there is a
                  practical alternative at ground level would be a breach of Regulation 9.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                One of the most significant &mdash; and frequently overlooked &mdash; aspects of CDM
                2015 is that <strong>electricians regularly act as designers</strong>
                without realising it. Whenever an electrician makes a decision that shapes how
                electrical work will be installed, they are preparing or modifying a design under
                the regulations.
              </p>
                ...
                <div className="space-y-3 text-sm text-white">
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        Deciding where cables will run &mdash; through voids, along cable trays, in
                        trunking, through walls or floors. These decisions affect who needs to work
                        in confined spaces, at height, or near existing services.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        Choosing which distribution boards, protective devices, accessories, and
                        containment systems to use. The weight, size, and installation requirements
                        of equipment affect manual handling and working-at-height risks.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        Configuring the layout of circuits, protective devices, and connections
                        within a distribution board. A poorly planned layout can create long-term
                        maintenance hazards and increase the risk of electrical faults.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        Creating drawings showing the positions of sockets, switches, luminaires,
                        and other accessories. These drawings are &ldquo;designs&rdquo; within the
                        meaning of CDM and carry designer duties.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        Deciding how cables will be fixed, what type of containment to use, and how
                        connections will be made. These decisions directly affect installation
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Think about buildability:</strong> When you
                      design a cable route, consider whether it can be installed safely. Does it
                      require working at height? Could the route be changed to avoid confined spaces
                      or hazardous areas?
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Think about maintenance:</strong> Will future
                      electricians be able to access the installation safely for testing,
                      fault-finding, and modifications? A cable route through a difficult-to-reach
                      void may be easy to install now but dangerous to maintain later.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Document your decisions:</strong> If you
                      identify residual risks that cannot be eliminated or reduced by your design,
                      communicate them. Note them on drawings, in specifications, or in the health
                      and safety file.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Cooperate with the principal designer:</strong>{' '}
                      On notifiable projects, the principal designer coordinates design health and
                      safety. Share information about your design decisions and any risks you have
                      identified.
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  lamp change. By redesigning the installation to use{' '}
                  <strong className="text-white">winch-lowerable luminaires</strong>, the
                  electrician eliminates the need for work at height during maintenance. This is
                  &ldquo;designing out risk&rdquo; under Regulation 9 &mdash; and it is exactly what
                  CDM expects designers to do.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Under CDM 2015, a{' '}
                <strong>
                  contractor is any person who, in the course or furtherance of a business, carries
                  out, manages, or controls construction work
                </strong>
                . Like the definition of &ldquo;designer&rdquo;, this is deliberately broad.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <div className="space-y-2 text-sm text-white">
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Main contractors</strong> &mdash; the
                      organisation with the primary contract to carry out the construction work
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Sub-contractors</strong> &mdash; organisations
                      or individuals engaged by the main contractor or another sub-contractor to
                      carry out specific packages of work
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Self-employed tradespeople</strong> &mdash;
                      individuals working on their own account who carry out construction work
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Labour-only sub-contractors</strong> &mdash;
                      individuals or agencies who supply workers to carry out construction work
                    </span>
                  </div>
                </div>
              </div>
              ...
              <p>
                CDM draws{' '}
                <strong>no distinction between the main contractor and sub-contractors</strong> when
                it comes to contractor duties. All contractors have the same legal obligations under
                Regulation 15, regardless of where they sit in the contractual chain.
              </p>
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1.5">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Skills</strong> &mdash; the practical abilities
                      needed for the work
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Knowledge</strong> &mdash; understanding of the
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Experience</strong> &mdash; relevant track
                      record in similar work
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Organisational capability</strong> &mdash; for
                      organisations, the capacity to manage the work safely (sufficient resources,
                      management systems, supervision)
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  standard contractor duties. This applies to many smaller electrical projects where
                  the electrician is the only person carrying out construction work. Understanding
                  this is crucial &mdash; you may have more responsibilities than you think on a
                  small job.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                <strong>Regulation 15</strong> sets out the duties that apply to every contractor on
                a CDM project. These duties apply to{' '}
                <strong>all contractors, all sub-contractors, and all self-employed people</strong>{' '}
                carrying out construction work &mdash; regardless of the size of the project.
              </p>
                ...
                <div className="space-y-4 text-sm text-white">
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        Plan, manage, and monitor construction work carried out by them or under
                        their control so that it is carried out without risks to health and safety,
                        so far as is reasonably practicable.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        Not carry out construction work on a project unless satisfied that the
                        client is aware of their duties and that a{' '}
                        <strong className="text-white">construction phase plan (CPP)</strong> is in
                  ...
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        Provide each worker under their control with appropriate{' '}
                        <strong className="text-white">
                          supervision, instructions, and information
                        </strong>{' '}
                        so that construction work can be carried out without risks to health and
                        safety.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        Ensure that no work is started unless there are{' '}
                        <strong className="text-white">reasonable steps</strong> to prevent access
                        by unauthorised persons to the construction site.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        ...
                        <strong className="text-white">welfare facilities</strong> are provided for
                        workers from the start of and throughout the construction phase. This
                        includes toilets, washing facilities, rest areas, and drinking water.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        Cooperate with the principal contractor (on projects with more than one
                        contractor), comply with directions given by the principal contractor or
                        principal designer, and comply with parts of the CPP relevant to their work.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-blue-400">Important:</strong> The duty to check that the
                  client is aware of their responsibilities and that a CPP exists applies to{' '}
                  <strong>every contractor</strong>, not just the principal contractor. If you
                  arrive on site and discover there is no construction phase plan, you have a duty
                  not to begin work until one is in place.
                </p>
              </div>
              ...
              <p>
                ...
                &mdash; it includes{' '}
                <strong>
                  toolbox talks, site-specific inductions, task briefings, and on-the-job
                  instruction
                </strong>
                . The training must be proportionate to the risk and the worker&rsquo;s existing
                level of competence.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1.5 mt-2">
                  ...
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-blue-400 mt-0.5 flex-shrink-0" />
                    <span>
                      Do my workers have the right information, instruction, and training?
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-blue-400 mt-0.5 flex-shrink-0" />
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                <strong>Regulation 14(2)</strong> places specific duties on every worker involved in
                a construction project. These duties apply to
                <strong> all workers</strong> &mdash; whether they are employees, sub-contractors,
                self-employed, or agency workers. The duties are personal and cannot be delegated.
              </p>
                ...
                <div className="space-y-4 text-sm text-white">
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        A worker must report to the person on whose behalf they are working anything
                        which they are aware is likely to{' '}
                        <strong className="text-white">
                          endanger their own health or safety or that of others
                        </strong>
                        . This includes unsafe conditions, defective equipment, near misses, and any
                        situation that could lead to harm.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        A worker must <strong className="text-white">cooperate</strong> with any
                        person working on the project who is carrying out duties under CDM or any
                        other health and safety legislation. This means following reasonable
                        instructions, attending briefings, and working constructively with site
                        management.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="text-white font-medium">
                        Not Misuse Anything Provided for H&amp;S
                      </p>
                      <p>
                        A worker must not{' '}
                        <strong className="text-white">interfere with or misuse</strong> anything
                        provided in the interests of health, safety, or welfare. This includes PPE,
                        safety barriers, warning signs, fire extinguishers, first aid equipment, and
                        welfare facilities.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        A worker must take <strong className="text-white">reasonable care</strong>{' '}
                        of their own health and safety and that of others who may be affected by
                        their actions or omissions at work. This is a personal duty &mdash; you
                        cannot blame someone else for your own unsafe behaviour.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  or ought to have known that the action was dangerous. If you are instructed to
                  carry out work that you believe is unsafe, you have a{' '}
                  <strong className="text-white">duty to refuse and report it</strong>, not a duty
                  to comply.
                </p>
              </div>
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  ...
                  effective safety improvements on construction sites come from workers reporting
                  issues &mdash; a loose scaffold fitting, a missing edge protection board, a
                  blocked fire exit. CDM formalises what good tradespeople have always done: look
                  out for each other and speak up when something is not right.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                CDM 2015 explicitly recognises that{' '}
                <strong>one person or organisation can hold more than one duty holder role</strong>{' '}
                on a project. This is common in practice, particularly on smaller projects and in
                ...
                <div className="space-y-3 text-sm text-white">
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        Acts as both <strong className="text-white">designer</strong> and{' '}
                        <strong className="text-white">contractor</strong>. If they are also the
                        only or main contractor on a multi-contractor project, they may also be the{' '}
                        <strong className="text-white">principal contractor</strong>. Three sets of
                        duties apply.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        An electrician who designs the installation, carries out the work, and is
                        the only contractor on the project acts as{' '}
                        <strong className="text-white">designer</strong>,{' '}
                        <strong className="text-white">contractor</strong>, and{' '}
                        <strong className="text-white">principal contractor</strong> (since there is
                        only one contractor).
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="text-white font-medium">
                        Architect as Principal Designer and Designer
                      </p>
                      <p>
                        An architect appointed as principal designer also has designer duties for
                        their own design work. They must fulfil{' '}
                        <strong className="text-white">principal designer duties</strong>{' '}
                        (Regulation 11) and <strong className="text-white">designer duties</strong>{' '}
                        (Regulation 9) concurrently.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        A client (e.g., a property developer) who also has their own construction
                        workforce acts as both <strong className="text-white">client</strong> and{' '}
                        <strong className="text-white">contractor</strong>. Both sets of duties
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="mt-3 bg-blue-500/10 border border-blue-500/30 p-3 rounded-lg">
                      <p className="text-xs text-white text-center">
                        ...
                        + Contractor + Principal Contractor. All duties stack.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-blue-400">Critical Point:</strong> When duties stack, they
                  do <strong>not</strong> merge, cancel each other out, or reduce. Every duty
                  attached to every role must be fulfilled in full. A design-and-build principal
                  contractor has the <em>most</em> duties of any party on the project, because they
                  hold three roles simultaneously.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                CDM 2015 requires that anyone appointed to carry out work on a construction project
                has the{' '}
                <strong>
                  skills, knowledge, experience, and (where relevant) organisational capability
                </strong>{' '}
                necessary for the work. This applies to designers, contractors, principal designers,
                and principal contractors alike.
              </p>

              <p>
                Crucially, the regulations{' '}
                <strong>do not specify particular qualifications or competence schemes</strong>.
                There is no list of required certificates, no mandatory card scheme, and no
                prescribed training course. Instead, CDM takes a{' '}
                <strong>outcomes-based approach</strong>: the question is whether the person is
                genuinely capable of doing the work safely, not whether they hold a particular piece
                of paper.
              </p>
                ...
                <div className="space-y-4 text-sm text-white">
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        The practical abilities needed for the work. For an electrician, this
                        includes the hands-on skills to carry out wiring, testing, and commissioning
                        safely and correctly. Skills are typically developed through formal training
                        and practice.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        Understanding of the relevant regulations, standards, risks, and control
                        measures. For CDM purposes, this includes knowledge of the specific hazards
                        associated with the type of construction work being undertaken &mdash; not
                        just general health and safety awareness.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        A relevant track record in similar work. A newly qualified person may have
                        the skills and knowledge but lack the experience to recognise unusual risks
                        or make sound judgements in unfamiliar situations. Experience can be built
                        through supervised work and mentoring.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        For organisations (not individuals), the capacity to manage the work safely.
                        This includes having adequate resources (people, equipment, time),
                        management systems for health and safety, supervision arrangements, and
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white mb-3">
                  ...
                  are widely used across the UK construction industry as evidence of competence.
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Not mandatory under CDM</strong> &mdash; the
                      regulations do not require any specific card or certification scheme
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Evidence, not proof</strong> &mdash; holding a
                      card provides evidence of competence but does not guarantee it. A worker who
                      holds a card but lacks the specific skills for the task at hand is not
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Industry standard</strong> &mdash; while not a
                      legal CDM requirement, cards are a de facto requirement on most commercial
                      construction sites. The Major Contractors Group and Build UK both require CSCS
                      cards for site access
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Part of the picture</strong> &mdash; a CSCS/ECS
                      card should be considered alongside references, qualifications, method
                      statements, and previous work history when assessing competence
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1.5">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Formal CPD</strong> &mdash; structured courses,
                      seminars, conferences, and qualifications
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Informal CPD</strong> &mdash; reading trade
                      publications, attending manufacturer briefings, learning from colleagues,
                      self-study
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">On-the-job learning</strong> &mdash; exposure
                      to new types of work, mentoring, supervised practice on unfamiliar tasks
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">ECS card renewal</strong> &mdash; requires
                      evidence of CPD and a current health and safety test, helping to ensure
                      ongoing competence
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  incompetent, the client has failed in their duty. If a principal contractor
                  appoints a sub-contractor who lacks the necessary skills, the principal contractor
                  has failed. Asking for a CSCS card is not enough &mdash; the appointer must make{' '}
                  <strong className="text-white">reasonable enquiries</strong> to satisfy themselves
                  that the appointee is genuinely capable.
                </p>
              </div>
            </div>
          </div>
