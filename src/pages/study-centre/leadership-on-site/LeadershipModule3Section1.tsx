...
const quizQuestions = [
  ...
  },
  {
    id: 3,
    question:
      'Which of the following is the LEAST effective delivery technique for a toolbox talk?',
    options: [
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      "The recommended duration for a toolbox talk is 10-15 minutes. This provides sufficient time for an opening hook, delivery of key points (maximum 3), discussion, and agreed action items without losing the audience's attention.",
  },
  {
    id: 5,
    question:
  ...
  },
  {
    id: 8,
    question:
      'Which of the following best describes the relationship between toolbox talks and formal training?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'Toolbox talks complement formal training — they do not replace it. Formal training provides comprehensive knowledge and qualifications, while toolbox talks reinforce key messages, address site-specific issues, and keep safety awareness current. Both are required under CDM 2015.',
  },
];
...
export default function LeadershipModule3Section1() {
  useSEO({
    ...
    description:
      'How to plan, deliver, and record effective toolbox talks and site briefings that engage your team and meet CDM 2015 requirements.',
  });
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-rose-500/5 border-l-2 border-rose-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Purpose:</strong> Brief, educate, engage, and build team cohesion
              </li>
              <li>
                <strong>Duration:</strong> 10&ndash;15 minutes, maximum 3 key points
              </li>
              <li>
                <strong>Legal basis:</strong> CDM 2015 &amp; CITB/SSSTS requirements
              </li>
              <li>
                <strong>Key fact:</strong> A good toolbox talk can prevent accidents
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-rose-500/5 border-l-2 border-rose-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Planning:</strong> Relevant topic, structured delivery, real examples
              </li>
              <li>
                <strong>Engagement:</strong> Interactive techniques beat reading from a sheet
              </li>
              <li>
                <strong>Recording:</strong> Date, topic, attendees, actions &mdash; legally required
              </li>
              <li>
                <strong>Follow-up:</strong> Track actions, identify training needs
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-rose-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The toolbox talk is the{' '}
                <strong>most regular leadership communication touchpoint</strong> on any
                construction site. It is your chance &mdash; often the only structured chance in a
                busy working day &mdash; to brief your team, educate them on hazards, engage them in
                safety thinking, and build the cohesion that turns a group of individuals into a
                functioning team.
              </p>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-base text-white leading-relaxed">
                  CITB and SSSTS require regular toolbox talks as part of competent site
                  supervision. CDM 2015 places a legal duty on duty holders to provide{' '}
                  <strong>information, instruction, and training</strong> to workers. Toolbox talks
                  are the primary mechanism for delivering ongoing instruction on site. They are not
                  optional &mdash; they are a legal obligation.
                </p>
              </div>

              <p>
                A good toolbox talk can <strong>prevent accidents</strong>. When a supervisor takes
                ten minutes to brief the team on the specific hazards of that day&rsquo;s work
                &mdash; the overhead power line near the excavation, the fragile roof on the
                adjacent building, the change to the traffic management plan &mdash; workers are
                forewarned and forearmed. They know what to watch for, what to avoid, and what to do
                if something goes wrong.
              </p>

              <p>
                A bad toolbox talk, by contrast,{' '}
                <strong>wastes everyone&rsquo;s time and breeds cynicism</strong>. When a supervisor
                reads monotonously from a generic sheet, covers topics that bear no relation to the
                actual work, and asks &ldquo;Any questions?&rdquo; into dead silence before sending
                everyone back to work, the message received is clear: this is a tick-box exercise.
                Nobody is listening. Nobody cares. And the next time there is a real hazard to
                communicate, the team will have already learned to tune out.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  communicate changes, and demonstrate that you take your team&rsquo;s safety
                  seriously. Workers judge their supervisors partly on how they run these talks. A
                  well-prepared, engaging toolbox talk builds respect and credibility. A lazy one
                  destroys it.
                </p>
              </div>
            </div>
          ...
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                <strong> preparation</strong>. You do not need to spend hours planning, but you do
                need to think about what you are going to say before you say it.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Recent near-miss?</strong> &mdash; A near-miss
                      last week is the most compelling topic imaginable. It happened here, to us,
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Upcoming hazard?</strong> &mdash; If a new
                      phase of work starts tomorrow with different risks, brief the team today.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Seasonal issue?</strong> &mdash; Winter brings
                      ice, dark mornings, and cold-related risks. Summer brings heat stress and UV
                      exposure.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">New regulation?</strong> &mdash; Changes to
                      standards, site rules, or industry guidance need communicating to the team.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <div className="text-sm text-white space-y-2">
                  ...
                  <p>
                    <strong className="text-white">2. Key points (max 3)</strong> &mdash; the core
                    message. What do you need people to know and do? Keep it focused.
                  </p>
                  <p>
                    <strong className="text-white">3. Discussion</strong> &mdash; open the floor.
                    Ask questions. Get input. This is where engagement happens.
                  </p>
                  <p>
                    <strong className="text-white">4. Action items</strong> &mdash; clear, specific
                    actions. Who does what, by when? This turns talk into results.
                  </p>
                </div>
              </div>

              <p>
                Keep to <strong>10&ndash;15 minutes</strong>. Use props, photos, or physical
                examples where possible &mdash; showing the damaged cable is more powerful than
                describing it.
                <strong> Do not just read from a sheet</strong>. Prepare your key points, but do not
                script every word. If you are reading, you are not making eye contact, and if you
                are not making eye contact, you have already lost them.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                You can have the best content in the world, but if the delivery is poor, the message
                will not land. Delivery is not about being a polished public speaker &mdash; it is
                about being clear, confident, and connected to your audience.
              </p>
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">
                        Stand where everyone can see and hear you
                      </strong>{' '}
                      &mdash; not behind a pillar, not with your back to the sun, not next to noisy
                      machinery. Position yourself so the whole group can make eye contact with you.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Make eye contact</strong> &mdash; scan the
                      group. Look at individuals, not at the floor or your notes. Eye contact
                      signals confidence and creates connection.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Use names</strong> &mdash; &ldquo;What do you
                      think, Steve?&rdquo; is more engaging than &ldquo;Does anyone have a
                      view?&rdquo;. Using names shows you know your team and value their input.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Speak clearly</strong> &mdash; project your
                      voice. On a construction site with background noise, mumbling means nobody
                      hears you.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Vary your pace</strong> &mdash; slow down for
                      important points. Pause after key statements to let them land. A monotone
                      delivery sends people to sleep.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Use real examples</strong> &mdash; stories from
                      your own experience are more compelling than abstract facts. &ldquo;I once saw
                      a lad drop a cable drum on his foot because...&rdquo; beats any textbook.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  point.
                  <strong className="text-white"> Do not just plough on regardless.</strong> The
                  ability to read your audience and adjust is what separates a good communicator
                  from someone who merely talks at people.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                This is the biggest challenge. Construction workers have heard{' '}
                <strong>hundreds of toolbox talks</strong> over the course of their careers. Many
                have learned to stand quietly, nod in the right places, and switch off mentally
                while appearing to listen. Breaking through that barrier requires deliberate effort
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm text-white">
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    ...
                    <p>
                      &ldquo;Who has ever had a near-miss with manual handling?&rdquo; &mdash; gets
                      physical involvement. People who raise a hand are now mentally engaged.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    <p className="text-white font-medium mb-1">Case Studies</p>
                    <p>
                      Present a real scenario: &ldquo;A spark on another site did X. What went
                      wrong? What should he have done?&rdquo; &mdash; gets people thinking
                      critically.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    ...
                    <p>
                      Describe a situation and ask the team how they would handle it. No right or
                      wrong answer &mdash; just discussion. This reveals knowledge gaps and builds
                      confidence.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    ...
                    <p>
                      Get someone to demonstrate the correct technique, or show a piece of damaged
                      equipment. Physical props make abstract concepts tangible and memorable.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  &mdash; the rest of the team listens differently. Peer-to-peer communication is
                  often more credible than top-down instruction. It also develops the
                  presenter&rsquo;s leadership skills and demonstrates trust.
                </p>
              </div>

              <p>
                Above all, make the talk <strong>relevant to today&rsquo;s work</strong>. A generic
                talk about slips, trips, and falls is far less impactful than &ldquo;Right,
                we&rsquo;ve got wet conditions on the second floor today because the roof
                isn&rsquo;t on yet. Here&rsquo;s what I need everyone to watch out for.&rdquo;
                Relevance creates urgency. Urgency creates attention.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="border-l-2 border-amber-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                information, instruction, and training appropriate to the work they are carrying
                out. Toolbox talk records are a primary piece of evidence for this.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Date and time</strong> of the toolbox talk
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Topic covered</strong> and a brief summary of
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Attendee names and signatures</strong> &mdash;
                      confirms who received the information
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Any actions raised</strong> &mdash; issues
                      flagged, questions asked, follow-up items
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Name of the presenter</strong> delivering the
                      talk
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  Report back at the next talk: &ldquo;Last week Steve raised the issue with the
                  scaffold access. I spoke to the scaffolder and it&rsquo;s been fixed.&rdquo; This
                  shows your team that their input matters and that toolbox talks lead to real
                  change.
                </p>
              </div>
            </div>
            ...
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <ul className="text-sm text-white space-y-2">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong className="text-white">Purpose:</strong> Toolbox talks brief, educate,
                    engage, and build team cohesion &mdash; they are the most regular leadership
                    touchpoint on site
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Planning:</strong> Choose a relevant, timely
                    topic. Structure with hook, key points (max 3), discussion, and actions. Keep to
                    10&ndash;15 minutes
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Delivery:</strong> Eye contact, use names, speak
                    clearly, vary pace, use real examples. Never just read from a sheet
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Engagement:</strong> Vary format, use interactive
                    techniques, involve team members as presenters, make it relevant to
                    today&rsquo;s work
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Records:</strong> Date, topic, key points,
                    attendees, actions &mdash; legally required under CDM 2015
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Follow-up:</strong> Always follow up on actions
                    raised. Report back at the next talk. This builds trust and credibility
                  </span>
                </li>
              </ul>
