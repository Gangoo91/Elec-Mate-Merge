...
const quickCheckQuestions = [
  ...
  },
  {
    id: 'trust-equation',
    question:
      "In the Trust Equation from 'The Trusted Advisor' (Maister, Green, Galford), which factor sits in the denominator and REDUCES trustworthiness when it increases?",
    options: [
...
const quizQuestions = [
  {
    id: 1,
    question:
      'Patrick Lencioni identifies five dysfunctions of a team. Which dysfunction sits at the base of the pyramid, undermining all others?',
    options: [
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      "Servant leadership means the leader's primary purpose is to serve the needs of their team — providing direction, removing obstacles, developing skills, and creating conditions for success. It does not mean being passive or avoiding accountability. A servant leader still makes tough calls but does so with the team's welfare as the primary focus.",
  },
  {
    id: 5,
    question: 'What is the key difference between positional authority and earned respect?',
...
export default function LeadershipModule2Section1() {
  useSEO({
    ...
    description:
      'Why trust is the foundation of effective leadership on site, how to build and maintain trust, the difference between positional authority and earned respect, and servant leadership principles.',
  });
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <header className="text-center mb-12">
          ...
          <p className="text-white text-sm sm:text-base max-w-2xl mx-auto">
            Why trust is the foundation of all effective leadership, how it is built and destroyed,
            and the difference between demanding compliance and earning genuine respect
          </p>
        </header>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-rose-500/5 border-l-2 border-rose-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Foundation:</strong> Trust is the base of all team performance (Lencioni)
              </li>
              <li>
                <strong>Equation:</strong> Credibility + Reliability + Intimacy / Self-Orientation
              </li>
              <li>
                <strong>Key fact:</strong> Trust takes months to build, seconds to destroy
              </li>
              <li>
                <strong>On site:</strong> Without trust, people won&rsquo;t report hazards or admit
                mistakes
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-rose-500/5 border-l-2 border-rose-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Earned respect:</strong> Gets people&rsquo;s best effort, not just
                compliance
              </li>
              <li>
                <strong>Servant leadership:</strong> Your role is to serve the team, not the reverse
              </li>
              <li>
                <strong>First 90 days:</strong> Critical window when trust is established or lost
              </li>
              <li>
                <strong>Lead from front:</strong> Be visible, available, and willing to graft
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-rose-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Without trust, nothing else in leadership works. You can have the best technical
                knowledge, the most efficient programme, and the clearest plans &mdash; but if your
                team does not trust you, none of it will translate into performance. Trust is not a
                &ldquo;soft skill&rdquo; or a nice-to-have. It is the{' '}
                <strong>operational foundation</strong> upon which every other leadership capability
                is built.
              </p>

              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                <p className="text-sm font-medium text-rose-400 mb-2">
                  Lencioni&rsquo;s Five Dysfunctions of a Team
                </p>
                <p className="text-base text-white leading-relaxed">
                  Patrick Lencioni&rsquo;s influential model identifies{' '}
                  <strong>absence of trust</strong> as the foundational dysfunction &mdash; the base
                  of a pyramid. Without trust, teams cannot engage in productive conflict, commit to
                  decisions, hold each other accountable, or focus on collective results. Every
                  dysfunction above depends on solving the one below it.
                </p>
              </div>

              <p>
                On a construction site, trust is directly linked to <strong>safety</strong>. If
                people do not trust their supervisor, they will not speak up about hazards they have
                spotted. They will not admit when they have made a mistake. They will not ask for
                help when they are unsure. They will not raise concerns about unrealistic
                timescales. Every one of these silences creates risk &mdash; risk of injury, risk of
                defective work, risk of costly rework.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong>Open communication</strong> &mdash; people tell you problems early,
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Safety reporting</strong> &mdash; near misses and hazards get flagged,
                      not hidden
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Honest feedback</strong> &mdash; your team will tell you when a plan
                      is not working
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Collaboration</strong> &mdash; people help each other rather than
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Discretionary effort</strong> &mdash; people go beyond the minimum
              ...
              <p>
                Research by Google&rsquo;s Project Aristotle &mdash; a major study into what makes
                teams effective &mdash; found that <strong>psychological safety</strong> (a concept
                closely related to trust) was the single most important factor in team performance.
                Teams where members felt safe to take risks and be vulnerable outperformed those
                with more talent but less trust.
              </p>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-3">
                  Lencioni&rsquo;s Five Dysfunctions &mdash; The Pyramid
                </p>
              ...
              <p>
                ...
                <strong> the</strong> priority. Everything else &mdash; delegation, motivation,
                feedback, communication, performance management &mdash; depends on it. A team
                without trust is not really a team at all. It is a group of individuals who happen
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Trust is earned through <strong>consistent actions over time</strong>, not through
                words, announcements, or job titles. You cannot declare yourself trustworthy. You
                demonstrate it through hundreds of small interactions, day after day, until the
                pattern becomes clear to those around you.
              </p>
              ...
              <p>
                ...
                <strong> denominator</strong>. Even if your credibility, reliability, and intimacy
                are all high, excessive self-focus will divide them all down. A supervisor who is
                clearly focused on their own career, their own comfort, or their own reputation will
                struggle to earn trust no matter how competent they are.
              </p>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-3">
                  Key Trust-Building Behaviours on Site
                </p>
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Keep promises</strong> &mdash; even small ones. If you say you will
                      chase the materials order, chase it. Every kept promise is a deposit in the
                      trust bank.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Be consistent</strong> &mdash; apply the same standards to everyone,
                      including yourself. Nothing destroys trust faster than double standards.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Admit mistakes</strong> &mdash; saying &ldquo;I got that wrong&rdquo;
                      shows strength, not weakness. It gives permission for others to be honest too.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Share credit</strong> &mdash; when the job goes well, credit the team
                      publicly. Take the blame privately when things go wrong.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Back your team</strong> &mdash; defend your people when they are
                      challenged unfairly. A supervisor who throws their team under the bus will
                      never be trusted.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Be transparent</strong> &mdash; explain the reasons behind decisions.
                      People do not need to agree with every decision, but they need to understand
                      the reasoning.
                    </span>
                  </li>
                </ul>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                You can demand compliance, but you cannot demand respect. This is one of the most
                important distinctions in leadership. <strong>Positional authority</strong> &mdash;
                the power that comes from your job title &mdash; can get people to do the minimum.{' '}
                <strong>Earned respect</strong>
              ...
              <p>
                On a construction site, the difference is stark. Consider two supervisors: one who
                sits in the cabin issuing instructions, never picks up a tool, and pulls rank when
                challenged. The other who is on the tools alongside the team when needed, helps
                carry materials without being asked, knows every person&rsquo;s name, and earns the
                right to lead through visible competence and fairness. Which one will the team
                follow when things get difficult?
              </p>
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  servant leader asks: &ldquo;What do my people need from me to do their best
                  work?&rdquo; This might mean clearing obstacles, fighting for resources,
                  protecting the team from unnecessary interference, or simply ensuring welfare
                  facilities are adequate. It is not about being passive &mdash; it is about placing
                  the team&rsquo;s needs above your own ego.
                </p>
              </div>

              <p>
                The most effective site leaders combine positional authority with earned respect.
                They use their formal authority when necessary (safety decisions, programme
                commitments, quality standards), but they lead primarily through the respect they
                have earned from their team. This combination creates leaders who can both{' '}
                <strong>direct</strong> when urgency demands it and
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>The cabin supervisor</strong> &mdash; sits in the office, sends
                      instructions via radio, pulls rank when questioned, never gets their hands
                      dirty. The team do exactly what is asked and not a fraction more.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>The front-line leader</strong> &mdash; walks the job every morning,
                      helps move cable drums without being asked, knows every person by name,
                      explains the &ldquo;why&rdquo; behind decisions, fights for proper materials.
                      The team would run through walls for them.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>The difference</strong> &mdash; both supervisors have the same
                      positional authority (same title, same organisational chart). The difference
                      is entirely in earned respect. The second supervisor gets 40% more productive
                      output from the same team, with fewer defects and zero safety incidents.
                    </span>
                  </li>
                </ul>
              </div>
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                dishonesty, betrayal, or inconsistency can undo months of careful trust-building.
                This asymmetry is one of the most important things to understand about trust &mdash;
                it is far easier to lose than it is to earn.
              </p>

              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                <p className="text-sm font-medium text-purple-400 mb-3">
                  Common Trust-Destroyers on Site
                </p>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
                  <div className="bg-white/5 rounded-lg p-3">
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  new behaviour before they will begin to trust again. This can take months or even
                  years. Some breaches of trust are so severe that recovery is not possible &mdash;
                  a new start with a different team may be the only option.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-amber-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Starting with a new team is one of the most challenging situations in leadership.
                Nobody knows you. They do not know if you are competent, fair, or reliable. They may
                have had bad experiences with previous supervisors. First impressions matter
                enormously, and the
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-3">
                  The First 90 Days &mdash; Trust-Building Actions
                </p>
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Be visible</strong> &mdash; spend your time on the work face, not in
                      the cabin. Be where the work is happening. Walk the site every morning.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Be available</strong> &mdash; make it clear that your door (or hard
                      hat) is always open. Respond to requests promptly. Do not make people wait
                      unnecessarily.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Learn names</strong> &mdash; this sounds basic but it is surprisingly
                      powerful. Learning everyone&rsquo;s name within the first week shows you see
                      them as individuals, not just labour.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Understand strengths</strong> &mdash; take time to learn what each
                      person is good at, what they enjoy, what they want to develop. This shows
                      genuine interest and helps with delegation.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Under-promise, over-deliver</strong> &mdash; do not make grand
                      promises you cannot keep. Promise less, then deliver more. Each small exceeded
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Listen before you change</strong> &mdash; resist the urge to change
                      everything in week one. Understand how things work first. The team may be
                      doing things for good reasons you do not yet know.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  the team learns you care about their wellbeing. If your first act is to ask for
                  their input, the team learns you value their experience.{' '}
                  <strong className="text-white">Choose your early actions deliberately</strong>{' '}
                  &mdash; they send a message about who you are.
                </p>
              </div>

              <p>
                Do not expect instant trust. Experienced tradespeople have often seen supervisors
                come and go, and many have been let down before. They will give you a fair chance,
                but they will be watching. Consistency is what converts initial scepticism into
                genuine trust. It is not about one big gesture &mdash; it is about dozens of small,
                consistent actions that demonstrate who you really are.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Changing everything immediately</strong> &mdash; coming in and
                      overhauling processes before understanding why they exist. The team feels
                      their experience is being dismissed.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Pulling rank</strong> &mdash; using your title to win arguments.
                      &ldquo;Because I said so&rdquo; might work once, but it destroys trust
                      permanently.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Making promises you cannot keep</strong> &mdash; over-promising on
                      pay, overtime, or conditions and then failing to deliver. Better to say
                      &ldquo;I will look into it&rdquo; than to promise something you cannot
                      control.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Being invisible</strong> &mdash; spending all your time in meetings,
                      on the phone, or in the cabin. If your team does not see you, they cannot
                      trust you.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Trying to be everyone&rsquo;s mate</strong> &mdash; being overly
                      friendly to gain approval, rather than earning respect through competence and
                      fairness. The team can tell the difference.
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-green-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                This section has explored why trust is the non-negotiable foundation of effective
                site leadership, how it is built and destroyed, and the critical distinction between
                positional authority and earned respect. The key points to remember are:
              </p>
              ...
              <ul className="text-sm text-white space-y-2">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong>Trust is foundational:</strong> Without trust, teams cannot function
                    effectively &mdash; Lencioni places it at the base of all team performance
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong>The Trust Equation:</strong> (Credibility + Reliability + Intimacy) /
                    Self-Orientation &mdash; self-focus is the biggest trust-reducer
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong>Earned respect beats positional authority:</strong> Compliance gets the
                    minimum; respect gets people&rsquo;s best
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong>Servant leadership:</strong> The leader&rsquo;s role is to serve the
                    team&rsquo;s needs so they can do their best work
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong>Trust is fragile:</strong> It takes months to build and seconds to
                    destroy &mdash; consistency is everything
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong>First 90 days:</strong> Be visible, learn names, keep promises, listen
                    first, and under-promise and over-deliver
                  </span>
                </li>
              </ul>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  ...
                  <strong> Delegating Effectively</strong> &mdash; the Skill-Will Matrix, the Seven
                  Levels of Delegation, SMART delegation, and the most common delegation mistakes
                  that new supervisors make.
                </p>
              </div>
            </div>
          </div>
