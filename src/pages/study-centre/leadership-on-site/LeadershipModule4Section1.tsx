...
export default function LeadershipModule4Section1() {
  useSEO({
    ...
    description:
      'The OODA Loop, the 70% Rule, owning decisions, and avoiding common decision traps for site supervisors and electrical leaders.',
  });
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-rose-500/5 border-l-2 border-rose-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Framework:</strong> The OODA Loop &mdash; Observe, Orient, Decide, Act
              </li>
              <li>
                <strong>Speed:</strong> The 70% Rule &mdash; decide with 70% of the information
              </li>
              <li>
                <strong>Ownership:</strong> Never blame the team for your decisions
              </li>
              <li>
                <strong>Awareness:</strong> Know the five common decision traps
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-rose-500/5 border-l-2 border-rose-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Reality:</strong> Dozens of decisions every day, some critical
              </li>
              <li>
                <strong>Danger:</strong> Indecision is itself a decision &mdash; and usually the
                worst
              </li>
              <li>
                <strong>Exception:</strong> Safety-critical decisions &mdash; always get it right
              </li>
              <li>
                <strong>Trust:</strong> Accountability builds it; deflection destroys it
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="border-l-2 border-rose-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                stop work because of weather? Do we accept that delivery or reject it? The ability
                to make good decisions quickly, especially under pressure, separates effective
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  construction site where labour costs hundreds of pounds per hour, every minute of
                  indecision has a real financial cost &mdash; and the reputational cost can be even
                  higher.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm text-white">
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    ...
                    <p>
                      Daily task allocation, material ordering, sequence adjustments, welfare
                      arrangements. These should be made quickly and confidently &mdash; do not
                      overthink them. They form the bulk of your daily output.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    <p className="text-white font-medium mb-1">Tactical Decisions</p>
                    <p>
                      Responding to programme changes, resolving clashes between trades, dealing
                      with defects, managing late deliveries. These need structured thinking but
                      timely action &mdash; hours, not days.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    <p className="text-white font-medium mb-1">Safety-Critical Decisions</p>
                    <p>
                      Stop-work calls, method changes, permit decisions, emergency response. These
                      must be right &mdash; take the time needed, consult others, and never
                      compromise safety for programme or cost.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    <p className="text-white font-medium mb-1">People Decisions</p>
                    <p>
                      Addressing poor performance, resolving conflicts, managing welfare issues,
              ...
              <p>
                The best site leaders do not agonise over every decision. They have{' '}
                <strong>frameworks</strong> &mdash; mental models that help them process information
                quickly, weigh options, and commit to a course of action. The following sections
                introduce the most effective of these frameworks and explain how to apply them on
                site.
              </p>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The OODA Loop was developed by{' '}
                <strong>United States Air Force Colonel John Boyd</strong>
                for military combat decision-making. Boyd observed that the pilot who could cycle
                through the decision loop fastest would gain the advantage in a dogfight &mdash; not
                the pilot with the better aircraft. The framework is now widely used in business,
                emergency response, law enforcement, and project management.
              </p>
              ...
              <p>
                The critical insight from Boyd is that{' '}
                <strong>the advantage goes to whoever cycles through the loop fastest</strong>. On a
                construction site, the supervisor who observes a problem early, orients quickly
                through experience, decides promptly, and acts decisively will stay ahead of events
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Observe:</strong> You walk the second floor and
                      see the ceiling grid going up, but your cable routes are not installed yet in
                      that zone. Three of your team are working on the ground floor.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Orient:</strong> If the ceiling closes before
                      cables are in, you will need to cut out access panels later &mdash; that means
                      rework, cost, delay, and a conversation with the project manager you do not
                      want to have.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Decide:</strong> Pull two electricians from the
                      ground floor (which is less urgent) and prioritise second-floor cable routes
                      today. The ground floor can wait until Wednesday.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Act:</strong> Brief the team, reallocate
                      resources, inform the main contractor you are prioritising that zone. Check
                      progress at midday and again at three o&rsquo;clock &mdash; then observe
                      again.
                    </span>
                  </li>
                </ul>
              ...
              <p>
                ...
                return to observing. Did the reallocation work? Is the ceiling team still on
                schedule? Have new problems emerged on the ground floor? Each cycle refines your
                understanding and keeps you ahead of the situation rather than behind it.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1.5">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Experienced supervisor:</strong> Sees the
                      ceiling going up, immediately recognises the sequencing clash, and begins
                      thinking about resource reallocation
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Inexperienced supervisor:</strong> Sees the
                      same ceiling work but does not connect it to the electrical programme until
                      someone else raises the alarm
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  have complete information. The OODA Loop is designed for imperfect information
                  &mdash; the speed of cycling matters more than the completeness of any single
                  stage.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                One of the greatest tensions in decision-making is between <strong>speed</strong>{' '}
                and
                <strong> accuracy</strong>. Wait too long and the opportunity passes. Decide too
                quickly and you may get it wrong. The 70% Rule, attributed to various military
                leaders, provides a practical framework for navigating this tension on site.
              </p>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-base text-white leading-relaxed">
                  ...
                  Waiting for 100% means the opportunity has passed. A good decision now is almost
                  always better than a perfect decision too late.
                </p>
              </div>
              ...
              <p>
                ...
                on. Programmes shift, deliveries change, weather intervenes, other trades alter
                their sequence. The supervisor who waits for perfect information will constantly be
                behind the curve, reacting to yesterday&rsquo;s problems while today&rsquo;s get
                worse.
              </p>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  If you are unsure whether a method is safe, stop work and investigate. If a permit
                  does not look right, do not authorise it. If there is any doubt about an
                  isolation, verify it. The 70% Rule applies to operational and programme decisions
                  &mdash; never to safety. Nobody was ever disciplined for stopping work over a
                  genuine safety concern. But people have been seriously injured because a
                  supervisor felt pressured to keep working when they should have stopped.
                </p>
              </div>

              <p>
                The practical skill is <strong>categorising each decision quickly</strong>: is this
                a speed decision or an accuracy decision? Routine and tactical decisions benefit
                from speed. Safety and contractual decisions demand accuracy. Getting this
                categorisation right is itself a leadership skill that improves with experience.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                the main contractor, by the client, and sometimes by yourself at three o&rsquo;clock
                in the morning. Some of your decisions will be wrong. This is inevitable. The mark
                of a leader is not whether they make mistakes, but{' '}
                <strong>how they handle being wrong</strong>.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Acknowledge it quickly</strong> &mdash; the
                      longer you delay, the worse it gets and the more trust you lose with every
                      passing hour
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Be specific</strong> &mdash; say what went
                      wrong and why, not vague generalities like &ldquo;things did not go to
                      plan&rdquo;
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Present the fix</strong> &mdash; come with a
                      solution, not just the problem. &ldquo;Here is what I am going to do
                      differently&rdquo;
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Learn publicly</strong> &mdash; share what you
                      learned so the team benefits from the experience
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Move on</strong> &mdash; do not dwell on it or
                      let it paralyse your future decisions. One wrong call does not define you.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <p>
                ...
                every mistake becomes a witch hunt, and the same errors keep happening because
                nobody talks about them honestly. In blame culture, people hide problems until they
                become crises. In accountability culture, problems surface early when they are still
                manageable.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  from the outcome, whether the decision turns out to be right or wrong.
                  &ldquo;Decided to prioritise Zone B cable routes over Zone C due to ceiling
                  programme. Based on conversation with MC site manager at 08:15.&rdquo; That takes
                  30 seconds to write and could save you hours of difficulty later.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-amber-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                signs of incompetence &mdash; they are cognitive biases that affect all human
                beings. Being aware of them is the first step to avoiding them. The following five
                are the most common and the most damaging in a construction environment.
              </p>
                ...
                <div className="space-y-3 text-sm">
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    ...
                    <p className="text-white">
                      ...
                      <strong className="text-white">Defence:</strong> Set time limits for decisions
                      and stick to them. Ask: &ldquo;What is the cost of not deciding right
                      now?&rdquo;
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    ...
                    <p className="text-white">
                      ...
                      Actively invite dissent: &ldquo;What could go wrong with this plan?&rdquo;
                      Reward people who challenge assumptions.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    ...
                    <p className="text-white">
                      ...
                      <strong className="text-white">Defence:</strong> Deliberately seek out
                      information that challenges your assumption. Ask someone who disagrees with
                      you.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    ...
                    <p className="text-white">
                      ...
                      <strong className="text-white">Defence:</strong> Evaluate the best path
                      forward from where you are now, not from where you started.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    ...
                    <p className="text-white">
                      ...
                      <strong className="text-white">Defence:</strong> Seek multiple independent
                      sources of information before committing to a view.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  ...
                  am I stalling? (2) Am I only seeing what I want to see? (3) Am I sticking with
                  this because I have already invested in it, rather than because it is still the
                  best option? If the answer to any of these is yes, pause and reconsider your
                  approach.
                </p>
              </div>
          ...
          <div className="border-l-2 border-green-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                it is about having a structured approach, acting decisively, and owning the
              ...
              <ul className="text-sm text-white space-y-2">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong className="text-white">Decision-making is core:</strong> Supervisors
                    make dozens of decisions daily &mdash; indecision is itself a decision, and
                ...
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">The OODA Loop:</strong> Observe, Orient, Decide,
                    Act &mdash; cycle through as fast as possible to stay ahead of events on site
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">The 70% Rule:</strong> If you have 70% of the
                    information, decide now &mdash; but never apply this to safety-critical
                    decisions
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Own your decisions:</strong> Admit mistakes
                    quickly, learn from them, and never blame the team for your calls
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Five decision traps:</strong> Analysis paralysis,
                    groupthink, confirmation bias, sunk cost fallacy, and anchoring &mdash;
                    awareness is your defence
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Skill, not talent:</strong> Decision-making
                    improves with experience, frameworks, and self-awareness &mdash; every decision
                    builds your capability
                  </span>
                </li>
              </ul>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  ...
                  root cause vs symptom analysis, fishbone diagrams, and how to tackle people
                  problems differently from technical ones.
                </p>
              </div>
            </div>
          </div>
