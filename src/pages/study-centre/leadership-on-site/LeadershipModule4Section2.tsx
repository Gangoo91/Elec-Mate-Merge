...
const quizQuestions = [
  ...
  },
  {
    id: 5,
    question:
      'When a problem on site is caused by a personality clash between team members, the most appropriate approach is:',
    options: [
  ...
  },
  {
    id: 7,
    question:
      "Using the 5 Whys, if your final answer is 'because the electrician made a mistake,' you should:",
    options: [
...
export default function LeadershipModule4Section2() {
  useSEO({
    ...
    description:
      'The 5 Whys, DECIDE model, root cause analysis, fishbone diagrams, and handling people problems for site supervisors.',
  });
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-rose-500/5 border-l-2 border-rose-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Diagnosis:</strong> The 5 Whys &mdash; ask why five times to find root cause
              </li>
              <li>
                <strong>Solution:</strong> The DECIDE model &mdash; six steps to the best option
              </li>
              <li>
                <strong>Visual tool:</strong> Fishbone diagrams for complex, multi-cause problems
              </li>
              <li>
                <strong>Key rule:</strong> Treat the cause, not the symptom
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-rose-500/5 border-l-2 border-rose-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Reality:</strong> Problems are constant &mdash; late deliveries, clashes,
                defects
              </li>
              <li>
                <strong>Difference:</strong> Systematic beats gut instinct for consistency
              </li>
              <li>
                <strong>People problems:</strong> Need different tools &mdash; GROW, SBI, DESC
              </li>
              <li>
                <strong>Prevention:</strong> Fix the process, not just the immediate issue
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-rose-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                On a construction site, problems are constant &mdash; late deliveries, design
                clashes, defects, weather delays, personnel issues, material shortages, programme
                conflicts. The difference between a good supervisor and a struggling one is often
                not their technical knowledge but their <strong>approach to problem-solving</strong>
                .
              </p>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  produce
                  <strong className="text-white"> better, more consistent results</strong> because
                  they force you to gather evidence, consider alternatives, and test your
                  assumptions.
                </p>
              </div>
              ...
              <p>
                ...
                tools used daily by effective site leaders across the construction industry. They
                work because they impose structure on what would otherwise be reactive, ad hoc
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  firefighting approach feels productive because you are always busy solving
                  problems &mdash; but you are solving the same problems repeatedly. Systematic
                  methods break this cycle by addressing the underlying causes rather than the
                  surface symptoms.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm text-white/80">
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    ...
                    <p>
                      Tasks running behind, clashes with other trades, resources in the wrong place,
                      unrealistic deadlines, weather delays cascading through the programme.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    <p className="text-white font-medium mb-1">Quality Problems</p>
                    <p>
                      Recurring defects, failed tests, snagging issues, workmanship complaints,
                      specification misunderstandings, material substitution problems.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    <p className="text-white font-medium mb-1">Supply Problems</p>
                    <p>
                      Late deliveries, wrong materials, damaged goods, long lead times, supplier
                      failures, specification changes after ordering.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    <p className="text-white font-medium mb-1">People Problems</p>
                    <p>
                      Skill gaps, motivation issues, personality clashes, absence, poor
                      communication, disputes between team members or trades.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <p className="text-sm font-medium text-rose-400">
                    5 Whys &mdash; Electrical Example
                  </p>
                </div>
                <div className="space-y-2 text-sm">
                  <div className="bg-white/5 rounded-lg p-3">
                    <p className="text-white">
                      <strong>Problem:</strong> The RCD tripped during testing
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-lg p-3">
                    <p className="text-white">
                      <strong>Why 1:</strong> Because there is a fault on the circuit
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-lg p-3">
                    <p className="text-white">
                      <strong>Why 2:</strong> Because there is water ingress in the junction box
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-lg p-3">
                    <p className="text-white">
                      <strong>Why 3:</strong> Because the IP rating is wrong for the environment
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-lg p-3">
                    <p className="text-white">
                      <strong>Why 4:</strong> Because nobody checked the specification before
                      ordering
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-lg p-3 border border-rose-500/30">
                    <p className="text-white">
                      <strong>Why 5:</strong> Because there is no sign-off process for material
                      orders
                    </p>
                    <p className="text-rose-400 text-xs mt-1 font-medium">
                      ROOT CAUSE = Process gap, not the immediate symptom
                    </p>
                  </div>
                </div>
              </div>
              ...
              <p>
                Notice how the root cause is a <strong>process gap</strong> (no sign-off for
                material orders), not the immediate symptom (RCD tripping). Fixing the junction box
                treats the symptom for that one circuit. Implementing a material order sign-off
                process prevents the same type of error across every future job. This is the power
                of root cause analysis &mdash; it leads to systemic improvements, not one-off fixes.
              </p>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-3">
                  Second Example &mdash; Programme Delay
                </p>
                <div className="space-y-2 text-sm">
                  <div className="bg-white/5 rounded-lg p-2">
                    <p className="text-white">
                      <strong>Problem:</strong> Second-fix electrical is consistently running behind
                      programme
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-lg p-2">
                    <p className="text-white">
                      <strong>Why 1:</strong> Because the electricians cannot start on time each
                      morning
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-lg p-2">
                    <p className="text-white">
                      <strong>Why 2:</strong> Because they are waiting for access to the rooms
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-lg p-2">
                    <p className="text-white">
                      <strong>Why 3:</strong> Because the decorators are still finishing in those
                      rooms
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-lg p-2">
                    <p className="text-white">
                      <strong>Why 4:</strong> Because the decorators are working to a different
                      sequence than the electrical programme
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-lg p-2 border border-rose-500/30">
                    <p className="text-white">
                      <strong>Why 5:</strong> Because the trades are not coordinating their
                      sequences at the weekly meeting
                    </p>
                    <p className="text-rose-400 text-xs mt-1 font-medium">
                      ROOT CAUSE = Coordination failure, not a lazy team
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Write it down</strong> &mdash; document each
                      question and answer to maintain clarity and prevent circular reasoning
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Five is a guide, not a rule</strong> &mdash;
                      you may reach the root cause in three whys or need seven depending on the
                      complexity
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Avoid blame</strong> &mdash; if your final
                      answer is a person, keep asking why the system allowed the error to occur
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Involve the right people</strong> &mdash; those
                      closest to the problem have the best information about what actually happened
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Look for process, not people</strong> &mdash;
                      the root cause should be something you can change in the system to prevent
                      recurrence
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Test your conclusion</strong> &mdash; ask
                      &ldquo;if we fix this, will the problem stop recurring?&rdquo; If the answer
                      is no, dig deeper
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Define:</strong> Second-fix electrical in Zone
                      B is two days behind; handover is next Friday
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Establish:</strong> No safety shortcuts, budget
                      overspend under &pound;2,000, must meet Friday handover
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Consider:</strong> (1) Overtime Saturday and
                      Sunday, (2) Bring in two extra electricians, (3) Resequence to do Zone C first
                      and negotiate Zone B extension, (4) Partial handover
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Identify:</strong> Option 2 &mdash; extra
                      labour at &pound;1,600 meets all criteria; overtime risks fatigue and errors
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Develop:</strong> Two electricians from agency,
                      starting Wednesday, supervised by senior on site
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Evaluate:</strong> Check progress Thursday
                      lunchtime; if not on track, activate overtime backup plan
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The most common problem-solving mistake on construction sites is{' '}
                <strong>treating the symptom instead of the cause</strong>. Symptoms are what you
                see on the surface &mdash; the immediate problem. Root causes are the underlying
                reasons why the problem occurred. Fix the symptom and it comes back. Fix the root
                cause and it does not.
              </p>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-3">
                  Symptom vs Root Cause &mdash; Examples
                </p>
              ...
              <p>
                For complex problems with multiple potential causes, use a{' '}
                <strong>fishbone (Ishikawa) diagram</strong>. The problem sits at the
                &ldquo;head&rdquo; of the fish, and the &ldquo;bones&rdquo; represent six categories
                of potential causes:
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  is almost always a{' '}
                  <strong className="text-white">process, system, or management issue</strong>{' '}
                  &mdash; not an individual failing.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-amber-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                different tools &mdash; you cannot use the 5 Whys on a personality clash or apply a
                fishbone diagram to a motivation problem.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <p className="text-sm font-medium text-rose-400">
                    People Problem-Solving Frameworks
                  </p>
                </div>
                <div className="space-y-3 text-sm">
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    ...
                    <p className="text-white/80">
                      ...
                      they do? <strong className="text-white">W</strong>ill &mdash; what will they
                      commit to? Use for skill gaps, development conversations, and performance
                      improvement.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    ...
                    <p className="text-white/80">
                      ...
                      &mdash; what was the effect? Use for giving constructive feedback on specific
                      observed behaviours.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    ...
                    <p className="text-white/80">
                      ...
                      <strong className="text-white">C</strong>onsequence &mdash; what happens if it
                      does or does not change. Use for conversations about unacceptable behaviour or
                      persistent issues.
                    </p>
                  </div>
                </div>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  ...
                  need empathy, active listening, and structured conversation &mdash; not
                  engineering analysis. The next section on Managing Conflict covers these
                  situations in detail.
                </p>
              </div>

              <p>
                The most important diagnostic question when a problem appears is:{' '}
                <strong>
                  is this fundamentally a technical or process issue, or is it a people issue?
                </strong>{' '}
                If materials keep arriving late, that is a supply chain process problem &mdash; use
                the 5 Whys. If two electricians keep arguing about methods, that is a relationship
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-green-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Systematic problem-solving is a core leadership skill. The frameworks in this
                section give you reliable tools for diagnosing causes and choosing solutions, even
              ...
              <ul className="text-sm text-white/80 space-y-2">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong className="text-white">5 Whys:</strong> Ask &ldquo;why&rdquo; repeatedly
                    to move from symptom to root cause &mdash; look for process gaps, not people to
                    blame
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">DECIDE model:</strong> Six structured steps for
                    choosing the best solution to complex problems with multiple options
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Root cause vs symptom:</strong> If the problem
                    keeps recurring, you are treating the symptom &mdash; dig deeper
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Fishbone diagrams:</strong> Categorise causes
                    into People, Process, Equipment, Materials, Environment, and Management
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">People problems:</strong> Use GROW for coaching,
                    SBI for feedback, DESC for difficult conversations
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Systematic beats gut:</strong> Structured methods
                    produce more consistent, better results than intuition alone
                  </span>
                </li>
              </ul>
