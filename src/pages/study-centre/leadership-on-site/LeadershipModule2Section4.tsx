...
const faqs = [
  {
    question:
      'I hate confrontation. How do I give critical feedback without it turning into an argument?',
    answer:
...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'GROW stands for Goal (what do you want to achieve?), Reality (what is happening now?), Options (what could you do?), Will (what WILL you do, and by when?). Developed by Sir John Whitmore, it is the most widely used coaching model globally, adopted by organisations including Google.',
  },
  {
    id: 4,
    question:
...
export default function LeadershipModule2Section4() {
  useSEO({
    ...
    description:
      "The SBI feedback model, GROW coaching model, why the feedback sandwich fails, and Marshall Goldsmith's feedforward approach for construction site leaders.",
  });
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <header className="text-center mb-12">
          ...
          <p className="text-white text-sm sm:text-base max-w-2xl mx-auto">
            Four evidence-based feedback and coaching models that turn conversations into real
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-rose-500/5 border-l-2 border-rose-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>SBI Model:</strong> Situation &rarr; Behaviour &rarr; Impact (factual,
                specific)
              </li>
              <li>
                <strong>GROW Model:</strong> Goal &rarr; Reality &rarr; Options &rarr; Will
                (coaching)
              </li>
              <li>
                <strong>Sandwich:</strong> Does NOT work &mdash; five research-based reasons why
              </li>
              <li>
                <strong>Feedforward:</strong> Future suggestions, not past critique (Goldsmith)
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-rose-500/5 border-l-2 border-rose-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Be specific:</strong> &ldquo;You interrupted Dave twice&rdquo; not
                &ldquo;bad attitude&rdquo;
              </li>
              <li>
                <strong>Give it early:</strong> As close to the event as possible
              </li>
              <li>
                <strong>5:1 ratio:</strong> Five positive interactions for every corrective one
              </li>
              <li>
                <strong>Make it normal:</strong> Frequent, informal feedback beats annual reviews
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-rose-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Regular, honest feedback is one of the{' '}
                <strong>highest-impact things a leader can do</strong>. Without feedback, people do
                not know where they stand, cannot improve, and gradually lose motivation. They are
                flying blind &mdash; unsure if their work is good enough, uncertain about
                expectations, and unable to develop.
              </p>

              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                <p className="text-sm font-medium text-rose-400 mb-2">The Feedback Gap</p>
                <p className="text-base text-white leading-relaxed">
                  Most new supervisors either <strong>avoid giving feedback entirely</strong>{' '}
                  (because it feels uncomfortable, especially corrective feedback) or{' '}
                  <strong>do it badly</strong>
                  (vague, emotional, judgemental, or poorly timed). Both approaches fail. Avoiding
                  feedback allows poor performance to continue and good performance to go
                  unrecognised. Bad feedback damages relationships and creates defensiveness.
                </p>
              </div>

              <p>
                The good news is that effective feedback is a <strong>learnable skill</strong>. The
                four models in this section provide structured approaches that take the guesswork
                out of feedback conversations. They work because they are based on research, focus
                on observable facts rather than subjective judgements, and create clear paths to
                improvement.
              </p>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-3">
                  What Effective Feedback Achieves
                </p>
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Reinforces good behaviour</strong> &mdash; people repeat actions that
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Corrects problems early</strong> &mdash; small issues get fixed before
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Builds trust</strong> &mdash; honest feedback signals respect (you
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Develops people</strong> &mdash; feedback is the primary mechanism for
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Sets standards</strong> &mdash; consistent feedback makes expectations
                      clear to everyone
                    </span>
                  </li>
                </ul>
          ...
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                one of the most widely used feedback frameworks in the world. It works because it
                keeps feedback <strong>factual, specific, and free from judgement</strong> &mdash;
                reducing defensiveness and increasing the chance of behaviour change.
              </p>
                ...
                <div className="space-y-3 text-sm">
                  <div className="bg-blue-500/10 border border-blue-500/30 p-3 rounded-lg">
                    ...
                    <p className="text-white text-xs mt-1">
                      <strong>Example:</strong> &ldquo;During the toolbox talk this
                      morning...&rdquo; or &ldquo;When you were working on the DB in corridor C
                  ...
                  <div className="bg-purple-500/10 border border-purple-500/30 p-3 rounded-lg">
                    ...
                    <p className="text-white text-xs mt-1">
                      <strong>Example:</strong> &ldquo;...you interrupted Dave twice while he was
                      explaining the isolation procedure...&rdquo; (NOT &ldquo;you were being rude
                      and disrespectful&rdquo;)
                    </p>
                  </div>
                  <div className="bg-green-500/10 border border-green-500/30 p-3 rounded-lg">
                    ...
                    <p className="text-white text-xs mt-1">
                      <strong>Example:</strong> &ldquo;...which meant the lads did not get the full
                      safety briefing and two of them looked confused about the procedure
                      afterwards.&rdquo;
                    </p>
                  </div>
                </div>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  what was going on?&rdquo; This opens a dialogue, shows you are interested in their
                  perspective, and often reveals context you were not aware of. Perhaps they
                  interrupted because they spotted an error in the procedure. Perhaps they were
                  having a terrible day. The intent question turns feedback from a one-way lecture
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Give it privately</strong> &mdash; never give corrective feedback in
                      front of others. Public criticism humiliates people and guarantees
                      defensiveness. Pull them aside.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Give it promptly</strong> &mdash; as close to the event as possible.
                      Feedback about something that happened three weeks ago is far less useful and
                      harder to remember.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Describe, do not judge</strong> &mdash; &ldquo;you interrupted Dave
                      twice&rdquo; is factual. &ldquo;You were being disrespectful&rdquo; is your
                      interpretation. Stick to what you observed.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Avoid &ldquo;always&rdquo; and &ldquo;never&rdquo;</strong> &mdash;
                      these words trigger defensiveness immediately because they are rarely
                      accurate. Use specific examples instead.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Focus on one thing at a time</strong> &mdash; do not save up multiple
                      issues and dump them all at once. Address the most important one and follow up
                      on others separately.
                    </span>
                  </li>
                </ul>
              </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="text-sm text-white">
                      ...
                      morning...&rdquo;
                      <br />
                      <strong className="text-white">B:</strong> &ldquo;...you interrupted Dave
                      twice while he was explaining the isolation procedure...&rdquo;
                      <br />
                      <strong className="text-white">I:</strong> &ldquo;...which meant the lads did
                      not get the full safety briefing.&rdquo;
                      <br />
                      <strong className="text-white">I (Intent):</strong> &ldquo;Can you help me
                      understand what was going on?&rdquo;
                    </p>
                  </div>
                  <div>
                    ...
                    <p className="text-sm text-white">
                      ...
                      today...&rdquo;
                      <br />
                      <strong className="text-white">B:</strong> &ldquo;...you spotted that the
                      earthing conductor was undersized on the new circuit and flagged it before it
                      was concealed...&rdquo;
                      <br />
                      <strong className="text-white">I:</strong> &ldquo;...which saved us from a
                      major non-compliance and potentially hours of rework. That was excellent
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The GROW model is the <strong>most widely used coaching model globally</strong>,
                adopted by organisations including Google. Developed by Sir John Whitmore, it
                provides a structured framework for coaching conversations that help people find
                their own solutions rather than being told what to do.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 sm:p-6 rounded-lg">
                ...
                <div className="space-y-3 text-sm">
                  <div className="bg-blue-500/10 border border-blue-500/30 p-3 rounded-lg">
                    ...
                    <p className="text-white text-xs mt-1">
                      <strong>Site example:</strong> An apprentice struggling with cable
                      calculations. Goal: &ldquo;I want to be able to do voltage drop calculations
                      confidently without needing to check every time.&rdquo;
                    </p>
                  </div>
                  <div className="bg-amber-500/10 border border-amber-500/30 p-3 rounded-lg">
                    ...
                    <p className="text-white text-xs mt-1">
                      <strong>Site example:</strong> &ldquo;Where do you get stuck? Is it the
                      formula, the tables, or applying it to real circuits? How are you
                      practising?&rdquo;
                    </p>
                  </div>
                  <div className="bg-green-500/10 border border-green-500/30 p-3 rounded-lg">
                    ...
                    <p className="text-white text-xs mt-1">
                      <strong>Site example:</strong> &ldquo;What options do you see? Extra practice
                      with the guide? Working through examples with a qualified electrician? Online
                      tutorials? A study group?&rdquo;
                    </p>
                  </div>
                  <div className="bg-purple-500/10 border border-purple-500/30 p-3 rounded-lg">
                    ...
                    <p className="text-white text-xs mt-1">
                      <strong>Site example:</strong> &ldquo;So what are you going to do? When will
                      you start? What might get in the way? How will you handle that? Let us check
                      in on Friday.&rdquo;
                    </p>
                  </div>
                </div>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  is: &ldquo;I will spend 30 minutes every evening this week working through voltage
                  drop examples from the guide, and I will bring three completed examples to show
                  you on Friday.&rdquo; Without a specific action, a specific timeline, and genuine
                  commitment, the coaching conversation produces no change.
                </p>
              </div>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-3">
                  GROW in Action &mdash; Full Construction Example
                </p>
                <div className="space-y-2 text-sm">
                  ...
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    ...
                    <p className="text-white text-xs">
                      ...
                      the results Friday morning.&rdquo;
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                commonly taught feedback technique. It is also one of the least effective. Research
                has identified <strong>five significant problems</strong> with this approach.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-3">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>1. Primacy/recency effects</strong> &mdash; People remember the first
                      and last things said most clearly. The critical message in the middle gets
                      lost between two pieces of praise. The person walks away remembering the
                      praise, not the corrective feedback.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>2. Conditions praise as a warning signal</strong> &mdash; When praise
                      is always followed by &ldquo;but...&rdquo;, people learn to distrust positive
                      feedback. Every time you say something nice, they brace for the criticism.
                      This undermines ALL your positive feedback, even when it is genuine.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>3. Perceived as manipulative</strong> &mdash; Most people see through
                      it immediately. It feels formulaic and insincere. Once someone recognises the
                      pattern, they dismiss the praise as tactical rather than genuine and focus on
                      the criticism with resentment.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>4. Undermines the corrective message</strong> &mdash; By softening the
                      criticism with praise on both sides, the urgency and importance of the
                      corrective message is diluted. If you need someone to change their behaviour,
                      be direct about it.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>5. No empirical support</strong> &mdash; Despite its popularity, there
                      is no robust research evidence that the feedback sandwich improves performance
                      or behaviour change compared to direct, specific feedback.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  positive feedback separately and frequently so it stands on its own merit. Give
                  corrective feedback directly when it is needed. Both are more effective when they
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-amber-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Executive coach Marshall Goldsmith developed the <strong>feedforward</strong>{' '}
                concept based on a simple insight: we can change the future but we cannot change the
                past. Instead of giving feedback on what went wrong (which often triggers
                defensiveness), feedforward asks for <strong>suggestions for the future</strong>.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-3 text-sm">
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    ...
                    <p className="text-white text-xs mt-1">
                      Try: &ldquo;Tomorrow&rsquo;s toolbox talk &mdash; what two things could you do
                      to make sure everyone is engaged and clear on the key messages?&rdquo;
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    ...
                    <ul className="text-white text-xs space-y-1.5">
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                        <span>
                          <strong className="text-white">Future-focused</strong> &mdash; only
                          discuss what to do going forward, not what went wrong
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                        <span>
                          <strong className="text-white">No personal critique</strong> &mdash; it is
                          about improvement, not blame
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                        <span>
                          <strong className="text-white">
                            The only reply is &ldquo;thank you&rdquo;
                          </strong>{' '}
                          &mdash; no defending, no explaining, just listen and accept
                        </span>
                      </li>
                    </ul>
                  </div>
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  . A seasoned electrician with 20 years on the tools is unlikely to respond well to
                  &ldquo;here is what you did wrong.&rdquo; But &ldquo;what two things could you do
                  differently on the next install to get an even better finish?&rdquo; invites them
                  to use their expertise to improve without feeling criticised. It preserves dignity
                  while still driving improvement.
                </p>
              </div>

              <p>
                Goldsmith reports that feedforward is almost universally received more positively
                than traditional feedback. People enjoy giving and receiving suggestions for the
                future much more than discussing past failures. It also tends to produce more
                creative and practical solutions, because the person is thinking forward rather than
                defending the past.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm">
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    ...
                    <p className="text-white text-xs mt-1">
                      <strong>Feedforward:</strong> &ldquo;For tomorrow&rsquo;s toolbox talk, what
                      two things could you do to keep everyone engaged from start to finish?&rdquo;
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    <p className="text-white text-xs">
                    ...
                    <p className="text-white text-xs mt-1">
                      <strong>Feedforward:</strong> &ldquo;On floor 3, what could you do differently
                      with the cable runs to get a really clean finish first time?&rdquo;
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    <p className="text-white text-xs">
                    ...
                    <p className="text-white text-xs mt-1">
                      <strong>Feedforward:</strong> &ldquo;Next time you are isolating, what steps
                      will you take to make sure the procedure is followed completely?&rdquo;
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  &mdash; you cannot simply ask &ldquo;what would you do differently next
                  time?&rdquo; when someone has just created a serious hazard. Similarly, repeated
                  performance issues that have already been discussed need clear, documented
                  feedback using the SBI model. Use feedforward for development and improvement
                  conversations, not for serious disciplinary matters.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-green-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                This section has covered four evidence-based models for giving feedback and coaching
                your team. Each has its place, and the best leaders use all of them depending on the
                situation.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>SBI:</strong> Day-to-day feedback (both positive and corrective). Your
                      default tool. Use it for specific incidents or behaviours.
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>GROW:</strong> Longer coaching conversations about development,
                      performance improvement, or career goals. Takes 15&ndash;30 minutes.
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Feedforward:</strong> With experienced people, for ongoing
                      improvement, or when someone is resistant to traditional feedback.
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Sandwich:</strong> Do not use it. Use direct, specific SBI feedback
                      instead.
                    </span>
                  </div>
                </div>
              ...
              <ul className="text-sm text-white space-y-2">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong>SBI model:</strong> Situation &rarr; Behaviour &rarr; Impact &mdash;
                    factual, specific, non-judgemental feedback
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong>GROW model:</strong> Goal &rarr; Reality &rarr; Options &rarr; Will
                    &mdash; structured coaching for development
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong>Feedback sandwich:</strong> Five research-based reasons why it fails
                    &mdash; use direct SBI instead
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong>Feedforward:</strong> Future-focused suggestions, particularly effective
                ...
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong>Give feedback regularly:</strong> Make it normal, informal, and frequent
                    rather than rare and formal
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  ...
                  <strong> Communication for Leaders</strong> &mdash; how to communicate clearly
                  with your team, run effective toolbox talks, manage upward communication with
                  project managers, and handle difficult conversations on site.
                </p>
              </div>
            </div>
          </div>
