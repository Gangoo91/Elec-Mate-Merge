...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'The three types of resource a supervisor manages are people (labour), materials (everything from cable to fixings), and plant/equipment (cherry pickers, power tools, hoists). Effective management means matching skills to tasks, ordering materials with correct lead times, and ensuring plant is booked, checked, and operated by certified personnel.',
  },
  {
    id: 'lead-plan-ooda',
...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      "A Gantt chart (also called a bar chart programme) displays tasks as horizontal bars on a timeline. Each bar's length represents the activity's duration. Arrows or links between bars show dependencies. Overlapping bars indicate concurrent activities. The critical path can be identified as the longest chain of dependent tasks.",
  },
  {
    id: 3,
    ...
    correctAnswer: 2,
    explanation:
      'The critical path is the longest chain of dependent activities that determines the minimum project duration. Any delay to a task on the critical path directly delays the project completion date. Understanding whether your work is on the critical path helps you prioritise and communicate the impact of delays.',
  },
  {
    id: 4,
  ...
  },
  {
    id: 6,
    question:
      'What should a supervisor do FIRST when they identify a delay that will affect the master programme?',
    options: [
    ...
    correctAnswer: 2,
    explanation:
      'When a delay will affect the master programme, the supervisor should raise it immediately with the site manager and record it in writing. Never bury bad news — early warning allows the project team to develop mitigation strategies. Waiting makes the problem worse and damages your credibility as a supervisor.',
  },
  {
    id: 7,
    question: 'Which of the following is NOT one of the three resource types a supervisor manages?',
    options: ['People (labour)', 'Materials', 'Plant and equipment', 'Corporate finance'],
    correctAnswer: 3,
    explanation:
      'The three resource types a supervisor manages are people (labour), materials, and plant/equipment. Corporate finance is managed at company level, not by site supervisors. However, supervisors must be cost-aware and avoid waste of the resources they do control.',
  },
  {
    id: 8,
    ...
    correctAnswer: 1,
    explanation:
      "A supervisor's daily site diary is a contemporaneous record — written at the time events occurred. This makes it valuable evidence in contractual disputes, delay claims, accident investigations, and legal proceedings. Courts give significant weight to contemporaneous records over statements written after the fact.",
  },
];
...
export default function LeadershipModule5Section1() {
  useSEO({
    ...
    description:
      'How to plan and organise construction work as a supervisor — programmes, look-ahead planning, resource management, and adapting when plans change.',
  });
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-rose-500/5 border-l-2 border-rose-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Core skill:</strong> Translating the programme into daily reality
              </li>
              <li>
                <strong>Tool:</strong> Weekly/fortnightly look-ahead programme
              </li>
              <li>
                <strong>Resources:</strong> People, materials, and plant/equipment
              </li>
              <li>
                <strong>Key fact:</strong> Plans always change &mdash; adaptability is everything
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-rose-500/5 border-l-2 border-rose-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Gantt chart:</strong> Your tool, not just the PM's tool
              </li>
              <li>
                <strong>Lead times:</strong> Order early or face delays
              </li>
              <li>
                <strong>OODA loop:</strong> Observe, Orient, Decide, Act
              </li>
              <li>
                <strong>Records:</strong> Your site diary is a legal document
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-rose-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                &ldquo;Failing to plan is planning to fail.&rdquo; This phrase is repeated so often
                it has become a clich&eacute; &mdash; but on a construction site, it is literally
                true. The difference between a smooth-running site and total chaos is almost always
                the quality of the planning behind it.
              </p>

              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                <p className="text-sm font-medium text-rose-500 mb-2">
                  The Supervisor&rsquo;s Planning Role
                </p>
                <p className="text-base text-white leading-relaxed">
                  As a supervisor, you are responsible for translating the programme into{' '}
                  <strong>daily reality</strong> &mdash; making sure the right people are in the
                  right place, with the right materials, at the right time. This is not the project
                  manager&rsquo;s job. It is yours.
                </p>
              </div>

              <p>
                Good planning is what separates a competent supervisor from someone who is merely
                &ldquo;in charge.&rdquo; Without planning, you are reactive &mdash; constantly
                firefighting, chasing materials, apologising to other trades, and explaining delays.
                With planning, you are proactive &mdash; anticipating problems before they arise,
                coordinating smoothly with others, and keeping your team productive.
              </p>
              ...
              <p>
                Planning is not paperwork. It is a <strong>leadership skill</strong> that directly
                impacts your team&rsquo;s productivity, morale, and safety. Workers who know what
                they are doing, have the materials they need, and can see the plan coming together
                are more motivated, more efficient, and safer than workers left in the dark.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Wasted labour</strong> &mdash; electricians
                      standing idle because materials have not arrived or areas are not ready costs
                      your employer hundreds of pounds per day per person
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Rework</strong> &mdash; work installed in the
                      wrong sequence, in the wrong area, or to the wrong specification must be
                      stripped out and redone at double the cost
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Programme delays</strong> &mdash; missed
                      milestones can trigger contractual penalties (liquidated damages) that run
                      into thousands of pounds per day
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Damaged reputation</strong> &mdash; a
                      supervisor who consistently fails to plan loses the confidence of their team,
                      their management, and other trades on site
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The overall project programme &mdash; usually presented as a{' '}
                <strong>Gantt chart</strong>
                (also called a bar chart) &mdash; shows how all trades interrelate across the entire
                project. Too many supervisors see this as &ldquo;the project manager&rsquo;s
                tool&rdquo; and never engage with it. This is a mistake. The programme is{' '}
                <strong>your</strong> tool.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Your critical dates and milestones</strong>{' '}
                      &mdash; when must first fix be complete? When is the testing and commissioning
                      window? What is the handover date for each zone?
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Which trades come before and after you</strong>{' '}
                      &mdash; you cannot start second fix until the plasterers have finished. The
                      painters cannot start until you have completed your fittings. Understanding
                      these dependencies is essential.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Lead times for materials</strong> &mdash;
                      switchgear might take 8&ndash;12 weeks. Standard cable might take 3&ndash;5
                      days. Specialist luminaires might take 16 weeks. If you do not order in time,
                      the programme slips.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Inspection and sign-off points</strong> &mdash;
                      when are containment inspections due? When must first-fix pre-plaster checks
                      happen? When are the building control inspections?
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  saved on your phone. The supervisors who engage with the programme are the ones
                  who deliver on time.
                </p>
              </div>

              <p>
                Understanding the programme also means understanding the{' '}
                <strong>critical path</strong>
                &mdash; the longest chain of dependent tasks that determines the overall project
                duration. If your electrical work is on the critical path, any delay you cause
                directly delays the entire project. This carries enormous contractual and financial
                implications. Know whether you are on the critical path and plan accordingly.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm text-white/80">
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    ...
                    <p>
                      The amount of time an activity can be delayed without affecting the overall
                      project completion date. Activities on the critical path have zero float.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    <p className="text-white font-medium mb-1">Milestone</p>
                    <p>
                      A key date marking the completion of a significant phase of work. Milestones
                      are often linked to payment applications and contractual obligations.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    <p className="text-white font-medium mb-1">Lead Time</p>
                    <p>
                      The time between placing an order for materials and their delivery to site.
                      Switchgear can be 8&ndash;12 weeks; specialist luminaires can be 16+ weeks.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    <p className="text-white font-medium mb-1">Dependencies</p>
                    <p>
                      Relationships between tasks. Finish-to-Start is the most common: Task B cannot
                      start until Task A finishes (e.g. second fix after plastering).
                    </p>
                  </div>
                </div>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The master programme tells you where you need to be in six months. The{' '}
                <strong>look-ahead programme</strong> tells you what you need to do{' '}
                <strong>this week</strong>. This is where the real planning happens &mdash; breaking
                the master programme into manageable weekly or fortnightly chunks that drive daily
                work.
              </p>
              ...
              <p>
                Check progress <strong>daily</strong> against your plan. At the end of each day,
                ask: did we achieve what we set out to? If not, why not? Adjust the plan for the
                rest of the week. Conditions change constantly on a construction site &mdash;
                weather, design changes, other trades overrunning, material delays. The look-ahead
                is a living document, not something you write on Monday and forget about.
              </p>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  and only discovering problems on Friday, (4) not adjusting the plan when
                  circumstances change, and (5) not recording what actually happened versus what was
                  planned. Avoid all five and you will be ahead of most supervisors in the industry.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                <strong> materials</strong>, and <strong>plant/equipment</strong>. Getting all three
                right at the same time is the hallmark of effective site management.
              </p>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-sm text-white/80">
                  ...
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    ...
                    <p className="text-white/80 text-xs">
                      ...
                      materials cause programme delays.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  <strong className="text-white">IPAF</strong>
                  (International Powered Access Federation) for cherry pickers and scissor lifts;
                  <strong className="text-white"> PASMA</strong> (Prefabricated Access
                  Suppliers&rsquo; and Manufacturers&rsquo; Association) for mobile tower scaffolds.
                  Check cards are in date and cover the specific category of equipment being used.
                </p>
              </div>

              <p>
                The most common resource failure is{' '}
                <strong>materials not being on site when needed</strong>. This is almost always a
                planning failure, not a supplier failure. If you know you need switchgear in week 20
                and the lead time is 10 weeks, you must order by week 10 at the latest. Build a
                materials schedule from the programme and track it actively. A team standing idle
                because materials have not arrived is the most expensive waste on any construction
                site.
              </p>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-amber-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Plans always go wrong. Weather stops external work. Deliveries arrive late or
                damaged. Key workers go off sick. Designs change mid-installation. Services clash in
                the ceiling void. The question is not <strong>whether</strong> your plans will be
                disrupted, but
              ...
              <p>
                When disruption occurs, communicate changes to your team{' '}
                <strong>immediately</strong>. Do not let your team discover problems themselves
                &mdash; brief them, explain the new plan, and keep them informed. If the disruption
                affects the master programme, escalate it to the site manager straight away.{' '}
                <strong>Never bury bad news</strong> &mdash; raise it early when there is still time
                to mitigate.
              </p>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  verbal conversation is not a record &mdash; put it in writing.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-green-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Effective planning is a core leadership skill that directly impacts your
              ...
              <ul className="text-sm text-white/80 space-y-2">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong className="text-white">Planning is leadership:</strong> Good planning is
                    the difference between a smooth-running site and chaos. It is a core supervisor
                    responsibility, not just project management admin.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Know the programme:</strong> Understand your
                    critical dates, dependencies, lead times, and inspection points. The Gantt chart
                    is your tool, not just the PM&rsquo;s.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Plan weekly:</strong> Use a rolling look-ahead
                    programme. Plan every Monday. Check progress daily. Adjust as conditions change.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Manage resources:</strong> Match people to tasks,
                    order materials early, and ensure plant is booked and operators are certified.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Adapt fast:</strong> Use the OODA loop when plans
                    change. Communicate immediately. Escalate programme-affecting delays. Never bury
                    bad news.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Keep records:</strong> Your site diary is a legal
                    document. Record delays, causes, instructions, and communications every day.
                  </span>
                </li>
              </ul>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-rose-500">Next:</strong> In Section 2, we will examine how
                  to manage subcontractors and other trades &mdash; coordination, sequencing,
                  setting expectations, and building the professional relationships that make
                  multi-trade sites work smoothly.
                </p>
              </div>
            </div>
          </div>
