...
const quizQuestions = [
  {
    id: 1,
    question:
      'According to Patrick Lencioni, fear of conflict is the second dysfunction of a team, coming after:',
    options: [
  ...
  },
  {
    id: 3,
    question:
      'The Collaborating conflict mode (high assertiveness, high cooperativeness) is best described as:',
    options: [
  ...
  },
  {
    id: 7,
    question:
      "When resolving a dispute about the quality of another trade's work, the recommended first step is:",
    options: [
    ...
    correctAnswer: 2,
    explanation:
      "The recommended first step is to establish the facts — what exactly is the issue, what standard was it supposed to meet, and what does the other trade's supervisor say about it? Only after understanding both perspectives can you decide the best course of action. Jumping straight to formal complaints or work refusal damages working relationships unnecessarily.",
  },
  {
    id: 8,
...
export default function LeadershipModule4Section3() {
  useSEO({
    ...
    description:
      'Thomas-Kilmann conflict modes, de-escalation techniques, ACAS principles, and practical approaches to common site conflicts.',
  });
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-rose-500/5 border-l-2 border-rose-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Reality:</strong> Conflict is normal &mdash; and sometimes healthy
              </li>
              <li>
                <strong>Framework:</strong> Thomas-Kilmann &mdash; five modes of handling conflict
              </li>
              <li>
                <strong>Skill:</strong> De-escalation &mdash; lower voice, private space,
                acknowledge
              </li>
              <li>
                <strong>UK standard:</strong> ACAS &mdash; early, informal resolution first
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-rose-500/5 border-l-2 border-rose-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Goal:</strong> Manage conflict constructively, not eliminate it
              </li>
              <li>
                <strong>Danger:</strong> Defaulting to one mode for every situation
              </li>
              <li>
                <strong>Never:</strong> Resolve conflict in front of others
              </li>
              <li>
                <strong>Always:</strong> Focus on the issue, not the person
              </li>
            </ul>
          </div>
        </div>
            ...
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  engage in honest, productive debate default to artificial harmony &mdash; where
                  real problems go unaddressed, better ideas go unheard, and poor decisions go
                  unchallenged.
                </p>
              </div>
              ...
              <p>
                ...
                expertise. The goal is not to eliminate conflict but to{' '}
                <strong>manage it constructively</strong> so that disagreement about ideas does not
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  result is poor decisions that nobody questioned, safety hazards that nobody
                  raised, and a team that looks compliant but is actually disengaged.{' '}
                  <strong className="text-white">
                    Your job is to create an environment where people can disagree safely,
                  </strong>{' '}
                  not one where they feel they cannot speak up.
                </p>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Kenneth Thomas and Ralph Kilmann identified five distinct ways people handle
                conflict, plotted on two axes: <strong>Assertiveness</strong> (how strongly you try
                to satisfy your own concerns) and <strong>Cooperativeness</strong> (how strongly you
                try to satisfy the other person&rsquo;s concerns). No single mode is always right
                &mdash; the problem is <strong>defaulting to one mode for every situation</strong>.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  always accommodates gets walked over.{' '}
                  <strong className="text-white">
                    Effective leaders consciously select the mode that fits the situation
                  </strong>{' '}
                  rather than defaulting to their natural preference every time.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Safety non-negotiable?</strong> Compete. No
                      discussion needed &mdash; the answer is no.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Complex issue, time available?</strong>{' '}
                      Collaborate. Invest the time for a win-win solution.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">
                        Moderate importance, need a quick result?
                      </strong>{' '}
                      Compromise. Split the difference and move on.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Trivial issue or emotions too high?</strong>{' '}
                      Avoid temporarily. Come back when heads are cooler.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">
                        You are wrong, or relationship matters more?
                      </strong>{' '}
                      Accommodate. Concede gracefully and build goodwill.
                    </span>
                  </li>
                </ul>
              </div>
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                de-escalate the situation is critical. An angry exchange in front of the team
                damages everyone&rsquo;s credibility and makes resolution harder. These seven
                techniques work because they reduce the emotional temperature so rational discussion
                can happen.
              </p>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-3">
                  Seven De-escalation Techniques
                </p>
                <div className="space-y-3 text-sm">
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  ...
                  comes across as dismissive. Never walk away without explanation. Never use sarcasm
                  or ridicule. Never threaten consequences in the heat of the moment. And above all,
                  never resolve a conflict publicly &mdash; an audience turns a disagreement into a
                  performance where saving face matters more than finding a solution.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                UK&rsquo;s statutory body for workplace relations. Their guidance on managing
                conflict is considered the gold standard and is referenced by employment tribunals
                across the country.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  , not assigning blame or imposing punishment. The question is not &ldquo;who was
                  wrong?&rdquo; but &ldquo;how do we move forward and work together
                  effectively?&rdquo; Disciplinary action is only appropriate where there has been
                  genuine misconduct &mdash; not simply because two people disagreed.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white/80">
                  <div className="flex items-start gap-3">
                    ...
                    <span>
                      Early intervention &mdash; speak to the parties informally as soon as you
                      become aware of the conflict. Most issues resolve here.
                    </span>
                  </div>
                  <div className="flex items-start gap-3">
                    <span className="text-rose-400 font-bold text-xs mt-0.5 flex-shrink-0">
                    ...
                    <span>
                      Facilitated conversation &mdash; bring the parties together with clear ground
                      rules. Focus on finding a way forward, not apportioning blame.
                    </span>
                  </div>
                  <div className="flex items-start gap-3">
                    <span className="text-rose-400 font-bold text-xs mt-0.5 flex-shrink-0">
                    ...
                    <span>
                      Mediation &mdash; if direct resolution fails, a neutral third party
                      facilitates dialogue. Voluntary, confidential, and non-binding.
                    </span>
                  </div>
                  <div className="flex items-start gap-3">
                    <span className="text-rose-400 font-bold text-xs mt-0.5 flex-shrink-0">
                    ...
                    <span>
                      Formal procedures &mdash; grievance or disciplinary processes. Only when all
                      informal options have been genuinely exhausted.
                    </span>
                  </div>
                </div>
              </div>
          ...
          <div className="border-l-2 border-amber-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                Having a prepared approach for each type means you can respond calmly and
                effectively rather than reacting in the moment. The following are the six most
                common and how to handle them using the Thomas-Kilmann framework.
              </p>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  <strong className="text-white">process or communication gap</strong> that needs
                  addressing. Use the problem-solving tools from Section 2 to identify and fix the
                  underlying issue, rather than resolving the same conflict every week.
                </p>
              </div>
                ...
                <div className="space-y-3 text-sm">
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    ...
                    <p className="text-white/80">
                      ...
                      <strong className="text-white">Mistake to avoid:</strong> Competing
                      aggressively &mdash; you need these relationships tomorrow.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    ...
                    <p className="text-white/80">
                      ...
                      &mdash; criticise the work, not the person.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    <p className="text-white font-medium mb-1">
                    ...
                    <p className="text-white/80">
                      ...
                      Avoiding indefinitely &mdash; it will get worse.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    <p className="text-white font-medium mb-1">
                    ...
                    <p className="text-white/80">
                      ...
                      <strong className="text-white">Mistake to avoid:</strong> Dismissing the
                      concern &mdash; perceived unfairness destroys trust.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    <p className="text-white font-medium mb-1">
                    ...
                    <p className="text-white/80">
                      ...
                      Accommodating everything &mdash; your team relies on you to advocate for fair
                      treatment.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    ...
                    <p className="text-white/80">
                      ...
                      cannot keep or dismissing legitimate concerns.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Act early</strong> &mdash; the longer you leave
                      a conflict unaddressed, the harder it becomes to resolve and the more damage
                      it does to the working environment
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Stay neutral</strong> &mdash; even if you have
                      a personal opinion, your role is to facilitate a fair resolution, not to take
                      sides
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Document it</strong> &mdash; keep a record of
                      what was discussed and what was agreed. This protects everyone and provides a
                      reference if the conflict resurfaces
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Follow up</strong> &mdash; check in with both
                      parties a few days later to ensure the resolution is holding and the working
                      relationship has genuinely improved
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Learn from it</strong> &mdash; if the same type
                      of conflict keeps recurring, there is a systemic cause that needs addressing
                      at a process level, not just a relationship level
                    </span>
                  </li>
                </ul>
              </div>
            ...
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <ul className="text-sm text-white/80 space-y-2">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong className="text-white">Conflict is normal:</strong> Healthy task
                    conflict drives better decisions; destructive relationship conflict must be
                    managed
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Five modes:</strong> Competing, Collaborating,
                    Compromising, Avoiding, Accommodating &mdash; each appropriate in different
                    situations
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">De-escalation:</strong> Lower voice, private
                    space, acknowledge feelings, use their name, open questions, issue not person,
                    take a break
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">ACAS approach:</strong> Early resolution,
                    informal first, mediation if needed, and line manager capability
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">No default mode:</strong> Effective leaders
                    select the conflict mode that fits the situation, not their comfort zone
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Know when to escalate:</strong> Violence risk,
                    discrimination, failed informal resolution, or personal involvement
                  </span>
                </li>
              </ul>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  ...
                  mistakes, holding others accountable fairly, and building a culture of
                  responsibility through Just Culture and psychological safety.
                </p>
              </div>
            </div>
          </div>
