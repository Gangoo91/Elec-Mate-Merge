...
const quickCheckQuestions = [
  ...
  },
  {
    id: 'pink-drive',
    question:
      "Dan Pink's research in 'Drive' found that for complex, non-routine tasks, traditional carrots and sticks (rewards and punishments):",
    options: [
...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      "Pink's three intrinsic motivators are Autonomy (control over your own work), Mastery (the desire to get better at something that matters), and Purpose (connection to something larger than yourself). These are particularly relevant to skilled trades like electrical work, where craftspeople value being trusted, becoming more expert, and doing work that matters.",
  },
  {
    id: 5,
    question:
      'A supervisor notices that site welfare facilities are poor — dirty toilets, no hot water, and an inadequate drying room. According to Maslow and Herzberg, fixing this will:',
    options: [
...
export default function LeadershipModule2Section3() {
  useSEO({
    ...
    description:
      "Maslow's Hierarchy of Needs, Herzberg's Two-Factor Theory, McGregor's Theory X and Y, and Dan Pink's Drive applied to motivating electricians on construction sites.",
  });
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <header className="text-center mb-12">
          ...
          <p className="text-white text-sm sm:text-base max-w-2xl mx-auto">
            Four evidence-based motivation theories and how to apply them to leading electricians
            and tradespeople on construction sites
          </p>
        </header>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-rose-500/5 border-l-2 border-rose-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Maslow:</strong> Meet basic needs first &mdash; fair pay, safety, welfare
              </li>
              <li>
                <strong>Herzberg:</strong> Hygiene prevents complaints; motivators drive engagement
              </li>
              <li>
                <strong>McGregor:</strong> Theory X (control) vs Theory Y (trust) &mdash; Y wins
              </li>
              <li>
                <strong>Pink:</strong> Autonomy + Mastery + Purpose = intrinsic motivation
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-rose-500/5 border-l-2 border-rose-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Fix basics first:</strong> Welfare, pay, safety are non-negotiable baseline
              </li>
              <li>
                <strong>Then motivate:</strong> Recognition, ownership, growth, meaningful work
              </li>
              <li>
                <strong>Trust your team:</strong> Theory Y approach outperforms Theory X every time
              </li>
              <li>
                <strong>Electricians fit perfectly:</strong> Complex trade = autonomy, mastery,
                purpose
              </li>
            </ul>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-rose-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Motivated teams work faster, safer, and produce higher quality work. Demotivated
                teams deliver the opposite: <strong>high turnover</strong> (people leave),{' '}
                <strong>poor quality</strong> (people stop caring about standards),{' '}
                <strong>safety incidents</strong>
                (people take shortcuts or stop paying attention), and <strong>
                  low morale
                </strong>{' '}
                (which spreads like a virus through a workforce).
              </p>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-base text-white leading-relaxed">
                  Understanding what drives people is not a &ldquo;nice to have&rdquo; &mdash; it is
                  a<strong> core leadership skill</strong> with direct commercial impact. Research
                  by Gallup consistently shows that engaged teams are 21% more productive and
                  experience 59% less turnover. In construction, where skilled labour is scarce and
                  training is expensive, keeping your best people motivated and retained is a
                  competitive advantage.
                </p>
              </div>

              <p>
                Most new supervisors inherit a mix of people: some highly motivated, some coasting,
                some actively disengaged. Your approach to each person needs to be different because
                the
                <strong> reasons</strong> behind their motivation (or lack of it) are different. The
                four theories in this section give you a framework for understanding why people
                behave the way they do and what you can do about it.
              </p>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-3">
                  Signs of a Motivated vs Demotivated Team
                </p>
                  ...
                  <div>
                    ...
                    <ul className="text-sm text-white space-y-1.5">
                      <li className="flex items-start gap-2">
                        ...
                        <span>
                          Clock-watching, arriving late, leaving at the earliest opportunity
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Abraham Maslow&rsquo;s Hierarchy of Needs (1943) is one of the most recognised
                motivation theories in the world. It proposes that human needs are arranged in a{' '}
                <strong>five-level pyramid</strong>, and that lower-level needs must generally be
                satisfied before higher-level needs can become motivating.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 sm:p-6 rounded-lg">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <p className="text-sm font-medium text-white">
                    Maslow&rsquo;s Five Levels &mdash; Applied to Tradespeople
                  </p>
                </div>
                <div className="space-y-3 text-sm">
                  <div className="bg-purple-500/10 border border-purple-500/20 p-3 rounded-lg">
                    ...
                    <p className="text-white text-xs mt-1">
                      <strong>For electricians:</strong> Mastering the trade at the highest level,
                      mentoring the next generation, being recognised as a true expert, contributing
                  ...
                  <div className="bg-blue-500/10 border border-blue-500/20 p-3 rounded-lg">
                    ...
                    <p className="text-white text-xs mt-1">
                      <strong>For electricians:</strong> Recognition for quality workmanship,
                      gaining qualifications (18th Edition, inspection), being trusted with complex
                      work, earning the respect of peers.
                    </p>
                  </div>
                  <div className="bg-green-500/10 border border-green-500/20 p-3 rounded-lg">
                    ...
                    <p className="text-white text-xs mt-1">
                      <strong>For electricians:</strong> Being part of a crew, team identity and
                      camaraderie, feeling included and valued by colleagues, social bonds formed on
                      site.
                    </p>
                  </div>
                  <div className="bg-amber-500/10 border border-amber-500/20 p-3 rounded-lg">
                    ...
                    <p className="text-white text-xs mt-1">
                      <strong>For electricians:</strong> Safe working conditions, adequate PPE,
                      proper risk assessments, job security, knowing you will be paid on time.
                    </p>
                  </div>
                  <div className="bg-red-500/10 border border-red-500/20 p-3 rounded-lg">
                    ...
                    <p className="text-white text-xs mt-1">
                      <strong>For electricians:</strong> Decent welfare facilities (clean toilets,
                      hot water, drying room, canteen), fair pay that covers living costs,
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  <strong className="text-white">Fix the lower levels first</strong> &mdash; they
                  are the foundation. Levels 1 and 2 are the non-negotiable baseline for any
                  construction site.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-3">
                  Practical Audit: Are Your Basics Met?
                </p>
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Welfare facilities</strong> &mdash; are toilets clean? Is there hot
                      water? Is the drying room adequate? Is there a proper canteen or at least a
                      clean space to eat?
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Pay and conditions</strong> &mdash; are people paid fairly for their
                      skill level? Are rates competitive? Is overtime paid correctly and on time?
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Safety</strong> &mdash; are risk assessments genuine or tick-box? Is
                      PPE provided and adequate? Do people feel safe raising concerns?
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Job security</strong> &mdash; do people know if they have work next
                      month? Is there clarity about the project timeline and their role in it?
                    </span>
                  </li>
                </ul>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Frederick Herzberg&rsquo;s Two-Factor Theory (1959) makes a powerful distinction
                between two types of workplace factors. <strong>Hygiene factors</strong> prevent
                dissatisfaction but do not create motivation. <strong>Motivators</strong> create
                genuine satisfaction and drive engagement. Understanding this distinction changes
                how you lead.
              </p>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <ul className="text-sm text-white space-y-1.5">
                      <li className="flex items-start gap-2">
                        ...
                        <span>
                          <strong>Pay</strong> &mdash; fair, competitive rates
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                        <span>
                          <strong>Working conditions</strong> &mdash; decent welfare, safe site
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                        <span>
                          <strong>Job security</strong> &mdash; knowing the work is ongoing
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                        <span>
                          <strong>Supervision quality</strong> &mdash; competent, fair management
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                        <span>
                          <strong>Company policies</strong> &mdash; reasonable rules and procedures
                        </span>
                      </li>
                    </ul>
                  </div>
                  <div>
                    <p className="text-green-400 font-semibold text-sm mb-2">
                      Motivators (Create Genuine Motivation)
                    </p>
                    <ul className="text-sm text-white space-y-1.5">
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-green-400 flex-shrink-0" />
                        <span>
                          <strong>Achievement</strong> &mdash; completing quality work, solving
                          problems
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-green-400 flex-shrink-0" />
                        <span>
                          <strong>Recognition</strong> &mdash; being acknowledged for good work
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-green-400 flex-shrink-0" />
                        <span>
                          <strong>Meaningful work</strong> &mdash; tasks that matter and challenge
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-green-400 flex-shrink-0" />
                        <span>
                          <strong>Responsibility</strong> &mdash; ownership and accountability
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-green-400 flex-shrink-0" />
                        <span>
                          <strong>Growth</strong> &mdash; learning, qualifications, development
                        </span>
                      </li>
                    </ul>
                  </div>
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  does not make them give their best. To genuinely motivate, you need the
                  motivators: give people ownership of a section, recognise quality workmanship
                  publicly, support 18th Edition updates, and create opportunities for growth.
                </p>
              </div>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-3">
                  Applied to Electricians on Site
                </p>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Douglas McGregor (1960) proposed that managers hold one of two fundamental beliefs
                about human nature, and these beliefs shape their entire management approach &mdash;
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="bg-red-500/10 border border-red-500/30 p-3 rounded-lg">
                    ...
                    <p className="text-white text-xs mt-2">
                      <strong>On site:</strong> Tight supervision, clock-watching, constant
                      checking, punitive approach, no trust.
                    </p>
                  </div>
                  <div className="bg-green-500/10 border border-green-500/30 p-3 rounded-lg">
                    ...
                    <ul className="text-sm text-white space-y-1.5">
                      ...
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-green-400 flex-shrink-0" />
                        <span>
                          People will self-direct towards objectives they are committed to
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-green-400 flex-shrink-0" />
                    ...
                    <p className="text-white text-xs mt-2">
                      <strong>On site:</strong> Trust, autonomy, development, coaching, recognition,
                      shared goals.
                    </p>
                  </div>
                </div>
              ...
              <p>
                Most traditional construction site management leans heavily towards Theory X &mdash;
                tight supervision, clock-watching, signing in and out, constant checking.
                McGregor&rsquo;s crucial insight is that this approach creates a{' '}
                <strong>self-fulfilling prophecy</strong>. If you treat people as lazy and
                untrustworthy, they respond by doing the minimum, hiding problems, and disengaging
                &mdash; which the manager then sees as proof that workers are indeed lazy.
              </p>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  they tend to
                  <strong className="text-white"> rise to that expectation</strong>. This does not
                  mean being naive or ignoring poor performance. It means starting from a position
                  of trust and only increasing control when specific evidence warrants it, rather
                  than starting from a position of suspicion.
                </p>
              </div>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-3">
                  Theory X vs Theory Y in Practice
                </p>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
                  <div className="bg-red-500/10 border border-red-500/20 p-3 rounded-lg">
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-amber-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Daniel Pink&rsquo;s research, published in <em>Drive</em> (2009), synthesised
                decades of behavioural science to reach a surprising conclusion: for anything beyond
                simple, mechanical tasks,{' '}
                <strong>traditional carrots and sticks do not work</strong> &mdash; they can
                actually <strong>damage</strong> performance. External rewards narrow focus, reduce
                creativity, diminish intrinsic motivation, and encourage shortcuts.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-3 text-sm">
                  <div className="bg-blue-500/10 border border-blue-500/30 p-3 rounded-lg">
                    ...
                    <p className="text-white text-xs mt-1">
                      <strong>For electricians:</strong> Being trusted to plan their own work
                      sequence, choose their methods, and manage their time. Electricians value
                      autonomy highly &mdash; being told exactly how to wire something they have
                      done a thousand times is deeply demotivating.
                    </p>
                  </div>
                  <div className="bg-purple-500/10 border border-purple-500/30 p-3 rounded-lg">
                    ...
                    <p className="text-white text-xs mt-1">
                      <strong>For electricians:</strong> The electrical trade has deep complexity
                      &mdash; the 18th Edition, inspection and testing, fire alarm systems,
                      emergency lighting, solar PV, EV charging. There is always more to learn and
                      master. Supporting CPD, qualifications, and specialist training feeds mastery.
                    </p>
                  </div>
                  <div className="bg-green-500/10 border border-green-500/30 p-3 rounded-lg">
                    ...
                    <p className="text-white text-xs mt-1">
                      <strong>For electricians:</strong> Electrical work directly affects safety
                      &mdash; a properly installed circuit protects lives. A completed hospital,
                      school, or home serves the community. Connecting daily work to this larger
                      purpose is powerful.
                    </p>
                  </div>
                </div>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  <strong className="text-white">autonomy</strong> (trusted to manage their own
                  work), supported in <strong className="text-white">mastery</strong> (continuous
                  learning and development), and connected to{' '}
                  <strong className="text-white">purpose</strong> (understanding the impact of their
                  work) will consistently outperform those who are simply offered bonuses or
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-green-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                This section has covered four major motivation theories and their practical
                application to leading electricians and tradespeople on site. Each theory offers a
                different lens on the same fundamental question: what makes people want to do their
                best work?
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Maslow:</strong> Meet basic needs (pay, safety, welfare) before trying
                      to motivate with higher-level factors
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Herzberg:</strong> Hygiene factors prevent complaints; motivators
                      (achievement, recognition, growth) drive real engagement
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>McGregor:</strong> Trust your team (Theory Y) &mdash; it outperforms
                      controlling them (Theory X) and avoids the self-fulfilling prophecy
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Pink:</strong> For complex skilled work, Autonomy + Mastery + Purpose
                      beats carrots and sticks every time
                    </span>
                  </div>
                </div>
              </div>
              ...
              <ul className="text-sm text-white space-y-2">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong>Practical action 1:</strong> Audit the basics &mdash; are welfare, pay,
                    and safety up to standard? Fix these first.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong>Practical action 2:</strong> Recognise good work publicly and
                    specifically &mdash; not vague praise but specific acknowledgement
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong>Practical action 3:</strong> Give experienced people autonomy and
                    ownership &mdash; trust them with the how
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong>Practical action 4:</strong> Support development &mdash; qualifications,
                    courses, new experiences
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong>Practical action 5:</strong> Connect the daily work to its purpose
                    &mdash; who benefits from what we are building?
                  </span>
                </li>
              </ul>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  ...
                  <strong> Giving Feedback That Sticks</strong> &mdash; the SBI feedback model, the
                  GROW coaching model, why the feedback sandwich does not work, and Marshall
                  Goldsmith&rsquo;s feedforward approach.
                </p>
              </div>
            </div>
          </div>
