...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    question:
      "According to Hersey and Blanchard's Situational Leadership model, which style should you use with a team member who has high competence and high commitment?",
    options: [
  ...
  },
  {
    ...
    question:
      'A safety near-miss has just occurred on site and workers are shaken. Which leadership style is MOST appropriate in this immediate moment?',
    options: [
...
const quizQuestions = [
  ...
  },
  {
    id: 5,
    question:
      'An experienced electrician who has been on your team for years is having a difficult personal week and their motivation is low, but their skills remain strong. According to Situational Leadership, which style is most appropriate?',
    options: [
...
export default function LeadershipModule1Section2() {
  useSEO({
    ...
    description:
      "Explore Daniel Goleman's six leadership styles, Hersey and Blanchard's Situational Leadership, and how to adapt your style on a construction site.",
  });
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <header className="text-center mb-12">
          ...
          <p className="text-white text-sm sm:text-base max-w-2xl mx-auto">
            Understanding different styles, when to use each, and why the ability to adapt is the
            most valuable leadership skill on site
          </p>
        </header>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-rose-500/5 border-l-2 border-rose-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Goleman:</strong> 6 styles based on emotional intelligence research
              </li>
              <li>
                <strong>Hersey &amp; Blanchard:</strong> Match style to follower readiness
              </li>
              <li>
                <strong>Classic three:</strong> Autocratic, Democratic, Laissez-faire
              </li>
              <li>
                <strong>Key insight:</strong> Flexibility is the superpower
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-rose-500/5 border-l-2 border-rose-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Emergency:</strong> Commanding &mdash; clear, decisive action
              </li>
              <li>
                <strong>Planning:</strong> Democratic &mdash; harness team expertise
              </li>
              <li>
                <strong>Apprentice:</strong> Coaching &mdash; develop skills over time
              </li>
              <li>
                <strong>Low morale:</strong> Affiliative &mdash; people come first
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="border-l-2 border-rose-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                everything about your team&rsquo;s performance. Research by Daniel Goleman,
                published in the <em>Harvard Business Review</em>, found that leadership style
                accounts for up to
                <strong> 30% of a team&rsquo;s measurable performance</strong>. That is an enormous
                impact from a single variable.
              </p>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm text-white/80">
                  <div className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Team morale</strong> &mdash; how people feel
                  ...
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Productivity</strong> &mdash; how much quality
                      work gets done
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Safety culture</strong> &mdash; whether people
                      report concerns or stay silent
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Staff retention</strong> &mdash; whether good
                  ...
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Innovation</strong> &mdash; whether people
                  ...
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Quality</strong> &mdash; whether people take
              ...
              <p>
                The most important finding from decades of leadership research is this:{' '}
                <strong>there is no single &ldquo;best&rdquo; style</strong>. The best leaders are
                those who can read the situation and adapt. They have a range of styles available
                and know when to deploy each one. This is the skill this section will help you
                develop.
              </p>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Daniel Goleman&rsquo;s research, based on a study of over 3,000 managers, identified
                six distinct leadership styles. Each is rooted in different components of emotional
                intelligence and has a measurable impact on team climate &mdash; either positive or
                negative.
              </p>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  results were those who used{' '}
                  <strong className="text-white">four or more styles regularly</strong>, switching
                  fluidly between them depending on the situation. Two styles &mdash; Coercive and
                  Pacesetting &mdash; had a negative impact on climate when overused, but were
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Paul Hersey and Ken Blanchard developed Situational Leadership Theory, which
                provides a practical framework for matching your leadership style to the{' '}
                <strong>readiness level</strong> of the person you are leading. Readiness is
                determined by two factors: <strong>competence</strong> (ability and skill) and{' '}
                <strong>commitment</strong> (motivation and confidence).
              </p>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-3">
                  The Four Styles Mapped to Follower Readiness
                </p>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
                  <div className="bg-red-500/10 border border-red-500/30 p-3 rounded-lg">
                    ...
                    <p className="text-white/80 text-xs">
                      ...
                      this. Watch me, then try it.&rdquo;
                    </p>
                  </div>
                  <div className="bg-amber-500/10 border border-amber-500/30 p-3 rounded-lg">
                    ...
                    <p className="text-white/80 text-xs">
                      ...
                      Build their confidence while guiding their learning.
                    </p>
                  </div>
                  ...
                  <div className="bg-green-500/10 border border-green-500/30 p-3 rounded-lg">
                    ...
                    <p className="text-white/80 text-xs">
                      ...
                      would be demotivating and insulting.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  when it comes to completing test certificates on a new digital system (S1 for that
                  task). Readiness is task-specific, not person-specific. Never assume someone who
                  is competent in one area will be competent in all areas.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The classic three-style model, originating from Kurt Lewin&rsquo;s research in the
                1930s, remains one of the most widely understood frameworks. While simpler than
                Goleman&rsquo;s or Hersey &amp; Blanchard&rsquo;s models, it captures the
                fundamental spectrum of leadership from total control to total freedom.
              </p>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-amber-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The real skill is not knowing the frameworks &mdash; it is being able to read a
                situation in real time and adapt your approach. Here are five real construction
                scenarios and the styles they demand:
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg space-y-3">
                <div className="bg-blue-500/10 border border-blue-500/30 p-3 rounded-lg">
                  ...
                  <p className="text-sm text-white/80">
                    ...
                    of purpose and direction. &ldquo;This week, we&rsquo;re finishing the second-fix
                    on floors 3 and 4. By Friday, every circuit on those floors will be live-tested
                    and signed off. Here&rsquo;s how we get there&hellip;&rdquo;
                  </p>
                </div>
                <div className="bg-rose-500/10 border border-rose-500/30 p-3 rounded-lg">
                  ...
                  <p className="text-sm text-white/80">
                    ...
                    first thing we need to know? Good. Now, where do we find that in the regs?
                    That&rsquo;s it. Now apply that to this circuit&hellip;&rdquo;
                  </p>
                </div>
                <div className="bg-red-500/10 border border-red-500/30 p-3 rounded-lg">
                  <p className="text-red-400 font-semibold text-sm mb-1">
                  ...
                  <p className="text-sm text-white/80">
                    ...
                    goes back until I say so.&rdquo; Once the area is safe, shift to affiliative
                    (check on the team emotionally) and then democratic (investigate what went wrong
                    together).
                  </p>
                </div>
                <div className="bg-amber-500/10 border border-amber-500/30 p-3 rounded-lg">
                  ...
                  <p className="text-sm text-white/80">
                    ...
                    with limited access. What&rsquo;s the best approach? Dave, you did something
                    similar on the hospital job &mdash; what worked?&rdquo;
                  </p>
                </div>
                <div className="bg-green-500/10 border border-green-500/30 p-3 rounded-lg">
                  ...
                  <p className="text-sm text-white/80">
                    ...
                    contributions. Show you care about the people, not just the work. &ldquo;I know
                    this week&rsquo;s been hard. I want you all to know I see the effort
                    you&rsquo;ve put in. Let&rsquo;s finish strong today and have a good
                    weekend.&rdquo;
                  </p>
                </div>
              </div>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-rose-400">The Superpower:</strong> Notice that in a single
                  week, an effective site supervisor might use five different styles. The ability to
                  read the situation and adapt is the single most valuable leadership skill you can
                  develop. It is not about being a chameleon or being inauthentic &mdash; it is
                  about having the range to give people what they need, when they need it.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <ul className="text-sm text-white/80 space-y-2">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong className="text-white">Goleman&rsquo;s six styles:</strong> Commanding,
                    Authoritative, Affiliative, Democratic, Pacesetting, Coaching &mdash; each has a
                    place, none should be used exclusively.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Situational Leadership:</strong> Match your style
                    to the person&rsquo;s readiness &mdash; their competence and commitment for the
                ...
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Classic three:</strong> Autocratic for
                    emergencies, Democratic for planning, Laissez-faire for trusted experts &mdash;
                    but never default to one.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Flexibility is key:</strong> The best leaders use
                    four or more styles regularly, switching based on situation, people, and task.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Overuse is dangerous:</strong> Any style, used
                    exclusively, has negative consequences. Commanding kills initiative; Democratic
                    slows crises; Pacesetting burns people out.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Every style is learnable:</strong> Even if it
                    feels unnatural now, you can develop range through awareness, practice, and
                    feedback.
                  </span>
                </li>
              </ul>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  ...
                  self-awareness &mdash; the Johari Window, Belbin Team Roles, recognising your
                  blind spots, and building on your strengths. Self-awareness is the foundation of
