...
const quizQuestions = [
  ...
  },
  {
    id: 3,
    question:
      "Jurgen Appelo's Seven Levels of Delegation range from Level 1 (Tell) to Level 7 (Delegate). Level 1 means:",
    options: [
    ...
    correctAnswer: 2,
    explanation:
      "Level 1 (Tell) means you make the decision and communicate it clearly: 'Do this, exactly this way.' It is appropriate for safety-critical tasks, emergencies, or situations where there is only one acceptable method. Using Level 1 for every task is micromanagement, but it has its place.",
  },
  {
    id: 4,
    ...
    correctAnswer: 1,
    explanation:
      "Specific means the task is clearly defined — what exactly needs to be done, what the deliverable looks like, and what 'done' means. 'Sort out area B' is not specific. 'Complete the first fix wiring in area B to drawing E-101, connecting all socket outlets to DB-3' IS specific.",
  },
  {
    id: 5,
  ...
  },
  {
    id: 7,
    question:
      'For a highly skilled, highly motivated electrician, the most appropriate delegation level would be:',
    options: [
    ...
    correctAnswer: 2,
    explanation:
      "A high-skill, high-will team member (the 'Delegate' quadrant of the Skill-Will Matrix) should be given maximum autonomy. Levels 6 (Inquire: you decide, just tell me about it) and 7 (Delegate: you decide, no need to tell me) are appropriate. Using lower levels would be demotivating and signal a lack of trust.",
  },
  {
    id: 8,
    question:
...
export default function LeadershipModule2Section2() {
  useSEO({
    ...
    description:
      'The Skill-Will Matrix, Seven Levels of Delegation, SMART delegation framework, and common delegation mistakes for construction site leaders.',
  });
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <header className="text-center mb-12">
          ...
          <p className="text-white text-sm sm:text-base max-w-2xl mx-auto">
            Why delegation is a core leadership skill, how to match your approach to each person,
            and how to avoid the most common mistakes that new supervisors make
          </p>
        </header>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-rose-500/5 border-l-2 border-rose-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Core truth:</strong> Delegation is not dumping work &mdash; it is strategic
                development
              </li>
              <li>
                <strong>Skill-Will Matrix:</strong> Match your approach to each person&rsquo;s
                ability and motivation
              </li>
              <li>
                <strong>7 Levels:</strong> From &ldquo;Tell&rdquo; to full &ldquo;Delegate&rdquo;
                (Appelo)
              </li>
              <li>
                <strong>Biggest mistake:</strong> Micromanaging after you have delegated
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-rose-500/5 border-l-2 border-rose-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>SMART tasks:</strong> Specific, Measurable, Achievable, Relevant, Time-bound
              </li>
              <li>
                <strong>New apprentice:</strong> Guide &mdash; high support, clear instruction
              </li>
              <li>
                <strong>Experienced spark:</strong> Delegate &mdash; set outcome, trust the method
              </li>
              <li>
                <strong>Keep the monkey:</strong> Help people solve problems, do not take tasks back
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-rose-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                You cannot do everything yourself. This is the first and most important lesson for
                any new supervisor. Trying to do it all leads to three inevitable outcomes:{' '}
                <strong>burnout</strong>
                (you work longer and harder until you break), <strong>bottleneck</strong>{' '}
                (everything stalls because it all flows through you), and{' '}
                <strong>undeveloped team</strong> (nobody else grows because they never get the
                chance).
              </p>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-base text-white leading-relaxed">
                  Delegation is not dumping work on other people. It is the{' '}
                  <strong>strategic allocation of tasks</strong> to develop your team AND get better
                  outcomes. When you were a tradesperson, you were measured on your own output. As a
                  supervisor, you are measured on the
                  <strong> team&rsquo;s output</strong>. Your job is to multiply performance through
                  others, not to be the best individual worker.
                </p>
              </div>

              <p>
                The biggest mistake new supervisors make is trying to do the technical work
                themselves instead of leading. It is understandable &mdash; you were promoted
                because you were good at the work, and doing the work feels productive. But every
                hour you spend on the tools is an hour you are not planning, coordinating,
                developing people, or solving the problems that only a supervisor can solve.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong>&ldquo;I can do it faster myself&rdquo;</strong> &mdash; True in the
                      short term, catastrophic in the long term. You become a bottleneck.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>&ldquo;They won&rsquo;t do it as well as me&rdquo;</strong> &mdash;
                      Maybe not the first time. But they never will if they never get the chance to
                      practise.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>&ldquo;It&rsquo;s quicker to just do it&rdquo;</strong> &mdash;
                      Teaching takes longer upfront but saves thousands of hours over time.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>&ldquo;I feel guilty giving work to others&rdquo;</strong> &mdash;
                      Delegation is not laziness. It is your job. Failing to delegate is failing to
                      lead.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>&ldquo;What if they mess it up?&rdquo;</strong> &mdash; People learn
                      by doing. Mistakes are part of development. Set guardrails, check in at
                      milestones, but let people learn.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>&ldquo;I miss being on the tools&rdquo;</strong> &mdash; Natural and
                      common. But your value has shifted from doing the work to enabling others to
                      do it. Your impact multiplies through the team.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  then you have a delegation problem.
                  <strong className="text-white">
                    {' '}
                    A well-led team should be able to function (not perfectly, but adequately) in
                    the leader&rsquo;s absence.
                  </strong>{' '}
                  If it cannot, you have made yourself a single point of failure.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The Skill-Will Matrix is a practical framework for deciding how to delegate to
                different people. It uses two axes: <strong>Skill</strong> (technical ability, from
                low to high) and <strong>Will</strong> (motivation and engagement, from low to
                high). This creates four quadrants, each requiring a different leadership approach.
              </p>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
                  <div className="bg-green-500/10 border border-green-500/30 p-3 rounded-lg">
                    ...
                    <p className="text-white text-xs">
                      <strong>Example:</strong> A new apprentice on their first site. Eager to
                      learn, asks lots of questions, but needs close instruction on methods and
                      standards.
                    </p>
                    <p className="text-white text-xs mt-1">
                      <strong>Approach:</strong> Coach, teach, demonstrate, set clear expectations,
                      give regular feedback, gradually increase responsibility.
                    </p>
                  </div>
                  <div className="bg-blue-500/10 border border-blue-500/30 p-3 rounded-lg">
                    ...
                    <p className="text-white text-xs">
                      <strong>Example:</strong> An experienced electrician who takes pride in their
                      work, keeps up with regulations, and actively looks for ways to improve.
                    </p>
                    <p className="text-white text-xs mt-1">
                      <strong>Approach:</strong> Set the outcome, trust the method, give autonomy,
                      check in lightly, recognise their contribution.
                    </p>
                  </div>
                  <div className="bg-amber-500/10 border border-amber-500/30 p-3 rounded-lg">
                    ...
                    <p className="text-white text-xs">
                      <strong>Example:</strong> A qualified electrician with years of experience who
                      has become disengaged &mdash; does the minimum, seems bored, no longer takes
                      pride in quality.
                    </p>
                    <p className="text-white text-xs mt-1">
                      <strong>Approach:</strong> Find out what demotivated them, give meaningful
                      challenges, provide ownership, recognise expertise, listen.
                    </p>
                  </div>
                  <div className="bg-red-500/10 border border-red-500/30 p-3 rounded-lg">
                    ...
                    <p className="text-white text-xs">
                      <strong>Example:</strong> A labourer with no electrical background who has
                      been told to help but does not want to be there and does not know what to do.
                    </p>
                    <p className="text-white text-xs mt-1">
                      <strong>Approach:</strong> Clear instructions, close supervision, set small
                      achievable goals, build confidence, address motivational barriers.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  experienced electrician how to do something they have done a thousand times is
                  insulting and will make disengagement worse. Instead, ask them what would make the
                  work more interesting, give them ownership of a section, or involve them in
                  mentoring apprentices.
                </p>
              </div>

              <p>
                People also move between quadrants over time. An enthusiastic apprentice (Guide)
                develops skills and becomes Delegate material. An experienced worker who suffers
                burnout or personal problems might shift from Delegate to Excite.{' '}
                <strong>Reassess regularly</strong> &mdash; the approach that worked last month may
                not work this month if circumstances have changed.
              </p>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-3">
                  Spotting the Quadrants on Site
                </p>
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-green-400 flex-shrink-0" />
                    <span>
                      <strong>Guide signs:</strong> Asks lots of questions, volunteers for tasks,
                      makes mistakes through inexperience not carelessness, eager to learn
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-blue-400 flex-shrink-0" />
                    <span>
                      <strong>Delegate signs:</strong> Produces consistent quality, takes
                      initiative, solves problems independently, others go to them for help
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong>Excite signs:</strong> Technically competent but doing the bare
                      minimum, seems bored, watches the clock, quality has dropped from their known
                      capability
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong>Direct signs:</strong> Unsure what to do, reluctant to start tasks,
                      needs constant checking, may seem withdrawn or anxious
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Jurgen Appelo&rsquo;s Management 3.0 framework describes{' '}
                <strong>seven levels of delegation</strong>, ranging from the leader making all
                decisions to the team having complete autonomy. Effective delegation is not binary
                (delegate or don&rsquo;t) &mdash; it is a spectrum, and the right level depends on
                the person, the task, and the consequences of getting it wrong.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-3 text-sm">
                  <div className="bg-red-500/10 border border-red-500/20 p-3 rounded-lg">
                    ...
                    <p className="text-white text-xs mt-1">
                      <strong>Site example:</strong> &ldquo;Isolate that circuit now using the
                      lock-off procedure. Do not energise until I have verified it
                      personally.&rdquo;
                    </p>
                  </div>
                  <div className="bg-orange-500/10 border border-orange-500/20 p-3 rounded-lg">
                    ...
                    <p className="text-white text-xs mt-1">
                      <strong>Site example:</strong> &ldquo;We are switching to containment-first
                      installation because it reduces rework. Here is how it helped on the last
                      project.&rdquo;
                    </p>
                  </div>
                  <div className="bg-yellow-500/10 border border-yellow-500/20 p-3 rounded-lg">
                    ...
                    <p className="text-white text-xs mt-1">
                      <strong>Site example:</strong> &ldquo;I am thinking about the cable route for
                      the new distribution board. What are your thoughts on running through the
                      ceiling void versus surface?&rdquo;
                    </p>
                  </div>
                  <div className="bg-green-500/10 border border-green-500/20 p-3 rounded-lg">
                    ...
                    <p className="text-white text-xs mt-1">
                      <strong>Site example:</strong> &ldquo;We need to plan the second fix sequence
                      for floors 3 and 4. Let us sit down together and work out the best
                      approach.&rdquo;
                    </p>
                  </div>
                  <div className="bg-teal-500/10 border border-teal-500/20 p-3 rounded-lg">
                    ...
                    <p className="text-white text-xs mt-1">
                      <strong>Site example:</strong> &ldquo;My suggestion would be to start with the
                      emergency lighting, but it is your call &mdash; you know that floor
                      best.&rdquo;
                    </p>
                  </div>
                  <div className="bg-blue-500/10 border border-blue-500/20 p-3 rounded-lg">
                    ...
                    <p className="text-white text-xs mt-1">
                      <strong>Site example:</strong> &ldquo;You are running the testing programme
                      for this section. Handle it however you think best &mdash; just let me know
                      the results.&rdquo;
                    </p>
                  </div>
                  <div className="bg-purple-500/10 border border-purple-500/20 p-3 rounded-lg">
                    ...
                    <p className="text-white text-xs mt-1">
                      <strong>Site example:</strong> &ldquo;You are responsible for the whole first
                      fix on wing B. I trust your judgement completely.&rdquo;
                    </p>
                  </div>
                </div>
              </div>
              ...
              <p>
                The key principle is to <strong>match the level to the person and the task</strong>.
                Use lower levels (1&ndash;3) for less experienced workers or high-risk tasks. Use
                higher levels (5&ndash;7) for experienced, trusted team members on tasks within
                their competence. Over time, the goal is to move people up the levels as their skill
                and trust grow.
              </p>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  before. Similarly, safety-critical tasks may always require Level 1 regardless of
                  the person&rsquo;s experience &mdash; &ldquo;Isolate that circuit now&rdquo; is
                  not a discussion point.{' '}
                  <strong className="text-white">
                    The level follows the task AND the person, not just the person.
                  </strong>
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1.5">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Week 1:</strong> Level 1&ndash;2 (Tell/Sell) &mdash; clear
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Month 1:</strong> Level 3&ndash;4 (Consult/Agree) &mdash; involving
                      them in decisions
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Month 3:</strong> Level 5&ndash;6 (Advise/Inquire) &mdash; they lead,
                      you support
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>Month 6+:</strong> Level 7 (Delegate) &mdash; full ownership and
                      autonomy
                    </span>
                  </li>
                </ul>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                When you delegate a task, clarity is everything. Vague instructions produce vague
                results. The <strong>SMART framework</strong> ensures every delegated task is
                crystal clear.
              </p>
              ...
              <p>
                Notice the final question in the SMART example: &ldquo;Can you manage that?&rdquo;
                This is not a formality. It gives the person an opportunity to raise concerns, flag
                resource issues, or negotiate the timeline. Effective delegation is a{' '}
                <strong>two-way conversation</strong>, not a one-way instruction. If the person
                identifies a genuine barrier (missing materials, conflicting priorities, lack of a
                specific skill), it is far better to know that upfront than to discover it on
                Thursday afternoon.
              </p>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  problems early while respecting autonomy.{' '}
                  <strong className="text-white">
                    The difference between a check-in and a check-up is intent
                  </strong>
                  : a check-in offers support, a check-up expresses doubt. Your tone and approach
                  make the difference.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-amber-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-3">
                  The Six Most Common Delegation Mistakes
                </p>
                <ul className="text-sm text-white space-y-3">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>1. Micromanaging after delegating</strong> &mdash; The worst one. You
                      hand over a task then constantly check up, question every decision, and hover.
                      This signals you do not actually trust the person, kills their motivation, and
                      defeats the entire purpose of delegating.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>2. Delegating without authority</strong> &mdash; Giving someone a task
                      but not the power to make decisions about it. &ldquo;You are in charge of this
                      area, but check with me before you do anything.&rdquo; This creates
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>3. Only delegating boring tasks</strong> &mdash; If you only delegate
                      the tedious work and keep the interesting, developmental tasks for yourself,
                      people quickly notice. Delegate a mix including tasks that stretch and develop
                      people.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>4. Not following up at all</strong> &mdash; The opposite of
                      micromanaging. Delegating then completely forgetting about it. No check-ins,
                      no support, no recognition when complete. People feel abandoned.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>5. Taking back tasks at the first sign of difficulty</strong> &mdash;
                      When someone struggles, resisting the urge to say &ldquo;Give it here, I will
                      do it.&rdquo; This is the &ldquo;monkey on the back&rdquo; problem &mdash;
                      help them solve it, do not take it back.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>6. Not being clear about expectations</strong> &mdash; Assuming people
                      know what you mean without being explicit. Then being frustrated when the
                      result is not what you wanted. If you did not make it clear, that is your
                      failure, not theirs.
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  <strong className="text-white">
                    &ldquo;monkey&rdquo; (the next action) jumps from the team member&rsquo;s back
                    onto the supervisor&rsquo;s
                  </strong>
                  . Soon the supervisor is overwhelmed with dozens of monkeys they have collected,
                  while the team stands idle. The solution: when someone brings you a problem, ask
                  &ldquo;What do you think we should do?&rdquo; Help them solve it &mdash; do not
                  solve it for them.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-3">
                  Keeping the Monkey &mdash; Practical Phrases
                </p>
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>&ldquo;What do you think we should do?&rdquo;</strong> &mdash; Forces
                      the person to think through the problem rather than passing it to you
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>&ldquo;What options have you considered?&rdquo;</strong> &mdash;
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong>
                        &ldquo;If you had to decide right now, what would you do?&rdquo;
                      </strong>{' '}
                      &mdash; Builds confidence in their own judgement
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong>&ldquo;Try that approach and let me know how it goes.&rdquo;</strong>{' '}
                      &mdash; Gives permission to act, keeping the monkey on their back
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-green-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                This section has covered the why, what, and how of effective delegation &mdash; one
                of the most important skills any site leader can develop. The key points to remember
                are:
              </p>
              ...
              <ul className="text-sm text-white space-y-2">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong>Delegation is leadership:</strong> Your job is to multiply output
                    through others, not to be the best individual worker
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong>Skill-Will Matrix:</strong> Guide (high will, low skill), Delegate (high
                    both), Excite (low will, high skill), Direct (low both)
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong>Seven Levels:</strong> Tell &rarr; Sell &rarr; Consult &rarr; Agree
                    &rarr; Advise &rarr; Inquire &rarr; Delegate &mdash; match the level to the
                    person and the risk
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong>SMART delegation:</strong> Specific, Measurable, Achievable, Relevant,
                    Time-bound &mdash; vague instructions produce vague results
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong>Worst mistake:</strong> Micromanaging after delegating &mdash; it
                    destroys trust and defeats the purpose
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong>Keep the monkey:</strong> Help people solve problems rather than taking
                    tasks back onto your own shoulders
                  </span>
                </li>
              </ul>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  ...
                  Herzberg&rsquo;s Two-Factor Theory, McGregor&rsquo;s Theory X and Y, and Dan
                  Pink&rsquo;s Drive model, all applied to managing electricians on site.
                </p>
              </div>
            </div>
          </div>
