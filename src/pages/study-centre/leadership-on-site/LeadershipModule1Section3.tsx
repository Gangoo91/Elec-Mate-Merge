...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    question:
      "Gallup's research found that people who use their strengths every day at work are how much more likely to be engaged?",
    options: [
      '2 times more likely',
      '4 times more likely',
      '6 times more likely',
...
export default function LeadershipModule1Section3() {
  useSEO({
    ...
    description:
      'Explore the Johari Window, Belbin Team Roles, recognising your blind spots, and building a strengths-based approach to leadership on site.',
  });
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <header className="text-center mb-12">
          ...
          <p className="text-white text-sm sm:text-base max-w-2xl mx-auto">
            Why understanding yourself is the foundation of effective leadership, and practical
            tools for uncovering your strengths, blind spots, and team roles
          </p>
        </header>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-rose-500/5 border-l-2 border-rose-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Johari Window:</strong> 4 quadrants revealing what you and others know
              </li>
              <li>
                <strong>Belbin Roles:</strong> 9 team roles across 3 categories
              </li>
              <li>
                <strong>Blind spots:</strong> What others see that you cannot
              </li>
              <li>
                <strong>Strengths-based:</strong> Build on what you do well
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-rose-500/5 border-l-2 border-rose-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Foundation:</strong> Self-awareness underpins all other leadership skills
              </li>
              <li>
                <strong>Engagement:</strong> Using strengths daily = 6x more engagement
              </li>
              <li>
                <strong>Reality check:</strong> Only 10&ndash;15% of people are truly self-aware
              </li>
              <li>
                <strong>Learnable:</strong> Self-awareness develops with deliberate practice
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="border-l-2 border-rose-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                platitude &mdash; it is backed by decades of leadership research.{' '}
                <strong>Daniel Goleman</strong>, whose work on emotional intelligence transformed
                our understanding of leadership, identified self-awareness as the{' '}
                <strong>foundational competency</strong> upon which all other leadership
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-base text-white leading-relaxed">
                  <strong>
                    &ldquo;If you do not have self-awareness, if you are not able to manage your
                    distressing emotions, if you can&rsquo;t have empathy and have effective
              ...
              <p>
                Research by organisational psychologist <strong>Tasha Eurich</strong> found that
                while 95% of people believe they are self-aware, only about{' '}
                <strong>10&ndash;15%</strong> actually meet objective criteria. This enormous gap
                &mdash; the &ldquo;self-awareness gap&rdquo; &mdash; means that most leaders are
                operating with significant blind spots they do not even know they have. The
                following tools will help you close that gap.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The Johari Window is one of the most widely used tools for developing
                self-awareness. Created by American psychologists <strong>Joseph Luft</strong> and{' '}
                <strong>Harrington Ingham</strong> in 1955, it provides a simple four-quadrant model
                for understanding the relationship between what you know about yourself and what
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  <strong className="text-white">appropriate self-disclosure</strong> (which reduces
                  your Hidden area &mdash; you share relevant information with your team). The
                  larger the Open area, the stronger the trust, communication, and effectiveness of
                  your leadership.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Dr Meredith Belbin&rsquo;s research at Henley Management College identified{' '}
                <strong>nine distinct team roles</strong> that people naturally adopt in team
                settings. Understanding your preferred roles helps you play to your strengths and
                recognise what you bring to a team &mdash; and what gaps might exist.
              </p>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-rose-400">Key insight:</strong> No single role is better
                  than the others. Belbin&rsquo;s research found that{' '}
                  <strong>balanced teams outperform unbalanced ones</strong>, even when the
                  unbalanced team had higher individual ability. A team of all Plants will generate
                  brilliant ideas but never finish anything. A team of all Implementers will execute
                  efficiently but lack creativity. Understanding your own preferred roles helps you
                  see what you bring to the team &mdash; and what roles you might need to recruit or
                  develop in others.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Every leader has blind spots &mdash; aspects of their behaviour, impact, and
                assumptions that they cannot see. For new leaders on a construction site, certain
                blind spots are particularly common and particularly damaging if left unaddressed.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">
                        Thinking you are approachable when you are not
                      </strong>{' '}
                      &mdash; you believe your door is always open, but your body language, tone, or
                      busyness sends a signal that says &ldquo;do not disturb.&rdquo; The result:
                      problems are hidden from you until they become crises.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">
                        Not realising your mood affects the whole team
                      </strong>{' '}
                      &mdash; you arrive stressed or frustrated and do not notice that the entire
                      team&rsquo;s energy drops. The leader&rsquo;s emotional state is contagious.
                      If you bring negativity, the team absorbs it.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Overestimating your own contribution</strong>{' '}
                      &mdash; taking credit (consciously or unconsciously) for the team&rsquo;s
                      achievements while attributing failures to external factors. This erodes trust
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">
                        Underestimating the impact of favouritism
                      </strong>{' '}
                      &mdash; giving more interesting work, more flexibility, or more attention to
                      certain team members without realising how obvious this is to everyone else.
                      Even perceived favouritism is destructive.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">
                        Believing that being busy means being effective
                      </strong>{' '}
                      &mdash; filling every moment with activity but not stepping back to assess
                      whether you are working on the right things. Activity is not the same as
                      productivity.
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">360-degree feedback</strong> &mdash; formal
                      feedback from your manager, your peers, and your team members. This is the
                      gold standard for uncovering blind spots because it captures multiple
                      perspectives.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Ask trusted colleagues directly</strong>{' '}
                      &mdash; find someone you trust and ask: &ldquo;What is one thing I could do
                      differently to be a more effective leader?&rdquo; Then listen without
                      defending.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Reflect after difficult situations</strong>{' '}
                      &mdash; after a conflict, a mistake, or a challenging interaction,
                      deliberately review your own behaviour. What did you do well? What would you
                      do differently? What were you feeling at the time?
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Watch for repeated patterns</strong> &mdash; if
                      the same type of conflict keeps happening, or the same feedback keeps
                      appearing, or the same type of person keeps struggling under your leadership,
                      that is a signal pointing to a blind spot.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  hidden.{' '}
                  <strong className="text-white">
                    The discomfort you feel when receiving challenging feedback is the discomfort of
                    growth.
                  </strong>{' '}
                  Lean into it.
                </p>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-amber-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Traditional development approaches focus heavily on fixing weaknesses.
                Strengths-based leadership takes a different view:{' '}
                <strong>invest most of your energy in building on what you already do well</strong>,
                while creating practical systems to manage your weaknesses.
              </p>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  <strong className="text-white">12.5% greater productivity</strong>. Employees who
                  feel their strengths are valued are
                  <strong className="text-white"> 15% less likely to leave</strong> their
                  organisation.
                </p>
              </div>
              ...
              <p>
                ...
                being <strong>strategic</strong> about how you allocate your development energy. If
                you are naturally excellent at technical problem-solving but weak at giving praise
                and recognition, the strengths-based approach would suggest:
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Leverage the strength:</strong> Put yourself in
                      situations where your technical problem-solving is needed. Volunteer for
                      complex challenges. Mentor others in technical skills. Build your reputation
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Create systems for the weakness:</strong> Do
                      not just try to force yourself to give more praise (that will feel inauthentic
                      and fade within a week). Instead, build a system: set a weekly reminder to
                      recognise one team member. Write brief thank-you notes at the end of each
                      week. Schedule a five-minute slot in every toolbox talk for recognition. Make
                      it structural, not reliant on willpower.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Partner with complementary people:</strong> If
                      you know your weakness is around people skills, find a team member or
                      colleague who excels in that area and lean on them. Great leaders do not try
                      to do everything themselves &mdash; they build teams that compensate for their
                      gaps.
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-rose-400">The bottom line:</strong> You will never be
                  equally strong in all areas, and that is perfectly fine. What matters is that you{' '}
                  <strong>
                    know your strengths, use them intentionally, and have honest strategies for
                    managing your weaknesses
                  </strong>
                  . That is mature, effective leadership.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-green-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                This section has provided you with practical frameworks for developing
                self-awareness &mdash; the foundation upon which all other leadership skills are
              ...
              <ul className="text-sm text-white space-y-2">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong className="text-white">Self-awareness is foundational:</strong> Goleman
                    identified it as the basis of emotional intelligence. You cannot lead
                    effectively without understanding yourself.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">The Johari Window:</strong> Four quadrants (Open,
                    Blind Spot, Hidden, Unknown) &mdash; expand the Open area through feedback and
                ...
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Belbin Team Roles:</strong> Nine roles in three
                    categories &mdash; know your preferred roles and understand how balanced teams
                    outperform unbalanced ones.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Blind spots are universal:</strong> Every leader
                    has them. Common ones include mood contagion, perceived favouritism, and
                    overestimating approachability.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Strengths-based approach:</strong> Build on what
                    you do well, create systems for weaknesses. People who use their strengths daily
                    are 6x more engaged.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Self-awareness is learnable:</strong> Through
                    feedback, reflection, and deliberate practice, anyone can close the
                    self-awareness gap.
                  </span>
                </li>
              </ul>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-rose-400">Next:</strong> In Section 4, we will tackle one
                  of the most challenging transitions in any career &mdash; the Mate-to-Manager
                  transition. Moving from being one of the team to leading the team is uniquely
                  difficult in construction, and we will cover the seven core challenges, boundary
                  setting, earning respect, and building your support network.
                </p>
              </div>
            </div>
          </div>
