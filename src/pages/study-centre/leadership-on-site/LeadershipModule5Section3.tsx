...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Research shows that transformational leadership (inspiring, motivating, intellectually stimulating) drives safety PARTICIPATION — workers going beyond the minimum, reporting near-misses, suggesting improvements, and looking out for each other. This creates a genuine safety culture rather than mere compliance.',
  },
  {
    id: 5,
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'Under CDM 2015, supervisors must ensure that risk assessments are communicated and understood by workers, safe systems of work are followed, PPE is worn, and competent workers carry out the tasks. These are practical, day-to-day duties that directly protect workers on site.',
  },
  {
    id: 8,
    ...
    correctAnswer: 1,
    explanation:
      'The Management of Health and Safety at Work Regulations 1999 require employers to carry out suitable and sufficient risk assessments for ALL work activities, not just those involving machinery or young workers. Supervisors play a critical role in ensuring these assessments are completed, communicated, and followed on the ground.',
  },
];
...
export default function LeadershipModule5Section3() {
  useSEO({
    ...
    description:
      'Your legal duties as a supervisor under CDM 2015 and HASAWA 1974, leading by example, building safety culture, meaningful inductions, and stopping unsafe work.',
  });
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-rose-500/5 border-l-2 border-rose-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Legal duty:</strong> Supervisors can be personally liable for safety
                failures
              </li>
              <li>
                <strong>Key legislation:</strong> CDM 2015, HASAWA 1974, MHSWR 1999
              </li>
              <li>
                <strong>Leading by example:</strong> Your behaviour is the strongest influence on
                your team
              </li>
              <li>
                <strong>Stopping work:</strong> You have the legal right AND moral duty to stop
                unsafe work
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-rose-500/5 border-l-2 border-rose-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Compliance:</strong> Following rules because you have to (minimum)
              </li>
              <li>
                <strong>Culture:</strong> Following rules because you believe in them (beyond
                minimum)
              </li>
              <li>
                <strong>Transformational:</strong> Inspires participation and ownership
              </li>
              <li>
                <strong>Goal:</strong> Workers who look out for each other instinctively
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-rose-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                As a supervisor on a construction site, you have specific legal duties under three
                key pieces of legislation. These are not optional guidelines &mdash; they are legal
                requirements, and failure to comply can result in personal prosecution, fines, and
                even imprisonment.
              </p>
              ...
              <p>
                You can be <strong>personally liable</strong> for safety failures. Under Section 37
                of HASAWA 1974, if an offence is committed with the consent, connivance, or neglect
                of a manager or officer, that individual can be prosecuted alongside the company.
                Supervisors have been personally fined and, in the most serious cases involving
                fatalities, imprisoned.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Keep records</strong> &mdash; risk assessments
                      delivered, toolbox talks given, inductions completed, hazards reported, unsafe
                      work stopped. These records demonstrate due diligence.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Stay trained</strong> &mdash; SMSTS, SSSTS,
                      first aid, fire marshal. Keep your qualifications current and your knowledge
                      up to date.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Act consistently</strong> &mdash; enforce the
                      same standards every day, with every person. Inconsistent enforcement
                      undermines your credibility and your legal position.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Escalate when needed</strong> &mdash; if you
                      identify a risk you cannot control, escalate it immediately. Documented
                      escalation shows you took all reasonably practicable steps.
                    </span>
                  </li>
                </ul>
              </div>
          ...
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                <strong> what they see YOU do</strong>. Research consistently shows that a
                supervisor&rsquo;s visible safety behaviour has more impact on worker behaviour than
                any poster, policy document, or training course.
              </p>
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">
                        If you walk past a hazard without acting
                      </strong>{' '}
                      &mdash; your team learns that hazards are acceptable and intervention is
                      optional
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">
                        If you do not wear your PPE consistently
                      </strong>{' '}
                      &mdash; nobody else will feel obligated to wear theirs
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">
                        If you cut corners under programme pressure
                      </strong>{' '}
                      &mdash; your team will cut corners too, and they may cut different, more
                      dangerous corners
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">
                        If you treat safety briefings as a tick-box exercise
                      </strong>{' '}
                      &mdash; your team will treat safety as a tick-box exercise
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  &mdash; the team internalises those standards. New starters are socialised into a
                  safe way of working by the team culture, not just by the induction. This is the
                  goal of safety leadership.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Always wear your full PPE</strong> &mdash; hard
                      hat, hi-vis, safety boots, eye protection when required. No exceptions. Not
                      even &ldquo;just for a minute&rdquo; or &ldquo;I&rsquo;m only popping to the
                      cabin.&rdquo;
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Challenge unsafe behaviour immediately</strong>{' '}
                      &mdash; if you see it, address it. Walking past sends the message that it is
                      acceptable. Challenge respectfully but clearly.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Report near-misses yourself</strong> &mdash; if
                      you want your team to report near-misses, show them that you do it too. It
                      demonstrates that reporting is valued, not punished.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Refuse to take shortcuts</strong> &mdash; even
                      under programme pressure. If the job needs scaffolding, get scaffolding. Do
                      not lean a ladder against the wall because it is quicker.
                    </span>
                  </li>
                </ul>
              </div>
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                <strong> safety culture</strong>, and understanding this distinction is fundamental
                to effective safety leadership.
              </p>
                  ...
                  <div>
                    ...
                    <ul className="text-sm text-white/80 space-y-1.5">
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                        <span>
                          Following rules because you{' '}
                          <strong className="text-white">have to</strong>
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                  ...
                  <div>
                    ...
                    <ul className="text-sm text-white/80 space-y-1.5">
                      <li className="flex items-start gap-2">
                        ...
                        <span>
                          Following rules because you{' '}
                          <strong className="text-white">believe in them</strong>
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-green-400 flex-shrink-0" />
              ...
              <p>
                ...
                <strong> transactional</strong> leadership influence safety outcomes, but in
                different ways. Transactional leadership (rewards and punishments) drives{' '}
                <strong>compliance</strong>
                &mdash; workers meet the minimum standard. Transformational leadership (inspiration,
                motivation, intellectual stimulation) drives <strong>participation</strong> &mdash;
                workers go beyond the minimum, report near-misses voluntarily, suggest improvements,
                and look out for each other. The goal is culture, not just compliance.
              </p>

              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-rose-500">The goal:</strong> A team where safety is so
                  deeply embedded that workers challenge each other&rsquo;s unsafe behaviour, report
                  near-misses without being asked, and take ownership of safety in their work area.
                  This does not happen through rules alone &mdash; it happens through consistent,
                  visible, authentic safety leadership.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Involve your team in risk assessments</strong>{' '}
                      &mdash; the people doing the work often spot hazards that the assessor missed.
                      Their involvement creates ownership.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Praise safe behaviour publicly</strong> &mdash;
                      when someone stops to secure a cable before it becomes a trip hazard,
                      acknowledge it. Positive reinforcement is more powerful than punishment.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Treat near-miss reports as gifts</strong>{' '}
                      &mdash; every near-miss reported is a serious accident prevented. Thank the
                      reporter. Investigate the root cause. Share the learning.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">
                        Have safety conversations, not interrogations
                      </strong>{' '}
                      &mdash; walk the site and talk to your team about what they are doing and why.
                      Show genuine interest in their safety, not just their productivity.
                    </span>
                  </li>
                </ul>
              </div>
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                subcontractors, visitors, and anyone else who enters your work zone. A proper
                induction is not a tick-box exercise &mdash; it is a critical safety communication
                that could save someone&rsquo;s life.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Site-specific hazards</strong> &mdash; live
                      services, excavations, overhead work, asbestos, confined spaces, fragile
                      surfaces
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      alarms, muster points, first aiders, emergency exits, accident reporting
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Permit requirements</strong> &mdash; hot works,
                      electrical isolation, confined space entry, excavation permits
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Exclusion zones</strong> &mdash; crane
                      operating areas, demolition zones, areas with restricted access
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Welfare locations</strong> &mdash; toilets,
                      drying rooms, canteen, drinking water, rest areas
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      ...
                      report hazards, near-misses, accidents, and defects
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  when conditions change. Keep records of who was inducted, when, and what was
                  covered. A meaningful ten-minute induction is worth more than a meaningless
                  thirty-minute one.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1.5">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      Choose topics relevant to the current work (e.g. working at height before
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      Ask questions to check understanding &mdash; do not just talk at your team
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-amber-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The hardest safety leadership decision you will ever make is stopping work. It costs
                time, money, and can create conflict. But you have the <strong>legal right</strong>{' '}
                and the
                <strong> moral duty</strong> to stop any work that you believe is unsafe. This
                includes your own team, other trades, and even people who are senior to you.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Intervene calmly and firmly</strong> &mdash; do
                      not shout or make it personal. Be clear and direct: &ldquo;I need you to stop
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Explain what you have observed</strong> &mdash;
                      describe the specific hazard factually: &ldquo;I can see that the scaffold
                      guard rail has been removed and you are working at the edge.&rdquo;
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Explain why it is unsafe</strong> &mdash;
                      connect the hazard to the potential harm: &ldquo;Without the guard rail, there
                      is a risk of falling three metres onto concrete.&rdquo;
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Do not restart until safe</strong> &mdash; the
                      work must not resume until the hazard has been controlled and the area is safe
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  contact the HSE directly. &ldquo;I was told to by my manager&rdquo; is{' '}
                  <strong className="text-white">not a legal defence</strong> if someone is injured
                  as a result of unsafe work you allowed to continue.
                </p>
              </div>

              <p>
                Stopping work takes courage. It is one of the defining moments of your career as a
                safety leader. The workers you protect may never fully appreciate what you did
                &mdash; because the accident never happened. But that is exactly the point. The best
                safety outcomes are the incidents that <strong>never occur</strong> because a
                supervisor had the courage to intervene. Every experienced supervisor has a story
                about a time they stopped work and prevented a serious injury. Be the supervisor who
                can tell that story.
              </p>

              <p>
                Remember that you are protected by law. The Employment Rights Act 1996 protects
                workers who raise genuine health and safety concerns from detriment or dismissal. If
                you stop work in good faith because you believe there is a serious and imminent
                danger, you are acting within your legal rights. Document your reasons and the
                actions you took.
              </p>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-green-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Health and safety leadership is one of the most important responsibilities you hold
                as a supervisor. People go home safely because of the decisions you make every day.
              ...
              <ul className="text-sm text-white/80 space-y-2">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong className="text-white">Legal duties:</strong> Under CDM 2015, HASAWA
                    1974, and MHSWR 1999, supervisors must ensure safe systems of work, communicate
                    risk assessments, enforce PPE, and verify competence. Personal liability
                    applies.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Lead by example:</strong> Your visible safety
                    behaviour is the single most powerful influence on your team. Walk past a hazard
                    and you normalise it. Address it and you set the standard.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Culture over compliance:</strong> Compliance
                    meets the minimum. Culture goes beyond it. Transformational leadership creates
                    safety participation; transactional leadership creates only compliance.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Meaningful inductions:</strong> Induct everyone.
                    Cover site-specific hazards, emergencies, permits, exclusion zones, welfare, and
                    reporting. Check understanding. Update when conditions change.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Stop unsafe work:</strong> You have the legal
                    right and moral duty. Intervene calmly, explain the hazard, do not restart until
                    safe. Never allow programme pressure to override safety.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Escalate pressure:</strong> If anyone pressures
                    you to compromise on safety, document it and escalate. &ldquo;I was told
                    to&rdquo; is not a legal defence.
                  </span>
                </li>
              </ul>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-rose-500">Next:</strong> In Section 4, we will explore how
                  to support apprentices and new starters &mdash; how people learn, effective
                  mentoring techniques, setting development goals, and the enormous impact you have
                  on whether the next generation stays in the trade.
                </p>
              </div>
            </div>
          </div>
