...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    correctIndex: 2,
    explanation:
      'The best approach is to pre-plan clash avoidance using drawings and markups. Before work starts, agree containment routes, penetration locations, and access routes with other trade supervisors. This prevents the costly and frustrating process of moving installed work because of avoidable clashes.',
  },
  {
    id: 'lead-sub-damage',
    question:
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Yes, always. Take photographs of the damage with a timestamp. Report it to the other trade's supervisor and to the site manager. Send an email confirming what happened, when, and what impact it has on your programme and costs. This is not about blame — it is about accountability and ensuring the damage is repaired to the correct standard. If damage is recurring, it may indicate a programme sequencing problem that needs to be addressed at management level. Unreported damage can lead to quality failures, failed inspections, and disputes about who is responsible for remedial work.",
  },
  {
    question:
      'How can I build better relationships with other trade supervisors when we disagree on priorities?',
    answer:
...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'From the first day, set clear expectations about quality standards, timelines, access arrangements, welfare, PPE requirements, and safety standards. Never assume subcontractors know your standards — they have worked on different sites with different supervisors. Put expectations in writing where possible.',
  },
  {
    id: 3,
    question:
  ...
  },
  {
    id: 4,
    question:
      'If another trade damages your completed electrical work, the correct response is to:',
    options: [
    ...
    correctAnswer: 2,
    explanation:
      "The professional approach is to document the damage with photographs, approach the other trade's supervisor calmly and factually, and raise the issue through the site management chain if direct discussion does not resolve it. This protects you contractually and maintains working relationships.",
  },
  {
    id: 5,
    ...
    correctAnswer: 2,
    explanation:
      'Coordination meetings are essential for proactive programme management. They allow trades to agree sequencing, resolve potential clashes before they become on-site problems, coordinate access, and share information about programme changes. Regular attendance prevents far more problems than it creates.',
  },
  {
    id: 6,
    question:
...
export default function LeadershipModule5Section2() {
  useSEO({
    ...
    description:
      'How to coordinate with subcontractors and other trades on multi-trade construction sites — setting expectations, sequencing, quality, and building professional relationships.',
  });
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-rose-500/5 border-l-2 border-rose-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Reality:</strong> Multiple trades share spaces with interdependent
                programmes
              </li>
              <li>
                <strong>Key skill:</strong> Coordination and sequencing across trades
              </li>
              <li>
                <strong>Approach:</strong> Professional, factual, documented communication
              </li>
              <li>
                <strong>Goal:</strong> Build a reputation as fair, competent, and easy to work with
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-rose-500/5 border-l-2 border-rose-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Mechanical:</strong> HVAC &mdash; containment routes, plant rooms
              </li>
              <li>
                <strong>Drylining:</strong> Back boxes, containment access, fire barriers
              </li>
              <li>
                <strong>Plumbing:</strong> Penetrations, risers, plant room sequencing
              </li>
              <li>
                <strong>Fire alarm:</strong> Zoning, detector positions, cause-and-effect
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-rose-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                On any construction project of reasonable size, multiple trades work simultaneously
                in shared spaces with interdependent programmes. Each trade has its own culture,
                norms, commercial pressures, and priorities. As an electrical supervisor, you do not
                work in isolation &mdash; you are one part of a complex, interconnected system.
              </p>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-base text-white leading-relaxed">
                  The order in which trades carry out their work is critical. First fix electrical
                  must happen before drylining closes up walls. Containment must be installed before
                  cables are pulled. Plastering must be complete before second fix fittings. Get the
                  sequence wrong and you create rework, delays, and conflict.
                </p>
              </div>

              <p>
                Each trade has its own commercial pressures and programme. The mechanical contractor
                wants to get their ductwork in early because it takes up the most space. The plumber
                wants to pressure-test before the walls are closed up. The dryliner wants to board
                and plaster in one continuous run without stopping for every back box you forgot to
                install. Understanding these competing pressures &mdash; and finding workable
                compromises &mdash; is a core skill of effective multi-trade coordination.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Phase 1 &mdash; Containment:</strong> Cable
                      tray, basket, trunking, and conduit installed after structure is complete but
                      before other services fill the ceiling void
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Phase 2 &mdash; First fix:</strong> Back boxes,
                      floor boxes, conduit drops, and cable pulling. Must be complete before
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Phase 3 &mdash; Second fix:</strong>{' '}
                      Accessories, luminaires, distribution board terminations. Requires plastering
                      and decoration to be substantially complete
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">
                        Phase 4 &mdash; Testing and commissioning:
                      </strong>{' '}
                      Full test and inspection, commissioning of systems, handover documentation
                    </span>
                  </li>
                </ul>
              </div>
          ...
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                absolutely clear about what you expect. Do not assume they know your standards
                &mdash; they have been on different sites with different supervisors, and every site
                is different.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Quality standards</strong> &mdash; what is
                      acceptable and what is not. Show examples of the standard you expect. Be
                      specific about fixings, alignments, labelling, and finish quality.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Areas of work</strong> &mdash; exactly which
                      zones, floors, or rooms they are working in. Clear boundaries prevent overlap
                      and conflict.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Timelines</strong> &mdash; when you need their
                      work completed by, including interim milestones. Link to the overall programme
                      so they understand the context.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Access arrangements</strong> &mdash; working
                      hours, restricted areas, key holding, scaffold access, permit requirements.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Welfare and site rules</strong> &mdash; welfare
                      facilities, smoking areas, parking, waste disposal, housekeeping standards.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">PPE and safety standards</strong> &mdash;
                      mandatory PPE, site-specific hazards, emergency procedures, reporting
                      requirements.
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  expectations were communicated clearly from the start.
                </p>
              </div>

              <p>
                Setting expectations is not a one-off event. As work progresses, conditions change,
                and new challenges emerge, you will need to <strong>reinforce and update</strong>{' '}
                your expectations. Regular check-ins with subcontractor foremen &mdash; even a
                five-minute conversation at the start of each day &mdash; keep standards consistent
                and catch problems early. The investment in communication always pays for itself in
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      cleaning up at the end of each shift, removing waste, keeping corridors and
                      escape routes clear
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Protection of completed work</strong> &mdash;
                      covering finished surfaces, protecting installed fittings, not stacking
                      materials on completed work
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Fire barrier reinstatement</strong> &mdash;
                      ensuring all penetrations through fire-rated walls and floors are properly
                      fire-stopped after services installation
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Labelling and identification</strong> &mdash;
                      marking cables, circuits, and distribution boards clearly during installation,
                      not leaving it until second fix
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The most common source of conflict between trades is sequencing: &ldquo;I
                can&rsquo;t do my second fix until the plasterer&rsquo;s finished, but they
                won&rsquo;t plaster until the plumber moves his pipes.&rdquo; These circular
                dependencies are a daily reality on construction sites and require proactive
              ...
              <p>
                Be flexible where possible but firm on quality. If another trade asks you to adjust
                your containment route by 100mm to accommodate their ductwork, and it does not
                compromise your installation, accommodate them. Flexibility builds goodwill and is
                reciprocated. But if a compromise would affect cable capacity, segregation
                distances, or BS 7671 compliance, explain why and stand firm.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Attend every meeting</strong> &mdash; decisions
                      get made whether you are there or not. If you are absent, decisions will be
                      made without your input and may not suit your programme.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Come prepared</strong> &mdash; bring your
                      look-ahead programme, a list of areas you need access to, and any issues that
                      need resolving. Being prepared shows professionalism and gets better results.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Raise issues early</strong> &mdash; do not wait
                      for problems to become crises. If you can see a sequencing clash developing
                      two weeks ahead, raise it now while there is time to resolve it.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Follow up actions</strong> &mdash; if
                      commitments are made at the meeting, check they are being delivered. A
                      coordination meeting is only useful if actions are followed through.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  waiting until their delay blocks your work. Early warning gives everyone more
                  options.
                </p>
              </div>
            </div>
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                contractor drives a heavy trolley over your floor boxes, the quality of your
                installation is compromised &mdash; even though you did everything right.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Back boxes filled with plaster</strong> &mdash;
                      plasterers covering socket and switch positions. This requires time-consuming
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Containment damaged by other trades</strong>{' '}
                      &mdash; cable tray bent, trunking lids removed, basket tray crushed by heavy
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Cables cut or disturbed</strong> &mdash; other
                      trades cutting through cables when drilling or chasing. This is both a quality
                      and safety issue.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Fire barrier integrity compromised</strong>{' '}
                      &mdash; trades breaching fire barriers without proper reinstatement. This is a
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  factually. Do not get into slanging matches on the work floor &mdash; it is
                  unprofessional and counterproductive. If direct discussion does not resolve it,
                  raise the issue through the site management chain with your photographic evidence.
                </p>
              </div>
              ...
              <p>
                ...
                discuss protection requirements at coordination meetings. When other trades
                understand the impact of damaging electrical work &mdash; including the safety
                implications of cutting through cables &mdash; they are more likely to take care.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Step 1:</strong> Direct conversation with the
                      other trade&rsquo;s supervisor or foreman. Most issues resolve here when
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Step 2:</strong> Follow-up email confirming the
                      discussion and agreed actions. Creates a paper trail if the issue recurs.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Step 3:</strong> Raise at the weekly
                      coordination meeting with the site manager present. Formal forum with minutes
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Step 4:</strong> Formal written complaint
                      through the principal contractor&rsquo;s management chain. Include
                      photographic evidence, dates, and previous attempts to resolve.
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-amber-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Even when you disagree with other trade supervisors &mdash; and you will &mdash;
                maintain professionalism. The construction world is smaller than you think. You will
                work with these people again on future projects, sometimes in different roles or for
                different employers. Your reputation travels with you.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Be professional always</strong> &mdash; even
                      under pressure, even when provoked, even when you are right and they are
                      wrong. Losing your temper loses you respect.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Help other trades when you can</strong> &mdash;
                      reciprocity is one of the most powerful forces in human relationships. If you
                      help them today, they are far more likely to help you tomorrow.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Share information freely</strong> &mdash; do
                      not hoard programme information, design changes, or site intelligence. Share
                      it and build trust.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">
                        Attend coordination meetings and social events
                      </strong>{' '}
                      &mdash; being present and engaged builds relationships. Do not be the
                      supervisor who is always absent or disengaged.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">
                        Build a reputation for fairness and competence
                      </strong>{' '}
                      &mdash; be someone that other trades respect. This makes every aspect of
                      coordination easier.
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-rose-500">Remember:</strong> The best supervisors are
                  known not just for technical competence, but for being easy to work with. When the
                  site manager is putting together a team for the next project, they pick
                  supervisors who coordinate well, communicate effectively, and do not create
                  unnecessary conflict. Your interpersonal skills are as important as your technical
                  skills.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-green-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Managing subcontractors and coordinating with other trades is one of the most
                challenging and important aspects of the supervisor&rsquo;s role. The key points
              ...
              <ul className="text-sm text-white/80 space-y-2">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong className="text-white">Multi-trade reality:</strong> Multiple trades
                    share spaces with interdependent programmes. Sequencing is everything &mdash;
                    get it wrong and you create rework, delays, and conflict.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Set expectations early:</strong> From day one, be
                    clear about quality, timelines, access, safety, and site rules. Put it in
                    writing. Never assume they know your standards.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Pre-plan to avoid clashes:</strong> Use drawings
                    and markups to agree containment routes, penetrations, and access before
                    starting work. Attend coordination meetings.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Address quality issues professionally:</strong>{' '}
                    Document damage with photographs. Approach calmly and factually. Escalate
                    through proper channels if direct discussion fails.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Build professional relationships:</strong> Be
                    fair, competent, and easy to work with. Help others. Share information. The
                    construction world is small &mdash; your reputation follows you.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Be flexible but firm:</strong> Accommodate other
                    trades where possible, but never compromise on quality, safety, or regulatory
                    compliance.
                  </span>
                </li>
              </ul>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-rose-500">Next:</strong> In Section 3, we will examine
                  your role as a health and safety leader &mdash; your legal duties under CDM 2015
                  and HASAWA 1974, leading by example, building safety culture, conducting
                  meaningful inductions, and having the courage to stop unsafe work.
                </p>
              </div>
            </div>
          </div>
