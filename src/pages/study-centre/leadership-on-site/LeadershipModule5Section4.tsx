...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    question:
      'According to the 70-20-10 model, where does the majority of workplace learning happen?',
    options: [
    ...
    correctIndex: 2,
    explanation:
      "The 70-20-10 model shows that 70% of learning happens on the job through hands-on experience, 20% from others (mentoring, feedback, observation), and only 10% from formal training (courses, qualifications). This means the supervisor and mentor have a far greater impact on an apprentice's development than their college.",
  },
  {
    id: 'lead-apprentice-retention',
    question:
      'Research shows that the NUMBER ONE reason apprentices leave the electrical trade is:',
    options: [
...
const quizQuestions = [
  ...
  },
  {
    id: 3,
    question:
      'The 70-20-10 model tells us that the largest proportion of workplace learning comes from:',
    options: [
    ...
    correctAnswer: 2,
    explanation:
      "The 70-20-10 model shows that 70% of learning happens on the job through hands-on experience. This means that the quality of on-site mentoring and supervision has a far greater impact on an apprentice's development than their college training (which falls within the 10% formal training category).",
  },
  {
    id: 4,
    ...
    correctAnswer: 1,
    explanation:
      'Mentoring is about guiding, supporting, and developing — helping someone find their own answers rather than always providing yours. Key mentoring skills include patience, active listening, asking good questions, sharing experience (not lecturing), setting appropriate challenges, and providing psychological safety to make mistakes.',
  },
  {
    id: 5,
    question:
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'Research consistently identifies a poor relationship with the supervisor/mentor as the number one reason apprentices leave the trade. The supervisor has more influence on retention than the college, the employer, or the pay. Being supportive, patient, and encouraging is one of the most impactful things a supervisor can do for the industry.',
  },
  {
    id: 8,
...
export default function LeadershipModule5Section4() {
  useSEO({
    ...
    description:
      "How to develop the next generation of electricians — learning theory, effective mentoring, SMART goals, and the supervisor's impact on apprentice retention.",
  });
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-rose-500/5 border-l-2 border-rose-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Skills shortage:</strong> Thousands of electricians retiring; recruitment
                lagging
              </li>
              <li>
                <strong>70-20-10:</strong> 70% of learning happens on the job, not in college
              </li>
              <li>
                <strong>Mentoring:</strong> Guide, support, develop &mdash; not lecture
              </li>
              <li>
                <strong>Retention:</strong> Poor supervision is the #1 reason apprentices leave
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-rose-500/5 border-l-2 border-rose-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Kolb&rsquo;s Cycle:</strong> Experience &rarr; Reflect &rarr; Conceptualise
                &rarr; Experiment
              </li>
              <li>
                <strong>GROW model:</strong> Goal, Reality, Options, Will
              </li>
              <li>
                <strong>SMART goals:</strong> Specific, Measurable, Achievable, Relevant, Time-bound
              </li>
              <li>
                <strong>Be the supervisor:</strong> You wished you had had
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-rose-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The UK construction industry faces a <strong>massive skills shortage</strong>. JIB
                and CITB data consistently shows that thousands of electricians will retire in the
                next decade, and recruitment is not keeping pace. The demand for electrical skills
                is actually
                <strong> increasing</strong> &mdash; driven by the green energy transition, electric
                vehicle charging infrastructure, smart buildings, and the electrification of heating
                systems.
              </p>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-base text-white leading-relaxed">
                  Every apprentice you develop today is an{' '}
                  <strong>investment in the industry&rsquo;s future</strong>. As a leader,
                  developing people is one of the most important things you will ever do. The
                  electrician you mentor today may supervise their own team in five years. They may
                  run their own company in ten. The standards, values, and skills you instil now
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Productivity:</strong> A well-trained
                      apprentice becomes a valuable team member who increases your team&rsquo;s
                      output within months
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Reputation:</strong> Being known as someone who
                      develops good electricians enhances your professional reputation and career
                      prospects
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Satisfaction:</strong> Watching someone you
                      mentored grow into a competent, confident electrician is one of the most
                      rewarding experiences in the trade
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Legacy:</strong> Your skills, knowledge, and
                      standards live on through the people you develop. This is how craftsmanship is
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  is growing faster than almost any other trade. Without effective apprentice
                  development, the industry simply cannot deliver the projects the country needs.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Not everyone learns the same way. Understanding <strong>how</strong> people learn
                makes you a far more effective mentor and supervisor. Two key frameworks help
                explain workplace learning: <strong>Kolb&rsquo;s Learning Cycle</strong> and the{' '}
                <strong>70-20-10 model</strong>.
              </p>
              ...
              <p>
                ...
                experimenters), some by reading and understanding the theory (abstract
                conceptualisers). Good mentors adapt their approach to the individual. If an
                apprentice is struggling with a concept, try explaining it differently &mdash; show
                them rather than telling them, or let them try it rather than just watching.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Step 1 &mdash; Let them do it:</strong> Give
                      the apprentice a task appropriate to their level. Let them attempt it (with
                      appropriate supervision for safety).
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Step 2 &mdash; Help them reflect:</strong> Ask
                      &ldquo;How did that go? What was difficult? What went well?&rdquo; Do not just
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Step 3 &mdash; Explain the theory:</strong> Now
                      connect the practice to the theory. &ldquo;The reason we do it this way is
                      because BS 7671 requires...&rdquo;
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Step 4 &mdash; Let them try again:</strong>{' '}
                      Armed with new understanding, let them try the task again. This time, they
                      will approach it with more knowledge and confidence.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80 mt-3">
                  ...
                  through the work you assign them and the mentoring you provide.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Mentoring is <strong>not</strong> the same as teaching. Teaching is transferring
                knowledge. Mentoring is guiding, supporting, and developing &mdash; helping someone
                find their own answers rather than always giving them yours. The best mentors ask
                more questions than they give answers.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Patience</strong> &mdash; everyone was a
                      beginner once, including you. Allow time for learning and accept that mistakes
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Active listening</strong> &mdash; listen to
                      understand, not just to respond. Pay attention to what the apprentice is
                      really telling you about their struggles and needs.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Asking good questions</strong> &mdash; instead
                      of &ldquo;Do it this way,&rdquo; try &ldquo;Why do you think we do it this
                      way?&rdquo; or &ldquo;What would happen if we did it differently?&rdquo;
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Sharing experience</strong> &mdash; tell
                      stories from your own career, including mistakes you made. This is mentoring,
                      not lecturing. It builds trust and shows you are human.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Setting appropriate challenges</strong> &mdash;
                      stretch them just beyond their comfort zone. Too easy and they get bored; too
                      hard and they lose confidence.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Psychological safety</strong> &mdash; create an
                      environment where mistakes are learning opportunities, not reasons for
                      humiliation. An apprentice who is afraid to ask questions stops learning.
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Work with your apprentice to set <strong>SMART development goals</strong> that go
                beyond simply &ldquo;finish the NVQ.&rdquo; A well-rounded development plan produces
                a well-rounded electrician who is ready for the demands of the modern industry.
              </p>
              ...
              <p>
                Review progress <strong>regularly</strong> &mdash; monthly at minimum. Do not wait
                for the formal college review. Have informal check-in conversations: &ldquo;How are
                you getting on with X?&rdquo; &ldquo;What have you found challenging this
                week?&rdquo; &ldquo;What do you want to learn next?&rdquo; And{' '}
                <strong>celebrate achievements</strong>. When an apprentice completes a challenging
                task independently for the first time, acknowledge it. Recognition is a powerful
                motivator.
              </p>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  tests, and ring final circuit continuity, achieving accurate results within 10% of
                  the expected values.&rdquo; This is{' '}
                  <strong className="text-white">Specific</strong> (defines the exact task),{' '}
                  <strong className="text-white">Measurable</strong> (accurate results),
          ...
          <div className="border-l-2 border-amber-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                <strong>number one reason apprentices leave the trade</strong> is a poor
                relationship with their supervisor or mentor. Not the pay. Not the college work. Not
                the weather. <strong>You.</strong>
              </p>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  toughest times. A dismissive, impatient, or hostile supervisor can drive even the
                  most talented apprentice out of the industry forever.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Being treated as cheap labour</strong> &mdash;
                      only given labouring tasks, never taught, never developed. The apprentice
                      feels used rather than valued.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Public humiliation for mistakes</strong>{' '}
                      &mdash; being shouted at, mocked, or belittled in front of others. This
                      destroys confidence and creates fear.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Lack of interest or engagement</strong> &mdash;
                      a supervisor who does not take time to explain, answer questions, or show
                      interest in the apprentice&rsquo;s development.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Bullying and hostile environments</strong>{' '}
                      &mdash; &ldquo;banter&rdquo; that crosses the line into harassment, exclusion,
                      or intimidation. This is unacceptable regardless of &ldquo;how things used to
                      be.&rdquo;
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  is a failure of leadership &mdash; and a loss the industry cannot afford.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Being given real work</strong> &mdash; not just
                      sweeping up and making tea. Apprentices who do meaningful electrical work feel
                      valued and engaged.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Having a patient mentor</strong> &mdash;
                      someone who explains things clearly, answers questions without irritation, and
                      remembers what it was like to be new.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Feeling part of the team</strong> &mdash;
                      included in conversations, invited to social events, treated as a colleague
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Seeing a clear path forward</strong> &mdash;
                      understanding what they are working towards, with regular progress reviews and
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Being respected as a person</strong> &mdash; no
                      bullying, no humiliation, no &ldquo;that&rsquo;s how I was treated so
                      that&rsquo;s how you get treated&rdquo; mentality.
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-green-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Supporting apprentices and new starters is not a side task &mdash; it is one of the
                most important things you will do as a supervisor and leader. The key points from
                this section are:
              </p>
              ...
              <ul className="text-sm text-white/80 space-y-2">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong className="text-white">Skills shortage:</strong> The UK electrical
                    industry faces a critical shortage. Every apprentice you develop is an
                    investment in the future of the trade.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">How people learn:</strong> Kolb&rsquo;s Learning
                    Cycle shows learning happens through experience, reflection, theory, and
                    experimentation. The 70-20-10 model shows 90% of learning happens outside the
                    classroom.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Mentor, do not lecture:</strong> Guide, support,
                    and ask questions. Use the GROW model. Create psychological safety. Share your
                    experience, including your mistakes.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Set SMART goals:</strong> Cover technical,
                    professional, personal, and qualification goals. Review monthly. Celebrate
                    achievements.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">You determine retention:</strong> A poor
                    supervisor relationship is the number one reason apprentices leave. Your
                    influence is greater than college, employer, or pay.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    ...
                    Patient, encouraging, supportive, and invested in your apprentice&rsquo;s
                    success.
                  </span>
                </li>
              </ul>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-rose-500">Congratulations</strong> &mdash; you have
                  completed Module 5 of the Leadership on Site course. You now have a comprehensive
                  understanding of planning and organising work, managing subcontractors, health and
                  safety leadership, and developing apprentices. These are the practical skills that
                  define effective site supervision. When you are ready, proceed to Module 6 for the{' '}
