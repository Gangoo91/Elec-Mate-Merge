...
const quizQuestions = [
  ...
  },
  {
    id: 5,
    question:
      'When a leader admits a mistake quickly and honestly, the typical effect on team trust is:',
    options: [
  ...
  },
  {
    id: 8,
    question:
      'An electrician accidentally connects a circuit incorrectly but immediately reports the error. Under Just Culture principles, the appropriate response is to:',
    options: [
...
export default function LeadershipModule4Section4() {
  useSEO({
    ...
    description:
      'Responsibility vs accountability, the Ladder of Inference, owning mistakes, holding others accountable fairly, and building a Just Culture.',
  });
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-rose-500/5 border-l-2 border-rose-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Responsibility:</strong> Who does the task &mdash; can be delegated
              </li>
              <li>
                <strong>Accountability:</strong> Who answers for the outcome &mdash; cannot be
                delegated
              </li>
              <li>
                <strong>Assumptions:</strong> The Ladder of Inference &mdash; check before acting
              </li>
              <li>
                <strong>Culture:</strong> Just Culture &mdash; console, coach, or discipline
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-rose-500/5 border-l-2 border-rose-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Own it:</strong> Admit mistakes quickly &mdash; it builds trust, not
                weakness
              </li>
              <li>
                <strong>Consistency:</strong> Hold everyone to the same standard, no exceptions
              </li>
              <li>
                <strong>Safety:</strong> Create an environment where people report errors freely
              </li>
              <li>
                <strong>Learning:</strong> If people hide mistakes, the same errors keep repeating
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-rose-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
                  ...
                  <div className="bg-white/5 rounded-lg p-3">
                    ...
                    <p className="text-white mt-1">
                      ...
                      that installation &mdash; even though someone else did the work.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <p>
                This is a fundamental principle of leadership:{' '}
                <strong>
                  you can delegate responsibility but you cannot delegate accountability
                </strong>
                . As a supervisor, you are accountable for everything your team does &mdash; even
                tasks you did not personally perform. When something goes wrong, you cannot say
                &ldquo;that was Dave&rsquo;s job, not mine.&rdquo; Dave was responsible for doing
                the work. You are accountable for the outcome.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">You set the standards</strong> &mdash; if you
                      do not make expectations clear, you cannot hold anyone accountable for not
                      meeting them
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">You provide the resources</strong> &mdash; if
                      the team does not have the tools, materials, or training they need, the
                      failure is yours
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">You check the work</strong> &mdash;
                      accountability means following up, not just assigning and hoping for the best
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">You answer for the outcome</strong> &mdash;
                      when the site manager asks why the programme is behind, you answer, not your
                      team
                    </span>
                  </li>
                </ul>
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">
                        &ldquo;That was Dave&rsquo;s job&rdquo;
                      </strong>{' '}
                      &mdash; blaming the person you delegated to instead of owning the outcome as
                      their supervisor
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">&ldquo;Nobody told me&rdquo;</strong> &mdash;
                      as a supervisor, it is your job to find out, not to wait to be told
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">&ldquo;It was not in my scope&rdquo;</strong>{' '}
                      &mdash; even if technically true, leaders find ways to solve problems rather
                      than hide behind boundaries
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">&ldquo;I did not know&rdquo;</strong> &mdash;
                      as the person accountable, knowing is your responsibility
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  progress. <strong className="text-white">Abdication</strong> means handing over
                  and walking away without any follow-up or support. When you delegate, you remain
                  accountable for the outcome. Effective delegation includes clear instructions, the
                  right level of support for the individual&rsquo;s experience level, defined check
                  points at agreed intervals, and a feedback loop &mdash; not just &ldquo;get on
                  with it.&rdquo;
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The Ladder of Inference, developed by organisational psychologist{' '}
                <strong>Chris Argyris</strong>, describes how we move from observable data to action
                through a series of mental steps &mdash; often unconsciously and at great speed.
                Understanding this process is critical for leaders because it explains how we arrive
                at flawed conclusions and unfair judgements.
              </p>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <p className="text-sm font-medium text-rose-400">
                    The Seven Rungs (Bottom to Top)
                  </p>
                </div>
                <div className="space-y-2 text-sm">
                  <div className="bg-white/5 rounded-lg p-3">
                    <p className="text-white">
                      <strong>1. Observable Data</strong> &mdash; The raw facts available to
                      everyone. What a camera would record.
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-lg p-3">
                    <p className="text-white">
                      <strong>2. Select Data</strong> &mdash; You unconsciously filter what you
                      notice. You cannot process everything, so your brain selects what seems
                      relevant.
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-lg p-3">
                    <p className="text-white">
                      <strong>3. Add Meaning</strong> &mdash; You interpret what you have noticed
                      through your own lens &mdash; your experience, culture, values, and
                      assumptions.
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-lg p-3">
                    <p className="text-white">
                      <strong>4. Make Assumptions</strong> &mdash; Based on your interpretation, you
                      fill in the gaps with assumptions about what is happening and why.
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-lg p-3">
                    <p className="text-white">
                      <strong>5. Draw Conclusions</strong> &mdash; You reach a conclusion about the
                      situation based on your assumptions.
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-lg p-3">
                    <p className="text-white">
                      <strong>6. Adopt Beliefs</strong> &mdash; Your conclusion becomes a belief
                      that shapes how you see this person or situation going forward.
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-lg p-3 border border-rose-500/30">
                    <p className="text-white">
                      <strong>7. Take Action</strong> &mdash; You act based on your beliefs, which
                      may be completely wrong because they rest on filtered data and unchecked
                      assumptions.
                    </p>
                  </div>
                </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white mb-3">
                  ...
                  <strong className="text-white">beliefs influenced what data they selected</strong>{' '}
                  (the reflexive loop) &mdash; if they already believe the worker is lazy, they
                  interpret the phone use negatively.
                </p>
            ...
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-base text-white leading-relaxed">
                  <strong>
                    &ldquo;I got that wrong. Here is what I am going to do about it.&rdquo;
                  </strong>
                  <br />
                  <br />
                  This is one of the most powerful things a leader can say. It demonstrates
                  integrity, builds trust, and shows the team that it is safe to be honest about
                  mistakes.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">In the toolbox talk:</strong> &ldquo;Yesterday
                      I made a call to prioritise Zone C over Zone B. That turned out to be wrong
                      because the plastering overran. Today we are correcting that &mdash; here is
                      the revised plan.&rdquo;
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">In the progress meeting:</strong> &ldquo;We
                      lost a day because I underestimated the cable pulling time. I have adjusted
                      the forecast and here is how we recover.&rdquo;
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">With your manager:</strong> &ldquo;I made the
                      wrong call on the material order. It is going to cost us an extra day. I have
                      already sourced an alternative and we can recover by Thursday.&rdquo;
                    </span>
                  </li>
                </ul>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Accountability is not about blame &mdash; it is about setting clear expectations and
                following through consistently. The steps are straightforward, but the consistency
                is where most supervisors fail.
              </p>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-3">
                  The Five Steps of Fair Accountability
                </p>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  clear: standards do not matter &mdash; favouritism does.{' '}
                  <strong className="text-white">
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">State the standard:</strong> &ldquo;We agreed
                      that all terminations would be tested before glanding off.&rdquo;
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">State the gap:</strong> &ldquo;I have checked
                      three junction boxes and none were tested before being closed up.&rdquo;
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Ask for their perspective:</strong> &ldquo;Help
                      me understand what happened.&rdquo;
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Agree the fix:</strong> &ldquo;What are we
                      going to do differently from tomorrow?&rdquo;
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Follow up:</strong> Check within 24 hours that
                      the new approach is being followed.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">If people hide mistakes</strong>, the same
                      errors repeat because the organisation never learns from them
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">If people fear speaking up</strong>, safety
                      hazards go unreported, near misses are concealed, and avoidable accidents
                      happen
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">If people feel safe to speak</strong>, errors
                      are caught early, ideas improve, and the team continuously learns and improves
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-green-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Accountability is the bedrock of effective leadership. It is not about being perfect
                &mdash; it is about owning outcomes, checking assumptions, and creating an
              ...
              <ul className="text-sm text-white space-y-2">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong className="text-white">Responsibility vs accountability:</strong> You
                    can delegate who does the task, but you cannot delegate who answers for the
                    outcome
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Ladder of Inference:</strong> We move from data
                    to action through unconscious mental steps &mdash; always check your assumptions
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Own your mistakes:</strong> &ldquo;I got that
                    wrong, here is what I am going to do about it&rdquo; &mdash; admit fast, learn,
                    move on
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Fair accountability:</strong> Set standards,
                    communicate, follow up, address shortfalls, apply consequences consistently
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Just Culture:</strong> Human error (console),
                    at-risk behaviour (coach), reckless behaviour (discipline)
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Psychological safety:</strong> People must feel
                    safe to speak up, report errors, and raise concerns without fear
                  </span>
                </li>
              </ul>
