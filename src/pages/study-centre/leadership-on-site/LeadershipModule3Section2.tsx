...
const quickCheckQuestions = [
  ...
  },
  {
    id: 'al-questions',
    question:
      'Which type of question should a leader generally AVOID using during a conversation with a team member?',
    options: [
...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      "Reflecting feelings means acknowledging the emotion behind what someone is saying. 'It sounds like that situation really frustrated you' names the feeling and shows you are listening to more than just the factual content. This builds trust and encourages the person to share more.",
  },
  {
    id: 5,
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      "Paraphrasing means restating the speaker's key message in your own words to confirm understanding. For example, 'So what you're saying is the access route isn't safe because of the excavation.' This shows you have listened, gives the speaker a chance to correct any misunderstanding, and builds rapport.",
  },
];
...
export default function LeadershipModule3Section2() {
  useSEO({
    ...
    description:
      'The five levels of listening, SOLER model, open vs closed questions, and reading non-verbal cues — essential communication skills for site leaders.',
  });
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-rose-500/5 border-l-2 border-rose-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Core skill:</strong> Active listening is deliberate and conscious
              </li>
              <li>
                <strong>5 levels:</strong> From ignoring to empathic listening
              </li>
              <li>
                <strong>SOLER model:</strong> Squarely, Open, Lean, Eye contact, Relax
              </li>
              <li>
                <strong>Key fact:</strong> Poor listening causes mistakes and missed hazards
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-rose-500/5 border-l-2 border-rose-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Questions:</strong> Open questions reveal more than closed ones
              </li>
              <li>
                <strong>Avoid:</strong> Leading questions that suggest the &ldquo;right&rdquo;
                answer
              </li>
              <li>
                <strong>Non-verbal:</strong> Body language often says more than words
              </li>
              <li>
                <strong>Courage:</strong> &ldquo;Are you alright, mate?&rdquo; saves lives
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-rose-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Most people <strong>hear</strong> but do not truly <strong>listen</strong>. Hearing
                is passive &mdash; it happens automatically when sound waves reach your ears.
                Listening is active &mdash; it is a deliberate, conscious skill that requires focus,
                attention, and the intention to understand.
              </p>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-base text-white leading-relaxed">
                  ...
                  &mdash; Stephen Covey, <strong>The 7 Habits of Highly Effective People</strong>
                </p>
              </div>

              <p>
                This observation cuts to the heart of the problem. When someone is talking to you,
                the natural tendency is to start preparing your response before they have finished
                speaking. You are filtering their words through your own experience, forming
                judgements, and constructing your reply &mdash; all while they are still talking.
                The result? You miss nuance, misunderstand intent, and respond to what you{' '}
                <em>think</em> they said rather than what they <em>actually</em> said.
              </p>

              <p>
                On a construction site, <strong>poor listening causes real problems</strong>.
                Instructions are misunderstood, leading to rework. Hazards are reported but not
                acted upon because the supervisor was not truly paying attention. Concerns are
                raised but dismissed, so the worker stops raising them. Relationships deteriorate
                because people do not feel heard. In safety-critical environments, the consequences
                can be severe &mdash; a missed warning, a misunderstood instruction, an ignored
                concern can all lead to serious incidents.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  information, which leads to better decisions.{' '}
                  <strong className="text-white">
                    Leaders who listen well get told the truth. Leaders who listen poorly get told
          ...
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                understanding the quality of your listening and identifying where you need to
                improve.
              </p>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  <strong className="text-white">levels 4 and 5</strong>. This does not happen
                  naturally &mdash; it requires deliberate practice, self-awareness, and the
                  discipline to give people your genuine, undivided attention.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm text-white/80">
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    ...
                    <p>
                      Face the person directly. This signals that you are giving them your full
                      attention. Turning away or angling your body suggests you have one foot out
                      the door.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    ...
                    <p>
                      Arms uncrossed, body language receptive. Crossed arms signal defensiveness or
                      impatience. An open posture says &ldquo;I am ready to hear what you have to
                      say.&rdquo;
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    ...
                    <p>
                      A slight lean towards the speaker shows engagement and interest. Leaning back
                      or slouching suggests boredom or disengagement.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    ...
                    <p>
                      Maintain comfortable eye contact. Not a fixed stare, but regular, natural eye
                      contact that shows you are focused on them, not on your phone or the site
                      around you.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg sm:col-span-2">
                    ...
                    <p>
                      Appear calm and unhurried, even if you are busy. Tension, fidgeting, or
                      obvious impatience tells the speaker they are an inconvenience. Relaxed body
                      language creates a safe space for honest communication.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Paraphrasing</strong> &mdash; &ldquo;So what
                      you&rsquo;re saying is the access route isn&rsquo;t safe because of the
                      excavation?&rdquo; Restating in your own words confirms understanding.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Reflecting feelings</strong> &mdash; &ldquo;It
                      sounds like that situation really frustrated you.&rdquo; Naming the emotion
                      shows you are listening beyond just the facts.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Summarising</strong> &mdash; &ldquo;So the main
                      issues are X, Y, and Z. Have I got that right?&rdquo; Drawing together the key
                      points and checking for accuracy.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Clarifying questions</strong> &mdash;
                      &ldquo;When you say the board wasn&rsquo;t right, what specifically was wrong
                      with it?&rdquo; Seeking clarity rather than making assumptions.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  more important than what they are saying. It shuts down communication and
                  discourages people from coming to you in future.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The questions you ask shape the answers you receive. Understanding the different
                types of questions &mdash; and when to use each &mdash; is a{' '}
                <strong>powerful leadership tool</strong> that directly affects the quality of
                information you get from your team.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm text-white/80">
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    ...
                    <p className="mb-2">
                      Invite yes/no or short factual answers. Useful for confirming specific facts.
                    </p>
                    <p className="text-rose-400 text-xs">
                      &ldquo;Did you isolate the supply?&rdquo;
                    </p>
                  ...
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    ...
                    <p className="mb-2">
                      Encourage fuller responses and reveal more information. Start with how, what,
                      why, tell me.
                    </p>
                    <p className="text-rose-400 text-xs">
                      &ldquo;How did you approach the cable routing?&rdquo;
                    </p>
                    <p className="text-rose-400 text-xs">
                      &ldquo;What concerns do you have about tomorrow&rsquo;s work?&rdquo;
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    <p className="text-white font-medium mb-1">Probing Questions</p>
                    <p className="mb-2">
                      Dig deeper into an issue. Follow up on initial answers to get more detail.
                    </p>
                    <p className="text-rose-400 text-xs">
                      &ldquo;Tell me more about what happened next.&rdquo;
                    </p>
                    <p className="text-rose-400 text-xs">
                      &ldquo;What made you decide to do it that way?&rdquo;
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    <p className="text-white font-medium mb-1">Leading Questions (AVOID)</p>
                    <p className="mb-2">
                      Suggest the answer you want to hear. Put pressure on the person to agree.
                    </p>
                    <p className="text-red-400 text-xs">
                      &ldquo;You did check the isolations, didn&rsquo;t you?&rdquo;
                    </p>
                    <p className="text-red-400 text-xs">
                      &ldquo;That scaffold looks fine to you, doesn&rsquo;t it?&rdquo;
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  . &ldquo;You did check the isolations, didn&rsquo;t you?&rdquo; is not really a
                  question &mdash; it is a statement disguised as a question. The worker feels
                  pressured to say &ldquo;yes&rdquo; even if the honest answer is &ldquo;no&rdquo;
                  or &ldquo;I&rsquo;m not sure.&rdquo; This can mask genuine hazards and prevent
                  honest reporting.
                </p>
              </div>
            </div>
            ...
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Body language</strong> &mdash; crossed arms
                      (defensive), turned away (disengaged), hunched shoulders (stressed or
                      defeated), clenched fists (anger or tension)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Tone of voice</strong> &mdash; flat tone (low
                      mood), raised voice (frustration), hesitation (uncertainty or fear), sarcasm
                      (resentment)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Facial expressions</strong> &mdash; furrowed
                      brow (confusion or concern), avoiding eye contact (discomfort or dishonesty),
                      forced smile (masking true feelings)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Fidgeting</strong> &mdash; restlessness,
                      tapping, inability to keep still can indicate anxiety, impatience, or
                      discomfort with the topic being discussed
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Withdrawal</strong> &mdash; becoming quieter,
                      eating alone, avoiding team interaction, not joining in banter
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Irritability</strong> &mdash; snapping at
                      colleagues, overreacting to minor issues, increased conflict
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Drop in quality</strong> &mdash; making
                      uncharacteristic mistakes, forgetting things, lower standard of work
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-rose-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Changes in timekeeping</strong> &mdash;
                      arriving late, leaving early, increased absence or sickness
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  industry has one of the highest suicide rates of any sector. Many workers struggle
                  in silence. A simple, genuine question &mdash; asked because you have noticed
                  something is off, not as a passing greeting &mdash; can open a door that saves a
                  life. You do not need to be a counsellor. You just need to notice, and care enough
                  to ask.
                </p>
              </div>
            </div>
            ...
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <ul className="text-sm text-white/80 space-y-2">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong className="text-white">Hearing vs listening:</strong> Hearing is passive
                    and automatic. Active listening is deliberate, conscious, and requires genuine
                ...
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Five levels:</strong> Most workplace
                    communication operates at levels 2-3 (pretend and selective listening). Leaders
                    must operate at levels 4-5 (attentive and empathic)
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">SOLER model:</strong> Squarely, Open posture,
                    Lean forward, Eye contact, Relax &mdash; the physical framework for
                ...
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Question types:</strong> Use open questions to
                    explore, closed questions to confirm, probing questions to dig deeper. Avoid
                ...
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Non-verbal cues:</strong> Body language, tone,
                    facial expressions, and behavioural changes often communicate more than words
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Courage to ask:</strong> &ldquo;Are you alright,
                    mate?&rdquo; is construction&rsquo;s most important question. Notice the signs
              ...
              <div className="bg-rose-500/10 border border-rose-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  ...
                  conversations that most leaders dread &mdash; having difficult conversations. You
                  will learn the DESC model, how to prepare, and how to handle the most common
