...
export default function CommunicationConfidenceCourse() {
  useSEO({
    title: 'Communication & Confidence | Personal Development',
    description:
      'Complete Communication & Confidence training — toolbox talks, client conversations, professional writing, negotiation and mock exam. Based on Toastmasters Pathways, Harvard Negotiation Project and ILM Level 2.',
  });
    ...
    <div className="overflow-x-hidden bg-[#1a1a1a]">
      ...
      <main className="px-4 sm:px-8 lg:px-12 pb-12">
        <div className="max-w-5xl mx-auto space-y-6 sm:space-y-8">
          {/* Course Header - ROSE theme for Personal Development */}
          <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-rose-500/10 via-rose-500/5 to-transparent border border-rose-500/15 p-5 sm:p-8">
            ...
            <div className="relative z-10">
              ...
              <p className="text-sm sm:text-base lg:text-lg text-muted-foreground mt-1 max-w-2xl">
                Toolbox talks, client conversations, professional writing and negotiation skills for
