...
const preparationTips = [
  { title: 'Review all five modules', description: 'Questions are drawn from Understanding Communication, Listening, Speaking with Confidence, Professional Writing and Negotiation. Cover every module before attempting the exam.' },
  { title: 'Know the key frameworks', description: "Shannon-Weaver model, Mehrabian 7-38-55 (correctly contextualised), Egan SOLER, Treasure RASA, Covey's 5 levels, Bandura's self-efficacy, DESC model, Fisher & Ury's principled negotiation, and Cialdini's six principles." },
  { title: 'Understand communication styles', description: 'The passive-aggressive-assertive continuum, Thomas Gordon I-messages, Eric Berne transactional analysis, and when to use each communication channel (verbal, written, digital).' },
  { title: 'Remember the practical techniques', description: 'Active listening with RASA, box breathing for anxiety, toolbox talk structure, email etiquette, quote writing, and the preparation framework for difficult conversations.' },
  { title: 'Apply to construction scenarios', description: 'Many questions present site-based scenarios. Think about how communication principles apply to real situations: toolbox talks, client conversations, subcontractor negotiations, and site documentation.' },
  ...
  return (
    <div className="min-h-screen bg-[hsl(0_0%_8%)] text-white">
      <div className="px-4 sm:px-6 lg:px-8 pt-2 pb-24">
        <PageFrame>
          <button
            onClick={() => navigate('../communication-confidence')}
            className="inline-flex items-center gap-2 h-10 px-3 rounded-full bg-white/[0.06] border border-white/[0.1] text-white text-[13px] font-medium touch-manipulation hover:bg-white/[0.1] mb-1 self-start"
          >
            <ArrowLeft className="h-4 w-4" /> Communication & confidence
          </button>

          <PageHero
            eyebrow="Module 6 · Final assessment"
            title="Mock exam"
            description="Put your communication & confidence knowledge to the test under timed exam conditions. Questions are drawn from a 200-question bank covering all five content modules."
            tone="yellow"
          />
          ...
          >
            <div className="rounded-2xl bg-gradient-to-br from-elec-yellow/15 via-amber-500/10 to-transparent border border-elec-yellow/30 p-5 sm:p-6 active:scale-[0.99] transition-transform">
              <div className="flex items-center justify-between gap-3">
                ...
                <PrimaryButton size="lg" onClick={() => navigate('../cc-mock-exam')}>
