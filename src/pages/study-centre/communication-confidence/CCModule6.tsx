    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Put your communication & confidence knowledge to the test under timed exam conditions.
        ...
        <Link to="../cc-mock-exam" className="block touch-manipulation focus:outline-none">
