...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: [
      'Stress is purely a physical condition while burnout is purely a mental one',
      'Stress only affects managers, whereas burnout affects all workers equally',
      'Stress is short-term pressure; burnout is sustained pressure with no recovery',
      'There is no meaningful difference — they are the same thing under two names',
    ],
    correctIndex: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Because employers are slow to arrange the necessary time off work',
      'Because the NHS waiting list for therapy and counselling is long',
      'Because people experiencing burnout are too lazy to recover quickly',
      'Because deep physiological depletion of the nervous and hormonal systems needs extended time to reset',
    ],
    correctIndex: 3,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: [
      'Forgetting your own name and basic details due to extreme fatigue',
      'Emotional detachment from your work and colleagues, shown as cynicism',
  ...
  },
  {
    ...
    options: [
      'Stress is caused by work, whereas burnout is caused by relationships',
      'Stress affects only the body, whereas burnout affects only the mind',
      'Stress is too much pressure; burnout is too much pressure without recovery',
      'They are identical conditions simply given two different names',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Because holidays are inherently boring and do not actually help with stress',
      'Because one week is not enough time to finish all the DIY jobs at home',
      'Because most employers do not allow workers to take long enough holidays',
      'Because burnout needs extended recovery, changed conditions and often professional support',
    ],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Only once they have already been formally signed off work by a doctor',
      'When symptoms persist beyond two weeks, sleep is poor, or mistakes increase',
      'Only if they are actively having thoughts of self-harm or suicide',
      'Never — burnout always resolves on its own without any outside help',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'All three: emotional exhaustion, depersonalisation and reduced accomplishment',
      'Only emotional exhaustion, with the other two dimensions absent here',
      'Only depersonalisation, with the other two dimensions absent here',
      'None of the dimensions — this is simply an ordinary bad week at work',
    ],
    correctAnswer: 0,
    explanation:
