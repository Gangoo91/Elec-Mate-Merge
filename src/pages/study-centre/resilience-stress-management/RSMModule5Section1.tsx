...
const quickCheckQuestions = [
  {
    ...
    options: [
      'Short 5-to-15-minute breaks taken roughly every 90 minutes through the day',
      'A single week-long holiday taken once a year to fully reset',
  ...
  },
  {
    ...
    options: [
      ...
      'Because physical exercise is the only genuinely effective form of recovery',
      'Because stress is a training load — you adapt and grow during recovery, not the stress',
    ],
    correctIndex: 3,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: [
      'A two-week annual holiday taken away from the job',
      'Short 5-to-15-minute breaks taken roughly every 90 minutes through the day',
      'Sleeping for an extra hour or two at the weekend to catch up',
      'Taking every Friday afternoon off as a half-day each week',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['Circadian rhythm', 'Infradian rhythm', 'Ultradian rhythm', 'Diurnal rhythm'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'A short 5-minute stretch break taken during the working day',
      'Extended sick leave taken after a period of serious burnout',
      'A career break lasting six months or more away from the trade',
      'Evenings and weekends used for genuine rest, hobbies and social activity',
    ],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Longer breaks between projects allow deep recovery that short breaks cannot',
      'It frees up time to finish unfinished paperwork from the previous project',
      'It only really matters for office workers, not for trade workers on site',
      'It is essentially the same as micro-recovery but lasting slightly longer',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Work all 52 weeks a year and only take time off when they feel unwell',
      'Take unpaid time off only during quiet spells when no work is available',
      'Treat macro-recovery as relevant only to employed workers with paid leave',
      'Budget for leave by basing the income target on 46 working weeks, not 52',
    ],
    correctAnswer: 3,
    explanation:
