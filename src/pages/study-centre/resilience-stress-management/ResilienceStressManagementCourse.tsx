...
export default function ResilienceStressManagementCourse() {
  useSEO({
    title: 'Resilience & Stress Management | Personal Development',
    description:
      'Complete resilience and stress management course for electricians and tradespeople. Based on MBSR, CBT, HSE Management Standards, and Mates in Mind.',
  });
          ...
          <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-rose-500/10 via-rose-400/5 to-transparent border border-rose-500/15 p-5 sm:p-8">
            ...
            <div className="relative z-10">
              ...
              <p className="text-sm sm:text-base lg:text-lg text-white mt-1 max-w-2xl">
                Managing pressure, bouncing back, switching off &mdash; based on MBSR principles,
                CBT, HSE Management Standards, and Mates in Mind
              </p>
            </div>
          </div>
