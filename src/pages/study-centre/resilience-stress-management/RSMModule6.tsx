    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Put your resilience and stress management knowledge to the test under timed exam
        ...
        <Link to="../rsm-mock-exam" className="block touch-manipulation focus:outline-none">
