...
export default function AsbestosAwarenessMockExamPage() {
  return (
    <PublicMockExamPage
      title={`Asbestos Awareness Mock Test — Free with Answers`}
      description={`Free Asbestos Awareness mock test matched to the Category A syllabus (UKATA/IATP courses). 25 questions, 30-min timer, answers explained. No sign-up.`}
