...
export default function L3FaultDiagnosisMockExamPage() {
  return (
    <PublicMockExamPage
      title={`C&G 2365-03 Level 3 Mock Exam with Answers — Fault Diagnosis`}
      description={`Free City & Guilds 2365-03 Level 3 mock exam with answers explained — Fault Diagnosis. 25 Qs from 251-Q bank. Logical fault-finding, MFT use, dead vs live testing, common fault types, EICR coding.`}
