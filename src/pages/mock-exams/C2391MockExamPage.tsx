...
export default function C2391MockExamPage() {
  return (
    <PublicMockExamPage
      ...
      // 2391-52 covers BOTH units, so the samples show that span: the standard
      // behind them, the purpose of periodic vs initial, and the certificate.
      sampleQuestionIds={[2, 217, 178]}
      questionBank={
