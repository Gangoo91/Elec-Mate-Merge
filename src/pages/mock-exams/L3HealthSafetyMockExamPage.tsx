...
export default function L3HealthSafetyMockExamPage() {
  return (
    <PublicMockExamPage
      title={`Level 3 H&S Supervisor Mock Exam (2365-03)`}
      description={`Free C&G 2365-03 Level 3 Health & Safety mock exam (supervisor grade). 25 Qs from a 251-Q bank. HASAWA, CDM 2015, CAR 2012, FFI notices.`}
