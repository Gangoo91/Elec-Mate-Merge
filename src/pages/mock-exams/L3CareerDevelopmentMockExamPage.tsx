...
export default function L3CareerDevelopmentMockExamPage() {
  return (
    <PublicMockExamPage
      title={`C&G 2365-03 Level 3 Mock Exam with Answers — Career Development`}
      description={`Free City & Guilds 2365-03 Level 3 mock exam with answers explained — Career Development. 25 Qs from 201-Q bank. CPD, ECS Gold Card, NICEIC + NAPIT registration, JIB grades, supervisor pathways.`}
