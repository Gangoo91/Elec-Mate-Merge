...
const sections = [
    ...
    content: (
      <>
        <p>
          ...
          end of the M6 motorway, 10 miles south of the Scottish border. With a population of
          around 75,000 in the city itself and a much larger catchment across north Cumbria and
          south-west Scotland, Carlisle punches above its weight as a commercial centre.
        </p>
        <p>
          ...
          Dumfries and the Scottish Borders. The city's flood history also creates periodic
          demand for rewiring of affected properties.
        </p>
        <p>
          Carlisle is not a nuclear site city in the way that Whitehaven and Workington are —
          Sellafield is 45 miles to the south-west — but some Carlisle-based electricians do
          commute to Sellafield for contract work, particularly on day shifts. The city's
          position on the M6 and A74(M) makes it well-connected for wider Cumbrian and
          cross-border work.
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>
          Electrical work in Carlisle is subject to the standard English regulatory framework:
        </p>
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                electrical work in England. Consumer unit replacements, new circuits, and
                rewires must be either notified to Cumberland Council (the unitary authority for
                most of Cumbria) or self-certified through a competent person scheme such as
                NICEIC or NAPIT.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>BS 7671:2018+A3:2024</strong> — the 18th Edition Wiring Regulations
                apply to all installations. RCD protection requirements under regulation 411.3.3
                apply to circuits in domestic premises. All new work requires an Electrical
                Installation Certificate (EIC), and periodic inspections require an EICR under
                Section 631.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Cumberland Council</strong> — the unitary authority created in 2023
                covering Carlisle (and most of former Cumbria county). Building control,
                planning, and Part P notifications go through Cumberland Council. Note:
                Westmorland and Furness is the separate unitary authority covering the south
                of the county (Barrow, Kendal, South Lakeland).
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Scottish work</strong> — if you regularly work across the border in
                Dumfries and Galloway or the Scottish Borders, Scottish Building Standards
                apply. Building warrants are required for notifiable work, obtained from the
                relevant Scottish local authority. An EIC is still required as evidence of BS
                7671 compliance. SELECT registration simplifies the process for Scottish work.
              </span>
            </li>
          </ul>
        </div>
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                connections portal. Supply capacity upgrades are commonly required for EV
                charger installations at properties with 60A or older 80A supplies, and for
                heat pump installations with high electrical demand.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                must be notified to ENW. G98 (up to 16A per phase) is a straightforward online
                notification. G99 applications for larger systems require prior approval and
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                Pennines) and north on the Solway Plain are more likely to have TT earthing
                via overhead distribution lines. Always confirm the earthing arrangement at
                the intake before designing or quoting work.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                Scotland, including Dumfries and the Scottish Borders. Work carried out north
                of the border requires SPEN notifications rather than ENW. Keep both DNOs'
                contact details if you work cross-border regularly.
              </span>
            </li>
          </ul>
        </div>
    ...
    content: (
      <>
        <p>
          ...
          means that many Carlisle electricians regularly work across the border. This creates
          a need to understand both regulatory systems:
        </p>
        <div className="rounded-2xl bg-amber-500/10 border border-amber-500/20 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Scottish Building Standards vs Part P</strong> — in Scotland, Part P
                does not apply. Instead, the Technical Handbook Section 4 (Safety) governs
                electrical installations. A building warrant from the Scottish local authority
                is required for notifiable work (rewires, consumer unit replacements, new
                circuits) before work starts. The completion certificate must be submitted
                after the work is finished with the EIC as evidence of compliance.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Landmark className="w-5 h-5 text-amber-400 mt-0.5 shrink-0" />
              <span>
                ...
                Certification Services to streamline the building warrant process. This is
                worth considering if you take on regular Scottish work from Carlisle.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Landmark className="w-5 h-5 text-amber-400 mt-0.5 shrink-0" />
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                are the same on both sides of the border. The difference is purely in the
                regulatory compliance and notification route. Electricians who understand both
                systems have a genuine competitive advantage in the Carlisle market.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Carlisle's housing stock spans several centuries, creating a varied range of
        ...
        <div className="grid gap-4 sm:grid-cols-2 my-4">
          <div className="rounded-2xl bg-blue-500/10 border border-blue-500/20 p-5">
            ...
            <p className="text-white text-sm leading-relaxed">
              Solid brick-built terraces in areas such as Denton Holme, Caldewgate, and
              Botcherby are the most common older property type. Solid walls mean no cavity
              for cables — surface trunking or chasing is required. Pre-1980 properties have
              potential asbestos in ceiling and floor materials. Old rubber-insulated wiring
              (TRS or VIR) is still found in unmodernised properties and requires full rewire.
            </p>
          </div>
          <div className="rounded-2xl bg-amber-500/10 border border-amber-500/20 p-5">
            <h3 className="font-bold text-white text-lg mb-3">Flood-Affected Properties</h3>
            <p className="text-white text-sm leading-relaxed">
              Carlisle's 2005 and 2015 floods caused extensive damage in low-lying areas near
              the River Eden and River Caldew. Flood-damaged electrical installations require
              complete inspection and often full rewire. Socket outlets in refurbished
              flood-affected properties should be positioned at a raised height (450mm above
              floor level minimum, higher where flood risk persists). All earthing must be
              verified after flooding.
            </p>
          </div>
          <div className="rounded-2xl bg-green-500/10 border border-green-500/20 p-5">
            ...
            <p className="text-white text-sm leading-relaxed">
              ...
              Harraby, Raffles, and Morton. These properties were built to the standards of
              their era and many now require consumer unit replacement and circuit updates to
              meet current requirements. Properties of this type often have single RCD
              protection or no RCD protection at all, requiring upgrade to meet current
              standards when work is carried out.
            </p>
          </div>
          <div className="rounded-2xl bg-purple-500/10 border border-purple-500/20 p-5">
            <h3 className="font-bold text-white text-lg mb-3">New Builds and Commercial</h3>
            <p className="text-white text-sm leading-relaxed">
              Carlisle has ongoing new-build residential development on the eastern and
              southern fringes of the city, and commercial development along the M6 corridor
              at Kingstown and Durranhill. New-build residential is standard cavity-wall
              construction with modern installations. Commercial logistics and industrial
              units often require three-phase supplies and specialist electrical fit-out work.
            </p>
          </div>
        </div>
      </>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Carlisle electrician rates are competitive with other northern English cities of
          similar size. Typical rates in 2026:
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
        ...
        <p>
          For work in rural areas north and east of Carlisle, apply a travel time premium of
          £20–40 per round trip above approximately 15 miles from the city centre. Cross-border
          Scottish work may also require additional time for building warrant administration —
          factor this into your project quotations.
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>
          Carlisle offers a solid, varied electrical market for sole traders and small firms.
          The combination of residential rewire work, a commercial and institutional sector,
          growing EV and renewable energy demand, and cross-border opportunities with Scotland
          creates a well-rounded workload.
        </p>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  ...
                  on site with AI-assisted board scanning. The Carlisle rental market requires
                  regular EICRs — deliver professional certificates from your phone before
                  you leave site.
                </p>
              </div>
            </div>
        ...
        <SEOAppBridge
          ...
          description="Join 430+ UK electricians using Elec-Mate for cable sizing, professional quoting, and on-site certification. Built for Carlisle's Victorian terraces, cross-border work, and rural Cumbrian properties. 7-day free trial."
          icon={MapPin}
        />
      </>
    ),
...
export default function ElectricianCarlislePage() {
  return (
    <GuideTemplate
      ...
      ctaSubheading="Join 430+ UK electricians using Elec-Mate for cable sizing, quoting, and on-site certification. Built for Carlisle's Victorian terraces, cross-border Scottish work, and rural Cumbrian properties. 7-day free trial."
    />
  );
}
