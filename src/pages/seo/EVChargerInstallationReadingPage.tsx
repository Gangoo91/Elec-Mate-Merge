...
const sections = [
  {
    ...
    content: (
      <>
        <p>
          Reading is one of the South East's most significant economic centres outside London,
          with a large professional and technology sector workforce. The area has seen strong
          growth in EV adoption, driven by higher-than-average household incomes, a significant
          daily commuter population (many of whom previously used the M4 corridor), and
          Reading Borough Council's commitment to achieving net zero by 2030.
        </p>
        <div className="rounded-2xl bg-blue-500/10 border border-blue-500/20 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Reading's EV strategy</strong> — Reading Borough Council has invested
                in public EV charging infrastructure across car parks and on-street locations.
                The council's Electric Vehicle Charging Strategy supports both public charging
                expansion and home charger adoption. Home charging remains by far the most
                cost-effective way to run an EV.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                ...
                drove to London are switching to EVs, making home charging infrastructure
                essential. A full overnight charge at home on an EV tariff can cost as little as
                £3 to £5 — versus £20 to £40 at a public rapid charger for the same amount of
                energy.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                development. Most suburban Reading properties have garages or driveways, making
                home EV charger installation straightforward.
              </span>
            </li>
          </ul>
        </div>
        ...
        <div className="rounded-2xl bg-green-500/10 border border-green-500/20 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Who qualifies?</strong> — You must own or have on order an eligible EV
                or PHEV, and live in a flat or rented accommodation. The residential grant no
                longer applies to homeowners in houses. For flats and rented properties, the grant
                can be combined with an OZEV-approved smart charger to significantly reduce the
                upfront cost.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-green-400 mt-0.5 shrink-0" />
              <span>
                <strong>Workplace Charging Scheme</strong> — Reading businesses can claim up to
                £350 per socket (maximum 40 sockets) for installing EV charge points at
                commercial premises through the OZEV Workplace Charging Scheme. This is
                particularly relevant for Reading's large technology and office campuses.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-green-400 mt-0.5 shrink-0" />
              <span>
                ...
                developments and housing associations with shared car parks may be eligible for
                this grant, covering up to 75% of installation costs (maximum £30,000 per grant)
                for installing multiple chargers.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-green-400 mt-0.5 shrink-0" />
              <span>
                ...
                is OZEV-registered before committing. Unregistered installers cannot apply the
    ...
    content: (
      <>
        <p>
          ...
          survey to certification. Understanding what is involved helps you prepare the property
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                cable route, earthing arrangement (most Reading properties are on SSEN PME supplies),
                and proposed charger location. Free surveys are commonly offered by Reading-area
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Charger installation and commissioning</strong> — the charger is wall-mounted,
                connected, and commissioned. Smart charging features are configured, including
                scheduling and any integration with your home energy tariff or solar PV system.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                per BS 7671 Chapter 61. An EIC is issued and the work is self-certified under
                Part P by your NICEIC or NAPIT registered installer. OZEV grant paperwork is
        ...
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Standard 7kW home installation</strong> — £800 to £1,200 all-in,
                including charger unit, dedicated circuit, RCD protection, EIC, and Part P
                certificate. After OZEV grant (where eligible): approximately £450 to £850.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                installations where cabling must run underground or overhead between the house
                and garage. Conduit and weatherproof junction boxes are required.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Consumer unit upgrade</strong> — £400 to £700 additional. 1930s and
                1950s Reading properties often have older consumer units without adequate spare
                ways or RCD protection that require upgrading before an EV charger circuit can
                be installed.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Earth electrode</strong> — £150 to £350 additional, if the PME earthing
                risk assessment determines a supplementary earth electrode is needed. More
                common at external or detached garage locations.
              </span>
            </li>
          </ul>
        </div>
    ...
    content: (
      <>
        <p>
          ...
          large estates at Shinfield, Arborfield Green, and the emerging new communities around
          the town. From June 2022, Building Regulations Part S requires new residential buildings
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                served by SSEN are on PME (TN-C-S) supplies. A PME earthing risk assessment
                must be carried out. Where a PME earth is unsuitable, an earth electrode is
                required at the EV charger location.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                ...
                must be protected by an RCD. OZEV-eligible smart chargers with integrated Type B
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                dedicated final circuit. A 32A radial circuit protected by a Type B MCB or RCBO
                is standard for a 7kW charger.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
          ...
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                qualifications, regular assessment, and appropriate insurance cover. Verify on
                the scheme's online register before proceeding.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Search className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>PME earthing competence</strong> — confirm your installer is familiar
                with the Regulation 722.411.4 PME earthing assessment. Ask whether they carry
                an earth electrode kit for installations where PME is unsuitable.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Search className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
    ...
    content: (
      <>
        <p>
          ...
          market for OZEV-approved EV charger installers. The area's new-build activity also
          creates commercial EV installation opportunities at residential developments complying
          with Building Regulations Part S.
        </p>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  ...
                  Reading property. Send the certificate to your customer immediately — no
        ...
        <SEOAppBridge
          ...
          description="Join 430+ UK electricians using Elec-Mate for on-site EV certification, instant PDF export, and professional quoting. 7-day free trial, cancel anytime."
          icon={Zap}
        />
      </>
    ),
