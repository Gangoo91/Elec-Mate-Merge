...
const sections = [
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                generates 5,100 to 5,400 kWh per year.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Sun className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                lifespan of 25 to 30 years. Panels typically come with 25-year performance
                guarantees.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                Meadows, Basford, and Radford may have north-facing rear roofs that are less
                suitable, but east/west installations remain viable.
              </span>
            </li>
          </ul>
        </div>
        <p>
          Solar PV is a long-term investment. Households planning to remain in their property for 10
          or more years are the best candidates. Solar installations also add value to a property —
          a 2023 Rightmove survey found that properties with solar panels sold for an average 4 per
          cent premium compared to comparable properties without.
        </p>
      </>
    ),
  },
    ...
    content: (
      <>
          ...
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                much of a typical family home's daytime electricity use.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                system is significantly cheaper than retrofitting later.
              </span>
            </li>
          </ul>
        </div>
        <p>
          ...
          connection, commissioning, MCS registration, and scaffolding for a standard pitched roof.
          VAT on residential solar PV installations is currently 0% until March 2027 under the
          Energy-Saving Materials VAT relief, making this a particularly cost-effective time to
          install.
        </p>
      </>
    ),
        ...
        <div className="rounded-2xl bg-blue-500/10 border border-blue-500/20 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>What MCS guarantees</strong> — MCS-certified installers are assessed against
                installation standards (MIS 3002 for solar PV), use MCS-certified products, carry
                public liability and professional indemnity insurance, and must register each
                installation in the MCS database within 10 working days of commissioning.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                ...
                mcscertified.com/find-an-installer. Enter your Nottingham postcode to find local
                MCS-certified solar PV installers. Many are also registered with NICEIC or NAPIT for
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                installation. The panels will still generate electricity but you will be unable to
            ...
            <li className="flex items-start gap-3">
              <CheckCircle className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>MCS certificate</strong> — upon completion, the installer must provide you
                with an MCS installation certificate. Keep this document — it is required to apply
                for SEG and may be required when selling your property.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          The Smart Export Guarantee replaced the Feed-in Tariff (which closed to new applicants in
          April 2019) as the mechanism for paying solar panel owners for electricity they export to
          the grid. Unlike the old Feed-in Tariff, SEG rates are set by individual energy suppliers
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                installed. For residential solar, your 4kW or 6kW system will qualify provided it
                was installed by an MCS-certified installer.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <TrendingUp className="w-5 h-5 text-green-400 mt-0.5 shrink-0" />
              <span>
                ...
                tariff offers up to 15p/kWh at peak times (4pm to 7pm) with a variable rate at other
                times. E.ON Next, Ovo Energy, and British Gas offer fixed rates of 3.5p to 7.5p/kWh.
                Compare rates before committing to a supplier.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <TrendingUp className="w-5 h-5 text-green-400 mt-0.5 shrink-0" />
              <span>
                ...
                approximately 30 to 40 per cent of generation (1,000 to 1,400 kWh) could earn £50 to
                £210 per year depending on the tariff chosen. Export earnings are in addition to
            ...
            <li className="flex items-start gap-3">
              <TrendingUp className="w-5 h-5 text-green-400 mt-0.5 shrink-0" />
              <span>
                <strong>Smart meter requirement</strong> — you must have a smart meter installed (or
                agree to have one installed) to receive SEG payments. Smart meters record
                half-hourly export data, enabling accurate payment. Contact your energy supplier to
                arrange installation if you don't already have one.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Battery storage allows solar-generated electricity to be stored during the day and used in
          the evening when generation has stopped. In Nottingham, where cloudy periods are common
          between October and March, battery storage can substantially increase year-round
          self-sufficiency.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                installed), Solis S6 hybrid with PYLONTECH battery stack (flexible capacity, £4,500
                to £7,000 for 10kWh installed), Fox ESS (£4,000 to £5,500 for 10kWh installed).
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Battery className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                discharge during the day, creating additional savings independent of solar
                generation.
              </span>
            </li>
            <li className="flex items-start gap-3">
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                than the highest part of the roof (excluding the chimney); and when no longer
                required, the installation must be removed.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Home className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                conservation area designations), panels must not be installed on a wall or roof that
                fronts a highway, a public open space, or a waterway. Planning permission is
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                both planning permission and listed building consent from Nottingham City Council or
                Nottinghamshire County Council, which is rarely granted.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Home className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                from public viewpoints or if the installation exceeds certain height limits.
              </span>
            </li>
          </ul>
        </div>
        <p>
          If in doubt, contact Nottingham City Council's planning department or apply for a Lawful
          Development Certificate (LDC) to confirm your installation is permitted development. Your
          MCS-certified installer should be familiar with local planning requirements and can advise
    ...
    content: (
      <>
        <p>
          ...
          installers. The key is selecting one that is reputable, properly certified, and provides a
          thorough site survey before quoting.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                the same scope — panels, inverter, mounting, cabling, commissioning, scaffolding,
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                Sunroof) before providing a quote. Surveys assess roof orientation, pitch, shading,
                structural suitability, and meter/consumer unit location.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                12-year warranties. Ask what workmanship warranty the installer provides — 5 years
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Solar PV installation is one of the fastest-growing areas of residential electrical work
          in Nottingham and the East Midlands. Qualified electricians with additional solar PV
          training and MCS certification can command premium rates — solar PV installations
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  ...
                  to complete electrical installation certificates for solar AC connections on site.
                  AI-assisted form completion and instant PDF export mean no evening paperwork.
                </p>
              </div>
            </div>
          </div>
