...
const relatedPages: RelatedPage[] = [
  {
    ...
    description: 'Duty of care, recommended EICR, PAT testing, and safety certificate for marketing.',
    icon: Home,
    category: 'Guide',
  },
  {
...
const sections = [
    ...
    content: (
      <>
        <p>
          ...
          Reform (Fire Safety) Order 2005). Understanding exactly what is required — and what
          is strongly recommended — is essential for protecting guests and yourself.
        </p>
        <div className="rounded-2xl bg-blue-500/10 border border-blue-500/20 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Occupiers Liability Act 1957 — duty of care</strong> — Airbnb hosts
                owe all guests a common duty of care to ensure they are reasonably safe whilst
                using the premises. This duty extends to the electrical installation. A defective
                socket that causes a guest an electric shock, or defective wiring that causes
                a fire, gives rise to liability under this Act regardless of whether a specific
                EICR regulation applies.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Scale className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Airbnb platform requirements</strong> — Airbnb requires all UK hosts
                to confirm in their host account that smoke alarms are installed on every
                floor and that carbon monoxide alarms are installed in spaces with
                fuel-burning appliances. Hosts who cannot confirm these requirements may
                have their listing removed.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Scale className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Insurance requirements</strong> — specialist Airbnb host and
                short-let insurance policies commonly require a current EICR (within the
                past five years) as a condition of cover for public liability claims
                arising from electrical incidents. Check your specific policy wording.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Scale className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Not covered by the 2020 Regulations</strong> — the Electrical
                Safety Standards in the Private Rented Sector (England) Regulations 2020
                apply only to properties let under assured shorthold and similar tenancies.
                Airbnb short lets where guests are tourists or visitors and the property
                is not their main home fall outside the mandatory EICR obligation — but not
                outside the duty of care.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Before your property goes live on Airbnb, carry out a systematic electrical safety
          review. This protects guests, protects your insurance position, and reduces the risk
          of a negative review caused by an electrical problem during a stay.
        </p>
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                <SEOInternalLink href="/tools/eicr-certificate">EICR</SEOInternalLink> from
                a NICEIC, NAPIT, or ELECSA registered electrician if you do not have one within
                the past five years. Keep the certificate and any remedial work confirmation on
                file.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                sandwich maker, television, lamps, hairdryer, and any other appliances
                provided for guests. Annual PAT testing is recommended. Keep a PAT testing
                register.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ClipboardCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Inspect sockets and switches</strong> — check all guest-accessible
                sockets and switches for visible damage, cracking, scorch marks, or loose
                fixings. Any damaged fittings should be replaced before the property is listed.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ClipboardCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Check consumer unit for RCD protection</strong> — open the consumer
                unit cover and confirm that RCD or RCBO protection is fitted on socket-outlet
                circuits. If the consumer unit is an older type without RCD protection on socket
                circuits, arrange an upgrade before listing.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ClipboardCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Test smoke and CO alarms</strong> — press the test button on every
                alarm in the property and replace any batteries that are low. Create a record
                of test dates and include alarm testing in your changeover checklist.
              </span>
            </li>
          </ul>
        </div>
        ...
        <div className="rounded-2xl bg-red-500/10 border border-red-500/20 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Smoke alarms — every floor</strong> — Airbnb requires smoke alarms
                on every floor of the listing. Position alarms in hallways and at the top of
                stairwells. Mains-powered interlinked alarms with battery back-up are the
                most reliable option. Test at every changeover.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <BellRing className="w-5 h-5 text-red-400 mt-0.5 shrink-0" />
              <span>
                <strong>Carbon monoxide alarms — fuel-burning appliances</strong> — CO alarms
                are required by Airbnb in any space containing a fuel-burning appliance. This
                includes gas boilers, gas cookers, gas fires, log burners, solid fuel stoves,
                and oil boilers. Position the CO alarm on the ceiling of the room containing
                the appliance, or in an adjacent hallway if the appliance is enclosed.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <BellRing className="w-5 h-5 text-red-400 mt-0.5 shrink-0" />
              <span>
                ...
                than a smoke detector in kitchens to avoid nuisance alarms from cooking. The
                heat detector should be interlinked with the smoke alarm network where possible.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <BellRing className="w-5 h-5 text-red-400 mt-0.5 shrink-0" />
              <span>
                <strong>Guest information</strong> — include a property guide for guests
                that explains the location of the consumer unit, how to reset a tripped RCD,
                the location of all smoke and CO alarms, and what to do in a fire. Leave this
                guide prominently displayed in the property.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          RCD (Residual Current Device) protection is a fundamental measure that can save lives
          by cutting the electricity supply in milliseconds when a fault to earth is detected.
        ...
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Check your consumer unit</strong> — look for RCD switches (usually
                wider than standard MCBs) or RCBO devices on each circuit. If your consumer
                unit has no RCD protection on socket circuits, an electrician can fit a
                consumer unit with RCBOs on each circuit, or fit an RCD adapter at the socket.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Test the RCD regularly</strong> — all RCDs and RCBOs have a test
                button. Press it quarterly to confirm the device trips correctly. Reset
                immediately after testing. If an RCD or RCBO does not trip when tested or
                will not reset, arrange replacement by an electrician.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>RCD in a tripped position between guests</strong> — if you arrive to
                prepare the property between guests and find an RCD or RCBO tripped, do not
                simply reset it. Identify and resolve the fault before the next guests arrive.
                Recurring RCD trips indicate a wiring or appliance fault that must be
                investigated by an electrician.
              </span>
            </li>
          </ul>
        </div>
    ...
    content: (
      <>
        <p>
          ...
          leads, and will use whatever they find in the property. Hosts can reduce risk by
          providing safe extension leads and removing or replacing unsafe ones.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Provide sufficient socket outlets</strong> — insufficient sockets
                lead guests to daisy-chain extension leads. If bedrooms or communal areas
                have fewer than four socket outlets, consider having an electrician install
                additional sockets before listing. Additional sockets are notifiable work
            ...
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Provide surge-protected extension leads</strong> — if you provide
                extension leads in the property, use surge-protected multi-socket leads with
                individually switched sockets and a minimum 13A rating. Replace any extension
                leads showing signs of wear, damage, or overheating.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>No daisy-chaining — house rules</strong> — include a note in your
                property guide and house rules advising guests not to plug one extension lead
                into another. Frame it as a safety rule, not a restriction.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                standard). This reduces the need for guests to use their own chargers in
                adaptor plugs, reducing overloading risk.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Outdoor areas are frequently highlighted in Airbnb listings as features — gardens,
          patios, outdoor kitchens, hot tubs, and EV chargers. Each outdoor electrical
          installation carries specific safety requirements that must be met before guests use
          these areas.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                rating), protected by 30mA RCD, and installed on a dedicated outdoor circuit.
                Socket covers must be checked before each guest stay. Any socket with damaged
                weatherproof cover must be repaired before guests use the garden.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Building2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                connections must comply with BS 7671 Section 702 (swimming pools and other
                basins). Requirements include supplementary equipotential bonding of all
                metalwork within 3.5 metres of the hot tub, 30mA RCD protection, and no
                socket outlets within 3.5 metres. These installations must be carried out by
                a qualified electrician and notified under Part P.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Building2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>EV chargers</strong> — if you offer EV charging as a feature, the
                charger must be installed by an OZEV-approved installer, comply with BS 7671
                Section 722, and have its own dedicated circuit and RCD protection. Include
                the charger in the EICR scope on next inspection.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Building2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Outbuilding supplies</strong> — garden rooms, summerhouses, and
                outbuildings used by guests must have a safe electrical supply installed
                to BS 7671 requirements, with separate RCD protection and appropriate
                circuit breakers. Underground cables must be armoured or protected, and
                buried at the correct depth with cable covers and cable route markers.
              </span>
            </li>
          </ul>
        </div>
        ...
        <div className="rounded-2xl bg-red-500/10 border border-red-500/20 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Standard home insurance — not valid for Airbnb</strong> — most
                standard home insurance policies exclude commercial or business use of the
                property. Letting on Airbnb constitutes a business use. A claim arising
                from a guest injury during a short let may be declined if you are using
            ...
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-red-400 mt-0.5 shrink-0" />
              <span>
                <strong>EICR requirement in specialist policies</strong> — specialist Airbnb
                host insurance from providers such as Guardhog, Superhog, and specialist
                brokers commonly requires a current EICR (within five years) as a policy
                condition. Confirm the requirement with your insurer before listing.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-red-400 mt-0.5 shrink-0" />
              <span>
                <strong>Public liability cover — essential</strong> — ensure your specialist
                policy includes public liability cover of at least £2 million. This covers
                claims from guests injured by electrical defects in the property. Some
                policies offer £5 million or more.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-red-400 mt-0.5 shrink-0" />
              <span>
                <strong>AirCover for Hosts — not a substitute</strong> — Airbnb's AirCover
                for Hosts provides some damage protection but is not a substitute for
                specialist public liability insurance. The terms and exclusions of AirCover
                are set by Airbnb and may not cover all electrical injury claims.
              </span>
            </li>
          </ul>
        </div>
        ...
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>No EICR on record</strong> — if you have no EICR for the property or
                the last one was more than five years ago, commission one before the next guest
                stay. This is a non-negotiable duty of care requirement.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                repair should be followed by an EIC from the contractor or an EICR to confirm
            ...
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>After a reported electrical incident during a guest stay</strong> — if
                a guest reports an electric shock, sparking socket, or frequently tripping RCD,
                have an electrician inspect the property before the next guest arrives. Do not
                simply reset the RCD and relet.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Before adding new features</strong> — adding a hot tub, EV charger,
                garden kitchen, or outbuilding supply to your Airbnb listing requires new
                electrical work followed by inspection. These are not DIY projects — they
                involve Part P notifiable work that must be carried out by a qualified
                electrician.
              </span>
            </li>
          </ul>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          The rapid growth of short-term letting in the UK has created a large new market for
          EICR and PAT testing work. Airbnb hosts are often unaware of their duty-of-care
          obligations and may not have had any electrical inspection since purchasing the
          property. This represents a significant opportunity for electricians who can clearly
          explain the risks and the straightforward solution.
        </p>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  ...
                  to complete the full EICR report on your phone while on site, then send the
                  PDF to the host before you leave. Combined EICR and PAT testing visits
                  maximise revenue per visit and give hosts everything they need in one
                  appointment.
                </p>
              </div>
            </div>
