...
const sections = [
  {
    ...
    content: (
      <>
        <p>
          Storage heaters store heat generated by cheap overnight electricity in ceramic or brick
          cores, releasing it through the day. The technology has existed since the 1960s, but
          modern models are dramatically more efficient and convenient than their predecessors.
        </p>
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                leakage through the day. Often too hot in the morning and cold by early evening.
                Heavy (up to 180 kg for large models). No room thermostat capability.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Modern models (2010+)</strong> — electronic automatic charge control using
                historical room temperature data to predict overnight charge requirement.
                ...
                integration on premium models. 20–30% reduction in electricity consumption versus
                equivalent old model.
              </span>
            </li>
          </ul>
        </div>
        <p>
          The Government's ECO4 scheme and the Great British Insulation Scheme can fund storage
          heater replacement for eligible households in homes with an EPC rating of D, E, F, or G.
          An MCS-accredited installer is typically required for funded installations.
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>
          Two brands dominate the modern UK storage heater replacement market: Dimplex and Elnur.
          Both offer a range of outputs suitable for different room sizes and installation
          scenarios.
        </p>
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                thermostat input, open window detection, and app control via the Dimplex Link hub.
                Uses a unique double-door damper system for improved heat retention. Compatible with
                Economy 7, Economy 10, and newer smart tariffs.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                charge control, and optional app control via a Wi-Fi interface. Well-regarded for
                build quality and competitive trade pricing. Particularly popular for social housing
                and ECO scheme installations.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                for landlord and student accommodation where simplicity and durability are the
                priority.
              </span>
            </li>
          </ul>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Every storage heater must be supplied by its own dedicated radial circuit from the
          consumer unit. This is a regulatory requirement and a practical necessity given the high
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                method. Confirm volt drop is within limits specified in{' '}
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                must be protected by a 30 mA RCD in accordance with Regulation 411.3.3 of BS 7671.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Settings className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                spare ways for both peak and off-peak circuits. An RCBO-equipped consumer unit
                simplifies individual circuit protection.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Settings className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                adjacent to the heater for safe maintenance access.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Storage heaters only make economic sense when connected to a dual-rate (Economy 7 or
          Economy 10) tariff that provides cheap overnight electricity. The wiring arrangement
          differs from standard domestic circuits.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                terminals: one for the standard rate supply (peaks hours) and one for the off-peak
                supply. Storage heater circuits connect to the off-peak terminals only.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Clock className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                time switch must be correctly set and periodically adjusted for GMT/BST changeover.
                Modern SMETS2 meters handle this automatically.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Clock className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                off-peak meter terminals, or in a split consumer unit with separate off-peak and
                peak busbars. The configuration varies by property age.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Clock className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                heaters — dedicated circuit, off-peak meter terminal. Modern smart immersion
                controllers (Eddi, Mixergy) can also divert solar surplus to the immersion.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Modern storage heaters require correct connection of both the power supply and the control
          wiring for the automatic charge control and room thermostat functions to operate
          correctly.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              <Thermometer className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Elnur Ecombi wiring</strong> — similar three-wire arrangement. The Ecombi's
                built-in room thermostat sensor is in the heater casing and does not require
                external sensor wiring. Some installers add an external Elnur thermostat for greater
                room temperature accuracy in larger rooms.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Thermometer className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Legacy two-wire heaters</strong> — older storage heaters use only L and N,
                with no electronic controller. The input charge is set manually each evening using a
                dial from 0–6 or 0–10. If replacing these with modern heaters, the installer must
                add the permanent live connection back to the consumer unit.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Storage heater replacement costs vary by heater size, brand, and whether new dedicated
          circuits are required. The following figures represent typical 2025 installed prices in
          the UK.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                runs, ceiling voids, or intermediate floors increase cost.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
        ...
        <p>
          ECO4 scheme funding may cover all or a significant portion of storage heater replacement
          costs for eligible households. Installers must be TrustMark registered and Pas 2030 or Pas
          2035 compliant to carry out funded work.
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>
          Storage heaters are not always the best heating choice, but they suit specific property
          and lifestyle profiles well.
        </p>
        <div className="rounded-2xl bg-blue-500/10 border border-blue-500/20 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Properties without gas supply</strong> — storage heaters are a practical
                alternative to oil, LPG, or electric panel heaters where gas is unavailable and a
                heat pump is not viable.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <TrendingUp className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>All-day occupancy homes</strong> — retired occupants or those working from
                home benefit from daytime heat release. Properties where occupants are absent all
                day gain little from storage heaters because most heat is released when no one is
                in.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                significantly lower than the peak rate to justify storage heaters. Check current
                Economy 7 and Economy 10 tariff availability from Octopus Energy, EDF, and British
                Gas before recommending storage heaters to a customer.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <TrendingUp className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Rental properties and social housing</strong> — storage heaters require no
                annual service or gas safety certificate, making them low maintenance for landlords.
                Modern models have 2–3 year warranties and 10+ year lifespans.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Storage heater replacement is steady domestic work that electricians encounter throughout
          the year, with peaks in autumn before the heating season. ECO4 funded work provides
          additional volume for TrustMark-registered businesses.
        </p>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  ...
                  storage heater replacements on your phone. Clients receive their Building
                  Regulations compliance documents before you leave.
                </p>
              </div>
            </div>
          </div>
