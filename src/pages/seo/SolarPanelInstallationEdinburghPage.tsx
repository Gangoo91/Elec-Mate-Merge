...
const relatedPages: RelatedPage[] = [
  {
    ...
    description:
      'Glasgow solar guide — Scotland-specific planning rules and Scottish Building Standards.',
    icon: Sun,
    category: 'Guide',
  },
  {
...
const sections = [
  {
    ...
    content: (
      <>
        ...
        <p>
          Scotland's regulatory framework for solar PV differs from England in two key areas: the
          planning system (Scottish planning rules and the World Heritage Site designation that
          covers much of Edinburgh's Old and New Towns) and building standards (Scottish Building
          Standards rather than England's Building Regulations). Understanding these differences is
          essential for any Edinburgh homeowner or installer.
        </p>
          ...
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                Planning (Scotland) Act 1997 and the 2012 GPDO Amendment.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Sun className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Edinburgh is at latitude 55.9°N — one of the most northerly capital cities in the UK. This
          latitude means shorter winter days and a more pronounced seasonal variation in solar
          output than southern England. Despite this, Edinburgh's irradiance levels are sufficient
          for solar PV to deliver meaningful savings.
        </p>
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                achieve around 680–760 kWh/kWp/year.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Sun className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                partially offset the lower sun angle. Winter months are significantly lower — panels
                may generate only 5–15% of peak summer output in December/January.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Sun className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
          ...
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                Edinburgh is a UNESCO World Heritage Site. Planning permission is required for solar
                PV installations that are visible from public areas within the World Heritage Site.
                This covers large areas of the city centre, Canongate, Grassmarket, New Town, and
                Calton Hill areas.
              </span>
            </li>
            <li className="flex items-start gap-3">
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          This is a critical difference for Edinburgh homeowners and installers. Scotland has its
          own building standards system, entirely separate from the Building Regulations that apply
          ...
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                commences (not after). City of Edinburgh Council's Building Standards team handles
                this.
              </span>
            </li>
            <li className="flex items-start gap-3">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                7671 for electrical installation requirements. Section 712 (Solar Photovoltaic Power
                Supply Systems) therefore applies to all Edinburgh solar PV installations. An{' '}
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Edinburgh's housing stock presents specific challenges for solar PV. The city's sandstone
          tenement blocks have shared roofs (requiring all owners' agreement), while the Georgian
          New Town properties have complex roof structures. Suburban Edinburgh — Corstorphine,
          Morningside, Portobello, and Joppa — has a more conventional housing stock with better
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Edinburgh solar installation costs are generally 5–15% higher than the English average due
          to a smaller pool of local installers, higher travel costs for specialist components, and
          the additional complexity of working within Edinburgh's planning and building standards
          environment.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
        ...
        <p>
          ...
          support for solar PV, as these schemes change. Home Energy Scotland (0808 808 2282) is the
          first point of contact for Scottish Government energy grant advice.
        </p>
      </>
    ),
  },
    ...
    content: (
      <>
        <p>
          ...
          register with any eligible SEG supplier and benefit from the same export tariff rates as
          English homeowners.
        </p>
        <div className="rounded-2xl bg-blue-500/10 border border-blue-500/20 p-6 my-4">
          <ul className="space-y-4 text-white">
    ...
    content: (
      <>
        <p>
          ...
          Scotland's long summer days produce substantial daytime generation, much of which occurs
          when households are at work. A battery stores this generation for evening use.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                months. A 10kWh battery can fully charge on summer days and provide electricity
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                Octopus Agile) and discharged in evening peak hours — useful year-round.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Battery className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Edinburgh's payback periods are longer than southern England due to lower irradiance, but
          rising electricity prices continue to improve the economics year on year.
        </p>
          ...
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                approximately 17 years without battery. With battery increasing self-consumption to
                70%: annual savings rise to ~£550+, improving payback to 14–16 years.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-green-400 mt-0.5 shrink-0" />
              <span>
                <strong>Long-term view:</strong> Over a 25-year system life, even Edinburgh's longer
                payback period results in substantial net returns. A system installed in 2025 with
                8-year payback achieved by 2033 would then generate free electricity until 2050+.
              </span>
            </li>
          </ul>
        </div>
          ...
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                specifically whether they have experience with Edinburgh City Council planning
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                Standards department (or can self-certify through an approved scheme).
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Search className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                current Scottish Government grant support.
              </span>
            </li>
          </ul>
        </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  ...
                  to complete the Electrical Installation Certificate for your PV wiring on site. BS
                  7671 Section 712 applies in Scotland as in England — the EIC requirements are
                  identical.
                </p>
              </div>
            </div>
...
export default function SolarPanelInstallationEdinburghPage() {
  return (
    <GuideTemplate
      title="Solar Panel Installation Edinburgh: PV Scotland"
