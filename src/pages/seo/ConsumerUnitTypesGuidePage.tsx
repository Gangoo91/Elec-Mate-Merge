...
const relatedPages: RelatedPage[] = [
  ...
  },
  {
    ...
    description:
      "SMETS1 vs SMETS2, DNO vs supplier roles, TT earthing, and the electrician's role.",
    icon: Zap,
    category: 'Guide',
  },
  {
...
const sections = [
  {
    ...
    content: (
      <>
        <p>
          A consumer unit (also called a fuse box, distribution board, or consumer control unit) is
          the central electrical distribution point for a domestic property. It receives the
          electricity supply from the meter and distributes it to individual circuits throughout the
          property. Every circuit has its own protective device within the consumer unit.
        </p>
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                domestic) and must be accessible without tools for emergency use. The main switch
                does not disconnect the meter tails upstream — those remain live even with the main
                switch open.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                current in the live and neutral conductors; if more than 30mA flows to earth, it
                trips. RCDs are typically 30mA sensitivity for domestic use.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                domestic ratings: 6A lighting, 16A or 20A immersion heater, 32A socket ring main,
                32A to 40A cooker). Type B for most domestic circuits; Type C for high inrush loads.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                Each circuit is individually protected.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                busbar. Consumer units are designed around specific busbar systems and protective
                devices from the same manufacturer must be used.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          The requirement for metal enclosures in domestic consumer units was introduced in response
          to fire safety concerns. Internal arcing within a consumer unit — caused by loose
          connections, vermin damage, or component failure — can ignite a plastic enclosure. A steel
          or aluminium enclosure contains the arc and resists combustion.
        </p>
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                derives from Amendment 3 to BS 7671:2008 and is incorporated into BS
                7671:2018+A3:2024 (the 18th Edition Wiring Regulations). Plastic consumer units
            ...
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>BS EN 61439-3 — the product standard</strong> — consumer units must comply
                with BS EN 61439-3 (Low-Voltage Switchgear and Controlgear Assemblies — Part 3:
                Distribution Boards Intended to be Operated by Ordinary Persons). This standard sets
                requirements for the design, construction, and testing of consumer units as complete
                assemblies. The standard also requires that protective devices fitted in the
                consumer unit are approved by the manufacturer for use in their specific enclosure.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                ...
                include a cover interlock that prevents the cover being opened when the main switch
                is in the ON position, reducing the risk of accidental contact with live busbars.
                This is a safety feature for ordinary persons, not a BS 7671 requirement but
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          The split-load consumer unit is the most common type found in UK domestic installations
          and has been the standard approach since the 17th Edition Wiring Regulations. It consists
          of a main switch, two RCDs (or occasionally one), and a series of MCBs divided between the
          two RCD sections.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                circuits in section 1. Section 2 circuits remain live. This is the "half-dark house"
                effect — a familiar problem in split-load boards when a faulty appliance trips one
                RCD.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                heating) are not all on the same RCD section. Spreading critical circuits across
                both sections reduces the impact of any single RCD trip.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                typically £50 to £150 for a domestic installation. For budget- conscious projects
                where individual circuit discrimination is not a priority, a split-load board
                remains a compliant and cost-effective solution.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          A high-integrity consumer unit provides an additional level of protection against total
          supply loss compared with a standard split-load board. It achieves this by providing three
          sections: a main switch, and two or more RCD-protected sections with carefully allocated
          circuits so that critical loads are never all on the same RCD section.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                (e.g. a hard-wired alarm on a dedicated circuit). In practice, most domestic
                circuits require RCD protection under Regulation 411.3.3, so Section 1 is often just
                the main switch connection. Sections 2 and 3 each have their own RCD protecting
                their group of MCBs.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                high-integrity board ensures that a fault on any single circuit leaves at least some
                circuits from every section live.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          An RCBO board replaces every MCB with an RCBO, eliminating the shared RCDs of a split-load
          or high-integrity board. The result is that each circuit has its own independent
          overcurrent and residual current protection. See the{' '}
          <SEOInternalLink href="/rcbo-installation-guide">RCBO installation guide</SEOInternalLink>{' '}
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                Fault finding is straightforward — the tripped RCBO directly identifies the faulted
                circuit.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                split-load MCB board. Labour time is comparable. The operational advantage often
                justifies the additional cost, particularly for clients who have experienced
                nuisance trips affecting multiple circuits.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                specific EV charger and medical equipment applications. Refer to the{' '}
  ...
  },
  {
    ...
    content: (
      <>
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                upgraded for 40 or more years. They provide no earth leakage protection and limited
                overcurrent protection. Always a recommendation for replacement on an EICR.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                almost certainly original and inadequate. A full rewire is likely to be required, of
                which consumer unit replacement is one element.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                does not meet the requirements of BS 7671 Regulation 411.3.3. Consumer unit
                replacement with a split-load or RCBO board resolves this.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                replacement is effectively required to restore the installation to a satisfactory
                condition.
              </span>
            </li>
          </ul>
        ...
        <p>
          For a full assessment of whether your consumer unit requires replacement, commission an{' '}
          <SEOInternalLink href="/guides/eicr-observation-codes-explained">EICR</SEOInternalLink>{' '}
          from a registered electrician. The EICR will identify all consumer unit deficiencies and
    ...
    content: (
      <>
        <p>
          ...
          replacement, earth electrode testing, or remediation of identified deficiencies. The
          following are approximate 2024/2025 guide prices for England:
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                metal-clad board, EIC, and Part P compliance certificate.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                Remediation of deficiencies identified during testing (e.g. circuit rewires, cable
                repairs) are priced separately.
              </span>
            </li>
          </ul>
        </div>
        <p>
          ...
          <SEOInternalLink href="/tools/eicr-certificate">Elec-Mate</SEOInternalLink> to generate
          their Electrical Installation Certificates at the job. The EIC, schedule of test results,
          and circuit chart can all be completed on a phone and exported to PDF for the client
