...
const relatedPages: RelatedPage[] = [
  {
    ...
    description: 'Full guide to HMO electrical compliance including fire detection and emergency lighting.',
    icon: Building2,
    category: 'Guide',
  },
  {
...
const sections = [
    ...
    content: (
      <>
        <p>
          ...
          Safety Standards in the Private Rented Sector (England) Regulations 2020. The nature
          of the occupants — students rather than working households — makes no difference to the
          legal obligation. Landlords must obtain an EICR and comply with all associated
          requirements.
        </p>
        <div className="rounded-2xl bg-blue-500/10 border border-blue-500/20 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>EICR required at least every five years</strong> — the landlord must
                have the fixed electrical installation inspected and tested by a qualified
                person and obtain an{' '}
                <SEOInternalLink href="/tools/eicr-certificate">EICR</SEOInternalLink> before
                a new tenancy begins and at least every five years thereafter. Many student
                tenancies are fixed terms of one year, meaning the EICR obligation applies on
                every new tenancy after the five-year cycle expires.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Scale className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Copy to tenants before move-in</strong> — the landlord must provide
                a copy of the EICR to new tenants before they occupy the property. This is
                not optional — failure to provide the EICR before move-in means the landlord
                cannot serve a valid Section 21 notice throughout the tenancy.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Scale className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Satisfactory condition required</strong> — the EICR must be
                satisfactory (no unresolved C1 or C2 observations). Where the report is
                unsatisfactory, all remedial works must be completed within 28 days (or
                sooner if specified) before a new tenancy begins.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Scale className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Penalties for non-compliance</strong> — local authorities can impose
                civil penalties of up to £30,000 per breach. Universities and student unions
                in many university cities actively publicise the right of students to receive
                an EICR, and local authority enforcement in university areas is increasingly
                active.
              </span>
            </li>
          </ul>
    ...
    content: (
      <>
        <p>
          ...
          compliance obligations on top of the standard EICR requirements, including additional
          fire safety measures and licensing conditions.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Mandatory licensing — 5+ occupants</strong> — a student house with
                five or more students from two or more households is subject to mandatory HMO
                licensing. A valid EICR is a mandatory condition of the licence. Many local
                authorities in university cities require a three-year EICR cycle rather than
            ...
            <li className="flex items-start gap-3">
              <Building2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Additional licensing — 3-4 occupants</strong> — many councils in
                university cities operate additional HMO licensing schemes that cover smaller
                properties with three or four student occupants. These schemes typically
                impose the same EICR and fire safety conditions as mandatory licensing.
                Check with your local council whether additional licensing applies to your
                area.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                interlinked mains-powered smoke detectors on all escape routes (hallways,
                landings, stairwells) and heat detectors in kitchens. The Grade D, LD2
                minimum is standard; many councils require LD1 (detectors in every room
                including bedrooms) for student HMOs.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Building2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Emergency lighting to BS 5266-1</strong> — three-storey or larger
                student HMOs commonly require emergency lighting in communal areas and escape
                routes. This is specified in the HMO licence conditions and forms part of
                the EICR inspection scope.
              </span>
            </li>
          </ul>
        </div>
        <p>
          Landlords of student HMOs who are unsure of their local authority's specific
          requirements should contact the private rented sector team or HMO licensing team
          at the relevant council. University student unions often also publish guidance for
          students on what to expect from their landlord.
        </p>
      </>
    ),
  },
        ...
        <div className="rounded-2xl bg-red-500/10 border border-red-500/20 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Overloaded sockets</strong> — plugging too many appliances into a
                single socket via adaptors causes overheating of the socket and wiring.
                Never use a cube adapter (block adapter) to plug multiple appliances into
                a single socket. Use a multi-socket extension lead with surge protection
                instead.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-red-400 mt-0.5 shrink-0" />
              <span>
                <strong>Daisy-chained extension leads</strong> — plugging one extension
                lead into another is one of the most dangerous electrical practices in
                student accommodation. It can cause the extension lead to overheat and
                start a fire. Never chain extension leads together under any circumstances.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-red-400 mt-0.5 shrink-0" />
              <span>
                <strong>Damaged appliance cables</strong> — cables on hairdryers, laptop
                chargers, and kitchen appliances are frequently damaged in student
                accommodation through door trapping, kinking, and heavy use. A damaged
                cable can cause electric shock or fire. Inspect appliance cables regularly
                and replace damaged items immediately.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-red-400 mt-0.5 shrink-0" />
              <span>
                <strong>Electric blankets left on overnight</strong> — electric blankets are
                a significant fire risk if left switched on or used with the temperature
                control set too high. Always switch off and unplug electric blankets before
                sleeping. Never use an electric blanket with a duvet folded over it.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-red-400 mt-0.5 shrink-0" />
              <span>
                <strong>Non-CE-marked chargers and appliances</strong> — counterfeit or
                uncertified USB chargers and phone chargers are commonly purchased cheaply
                online and do not meet UK safety standards. They are a significant fire and
                shock risk. Only use chargers and adaptors bearing the UKCA or CE mark.
              </span>
            </li>
          </ul>
        </div>
        ...
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Total load limit — 13A per socket</strong> — a single UK socket outlet
                is rated at 13A (approximately 3,000W). Exceeding this through adaptor plugs
                or overloaded extension leads can cause the socket, wiring, or extension lead
                to overheat. Add up the wattage of all appliances connected to one socket to
                check you are not exceeding the limit.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Never daisy-chain</strong> — connecting extension leads in series
                increases resistance in the circuit and the total load, which can cause
                overheating of the leads and their plugs. This is prohibited by UK fire
                safety guidance and is a common cause of fires in student accommodation.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Safe extension lead use</strong> — use a single multi-socket extension
                lead plugged directly into the wall. Choose a lead with surge protection and
                individually switched sockets. Never run extension leads under carpets, through
                doorways, or coiled up — heat cannot dissipate safely when a lead is coiled.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Report insufficient sockets to your landlord</strong> — if your room
                or shared areas have too few socket outlets, ask your landlord to install
                additional sockets. Additional sockets are notifiable electrical work under
                Part P of the Building Regulations and must be carried out by a qualified
                electrician.
              </span>
            </li>
          </ul>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Landlords of student properties have identical obligations under the 2020 Regulations
          as any other private landlord. The high turnover of student tenancies and the relative
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                satisfactory before new students occupy the property. Provide a copy to every
                named tenant before the tenancy start date. Keep a record of when each copy
                was provided.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                electrical faults in writing, the landlord must respond and arrange inspection
                or remedial work promptly. Ignoring written reports of electrical faults is
                evidence of failure to take reasonable care and will be damaging in any
                subsequent enforcement action or civil claim.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Fire detection and emergency lighting</strong> — for HMO student
                properties, maintain the fire detection system to BS 5839-6, carry out and
                record monthly function tests, and ensure emergency lighting is tested and
                maintained to BS 5266-1.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Sufficient socket outlets</strong> — whilst not specifying a minimum
                number, the Housing Health and Safety Rating System (HHSRS) includes electrical
                hazards in its assessment criteria. Too few socket outlets in a bedroom is a
                known contributory factor to overloaded extension lead use. Landlords should
                ensure bedrooms have at least four socket outlets.
              </span>
            </li>
          </ul>
        </div>
        ...
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Check the consumer unit</strong> — locate the consumer unit (fuse
                board). Check it has a label showing when the last EICR was carried out (if
                the landlord does not provide one). Check that all MCBs and RCDs are in the
                ON position. If any have tripped, note which circuit and report to the
                landlord.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ClipboardCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Inspect sockets and switches</strong> — look for cracked faceplates,
                scorch marks, loose fixings, or sockets that are not flush with the wall.
                These are indicators of damage or poor installation that should be reported
                to the landlord.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ClipboardCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Test smoke alarms</strong> — press the test button on every smoke
                alarm in the property. A functioning alarm will sound. If any alarm does not
                sound, replace the battery immediately. If the alarm still does not sound after
                a battery replacement, report it to the landlord in writing.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ClipboardCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Check your own appliances</strong> — inspect the cables and plugs of
                all appliances you bring to the property. Discard and replace any appliance
                with a damaged cable, cracked plug, or burn marks on the plug or socket. Do
                not bring uncertified or counterfeit chargers.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Students have the right to report electrical faults and to expect prompt action from
          their landlord. The 2020 Regulations give student tenants the same rights as any other
          private tenant.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Report in writing immediately</strong> — email or text the landlord
                or letting agent as soon as you identify a fault. Include a description of the
                problem, its location, and any safety concerns. Keep a copy of every
                communication.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <BellRing className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Dangerous faults — do not use the circuit</strong> — if you see or
                smell burning, hear crackling from a socket or switch, or an RCD trips
                repeatedly, stop using that circuit immediately and report it to the landlord
                urgently. Do not attempt to reset a repeatedly tripping RCD without identifying
                the cause.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <BellRing className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Landlord failing to act — escalate to the council</strong> — if the
                landlord does not respond to a written report of an electrical fault within
                a reasonable time (typically 24–48 hours for dangerous faults, seven days
                for non-urgent faults), contact your local housing authority's environmental
                health team. The council can require the landlord to carry out works and can
            ...
            <li className="flex items-start gap-3">
              <BellRing className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>University support</strong> — most universities have a student
                accommodation team or students' union housing advisor who can provide guidance
                on reporting electrical faults and escalating complaints against landlords.
                Seek their advice if the landlord is unresponsive.
              </span>
            </li>
          </ul>
        </div>
        ...
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Regulatory Reform (Fire Safety) Order 2005</strong> — university
                halls of residence are non-domestic premises and are subject to the
                Regulatory Reform (Fire Safety) Order 2005. The responsible person (the
                university) must carry out a fire risk assessment and implement appropriate
                fire precautions, including electrical safety measures.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Users className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Universities UK code of practice</strong> — most UK universities
                follow the Universities UK Code of Practice for the Management of Student
                Housing, which sets minimum standards for electrical safety including regular
                testing of fixed installations and portable appliances. The code recommends
                five-yearly EICRs for student residential buildings.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Users className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                accommodation companies) must also comply with the Regulatory Reform (Fire
                Safety) Order 2005 and typically hold operating licences from local
                authorities requiring EICR compliance. Standards in this sector are generally
                high due to the commercial and regulatory scrutiny involved.
              </span>
            </li>
          </ul>
        </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  ...
                  to complete reports on your phone while on site. Student properties often
                  require multiple EICRs in August and September before the academic year
                  starts — fast on-site completion means more inspections per day.
                </p>
              </div>
            </div>
          </div>
