...
export default function CorrectionFactorsGuidePage() {
  return (
    <GuideTemplate
      ...
      ctaSubheading="Join 1,000+ UK electricians using Elec-Mate for on-site cable sizing, 70+ calculators, and 16 certificate types — all built to BS 7671:2018+A4:2026. 7-day free trial, cancel anytime."
    />
  );
}
