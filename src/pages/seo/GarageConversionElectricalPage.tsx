...
const faqs = [
  ...
  {
    question:
      'Does a garage conversion need Planning Permission and Building Regulations approval?',
    answer:
  ...
  {
    question:
      'What is the difference between an attached and detached garage conversion electrically?',
    answer:
...
const sections = [
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                will be replaced or supplemented with properly rated circuits for the habitable room
                use.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                This is typically achieved using SWA (steel wire armour) armoured cable buried in a
                trench between the house and the garage, feeding a sub-board or consumer unit in the
                garage. The armoured cable route, trench depth, and earthing arrangement must comply
                with BS 7671. See the{' '}
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          The first task when converting a garage electrically is to assess the existing supply and
          determine what needs to be upgraded. In most cases, this means installing entirely new
          circuits rather than modifying the existing ones.
        </p>
          ...
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                circuits in the converted garage. For a room with heating, lighting, and
                socket-outlets, the feed cable is typically 10mm² or 16mm² twin and earth (for an
                attached garage) or SWA armoured cable of appropriate cross-section (for a detached
                garage).
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                Distribution Network Operator (DNO) must be consulted about a supply upgrade. DNO
                upgrades can take several weeks to arrange and should be factored into the project
                timeline.
              </span>
            </li>
          </ul>
        ...
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Lighting</strong> — a dedicated lighting circuit with switched control. LED
                downlighters are a popular choice for converted garages with lower ceiling heights.
                Confirm that the driver type is compatible with the dimmer switch if dimming is
                required.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Smoke detection</strong> — a mains-powered smoke alarm with battery backup
                (Grade D under BS 5839-6:2019), interlinked with the existing alarms in the house.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                ...
                entering the converted space must be bonded to earth under Regulation 544 of BS
                7671.
              </span>
            </li>
          </ul>
        ...
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Electric underfloor heating</strong> — the most popular option for converted
                garages with a concrete floor. A heating mat is installed under the floor covering
                and connected to a dedicated circuit with a thermostat and floor sensor. For a 15m²
                garage, a 2kW system on a 10A circuit is typical. The thermostat must be appropriate
                for the floor type — tile, laminate, and carpet all require different sensor
                configurations.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                programmable thermostats are a lower-cost option. A 2kW panel heater requires a 10A
                circuit. If multiple heaters are installed, a dedicated heating circuit or separate
                circuits for each heater should be used rather than connecting to the general socket
                ring.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                heat objects rather than air, making them efficient for well-insulated spaces. They
                can be connected via a standard 13A socket or hardwired on a dedicated circuit. For
                a permanent installation in a habitable room, hardwiring is preferred.
              </span>
            </li>
            <li className="flex items-start gap-3">
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                consumer unit enclosures are the standard solution. Older plastic-encased consumer
                units must be replaced if the unit is being upgraded.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Settings className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                for a separate building control electrical inspection.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                affect the property's value, its insurability, and the ability to sell in the
                future. Retrospective regularisation is possible but involves an EICR on the
                existing installation and can be expensive.
              </span>
            </li>
          </ul>
        </div>
...
export default function GarageConversionElectricalPage() {
  return (
    <GuideTemplate
      ...
      ctaSubheading="Join 1,000+ UK electricians using Elec-Mate for on-site EIC completion, quoting, and Part P compliance. 7-day free trial, cancel anytime."
    />
  );
}
