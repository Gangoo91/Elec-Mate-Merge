...
const sections = [
  {
    ...
    content: (
      <>
        <p>
          Barrow-in-Furness is an industrial town at the tip of the Furness Peninsula in south-west
          Cumbria, separated from the rest of England by Morecambe Bay. With a population of around
          70,000 in the wider Barrow area, it is the largest settlement in the Westmorland and
          Furness unitary authority and one of the most distinctive industrial towns in England.
        </p>
        <p>
          The town's entire economic character is shaped by BAE Systems's Barrow Shipyard — the UK's
          largest naval shipbuilding facility and the sole manufacturer of Britain's nuclear
          submarines. The shipyard directly employs around 10,000 people and supports a large supply
          chain, making it the dominant influence on the local labour market, including the
          electrical trades.
        </p>
        <p>
          For electricians, Barrow presents a dual market. The domestic and commercial sector is a
          typical northern post-industrial town with older housing stock, a growing rental market,
          and increasing demand for EV chargers and renewables. Alongside this is the defence and
          marine sector — high-value, highly regulated, requiring specialist clearances and
          qualifications, but offering some of the best electrical contractor rates in the region.
        </p>
        <p>
          The town's geographic isolation (limited road access, effectively a peninsula) means the
          local electrical market is more self-contained than most, with less competition from
          outside contractors than similarly sized towns with better transport links.
        </p>
      </>
    ),
  },
    ...
    content: (
      <>
        <p>
          ...
          vessels that form the UK's nuclear deterrent. This creates a sustained, long-term demand
          for specialist electrical contractors on site.
        </p>
        <div className="rounded-2xl bg-blue-500/10 border border-blue-500/20 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Security clearance</strong> — Security Check (SC) clearance is required for
                general access to BAE Systems Barrow. Some roles involving nuclear propulsion
                systems or classified areas require Developed Vetting (DV) — the highest level of UK
                government security clearance. Both processes are sponsored by BAE Systems or an
                approved supply chain contractor and can take months to complete. DV clearance
                involves an in-depth background investigation.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Defence standards</strong> — naval shipbuilding electrical work is governed
                by DEF STAN (Defence Standards), particularly the DEF STAN 08 series covering marine
                engineering. These standards impose requirements that differ from and are generally
                more demanding than civilian BS 7671. Electricians working in this environment must
                develop familiarity with the applicable defence and marine standards through their
                employer or principal contractor.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                ...
                systems as well as AC, with redundancy built into critical systems. The propulsion,
                weapons, navigation, and life support systems all have electrical elements with
                exceptional reliability requirements. This is specialist work that requires specific
                training and experience alongside civilian electrical qualifications.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                ...
                work at Barrow takes place inside the shipyard. The defence supply chain includes
                facilities, maintenance, and support services that employ electricians with lower
                clearance levels. MRO (maintenance, repair, and overhaul) facilities, defence
                logistics sites, and BAE Systems-adjacent offices and facilities all require
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                vessels. Electricians working on or near nuclear propulsion systems must comply with
                MoD nuclear safety requirements in addition to any civilian standards. The MoD
                Defence Nuclear Safety Regulator (DNSR) is the relevant authority.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-amber-400 mt-0.5 shrink-0" />
              <span>
                ...
                BS 7671. Understanding IEC 60364 alongside BS 7671 is valuable for electricians
                working in high-specification industrial and defence environments where IEC
                standards are applied directly rather than through the BS 7671 interpretation.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-amber-400 mt-0.5 shrink-0" />
              <span>
                ...
                on electrical systems are demonstrably competent. In the defence sector, this
                typically means formal SQEP assessment or equivalent competency frameworks. Maintain
                comprehensive records of qualifications, training, and experience — they will be
                required for access to defence work.
              </span>
            </li>
          </ul>
        </div>
        <p>
          For most locally based electricians, defence and marine work at BAE Systems is accessed
          through a career of building qualifications and industrial experience, then entering the
          BAE Systems supply chain through a cleared contractor. The investment in clearance and
          specialist training is significant but the career trajectory and rates can be exceptional.
        </p>
      </>
    ),
  },
    ...
    content: (
      <>
        <p>
          ...
          Barrow-in-Furness and the wider Furness Peninsula. Key points for Barrow electricians:
        </p>
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                high-power loads (EV chargers, heat pumps) may have longer lead times than in
                better-connected areas, as network reinforcement may be needed on the peninsula.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                the network that balances this significant generation capacity. Local electricians
                may encounter ENW's network reinforcement and upgrade activity in the Barrow area
                related to offshore wind connections.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                online notification. G99 applications take 4–10 weeks to process. The Furness coast
                has a good renewable energy resource and growing domestic generation adoption.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                earthing via overhead lines. Always verify earthing type at the intake. Walney
                Island properties accessible via the Jubilee Bridge should be specifically checked —
                coastal island locations can have varied earthing arrangements.
              </span>
            </li>
          </ul>
        </div>
        ...
        <div className="grid gap-4 sm:grid-cols-2 my-4">
          <div className="rounded-2xl bg-blue-500/10 border border-blue-500/20 p-5">
            ...
            <p className="text-white text-sm leading-relaxed">
              The majority of Barrow's older housing stock comprises Victorian brick-built terraces
              built for shipyard workers in areas such as Barrow Island, Hindpool, and Ormsgill.
              Solid walls, no cavity, pre-1980 asbestos risk, and dated electrical systems are all
              common features. Full rewires and consumer unit upgrades are a regular source of
              domestic work. Asbestos surveys are essential before any invasive work in properties
              built before 1985.
            </p>
          </div>
          <div className="rounded-2xl bg-amber-500/10 border border-amber-500/20 p-5">
            ...
            <p className="text-white text-sm leading-relaxed">
              ...
              Hawcoat. Properties from the 1950s–1980s typically have dated consumer units with no
              or inadequate RCD protection, limited socket provision, and wiring at or approaching
          ...
          <div className="rounded-2xl bg-purple-500/10 border border-purple-500/20 p-5">
            ...
            <p className="text-white text-sm leading-relaxed">
              ...
              community. The island's coastal position and wind exposure make external electrical
              installations particularly demanding — IP65+ fittings, sealed cable entries, and
              corrosion-resistant fixings are essential. Walney is also home to the wind farm
              visitor centre and operational infrastructure.
            </p>
          </div>
          <div className="rounded-2xl bg-green-500/10 border border-green-500/20 p-5">
            <h3 className="font-bold text-white text-lg mb-3">Commercial and Industrial</h3>
            <p className="text-white text-sm leading-relaxed">
              Beyond BAE Systems, Barrow has commercial retail, leisure, and service businesses. The
              Furness General Hospital is a major institutional client for specialist healthcare
              electrical work. Retail parks and commercial developments on the outskirts of the town
              require standard commercial electrical fit-out and maintenance. Industrial units on
              the dockside and in the Devonshire Road area have three-phase supply requirements.
            </p>
          </div>
        </div>
      </>
    ...
    content: (
      <>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div className="space-y-3">
              ...
              <p className="text-white text-xs leading-relaxed pt-2">
                ...
                investment required. The premium over standard domestic work is substantial and
                sustained over the multi-decade submarine build programme.
              </p>
            </div>
          </div>
        </div>
        <p>
          ...
          contractors — a benefit for locally based electricians. For rural jobs on the Furness
          Peninsula beyond Ulverston, apply a travel premium to cover the additional distance and
          time.
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>
          Barrow offers a self-contained domestic and commercial electrical market, enhanced by the
          high-value defence and marine sector for those who invest in the necessary clearances and
          specialist skills. The town's geographic isolation reduces outside competition — a genuine
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  ...
                  site with AI-assisted board scanning. The Barrow rental market and growing BAE
                  Systems employee owner-occupier market both need regular professional
                  documentation.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h4 className="font-bold text-white mb-1">
                  Cable Sizing for Rewires and Rural Jobs
                </h4>
                <p className="text-white text-sm leading-relaxed">
                  Use the{' '}
