...
const relatedPages: RelatedPage[] = [
  {
    ...
    description: 'A complete guide to Electrical Installation Condition Reports — what they check, what the codes mean, and what happens next.',
    icon: ClipboardCheck,
    category: 'Guide',
  },
  {
    ...
    description: 'Full guide to landlord EICR obligations, Scottish regulations, compliance deadlines, and managing multiple properties.',
    icon: Home,
    category: 'Guide',
  },
  {
    ...
    description: 'What C1, C2, C3 and FI codes mean, what action is required, and real-world examples from Scottish properties.',
    icon: AlertTriangle,
    category: 'Guide',
  },
  {
...
const sections = [
    ...
    content: (
      <>
        <p>
          ...
          standard method used by qualified electricians to evaluate whether an existing installation
          is safe and fit for continued use, and whether it complies with current standards set
          out in{' '}
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                bonding arrangements, and any fixed electrical equipment. It does not cover
                portable appliances (which are assessed by Portable Appliance Testing).
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Visual inspection and testing</strong> — the inspection combines a
                thorough visual examination with a series of electrical tests using calibrated
                instruments. Test results are recorded in the Schedule of Test Results,
                which forms part of the completed{' '}
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                Unsatisfactory. An Unsatisfactory result means the installation contains C1 or
                C2 coded observations that must be rectified. C3 observations (improvement
                recommended) do not make the EICR Unsatisfactory.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Next inspection date</strong> — the EICR states a recommended date for
                the next inspection. For private rented properties in Scotland, this is typically
                five years (or as specified by the installer, whichever is sooner).
              </span>
            </li>
          </ul>
        </div>
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                repair and in proper working order. A valid EICR (no more than five years old)
                is the standard means of demonstrating compliance.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
            ...
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Landlord registration</strong> — all private landlords in Dundee must
                be registered with Dundee City Council. Electrical non-compliance can result
                in registration sanctions, preventing the landlord from legally letting
                properties.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Tenant enforcement</strong> — tenants can apply to the First-tier
                Tribunal (Housing and Property Chamber) if a landlord fails to comply with
                the Repairing Standard. The tribunal can order the landlord to carry out
                required work.
              </span>
            </li>
          </ul>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Dundee has a diverse housing stock that shapes the nature of EICR work in the city.
          The private rented sector includes pre-war tenement buildings, post-war local authority
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                failure risks. Such wiring is typically coded C2 or C1 depending on its
                condition.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                the mid-1990s frequently lack RCD protection on socket-outlet circuits. BS 7671
            ...
            <li className="flex items-start gap-3">
              <Building2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Post-war social housing stock</strong> — much of Dundee's post-war
                housing was built between 1950 and 1975. These properties may have been rewired
                at some point but can still present earthing and bonding deficiencies, or
                dated consumer units without RCD protection.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Building2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Newer developments</strong> — properties built or comprehensively
                rewired after 2000 are generally compliant with the then-current edition of
                BS 7671 but may require assessment against the current 18th Edition requirements.
                Consumer units in older new-builds may lack arc fault detection or updated
                RCD protection.
              </span>
            </li>
          </ul>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Understanding the EICR process helps property owners and tenants know what to expect
          and how to prepare.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Before the inspection</strong> — ensure all rooms, cupboards, and the
                loft hatch (if relevant) are accessible. The consumer unit must be reachable
                throughout. Notify tenants in advance that power may be briefly interrupted.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Clock className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                of the fixed installation, checking for damage, deterioration, non-compliant
                wiring, and the general condition of accessories and the consumer unit.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Clock className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                typically involving de-energising each circuit to carry out tests including
                earth continuity, insulation resistance, polarity, earth fault loop impedance,
                and RCD operating time. Results are recorded in the Schedule of Test Results.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Clock className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Report completion</strong> — the inspector completes the EICR (ideally
                on site using a digital tool) and provides the report to the client. The report
                states Satisfactory or Unsatisfactory, lists all observations with codes, and
                recommends the next inspection date.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Every finding noted during an EICR is assigned a classification code. The four codes
          used are defined in BS 7671 and its guidance notes.
        </p>
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                immediate remedial action. May require disconnection of the affected circuit.
                Always makes the EICR Unsatisfactory.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>C2 — Potentially dangerous</strong> — urgent action required. The
                defect is potentially dangerous but not an immediate risk. Always makes the
                EICR Unsatisfactory. Common C2 findings in Dundee: absence of RCD protection,
                degraded rubber insulation, inadequate bonding.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>C3 — Improvement recommended</strong> — the installation does not
                fully meet current standards but is not unsafe. Does not make the EICR
                Unsatisfactory on its own.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-white mt-0.5 shrink-0" />
              <span>
                <strong>FI — Further investigation required</strong> — a potential issue has
                been identified that cannot be assessed without further investigation. Makes
                the EICR Unsatisfactory until resolved.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Dundee offers some of the most competitive EICR pricing in Scotland, reflecting
          the city's lower overall labour rates compared with Edinburgh or Glasgow.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>One-bedroom flat</strong> — £95 to £190. Most Dundee flats have
                3 to 5 circuits and a single consumer unit.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Two-bedroom property</strong> — £140 to £260. Tenement conversions
                may be more complex than purpose-built flats.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Three-bedroom house</strong> — £160 to £320. Older properties with
                degraded wiring will be at the higher end of the range.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>HMO or larger property</strong> — £280 to £550+. Multiple consumer
                units, fire alarm systems, and communal area circuits increase scope and cost.
              </span>
            </li>
          </ul>
        </div>
        <p>
          Remedial work identified during an EICR is quoted separately. A consumer unit upgrade
          to provide full RCD protection — one of the most common remedial requirements in
          Dundee — typically costs £350 to £650 including materials and labour.
        </p>
      </>
    ),
  },
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                or ELECSA online registers to find electricians operating in Dundee. Scheme
                membership confirms qualifications, public liability and professional indemnity
                insurance, and regular technical assessment.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Search className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Inspection and testing qualifications</strong> — verify that the
                electrician holds City and Guilds 2391 or C&G 2395 (Inspection and Testing)
                and a current BS 7671 18th Edition qualification (C&G 2382). Not all
                electricians hold these qualifications.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Search className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Experience with local property types</strong> — prefer electricians
                with proven experience of Dundee's tenement and post-war housing stock. They
                will be more familiar with the wiring issues commonly encountered and better
                placed to assess them accurately.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Search className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                three-bedroom property takes three to five hours and requires expensive
                calibrated instruments. Quotes significantly below market rate may indicate
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Dundee's private rented sector creates consistent demand for landlord EICRs. Building
          a reputation for reliable, thorough inspection work can generate a significant volume
          of repeat business from landlords managing multiple Dundee properties.
        </p>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  ...
                  scanning, voice test entry, and instant PDF export mean landlords get the
                  report before you even leave the site.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  ...
                  . Scottish landlords must act within 28 days — the electrician who quotes on
                  the day wins the job.
                </p>
              </div>
            </div>
          </div>
