...
const sections = [
        ...
        <div className="rounded-2xl bg-blue-500/10 border border-blue-500/20 p-5 my-4">
          ...
          <div className="space-y-3 text-white text-sm leading-relaxed">
            ...
            <p>
              ...
              systems) notification. Note that solar PV installations in Bath conservation areas
              face planning restrictions in addition to DNO notification requirements.
            </p>
            <p>
              ...
              sheath cable, particularly those that have not had a service upgrade. A small number
              of properties on the hills above Bath (Lansdown, Bathwick Hill) may be TT. Always
              verify the earthing arrangement at the service head.
            </p>
          </div>
        </div>
        <p>
          Service upgrades in Bath city centre can be complicated by the conservation restrictions
          on external cable routes and meter positions. Coordinate with NGED and the BANES
          conservation team early if a service upgrade involves any external changes to a listed
          building.
        </p>
      </>
    ),
    ...
    content: (
      <>
        <p>
          ...
          outstanding universal value as an example of Georgian town planning, Roman engineering,
          and the integration of architecture with landscape. The World Heritage Site designation
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                original lath-and-plaster ceiling below. Never cut through lath-and-plaster to route
                cables — it is original fabric and often includes decorative cornicing on the room
                below. Use flexible draw rods and route cables alongside joists.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                fireplaces are blocked up with voids accessible from the basement or loft), existing
                service risers from previous electrical or plumbing work, or carefully created
                routes in internal partition walls (timber stud with lath and plaster — check for
                significance before opening up). External walls are Bath stone and must not be
                chased.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                route them behind original skirting boards, dado rails, or picture rails — these are
                often deep enough to conceal a cable. If making good is required after electrical
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                brass or nickel accessories are expected. Some conservation officers have approved
                specific ranges of slim, discreet modern accessories in muted colours for less
                significant rooms. Agree the accessory specification with the homeowner and, if
                necessary, the conservation officer before ordering.
              </span>
            </li>
          </ul>
        </div>
    ...
    content: (
      <>
        <p>
          ...
          limestone that gives Bath its distinctive appearance. Understanding Bath stone is
          essential for any electrician working in the city, because it directly affects how you
          route cables, make fixings, and protect the building.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                cables. All cable routes through Bath stone walls must use existing openings
                (windows, doors, service holes) or carefully drilled cores through mortar joints.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Building2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                ground floor level. Electrical accessories and distribution boards in damp areas
                must be appropriately IP-rated. Cable insulation in persistently damp conditions
                should be monitored via regular insulation resistance testing. Recommend that the
                homeowner addresses the damp issue alongside the electrical work.
              </span>
            </li>
          </ul>
        </div>
    ...
    content: (
      <>
        <p>
          ...
          radiators, and underfloor heating offers an invisible solution. However, installing UFH in
        ...
        <p>
          UFH installation in listed buildings is a growing niche in Bath. Partnering with a
          flooring specialist and heritage architect allows you to offer a complete service from
          design through LBC application to installation and certification.
        </p>
      </>
    ),
  },
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Bath is a premium market for electricians who invest in heritage skills. The combination
          of UNESCO-grade conservation work, affluent homeowners, a busy tourism sector, and growing
