...
const howToSteps = [
  ...
  },
  {
    ...
    text: 'Look up the appropriate Appendix 4 table for your cable type (e.g., Table 4D5 for 70 degree C thermoplastic flat cable, or Table 4E2A for 90 degree C thermosetting singles). Find the smallest cable size with a tabulated Iz value equal to or greater than your calculated It value.',
  },
  {
...
const features = [
  ...
  },
  {
    ...
    description:
      'Verifies the selected cable can withstand the prospective fault current using the adiabatic equation from BS 7671 Regulation 434.5.2.',
  },
  {
    icon: Layers,
            ...
            <div className="flex gap-4 p-5 rounded-2xl bg-white/[0.04] border border-white/10">
              ...
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  ...
                  disconnect. This is checked using the adiabatic equation from Regulation 434.5.2
                  (for live conductors) and 543.1.3 (for protective conductors): minimum CSA =
                  square root of (I squared t) / k, where I squared t is the energy let-through of
                  the device and k is a constant for the conductor and insulation type (115 for
                  copper/PVC, 143 for copper/XLPE).
                </p>
              </div>
            </div>
