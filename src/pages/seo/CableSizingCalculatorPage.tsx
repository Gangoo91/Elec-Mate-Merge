...
const features = [
  ...
  },
  {
    ...
    description:
      'Verifies the selected cable can withstand the prospective fault current using the adiabatic equation from BS 7671 Regulation 543.1.3.',
  },
  {
    icon: Layers,
            ...
            <div className="flex gap-4 p-5 rounded-2xl bg-white/[0.04] border border-white/10">
              ...
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  ...
                  disconnect. This is checked using the adiabatic equation from Regulation 543.1.3:
