    ...
    <PublicPageLayout>
      ...
      <section id="calculator" className="px-5 pb-12 scroll-mt-24">
        <div className="max-w-4xl mx-auto">
          <CalculatorSurface><CableSizingCalculator /></CalculatorSurface>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4 text-white leading-relaxed">
            ...
            <p>
              ...
              for a complete circuit design check.
            </p>
          </div>
        </div>
      </section>
            ...
            <div className="flex gap-4 p-5 rounded-2xl bg-white/[0.04] border border-white/10">
              ...
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  ...
                  disconnect. This is checked using the adiabatic equation from Regulation 434.5.1
                  (for live conductors) and 543.1 (for protective conductors): minimum CSA = square
                  root of (I squared t) / k, where I squared t is the energy let-through of the
                  device and k is a constant for the conductor and insulation type (115 for
