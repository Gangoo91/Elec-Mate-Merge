...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'Yes. The AI has full access to the tables in BS 7671, including the maximum earth fault loop impedance tables (Tables 41.2 to 41.6), the cable current-carrying capacity tables in Appendix 4, the voltage drop tables in Appendix 4, the correction factor tables (ambient temperature, grouping, thermal insulation), and the disconnection time tables. When you ask a question that requires reference to a table — for example, "What is the maximum Zs for a 32A Type B MCB?" — the AI returns the specific value from the correct table (in this case, 1.37 ohms from Table 41.3) along with an explanation of how to apply it, including the 80% rule for comparing measured values to tabulated maximums.',
  },
  {
