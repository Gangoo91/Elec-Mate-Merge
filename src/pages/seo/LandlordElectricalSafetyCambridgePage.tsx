...
const sections = [
    ...
    content: (
      <>
        ...
        <p>
          ...
          regulated tenancies in England, including all student lets and professional tenancies
          in Cambridge. They do not apply to social housing or lodger arrangements where the
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Cambridge City Council is the local housing authority responsible for enforcing the
          2020 Regulations within the city. South Cambridgeshire District Council covers the
          surrounding rural and village areas. Both authorities have enforcement powers, though
          Cambridge City Council handles the vast majority of private rented sector enforcement
          due to the concentration of rental properties within the city.
        </p>
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                inspects properties, and issues civil penalties. The large student rental market
                and high concentration of HMOs make this one of the more active enforcement
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                Cambridge begin with tenant complaints. Students who discover their property lacks
                a valid EICR, or who raise concerns about electrical safety, can report this to
                the council's environmental health team, triggering a formal investigation.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Building2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                work to be carried out and recover costs from the landlord, in addition to
        ...
        <p>
          Cambridge landlords should maintain up-to-date records of all EICRs and remedial work
          for every property. The council can request these records at any time, and inability
          to produce a valid EICR is treated as evidence of non-compliance.
        </p>
      </>
    ),
  },
    ...
    content: (
      <>
        <p>
          ...
          create one of the largest student rental markets in England. The majority of
          second-year and beyond students live in privately rented accommodation, most of it in
          shared houses that qualify as Houses in Multiple Occupation (HMOs). This makes HMO
          compliance a critical issue for Cambridge landlords.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                electrical installations including communal areas, fire alarms, and emergency
            ...
            <li className="flex items-start gap-3">
              <Users className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Additional licensing</strong> — Cambridge City Council operates
                additional licensing covering smaller HMOs (three or four occupants) in parts
                of the city with high concentrations of student accommodation, including areas
                near the city centre and around Hills Road and Mill Road. Check with the council
                whether your property falls within a designated additional licensing area.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Users className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Shorter EICR intervals for HMOs</strong> — Cambridge HMO licence
                conditions typically require EICRs every three years or at each licence renewal
                (licences are normally issued for five years). Always check the specific
                conditions on your licence certificate.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Users className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Summer inspection window</strong> — the Cambridge student rental market
                runs on an academic year cycle, with most tenancies beginning in late June or
                September. Landlords should arrange EICRs in April or May to allow time for
                remedial work before the next tenancy begins. Leaving it until August risks
                delays if remedial work is required.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Users className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                Coleridge, Cherry Hinton, and Mill Road areas are Victorian terraced properties
                with original or early-twentieth-century wiring. These properties commonly
                receive C2 observations for absent RCD protection, deteriorated cables, and
                inadequate earthing. Landlords of older stock should budget for consumer unit
                upgrades as part of ongoing maintenance.
              </span>
            </li>
          </ul>
        </div>
        <p>
          ...
          prosecution and an unlimited fine, as well as civil penalties under the electrical
          safety regulations. Cambridge City Council actively prosecutes unlicensed HMO operators.
        </p>
      </>
    ),
  },
    ...
    content: (
      <>
        <p>
          ...
          constitutes a separate breach. Cambridge landlords with multiple non-compliant
          properties can face cumulative penalties well in excess of this figure.
        </p>
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                to provide it to the tenant, failing to supply it to the local authority on
                request, and failing to complete remedial work are each separate breaches. A
                landlord who ignores all obligations could face multiple penalties from a single
                property.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-red-400 mt-0.5 shrink-0" />
              <span>
                <strong>HMO licence revocation</strong> — Cambridge City Council can revoke an
                HMO licence for persistent non-compliance with licence conditions. A revoked
                licence means the property cannot legally be operated as an HMO, which for
                Cambridge student landlords can mean losing several years of rental income
                while a new licence is sought.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-red-400 mt-0.5 shrink-0" />
              <span>
                ...
                21 (no-fault eviction) notice without having provided the tenant with a copy of
                the current EICR. This is a significant practical consequence for Cambridge
                landlords who wish to regain possession of their property at the end of a
                student tenancy.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-red-400 mt-0.5 shrink-0" />
              <span>
                <strong>Unlicensed HMO prosecution</strong> — operating a licensable HMO without
                a licence is a criminal offence. Cambridge City Council has prosecuted landlords
                in the Magistrates' Court, with fines of up to £20,000 per offence plus costs,
                entirely separately from the electrical safety civil penalty regime.
              </span>
            </li>
          </ul>
        </div>
        <p>
          The cost of an EICR every five years (typically £150 to £400 in Cambridge) is
          negligible compared to the potential penalties. Cambridge landlords should treat
          electrical safety compliance as a non-negotiable part of operating a rental property.
        </p>
      </>
    ),
  },
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                inspection. Request the EICR in writing from your landlord or letting agent
            ...
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Right to report non-compliance</strong> — if your Cambridge landlord
                cannot provide a valid EICR, you can report this to Cambridge City Council's
                environmental health team. The council can require the landlord to arrange an
                inspection and impose a penalty for non-compliance.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                ...
                fails to act, the council can arrange for the work to be done and recover costs
                from the landlord. Tenants should not be charged for any remedial work arising
                from electrical safety compliance.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                ...
                students with concerns about landlord compliance. The Cambridge University
                Students' Union has published guidance on private rented sector rights.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          When a Cambridge EICR identifies C1 or C2 observations (classified under BS 7671
          Section 631), the landlord must complete remedial work within strict timescales set
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                The 28-day clock runs from the date of the inspection, not the date the landlord
                receives the report.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                landlords should treat C1 findings as emergencies and arrange remedial work
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                the landlord must obtain written confirmation from a qualified electrician. This
                confirmation must be provided to the tenant and to Cambridge City Council within
            ...
            <li className="flex items-start gap-3">
              <Clock className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Common Cambridge remedial work</strong> — typical remedial work in
                Cambridge rental properties includes fitting RCD protection under Regulation
                411.3.3 of BS 7671, replacing deteriorated consumer units, upgrading earthing
                and bonding, replacing old rubber or PVC-insulated cables, and addressing
                overloaded circuits in converted Victorian properties.
              </span>
            </li>
          </ul>
        </div>
        <p>
          Cambridge landlords with student properties should aim to complete all EICR remedial
          work before the summer inspection window ends, well before the new academic year
          tenancies begin in September.
        </p>
      </>
    ),
  },
    ...
    content: (
      <>
        <p>
          ...
          but demand peaks in the summer months as landlords prepare student properties for the
          new academic year. Landlords should book inspections early to avoid availability
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                online registers to find Cambridge-based inspectors. Scheme registration confirms
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                qualification (C&G 2382 18th Edition). Experience with Victorian terraced housing
                and HMOs is particularly valuable in Cambridge.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Search className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                significantly in May to July. Landlords who leave booking until late summer
                risk being unable to get an inspection before the new tenancy begins, which
                itself constitutes a breach of the 2020 Regulations.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Search className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                professional indemnity insurance. This is a requirement of competent person
                scheme membership and protects the landlord if an error appears on the report.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Cambridge EICR costs are broadly in line with East of England rates, which are
          generally lower than London but higher than rural East Anglia. Prices reflect local
          labour rates, the prevalence of older housing stock, and seasonal demand peaks.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>One-bedroom flat</strong> — £120 to £200. Modern purpose-built flats
                are typically quicker to inspect than converted Victorian properties.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                consumer units, fire alarm systems, and emergency lighting increase the
                inspection scope and price.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                properties with complex electrical installations and multiple distribution
                boards require longer inspection times.
              </span>
            </li>
          </ul>
        </div>
        <p>
          These prices cover the inspection and report only. Remedial work is quoted and
          charged separately. Landlords with multiple Cambridge properties may be able to
          negotiate block pricing with a local electrician, reducing the per-property cost.
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>
          Cambridge's large and continuously renewing student rental market creates sustained
          demand for landlord EICRs. Electricians who specialise in inspection and testing work
          can build strong relationships with Cambridge letting agents and landlords, generating
          regular annual income from EICR portfolios.
        </p>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  ...
                  report to the Cambridge landlord or letting agent before you leave the property.
                </p>
              </div>
            </div>
          </div>
          <div className="rounded-2xl bg-green-500/10 border border-green-500/20 p-5">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  When C1 or C2 observations are found, quote the remedial work immediately
                  using the{' '}
                  <SEOInternalLink href="/tools/electrical-quoting-app">
                    quoting app
                  </SEOInternalLink>
                  . Cambridge landlords must act within 28 days — the electrician who quotes
                  on the day of the EICR wins the work. With summer inspection pressure,
                  landlords want one trusted contractor for both the EICR and any remedials.
                </p>
              </div>
            </div>
          </div>
        ...
        <SEOAppBridge
          ...
          description="Join 430+ UK electricians using Elec-Mate for on-site EICR completion, AI board scanning, and instant PDF export. Complete more EICRs per day during the Cambridge summer rush. 7-day free trial."
          icon={FileCheck2}
        />
      </>
    ),
