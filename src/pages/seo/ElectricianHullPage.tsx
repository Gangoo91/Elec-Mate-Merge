...
const sections = [
          ...
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                in dwellings and for circuits in locations of increased shock risk (bathrooms,
                kitchens, outdoors).
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>EICR for rental properties</strong> — the Electrical Safety Standards in
                the Private Rented Sector (England) Regulations 2020 require five-yearly EICRs
                on all private rented properties. Periodic inspection follows Section 631 of BS 7671.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          <strong>Northern Powergrid</strong> serves Hull and the East Riding of Yorkshire.
          All DNO interactions for Hull electricians go through Northern Powergrid:
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Earthing in Hull properties</strong> — most Hull properties are supplied
                on TN-C-S (PME) systems. Some older properties, particularly in the city centre
                and near the docks, may have TN-S earthing from the original lead-sheathed supply.
        ...
        <div className="grid gap-4 sm:grid-cols-2 my-4">
          <div className="rounded-2xl bg-blue-500/10 border border-blue-500/20 p-5">
            ...
            <p className="text-white text-sm leading-relaxed">
              ...
              Holderness Road. Solid or partial cavity brick walls, lath-and-plaster ceilings,
              and often original or early-replacement wiring. Rewires are common. Asbestos surveys
          ...
          <div className="rounded-2xl bg-green-500/10 border border-green-500/20 p-5">
            ...
            <p className="text-white text-sm leading-relaxed">
              Large 1960s–1980s estates in Bransholme, Orchard Park, and Longhill. Cavity
              brick construction, standard cable routing. Consumer unit replacements and rewires
              are common on these properties. Asbestos textured coatings (artex) may be present
              on pre-1985 ceilings.
            </p>
          </div>
          ...
          <div className="rounded-2xl bg-amber-500/10 border border-amber-500/20 p-5">
            ...
            <p className="text-white text-sm leading-relaxed">
              Hull's port complex, the Siemens wind turbine plant, and commercial premises in
              the city centre and retail parks offer commercial electrical work. Three-phase
              supplies, industrial wiring, and specialist installations are common in this sector.
            </p>
          </div>
        </div>
      </>
    ...
    content: (
      <>
        ...
        <p>
          ...
          invest in professional documentation, fast turnaround, and scheme registration can
          build strong customer loyalty in a competitive market.
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>
          Hull provides consistent work for qualified electricians willing to engage with the
          local market. The ageing housing stock, large rental sector, and growing EV and wind
          energy demand create a varied and sustainable workload.
        </p>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  ...
                  on site. Landlords need compliant EICR documents quickly — deliver them from
                  your phone before leaving the property.
                </p>
              </div>
            </div>
          </div>
        ...
        <SEOAppBridge
          ...
          description="Join 430+ UK electricians using Elec-Mate for cable sizing, professional quoting, and on-site certification. Built for electricians working in Yorkshire and the Humber. 7-day free trial."
          icon={MapPin}
        />
      </>
    ),
...
export default function ElectricianHullPage() {
  return (
    <GuideTemplate
      ...
      ctaSubheading="Join 430+ UK electricians using Elec-Mate for cable sizing, quoting, and on-site certification. Built for electricians working across Yorkshire and the Humber. 7-day free trial."
    />
  );
}
