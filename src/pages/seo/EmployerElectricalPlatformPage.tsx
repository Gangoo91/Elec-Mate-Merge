      ...
      relatedPages={[
        {
          ...
          description:
            'All 19 certificate types used by your team — EICR, EIC, Minor Works, and more.',
          icon: FileCheck2,
