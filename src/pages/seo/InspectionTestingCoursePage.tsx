...
const faqs = [
  {
    question: 'What is the difference between C&G 2391, C&G 2394, and C&G 2395?',
    answer:
...
const courseSchema = {
  ...
  inLanguage: 'en-GB',
  courseMode: 'online',
  coursePrerequisites: 'C&G 2382 (18th Edition IET Wiring Regulations) or equivalent',
  offers: {
    '@type': 'Offer',
    price: '4.99',
    priceCurrency: 'GBP',
    ...
    <PublicPageLayout>
      ...
      <section className="py-16 sm:py-24 px-5">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-white max-w-2xl mx-auto leading-relaxed mb-8">
            ...
            Everything you need to prepare for the Inspection and Testing qualification.
          </p>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4 text-white leading-relaxed">
            ...
            <p>
              ...
              Verification) and C&G 2395 (Periodic Inspection and Testing). The 2394 covered the
              inspection and testing required before a new installation is connected to the supply —
              ensuring it has been designed, constructed, and tested in accordance with BS 7671. The
              2395 covered the periodic inspection of existing installations, identifying
              deterioration, damage, and departures from the current edition of the regulations. The
              2391 covers both areas in a single qualification.
            </p>
            <p>
      ...
      <section className="py-12 px-5 border-t border-white/5">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4 text-white leading-relaxed">
            <p>
              The 2391 is required for several critical career milestones in the electrical
              industry. Understanding these requirements helps you plan your career progression
              effectively.
            </p>
          </div>
            ...
            <ul className="space-y-4 text-white">
              <li className="flex items-start gap-3">
                ...
                <span>
                  ...
                  membership, you cannot self-certify notifiable electrical work under Part P of the
              ...
              <li className="flex items-start gap-3">
                ...
                <span>
                  ...
                  standard evidence of this competence. Landlord EICR work is a growing market since
                  the 2020 regulations made them mandatory for rented properties in England.
                </span>
              </li>
              <li className="flex items-start gap-3">
                <ShieldCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
                <span>
                  ...
                  level of competence and is valued by employers in commercial and industrial work.
                </span>
              </li>
              <li className="flex items-start gap-3">
                <ShieldCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
                <span>
                  ...
                  manager positions. It is also valuable for electricians moving into consultancy,
      ...
      <section className="py-12 px-5 border-t border-white/5">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4 text-white leading-relaxed">
            <p>
              The 2391 course content covers every aspect of electrical inspection and testing that
              a competent person needs to know. The syllabus is divided into several key areas, each
              of which is tested in both the written examination and the practical assessment.
            </p>
            <p>
              <strong>Safe isolation procedures</strong> form the foundation of all inspection and
              testing work. Before any dead testing can be carried out, the circuit or installation
              must be safely isolated and proved dead using a GS 38 compliant voltage indicator and
              proving unit. The correct procedure is: test the voltage indicator on a known live
              source (or proving unit), test the circuit for dead on all conductors, then test the
              voltage indicator again to confirm it is still working. This three-step procedure must
              be followed every time without exception.
            </p>
            <p>
              <strong>Initial verification</strong> covers the inspection and testing required
              before a new installation or alteration is connected to the supply. This includes a
              detailed visual inspection of the installation against the design documentation and BS
              7671 requirements, followed by a sequence of electrical tests. The documentation
              produced is the Electrical Installation Certificate (EIC), which confirms that the
              installation has been designed, constructed, inspected, and tested in accordance with
              BS 7671.
            </p>
            <p>
              <strong>Periodic inspection</strong> covers the assessment of existing installations
              that are already in service. This involves a thorough visual inspection, followed by
              testing, to identify any deterioration, damage, defects, or non-compliance with the
              current edition of BS 7671. The documentation produced is the Electrical Installation
              Condition Report (EICR), which includes observation codes (C1, C2, C3, FI) and an
              overall assessment of the installation condition.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 px-5 border-t border-white/5">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4 text-white leading-relaxed mb-6">
            <p>
              Guidance Note 3 (GN3) published by the IET specifies the correct sequence of tests for
              both initial verification and periodic inspection. The tests must be carried out in a
              specific order because each test validates the results of the previous one and
              confirms that it is safe to proceed to the next. Understanding this sequence is
              essential for both the 2391 exam and real-world practice.
            </p>
          </div>
          <div className="space-y-4">
            <div className="flex gap-4 p-5 rounded-2xl bg-white/[0.04] border border-white/10">
              ...
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  This test confirms that the circuit protective conductors (CPCs) provide a
                  continuous low-resistance path from every exposed-conductive-part back to the main
                  earthing terminal. A low-resistance ohmmeter is used to measure the R1+R2 value
                  for each circuit. This test is done first because a functioning earth path is
                  essential for safety before any further tests are carried out.
                </p>
              </div>
            </div>
            <div className="flex gap-4 p-5 rounded-2xl bg-white/[0.04] border border-white/10">
              ...
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  For ring final circuits, this test confirms that the line, neutral, and CPC are
                  all continuous rings without breaks, and that no interconnections or spurs exist
                  where they should not. The three-step test method (end-to-end, cross-connect, test
                  at each socket) is the standard approach. The measured values at each socket
                  outlet should be reasonably consistent, indicating a healthy ring.
                </p>
              </div>
            </div>
            <div className="flex gap-4 p-5 rounded-2xl bg-white/[0.04] border border-white/10">
              ...
              <div>
                <h3 className="font-bold text-white text-lg mb-1">Insulation Resistance</h3>
                <p className="text-white text-sm leading-relaxed">
                  This test applies a DC test voltage (typically 500V for standard 230V circuits)
                  between live conductors and earth, and between line and neutral, to confirm that
                  the insulation of the cables and accessories is in good condition. The minimum
                  acceptable value is 1 megohm, though in practice healthy insulation should read
                  significantly higher. This test is done after continuity tests because it requires
                  the circuit to be isolated and all loads disconnected.
                </p>
              </div>
            </div>
            <div className="flex gap-4 p-5 rounded-2xl bg-white/[0.04] border border-white/10">
              ...
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  This test confirms that single-pole switching and protective devices are connected
                  in the line conductor only, not the neutral. It also confirms that socket outlets
                  are correctly wired (line to the correct terminal, neutral to the correct
                  terminal, earth connected). Polarity is typically confirmed during the R1+R2
                  continuity test using the wander lead method.
                </p>
              </div>
            </div>
            <div className="flex gap-4 p-5 rounded-2xl bg-white/[0.04] border border-white/10">
              ...
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  This live test measures the total impedance of the earth fault loop for each
                  circuit. The measured Zs value must not exceed the maximum permitted value for the
                  protective device on that circuit (as tabulated in BS 7671). This ensures that in
                  the event of an earth fault, sufficient current will flow to operate the
                  protective device within the required disconnection time (0.4 seconds for final
                  circuits, 5 seconds for distribution circuits).
                </p>
              </div>
            </div>
            <div className="flex gap-4 p-5 rounded-2xl bg-white/[0.04] border border-white/10">
              ...
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  This test measures the maximum prospective short-circuit current and prospective
                  earth fault current at the origin of the installation. The measured value must not
                  exceed the rated breaking capacity of the protective devices. This is important
                  because if the fault current exceeds the device rating, the device may fail to
            ...
            <div className="flex gap-4 p-5 rounded-2xl bg-white/[0.04] border border-white/10">
              ...
              <div>
                <h3 className="font-bold text-white text-lg mb-1">RCD Testing</h3>
                <p className="text-white text-sm leading-relaxed">
                  Residual Current Devices (RCDs) are tested to confirm they operate within the
                  required time at their rated residual operating current. A 30mA RCD protecting a
                  socket outlet must trip within 300ms at the rated current and within 40ms at five
                  times the rated current. The test also confirms the RCD does not trip at 50% of
                  the rated current (to avoid nuisance tripping). This is the final test because it
                  requires the supply to be live.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-12 px-5 border-t border-white/5">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4 text-white leading-relaxed">
            <p>
              The practical assessment is the component that many candidates find most challenging.
              It requires you to demonstrate that you can carry out a real inspection and testing
              procedure on an actual or simulated installation, following the correct sequence and
              producing accurate documentation.
            </p>
            <p>
              The practical typically involves two scenarios. The first is an initial verification
              of a newly installed or altered circuit. You inspect the installation visually, carry
              out the full testing sequence, and complete an Electrical Installation Certificate
              (EIC) with accurate test results and any observations about departures from BS 7671.
            </p>
            <p>
              The second scenario is a periodic inspection of an existing installation. You carry
              out a visual inspection and testing of an installation that has been in service,
              identify any defects or non-compliance, assign appropriate observation codes (C1, C2,
              C3, or FI), determine the overall assessment (Satisfactory or Unsatisfactory), and
              complete an Electrical Installation Condition Report (EICR).
            </p>
            <p>
              In both scenarios, assessors are looking for several things: that you follow the
              correct testing sequence, that you perform safe isolation properly, that your test
              instrument readings are accurate and consistent, that you identify defects correctly,
              that you assign the appropriate observation codes, and that your documentation is
              complete and accurate. Elec-Mate scenario walkthroughs simulate both types of
              assessment so you arrive prepared and confident.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 px-5 border-t border-white/5">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4 text-white leading-relaxed mb-8">
            <p>
              Studying for the 2391 alongside a full-time job is challenging. You need a study
              method that fits around your work schedule and gives you access to the information you
              need when you need it. Elec-Mate provides exactly that.
            </p>
            <p>
              The AI study assistant is available 24/7 and can answer any question about inspection
              and testing procedures, BS 7671 regulations, GN3 guidance, or documentation
              requirements. Unlike a textbook, the assistant explains concepts in plain language and
              can give you examples relevant to the specific type of installation you are studying.
              Ask it to explain the difference between Zs and Ze, to walk you through the ring final
              circuit continuity test, or to clarify when an FI code is appropriate instead of a C2.
              It responds instantly with clear, regulation- referenced answers.
            </p>
            <p>
              The mock exam questions are drawn from the full 2391 syllabus and are designed to
              mirror the style and difficulty of the real examination. Each question includes a
              detailed explanation of the correct answer, with references to the relevant
              regulations and guidance notes. Timed practice exams help you build the speed and
      ...
      <section id="how-it-works" className="py-12 px-5 border-t border-white/5">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-white mb-8 leading-relaxed">
            Follow these steps to build your knowledge and confidence before the C&G 2391
