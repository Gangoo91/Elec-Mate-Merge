...
const faqs = [
  ...
  {
    question:
      'What is the difference between the Crown Commercial Service and regional purchasing consortia?',
    answer:
  ...
  {
    question:
      'What financial standing is usually required for a public sector electrical framework?',
    answer:
...
const sections = [
    ...
    content: (
      <>
        <p>
          ...
          and one or more contractors, under which the contractor is approved to carry out work over
          a set period — typically two to four years — without tendering for each individual job.
          For electrical contractors, getting onto frameworks is one of the most effective ways to
          secure a reliable pipeline of public sector work.
        </p>
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                certainty of work volume; established working relationships with clients; earlier
                involvement in project planning; and reputational credibility from being a named
                public sector framework contractor.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Briefcase className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Framework structure</strong> — most frameworks are divided into lots by
                geography (regional or national), value (small works, medium works, major works), or
                activity (maintenance, installation, emergency works). Apply for the lots that match
                your capability and geography — applying for lots you cannot genuinely resource is
                wasted effort and can damage your credibility.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Briefcase className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Call-off mechanisms</strong> — work is awarded either by direct award (for
                smaller jobs, where the client selects one framework contractor) or by
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                include indicative volumes (not guaranteed); others are purely access-based. Build
                relationships with the client's works managers and project teams to maximise your
    ...
    content: (
      <>
        <p>
          ...
          Framework contracts are the standard route for councils to manage their electrical supply
          chains efficiently.
        </p>
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                installation and maintenance covering local authorities, schools, and public sector
                bodies across the Midlands and East of England. Frameworks are open to other public
                bodies nationally.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                electrical frameworks cover maintenance, installation, and specialist electrical
                works. Open to all public bodies nationally.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Building2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                electrical services. CCS frameworks can be used by all central government
                departments, many public bodies, and devolved administrations.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Building2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                frameworks directly rather than using consortium routes. Watch Find a Tender Service
                and Contracts Finder for these opportunities.
              </span>
            </li>
          </ul>
        </div>
    ...
    content: (
      <>
        <p>
          ...
          theatres, ITUs, data centres, and patient areas — requiring contractors with demonstrable
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                frameworks include electrical installation and maintenance. Access is through the
                NHS SBS portal.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                Distribution) and HTM 06-02 (Electrical Safety Guidance for Low Voltage Systems).
                Demonstrating knowledge of HTM requirements in your tender response is essential for
                NHS framework opportunities.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                more; professional indemnity insurance; and specific references for healthcare
                electrical work. The Permit to Work requirements in NHS environments are also more
                stringent than standard commercial sites.
              </span>
            </li>
          </ul>
        </div>
        <p>
          ...
          reactive maintenance frameworks before pursuing major installation work. Building a track
          record of NHS project references is essential for larger NHS framework opportunities.
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>
          Housing associations (registered providers of social housing) manage hundreds of thousands
          of homes and require regular electrical maintenance (EICR programmes, rewires, consumer
          unit upgrades) and installation work (EV chargers, solar PV, fire alarm upgrades).
          Framework contracts are the standard procurement route.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                new-build works. LHC frameworks include electrical installation and are widely used
                by housing associations in England, Scotland, and Wales.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Users className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                construction and refurbishment works. SCF has lots for works contractors (including
                electrical) at various value bands.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Users className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                electrical frameworks directly. These are advertised on Find a Tender Service and
                Contracts Finder. Relationships with association asset managers and procurement
                teams are valuable for direct framework opportunities.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Users className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                standards have driven significant EICR demand from housing associations. Framework
                contracts for EICR programmes (testing thousands of properties over several years)
                are a significant opportunity for electrical contractors with the capacity to
                deliver at volume.
              </span>
            </li>
          </ul>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          A Pre-Qualification Questionnaire (PQQ) — called a Selection Questionnaire (SQ) under the
          Procurement Act 2023 — is the first stage of a public sector framework procurement. It
          screens applicants before they are invited to tender. A poorly completed PQQ means you
          will not reach the tender stage regardless of your technical ability.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                for. References should include the client's name and contact details, the contract
                value, the scope of electrical works, and the outcome. Strong references from public
                sector clients are most persuasive.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ClipboardList className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                typically two to three times the estimated annual lot value. If your accounts show
                consecutive years of loss, you may be excluded regardless of other credentials.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ClipboardList className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                not hold a recognised scheme, you will need to provide your full H&amp;S policy,
                risk assessment procedures, accident records, and training records for assessment.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ClipboardList className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                applied in your recruitment, training, and subcontracting practices. It is also
                increasingly required to provide data on your workforce diversity for larger
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                larger local authority frameworks. At minimum, you need a policy covering waste
                management, vehicle emissions, and material sourcing.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Finding framework opportunities requires monitoring several procurement portals regularly.
          Many electrical contractors miss framework opportunities simply because they are not
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                thresholds must be advertised here. Set up email alerts for "electrical" in your
                region. Find a Tender Service is at find-tender.service.gov.uk.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Search className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                bodies). All public sector contracts above these values should be advertised here.
                Set up alerts by category and region at contractsfinder.service.gov.uk.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Search className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                notify registered suppliers when relevant frameworks are being tendered.
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                bids. Registration ensures you appear in searches for electrical contractors in your
                region and value band.
              </span>
            </li>
          </ul>
        </div>
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                sub-central authorities (local authorities, NHS, schools). Contracts above this
                value must be advertised on Find a Tender Service and follow the full Procurement
                Act procedure.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                threshold (£663,540) and a simpler procedure but still require transparency notices
                on Find a Tender Service.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Scale className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                pipeline notice for contracts over £2m expected in the next 18 months. This gives
                suppliers advance warning to prepare bids. Watch Find a Tender Service for pipeline
                notices from your target clients.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Scale className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                extreme urgency and where only one supplier can deliver. For electrical contractors,
                this creates opportunities for emergency and specialist work without a competitive
                tender.
              </span>
            </li>
          </ul>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Being on a framework is only the first step. Maximising the call-off work you receive from
          framework clients requires active relationship management and consistent delivery.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Relationship management</strong> — visit the client's works managers and
                estate teams after framework appointment. Build personal relationships with the
                people who decide which framework contractor to call off. Attend any client
                briefings, supply chain events, or framework review meetings.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle className="w-5 h-5 text-green-400 mt-0.5 shrink-0" />
              <span>
                ...
                responsive contractors above almost everything else. Respond to call-off enquiries
                quickly, hit your programme milestones, and communicate proactively if problems
                arise. Your KPI performance is often reviewed at framework renewal.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle className="w-5 h-5 text-green-400 mt-0.5 shrink-0" />
              <span>
                ...
                annually against market conditions. Being uncompetitive on day rates will cost you
                mini-competitions even on frameworks where you are well-regarded.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle className="w-5 h-5 text-green-400 mt-0.5 shrink-0" />
              <span>
                ...
                mini-competition quality submissions. Social value scoring is increasingly weighted
                at 10 to 20 per cent of the overall evaluation.
              </span>
            </li>
          </ul>
        </div>
        <p>
          Framework contracts that are managed well become long-term relationships. When a framework
          is re-tendered after its term (typically two to four years), existing performing
          contractors have a significant advantage — they have proven track records and are the
          known, low-risk choice for the client.
        </p>
      </>
    ),
  },
    ...
    content: (
      <>
        <p>
          ...
          documentation, performance tracking, and client reporting. The right tools make framework
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  ...
                  policy, environmental policy, and project references. Keep these documents current
                  so you can respond quickly when framework opportunities arise. See the{' '}
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  ...
                  generate call-off quotes from your standard rates, with materials pricing built in
                  and professional PDF export for submission.
                </p>
              </div>
            </div>
          </div>
