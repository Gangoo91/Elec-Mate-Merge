...
const sections = [
  {
    id: 'the-symbol',
    heading: 'RCBO (RCD + MCB Combined) — IEC 60617 Symbol',
    content: (
      <>
        <SymbolGallery
          symbolIds={['rcbo']}
...
export default function RcboSymbolPage() {
  return (
    <GuideTemplate
      title="RCBO Symbol: BS EN 61009 Diagram Reference"
      description="RCBO (RCD + MCB Combined) IEC 60617 symbol — what it represents, when used in UK electrical drawings, and where it appears on EIC + EICR schedules."
      ...
      heroSubtitle="RCBO residual current breaker with overcurrent electrical symbol IEC 60617 — what it represents, where it appears in UK electrical drawings, and how it relates to the rest of the symbol library."
      readingTime={4}
      keyTakeaways={[
