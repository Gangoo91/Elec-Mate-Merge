...
const relatedPages: RelatedPage[] = [
  {
    ...
    description:
      'Overview of all insurance types recommended for electricians running their own business.',
    icon: ShieldCheck,
  ...
  },
  {
    ...
    description:
      'How to register with NICEIC as a sole trader or company — requirements, costs, and assessment.',
    icon: ClipboardCheck,
    category: 'Guide',
  },
  {
  ...
  },
  {
    ...
    description:
      'How tool insurance works, what to look for in a policy, and the best providers for electricians.',
    icon: Wrench,
    category: 'Business Guide',
  },
  {
...
const sections = [
  {
    ...
    content: (
      <>
        <p>
          Public liability (PL) insurance protects your business against claims from members of the
          public or clients who suffer injury or property damage as a result of your work or
          negligence. For an electrician, this includes a wide range of scenarios — from a client
          tripping over cable on site to a fire caused by a wiring fault attributed to your
          installation.
        </p>
        <div className="rounded-2xl bg-blue-500/10 border border-blue-500/20 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Minimum cover: £2 million</strong> — NICEIC, NAPIT, and ELECSA all require
                at least £2 million PL cover as a condition of registration. This is the absolute
                floor, not a recommendation. Most claims settle for far less, but legal defence
                costs on a complex claim can exhaust a £2 million policy quickly.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Industry standard: £5 million</strong> — the majority of commercial clients,
                principal contractors, and local authorities specify £5 million PL as a minimum in
                their procurement requirements. If you want to work commercially, £5 million cover
            ...
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>What PL does not cover</strong> — faulty workmanship or materials that fail
                (this is a defects claim, covered separately or under contract law); deliberate
                acts; claims from employees (covered by employer&apos;s liability); and professional
                advice errors (covered by professional indemnity).
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Cost: £400 to £900/year</strong> — for a sole trader with annual turnover
                under £300,000, doing standard domestic and commercial work, £5 million PL cover
                costs approximately £400 to £900 per year. Specialist or higher-risk work (HV,
                industrial) will increase premiums.
              </span>
            </li>
          </ul>
        </div>
    ...
    content: (
      <>
        <p>
          ...
          Liability (Compulsory Insurance) Act 1969 for any UK business that employs staff. Unlike
          public liability, this is not a matter of choice — it is the law.
        </p>
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                who work exclusively for you and under your direction may legally be treated as
                employees for EL purposes. Always seek advice if you are unsure whether your
                subcontractors constitute employees.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                compensation awards. You must display your EL certificate in your workplace and make
                it available to HSE inspectors.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                on the total fine. This is a criminal liability, not a civil matter.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                legally required to hold EL insurance. However, as soon as you take on any helper,
                even informally, the requirement applies.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Professional indemnity (PI) insurance covers claims arising from errors, omissions, or
          negligence in professional services including design, advice, and specification. It is
          distinct from public liability and covers financial loss rather than physical injury or
          property damage.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                part of your service, PI is essential. An error in a design that causes the client
                financial loss (e.g., an undersized cable causing equipment damage or a failed
                inspection) could result in a PI claim.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                exposure. If you are installing to a consultant engineer&apos;s specification, the
                design risk sits with the consultant.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                done. This means you need to maintain PI insurance continuously or purchase
                retroactive cover to protect against claims on historic work.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Tools and test equipment represent a significant capital investment for any electrician. A
          multifunction tester, insulation resistance tester, clamp meter, and hand tools can total
          £3,000 to £8,000 or more. Standard home contents and van insurance typically exclude trade
          tools.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                sometimes mechanical breakdown for electronic test equipment. Policy terms vary —
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                that does not have an alarm; and wear and tear. Many policies require you to have a
                Thatcham-rated van alarm and locked metal toolbox as a condition of cover.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Wrench className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                numbers and purchase receipts. Update it whenever you buy significant new equipment.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Wrench className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                conditions. Some specialist trade insurers include tool cover as part of a package
                policy with PL and EL.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Your van is your mobile workshop and one of your highest-value assets. Standard private
          car insurance does not cover a vehicle used for trade — you need specific commercial
          vehicle insurance.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                equipment&quot; to ensure your policy covers the purpose for which you are using the
                vehicle. A standard private car policy is void if you are involved in an accident
                while using the vehicle for trade.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Car className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                insurer. Undisclosed modifications can invalidate a claim.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Car className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                transit&quot; cover protects tools while they are being transported but may not
                cover tools left in a parked vehicle overnight.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Car className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                measures. Fitting a GPS tracker and Thatcham-approved alarm can reduce premiums by
                10 to 20 per cent.
              </span>
            </li>
          </ul>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Registration with NICEIC, NAPIT, ELECSA, or another approved competent person scheme is a
          condition of self-certifying notifiable electrical work. All schemes have minimum
          insurance requirements that must be met at registration and maintained throughout
          membership.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                currently mandate professional indemnity or employer&apos;s liability (though EL is
                a legal requirement if you employ staff). The NICEIC may request to see your
                insurance schedule rather than just the certificate.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ClipboardCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                for specific work types (e.g., commercial, industrial, or specialist systems).
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ClipboardCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                million EL as minimum conditions for being added to approved supplier lists. Check
                the requirements of each client before tendering.
              </span>
            </li>
          </ul>
        </div>
        <SEOAppBridge
          ...
          description="Keep your NICEIC registration documents, insurance certificates, and compliance records organised with Elec-Mate. Join 1,000+ UK electrical contractors."
          icon={ShieldCheck}
        />
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>
          The following costs are indicative for 2026. Premiums vary based on turnover, number of
          employees, location, type of work, and claims history. Always obtain at least three quotes
          before purchasing any business insurance policy.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                policies are generally better value than buying individual policies separately.
              </span>
            </li>
          </ul>
        </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  A valid certificate is your first line of defence in any insurance or liability
                  claim. If your work is challenged, a properly completed and signed EIC or EICR
                  demonstrates you carried out the work correctly. Use the{' '}
