    ...
    <PublicPageLayout>
      ...
      <section className="relative overflow-hidden py-20 sm:py-28 px-5">
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg sm:text-xl text-white max-w-2xl mx-auto mb-8 leading-relaxed">
            ...
            compliance with the 3% lighting and 5% power limits from BS 7671 Table 4Ab.
          </p>
      ...
      <section className="py-16 px-5">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4 text-white leading-relaxed">
            <p>
              Voltage drop is the reduction in electrical potential (voltage) along a conductor as
              current flows through it. Every cable has resistance, and when current passes through
              that resistance, some of the supply voltage is lost as heat in the cable itself. The
              voltage available at the load end of the cable is therefore lower than the voltage at
              the supply end.
            </p>
            <p>
              In practical terms, excessive voltage drop means that the equipment connected at the
              far end of a cable run does not receive its full rated voltage. For lighting circuits,
              this causes lamps to produce less light and can lead to visible flickering,
              particularly with LED drivers. For motors and other power equipment, low voltage
              causes higher current draw, reduced efficiency, overheating, and premature failure. On
              very long cable runs — such as those found in commercial buildings, farms, and
              industrial sites — voltage drop is often the factor that determines the minimum cable
              size rather than the current-carrying capacity alone.
            </p>
            <p>
              The amount of voltage drop depends on three main factors: the resistance of the cable
              per unit length (determined by its cross-sectional area and conductor material), the
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4 text-white leading-relaxed">
            ...
            <p>
              ...
              (i.e. most domestic and commercial properties connected to the DNO network), the
              limits in Table 4Ab are:
            </p>
            ...
            <p>
              ...
              installation (the supply terminals) to the most distant point of the circuit. If an
              installation has sub-distribution boards, the voltage drop accumulates along the
              entire path from the main incoming supply through any sub-mains to the final circuit.
      ...
      <section className="py-16 px-5">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4 text-white leading-relaxed">
            ...
            <p>
              The mV/A/m value is the key figure. It represents the voltage drop per ampere of
              current per metre of cable length, expressed in millivolts. This value is specific to
              each cable type, conductor material, cross-sectional area, and whether the circuit is
              single-phase or three-phase. These values are tabulated in BS 7671 Appendix 4, in the
              "B" series of tables (4D1B, 4D2B, 4E1B, etc.).
            </p>
            <p>
              For example, a 2.5 mm² copper twin and earth cable (flat thermoplastic, Table 4D5B)
              has a tabulated voltage drop of 18 mV/A/m for single-phase circuits. If this cable
              carries 20 A over a length of 25 metres, the voltage drop is:
            </p>
            ...
            <p>
              The division by 1000 is necessary because the tabulated values are in millivolts, and
              we need the result in volts. Always remember to express the final answer as a
              percentage of the nominal supply voltage to compare against the BS 7671 limit: (VD ÷
              230) × 100 for single-phase, or (VD ÷ 400) × 100 for three-phase.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-5 bg-white/[0.02]">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4 text-white leading-relaxed">
            <p>
              The voltage drop per ampere per metre values are found in the "B" series of
              current-carrying capacity tables in Appendix 4 of BS 7671. Each table covers a
              specific cable construction. The most commonly used tables for UK domestic and
              commercial installations are:
            </p>
            ...
            <p>
              Within each table, find the row for your cable cross-sectional area (1.0 mm², 1.5 mm²,
              2.5 mm², 4 mm², 6 mm², 10 mm², 16 mm², 25 mm², etc.). Then read across to the column
              for your circuit type: "2-core cable, single-phase a.c. or d.c." or "3-core or 4-core
              cable, three-phase a.c.". Some tables split the value into separate resistive (r) and
              reactive (x) components for larger cables where reactance becomes significant.
            </p>
            <p>
              The Elec-Mate voltage drop calculator has all of these tables built in. Simply select
              your cable type and cross-sectional area, and the correct mV/A/m value is
              automatically applied to the calculation. This eliminates manual table look-up errors
              and saves considerable time when designing circuits or verifying installations on
              site.
            </p>
          </div>
        </div>
          ...
          <div className="space-y-6">
            ...
            <div className="p-6 rounded-2xl bg-white/[0.04] border border-white/10">
              ...
              <div className="space-y-2 text-white leading-relaxed text-sm">
                <p>
                  A ring final circuit supplies socket outlets in a domestic kitchen. The circuit is
                  wired in 2.5 mm² flat twin and earth cable (Table 4D5B). The total cable length of
                  the ring is 50 metres. The design current is 30 A (though the ring is protected by
                  a 32 A MCB). What is the voltage drop?
                </p>
                <p>
                  For a ring circuit, the effective length used in the volt drop calculation is one
                  quarter of the total ring length (because current flows in both directions around
                ...
                <p>
                  Result: <strong className="text-green-400">PASS</strong> — 6.75 V is within the
                  11.5 V (5%) limit for power circuits.
                </p>
              </div>
            </div>
            ...
            <div className="p-6 rounded-2xl bg-white/[0.04] border border-white/10">
              ...
              <div className="space-y-2 text-white leading-relaxed text-sm">
                <p>
                  A lighting circuit in a large workshop runs 45 metres from the consumer unit to
                  the furthest luminaire. The circuit is wired in 1.5 mm² flat twin and earth cable
                ...
                <p>
                  Result: <strong className="text-red-400">FAIL</strong> — 10.44 V exceeds the 6.9 V
                  (3%) limit for lighting circuits. The cable must be increased to 2.5 mm² (mV/A/m =
                  18), giving: 18 × 8 × 45 ÷ 1000 = 6.48 V (2.82%) —{' '}
            ...
            <div className="p-6 rounded-2xl bg-white/[0.04] border border-white/10">
              ...
              <div className="space-y-2 text-white leading-relaxed text-sm">
                <p>
                  A three-phase SWA sub-main cable runs 60 metres from the main switchboard to a
                  sub-distribution board. The cable is 25 mm² 4-core copper XLPE SWA (Table 4E4B,
                ...
                <p>
                  Result: <strong className="text-green-400">PASS</strong> — 7.2 V is within the 20
                  V (5% of 400 V) limit for a three-phase power circuit. However, remember that the
                  voltage drop in the final circuits downstream of the sub-distribution board must
                  also be added, and the total must remain within 5%.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 px-5">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-white text-center mb-10 max-w-2xl mx-auto">
            Purpose-built for UK electricians working to BS 7671. Faster and more accurate than
      ...
      <section className="py-16 px-5">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-white mb-6 leading-relaxed">
            Below are the most commonly referenced mV/A/m values from BS 7671 Table 4D5B for flat
            twin and earth cable (copper conductors, single-phase). These are the cables used in the
            vast majority of domestic and small commercial installations.
          </p>
