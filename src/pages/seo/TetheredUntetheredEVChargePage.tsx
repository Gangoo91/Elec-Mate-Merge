...
const sections = [
    ...
    content: (
      <>
        <p>
          ...
          point unit. One end of the cable is hardwired or factory-fitted into the charger housing;
          the other end terminates in a vehicle connector (almost always Type 2 in the UK) that
          plugs directly into the vehicle's charging inlet. To charge, you simply lift the cable
          from its holster, walk to your car, and plug in.
        </p>
        <div className="rounded-2xl bg-blue-500/10 border border-blue-500/20 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Mode 3 charging</strong> — all dedicated home and workplace AC EV chargers
                in the UK operate in Mode 3 (IEC 61851-1). This mode uses a Communication Pilot
                signal between the charger and vehicle to negotiate charge rate and confirm that
                both ends are safely connected before power flows. Mode 3 is distinct from Mode 2
                (portable "granny charger" with in-cable control box) and Mode 4 (DC rapid
                charging).
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                holster or bracket to store the cable neatly when not in use. The vehicle connector
                typically clips into a socket on the front or side of the unit to protect the pins
                from the elements and prevent trip hazards.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Fixed cable length</strong> — tethered cables are typically 5m or 8.5m. The
                cable cannot be extended after installation. If the driveway layout changes (e.g., a
                second vehicle parks further away), a longer tethered cable or an additional charger
                may be needed.
              </span>
            </li>
          </ul>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          An untethered EV charger (also called a socketed charger) has a Type 2 outlet socket on
          the charge point unit but no permanently attached cable. The user provides their own Mode
          3 cable — plugging one end into the charge point socket and the other into the vehicle
          inlet. The cable is the user's property and travels with them (in the car boot,
          typically).
        </p>
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                all modern EVs in the UK). Some older EVs imported from North America or Japan use
                Type 1 (SAE J1772) inlets and require a Type 1 to Type 2 cable (Type 1 end into the
                vehicle, Type 2 end into the charger socket).
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Settings className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                3 cables are rated for 32A. Cheaper cables may only be rated for 16A or 20A,
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                specification). The connector cannot be removed without ending the session. This
                prevents accidental disconnection but not deliberate cable cutting.
              </span>
            </li>
          </ul>
        </div>
        ...
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Type 2 to Type 2 (Mennekes to Mennekes)</strong> — the standard cable for
                all modern UK EVs. Both ends are 7-pin IEC 62196-2 Type 2 connectors. Used for:
                Tesla (Models 3/Y/S/X), Volkswagen Group vehicles, BMW, Mercedes, Hyundai, Kia,
                Nissan LEAF (2013+), Renault Zoe, Vauxhall, Peugeot, Ford Mustang Mach-E, and
                virtually all other EVs sold new in the UK. Prices range from approximately £100
                (basic) to £350 (premium with data cable for reduced latency). A 7.5m Type 2 cable
                at 32A rating is the recommended length and rating for domestic use.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle className="w-5 h-5 text-green-400 mt-0.5 shrink-0" />
              <span>
                <strong>Type 1 to Type 2 (SAE J1772 to Mennekes)</strong> — required for older EVs
                with a Type 1 inlet, primarily pre-2013 Nissan LEAF, early Mitsubishi Outlander
                PHEV, some Chevrolet Volt imports. The Type 1 end (5-pin round connector) goes into
                the vehicle; the Type 2 end goes into the charge point socket. These vehicles
                typically charge at a maximum of 7.4kW on single-phase.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                additional DC pins (lower section). For home AC charging, the vehicle uses the Type
                2 upper section only with a standard Type 2 cable. CCS is not relevant to the
                tethered vs untethered decision for AC chargers.
              </span>
            </li>
          </ul>
        </div>
        ...
        <div className="rounded-2xl bg-green-500/10 border border-green-500/20 p-6 my-4">
          ...
          <ul className="space-y-3 text-white">
            <li className="flex items-start gap-3">
              <CheckCircle className="w-5 h-5 text-green-400 mt-0.5 shrink-0" />
              <span>
                <strong>Convenience</strong> — no cable to retrieve from the boot, plug in both
                ends, and coil away afterwards. Simply take the tethered cable and plug into the
                car. Particularly appreciated during cold, wet, or dark winter evenings.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle className="w-5 h-5 text-green-400 mt-0.5 shrink-0" />
              <span>
                <strong>No additional cable cost</strong> — the cable is included with the charger.
                No need to purchase a separate Mode 3 cable (£100–350).
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle className="w-5 h-5 text-green-400 mt-0.5 shrink-0" />
              <span>
                <strong>Cable always on-site</strong> — the cable cannot be accidentally left at
                home, in the car, or forgotten. It is always ready to use.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle className="w-5 h-5 text-green-400 mt-0.5 shrink-0" />
              <span>
                <strong>No cable theft</strong> — the cable is permanently attached and cannot be
        ...
        <div className="rounded-2xl bg-gradient-to-b from-white/[0.08] to-white/[0.04] border border-white/[0.14] p-6 my-4">
          ...
          <ul className="space-y-3 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Single cable type</strong> — a Type 2 tethered cable will not work with
                older Type 1 vehicles (pre-2013 Nissan LEAF, etc.) without an adapter, which is not
                recommended for Mode 3 charging.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-red-400 mt-0.5 shrink-0" />
              <span>
                <strong>Fixed cable length</strong> — if the car is parked at an unexpected angle or
                distance, the cable may not reach. Cannot be extended after installation.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-red-400 mt-0.5 shrink-0" />
              <span>
                <strong>Cable degradation</strong> — the permanently attached cable is exposed to
                weather, UV, and wear for the life of the charger. Cable replacement (if available)
                is a manufacturer service job, not a quick swap.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-red-400 mt-0.5 shrink-0" />
              <span>
                <strong>Not ideal for shared bays</strong> — in communal parking, multiple users
                sharing one charger with different vehicles and potentially different connector
                needs makes untethered more practical.
              </span>
            </li>
          </ul>
        </div>
        ...
        <div className="rounded-2xl bg-green-500/10 border border-green-500/20 p-6 my-4">
          ...
          <ul className="space-y-3 text-white">
            <li className="flex items-start gap-3">
              <CheckCircle className="w-5 h-5 text-green-400 mt-0.5 shrink-0" />
              <span>
                <strong>Multiple users, multiple vehicles</strong> — any user with a Type 2 cable
                (or Type 1 to Type 2 adapter) can use the same charger socket. Ideal for shared
                bays, communal car parks, and visitor charging.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle className="w-5 h-5 text-green-400 mt-0.5 shrink-0" />
            ...
            <li className="flex items-start gap-3">
              <CheckCircle className="w-5 h-5 text-green-400 mt-0.5 shrink-0" />
              <span>
                <strong>No cable degradation at the charger</strong> — the charger housing contains
                only the socket; the cable wears normally as a user-replaceable item.
              </span>
            </li>
          </ul>
        </div>
        <div className="rounded-2xl bg-gradient-to-b from-white/[0.08] to-white/[0.04] border border-white/[0.14] p-6 my-4">
          ...
          <ul className="space-y-3 text-white">
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-red-400 mt-0.5 shrink-0" />
              <span>
                <strong>Requires a separate cable</strong> — the user must purchase and maintain a
                Mode 3 cable (£100–350). The cable must be stored (usually in the boot) and handled
            ...
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-red-400 mt-0.5 shrink-0" />
              <span>
                <strong>Cable theft risk</strong> — cables left connected to an untethered charger
                between sessions can be stolen. Cable locking during sessions reduces (but does not
                eliminate) this risk.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-red-400 mt-0.5 shrink-0" />
              <span>
                <strong>Convenience</strong> — handling a charging cable in poor weather is less
                convenient than picking up a tethered connector. The cable can be heavy (a 7.5m 32A
                Type 2 cable weighs approximately 3–4kg).
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Cable theft and charge point vandalism are genuine concerns for EV charger installations
          in exposed or communal locations. Understanding the security features of different charger
          types helps installers advise customers appropriately.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                and the charger housing is typically covered by the enclosure. Cable cutting is
                possible but uncommon for a tethered unit as the cable has no resale value without
                the charger.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                locked at both the charge point socket and the vehicle inlet until the session ends.
                A cable left plugged in but with no active session (between sessions) is not locked
                and can be removed.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                alarmed enclosures and remote monitoring that alerts the operator to physical
                tampering.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                chargers are required for access flexibility, choose chargers with a socket guard (a
                lockable cover over the socket when not in use) and advise users not to leave their
                cable plugged into the socket between sessions.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          The question of future-proofing often leads customers to favour untethered chargers, on
          the assumption that connector standards may change. In practice, the risk of obsolescence
          is low for AC Type 2 charging, and other future-proofing considerations are more
          important.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Type 2 stability</strong> — the Type 2 connector is mandated by EU Directive
                2014/94/EU and is the UK standard (retained post-Brexit). All EVs sold new in the UK
                accept Type 2 AC charging. No change to this standard is anticipated in the
                foreseeable future.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Smart functionality</strong> — a more relevant future-proofing consideration
                is ensuring the charger supports OCPP (Open Charge Point Protocol) and can receive
                firmware updates, enabling it to benefit from improvements to smart charging, demand
                response, and vehicle API integration over its lifetime. All OZEV-approved smart
                chargers support these features.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Load management headroom</strong> — if the property may add additional
                chargers in future, installing a dynamic load management system from the start (even
                for a single charger) means additional chargers can be added without supply
                upgrades.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                three-phase supply, installing a three-phase-capable charger (or conduit that could
                accommodate three-phase cabling in future) allows upgrading from 7.4kW to 22kW
                without additional groundworks.
              </span>
            </li>
          </ul>
        </div>
        ...
        <div className="rounded-2xl bg-blue-500/10 border border-blue-500/20 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Detached house, single EV household</strong> — tethered 7.4kW, 5m cable.
                Maximum convenience; no shared access needed; cable theft not a concern. Specify
                Zappi if solar PV is installed; Pod Point or Ohme if smart tariff optimisation is
                the priority.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Flat, private parking bay</strong> — tethered 7.4kW (most convenient for the
                resident); or untethered if visitor access to the bay is occasionally needed. Ohme
                ePod or Pod Point Solo 3 popular choices for flats.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Communal car park, multiple residents</strong> — untethered with access
                control (RFID or app). Each resident uses their own cable. Load management
                essential. Easee Charge or Pod Point Solo 3 (socket version) with a management
                platform.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Workplace, employee parking</strong> — untethered (employees bring their own
                cables) with RFID access control and fleet management portal. Easee Charge with
                Equalizer or Pod Point Pro for multi-charger sites.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Fleet depot, commercial vehicles</strong> — untethered 22kW three-phase (for
                vans with 11–22kW onboard chargers) with load management. Easee Charge (22kW) or
                Wallbox Commander 2 with fleet management software.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Visitor or public access</strong> — untethered (visitors have their own
                cables) with contactless payment to comply with Public Charge Point Regulations
                2023. Pod Point network chargers or similar payment-enabled units.
              </span>
            </li>
          </ul>
        </div>
    ...
    content: (
      <>
        <p>
          ...
          recommendation — based on their specific situation — builds trust and positions you as a
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  ...
                  leave. For OZEV grant-funded installations, the certificate must be submitted with
                  the grant claim.
                </p>
              </div>
            </div>
...
export default function TetheredUntetheredEVChargePage() {
  return (
    <GuideTemplate
      title="Tethered vs Untethered EV Charger: UK Guide"
