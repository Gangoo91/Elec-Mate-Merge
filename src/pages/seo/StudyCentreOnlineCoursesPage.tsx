      ...
      sections={[
        {
          ...
          content: (
            <>
              ...
              <p>
                ...
                £6.99/month. There are no per-course charges. You have unlimited access to every
          ...
          appBridge: {
            ...
            description:
              'Level 2, Level 3, 18th Edition, 2391, AM2 preparation, and CPD. Video lessons, quizzes, flashcards, and mock exams. From £6.99/month with 7-day free trial.',
            icon: GraduationCap,
          },
        },
        {
