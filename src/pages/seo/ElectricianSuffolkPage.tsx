...
const faqs = [
  ...
  {
    question:
      'What electrical certifications do I need for port or industrial electrical work at Felixstowe?',
    answer:
  ...
  {
    question:
      'What electrical qualifications are needed for offshore wind support work in Suffolk?',
    answer:
...
const sections = [
  {
    ...
    content: (
      <>
        <p>
          Suffolk electricians registered on Elec-Mate cover the whole county, from the county town
          of Ipswich to the coastal towns and the rural interior.
        </p>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          UK Power Networks is the sole Distribution Network Operator for Suffolk. All supply
          connections, meter upgrades, and network faults are handled through UK Power Networks.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                connection quote. Lead times for new 3-phase connections can be 3 to 6 months in
                rural areas.
              </span>
            </li>
          </ul>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          The Port of Felixstowe is the UK&apos;s largest container port, handling around 4 million
          TEUs per year. The port and associated logistics parks on the Orwell estuary create
          extensive demand for specialist industrial electrical services.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                supplies, busbar systems, and festoon cable maintenance.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                weatherproof enclosures to IP55 minimum.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Suffolk has an exceptionally high concentration of Listed buildings, particularly in
          Lavenham, Long Melford, Framlingham, Woodbridge, and the Dedham Vale area. Electricians
          working in these buildings must balance compliance with BS 7671 with the requirements of
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                replacement light fittings that differ from existing, or any work that removes or
                alters original fabric.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                finishes. Brass or period-style accessories are available where modern white plastic
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          The East Anglia offshore wind zone is one of the largest offshore wind development areas
          in the world, with East Anglia ONE already operational and further projects in
          development. Suffolk-based electricians with relevant qualifications are well placed to
          support the onshore and inter-array electrical infrastructure.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                works, joint bay installations, and substation civil and electrical work.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
