...
export default function BestQuotingAppPage() {
  return (
    <ComparisonTemplate
          ...
          content: (
            <>
              <p>
                ...
                calculators, AI tools, and 46+ training courses. From £6.99/month.
              </p>
              <p>
      ...
      verdictContent={
        <>
          ...
          <p>
            ...
            everything. From £6.99 per month with a 7-day free trial, Elec-Mate is the most
      ...
      ctaSubheading="Try Elec-Mate free for 7 days. Quoting, invoicing, Stripe payments, Xero integration, certificates, calculators, AI tools, and training. All from £6.99/month."
