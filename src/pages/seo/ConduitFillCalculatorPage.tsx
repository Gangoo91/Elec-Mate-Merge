...
export default function ConduitFillCalculatorPage() {
  useSEO({
    ...
    description:
      'Free conduit fill calculator: add your cables and get the minimum conduit size, bends included. Factors 16mm 290, 20mm 460, 25mm 800, 32mm 1400.',
  });
    ...
    <PublicPageLayout>
      ...
      <section className="relative overflow-hidden py-20 sm:py-28 px-5">
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg sm:text-xl text-white max-w-2xl mx-auto mb-8 leading-relaxed">
            ...
            conduit size for any combination of cables, with bend adjustments and trunking fill mode
            included.
          </p>
      ...
      <section className="py-16 px-5">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4 text-white leading-relaxed">
            <p>
              Conduit fill refers to the proportion of a conduit's internal space that is occupied
              by cables. Getting this right is critical for three reasons: heat dissipation, pulling
            ...
            <p>
              ...
              is packed too tightly with cables, the air space is insufficient, and the cables
              overheat. Overheating degrades the insulation over time, reducing the cable's lifespan
              and eventually causing insulation failure, short circuits, and potentially fire. The
              cable factor tables account for this by limiting the fill to approximately 40% of the
            ...
            <p>
              ...
              risking damage to the cable insulation — particularly at bends where the cables are
              pressed against the conduit wall. Damaged insulation can lead to earth faults, short
            ...
            <p>
              ...
              alterations, extensions, or technology upgrades may require. Many specifications call
              for conduit to be no more than 30 to 35% full to allow for future growth.
            </p>
            <p>
              For these reasons, conduit fill calculations are a fundamental part of electrical
      ...
      <section className="py-16 px-5 bg-white/[0.02]">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4 text-white leading-relaxed">
            <p>
              The cable factor method is the standard approach in the UK for calculating conduit
              fill. It uses a system of dimensionless "factors" — one for each cable size and one
              for each conduit size — that make the calculation simple without needing to work with
              actual cross-sectional areas in square millimetres.
            </p>
            <p>
              The principle is straightforward: each cable has a cable factor that represents the
              space it occupies. Each conduit has a conduit factor that represents the space
            ...
            <p>
              The cable factors are derived from the overall diameter of each cable (including
              insulation), and the conduit factors are derived from the usable internal
              cross-sectional area of each conduit size, reduced to approximately 40% to allow for
              air space and pulling clearance. This means the factor system already has the safety
              margin built in — you do not need to apply an additional reduction.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-5">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4 text-white leading-relaxed">
            <p>
              The table below shows the cable factors for the most common sizes of single-core PVC
              insulated cables (to BS 6004) used in conduit installations. These are the "singles" —
              individual conductors with PVC insulation but no sheath — that are drawn into conduit
              for wiring circuits.
            </p>
          </div>
          ...
          <div className="space-y-4 text-white leading-relaxed mt-6">
            <p>
              Note that 1.0 mm² and 1.5 mm² cables have the same cable factor (22) because their
              overall diameters (including insulation) are very similar. The difference in conductor
              cross-section is small at these sizes, and the insulation thickness is the dominant
              dimension.
            </p>
          </div>
        </div>
      ...
      <section className="py-16 px-5 bg-white/[0.02]">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4 text-white leading-relaxed">
            <p>
              The conduit factors below are for standard round PVC conduit (heavy gauge, to BS EN
              61386). The factor depends on the conduit size and the length and complexity of the
              run. Straight runs and runs with gentle bends have higher factors (more capacity),
              while runs with multiple tight bends have lower factors.
            </p>
          </div>
          ...
          <p className="text-white text-sm leading-relaxed mt-4">
            The "With Bends" column shows a reduced conduit factor for runs containing two or more
            bends. For runs with a single bend, use a value between the straight and bends columns.
            The Elec-Mate calculator adjusts the factor automatically based on the number of bends
            you specify.
          </p>
        </div>
      </section>
          ...
          <div className="space-y-6">
            ...
            <div className="p-6 rounded-2xl bg-white/[0.04] border border-white/10">
              ...
              <div className="space-y-2 text-white leading-relaxed text-sm">
                <p>
                  A conduit run carries two lighting circuits. Each circuit requires one 1.5 mm²
                  line conductor and one 1.5 mm² neutral conductor, plus a shared 1.5 mm² CPC. Total
                ...
                <p>
                  ...
                  room. You could fit up to 20 conductors of 1.5 mm² in a 20 mm straight run (20 x
                  22 = 440 ≤ 460).
                </p>
              </div>
            </div>
            ...
            <div className="p-6 rounded-2xl bg-white/[0.04] border border-white/10">
              ...
              <div className="space-y-2 text-white leading-relaxed text-sm">
                <p>
                  A conduit run with two 90-degree bends carries one 2.5 mm² radial circuit (line,
                  neutral, CPC = three 2.5 mm² singles) and two 1.5 mm² lighting circuits (line,
                  neutral each = four 1.5 mm² singles, plus one shared 1.5 mm² CPC = five 1.5 mm²
                  singles).
                </p>
                <p className="font-mono text-white">
                ...
                <p>
                  ...
                  conduit is adequate. A 20 mm conduit with bends (factor 320) would also work: 200
                  ≤ 320.
                </p>
              </div>
            </div>
            ...
            <div className="p-6 rounded-2xl bg-white/[0.04] border border-white/10">
              ...
              <div className="space-y-2 text-white leading-relaxed text-sm">
                <p>
                  An electrician wants to run three 2.5 mm² radial circuits and one 4 mm² cooker
                  circuit through a single 20 mm conduit with three bends. Each 2.5 mm² circuit has
                  3 conductors; the 4 mm² circuit has 3 conductors.
                </p>
                <p className="font-mono text-white">
                ...
                <p>
                  ...
                  conduit is too small. Upgrading to 25 mm conduit with bends (factor 560) solves
                  the problem: 399 ≤ 560. Alternatively, install a draw-in box to split the run and
                  use the straight-run factor for 20 mm (460), which also works: 399 ≤ 460.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4 text-white leading-relaxed">
            <p>
              ...
              difficulty. Each bend increases friction between the cables and the conduit wall, and
              the cables press against each other at bend points, increasing the pulling tension
              required. Excessive pulling tension can stretch conductors, damage insulation, and
              even pull cables off their terminations.
            </p>
            <p>
              As a general rule, a conduit run should not contain more than two 90-degree bends (or
              the equivalent) between draw-in points. If the run requires more bends, a draw-in box
              or inspection tee should be installed to break the run into manageable sections. Each
              section is then treated as an independent run for the purposes of conduit fill
              calculations.
            </p>
            <p>
              Long straight runs also present challenges. Friction accumulates over length, and a
              15-metre straight run requires more pulling force than a 5-metre run. For runs
              exceeding 10 metres without a bend, some specifications recommend reducing the conduit
              factor by 10% to account for the additional friction. The Elec-Mate calculator allows
              you to input the run length and automatically flags long runs that may benefit from
              intermediate draw-in points.
            </p>
            <p>
              Cable lubricant (sometimes called "cable wax" or "pulling compound") can significantly
              reduce friction during installation and is recommended for any run that is near the
              conduit factor limit or contains multiple bends. This does not change the conduit
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4 text-white leading-relaxed">
            ...
            <p>
              ...
              (including insulation and sheath for multicore cables, or insulation only for
              singles). The cross-sectional area of each cable is calculated as pi times the radius
              squared. Sum the areas of all cables, then compare against 45% of the trunking's
              internal cross-sectional area (width x height for rectangular trunking).
            </p>
            <p>
              For example, consider a 100 mm x 50 mm trunking. The internal cross-sectional area is
              100 x 50 = 5000 mm². 45% of 5000 = 2250 mm². If the total cross-sectional area of all
              cables is 2000 mm², the trunking is adequate: 2000 ≤ 2250.
            </p>
            <p>
              The 45% limit is more generous than the approximately 40% limit for conduit because
              trunking has a removable lid — cables are laid in from the top rather than pulled
              through, so the friction and pulling tension constraints are less severe. However, the
              heat dissipation requirement still applies, which is why the fill is limited to less
              than half.
            </p>
            <p>
      ...
      <section className="py-16 px-5">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-white text-center mb-10 max-w-2xl mx-auto">
            Purpose-built for UK electricians working to BS 7671. Eliminates guesswork and ensures
