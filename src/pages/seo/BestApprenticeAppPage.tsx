...
export default function BestApprenticeAppPage() {
  return (
    <ComparisonTemplate
      ...
      verdictContent={
        <>
          ...
          <p>
            ...
            subscription from £6.99 per month covers your entire career progression, with a 7-day
      ...
      ctaSubheading="Try Elec-Mate free for 7 days. 46+ training courses, 20,000+ practice questions, AM2 prep, EPA simulator, flashcards, mock exams, and everything else you need to qualify. From £6.99/month."
