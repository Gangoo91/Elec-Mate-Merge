...
const sections = [
  {
    ...
    content: (
      <>
        <p>
          Unlike residential rental properties, holiday lets in England are not currently subject
          to the Electrical Safety Standards in the Private Rented Sector (England) Regulations
          2020. Those regulations apply only to properties let under assured shorthold tenancies,
          assured tenancies, and regulated tenancies. A holiday let — defined as accommodation let
          for a short period to guests who are not occupying the property as their main or only
          home — falls outside the scope of these regulations.
        </p>
        <div className="rounded-2xl bg-blue-500/10 border border-blue-500/20 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Not caught by the 2020 Regulations</strong> — the mandatory EICR regime
                for landlords does not apply to holiday accommodation, short-term holiday lets,
                or properties let through platforms such as Airbnb where guests are tourists or
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                Reform (Fire Safety) Order 2005, which applies to non-domestic premises and
                premises to which members of the public have access. A fire risk assessment
                may be required.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                Occupiers Liability Act 1957 imposes a duty of care on all owners of premises
                to which they invite visitors for a business purpose. A holiday let is a
                business use of the property and this duty applies fully.
              </span>
            </li>
          </ul>
        </div>
        <p>
          ...
          regulations impose electrical safety obligations on some Welsh holiday lets. Scottish
          law also differs. This guide focuses on England.
        </p>
      </>
    ),
  },
        ...
        <div className="rounded-2xl bg-red-500/10 border border-red-500/20 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Liability for electrical defects</strong> — if a guest is injured or
                killed by an electrical fault — electric shock, fire caused by a wiring defect,
                or malfunction of a fixed appliance — the holiday let owner may face civil
                liability under the 1957 Act. Compensation claims can be substantial, particularly
                where injuries are serious or fatal.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-red-400 mt-0.5 shrink-0" />
              <span>
                <strong>Failure to inspect as evidence of negligence</strong> — courts will
                consider whether the owner took reasonable steps to identify and remedy
                electrical hazards. Having no EICR, no PAT testing records, and no inspection
                history is strong evidence of failure to take reasonable care. Having a current
                EICR significantly strengthens the owner's position in any claim.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-red-400 mt-0.5 shrink-0" />
              <span>
                ...
                applies in relation to trespassers, including children. Where a holiday let has
                a garden or outbuildings accessible to children, the owner must take reasonable
                steps to protect children from electrical hazards in those areas.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Industry bodies including NICEIC, NAPIT, and the UK Holiday Letting Association
          recommend that holiday let owners obtain an EICR at least every five years — the same
          interval as for residential rental properties. This recommendation reflects the duty of
          care owed to guests and the requirements of most specialist holiday let insurance policies.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Five years — standard recommended interval</strong> — consistent with
                the residential landlord EICR requirement and with BS 7671 guidance on periodic
                inspection of domestic and similar premises. Properties with older wiring or
                a history of defects may warrant a shorter interval.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ClipboardCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                immediately when purchasing a property for holiday letting, before the first
                guests are admitted. Do not rely on any EICR commissioned by the previous
                owner for a different purpose without confirming its scope and validity.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ClipboardCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                replacement, or significant circuit addition should be followed by a fresh EICR
                to confirm the installation remains safe and compliant. The contractor carrying
                out the work should issue an Electrical Installation Certificate (EIC) for
                notifiable work.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ClipboardCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Keep the report on file</strong> — retain every EICR carried out on
                the property. In the event of a claim, these records demonstrate the history
                of inspection and the steps taken to maintain electrical safety.
              </span>
            </li>
          </ul>
        </div>
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                letting season or as part of an annual safety review. High-use items in busy
                holiday lets may warrant more frequent testing.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>What PAT testing covers</strong> — visual inspection of plugs, cables,
                and appliance casings plus electrical testing of insulation resistance and earth
                continuity. Each tested appliance receives a pass or fail label with the test
                date and next test due date.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Electric blankets — additional risk</strong> — electric blankets are
                one of the highest-risk portable appliances in holiday lets. They should be
                tested annually and replaced every ten years regardless of condition. Consider
                removing electric blankets from holiday lets entirely and substituting with
                good-quality duvets to eliminate the risk.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Keep a PAT testing register</strong> — maintain a record of every
                appliance tested, the test date, result, and tester's details. This register
                is evidence of reasonable care in any liability claim and is often requested
                by insurers on renewal.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Whilst there is currently no statutory requirement mandating smoke alarms specifically
          in holiday lets in England under residential tenancy legislation, the duty of care under
          the Occupiers Liability Act 1957 makes fitting them effectively obligatory in practice.
          Absence of smoke alarms would be very difficult to defend in a personal injury or
          fatality claim following a fire.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Smoke alarms on every floor</strong> — fit an interlinked smoke alarm
                on every floor of the holiday let, positioned in hallways and at the top of
                stairwells. Mains-powered alarms with battery back-up are preferred over
                battery-only alarms. Test alarms at every changeover clean.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <BellRing className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Carbon monoxide alarms</strong> — fit a CO alarm in every room
                containing a solid fuel burning appliance (log burner, open fire) and in
                any room adjacent to a gas boiler or gas cooking appliance. CO poisoning is
                a significant risk in holiday lets where guests may use log burners or solid
                fuel fires incorrectly.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <BellRing className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Heat detectors in kitchens</strong> — install a heat detector rather
                than a smoke detector in the kitchen to avoid false alarms from cooking.
                The heat detector should be interlinked with the smoke alarm network.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <BellRing className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Guest information — what to do in a fire</strong> — post clear
                instructions in each bedroom and in the hallway explaining the fire exit
                route, the location of the fire assembly point, and instructions for
                raising the alarm. This is a basic duty-of-care requirement.
              </span>
            </li>
          </ul>
        </div>
    ...
    content: (
      <>
        <p>
          ...
          Regulation 411.3.3 of BS 7671:2018 requires 30mA RCD protection on socket-outlet
          circuits — a requirement that applies to new and replacement installations regardless
          of property type.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>RCD protection on all socket circuits</strong> — all socket-outlet
                circuits rated up to 32A must be protected by a 30mA RCD under Regulation
                411.3.3. If the holiday let's consumer unit does not provide this, an EICR
                will record a C2 observation and a consumer unit upgrade will be required.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Outdoor circuits — higher risk in holiday lets</strong> — guests
                frequently use outdoor areas: gardens, patios, hot tubs, and outbuildings.
                All outdoor circuits must have 30mA RCD protection. Consider installing
                additional outdoor socket outlets with integrated RCD protection for
                safety and guest convenience.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Hot tubs and swimming pools</strong> — if the holiday let includes a
                hot tub or swimming pool, the electrical supply must comply with BS 7671
                Part 7 special locations (Section 702 for swimming pools and Section 709
                for marinas and similar). These areas require additional protection measures
                including supplementary equipotential bonding and specific circuit
                arrangements.
              </span>
            </li>
          </ul>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          A current EICR certificate is increasingly used as a marketing tool by holiday let
          owners to differentiate their property and reassure prospective guests. Safety
          credentials are becoming an expected feature of professionally managed holiday lets.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              <ClipboardCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Listing on booking platforms</strong> — platforms including Airbnb,
                Vrbo, and Booking.com allow or encourage owners to display safety certificates.
                Airbnb has expanded its safety requirements for UK hosts. A current EICR,
                combined with a gas safety certificate and PAT testing record, can be
                highlighted in the listing description to increase guest confidence.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ClipboardCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                increasingly ask about electrical safety certificates. Some require confirmation
                of a current EICR as a condition of listing.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ClipboardCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Reassurance for families with children</strong> — families booking
                holiday accommodation are increasingly aware of electrical safety risks.
                Displaying a current EICR certificate is a straightforward way to provide
                reassurance and may tip a booking decision in your favour.
              </span>
            </li>
          </ul>
        </div>
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                including Hiscox, Zurich, and various Lloyd's market providers commonly require
                a current EICR (typically within the past five years) as a condition of cover.
                Failure to disclose the absence of an EICR, or failure to carry out an EICR
                required by the policy, may result in a claim being declined or the policy
                being voided.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-red-400 mt-0.5 shrink-0" />
              <span>
                <strong>Public liability claims — uninsured exposure</strong> — if an EICR
                is required by your policy and has not been obtained, a public liability
                claim arising from an electrical injury may not be covered. The costs of an
                uninsured personal injury claim can be catastrophic for a property owner.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-red-400 mt-0.5 shrink-0" />
              <span>
                <strong>Contents and building claims</strong> — an electrical fire caused by
                a defective installation without a current EICR may give the insurer grounds
                to dispute a buildings or contents claim on the basis of failure to maintain
                the property in a safe condition. Check your policy wording carefully.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-red-400 mt-0.5 shrink-0" />
              <span>
                <strong>PAT testing records — often required</strong> — many policies also
                require evidence of PAT testing for portable appliances. Keep testing records
                available and present them to your insurer on renewal.
              </span>
            </li>
          </ul>
        </div>
        ...
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>PAT testing of all portable appliances</strong> — test annually and
                keep a register of all appliances, test dates, and results.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Smoke alarms on every floor</strong> — mains-powered with battery
                back-up, interlinked. Test at every changeover clean.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Carbon monoxide alarms</strong> — in every room with a solid fuel or
                gas appliance. Test at every changeover clean.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>RCD protection on all socket circuits</strong> — check the consumer
                unit provides 30mA RCD protection on all socket-outlet circuits. If not,
                arrange upgrade.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Outdoor circuits protected</strong> — garden sockets, outbuilding
                supplies, hot tub connections, and outdoor lighting all require appropriate
                RCD protection and weatherproof fittings.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Insurance policy reviewed</strong> — check policy wording for EICR
                and PAT testing requirements. Ensure all certificates are available for
                inspection by the insurer on renewal.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Holiday lets represent a growing and underserved market for electricians specialising
          in inspection and testing. Owners are often unaware of their duty-of-care obligations,
          many have no EICR on record, and the seasonal nature of the market creates recurring
          inspection and remedial work opportunities.
        </p>
