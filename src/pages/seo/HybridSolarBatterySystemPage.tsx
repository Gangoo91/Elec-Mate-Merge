...
const breadcrumbs = [{ label: 'Hybrid Solar Systems', href: '/hybrid-solar-battery-system' }];
...
const sections = [
  {
    ...
    content: (
      <>
        <p>
          A hybrid solar battery system is a grid-tied solar PV installation combined with a battery
          storage system. The term "hybrid" reflects the dual-source nature: the system can draw
          from both solar generation and the grid, and can export to the grid while also charging or
        ...
        <div className="rounded-2xl bg-blue-500/10 border border-blue-500/20 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Grid-tied with storage</strong> — unlike a pure off-grid system, a hybrid
                system remains connected to the grid. The grid acts as a backup when solar
                generation and battery are insufficient, and as a destination for surplus generation
                via the Smart Export Guarantee.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Battery className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Priority hierarchy</strong> — the system management software sets a priority
                order: (1) supply loads directly from solar; (2) charge battery with surplus; (3)
                export surplus to grid; (4) when solar insufficient, draw from battery; (5) import
                from grid when battery is depleted.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                England can achieve 60–75% annual self-sufficiency (percentage of demand met by
                solar + battery). This rises to 80%+ with larger arrays and EV smart charging.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          There are two technical approaches to creating a hybrid solar battery system. The right
          choice depends on whether an existing solar installation is already in place.
        </p>
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                hybrid inverter's MPPT inputs (DC), which then manages charging the battery (DC) and
                supplying AC loads. One DC-to-AC conversion step achieves 90–95% round-trip
                efficiency. Best for new installations. Requires replacing an existing solar
                inverter if retrofitting.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Settings className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                on the AC side. Solar DC → solar inverter AC → battery inverter AC → DC → battery.
                Two conversion steps reduce efficiency to 85–90% round-trip. No disruption to
                existing solar system. The lowest-risk retrofit for customers with mid-life solar
                inverters.
              </span>
            </li>
          </ul>
        ...
        <p>
          ...
          replacing it with a hybrid inverter and adding a DC-coupled battery is usually the most
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Modern hybrid systems use software to maximise the percentage of household demand met by
          solar — minimising grid import and maximising the value extracted from the solar array.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                inverters use weather forecasting APIs to predict tomorrow's solar yield. If a sunny
                day is forecast, the battery is not fully charged overnight from cheap grid
                electricity (to leave room for solar tomorrow). If a cloudy day is forecast, the
                battery is charged to 100% from cheap overnight tariff.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <TrendingUp className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Consumption monitoring</strong> — a current transformer (CT clamp) on the
                main incoming supply measures import/export in real time. The inverter uses this
                data to modulate battery charge/discharge to keep net import as close to zero as
                possible.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                Intelligent integrate the home battery, solar system, and EV charger. The platform
                optimises all three energy flows simultaneously to minimise import cost.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Time-of-use (ToU) electricity tariffs are where hybrid solar battery systems deliver their
          most significant financial benefit. The price spread between off-peak and peak import
          rates creates an arbitrage opportunity that the battery can exploit.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                fully charged from off-peak and fully discharged in the evening saves approximately
                £2 per cycle, or £730 per year at 365 cycles.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Clock className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                dispatch extracts maximum value from volatile pricing. Best combined with a hybrid
                system that has API integration with the Octopus platform.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Clock className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                half-hourly slots automatically, coordinated with weather forecast data.
              </span>
            </li>
          </ul>
        </div>
        <p>
          The actual savings depend on electricity prices at the time of installation. Customers
          should model savings based on current tariff rates using their actual smart meter
          half-hourly consumption data, available from the Octopus API or via n3rgy.
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>
          Hybrid systems can be configured to manage grid export and import actively, going beyond
          simple self-consumption to provide grid services and earn additional income.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                (premium rates from Octopus, OVO). MCS certification of installer and product is
                required. SMETS2 smart meter with half-hourly export metering is mandatory.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                inverters (SolarEdge, Sungrow, GivEnergy) can enforce a software-defined export
                limit using the CT clamp measurement.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                reducing or shifting consumption at peak grid stress times. GivEnergy, Tesla
                Powerwall, and Sungrow systems are compatible with various UK flexibility market
                platforms.
              </span>
            </li>
          </ul>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          The following hybrid systems are widely specified and installed in the UK market. All are
          available through UK trade distributors and have MCS-listed product ranges.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                portal. Very popular with UK installers for both new and retrofit applications.
                GivEnergy EMS integrates with Octopus tariffs natively.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                inverter. Deep integration with SolarEdge optimisers and monitoring platform. EV
                charger and heat pump interfaces available.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                the trade channel. Rapidly growing UK market share.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                sacrificing LFP chemistry or monitoring quality.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Hybrid solar battery systems represent a larger investment than solar-only installations,
          but the additional self-consumption savings and ToU arbitrage improve the overall return
          on investment.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                Battery payback adds 3–5 years to the solar-only payback period but extends the
                financial benefit horizon.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                Battery-only retrofits are also zero-rated since February 2024.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Hybrid solar battery installation is a growth market for qualified electricians with solar
          PV experience. G98 notification, MCS commissioning documentation, and inverter
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  ...
                  on your phone while still on site. Customers receive their documents before you
                  leave.
                </p>
              </div>
            </div>
