...
const sections = [
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Exeter EICR prices are broadly in line with the South West average. Below are typical
          2026 prices:
        </p>
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                centre and student areas near the University of Exeter.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Two-bedroom flat</strong> — £95 to £180. Victorian and Edwardian
                conversions in St David's and Heavitree take longer to inspect than modern
                purpose-built flats.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Three-bedroom house</strong> — £150 to £270. Victorian terraced houses
                in St Thomas, Heavitree, and Pinhoe are common in Exeter's private rented sector.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Four-bedroom+ house / HMO</strong> — £250 to £480+. Student HMOs in
                St David's and Heavitree have a broader inspection scope including fire alarm
          ...
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                28 days. Written confirmation must be provided to the tenant and to Exeter City
            ...
            <li className="flex items-start gap-3">
              <Scale className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Penalties</strong> — Exeter City Council can issue civil penalties of
    ...
    content: (
      <>
        <p>
          ...
          Georgian, and Victorian buildings. The inner suburbs of St David's, Heavitree, and
          St Thomas contain dense Victorian and Edwardian terraced housing that forms the backbone
          of the student rental market. Outer suburbs include inter-war and post-war housing:
        </p>
        <div className="rounded-2xl bg-red-500/10 border border-red-500/20 p-6 my-4">
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-red-400 mt-0.5 shrink-0" />
              <span>
                <strong>Rubber-insulated cables in Victorian properties</strong> — properties in
                St David's, Heavitree, and the city centre that have not been fully rewired may
                retain rubber-insulated cables from mid-20th century wiring. These degrade over
                time and are typically C1 or C2 observations.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-red-400 mt-0.5 shrink-0" />
              <span>
                ...
                arrangements and absent main protective bonding to gas and water services.
                These are frequent C2 findings.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-red-400 mt-0.5 shrink-0" />
              <span>
                ...
                heavy appliance use in student lets can overload circuits designed for domestic
                use. Extension leads used in lieu of sufficient socket outlets are a common source
        ...
        <p>
          Electricians working in St David's, Heavitree, and the city centre should allow extra
          time for EICRs in Victorian terraces and should be familiar with the requirements for
          working in Exeter's conservation areas.
        </p>
      </>
    ),
  },
        ...
        <div className="grid gap-4 sm:grid-cols-2 my-4">
          ...
          <div className="rounded-2xl bg-yellow-500/10 border border-yellow-500/20 p-5">
            ...
            <p className="text-white text-sm leading-relaxed">
              ...
              in Exeter properties where older accessories are still functional but dated.
            </p>
          </div>
        ...
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              <Clock className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>HMO</strong> — every 5 years minimum under Exeter City Council HMO
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                moves into any privately rented Exeter property, even if the current EICR has
                not expired.
              </span>
            </li>
          </ul>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Exeter's University of Exeter student population, strong private rented sector, and
          mixed Victorian and post-war housing stock create consistent demand for EICR work.
          The start of the academic year in September and October brings a surge in EICR
          requests as landlords rush to comply before new tenants move in.
        </p>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  ...
                  . Exeter landlords face a 28-day deadline and are under pressure to comply
                  before students arrive — quoting immediately gives you the best chance of
                  winning the remedial work.
                </p>
              </div>
            </div>
          </div>
