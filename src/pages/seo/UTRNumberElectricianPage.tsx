...
const relatedPages: RelatedPage[] = [
  {
    ...
    description:
      'Complete guide to filing your self-assessment tax return, allowable expenses, and deadlines.',
    icon: FileText,
  ...
  },
  {
    ...
    description:
      'When to register for VAT, the flat rate scheme, and domestic reverse charge explained.',
    icon: PoundSterling,
    category: 'Finance Guide',
  },
  {
...
const sections = [
    ...
    content: (
      <>
        <p>
          ...
          identifier with HMRC and never changes, even if you move house, change your name, or stop
        ...
        <div className="rounded-2xl bg-blue-500/10 border border-blue-500/20 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Format</strong> — your UTR is always 10 digits long, for example 1234567890.
                It appears on letters from HMRC, your online Personal Tax Account, self-assessment
                returns, and official correspondence. It is sometimes written with a K suffix (e.g.
                1234567890K) in certain contexts.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                ...
                take a break from self-employment and return years later, HMRC will reactivate your
                existing UTR rather than issue a new one.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                letters from HMRC titled "Your Unique Taxpayer Reference", your online HMRC Personal
                Tax Account, and notices to file a return.
              </span>
            </li>
          </ul>
        </div>
        <p>
          If you have been self-employed for some time but are unsure whether you have a UTR, log in
          to your HMRC Personal Tax Account at gov.uk/personal-tax-account or call HMRC on 0300 200
          3310 with your National Insurance number to hand.
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>
          You need a UTR number and must register for self-assessment if any of the following apply
          to your situation as an electrician:
        </p>
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                register. This threshold is the trading allowance; income below it can be covered by
                the allowance without a return in some circumstances.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                UTR. Your contractor will ask for it before the first payment, and HMRC requires it
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                separate UTR for the partnership itself.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                usually also need to file a personal self-assessment return and have a personal UTR.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Registering for self-assessment and obtaining your UTR number is a straightforward online
          process. Use form CWF1 if you are registering as a self-employed sole trader (the most
          common situation for electricians). Here is the process step by step:
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                trader". Complete the CWF1 online form. You will need a Government Gateway user ID
                and password; create one if you do not already have one.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ClipboardCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                away — keep it somewhere safe. If the letter does not arrive after three weeks,
                contact HMRC.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                account. Once activated, you can manage your self-assessment returns online and view
                your UTR at any time.
              </span>
            </li>
          </ul>
        </div>
        <p>
          ...
          self-assessment return) and obligates you to pay Class 4 NICs on profits above the Small
          Profits Threshold. Consult a qualified accountant if you are unsure how these affect your
          overall tax position.
        </p>
        <div className="rounded-2xl bg-yellow-500/10 border border-yellow-500/20 p-5 my-4">
          <p className="text-white text-sm">
            <strong>Disclaimer:</strong> This guide provides general information about HMRC
            registration processes. Tax law is complex and your individual circumstances may differ.
            Always consult a qualified accountant or tax adviser for advice tailored to your
            situation.
          </p>
        </div>
      </>
          ...
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                working days but can take up to 4 weeks during busy periods (January and April/May).
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Clock className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                are starting CIS work and need your UTR urgently. They can sometimes provide it
                verbally after verifying your identity.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          The Construction Industry Scheme (CIS) is particularly relevant for electricians working
          on construction projects as subcontractors. Your UTR number is central to how CIS works in
          practice.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                labour payments (not materials) and pay it to HMRC on your behalf. This is offset
                against your tax bill at year end.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                contractor must deduct 30%. This higher rate is a powerful financial incentive to
                register and obtain your UTR before starting work.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                deductions suffered and offset them against your tax liability. If your deductions
                exceed your tax bill, you receive a refund from HMRC.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                status under CIS, meaning contractors pay you without any deduction. You then settle
                your full tax bill via self-assessment.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Your UTR number is sensitive information. While it is not as widely misused as financial
          account details, it can be combined with other personal data to impersonate you with HMRC
          or commit tax fraud. Follow these basic security practices:
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                CIS contractors who need to verify you, and HMRC directly. Do not post it in online
                forums, include it in general email signatures, or share it with anyone who does not
            ...
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Secure the paper letter</strong> — the letter from HMRC containing your UTR
                should be filed securely (or scanned and stored in encrypted cloud storage) and not
                left accessible on a van dashboard or worksite.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                ...
                HMRC Personal Tax Account and enable two-factor authentication. If your HMRC account
                is compromised, your UTR and tax affairs are exposed.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Beware of phishing</strong> — HMRC will never ask for your UTR by email,
                text, or phone call out of the blue. If you receive an unsolicited contact claiming
                to be from HMRC and asking for your UTR, treat it as a phishing attempt and report
                it to HMRC's phishing team.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Once you have your UTR and are registered for self-assessment, keeping accurate records of
          your income and expenses throughout the year makes completing your annual return far
          simpler — and ensures you claim every allowable expense you are entitled to.
        </p>
          ...
          <div className="rounded-2xl bg-green-500/10 border border-green-500/20 p-5">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  Record every job as you complete it. Keeping organised records throughout the year
                  means no scrambling in January, and you are less likely to miss allowable expenses
