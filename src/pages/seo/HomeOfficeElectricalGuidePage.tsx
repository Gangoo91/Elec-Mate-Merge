...
const relatedPages: RelatedPage[] = [
  {
    ...
    description:
      'Zone requirements, socket positions, cooker circuits, and Part P compliance for kitchens.',
    icon: Zap,
    category: 'Guide',
  },
  {
    ...
    description:
      'Things to do when moving into a new property — RCD tests, smoke detectors, meter registration.',
    icon: Home,
    category: 'Guide',
  },
  {
...
const sections = [
    ...
    content: (
      <>
        <p>
          ...
          capacity of a standard ring circuit, a dedicated circuit provides several practical
          advantages.
        </p>
        <div className="rounded-2xl bg-blue-500/10 border border-blue-500/20 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Recommended circuit specification</strong> — a 20A radial circuit on 2.5mm²
                twin and earth (T&amp;E) cable, protected by a 20A MCB and a 30mA RCBO. This
                provides a dedicated, isolated supply with 4.6kW capacity — more than sufficient for
                all typical home office equipment combined.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                ...
                well-equipped office. Sockets at desk height (approximately 900mm from floor) or in
                a floor box reduce cable clutter. Avoid reliance on extension leads for permanent
                installations.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                positions. USB-C PD outlets (delivering 20W or more) are useful where laptops are
                used without their standard charger.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Switched spur for printer or server</strong> — a fused connection unit (FCU)
                with a local switch allows high-load equipment such as a laser printer or small
                server to be completely isolated when not in use, without having to access the
                consumer unit.
              </span>
            </li>
          </ul>
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                offices in 2026, Cat6 is entirely sufficient. Cat6A (augmented) provides 10 Gigabit
                at up to 100 metres and is future-proof.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Wifi className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                access point. Additional points for a monitor, NAS device, or VoIP phone are useful.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Wifi className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                (Cat8, optical fibre) without replastering. Conduit adds modest cost but significant
                long-term value.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                gives maximum flexibility for network configuration. Each point can be patched to
                the router, a switch, or left unused.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Lighting quality has a measurable effect on productivity, eye strain, and alertness. A
          home office converted from a bedroom or reception room typically has insufficient lighting
          for sustained desk work without modifications.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                for general office tasks (reading, writing) and 500 lux for detailed visual tasks.
                Measure existing light levels with a free lux meter app to understand what you are
                starting with.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                3m × 3m office, four to six downlights provide adequate general illuminance. Install
                on a dimmer to allow adjustment throughout the day.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Monitor className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                focus. Tunable white LED systems that shift colour temperature from warm in the
                morning to cool during peak working hours are available at modest cost.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Monitor className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                horizontal viewing angle. Downlights positioned directly above the desk are most
                problematic; side-mounted lighting or uplighting reduces direct screen reflection.
              </span>
            </li>
          </ul>
        </div>
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                draws approximately 30A continuously. This exceeds the capacity of a standard home
                office radial circuit. An EV charger requires its own dedicated 32A radial circuit
                protected by a Type B RCBO (required for DC fault protection where no in-built DC
                detection is present) under the OZEV (Office for Zero Emission Vehicles) grant
                conditions and BS 7671 Section 722.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Car className="w-5 h-5 text-red-400 mt-0.5 shrink-0" />
              <span>
                <strong>OZEV grant eligibility</strong> — the Electric Vehicle Chargepoint Grant for
                renters and flat owners (and certain home installations) requires the charger to be
                installed by an OZEV-authorised installer. The installation must include appropriate
                protective devices and cable management. A separate dedicated circuit is a condition
            ...
            <li className="flex items-start gap-3">
              <Car className="w-5 h-5 text-red-400 mt-0.5 shrink-0" />
              <span>
                <strong>Smart charging</strong> — a smart EV charger (required for any OZEV grant)
                allows scheduled charging at off-peak tariff times (typically overnight on Octopus
                Energy's Intelligent Tariff or similar). This significantly reduces charging costs
                and avoids daytime load coinciding with office equipment use.
              </span>
            </li>
          </ul>
        </div>
        <p>
          An EV charger installation is notifiable under Part P of the Building Regulations. Use an
          OZEV-registered installer to ensure grant eligibility, correct protection, and proper
          certification.
        </p>
      </>
    ),
          ...
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                route with cable protection tiles or warning tape at 150mm above the cable. Keep a
                record of the cable route with photographs taken before backfilling.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Sun className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                over the buried cable run, a supplementary earth electrode at the garden office end
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                is sufficient for a well-insulated 10m² to 15m² space. Ensure the circuit is rated
                for the heater load. Oil-filled radiators are not recommended as unattended
                overnight heating in an outbuilding.
              </span>
            </li>
          </ul>
        </div>
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                2m of a boundary (4m for a dual-pitched roof, 3m for any other roof); it does not
                cover more than 50% of the garden; it is not forward of the principal elevation; and
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                always notifiable under Part P of the Building Regulations. Use a registered
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                properties where permitted development rights have been removed by condition require
                full planning permission. Check with your local planning authority before
                proceeding.
              </span>
            </li>
          </ul>
    ...
    content: (
      <>
        <p>
          ...
          during a mains power interruption. For a home business, the cost of equipment failure or
          data loss from a single power event can far exceed the cost of UPS protection.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                sensitive electronics over time, and complete power failures that allow controlled
                shutdown.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                (volt-amperes). A workstation drawing 300W plus monitors at 100W plus network
                equipment at 50W = 450W × 1.4 = 630VA. A 1,000VA UPS provides comfortable headroom
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                (double-conversion) UPS units provide cleaner power with no switchover time but cost
                significantly more and are more appropriate for server rooms.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Whether you can claim tax relief on home office electrical work depends on your employment
          status, the nature of the work, and current HMRC rules. Always seek advice from a
          qualified accountant before making claims.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                allows this on a time and space basis (percentage of home used for business ×
                percentage of time used for business). The simplified flat-rate method (£10 to £26
                per month depending on hours worked from home) is also available and requires no
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                revenue expenditure. Capital allowances may be available, but the rules are complex.
                The Annual Investment Allowance (AIA) allows 100% first-year deduction on qualifying
                plant and machinery. Consult an accountant.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                additional household costs. This can be claimed without receipts. Actual cost claims
                above this amount require detailed records and employer confirmation that home
                working is required.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                value to the property (deductible against capital gains on eventual sale), but there
        ...
        <p>
          Tax rules change frequently. The information above is a general guide for 2026 and should
          not be relied upon as professional tax advice. Always consult a qualified accountant
    ...
    content: (
      <>
        <p>
          ...
          residential work. A typical garden office sub-main, consumer unit, and internal wiring job
          runs to £1,500 to £3,000 — and buyers often want data cabling, outdoor lighting, and EV
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  ...
                  to issue the Electrical Installation Certificate on completion. Homeowners want
                  their certificate quickly — it is often required for building control sign-off and
                  insurance purposes.
                </p>
              </div>
            </div>
