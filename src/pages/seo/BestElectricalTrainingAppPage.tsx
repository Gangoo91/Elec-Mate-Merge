    ...
    <GuideTemplate
          ...
          content: (
            <>
              ...
              <p>
                ...
                subscription from £6.99/month. There are no separate training fees or per-course
                ...
                <table className="w-full text-sm text-white border-collapse">
                  ...
                  <tbody className="divide-y divide-white/10">
                    ...
                    <tr>
                      ...
                      <td className="py-2 px-3 text-centre font-semibold">From £6.99/mo</td>
      ...
      faqs={[
        ...
        },
        {
          ...
          answer:
            'Training costs vary enormously depending on the delivery method. Traditional classroom courses for the 18th Edition typically cost £200-400 per course. Online courses from training providers range from £100-500+ per course. Individual BS 7671 quiz apps may be free or a few pounds but cover only one topic. Elec-Mate includes 46+ courses, 20,000+ practice questions, flashcards, mock exams, simulators, and an AI study assistant — all for £6.99/month with the standard subscription. For an apprentice who needs Level 2, Level 3, 18th Edition, AM2 preparation, and EPA simulator, Elec-Mate provides all of these for less than the cost of a single traditional course.',
        },
      ]}
      relatedPages={[
        {
