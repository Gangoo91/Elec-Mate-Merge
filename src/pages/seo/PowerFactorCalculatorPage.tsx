      ...
      <section className="py-16 px-5">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4 text-white leading-relaxed">
            ...
            <p>
              <strong className="text-yellow-400">The power triangle</strong> is the fundamental relationship that links these three quantities. Real power (kW) forms the horizontal leg, reactive power (kVAr) forms the vertical leg, and apparent power (kVA) is the hypotenuse. The angle between real power and apparent power is called the phase angle (phi), and the cosine of this angle is the power factor: PF = cos(phi) = kW / kVA.
            </p>
            <p>
              Understanding power factor matters because it directly affects installation sizing, energy costs, and equipment lifespan. A poor power factor means the installation draws more current than necessary, which requires larger cables, larger switchgear, and a larger transformer — all of which cost more to install and maintain. It also means higher losses in the distribution system and, for commercial and industrial customers, additional charges from the electricity supplier.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-5 bg-white/[0.02]">
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-white">True Power, Apparent Power, and Reactive Power</h2>
          </div>
          <div className="space-y-4 text-white leading-relaxed">
            <p>
              <strong className="text-yellow-400">Real (true) power (kW)</strong> is the power that actually performs useful work. It heats elements, turns motor shafts, and produces light. Real power is what you pay for on a domestic electricity bill and what the load actually consumes. It is measured in kilowatts (kW) or watts (W).
            </p>
            <p>
              <strong className="text-yellow-400">Apparent power (kVA)</strong> is the total power that the supply must deliver to the installation. It is the product of the RMS voltage and the RMS current: for single-phase, kVA = V x I / 1000; for three-phase, kVA = V x I x 1.732 / 1000. Apparent power is what the supply cables, switchgear, transformer, and generator must be rated for. It is always equal to or greater than the real power.
            </p>
            <p>
              <strong className="text-yellow-400">Reactive power (kVAr)</strong> is the power that oscillates between the supply and the load, sustaining the magnetic and electric fields in inductive and capacitive components. It does no useful work, but it is essential for the operation of motors, transformers, and other electromagnetic devices. Reactive power is measured in kilovolt-amperes reactive (kVAr). For inductive loads, the reactive power is positive (lagging); for capacitive loads, it is negative (leading).
            </p>
            <div className="p-6 rounded-2xl bg-yellow-500/5 border border-yellow-500/20 text-center my-6">
              ...
              <p className="mt-3 text-sm text-white">The power triangle: apparent power is always the hypotenuse</p>
            </div>
            <p>
      ...
      <section className="py-16 px-5">
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-white">Why Low Power Factor Costs Money</h2>
          </div>
          <div className="space-y-4 text-white leading-relaxed">
            <p>
      ...
      <section className="py-16 px-5 bg-white/[0.02]">
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-white">Power Factor Correction with Capacitors</h2>
          </div>
          <div className="space-y-4 text-white leading-relaxed">
            <p>
            ...
            <p>
              <strong className="text-yellow-400">Fixed capacitor banks</strong> are used where the load is constant or near-constant — for example, a single large motor that runs continuously. A fixed capacitor is wired in parallel with the load and provides a constant amount of kVAr correction. The capacitor size is calculated to correct the load's specific power factor to the target value.
            </p>
            <p>
              <strong className="text-yellow-400">Automatic capacitor banks</strong> are used where the load varies throughout the day. An automatic unit contains multiple capacitor stages (steps), each with its own contactor, controlled by a power factor controller. The controller continuously monitors the power factor at the incoming supply and switches capacitor stages in and out to maintain the target power factor. This prevents over-correction when the load drops and under-correction when the load increases.
            </p>
            <p>
              <strong className="text-yellow-400">Detuned capacitor banks</strong> include series reactors that shift the resonant frequency of the capacitor bank away from common harmonic frequencies. This prevents harmonic resonance — a dangerous condition where the capacitor bank amplifies harmonic currents instead of correcting the power factor. Detuned banks are essential on any site with significant harmonic-producing loads such as variable speed drives, LED lighting, IT equipment, or UPS systems.
            </p>
            <p>
      ...
      <section className="py-16 px-5">
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-white">Industrial Tariff Penalties and Savings</h2>
          </div>
          <div className="space-y-4 text-white leading-relaxed">
            <p>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            ...
            <div className="p-6 rounded-2xl bg-white/[0.04] border border-white/10">
              <h3 className="font-bold text-yellow-400 text-lg mb-3">Example 1: Single Motor Correction</h3>
              <div className="space-y-2 text-white leading-relaxed text-sm">
                ...
                <p className="font-mono text-white">
                  Existing angle = arccos(0.78) = 38.74 degrees, tan(38.74) = <strong className="text-yellow-400">0.8028</strong>
                </p>
                <p className="font-mono text-white">
                  Target angle = arccos(0.95) = 18.19 degrees, tan(18.19) = <strong className="text-yellow-400">0.3287</strong>
                </p>
                <p className="font-mono text-white">
                  kVAr required = 30 x (0.8028 - 0.3287) = 30 x 0.4741 = <strong className="text-yellow-400">14.2 kVAr</strong>
                </p>
                <p>
                  Result: Install a <strong className="text-green-400">15 kVAr capacitor</strong> at the motor terminals. The corrected apparent power drops from 38.5 kVA to 31.6 kVA, reducing the current by 18%.
                </p>
              </div>
            </div>
            ...
            {/* Example 2 */}
            <div className="p-6 rounded-2xl bg-white/[0.04] border border-white/10">
              <h3 className="font-bold text-yellow-400 text-lg mb-3">Example 2: Factory Main Incomer Correction</h3>
              <div className="space-y-2 text-white leading-relaxed text-sm">
                <p>
                ...
                <p className="font-mono text-white">
                  Before correction: kVA = 250 / 0.72 = <strong className="text-yellow-400">347.2 kVA</strong>
                </p>
                <p className="font-mono text-white">
                  After correction: kVA = 250 / 0.95 = <strong className="text-yellow-400">263.2 kVA</strong>
                </p>
                <p className="font-mono text-white">
                  Monthly saving = (347.2 - 263.2) x £4.50 = 84 x £4.50 = <strong className="text-yellow-400">£378 per month</strong>
                </p>
                <p className="font-mono text-white">
                  Annual saving = £378 x 12 = <strong className="text-green-400">£4,536 per year</strong>
                </p>
                <p>
                  kVAr required = 250 x (tan(43.95) - tan(18.19)) = 250 x (0.9646 - 0.3287) = <strong className="text-yellow-400">158.9 kVAr</strong>. Install a 150 kVAr automatic capacitor bank. Typical cost: £4,000 to £6,000 installed. Payback period: 10 to 16 months.
                </p>
              </div>
            </div>
            ...
            {/* Example 3 */}
            <div className="p-6 rounded-2xl bg-white/[0.04] border border-white/10">
              <h3 className="font-bold text-yellow-400 text-lg mb-3">Example 3: Power Triangle Conversion</h3>
              <div className="space-y-2 text-white leading-relaxed text-sm">
                <p>
                  A three-phase supply reads 415 V and 120 A per phase. The real power measured is 72 kW. Calculate the apparent power, reactive power, and power factor.
                </p>
                <p className="font-mono text-white">
                  Apparent power = 415 x 120 x 1.732 / 1000 = <strong className="text-yellow-400">86.2 kVA</strong>
                </p>
                <p className="font-mono text-white">
                  Reactive power = sqrt(86.2² - 72²) = sqrt(7430.44 - 5184) = sqrt(2246.44) = <strong className="text-yellow-400">47.4 kVAr</strong>
                </p>
                <p className="font-mono text-white">
                  Power factor = 72 / 86.2 = <strong className="text-yellow-400">0.835 lagging</strong>
                </p>
                <p>
                  Result: The power factor is <strong className="text-red-400">below 0.90</strong> — this site would attract reactive power penalties. Correction to 0.95 would require 72 x (0.6609 - 0.3287) = <strong className="text-green-400">23.9 kVAr</strong> of capacitors.
                </p>
              </div>
            </div>
          </div>
      ...
      <section id="how-it-works" className="py-16 px-5">
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-white">How to Calculate Power Factor and Size Capacitors — Step by Step</h2>
          </div>
