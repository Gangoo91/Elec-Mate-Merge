...
const sections = [
    ...
    content: (
      <>
        <p>
          ...
          employment base in logistics, food processing, and distribution, aided by excellent
          rail and road connections (45 minutes to London King's Cross by train, at the junction
          of the A1 and A47).
        </p>
        <p>
          For electricians, Peterborough offers a highly varied workload. The large new-build
          sector in Hampton and other growth areas provides modification and addition work.
          The older housing stock in the city centre and inner suburbs needs upgrade and rewire
          work. The large private rental sector — one of the city's distinctive features given
          its population growth — creates consistent EICR demand. And the commuter belt
          population drives demand for premium installations including EV chargers, smart home
          systems, and kitchen and bathroom fit-outs.
        </p>
        <p>
          This guide covers Part P, the local DNO (UK Power Networks), pricing, and practical
          advice for electricians working in Peterborough.
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>
          Peterborough is in England, so Part P of the Building Regulations applies:
        </p>
          ...
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                the 2020 Regulations. Section 631 of BS 7671 governs periodic inspection
                methodology.
              </span>
            </li>
          </ul>
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                connections portal. New supplies for developments, service upgrades for EV
                chargers and heat pumps, and substation connections for larger commercial premises.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                systems up to 16A per phase is an online notification, processed promptly. G99
                for systems above this threshold requires UKPN pre-approval.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Earthing</strong> — Peterborough properties are predominantly supplied
                on TN-C-S (PME) systems. Always confirm the earthing arrangement at the supply
                intake, particularly in older properties near the city centre where TN-S supplies
                from original lead-sheathed cables may still exist.
              </span>
            </li>
          </ul>
        </div>
      ...
      <>
        ...
        <div className="grid gap-4 sm:grid-cols-2 my-4">
          ...
          <div className="rounded-2xl bg-green-500/10 border border-green-500/20 p-5">
            ...
            <p className="text-white text-sm leading-relaxed">
              1950s–1980s semis and terraces in Bretton, Ravensthorpe, and Orton estates.
              Cavity brick construction, generally more amenable to concealed wiring.
              Consumer unit replacements and EICR work are the primary jobs in this stock.
            </p>
          </div>
          <div className="rounded-2xl bg-purple-500/10 border border-purple-500/20 p-5">
            ...
            <p className="text-white text-sm leading-relaxed">
              ...
              provisions. High demand for EV charger installations, additional circuits,
          ...
          <div className="rounded-2xl bg-amber-500/10 border border-amber-500/20 p-5">
            ...
            <p className="text-white text-sm leading-relaxed">
              Major distribution and logistics warehousing on the A1/A47 corridor, including
              Amazon, DHL, and numerous food processing facilities. Three-phase supplies, large
              floor areas, and industrial-scale electrical installation and maintenance work.
            </p>
          </div>
        </div>
      </>
        ...
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>EV charger installations</strong> — one of the highest-demand services
                in Peterborough due to the commuter population and new-build estate prevalence.
                OZEV registration essential for grant-assisted installs.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Consumer unit replacements and rewires</strong> — steady demand from
                the large pre-1980s housing stock.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
            ...
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>New-build additions</strong> — homeowners in Hampton and Cardea
                regularly commission additional circuits, outdoor power, and smart home
                installations after moving in.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Peterborough is a strong market for electricians, particularly those who can serve
          both the growing new-build and commuter sector and the large rental market. The
          city's growth shows no sign of slowing, creating sustained long-term demand.
        </p>
        ...
        <SEOAppBridge
          ...
          description="Join 430+ UK electricians using Elec-Mate for cable sizing, professional quoting, and on-site certification. Built for electricians working across the East of England. 7-day free trial."
          icon={MapPin}
        />
      </>
    ),
...
export default function ElectricianPeterboroughPage() {
  return (
    <GuideTemplate
      ...
      ctaSubheading="Join 430+ UK electricians using Elec-Mate for cable sizing, quoting, and on-site certification. Built for electricians working across Cambridgeshire and the East of England. 7-day free trial."
    />
  );
}
