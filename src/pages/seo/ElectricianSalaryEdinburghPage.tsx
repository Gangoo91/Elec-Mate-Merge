...
const sections = [
  {
    ...
    content: (
      <>
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                equates to approximately £41,500 per year at 37.5 hours per week. Edinburgh
                employers typically pay £23 to £26 per hour to attract and retain staff.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
        ...
        <p>
          Scotland's distinct legal and regulatory framework — including Scottish Building Standards
          rather than English Building Regulations — creates a slightly different operating
          environment for Edinburgh electricians compared to their counterparts in England, though
          the core electrical standards (BS 7671) are identical.
        </p>
      </>
    ),
  },
    ...
    content: (
      <>
          ...
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                Edinburgh is typically £23 to £26 per hour.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Users className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
        ...
        <p>
          ...
          days per year), pension contributions, and the Scottish electrical welfare scheme. SELECT
          (Electrical Contractors' Association of Scotland) represents the majority of JIB-SECTA
          member firms in Edinburgh.
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>
          SECTT (Scottish & Northern Ireland Joint Training Limited) is the industry's training body
          for Scotland and Northern Ireland. It administers electrical apprenticeships across
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                equivalent to the English NVQ Level 3, both widely accepted by employers across the
                UK.
              </span>
            </li>
            <li className="flex items-start gap-3">
            ...
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Duration and structure</strong> — four years of combined on-the-job training
                and college day-release. SECTT apprentices complete the same core competencies as
                JTL apprentices in England, including installation, testing, and fault-finding.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>ECS Card pathway</strong> — on completion of SVQ Level 3 and required AM2S
                (Assessment of Mechanical and Electrical Skills) assessment, Edinburgh apprentices
                apply for the ECS Gold Card via JIB-SECTA, granting access to commercial and
                industrial sites across the UK.
              </span>
            </li>
          </ul>
        </div>
        <p>
          SECTT-trained electricians are fully recognised across the UK. Edinburgh electricians with
          SVQ Level 3 and ECS Gold Cards can work on English and Welsh sites without additional
          ...
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                services sector. Critical systems electricians with UPS and generator experience are
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                electricians experienced in low-impact installation techniques. Specialist domestic
                rates of £450 to £650 per day.
              </span>
            </li>
          </ul>
        </div>
    ...
    content: (
      <>
        <p>
          ...
          apprenticeship wage broadly mirrors the England JIB, with many Edinburgh employers paying
          above these minimums to attract quality entrants in a competitive market.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
          ...
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                after five years' service with many Edinburgh employers.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Star className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                benefit from the SELECT tool and equipment scheme.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Star className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                costs make a van with a permit particularly valuable.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Star className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                days for New Year — all at double time if worked.
              </span>
            </li>
          </ul>
        </div>
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                Level 3 and ECS Gold Card on completion.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <TrendingUp className="w-5 h-5 text-green-400 mt-0.5 shrink-0" />
              <span>
                ...
                Edinburgh. Add specialist qualifications (18th edition, inspection and testing, HV
                awareness) to access premium public sector rates.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <TrendingUp className="w-5 h-5 text-green-400 mt-0.5 shrink-0" />
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  Edinburgh domestic electricians handling EICRs, EICs, and minor works certificates
                  can use the{' '}
          ...
          <div className="rounded-2xl bg-green-500/10 border border-green-500/20 p-5">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  Edinburgh has the highest EV ownership rate in Scotland. OZEV-authorised EV
                  charger installers charge £400 to £600 per day for residential and commercial EV
                  charger installations — a growing and lucrative specialism in the Edinburgh market
                  with strong support from the City of Edinburgh Council.
                </p>
              </div>
            </div>
          </div>
