...
const relatedPages: RelatedPage[] = [
  {
    ...
    description: 'HTM 06-01 compliance, medical grade supply, UPS, and essential services for hospitals.',
    icon: Heart,
    category: 'Guide',
  },
  {
...
const sections = [
        ...
        <div className="rounded-2xl bg-blue-500/10 border border-blue-500/20 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>CQC Registration Condition 15</strong> — requires that premises used for
                the purposes of a regulated activity are safe, clean, and suitable. This includes
                the electrical installation. CQC inspectors will ask to see EICR documentation,
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                detection) is the minimum standard, and why emergency lighting coverage must
                be comprehensive.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Heart className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Overlapping standards</strong> — care home electrical design involves:
                BS 7671:2018+A3:2024 (wiring regulations), BS 5839-1 (fire alarms), BS 5266-1
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          The nurse call (or warden call) system is one of the most critical electrical systems
          in a care home. It allows residents to summon assistance from any room, enables staff
          to respond efficiently, and provides a management record of call patterns and response
          times.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Room call points</strong> — each bedroom requires at minimum a combined
                call unit with a call button (accessible from the bed), an over-door light (red
                when call is active), and a reset button. Modern IP-based systems use corridor
                display units to direct staff to the correct room without requiring paging.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Bell className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Bathroom and shower room pull cords</strong> — mandatory in all
                assisted bathrooms and shower rooms. Pull cord must hang to within 100mm of
                the floor. The pull cord unit generates a separate category call (typically
                a higher-priority emergency call) at the central panel.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Bell className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Central monitoring</strong> — BS 8670 requires a central monitoring
                point (nurses' station or duty room) with a visual and audible indication of
                all active calls, call category, and room identification. Many modern systems
                add staff location (DECT or RFID) so call routing can direct the nearest
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                40-bed care home: £15,000–£35,000 depending on system tier (conventional
                versus IP-based), number of bedrooms, and whether staff location is included.
                Cabling is typically Category 5/6 structured cabling on modern IP systems or
                dedicated 2-core screened on conventional.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Assisted bathing rooms (hoist baths, assisted shower rooms, wet rooms) in care homes
          are classified under BS 7671 Section 701 (Locations Containing a Bath or Shower).
          The combination of high-voltage electrical equipment (hoists, height-adjustable baths,
          drying systems) and wet environments requires careful application of the zone system
          and protective measures specified in Section 701.
        </p>
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                circuit, typically 13A or 16A single-phase. The hoist track must be positioned
                to avoid Zone 1 above the bath. Battery-powered hoists eliminate the need for
                a permanent overhead supply but require a dedicated charging point outside
                the wet zone.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Height-adjustable bath electrical</strong> — powered height-adjustable
                baths (Arjo, Gainsborough, and similar) draw 1–3kW and require a 13A or 16A
                supply with isolation within sight of the bath. Where the bath has integrated
                thermostatic temperature control and Jacuzzi functions, a 32A circuit may be
                required. All circuits in the bathroom must be RCD-protected.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Supplementary equipotential bonding</strong> — Regulation 701.415.2
                requires supplementary bonding of all simultaneously accessible conductive
                parts in bathroom zones. This includes the bath, hoist track, water pipes,
                heating pipes, and any metal door frames, connected to the main earthing
                terminal via 4mm² or larger bonding conductors.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
    ...
    content: (
      <>
        <p>
          ...
          population means that emergency lighting design must go beyond the minimum requirements
          of BS 5266-1 to ensure safe evacuation under all fire and power failure scenarios.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                duration for emergency lighting in residential premises (including care homes).
                This reflects the time required for staff-assisted evacuation of dependent
                residents.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                emergency lighting in individual bedrooms in other premises types, the fire
                risk assessment for a care home typically recommends emergency lighting in
                each bedroom to allow staff to locate and assist residents during an evacuation.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Assisted bathrooms and wet rooms</strong> — emergency lighting is
                essential in these areas where residents may be partially clothed or in
                baths/showers during a fire alarm activation. IP-rated emergency fittings
                (IPX4 minimum) are required in wet zones.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                ...
                Self-test luminaires (BS EN 62034) are recommended to simplify the mandatory
                monthly and annual test regime.
              </span>
            </li>
          </ul>
        </div>
    ...
    content: (
      <>
        <p>
          ...
          rationale is that residents may require staff-assisted evacuation and the earliest possible
          detection maximises the time available.
        </p>
        <div className="rounded-2xl bg-red-500/10 border border-red-500/20 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Detector types</strong> — optical smoke detectors in bedrooms and
                corridors; heat detectors in kitchens (to avoid cooking-related false alarms);
                combined smoke/CO detectors in plant rooms where fuel-burning equipment is
                present; beam detectors in large open communal spaces (dining rooms, lounges)
                where point detectors would be impractical.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-red-400 mt-0.5 shrink-0" />
              <span>
                <strong>Addressable panel</strong> — with 100–300+ detectors across a typical
                40-bed care home, an addressable fire alarm panel is the only practical choice.
                Addressable systems allow the exact location of each detector activation to be
                identified at the panel, enabling staff to respond to the correct location
                immediately.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                bathrooms, and communal areas in addition to standard audible sounders. The
                sound pressure level in each bedroom at the alarm sounder must meet BS 5839-1
                requirements to wake sleeping residents.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-red-400 mt-0.5 shrink-0" />
              <span>
                <strong>Fire alarm installation cost</strong> — Category L1 addressable fire
                alarm for a 40-bed care home: £18,000–£40,000 including panel, detectors,
                sounders, visual alarms, cable installation, commissioning, and BS 5839-1
    ...
    content: (
      <>
        <p>
          ...
          design, but dementia-specific units increasingly specify anti-ligature features as part
          of a person-centred design approach.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Anti-ligature light fittings</strong> — flush or semi-flush LED panels
                with tamper-resistant fixings. No surface-mounted pendants, chains, or downlighters
                with exposed lamp holders. Concealed or flush driver modules. IP rating to suit
                the environment.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                outlets with concealed screw fixings. Some specifications require key-operated
                or staff-only accessible socket outlets to prevent residents accessing power
                for unsafe appliances.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                anti-ligature cord ends (soft loop type, maximum 25mm projection) are available
                from nurse call system manufacturers.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Concealed containment</strong> — cables are run in concealed conduit
                within the wall structure or in solid-fill cable ducts flush with the surface.
                No surface-mounted trunking with removable lids in resident bedroom or bathroom
                areas.
              </span>
            </li>
          </ul>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Electrical safety compliance documentation is scrutinised by CQC inspectors. A care
          home with an expired or unsatisfactory EICR is at risk of an adverse CQC finding under
          Regulation 15 (Premises and Equipment), which can affect the home's overall CQC rating
          and lead to compliance notices.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                — functional testing is carried out by the nurse call engineer), fire alarm
                power supply circuits (tested in conjunction with the fire alarm service), and
                all emergency lighting circuits.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ClipboardCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Cost</strong> — EICR for a 40-bed care home: £800–£2,000. Larger
                nursing homes (80+ beds) with multiple distribution boards: £1,500–£3,500.
                EICRs should be scheduled during periods of lower occupancy where possible
            ...
            <li className="flex items-start gap-3">
              <ClipboardCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Remedial work</strong> — C1 or C2 observations must be remedied
                before the installation can be deemed satisfactory. In an occupied care home,
                circuit outages must be planned with the home manager to ensure that life-safety
                systems (nurse call, fire alarm, emergency lighting) remain operational at all
                times during remedial works.
              </span>
            </li>
          </ul>
        </div>
        ...
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>General power and lighting (bedrooms and communal)</strong> — £60,000–£110,000.
                Includes DALI lighting control, socket outlets, and all wiring to bedrooms,
                communal lounges, dining rooms, corridors, and offices.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
            ...
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Assisted bathing room electrical (per room)</strong> — £3,000–£6,000.
                Hoist supply, height-adjustable bath circuit, supplementary bonding, pull cord.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                <strong>£180,000–£350,000</strong>. Nursing homes with clinical rooms and
                medical gas electrical interlocks: £280,000–£450,000+.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Care home electrical contracts require detailed knowledge of BS 7671 Section 701,
          BS 5839-1 Category L1, BS 5266-1, and BS 8670. Electricians who develop expertise
          in this sector and can demonstrate CQC compliance knowledge are in high demand from
          care home operators and NHS property service contractors.
        </p>
