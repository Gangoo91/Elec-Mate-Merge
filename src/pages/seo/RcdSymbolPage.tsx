...
const sections = [
  {
    id: 'the-symbol',
    heading: 'RCD (Residual Current Device) — IEC 60617 Symbol',
    content: (
      <>
        <SymbolGallery
          symbolIds={['rcd']}
...
export default function RcdSymbolPage() {
  return (
    <GuideTemplate
      ...
      heroSubtitle="RCD residual current device electrical symbol IEC 60617 — what it represents, where it appears in UK electrical drawings, and how it relates to the rest of the symbol library."
      readingTime={4}
      keyTakeaways={[
