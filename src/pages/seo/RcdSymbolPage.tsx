...
const breadcrumbs = [
  ...
  { label: 'RCD (Residual Current Device)', href: '/guides/rcd-symbol' },
];
...
const sections = [
  {
    id: 'the-symbol',
    heading: 'RCD (Residual Current Device) — BS EN 60617 Symbol',
    content: (
      <>
        <SymbolGallery
          symbolIds={['rcd']}
  ...
  },
  {
    ...
    heading: 'What the RCD (Residual Current Device) Symbol Represents',
    content: (
      <>
        <p>
          A Residual Current Device to BS EN 61008. Detects imbalance between live and neutral
          (earth-fault leakage) and trips. 30 mA RCDs provide additional protection against electric
          shock.
        </p>
      </>
    ),
  ...
  {
    id: 'when-used',
    heading: 'When + Where the RCD (Residual Current Device) Symbol Is Used',
    content: (
      <>
        <p>
          Bathrooms, kitchens, outdoor sockets, EV chargers — anywhere BS 7671 requires additional
          protection.
        </p>
        <p>
...
export default function RcdSymbolPage() {
  return (
    <GuideTemplate
      title="RCD Symbol Electrical | BS EN 60617 + BS 7671"
      description="RCD (Residual Current Device) BS EN 60617 symbol — what it represents, when used in UK electrical drawings, and where it appears on EIC + EICR schedules."
      ...
      heroTitle={
        <>
          RCD (Residual Current Device) Symbol{' '}
          <span className="text-yellow-400">BS EN 60617 reference</span>
        </>
      }
      heroSubtitle="RCD residual current device electrical symbol BS EN 60617 — what it represents, where it appears in UK electrical drawings, and how it relates to the rest of the symbol library."
      readingTime={4}
      keyTakeaways={[
      ...
      faqs={[
        {
          question: 'What does the RCD (Residual Current Device) symbol mean?',
          answer:
            'A Residual Current Device to BS EN 61008. Detects imbalance between live and neutral (earth-fault leakage) and trips. 30 mA RCDs provide additional protection against electric shock.',
        },
        {
          question: 'Where is the RCD (Residual Current Device) symbol used?',
          answer:
            'Bathrooms, kitchens, outdoor sockets, EV chargers — anywhere BS 7671 requires additional protection.',
        },
      ]}
      faqHeading="FAQ — RCD (Residual Current Device) Symbol"
