...
const faqs = [
  ...
  {
    question: 'Are there strong opportunities for solar PV and EV charging installations in Oxfordshire?',
    answer:
  ...
  {
    question: 'What is the Bicester Garden Town development and what electrical work does it create?',
    answer:
...
const sections = [
    ...
    content: (
      <>
        <p>
          ...
          counties — home to one of the world's greatest universities, a world-leading
          science and technology cluster, and some of the most beautiful and historically
          significant buildings in Britain. For electricians, this creates a uniquely
          challenging and rewarding market.
        </p>
        <p>
          Oxford city's 44 university colleges represent some of the most complex heritage
          electrical environments in the UK. The Harwell and Oxford science parks create
          specialist commercial and laboratory electrical demand. And across the county's
          market towns and Cotswold villages, high-value residential work — rewires, smart
          home systems, solar PV, and EV charging — provides consistent income for
          well-qualified electrical contractors.
        </p>
        <div className="rounded-2xl bg-blue-500/10 border border-blue-500/20 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Verify NICEIC, NAPIT, or ELECSA registration</strong> — essential
                for all Part P notifiable work in Oxfordshire.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Scottish and Southern Electricity Networks (SSEN)</strong> is the
                DNO for Oxfordshire — all G98/G99 solar notifications and connection
            ...
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Elec-Mate</strong> enables Oxfordshire electricians to issue EICR
                reports and EIC certificates on site via mobile, reducing admin and
                speeding up payment.
              </span>
            </li>
          </ul>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Oxfordshire covers four district councils (Cherwell, South Oxfordshire, Vale of
          White Horse, and West Oxfordshire) plus the Oxford City Council unitary authority.
          Key areas for electrical contractors include:
        </p>
          ...
          <ul className="space-y-3 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                conservation areas throughout. Strong demand for heritage-sympathetic
                rewiring and specialist university building work.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <MapPin className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Abingdon</strong> — growing town on the southern fringes of Oxford
                with significant residential development and the Abingdon Science Park.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <MapPin className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Banbury</strong> — north Oxfordshire's largest town. Mix of
                Victorian housing, industrial areas, and expanding residential estates.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <MapPin className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
            ...
            <li className="flex items-start gap-3">
              <MapPin className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Didcot and Harwell</strong> — energy and science hub. Specialist
                commercial and research facility electrical work at Harwell Campus.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <MapPin className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Witney</strong> — west Oxfordshire market town with a mix of
                period properties and modern estates. Growing solar PV market.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Part P of the Building Regulations applies across all of Oxfordshire. Competent
          person scheme registrants can self-certify notifiable work and notify the relevant
          local authority on the homeowner's behalf.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          ...
          <ul className="space-y-3 text-white">
            ...
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>Public liability insurance — minimum £2 million, £5 million for heritage/university buildings</span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>For Oxford University buildings: confirm the contractor operates under a University Framework Agreement</span>
            </li>
          </ul>
        </div>
      </>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Oxfordshire electrician rates reflect the county's high cost of living, the
          affluence of the university city economy, and competition for skilled labour
          from the research and technology sector. Budget 15% to 25% above the national
          average for standard domestic work.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          ...
          <ul className="space-y-3 text-white">
            <li className="flex items-start gap-3">
              ...
              <span><strong>EICR (3-bed house):</strong> £175 to £310</span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
            ...
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span><strong>Full rewire (3-bed Victorian terrace):</strong> £4,200 to £7,000</span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
            ...
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span><strong>Solar PV electrical connection (4kWp):</strong> £620 to £1,000</span>
            </li>
          </ul>
        </div>
      </>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          The University of Oxford comprises 44 colleges and six permanent private halls,
          most of which occupy medieval or early modern buildings in the heart of Oxford.
          Nearly all are Grade I or Grade II* listed, making them among the most sensitive
          environments for electrical work in England.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Framework contractors:</strong> Most University of Oxford colleges
                and departments procure electrical work through approved framework
                contractors. Electricians seeking work at the University should register
                on the University's procurement portal or approach colleges directly
                about approved contractor status.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Building2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Surface-mounted wiring:</strong> In Grade I listed college
                buildings, all cable routes in original fabric are surface-mounted — typically
                in painted steel conduit or MI cable. Chasing into medieval stonework
                or original plasterwork is not acceptable to Oxford City Council's
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Fire safety in historic buildings:</strong> Fire detection wiring in
                Oxford college buildings requires careful design to meet BS 5839 Part 1 while
                avoiding damage to historic fabric. Wireless fire detection systems are
                increasingly used in the most sensitive spaces.
              </span>
            </li>
          </ul>
        </div>
        <p>
          ...
          for how electrical deficiencies found in Oxford's heritage buildings are
          typically graded and what remedial action is required.
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>
          The Oxford-to-Didcot science corridor is one of the UK's most important
          knowledge economy clusters. The Harwell Science and Innovation Campus, Milton
          Park, Oxford Science Park, and Culham Science Centre collectively employ
          thousands of researchers and scientists, creating a distinct market for
        ...
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Fusion energy (UKAEA, Culham):</strong> The UK Atomic Energy
                Authority's Culham Campus is home to the JET and STEP fusion energy
                programmes. High-current power supplies, specialist earthing for EMC,
                and power quality management are key requirements.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Wrench className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Laboratory electrical fit-out:</strong> Oxford's biotech and
                pharmaceutical companies at Milton Park and Oxford Science Park require
                laboratory-grade electrical fit-outs — including fume cupboard supplies,
                gas interlocking, emergency stop systems, and cleanroom containment wiring.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Wrench className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Energy storage (Harwell):</strong> Harwell is the UK's national
                centre for energy storage research. Battery test facility electrical
                installations require specialist knowledge of energy storage safety
                standards and high-current DC systems.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Scottish and Southern Electricity Networks (SSEN) serves all of Oxfordshire.
          Electricians moving to Oxfordshire from the South East (UKPN territory) should
          note this important distinction, particularly when completing EICR and EIC
          certificates and when submitting G98/G99 notifications.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>G98 solar notifications:</strong> Systems up to 3.68kW single-phase
                notified to SSEN via the online portal within 28 days of commissioning.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>G99 applications:</strong> Prior SSEN approval required for systems
                above 3.68kW single-phase. Allow 45 working days. Harwell Campus research
                systems may require bespoke technical assessment.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                Oxfordshire — Cotswold villages, the Vale of White Horse, and rural areas
                across all four districts. Always verify earthing arrangements under
                BS 7671 Regulation 542 for rural and semi-rural properties before
                carrying out earthing or renewable energy connection work.
              </span>
            </li>
          </ul>
        </div>
        <p>
          ...
          SSEN as the DNO on all EIC and EICR certificates issued in Oxfordshire, and to
          manage your compliance documentation from site.
        </p>
      </>
    ),
  },
