...
const sections = [
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Elec-Mate is the only platform that brings all 19 certificate types together in one app,
