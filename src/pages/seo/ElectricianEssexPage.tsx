...
const faqs = [
  ...
  {
    question:
      'Are there specialist electrical requirements for data centres in the Stansted corridor?',
    answer:
...
const sections = [
  {
    ...
    content: (
      <>
        <p>
          Essex is home to 1.9 million people and covers a remarkable variety of environments — from
          London commuter suburbs in the south-west to post-war new towns in the centre, historic
          market towns in the north, and coastal resorts and estuary settlements to the east and
          south. This diversity creates a broad and consistent market for electrical contractors
          across the county.
        </p>
        <p>
          The county's most distinctive electrical market drivers include the aging new town housing
          stock in Harlow and Basildon — now overdue for full electrical upgrades — the rapidly
          expanding data centre and logistics sector along the Stansted and M11 corridor, and the
          coastal properties on the Thames Estuary and North Sea coast where corrosion
          considerations affect installation specifications.
        </p>
        <div className="rounded-2xl bg-blue-500/10 border border-blue-500/20 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Verify competent person scheme registration</strong> (NICEIC, NAPIT, ELECSA)
                before booking — check the registration number online.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>UK Power Networks (UKPN)</strong> serves all of Essex — all solar PV
                notifications (G98/G99) and new connection applications go through UKPN.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Elec-Mate</strong> enables Essex electricians to issue and manage EICR
                reports, EIC certificates, and customer records entirely from a mobile device.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Essex covers twelve district councils plus the three unitary authorities of
          Southend-on-Sea, Thurrock, and (from 2025) Basildon. Key areas for electrical contractors
          include:
        </p>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Part P of the Building Regulations requires notifiable domestic electrical work in Essex
          to be either self-certified by a competent person scheme registrant, or inspected by
          building control. Using a registered electrician is the most efficient route for
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Essex electrical contractor rates broadly follow a south-to-north gradient, with
          south-west Essex (close to the M25 and M11) commanding the highest rates due to
          competition from London-based employers, and the coastal and northern districts sitting
          closer to East Anglian rates.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
        ...
        <p>
          Always obtain at least three written quotes for larger projects, and ensure each quote
          clearly itemises labour, materials, certification, and any building control or UKPN
          notification fees.
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>
          Essex housing presents two distinct electrical challenge profiles: the post-war new town
          stock in Harlow, Basildon, and South Woodham Ferrers, which is now overdue for full
          modernisation; and the historic town centre properties in Colchester, Saffron Walden, and
          Thaxted, which require sympathetic approaches to comply with planning and listed building
          obligations.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                insulation; C2 for absence of RCD protection; C3 for inadequate earthing or bonding.
                Full rewires are routinely recommended.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Building2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                avoid damaging plaster. Older meter tails and service heads often require
                replacement as part of consumer unit upgrades.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Building2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                circuits, solar PV connections, and smart home wiring.
              </span>
            </li>
          </ul>
        </div>
        <p>
          ...
          />{' '}
          to understand how findings in Essex's housing stock are typically graded and what remedial
          action each classification requires.
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>
          Two of Essex's most distinctive electrical market sectors are the coastal residential and
          commercial properties along the Thames Estuary and North Sea coastline, and the rapidly
          expanding data centre cluster along the M11 and Stansted corridors.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                higher IP ratings for external electrical installations. Regular inspection of earth
                continuity is important where metalwork is exposed to salt air.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Wrench className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                high-current busbars, UPS and generator interconnection, precision cooling supplies,
                and DCIM wiring. Three-phase 11kV and 33kV substation work is common for hyperscale
                sites.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                electrical fit-outs, LED lighting installations, three-phase power, and increasingly
                large EV fleet charging infrastructure.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          UK Power Networks (UKPN) operates the electricity distribution network across all of
          Essex. Electricians in Essex need to be familiar with UKPN's requirements for both
          domestic and commercial connection and notification processes.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                commercial sites near the data centre corridor.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                out earthing work. TT is common in areas not served by UKPN's PME network.
              </span>
            </li>
          </ul>
        </div>
        <p>
          Use <SEOAppBridge href="/tools/eicr-certificate" label="Elec-Mate" /> to record UKPN as
          the DNO on all EIC and EICR certificates for Essex addresses, and to issue certificates
          digitally from the job site.
        </p>
      </>
    ),
  },
