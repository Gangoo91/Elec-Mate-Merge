...
const sections = [
  {
    ...
    content: (
      <>
        <p>
          Derbyshire is a large and geographically diverse county, ranging from the urban areas of
          Derby and Chesterfield to the rural and sometimes remote landscapes of the Peak District
          National Park and the Derbyshire Dales. Electricians across Derbyshire serve a wide range
          of domestic, commercial, and agricultural clients.
        </p>
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                and industrial electrical demand alongside a large domestic market. Well-served by
                electricians across all competency areas.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <MapPin className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                commercial electrical work including new build developments across the north
                Derbyshire area.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                high proportion of properties on TT earthing systems. Specialist electricians
                familiar with older wiring and TT earthing assessment are in particular demand in
                this area.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                with older wiring) and newer residential developments.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <MapPin className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                housing and newer properties. Ring main and radial socket circuit work is common in
                these areas.
              </span>
            </li>
          </ul>
    ...
    content: (
      <>
        <p>
          ...
          Electricity Distribution (NGED), operating the East Midlands network. NGED is responsible
          for the electricity network — the cables, substations, and equipment — from the
          high-voltage transmission network down to the service head (cutout) at individual
          properties.
        </p>
        <div className="rounded-2xl bg-blue-500/10 border border-blue-500/20 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Power cut emergencies</strong> — call 105, available from any UK phone
                including mobiles, 24 hours a day. This connects you to the national power cut
                helpline which routes you to NGED for Derbyshire. For dangerous situations (fallen
                power lines, electrical fires involving network equipment), call 999 as well.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>New connections and alterations</strong> — any change to the metered supply,
                new service heads, or work affecting the distribution network must be arranged
                through NGED. Electricians cannot work on the live service head or service cable —
                these remain the property and responsibility of NGED at all times.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Supply voltage</strong> — the nominal supply voltage in the UK is 230V AC,
                50Hz. The declared voltage is 230V +10%/-6% (i.e. 216.2V to 253V). Electricians
                working in Derbyshire should verify supply voltage at the consumer unit if
                voltage-sensitive equipment is being installed, particularly in rural areas where
                supply impedance may be higher.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          The Peak District National Park and surrounding Derbyshire Dales contain some of the
          oldest domestic electrical installations in the country. Many farmhouses, stone-built
          cottages, and converted agricultural buildings retain wiring from the 1950s, 1960s, and
          1970s, and earthing systems that predate PME (Protective Multiple Earthing) becoming the
          standard approach.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                infrastructure was available. In a TT system, earth continuity is provided by a
                local earth electrode. Electricians should always check the earthing system type at
                the beginning of any inspection or significant installation work on these
                properties.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                sometimes encased in lead sheathing. Rubber insulation degrades over time, becoming
                brittle and cracking. This is a C1 (danger present) or C2 (potentially dangerous)
                finding on EICR depending on the extent and severity. Full rewires are often
                required.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                MCBs or RCBOs. These boards offer no earth leakage protection and are typically
                rated Unsatisfactory on EICR. Replacement with a modern metal-clad consumer unit is
                recommended.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                buildings and conservation areas. Electrical work in listed buildings may require
                consent from the local planning authority (typically Derbyshire Dales District
                Council or the Peak District National Park Authority) in addition to Part P
                compliance. Surface-mounted wiring in conduit is often specified to avoid damage to
                historic fabric.
              </span>
            </li>
          </ul>
        ...
        <p>
          ...
          on older Derbyshire properties should allow significantly more time than for equivalent
          modern properties. The inspection of rubber wiring, TT earthing systems, and rewirable
          fuse equipment requires thorough testing and detailed observation recording.
        </p>
      </>
    ),
  },
    ...
    content: (
      <>
        <p>
          ...
          including all of Derbyshire. Notifiable electrical work must either be carried out by a
          registered competent person or notified to building control. The relevant local
          authorities for building control in Derbyshire include Derby City Council, Derbyshire
          Dales District Council, Amber Valley Borough Council, Erewash Borough Council, and others
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                recognised competent person schemes. NICEIC-registered electricians in Derbyshire
                are assessed annually for technical competence and can self-certify all notifiable
                electrical work.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                NAPIT registration covers Part P self-certification for domestic electrical work in
                Derbyshire.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                Certificate (MEWC) from the electrician, plus a Building Regulations compliance
                certificate from the competent person scheme. The compliance certificate should be
                provided to the homeowner within 30 days of completing the work. Elec-Mate generates
                both the EIC and MEWC directly on site.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Electricians working in Derbyshire carry out a broad range of domestic and commercial
          electrical work. The specific mix varies significantly between urban Derby and
          Chesterfield on the one hand, and the rural Peak District on the other.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                property purchases. Rural properties and older properties in the Peak District
                frequently require remediation following EICR.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                common jobs across older Derbyshire properties. TT earthing systems require careful
                consideration during consumer unit replacement.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                urban properties in Derbyshire requires specific earthing arrangements for EV
                chargers under BS 7671.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                the surrounding towns. Many Peak District properties are exploring battery storage
                as grid backup given the risk of supply interruption in remote areas.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Electrician rates in Derbyshire are generally somewhat lower than in London and the South
          East, though they have risen significantly since 2021 in line with national labour market
          pressures. The following are approximate 2024/2025 guide prices for common jobs in
          Derbyshire:
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                earth electrode testing may be at the higher end.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                redecoration required. Older Peak District properties with rubber wiring will
                typically be at the higher end of this range.
              </span>
            </li>
          </ul>
        </div>
        <p>
          ...
          <SEOInternalLink href="/tools/eicr-certificate">Elec-Mate</SEOInternalLink> can generate
          professional quotes and invoices alongside their electrical certificates — all from one
          app, even in the remote parts of the Peak District where mobile data may be limited.
        </p>
      </>
    ),
  },
