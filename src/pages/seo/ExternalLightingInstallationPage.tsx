...
const faqs = [
  ...
  {
    question: 'Can I install external lighting on a socket outlet circuit for a garden shed or outbuilding?',
    answer:
...
const sections = [
    ...
    content: (
      <>
        <p>
          ...
          outdoor installations must contend with moisture, temperature extremes, UV exposure,
          and the risk of physical damage.
        </p>
        <p>
          In the UK, all external lighting work on new circuits must be carried out by a registered
          competent person and notified under Building Regulations Part P. The technical standard
          is{' '}
          <SEOInternalLink href="/guides/bs-7671-18th-edition-guide">
            BS 7671:2018+A3:2024
          </SEOInternalLink>{' '}
          (the IET Wiring Regulations). Key requirements for outdoor installations include
          appropriate IP ratings, mandatory RCD protection, and suitable cable types and installation
          methods.
        </p>
          ...
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                outdoor lighting installations) and general requirements for RCD protection,
                cable selection, and earthing all apply.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Cable selection for external lighting is governed by the installation method, exposure
          to mechanical damage, UV radiation, temperature, and moisture. BS 7671 Section 522
          covers cable selection for external conditions.
        </p>
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                conduit. All conduit must be UV-resistant — standard white conduit degrades
                rapidly outdoors.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Underground direct burial</strong> — SWA (Steel Wire Armoured) cable is
                the standard choice for direct burial. The steel wire armour provides mechanical
                protection against accidental damage from digging. The cable must be buried at
                the correct depth and route markers installed.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Underground in conduit</strong> — standard twin and earth cable in a
                rigid HDPE duct or conduit is acceptable underground, provided the conduit
                provides adequate mechanical protection. This method is easier to pull through
                if cable replacement is needed in future.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                lights must be designed to limit volt drop to 3% (for lighting circuits) under
                BS 7671. For long runs, upsizing the cable conductor cross-section is often
                necessary. Calculate the run length and load before selecting cable size.
              </span>
            </li>
          </ul>
        </div>
        ...
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>IP44</strong> — protected against solid objects over 1mm and water
                splashing from any direction. Minimum for general outdoor use on walls and
                ceilings. Suitable for porch lights, wall lanterns, and garden fittings in
                sheltered positions.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                direction. Recommended for exposed fittings, security floodlights, and any
                fitting likely to be cleaned with a hose or subject to driving rain. Most
                quality outdoor floodlights are rated IP65.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Lightbulb className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                prolonged immersion in water. Required for in-ground path lights, pond lighting,
                and any fitting set into paving or grass where water pooling can occur.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Lightbulb className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>IK rating</strong> — the IK rating (BS EN 62262) indicates resistance
                to mechanical impact. For fittings in vulnerable locations (low-mounted lights,
                car park bollards), specify IK08 (5 joule) or higher in addition to the
    ...
    content: (
      <>
        <p>
          ...
          circuits rated up to 32A. For external lighting circuits, Regulation 411.3.4 and
          the general additional protection requirements in Section 411 mean that 30mA RCD
          protection is effectively mandatory for all outdoor circuits.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Why RCDs are essential outdoors</strong> — outdoor environments increase
                the risk of insulation damage (from UV degradation, mechanical damage, rodent
                attack, or moisture ingress), which can create lethal shock hazards. A 30mA
                RCD will trip in the event of a leakage current exceeding 30mA, providing
                life-saving protection before a fatal shock can occur.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>RCBO protection</strong> — where the external lighting is on a
                dedicated circuit, an RCBO (combined RCD and MCB) provides the most elegant
                solution: the circuit is individually protected for both overload and earth
                leakage without affecting other circuits if the RCBO trips. RCBOs are strongly
                preferred over a shared RCD protecting multiple circuits.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Nuisance tripping</strong> — outdoor circuits with long cable runs,
                multiple fittings, or LED drivers with capacitive filters can have significant
                leakage currents that cause nuisance RCD tripping. Where nuisance tripping is
                a problem, investigate the root cause (cable insulation quality, LED driver
                quality) rather than increasing the RCD trip threshold.
              </span>
            </li>
          </ul>
        </div>
        ...
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Depth requirements</strong> — under non-vehicular areas (gardens,
                paths, flower beds): minimum 500mm depth. Under vehicular areas (driveways,
                car parks): minimum 600mm depth. Under roads: consult local authority, typically
                750mm minimum. Shallower burial is only acceptable if additional mechanical
                protection (concrete cover, steel channel, or duct) is provided.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Route markers and cable tiles</strong> — yellow plastic cable warning
                tiles must be placed 150mm above the cable, and cable route markers should be
                installed every metre and at changes of direction. A cable route plan must be
                provided to the property owner and retained in the installation documentation.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                gel-filled or resin-filled underground joint kits. Standard junction boxes are
                not suitable for direct burial. Where possible, avoid joints in underground
                sections altogether by using a single cable length from supply to luminaire.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                contact Dial Before You Dig (0800 96 93 66) or use the online plans request
                service for utility company records.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          External lighting controls serve two purposes: energy efficiency (avoiding lights
          burning unnecessarily during daylight or when no one is present) and security (ensuring
          detection zones are well-lit when activity occurs). BS 7671 has no specific requirements
          for control types, but energy efficiency regulations and planning conditions may specify
        ...
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>PIR (Passive Infrared) sensors</strong> — detect heat from moving
                bodies and switch the light on for a preset period. Detection range and angle
                are adjustable on most commercial sensors. Sensitivity, hold time, and lux
                threshold (to prevent triggering in daylight) must be correctly set. PIRs
                can be integral to the luminaire or separate wall-mounted units.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Lightbulb className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                ...
                switch) switches the light on at dusk and off at dawn automatically. Suitable
                for security and amenity lighting that must be on throughout the night. Can
                be combined with a PIR for dim-and-bright operation: constant low-level
                illumination switching to full output on detection.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Lightbulb className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Timer controls</strong> — programmable timers allow precise control
                of operating hours. Useful for decorative lighting, entrance lighting, or
                areas where security lighting operating throughout the night is undesirable.
                Astro timers (which automatically adjust to sunrise/sunset times) are
                preferred over fixed timers.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Lightbulb className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                ...
                Philips Hue, LIFX, and similar systems are popular for domestic installations.
                The wiring and circuit requirements are identical to standard fittings; the
                intelligence is in the driver or a separate controller.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Most domestic external lighting is permitted development and does not require
          planning permission. However, there are exceptions that electricians should be
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                including adding light fittings, requires listed building consent. This applies
                even to minor changes such as replacing a wall-mounted lantern. Advise clients
                to contact their local planning authority before installation.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Home className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Conservation areas</strong> — properties in conservation areas have
                reduced permitted development rights. External lighting on the principal
                elevation or roof slopes fronting a highway may require planning consent.
                Again, clients should check with the local planning authority.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Home className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Commercial premises</strong> — external lighting for car parks,
                security, signage, or advertising at commercial premises is more likely to
                require planning permission, particularly if it will operate at night or
                could affect neighbours. A lighting design report (including lux spill
                calculations) is commonly required as part of a planning application.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Home className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Party Wall Act 1996</strong> — if external lighting requires
                structural work on or near a party wall (shared boundary wall), the
                Party Wall Act may require service of a party wall notice on the adjoining
                owner. Electrical installation alone rarely triggers the Act, but coring
                through a party wall or fixing a bracket to a party wall might.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Light pollution from poorly designed external lighting is a growing concern in the UK.
          The Institution of Lighting Professionals (ILP) and the CIBSE publish guidance on
          obtrusive light, and local planning authorities increasingly include lighting conditions
        ...
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Direct upward light</strong> — avoid fittings that direct light upward
                into the sky. Full-cutoff luminaires (those which direct all light downward and
                forward) minimise sky glow and are recommended by the ILP for all external
                installations.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                users, pedestrians, or neighbours. Choose fittings with appropriate glare
                control and position them to avoid direct lines of sight into adjacent properties
                or public areas.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                placing floodlights on gable ends where they will illuminate adjacent gardens.
                The common law of nuisance may be invoked by neighbours if lighting causes a
                material interference with their enjoyment of their property.
              </span>
            </li>
          </ul>
        </div>
    ...
    content: (
      <>
        <p>
          ...
          complementary security lighting), and commercial security upgrades all generate
          external lighting work throughout the year.
        </p>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  ...
                  to issue an Electrical Installation Certificate or Minor Works Certificate
                  for external lighting work on site. PDF delivered to the client instantly —
                  no paper forms, no scanning, no delays.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  ...
                  cable to garden outbuilding (10m run, SWA, including consumer unit in
                  outbuilding): £400–£800. Full garden lighting scheme with path lights,
                  feature lighting, and dusk-to-dawn control: £800–£2,500 depending on
                  scope. Always quote separately for cable laying, certificate, and notifiable
                  work fees.
                </p>
              </div>
            </div>
        ...
        <SEOAppBridge
          ...
          description="Join 430+ UK electricians using Elec-Mate to issue Electrical Installation Certificates and Minor Works Certificates on site. Instant PDF export and automatic notification to competent person schemes. 7-day free trial."
          icon={FileCheck2}
        />
      </>
    ),
...
export default function ExternalLightingInstallationPage() {
  return (
    <GuideTemplate
      ...
      ctaSubheading="Join 430+ UK electricians using Elec-Mate for on-site Electrical Installation Certificates and Minor Works Certificates. Instant PDF export, automatic competent person scheme notification. 7-day free trial, cancel anytime."
    />
  );
}
