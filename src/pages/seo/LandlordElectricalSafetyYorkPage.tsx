...
const sections = [
    ...
    content: (
      <>
        <p>
          ...
          These regulations came into force on 1 June 2020 for new tenancies and 1 April 2021
          for all existing tenancies. Every private landlord in York must comply, regardless of
          property age, size, or tenant type.
        </p>
          ...
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                the EICR to City of York Council within seven days if requested.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Scale className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
        ...
        <p>
          ...
          regulated tenancies in England, covering all student lets, professional tenancies,
          and long-term rental arrangements in York. They do not apply to social housing or
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          City of York Council is the unitary local authority responsible for enforcing the
          2020 Regulations within York. The council's environmental health team investigates
          complaints, conducts licensing inspections, and has powers to impose civil penalties,
          issue remedial notices, and revoke HMO licences.
        </p>
          ...
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                condition of all HMO licences granted by City of York Council. The council
                can refuse to grant or renew licences where EICR documentation cannot be
                produced and can revoke licences for persistent non-compliance with
            ...
            <li className="flex items-start gap-3">
              <Building2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Remedial powers</strong> — where a landlord fails to comply with a
                remedial notice, City of York Council can arrange for the work to be carried out
                and recover costs from the landlord, alongside imposing civil penalties of up to
                £30,000 per breach.
              </span>
            </li>
          </ul>
        ...
        <p>
          York landlords with multiple properties should maintain comprehensive EICR records
          for every property. City of York Council can request this documentation at any time,
          and absence of a valid EICR is treated as prima facie evidence of non-compliance.
        </p>
      </>
    ),
  },
    ...
    content: (
      <>
        <p>
          ...
          and since converted to private rented or multi-occupancy use, are a defining feature
          of York's rental landscape. These properties present specific electrical safety
          challenges that York landlords must understand.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Rubber-insulated wiring</strong> — properties built before the 1960s
                often have rubber-insulated conductors. Rubber insulation deteriorates over
                decades, becoming brittle and eventually cracking or crumbling. Deteriorated
                rubber wiring is recorded as a C2 observation on the EICR and must be replaced
                as part of remedial work.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Absent RCD protection</strong> — properties installed before modern
                wiring regulations required RCD protection on socket circuits frequently lack
                this critical safety device. Under BS 7671 Regulation 411.3.3, 30mA RCD
                protection is required on socket-outlet circuits rated up to 32A. Absence of
                RCD protection is one of the most common C2 observations in York EICRs and
                typically requires consumer unit replacement to rectify.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                frequently lack adequate main protective bonding to gas and water services,
                or have earthing conductors that are undersized by current standards. These
                are commonly recorded as C2 observations requiring remedial work.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Consumer unit age</strong> — many York Victorian rental properties
                still have older-style consumer units (fuse boxes) using rewirable or
                cartridge fuses rather than modern MCBs and RCDs. These are typically
                recorded as C2 or C3 observations, with consumer unit replacement being
        ...
        <p>
          ...
          replacement and wiring upgrades as part of their long-term property maintenance
          planning. Proactive investment in electrical infrastructure reduces the risk of
          Unsatisfactory EICRs and the costly emergency remedial work that follows.
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>
          York has a substantial HMO market, driven primarily by the University of York
          (Heslington campus) and York St John University, as well as a growing professional
          co-living sector. Areas including Fulford, Fishergate, Bishopthorpe Road, and
          Heworth contain high concentrations of HMO properties.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
            ...
            <li className="flex items-start gap-3">
              <Users className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Additional HMO licensing</strong> — City of York Council operates
                additional licensing schemes covering smaller HMOs in designated areas. Landlords
                should check whether their property falls within an additional licensing
                designation and what conditions apply.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Users className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Shorter EICR intervals</strong> — York HMO licence conditions
                typically require EICRs every three to five years. Always check the specific
                conditions on your HMO licence certificate. Older properties with complex
                electrical installations may face more frequent requirements.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Users className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Academic year planning</strong> — the York student rental market
                operates on an academic year cycle with most tenancies beginning in September
                or October. Landlords should arrange EICR inspections in May or June and
                complete any remedial work before the summer handover period.
              </span>
            </li>
          </ul>
        </div>
        <p>
          Operating an unlicensed HMO in York is a criminal offence with an unlimited fine
          on conviction. City of York Council actively investigates unlicensed HMOs and has
          prosecuted landlords. Civil penalties for electrical safety non-compliance apply
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          York landlords who fail to comply with the 2020 Regulations face civil penalties of
          up to £30,000 per breach. The regulations create multiple distinct obligations, each
          of which can attract its own penalty if breached.
        </p>
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                to provide it to tenants, failing to supply it to City of York Council on
                request, and failing to complete remedial work within 28 days are each separate
            ...
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-red-400 mt-0.5 shrink-0" />
              <span>
                <strong>HMO licence consequences</strong> — City of York Council can refuse to
                renew or revoke an HMO licence for non-compliance with electrical safety
                conditions. For York student landlords, losing a licence during term time
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                to the tenant. This applies to all York tenancies, including student lets with
                fixed end dates.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-red-400 mt-0.5 shrink-0" />
              <span>
                <strong>Unlicensed HMO prosecution</strong> — operating an unlicensed HMO is
                a separate criminal offence with an unlimited fine, in addition to any civil
                penalties for electrical safety non-compliance. These consequences can run
        ...
        <p>
          A York EICR every five years — typically £140 to £300 — is negligible compared to
          the potential penalties or the consequences of losing an HMO licence. Electrical
          safety compliance should be a non-negotiable part of operating a York rental property.
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>
          York tenants — including students from the University of York and York St John
          University, tourism and hospitality workers, and long-term residents — have specific
          rights under the 2020 Regulations regarding electrical safety in their rented property.
        </p>
        <div className="rounded-2xl bg-blue-500/10 border border-blue-500/20 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                inspection. Always request the EICR in writing before signing a York tenancy
                agreement.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                provide a valid EICR, report this to City of York Council's environmental
                health team. The University of York Students' Union and York St John University
                Students' Union both provide housing support for student tenants.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                ...
                landlord fails to act, City of York Council can arrange the work and recover
                costs from the landlord. Tenants must not be charged for this work.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
        ...
        <p>
          York tenants can seek further advice from Citizens Advice York, Shelter, or City of
          York Council's housing team. The council's website provides an online form for
          reporting private rented sector concerns.
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>
          When a York EICR identifies C1 or C2 observations (classified under BS 7671
          Section 631), landlords must complete remedial work within the strict timescales
          set by the 2020 Regulations. For York's older housing stock, this work frequently
          involves significant electrical upgrades.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                The 28-day period starts from the date of the inspection.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Clock className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                may require immediate disconnection. York landlords must treat C1 observations
                as urgent and arrange emergency remedial work as soon as possible rather than
                waiting for the 28-day deadline.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Clock className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                to the tenant and to City of York Council within 28 days of completion.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Clock className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Common York remedial work</strong> — in York's Victorian properties,
                typical remedial work includes consumer unit replacement to add RCD protection
                (Regulation 411.3.3 of BS 7671), replacement of deteriorated rubber-insulated
                wiring, installation of main protective bonding, upgrading earthing conductors,
                and replacement of damaged or inadequate accessories.
              </span>
            </li>
          </ul>
        </div>
        <p>
          ...
          Consumer unit replacements in Victorian properties can take a full day or more and
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          York has a reasonable supply of qualified electricians for EICR work. Demand peaks
          during summer as student landlords prepare properties for the new academic year.
          Early booking is particularly important for May to August inspections.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                online registers to find York-based inspectors. Registration confirms
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                qualification (C&G 2382 18th Edition). Specific experience with Victorian
                terraced properties and older wiring systems is highly valuable in York.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Search className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Book early</strong> — demand for EICR inspections in York peaks
                between May and August. Booking in March or April for summer inspections
                ensures availability and allows time for remedial work — which in York's
                Victorian properties can take considerably longer than a modern property.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Search className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Insurance</strong> — verify professional indemnity insurance is held.
                This is required by all recognised competent person schemes and protects
                both parties if an error appears on the report.
              </span>
            </li>
          </ul>
        </div>
    ...
    content: (
      <>
        <p>
          ...
          properties and HMOs with older electrical systems means some York EICRs take
          considerably longer than modern properties, affecting cost.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>One-bedroom flat</strong> — £100 to £180. Modern purpose-built flats
                are the most straightforward to inspect and sit at the lower end of the range.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Two to three-bedroom Victorian terrace</strong> — £160 to £280.
                Victorian properties with older wiring and complex layouts take longer,
                pushing costs towards the higher end of this range.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                increase inspection scope and time.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Large HMO or complex Victorian property</strong> — £400 to £650+.
                Properties with rubber wiring, multiple conversion phases, or particularly
                aged electrical installations require the most thorough inspection and
        ...
        <p>
          Prices cover the inspection and report only. Remedial work — particularly consumer
          unit replacement in York Victorian properties — is quoted and charged separately
          and can represent a significant additional cost. Proactive landlords who invest in
          electrical upgrades between EICR cycles reduce the risk of costly emergency remedials.
        </p>
      </>
    ),
  },
    ...
    content: (
      <>
        <p>
          ...
          aged wiring frequently result in Unsatisfactory EICRs requiring consumer unit
          replacement or rewiring — high-value follow-on work for the inspecting electrician.
        </p>
          ...
          <div className="rounded-2xl bg-green-500/10 border border-green-500/20 p-5">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  When rubber wiring or absent RCD protection is found in a York Victorian
                  terrace, quote the consumer unit replacement immediately using the{' '}
        ...
        <SEOAppBridge
          ...
          description="Join 430+ UK electricians using Elec-Mate for on-site EICR completion, AI board scanning, and instant PDF export. Complete more York EICRs per day and win the Victorian property remedial work. 7-day free trial."
          icon={FileCheck2}
        />
      </>
    ),
