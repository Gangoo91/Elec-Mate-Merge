...
const sections = [
    ...
    content: (
      <>
        <p>
          ...
          2020 (SI 2020/312) impose a statutory duty on landlords to ensure that the electrical
          installation in rented properties is inspected and tested at least every 5 years by
          a qualified person. This applies to all privately rented residential properties in
          England, including student accommodation.
        </p>
        <p>
          Student houses that meet the definition of an HMO under the Housing Act 2004 are
          subject to the 2020 Regulations plus additional HMO licensing requirements from
          their local authority. The combination of these two regulatory regimes means that
          student HMO landlords face the most comprehensive electrical compliance obligations
          of any residential landlord category.
        </p>
        <div className="rounded-2xl bg-blue-500/10 border border-blue-500/20 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>When is a student house an HMO?</strong> — a property is an HMO
                when it is occupied by three or more people forming two or more households
                who share basic amenities (kitchen, bathroom, WC). Most student houses of
                three or more tenants qualify. Two-person households with two students are
                not HMOs.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Mandatory licensing threshold:</strong> HMOs of five or more tenants
                in a building of three or more storeys require a mandatory HMO licence from
                the local authority. The EICR is a condition of this licence.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Additional licensing:</strong> many local authorities in university
                cities have introduced additional (selective) HMO licensing schemes that
                apply to smaller student houses of three or four tenants. Check with the
                relevant council whether additional licensing applies in your area.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          The 2020 Regulations require EICRs at intervals not exceeding 5 years. The clock
          starts from the date of the most recent EICR — not from the start of any particular
          tenancy. This means a landlord with a valid 2021 EICR must obtain a new one by 2026,
          regardless of how many tenants have come and gone in the interim.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>New tenants:</strong> the landlord must provide a copy of the current
                EICR to each new tenant before or at the commencement of their tenancy. For
                student houses where groups change annually, this means providing the EICR
                to each incoming cohort at the start of the academic year.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Existing tenants:</strong> if an EICR is obtained during an existing
                tenancy (for example, as the first EICR under the 2020 Regulations), a copy
                must be provided to current tenants within 28 days.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Local authority copies:</strong> the local authority can request a
                copy of the EICR at any time. The landlord must supply it within 7 days of
                the request. Failure to do so can result in a remedial notice.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Shorter intervals:</strong> where the EICR specifies a shorter interval
                (for example, "next inspection in 3 years" due to the age of the wiring), the
                shorter period overrides the 5-year default. Always check the recommendation
                on the report.
              </span>
            </li>
          </ul>
    ...
    content: (
      <>
        <p>
          ...
          occupation by tenants with little incentive to report maintenance issues. This
          combination produces a predictable set of recurring defects on EICRs.
        </p>
        <div className="rounded-2xl bg-yellow-500/10 border border-yellow-500/20 p-6 my-4">
          <h3 className="text-lg font-semibold text-white mb-3">Most Frequent C2 Findings in Student Houses</h3>
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>No RCD protection on socket circuits</strong> — properties with older
                consumer units (single-fuse boards or older split-load boards without RCDs on
                socket circuits) fail to meet Regulation 411.3.3 of BS 7671. This is the single
                most common C2 in student house EICRs.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                gaming equipment, mini-fridges). This does not typically cause an immediate
                C1 finding but contributes to circuit loading concerns and damaged socket outlets.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                installations may lack supplementary bonding of metallic bath, basin, pipework,
                and heating (if present). Where the main protective bonding is also deficient,
                this can be a C1 finding.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                light switches with exposed conductors, and damaged flex at light fittings
                are commonly found in student houses. These are typically C2 (potentially
                dangerous) if conductors are exposed.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Old consumer units without RCDs</strong> — rewirable fuse boards and
                early MCB boards without RCDs are still found in older student house stock.
                Replacement with a modern RCBO board is typically required to achieve
                satisfactory status.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Deteriorated insulation</strong> — rubber-insulated cables from
                pre-1960s installations may show evidence of insulation cracking or
                deterioration, particularly on buried or underfloor cable routes. These
                installations typically require full or partial rewiring.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          A C2 observation code (potentially dangerous) on an EICR requires the landlord to
          take remedial action. The 2020 Regulations prescribe a specific process that must
          be followed. Failure to comply can result in enforcement action by the local authority.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                electrician to carry out the remedial work identified in the EICR within 28
                days of receiving the report (or within the period specified in the EICR if
                shorter). A C1 (danger present) observation requires immediate action.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Step 2 — Obtain confirmation:</strong> once remedial work is
                completed, the electrician must issue either a new EICR (if a full inspection
                was required) or an Electrical Installation Certificate or Minor Works
                Certificate for the remedial works. This written confirmation is required.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                receiving the written confirmation, provide a copy to each tenant of the
                property.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Step 4 — Provide confirmation to local authority:</strong> if the
                local authority has requested a copy of the EICR or evidence of remediation,
                provide it within 28 days. The 2020 Regulations require landlords to supply
                this evidence to local authorities on request.
              </span>
            </li>
          </ul>
        </div>
        <div className="rounded-2xl bg-yellow-500/10 border border-yellow-500/20 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>C3 findings (improvement recommended):</strong> a C3 observation
                does not require remedial action under the 2020 Regulations — it is a
                recommendation only. However, many landlords choose to address C3 items
                proactively to avoid them becoming C2 items at the next inspection. Common
                C3 findings include lack of SPD (surge protection device) and absence of
                arc fault detection.
              </span>
            </li>
          </ul>
    ...
    content: (
      <>
        <p>
          ...
          Regulations in their area. For student house landlords, this enforcement typically
          comes through the council's housing or private sector housing team, often the same
          team that processes HMO licence applications.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Remedial notices:</strong> where the council is satisfied that a
                landlord has not complied with the 2020 Regulations, it can issue a remedial
                notice requiring specified works to be completed within 28 days.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Civil penalty notices:</strong> where a landlord fails to comply with
                a remedial notice, the local authority can arrange for the works to be carried
                out and recover the cost from the landlord, or impose a civil penalty of up
                to \u00a330,000 per breach.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>HMO licence conditions:</strong> for licensed HMOs, non-compliance
                with the EICR requirement can be grounds for refusing to grant or renew the
                licence, or for adding conditions that restrict occupancy.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                university accommodation offices) can report non-compliance to the local
                authority. Councils have a duty to investigate such complaints.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          The cost of an EICR for a student house depends primarily on the number of circuits
          (each circuit requires individual testing), the size of the property, and the
          electrician's location. University cities vary significantly in their EICR pricing.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
            ...
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>4 to 5 bedroom student HMO (8 to 12 circuits):</strong> \u00a3200 to \u00a3350
              </span>
            </li>
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>6+ bedroom large HMO:</strong> \u00a3300 to \u00a3500 — larger boards,
                more circuits, potential fire alarm system testing adds cost
              </span>
            </li>
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Consumer unit replacement (C2 remediation):</strong> \u00a3500 to \u00a31,200
                for a modern RCBO board including installation and a new EICR
              </span>
            </li>
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Partial rewire (C2 old wiring remediation):</strong> \u00a3800 to \u00a33,000
                depending on extent and access
              </span>
            </li>
          </ul>
        </div>
        <p>
          ...
          electricians for block bookings — typically arranged at the end of the academic year
          when properties are vacant between tenancies. This is also the most practical time
    ...
    content: (
      <>
        <p>
          ...
          electricians complete EICRs efficiently on-site and deliver professional PDF reports
          to landlords immediately.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                — complete student house EICRs on your phone. AI board scanning identifies
                circuit types and auto-populates the schedule of circuits. Observations with
                C1/C2/C3/FI codes, recommendations, and limitation fields all included.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                — issue EICs for remedial works including consumer unit replacements and
                new circuits installed to address C2 findings.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <SEOInternalLink href="/guides/eicr-observation-codes-explained" label="EICR observation codes reference" />{' '}
