...
const sections = [
    ...
    content: (
      <>
        <p>
          ...
          per capita, supported by Brighton & Hove City Council's Electric Vehicle Strategy and
          the city's strong environmental ethos. Home EV charger installation demand has grown
          significantly as residents upgrade to electric vehicles and seek the convenience and
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                The lamp column charging scheme converts existing street lighting into charge points,
                addressing the challenge of terraced streets without driveways. The council is also
                piloting on-street charging bays across the city.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Solar PV uptake</strong> — Brighton & Hove has some of the highest solar
                PV installation rates in the UK, benefiting from above-average sunshine hours.
                Many Brighton EV owners combine solar panels with a smart EV charger (such as the
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                particularly in areas such as Hanover, Elm Grove, and Bevendean — present
                challenges for home charging due to the lack of off-street parking. Where off-street
                parking is available (garages, driveways), home EV charger installation is
          ...
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                whichever is less. On a typical Brighton installation of £900, the grant saves
                you £350, reducing your net cost to £550.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-green-400 mt-0.5 shrink-0" />
              <span>
                ...
                can apply the grant. Verify your Brighton installer's OZEV status on the gov.uk
                OZEV installer search before agreeing to the installation.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-green-400 mt-0.5 shrink-0" />
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          The installation process for a home EV charger in Brighton follows the same core steps
          as any UK installation, with some specific considerations for Brighton's older housing
          stock and the city's DNO (UK Power Networks) PME supply arrangements.
        </p>
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                and available ways (spare MCB positions), cable route from the consumer unit to
                the charger location, earthing arrangement (most Brighton properties are on PME
                TN-C-S systems), and the proposed mounting location for the charger.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                722.411.4. Where the property is on a PME supply (common in Brighton), the
                installer must assess whether a PME earth is suitable or whether an earth electrode
                should be installed at the charger location.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                this often involves routing through loft spaces, dropping cables through cavity walls,
                or running externally in weatherproof conduit or trunking.
              </span>
            </li>
            <li className="flex items-start gap-3">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                is issued and the work is self-certified under Part P (if the installer is NICEIC
                or NAPIT registered) or notified to Brighton & Hove City Council building control.
                The OZEV grant application is submitted by the installer.
              </span>
            </li>
          </ul>
        </div>
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                charger unit, dedicated circuit, RCD protection, commissioning, and EIC.
                After OZEV grant (where eligible): approximately £450 to £850.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                Brighton's Victorian terraced houses where the consumer unit is at the front of
                the property and the garage or parking space is at the rear.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                properties (pre-2000) often have full or outdated consumer units that need
                upgrading to accommodate the new EV circuit.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Earth electrode installation</strong> — £200 to £400 additional, if
                required following the PME earthing risk assessment. More common in detached
                garages with no existing earth path.
              </span>
            </li>
          </ul>
        </div>
        <p>
          Request itemised quotes from at least two OZEV-approved Brighton installers. Confirm
          that the OZEV grant deduction is shown on the quote if you qualify, and that the quote
          includes all certification costs.
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>
          A significant proportion of Brighton & Hove's housing stock consists of Victorian
          terraced houses without off-street parking. If you live in one of these properties,
          home charging options are more limited but not impossible.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Lamp column charging</strong> — Brighton & Hove City Council is rolling
                out lamp column chargers across the city, converting existing street lighting into
                3.6kW or 7kW charge points. These are ideal for residents without driveways.
                Contact the council's transport team to enquire about your street's inclusion in
                the programme.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Car className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Garage or rear access charging</strong> — if your terraced property has
                a rear garage or rear access yard (common in many Brighton terraced streets),
                a home EV charger can be installed in the garage or on an exterior rear wall.
                The cable route from the consumer unit may be longer, adding to installation cost.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Car className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Public charging</strong> — Brighton has a growing network of public
                chargers including rapid chargers at Regency Square car park, Churchill Square,
                and a number of BP Pulse and Pod Point sites. For lower-mileage drivers, public
                charging may be sufficient without a home charger.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Car className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                Car Parks, covering up to £30,000 (or 75% of costs) for installing multiple
                chargers in a shared car park.
              </span>
            </li>
          </ul>
        </div>
    ...
    content: (
      <>
        <p>
          ...
          Section 722. A competent NICEIC or NAPIT registered installer will ensure full
          compliance, but it is useful to understand the key requirements.
        </p>
        <div className="rounded-2xl bg-blue-500/10 border border-blue-500/20 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Regulation 722.411.4 — PME earthing</strong> — most Brighton properties
                are supplied via a PME (TN-C-S) earthing arrangement from UK Power Networks.
                The installer must complete a PME earthing risk assessment and, if required,
                install an earth electrode to supplement or replace the PME earth at the charger.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                ...
                must be protected by an appropriate RCD. Many modern OZEV-eligible smart chargers
                incorporate Type B equivalent DC fault protection, enabling a Type A RCBO to be
                used at the consumer unit. Your installer will specify the correct protection
                device based on the charger model selected.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Dedicated circuit requirement</strong> — the EV charger must be supplied
                by its own dedicated final circuit. It must not share a circuit with other loads.
                A 32A Type B MCB or RCBO is typically used for a 7kW charger.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                ...
                electrical work. NICEIC and NAPIT registered installers can self-certify under
                Part P — you receive a Part P certificate and the council is notified automatically
                by the scheme. Non-registered installers must notify Brighton & Hove City Council
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          The Brighton area has a good number of OZEV-approved EV charger installers, but
          standards vary. Use the following criteria to identify a competent, properly insured
          installer.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                Brighton's specific housing challenges — Victorian terraces, rear garage cable
                runs, and the local DNO (UK Power Networks) PME earthing arrangements.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Search className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Brighton's high EV adoption rate and growing housing stock make it an excellent market
          for OZEV-approved EV charger installers. Residential 7kW installations are the bread
          and butter of EV installation work, but Brighton also offers commercial and workplace
          charging opportunities across the city's growing business sector.
        </p>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  ...
                  to complete the EIC and all OZEV documentation on your phone while still at
                  the Brighton property. Send the certificate to your customer before you leave
                  — no evening admin.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  ...
                  . Include itemised materials, labour, and OZEV grant deduction automatically.
                  Win more Brighton EV jobs with faster, more professional quotes.
                </p>
              </div>
            </div>
          </div>
