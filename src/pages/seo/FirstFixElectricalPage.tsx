...
export default function FirstFixElectricalPage() {
  return (
    <GuideTemplate
      ...
      ctaSubheading="Elec-Mate's AI circuit designer, cable sizing calculator and quoting app help you plan, price and deliver first fix work professionally. Join 1,600+ UK electricians. 7-day free trial."
    />
  );
}
