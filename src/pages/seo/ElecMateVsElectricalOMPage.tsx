  ...
  return (
    <ComparisonTemplate
      ...
      comparisonRows={[
        ...
        { feature: 'Pricing From', values: ['£6.99/mo', 'Varies'] },
      ]}
      ...
      verdictContent={
        <>
          ...
          <p>
            The value calculation is straightforward: Elec-Mate from £6.99 per month includes
      ...
      ctaSubheading="Try Elec-Mate free for 7 days. Certificates, calculators, AI tools, training, and business management — all from £6.99/month."
