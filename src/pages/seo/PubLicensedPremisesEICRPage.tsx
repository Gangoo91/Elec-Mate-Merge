...
const sections = [
  {
    ...
    content: (
      <>
        <p>
          The Licensing Act 2003 is the primary legislation governing the sale of alcohol and
          the operation of licensed premises in England and Wales. It does not directly mandate
          an EICR, but it creates a framework under which local licensing authorities routinely
          attach electrical safety conditions to premises licences as part of the licensing
          objectives — in particular, the prevention of crime and disorder, public safety, and
        ...
        <div className="rounded-2xl bg-blue-500/10 border border-blue-500/20 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Premises licence conditions</strong> — local licensing authorities
                attach conditions to premises licences that promote the licensing objectives.
                Electrical safety conditions commonly require the premises licence holder to
                maintain a current{' '}
                <SEOInternalLink href="/tools/eicr-certificate">EICR</SEOInternalLink>,
                carry out periodic maintenance, and produce the EICR to the licensing authority
                or building control within a specified period of request.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Scale className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Licence review — risk of revocation</strong> — a premises licence
                can be reviewed and conditions added, modified, or the licence suspended or
                revoked where the licensing authority determines that the licensing objectives
                are not being promoted. A pub operating with an expired EICR and an electrical
                fire risk identified by environmental health inspectors can trigger a licence
                review.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Scale className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Designated Premises Supervisor (DPS)</strong> — the DPS is responsible
                for the day-to-day management of the licensed premises under the Licensing Act
                2003. Compliance with licence conditions including electrical safety conditions
            ...
            <li className="flex items-start gap-3">
              <Scale className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Regulatory Reform (Fire Safety) Order 2005</strong> — separately from
                the Licensing Act, all pubs and licensed premises are subject to the Regulatory
                Reform (Fire Safety) Order 2005. The responsible person must carry out a fire
                risk assessment, implement adequate fire precautions, and maintain fire safety
                equipment. The electrical installation is a key element of fire risk.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Local licensing authorities across England and Wales attach a variety of electrical
          safety conditions to premises licences. Whilst conditions vary between authorities,
          the following are common examples of what premises licence holders can expect.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              <ClipboardCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Emergency lighting inspection and testing</strong> — monthly function
                tests and annual full-duration tests of the emergency lighting system, with
                records kept in a logbook available for inspection by the licensing authority
                or fire authority.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ClipboardCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Fire alarm inspection and testing</strong> — weekly testing of at
                least one fire alarm call point or detector (rotated to test all devices over
                time), six-monthly inspection by a competent person, and annual full system
                test in accordance with BS 5839-1:2017.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ClipboardCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Remedial works — specified timescale</strong> — where the EICR
                identifies C1 or C2 observations, remedial works must be completed within
                the timescale specified by the licence condition (typically 28 days, but
                may be shorter). Written confirmation of completion must be retained.
              </span>
            </li>
          </ul>
        </div>
        <p>
          Premises licence holders should read their licence conditions carefully and diarise
          the inspection and testing requirements. Operating in breach of a licence condition
          is a criminal offence under the Licensing Act 2003.
        </p>
      </>
    ),
  },
    ...
    content: (
      <>
        <p>
          ...
          intensity of use of electrical installations in licensed premises — high continuous
          loads, frequent equipment changes, damp cellar environments — means that a purely
          calendar-based approach to inspection may not be sufficient.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
            ...
            <li className="flex items-start gap-3">
              <Building2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Three years — high-use or older premises</strong> — industry best
                practice for high-volume premises (busy city-centre pubs, nightclubs, music
                venues), premises with older wiring (pre-1990 installations), or premises
                with damp or corrosive environments (coastal pubs, properties with cellar
                flooding history).
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Building2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>After change of occupier</strong> — when a pub changes hands, the
                new operator should commission a fresh EICR before reopening. An EICR
                commissioned by the previous operator may not reflect changes made by that
                operator, and the new operator bears responsibility for the installation
                from the date they take over.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Building2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                gaming machine circuit addition, or entertainment system upgrade should be
                followed by an EIC from the contractor (for notifiable work) or an EICR update
                to confirm the installation remains satisfactory.
              </span>
            </li>
          </ul>
        </div>
    ...
    content: (
      <>
        <p>
          ...
          installation, which in a pub typically includes elements not found in residential
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                accessibility, overcurrent protection, and RCD protection on appropriate
                circuits. Thermographic survey of distribution boards is best practice and can
                identify hot connections before they cause failures.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ClipboardCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                will verify correct MCB sizing, cable ratings, and that extraction interlock
                systems (which shut down cooking equipment if extraction fails) are correctly
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                appropriate IP-rated fittings and adequate RCD protection. The inspector
                will check for signs of water ingress into electrical fittings.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ClipboardCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                lighting, outdoor heaters, and any outdoor bar or food service areas must
                be protected by 30mA RCD and installed with weatherproof fittings to a
                minimum IP44 rating.
              </span>
            </li>
          </ul>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          The pub cellar is an electrically intensive environment. Glycol coolers, beer cooler
          and chiller units, CO2 and mixed gas extraction systems, and cleaning equipment all
          operate in a damp, often poorly ventilated space. This combination of high electrical
          loads and moisture creates significant inspection challenges.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                will verify that the circuit rating matches the cooling system's current draw,
                that the MCB is correctly sized, and that the cable is not undersized for
                the load.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Beer cooler circuits — RCD protection essential</strong> — beer cooler
                and chiller units in damp environments must be protected by 30mA RCD. A cellar
                beer cooler with a deteriorating motor or compressor seal can develop earth
                faults — without RCD protection, this presents a shock risk to cellar staff.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>CO2 and mixed gas systems</strong> — CO2 and mixed gas extraction
                fans in cellars are safety-critical. The inspector will verify that
                extraction fan circuits are correctly installed, fused, and that any
                gas detection system interlock with the extraction fan is functional.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Insulation resistance — commonly low in cellars</strong> — damp
                cellar environments cause insulation resistance to deteriorate more rapidly
                than in dry areas. Low insulation resistance readings on cellar circuits are
                common and require investigation. The inspector will assess whether the low
                reading indicates active degradation or acceptable moisture ingress.
              </span>
            </li>
          </ul>
        </div>
    ...
    content: (
      <>
        <p>
          ...
          electrical connections. They are among the most frequently deficient circuits found
          during EICR inspections of licensed premises.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Dedicated circuit — best practice</strong> — each gaming machine
                should ideally be on its own dedicated circuit with an appropriately sized MCB.
                Machines plugged into general bar area socket rings are susceptible to voltage
                fluctuations caused by other loads, which can cause machine errors and resets.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Users className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Extension lead use — commonly found</strong> — gaming machines
                frequently found on extension leads rather than hardwired connections. Extension
                leads are not appropriate for fixed gaming machine installations — a dedicated
                socket or hardwired connection is required. Extension leads will be recorded as
                an observation on the EICR.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Users className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>RCD protection — required</strong> — gaming machine circuits in
                public areas must be protected by 30mA RCD in accordance with Regulation
                411.3.3 of BS 7671. Absence of RCD protection is commonly recorded as a
                C2 observation.
              </span>
            </li>
          </ul>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Emergency lighting to BS 5266-1:2016 is required in all pubs and licensed premises
          as part of the fire safety measures under the Regulatory Reform (Fire Safety) Order
          2005. The responsible person must ensure that emergency lighting covers all means of
          escape and provides adequate illumination for safe evacuation.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Coverage requirements</strong> — emergency lighting must cover all
                escape routes, all bar and function room areas, all toilet areas (where internal
                with no natural light), stairwells, corridors, and all final exit doors. Exit
                signs must be illuminated, either by maintained emergency luminaires or by
                non-maintained luminaires that illuminate the sign on power failure.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Duration</strong> — emergency lighting in licensed premises must
                operate for a minimum of one hour from the moment of mains power failure.
                Three-hour duration is required for higher-occupancy or higher-risk premises.
                The fire risk assessment determines the required duration.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Testing and records</strong> — monthly 30-second function tests and
                annual full-duration discharge tests must be carried out and recorded in a
                logbook. The logbook must be available for inspection by the licensing
                authority, fire authority, and the EICR inspector.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Inclusion in EICR scope</strong> — emergency lighting circuits are
                part of the fixed electrical installation and must be included in the EICR.
                The inspector will verify correct wiring, circuit protection, and operation
                of all emergency luminaires. Defective or missing emergency lighting is
        ...
        <div className="rounded-2xl bg-red-500/10 border border-red-500/20 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>L2 or L3 system — minimum for most pubs</strong> — automatic detection
                in escape routes and high-risk areas (kitchen, cellar). Manual call points
                adjacent to all final exits and at strategic points throughout the premises.
                Central control panel with visual and audible alarm.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <BellRing className="w-5 h-5 text-red-400 mt-0.5 shrink-0" />
              <span>
                <strong>L1 system — larger or high-occupancy venues</strong> — automatic
                detection in all areas including storage rooms, function rooms, and all
                areas accessible to the public. Required for venues with high occupancy
                loads, large floor plans, or complex layouts.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <BellRing className="w-5 h-5 text-red-400 mt-0.5 shrink-0" />
              <span>
                <strong>Weekly testing requirement</strong> — BS 5839-1 requires weekly
                testing of at least one manual call point (rotating to test all call points
                over time) and regular checks of the control panel. Six-monthly inspection
                and annual test by a competent person are also required. Records must be
                kept in a logbook.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                wiring is part of the fixed electrical installation. The EICR inspector will
                check the fire alarm circuit wiring, panel supply, and verify that the system
                is operational. Faults will be recorded as observations on the EICR.
              </span>
            </li>
          </ul>
        </div>
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                substantially larger than a domestic EICR: multiple distribution boards,
                catering kitchen circuits, cellar equipment, gaming machine circuits, emergency
                lighting, and fire alarm wiring all increase inspection time.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Distribution board replacement</strong> — £1,500 to £3,000 per board
                for a commercial-grade RCBO distribution board. A pub may have two or three
                distribution boards. RCBO protection on each circuit is essential to prevent
                single-fault trips taking down the entire pub.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                depending on the size of the premises and the number of luminaires required.
                Larger function rooms and multi-floor premises are at the higher end of this
                range.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Fire alarm system upgrade</strong> — £3,000 to £12,000 to upgrade
                from a basic manual system to a full L2 addressable system. Annual maintenance
                contracts for BS 5839-1 systems typically cost £500 to £1,500 per year.
              </span>
            </li>
          </ul>
        </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  ...
                  to document complex commercial installations circuit by circuit on your phone.
                  AI board scanning, voice test entry, and the ability to add site photos means
                  you can complete a full pub EICR report on site and email the PDF to the
                  licence holder the same day.
                </p>
              </div>
            </div>
          </div>
