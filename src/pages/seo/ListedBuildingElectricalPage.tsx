...
const faqs = [
  ...
  {
    question:
      'What is the difference between Grade I and Grade II listed buildings for electrical work?',
    answer:
...
const relatedPages: RelatedPage[] = [
  {
    ...
    description:
      'Rewiring Victorian properties — rubber wiring, solid walls, cornicing preservation, and costs.',
    icon: Home,
    category: 'Guide',
  },
  {
  ...
  },
  {
    ...
    description:
      'Rewiring 1901–1910 Edwardian properties — VIR cables, early consumer units, renovation considerations.',
    icon: Home,
    category: 'Guide',
  },
  {
...
const sections = [
  {
    ...
    content: (
      <>
        <p>
          There are approximately 400,000 listed buildings in England, managed by Historic England
          under the Planning (Listed Buildings and Conservation Areas) Act 1990. The vast majority —
          around 92 per cent — are Grade II listed. A further 5.5 per cent are Grade II* (two star)
          and approximately 2 per cent are Grade I, representing buildings of exceptional interest.
        </p>
        <div className="rounded-2xl bg-red-500/10 border border-red-500/20 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Listed building consent (LBC)</strong> — required for any works that would
                affect the character of a listed building as a building of special architectural or
                historic interest. This includes both the interior and exterior of the building, and
                all fixtures that are considered part of the listing. LBC is in addition to (not
                instead of) planning permission and Building Regulations.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Scale className="w-5 h-5 text-red-400 mt-0.5 shrink-0" />
              <span>
                <strong>When LBC is required for electrical work</strong> — chasing cables into
                original historic plasterwork, cutting through historic timbers or masonry, removing
                or altering original joinery or fittings, and any work that materially alters the
                character of the building will require LBC. Works that are entirely reversible and
                affect only non-original fabric may not require consent — but the advice of the
                conservation officer should be sought before proceeding.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Scale className="w-5 h-5 text-red-400 mt-0.5 shrink-0" />
              <span>
                <strong>Criminal offence</strong> — carrying out works to a listed building without
                consent is a criminal offence. There is no time limit on prosecution, and the
                offence runs with the building — a new owner who discovers unauthorised works may be
                required to reverse them at their own expense even if they did not commission them.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Scale className="w-5 h-5 text-red-400 mt-0.5 shrink-0" />
              <span>
                ...
                authority (the same body as for planning permission). Most authorities have a
                conservation officer who handles listed building matters. Applications should
                include drawings showing the proposed cable routes, conduit types, and accessory
                locations, and should explain how the works minimise impact on historic fabric.
              </span>
            </li>
          </ul>
        </div>
        <p>
          ...
          buildings, as for any domestic property. A registered electrician (NICEIC, NAPIT) can
          self-certify the electrical work. The listed building consent is a separate process
          handled by the planning authority.
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>
          Conservation officers at local planning authorities are the specialists responsible for
          administering listed building consent. They are not adversaries — their role is to help
          owners maintain listed buildings appropriately and to balance the needs of the building
          with the needs of the occupants. Early and open engagement is almost always beneficial.
        </p>
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                pre-application advice for listed building works, sometimes free of charge. A
                pre-application meeting or written query allows you to explain the proposed
                electrical work and get informal guidance on whether LBC is required and what
                approach is likely to be acceptable, before committing to a formal application.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>What conservation officers look for</strong> — the key principles are
                reversibility (can the work be undone without damaging historic fabric?), minimum
                intervention (does the proposed method of installation cause the least possible
                impact on the historic building?), and authenticity (does the finished appearance
                respect the character of the building?). Proposals that score well on all three are
            ...
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Involving the electrician early</strong> — a conservation officer will want
                to understand the proposed installation method in detail. Having a qualified
                electrician with listed building experience involved from the outset — and able to
                attend a site meeting if required — significantly strengthens the application.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Historic England guidance</strong> — Historic England publishes detailed
                guidance on electrical installations in historic buildings. This guidance (available
                on the Historic England website) is the standard reference document for conservation
                officers and electricians working on listed buildings. Electricians who can
                demonstrate familiarity with this guidance are well-placed to work on listed
                buildings.
              </span>
            </li>
          </ul>
    ...
    content: (
      <>
        <p>
          ...
          into original historic plasterwork or masonry. Surface wiring — cables run in conduit or
          trunking fixed to the surface — is the accepted alternative. Done well, it can be almost
          invisible or even sympathetically decorative.
        </p>
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                structures. It has a period character that sits sympathetically in old buildings and
                is accepted by many conservation officers in rooms of high historic significance.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Wrench className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                installed with period-appropriate switches and sockets (in matching brass or nickel
                finishes), the surface installation becomes a feature rather than a compromise.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Wrench className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                secondary rooms of listed buildings. It is easy to install, clean in appearance, and
                fully reversible. Conservation officers generally accept it in non-principal rooms.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Wrench className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                concealed without surface conduit. This requires careful planning — cables in voids
                must still comply with BS 7671, particularly regarding protection from mechanical
                damage and the risk of rodent damage.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Wrench className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                chasing. Purpose-designed skirting trunking systems provide a clean finish with easy
                future access. Some conservation officers require that original skirting boards are
                not permanently altered to accommodate trunking.
              </span>
            </li>
          </ul>
        </div>
    ...
    content: (
      <>
        <p>
          ...
          respect and complement the character of the building. The best listed building electrical
          installations are almost invisible within their historic context.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                (Hamilton Litestat, Forbes and Lomax, Crabtree Vintage). Surface-mounted boxes in
                the same finish complete the period aesthetic. These accessories cost more than
                standard white plastic but are appropriate investments in a listed building.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                existing rose aperture without disturbing the rose itself. Where original roses have
                been removed, replica plaster roses are available from specialist suppliers and are
                generally acceptable to conservation officers.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                floor lamps reduce the need for extensive ceiling wiring. A lighting designer
                experienced in historic buildings can often achieve excellent results with minimal
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                cupboard) rather than in a historically significant space. Modern metal consumer
                units are functional rather than decorative and should not be visible within
                principal rooms.
              </span>
            </li>
          </ul>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Not all qualified electricians have experience of listed building work. The constraints of
          listed building consent, the need to work with conservation officers, and the specialist
          installation methods required mean that experience matters significantly. The following
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                about listed building experience and whether they have worked with local
                conservation officers before. Ask for references from listed building clients.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                worked with successfully on similar projects. This is not an official endorsement
                but is a useful practical resource.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                in historic building work. Their websites carry guidance on finding appropriate
                tradespeople.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                quotes, each specifying the installation method, materials, and accessories in
                detail. The cheapest quote may not be the most appropriate for a listed building
                context.
              </span>
            </li>
          </ul>
    ...
    content: (
      <>
        <p>
          ...
          in a listed building follows the same technical requirements as any EICR under BS 7671,
          but presents additional practical challenges. The inspector must carry out a thorough
          inspection without causing damage to historic fabric.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                without consent. The inspection scope must be agreed with the owner in advance, and
                any limitations on access must be documented in the EICR. Where access is limited,
                the inspection may be classified as a "limited inspection" with appropriate caveats.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ClipboardCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                The inspector must use professional judgement in deciding how many accessories to
                open and inspect, balancing thoroughness against the risk of causing damage to
                historic fittings.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                and to provide a baseline record of the installation condition before any remedial
                work is carried out.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                properties. An interval of 5 years is appropriate; some inspectors recommend 3 years
                for the oldest and most complex installations.
              </span>
            </li>
          </ul>
        </div>
    ...
    content: (
      <>
        <p>
          ...
          properties. The premium reflects the additional time required for sympathetic installation
          methods, specialist materials, and the preparation and liaison required for listed
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                inspections of complex multi-storey listed buildings at the higher end.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                connections to existing (potentially original) wiring are properly assessed.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                conservation officer, listed building consent application. Significantly more
                time-consuming than an equivalent unlisted property.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                and the greatest investment of time and specialist materials. Projects at the upper
                end typically involve full surface installations in period conduit throughout
                multiple floors.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                LBC application fee (currently £206 in England).
              </span>
            </li>
          </ul>
        </div>
        <p>
          Owners of listed buildings may be eligible for grants from Historic England, the National
          Lottery Heritage Fund, or local authority conservation grants to assist with the cost of
          repairs and improvements to listed buildings. Check with your local conservation officer
    ...
    content: (
      <>
        <p>
          ...
          listed building work are rarely short of work — the pool of qualified competitors is small
          and the clients (often wealthy, highly educated, and deeply invested in their properties)
          are loyal and refer actively.
        </p>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  ...
                  Comprehensive photographic documentation protects you if the condition of the
                  original installation is later disputed, and supports any listed building consent
                  application.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  ...
                  materials, and an allowance for listed building consent liaison time. Transparent,
                  professional quotes build trust with clients who are accustomed to specialist
                  contractors.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  ...
                  building without consent — even if instructed to do so by the owner. Before
                  starting any work that involves disturbing historic fabric, confirm in writing
                  that listed building consent has been obtained and obtain a copy. If consent has
                  not been obtained, do not proceed until it has been.
                </p>
              </div>
            </div>
          </div>
        ...
        <SEOAppBridge
          ...
          description="Join 1,000+ UK electricians using Elec-Mate for on-site EICR completion with thorough photographic documentation, AI board scanning, and professional quoting. 7-day free trial."
          icon={FileCheck2}
        />
      </>
    ),
