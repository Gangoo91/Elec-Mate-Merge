...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'The fill ratio (also called the space factor) for cable trunking is the proportion of the trunking cross-sectional area occupied by cables. BS 7671 Regulation 522.8.1 requires that conductors can be drawn in or out without damage, and the IET On-Site Guide Appendix E gives the working figure: the total cross-sectional area of cables (including insulation) in a trunking should not exceed 45% of the internal cross-sectional area of the trunking for wiring systems installed during construction, 40% where installation must be carried out through access points in an installed conduit, and 35% for cables drawn into installed conduit. The reason is twofold: heat dissipation (cables must be able to dissipate heat — excessive fill increases thermal resistance) and installation practicality (a trunking too tightly packed with cables cannot have cables withdrawn and reinstalled). Exceeding the fill ratio is a common observation on EICRs for commercial installations.',
  },
  {
  ...
  {
    question:
      'What is the difference between rigid, flexible, and pliable conduit, and when is each used?',
    answer:
...
const relatedPages: RelatedPage[] = [
  ...
  },
  {
    ...
    description:
      'How to size a solar PV system — kWp, orientation, MCS, G98/G99, BS 7671 Section 712.',
    icon: Zap,
    category: 'Guide',
  },
  {
  ...
  },
  {
    ...
    description:
      'Complete guide to two-way and intermediate switch wiring and BS 7671 requirements.',
    icon: Wrench,
    category: 'Guide',
  },
  {
...
const sections = [
  {
    ...
    content: (
      <>
        <p>
          Conduit systems provide a protective enclosure for electrical cables, offering mechanical
          protection against impact, compression, and penetration, as well as a degree of protection
          against dust and moisture. In the UK, conduit systems are governed by BS EN 61386 (the
          European harmonised standard for conduit systems for cable management), which replaced the
          older British standards BS 4607 (steel conduit) and BS 6053 (PVC conduit).
        </p>
          ...
          <ul className="space-y-3 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                rooms, and exposed locations. Can serve as CPC if correctly installed and bonded.
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                impact resistance than steel. Cannot serve as CPC — a separate earth conductor is
                always required.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                grey (non-corrugated outer, corrugated inner) or orange (standard for underground).
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Wrench className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                wiring routes — keep runs as short as practicable.
              </span>
            </li>
          </ul>
        </div>
        <div className="rounded-2xl bg-blue-500/10 border border-blue-500/20 p-6 my-4">
          <ul className="space-y-3 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Standard conduit sizes:</strong> 16mm, 20mm, 25mm, 32mm, 40mm, 50mm internal
                diameter are the most common in UK electrical installations. Select the size based
                on the number and diameter of cables to be installed, applying BS 7671 Appendix 5
                fill ratios.
              </span>
            </li>
          </ul>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Cable trunking is a rectangular channel with a removable lid used for surface-mounted
          wiring in commercial, industrial, and domestic premises. It provides easy access for cable
          installation and modification, and a professional appearance. BS EN 50085 is the European
          harmonised standard for cable trunking systems and cable ducting systems.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          ...
          <ul className="space-y-3 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                serve as CPC where continuity joints are earth-bonded. Common sizes: 50×50mm to
                300×150mm.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                finishes. Lighter and corrosion-resistant. Cannot serve as CPC.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Building2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                where BS 7671 Regulation 528 separation must be maintained within a single trunking
                route.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                commercial fit-outs. Provide power, data, and AV cable routes with access every
                600mm via snap-in faceplates.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Cable tray and basket tray are open cable management systems — unlike conduit and
          trunking, they do not enclose cables but support them on an open channel or mesh. This
          allows cables to dissipate heat effectively, which is particularly important for
          high-current circuits where grouping derating would otherwise significantly reduce cable
          capacity.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                in hot-dip galvanised (standard), stainless steel (for food processing and corrosive
                environments), and PVC-coated. Width 50mm to 900mm, standard load classifications to
                BS EN 61537.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                large cables. Standard in power station, process plant, and large industrial
                installations.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                Easily cut and bent on site. Cannot serve as CPC — a separate earth conductor must
                be installed.
              </span>
            </li>
          </ul>
        ...
        <p>
          For cable tray, the IET Wiring Regulations guidance and BS EN 61537 (cable management
          systems — cable tray and cable ladder) apply. Metallic cable tray must be bonded to earth
          under BS 7671 Regulation 411.3.
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>
          Fill ratios control the proportion of a cable management system's internal cross-sectional
          area that can be occupied by cables. Exceeding the fill ratio causes overheating (cables
          cannot dissipate heat), makes cable installation and withdrawal impractical, and is a
          common observation on EICRs for commercial installations.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          ...
          <ul className="space-y-3 text-white">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                multi-layer installations using grouping derating from BS 7671 Appendix 4.
              </span>
            </li>
          </ul>
        </div>
          ...
          <ul className="space-y-3 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                must be applied when selecting cable size — for 4 cables touching, Cg = 0.65 (35%
                reduction in CCC). For thermally benign single-layer installations on cable tray
                with cables spaced apart by one cable diameter, no derating is required.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Fire barriers at cable penetrations through compartment walls and floors are a mandatory
          requirement under the Building Regulations (Approved Document B — Fire Safety) and under
          BS 9999 (Code of Practice for Fire Safety in the Design, Management and Use of Buildings).
          They are also required under BS 7671 Regulation 527.2.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                sealed to restore the fire resistance of the compartment element. The seal must
                achieve the same fire resistance period as the element penetrated (E = integrity, I
                = insulation, R = resistance).
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                systems. All must be third-party tested and certified to BS EN 1366-3 (penetration
                seals) and marked with the achieved FRL.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                conduit in the wall aperture. Sealing conduit with ordinary caulk or foam is not
                acceptable — it must be tested fire-stopping product.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                required by the Building Safety Act 2022 for higher-risk buildings (7 storeys or 18
                metres+).
              </span>
            </li>
          </ul>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          BS 7671 Regulation 528 requires adequate separation between circuits of different voltage
          bands to prevent interference. Band I (extra-low voltage — telecommunications, data, fire
          alarms) and Band II (low voltage — standard electrical circuits) must be segregated.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                trunking systems designed for this purpose are available from most manufacturers.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                cables and Cat 5e/6 data cables (unscreened); 100mm where one or both are screened;
                50mm where both are in metallic conduit or trunking.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                to be segregated from other services to prevent common-cause failure. Fire alarm
                cables in fire-resistant containment must not share containment with general power
                or lighting circuits.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Metallic cable management systems — steel conduit, metal trunking, metal cable tray — are
          extraneous conductive parts under BS 7671 and must be bonded to the protective earth
          system of the installation. Failure to earth metallic containment is a common C2
          observation on EICRs.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                determined by BS 7671 Table 54.8 — minimum 4mm² copper where the bonding conductor
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                supply earth continuity link straps to bridge each joint. Where earth continuity
                link straps are not fitted, a separate earth conductor must be bonded at each end of
                the run and at regular intervals.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                The resistance must be low enough that a fault to the metalwork would operate the
                protective device within the required disconnection time.
              </span>
            </li>
          </ul>
        </div>
        <p>
          ...
          />{' '}
          for how unearthed metallic containment is graded on electrical inspection reports and what
          remedial action is required.
        </p>
        <p>
          Use <SEOAppBridge href="/tools/eicr-certificate" label="Elec-Mate" /> to record earth
          continuity test results and containment earthing observations in your EICR and initial
...
export default function CableManagementSystemsPage() {
  return (
    <GuideTemplate
      title="Cable Management Systems UK Guide 2024"
