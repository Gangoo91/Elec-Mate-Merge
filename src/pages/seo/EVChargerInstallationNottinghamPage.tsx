...
const sections = [
  {
    ...
    content: (
      <>
        <p>
          Nottingham is one of the East Midlands' largest cities, and EV adoption is accelerating
          as more residents make the switch from petrol and diesel vehicles. A home EV charger
          is the most practical and cost-effective way to keep an electric vehicle charged,
          providing a full charge overnight at a fraction of the cost of public rapid charging.
        </p>
        <p>
          Nottingham's housing stock is diverse, ranging from modern new builds in Clifton,
          Wollaton, and Arnold to Victorian terraces in the Meadows, Forest Fields, and Hyson
          Green. This variety means installation complexity and cost differ significantly across
          the city. Modern detached or semi-detached properties with garages or short driveways
          sit at the lower end of the cost range; older terraces with longer cable routes and
          ageing consumer units sit higher.
        </p>
        <p>
          This guide covers realistic costs for EV charger installation in Nottingham in 2026,
          the OZEV grant of up to £350 for eligible residents, the DNO notification process
          through{' '}
          <strong>National Grid Electricity Distribution (NGED)</strong>, Part P compliance,
          and what Nottingham's housing mix means for your installation.
        </p>
      </>
    ),
  },
    ...
    content: (
      <>
        <p>
          ...
          installation. East Midlands labour rates are lower than London and the South East,
          and most residential properties have manageable cable routes.
        </p>
          ...
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                to £1,100. Cable run of 8 to 15 metres, PME earth rod required for outdoor
                charger, possible MCB addition. Typical for Meadows, Forest Fields, and Hyson
                Green terraces with off-street parking.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Complex installation (long run, board upgrade)</strong> — £1,100 to
                £1,400. Cable run over 15 metres, full consumer unit replacement, earth rod
                and TT arrangement. More common for older Victorian terraces where the
                consumer unit is at the back and parking is at the front.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                Requires a three-phase supply and G99 approval from NGED. Suitable for
                properties with high daily mileage or multiple EVs.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Several grant schemes are available to Nottingham residents and businesses:
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                tenants who own or lease an eligible plug-in vehicle. Given Nottingham's large
                student and rented-accommodation population, many city residents may be eligible.
                Applied for by your OZEV-approved installer.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Workplace Charging Scheme</strong> — Nottingham businesses can claim
                up to £350 per socket (maximum 40 sockets) for workplace EV charger
                installations. Requires an OZEV-approved installer and a registered business.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Nottingham City Council EV strategy</strong> — Nottingham City Council
                has an active zero-emission transport strategy supporting on-street charging
        ...
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Dedicated circuit (Regulation 722.533.101)</strong> — a dedicated 32A
                final circuit from the consumer unit. Older Nottingham consumer units may not
                have a spare way, requiring a board upgrade or separate enclosure.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                protection covering the EV circuit. Most quality smart chargers include
                integrated DC fault protection, satisfying the requirement for a Type B RCD
                or Type A RCD with 6mA DC RDC-DD.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Smart charger compliance</strong> — the Electric Vehicles (Smart
                Charge Points) Regulations 2021 require all new home EV chargers to support
                smart scheduling and demand side response functionality.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                for the actual cable run length. 6mm² cable is typically adequate for runs up to
                15 metres; 10mm² may be needed for longer runs carrying 32A.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Most Nottingham properties are supplied on PME (TN-C-S) earthing arrangements.
          Regulation 722.411.4.1 and the IET Code of Practice for EV Charging Equipment
          Installation set out the requirements for outdoor chargers on PME supplies.
        </p>
        <div className="grid gap-4 sm:grid-cols-2 my-4">
          <div className="rounded-2xl bg-blue-500/10 border border-blue-500/20 p-5">
            <h3 className="font-bold text-white text-lg mb-3">The PME Risk</h3>
            <p className="text-white text-sm leading-relaxed">
              A broken PEN conductor on a PME supply can cause dangerous touch voltages on
              earthed metalwork, including an EV being charged outdoors. The risk is greatest
              on wet surfaces where the vehicle tyres provide limited isolation from the ground.
              The IET Code of Practice requires protective measures for all outdoor EV charging
              on PME supplies.
            </p>
          </div>
          <div className="rounded-2xl bg-green-500/10 border border-green-500/20 p-5">
            ...
            <p className="text-white text-sm leading-relaxed">
              ...
              Alternatively, smart chargers with integrated PEN fault detection remove the need
              for a separate earth rod. Where the charger is inside a garage or enclosed
              carport, an assessment may allow the PME earth to be retained.
            </p>
          </div>
        </div>
        <p>
          ...
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                from NGED before installation. Allow 4 to 10 weeks for assessment. Used for
                three-phase chargers and commercial premises.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                NGED can require the charger to be disconnected until notification is complete.
              </span>
            </li>
          </ul>
        </div>
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                properties typically have modern consumer units, shorter cable routes, and
                adequate earthing. These are the most straightforward and cost-effective
                installations, often completed in under 4 hours.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Home className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Victorian terraces (Meadows, Forest Fields, Hyson Green)</strong> —
                longer cable runs are common, and many older consumer units need upgrading to
                accommodate a 32A EV circuit. Installation is feasible but costs are higher.
                Always commission a survey before agreeing a price.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Home className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Student accommodation and HMOs (Lenton, Dunkirk, Radford)</strong> —
                large numbers of rented properties in the university quarter. Tenants may be
                eligible for OZEV grants; landlords should seek advice on installation
                responsibility and compliance with HMO licensing requirements.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>City-centre flats</strong> — shared parking, communal electricity
                supplies, and freeholder permissions add complexity. Load management systems
                may be needed where multiple residents install chargers. Flat owners are
                eligible for the OZEV grant.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Nottingham and the East Midlands offer consistent demand for EV charger installation
          work. The city's diverse housing stock and growing EV uptake across all property types
          mean steady opportunity for NICEIC and NAPIT-registered electricians who can offer a
          ...
          <div className="rounded-2xl bg-yellow-500/10 border border-yellow-500/20 p-5">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  Factor in East Midlands labour rates (£38 to £50/hour), site survey time for
                  older properties, earth rod costs, NGED G98 notification, and EIC
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  ...
                  full EIC under BS 7671 Section 722. Elec-Mate's certificate app includes all
                  required test fields and can be emailed to the customer instantly.
                </p>
              </div>
            </div>
          </div>
        ...
        <SEOAppBridge
          ...
          description="Join 430+ UK electricians using Elec-Mate for cable sizing, AI-powered quoting, and on-site EIC certification. Complete EV charger quotes and certificates from your phone — built for electricians working across Nottingham and the East Midlands."
          icon={Car}
        />
      </>
    ),
