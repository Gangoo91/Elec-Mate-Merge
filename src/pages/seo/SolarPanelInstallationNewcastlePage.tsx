...
const sections = [
  {
    ...
    content: (
      <>
        <p>
          A common misconception is that the Northeast of England is too cloudy for solar panels to
          be worthwhile. In reality, Newcastle and the surrounding Tyne and Wear area receive
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                irradiance to Newcastle (approximately 950 to 1,050 kWh/m²/year). The argument that
                the Northeast is "too far north" for solar simply does not hold up to comparison.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Sun className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                Newcastle has the same financial value as one generated in London, even though
                London generates slightly more units per kWp installed.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                December and January see significantly reduced output. Battery storage and
                time-of-use tariffs can help manage this variation effectively.
              </span>
            </li>
          </ul>
        </div>
        <p>
          Solar PV in Newcastle typically achieves payback in 9 to 14 years on a system with a 25 to
          30-year lifespan. At current electricity prices, the lifetime return on a £7,000 system is
          often £15,000 to £25,000 in combined bill savings and export payments.
        </p>
      </>
    ),
  },
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                surfaces at 35° receive slightly more — approximately 1,050 to 1,100 kWh/m²/year —
                due to optimal angle relative to the sun's path.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Sun className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                (7 to 8 hours) and lower sun angles. A 4kW system might generate 450 to 550 kWh in
                June but only 80 to 120 kWh in December.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Sun className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                kWh/kWp for London and 750 to 800 kWh/kWp for Aberdeen.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                North-facing properties or those shaded by trees, chimney stacks, or neighbouring
                buildings will generate significantly less than south-facing equivalents.
              </span>
            </li>
          </ul>
        </div>
          ...
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                large proportion of a typical family home's electricity use.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                battery is particularly valuable for capturing summer evening surplus.
              </span>
            </li>
          </ul>
        </div>
        <p>
          All prices include panels, inverter, mounting hardware, cabling, consumer unit connection,
          commissioning, MCS registration, and scaffolding. VAT on residential solar installations
          is 0% until March 2027.
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>
          The Smart Export Guarantee (SEG) pays solar panel owners for surplus electricity exported
          to the grid. The scheme replaced the Feed-in Tariff (closed April 2019) and is available
          to all MCS-certified solar installations regardless of size (up to 5MW).
        </p>
        <div className="rounded-2xl bg-green-500/10 border border-green-500/20 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Best 2025 SEG rates</strong> — Octopus Energy's Outgoing Octopus tariff
                offers up to 15p/kWh at peak times (4pm to 7pm weekdays) with a variable rate at
                other times; E.ON Next offers 5.5p/kWh fixed; Ovo Energy offers 5p/kWh fixed;
                British Gas offers 4.5p/kWh fixed. Rates change periodically — compare at the time
            ...
            <li className="flex items-start gap-3">
              <TrendingUp className="w-5 h-5 text-green-400 mt-0.5 shrink-0" />
              <span>
                <strong>Newcastle earnings estimate</strong> — a 4kW system in Newcastle exporting
                around 35 per cent of its 3,100 to 3,400 kWh annual generation (approximately 1,085
                to 1,190 kWh) could earn £55 to £180 per year depending on the tariff chosen.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <TrendingUp className="w-5 h-5 text-green-400 mt-0.5 shrink-0" />
              <span>
                <strong>Smart meter requirement</strong> — a functioning smart meter is required for
                SEG. If you do not have one, your energy supplier is obliged to offer to install
                one. Half-hourly smart meter data is used to calculate your export payments
                accurately.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <TrendingUp className="w-5 h-5 text-green-400 mt-0.5 shrink-0" />
              <span>
                <strong>Switching supplier</strong> — you can switch energy supplier and still
                maintain your SEG. Your new supplier must also offer an SEG tariff if they have
                150,000 or more domestic customers. Switching regularly to get the best rate is
                permitted.
              </span>
            </li>
          </ul>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Various public sector initiatives in Newcastle and the wider Northeast can help homeowners
          and businesses access solar PV at reduced cost or with additional support.
        </p>
        <div className="rounded-2xl bg-blue-500/10 border border-blue-500/20 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>ECO4 scheme</strong> — the government's Energy Company Obligation (ECO4)
                scheme funds energy efficiency measures, including solar PV, for low-income
                households and those in fuel poverty. Newcastle City Council operates a Warm Homes
                programme that channels ECO4 funding to eligible residents. Contact Newcastle City
                Council's housing team to check eligibility.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Building2 className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>North East Combined Authority</strong> — the NECA has supported community
                energy projects across the region and published guidance on renewable energy
                investment. Check the NECA website for current initiatives.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Building2 className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Great British Insulation Scheme</strong> — the GBIS scheme, managed by
                Ofgem, funds insulation and some energy efficiency measures for eligible households.
                Solar panels are not directly funded under GBIS but the scheme may improve the
                economics of solar by reducing heating demand.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Building2 className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>0% VAT relief</strong> — the most broadly available financial benefit. All
                residential solar PV installations benefit from 0% VAT on supply and installation
                until March 2027 under the Energy-Saving Materials relief. This saves approximately
                £500 to £1,000 on a typical system compared to the standard 20% VAT rate.
              </span>
            </li>
          </ul>
        </div>
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                only). Adding a 9.5kWh battery can increase this to 60 to 75 per cent, substantially
                improving bill savings.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Battery className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                installed), Tesla Powerwall 3 (13.5kWh, £9,000 to £12,000 installed). GivEnergy is
                particularly popular with Northeast installers for its reliability and support.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Battery className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                7p/kWh, Intelligent Octopus from 9p/kWh) and discharge during the day, reducing
                bills even in winter when solar generation is low.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          The majority of residential solar installations in Newcastle are permitted development and
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                must not project more than 200mm above the roof plane and must not be higher than
                the highest part of the roof (excluding chimney).
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                areas, panels on a roof that faces a highway require planning permission. Contact
                Newcastle City Council's planning department to check your specific address.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                permission and listed building consent. These are rarely granted for panels on
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                City Council. The fee is approximately £120 for a residential application and
                provides legal certainty before proceeding.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Solar PV is one of the most in-demand additional skills for electricians in Newcastle and
          the Northeast. Electricians with City and Guilds 2399 (Solar PV Design, Installation, and
          Commissioning) or equivalent, combined with MCS certification, can command day rates of
          £350 to £600+ for solar installation work.
        </p>
        <div className="space-y-4 my-4">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  ...
                  to complete EICs for solar AC connections on site. AI-assisted form completion, BS
                  7671 compliant, and instant PDF export mean the certificate is ready for the
          ...
          <div className="rounded-2xl bg-green-500/10 border border-green-500/20 p-5">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h4 className="font-bold text-white mb-1">
                  Quote Solar Installations Professionally
                </h4>
                <p className="text-white text-sm leading-relaxed">
                  ...
                  . Include panels, inverter, mounting, scaffolding, electrical connection, and MCS
                  registration in a clear PDF that wins jobs.
                </p>
              </div>
            </div>
          </div>
