...
const relatedPages: RelatedPage[] = [
  {
    ...
    description: 'Local price bands and labour rates for consumer unit replacement in Bristol.',
    icon: PoundSterling,
    category: 'Guide',
  },
  {
    ...
    content: (
      <>
        ...
        <SEOAppBridge
          ...
          description="Elec-Mate connects you with NICEIC and NAPIT registered electricians across Bristol and the South West."
          icon={MapPin}
        />
      </>
    ),
...
export default function ConsumerUnitReplacementBristolPage() {
  return (
    <GuideTemplate
      title="Consumer Unit Replacement Bristol | Fuse Board Upgrade Cost"
      description="How much does a consumer unit replacement cost in Bristol in 2026? Local pricing for fuse board upgrades, Part P notification, what to expect…"
