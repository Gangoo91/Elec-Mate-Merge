    ...
    <ToolTemplate
      ...
      faqs={[
        ...
        },
        {
          ...
          answer:
            'Yes. The AI Board Scanner is included in all Elec-Mate subscription plans from £6.99 per month. There are no additional charges for scans and no usage limits. You can scan as many boards as you need. The feature is available on both iPhone and Android devices.',
        },
      ]}
      relatedPages={[
        {
      ...
      ctaSubheading="7-day free trial includes unlimited board scans, all 19 certificate types, 70+ calculators, and every AI tool. No charge until day 8."
