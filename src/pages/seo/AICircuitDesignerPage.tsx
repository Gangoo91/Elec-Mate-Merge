  ...
  return (
    <PublicPageLayout>
      ...
      <section className="px-5 pb-4">
        <div className="max-w-3xl mx-auto p-5 rounded-2xl bg-gradient-to-b from-white/[0.08] to-white/[0.04] border border-white/[0.14] text-white text-sm leading-relaxed">
