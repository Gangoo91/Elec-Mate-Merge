...
const faqs = [
  {
    question:
      'Does Welsh building regulations law differ from England for consumer unit replacement?',
    answer:
  ...
  {
    question:
      'Is there a requirement for Bilingual (Welsh and English) documentation for Cardiff consumer unit certificates?',
    answer:
...
const relatedPages: RelatedPage[] = [
  ...
  },
  {
    ...
    description:
      'Consumer unit replacement in Southampton — costs, regulations, and qualified electricians.',
    icon: Building2,
    category: 'Guide',
  },
  {
...
const sections = [
  {
    ...
    content: (
      <>
        <p>
          Cardiff is the capital city of Wales and one of the fastest-growing cities in the UK. The
          city has a diverse housing stock — from Victorian terraces in Cathays and Roath to
          Edwardian semis in Whitchurch and Llandaff, post-war housing in Ely and Llanrumney, and
          modern waterfront apartments in Cardiff Bay. Consumer unit replacement demand spans all
          these property types, with particularly high volumes in the large private rented sector
          that serves Cardiff's two major universities.
        </p>
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                (Regulation 411.3.3) apply in full.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Info className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
        ...
        <div className="rounded-2xl bg-blue-500/10 border border-blue-500/20 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Fire containment rationale</strong> — arc flash events during internal short
                circuits inside a consumer unit release intense energy. A steel enclosure contains
                this event and prevents ignition of surrounding building materials. Plastic
                enclosures can melt and ignite, which is a particular concern in Cardiff's Victorian
                terrace stock where consumer units are often installed in timber outbuildings,
                understairs cupboards, or close to timber joists.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
    ...
    content: (
      <>
        <p>
          ...
          rated up to 32A and for all circuits serving bathrooms and shower rooms (Regulation 701).
          This applies throughout Cardiff and Wales. Many older Cardiff properties — particularly
          those rewired in the 1970s and 1980s — lack adequate RCD protection and require a consumer
          unit upgrade to achieve compliance.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                trips all circuits in that group. This can be disruptive in Cardiff rental
                properties where tenants share circuits.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                Preferred for new installations and for Cardiff rental properties where maximum
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                insulation. RCBOs limit the impact to a single circuit. Recurring nuisance tripping
                should be investigated as it may indicate wiring requiring remedial attention.
              </span>
            </li>
          </ul>
        </div>
    ...
    content: (
      <>
        <p>
          ...
          electrical work in dwellings are substantively similar — consumer unit replacement is
          notifiable work and must be carried out by a competent person or notified to Cardiff
        ...
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Competent person self-certification in Wales</strong> — NICEIC, NAPIT, and
                ELECSA registered electricians can self-certify electrical work in Wales. They
                notify Cardiff Council building control on your behalf and issue a Building
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                fitness-for-purpose standard expected of registered landlords. Consumer unit
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          BS EN 61439-3 is the British and European Standard for distribution boards intended for
          use by ordinary persons, including domestic consumer units. It applies throughout the UK
          including Cardiff and Wales, setting requirements for design verification, construction,
        ...
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              <Info className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Design verification</strong> — manufacturers must verify through testing or
                calculation that the consumer unit assembly meets its rated voltage, current, and
                prospective short-circuit current (PSCC) values. The PSCC rating must be adequate
                for the fault level at the Cardiff installation address — your electrician measures
                this and confirms the selected unit is appropriately rated.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Info className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                ...
                2022 must carry UKCA marking. Cardiff electricians should only install units from
                reputable manufacturers such as Hager, Schneider Electric, Wylex, or Contactum that
                comply with BS EN 61439-3 and carry UKCA marking.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Info className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Site testing under BS 7671 Part 6</strong> — factory testing under BS EN
                61439-3 is supplemented by on-site inspection and testing under BS 7671 Part 6. All
                measured values are recorded in the Schedule of Test Results forming part of the
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Cardiff's consumer unit replacement costs are broadly comparable to equivalent cities in
          the South West of England and the Midlands. Welsh labour rates are generally lower than
          London but similar to Bristol or Nottingham. The following 2026 guide prices are
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Cardiff has experienced rapid population growth and significant property development since
          the 1990s, alongside a large stock of older Victorian, Edwardian, and post-war properties.
          Consumer unit replacement considerations vary across the city's distinct neighbourhoods.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                very common, often driven by EICR compliance requirements under Cardiff Council's
                Selective Licensing scheme and Rent Smart Wales obligations.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Building2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                older converted properties and some 1990s blocks may have consumer units that
                require updating to current standards. Communal area electrical installations should
                also be considered.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                electrode rather than the PME (TN-C-S) arrangement common in Cardiff's urban areas.
                TT installations require RCD protection at the origin and different consumer unit
                specification. Your electrician must identify the earthing system before proceeding.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Building2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                Welsh-language communication is preferred, ask the electrician at the quotation
                stage. There is no legal requirement for the EIC or compliance certificate to be in
                Welsh.
              </span>
            </li>
          </ul>
    ...
    content: (
      <>
        <p>
          ...
          Newport, Swansea, and the Valleys can build significant consumer unit replacement volumes
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  ...
                  No clipboards, no evening admin, no paper.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  ...
                  particularly receptive to planned upgrade programmes quoted at the time of the
                  first visit.
                </p>
              </div>
            </div>
