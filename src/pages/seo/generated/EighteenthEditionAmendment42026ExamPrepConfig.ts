...
// 18th Edition Amendment 4:2026 Exam Prep — apprentice / electrician / employer content.
// Updated 2026-05-18.
...
export const EighteenthEditionAmendment42026ExamPrepConfig: GeneratedGuideConfig = {
  ...
  breadcrumbLabel: '18th Edition Amendment 4:2026 Ex...',
  heroPrefix: '18th Edition Amendment 4:2026 Exam Prep:',
  heroHighlight: 'Complete 2026 Guide',
  heroSuffix: '— For UK Electrical Trade',
  heroSubtitle:
    'A focused study guide for the City & Guilds 2382-23 (or equivalent) 18th Edition Amendment 4:2026 exam. Covers what changed from A3, where to focus revision, exam format, and the five chapters that dominate the question paper. This guide is for qualified electricians taking or re-taking the 18th Edition (C&G 2382-23) exam.',
  keyTakeaways: [
  ...
  sections: [
    {
      id: 'changes-from-a3',
      heading: 'Key Changes from A3:2024 to A4:2026',
      tocLabel: 'Key Changes from A3:2024 ...',
      blocks: [
        {
          type: 'paragraph',
  ...
  faqs: [
    { question: 'Who is this guide for?', answer: 'This guide is written for qualified electricians taking or re-taking the 18th Edition (C&G 2382-23) exam. The advice is practical, UK-specific, and based on current 2026 regulations.' },
