...
export const qualHub5357Config: GeneratedGuideConfig = {
  ...
  keyTakeaways: [
    'Level: Level 3 — awarded by City & Guilds — regulated by IfATE.',
    'Designed for: apprentices on the official Apprenticeship Standard (most new starters since 2018).',
    'Typical duration: 3-4 years.',
    'End-point assessment: AM2 end-point assessment (mandatory).',
    'On completion this leads to: JIB Approved Electrician grade, ECS Gold Card, scheme membership eligibility.',
    'Funding route: Apprenticeship Levy + 95% Government funding (or 100% for under-21s with under-50-employee firms).',
    '15 core units cover 340 specific topic points across the qualification.',
  ],
  sections: [
    {
      id: 'overview',
      ...
      blocks: [
        {
          type: 'paragraph',
          text: 'City & Guilds 5357 (Level 3 Electrotechnical Qualification (Apprenticeship Standard)) is a Level 3 qualification awarded by City & Guilds and regulated by IfATE. It is designed for apprentices on the official Apprenticeship Standard (most new starters since 2018) and typically runs 3-4 years.',
        },
        {
          type: 'paragraph',
          text: 'The qualification is built around 15 core units. Each unit covers a distinct theme — health and safety, electrical science, installation, fault diagnosis, inspection and testing, design — and combines theory assessment with practical workshop observation. Below is every unit with a direct link to its full revision page.',
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          ordered: true,
          items: [
            'Unit 022 — Understand the Requirements of Electrical Installations BS 7671:2018 (2022) (17 topic points).',
            'Unit 101/001 — Understand Health, Safety and Environmental Considerations (26 topic points).',
            'Unit 102 — Apply Health, Safety and Environmental Considerations (14 topic points).',
            'Unit 103/003 — Electrical Scientific Principles and Technologies (47 topic points).',
            'Unit 104/004 — Understand Design and Installation Practices and Procedures (45 topic points).',
            'Unit 105/505 — Understand How to Plan and Oversee Electrical Work Activities (17 topic points).',
            'Unit 106 — Organise and Oversee the Electrical Work Environment (18 topic points).',
            'Unit 107 — Understand Terminations and Connections of Conductors (7 topic points).',
            'Unit 109 — Apply Design and Installation Practices and Procedures (13 topic points).',
            ...
            'Unit 114/014 — Understand Fault Diagnosis and Rectification (21 topic points).',
            ...
            'Unit 312/212 — Inspection, Testing and Commissioning (56 topic points).',
          ],
        },
      ],
    },
    {
      ...
      blocks: [
        {
          type: 'paragraph',
          text: 'AM2 end-point assessment (mandatory). Each individual unit also has its own assessment — typically a mix of online multiple-choice exams, written short-answer papers, and practical workshop tasks observed by your tutor or assessor.',
        },
        {
          type: 'paragraph',
    ...
    },
    {
      ...
      blocks: [
        {
          type: 'paragraph',
          text: 'Funding route: Apprenticeship Levy + 95% Government funding (or 100% for under-21s with under-50-employee firms). Exact arrangements vary by your specific employer, college, and personal circumstances — confirm with your training provider before enrolling.',
        },
      ],
    },
    {
      ...
      blocks: [
        {
          type: 'paragraph',
          text: 'The Elec-Mate apprentice tier covers every unit in City & Guilds 5357 with mock exams, flashcards, revision notes, and OJT (off-the-job) hour tracking. Tutors get a dashboard showing every apprentice\u2019s progress in real time.',
        },
        {
          type: 'callout',
          tone: 'info',
  ...
  faqs: [
    ...
    },
    {
      ...
      answer: 'City & Guilds 5357 is designed for apprentices on the official Apprenticeship Standard (most new starters since 2018). Confirm with your training provider that this is the right pathway for your situation before enrolling.',
    },
    {
      question: 'What is the end-point assessment?',
      answer: 'The end-point assessment is: AM2 end-point assessment (mandatory). This sits alongside each unit\u2019s own assessment — every unit must be passed to be eligible for the end-point.',
    },
    {
      question: 'How much does City & Guilds 5357 cost?',
      answer: 'Cost depends on funding route: Apprenticeship Levy + 95% Government funding (or 100% for under-21s with under-50-employee firms). Adult learners self-funding typically pay £2,000-6,500 across the duration. Apprentices on the Apprenticeship Standard route typically pay nothing themselves.',
    },
    {
      question: 'What does City & Guilds 5357 qualify me to do?',
      answer: 'On completion this leads to: JIB Approved Electrician grade, ECS Gold Card, scheme membership eligibility. With JIB Approved Electrician grade and an ECS Gold Card you are eligible for competent person scheme membership (NICEIC, NAPIT, ELECSA, Stroma) and can self-certify Part P notifiable work.',
    },
    {
