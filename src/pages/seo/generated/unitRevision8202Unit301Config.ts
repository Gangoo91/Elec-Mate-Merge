...
// Apprentice revision page for City & Guilds 8202 Unit 301.
...
export const unitRevision8202Unit301Config: GeneratedGuideConfig = {
  ...
  breadcrumbLabel: 'Unit 301 Revision',
  heroPrefix: 'City & Guilds 8202 Unit 301:',
  heroHighlight: 'Planning and overseeing electrical work activities',
  heroSuffix: '— Complete Revision Guide',
  heroSubtitle:
    'A structured revision walkthrough of every topic in City & Guilds 8202 Unit 301 (Planning and overseeing electrical work activities). Use it as a personal study checklist — work through each topic, tick off the points you can confidently explain or calculate, and use the linked Elec-Mate tools to practice the calculation-led parts. Designed for T Level students taking the electrical installation specialism.',
  keyTakeaways: [
    'City & Guilds 8202 Unit 301 — Planning and overseeing electrical work activities — is a core component of the T Level in Building Services Engineering — Electrical Installation.',
    'This unit is typically delivered to T Level students taking the electrical installation specialism and covers 3 main topic areas.',
    'Across the 3 topics there are 13 specific points you should be able to explain, demonstrate or calculate before the end-of-unit assessment.',
  ...
  sections: [
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          ordered: false,
          items: [
            'Learners will describe techniques for the communication for different purposes including:.',
            'Learners will describe methods of determining the competence of operatives for whom they are responsible including:.',
            'Learners will specify procedures for re-scheduling work to co-ordinate with changing conditions in the workplace and to coincide with other trades..',
            'Learners will specify organisational procedures for completing the documentation that is required during work operations..',
          ],
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          ordered: false,
          items: [
            'Learners will describe how to plan and implement work programs with consideration of:.',
            'Learners will describe the procedures for carrying out work activities with consideration of:.',
            'Learners will know the industry standards that are relevant to activities carried out during the installation of electrical systems and equipment, including the current editions:.',
            'Learners will explain how work completion times are estimated, taking into account influential factors such as:.',
            'Learners will know the potential consequences of problems during scheduling including:.',
          ],
        },
      ],
    },
    {
      id: 'topic-3',
      heading: 'Topic 3: The requirements for organising the provision and storage of resources required for work activities Level 3 Advanced Technical Diploma in Electrical Installation (450) (8202-30)',
      tocLabel: 'Topic 3',
      blocks: [
        {
          type: 'paragraph',
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          body:
            'The Elec-Mate apprentice tier includes mock exams, flashcards, and revision notes for City & Guilds 8202 Unit 301 plus every other unit in your qualification. 7-day free trial — see your progress on the tutor dashboard.',
        },
      ],
    },
  ],
  faqs: [
    {
      question: 'What does City & Guilds 8202 Unit 301 cover?',
      answer: 'Unit 301 (Planning and overseeing electrical work activities) covers 3 main topic areas: The requirements for liaising with others when organising and overseeing work activities; The requirements for organising and overseeing work programmes; The requirements for organising the provision and storage of resources required for work activities Level 3 Advanced Technical Diploma in Electrical Installation (450) (8202-30). Each topic has specific points you should be able to explain, demonstrate or calculate.',
    },
    {
  ...
  ctaHeading: 'For Apprentices: Pass City & Guilds 8202 Unit 301 with Confidence',
  ctaSubheading:
