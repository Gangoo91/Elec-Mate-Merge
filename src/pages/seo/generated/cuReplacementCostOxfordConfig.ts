  ...
  sections: [
    ...
    },
    {
      ...
      blocks: [
        {
          type: 'paragraph',
          text: 'If you are quoting consumer unit replacements in Oxford, the £570–900 band above is your fair-margin floor for a 10–14 way RCBO board with SPD, EIC and labour. Quoting below this band means you are absorbing the cost of your scheme fee, professional indemnity, calibrated test kit, and the certificate liability you sign. Use the bands as anchors, then adjust for: tails upgrade, bonding remedials, AFDDs (mandatory in HMOs / certain residential under A4:2026), and any DNO coordination through Scottish and Southern Electricity Networks (SSEN).',
        },
        {
          type: 'callout',
          tone: 'info',
