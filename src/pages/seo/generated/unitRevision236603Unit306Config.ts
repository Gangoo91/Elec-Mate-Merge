...
// Apprentice revision page for City & Guilds 2366-03 Unit 306.
...
export const unitRevision236603Unit306Config: GeneratedGuideConfig = {
  pagePath: '/guides/2366-03-unit-306-understand-the-requirements-of-electrical-installations-bs-7671-2018-2022-revision',
  title: 'City & Guilds 2366-03 Unit 306: Understand the Requirements',
  description: 'Complete revision guide for City & Guilds 2366-03 Unit 306 (Understand the Requirements of Electrical Installations BS 7671:2018 (2022)).',
  ...
  heroPrefix: 'City & Guilds 2366-03 Unit 306:',
  ...
  heroSubtitle:
    'A structured revision walkthrough of every topic in City & Guilds 2366-03 Unit 306 (Understand the Requirements of Electrical Installations BS 7671:2018 (2022)). Use it as a personal study checklist — work through each topic, tick off the points you can confidently explain or calculate, and use the linked Elec-Mate tools to practice the calculation-led parts. Designed for Level 3 apprentices.',
  keyTakeaways: [
    'City & Guilds 2366-03 Unit 306 — Understand the Requirements of Electrical Installations BS 7671:2018 (2022) — is a core component of the Level 3 Diploma in Electrotechnical Technology.',
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            'Interpret how this applies to electrical installations within the scope of BS 7671.',
          ],
        },
      ],
    },
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          ordered: false,
          items: [
            'Identify the requirements for special installations.',
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          body:
            'The Elec-Mate apprentice tier includes mock exams, flashcards, and revision notes for City & Guilds 2366-03 Unit 306 plus every other unit in your qualification. 7-day free trial — see your progress on the tutor dashboard.',
        },
      ],
    },
  ],
  faqs: [
    ...
    },
    {
      ...
      answer: 'Level 3 Diploma in Electrotechnical Technology units are typically delivered across the apprenticeship in college-block weeks. Unit 306 is usually delivered to Level 3 apprentices. Check your individual learning plan with your tutor for exact timing.',
    },
    {
    ...
    },
    {
      ...
      answer: 'Unit 306 is one of several units that together make up the Level 3 Diploma in Electrotechnical Technology. Passing every unit and the end-point assessment (AM2 or equivalent) earns you the full qualification. Check the unit overview in our City & Guilds qualification hub for the full unit list.',
    },
  ],
  howToHeading: 'A Five-Step Revision Plan for This Unit',
  howToDescription:
    'A repeatable approach that works for City & Guilds 2366-03 Unit 306 and every other unit in your qualification.',
  howToSteps: [
    {
  ...
  ctaHeading: 'For Apprentices: Pass City & Guilds 2366-03 Unit 306 with Confidence',
  ctaSubheading:
