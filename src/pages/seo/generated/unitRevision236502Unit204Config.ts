...
// Apprentice revision page for City & Guilds 2365-02 Unit 204.
...
export const unitRevision236502Unit204Config: GeneratedGuideConfig = {
  ...
  breadcrumbLabel: 'Unit 204 Revision',
  heroPrefix: 'City & Guilds 2365-02 Unit 204:',
  heroHighlight: 'Installation of wiring systems and enclosures',
  heroSuffix: '— Complete Revision Guide',
  heroSubtitle:
    'A structured revision walkthrough of every topic in City & Guilds 2365-02 Unit 204 (Installation of wiring systems and enclosures). Use it as a personal study checklist — work through each topic, tick off the points you can confidently explain or calculate, and use the linked Elec-Mate tools to practice the calculation-led parts. Designed for 1st-year apprentices.',
  keyTakeaways: [
    'City & Guilds 2365-02 Unit 204 — Installation of wiring systems and enclosures — is a core component of the Level 2 Diploma in Electrical Installations.',
    'This unit is typically delivered to 1st-year apprentices and covers 6 main topic areas.',
    'Across the 6 topics there are 24 specific points you should be able to explain, demonstrate or calculate before the end-of-unit assessment.',
  ...
  sections: [
    {
      id: 'topic-1',
      heading: 'Topic 1: Tools used to install wiring systems',
      tocLabel: 'Topic 1',
      blocks: [
        {
          type: 'paragraph',
    ...
    {
      id: 'topic-2',
      heading: 'Topic 2: To prepare for installing wiring systems',
      tocLabel: 'Topic 2',
      blocks: [
        {
          type: 'paragraph',
    ...
    {
      id: 'topic-3',
      heading: 'Topic 3: How to install wiring systems',
      tocLabel: 'Topic 3',
      blocks: [
        {
          type: 'paragraph',
        ...
        },
        {
          ...
          items: [
            ...
            'Terminate wiring systems.',
            'Maintain safe working practices.',
            'Use JIB safe isolation procedures.',
          ],
        },
      ],
    },
    {
      id: 'topic-4',
      heading: 'Topic 4: How to bond mains services to main earthing terminal',
      tocLabel: 'Topic 4',
      blocks: [
        {
          type: 'paragraph',
    ...
    {
      id: 'topic-5',
      heading: 'Topic 5: How to inspect a dead electrical installation',
      tocLabel: 'Topic 5',
      blocks: [
        {
          type: 'paragraph',
    ...
    {
      id: 'topic-6',
      heading: 'Topic 6: How to test a dead electrical installation',
      tocLabel: 'Topic 6',
      blocks: [
        {
          type: 'paragraph',
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          body:
            'The Elec-Mate apprentice tier includes mock exams, flashcards, and revision notes for City & Guilds 2365-02 Unit 204 plus every other unit in your qualification. 7-day free trial — see your progress on the tutor dashboard.',
        },
      ],
    },
  ],
  faqs: [
    {
      question: 'What does City & Guilds 2365-02 Unit 204 cover?',
      answer: 'Unit 204 (Installation of wiring systems and enclosures) covers 6 main topic areas: Tools used to install wiring systems; To prepare for installing wiring systems; How to install wiring systems; How to bond mains services to main earthing terminal; How to inspect a dead electrical installation; How to test a dead electrical installation. Each topic has specific points you should be able to explain, demonstrate or calculate.',
    },
    {
    ...
    },
    {
      ...
      answer: 'Level 2 Diploma in Electrical Installations units are typically delivered across the apprenticeship in college-block weeks. Unit 204 is usually delivered to 1st-year apprentices. Check your individual learning plan with your tutor for exact timing.',
    },
    {
    ...
    },
    {
      ...
      answer: 'Unit 204 is one of several units that together make up the Level 2 Diploma in Electrical Installations. Passing every unit and the end-point assessment (AM2 or equivalent) earns you the full qualification. Check the unit overview in our City & Guilds qualification hub for the full unit list.',
    },
  ],
  howToHeading: 'A Five-Step Revision Plan for This Unit',
  howToDescription:
    'A repeatable approach that works for City & Guilds 2365-02 Unit 204 and every other unit in your qualification.',
  howToSteps: [
    {
  ...
  ctaHeading: 'For Apprentices: Pass City & Guilds 2365-02 Unit 204 with Confidence',
  ctaSubheading:
