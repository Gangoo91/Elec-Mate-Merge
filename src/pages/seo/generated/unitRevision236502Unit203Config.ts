...
// Apprentice revision page for City & Guilds 2365-02 Unit 203.
...
export const unitRevision236502Unit203Config: GeneratedGuideConfig = {
  ...
  breadcrumbLabel: 'Unit 203 Revision',
  heroPrefix: 'City & Guilds 2365-02 Unit 203:',
  heroHighlight: 'Electrical installations technology',
  heroSuffix: '— Complete Revision Guide',
  heroSubtitle:
    'A structured revision walkthrough of every topic in City & Guilds 2365-02 Unit 203 (Electrical installations technology). Use it as a personal study checklist — work through each topic, tick off the points you can confidently explain or calculate, and use the linked Elec-Mate tools to practice the calculation-led parts. Designed for 1st-year apprentices.',
  keyTakeaways: [
    'City & Guilds 2365-02 Unit 203 — Electrical installations technology — is a core component of the Level 2 Diploma in Electrical Installations.',
    'This unit is typically delivered to 1st-year apprentices and covers 6 main topic areas.',
    'Across the 6 topics there are 26 specific points you should be able to explain, demonstrate or calculate before the end-of-unit assessment.',
  ...
  sections: [
    {
      id: 'topic-1',
      heading: 'Topic 1: Implications of electrical industry regulations',
      tocLabel: 'Topic 1',
      blocks: [
        {
          type: 'paragraph',
        ...
        },
        {
          ...
          ordered: false,
          items: [
            'Identify statutory regulations.',
            'Identify non statutory regulations/guidance.',
            'State implications of statutory regulations.',
            'State implications of non-statutory regulations.',
          ],
        },
      ],
    },
    {
      id: 'topic-2',
      heading: 'Topic 2: To obtain technical information',
      tocLabel: 'Topic 2',
      blocks: [
        {
          type: 'paragraph',
        ...
        },
        {
          ...
          ordered: false,
          items: [
            'State purpose of different sources of technical information.',
            'Recognise different drawing types.',
            'Recognise symbols used in drawings.',
            'Convert scale from drawings to actual dimensions.',
          ],
        },
      ],
    },
    {
      id: 'topic-3',
      heading: 'Topic 3: Wiring systems of electrical installations',
      tocLabel: 'Topic 3',
      blocks: [
        {
          type: 'paragraph',
        ...
        },
        {
          ...
          ordered: false,
          items: [
            'Describe principles of operation of different circuit types.',
            'Identify wiring systems for different environments.',
            'Determine minimum current carrying capacity of live conductors for given installation conditions.',
            'State applications of different types of protective devices.',
            'Identify purpose of specialised equipment for installing wiring systems.',
            'Calculate spacing factor of wiring enclosures.',
          ],
        },
      ],
    },
    {
      id: 'topic-4',
      heading: 'Topic 4: Requirements earthing systems',
      tocLabel: 'Topic 4',
      blocks: [
        {
          type: 'paragraph',
        ...
        },
        {
          ...
          ordered: false,
          items: [
            'Identify different types of earthing systems.',
            'Identify component parts of Automatic Disconnection of Supply (ADS).',
            'Identify exposed conductive parts.',
            'Identify extraneous conductive parts.',
            'Identify component parts of an earth loop impedance path.',
          ],
        },
      ],
    },
    {
      id: 'topic-5',
      heading: 'Topic 5: Electricity is supplied',
      tocLabel: 'Topic 5',
      blocks: [
        {
          type: 'paragraph',
        ...
        },
        {
          ...
          ordered: false,
          items: [
            'Identify methods of generating electricity for distribution.',
            'Identify transmission voltages.',
            'Identify distribution voltages.',
            'State the component parts of the electrical distribution network.',
          ],
        },
      ],
    },
    {
      id: 'topic-6',
      heading: 'Topic 6: Requirements for different types of micro-renewable energies',
      tocLabel: 'Topic 6',
      blocks: [
        {
          type: 'paragraph',
        ...
        },
        {
          ...
          ordered: false,
          items: [
            'Describe types of micro-renewable energies.',
            'Identify requirements for installation of micro-renewable energies.',
            'Identify advantages and disadvantages of micro-renewable energies.',
          ],
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          body:
            'The Elec-Mate apprentice tier includes mock exams, flashcards, and revision notes for City & Guilds 2365-02 Unit 203 plus every other unit in your qualification. 7-day free trial — see your progress on the tutor dashboard.',
        },
      ],
    },
  ],
  faqs: [
    {
      question: 'What does City & Guilds 2365-02 Unit 203 cover?',
      answer: 'Unit 203 (Electrical installations technology) covers 6 main topic areas: Implications of electrical industry regulations; To obtain technical information; Wiring systems of electrical installations; Requirements earthing systems; Electricity is supplied; Requirements for different types of micro-renewable energies. Each topic has specific points you should be able to explain, demonstrate or calculate.',
    },
    {
    ...
    },
    {
      ...
      answer: 'Level 2 Diploma in Electrical Installations units are typically delivered across the apprenticeship in college-block weeks. Unit 203 is usually delivered to 1st-year apprentices. Check your individual learning plan with your tutor for exact timing.',
    },
    {
    ...
    },
    {
      ...
      answer: 'Unit 203 is one of several units that together make up the Level 2 Diploma in Electrical Installations. Passing every unit and the end-point assessment (AM2 or equivalent) earns you the full qualification. Check the unit overview in our City & Guilds qualification hub for the full unit list.',
    },
  ],
  howToHeading: 'A Five-Step Revision Plan for This Unit',
  howToDescription:
    'A repeatable approach that works for City & Guilds 2365-02 Unit 203 and every other unit in your qualification.',
  howToSteps: [
    {
  ...
  ctaHeading: 'For Apprentices: Pass City & Guilds 2365-02 Unit 203 with Confidence',
  ctaSubheading:
