...
// Apprentice revision page for City & Guilds 2357 Unit 601.
...
export const unitRevision2357Unit601Config: GeneratedGuideConfig = {
  ...
  breadcrumbLabel: 'Unit 601 Revision',
  heroPrefix: 'City & Guilds 2357 Unit 601:',
  heroHighlight: 'Understanding Health and Safety legislation, practices and procedures (installing and maintaining electrotechnical systems and equipment) (ELTK 01)',
  heroSuffix: '— Complete Revision Guide',
  heroSubtitle:
    'A structured revision walkthrough of every topic in City & Guilds 2357 Unit 601 (Understanding Health and Safety legislation, practices and procedures (installing and maintaining electrotechnical systems and equipment) (ELTK 01)). Use it as a personal study checklist — work through each topic, tick off the points you can confidently explain or calculate, and use the linked Elec-Mate tools to practice the calculation-led parts. Designed for apprentices working through an NVQ pathway with on-the-job portfolio evidence.',
  keyTakeaways: [
    'City & Guilds 2357 Unit 601 — Understanding Health and Safety legislation, practices and procedures (installing and maintaining electrotechnical systems and equipment) (ELTK 01) — is a core component of the Level 3 NVQ Diploma in Installing Electrotechnical Systems and Equipment.',
    ...
    'Across the 4 topics there are 24 specific points you should be able to explain, demonstrate or calculate before the end-of-unit assessment.',
  ...
  sections: [
    {
      id: 'topic-1',
      heading: 'Topic 1: How relevant Health and Safety legislation applies in the workplace',
      tocLabel: 'Topic 1',
      blocks: [
        {
          type: 'paragraph',
        ...
        },
        {
          ...
          items: [
            ...
            'Specify particular Health and Safety risks which may be present and the requirements of current health and safety legislation for the.',
          ],
        },
      ],
    },
    {
      id: 'topic-2',
      heading: 'Topic 2: The procedures for dealing with Health and Safety in the work environment',
      tocLabel: 'Topic 2',
      blocks: [
        {
          type: 'paragraph',
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            'Explain practices and procedures for addressing hazards in the work place.',
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          body:
            'The Elec-Mate apprentice tier includes mock exams, flashcards, and revision notes for City & Guilds 2357 Unit 601 plus every other unit in your qualification. 7-day free trial — see your progress on the tutor dashboard.',
        },
      ],
    },
  ],
  faqs: [
    {
      question: 'What does City & Guilds 2357 Unit 601 cover?',
      answer: 'Unit 601 (Understanding Health and Safety legislation, practices and procedures (installing and maintaining electrotechnical systems and equipment) (ELTK 01)) covers 4 main topic areas: How relevant Health and Safety legislation applies in the workplace; The procedures for dealing with Health and Safety in the work environment; The procedures for establishing a safe working environment; The requirements for identifying and dealing with hazards in the work environment. Each topic has specific points you should be able to explain, demonstrate or calculate.',
    },
    {
  ...
  ctaHeading: 'For Apprentices: Pass City & Guilds 2357 Unit 601 with Confidence',
  ctaSubheading:
