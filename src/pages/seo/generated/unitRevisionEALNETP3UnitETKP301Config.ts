...
// Apprentice revision page for EAL NETP3 Unit ETKP3-01.
...
export const unitRevisionEALNETP3UnitETKP301Config: GeneratedGuideConfig = {
  ...
  breadcrumbLabel: 'Unit ETKP3-01 Revision',
  heroPrefix: 'EAL NETP3 Unit ETKP3-01:',
  heroHighlight: 'Apply Health, Safety and Environmental Considerations',
  heroSuffix: '— Complete Revision Guide',
  heroSubtitle:
    'A structured revision walkthrough of every topic in EAL NETP3 Unit ETKP3-01 (Apply Health, Safety and Environmental Considerations). Use it as a personal study checklist — work through each topic, tick off the points you can confidently explain or calculate, and use the linked Elec-Mate tools to practice the calculation-led parts. Designed for apprentices and adult learners on the EAL NVQ pathway.',
  keyTakeaways: [
    'EAL NETP3 Unit ETKP3-01 — Apply Health, Safety and Environmental Considerations — is a core component of the EAL Level 3 NVQ in Electrotechnical Practice.',
  ...
  sections: [
    ...
    {
      id: 'topic-2',
      heading: 'Topic 2: How to assess the work environment for hazards and identify remedial actions',
      tocLabel: 'Topic 2',
      blocks: [
        {
          type: 'paragraph',
        ...
        },
        {
          ...
          items: [
            ...
            'Assess the work environment and revise work practices accordingly to take into account hazards which could cause harm, including the handling of potentially hazardous materials, tools, and equipment.',
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            'Apply procedures to ensure the safe use, maintenance and storage of tools, plant and equipment as stipulated in workplace policies, supplier information, and manufacturer instructions.',
            ...
            'Use access equipment correctly including ladder, tower scaffold or MEWP, stepladder, and platform.',
          ],
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          ordered: false,
          items: [
            'Demonstrate appropriate procedures for the safe handling, storage and disposal of hazardous materials and products in accordance with Environmental Protection Act, Hazardous Waste Regulations, Pollution Prevention and Control Act, and related legislation.',
          ],
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          body:
            'The Elec-Mate apprentice tier includes mock exams, flashcards, and revision notes for EAL NETP3 Unit ETKP3-01 plus every other unit in your qualification. 7-day free trial — see your progress on the tutor dashboard.',
        },
      ],
    },
  ],
  faqs: [
    {
      question: 'What does EAL NETP3 Unit ETKP3-01 cover?',
      answer: 'Unit ETKP3-01 (Apply Health, Safety and Environmental Considerations) covers 4 main topic areas: How to apply relevant health and safety legislation in the workplace; How to assess the work environment for hazards and identify remedial actions; How to apply methods and procedures to ensure work on site is in accordance with health and safety legislation; How to work in accordance with environmental legislation for electrical services. Each topic has specific points you should be able to explain, demonstrate or calculate.',
    },
    {
    ...
    },
    {
      ...
      answer: 'EAL Level 3 NVQ in Electrotechnical Practice units are typically delivered across the apprenticeship in college-block weeks. Unit ETKP3-01 is usually delivered to apprentices and adult learners on the EAL NVQ pathway. Check your individual learning plan with your tutor for exact timing.',
    },
    {
    ...
    },
    {
      ...
      answer: 'Unit ETKP3-01 is one of several units that together make up the EAL Level 3 NVQ in Electrotechnical Practice. Passing every unit and the end-point assessment (AM2 or equivalent) earns you the full qualification. Check the unit overview in our City & Guilds qualification hub for the full unit list.',
    },
  ],
  howToHeading: 'A Five-Step Revision Plan for This Unit',
  howToDescription:
    'A repeatable approach that works for EAL NETP3 Unit ETKP3-01 and every other unit in your qualification.',
  howToSteps: [
    {
  ...
  ctaHeading: 'For Apprentices: Pass EAL NETP3 Unit ETKP3-01 with Confidence',
  ctaSubheading:
