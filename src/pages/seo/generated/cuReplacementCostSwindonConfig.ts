...
// Programmatically generated consumer-unit-replacement cost landing page for Swindon.
// Market-rate data only — pricing bands derived from Swindon labour rates
...
export const cuReplacementCostSwindonConfig: GeneratedGuideConfig = {
  pagePath: '/guides/consumer-unit-replacement-cost-swindon',
  title: 'Consumer Unit Replacement Cost Swindon 2026 — Full Pricing',
  description: 'Consumer unit (fuse board) replacement cost in Swindon — typical 2026 prices £468–750 for a domestic swap with RCBOs, BS 7671:2018+A4:2026 compliant.',
  datePublished: published,
  dateModified: modified,
  readingTime: 8,
  badge: 'Cost Guide',
  badgeIcon: 'PoundSterling',
  breadcrumbLabel: 'Consumer Unit Replacement Cost in Swindon',
  breadcrumbParent: { label: 'Consumer Unit Replacement Cost', href: '/guides/consumer-unit-replacement-cost' },
  heroPrefix: 'Consumer Unit Replacement Cost in Swindon:',
  heroHighlight: '2026 Full Pricing Guide',
  heroSuffix: '— RCBO Boards & BS 7671:2018+A4:2026',
  heroSubtitle:
    'Whether you are an electrician quoting consumer unit replacements in Swindon or a homeowner trying to understand the market rate, this guide gives the fair-margin 2026 prices for a NICEIC or NAPIT scheme-registered electrician. Old wired-fuse boards, plastic enclosures and missing RCD protection are all driving replacements. Labour rates in Swindon typically run £55–£75/hour. Use it as a market-rate reference for your next quote, or as a buyer\u2019s guide to a fair price.',
  keyTakeaways: [
    'A typical 10–14 way domestic consumer unit replacement in Swindon costs £468–750 (2026 prices) including the new board, RCBOs, surge protection, labour and the Electrical Installation Certificate.',
    'Larger 18+ way boards, three-phase boards, or boards needing tail upgrades push the price toward £900 and beyond.',
    ...
    'The DNO for South West is National Grid Electricity Distribution (NGED). Any work that requires the meter to be pulled (e.g. tails upgrade) must be coordinated with the DNO or a metal-seal-cutting service.',
  ],
  sections: [
    {
      id: 'typical-prices',
      heading: 'Typical Consumer Unit Replacement Prices in Swindon (2026)',
      tocLabel: 'Typical prices',
      blocks: [
        {
          type: 'paragraph',
          text: 'These are working prices for Swindon based on competent-person scheme members in the area, current copper / steel pricing, and typical labour. Each scenario assumes a same-day swap with no unexpected remedial work.',
        },
        {
          type: 'list',
          ordered: false,
          items: [
            'Small property (1-bed flat or maisonette, 6–8 way board) — £398–491 including board, RCBOs, labour, EIC',
            'Standard 3-bed house (10–14 way all-RCBO board) — £468–750 (typical 4–6 hours on site)',
            'Larger 4-bed house (14–18 way board with SPD) — £750–900',
            'HMO or rented property (with AFDDs on relevant circuits) — £825–1050',
            'Three-phase domestic / light commercial board — £975–1350+ (priced on site)',
    ...
    },
    {
      ...
      blocks: [
        {
          type: 'paragraph',
          text: 'A compliant consumer unit replacement in Swindon should include all of the following — anything missing should be flagged in the quote:',
        },
        {
          type: 'list',
          ordered: false,
    ...
    },
    {
      ...
      blocks: [
        {
          type: 'paragraph',
          text: 'Beyond the board itself, six factors push the final Swindon price into the upper band:',
        },
        {
          type: 'list',
          ordered: true,
          items: [
            'Tails upgrade — if existing tails are < 25mm² or in poor condition, they must be replaced and coordinated with the DNO National Grid Electricity Distribution (NGED).',
    ...
    {
      id: 'for-electricians',
      heading: 'For Electricians: Quote CU Replacements in Swindon at the Right Price',
      tocLabel: 'For electricians',
      blocks: [
        {
          type: 'paragraph',
          text: 'If you are quoting consumer unit replacements in Swindon, the £468–750 band above is your fair-margin floor for a 10–14 way RCBO board with SPD, EIC and labour. Quoting below this band means you are absorbing the cost of your scheme fee, professional indemnity, calibrated test kit, and the certificate liability you sign. Use the bands as anchors, then adjust for: tails upgrade, bonding remedials, AFDDs (recommended in HMOs / certain residential under A4:2026), and any DNO coordination through National Grid Electricity Distribution (NGED).',
        },
        {
          type: 'callout',
          tone: 'info',
          ...
          body:
            'Elec-Mate gives Swindon electricians the tools to scan the existing board, generate an itemised quote with RCBOs, SPDs, AFDDs and labour, and issue the EIC on-site. 7-day free trial.',
        },
        {
          type: 'paragraph',
  ...
  faqs: [
    {
      question: 'How much does it cost to replace a consumer unit in Swindon?',
      answer: 'A typical 10–14 way domestic consumer unit replacement in Swindon costs £468–750 in 2026, including the new metal-clad board, all RCBOs, surge protection, labour and the EIC. Larger or HMO-spec boards push toward £900+.',
    },
    {
    ...
    },
    {
      ...
      answer: 'Sometimes — a competent person can add an RCD upstream of an existing board as a stop-gap. However if the board is old, plastic, or has missing labelling, the EICR will continue to flag observations. For most Swindon properties, a full replacement is the better long-term option.',
    },
  ],
  howToHeading: 'How to Book a Consumer Unit Replacement in Swindon',
  howToDescription:
  ...
  relatedPages: [
    ...
    {
      href: '/guides/consumer-unit-replacement-cost-oxford',
      title: 'Consumer unit replacement cost in Oxford',
      description: 'Local price bands and labour rates for Oxford.',
      icon: 'MapPin',
      category: 'Guide',
    },
    {
      href: '/guides/consumer-unit-replacement-cost-bristol',
      title: 'Consumer unit replacement cost in Bristol',
    ...
    {
      href: '/electricians/swindon',
      title: 'Find an Electrician in Swindon',
      description: 'Vetted scheme-registered electricians in Swindon.',
      icon: 'MapPin',
      category: 'Guide',
    },
    {
      href: '/guides/eicr-cost-swindon',
      title: 'EICR Cost in Swindon',
