...
// Apprentice revision page for City & Guilds 8202 Unit 307.
...
export const unitRevision8202Unit307Config: GeneratedGuideConfig = {
  ...
  breadcrumbLabel: 'Unit 307 Revision',
  heroPrefix: 'City & Guilds 8202 Unit 307:',
  heroHighlight: 'Requirements for electrical installations',
  heroSuffix: '— Complete Revision Guide',
  heroSubtitle:
    'A structured revision walkthrough of every topic in City & Guilds 8202 Unit 307 (Requirements for electrical installations). Use it as a personal study checklist — work through each topic, tick off the points you can confidently explain or calculate, and use the linked Elec-Mate tools to practice the calculation-led parts. Designed for T Level students taking the electrical installation specialism.',
  keyTakeaways: [
    'City & Guilds 8202 Unit 307 — Requirements for electrical installations — is a core component of the T Level in Building Services Engineering — Electrical Installation.',
    ...
    'Across the 5 topics there are 9 specific points you should be able to explain, demonstrate or calculate before the end-of-unit assessment.',
  ...
  sections: [
    {
      id: 'topic-1',
      heading: 'Topic 1: The fundamental principles and general assessments of BS 7671',
      tocLabel: 'Topic 1',
      blocks: [
        {
          type: 'paragraph',
        ...
        },
        {
          ...
          ordered: false,
          items: [
            'Learners will describe the scope and objective of the BS 7671 requirements for electrical installations..',
            'Learners will explain the fundamental principles of the BS 7671 requirements for electrical installations..',
            'Learners will explain and interpret the definitions used in BS 7671 and relate the definitions to the regulations and relevant appendices..',
            'Learners will interpret the requirements for assessing the general characteristics of electrical installations within the scope of BS 7671..',
          ],
        },
      ],
    },
    {
      id: 'topic-2',
      heading: 'Topic 2: The protective measures given in BS 7671',
      tocLabel: 'Topic 2',
      blocks: [
        {
          type: 'paragraph',
        ...
        },
        {
          ...
          ordered: false,
          items: [
            'Learners will identify the requirements of protection for safety within the scope of BS 7671 and interpret how requirements for safety apply to electrical installations within the scope of BS 7671 to include:.',
          ],
        },
      ],
    },
    {
      id: 'topic-3',
      heading: 'Topic 3: The requirements for selection and erection of BS 7671',
      tocLabel: 'Topic 3',
      blocks: [
        {
          type: 'paragraph',
        ...
        },
        {
          ...
          ordered: false,
          items: [
            'Learners will identify the requirements for selecting and erecting equipment, within the scope of BS 7671 and interpret how they apply to electrical installations within the scope of BS 7671 to include:.',
          ],
        },
      ],
    },
    {
      id: 'topic-4',
      heading: 'Topic 4: The requirements for inspection and testing in BS 7671',
      tocLabel: 'Topic 4',
      blocks: [
        {
          type: 'paragraph',
        ...
        },
        {
          ...
          ordered: false,
          items: [
            'Learners will identify the requirements in BS 7671 for inspection and testing and interpret how this applies to electrical installation..',
          ],
        },
      ],
    },
    {
      id: 'topic-5',
      heading: 'Topic 5: The requirements for special locations and information within appendices of BS 7671',
      tocLabel: 'Topic 5',
      blocks: [
        {
          type: 'paragraph',
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          body:
            'The Elec-Mate apprentice tier includes mock exams, flashcards, and revision notes for City & Guilds 8202 Unit 307 plus every other unit in your qualification. 7-day free trial — see your progress on the tutor dashboard.',
        },
      ],
    },
  ],
  faqs: [
    {
      question: 'What does City & Guilds 8202 Unit 307 cover?',
      answer: 'Unit 307 (Requirements for electrical installations) covers 5 main topic areas: The fundamental principles and general assessments of BS 7671; The protective measures given in BS 7671; The requirements for selection and erection of BS 7671; The requirements for inspection and testing in BS 7671; The requirements for special locations and information within appendices of BS 7671. Each topic has specific points you should be able to explain, demonstrate or calculate.',
    },
    {
  ...
  ctaHeading: 'For Apprentices: Pass City & Guilds 8202 Unit 307 with Confidence',
  ctaSubheading:
