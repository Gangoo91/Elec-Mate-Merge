...
// Programmatically generated EICR cost landing page for Portsmouth.
...
export const eicrCostPortsmouthConfig: GeneratedGuideConfig = {
  pagePath: '/guides/eicr-cost-portsmouth',
  title: 'EICR Cost Portsmouth 2026 — Domestic & Commercial Pricing',
  description: 'How much does an EICR cost in Portsmouth? Fair-margin 2026 prices for scheme-registered electricians — £235–315 for a 1-bed, £360–490 for a 4-bed…',
  datePublished: published,
  dateModified: modified,
  readingTime: 7,
  badge: 'Cost Guide',
  badgeIcon: 'PoundSterling',
  breadcrumbLabel: 'EICR Cost in Portsmouth',
  breadcrumbParent: { label: 'EICR Cost UK', href: '/guides/eicr-cost-uk' },
  heroPrefix: 'EICR Cost in Portsmouth:',
  heroHighlight: '2026 Pricing Guide',
  heroSuffix: '— Domestic & Commercial',
  heroSubtitle:
    'Whether you are an electrician quoting EICRs in Portsmouth or a landlord trying to understand the market rate, this guide gives the fair-margin 2026 prices charged by NICEIC and NAPIT scheme-registered electricians, what is included, and why below-market quotes are usually missing something. Hourly rates for inspection work in Portsmouth run £60–£80, with a typical 3-bed terrace EICR landing at £290–395. Use it as a market-rate reference for your next quote, or as a buyer\u2019s guide to a fair price.',
  keyTakeaways: [
  ...
  sections: [
    {
      id: 'typical-prices',
      heading: 'Typical EICR Prices in Portsmouth (2026)',
      tocLabel: 'Typical prices',
      blocks: [
        {
          type: 'paragraph',
          text: 'Below is a working price guide for Portsmouth based on competent-person scheme members operating in the area, hourly rate aggregates, and competitor pricing. Prices exclude any remedial work, which is quoted separately.',
        },
        {
          type: 'list',
          ordered: false,
    ...
    },
    {
      ...
      blocks: [
        {
          type: 'paragraph',
          text: 'Six factors push an EICR price up or down within Portsmouth:',
        },
        {
          type: 'list',
          ordered: true,
    ...
    {
      id: 'when-required',
      heading: 'When You Need an EICR in Portsmouth',
    ...
    {
      id: 'for-electricians',
      heading: 'For Electricians: Quote EICRs in Portsmouth at the Right Price',
      tocLabel: 'For electricians',
      blocks: [
        {
          type: 'paragraph',
          text: 'If you are a self-employed electrician or small contractor working in Portsmouth, this page is your local market-rate reference. The £290–395 band for a 3-bed terrace EICR is the fair-margin floor for a scheme-registered electrician — quoting below it means you are undercutting yourself before you start. Use the figures above to anchor your own quoting, with adjustments for property complexity, accessibility, and your scheme + insurance overhead.',
        },
        {
          type: 'callout',
          tone: 'info',
          ...
          body:
            'Elec-Mate gives Portsmouth electricians voice-driven test entry, 16 certificate types, on-site Schedule of Test Results, and a professional PDF quote that the client cannot haggle. 7-day free trial — see how much faster you can quote and certify in your area.',
        },
        {
          type: 'paragraph',
    ...
    {
      id: 'get-a-quote',
      heading: 'For Property Owners: Booking an EICR in Portsmouth',
      tocLabel: 'For property owners',
      blocks: [
        {
          type: 'paragraph',
          text: 'If you are a landlord, owner or managing agent in Portsmouth looking for an EICR, Elec-Mate connects you to vetted competent-person scheme electricians. Send a brief — property type, postcode, last EICR date — and get a price from a local electrician. Most Portsmouth jobs are booked within 5–10 working days, with same-day availability typical for smaller properties or urgent landlord deadlines under the Electrical Safety Standards in the Private Rented Sector Regulations 2020.',
        },
        {
          type: 'paragraph',
  ...
  faqs: [
    ...
    {
      question: 'Can I get a same-day EICR in Portsmouth?',
      answer: 'Same-day or next-day EICRs are possible in Portsmouth for smaller properties (1–2 bed) where an electrician is local and a slot is available. Larger jobs typically require 5–10 working days lead time.',
    },
  ],
  howToHeading: 'How to Book an EICR in Portsmouth',
  howToDescription:
  ...
  howToSteps: [
    ...
    },
    {
      ...
      text: 'Use Elec-Mate to find vetted Portsmouth electricians, or check NICEIC / NAPIT directories directly. Avoid trader-aggregator sites that bid jobs out without checking competence.',
    },
    {
  ...
  relatedPages: [
    ...
    },
    {
      ...
      description: 'Local price bands and labour rates for Southampton.',
      icon: 'MapPin',
      category: 'Guide',
    },
    {
      ...
      description: 'Local price bands and labour rates for Brighton.',
      icon: 'MapPin',
      category: 'Guide',
    },
    {
      href: '/electricians/portsmouth',
      title: 'Find an Electrician in Portsmouth',
      description: 'Vetted scheme-registered electricians in Portsmouth.',
      icon: 'MapPin',
      category: 'Guide',
    },
    {
  ...
  ctaHeading: 'For Electricians: Quote and Certify EICRs in Portsmouth',
  ctaSubheading:
