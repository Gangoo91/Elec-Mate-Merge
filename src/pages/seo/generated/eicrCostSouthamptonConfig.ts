...
// Programmatically generated EICR cost landing page for Southampton.
...
export const eicrCostSouthamptonConfig: GeneratedGuideConfig = {
  pagePath: '/guides/eicr-cost-southampton',
  title: 'EICR Cost Southampton 2026 — Domestic & Commercial Pricing',
  description: 'How much does an EICR cost in Southampton? Fair-margin 2026 prices for scheme-registered electricians — £235–315 for a 1-bed, £360–490 for a 4-bed…',
  ...
  heroSubtitle:
    'Whether you are an electrician quoting EICRs in Southampton or a landlord trying to understand the market rate, this guide gives the fair-margin 2026 prices charged by NICEIC and NAPIT scheme-registered electricians, what is included, and why below-market quotes are usually missing something. Hourly rates for inspection work in Southampton run £60–£80, with a typical 3-bed terrace EICR landing at £290–395. Use it as a market-rate reference for your next quote, or as a buyer\u2019s guide to a fair price.',
  keyTakeaways: [
    'A 1-bed flat EICR in Southampton typically costs £235–315, a 3-bed terrace £290–395, and a 4-bed house £360–490 (2026 prices for a scheme-registered electrician, excluding remedial work).',
    'Commercial EICRs in Southampton are priced per socket / fitting — typically £17–25 per item, with minimum visit fees of £80–£120.',
    ...
    'Hourly rates for Southampton sit at £60–£80 because a NICEIC / NAPIT registered electrician carries professional indemnity insurance, scheme fees, calibrated test equipment (typically £1,200+ MFT), and is liable for the certificate they sign.',
  ...
  sections: [
    {
      id: 'typical-prices',
      heading: 'Typical EICR Prices in Southampton (2026)',
      tocLabel: 'Typical prices',
      blocks: [
        {
          type: 'paragraph',
          text: 'Below is a working price guide for Southampton based on competent-person scheme members operating in the area, hourly rate aggregates, and competitor pricing. Prices exclude any remedial work, which is quoted separately.',
        },
        {
          type: 'list',
          ordered: false,
          items: [
            '1-bedroom flat or maisonette — £235–315 (typically 1.5–2 hours on site)',
            '2-bedroom terrace — £290–375 (typically 2–3 hours)',
            '3-bedroom semi or terrace — £290–395 (typically 2.5–3.5 hours)',
            '4-bedroom detached — £360–490 (typically 3.5–5 hours)',
            '5+ bedroom / large houses — £564+ (priced on visit)',
            'Commercial property — £17–25 per socket / fitting with a minimum visit fee of £80–£120',
          ],
        },
        {
          type: 'callout',
    ...
    },
    {
      ...
      blocks: [
        {
          type: 'paragraph',
          text: 'Six factors push an EICR price up or down within Southampton:',
        },
        {
          type: 'list',
          ordered: true,
    ...
    {
      id: 'when-required',
      heading: 'When You Need an EICR in Southampton',
    ...
    {
      id: 'for-electricians',
      heading: 'For Electricians: Quote EICRs in Southampton at the Right Price',
      tocLabel: 'For electricians',
      blocks: [
        {
          type: 'paragraph',
          text: 'If you are a self-employed electrician or small contractor working in Southampton, this page is your local market-rate reference. The £290–395 band for a 3-bed terrace EICR is the fair-margin floor for a scheme-registered electrician — quoting below it means you are undercutting yourself before you start. Use the figures above to anchor your own quoting, with adjustments for property complexity, accessibility, and your scheme + insurance overhead.',
        },
        {
          type: 'callout',
          tone: 'info',
          ...
          body:
            'Elec-Mate gives Southampton electricians voice-driven test entry, 16 certificate types, on-site Schedule of Test Results, and a professional PDF quote that the client cannot haggle. 7-day free trial — see how much faster you can quote and certify in your area.',
        },
        {
          type: 'paragraph',
    ...
    {
      id: 'get-a-quote',
      heading: 'For Property Owners: Booking an EICR in Southampton',
      tocLabel: 'For property owners',
      blocks: [
        {
          type: 'paragraph',
          text: 'If you are a landlord, owner or managing agent in Southampton looking for an EICR, Elec-Mate connects you to vetted competent-person scheme electricians. Send a brief — property type, postcode, last EICR date — and get a price from a local electrician. Most Southampton jobs are booked within 5–10 working days, with same-day availability typical for smaller properties or urgent landlord deadlines under the Electrical Safety Standards in the Private Rented Sector Regulations 2020.',
        },
        {
          type: 'paragraph',
  ...
  faqs: [
    {
      question: 'How much does a standard EICR cost in Southampton?',
      answer: 'For a 3-bedroom property in Southampton the typical 2026 EICR price from a NICEIC or NAPIT scheme-registered electrician is £290–395, excluding any remedial work. Prices vary with property size, consumer unit condition, and number of circuits. Quotes substantially below this band usually mean the EIC certificate, RCD test sweep or insurance is missing — verify what is included.',
    },
    {
      question: 'How long is an EICR valid for in Southampton?',
    ...
    {
      question: 'Who can carry out an EICR in Southampton?',
    ...
    {
      question: 'Can I get a same-day EICR in Southampton?',
      answer: 'Same-day or next-day EICRs are possible in Southampton for smaller properties (1–2 bed) where an electrician is local and a slot is available. Larger jobs typically require 5–10 working days lead time.',
    },
  ],
  howToHeading: 'How to Book an EICR in Southampton',
  howToDescription:
  ...
  howToSteps: [
    ...
    },
    {
      ...
      text: 'Use Elec-Mate to find vetted Southampton electricians, or check NICEIC / NAPIT directories directly. Avoid trader-aggregator sites that bid jobs out without checking competence.',
    },
    {
  ...
  relatedPages: [
    {
      ...
      description: 'Vetted scheme-registered electricians in Southampton.',
      icon: 'MapPin',
      category: 'Guide',
    },
    {
  ...
  ctaHeading: 'For Electricians: Quote and Certify EICRs in Southampton',
  ctaSubheading:
