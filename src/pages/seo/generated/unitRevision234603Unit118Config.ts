...
// Apprentice revision page for City & Guilds 2346-03 Unit 118.
...
export const unitRevision234603Unit118Config: GeneratedGuideConfig = {
  ...
  breadcrumbLabel: 'Unit 118 Revision',
  heroPrefix: 'City & Guilds 2346-03 Unit 118:',
  heroHighlight: 'Termination and Connection of Conductors',
  heroSuffix: '— Complete Revision Guide',
  heroSubtitle:
    'A structured revision walkthrough of every topic in City & Guilds 2346-03 Unit 118 (Termination and Connection of Conductors). Use it as a personal study checklist — work through each topic, tick off the points you can confidently explain or calculate, and use the linked Elec-Mate tools to practice the calculation-led parts. Designed for experienced workers consolidating skills outside a formal apprenticeship.',
  keyTakeaways: [
    'City & Guilds 2346-03 Unit 118 — Termination and Connection of Conductors — is a core component of the Electrotechnical Experienced Worker Qualification.',
    ...
    'Across the 2 topics there are 7 specific points you should be able to explain, demonstrate or calculate before the end-of-unit assessment.',
  ...
  sections: [
    {
      id: 'topic-1',
      heading: 'Topic 1: Prepare to terminate and connect cables and conductors',
      tocLabel: 'Topic 1',
      blocks: [
        {
          type: 'paragraph',
        ...
        },
        {
          ...
          ordered: false,
          items: [
            'Evaluate and apply appropriate procedures to include: a. Selecting appropriate tools/equipment to enable termination and connection b. Adopting appropriate PPE c. Following a safe system of work (eg. risk assessment, method statement, permit to work procedure)..',
            'Assess and confirm it is safe to complete termination and connection in terms of: a. Checking for presence of supply/carrying out safe isolation b. Mechanical soundness of the electrical equipment to be connected to c. Checking for unsafe situations. UAN: Level: GLH: Endorsement by a sector or regulatory body: Aim: Assessment type: City & Guilds Level 3 Electrotechnical Experienced Worker Qualification (2346-03).',
          ],
        },
      ],
    },
    {
      id: 'topic-2',
      heading: 'Topic 2: Terminate and connect conductors and cables',
      tocLabel: 'Topic 2',
      blocks: [
        {
          type: 'paragraph',
        ...
        },
        {
          ...
          ordered: false,
          items: [
            'Terminate and connect cables and conductors in accordance with manufacturers instructions, BS 7671, and any relevant drawing or specification Assess five from the following: a. Single core (singles) b. Multicore insulated c. PVC - PVC flat profile cable d. MICC e. Fire performance f. SWA cable g. GSWB galvanised steel wire braid h. Data / PoE i. DC Cabling.',
            'Connect to electrical equipment in accordance with manufacturers instructions, BS 7671, and any relevant drawing or specification Assess five from the following: a. Isolators /switches b. Socket outlets c. Distribution-boards / consumer control units d. Luminaires e. Electric motors / motor control equipment f. Overcurrent protective devices g. Earthing terminals h. Control panels i. Data socket outlets or data connections j. Fire detection/alarm components k. Other appropriate equipment (such as: heating system components, fire detection components, smart camera, smart lighting or heating control) (N.B an individual smart lamp is not sufficient).',
            'Terminate and connect conductors, using appropriate methods Assess two from the following: a. Screwing b. Crimping c. Soldering d. Non-screw compression e. Insulation displacement..',
            ...
            'Ensure cables have appropriate identification in accordance with BS 7671 City & Guilds Level X Award/Certificate/Diploma in Xxxxxxx (XXXX-XX) 29.',
          ],
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          body:
            'The Elec-Mate apprentice tier includes mock exams, flashcards, and revision notes for City & Guilds 2346-03 Unit 118 plus every other unit in your qualification. 7-day free trial — see your progress on the tutor dashboard.',
        },
      ],
    },
  ],
  faqs: [
    {
      question: 'What does City & Guilds 2346-03 Unit 118 cover?',
      answer: 'Unit 118 (Termination and Connection of Conductors) covers 2 main topic areas: Prepare to terminate and connect cables and conductors; Terminate and connect conductors and cables. Each topic has specific points you should be able to explain, demonstrate or calculate.',
    },
    {
    ...
    },
    {
      ...
      answer: 'Unit 118 is one of several units that together make up the Electrotechnical Experienced Worker Qualification. Passing every unit and the end-point assessment (AM2 or equivalent) earns you the full qualification. Check the unit overview in our City & Guilds qualification hub for the full unit list.',
    },
  ],
  howToHeading: 'A Five-Step Revision Plan for This Unit',
  howToDescription:
    'A repeatable approach that works for City & Guilds 2346-03 Unit 118 and every other unit in your qualification.',
  howToSteps: [
    {
  ...
  ctaHeading: 'For Apprentices: Pass City & Guilds 2346-03 Unit 118 with Confidence',
  ctaSubheading:
