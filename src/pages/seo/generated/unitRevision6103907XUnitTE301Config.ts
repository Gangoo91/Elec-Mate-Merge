...
// Apprentice revision page for EAL Level 3 Unit TE3-01.
...
export const unitRevision6103907XUnitTE301Config: GeneratedGuideConfig = {
  ...
  breadcrumbLabel: 'Unit TE3-01 Revision',
  heroPrefix: 'EAL Level 3 Unit TE3-01:',
  heroHighlight: 'Health, Safety and Environmental Considerations',
  heroSuffix: '— Complete Revision Guide',
  heroSubtitle:
    'A structured revision walkthrough of every topic in EAL Level 3 Unit TE3-01 (Health, Safety and Environmental Considerations). Use it as a personal study checklist — work through each topic, tick off the points you can confidently explain or calculate, and use the linked Elec-Mate tools to practice the calculation-led parts. Designed for EAL Level 3 apprentices.',
  keyTakeaways: [
    'EAL Level 3 Unit TE3-01 — Health, Safety and Environmental Considerations — is a core component of the EAL Level 3 Electrotechnical Technical Occupational Entry qualification.',
    'This unit is typically delivered to EAL Level 3 apprentices and covers 3 main topic areas.',
    'Across the 3 topics there are 7 specific points you should be able to explain, demonstrate or calculate before the end-of-unit assessment.',
  ...
  sections: [
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          ordered: false,
          items: [
            'Explain factors which can constitute a hazard in the workplace.',
            'State the procedures that should be followed in the case of.',
            'Describe how the environment may be affected by work activities.',
          ],
        },
      ],
    },
    {
      id: 'topic-3',
      heading: 'Topic 3: How to establish a safe working environment',
      tocLabel: 'Topic 3',
      blocks: [
        {
          type: 'paragraph',
        ...
        },
        {
          ...
          ordered: false,
          items: [
            'Produce a risk assessment and method statements in accordance with own level of responsibility.',
            'Demonstrate the safe practices and procedures for the use of equipment and materials.',
          ],
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          body:
            'The Elec-Mate apprentice tier includes mock exams, flashcards, and revision notes for EAL Level 3 Unit TE3-01 plus every other unit in your qualification. 7-day free trial — see your progress on the tutor dashboard.',
        },
      ],
    },
  ],
  faqs: [
    {
      question: 'What does EAL Level 3 Unit TE3-01 cover?',
      answer: 'Unit TE3-01 (Health, Safety and Environmental Considerations) covers 3 main topic areas: Relevant legislation applies in the workplace; The procedures for dealing with environmental and health and safety situations in the work environment; How to establish a safe working environment. Each topic has specific points you should be able to explain, demonstrate or calculate.',
    },
    {
    ...
    },
    {
      ...
      answer: 'EAL Level 3 Electrotechnical Technical Occupational Entry qualification units are typically delivered across the apprenticeship in college-block weeks. Unit TE3-01 is usually delivered to EAL Level 3 apprentices. Check your individual learning plan with your tutor for exact timing.',
    },
    {
  ...
  ctaHeading: 'For Apprentices: Pass EAL Level 3 Unit TE3-01 with Confidence',
  ctaSubheading:
