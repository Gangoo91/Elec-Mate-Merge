...
// Apprentice revision page for City & Guilds 5357 Unit 107.
...
export const unitRevision5357Unit107Config: GeneratedGuideConfig = {
  ...
  breadcrumbLabel: 'Unit 107 Revision',
  heroPrefix: 'City & Guilds 5357 Unit 107:',
  heroHighlight: 'Understand Terminations and Connections of Conductors',
  heroSuffix: '— Complete Revision Guide',
  heroSubtitle:
    'A structured revision walkthrough of every topic in City & Guilds 5357 Unit 107 (Understand Terminations and Connections of Conductors). Use it as a personal study checklist — work through each topic, tick off the points you can confidently explain or calculate, and use the linked Elec-Mate tools to practice the calculation-led parts. Designed for electrotechnical apprentices on the apprenticeship standard.',
  keyTakeaways: [
    'City & Guilds 5357 Unit 107 — Understand Terminations and Connections of Conductors — is a core component of the Level 3 Electrotechnical Qualification (Apprenticeship Standard).',
  ...
  sections: [
    {
      id: 'topic-1',
      heading: 'Topic 1: The regulatory requirements and procedures for terminating and connecting conductors and cables in electrical wiring systems and equipment',
      tocLabel: 'Topic 1',
      blocks: [
        {
          type: 'paragraph',
        ...
        },
        {
          ...
          items: [
            ...
            'Describe methods and procedures appropriate to the installation environment to ensure the safe and effective termination and connection of conductors and cables in electrical wiring systems and equipment.',
          ],
        },
      ],
    },
    {
      id: 'topic-2',
      heading: 'Topic 2: The procedures and applications of different methods of terminating, connecting and supporting conductors and cables in electrical wiring systems and equipment',
      tocLabel: 'Topic 2',
      blocks: [
        {
          type: 'paragraph',
        ...
        },
        {
          ...
          ordered: false,
          items: [
            'Explain the advantages, limitations and applications of the following connection methods: a. screw b. crimped c. soldered d. non-screw compression e. insulation displacement. f. compact lever g. DC rated terminals..',
            ...
            'Interpret and apply the techniques and methods for the safe and effective termination and connection of: a. flexible cables b. single and multicore thermoplastic (PVC) and thermosetting insulated cables c. PVC/PVC flat profile cable d. MICC e. SWA cables f. Galvanised steel wire braid g. data cables h. fire performance cable i. DC cables.',
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          body:
            'The Elec-Mate apprentice tier includes mock exams, flashcards, and revision notes for City & Guilds 5357 Unit 107 plus every other unit in your qualification. 7-day free trial — see your progress on the tutor dashboard.',
        },
      ],
    },
  ],
  ...
  ctaHeading: 'For Apprentices: Pass City & Guilds 5357 Unit 107 with Confidence',
  ctaSubheading:
