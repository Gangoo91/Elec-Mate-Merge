...
// Electrical business owner / employer guide. Audience: self-employed electricians and small electrical business owners.
...
export const ElectricalContractorMarketingGuideConfig: GeneratedGuideConfig = {
  ...
  badgeIcon: 'Briefcase',
  breadcrumbLabel: 'Electrical Contractor Marketing ...',
  heroPrefix: 'Electrical Contractor Marketing — How to Get Customers:',
  heroHighlight: 'Practical 2026 Guide',
  heroSuffix: '— For UK Electrical Contractors',
  heroSubtitle:
    'A practical 2026 marketing playbook for UK electrical contractors. What channels work, what they cost, what to expect for first-12-months results, and how to balance paid platforms against organic local presence. This guide is for self-employed electricians and small electrical business owners.',
  keyTakeaways: [
  ...
  faqs: [
    {
      ...
      answer: 'This guide is written for self-employed electricians and small electrical business owners. The advice is practical, UK-specific, and based on 2026 regulations and market rates.',
    },
    {
