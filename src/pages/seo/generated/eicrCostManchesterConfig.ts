...
// Programmatically generated EICR cost landing page for Manchester.
...
export const eicrCostManchesterConfig: GeneratedGuideConfig = {
  pagePath: '/guides/eicr-cost-manchester',
  title: 'EICR Cost Manchester 2026 — Domestic & Commercial Pricing',
  description: 'How much does an EICR cost in Manchester? Fair-margin 2026 prices for scheme-registered electricians — £220–290 for a 1-bed, £340–460 for a 4-bed…',
  datePublished: published,
  dateModified: modified,
  readingTime: 7,
  badge: 'Cost Guide',
  badgeIcon: 'PoundSterling',
  breadcrumbLabel: 'EICR Cost in Manchester',
  heroPrefix: 'EICR Cost in Manchester:',
  heroHighlight: '2026 Pricing Guide',
  heroSuffix: '— Domestic & Commercial',
  heroSubtitle:
    'Whether you are an electrician quoting EICRs in Manchester or a landlord trying to understand the market rate, this guide gives the fair-margin 2026 prices charged by NICEIC and NAPIT scheme-registered electricians, what is included, and why below-market quotes are usually missing something. Hourly rates for inspection work in Manchester run £55–£75, with a typical 3-bed terrace EICR landing at £270–360. Use it as a market-rate reference for your next quote, or as a buyer\u2019s guide to a fair price.',
  keyTakeaways: [
    'A 1-bed flat EICR in Manchester typically costs £220–290, a 3-bed terrace £270–360, and a 4-bed house £340–460 (2026 prices for a scheme-registered electrician, excluding remedial work).',
    'Commercial EICRs in Manchester are priced per socket / fitting — typically £16–24 per item, with minimum visit fees of £75–£113.',
    ...
    'Hourly rates for Manchester sit at £55–£75 because a NICEIC / NAPIT registered electrician carries professional indemnity insurance, scheme fees, calibrated test equipment (typically £1,200+ MFT), and is liable for the certificate they sign.',
    ...
    'North West\u2019s DNO is Electricity North West. Any remedial work involving DNO notification (PME, supply upgrades) routes through them.',
  ...
  sections: [
    {
      id: 'typical-prices',
      heading: 'Typical EICR Prices in Manchester (2026)',
      tocLabel: 'Typical prices',
      blocks: [
        {
          type: 'paragraph',
          text: 'Below is a working price guide for Manchester based on competent-person scheme members operating in the area, hourly rate aggregates, and competitor pricing. Prices exclude any remedial work, which is quoted separately.',
        },
        {
          type: 'list',
          ordered: false,
          items: [
            ...
            '4-bedroom detached — £340–460 (typically 3.5–5 hours)',
            '5+ bedroom / large houses — £529+ (priced on visit)',
    ...
    },
    {
      ...
      blocks: [
        {
          type: 'paragraph',
          text: 'Six factors push an EICR price up or down within Manchester:',
        },
        {
          type: 'list',
          ordered: true,
    ...
    {
      id: 'when-required',
      heading: 'When You Need an EICR in Manchester',
      tocLabel: 'When required',
      blocks: [
        {
          type: 'paragraph',
          text: 'EICRs are mandatory in several scenarios under UK regulation, regardless of North West location:',
        },
        {
          type: 'list',
          ordered: false,
    ...
    {
      id: 'for-electricians',
      heading: 'For Electricians: Quote EICRs in Manchester at the Right Price',
      tocLabel: 'For electricians',
      blocks: [
        {
          type: 'paragraph',
          text: 'If you are a self-employed electrician or small contractor working in Manchester, this page is your local market-rate reference. The £270–360 band for a 3-bed terrace EICR is the fair-margin floor for a scheme-registered electrician — quoting below it means you are undercutting yourself before you start. Use the figures above to anchor your own quoting, with adjustments for property complexity, accessibility, and your scheme + insurance overhead.',
        },
        {
          type: 'callout',
          tone: 'info',
          ...
          body:
            'Elec-Mate gives Manchester electricians voice-driven test entry, 16 certificate types, on-site Schedule of Test Results, and a professional PDF quote that the client cannot haggle. 7-day free trial — see how much faster you can quote and certify in your area.',
        },
        {
          type: 'paragraph',
  ...
  faqs: [
    {
      question: 'How much does a standard EICR cost in Manchester?',
      answer: 'For a 3-bedroom property in Manchester the typical 2026 EICR price from a NICEIC or NAPIT scheme-registered electrician is £270–360, excluding any remedial work. Prices vary with property size, consumer unit condition, and number of circuits. Quotes substantially below this band usually mean the EIC certificate, RCD test sweep or insurance is missing — verify what is included.',
    },
    {
      question: 'How long is an EICR valid for in Manchester?',
    ...
    {
      question: 'Who can carry out an EICR in Manchester?',
    ...
    {
      question: 'Can I get a same-day EICR in Manchester?',
      answer: 'Same-day or next-day EICRs are possible in Manchester for smaller properties (1–2 bed) where an electrician is local and a slot is available. Larger jobs typically require 5–10 working days lead time.',
    },
  ],
  howToHeading: 'How to Book an EICR in Manchester',
  howToDescription:
  ...
  howToSteps: [
    ...
    },
    {
      ...
      text: 'Use Elec-Mate to find vetted Manchester electricians, or check NICEIC / NAPIT directories directly. Avoid trader-aggregator sites that bid jobs out without checking competence.',
    },
    {
  ...
  relatedPages: [
    {
      href: '/electricians/manchester',
      title: 'Find an Electrician in Manchester',
      description: 'Vetted scheme-registered electricians in Manchester.',
      icon: 'MapPin',
      category: 'Guide',
    },
    {
  ...
  ctaHeading: 'For Electricians: Quote and Certify EICRs in Manchester',
  ctaSubheading:
