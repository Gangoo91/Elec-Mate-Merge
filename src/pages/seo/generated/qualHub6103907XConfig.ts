...
// Qualification hub for EAL Level 3. Pillar page that lists every unit
...
export const qualHub6103907XConfig: GeneratedGuideConfig = {
  ...
  breadcrumbLabel: 'EAL Level 3 Hub',
  heroPrefix: 'EAL Level 3:',
  heroHighlight: 'EAL Level 3 Electrotechnical Technical Occupational Entry qualification',
  heroSuffix: '— Complete 2026 Guide',
  heroSubtitle:
    'A complete guide to EAL Level 3 (EAL Level 3 Electrotechnical Technical Occupational Entry qualification). Designed for EAL Level 3 apprentices (alternative to C&G 5357). This hub indexes every unit with a direct link to its revision page, plus structure, end-point, duration and funding — everything you need to plan your study.',
  keyTakeaways: [
    'Level: Level 3 — awarded by EAL — regulated by Ofqual.',
    'Designed for: EAL Level 3 apprentices (alternative to C&G 5357).',
  ...
  sections: [
    {
      ...
      blocks: [
        {
          type: 'paragraph',
          text: 'EAL Level 3 (EAL Level 3 Electrotechnical Technical Occupational Entry qualification) is a Level 3 qualification awarded by EAL and regulated by Ofqual. It is designed for EAL Level 3 apprentices (alternative to C&G 5357) and typically runs 3-4 years.',
        },
        {
          type: 'paragraph',
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          ordered: true,
          items: [
            'Unit 18ED3-02 — Understand the Requirements of Electrical Installations BS 7671:2018 (2022) (17 topic points).',
            'Unit TE3-01 — Health, Safety and Environmental Considerations (7 topic points).',
            'Unit TE3-03 — Practices and Procedures for Planning and Overseeing Electrical Work Activities (14 topic points).',
            'Unit TE3-04 — Design and Installation Practices and Procedures (45 topic points).',
            'Unit TE3-06 — Practices and Procedures for Inspection, Testing and Commissioning (10 topic points).',
            'Unit TE3-07 — Practices and Procedures for Fault for Diagnosis and Rectification (19 topic points).',
            'Unit TE3-08 — Electrical Scientific Principles (33 topic points).',
          ],
        },
      ],
    },
    ...
    },
    {
      ...
      heading: 'Study EAL Level 3 With Elec-Mate',
      tocLabel: 'Study with Elec-Mate',
      blocks: [
        {
          type: 'paragraph',
          text: 'The Elec-Mate apprentice tier covers every unit in EAL Level 3 with mock exams, flashcards, revision notes, and OJT (off-the-job) hour tracking. Tutors get a dashboard showing every apprentice\u2019s progress in real time.',
        },
        {
          type: 'callout',
          tone: 'info',
          ...
          body:
            '7-day free trial of the Elec-Mate apprentice tier. Specify EAL Level 3 on signup and the dashboard tailors to your specific units.',
        },
      ],
    },
  ],
  faqs: [
    {
      question: 'How long does EAL Level 3 take?',
      answer: 'EAL Level 3 typically takes 3-4 years to complete. Time depends on whether you are full-time at college, part-time alongside on-the-job work, or an adult learner self-funding.',
    },
    {
      question: 'Who is EAL Level 3 for?',
      answer: 'EAL Level 3 is designed for EAL Level 3 apprentices (alternative to C&G 5357). Confirm with your training provider that this is the right pathway for your situation before enrolling.',
    },
    {
    ...
    {
      question: 'Can I revise for EAL Level 3 on my phone?',
      answer: 'Yes — Elec-Mate\u2019s apprentice tier covers every EAL Level 3 unit with mobile-friendly revision content, mock exams, and flashcards. 7-day free trial.',
    },
  ],
  howToHeading: 'How to Get the Most Out of EAL Level 3',
  howToDescription:
  ...
  ctaHeading: 'Study EAL Level 3 With Confidence',
  ctaSubheading:
