...
// Apprentice revision page for EAL NETP3 Unit ETKP3-05.
...
export const unitRevisionEALNETP3UnitETKP305Config: GeneratedGuideConfig = {
  ...
  breadcrumbLabel: 'Unit ETKP3-05 Revision',
  heroPrefix: 'EAL NETP3 Unit ETKP3-05:',
  heroHighlight: 'Terminate and Connect Conductors',
  heroSuffix: '— Complete Revision Guide',
  heroSubtitle:
    'A structured revision walkthrough of every topic in EAL NETP3 Unit ETKP3-05 (Terminate and Connect Conductors). Use it as a personal study checklist — work through each topic, tick off the points you can confidently explain or calculate, and use the linked Elec-Mate tools to practice the calculation-led parts. Designed for apprentices and adult learners on the EAL NVQ pathway.',
  keyTakeaways: [
    'EAL NETP3 Unit ETKP3-05 — Terminate and Connect Conductors — is a core component of the EAL Level 3 NVQ in Electrotechnical Practice.',
    'This unit is typically delivered to apprentices and adult learners on the EAL NVQ pathway and covers 2 main topic areas.',
  ...
  sections: [
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          ordered: false,
          items: [
            'Evaluate and apply appropriate procedures including selecting appropriate tools, adopting PPE, and following a safe system of work.',
            'Assess and confirm it is safe to complete termination including checking for supply/safe isolation, mechanical soundness, and unsafe situations.',
          ],
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          ordered: false,
          items: [
            'Terminate and connect cables including single core, multicore, PVC flat profile, MICC, fire performance, SWA, GSWB, and data cable.',
            'Connect to electrical equipment including isolators, socket outlets, distribution boards, luminaires, motors, overcurrent devices, earthing terminals, control panels, data connections, fire alarm components.',
            'Terminate and connect conductors using appropriate methods including screwing, crimping, soldering, non-screw compression, and insulation displacement.',
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          body:
            'The Elec-Mate apprentice tier includes mock exams, flashcards, and revision notes for EAL NETP3 Unit ETKP3-05 plus every other unit in your qualification. 7-day free trial — see your progress on the tutor dashboard.',
        },
      ],
    },
  ],
  faqs: [
    {
      question: 'What does EAL NETP3 Unit ETKP3-05 cover?',
      answer: 'Unit ETKP3-05 (Terminate and Connect Conductors) covers 2 main topic areas: Prepare to terminate and connect cables and conductors; Terminate and connect conductors and cables. Each topic has specific points you should be able to explain, demonstrate or calculate.',
    },
    {
    ...
    },
    {
      ...
      answer: 'EAL Level 3 NVQ in Electrotechnical Practice units are typically delivered across the apprenticeship in college-block weeks. Unit ETKP3-05 is usually delivered to apprentices and adult learners on the EAL NVQ pathway. Check your individual learning plan with your tutor for exact timing.',
    },
    {
    ...
    },
    {
      ...
      answer: 'Unit ETKP3-05 is one of several units that together make up the EAL Level 3 NVQ in Electrotechnical Practice. Passing every unit and the end-point assessment (AM2 or equivalent) earns you the full qualification. Check the unit overview in our City & Guilds qualification hub for the full unit list.',
    },
  ],
  howToHeading: 'A Five-Step Revision Plan for This Unit',
  howToDescription:
    'A repeatable approach that works for EAL NETP3 Unit ETKP3-05 and every other unit in your qualification.',
  howToSteps: [
    {
  ...
  ctaHeading: 'For Apprentices: Pass EAL NETP3 Unit ETKP3-05 with Confidence',
  ctaSubheading:
