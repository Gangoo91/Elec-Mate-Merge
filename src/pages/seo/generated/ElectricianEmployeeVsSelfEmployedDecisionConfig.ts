...
// Electrical business owner / employer guide. Audience: qualified electricians weighing up going self-employed vs staying on PAYE.
...
export const ElectricianEmployeeVsSelfEmployedDecisionConfig: GeneratedGuideConfig = {
  ...
  badgeIcon: 'Briefcase',
  breadcrumbLabel: 'Employee vs Self-Employed Electr...',
  heroPrefix: 'Employee vs Self-Employed Electrician — Which Is Right?:',
  heroHighlight: 'Practical 2026 Guide',
  heroSuffix: '— For UK Electrical Contractors',
  heroSubtitle:
    'A clear-eyed 2026 decision guide for UK electricians choosing between PAYE employee and self-employed (sole trader or limited company). Covers earnings, security, scope of work, lifestyle trade-offs and the realistic transition path. This guide is for qualified electricians weighing up going self-employed vs staying on PAYE.',
  keyTakeaways: [
  ...
  faqs: [
    {
      ...
      answer: 'This guide is written for qualified electricians weighing up going self-employed vs staying on PAYE. The advice is practical, UK-specific, and based on 2026 regulations and market rates.',
    },
    {
