...
// Apprentice revision page for City & Guilds 5357 Unit 118.
...
export const unitRevision5357Unit118Config: GeneratedGuideConfig = {
  pagePath: '/guides/5357-unit-118-termination-and-connection-of-conductors-revision',
  title: 'City & Guilds 5357 Unit 118 Revision Guide',
  description: 'Complete revision guide for City & Guilds 5357 Unit 118 (Termination and Connection of Conductors).',
  ...
  heroPrefix: 'City & Guilds 5357 Unit 118:',
  heroHighlight: 'Termination and Connection of Conductors',
  heroSuffix: '— Complete Revision Guide',
  heroSubtitle:
    'A structured revision walkthrough of every topic in City & Guilds 5357 Unit 118 (Termination and Connection of Conductors). Use it as a personal study checklist — work through each topic, tick off the points you can confidently explain or calculate, and use the linked Elec-Mate tools to practice the calculation-led parts. Designed for electrotechnical apprentices on the apprenticeship standard.',
  keyTakeaways: [
    'City & Guilds 5357 Unit 118 — Termination and Connection of Conductors — is a core component of the Level 3 Electrotechnical Qualification (Apprenticeship Standard).',
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            'Assess and confirm it is safe to complete termination and connection in terms of: a. Checking for presence of supply/carrying out safe isolation b. Mechanical soundness of the electrical equipment to be connected to c. Checking for unsafe situations..',
          ],
        },
      ],
    },
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          body:
            'The Elec-Mate apprentice tier includes mock exams, flashcards, and revision notes for City & Guilds 5357 Unit 118 plus every other unit in your qualification. 7-day free trial — see your progress on the tutor dashboard.',
        },
      ],
    },
  ],
  faqs: [
    {
      question: 'What does City & Guilds 5357 Unit 118 cover?',
  ...
  ctaHeading: 'For Apprentices: Pass City & Guilds 5357 Unit 118 with Confidence',
  ctaSubheading:
