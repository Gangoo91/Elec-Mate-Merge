...
export const OffTheJobTrainingEmployerGuideConfig: GeneratedGuideConfig = {
  ...
  badgeIcon: 'Briefcase',
  breadcrumbLabel: 'Off-The-Job Training for Electri...',
  heroPrefix: 'Off-The-Job Training for Electrical Employers:',
  ...
  sections: [
    {
      ...
      heading: 'Your Legal Obligation as Employer',
      tocLabel: 'Your Legal Obligation as ...',
      blocks: [
        {
          type: 'paragraph',
    ...
    },
    {
      ...
      heading: 'Activities That Qualify',
      tocLabel: 'Activities That Qualify',
      blocks: [
        {
          type: 'paragraph',
          text: 'College attendance (full days credited). Supervised learning of new skills on site — your senior electrician explicitly mentoring the apprentice on a new technique. CPD events. Manufacturer training (Hager, Schneider, NICEIC sessions). Online courses (scheme-led, technical). Time with the apprentice reviewing their NVQ portfolio. Reading technical material in supervised time. Bench / simulation practice in your workshop.',
        },
      ],
    },
    {
      id: 'non-qualifying-activities',
      heading: 'Activities That Don\u2019t Qualify',
      tocLabel: 'Activities That Don\u2019...',
      blocks: [
        {
          type: 'paragraph',
          text: 'Routine productive work the apprentice can already do. Lunch breaks. Travel time. Statutory holidays. Sick days. Time fixing the apprentice\u2019s own mistakes. Time at college that\u2019s not formal training (lunch breaks at college also don\u2019t count). Be conservative — over-claiming creates audit risk.',
        },
      ],
    },
    {
    ...
    {
      id: 'use-elec-mate-employer',
      heading: 'Use the Elec-Mate Employer Tier',
      tocLabel: 'Use the Elec-Mate Employe...',
      blocks: [
        {
          type: 'paragraph',
  ...
  faqs: [
    { question: 'Who is this guide for?', answer: 'This guide is written for electrical contractors and small business owners managing apprentice OTJ requirements. The advice is practical, UK-specific, and based on current 2026 regulations.' },
  ...
  relatedPages: [
    ...
    {
      href: '/guides/electrical-contractor-marketing-guide',
