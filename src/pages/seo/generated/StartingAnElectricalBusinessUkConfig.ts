...
// Electrical business owner / employer guide. Audience: qualified electricians ready to go self-employed or set up a limited company.
...
export const StartingAnElectricalBusinessUkConfig: GeneratedGuideConfig = {
  ...
  badgeIcon: 'Briefcase',
  breadcrumbLabel: 'Starting an Electrical Business ...',
  heroPrefix: 'Starting an Electrical Business in the UK:',
  heroHighlight: 'Practical 2026 Guide',
  heroSuffix: '— For UK Electrical Contractors',
  heroSubtitle:
    'A practical step-by-step guide to starting your own UK electrical business in 2026. Covers sole trader vs limited company, registering with HMRC, choosing a competent person scheme, insurance, first-jobs funding, and the realistic 12-month timeline from registration to break-even. This guide is for qualified electricians ready to go self-employed or set up a limited company.',
  keyTakeaways: [
  ...
  sections: [
    {
      ...
      tocLabel: 'Sole Trader vs Limited...',
      blocks: [
        {
          type: 'paragraph',
          text: 'Sole trader is faster to set up (free, HMRC self-assessment registration) but you are personally liable for every debt and claim. Limited company gives you liability protection, separates your personal finances, and is more tax-efficient above £30-40k profit — but it costs ~£200-400/year in accountancy. Most electricians start sole trader for year one then limit company when revenue justifies it.',
        },
      ],
    },
    {
      id: 'register',
      heading: 'Registration: HMRC + Companies House + CIS',
      tocLabel: 'Registration: HMRC + C...',
      blocks: [
        {
          type: 'paragraph',
          text: 'Register as self-employed with HMRC within 3 months of starting trading. If limiting a company, register with Companies House (£12 fee online). Apply for CIS (Construction Industry Scheme) registration before doing any sub-contract work — without it your contractors deduct 30% at source instead of 20%. Get a business bank account immediately — personal accounts mix transactions and complicate the tax return.',
        },
      ],
    },
    {
      id: 'scheme',
      heading: 'Competent Person Scheme: NICEIC / NAPIT / ELECSA / Stroma',
      tocLabel: 'Competent Person Schem...',
      blocks: [
        {
          type: 'paragraph',
          text: 'Scheme membership is the legal route to self-certify notifiable Part P work. The four main schemes (NICEIC, NAPIT, ELECSA, Stroma) are equivalent in industry recognition — pick on cost (~£500/year), local assessor availability, and which scheme your insurer recommends. Initial assessment requires a sample of certified work plus a desk audit of your QMS — give yourself 6-12 weeks lead time.',
        },
      ],
    },
    {
      id: 'insurance',
      heading: 'Insurance: PL + PI + Tools',
      tocLabel: 'Insurance: PL + PI + T...',
      blocks: [
        {
          type: 'paragraph',
          text: 'Three policies are essentially mandatory: Public Liability (£2-5m, ~£250-450/year), Professional Indemnity (£250k-1m, ~£200-400/year), Tools-in-Van (replacement cost, ~£100-300/year). Add Employers\u2019 Liability (£5m statutory minimum) if you ever hire anyone, even an apprentice. Get a quote from a broker that specialises in electrical contractors — generic tradesman policies often exclude scheme membership.',
        },
      ],
    },
    {
  ...
  faqs: [
    {
      ...
      answer: 'This guide is written for qualified electricians ready to go self-employed or set up a limited company. The advice is practical, UK-specific, and based on 2026 regulations and market rates.',
    },
    {
