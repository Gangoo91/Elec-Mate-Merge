...
export const poePlusPlusType4Config: GeneratedGuideConfig = {
  ...
  keyTakeaways: [
    ...
    'BS 7671:2018+A4:2026 applies to PoE installations where the cabling shares containment with mains, where it powers fixed building services (e.g. lighting), or where Section 715 ELV lighting applies. Type 4 PoE at 57V DC is ELV, not SELV-by-default — designer must declare.',
  ...
  sections: [
    {
      ...
      blocks: [
        ...
        },
        {
          type: 'paragraph',
          text:
            'The leap from Type 2 to Type 4 is large. It triples the deliverable power, doubles the number of conductors carrying current, and roughly doubles the heating effect inside the cable bundle. From an electrician\'s perspective, PoE Type 4 is the point at which Power over Ethernet stops being "just data" and becomes a small DC distribution system that needs proper design.',
        },
        {
          type: 'callout',
          tone: 'info',
          ...
          text:
            'You will see equipment marketed as "PoE++", "Hi-PoE", "Ultra PoE", "4PPoE", or "90W PoE". The underlying standard is IEEE 802.3bt. Always check the datasheet for the IEEE class number (Class 8 = 90W Type 4), not just the marketing label.',
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          text:
            'A PoE Type 4 PD must operate down to 41.1V DC at its input. If you measure 44V DC at a luminaire 90m from the switch under full load, that is by design — the IEEE 802.3bt voltage drop budget allows for it. Measure at the PSE and the PD; the difference is the cable voltage drop.',
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        },
        {
          type: 'paragraph',
          text:
            'With Gigabit Ethernet (1000BASE-T) and faster, all four pairs are used for data simultaneously. PoE Type 3 and Type 4 therefore had to define a way to share DC power on all four pairs while the same pairs still carry differential Ethernet signalling. The result is 4-pair power, often called 4PPoE: the DC supply is split across all four pairs, each carrying roughly a quarter of the total current.',
        },
        {
          type: 'list',
          items: [
      ...
      blocks: [
        {
          type: 'paragraph',
          text:
            'IEEE 802.3bt is written conservatively: it states that Type 3 and Type 4 will work over a Class D channel (Cat5e) up to 100m. In practice, UK installers should treat Cat6a as the realistic minimum for Type 4 90W operation, and reserve Cat5e only for the lowest power classes. The reason is heat.',
        },
        {
          type: 'paragraph',
          text:
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          text:
            'Sustained operation of an undersized bundle above the cable\'s rated temperature degrades the insulation polymer. Over years, this can lead to insulation breakdown, short-circuit between conductors, and arcing. The fire risk is low but real, especially in plenum and riser locations. Treat bundle planning with the same seriousness you treat grouping factors for mains cables under BS 7671.',
        },
      ],
    },
    {
      id: 'bs7671-applicability',
      heading: 'BS 7671 Section 715 Applicability to PoE Installations',
      tocLabel: 'BS 7671 Section 715',
      blocks: [
        {
          type: 'paragraph',
          text:
            'BS 7671:2018+A4:2026 (published 15 April 2026) applies to electrical installations including those operating at extra-low voltage (ELV). Type 4 PoE at 52–57V DC sits firmly in the ELV band (BS 7671 defines ELV as not exceeding 50V AC or 120V ripple-free DC, and PoE is well below the DC ceiling). The presence of mains-powered PSE upstream brings PoE within the broader scope of BS 7671 wherever it shares containment with low-voltage circuits or supplies fixed building services.',
        },
        {
          type: 'list',
          items: [
            'Section 715 of BS 7671 (Extra-low voltage lighting installations) applies where PoE is used to power luminaires. Designer must specify the ELV system type (SELV, PELV, FELV) and follow the Section 715 requirements for source isolation, segregation and identification.',
            ...
            'Section 444 (Measures against electromagnetic disturbances) applies to data-cable routing parallel to noisy LV cables (VFDs, lift motors, transformers).',
        ...
        },
        {
          type: 'paragraph',
          text:
            'For PoE-powered lighting in particular, see our dedicated [PoE lighting guide](/guides/poe-lighting-guide) and the [Section 715 ELV lighting A4:2026 update](/guides/section-715-elv-lighting-a4-2026) for the latest amendment-specific guidance.',
        },
        {
          type: 'callout',
          tone: 'info',
      ...
      blocks: [
        {
          type: 'paragraph',
          text:
            'Type 4 PoE is not for everything — for a single 9W ceiling pendant it is overkill. It earns its place in installations where centralised low-voltage DC distribution, single-cable convenience, network integration and remote management together justify the slightly higher infrastructure cost.',
        },
        {
          type: 'list',
          items: [
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          text:
            'A single unprotected outdoor camera cable, hit by a near-miss lightning strike, can put a transient onto every PoE port of the PSE switch and propagate further into the LAN. The cost of an in-line PoE SPD is trivial compared to a 48-port managed switch.',
        },
      ],
    },
    {
      ...
      blocks: [
        {
          type: 'paragraph',
          text:
            'Testing a PoE installation requires both BS 7671 verification of the LV supply to the PSE and structured-cabling certification of the PoE-carrying channels. These are two distinct exercises with two distinct sets of test equipment.',
        },
        {
          type: 'list',
          ordered: true,
        ...
        },
        {
          type: 'paragraph',
          text:
            'Many UK contractors split the work: an electrician handles the PSE supply and the BS 7671 certification, and a structured-cabling subcontractor handles the data cable certification. Where one contractor takes both, the documentation pack should include both certificates plus the PoE power test result.',
        },
      ],
    },
    {
      ...
      blocks: [
        {
          type: 'paragraph',
          text:
            'PoE Type 4 puts more current through each conductor than any previous PoE generation. That current passes through every termination: the IDC contacts at the patch panel, the RJ45 plug at each end, and the modular jack inside the PD. A poor termination at any of these points is a hot spot — and under Type 4 currents, hot spots can damage the contact, cause intermittent disconnections, and in worst cases arc on disconnect.',
        },
        {
          type: 'list',
          items: [
        ...
        },
        {
          ...
          text:
            'BS EN 50174 limits the untwisted length at terminations to 13mm for Cat6a. Under Type 4 current loads, exceeding this not only degrades NEXT and ACR-F (data parameters) but also concentrates current at the termination, raising local heating. Take the time to terminate properly.',
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            'BS 7671:2018+A4:2026 — Requirements for Electrical Installations (the 18th Edition Wiring Regulations as amended). See our overview at [BS 7671 Amendment 4 (2026)](/guides/bs-7671-amendment-4-2026).',
        ...
        },
        {
          type: 'paragraph',
          text:
            'For broader structured cabling context, see our [structured cabling and BS EN 50173 guide for electricians](/guides/structured-cabling-bs-en-50173-electricians) and the dedicated [BS EN 50174 data cable installation guide](/guides/bs-en-50174-data-cable-installation).',
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          text:
            'The PoE design tools sit alongside the BS 7671 calculator suite, the EIC and EICR tools, and the [Minor Works Certificate](/minor-works-certificate) generator. 7-day free trial, cancel anytime.',
        },
      ],
    },
  ],
  ...
  howToSteps: [
    {
      ...
      text:
        'Confirm the PD\'s IEEE 802.3bt class (typically Class 8 for 90W Type 4), measure the channel length end-to-end (patch + permanent link + patch), and confirm the channel will not exceed the 100m IEEE limit.',
    },
    {
      name: 'Select cable and connectors rated for Type 4',
      text:
        'Specify Cat6a as the baseline (solid copper, never CCA), with RJ45 plugs and modular jacks marked as 802.3bt-compatible. For outdoor or industrial environments, specify shielded Cat6a F/UTP with appropriate jacket rating.',
    },
    {
      name: 'Plan the bundle and containment for thermal headroom',
      text:
        'Limit bundles to 24 cables, use hook-and-loop ties rather than cable ties, prefer perforated tray with airflow, and de-rate further in plant rooms and risers above 30°C ambient.',
    },
    {
      name: 'Design the BS 7671 supply to the PSE',
      text:
        'Size the supply circuit to the PSE based on its nameplate rating, install appropriate circuit protection, fit a Type 2 SPD on the supply, and ensure segregation between the data cabling and any shared LV circuits per Section 528.',
    },
    {
      name: 'Terminate cleanly and test to BS EN 50346',
      text:
        'Untwist by less than 13mm at every termination, certify each permanent link with a Fluke / Viavi / TREND tester, and run the PoE class test option to confirm the channel sustains Type 4 current.',
    },
    {
      name: 'Energise, verify and document',
      text:
        'Power on the PSE, confirm the PD enumerates at the expected class, measure the PD input voltage under load, hand over the BS EN 50346 channel certificate alongside the BS 7671 EIC for the PSE supply circuit.',
    },
  ],
  faqs: [
    {
    ...
    },
    {
      ...
      answer:
        'BS 7671:2018+A4:2026 applies to PoE installations wherever they share containment with low-voltage circuits (Section 528 segregation), wherever they supply fixed building services such as lighting (Section 715), and to the full mains supply feeding the PSE. The PoE channel itself is ELV and outside the strict scope of BS 7671\'s circuit-design rules, but the designer cannot ignore BS 7671 — segregation, identification, source isolation and inspection and testing on the supply side all apply.',
    },
    {
  ...
  relatedPages: [
    ...
    },
    {
      ...
      description: 'The BS 7671:2018+A4:2026 update to extra-low voltage lighting installations, source isolation requirements and SELV/PELV declarations.',
      icon: 'BookOpen',
      category: 'Guide',
    },
    {
      ...
      description: 'The BS EN 50173 series for UK electricians — channel and link specifications, Cat5e through Cat8, and integration with BS 7671 installations.',
      icon: 'Cable',
      category: 'Guide',
    },
    {
      ...
      description: 'Installation rules for data cabling inside and outside buildings — segregation, bundle sizing, containment and remote-powering considerations.',
      icon: 'ClipboardCheck',
      category: 'Guide',
    },
    {
      ...
      description: 'Residential smart lighting design, including PoE-powered scenes, KNX, DALI and mesh wireless options for new builds and renovations.',
      icon: 'Home',
      category: 'Guide',
    },
    {
      ...
      description: 'Commercial lighting design under BS 7671 — load assessment, emergency lighting, controls, and where PoE-powered luminaires fit the brief.',
      icon: 'Building2',
      category: 'Guide',
    },
  ],
