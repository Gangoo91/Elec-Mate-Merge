...
// Apprentice revision page for City & Guilds 2365-03 Unit 201.
...
export const unitRevision236503Unit201Config: GeneratedGuideConfig = {
  ...
  heroPrefix: 'City & Guilds 2365-03 Unit 201:',
  heroHighlight: 'Health and safety in building services engineering',
  heroSuffix: '— Complete Revision Guide',
  heroSubtitle:
    'A structured revision walkthrough of every topic in City & Guilds 2365-03 Unit 201 (Health and safety in building services engineering). Use it as a personal study checklist — work through each topic, tick off the points you can confidently explain or calculate, and use the linked Elec-Mate tools to practice the calculation-led parts. Designed for 2nd to 4th-year apprentices.',
  keyTakeaways: [
    'City & Guilds 2365-03 Unit 201 — Health and safety in building services engineering — is a core component of the Level 3 Diploma in Electrical Installations.',
    'This unit is typically delivered to 2nd to 4th-year apprentices and covers 4 main topic areas.',
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          body:
            'The Elec-Mate apprentice tier includes mock exams, flashcards, and revision notes for City & Guilds 2365-03 Unit 201 plus every other unit in your qualification. 7-day free trial — see your progress on the tutor dashboard.',
        },
      ],
    },
  ],
  faqs: [
    {
      question: 'What does City & Guilds 2365-03 Unit 201 cover?',
    ...
    },
    {
      ...
      answer: 'Level 3 Diploma in Electrical Installations units are typically delivered across the apprenticeship in college-block weeks. Unit 201 is usually delivered to 2nd to 4th-year apprentices. Check your individual learning plan with your tutor for exact timing.',
    },
    {
    ...
    },
    {
      ...
      answer: 'Unit 201 is one of several units that together make up the Level 3 Diploma in Electrical Installations. Passing every unit and the end-point assessment (AM2 or equivalent) earns you the full qualification. Check the unit overview in our City & Guilds qualification hub for the full unit list.',
    },
  ],
  howToHeading: 'A Five-Step Revision Plan for This Unit',
  howToDescription:
    'A repeatable approach that works for City & Guilds 2365-03 Unit 201 and every other unit in your qualification.',
  howToSteps: [
    {
  ...
  ctaHeading: 'For Apprentices: Pass City & Guilds 2365-03 Unit 201 with Confidence',
  ctaSubheading:
