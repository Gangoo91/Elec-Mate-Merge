...
// Programmatically generated EICR cost landing page for Birmingham.
...
export const eicrCostBirminghamConfig: GeneratedGuideConfig = {
  ...
  breadcrumbLabel: 'EICR Cost in Birmingham',
  breadcrumbParent: { label: 'EICR Cost UK', href: '/guides/eicr-cost-uk' },
  heroPrefix: 'EICR Cost in Birmingham:',
  heroHighlight: '2026 Pricing Guide',
  heroSuffix: '— Domestic & Commercial',
  heroSubtitle:
    'Whether you are an electrician quoting EICRs in Birmingham or a landlord trying to understand the market rate, this guide gives the fair-margin 2026 prices charged by NICEIC and NAPIT scheme-registered electricians, what is included, and why below-market quotes are usually missing something. Hourly rates for inspection work in Birmingham run £60–£80, with a typical 3-bed terrace EICR landing at £290–390. Use it as a market-rate reference for your next quote, or as a buyer\u2019s guide to a fair price.',
  keyTakeaways: [
    'A 1-bed flat EICR in Birmingham typically costs £235–310, a 3-bed terrace £290–390, and a 4-bed house £360–490 (2026 prices for a scheme-registered electrician, excluding remedial work).',
    'Commercial EICRs in Birmingham are priced per socket / fitting — typically £17–25 per item, with minimum visit fees of £80–£120.',
    ...
    'Hourly rates for Birmingham sit at £60–£80 because a NICEIC / NAPIT registered electrician carries professional indemnity insurance, scheme fees, calibrated test equipment (typically £1,200+ MFT), and is liable for the certificate they sign.',
  ...
  sections: [
    {
      id: 'typical-prices',
      heading: 'Typical EICR Prices in Birmingham (2026)',
      tocLabel: 'Typical prices',
      blocks: [
        {
          type: 'paragraph',
          text: 'Below is a working price guide for Birmingham based on competent-person scheme members operating in the area, hourly rate aggregates, and competitor pricing. Prices exclude any remedial work, which is quoted separately.',
        },
        {
          type: 'list',
          ordered: false,
          items: [
            '1-bedroom flat or maisonette — £235–310 (typically 1.5–2 hours on site)',
            '2-bedroom terrace — £290–371 (typically 2–3 hours)',
            '3-bedroom semi or terrace — £290–390 (typically 2.5–3.5 hours)',
    ...
    },
    {
      ...
      blocks: [
        {
          type: 'paragraph',
          text: 'Six factors push an EICR price up or down within Birmingham:',
        },
        {
          type: 'list',
          ordered: true,
    ...
    {
      id: 'when-required',
      heading: 'When You Need an EICR in Birmingham',
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          body:
            'Elec-Mate gives Birmingham electricians voice-driven test entry, 16 certificate types, on-site Schedule of Test Results, and a professional PDF quote that the client cannot haggle. 7-day free trial — see how much faster you can quote and certify in your area.',
        },
        {
          type: 'paragraph',
  ...
  faqs: [
    {
      question: 'How much does a standard EICR cost in Birmingham?',
      answer: 'For a 3-bedroom property in Birmingham the typical 2026 EICR price from a NICEIC or NAPIT scheme-registered electrician is £290–390, excluding any remedial work. Prices vary with property size, consumer unit condition, and number of circuits. Quotes substantially below this band usually mean the EIC certificate, RCD test sweep or insurance is missing — verify what is included.',
    },
    {
      question: 'How long is an EICR valid for in Birmingham?',
    ...
    {
      question: 'Who can carry out an EICR in Birmingham?',
    ...
    {
      question: 'Can I get a same-day EICR in Birmingham?',
      answer: 'Same-day or next-day EICRs are possible in Birmingham for smaller properties (1–2 bed) where an electrician is local and a slot is available. Larger jobs typically require 5–10 working days lead time.',
    },
  ],
  howToHeading: 'How to Book an EICR in Birmingham',
  howToDescription:
  ...
  howToSteps: [
    ...
    },
    {
      ...
      text: 'Use Elec-Mate to find vetted Birmingham electricians, or check NICEIC / NAPIT directories directly. Avoid trader-aggregator sites that bid jobs out without checking competence.',
    },
    {
  ...
  relatedPages: [
    ...
    {
      href: '/electricians/birmingham',
      title: 'Find an Electrician in Birmingham',
      description: 'Vetted scheme-registered electricians in Birmingham.',
      icon: 'MapPin',
      category: 'Guide',
    },
    {
  ...
  ctaHeading: 'For Electricians: Quote and Certify EICRs in Birmingham',
  ctaSubheading:
