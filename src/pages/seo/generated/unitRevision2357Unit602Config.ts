...
// Apprentice revision page for City & Guilds 2357 Unit 602.
...
export const unitRevision2357Unit602Config: GeneratedGuideConfig = {
  ...
  breadcrumbLabel: 'Unit 602 Revision',
  heroPrefix: 'City & Guilds 2357 Unit 602:',
  heroHighlight: 'Understanding environmental legislation, working practices and the principles of environmental technology systems (ELTK 02)',
  heroSuffix: '— Complete Revision Guide',
  heroSubtitle:
    'A structured revision walkthrough of every topic in City & Guilds 2357 Unit 602 (Understanding environmental legislation, working practices and the principles of environmental technology systems (ELTK 02)). Use it as a personal study checklist — work through each topic, tick off the points you can confidently explain or calculate, and use the linked Elec-Mate tools to practice the calculation-led parts. Designed for apprentices working through an NVQ pathway with on-the-job portfolio evidence.',
  keyTakeaways: [
    'City & Guilds 2357 Unit 602 — Understanding environmental legislation, working practices and the principles of environmental technology systems (ELTK 02) — is a core component of the Level 3 NVQ Diploma in Installing Electrotechnical Systems and Equipment.',
  ...
  sections: [
    {
      id: 'topic-1',
      heading: 'Topic 1: The environmental legislation, working practices and principles which are relevant to work activities',
      tocLabel: 'Topic 1',
      blocks: [
        {
          type: 'paragraph',
        ...
        },
        {
          ...
          items: [
            ...
            'Identify and interpret the requirements for electrical installations as outlined in relevant sections of the Building Regulations and the Code for Sustainable Homes.',
            'State materials and products that are classed as: • hazardous to the environment • recyclable..',
            'Describe the organisational procedures for processing materials that are classed as: • hazardous to the environment • recyclable..',
          ],
        },
      ],
    },
    {
      id: 'topic-2',
      heading: 'Topic 2: How work methods and procedures can reduce material wastage and impact on the environment',
      tocLabel: 'Topic 2',
      blocks: [
        {
          type: 'paragraph',
        ...
        },
        {
          ...
          items: [
            ...
            'Specify environmentally friendly materials, products and procedures that can be used in the installation and maintenance of electrotechnical systems and equipment. 56 City & Guilds Level 3 Diplomas in Electrotechnical Technology (2357) Unit 602 Understanding environmental legislation, working practices and the principles of environmental technology systems (ELTK 02).',
          ],
        },
      ],
    },
    {
      id: 'topic-3',
      heading: 'Topic 3: How and where environmental technology systems can be applied',
      tocLabel: 'Topic 3',
      blocks: [
        {
          type: 'paragraph',
        ...
        },
        {
          ...
          items: [
            ...
            'State the Local Authority Building Control requirements which apply to the installation of environmental technology systems..',
          ],
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          body:
            'The Elec-Mate apprentice tier includes mock exams, flashcards, and revision notes for City & Guilds 2357 Unit 602 plus every other unit in your qualification. 7-day free trial — see your progress on the tutor dashboard.',
        },
      ],
    },
  ],
  faqs: [
    {
      question: 'What does City & Guilds 2357 Unit 602 cover?',
      answer: 'Unit 602 (Understanding environmental legislation, working practices and the principles of environmental technology systems (ELTK 02)) covers 3 main topic areas: The environmental legislation, working practices and principles which are relevant to work activities; How work methods and procedures can reduce material wastage and impact on the environment; How and where environmental technology systems can be applied. Each topic has specific points you should be able to explain, demonstrate or calculate.',
    },
    {
  ...
  ctaHeading: 'For Apprentices: Pass City & Guilds 2357 Unit 602 with Confidence',
  ctaSubheading:
