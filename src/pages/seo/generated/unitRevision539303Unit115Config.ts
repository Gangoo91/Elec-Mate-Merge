...
// Apprentice revision page for City & Guilds 5393-03 Unit 115.
...
export const unitRevision539303Unit115Config: GeneratedGuideConfig = {
  ...
  heroPrefix: 'City & Guilds 5393-03 Unit 115:',
  heroHighlight: 'Apply fault diagnosis and rectification in dwellings',
  heroSuffix: '— Complete Revision Guide',
  heroSubtitle:
    'A structured revision walkthrough of every topic in City & Guilds 5393-03 Unit 115 (Apply fault diagnosis and rectification in dwellings). Use it as a personal study checklist — work through each topic, tick off the points you can confidently explain or calculate, and use the linked Elec-Mate tools to practice the calculation-led parts. Designed for apprentices working primarily in domestic environments.',
  keyTakeaways: [
    'City & Guilds 5393-03 Unit 115 — Apply fault diagnosis and rectification in dwellings — is a core component of the Level 3 Electrotechnical (Dwellings).',
    'This unit is typically delivered to apprentices working primarily in domestic environments and covers 3 main topic areas.',
  ...
  sections: [
    {
      id: 'topic-1',
      heading: 'Topic 1: Prepare to carry out fault diagnosis in dwellings',
      tocLabel: 'Topic 1',
      blocks: [
        {
          type: 'paragraph',
        ...
        },
        {
          ...
          items: [
            ...
            'Apply appropriate methods to ensure the safety of themselves and others when diagnosing and correcting electrical faults.',
          ],
        },
      ],
    },
    {
      id: 'topic-2',
      heading: 'Topic 2: Carry out fault diagnosis in dwellings',
      tocLabel: 'Topic 2',
      blocks: [
        {
          type: 'paragraph',
        ...
        },
        {
          ...
          ordered: false,
          items: [
            'Communicate effectively with relevant personnel (eg customer) to ascertain the nature of the fault.',
            'Interpret documents which relate to the electrical systems and equipment being worked upon.',
            'Communicate potential disruption that may be a consequence of fault diagnosis and correction work to relevant people, to include: a. other workers/colleagues b. customers/clients.',
            ...
            'Perform suitable diagnostic tests, based on engineering decision, to identify electrical faults.',
            ...
            'Use appropriate instruments correctly to carry out fault diagnosis.',
          ],
        },
      ],
    },
    {
      id: 'topic-3',
      heading: 'Topic 3: Carry out fault rectification in dwellings',
      tocLabel: 'Topic 3',
      blocks: [
        {
          type: 'paragraph',
        ...
        },
        {
          ...
          ordered: false,
          items: [
            'Assess the appropriate repairs, removals and replacements and their implications with relevant people: other workers/colleagues, customers/clients.',
            'Perform fault correction procedures correctly and safely using appropriate tools, equipment and material.',
            'Verify that replacement components and associated equipment maintain: a. ease of access to enable future maintenance b. compliance with relevant regulations c. compliance with manufacturer\'s instructions/organisational procedures.',
            ...
            'Record test results and other information regarding the fault correction work clearly and accurately and report it to relevant people: other workers/colleagues, customers/clients, representatives of other services.',
          ],
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          body:
            'The Elec-Mate apprentice tier includes mock exams, flashcards, and revision notes for City & Guilds 5393-03 Unit 115 plus every other unit in your qualification. 7-day free trial — see your progress on the tutor dashboard.',
        },
      ],
    },
  ],
  faqs: [
    {
      question: 'What does City & Guilds 5393-03 Unit 115 cover?',
      answer: 'Unit 115 (Apply fault diagnosis and rectification in dwellings) covers 3 main topic areas: Prepare to carry out fault diagnosis in dwellings; Carry out fault diagnosis in dwellings; Carry out fault rectification in dwellings. Each topic has specific points you should be able to explain, demonstrate or calculate.',
    },
    {
    ...
    },
    {
      ...
      answer: 'Level 3 Electrotechnical (Dwellings) units are typically delivered across the apprenticeship in college-block weeks. Unit 115 is usually delivered to apprentices working primarily in domestic environments. Check your individual learning plan with your tutor for exact timing.',
    },
    {
    ...
    },
    {
      ...
      answer: 'Unit 115 is one of several units that together make up the Level 3 Electrotechnical (Dwellings). Passing every unit and the end-point assessment (AM2 or equivalent) earns you the full qualification. Check the unit overview in our City & Guilds qualification hub for the full unit list.',
    },
  ],
  howToHeading: 'A Five-Step Revision Plan for This Unit',
  howToDescription:
    'A repeatable approach that works for City & Guilds 5393-03 Unit 115 and every other unit in your qualification.',
  howToSteps: [
    {
  ...
  ctaHeading: 'For Apprentices: Pass City & Guilds 5393-03 Unit 115 with Confidence',
  ctaSubheading:
