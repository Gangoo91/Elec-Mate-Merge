...
// Apprentice revision page for City & Guilds 2357 Unit 311.
...
export const unitRevision2357Unit311Config: GeneratedGuideConfig = {
  ...
  breadcrumbLabel: 'Unit 311 Revision',
  heroPrefix: 'City & Guilds 2357 Unit 311:',
  heroHighlight: 'Applying Health and Safety legislation and working practices (installing and maintaining electrotechnical systems and equipment) (ELTP01)',
  heroSuffix: '— Complete Revision Guide',
  heroSubtitle:
    'A structured revision walkthrough of every topic in City & Guilds 2357 Unit 311 (Applying Health and Safety legislation and working practices (installing and maintaining electrotechnical systems and equipment) (ELTP01)). Use it as a personal study checklist — work through each topic, tick off the points you can confidently explain or calculate, and use the linked Elec-Mate tools to practice the calculation-led parts. Designed for apprentices working through an NVQ pathway with on-the-job portfolio evidence.',
  keyTakeaways: [
    'City & Guilds 2357 Unit 311 — Applying Health and Safety legislation and working practices (installing and maintaining electrotechnical systems and equipment) (ELTP01) — is a core component of the Level 3 NVQ Diploma in Installing Electrotechnical Systems and Equipment.',
    ...
    'Across the 4 topics there are 14 specific points you should be able to explain, demonstrate or calculate before the end-of-unit assessment.',
  ...
  sections: [
    {
      id: 'topic-1',
      heading: 'Topic 1: How to apply relevant Health and Safety legislation in the workplace',
      tocLabel: 'Topic 1',
      blocks: [
        {
          type: 'paragraph',
        ...
        },
        {
          ...
          items: [
            ...
            'Work within the requirements of: • risk assessments • method statements • safe systems of work. Unit 311 Applying Health and Safety legislation and working practices (installing and maintaining electrotechnical systems and equipment) (ELTP01).',
          ],
        },
      ],
    },
    {
      id: 'topic-2',
      heading: 'Topic 2: How to assess the work environment for hazards and identify remedial actions in accordance with Health and Safety legislation',
      tocLabel: 'Topic 2',
      blocks: [
        {
          type: 'paragraph',
        ...
        },
        {
          ...
          items: [
            ...
            'Assess the work environment and revise work practices accordingly to take into account hazards which could cause harm, including the handling of potentially hazardous: • materials • tools • equipment..',
            ...
            'Select and use correct personal protective equipment and protection measures to ensure the health and safety of themselves and others in the work environment. 126 City & Guilds Level 3 Diplomas in Electrotechnical Technology (2357) Unit 311 Applying Health and Safety legislation and working practices (installing and maintaining electrotechnical systems and equipment) (ELTP01).',
          ],
        },
      ],
    },
    {
      id: 'topic-3',
      heading: 'Topic 3: How to apply methods and procedures to ensure work on site is in accordance with Health and Safety legislation',
      tocLabel: 'Topic 3',
      blocks: [
        {
          type: 'paragraph',
        ...
        },
        {
          ...
          items: [
            ...
            'Apply procedures to ensure the safe use, maintenance and storage of tools, plant and equipment as stipulated in: • workplace policies (company and site) • supplier information • manufacturer’s instructions.',
            ...
            'Use access equipment correctly. Unit 311 Applying Health and Safety legislation and working practices (installing and maintaining electrotechnical systems and equipment) (ELTP01).',
          ],
        },
      ],
    },
    {
      id: 'topic-4',
      heading: 'Topic 4: How to apply procedures to deal with and report Health and Safety in accordance with Health and Safety legislation',
      tocLabel: 'Topic 4',
      blocks: [
        {
          type: 'paragraph',
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          body:
            'The Elec-Mate apprentice tier includes mock exams, flashcards, and revision notes for City & Guilds 2357 Unit 311 plus every other unit in your qualification. 7-day free trial — see your progress on the tutor dashboard.',
        },
      ],
    },
  ],
  faqs: [
    {
      question: 'What does City & Guilds 2357 Unit 311 cover?',
      answer: 'Unit 311 (Applying Health and Safety legislation and working practices (installing and maintaining electrotechnical systems and equipment) (ELTP01)) covers 4 main topic areas: How to apply relevant Health and Safety legislation in the workplace; How to assess the work environment for hazards and identify remedial actions in accordance with Health and Safety legislation; How to apply methods and procedures to ensure work on site is in accordance with Health and Safety legislation; How to apply procedures to deal with and report Health and Safety in accordance with Health and Safety legislation. Each topic has specific points you should be able to explain, demonstrate or calculate.',
    },
    {
  ...
  ctaHeading: 'For Apprentices: Pass City & Guilds 2357 Unit 311 with Confidence',
  ctaSubheading:
