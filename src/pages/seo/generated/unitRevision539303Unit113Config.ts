...
// Apprentice revision page for City & Guilds 5393-03 Unit 113.
...
export const unitRevision539303Unit113Config: GeneratedGuideConfig = {
  ...
  heroPrefix: 'City & Guilds 5393-03 Unit 113:',
  heroHighlight: 'Inspect, test, report and commission electrical systems in dwellings',
  heroSuffix: '— Complete Revision Guide',
  heroSubtitle:
    'A structured revision walkthrough of every topic in City & Guilds 5393-03 Unit 113 (Inspect, test, report and commission electrical systems in dwellings). Use it as a personal study checklist — work through each topic, tick off the points you can confidently explain or calculate, and use the linked Elec-Mate tools to practice the calculation-led parts. Designed for apprentices working primarily in domestic environments.',
  keyTakeaways: [
    'City & Guilds 5393-03 Unit 113 — Inspect, test, report and commission electrical systems in dwellings — is a core component of the Level 3 Electrotechnical (Dwellings).',
    'This unit is typically delivered to apprentices working primarily in domestic environments and covers 4 main topic areas.',
    'Across the 4 topics there are 20 specific points you should be able to explain, demonstrate or calculate before the end-of-unit assessment.',
  ...
  sections: [
    {
      id: 'topic-1',
      heading: 'Topic 1: How to confirm safety of the system and equipment prior to completion of inspection, testing and commissioning of single-phase systems in accordance with statutory and non-statutory regulations',
      tocLabel: 'Topic 1',
      blocks: [
        {
          type: 'paragraph',
    ...
    {
      id: 'topic-2',
      heading: 'Topic 2: How to inspect single-phase electrical systems and equipment',
      tocLabel: 'Topic 2',
      blocks: [
        {
          type: 'paragraph',
    ...
    {
      id: 'topic-3',
      heading: 'Topic 3: How to test and commission single-phase electrical systems and equipment',
      tocLabel: 'Topic 3',
      blocks: [
        {
          type: 'paragraph',
        ...
        },
        {
          ...
          items: [
            ...
            'Carry out tests in accordance with the installation specification and BS 7671 and manufacturer\'s instructions. Tests include: a. continuity b. insulation resistance c. polarity d. earth fault loop impedance/earth electrode e. prospective fault current f. RCD operation g. functional testing.',
            'Verify test results reporting all findings to relevant persons, as appropriate: a. representatives of other services/colleagues b. customers/clients.',
            'Complete in accordance with BS 7671 and IET Guidance Note 3: a. Electrical Installation Certificates and associated documents b. Minor Electrical Installation Works Certificates.',
    ...
    {
      id: 'topic-4',
      heading: 'Topic 4: How to inspect, test and report on the condition of an existing electrical installation',
      tocLabel: 'Topic 4',
      blocks: [
        {
          type: 'paragraph',
        ...
        },
        {
          ...
          items: [
            ...
            'Agree and set samples with client and other stakeholders based on the quality of information and systems and maintenance.',
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          body:
            'The Elec-Mate apprentice tier includes mock exams, flashcards, and revision notes for City & Guilds 5393-03 Unit 113 plus every other unit in your qualification. 7-day free trial — see your progress on the tutor dashboard.',
        },
      ],
    },
  ],
  faqs: [
    {
      question: 'What does City & Guilds 5393-03 Unit 113 cover?',
      answer: 'Unit 113 (Inspect, test, report and commission electrical systems in dwellings) covers 4 main topic areas: How to confirm safety of the system and equipment prior to completion of inspection, testing and commissioning of single-phase systems in accordance with statutory and non-statutory regulations; How to inspect single-phase electrical systems and equipment; How to test and commission single-phase electrical systems and equipment; How to inspect, test and report on the condition of an existing electrical installation. Each topic has specific points you should be able to explain, demonstrate or calculate.',
    },
    {
    ...
    },
    {
      ...
      answer: 'Level 3 Electrotechnical (Dwellings) units are typically delivered across the apprenticeship in college-block weeks. Unit 113 is usually delivered to apprentices working primarily in domestic environments. Check your individual learning plan with your tutor for exact timing.',
    },
    {
    ...
    },
    {
      ...
      answer: 'Unit 113 is one of several units that together make up the Level 3 Electrotechnical (Dwellings). Passing every unit and the end-point assessment (AM2 or equivalent) earns you the full qualification. Check the unit overview in our City & Guilds qualification hub for the full unit list.',
    },
  ],
  howToHeading: 'A Five-Step Revision Plan for This Unit',
  howToDescription:
    'A repeatable approach that works for City & Guilds 5393-03 Unit 113 and every other unit in your qualification.',
  howToSteps: [
    {
  ...
  ctaHeading: 'For Apprentices: Pass City & Guilds 5393-03 Unit 113 with Confidence',
  ctaSubheading:
