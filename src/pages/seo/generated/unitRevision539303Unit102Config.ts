...
// Apprentice revision page for City & Guilds 5393-03 Unit 102.
...
export const unitRevision539303Unit102Config: GeneratedGuideConfig = {
  pagePath: '/guides/5393-03-unit-102-apply-health-safety-and-environmental-considerations-in-dwellings-revision',
  title: 'City & Guilds 5393-03 Unit 102: Apply health, safety and',
  description: 'Complete revision guide for City & Guilds 5393-03 Unit 102 (Apply health, safety and environmental considerations in dwellings).',
  datePublished: published,
  dateModified: modified,
  readingTime: 8,
  badge: 'Unit Revision',
  badgeIcon: 'GraduationCap',
  breadcrumbLabel: 'Unit 102 Revision',
  heroPrefix: 'City & Guilds 5393-03 Unit 102:',
  heroHighlight: 'Apply health, safety and environmental considerations in dwellings',
  heroSuffix: '— Complete Revision Guide',
  heroSubtitle:
    'A structured revision walkthrough of every topic in City & Guilds 5393-03 Unit 102 (Apply health, safety and environmental considerations in dwellings). Use it as a personal study checklist — work through each topic, tick off the points you can confidently explain or calculate, and use the linked Elec-Mate tools to practice the calculation-led parts. Designed for apprentices working primarily in domestic environments.',
  keyTakeaways: [
    'City & Guilds 5393-03 Unit 102 — Apply health, safety and environmental considerations in dwellings — is a core component of the Level 3 Electrotechnical (Dwellings).',
  ...
  sections: [
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          ordered: false,
          items: [
            'Identify which workplace Health and Safety procedures are relevant to working in domestic dwelling environments and comply with their duties and obligations as defined by current legislation and organisational procedures.',
            'Produce a risk assessment and method statement in accordance with organisational procedures for a given work activity.',
            'Work within the requirements of: a. risk assessments b. method statements c. safe systems of work.',
          ],
        },
      ],
    },
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            'Assess the work environment and revise work practices accordingly to take into account hazards which could cause harm, including the handling of potentially hazardous: a. materials b. tools c. equipment.',
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            'Apply procedures to ensure the safe use, maintenance and storage of tools, plant and equipment as stipulated in: a. workplace policies (company and site) b. supplier information c. manufacturer\'s instructions.',
            ...
            'Use access equipment correctly: ladder, tower scaffold or mewp, stepladder, platform.',
          ],
        },
      ],
    },
    {
      id: 'topic-4',
      heading: 'Topic 4: How to work in accordance with environmental legislation for electrical services',
      tocLabel: 'Topic 4',
      blocks: [
        {
          type: 'paragraph',
        ...
        },
        {
          ...
          ordered: false,
          items: [
            'Use appropriate procedures for the safe handling, storage and disposal of hazardous materials and products, in accordance with the: Environmental Protection Act, the Hazardous Waste Regulations, Pollution Prevention and Control Act, Control of Pollution Act, the Control of Noise at Work Regulations, Environment Act.',
          ],
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          body:
            'The Elec-Mate apprentice tier includes mock exams, flashcards, and revision notes for City & Guilds 5393-03 Unit 102 plus every other unit in your qualification. 7-day free trial — see your progress on the tutor dashboard.',
        },
      ],
    },
  ],
  faqs: [
    {
      question: 'What does City & Guilds 5393-03 Unit 102 cover?',
      answer: 'Unit 102 (Apply health, safety and environmental considerations in dwellings) covers 4 main topic areas: How to apply relevant Health and Safety legislation in the workplace; How to assess the work environment for hazards and identify remedial actions in accordance with Health and Safety legislation; How to apply methods and procedures to ensure work on site is in accordance with Health and Safety legislation; How to work in accordance with environmental legislation for electrical services. Each topic has specific points you should be able to explain, demonstrate or calculate.',
    },
    {
    ...
    },
    {
      ...
      answer: 'Level 3 Electrotechnical (Dwellings) units are typically delivered across the apprenticeship in college-block weeks. Unit 102 is usually delivered to apprentices working primarily in domestic environments. Check your individual learning plan with your tutor for exact timing.',
    },
    {
    ...
    },
    {
      ...
      answer: 'Unit 102 is one of several units that together make up the Level 3 Electrotechnical (Dwellings). Passing every unit and the end-point assessment (AM2 or equivalent) earns you the full qualification. Check the unit overview in our City & Guilds qualification hub for the full unit list.',
    },
  ],
  howToHeading: 'A Five-Step Revision Plan for This Unit',
  howToDescription:
    'A repeatable approach that works for City & Guilds 5393-03 Unit 102 and every other unit in your qualification.',
  howToSteps: [
    {
  ...
  ctaHeading: 'For Apprentices: Pass City & Guilds 5393-03 Unit 102 with Confidence',
  ctaSubheading:
