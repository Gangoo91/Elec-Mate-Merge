...
export const eicrCostPlymouthConfig: GeneratedGuideConfig = {
  ...
  title: 'EICR Cost Plymouth 2026: Domestic & Commercial',
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          body:
            'Elec-Mate gives Plymouth electricians voice-driven test entry, 19 certificate types, on-site Schedule of Test Results, and a professional PDF quote that the client cannot haggle. 7-day free trial — see how much faster you can quote and certify in your area.',
        },
        {
          type: 'paragraph',
