...
// Apprentice revision page for EAL NETP3 Unit ETP3-07.
...
export const unitRevisionEALNETP3UnitETP307Config: GeneratedGuideConfig = {
  ...
  breadcrumbLabel: 'Unit ETP3-07 Revision',
  heroPrefix: 'EAL NETP3 Unit ETP3-07:',
  heroHighlight: 'Apply Fault Diagnosis and Rectification',
  heroSuffix: '— Complete Revision Guide',
  heroSubtitle:
    'A structured revision walkthrough of every topic in EAL NETP3 Unit ETP3-07 (Apply Fault Diagnosis and Rectification). Use it as a personal study checklist — work through each topic, tick off the points you can confidently explain or calculate, and use the linked Elec-Mate tools to practice the calculation-led parts. Designed for apprentices and adult learners on the EAL NVQ pathway.',
  keyTakeaways: [
    'EAL NETP3 Unit ETP3-07 — Apply Fault Diagnosis and Rectification — is a core component of the EAL Level 3 NVQ in Electrotechnical Practice.',
    'This unit is typically delivered to apprentices and adult learners on the EAL NVQ pathway and covers 3 main topic areas.',
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            'Inform the relevant personnel of the fault diagnosis work.',
            'Carry out the safe isolation procedure.',
            'Evaluate and apply appropriate methods to ensure safety when diagnosing and correcting electrical faults.',
          ],
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          ordered: false,
          items: [
            'Communicate effectively with relevant personnel to ascertain the nature of the fault.',
            'Select and interpret appropriate documents such as layout drawings and schematic diagrams.',
            'Assess and communicate potential disruption that may be a consequence of fault diagnosis and correction work.',
            ...
            'Perform suitable diagnostic tests to identify electrical faults including loss of supply, overload, short-circuit, earth fault, incorrect phase rotation, high resistance joints, component faults, open circuit, and signal faults.',
            'Use appropriate methods for locating faults including a logical approach, safe working practices, and interpretation of test readings.',
            'Use appropriate instruments correctly including voltage indicator, low resistance ohm meter, insulation resistance tester, EFLI and PFC tester, RCD tester, ammeter, phase rotation tester.',
          ],
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          ordered: false,
          items: [
            'Assess the appropriate repairs, removals and replacements and their implications with relevant people.',
            'Perform fault correction procedures correctly and safely using appropriate tools, equipment and material.',
            'Assess and verify that replacement components maintain ease of access, compliance with regulations, and compliance with manufacturer instructions.',
            'Apply appropriate procedures to ensure equipment is left safe if the fault cannot be corrected immediately.',
            'Establish and perform an appropriate inspection and testing procedure to confirm circuits are functioning correctly after fault correction.',
            'Record test results and other appropriate information regarding the fault correction work clearly and accurately.',
          ],
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          body:
            'The Elec-Mate apprentice tier includes mock exams, flashcards, and revision notes for EAL NETP3 Unit ETP3-07 plus every other unit in your qualification. 7-day free trial — see your progress on the tutor dashboard.',
        },
      ],
    },
  ],
  faqs: [
    {
      question: 'What does EAL NETP3 Unit ETP3-07 cover?',
      answer: 'Unit ETP3-07 (Apply Fault Diagnosis and Rectification) covers 3 main topic areas: Prepare to carry out fault diagnosis; Carry out fault diagnosis; Carry out fault rectification. Each topic has specific points you should be able to explain, demonstrate or calculate.',
    },
    {
    ...
    },
    {
      ...
      answer: 'EAL Level 3 NVQ in Electrotechnical Practice units are typically delivered across the apprenticeship in college-block weeks. Unit ETP3-07 is usually delivered to apprentices and adult learners on the EAL NVQ pathway. Check your individual learning plan with your tutor for exact timing.',
    },
    {
    ...
    },
    {
      ...
      answer: 'Unit ETP3-07 is one of several units that together make up the EAL Level 3 NVQ in Electrotechnical Practice. Passing every unit and the end-point assessment (AM2 or equivalent) earns you the full qualification. Check the unit overview in our City & Guilds qualification hub for the full unit list.',
    },
  ],
  howToHeading: 'A Five-Step Revision Plan for This Unit',
  howToDescription:
    'A repeatable approach that works for EAL NETP3 Unit ETP3-07 and every other unit in your qualification.',
  howToSteps: [
    {
  ...
  ctaHeading: 'For Apprentices: Pass EAL NETP3 Unit ETP3-07 with Confidence',
  ctaSubheading:
