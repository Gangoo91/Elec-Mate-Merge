...
// Programmatically generated consumer-unit-replacement cost landing page for Southampton.
// Market-rate data only — pricing bands derived from Southampton labour rates
...
export const cuReplacementCostSouthamptonConfig: GeneratedGuideConfig = {
  pagePath: '/guides/consumer-unit-replacement-cost-southampton',
  title: 'Consumer Unit Replacement Cost Southampton 2026 — Full',
  description: 'Consumer unit (fuse board) replacement cost in Southampton — typical 2026 prices £493–790 for a domestic swap with RCBOs, BS 7671:2018+A4:2026 compliant.',
  datePublished: published,
  dateModified: modified,
  readingTime: 8,
  badge: 'Cost Guide',
  badgeIcon: 'PoundSterling',
  breadcrumbLabel: 'Consumer Unit Replacement Cost in Southampton',
  breadcrumbParent: { label: 'Consumer Unit Replacement Cost', href: '/guides/consumer-unit-replacement-cost' },
  heroPrefix: 'Consumer Unit Replacement Cost in Southampton:',
  heroHighlight: '2026 Full Pricing Guide',
  heroSuffix: '— RCBO Boards & BS 7671:2018+A4:2026',
  heroSubtitle:
    'Whether you are an electrician quoting consumer unit replacements in Southampton or a homeowner trying to understand the market rate, this guide gives the fair-margin 2026 prices for a NICEIC or NAPIT scheme-registered electrician. Old wired-fuse boards, plastic enclosures and missing RCD protection are all driving replacements. Labour rates in Southampton typically run £60–£80/hour. Use it as a market-rate reference for your next quote, or as a buyer\u2019s guide to a fair price.',
  keyTakeaways: [
    'A typical 10–14 way domestic consumer unit replacement in Southampton costs £493–790 (2026 prices) including the new board, RCBOs, surge protection, labour and the Electrical Installation Certificate.',
  ...
  sections: [
    {
      id: 'typical-prices',
      heading: 'Typical Consumer Unit Replacement Prices in Southampton (2026)',
      tocLabel: 'Typical prices',
      blocks: [
        {
          type: 'paragraph',
          text: 'These are working prices for Southampton based on competent-person scheme members in the area, current copper / steel pricing, and typical labour. Each scenario assumes a same-day swap with no unexpected remedial work.',
        },
        {
          type: 'list',
          ordered: false,
    ...
    },
    {
      ...
      blocks: [
        {
          type: 'paragraph',
          text: 'A compliant consumer unit replacement in Southampton should include all of the following — anything missing should be flagged in the quote:',
        },
        {
          type: 'list',
          ordered: false,
    ...
    },
    {
      ...
      blocks: [
        {
          type: 'paragraph',
          text: 'Beyond the board itself, six factors push the final Southampton price into the upper band:',
        },
        {
          type: 'list',
          ordered: true,
    ...
    {
      id: 'for-electricians',
      heading: 'For Electricians: Quote CU Replacements in Southampton at the Right Price',
      tocLabel: 'For electricians',
      blocks: [
        {
          type: 'paragraph',
          text: 'If you are quoting consumer unit replacements in Southampton, the £493–790 band above is your fair-margin floor for a 10–14 way RCBO board with SPD, EIC and labour. Quoting below this band means you are absorbing the cost of your scheme fee, professional indemnity, calibrated test kit, and the certificate liability you sign. Use the bands as anchors, then adjust for: tails upgrade, bonding remedials, AFDDs (recommended in HMOs / certain residential under A4:2026), and any DNO coordination through Scottish and Southern Electricity Networks (SSEN).',
        },
        {
          type: 'callout',
          tone: 'info',
          ...
          body:
            'Elec-Mate gives Southampton electricians the tools to scan the existing board, generate an itemised quote with RCBOs, SPDs, AFDDs and labour, and issue the EIC on-site. 7-day free trial.',
        },
        {
          type: 'paragraph',
  ...
  faqs: [
    {
      question: 'How much does it cost to replace a consumer unit in Southampton?',
      answer: 'A typical 10–14 way domestic consumer unit replacement in Southampton costs £493–790 in 2026, including the new metal-clad board, all RCBOs, surge protection, labour and the EIC. Larger or HMO-spec boards push toward £948+.',
    },
    {
    ...
    },
    {
      ...
      answer: 'Sometimes — a competent person can add an RCD upstream of an existing board as a stop-gap. However if the board is old, plastic, or has missing labelling, the EICR will continue to flag observations. For most Southampton properties, a full replacement is the better long-term option.',
    },
  ],
  howToHeading: 'How to Book a Consumer Unit Replacement in Southampton',
  howToDescription:
  ...
  relatedPages: [
    ...
    {
      href: '/guides/eicr-cost-southampton',
      title: 'EICR Cost in Southampton',
  ...
  ctaHeading: 'For Electricians: Quote CU Swaps in Southampton',
  ctaSubheading:
