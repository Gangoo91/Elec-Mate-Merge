...
// Programmatically generated consumer-unit-replacement cost landing page for Bristol.
// Market-rate data only — pricing bands derived from Bristol labour rates
...
export const cuReplacementCostBristolConfig: GeneratedGuideConfig = {
  pagePath: '/guides/consumer-unit-replacement-cost-bristol',
  title: 'Consumer Unit Replacement Cost Bristol 2026 — Full Pricing',
  description: 'Consumer unit (fuse board) replacement cost in Bristol — typical 2026 prices £527–840 for a domestic swap with RCBOs, BS 7671:2018+A4:2026 compliant.',
  datePublished: published,
  dateModified: modified,
  readingTime: 8,
  badge: 'Cost Guide',
  badgeIcon: 'PoundSterling',
  breadcrumbLabel: 'Consumer Unit Replacement Cost in Bristol',
  breadcrumbParent: { label: 'Consumer Unit Replacement Cost', href: '/guides/consumer-unit-replacement-cost' },
  heroPrefix: 'Consumer Unit Replacement Cost in Bristol:',
  heroHighlight: '2026 Full Pricing Guide',
  heroSuffix: '— RCBO Boards & BS 7671:2018+A4:2026',
  heroSubtitle:
    'Whether you are an electrician quoting consumer unit replacements in Bristol or a homeowner trying to understand the market rate, this guide gives the fair-margin 2026 prices for a NICEIC or NAPIT scheme-registered electrician. Old wired-fuse boards, plastic enclosures and missing RCD protection are all driving replacements. Labour rates in Bristol typically run £65–£85/hour. Use it as a market-rate reference for your next quote, or as a buyer\u2019s guide to a fair price.',
  keyTakeaways: [
    'A typical 10–14 way domestic consumer unit replacement in Bristol costs £527–840 (2026 prices) including the new board, RCBOs, surge protection, labour and the Electrical Installation Certificate.',
    'Larger 18+ way boards, three-phase boards, or boards needing tail upgrades push the price toward £1008 and beyond.',
  ...
  sections: [
    {
      id: 'typical-prices',
      heading: 'Typical Consumer Unit Replacement Prices in Bristol (2026)',
      tocLabel: 'Typical prices',
      blocks: [
        {
          type: 'paragraph',
          text: 'These are working prices for Bristol based on competent-person scheme members in the area, current copper / steel pricing, and typical labour. Each scenario assumes a same-day swap with no unexpected remedial work.',
        },
        {
          type: 'list',
          ordered: false,
          items: [
            'Small property (1-bed flat or maisonette, 6–8 way board) — £448–553 including board, RCBOs, labour, EIC',
            'Standard 3-bed house (10–14 way all-RCBO board) — £527–840 (typical 4–6 hours on site)',
            'Larger 4-bed house (14–18 way board with SPD) — £840–1008',
            'HMO or rented property (with AFDDs on relevant circuits) — £924–1176',
            'Three-phase domestic / light commercial board — £1092–1512+ (priced on site)',
    ...
    },
    {
      ...
      blocks: [
        {
          type: 'paragraph',
          text: 'A compliant consumer unit replacement in Bristol should include all of the following — anything missing should be flagged in the quote:',
        },
        {
          type: 'list',
          ordered: false,
    ...
    },
    {
      ...
      blocks: [
        {
          type: 'paragraph',
          text: 'Beyond the board itself, six factors push the final Bristol price into the upper band:',
        },
        {
          type: 'list',
          ordered: true,
    ...
    {
      id: 'for-electricians',
      heading: 'For Electricians: Quote CU Replacements in Bristol at the Right Price',
      tocLabel: 'For electricians',
      blocks: [
        {
          type: 'paragraph',
          text: 'If you are quoting consumer unit replacements in Bristol, the £527–840 band above is your fair-margin floor for a 10–14 way RCBO board with SPD, EIC and labour. Quoting below this band means you are absorbing the cost of your scheme fee, professional indemnity, calibrated test kit, and the certificate liability you sign. Use the bands as anchors, then adjust for: tails upgrade, bonding remedials, AFDDs (recommended in HMOs / certain residential under A4:2026), and any DNO coordination through National Grid Electricity Distribution (NGED).',
        },
        {
          type: 'callout',
          tone: 'info',
          ...
          body:
            'Elec-Mate gives Bristol electricians the tools to scan the existing board, generate an itemised quote with RCBOs, SPDs, AFDDs and labour, and issue the EIC on-site. 7-day free trial.',
        },
        {
          type: 'paragraph',
  ...
  faqs: [
    {
      question: 'How much does it cost to replace a consumer unit in Bristol?',
      answer: 'A typical 10–14 way domestic consumer unit replacement in Bristol costs £527–840 in 2026, including the new metal-clad board, all RCBOs, surge protection, labour and the EIC. Larger or HMO-spec boards push toward £1008+.',
    },
    {
    ...
    },
    {
      ...
      answer: 'Sometimes — a competent person can add an RCD upstream of an existing board as a stop-gap. However if the board is old, plastic, or has missing labelling, the EICR will continue to flag observations. For most Bristol properties, a full replacement is the better long-term option.',
    },
  ],
  howToHeading: 'How to Book a Consumer Unit Replacement in Bristol',
  howToDescription:
  ...
  relatedPages: [
    ...
    },
    {
      ...
      description: 'Local price bands and labour rates for Cardiff.',
      icon: 'MapPin',
      category: 'Guide',
    },
    {
      href: '/guides/consumer-unit-replacement-cost-swindon',
      title: 'Consumer unit replacement cost in Swindon',
      description: 'Local price bands and labour rates for Swindon.',
      icon: 'MapPin',
      category: 'Guide',
    },
    {
    ...
    {
      href: '/electricians/bristol',
      title: 'Find an Electrician in Bristol',
      description: 'Vetted scheme-registered electricians in Bristol.',
      icon: 'MapPin',
      category: 'Guide',
    },
    {
  ...
  ctaHeading: 'For Electricians: Quote CU Swaps in Bristol',
  ctaSubheading:
