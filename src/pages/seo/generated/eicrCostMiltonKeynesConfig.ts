...
// Programmatically generated EICR cost landing page for Milton Keynes.
...
export const eicrCostMiltonKeynesConfig: GeneratedGuideConfig = {
  ...
  breadcrumbLabel: 'EICR Cost in Milton Keynes',
  breadcrumbParent: { label: 'EICR Cost UK', href: '/guides/eicr-cost-uk' },
  heroPrefix: 'EICR Cost in Milton Keynes:',
  heroHighlight: '2026 Pricing Guide',
  heroSuffix: '— Domestic & Commercial',
  heroSubtitle:
    'Whether you are an electrician quoting EICRs in Milton Keynes or a landlord trying to understand the market rate, this guide gives the fair-margin 2026 prices charged by NICEIC and NAPIT scheme-registered electricians, what is included, and why below-market quotes are usually missing something. Hourly rates for inspection work in Milton Keynes run £65–£85, with a typical 3-bed terrace EICR landing at £310–420. Use it as a market-rate reference for your next quote, or as a buyer\u2019s guide to a fair price.',
  keyTakeaways: [
    'A 1-bed flat EICR in Milton Keynes typically costs £250–340, a 3-bed terrace £310–420, and a 4-bed house £385–520 (2026 prices for a scheme-registered electrician, excluding remedial work).',
    'Commercial EICRs in Milton Keynes are priced per socket / fitting — typically £18–27 per item, with minimum visit fees of £85–£128.',
    ...
    'Hourly rates for Milton Keynes sit at £65–£85 because a NICEIC / NAPIT registered electrician carries professional indemnity insurance, scheme fees, calibrated test equipment (typically £1,200+ MFT), and is liable for the certificate they sign.',
  ...
  sections: [
    {
      id: 'typical-prices',
      heading: 'Typical EICR Prices in Milton Keynes (2026)',
      tocLabel: 'Typical prices',
      blocks: [
        {
          type: 'paragraph',
          text: 'Below is a working price guide for Milton Keynes based on competent-person scheme members operating in the area, hourly rate aggregates, and competitor pricing. Prices exclude any remedial work, which is quoted separately.',
        },
        {
          type: 'list',
          ordered: false,
          items: [
            '1-bedroom flat or maisonette — £250–340 (typically 1.5–2 hours on site)',
            '2-bedroom terrace — £310–399 (typically 2–3 hours)',
            '3-bedroom semi or terrace — £310–420 (typically 2.5–3.5 hours)',
            '4-bedroom detached — £385–520 (typically 3.5–5 hours)',
            '5+ bedroom / large houses — £598+ (priced on visit)',
            'Commercial property — £18–27 per socket / fitting with a minimum visit fee of £85–£128',
          ],
        },
        {
          type: 'callout',
    ...
    },
    {
      ...
      blocks: [
        {
          type: 'paragraph',
          text: 'Six factors push an EICR price up or down within Milton Keynes:',
        },
        {
          type: 'list',
          ordered: true,
    ...
    {
      id: 'when-required',
      heading: 'When You Need an EICR in Milton Keynes',
    ...
    {
      id: 'for-electricians',
      heading: 'For Electricians: Quote EICRs in Milton Keynes at the Right Price',
      tocLabel: 'For electricians',
      blocks: [
        {
          type: 'paragraph',
          text: 'If you are a self-employed electrician or small contractor working in Milton Keynes, this page is your local market-rate reference. The £310–420 band for a 3-bed terrace EICR is the fair-margin floor for a scheme-registered electrician — quoting below it means you are undercutting yourself before you start. Use the figures above to anchor your own quoting, with adjustments for property complexity, accessibility, and your scheme + insurance overhead.',
        },
        {
          type: 'callout',
          tone: 'info',
          ...
          body:
            'Elec-Mate gives Milton Keynes electricians voice-driven test entry, 16 certificate types, on-site Schedule of Test Results, and a professional PDF quote that the client cannot haggle. 7-day free trial — see how much faster you can quote and certify in your area.',
        },
        {
          type: 'paragraph',
    ...
    {
      id: 'get-a-quote',
      heading: 'For Property Owners: Booking an EICR in Milton Keynes',
      tocLabel: 'For property owners',
      blocks: [
        {
          type: 'paragraph',
          text: 'If you are a landlord, owner or managing agent in Milton Keynes looking for an EICR, Elec-Mate connects you to vetted competent-person scheme electricians. Send a brief — property type, postcode, last EICR date — and get a price from a local electrician. Most Milton Keynes jobs are booked within 5–10 working days, with same-day availability typical for smaller properties or urgent landlord deadlines under the Electrical Safety Standards in the Private Rented Sector Regulations 2020.',
        },
        {
          type: 'paragraph',
  ...
  faqs: [
    {
      question: 'How much does a standard EICR cost in Milton Keynes?',
      answer: 'For a 3-bedroom property in Milton Keynes the typical 2026 EICR price from a NICEIC or NAPIT scheme-registered electrician is £310–420, excluding any remedial work. Prices vary with property size, consumer unit condition, and number of circuits. Quotes substantially below this band usually mean the EIC certificate, RCD test sweep or insurance is missing — verify what is included.',
    },
    {
      question: 'How long is an EICR valid for in Milton Keynes?',
    ...
    {
      question: 'Who can carry out an EICR in Milton Keynes?',
    ...
    {
      question: 'Can I get a same-day EICR in Milton Keynes?',
      answer: 'Same-day or next-day EICRs are possible in Milton Keynes for smaller properties (1–2 bed) where an electrician is local and a slot is available. Larger jobs typically require 5–10 working days lead time.',
    },
  ],
  howToHeading: 'How to Book an EICR in Milton Keynes',
  howToDescription:
  ...
  howToSteps: [
    ...
    },
    {
      ...
      text: 'Use Elec-Mate to find vetted Milton Keynes electricians, or check NICEIC / NAPIT directories directly. Avoid trader-aggregator sites that bid jobs out without checking competence.',
    },
    {
  ...
  relatedPages: [
    ...
    {
      href: '/electricians/milton-keynes',
      title: 'Find an Electrician in Milton Keynes',
      description: 'Vetted scheme-registered electricians in Milton Keynes.',
      icon: 'MapPin',
      category: 'Guide',
    },
    {
  ...
  ctaHeading: 'For Electricians: Quote and Certify EICRs in Milton Keynes',
  ctaSubheading:
