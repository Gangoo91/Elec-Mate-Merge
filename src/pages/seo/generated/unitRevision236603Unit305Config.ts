...
// Apprentice revision page for City & Guilds 2366-03 Unit 305.
...
export const unitRevision236603Unit305Config: GeneratedGuideConfig = {
  ...
  heroPrefix: 'City & Guilds 2366-03 Unit 305:',
  heroHighlight: 'Organising and overseeing electrical work activities in buildings',
  heroSuffix: '— Complete Revision Guide',
  heroSubtitle:
    'A structured revision walkthrough of every topic in City & Guilds 2366-03 Unit 305 (Organising and overseeing electrical work activities in buildings). Use it as a personal study checklist — work through each topic, tick off the points you can confidently explain or calculate, and use the linked Elec-Mate tools to practice the calculation-led parts. Designed for Level 3 apprentices.',
  keyTakeaways: [
    'City & Guilds 2366-03 Unit 305 — Organising and overseeing electrical work activities in buildings — is a core component of the Level 3 Diploma in Electrotechnical Technology.',
    'This unit is typically delivered to Level 3 apprentices and covers 3 main topic areas.',
    'Across the 3 topics there are 16 specific points you should be able to explain, demonstrate or calculate before the end-of-unit assessment.',
  ...
  sections: [
    {
      id: 'topic-1',
      heading: 'Topic 1: The requirements for organising and overseeing work programmes',
      tocLabel: 'Topic 1',
      blocks: [
        {
          type: 'paragraph',
        ...
        },
        {
          ...
          ordered: false,
          items: [
            'The considerations of work allocations to electrical operatives.',
            'The overriding principles for carrying out work activities.',
            'The industry standards that are relevant to activities carried out during the installation of electrical systems and equipment.',
            'The procedures for dealing with changes to an original contract specification.',
            'The installations that require specialist advice or guidance.',
            'The influential factors and consequences that could affect the estimated completion time of electrical work.',
            'Types of work programmes.',
            'The procedure for completing and handing over work.',
          ],
        },
      ],
    },
    {
      id: 'topic-2',
      heading: 'Topic 2: The requirements for working with others when organising and overseeing work activities',
      tocLabel: 'Topic 2',
      blocks: [
        {
          type: 'paragraph',
        ...
        },
        {
          ...
          ordered: false,
          items: [
            'The purpose for effective communication when working with others.',
            'The methods of determining the competence of electrical operatives and ensuring continued professional development.',
            'The procedures for rescheduling work to coordinate with changing conditions in the workplace.',
            'The documentation required for work operations.',
            'The relevant, current employment legislation that affects roles and responsibilities.',
          ],
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          ordered: false,
          items: [
            'The resource requirements relevant to the project.',
            'The material checks required to suit the work programmes.',
            'The considerations and methods for the safe and effective storage of materials, tools and equipment.',
          ],
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          body:
            'The Elec-Mate apprentice tier includes mock exams, flashcards, and revision notes for City & Guilds 2366-03 Unit 305 plus every other unit in your qualification. 7-day free trial — see your progress on the tutor dashboard.',
        },
      ],
    },
  ],
  faqs: [
    ...
    },
    {
      ...
      answer: 'Level 3 Diploma in Electrotechnical Technology units are typically delivered across the apprenticeship in college-block weeks. Unit 305 is usually delivered to Level 3 apprentices. Check your individual learning plan with your tutor for exact timing.',
    },
    {
    ...
    },
    {
      ...
      answer: 'Unit 305 is one of several units that together make up the Level 3 Diploma in Electrotechnical Technology. Passing every unit and the end-point assessment (AM2 or equivalent) earns you the full qualification. Check the unit overview in our City & Guilds qualification hub for the full unit list.',
    },
  ],
  howToHeading: 'A Five-Step Revision Plan for This Unit',
  howToDescription:
    'A repeatable approach that works for City & Guilds 2366-03 Unit 305 and every other unit in your qualification.',
  howToSteps: [
    {
  ...
  ctaHeading: 'For Apprentices: Pass City & Guilds 2366-03 Unit 305 with Confidence',
  ctaSubheading:
