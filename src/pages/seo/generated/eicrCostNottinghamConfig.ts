...
// Programmatically generated EICR cost landing page for Nottingham.
...
export const eicrCostNottinghamConfig: GeneratedGuideConfig = {
  pagePath: '/guides/eicr-cost-nottingham',
  title: 'EICR Cost Nottingham 2026 — Domestic & Commercial Pricing',
  description: 'How much does an EICR cost in Nottingham? Fair-margin 2026 prices for scheme-registered electricians — £220–290 for a 1-bed, £330–450 for a 4-bed…',
  datePublished: published,
  dateModified: modified,
  readingTime: 7,
  badge: 'Cost Guide',
  badgeIcon: 'PoundSterling',
  breadcrumbLabel: 'EICR Cost in Nottingham',
  breadcrumbParent: { label: 'EICR Cost UK', href: '/guides/eicr-cost-uk' },
  heroPrefix: 'EICR Cost in Nottingham:',
  heroHighlight: '2026 Pricing Guide',
  heroSuffix: '— Domestic & Commercial',
  heroSubtitle:
    'Whether you are an electrician quoting EICRs in Nottingham or a landlord trying to understand the market rate, this guide gives the fair-margin 2026 prices charged by NICEIC and NAPIT scheme-registered electricians, what is included, and why below-market quotes are usually missing something. Hourly rates for inspection work in Nottingham run £55–£75, with a typical 3-bed terrace EICR landing at £270–360. Use it as a market-rate reference for your next quote, or as a buyer\u2019s guide to a fair price.',
  keyTakeaways: [
    'A 1-bed flat EICR in Nottingham typically costs £220–290, a 3-bed terrace £270–360, and a 4-bed house £330–450 (2026 prices for a scheme-registered electrician, excluding remedial work).',
    'Commercial EICRs in Nottingham are priced per socket / fitting — typically £16–24 per item, with minimum visit fees of £75–£113.',
    ...
    'Hourly rates for Nottingham sit at £55–£75 because a NICEIC / NAPIT registered electrician carries professional indemnity insurance, scheme fees, calibrated test equipment (typically £1,200+ MFT), and is liable for the certificate they sign.',
    ...
    'East Midlands\u2019s DNO is National Grid Electricity Distribution (NGED). Any remedial work involving DNO notification (PME, supply upgrades) routes through them.',
  ...
  sections: [
    {
      id: 'typical-prices',
      heading: 'Typical EICR Prices in Nottingham (2026)',
      tocLabel: 'Typical prices',
      blocks: [
        {
          type: 'paragraph',
          text: 'Below is a working price guide for Nottingham based on competent-person scheme members operating in the area, hourly rate aggregates, and competitor pricing. Prices exclude any remedial work, which is quoted separately.',
        },
        {
          type: 'list',
          ordered: false,
    ...
    },
    {
      ...
      blocks: [
        {
          type: 'paragraph',
          text: 'Six factors push an EICR price up or down within Nottingham:',
        },
        {
          type: 'list',
          ordered: true,
    ...
    {
      id: 'when-required',
      heading: 'When You Need an EICR in Nottingham',
      tocLabel: 'When required',
      blocks: [
        {
          type: 'paragraph',
          text: 'EICRs are mandatory in several scenarios under UK regulation, regardless of East Midlands location:',
        },
        {
          type: 'list',
          ordered: false,
    ...
    {
      id: 'for-electricians',
      heading: 'For Electricians: Quote EICRs in Nottingham at the Right Price',
      tocLabel: 'For electricians',
      blocks: [
        {
          type: 'paragraph',
          text: 'If you are a self-employed electrician or small contractor working in Nottingham, this page is your local market-rate reference. The £270–360 band for a 3-bed terrace EICR is the fair-margin floor for a scheme-registered electrician — quoting below it means you are undercutting yourself before you start. Use the figures above to anchor your own quoting, with adjustments for property complexity, accessibility, and your scheme + insurance overhead.',
        },
        {
          type: 'callout',
          tone: 'info',
          ...
          body:
            'Elec-Mate gives Nottingham electricians voice-driven test entry, 16 certificate types, on-site Schedule of Test Results, and a professional PDF quote that the client cannot haggle. 7-day free trial — see how much faster you can quote and certify in your area.',
        },
        {
          type: 'paragraph',
    ...
    {
      id: 'get-a-quote',
      heading: 'For Property Owners: Booking an EICR in Nottingham',
      tocLabel: 'For property owners',
      blocks: [
        {
          type: 'paragraph',
          text: 'If you are a landlord, owner or managing agent in Nottingham looking for an EICR, Elec-Mate connects you to vetted competent-person scheme electricians. Send a brief — property type, postcode, last EICR date — and get a price from a local electrician. Most Nottingham jobs are booked within 5–10 working days, with same-day availability typical for smaller properties or urgent landlord deadlines under the Electrical Safety Standards in the Private Rented Sector Regulations 2020.',
        },
        {
          type: 'paragraph',
  ...
  faqs: [
    {
      question: 'How much does a standard EICR cost in Nottingham?',
      answer: 'For a 3-bedroom property in Nottingham the typical 2026 EICR price from a NICEIC or NAPIT scheme-registered electrician is £270–360, excluding any remedial work. Prices vary with property size, consumer unit condition, and number of circuits. Quotes substantially below this band usually mean the EIC certificate, RCD test sweep or insurance is missing — verify what is included.',
    },
    {
      question: 'How long is an EICR valid for in Nottingham?',
    ...
    {
      question: 'Who can carry out an EICR in Nottingham?',
    ...
    {
      question: 'Can I get a same-day EICR in Nottingham?',
      answer: 'Same-day or next-day EICRs are possible in Nottingham for smaller properties (1–2 bed) where an electrician is local and a slot is available. Larger jobs typically require 5–10 working days lead time.',
    },
  ],
  howToHeading: 'How to Book an EICR in Nottingham',
  howToDescription:
  ...
  howToSteps: [
    ...
    },
    {
      ...
      text: 'Use Elec-Mate to find vetted Nottingham electricians, or check NICEIC / NAPIT directories directly. Avoid trader-aggregator sites that bid jobs out without checking competence.',
    },
    {
  ...
  ctaHeading: 'For Electricians: Quote and Certify EICRs in Nottingham',
  ctaSubheading:
