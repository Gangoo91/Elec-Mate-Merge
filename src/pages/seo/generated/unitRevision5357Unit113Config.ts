...
// Apprentice revision page for City & Guilds 5357 Unit 113.
...
export const unitRevision5357Unit113Config: GeneratedGuideConfig = {
  pagePath: '/guides/5357-unit-113-inspect-test-and-commission-electrical-systems-revision',
  title: 'City & Guilds 5357 Unit 113: Inspect, Test and Commission',
  description: 'Complete revision guide for City & Guilds 5357 Unit 113 (Inspect, Test and Commission Electrical Systems).',
  ...
  heroPrefix: 'City & Guilds 5357 Unit 113:',
  heroHighlight: 'Inspect, Test and Commission Electrical Systems',
  heroSuffix: '— Complete Revision Guide',
  heroSubtitle:
    'A structured revision walkthrough of every topic in City & Guilds 5357 Unit 113 (Inspect, Test and Commission Electrical Systems). Use it as a personal study checklist — work through each topic, tick off the points you can confidently explain or calculate, and use the linked Elec-Mate tools to practice the calculation-led parts. Designed for electrotechnical apprentices on the apprenticeship standard.',
  keyTakeaways: [
    'City & Guilds 5357 Unit 113 — Inspect, Test and Commission Electrical Systems — is a core component of the Level 3 Electrotechnical Qualification (Apprenticeship Standard).',
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          body:
            'The Elec-Mate apprentice tier includes mock exams, flashcards, and revision notes for City & Guilds 5357 Unit 113 plus every other unit in your qualification. 7-day free trial — see your progress on the tutor dashboard.',
        },
      ],
    },
  ],
  faqs: [
    {
      question: 'What does City & Guilds 5357 Unit 113 cover?',
  ...
  ctaHeading: 'For Apprentices: Pass City & Guilds 5357 Unit 113 with Confidence',
  ctaSubheading:
