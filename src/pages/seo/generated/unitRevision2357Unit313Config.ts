...
// Apprentice revision page for City & Guilds 2357 Unit 313.
...
export const unitRevision2357Unit313Config: GeneratedGuideConfig = {
  ...
  breadcrumbLabel: 'Unit 313 Revision',
  heroPrefix: 'City & Guilds 2357 Unit 313:',
  heroHighlight: 'Overseeing and organising the work environment (electrical installation) (ELTP03)',
  heroSuffix: '— Complete Revision Guide',
  heroSubtitle:
    'A structured revision walkthrough of every topic in City & Guilds 2357 Unit 313 (Overseeing and organising the work environment (electrical installation) (ELTP03)). Use it as a personal study checklist — work through each topic, tick off the points you can confidently explain or calculate, and use the linked Elec-Mate tools to practice the calculation-led parts. Designed for apprentices working through an NVQ pathway with on-the-job portfolio evidence.',
  keyTakeaways: [
    'City & Guilds 2357 Unit 313 — Overseeing and organising the work environment (electrical installation) (ELTP03) — is a core component of the Level 3 NVQ Diploma in Installing Electrotechnical Systems and Equipment.',
    ...
    'Across the 6 topics there are 19 specific points you should be able to explain, demonstrate or calculate before the end-of-unit assessment.',
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            'Follow procedures to confirm that work is being completed in accordance with Health and Safety legislation and industry standards. Unit 313 Overseeing and organising the work environment (electrical installation) (ELTP03).',
          ],
        },
      ],
    },
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            'Apply communication techniques that are clear, accurate and appropriate to the situation. 138 City & Guilds Level 3 Diplomas in Electrotechnical Technology (2357) Unit 313 Overseeing and organising the work environment (electrical installation) (ELTP03).',
          ],
        },
      ],
    },
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            'Monitor the work of operatives to ensure it is in accordance with: • industry working practices • programme of work • health and Safety requirements • cost effectiveness.',
            'Apply the correct procedures when a non compliance is identified during the completion of work activities. Unit 313 Overseeing and organising the work environment (electrical installation) (ELTP03).',
          ],
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          ordered: false,
          items: [
            'Produce a programme of work from the work specification, including requirements for the following: • estimate of the amount of time required for completion of the work • liaison with other trades where necessary.',
            'Communicate with others clearly and concisely.',
            'Identify situations when it is necessary to liaise with other relevant parties to resolve issues which are outside the scope of their job role. 140 City & Guilds Level 3 Diplomas in Electrotechnical Technology (2357) Unit 313 Overseeing and organising the work environment (electrical installation) (ELTP03).',
          ],
        },
      ],
    },
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            'Demonstrate procedures for confirming that materials available are: • the right type • fit for purpose • in the correct quantity • suitable for work to be completed cost efficiently..',
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          body:
            'The Elec-Mate apprentice tier includes mock exams, flashcards, and revision notes for City & Guilds 2357 Unit 313 plus every other unit in your qualification. 7-day free trial — see your progress on the tutor dashboard.',
        },
      ],
    },
  ],
  faqs: [
    {
      question: 'What does City & Guilds 2357 Unit 313 cover?',
      answer: 'Unit 313 (Overseeing and organising the work environment (electrical installation) (ELTP03)) covers 6 main topic areas: How to provide relevant people with technical and functional information for work on electrical systems and equipment; How to oversee Health and Safety during work on electrical systems and equipment; How to co-ordinate liaison with other relevant persons during work activities; How to organise and oversee work activities and operations; How to organise a programme for working on electrical systems and equipment; How to organise the resource requirements for work on electrical systems and equipment. Each topic has specific points you should be able to explain, demonstrate or calculate.',
    },
    {
  ...
  ctaHeading: 'For Apprentices: Pass City & Guilds 2357 Unit 313 with Confidence',
  ctaSubheading:
