...
// Apprentice revision page for EAL Level 3 Unit 18ED3-02.
...
export const unitRevision6103907XUnit18ED302Config: GeneratedGuideConfig = {
  ...
  breadcrumbLabel: 'Unit 18ED3-02 Revision',
  heroPrefix: 'EAL Level 3 Unit 18ED3-02:',
  ...
  heroSubtitle:
    'A structured revision walkthrough of every topic in EAL Level 3 Unit 18ED3-02 (Understand the Requirements of Electrical Installations BS 7671:2018 (2022)). Use it as a personal study checklist — work through each topic, tick off the points you can confidently explain or calculate, and use the linked Elec-Mate tools to practice the calculation-led parts. Designed for EAL Level 3 apprentices.',
  keyTakeaways: [
    'EAL Level 3 Unit 18ED3-02 — Understand the Requirements of Electrical Installations BS 7671:2018 (2022) — is a core component of the EAL Level 3 Electrotechnical Technical Occupational Entry qualification.',
  ...
  sections: [
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          ordered: false,
          items: [
            'Identify the scope of BS 7671 Cover: Each part in BS 7671, except one, contains chapters. Each chapter contains sections. Each section contains individual (or groups of) regulations. Note the informative element, and verbal forms in the plan of the 18th Edition. For this outcome cover: Cover Chapter 11, Scope. Cover Chapter 12, Object and Effects. Cover Chapter 13, Fundamental Principles..',
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          ordered: false,
          items: [
            'Interpret the definitions used within BS 7671 Cover: Part 2, Definitions. The learner must be able to relate the definitions used within Part 2 to the contents of BS 7671. This will also include the symbols and abbreviations used within the regulations..',
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          ordered: false,
          items: [
            'Interpret the requirements of assessing the general characteristics of electrical installations within the scope of BS 7671.',
          ],
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          ordered: false,
          items: [
            'Identify the requirements of protection for safety within the scope of BS 7671.',
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          ordered: false,
          items: [
            'Identify the requirements for selecting and erecting equipment, within the scope of BS 7671.',
            'Interpret how this applies to electrical installations within the scope of BS 7671 to include:.',
          ],
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          ordered: false,
          items: [
            'Identify the requirements for inspection and testing Cover: Part 6, Inspection and testing. Chapter 64, Initial verification. Chapter 65, Periodic inspection and testing. Cover how the requirements of Part 6 relate to the process of inspection, testing and certificating electrical installations..',
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          body:
            'The Elec-Mate apprentice tier includes mock exams, flashcards, and revision notes for EAL Level 3 Unit 18ED3-02 plus every other unit in your qualification. 7-day free trial — see your progress on the tutor dashboard.',
        },
      ],
    },
  ],
  faqs: [
    ...
    },
    {
      ...
      answer: 'EAL Level 3 Electrotechnical Technical Occupational Entry qualification units are typically delivered across the apprenticeship in college-block weeks. Unit 18ED3-02 is usually delivered to EAL Level 3 apprentices. Check your individual learning plan with your tutor for exact timing.',
    },
    {
  ...
  ctaHeading: 'For Apprentices: Pass EAL Level 3 Unit 18ED3-02 with Confidence',
  ctaSubheading:
