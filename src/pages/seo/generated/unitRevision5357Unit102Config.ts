...
// Apprentice revision page for City & Guilds 5357 Unit 102.
...
export const unitRevision5357Unit102Config: GeneratedGuideConfig = {
  pagePath: '/guides/5357-unit-102-apply-health-safety-and-environmental-considerations-revision',
  title: 'City & Guilds 5357 Unit 102: Apply Health, Safety and',
  description: 'Complete revision guide for City & Guilds 5357 Unit 102 (Apply Health, Safety and Environmental Considerations).',
  ...
  heroPrefix: 'City & Guilds 5357 Unit 102:',
  heroHighlight: 'Apply Health, Safety and Environmental Considerations',
  heroSuffix: '— Complete Revision Guide',
  heroSubtitle:
    'A structured revision walkthrough of every topic in City & Guilds 5357 Unit 102 (Apply Health, Safety and Environmental Considerations). Use it as a personal study checklist — work through each topic, tick off the points you can confidently explain or calculate, and use the linked Elec-Mate tools to practice the calculation-led parts. Designed for electrotechnical apprentices on the apprenticeship standard.',
  keyTakeaways: [
    'City & Guilds 5357 Unit 102 — Apply Health, Safety and Environmental Considerations — is a core component of the Level 3 Electrotechnical Qualification (Apprenticeship Standard).',
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          ordered: false,
          items: [
            'Demonstrate a level of personal conduct and behaviour within the workplace, to ensure that the health and safety of themselves and others is not endangered.',
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          ordered: false,
          items: [
            'Demonstrate appropriate procedures for the safe handling, storage and disposal of hazardous materials and products, in accordance with one of the following: • Environmental Protection Act • the Hazardous Waste Regulations • Pollution Prevention and Control Act • Control of Pollution Act • the Control of Noise at Work Regulations • Environment Act. Unit 102 Apply Health, Safety and Environmental Considerations.',
          ],
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          body:
            'The Elec-Mate apprentice tier includes mock exams, flashcards, and revision notes for City & Guilds 5357 Unit 102 plus every other unit in your qualification. 7-day free trial — see your progress on the tutor dashboard.',
        },
      ],
    },
  ],
  faqs: [
    {
      question: 'What does City & Guilds 5357 Unit 102 cover?',
      answer: 'Unit 102 (Apply Health, Safety and Environmental Considerations) covers 4 main topic areas: How to apply relevant health and safety legislation in the workplace; How to assess the work environment for hazards and identify remedial actions in accordance with Health and Safety legislation; How to apply methods and procedures to ensure work on site is in accordance with health and safety legislation; How to work in accordance with environmental legislation for electrical services. Each topic has specific points you should be able to explain, demonstrate or calculate.',
    },
    {
  ...
  ctaHeading: 'For Apprentices: Pass City & Guilds 5357 Unit 102 with Confidence',
  ctaSubheading:
