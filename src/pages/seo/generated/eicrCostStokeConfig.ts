...
// Programmatically generated EICR cost landing page for Stoke-on-Trent.
...
export const eicrCostStokeConfig: GeneratedGuideConfig = {
  pagePath: '/guides/eicr-cost-stoke',
  title: 'EICR Cost Stoke-on-Trent 2026 — Domestic & Commercial',
  description: 'How much does an EICR cost in Stoke-on-Trent? Fair-margin 2026 prices for scheme-registered electricians — £195–265 for a 1-bed, £310–420 for a 4-bed…',
  datePublished: published,
  dateModified: modified,
  readingTime: 7,
  badge: 'Cost Guide',
  badgeIcon: 'PoundSterling',
  breadcrumbLabel: 'EICR Cost in Stoke-on-Trent',
  breadcrumbParent: { label: 'EICR Cost UK', href: '/guides/eicr-cost-uk' },
  heroPrefix: 'EICR Cost in Stoke-on-Trent:',
  heroHighlight: '2026 Pricing Guide',
  heroSuffix: '— Domestic & Commercial',
  heroSubtitle:
    'Whether you are an electrician quoting EICRs in Stoke-on-Trent or a landlord trying to understand the market rate, this guide gives the fair-margin 2026 prices charged by NICEIC and NAPIT scheme-registered electricians, what is included, and why below-market quotes are usually missing something. Hourly rates for inspection work in Stoke-on-Trent run £48–£68, with a typical 3-bed terrace EICR landing at £250–335. Use it as a market-rate reference for your next quote, or as a buyer\u2019s guide to a fair price.',
  keyTakeaways: [
    'A 1-bed flat EICR in Stoke-on-Trent typically costs £195–265, a 3-bed terrace £250–335, and a 4-bed house £310–420 (2026 prices for a scheme-registered electrician, excluding remedial work).',
    'Commercial EICRs in Stoke-on-Trent are priced per socket / fitting — typically £14–22 per item, with minimum visit fees of £68–£102.',
    ...
    'Hourly rates for Stoke-on-Trent sit at £48–£68 because a NICEIC / NAPIT registered electrician carries professional indemnity insurance, scheme fees, calibrated test equipment (typically £1,200+ MFT), and is liable for the certificate they sign.',
    ...
    'West Midlands\u2019s DNO is National Grid Electricity Distribution (NGED). Any remedial work involving DNO notification (PME, supply upgrades) routes through them.',
  ...
  sections: [
    {
      id: 'typical-prices',
      heading: 'Typical EICR Prices in Stoke-on-Trent (2026)',
      tocLabel: 'Typical prices',
      blocks: [
        {
          type: 'paragraph',
          text: 'Below is a working price guide for Stoke-on-Trent based on competent-person scheme members operating in the area, hourly rate aggregates, and competitor pricing. Prices exclude any remedial work, which is quoted separately.',
        },
        {
          type: 'list',
          ordered: false,
          items: [
            '1-bedroom flat or maisonette — £195–265 (typically 1.5–2 hours on site)',
            '2-bedroom terrace — £250–318 (typically 2–3 hours)',
            '3-bedroom semi or terrace — £250–335 (typically 2.5–3.5 hours)',
            '4-bedroom detached — £310–420 (typically 3.5–5 hours)',
            '5+ bedroom / large houses — £483+ (priced on visit)',
            'Commercial property — £14–22 per socket / fitting with a minimum visit fee of £68–£102',
          ],
        },
        {
          type: 'callout',
    ...
    },
    {
      ...
      blocks: [
        {
          type: 'paragraph',
          text: 'Six factors push an EICR price up or down within Stoke-on-Trent:',
        },
        {
          type: 'list',
          ordered: true,
    ...
    {
      id: 'when-required',
      heading: 'When You Need an EICR in Stoke-on-Trent',
      tocLabel: 'When required',
      blocks: [
        {
          type: 'paragraph',
          text: 'EICRs are mandatory in several scenarios under UK regulation, regardless of West Midlands location:',
        },
        {
          type: 'list',
          ordered: false,
    ...
    {
      id: 'for-electricians',
      heading: 'For Electricians: Quote EICRs in Stoke-on-Trent at the Right Price',
      tocLabel: 'For electricians',
      blocks: [
        {
          type: 'paragraph',
          text: 'If you are a self-employed electrician or small contractor working in Stoke-on-Trent, this page is your local market-rate reference. The £250–335 band for a 3-bed terrace EICR is the fair-margin floor for a scheme-registered electrician — quoting below it means you are undercutting yourself before you start. Use the figures above to anchor your own quoting, with adjustments for property complexity, accessibility, and your scheme + insurance overhead.',
        },
        {
          type: 'callout',
          tone: 'info',
    ...
    {
      id: 'get-a-quote',
      heading: 'For Property Owners: Booking an EICR in Stoke-on-Trent',
      tocLabel: 'For property owners',
      blocks: [
        {
          type: 'paragraph',
          text: 'If you are a landlord, owner or managing agent in Stoke-on-Trent looking for an EICR, Elec-Mate connects you to vetted competent-person scheme electricians. Send a brief — property type, postcode, last EICR date — and get a price from a local electrician. Most Stoke-on-Trent jobs are booked within 5–10 working days, with same-day availability typical for smaller properties or urgent landlord deadlines under the Electrical Safety Standards in the Private Rented Sector Regulations 2020.',
        },
        {
          type: 'paragraph',
  ...
  faqs: [
    {
      question: 'How much does a standard EICR cost in Stoke-on-Trent?',
      answer: 'For a 3-bedroom property in Stoke-on-Trent the typical 2026 EICR price from a NICEIC or NAPIT scheme-registered electrician is £250–335, excluding any remedial work. Prices vary with property size, consumer unit condition, and number of circuits. Quotes substantially below this band usually mean the EIC certificate, RCD test sweep or insurance is missing — verify what is included.',
    },
    {
      question: 'How long is an EICR valid for in Stoke-on-Trent?',
    ...
    {
      question: 'Who can carry out an EICR in Stoke-on-Trent?',
    ...
    {
      question: 'Can I get a same-day EICR in Stoke-on-Trent?',
      answer: 'Same-day or next-day EICRs are possible in Stoke-on-Trent for smaller properties (1–2 bed) where an electrician is local and a slot is available. Larger jobs typically require 5–10 working days lead time.',
    },
  ],
  howToHeading: 'How to Book an EICR in Stoke-on-Trent',
  howToDescription:
  ...
  howToSteps: [
    ...
    },
    {
      ...
      text: 'Use Elec-Mate to find vetted Stoke-on-Trent electricians, or check NICEIC / NAPIT directories directly. Avoid trader-aggregator sites that bid jobs out without checking competence.',
    },
    {
  ...
  relatedPages: [
    ...
    {
      href: '/guides/eicr-cost-birmingham',
      title: 'EICR cost in Birmingham',
      description: 'Local price bands and labour rates for Birmingham.',
      icon: 'MapPin',
      category: 'Guide',
    },
    {
      href: '/electricians/stoke',
      title: 'Find an Electrician in Stoke-on-Trent',
      description: 'Vetted scheme-registered electricians in Stoke-on-Trent.',
      icon: 'MapPin',
      category: 'Guide',
    },
    {
