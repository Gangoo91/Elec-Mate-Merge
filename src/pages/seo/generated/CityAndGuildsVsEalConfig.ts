...
export const CityAndGuildsVsEalConfig: GeneratedGuideConfig = {
  ...
  breadcrumbLabel: 'City & Guilds vs EAL',
  heroPrefix: 'City & Guilds vs EAL',
  heroHighlight: 'UK Electrical Awarding Bodies Compared',
  heroSuffix: '— UK 2026 Guide',
  heroSubtitle:
    'City & Guilds and EAL are the two largest awarding bodies for UK electrical qualifications. Most apprentices are with one or the other. The qualifications are largely equivalent in industry recognition — but the assessment style and unit structure differ. This guide explains the practical differences between the routes — audience, structure, time commitment, end-point assessment — so you can choose the right one for your situation.',
  keyTakeaways: [
  ...
  sections: [
    {
      id: 'city-guilds',
      heading: 'City & Guilds — The oldest and largest UK vocational awarding body',
      tocLabel: 'City & Guilds',
      blocks: [
        {
          type: 'paragraph',
          text: 'Audience: Most UK electrical apprentices — default if your training provider does not specify.',
        },
        {
          type: 'paragraph',
          text: 'Strengths:',
        },
        {
          ...
          ordered: false,
          items: [
            'Largest UK electrical apprentice market share.',
            'Most colleges deliver C&G pathways.',
            'Strong industry brand recognition.',
          ],
        },
        {
          type: 'paragraph',
          text: 'End-point / assessment: AM2 (under 5357) or unit-level + 2391 (under 2365).',
        },
      ],
    },
    {
      id: 'eal',
      heading: 'EAL — Engineering and Manufacturing Awarding Body — Level 3 NVQ / Technical pathways',
      tocLabel: 'EAL',
      blocks: [
        {
          type: 'paragraph',
          text: 'Audience: Apprentices in industrial / engineering-led employers, alternative training providers.',
        },
        {
          type: 'paragraph',
          text: 'Strengths:',
        },
        {
          ...
          ordered: false,
          items: [
            'Strong in industrial / engineering pathways.',
            'Different unit structure that some employers prefer.',
            'Identical industry recognition once qualified.',
          ],
        },
        {
          type: 'paragraph',
          text: 'End-point / assessment: AM2 (under the EAL Apprenticeship Standard) or NVQ portfolio (NETP3).',
        },
      ],
    },
    {
