...
// Apprentice revision page for City & Guilds 2365-02 Unit 201.
...
export const unitRevision236502Unit201Config: GeneratedGuideConfig = {
  pagePath: '/guides/2365-02-unit-201-health-and-safety-in-building-services-engineering-revision',
  title: 'City & Guilds 2365-02 Unit 201: Health and safety in',
  description: 'Complete revision guide for City & Guilds 2365-02 Unit 201 (Health and safety in building services engineering).',
  datePublished: published,
  dateModified: modified,
  readingTime: 10,
  badge: 'Unit Revision',
  badgeIcon: 'GraduationCap',
  breadcrumbLabel: 'Unit 201 Revision',
  heroPrefix: 'City & Guilds 2365-02 Unit 201:',
  heroHighlight: 'Health and safety in building services engineering',
  heroSuffix: '— Complete Revision Guide',
  heroSubtitle:
    'A structured revision walkthrough of every topic in City & Guilds 2365-02 Unit 201 (Health and safety in building services engineering). Use it as a personal study checklist — work through each topic, tick off the points you can confidently explain or calculate, and use the linked Elec-Mate tools to practice the calculation-led parts. Designed for 1st-year apprentices.',
  keyTakeaways: [
    'City & Guilds 2365-02 Unit 201 — Health and safety in building services engineering — is a core component of the Level 2 Diploma in Electrical Installations.',
    'This unit is typically delivered to 1st-year apprentices and covers 4 main topic areas.',
    'Across the 4 topics there are 26 specific points you should be able to explain, demonstrate or calculate before the end-of-unit assessment.',
  ...
  sections: [
    {
      id: 'topic-1',
      heading: 'Topic 1: How relevant legislation applies in the workplace',
      tocLabel: 'Topic 1',
      blocks: [
        {
          type: 'paragraph',
    ...
    {
      id: 'topic-3',
      heading: 'Topic 3: How to demonstrate and understand the procedures for establishing a safe working environment',
      tocLabel: 'Topic 3',
      blocks: [
        {
          type: 'paragraph',
        ...
        },
        {
          ...
          items: [
            ...
            'Describe and demonstrate safe practices and procedures for the use of equipment and materials in the working environment.',
            'Specify and demonstrate the procedures for ensuring electrical systems are safe to work on.',
            'State the implications of: carrying out safe isolation procedures and not carrying out safe isolation procedures.',
          ],
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          ordered: false,
          items: [
            'Identify warning pictograms for hazardous substances, as defined by the GB CLP Regulation.',
            'Define what is meant by the term hazard in relation to Health and Safety legislation in the workplace.',
            'Identify specific hazards associated with the installation and maintenance of electrical systems and equipment.',
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          body:
            'The Elec-Mate apprentice tier includes mock exams, flashcards, and revision notes for City & Guilds 2365-02 Unit 201 plus every other unit in your qualification. 7-day free trial — see your progress on the tutor dashboard.',
        },
      ],
    },
  ],
  faqs: [
    {
      question: 'What does City & Guilds 2365-02 Unit 201 cover?',
      answer: 'Unit 201 (Health and safety in building services engineering) covers 4 main topic areas: How relevant legislation applies in the workplace; The procedures for dealing with Environmental and Health and Safety situations in the work environment; How to demonstrate and understand the procedures for establishing a safe working environment; The requirements for identifying and dealing with hazards in the work environment. Each topic has specific points you should be able to explain, demonstrate or calculate.',
    },
    {
    ...
    },
    {
      ...
      answer: 'Level 2 Diploma in Electrical Installations units are typically delivered across the apprenticeship in college-block weeks. Unit 201 is usually delivered to 1st-year apprentices. Check your individual learning plan with your tutor for exact timing.',
    },
    {
    ...
    },
    {
      ...
      answer: 'Unit 201 is one of several units that together make up the Level 2 Diploma in Electrical Installations. Passing every unit and the end-point assessment (AM2 or equivalent) earns you the full qualification. Check the unit overview in our City & Guilds qualification hub for the full unit list.',
    },
  ],
  howToHeading: 'A Five-Step Revision Plan for This Unit',
  howToDescription:
    'A repeatable approach that works for City & Guilds 2365-02 Unit 201 and every other unit in your qualification.',
  howToSteps: [
    {
  ...
  ctaHeading: 'For Apprentices: Pass City & Guilds 2365-02 Unit 201 with Confidence',
  ctaSubheading:
