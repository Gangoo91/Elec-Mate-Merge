...
// Apprentice revision page for City & Guilds 2357 Unit 318.
...
export const unitRevision2357Unit318Config: GeneratedGuideConfig = {
  ...
  breadcrumbLabel: 'Unit 318 Revision',
  heroPrefix: 'City & Guilds 2357 Unit 318:',
  heroHighlight: 'Diagnosing and correcting electrical faults in electrical systems and equipment in buildings, structures and the environment (ELTP07)',
  heroSuffix: '— Complete Revision Guide',
  heroSubtitle:
    'A structured revision walkthrough of every topic in City & Guilds 2357 Unit 318 (Diagnosing and correcting electrical faults in electrical systems and equipment in buildings, structures and the environment (ELTP07)). Use it as a personal study checklist — work through each topic, tick off the points you can confidently explain or calculate, and use the linked Elec-Mate tools to practice the calculation-led parts. Designed for apprentices working through an NVQ pathway with on-the-job portfolio evidence.',
  keyTakeaways: [
    'City & Guilds 2357 Unit 318 — Diagnosing and correcting electrical faults in electrical systems and equipment in buildings, structures and the environment (ELTP07) — is a core component of the Level 3 NVQ Diploma in Installing Electrotechnical Systems and Equipment.',
  ...
  sections: [
    {
      id: 'topic-1',
      heading: 'Topic 1: How to confirm safety of the system and equipment prior to diagnosing and correcting electrical faults in accordance with statutory and non statutory regulations',
      tocLabel: 'Topic 1',
      blocks: [
        {
          type: 'paragraph',
        ...
        },
        {
          ...
          items: [
            ...
            'Check the safety of electrical systems prior to the commencement of diagnosing and correcting electrical faults. 166 City & Guilds Level 3 Diplomas in Electrotechnical Technology (2357) Unit 318 Diagnosing and correcting electrical faults in electrical systems and equipment in buildings, structures and the environment (ELTP07).',
          ],
        },
      ],
    },
    {
      id: 'topic-2',
      heading: 'Topic 2: How to carry out procedures to identify faults on electrical systems and equipment',
      tocLabel: 'Topic 2',
      blocks: [
        {
          type: 'paragraph',
    ...
    {
      id: 'topic-3',
      heading: 'Topic 3: How to correct faults on electrical systems and equipment',
      tocLabel: 'Topic 3',
      blocks: [
        {
          type: 'paragraph',
        ...
        },
        {
          ...
          ordered: false,
          items: [
            'Confirm appropriate repairs, removals and replacements and their implications with relevant people including: • other workers/colleagues • customers/clients • representatives of other services.',
            'Perform fault correction procedures correctly and safely using appropriate tools, equipment and material.',
            'Perform the removal and replacement of components and associated equipment from electrotechnical systems to ensure: • ease of access to enable future maintenance • accordance with: o relevant regulations o manufacturer’s instructions o organisational procedures.',
            ...
            'Record test results and other appropriate information regarding the fault correction work clearly and accurately and report to relevant people, such as: • Other workers/colleagues • Customers/clients • Representatives of other services. Unit 318 Diagnosing and correcting electrical faults in electrical systems and equipment in buildings, structures and the environment (ELTP07) Notes for guidance Unit entry requirements Prior to undertaking this unit a learner must provide auditable evidence that they have the relevant knowledge and understanding as detailed in the units: • Understanding the principles, practices and legislation for diagnosing and correcting electrical faults in electrotechnical systems and equipment in buildings, structures and the environment (2357-608/ELTK07) • Understanding the electrical principles associated with the design, building, installation and maintenance of electrical equipment and systems (2357-609/ELTK08). Evidence requirements Learning.',
          ],
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          body:
            'The Elec-Mate apprentice tier includes mock exams, flashcards, and revision notes for City & Guilds 2357 Unit 318 plus every other unit in your qualification. 7-day free trial — see your progress on the tutor dashboard.',
        },
      ],
    },
  ],
  faqs: [
    {
      question: 'What does City & Guilds 2357 Unit 318 cover?',
      answer: 'Unit 318 (Diagnosing and correcting electrical faults in electrical systems and equipment in buildings, structures and the environment (ELTP07)) covers 3 main topic areas: How to confirm safety of the system and equipment prior to diagnosing and correcting electrical faults in accordance with statutory and non statutory regulations; How to carry out procedures to identify faults on electrical systems and equipment; How to correct faults on electrical systems and equipment. Each topic has specific points you should be able to explain, demonstrate or calculate.',
    },
    {
  ...
  ctaHeading: 'For Apprentices: Pass City & Guilds 2357 Unit 318 with Confidence',
  ctaSubheading:
