...
// Programmatically generated consumer-unit-replacement cost landing page for Portsmouth.
// Market-rate data only — pricing bands derived from Portsmouth labour rates
...
export const cuReplacementCostPortsmouthConfig: GeneratedGuideConfig = {
  ...
  breadcrumbLabel: 'Consumer Unit Replacement Cost in Portsmouth',
  breadcrumbParent: { label: 'Consumer Unit Replacement Cost', href: '/guides/consumer-unit-replacement-cost' },
  heroPrefix: 'Consumer Unit Replacement Cost in Portsmouth:',
  heroHighlight: '2026 Full Pricing Guide',
  heroSuffix: '— RCBO Boards & BS 7671:2018+A4:2026',
  heroSubtitle:
    'Whether you are an electrician quoting consumer unit replacements in Portsmouth or a homeowner trying to understand the market rate, this guide gives the fair-margin 2026 prices for a NICEIC or NAPIT scheme-registered electrician. Old wired-fuse boards, plastic enclosures and missing RCD protection are all driving replacements. Labour rates in Portsmouth typically run £60–£80/hour. Use it as a market-rate reference for your next quote, or as a buyer\u2019s guide to a fair price.',
  keyTakeaways: [
  ...
  sections: [
    {
      id: 'typical-prices',
      heading: 'Typical Consumer Unit Replacement Prices in Portsmouth (2026)',
      tocLabel: 'Typical prices',
      blocks: [
        {
          type: 'paragraph',
          text: 'These are working prices for Portsmouth based on competent-person scheme members in the area, current copper / steel pricing, and typical labour. Each scenario assumes a same-day swap with no unexpected remedial work.',
        },
        {
          type: 'list',
          ordered: false,
    ...
    },
    {
      ...
      blocks: [
        {
          type: 'paragraph',
          text: 'A compliant consumer unit replacement in Portsmouth should include all of the following — anything missing should be flagged in the quote:',
        },
        {
          type: 'list',
          ordered: false,
    ...
    },
    {
      ...
      blocks: [
        {
          type: 'paragraph',
          text: 'Beyond the board itself, six factors push the final Portsmouth price into the upper band:',
        },
        {
          type: 'list',
          ordered: true,
    ...
    {
      id: 'for-electricians',
      heading: 'For Electricians: Quote CU Replacements in Portsmouth at the Right Price',
      ...
      blocks: [
        ...
        },
        {
          ...
          body:
            'Elec-Mate gives Portsmouth electricians the tools to scan the existing board, generate an itemised quote with RCBOs, SPDs, AFDDs and labour, and issue the EIC on-site. 7-day free trial.',
        },
        {
          type: 'paragraph',
  ...
  faqs: [
    {
      question: 'How much does it cost to replace a consumer unit in Portsmouth?',
      answer: 'A typical 10–14 way domestic consumer unit replacement in Portsmouth costs £493–790 in 2026, including the new metal-clad board, all RCBOs, surge protection, labour and the EIC. Larger or HMO-spec boards push toward £948+.',
    },
    {
    ...
    },
    {
      ...
      answer: 'Sometimes — a competent person can add an RCD upstream of an existing board as a stop-gap. However if the board is old, plastic, or has missing labelling, the EICR will continue to flag observations. For most Portsmouth properties, a full replacement is the better long-term option.',
    },
  ],
  howToHeading: 'How to Book a Consumer Unit Replacement in Portsmouth',
  howToDescription:
  ...
  relatedPages: [
    ...
    {
      href: '/guides/consumer-unit-replacement-cost-brighton',
      title: 'Consumer unit replacement cost in Brighton',
  ...
  ctaHeading: 'For Electricians: Quote CU Swaps in Portsmouth',
  ctaSubheading:
