...
export const eicrPlasticConsumerUnitHmoConfig: GeneratedGuideConfig = {
  ...
  keyTakeaways: [
    'Regulation 421.1.201 of BS 7671 (introduced January 2016 in BS 7671:2008+A3 and retained through A4:2026) requires consumer units in domestic premises to have a non-combustible enclosure.',
    ...
    'Remedial options: full consumer unit replacement to a metal-enclosed unit (most common); retrofit a metal enclosure around the existing CU (rare, manufacturer-specific); upgrade to RCBOs in a metal-clad replacement (best practice combining 421.1.201 + 411.3.4 A4 compliance).',
      ...
      blocks: [
        {
          type: 'paragraph',
          text:
            'For a plastic consumer unit installed pre-2016, the classification on the EICR depends on the physical context — particularly the fire-spread implications. Three typical scenarios:',
        },
        {
          type: 'list',
          items: [
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          ordered: true,
          items: [
            '**Full consumer unit replacement to metal-enclosed all-RCBO unit** — the most thorough option. The new CU also addresses A4:2026 requirements: 411.3.4 luminaire RCD protection (every circuit on its own 30 mA RCBO), 421.1.6/7 AFDD where required, SPD where the risk assessment indicates. Typical UK trade cost £700-£1,500 depending on board size, complexity, and any associated remedial work needed on the circuits.',
            '**Replacement to metal-enclosed unit retaining existing MCB protection** — cheaper than full RCBO replacement but loses the A4 luminaire-RCD benefit. Some inspectors flag this as inadequate where the EICR also has C2/C3 observations on missing luminaire RCD protection (411.3.4).',
            '**Metal-enclosing retrofit (rare)** — some manufacturers offer steel retrofit cabinets that go around an existing plastic CU. Verify against the BS 7671 Regulation 421.1.201 non-combustibility requirement and the manufacturer\'s installation instructions. Less common than full replacement.',
          ],
        },
      ],
    },
  ...
  faqs: [
    {
      question: 'My HMO consumer unit is plastic but it\'s in a locked meter cupboard outside the escape route. Is that still a C2?',
      answer:
    ...
    },
    {
      ...
      answer:
        'Regulation 421.1.201 of BS 7671:2018+A4:2026 requires consumer units and similar switchgear assemblies in domestic (household) premises to either be enclosed in a non-combustible enclosure, or to have measures to ensure that any fire originating within the assembly cannot spread to combustible surrounding materials. In practice, this means a steel-enclosed consumer unit. The regulation was introduced in BS 7671:2008+A3 (effective January 2016) and is retained unchanged in A4:2026.',
    },
    {
  ...
  relatedPages: [
    {
      ...
      description: 'How C2 observations affect the overall EICR assessment and PRS Regs 2020 timeline.',
      icon: 'AlertTriangle',
      category: 'Guide',
    },
    {
    ...
    },
    {
      ...
      description: 'The other classic UK domestic C2 — often found alongside plastic CU on HMO inspections.',
      icon: 'AlertTriangle',
      category: 'Guide',
    },
    {
      ...
      description: 'Why a CU replacement is the right time to add 30 mA RCD on every luminaire circuit (Regulation 411.3.4).',
      icon: 'ShieldCheck',
      category: 'Guide',
    },
    {
      ...
      description: 'Digital A4:2026 EICR with HMO-aware C2/C3 observation library for plastic consumer units.',
      icon: 'FileCheck2',
      category: 'Tool',
    },
    {
      ...
      description: 'Issue the EIC for the consumer unit replacement — three-signatory model form, A4:2026 compliant.',
      icon: 'FileCheck2',
      category: 'Tool',
    },
  ],
