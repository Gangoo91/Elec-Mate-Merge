...
// Apprentice revision page for City & Guilds 2346-03 Unit 102.
...
export const unitRevision234603Unit102Config: GeneratedGuideConfig = {
  pagePath: '/guides/2346-03-unit-102-apply-health-safety-and-environmental-considerations-revision',
  title: 'City & Guilds 2346-03 Unit 102 Revision Guide',
  description: 'Complete revision guide for City & Guilds 2346-03 Unit 102 (Apply Health, Safety and Environmental Considerations).',
  ...
  heroPrefix: 'City & Guilds 2346-03 Unit 102:',
  heroHighlight: 'Apply Health, Safety and Environmental Considerations',
  heroSuffix: '— Complete Revision Guide',
  heroSubtitle:
    'A structured revision walkthrough of every topic in City & Guilds 2346-03 Unit 102 (Apply Health, Safety and Environmental Considerations). Use it as a personal study checklist — work through each topic, tick off the points you can confidently explain or calculate, and use the linked Elec-Mate tools to practice the calculation-led parts. Designed for experienced workers consolidating skills outside a formal apprenticeship.',
  keyTakeaways: [
    'City & Guilds 2346-03 Unit 102 — Apply Health, Safety and Environmental Considerations — is a core component of the Electrotechnical Experienced Worker Qualification.',
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          ordered: false,
          items: [
            'Demonstrate appropriate procedures for the safe handling, storage and disposal of hazardous materials and products, in accordance with one of the following: Environmental Protection Act, Hazardous Waste Regulations, Pollution Prevention and Control Act, Control of Pollution Act, Control of Noise at Work Regulations, Environment Act.',
          ],
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          body:
            'The Elec-Mate apprentice tier includes mock exams, flashcards, and revision notes for City & Guilds 2346-03 Unit 102 plus every other unit in your qualification. 7-day free trial — see your progress on the tutor dashboard.',
        },
      ],
    },
  ],
  faqs: [
    {
      question: 'What does City & Guilds 2346-03 Unit 102 cover?',
    ...
    },
    {
      ...
      answer: 'Unit 102 is one of several units that together make up the Electrotechnical Experienced Worker Qualification. Passing every unit and the end-point assessment (AM2 or equivalent) earns you the full qualification. Check the unit overview in our City & Guilds qualification hub for the full unit list.',
    },
  ],
  howToHeading: 'A Five-Step Revision Plan for This Unit',
  howToDescription:
    'A repeatable approach that works for City & Guilds 2346-03 Unit 102 and every other unit in your qualification.',
  howToSteps: [
    {
  ...
  ctaHeading: 'For Apprentices: Pass City & Guilds 2346-03 Unit 102 with Confidence',
  ctaSubheading:
