...
// Section 722 + Section 712), IET Code of Practice for Electric Vehicle Charging
...
export const v2hBidirectionalEvChargingConfig: GeneratedGuideConfig = {
  ...
  heroSubtitle:
    'Vehicle-to-Home (V2H) bidirectional charging turns a parked electric vehicle into a multi-tens-of-kWh home battery — large enough to run a typical UK household for several days off-grid and to arbitrage Octopus Intelligent tariffs profitably. For UK electricians, the install brings together BS 7671 Section 722, Section 712, the IET Code of Practice for EV Charging (5th Edition), Engineering Recommendation G99, and the Electric Vehicles (Smart Charge Points) Regulations 2021. This guide walks through the technology, the architecture choices, the DNO paperwork and the EICR implications.',
  keyTakeaways: [
    ...
    'V2H installations split between DC-coupled (charger handles both rectification and inversion, vehicle exports raw DC) and AC-coupled (vehicle exports AC via its onboard inverter, charger acts as a contactor and meter) — the architecture drives the inverter selection and the BS 7671 Section 712 treatment.',
    'BS 7671:2018+A4:2026 Section 712 governs prosumer electrical installations — a V2H charger that exports into the dwelling is a prosumer source and must be designed to Section 712, not just Section 722.',
      ...
      blocks: [
        {
          type: 'paragraph',
          text:
            'Three acronyms get used interchangeably in marketing copy, but they describe materially different installations with materially different paperwork. Before specifying a charger, the electrician must know which one the client actually wants — the DNO notification, the inverter rating and the BS 7671 treatment all change.',
        },
        {
          type: 'list',
          ordered: true,
        ...
        },
        {
          ...
          text:
            'When a client says "bidirectional charger" they almost always mean V2H — lower bills via tariff arbitrage and backup for outages. Only a small minority want true V2G with grid export. Confirm before quoting — V2G needs a flexibility platform contract, export meter and full G99 notification.',
        },
        {
          type: 'paragraph',
          text:
            'For the underlying BS 7671 framework that governs all three modes, see our [Section 722 EV charging A4:2026 changes guide](/guides/section-722-ev-charging-a4-2026-changes). For the prosumer interaction rules that apply to V2H and V2G, see [Section 712 prosumer A4:2026](/guides/section-712-prosumer-a4-2026).',
        },
      ],
    },
    {
      ...
      blocks: [
        {
          type: 'paragraph',
          text:
            'The connector determines whether bidirectional charging works at all. The two DC fast-charge standards on the UK road — CHAdeMO and CCS Combo 2 — have very different bidirectional histories.',
        },
        {
          type: 'list',
          items: [
        ...
        },
        {
          ...
          text:
            'Bidirectional capability is firmware-controlled and model-year-specific. A 2024 Hyundai Ioniq 5 may not support bidirectional via CCS while a 2026 Ioniq 5 of the same trim does. Always check the manufacturer documentation for the specific model year and trim before specifying the charger.',
        },
      ],
    },
    {
      ...
      blocks: [
        {
          type: 'paragraph',
          text:
            'ISO 15118 defines how an EV and a charger talk beyond the basic "cable plugged in" pilot signal. ISO 15118-2 (2014) defined Plug & Charge and basic high-level communication. ISO 15118-20 (2022) is the bidirectional extension — the standard that turns the vehicle from a passive load into a managed two-way power source.',
        },
        {
          type: 'list',
          items: [
        ...
        },
        {
          type: 'paragraph',
          text:
            'For UK installs in 2026, the practical implication is that the charger and vehicle must be a matched pair from a tested compatibility list. Wallbox Quasar 2, Indra V2H, dcbel r16 and EVTec hybrid units publish compatibility matrices — treat these as gospel.',
        },
      ],
    },
    {
      ...
      blocks: [
        {
          type: 'paragraph',
          text:
            'A bidirectional charger converts between the DC inside the vehicle battery and the AC inside the dwelling. Where that conversion happens — inside the charger (DC-coupled) or inside the vehicle (AC-coupled) — drives the inverter rating, the cable size, the BS 7671 treatment and the cost.',
        },
        {
          type: 'list',
          ordered: true,
        ...
        },
        {
          ...
          text:
            'A DC-coupled charger is the prosumer source under BS 7671 Section 712 and needs a substantial AC feed (typically 32-40 A radial). An AC-coupled charger has the same supply but the vehicle is the prosumer source. The Section 712 cabling, isolation and labelling requirements apply to whichever device is the AC-side inverter — get the architecture wrong on the design and the isolation arrangements end up in the wrong place.',
        },
      ],
    },
    {
      ...
      blocks: [
        {
          type: 'paragraph',
          text:
            'A bidirectional EV charger\'s inverter has to do two jobs normally done by two products. In grid-tied mode it synchronises with the public supply. In island mode (grid down) it becomes the voltage and frequency reference for the dwelling — the role of an uninterruptible power supply.',
        },
        {
          type: 'list',
          items: [
            ...
            'Transfer between modes requires a transfer switch (manual or automatic) and protection against back-feeding the grid during an outage. The transfer switch is a Section 712 component and must be labelled, isolatable and accessible.',
        ...
        },
        {
          ...
          text:
            'Many cheaper bidirectional units only support grid-tied export — when the grid goes down, the charger disconnects under G99 anti-islanding and the household loses power even though the vehicle is full. If the customer wants backup during an outage, confirm true grid-forming island-mode capability and specify a transfer switch. Often a £1,000-£2,000 cost premium over basic V2H.',
        },
      ],
    },
    {
      id: 'section-712-prosumer',
      heading: 'BS 7671 Section 712 — Prosumer Interaction',
      tocLabel: 'Section 712 prosumer',
      blocks: [
        {
          type: 'paragraph',
          text:
            'BS 7671:2018+A4:2026 introduced expanded Section 712 coverage for "prosumer" installations — dwellings that both consume and produce electricity. A V2H bidirectional EV charger is a prosumer source, and Section 712 governs how it integrates with the rest of the installation.',
        },
        {
          type: 'list',
          items: [
            ...
            'Protective coordination with the dwelling\'s main earthing and bonding. For TN-C-S (PNB) supplies, A4:2026 brought specific requirements for the earthing arrangement at the inverter and any island-mode transfer contactor.',
        ...
        },
        {
          type: 'paragraph',
          text:
            'For a deeper walk-through of the prosumer rules introduced in A4:2026, see our [Section 712 prosumer A4:2026 guide](/guides/section-712-prosumer-a4-2026). For the EV-specific Section 722 changes, see our [Section 722 EV charging A4:2026 changes](/guides/section-722-ev-charging-a4-2026-changes).',
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          text:
            'G99 Fast Track requires prior approval. Installing a bidirectional charger and only notifying afterwards is non-compliant and can lead to disconnection orders. Build the 10-working-day response into the project programme — start the application as soon as equipment is selected.',
        },
      ],
    },
    {
      ...
      blocks: [
        {
          type: 'paragraph',
          text:
            'The most compelling V2H pitch is "you keep the lights on when the grid goes down". Delivering this requires a transfer switch, careful earthing design and a clear understanding of which circuits will be supplied during an outage.',
        },
        {
          type: 'list',
          items: [
            'Transfer switch — disconnects the dwelling from the grid and connects it to the inverter when the grid fails. Manual (cheaper, customer operated) or automatic (seamless). A Section 712 component — must be labelled and accessible.',
            ...
            'Neutral-earth bonding — in island mode the dwelling is no longer referenced to the substation neutral. A bond must be re-established at the inverter side of the transfer switch, otherwise RCDs cannot trip on L-PE faults.',
        ...
        },
        {
          ...
          text:
            'A typical UK household consumes 8-12 kWh per day. A 60 kWh battery can supply the dwelling for 5-7 days if drained to a low SOC. In practice most V2H installs set a 20-30% reserve so the vehicle remains drivable, giving 3-5 days of practical backup — far longer than any home battery on the market.',
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        },
        {
          type: 'paragraph',
          text:
            'For the broader smart-tariff context that V2H plugs into, see our [smart EV charging guide](/guides/smart-ev-charging). For the underlying unidirectional install that precedes any bidirectional upgrade, see [EV charger installation](/guides/ev-charger-installation).',
        },
      ],
    },
    {
      ...
      blocks: [
        {
          type: 'paragraph',
          text:
            'A bidirectional EV charger is a relatively new beast on a periodic inspection — by 2026 inspectors are starting to encounter them on EICRs. Coding follows prosumer-install logic with EV-specific overlays from Section 722.',
        },
        {
          type: 'list',
          items: [
            'C1 — missing prosumer labelling that prevents an isolator being identified, absence of the lockable isolator required by Section 712, broken or bypassed island-mode bonding contactor leaving the inverter floating during an outage.',
            'C2 — Type AC or Type A RCD without separate DC fault detection on a bidirectional unit (Section 722 requires Type B or A+DC-detection), inadequate overcurrent coordination, G99 unit installed without DNO notification.',
        ...
        },
        {
          ...
          text:
            'Even after the main switch is off, a bidirectional charger can have the vehicle as a live source. Safe isolation must isolate the vehicle too — disconnect the charging cable or lock off the local isolator while the vehicle is unplugged. A Section 712 requirement that gets missed on inspections of hastily-commissioned units.',
        },
      ],
    },
    {
      ...
      blocks: [
        {
          type: 'paragraph',
          text:
            'Vehicle manufacturers vary on whether V2H/V2G affects the battery warranty. Some explicitly support it (Nissan); others are silent; others exclude V2X from cover.',
        },
        {
          type: 'list',
          items: [
        ...
        },
        {
          ...
          text:
            'A customer who finds the install voids their battery warranty will not be happy. Ask them to confirm with the vehicle manufacturer or dealer that bidirectional usage is permitted under their warranty, and document the confirmation in the project file.',
        },
      ],
    },
    {
      ...
      blocks: [
        {
          type: 'paragraph',
          text:
            'Part P covers electrical safety in dwellings in England and Wales (Scotland and Northern Ireland have parallel arrangements). A V2H bidirectional charger installation is notifiable — via a Competent Person Scheme (NICEIC, NAPIT, Stroma, ELECSA) or direct notification to local authority Building Control.',
        },
        {
          type: 'list',
          items: [
  ...
  howToDescription:
    'The end-to-end sequence from initial customer conversation to commissioned, DNO-notified, EICR-friendly V2H install — based on BS 7671:2018+A4:2026, G99, the IET Code of Practice for EV Charging (5th Edition) and the Electric Vehicles (Smart Charge Points) Regulations 2021.',
  howToSteps: [
    {
      name: 'Confirm V2H vs V2G vs V2L with the customer',
      text:
        'Establish whether the customer wants tariff arbitrage only (V2H), grid export and flexibility income (V2G), or a portable AC outlet on the vehicle (V2L). The DNO paperwork, inverter rating and BS 7671 treatment differ for each. Most domestic customers want V2H — confirm before quoting.',
    },
    {
      name: 'Verify vehicle compatibility against the charger matrix',
      text:
        'Take the exact vehicle make, model, model year, trim and software version. Cross-reference against the charger manufacturer\'s compatibility matrix (Wallbox Quasar 2, Indra V2H, dcbel r16, EVTec hybrid) and the ISO 15118-20 conformance status. Document the match in the design file.',
    },
    {
      name: 'Survey the supply, consumer unit and earthing arrangement',
      text:
        'Confirm meter-tail capacity, consumer unit spare ways, earthing arrangement (TN-C-S/PNB, TN-S or TT) and the route to the charger location. A 7-11 kW bidirectional unit typically needs a 32-40 A radial. Check A4:2026 Section 722 earthing requirements for the supply type.',
    },
    {
      name: 'Submit the G99 (or G98) application to the DNO',
      text:
        'Use the ENA Connect Direct portal to submit a G99 Fast Track application for the specific Type Tested unit. Most domestic V2H units complete in 10 working days. Do not energise before approval. Where an export limiter keeps the install under G98, lodge a G98 fit-and-inform notification instead.',
    },
    {
      name: 'Install per BS 7671 Section 722 and Section 712',
      text:
        'Install the dedicated supply with Type B RCD (or Type A with DC fault detection), lockable local isolator, prosumer labelling per Section 712, and the earthing arrangements required for the supply type. For island-mode, fit the transfer switch and backup-only consumer unit with neutral-earth bonding correctly configured. Issue the EIC on completion.',
    },
    {
      name: 'Commission, notify via CPS and brief the customer',
      text:
        'Commission per manufacturer instructions, verify bidirectional operation with the actual customer vehicle, confirm anti-islanding under G99, and notify Building Control via the relevant Competent Person Scheme. Brief the customer on the transfer switch, SOC reserve, tariff configuration and the safe-isolation procedure.',
    },
  ],
  faqs: [
    {
    ...
    {
      question: 'How does V2H interact with BS 7671 Section 712?',
      answer:
        'A V2H bidirectional charger is a prosumer source under BS 7671:2018+A4:2026 Section 712. The installation must include prosumer labelling, a dedicated lockable isolator, protective coordination with the dwelling\'s main earthing and bonding (with specific TN-C-S/PNB requirements under A4:2026), Type B RCDs as required by Section 722, and overcurrent coordination between the CU breaker and the inverter\'s downstream protection.',
    },
    {
  ...
  relatedPages: [
    ...
    },
    {
      ...
      description: 'The expanded prosumer interaction rules in Amendment 4:2026 — labelling, isolation, protective coordination, and how V2H fits into the prosumer framework.',
      icon: 'BookOpen',
      category: 'Guide',
    },
    {
  ...
  ctaSubheading:
    'Elec-Mate gives UK electricians the tools to design, install and certify bidirectional EV charging to BS 7671:2018+A4:2026 — Section 722 EV charging logic, Section 712 prosumer labelling, G99 notification checklists, EIC and EICR generation, all on the Electrician subscription. 7-day free trial, cancel anytime.',
};
