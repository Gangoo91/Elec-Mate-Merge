...
export const v2hBidirectionalEvChargingConfig: GeneratedGuideConfig = {
  ...
  answerBox: {
    question: 'What is V2H bidirectional EV charging and how is it installed in the UK?',
    answer:
      "V2H (Vehicle-to-Home) lets an EV discharge back into the dwelling — turning the car into a large home battery for tariff arbitrage and outage backup, without selling power to the grid. In the UK the install is governed by BS 7671 Section 722 and Chapter 82 (Prosumer's Electrical Installations), needs a G99 DNO notification, Building Regulations Part P notification and an EIC, and uses a Type B RCD (or Type A with 6 mA DC fault detection) under Reg 722.531.3.101.",
  },
  keyTakeaways: [
    ...
    "BS 7671:2018+A4:2026 Chapter 82 governs Prosumer's Electrical Installations (PEIs) — a V2H charger that exports into the dwelling is a prosumer source and must be designed to Chapter 82 alongside Section 722. Section 712 governs solar PV systems only, so a vehicle source is treated under Section 722 and Chapter 82, not Section 712. BS 7671 makes the link explicit: Reg 722.826.3.201 takes account of prosumer's electrical installations, and a note in Chapter 57 (Stationary Secondary Batteries) directs you to Section 722 and Chapter 82 for the supply of a fixed installation by electric vehicles.",
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            'RCD selection — Reg 722.531.3.101 requires each EV charging point to be protected by an RCD, with protection against d.c. fault current provided either by a Type B RCD or by a Type A RCD with a residual direct current detecting device (RDC-DD) that detects smooth d.c. residual current at or above 6 mA (BS IEC 62955). The same applies to bidirectional units, with additional consideration where d.c. injection could occur during export.',
