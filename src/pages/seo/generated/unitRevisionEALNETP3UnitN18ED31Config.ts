...
// Apprentice revision page for EAL NETP3 Unit N18ED3/1.
...
export const unitRevisionEALNETP3UnitN18ED31Config: GeneratedGuideConfig = {
  ...
  breadcrumbLabel: 'Unit N18ED3/1 Revision',
  heroPrefix: 'EAL NETP3 Unit N18ED3/1:',
  heroHighlight: 'Understand the Requirements for Electrical Installations BS 7671:2018',
  heroSuffix: '— Complete Revision Guide',
  heroSubtitle:
    'A structured revision walkthrough of every topic in EAL NETP3 Unit N18ED3/1 (Understand the Requirements for Electrical Installations BS 7671:2018). Use it as a personal study checklist — work through each topic, tick off the points you can confidently explain or calculate, and use the linked Elec-Mate tools to practice the calculation-led parts. Designed for apprentices and adult learners on the EAL NVQ pathway.',
  keyTakeaways: [
    'EAL NETP3 Unit N18ED3/1 — Understand the Requirements for Electrical Installations BS 7671:2018 — is a core component of the EAL Level 3 NVQ in Electrotechnical Practice.',
    'This unit is typically delivered to apprentices and adult learners on the EAL NVQ pathway and covers 8 main topic areas.',
    'Across the 8 topics there are 16 specific points you should be able to explain, demonstrate or calculate before the end-of-unit assessment.',
  ...
  sections: [
    ...
    {
      id: 'topic-2',
      heading: 'Topic 2: The scope, object and fundamental principles of BS 7671',
      tocLabel: 'Topic 2',
      blocks: [
        {
          type: 'paragraph',
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            'Interpret how this applies to electrical installations including protection against electric shock, thermal effects, overcurrent, voltage disturbances and electromagnetic disturbances, isolation and switching.',
          ],
        },
      ],
    },
    {
      id: 'topic-5',
      heading: 'Topic 5: The requirements for selecting and erecting equipment',
      tocLabel: 'Topic 5',
      blocks: [
        {
          type: 'paragraph',
        ...
        },
        {
          ...
          items: [
            ...
            'Interpret how this applies to electrical installations including common rules, wiring systems, protection, isolation, switching, control and monitoring, earthing arrangements and protective conductors, other equipment, and safety services.',
          ],
        },
      ],
    },
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            'Interpret how these effect the general requirements of the regulations.',
          ],
        },
      ],
    },
    {
      id: 'topic-8',
      heading: 'Topic 8: The information contained within the appendices of BS 7671',
      tocLabel: 'Topic 8',
      blocks: [
        {
          type: 'paragraph',
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          body:
            'The Elec-Mate apprentice tier includes mock exams, flashcards, and revision notes for EAL NETP3 Unit N18ED3/1 plus every other unit in your qualification. 7-day free trial — see your progress on the tutor dashboard.',
        },
      ],
    },
  ],
  faqs: [
    {
      question: 'What does EAL NETP3 Unit N18ED3/1 cover?',
      answer: 'Unit N18ED3/1 (Understand the Requirements for Electrical Installations BS 7671:2018) covers 8 main topic areas: The scope, object and fundamental principles of BS 7671; The scope, object and fundamental principles of BS 7671; How to assess the general characteristics of electrical installations; Requirements of protection for safety for electrical installations; The requirements for selecting and erecting equipment; The requirements of inspection and testing of electrical installations; The requirements of special installations or locations as identified in BS 7671; The information contained within the appendices of BS 7671. Each topic has specific points you should be able to explain, demonstrate or calculate.',
    },
    {
    ...
    },
    {
      ...
      answer: 'EAL Level 3 NVQ in Electrotechnical Practice units are typically delivered across the apprenticeship in college-block weeks. Unit N18ED3/1 is usually delivered to apprentices and adult learners on the EAL NVQ pathway. Check your individual learning plan with your tutor for exact timing.',
    },
    {
    ...
    },
    {
      ...
      answer: 'Unit N18ED3/1 is one of several units that together make up the EAL Level 3 NVQ in Electrotechnical Practice. Passing every unit and the end-point assessment (AM2 or equivalent) earns you the full qualification. Check the unit overview in our City & Guilds qualification hub for the full unit list.',
    },
  ],
  howToHeading: 'A Five-Step Revision Plan for This Unit',
  howToDescription:
    'A repeatable approach that works for EAL NETP3 Unit N18ED3/1 and every other unit in your qualification.',
  howToSteps: [
    {
  ...
  ctaHeading: 'For Apprentices: Pass EAL NETP3 Unit N18ED3/1 with Confidence',
  ctaSubheading:
