...
// Electrical business owner / employer guide. Audience: electricians applying for their first scheme membership or considering switching.
...
export const NiceicVsNapitRegistrationConfig: GeneratedGuideConfig = {
  pagePath: '/guides/niceic-vs-napit-registration',
  title: 'NICEIC vs NAPIT — Which Competent Person Scheme?',
  description: 'A detailed 2026 comparison of NICEIC and NAPIT, the two largest competent person schemes for UK electricians.',
  datePublished: published,
  dateModified: modified,
  readingTime: 12,
  badge: 'Business Owner Guide',
  badgeIcon: 'Briefcase',
  breadcrumbLabel: 'NICEIC vs NAPIT — Which Competen...',
  heroPrefix: 'NICEIC vs NAPIT — Which Competent Person Scheme?:',
  heroHighlight: 'Practical 2026 Guide',
  heroSuffix: '— For UK Electrical Contractors',
  heroSubtitle:
    'A detailed 2026 comparison of NICEIC and NAPIT, the two largest competent person schemes for UK electricians. Both let you self-certify Part P work and are equivalent in industry recognition — but cost, assessor availability, and contractor support differ. This guide is for electricians applying for their first scheme membership or considering switching.',
  keyTakeaways: [
  ...
  sections: [
    ...
    },
    {
      ...
      tocLabel: 'Side-by-Side Comparison',
      blocks: [
        {
          type: 'paragraph',
          text: 'Annual fee: NICEIC ~£550 / NAPIT ~£480. Initial assessment: NICEIC £300-500 / NAPIT £280-450. Market share: NICEIC ~55% / NAPIT ~25%. Self-certification of Part P: both. Technical helpline: both. Insurance broker recognition: both equally recognised. Choose NICEIC if your area has a NICEIC assessor closer + your insurer specifies. Choose NAPIT if you want multi-trade scheme membership + slightly lower fees.',
        },
      ],
    },
    {
      id: 'application-process',
      heading: 'The Application Process (Either Scheme)',
      tocLabel: 'The Application Proces...',
      blocks: [
        {
          type: 'paragraph',
          text: 'Apply via the scheme\u2019s online portal. Submit: your qualifications (Level 3 / AM2 / 18th Edition / 2391 or equivalent), insurance certificates, sample of certified work (typically 5-10 certified jobs), QMS / health and safety documentation. Wait for assessor visit (4-12 weeks). Assessor reviews 2-3 sample jobs on site + your paperwork. Pass: scheme membership granted. Annual re-audit thereafter.',
        },
      ],
    },
    {
      id: 'after-membership',
      heading: 'After Joining the Scheme',
      tocLabel: 'After Joining the Scheme',
      blocks: [
        {
          type: 'paragraph',
          text: 'Notification of work via the scheme portal — every Part P notifiable job is notified. Scheme issues the building control compliance certificate. Annual audit visit (typically 2-4 hours on site). Pay attention to: scheme correspondence (deadlines for renewal, audit dates), MTR (Minor Works) and EIC paperwork standards, customer-facing scheme branding (you can use the logo).',
        },
      ],
    },
    {
  ...
  faqs: [
    {
      ...
      answer: 'This guide is written for electricians applying for their first scheme membership or considering switching. The advice is practical, UK-specific, and based on 2026 regulations and market rates.',
    },
    {
