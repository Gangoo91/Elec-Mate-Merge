...
// Programmatically generated EICR cost landing page for Cambridge.
...
export const eicrCostCambridgeConfig: GeneratedGuideConfig = {
  pagePath: '/guides/eicr-cost-cambridge',
  title: 'EICR Cost Cambridge 2026 — Domestic & Commercial Pricing',
  description: 'How much does an EICR cost in Cambridge? Fair-margin 2026 prices for scheme-registered electricians — £270–370 for a 1-bed, £410–550 for a 4-bed…',
  datePublished: published,
  dateModified: modified,
  readingTime: 7,
  badge: 'Cost Guide',
  badgeIcon: 'PoundSterling',
  breadcrumbLabel: 'EICR Cost in Cambridge',
  breadcrumbParent: { label: 'EICR Cost UK', href: '/guides/eicr-cost-uk' },
  heroPrefix: 'EICR Cost in Cambridge:',
  heroHighlight: '2026 Pricing Guide',
  heroSuffix: '— Domestic & Commercial',
  heroSubtitle:
    'Whether you are an electrician quoting EICRs in Cambridge or a landlord trying to understand the market rate, this guide gives the fair-margin 2026 prices charged by NICEIC and NAPIT scheme-registered electricians, what is included, and why below-market quotes are usually missing something. Hourly rates for inspection work in Cambridge run £70–£92, with a typical 3-bed terrace EICR landing at £330–440. Use it as a market-rate reference for your next quote, or as a buyer\u2019s guide to a fair price.',
  keyTakeaways: [
    'A 1-bed flat EICR in Cambridge typically costs £270–370, a 3-bed terrace £330–440, and a 4-bed house £410–550 (2026 prices for a scheme-registered electrician, excluding remedial work).',
    'Commercial EICRs in Cambridge are priced per socket / fitting — typically £19–28 per item, with minimum visit fees of £92–£138.',
    ...
    'Hourly rates for Cambridge sit at £70–£92 because a NICEIC / NAPIT registered electrician carries professional indemnity insurance, scheme fees, calibrated test equipment (typically £1,200+ MFT), and is liable for the certificate they sign.',
    ...
    'East of England\u2019s DNO is UK Power Networks. Any remedial work involving DNO notification (PME, supply upgrades) routes through them.',
  ...
  sections: [
    {
      id: 'typical-prices',
      heading: 'Typical EICR Prices in Cambridge (2026)',
      tocLabel: 'Typical prices',
      blocks: [
        {
          type: 'paragraph',
          text: 'Below is a working price guide for Cambridge based on competent-person scheme members operating in the area, hourly rate aggregates, and competitor pricing. Prices exclude any remedial work, which is quoted separately.',
        },
        {
          type: 'list',
          ordered: false,
          items: [
            '1-bedroom flat or maisonette — £270–370 (typically 1.5–2 hours on site)',
            '2-bedroom terrace — £330–418 (typically 2–3 hours)',
            '3-bedroom semi or terrace — £330–440 (typically 2.5–3.5 hours)',
            '4-bedroom detached — £410–550 (typically 3.5–5 hours)',
            '5+ bedroom / large houses — £633+ (priced on visit)',
            'Commercial property — £19–28 per socket / fitting with a minimum visit fee of £92–£138',
          ],
        },
        {
          type: 'callout',
    ...
    },
    {
      ...
      blocks: [
        {
          type: 'paragraph',
          text: 'Six factors push an EICR price up or down within Cambridge:',
        },
        {
          type: 'list',
          ordered: true,
    ...
    {
      id: 'when-required',
      heading: 'When You Need an EICR in Cambridge',
      tocLabel: 'When required',
      blocks: [
        {
          type: 'paragraph',
          text: 'EICRs are mandatory in several scenarios under UK regulation, regardless of East of England location:',
        },
        {
          type: 'list',
          ordered: false,
    ...
    {
      id: 'for-electricians',
      heading: 'For Electricians: Quote EICRs in Cambridge at the Right Price',
      tocLabel: 'For electricians',
      blocks: [
        {
          type: 'paragraph',
          text: 'If you are a self-employed electrician or small contractor working in Cambridge, this page is your local market-rate reference. The £330–440 band for a 3-bed terrace EICR is the fair-margin floor for a scheme-registered electrician — quoting below it means you are undercutting yourself before you start. Use the figures above to anchor your own quoting, with adjustments for property complexity, accessibility, and your scheme + insurance overhead.',
        },
        {
          type: 'callout',
          tone: 'info',
          ...
          body:
            'Elec-Mate gives Cambridge electricians voice-driven test entry, 16 certificate types, on-site Schedule of Test Results, and a professional PDF quote that the client cannot haggle. 7-day free trial — see how much faster you can quote and certify in your area.',
        },
        {
          type: 'paragraph',
    ...
    {
      id: 'get-a-quote',
      heading: 'For Property Owners: Booking an EICR in Cambridge',
      tocLabel: 'For property owners',
      blocks: [
        {
          type: 'paragraph',
          text: 'If you are a landlord, owner or managing agent in Cambridge looking for an EICR, Elec-Mate connects you to vetted competent-person scheme electricians. Send a brief — property type, postcode, last EICR date — and get a price from a local electrician. Most Cambridge jobs are booked within 5–10 working days, with same-day availability typical for smaller properties or urgent landlord deadlines under the Electrical Safety Standards in the Private Rented Sector Regulations 2020.',
        },
        {
          type: 'paragraph',
  ...
  faqs: [
    {
      question: 'How much does a standard EICR cost in Cambridge?',
      answer: 'For a 3-bedroom property in Cambridge the typical 2026 EICR price from a NICEIC or NAPIT scheme-registered electrician is £330–440, excluding any remedial work. Prices vary with property size, consumer unit condition, and number of circuits. Quotes substantially below this band usually mean the EIC certificate, RCD test sweep or insurance is missing — verify what is included.',
    },
    {
      question: 'How long is an EICR valid for in Cambridge?',
    ...
    {
      question: 'Who can carry out an EICR in Cambridge?',
    ...
    {
      question: 'Can I get a same-day EICR in Cambridge?',
      answer: 'Same-day or next-day EICRs are possible in Cambridge for smaller properties (1–2 bed) where an electrician is local and a slot is available. Larger jobs typically require 5–10 working days lead time.',
    },
  ],
  howToHeading: 'How to Book an EICR in Cambridge',
  howToDescription:
  ...
  howToSteps: [
    ...
    },
    {
      ...
      text: 'Use Elec-Mate to find vetted Cambridge electricians, or check NICEIC / NAPIT directories directly. Avoid trader-aggregator sites that bid jobs out without checking competence.',
    },
    {
  ...
  relatedPages: [
    ...
    {
      href: '/guides/eicr-cost-norwich',
      title: 'EICR cost in Norwich',
      description: 'Local price bands and labour rates for Norwich.',
      icon: 'MapPin',
      category: 'Guide',
    },
    {
      href: '/guides/eicr-cost-luton',
      title: 'EICR cost in Luton',
      description: 'Local price bands and labour rates for Luton.',
      icon: 'MapPin',
      category: 'Guide',
    },
    {
      href: '/electricians/cambridge',
      title: 'Find an Electrician in Cambridge',
      description: 'Vetted scheme-registered electricians in Cambridge.',
      icon: 'MapPin',
      category: 'Guide',
    },
    {
  ...
  ctaHeading: 'For Electricians: Quote and Certify EICRs in Cambridge',
  ctaSubheading:
