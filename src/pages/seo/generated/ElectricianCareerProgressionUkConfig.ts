...
// Electrician Career Progression in the UK — apprentice / electrician / employer content.
// Updated 2026-05-18.
...
export const ElectricianCareerProgressionUkConfig: GeneratedGuideConfig = {
  ...
  breadcrumbLabel: 'Electrician Career Progression i...',
  heroPrefix: 'Electrician Career Progression in the UK:',
  heroHighlight: 'Complete 2026 Guide',
  heroSuffix: '— For UK Electrical Trade',
  heroSubtitle:
    'A practical map of UK electrician career progression — the recognised roles, what they pay, how to move between them, and the qualifications / experience needed at each level. This guide is for qualified electricians thinking about their next career step.',
  keyTakeaways: [
  ...
  sections: [
    {
      id: 'the-ladder',
      heading: 'The Standard Career Ladder',
      tocLabel: 'The Standard Career Ladder',
      blocks: [
        {
          type: 'paragraph',
    ...
    {
      id: 'specialist-routes',
      heading: 'Specialist Routes',
      tocLabel: 'Specialist Routes',
      blocks: [
        {
          type: 'paragraph',
          text: 'Inspection & Testing specialist (C&G 2391 qualified) — £45-60k as employee, or £400-650/day as self-employed specialist. EV Charging specialist (OZEV-approved installer) — £40-55k employed; self-employed £75-110/hour for EV installs. Solar PV installer (MCS-certified) — £40-55k employed; self-employed £6-9k per installation. Industrial maintenance — £45-65k. Smart building / PoE / DALI / KNX specialist — £45-70k.',
        },
      ],
    },
    {
      id: 'qualifications-to-advance',
      heading: 'Qualifications That Advance Your Career',
      tocLabel: 'Qualifications That Advan...',
      blocks: [
        {
          type: 'paragraph',
          text: 'C&G 2391 Inspection and Testing — opens periodic-inspection specialist work + EICR contracts. C&G 2393 Wiring Regulations Amendment (updated for each Amendment) — needed for current scheme membership. C&G 2356 Senior Electrician — formal recognition of supervisor competence. OZEV EV charging installer — opens EV charger work + grant-funded jobs. MCS Solar PV installer — opens microgeneration work. Each adds ~£25-100 to the daily / weekly rate.',
        },
      ],
    },
    {
      id: 'self-employed-route',
      heading: 'Self-Employed Route',
      tocLabel: 'Self-Employed Route',
      blocks: [
        {
          type: 'paragraph',
          text: 'Many electricians transition from employed to self-employed sole trader, then limit company once revenue justifies it. Typical timeline: 5+ years post-AM2 before going self-employed (need site experience + customer relationships). 12-18 months to break even self-employed. 3-5 years to grow to multi-electrician firm (if that\u2019s the goal). See our "Starting an Electrical Business" guide for the detailed roadmap.',
        },
      ],
    },
    {
      id: 'project-management',
      heading: 'Project Management Route',
      tocLabel: 'Project Management Route',
      blocks: [
        {
          type: 'paragraph',
          text: 'Best for electricians who enjoy planning, customer-facing work, and team coordination. Typical path: Approved Electrician (3-5 years) → Senior with supervisor responsibility (5-7 years) → Project Manager (8-12 years). Additional qualifications useful: SSSTS or SMSTS (site supervisor / manager safety), Black Hat (NEBOSH), construction management courses. Peak earnings £55-85k employed.',
        },
      ],
    },
    {
      id: 'estimator-route',
      heading: 'Estimator Route',
      tocLabel: 'Estimator Route',
      blocks: [
        {
          type: 'paragraph',
          text: 'Best for electricians who enjoy detail, BS 7671 knowledge, and quoting. Path: Senior Electrician → trainee estimator (£40-50k) → senior estimator (£55-80k). Most successful estimators have 8-15 years on the tools first. Useful qualifications: City & Guilds 2356 (Senior Electrician), HND in Electrical Engineering, AutoCAD for electrical drawings, Trimble Accubid or similar estimating software.',
        },
      ],
    },
    {
  ...
  faqs: [
    { question: 'Who is this guide for?', answer: 'This guide is written for qualified electricians thinking about their next career step. The advice is practical, UK-specific, and based on current 2026 regulations.' },
  ...
  relatedPages: [
    ...
    {
      href: '/guides/jib-pay-scales-2026',
      title: 'JIB Pay Scales 2026',
      description: 'Related guide for qualified electricians thinking about their next career step.',
      icon: 'PoundSterling',
      category: 'Guide',
    },
    ...
    {
      href: '/guides/after-am2-what-happens-next',
      title: 'After AM2',
      description: 'Related guide for qualified electricians thinking about their next career step.',
      icon: 'GraduationCap',
      category: 'Guide',
