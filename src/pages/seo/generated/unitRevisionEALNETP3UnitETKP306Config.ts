...
// Apprentice revision page for EAL NETP3 Unit ETKP3-06.
...
export const unitRevisionEALNETP3UnitETKP306Config: GeneratedGuideConfig = {
  ...
  breadcrumbLabel: 'Unit ETKP3-06 Revision',
  heroPrefix: 'EAL NETP3 Unit ETKP3-06:',
  heroHighlight: 'Inspect, Test and Commission Electrical Systems',
  heroSuffix: '— Complete Revision Guide',
  heroSubtitle:
    'A structured revision walkthrough of every topic in EAL NETP3 Unit ETKP3-06 (Inspect, Test and Commission Electrical Systems). Use it as a personal study checklist — work through each topic, tick off the points you can confidently explain or calculate, and use the linked Elec-Mate tools to practice the calculation-led parts. Designed for apprentices and adult learners on the EAL NVQ pathway.',
  keyTakeaways: [
    'EAL NETP3 Unit ETKP3-06 — Inspect, Test and Commission Electrical Systems — is a core component of the EAL Level 3 NVQ in Electrotechnical Practice.',
  ...
  sections: [
    {
      id: 'topic-1',
      heading: 'Topic 1: How to confirm safety of the system and equipment prior to inspection, testing and commissioning',
      tocLabel: 'Topic 1',
      blocks: [
        {
          type: 'paragraph',
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            'Complete a schedule of inspections in accordance with BS 7671 and IET Guidance Note 3 making technical decisions.',
          ],
        },
      ],
    },
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            'Carry out tests in accordance with BS 7671 including continuity, insulation resistance, polarity, earth fault loop impedance, prospective fault current, RCD operation, and functional testing.',
            'Analyse and verify test results reporting all findings to relevant persons.',
            'Complete an Electrical Installation Certificate and a Minor Electrical Installation Works Certificate in accordance with BS 7671.',
            'Complete the handover of electrical systems including provision of accurate documentation regarding inspection, testing, commissioning and customer satisfaction.',
            'Demonstrate to the customer that the operation of circuits, equipment and components are in accordance with the installation specification.',
          ],
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          body:
            'The Elec-Mate apprentice tier includes mock exams, flashcards, and revision notes for EAL NETP3 Unit ETKP3-06 plus every other unit in your qualification. 7-day free trial — see your progress on the tutor dashboard.',
        },
      ],
    },
  ],
  faqs: [
    {
      question: 'What does EAL NETP3 Unit ETKP3-06 cover?',
      answer: 'Unit ETKP3-06 (Inspect, Test and Commission Electrical Systems) covers 3 main topic areas: How to confirm safety of the system and equipment prior to inspection, testing and commissioning; How to inspect electrical systems and equipment; How to test and commission electrical systems and equipment. Each topic has specific points you should be able to explain, demonstrate or calculate.',
    },
    {
    ...
    },
    {
      ...
      answer: 'EAL Level 3 NVQ in Electrotechnical Practice units are typically delivered across the apprenticeship in college-block weeks. Unit ETKP3-06 is usually delivered to apprentices and adult learners on the EAL NVQ pathway. Check your individual learning plan with your tutor for exact timing.',
    },
    {
    ...
    },
    {
      ...
      answer: 'Unit ETKP3-06 is one of several units that together make up the EAL Level 3 NVQ in Electrotechnical Practice. Passing every unit and the end-point assessment (AM2 or equivalent) earns you the full qualification. Check the unit overview in our City & Guilds qualification hub for the full unit list.',
    },
  ],
  howToHeading: 'A Five-Step Revision Plan for This Unit',
  howToDescription:
    'A repeatable approach that works for EAL NETP3 Unit ETKP3-06 and every other unit in your qualification.',
  howToSteps: [
    {
  ...
  ctaHeading: 'For Apprentices: Pass EAL NETP3 Unit ETKP3-06 with Confidence',
  ctaSubheading:
