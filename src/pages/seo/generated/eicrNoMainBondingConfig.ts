...
export const eicrNoMainBondingConfig: GeneratedGuideConfig = {
  ...
  sections: [
    ...
    },
    {
      ...
      blocks: [
        {
          type: 'paragraph',
          text: 'Verifying main protective bonding during EICR is a methodical walk-through of the service entry points:',
        },
        {
          type: 'list',
          ordered: true,
    ...
    },
    {
      ...
      blocks: [
        {
          type: 'paragraph',
          text: 'BS 7671 / IET GN3 give a strict hierarchy for observation coding (see the dedicated EICR Code C1, C2, C3 and FI guides). Missing main bonding is almost always C2 because:',
        },
        {
          type: 'list',
          items: [
        ...
        {
          type: 'paragraph',
          text: 'The single exception: where the structure has NO extraneous-conductive-parts (e.g., all-plastic plumbing from the boundary, no gas service, no metallic structural steel) — but the inspector MUST verify this and document the rationale on the EICR.',
        },
      ],
    },
    {
      ...
      blocks: [
        {
          type: 'paragraph',
          text: 'Main bonding conductor CSA depends on the earthing arrangement:',
        },
        {
          type: 'list',
          items: [
        ...
        },
        {
          ...
          text: 'Most UK domestic installations on a 100 A PME service install 10 mm² green-and-yellow conductor with a BS 951 clamp at each service. On larger services (e.g. 200 A) or three-phase domestic supplies, 16 mm² becomes the standard.',
        },
      ],
    },
    {
      ...
      blocks: [
        {
          type: 'paragraph',
          text: 'The remedial action for missing main bonding is straightforward: install the missing conductor(s). The specifics:',
        },
        {
          type: 'list',
          ordered: true,
  ...
  faqs: [
    {
      question:
        'My EICR says "C2 — no main protective bonding to incoming water service." What\'s the cost to fix?',
      answer:
    ...
    {
      question:
        'My house has metallic pipes inside but the supply pipe is plastic. Do I still need bonding?',
      answer:
    ...
    {
      question:
        'How long does the landlord have to fix a "no main bonding" C2 in a rented property?',
      answer:
  ...
  relatedPages: [
    {
      ...
      description:
        'How C2 observations are recorded on Section K and what the report assessment becomes.',
      icon: 'AlertTriangle',
      category: 'Guide',
    },
    {
      ...
      description:
        'The more serious "immediate danger" classification — typically not appropriate for missing bonding.',
      icon: 'AlertTriangle',
      category: 'Guide',
    },
    {
    ...
    },
    {
      ...
      description:
        'Digital A4:2026 EICR with built-in bonding observation library and remedial-quote conversion.',
      icon: 'FileCheck2',
      category: 'Tool',
    },
    {
