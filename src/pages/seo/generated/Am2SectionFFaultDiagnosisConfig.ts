...
// AM2 Section deep-dive — F. Apprentice-facing study guide for the end-point
...
export const Am2SectionFFaultDiagnosisConfig: GeneratedGuideConfig = {
  pagePath: '/guides/am2-section-f-fault-diagnosis',
  title: 'AM2 Section F — Diagnosis & Rectification of Faults',
  description: 'Complete study guide for AM2 Section F — Diagnosis & Rectification of Faults. Topics, time allocation, weighting, common mistakes…',
  datePublished: published,
  dateModified: modified,
  readingTime: 10,
  badge: 'AM2 Revision',
  badgeIcon: 'GraduationCap',
  breadcrumbLabel: 'AM2 Section F',
  heroPrefix: 'AM2 Section F — Diagnosis & Rectification of Faults',
  heroHighlight: 'Complete Study Guide',
  heroSuffix: '— ~60 minutes',
  heroSubtitle:
    'A timed fault-finding task. Apprentices are presented with an installation containing 3-4 deliberately-introduced faults and must safely diagnose and rectify them in time. This page is a focused study guide for Section F — Diagnosis & Rectification of Faults — topics, common mistakes, what assessors look for, and a 5-step revision plan.',
  keyTakeaways: [
    'Duration: ~60 minutes.',
    'Weighting: ~10% of the overall AM2 score.',
    'A timed fault-finding task. Apprentices are presented with an installation containing 3-4 deliberately-introduced faults and must safely diagnose and rectify them in time.',
    'There are 4 specific topic areas you should be confident with going in — listed in full below.',
  ...
  sections: [
    {
      ...
      blocks: [
        {
          type: 'paragraph',
          text: 'Below is a focused list of every topic area that comes up in AM2 Section F — Diagnosis & Rectification of Faults. Use it as a personal checklist — work through each one and confirm you can explain or demonstrate it without reference to notes.',
        },
        {
          type: 'list',
          ordered: false,
    ...
    },
    {
      ...
      blocks: [
        {
          type: 'paragraph',
          text: 'Most lost marks in AM2 Section F — Diagnosis & Rectification of Faults come from a handful of repeatable errors. Internalise these tips before the day:',
        },
        {
          type: 'list',
          ordered: true,
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          body:
            'Try a free AM2 Section F mock — see your scoring against the published weighting and identify weak topics before the real day. 7-day free trial.',
        },
      ],
    },
  ],
  faqs: [
    {
      question: 'How long is AM2 Section F — Diagnosis & Rectification of Faults?',
      answer: 'AM2 Section F — Diagnosis & Rectification of Faults runs for approximately ~60 minutes on the AM2 day. Time management is critical — most apprentices run short because they over-explain or rework early answers.',
    },
    {
      question: 'How much is AM2 Section F — Diagnosis & Rectification of Faults worth?',
  ...
  howToHeading: 'Five-Step Revision Plan for AM2 Section F — Diagnosis & Rectification of Faults',
  howToDescription:
  ...
  relatedPages: [
    {
      ...
      description: 'Practice Section F — Diagnosis & Rectification of Faults topics with a working tool.',
      icon: 'Calculator',
      category: 'Tool',
    },
    {
  ...
  ctaHeading: 'For Apprentices: Pass Section F — Diagnosis & Rectification of Faults With Confidence',
  ctaSubheading:
