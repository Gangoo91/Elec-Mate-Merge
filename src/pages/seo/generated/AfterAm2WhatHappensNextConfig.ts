...
// After AM2: What Happens Next? — apprentice / electrician / employer content.
// Updated 2026-05-18.

const published = '2026-05-18';
const modified = '2026-05-18';

export const AfterAm2WhatHappensNextConfig: GeneratedGuideConfig = {
  pagePath: '/guides/after-am2-what-happens-next',
  title: 'After AM2: What Happens Next? — 2026 Guide',
  description: 'A clear roadmap for the months after passing your AM2 end-point assessment. ECS Gold Card application, JIB grading, scheme membership…',
  datePublished: published,
  dateModified: modified,
  readingTime: 11,
  badge: 'Career Path',
  badgeIcon: 'GraduationCap',
  breadcrumbLabel: 'After AM2: What Happens Next?',
  heroPrefix: 'After AM2: What Happens Next?:',
  heroHighlight: 'Complete 2026 Guide',
  heroSuffix: '— For UK Electrical Trade',
  heroSubtitle:
    'A clear roadmap for the months after passing your AM2 end-point assessment. ECS Gold Card application, JIB grading, scheme membership, deciding employed vs self-employed, and the next 12 months. This guide is for apprentices about to take or just-passed AM2.',
  keyTakeaways: [
  ...
  faqs: [
    { question: 'Who is this guide for?', answer: 'This guide is written for apprentices about to take or just-passed AM2. The advice is practical, UK-specific, and based on current 2026 regulations.' },
