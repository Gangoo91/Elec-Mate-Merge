...
// Apprentice revision page for EAL Level 3 Unit TE3-06.
...
export const unitRevision6103907XUnitTE306Config: GeneratedGuideConfig = {
  ...
  breadcrumbLabel: 'Unit TE3-06 Revision',
  heroPrefix: 'EAL Level 3 Unit TE3-06:',
  heroHighlight: 'Practices and Procedures for Inspection, Testing and Commissioning',
  heroSuffix: '— Complete Revision Guide',
  heroSubtitle:
    'A structured revision walkthrough of every topic in EAL Level 3 Unit TE3-06 (Practices and Procedures for Inspection, Testing and Commissioning). Use it as a personal study checklist — work through each topic, tick off the points you can confidently explain or calculate, and use the linked Elec-Mate tools to practice the calculation-led parts. Designed for EAL Level 3 apprentices.',
  keyTakeaways: [
    'EAL Level 3 Unit TE3-06 — Practices and Procedures for Inspection, Testing and Commissioning — is a core component of the EAL Level 3 Electrotechnical Technical Occupational Entry qualification.',
    'This unit is typically delivered to EAL Level 3 apprentices and covers 3 main topic areas.',
    'Across the 3 topics there are 10 specific points you should be able to explain, demonstrate or calculate before the end-of-unit assessment.',
  ...
  sections: [
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            'Recognise the implications of not carrying out safe isolation.',
    ...
    {
      id: 'topic-2',
      heading: 'Topic 2: The requirements for the inspection of electrical installations',
      tocLabel: 'Topic 2',
      blocks: [
        {
          type: 'paragraph',
        ...
        },
        {
          ...
          ordered: false,
          items: [
            'State the purpose and requirements of the inspection of electrical installations.',
            'Identify the relevant documents associated with the with the inspection and testing.',
    ...
    {
      id: 'topic-3',
      heading: 'Topic 3: Regulation 642.2, Section 131, The general characteristics required by Sections 311 to 313. Information required by Regulation 514.9.1 (diagrams, charts, circuit schedules). And as applicable (for a PIR): previous inspection and test results, and the extent and limitations of the report.',
      tocLabel: 'Topic 3',
      blocks: [
        {
          type: 'paragraph',
        ...
        },
        {
          ...
          items: [
            ...
            'Recognise utilisation of human senses during the inspection process Typical examples to be covered..',
            'Specify the requirements for the inspection of electrical installations as detailed in the guidance for inspection in BS 7671 Refer to the complete list of items in Section 642, and GN3. Ensure learners understand the meaning, requirements and relevance of items to verified. Ensure coverage of.',
          ],
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          body:
            'The Elec-Mate apprentice tier includes mock exams, flashcards, and revision notes for EAL Level 3 Unit TE3-06 plus every other unit in your qualification. 7-day free trial — see your progress on the tutor dashboard.',
        },
      ],
    },
  ],
  faqs: [
    {
      question: 'What does EAL Level 3 Unit TE3-06 cover?',
      answer: 'Unit TE3-06 (Practices and Procedures for Inspection, Testing and Commissioning) covers 3 main topic areas: The requirements for completing the safe isolation of electrical circuits and installations; The requirements for the inspection of electrical installations; Regulation 642.2, Section 131, The general characteristics required by Sections 311 to 313. Information required by Regulation 514.9.1 (diagrams, charts, circuit schedules). And as applicable (for a PIR): previous inspection and test results, and the extent and limitations of the report.. Each topic has specific points you should be able to explain, demonstrate or calculate.',
    },
    {
    ...
    },
    {
      ...
      answer: 'EAL Level 3 Electrotechnical Technical Occupational Entry qualification units are typically delivered across the apprenticeship in college-block weeks. Unit TE3-06 is usually delivered to EAL Level 3 apprentices. Check your individual learning plan with your tutor for exact timing.',
    },
    {
  ...
  ctaHeading: 'For Apprentices: Pass EAL Level 3 Unit TE3-06 with Confidence',
  ctaSubheading:
