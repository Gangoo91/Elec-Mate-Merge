...
export const Nvq2357VsApprenticeshipStandard5357Config: GeneratedGuideConfig = {
  ...
  breadcrumbLabel: 'NVQ 2357 vs Apprenticeship Standard 5357',
  heroPrefix: 'NVQ 2357 vs Apprenticeship Standard 5357',
  heroHighlight: 'Which Pathway?',
  heroSuffix: '— UK 2026 Guide',
  heroSubtitle:
    'NVQ 2357 and the Apprenticeship Standard 5357 are the two main on-the-job evidence routes for UK electrical qualification. They sound similar but have different funding, structure, and end-point assessment. This guide explains the practical differences between the routes — audience, structure, time commitment, end-point assessment — so you can choose the right one for your situation.',
  keyTakeaways: [
  ...
  sections: [
    {
      id: 'nvq-2357',
      heading: 'NVQ 2357 — Level 3 NVQ Diploma in Installing Electrotechnical Systems and Equipment',
      tocLabel: 'NVQ 2357',
      blocks: [
        {
          type: 'paragraph',
          text: 'Audience: Adult learners, career-changers, experienced workers, those outside the funded apprenticeship route.',
        },
        {
          type: 'paragraph',
          text: 'Strengths:',
        },
        {
          ...
          ordered: false,
          items: [
            'Portfolio-based — evidence collected on real jobs.',
            'Suits adult learners, experienced workers and career-changers.',
            'Can be done alongside any compatible Level 3 Diploma.',
          ],
        },
        {
          type: 'paragraph',
          text: 'End-point / assessment: Portfolio + AM2 (where applicable).',
        },
      ],
    },
    {
      id: 'apprenticeship-standard-5357',
      heading: 'Apprenticeship Standard 5357 — Level 3 Electrotechnical Qualification — Apprenticeship Standard route',
      tocLabel: 'Apprenticeship Standard 5357',
      blocks: [
        {
          type: 'paragraph',
          text: 'Audience: New starters under the Apprenticeship Standard pathway (most 16-24 apprentices).',
        },
        {
          type: 'paragraph',
          text: 'Strengths:',
        ...
        {
          type: 'paragraph',
          text: 'End-point / assessment: AM2 end-point assessment (gateway-controlled).',
        },
      ],
    },
    {
