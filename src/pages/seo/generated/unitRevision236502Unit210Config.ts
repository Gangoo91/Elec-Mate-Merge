...
// Apprentice revision page for City & Guilds 2365-02 Unit 210.
...
export const unitRevision236502Unit210Config: GeneratedGuideConfig = {
  ...
  breadcrumbLabel: 'Unit 210 Revision',
  heroPrefix: 'City & Guilds 2365-02 Unit 210:',
  heroHighlight: 'Understand how to communicate with others within building services engineering',
  heroSuffix: '— Complete Revision Guide',
  heroSubtitle:
    'A structured revision walkthrough of every topic in City & Guilds 2365-02 Unit 210 (Understand how to communicate with others within building services engineering). Use it as a personal study checklist — work through each topic, tick off the points you can confidently explain or calculate, and use the linked Elec-Mate tools to practice the calculation-led parts. Designed for 1st-year apprentices.',
  keyTakeaways: [
    'City & Guilds 2365-02 Unit 210 — Understand how to communicate with others within building services engineering — is a core component of the Level 2 Diploma in Electrical Installations.',
    'This unit is typically delivered to 1st-year apprentices and covers 3 main topic areas.',
  ...
  sections: [
    {
      id: 'topic-1',
      heading: 'Topic 1: The members of the construction team and their role within the building services industry',
      tocLabel: 'Topic 1',
      blocks: [
        {
          type: 'paragraph',
        ...
        },
        {
          ...
          items: [
            ...
            'Identify the key roles of the individuals that report to the site management team.',
    ...
    {
      id: 'topic-2',
      heading: 'Topic 2: To apply information sources in the building services industry',
      tocLabel: 'Topic 2',
      blocks: [
        {
          type: 'paragraph',
        ...
        },
        {
          ...
          ordered: false,
          items: [
            'Identify the types of statutory legislation and guidance information that applies to working in the industry.',
    ...
    {
      id: 'topic-3',
      heading: 'Topic 3: To communicate with others in the building services industry',
      tocLabel: 'Topic 3',
      blocks: [
        {
          type: 'paragraph',
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          body:
            'The Elec-Mate apprentice tier includes mock exams, flashcards, and revision notes for City & Guilds 2365-02 Unit 210 plus every other unit in your qualification. 7-day free trial — see your progress on the tutor dashboard.',
        },
      ],
    },
  ],
  faqs: [
    {
      question: 'What does City & Guilds 2365-02 Unit 210 cover?',
      answer: 'Unit 210 (Understand how to communicate with others within building services engineering) covers 3 main topic areas: The members of the construction team and their role within the building services industry; To apply information sources in the building services industry; To communicate with others in the building services industry. Each topic has specific points you should be able to explain, demonstrate or calculate.',
    },
    {
    ...
    },
    {
      ...
      answer: 'Level 2 Diploma in Electrical Installations units are typically delivered across the apprenticeship in college-block weeks. Unit 210 is usually delivered to 1st-year apprentices. Check your individual learning plan with your tutor for exact timing.',
    },
    {
    ...
    },
    {
      ...
      answer: 'Unit 210 is one of several units that together make up the Level 2 Diploma in Electrical Installations. Passing every unit and the end-point assessment (AM2 or equivalent) earns you the full qualification. Check the unit overview in our City & Guilds qualification hub for the full unit list.',
    },
  ],
  howToHeading: 'A Five-Step Revision Plan for This Unit',
  howToDescription:
    'A repeatable approach that works for City & Guilds 2365-02 Unit 210 and every other unit in your qualification.',
  howToSteps: [
    {
  ...
  ctaHeading: 'For Apprentices: Pass City & Guilds 2365-02 Unit 210 with Confidence',
  ctaSubheading:
