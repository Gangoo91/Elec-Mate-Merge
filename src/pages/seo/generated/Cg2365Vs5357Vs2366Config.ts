...
export const Cg2365Vs5357Vs2366Config: GeneratedGuideConfig = {
  ...
  breadcrumbLabel: 'City & Guilds 2365 vs 5357 vs 2366',
  heroPrefix: 'City & Guilds 2365 vs 5357 vs 2366',
  heroHighlight: 'Electrical Apprentice Routes Compared',
  heroSuffix: '— UK 2026 Guide',
  heroSubtitle:
    'A side-by-side comparison of the three main City & Guilds pathways for UK electrical apprentices. Which one you take depends on your employer, your training provider, and the funding route — but the differences in scope, exams, and end-point matter. This guide explains the practical differences between the routes — audience, structure, time commitment, end-point assessment — so you can choose the right one for your situation.',
  keyTakeaways: [
  ...
  sections: [
    {
      id: 'city-guilds-2365',
      heading: 'City & Guilds 2365 — Level 2 + Level 3 Diploma in Electrical Installations',
      tocLabel: 'City & Guilds 2365',
      blocks: [
        {
          type: 'paragraph',
          text: 'Audience: College-based apprentices funded outside the Apprenticeship Standard route.',
        },
        {
          type: 'paragraph',
          text: 'Strengths:',
        },
        {
          ...
          ordered: false,
          items: [
            'Traditional college-led structure.',
            'Strong theory foundation across years 1-3.',
            'Clear unit-by-unit progression.',
          ],
        },
        {
          type: 'paragraph',
          text: 'End-point / assessment: Multiple unit-level assessments + 2391 inspection-and-testing exam (separate).',
        },
      ],
    },
    {
      id: 'city-guilds-5357',
      heading: 'City & Guilds 5357 — Level 3 Electrotechnical Qualification (Apprenticeship Standard)',
      tocLabel: 'City & Guilds 5357',
      blocks: [
        {
          type: 'paragraph',
          text: 'Audience: Apprentices on the official Apprenticeship Standard pathway (most new starters from 2018 onwards).',
        },
        {
          type: 'paragraph',
          text: 'Strengths:',
        },
        {
          ...
          ordered: false,
          items: [
            'Aligns with the Government Apprenticeship Standard.',
            'Employer-led structure with mandatory on-the-job evidence.',
            'AM2 end-point assessment is built into the qualification.',
          ],
        },
        {
          type: 'paragraph',
          text: 'End-point / assessment: AM2 end-point assessment (mandatory).',
        },
      ],
    },
    {
      id: 'city-guilds-2366',
      heading: 'City & Guilds 2366 — Level 3 Diploma in Electrotechnical Technology',
      tocLabel: 'City & Guilds 2366',
      blocks: [
        {
          type: 'paragraph',
          text: 'Audience: Industrial / maintenance electricians, technician pathways.',
        },
        {
          type: 'paragraph',
          text: 'Strengths:',
        },
        {
          ...
          ordered: false,
          items: [
            'Broader electrotechnical scope (motors, building services, controls).',
            'Suits maintenance / industrial pathways.',
            'Often paired with a specific NVQ for the workplace evidence.',
          ],
        },
        {
          type: 'paragraph',
          text: 'End-point / assessment: Final exams + workplace NVQ evidence.',
        },
      ],
    },
    {
