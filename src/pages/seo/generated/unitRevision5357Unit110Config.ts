...
// Apprentice revision page for City & Guilds 5357 Unit 110.
...
export const unitRevision5357Unit110Config: GeneratedGuideConfig = {
  ...
  heroPrefix: 'City & Guilds 5357 Unit 110:',
  heroHighlight: 'Apply Practices and Procedures for Maintenance',
  heroSuffix: '— Complete Revision Guide',
  heroSubtitle:
    'A structured revision walkthrough of every topic in City & Guilds 5357 Unit 110 (Apply Practices and Procedures for Maintenance). Use it as a personal study checklist — work through each topic, tick off the points you can confidently explain or calculate, and use the linked Elec-Mate tools to practice the calculation-led parts. Designed for electrotechnical apprentices on the apprenticeship standard.',
  keyTakeaways: [
    'City & Guilds 5357 Unit 110 — Apply Practices and Procedures for Maintenance — is a core component of the Level 3 Electrotechnical Qualification (Apprenticeship Standard).',
    'This unit is typically delivered to electrotechnical apprentices on the apprenticeship standard and covers 2 main topic areas.',
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          body:
            'The Elec-Mate apprentice tier includes mock exams, flashcards, and revision notes for City & Guilds 5357 Unit 110 plus every other unit in your qualification. 7-day free trial — see your progress on the tutor dashboard.',
        },
      ],
    },
  ],
  faqs: [
    {
      question: 'What does City & Guilds 5357 Unit 110 cover?',
  ...
  ctaHeading: 'For Apprentices: Pass City & Guilds 5357 Unit 110 with Confidence',
  ctaSubheading:
