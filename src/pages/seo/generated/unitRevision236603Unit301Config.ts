...
// Apprentice revision page for City & Guilds 2366-03 Unit 301.
...
export const unitRevision236603Unit301Config: GeneratedGuideConfig = {
  ...
  heroPrefix: 'City & Guilds 2366-03 Unit 301:',
  heroHighlight: 'Electrical science and principles',
  heroSuffix: '— Complete Revision Guide',
  heroSubtitle:
    'A structured revision walkthrough of every topic in City & Guilds 2366-03 Unit 301 (Electrical science and principles). Use it as a personal study checklist — work through each topic, tick off the points you can confidently explain or calculate, and use the linked Elec-Mate tools to practice the calculation-led parts. Designed for Level 3 apprentices.',
  keyTakeaways: [
    'City & Guilds 2366-03 Unit 301 — Electrical science and principles — is a core component of the Level 3 Diploma in Electrotechnical Technology.',
  ...
  sections: [
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          ordered: false,
          items: [
            'The main methods of generation and the National Grid voltages of electricity used for domestic, industrial and commercial consumption.',
            'Small scale, localised sources of electricity.',
            'The types of supply system used in the low-voltage public distribution network.',
            'Operating principles, applications and limitations of transformers.',
          ],
        },
      ],
    },
    {
      id: 'topic-2',
      heading: 'Topic 2: How to determine how different electrical properties can affect electrical circuits, systems and equipment',
      tocLabel: 'Topic 2',
      blocks: [
        {
          type: 'paragraph',
        ...
        },
        {
          ...
          items: [
            ...
            'Calculate values in AC circuits.',
            'Show the relationship between power quantities.',
            'Methods of power factor correction.',
            'Calculate the neutral current in three-phase and neutral systems.',
            'Calculate values in both star and delta connected systems.',
          ],
        },
      ],
    },
    {
      id: 'topic-3',
      heading: 'Topic 3: The applications of AC motors, DC machines and motor control',
      tocLabel: 'Topic 3',
      blocks: [
        {
          type: 'paragraph',
    ...
    {
      id: 'topic-4',
      heading: 'Topic 4: The operating principles of electrical components and protective devices',
      tocLabel: 'Topic 4',
      blocks: [
        {
          type: 'paragraph',
        ...
        },
        {
          ...
          ordered: false,
          items: [
            'The operating principles of electrical components used for circuit control.',
            'Types and operating principles of protective devices.',
          ],
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          ordered: false,
          items: [
            'The principles of illumination and illumination laws.',
            'The types, controls and connections of luminaires.',
          ],
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          ordered: false,
          items: [
            'The principles of heat transfer and different types of electrical heating to heat space and water.',
            'The types of central heating control systems, the components and how they operate.',
          ],
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          body:
            'The Elec-Mate apprentice tier includes mock exams, flashcards, and revision notes for City & Guilds 2366-03 Unit 301 plus every other unit in your qualification. 7-day free trial — see your progress on the tutor dashboard.',
        },
      ],
    },
  ],
  faqs: [
    {
      question: 'What does City & Guilds 2366-03 Unit 301 cover?',
      answer: 'Unit 301 (Electrical science and principles) covers 6 main topic areas: Electrical supply systems; How to determine how different electrical properties can affect electrical circuits, systems and equipment; The applications of AC motors, DC machines and motor control; The operating principles of electrical components and protective devices; The principles and applications of electrical lighting systems; The principles and applications of electrical heating. Each topic has specific points you should be able to explain, demonstrate or calculate.',
    },
    {
    ...
    },
    {
      ...
      answer: 'Level 3 Diploma in Electrotechnical Technology units are typically delivered across the apprenticeship in college-block weeks. Unit 301 is usually delivered to Level 3 apprentices. Check your individual learning plan with your tutor for exact timing.',
    },
    {
    ...
    },
    {
      ...
      answer: 'Unit 301 is one of several units that together make up the Level 3 Diploma in Electrotechnical Technology. Passing every unit and the end-point assessment (AM2 or equivalent) earns you the full qualification. Check the unit overview in our City & Guilds qualification hub for the full unit list.',
    },
  ],
  howToHeading: 'A Five-Step Revision Plan for This Unit',
  howToDescription:
    'A repeatable approach that works for City & Guilds 2366-03 Unit 301 and every other unit in your qualification.',
  howToSteps: [
    {
  ...
  ctaHeading: 'For Apprentices: Pass City & Guilds 2366-03 Unit 301 with Confidence',
  ctaSubheading:
