...
// Programmatically generated EICR cost landing page for Edinburgh.
...
export const eicrCostEdinburghConfig: GeneratedGuideConfig = {
  ...
  heroSubtitle:
    'Whether you are an electrician quoting EICRs in Edinburgh or a landlord trying to understand the market rate, this guide gives the fair-margin 2026 prices charged by NICEIC and NAPIT scheme-registered electricians, what is included, and why below-market quotes are usually missing something. Hourly rates for inspection work in Edinburgh run £60–£80, with a typical 3-bed terrace EICR landing at £290–395. Use it as a market-rate reference for your next quote, or as a buyer\u2019s guide to a fair price.',
  keyTakeaways: [
    'A 1-bed flat EICR in Edinburgh typically costs £235–315, a 3-bed terrace £290–395, and a 4-bed house £360–490 (2026 prices for a scheme-registered electrician, excluding remedial work).',
    'Commercial EICRs in Edinburgh are priced per socket / fitting — typically £17–25 per item, with minimum visit fees of £80–£120.',
    ...
    'Hourly rates for Edinburgh sit at £60–£80 because a NICEIC / NAPIT registered electrician carries professional indemnity insurance, scheme fees, calibrated test equipment (typically £1,200+ MFT), and is liable for the certificate they sign.',
  ...
  sections: [
    {
      id: 'typical-prices',
      heading: 'Typical EICR Prices in Edinburgh (2026)',
      tocLabel: 'Typical prices',
      blocks: [
        {
          type: 'paragraph',
          text: 'Below is a working price guide for Edinburgh based on competent-person scheme members operating in the area, hourly rate aggregates, and competitor pricing. Prices exclude any remedial work, which is quoted separately.',
        },
        {
          type: 'list',
          ordered: false,
    ...
    },
    {
      ...
      blocks: [
        {
          type: 'paragraph',
          text: 'Six factors push an EICR price up or down within Edinburgh:',
        },
        {
          type: 'list',
          ordered: true,
    ...
    {
      id: 'when-required',
      heading: 'When You Need an EICR in Edinburgh',
    ...
    {
      id: 'for-electricians',
      heading: 'For Electricians: Quote EICRs in Edinburgh at the Right Price',
      tocLabel: 'For electricians',
      blocks: [
        {
          type: 'paragraph',
          text: 'If you are a self-employed electrician or small contractor working in Edinburgh, this page is your local market-rate reference. The £290–395 band for a 3-bed terrace EICR is the fair-margin floor for a scheme-registered electrician — quoting below it means you are undercutting yourself before you start. Use the figures above to anchor your own quoting, with adjustments for property complexity, accessibility, and your scheme + insurance overhead.',
        },
        {
          type: 'callout',
          tone: 'info',
          ...
          body:
            'Elec-Mate gives Edinburgh electricians voice-driven test entry, 16 certificate types, on-site Schedule of Test Results, and a professional PDF quote that the client cannot haggle. 7-day free trial — see how much faster you can quote and certify in your area.',
        },
        {
          type: 'paragraph',
  ...
  faqs: [
    {
      question: 'How much does a standard EICR cost in Edinburgh?',
      answer: 'For a 3-bedroom property in Edinburgh the typical 2026 EICR price from a NICEIC or NAPIT scheme-registered electrician is £290–395, excluding any remedial work. Prices vary with property size, consumer unit condition, and number of circuits. Quotes substantially below this band usually mean the EIC certificate, RCD test sweep or insurance is missing — verify what is included.',
    },
    {
      question: 'How long is an EICR valid for in Edinburgh?',
    ...
    {
      question: 'Who can carry out an EICR in Edinburgh?',
    ...
    {
      question: 'Can I get a same-day EICR in Edinburgh?',
      answer: 'Same-day or next-day EICRs are possible in Edinburgh for smaller properties (1–2 bed) where an electrician is local and a slot is available. Larger jobs typically require 5–10 working days lead time.',
    },
  ],
  howToHeading: 'How to Book an EICR in Edinburgh',
  howToDescription:
  ...
  howToSteps: [
    ...
    },
    {
      ...
      text: 'Use Elec-Mate to find vetted Edinburgh electricians, or check NICEIC / NAPIT directories directly. Avoid trader-aggregator sites that bid jobs out without checking competence.',
    },
    {
  ...
  ctaHeading: 'For Electricians: Quote and Certify EICRs in Edinburgh',
  ctaSubheading:
