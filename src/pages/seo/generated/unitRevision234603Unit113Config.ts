...
// Apprentice revision page for City & Guilds 2346-03 Unit 113.
...
export const unitRevision234603Unit113Config: GeneratedGuideConfig = {
  pagePath: '/guides/2346-03-unit-113-inspect-test-and-commission-electrical-systems-revision',
  title: 'City & Guilds 2346-03 Unit 113: Inspect, Test and',
  description: 'Complete revision guide for City & Guilds 2346-03 Unit 113 (Inspect, Test and Commission Electrical Systems).',
  datePublished: published,
  dateModified: modified,
  readingTime: 8,
  badge: 'Unit Revision',
  badgeIcon: 'GraduationCap',
  breadcrumbLabel: 'Unit 113 Revision',
  heroPrefix: 'City & Guilds 2346-03 Unit 113:',
  heroHighlight: 'Inspect, Test and Commission Electrical Systems',
  heroSuffix: '— Complete Revision Guide',
  heroSubtitle:
    'A structured revision walkthrough of every topic in City & Guilds 2346-03 Unit 113 (Inspect, Test and Commission Electrical Systems). Use it as a personal study checklist — work through each topic, tick off the points you can confidently explain or calculate, and use the linked Elec-Mate tools to practice the calculation-led parts. Designed for experienced workers consolidating skills outside a formal apprenticeship.',
  keyTakeaways: [
    'City & Guilds 2346-03 Unit 113 — Inspect, Test and Commission Electrical Systems — is a core component of the Electrotechnical Experienced Worker Qualification.',
    ...
    'Across the 3 topics there are 12 specific points you should be able to explain, demonstrate or calculate before the end-of-unit assessment.',
  ...
  sections: [
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            'Check the safety of electrical systems prior to the commencement of inspection, testing and commissioning UAN: Level: GLH: Endorsement by a sector or regulatory body: Aim: Assessment type City & Guilds Level X Award/Certificate/Diploma in Xxxxxxx (XXXX-XX) 37.',
          ],
        },
      ],
    },
    {
      id: 'topic-2',
      heading: 'Topic 2: How to inspect electrical systems and equipment',
      tocLabel: 'Topic 2',
      blocks: [
        {
          type: 'paragraph',
        ...
        },
        {
          ...
          items: [
            ...
            'Complete a schedule of inspections in accordance with the BS 7671 and IET Guidance Note 3 making technical decisions..',
          ],
        },
      ],
    },
    {
      id: 'topic-3',
      heading: 'Topic 3: How to test and commission electrical systems and equipment',
      tocLabel: 'Topic 3',
      blocks: [
        {
          type: 'paragraph',
        ...
        },
        {
          ...
          items: [
            ...
            'Carry out tests in accordance with the installation specification and BS 7671and manufacturer’s instructions.',
            'Analyse and verify test results reporting all findings to relevant persons, as appropriate.',
            'Complete in accordance with BS 7671 and IET Guidance Note 3: a. Electrical installation certificates: i. Schedules of inspections ii. Schedules of test results b. Minor electrical installation works certificates.',
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          body:
            'The Elec-Mate apprentice tier includes mock exams, flashcards, and revision notes for City & Guilds 2346-03 Unit 113 plus every other unit in your qualification. 7-day free trial — see your progress on the tutor dashboard.',
        },
      ],
    },
  ],
  faqs: [
    {
      question: 'What does City & Guilds 2346-03 Unit 113 cover?',
      answer: 'Unit 113 (Inspect, Test and Commission Electrical Systems) covers 3 main topic areas: How to confirm safety of the system and equipment prior to completion of inspection, testing and commissioning in accordance with statutory and non-statutory regulations; How to inspect electrical systems and equipment; How to test and commission electrical systems and equipment. Each topic has specific points you should be able to explain, demonstrate or calculate.',
    },
    {
    ...
    },
    {
      ...
      answer: 'Unit 113 is one of several units that together make up the Electrotechnical Experienced Worker Qualification. Passing every unit and the end-point assessment (AM2 or equivalent) earns you the full qualification. Check the unit overview in our City & Guilds qualification hub for the full unit list.',
    },
  ],
  howToHeading: 'A Five-Step Revision Plan for This Unit',
  howToDescription:
    'A repeatable approach that works for City & Guilds 2346-03 Unit 113 and every other unit in your qualification.',
  howToSteps: [
    {
  ...
  ctaHeading: 'For Apprentices: Pass City & Guilds 2346-03 Unit 113 with Confidence',
  ctaSubheading:
