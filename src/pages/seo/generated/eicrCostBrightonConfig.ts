...
// Programmatically generated EICR cost landing page for Brighton.
...
export const eicrCostBrightonConfig: GeneratedGuideConfig = {
  pagePath: '/guides/eicr-cost-brighton',
  title: 'EICR Cost Brighton 2026 — Domestic & Commercial Pricing',
  description: 'How much does an EICR cost in Brighton? Fair-margin 2026 prices for scheme-registered electricians — £260–360 for a 1-bed, £400–540 for a 4-bed…',
  datePublished: published,
  dateModified: modified,
  readingTime: 7,
  badge: 'Cost Guide',
  badgeIcon: 'PoundSterling',
  breadcrumbLabel: 'EICR Cost in Brighton',
  breadcrumbParent: { label: 'EICR Cost UK', href: '/guides/eicr-cost-uk' },
  heroPrefix: 'EICR Cost in Brighton:',
  heroHighlight: '2026 Pricing Guide',
  heroSuffix: '— Domestic & Commercial',
  heroSubtitle:
    'Whether you are an electrician quoting EICRs in Brighton or a landlord trying to understand the market rate, this guide gives the fair-margin 2026 prices charged by NICEIC and NAPIT scheme-registered electricians, what is included, and why below-market quotes are usually missing something. Hourly rates for inspection work in Brighton run £68–£90, with a typical 3-bed terrace EICR landing at £320–430. Use it as a market-rate reference for your next quote, or as a buyer\u2019s guide to a fair price.',
  keyTakeaways: [
    'A 1-bed flat EICR in Brighton typically costs £260–360, a 3-bed terrace £320–430, and a 4-bed house £400–540 (2026 prices for a scheme-registered electrician, excluding remedial work).',
    'Commercial EICRs in Brighton are priced per socket / fitting — typically £19–28 per item, with minimum visit fees of £90–£135.',
    ...
    'Hourly rates for Brighton sit at £68–£90 because a NICEIC / NAPIT registered electrician carries professional indemnity insurance, scheme fees, calibrated test equipment (typically £1,200+ MFT), and is liable for the certificate they sign.',
    ...
    'South East\u2019s DNO is UK Power Networks. Any remedial work involving DNO notification (PME, supply upgrades) routes through them.',
  ...
  sections: [
    {
      id: 'typical-prices',
      heading: 'Typical EICR Prices in Brighton (2026)',
      tocLabel: 'Typical prices',
      blocks: [
        {
          type: 'paragraph',
          text: 'Below is a working price guide for Brighton based on competent-person scheme members operating in the area, hourly rate aggregates, and competitor pricing. Prices exclude any remedial work, which is quoted separately.',
        },
        {
          type: 'list',
          ordered: false,
          items: [
            '1-bedroom flat or maisonette — £260–360 (typically 1.5–2 hours on site)',
            '2-bedroom terrace — £320–409 (typically 2–3 hours)',
            '3-bedroom semi or terrace — £320–430 (typically 2.5–3.5 hours)',
            '4-bedroom detached — £400–540 (typically 3.5–5 hours)',
            '5+ bedroom / large houses — £621+ (priced on visit)',
            'Commercial property — £19–28 per socket / fitting with a minimum visit fee of £90–£135',
          ],
        },
        {
          type: 'callout',
    ...
    },
    {
      ...
      blocks: [
        {
          type: 'paragraph',
          text: 'Six factors push an EICR price up or down within Brighton:',
        },
        {
          type: 'list',
          ordered: true,
    ...
    {
      id: 'when-required',
      heading: 'When You Need an EICR in Brighton',
      tocLabel: 'When required',
      blocks: [
        {
          type: 'paragraph',
          text: 'EICRs are mandatory in several scenarios under UK regulation, regardless of South East location:',
        },
        {
          type: 'list',
          ordered: false,
    ...
    {
      id: 'for-electricians',
      heading: 'For Electricians: Quote EICRs in Brighton at the Right Price',
      tocLabel: 'For electricians',
      blocks: [
        {
          type: 'paragraph',
          text: 'If you are a self-employed electrician or small contractor working in Brighton, this page is your local market-rate reference. The £320–430 band for a 3-bed terrace EICR is the fair-margin floor for a scheme-registered electrician — quoting below it means you are undercutting yourself before you start. Use the figures above to anchor your own quoting, with adjustments for property complexity, accessibility, and your scheme + insurance overhead.',
        },
        {
          type: 'callout',
          tone: 'info',
          ...
          body:
            'Elec-Mate gives Brighton electricians voice-driven test entry, 16 certificate types, on-site Schedule of Test Results, and a professional PDF quote that the client cannot haggle. 7-day free trial — see how much faster you can quote and certify in your area.',
        },
        {
          type: 'paragraph',
    ...
    {
      id: 'get-a-quote',
      heading: 'For Property Owners: Booking an EICR in Brighton',
      tocLabel: 'For property owners',
      blocks: [
        {
          type: 'paragraph',
          text: 'If you are a landlord, owner or managing agent in Brighton looking for an EICR, Elec-Mate connects you to vetted competent-person scheme electricians. Send a brief — property type, postcode, last EICR date — and get a price from a local electrician. Most Brighton jobs are booked within 5–10 working days, with same-day availability typical for smaller properties or urgent landlord deadlines under the Electrical Safety Standards in the Private Rented Sector Regulations 2020.',
        },
        {
          type: 'paragraph',
  ...
  faqs: [
    {
      question: 'How much does a standard EICR cost in Brighton?',
      answer: 'For a 3-bedroom property in Brighton the typical 2026 EICR price from a NICEIC or NAPIT scheme-registered electrician is £320–430, excluding any remedial work. Prices vary with property size, consumer unit condition, and number of circuits. Quotes substantially below this band usually mean the EIC certificate, RCD test sweep or insurance is missing — verify what is included.',
    },
    {
      question: 'How long is an EICR valid for in Brighton?',
    ...
    {
      question: 'Who can carry out an EICR in Brighton?',
    ...
    {
      question: 'Can I get a same-day EICR in Brighton?',
      answer: 'Same-day or next-day EICRs are possible in Brighton for smaller properties (1–2 bed) where an electrician is local and a slot is available. Larger jobs typically require 5–10 working days lead time.',
    },
  ],
  howToHeading: 'How to Book an EICR in Brighton',
  howToDescription:
  ...
  howToSteps: [
    ...
    },
    {
      ...
      text: 'Use Elec-Mate to find vetted Brighton electricians, or check NICEIC / NAPIT directories directly. Avoid trader-aggregator sites that bid jobs out without checking competence.',
    },
    {
  ...
  ctaHeading: 'For Electricians: Quote and Certify EICRs in Brighton',
  ctaSubheading:
