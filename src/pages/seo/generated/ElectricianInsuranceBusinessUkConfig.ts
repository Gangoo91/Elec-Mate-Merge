...
// Electrical business owner / employer guide. Audience: self-employed electricians and small business owners arranging insurance.
...
export const ElectricianInsuranceBusinessUkConfig: GeneratedGuideConfig = {
  ...
  badgeIcon: 'Briefcase',
  breadcrumbLabel: 'Electrician Insurance for Your B...',
  heroPrefix: 'Electrician Insurance for Your Business — UK 2026 Guide:',
  heroHighlight: 'Practical 2026 Guide',
  heroSuffix: '— For UK Electrical Contractors',
  heroSubtitle:
    'A practical 2026 guide to the insurance an electrical business must carry. Public Liability, Professional Indemnity, Tools-in-Van, Employers\' Liability — what each covers, what it costs, and where small electricians get caught out. This guide is for self-employed electricians and small business owners arranging insurance.',
  keyTakeaways: [
  ...
  faqs: [
    {
      ...
      answer: 'This guide is written for self-employed electricians and small business owners arranging insurance. The advice is practical, UK-specific, and based on 2026 regulations and market rates.',
    },
    {
