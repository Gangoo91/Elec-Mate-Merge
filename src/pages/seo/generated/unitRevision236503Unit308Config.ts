...
// Apprentice revision page for City & Guilds 2365-03 Unit 308.
...
export const unitRevision236503Unit308Config: GeneratedGuideConfig = {
  ...
  breadcrumbLabel: 'Unit 308 Revision',
  heroPrefix: 'City & Guilds 2365-03 Unit 308:',
  heroHighlight: 'Career awareness in building services engineering',
  heroSuffix: '— Complete Revision Guide',
  heroSubtitle:
    'A structured revision walkthrough of every topic in City & Guilds 2365-03 Unit 308 (Career awareness in building services engineering). Use it as a personal study checklist — work through each topic, tick off the points you can confidently explain or calculate, and use the linked Elec-Mate tools to practice the calculation-led parts. Designed for 2nd to 4th-year apprentices.',
  keyTakeaways: [
    'City & Guilds 2365-03 Unit 308 — Career awareness in building services engineering — is a core component of the Level 3 Diploma in Electrical Installations.',
    'This unit is typically delivered to 2nd to 4th-year apprentices and covers 2 main topic areas.',
    'Across the 2 topics there are 12 specific points you should be able to explain, demonstrate or calculate before the end-of-unit assessment.',
  ...
  sections: [
    {
      id: 'topic-1',
      heading: 'Topic 1: How to plan for careers in building services engineering',
      tocLabel: 'Topic 1',
      blocks: [
        {
          type: 'paragraph',
        ...
        },
        {
          ...
          ordered: false,
          items: [
            'Identify resources to support career planning.',
            'Describe elements of career planning.',
            'Describe documents to support career development.',
            'Explain the principles of goal setting.',
            'Describe how to set goals.',
            'Define the different roles in building services engineering.',
            'Explain opportunities for progression within building services engineering.',
          ],
        },
      ],
    },
    {
      id: 'topic-2',
      heading: 'Topic 2: The requirements to become a qualified operative in building services engineering',
      tocLabel: 'Topic 2',
      blocks: [
        {
          type: 'paragraph',
        ...
        },
        {
          ...
          ordered: false,
          items: [
            'Describe specific requirements for career choices in building services engineering.',
            'Identify the areas in building services which run competent person schemes.',
            'Define the term competent person scheme.',
            'Identify the renewal requirements for being part of competent person schemes.',
            'Describe the consequences of not being part of the competent person scheme when working in building services engineering.',
          ],
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          body:
            'The Elec-Mate apprentice tier includes mock exams, flashcards, and revision notes for City & Guilds 2365-03 Unit 308 plus every other unit in your qualification. 7-day free trial — see your progress on the tutor dashboard.',
        },
      ],
    },
  ],
  faqs: [
    {
      question: 'What does City & Guilds 2365-03 Unit 308 cover?',
      answer: 'Unit 308 (Career awareness in building services engineering) covers 2 main topic areas: How to plan for careers in building services engineering; The requirements to become a qualified operative in building services engineering. Each topic has specific points you should be able to explain, demonstrate or calculate.',
    },
    {
    ...
    },
    {
      ...
      answer: 'Level 3 Diploma in Electrical Installations units are typically delivered across the apprenticeship in college-block weeks. Unit 308 is usually delivered to 2nd to 4th-year apprentices. Check your individual learning plan with your tutor for exact timing.',
    },
    {
    ...
    },
    {
      ...
      answer: 'Unit 308 is one of several units that together make up the Level 3 Diploma in Electrical Installations. Passing every unit and the end-point assessment (AM2 or equivalent) earns you the full qualification. Check the unit overview in our City & Guilds qualification hub for the full unit list.',
    },
  ],
  howToHeading: 'A Five-Step Revision Plan for This Unit',
  howToDescription:
    'A repeatable approach that works for City & Guilds 2365-03 Unit 308 and every other unit in your qualification.',
  howToSteps: [
    {
  ...
  ctaHeading: 'For Apprentices: Pass City & Guilds 2365-03 Unit 308 with Confidence',
  ctaSubheading:
