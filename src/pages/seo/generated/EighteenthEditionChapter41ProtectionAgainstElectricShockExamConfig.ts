...
export const EighteenthEditionChapter41ProtectionAgainstElectricShockExamConfig: GeneratedGuideConfig = {
  ...
  description: 'Chapter 41 is the single most-tested chapter in the 18th Edition exam — Automatic Disconnection of Supply (ADS), maximum Zs values, RCD requirements…',
  ...
  faqs: [
    { question: 'Who is this guide for?', answer: 'This guide is written for electricians studying for the 18th Edition exam — Chapter 41 deep-dive. The advice is practical, UK-specific, and based on current 2026 regulations.' },
  ...
  relatedPages: [
    {
      ...
      description: 'Related guide for electricians studying for the 18th Edition exam — Chapter 41 deep-dive.',
      icon: 'GraduationCap',
      category: 'Guide',
    },
    {
