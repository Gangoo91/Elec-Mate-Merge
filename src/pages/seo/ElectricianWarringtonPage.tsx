...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "The requirements are standard for England. You need City & Guilds 2365 Level 2 and 3 (or NVQ Level 3 in Electrical Installation), plus the 18th Edition (BS 7671:2018+A4:2026) certificate. For self-certification under Part P, NICEIC or NAPIT registration is required. Electricians targeting Warrington's commercial and industrial sector should also consider qualifications in three-phase installations and, for sites with hazardous areas, CompEx (explosion-protected equipment) certification may be required for certain industrial sites.",
  },
  {
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  ...
                  send professional quotes to Warrington homeowners and commercial clients.
...
export default function ElectricianWarringtonPage() {
  return (
    <GuideTemplate
      ...
      title="Electrician in Warrington: Local Electricians"
