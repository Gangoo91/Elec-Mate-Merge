...
const sections = [
  {
    id: 'the-symbol',
    heading: 'Two-Way Switch — IEC 60617 Symbol',
    content: (
      <>
        <SymbolGallery
...
export default function TwowaySwitchSymbolPage() {
  return (
    <GuideTemplate
      ...
      heroTitle={
        <>
          Two-Way Switch Symbol <span className="text-yellow-400">IEC 60617 reference</span>
        </>
      }
      heroSubtitle="Two-way switch electrical symbol IEC 60617 — what it represents, where it appears in UK electrical drawings, and how it relates to the rest of the symbol library."
      readingTime={4}
      keyTakeaways={[
