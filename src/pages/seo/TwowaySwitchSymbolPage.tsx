...
const breadcrumbs = [
  ...
  { label: 'Two-Way Switch', href: '/guides/2way-switch-symbol' },
];
...
const sections = [
  {
    id: 'the-symbol',
    heading: 'Two-Way Switch — BS EN 60617 Symbol',
    content: (
      <>
        <SymbolGallery
          symbolIds={['2way-switch']}
  ...
  },
  {
    ...
    heading: 'What the Two-Way Switch Symbol Represents',
    content: (
      <>
        <p>
          A switch with two fixed contacts and one common, allowing control of the same load from
          two locations. Always used in pairs with a second 2-way switch (e.g. staircase,
          hall-and-landing).
        </p>
      </>
    ),
  ...
  {
    id: 'when-used',
    heading: 'When + Where the Two-Way Switch Symbol Is Used',
    content: (
      <>
        <p>
          Staircases, halls with two entries, long corridors, bedrooms with both door and bedhead
          switches.
        </p>
        <p>
...
export default function TwowaySwitchSymbolPage() {
  return (
    <GuideTemplate
      title="Two-Way Switch Symbol | BS EN 60617 Diagram Reference"
      description="Two-Way Switch BS EN 60617 symbol — what it represents, when used in UK electrical drawings, and where it appears on EIC + EICR schedules."
      ...
      heroTitle={
        <>
          Two-Way Switch Symbol <span className="text-yellow-400">BS EN 60617 reference</span>
        </>
      }
      heroSubtitle="Two-way switch electrical symbol BS EN 60617 — what it represents, where it appears in UK electrical drawings, and how it relates to the rest of the symbol library."
      readingTime={4}
      keyTakeaways={[
      ...
      faqs={[
        {
          question: 'What does the Two-Way Switch symbol mean?',
          answer:
            'A switch with two fixed contacts and one common, allowing control of the same load from two locations. Always used in pairs with a second 2-way switch (e.g. staircase, hall-and-landing).',
        },
        {
          question: 'Where is the Two-Way Switch symbol used?',
          answer:
            'Staircases, halls with two entries, long corridors, bedrooms with both door and bedhead switches.',
        },
      ]}
      faqHeading="FAQ — Two-Way Switch Symbol"
