...
const relatedPages: RelatedPage[] = [
  {
    ...
    description:
      "Compare the UK's two main competent person schemes — costs, assessments, and consumer appeal.",
    icon: Scale,
    category: 'Guide',
  },
  {
    ...
    description:
      'The Scottish trade body equivalent of ECA — how SELECT works north of the border.',
    icon: Building2,
    category: 'Guide',
  },
  {
    ...
    description:
      'How competent person schemes work and what notifiable work requires registration.',
    icon: ShieldCheck,
    category: 'Guide',
  },
  {
    ...
    description:
      'How to get the JIB Gold Card — AM2, Level 3 qualifications, and card types explained.',
    icon: ClipboardCheck,
    category: 'Guide',
  },
  {
...
const sections = [
  {
    ...
    content: (
      <>
        <p>
          The Electrical Contractors Association (ECA) is the UK's leading trade association for
          businesses working in the electrotechnical, engineering services, and related building
          services sectors. Founded in 1901, the ECA has over 120 years of history representing
          electrical contractors across England, Wales, and Northern Ireland.
        </p>
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                primarily a trade body rather than a competent person scheme. This is an important
                distinction: the ECA represents the interests of electrical contractors politically
                and commercially, whereas NICEIC and{' '}
                <SEOInternalLink href="/niceic-vs-napit-comparison">NAPIT</SEOInternalLink> are
                certification bodies that allow self-certification under Part P.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Building2 className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                ...
                (the Electrical Contractors' Association of Scotland). The two organisations work
                collaboratively on UK-wide industry issues.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Building2 className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Membership breadth</strong> — the ECA represents businesses ranging from
                sole traders to major national contractors with thousands of employees. Members
                include general electrical contractors, specialist contractors, and businesses in
                building services engineering, facilities management, and utilities sectors.
              </span>
            </li>
          </ul>
        </div>
    ...
    content: (
      <>
        <p>
          ...
          electrical contractors run their businesses more effectively and safely. The core benefits
          include:
        </p>
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                complex installation scenarios. This is one of the most valued ECA member benefits —
                particularly useful for non-standard situations not clearly covered by the wiring
                regulations.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                disputes, payment issues, debt recovery, employment law, and health and safety
                regulatory queries. Available during business hours with out-of-hours emergency
                legal cover.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                implications. ECA technical staff participate in IET wiring regulations committee
                work, giving members an inside track on upcoming changes.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                specifically for the electrotechnical sector and are regularly updated to reflect
                legal changes.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                valuable for contractors working on larger commercial sites where detailed health
                and safety documentation is required.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                professional indemnity, and commercial vehicle insurance for electrical contractors.
              </span>
            </li>
          </ul>
        </div>
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                public liability insurance (minimum £2 million, typically £5 million for commercial
                work). No formal assessment of work quality is required for standard membership.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Users className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                must hold appropriate electrotechnical qualifications (Level 3 NVQ/SVQ or
                equivalent, 18th Edition BS 7671, and inspection and testing qualifications). An
                assessor visits to inspect sample installations.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Users className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                Proof of insurance is required at membership application and renewal.
              </span>
            </li>
          </ul>
        </div>
    ...
    content: (
      <>
        <p>
          ...
          membership remains accessible to sole traders and small businesses while reflecting the
          greater resources available to larger contractors. Exact fees should be confirmed with ECA
          directly as they are updated annually.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                contractors may pay several thousand pounds per year.
              </span>
            </li>
          </ul>
        </div>
        <p>
          First-year discounts are typically available for new ECA members. Contact the ECA regional
          office covering your area for an exact quote and details of any current joining offers.
        </p>
      </>
    ),
  },
    ...
    content: (
      <>
        <p>
          ...
          Approved Contractor status. Understanding the difference is important when deciding which
          tier to pursue.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                (technical helpline, legal helpline, model contracts, insurance, lobbying) but does
                not include a formal quality assessment. Standard members cannot use the ECA
                Approved Contractor quality mark and do not have Part P self- certification
                capability through ECA alone (they would need a separate NICEIC, NAPIT, or ELECSA
                registration).
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Scale className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>ECA Approved Contractor</strong> — includes an assessment of work quality
                and management systems. Approved Contractors can use the ECA quality mark, appear in
                the ECA's public contractor directory, and access Part P self-certification through
                ECA's approved scheme partnership. This is the tier equivalent to NICEIC Approved
                Contractor.
              </span>
            </li>
          </ul>
        ...
        <p>
          ...
          clients and self-certification capability, ECA Approved Contractor is the appropriate
          tier.
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>
          UK electricians encounter several organisations that serve different purposes.
          Understanding how ECA, SELECT, and NICEIC/NAPIT relate to each other helps you make the
          right choices for your business.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                a certification or competent person scheme (though ECA Approved Contractor includes
                this).
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                covering Building Standards Scotland (the Scottish equivalent of Part P). SELECT
                operates differently from ECA because Building Standards Scotland is managed
                differently from Part P in England.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Building2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                contractors are members of ECA (for the trade body benefits) and also registered
                with{' '}
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          One of the most practically valuable ECA member benefits is access to expert guidance on
          BS 7671 — the IET Wiring Regulations. Electrical installations in the UK must comply with
          the current edition (18th Edition, incorporating amendments), and interpretation can be
          complex.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Technical helpline interpretations</strong> — ECA technical advisers help
                members interpret complex or ambiguous BS 7671 requirements for specific
                installation scenarios. This is particularly useful for non-standard applications
                such as EV charging, solar PV, temporary installations, or older properties with
            ...
            <li className="flex items-start gap-3">
              <BookOpen className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>IET committee participation</strong> — ECA participates in the IET's
                technical committees that draft and revise BS 7671. This gives ECA an influence over
                the content of future amendments and provides members with advance insight into the
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Beyond day-to-day member services, the ECA plays a significant role in shaping the policy
          and regulatory environment for UK electrical contractors. This lobbying function is a
          collective benefit — all ECA members contribute to and benefit from it.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Government engagement</strong> — the ECA engages with government departments
                (MHCLG, DESNZ, and others) on building regulations reform, electrical safety
                legislation, net zero energy policy, and skills and apprenticeship funding. ECA
                responses to consultations represent the collective view of its membership.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Scale className="w-5 h-5 text-green-400 mt-0.5 shrink-0" />
              <span>
                <strong>CITB levy</strong> — the ECA represents contractor views on the Construction
                Industry Training Board (CITB) levy, grant, and skills development. For electrical
                contractors paying the CITB levy, ECA advocacy helps shape how levy funds are
                distributed and what training programmes are funded.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Scale className="w-5 h-5 text-green-400 mt-0.5 shrink-0" />
              <span>
                <strong>Payment and contract legislation</strong> — the ECA lobbies on issues such
                as retention reform, prompt payment, and construction contract law. These affect all
                electrical contractors but particularly those doing subcontract work for main
                contractors.
              </span>
            </li>
          </ul>
    ...
    content: (
      <>
        <p>
          ...
          benefits. Pair ECA membership with Elec-Mate's certificate and business management tools
          to run a fully compliant, efficient electrical contracting business.
        </p>
        <SEOAppBridge
...
export default function ECAMembershipGuidePage() {
  return (
    <GuideTemplate
      title="ECA Membership Guide UK: Electrical Contractors"
