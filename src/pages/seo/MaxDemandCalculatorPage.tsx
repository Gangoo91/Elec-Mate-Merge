...
const howToSteps = [
  ...
  {
    name: 'Look up diversity factors from Table A2',
    text: 'For each circuit type, find the applicable diversity factor from the IET On-Site Guide Table A2. Note that the factors differ depending on the circuit type: lighting uses a percentage method, cooking appliances use the "first 10 A plus 30% of remainder" formula, and some loads like immersion heaters and showers are taken at full load with no diversity (unless there are multiple units).',
  },
  {
    name: 'Apply diversity to each circuit',
    text: 'Calculate the diversified demand for each circuit by applying the Table A2 factor to the connected load. For ring final circuits, Table A2 allows the current demand to be taken as the design current of the circuit. For lighting, the factor depends on the number of points and the type of premises. Work through each circuit systematically.',
  },
  {
...
const features = [
  {
    ...
    description:
      'All IET On-Site Guide Table A2 diversity factors built in. Select the circuit type and load, and the correct factor is applied automatically.',
  },
  {
    icon: Home,
  ...
  },
  {
    ...
    description:
      'All calculations follow the diversity methodology in the IET On-Site Guide (Table A2), the companion to BS 7671:2018+A4:2026. Verified against the current edition of the IET Wiring…',
  },
];
...
const howToSchema = {
  ...
  description:
    'Step-by-step guide to calculating maximum demand for electrical installations in the UK using the IET On-Site Guide diversity factors (Table A2).',
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4 text-white leading-relaxed">
            ...
            <p>
              ...
              published in the IET On-Site Guide Table A2.
            </p>
            <p>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4 text-white leading-relaxed">
            <p>
              ...
              installation and includes Table A1 (current demand to be assumed for points of
              utilization), Table A2 (allowances for diversity) and Appendix H (standard circuit
              arrangements for household and similar premises). Diversity guidance is not contained
            ...
            <p>
              It is important to understand that the Table A2 factors are guidance, not absolute
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4 text-white leading-relaxed">
            <p>
              ...
              loads. We will calculate the maximum demand step by step using the Table A2 diversity
              factors.
            </p>
          </div>
          ...
          <div className="space-y-4 text-white leading-relaxed">
            <p>
              ...
              as well as table look-ups. The Table A2 factors are a starting point, but the
      ...
      <section className="py-16 px-5 bg-white/[0.02]">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4 text-white leading-relaxed">
            ...
            <p>
              For commercial premises, the diversity factors from Table A2 still apply where the
      ...
      <section className="py-16 px-5">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-white text-center mb-10 max-w-2xl mx-auto">
            ...
            manual calculations with Table A2.
          </p>
