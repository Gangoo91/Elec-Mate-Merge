    ...
    <PublicPageLayout>
      ...
      <section className="relative overflow-hidden py-20 sm:py-28 px-5">
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg sm:text-xl text-white max-w-2xl mx-auto mb-8 leading-relaxed">
            ...
            against any trunking size, with compartment mode for segregated installations.
          </p>
      ...
      <section className="py-16 px-5">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4 text-white leading-relaxed">
            <p>
              Trunking fill refers to the proportion of a cable trunking's internal cross-sectional
              area that is occupied by cables. BS 7671:2018+A3:2024 and the IET Guidance Note 1
              state that the total cross-sectional area of all cables installed in trunking must not
              exceed 45% of the trunking's internal cross-sectional area. This is known as the 45%
              fill rule, and it applies to all types of cable trunking — PVC, galvanised steel,
            ...
            <p>
              ...
              then to the surrounding environment. If the trunking is packed too tightly, the
              temperature inside rises, potentially exceeding the cable insulation's rated
              temperature and causing degradation or failure.
            </p>
            <p>
              Second, installation practicality: cables need to be laid into the trunking without
              excessive bending or forcing. They must be arranged neatly to avoid crossing over each
              other, which creates pressure points that can damage insulation over time. A 45% fill
              leaves enough space for cables to be routed neatly with gentle bends at fittings and
              junctions.
            </p>
            <p>
      ...
      <section className="py-16 px-5 bg-white/[0.02]">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4 text-white leading-relaxed">
            <p>
              The most common mistake in trunking fill calculations is confusing the conductor
              cross-sectional area with the overall cable cross-sectional area. When you say "2.5
              mm² cable", the 2.5 mm² refers to the cross-section of the copper conductor only. The
              actual space the cable occupies in the trunking is much larger because it includes the
            ...
            <p>
              ...
              calculations must always use the overall cable dimensions, never the conductor size.
            </p>
          </div>
      ...
      <section className="py-16 px-5">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-white text-sm leading-relaxed mt-4">
            The sizes above are nominal external dimensions. The internal dimensions are slightly
            smaller due to wall thickness — typically 1 to 2 mm per side for PVC trunking and 1 mm
            per side for metal trunking. The Elec-Mate calculator uses the actual internal
            dimensions for accurate fill calculations.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4 text-white leading-relaxed">
            ...
            <p>
              ...
              calculations — the 45% rule applies to each compartment separately.
            </p>
            <p>
              For example, a 100 x 50 mm three-compartment trunking might divide into one 50 x 50 mm
              power compartment and one 50 x 50 mm data compartment (the third compartment is
              sometimes a narrower ELV channel). The power compartment has an internal CSA of
              approximately 2,500 mm², giving a 45% usable area of 1,125 mm². The data compartment
              has the same capacity. You cannot add the two compartments together — each is assessed
              against its own 45% limit.
            </p>
            <p>
              When specifying compartmentalised trunking, always check the internal dimensions of
              each compartment from the manufacturer's data, as the dividers reduce the usable
          ...
          <div className="space-y-6">
            <div className="p-6 rounded-2xl bg-white/[0.04] border border-white/10">
              ...
              <div className="space-y-2 text-white leading-relaxed text-sm">
                <p>
                  Four ring final circuits use 2.5 mm² T&E flat cable. Each ring has two cables in
                  the trunking run (outgoing and return legs of the ring). Total: 8 cables of 2.5
                  mm² T&E.
                </p>
                ...
                <p>
                  ...
                  percentage is 25.4%, leaving good spare capacity for future circuits.
                </p>
              </div>
            </div>
            ...
            <div className="p-6 rounded-2xl bg-white/[0.04] border border-white/10">
              ...
              <div className="space-y-2 text-white leading-relaxed text-sm">
                <p>
                  An electrician wants to run one 2.5 mm² T&E (socket circuit) and one 1.5 mm² T&E
                  (lighting circuit) through 25 x 16 mm mini-trunking.
                </p>
                <p className="font-mono text-white">2.5 mm² T&E CSA = 79.4 mm²</p>
                ...
                <p>
                  ...
                  the fill is 78% of the usable space (35.1% of total), which is tight. No room for
                  additional cables. Consider upgrading to 38 x 16 mm (45% capacity: 274 mm²) to
            ...
            <div className="p-6 rounded-2xl bg-white/[0.04] border border-white/10">
              ...
              <div className="space-y-2 text-white leading-relaxed text-sm">
                <p>
                  A trunking run carries 6 cables of 4.0 mm² T&E and 4 cables of 2.5 mm² T&E in 50 x
                  25 mm trunking.
                </p>
                <p className="font-mono text-white">4.0 mm² T&E CSA: 6 x 95.0 = 570.0 mm²</p>
                ...
                <p>
                  ...
                  x 25 mm trunking is too small. Upgrade to 50 x 50 mm trunking (45% capacity: 1,125
                  mm²), which gives 887.6 ≤ 1,125 — PASS.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 px-5">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-white text-center mb-10 max-w-2xl mx-auto">
            Purpose-built for UK electricians working to BS 7671. Eliminates manual CSA lookups and
