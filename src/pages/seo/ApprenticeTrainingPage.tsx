      ...
      <section className="relative py-16 sm:py-24 px-5 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <span className="text-white text-sm">From £6.99/mo after trial — cancel anytime</span>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4 text-white leading-relaxed">
            ...
            <p>
              ...
              approaches to identifying and repairing faults), and the full application of BS 7671:2018+A4:2026 wiring regulations.
            </p>
            <p>
