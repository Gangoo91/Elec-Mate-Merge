    ...
    content: (
      <>
        ...
        <p>
          ...
          Ireland. This means that electrical work carried out by a NICEIC-registered contractor can
          be self-certified across the whole of the UK: the contractor can sign off their own work
          as complying with the Building Regulations, without the need for a separate inspection by
          Building Control.
        </p>
        <p>
          ...
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                (periodic inspection) — and Building Control notification must be included where the
                work is notifiable.
              </span>
            </li>
          </ul>
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p>
          To achieve and maintain registration, all qualifying staff must meet the baseline set by
          the Electrotechnical Assessment Specification (EAS) — the industry-standard document that
