    ...
    <ToolTemplate
      ...
      calculator={
        <CalculatorWithEmailCapture
          calculatorName="Motor Starting Current Calculator"
          calculatorPath="/tools/motor-starting-current-calculator"
        >
          {(onResult) => <MotorStartingCurrentCalculator onResult={onResult} />}
        </CalculatorWithEmailCapture>
      }
