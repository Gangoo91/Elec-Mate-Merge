...
const sections = [
          ...
          <ul className="space-y-5 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                into boxes. Can be bent with a conduit bender to form sets, right-angle bends, and
                offsets. Can serve as the CPC when correctly earthed. Standard sizes: 16mm, 20mm,
                25mm, 32mm, 50mm OD.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                runs. Not suitable for threading and not recommended for use as a CPC.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Wrench className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                extensively in domestic surface wiring and commercial skirting and trunking
                installations. Oval conduit is used for chasing into plaster in domestic first fix.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Wrench className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                present. Must be used with appropriate end fittings for mechanical and earth
                continuity.
              </span>
            </li>
          </ul>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Heavy gauge steel conduit is the workhorse of commercial and industrial electrical wiring.
          Its combination of mechanical protection, earthing capability, and long service life makes
          it the standard specification for industrial premises, schools, hospitals, and commercial
          buildings where durability is paramount.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                or accidental damage. It is the preferred system in factories, warehouses, and
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                circuits within, per BS 7671 Regulation 543. All joints must be electrically
                continuous.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                humid environments). Stainless steel conduit is available for highly corrosive
                environments.
              </span>
            </li>
          </ul>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          PVC conduit is widely used in domestic and light commercial electrical installations in
          the UK. It is cheaper, lighter, and easier to work with than steel conduit, but does not
          provide earthing capability and has lower mechanical strength.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                fittings for permanent joints. Standard sizes: 16mm, 20mm, 25mm, 32mm OD.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Wrench className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                and is easier to cover with plaster. Available in 16mm × 4mm and 25mm × 16mm nominal
                sizes.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                movement. Failing to include expansion couplings will result in buckling, cracking,
                or pull-out at box connections.
              </span>
            </li>
          </ul>
        </div>
    ...
    content: (
      <>
        <p>
          ...
          systems. A good bend maintains the full internal bore of the conduit, allowing cables to
          be drawn through easily after installation.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-5 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                diameter). For 20mm OD conduit this gives a minimum internal radius of approximately
                40mm. Tighter bends crush the conduit and make cable drawing impossible.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Wrench className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                bender shoe matched to the conduit size — an undersized shoe will kink the conduit.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Wrench className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                apply steady pressure until the conduit reaches 90°. Verify with a set square.
                Overbent conduit can be gently straightened but will have internal deformation.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Wrench className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                the conduit returns to parallel with the original run. Accurate measurement and
                marking is essential for neat sets.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Wrench className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                kinking during bending. Heat bending allows gentle curves but requires practice to
                avoid flattening the conduit.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Draw wires (also called fish wires or pulling lines) are essential for threading cables
          through conduit runs, particularly in embedded or inaccessible conduit where the cable
          cannot be pushed through from one end.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                future cables to be pulled in without difficulty, particularly in long or bent runs.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Wrench className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                pushing through conduit when a draw wire is not present). Fish tapes are flexible
                flat steel strips wound on a reel for reaching through long runs.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Wrench className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                prevents cable sheath damage on bends. Do not use grease, oil, or washing-up liquid
                — these can degrade cable insulation.
              </span>
            </li>
          </ul>
        </div>
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                connections be accessible for inspection and maintenance. Inspection boxes should be
                positioned at bends and at regular intervals on long straight runs.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Wrench className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                to 5m on runs with multiple bends. Longer uninterrupted runs make cable drawing
                extremely difficult.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                conductors and any connections made within. Select box depth for the number and size
                of conductors.
              </span>
            </li>
          </ul>
    ...
    content: (
      <>
        <p>
          ...
          connections. Thread cutting is a necessary skill for steel conduit installation work.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                cleaned and de-burred conduit end using cutting oil to lubricate and carry away
                swarf.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                thread must engage fully with both the box entry and the locknut.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Wrench className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                Loose or corroded threads create high-resistance earth paths. Check earth continuity
                throughout the completed installation.
              </span>
            </li>
          </ul>
        </div>
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                zone. PVC has a high coefficient of thermal expansion and will buckle without
                adequate expansion provisions.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Wrench className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                to large temperature variations (e.g., external conduit between buildings). In
                indoor commercial installations, steel conduit runs rarely require expansion
                couplings due to the low coefficient of expansion and controlled internal
                environment.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                be fitted across the expansion coupling to maintain earth continuity. The expansion
                coupling itself does not maintain a reliable earth path as it is designed to slide.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Steel conduit must be earthed as a system. Where it serves as the CPC, its earth impedance
          must be verified to meet BS 7671 requirements for the protective device installed.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                must be mechanically secure and electrically continuous.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                ohmmeter. The resistance must be low enough that the earth fault loop impedance at
                the furthest point meets BS 7671 Table 41.2 for the protective device.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                joints, painted or coated conduit surfaces at connections, and locknuts not fully
                tightened. Insulating washers accidentally fitted at box entries will break the
                earth path.
              </span>
            </li>
          </ul>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Any penetration through a fire-rated structure by conduit — or by cables within conduit —
          must be fire stopped to maintain the fire compartmentation of the building. This is a
          Building Regulations requirement and a matter of life safety.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Conduit alone is not fire stopping</strong> — steel and PVC conduit both
                have hollow bores that allow flame and combustion gases to pass through a fire-rated
                structure. The conduit must be sealed with an approved fire stopping product.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Flame className="w-5 h-5 text-orange-400 mt-0.5 shrink-0" />
              <span>
                ...
                intumescent collar devices (for PVC conduit — the collar expands in heat to crush
                and seal the conduit), and proprietary fire stop block systems. Each product must be
                installed per the manufacturer's instructions and data sheet.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Flame className="w-5 h-5 text-orange-400 mt-0.5 shrink-0" />
              <span>
                <strong>Documentation</strong> — fire stopping must be recorded on a fire stopping
                schedule, giving the location, product used, installer, and date of installation.
                This documentation forms part of the building's fire safety file under the Building
                Regulations.
              </span>
            </li>
          </ul>
    ...
    content: (
      <>
        <p>
          ...
          Certificate, including earth continuity verification for steel conduit systems used as
          CPCs, and earth fault loop impedance measurements at the furthest points of the
          installation.
        </p>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  ...
                  to complete and issue Electrical Installation Certificates for conduit wiring
                  installations. Record earth continuity, insulation resistance, and earth fault
                  loop impedance results on site — instant PDF export.
                </p>
              </div>
            </div>
          </div>
