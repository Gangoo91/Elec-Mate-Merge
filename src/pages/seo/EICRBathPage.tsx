...
const faqs = [
  ...
  {
    question: 'Can an electrician complete an EICR in a Bath Georgian townhouse without damaging the property?',
    answer:
...
const sections = [
    ...
    content: (
      <>
        ...
        <p>
          ...
          stock. The city's Georgian buildings — many of which still contain electrical installations
          from the mid-20th century or earlier — require thorough inspection by experienced
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Bath EICR prices are above the South West regional average due to the city's high
          property values and the complexity of inspecting Georgian and Victorian buildings.
        ...
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Studio / one-bedroom flat</strong> — £110 to £200. Many flats in Bath
                are Georgian or Victorian conversions with complex wiring layouts.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Two-bedroom flat</strong> — £130 to £240. Georgian terrace conversions
                in Lansdown, Bathwick, and the city centre take significantly longer than modern
                flats.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Three-bedroom house</strong> — £200 to £350. Victorian terraced houses
                in Oldfield Park, Twerton, and Walcot are common in Bath's private rented sector.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
        ...
        <p>
          ...
          Listed building properties in the city centre may attract additional charges for the
          extra care required.
        </p>
      </>
    ),
          ...
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                28 days. New tenants must receive a copy before moving in.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Scale className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                ...
                28 days. In Bath listed buildings, consent may be needed first — landlords should
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Bath is unique in England for the density and quality of its Georgian architecture.
          The city centre is a UNESCO World Heritage Site and contains some of England's finest
          examples of 18th-century domestic architecture. This creates distinctive and demanding
          EICR challenges:
        </p>
        <div className="rounded-2xl bg-red-500/10 border border-red-500/20 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Early and mid-20th century wiring in Georgian buildings</strong> — many
                Bath city centre properties were first wired in the 1930s to 1950s. Rubber-
                insulated and lead-sheathed cables from this period are frequently encountered
                and are classified as C1 or C2 depending on their condition.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-red-400 mt-0.5 shrink-0" />
              <span>
                ...
                finding in Bath's pre-1990s rented properties, including the majority of Georgian
                and Victorian conversions.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-red-400 mt-0.5 shrink-0" />
              <span>
                <strong>Concealed wiring in original construction</strong> — Georgian buildings
                in Bath use original Bath stone construction with lath-and-plaster internal
                walls. Cables concealed within this original fabric cannot be easily accessed
                or traced, leading to FI observations that require further investigation.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-red-400 mt-0.5 shrink-0" />
              <span>
                ...
                arrangements: shared earth conductors, undersized main bonding conductors,
                and absent bonding to gas and water services. These are common C2 findings.
              </span>
            </li>
          </ul>
        </div>
        <p>
          Electricians working in central Bath should allow extra time for every EICR and
          develop familiarity with the constraints and requirements of working in the World
          Heritage Site. Experience liaising with Bath & North East Somerset Council's
          conservation team is a significant advantage.
        </p>
      </>
    ),
  },
        ...
        <div className="grid gap-4 sm:grid-cols-2 my-4">
          <div className="rounded-2xl bg-red-500/10 border border-red-500/20 p-5">
            ...
            <p className="text-white text-sm leading-relaxed">
              Risk of injury exists. Immediate remedial action required. In Bath, this most
              commonly relates to crumbling rubber-insulated cables from 1930s or 1940s
              wiring or exposed live conductors in poorly maintained properties.
            </p>
          </div>
          <div className="rounded-2xl bg-orange-500/10 border border-orange-500/20 p-5">
            ...
            <p className="text-white text-sm leading-relaxed">
              ...
              (Regulation 411.3.3) and inadequate earthing are the most frequent C2 findings
              in Bath's private rented sector.
            </p>
          </div>
          <div className="rounded-2xl bg-yellow-500/10 border border-yellow-500/20 p-5">
            ...
            <p className="text-white text-sm leading-relaxed">
              ...
              in Bath properties where older accessories are still functional but dated.
            </p>
          </div>
          <div className="rounded-2xl bg-blue-500/10 border border-blue-500/20 p-5">
            <h3 className="font-bold text-white text-lg mb-3">FI — Further Investigation</h3>
            <p className="text-white text-sm leading-relaxed">
              Particularly common in Bath's Georgian buildings where original stone construction
              and lath-and-plaster walls conceal wiring that cannot be safely accessed during
              the inspection without specialist consent.
            </p>
          </div>
        </div>
      </>
        ...
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              <Clock className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Owner-occupied domestic</strong> — every 10 years recommended.
                Given Bath's stock of very old properties, the 5-year interval is recommended
                for anything over 25 years old — which covers almost all of the city centre.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Clock className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
          ...
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                plus a current 18th Edition (C&G 2382) qualification. Experience with Georgian
                and Victorian listed buildings is a significant advantage in Bath.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Bath's concentration of Georgian and Victorian properties, large student population,
          and active private rented sector create consistent demand for EICR work. The complexity
          of the housing stock and the high proportion of older wiring mean that EICRs frequently
          identify remedial work, making Bath a commercially rewarding market for experienced
          inspectors.
        </p>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  ...
                  . Bath landlords face a 28-day deadline — quoting immediately gives you the
