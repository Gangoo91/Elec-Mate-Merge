...
const relatedPages: RelatedPage[] = [
  ...
  },
  {
    ...
    description:
      'Outdoor sockets share similar cable routing and IP rating requirements with security lighting.',
    icon: Cable,
    category: 'Guide',
  },
  {
...
const sections = [
  {
    ...
    content: (
      <>
        <p>
          Security lighting is one of the most effective and affordable home security measures. A
          well-positioned PIR floodlight deters intruders, illuminates paths and driveways for
          safety, and is visible confirmation that a property is protected. For electricians, it is
          reliable bread-and-butter work with quick turnaround and good margins.
        </p>
        <p>
          A typical security light installation costs <strong>£100 to £600</strong> depending on the
          type of fitting, the cable route, and how many lights are being installed. A simple
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          The following table shows typical costs for security lighting installation in the UK. All
          prices include materials and labour unless stated otherwise.
        </p>
        ...
        <p>
          ...
          approximately £13 at trade price, a 20W PIR floodlight approximately £21, and a 30W PIR
          floodlight approximately £30. The 50W PIR floodlight (for larger areas) costs
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          PIR (passive infrared) floodlights are the standard choice for domestic security lighting.
          The PIR sensor detects heat from moving objects (people, vehicles, animals) and activates
          the floodlight for a preset duration:
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                sensors with tilt and swivel capability (such as the Guardian IP44 exterior sensor,
                trade price approximately £20) allow precise coverage adjustment.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Eye className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                seconds to 10 minutes), lux level (the ambient light level below which the PIR
                activates — prevents daytime triggering), and sensitivity (reduces false triggers
                from pets, cats, and wind-blown vegetation).
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Eye className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                — equivalent to a 150W halogen. A 10W LED (800 to 1,000 lumens) is sufficient for a
                side passage. A 30W to 50W LED (2,400 to 4,000 lumens) covers a large driveway or
                rear garden.
              </span>
            </li>
          </ul>
        ...
        <p>
          ...
          sensor should face the direction of approach so that the intruder walks across the sensor
          field (side-on detection is more reliable than head-on). Mount the light at 2 to 3 metres
          height for optimal PIR performance and to make the light difficult to tamper with.
        </p>
      </>
    ),
  },
        ...
        <div className="grid gap-4 sm:grid-cols-2 my-4">
          <div className="rounded-2xl bg-blue-500/10 border border-blue-500/20 p-5">
            ...
            <p className="text-white text-sm leading-relaxed">
              Bollard lights or low-level wall lights along a driveway or garden path provide safe
              passage for residents and visitors. The continuous illumination also deters
              opportunistic intruders by eliminating dark hiding spots. LED bollard lights with
              photocells cost £30 to £80 each at trade price. Running costs are minimal — a 5W LED
              bollard running for 12 hours costs approximately 1p per night.
            </p>
          </div>
          <div className="rounded-2xl bg-green-500/10 border border-green-500/20 p-5">
            ...
            <p className="text-white text-sm leading-relaxed">
              ...
              security. A dusk-to-dawn night light pack (trade price from approximately £15 for a
              2-pack) provides low-cost ambient lighting for porches and entrance halls. For a more
              substantial fitting, a coach light or lantern with an integrated photocell costs £20
              to £60 at trade price.
            </p>
          </div>
        </div>
        <p>
          Dusk-to-dawn lights can be combined with PIR floodlights for a layered security approach —
          the dusk-to-dawn lights provide constant low-level illumination while the PIR floodlights
          activate at full brightness on detecting movement.
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>
          Security lighting installations often include provision for CCTV cameras. Electricians are
          increasingly asked to install the power and data cabling for CCTV as part of a security
          lighting package:
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                (Network Video Recorder). The electrician runs Cat6 from each camera position to the
                NVR location. This is the cleanest approach with minimal external wiring. Cost: £80
                to £150 per camera position (Cat6 run, termination, weatherproof entry point).
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Cable className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                work at all. Mains-powered WiFi cameras need a nearby power supply. The trade-off is
                that WiFi cameras are less reliable than wired PoE cameras, particularly at the edge
                of WiFi coverage.
              </span>
            </li>
          </ul>
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                locations. Ground-recessed fittings must be IP67 or IP68.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                lighting circuits. The cable must be buried at a minimum depth of 500mm with marker
                tape above it. SWA costs approximately £2 to £3 per metre at trade price.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
  ...
  },
  {
    ...
    content: (
      <>
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                of the installation and the significance of the affected part of the building. Check
            ...
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-red-400 mt-0.5 shrink-0" />
              <span>
                <strong>Conservation areas</strong> — external alterations in conservation areas may
                require planning permission. A small, discreet security light is unlikely to need
                permission, but multiple large floodlights may attract attention from the planning
                authority.
              </span>
            </li>
            <li className="flex items-start gap-3">
        ...
        <p>
          The Institution of Lighting Professionals (ILP) publishes guidance document GN01 "Guidance
          Notes for the Reduction of Obtrusive Light" which provides recommendations for domestic
          lighting installations. Following this guidance demonstrates good practice and helps avoid
          disputes.
        </p>
      </>
    ),
    ...
    content: (
      <>
        <p>
          ...
          homeowner requesting a PIR floodlight may also want CCTV preparation, garden lighting, an
          outdoor socket, or a consumer unit upgrade. Always survey the full requirement before
          quoting.
        </p>
