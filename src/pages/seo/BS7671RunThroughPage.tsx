...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'The appendices in BS 7671 contain essential reference data that you will use constantly — both in the exam and in practice. Appendix 1 lists the British Standards referred to in BS 7671. Appendix 3 gives the time/current characteristics of protective devices (fuses, circuit-breakers and RCBOs) — the basis for the maximum earth fault loop impedance limits, and where loop-impedance measurement guidance now sits. Appendix 4 contains the cable current-carrying capacity tables and the voltage drop (mV/A/m) data in Section 6 — these are the tables you use for cable sizing calculations. Appendix 6 contains the model forms for certificates (EIC, Minor Works Certificate) and reports (EICR, condition report). The maximum Zs values themselves are tabulated in Chapter 41 (Tables 41.2 to 41.6) — tab those, along with these appendices, in your book before the exam.',
  },
];
