...
const sections = [
    ...
    content: (
      <>
        <p>
          ...
          and Hove. These regulations came into force on 1 June 2020 for new tenancies and 1 April
          2021 for all existing tenancies. Every private landlord in Brighton must comply.
        </p>
        ...
        <p>
          ...
          tenancies in England, covering all student lets, co-living arrangements, and professional
          tenancies in Brighton and Hove. They do not apply to social housing or lodger arrangements
          where the landlord lives in the property.
        </p>
      </>
    ),
  },
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                penalties for non-compliance with the 2020 Regulations. Brighton has a large private
                rented sector as a proportion of total housing, making enforcement a significant
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                licence where a valid EICR cannot be provided and can revoke a licence for
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                and recover costs, in addition to imposing civil penalties.
              </span>
            </li>
          </ul>
        </div>
        <p>
          Brighton landlords should maintain clear records of all EICRs, remedial work, and tenant
          communications for every property in their portfolio. The council can request these at any
          time and treats absence of documentation as evidence of non-compliance.
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>
          Brighton and Hove has one of the largest HMO markets on the South Coast, driven by two
          universities, a young professional population, and a culture of co-living. The University
          of Brighton (city centre and Eastbourne campuses) and the University of Sussex (Falmer)
          both generate substantial demand for shared accommodation in areas including Kemptown,
          Hanover, Lewes Road, and Preston Park.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                installations, fire alarm systems, and emergency lighting is a mandatory licence
                condition.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                designated areas with high HMO concentrations. Many Brighton student properties in
                Kemptown, Hanover, and around the university campuses fall within additional
                licensing areas.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                licence certificate. Licences are usually issued for five years and EICR
                requirements are typically checked at renewal.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Users className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                terraced houses used as HMOs, and purpose-built student accommodation. Converted
                properties often have complex electrical installations with shared wiring, multiple
                consumer units, and outdated systems requiring upgrading to meet current standards.
              </span>
            </li>
          </ul>
        </div>
        <p>
          Operating an unlicensed HMO in Brighton is a criminal offence. Brighton and Hove City
          Council actively investigates unlicensed HMOs and has prosecuted landlords in the
          Magistrates' Court. Civil penalties for electrical safety non-compliance apply entirely
          separately from HMO licensing offences.
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>
          Brighton landlords who fail to comply with the 2020 Regulations face civil penalties of up
          to £30,000 per breach. The regulations create multiple distinct obligations, each of which
          ...
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                refuse to renew or revoke an HMO licence for non-compliance with electrical safety
                conditions. For Brighton landlords operating student HMOs, licence revocation can
                result in significant financial loss and reputational damage within the competitive
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                This is particularly relevant for Brighton landlords who wish to regain possession
                at the end of a student tenancy.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-red-400 mt-0.5 shrink-0" />
              <span>
                ...
                records. Repeat non-compliance results in escalated penalties and increases the
                frequency of council inspections across a landlord's Brighton portfolio.
              </span>
            </li>
          </ul>
        </div>
        <p>
          The cost of an EICR every five years — typically £150 to £400 in Brighton — is negligible
          when weighed against potential penalties and the loss of an HMO licence. Brighton
          landlords should treat electrical safety compliance as a basic operating cost.
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>
          Brighton tenants — including students, young professionals, and long-term residents — have
          specific rights under the 2020 Regulations. Brighton's active tenant advocacy community
          and strong student union networks mean these rights are increasingly well known.
        </p>
        <div className="rounded-2xl bg-blue-500/10 border border-blue-500/20 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                Always request the EICR in writing before signing a tenancy agreement in Brighton.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Right to report non-compliance</strong> — if your Brighton landlord cannot
                provide a valid EICR, report this to Brighton and Hove City Council's environmental
                health team. The University of Brighton Students' Union and University of Sussex
                Students' Union both provide housing support for students experiencing non-compliant
                landlords.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Right to prompt remedial action</strong> — if the EICR identifies C1 or C2
                ...
                must not be charged for remedial work.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                ...
                additionally protects tenants who have raised legitimate complaints about property
        ...
        <p>
          Brighton tenants can seek further advice from Citizens Advice Brighton, Shelter, or
          Brighton and Hove City Council's housing team. The council's website provides an online
          form for reporting private rented sector concerns.
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>
          When a Brighton EICR identifies C1 or C2 observations (classified under BS 7671 Section
          631), landlords must complete remedial work within the timescales set by the 2020
          Regulations.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                from the date of the inspection, not when the report arrives.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Clock className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                treat C1 observations as urgent and arrange emergency remedial work promptly, not
                wait for the 28-day deadline.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Clock className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                411.3.3 of BS 7671), replacing deteriorated consumer units, upgrading earthing and
                bonding in converted properties, replacing aged wiring, and addressing inadequate
                fire alarm and emergency lighting circuits in HMOs.
              </span>
            </li>
          </ul>
        </div>
        <p>
          Brighton landlords should maintain relationships with reliable local electricians who can
          respond quickly when remedial work is required. Delays beyond the 28-day deadline are a
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Brighton has a good supply of qualified electricians capable of carrying out EICRs. Demand
          increases during the summer months as landlords prepare student properties for the new
          academic year. Early booking is advisable for June to August inspections.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                (C&G 2382 18th Edition). Experience with converted Regency and Victorian properties
                and HMOs is particularly useful in Brighton.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Search className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                avoids availability constraints and allows time for remedial work before September
                tenancy start dates.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                both parties if an error is discovered on the report.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Brighton EICR costs are broadly in line with South East of England rates, reflecting local
          labour costs and the prevalence of older housing stock. Converted properties and HMOs with
          complex electrical installations cost more to inspect.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                inspection scope and cost significantly.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                inspection times and higher fees.
              </span>
            </li>
          </ul>
        </div>
        <p>
          These figures cover the inspection and report only. Remedial work is quoted and charged
          separately. Brighton landlords with multiple properties may benefit from negotiating
          portfolio pricing with a trusted local electrician.
        </p>
      </>
    ),
  },
    ...
    content: (
      <>
        <p>
          ...
          co-living properties, and long-term family rentals — creates sustained demand for landlord
          EICRs. The concentration of converted Victorian properties and HMOs means inspections
          frequently identify remedial work, creating follow-on revenue opportunities.
        </p>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  ...
                  to complete the full report on your phone while on site. AI board scanning, voice
                  test entry, and instant PDF export mean the Brighton landlord has their report
                  before you leave. Complete more jobs per day during the summer peak.
                </p>
              </div>
            </div>
          </div>
...
export default function LandlordElectricalSafetyBrightonPage() {
  return (
    <GuideTemplate
      title="Landlord EICR Requirements Brighton & Hove"
