...
const relatedPages: RelatedPage[] = [
  ...
  },
  {
    ...
    description:
      'What to do if someone receives an electric shock — critical first aid steps.',
    icon: AlertTriangle,
    category: 'Safety',
  },
  {
...
const sections = [
  {
    ...
    content: (
      <>
        <p>
          Not every electrical problem is an emergency. Understanding what constitutes a
          genuine electrical emergency helps you respond appropriately — and avoid paying
          emergency rates for non-urgent work.
        </p>
        <div className="rounded-2xl bg-red-500/10 border border-red-500/20 p-6 my-4">
          ...
          <ul className="space-y-3 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Sparking</strong> from a socket, switch, consumer unit, or
            ...
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-red-400 mt-0.5 shrink-0" />
              <span>
                <strong>Burning smell</strong> from wiring, fittings, or the consumer
                unit — particularly a distinctive acrid electrical burning smell
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-red-400 mt-0.5 shrink-0" />
            ...
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-red-400 mt-0.5 shrink-0" />
              <span>
                <strong>Water on electrics</strong> — flooding, burst pipes, or roof
                leaks that have reached electrical fittings or the consumer unit
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-red-400 mt-0.5 shrink-0" />
              <span>
                <strong>Total power loss</strong> that is not a local network outage
                (check by calling 105 — the free DNO fault line — or checking your
                area on the DNO's website)
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-red-400 mt-0.5 shrink-0" />
              <span>
                <strong>Electric shock</strong> — anyone who has received an electric
                shock requires medical attention; call 999 immediately
              </span>
            </li>
          </ul>
        </div>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <p className="font-semibold text-white mb-3">Non-emergency situations (can wait for a standard appointment):</p>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Taking the right steps before the electrician arrives can reduce the risk to you
          and your household, and may make the electrician's job easier and quicker.
        </p>
        <div className="rounded-2xl bg-blue-500/10 border border-blue-500/20 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Turn off at the consumer unit</strong> — if it is safe to do so,
                turn off the affected circuit at the consumer unit (or the main switch to
                the whole installation). Do not touch damaged, wet, or sparking fittings
                to do this — only use the switches on the consumer unit itself.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Do not touch wet electrics</strong> — if water has contacted
                electrical fittings, do not touch them. Turn off the main switch at
                the consumer unit if you can reach it safely without crossing the
                affected area. If you cannot do this safely, leave the building and
                call an electrician and, if necessary, the fire brigade.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Unplug appliances on the affected circuit</strong> — where safe,
                unplug appliances from sockets on the affected circuit. This eliminates
                the possibility that an appliance fault is the cause and reduces load
                on the circuit when power is restored.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Note what happened</strong> — note the sequence of events (what
                you were doing when the problem started, what you saw, heard, or smelled),
                which circuits are affected, and anything you have already tried. This
                information helps the electrician diagnose the fault quickly.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          In a genuine emergency, the priority is to find a registered electrician who is
          available immediately. Here is how to find one reliably.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                niceic.com/find-a-contractor. You can filter by location and, in
                some cases, by emergency availability. NICEIC registration means the
                electrician has been assessed for technical competence and carries
            ...
            <li className="flex items-start gap-3">
              <Search className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>NAPIT registered contractor search</strong> — go to napit.org.uk
                and use the Find a Member tool. NAPIT is a government-approved competent
                person scheme equivalent to NICEIC.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Search className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Check your home insurance policy</strong> — many home insurance
                and home assistance policies include 24/7 emergency electrician cover.
                Check your policy documents or call your insurer before paying out-of-pocket
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                recommendation for a local electrician who has recently done good work
                is often more reliable than an internet search in an emergency situation.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          In an emergency it is tempting to accept the first electrician who responds,
          but taking 60 seconds to verify registration before allowing work to begin
          protects you from unqualified or dishonest traders.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Ask for their NICEIC or NAPIT registration number</strong> — any
                registered electrician will know their registration number immediately.
                Enter it on the NICEIC or NAPIT website to confirm they are currently
                registered.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-green-400 mt-0.5 shrink-0" />
              <span>
                <strong>Ask for photo ID and a business card</strong> — a legitimate
                electrician will have no objection to providing identification. Note the
                name, company, and vehicle registration before work starts.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-green-400 mt-0.5 shrink-0" />
              <span>
                <strong>Get a price in writing before work starts</strong> — even in an
                emergency, a legitimate electrician will quote the callout fee and hourly
                rate before beginning work. Ask for this in writing (a text message is
                sufficient).
              </span>
            </li>
          </ul>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Emergency electrician rates vary significantly by region and time of day. London
          and South East rates are consistently higher than the national average.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Callout fee</strong> — typically £100 to £200 just to attend.
                This covers the electrician's time to travel to you and the first
                30 minutes or hour of their time. The callout fee is the same whether
                or not the problem can be fixed in one visit.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Hourly rate</strong> — typically £50 to £100 per hour after the
                initial callout period. Out-of-hours rates (weekends, evenings, bank
                holidays) are typically 25 to 50 per cent higher than daytime rates.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Total typical emergency callout cost</strong> — for attendance,
                diagnosis, and making safe (without significant parts), expect to pay
                £150 to £400. A straightforward fix (replacing a consumer unit main
                switch, for example) can easily exceed £500 once parts are included.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>London and South East premium</strong> — London emergency rates
                are typically 20 to 40 per cent higher than the national average, with
                callout fees of £150 to £250 being common.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Electrical emergencies create vulnerability to unscrupulous traders who charge
          high rates for poor or dangerous work. These are the warning signs to watch for.
        </p>
        <div className="rounded-2xl bg-red-500/10 border border-red-500/20 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-red-400 mt-0.5 shrink-0" />
              <span>
                <strong>Cannot provide a registration number</strong> — any legitimate
                electrician registered with NICEIC, NAPIT, or ELECSA will know their
                registration number immediately and will not hesitate to provide it.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-red-400 mt-0.5 shrink-0" />
              <span>
                <strong>Demands cash payment upfront</strong> — legitimate tradespeople
                invoice after work is completed or request a deposit for materials, not
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                confirmation of rates is better than nothing. Refusal to quote in advance
                of work starting is a warning sign.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-red-400 mt-0.5 shrink-0" />
              <span>
                <strong>Pressure to authorise extensive work immediately</strong> — some
                dishonest traders deliberately create a sense of urgency to persuade
                customers to authorise expensive work that is not actually necessary.
                A legitimate electrician will make the installation safe and explain
                what further work is required, giving you time to consider.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-red-400 mt-0.5 shrink-0" />
              <span>
                <strong>No invoicing or certification</strong> — any electrical work must
                be accompanied by an appropriate certificate (Electrical Installation
                Certificate or Minor Works Certificate). If the electrician does not
                mention certification, ask specifically.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Once the immediate situation is resolved and the installation has been made safe,
          there are important follow-up steps to take.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Obtain a certificate for the work done</strong> — insist on an
                Electrical Installation Certificate or Minor Works Certificate for any
                work carried out. This is a legal requirement for notifiable work and
                provides evidence the work was done safely.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Arrange a full EICR</strong> — an electrical emergency often
                indicates an underlying issue with the installation. An{' '}
                <SEOInternalLink href="/guides/eicr-for-landlords">
                  Electrical Installation Condition Report (EICR)
                </SEOInternalLink>{' '}
                will assess the whole installation and identify any other faults before
                they cause another emergency.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Notify your insurer</strong> — if the emergency resulted in
                damage to your property or its contents, contact your home insurer to
                discuss a claim. The electrician's certificate and invoice will be
                required evidence.
              </span>
            </li>
          </ul>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Emergency electrical work commands premium rates and can be a lucrative part of
          an electrician's business. Here is how to position yourself effectively.
        </p>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-white text-sm leading-relaxed">
                ...
                Business profile, and any directory listings. Customers searching for an
                emergency electrician will be reassured by clear evidence of registration.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-white text-sm leading-relaxed">
                ...
                to complete and issue Minor Works Certificates and EICs on site before
                you leave. Handing the customer a certificate immediately builds trust
                and differentiates you from unregistered traders.
              </p>
            </div>
          </div>
        </div>
        <SEOAppBridge
          ...
          description="Join 430+ UK electricians using Elec-Mate for on-site certificate completion, AI board scanning, and instant PDF export. Start your 7-day free trial."
          icon={FileCheck2}
        />
      </>
    ),
...
export default function FindingEmergencyElectricianPage() {
  return (
    <GuideTemplate
      ...
      ctaSubheading="Issue Minor Works Certificates and EICs on site before you leave. Join 430+ UK electricians. 7-day free trial, cancel anytime."
    />
  );
}
