...
const faqs = [
  ...
  {
    question:
      'What are the differences between pharmaceutical and semiconductor cleanroom electrical requirements?',
    answer:
...
const relatedPages: RelatedPage[] = [
  {
    ...
    description:
      'GMP cleanroom wiring, IQ/OQ/PQ validation, isolation transformers, and FDA 21 CFR compliance.',
    icon: ShieldCheck,
    category: 'Guide',
  },
  {
...
const sections = [
    ...
    content: (
      <>
        ...
        <p>
          ...
          manufacturing, aerospace component assembly, precision optics, and biotechnology research.
          The classification level and specific requirements differ between sectors, but the
          fundamental principles of cleanroom electrical installation are consistent.
        </p>
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                industrial environments — surface-mounted boxes, open cable tray, exposed conduit
                threads — are incompatible with cleanroom requirements. They generate particles,
                create surfaces that cannot be cleaned, and may disrupt critical airflow patterns.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Building2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                must be coordinated with the HVAC system (which drives the cleanroom
                classification), the process equipment (which has specific power and control
                requirements), and the building structure (which defines where cables can run
                without compromising the cleanroom envelope).
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          ISO 14644-1:2015 is the international standard that defines cleanroom classifications. The
          classification of each area in a facility determines the specification of the electrical
          installation — from the complexity of the sealing regime to the materials permitted for
          cable management.
        </p>
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                classification for most industrial applications. Used for pharmaceutical aseptic
                filling (Grade A), semiconductor critical areas, and precision optics assembly.
                Unidirectional (laminar) airflow is essential. The electrical installation must be
                minimal, completely flush, and must not disturb the laminar flow. Every penetration
                must be sealed. Materials must not shed particles or be attacked by disinfectants.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ClipboardCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>ISO 6 and ISO 7 (35,200 to 352,000 particles/m³)</strong> — used for
                pharmaceutical background environments (Grade B/C), medical device assembly, and
                many electronics manufacturing applications. Turbulent (non-unidirectional) airflow
                is typically used. Flush mounting and sealed penetrations remain essential. Slightly
                more latitude in material selection than ISO 5.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ClipboardCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>ISO 8 (≤3,520,000 particles/m³)</strong> — used for general pharmaceutical
                manufacturing (Grade D), medical device assembly secondary areas, and clean
                manufacturing generally. Requirements are significantly less stringent than ISO 5–7
                but still require a controlled approach to electrical installation — cleanable
                surfaces, no horizontal ledges, sealed penetrations.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ClipboardCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                ...
                (personnel present) states. The classification is typically specified in the at-rest
                or occupied state. Personnel are a major source of particles — the electrical
                installation must be designed to support the room achieving its classification with
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                boards, MCCs, and main panels outside the cleanroom envelope wherever possible. Run
                cables through the cleanroom wall in sealed conduits rather than routing
                distribution panels inside the room.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                prevent particle generation from cable movement. All joints must be sealed. The
                conduit system must be self-draining or provided with drain points to prevent liquid
                accumulation.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                available with anti-static or ESD-dissipative sheaths for semiconductor
                applications. All cables should be wiped down with cleanroom- compatible wipes
                before installation to remove manufacturing debris.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                edges, and cut ends. Cleanroom-grade cable ties with no cut tail requirement,
                smooth-head bolts and screws, and captive fasteners minimise fastener-related
                particle generation.
              </span>
            </li>
          </ul>
    ...
    content: (
      <>
        <p>
          ...
          requirement driven by cleanability, airflow management, and contamination control. Every
          electrical accessory in a cleanroom must be evaluated for its mounting method and its
        ...
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Wall-mounted socket outlets and switches</strong> — must be set flush in the
                cleanroom wall with a continuous, gapless seal between the fitting plate and the
                wall surface. The seal must be compatible with cleaning and disinfection agents. Any
                gap between the fitting and the wall is a particle trap and a potential harborage
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                flush-mounted in the ceiling with sealed edges. Recessed luminaires are preferred —
                they sit within the ceiling structure with a flush, sealed frame. Luminaires must
                not allow air to bypass HEPA filtration by leaking around the fitting. In ISO 5
                cleanrooms, luminaires are often integrated into the ceiling panel system with
                sealed frames.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Building2 className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Control panels and HMIs</strong> — control panels within cleanrooms must be
                flush-mounted where possible, or be hygienic in design (smooth, sloped tops, no
                horizontal ledges, fully sealed). HMI (Human Machine Interface) screens should be
                panel-mounted with sealed bezels. Keyboards, if used, should be sealed membrane
                types compatible with cleanroom cleaning and disinfection.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Building2 className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                ...
                cleanroom wall (for cable entry or control wiring), the junction between the panel
                frame and the wall must be continuously sealed to maintain the cleanroom envelope
    ...
    content: (
      <>
        <p>
          ...
          represents a potential breach of the cleanroom envelope. Unsealed penetrations allow the
          positive pressure differential to drive cleanroom air outward (acceptable) but also allow
          particles from outside to bypass HEPA filtration if the pressure differential is lost —
          which is exactly when contamination control is most critical.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                cable sheath and the wall/conduit penetration. Silicone sealant is commonly used to
                seal the interface between gland and wall.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                conduit sealing systems (foam putty, gel seals, or modular frame seals) are
                available that maintain the seal after cable installation and can be reopened for
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                finding in pharmaceutical GMP audits and quality system reviews. Photographic
                records of the sealing condition at handover are good practice.
              </span>
            </li>
          </ul>
        </div>
    ...
    content: (
      <>
        <p>
          ...
          air quality control. The electrical systems that support HEPA filtration — fan motors,
          variable speed drives, filter differential pressure monitoring — are critical
          infrastructure whose failure directly impacts cleanroom classification.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              <ClipboardCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Filter differential pressure monitoring</strong> — the pressure drop across
                each HEPA filter bank is monitored to detect filter loading. A rising differential
                pressure indicates filter loading and triggers an alert for maintenance.
                Differential pressure transmitters are connected to the BMS. Monitoring signals are
                GMP-critical in pharmaceutical cleanrooms and must be calibrated at defined
                intervals.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ClipboardCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Fan motor controls</strong> — cleanroom fans are typically controlled by
                variable speed drives (VSDs) to maintain constant airflow as filters load. VSDs must
                be located outside the cleanroom (EMI and heat generation from VSDs are incompatible
                with cleanroom requirements). VSD output cables must be screened to minimise EMI.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ClipboardCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Fan failure alarms</strong> — failure of a cleanroom fan must trigger an
                immediate alarm. In pharmaceutical cleanrooms, fan failure alarms are GMP-critical —
                a defined response procedure must be in place. The BMS must detect fan failure
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Air handling units (AHUs) serving cleanrooms are substantial items of plant that require
          significant electrical supplies. AHU electrical installation involves motor supplies,
          control panels, VSD installation, heating and cooling electrical connections, and
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                corridors. The MCC room environment must be controlled to avoid excessive heat,
                humidity, or contamination that could affect MCC reliability.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Users className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                refrigeration), and sometimes electric re-heat coils. All electrical connections to
                these services must be rated for the operating conditions (high humidity in the
                airstream, exposure to condensation).
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Users className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                classification loss from a single equipment failure. The electrical installation
                must support the automatic changeover function, including interlocks that prevent
                both fans running simultaneously (unless designed for concurrent operation).
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Maintaining positive pressure in cleanrooms relative to adjacent non-cleanroom spaces is
          essential to preventing contamination ingress. The electrical systems that support
        ...
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Pressure transducer installation</strong> — pressure transducers must be
                located where they accurately reflect the pressure differential between the
                cleanroom and the adjacent space. Transducers must not be located near air supply
                diffusers or extract grilles where local pressure variations would give misleading
                readings. Signal cables must be screened to prevent EMI from VSD drives affecting
                the measurement.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>BMS integration</strong> — pressure monitoring data is integrated into the
                Building Management System (BMS) for trending, alarm management, and reporting. The
                BMS connection must be reliable — loss of pressure monitoring data is itself an
                alarm condition in GMP environments. Redundant BMS communication paths are used in
                critical pharmaceutical cleanrooms.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                ...
                Calibration records must be maintained and available for regulatory inspection. The
                calibration uncertainty must be appropriate for the measurement range (typically ±1
                Pa for cleanroom differential pressures of 10–15 Pa).
              </span>
            </li>
          </ul>
        </div>
    ...
    content: (
      <>
        <p>
          ...
          essential part of the infrastructure that protects the cleanroom classification and the
          processes it supports from the consequences of mains power interruption.
        </p>
        <div className="rounded-2xl bg-blue-500/10 border border-blue-500/20 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Essential loads</strong> — the UPS must cover all loads whose failure during
                a mains interruption would cause cleanroom classification loss or process failure:
                HVAC fan motors, HEPA filter fans, pressure monitoring systems, environmental
                monitoring systems, BMS, and process equipment in critical operational states.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Autonomy sizing</strong> — UPS autonomy must cover the time for an emergency
                generator to start and take load (typically 10–30 seconds for automatic start) plus
                an appropriate safety margin. For cleanrooms without emergency generation, UPS
                autonomy must cover the time required for safe shutdown of critical processes —
                which may be 30 minutes or more.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Static transfer switch</strong> — modern online double-conversion UPS
                systems provide seamless (zero break time) changeover between mains and battery
                supply. This is essential for sensitive process equipment that cannot tolerate any
                supply interruption. Older offline UPS systems with transfer times of 5–20ms are not
                suitable for the most sensitive loads.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Battery maintenance and testing</strong> — UPS batteries must be tested at
                defined intervals to verify that the required autonomy is still available. Battery
                capacity decreases over time, particularly in warm environments. In GMP cleanrooms,
                UPS battery test records form part of the maintenance documentation available for
                MHRA inspection.
              </span>
            </li>
          </ul>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Cleanroom electrical work requires technical competence, attention to detail, and strict
          compliance with cleanroom protocols. The financial rewards reflect the specialist nature
          of the work and the consequences of getting it wrong.
        </p>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  Before entering a cleanroom, you must complete site-specific gowning training and
                  demonstrate compliance with cleanroom behaviour rules — no cosmetics or perfume,
                  no particle-shedding clothing under gowns, slow deliberate movements, no eating or
                  drinking, strict tool and material control. Violations result in immediate removal
                  from the cleanroom and potential site ban. The cleanroom operator's rules exist to
                  protect their product and must be respected without exception.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  ...
                  Every aspect of the installation must be documented, tested, and formally
                  recorded. Use{' '}
                  <SEOInternalLink href="/tools/eicr-certificate">Elec-Mate</SEOInternalLink> to
                  produce professional test records and inspection reports that support IQ protocol
                  completion and give quality departments the documentation they need for regulatory
                  compliance.
                </p>
              </div>
            </div>
