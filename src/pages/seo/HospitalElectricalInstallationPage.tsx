...
const faqs = [
  {
    question: 'What is IEC 60364-7-710 and how does it apply to UK hospital electrical installations?',
    answer:
...
const sections = [
    ...
    content: (
      <>
        <p>
          ...
          vulnerable patients, life-critical equipment, 24/7 operational requirements, and
          complex regulatory obligations makes healthcare electrical engineering a distinct specialism.
        ...
        <p>
          ...
          IEC 60364-7-710 for medical locations. The primary management and design guidance is
          NHS England's Health Technical Memorandum HTM 06-01. These documents must be read
          together — BS 7671 provides the statutory minimum requirements, while HTM 06-01 provides
          the additional engineering guidance appropriate for NHS facilities.
        </p>
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                equipment is used in direct contact with patients, including private facilities
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                apply in full to all healthcare premises. NHS facilities also have obligations
                under the Health and Safety at Work etc. Act 1974 and the Care Quality Commission
                (CQC) registration requirements, which include electrical safety.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Building2 className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                ...
                Engineer (Electrical) under HTM 06-01. This person holds overall technical
                authority for the electrical safety of the estate and authorises Appointed Persons
                and Competent Persons to carry out work on the electrical installation.
              </span>
            </li>
          </ul>
        </div>
    ...
    content: (
      <>
        <p>
          ...
          the nature of the medical activity carried out and the consequence to patient safety of
          an electrical supply interruption or fault.
        </p>
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                used. Examples: waiting rooms, hospital corridors, administrative areas. Standard
                BS 7671 requirements apply with no special Section 710 measures beyond general
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                examination rooms, physiotherapy rooms, radiology (X-ray), general wards,
                dental surgeries. 30mA RCDs are required on all socket circuits within the patient
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                theatres, cardiac catheter labs, ICUs, NICUs, anaesthetic rooms. IT systems
                with insulation monitoring are mandatory. Essential supply changeover within 0.5
                seconds for life-critical circuits is required.
              </span>
            </li>
          </ul>
        </div>
    ...
    content: (
      <>
        <p>
          ...
          sets out specific requirements that supplement or modify the general requirements of
          the rest of the standard for medical locations. Key requirements include:
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Regulation 710.312.2 — Essential supply:</strong> Final circuits for
                life support systems, operating theatre lighting, and surgical luminaires must be
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                must be prepared and kept at the main distribution point. This forms part of
                the as-built documentation for the installation.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Regulation 710.53 — Isolation and switching:</strong> A means of
                switching off the electrical supply to each Group 2 location in an emergency must
                be provided outside the room, clearly labelled, and accessible to authorised
                persons only. This must not interrupt the supply to essential circuits fed from
                the Category 1 essential supply.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          The IT system is the defining electrical feature of Group 2 medical locations. Understanding
          how IT systems work, and how to install and test them correctly, is essential for electricians
          working in operating theatres and critical care environments.
        </p>
        <div className="rounded-2xl bg-blue-500/10 border border-blue-500/20 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                transformer (compliant with BS EN 61558-2-15) separates the Group 2 circuit from
                the earthed supply, creating an unearthed (isolated) secondary. The transformer
                is typically rated 0.5 kVA to 10 kVA and is specifically designed for medical use
                with reinforced insulation and a secondary leakage current not exceeding 0.5mA.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Insulation Monitoring Device (IMD):</strong> The IMD continuously
                measures the insulation resistance between each conductor of the IT system and
                earth. When the combined insulation resistance falls below the alarm threshold
                (typically 50 kΩ at 25V DC test voltage), a visual and audible alarm is activated
                at the local alarm panel in the medical location. The alarm does not interrupt
                supply — it signals the need for maintenance action.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Load line monitor (LIM):</strong> A load line monitor (also called a
                line isolation monitor in some standards) indicates the total hazard current that
                would flow in the event of a fault. In US-influenced specifications this device
                is prominent; in UK practice the IMD described in BS 7671 Section 710 serves
                the same function.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Testing:</strong> IT systems must be tested on commissioning and at
                regular intervals. Testing includes: verification of IMD alarm function, measurement
                of transformer secondary leakage current, insulation resistance measurement of
                all circuits, and verification of equipotential bonding continuity throughout
        ...
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Category 1 — No-break supply (0 to 0.5 seconds):</strong> Supplied by
                a UPS system. Covers life support equipment, cardiac monitors, critical alarm
                systems, and operating theatre lighting. The UPS must bridge the gap between
                mains failure and generator start without any interruption to supply.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Category 2 — Short-break supply (up to 15 seconds):</strong> Supplied
                via Automatic Transfer Switches (ATS) from the generator. Covers emergency
                lighting, general operating theatre power, endoscopy, and high-dependency
                ward circuits. The generator must start, reach stable voltage and frequency,
                and the ATS must transfer within 15 seconds of mains failure.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
    ...
    content: (
      <>
        <p>
          ...
          guidance for NHS facilities and compliance with it is expected by NHS Estates teams
          and the CQC.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Authorising Engineer (Electrical):</strong> HTM 06-01 requires NHS trusts
                to appoint an Authorising Engineer (Electrical) — an independent, suitably qualified
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                work in hospitals must be carried out under a formal Permit to Work system. The
                PTW defines the work scope, isolation points, testing requirements, and safe working
            ...
            <li className="flex items-start gap-3">
              <Settings className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Periodic inspection:</strong> HTM 06-01 specifies inspection frequencies
                for all categories of electrical installation in healthcare premises. Group 2
                medical locations require annual testing of the IT system and equipotential bonding.
                The main electrical installation should be inspected at intervals not exceeding
        ...
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Group 1 socket outlets:</strong> In Group 1 medical locations, all
                socket outlets within the patient environment must be protected by a 30mA RCD
                in accordance with Regulation 710.411.3.2.5 of BS 7671. Type A RCDs are suitable
                for most applications; Type B RCDs are required where equipment with DC residual
                current components (such as some MRI-compatible equipment) is connected.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Group 2 — no standard RCDs:</strong> In Group 2 locations, standard
                30mA RCDs are not used on circuits within the patient environment because
                a nuisance trip during surgery could be fatal. Protection is provided by the
                IT system and IMD as described above, combined with supplementary equipotential
                bonding.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Overcurrent protection:</strong> Circuit breakers in medical locations
                must be selected to achieve correct discrimination between upstream and downstream
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                patient) must be connected by supplementary equipotential bonding conductors to
                a local equipotential bonding bar (patient zone bonding bar). This includes bed
                frames, medical equipment frames, metallic pipework, HVAC components, and
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                be sized in accordance with Regulation 544.2 of BS 7671, with a minimum
                cross-sectional area of 2.5 mm² if mechanically protected or 4 mm² if not
            ...
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Bonding verification:</strong> The resistance of each supplementary
                bonding connection must be measured on commissioning and periodically thereafter.
                BS 7671 Section 710 requires a maximum resistance of 0.2 ohm between any two
                simultaneously accessible conductive parts within the patient environment.
              </span>
            </li>
          </ul>
        </div>
    ...
    content: (
      <>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  ...
                  to complete Electrical Installation Certificates and test schedules on site,
                  with immediate PDF delivery to the NHS Estates team.
                </p>
              </div>
            </div>
          </div>
        ...
        <SEOAppBridge
          ...
          description="Join 430+ UK electricians using Elec-Mate for on-site certification, quoting, and project management. Complete EICs and EICRs on your phone. 7-day free trial."
          icon={FileCheck2}
        />
      </>
    ),
...
export default function HospitalElectricalInstallationPage() {
  return (
    <GuideTemplate
      ...
      ctaSubheading="Join 430+ UK electricians using Elec-Mate for on-site certification, quoting, and project management in healthcare environments. 7-day free trial, cancel anytime."
    />
  );
}
