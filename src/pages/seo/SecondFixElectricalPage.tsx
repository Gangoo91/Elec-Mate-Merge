    ...
    content: (
      <>
        ...
        <p>
          ...
          <SEOInternalLink href="/eic-certificate">EIC certificate</SEOInternalLink> workflow. Enter
          the circuit details once and the chart is included in the certificate PDF — no separate
          chart to print.
        </p>
      </>
    ),
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p>
          Elec-Mate's <SEOInternalLink href="/eic-certificate">EIC certificate app</SEOInternalLink>{' '}
          ...
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                an SPD, explain what they do and what the customer should do if they trip.
              </span>
            </li>
          </ul>
        </div>
