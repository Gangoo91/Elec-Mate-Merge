...
const sections = [
    ...
    content: (
      <>
        ...
        <p>
          ...
          FI observation codes — not a simple pass or fail. The overall outcome is either
    ...
    content: (
      <>
        ...
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Studio / one-bedroom flat</strong> — £130 to £220. Common in the city
                centre and Cowley Road area.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Two-bedroom flat</strong> — £150 to £270. Victorian conversions near
                the city centre take longer to inspect than modern purpose-built flats.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Three-bedroom house</strong> — £220 to £380. Victorian terraced houses
                in Jericho, East Oxford, and Headington are the backbone of Oxford's private
                rented sector.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Four-bedroom+ house / HMO</strong> — £350 to £650+. Oxford's student
                HMO market is one of the densest in England. HMOs require broader inspection
                scope including fire alarm and emergency lighting.
              </span>
            </li>
          </ul>
        </div>
        <p>
          ...
          Some Oxford electricians offer combined EICR and remedial packages for portfolio
          landlords managing multiple student lets.
        </p>
      </>
    ),
  },
          ...
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                28 days. Written confirmation must be provided to the tenant and to Oxford City
            ...
            <li className="flex items-start gap-3">
              <Scale className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Penalties</strong> — Oxford City Council can issue civil penalties of up
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Oxford's housing stock is characterised by a high concentration of Victorian and
          Edwardian terraced properties, many converted into student HMOs, alongside some of
          England's finest examples of listed and conservation area buildings:
        </p>
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                finding in Oxford's large stock of pre-1990s rented properties.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-red-400 mt-0.5 shrink-0" />
        ...
        <div className="grid gap-4 sm:grid-cols-2 my-4">
          <div className="rounded-2xl bg-red-500/10 border border-red-500/20 p-5">
            ...
            <p className="text-white text-sm leading-relaxed">
              Risk of injury exists. Immediate remedial action required. Common in Oxford
              properties with crumbling rubber-insulated cables or exposed live conductors in
              poorly maintained HMOs.
            </p>
          </div>
          <div className="rounded-2xl bg-orange-500/10 border border-orange-500/20 p-5">
            ...
            <p className="text-white text-sm leading-relaxed">
              ...
              in Oxford's private rented sector.
            </p>
          </div>
          <div className="rounded-2xl bg-yellow-500/10 border border-yellow-500/20 p-5">
            ...
            <p className="text-white text-sm leading-relaxed">
              ...
              in Oxford properties where older accessories are functional but dated.
            </p>
          </div>
          <div className="rounded-2xl bg-blue-500/10 border border-blue-500/20 p-5">
            ...
            <p className="text-white text-sm leading-relaxed">
              ...
              listed properties where cables cannot be traced without potentially damaging
              historic fabric.
            </p>
          </div>
        </div>
        ...
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              <Clock className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>HMO</strong> — every 5 years minimum under Oxford City Council HMO
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                moves into any privately rented Oxford property, even if the current EICR has
                not expired.
              </span>
            </li>
          </ul>
          ...
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                HMOs and listed buildings is an advantage in Oxford.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  ...
                  to complete reports on your phone while still on site. AI board scanning,
                  voice test entry, and instant PDF export mean the landlord has the report
                  before you leave.
                </p>
              </div>
            </div>
