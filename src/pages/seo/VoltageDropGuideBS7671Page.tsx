...
export default function VoltageDropGuideBS7671Page() {
  return (
    <GuideTemplate
      ...
      ctaSubheading="Every Appendix 4 table built in. Enter cable type, length, and load — get an instant pass/fail result. Plus 70 more calculators, 19 certificate types, and 8 AI agents. 7-day free trial."
    />
  );
}
