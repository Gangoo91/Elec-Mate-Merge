...
const relatedPages: RelatedPage[] = [
  {
    ...
    description: 'Local price bands and labour rates for consumer unit replacement in Birmingham.',
    icon: PoundSterling,
    category: 'Guide',
  },
  {
    ...
    content: (
      <>
        ...
        <SEOAppBridge
          ...
          description="Elec-Mate connects you with NICEIC and NAPIT registered electricians across Birmingham and the West Midlands."
          icon={MapPin}
        />
      </>
    ),
