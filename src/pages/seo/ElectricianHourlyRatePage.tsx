...
const relatedPages: RelatedPage[] = [
  {
    ...
    description: 'Step-by-step guide to calculating your minimum viable hourly rate as a sole trader.',
    icon: PoundSterling,
  ...
  },
  {
    ...
    description: 'Public liability, employer\'s liability, professional indemnity, and tool insurance explained.',
    icon: ShieldCheck,
    category: 'Business Guide',
  },
  {
...
const sections = [
  {
    ...
    content: (
      <>
        <p>
          Electrician hourly rates in the UK have increased consistently over the past three
          years, driven by rising fuel costs, materials inflation, and strong demand for qualified
          electricians. The rates below reflect what electricians are charging their clients
          in 2026, not what they take home.
        </p>
        <div className="rounded-2xl bg-blue-500/10 border border-blue-500/20 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Standard domestic rate (UK average)</strong> — £48 to £68 per hour.
                A qualified sole trader electrician in most parts of the UK charges within this
                range for standard domestic installation and maintenance work.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Commercial and industrial rate (UK average)</strong> — £55 to £80
                per hour. Commercial work typically attracts a higher rate due to more complex
                specifications, testing requirements, and documentation.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Specialist work premium</strong> — EV charger installation, solar PV,
                data centres, HV systems, and fire alarm work attract a 20 to 40 per cent
                premium above standard rates, reflecting additional qualifications, specialist
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Where you work is one of the most significant factors in determining what you can
          charge. The following regional rates are for qualified sole trader electricians
          doing domestic and light commercial work in 2026.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>London (inner)</strong> — £70 to £90 per hour. Central London rates
                reflect the congestion charge, ULEZ costs (up to £12.50/day), parking charges,
                high cost of living, and strong demand. Top specialists in London regularly
                charge £90 to £110/hr.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                including Kent, Essex, Surrey, and the Home Counties. Lower operating costs
                than inner London but strong demand from high-income residential clients.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <MapPin className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>South West</strong> — £50 to £70 per hour. Bristol, Bath, Exeter,
                and the wider South West. Strong demand in coastal areas and from second-home
                owners. Seasonal fluctuations in some rural areas.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <MapPin className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Midlands</strong> — £45 to £65 per hour. Birmingham, Nottingham,
                Leicester, Derby. Strong commercial and industrial sector. Domestic rates
                towards the lower end of this range in lower-income residential areas.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <MapPin className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>North of England</strong> — £40 to £60 per hour. Manchester,
                Leeds, Sheffield, Newcastle. Rate variation is significant — Manchester
                city centre rates approach South East levels while rural Yorkshire and
                County Durham rates are at the lower end.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <MapPin className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Scotland</strong> — £45 to £65 per hour. Edinburgh and Glasgow
                at the higher end; rural Highlands and Islands at or below the lower end.
                The oil and gas sector in Aberdeen supports premium rates for industrial
                electricians (£65 to £90/hr).
              </span>
            </li>
            <li className="flex items-start gap-3">
              <MapPin className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Wales and Northern Ireland</strong> — £38 to £55 per hour. Lower
                average rates reflecting lower average incomes. Cardiff and Belfast city
                centres trend towards the upper end of local ranges.
              </span>
            </li>
          </ul>
        </div>
    ...
    content: (
      <>
        <p>
          ...
          Understanding why rates differ — and what they pay for — helps you position your
          pricing confidently.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Sole trader rates</strong> — typically £45 to £75/hr. Lower overheads
                than a company (no employer&apos;s NI on employees, smaller office costs, no
                management layer). Can offer competitive prices while maintaining healthy
                margins. Clients deal directly with the qualified electrician on the job.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Small electrical company (1–5 electricians)</strong> — typically
                £55 to £80/hr. Higher overhead structure: employer&apos;s NI contributions,
                office administration, management time, and greater insurance requirements.
                Can offer more scheduling flexibility and backup cover.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Medium to large contractor</strong> — typically £75 to £120/hr
                (often quoted as a day rate for planned works). High overhead, project
                management, dedicated estimating teams, and accreditations for commercial
                and public sector work. Often the only option for large commercial or
            ...
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Labour-only subcontract rate</strong> — £28 to £50/hr (labour only,
                no materials, no certification). This is what a qualified electrician receives
                when working as a subcontractor for a main contractor. Not a consumer-facing
                rate — do not benchmark your charge-out rate against this.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          A callout charge covers the cost of your time and transport to attend a job,
          regardless of how long the work takes once you arrive. It is a legitimate and
          standard part of electrical pricing.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Typical domestic callout charge</strong> — £50 to £100, covering
                travel and the first 30 to 60 minutes on site. Clearly communicate to the
                client that this is charged regardless of outcome (including situations where
                you attend and find no fault).
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Clock className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Minimum charge</strong> — set a minimum charge of 1 to 2 hours for
                any visit. A 20-minute job still costs you travel time and vehicle running
                costs. A £35 minimum charge for a 15-minute job is appropriate and expected
                by most clients.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Clock className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Travel time</strong> — charging for travel time is standard practice.
                Many electricians charge 50% of their standard rate for travel beyond a set
                radius (e.g., 10 miles from base). Clearly state this policy when quoting.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Emergency electrical work — power failures, tripped circuits that cannot be reset,
          exposed live conductors — justifies a premium rate. Clients calling in a genuine
          emergency expect to pay more, and your pricing should reflect the inconvenience
          and readiness cost of providing this service.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Evening and weekend (out of hours)</strong> — 1.5x standard rate.
                A standard rate of £55/hr becomes £82.50/hr. Most electricians define
                &quot;out of hours&quot; as weekdays after 6pm and all day Saturday.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Sunday and bank holiday emergency</strong> — 2x standard rate.
                A standard rate of £55/hr becomes £110/hr. Bank holiday callouts often
                attract an additional fixed premium of £50 to £100 on top of the doubled rate.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Minimum emergency call charge</strong> — typically 2 hours at the
                emergency rate. Attending a job that takes 30 minutes at midnight costs
                you the same in preparation, travel, and disruption as a 2-hour job.
                A 2-hour minimum is standard and fair.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Communicate rates clearly upfront</strong> — state your emergency
                rates clearly when the client calls, before you attend. A client who agrees
                to your emergency rate before you arrive will not dispute it afterwards.
                Disputes about rates are almost always caused by a failure to communicate
                the rate before starting work.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Understanding your true costs is essential to setting a rate that keeps your
          business profitable. Many electricians underestimate their overhead and undercharge
          as a result. The following annual cost estimates are for a typical UK sole trader
          electrician in 2026.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                depreciation alone if purchased new. Fuel adds £3,000 to £6,000 depending on
                mileage and fuel type. Van insurance for a commercial vehicle with tools is
                £1,500 to £3,000/year.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Tools and test equipment</strong> — £1,000 to £3,500 per year.
                Multifunction testers, insulation resistance testers, clamp meters, hand
                tools, and consumables. A quality multifunction tester (Megger MFT1741 or
                equivalent) represents a one-off cost of £500 to £900 with ongoing calibration.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Public liability insurance</strong> — £400 to £900/year for £5m
                public liability cover. Essential for any client-facing work. See the{' '}
            ...
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>NICEIC or NAPIT registration</strong> — £400 to £800/year depending
                on scheme tier and business size. Required to self-certify notifiable work.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                (certificates and quoting), accounting software, phone contract, and
                accountancy fees if you use a bookkeeper or accountant.
              </span>
            </li>
          </ul>
        </div>
        <p>
          ...
          between £12,000 and £25,000. This must be earned before you pay yourself a penny.
          Use this figure in your rate calculation: (target annual income + annual overhead)
          divided by chargeable hours per year equals your minimum charge-out rate.
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>
          Most experienced electricians use fixed-price quotes for the majority of domestic
          work and reserve hourly charging for reactive and diagnostic work. Here is how
          to decide which approach to use and how to set the price.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                replacements, new circuits, rewires, and appliance installations are all
                well-suited to fixed pricing. Estimate the time based on your experience,
                add materials at cost plus mark-up, and quote a single all-inclusive price.
                Clients prefer this and it protects your margin on straightforward jobs.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Hourly rate — use for fault-finding and investigation</strong> —
                when you do not know what you will find, quote an hourly rate with an estimated
                maximum. &quot;Fault-finding at £60/hr, estimated 1 to 3 hours&quot; is honest and
            ...
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Materials mark-up</strong> — charge materials at trade price plus 15
                to 25 per cent. This compensates for the time spent sourcing, ordering, and
                carrying materials, and is standard practice. Clients who query this are
                comparing your trade price to the retail price they see online — explain that
                you carry stock, manage suppliers, and return unused materials.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Always confirm in writing</strong> — a written quote protects both
                parties. Use the{' '}
    ...
    content: (
      <>
        ...
        <div className="space-y-4 my-4">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  Clients who receive a professional, written quote on the day of a site visit
                  are significantly more likely to accept than those who receive one a day later.
                  Use the{' '}
                  <SEOInternalLink href="/tools/electrical-quoting-app">
                    Elec-Mate quoting app
                  </SEOInternalLink>{' '}
          ...
          <div className="rounded-2xl bg-green-500/10 border border-green-500/20 p-5">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h4 className="font-bold text-white mb-1">Issue Certificates and Invoices Together</h4>
                <p className="text-white text-sm leading-relaxed">
                  ...
                  and convert the job to an invoice in the same session.
                </p>
              </div>
            </div>
          </div>
        ...
        <SEOAppBridge
          ...
          description="Join 430+ UK electricians using Elec-Mate to produce professional quotes, certificates, and invoices on site. Stop losing jobs to slower competitors. 7-day free trial."
          icon={Zap}
        />
      </>
    ),
...
export default function ElectricianHourlyRatePage() {
  return (
    <GuideTemplate
      ...
      ctaSubheading="Join 430+ UK electricians using Elec-Mate to produce professional quotes, certificates, and invoices on site. 7-day free trial, no credit card required."
    />
  );
}
