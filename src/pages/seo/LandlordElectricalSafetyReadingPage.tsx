...
const relatedPages: RelatedPage[] = [
  ...
  },
  {
    ...
    description: 'EICR requirements for Brighton landlords, HMO licensing, and converted property challenges.',
    icon: Building2,
    category: 'Guide',
  },
  {
...
const sections = [
    ...
    content: (
      <>
        <p>
          ...
          for all existing tenancies. Every private landlord in Reading must comply, regardless
          of property age, type, or tenant category.
        </p>
          ...
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                the EICR to Reading Borough Council within seven days if requested.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Scale className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                ...
                who is qualified and competent, meaning registration with a recognised competent
                person scheme (NICEIC, NAPIT, ELECSA, or equivalent).
              </span>
            </li>
          </ul>
        </div>
        <p>
          ...
          across Reading, Earley, Caversham, and the surrounding borough. They do not apply to
          social housing or lodger arrangements where the landlord lives in the property.
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>
          Reading Borough Council is the local housing authority responsible for enforcing the
          2020 Regulations within Reading. The council's environmental health team handles
          private rented sector complaints and licensing inspections. Wokingham Borough Council
          and West Berkshire District Council cover the surrounding areas beyond the Reading
          borough boundary.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Environmental health team</strong> — Reading Borough Council's
                environmental health team investigates tenant complaints about electrical safety,
                conducts HMO licensing inspections, and issues civil penalties for non-compliance.
                Reading's large private rented sector generates a significant volume of
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                condition of HMO licences issued by Reading Borough Council. The council can
                refuse to grant or renew a licence where an EICR cannot be provided and can
                revoke a licence for persistent non-compliance with electrical safety conditions.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Building2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Complaint-driven investigations</strong> — many Reading enforcement
                actions begin with tenant complaints. Tenants who discover their property lacks
                a valid EICR can report this to the council, triggering a formal investigation.
                Reading's active student population means awareness of housing rights is high.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Building2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                recover costs from the landlord, alongside imposing civil penalties of up to
                £30,000 per breach.
              </span>
            </li>
          </ul>
        ...
        <p>
          Reading landlords with properties across the borough boundary should note that
          Wokingham and West Berkshire have their own enforcement teams and may operate different
          licensing schemes. Compliance must be verified separately for each local authority area.
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>
          Reading has a substantial HMO market driven by the University of Reading, Reading's
          role as a major Thames Valley employment centre, and its position as an affordable
          alternative to London for commuters and young professionals. Areas around Whiteknights,
          Earley, Tilehurst, and the town centre contain high concentrations of HMO properties.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                more occupants forming two or more households. A valid EICR is required, covering
                all fixed electrical installations, communal areas, fire alarm systems, and
                emergency lighting.
              </span>
            </li>
            <li className="flex items-start gap-3">
            ...
            <li className="flex items-start gap-3">
              <Users className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Shorter EICR intervals for HMOs</strong> — Reading HMO licence
                conditions commonly require EICRs every three to five years. Always check the
                conditions specified on your licence certificate. Properties that have received
                Unsatisfactory EICRs previously may face more frequent inspection requirements.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Users className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Post-war housing stock</strong> — a significant proportion of Reading's
                HMOs are in post-war terraced and semi-detached houses originally built for
                single-family occupation. Conversion to multi-occupancy use, combined with
                original 1950s to 1970s wiring, frequently results in C2 observations for
                absent RCD protection and overloaded circuits. Consumer unit replacement is
                commonly required.
              </span>
            </li>
          </ul>
        ...
        <p>
          ...
          actively investigates unlicensed HMOs, and landlords face prosecution and unlimited
          fines in addition to civil penalties under the electrical safety regulations.
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>
          The 2020 Regulations give Reading Borough Council the power to impose civil penalties
          of up to £30,000 per breach. Non-compliance creates multiple separate offences, each
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                A Reading landlord ignoring all obligations on a single property could face
                combined penalties exceeding this figure.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-red-400 mt-0.5 shrink-0" />
              <span>
                ...
                conditions can lead to licence revocation. For Reading landlords operating
                student or professional HMOs, losing a licence means the property cannot
                legally be occupied as an HMO while a new application is processed.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-red-400 mt-0.5 shrink-0" />
              <span>
                ...
                to the tenant. Reading landlords relying on Section 21 to regain possession at
                the end of professional or student tenancies must have EICR documentation in
                order.
              </span>
            </li>
            <li className="flex items-start gap-3">
        ...
        <p>
          A Reading EICR every five years — typically £150 to £350 — represents a very small
          cost compared to the maximum penalties or the consequences of losing an HMO licence.
          Reading landlords should budget for regular electrical safety inspections as a
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Reading tenants — whether students, young professionals, or long-term residents —
          have specific statutory rights regarding electrical safety in their rented property.
          Awareness of these rights has grown significantly since the 2020 Regulations came
          into force.
        </p>
        <div className="rounded-2xl bg-blue-500/10 border border-blue-500/20 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                inspection. Always request the EICR from your Reading landlord or letting agent
            ...
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Right to report non-compliance</strong> — if your Reading landlord
                cannot provide a valid EICR, report this to Reading Borough Council's
                environmental health team. The University of Reading Students' Union can also
                assist student tenants with housing complaints.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
        ...
        <p>
          Reading tenants can seek further advice from Citizens Advice Reading, Shelter,
          or Reading Borough Council's housing team. The council provides an online form for
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          When a Reading EICR identifies C1 or C2 observations (classified under BS 7671
          Section 631), landlords must complete remedial work within the strict timescales
          set by the 2020 Regulations.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                The 28-day period runs from the date of the inspection, not when the report
                is received.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                finding may require immediate disconnection of the affected circuit. Reading
                landlords must treat C1 observations as urgent and arrange emergency remedial
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                to the tenant and to Reading Borough Council within 28 days of the work
                being completed.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                fitting RCD protection on socket circuits (Regulation 411.3.3 of BS 7671),
                replacing older consumer units, upgrading main bonding, replacing deteriorated
                cables in post-war properties, and rectifying overloaded circuits in converted
                HMOs.
              </span>
            </li>
          </ul>
        ...
        <p>
          Reading landlords should maintain relationships with reliable local electricians who
          can respond promptly to remedial notices. Delays beyond 28 days are a separate breach
          of the regulations and can attract additional penalties.
        </p>
      </>
    ),
  },
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                online registers to find qualified Reading-based inspectors. Scheme registration
                confirms qualifications, insurance, and regular assessment.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Search className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                qualification (C&G 2382 18th Edition). Experience with post-war housing stock
                and HMOs common in the Reading area is valuable.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Search className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Book ahead of summer</strong> — demand peaks in June and July for
                student properties. Booking in April or May ensures availability and allows
                time for remedial work before September tenancy start dates.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Search className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                professional indemnity insurance. This is required by all recognised competent
                person schemes and protects both parties if an error appears on the report.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Reading EICR costs reflect Thames Valley labour rates — higher than the national
          average but below central London levels. Costs vary with property age, size, and
        ...
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>One-bedroom flat</strong> — £110 to £200. Modern flats with
                straightforward installations are typically quicker and less expensive to inspect.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Two to three-bedroom house</strong> — £180 to £320. Post-war terraced
                and semi-detached houses with older wiring may take longer to inspect.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Student HMO (four to six bedrooms)</strong> — £280 to £500. Fire
                alarm systems, emergency lighting, and multiple consumer units increase
            ...
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Large HMO (seven or more bedrooms)</strong> — £450 to £750+.
                Larger properties with complex electrical installations require
                proportionally longer inspections.
              </span>
            </li>
          </ul>
        </div>
        <p>
          ...
          separately. Reading landlords with multiple properties may benefit from negotiating
          block pricing with a trusted local electrician to reduce the cost per inspection.
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>
          Reading's combination of a large student population, a major professional workforce
          drawn by the Thames Valley technology and financial sectors, and significant post-war
          housing stock creates strong and consistent demand for landlord EICRs. The prevalence
          of older wiring in converted HMOs means remedial work opportunities are frequent and
          valuable.
        </p>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  ...
                  . Reading landlords must act within 28 days — the electrician who quotes on
        ...
        <SEOAppBridge
          ...
          description="Join 430+ UK electricians using Elec-Mate for on-site EICR completion, AI board scanning, and instant PDF export. Complete more Reading EICRs per day and win the remedial work. 7-day free trial."
          icon={FileCheck2}
        />
      </>
    ),
