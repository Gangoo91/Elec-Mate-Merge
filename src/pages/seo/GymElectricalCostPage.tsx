...
const sections = [
    ...
    content: (
      <>
        <p>
          ...
          feature lighting, and fire safety provisions. The electrical installation directly
          affects the gym experience — reliable power for equipment, motivating lighting and
          sound, and safe changing facilities are all dependent on the electrical design.
        </p>
        <p>
          Whether you are a gym owner planning a fit-out, a property developer including a gym
          in a mixed-use development, or an electrical contractor pricing a gym installation,
          this guide provides realistic cost breakdowns based on current UK market rates.
        </p>
      </>
    ),
  },
        ...
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Cardio equipment</strong> — Treadmills: 1.5 to 3kW each. Cross trainers:
                0.3 to 1kW each (self-powered models draw less). Rowing machines: 0.1 to 0.3kW
                each. Exercise bikes: 0.1 to 0.5kW each. A cardio floor with 30 machines can
                draw 30 to 50kW at peak.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                power due to the high occupancy and heat generated by exercising. Budget 10 to
                30kW for a medium gym. Typically 3-phase for the compressor units.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Sauna and steam room</strong> — Sauna heater: 6 to 12kW (dedicated
                circuit, often 3-phase for larger saunas). Steam generator: 6 to 18kW
                (dedicated circuit). Both require local isolators and specific containment
            ...
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Water heating</strong> — Commercial water heating for showers can draw 20
                to 50kW for instantaneous systems or 6 to 12kW for stored hot water. Some gyms
                use gas water heating with electrical controls only.
              </span>
            </li>
          </ul>
        </div>
    ...
    content: (
      <>
        <p>
          ...
          containing a bath or shower). This section defines zones around showers and baths
          with specific requirements for IP ratings and equipment types.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Zone 0 (inside shower tray)</strong> — IPX7 minimum. Only SELV circuits
                at maximum 12V AC or 30V DC. No socket outlets, no switches.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Droplets className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Zone 1 (above shower to 2.25m)</strong> — IPX4 minimum (IPX5 if
                communal showers with jet washing). Only fixed equipment permanently connected
                to the electrical supply. Suitable for shower pumps, water heaters, and
                luminaires rated for Zone 1.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Droplets className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Zone 2 (0.6m from shower)</strong> — IPX4 minimum. Luminaires, fans,
                and hand dryers suitable for the zone. Socket outlets for shavers fed from an
                isolating transformer complying with BS EN 61558-2-5 are permitted.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Droplets className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Outside Zone 2</strong> — Standard accessories are permitted but 30mA
                RCD protection per Regulation 411.3.3 is mandatory for all circuits in the
                room. Socket outlets for hair dryers (provided in many gyms) must be outside
                Zone 2.
              </span>
            </li>
          </ul>
    ...
    content: (
      <>
        <p>
          ...
          that could cause serious injury if a member is exercising in sudden darkness. Free
          weights areas, studio spaces with group classes, and wet changing rooms all present
          specific risks.
        </p>
        <div className="grid gap-4 sm:grid-cols-2 my-4">
          <div className="rounded-2xl bg-blue-500/10 border border-blue-500/20 p-5">
            ...
            <p className="text-white text-sm leading-relaxed">
              ...
              (disorientation risk) all require maintained emergency lighting that provides
              adequate illumination to prevent injury and allow safe evacuation.
            </p>
          </div>
          <div className="rounded-2xl bg-green-500/10 border border-green-500/20 p-5">
            <h3 className="font-bold text-white text-lg mb-3">Escape Routes</h3>
            <p className="text-white text-sm leading-relaxed">
              Minimum 1 lux on escape route centre lines to BS 5266-1. Illuminated exit signs
              at all exits and changes of direction. 3-hour duration is standard. Self-contained
              LED fittings are the most common choice. A medium gym typically needs 20 to 35
              emergency fittings. Cost: £2,000 to £5,000 installed.
            </p>
          </div>
        </div>
      </>
    ...
    content: (
      <>
        <p>
          ...
          audio system with zone control allows different music in different areas — high-energy
          on the cardio floor, instructor-led in studios, ambient in changing rooms.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Ceiling speakers</strong> — Commercial ceiling speakers for gym use cost
                £30 to £80 each. A medium gym needs 12 to 20 speakers for adequate coverage.
                Use moisture-rated speakers (IP44) in changing rooms and wet areas.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Music className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Commercial amplifier</strong> — A multi-zone commercial amplifier with 4
                to 6 zones costs £500 to £1,500. Rack-mounted with Bluetooth and aux inputs.
            ...
            <li className="flex items-start gap-3">
              <Music className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Studio PA</strong> — Each studio needs a wireless microphone system (£200
                to £500) for instructors, plus dedicated speakers and a sub-woofer for bass-heavy
            ...
            <li className="flex items-start gap-3">
              <Music className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Wiring</strong> — Speaker cable (2-core, 1.5mm² or 2.5mm² for longer
                runs) from the amplifier location to each speaker position. Allow £3 to £8 per
                metre installed including containment. Total wiring cost for a medium gym: £500
                to £1,500.
              </span>
            </li>
          </ul>
        ...
        <p>
          Total sound system cost for a medium gym: £2,000 to £6,000 installed. This is
          specialist work — if you are not experienced with audio installations, consider
          subcontracting the system design and commissioning to an AV specialist whilst
          handling the infrastructure wiring yourself.
        </p>
      </>
    ),
  },
          ...
          <ul className="space-y-5 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                or small 3-phase supply, 10 to 15 equipment sockets, basic sound system, LED
                panel lighting, small changing room with 2 to 4 showers (Section 701 compliance),
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>BS 5266-1</strong> — Emergency lighting in all escape routes and
                high-risk areas. 3-hour duration standard. Regular testing and maintenance
                records required.
              </span>
            </li>
            <li className="flex items-start gap-3">
        ...
        <p>
          An Electrical Installation Certificate (EIC) must be issued for the complete
          installation. Fire alarm and emergency lighting require separate commissioning
          certificates.
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>
          Gym electrical installations are high-value, multi-discipline projects. Here are
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  ...
                  power. Treadmills, cross trainers, bikes, cable machines, and display screens
                  all need socket outlets in specific positions. Use{' '}
          ...
          <div className="rounded-2xl bg-green-500/10 border border-green-500/20 p-5">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  Changing rooms and shower areas with Section 701 compliance are significantly
                  more expensive per square metre than the gym floor. Price them as a separate
                  section of the quote with the IP-rated accessories and supplementary bonding
                  clearly itemised.
                </p>
              </div>
            </div>
          ...
          <div className="rounded-2xl bg-blue-500/10 border border-blue-500/20 p-5">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  If you are not experienced with commercial audio installations, subcontract
                  the system design and commissioning to an AV specialist. You provide the
                  infrastructure — speaker cable routes, power to the rack, and speaker
                  positions — they provide the equipment specification and commissioning.
                </p>
              </div>
            </div>
          </div>
  ...
  return (
    <GuideTemplate
      ...
      heroTitle={
        <>
          Gym Electrical Cost:{' '}
          <span className="text-yellow-400">UK Commercial Gym Guide 2026</span>
        </>
      }
      ...
      ctaSubheading="Join 430+ UK electricians using Elec-Mate for gym fit-out quoting with equipment schedules, wet area provisions, and professional PDF output. 7-day free trial."
    />
  );
}
