            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  ...
                  phone after installation and testing. ENW G98 notification, Part P building
                  control notification, and professional PDF certificate — all from site.
                </p>
              </div>
            </div>
          </div>
...
export default function EVChargerInstallationManchesterPage() {
  return (
    <GuideTemplate
      title="EV Charger Installation Manchester 2026"
