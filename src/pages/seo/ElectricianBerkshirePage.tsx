...
const sections = [
  {
    ...
    content: (
      <>
        <p>
          Berkshire sits at the heart of the Thames Valley economic corridor — one of the
          most prosperous areas outside central London. The Royal County is home to global
          technology giants, world-leading pharmaceutical companies, and some of England's
          most historic and valuable real estate, from Windsor Castle to the Georgian
          townhouses of Newbury.
        </p>
        <p>
          For electrical contractors, this creates a unique combination of opportunities:
          high-value residential smart home and EV charging work; specialist commercial
          electrical work for technology campuses; heritage-sensitive rewiring and
          installation in listed properties; and a constantly growing renewables market
          driven by affluent homeowners and corporate sustainability targets.
        </p>
        <div className="rounded-2xl bg-blue-500/10 border border-blue-500/20 p-6 my-4">
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Scottish and Southern Electricity Networks (SSEN)</strong> — not UKPN
                — is the DNO for Berkshire. All solar PV notifications (G98/G99) and connection
            ...
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Elec-Mate</strong> supports Berkshire electricians with EICR, EIC,
                and Minor Works Certificate generation on site via mobile app.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Berkshire covers six unitary authority areas. The main population centres
          and electrical work markets include:
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-3 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Reading</strong> — major commercial centre, home to Oracle UK HQ
                and large-scale retail and office developments. Strong commercial and
                domestic residential electrical market.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <MapPin className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Slough</strong> — one of the largest trading estates in Europe.
                High-density commercial and industrial electrical work. Significant
                EICR compliance demand in the rental sector.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <MapPin className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Windsor and Maidenhead</strong> — premium residential market with
                listed buildings, conservation areas, and strong demand for smart home
            ...
            <li className="flex items-start gap-3">
              <MapPin className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Bracknell</strong> — established technology business park town.
                Large Cisco and HP offices drive commercial electrical and data
            ...
            <li className="flex items-start gap-3">
              <MapPin className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Newbury and West Berkshire</strong> — rural market town with
                growing affluent residential market. Vodafone UK HQ in Newbury.
                Rural TT earthing considerations.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <MapPin className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Wokingham</strong> — consistently ranked among England's most
                prosperous boroughs. High-value residential work and strong EV and
                solar PV demand.
              </span>
            </li>
          </ul>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Part P of the Building Regulations applies across all six Berkshire unitary
          authorities. Registered competent person scheme electricians can self-certify
          notifiable work and avoid the need for building control inspections.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          ...
          <ul className="space-y-3 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>NICEIC, NAPIT, ELECSA, or STROMA registration — verify online before booking</span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>Current ECS gold or blue card confirming NVQ Level 3 or 18th Edition update</span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>Public liability insurance — minimum £2 million (£5 million for commercial sites)</span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>For Windsor listed buildings: ask for specific heritage electrical experience and references</span>
            </li>
          </ul>
        </div>
      </>
    ...
    content: (
      <>
        <p>
          ...
          technology sector creates competition for qualified electrical labour, pushing
          rates upward. Budget 15% to 30% above the national average for most work.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          ...
          <ul className="space-y-3 text-white">
            <li className="flex items-start gap-3">
              ...
              <span><strong>EICR (3-bed house):</strong> £190 to £320</span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span><strong>Consumer unit upgrade:</strong> £540 to £820</span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span><strong>Full rewire (4-bed detached):</strong> £5,500 to £9,000</span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span><strong>EV charger installation:</strong> £900 to £1,400</span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span><strong>Smart home electrical fit-out:</strong> £2,000 to £15,000+</span>
            </li>
          </ul>
        </div>
      </>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          The Reading-to-Slough-to-Bracknell technology corridor is sometimes called
          the "UK Silicon Valley" — home to European or UK headquarters of Oracle, Microsoft,
          Cisco, Vodafone, HP, and dozens of other global technology companies. This creates
          a specialist commercial electrical market unavailable in most other UK locations.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                experience in office CAT A and CAT B work — raised floor power, perimeter
                trunking, suspended ceiling lighting — are in consistent demand.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Building2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Slough Trading Estate:</strong> One of Europe's largest trading
                estates with over 400 companies. Industrial electrical work here ranges
                from standard three-phase supplies to specialist manufacturing and
                pharmaceutical electrical installations.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Building2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>EV fleet charging (commercial):</strong> Technology companies with
                large vehicle fleets are installing high-power depot charging infrastructure.
                OZEV LEVI approval and three-phase load management expertise required.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Windsor is home to Windsor Castle — the oldest and largest occupied castle in the
          world — and an extensive surrounding town centre with some of the most sensitive
          heritage buildings in England. The Royal Borough of Windsor and Maidenhead has
          more than 2,000 listed buildings within its boundaries.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Listed Building Consent:</strong> Required from the Royal Borough for
                any electrical work affecting the character of a listed building — including
                new cable routes in original plasterwork, new accessory positions in
                prominent locations, and external installations visible from the street.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Wrench className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Surface-mounted wiring:</strong> In Grade I and Grade II* listed
                buildings, chasing into original plasterwork or masonry is rarely acceptable
                to the Royal Borough's conservation officer. Surface-mounted mineral insulated
                (MI) cable, steel conduit, or period-appropriate trunking in matching finishes
                are the approved approaches.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Crown Estate and Royal Household properties:</strong> Some properties
                within the Windsor Castle precincts and Crown Estate are not subject to the
                normal listed building regime — they fall under Crown Immunity or specific
                Crown Estate management policies. Always confirm the consent regime before
                starting work on any property within the castle boundaries.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Scottish and Southern Electricity Networks (SSEN) is the distribution network
          operator for Berkshire and the wider South of England. Electricians who have
          previously worked in the South East — where UKPN operates — should note this
          important distinction when working in Berkshire.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>New connections and upgrades:</strong> Apply via ssen.co.uk. SSEN
                processes new domestic connections within the statutory timescales under
            ...
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>G98/G99 notifications:</strong> Submit via SSEN's online portal.
                G98 (up to 3.68kW single-phase) notified after installation within 28 days.
                G99 requires prior approval — allow 45 working days minimum.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Power cuts:</strong> Report power cuts to SSEN by calling 105 —
                the national power cut number. Do not call UKPN for Berkshire power cuts.
              </span>
            </li>
          </ul>
        </div>
        <p>
          ...
          SSEN as the DNO on all EIC and EICR certificates issued in Berkshire.
        </p>
      </>
    ),
  },
