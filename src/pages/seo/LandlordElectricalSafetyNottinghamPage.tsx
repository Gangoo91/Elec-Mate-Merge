...
const breadcrumbs = [
  ...
  { label: 'Landlord Electrical Safety Nottingham', href: '/guides/landlord-electrical-safety-nottingham' },
];
...
const sections = [
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Nottingham City Council is widely regarded as one of the most active local authorities
          in England for private rented sector enforcement. The city operates the UK's first
          city-wide selective licensing scheme and has invested significantly in enforcement
          capacity.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              <Building2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Civil penalty enforcement</strong> — Nottingham City Council has been
                among the more active councils in England in using civil penalty powers under the
                2020 Regulations. Penalties of up to £30,000 per breach have been issued to
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                tenant complaints, Nottingham City Council proactively monitors compliance
                through its licensing programme. Landlords should not assume that non-compliance
                will go undetected.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                of the current EICR. In Nottingham's competitive student rental market, this
                is a significant practical consequence for landlords seeking possession.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Nottingham has one of the highest concentrations of HMOs per capita in England, driven
          by the large student populations at the University of Nottingham and Nottingham Trent
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                communal areas, fire alarm systems, and emergency lighting.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Users className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Additional licensing</strong> — Nottingham City Council operates
                additional HMO licensing covering smaller HMOs, particularly in the student
                areas around Lenton, Dunkirk, Forest Fields, and Radford. Check the council's
                website for the current licensing area. EICR compliance is equally required
                under additional licensing.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Users className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Inspection frequency</strong> — Nottingham HMO licence conditions
                typically require EICRs at intervals specified in the licence. Check your
                specific licence conditions rather than assuming the standard five-year
                interval applies.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Users className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Enforcement</strong> — operating an unlicensed HMO in Nottingham is
                a criminal offence. Nottingham City Council has prosecuted unlicensed HMO
                landlords and imposed substantial fines. The council's active enforcement
                reputation means that non-compliance is significantly more likely to be
                detected in Nottingham than in many other cities.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Nottingham City Council can impose civil penalties of up to £30,000 per breach under
          the 2020 Regulations. In Nottingham, the risk of non-compliance being detected is higher
          than in most English cities due to the selective licensing scheme.
        </p>
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                complete remedial work are each separate breaches. Multiple penalties can be
                imposed on the same landlord.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-red-400 mt-0.5 shrink-0" />
              <span>
                <strong>Selective licence revocation</strong> — persistent non-compliance with
                EICR requirements can result in licence revocation under the selective licensing
                scheme. Without a licence, it is unlawful to rent the property.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-red-400 mt-0.5 shrink-0" />
              <span>
                <strong>Section 21 restrictions</strong> — landlords cannot serve a valid
                Section 21 notice without providing the EICR. In Nottingham's active student
                market, this is a meaningful restriction on landlords' ability to manage tenancies.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-red-400 mt-0.5 shrink-0" />
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Nottingham tenants have specific rights under the 2020 Regulations and benefit from one
          of the UK's most active local enforcement regimes.
        </p>
        <div className="rounded-2xl bg-blue-500/10 border border-blue-500/20 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
          ...
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                observations require immediate action. Do not wait the full 28 days. The
                inspector may recommend immediate disconnection of the affected circuit.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Clock className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Nottingham has a good supply of qualified electricians experienced in landlord EICR
          work. Given the city's active enforcement environment, it is important to choose
          a fully qualified and registered inspector.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                online register for Nottingham-based inspectors. Scheme membership provides
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                property requires 2 to 4 hours and calibrated test equipment. A report produced
                in under an hour is unlikely to meet the required standard and could expose a
                landlord to enforcement risk if challenged by the council.
              </span>
            </li>
          </ul>
        </div>
        ...
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Two-bedroom flat or terraced house</strong> — £155 to £280. Usually 5
                to 8 circuits.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Three-bedroom house</strong> — £220 to £380. Victorian terraces in
                Lenton and Dunkirk may take longer due to aged wiring.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>HMO</strong> — £320 to £620+. Multiple consumer units, fire alarm
                systems, and emergency lighting increase the inspection scope significantly.
              </span>
            </li>
          </ul>
        </div>
        <p>
          These prices cover inspection and report only. Given Nottingham's enforcement
          environment, landlords should factor in the potential cost of remedial work identified
          during the EICR when budgeting. Some Nottingham electricians offer combined EICR and
          remedial packages for landlords managing multiple properties.
        </p>
      </>
    ),
  },
    ...
    content: (
      <>
        <p>
          ...
          enforcement regime create some of the strongest demand for landlord EICRs of any
          city in England. Electricians who position themselves as the go-to inspection resource
          for Nottingham landlords and letting agents can build a very strong pipeline of
          recurring work.
        </p>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  ...
                  voice test entry, and instant PDF export mean no evening paperwork. In
                  Nottingham, landlords are highly motivated to have reports quickly due to
                  licensing deadlines.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  ...
                  . Nottingham landlords must act within 28 days — the electrician who quotes on
                  the day of the EICR wins the remedial work.
                </p>
              </div>
            </div>
          </div>
