...
const relatedPages: RelatedPage[] = [
  ...
  },
  {
    ...
    description:
      'Generate compliant Electrical Installation Certificates — practice on Elec-Mate as an apprentice.',
    icon: FileCheck2,
...
const sections = [
          ...
          <ul className="space-y-3 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                months. Leads to a City and Guilds 2365 Level 2 diploma or equivalent EAL
                qualification.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                through to Level 3 as a combined three to four year programme.
              </span>
            </li>
          </ul>
        </div>
          ...
          <ul className="space-y-3 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                fault diagnosis, and BS 7671 Wiring Regulations. Duration: three to four years
                including the Level 2 stage.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                the holder to an ECS Approved Electrician card and JIB grade.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
          ...
          <ul className="space-y-3 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                safety training, and experience appropriate to their grade.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                Electrician card (after two years post-qualification experience); Electrician card
                (JIB Gold Card, with NVQ Level 3 and AM2).
              </span>
            </li>
          </ul>
        </div>
          ...
          <ul className="space-y-3 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                ECS card is the preferred card as it is accepted on all electrical and construction
                sites. The ECS and CSCS schemes are linked — ECS card holders do not need a separate
                CSCS card on most sites.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                electrical health and safety. The test must be passed within two years of the card
                application.
              </span>
            </li>
          </ul>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          The most important step in applying for an electrical apprenticeship is identifying a host
          employer willing to take you on. Without an employer, most training providers cannot enrol
          ...
          <ul className="space-y-3 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                Search for "electrical installation" to find current vacancies in your area.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                help match candidates to suitable employers in their area.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                NICEIC, NAPIT, or ECA (Electrical Contractors Association) registered companies —
                these are more likely to have training programmes.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                select.org.uk for vacancy listings and career guidance.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          A well-prepared application significantly improves the chance of securing an interview.
          Employers receive many applications for electrical apprenticeships — a generic application
          will not stand out.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-3 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                experience such as helping a family member with DIY electrical work, a school
                project, or a short work experience placement.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                grade and any additional maths study. If your maths grade is low, take a Level 2
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                willingness to work long hours, follow instructions, and prioritise safety at all
                times.
              </span>
            </li>
          </ul>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Electrical apprenticeship interviews assess attitude, aptitude, and commitment as much as
          existing knowledge. Employers do not expect school leavers to have trade knowledge — they
          ...
          <ul className="space-y-3 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                "Describe a time you solved a practical problem", "Are you comfortable working at
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                basic maths — fractions, percentages, and simple formula rearrangement — before the
                interview.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                will judge whether you can represent the company professionally on client premises.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Understanding what employers value helps candidates present themselves more effectively
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                apprenticeship quickly. Employers rate reliability above almost any other attribute.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                unsure. A cavalier attitude to safety is grounds for immediate dismissal.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                study in their own time — progress faster and are more valued by employers.
              </span>
            </li>
          </ul>
        </div>
        <p>
          ...
          <SEOInternalLink href="/tools/eicr-certificate" label="Elec-Mate EICR app" /> demonstrates
          to employers that you take your career seriously and stay current with industry best
          practice.
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>
          Elec-Mate includes a Study Centre with structured learning content for Level 2 and Level 3
          electrical apprentices, alongside the professional certificate tools used by qualified
          electricians.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                trade calculations. Ideal for exam preparation and on-the-job revision.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                format early in your apprenticeship gives you a significant advantage when it comes
                to assessment.
              </span>
            </li>
          </ul>
...
export default function ElectricalApprenticeshipApplyPage() {
  return (
    <GuideTemplate
      title="How to Apply for an Electrical Apprenticeship UK"
