...
const faqs = [
  {
    question: 'What IP rating is required for electrical equipment in food processing wash-down areas?',
    answer:
  ...
  {
    question: 'What BRC Global Standard requirements apply to electrical installations in food factories?',
    answer:
...
const relatedPages: RelatedPage[] = [
  {
    ...
    description: 'ATEX zone classification, DSEAR compliance, CompEx qualification, and Ex equipment maintenance.',
    icon: AlertTriangle,
    category: 'Guide',
  },
  {
    ...
    description: 'GMP cleanroom wiring, ISO classifications, IQ/OQ/PQ validation, and FDA 21 CFR Part 11.',
    icon: ShieldCheck,
    category: 'Guide',
  },
  {
    ...
    description: 'ISO 14644 classifications, flush-mounted fittings, sealed cable entries, and UPS for critical environments.',
    icon: Building2,
    category: 'Guide',
  },
  {
...
const sections = [
    ...
    content: (
      <>
        <p>
          ...
          in Europe, employing over 400,000 people and producing £104bn of output annually — requires
          electrical contractors who understand both the technical and regulatory dimensions of
          food factory electrical work.
        </p>
        <p>
          The consequences of inadequate electrical installation in a food factory extend well beyond
          the electrical system itself. Contamination of food products, pest ingress through poorly
          sealed enclosures, explosion from combustible dust, and failure to comply with BRC or
          retailer audit requirements can all result from substandard electrical installation. The
          reputational and financial consequences for food manufacturers are severe.
        </p>
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                must comply with BS 7671 (Wiring Regulations), DSEAR 2002 (where combustible
                dusts are present), the Food Safety Act 1990 and associated regulations,
                and industry standards including BRC Global Standard for Food Safety.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ClipboardCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                suppliers to achieve certification to the BRC Global Standard or equivalent
                (IFS Food, SQF). The electrical installation is assessed as part of the audit.
                Failures at audit due to electrical non-conformances can result in loss of
                supply contracts.
              </span>
            </li>
          </ul>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Wash-down is fundamental to food factory hygiene. Production areas are cleaned at the
          end of every shift — sometimes multiple times per day — using high-pressure hot water
          lances and caustic cleaning agents. All electrical equipment in these areas must be
          able to withstand this process without ingress of water, loss of function, or release
          of contaminants.
        </p>
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                protection against high-pressure, high-temperature water jets: test conditions
                are 80°C water at 80 bar pressure, flow rate of 14–16 litres per minute,
                nozzle at 100–150mm distance, applied from all angles over a 30-second duration.
                This closely mirrors the conditions used in food factory cleaning.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Building2 className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Chemical resistance</strong> — IP rating alone does not address
                chemical resistance. Gaskets, seals, and enclosure materials must be
                compatible with the cleaning chemicals used on site — typically alkaline
                detergents (NaOH-based), acid rinses (phosphoric acid), and disinfectants
                (quaternary ammonium compounds, peracetic acid). Manufacturer compatibility
                data must be verified for each chemical used.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Building2 className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Drainage</strong> — even IP69K-rated enclosures can accumulate
                condensate internally. Internal drainage plugs or breathers allow
                condensate to drain without compromising the IP rating. In environments
                with significant temperature cycling, thermal management of enclosures
                prevents condensation damage to electrical components.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Building2 className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                ...
                IP69K-rated enclosures must use IP69K-rated glands or conduit fittings.
                A weak seal at a cable entry undermines the enclosure's IP rating entirely.
                Glands must also be chemically compatible with cleaning agents.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Organic dusts — flour, grain, sugar, dried milk, cocoa, spice — are combustible and
          can form explosive clouds in concentrations above their Minimum Explosible Concentration
        ...
        <div className="rounded-2xl bg-red-500/10 border border-red-500/20 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Zone 20</strong> — a combustible dust cloud is present continuously
                or for long periods inside equipment. Typically applies to the interior of
                hoppers, silos, mills, conveyors, cyclones, and bag filters. Zone 20
                equipment must be Category 1D (Da).
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-red-400 mt-0.5 shrink-0" />
              <span>
                <strong>Zone 21</strong> — a combustible dust cloud is likely to occur in
                normal operation. Typically applies to the immediate surroundings of Zone 20
                equipment, filling points, transfer points, loading spouts, and sifters.
                Category 2D (Db) equipment required.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-red-400 mt-0.5 shrink-0" />
              <span>
                <strong>Zone 22</strong> — a combustible dust cloud is unlikely to occur in
                normal operation but may occur in abnormal conditions. Typically applies to
                the wider area around Zone 21 locations where dust layers may accumulate.
                Category 3D (Dc) equipment required.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-red-400 mt-0.5 shrink-0" />
              <span>
                <strong>CompEx for dust zones</strong> — electricians carrying out installation
                or maintenance work in ATEX dust zones must hold{' '}
                <SEOInternalLink href="/petrochemical-electrical">
                  CompEx certification
                </SEOInternalLink>{' '}
                covering dust zone work (ExD units). Installation requirements differ from gas
                zones — dust can penetrate through smaller gaps and surface temperature limits
    ...
    content: (
      <>
        <p>
          ...
          approach to designing equipment and structures so that they can be effectively cleaned
          and do not harbour food residues, bacteria, or pests. The European Hygienic Engineering
          and Design Group (EHEDG) and the BRC Global Standard both provide detailed guidance on
        ...
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Sloped tops</strong> — horizontal surfaces on electrical enclosures
                are collection points for dust, food residues, and pests. All enclosures in
                food production areas must have sloped tops — a minimum of 3 degrees from
                horizontal, and 45 degrees or more in high-care areas. Sloped tops allow
                wash-down water to drain rather than pool.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Users className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>No horizontal ledges or recesses</strong> — shelves, ledges, and
                recesses inside and outside enclosures are contamination risks. All surfaces
                should be smooth and continuous. Any unavoidable external ledges must be
                sloped. Internal surfaces must be smooth and free of shafts, threads, or
                other features that cannot be cleaned.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Users className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Continuous welds</strong> — intermittent or spot welds create
                crevices where bacteria and food residues accumulate and are protected from
                cleaning. All welds on food contact or food proximity surfaces must be
                continuous, ground smooth, and free of porosity.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Users className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Accessible for cleaning</strong> — all parts of the electrical
                installation that require cleaning must be accessible without the need to
                dismantle equipment. Control panels must be positioned or mounted to allow
                cleaning of all surfaces including behind and beneath. Leg heights and
                clearances are defined in EHEDG guidance.
              </span>
            </li>
          </ul>
        </div>
        ...
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              <Building2 className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Grade selection</strong> — 304 stainless steel (18/8, EN 1.4301) is
                suitable for most food processing environments. 316 stainless steel (18/10/2,
                EN 1.4401) is required in high-chloride environments such as fish processing,
                brine handling, and areas where hypochlorite disinfectants are used regularly.
                316L (low-carbon) is preferred for welded fabrications to avoid sensitisation.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Building2 className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Surface finish</strong> — external surfaces of enclosures should
                have a smooth, polished finish (typically 2B or BA finish) that minimises
                surface roughness and is easy to clean. Rougher finishes (No. 4 brushed)
                are used in some applications but are harder to clean than polished finishes.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Building2 className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Fixings and hardware</strong> — all fixings (bolts, nuts, hinges,
                locks) should be stainless steel of the same grade as the enclosure, or at
                least of compatible grade. Dissimilar metal contact between stainless steel
                and carbon steel fixings causes galvanic corrosion. Nylon and non-metallic
                fixings are acceptable in many low-stress applications.
              </span>
            </li>
          </ul>
        </div>
    ...
    content: (
      <>
        <p>
          ...
          design. Conventional cable tray, trunking, and ladder rack have many surfaces, edges,
          and fixings that are difficult to clean and may accumulate food residues or harbour
          pests. Hygienic cable management requires careful selection and detailing.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              <ClipboardCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Stainless steel wire mesh tray</strong> — smooth-surfaced stainless
                steel wire mesh cable tray is widely used in food factories. It is easy to
                clean, allows drainage, and does not create horizontal ledges if mounted
                correctly. Joints and fixings must be stainless steel and flush to avoid
            ...
            <li className="flex items-start gap-3">
              <ClipboardCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Minimise horizontal runs above open product</strong> — cable
                management above open food should be minimised. Where overhead runs are
                unavoidable, use round conduit or smooth-surfaced trunking that cannot
                collect debris, and ensure that any failure (cable, conduit clip, or
                fixing) would not cause a product contamination incident.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ClipboardCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Sealed conduit systems</strong> — in high-care and high-hygiene
                areas, conduit systems may be preferred to open cable management because
                they enclose the cables and prevent ingress of food residues. All
                terminations must be sealed. Conduit must be self-draining or drainable.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ClipboardCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                chemical-resistant outer sheaths compatible with the cleaning agents
                used on site. PVC sheathed cables are acceptable in many areas but
                may be attacked by certain disinfectants. LSF (Low Smoke Free)
                halogen-free cables with appropriate sheath materials are specified
                in many food factory projects.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          BRC Global Standard for Food Safety (Issue 9, published 2022) is the most widely used
          food safety certification standard in the UK. Certification is required by most major UK
        ...
        <div className="rounded-2xl bg-blue-500/10 border border-blue-500/20 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Equipment condition and maintenance</strong> — BRC requires that
                all equipment, including electrical equipment, be maintained in good
                condition and subject to a planned preventive maintenance programme.
                Evidence of maintenance records, calibration certificates, and corrective
                actions for defects must be available at audit.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Anti-shatter lighting</strong> — lighting in food production areas
                must be protected against shattering to prevent glass contamination of
                food. Shatter-resistant sleeves, anti-shatter LED fittings, or enclosed
                luminaires are all acceptable. BRC auditors will check that lighting
                protection is in place and that there is a procedure for dealing with
                any broken lamp.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Pest control integration</strong> — the electrical installation must
                not provide harborage for pests. Sealed enclosures, sealed cable entries,
                and hygienic mounting that eliminates voids and ledges all contribute to
                pest control. Open conduit ends, poorly sealed panels, and cable routes
                with voids behind walls are common BRC findings.
              </span>
            </li>
          </ul>
        </div>
        ...
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Physical separation of cable routes</strong> — cable management
                systems must not create pathways for allergen-containing dust or debris to
                travel from allergen zones to allergen-free zones. Trunking and conduit
                passing through partition walls between zones must be sealed to maintain
                physical separation.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                production lines are in adjacent areas, separate control panels for each
                area support clear operational segregation and simplify allergen cleaning
                validation (the scope of cleaning for each panel is clear and separate).
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                systems must not draw allergen-containing air from allergen zones and
                discharge it into allergen-free areas. Where ventilation or cooling is
                required, filtered air intake and directional discharge must be designed
                to respect the allergen zone boundaries.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                installation can support it through consistent use of zone-specific colours
                for socket outlets, isolators, and other field equipment.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Food processing electrical work combines the challenges of industrial electrical work
          with strict hygiene requirements, food safety regulations, and in some facilities,
          ATEX hazardous area requirements. It is well-rewarded, in constant demand, and offers
        ...
        <div className="space-y-4 my-4">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  ...
                  typically means hair covering, protective clothing, no jewellery or loose
                  items, no food or drink in production areas, and strict foreign object controls
                  — every screw, cable tie, and tool must be accounted for. Failure to comply
                  with site hygiene rules will result in immediate removal from site.
                </p>
              </div>
            </div>
          </div>
          <div className="rounded-2xl bg-blue-500/10 border border-blue-500/20 p-5">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h4 className="font-bold text-white mb-1">Keep Records That Satisfy BRC Auditors</h4>
                <p className="text-white text-sm leading-relaxed">
                  ...
                  to produce professional, well-organised test records and inspection reports
                  that demonstrate compliance and give food factory quality managers the
                  documentation they need for audit.
                </p>
              </div>
            </div>
          </div>
        ...
        <SEOAppBridge
          ...
          description="Create test records and inspection reports that satisfy BRC Global Standard audit requirements. Join 430+ UK electricians using Elec-Mate. 7-day free trial."
          icon={ShieldCheck}
        />
      </>
    ),
...
export default function FoodProcessingElectricalPage() {
  return (
    <GuideTemplate
      ...
      ctaSubheading="Create professional test records and inspection reports for food factory BRC audits. Join 430+ UK electricians using Elec-Mate. 7-day free trial, cancel anytime."
    />
  );
}
