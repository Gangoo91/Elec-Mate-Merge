...
export default function AdiabaticEquationCalculatorPage() {
  ...
  return (
    <PublicPageLayout>
      ...
      <section className="py-16 sm:py-24 px-5">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-white max-w-2xl mx-auto leading-relaxed mb-8">
            ...
            Built-in k values for all conductor types, disconnection time references, and 70
            electrical calculators — all on your phone.
          </p>
      ...
      <section className="py-12 px-5 border-t border-white/5">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4 text-white leading-relaxed">
            <p>
              The adiabatic equation is the fundamental formula used to determine whether a
              protective conductor is large enough to withstand the heating effect of a fault
              current. When an earth fault occurs in an electrical circuit, the fault current flows
              through the circuit protective conductor (CPC) until the protective device (MCB, fuse,
              or RCBO) disconnects the supply. During this time, the fault current heats the
              conductor. The adiabatic equation calculates the minimum conductor size that can
              absorb this heat energy without the insulation reaching a damaging temperature.
            </p>
            <p>
              The term "adiabatic" means "without heat transfer to the surroundings." The equation
              assumes that all the heat generated by the fault current is absorbed by the conductor
              itself, with no heat being dissipated to the surrounding insulation, cable sheath, or
              environment during the fault. This is a valid assumption because fault durations are
              very short (typically fractions of a second), and in such a short time, virtually no
              heat escapes the conductor. The calculation therefore gives a conservative
              (worst-case) result.
            </p>
            <p>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="rounded-2xl bg-white/[0.04] border border-yellow-500/20 p-6 my-6 text-center">
            ...
            <div className="space-y-2 text-white text-sm text-left max-w-lg mx-auto">
              <p>
                <strong>S</strong> = Minimum cross-sectional area of the protective conductor (mm²)
              </p>
              <p>
                <strong>I</strong> = Fault current in amperes (A) — the earth fault current flowing
                through the CPC
              </p>
              <p>
                <strong>t</strong> = Disconnection time in seconds (s) — the time taken by the
                protective device to clear the fault
              </p>
              <p>
                <strong>k</strong> = A factor dependent on the conductor material, insulation type,
                and initial/final temperatures
              </p>
            </div>
          </div>
          <div className="space-y-4 text-white leading-relaxed">
            <p>
              ...
              seconds). A high fault current for a short time, or a lower fault current for a longer
              time, can both produce the same I²t value. The protective conductor must be sized to
              withstand whatever I²t value the protective device allows through before it
              disconnects.
            </p>
            <p>
              The k value encapsulates the thermal properties of the conductor — essentially how
              much energy per unit volume the conductor material can absorb before reaching the
              maximum permitted temperature. A higher k value means the conductor can absorb more
      ...
      <section className="py-12 px-5 border-t border-white/5">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4 text-white leading-relaxed mb-6">
            <p>
              The k value is the most important factor in the adiabatic equation because it reflects
              the conductor material's ability to absorb fault energy. BS 7671 provides k values in
              Tables 54.2 to 54.6 for different combinations of conductor material and insulation
              type. Here are the most commonly used values.
            </p>
          </div>
          ...
          <div className="space-y-4 text-white leading-relaxed">
            <p>
              The k value for steel (51 for PVC) is significantly lower than for copper (115 for
              PVC), meaning a steel CPC (such as the steel wire armour of an SWA cable used as the
              protective conductor) needs to have a much larger cross-sectional area than an
              equivalent copper CPC to carry the same fault energy. This is an important
              consideration when relying on cable armour as the sole CPC — the adiabatic check must
              always be performed to verify the armour is adequate.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 px-5 border-t border-white/5">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl sm:text-3xl font-bold text-white mb-6">Worked Examples</h2>
          ...
          <div className="mt-6 space-y-4 text-white leading-relaxed">
            <p>
              These examples illustrate why the adiabatic check is important. In Example 1, the CPC
              is well within limits — the installed 1.5 mm² CPC is more than double the minimum
              required. In Example 2, the check is critical — if the SWA cable chosen has armour
      ...
      <section className="py-12 px-5 border-t border-white/5">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4 text-white leading-relaxed mb-8">
            <p>
              The adiabatic equation involves looking up k values, finding disconnection times from
              device characteristics, and running the calculation — all of which are straightforward
              individually but time-consuming when done repeatedly for every circuit in a large
              installation. Elec-Mate automates the entire process.
            </p>
            <p>
              Select the conductor material and insulation from a dropdown, and the k value is
              applied automatically. Enter the fault current and disconnection time, and the minimum
              CPC size appears instantly. The calculator shows the nearest standard cable size above
              the calculated minimum and compares the result to the simplified Table 54.7 method, so
              you can see at a glance which requirement governs.
            </p>
            <p>
      ...
      <section id="how-it-works" className="py-12 px-5 border-t border-white/5">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-white mb-8 leading-relaxed">
            Follow these steps to verify that a protective conductor is adequately sized using the
            adiabatic equation in the Elec-Mate app.
          </p>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4 text-white leading-relaxed">
            ...
            <p>
              ...
              verifier must either confirm that the CPC size meets Table 54.7 (the simpler check) or
              perform the adiabatic calculation to verify that the installed CPC is at least as
              large as the minimum calculated. The adiabatic method is particularly important for
              non-standard situations — for example, when the CPC is not the same material as the
              line conductor, when steel wire armour is used as the CPC, or when the designer wants
