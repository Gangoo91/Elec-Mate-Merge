...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'You must register for VAT if your taxable turnover exceeds the VAT threshold (£90,000 in 2026/27) in any rolling 12-month period. You can voluntarily register below the threshold if you want to reclaim VAT on purchases (useful if you buy a lot of materials). The Flat Rate Scheme (FRS) allows small businesses to pay a fixed percentage of gross (VAT-inclusive) turnover instead of calculating input and output VAT on every transaction. There is no single electrician sector — HMRC classifies you by how much material you supply: 9.5% for general building or construction services, or 14.5% labour-only where materials are under 10% of turnover. On the standard scheme, you charge 20% VAT on your invoices and reclaim VAT on your business purchases. The standard scheme is usually better for electricians because material costs are high, generating significant input VAT to reclaim. Discuss with your accountant before registering voluntarily.',
  },
  {
...
export default function PartnershipVsSoleTraderPage() {
  return (
    <GuideTemplate
      title="Partnership vs Sole Trader vs Ltd: Electricians"
