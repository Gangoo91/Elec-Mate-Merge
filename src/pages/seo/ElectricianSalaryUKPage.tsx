...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'The most effective ways for an electrician to increase their earnings are specialisation, business skills, and certification. Specialisation means adding qualifications that allow you to work in higher-paying niches: EV charger installation (currently in high demand with strong margins), solar PV and battery storage, fire alarm systems (BS 5839), emergency lighting (BS 5266), inspection and testing (C&G 2391), and data and fibre optic cabling. Each of these specialisms commands a premium because the pool of qualified installers is smaller than the demand. Business skills matter because many electricians undercharge — learning to quote accurately (covering materials, labour, overheads, and profit margin), invoice promptly, and manage cash flow can add thousands to annual income without doing more hours. Finally, holding current certifications including the 18th Edition (BS 7671:2018+A4:2026), C&G 2391, and membership of a competent person scheme (NICEIC, NAPIT, ELECSA) signals competence to clients and allows you to self-certify notifiable work, which means you can take on more jobs without needing building control involvement.',
  },
  {
