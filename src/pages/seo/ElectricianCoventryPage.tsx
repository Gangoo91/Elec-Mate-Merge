...
const sections = [
    ...
    content: (
      <>
        <p>
          ...
          now reaching the age where the original electrical installations need complete
          replacement.
        </p>
        <p>
        ...
        <p>
          This guide covers the DNO arrangements, post-war housing rewiring, ring main versus radial
          considerations, university area work, the EV gigafactory impact, and realistic pricing for
    ...
    content: (
      <>
        ...
        <div className="rounded-2xl bg-blue-500/10 border border-blue-500/20 p-5 my-4">
          ...
          <div className="space-y-3 text-white text-sm leading-relaxed">
            ...
            <p>
              ...
              adding EV chargers, heat pumps, or battery storage may need a service upgrade from the
              older 60A fuse to a modern 80A or 100A cut-out.
            </p>
            <p>
              ...
              systems) notification to NGED before energisation.
            </p>
            <p>
        ...
        <p>
          ...
          may benefit electricians by reducing the wait times for service upgrades as network
          capacity improves.
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>
          Coventry's defining characteristic for electricians is its post-war housing stock. The
          city was rebuilt at speed in the 1950s and 1960s, producing large estates of semi-detached
          ...
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                ceiling tiles in kitchens and bathrooms, asbestos insulation boards in some
                partition walls, and asbestos cement flue pipes. Before starting any rewiring work,
                carry out an asbestos assessment. If you suspect asbestos, stop work and arrange
                professional testing. Never drill, cut, or disturb suspected asbestos materials. A
                referable asbestos survey is a legal requirement before demolition or refurbishment
                work.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                compared to period or listed buildings. A competent electrician can rewire a
                standard 3-bedroom Coventry semi in 4 to 5 days.
              </span>
            </li>
          </ul>
        </div>
        <p>
          ...
          need rewiring within the same timeframe. This provides a concentrated, predictable
          pipeline of work for local electricians.
        </p>
      </>
    ),
  },
        ...
        <div className="grid gap-4 sm:grid-cols-2 my-4">
          ...
          <div className="rounded-2xl bg-green-500/10 border border-green-500/20 p-5">
            ...
            <p className="text-white text-sm leading-relaxed">
              ...
              serves up to 75 square metres. Advantages: simpler topology — easier to fault-find and
              understand; no ring continuity testing required; no risk of hidden ring breaks.
    ...
    content: (
      <>
        ...
        <p>
          ...
          student properties provides stable, recurring revenue. A landlord with 10 HMOs needs EICRs
          every 5 years, annual fire alarm servicing, and reactive maintenance — that represents a
          steady annual contract worth £3,000 to £6,000.
        </p>
      </>
    ),
  },
          ...
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                installing multiple EV charge points, requiring three-phase supplies, load
                management systems, and cable infrastructure. The Coventry Very Light Rail project
                and other transport electrification schemes add further demand.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                power distribution, battery storage systems, and smart energy management.
                Electricians who invest in these qualifications now will be well-positioned as the
                Coventry EV ecosystem grows over the next decade.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Coventry pricing is at or slightly below the national average for domestic work,
          reflecting the West Midlands cost of living. However, EV charger installations and
          commercial work command competitive rates, and the volume of available work compensates
          for lower per-job pricing compared to southern cities.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Coventry is a volume market with growing specialist opportunities. The combination of mass
          post-war rewiring demand, a healthy HMO sector, and the accelerating EV transition means
          there is more work than the current number of local electricians can handle. Efficiency
          and professional systems are the key to maximising revenue.
        </p>
