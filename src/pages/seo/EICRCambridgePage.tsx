...
const relatedPages: RelatedPage[] = [
  {
    ...
    description: 'Local EICR price bands by property size, hourly rates, and remedial costs for Cambridge.',
    icon: Home,
    category: 'Guide',
  },
  {
          ...
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                years, or sooner if recommended by the inspector. BS 7671 Regulation 135.1 requires
...
export default function EICRCambridgePage() {
  return (
    <GuideTemplate
      title="EICR Cambridge: Cost & Safety Certificate 2026"
