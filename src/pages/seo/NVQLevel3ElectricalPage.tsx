...
const sections = [
        ...
        <div className="rounded-2xl bg-blue-500/10 border border-blue-500/20 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>No written examinations</strong> — the NVQ is assessed entirely through a
                portfolio of evidence and direct observation by a qualified assessor. Candidates are
                not required to sit any written exams. This makes it accessible to experienced
                electricians who have strong practical ability but may struggle with formal academic
                assessments.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Workplace-based assessment</strong> — your assessor makes regular visits to
                your workplace or job sites to observe you working and to verify your portfolio
                evidence. The qualification is awarded when you have demonstrated competence across
                all mandatory and selected optional units.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                ...
                terminating and connecting conductors, inspection and testing, and fault diagnosis.
                The specific units depend on the pathway (installation, maintenance, or
                commissioning).
              </span>
            </li>
            <li className="flex items-start gap-3">
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                learning. Typically completed as part of a formal apprenticeship. Covers electrical
                principles, science, technology, and installation in a structured curriculum.
                Suitable for those starting in the trade with no prior experience.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                for experienced electricians already working in the trade who want to formalise
                their competence. Does not replace the 2365 — they test different things.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                the City and Guilds 2365 (knowledge) and NVQ Level 3 (competency) components, plus
                the AM2 assessment. This is the most comprehensive route and the benchmark the
                industry measures against.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                to an Experienced Worker card, which is not accepted by many principal contractors.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          The NVQ Level 3 is primarily designed for experienced electricians who are working in the
          trade but do not hold a formal qualification. Several specific situations make the NVQ the
          right choice.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                years, or entering from abroad) and who have significant practical experience but no
                UK qualification.
              </span>
            </li>
            <li className="flex items-start gap-3">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                longer accepted as current by some competent person schemes or principal employers
                may use the NVQ to evidence current competence.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ClipboardCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          The NVQ Level 3 in Electrotechnical Technology is offered by two primary awarding bodies
          in the UK: EAL (the engineering sector awarding organisation) and City and Guilds. Both
          are regulated by Ofqual and produce qualifications recognised for ECS card purposes.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                Association (ECA). EAL NVQs are delivered through approved EAL training centres and
                are widely accepted by NICEIC, NAPIT, ELECSA, and the JIB. EAL has a significant
                presence in the electrotechnical sector.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Award className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                Technology is widely delivered through FE colleges and private training centres.
                City and Guilds NVQs are accepted for ECS card purposes and by all major competent
                person schemes.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                assessment visits, and the total cost. Both awarding bodies produce equivalent
                outcomes for career purposes. The quality of the training centre and assessor
                matters more than the awarding body.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          The portfolio of evidence is the core of the NVQ Level 3. It must demonstrate that you are
          competent across all required units through real workplace evidence. Understanding what
          good evidence looks like is key to completing the NVQ efficiently.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                observed. This is the strongest form of evidence and cannot be replaced by other
                types.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                be signed and dated. Witness statements supplement but do not replace assessor
                observations.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                installation work (cable containment, consumer units, socket positions) that is
                later concealed or handed over to the client.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <BookOpen className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          The AM2 (Achievement Measure 2) is a practical assessment conducted at an approved AM2
          centre over approximately one and a half days. It is separate from the NVQ but is required
          alongside it for ECS Gold Card eligibility.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                is recommended as centres can have waiting lists of several weeks.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
          ...
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                overall package. Candidates who need more visits to complete their evidence pay
                more.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                number of observations included. Confirm what is included — some packages exclude
                AM2 costs.
              </span>
            </li>
            <li className="flex items-start gap-3">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                Check with the training centre whether you qualify before paying full price.
              </span>
            </li>
          </ul>
        </div>
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                and test documentation. Wide evidence base allows all units to be covered quickly.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ClipboardCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                seek additional opportunities to evidence units not covered by their regular work.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ClipboardCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                an organised portfolio. Starting your portfolio early and documenting work
                systematically from day one is the most effective approach.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Completing your NVQ Level 3 and AM2 opens the door to ECS Gold Card status, registration
          with a competent person scheme, and self-employed trading. Having the right tools from day
          one sets you up for a professional, compliant practice.
        </p>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  Once you are registered with a competent person scheme, you are required to issue
                  compliant certificates for all notifiable work. Use the{' '}
                  <SEOInternalLink href="/tools/eicr-certificate">
                    Elec-Mate certificate app
                  </SEOInternalLink>{' '}
                  to complete EICs, EICRs, and Minor Works Certificates on your phone and issue PDFs
