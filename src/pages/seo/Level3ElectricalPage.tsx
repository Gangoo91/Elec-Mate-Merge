...
const PAGE_TITLE =
  'Level 3 Electrical Installation Course Online | Advanced Diploma | Elec-Mate';
...
const courseSchema = {
  ...
  courseMode: 'online',
  coursePrerequisites:
    'Level 2 Diploma in Electrical Installation (C&G 2365-02 or equivalent)',
  hasCourseInstance: {
    '@type': 'CourseInstance',
    courseMode: 'online',
    courseWorkload: 'P2Y',
    ...
    <PublicPageLayout>
      ...
      <section className="py-16 sm:py-24 px-5">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-white max-w-2xl mx-auto leading-relaxed mb-8">
            Master circuit design, inspection and testing, fault diagnosis, and
            BS 7671 special locations. The advanced qualification that takes you
      ...
      <section id="what-is-level-3" className="py-12 px-5 border-t border-white/5">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4 text-white leading-relaxed">
            <p>
              The City & Guilds 2365-03 Level 3 Diploma in Electrical
              Installation is the advanced qualification that transforms a
              foundation-level learner into a technically competent electrician.
              Where Level 2 introduces the fundamental principles, Level 3
              develops the depth of knowledge and practical skill needed to
              design circuits, inspect and test installations independently,
              diagnose and rectify faults systematically, and apply the full
              scope of BS 7671:2018+A3:2024 including Part 7 special
              installations and locations.
            </p>
            <p>
              The Level 3 Diploma is a substantial qualification, typically
              studied over one to two years alongside practical experience on
              site. For apprentices, it forms the core of years two and three of
              the apprenticeship programme. The qualification maps directly to
              the technical knowledge requirements of the Installation
              Electrician / Maintenance Electrician apprenticeship standard
              (ST0215) and is assessed through a combination of written
              examinations and practical assignments.
            </p>
            <p>
              Achieving Level 3 is a major milestone because it is the last
              knowledge-based qualification before the AM2 practical assessment.
              Once you have Level 3 plus the AM2, plus the 18th Edition (C&G
              2382), you are eligible for the JIB Installation Electrician Gold
              Card — the industry's benchmark for a fully qualified electrician.
              From there, the path continues to the 2391-52 (Inspection and
              Testing), scheme registration with NICEIC, NAPIT, or ELECSA, and
              potentially the JIB Approved Electrician grading.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 px-5 border-t border-white/5">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4 text-white leading-relaxed">
            <p>
              Circuit design is one of the most technically demanding areas of
              the Level 3 qualification and one of the most important skills
              you will develop. A properly designed circuit is safe, efficient,
              and compliant with BS 7671:2018+A3:2024. A poorly designed circuit
              can be dangerous, wasteful, and non-compliant — potentially
              leading to overheating, fire, or failure of protective devices
              under fault conditions.
            </p>
            <p>
              The design process follows a logical sequence. First, determine
              the design current (Ib) from the connected load. For example, a
              9.5 kW electric shower on a 230V single-phase supply has a design
              current of approximately 41.3A (I = P / V). Second, select a
              protective device with a nominal rating (In) equal to or greater
              than Ib — in this case, a 45A MCB. Third, apply correction
              factors to determine the minimum tabulated current-carrying
              capacity (It) the cable must have. These correction factors
              account for ambient temperature (Ca), grouping with other cables
              (Cg), thermal insulation (Ci), and the type of protective device
              if using BS 3036 semi-enclosed fuses (Cc).
            </p>
            <p>
              Fourth, select a cable from the appropriate current rating table
              in BS 7671 Appendix 4 that has a tabulated rating equal to or
              greater than It. Fifth, verify that the voltage drop across the
              cable run does not exceed the maximum permitted value — typically
              3% of the nominal voltage for lighting circuits (6.9V) or 5% for
              other circuits (11.5V). Sixth, confirm the earth fault loop
              impedance (Zs = Ze + R1 + R2) does not exceed the maximum value
              for the selected protective device, ensuring automatic
              disconnection within the required time (0.4s for final circuits,
              5s for distribution circuits). Seventh, check the cable can
              withstand the thermal effects of fault current using the adiabatic
              equation.
            </p>
            <p>
              Elec-Mate's AI design assistant walks you through each step,
              pulling values from the correct BS 7671 tables and showing you
              exactly how each correction factor affects the final cable size.
              You can input your own scenarios — "Size a cable for a 32A ring
              final circuit with 28 metres of cable run, three other circuits
              grouped in the same conduit, ambient temperature 35 degrees
              Celsius" — and receive a fully worked calculation with regulation
              references. This kind of targeted practice is far more effective
      ...
      <section className="py-12 px-5 border-t border-white/5">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4 text-white leading-relaxed">
            <p>
              Level 3 introduces the full inspection and testing procedures
              specified in Chapter 61 (initial verification) and Chapter 62
              (periodic inspection and testing) of BS 7671:2018+A3:2024, and
              detailed in Guidance Note 3: Inspection & Testing (GN3, 9th
              Edition).
            </p>
            <p>
              The GN3 testing sequence — continuity of protective conductors,
              continuity of ring final circuit conductors, insulation
              resistance, polarity, earth fault loop impedance, prospective
              fault current, and RCD testing — is taught with emphasis on both
              the correct procedure and the reasoning behind the test order.
              You will learn how to use a multifunction tester to perform each
              test, how to interpret the results against the BS 7671 maximum
              permitted values, and how to record results accurately on the
              Schedule of Test Results.
            </p>
            <p>
              Visual inspection is covered in detail, including what to look
              for when assessing an installation for compliance with BS 7671.
              The inspection checklist covers correct selection and erection of
              equipment, cable condition and routing, accessory condition and
              fixings, protective device ratings and coordination, earthing and
              bonding adequacy, labelling and identification, and compliance
              with any Part 7 special requirements applicable to the
              installation.
            </p>
            <p>
              Elec-Mate provides interactive scenario walkthroughs that
              simulate both initial verification and periodic inspection
              situations. Each scenario presents you with photographs, circuit
              details, and test results. You must identify defects, assign
              observation codes, determine the overall condition, and complete
              the relevant certification. The AI provides instant feedback on
              your decisions, citing the relevant BS 7671 regulations.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 px-5 border-t border-white/5">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4 text-white leading-relaxed">
            <p>
              Fault diagnosis is a core skill for any qualified electrician and
              is tested in both the Level 3 examination and the AM2 assessment.
              The ability to identify a fault quickly, safely, and
              systematically separates competent professionals from those who
              rely on trial and error.
            </p>
            <p>
              Level 3 teaches a structured approach to fault diagnosis. The
              first step is always safe isolation — following the three-step
              procedure (prove, test, re-prove) to ensure the circuit is dead
              before carrying out any investigation. The second step is to
              gather information: what are the symptoms, when did the fault
              occur, was anything changed recently, and what is the circuit
              configuration?
            </p>
            <p>
              The third step is systematic testing using logical methods. The
              half-split method divides the circuit into two halves and tests
              each to determine which half contains the fault, then divides the
              faulty half again, and so on until the fault location is
              identified. This is significantly faster than testing every
              component in sequence. Other diagnostic approaches include
              comparing measured values against expected values (for example, an
              unexpectedly high R1+R2 may indicate a high-resistance connection),
              visual inspection for signs of damage or deterioration, and
              insulation resistance testing to identify breakdown.
            </p>
            <p>
              Common fault types covered at Level 3 include open circuit faults
              (broken conductor, loose connection, blown fuse), short circuit
              faults (line-to-neutral or line-to-earth), earth faults (insulation
              breakdown causing current to flow to earth), and transient faults
              (intermittent problems that only occur under certain conditions such
              as thermal expansion or vibration). Elec-Mate presents realistic
              fault scenarios with multiple possible causes, challenging you to
              apply the systematic approach and arrive at the correct diagnosis
              through logical reasoning rather than guesswork.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 px-5 border-t border-white/5">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4 text-white leading-relaxed mb-6">
            <p>
              Part 7 of BS 7671:2018+A3:2024 specifies additional requirements
              for installations in locations where the risk of electric shock is
              increased due to environmental conditions, the presence of water,
              reduced body resistance, or other factors. These requirements are
              applied on top of the general regulations — they do not replace
              them.
            </p>
          </div>
      ...
      <section className="py-12 px-5 border-t border-white/5">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4 text-white leading-relaxed">
            <p>
              Level 3 is the final knowledge-based qualification before the AM2
              practical assessment. The AM2 (Achievement Measurement 2), run by
              NET (National Electrotechnical Training) on behalf of the JIB
              (Joint Industry Board), is a practical assessment that tests your
              ability to carry out electrical installation work safely, competently,
              and to industry standards within time constraints.
            </p>
            <p>
              The AM2 covers consumer unit installation, ring final circuit wiring,
              one-way and two-way lighting circuit wiring, safe isolation and fault
              finding on a pre-built faulty circuit, and inspection and testing with
              accurate documentation. Every one of these tasks directly applies the
              knowledge and skills taught at Level 3. Elec-Mate provides dedicated
              AM2 preparation modules with timed exercises, common fault patterns,
              and assessment tips from electricians who have recently passed.
            </p>
            <p>
              Upon passing the AM2 alongside your Level 3 Diploma, NVQ Level 3 in
              Electrical Installation, and the current 18th Edition qualification
              (C&G 2382), you are eligible for the JIB Installation Electrician Gold
              Card. The Gold Card is the industry-recognised credential that confirms
              you are a fully qualified electrician, opening doors to employment with
              major contractors, self-employment, and progression to scheme
              registration and the Approved Electrician grading.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 px-5 border-t border-white/5">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-white text-center mb-8 max-w-2xl mx-auto">
            Advanced tools for advanced learners. Design calculators, fault
            diagnosis simulators, and AI-powered study across every Level 3 topic.
          </p>
