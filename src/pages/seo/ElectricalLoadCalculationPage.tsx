...
const faqs = [
  ...
  {
    question:
      'How do I size a supply for a new EV charger without overloading the existing installation?',
    answer:
...
const sections = [
  {
    ...
    content: (
      <>
        <p>
          Electrical load is the total power demand placed on a circuit, distribution board, or
          supply by the connected electrical equipment. It is expressed in amperes (A) for current,
          watts (W) or kilowatts (kW) for power, or volt-amperes (VA) for apparent power. The design
          current (Ib) is the current that a circuit is expected to carry under normal operating
          conditions.
        </p>
        <p>
          Load calculations are required when designing a new installation, when modifying an
          existing installation to add significant new loads, and when assessing whether an existing
          installation can safely accommodate additional loads. Incorrectly sized circuits,
          distribution boards, or supply connections are a significant cause of electrical fires and
          equipment damage.
        </p>
        <div className="rounded-2xl bg-blue-500/10 border border-blue-500/20 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Design current (Ib):</strong> The current the circuit is designed to carry.
                Must not exceed the current-carrying capacity (Iz) of the cable after applying
                correction factors.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Maximum demand:</strong> The highest assessed demand that the installation
                will draw simultaneously. Used to size the main switch, supply cable, and supply
                fuse.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                equipment. The maximum demand is always less than the connected load for most
                installations because not all loads run simultaneously.
              </span>
            </li>
          </ul>
        </div>
          ...
          <ul className="space-y-3 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                actively limits output. Always discuss with the client and document the assessment
                basis in the design.
              </span>
            </li>
          </ul>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Maximum demand calculation brings together connected loads and diversity factors to
          establish the design basis for a supply, distribution board, or circuit. The result is
          used to select the main protective device rating and the supply cable CCC.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
        ...
        <p>
          The actual calculation must be performed using the connected loads specific to the
          property. Document the calculation and retain it with the EIC for the installation. Use{' '}
          <SEOAppBridge href="/tools/eicr-certificate" label="Elec-Mate" /> to record design details
          on the EIC.
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>
          Once the design current (Ib) for a circuit is established, the cable must be selected with
          sufficient current-carrying capacity (Iz) after applying all relevant correction factors.
          ...
          <ul className="space-y-3 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                reach 60°C+ ambient — Ca can reduce CCC by 40% or more.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Calculator className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                methods — a 50% reduction in CCC.
              </span>
            </li>
          </ul>
        </div>
        <p>
          BS 7671 Appendix 4 contains the full tables of CCC and correction factors. The IET On-Site
          Guide provides simplified tables for common installation methods. Always check voltage
          drop (Regulation 525) as well as CCC — the voltage drop from supply to load must not
          exceed 3% for lighting circuits and 5% for other circuits under normal operating
          conditions.
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>
          Three-phase supplies are standard for commercial and industrial premises, and are
          increasingly used in domestic premises with large electrical loads (EV charging, large
          heat pumps). The load calculation approach differs from single-phase.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                line voltage (400V in the UK). A 22kW three-phase EV charger draws 22,000 / (√3 ×
                400 × 1.0) = 31.8A per phase.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                design — allocate single-phase circuits to phases to minimise the difference in
                loading between L1, L2, and L3.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                significant single-phase loads cause phase imbalance, or where non-linear loads
                (LEDs, VFDs, switched-mode power supplies) create third-harmonic currents, the
                neutral current may exceed the phase current — requiring the neutral to be the same
                cross-section as the phase conductors (BS 7671 Regulation 523.6.3).
              </span>
            </li>
          </ul>
        </div>
    ...
    content: (
      <>
        <p>
          ...
          calculations, but the scale and complexity is greater and the consequences of errors more
          significant. Full first-principles calculations are required — not simplified OSG methods.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                design current, and diversity. This schedule forms part of the EIC documentation.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Wrench className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                Power factor correction (PFC) capacitors reduce the reactive demand and can avoid
                penalty charges from the supply authority. Cable sizing uses apparent current (kVA /
                V), not true power current.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          The following worked examples illustrate the application of diversity factors and load
          calculation methods for common UK electrical installation scenarios.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <h3 className="text-lg font-semibold text-white mb-3">
        ...
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <h3 className="text-lg font-semibold text-white mb-3">
            Example 2 — Small Office Distribution Board
          </h3>
          <ul className="space-y-3 text-white">
            <li className="flex items-start gap-3">
              <Calculator className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
        ...
        <p>
          ...
          />{' '}
          for how undersized cables and protective devices are typically recorded as C2 observations
          on electrical inspection reports.
        </p>
      </>
    ),
  },
