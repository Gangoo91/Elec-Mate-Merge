    ...
    content: (
      <>
        <p>
          ...
          upon Tyne. These regulations came into force on 1 June 2020 for new tenancies and
          1 April 2021 for all existing tenancies. Every private landlord in Newcastle must comply.
        </p>
    ...
    content: (
      <>
        <p>
          ...
          Regulations across Newcastle upon Tyne. The council has been identified as one of the
          more active councils for EICR enforcement following the introduction of the Regulations,
          ...
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                A valid EICR is a condition of the licence. The council cross-references HMO
                licence applications against EICR records, so landlords without valid reports face
                immediate licence refusal.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Building2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                out-of-date EICRs to the council trigger formal enforcement action. The council
                can require the landlord to provide the EICR within a fixed period, issue a
                remedial notice if problems are found, and ultimately impose a financial penalty
                of up to £30,000.
              </span>
            </li>
            <li className="flex items-start gap-3">
    ...
    content: (
      <>
        <p>
          ...
          stock in these three areas makes Newcastle's HMO licensing and EICR enforcement among
          the most active of any English city outside London.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                original TN-S earthing from the 1880s–1920s construction period is frequently
                found to be inadequate on inspection. Inspectors must assess both flats' electrical
            ...
            <li className="flex items-start gap-3">
              <Users className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>RCD protection in HMOs</strong> — Regulation 411.3.3 of BS 7671 requires
                RCD protection on socket-outlet circuits rated up to 32A. In HMOs with multiple
        ...
        <p>
          ...
          applications with EICR records, so landlords without valid reports face immediate
          licence refusal.
        </p>
      </>
    ),
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                and failing to complete remedial work are each separate breaches. A landlord
                who has never obtained an EICR and ignores a remedial notice could face multiple
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                non-compliance. The council's active enforcement posture means repeat offenders
                are more likely to face the upper end of the penalty range.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-red-400 mt-0.5 shrink-0" />
    ...
    content: (
      <>
        <p>
          ...
          in their rented property. Students renting in Jesmond, Heaton, and Sandyford — who make
          up an unusually large proportion of Newcastle's private rental market — should be
          ...
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                The tenant should not be charged for any remedial work.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                ...
                also provides protection from retaliatory eviction where a tenant has raised a
                legitimate complaint about the condition of the property.
              </span>
            </li>
          </ul>
        </div>
    ...
    content: (
      <>
          ...
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                has been done satisfactorily. This must be provided to the tenant and to Newcastle
                City Council within 28 days of the work being completed.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Clock className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Common Newcastle remedial work</strong> — typical remedial work in
                Newcastle rental properties includes fitting RCD protection (Regulation 411.3.3),
                replacing rubber-insulated wiring in Tyneside flats, upgrading outdated consumer
                units, addressing TN-S earthing deficiencies, adding supplementary bonding in
                bathrooms, and remedying overloaded circuits.
              </span>
            </li>
          </ul>
        </div>
        <p>
          ...
          are a separate breach of the regulations.
        </p>
      </>
    ),
  },
    ...
    content: (
      <>
        <p>
          ...
          particularly in the older Tyneside flat and Victorian terrace stock that dominates
          the local rental market. Landlords should verify qualifications and experience before
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                online registers for Newcastle-based inspectors. Registration provides assurance
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                qualification (C&G 2382 18th Edition). Experience with Tyneside flats and
                Victorian terraces in Heaton, Byker, and Jesmond is particularly important given
                the rubber-insulated wiring and TN-S earthing arrangements commonly found.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Search className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                Distribution Network Operator (DNO) serving Newcastle. Inspectors should be
                familiar with Northern Powergrid supply arrangements and earthing systems, as
                PME and TN-S configurations each have different bonding requirements.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Search className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                Newcastle two-bedroom terraced house takes 2 to 4 hours and requires calibrated
                test instruments. Quotes significantly below £180 should raise concerns about
                the quality and thoroughness of the inspection.
              </span>
            </li>
          </ul>
        </div>
    ...
    content: (
      <>
        <p>
          ...
          required by the city's older housing stock. Tyneside flats and Victorian terraces
          with non-standard wiring routinely take longer to inspect thoroughly than modern builds,
        ...
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>One-bedroom flat (including Tyneside flat lower/upper)</strong> — £180
                to £240. Shared consumer units or TN-S earthing in Tyneside flats can add time
                and cost.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                Sandyford. Victorian properties with original wiring take longer to inspect and
            ...
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Three-bedroom terraced house</strong> — £280 to £450. Properties in
                Jesmond, Gosforth, and Fenham vary widely depending on age, wiring condition,
            ...
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Student HMO</strong> — £380 to £700+. Multiple consumer units, fire
                alarm systems, emergency lighting, and communal circuits increase inspection
                scope and time significantly.
              </span>
            </li>
          </ul>
        </div>
        <p>
          ...
          EICR is quoted and charged separately. Some Newcastle electricians offer combined EICR
