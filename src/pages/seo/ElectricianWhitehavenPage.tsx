...
const faqs = [
  ...
  {
    question:
      "Are there special requirements for electrical work in Whitehaven's conservation area?",
    answer:
...
const sections = [
    ...
    content: (
      <>
        <p>
          ...
          Sellafield nuclear site. With a population of around 24,000, it is the main town in the
          Copeland area and serves as the commercial and service centre for the surrounding
        ...
        <p>
          ...
          Sellafield — the nuclear site is closer to Whitehaven than to any other significant town
          in the region, making Sellafield contract work genuinely local for Whitehaven-based
          electricians. Second, the town has an unusually well-preserved Georgian town centre — one
          of the finest examples of planned Georgian urban design in England — which creates
          heritage property considerations for electrical work in the town centre conservation area
        ...
        <p>
          ...
          and industrial work, and the specific considerations of a coastal location where salt air
          and weather exposure affect external electrical installations.
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>
          For electricians based in Whitehaven, Sellafield represents the most accessible high-value
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                Conditions govern all activities, including electrical work. Electricians working on
                site must understand the permit-to-work system, Electrical Safety Rules, and
                isolation procedures specific to nuclear installations.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-amber-400 mt-0.5 shrink-0" />
              <span>
                ...
                sensitive areas). The process is initiated through a principal contractor on site.
                Allow several weeks for the vetting process. Once a pass is granted, it is valid for
                site access across multiple contractors.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-amber-400 mt-0.5 shrink-0" />
              <span>
                ...
                industry-specific codes and guidance published by the Nuclear Decommissioning
                Authority. These add significant additional requirements to the BS 7671 baseline,
                particularly for safety-related electrical systems.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-amber-400 mt-0.5 shrink-0" />
              <span>
                ...
                Bring evidence of qualifications and experience to any SQEP assessment — a
                qualification alone is insufficient without demonstrable experience in comparable
        ...
        <p>
          ...
          Whitehaven domestic work (£35–52/hr) is substantial. For a Whitehaven electrician who has
          obtained the necessary clearances, a mix of local domestic work and Sellafield contract
          shifts can create a highly productive and well-compensated working week.
        </p>
      </>
    ),
  },
    ...
    content: (
      <>
        <p>
          ...
          development in England and remains one of its best-preserved. The grid-pattern streets,
          Georgian townhouses, and harbour buildings are protected by conservation area designation
          and multiple listed building entries. This has direct implications for electrical work:
        </p>
        <div className="rounded-2xl bg-blue-500/10 border border-blue-500/20 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Listed building consent</strong> — required for any work that affects the
                character of a listed building, internally or externally. In practice: external EV
                charger installations, external cable routes, new meter enclosures, external
                lighting, and security cameras on listed properties all require consent from
                Cumberland Council. Internal rewiring is generally acceptable but should avoid
                damage to original features including cornices, panelling, and original fittings.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Landmark className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Conservation area restrictions</strong> — the conservation area covers much
                of the Georgian town centre. Even unlisted buildings within the conservation area
                face restrictions on external alterations that affect the streetscape. EV charger
                installations on front elevations are routinely scrutinised. Advise customers to
                check with the planning department before committing to visible external
                installations.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Landmark className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Practical considerations</strong> — Georgian townhouses typically have solid
    ...
    content: (
      <>
        <p>
          ...
          Whitehaven and the wider Copeland district. Key points for Whitehaven electricians:
        </p>
          ...
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                (larger systems) requires prior approval, typically 4–10 weeks. The west Cumbrian
                coast has a strong wind resource and growing solar adoption.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
  ...
  },
  {
    ...
    content: (
      <>
        <p>Whitehaven's housing and commercial stock spans several centuries of development:</p>
        <div className="grid gap-4 sm:grid-cols-2 my-4">
          <div className="rounded-2xl bg-blue-500/10 border border-blue-500/20 p-5">
            <h3 className="font-bold text-white text-lg mb-3">Georgian Town Centre</h3>
            <p className="text-white text-sm leading-relaxed">
              The grid-plan Georgian streets around King Street, Lowther Street, and the harbour
              contain some of the finest Georgian architecture in England. Solid stone and brick
              walls, high ceilings, original features, and heritage restrictions make electrical
              work here more complex and time-consuming than in modern properties. Plan cable routes
          ...
          <div className="rounded-2xl bg-amber-500/10 border border-amber-500/20 p-5">
            ...
            <p className="text-white text-sm leading-relaxed">
              ...
              forms the bulk of Whitehaven's residential stock. Solid walls, potential asbestos in
              pre-1980 properties, and dated wiring systems (rubber-insulated TRS, early PVC) are
              common. Consumer unit upgrades and rewires are routine jobs.
            </p>
          </div>
          ...
          <div className="rounded-2xl bg-green-500/10 border border-green-500/20 p-5">
            ...
            <p className="text-white text-sm leading-relaxed">
              Whitehaven's historic harbour has undergone significant regeneration, with residential
              and commercial properties now occupying former industrial buildings. Harbour-front and
              coastal properties require attention to corrosion: IP65+ external fittings, sealed
              cable entries, stainless steel or marine-grade fixings. EV charger installations on
              harbour-front properties should specify units with appropriate salt atmosphere
              ratings.
            </p>
          </div>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Whitehaven rates are typical for west Cumbrian coastal towns. The proximity to Sellafield
          creates a two-tier earning environment for locally based electricians. Typical rates in
          2026:
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div className="space-y-3">
              ...
              <p className="text-white text-xs leading-relaxed pt-2">
                Heritage premium applies to period town centre properties requiring additional
                planning, survey time, and careful installation methods.
              </p>
            </div>
          </div>
        </div>
    ...
    content: (
      <>
        <p>
          ...
          heritage property challenges, and the most immediately accessible nuclear site contract
          work in England. Electricians who build both domestic expertise and Sellafield clearances
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  ...
                  site with AI-assisted board scanning. Heritage properties often require thorough
                  documentation — deliver professional certificates from your phone before you leave
                  site.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h4 className="font-bold text-white mb-1">
                  Cable Sizing for Heritage and Coastal Properties
                </h4>
                <p className="text-white text-sm leading-relaxed">
                  Use the{' '}
                  ...
                  longer cable runs than standard cavity-wall properties. Accurate voltage drop
