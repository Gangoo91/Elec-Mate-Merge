...
const faqs = [
  ...
  {
    question:
      'Do I need to re-identify old red and black cores when working on a switching circuit?',
    answer:
...
const sections = [
    ...
    content: (
      <>
        <p>
          ...
          installations. It allows a single light (or group of lights) to be switched on or off from
          two separate locations — the most common application being at the top and bottom of a
          staircase, or at the two ends of a long hallway.
        </p>
        <p>
          The circuit works by using two special switches — two-way switches — each with three
          terminals: a common (C), an L1, and an L2. The common of the first switch is connected to
          the incoming line. The common of the second switch feeds the lamp. The two switches are
          connected together by two conductors called strappers, which link L1 of switch 1 to L1 of
          switch 2, and L2 of switch 1 to L2 of switch 2.
        </p>
        <div className="rounded-2xl bg-blue-500/10 border border-blue-500/20 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Both switches up (L1):</strong> Line travels from switch 1 common to L1,
                across strapper to switch 2 L1, through switch 2 to common, and on to the lamp —
                circuit complete, lamp on.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Switch 1 up (L1), Switch 2 down (L2):</strong> Line travels to switch 2 L1,
                but switch 2 is on L2 — no connection to common — lamp off.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Operating either switch changes the lamp state</strong> — each switch
                toggles between L1 and L2, either completing or breaking the circuit path regardless
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          In April 2006, the UK adopted the harmonised European cable colour code for fixed wiring.
          Electricians regularly encounter both old and new colour codes in existing domestic
          installations, often in the same property. Correctly identifying and re-identifying
          conductors is a critical safety and compliance requirement.
        </p>
          ...
          <ul className="space-y-3 text-white">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                be sleeved brown where used as line conductors.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                re-identified with brown sleeving at each termination.
              </span>
            </li>
          </ul>
        </div>
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                connection stating: "Caution — this installation has wiring colours to two versions
                of BS 7671." This is a mandatory requirement under Regulation 514.14.1 of BS 7671.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                core must be sleeved red (old) or brown (new) at both ends. Failure to do so is a
                common C3 or C2 finding on EICRs.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          There are two common approaches to two-way switching in UK domestic wiring. The choice
          depends on the cable routing in the property.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          ...
          <ul className="space-y-3 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                switch 2. Switch return from switch 2 common back to the ceiling rose lamp
                terminals.
              </span>
            </li>
            <li className="flex items-start gap-3">
          ...
          <ul className="space-y-3 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                continues to the ceiling rose or junction box. Strapper connects switch 1 L1/L2 to
                switch 2 L1/L2. Switch 2 common returns to the lamp.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                connected to any switch terminal.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Where a light needs to be controlled from three or more positions (for example, a long
          landing with a switch at each end and one in the middle), an intermediate switch is
          inserted in the strapper cable between the two outer two-way switches.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                the strapper conductors between the pairs.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Wrench className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                from the intermediate to two-way switch 2 (connect to the second pair). Use
                consistent colour mapping across both cables.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Wrench className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                switch. Each additional control point requires one additional intermediate switch
                and one additional strapper cable.
              </span>
            </li>
          </ul>
        </div>
        <p>
          ...
          They are sometimes sold as combined two-way/intermediate switches with a link fitted at
          the factory — remove the link to use as intermediate.
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>
          Two-way switching is a source of numerous installation errors, many of which result in C2
          or C3 findings on EICRs or persistent fault callbacks from customers.
        </p>
        <div className="rounded-2xl bg-yellow-500/10 border border-yellow-500/20 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                to L2) results in a light that only operates from one switch. Always map L1 to L1
                and L2 to L2 consistently.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                or red sleeving creates a hazard for future workers who may assume it is neutral.
                This is a C3 in most EICR guidance, C2 if particularly hazardous.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                in one switch position permanently disconnecting the circuit — the light cannot be
                controlled from the other switch.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                to the switch. Connecting it accidentally to a switch terminal creates an earth
                fault (neutral shorted to line via the lamp) when the switch operates.
              </span>
            </li>
          </ul>
        </div>
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                (brown/black/grey), the black and grey must be sleeved or taped brown at every
                accessible termination. In old cable (red/yellow/blue), yellow and blue must be
                sleeved or taped red (old installations) or brown (new work).
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                both terminations — at the switch and at the ceiling rose or junction box.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                of the installation and at any point where both colour schemes are present.
              </span>
            </li>
          </ul>
        </div>
        <p>
          These identification requirements apply whenever any wiring work is carried out on an
          existing switching circuit — even if you are only replacing a switch. Failing to
          re-identify conductors when they are accessible is a common C3 finding and can be upgraded
          to C2 if the risks are significant.
        </p>
        <p>
          See the{' '}
          <SEOInternalLink
    ...
    content: (
      <>
        <p>
          ...
          Certificate. Where new cables are installed that form part of a new circuit, an Electrical
          Installation Certificate is required. Use Elec-Mate to generate compliant certificates
          on-site.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
