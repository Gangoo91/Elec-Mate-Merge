    ...
    content: (
      <>
        ...
        <SEOAppBridge
          ...
          description="Every risk assessment and method statement generated by Elec-Mate's AI Health and Safety agent includes the correct safe isolation procedure referencing…"
          icon={Shield}
        />
      </>
    ),
    ...
    content: (
      <>
        ...
        <SEOAppBridge
          ...
          description="Elec-Mate's site safety tools help you manage test equipment calibration dates, PPE inspection records, and training certificates."
          icon={Eye}
        />
      </>
    ),
...
export default function GS38ProvingDeadPage() {
  return (
    <GuideTemplate
      title="GS 38 Proving Dead | HSE Test Equipment Rules 2026"
      description="HSE Guidance Note GS 38 (4th ed) explained: voltage indicator + proving unit rules, 2-pole testers, 4 mm probe-tip limit, fused leads, prove-test-prove."
