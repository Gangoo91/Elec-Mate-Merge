...
const faqs = [
  {
    question: 'Do I really need a website as an electrician, or will my Google Business Profile do?',
    answer:
  ...
  {
    question: 'What is the difference between Wix, Squarespace, and WordPress for an electrician website?',
    answer:
...
const relatedPages: RelatedPage[] = [
  {
    ...
    description: 'How to rank on Google as an electrician — Google Business Profile, local citations, and on-page SEO.',
    icon: Search,
    category: 'Guide',
  },
  {
    ...
    description: 'PPC guide for electrical contractors — Local Services Ads, search ads, and budgets.',
    icon: BarChart3,
    category: 'Guide',
  },
  {
...
const sections = [
  {
    ...
    content: (
      <>
        <p>
          The majority of homeowners and small businesses now search Google before hiring a tradesperson.
          If you have no website — or a poor one — you lose jobs before a single conversation happens.
          A professional website works for you around the clock: it takes enquiries while you are on a
          job, builds trust before you arrive, and gives prospective customers a reason to choose you
          over the unregistered competitor who came up first on Checkatrade.
        </p>
        <p>
          Word of mouth remains the most valuable source of work for most electricians, but even referred
          customers Google you before calling. A website that clearly shows your NICEIC registration,
          Google reviews, and the types of work you do converts those referred prospects into confirmed
          bookings. Without one, you are asking people to trust a name they found on a piece of paper.
        </p>
          ...
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                pricing or explain why your service costs more than the cheapest quote. Customers who
                see your NICEIC logo and 50 five-star reviews are far less likely to haggle than
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Trust signals are the elements on your website that reassure a stranger they are safe hiring
          you. For electricians, where the stakes include fire risk and legal compliance, trust signals
          are particularly important. Get these right and your conversion rate — the percentage of
          visitors who make an enquiry — will be noticeably higher.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Scheme membership logos</strong> — display your NICEIC, NAPIT, or ELECSA logo
                prominently with your registration number. Include a note that customers can verify
                your registration on the scheme's website. This is the single most effective trust
                signal for electrical work.
              </span>
            </li>
            <li className="flex items-start gap-3">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                van, your completed work (consumer unit upgrades, EV chargers, clean cable runs), and
                ideally yourself build a human connection stock images cannot replicate.
              </span>
            </li>
          </ul>
        </div>
        <p>
          ...
          scrolling. Customers who see these within the first two seconds of landing on your site are
          significantly more likely to stay and enquire.
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>
          The choice between a website builder and a custom-built site comes down to budget, technical
          confidence, and where you are in your business journey. Here is an honest breakdown of each
          option.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
            ...
            <li className="flex items-start gap-3">
              ...
              <div>
                ...
                <span>
                  ...
                  knowledge required. Customer support available. The main limitation is that
                  you cannot move your Wix site to another host if you outgrow it.
                </span>
              </div>
            </li>
            <li className="flex items-start gap-3">
              ...
              <div>
                ...
                <span>
                  ...
                  Excellent for portfolio-style sites. Good built-in analytics. Less suitable if
                  you need multiple location pages or complex SEO configurations.
                </span>
              </div>
            </li>
            <li className="flex items-start gap-3">
              ...
              <div>
                ...
                <span>
                  The best long-term SEO platform and most used website system in the world. Free
                  to use but requires hosting, domain, and ongoing maintenance. Plugins like Yoast
                  SEO, Rank Math, and WPForms give you sophisticated tools. Recommended once you
                  have budget to pay a developer or are willing to invest time learning it.
                </span>
              </div>
            </li>
            <li className="flex items-start gap-3">
              ...
              <div>
                ...
                <span>
                  A bespoke site designed and built by an agency or specialist developer. Justifiable
                  once you are generating consistent revenue and want to differentiate significantly
                  from competitors. Not the right starting point for most electricians.
                </span>
              </div>
            </li>
          </ul>
        ...
        <p>
          The most cost-effective approach for most electricians: hire a freelancer on People Per Hour
          or Bark to build a Wix or Squarespace site for £300–£800. You get a professionally built
          site without the ongoing technical burden of WordPress, and without paying agency prices.
        </p>
      </>
    ),
  },
        ...
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Google Business Profile first</strong> — before spending time on website SEO,
                make sure your Google Business Profile is fully optimised. It drives more local
                enquiries than organic rankings for most electricians. See our{' '}
                <SEOInternalLink href="/seo-for-electricians">
                  full SEO guide
                </SEOInternalLink>{' '}
                for detailed Profile optimisation steps.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Search className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                have a unique title including your target keyword and location. Example: "Electrician
                in Coventry | NICEIC Registered | [Your Business Name]". The meta description (the
                text shown under your link in Google results) should include your phone number and a
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                separate page for each one. "Electrician in [Town]" pages, each with 300–500 words of
                genuine content about the area and your services there, dramatically improve local
                rankings. Generic pages with just the town name swapped out do not work — Google
            ...
            <li className="flex items-start gap-3">
              <Search className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Service pages</strong> — create individual pages for each main service (EICR,
                consumer unit upgrade, EV charger installation, rewire, solar PV). Each page should
                explain the service, why it matters, what the process involves, and approximate costs.
                These pages rank for specific service searches and pre-qualify customers before they
                contact you.
              </span>
            </li>
            <li className="flex items-start gap-3">
    ...
    content: (
      <>
        <p>
          ...
          breaker, a failed socket, a moving-day panic. If your website is slow or difficult to
          use on a phone, they will bounce immediately to the next result.
        </p>
        <div className="rounded-2xl bg-blue-500/10 border border-blue-500/20 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                remove unnecessary plugins, and use a fast hosting provider. A one-second delay
                in page load time reduces conversions by approximately 7 per cent.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Smartphone className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                ...
                header on every page and must be a clickable <code>tel:</code> link so mobile
                users can call with one tap. This single change often produces a measurable
                increase in phone enquiries within days.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Smartphone className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                Paint, Cumulative Layout Shift, Interaction to Next Paint) as ranking factors.
                Wix and Squarespace handle most of these automatically. WordPress sites need careful
        ...
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              <Phone className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Call tracking setup</strong> — services like CallRail (from £30/month)
                or ResponseTap assign a unique phone number to each marketing channel (your website,
            ...
            <li className="flex items-start gap-3">
              <Phone className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>WhatsApp button</strong> — adding a WhatsApp click-to-chat button (free
                via WhatsApp Business) generates additional enquiries from customers who prefer
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Here is an honest breakdown of what you should expect to pay at each level. These are
          UK market rates for 2026.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
            ...
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>WordPress site — £800–£2,000 + £80–£200/year</strong>: A freelancer or
                small agency builds a WordPress site. More powerful SEO capabilities and more
                flexibility, but you pay for ongoing hosting, maintenance, and updates separately.
                Right choice when you are ready to invest seriously in SEO.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Custom agency site — £2,000–£5,000+</strong>: Bespoke design and build by
                a specialist agency. Justified only when you have consistent revenue, clear
                differentiation, and a strategy that requires more than a standard builder can offer.
              </span>
            </li>
          </ul>
        </div>
        <p>
          ...
          Google Business Profile and reviews working first, then reinvest in your website as revenue
          grows.
        </p>
      </>
    ),
    ...
    content: (
      <>
        ...
        <div className="space-y-4 my-4">
          <div className="rounded-2xl bg-yellow-500/10 border border-yellow-500/20 p-5">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h4 className="font-bold text-white mb-1">Quote While You Are Still Talking to Them</h4>
                <p className="text-white text-sm leading-relaxed">
                  Use the{' '}
                  <SEOInternalLink href="/tools/electrical-quoting-app">
                    Elec-Mate quoting app
                  </SEOInternalLink>{' '}
                  to send a professional, itemised quote from your phone within minutes of an enquiry.
                  Customers who receive a quote quickly are far more likely to proceed — and far less
          ...
          <div className="rounded-2xl bg-green-500/10 border border-green-500/20 p-5">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h4 className="font-bold text-white mb-1">Customer Records That Follow Every Job</h4>
                <p className="text-white text-sm leading-relaxed">
        ...
        <SEOAppBridge
          ...
          description="Elec-Mate gives electricians professional quoting, invoicing, job management, and certification in one app. Join 430+ UK electricians. 7-day free trial."
          icon={Globe}
        />
      </>
    ),
...
export default function ElectricalBusinessWebsitePage() {
  return (
    <GuideTemplate
      ...
      ctaSubheading="Professional quoting, invoicing, and job management for UK electricians. Join 430+ electrical businesses. 7-day free trial, no card required."
    />
  );
}
