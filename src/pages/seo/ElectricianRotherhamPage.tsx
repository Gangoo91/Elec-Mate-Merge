...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'The requirements are standard for England. You need City & Guilds 2365 Level 2 and 3 (or NVQ Level 3 in Electrical Installation), plus the 18th Edition (BS 7671:2018+A4:2026) certificate. For self-certification under Part P, NICEIC or NAPIT registration is required. Rotherham College (now part of RNN Group) offers electrical training and apprenticeship programmes locally. Building trade qualifications locally can help establish a reputation in the Rotherham market.',
  },
  {
    question:
...
export default function ElectricianRotherhamPage() {
  return (
    <GuideTemplate
      ...
      ctaSubheading="Join 1,600+ UK electricians using Elec-Mate for cable sizing, quoting, and on-site certification. Built for the residential and commercial electrical market in Rotherham. 7-day free trial."
    />
  );
}
