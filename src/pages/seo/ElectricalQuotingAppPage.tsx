    ...
    <PublicPageLayout>
      ...
      <section id="why-quoting-matters" className="py-16 px-5">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4 text-white leading-relaxed">
            <p>
              Quoting is one of the most important — and most undervalued — activities in any
              electrical business. A quote is not just a price; it is a promise to the client about
              what work will be done, what it will cost, and when it will be completed. A poor quote
              leads to disputes, lost profits, and damaged reputation. A good quote wins work,
              protects your margin, and sets clear expectations.
            </p>
            <p>
              Yet most electricians still quote from memory, using rough calculations based on
              experience. "A rewire? That is about three grand." The problem is that "about three
              grand" can easily become two and a half or three and a half depending on the specifics
              — the number of circuits, the type of accessories, the difficulty of the cable routes,
              the condition of the existing installation, and the client's expectations. Without a
              systematic approach, quotes are inconsistent: the same electrician might quote
              different prices for the same job on different days, depending on how busy they are or
            ...
            <p>
              ...
              margin, and is competitive. Achieving this consistently requires a structured approach
            ...
            <p>
              ...
              clearly explains the work, the client is more likely to trust you with the job — even
              if your price is slightly higher than a competitor's scribbled note.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-5 bg-white/[0.02]">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4 text-white leading-relaxed">
            <p>
              Elec-Mate's quote builder is designed for electricians, not generic tradespeople. It
              understands the specific cost structure of electrical work — the materials, the labour
              time for different tasks, the fixed costs, and the variables. The AI Cost Engineer is
            ...
            <p>
              ...
              basis — perhaps a repeat client gets a smaller margin, or a complex job needs a larger
              contingency.
            </p>
            <p>
      ...
      <section className="py-16 px-5">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4 text-white leading-relaxed">
            <p>
              Accurate material pricing is the foundation of a good quote. Elec-Mate includes a
              built-in database of current UK trade prices for the most commonly used electrical
              materials — cables, accessories (sockets, switches, plates), consumer units, MCBs,
              RCBOs, SPDs, trunking, conduit, fixings, fire hoods, downlights, EV chargers, and
              more.
            </p>
            <p>
              Prices are sourced from major UK wholesalers and updated regularly to reflect market
              changes. You can also override any price with your own supplier's rate — if you have a
              trade account that gives you better pricing on a particular brand, enter your price
              and it will be used in all future quotes. The material database also includes wastage
              factors — the percentage of additional material you should order to account for
              offcuts, damaged items, and measurement errors (typically 5 to 10% for cable, higher
            ...
            <p>
              ...
              Elec-Mate supports both sole-trader pricing (your time only) and employer pricing
              (multiple operatives at different rates — qualified electrician, improver,
              apprentice).
            </p>
          </div>
        </div>
      ...
      <section className="py-16 px-5 bg-white/[0.02]">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4 text-white leading-relaxed">
            <p>
              The job does not end when the quote is accepted — it ends when you are paid. Elec-Mate
              connects the entire workflow from quote to payment, eliminating the duplicate data
              entry that wastes time and introduces errors.
            </p>
            <p>
              When a client accepts your quote (by clicking "Accept" in the client portal, or by
              confirming verbally and you marking it as accepted), the quote status changes to
              "Accepted" and you can begin scheduling the work. Once the work is complete, you
              convert the quote to an invoice with a single tap. All line items, prices, client
              details, and job references are carried forward automatically.
            </p>
            <p>
              If the final job differed from the quote — additional circuits were needed, fewer
              materials were used, or the client requested changes during the work — you can edit
              the invoice before sending. Add or remove line items, adjust quantities, and add notes
              explaining any variations. This ensures the invoice accurately reflects the work done,
              not just the work quoted.
            </p>
            <p>
              The invoice is generated as a professional PDF with your company branding, a unique
              sequential invoice number, VAT breakdown (if VAT-registered), payment terms, and bank
              details or a Stripe payment link for card payments. Clients can pay by bank transfer
              or by clicking the payment link to pay by card instantly — the payment is
              automatically recorded and reconciled.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-5">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4 text-white leading-relaxed">
            <p>
              For electricians who use accounting software — or whose accountant requires it —
              Elec-Mate is designed to integrate with Xero and QuickBooks. These are the two most
              widely used accounting platforms for UK small businesses and sole traders, and
              integrating your quoting and invoicing with your accounts eliminates hours of manual
            ...
            <p>
              ...
              card through Stripe), the payment is reconciled automatically. Your profit and loss,
            ...
            <p>
              ...
              deductions are reported correctly in your accounting software, making it easy for your
            ...
            <p>
              ...
              are most profitable and price future jobs accordingly.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-5 bg-white/[0.02]">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4 text-white leading-relaxed">
            <p>
              First impressions matter. When a client receives a quote from Elec-Mate, they see a
              clean, professional portal branded with your business details — not a generic app
              interface. The portal is designed to be simple for non-technical clients: they can
              view the quote, see the scope of works, review the pricing, and accept with a single
              click.
            </p>
            <p>
              The client portal also shows the status of every document — sent, viewed (you receive
              a notification when the client opens it), accepted, invoiced, paid, or overdue. This
              visibility saves you from chasing clients for updates: you can see at a glance whether
              they have looked at the quote or not. If a quote has been viewed but not accepted
              after a few days, the system can send an automatic follow-up reminder.
            </p>
            <p>
              For invoices, the portal includes a "Pay Now" button if you have Stripe payment links
              enabled. The client can pay by debit or credit card instantly, without needing to set
              up a bank transfer or remember your bank details. Card payments typically arrive in
              your account within 2 working days, improving your cash flow compared to the typical
              14 to 30 day payment terms on bank transfer invoices.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-5">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-white text-center mb-10 max-w-2xl mx-auto">
            Purpose-built for UK electricians. Accurate pricing, professional presentation, and a
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4 text-white leading-relaxed">
            ...
            <p>
              ...
              The certificates you produce are linked to the jobs. The invoices reference the
              quotes. And all of it syncs to your accounting software. One platform, one login, one
