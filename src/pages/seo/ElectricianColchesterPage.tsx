...
const relatedPages: RelatedPage[] = [
  ...
  },
  {
    ...
    description:
      'Study for C&G 2391 — essential for EICR and HMO inspection work in Colchester.',
    icon: GraduationCap,
    category: 'Training',
  },
];
...
const sections = [
  {
    ...
    content: (
      <>
        <p>
          Colchester is a city in north Essex and Britain's oldest recorded town, with a
          population of around 130,000. It combines a historic town centre with Roman walls,
          a Norman castle, and significant medieval architecture — alongside modern residential
          expansion, the University of Essex, and the Army Garrison at Colchester.
        </p>
        <p>
          For electricians, Colchester presents a varied and interesting market. The historic
          town centre has listed buildings and conservation areas that require careful electrical
          work. The large student and military populations drive strong demand for HMO EICRs,
          fire alarm work, and emergency lighting. The expanding residential estates on the
          town's fringes create ongoing demand for new installations and EV charger work.
          South East rates apply throughout.
        </p>
        <p>
          This guide covers finding a qualified electrician in Colchester, typical costs,
          common jobs, the regulatory requirements, and the specific considerations for
          electrical work in this historic Essex city.
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>
          To find a qualified and registered electrician in Colchester, use the official
          contractor search tools:
        </p>
        <div className="rounded-2xl bg-blue-500/10 border border-blue-500/20 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>NICEIC</strong> — the NICEIC "find a contractor" search returns approved
                and assessed electricians covering Colchester and the surrounding Essex area.
                NICEIC contractors self-certify notifiable work and notify the local authority
                automatically.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                electricians carry out the same self-certification process under Part P.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                ...
                buildings in Colchester's historic centre, look for electricians with experience
                of working in heritage properties and familiarity with the listed building
                consent process.
              </span>
            </li>
          </ul>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Colchester sits firmly in the South East pricing band. Typical 2026 rates:
        </p>
        ...
        <div className="grid gap-4 sm:grid-cols-2 my-4">
          <div className="rounded-2xl bg-blue-500/10 border border-blue-500/20 p-5">
            ...
            <p className="text-white text-sm leading-relaxed">
              ...
              market. Landlord EICRs are legally required every 5 years. HMO properties near
              the University of Essex and Garrison also require fire alarms to BS 5839-6,
              emergency lighting, and sufficient socket provision for Colchester City Council's
          ...
          <div className="rounded-2xl bg-green-500/10 border border-green-500/20 p-5">
            ...
            <p className="text-white text-sm leading-relaxed">
              ...
              consumer units that lack adequate RCD protection. Upgrading to a modern unit with
              RCDs or RCBOs in compliance with BS 7671 is a common job —
              often prompted by a failed EICR or a conveyancing requirement.
            </p>
          </div>
          <div className="rounded-2xl bg-purple-500/10 border border-purple-500/20 p-5">
            <h3 className="font-bold text-white text-lg mb-3">Listed Building Electrical Work</h3>
            <p className="text-white text-sm leading-relaxed">
              Colchester's historic centre has a significant number of listed buildings dating
              from Roman, Norman, and medieval periods. Electrical work on these properties
              requires care to preserve historical fabric. External work requires listed building
              consent. Internal rewiring must avoid damaging original features and fabric.
            </p>
          </div>
          <div className="rounded-2xl bg-amber-500/10 border border-amber-500/20 p-5">
            <h3 className="font-bold text-white text-lg mb-3">EV Charger Installation</h3>
            <p className="text-white text-sm leading-relaxed">
              EV charger installations are growing across Colchester's residential market.
              Home 7kW Type 2 chargers on dedicated circuits with UK Power Networks G98
              notification are the standard installation. New residential developments on the
              town's fringes are required to include EV charger provision under building
              regulations.
            </p>
          </div>
        </div>
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                by a registered competent person or notified to Colchester City Council building
            ...
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Periodic inspection</strong> — BS 7671 Section 631 covers the
                requirements for periodic inspection. Rental properties require an EICR every
                5 years by law.
              </span>
            </li>
          </ul>
      ...
      <>
        <div className="grid gap-4 sm:grid-cols-2 my-4">
          <div className="rounded-2xl bg-blue-500/10 border border-blue-500/20 p-5">
            ...
            <p className="text-white text-sm leading-relaxed">
              Properties within Colchester's Roman walls and medieval town centre, many of which
              are listed. External electrical work requires listed building consent. Solid stone
              or brick walls make internal cable routing more complex. Pre-1980s properties
              should be assessed for asbestos before invasive work.
            </p>
          </div>
          <div className="rounded-2xl bg-green-500/10 border border-green-500/20 p-5">
            <h3 className="font-bold text-white text-lg mb-3">Victorian and Edwardian Terraces</h3>
            <p className="text-white text-sm leading-relaxed">
              Victorian and Edwardian terraced housing in areas like St Botolphs, Greenstead,
              and New Town. Solid brick walls, ageing wiring in many properties. Consumer unit
              upgrades and rewires are common. Solid-wall properties require surface-mounted
              trunking or careful routing through floor voids.
            </p>
          </div>
          <div className="rounded-2xl bg-purple-500/10 border border-purple-500/20 p-5">
            <h3 className="font-bold text-white text-lg mb-3">Post-War and Modern Estates</h3>
            <p className="text-white text-sm leading-relaxed">
              Large post-war and modern estates in areas like Shrub End, Highwoods, and
              Stanway. Cavity wall construction, easier cable access. Older post-war properties
              may have consumer units approaching the end of their life. New-build estates
              have modern wiring and EV charger provision.
            </p>
          </div>
          <div className="rounded-2xl bg-amber-500/10 border border-amber-500/20 p-5">
            <h3 className="font-bold text-white text-lg mb-3">Student and Military HMOs</h3>
            <p className="text-white text-sm leading-relaxed">
              Properties near the University of Essex (Wivenhoe Park) and Colchester Garrison
              let to students and military families. Regular EICRs, fire alarms to BS 5839-6,
              and emergency lighting are required for HMO licensing. A reliable and consistent
              revenue stream for electricians who serve this sector.
            </p>
          </div>
        </div>
      </>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Colchester offers a diverse and interesting workload for electricians — from
          challenging listed building work to volume HMO EICRs, residential rewires, and
          a growing EV charger market. South East rates apply, making it a rewarding area
          for well-qualified practitioners.
        </p>
        <div className="space-y-4 my-4">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  ...
                  on your phone using AI-assisted board scanning. Process high volumes of
                  Colchester landlord EICRs efficiently and issue certificates on site.
                </p>
              </div>
            </div>
          </div>
          <div className="rounded-2xl bg-green-500/10 border border-green-500/20 p-5">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h4 className="font-bold text-white mb-1">Professional Quoting in the South East</h4>
                <p className="text-white text-sm leading-relaxed">
                  Use the{' '}
                  <SEOInternalLink href="/tools/electrical-quoting-app">
                    quoting app
                  </SEOInternalLink>{' '}
                  to send professional PDF quotes from Colchester surveys. Accurate South East
                  rates built in — close jobs faster by quoting on site.
                </p>
              </div>
            </div>
          </div>
        ...
        <SEOAppBridge
          ...
          description="Join 430+ UK electricians using Elec-Mate for cable sizing, professional quoting, and on-site certification. Built for South East electricians working across Essex. 7-day free trial."
          icon={MapPin}
        />
      </>
    ),
...
export default function ElectricianColchesterPage() {
  return (
    <GuideTemplate
      ...
      ctaSubheading="Join 430+ UK electricians using Elec-Mate for cable sizing, quoting, and on-site certification. Built for South East electricians working across Essex. 7-day free trial."
    />
  );
}
