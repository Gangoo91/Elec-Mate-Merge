...
const faqs = [
  ...
  {
    question: 'What are the electrical requirements for the new town housing stock in Stevenage and Welwyn Garden City?',
    answer:
  ...
  {
    question: 'What electrical work is needed for biotech and pharmaceutical facilities in Stevenage?',
    answer:
  ...
  {
    question: 'Are there any areas of Hertfordshire with conservation area restrictions on electrical work?',
    answer:
...
const relatedPages: RelatedPage[] = [
  {
    ...
    description: 'Landlord EICR obligations — mandatory 5-year inspection cycle and tenant requirements.',
    icon: ShieldCheck,
    category: 'Guide',
  },
  {
    ...
    description: 'Find qualified electricians in Maidstone, Canterbury, Tunbridge Wells, and Dover.',
    icon: MapPin,
    category: 'Location',
  },
  {
...
const sections = [
  {
    ...
    content: (
      <>
        <p>
          Hertfordshire is one of the most prosperous counties in the UK, stretching from
          the edge of Greater London north to the Bedfordshire and Cambridgeshire borders.
          Home to over 1.2 million residents, the county combines commuter towns with historic
          market towns, post-war new towns, and a growing life sciences and technology sector.
        </p>
        <p>
          The county presents a remarkably varied market for electrical contractors. In the
          south — St Albans, Watford, Harpenden — large Victorian and Edwardian properties
          create consistent demand for rewires, EICRs, and heritage-sympathetic upgrades.
          In the new towns of Stevenage and Welwyn Garden City, post-war housing stock built
          to the best standards of the 1950s now requires comprehensive electrical modernisation.
          And across the commuter belt as a whole, affluent homeowners drive demand for EV
          charging, solar PV, battery storage, and high-end smart home systems.
        </p>
        <div className="rounded-2xl bg-blue-500/10 border border-blue-500/20 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Always verify competent person scheme registration</strong> before
                booking any electrician — use the NICEIC, NAPIT, or ELECSA online lookup tools.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>UK Power Networks (UKPN)</strong> is the distribution network operator
                for all of Hertfordshire. New connections, upgrades, and renewable energy
                notifications all go through UKPN.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Elec-Mate</strong> helps electricians across Hertfordshire manage
                EICR certificates, EIC documents, and client communications from their phone.
              </span>
            </li>
          </ul>
        </div>
        ...
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-3 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>St Albans</strong> — historic city with Roman heritage and large
                Victorian and Edwardian housing stock. High EICR and rewire demand. Conservation
                area and listed building constraints in the city centre.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <MapPin className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                premises, and retail. Strong demand for commercial electrical work and
                landlord compliance EICRs.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <MapPin className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Stevenage</strong> — first UK new town, now a major employment
                centre. Substantial post-war housing plus the UK biotech cluster around GSK
                and Roche, driving commercial and specialist electrical demand.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <MapPin className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Hemel Hempstead</strong> — new town with large industrial areas
                and residential estates from the 1950s and 1960s requiring electrical upgrades.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <MapPin className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Welwyn Garden City</strong> — second garden city, built 1920s onwards.
                Mix of inter-war and post-war housing with a large industrial and commercial
                estate. Growing demand for EV charging at commercial sites.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <MapPin className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                defence and aerospace heritage. Modern business park electrical work plus
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Under Part P of the Building Regulations, electrical work in domestic premises must
          either be carried out by a competent person registered with an approved scheme, or
          be notified to and inspected by building control. There is no legal requirement for
          a homeowner to check qualifications before booking — but doing so protects both
          ...
          <ul className="space-y-3 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                UKAS-accredited competent person scheme. Verify the registration number on
                the scheme website before work starts.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
            ...
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                Confirm they hold public liability insurance — minimum £2 million, and
                £5 million for larger or more complex projects.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                For commercial or specialist work (laboratories, cleanrooms, data centres),
                ask for specific experience and references from similar projects.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Hertfordshire sits in the South East premium band for labour costs, reflecting
          high land values, strong local demand, and competition for skilled tradespeople
          from London-based employers. Costs are typically 15% to 25% above the national
          average, with the highest rates in St Albans, Harpenden, and the Welwyn Garden
          City commuter corridor.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          ...
          <ul className="space-y-3 text-white">
            <li className="flex items-start gap-3">
              ...
              <span><strong>EICR (3-bed house):</strong> £180 to £300</span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span><strong>Consumer unit upgrade:</strong> £520 to £800</span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span><strong>Full rewire (3-bed semi):</strong> £4,500 to £7,200</span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span><strong>EV charger installation:</strong> £850 to £1,350</span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span><strong>Smart home electrical fit-out:</strong> £1,500 to £6,000+</span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span><strong>Solar PV electrical connection (4kWp system):</strong> £600 to £1,000</span>
            </li>
          </ul>
        </div>
        <p>
          Always obtain at least three written quotes for larger jobs. Quotes should itemise
          labour, materials, certification costs, and any building control notification fees.
        </p>
      </>
    ),
  },
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                Properties from 1860 to 1918 typically have lath-and-plaster walls, suspended
                timber floors, and original or post-war rewires using rubber-insulated conductors.
                EICRs on these properties almost invariably identify multiple C2 and C3 observations,
                with full rewires the most common recommendation.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Building2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>New town stock (Stevenage, Hemel Hempstead, Welwyn Garden City, Hatfield):</strong>{' '}
            ...
            <li className="flex items-start gap-3">
              <Building2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Modern estates and executive homes:</strong> Properties from the 1990s
                and 2000s typically have adequate wiring but are increasingly in demand for
                upgrades to accommodate EV charging, solar PV, battery storage, and smart home
                systems. RCBO consumer unit upgrades to accommodate additional circuits are common.
              </span>
            </li>
          </ul>
        </div>
          ...
          <ul className="space-y-3 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                every five years for all private rental properties in Hertfordshire. Landlords
                must provide tenants with a copy of the EICR within 28 days of the inspection.
                Use the{' '}
    ...
    content: (
      <>
        <p>
          ...
          Hertfordshire, along with South East England and the East of England. Electricians
          working in Hertfordshire need to be familiar with UKPN's processes for connection
          applications, supply upgrades, and renewable energy notifications.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>New connections:</strong> Apply via ukpowernetworks.co.uk for new
                electrical connections or supply capacity increases. New town commercial sites
                and housing developments require connection agreements in advance of work.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                up to 3.68kW per phase can be notified to UKPN under G98 after installation.
                Systems above this threshold require G99 application and prior approval.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Earthing arrangements:</strong> Most urban Hertfordshire properties
                are connected to the UKPN TN-C-S (PME) network. Rural properties and some
                older properties in the new towns may be TT earthed — always verify before
                carrying out earthing work under BS 7671 Regulation 542.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Power cuts:</strong> Report power cuts and emergencies in Hertfordshire
                by calling 105 — the national power cut number for all UK DNOs.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Hertfordshire offers strong earning potential for electricians willing to invest
          in qualifications and specialisms beyond standard domestic work. The biotech and
          technology sector, combined with the affluent commuter belt, creates demand for
          specialist skills that command premium rates.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                rates of EV ownership in the UK. OZEV-approved installer status (previously
                OLEV) is essential to access grant-funded installations. Demand across both
                domestic and commercial sites is strong.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Wrench className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                Hertfordshire market has strong solar PV demand. MCS accreditation allows
                customers to access the Smart Export Guarantee (SEG) — without it you cannot
                install MCS-compliant systems.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Wrench className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
