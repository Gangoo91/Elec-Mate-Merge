...
const relatedPages: RelatedPage[] = [
  {
    ...
    description: 'ATEX Zone 0/1/2 on oil and gas platforms, BOSIET training, and day rates £400–£700.',
    icon: Zap,
    category: 'Guide',
  },
  {
...
const sections = [
  {
    ...
    content: (
      <>
        <p>
          Petrochemical electrical installation encompasses electrical work on refineries,
          chemical plants, petroleum storage facilities, LNG terminals, and associated
          infrastructure. It is one of the most technically demanding and highly regulated
          areas of industrial electrical engineering in the UK — and one of the best paid.
        </p>
        <p>
          The fundamental challenge of petrochemical electrical installation is the presence
          of flammable and explosive substances throughout the plant. Hydrocarbons, solvents,
          gases, and in some cases dusts create potentially explosive atmospheres across large
          parts of the facility. Every electrical decision — equipment selection, cable routing,
          earthing, protection — must account for the hazardous area classification of the
          area in which the work is carried out.
        </p>
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                Stanlow Refinery (Essar) in Cheshire, and the major chemical manufacturing
                complexes at Teesside and Merseyside provide the majority of petrochemical
                electrical contractor demand in the UK.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                contractor work is concentrated in planned shutdowns and turnarounds, when
                plant is taken offline for major inspection and maintenance. These intensive
                periods involve large numbers of contractors working around the clock to
                complete the work within the planned outage window.
              </span>
            </li>
          </ul>
        </div>
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                flammable gas, vapour, or mist is present continuously or for long periods.
                Zone 0 locations include the interior of storage tanks, process vessels, and
                pipework. Category 1G (Ga) equipment required. Very few electrical devices
                are installed in Zone 0 — instrumentation such as level transmitters is the
                main exception.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-red-400 mt-0.5 shrink-0" />
              <span>
                <strong>Zone 1</strong> — an explosive gas atmosphere is likely to occur in
                normal operation. Typical Zone 1 locations include pump sumps, drain pits,
                areas within 1.5m of process flanges and valve glands, and the process deck
                area. Category 2G (Gb) equipment required. This is where the majority of
                petrochemical Ex electrical equipment is installed.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-red-400 mt-0.5 shrink-0" />
              <span>
                <strong>Zone 2</strong> — an explosive gas atmosphere is unlikely to occur in
                normal operation but may occur in abnormal conditions. Zone 2 typically extends
                3–5m from Zone 1 sources, and covers areas such as the wider process deck,
                pipe racks with potential for leakage, and areas below Zone 1 where heavier-
                than-air gases can accumulate. Category 3G (Gc) or better required.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-red-400 mt-0.5 shrink-0" />
              <span>
                <strong>DSEAR Explosion Protection Document</strong> — employers must produce
                and maintain an Explosion Protection Document (EPD) that records the zone
                classification, equipment selection criteria, personnel requirements, and
                overall explosion protection strategy. The EPD must be reviewed when plant
                or processes change significantly.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          The IEC 60079 series of standards defines the protection concepts (Ex types) that can
          be used to make electrical equipment safe for use in explosive atmospheres. Understanding
          the operating principle, application, and installation requirements of each protection
          concept is essential for CompEx-certified petrochemical electricians.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Ex d — flameproof enclosure (IEC 60079-1)</strong> — the enclosure
                is designed to contain an internal ignition and cool the products of combustion
                before they escape through gaps and joints. Used for motors, switchgear, and
                junction boxes in Zone 1 and Zone 2. Heavy, robust construction. Flameproof
                joints and thread engagements must be maintained — damaged flanges cannot
            ...
            <li className="flex items-start gap-3">
              <ClipboardCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Ex e — increased safety (IEC 60079-7)</strong> — additional measures
                are applied to equipment that does not normally produce sparks or hot surfaces
                to prevent ignition of the surrounding atmosphere. Applies to terminal boxes,
                luminaires, and motors in Zone 1 and Zone 2. Lighter than Ex d. Terminal
                tightening torques and creepage/clearance distances are critical.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ClipboardCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Ex ia/ib — intrinsic safety (IEC 60079-11)</strong> — the energy
                in the circuit is limited to levels that cannot ignite the explosive
                atmosphere under defined normal and fault conditions. Ex ia (two fault
                tolerance) is the only protection concept suitable for Zone 0. Used
                exclusively for instrumentation and control systems. Associated apparatus
                (barriers, galvanic isolators) must be correctly selected and entity
                parameters matched.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ClipboardCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Ex m — encapsulation (IEC 60079-18)</strong> — components that
                could cause ignition are encapsulated in a compound that excludes the
                explosive atmosphere. Used for certain instrumentation, solenoid valve
                coils, and electronic modules. No maintenance is possible on the
                encapsulated components — replacement of the complete unit is required
                on failure.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ClipboardCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Ex n / Ex ec — non-sparking (IEC 60079-15)</strong> — simplified
                protection for Zone 2 only. The equipment is designed to not produce sparks
                or hot surfaces capable of igniting a Zone 2 atmosphere under normal
                operating conditions. Lighter and less expensive than Zone 1 protection
                concepts. Common for Zone 2 luminaires and small motors.
              </span>
            </li>
          </ul>
        </div>
        ...
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>What they show</strong> — area classification drawings show the
                boundaries of Zone 0, Zone 1, and Zone 2 areas on plan and elevation views.
                Zone boundaries are shown as dashed or coloured lines with the zone
                designation clearly marked. The drawings also identify the source of
                hazardous release (grade of release) that defines each zone.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>How they are used</strong> — before selecting or installing any
                electrical equipment on a petrochemical site, the electrician or engineer
                must consult the area classification drawings to determine the zone
                applicable to the intended equipment location. Equipment must be certified
                for the zone in which it is installed — installing Zone 2 equipment in a
                Zone 1 area is non-compliant and potentially dangerous.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Maintaining drawings</strong> — area classification drawings must
                be updated when plant layout, process conditions, or substance inventories
                change. Out-of-date drawings present a serious hazard — equipment may have
                been installed to the wrong zone specification. Document control is a
                critical aspect of area classification management.
              </span>
            </li>
          </ul>
        </div>
        ...
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Gas groups</strong> — Group IIA covers propane, acetone, and most
                common hydrocarbons (minimum ignition energy &gt;180µJ). Group IIB covers
                ethylene and hydrogen sulphide (45–180µJ). Group IIC covers hydrogen and
                acetylene (&lt;45µJ) and requires the most stringent equipment. Equipment must
                be rated for the same or a higher gas group than the hazardous substance
                on site.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                through T6 (85°C). The temperature class must be below the auto-ignition
                temperature (AIT) of the flammable substance by an appropriate margin.
                For petrol (AIT ~280°C), T3 equipment (200°C surface temperature) is
                appropriate. For hydrogen sulphide (AIT 260°C), T3 or T4 is required.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Building2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Equipment Protection Level (EPL)</strong> — Ga, Gb, Gc (for gas zones)
                or Da, Db, Dc (for dust zones). EPL must match or exceed the zone requirement:
                Ga for Zone 0, Gb or Ga for Zone 1, Gc or better for Zone 2.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          BS EN 60079-17 (the UK adoption of IEC 60079-17) is the standard for the inspection
          and maintenance of electrical installations in explosive atmospheres. It is mandatory
          reading for anyone responsible for maintaining Ex electrical equipment on petrochemical
          sites, and CompEx ExM units are based directly on its requirements.
        </p>
        <div className="rounded-2xl bg-blue-500/10 border border-blue-500/20 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              <ClipboardCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Grade 1 — Visual inspection</strong> — a check for obvious defects
                without the need to open equipment or use tools. Checks include: enclosure
                integrity (no cracks or damage), all bolts present and tightened, cable
                entry condition, no unauthorised modifications, warning labels in place, and
                equipment type and marking match the area classification. This grade can be
                performed by persons with basic Ex awareness.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ClipboardCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Grade 2 — Close inspection</strong> — all visual inspection checks
                plus opening the equipment (where it can be done safely without live work)
                to check internally. Checks include: internal condition (moisture, damage,
                contamination), correct cable type and cross-sectional area, correct gland
                type and installation, correct terminal tightening, and earth continuity.
                Requires CompEx-qualified personnel.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ClipboardCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Grade 3 — Detailed inspection</strong> — all close inspection checks
                plus more detailed examination including verification against certification
                documents, measurement of Ex d flameproof gaps, insulation resistance
                testing, verification of intrinsically safe circuit entity parameters, and
                earth loop impedance testing. Requires competent CompEx-qualified personnel
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                typically one to three years for Zone 1 and Zone 21 equipment, and three years
                for Zone 2 and Zone 22. The interval can be extended based on the results of
                initial inspections. All inspection findings must be formally recorded and
                defects formally managed through a corrective action process.
              </span>
            </li>
          </ul>
        </div>
    ...
    content: (
      <>
        ...
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>CompEx Foundation (ExI01–ExI04)</strong> — covers the fundamentals
                of explosive atmospheres, zone classification, Ex d flameproof, Ex e increased
                safety, and Ex i intrinsic safety installation. This is the minimum requirement
                for most petrochemical installation roles. Typically delivered as a five-day
                course with practical and written assessments.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                electricians on petrochemical sites. Covers inspection grades, inspection
                records, and corrective action management.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>CompEx Dust (ExD units)</strong> — covers dust zone classification
                and equipment selection for Zones 20, 21, and 22. Relevant for petrochemical
                sites with solid catalyst handling, powder processing, or other combustible
                dust risks.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Reassessment every five years</strong> — CompEx certification must
                be renewed by reassessment every five years. The reassessment demonstrates
                that the candidate has maintained their competence and is aware of any changes
                to the standards and regulations since their previous assessment.
              </span>
            </li>
          </ul>
        </div>
        <p>
          ...
          Self-employed contractors earn £40 to £65 per hour, with higher rates during
          shutdown and turnaround periods when demand peaks.
        </p>
      </>
    ),
  },
        ...
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Electrical isolation</strong> — all electrical work on live or
                potentially live circuits requires a formal isolation and lock-off procedure.
                The PTW specifies the isolation points, the lock-off procedure, and the
                verification testing required to confirm the system is dead before work
                commences. Isolation is typically achieved by a person authorised by the
                duty holder.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                — angle grinding, welding, use of non-Ex tools — in or near hazardous areas
                requires a hot work permit in addition to the standard electrical PTW. Hot
                work permits require gas testing before commencement and a fire watch during
                and after the work.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                <strong>Confined space permits</strong> — working inside process vessels,
                tanks, or enclosed spaces (even without an active explosive atmosphere risk)
                requires a confined space entry permit. Many petrochemical electrical tasks
                involve cable pulling or equipment installation in confined spaces.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Petrochemical electrical work is financially rewarding, technically interesting, and
          in sustained demand from UK refineries, chemical plants, and the energy transition
          sector. CompEx certification is the essential first step.
        </p>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  ...
                  petrochemical operator or principal contractor will engage you for hazardous
                  area electrical work. Add ExM01–ExM04 if you are targeting maintenance roles.
                  Register with petrochemical electrical specialist agencies — most major UK
                  refineries use a small number of specialist contractors for shutdown work.
                </p>
              </div>
            </div>
          </div>
          <div className="rounded-2xl bg-blue-500/10 border border-blue-500/20 p-5">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  CompEx requires five-yearly reassessment. 18th Edition must be renewed.
                  Use{' '}
                  <SEOInternalLink href="/tools/eicr-certificate">
                    Elec-Mate
                  </SEOInternalLink>{' '}
                  to track all your certifications and renewal dates, and to produce professional
                  test records and inspection reports that meet the documentation standards
                  expected on petrochemical sites.
                </p>
              </div>
            </div>
          </div>
        ...
        <SEOAppBridge
          ...
          description="Track CompEx, 18th Edition, and all petrochemical certifications with renewal reminders. Produce professional inspection records. Join 430+ UK electricians using Elec-Mate. 7-day free trial."
          icon={ShieldCheck}
        />
      </>
    ),
