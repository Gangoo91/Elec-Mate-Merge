...
const sections = [
    ...
    content: (
      <>
        <p>
          ...
          and condition of the fixed electrical installation in an existing building. Conducted by a
          qualified and competent electrician, it combines visual inspection with a structured
        ...
        <div className="rounded-2xl bg-blue-500/10 border border-blue-500/20 p-6 my-4">
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Outcome</strong> — the EICR states Satisfactory or Unsatisfactory, lists all
                observations with code classifications, and recommends the next inspection date.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Reading landlords are subject to the English regulatory framework for electrical safety in
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                tenants within 28 days and to Reading Borough Council within seven days if
                requested.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                not providing it to the tenant, not completing remedial work) constitutes a separate
          ...
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                EICR Unsatisfactory and typically requiring a full consumer unit upgrade.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Building2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                wired but older examples from the 1990s and early 2000s may have partial RCD
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                there may be brief power interruptions during circuit testing.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Clock className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                conductors, and any external or garden installations.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Clock className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                units and fire alarm systems: four to seven hours or more.
              </span>
            </li>
          </ul>
        </div>
          ...
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                Common in Reading: absence of RCD protection, degraded rubber wiring, inadequate
                earthing or bonding.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                standards but is not a safety hazard. Does not make the EICR Unsatisfactory on its
                own.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                properly assessed without further investigation. Makes the EICR Unsatisfactory until
    ...
    content: (
      <>
        <p>
          ...
          outside of London. Reading sits firmly in the commuter belt and rates are typically 15 to
          25 per cent higher than the Midlands average.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                testing qualifications. Registration confirms qualifications, insurance, and ongoing
                technical assessment by the scheme.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Search className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                quotes that are either unrealistically cheap (suggesting inadequate inspection) or
                inflated.
              </span>
            </li>
          </ul>
