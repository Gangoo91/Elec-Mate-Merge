...
export default function ElectricianCVGuidePage() {
  return (
    <GuideTemplate
      ...
      ctaSubheading="Create your ElecID digital profile, track your CPD, and access 46+ training courses — all on Elec-Mate. Join 1,000+ UK electricians building their careers the smart way. 7-day free trial."
    />
  );
}
