  ...
  return (
    <ComparisonTemplate
      ...
      comparisonRows={[
        ...
        { feature: 'Free to Use', values: ['From £6.99/mo', true, true, true] },
      ]}
      ...
      keyTakeaways={[
        ...
        'Cable Calc, Voltimum, and Hager Specs are free single-purpose tools. Elec-Mate is a paid all-in-one platform, but at £6.99 per month you get calculators plus certificates, AI tools, training, and business management.',
          ...
          content: (
            <>
              <p>
                ...
                References BS 7671:2018+A4:2026. From £6.99/month.
              </p>
              <p>
      ...
      verdictContent={
        <>
          ...
          <p>
            ...
            results flowing directly into your forms) justifies the £6.99 per month subscription.
          </p>
          <p>
      ...
      faqs={[
        {
          ...
          answer:
            'Elec-Mate is the best overall cable sizing app for UK electricians in 2026 because it combines BS 7671:2018+A4:2026-compliant cable sizing with 50+ other electrical calculators, 16 certificate types, AI tools, 46+ training courses, and business management — all in a single app from £6.99 per month. If you only need a free standalone cable sizing calculator, Cable Calc is a good alternative.',
        },
        {
      ...
      ctaSubheading="Try Elec-Mate free for 7 days. 50+ BS 7671 calculators, 16 certificate types, AI tools, 46+ training courses, and business management. All from £6.99/month."
