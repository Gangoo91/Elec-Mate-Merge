...
export default function PPEForElectriciansPage() {
  return (
    <GuideTemplate
      ...
      description="Electrical PPE for live and dead working: insulating gloves to BS EN 60903, arc flash categories, BS EN 60900 tools, boots, eye and head protection."
      ...
      ctaSubheading="Join 1,600+ UK electricians using Elec-Mate for AI risk assessments, RAMS generation, site safety tools, and training courses. PPE requirements are built into every assessment. 7-day free trial, cancel anytime."
    />
  );
}
