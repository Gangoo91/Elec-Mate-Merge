...
const sections = [
  {
    ...
    content: (
      <>
        <p>
          The Electrical Safety Standards in the Private Rented Sector (England) Regulations 2020
          are the primary legislation governing landlord electrical safety obligations in Exeter and
          across Devon. These regulations came into force on 1 June 2020 for new tenancies and 1
          April 2021 for all existing tenancies. Every private landlord in Devon must comply, from
          city-centre student HMOs to rural farmhouse lettings.
        </p>
          ...
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                Prospective tenants can request a copy within 28 days of asking.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Scale className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                ...
                EICR to the relevant local council within seven days if requested. In Exeter this
                means Exeter City Council; in the wider county, the relevant Devon district council.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Scale className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Exeter City Council is the local housing authority responsible for enforcing the 2020
          Regulations within Exeter. The council's environmental health and housing standards team
          handles private rented sector complaints and HMO licensing inspections. Beyond the city
          boundary, Devon's district councils — East Devon, Mid Devon, Teignbridge, Torridge, North
          Devon, West Devon, and South Hams — are each responsible for enforcement in their areas.
        </p>
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                inspections, and issues civil penalties for non-compliance. The concentration of
                student HMOs around the University of Exeter makes electrical safety a significant
                enforcement priority within the city.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Building2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                renew a licence where an EICR cannot be provided and can revoke a licence for
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                actively supports students with housing concerns and refers non-compliant landlords
                to the council's environmental health team.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Building2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                can report non-compliant landlords to their local district council. While
                enforcement capacity varies across Devon's districts, all have powers to impose
        ...
        <p>
          Exeter and Devon landlords should maintain clear EICR records for every property in their
          portfolio. The relevant council can request these documents at any time, and absence of a
          valid EICR is treated as evidence of non-compliance.
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>
          Exeter has a substantial HMO market driven primarily by the University of Exeter, with
          some of England's highest student satisfaction ratings and a growing student population.
          Student accommodation is concentrated in areas including St Thomas, Heavitree,
          Pennsylvania, and around the Streatham campus. Most shared student houses qualify as HMOs
          requiring licensing.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                concentrations. Landlords should check with the council whether their property falls
                within an additional licensing area and what conditions apply.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Users className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                your HMO licence certificate. Properties that have received Unsatisfactory EICRs may
                face more frequent inspection requirements.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Users className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                work well before the new term begins.
              </span>
            </li>
          </ul>
        </div>
        <p>
          Operating an unlicensed HMO in Exeter is a criminal offence with an unlimited fine on
          conviction, in addition to any civil penalties under the electrical safety regulations.
          Exeter City Council actively investigates unlicensed HMOs.
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>
          Beyond Exeter, Devon's private rental market spans coastal towns, market towns, rural
          villages, and the South Devon Riviera resorts of Torquay, Paignton, and Brixham. Each area
          has its own mix of property ages, tenant demographics, and local authority enforcement
          approaches.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                let conversions and long-term residential tenancies. Victorian and Edwardian seaside
                boarding houses converted to flats are common and frequently present EICR challenges
                similar to urban terraced housing.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Building2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                require specific testing and verification of the earth electrode resistance (RN) and
                the installation of RCD protection for all circuits. Landlords of rural properties
                should ensure their EICR inspector has specific experience with TT systems.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Building2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                with properties in remote locations should factor this into their budget and allow
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                Exeter, all councils have the same powers and the same maximum penalty of £30,000
                per breach. Non-compliance in rural Devon is not safer than non-compliance in
                Exeter.
              </span>
            </li>
          </ul>
        ...
        <p>
          Landlords with properties across multiple Devon district council areas should maintain
          separate compliance records for each property and ensure they understand which local
          authority to supply EICR documentation to for each one.
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>
          The 2020 Regulations give local authorities the power to impose civil penalties of up to
          £30,000 per breach. Non-compliance creates multiple distinct obligations, each capable of
          attracting its own penalty. Exeter and Devon landlords with multiple non-compliant
          properties face significant cumulative exposure.
        </p>
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                to complete remedial work within 28 days are each separate breaches with their own
                potential penalty.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-red-400 mt-0.5 shrink-0" />
              <span>
                <strong>HMO licence consequences</strong> — Exeter City Council can refuse to renew
                or revoke an HMO licence for persistent non-compliance with electrical safety
                conditions. For Exeter student landlords, licence revocation during an active
                tenancy cycle can mean significant financial disruption.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-red-400 mt-0.5 shrink-0" />
              <span>
                ...
                This applies equally to Exeter student lets and rural Devon tenancies.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-red-400 mt-0.5 shrink-0" />
              <span>
                <strong>Remedial action at landlord's cost</strong> — where a landlord fails to
                comply with a remedial notice, the council can arrange for the work to be carried
                out and recover costs from the landlord. This power exists alongside the civil
                penalty regime and can result in significant additional expenditure.
              </span>
            </li>
          </ul>
        </div>
        <p>
          A Devon EICR every five years — typically £120 to £300 in the region — is modest compared
          to the maximum penalties. Exeter and Devon landlords should treat electrical safety
          compliance as a non-negotiable operating cost.
        </p>
      </>
    ),
  },
    ...
    content: (
      <>
        <p>
          ...
          Regulations regarding electrical safety in their rented property. This includes university
          students, coastal town residents, and rural tenants in villages across the county.
        </p>
        <div className="rounded-2xl bg-blue-500/10 border border-blue-500/20 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                Request the EICR in writing from your Exeter landlord or letting agent before
            ...
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Right to report non-compliance</strong> — if your Exeter landlord cannot
                provide a valid EICR, report this to Exeter City Council's environmental health team
                (or the relevant Devon district council if outside the city). The University of
                Exeter Students' Guild can also assist students with housing complaints.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                ...
                must not be charged for remedial work arising from electrical safety compliance.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
        ...
        <p>
          Exeter and Devon tenants can seek advice from Citizens Advice Devon, Shelter, or their
          local council's housing team. The University of Exeter Students' Guild has a dedicated
          advice and support service for student tenants experiencing housing issues in the city.
        </p>
      </>
    ),
  },
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                starts from the date of the inspection, not when the report arrives.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Clock className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                observations as urgent and arrange emergency remedial work as soon as possible,
                particularly in rural areas where electrician availability may be limited.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Clock className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                the tenant and to the relevant council within 28 days of the work being completed.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Clock className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                consumer unit replacement, earthing conductor upgrades, main protective bonding
                installation, replacement of deteriorated cables, and earth electrode verification
                and improvement in rural TT properties.
              </span>
            </li>
          </ul>
        </div>
        <p>
          Exeter landlords should maintain relationships with reliable local electricians who can
          respond quickly when remedial work is required. Rural Devon landlords should identify
          qualified electricians in their area in advance rather than searching when work is
          urgently needed.
        </p>
      </>
    ),
    ...
    content: (
      <>
        <p>
          ...
          availability may be more limited and some inspectors may charge travel costs for remote
          properties. Booking well in advance is advisable, particularly for student property
          inspections in May to August.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                (C&G 2382 18th Edition). For rural Devon properties, experience with TT earthing
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                agricultural supplies, and the older electrical installations common in Devon
                farmhouses and converted rural properties.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Search className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                for remedial work before September tenancy starts.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Exeter and Devon EICR costs are broadly in line with the South West of England — generally
          below the national average. Rural Devon properties may attract travel surcharges, and
          properties with complex or aged electrical installations cost more to inspect thoroughly.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
    ...
    content: (
      <>
        <p>
          ...
          create varied and consistent demand for landlord EICRs across the county. Electricians who
          build relationships with Exeter letting agents or develop a rural Devon portfolio can
          generate reliable annual income from EICR contracts and the remedial work that follows
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  ...
                  to complete the full report on your phone while still on site in Exeter or rural
                  Devon. AI board scanning, voice test entry, and instant PDF export mean the
                  landlord has their report before you leave. Particularly valuable for rural Devon
                  jobs where you might be far from your office.
                </p>
              </div>
            </div>
          </div>
...
export default function LandlordElectricalSafetyExeterPage() {
  return (
    <GuideTemplate
      title="Landlord Electrical Safety Exeter: EICR Devon"
