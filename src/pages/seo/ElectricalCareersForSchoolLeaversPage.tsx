...
const keyTakeaways = [
  ...
  'Apprentice electricians in England earn at least the apprentice minimum wage (£8.00/hour from 1 April 2026), but many employers pay more — typically £15,000 to £20,000 in the first year, rising each year.',
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'Apprentice electricians are entitled to at least the apprentice minimum wage, which is £8.00 per hour from 1 April 2026. However, many employers pay significantly more, especially after the first year. The JIB (Joint Industry Board) sets higher graded rates for electrical apprentices — £8.16 to £14.03 per hour by stage in 2026. Typical apprentice pay ranges are: Year 1: £15,000-£18,000, Year 2: £16,000-£21,000, Year 3: £19,000-£25,000, Year 4: £22,000-£28,000. London and the South East tend to pay higher rates. Some employers also provide a van, tools, or a tool allowance. Remember that as an apprentice, you are earning while others your age are paying for university — and you will have no student debt when you qualify.',
  },
  {
