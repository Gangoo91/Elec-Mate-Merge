...
export default function ElectricianHarrogatePage() {
  return (
    <GuideTemplate
      noindex={true}
      localArea="Harrogate"
      title="Electrician in Harrogate: Local Electricians"
      ...
      ctaSubheading="Join 1,600+ UK electricians using Elec-Mate for cable sizing, quoting, and on-site certification. Built for electricians working across Harrogate and North Yorkshire. 7-day free trial."
    />
  );
}
