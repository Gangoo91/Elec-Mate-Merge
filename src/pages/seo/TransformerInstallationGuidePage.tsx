...
const faqs = [
  {
    question:
      'What is the difference between an isolation transformer and a step-down transformer?',
    answer:
...
const relatedPages: RelatedPage[] = [
  ...
  },
  {
    ...
    description:
      'Complete EICs on your phone and export PDF instantly for transformer installations.',
    icon: FileCheck2,
...
const sections = [
    ...
    content: (
      <>
        <p>
          ...
          installations in the UK must comply with BS EN 61558 (small power transformers) or BS EN
          60076 (power transformers above 1 kVA) and with BS 7671 or BS EN 61936-1 for the
          associated electrical installation. The principal types encountered in UK electrical work
          are as follows.
        </p>
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                pump rooms, IT systems requiring floating earth, and where safety isolation from the
                earthed supply system is needed.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                ...
                60742), 11 kV to 400 V distribution transformers for LV supply, 33 kV to 11 kV for
            ...
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Autotransformers</strong> — single winding with a tapping point. Smaller and
                cheaper than double-wound transformers for the same rating, but provide no galvanic
                isolation. Used in star-delta motor starters, voltage regulators, and some HVAC
                equipment. Not permitted where isolation is required.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                ...
                rated from 100 kVA to 3 MVA or more. Either oil-filled or dry-type. Installed in a
                dedicated transformer chamber or outdoor compound.
              </span>
            </li>
          </ul>
        </div>
    ...
    content: (
      <>
        <p>
          ...
          installation environment. Installations above 1 kV must comply with BS EN 61936-1 (Power
          installations exceeding 1 kV AC). LV transformer installations are covered by BS 7671. The
          critical installation parameters are ventilation, clearances to live parts, and fire
          containment for oil-filled units.
        </p>
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                transformer loading. Ventilation openings must be protected against entry of vermin
                and insects without significantly restricting airflow.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Building2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                phase-to-earth, 160 mm phase-to-phase in accordance with BS EN 61936-1 Table 1 for
                internal installations. HV terminals must be inaccessible to unauthorised persons —
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                constructed with walls, floor, and ceiling of minimum 2 hours fire resistance. An
                oil retention sump (bund) must be provided under and around the transformer, sized
                to contain 100% of the transformer oil volume. Drainage from the sump should go to
                an oil separator, not directly to a surface water drain.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Building2 className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                document system (permit to work) must be in place before any work is carried out
                near HV equipment. Earthing facilities (earthing sticks) must be provided for safely
                earthing isolated conductors.
              </span>
            </li>
          </ul>
        </div>
    ...
    content: (
      <>
        <p>
          ...
          decisions in transformer specification. Both types are available from approximately 100
          kVA to several MVA. The correct choice depends on the installation environment, fire risk,
          maintenance capability, and lifetime cost.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Oil-filled (ONAN/ONAF)</strong> — mineral oil provides both insulation and
                cooling. Lower purchase cost for equivalent rating, lower no-load losses, proven
                long service life (30+ years with proper oil maintenance). Requires fire
                containment, periodic oil sampling, and disposal of condemned oil to licensed waste
                contractor. Preferred for outdoor substations and large indoor installations where
                fire containment can be provided economically.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Thermometer className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Dry-type (AN/AF, cast resin)</strong> — epoxy resin or open-wound dry coils,
                cooled by air. No oil, no fire hazard, no bund required. Preferred for indoor urban
                buildings, hospitals, shopping centres, and high-rise buildings where oil storage is
                not permitted. Higher purchase cost than oil-filled equivalent. Less tolerant of
                overloading (no oil thermal buffer). Cast resin type has excellent moisture
                resistance.
              </span>
            </li>
            <li className="flex items-start gap-3">
        ...
        <p>
          ...
          increasingly specified to simplify planning consent and reduce the cost and complexity of
          fire containment. Consult with the building insurer before specifying the transformer type
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                approximately 1 MVA) or HV circuit breakers with overcurrent and earth fault relays
                (for larger transformers) protect the primary winding. Fuses are sized to the
                transformer rated primary current, allowing for magnetising inrush (typically 10–12
                times rated current for 100 ms) without blowing. Coordinate with the DNO's
            ...
            <li className="flex items-start gap-3">
              <Shield className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>LV secondary protection</strong> — the main LV circuit breaker (ACB or MCCB)
                on the secondary side protects the transformer from secondary faults and overload.
                Sized to the transformer rated secondary current. Must have a breaking capacity
                sufficient to interrupt the maximum prospective short-circuit current at the LV
                terminals (can be very high — 50 kA or more for large transformers on a stiff HV
                supply).
              </span>
            </li>
            <li className="flex items-start gap-3">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                (WTI) and oil temperature indicators (OTI) provide alarm and trip signals at preset
                temperatures (typically alarm at 100°C, trip at 115°C for oil-filled). Dry-type
                transformers use PT100 or thermistor sensors embedded in the windings.
              </span>
            </li>
          </ul>
        </div>
    ...
    content: (
      <>
        <p>
          ...
          transformer installations to the distribution network. Failure to notify can result in the
          connection being refused, the installation having to be modified, or the customer being
          disconnected. The relevant Engineering Recommendations (ERs) are published by the Energy
        ...
        <div className="rounded-2xl bg-blue-500/10 border border-blue-500/20 p-6 my-4">
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>HV supply connections</strong> — connecting a private HV/LV transformer to
                the DNO's HV network always requires a formal connection agreement. The DNO
                specifies the metering arrangement (typically at HV), protection relay settings, and
                earthing requirements. The site HV switchgear must meet DNO specifications.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                Plan well in advance and submit the application as early in the project as possible
                to avoid programme delays.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          A new transformer must be tested before energisation to verify it has not been damaged in
          transit, is correctly installed, and its protection systems are functional. Commissioning
          tests are carried out by the transformer manufacturer's representative or by a specialist
          high-voltage testing contractor. An Electrical Installation Certificate is required for
          the associated LV installation work.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                (transformer turns ratio) meter applied to each phase. Result should be within ±0.5%
                of nameplate ratio. Incorrect ratio indicates a winding fault or incorrect tap
                position.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                30° lag). Incorrect vector group causes circulating currents and potential damage if
                the transformer is paralleled with another unit.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Settings className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                gap. Low dielectric strength indicates moisture or contamination in the oil — oil
                must be filtered or replaced before energisation.
              </span>
            </li>
          </ul>
        </div>
    ...
    content: (
      <>
        <p>
          ...
          Regulations 1989 require that electrical systems are maintained to prevent danger. The
          specific maintenance requirements depend on the transformer type.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                cable boxes and glands, operation of temperature indicators, and Buchholz relay
                (oil-filled). Record and act on all defects found.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Settings className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                tension. DGA results interpreted against IEC 60599 (Guide to the Interpretation of
                Dissolved and Free Gases Analysis) to identify developing faults.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Settings className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                before they cause failures. Requires the transformer to be loaded to at least 70% of
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                settings match the protection coordination study. Buchholz relay float test. Winding
                temperature relay simulation test.
              </span>
            </li>
          </ul>
        </div>
    ...
    content: (
      <>
        <p>
          ...
          conductor sizing, cable installations, and protective device installation — requires an
          Electrical Installation Certificate under BS 7671. HV work on the transformer itself
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  ...
                  Installation Certificate on your phone. Record insulation resistance values, earth
                  conductor details, prospective fault current, and protective device ratings — then
                  export the PDF certificate before leaving site.
                </p>
              </div>
            </div>
          </div>
