...
const keyTakeaways = [
  'Electrical symbols in the UK follow IEC 60617 (graphical symbols for diagrams). BS EN 60617 has been withdrawn and replaced by IEC 60617 (BS 7671:2018+A4:2026, Reg 710.512.2.1 note). Symbols are used on circuit diagrams, installation drawings, and electrical certificates.',
  ...
  'Socket symbols use a semicircle standing on a baseline. The number of strokes drawn inside the semicircle is the number of outlets: one stroke for a single socket, two for a double. The semicircle itself does not change.',
  'Protection device symbols differentiate between fuses, MCBs, RCDs, RCBOs, AFDDs, and SPDs. Each has a distinct symbol that shows its operating principle.',
  'Elec-Mate draws on IEC 60617 for the circuit diagrams, distribution board schedules and certificates generated by the app. Symbols on installation plans and on circuit diagrams are drawn differently — always check a drawing against its own legend before relying on it.',
];
...
const faqs = [
  {
    ...
    answer:
      'Electrical symbols in the UK are defined by IEC 60617 (Graphical symbols for diagrams). BS EN 60617, the former European harmonised version, has been withdrawn and replaced by IEC 60617 — as noted in BS 7671:2018+A4:2026 at Regulation 710.512.2.1. IEC 60617 covers symbols for all types of electrical diagrams, including circuit diagrams, wiring diagrams, block diagrams, and installation drawings. BS 7671 cross-references IEC 60617 for the symbols used on electrical installation certificates, distribution board schedules, and circuit charts. Some older UK installations may use symbols from the superseded BS 3939, but IEC 60617 is the current standard and should be used for all new work.',
  },
  {
    question: 'What is the difference between a circuit diagram and a wiring diagram?',
    answer:
      'A circuit diagram (sometimes called a schematic diagram) shows the electrical connections between components using standard symbols. It focuses on the function of the circuit — how the components are connected electrically — without showing the physical layout or cable routing. A wiring diagram shows the physical layout of the installation, including the position of accessories, the routes of cables, and the connections at each point. In domestic electrical work, you are more likely to encounter wiring diagrams (such as a lighting layout for a house) than circuit diagrams. Both use IEC 60617 symbols, but wiring diagrams also include dimensional information and cable identification.',
  },
  {
...
const relatedPages: RelatedPage[] = [
  ...
  },
  {
    ...
    description:
      'Complete digital EICR certificates with correct IEC 60617 symbols on all generated documents.',
    icon: FileCheck2,
...
const sections = [
  {
    id: 'symbol-library',
    heading: 'The Complete IEC 60617 Symbol Library',
    content: (
      <>
        <p>
          Below is the complete IEC 60617 symbol set used on UK electrical installation drawings,
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p>
          In the UK, electrical symbols follow <strong>IEC 60617</strong> (Graphical symbols for
          diagrams). BS EN 60617, the former European harmonised version, has been withdrawn and
          replaced by IEC 60617 directly — as noted in BS 7671:2018+A4:2026 at Reg 710.512.2.1. IEC
          60617 defines symbols for everything from simple switches and socket outlets to complex
          protection devices and control circuits.
        </p>
          ...
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              <span>
                ...
                specified under BS 7671 Reg 534 series and appear on post-A4:2026 consumer unit
                drawings and distribution board schedules where surge protection has been installed
                or considered.
              </span>
            </li>
            <li className="flex items-start gap-3">
          ...
          <div className="flex items-start gap-3">
            <div>
              <p className="text-white text-sm leading-relaxed">
                ...
                exceeding 30 mA. This mandatory requirement means that on new and rewired domestic
                installations, lighting circuits must show RCD or RCBO protection ≤ 30 mA on the
    ...
    content: (
      <>
        <p>
          ...
          schedules, and existing circuit charts. Elec-Mate integrates IEC 60617 symbols throughout
          the app:
        </p>
          ...
          <div className="rounded-2xl bg-gradient-to-b from-white/[0.08] to-white/[0.04] border border-white/[0.14] p-5">
            <div className="flex items-start gap-4">
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  Access the complete IEC 60617 symbol set from within the app. Search by category
                  (switches, sockets, lights, protection devices) or by name. Each symbol includes a
                  description and the IEC 60617 reference number.
                </p>
              </div>
            </div>
          </div>
          <div className="rounded-2xl bg-blue-500/10 border border-blue-500/20 p-5">
            <div className="flex items-start gap-4">
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  All certificates generated by Elec-Mate use correct IEC 60617 symbols on
        ...
        <SEOAppBridge
          title="Electrical Symbols Chart: 114 UK Wiring Symbols (IEC 60617)"
          description="Complete electrical symbols chart: 114 wiring, circuit and installation symbols to IEC 60617 with meanings. Free reference for UK electricians."
          icon={PenTool}
        />
      </>
    ),
