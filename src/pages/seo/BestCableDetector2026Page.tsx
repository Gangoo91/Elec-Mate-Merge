...
const relatedPages: RelatedPage[] = [
  ...
  },
  {
    ...
    description: 'Complete your testing toolkit with the right MFT for EICR and EIC testing.',
    icon: Gauge,
    category: 'Guide',
  },
  {
...
const sections = [
  {
    ...
    content: (
      <>
        ...
        <p>
          For electricians, cable detection is relevant in two main scenarios. First, excavation
          work — installing external supplies, EV charger feeds, garden lighting, or outbuilding
          cables where you need to dig or trench across ground that may contain existing services.
          Second, indoor work — drilling, chasing, or cutting into walls and floors where existing
          cables may be concealed.
        </p>
        <p>
          The instruments for these two scenarios are different. Underground cable detection
          requires a professional Cable Avoidance Tool (CAT) — typically paired with a signal
          generator (Genny) for active tracing. Indoor wall scanning uses simpler, cheaper devices
          designed for shallow-depth detection through plaster and plasterboard. This guide covers
          both.
        </p>
      </>
    ),
        ...
        <div className="grid gap-4 sm:grid-cols-2 my-4">
          <div className="rounded-2xl bg-green-500/10 border border-green-500/20 p-5">
            ...
            <p className="text-white text-sm leading-relaxed">
              ...
              unit, distribution board, or a cable chamber. The signal generator clips onto the
              cable or is coupled inductively. Active mode gives the best depth accuracy and the
              most reliable cable route tracing.
            </p>
          </div>
          <div className="rounded-2xl bg-yellow-500/10 border border-yellow-500/20 p-5">
            ...
            <p className="text-white text-sm leading-relaxed">
              ...
              initial sweeps and for detecting cables you cannot access at either end. However, it
              is less accurate, less reliable, and cannot detect dead (de-energised) cables. A cable
        ...
        <div className="rounded-2xl bg-red-500/10 border border-red-500/20 p-5 my-4">
          <div className="flex items-start gap-3">
            ...
            <p className="text-white text-sm">
              <strong>Critical safety point:</strong> Passive detection alone cannot guarantee that
              an area is clear of cables. A de-energised cable, a cable with no load, or a cable
              shielded by other metallic objects may not be detected in passive mode. Always use
              active detection where possible, and always hand-dig within 500mm of a detected cable
              route.
            </p>
          </div>
        </div>
      ...
      <>
        <div className="rounded-2xl bg-blue-500/10 border border-blue-500/20 p-5 my-4">
          ...
          <p className="text-white text-sm leading-relaxed mb-3">
            The C.A.T4+ (Cable Avoidance Tool) with Genny4 signal generator is the most widely used
            underground cable and pipe locator in the UK. It is the instrument specified by most
            main contractors, utility companies, and local authorities.
          </p>
          <div className="grid gap-3 sm:grid-cols-2">
            <div className="rounded-xl bg-white/[0.04] border border-white/10 p-4">
              <p className="text-white text-sm">
                <strong>Detection modes:</strong> Power, Radio, Genny
              </p>
              <p className="text-white text-sm">
                <strong>Max depth (active):</strong> Up to 3 metres
              </p>
              <p className="text-white text-sm">
                <strong>Depth accuracy:</strong> +/- 5% at 1m depth
              </p>
              <p className="text-white text-sm">
                <strong>StrikeAlert:</strong> Yes (proximity warning)
              </p>
            </div>
            <div className="rounded-xl bg-white/[0.04] border border-white/10 p-4">
              <p className="text-white text-sm">
                <strong>Data logging:</strong> Yes (usage and avoidance data)
              </p>
              <p className="text-white text-sm">
                <strong>Swing warning:</strong> Yes (detects poor technique)
              </p>
              <p className="text-white text-sm">
                <strong>Battery:</strong> 4x AA, 30+ hours
              </p>
              <p className="text-white text-sm">
                <strong>Street price:</strong> 1,200 to 1,500 pounds (with Genny4)
              </p>
            </div>
          </div>
        </div>
        <p>
          <strong>Strengths:</strong> The C.A.T4+ is purpose-built for avoiding underground
          services. StrikeAlert provides automatic sensitivity adjustment and an audible warning
          when a signal is detected above a threshold — it is harder to accidentally ignore a buried
          cable. The swing warning alerts you if you are not sweeping the detector correctly, which
          reduces the chance of missing a cable due to poor technique. Data logging records usage
          patterns, which is useful for demonstrating due diligence if an incident is investigated.
          The Genny4 signal generator has multiple output frequencies and coupling options. Battery
          life is excellent.
        </p>
        <p>
        ...
        <p>
          <strong>Best for:</strong> Electricians who regularly work on external cable
          installations, EV charger groundwork, or any project involving excavation. If you work on
          sites managed by main contractors, many require a C.A.T4+ specifically — other brands may
          not be accepted.
        </p>
      </>
    ),
    ...
    content: (
      <>
        <div className="rounded-2xl bg-green-500/10 border border-green-500/20 p-5 my-4">
          ...
          <p className="text-white text-sm leading-relaxed mb-3">
            Leica (the surveying instrument manufacturer, not the camera company) produces a range
            of cable and pipe locators. The DD220 is their mid-range model aimed at electrical
            contractors and utility workers.
          </p>
          <div className="grid gap-3 sm:grid-cols-2">
            <div className="rounded-xl bg-white/[0.04] border border-white/10 p-4">
              <p className="text-white text-sm">
                <strong>Detection modes:</strong> Power, Radio, Generator
              </p>
              <p className="text-white text-sm">
                <strong>Max depth (active):</strong> Up to 3 metres
              </p>
              ...
              <p className="text-white text-sm">
                <strong>Auto-depth:</strong> Yes (continuous depth reading)
              </p>
            </div>
            <div className="rounded-xl bg-white/[0.04] border border-white/10 p-4">
              <p className="text-white text-sm">
                <strong>Data logging:</strong> Yes (Bluetooth to app)
              </p>
              <p className="text-white text-sm">
                <strong>Signal strength:</strong> Proportional bar + audio
              </p>
              <p className="text-white text-sm">
                <strong>Battery:</strong> Rechargeable, 20+ hours
              </p>
              <p className="text-white text-sm">
                <strong>Street price:</strong> 1,000 to 1,300 pounds (with generator)
              </p>
            </div>
          </div>
        </div>
        <p>
          ...
          Leica app provides GPS-tagged detection records, useful for creating as-built cable route
          drawings. The rechargeable battery with 20+ hours life eliminates the need to carry spare
          AAs. The signal strength display is clear and intuitive.
        </p>
        <p>
          <strong>Weaknesses:</strong> The Leica brand has less market share in UK cable detection
          than Radiodetection. Some main contractors may not recognise or accept it as equivalent to
          a C.A.T4+. The DD220 signal generator (sold separately or in a kit) is less widely
        ...
        <p>
          ...
          excellent depth measurement and data logging, and who work for clients that accept Leica
          as an alternative to Radiodetection.
        </p>
      </>
    ),
  },
      ...
      <>
        <div className="rounded-2xl bg-purple-500/10 border border-purple-500/20 p-5 my-4">
          ...
          <p className="text-white text-sm leading-relaxed mb-3">
            ...
            underground and through buildings. It combines underground cable location with circuit
            identification and breaker finding capabilities.
          </p>
          <div className="grid gap-3 sm:grid-cols-2">
            <div className="rounded-xl bg-white/[0.04] border border-white/10 p-4">
              <p className="text-white text-sm">
                <strong>Detection modes:</strong> Power, Tone, Active
              </p>
              <p className="text-white text-sm">
                <strong>Max depth (active):</strong> Up to 2.5 metres
              </p>
              <p className="text-white text-sm">
                <strong>Circuit identification:</strong> Yes (breaker finder)
              </p>
              <p className="text-white text-sm">
                <strong>Cable tracing:</strong> Through walls and underground
              </p>
            </div>
            <div className="rounded-xl bg-white/[0.04] border border-white/10 p-4">
              <p className="text-white text-sm">
                <strong>Transmitter frequencies:</strong> 4 selectable
              </p>
              <p className="text-white text-sm">
                <strong>Signal clamp:</strong> Included
              </p>
              <p className="text-white text-sm">
                <strong>Battery:</strong> 9V + 8x AA, 15+ hours
              </p>
              <p className="text-white text-sm">
                <strong>Street price:</strong> 800 to 1,000 pounds
              </p>
            </div>
          </div>
        </div>
    ...
    content: (
      <>
        <div className="rounded-2xl bg-yellow-500/10 border border-yellow-500/20 p-5 my-4">
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            <div className="rounded-xl bg-white/[0.04] border border-white/10 p-4">
              ...
              <p className="text-white text-sm">
                <strong>Max depth (active):</strong> Up to 2 metres
              </p>
              <p className="text-white text-sm">
                <strong>Circuit identification:</strong> Yes (fuse finder)
              </p>
              <p className="text-white text-sm">
                <strong>Cable tracing:</strong> Through walls and underground
              </p>
            ...
            <div className="rounded-xl bg-white/[0.04] border border-white/10 p-4">
              <p className="text-white text-sm">
                <strong>Transmitter frequencies:</strong> 2 selectable
              </p>
              <p className="text-white text-sm">
                <strong>Signal coupling:</strong> Direct connect + clamp
              </p>
              <p className="text-white text-sm">
                <strong>Battery:</strong> 9V batteries, 10+ hours
              </p>
              <p className="text-white text-sm">
                <strong>Street price:</strong> 600 to 800 pounds
              </p>
            </div>
          </div>
        </div>
        ...
        <p>
          ...
          and Leica DD220. Only two transmitter frequencies (versus four on the Amprobe) limits your
          ability to differentiate parallel cables. No StrikeAlert or swing warning features. Not
          accepted as equivalent to a C.A.T4+ by most main contractors for excavation work. Better
          suited to cable tracing and circuit identification than safety-critical cable avoidance.
        </p>
        <p>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          For domestic electricians who primarily need to find cables before drilling into walls, a
          purpose-built wall scanner is more practical and affordable than a full cable avoidance
          tool.
        </p>
          ...
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                Adequate for simple domestic jobs — finding cables before hanging a shelf or
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                solid brick or concrete walls. The WireWarning feature indicates live AC cables, but
                only if they are carrying current. Good for timber-frame properties and stud
                partition walls.
              </span>
            </li>
          </ul>
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                Western Power Distribution, etc.). Service drawings show approximate routes but are
                not always accurate — they are a starting point, not a guarantee.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                attempt to repair the cable. Report the incident to the HSE under RIDDOR if there is
                an injury or a dangerous occurrence.
              </span>
            </li>
          </ul>
        </div>
        ...
        <div className="space-y-3 my-4">
          <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-5">
            ...
            <div className="space-y-2 text-white text-sm">
              <p>
                <strong>Industry standard:</strong> Radiodetection C.A.T4+ with Genny4 (1,200 to
                1,500 pounds)
              </p>
              <p>
                <strong>Professional alternative:</strong> Leica DD220 with generator (1,000 to
                1,300 pounds)
              </p>
              <p>
                <strong>Multi-purpose:</strong> Amprobe AT-3500 (800 to 1,000 pounds)
              </p>
            </div>
          </div>
          <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-5">
            ...
            <div className="space-y-2 text-white text-sm">
              <p>
                <strong>Best:</strong> Amprobe AT-3500 (cable tracing + breaker finding in one kit)
              </p>
              <p>
                <strong>Good:</strong> Fluke 2042 (cable tracing + fuse finding, Fluke quality)
              </p>
            </div>
          </div>
          <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-5">
            ...
            <div className="space-y-2 text-white text-sm">
              <p>
                <strong>Best:</strong> Bosch GMS 120 (80 to 100 pounds — reliable, three modes)
              </p>
              <p>
                <strong>Budget:</strong> Stanley FatMax S300 (40 to 60 pounds — basic but
                functional)
              </p>
            </div>
          </div>
    ...
    content: (
      <>
        <div className="rounded-2xl bg-green-500/10 border border-green-500/20 p-6 my-4">
          ...
          <p className="text-white text-sm leading-relaxed mb-3">
            <strong>
              For domestic electricians: Bosch GMS 120 + Fluke 2042 or Amprobe AT-3500.
            </strong>{' '}
            A wall scanner handles 90% of your indoor cable detection needs. Add a cable tracer like
            the Fluke 2042 for circuit identification and occasional outdoor cable tracing. The
            Amprobe AT-3500 combines both functions if you want one kit.
          </p>
          <p className="text-white text-sm leading-relaxed">
