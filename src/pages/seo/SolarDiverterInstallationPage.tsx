...
const sections = [
  {
    ...
    content: (
      <>
        <p>
          A solar diverter — also known as a solar PV diverter, immersion diverter, or solar water
          heater controller — is a device that maximises the value of a solar PV system by using
          surplus generation to heat domestic hot water, rather than allowing that electricity to be
          exported to the grid at a low Smart Export Guarantee rate.
        </p>
          ...
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                heater in real time — matching the available surplus precisely. This means that if
                600 W is available, the diverter sends 600 W to the immersion heater, leaving the
                household's import/export at near-zero.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Thermometer className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                element). Properties with combi boilers (which heat water on demand with no storage
                cylinder) cannot use a diverter without first installing a cylinder.
              </span>
            </li>
          </ul>
        </div>
        <p>
          ...
          generate surplus electricity for 4–6 hours. A solar diverter can heat a full 200-litre hot
          water cylinder using this surplus — providing free hot water for the day with no gas or
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Three brands dominate the UK solar diverter market, each with a strong track record and
          nationwide installer support:
        </p>
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                provides a wall-mounted display showing live data including surplus diverted, solar
                generation, and energy saved. Sold through electrical wholesalers nationwide.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                app monitoring (myenergi app), support for two separate heating outputs (e.g.,
                immersion + underfloor heating), integration with Harvi CT clamp for wireless
                monitoring, and compatibility with the rest of the myenergi ecosystem. The natural
                choice for customers who already have or are considering a Zappi EV charger.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                proportional power control, boost button, and real-time monitoring. Wired CT clamp
                configuration rather than wireless, which some installers prefer for reliability in
                properties with signal interference.
              </span>
            </li>
          </ul>
        </div>
        <p>
          All three brands are available through electrical wholesalers. The iBoost and Eddi are the
          most widely sold in the UK market. For commercial or industrial hot water diversion,
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Solar diverter installation is an electrical installation task that must comply with BS
          7671 and Part P of the Building Regulations. The installation process varies slightly
          between brands but follows a common pattern:
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>CT clamp installation:</strong> The CT clamp must be installed on the live
                (line) conductor of the main supply cable, positioned between the meter and the
                consumer unit. This is typically done by the electrician at the consumer unit. For
                wireless diverters (iBoost, Eddi with Harvi), the CT clamp sender unit clips onto
                the cable without breaking the circuit. For wired diverters (Immersun), a cable run
                from the CT clamp to the diverter unit is required.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-orange-400 mt-0.5 shrink-0" />
              <span>
                <strong>Diverter unit location:</strong> The main diverter unit is installed near
                the hot water cylinder (typically in the airing cupboard). The output terminals
                connect to the immersion heater element — usually via a flex outlet plate or direct
                to the existing immersion heater wiring.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-orange-400 mt-0.5 shrink-0" />
              <span>
                ...
                (typically a switched fused connection unit, 3A). The output to the immersion heater
                is rated for the full heater load (typically 3 kW / 13A). The existing immersion
                heater wiring and thermostat remain in place as a backup.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-orange-400 mt-0.5 shrink-0" />
              <span>
                <strong>Part P notification:</strong> Installation must be notified under Part P via
                a registered competent person scheme. An Electrical Installation Certificate or
                Minor Works Certificate must be issued on completion. The customer should receive a
                copy along with the diverter's user manual.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Solar diverters represent one of the best value add-ons available for existing solar PV
          owners, with a straightforward payback period and no ongoing maintenance costs.
        </p>
        <div className="rounded-2xl bg-green-500/10 border border-green-500/20 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Unit cost:</strong> £200–£400 depending on brand and specification. iBoost:
                approximately £240. Eddi: approximately £310. Immersun: approximately £210. Prices
                vary by supplier and may fluctuate with energy market conditions.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-green-400 mt-0.5 shrink-0" />
              <span>
                <strong>Installation labour:</strong> £100–£200 for a standard domestic installation
                (approximately 1.5–3 hours for an experienced electrician). More complex
                installations (long cable runs, airing cupboard access difficulties) may cost more.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-green-400 mt-0.5 shrink-0" />
              <span>
                ...
                installation, including unit, labour, and any minor materials (cable, FCU, fixings).
              </span>
            </li>
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-green-400 mt-0.5 shrink-0" />
              <span>
                ...
                depending on solar system size, hot water usage, and whether gas or electricity is
                the current water heating fuel. The saving represents the cost of the water heating
                energy displaced by diverted solar electricity.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <PoundSterling className="w-5 h-5 text-green-400 mt-0.5 shrink-0" />
              <span>
                <strong>Payback period:</strong> Typically 2–4 years. The diverter has no moving
                parts, requires no maintenance, and should last 10+ years — making the long-term
                return on investment very attractive.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          The wiring arrangements for a solar diverter installation require careful planning to
          ensure compliance with BS 7671 and safe, reliable operation. Key wiring considerations:
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                (typically 2.5 mm² T&E on a 16A or 20A MCB) should be assessed before installation.
                Old rubber or cloth-insulated wiring must be replaced — not connected to a modern
                diverter. The circuit should be on an RCD-protected way in the consumer unit.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
            ...
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Thermostat retention:</strong> The immersion heater's thermal cutout and
                thermostat must remain in the circuit and be operational. The diverter does not
                bypass the thermostat — it controls power input to the element while the thermostat
                remains the safety mechanism. Do not remove or bypass the immersion heater's thermal
                cutout.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Earthing and bonding:</strong> Ensure supplementary bonding of the hot water
                cylinder is maintained (or installed if absent). Check for any existing bonding that
                may be disturbed during access to the airing cupboard.
              </span>
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                required; simple installation; fast payback (2–4 years). Best for customers with an
                existing hot water cylinder who primarily want to offset water heating costs.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ClipboardCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                enables time-of-use tariff optimisation; provides backup power capability (with
                certain systems); higher total energy value captured from the solar system. Best for
                customers who want to maximise self-consumption across all household loads.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <ClipboardCheck className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
              <span>
                ...
                diverter handles any surplus that the battery cannot absorb. For systems with a
                large solar array, both components together can achieve very high self-consumption
                rates.
              </span>
            </li>
          </ul>
        ...
        <p>
          For most UK solar PV owners who already have a hot water cylinder, a solar diverter is the
          logical first step — install it within a year of the solar panels, enjoy the immediate
          savings on water heating, and consider adding battery storage later if electricity bills
          remain high.
        </p>
      </>
    ),
    ...
    content: (
      <>
        <p>
          ...
          working on solar PV or general domestic electrical work. A typical installation takes 2–3
          hours, requires minimal materials, and generates a healthy margin at the current market
          rate. With over 1.3 million solar PV installations in the UK, many of which do not yet
          have a diverter fitted, the market opportunity is substantial.
        </p>
        <p>
          Key upselling opportunity: when carrying out an annual inspection or EICR on a property
          with solar panels and a hot water cylinder but no diverter, always mention the diverter
          option. The payback period and simple explanation (
          <em>
            "it heats your hot water for free using electricity you'd otherwise sell for 3–5p per
            unit"
          </em>
