...
import { Calculator, BookOpen, Zap, GraduationCap, Lightbulb, ClipboardCheck } from 'lucide-react';
...
const relatedPages: RelatedPage[] = [
  {
    ...
    description:
      "Ohm's Law, electrical units, circuit theory, health and safety — complete Year 1 revision.",
    icon: BookOpen,
    category: 'Guide',
  },
  {
    ...
    description:
      'Knowledge test, practical observation, professional discussion — everything about the EPA.',
    icon: ClipboardCheck,
    category: 'Guide',
  },
  {
    ...
    description:
      'The 2365 qualification structure, units, assessment methods, and achieving distinction.',
    icon: BookOpen,
    category: 'Guide',
  },
  {
...
const sections = [
  {
    ...
    content: (
      <>
        <p>
          Ohm's Law is V = I × R. The three variables — voltage (V), current (I), and resistance (R)
          — are related such that if you know any two, you can calculate the third. This is the
          foundation of every electrical calculation you will do throughout your career.
        </p>
    ...
    content: (
      <>
        <p>
          ...
          By combining P = IV with Ohm's Law (V = IR), you get two additional forms that allow you
          to calculate power from any pair of known quantities.
        </p>
        <div className="rounded-2xl bg-blue-500/10 border border-blue-500/20 p-6 my-4">
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>P = I² × R</strong> — use when you know current and resistance. Example: 5A
                through a 20Ω resistor. P = 5² × 20 = 25 × 20 = 500W. This formula also shows why
                cable sizing matters — doubling the current quadruples the power dissipated as heat.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                a 3kW shower on 230V draws I = 3,000 ÷ 230 ≈ 13A. This tells you the minimum circuit
                current rating required.
              </span>
            </li>
          </ul>
        </div>
        <p>
          ...
          calculations. The formulae also appear in design work — calculating the current demand of
          a circuit before selecting the correct cable and protective device.
        </p>
      </>
    ),
  },
          ...
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                load), or reduce the current demand. Recalculate until Vd is within limits.
              </span>
            </li>
          </ul>
        </div>
    ...
    content: (
      <>
        ...
        <div className="rounded-2xl bg-blue-500/10 border border-blue-500/20 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Formula:</strong> % Vd = (Vd ÷ Vn) × 100. Where Vd = actual voltage drop (V)
                and Vn = nominal supply voltage (230V for single-phase UK).
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Calculator className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Example:</strong> Actual Vd = 8.5V on a 230V power circuit. % Vd = (8.5 ÷
                230) × 100 = 3.7%. This is within the 5% limit for power circuits but would exceed
                the 3% limit for a lighting circuit.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Calculator className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
        ...
        <p>
          ...
          <SEOInternalLink href="/study-centre">Elec-Mate calculation tools</SEOInternalLink> to
          ...
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                If it is divided, multiply both sides.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Lightbulb className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                sides by (mV/A/m × I) → L = (Vd × 1000) ÷ (mV/A/m × I).
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Lightbulb className="w-5 h-5 text-yellow-400 mt-0.5 shrink-0" />
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          In AC circuits containing inductance or capacitance, resistance (R) and reactance (X) are
          out of phase with each other. They cannot simply be added — instead they are combined
          using Pythagoras' theorem because they are at 90° to each other on a phasor diagram.
        </p>
        <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-6 my-4">
          <ul className="space-y-4 text-white">
            <li className="flex items-start gap-3">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                304. Recognising a 3-4-5 triangle (and its multiples: 6-8-10, 5-12-13) saves
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Electrical values span an enormous range — from picofarads (millionths of millionths of a
          farad) to megawatts (millions of watts). Scientific notation and SI prefixes let you
        ...
        <div className="rounded-2xl bg-blue-500/10 border border-blue-500/20 p-6 my-4">
          <ul className="space-y-4 text-white">
            ...
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                <strong>Milli (m) = ×10⁻³:</strong> 30mA = 0.03A — the standard RCD tripping current
                for protection against electric shock. 100mV = 0.1V. mV/A/m values in voltage drop
                tables are in millivolts.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
              <span>
                ...
                typically 4μF to 70μF. Power factor correction capacitors in commercial
                installations may be hundreds of μF.
              </span>
            </li>
          </ul>
        </div>
            ...
            <li className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="mt-1">
                  ...
                  for 2.5mm² in a ring circuit = 7.3mV/A/m (half the tabulated value because of the
                  ring). Design current (Ib) = 20A (typical). Vd = (7.3 × 20 × 22) ÷ 1000 = 3,212 ÷
                  1000 = 3.21V. % Vd = (3.21 ÷ 230) × 100 = 1.4%. Well within the 5% limit.
                </p>
              </div>
            </li>
            <li className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="mt-1">
                  ...
                  its resistance? I = P ÷ V = 3,000 ÷ 230 = 13.04A. R = V ÷ I = 230 ÷ 13.04 = 17.64Ω
                  (or R = V² ÷ P = 52,900 ÷ 3,000 = 17.63Ω — same answer). The circuit requires a
                  16A MCB and 2.5mm² cable.
                </p>
              </div>
            </li>
            <li className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="mt-1">
                  Three lamps of 20Ω, 30Ω, and 50Ω are connected in series across a 200V supply. Rt
                  = 20 + 30 + 50 = 100Ω. I = V ÷ Rt = 200 ÷ 100 = 2A. Vd across 30Ω lamp = 2 × 30 =
                  60V. P dissipated by 50Ω lamp = I² × R = 4 × 50 = 200W.
                </p>
              </div>
            </li>
          </ul>
...
export default function ApprenticeMathsElectricianPage() {
  return (
    <GuideTemplate
      title="Maths for Electrical Apprentices: Essentials"
