  ...
  return (
    <div className="bg-elec-dark text-white">
      <Helmet>
        ...
        <meta
          name="description"
          content="Compare electrical material prices across multiple UK suppliers. Find the best deals on cables, components, and electrical equipment."
        />
        <meta
          name="keywords"
          content="electrical materials price comparison, UK suppliers, cables prices, electrical components deals"
        />
      </Helmet>
