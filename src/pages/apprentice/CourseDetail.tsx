...
import { ealLevel2Units as courseUnits } from "@/data/courseUnits";
...
const CourseDetail = () => {
  ...
  // Get the course title based on the course slug
  const getCourseTitle = () => {
    if (courseSlug?.includes('level-2')) {
      return "Level 2 Diploma in Electrical Installation";
    } else if (courseSlug?.includes('level-3')) {
      return "Level 3 Advanced Diploma in Electrical Installation";
    } else if (courseSlug?.includes('level-4')) {
      return "Level 4 Higher Diploma in Electrical Engineering";
    }
    return "Electrical Installation Course";
  };
