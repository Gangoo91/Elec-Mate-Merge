...
const Card = ({
  ...
  <div
    className={
      'rounded-xl border border-white/[0.06] bg-[hsl(0_0%_10%)] p-4 sm:p-5 ' +
      className
    }
  >
    {children}
        ...
        <div className="space-y-2.5">
          ...
          <Card>
            ...
            <ul className="space-y-1.5 list-none mt-2">
              ...
              <Bullet icon={PoundSterling}>
                JIB Stage 1: £8.16/hr → Stage 2: £9.89/hr → Stage 3: £11.70/hr → Stage 4: £14.03/hr (national)
              </Bullet>
              <Bullet icon={MapPin}>London rates approximately 12–15% higher</Bullet>
      ...
      <motion.section variants={itemVariants} className="space-y-3">
        ...
        <div className="space-y-2.5">
          <Card>
            ...
            <ul className="space-y-1.5 list-none mt-2">
              <Bullet icon={CheckCircle2}>
                Off-the-job training hours fixed per standard (Aug 2025 onwards, replacing the old 20% rule)
              </Bullet>
              <Bullet icon={Calendar}>
              ...
              <Bullet icon={Lightbulb}>
                T-Level in Building Services Engineering is a 2-year college alternative (not a replacement)
              </Bullet>
            </ul>
          </Card>
          <Card>
            ...
            <ul className="space-y-1.5 list-none mt-2">
              <Bullet icon={Award}>
                <span className="font-medium">Knowledge:</span> City & Guilds 2365-03 Level 3 Diploma (or EAL equivalent)
              </Bullet>
              <Bullet icon={Award}>
                <span className="font-medium">Competence:</span> NVQ Level 3 Electrotechnical Services (C&G 5357 or EAL equivalent)
              </Bullet>
              <Bullet icon={Award}>
        ...
        <div className="space-y-2.5">
          ...
          <Card>
            ...
            <ul className="space-y-1.5 list-none mt-2">
              ...
              <Bullet icon={FileText}>ST0152 v1.2 (July 2025) has revised EPA plan</Bullet>
            </ul>
          </Card>
        </div>
      </motion.section>
        ...
        <Card>
          <div className="grid grid-cols-2 gap-x-4 gap-y-3">
            ...
            <GridStat
              icon={GraduationCap}
              title="College fees"
              meta="100% government-funded"
            />
            <GridStat
              icon={PoundSterling}
              title="Regular wage"
              meta="From day one inc. college"
            />
            <GridStat
              icon={Users}
              title="Supervision"
              meta="Qualified electricians"
            />
            <GridStat
              icon={Award}
              title="Qualification"
              meta="L3 Diploma, NVQ, AM2S"
            />
          </div>
        </Card>
      </motion.section>
      ...
      <motion.section variants={itemVariants} className="space-y-3">
        ...
        <Card>
          <ul className="space-y-1.5 list-none">
            ...
            <Bullet icon={BookOpen}>BS 7671 Amendment 4 expected 2026</Bullet>
          </ul>
        </Card>
      </motion.section>
      ...
      <motion.section variants={itemVariants}>
        <div className="rounded-xl border border-elec-yellow/25 bg-elec-yellow/[0.04] p-4 sm:p-5 space-y-1.5">
          ...
          <p className="text-[13px] text-white/85 leading-relaxed">
            Electrician → Approved Electrician (2 yr + Inspection & Testing quals)
            → Technician (5 yr + Level 4 qualification).
          </p>
        </div>
      </motion.section>
    </PageFrame>
