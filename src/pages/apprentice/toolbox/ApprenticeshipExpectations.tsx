...
const ApprenticeshipExpectations = () => {
  return (
    <HubPage>
      <HubMasthead
        section="Apprentice · Expectations"
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          {
            'What each year of an Installation & Maintenance Electrician apprenticeship actually looks like — month by month, salary by salary, qualification by qualification.'
          }
        </p>
            ...
            <Card>
              ...
              <ul className="space-y-1.5 list-none mt-2">
                <Bullet icon={PoundSterling}>
                  Apprentice NMW: £8.00/hr (from 1 April 2026). Applies if you're under 19, or 19+
                  in the first year of your apprenticeship — after that you move to the
                  age-appropriate NMW/NLW rate
                </Bullet>
                <Bullet icon={PoundSterling}>
            ...
            <Card>
              ...
              <ul className="space-y-1.5 list-none mt-2">
                <Bullet icon={CheckCircle2}>
                  Off-the-job training is fixed hours per standard (1 Aug 2025 onwards, replacing
                  the old 20% rule) — ST0152 = 1,066 off-the-job hours
                </Bullet>
                <Bullet icon={Calendar}>
            ...
            <Card>
              ...
              <ul className="space-y-1.5 list-none mt-2">
                ...
                <Bullet icon={CheckCircle2}>
                  ...
                  portfolio signed off before EPA entry
                </Bullet>
                <Bullet icon={FileText}>
          ...
          <div className="space-y-2.5">
            ...
            <div className="rounded-xl border border-elec-yellow/25 bg-elec-yellow/[0.04] p-4 sm:p-5 space-y-2">
              ...
              <ul className="space-y-1.5 list-none mt-1">
                ...
                <Bullet icon={Shield}>
                  If you&apos;re ever asked to do something that feels unsafe, it is always
                  acceptable to stop and ask — under the Electricity at Work Regulations 1989 the
                  duty to work safely is yours too, not only your employer&apos;s
                </Bullet>
                <Bullet icon={Calendar}>
            ...
            <div className="rounded-xl border border-elec-yellow/25 bg-elec-yellow/[0.04] p-4 sm:p-5 space-y-2">
              ...
              <ul className="space-y-1.5 list-none mt-1">
                ...
                <Bullet icon={Shield}>
                  ACAS — free, impartial advice on pay, contracts and workplace disputes
                  (acas.org.uk)
                </Bullet>
                <Bullet icon={PoundSterling}>
        ...
        <motion.section variants={itemVariants} className="space-y-3">
          ...
          <Card>
            <ul className="space-y-1.5 list-none">
              <Bullet icon={Zap}>
                Acute shortage: roughly a 227:1 vacancy-to-apprentice ratio, with an estimated
                104,000 more electricians needed by 2032 (ECA / industry projection)
              </Bullet>
