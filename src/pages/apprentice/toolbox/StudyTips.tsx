  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8 animate-fade-in">
      <div className="flex flex-col items-center justify-center mb-6">
        <h1 className="text-3xl font-bold tracking-tight mb-4">Study Hub</h1>
      ...
      <Card className="border-green-500/50 bg-green-500/10">
        ...
        <CardContent>
          <p className="text-muted-foreground">
            Remember: Success in electrical training comes from consistent, focused study habits. 
            ...
            The electrical trade rewards methodical, steady progress - let these proven strategies guide your path to qualification.
          </p>
        </CardContent>
      </Card>
    </div>
