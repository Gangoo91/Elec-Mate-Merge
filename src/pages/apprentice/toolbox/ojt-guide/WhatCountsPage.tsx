...
const greyAreaScenarios = [
  ...
  {
    scenario:
      'Your supervisor explains BS 7671 regulations while you wire a board together on site',
    verdict: false,
    explanation:
  ...
  {
    scenario:
      'You attend a structured team session where your supervisor teaches cable sizing calculations',
    verdict: true,
    explanation:
  ...
  {
    scenario: 'You study for your AM2S at college during a scheduled revision day',
    verdict: true,
    explanation:
