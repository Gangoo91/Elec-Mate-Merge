    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          {
            "Thinking about what you did, why, and what you'd do differently. The part of your portfolio that shows assessors you understand your work — not just that you can do it."
          }
        </p>
