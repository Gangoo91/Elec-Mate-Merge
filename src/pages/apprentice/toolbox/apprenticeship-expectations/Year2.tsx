...
const bs7671A4Changes = [
  'RCD verification simplified — Appendix 3 Table 3A and the 5×IΔn test are deleted; one AC test at IΔn verifies any RCD Type',
  'Reg 411.3.3 socket-outlet RCD scope revised — additional protection for socket-outlets up to 32 A, with the old dwelling-only framing removed',
  'Cables concealed in walls — the protection requirements are gathered into Table 52.1 (Reg 522.6.201)',
  'Arc fault detection devices (AFDDs) — Reg 421.1.7 scope revised for certain final circuits',
];
