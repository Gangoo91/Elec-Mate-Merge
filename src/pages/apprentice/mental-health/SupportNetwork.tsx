        ...
        <Card className="border-purple-500/20 bg-white/5">
          ...
          <CardContent>
            <p className="text-sm text-white mb-4">
              Stay informed about upcoming events, support groups, and mental health resources
              specific to electrical apprentices.
            </p>
            {!isSubscribed ? (
              ...
              <div className="text-center py-2 px-4 bg-purple-500/10 rounded-md border border-purple-500/20">
                <p className="text-purple-400">
                  You're subscribed! We'll send updates to your email.
                </p>
              </div>
            )}
          </CardContent>
