    ...
    <div className="max-w-7xl mx-auto space-y-8 animate-fade-in">
        ...
        <div className="flex flex-col md:flex-row gap-6 items-start">
          ...
          <div className="flex-1">
            ...
            <p className="text-white">
              Access common questions and expert answers from site supervisors and qualified
              electricians. Can't find what you're looking for? Submit your own question to be
              answered by verified mentors.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-amber-950/20 border border-amber-600/30 rounded-md p-6">
        ...
        <p className="text-sm text-amber-200/90">
          Future expansion will allow verified mentors or supervisors to directly answer submitted
          questions through a dedicated portal. This feature is currently in development.
        </p>
      </div>
    </div>
  );
