  ...
  const educationOptions = [
    {
      ...
      description:
        'Learn about cutting-edge products, installation techniques, and system integration from leading manufacturers',
      examples: [
    ...
    },
    {
      ...
      description:
        'Stay current with industry developments, regulatory changes, and best practices through expert-led sessions',
      examples: [
      ...
      benefits: [
        'CPD hours towards registration',
    ...
    },
    {
      ...
      description:
        'Pursue formal qualifications to advance into engineering, management, or specialist technical roles',
      examples: [
      ...
      benefits: [
        'Academic qualifications for career progression',
        'Management and leadership skills',
        'Research and analysis capabilities',
        'Access to professional engineering status',
    ...
    },
    {
      ...
      description:
        'Join professional engineering institutions for access to technical resources, networking, and career development',
      examples: [
      ...
      benefits: [
        'Professional recognition and letters (MIET, CENG)',
        'Access to technical journals and standards',
    ...
    },
    {
      ...
      description:
        'Maintain current health and safety qualifications essential for electrical work in all environments',
      examples: [
      ...
      benefits: [
        'Legal compliance for site work',
        'Insurance requirement satisfaction',
        'Reduced workplace accident risk',
        'Enhanced employability',
        'Site access card maintenance',
      ],
    ...
    },
    {
      ...
      description:
        'Master new technologies transforming the electrical industry to future-proof your career',
      examples: [
    ...
    },
    {
      ...
      description:
        'Develop business acumen essential for career progression into management or self-employment',
      examples: [
      ...
      benefits: [
        ...
        'Essential skills for contracting',
    ...
    },
    {
      ...
      benefits: [
        'Access to specialist high-paying markets',
    ...
    <div className="max-w-7xl mx-auto space-y-8 animate-fade-in">
      <div className="flex flex-col items-center justify-center mb-6">
        ...
        <p className="text-white text-center max-w-2xl mb-4">
          Stay at the forefront of the electrical industry through ongoing education and
          professional development. Meet CPD requirements whilst building expertise that advances
          your career and increases earning potential.
        </p>
        <SmartBackButton />
      </div>
              ...
              <div>
                ...
                <ul className="space-y-1">
                  {option.examples.map((example, exampleIndex) => (
                    <li key={exampleIndex} className="text-sm text-white flex items-start gap-2">
      ...
      <Card className="border-elec-yellow/20 bg-gradient-to-r from-elec-yellow/10 to-elec-yellow/5">
        <CardHeader>
          <CardTitle className="text-elec-yellow">
            UK Registration Scheme CPD Requirements
          </CardTitle>
        </CardHeader>
        <CardContent>
          <p className="text-white mb-4">
            All UK electrical registration schemes require annual CPD to maintain competent person
            status. Here's what each scheme expects:
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {cpdRequirements.map((scheme, index) => (
              <div key={index} className="border border-elec-yellow/20 rounded-lg p-4">
                ...
                <p className="text-white text-sm mb-3">{scheme.details}</p>
                <div>
                  <h5 className="font-medium text-white text-sm mb-2">Required Categories:</h5>
                  <div className="grid grid-cols-2 gap-1">
                    {scheme.categories.map((category, catIndex) => (
                      <div key={catIndex} className="text-xs text-white flex items-center gap-1">
                        <span className="text-elec-yellow">•</span>
                        {category}
                      </div>
                    ))}
              ...
              <tbody>
                {learningMethods.map((method, index) => (
                  <tr key={index} className="border-b border-elec-yellow/10">
                    ...
                    <td className="py-3 text-white">{method.timeCommitment}</td>
                    <td className="py-3 text-white">{method.cpdValue}</td>
                    <td className="py-3 text-white">{method.cost}</td>
                  </tr>
                ))}
              </tbody>
            </table>
              ...
              <div key={index} className="border border-elec-yellow/20 rounded-lg p-3">
                ...
                <ul className="space-y-1">
                  {method.benefits.map((benefit, benefitIndex) => (
                    <li key={benefitIndex} className="text-xs text-white flex items-start gap-1">
                      <span className="text-elec-yellow">•</span>
                      {benefit}
                    </li>
                  ))}
        ...
        <CardContent>
          ...
          <div className="mt-6 p-4 bg-elec-yellow/10 rounded-lg">
            ...
            <p className="text-white text-sm">
              The most successful electrical professionals exceed minimum CPD requirements and
              actively seek learning opportunities that differentiate them in the market. Consider
              targeting 30-40 hours annually, with a mix of technical updates, business skills, and
              emerging technology training. This investment in professional development typically
              returns 3-5 times its cost through increased earning potential and career
              opportunities.
            </p>
          </div>
        </CardContent>
