...
const OnJobTools = () => {
  ...
  const safetyTools = [
    ...
    },
    {
      ...
      icon: ClipboardCheck,
      description:
        'Pre-job safety checklists, site condition assessments, risk analysis templates & installation checks',
      link: '/apprentice/on-job-tools/assessment',
      badge: '15+ Checklists',
      color: 'green',
    },
    {
      ...
      icon: Zap,
      description:
        'Complete 18th Edition inspection & testing procedures with step-by-step documentation guides',
  ...
  const guideTools = [
    {
      ...
      icon: Wrench,
      description:
        'Complete guide to professional electrician tools — from hand tools to test equipment, with UK supplier recommendations',
    ...
    },
    {
      ...
      icon: BookOpen,
      description:
        'Step-by-step guides for domestic, commercial, industrial & outdoor installations with BS7671 compliance',
    ...
    },
    {
      ...
      icon: HelpCircle,
      description:
        'Knowledge bank with common site questions, when to ask for help & professional communication tips',
  ...
  const practiceTools = [
    {
      ...
      icon: Lightbulb,
      description:
        'Quick revision for cable colours, BS7671 regulations, EICR codes, safe isolation & fault finding',
      link: '/apprentice/on-job-tools/flashcards',
      badge: '100+ Cards',
      color: 'orange',
    },
    {
      ...
      icon: Calculator,
      description:
        'On-site tools for cable sizing, volt drop, maximum demand, protective device selection & more',
      link: '/apprentice/on-job-tools/calculations',
      badge: '20+ Tools',
      color: 'green',
    },
    {
      ...
      icon: MessageSquare,
      description:
        'Master site communication, UK trade culture, regional terminology & professional relationships',
  ...
  const getQuickAccessColor = (color: string) => {
    switch (color) {
      ...
      default:
        return {
          bg: 'bg-elec-yellow/15 hover:bg-elec-yellow/25',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-5 sm:py-8 space-y-6 sm:space-y-8 animate-fade-in">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-[13px] text-white leading-relaxed">
                  These tools help you prepare properly, but never substitute them for training or
                  supervision. When in doubt,{' '}
                  <span className="font-medium text-amber-200">stop and ask</span>.
                </p>
              </div>
            </div>
          </CardContent>
          ...
          <CardContent className="p-4">
            <div className="flex items-start gap-3">
              ...
              <div className="min-w-0">
                ...
                <p className="text-[13px] text-white leading-relaxed">{todaysTip.tip}</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <div className="space-y-3">
          <div className="flex items-center gap-2.5 px-1">
            ...
            <h2 className="text-sm sm:text-base font-semibold text-white">Safety & Compliance</h2>
          </div>
        ...
        <div className="space-y-3">
          <div className="flex items-center gap-2.5 px-1">
            ...
            <h2 className="text-sm sm:text-base font-semibold text-white">Guides & Reference</h2>
          </div>
