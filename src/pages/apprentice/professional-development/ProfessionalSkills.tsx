...
const ProfessionalSkills = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Apprentice · Soft skills"
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          {
            "Technical ability gets you qualified — professional skills decide how far you go. Communication, problem solving, customer handling, business sense — the parts the JIB grade can't measure."
          }
        </p>
