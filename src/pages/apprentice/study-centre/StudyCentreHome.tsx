...
export default function StudyCentreHome() {
  ...
  const level2Modules = [
    {
      ...
      category: 'Level 2',
      duration: '4 weeks',
      progress: getProgress('level2-module1')?.progress_pct ?? 0,
      lessonsCount: 12,
      questionsCount: 250,
    ...
    },
    {
      ...
      category: 'Level 2',
      duration: '6 weeks',
      progress: getProgress('level2-module2')?.progress_pct ?? 0,
      lessonsCount: 18,
      questionsCount: 250,
    ...
    },
    {
      ...
      category: 'Level 2',
      duration: '8 weeks',
      progress: getProgress('level2-module3')?.progress_pct ?? 0,
      lessonsCount: 24,
      questionsCount: 250,
    ...
    },
    {
      ...
      category: 'Level 2',
      duration: '6 weeks',
      progress: getProgress('level2-module4')?.progress_pct ?? 0,
      lessonsCount: 16,
      questionsCount: 250,
    ...
    },
    {
      ...
      category: 'Level 2',
      duration: '5 weeks',
      progress: getProgress('level2-module5')?.progress_pct ?? 0,
      lessonsCount: 14,
      questionsCount: 250,
    ...
    },
    {
      ...
      category: 'Level 2',
      duration: '4 weeks',
      progress: getProgress('level2-module6')?.progress_pct ?? 0,
      lessonsCount: 12,
      questionsCount: 250,
    ...
    },
    {
      ...
      category: 'Level 2',
      duration: '4 weeks',
      progress: getProgress('level2-module7')?.progress_pct ?? 0,
      lessonsCount: 10,
      questionsCount: 250,
      icon: <BookOpen className="h-4 w-4 text-blue-400" />,
    },
  ...
  const am2Modules = [
    {
      ...
      category: 'AM2',
      duration: '8 weeks',
      progress: getProgress('am2')?.progress_pct ?? 0,
      lessonsCount: 20,
      questionsCount: 400,
  ...
  const completedCount = dbCompletedCount;
    ...
    <div className="pb-24 bg-elec-dark">
      <div className="max-w-6xl mx-auto lg:px-8">
        ...
        <div className="px-4 space-y-4 -mt-2">
          ...
          {lastAccessed &&
            (() => {
              const lastModule = allModules.find((m) => m.id === lastAccessed.course_key);
              ...
              return (
                <motion.div
                  ...
                  className="relative overflow-hidden rounded-xl bg-gradient-to-r from-elec-yellow/15 via-elec-yellow/5 to-transparent border border-elec-yellow/30 p-4"
                >
                  <div className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-elec-yellow/60 to-transparent" />
                  <div className="flex items-center gap-3">
                    <div className="p-2.5 rounded-xl bg-elec-yellow/20 shrink-0">
                      <PlayCircle className="h-5 w-5 text-elec-yellow" />
                    </div>
                    <div className="flex-1 min-w-0">
                      <p className="text-xs font-medium text-elec-yellow uppercase tracking-wider mb-0.5">
                        Continue Learning
                      </p>
                      <p className="text-sm font-semibold text-white truncate">
                        {lastModule.title}
                      </p>
                      {lastAccessed.section_key && (
                      ...
                      <div className="mt-2 h-1.5 w-full rounded-full bg-white/10 overflow-hidden">
                        <div
                          ...
                          style={{ width: `${lastAccessed.progress_pct}%` }}
                        />
                      </div>
                      <p className="text-[10px] text-white mt-1">
                        {lastAccessed.progress_pct}% complete
                      </p>
                    </div>
                    <Button
                      size="sm"
                      onClick={() => navigate(`/study-centre/apprentice/${lastModule.id}`)}
                      className="h-11 px-4 bg-elec-yellow text-black font-semibold hover:bg-elec-yellow/90 touch-manipulation shrink-0"
                    >
                      Continue
                    </Button>
                  </div>
