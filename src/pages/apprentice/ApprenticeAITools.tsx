...
const ApprenticeAITools = () => {
  const aiTools = [
    ...
    },
    {
      ...
      description:
        'Step-by-step AI guidance for complex electrical installations compliant with BS 7671',
      status: 'Beta Access',
      icon: FileText,
    },
    {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 animate-fade-in">
      ...
      <Card className="border-elec-yellow/20 bg-white/5">
        ...
        <CardContent>
          <p className="mb-4">
            Our AI tools provide instant feedback, personalised learning, and practical guidance to
            supplement your formal training and on-site experience. All tools are built with UK
            electrical standards and practices in mind.
          </p>
        </CardContent>
      </Card>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {aiTools.map((tool) => (
          <Card
            key={tool.id}
            className="border-elec-yellow/20 bg-white/5 hover:shadow-md transition-shadow"
          >
