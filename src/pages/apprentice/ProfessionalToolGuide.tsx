        ...
        <div className="grid grid-cols-3 gap-3">
          {categoryCards.map((card) => {
            ...
            return (
              ...
              >
                <div
                  className={`p-2 rounded-lg ${card.bgColour} inline-block mb-2`}
                >
                  <Icon className={`h-5 w-5 ${card.colour}`} />
                </div>
                <div
                  className={`text-sm font-semibold ${isActive ? card.colour : "text-white"}`}
                >
                  {card.label}
                </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <p className="text-sm text-white">
                ...
                <span className="font-medium text-amber-300">
                  VDE certified to BS EN 60900
                </span>
                . Test equipment must comply with{" "}
                <span className="font-medium text-amber-300">
                  GS38 guidance
                </span>{" "}
                and be calibrated annually. Voltage indicators must meet{" "}
                <span className="font-medium text-amber-300">
                  BS EN 61243-3
                </span>
                .
