    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          {
            "Reading them, understanding them, and writing your own. RAMS aren't paperwork — they're the difference between knowing the risks and walking into them blind."
          }
        </p>
        ...
        <div className="rounded-xl border border-white/[0.06] bg-[hsl(0_0%_10%)]">
          <div className="p-4 sm:p-5 space-y-4">
            ...
            <p className="text-white text-sm leading-relaxed">
              ...
              prevent it. Every job you work on should have a risk assessment — and you should read
              it before you start work. The Management of Health and Safety at Work Regulations 1999
            ...
            <p className="text-white text-sm leading-relaxed">
              ...
              <span className="font-bold text-elec-yellow">
                must understand them, follow them, and speak up if something does not match reality
                on site
              </span>
              .
            </p>
            ...
            <div className="rounded-md border border-elec-yellow/20 bg-elec-yellow/[0.04] p-3 space-y-2">
              ...
              <p className="text-white text-xs leading-relaxed">
                ...
                actually cause harm, combined with how serious that harm would be. The same hazard
                can carry a high or low risk depending on the controls in place. Risk assessment is
                about reducing that risk — you rarely remove the hazard entirely.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-xl border border-white/[0.06] bg-[hsl(0_0%_10%)]">
          <div className="p-4 sm:p-5 space-y-4">
            ...
            <p className="text-white text-sm leading-relaxed">
              The Health and Safety Executive's long-standing five-step approach (set out in
              INDG163) is the process you will learn for your qualifications and the one most
              employers' assessments are built on. HSE now also frames this as identify, assess,
              control, record and review — the same five actions in plain language.
            </p>
        ...
        <div className="rounded-xl border border-white/[0.06] bg-[hsl(0_0%_10%)]">
          <div className="p-4 sm:p-5 space-y-4">
            ...
            <p className="text-white text-sm leading-relaxed">
              ...
              (most effective) and work down — only move to a lower, weaker control when the one
              above is not reasonably practicable. PPE is always the{' '}
        ...
        <div className="rounded-xl border border-white/[0.06] bg-[hsl(0_0%_10%)]">
          <div className="p-4 sm:p-5 space-y-4">
            ...
            <p className="text-white text-sm leading-relaxed">
              On commercial and industrial sites, you will encounter RAMS documents. A RAMS combines
              a risk assessment with a method statement — it covers both "what could go wrong" and
              "how we will do the work safely". Most principal contractors will not allow you to
              start work until RAMS have been submitted and approved.
            </p>
        ...
        <div className="rounded-xl border border-white/[0.06] bg-[hsl(0_0%_10%)]">
          <div className="p-4 sm:p-5 space-y-4">
            ...
            <p className="text-white text-sm leading-relaxed">
              A dynamic risk assessment is an ongoing, real-time mental process of identifying
              hazards as you encounter them during work. Even when a formal written risk assessment
              exists, conditions on site change — and you must continuously assess whether it is
              safe to continue.
            </p>
        ...
        <div className="rounded-xl border border-white/[0.06] bg-[hsl(0_0%_10%)]">
          <div className="p-4 sm:p-5 space-y-4">
            ...
            <p className="text-white text-sm leading-relaxed">
              ...
              employers to assess and control exposure to hazardous substances. As an electrician,
              you may encounter:
            </p>
        ...
        <div className="rounded-xl border border-white/[0.06] bg-[hsl(0_0%_10%)]">
          <div className="p-4 sm:p-5 space-y-4">
            ...
            <p className="text-white text-sm leading-relaxed">
              Manual handling injuries are one of the most common workplace injuries for
              electricians. Heavy cable drums, distribution boards, trunking lengths, and tools all
              need to be lifted, carried, and positioned regularly.
            </p>
          ...
          <div className="p-4 sm:p-5 space-y-3">
            ...
            <div className="rounded-md border border-white/[0.08] bg-[hsl(0_0%_8%)] p-3">
              <p className="text-white text-xs leading-relaxed">
                ...
                what you do, and to cooperate with your employer on safety. You cannot be
                disciplined or dismissed for raising a genuine safety concern — stopping an unsafe
                job is always the right call.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-xl border border-white/[0.06] bg-[hsl(0_0%_10%)]">
          <div className="p-4 sm:p-5">
            <p className="text-white text-xs leading-relaxed">
              ...
              the Control of Substances Hazardous to Health Regulations 2002, and the Manual
              Handling Operations Regulations 1992. Always follow your employer's specific risk
              assessment and method statement for each task.
            </p>
          </div>
        </div>
      </HubBody>
