    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          {
            "What to wear, what to test before you wear it, and what your employer has to provide. The kit that's between you and a serious incident — treat it accordingly."
          }
        </p>
        ...
        <div className={cn('rounded-2xl border border-elec-yellow/35', CARD_SURFACE)}>
          <div className="p-4 sm:p-5 space-y-4">
            ...
            <p className="text-white text-sm leading-relaxed">
              ...
              because it does nothing to remove the danger, it only reduces the harm if something
              goes wrong. But when you need it, it must be right.
            </p>
            <p className="text-white text-sm leading-relaxed">
              ...
              . The 2022 amendment extended those duties so they now cover "limb (b)" workers —
              agency staff and many self-employed and casual workers — not just directly employed
              staff. You are legally required to wear the PPE provided, look after it, and report
              any defects.
            </p>
          </div>
        </div>
        ...
        <div className={cn('rounded-2xl border border-elec-yellow/35', CARD_SURFACE)}>
          <div className="p-4 sm:p-5 space-y-4">
            ...
            <p className="text-white text-sm leading-relaxed">
              ...
              chosen for the risk that is left after everything above it has been applied. If you
              find yourself relying on PPE alone, stop — a higher control has probably been missed.
            </p>
            ...
            <div className="space-y-4">
              {[
                ...
                },
                {
                  ...
                  replace:
                    'Ear muff seals every 6–12 months. Disposable plugs are single use only.',
                },
                {
                  item: 'Dust Masks / RPE',
        ...
        <div className="rounded-xl border border-red-500/25 bg-red-500/[0.04]">
          <div className="p-4 sm:p-5 space-y-4">
            ...
            <p className="text-white text-sm leading-relaxed">
              An arc flash can produce temperatures up to 19,000°C and cause severe burns,
              blindness, and blast injuries. While arc flash is more common in high-voltage and
              industrial environments, it can occur at any voltage level. Special arc-rated PPE is
              required where arc flash risk has been identified.
            </p>
            ...
            <div className="rounded-md border border-red-500/25 bg-red-500/[0.04] p-3">
              <p className="text-white text-xs">
                ...
                You should not be working in arc flash risk zones without specific training, PPE,
                and close supervision. If you are asked to work on high-energy systems, speak to
                your supervisor about the arc flash risk assessment.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className={cn('rounded-2xl border border-elec-yellow/35', CARD_SURFACE)}>
          <div className="p-4 sm:p-5 space-y-4">
            ...
            <p className="text-white text-sm leading-relaxed">
              ...
              All electrical hand tools must be inspected before use. Power tools must have a
              current PAT test label and be appropriate for the environment.
            </p>
            ...
            <div className="space-y-3">
              ...
              <p className="text-white text-sm leading-relaxed">
                VDE-certified tools are individually tested to 10,000V AC and rated for working up
                to 1,000V AC. They are identified by the VDE triangle symbol and orange/red
        ...
        <div className={cn('rounded-2xl border border-elec-yellow/35', CARD_SURFACE)}>
          <div className="p-4 sm:p-5">
            <p className="text-white text-xs leading-relaxed">
              ...
              Regulations 1992 (as amended by the PPE at Work (Amendment) Regulations 2022), the BS
              EN standards cited above, and HSE guidance. Your employer must assess the risk, select
