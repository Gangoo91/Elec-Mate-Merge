    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          {
            'Falls are the biggest cause of fatal injuries on UK construction sites. Ladder use, podiums, scaffolding, mobile towers, edge protection — the rules and the practical decisions that keep you on solid ground.'
          }
        </p>
        ...
        <div className={cn('rounded-2xl border border-elec-yellow/35', CARD_SURFACE)}>
          <div className="p-4 sm:p-5 space-y-4">
            ...
            <p className="text-white text-sm leading-relaxed">
              ...
              and the single biggest killer in construction — HSE figures show falls account for
              over half of construction worker deaths. As an electrician, you will regularly work
              from ladders, step ladders, scaffolding, and mobile towers. The{' '}
        ...
        <div className={cn('rounded-2xl border border-elec-yellow/35', CARD_SURFACE)}>
          <div className="p-4 sm:p-5 space-y-4">
            ...
            <p className="text-white text-sm leading-relaxed">
              Scaffolding provides a safe working platform for longer-duration work at height. It
              must be erected and inspected by a competent person. The NASC (National Access and
              Scaffolding Confederation) publishes safety guidance including SG4 (preventing falls
              in scaffolding).
            </p>
        ...
        <div className={cn('rounded-2xl border border-elec-yellow/35', CARD_SURFACE)}>
          <div className="p-4 sm:p-5 space-y-4">
            ...
            <p className="text-white text-sm leading-relaxed">
              A Mobile Elevating Work Platform (MEWP) — a scissor lift or a boom/cherry picker —
              gives a guarded platform that can be raised to height, ideal for high-bay lighting,
              ...
              Access Federation), which issues the PAL Card (Powered Access Licence). Never operate
              a MEWP you are not licensed and authorised for.
            </p>
        ...
        <div className="rounded-xl border border-red-500/25 bg-red-500/[0.04]">
          <div className="p-4 sm:p-5 space-y-4">
            ...
            <p className="text-white text-sm leading-relaxed">
              Harnesses are a last resort — they do not prevent falls, they arrest them. A fall into
              a harness can still cause serious injury (suspension trauma, impact injuries).
              Harnesses are used when guard rails or platforms are not feasible, such as working on
              steel structures, near roof edges, or in confined access areas.
            </p>
        ...
        <div className="rounded-xl border border-red-500/25 bg-red-500/[0.04]">
          <div className="p-4 sm:p-5 space-y-4">
            ...
            <p className="text-white text-sm leading-relaxed">
              Fragile roofs and surfaces are a major cause of fatal falls. Materials like cement
              fibre sheets, glass skylights, plastic roof lights, and corroded metal sheeting can
              give way without warning. You should{' '}
              <span className="font-bold text-red-400">never</span> walk on a fragile surface unless
        ...
        <div className={cn('rounded-2xl border border-elec-yellow/35', CARD_SURFACE)}>
          <div className="p-4 sm:p-5 space-y-4">
            ...
            <p className="text-white text-sm leading-relaxed">
              As an electrician, you will frequently need to work at height. Here are the most
              common tasks and the recommended access equipment:
            </p>
            ...
            <div className="space-y-3">
              {[
                ...
                },
                {
                  ...
                  equipment:
                    'Step ladder or mobile tower depending on ceiling height and duration.',
                },
              ].map((item) => (
                <div
                  key={item.task}
        ...
        <div className={cn('rounded-2xl border border-elec-yellow/35', CARD_SURFACE)}>
          <div className="p-4 sm:p-5">
            <p className="text-white text-xs leading-relaxed">
              ...
              (thorough examination of access equipment), BS EN 361/355/795 (harnesses, lanyards,
              and anchors), and HSE guidance INDG401 (Working at height — a brief guide). Always
              follow your employer's site-specific risk assessment and method statement for working
              at height.
            </p>
          </div>
        </div>
