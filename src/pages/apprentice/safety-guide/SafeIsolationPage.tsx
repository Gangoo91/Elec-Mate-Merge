    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          {
            'The single most critical procedure in electrical work. Failing to isolate has killed electricians. Every circuit, every time — no shortcuts, no exceptions, no matter how simple the job seems.'
          }
        </p>
        ...
        <div className="rounded-xl border border-red-500/30 bg-red-500/[0.04]">
          <div className="p-4 sm:p-5 space-y-3">
            ...
            <p className="text-white text-sm leading-relaxed">
              Safe isolation is the single most critical safety procedure in electrical work.
              Failing to isolate correctly has killed electricians. Every time you work on a
              circuit, you <span className="font-bold text-red-400">must</span> follow this
              procedure — no shortcuts, no exceptions, no matter how simple the job seems.
            </p>
          </div>
        </div>
        ...
        <div className="rounded-xl border border-white/[0.06] bg-[hsl(0_0%_10%)]">
          <div className="p-4 sm:p-5 space-y-4">
            ...
            <p className="text-white text-sm leading-relaxed">
              Safe isolation is the process of disconnecting a circuit or piece of equipment from
              all sources of electrical supply and ensuring it cannot be accidentally re-energised
              while work is being carried out. It is a legal duty under the{' '}
          ...
          <div className="p-4 sm:p-5 space-y-4">
            ...
            <div className="rounded-md border border-elec-yellow/20 bg-elec-yellow/[0.04] p-3 sm:p-4">
              ...
              <p className="text-white text-sm">
                ...
                <span className="font-bold text-elec-yellow">I-I-L-P-T-P</span>. Some electricians
                use the phrase{' '}
                <span className="italic text-elec-yellow">
                  "I Isolate, Lock, Prove, Test, Prove"
                </span>{' '}
        ...
        <div className="rounded-xl border border-red-500/25 bg-red-500/[0.04]">
          <div className="p-4 sm:p-5 space-y-4">
            ...
            <p className="text-white text-sm leading-relaxed">
              A circuit can still be live after you have switched off and locked off the
              distribution board. This is why you always prove dead at the point of work, not just
              at the board. Look out for:
            </p>
            ...
            <div className="rounded-md border border-red-500/25 bg-red-500/[0.04] p-3">
              <p className="text-white text-xs">
                ...
                or AC side is disconnected. Prove dead on the DC side separately, and never assume
                an isolated AC supply has made the array safe.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-xl border border-white/[0.06] bg-[hsl(0_0%_10%)]">
          <div className="p-4 sm:p-5 space-y-4">
            ...
            <p className="text-white text-sm leading-relaxed">
              ...
              electricians. Your voltage indicator and test leads must meet these requirements.
              Using non-compliant equipment is dangerous and could make you liable in the event of
              an accident.
            </p>
        ...
        <div className="rounded-xl border border-white/[0.06] bg-[hsl(0_0%_10%)]">
          <div className="p-4 sm:p-5 space-y-4">
            ...
            <p className="text-white text-sm leading-relaxed">
              ...
              way to perform the "prove before" and "prove after" steps because it avoids the need
              to test on a live circuit.
            </p>
            ...
            <div className="space-y-3">
              {[
                ...
                },
                {
                  ...
                  consequence:
                    'Inaccurate schedules are common. Always verify at the point of work.',
                },
                {
        ...
        <div className="rounded-xl border border-elec-yellow/25 bg-elec-yellow/[0.04]">
          <div className="p-4 sm:p-5 space-y-3">
            ...
            <p className="text-white text-sm leading-relaxed">
              Safe isolation is assessed in your end-point assessment — the integrated AM2S
              practical. Failing to carry out safe isolation correctly is an automatic fail:
              assessors watch for every step, including proving the indicator before and after,
              locking off, and proving dead at all conductor combinations. Practise until it becomes
              second nature long before your assessment day.
            </p>
          </div>
        </div>
