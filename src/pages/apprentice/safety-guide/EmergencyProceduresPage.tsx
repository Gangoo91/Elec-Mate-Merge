    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          {
            'What to do when something goes wrong on site. Electrical accidents, injuries, fires, evacuations — the calm, repeatable response that keeps you and the people around you alive.'
          }
        </p>
        ...
        <div className="rounded-xl border border-red-500/30 bg-red-500/[0.04]">
          <div className="p-4 sm:p-5 space-y-3">
            ...
            <p className="text-white text-sm leading-relaxed">
              ...
              through each section, understand the steps, and practise them mentally. When you
              arrive on a new site, always find out where the first aid kit, fire extinguishers,
              assembly point, and nearest phone are located.
            </p>
          </div>
        </div>
        ...
        <div className="rounded-xl border border-red-500/25 bg-red-500/[0.04]">
          <div className="p-4 sm:p-5 space-y-4">
            ...
            <p className="text-white text-sm leading-relaxed">
              ...
              severity depends on the current path through the body, the duration of contact, and
              the voltage level. A current as low as 30mA across the heart can be fatal.
            </p>
            ...
            <div className="rounded-md border border-red-500/25 bg-red-500/[0.04] p-3 sm:p-4">
              ...
              <p className="text-white text-sm mt-3">
                ...
                do <span className="font-bold">not</span> approach. HV can arc several metres
                through the air. Stay back at least 10 metres, keep others away, and call 999 — the
                electricity is not safe until the network operator (call 105) confirms it is
            ...
            <div className="rounded-md border border-elec-yellow/20 bg-elec-yellow/[0.04] p-3 sm:p-4 space-y-2">
              ...
              <ul className="space-y-1 text-white text-xs leading-relaxed">
                ...
                <li>
                  <span className="font-bold text-elec-yellow">B — Breathing:</span> Look, listen
                  and feel for normal breathing for up to 10 seconds.
                </li>
                <li>
        ...
        <div className="rounded-xl border border-red-500/25 bg-red-500/[0.04]">
          <div className="p-4 sm:p-5 space-y-4">
            ...
            <p className="text-white text-sm leading-relaxed">
              ...
              connections, or faulty equipment. They require specific handling because water and
              some extinguishers can conduct electricity and make the situation much worse.
            </p>
        ...
        <div className="rounded-xl border border-red-500/25 bg-red-500/[0.04]">
          <div className="p-4 sm:p-5 space-y-4">
            ...
            <p className="text-white text-sm leading-relaxed">
              ...
              conductors or between a conductor and earth. Temperatures can reach 19,000°C (four
              times the temperature of the sun's surface). The blast can throw a person across a
              room, cause severe burns, damage hearing, and cause blindness.
            </p>
        ...
        <div className="rounded-xl border border-white/[0.06] bg-[hsl(0_0%_10%)]">
          <div className="p-4 sm:p-5 space-y-4">
            ...
            <p className="text-white text-sm leading-relaxed">
              ...
              (RIDDOR) requires employers and people in control of work premises to report certain
              serious workplace incidents to the HSE. As an apprentice, you need to know what is
              reportable so you can alert your supervisor.
            </p>
        ...
        <div className="rounded-xl border border-white/[0.06] bg-[hsl(0_0%_10%)]">
          <div className="p-4 sm:p-5 space-y-4">
            ...
            <p className="text-white text-sm leading-relaxed">
              ...
              adequate first aid equipment, facilities, and trained people so anyone injured or
              taken ill at work can be helped. When you arrive on a new site, you should identify:
            </p>
        ...
        <div className="rounded-xl border border-white/[0.06] bg-[hsl(0_0%_10%)]">
          <div className="p-4 sm:p-5">
            <p className="text-white text-xs leading-relaxed">
              ...
              and Safety (First-Aid) Regulations 1981, HSE first aid guidance (INDG214), and RIDDOR
              2013. Adult CPR ratio: 30 chest compressions to 2 rescue breaths (or continuous
              compressions if untrained). This guidance does not replace a recognised first aid at
              work qualification. Always follow your employer's emergency procedures and attend
