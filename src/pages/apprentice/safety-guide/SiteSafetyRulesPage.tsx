  ...
  return (
    <HubPage>
      <HubMasthead
        ...
        backTo="/apprentice/safety-fundamentals"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          {
            'The rules every site has, and why. From sign-in to PPE policy to first-aid points — knowing the rules keeps you on site, and knowing why they exist keeps you alive.'
          }
        </p>
        ...
        <div className="rounded-xl border border-white/[0.06] bg-[hsl(0_0%_10%)]">
          <div className="p-4 sm:p-5 space-y-4">
            ...
            <p className="text-white text-sm leading-relaxed">
              Construction sites are controlled environments with strict rules to protect everyone
              on site. These rules come from legislation (primarily the{' '}
              <span className="font-semibold text-elec-yellow">
                Construction (Design and Management) Regulations 2015
              </span>
              ), the principal contractor's site rules, and your employer's own safety procedures.
              As an apprentice, you must follow all site rules — ignorance is not an excuse, and
              breaking rules can result in being removed from site.
            </p>
          </div>
        </div>
        ...
        <div className="rounded-xl border border-white/[0.06] bg-[hsl(0_0%_10%)]">
          <div className="p-4 sm:p-5 space-y-4">
            ...
            <p className="text-white text-sm leading-relaxed">
              ...
              legal requirement under CDM 2015. The induction is delivered by the principal
              contractor (or client on smaller sites) and covers everything you need to know to work
              safely on that particular site.
            </p>
            ...
            <div className="rounded-md border border-elec-yellow/20 bg-elec-yellow/[0.04] p-3">
              <p className="text-white text-xs">
                ...
                show it to prove you have been inducted. If you lose it, get a replacement before
                returning to site.
              </p>
            </div>
          </div>
        ...
        <div className="rounded-xl border border-red-500/25 bg-red-500/[0.04]">
          <div className="p-4 sm:p-5 space-y-4">
            ...
            <p className="text-white text-sm leading-relaxed">
              ...
              take place under controlled conditions. It is not a risk assessment — it works
              alongside the risk assessment and method statement. The permit system ensures that the
              right checks have been done and the right people have authorised the work.
            </p>
        ...
        <div className="rounded-xl border border-white/[0.06] bg-[hsl(0_0%_10%)]">
          <div className="p-4 sm:p-5 space-y-4">
            ...
            <p className="text-white text-sm leading-relaxed">
              ...
              responsible for what, and apply to all construction work — from a domestic extension
        ...
        <div className="rounded-xl border border-white/[0.06] bg-[hsl(0_0%_10%)]">
          <div className="p-4 sm:p-5 space-y-4">
            ...
            <p className="text-white text-sm leading-relaxed">
              ...
              which requires your employer — or the principal contractor on multi-employer sites —
              to provide adequate welfare facilities from the very start of the project. You have a
              legal right to these — do not accept substandard provision.
            </p>
            ...
            <div className="rounded-md border border-elec-yellow/20 bg-elec-yellow/[0.04] p-3">
              <p className="text-white text-xs">
                ...
                (leptospirosis) from rat-contaminated water, and skin conditions from lack of
                washing facilities.
              </p>
            </div>
          </div>
        ...
        <div className="rounded-xl border border-white/[0.06] bg-[hsl(0_0%_10%)]">
          <div className="p-4 sm:p-5 space-y-4">
            ...
            <p className="text-white text-sm leading-relaxed">
              A toolbox talk is a short (5–15 minute) safety briefing given to workers, usually at
              the start of the day or before a specific task. They cover a single safety topic and
              are an opportunity to discuss hazards relevant to the current work.
            </p>
        ...
        <div className="rounded-xl border border-white/[0.06] bg-[hsl(0_0%_10%)]">
          <div className="p-4 sm:p-5 space-y-4">
            ...
            <p className="text-white text-sm leading-relaxed">
              ...
              Regulations 1996, with the symbols themselves standardised in BS EN ISO 7010. The
              colour and shape tell you what the sign means before you even read the words — learn
              them.
            </p>
        ...
        <div className="rounded-xl border border-elec-yellow/25 bg-elec-yellow/[0.04]">
          <div className="p-4 sm:p-5 space-y-3">
            ...
            <p className="text-white text-sm leading-relaxed">
              ...
              serious and imminent danger to you or others. Under the Employment Rights Act 1996,
              your employer cannot subject you to any detriment (section 44) or dismiss you (section
              100) for raising legitimate health and safety concerns or for leaving a dangerous
              situation. If you are pressured to do unsafe work, speak to your supervisor, your
              training provider, your union, or call the HSE.
            </p>
          </div>
        </div>
        ...
        <div className="rounded-xl border border-white/[0.06] bg-[hsl(0_0%_10%)]">
          <div className="p-4 sm:p-5">
            <p className="text-white text-xs leading-relaxed">
              ...
              Safety at Work etc. Act 1974, the Provision and Use of Work Equipment Regulations
              1998, the Manual Handling Operations Regulations 1992, the Health and Safety (Safety
              Signs and Signals) Regulations 1996, the Work at Height Regulations 2005, the
              Employment Rights Act 1996, and CITB/JIB guidance for the construction industry.
              Site-specific rules may vary — always follow the site induction and your principal
