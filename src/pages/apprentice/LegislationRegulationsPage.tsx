...
import { legislationSubsections } from "@/data/healthAndSafety/subsections";

const LegislationRegulationsPage = () => {
    ...
    <div className="space-y-6 animate-fade-in px-4 md:px-6">
      <div className="max-w-5xl mx-auto py-6">
        <div className="flex items-center mb-6">
          ...
          <h1 className="text-2xl font-bold text-elec-yellow">Legislation and Regulations</h1>
        </div>
        
        <p className="text-elec-light/80 mb-8">
          Study of key health and safety laws relevant to electrical work.
        </p>
        
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {legislationSubsections.map((subsection) => (
            <Link
              key={subsection.id}
              to={`/apprentice/study/eal/${courseSlug}/unit/${unitSlug}/legislation/${subsection.id}`}
...
export default LegislationRegulationsPage;
