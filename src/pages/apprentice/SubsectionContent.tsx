              ...
              {subsectionData.id === "1.1" && (
                <>
                  ...
                  <section>
                    ...
                    {/* New content - Electrical symbols visualization */}
                    <div className="mt-6">
                      <h3 className="text-lg font-semibold mb-3">Visual Guide to Electrical Symbols</h3>
                        ...
                        <div className="bg-elec-gray/50 border border-elec-yellow/20 rounded-lg p-4">
                          ...
                          <div className="space-y-4">
                            ...
                            <div className="flex flex-col items-center">
                              ...
                              <span className="text-sm text-elec-light/80">Single Socket</span>
                            </div>
                            ...
                            <div className="flex flex-col items-center">
                              ...
                              <span className="text-sm text-elec-light/80">Double Socket</span>
                            </div>
                            ...
                            <div className="flex flex-col items-center">
                              ...
                              <span className="text-sm text-elec-light/80">Switched Socket</span>
                            </div>
                          </div>
                        </div>
                              ...
                              <div className="w-14 h-14 border-2 border-white/80 rounded-md flex items-center justify-center mb-2">
                                <div className="w-8 h-8 flex flex-col items-center justify-center">
                                  ...
                                  <div className="flex items-center">
                                    <div className="w-2 h-2 border border-white rounded-full"></div>
                                    <div className="w-3 h-0.5 bg-white transform rotate-45 translate-x-1 -translate-y-1"></div>
                                  </div>
                        ...
                        <div className="bg-elec-gray/50 border border-elec-yellow/20 rounded-lg p-4">
                          ...
                          <div className="space-y-4">
                            ...
                            <div className="flex flex-col items-center">
                              ...
                              <span className="text-sm text-elec-light/80">Ceiling Light</span>
                            </div>
                      ...
                      <div className="mt-4 p-3 bg-elec-gray/30 border border-elec-yellow/10 rounded text-sm text-elec-light/80">
                        <p>Note: These symbols may vary slightly depending on the drawing standard used (BS, IEC, etc). Always refer to the drawing legend for the specific meanings of symbols in a given electrical schematic.</p>
                      </div>
                    </div>
