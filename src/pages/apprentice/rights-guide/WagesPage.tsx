    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          {
            'At least the National Minimum Wage applies. Many employers pay above. Knowing your entitlements helps you spot problems early — and gives you the words for a conversation when something looks off.'
          }
        </p>
          ...
          <div className="border-0 bg-transparent sm:rounded-xl sm:border sm:border-red-500/25 sm:bg-red-500/[0.04]">
            <div className="py-4 sm:p-5 space-y-2">
              ...
              <p className="mt-3 text-[11.5px] text-red-200/80 leading-relaxed">
                ...
                provider, the JIB, or ACAS before you let it slide. You can check whether you're
                being underpaid with the government's apprentice pay checker at
          ...
          <div className="border-0 bg-transparent sm:rounded-xl sm:border sm:border-elec-yellow/25 sm:bg-white/[0.05]">
            <div className="py-4 sm:p-5 space-y-3">
              ...
              <p className="text-[11.5px] text-white leading-relaxed">
                ...
                where it's higher. Check the latest JIB National Working Rules for the current
                figures.
              </p>
            </div>
          </div>
