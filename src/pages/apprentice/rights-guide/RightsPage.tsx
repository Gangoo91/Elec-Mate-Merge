    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          {
            "You have the same employment rights as any employee, plus extras. Your apprenticeship agreement is a legal contract — knowing what's in it protects you from unfair treatment and gets you the most from your training."
          }
        </p>
          ...
          <div className="py-4 sm:p-5 space-y-4">
            ...
            <div className="rounded-lg border border-elec-yellow/25 bg-white/[0.05] p-3">
              ...
              <p className="text-white text-xs leading-relaxed">
                ...
                months under the Employment Rights Act 2025. The originally-proposed day-one right
                was not enacted — 6 months is the final position.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="py-4 sm:p-5 space-y-4">
            ...
            <div className="rounded-lg border border-white/10 bg-white/[0.03] p-3">
              ...
              <p className="text-white text-xs leading-relaxed">
                ...
                government covering the remaining 95%. Either way the End Point Assessment is paid
                for out of the funding band — never by you. If anyone asks you to pay, that's a red
                flag.
              </p>
            </div>
          </div>
          ...
          <div className="py-4 sm:p-5">
            <div className="flex items-start gap-2">
              ...
              <p className="text-white text-sm leading-relaxed">
                <strong className="text-red-400">Important:</strong> It is illegal for an employer
                to dismiss you or treat you unfairly for raising a genuine concern about your
                rights. This is called whistleblower protection.
              </p>
            </div>
          </div>
        </div>
