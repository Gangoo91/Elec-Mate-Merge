...
const SiteJargon = () => {
  ...
  const jargonTerms = [
    {
      term: '2nd Fix',
      meaning: 'Second phase of electrical installation - switches, sockets, light fittings',
    ...
    {
      term: '1st Fix',
      meaning: 'First phase - cables, back boxes, rough wiring before plastering',
      category: 'Installation',
      difficulty: 'beginner',
      audio: true,
    },
    {
      term: 'Genny',
      meaning: 'Generator - portable power source',
      category: 'Equipment',
      difficulty: 'beginner',
      audio: true,
    },
    {
      term: 'Daisy Chain',
      meaning: 'Connecting multiple devices in series, one after another',
      category: 'Wiring',
    ...
    {
      term: 'Dead Test',
      meaning: 'Testing with power isolated/switched off',
      category: 'Testing',
      difficulty: 'beginner',
      audio: true,
    },
    {
      term: 'Live Test',
      meaning: 'Testing with power on (dangerous - needs proper procedures)',
      category: 'Testing',
      difficulty: 'advanced',
      audio: true,
    },
    {
      term: 'Sparky',
      meaning: 'Electrician (common nickname)',
      category: 'People',
      difficulty: 'beginner',
      audio: true,
    },
    {
      term: 'Mate',
      meaning: 'Apprentice or assistant electrician',
      category: 'People',
      difficulty: 'beginner',
      audio: true,
    },
    {
      term: 'Gaffer',
      meaning: 'Boss, supervisor, or site manager',
      category: 'People',
      difficulty: 'beginner',
      audio: true,
    },
    {
      term: 'Spark up',
      meaning: 'Turn the power on, energize a circuit',
      category: 'Operation',
      difficulty: 'beginner',
      audio: true,
    },
    {
      term: 'Kill it',
      meaning: 'Turn off the power, isolate a circuit',
      category: 'Operation',
      difficulty: 'beginner',
      audio: true,
    },
    {
      term: 'Hot',
      meaning: 'Live electrical circuit (dangerous)',
      category: 'Safety',
      difficulty: 'beginner',
      audio: true,
    },
    {
      term: 'Earth',
      meaning: 'Ground connection for safety',
      category: 'Safety',
      difficulty: 'beginner',
      audio: true,
    },
    ...
    {
      term: 'IR',
      meaning: 'Insulation resistance testing',
      category: 'Testing',
      difficulty: 'intermediate',
      audio: false,
    },
    {
      term: 'RCD',
      meaning: 'Residual Current Device (safety trip switch)',
      category: 'Equipment',
      difficulty: 'beginner',
      audio: true,
    },
    ...
    {
      term: 'CU',
      meaning: 'Consumer Unit (fuse box)',
      category: 'Equipment',
      difficulty: 'beginner',
      audio: true,
    },
    ...
    {
      term: '3C+E',
      meaning: '3 Core plus Earth cable',
      category: 'Cable',
      difficulty: 'beginner',
      audio: true,
    },
    {
      term: 'Ring',
      meaning: 'Ring final circuit (sockets)',
      category: 'Wiring',
      difficulty: 'intermediate',
      audio: true,
    },
    {
      term: 'Radial',
      meaning: "Circuit that goes out and doesn't return",
      category: 'Wiring',
      difficulty: 'intermediate',
      audio: true,
    },
    {
      term: 'Trunking',
      meaning: 'Plastic or metal channel for cables',
      category: 'Installation',
      difficulty: 'beginner',
      audio: true,
    },
    {
      term: 'Conduit',
      meaning: 'Tube for protecting and routing cables',
      category: 'Installation',
      difficulty: 'beginner',
      audio: true,
    },
    ...
    {
      term: 'Banjo',
      meaning: 'Metal earth tag used on glands',
      category: 'Equipment',
      difficulty: 'intermediate',
      audio: true,
    },
    {
      term: 'Choc Block',
      meaning: 'Terminal block connector',
      category: 'Equipment',
      difficulty: 'beginner',
      audio: true,
    },
    {
      term: 'Coffin',
      meaning: 'Joint box or enclosure',
      category: 'Equipment',
      difficulty: 'beginner',
      audio: true,
    },
    {
      term: 'Crimp',
      meaning: 'Method of joining cables with a metal sleeve',
      category: 'Technique',
      difficulty: 'beginner',
      audio: true,
    },
    {
      term: 'Grunt',
      meaning: 'Apprentice or labourer',
      category: 'People',
      difficulty: 'beginner',
      audio: true,
    },
    ...
    {
      term: 'Nutty',
      meaning: 'Something dangerous or dodgy',
      category: 'Safety',
      difficulty: 'beginner',
      audio: true,
    },
    {
      term: 'Pattress',
      meaning: 'Back box for switches/sockets',
      category: 'Installation',
      difficulty: 'beginner',
      audio: true,
    },
    ...
    {
      term: 'Volt stick',
      meaning: 'Non-contact voltage detector',
      category: 'Tools',
      difficulty: 'beginner',
      audio: true,
    },
    {
      term: 'Wagos',
      meaning: 'Type of connector (brand name)',
      category: 'Equipment',
      difficulty: 'beginner',
      audio: true,
    },
    {
      term: 'Bodge',
      meaning: 'Temporary or poor quality fix',
      category: 'General',
      difficulty: 'beginner',
      audio: true,
    },
    {
      term: 'Brick',
      meaning: 'Large transformer or power supply',
      category: 'Equipment',
      difficulty: 'beginner',
      audio: true,
    },
    {
      term: 'Donkey',
      meaning: 'Portable cable drum stand',
      category: 'Equipment',
      difficulty: 'beginner',
      audio: true,
    },
    {
      term: 'Duct',
      meaning: 'Cable management system',
      category: 'Installation',
      difficulty: 'beginner',
      audio: true,
    },
  ...
  const situationalPhrases = [
    {
      phrase: "Right, let's crack on",
      meaning: "Let's get started/continue working",
      situation: 'Starting work',
      formality: 'informal',
    },
    {
      phrase: "Bob's your uncle",
      meaning: "There you go, it's done",
      situation: 'Completing a task',
      formality: 'informal',
    },
    {
      phrase: 'Piece of piss',
      meaning: 'Very easy task',
      situation: 'Describing difficulty',
      formality: 'informal',
    },
    {
      phrase: 'Bodge job',
      meaning: 'Poor quality, temporary fix',
      situation: 'Describing workmanship',
      formality: 'informal',
    },
    {
      phrase: 'Proper job',
      meaning: 'Well done, correct way',
      situation: 'Praising work',
      formality: 'informal',
    },
    {
      phrase: 'Having a mare',
      meaning: 'Having a difficult/bad time',
      situation: 'Struggling with work',
      formality: 'informal',
    },
    {
      phrase: 'Wind your neck in',
      meaning: 'Calm down, stop being aggressive',
      situation: 'Conflict resolution',
      formality: 'informal',
    },
    {
      phrase: "Don't be a melt",
      meaning: "Don't be stupid/annoying",
      situation: 'Mild criticism',
      formality: 'informal',
    },
    {
      phrase: 'Safe as houses',
      meaning: 'Very secure or reliable',
      situation: 'Describing safety',
      formality: 'informal',
    },
    {
      phrase: 'Take it steady',
      meaning: "Work carefully, don't rush",
  ...
  const safetyTerms = [
    {
      term: 'Hot work',
      meaning: 'Work involving heat/sparks (welding, cutting)',
      category: 'Safety',
      difficulty: 'intermediate',
    },
    {
      term: 'Permit to work',
      meaning: 'Safety document for high-risk activities',
      category: 'Safety',
      difficulty: 'intermediate',
    },
    {
      term: 'LOTO',
      meaning: 'Lock Out Tag Out - isolation procedure',
      category: 'Safety',
      difficulty: 'advanced',
    },
    {
    ...
    },
    {
      ...
      meaning: 'Planned method to work safely',
      category: 'Safety',
      difficulty: 'intermediate',
    },
    {
      term: 'Risk assessment',
      meaning: 'Process of identifying hazards',
      category: 'Safety',
      difficulty: 'beginner',
    },
    {
      term: 'Method statement',
      meaning: 'Step-by-step work procedure',
      category: 'Safety',
      difficulty: 'intermediate',
    },
    {
      term: 'Toolbox talk',
      meaning: 'Short safety briefing',
      category: 'Safety',
      difficulty: 'beginner',
    },
  ];
  ...
  const filteredPhrases = useMemo(() => {
    return situationalPhrases.filter(
      (phrase) =>
  ...
  const getCategoryColor = (category: string) => {
    const colors = {
      ...
      General: 'border-gray-500/40 text-white',
  ...
  const getDifficultyColor = (difficulty: string) => {
    ...
    return colors[difficulty as keyof typeof colors] || 'bg-gray-500/20 text-white';
  };
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-8 animate-fade-in">
      <div className="flex flex-col items-center justify-center mb-4 sm:mb-6">
        <h1 className="text-2xl sm:text-3xl font-bold tracking-tight mb-3 sm:mb-4 px-2">
          Site Slang & Jargon Decoder
        </h1>
        <p className="text-sm sm:text-base text-white text-center max-w-2xl mb-3 sm:mb-4 px-2">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <TabsList className="grid w-full grid-cols-2 sm:grid-cols-4 h-auto">
          ...
          <TabsTrigger value="phrases" className="text-xs sm:text-sm py-2">
            Phrases
          </TabsTrigger>
          <TabsTrigger value="regional" className="text-xs sm:text-sm py-2">
            Regional
          </TabsTrigger>
        ...
        <TabsContent value="terminology" className="space-y-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-4">
            <Card className="border-elec-yellow/20 bg-white/5 border border-white/10">
              <CardContent className="p-3 sm:p-4 text-center">
                ...
                <div className="text-xs sm:text-sm text-white">Terms Found</div>
              </CardContent>
            </Card>
            <Card className="border-elec-yellow/20 bg-white/5 border border-white/10">
              <CardContent className="p-3 sm:p-4 text-center">
                ...
                <div className="text-xs sm:text-sm text-white">Beginner</div>
              </CardContent>
            </Card>
            <Card className="border-elec-yellow/20 bg-white/5 border border-white/10">
              <CardContent className="p-3 sm:p-4 text-center">
                ...
                <div className="text-xs sm:text-sm text-white">Intermediate</div>
              </CardContent>
            </Card>
            <Card className="border-elec-yellow/20 bg-white/5 border border-white/10">
              <CardContent className="p-3 sm:p-4 text-center">
                ...
                <div className="text-xs sm:text-sm text-white">Advanced</div>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
            {filteredTerms.map((item, index) => (
              <Card
                key={index}
                className="border-elec-yellow/20 bg-white/5 hover:bg-white/10 transition-colors"
              >
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {filteredPhrases.map((phrase, index) => (
                  <div
                    key={index}
                    className="border border-elec-yellow/20 rounded-lg p-4 bg-white/5 border border-white/10"
                  >
                    <h4 className="font-semibold text-white mb-1">"{phrase.phrase}"</h4>
                    <p className="text-sm text-white mb-2">{phrase.meaning}</p>
                    <div className="flex gap-2">
                      ...
                      <Badge
                        variant="outline"
                        className={
                          phrase.formality === 'informal' ? 'text-orange-300' : 'text-blue-300'
                        }
                      >
                        {phrase.formality}
                      </Badge>
            ...
            {filteredRegionalTerms.map((region, index) => (
              <Card key={index} className="border-elec-yellow/20 bg-white/5">
                <CardHeader>
                  ...
                  <p className="text-sm text-white">{region.accent}</p>
                </CardHeader>
                <CardContent>
                  <div className="space-y-3">
                    {region.terms.map((term, termIndex) => (
                      <div key={termIndex} className="flex justify-between items-start">
                        ...
                        <span className="text-sm text-white text-right">{term.meaning}</span>
                      </div>
                    ))}
                  </div>
                </CardContent>
            ...
            <CardContent className="space-y-6">
              ...
              <div>
                <h3 className="font-semibold text-white mb-3">
                  Safety-Critical Terms (Learn These First!)
                </h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  {safetyTerms.map((term, index) => (
                    <div key={index} className="p-3 border border-red-500/30 rounded-lg bg-card">
                      ...
                      <p className="text-sm text-white mt-1">{term.meaning}</p>
                    </div>
                  ))}
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="space-y-2">
              ...
              <p className="text-sm text-white">
                Quick understanding of urgent safety instructions can prevent accidents and save
                lives.
              </p>
            </div>
            <div className="space-y-2">
