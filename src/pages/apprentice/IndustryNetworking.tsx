  ...
  const networkingOpportunities = [
    {
      ...
      description:
        'Connect with industry professionals through established electrical trade bodies and their regional events',
      examples: [
      ...
      benefits: [
        ...
        'Contract and partnership opportunities',
      ],
    ...
    },
    {
      ...
      description:
        'Build relationships with peers whilst gaining qualifications and updating skills',
      examples: [
      ...
      benefits: [
        ...
        'Course collaboration and study groups',
        'Ongoing professional contacts',
    ...
    },
    {
      ...
      description:
        'Major trade shows featuring the latest electrical products, technologies, and industry innovations',
      examples: [
      ...
      benefits: [
        'Latest product knowledge',
        'Manufacturer representative contacts',
    ...
    },
    {
      ...
      description:
        'Regional groups of electrical contractors and professionals focused on local business development',
      examples: [
    ...
    },
    {
      ...
      description:
        'Digital platforms connecting electrical professionals for knowledge sharing and career development',
      examples: [
    ...
    },
    {
      ...
      description:
        'Formal and informal relationships connecting experienced professionals with newcomers',
      examples: [
    ...
    },
    {
      ...
      description:
        'Build relationships with electrical suppliers, manufacturers, and their representatives',
      examples: [
  ...
  const networkingStrategy = [
    ...
    },
    {
      ...
      goals: [
        ...
        'Explore specialist opportunities',
      ],
    },
    {
    ...
    <div className="max-w-7xl mx-auto space-y-8 animate-fade-in">
      <div className="flex flex-col items-center justify-center mb-6">
        <h1 className="text-3xl font-bold tracking-tight mb-4">
          Professional Networking in the Electrical Industry
        </h1>
        <p className="text-white text-center max-w-2xl mb-4">
          Build meaningful professional relationships that accelerate career growth, create business
          opportunities, and keep you connected to industry developments. Networking is essential
          for long-term success in the electrical trade.
        </p>
        <SmartBackButton />
      </div>
        ...
        {networkingOpportunities.map((opportunity, index) => (
          ...
          >
            <CardHeader>
              ...
              <p className="text-white text-sm">{opportunity.description}</p>
            </CardHeader>
      ...
      <Card className="border-elec-yellow/20 bg-gradient-to-r from-elec-yellow/10 to-elec-yellow/5">
        <CardHeader>
          <CardTitle className="text-elec-yellow">
            UK Electrical Industry Associations & Bodies
          </CardTitle>
        </CardHeader>
        <CardContent>
          <p className="text-white mb-4">
            Strategic membership in industry associations provides structured networking
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {keyAssociations.map((association, index) => (
              <div key={index} className="border border-elec-yellow/20 rounded-lg p-4">
                ...
                <p className="text-white text-sm mb-3">{association.focus}</p>
                <div className="space-y-1 mb-3">
                  {association.benefits.map((benefit, benefitIndex) => (
                    <div key={benefitIndex} className="text-xs text-white flex items-center gap-2">
                      <span className="text-elec-yellow">•</span>
                      {benefit}
                    </div>
                  ))}
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-xs text-white">{association.bestFor}</span>
                </div>
              </div>
            ))}
          </div>
      ...
      <Card className="border-elec-yellow/20 bg-white/5">
        <CardHeader>
          <CardTitle className="text-elec-yellow">
            Building Your Professional Brand & Reputation
          </CardTitle>
        </CardHeader>
        <CardContent>
          ...
          <div className="mt-6 p-4 bg-elec-yellow/10 rounded-lg">
            ...
            <p className="text-white text-sm">
              The most successful electrical professionals view networking as relationship building,
              not just business card collection. Focus on how you can help others first, and
              opportunities will naturally follow. Remember that strong professional relationships
              often take years to develop but can provide career opportunities, business referrals,
              and industry insights that last throughout your career.
            </p>
          </div>
        </CardContent>
      </Card>
