    ...
    <div className="max-w-7xl mx-auto space-y-8 animate-fade-in">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
        <Card className="border-elec-yellow/20 bg-gradient-to-b from-elec-yellow/10 to-elec-yellow/5 hover:from-elec-yellow/15 hover:to-elec-yellow/10 transition-all duration-300 shadow-lg shadow-black/20">
          <CardContent className="flex flex-col items-center justify-center p-4 sm:p-6 h-full">
            ...
            <p className="text-center text-white mb-4">
              Review addition, subtraction, multiplication, and division - the foundation for all
              electrical calculations.
            </p>
            <Button variant="study" className="mt-auto">
              Study Now
            </Button>
          </CardContent>
        </Card>
        ...
        <Card className="border-elec-yellow/20 bg-gradient-to-b from-elec-yellow/10 to-elec-yellow/5 hover:from-elec-yellow/15 hover:to-elec-yellow/10 transition-all duration-300 shadow-lg shadow-black/20">
          <CardContent className="flex flex-col items-center justify-center p-4 sm:p-6 h-full">
            ...
            <p className="text-center text-white mb-4">
              Learn how to calculate percentages and work with ratios, essential for voltage drop
              calculations.
            </p>
            <Button variant="study" className="mt-auto">
              Study Now
        ...
        <Card className="border-elec-yellow/20 bg-gradient-to-b from-elec-yellow/10 to-elec-yellow/5 hover:from-elec-yellow/15 hover:to-elec-yellow/10 transition-all duration-300 shadow-lg shadow-black/20">
          <CardContent className="flex flex-col items-center justify-center p-6 h-full">
            ...
            <p className="text-center text-white mb-4">
              Understand how to rearrange formulas and solve equations crucial for electrical
              formulas.
            </p>
            <Button variant="study" className="mt-auto">
              Study Now
      ...
      <div className="bg-amber-950/20 border border-amber-600/30 rounded-md p-6 mt-8">
        <h3 className="text-lg font-semibold text-elec-yellow mb-2">
          Why Maths Matters in Electrical Work
        </h3>
        <p className="text-sm text-amber-200/90 mb-4">
          Strong mathematical skills are critical for electricians to accurately calculate
          electrical loads, determine proper wire sizes, measure voltage drop, and ensure
          installations meet safety standards. This refresher course helps you build the
          mathematical foundation needed for successful electrical work.
        </p>
