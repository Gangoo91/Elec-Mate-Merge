...
const OnJobSupervisorKnowledge = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Apprentice · Ask a supervisor"
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          {
            "The questions you'd ask a senior sparky if they had time. Searchable knowledge bank covering safety, technical, and the awkward 'how do I…' moments."
          }
        </p>
            ...
            <div className="flex flex-col h-full">
              ...
              <div className="flex-1 overflow-y-auto px-5 pb-6 space-y-2.5">
                ...
                {emergencyContacts.map((contact) => (
                  <Card key={contact.id} className="border-red-500/25 bg-red-500/[0.04]">
