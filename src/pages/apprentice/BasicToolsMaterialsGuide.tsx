...
const BasicToolsMaterialsGuide = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-8 animate-fade-in">
      ...
      {/* NEW: Electrical Installation Guides Section */}
      <Card className="border-elec-yellow/30 bg-gradient-to-br from-elec-yellow/5 via-elec-gray to-elec-dark/80">
        <CardHeader className="bg-elec-yellow/15 rounded-t-lg">
          <div className="flex items-center gap-3">
            ...
            <div>
              <CardTitle className="text-elec-yellow text-2xl">Electrical Installation Guides</CardTitle>
              <p className="text-muted-foreground mt-1">Step-by-step installation guides for different electrical environments</p>
            </div>
          </div>
        </CardHeader>
