  ...
  const certifications = [
    {
      ...
      cost: '£300-£500',
      description:
        'Essential qualification covering current UK wiring regulations - legally required for all electrical work',
      requirements: [
      ...
      benefits: [
        ...
        'Required by all registration schemes',
      ],
    ...
    },
    {
      ...
      cost: '£800-£1,200',
      description:
        'Enables you to inspect, test and certify electrical installations - essential for EICR work',
      requirements: [
        'Level 3 Electrical Installation',
        'AM2 or equivalent practical experience',
        '18th Edition certification',
        'Minimum 2 years experience',
      ],
      benefits: [
        'Issue Electrical Installation Condition Reports',
        'Higher earning potential (£200-£400 per EICR)',
        'Work independently',
        'Required for Approved Electrician status',
      ],
    ...
    },
    {
      ...
      cost: '£600-£800',
      description:
        'Qualify to test and commission new electrical installations and issue completion certificates',
      requirements: [
        'Level 3 electrical qualification',
        'Understanding of testing procedures',
        '18th Edition knowledge',
      ],
      benefits: [
        'Test new installations',
        'Issue installation certificates',
    ...
    },
    {
      ...
      cost: '£200-£400',
      description:
        'Portable Appliance Testing - inspect and test electrical equipment in workplaces',
      requirements: [
        'Basic electrical knowledge',
      ...
      benefits: [
        'Additional income stream (£2-5 per test)',
    ...
    },
    {
      ...
      cost: '£500-£2,000',
      description:
        'Install and programme intelligent building systems including lighting, heating, security and audio-visual',
      requirements: [
        'Electrical qualification',
        'IT understanding helpful',
    ...
    },
    {
      ...
      cost: '£800-£1,500',
      description:
        'Install solar photovoltaic systems and qualify for government green energy schemes',
      requirements: [
        'Level 3 electrical qualification',
      ...
      benefits: [
        ...
        'Installation rates £150-200/kWp',
      ],
    ...
    },
    {
      ...
      cost: '£400-£800',
      description:
        'Install and maintain electric vehicle charging infrastructure for domestic and commercial use',
      requirements: [
        'Electrical qualification',
        'Understanding of charging standards',
        'Knowledge of OLEV grant schemes',
      ],
      benefits: [
    ...
    },
    {
      ...
      cost: '£300-£800',
      description:
        'Work safely in potentially explosive atmospheres - essential for oil, gas, chemical industries',
      requirements: [
        'Electrical qualification',
      ...
      benefits: [
        'Access to high-paying industrial work',
        'Oil and gas industry opportunities',
        'Offshore work possibilities',
        'Premium rates £300-500/day',
      ],
    ...
    },
    {
      ...
      cost: '£1,500-£3,000',
      description:
        'Become a qualified electrical trainer or assessor in colleges or training centres',
      requirements: [
      ...
      benefits: [
        ...
        'Regular hours and holidays',
        'Job security in education sector',
      ],
    ...
    <div className="max-w-7xl mx-auto space-y-8 animate-fade-in">
      <div className="flex flex-col items-center justify-center mb-6">
        <h1 className="text-3xl font-bold tracking-tight mb-4">
          Professional Electrical Certifications
        </h1>
        <p className="text-white text-center max-w-2xl mb-4">
          Advance your electrical career with industry-recognised qualifications. These
          certifications open new opportunities, increase earning potential, and demonstrate
          professional competence to clients and employers.
        </p>
        <SmartBackButton />
      </div>
      ...
      <Card className="border-elec-yellow/20 bg-gradient-to-r from-elec-yellow/10 to-elec-yellow/5">
        ...
        <CardContent>
          <p className="text-white mb-4">
            To maintain your registration with UK competent person schemes, you must complete
      ...
      <Card className="border-elec-yellow/20 bg-white/5">
        <CardHeader>
          <CardTitle className="text-elec-yellow">
            Certification Strategy for Electrical Apprentices
          </CardTitle>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <h4 className="font-semibold text-white mb-3">
                Priority Order for New Electricians:
              </h4>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-white">
                ...
                <li className="flex items-start gap-2">
                  <span className="text-elec-yellow">•</span>
                  Calculate return on investment - 2391 can increase earnings by £8,000-£12,000
                  annually
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-elec-yellow">•</span>
              ...
              <div className="mt-4 p-3 bg-elec-yellow/10 rounded-lg">
                ...
                <p className="text-xs text-white">
                  The average Approved Electrician earns £10,000-£15,000 more annually than a
                  standard electrician. The initial investment of £2,000-£3,000 in qualifications
