...
const IndustryNews = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-elec-dark via-elec-dark/98 to-elec-dark/95 text-white pb-safe">
      <Helmet>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8 pt-safe">
        <NewIndustryNewsCard />
      </div>
    </div>
  );
