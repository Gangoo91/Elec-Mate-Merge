    ...
    <main className="space-y-6 animate-fade-in">
      ...
      <section className="space-y-4 relative z-10">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full relative">
          <TabsList className="flex w-full overflow-x-auto scrollbar-hide lg:grid lg:grid-cols-5 bg-elec-gray border border-elec-yellow/20 relative z-20 gap-2 p-2 h-fit">
