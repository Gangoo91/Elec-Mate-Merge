            ...
            summary={
              <div className="space-y-3">
                <p className="text-white">
                  ...
                  directly influences your service offerings, pricing strategy, and marketing
                  approach.
                </p>
                <div className="flex flex-wrap gap-2 mt-4">
                  <span className="px-3 py-1.5 text-xs font-medium rounded-lg bg-yellow-400/10 text-yellow-400 border border-yellow-400/20">
                  ...
                  {[
                    {
                      ...
                      desc: 'Repairs, upgrades, safety certificates. Value trust and reliability.',
                      avg: '£150-500/job',
                    },
                    {
                      segment: 'Landlords & Letting Agents',
                      desc: 'EICR certificates, compliance work, regular maintenance contracts.',
                      avg: '£200-400/property',
                    },
                    {
                      segment: 'Property Developers',
                      desc: 'New builds, renovations, large-scale projects. Volume work, longer payment terms.',
                      avg: '£5k-50k/project',
                    },
                    {
                      segment: 'Commercial Clients',
                      desc: 'Offices, retail, industrial. Regular maintenance, emergency callouts.',
                      avg: '£500-5k/job',
                    },
                  ].map((cust, i) => (
            ...
            <div className="space-y-5">
              <div className="p-5 rounded-xl bg-white/[0.03] border border-white/10">
                ...
                <div className="space-y-3">
                  {[
                    {
                      item: 'Professional hand & power tool kit',
                      amount: '£3,000 - £8,000',
                      note: 'Quality brands last longer and inspire client confidence',
                    },
                    {
                      item: 'Test equipment (multifunction tester, voltage indicators)',
                      amount: '£1,500 - £3,000',
                      note: 'Essential for Part P compliance and certification',
                    },
                    {
                      item: 'Commercial vehicle (van)',
                      amount: '£8,000 - £20,000',
                      note: 'Consider lease options to preserve cash flow',
                    },
                    {
                      item: 'Public liability insurance (£2-5m cover)',
                      amount: '£800 - £2,500/year',
                      note: 'Required by most scheme providers and commercial clients',
                    },
                  ].map((inv, i) => (
                    <div
                      key={i}
                      className="flex flex-col sm:flex-row sm:items-center sm:justify-between py-3 border-b border-white/5 last:border-0 gap-2"
                    >
              ...
              <div className="p-5 rounded-xl bg-white/[0.03] border border-white/10">
                ...
                <div className="space-y-3">
                  {[
                    {
                      item: 'Company registration & legal setup',
                      amount: '£100 - £500',
                      note: 'Ltd company via Companies House or accountant',
                    },
                    {
                      item: 'Professional qualifications (if needed)',
                      amount: '£2,000 - £4,000',
                      note: '18th Edition, 2391, AM2 if not already qualified',
                    },
                    {
                      item: 'Scheme membership (NICEIC/NAPIT/ELECSA)',
                      amount: '£500 - £800/year',
                      note: 'Required for Part P self-certification',
                    },
                    {
                      item: 'Branding, website & marketing materials',
                      amount: '£1,000 - £3,000',
                      note: 'Professional image attracts better clients',
                    },
                  ].map((inv, i) => (
                    <div
                      key={i}
              ...
              <div className="p-5 rounded-xl bg-white/[0.03] border border-white/10">
                ...
                <div className="space-y-3">
                  {[
                    {
                      item: '3-6 month personal living expenses',
                      amount: '£6,000 - £12,000',
                      note: 'You may not draw a salary immediately',
                    },
                    {
                      item: 'Initial material stock & consumables',
                      amount: '£2,000 - £5,000',
                      note: 'Cable, accessories, fixings for first jobs',
                    },
                    {
                      item: 'Emergency & contingency fund',
                      amount: '£3,000 - £8,000',
                      note: 'Van breakdown, tool replacement, slow periods',
                    },
                    {
                      item: 'Marketing & growth investment',
                      amount: '£2,000 - £5,000',
                      note: 'Google Ads, Checkatrade, vehicle graphics',
                    },
                  ].map((inv, i) => (
                    <div
                      key={i}
              ...
              {[
                {
                  ...
                  pros: [
                    'Register online in minutes with HMRC',
                  ...
                  cons: [
                    ...
                    'Can look less professional to larger clients',
                ...
                },
                {
                  ...
                  cons: [
                    'More complex accounting and annual filings',
                    'Director responsibilities and compliance duties',
                ...
                },
                {
                  ...
                  pros: [
                    'Pool resources, tools, and client bases',
                    "Share workload and cover each other's holidays",
                    'Combined skills cover more service types',
                    'Limited liability with LLP structure',
                  ],
                  cons: [
                    'Joint decision-making required on major issues',
                    'Profits shared according to partnership agreement',
                    'Potential for disputes between partners',
                    'More complex exit if partnership dissolves',
                  ],
                },
              ].map((structure, i) => (
          ...
          >
            <div className="space-y-5">
              <InfoList
                ...
                items={[
                  {
                    title: 'Complete detailed local market research',
                    description:
                      'Analyse competitors, pricing, and identify your target customer segments and service area.',
                  },
                  {
                    title: 'Define service offerings and pricing strategy',
                    description:
                      "Decide which services you'll offer and research competitive pricing for your area.",
                  },
                  {
                    title: 'Calculate startup costs and create 12-month cash flow forecast',
                    description:
                      'Document all required investments and project monthly income/expenses.',
                  },
                  {
                  ...
                  },
                  {
                    ...
                    description:
                      'Public liability, employers liability (if hiring), and NICEIC/NAPIT membership.',
                  },
                  {
                    title: 'Set up business banking and accounting systems',
                    description:
                      'Separate business account, accounting software, and processes for invoicing and expenses.',
                  },
                  {
                    title: 'Create marketing plan and establish online presence',
                    description:
                      'Website, Google Business Profile, social media, and customer acquisition strategy.',
                  },
                ]}
              />
                ...
                <div className="space-y-3">
                  {[
                    ...
                    },
                    {
                      ...
                      target: 'Consider hiring first employee',
                    },
                  ].map((item, i) => (
                    <div
                      key={i}
                      className="flex flex-col sm:flex-row sm:items-center sm:justify-between py-3 border-b border-white/5 last:border-0 gap-1"
                    >
        ...
        <section id="legal" className="scroll-mt-32 space-y-6 pt-10 border-t border-white/10">
          ...
          >
            <InfoList
              ...
              items={[
                {
                  title: 'Register with HMRC for Self-Assessment or Corporation Tax',
                  description:
                    'Sole traders register for self-assessment within 3 months of starting. Limited companies register for corporation tax within 3 months of starting to trade.',
                  detail: 'Online registration takes 10-20 minutes',
                },
                {
                ...
                },
                {
                  ...
                  description:
                    'Keep business and personal finances completely separate. Most banks offer free business banking for the first 1-2 years.',
            ...
            <div className="space-y-5">
              <div className="p-5 rounded-xl bg-white/[0.03] border border-white/10">
                ...
                <div className="space-y-3">
                  {[
                    {
                      qual: 'Level 3 NVQ/Diploma in Electrical Installation',
                      cost: '£2,000 - £3,500',
                    ...
                    {
                      qual: 'City & Guilds 2391 Inspection & Testing',
                      cost: '£600 - £900',
                      note: 'Required for certification of completed work',
                    },
                    {
                      qual: 'AM2 Assessment (if not completed in apprenticeship)',
                      cost: '£500 - £700',
                      note: 'Practical assessment for scheme membership',
                    },
                  ].map((q, i) => (
                    <div
                      key={i}
                ...
                {[
                  {
                    ...
                    cost: '£300 - £600/year',
                    note: 'Covers injury to public and damage to property. Required by most scheme providers.',
                  },
                  {
                    type: 'Employers Liability Insurance',
                    coverage: '£10 million minimum (legal requirement)',
                    cost: '£400 - £800/year',
                    note: 'Legally required if you employ anyone, even casually. Fines up to £2,500 per day without it.',
                  },
                  {
                    type: 'Professional Indemnity Insurance',
                    coverage: '£1-2 million recommended',
                    cost: '£200 - £400/year',
                    note: 'Covers claims arising from professional advice or design errors. Important for design work.',
                  },
                  {
                    type: 'Tool & Equipment Insurance',
                    coverage: 'Full replacement value',
                    cost: '£150 - £300/year',
                    note: "Covers theft from van and damage. Check van insurance doesn't already include this.",
                  },
                ].map((ins, i) => (
                  <div key={i} className="p-4 rounded-lg bg-white/[0.02] border border-white/5">
          ...
          >
            <div className="space-y-3">
              {[
                {
                  name: 'NICEIC',
                  desc: 'The leading certification body for electrical contractors. Offers domestic and commercial installer schemes. Trusted by insurance companies and commercial clients.',
                  link: 'niceic.com',
                },
                {
                  name: 'NAPIT',
                  desc: 'National Association of Professional Inspectors and Testers. Comprehensive scheme with good value pricing and excellent support.',
                  link: 'napit.org.uk',
                },
                {
                  name: 'ELECSA',
                  desc: 'Electrical Self-Assessment scheme, now part of NAPIT group. Good option for those focusing on domestic work.',
                  link: 'elecsa.co.uk',
                },
                {
                  name: 'ECA',
                  desc: "The Electrical Contractors' Association. Trade association offering business support, legal advice, and networking. Best for larger contractors.",
                  link: 'eca.co.uk',
                },
                {
                  name: 'JIB',
                  desc: "Joint Industry Board. Sets employment standards, grades, and pay rates. Important if you're employing others.",
                  link: 'jib.org.uk',
                },
              ].map((body, i) => (
                <div
                  key={i}
                  className="flex items-start justify-between p-4 rounded-xl bg-white/[0.03] border border-white/10 gap-4"
                >
                  <div className="flex-1">
              ...
              {[
                {
                  ...
                  phone: '0300 200 3300',
                  desc: 'Tax registration, VAT queries, self-assessment help. Open Mon-Fri 8am-6pm.',
                },
                {
                  name: 'Business Wales / Business Gateway (Scotland)',
                  phone: '03000 6 03000',
                  desc: 'Free business advice, mentoring, and startup support. Regional advisors available.',
                },
                {
                  name: 'ACAS Helpline',
                  phone: '0300 123 1100',
                  desc: 'Employment relations, contracts, disputes, and HR guidance. Essential when hiring.',
                },
                {
                  name: 'Health & Safety Executive',
                  phone: '0300 003 1747',
                  desc: 'Workplace safety requirements, COSHH, risk assessments, reporting incidents.',
                },
              ].map((line, i) => (
                <div
                  key={i}
                  className="flex flex-col sm:flex-row sm:items-center justify-between p-4 rounded-xl bg-white/[0.03] border border-white/10 gap-3"
                >
                  <div className="flex-1">
              ...
              {[
                {
                  ...
                  url: 'gov.uk/set-up-business',
                  desc: 'Official government guide covering registration, tax, and legal requirements.',
                },
                {
                  name: 'Companies House WebFiling',
                  url: 'companieshouse.gov.uk',
                  desc: 'Register and manage your limited company online. File annual accounts and returns.',
                },
                {
                  name: 'Start Up Loans',
                  url: 'startuploans.co.uk',
                  desc: 'Government-backed loans up to £25,000 at 6% fixed interest with free mentoring.',
                },
                {
                  name: 'Electrical Safety First',
                  url: 'electricalsafetyfirst.org.uk',
                  desc: 'Safety guidance, best practice resources, and consumer information.',
                },
                {
                  name: 'IET Wiring Regulations',
                  url: 'theiet.org',
                  desc: 'BS 7671 updates, guidance notes, and technical resources from the regulation authors.',
                },
              ].map((resource, i) => (
                <a
                  key={i}
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-white leading-relaxed">
                ...
                started with a single step. Use the resources on this page, join industry bodies for
                support, and don't hesitate to ask questions.
              </p>
            </div>
          </div>
        </div>
