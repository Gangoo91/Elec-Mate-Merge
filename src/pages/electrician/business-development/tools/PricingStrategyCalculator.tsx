                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <div className="flex justify-between items-center py-2 font-medium bg-white/5 px-2 rounded">
                      ...
                      <span className="text-white font-mono">
                        {formatCurrency(result.subtotalNet)}
                      </span>
                    </div>
                    <div className="flex justify-between items-center py-2 border-b border-white/10">
                      <span className="text-white/80">
            ...
            <CollapsibleContent className="p-4 pt-0">
              ...
              <div className="mt-4 pt-3 border-t border-amber-500/20">
                <p className="text-xs text-amber-200/60">
                  ...
                  Prices are estimates. Verify reduced VAT eligibility where applicable. CIS
                  deductions may apply for subcontract labour. All designs must comply with BS
                  7671:2018+A3:2024.
                </p>
              </div>
            </CollapsibleContent>
