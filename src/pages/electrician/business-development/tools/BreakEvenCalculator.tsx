            ...
            {markupNum < 15 && markupNum > 0 && (
              <div className="mt-3 p-3 rounded-xl bg-amber-500/10 border border-amber-500/30">
                <div className="flex items-center gap-2 text-amber-400 text-sm">
                  ...
                  <span>Markup below 15% may not cover procurement time and wastage</span>
                </div>
              </div>
            )}
          </div>
            ...
            {marginNum < 10 && marginNum > 0 && (
              <div className="mt-3 p-3 rounded-xl bg-red-500/10 border border-red-500/30">
                <div className="flex items-center gap-2 text-red-400 text-sm">
                  <AlertTriangle className="h-4 w-4" />
                  <span>Margin below 10% leaves little room for unexpected costs</span>
                </div>
              </div>
            )}
          </div>
                ...
                <CollapsibleContent className="p-4 pt-0 space-y-4">
                  ...
                  <div className="p-3 rounded-xl bg-white/5 border border-white/10 space-y-2">
                    ...
                    <div className="space-y-1 text-sm">
                      <div className="flex justify-between text-white">
                        <span>
                          Labour ({exHoursNum}h × {currency(breakEvenHr)})
                        </span>
                        <span className="text-white">{currency(exLabourCost)}</span>
                      </div>
                      <div className="flex justify-between text-white">
                        <span>
                          Materials ({currency(exMatsNum)} + {markupNum}%)
                        </span>
                      ...
                      <div className="flex justify-between text-white pt-2 border-t border-white/10">
                        ...
                        <span className="text-green-400">
                          +{currency(targetUplift - basePrice)}
                        </span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="p-4 rounded-xl bg-green-500/10 border border-green-500/30 text-center">
                      ...
                      <p className="text-xs text-green-300/60 mt-1">Includes {marginNum}% margin</p>
                    </div>
                    <div
