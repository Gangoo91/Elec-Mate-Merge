        ...
        <CalculatorResult category="business">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-between py-2 border-b border-white/10">
              <span className="text-sm text-white font-medium">Hours Variance</span>
            ...
            {/* Labour Variance */}
            <div className="flex items-center justify-between py-2 border-b border-white/10">
              <span className="text-sm text-white font-medium">Labour Cost Variance</span>
              <div className="flex items-center gap-2">
            ...
            {/* Materials Variance */}
            <div className="flex items-center justify-between py-2 border-b border-white/10">
              <span className="text-sm text-white font-medium">Materials Variance</span>
              <div className="flex items-center gap-2">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 py-3 bg-white/5 px-3 rounded-lg mt-2">
              ...
              <div className="flex items-center gap-2">
                <span className={getVarianceColor(totalVar)}>{getVarianceIcon(totalVar)}</span>
                <strong
                  className="text-lg"
                  style={{
                    backgroundImage:
            ...
            <div className="mt-3 p-3 bg-white/5 rounded-lg border border-white/10">
              <p className="text-sm text-white">
                {Math.abs(parseFloat(totalVarPercent)) < 5 ? (
                  ...
                  <>
                    <strong className="text-red-400">Over budget.</strong> The job cost{' '}
                    {currency(Math.abs(totalVar))} more than quoted. Review your notes to understand
                    why.
                  </>
                ) : (
                  <>
                    <strong className="text-amber-400">Under budget.</strong> The job cost{' '}
                    {currency(Math.abs(totalVar))} less than quoted. Good margin protection.
                  </>
                )}
              </p>
            </div>
