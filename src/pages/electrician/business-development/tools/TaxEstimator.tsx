...
const TaxEstimator = () => {
  ...
  const basicRateIncome = Math.min(
    ...
    MARKET_RATES_2025.taxRates.basicRateThreshold
  );
  const higherRateIncome = Math.max(
    0,
    personalTaxableIncome - MARKET_RATES_2025.taxRates.basicRateThreshold
  );
  ...
  const class2NI = taxableProfit > 6515 ? 183.6 : 0; // 2025/26 Class 2 NI
  ...
  // VAT calculation
  const vatDue = inputs.vatRegistered
    ? inputs.annualRevenue * (MARKET_RATES_2025.taxRates.vatRate / 100)
    : 0;
  const vatOnExpenses = inputs.vatRegistered
    ? inputs.businessExpenses * (MARKET_RATES_2025.taxRates.vatRate / 100)
    : 0;
    ...
    <div className="bg-background  ">
      <div className="container mx-auto px-4 py-8 max-w-6xl animate-fade-in">
        <Helmet>
          ...
          <meta
            name="description"
            content="Calculate UK electrician tax and National Insurance for 2025/26. Income tax, Class 2/4 NI, VAT and take-home pay calculator."
          />
        ...
        <div className="flex flex-col items-center justify-center mb-8">
          ...
          <p className="text-muted-foreground text-center max-w-2xl mb-6">
            Calculate your Income Tax, National Insurance, and VAT liability for the 2025/26 tax
            year. Updated with latest HMRC rates and thresholds.
          </p>
          <BackButton
          ...
          <Card className="border-elec-yellow/20 bg-elec-card">
            ...
            <CardContent className="space-y-6">
              ...
              <MobileInput
                ...
                onChange={(e) =>
                  updateInput('personalAllowanceUsed', parseFloat(e.target.value) || 0)
                }
                unit="£"
          ...
          <Card className="border-elec-yellow/20 bg-elec-card mt-8">
            ...
            <CardContent>
              <div className="text-sm text-muted-foreground space-y-2">
                <p>
                  • This is an estimate based on 2025/26 tax rates and may not account for all
