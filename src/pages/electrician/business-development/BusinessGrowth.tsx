        ...
        <Card className="border-elec-yellow/20">
          <CardHeader className="pb-3">
            <div className="flex items-center gap-3">
              <Rocket className="h-6 w-6 text-elec-yellow" />
              <div>
                <CardTitle>Market Positioning & Specialisation</CardTitle>
                <CardDescription>Finding your niche in the electrical industry</CardDescription>
              </div>
            </div>
          </CardHeader>
        ...
        <Card className="border-elec-yellow/20">
          <CardHeader className="pb-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                <CardTitle>Effective Marketing Strategies</CardTitle>
                <CardDescription>Building visibility in your local market and beyond</CardDescription>
              </div>
            </div>
          </CardHeader>
          <CardContent className="space-y-3 text-slate-200">
        ...
        <Card className="border-elec-yellow/20">
          <CardHeader className="pb-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                <CardTitle>Operational Excellence & Efficiency</CardTitle>
                <CardDescription>Streamline your processes to handle increased workload</CardDescription>
              </div>
            </div>
          </CardHeader>
          <CardContent className="space-y-3 text-slate-200">
        ...
        <Card className="border-elec-yellow/20">
          <CardHeader className="pb-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                <CardTitle>Team Building & Development</CardTitle>
                <CardDescription>Growing beyond a one-person operation</CardDescription>
              </div>
            </div>
          </CardHeader>
          <CardContent className="space-y-3 text-slate-200">
        ...
        <Card className="border-elec-yellow/20">
          <CardHeader className="pb-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                <CardTitle>Financial Management & Growth Funding</CardTitle>
                <CardDescription>Managing and funding your business growth</CardDescription>
              </div>
            </div>
          </CardHeader>
          <CardContent className="space-y-3 text-slate-200">
          ...
          <CardHeader className="pb-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <CardDescription>Expanding your service offerings strategically</CardDescription>
              </div>
            </div>
          </CardHeader>
          <CardContent className="space-y-3 text-slate-200">
