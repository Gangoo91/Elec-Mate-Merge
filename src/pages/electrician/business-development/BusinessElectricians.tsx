    ...
    <>
      ...
      >
        ...
        <div className="space-y-8">
            ...
            <ContentBlock
              ...
              summary={
                <p className="text-white">
                  ...
                  and direct approaches. Quality candidates expect professional recruitment
                  processes and competitive packages.
                </p>
              }
            >
                    ...
                    {[
                      {
                        ...
                        desc: 'Leading specialist electrical recruitment platform with skills-based matching and qualification verification.',
                        cost: '£300-600/post',
                      },
                      {
                        name: 'LinkedIn Professional',
                        desc: 'Target qualified electricians with proven experience. Advanced targeting and professional messaging.',
                        cost: '£200-500/month',
                      },
                      {
                        name: 'Indeed & Reed',
                        desc: 'High-volume general job boards with electrical filters. Good for entry-level and experienced roles.',
                        cost: '£150-400/post',
                      },
                    ].map((platform, i) => (
                      <div
                        key={i}
                        className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2 py-3 border-b border-white/5 last:border-0"
                      >
                    ...
                    {[
                      {
                        ...
                        desc: 'ECA, NICEIC, NAPIT member networks and job boards. Access to verified, qualified professionals.',
                        cost: '£100-300/year',
                      },
                      {
                        name: 'Specialist Recruitment Agencies',
                        desc: 'Electrical trade recruitment specialists with pre-screened candidates and placement guarantees.',
                        cost: '15-25% of salary',
                      },
                      {
                        name: 'Word of Mouth & Referrals',
                        desc: 'Employee referral schemes are highly effective. Offer bonuses for successful referrals.',
                        cost: '£500-1,000 bonus',
                      },
                    ].map((channel, i) => (
                      <div
                        key={i}
            ...
            <ContentBlock
              ...
              summary={
                <p className="text-white">
                  ...
                  skills, qualifications, and cultural fit. Poor hiring decisions cost an average of
                  £15,000 in lost productivity and re-recruitment.
                </p>
              }
            >
              <InfoList
                ...
                items={[
                  {
                    title: 'Initial Screening (Day 1-3)',
                    description:
                      'Review CVs for essential qualifications (18th Edition, 2391), relevant experience, and career stability. Check qualification validity with awarding bodies.',
                  },
                  {
                    title: 'Phone Interview (Day 4-7)',
                    description:
                      '15-20 minute call to assess communication, confirm experience, discuss salary expectations, and gauge genuine interest in the role.',
                  },
                  {
                    title: 'Technical Assessment (Day 8-14)',
                    description:
                      'Practical skills test covering circuit diagnosis, testing procedures, and BS 7671 knowledge. Include scenario-based problem solving.',
                  },
                  {
                    title: 'In-Person Interview (Day 15-21)',
                    description:
                      'Face-to-face meeting to assess cultural fit, work ethic, and team compatibility. Include site visit where possible.',
                  },
                  {
                    title: 'Reference & Background Checks (Day 22-28)',
                    description:
                      'Verify employment history, qualifications, and obtain two professional references. Check for any industry sanctions.',
                  },
                  {
                    title: 'Offer & Negotiation (Day 29-35)',
                    description:
                      'Make competitive offer including salary, benefits, vehicle, and development opportunities. Allow 5-7 days for decision.',
                  },
                ]}
              />
            </ContentBlock>
            ...
            <ContentBlock
              ...
              summary={
                <p className="text-white">
                  ...
                  packages combine base salary with benefits, development opportunities, and quality
          ...
          <section
            id="onboarding"
            className="scroll-mt-20 space-y-6 pt-10 border-t border-white/10"
          >
            <div className="text-center max-w-3xl mx-auto mb-8">
            ...
            <ContentBlock
              ...
              summary={
                <p className="text-white">
                  ...
                  administrative setup, safety training, and introductions rather than immediately
            ...
            >
              <div className="space-y-4">
                {[
                  {
                    day: 'Day 1',
                    title: 'Welcome & Administration',
                    tasks:
                      'Complete HR paperwork, issue equipment (tools, PPE, vehicle), set up IT access, introduce to office team, review company handbook and policies.',
                  },
                  {
                    day: 'Day 2',
                    title: 'Safety & Compliance',
                    tasks:
                      'H&S induction, site safety procedures, risk assessment training, review of company safety standards, emergency procedures.',
                  },
                  {
                    day: 'Day 3',
                    title: 'Technical Orientation',
                    tasks:
                      'Review company quality standards, certification procedures, documentation requirements, testing equipment familiarisation.',
                  },
                  {
                    day: 'Day 4-5',
                    title: 'Shadowing',
                    tasks:
                      'Accompany experienced electrician on typical jobs, observe customer interaction standards, understand job completion procedures.',
                  },
                ].map((item, i) => (
            ...
            <ContentBlock
              ...
              summary={
                <p className="text-white">
                  ...
                  electricians develop the skills and confidence needed to work independently and
            ...
            <ContentBlock
              ...
              summary={
                <p className="text-white">
                  ...
                  opportunities, work-life balance, and feeling valued have the biggest impact on
                  long-term retention.
                </p>
              }
            >
                ...
                {[
                  {
                    ...
                    desc: 'Clear progression path, training opportunities, and support for additional qualifications.',
                    impact: '35% retention impact',
                  },
                  {
                    factor: 'Competitive Compensation',
                    desc: 'Market-rate salary, regular reviews, and performance bonuses.',
                    impact: '30% retention impact',
                  },
                  {
                    factor: 'Work-Life Balance',
                    desc: 'Reasonable hours, flexible scheduling where possible, and respect for personal time.',
                    impact: '20% retention impact',
                  },
                  {
                    factor: 'Company Culture',
                    desc: 'Feeling valued, good team relationships, and alignment with company values.',
                    impact: '15% retention impact',
                  },
                ].map((item, i) => (
            ...
            <ContentBlock
              ...
              summary={
                <p className="text-white">
                  ...
                  budgets of £500-1,500 per employee annually deliver returns through improved
                  skills and loyalty.
                </p>
              }
            >
              <div className="space-y-4">
                <div className="p-5 rounded-xl bg-white/[0.03] border border-white/10">
                  ...
                  <div className="space-y-3">
                    {[
                      {
                        training: '18th Edition updates & amendments',
                        cost: '£250-400',
                        freq: 'Every 3 years',
                      },
                      {
                        training: 'Inspection & Testing refresher (2391)',
                        cost: '£400-600',
                        freq: 'Every 5 years',
                      },
                      {
                        training: 'EV charging installation (C&G 2919)',
                        cost: '£600-900',
                        freq: 'One-time + updates',
                      },
                      {
                        training: 'Solar PV installation',
                        cost: '£800-1,200',
                        freq: 'One-time + updates',
                      },
                      ...
                      <div
                        key={i}
                        className="flex flex-col sm:flex-row sm:items-center sm:justify-between py-2 border-b border-white/5 last:border-0 gap-2"
                      >
            ...
            <ContentBlock
              ...
              summary={
                <p className="text-white">
                  ...
                  employees. Non-compliance can result in tribunal claims averaging £10,000+.
                </p>
              }
            >
              <InfoList
                ...
                items={[
                  {
                    ...
                    description:
                      'Must be provided within 2 months of start date. Include job title, salary, hours, holiday entitlement, and notice periods.',
                  },
                  {
                    title: 'Right to work checks',
                    description:
                      'Verify all employees have legal right to work in UK before employment starts. Keep copies of documents.',
                  },
                  {
                    title: 'Minimum wage compliance',
                    description:
                      'Current rates: £11.44/hour (23+), £8.60 (18-20), £6.40 (under 18). Review annually each April.',
                  },
                  {
                    title: 'Working time regulations',
                    description:
                      'Maximum 48-hour average working week unless opt-out signed. Rest breaks and minimum rest periods required.',
                  },
                  {
                    title: 'Holiday entitlement',
                    description:
                      'Minimum 5.6 weeks (28 days) including bank holidays for full-time workers. Pro-rata for part-time.',
                  },
                  {
                    title: 'Health & safety duties',
                    description:
                      'Provide safe working environment, PPE, training, and risk assessments. H&S liability is non-delegable.',
                  },
                ]}
              />
            </ContentBlock>
            ...
            <ContentBlock
              ...
              summary={
                <p className="text-white">
                  ...
                  electricians understand expectations. Annual reviews alone are insufficient - aim
            ...
            <ContentBlock
              ...
              summary={
                <p className="text-white">
                  ...
                  procedures to protect both the employee and your business.
                </p>
              }
            >
              <div className="space-y-4">
                {[
                  {
                    ...
                    approach:
                      'Informal conversation first, then formal performance improvement plan (PIP) with clear targets and support. Document everything.',
                  },
                  {
                    issue: 'Conduct Issues',
                    approach:
                      'Follow disciplinary procedure: investigation, hearing, decision. ACAS guidelines must be followed. Consider mediation for relationship issues.',
                  },
                  {
                    issue: 'Absence Management',
                    approach:
                      'Return-to-work interviews, trigger points for formal review, occupational health referral if needed. Balance support with business needs.',
                  },
                  {
                    issue: 'Grievances',
                    approach:
                      'Take seriously, investigate promptly, allow right to be accompanied. Resolve at lowest level possible. Document outcomes.',
                  },
                ].map((item, i) => (
                  <div key={i} className="p-4 rounded-xl bg-white/[0.03] border border-white/10">
