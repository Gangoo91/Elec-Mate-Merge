        ...
        <div className="space-y-6">
          ...
          <div className="text-center space-y-4">
            <div className="flex items-center justify-center gap-3">
              <div className="p-4 bg-elec-yellow/20 rounded-2xl backdrop-blur-sm border border-elec-yellow/20">
                <Wrench className="h-8 w-8 text-elec-yellow" />
              </div>
              <h1 className="text-4xl font-bold tracking-tight text-elec-yellow">
                Electrical Workshop
              </h1>
            </div>
