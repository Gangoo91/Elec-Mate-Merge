  ...
  const resources = [
    {
      ...
      description:
        'Learn how to create healthy limits between work and personal life for electrical professionals',
    ...
    },
    {
      ...
      description:
        'Understanding the importance of downtime for productivity and wellbeing in physically demanding trades',
    ...
    },
    {
      ...
      description:
        'UK charity providing welfare support specifically for people from the electrical sector',
    ...
    },
    {
      ...
      description:
        'Free 24/7 confidential support line for UK construction workers including electricians',
      type: 'website' as const,
