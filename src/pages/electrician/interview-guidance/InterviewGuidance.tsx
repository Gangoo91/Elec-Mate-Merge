  ...
  const interviewGuides = [
    {
      ...
      content: {
        overview:
          'Comprehensive preparation is crucial for interview success in the competitive UK electrical industry.',
        phases: [
          {
    ...
    },
    {
      ...
      content: {
        overview:
          'Understanding different interview formats helps you prepare appropriately for each scenario.',
        phases: [
          {
    ...
    },
    {
      ...
      content: {
        overview:
          'Master responses to the most common electrical interview questions with UK-specific context.',
        phases: [
          {
    ...
    },
    {
      ...
      content: {
        overview:
          'Strong presentation skills set you apart in the competitive UK electrical job market.',
        phases: [
          {
    ...
    },
    {
      ...
      content: {
        overview:
          'Professional follow-up can influence hiring decisions and demonstrate your continued interest.',
        phases: [
          {
    ...
    },
    {
      ...
      content: {
        overview:
          'Overcome common interview challenges with proven strategies and recovery techniques.',
        phases: [
          {
      ...
      <div className="space-y-6 px-4 py-6 animate-fade-in">
        ...
        <div className="mb-6">
          <p className="text-muted-foreground">
            Master every aspect of the electrical job interview process with comprehensive
            UK-focused guidance. From preparation strategies to post-interview follow-up, secure the
            role you want in the electrical industry.
          </p>
        </div>
            ...
            <MobileAccordion type="multiple" className="w-full">
              {interviewGuides.map((guide) => (
                <MobileAccordionItem key={guide.id} value={guide.id}>
                  <MobileAccordionTrigger icon={guide.icon} className="hover:bg-elec-yellow/5">
                        ...
                        <div className="space-y-4">
                          ...
                          {guide.content.phases.map((phase, index) => (
                            <div key={index} className="space-y-2">
                              <h5 className="text-sm font-medium text-elec-yellow">
                                {phase.phase}
                              </h5>
