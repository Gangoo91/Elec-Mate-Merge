  ...
  const questionCategories = [
      ...
      questions: [
        {
          ...
          answer:
            'TN-S has separate neutral and earth conductors throughout, while TN-C-S combines them in the supply but separates at the installation. TN-C-S is more common in UK installations but requires RCD protection.',
        ...
        },
        {
          ...
          answer:
            'Key changes include enhanced protection against arc faults, improved surge protection requirements, updated earthing arrangements, and new requirements for electric vehicle charging installations.',
          tips: 'Mention specific amendment numbers if you know them.',
        },
        {
          question: 'How do you perform safe isolation?',
          answer:
            'Follow the 6-step process: 1) Identify circuit, 2) Secure isolation, 3) Test voltage indicator, 4) Test for dead, 5) Test voltage indicator again, 6) Fit warning labels.',
          tips: 'Emphasise that this is non-negotiable for safety.',
        },
        {
          question: "What's the maximum Zs value for a 32A Type B MCB?",
          answer:
            '1.44Ω for a 32A Type B MCB. This ensures disconnection within 0.4 seconds for final circuits, meeting the requirements of BS 7671.',
      ...
      questions: [
        {
          ...
          answer:
            'I follow the HSE 5-step process: identify hazards, determine who might be harmed, evaluate risks, record findings, and review regularly. For electrical work, I consider voltage levels, environment, access, and other trades.',
          tips: 'Give specific examples from your experience.',
        },
        {
          question: 'What PPE do you use for different electrical tasks?',
          answer:
            'Basic PPE includes safety boots, hard hat, and high-vis. For live work (emergency only), I use insulated gloves, face shield, and arc-rated clothing. I always assess the specific task requirements.',
        ...
        },
        {
          ...
          answer:
            "I follow the hierarchy: avoid, prevent, arrest. Use proper access equipment, 3-point contact, and fall protection. I'm trained in ladder safety and use tower scaffolds where appropriate.",
    ...
    },
    {
      ...
      questions: [
        {
          question:
            'Describe a challenging project you completed. How did you overcome difficulties?',
          answer:
            'Structure using STAR method: Situation, Task, Action, Result. Focus on problem-solving, communication, and successful outcomes.',
        ...
        },
        {
          ...
          answer:
            "I believe in open communication and finding solutions that work for everyone. I listen to understand concerns, explain my perspective clearly, and focus on the project's success.",
        ...
        },
        {
          ...
          answer:
            'Acknowledge the mistake immediately, assess safety implications, correct the issue, inform relevant parties, and learn from it. Safety and honesty are paramount.',
          tips: 'Choose a minor mistake with good learning outcomes.',
        },
        {
          question: 'Where do you see yourself in 5 years?',
          answer:
            'I aim to advance my technical skills, potentially move into supervisory roles, and continue professional development through additional qualifications.',
      ...
      questions: [
        {
          ...
          answer:
            'Research-based answer highlighting their reputation, projects, values, or growth opportunities that align with your career goals.',
        ...
        },
        {
          ...
          answer:
            'Connect the role requirements to your skills and interests. Mention specific aspects like project types, team structure, or learning opportunities.',
          tips: "Show you've read and understood the job description thoroughly.",
        },
        {
          question: 'What questions do you have for us?',
          answer:
            'Prepare 3-5 thoughtful questions about training opportunities, typical projects, team structure, company culture, or growth plans.',
  ...
  return (
    <div className="space-y-6">
      ...
      <Alert>
        ...
        <AlertDescription>
          <strong>Pro Tip:</strong> Practice your answers out loud. The most technically competent
          electricians can struggle if they can't communicate their knowledge clearly.
        </AlertDescription>
      </Alert>
                  ...
                  <div className="space-y-4">
                    {category.questions.map((item, index) => (
                      <div key={index} className="border rounded-lg p-4 space-y-3">
                        <h4 className="font-medium text-sm text-primary">Q: {item.question}</h4>
