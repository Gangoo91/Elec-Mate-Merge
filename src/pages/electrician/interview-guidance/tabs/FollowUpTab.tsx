  ...
  const followUpTimeline = [
    {
      ...
      emailTemplate:
        'Thank you for taking the time to interview me for the [Position] role. I was particularly excited to learn about [specific project/aspect discussed]. I look forward to the next steps in the process.',
    },
    {
      ...
      emailTemplate:
        'I wanted to follow up on my interview for the [Position] role. I remain very interested in the opportunity and wanted to check on the status of the selection process.',
    },
    {
      ...
      emailTemplate:
        'I understand these decisions take time, but I wanted to express my continued strong interest in the [Position] role and inquire about the timeline for the selection process.',
    },
  ];
  ...
  return (
    <div className="space-y-6">
      ...
      <Alert>
        ...
        <AlertDescription>
          <strong>Critical:</strong> Follow-up within 24 hours shows professionalism and genuine
          interest. However, balance persistence with patience - respect their decision-making
          timeline.
        </AlertDescription>
      </Alert>
          ...
          <MobileAccordion type="single" collapsible defaultValue="salary">
            {negotiationAreas.map((area, index) => (
              <AccordionItem key={index} value={area.area.toLowerCase().replace(/\s+/g, '-')}>
                <MobileAccordionTrigger icon={area.icon}>{area.area}</MobileAccordionTrigger>
                <MobileAccordionContent>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="grid md:grid-cols-2 gap-4">
            <div className="space-y-3">
              ...
              <div className="bg-muted/50 p-3 rounded text-sm">
                <p className="italic">
                  "Based on my research of market rates for electricians with [X years] experience
                  in [location], and considering the value I can bring through [specific
                  skills/qualifications], I was hoping we could discuss a salary in the range of
                  £[X-Y]k."
                </p>
              </div>
            </div>
            <div className="space-y-3">
              ...
              <div className="bg-muted/50 p-3 rounded text-sm">
                <p className="italic">
                  "Thank you for the offer. I'm very excited about the opportunity. Could I have
                  [2-3 days] to review the details and get back to you? I want to make sure I can
                  give this the consideration it deserves."
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="bg-muted/50 p-3 rounded text-sm">
              <p className="italic">
                "Thank you for offering me the [Position] role. After careful consideration, I've
                decided that this opportunity isn't the right fit for me at this time. I appreciate
                the time you invested in the interview process and wish you all the best in finding
                the right candidate."
              </p>
            </div>
          </div>
