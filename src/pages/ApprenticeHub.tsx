          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5">
            {mainResources.map((resource) => (
              <Link to={resource.link} key={resource.id} className="block focus:outline-none group touch-manipulation">
                <Card className="border-elec-yellow/20 bg-elec-gray hover:bg-elec-gray/80 hover:border-elec-yellow/40 transition-all duration-300 active:scale-[0.97] h-full min-h-[140px]">
        ...
        <div className="space-y-5">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4">
            {additionalResources.map((resource) => (
              <Link to={resource.link} key={resource.id} className="block focus:outline-none group touch-manipulation">
                <Card className="border-elec-yellow/20 bg-elec-gray hover:bg-elec-gray/80 hover:border-elec-yellow/40 transition-all duration-300 active:scale-[0.97] h-full min-h-[120px] sm:min-h-[130px]">
