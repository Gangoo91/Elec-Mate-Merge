...
import { MessageSquare, ThumbsUp, Send, Edit, Trash2, UserRound } from "lucide-react";
import {
  ContextMenu,
  ContextMenuContent,
  ContextMenuItem,
    ...
    <>
      <ContextMenu>
                ...
                <TooltipProvider>
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <div className="flex items-center cursor-pointer" onClick={handleOpenDirectMessage}>
        ...
        <ContextMenuContent>
          ...
          <ContextMenuItem onClick={handleOpenDirectMessage}>
