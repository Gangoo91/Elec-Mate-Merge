...
export const CALCULATOR_COMPONENTS: Record<string, ComponentType> = {
  ...
  'bonding-conductor-size': lazy(
    () => import('@/components/apprentice/calculators/BondingConductorSizeCalculator')
  ),
  ...
  'bs7671-zs-lookup': lazy(
    () => import('@/components/apprentice/calculators/BS7671ZsLookupCalculator')
  ),
  'insulation-resistance': lazy(
    () => import('@/components/apprentice/calculators/InsulationResistanceInterpreter')
  ),
