  ...
  const metals: MetalPrice[] =
    data?.metalPrices?.map((metal: any) => ({
      ...
      pricePerKg:
        ...
        0,
      trend24h:
        parseFloat(metal.change?.replace(/[%+]/g, '') || '0') * (metal.trend === 'down' ? -1 : 1) ||
        0,
  ...
  function getDefaultMetals(): MetalPrice[] {
    return [
      ...
      },
      {
        ...
        grades: getMetalGrades('Aluminium'),
      },
      {
        name: 'Brass',
        pricePerKg: 3.5,
