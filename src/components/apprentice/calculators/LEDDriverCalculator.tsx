                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3 text-sm">
                      ...
                      <div className="bg-elec-yellow/10 p-3 rounded">
                        <h4 className="font-semibold text-elec-yellow mb-2">Recommended Driver Specification</h4>
                        <div className="space-y-1 text-xs">
                          <div>Compliance Voltage: <span className="text-elec-yellow">{result.recommendations.complianceVoltage.toFixed(1)} V</span></div>
                          <div>Recommended Power: <span className="text-elec-yellow">{result.recommendations.recommendedDriverPower.toFixed(1)} W</span></div>
                          <div>Nearest Standard: <span className="text-elec-yellow">{result.recommendations.nearestStandardDriver}</span></div>
                        </div>
                      </div>
                      ...
                      {result.recommendations.messages.length > 0 && (
                        <>
                          ...
                          <div className="space-y-2">
                            <h4 className="font-semibold text-elec-yellow text-xs">Connection Guidance:</h4>
                            <p className="text-xs text-elec-light/80 leading-relaxed">{result.recommendations.connectionGuidance}</p>
                            <div className="space-y-1">
                              {result.recommendations.messages.map((msg, idx) => (
                                <div key={idx} className="text-xs text-elec-light/80 flex items-start gap-2">
