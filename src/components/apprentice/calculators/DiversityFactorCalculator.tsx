  ...
  return (
    ...
    >
      <CalculatorPanes
              ...
              */}
                  <div className="p-3 rounded-xl bg-orange-500/10 border border-orange-500/30">
                    <p className="text-sm text-white">
                      ...
                      overload protection. The device protecting a consumer unit or distribution
                      board must satisfy one of: (a) In ≤ Ina and Inc, (b) documented load
                  ...
                  <CollapsibleContent className="pt-2">
                    <div className="text-sm font-mono text-white space-y-4 p-3 rounded-xl bg-white/[0.04] border border-white/5">
                      ...
                      <div className="pt-2 border-t border-purple-500/20">
                        <p className="text-xs text-purple-400 mb-2">
                          Step 2: Apply diversity per type
                        </p>
                        {result.breakdownByType.map((b, i) => (
                      ...
                      <div className="pt-2 border-t border-purple-500/20">
                        <p className="text-xs text-purple-400 mb-1">
                          ...
                          {supplyType === 'three-phase' ? '3-phase' : 'single-phase'} at{' '}
                          {supplyVoltage}V)
                        </p>
                    ...
                    <div className="grid md:grid-cols-2 gap-4 text-sm">
                      <div className="space-y-2">
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="border-l-2 border-white/[0.14] pl-3">
                            <p className="text-white">
                              <strong>Protection:</strong> {getMainDeviceRecommendation()}{' '}
                              recommended
                            </p>
                          </div>
                          <div className="border-l-2 border-white/[0.14] pl-3">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="space-y-2">
                          <div className="border-l-2 border-white/[0.14] pl-3">
                            <p className="text-white">
                              <strong>Diversity Factor:</strong> Not all loads operate
                              simultaneously
                            </p>
                          </div>
                          <div className="border-l-2 border-white/[0.14] pl-3">
                          ...
                          <div className="border-l-2 border-white/[0.14] pl-3">
                            <p className="text-white">
                              <strong>Note:</strong> Diversity allowances are published in the IET
                              On-Site Guide, not BS 7671 directly. Reg 311.1 says maximum demand
                              shall be determined and that diversity <em>may</em> be taken into
                              account
                            </p>
                          </div>
                        </div>
              ...
              */}
                  <div className="border-l-2 border-amber-400/40 pl-3">
                    <p className="text-sm text-white">
                      <strong className="text-white">
                        IET On-Site Guide Appendix A, Table A2:
                      </strong>{' '}
                  ...
                  <div className="border-l-2 border-amber-400/40 pl-3">
                    <p className="text-sm text-white">
                      ...
                      similar premises. Blocks of dwellings, large hotels, industrial and large
                      commercial premises are excluded and must be assessed case by case by the
                      designer — the non-domestic figures here are designer allowances, not
                      published values.
                    </p>
                  </div>
                  <div className="border-l-2 border-amber-400/40 pl-3">
                    <p className="text-sm text-white">
                      ...
                      arrangement complying with Appendix H, the current demand of that final
                      circuit is the rated current of its own overcurrent protective device.
                    </p>
                  </div>
                  <div className="border-l-2 border-amber-400/40 pl-3">
                    <p className="text-sm text-white">
                      <strong className="text-white">Note:</strong> Diversity allowances are not
                      published in BS 7671 directly. They appear in the IET On-Site Guide (a
                      companion publication). Reg 536.4.202 forbids using diversity as a means of
        ...
        footer={<CalculatorEditorial content={diversityFactorContent} category="power" />}
      />
    </CalculatorCard>
  );
};
