  ...
  return (
    ...
    >
      <CalculatorPanes
                  ...
                  <div className="p-3 rounded-xl bg-red-500/10 border border-red-500/30">
                    <div className="flex items-start gap-2">
                      ...
                      <p className="text-sm text-white">
                        Daily deficit of {Math.abs(result.dailyEnergyBalance).toFixed(1)}kWh —
                        increase panels or reduce consumption.
                      </p>
                    </div>
                  </div>
                )}
                      ...
                      <div className="space-y-2 text-sm">
                        ...
                        <div className="flex justify-between pt-2 border-t border-white/10 font-semibold">
                          ...
                          <span className="text-green-400">
                            £{result.costBreakdown.total.toFixed(0)}
                          </span>
                        </div>
                      </div>
                    </div>
                  ...
                  <CollapsibleContent className="pt-2">
                    ...
                    >
                      <div className="space-y-2 text-sm text-white">
                        <p>
                          <strong>BS 7671:</strong> Wiring regulations apply to all DC and AC
                          circuits
                        </p>
                        <p>
                          <strong>Building Regs Part P:</strong> Notification required for
                          electrical work
                        </p>
                        <p>
        ...
        footer={<CalculatorEditorial content={offGridSystemContent} category={CAT} />}
      />
    </CalculatorCard>
  );
}
