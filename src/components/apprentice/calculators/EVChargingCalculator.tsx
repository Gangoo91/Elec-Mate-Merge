  ...
  return (
    ...
    >
      <CalculatorPanes
          ...
          <>
                  ...
                  <CollapsibleContent className="pt-2">
                    ...
                    >
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="text-sm text-white">
                          {results.reviewFindings.cableAssessment}
                        </p>
                      </div>
                      <div className="space-y-2">
            ...
            <div className="p-3 rounded-xl bg-white/[0.04] border border-white/[0.12]">
              <div className="flex items-start gap-2">
                <Car className="h-4 w-4 text-white mt-0.5 shrink-0" />
                <p className="text-sm text-white">
        ...
        footer={<CalculatorEditorial content={evChargingContent} category={CAT} />}
      />
    </CalculatorCard>
  );
};
