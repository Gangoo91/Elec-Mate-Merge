  ...
  return (
    ...
    >
      <CalculatorPanes
                    ...
                    >
                      <div className="space-y-2">
                        ...
                        <p className="text-sm text-white">
                          ...
                          creating a voltage gradient. Touch voltage is the potential difference
                          between the earthed equipment and the ground at arm's reach. Step voltage
                          is the difference between two feet 1m apart near the electrode.
                        </p>
                      </div>
                      <div className="space-y-2">
                        <p className="text-sm text-white font-medium">
                          IEC 60479 Physiological Effects
                        </p>
                        <ul className="space-y-1">
                          ...
                          <li className="flex items-start gap-2 text-sm text-white">
                            <span
                              ...
                              style={{ backgroundColor: config.gradientFrom }}
                            />
                            Zone 3 (10–100 mA): Muscular contractions — "can't let go" effect,
                            potential breathing difficulty
                          </li>
                          <li className="flex items-start gap-2 text-sm text-white">
                            <span
                              className="w-1.5 h-1.5 rounded-full mt-2 shrink-0"
                      ...
                      <div className="space-y-2">
                        <p className="text-sm text-white font-medium">
                          Reducing Touch and Step Voltages
                        </p>
                        <ul className="space-y-1">
                          <li className="flex items-start gap-2 text-sm text-white">
                            <span
                              ...
                              style={{ backgroundColor: config.gradientFrom }}
                            />
                            Lower electrode resistance: use longer rods, parallel rods, or mesh
                            grids
                          </li>
                          <li className="flex items-start gap-2 text-sm text-white">
                            <span
        ...
        footer={<CalculatorEditorial content={touchStepVoltageContent} category={CAT} />}
      />
    </CalculatorCard>
  );
};
