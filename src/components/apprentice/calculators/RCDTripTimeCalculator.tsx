  ...
  const buildReport = (): CalcReport | null => {
    ...
    return {
      meta: {
        ...
        standard: 'BS 7671:2018+A4:2026 — Reg 643.8',
      },
      headline: [
        {
  ...
  return (
    ...
    >
      <CalculatorPanes
                    ...
                    {!result.isCompliant && (
                      <div className="flex items-start gap-2 p-3 rounded-lg bg-red-500/10 border border-red-500/30">
                        ...
                        <p className="text-sm text-white">
                          RCD trip time exceeds maximum allowed. Do not energise circuits protected
                          by this RCD. Replace immediately and investigate root cause.
                        </p>
                      </div>
                    )}
                  </>
                  ...
                  <CollapsibleContent className="pt-2">
                    ...
                    >
                      <div className="space-y-2">
                        ...
                        <p className="text-sm text-white">
                          Under BS 7671:2018+A4:2026, RCD effectiveness is confirmed by a single
                          test at the rated residual operating current (1×IΔn). Appendix 3 Table 3A
                          and the ×5 IΔn test were deleted in A4:2026:
                        </p>
                        <ul className="space-y-1">
                          ...
                          <li className="flex items-start gap-2 text-sm text-white">
                            <span
                              ...
                              style={{ backgroundColor: config.gradientFrom }}
                            />
                            0.5× IΔn check: RCD should NOT trip — a useful confidence check that it
                            will not nuisance-trip under normal leakage currents
                          </li>
                          <li className="flex items-start gap-2 text-sm text-white">
                            <span
                              className="w-1.5 h-1.5 rounded-full mt-2 shrink-0"
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="text-sm text-white">
                          The 1×IΔn test is the A4:2026 requirement; the others are optional checks.
                          Work in this order to avoid false results and let the RCD reset between
                          tests:
                        </p>
                        <ul className="space-y-1">
                          <li className="flex items-start gap-2 text-sm text-white">
                          ...
                          <li className="flex items-start gap-2 text-sm text-white">
                            <span
                              ...
                              style={{ backgroundColor: config.gradientFrom }}
                            />
                            Optional 0.5× IΔn check — should NOT trip (if it does, investigate
                            leakage)
                          </li>
                          <li className="flex items-start gap-2 text-sm text-white">
                            <span
                              ...
                              style={{ backgroundColor: config.gradientFrom }}
                            />
                            Test at 1× IΔn (A4:2026 requirement) — record trip time (must be ≤
                            300ms)
                          </li>
                          <li className="flex items-start gap-2 text-sm text-white">
                            <span
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="text-sm text-white">
                          A failed RCD is a serious safety issue. Do not leave circuits energised
                          behind a device that cannot protect against earth faults:
                        </p>
                        <ul className="space-y-1">
                          <li className="flex items-start gap-2 text-sm text-white">
                            <span
                          ...
                          <li className="flex items-start gap-2 text-sm text-white">
                            <span
                              ...
                              style={{ backgroundColor: config.gradientFrom }}
                            />
                            Check for high earth leakage on downstream circuits (faulty appliances,
                            damp)
                          </li>
                          <li className="flex items-start gap-2 text-sm text-white">
                            <span
                              ...
                              style={{ backgroundColor: config.gradientFrom }}
                            />
                            Issue a danger notice (EICR code C1) if the installation cannot be made
                            safe
                          </li>
                        </ul>
                      </div>
        ...
        footer={<CalculatorEditorial content={rcdTripTimeContent} category={CAT} />}
      />
    </CalculatorCard>
  );
};
