              ...
              <div className="calculator-card overflow-hidden" style={{ borderColor: '#60a5fa15' }}>
                ...
                <CollapsibleContent className="p-4 pt-0 space-y-3 text-sm">
                  <p className="text-blue-200/80">
                    RCD trip times are marked on the device. This calculator helps you understand
                    what your
                    <strong className="text-blue-300"> actual measured readings</strong> mean for
                    safety and compliance.
                  </p>
                  <div className="p-3 rounded-xl bg-blue-500/10 border border-blue-500/20">
                    <h5 className="text-blue-300 font-medium mb-2">Real-World Example</h5>
                    <p className="text-blue-200/80 mb-2">
                      A 30mA RCD might trip at 25mA in 150ms, or 35mA in 400ms:
                    </p>
                    <ul className="space-y-1 text-blue-200/80">
                      <li className="flex items-start gap-2">
                        <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 shrink-0" />
                        <span>
                          <strong className="text-green-400">25mA in 150ms:</strong> Excellent -
                          trips early with good safety margin
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <XCircle className="h-4 w-4 text-red-400 mt-0.5 shrink-0" />
                        <span>
                          <strong className="text-red-400">35mA in 400ms:</strong> Dangerous -
                          exceeds time limits
                        </span>
                      </li>
                    </ul>
              ...
              <div className="calculator-card overflow-hidden" style={{ borderColor: '#fbbf2415' }}>
                ...
                <CollapsibleContent className="p-4 pt-0 space-y-3 text-sm">
                  <div className="space-y-2 text-amber-200/80">
                    <p>
                      <strong className="text-amber-300">Testing Sequence:</strong>
                    </p>
              ...
              <div className="calculator-card overflow-hidden" style={{ borderColor: '#ef444415' }}>
                ...
                <CollapsibleContent className="p-4 pt-0 space-y-3 text-sm">
                  ...
                  <div className="p-3 rounded-xl bg-red-500/20 border border-red-500/30">
                    ...
                    <ul className="space-y-1 text-red-200/80">
                      <li>
                        • <strong>Do not energise</strong> circuits protected by failed RCD
                      </li>
                      <li>
                        • <strong>Replace RCD immediately</strong> if it fails to trip
                      </li>
                      <li>
                        • <strong>Investigate root cause</strong> before re-energising
                      </li>
                      <li>
                        • <strong>Issue danger notice</strong> if installation cannot be made safe
                      </li>
                    </ul>
                  </div>
                </CollapsibleContent>
      ...
      <div className="p-3 rounded-xl bg-orange-500/10 border border-orange-500/20">
        <div className="flex items-start gap-2">
          ...
          <div className="text-sm text-orange-200">
            <p>
              <strong>RCD should NOT trip</strong> at 0.5×IΔn
            </p>
            <p>
              <strong>RCD must trip</strong> within specified time at 1×IΔn and 5×IΔn
            </p>
          </div>
        </div>
      </div>
