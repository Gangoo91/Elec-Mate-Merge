  ...
  return (
    ...
    >
      <CalculatorPanes
              ...
              <>
                ...
                <div className="flex items-start gap-2 p-3 rounded-lg bg-amber-500/10 border border-amber-500/30">
                  ...
                  <p className="text-sm text-white">
                    ...
                    rotation meter gives definitive results.
                  </p>
                </div>
              </>
            )}
              ...
              <div className="space-y-4 animate-fade-in">
                ...
                {!result.isCorrect && (
                  <div className="flex items-start gap-2 p-3 rounded-lg bg-red-500/10 border border-red-500/30">
                    ...
                    <p className="text-sm text-white">
                      Always isolate supply and prove dead before making any phase corrections.
                  ...
                  <CollapsibleContent className="pt-2">
                    ...
                    >
                      <div className="space-y-2">
                        ...
                        <p className="text-sm text-white">
                          Phase rotation (or phase sequence) is the order in which the three phases
                          reach their peak voltage. In the UK, the standard sequence is L1–L2–L3
                          (Brown–Black–Grey), which creates a clockwise rotating magnetic field.
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="text-sm text-white">
                          To reverse phase sequence: isolate the supply, prove dead, then swap any
                          two of the three phases (typically L2 and L3). This reverses the rotating
                          magnetic field direction. Never swap all three — this achieves nothing.
                        </p>
                      </div>
                    </div>
                  </CollapsibleContent>
                    ...
                    >
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="text-xs text-white">
                          Old colours may still be found in installations predating March 2004.
                          Always verify before assuming phase identity.
                        </p>
                      </div>
                    </div>
                  </CollapsibleContent>
        ...
        footer={<CalculatorEditorial content={phaseRotationContent} category={CAT} />}
      />
    </CalculatorCard>
  );
};
