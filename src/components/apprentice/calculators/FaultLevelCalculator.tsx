  ...
  return (
    ...
    >
      <CalculatorPanes
                    ...
                    >
                      <div className="space-y-2">
                        ...
                        <p className="text-sm text-white">
                          The prospective fault current (PSCC) is the maximum current that would
                          flow during a short circuit at any given point in the installation. It
                          decreases as you move further from the source because cable impedance
                          increases.
                        </p>
                      </div>
                      <div className="space-y-2">
                        ...
                        <p className="text-sm text-white">
                          Every protective device must have a rated short-circuit capacity not less
                          than the prospective fault current at its point of installation. If the
                          fault level exceeds the device rating, the device may fail to interrupt
                          the fault safely.
                        </p>
                      </div>
                      <div className="space-y-2">
                        ...
                        <ul className="space-y-1">
                          ...
                          <li className="flex items-start gap-2 text-sm text-white">
                            <span
                              ...
                              style={{ backgroundColor: config.gradientFrom }}
                            />
                            Longer cable runs and smaller conductors reduce fault levels at the load
                            end
                          </li>
                          <li className="flex items-start gap-2 text-sm text-white">
                            <span
                              ...
                              style={{ backgroundColor: config.gradientFrom }}
                            />
                            Always verify transformer nameplate impedance rather than relying on
                            typical values
                          </li>
                          <li className="flex items-start gap-2 text-sm text-white">
                            <span
                              ...
                              style={{ backgroundColor: config.gradientFrom }}
                            />
                            Aluminium conductors have higher resistivity than copper, giving lower
                            fault levels for the same cable size
                          </li>
                        </ul>
                      </div>
                    </div>
        ...
        footer={<CalculatorEditorial content={faultLevelContent} category={CAT} />}
      />
    </CalculatorCard>
  );
};
