                    ...
                    >
                      <div className="space-y-2">
                        <p className="text-sm text-white font-medium">
                          Zone Rules (BS 7671 Section 702)
                        </p>
            ...
            <FormulaReference
              ...
              variables={[
                ...
                },
                {
                  ...
                  symbol: 'Bonding',
                  description:
                    '4mm² min conductor to all extraneous-conductive-parts in zones 0, 1 and 2',
                },
              ]}
            />
          </>
        }
        footer={<CalculatorEditorial content={swimmingPoolContent} category={CAT} />}
      />
    </CalculatorCard>
  );
};
