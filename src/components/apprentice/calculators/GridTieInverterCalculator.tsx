  ...
  return (
    ...
    >
      <CalculatorPanes
              ...
              <div className="space-y-4 animate-fade-in">
                ...
                <div className="flex items-center justify-between">
                  <ResultBadge
                    ...
                    label={
                      result.isG98
                        ? 'G98 — Simplified Connection'
                        : 'G99 — DNO Application Required'
                    }
                  />
                  <button
                    onClick={handleCopy}
                ...
                {result.clippingLoss > 0 && (
                  <div className="flex items-start gap-2 p-3 rounded-lg bg-amber-500/10 border border-amber-500/30">
                    ...
                    <p className="text-sm text-white">
                      ...
                      %). DC:AC ratio of {result.dcAcRatio.toFixed(2)} causes inverter saturation
                      during peak irradiance.
                    </p>
                  </div>
                )}
                  ...
                  <CollapsibleContent className="pt-2">
                    ...
                    >
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="text-sm text-white">
                          Self-consumption saves £{result.billSavings.toFixed(0)}/yr by offsetting
                          retail electricity at £{parseFloat(retailPrice).toFixed(2)}/kWh. Exported
                          energy earns £{result.exportIncome.toFixed(0)}/yr at the Smart Export
                          Guarantee rate.
                        </p>
                      </div>
                    </div>
        ...
        footer={<CalculatorEditorial content={gridTieInverterContent} category={CAT} />}
      />
    </CalculatorCard>
  );
}
