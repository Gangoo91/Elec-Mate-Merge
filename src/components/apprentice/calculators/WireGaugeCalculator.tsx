  ...
  const performCalculation = (): CalculationResult | null => {
    ...
    if (current > 0) {
      ...
      if (voltageDropPercentage > 5) {
        ...
        warnings.push(
          `Moderate voltage drop: ${formatNumber(voltageDropPercentage)}% - consider optimization`
        );
      }
    }
            ...
            <div className="calculator-card overflow-hidden" style={{ borderColor: '#fbbf2415' }}>
              ...
              <CollapsibleContent className="p-4 pt-0">
                <div className="space-y-2 text-sm text-amber-200/80">
                  ...
                  <p>
                    <strong className="text-amber-300">Appendix 4:</strong> Voltage drop limits (5%)
                  </p>
                  <p>
                    <strong className="text-amber-300">Regulation 411:</strong> Protective measures
                  </p>
                  <p>
                    <strong className="text-amber-300">Section 433:</strong> Overload protection
                  </p>
                </div>
              </CollapsibleContent>
            </div>
