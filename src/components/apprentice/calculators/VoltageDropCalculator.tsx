        ...
        {tabs.map((tab) => (
          <button
            ...
            className={cn(
              ...
              activeTab === tab.key ? 'text-black' : 'text-white hover:bg-white/5'
            )}
            style={
              activeTab === tab.key
                ? {
        ...
        <div className="space-y-4">
          ...
          {selectedMvam && (
            <div className="p-3 rounded-xl bg-emerald-400/10 border border-emerald-400/20">
              ...
              <p className="text-xs text-emerald-300 mt-1 ml-6">From BS 7671 Appendix 4</p>
            </div>
          )}
          ...
          <div className="p-4 rounded-xl bg-emerald-500/10 border border-emerald-500/20">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                ...
                <tbody className="text-emerald-200 text-xs">
        ...
        <div className="space-y-4">
          ...
          <div className="p-4 rounded-xl bg-blue-500/10 border border-blue-500/20">
            ...
            <p className="text-sm text-blue-200 mb-2">
              Provides tabulated voltage drop values in millivolts per ampere per metre for various
