...
const VoltageDropCalculator = () => {
  ...
  const calculateVoltageDrop = () => {
    if (!cableLength || !cableSize || !loadCurrent || !voltage) return;
    ...
    if (isNaN(length) || isNaN(current) || isNaN(size) || isNaN(v)) return;
  ...
  return (
    <Card className="border-elec-yellow/20 bg-elec-gray">
      ...
      <CardContent className="space-y-4">
        ...
        {voltageDrop && (
          <div className="space-y-2 rounded-md bg-elec-dark p-4">
        ...
        {voltageDrop && parseFloat(percentage!) > 2.5 && (
          <div className="p-3 bg-destructive/20 border border-destructive/40 rounded-md text-sm">
