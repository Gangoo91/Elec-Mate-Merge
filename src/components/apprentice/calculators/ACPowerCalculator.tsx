  ...
  return (
    ...
    >
      <CalculatorPanes
                  ...
                  <CollapsibleContent className="pt-2">
                    <div className="space-y-3 pl-1">
                      ...
                      <div className="border-l-2 border-purple-400/40 pl-3">
                        ...
                        <code className="block mt-1 text-xs px-2.5 py-1.5 rounded-lg bg-black/20 text-white font-mono space-y-0.5">
                          <span className="block">
                            φ = cos⁻¹(PF) = cos⁻¹({powerFactor || '1'}) ={' '}
                            {results.phaseAngle?.toFixed(1)}°
                          </span>
                  ...
                  <CollapsibleContent className="pt-2">
                    <div className="space-y-3 pl-1">
                      <div className="border-l-2 border-white/[0.14] pl-3">
                        <p className="text-sm text-white">
                          <strong className="text-elec-yellow">Power Factor Impact</strong> {'—'}{' '}
                          Lower PF means higher current for same power output, increasing energy
                      ...
                      {results.currentAtUnity && results.current && (
                        <div className="border-l-2 border-white/[0.14] pl-3">
                          <p className="text-sm text-white">
                            <strong className="text-elec-yellow">Current Difference</strong> {'—'}{' '}
                            At unity PF, current would be {results.currentAtUnity?.toFixed(1)}A vs
                            actual {results.current?.toFixed(1)}A
                          </p>
                        </div>
                      )}
                      ...
                      <div className="border-l-2 border-white/[0.14] pl-3">
                        <p className="text-sm text-white">
                          <strong className="text-elec-yellow">Energy Efficiency</strong> {'—'}{' '}
                      ...
                      {phaseSystem === 'three' && (
                        <div className="border-l-2 border-white/[0.14] pl-3">
                          <p className="text-sm text-white">
                            <strong className="text-elec-yellow">Three-Phase</strong> {'—'} Balanced
                            loading assumed - check individual phases for unbalance
                          </p>
                        </div>
                      )}
                    </div>
        ...
        footer={<CalculatorEditorial content={acPowerContent} category="power" />}
      />
    </CalculatorCard>
  );
};
