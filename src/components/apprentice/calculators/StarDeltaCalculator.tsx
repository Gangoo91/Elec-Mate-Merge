  ...
  return (
    ...
    >
      <CalculatorPanes
                    ...
                    <div className="space-y-3 pl-1">
                      ...
                      <div className="border-l-2 border-green-400/40 pl-3">
                        ...
                        <ul className="mt-1 text-xs text-white space-y-0.5">
                          <li>
                            • <strong>Motor starting:</strong> Star-delta starters reduce inrush
                            current by ~67%
                          </li>
                          <li>
                            • <strong>Circuit analysis:</strong> Converting networks simplifies
                            fault current calculations
                          </li>
                          <li>
                            • <strong>Transformer windings:</strong> Understanding both
                            configurations helps with connections
                          </li>
                          <li>
                            • <strong>Load balancing:</strong> Delta allows operation with one phase
                            lost (open delta)
                          </li>
                        </ul>
                      </div>
                      ...
                      <div className="border-l-2 border-white/[0.14] pl-3">
                        <p className="text-sm text-white">
                          <strong className="text-elec-yellow">Delta (Δ) Connection</strong>
                        </p>
                        <ul className="mt-1 text-xs text-white space-y-0.5">
                      ...
                      <div className="border-l-2 border-green-400/40 pl-3">
                        <p className="text-sm text-white">
                          ...
                          {'—'} Commonly used for motors above 7.5kW. Motor starts in star (lower
                          voltage, ~⅓ starting current) then switches to delta (full voltage, full
                          power) once up to speed.
                        </p>
                      ...
                      <div className="border-l-2 border-white/[0.14] pl-3">
                        ...
                        <code className="block mt-1 text-xs px-2.5 py-1.5 rounded-lg bg-black/20 text-white font-mono space-y-0.5">
                          ...
                          <span className="block text-elec-yellow mt-1">Delta (Δ):</span>
                      ...
                      <div className="border-l-2 border-amber-400/40 pl-3">
                        <p className="text-sm text-white">
                          <strong className="text-amber-300">Exam Tip</strong> {'—'} The ratio 3:1
                          applies to balanced impedances. For UK 400V three-phase: Star phase
                          voltage = 400/√3 = 230V, Delta phase voltage = 400V. This is why we have
                          both 230V and 400V available from a three-phase supply.
                        </p>
                      </div>
                    </div>
                  </CollapsibleContent>
                    ...
                    <div className="space-y-3 pl-1">
                      <div className="border-l-2 border-amber-400/40 pl-3">
                        <p className="text-sm text-white">
                          ...
                          {'—'} Star-delta starting is covered under motor starting methods.
                          Starting current must not cause excessive voltage drop ({'<'}4%
                          recommended). Motor must have 6 terminals.
                        </p>
                      </div>
                      ...
                      <div className="border-l-2 border-amber-400/40 pl-3">
                        <p className="text-sm text-white">
                          ...
                          {'—'} Motor starting arrangements shall be designed to limit voltage
                          disturbances to other equipment. Star-delta starting reduces starting
                          current to approximately ⅓ of DOL.
                        </p>
                      </div>
                      ...
                      <div className="border-l-2 border-amber-400/40 pl-3">
                        ...
                        <code className="block mt-1 text-xs px-2.5 py-1.5 rounded-lg bg-black/20 text-white font-mono space-y-0.5">
                          ...
                          <span className="block">
                            <span className="text-amber-300">Industrial:</span> Delta common for
                            motors
                          </span>
                        </code>
                      </div>
                      ...
                      <div className="border-l-2 border-amber-400/40 pl-3">
                        <p className="text-sm text-white">
                          ...
                          protection settings, transformer vector groups, and three-phase load
        ...
        footer={<CalculatorEditorial content={starDeltaContent} category="power" />}
      />
    </CalculatorCard>
  );
};
