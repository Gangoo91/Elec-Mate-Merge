  ...
  return (
    ...
    >
      <CalculatorPanes
                  ...
                  <CollapsibleContent className="pt-2">
                    ...
                    >
                      <div className="space-y-2">
                        ...
                        <p className="text-sm text-white">
                          FIT provides generation payments on ALL electricity produced (not just
                          exports), export payments on surplus sent to the grid, and bill savings
                          from self-consumed energy offsetting retail electricity costs.
                        </p>
                      </div>
                      <div className="space-y-2">
                        ...
                        <p className="text-sm text-white">
                          ...
                          installations where FIT generation rates dropped significantly. Adding
                          battery storage can increase self-consumption from ~30% to ~65%.
                        </p>
                      </div>
                    </div>
                  </CollapsibleContent>
        ...
        footer={<CalculatorEditorial content={feedInTariffContent} category={CAT} />}
      />
    </CalculatorCard>
  );
}
