...
export function useRingCircuitCalculator() {
      ...
      const endToEndChecks: ValidationCheck[] = [
        {
          ...
          status:
            readingValues.endToEndLive > 0 && readingValues.endToEndLive < 10 ? 'pass' : 'fail',
          actualValue: readingValues.endToEndLive,
          message:
            readingValues.endToEndLive > 0 && readingValues.endToEndLive < 10
        ...
        },
        {
          ...
          status:
            readingValues.endToEndNeutral > 0 && readingValues.endToEndNeutral < 10
              ? 'pass'
              : 'fail',
        ...
        },
        {
          ...
          message:
            readingValues.endToEndCpc > 0 && readingValues.endToEndCpc < 15
      ...
      const crossConnectionChecks: ValidationCheck[] = [
        {
          ...
          status:
            Math.abs(readingValues.liveToNeutral - (calculatedValues.r1 + calculatedValues.rn)) <
            0.1
              ? 'pass'
              : 'fail',
        ...
        },
        {
          ...
          status:
            Math.abs(readingValues.liveToCpc - calculatedValues.r1PlusR2) < 0.1 ? 'pass' : 'fail',
          actualValue: readingValues.liveToCpc,
          expectedValue: calculatedValues.r1PlusR2,
          tolerance: 0.1,
          message:
            Math.abs(readingValues.liveToCpc - calculatedValues.r1PlusR2) < 0.1
        ...
        },
        {
          ...
          status:
            Math.abs(readingValues.neutralToCpc - (calculatedValues.rn + calculatedValues.r2)) < 0.1
              ? 'pass'
              : 'fail',
      ...
      const mathematicalChecks: ValidationCheck[] = [
        {
          ...
          message:
            Math.abs(calculatedValues.r1 - calculatedValues.rn) < 0.05
        ...
        cableComparisonChecks.push(
          {
            ...
            message:
              r1Difference < expectedValues.toleranceRange
          ...
          },
          {
            ...
            tolerance: expectedValues.toleranceRange,
            message:
              r2Difference < expectedValues.toleranceRange
  ...
  const calculateValues = useCallback(() => {
    ...
    const validationDetails = performValidationChecks(
      calculatedValues,
      readingValues,
      expectedValues,
      cable,
