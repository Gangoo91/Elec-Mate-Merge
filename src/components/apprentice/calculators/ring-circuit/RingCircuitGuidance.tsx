  ...
  const commonIssues = [
    {
      ...
      causes: [
        'Loose connections at socket outlets',
        'Corroded conductors',
    ...
    },
    {
      ...
      solutions: [
        'Trace cable route carefully',
        'Check all junction boxes',
        'Verify ring circuit design',
      ],
    },
    {
      ...
      solutions: [
        'Check current distribution patterns',
        'Verify socket operation',
        'Use phase rotation testing',
      ],
    },
  ];
      ...
      <Card className="bg-elec-card border-elec-yellow/20">
        ...
        <CardContent>
          <Accordion type="single" collapsible className="w-full space-y-2">
            <AccordionItem
              value="r1-r2"
              className="border-elec-yellow/20 bg-white/10 rounded-lg px-4"
            >
              ...
              <AccordionContent className="text-elec-light/80 space-y-3 pb-4">
                <p className="text-sm sm:text-base leading-relaxed">
                  R1 + R2 represents the resistance of the live and earth conductors combined. For a
                  ring circuit:
                </p>
                ...
                <p className="text-xs sm:text-sm leading-relaxed">
                  This is because at the midpoint of the ring, you have two parallel paths, each
                  with half the total resistance.
                </p>
              </AccordionContent>
            </AccordionItem>
            ...
            >
              ...
              <AccordionContent className="text-elec-light/80 space-y-3 pb-4">
                <p className="text-sm sm:text-base leading-relaxed">
                  Cross-connection tests verify the ring is properly wired and not interconnected
                  with other circuits:
                </p>
                <ul className="space-y-2 text-xs sm:text-sm">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong>Live to Neutral:</strong> Should equal R1 + Rn
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="flex-shrink-0 w-1.5 h-1.5 bg-elec-yellow rounded-full mt-2"></span>
                    <span>
                      <strong>Live to CPC:</strong> Should equal R1 + R2
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="flex-shrink-0 w-1.5 h-1.5 bg-elec-yellow rounded-full mt-2"></span>
                    <span>
                      <strong>Neutral to CPC:</strong> Should equal Rn + R2
                    </span>
                  </li>
                </ul>
              </AccordionContent>
            ...
            >
              ...
              <AccordionContent className="text-elec-light/80 space-y-3 pb-4">
                ...
                <div className="bg-white/10 rounded-lg p-3 sm:p-4 text-xs sm:text-sm border border-elec-yellow/20 space-y-2">
                  <div>
                    <strong>2.5mm² T&E:</strong> Live: 7.41mΩ/m, CPC (1.5mm²): 12.1mΩ/m
                  </div>
                  <div>
                    <strong>4.0mm² T&E:</strong> Live: 4.61mΩ/m, CPC (2.5mm²): 7.41mΩ/m
                  </div>
                  <div>
                    <strong>6.0mm² T&E:</strong> Live: 3.08mΩ/m, CPC (4.0mm²): 4.61mΩ/m
                  </div>
                  <div>
                    <strong>10mm² T&E:</strong> Live: 1.83mΩ/m, CPC (6.0mm²): 3.08mΩ/m
                  </div>
                </div>
