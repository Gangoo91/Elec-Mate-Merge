  ...
  return (
    ...
    >
      <CalculatorPanes
                  ...
                  <div key={load.id} className="space-y-3">
                    ...
                    <CalculatorInputGrid columns={2} className="grid-cols-2">
                      ...
                      <CalculatorInput
                        ...
                        onChange={(val) =>
                          updateLoad(load.id, { powerFactor: parseFloat(val) || 0.85 })
                        }
                        placeholder="0.85"
                      />
                    </CalculatorInputGrid>
            ...
            {result && (
              <div className="space-y-4 animate-fade-in">
                ...
                <div className="flex items-center justify-between">
                  <ResultBadge
                    status={getSizingVerdict().status}
                    label={getSizingVerdict().label}
                  />
                  <button
                    onClick={handleCopy}
        ...
        footer={<CalculatorEditorial content={generatorSizingContent} category={CAT} />}
      />
    </CalculatorCard>
  );
};
