  ...
  return (
    ...
    >
      <CalculatorPanes
              ...
              <div className="space-y-4 animate-fade-in">
                ...
                <CalculatorSection title="Cost Comparison">
                  ...
                  <p className="text-xs text-white mt-2">
                    Central battery typically becomes cost-effective above ~
                    {result.costCrossoverPoint} luminaires
                  </p>
                </CalculatorSection>
                    ...
                    >
                      <div className="space-y-2">
                        ...
                        <p className="text-sm text-white">
                          Emergency lighting activates when the mains supply fails, providing enough
                          light for people to find their way out safely. Without it, a power failure
                          in a windowless building leaves occupants in complete darkness — a serious
                          safety risk.
                        </p>
                      </div>
                      <div className="space-y-2">
                        ...
                        <ul className="space-y-1">
                          ...
                          <li className="flex items-start gap-2 text-sm text-white">
                            <span
                              ...
                              style={{ backgroundColor: config.gradientFrom }}
                            />
                            Open areas (&gt;60m²): minimum 0.5 lux to prevent panic, changeover
                            within 5 seconds
                          </li>
                          <li className="flex items-start gap-2 text-sm text-white">
                            <span
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="text-sm text-white">
                          Self-contained luminaires have their own battery and are simpler to
                          install — ideal for smaller installations. Central battery systems share a
                          single battery bank and become more cost-effective above about 25
                          luminaires, with the advantage of centralised monitoring and easier
                          battery replacement.
                        </p>
                      </div>
                      <div className="space-y-2">
                        ...
                        <ul className="space-y-1">
                          <li className="flex items-start gap-2 text-sm text-white">
                            <span
                              ...
                              style={{ backgroundColor: config.gradientFrom }}
                            />
                            1 hour: premises that can be evacuated immediately and are not
                            reoccupied until mains is restored
                          </li>
                          <li className="flex items-start gap-2 text-sm text-white">
                            <span
                              className="w-1.5 h-1.5 rounded-full mt-2 shrink-0"
                              style={{ backgroundColor: config.gradientFrom }}
                            />
                            3 hours: sleeping accommodation, premises likely to be reoccupied before
                            mains is restored
                          </li>
                        </ul>
                      </div>
        ...
        footer={<CalculatorEditorial content={emergencyLightingContent} category={CAT} />}
      />
    </CalculatorCard>
  );
};
