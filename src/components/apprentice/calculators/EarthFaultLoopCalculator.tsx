  ...
  const results = useMemo(() => {
    if (earthingSystem === 'tn') {
      ...
      return {
        ...
        deviceInfo:
          deviceType === 'fuse'
            ? fuseTypes[fuseType as keyof typeof fuseTypes]
            : curveType
                  ...
                  <ResultsGrid columns={2}>
                    ...
                    <div className="p-3 rounded-xl bg-white/5 border border-white/10">
                      ...
                      <p className="text-xl font-bold text-white">
                        {results.testLimit80?.toFixed(3)}Ω
                      </p>
                      <div
                        className={cn(
                          'flex items-center gap-2 mt-2 text-sm font-medium',
                  ...
                  <div className="p-3 rounded-xl bg-amber-500/10 border border-amber-500/30 flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-amber-300 mt-1">
                        ...
                        {deviceType === 'fuse' ? ` ${fuseType}` : ` ${curveType}`}. Please check
                        available ratings or select a different device.
                      </p>
                    </div>
                  </div>
                )}
              ...
              <>
                ...
                <div className="p-3 rounded-xl bg-white/5 border border-white/10 text-sm">
                  <p className="text-white">
                    <strong>Calculation:</strong> {results.raValue}Ω × {results.iDeltaNValue}A ={' '}
                    {results.product.toFixed(1)}V
                  </p>
                  <p className="text-white/60 mt-2">
                    For TT systems, the product of earth electrode resistance and RCD operating
                    current must not exceed 50V.
                  </p>
                </div>
              </>
            )}
          ...
          <Collapsible open={showGuidance} onOpenChange={setShowGuidance}>
            <div className="calculator-card overflow-hidden" style={{ borderColor: '#60a5fa15' }}>
              ...
              <CollapsibleContent className="p-4 pt-0 space-y-2 text-sm text-blue-200/80">
                <p>
                  • Earth fault loop impedance determines how quickly protective devices operate
                  during earth faults
                </p>
                <p>
                  • Ensures adequate protection against electric shock by guaranteeing disconnection
                  within required times
                </p>
                <p>
                  • Critical for fire prevention - prevents dangerous heating of conductors during
                  fault conditions
                </p>
                <p>
                  • Legal requirement under BS 7671 - must be verified during initial verification
                  and periodic inspection
                </p>
                <p>
                  • Values change with temperature - cables get hotter in service, increasing
                  resistance and Zs values
                </p>
              </CollapsibleContent>
            </div>
          </Collapsible>
              ...
              <CollapsibleContent className="p-4 pt-0 space-y-3 text-sm">
                <div>
                  ...
                  <div className="space-y-1 text-amber-200/80">
                    <p>
                      • <strong className="text-amber-300">411.3.2:</strong> TN systems - protective
                      devices must disconnect in fault conditions
                    </p>
                    <p>
                      • <strong className="text-amber-300">411.4.4:</strong> TT systems - RCD
                      protection required with RA × IΔn ≤ 50V
                    </p>
                    <p>
                      • <strong className="text-amber-300">Table 41.3:</strong> Maximum Zs values
                      for different protective devices
                    </p>
                    <p>
                      • <strong className="text-amber-300">Section 612:</strong> Initial
                      verification requirements for earth fault loop impedance
                    </p>
                  </div>
                </div>
                <div>
                  ...
                  <div className="space-y-1 text-amber-200/80">
                    <p>
                      • <strong className="text-amber-300">Socket outlets:</strong> ≤ 0.4 seconds
                    </p>
                    <p>
                      • <strong className="text-amber-300">Fixed equipment:</strong> ≤ 5 seconds (or
                      ≤ 0.4s if accessible to ordinary persons)
                    </p>
                    <p>
                      • <strong className="text-amber-300">Distribution circuits:</strong> ≤ 5
                      seconds
                    </p>
                  </div>
                </div>
              ...
              <CollapsibleContent className="p-4 pt-0 space-y-3 text-sm">
                <div>
                  ...
                  <div className="space-y-1 text-green-200/80">
                    <p>
                      • Ensure all circuits are complete and protective conductors properly
                      connected
                    </p>
              ...
              <CollapsibleContent className="p-4 pt-0">
                <div className="p-3 rounded-xl bg-purple-500/10 border border-purple-500/20 text-sm">
                  <h4 className="font-medium text-purple-300 mb-2">
                    Ring Final Circuit - 32A Type B MCB
                  </h4>
                  <div className="space-y-2 text-purple-200/80">
                    <p>
                      <strong className="text-purple-300">Given:</strong>
                    </p>
                    ...
                    <p className="mt-3">
                      <strong className="text-purple-300">Calculation:</strong>
                    </p>
                    <p className="ml-4 font-mono">Zs = Ze + (R1 + R2) = 0.35 + 0.72 = 1.07Ω</p>

                    <p className="mt-3">
                      <strong className="text-purple-300">Compliance:</strong>
                    </p>
                    <ul className="ml-4 space-y-1">
      ...
      <div className="p-3 rounded-xl bg-orange-500/10 border border-orange-500/20">
        <div className="flex items-start gap-2">
          ...
          <div className="text-sm text-orange-200">
            <p>
              <strong>TN Systems:</strong> Zs = Ze + (R1 + R2), verify against Table 41.3
            </p>
            <p className="mt-1">
              <strong>TT Systems:</strong> RA × IΔn ≤ 50V
            </p>
          </div>
        </div>
      </div>
