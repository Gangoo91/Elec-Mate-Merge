  ...
  return (
    ...
    >
      <CalculatorPanes
              ...
              <>
                ...
                <CalculatorSection title="Required Disconnection Time">
                  ...
                  <p className="text-xs text-white">
                    ...
                    equipment (Reg 411.3.2.2, Table 41.1). 5 s is permitted for a TN distribution
                    circuit and any circuit not covered by 411.3.2.2 (Reg 411.3.2.3). In a TT system
                    the corresponding allowance is 1 s (Reg 411.3.2.4).
                  </p>
                </CalculatorSection>
                  ...
                  {deviceType === 'rcbo' && (
                    <div className="flex items-start gap-2 p-3 rounded-lg bg-white/5 border border-white/10">
                      ...
                      <p className="text-sm text-white">
                        ...
                        characteristic of the RCBO (Table 41.3). Where the residual-current function
                        is what satisfies the disconnection time, Reg 411.4.204 permits the much
                        higher Table 41.5 values instead (30 mA → 1667 Ω, 100 mA → 500 Ω, 300 mA →
                        167 Ω, 500 mA → 100 Ω), provided an overcurrent device gives overload and
                        fault-current protection to Chapter 43.
                      </p>
                    </div>
                  )}
                </CalculatorSection>
                    ...
                    {!result.maxZsValue && (
                      <div className="flex items-start gap-2 p-3 rounded-lg bg-amber-500/10 border border-amber-500/30">
                        ...
                        <p className="text-sm text-white">
                          ...
                          maximum Zs tables — Table 41.2 (fuses, 0.4 s), Table 41.3
                          (circuit-breakers) or Table 41.4 (fuses, 5 s).
                        </p>
                      </div>
                    )}
                    ...
                    {!result.deviceValid && rating && (
                      <div className="flex items-start gap-2 p-3 rounded-lg bg-amber-500/10 border border-amber-500/30">
                        ...
                        <p className="text-sm text-white">
                          ...
                          {result.disconnectionTime} s. Table 41.2 (0.4 s) stops at 63 A for BS 88-2
                          and BS 88-3, and 60 A for BS 3036 — the higher ratings appear only in
                          Table 41.4 (5 s). Change the disconnection time or the device.
                        </p>
                      </div>
                    )}
                    ...
                    {result.compliance100 && !result.compliance80 && (
                      <div className="flex items-start gap-2 p-3 rounded-lg bg-amber-500/10 border border-amber-500/30">
                        ...
                        <p className="text-sm text-white">
                          ...
                          resistance increases with temperature in service — this circuit may fail
                          under load conditions. Consider cable upgrade or additional RCD
                          protection.
                        </p>
                      </div>
                    )}
                  ...
                  <>
                    ...
                    <div className="flex items-start gap-2 p-3 rounded-lg bg-amber-500/10 border border-amber-500/30">
                      ...
                      <p className="text-sm text-white">
                        ...
                        411.5.3 requires both: (a) disconnection within the time required by Reg
                        411.3.2.2 (Table 41.1 — 0.2 s for TT at 230 V) or Reg 411.3.2.4 (1 s for a
                        distribution circuit), and (b) RA × IΔn ≤ 50 V. Meeting (b) alone is not
                        compliance. Table 41.5 satisfies both where the loop impedance is within its
                        values.
                      </p>
                    </div>
                    ...
                    {result.electrodeAboveStabilityLimit && (
                      <div className="flex items-start gap-2 p-3 rounded-lg bg-amber-500/10 border border-amber-500/30">
                        ...
                        <p className="text-sm text-white">
                          ...
                          installation earth electrode should be as low as practicable and that a
                          value exceeding 200 Ω may not be stable — see Reg 542.2.4, which requires
                          the electrode type and depth to be such that soil drying and freezing will
                          not raise its resistance above the required value. Passing the 50 V
                          arithmetic on a 30 mA device does not make a 200 Ω+ electrode a sound
                          design.
                        </p>
                      </div>
                    )}
                      ...
                      {earthingSystem === 'tn' ? (
                        <>
                          <div className="space-y-2">
                            ...
                            <p className="text-sm text-white">
                              ...
                              transformer, through the line conductor, through the fault, and back
                              via the CPC and external earth. A low Zs means high fault current,
                              which trips the protective device quickly.
                            </p>
                          </div>
                          <div className="space-y-2">
                            <p className="text-sm text-white font-medium">Why the 80% Rule?</p>
                            <p className="text-sm text-white">
                              BS 7671 Table 41.3 values are for conductors at their maximum
                              operating temperature. When you test with a low-resistance ohmmeter,
                              cables are cold. The 80% rule accounts for resistance increasing when
                              cables are loaded and hot. If your measured Zs exceeds 80% of the
                              table value, it may fail under load.
                            </p>
                          </div>
                          ...
                          <div className="space-y-2">
                            ...
                            <ul className="space-y-1">
                              <li className="flex items-start gap-2 text-sm text-white">
                                ...
                                />
                                Final circuit up to 63 A with one or more socket-outlets: ≤ 0.4 s
                                (Reg 411.3.2.2(a), Table 41.1)
                              </li>
                              <li className="flex items-start gap-2 text-sm text-white">
                                <span
                                  className="w-1.5 h-1.5 rounded-full mt-2 shrink-0"
                                  style={{ backgroundColor: config.gradientFrom }}
                                />
                                Final circuit up to 32 A supplying only fixed connected
                                current-using equipment: ≤ 0.4 s (Reg 411.3.2.2(b)) — not 5 s
                              </li>
                              <li className="flex items-start gap-2 text-sm text-white">
                                <span
                                  className="w-1.5 h-1.5 rounded-full mt-2 shrink-0"
                                  style={{ backgroundColor: config.gradientFrom }}
                                />
                                Distribution circuit, and any circuit not covered by 411.3.2.2: ≤ 5
                                s (Reg 411.3.2.3)
                              </li>
                              <li className="flex items-start gap-2 text-sm text-white">
                                <span
                                  ...
                                  style={{ backgroundColor: config.gradientFrom }}
                                />
                                TT equivalents: 0.2 s from Table 41.1, and 1 s for the same cases
                                under Reg 411.3.2.4
                              </li>
                            </ul>
                          </div>
                        ...
                        <>
                          <div className="space-y-2">
                            ...
                            <p className="text-sm text-white">
                              In a TT system, the earth fault return path goes through the general
                              mass of earth — which has high impedance. Overcurrent devices alone
                              cannot guarantee fast disconnection, so RCD protection is essential.
                            </p>
                          </div>
                          <div className="space-y-2">
                            <p className="text-sm text-white font-medium">
                              Reg 411.5.3 — Both Conditions
                            </p>
                            <p className="text-sm text-white">
                              Where an RCD provides fault protection in a TT system, Reg 411.5.3
                              requires (a) disconnection within the time required by Reg 411.3.2.2
                              or 411.3.2.4, and (b) RA × IΔn ≤ 50 V. RA is the sum of the
                              resistances of the earth electrode and the protective conductor
                              connecting it to the exposed-conductive-parts; IΔn is the RCD rated
                              residual operating current. Where RA is not known it may be replaced
                              by Zs. Both conditions are met if the loop impedance is within the
                              Table 41.5 values.
                            </p>
                          </div>
                          ...
                          <div className="space-y-2">
                            ...
                            <ul className="space-y-1">
                              ...
                              <li className="flex items-start gap-2 text-sm text-white">
                                ...
                                542.2.4 (soil drying and freezing must not raise it above the
                                required value). Improve the electrode rather than rely on the RA ×
                                IΔn arithmetic.
                              </li>
                            </ul>
                          </div>
              ...
              variables={
                earthingSystem === 'tn'
                  ? [
                      ...
                      {
                        symbol: 'R1+R2',
                        description: 'Line + CPC resistance to furthest point (Ω)',
                      },
                    ]
                  : [
                      {
                      ...
                      {
                        symbol: '50V',
                        description: 'Maximum permitted touch voltage — Reg 411.5.3(b)',
                      },
                    ]
              }
            />
        ...
        footer={<CalculatorEditorial content={earthFaultLoopContent} category={CAT} />}
      />
    </CalculatorCard>
  );
};
