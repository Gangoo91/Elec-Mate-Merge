  ...
  return (
    ...
    >
      <CalculatorPanes
            ...
            <div className="p-3 rounded-xl bg-red-500/10 border border-red-500/30">
              <div className="flex items-start gap-2">
                ...
                <p className="text-sm text-white">
                  <strong>Warning:</strong> This calculation is for estimation only. Formal arc
                  flash studies must be conducted by qualified engineers.
                </p>
              </div>
            </div>
                    ...
                    >
                      <div className="space-y-2">
                        ...
                        <p className="text-sm text-white">
                          ...
                          fault through air. Temperatures can exceed 20,000°C — hotter than the
                          surface of the sun. The blast produces intense heat, blinding light, a
                          pressure wave, and molten metal spray.
                        </p>
                      </div>
                      <div className="space-y-2">
                        ...
                        <ul className="space-y-1">
                          <li className="flex items-start gap-2 text-sm text-white">
                            <span
                              ...
                              style={{ backgroundColor: config.gradientFrom }}
                            />
                            Category 1 (4 cal/cm²): Single-layer FR clothing, safety glasses,
                            leather gloves
                          </li>
                          <li className="flex items-start gap-2 text-sm text-white">
                            <span
                          ...
                          <li className="flex items-start gap-2 text-sm text-white">
                            <span
                              ...
                              style={{ backgroundColor: config.gradientFrom }}
                            />
                            Category 4 (40 cal/cm²): Full arc flash suit, arc-rated hood with lens,
                        ...
                        <ul className="space-y-1">
                          ...
                          <li className="flex items-start gap-2 text-sm text-white">
                            <span
                              ...
                              style={{ backgroundColor: config.gradientFrom }}
                            />
                            Increase distance: Working further from the source reduces exposure by
                          ...
                          <li className="flex items-start gap-2 text-sm text-white">
                            <span
                              ...
                              style={{ backgroundColor: config.gradientFrom }}
                            />
                            De-energise: The safest approach is always to work dead — arc flash risk
                            is zero when isolated
                          </li>
                          <li className="flex items-start gap-2 text-sm text-white">
                            <span
                              className="w-1.5 h-1.5 rounded-full mt-2 shrink-0"
                              style={{ backgroundColor: config.gradientFrom }}
                            />
                            Arc flash relays: Detect light from an arc and trip the upstream device
                            in under 5ms
                          </li>
                        </ul>
                      </div>
        ...
        footer={<CalculatorEditorial content={arcFlashContent} category={CAT} />}
      />
    </CalculatorCard>
  );
};
