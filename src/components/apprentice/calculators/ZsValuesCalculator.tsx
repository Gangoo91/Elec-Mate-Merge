...
import { CalculatorCard, CALCULATOR_CONFIG } from '@/components/calculators/shared';
              ...
              <div className="space-y-4">
                <div className="p-4 rounded-xl bg-blue-500/10 border border-blue-500/20">
                  <h4 className="font-medium mb-2 text-blue-300">
                    Regulation 411.4.5 - Maximum Earth Fault Loop Impedance
                  </h4>
                  <p className="text-blue-200/90 text-sm mb-3">
                    "The earth fault loop impedance (Zs) at every point of utilisation shall not
                    exceed the values given in Tables 41.2, 41.3 and 41.4."
                  </p>
                  <div className="text-sm text-blue-200">
                    ...
                    <p>
                      Every socket, light fitting, and electrical point must have a low enough earth
                      fault loop impedance so that if a dangerous fault occurs, the protective
                      device (MCB, fuse, etc.) will switch off quickly enough to prevent electric
                      shock or fire.
                    </p>
                  </div>
                </div>
                ...
                <div className="p-4 rounded-xl bg-blue-500/10 border border-blue-500/20">
                  <h4 className="font-medium mb-2 text-blue-300">
                    Table 41.3 - Maximum Zs Values for Final Circuits ≤32A
                  </h4>
            ...
            <div className="calculator-card p-4" style={{ borderColor: '#22c55e30' }}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="p-4 rounded-xl bg-emerald-500/10 border border-emerald-500/20">
                  <h4 className="font-medium mb-2 text-emerald-300">
                    0.4 Second Rule (Final Circuits ≤32A)
                  </h4>
                  <div className="text-sm text-emerald-200">
                    <p className="mb-2">
                      <strong>Why 0.4 seconds?</strong>
                    </p>
                ...
                <div className="p-4 rounded-xl bg-amber-500/10 border border-amber-500/20">
                  <h4 className="font-medium mb-2 text-amber-300">
                    5 Second Rule (Distribution {'>'}32A)
                  </h4>
                  <div className="text-sm text-amber-200">
                    <p className="mb-2">
                      <strong>Why longer is acceptable?</strong>
                    </p>
                ...
                <CollapsibleContent className="p-4 pt-0">
                  <div className="p-4 rounded-xl bg-purple-500/10 border border-purple-500/20">
                    <h4 className="font-medium mb-3 text-purple-300">
                      How are the tabulated values calculated?
                    </h4>
              ...
              <div className="calculator-card overflow-hidden" style={{ borderColor: '#fb923c30' }}>
                <CollapsibleTrigger className="agent-collapsible-trigger w-full">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm sm:text-base font-medium text-orange-300">
                      TT System Considerations
                    </span>
                  </div>
                  <ChevronDown className="h-4 w-4 text-white/70 transition-transform duration-200 group-data-[state=open]:rotate-180" />
                ...
                <CollapsibleContent className="p-4 pt-0">
                  <div className="p-4 rounded-xl bg-orange-500/10 border border-orange-500/20">
                    <h4 className="font-medium mb-3 text-orange-300">
                      RCD Protection Verification (Regulation 411.5.3)
                    </h4>
                    <div className="space-y-3 text-sm text-orange-200">
                      <p>
                        For TT systems, the condition{' '}
            ...
            <Collapsible>
              <div className="calculator-card overflow-hidden" style={{ borderColor: '#fbbf2430' }}>
                ...
                <CollapsibleContent className="p-4 pt-0">
                  <div className="text-sm text-amber-200">
                    <p className="mb-3">
                      BS 7671 tabulated Zs values are calculated using a voltage factor approach,
                      which balances practical considerations with safety requirements.
                    </p>
      ...
      <div className="p-3 rounded-xl bg-blue-500/10 border border-blue-500/20">
        <div className="flex items-start gap-2">
          ...
          <p className="text-sm text-blue-200">
            <strong>Zs</strong> = Ze + (R1+R2). Must be ≤ tabulated maximum for automatic
