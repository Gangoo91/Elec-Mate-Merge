  ...
  return (
    ...
    >
      <CalculatorPanes
        ...
        result={
          <>
              ...
              <div className="space-y-4 animate-fade-in">
                    ...
                    >
                      <div className="space-y-2 text-sm">
                        ...
                        <div className="flex justify-between">
                          ...
                          <span className="text-white">
                            £{result.costPerKwhStored.toFixed(0)}/kWh
                          </span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-white">Expected life</span>
                          <span className="text-white">
                            {result.warrantyYears}+ years ({result.cycleLife.toLocaleString()}{' '}
                            cycles)
                          </span>
                        </div>
                      </div>
                ...
                <div className="p-3 rounded-xl bg-green-500/10 border border-green-500/20 space-y-2">
                  ...
                  <p className="text-xs text-white">
                    Charge off-peak (£{result.tariffArbitrage.offPeakRate.toFixed(2)}/kWh) and use
                    during peak (£{result.tariffArbitrage.peakRate.toFixed(2)}/kWh)
                  </p>
                  ...
                  <p className="text-xs text-white">
                    ...
                    {(result.costBreakdown.total / result.tariffArbitrage.annualSaving).toFixed(1)}{' '}
                    years
                  </p>
                </div>
            ...
            <div className="p-3 rounded-xl bg-white/[0.04] border border-white/[0.12]">
              <div className="flex items-start gap-2">
                <Battery className="h-4 w-4 text-white mt-0.5 shrink-0" />
                <p className="text-sm text-white">
                  <strong>2025 technology data.</strong> Professional design review required for
        ...
        footer={<CalculatorEditorial content={batteryStorageContent} category={CAT} />}
      />
    </CalculatorCard>
  );
};
