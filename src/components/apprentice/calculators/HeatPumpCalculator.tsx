  ...
  return (
    ...
    >
      <CalculatorPanes
          ...
          <>
                      ...
                      <div className="grid grid-cols-2 gap-3 text-sm">
                        ...
                        <div>
                          ...
                          <p className="text-white">
                            {result.carbonSavings.toFixed(0)} kg CO₂/yr vs gas
                          </p>
                        </div>
                        <div>
            ...
            <div className="p-3 rounded-xl bg-white/[0.04] border border-white/[0.12]">
              <div className="flex items-start gap-2">
                ...
                <p className="text-sm text-white">
                  <strong>MCS certified installer required.</strong> This calculator provides
                  estimates for guidance. A full MCS design assessment is required before
                  installation.
                </p>
              </div>
            </div>
            ...
            <FormulaReference
              ...
              variables={[
                ...
                {
                  symbol: 'HLP',
                  description: 'Heat loss per floor area (W/m²), calibrated to 21 K ΔT',
                },
        ...
        footer={<CalculatorEditorial content={heatPumpContent} category={CAT} />}
      />
    </CalculatorCard>
  );
};
