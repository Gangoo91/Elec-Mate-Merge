          ...
          <Collapsible open={showGuidance} onOpenChange={setShowGuidance}>
            <div className="calculator-card overflow-hidden" style={{ borderColor: '#60a5fa15' }}>
              ...
              <CollapsibleContent className="p-4 pt-0 space-y-2 text-sm text-blue-200/80">
                <p>
                  <strong className="text-blue-300">Design Current:</strong> Determines cable sizing
                  and protection device rating.{' '}
                  {result.designCurrent > 100
                    ? 'High current - consider 3-phase supply.'
                    : 'Standard residential/commercial load.'}
                </p>
                <p>
                  <strong className="text-blue-300">Voltage Drop:</strong> Must stay below 5% (BS
                  7671).{' '}
                ...
                <p>
                  <strong className="text-blue-300">Diversity Factor:</strong> Accounts for
                  realistic usage patterns. Multiple chargers rarely operate at full load
                  simultaneously.
                </p>
              </CollapsibleContent>
            </div>
          ...
          <Collapsible open={showRegs} onOpenChange={setShowRegs}>
            <div className="calculator-card overflow-hidden" style={{ borderColor: '#fbbf2415' }}>
              ...
              <CollapsibleContent className="p-4 pt-0 space-y-2 text-sm text-amber-200/80">
                <p>
                  <strong className="text-amber-300">Section 722:</strong> EV charging installations
                  - RCD protection mandatory (30mA Type A minimum)
                </p>
                <p>
                  <strong className="text-amber-300">IET Code of Practice:</strong> EV supply
                  equipment installation and earthing arrangements
                </p>
                <p>
                  <strong className="text-amber-300">Earthing:</strong>{' '}
                  {EARTHING_SYSTEMS[earthingSystem as keyof typeof EARTHING_SYSTEMS]?.description}
                </p>
                {result.selectedProtection?.includes('DC') && (
                  <p className="text-blue-300">
                    <strong>DC Protection:</strong> Required for installations &gt;32A. Consult
