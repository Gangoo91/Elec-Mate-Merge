...
const BasicACCircuitCalculator = () => {
  ...
  const getCircuitStatus = () => {
    ...
    return { text: 'Standard Circuit', color: 'text-white' };
  };
  ...
  return (
    ...
    >
      <CalculatorPanes
              ...
              <>
                    ...
                    <div className="space-y-3 pl-1">
                      ...
                      <div className="border-l-2 border-purple-400/40 pl-3">
                        ...
                        <code className="block mt-1 text-xs px-2.5 py-1.5 rounded-lg bg-black/20 text-white font-mono space-y-0.5">
                          ...
                          {inductance && (
                            <span className="block">Inductance (L): {inductance}mH</span>
                          )}
                          {capacitance && (
                            <span className="block">Capacitance (C): {capacitance}µF</span>
                          )}
                  ...
                  <CollapsibleContent className="pt-2">
                    <div className="space-y-3 pl-1">
                      <div className="border-l-2 border-white/[0.14] pl-3">
                        <p className="text-sm text-white">
                          <strong className="text-elec-yellow">Circuit Behaviour</strong> {'—'}{' '}
                          {results.leadLag}
                        </p>
                      </div>
                      <div className="border-l-2 border-white/[0.14] pl-3">
                        <p className="text-sm text-white">
                          <strong className="text-elec-yellow">X/R Ratio</strong> {'—'}{' '}
                      ...
                      {results.resonantFreq && (
                        <div className="border-l-2 border-white/[0.14] pl-3">
                          <p className="text-sm text-white">
                            <strong className="text-elec-yellow">Resonance</strong> {'—'} Avoid
                            operating at {results.resonantFreq.toFixed(1)} Hz - can cause excessive
                            currents and voltage stress
                          </p>
                        </div>
                      )}
                      <div className="border-l-2 border-white/[0.14] pl-3">
                ...
                <div className="p-3 rounded-xl bg-white/[0.04] border border-white/[0.12]">
                  <div className="flex items-start gap-2">
                    <Info className="h-4 w-4 text-white mt-0.5 shrink-0" />
                    <p className="text-sm text-white">
                      <strong>Key Formulas:</strong> Z = √(R² + X²) | XL = 2πfL | XC = 1/(2πfC) | I
                      = V/Z
                    </p>
                  </div>
                </div>
        ...
        footer={<CalculatorEditorial content={basicAcCircuitContent} category="power" />}
      />
    </CalculatorCard>
  );
};
