      ...
      {result && (
        <div className="space-y-4 animate-fade-in">
          ...
          <div
            ...
            style={{ borderColor: allChecksPass ? '#22c55e20' : '#ef444420' }}
          >
          ...
          <Collapsible open={showGuidance} onOpenChange={setShowGuidance}>
            <div className="calculator-card overflow-hidden" style={{ borderColor: '#60a5fa15' }}>
              ...
              <CollapsibleContent className="p-4 pt-0 space-y-2">
                ...
                <p className="text-sm text-blue-200/80">
                  Area utilisation of{' '}
                  <strong className="text-blue-300">{result.areaEfficiency.toFixed(1)}%</strong>{' '}
            ...
            <div className="calculator-card overflow-hidden" style={{ borderColor: '#fbbf2415' }}>
              ...
              <CollapsibleContent className="p-4 pt-0">
                <div className="space-y-2 text-sm text-amber-200/80">
                  <p>
                    <strong className="text-amber-300">DC isolation:</strong> Min 6mm air gap, 4mm
                    creepage
                  </p>
                  <p>
                    <strong className="text-amber-300">Section 712:</strong> Solar PV power supply
                    systems
                  </p>
                  <p>
                    <strong className="text-amber-300">Section 534:</strong> Type 2 SPDs at DC and
                    AC sides
                  </p>
                  <p>
                    <strong className="text-amber-300">Fire safety:</strong> 1m setback from roof
                    edges
                  </p>
                </div>
              </CollapsibleContent>
      ...
      <div className="p-3 rounded-xl bg-green-500/10 border border-green-500/20">
        <div className="flex items-start gap-2">
          ...
          <p className="text-sm text-green-200">
            <strong>Annual Yield</strong> = Capacity × Irradiance × PR. UK typical: 850-1000
            kWh/kWp/year.
          </p>
        </div>
      </div>
