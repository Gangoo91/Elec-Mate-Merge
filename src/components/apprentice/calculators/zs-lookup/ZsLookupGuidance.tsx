    ...
    <div className="space-y-6">
      ...
      <div className="rounded-xl border border-white/[0.06] bg-white/[0.02] p-4 sm:p-5 space-y-3">
        ...
        <p className="text-[13px] text-white leading-relaxed">
          <strong>Why the 80% factor?</strong> Table 41.3 values assume the conductor at its normal
          operating temperature, but you measure it cold. The GN3 rule of thumb compares a cold
          reading against 80% of the table value to allow for the resistance rising once the circuit
          is loaded.
        </p>
      </div>
      ...
      <div className="rounded-xl border border-white/[0.06] bg-white/[0.02] p-4 sm:p-5 space-y-3">
        ...
        <div className="rounded-lg border border-white/[0.06] bg-white/[0.02] p-3 space-y-1">
          ...
          <div className="text-[13px] text-white space-y-0.5 font-mono">
