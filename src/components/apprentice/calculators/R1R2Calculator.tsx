  ...
  return (
    ...
    >
      <CalculatorPanes
          ...
          <>
                    ...
                    <div className="text-sm font-mono text-white space-y-3 p-3 rounded-xl bg-white/[0.04] border border-white/5">
                      ...
                      <div className="pt-2 border-t border-purple-500/20">
                        ...
                        <div className="pl-3 border-l-2 border-purple-500/30 space-y-0.5">
                          ...
                          <p>
                            Ct ={' '}
                            <span className="font-bold">{result.tempCorrection.toFixed(4)}</span>
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="pt-2 border-t border-purple-500/20">
                        ...
                        <div className="pl-3 border-l-2 border-purple-500/30 space-y-0.5">
                          ...
                          <p>
                            R1+R2 = <span className="font-bold">{result.r1r2.toFixed(4)} Ω</span>{' '}
                            (at {result.temperature}°C)
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="space-y-3 pl-1">
                      <div className="border-l-2 border-white/[0.14] pl-3">
                        <p className="text-sm text-white">
                          <strong>R1:</strong> Resistance of the line conductor from origin to
                          furthest point of the circuit
                        </p>
                      </div>
                      <div className="border-l-2 border-white/[0.14] pl-3">
                        <p className="text-sm text-white">
                          <strong>R2:</strong> Resistance of the circuit protective conductor
                          (CPC/earth)
                        </p>
                      </div>
                      <div className="border-l-2 border-white/[0.14] pl-3">
                        <p className="text-sm text-white">
                          <strong>R1+R2:</strong> Combined resistance used in Zs calculations — Zs =
                          Ze + (R1+R2)
                        </p>
                      </div>
                      <div className="border-l-2 border-white/[0.14] pl-3">
                        <p className="text-sm text-white">
                          <strong>Temperature correction:</strong> Testing is done at ambient
                          (~20°C) but cables operate at 70°C or 90°C. The correction factor accounts
                          for resistance increase under load.
                        </p>
                      </div>
                      <div className="border-l-2 border-white/[0.14] pl-3">
                        <p className="text-sm text-white">
                          <strong>Practical use:</strong> Compare your measured R1+R2 with the
                          calculated value at 20°C. If your reading is higher, check for loose
                          connections, damaged conductors, or incorrect terminations.
                        </p>
                      </div>
                    </div>
                  </CollapsibleContent>
            ...
            <div className="p-3 rounded-xl bg-white/[0.04] border border-white/[0.12]">
              <div className="flex items-start gap-2">
                ...
                <p className="text-sm text-white">
                  <strong>R1+R2</strong> = (r₁ × L × Ct) + (r₂ × L × Ct) / 1000 — where Ct =
        ...
        footer={<CalculatorEditorial content={r1r2Content} category="testing" />}
      />
    </CalculatorCard>
  );
};
