...
const R1R2Calculator = () => {
  ...
  // Simplified resistance values (mΩ/m at 20°C) for common cable sizes
  const cableResistance = {
    "1.5": { r1: 12.1, r2: 12.1 }, // 1.5mm² with same size CPC
    "2.5": { r1: 7.41, r2: 7.41 }, // 2.5mm² with same size CPC
    "4.0": { r1: 4.61, r2: 4.61 }, // 4.0mm² with same size CPC
    "6.0": { r1: 3.08, r2: 3.08 }, // 6.0mm² with same size CPC
    "10.0": { r1: 1.83, r2: 1.83 }, // 10.0mm² with same size CPC
    "16.0": { r1: 1.15, r2: 1.91 }, // 16.0mm² with 10mm² CPC
  ...
  const calculateR1R2 = () => {
    ...
    const r1 = (resistance.r1 * length * tempFactor) / 1000; // Convert to Ω
    const r2 = (resistance.r2 * length * tempFactor) / 1000; // Convert to Ω
    const r1r2 = r1 + r2;
              ...
              <div className="space-y-3">
                ...
                <div className="bg-blue-500/10 border border-blue-500/30 rounded p-3">
                  <p className="text-xs text-blue-300">
                    <strong>Note:</strong> This calculation assumes copper conductors and includes temperature correction for {temperature}°C operation.
                  </p>
                </div>
              </div>
            ) : (
