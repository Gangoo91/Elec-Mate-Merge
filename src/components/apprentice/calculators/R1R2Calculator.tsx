...
const R1R2Calculator = () => {
  ...
  const calculateR1R2 = () => {
    ...
    const resistanceData =
      conductorMaterial === 'copper' ? copperResistance20C : aluminiumResistance20C;
            ...
            >
              <div className="flex items-center gap-2 mb-2">
                <Calculator
                  ...
                  style={{
                    color:
                      parseFloat(measuredValue) <= result.continuityLimit ? '#10b981' : '#ef4444',
                  }}
                />
                <span
                  className={cn(
            ...
            <div className="calculator-card overflow-hidden" style={{ borderColor: '#60a5fa15' }}>
              ...
              <CollapsibleContent className="p-4 pt-0 space-y-2">
                <p className="text-sm text-blue-200/80">
                  <strong className="text-blue-300">R1:</strong> Resistance of the line conductor
                  from origin to furthest point
                </p>
                <p className="text-sm text-blue-200/80">
                  <strong className="text-blue-300">R2:</strong> Resistance of the circuit
                  protective conductor (CPC)
                </p>
                <p className="text-sm text-blue-200/80">
                  <strong className="text-blue-300">R1+R2:</strong> Combined resistance used in Zs
                  calculations for fault loop impedance
                </p>
                <p className="text-sm text-blue-200/80">
                  <strong className="text-blue-300">Test Limit (×1.67):</strong> Correction factor
                  for conductor heating during fault - allows comparison with cold test readings
                </p>
              </CollapsibleContent>
            </div>
          </Collapsible>
            ...
            <div className="calculator-card overflow-hidden" style={{ borderColor: '#fbbf2415' }}>
              ...
              <CollapsibleContent className="p-4 pt-0">
                <div className="space-y-2 text-sm text-amber-200/80">
                  <p>
                    • <strong className="text-amber-300">Reg 612.2:</strong> Continuity of
                    protective conductors including main and supplementary bonding
                  </p>
                  <p>
                    • <strong className="text-amber-300">Reg 411.4.5:</strong> Maximum earth fault
                    loop impedance (Zs) requirements
                  </p>
                  <p>
                    • <strong className="text-amber-300">GN3:</strong> Inspection and Testing
                    guidance for R1+R2 measurements
                  </p>
                  <p>
                    • <strong className="text-amber-300">Table 54.7:</strong> Resistance values for
                    conductors at 20°C
                  </p>
                </div>
              </CollapsibleContent>
      ...
      <div className="p-3 rounded-xl bg-blue-500/10 border border-blue-500/20">
        <div className="flex items-start gap-2">
          ...
          <p className="text-sm text-blue-200">
            <strong>R1+R2</strong> = (r₁ × L × k) + (r₂ × L × k) where k = temperature correction
            factor
          </p>
        </div>
      </div>
