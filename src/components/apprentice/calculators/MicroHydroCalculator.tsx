  ...
  return (
    ...
    >
      <CalculatorPanes
                    ...
                    >
                      <div className="space-y-2">
                        ...
                        <p className="text-sm text-white">
                          Your {result.flowValue} m³/s flow rate with {result.headValue}m head
                          produces {result.practicalPower.toFixed(1)}kW — enough to power
                          approximately {Math.round(result.practicalPower / 3)} average UK homes.
                        </p>
                      </div>
                      <div className="space-y-2">
        ...
        footer={<CalculatorEditorial content={microHydroContent} category={CAT} />}
      />
    </CalculatorCard>
  );
};
