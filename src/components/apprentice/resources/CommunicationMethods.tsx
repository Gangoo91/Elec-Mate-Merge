        ...
        <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="bg-white/5 p-4 rounded-md border border-elec-yellow/10">
                ...
                <p className="text-elec-light/90">
                  Brief, focused safety discussions at the start of shifts that address specific
                  hazards or procedures relevant to the day's work.
                </p>
              </div>
              ...
              <div className="bg-white/5 p-4 rounded-md border border-elec-yellow/10">
                ...
                <p className="text-elec-light/90">
                  More comprehensive discussions covering broader safety topics, often scheduled
                  weekly or monthly.
                </p>
              </div>
              ...
              <div className="bg-white/5 p-4 rounded-md border border-elec-yellow/10">
                ...
                <p className="text-elec-light/90">
                  Direct communication between supervisors and workers for specific task-related
                  safety guidance.
                </p>
              </div>
            </div>
          ...
          <section className="bg-white/10 p-6 rounded-lg border border-elec-yellow/20">
            ...
            <div className="space-y-4">
              <div className="bg-white/5 p-4 rounded-md border border-elec-yellow/10">
                ...
                <p className="text-elec-light/90">
                  Clear, standardized signs that communicate hazards, required PPE, and safety
                  procedures.
                </p>
              </div>
              ...
              <div className="bg-white/5 p-4 rounded-md border border-elec-yellow/10">
                ...
                <p className="text-elec-light/90">
                  Dedicated display areas for safety information, incident reports, and current
                  safety focus areas.
                </p>
              </div>
              ...
              <div className="bg-white/5 p-4 rounded-md border border-elec-yellow/10">
                ...
                <p className="text-elec-light/90">
                  Using consistent colors to indicate different hazards or safety requirements
                  (e.g., red for fire equipment, yellow for caution).
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="bg-white/10 p-6 rounded-lg border border-elec-yellow/20">
            ...
            <div className="space-y-4">
              <div className="bg-white/5 p-4 rounded-md border border-elec-yellow/10">
                ...
                <p className="text-elec-light/90">
                  Comprehensive documents containing all safety policies, procedures, and reference
                  information.
                </p>
              </div>
              ...
              <div className="bg-white/5 p-4 rounded-md border border-elec-yellow/10">
                ...
                <p className="text-elec-light/90">
                  Detailed documents outlining how specific tasks should be performed safely.
                </p>
              </div>
              ...
              <div className="bg-white/5 p-4 rounded-md border border-elec-yellow/10">
                ...
                <p className="text-elec-light/90">
                  Written evaluations of potential hazards and control measures for specific tasks
                  or environments.
                </p>
              </div>
            </div>
          ...
          <section className="bg-white/10 p-6 rounded-lg border border-elec-yellow/20">
            ...
            <div className="space-y-4">
              <div className="bg-white/5 p-4 rounded-md border border-elec-yellow/10">
                ...
                <p className="text-elec-light/90">
                  Mobile applications that provide real-time safety information, hazard reporting,
                  and reference materials.
                </p>
              </div>

              <div className="bg-white/5 p-4 rounded-md border border-elec-yellow/10">
                <h3 className="font-medium text-elec-yellow mb-2">
                  Emergency Notification Systems
                </h3>
                <p className="text-elec-light/90">
                  Digital systems that can rapidly communicate emergency information to all workers
              ...
              <div className="bg-white/5 p-4 rounded-md border border-elec-yellow/10">
                ...
                <p className="text-elec-light/90">
                  Visual displays showing safety performance metrics, recent incidents, and current
                  focus areas.
                </p>
              </div>
            </div>
          ...
          <section className="bg-white/10 p-6 rounded-lg border border-elec-yellow/20">
            ...
            <ul className="list-disc pl-6 space-y-2 text-elec-light/90">
              <li>
                Use multiple communication methods to reach workers with different learning
                preferences
              </li>
