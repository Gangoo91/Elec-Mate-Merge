      ...
      <div className="space-y-8">
        ...
        <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="bg-white/5 p-4 rounded-md border border-elec-yellow/10">
                ...
                <p className="text-elec-light/90 mb-2">
                  Formal evaluations of potential hazards and the control measures required to
                  mitigate them.
                </p>
                <p className="text-elec-light/70 text-sm italic">
                  Required for all electrical work activities with significant risks.
                </p>
              </div>
              ...
              <div className="bg-white/5 p-4 rounded-md border border-elec-yellow/10">
                ...
                <p className="text-elec-light/90 mb-2">
                  Step-by-step procedures for completing tasks safely, incorporating risk assessment
                  findings.
                </p>
                <p className="text-elec-light/70 text-sm italic">
                  Particularly important for complex or high-risk electrical installations.
                </p>
              </div>
              ...
              <div className="bg-white/5 p-4 rounded-md border border-elec-yellow/10">
                ...
                <p className="text-elec-light/70 text-sm italic">
                  Provides evidence of ongoing safety communication and training.
                </p>
              </div>
              ...
              <div className="bg-white/5 p-4 rounded-md border border-elec-yellow/10">
                ...
                <p className="text-elec-light/90 mb-2">
                  Detailed records of accidents, near-misses, and safety violations with
                  investigation findings.
                </p>
                <p className="text-elec-light/70 text-sm italic">
                  Critical for preventing recurrence and demonstrating regulatory compliance.
                </p>
              </div>
              ...
              <div className="bg-white/5 p-4 rounded-md border border-elec-yellow/10">
                ...
                <p className="text-elec-light/70 text-sm italic">
                  Legally required for most electrical installation work.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="bg-white/10 p-6 rounded-lg border border-elec-yellow/20">
            ...
            <p className="mb-4">
              Standardized templates ensure consistent and complete documentation:
            </p>
          ...
          <section className="bg-white/10 p-6 rounded-lg border border-elec-yellow/20">
            ...
            <div className="bg-white/5 p-4 rounded-md border border-elec-yellow/10">
              ...
              <p className="mt-3 text-elec-light/70 text-sm italic">
