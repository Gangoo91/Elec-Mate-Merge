            ...
            <div className="space-y-4">
              <div className="bg-white/5 p-4 rounded-md border border-elec-yellow/10">
                <h3 className="font-medium text-elec-yellow mb-2">
                  Daily Toolbox Talks (5-15 minutes)
                </h3>
              ...
              <div className="bg-white/5 p-4 rounded-md border border-elec-yellow/10">
                <h3 className="font-medium text-elec-yellow mb-2">
                  Weekly Safety Meetings (15-30 minutes)
                </h3>
                <ul className="list-disc pl-6 space-y-1 text-elec-light/90">
              ...
              <div className="bg-white/5 p-4 rounded-md border border-elec-yellow/10">
                <h3 className="font-medium text-elec-yellow mb-2">
                  Monthly Safety Committee Meetings (30-60 minutes)
                </h3>
                <ul className="list-disc pl-6 space-y-1 text-elec-light/90">
              ...
              <div className="bg-white/5 p-4 rounded-md border border-elec-yellow/10">
                <h3 className="font-medium text-elec-yellow mb-2">
                  Emergency Response Drills (varies)
                </h3>
                <ul className="list-disc pl-6 space-y-1 text-elec-light/90">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-white/5 p-4 rounded-md border border-elec-yellow/10">
                ...
                <p className="text-elec-light/90">
                  Focus on topics directly applicable to current work tasks and actual conditions on
                  site.
                </p>
              </div>
              ...
              <div className="bg-white/5 p-4 rounded-md border border-elec-yellow/10">
                ...
                <p className="text-elec-light/90">
                  Include photos, diagrams, or actual equipment to illustrate key points and improve
                  retention.
                </p>
              </div>
              ...
              <div className="bg-white/5 p-4 rounded-md border border-elec-yellow/10">
                ...
                <p className="text-elec-light/90">
                  Ask questions, invite experiences, and create an environment where workers feel
              ...
              <div className="bg-white/5 p-4 rounded-md border border-elec-yellow/10">
                ...
                <p className="text-elec-light/90">
                  Allow different team members to lead meetings to increase engagement and develop
                  safety leadership.
                </p>
              </div>
            </div>
