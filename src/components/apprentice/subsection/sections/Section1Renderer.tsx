...
export const renderSection1 = ({
  ...
  isCompleted,
  markAsComplete,
  isElectricalTheory: propIsElectricalTheory,
}: SubsectionProps) => {
  useEffect(() => {
  ...
  const isElectricalTheory =
    propIsElectricalTheory ||
    unitSlug === 'elec2-04' ||
    urlPath.includes('electrical-theory') ||
    urlPath.includes('/elec2-04');

  console.log(
    'Section1Renderer - Is Electrical Theory:',
    isElectricalTheory,
    'Unit:',
    unitSlug,
    'Path:',
  ...
  const renderHealthSafetyContent = (id: string, type: string) => {
    console.log(
      'Section1Renderer - Rendering health & safety content with type:',
      type,
      'and id:',
      id
    );
