  ...
  return (
    <div className="space-y-6">
      <div className="p-6 bg-white/5 border border-elec-yellow/20 rounded-lg text-center">
        ...
        <div
          className={`p-4 rounded-lg ${isPassing ? 'bg-green-500/20 border border-green-500/30' : 'bg-amber-500/20 border border-amber-500/30'}`}
        >
          {isPassing ? (
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-white">You need 70% to pass. Keep studying and try again.</p>
            </div>
          )}
        </div>
        ...
        <div className="space-y-6">
          {questions.map((question, index) => {
            ...
            return (
              <div
                key={index}
                className="pb-4 border-b border-elec-yellow/10 last:border-0 last:pb-0"
              >
                  ...
                  <div>
                    ...
                    {!isCorrect && question.explanation && (
                      <div className="mt-2 p-2 bg-elec-yellow/5 rounded text-xs border border-elec-yellow/10">
                        <span className="font-medium text-elec-yellow">Explanation:</span>{' '}
