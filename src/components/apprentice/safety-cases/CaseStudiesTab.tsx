  ...
  const caseStudies = [
    {
      ...
      description:
        'Investigation into a fatal arc flash incident during maintenance work on a 11kV switchgear. The victim was an experienced electrician performing routine maintenance when an arc flash occurred.',
      detailedDescription:
        'A 45-year-old qualified electrician was performing routine maintenance on an 11kV switchgear panel when an arc flash incident occurred. The electrician was wearing standard PPE but not arc-rated clothing. The incident resulted in severe burns and ultimately proved fatal.',
      keyLearnings: [
      ...
      lessonsLearned:
        'This incident highlights the critical importance of comprehensive arc flash risk assessments and appropriate PPE selection. All electrical work must be properly planned with appropriate safety measures.',
      impact: 'High',
    ...
    },
    {
      ...
      industry: 'Domestic',
      description:
        'An apprentice electrician received an electric shock due to faulty RCD protection on a domestic installation during routine testing work.',
      detailedDescription:
        "A second-year apprentice was conducting routine electrical testing in a domestic property when they received an electric shock from a socket outlet. Investigation revealed that the RCD protection had failed but this wasn't detected during previous testing.",
      keyLearnings: [
      ...
      lessonsLearned:
        'Regular testing of protective devices is essential. This case demonstrates why additional protection measures and proper supervision are crucial when working with electricity.',
      impact: 'Medium',
    ...
    },
    {
      ...
      industry: 'Commercial',
      description:
        'A near-miss incident caused by improper lockout/tagout procedures during maintenance work on a commercial electrical system.',
      detailedDescription:
        "During planned maintenance work on a commercial building's electrical system, a contractor nearly worked on live equipment due to inadequate isolation procedures. The incident was prevented when another worker noticed the error.",
      keyLearnings: [
      ...
      lessonsLearned:
        'Effective communication and proper isolation procedures are fundamental to electrical safety. This near-miss shows how easily accidents can occur without proper systems.',
      impact: 'Low',
    ...
    },
    {
      ...
      description:
        'Fatal incident involving contact with overhead power lines during crane operations on a construction site.',
      detailedDescription:
        "A crane operator was moving materials when the crane's jib contacted 11kV overhead power lines. The operator was electrocuted and died at the scene. Investigation revealed inadequate site planning and lack of exclusion zones.",
      keyLearnings: [
      ...
      regulations: [
        'HSG47 Avoiding Danger from Overhead Power Lines',
      ...
      lessonsLearned:
        'Overhead lines present significant risks that must be properly managed through planning, identification, and control measures. This tragic case emphasises the need for comprehensive site safety planning.',
      impact: 'High',
    ...
    },
    {
      ...
      industry: 'Domestic',
      description:
        'A house fire originated from a newly installed consumer unit due to poor workmanship and inadequate cable terminations.',
      detailedDescription:
        'Three weeks after a full domestic rewire, a fire broke out in the utility cupboard where the new consumer unit had been installed. Investigation revealed loose terminations, undersized cables on high-load circuits, and missing fire barriers. The family escaped but the property suffered £80,000 in damage.',
      keyLearnings: [
      ...
      lessonsLearned:
        'This case demonstrates that poor workmanship can have devastating consequences even weeks after installation. Proper torque settings, cable sizing, and independent verification are essential safeguards.',
      impact: 'High',
    ...
    },
    {
      ...
      industry: 'Domestic',
      description:
        'A landscaper struck a buried electrical cable while digging a trench for garden lighting, causing serious burns and electrical injuries.',
      detailedDescription:
        'A self-employed landscaper was installing garden lighting when his spade cut through a buried armoured cable supplying an outbuilding. The cable was not at the required depth and no cable location survey had been conducted. The worker suffered significant burns to hands and arms.',
      keyLearnings: [
      ...
      lessonsLearned:
        'Underground services can be anywhere. This incident reinforces that cable location equipment must be used before ANY excavation work, regardless of how minor it may seem.',
      impact: 'Medium',
    ...
    },
    {
      ...
      industry: 'Construction',
      description:
        'A first-year apprentice fell from a stepladder while installing a high-level socket, sustaining a broken wrist and concussion.',
      detailedDescription:
        'An 18-year-old apprentice was left unsupervised to install a socket for a wall-mounted TV at 2.4m height. Using a worn stepladder on an uneven floor, they overreached and fell. The supervising electrician was working in another room at the time of the incident.',
      keyLearnings: [
      ...
      lessonsLearned:
        'Apprentices need appropriate supervision levels based on their competence. This case shows how quickly accidents can happen when supervision lapses, even for seemingly simple tasks.',
      impact: 'Medium',
    ...
    },
    {
      ...
      industry: 'Industrial',
      description:
        'A three-phase motor overheated due to phase imbalance, nearly causing a fire in a food processing area.',
      detailedDescription:
        'During routine maintenance, one phase connection to a large conveyor motor was not properly tightened. Over several weeks, the loose connection caused increasing resistance and phase imbalance. The motor overheated to near-ignition point before thermal protection finally tripped.',
      keyLearnings: [
      ...
      lessonsLearned:
        'Phase imbalance is a gradual killer of motors and can create serious fire risks. Proper connection torques and regular thermal monitoring are essential preventive measures in industrial settings.',
      impact: 'Low',
    ...
    },
    {
      ...
      industry: 'Events',
      description:
        'A festival worker was electrocuted by a temporary power installation that had not been properly protected against ground conditions.',
      detailedDescription:
        'During setup for a music festival, a 23-year-old worker touched a generator distribution board that had become live due to water ingress. Heavy rain had flooded the area but work continued. The installation lacked adequate IP rating and earth fault protection for the conditions.',
      keyLearnings: [
      ...
      lessonsLearned:
        'Temporary does not mean temporary standards. This tragedy shows that outdoor and temporary installations face unique hazards that require specific protective measures and the courage to stop work when conditions deteriorate.',
      impact: 'High',
    ...
    },
    {
      ...
      industry: 'Commercial',
      description:
        'A battery explosion in a data centre UPS room caused injuries to two technicians and significant equipment damage.',
      detailedDescription:
        'During routine UPS maintenance, a lead-acid battery exploded due to hydrogen gas accumulation and an ignition source from sparking during connection work. Two technicians suffered burns and hearing damage. Investigation revealed inadequate ventilation and missing gas detection systems.',
      keyLearnings: [
      ...
      regulations: [
        'BS EN 50272-2 Battery Installations',
        'DSEAR 2002',
        'Electricity at Work Regulations 1989',
      ],
      timeline: [
      ...
      lessonsLearned:
        'Battery systems present explosion risks that are often underestimated. This case emphasises the importance of treating battery rooms as hazardous areas requiring specific safety measures and procedures.',
      impact: 'Medium',
    ...
    },
    {
      ...
      industry: 'Commercial',
      description:
        'An electrician nearly contacted live parts while working on what was believed to be an isolated circuit in a school during term time.',
      detailedDescription:
        "During a partial rewire of a primary school, an electrician began work on a circuit he believed was isolated. Unknown to him, the circuit had been incorrectly labelled and was fed from a different distribution board. A colleague noticed the voltage indicator hadn't been used and stopped the work.",
      keyLearnings: [
      ...
      lessonsLearned:
        'Proving dead is non-negotiable. This near miss shows how even experienced electricians can make assumptions that could prove fatal. The intervention of a colleague prevented a potential tragedy.',
      impact: 'Low',
    ...
    },
    {
      ...
      description:
        'A solar installer received a serious DC electric shock while working on a rooftop PV array in sunny conditions.',
      detailedDescription:
        'An installer was connecting DC cables from a solar array when they received a shock from exposed conductors. Despite the AC isolator being off, the DC side remained energised by sunlight. The installer had not used appropriate DC-rated PPE or followed solar-specific safe working procedures.',
      keyLearnings: [
      ...
      regulations: [
        'BS 7671:2018 Section 712',
        'BS EN 62446 PV Systems',
        'Electricity at Work Regulations 1989',
      ],
      timeline: [
      ...
      lessonsLearned:
        'Solar PV systems present unique hazards because DC is generated whenever light is present. This case highlights that renewable energy technologies require specific competencies and procedures beyond traditional electrical work.',
      impact: 'Medium',
      investigationDuration: '3 months',
      fineAmount: '£65,000',
      views: 1987,
