    ...
    <div className="space-y-6 animate-fade-in">
        ...
        {regionalJobMarkets.map((region) => (
          ...
          >
            ...
            <div className="rounded-lg border border-white/[0.06] bg-white/[0.02] p-3 space-y-1.5 text-[13px] text-white">
              <div>
                <span className="text-white">Transport links: </span>
              ...
              <div>
                <span className="text-white">Career tip: </span>
                <span>
      ...
      <div className="rounded-xl border border-white/[0.06] bg-white/[0.02] p-4 sm:p-5 space-y-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="space-y-2">
            <p className="text-[12px] text-white">Market trends</p>
          ...
          <div className="space-y-2">
            <p className="text-[12px] text-white">Best regions for</p>
            <ul className="space-y-1 text-[13px] text-white">
          ...
          <div className="space-y-2">
            <p className="text-[12px] text-white">Outlook</p>
            <ul className="space-y-1 text-[13px] text-white">
