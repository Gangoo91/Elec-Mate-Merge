...
export const ukQualifications: UKQualification[] = [
  ...
  {
    level: 'Level 3',
    name: 'AM2S Assessment',
    code: 'AM2S',
    duration: '2½–3 days',
    cost: 'Funded within the apprenticeship (centre fee for standalone candidates)',
    awarding_body: 'NET',
    description:
      'The end-point assessment for ST0152 — the practical gateway to the ECS Gold card at Electrician grade',
  },
  {
    level: 'Level 3',
    name: '18th Edition BS 7671',
    code: '2382 (current amendment)',
    duration: '3-5 days',
    cost: '£300-£500',
    awarding_body: 'City & Guilds, EAL',
...
export const ukCareerLevels: UKCareerLevel[] = [
  {
    ...
    prerequisites: [
      {
        name: 'ECS Health & Safety Assessment',
        code: 'ECS H&S',
        mandatory: true,
        awarding_body: 'ECS',
      },
      ...
      {
        name: 'BS 7671 awareness (18th Edition)',
        code: '2382',
        mandatory: false,
    ...
    cpd: {
      interval: 'Ongoing',
      requirements: ['College assignments', 'Toolbox talks', 'Logbook updates'],
    },
    branches: [],
    portfolio_evidence: [
  ...
  },
  {
    ...
    prerequisites: [
      ...
      { name: '18th Edition (recommended)', code: '2382', mandatory: false },
  ...
  },
  {
    ...
    prerequisites: [
      ...
      {
        name: 'AM2/AM2S practical assessment',
        code: 'AM2/AM2S',
        mandatory: true,
        awarding_body: 'JIB/ECS',
      },
      { name: '18th Edition BS 7671', code: '2382', mandatory: true },
    ],
    day_rates: { employed: '£165–£240/day equivalent', contractor: '£195–£305/day' },
    cpd: {
      interval: 'Annual (recommended)',
      requirements: ['BS 7671 amendment updates', 'Manufacturer CPD'],
    },
    branches: [
      {
        id: 'qs',
        title: 'Qualified Supervisor (NICEIC/NAPIT)',
        description: 'Take responsibility for compliance and certification',
      },
      {
        id: 'specialist',
        title: 'Specialist Installer (EV/Solar)',
        description: 'Gain 2919 (EV) or 2399 (Solar PV) and focus on renewables',
      },
    ],
    portfolio_evidence: [
      'EIC/MWC certificates',
      'Test sheets (initial verification)',
      'Complex fault rectification write-ups',
    ],
  ...
  },
  {
    ...
    cpd: {
      interval: 'Annual',
      requirements: ['Management H&S (SMSTS/SSSTS)', 'Manufacturer leadership briefings'],
    },
    portfolio_evidence: [
      'Project programmes',
      'RAMS & permits',
  ...
  },
  {
    ...
    cpd: {
      interval: 'Annual',
      requirements: ['Scheme assessment', 'Regulatory updates', 'Accounts & H&S compliance'],
    },
    branches: [
...
export const ukWorkSectors = [
  ...
  },
  {
    ...
    key_skills: [
      ...
      'Smart Metering Technical Expert (SMTE)',
      'Customer interface',
    ],
  },
  {
