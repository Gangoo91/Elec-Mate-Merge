...
export const careerSections: CareerSection[] = [
  {
    ...
    description:
      'Explore 12+ career routes from apprentice to senior roles with salary guides and progression timelines',
  ...
  },
  {
    ...
    description:
      'Find training courses to advance your skills - from 18th Edition to specialist certifications',
  ...
  },
  {
    ...
    description:
      'Essential certifications from NICEIC, NAPIT, ECS cards and more to advance your career',
  ...
  },
  {
    ...
    description:
      'HNC, HND, degrees and advanced qualifications to take your career to the next level',
  ...
  },
  {
    ...
    description:
      'Start and grow your own electrical contracting business with step-by-step guidance',
