...
export const careerCourses: CareerCourse[] = [
  {
    ...
    provider: 'NICEIC',
    description:
      'Essential course covering the latest BS7671 electrical regulations for all UK installations.',
    duration: '3 days',
    level: 'Intermediate',
    price: '£350 - £450',
  ...
  },
  {
    ...
    description:
      'Learn how to properly test and verify electrical installations to industry standards.',
    duration: '5 days',
    level: 'Advanced',
    price: '£600 - £750',
  ...
  },
  {
    ...
    description:
      'Mobile Elevating Work Platform operation certification, essential for electricians working at height.',
    duration: '1-2 days',
    level: 'All levels',
    price: '£200 - £350',
  ...
  },
  {
    ...
    description:
      'Essential training for safe assembly, dismantling and use of mobile access towers.',
    duration: '1 day',
    level: 'All levels',
    price: '£150 - £200',
  ...
  },
  {
    ...
    description:
      'Critical safety training for electrical work at height including harness use and rescue procedures.',
    duration: '1 day',
    level: 'All levels',
    price: '£120 - £180',
  ...
  },
  {
    ...
    provider: 'FIA',
    description:
      'Comprehensive training on designing, installing and maintaining fire detection systems.',
    duration: '4 days',
    level: 'Intermediate',
    price: '£500 - £600',
  ...
  },
  {
    ...
    description:
      'Critical safety training for identifying and working safely around potential asbestos materials.',
    duration: 'Half day',
    level: 'All levels',
    price: '£70 - £90',
  ...
  },
  {
    ...
    provider: 'CompEx',
    description:
      'Specialist training for electricians working in potentially explosive atmospheres and hazardous environments.',
    duration: '5 days',
    level: 'Advanced',
    price: '£900 - £1,200',
    format: 'Classroom with practical assessments',
  ...
  },
  {
    ...
    description:
      'Essential first aid qualification for site workers, covering emergency response procedures.',
    duration: '3 days',
    level: 'All levels',
    price: '£250 - £350',
  ...
  },
  {
    ...
    description:
      'Specialised certification for installing, testing and maintaining emergency lighting systems.',
    duration: '2 days',
    level: 'Intermediate',
    price: '£320 - £400',
  ...
  },
  {
    ...
    description:
      'Modern technology integration training for intelligent building systems installation and programming.',
    duration: '5 days',
    level: 'Advanced',
    price: '£850 - £1,200',
  ...
  },
  {
    ...
    description:
      'Advanced training for complex EV charging installations including three-phase and commercial systems.',
    duration: '3 days',
    level: 'Advanced',
    price: '£550 - £700',
  ...
  },
  {
    ...
    provider: 'NAPIT',
    description:
      'Comprehensive training for conducting periodic inspection and testing of electrical installations.',
    duration: '4 days',
    level: 'Advanced',
    price: '£650 - £800',
  ...
  },
  {
    ...
    provider: 'ECA',
    description:
      'Specialised power systems training for complex commercial and industrial installations.',
    duration: '4 days',
    level: 'Advanced',
    price: '£700 - £850',
  ...
  },
  {
    ...
    description:
      'Installation and testing of structured cabling systems for network and communications.',
    duration: '3 days',
    level: 'Intermediate',
    price: '£450 - £600',
