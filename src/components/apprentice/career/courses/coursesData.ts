...
export const careerCourses: CareerCourse[] = [
  ...
  },
  {
    ...
    description: "Specialised certification for installing, testing and maintaining emergency lighting systems.",
    duration: "2 days",
    level: "Intermediate",
    price: "£320 - £400",
  ...
  },
  {
    ...
    provider: "ECA",
    description: "Specialised power systems training for complex commercial and industrial installations.",
    duration: "4 days",
    level: "Advanced",
    price: "£700 - £850",
