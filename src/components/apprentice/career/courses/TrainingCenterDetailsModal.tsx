...
const TrainingCenterDetailsModal = ({ center, onClose }: TrainingCenterDetailsModalProps) => {
  return (
    <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="rounded-xl border border-white/[0.06] bg-white/[0.06] w-full max-w-4xl max-h-[90vh] overflow-y-auto">
          ...
          <Section eyebrow="Training facilities">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
              {center.facilities.map((facility, idx) => (
                <div key={idx} className="text-[14px] text-white leading-relaxed">
                  {facility}
                </div>
              ))}
            </div>
            ...
            <form className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <label className="text-[12px] text-white">Full name</label>
                  <Input
                ...
                <div className="space-y-2">
                  <label className="text-[12px] text-white">Course interest</label>
                  <Select>
