...
export const enhancedCareerCourses: EnhancedCareerCourse[] = [
  {
    id: 1,
    title: '18th Edition Wiring Regulations (BS 7671:2018+A4:2026)',
    provider: 'NICEIC Academy',
    description:
      'Comprehensive training on the latest IET Wiring Regulations, covering all amendments and updates essential for UK electrical installations.',
    duration: '3 days',
    level: 'Intermediate',
    price: '£395 - £495',
  ...
  },
  {
    ...
    description:
      'Advanced practical training for electrical installation inspection, testing and verification to BS 7671 standards.',
    duration: '5 days',
    level: 'Advanced',
    price: '£695 - £895',
  ...
  },
  {
    ...
    description:
      'Specialised certification for installing domestic and commercial EV charging points, covering Mode 3 charging systems.',
    duration: '2 days',
    level: 'Intermediate',
    price: '£425 - £525',
  ...
  },
  {
    ...
    description:
      'Advanced training in intelligent building control systems, IoT integration, and smart home technologies.',
    duration: '5 days',
    level: 'Advanced',
    price: '£1,295 - £1,595',
  ...
  },
  {
    ...
    description:
      'Comprehensive training on fire detection and alarm system design, installation, and maintenance to British Standards.',
    duration: '4 days',
    level: 'Intermediate',
    price: '£595 - £695',
  ...
  },
  {
    ...
    description:
      'Complete training for solar photovoltaic system installation, covering MCS requirements and grid connection procedures.',
    duration: '3 days',
    level: 'Intermediate',
    price: '£495 - £595',
  ...
  },
  {
    ...
    description:
      'Essential certification for operating aerial work platforms and mobile elevating work platforms safely in electrical installations.',
    duration: '1-2 days',
    level: 'Beginner',
    price: '£200 - £350',
  ...
  },
  {
    ...
    provider: 'Cenex',
    description:
      'Advanced course covering the design and specification of commercial EV charging networks and rapid charging systems.',
    duration: '3 days',
    level: 'Advanced',
    price: '£795 - £995',
  ...
  },
  {
    ...
    description:
      'Comprehensive training on battery storage technology, installation, and grid integration for renewable energy systems.',
    duration: '4 days',
    level: 'Advanced',
    price: '£895 - £1,095',
  ...
  },
  {
    ...
    description:
      'Cutting-edge training in smart home systems, IoT devices, and home automation for modern electrical installations.',
    duration: '3 days',
    level: 'Intermediate',
    price: '£595 - £745',
  ...
  },
  {
    ...
    description:
      'Specialised training for electrical installations in data centres, covering power distribution, UPS systems, and critical infrastructure.',
    duration: '5 days',
    level: 'Advanced',
    price: '£1,295 - £1,595',
  ...
  },
  {
    ...
    description:
      'Comprehensive training on air source and ground source heat pump installation, covering MCS requirements and renewable incentives.',
    duration: '3 days',
    level: 'Intermediate',
    price: '£545 - £695',
  ...
  },
  {
    ...
    description:
      'Advanced course combining drone operation with electrical inspection techniques for overhead lines and solar installations.',
    duration: '5 days',
    level: 'Advanced',
    price: '£1,195 - £1,495',
    ...
    accreditation: [
      ...
      'Electrical inspection qualified',
    ],
    employerSupport: false,
  ...
  },
  {
    ...
    description:
      'Professional training in energy management systems, monitoring technologies, and efficiency optimisation for commercial buildings.',
    duration: '4 days',
    level: 'Advanced',
    price: '£795 - £995',
    format: 'Technical workshop with site visits',
  ...
  },
  {
    ...
    description:
      'Comprehensive training in modern LED lighting design, smart controls, and energy-efficient lighting solutions for all applications.',
    duration: '3 days',
    level: 'Intermediate',
    price: '£495 - £625',
  ...
  },
  {
    ...
    description:
      'Specialised training for managing commercial EV fleets, including charging infrastructure planning and energy management.',
    duration: '2 days',
    level: 'Intermediate',
    price: '£445 - £565',
  ...
  },
  {
    ...
    description:
      "Forward-looking training on hydrogen fuel cells, electrolysis systems, and hydrogen's role in future electrical infrastructure.",
    duration: '4 days',
    level: 'Advanced',
    price: '£995 - £1,295',
    ...
    prerequisites: [
      ...
      'Chemical engineering knowledge beneficial',
    ],
    courseOutline: [
  ...
  },
  {
    ...
    description:
      'Comprehensive safety training specific to renewable energy installations, covering wind, solar, and energy storage safety protocols.',
    duration: '3 days',
    level: 'Intermediate',
    price: '£425 - £545',
  ...
  },
  {
    ...
    description:
      'Comprehensive training on portable appliance testing procedures, safety standards, and certification for electrical equipment inspection.',
    duration: '1 day',
    level: 'Beginner',
    price: '£150 - £250',
  ...
  },
  {
    ...
    description:
      'Essential certification for working with electrical equipment in hazardous areas and explosive atmospheres.',
    duration: '3-5 days',
    level: 'Advanced',
    price: '£695 - £995',
  ...
  },
  {
    ...
    description:
      'Authorised person training for high voltage switching operations and electrical safety in high voltage environments.',
    duration: '5 days',
    level: 'Advanced',
    price: '£1,195 - £1,495',
  ...
  },
  {
    ...
    description:
      'Essential first aid training for electricians working in potentially hazardous environments, including electrical emergency procedures.',
    duration: '1 day',
    level: 'Beginner',
    price: '£85 - £150',
  ...
  },
  {
    ...
    description:
      'Health & safety assessment and ECS card application support for electricians working on construction sites.',
    duration: 'Half day',
    level: 'Beginner',
    price: '£50 - £85',
