...
export const enhancedEducationOptions: EnhancedEducationOption[] = [
  {
    ...
    description:
      'Higher National Certificate providing advanced electrical theory and practical skills for technical roles in the electrical industry.',
    level: 'Level 4',
    duration: '1-2 years',
  ...
  },
  {
    ...
    description:
      'Higher National Diploma offering comprehensive electrical and electronic engineering knowledge with strong industry links.',
    level: 'Level 5',
  ...
  },
  {
    ...
    description:
      'Honours degree in electrical engineering covering all aspects from power systems to electronics and renewable energy.',
    level: 'Level 6',
  ...
  },
  {
    ...
    institution: 'Universities',
    description:
      "Advanced master's degree specialising in renewable energy technologies and sustainable electrical systems.",
    level: 'Level 7',
    duration: '1 year full-time, 2-3 years part-time',
    entryRequirements:
      "Bachelor's degree (2:1 or above) in electrical/electronic engineering or related field",
  ...
  },
  {
    ...
    description:
      'Work-based foundation degree combining practical electrical skills with academic study, ideal for working electricians.',
    level: 'Level 5',
    duration: '2-3 years part-time',
    entryRequirements:
      'Level 3 electrical qualification and current employment in electrical industry',
    progressionOptions:
      'Top-up to full honours degree, senior technician roles, supervisory positions',
    keyTopics: [
  ...
  },
  {
    ...
    description:
      "Integrated master's degree providing the most direct route to chartered engineer status with industry placement year.",
    level: 'Level 7',
    duration: '4 years full-time (including placement year)',
    entryRequirements: 'A-Levels AAB-A*A*A (including Maths and Physics)',
    progressionOptions:
      'Direct entry to graduate schemes, chartered engineer fast-track, PhD research',
    keyTopics: [
...
export const fundingOptions: FundingOption[] = [
  {
    ...
    type: 'Loan',
    description:
      'Government loan for Level 3, 4, 5 and 6 qualifications at approved colleges and training organisations.',
  ...
  },
  {
    ...
    description:
      'Many employers will fund further education that benefits their business operations.',
  ...
  },
  {
    ...
    type: 'Scholarship',
    description:
      'Financial support for electrical engineering students from the Institution of Engineering and Technology.',
    eligibility: [
      'Studying accredited engineering course',
...
export const careerPathways: CareerPathway[] = [
  {
    ...
    description:
      'Progress from technician to senior technical leadership roles in electrical engineering.',
    educationSteps: [
      ...
      {
        level: 'BEng (Level 6)',
        duration: '1-2 years top-up',
        requirements: 'HND with good grades',
      },
    ],
    salaryProgression: [
      ...
      {
        stage: 'Engineering Manager',
        salary: '£45,000 - £60,000+',
        experience: 'Degree + 5 years',
      },
    ],
    ...
    futureOutlook:
      'Excellent - increasing complexity of electrical systems requires qualified technical leaders',
  },
  {
    id: 2,
    name: 'Renewable Energy Specialist',
    description:
      'Specialise in the rapidly growing renewable energy sector with cutting-edge technology focus.',
    educationSteps: [
      {
        level: 'Foundation in Renewables',
        duration: '6 months',
        requirements: 'Electrical qualification',
      },
      {
        level: 'BEng Electrical Engineering',
        duration: '3-4 years',
        requirements: 'Level 3 or foundation',
      },
