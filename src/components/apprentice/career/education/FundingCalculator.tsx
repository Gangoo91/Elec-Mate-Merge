...
const OFFICIAL_LINKS = [
  ...
  {
    label: 'IET Awards',
    url: 'https://www.theiet.org/impact-society/awards-prizes-and-scholarships',
  },
];
        ...
        {FUNDING_TYPES.map((type) => (
          ...
          >
            <div className="min-w-0 flex-1">
              ...
              <p className="text-[12px] text-white mt-0.5">{type.amount}</p>
            </div>
        ...
        <div className="grid grid-cols-2 gap-2">
          {OFFICIAL_LINKS.map((link) => (
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-2.5 bg-white/[0.02] border border-white/[0.06] rounded-lg text-[12px] text-white hover:bg-white/[0.04] transition-colors touch-manipulation text-left"
            >
              <ExternalLink className="h-3 w-3 flex-shrink-0 text-white" />
        ...
        >
          <div className="flex flex-col h-full">
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-5">
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  <Label className="text-[12px] text-white">Course cost (£) *</Label>
                  <Input
                    type="number"
                ...
                <div className="space-y-2">
                  <Label className="text-[12px] text-white">Your annual salary (£)</Label>
                  <Input
                    type="number"
                    ...
                    className="h-11 text-base touch-manipulation bg-white/[0.03] border-white/10 text-white placeholder:text-white/40 focus:border-yellow-500 focus:ring-yellow-500"
                  />
                  <p className="text-[12px] text-white">Used to calculate repayments</p>
                </div>

                <div className="space-y-2">
                  <Label className="text-[12px] text-white">Employer contribution (£)</Label>
                  <Input
                    type="number"
                ...
                {result.monthlyRepayment > 0 && (
                  <div className="rounded-xl border border-white/[0.06] bg-white/[0.02] p-4 space-y-2">
                    ...
                    <p className="text-[24px] font-semibold text-white">
                      ...
                      <span className="text-[14px] font-normal text-white"> / month</span>
                    </p>
