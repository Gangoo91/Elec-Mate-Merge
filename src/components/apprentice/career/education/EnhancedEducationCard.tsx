...
const EnhancedEducationCard = ({ 
  ...
  return (
    <Card className="border-elec-yellow/20 bg-white/5 hover:border-elec-yellow/40 transition-all duration-200 h-full flex flex-col">
      <CardHeader className="pb-3">
        <div className="flex justify-between items-start gap-2">
          ...
          <div className="flex flex-col items-end gap-1">
            <Badge variant="outline" className="text-xs bg-white/10 border-elec-yellow/30">
              {option.level}
            </Badge>
      ...
      <CardContent className="pt-0 flex-grow flex flex-col">
        ...
        <div className="grid grid-cols-1 gap-3 mb-4">
          ...
          <div className="flex items-center gap-2 text-sm">
            ...
            <span className="text-white">{option.employmentRate}% employment rate</span>
          </div>

          <div className="flex items-center gap-2 text-sm">
            <Calendar className="h-4 w-4 text-elec-yellow flex-shrink-0" />
            <span className="text-white">Next intake: {option.nextIntakes[0]}</span>
          </div>
        </div>
        ...
        <div className="mb-4">
          ...
          <div className="flex flex-wrap gap-1">
            ...
            {option.keyTopics.length > 3 && (
              <span className="text-xs text-white">+{option.keyTopics.length - 3} more</span>
            )}
          </div>
        </div>
