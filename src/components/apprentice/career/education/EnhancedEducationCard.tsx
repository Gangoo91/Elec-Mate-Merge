  ...
  return (
    <div className="rounded-xl border border-white/[0.06] bg-white/[0.02] p-4 sm:p-5 h-full flex flex-col gap-4">
      <div className="space-y-2">
        ...
        <p className="text-[14px] text-white">{option.institution}</p>
      </div>

      <p className="text-[14px] text-white leading-relaxed line-clamp-2">{option.description}</p>
      ...
      <div className="space-y-2 text-[14px] text-white leading-relaxed">
        ...
        <div>
          <span className="text-white">Employment rate: </span>
          {option.employmentRate}%
        </div>
        <div>
          <span className="text-white">Next intake: </span>
      ...
      <div className="space-y-2">
        ...
        <div className="flex flex-wrap gap-1.5">
          ...
          {option.keyTopics.length > 3 && (
            <span className="text-[12px] text-white">+{option.keyTopics.length - 3} more</span>
          )}
        </div>
      </div>
      ...
      <div className="mt-auto pt-3 border-t border-white/[0.06] space-y-3">
        <div className="flex items-baseline justify-between text-[14px]">
          ...
          <span className="text-white">{option.averageStartingSalary}</span>
        </div>
        <Button
