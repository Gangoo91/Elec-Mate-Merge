...
export const ukAccreditations: UKAccreditation[] = [
  {
    ...
    description:
      'Professional membership demonstrating engineering competence and commitment to CPD.',
    detailedDescription:
      'Membership of the IET provides professional recognition, access to technical resources, networking opportunities, and demonstrates your commitment to engineering excellence. MIET status is widely recognised across the UK electrical industry.',
    requirements: [
  ...
  },
  {
    ...
    category: 'Engineering',
    description:
      'The highest level of engineering qualification in the UK, demonstrating engineering leadership.',
    detailedDescription:
      'CEng is the gold standard for engineering professionals in the UK. It demonstrates your ability to develop appropriate solutions to engineering problems using new or existing technologies, with commercial awareness and environmental impact consideration.',
    requirements: [
    ...
    contactInfo: {
      ...
      address:
        'Engineering Council, Arden House, 1102 Warwick Road, Acocks Green, Birmingham B27 6BH',
    },
  },
  {
    id: 'eca-membership',
    ...
    category: 'Trade',
    description:
      'Essential membership for electrical contractors, providing business credibility and support.',
    detailedDescription:
      'ECA membership is the mark of quality for electrical contractors in the UK. It provides business credibility, technical support, and access to industry schemes that can significantly boost your contracting business.',
    requirements: [
  ...
  },
  {
    ...
    category: 'Engineering',
    description:
      'Professional registration for engineers implementing existing and emerging technologies.',
    detailedDescription:
      'IEng registration demonstrates your ability to maintain and manage applications of current and developing technology, and may involve responsibility for complex technical or other work.',
    requirements: [
  ...
  },
  {
    ...
    detailedDescription:
      "EngTech registration recognises your ability to apply proven techniques and procedures to solve practical engineering problems. It's the first step on the professional registration ladder.",
    requirements: [
