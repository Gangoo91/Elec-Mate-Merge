      ...
      developmentAreas: [
        {
          ...
          businessImpact:
            'Improved team productivity, better remote project outcomes, increased team engagement',
        },
        {
      ...
      developmentAreas: [
        {
          ...
          description:
            'Maintaining physical and mental health in demanding electrical work environments',
          developmentPath:
    ...
    <div className="space-y-4">
      <Alert className="border-green-500/50 bg-green-500/10">
        ...
        <AlertDescription className="text-green-200">
          Strategic professional development reduces career progression time by 50% and increases
          lifetime earning potential by £200,000+.
        </AlertDescription>
      </Alert>
                ...
                <div className="space-y-3">
                  {category.programmes.map((programme, progIndex) => (
                    ...
                    >
                      ...
                      <div>
                        <h6
                          className={`font-medium text-amber-300 mb-1 ${isMobile ? 'text-xs' : 'text-sm'}`}
                        >
                          Prerequisites
                        </h6>
                        <p className={`${isMobile ? 'text-xs' : 'text-sm'} text-amber-200`}>
          ...
          <MobileAccordionContent className="space-y-4 p-4 bg-white/5">
            {leadershipDevelopment.map((category, index) => (
              <div key={index} className="border border-purple-500/20 rounded-lg p-3 space-y-3">
                <h4
                  className={`font-medium text-white ${isMobile ? 'text-sm' : 'text-base'} border-b border-purple-500/20 pb-1`}
                >
                  {category.category}
                </h4>
          ...
          <MobileAccordionContent className="space-y-4 p-4 bg-white/5">
            {digitalProfessionalismSkills.map((category, index) => (
              <div key={index} className="border border-cyan-500/20 rounded-lg p-3 space-y-3">
                <h4
                  className={`font-medium text-white ${isMobile ? 'text-sm' : 'text-base'} border-b border-cyan-500/20 pb-1`}
                >
                  {category.category}
                </h4>
          ...
          <MobileAccordionContent className="space-y-4 p-4 bg-white/5">
            {innovationEntrepreneurship.map((category, index) => (
              <div key={index} className="border border-orange-500/20 rounded-lg p-3 space-y-3">
                <h4
                  className={`font-medium text-white ${isMobile ? 'text-sm' : 'text-base'} border-b border-orange-500/20 pb-1`}
                >
                  {category.category}
                </h4>
        ...
        <MobileAccordionItem value="sustainability-esg">
          ...
          <MobileAccordionContent className="space-y-4 p-4 bg-white/5">
            {sustainabilityESG.map((category, index) => (
              <div key={index} className="border border-green-500/20 rounded-lg p-3 space-y-3">
                <h4
                  className={`font-medium text-white ${isMobile ? 'text-sm' : 'text-base'} border-b border-green-500/20 pb-1`}
                >
                  {category.category}
                </h4>
          ...
          <MobileAccordionContent className="space-y-4 p-4 bg-white/5">
            {wellbeingResilience.map((category, index) => (
              <div key={index} className="border border-pink-500/20 rounded-lg p-3 space-y-3">
                <h4
                  className={`font-medium text-white ${isMobile ? 'text-sm' : 'text-base'} border-b border-pink-500/20 pb-1`}
                >
                  {category.category}
                </h4>
          ...
          <MobileAccordionContent className="space-y-4 p-4 bg-white/5">
            {industryAdvocacy.map((category, index) => (
              <div key={index} className="border border-indigo-500/20 rounded-lg p-3 space-y-3">
                <h4
                  className={`font-medium text-white ${isMobile ? 'text-sm' : 'text-base'} border-b border-indigo-500/20 pb-1`}
                >
                  {category.category}
                </h4>
          ...
          <MobileAccordionContent className="space-y-4 p-4 bg-white/5">
            {internationalOpportunities.map((category, index) => (
              <div key={index} className="border border-teal-500/20 rounded-lg p-3 space-y-3">
                <h4
                  className={`font-medium text-white ${isMobile ? 'text-sm' : 'text-base'} border-b border-teal-500/20 pb-1`}
                >
                  {category.category}
                </h4>
                ...
                <div className="space-y-3">
                  {category.developmentAreas.map((area, areaIndex) => (
                    <div
                      key={areaIndex}
                      className="bg-teal-500/5 border border-teal-500/20 rounded p-3 space-y-2"
                    >
                      <h5
                      ...
                      <div>
                        <h6
                          className={`font-medium text-teal-300 mb-1 ${isMobile ? 'text-xs' : 'text-sm'}`}
                        >
                          Development Path
                        </h6>
                        <p className={`${isMobile ? 'text-xs' : 'text-sm'} text-teal-200`}>
                          {area.developmentPath}
                        </p>
                      </div>
                  ...
                  <CardContent className="space-y-3">
                    <div className="space-y-2">
                      <div className={`${isMobile ? 'text-xs' : 'text-sm'} text-violet-200`}>
                        <strong>Year 1-2:</strong> Foundation skills mastery and professional
                        qualification completion
                      </div>
                      <div className={`${isMobile ? 'text-xs' : 'text-sm'} text-violet-200`}>
                        <strong>Year 3:</strong> Specialisation selection and advanced training
                        commencement
                      </div>
                      <div className={`${isMobile ? 'text-xs' : 'text-sm'} text-violet-200`}>
                        <strong>Year 4:</strong> Leadership role development and business skills
                        acquisition
                      </div>
                      <div className={`${isMobile ? 'text-xs' : 'text-sm'} text-violet-200`}>
                        <strong>Year 5:</strong> Senior position achievement or business
                        establishment
                      </div>
                    </div>
                  </CardContent>
                  ...
                  <CardContent className="space-y-3">
                    <div className="grid grid-cols-2 gap-2">
                      <div className="space-y-1">
                        <h6
                          className={`font-medium text-green-300 ${isMobile ? 'text-xs' : 'text-sm'}`}
                        >
                          Strengths
                        </h6>
                        <div className={`${isMobile ? 'text-xs' : 'text-sm'} text-green-200`}>
                          Technical skills, work ethic, problem-solving
                        </div>
                      </div>
                      <div className="space-y-1">
                        <h6
                          className={`font-medium text-red-300 ${isMobile ? 'text-xs' : 'text-sm'}`}
                        >
                          Weaknesses
                        </h6>
                        <div className={`${isMobile ? 'text-xs' : 'text-sm'} text-red-200`}>
                          Business skills, networking, experience
                        </div>
                      </div>
                      <div className="space-y-1">
                        <h6
                          className={`font-medium text-blue-300 ${isMobile ? 'text-xs' : 'text-sm'}`}
                        >
                          Opportunities
                        </h6>
                        <div className={`${isMobile ? 'text-xs' : 'text-sm'} text-blue-200`}>
                          Green energy, smart buildings, EV charging
                        </div>
                      </div>
                      <div className="space-y-1">
                        <h6
                          className={`font-medium text-orange-300 ${isMobile ? 'text-xs' : 'text-sm'}`}
                        >
                          Threats
                        </h6>
                        <div className={`${isMobile ? 'text-xs' : 'text-sm'} text-orange-200`}>
