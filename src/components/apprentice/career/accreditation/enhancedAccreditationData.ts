...
export const enhancedAccreditationOptions: AccreditationOption[] = [
  {
    ...
    description:
      'Premier electrical contracting scheme providing consumer confidence and industry recognition for electrical contractors.',
    benefits: [
  ...
  },
  {
    ...
    description:
      'Leading competent person scheme for electrical contractors, providing industry recognition and Building Regulations compliance.',
    benefits: [
      'Building Control notification rights',
  ...
  {
    id: 'elecsa-scheme',
    title: 'ELECSA (retired — now NICEIC)',
    provider: 'Certsure (NICEIC)',
    category: 'Competent Person Schemes',
    level: 'Advanced',
    duration: 'Initial assessment + ongoing',
    cost: '£500-900 annually',
    description:
      'ELECSA was consolidated into NICEIC by Certsure and no longer takes new applications — register with NICEIC for the same self-certification rights.',
    benefits: [
    ...
    requirements: [
      'Electrical qualifications (City & Guilds 2391-52) + 18th Edition A4:2026',
      'Minimum 3 years electrical experience',
      'Public liability insurance',
      'Initial assessment process',
    ],
    nextSteps: [
      'Apply for NICEIC registration instead',
    ...
    locations: ['UK-wide'],
    website: 'https://www.niceic.com',
    accreditationBody: 'Certsure (NICEIC)',
    renewalPeriod: 'Annual',
  ...
  },
  {
    ...
    description:
      'UKAS-accredited certification body providing competent person scheme membership for electrical contractors.',
    benefits: [
  ...
  },
  {
    ...
    description:
      'Professional registration with the IET demonstrating competence and commitment to electrical engineering excellence.',
    benefits: [
  ...
  },
  {
    ...
    description:
      'Professional membership for building services engineers, including electrical systems designers and engineers.',
    benefits: [
  ...
  },
  {
    ...
    description:
      "Membership of the UK's leading trade association for electrical contractors, providing business support and industry representation.",
    benefits: [
  ...
  },
  {
    ...
    description:
      "Scotland's leading electrical trade association, representing electrical contractors and promoting industry standards.",
    benefits: [
  ...
  },
  {
    ...
    cost: '£35-50 for card',
    description:
      'Industry employment and card scheme providing portable skills record and site access for electrical workers.',
    benefits: [
  ...
  },
  {
    ...
    description:
      "Professional membership of the world's largest professional health and safety organisation.",
    benefits: [
  ...
  },
  {
    ...
    description:
      'Internationally recognised health and safety qualifications for safety professionals and managers.',
    benefits: [
  ...
  },
  {
    ...
    cost: '£200-400 annually',
    description:
      "Professional membership of the UK's chartered body for project management professionals.",
    benefits: [
  ...
  },
  {
    ...
    description:
      'Professional membership for construction and project management professionals in the built environment.',
    benefits: [
