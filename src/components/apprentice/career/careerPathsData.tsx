...
export const careerPaths = [
  {
    ...
    description:
      'Maintain, troubleshoot, and repair electrical systems in factories, plants, or commercial buildings.',
  ...
  },
  {
    ...
    description:
      'Install, maintain, and repair electrical systems in domestic, commercial and industrial environments.',
  ...
  },
  {
    ...
    description:
      'Focus on specific areas like renewable energy, electric vehicles, battery storage, or building management systems.',
  ...
  },
  {
    ...
    description:
      'An approved status electrician is qualified to supervise others and can work on most electrical installations independently.',
  ...
  },
  {
    ...
    description:
      'Design, develop and test electrical equipment and systems for buildings, transportation, or power generation.',
  ...
  },
  {
    ...
    description:
      'Create detailed electrical designs and drawings for construction projects using CAD and BIM software.',
  ...
  },
  {
    ...
    description:
      'Ensure electrical installations comply with regulations and safety standards, working with local authorities.',
  ...
  },
  {
    ...
    description:
      'Test, verify and commission new electrical systems to ensure they operate according to specification.',
  ...
  },
  {
    ...
    description:
      'Lead complex commissioning projects for major electrical and control systems in commercial and industrial facilities.',
  ...
  },
  {
    ...
    description:
      'Oversee large-scale electrical projects, coordinate teams, and manage budgets and timelines.',
  ...
  },
  {
    ...
    description:
      'Run your own electrical contracting business focusing on residential, commercial, or industrial work.',
