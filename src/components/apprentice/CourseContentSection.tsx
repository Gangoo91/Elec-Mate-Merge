              ...
              : icon === 'list'
                ...
                : icon === 'section'
                  ...
                  : icon === 'cable'
                    ? Cable
                    : icon === 'socket'
                      ? Cable // Using Cable as a fallback for socket since it doesn't exist
                      : icon === 'bulb'
                        ? Lightbulb
                        : icon === 'test'
                          ? TestTube
                          : icon === 'tools'
                            ? Construction
                            : Info; // Using Construction as a fallback for tools
        ...
        <>
          ...
          <div className="my-4 bg-white/10 border border-elec-yellow/20 rounded-md p-4">
            <h4 className="text-lg font-semibold text-elec-yellow mb-3">
              The Essential Steps of Safe Isolation:
            </h4>
            <ol className="list-decimal pl-5 space-y-2 text-white">
              ...
              <li>
                <span className="font-medium text-white">Prove the tester</span> - Test your voltage
                indicator on a known live source
              </li>
              <li>
    ...
    <div className={`mb-4 ${isMainSection ? 'bg-transparent' : ''}`}>
      <div className="flex items-start gap-3 mb-2">
        <div className="flex-shrink-0 mt-1">
          ...
          {!sectionNumber && <IconComponent className="h-6 w-6 text-elec-yellow" />}
        </div>
        <div className="flex-1">{formatDescription(description, subsectionId)}</div>
      </div>
