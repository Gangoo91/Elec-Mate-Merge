  ...
  return (
    <div className="border border-elec-yellow/30 rounded-lg p-6 space-y-4">
      ...
      <div className="space-y-4">
        <p>
          The Work at Height Regulations 2005 provides a comprehensive framework for managing the
          risks associated with working at height. Electrical workers must understand these
          regulations as they frequently work in elevated positions when installing lighting, cable
          trays, or accessing distribution boards.
        </p>
        ...
        <div className="bg-white/10 border border-elec-yellow/20 rounded-lg p-4">
          ...
          <ul className="list-disc pl-5 space-y-2 text-elec-light/80">
            ...
            <li>
              <span className="font-medium text-white">Regulation 6:</span> Avoiding work at height
              where possible
            </li>
            <li>
              <span className="font-medium text-white">Regulation 7:</span> Proper risk assessment
              for unavoidable height work
            </li>
            <li>
              <span className="font-medium text-white">Regulation 8:</span> Account for weather
              conditions that could endanger health and safety
            </li>
            <li>
              <span className="font-medium text-white">Regulation 9:</span> Staff must be properly
              trained for working at height
            </li>
            <li>
              <span className="font-medium text-white">Regulation 12:</span> Inspection of work
