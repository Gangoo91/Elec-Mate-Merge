      ...
      <CardContent className="space-y-4">
        ...
        <div className="pt-4">
          <ResizablePanelGroup
            ...
            className="rounded-lg border border-elec-yellow/20"
          >
            <ResizablePanel defaultSize={33} minSize={20} className="bg-white/10 p-4 rounded-l-lg">
              ...
              <ul className="list-disc pl-5 space-y-1 text-sm">
                <li>
                  <span className="font-medium">Non-conductive</span> - Safe for electrical work
                </li>
            ...
            <ResizablePanel defaultSize={33} minSize={20} className="bg-white/10 p-4">
              ...
              <ul className="list-disc pl-5 space-y-1 text-sm">
                <li>
                  <span className="text-red-400 font-medium">Conductive</span> - NOT suitable near
                  live electricity
                </li>
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
          <Card className="bg-white/10 border border-elec-yellow/20 rounded-xl overflow-hidden">
            <CardHeader className="pb-2">
              <CardTitle className="text-lg font-semibold text-elec-yellow">
                Ladder Designs for Electrical Applications
              </CardTitle>
            </CardHeader>
            <CardContent>
              <ul className="space-y-3">
                <li>
                  ...
                  <p className="text-sm mt-1">
                    Used for accessing higher elevations; must be properly secured before climbing.
                    Required overlap sections increase with ladder length.
                  </p>
                </li>
                <li>
                  <span className="font-medium text-elec-yellow">Stepladders</span>
                  <p className="text-sm mt-1">
                    Self-supporting; ideal for lighting installations and low-level distribution
                    board work. Must be fully opened with spreaders locked.
                  </p>
                </li>
                <li>
                  <span className="font-medium text-elec-yellow">Platform Ladders</span>
                  <p className="text-sm mt-1">
                    Include a standing platform; excellent for extended work periods and when using
                    both hands for electrical connections. Provide better stability.
                  </p>
                </li>
                <li>
                  <span className="font-medium text-elec-yellow">Combination Ladders</span>
                  <p className="text-sm mt-1">
                    Versatile design; can function as stepladder, extension ladder, or stairwell
                    ladder. Useful for varying electrical tasks throughout a project.
                  </p>
                </li>
              </ul>
            </CardContent>
          ...
          <Card className="bg-white/10 border border-elec-yellow/20 rounded-xl overflow-hidden">
            ...
            <CardContent>
              <p className="mb-4">
                Ladders for professional electrical work must conform to EN 131 Professional
                standard or BS 2037 Class 1. These classifications ensure appropriate duty ratings
                for industrial use.
              </p>
              <div className="bg-white/10 p-4 rounded-lg border border-elec-yellow/20">
                ...
                <ul className="space-y-2 text-sm">
                  <li>
                    <span className="font-medium">Class 1 (Industrial):</span> Maximum load - 175kg
                  </li>
                  <li>
                    <span className="font-medium">EN131 Professional:</span> Maximum load - 150kg
                  </li>
                  <li>
                    <span className="font-medium">EN131 Non-Professional:</span> Maximum load -
                    120kg
                  </li>
                  <li>
                    <span className="font-medium">Class 3 (Domestic):</span> NOT suitable for
                    electrical work
                  </li>
                </ul>
              </div>
