    ...
    <Card className="border border-elec-yellow/30 bg-elec-card rounded-xl overflow-hidden">
      ...
      <CardContent className="space-y-6">
        <div className="bg-white/10 border-l-4 border-amber-500 p-4 rounded-r">
          ...
          <p className="text-sm">
            A task-specific risk assessment must be completed before using ladders for electrical
            work. This assessment should identify hazards, evaluate risks, and determine control
            measures needed to work safely at height whilst managing electrical hazards.
          </p>
        </div>
            ...
            <CardHeader className="pb-2">
              <div className="flex items-center">
                ...
                <CardTitle className="text-lg font-semibold text-elec-yellow">
                  Working Near Electrical Services
                </CardTitle>
              </div>
            </CardHeader>
            <CardContent>
              <ul className="space-y-3 text-sm">
                <li>
                  ...
                  <p className="mt-1">
                    Maintain minimum clearances from overhead power lines: 3m from low voltage, 6m
                    from high voltage. Distance increases with voltage level.
                  </p>
                </li>
                <li>
                  <span className="font-medium text-elec-yellow">Fiberglass Ladders Only</span>
                  <p className="mt-1">
                    When working near any energised electrical equipment, only use fully insulated
                    fiberglass ladders with non-conductive stiles.
                  </p>
                </li>
                <li>
                  <span className="font-medium text-elec-yellow">Weather Conditions</span>
                  <p className="mt-1">
                    Avoid using ladders outdoors during high winds, heavy rain, or lightning storms
                    as these conditions increase electrical hazards.
                  </p>
                </li>
                <li>
                  <span className="font-medium text-elec-yellow">Isolation Verification</span>
                  <p className="mt-1">
                    Always verify electrical isolation before positioning ladder near electrical
                    equipment. Never assume a circuit is dead.
                  </p>
                </li>
              </ul>
            </CardContent>
            ...
            <CardContent>
              <ul className="space-y-3 text-sm">
                <li>
                  ...
                  <p className="mt-1">
                    Always position extension ladders at a 75° angle (1 out for every 4 up). A
                    simple check: stand with toes against ladder feet, extend arms - palms should
                    touch rung at shoulder height.
                  </p>
                </li>
                <li>
                  <span className="font-medium text-elec-yellow">Level Base</span>
                  <p className="mt-1">
                    Ensure ladder feet are on firm, level ground. Never use bricks or other
                    materials to level a ladder - use purpose-designed leg levellers instead.
                  </p>
                </li>
                <li>
                  <span className="font-medium text-elec-yellow">Securing Methods</span>
                  <p className="mt-1">
                    Tie ladders at the top, bottom or both when possible. When securing isn't
                    possible, have a second person 'foot' the ladder during use.
                  </p>
                </li>
                <li>
                  <span className="font-medium text-elec-yellow">Stabilising Devices</span>
                  <p className="mt-1">
                    Use appropriate stabilisers, stand-offs, or outriggers in accordance with
                    manufacturer's recommendations for additional stability.
                  </p>
                </li>
              </ul>
            </CardContent>
        ...
        <Card className="bg-white/10 border border-elec-yellow/20 rounded-xl overflow-hidden">
          <CardHeader className="pb-2">
            <CardTitle className="text-lg font-semibold text-elec-yellow">
              Legal Requirements & Alternatives
            </CardTitle>
          </CardHeader>
          <CardContent>
