    ...
    <div className="space-y-8">
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-white mt-1">
              ...
              covering occupational health and safety in the United Kingdom. It establishes the
              legal framework to promote, stimulate and encourage high standards of health and
      ...
      <Card className="border-elec-yellow/30 bg-white/10">
        ...
        <CardContent className="space-y-4">
          <p>
            The Health and Safety at Work Act 1974 sets out the legal duties that employers have
            towards their employees and members of the public, as well as the duties that employees
            have to themselves and to each other. These duties are qualified by the principle of 'so
      ...
      <Card className="border-elec-yellow/30 bg-white/10">
        ...
        <CardContent className="space-y-4">
          <p>
            Under Section 2 of the Act, employers have a duty to ensure, so far as is reasonably
            practicable, the health, safety and welfare at work of all employees. This includes
            specific obligations that are particularly relevant to electrical work.
          </p>
          ...
          <div className="bg-white/10 rounded-md p-4 border border-elec-yellow/20 mb-4">
            ...
            <ul className="list-disc pl-5 space-y-2">
              <li>
                <span className="font-medium text-white">Safe plant and systems of work</span> -
                Ensuring electrical installations and equipment are safe
              </li>
              <li>
                <span className="font-medium text-white">
                  Safe use, handling, storage of substances
                </span>{' '}
                - Including electrical components and materials
              </li>
              <li>
                <span className="font-medium text-white">
                  Information, instruction, training and supervision
                </span>{' '}
                - Ensuring electrical workers are competent
              </li>
              <li>
                <span className="font-medium text-white">Safe workplaces</span> - Including
                electrical safety measures and emergency procedures
              </li>
              <li>
                <span className="font-medium text-white">Safe working environment</span> - Proper
                lighting, ventilation, etc. for electrical work
              </li>
              <li>
                <span className="font-medium text-white">Adequate welfare facilities</span> - Rest
                areas, washing facilities, etc.
              </li>
              <li>
                <span className="font-medium text-white">Health and safety policy</span> - Written
                policy for organisations with 5+ employees
              </li>
              <li>
                <span className="font-medium text-white">Risk assessment</span> - Identifying and
          ...
          <div className="bg-elec-yellow/10 p-4 rounded-md border border-elec-yellow/30 flex items-start gap-3">
            ...
            <p className="text-sm">
              ...
              comply with additional specific regulations, such as the Electricity at Work
              Regulations 1989, which detail more specific requirements for electrical safety in the
              workplace.
            </p>
          </div>
        </CardContent>
      ...
      <Card className="border-elec-yellow/30 bg-white/10">
        ...
        <CardContent className="space-y-4">
          <p>
            Under Sections 7 and 8 of the Act, employees also have duties while at work. These are
            particularly important for electrical workers due to the hazardous nature of their work.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="bg-white/10 rounded-md p-4 border border-elec-yellow/20">
              ...
              <ul className="list-disc pl-5 space-y-2">
                ...
                <li>
                  Take reasonable care for the safety of others who may be affected by their acts or
                  omissions
                </li>
          ...
          <div className="bg-elec-yellow/10 p-4 rounded-md border border-elec-yellow/30 flex items-start gap-3 mt-4">
            ...
            <p className="text-sm">
              ...
              follow safe isolation procedures, use appropriate test equipment, wear correct PPE,
              and never work on live equipment unless absolutely necessary and with appropriate
      ...
      <Card className="border-elec-yellow/30 bg-white/10">
        ...
        <CardContent className="space-y-4">
          <p>
            The Health and Safety Executive (HSE) and local authorities enforce the Health and
            Safety at Work Act. Inspectors have significant powers and can issue various notices and
            initiate prosecutions for breaches.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div className="bg-white/10 rounded-md p-4 border border-elec-yellow/20">
              ...
              <ul className="list-disc pl-5 space-y-1">
                <li>
                  <span className="font-medium text-white">Improvement Notice</span> - Requires
                  remedy of a breach within a specified time
                </li>
                <li>
                  <span className="font-medium text-white">Prohibition Notice</span> - Stops work
                  activities that create serious risk
                </li>
                <li>
                  <span className="font-medium text-white">Fee for Intervention</span> - HSE can
                  charge for their time when they identify material breaches
                </li>
                <li>
                  <span className="font-medium text-white">Prosecution</span> - For serious breaches
                  or where notices are not complied with
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="bg-elec-yellow/10 p-4 rounded-md border border-elec-yellow/30 flex items-start gap-3 mt-4">
            ...
            <p className="text-sm">
              ...
              the potentially fatal consequences of electrical incidents, prosecutions for
              electrical safety breaches often result in significant penalties, especially where
              proper risk assessments and safe systems of work were not in place.
            </p>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="border-elec-yellow/30 bg-white/10">
        ...
        <CardContent className="space-y-4">
          <p>
            While the Health and Safety at Work Act 1974 provides the foundation, specific
            regulations detail requirements for electrical safety. For electrical workers and
            apprentices, understanding how these work together is essential.
          </p>

          <div className="bg-white/10 rounded-md p-4 border border-elec-yellow/20">
            <h3 className="text-lg font-semibold text-elec-yellow mb-2">
              Regulations Relevant to Electrical Workers:
            </h3>
            <ul className="list-disc pl-5 space-y-2">
              <li>
                <span className="font-medium text-white">Electricity at Work Regulations 1989</span>{' '}
                - Specific duties relating to electrical systems and work activities
              </li>
              <li>
                <span className="font-medium text-white">
                  Provision and Use of Work Equipment Regulations 1998
                </span>{' '}
                - Requirements for electrical tools and test equipment
              </li>
              <li>
                <span className="font-medium text-white">
                  Personal Protective Equipment at Work Regulations 1992
                </span>{' '}
                - Requirements for PPE including insulating gloves, face shields, etc.
              </li>
              <li>
                <span className="font-medium text-white">
              ...
              <li>
                <span className="font-medium text-white">Work at Height Regulations 2005</span> -
                Safety when working at height on electrical installations
              </li>
              <li>
                <span className="font-medium text-white">
          ...
          <div className="bg-white/10 rounded-md p-4 border border-elec-yellow/20 mt-4">
            <h3 className="text-lg font-semibold text-elec-yellow mb-2">
              How the HSWA Applies to Daily Electrical Work:
            </h3>
            <ul className="list-disc pl-5 space-y-2">
              <li>
                <span className="font-medium text-white">Risk Assessments</span> - Legally required
                before starting electrical work
              </li>
              <li>
                <span className="font-medium text-white">Method Statements</span> - Document safe
                systems of work for electrical tasks
              </li>
              <li>
                <span className="font-medium text-white">Competence</span> - Only competent persons
                should work on electrical installations
              </li>
              <li>
                <span className="font-medium text-white">Safe Isolation</span> - Following proper
                procedures to isolate electrical supplies
              </li>
              <li>
                <span className="font-medium text-white">Test Equipment</span> - Using appropriate,
                calibrated tools and instruments
              </li>
              <li>
                <span className="font-medium text-white">Personal Protective Equipment</span> -
                Using appropriate PPE for electrical tasks
              </li>
              <li>
                <span className="font-medium text-white">Information and Training</span> - Proper
                instruction on electrical hazards and controls
              </li>
              <li>
                <span className="font-medium text-white">Emergency Procedures</span> - Knowing what
                to do in case of electrical incidents
              </li>
            </ul>
          </div>
        </CardContent>
      ...
      <Card className="border-elec-yellow/30 bg-white/10">
        ...
        <CardContent className="space-y-4">
          <div className="bg-white/10 rounded-md p-4 border border-elec-yellow/20">
            <h3 className="text-lg font-semibold text-elec-yellow mb-2">
              Case Study 1: Fatal Electric Shock
            </h3>
            <p className="mb-2">
              An electrician was electrocuted while working on a distribution board that was not
              properly isolated. The company was fined £300,000 under Section 2 of HSWA for failing
          ...
          <div className="bg-white/10 rounded-md p-4 border border-elec-yellow/20 mt-4">
            <h3 className="text-lg font-semibold text-elec-yellow mb-2">
              Case Study 2: Apprentice Injury
            </h3>
            <p className="mb-2">
              An apprentice electrician suffered serious burns when instructed to work on equipment
              that was still energised. The employer was prosecuted for inadequate supervision and
              training, resulting in a £75,000 fine and a custodial sentence for the supervisor.
            </p>
            <p className="text-elec-yellow font-semibold mt-4">Key Lessons:</p>
            <ul className="list-disc pl-5 space-y-1">
      ...
      <div className="bg-elec-yellow/10 p-6 rounded-md border border-elec-yellow/30 flex items-start gap-3">
        ...
        <div>
          ...
          <p className="mb-3">For your EAL Level 2 Diploma assessments, you should be able to:</p>
          <ul className="list-disc pl-5 space-y-1">
