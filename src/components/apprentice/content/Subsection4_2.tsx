    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        <div className="bg-elec-dark/50 border border-elec-yellow/30 rounded-lg p-6">
          ...
          <p className="text-elec-light/80">
            We're working on comprehensive materials covering scaffolding and platforms for electrical work,
            including types, safety requirements, and best practices for working at height.
          </p>
        </div>
      </div>
