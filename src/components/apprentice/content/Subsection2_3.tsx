    ...
    <div className="space-y-6">
      ...
      <div className="space-y-5">
        ...
        <div className="bg-elec-dark/30 border border-elec-yellow/20 rounded-lg p-4 md:p-6">
          <h3 className="text-xl font-bold text-elec-yellow mb-4">Safety Meeting Structure</h3>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              <h4 className="font-medium">Meeting Components:</h4>
            ...
            <div className="space-y-2">
              <h4 className="font-medium">Inclusive Communication:</h4>
              <ul className="list-disc pl-5 space-y-1 text-sm">
