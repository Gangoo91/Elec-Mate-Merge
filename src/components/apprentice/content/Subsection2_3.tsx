          ...
          <div className="bg-elec-dark/50 border border-elec-yellow/30 rounded-lg">
            ...
            <AccordionContent className="px-4 pb-4 pt-2">
              <div className="space-y-4">
                ...
                <ul className="list-disc pl-5 space-y-2 mx-auto max-w-lg">
                  <li>
            ...
            <AccordionContent className="px-4 pb-4 pt-2">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <h4 className="font-medium text-center md:text-left">Meeting Components:</h4>
                  <ul className="list-disc pl-5 space-y-1 text-sm mx-auto max-w-md">
                ...
                <div className="space-y-2">
                  <h4 className="font-medium text-center md:text-left">Inclusive Communication:</h4>
                  <ul className="list-disc pl-5 space-y-1 text-sm mx-auto max-w-md">
              ...
              <div className="mt-4 p-4 bg-elec-dark/70 rounded-lg text-sm mx-auto max-w-lg">
