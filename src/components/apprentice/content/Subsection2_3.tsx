    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        <div className="bg-elec-dark/50 border border-elec-yellow/30 rounded-lg p-6">
          ...
          <p className="text-elec-light/80">
            We're working on comprehensive materials covering safety communication systems,
            including communication structures, methods, meeting formats, and documentation systems.
          </p>
        </div>
      </div>
