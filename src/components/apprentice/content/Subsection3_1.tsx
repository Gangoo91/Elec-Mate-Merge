...
const Subsection3_1 = ({ subsectionId, isCompleted, markAsComplete }: SubsectionProps) => {
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="bg-elec-dark/50 border border-elec-yellow/30">
        <CardHeader 
          className="cursor-pointer flex flex-row items-center justify-between"
          onClick={() => toggleSection("overview")}
        >
          <CardTitle className="text-xl text-elec-yellow">Overview</CardTitle>
          <ChevronDown 
            className={`h-5 w-5 text-elec-yellow transition-transform ${
      ...
      <Card className="bg-elec-dark/50 border border-elec-yellow/30">
        ...
        >
          ...
          <ChevronDown 
            className={`h-5 w-5 text-elec-yellow transition-transform ${
              expandedSection === "hazards" ? "transform rotate-180" : ""
            }`}
          />
        </CardHeader>
      ...
      <Card className="bg-elec-dark/50 border border-elec-yellow/30">
        ...
        >
          ...
          <ChevronDown 
            className={`h-5 w-5 text-elec-yellow transition-transform ${
              expandedSection === "isolation" ? "transform rotate-180" : ""
            }`}
          />
        </CardHeader>
        {expandedSection === "isolation" && (
          <CardContent className="pt-0 space-y-4">
      ...
      <Card className="bg-elec-dark/50 border border-elec-yellow/30">
        ...
        >
          ...
          <ChevronDown 
            className={`h-5 w-5 text-elec-yellow transition-transform ${
              expandedSection === "legislation" ? "transform rotate-180" : ""
            }`}
          />
        </CardHeader>
