  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white/10 border border-elec-yellow/20 rounded-lg p-6 mb-6">
        <h2 className="text-xl font-semibold mb-4 text-elec-yellow">
          Emergency Response Framework
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          <div className="bg-white/5 p-4 rounded-lg border border-elec-yellow/10">
            <div className="flex items-center gap-2 mb-2">
              <AlertCircle className="h-5 w-5 text-elec-yellow" />
              <h3 className="font-medium">Preparation</h3>
            </div>
            <p className="text-sm text-white">
              Training, drills, clear procedures, and properly maintained emergency equipment that
              is regularly checked and accessible.
            </p>
          </div>
          ...
          <div className="bg-white/5 p-4 rounded-lg border border-elec-yellow/10">
            ...
            <p className="text-sm text-white">
              Rapid assessment, clear communication, following established protocols and delegating
          ...
          <div className="bg-white/5 p-4 rounded-lg border border-elec-yellow/10">
            ...
            <p className="text-sm text-white">
              Thorough documentation, proper reporting, investigation to prevent recurrence and
      ...
      <div className="bg-white/10 border border-elec-yellow/20 rounded-lg p-6 mb-6">
        ...
        <div className="space-y-4">
          <p className="text-white">
            Electric shock injuries require immediate and careful response. Following the proper
            sequence of actions can save lives and prevent secondary injuries.
          </p>

          <ol className="space-y-4 mt-4">
            <li className="bg-white/5 p-4 rounded-lg border-l-4 border-elec-yellow">
              <h3 className="font-medium mb-1">1. Ensure your own safety first</h3>
              <p className="text-sm text-white">
                Never touch a casualty while they are still in contact with an electrical source.
            ...
            <li className="bg-white/5 p-4 rounded-lg border-l-4 border-elec-yellow">
              ...
              <p className="text-sm text-white">
                Switch off the power at the mains or isolator if possible. If not accessible, use a
                non-conductive material (wooden broom handle, rubber mat) to separate the casualty
                from the source.
              </p>
            </li>
            ...
            <li className="bg-white/5 p-4 rounded-lg border-l-4 border-elec-yellow">
              ...
              <p className="text-sm text-white">
                Clearly state that there has been an electrical accident. Provide accurate location
                details and the condition of the casualty.
              </p>
            </li>
            ...
            <li className="bg-white/5 p-4 rounded-lg border-l-4 border-elec-yellow">
              ...
              <p className="text-sm text-white">
                Once safe to do so, check Airway, Breathing, and Circulation. Begin CPR if necessary
            ...
            <li className="bg-white/5 p-4 rounded-lg border-l-4 border-elec-yellow">
              ...
              <p className="text-sm text-white">
                Record all details about what happened, the response taken, and any observed
                injuries. This information is vital for medical treatment and incident
                investigation.
              </p>
            </li>
          </ol>
          ...
          <div className="bg-red-900/20 border border-red-500/30 rounded-lg p-4 mt-4">
            <div className="flex items-start gap-2">
              ...
              <div>
                ...
                <p className="text-sm text-white">
                  All electric shock victims require medical evaluation, even if they appear
                  unharmed. Electrical injuries can cause internal damage that may not be
      ...
      <div className="bg-white/10 border border-elec-yellow/20 rounded-lg p-6 mb-6">
        <div className="flex items-start gap-3 mb-4">
          ...
          <h2 className="text-xl font-semibold text-elec-yellow">
            Fire Procedures for Electrical Incidents
          </h2>
        </div>
        ...
        <div className="space-y-4">
          <p className="text-white">
            ...
            Understanding the correct actions to take can prevent fire spread and additional risks.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-2">
                  ...
                  <span className="text-sm text-white">
                    Raise the alarm immediately by activating the nearest fire alarm point
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="bg-elec-yellow/20 text-elec-yellow font-bold rounded-full h-5 w-5 flex items-center justify-center flex-shrink-0 mt-0.5">
                ...
                <li className="flex items-start gap-2">
                  ...
                  <span className="text-sm text-white">
                    If safe, isolate power to affected equipment or area using emergency stop
                    buttons or main switches
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="bg-elec-yellow/20 text-elec-yellow font-bold rounded-full h-5 w-5 flex items-center justify-center flex-shrink-0 mt-0.5">
                  ...
                  <span className="text-sm text-white">
                    Use appropriate fire extinguishers (CO₂ or dry powder) for electrical
                    fires—NEVER use water
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="bg-elec-yellow/20 text-elec-yellow font-bold rounded-full h-5 w-5 flex items-center justify-center flex-shrink-0 mt-0.5">
                  ...
                  <span className="text-sm text-white">
                    Evacuate the building using designated escape routes
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div>
              <h3 className="text-lg font-medium mb-3 text-elec-yellow/80">
              ...
              <div className="space-y-3">
                <div className="bg-white/5 p-3 rounded-lg">
                  ...
                  <p className="text-xs text-white">
                    Identified by black labels. Safe for electrical fires as they don't conduct
                    electricity. Displaces oxygen to extinguish flames without leaving residue.
                  </p>
                </div>
                ...
                <div className="bg-white/5 p-3 rounded-lg">
                  ...
                  <p className="text-xs text-white">
                    Identified by blue labels. Safe for electrical fires but leaves residue that can
                    damage equipment. Use when CO₂ is not available.
                  </p>
                </div>
      ...
      <div className="bg-white/10 border border-elec-yellow/20 rounded-lg p-6">
        <h2 className="text-xl font-semibold mb-4 text-elec-yellow">
          First Aid Requirements for Electrical Workplaces
        </h2>

        <div className="space-y-6">
          <p className="text-white">
            The Health and Safety (First-Aid) Regulations 1981 require employers to provide adequate
            first-aid equipment, facilities, and trained personnel. For electrical work
            environments, specific considerations apply.
          </p>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
              <h3 className="text-lg font-medium text-elec-yellow/80">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-white/5 p-4 rounded-lg">
                ...
                <ul className="space-y-1 text-sm text-white">
                  <li>
                    • At least one appointed first aider for low-risk workplaces with fewer than 50
                    workers
                  </li>
                  <li>
                    • At least one first-aid trained person for every 50 employees in higher-risk
                    environments
                  </li>
          ...
          <div className="bg-white/5 p-4 rounded-lg border-l-4 border-elec-yellow mt-4">
            ...
            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-2 text-sm text-white">
