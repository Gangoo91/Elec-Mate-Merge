            ...
            <div>
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-2">
                  ...
                  <span className="text-sm text-white">Raise the alarm immediately by activating the nearest fire alarm point</span>
                </li>
                <li className="flex items-start gap-2">
                ...
                <li className="flex items-start gap-2">
                  ...
                  <span className="text-sm text-white">If safe, isolate power to affected equipment or area using emergency stop buttons or main switches</span>
                </li>
                <li className="flex items-start gap-2">
                  ...
                  <span className="text-sm text-white">Use appropriate fire extinguishers (CO₂ or dry powder) for electrical fires—NEVER use water</span>
                </li>
                <li className="flex items-start gap-2">
                  ...
                  <span className="text-sm text-white">Evacuate the building using designated escape routes</span>
                </li>
              </ul>
            </div>
