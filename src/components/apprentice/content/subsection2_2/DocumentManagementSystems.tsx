    ...
    <div className="bg-white/10 border border-elec-yellow/20 rounded-lg p-6 mb-6">
      ...
      <div className="space-y-4">
        <p className="text-white mb-4">
          Maintaining an organized documentation system is crucial for ensuring documents are
          accessible when needed and can be readily provided during inspections or audits.
        </p>

        <h3 className="font-semibold text-white mt-6 mb-2">Document Control</h3>
        <p className="text-white mb-6">
          A robust document control system ensures that all personnel have access to the correct,
          up-to-date versions of essential documents. Key elements include version numbering, clear
          revision histories, approval signatures, and distribution lists. Documents should be
          reviewed at regular intervals, typically every 12 months or whenever processes change
          significantly.
        </p>

        <h3 className="font-semibold text-white mt-6 mb-2">Storage Systems</h3>
        <p className="text-white mb-6">
          Modern electrical contractors typically employ a combination of physical and digital
          storage. Digital systems offer advantages of accessibility, searchability, and backup
          capabilities, while physical copies may be required on-site. Cloud-based systems with
          appropriate security measures are increasingly becoming the industry standard, allowing
          real-time access from multiple locations while maintaining document integrity.
        </p>

        <h3 className="font-semibold text-white mt-6 mb-2">Retention Periods</h3>
        <p className="text-white mb-6">
          Different documentation types require different retention periods according to
          regulations:
        </p>
        ...
        <p className="text-white mb-6">
          Safety documentation must be accessible to those who need it, when they need it. This
          includes:
        </p>
        <ul className="list-disc pl-6 space-y-2 text-white mb-6">
          ...
          <li>
            Security measures to protect sensitive information while maintaining accessibility
          </li>
