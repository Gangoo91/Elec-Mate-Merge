    ...
    <div className="bg-white/10 border border-elec-yellow/20 rounded-lg p-6">
      ...
      <div className="space-y-4">
        <p className="text-white mb-4">
          Following these best practices ensures that your documentation system is effective and
          compliant:
        </p>
        ...
        <p className="text-white mb-6">
          Transitioning to digital documentation offers numerous advantages for electrical
          contractors:
        </p>
        <ul className="list-disc pl-6 space-y-2 text-white mb-6">
        ...
        <p className="text-white mb-6">Avoid these common mistakes in safety documentation:</p>
        <ul className="list-disc pl-6 space-y-2 text-white mb-6">
