    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        <div className="bg-elec-dark/50 border border-elec-yellow/30 rounded-lg p-6">
          ...
          <p className="text-elec-light/80">
            We're working on comprehensive materials covering RIDDOR and incident reporting procedures,
            including legal requirements, reporting timelines, and practical guidance for electrical workers.
          </p>
        </div>
      </div>
