      ...
      <div className="space-y-4">
        ...
        <div className="mt-6 grid grid-cols-1 lg:grid-cols-2 gap-4">
          <div>
            ...
            <ul className="list-disc pl-5 space-y-2">
              ...
              <li>
                ...
                <p className="text-sm mt-1">
                  Self-supporting; ideal for lighting installations and low-level distribution board
                  work. Must be fully opened with spreaders locked.
                </p>
              </li>
              <li>
          ...
          <div>
            ...
            <p className="mb-3">
              Ladders for professional electrical work must conform to EN 131 Professional standard
              or BS 2037 Class 1. These classifications ensure appropriate duty ratings for
              industrial use.
            </p>
            <div className="bg-white/10 p-3 rounded-lg border border-elec-yellow/20">
              ...
              <ul className="space-y-1 text-sm">
                ...
                <li>
                  <span className="font-medium">EN131 Non-Professional:</span> Maximum load - 120kg
                </li>
                <li>
