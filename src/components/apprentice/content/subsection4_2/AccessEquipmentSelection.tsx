    ...
    <Card className="border border-elec-yellow/30 bg-elec-card rounded-xl overflow-hidden">
      ...
      <CardContent className="space-y-4">
        <p className="text-sm md:text-base">
          Selecting the appropriate access equipment for electrical work is crucial for both safety
          and efficiency. The choice depends on the task duration, height, location, and specific
        ...
        <div className="bg-white/10 border-l-4 border-red-500 p-4 rounded-r">
          ...
          <p className="text-sm">
            When working near electrical installations, standard height access equipment may present
            additional hazards. Never use metal ladders or conductive access equipment near live
            electrical systems. Fiberglass ladders and insulated platforms should be used when
            electrical shock risks are present.
          </p>
        </div>
          ...
          <Card className="bg-white/10 border border-elec-yellow/20 rounded-xl overflow-hidden">
            ...
            <CardContent>
              <p className="text-sm mb-2">
                Best for tasks under 30 minutes where minimal movement is required
              </p>
            ...
            <ol className="list-decimal pl-5 space-y-3">
              <li>
                ...
                <p className="text-sm mt-1">
                  Evaluate electrical hazards, working height, task duration, access constraints,
              ...
              <li>
                ...
                <p className="text-sm mt-1">
                  For work near live systems, non-conductive equipment is essential. Metal
                  scaffolding and MEWPs require additional precautions near overhead lines.
                </p>
              </li>
              <li>
                <span className="font-medium">Evaluate Working Space</span>
                <p className="text-sm mt-1">
                  Consider space constraints, floor loading capacity, and surface conditions. Some
                  equipment requires level, stable ground while other types can accommodate uneven
                  surfaces.
                </p>
              </li>
              <li>
                ...
                <p className="text-sm mt-1">
                  Ensure workers are trained and competent to use the selected equipment.
                  Specialised access equipment like MEWPs requires specific certification.
                </p>
              </li>
              <li>
                <span className="font-medium">Emergency Planning</span>
                <p className="text-sm mt-1">
                  Consider how a worker would be rescued in the event of an emergency, particularly
                  for isolated electrical work at height. Rescue plans must be documented.
                </p>
              </li>
            </ol>
          </CardContent>
        ...
        <Card className="bg-white/10 border border-elec-yellow/20 mt-4">
          <CardHeader className="pb-2">
            <CardTitle className="text-lg font-semibold text-elec-yellow">
              Fall Protection Systems for Electrical Work
            </CardTitle>
          </CardHeader>
          <CardContent>
