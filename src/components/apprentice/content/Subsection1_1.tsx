    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        <div className="bg-elec-dark/50 border border-elec-yellow/30 rounded-lg p-6">
          ...
          <p className="text-elec-light/80">
            We're working on comprehensive materials covering the Electricity at Work Regulations 1989,
            including key requirements, responsibilities, and practical implications for electrical workers.
          </p>
        </div>
      </div>
