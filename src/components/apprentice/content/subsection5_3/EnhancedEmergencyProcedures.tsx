...
const EnhancedEmergencyProcedures = () => {
  ...
  const filteredProcedures = emergencyProcedures.filter(
    (procedure) =>
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-white">
                  ...
                  <span className="font-bold text-red-500 text-lg">999</span> immediately
                </p>
              </div>
            </div>
            <div className="flex gap-2">
              ...
              >
                ...
                <a href="tel:999" className="text-current no-underline">
                  Call 999
                </a>
              </Button>
            </div>
