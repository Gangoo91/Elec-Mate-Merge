  ...
  return (
    <div className="space-y-8 animate-fade-in pb-8">
      ...
      <Card className="bg-white/5 border border-elec-yellow/20">
        ...
        <CardContent className="pt-6">
          <p className="text-base mb-6">
            Before attempting any manual handling task, electricians should apply the TILE
            principles to assess and minimise risks.
          </p>
          ...
          <div className="mt-6 p-4 border-t border-elec-yellow/20 bg-gradient-to-b from-elec-dark/70 to-elec-dark">
            ...
            <p className="text-sm">
              Following the hierarchy of control, first try to <strong>avoid</strong> hazardous
              manual handling operations altogether. If unavoidable, <strong>assess</strong> the
              risk and <strong>reduce</strong> it as far as reasonably practicable using mechanical
              aids or team lifting as appropriate.
            </p>
          </div>
        </CardContent>
      </Card>
      ...
      <div className="rounded-lg border border-elec-yellow/20 p-4 md:p-6 bg-gradient-to-b from-elec-dark/50 to-elec-dark">
        ...
        <div className="mt-8 p-4 bg-white/10 border border-elec-yellow/20 rounded-lg">
          ...
          <p className="mb-4 text-sm">
            These guideline weights should be reduced if handling conditions are less than ideal.
            Consider the individual's capability when applying these limits.
          </p>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
            <WeightGuidelineCard
              position="Shoulder height (head to shoulders)"
              menKg={10}
              womenKg={7}
            />
            <WeightGuidelineCard
              position="Elbow height (shoulders to waist)"
              menKg={20}
              womenKg={13}
            />
            <WeightGuidelineCard
              position="Knuckle height (waist to knuckle)"
              menKg={25}
              womenKg={16}
            />
            <WeightGuidelineCard
              position="Mid lower leg (knuckle to floor)"
              menKg={20}
              womenKg={13}
            />
          </div>
      ...
      <Card className="border-elec-yellow/20 bg-white/5">
        <div className="p-4 md:p-6">
          <h3 className="text-xl font-bold text-elec-yellow mb-4">
            Electrical-Specific Handling Considerations
          </h3>
                ...
                {[
                  {
                    title: 'Cable Drums',
                    content:
                      'Use cable drum jacks or spindles rather than manually lifting. Roll drums rather than carry where possible. Large drums should always be handled by mechanical means such as forklifts or specialised cable handling equipment.',
                  },
                  {
                    title: 'Distribution Boards',
                    content:
                      'Metal enclosures can be heavy and have sharp edges. Use team lifting for boards over 20kg. Ensure clear communication between team members before lifting. Consider using shoulder straps or carrying handles where provided.',
                  },
                  {
                    title: 'Conduit and Trunking',
                    content:
                      'Long lengths can be unwieldy and cause balance issues. Carry with a partner for lengths over 3 metres. Be aware of overhead obstacles when carrying. Use pipe carriers or shoulder pads for metallic conduit to prevent injury.',
                  },
                ].map((item, index) => (
                  <li
                    key={index}
                    className="bg-white/10 p-3 rounded-lg border border-elec-yellow/10"
                  >
                ...
                {[
                  {
                    title: 'Batteries',
                    content:
                      'Lead-acid batteries contain corrosive substances. Use battery carriers with insulated handles. Never lift by terminals or connectors. Be aware of weight - even small batteries can exceed 20kg. Wear acid-resistant gloves and eye protection.',
                  },
                  {
                    title: 'Transformers',
                    content:
                      'Often extremely heavy with uneven weight distribution. Always use mechanical handling for units over 25kg. Check for oil leaks before handling. Never attempt to manually handle pole-mounted or substation transformers without proper equipment and training.',
                  },
                  {
                    title: 'Switchgear',
                    content:
                      'Plan installation carefully to avoid manual handling where possible. Use skates or rollers for final positioning. Consider access routes during planning stages. Components may need to be installed separately and assembled in-situ to reduce handling risks.',
                  },
                ].map((item, index) => (
                  <li
                    key={index}
          ...
          <div className="mt-6 p-4 bg-white/10 border border-elec-yellow/20 rounded-lg">
            ...
            <p className="text-sm mb-3">
              When items are too heavy for one person, team lifting may be appropriate if mechanical
              aids aren't available:
            </p>
            <ul className="grid grid-cols-1 md:grid-cols-2 gap-x-4 gap-y-2 text-sm">
              ...
              <li className="flex items-start gap-2">
                <ArrowRight className="h-4 w-4 text-elec-yellow shrink-0 mt-1" />
                <span>
                  Each person should not handle more than 75% of their individual capacity
                </span>
              </li>
              <li className="flex items-start gap-2">
                <ArrowRight className="h-4 w-4 text-elec-yellow shrink-0 mt-1" />
      ...
      <div className="bg-white/10 border border-elec-yellow/20 rounded-lg p-4 md:p-6">
        ...
        <div className="space-y-4">
          <p className="mb-4">
            Using appropriate mechanical aids can significantly reduce the risk of manual handling
            injuries:
          </p>
          ...
          <div className="mt-4 p-4 bg-white/10 rounded-lg text-sm">
            ...
            <p>
              When selecting mechanical aids, consider the specific requirements of the task, the
              working environment, and the capabilities of the users. Always inspect aids before use
              for any damage or defects. Ensure equipment is suitable for the load characteristics
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="space-y-4">
            <h4 className="font-semibold text-elec-yellow text-lg flex items-center gap-2">
              <span className="inline-block w-6 h-6 bg-elec-yellow text-elec-dark rounded-full text-center font-bold text-sm leading-6">
                1
              </span>
              Training Requirements
            </h4>
            <p className="text-sm mb-3">
              Employers must ensure workers receive appropriate training on manual handling. This
              should include:
            </p>
            ...
            <div className="mt-4 p-4 bg-white/10 rounded-lg border border-elec-yellow/10">
              ...
              <p className="text-sm">
                Manual handling training should be refreshed regularly, typically every 1-3 years or
                when:
              </p>
              ...
              <div className="bg-white/10 p-4 rounded-lg border border-elec-yellow/20">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className="bg-white/10 p-3 rounded-lg border border-elec-yellow/10">
                    ...
                    <p className="text-sm mb-2">Report early signs of:</p>
