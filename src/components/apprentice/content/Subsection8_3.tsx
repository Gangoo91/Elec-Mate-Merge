    ...
    <div className="space-y-6">
      <div className="space-y-2">
        ...
        <p className="text-white">
          Understanding the key standards and compliance requirements for electrical installations
          in the UK.
        </p>
      </div>
      ...
      <Card className="border-elec-yellow/20 bg-white/5">
        <CardContent className="pt-6">
          ...
          <div className="space-y-4">
            <p>
              BS 7671, also known as the IET Wiring Regulations, forms the national standard to
              which all UK domestic and industrial wiring must conform. Currently in its 18th
              Edition, these regulations are essential knowledge for all electrical professionals.
            </p>
            ...
            <p>
              The regulations are not statutory, but compliance with them is often required to
              satisfy Health and Safety legislation such as the Electricity at Work Regulations
              1989.
            </p>
          </div>
        </CardContent>
      ...
      <Card className="border-elec-yellow/20 bg-white/5">
        <CardContent className="pt-6">
          ...
          <div className="space-y-4">
            <p>
              In England and Wales, Part P of the Building Regulations specifically relates to
              electrical safety in dwellings. It places legal requirements on those carrying out
            ...
            <div className="bg-white/10 border border-blue-400/30 rounded-md p-4">
              ...
              <ul className="list-disc pl-5 space-y-1">
                <li>
                  All work must be designed and installed to protect people from fire and electric
                  shocks
                </li>
            ...
            <div className="flex items-center gap-3 mt-3 bg-orange-500/10 p-3 rounded-md border border-orange-500/20">
              ...
              <p className="text-sm">
                Failure to comply with Building Regulations is a criminal offence and can result in
                prosecution with fines of up to £5,000, plus £50 for each day the violation
                continues.
              </p>
            </div>
          </div>
      ...
      <Card className="border-elec-yellow/20 bg-white/5">
        <CardContent className="pt-6">
          ...
          <div className="space-y-4">
            <p>
              Proper documentation is a crucial part of electrical installation work in the UK. As
              an apprentice, understanding these requirements is essential for your future practice.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-white/10 border border-elec-yellow/30 rounded-md p-4 space-y-2">
                ...
                <p className="text-sm">
                  Required for new installations, additions and alterations to existing
                  installations. Must be issued by the person responsible for the design,
              ...
              <div className="bg-white/10 border border-elec-yellow/30 rounded-md p-4 space-y-2">
                ...
                <p className="text-sm">
                  Used for additions or alterations that don't require an EIC, such as adding a new
                  circuit to an existing installation.
                </p>
              </div>
              ...
              <div className="bg-white/10 border border-elec-yellow/30 rounded-md p-4 space-y-2">
                ...
                <p className="text-sm">
                  Detailed record of all testing carried out, with measured values and pass/fail
                  indications. Must be included with certification.
                </p>
              </div>
            </div>
          </div>
