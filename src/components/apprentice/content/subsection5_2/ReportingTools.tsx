  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-sm md:text-base mb-4">
        Modern workplaces employ various tools and systems to streamline the hazard reporting
        process, ensure proper tracking, and facilitate effective resolution.
      </p>
      ...
      <div className="bg-white/10 border border-elec-yellow/20 rounded-lg p-4 md:p-5">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
          ...
          <div>
            ...
            <div className="bg-white/5 rounded-md p-3 mb-3">
              ...
              <p className="text-sm mt-1">
                Traditional forms, near-miss cards, and safety observation booklets for manual
            ...
            <div className="bg-white/5 rounded-md p-3 mb-3">
              ...
              <p className="text-sm mt-1">
                Health & safety software platforms, mobile reporting apps, and QR code scanning for
            ...
            <div className="bg-white/5 rounded-md p-3">
              ...
              <p className="text-sm mt-1">
                Toolbox talks, safety committee reviews, and anonymous reporting channels to ensure
          ...
          <div>
            ...
            <div className="bg-white/5 rounded-md p-3 mb-3">
              ...
              <p className="text-sm mt-1">
                Provide exact location and detailed description. "Exposed wiring near workstation 3"
                is better than "Dangerous wiring."
              </p>
            </div>
            ...
            <div className="bg-white/5 rounded-md p-3 mb-3">
              ...
              <p className="text-sm mt-1">
                Whenever possible, attach photographs or videos of the hazard to provide visual
                context for assessment.
              </p>
            </div>

            <div className="bg-white/5 rounded-md p-3">
              <h5 className="font-medium text-elec-yellow text-sm">
                Suggest Solutions & Follow Up
              </h5>
              <p className="text-sm mt-1">
                Include ideas for hazard control and follow up if no action is taken within a
          ...
          <div>
            ...
            <div className="bg-white/5 rounded-md p-3 mb-3">
              ...
              <p className="text-sm mt-1">
                Workers may hesitate if they fear being blamed. Management should promote a no-blame
                culture focused on fixing problems.
              </p>
            </div>
            ...
            <div className="bg-white/5 rounded-md p-3 mb-3">
              ...
              <p className="text-sm mt-1">
                If previous reports haven't led to visible action, workers may become discouraged.
                Ensure all reports receive feedback.
              </p>
            </div>
            ...
            <div className="bg-white/5 rounded-md p-3">
              ...
              <p className="text-sm mt-1">
                Use simple reporting processes and provide regular hazard identification training to
        ...
        <div className="mt-5 bg-white/5 rounded-lg p-4">
          <h4 className="font-medium text-elec-yellow mb-3">
            Case Study: Effective Hazard Reporting
          </h4>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-sm">
                  At a commercial electrical installation site, an apprentice noticed several
                  temporary power cables creating a trip hazard across a walkway. The situation was
                  complicated because the cables needed to power essential equipment.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-3">
              ...
              <div>
                ...
                <ol className="list-decimal list-inside text-sm space-y-1">
                  ...
                  <li>
                    Supervisor acknowledged the report and implemented a temporary solution within
                    hours
                  </li>
          ...
          <p className="text-sm italic mt-3">
            This example demonstrates how proper hazard reporting can lead to both immediate action
            and longer-term improvements to workplace safety.
          </p>
        </div>
      </div>
    </div>
