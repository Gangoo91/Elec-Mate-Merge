    ...
    <div className="border border-elec-yellow/30 rounded-lg p-4 md:p-6 space-y-4">
        ...
        <Card className="bg-elec-dark/50 border border-elec-yellow/20">
          ...
          <CardContent>
            <ul className="space-y-3">
              <li className="p-3 rounded bg-elec-dark border border-elec-yellow/10">
      ...
      <div className="bg-elec-dark/70 border border-elec-yellow/15 rounded-lg p-4 mt-6">
        ...
        <p className="text-sm">
          ...
          identify, and employers must have systems in place to record and address these reports. Failure to comply with 
          these regulations can result in prosecution, fines, or even imprisonment in severe cases.
        </p>
      </div>
    </div>
  );
