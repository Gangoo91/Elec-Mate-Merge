  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-sm md:text-base mb-4">
        Proper documentation of hazards is crucial for maintaining safety records, ensuring
        appropriate action is taken, and meeting legal obligations.
      </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <div className="bg-white/5 rounded-md p-3 h-full">
                  <ul className="space-y-2 text-sm">
                    <li>
                      <span className="font-medium text-elec-yellow">Retention Period:</span>{' '}
                      Minimum 3 years, 5 years recommended
                    </li>
                    <li>
                      <span className="font-medium text-elec-yellow">Accessibility:</span> Records
                      must be easily accessible to safety representatives and inspectors
                    </li>
                    <li>
                      <span className="font-medium text-elec-yellow">Storage Format:</span> Both
                      physical and electronic records acceptable with backup
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="bg-white/5 rounded-md p-3 h-full">
                  <ul className="space-y-2 text-sm">
                    <li>
                      <span className="font-medium text-elec-yellow">Regular Review:</span> All
                      reports reviewed in safety meetings
                    </li>
                    <li>
                      <span className="font-medium text-elec-yellow">Action Tracking:</span>{' '}
                      Document actions taken, dates, and responsible persons
                    </li>
                    <li>
                      <span className="font-medium text-elec-yellow">Effectiveness:</span>{' '}
                      Periodically assess effectiveness of control measures
                    </li>
                  </ul>
                </div>
              </div>
