        ...
        <div className="bg-white/5 border border-elec-yellow/20 rounded-lg p-5 hover:border-elec-yellow/40 transition-colors">
          ...
          <ul className="space-y-2.5">
            <li className="flex items-start gap-3">
              ...
              <p className="text-sm">
                Identify and apply safe working practices during electrical installation tasks
              </p>
            </li>
            <li className="flex items-start gap-3">
              <span className="bg-elec-yellow/10 text-elec-yellow px-2 py-1 rounded text-xs font-medium mt-0.5">
              ...
              <p className="text-sm">
                Conduct effective risk assessments for electrical work environments
              </p>
            </li>
            <li className="flex items-start gap-3">
              <span className="bg-elec-yellow/10 text-elec-yellow px-2 py-1 rounded text-xs font-medium mt-0.5">
              ...
              <p className="text-sm">
                Implement appropriate safe isolation procedures to prevent electrical accidents
              </p>
            </li>
            <li className="flex items-start gap-3">
              <span className="bg-elec-yellow/10 text-elec-yellow px-2 py-1 rounded text-xs font-medium mt-0.5">
              ...
              <p className="text-sm">
                Develop comprehensive work plans that prioritize safety and efficiency
              </p>
            </li>
          </ul>
        </div>
        ...
        <div className="bg-white/5 border border-elec-yellow/20 rounded-lg p-5 hover:border-elec-yellow/40 transition-colors">
          ...
          <ul className="space-y-3">
            <li className="flex items-start gap-3 group">
              ...
              <div>
                <p className="text-sm font-medium text-white group-hover:text-elec-yellow transition-colors">
