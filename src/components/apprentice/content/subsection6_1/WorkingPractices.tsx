    ...
    <Card className="bg-white/5 border border-elec-yellow/20">
      ...
      <CardContent className="pt-6">
        <p className="text-base mb-6">
          Safe working practices are essential for electricians to maintain safety for themselves,
          colleagues, and end-users. Following established procedures helps prevent accidents,
          injuries, and property damage throughout electrical work activities.
        </p>
        ...
        <div className="mt-5 p-4 border-t border-elec-yellow/20 bg-gradient-to-b from-elec-dark/70 to-elec-dark">
          ...
          <p className="text-sm">
            The Electricity at Work Regulations 1989 require that all reasonable steps must be taken
            to ensure that work activities do not give rise to danger. This includes following
            proper procedures, using appropriate equipment, and ensuring all workers are competent
            to carry out their assigned tasks safely.
          </p>
        </div>
      </CardContent>
    </Card>
