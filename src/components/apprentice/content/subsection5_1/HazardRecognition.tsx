  ...
  return (
    <div className="border border-elec-yellow/30 rounded-xl p-4 md:p-6 space-y-4">
      ...
      <p className="text-sm md:text-base mb-4">
        Developing the ability to recognise hazards requires both formal training and practical
        experience. Understanding how to assess the risk level of identified hazards is crucial for
        ...
        <Card className="bg-white/10 border border-elec-yellow/20 rounded-xl overflow-hidden">
          ...
          <CardContent>
            <p className="mb-4 text-sm">
              Risk is typically calculated by multiplying the likelihood of a hazard occurring by
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full border-collapse text-sm">
                ...
                <tbody>
                  <tr>
                    <td className="border border-elec-yellow/30 px-3 py-2 bg-red-900/20 font-medium">
                      High
                    </td>
                    <td className="border border-elec-yellow/30 px-3 py-2">
                      Work must not proceed until risk is reduced
                    </td>
                  </tr>
                  <tr>
                    <td className="border border-elec-yellow/30 px-3 py-2 bg-orange-800/20 font-medium">
                      Medium
                    </td>
                    <td className="border border-elec-yellow/30 px-3 py-2">
                      Implement risk reduction measures within a set timeframe
                    </td>
                  </tr>
                  <tr>
                    <td className="border border-elec-yellow/30 px-3 py-2 bg-green-900/20 font-medium">
                      Low
                    </td>
                    <td className="border border-elec-yellow/30 px-3 py-2">
                      Monitor and ensure existing controls are maintained
                    </td>
                  </tr>
                </tbody>
              </table>
        ...
        <Card className="bg-white/10 border border-elec-yellow/20 rounded-xl overflow-hidden">
          ...
          <CardContent>
            <p className="mb-3 text-sm">
              Being able to recognise early warning signs can help prevent accidents:
            </p>
      ...
      <Card className="bg-white/10 border border-elec-yellow/20 mt-6">
        ...
        <CardContent>
          <p className="mb-4 text-sm">
            When addressing identified hazards, follow the hierarchy of controls in this order:
          </p>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-3">
            <div className="p-3 rounded-lg bg-white/10 border border-elec-yellow/10">
              <div className="flex items-center gap-2 mb-1">
                <span className="bg-elec-yellow text-elec-dark rounded-full w-6 h-6 flex items-center justify-center font-bold">
                  1
                </span>
