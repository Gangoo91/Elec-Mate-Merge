  ...
  return (
    <div className="border border-elec-yellow/30 rounded-xl p-4 md:p-6 space-y-4">
      ...
      <p className="text-sm md:text-base mb-4">
        ...
        control exposure to hazardous substances to prevent ill health. These regulations are
        particularly important for electricians who frequently encounter various chemicals and
          ...
          <CardContent>
            <div className="space-y-3">
              <div className="p-3 rounded-lg bg-white/10 border border-elec-yellow/10">
                ...
                <p className="text-sm">
                  Used for cleaning electrical contacts and components, can cause skin irritation
              ...
              <div className="p-3 rounded-lg bg-white/10 border border-elec-yellow/10">
                ...
                <p className="text-sm">
                  Used to ease cable installation, may contain chemicals harmful if ingested or in
                  contact with eyes.
                </p>
              </div>
              ...
              <div className="p-3 rounded-lg bg-white/10 border border-elec-yellow/10">
                ...
                <p className="text-sm">
                  Can contain silica, plaster, and other harmful particles that can damage lungs
                  when inhaled.
                </p>
              </div>
              ...
              <div className="p-3 rounded-lg bg-white/10 border border-elec-yellow/10">
                ...
                <p className="text-sm">
                  Often contain volatile organic compounds (VOCs) that can cause headaches and
          ...
          <CardContent>
            <div className="space-y-3">
              <div className="p-3 rounded-lg bg-white/10 border border-elec-yellow/10">
                ...
                <p className="text-sm">
                  Employers must assess risks from hazardous substances before work begins.
                </p>
              </div>
              ...
              <div className="p-3 rounded-lg bg-white/10 border border-elec-yellow/10">
                ...
                <p className="text-sm">
                  Implementation of appropriate control measures to prevent or reduce exposure.
                </p>
              </div>
              ...
              <div className="p-3 rounded-lg bg-white/10 border border-elec-yellow/10">
                ...
                <p className="text-sm">
                  Manufacturers must provide these for all hazardous substances, containing vital
                  safety information.
                </p>
              </div>
              ...
              <div className="p-3 rounded-lg bg-white/10 border border-elec-yellow/10">
                ...
                <p className="text-sm">
                  Workers must be informed about the hazards, risks, and precautions required when
      ...
      <Card className="bg-white/10 border border-elec-yellow/20 mt-6">
        <CardHeader className="pb-2">
        ...
        <CardContent>
          <ol className="space-y-3">
            <li className="p-3 rounded-lg bg-white/10 border border-elec-yellow/10 flex items-center gap-3">
              <span className="bg-elec-yellow text-elec-dark rounded-full w-6 h-6 flex items-center justify-center font-bold flex-shrink-0">
                1
              </span>
              <div>
                <h4 className="font-medium">Elimination</h4>
                <p className="text-sm">
                  Completely remove the hazardous substance from the work process
                </p>
              </div>
            </li>
            ...
            <li className="p-3 rounded-lg bg-white/10 border border-elec-yellow/10 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm">
                  Use PPE as a last resort when other controls are insufficient
                </p>
              </div>
            </li>
          </ol>
