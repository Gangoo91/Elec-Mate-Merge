  ...
  return (
    <div className="border border-elec-yellow/30 rounded-xl p-4 md:p-6 space-y-4">
      ...
      <p className="text-sm md:text-base mb-4">
        While electrical hazards are a primary concern for electricians, there are numerous
        non-electrical hazards present in the workplace that require equal attention. Recognising
        and managing these hazards is essential for overall safety.
      </p>
          ...
          <CardContent>
            <div className="space-y-3">
              <div className="p-3 rounded-lg bg-white/10 border border-elec-yellow/10">
                ...
                <p className="text-sm">
                  Caused by uneven surfaces, trailing cables, poor housekeeping, and improper
              ...
              <div className="p-3 rounded-lg bg-white/10 border border-elec-yellow/10">
                ...
                <p className="text-sm">
                  Risks when using ladders, scaffolds or platforms without proper safety measures.
                </p>
              </div>
              ...
              <div className="p-3 rounded-lg bg-white/10 border border-elec-yellow/10">
                ...
                <p className="text-sm">
                  Limited access/egress points creating additional risks during emergency
                  situations.
                </p>
              </div>
              ...
              <div className="p-3 rounded-lg bg-white/10 border border-elec-yellow/10">
                ...
                <p className="text-sm">
                  Injuries from lifting heavy equipment, cable drums or awkward loads incorrectly.
                </p>
              </div>
            </div>
          </CardContent>
          ...
          <CardContent>
            <div className="space-y-3">
              <div className="p-3 rounded-lg bg-white/10 border border-elec-yellow/10">
                ...
                <p className="text-sm">
                  Extended exposure to high noise levels on construction sites or in industrial
                  settings.
                </p>
              </div>
              ...
              <div className="p-3 rounded-lg bg-white/10 border border-elec-yellow/10">
                ...
                <p className="text-sm">
                  Working in extreme heat or cold environments affecting concentration and
                  performance.
                </p>
              </div>
              ...
              <div className="p-3 rounded-lg bg-white/10 border border-elec-yellow/10">
                ...
                <p className="text-sm">
                  Respiratory hazards when drilling, cutting or working in dusty environments.
                </p>
              </div>
              ...
              <div className="p-3 rounded-lg bg-white/10 border border-elec-yellow/10">
                ...
                <p className="text-sm">
                  Risks from power tools, soldering, welding and using heat guns that can create
