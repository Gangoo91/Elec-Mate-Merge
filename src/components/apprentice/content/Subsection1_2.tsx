    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        <div className="bg-elec-dark/50 border border-elec-yellow/30 rounded-lg p-6">
          ...
          <p className="text-elec-light/80">
            We're working on comprehensive materials covering BS 7671 (IET Wiring Regulations),
            including key requirements, structure, and practical applications in electrical installations.
          </p>
        </div>
      </div>
