  ...
  return (
    <div className="mb-8">
      ...
      <p className="mb-4 text-elec-light/90">
        ...
        numerous injuries and fatalities in the UK.
      </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          ...
          <ol className="list-decimal pl-5 space-y-2">
            <li>
              <span className="font-medium">Identify</span> the circuit or equipment to be worked on
            </li>
            <li>
              <span className="font-medium">Isolate</span> and secure with appropriate lock-off
              devices
            </li>
            <li>
              <span className="font-medium">Prove</span> the voltage tester is working on known live
              source
            </li>
            <li>
              <span className="font-medium">Test</span> that the circuit or equipment is dead
            </li>
            <li>
