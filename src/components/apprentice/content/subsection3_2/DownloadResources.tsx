  ...
  const resources: Resource[] = [
    {
      ...
      description:
        'A detailed checklist for safe isolation of electrical circuits in accordance with HSE guidelines',
      fileType: 'PDF',
      fileSize: '1.2 MB',
    },
    {
    ...
    },
    {
      ...
      description:
        'Visual guide for selecting appropriate PPE based on the voltage level and work environment',
      fileType: 'PDF',
      fileSize: '3.1 MB',
    },
    {
      ...
      <Dialog>
        ...
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>Select a resource to download</DialogDescription>
          </DialogHeader>
