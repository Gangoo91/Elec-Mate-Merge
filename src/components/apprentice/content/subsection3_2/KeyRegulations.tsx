  ...
  return (
    <div className="mb-8">
      ...
      <p className="mb-4 text-elec-light/90">
        Electrical safety in the UK is governed by multiple regulations and standards. Compliance is
        legally required and failure to adhere can result in prosecution by the HSE, substantial
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          ...
          <p className="text-elec-light/80 mb-2">
            These regulations place duties on employers, employees and the self-employed to ensure
            electrical safety in the workplace.
          </p>
          <p className="text-elec-light/80">
            Regulation 14 specifically covers working on or near live conductors, requiring that no
            person shall work on or near any live conductor unless:
          </p>
        ...
        <div>
          ...
          <p className="text-elec-light/80 mb-2">
            The IET Wiring Regulations are the national standard for electrical installations in the
            UK. The 18th Edition provides specific technical standards for:
          </p>
