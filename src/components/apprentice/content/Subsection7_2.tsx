          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-white/5 p-3 rounded-lg">
              ...
              <div className="mt-2 p-2 bg-white/10 rounded text-xs">
                <strong>Step back 5×5 technique:</strong> Pause work every hour, step back 5 feet,
                spend 5 minutes reassessing the work area and conditions for new hazards.
              </div>
            </div>
            ...
            <div className="bg-white/5 p-3 rounded-lg">
              ...
              <ul className="list-disc pl-4 space-y-1 text-elec-light/80 text-sm">
                ...
                <li>
                  <span className="font-medium text-amber-400">Caution Indicators:</span> Changes in
                  environment, time pressure, fatigue
                </li>
                <li>
                  <span className="font-medium text-green-400">Proceed Conditions:</span> All
                  controls in place, verification complete
                </li>
              </ul>

              <div className="mt-2 p-2 bg-white/10 rounded text-xs">
                <strong>Remember:</strong> You have the authority and responsibility to stop work if
