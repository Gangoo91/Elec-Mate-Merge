    ...
    <div className="space-y-6">
      <div className="space-y-2">
        ...
        <p className="text-white">
          Understanding the essential documentation requirements for testing and commissioning
          electrical installations in the UK.
        </p>
      </div>
      ...
      <Card className="border-elec-yellow/20 bg-white/5">
        <CardContent className="pt-6">
          ...
          <div className="space-y-4">
            <p>
              Proper documentation is a critical aspect of electrical testing and commissioning in
              the UK. It provides evidence of compliance with regulations, serves as a record of
              safety testing, and forms part of the handover package to clients.
            </p>
            ...
            <div className="bg-white/10 border border-elec-yellow/30 rounded-md p-4">
              ...
              <ul className="list-disc pl-5 space-y-2">
                <li>
                  <strong>Certification Documents</strong>: Formal records confirming the
                  installation meets regulatory requirements
                </li>
                <li>
                  <strong>Test Results</strong>: Detailed records of all tests performed and their
                  outcomes
                </li>
                <li>
                  <strong>Design Documentation</strong>: Plans, specifications, and calculations
                  related to the installation
                </li>
                <li>
                  <strong>Operation & Maintenance Information</strong>: Instructions for safe
            ...
            <div className="flex items-center gap-3 mt-3 bg-blue-500/10 p-3 rounded-md border border-blue-500/20">
              ...
              <p className="text-sm">
                Under UK regulations, failing to provide proper electrical certification can result
                in legal consequences, invalidated insurance, and potential prosecution under the
      ...
      <Card className="border-elec-yellow/20 bg-white/5">
        <CardContent className="pt-6">
          ...
          <div className="space-y-4">
            <p>
              These are the formal documents that certify an electrical installation meets the
              requirements of BS 7671 (IET Wiring Regulations) and is safe for use.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
              <div className="bg-white/10 border border-elec-yellow/30 rounded-md p-4">
                ...
                <ul className="list-disc pl-5 space-y-2 text-sm">
                  <li>Required for all new electrical installations</li>
                  <li>
                    Must be issued by a competent person responsible for the design, construction,
                    inspection and testing
                  </li>
                  <li>
                    Includes details of the installation, departures from BS 7671, and particulars
                    of the installation
                  </li>
                  <li>Must be accompanied by schedule(s) of inspections and test results</li>
                </ul>
              </div>
              ...
              <div className="bg-white/10 border border-elec-yellow/30 rounded-md p-4">
                ...
                <ul className="list-disc pl-5 space-y-2 text-sm">
                  <li>
                    Used for alterations or additions to an existing installation that do not
                    include a new circuit
                  </li>
                  <li>Simpler format than the EIC, but still confirms safety and compliance</li>
                  <li>Contains limited test results specific to the work carried out</li>
              ...
              <div className="bg-white/10 border border-elec-yellow/30 rounded-md p-4">
                ...
                <ul className="list-disc pl-5 space-y-2 text-sm">
                  <li>
                    Periodic inspection report that evaluates the condition of an existing
                    installation
                  </li>
                  <li>
                    Identifies damage, deterioration, defects, and non-compliance with current
                    regulations
                  </li>
                  <li>
                    Classifies observed deficiencies as C1 (danger present), C2 (potentially
                    dangerous), or C3 (improvement recommended)
                  </li>
                  <li>
                    Now legally required for rental properties in England with periodic inspection
      ...
      <Card className="border-elec-yellow/20 bg-white/5">
        <CardContent className="pt-6">
          ...
          <div className="space-y-4">
            <p>
              Test results provide detailed evidence of the various electrical tests performed on an
              installation and confirm that the installation meets the safety parameters defined in
              BS 7671.
            </p>

            <div className="bg-white/10 border border-elec-yellow/30 rounded-md p-4">
              <h4 className="text-lg font-medium text-elec-yellow mb-2">
                Schedule of Test Results should include:
              </h4>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
              <div className="bg-white/10 p-4 rounded-md">
                <h5 className="font-medium mb-2 text-elec-yellow">
      ...
      <Card className="border-elec-yellow/20 bg-white/5">
        <CardContent className="pt-6">
          ...
          <div className="space-y-4">
            <p>
              The handover documentation package provides essential information to the client or end
              user for the safe operation, maintenance, and future modification of the electrical
              installation.
            </p>
            ...
            <div className="flex items-center gap-3 mt-4 bg-orange-500/10 p-3 rounded-md border border-orange-500/20">
              ...
              <p className="text-sm">
                Health and Safety File: For projects falling under the Construction (Design and
                Management) Regulations 2015, the electrical documentation forms part of the Health
                and Safety File that must be provided to the client.
              </p>
            </div>
          </div>
        </CardContent>
