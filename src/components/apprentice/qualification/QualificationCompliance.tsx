      ...
      <div className="rounded-xl border border-white/[0.06] bg-white/[0.02] p-4 sm:p-5 space-y-4">
        ...
        <div className="grid grid-cols-3 gap-3">
          <div className="rounded-lg border border-white/[0.06] bg-white/[0.02] p-3">
            ...
            <p className="text-[10px] uppercase tracking-[0.18em] text-white mt-1">Completed</p>
          </div>
          <div className="rounded-lg border border-white/[0.06] bg-white/[0.02] p-3">
            <div className="text-2xl font-mono text-white">{inProgressCategories}</div>
            <p className="text-[10px] uppercase tracking-[0.18em] text-white mt-1">In progress</p>
          </div>
          <div className="rounded-lg border border-white/[0.06] bg-white/[0.02] p-3">
            <div className="text-2xl font-mono text-white">{notStartedCategories}</div>
            <p className="text-[10px] uppercase tracking-[0.18em] text-white mt-1">Not started</p>
          </div>
        </div>
      </div>
              ...
              >
                ...
                <div className="space-y-2">
                  <div className="flex justify-between text-[12px]">
                    <span className="text-white">Portfolio entries</span>
                  ...
                  <div className="pt-3 border-t border-white/[0.06] space-y-1">
                    ...
                    <ul className="space-y-1.5 mt-1">
                      {category.learning_outcomes.slice(0, 2).map((outcome, index) => (
                        <li
                          key={index}
                          className="text-[12px] text-white leading-relaxed flex items-start gap-2"
                        >
                      ...
                      {category.learning_outcomes.length > 2 && (
                        <li className="text-[11px] text-white italic">
