  ...
  const commonFailures = [
    {
      ...
      failures: [
        {
          issue: 'High supplementary bonding resistance',
          cause: 'Corroded connections, paint on joints',
          solution: 'Clean and remake connections',
        },
        {
          issue: 'Wrong IP rated equipment in zones',
          cause: 'Incorrect specification',
          solution: 'Replace with correctly rated equipment',
        },
        {
          issue: 'RCD not protecting all circuits',
          cause: 'Old installation without full protection',
          solution: 'Upgrade consumer unit protection',
        },
      ],
    },
    {
      ...
      failures: [
        {
          issue: 'SELV voltage exceeds 12V',
          cause: 'Transformer fault or wrong specification',
          solution: 'Replace transformer, verify output',
        },
        {
          issue: 'Missing supplementary bonding',
          cause: 'Bonding not extended to new metalwork',
          solution: 'Install additional bonding conductors',
        },
        {
          issue: 'Failed underwater light insulation',
          cause: 'Water ingress, seal failure',
          solution: 'Replace light fitting, check seals',
        },
      ],
    },
    {
      ...
      failures: [
        {
          issue: 'Damaged cables and connectors',
          cause: 'Site traffic, poor cable routing',
          solution: 'Replace and improve protection',
        },
        {
          issue: 'Failed insulation resistance',
          cause: 'Moisture ingress, physical damage',
          solution: 'Identify and replace damaged sections',
        },
        {
          issue: 'High earth electrode resistance',
          cause: 'Dry conditions, electrode corrosion',
          solution: 'Additional electrodes or treatment',
        },
      ],
    },
    {
      ...
      failures: [
        {
          issue: 'Rodent damage to cables',
          cause: 'Inadequate protection',
          solution: 'Install SWA or conduit protection',
        },
        {
          issue: 'High touch voltage in livestock areas',
          cause: 'Inadequate bonding',
          solution: 'Improve supplementary bonding',
        },
        {
          issue: 'Corroded equipment in dusty areas',
          cause: 'Wrong IP rating',
          solution: 'Replace with higher IP rated equipment',
        },
      ],
    },
    {
      ...
      failures: [
        {
          issue: 'Low DC insulation resistance',
          cause: 'Moisture ingress, connector failure',
          solution: 'Locate and repair/replace affected components',
        },
        {
          issue: 'Low Voc reading',
          cause: 'Shading, module degradation, string fault',
          solution: 'Investigate string by string',
        },
        {
          issue: 'Earth fault on DC side',
          cause: 'Insulation breakdown, water ingress',
          solution: 'Locate fault using string isolation',
        },
      ],
    },
    {
      ...
      failures: [
        {
          issue: 'RCD not Type A or B',
          cause: 'Incorrect specification',
          solution: 'Replace with Type A or B RCD',
        },
        {
          issue: 'High Zs preventing fast disconnection',
          cause: 'Long cable run, undersized cable',
          solution: 'Increase cable size or add local RCD',
        },
        {
          issue: 'O-PEN device not installed (PME)',
          cause: 'Specification oversight',
          solution: 'Install O-PEN device or earth electrode',
        },
      ],
    },
  ];
    ...
    <div className="space-y-6">
        ...
        <CardHeader className="p-0 pb-3">
          <div className="flex items-center gap-2">
            <CardTitle className="text-[15px] font-semibold tracking-tight text-white">
              Special Location Testing Requirements
            </CardTitle>
          </div>
        </CardHeader>
        <CardContent className="space-y-4 p-0">
          <Alert className="border-elec-yellow/60 bg-white/[0.06]">
            ...
            <AlertDescription className="text-elec-yellow/90">
              Special locations require additional tests beyond the standard BS 7671 sequence. These
              tests verify the enhanced protection measures specific to each location type.
            </AlertDescription>
          </Alert>
          ...
          <div className="bg-white/10 p-4 rounded-lg border border-elec-yellow/20">
            ...
            <p className="text-sm text-white mt-3">
              Plus functional testing, prospective fault current measurement, and verification of
              voltage drop where required.
            </p>
          </div>
        </CardContent>
      </Card>
      ...
      <Card variant="plain">
        <CardHeader className="p-0 pb-3">
          <div className="flex items-center gap-2">
            <CardTitle className="text-[15px] font-semibold tracking-tight text-white">
              Common Test Failures in Special Locations
            </CardTitle>
          </div>
        </CardHeader>
        <CardContent className="space-y-4 p-0">
            ...
            >
              ...
              <div className="space-y-3">
                {loc.failures.map((failure, fIdx) => (
                  <div key={fIdx} className="bg-white/[0.06] p-3 rounded border border-red-500/30">
                    <div className="flex items-center gap-2 mb-2">
