...
const SpecialistReferenceGuide = () => {
  ...
  const bs7671Part7Sections = [
    {
      ...
      applicability: 'Bathrooms, shower rooms, en-suites',
      keyRegulation: 'Zones 0-2, supplementary bonding, IP ratings',
    },
    {
      section: '702',
      title: 'Swimming Pools and Paddling Pools',
      applicability: 'Pools, hot tubs, fountains',
      keyRegulation: 'SELV 12V max, enhanced bonding, zones',
    },
    {
      section: '703',
      title: 'Rooms Containing Sauna Heaters',
      applicability: 'Saunas, steam rooms',
      keyRegulation: 'Temperature zones, heat-resistant cables',
    },
    {
      section: '704',
      title: 'Construction and Demolition Sites',
      applicability: 'Temporary site installations',
      keyRegulation: '110V CTE, RCD protection, IP44',
    },
    {
      section: '705',
      title: 'Agricultural and Horticultural Premises',
      applicability: 'Farms, livestock areas, greenhouses',
      keyRegulation: '25V touch voltage, enhanced bonding',
    },
    {
      section: '706',
      title: 'Restrictive Conductive Locations',
      applicability: 'Inside tanks, boilers, vessels',
      keyRegulation: 'SELV only, max 25V AC',
    },
    {
      section: '708',
      title: 'Caravan and Camping Parks',
      applicability: 'Pitch supplies, touring sites',
      keyRegulation: 'Individual RCD per socket, TT earthing',
    },
    {
      section: '709',
      title: 'Marinas and Similar Locations',
      applicability: 'Boat berths, pontoons',
      keyRegulation: 'No PME, IP56+, TT only',
    },
    {
      section: '710',
      title: 'Medical Locations',
      applicability: 'Hospitals, surgeries, clinics',
      keyRegulation: 'Group 0/1/2, IT systems in theatres',
    },
    {
      section: '711',
      title: 'Exhibitions, Shows and Stands',
      applicability: 'Trade shows, exhibitions',
      keyRegulation: 'Temporary wiring, pre-event inspection',
    },
    {
      section: '712',
      title: 'Solar Photovoltaic Systems',
      applicability: 'Solar PV installations',
      keyRegulation: 'DC isolation, arc fault protection',
    },
    {
      section: '717',
      title: 'Mobile or Transportable Units',
      applicability: 'Mobile homes, portacabins',
      keyRegulation: 'PME measures, external isolation',
    },
    {
      section: '721',
      title: 'Electrical Installations in Caravans',
      applicability: 'Internal caravan wiring',
      keyRegulation: 'Double-pole isolation, bonding',
    },
    {
      section: '722',
      title: 'Electric Vehicle Charging',
      applicability: 'EV charge points',
      keyRegulation: 'Type A/B RCD, O-PEN device',
    },
    {
      section: '729',
      title: 'Operating and Maintenance Gangways',
      applicability: 'Switchroom access',
      keyRegulation: 'Clearances, emergency lighting',
    },
    {
      section: '740',
      title: 'Temporary Electrical Installations',
      applicability: 'Fairgrounds, festivals',
      keyRegulation: 'Daily inspection, emergency stops',
    },
    {
      section: '753',
      title: 'Floor and Ceiling Heating Systems',
      applicability: 'Electric UFH, heated ceilings',
      keyRegulation: 'RCD protection, thermal limits',
    },
  ];
  ...
  const gn7Contents = {
    ...
    description:
      'Essential companion to BS 7671 Part 7, providing detailed explanations, diagrams, and practical guidance for special locations',
    chapters: [
      {
        chapter: '1',
        title: 'Introduction',
        content: 'General principles and application of Part 7',
      },
      {
        chapter: '2',
        title: 'Locations containing a bath or shower',
        content: 'Detailed zone diagrams, equipment selection',
      },
      {
        chapter: '3',
        title: 'Swimming pools',
        content: 'Pool zone layouts, SELV requirements, equipment selection',
      },
      {
        chapter: '4',
        title: 'Sauna heaters',
        content: 'Temperature zones, cable selection tables',
      },
      {
        chapter: '5',
        title: 'Construction sites',
        content: '110V systems, transformer specifications, TT earthing',
      },
      {
        chapter: '6',
        title: 'Agricultural premises',
        content: 'Livestock protection, bonding requirements',
      },
      {
        chapter: '7',
        title: 'Restrictive conductive locations',
        content: 'SELV implementation, equipment requirements',
      },
      {
        chapter: '8',
        title: 'Caravan and camping parks',
        content: 'Supply pillar design, earthing options',
      },
      { chapter: '9', title: 'Marinas', content: 'Shore supply design, corrosion protection' },
      {
        chapter: '10',
        title: 'Medical locations',
        content: 'Group classifications, IT system design',
      },
      ...
      { chapter: '12', title: 'Solar PV', content: 'DC system design, testing procedures' },
      {
        chapter: '13',
        title: 'Mobile units',
        content: 'Connection requirements, PME considerations',
      },
      {
        chapter: '14',
        title: 'EV charging',
        content: 'Installation design, earthing arrangements',
      },
      {
        chapter: '15',
        title: 'Temporary installations',
        content: 'Fairground and outdoor event requirements',
      },
    ],
  };
  ...
  const certificationRequirements = [
    {
      ...
      certificates: [
        ...
        {
          type: 'Schedule of Inspections',
          description: 'With Part 7 specific items noted',
          required: true,
        },
        {
          type: 'Schedule of Test Results',
          description: 'Including additional special location tests',
          required: true,
        },
      ],
    ...
    },
    {
      ...
      certificates: [
        ...
        {
          type: 'MCS Certificate',
          description: 'MCS Installation Certificate (for incentives)',
          required: false,
        },
        {
          type: 'G98 Notification',
          description: 'DNO notification for grid connection',
          required: true,
        },
        {
          type: 'Commissioning Record',
          description: 'Inverter and system commissioning data',
          required: true,
        },
      ],
    ...
    },
    {
      ...
      certificates: [
        { type: 'EIC', description: 'BS 7671 Electrical Installation Certificate', required: true },
        {
          type: 'OZEV Documentation',
          description: 'Government grant scheme paperwork',
          required: false,
        },
        {
          type: 'Commissioning Certificate',
          description: 'Charger-specific commissioning',
          required: true,
        },
        {
          type: 'Smart Charging Compliance',
          description: 'Device Regulations compliance',
          required: true,
        },
      ],
    ...
    },
    {
      ...
      certificates: [
        ...
        {
          type: 'IT System Verification',
          description: 'IMD commissioning records',
          required: true,
        },
        {
          type: 'Emergency Power Test',
          description: 'Switchover time verification',
          required: true,
        },
  ...
  const industrySchemes = [
    ...
    },
    {
      ...
      requirements: ['Electrician registration', 'Technical assessment', 'Insurance requirements'],
      benefits: ['Part P self-certification', 'Online portal', 'Technical support'],
    },
    {
      name: 'ECA',
      ...
      requirements: ['Business membership', 'Competence demonstration', 'Financial stability'],
      benefits: ['Industry representation', 'Technical resources', 'Contract and legal support'],
    },
  ];
  ...
  const qualificationsPathways = [
    {
      ...
      qualifications: [
        {
          name: 'City & Guilds 2399-11',
          level: 'Level 3',
          description: 'Award in Solar PV Installation',
        },
        {
          name: 'EAL Level 3 Award',
          level: 'Level 3',
          description: 'Installing Solar Photovoltaic Systems',
        },
        {
          name: 'MCS Installer Certification',
          level: 'Industry',
          description: 'Required for MCS company registration',
        },
      ],
    ...
    },
    {
      ...
      qualifications: [
        {
          name: 'City & Guilds 2919-01',
          level: 'Level 3',
          description: 'Electric Vehicle Charging Equipment Installation',
        },
        {
          name: 'EAL Level 3 Award',
          level: 'Level 3',
        ...
        },
        {
          ...
          level: 'Industry',
          description: 'Required for government grant work',
        },
      ],
    ...
    },
    {
      ...
      qualifications: [
        {
          name: 'City & Guilds 2391-52',
          level: 'Level 3',
          description: 'Initial and Periodic Inspection and Testing',
        },
        {
          name: 'EAL Level 3 Award',
          level: 'Level 3',
          description: 'Electrical Inspection and Testing',
        },
        {
          name: 'City & Guilds 2391-50',
          level: 'Level 3',
          description: 'Initial Verification only',
        },
      ],
    ...
    },
    {
      ...
      qualifications: [
        {
          name: 'City & Guilds 2393',
          level: 'Level 3',
          description: 'Building Regulations for Electrical Installations',
        },
        {
          name: 'Part P Training',
          level: 'CPD',
          description: 'Various provider courses available',
        },
      ],
  ...
  const usefulResources = [
    {
      ...
      resources: [
        ...
        },
        {
          ...
          description: 'Published version with commentary',
          source: 'IET',
        },
    ...
    },
    {
      ...
      resources: [
        {
          name: 'IET Code of Practice for EV Charging',
          description: 'Electric vehicle installation guidance',
          source: 'IET',
        },
        {
          name: 'IET Code of Practice for Grid-Connected Solar PV',
          description: 'Solar installation guidance',
          source: 'IET',
        },
        {
          name: 'HTM 06-01',
          description: 'Electrical services in healthcare premises',
          source: 'NHS',
        },
    ...
    },
    {
      ...
      resources: [
        {
          name: 'GS38',
          description: 'Electrical test equipment for use by electricians',
          source: 'HSE',
        },
        {
          name: 'HSR25',
          description: 'Memorandum of guidance on Electricity at Work Regulations',
          source: 'HSE',
        },
        { name: 'INDG231', description: 'Electrical safety and you', source: 'HSE' },
        {
          name: 'HSG85',
          description: 'Electricity at work - Safe working practices',
          source: 'HSE',
        },
      ],
    },
    {
      ...
      resources: [
        ...
        {
          name: 'G100',
          description: 'Technical requirements for customer export limiting schemes',
          source: 'ENA',
        },
        {
          name: 'DNO Connections Guide',
          description: 'Individual DNO application processes',
          source: 'Various DNOs',
        },
      ],
    },
    {
      ...
      resources: [
        ...
        {
          name: 'SELECT',
          description: "Scotland's electrical trade body",
          source: 'select.org.uk',
        },
        {
          name: 'JIB',
      ...
      resources: [
        {
          ...
          source: 'theiet.org/forums',
        },
        {
          name: 'Electrical Safety First',
          description: 'Consumer safety information and resources',
          source: 'electricalsafetyfirst.org.uk',
        },
        {
          name: 'NICEIC Technical Helpline',
          description: 'For registered contractors',
          source: 'niceic.com',
        },
        {
          name: 'Cable Calculator Tools',
          description: 'Various manufacturer calculators',
          source: 'Multiple',
        },
      ],
    },
  ...
  const ipRatingsTable = [
    {
      rating: 'IP20',
      firstDigit: 'Touch by fingers',
      secondDigit: 'No water protection',
      typical: 'Indoor general',
    },
    {
      rating: 'IP44',
      firstDigit: 'Tools/wires 1mm+',
      secondDigit: 'Splashing water',
      typical: 'Construction sites',
    },
    {
      rating: 'IP54',
      firstDigit: 'Dust protected',
      secondDigit: 'Splashing water',
      typical: 'Industrial',
    },
    {
      rating: 'IP55',
      firstDigit: 'Dust protected',
      secondDigit: 'Water jets',
      typical: 'Outdoor general',
    },
    {
      rating: 'IP56',
      firstDigit: 'Dust protected',
      secondDigit: 'Heavy seas/jets',
      typical: 'Marinas',
    },
    {
      rating: 'IP65',
      firstDigit: 'Dust tight',
      secondDigit: 'Water jets',
      typical: 'Washdown areas',
    },
    {
      rating: 'IP66',
      firstDigit: 'Dust tight',
      secondDigit: 'Powerful jets',
      typical: 'Milking parlours',
    },
    {
      rating: 'IP67',
      firstDigit: 'Dust tight',
      secondDigit: 'Temporary immersion',
      typical: 'Pool surrounds',
    },
    {
      rating: 'IP68',
      firstDigit: 'Dust tight',
      secondDigit: 'Continuous immersion',
      typical: 'Underwater',
    },
    {
      rating: 'IPX4',
      firstDigit: 'Not specified',
      secondDigit: 'Splashing water',
      typical: 'Bathrooms Zone 2',
    },
    {
      rating: 'IPX5',
      firstDigit: 'Not specified',
      secondDigit: 'Water jets',
      typical: 'Bathrooms Zone 1 (jets)',
    },
    {
      rating: 'IPX7',
      firstDigit: 'Not specified',
      secondDigit: 'Temp immersion',
      typical: 'Bathrooms Zone 0',
    },
  ];
  ...
  const rcdTypesTable = [
    {
      type: 'Type AC',
      detects: 'AC residual currents only',
      applications: 'General circuits without electronics',
      notes: 'Minimum for most circuits',
    },
    {
      type: 'Type A',
      detects: 'AC + pulsating DC',
      applications: 'EV charging, electronics, inverters',
      notes: 'Required for EV, PV inverters',
    },
    {
      type: 'Type F',
      detects: 'AC + pulsating DC + mixed frequency',
      applications: 'VFDs, frequency inverters',
      notes: 'For variable frequency equipment',
    },
    {
      type: 'Type B',
      detects: 'AC + pulsating DC + smooth DC',
      applications: 'Three-phase EV charging, PV',
      notes: 'Highest protection level',
    },
  ];
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="border-white/[0.06] bg-white/5">
        <CardHeader>
          <div className="flex items-center gap-2">
            ...
            <CardTitle className="text-white">BS 7671 Part 7 Quick Reference</CardTitle>
          </div>
        </CardHeader>
      ...
      <Card className="border-white/[0.06] bg-white/5">
        <CardHeader>
          <div className="flex items-center gap-2">
            <BookOpen className="h-6 w-6 text-white/55" />
            <CardTitle className="text-white">{gn7Contents.title}</CardTitle>
          </div>
        </CardHeader>
        <CardContent className="space-y-4">
                ...
                {cert.certificates.map((doc, docIdx) => (
                  <div key={docIdx} className="flex items-center justify-between text-sm">
                    ...
                    <Badge
                      variant="outline"
                      className={
                        doc.required ? 'border-white/10 text-white' : 'border-white/50 text-white'
                      }
                    >
      ...
      <Card className="border-white/[0.06] bg-white/5">
        <CardHeader>
          <div className="flex items-center gap-2">
            ...
            <CardTitle className="text-white">Industry Bodies & Certification Schemes</CardTitle>
          </div>
        </CardHeader>
        <CardContent className="space-y-4">
            ...
            {industrySchemes.map((scheme, idx) => (
              <div key={idx} className="bg-white/[0.02] p-4 rounded-lg border border-white/[0.06]">
                ...
                <div className="text-xs">
                  <div className="text-white mb-1">Key Benefits:</div>
      ...
      <Card className="border-white/[0.06] bg-white/5">
        <CardHeader>
          <div className="flex items-center gap-2">
            ...
            <CardTitle className="text-white">Further Training & Qualifications</CardTitle>
          </div>
        </CardHeader>
        <CardContent className="space-y-4">
          {qualificationsPathways.map((pathway, idx) => (
            <div key={idx} className="bg-white/[0.02] p-4 rounded-lg border border-white/[0.06]">
              ...
              <div className="text-xs text-white">
                <span className="text-white">Prerequisites: </span>
      ...
      <Card className="border-white/[0.06] bg-white/5">
        <CardHeader>
          <div className="flex items-center gap-2">
            ...
            <CardTitle className="text-white">IP Ratings Quick Reference</CardTitle>
          </div>
        </CardHeader>
        <CardContent className="space-y-4">
          <Alert className="border-white/[0.06] bg-white/[0.02]">
      ...
      <Card className="border-white/[0.06] bg-white/5">
        <CardHeader>
          <div className="flex items-center gap-2">
            ...
            <CardTitle className="text-white">RCD Types Quick Reference</CardTitle>
          </div>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="overflow-x-auto">
      ...
      <Card className="border-white/[0.06] bg-white/5">
        <CardHeader>
          <div className="flex items-center gap-2">
            ...
            <CardTitle className="text-white">Useful Resources & Links</CardTitle>
          </div>
        </CardHeader>
        <CardContent className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                {category.resources.map((resource, rIdx) => (
                  <div key={rIdx} className="flex items-start gap-2 text-sm">
                    <Lightbulb className="h-4 w-4 text-white/55 mt-0.5 flex-shrink-0" />
                    <div>
        ...
        <CardHeader>
          <div className="flex items-center gap-2">
            ...
            <CardTitle className="text-elec-yellow">
              Specialist Installer Career Progression
            </CardTitle>
          </div>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <Alert className="border-elec-yellow/50 bg-elec-yellow/10">
            ...
            <AlertDescription className="text-elec-yellow/90 text-sm">
              Specialist areas like Solar PV and EV charging offer excellent career progression
              opportunities with growing market demand. Consider combining multiple specialisms for
              maximum flexibility.
            </AlertDescription>
          </Alert>
        </CardContent>
