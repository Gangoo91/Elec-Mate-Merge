...
const SpecialLocationsGuide = () => {
  ...
  const bathroomQuickRef = {
    ...
    icon: ShowerHead,
    description:
      'Locations containing a bath or shower - detailed guide available in Domestic Installations',
    linkTo: '/apprentice/on-job-tools/electrical-installation-guides/domestic',
    zones: [
      {
        zone: 'Zone 0',
        description: 'Inside the bath or shower basin',
        ipRating: 'IPX7',
        voltage: 'SELV 12V AC / 30V DC only',
      },
      {
        zone: 'Zone 1',
        description: 'Above Zone 0 to 2.25m from floor',
        ipRating: 'IPX4 (IPX5 if jets)',
        voltage: 'SELV permitted, equipment rated for zone',
      },
      {
        zone: 'Zone 2',
        description: '0.6m beyond Zone 1',
        ipRating: 'IPX4',
        voltage: 'Specified equipment only',
      },
      {
        zone: 'Outside Zones',
        description: '3m from Zone 1 edge',
        ipRating: 'General requirements',
        voltage: '30mA RCD protection',
      },
    ],
    keyRequirements: [
    ...
    zones: [
      {
        ...
        ipRating: 'IPX8',
        voltage: 'SELV 12V AC only',
      },
      {
        zone: 'Zone 1',
        description: '2m from Zone 0 edge, 2.5m above',
        ipRating: 'IPX5',
        voltage: 'SELV or protective measures',
      },
      {
        zone: 'Zone 2',
        description: '1.5m beyond Zone 1',
        ipRating: 'IPX4',
        voltage: 'Specific equipment only',
      },
    ],
    keyRequirements: [
  ...
  const saunasData = {
    ...
    cableTypes: [
      { type: 'Standard T&E', maxTemp: '70C', suitability: 'Zone A only, outside sauna' },
      {
        ...
        maxTemp: '180C',
        suitability: 'Zones B and C, heater connections',
      },
      {
        type: 'Mineral insulated (MICC)',
        maxTemp: '250C',
        suitability: 'All zones, highest protection',
      },
  ...
  const constructionSitesData = {
    ...
    earthingSystems: [
      {
        system: 'TT System',
        description: 'Most common on construction sites',
        earthing: 'Local earth electrode required',
      },
      {
        system: 'TN-S (if available)',
        description: 'Permanent supply connected',
        earthing: 'Use supply earth',
      },
    ],
    keyRequirements: [
  ...
  const agriculturalData = {
    ...
    ipRatings: [
      {
        location: 'Livestock areas',
        ipRating: 'IP44 minimum',
        reason: 'Dust, moisture, animal contact',
      },
      {
        location: 'Feed storage areas',
        ipRating: 'IP54 or higher',
        reason: 'Combustible dust hazard',
      },
  ...
  const restrictiveLocationsData = {
    ...
    definition:
      'A location whose dimensions restrict movement so that parts of the body are likely to be in continuous contact with extraneous-conductive-parts (e.g., inside boilers, tanks, ducts, metal vessels)',
    examples: [
  ...
  const caravanParksData = {
    ...
    icon: Caravan,
    description:
      'Electrical installations in caravan and camping parks providing pitches with electrical connections',
    supplyPillars: [
    ...
    earthingRequirements: [
      {
        system: 'TT Earthing',
        details: 'Most common - local earth electrode',
        resistance: 'Max 200 ohms Ra',
      },
      {
        system: 'Earth Electrode',
        details: 'At each supply pillar or group',
        resistance: 'Must satisfy 30mA x Ra less than 50V',
      },
      {
        system: 'PME Warning',
        details: 'PME earthing requires special measures',
        notes: 'See Regulation 708.411.4',
      },
    ],
    hookUpRequirements: [
  ...
  const marinasData = {
    ...
    floatingStructures: [
      {
        structure: 'Fixed Pontoons',
        requirements: 'Standard shore supply installation',
        cables: 'Flexible for movement',
      },
      {
        structure: 'Floating Pontoons',
        requirements: 'Allow for vertical movement',
        cables: 'Extra slack for tide',
      },
      {
        structure: 'Boat Berths',
        requirements: 'Individual metered supply',
        cables: 'Floating cable support',
      },
    ],
    ipRatings: [
    ...
    earthElectrodes: [
      {
        type: 'Shore-based electrode',
        location: 'On land, main earthing',
        resistance: 'As per TT requirements',
      },
      {
        type: 'Pontoon earthing',
        location: 'Each floating section',
        resistance: 'Bonded to main earth',
      },
      {
        type: 'No water electrode',
        location: 'Never use water as earth',
        notes: 'Electric shock hazard to swimmers',
      },
    ],
    keyRequirements: [
  ...
  const medicalLocationsData = {
    ...
    itSystemRequirements: [
      {
        aspect: 'Insulation Monitoring',
        requirement: 'Alarm at 50k ohms',
        purpose: 'First fault detection',
      },
      {
        aspect: 'Power Supply',
        requirement: 'IT via isolating transformer',
        purpose: 'Continuity during first fault',
      },
      {
        aspect: 'Transformer Rating',
        requirement: 'Max 10kVA per transformer',
        purpose: 'Limit fault current',
      },
      {
        aspect: 'Response Time',
        requirement: 'Switchover less than 0.5s',
        purpose: 'Life support continuity',
      },
    ],
    bondingRequirements: [
  ...
  const mobileUnitsData = {
    ...
    categories: [
      {
        type: 'Touring Caravans',
        section: 'Section 721',
        description: 'Caravans for temporary use',
      },
      {
        type: 'Motorhomes',
        section: 'Section 717',
        description: 'Motor vehicles with living accommodation',
      },
      {
        type: 'Transportable Units',
        section: 'Section 717',
        description: 'Buildings designed to be moved',
      },
    ],
    supplyRequirements: [
  ...
  const fairgroundsData = {
    ...
    amusementDevices: [
      {
        type: 'Rides requiring power',
        protection: '30mA RCD, emergency stop',
        notes: 'Annual inspection',
      },
      {
        type: 'Lighting installations',
        protection: '30mA RCD, mechanical protection',
        notes: 'IP44 minimum',
      },
      {
        type: 'Food stalls',
        protection: '30mA RCD per outlet',
        notes: 'Portable appliance testing',
      },
    ],
    temporaryStructures: [
      {
        structure: 'Marquees',
        requirements: 'Temporary distribution, RCD protection',
        earthing: 'TT with local electrode',
      },
      {
        structure: 'Stage structures',
        requirements: 'Performance lighting and PA',
        earthing: 'Enhanced bonding',
      },
      {
        structure: 'Festival installations',
        requirements: 'Multiple distribution points',
        earthing: 'Coordination with generators',
      },
    ],
    keyRequirements: [
  ...
  const getColorClasses = (color: string) => {
    const colors: Record<string, { border: string; bg: string; text: string; badge: string }> = {
      ...
      slate: {
        ...
        bg: 'bg-slate-500/10',
        text: 'text-white',
        badge: 'border-slate-400 text-white',
      },
      fuchsia: {
        border: 'border-white/[0.10]',
        bg: 'bg-white/[0.06]',
    ...
    return (
      <CardHeader className="pb-2">
        <div className="flex items-center gap-2">
          ...
          <div>
            <Badge variant="outline" className={`${colors.badge} text-xs mb-1`}>
              {section}
            </Badge>
  ...
  return (
    <div className="space-y-6">
        ...
        <CardContent className="space-y-4 p-0">
          <Alert className="border-elec-yellow/60 bg-white/[0.06]">
            ...
            <AlertDescription className="text-elec-yellow/90">
              Part 7 of BS 7671 contains requirements for special installations and locations. These
              supplement or modify the general requirements of Parts 1-6 and take precedence where
          ...
          <div className="bg-white/10 p-4 rounded-lg border border-elec-yellow/20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
              ...
              <div className="flex items-start gap-2">
                <HardHat className="h-4 w-4 text-elec-yellow mt-0.5 flex-shrink-0" />
                <span className="text-white">
                  Temporary installations (construction, exhibitions)
                </span>
              </div>
            </div>
          </div>
      ...
      <Card className={`${getColorClasses(bathroomQuickRef.color).border} bg-white/5`}>
        {renderSectionHeader(
          bathroomQuickRef.section,
          bathroomQuickRef.title,
          bathroomQuickRef.color,
          bathroomQuickRef.icon,
          bathroomQuickRef.description
        )}
        <CardContent className="space-y-4 p-0">
          <div
            className={`${getColorClasses(bathroomQuickRef.color).bg} p-4 rounded-lg border ${getColorClasses(bathroomQuickRef.color).border}`}
          >
                ...
                <tbody>
                  {bathroomQuickRef.zones.map((zone, idx) => (
                    <tr key={idx} className="border-b border-white/[0.10]">
                      ...
                      <td className="py-2 text-white">{zone.ipRating}</td>
      ...
      <Card className={`${getColorClasses(swimmingPoolsRef.color).border} bg-white/5`}>
        {renderSectionHeader(
          swimmingPoolsRef.section,
          swimmingPoolsRef.title,
          swimmingPoolsRef.color,
          swimmingPoolsRef.icon,
          swimmingPoolsRef.description
        )}
        <CardContent className="space-y-4 p-0">
          <div
            className={`${getColorClasses(swimmingPoolsRef.color).bg} p-4 rounded-lg border ${getColorClasses(swimmingPoolsRef.color).border}`}
          >
            <h4 className="font-medium text-white mb-3">Zone Summary</h4>
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
      ...
      <Card className={`${getColorClasses(saunasData.color).border} bg-white/5`}>
        {renderSectionHeader(
          ...
          saunasData.color,
          saunasData.icon,
          saunasData.description
        )}
        <CardContent className="space-y-4 p-0">
          <div
            className={`${getColorClasses(saunasData.color).bg} p-4 rounded-lg border ${getColorClasses(saunasData.color).border}`}
          >
                ...
                <div key={idx} className="bg-white/[0.06] p-3 rounded border border-white/[0.10]">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm">
                    <div>
                      ...
                      <span className="text-white">{zone.cables}</span>
                    </div>
                    <div>
                      <span className="text-white">Equipment:</span>{' '}
                      <span className="text-white">{zone.equipment}</span>
                    </div>
                  </div>
                </div>
              ))}
                ...
                <tbody>
                  {saunasData.cableTypes.map((cable, idx) => (
                    <tr key={idx} className="border-b border-white/[0.10]">
                      ...
                      <td className="py-2 text-white">{cable.maxTemp}</td>
      ...
      <Card className={`${getColorClasses(constructionSitesData.color).border} bg-white/5`}>
        {renderSectionHeader(
          constructionSitesData.section,
          constructionSitesData.title,
          constructionSitesData.color,
          constructionSitesData.icon,
          constructionSitesData.description
        )}
        <CardContent className="space-y-4 p-0">
          <div
            className={`${getColorClasses(constructionSitesData.color).bg} p-4 rounded-lg border ${getColorClasses(constructionSitesData.color).border}`}
          >
              ...
              {constructionSitesData.voltageRequirements.map((volt, idx) => (
                <div key={idx} className="bg-white/[0.06] p-3 rounded border border-elec-yellow/30">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-elec-yellow font-medium">{volt.use}</span>
                  </div>
                  <div className="text-sm text-white">
                    ...
                    {volt.maxVoltage && (
                      <span className="ml-2">
                        | <span className="text-white">Max to earth: </span>
                        {volt.maxVoltage}
                      </span>
                    )}
                  </div>
              ...
              <div className="space-y-2">
                {constructionSitesData.transformerRequirements.map((trans, idx) => (
                  <div key={idx} className="text-sm">
                    <span className="text-elec-yellow font-medium">{trans.type}</span>
            ...
            >
              ...
              <div className="space-y-2">
                {constructionSitesData.earthingSystems.map((earth, idx) => (
                  <div key={idx} className="text-sm">
                    <span className="text-elec-yellow font-medium">{earth.system}</span>
      ...
      <Card className={`${getColorClasses(agriculturalData.color).border} bg-white/5`}>
        {renderSectionHeader(
          agriculturalData.section,
          agriculturalData.title,
          agriculturalData.color,
          agriculturalData.icon,
          agriculturalData.description
        )}
        <CardContent className="space-y-4 p-0">
          <Alert className="border-white/[0.10] bg-white/[0.06]">
            <AlertTriangle className="h-4 w-4 text-white" />
          ...
          <div
            className={`${getColorClasses(agriculturalData.color).bg} p-4 rounded-lg border ${getColorClasses(agriculturalData.color).border}`}
          >
                ...
                <tbody>
                  {agriculturalData.ipRatings.map((ip, idx) => (
                    <tr key={idx} className="border-b border-white/[0.10]">
                      ...
                      <td className="py-2 text-white">{ip.ipRating}</td>
      ...
      <Card className={`${getColorClasses(restrictiveLocationsData.color).border} bg-white/5`}>
        {renderSectionHeader(
          restrictiveLocationsData.section,
          restrictiveLocationsData.title,
          restrictiveLocationsData.color,
          restrictiveLocationsData.icon,
          restrictiveLocationsData.description
        )}
        <CardContent className="space-y-4 p-0">
          <Alert className="border-white/[0.12] border-l-[3px] border-l-red-500 bg-white/[0.06]">
            <AlertTriangle className="h-4 w-4 text-red-400" />
            <AlertDescription className="text-red-200 text-sm">
              <strong>CRITICAL:</strong> SELV is the ONLY permitted protective measure in
              restrictive conductive locations. Standard fault protection is not adequate due to
              continuous body contact with conductive surfaces.
            </AlertDescription>
          </Alert>
      ...
      <Card className={`${getColorClasses(caravanParksData.color).border} bg-white/5`}>
        {renderSectionHeader(
          caravanParksData.section,
          caravanParksData.title,
          caravanParksData.color,
          caravanParksData.icon,
          caravanParksData.description
        )}
        <CardContent className="space-y-4 p-0">
          <div
            className={`${getColorClasses(caravanParksData.color).bg} p-4 rounded-lg border ${getColorClasses(caravanParksData.color).border}`}
          >
                ...
                <tbody>
                  {caravanParksData.supplyPillars.map((item, idx) => (
                    <tr key={idx} className="border-b border-white/[0.10]">
                      ...
                      <td className="py-2 text-white">{item.requirement}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
      ...
      <Card className={`${getColorClasses(marinasData.color).border} bg-white/5`}>
        ...
        <CardContent className="space-y-4 p-0">
          ...
          <div
            className={`${getColorClasses(marinasData.color).bg} p-4 rounded-lg border ${getColorClasses(marinasData.color).border}`}
          >
              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  {marinasData.ipRatings.map((ip, idx) => (
                    <tr key={idx} className="border-b border-white/[0.10]">
                      <td className="py-2 text-white">{ip.location}</td>
                      <td className="py-2 text-white">{ip.rating}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
      ...
      <Card className={`${getColorClasses(medicalLocationsData.color).border} bg-white/5`}>
        {renderSectionHeader(
          medicalLocationsData.section,
          medicalLocationsData.title,
          medicalLocationsData.color,
          medicalLocationsData.icon,
          medicalLocationsData.description
        )}
        <CardContent className="space-y-4 p-0">
          <div
            className={`${getColorClasses(medicalLocationsData.color).bg} p-4 rounded-lg border ${getColorClasses(medicalLocationsData.color).border}`}
          >
            <h4 className="font-medium text-white mb-3">Group Classifications</h4>
            <div className="space-y-3">
              {medicalLocationsData.groupClassifications.map((group, idx) => (
                <div key={idx} className="bg-white/[0.06] p-3 rounded border border-red-500/30">
                  <div className="flex items-center gap-2 mb-2">
                  ...
                  <div className="text-sm">
                    <div className="text-white">
                      <span className="text-white">Examples:</span> {group.examples}
                    </div>
                    <div className="text-white">
                      <span className="text-white">Requirements:</span> {group.requirements}
                    </div>
                  </div>
                </div>
              ))}
          ...
          <Alert className="border-white/[0.12] border-l-[3px] border-l-red-500 bg-white/[0.06]">
            ...
            <AlertDescription className="text-red-200 text-sm">
              Medical electrical installations are life-critical. Specialist design and installation
              by competent persons with healthcare experience is essential.
            </AlertDescription>
          </Alert>
        </CardContent>
      </Card>
      ...
      <Card className={`${getColorClasses(exhibitionsData.color).border} bg-white/5`}>
        {renderSectionHeader(
          exhibitionsData.section,
          exhibitionsData.title,
          exhibitionsData.color,
          exhibitionsData.icon,
          exhibitionsData.description
        )}
        <CardContent className="space-y-4 p-0">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div
              className={`${getColorClasses(exhibitionsData.color).bg} p-4 rounded-lg border ${getColorClasses(exhibitionsData.color).border}`}
            >
      ...
      <Card className={`${getColorClasses(mobileUnitsData.color).border} bg-white/5`}>
        {renderSectionHeader(
          mobileUnitsData.section,
          mobileUnitsData.title,
          mobileUnitsData.color,
          mobileUnitsData.icon,
          mobileUnitsData.description
        )}
        <CardContent className="space-y-4 p-0">
          <div
            className={`${getColorClasses(mobileUnitsData.color).bg} p-4 rounded-lg border ${getColorClasses(mobileUnitsData.color).border}`}
          >
      ...
      <Card className={`${getColorClasses(evChargingRef.color).border} bg-white/5`}>
        {renderSectionHeader(
          evChargingRef.section,
          evChargingRef.title,
          evChargingRef.color,
          evChargingRef.icon,
          evChargingRef.description
        )}
        <CardContent className="space-y-4 p-0">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
      ...
      <Card className={`${getColorClasses(gangwaysData.color).border} bg-white/5`}>
        {renderSectionHeader(
          gangwaysData.section,
          gangwaysData.title,
          gangwaysData.color,
          gangwaysData.icon,
          gangwaysData.description
        )}
        <CardContent className="space-y-4 p-0">
          <div
            className={`${getColorClasses(gangwaysData.color).bg} p-4 rounded-lg border ${getColorClasses(gangwaysData.color).border}`}
          >
      ...
      <Card className={`${getColorClasses(fairgroundsData.color).border} bg-white/5`}>
        {renderSectionHeader(
          fairgroundsData.section,
          fairgroundsData.title,
          fairgroundsData.color,
          fairgroundsData.icon,
          fairgroundsData.description
        )}
        <CardContent className="space-y-4 p-0">
          <div
            className={`${getColorClasses(fairgroundsData.color).bg} p-4 rounded-lg border ${getColorClasses(fairgroundsData.color).border}`}
          >
      ...
      <Card className="border-white/[0.12] border-l-[3px] border-l-red-500 bg-white/[0.06]">
        ...
        <CardContent className="space-y-4 p-0">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
            <div className="space-y-3">
              <div className="p-3 rounded-lg border border-white/[0.12] border-l-[3px] border-l-red-500 bg-white/[0.06]">
