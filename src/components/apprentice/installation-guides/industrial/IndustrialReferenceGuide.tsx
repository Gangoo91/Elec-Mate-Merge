      ...
      standards: [
        {
          ...
          scope: 'Equipment design and certification',
        },
        {
          code: 'BS EN 60079-14',
          title: 'Explosive atmospheres - Installation design',
          scope: 'Installation requirements',
        },
        {
          code: 'BS EN 60079-17',
          title: 'Explosive atmospheres - Inspection and maintenance',
          scope: 'Ongoing compliance',
        },
        {
          code: 'DSEAR 2002',
          title: 'Dangerous Substances and Explosive Atmospheres Regulations',
          scope: 'Risk assessment and control',
        },
      ],
    },
    {
      ...
      standards: [
        {
          ...
          scope: 'Machine control systems',
        },
        {
          code: 'PUWER 1998',
          title: 'Provision and Use of Work Equipment Regulations',
          scope: 'Equipment safety requirements',
        },
        {
          code: 'BS EN ISO 13849-1',
          title: 'Safety-related parts of control systems',
          scope: 'Functional safety',
        },
        {
          code: 'Machinery Directive 2006/42/EC',
          title: 'Machinery safety requirements',
          scope: 'CE marking compliance',
        },
      ],
    },
    {
