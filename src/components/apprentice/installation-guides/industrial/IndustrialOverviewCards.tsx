...
const IndustrialOverviewCards = () => {
  ...
  const industrialBackground = {
    ...
    definition:
      'Industrial electrical work involves the installation, maintenance, and repair of electrical systems in manufacturing plants, processing facilities, warehouses, and heavy industry environments. It typically involves higher voltages, larger equipment, and more complex control systems than domestic or commercial work.',
    premises: [
      {
        type: 'Manufacturing Plants',
        description:
          'Factories producing goods using production lines, assembly systems, and automated machinery',
        examples: 'Car plants, electronics assembly, textile mills',
      },
      {
        type: 'Processing Facilities',
        description: 'Plants that process raw materials into finished products',
        examples: 'Food processing, chemical plants, refineries',
      },
      {
        type: 'Warehousing',
        description: 'Large storage and distribution centres with automated handling systems',
        examples: 'Amazon fulfilment centres, cold storage, logistics hubs',
      },
      {
        type: 'Heavy Industry',
        description: 'Large-scale industrial operations handling raw materials',
        examples: 'Steel works, foundries, mining operations',
      },
    ],
    differences: [
      {
        aspect: 'Voltage Levels',
        commercial: '230V single-phase, 400V 3-phase',
        industrial: '400V, 690V, 3.3kV, 11kV, 33kV',
      },
      {
        aspect: 'Motor Sizes',
        commercial: 'Up to 7.5kW typically',
        industrial: 'From 7.5kW to several MW',
      },
      {
        aspect: 'Hazards',
        commercial: 'Standard electrical risks',
        industrial: 'Explosive atmospheres, arc flash, heavy machinery, chemicals',
      },
      {
        aspect: 'Control Systems',
        commercial: 'Basic switching, timers',
        industrial: 'PLCs, SCADA, DCS, complex automation',
      },
      {
        aspect: 'Certification',
        commercial: 'Part P, EIC/EICR',
        industrial: 'CompEx, IECEx, authorised person training',
      },
    ],
  };
    ...
    paths: [
      {
        ...
        description:
          'Maintain and repair electrical systems in operating factories. Involves fault-finding, preventive maintenance, and emergency repairs.',
      ...
      },
      {
        ...
        description:
          'Work on new installations and major upgrades. Install new production lines, motor control centres, and distribution systems.',
      ...
      },
      {
        ...
        description:
          'Specialise in PLC programming, SCADA systems, and automation. Design and implement control strategies for industrial processes.',
      ...
      },
      {
        ...
        description:
          'Work on HV systems (11kV, 33kV). Includes switchgear operations, transformer maintenance, and HV cable installations.',
      ...
      },
      {
        ...
        description:
          'Work in explosive atmospheres (ATEX zones). Requires CompEx certification and specialised equipment knowledge.',
  ...
  const manufacturingContent = {
    ...
    productionLines: {
      ...
      description:
        'Production lines require coordinated electrical systems that control multiple machines working in sequence. Understanding interlocking, sequencing, and safety circuits is essential.',
      components: [
        {
          name: 'Conveyor Systems',
          voltage: '400V 3-phase',
          control: 'VFD with encoder feedback',
          safety: 'E-stop chain, light curtains',
        },
        {
          name: 'Assembly Stations',
          voltage: '230V single-phase',
          control: 'PLC I/O modules',
          safety: 'Local isolation, two-hand controls',
        },
        {
          name: 'Robotic Cells',
          voltage: '400V 3-phase',
          control: 'Robot controller + PLC',
          safety: 'Safety PLC, area scanners',
        },
        {
          name: 'Quality Testing',
          voltage: '230V single-phase',
          control: 'PC-based DAQ',
    ...
    mcc: {
      ...
      description:
        'MCCs are centralised assemblies containing motor starters, protection devices, and control equipment. They provide a safe, organised way to control multiple motors from one location.',
      components: [
        { item: 'Incoming Section', function: 'Main isolator, metering, protection relays' },
        {
          item: 'Distribution Busbars',
          function: 'Copper or aluminium busbars rated for full load current',
        },
        {
          item: 'Motor Starter Drawers',
          function: 'Individual motor starters with isolation capability',
        },
        { item: 'Control Section', function: 'PLC rack, I/O modules, power supplies' },
      ],
      starterTypes: [
        {
          type: 'DOL (Direct On Line)',
          use: 'Motors up to 7.5kW',
          characteristics: 'Simple, high starting current (6-8x FLC)',
        },
        {
          type: 'Star-Delta',
          use: 'Motors 7.5kW - 30kW',
          characteristics: 'Reduced starting current (33%), torque dip on changeover',
        },
        {
          type: 'Soft Starter',
          use: 'Motors 15kW+',
          characteristics: 'Smooth acceleration, reduced mechanical stress',
        },
        {
          type: 'VFD (Variable Frequency Drive)',
          use: 'Variable speed applications',
          characteristics: 'Full speed control, energy savings, precise positioning',
        },
      ],
    },
    plcAutomation: {
      ...
      description:
        'Programmable Logic Controllers (PLCs) are the backbone of modern industrial automation. They replace relay logic with programmable, flexible control.',
      keyComponents: [
        {
          component: 'CPU Module',
          function: 'Executes program logic, stores data and configuration',
        },
        {
          component: 'Power Supply',
          function: 'Provides DC power to all modules (typically 24VDC)',
        },
        {
          component: 'Digital Inputs',
          function: 'Receives signals from sensors, switches (24VDC typically)',
        },
        ...
        { component: 'Analogue Outputs', function: 'Controls VFDs, valve positioners (4-20mA)' },
        {
          ...
          function: 'Ethernet/IP, Profinet, Modbus connectivity',
        },
      ],
      commonProtocols: [
    ...
    compressedAir: {
      ...
      description:
        "Compressed air is often called the 'fourth utility' in manufacturing. The electrical systems supporting compressors and air treatment require careful design.",
      components: [
        {
          equipment: 'Compressor Motor',
          typical: '22kW - 250kW',
          starting: 'Soft starter or VFD essential',
          notes: 'High inrush, consider power factor',
        },
        {
          equipment: 'Dryer Controls',
          typical: '1-5kW',
          starting: 'DOL acceptable',
          notes: 'Interlock with compressor',
        },
        {
          equipment: 'Pressure Transmitters',
          typical: '4-20mA output',
          starting: 'N/A',
          notes: '24VDC loop powered',
        },
        {
          equipment: 'Control Panel',
          typical: '3-5kW',
          starting: 'N/A',
          notes: 'PLC with touch screen HMI',
        },
      ],
    },
    voltages: {
      ...
      levels: [
        {
          voltage: '230V AC',
          use: 'Control circuits, lighting, small equipment',
          cable: 'Singles in trunking, flex',
        },
        {
          voltage: '400V AC 3-phase',
          use: 'Standard motors up to 200kW, distribution',
          cable: 'SWA, singles in tray',
        },
        {
          voltage: '690V AC 3-phase',
          use: 'Large motors 200kW+, reduced cable sizes',
          cable: 'SWA, XLPE insulation',
        },
        {
          voltage: '24V DC',
          use: 'Control circuits, PLC I/O, sensors',
          cable: 'Control cable, screened',
        },
        {
          voltage: '110V AC CTE',
          use: 'Portable tools, temporary lighting',
          cable: 'Arctic grade flex, yellow',
        },
      ],
    },
  };
  ...
  const warehousingContent = {
    ...
    highBayLighting: {
      ...
      description:
        'Warehouse lighting must provide adequate illumination for safe working while minimising energy costs. Modern LED systems offer significant advantages.',
      comparison: [
        {
          type: 'LED High Bay',
      ...
      controlOptions: [
        {
          method: 'DALI',
          description:
            'Digital addressable lighting - individual fixture control, dimming, scheduling',
        },
        ...
        {
          method: 'Daylight Harvesting',
          description: 'Photocells dim lights based on natural light levels',
        },
      ],
    ...
    loadingBays: {
      ...
      description:
        'Loading bays are challenging environments requiring weatherproof equipment, traffic considerations, and integration with door controls.',
      equipment: [
        {
          item: 'Dock Levellers',
          power: '1.5-3kW',
          requirements: 'Interlock with door position, safety edge sensors',
        },
        {
          item: 'Fast-Acting Doors',
          power: '0.5-1.5kW',
          requirements: 'Photocell safety, wind sensors, traffic lights',
        },
        {
          item: 'Loading Bay Lighting',
          power: 'Varies',
          requirements: 'IP65 minimum, switched from cab control',
        },
        {
          item: 'Vehicle Restraints',
          power: '0.5kW',
          requirements: 'Interlock with dock leveller and internal door',
        },
      ],
      safetyCircuits: [
    ...
    forkliftCharging: {
      ...
      description:
        'Electric forklift charging areas require careful electrical design to handle high currents safely and efficiently.',
      types: [
        {
          type: 'Lead-Acid Conventional',
          charging: '8-12 hours',
          power: '3-phase 400V',
          current: '30-80A per charger',
        },
        {
          type: 'Lead-Acid Fast Charge',
          charging: '1-2 hours',
          power: '3-phase 400V',
          current: '100-200A per charger',
        },
        {
          type: 'Lithium-Ion',
          charging: '1-3 hours',
          power: '3-phase 400V',
          current: '50-150A per charger',
        },
        {
          type: 'Lithium-Ion Opportunity',
          charging: '15-30 mins',
          power: '3-phase 400V',
          current: '200-400A per charger',
        },
      ],
      designRequirements: [
    ...
    automatedStorage: {
      ...
      description:
        'Modern warehouses increasingly use automated storage and retrieval systems (AS/RS) requiring sophisticated electrical infrastructure.',
      systems: [
        {
          system: 'Shuttle Systems',
          description: 'Autonomous shuttles moving within racking',
          power: 'Battery powered with charging rails',
          controls: 'Warehouse Management System (WMS) integration',
        },
        {
          system: 'Stacker Cranes',
          description: 'Rail-mounted cranes for high-bay storage',
          power: '400V busbars or cable festoons',
          controls: 'Positioning via encoders and laser',
        },
        {
          system: 'Conveyor Networks',
          description: 'Interconnected conveyors for goods movement',
          power: 'Distributed VFDs along route',
          controls: 'PLC control with barcode tracking',
        },
        {
          system: 'Robotic Picking',
          description: 'Automated goods-to-person systems',
          power: 'Individual robot batteries',
          controls: 'Fleet management software',
        },
      ],
    },
    coldStorage: {
      ...
      description:
        'Refrigerated warehouses have unique electrical requirements due to extreme temperatures and the critical nature of maintaining the cold chain.',
      zones: [
        ...
        { zone: 'Chilled', temp: '0 to +5C', considerations: 'Condensation risk, IP54 minimum' },
        {
          zone: 'Frozen',
          temp: '-18 to -25C',
          considerations: 'Special cables, low-temp rated equipment',
        },
        {
          zone: 'Deep Freeze',
          temp: '-30 to -40C',
          considerations: 'Arctic-grade everything, heated enclosures for controls',
        },
      ],
      specialRequirements: [
    ...
    securityAccess: {
      ...
      description:
        'Warehouse security systems integrate with electrical infrastructure to protect goods and control personnel access.',
      systems: [
        {
          system: 'Access Control',
          description: 'Card readers, biometrics, turnstiles',
          power: 'Low voltage (12-24VDC)',
          interface: 'Wiegand or OSDP protocol',
        },
        {
          system: 'CCTV',
          description: 'IP cameras, NVR storage',
          power: 'PoE or dedicated supplies',
          interface: 'Ethernet network',
        },
        {
          system: 'Intruder Alarm',
          description: 'PIR sensors, door contacts, control panel',
          power: 'Battery-backed PSU',
          interface: 'Monitored alarm connection',
        },
        {
          system: 'Perimeter Security',
          description: 'Fence detection, vehicle barriers',
          power: 'Mains with battery backup',
          interface: 'Integration with BMS',
        },
      ],
    },
  };
  ...
  const heavyIndustryContent = {
    ...
    hvSupplies: {
      ...
      description:
        'Heavy industrial sites often have their own HV infrastructure, requiring specialised knowledge and authorisation.',
      voltages: [
        {
          level: '11kV',
          typical: 'Site primary distribution',
          notes: 'Common for larger factories, supplied by DNO or private network',
        },
        {
          level: '33kV',
          typical: 'Very large sites, grid connection',
          notes: 'Steelworks, large manufacturing, data centres',
        },
        {
          level: '132kV',
          typical: 'Major industrial complexes',
          notes: 'Direct grid connection, own substation',
        },
      ],
      equipment: [
        {
          item: 'Ring Main Units (RMU)',
          function: 'Switching and protection for HV cables',
          location: 'Each building/area intake',
        },
        {
          item: 'HV/LV Transformers',
          function: 'Step down voltage to 400V for distribution',
          location: 'Substations throughout site',
        },
        {
          item: 'HV Switchgear',
          function: 'Circuit breakers for HV protection',
          location: 'Main intake, major substations',
        },
        {
          item: 'Protection Relays',
          function: 'Overcurrent, earth fault, differential protection',
          location: 'Associated with each circuit breaker',
        },
      ],
      authorisation: [
        {
          level: 'Competent Person (HV)',
          description: 'Can carry out work under supervision of AP',
        },
        {
          level: 'Authorised Person (HV)',
          description: 'Can issue safety documents, control access',
        },
    ...
    largeMotors: {
      ...
      description:
        'Motors above 200kW require careful consideration of starting methods, protection, and power quality impact.',
      startingMethods: [
        {
    ...
    hazardousAreas: {
      ...
      description:
        'Areas where explosive atmospheres may occur require special equipment selection and installation practices. DSEAR (Dangerous Substances and Explosive Atmospheres Regulations) implements EU ATEX directives in UK law.',
      gasZones: [
        {
          zone: 'Zone 0',
          definition: 'Explosive atmosphere present continuously or for long periods',
          frequency: '>1000 hours/year',
          equipment: 'Category 1 (Ex ia, Ex ma)',
        },
        {
          zone: 'Zone 1',
          definition: 'Explosive atmosphere likely during normal operation',
          frequency: '10-1000 hours/year',
          equipment: 'Category 2 (Ex d, Ex e, Ex ib)',
        },
        {
          zone: 'Zone 2',
          definition: 'Explosive atmosphere unlikely, only in abnormal conditions',
          frequency: '<10 hours/year',
          equipment: 'Category 3 (Ex n, Ex ic)',
        },
      ],
      dustZones: [
        {
          zone: 'Zone 20',
          definition: 'Explosive dust cloud present continuously',
          frequency: '>1000 hours/year',
          equipment: 'Category 1D',
        },
        {
          zone: 'Zone 21',
          definition: 'Explosive dust cloud likely during normal operation',
          frequency: '10-1000 hours/year',
          equipment: 'Category 2D',
        },
        {
          zone: 'Zone 22',
          definition: 'Explosive dust cloud unlikely, only abnormal conditions',
          frequency: '<10 hours/year',
          equipment: 'Category 3D',
        },
      ],
      protectionTypes: [
        {
          code: 'Ex d',
          name: 'Flameproof',
          description: 'Equipment in robust enclosure that contains any internal explosion',
        },
        {
          code: 'Ex e',
          name: 'Increased Safety',
          description: 'Enhanced measures to prevent arcs, sparks, or hot surfaces',
        },
        {
          code: 'Ex i',
          name: 'Intrinsic Safety',
          description: 'Energy limited so cannot ignite - safest method',
        },
        {
          code: 'Ex n',
          name: 'Non-Sparking',
          description: 'Equipment unlikely to produce arcs in normal operation',
        },
        {
          code: 'Ex p',
          name: 'Pressurised',
          description: 'Enclosure purged and pressurised with clean air/gas',
        },
    ...
    intrinsicSafety: {
      ...
      description:
        'Intrinsic safety (Ex i) limits electrical energy so that ignition cannot occur. It is the preferred method for instrumentation in hazardous areas.',
      principles: [
      ...
      barriers: [
        {
          type: 'Zener Barrier',
          function: 'Shunt excess voltage to earth via zener diodes',
          requirements: 'Intrinsic safety earth essential',
        },
        {
          type: 'Galvanic Isolator',
          function: 'Complete electrical isolation using transformer/opto',
          requirements: 'No special earth required',
        },
      ],
      cabling: [
    ...
    earthingSystems: {
      ...
      description:
        'Industrial earthing is more complex than domestic systems, often combining multiple earthing arrangements and dealing with HV systems.',
      systems: [
        {
          type: 'TN-C-S (PME)',
  ...
  const processIndustries = {
    ...
    chemical: {
      ...
      description:
        'Chemical plants present unique electrical challenges due to corrosive atmospheres, flammable materials, and continuous process requirements.',
      considerations: [
        {
          aspect: 'Corrosive Atmospheres',
          requirements: 'GRP enclosures, stainless steel or coated fittings, special cable glands',
        },
        {
          aspect: 'Hazardous Areas',
          requirements: 'Zone classification throughout, ATEX equipment, CompEx trained staff',
        },
        {
          aspect: 'Process Continuity',
          requirements: 'Redundant supplies, UPS systems, auto-changeover schemes',
        },
        {
          aspect: 'Cleaning/Washdown',
          requirements: 'IP66/IP67 minimum, chemical-resistant seals',
        },
      ],
      equipment: [
    ...
    foodProcessing: {
      ...
      description:
        'Food processing facilities must meet stringent hygiene standards that affect electrical equipment selection and installation methods.',
      zones: [
        {
          zone: 'Production Areas',
          requirements: 'IP69K for washdown, smooth surfaces, food-safe materials',
        },
        {
          zone: 'High Care Areas',
          requirements: 'Maximum hygiene, stainless steel only, positive pressure',
        },
    ...
    pharmaceutical: {
      ...
      description:
        'Pharmaceutical manufacturing requires strict contamination control, affecting electrical installations in classified clean rooms.',
      classifications: [
        {
          class: 'Grade A',
          particles: '<3,520 (0.5um)',
          description: 'Critical zone for high-risk operations',
          electrical: 'Flush-mounted, HEPA-filtered',
        },
        {
          class: 'Grade B',
          particles: '<352,000 (0.5um)',
          description: 'Background for Grade A zones',
          electrical: 'Smooth, sealed surfaces',
        },
        {
          class: 'Grade C',
          particles: '<3,520,000 (0.5um)',
          description: 'Less critical stages',
          electrical: 'Wipeable, sealed equipment',
        },
        {
          class: 'Grade D',
          particles: '<35,200,000 (0.5um)',
          description: 'Controlled but not critical',
          electrical: 'Standard clean spec',
        },
      ],
      requirements: [
    ...
    waterTreatment: {
      ...
      description:
        'Water and wastewater treatment facilities combine electrical challenges of wet environments, pumping systems, and often remote operation.',
      areas: [
        {
          area: 'Pump Houses',
          considerations: 'Wet environment, large motors, VFD control common',
        },
        {
          area: 'Chemical Dosing',
          considerations: 'Corrosive chemicals, accurate metering, safety interlocks',
        },
        {
          area: 'Filter Galleries',
          considerations: 'Wash-down areas, valve actuation, level sensing',
        },
        { area: 'Control Building', considerations: 'SCADA systems, telemetry, instrument air' },
        {
          area: 'Remote Pumping Stations',
          considerations: 'Unattended operation, telemetry, generator standby',
        },
      ],
      typicalSystems: [
        {
          system: 'Raw Water Pumps',
          size: '50-500kW',
          control: 'VFD for flow control',
          notes: 'Duty/standby arrangement',
        },
        {
          system: 'Blowers/Aerators',
          size: '20-200kW',
          control: 'VFD for DO control',
          notes: 'Multiple units for N+1 redundancy',
        },
        {
          system: 'RAS/WAS Pumps',
          size: '10-50kW',
          control: 'VFD, flow paced',
          notes: 'Sludge handling, wear consideration',
        },
        {
          system: 'Chemical Dosing',
          size: '0.5-5kW',
          control: 'Peristaltic/diaphragm pumps',
          notes: 'Flow-proportional control',
        },
        {
          system: 'UV Disinfection',
          size: '5-50kW',
          control: 'Dose-paced with flow',
          notes: 'Lamp intensity monitoring',
        },
      ],
      control: [
  ...
  const projectTypes = [
    ...
    {
      type: 'Heavy Machinery Installation',
      complexity: 90,
      duration: '3-6 weeks',
      cost: '£40,000-£150,000',
    },
    {
      type: 'Hazardous Area Systems',
      complexity: 98,
      duration: '4-10 weeks',
      cost: '£60,000-£250,000',
    },
    {
      type: 'HV Installation (11kV)',
      complexity: 95,
      duration: '6-12 weeks',
  ...
  const safetyRequirements = [
    {
      requirement: 'ATEX Compliance',
      description: 'Explosive atmosphere protection per EU Directive 2014/34/EU',
      level: 'Critical',
    },
    {
      requirement: 'DSEAR Regulations',
      description: 'UK dangerous substances regulations - risk assessment mandatory',
      level: 'Legal',
    },
    {
      requirement: 'PUWER Compliance',
      description: 'Safe provision and use of work equipment',
      level: 'Legal',
    },
    {
      requirement: 'Arc Flash Protection',
      description: 'PPE and procedures for high-energy arc flash risk',
      level: 'Critical',
    },
    {
      requirement: 'LOLER',
      description: 'Lifting Operations and Lifting Equipment Regulations',
      level: 'Legal',
    },
    {
      requirement: 'CDM Regulations',
      description: 'Construction (Design and Management) for projects',
      level: 'Legal',
    },
  ];
  ...
  const hazardCategories = [
    {
      hazard: 'High Voltage Systems',
      risk: 'Critical',
      mitigation: 'Authorised person only, permit to work, HV PPE',
    },
    {
      hazard: 'Explosive Atmospheres',
      risk: 'Critical',
      mitigation: 'ATEX certified equipment, hot work permits, zone classification',
    },
    {
      hazard: 'Arc Flash',
      risk: 'Critical',
      mitigation: 'Incident energy calculation, appropriate PPE level, remote racking',
    },
    {
      hazard: 'Heavy Machinery',
      risk: 'High',
      mitigation: 'LOTO procedures, machine guarding, PTW system',
    },
    {
      hazard: 'Chemical Exposure',
      risk: 'Medium',
      mitigation: 'COSHH assessment, appropriate PPE, emergency procedures',
    },
    {
      hazard: 'Confined Spaces',
      risk: 'High',
      mitigation: 'Permit system, gas monitoring, rescue arrangements',
    },
  ];
    ...
    <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              {industrialBackground.premises.map((premise, idx) => (
                <div key={idx} className="bg-white/[0.06] p-3 rounded border border-white/[0.10]">
                  <h5 className="font-medium text-white text-sm mb-1">{premise.type}</h5>
                  <p className="text-xs text-white mb-2">{premise.description}</p>
                  <p className="text-xs text-white">
                    <strong>Examples:</strong> {premise.examples}
                  </p>
                </div>
              ))}
            </div>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-white/[0.10]">
                    ...
                    <th className="text-left py-2 text-white">Commercial</th>
                    <th className="text-left py-2 text-white">Industrial</th>
                  </tr>
                </thead>
                <tbody>
          ...
          {careerPaths.paths.map((path, idx) => (
            <div key={idx} className="bg-white/[0.06] p-4 rounded-lg border border-white/[0.10]">
              <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-3 mb-3">
                ...
                <Badge variant="outline" className="border-white/10 text-white text-sm self-start">
                  {path.salary}
                </Badge>
              </div>
        ...
        <CardContent className="space-y-6 p-0">
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-white/[0.10]">
                    ...
                    <th className="text-left py-2 text-white">Safety</th>
                  </tr>
                </thead>
                <tbody>
                  {manufacturingContent.productionLines.components.map((comp, idx) => (
                    <tr key={idx} className="border-b border-white/[0.10]">
                      ...
                      <td className="py-2 text-white">{comp.safety}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
          ...
          <div className="bg-white/[0.06] p-4 rounded-lg border border-white/[0.10]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              <div>
                <h5 className="text-sm font-medium text-white mb-2">MCC Components</h5>
                {manufacturingContent.mcc.components.map((comp, idx) => (
                  <div key={idx} className="text-xs text-white mb-1">
                    <span className="text-white">{comp.item}:</span> {comp.function}
                  </div>
                ))}
              </div>
              <div>
                <h5 className="text-sm font-medium text-white mb-2">Motor Starting Methods</h5>
          ...
          <div className="bg-white/[0.06] p-4 rounded-lg border border-white/[0.10]">
            ...
            <p className="text-sm text-white mb-3">
              {manufacturingContent.plcAutomation.description}
            </p>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <h5 className="text-sm font-medium text-white mb-2">PLC Components</h5>
                {manufacturingContent.plcAutomation.keyComponents.map((comp, idx) => (
                  <div key={idx} className="text-xs text-white mb-1 flex items-start gap-2">
                    ...
                    <span>
                      <span className="text-white">{comp.component}:</span> {comp.function}
                    </span>
                  </div>
                ))}
              </div>
              <div>
                <h5 className="text-sm font-medium text-white mb-2">Communication Protocols</h5>
          ...
          <div className="bg-white/[0.06] p-4 rounded-lg border border-white/[0.10]">
            ...
            <p className="text-sm text-white mb-3">
              {manufacturingContent.compressedAir.description}
            </p>
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-white/[0.10]">
                    ...
                    <th className="text-left py-2 text-white">Typical Power</th>
                    <th className="text-left py-2 text-white">Starting Method</th>
                ...
                <tbody>
                  {manufacturingContent.compressedAir.components.map((comp, idx) => (
                    <tr key={idx} className="border-b border-white/[0.10]">
                      ...
                      <td className="py-2 text-white">{comp.notes}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
              {manufacturingContent.voltages.levels.map((level, idx) => (
                <div key={idx} className="bg-white/[0.06] p-3 rounded border border-white/[0.10]">
                  ...
                  <p className="text-xs text-white">
                    <strong>Cable:</strong> {level.cable}
                  </p>
                </div>
              ))}
            </div>
      ...
      <Card variant="plain">
        ...
        <CardContent className="space-y-6 p-0">
          ...
          <div className="space-y-3">
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-white/[0.10]">
                    ...
                    <th className="text-left py-2 text-white">Efficacy</th>
                    <th className="text-left py-2 text-white">Lifespan</th>
                    <th className="text-left py-2 text-white">Startup</th>
                    <th className="text-left py-2 text-white">Dimming</th>
                  </tr>
                </thead>
                <tbody>
                  {warehousingContent.highBayLighting.comparison.map((light, idx) => (
                    <tr key={idx} className="border-b border-white/[0.10]">
                      ...
                      <td className="py-2 text-white">{light.dimming}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-3">
              <div className="bg-white/[0.06] p-3 rounded-lg border border-white/[0.10]">
                <h5 className="text-sm font-medium text-white mb-2">Control Options</h5>
                {warehousingContent.highBayLighting.controlOptions.map((opt, idx) => (
                  <div key={idx} className="text-xs text-white mb-2">
                    <span className="text-white font-medium">{opt.method}:</span> {opt.description}
                  </div>
                ))}
              </div>
              <div className="bg-white/[0.06] p-3 rounded-lg border border-white/[0.10]">
                <h5 className="text-sm font-medium text-white mb-2">Design Considerations</h5>
          ...
          <div className="bg-white/[0.06] p-4 rounded-lg border border-white/[0.10]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <h5 className="text-sm font-medium text-white mb-2">Equipment</h5>
              ...
              <div>
                <h5 className="text-sm font-medium text-white mb-2">Safety Circuits</h5>
          ...
          <div className="bg-white/[0.06] p-4 rounded-lg border border-white/[0.10]">
            ...
            <p className="text-sm text-white mb-3">
              {warehousingContent.forkliftCharging.description}
            </p>
            ...
            <div className="overflow-x-auto mb-4">
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-white/[0.10]">
                    <th className="text-left py-2 text-white">Type</th>
                    <th className="text-left py-2 text-white">Charge Time</th>
                    <th className="text-left py-2 text-white">Power</th>
                    <th className="text-left py-2 text-white">Current</th>
                  </tr>
                </thead>
                <tbody>
                  {warehousingContent.forkliftCharging.types.map((type, idx) => (
                    <tr key={idx} className="border-b border-white/[0.10]">
                      ...
                      <td className="py-2 text-white">{type.current}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
                ...
                <ul className="mt-2 space-y-1">
                  {warehousingContent.forkliftCharging.designRequirements.map((req, idx) => (
                    <li key={idx} className="flex items-start gap-2">
                      <span className="w-1 h-1 bg-white/55 rounded-full mt-2 flex-shrink-0"></span>
                      {req}
                    </li>
                  ))}
                </ul>
          ...
          <div className="bg-white/[0.06] p-4 rounded-lg border border-white/[0.10]">
            ...
            <p className="text-sm text-white mb-3">
              {warehousingContent.automatedStorage.description}
            </p>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              {warehousingContent.automatedStorage.systems.map((sys, idx) => (
                <div key={idx} className="bg-white/[0.06] p-3 rounded border border-white/[0.10]">
                  <h5 className="font-medium text-white text-sm mb-1">{sys.system}</h5>
                  <p className="text-xs text-white mb-2">{sys.description}</p>
                  <div className="text-xs">
                    <p className="text-white">
                      <strong>Power:</strong> {sys.power}
                    </p>
                    <p className="text-white">
                      <strong>Controls:</strong> {sys.controls}
                    </p>
                  </div>
                </div>
              ))}
          ...
          <div className="bg-white/[0.06] p-4 rounded-lg border border-white/[0.10]">
            ...
            <div className="bg-white/[0.06] p-3 rounded border border-white/[0.10]">
              <h5 className="text-sm font-medium text-white mb-2">Special Requirements</h5>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                {warehousingContent.coldStorage.specialRequirements.map((req, idx) => (
                  <div key={idx} className="text-xs text-white flex items-start gap-2">
                    <Thermometer className="h-3 w-3 text-white mt-0.5 flex-shrink-0" />
                    {req}
                  </div>
                ))}
              </div>
          ...
          <div className="bg-white/[0.06] p-4 rounded-lg border border-white/[0.10]">
            ...
            <p className="text-sm text-white mb-3">
              {warehousingContent.securityAccess.description}
            </p>
              ...
              {warehousingContent.securityAccess.systems.map((sys, idx) => (
                <div key={idx} className="bg-white/[0.06] p-3 rounded border border-white/[0.10]">
                  ...
                  <div className="text-xs">
                    ...
                    <p className="text-white">
                      <strong>Interface:</strong> {sys.interface}
                    </p>
                  </div>
                </div>
              ))}
      ...
      <Card variant="plain">
        ...
        <CardContent className="space-y-6 p-0">
          ...
          <div className="space-y-3">
            ...
            <Alert className="border-white/[0.12] border-l-[3px] border-l-red-500 bg-white/[0.06]">
              ...
              <AlertDescription className="text-red-200 text-sm">
                ...
                training. Only HV Authorised Persons may access HV equipment or issue safety
                documents.
              </AlertDescription>
            </Alert>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
              <div className="bg-white/[0.06] p-3 rounded-lg border border-white/[0.10]">
                <h5 className="text-sm font-medium text-white mb-2">HV Equipment</h5>
                {heavyIndustryContent.hvSupplies.equipment.map((eq, idx) => (
                  <div key={idx} className="text-xs text-white mb-2">
                    <span className="text-white font-medium">{eq.item}:</span> {eq.function}
                  </div>
                ))}
              </div>
              <div className="bg-white/[0.06] p-3 rounded-lg border border-white/[0.10]">
                <h5 className="text-sm font-medium text-white mb-2">Authorisation Levels</h5>
          ...
          <div className="bg-white/[0.06] p-4 rounded-lg border border-white/[0.10]">
            ...
            <p className="text-sm text-white mb-3">
              {heavyIndustryContent.largeMotors.description}
            </p>
              ...
              <table className="w-full text-xs">
                <thead>
                  <tr className="border-b border-white/[0.10]">
                    ...
                    <th className="text-left py-2 text-white">Motor Size</th>
                    <th className="text-left py-2 text-white">Starting Current</th>
                    <th className="text-left py-2 text-white">Advantages</th>
                    <th className="text-left py-2 text-white">Disadvantages</th>
                  </tr>
                </thead>
                <tbody>
                  {heavyIndustryContent.largeMotors.startingMethods.map((method, idx) => (
                    <tr key={idx} className="border-b border-white/[0.10]">
                      ...
                      <td className="py-2 text-white">{method.advantages}</td>
            ...
            <div className="bg-white/[0.06] p-3 rounded border border-white/[0.10]">
              <h5 className="text-sm font-medium text-white mb-2">Motor Protection Devices</h5>
              <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
                {heavyIndustryContent.largeMotors.protection.map((prot, idx) => (
                  <div key={idx} className="text-xs">
                    <span className="text-white font-medium">{prot.device}:</span>
          ...
          <div className="p-4 rounded-lg border border-white/[0.12] border-l-[3px] border-l-red-500 bg-white/[0.06]">
            ...
            <Alert className="border-red-500/50 bg-white/[0.06] mb-4">
              ...
              <AlertDescription className="text-red-200 text-sm">
                ...
                Improper installation can cause explosions resulting in fatalities.
              </AlertDescription>
            </Alert>
              ...
              <div>
                ...
                {heavyIndustryContent.hazardousAreas.gasZones.map((zone, idx) => (
                  ...
                  >
                    ...
                    <p className="text-xs text-white">
                      <strong>Equipment:</strong> {zone.equipment}
                    </p>
                  </div>
                ))}
              </div>
          ...
          <div className="bg-white/[0.06] p-4 rounded-lg border border-white/[0.10]">
            ...
            <p className="text-sm text-white mb-3">
              {heavyIndustryContent.intrinsicSafety.description}
            </p>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-white/[0.06] p-3 rounded border border-white/[0.10]">
                <h5 className="text-sm font-medium text-white mb-2">Key Principles</h5>
              ...
              <div className="bg-white/[0.06] p-3 rounded border border-white/[0.10]">
                <h5 className="text-sm font-medium text-white mb-2">Barrier Types</h5>
                {heavyIndustryContent.intrinsicSafety.barriers.map((barrier, idx) => (
                  <div key={idx} className="mb-2">
                    ...
                    <p className="text-xs text-white mt-1">{barrier.requirements}</p>
                  </div>
                ))}
              </div>
              <div className="bg-white/[0.06] p-3 rounded border border-white/[0.10]">
                <h5 className="text-sm font-medium text-white mb-2">IS Cabling</h5>
          ...
          <div className="bg-white/[0.06] p-4 rounded-lg border border-white/[0.10]">
            ...
            <p className="text-sm text-white mb-3">
              {heavyIndustryContent.earthingSystems.description}
            </p>
              ...
              {heavyIndustryContent.earthingSystems.systems.map((sys, idx) => (
                <div key={idx} className="bg-white/[0.06] p-3 rounded border border-white/[0.10]">
                  ...
                  <p className="text-xs text-white mb-1">
                    <strong>Use:</strong> {sys.use}
                  </p>
                  <p className="text-xs text-white">
                    <strong>Notes:</strong> {sys.notes}
                  </p>
                </div>
              ))}
            </div>
        ...
        <CardContent className="space-y-6 p-0">
          ...
          <div className="bg-white/[0.06] p-4 rounded-lg border border-white/[0.10]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <h5 className="text-sm font-medium text-white mb-2">Typical Equipment</h5>
          ...
          <div className="bg-white/[0.06] p-4 rounded-lg border border-white/[0.10]">
            ...
            <p className="text-sm text-white mb-3">
              {processIndustries.foodProcessing.description}
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-white/[0.06] p-3 rounded border border-white/[0.10]">
                <h5 className="text-sm font-medium text-white mb-2">Hygiene Standards</h5>
              ...
              <div className="bg-white/[0.06] p-3 rounded border border-white/[0.10]">
                <h5 className="text-sm font-medium text-white mb-2">Installation Methods</h5>
                {processIndustries.foodProcessing.installation.map((inst, idx) => (
                  <div key={idx} className="text-xs text-white mb-1 flex items-start gap-2">
                    <Wrench className="h-3 w-3 text-white mt-0.5 flex-shrink-0" />
                    {inst}
                  </div>
                ))}
              </div>
          ...
          <div className="bg-white/[0.06] p-4 rounded-lg border border-white/[0.10]">
            ...
            <p className="text-sm text-white mb-3">
              {processIndustries.pharmaceutical.description}
            </p>
            ...
            <div className="overflow-x-auto mb-4">
              <table className="w-full text-xs">
                <thead>
                  <tr className="border-b border-white/[0.10]">
                    <th className="text-left py-2 text-white">Classification</th>
                    <th className="text-left py-2 text-white">Particle Count</th>
                    <th className="text-left py-2 text-white">Description</th>
                    <th className="text-left py-2 text-white">Electrical Requirements</th>
                  </tr>
                </thead>
                <tbody>
                  {processIndustries.pharmaceutical.classifications.map((cls, idx) => (
                    <tr key={idx} className="border-b border-white/[0.10]">
                      ...
                      <td className="py-2 text-white">{cls.electrical}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-white/[0.06] p-3 rounded border border-white/[0.10]">
                <h5 className="text-sm font-medium text-white mb-2">Equipment Requirements</h5>
              ...
              <div className="bg-white/[0.06] p-3 rounded border border-white/[0.10]">
                <h5 className="text-sm font-medium text-white mb-2">Validation Requirements</h5>
                {processIndustries.pharmaceutical.validation.map((val, idx) => (
                  <div key={idx} className="text-xs text-white mb-1 flex items-start gap-2">
                    <Book className="h-3 w-3 text-white mt-0.5 flex-shrink-0" />
                    {val}
                  </div>
                ))}
              </div>
          ...
          <div className="bg-white/[0.06] p-4 rounded-lg border border-white/[0.10]">
            ...
            <p className="text-sm text-white mb-3">
              {processIndustries.waterTreatment.description}
            </p>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              <div>
                <h5 className="text-sm font-medium text-white mb-2">Treatment Areas</h5>
              ...
              <div>
                <h5 className="text-sm font-medium text-white mb-2">Control Systems</h5>
              ...
              <table className="w-full text-xs">
                <thead>
                  <tr className="border-b border-white/[0.10]">
                    ...
                    <th className="text-left py-2 text-white">Typical Size</th>
                    <th className="text-left py-2 text-white">Control</th>
                    <th className="text-left py-2 text-white">Notes</th>
                  </tr>
                </thead>
                <tbody>
                  {processIndustries.waterTreatment.typicalSystems.map((sys, idx) => (
                    <tr key={idx} className="border-b border-white/[0.10]">
                      ...
                      <td className="py-2 text-white">{sys.notes}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
      ...
      <Card variant="plain">
        <CardHeader className="p-0 pb-3">
          <div className="flex items-center gap-2">
            <CardTitle className="text-[15px] font-semibold tracking-tight text-white">
              Hazard Categories & Risk Assessment
            </CardTitle>
          </div>
        </CardHeader>
        <CardContent className="space-y-3 p-0">
          {hazardCategories.map((hazard, index) => (
            <div key={index} className="bg-white/[0.06] p-3 rounded-lg border border-white/[0.10]">
              <div className="flex items-start justify-between gap-3 mb-2">
                <h4 className="font-medium text-white">{hazard.hazard}</h4>
                <Badge
                  variant="outline"
                  className={`text-xs ${
