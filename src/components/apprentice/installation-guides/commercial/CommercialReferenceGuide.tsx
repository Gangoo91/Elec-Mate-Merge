...
const CommercialReferenceGuide = () => {
  ...
  const filteredCables = commercialCables.filter(
    (cable) =>
          ...
          <Card className="border-purple-500/30 bg-white/5">
            ...
            <CardContent className="space-y-3">
              {[
                ...
                {
                  standard: 'BS 6387:2013',
                  description:
                    'Performance requirements for cables required to maintain circuit integrity under fire conditions',
                },
                {
                  standard: 'Building Regulations Part B',
                  description: 'Fire safety requirements for commercial premises',
                },
                {
                  standard: 'Workplace Regulations 1992',
                  description: 'Health, Safety and Welfare Regulations for workplaces',
                },
                {
