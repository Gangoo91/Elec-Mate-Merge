    ...
    <div className="space-y-6">
      ...
      <Card className="border-blue-500/30 bg-elec-gray">
        ...
        <CardContent className="space-y-4">
          ...
          <p className="text-sm text-gray-300">{testSequenceOrder.description}</p>
      ...
      <Card className="border-green-500/30 bg-elec-gray">
        ...
        <CardContent className="space-y-4">
          <p className="text-sm text-gray-300">{continuityTesting.description}</p>
      ...
      <Card className="border-amber-500/30 bg-elec-gray">
        ...
        <CardContent className="space-y-4">
          <p className="text-sm text-gray-300">{insulationResistance.description}</p>
            ...
            <div className="space-y-2">
              {insulationResistance.threePhaseMethod.expectedValues.map((val, idx) => (
                <div key={idx} className="flex justify-between text-sm">
                  <span className="text-gray-300">{val.installation}</span>
      ...
      <Card className="border-purple-500/30 bg-elec-gray">
        ...
        <CardContent className="space-y-4">
          <p className="text-sm text-gray-300">{loopImpedance.description}</p>
          ...
          {loopImpedance.considerations.map((item, index) => (
            <div key={index} className="bg-purple-500/10 p-4 rounded-lg border border-purple-500/20">
              ...
              <p className="text-xs text-gray-400"><strong>Example:</strong> {item.example}</p>
            </div>
          ))}
                ...
                <tbody>
                  {loopImpedance.maxZsValues.values.map((row, idx) => (
                    <tr key={idx} className="border-b border-purple-500/20">
                      ...
                      <td className="py-2 text-gray-400 text-xs">{row.use}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
      ...
      <Card className="border-cyan-500/30 bg-elec-gray">
        ...
        <CardContent className="space-y-4">
          <p className="text-sm text-gray-300">{rcdTesting.description}</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            {rcdTesting.rcdTypes.map((rcd, index) => (
              <div key={index} className="bg-cyan-500/10 p-4 rounded-lg border border-cyan-500/20">
                ...
                <p className="text-xs text-gray-400 mb-1"><strong>Application:</strong> {rcd.application}</p>
                ...
                <tbody>
                  {rcdTesting.testResults.tests.map((test, idx) => (
                    <tr key={idx} className="border-b border-cyan-500/20">
                      ...
                      <td className="py-2 text-gray-400 text-xs">{test.notes}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
      ...
      <Card className="border-rose-500/30 bg-elec-gray">
        ...
        <CardContent className="space-y-4">
          <p className="text-sm text-gray-300">{phaseSequenceTesting.description}</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="bg-rose-500/10 p-4 rounded-lg border border-rose-500/20">
              ...
              <p className="text-xs text-gray-400 mt-2">{phaseSequenceTesting.phaseColours.note}</p>
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="border-yellow-500/30 bg-elec-gray">
        ...
        <CardContent className="space-y-4">
          <p className="text-sm text-gray-300">{emergencyLightingTesting.description}</p>
          ...
          <div className="space-y-3">
            {emergencyLightingTesting.testTypes.map((test, index) => (
              <div key={index} className="bg-yellow-500/10 p-4 rounded-lg border border-yellow-500/20">
                ...
                <p className="text-sm text-gray-300 mb-2"><strong>Requirement:</strong> {test.requirement}</p>
                ...
                <tbody>
                  {emergencyLightingTesting.centralBatterySystem.tests.map((test, idx) => (
                    <tr key={idx} className="border-b border-yellow-500/20">
                      ...
                      <td className="py-2 text-gray-400 text-xs">{test.tolerance}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
      ...
      <Card className="border-red-500/30 bg-elec-gray">
        ...
        <CardContent className="space-y-4">
          <p className="text-sm text-gray-300">{fireAlarmTesting.description}</p>
        ...
        <CardContent className="space-y-4">
          {documentationRequirements.certificates.map((cert, index) => (
            <div key={index} className="bg-purple-500/10 p-4 rounded-lg border border-purple-500/20">
                  ...
                  <div className="space-y-1">
                    {cert.sections.map((section, idx) => (
                      <div key={idx} className="text-xs">
                        ...
                        <span className="text-gray-300 ml-1">{section.content}</span>
                      </div>
                    ))}
                  </div>
                </div>
                  ...
                  <div className="space-y-1">
                    {cert.classifications.map((classification, idx) => (
                      <div key={idx} className="text-xs flex items-start gap-2">
                        ...
                        <span className="text-gray-300">{classification.meaning}</span>
                      </div>
                    ))}
                  </div>
                </div>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
                    {cert.frequencyGuide.map((item, idx) => (
                      <div key={idx} className="bg-purple-600/10 p-2 rounded border border-purple-500/30">
                        <div className="text-xs text-gray-300">{item.premises}</div>
              ...
              {'signatures' in cert && (
                <p className="text-xs text-gray-400 mt-2"><strong>Signatures:</strong> {cert.signatures}</p>
              )}
            </div>
          ))}
        </CardContent>
      ...
      <Card className="border-indigo-500/30 bg-elec-gray">
        ...
        <CardContent className="space-y-4">
          <p className="text-sm text-gray-300">{eicrRequirements.description}</p>
          ...
          <div className="bg-indigo-500/10 p-4 rounded-lg border border-indigo-500/20">
            ...
            <p className="text-xs text-gray-300 mb-3">{eicrRequirements.sampleTesting.description}</p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {testEquipment.equipment.map((equip, index) => (
              <div key={index} className="bg-amber-500/10 p-3 rounded-lg border border-amber-500/20">
                ...
                <p className="text-xs text-gray-300 mb-1"><strong>Function:</strong> {equip.function}</p>
                <p className="text-xs text-gray-300 mb-1"><strong>Requirements:</strong> {equip.requirements}</p>
                <p className="text-xs text-gray-300 mb-1"><strong>Calibration:</strong> {equip.calibration}</p>
