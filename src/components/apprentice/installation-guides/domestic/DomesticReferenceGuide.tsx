...
const DomesticReferenceGuide = () => {
        ...
        keyRegulations: [
          {
            ...
            topic: 'Scope',
            description:
              'Applies to design, erection, and verification of electrical installations',
          },
          {
            reg: '131.1-131.8',
            topic: 'Protection for safety',
            description: 'General requirements for protective measures',
          },
          {
            reg: '132.1-132.16',
            topic: 'Design',
            description: 'Characteristics of available supply, requirements of the installation',
          },
        ],
      },
      {
        ...
        keyRegulations: [
          {
            ...
            description: 'Socket outlets up to 32A require 30mA RCD (except specified exclusions)',
          },
          {
            reg: '411.3.4',
            topic: 'Additional RCD',
            description:
              '30mA RCD additional protection for AC final circuits supplying luminaires in domestic premises',
          },
          {
            reg: '411.3.2',
            topic: 'TN Disconnection',
            description:
              'Maximum disconnection times — 0.4s for final circuits up to 63A with socket-outlets or 32A fixed equipment (Table 41.1)',
          },
          {
            reg: '411.6',
            topic: 'RCD Selection',
            description: 'Type AC, A, F or B depending on load characteristics',
          },
          {
            reg: '421.1.201',
            topic: 'Consumer Units',
            description: 'Must be non-combustible material (metal) in domestic premises',
          },
          {
            reg: '443.4',
            topic: 'Surge Protection',
            description: 'SPD requirements for protection against transient overvoltages',
          },
        ],
      },
      {
        ...
        keyRegulations: [
          {
            reg: '522.6.202 / Table 52.1',
            topic: 'Cable Zones',
            description:
              'Cables concealed in walls: prescribed zones, or earthed/mechanical protection or 30mA RCD — A4:2026 relocated the detail into Table 52.1',
          },
          {
            reg: '522.8.10',
            topic: 'Buried Cables',
          ...
          },
          {
            reg: '526.3',
            topic: 'Connections',
            description: 'Every connection must be accessible for inspection and testing',
          },
          {
            reg: '543.1.3 / Table 54.7',
            topic: 'CPC Cross-section',
            description:
              'Protective conductor size by adiabatic calculation, or Table 54.7 where not calculated',
          },
          {
            reg: '542.4 / 544.1',
            topic: 'Earthing Arrangements',
            description: 'Main earthing terminal requirements',
          },
        ],
      },
      {
      ...
      },
      {
        ...
        keyRegulations: [
          ...
          { reg: '717', topic: 'Mobile Units', description: 'Mobile or transportable units' },
          {
            reg: '722',
            topic: 'EV Charging',
            description: 'Electric vehicle charging installations',
          },
        ],
      },
    ],
  ...
  const ietGuidanceNotes = {
    ...
    additionalPublications: [
      { title: 'On-Site Guide', description: 'Pocket-sized quick reference for site work' },
      {
        ...
        description: 'Part P compliance guidance',
      },
      {
        title: 'Code of Practice for EV Charging',
        description: 'Electric vehicle installation requirements',
      },
      {
        title: 'Code of Practice for Grid-Connected Solar PV',
  ...
  const competentPersonSchemes = {
    ...
    description:
      'Government-authorised schemes allowing qualified electricians to self-certify Part P compliance',
    schemes: [
      {
        name: 'NICEIC',
  ...
  const advancedScenarios = [
    {
      ...
      solutions: [
        'Surface-mounted trunking in appropriate areas',
        'Minimal intervention routes',
  ...
  const usefulReferences = [
    {
      ...
      description: 'Requirements for Electrical Installations (18th Edition, Amendment 4)',
    },
    ...
    {
      resource: 'IET Code of Practice for EV',
      description: 'Electric vehicle charging installations',
    },
  ];
    ...
    <div className="space-y-6">
              ...
              <div className="space-y-2">
                {section.keyRegulations.map((reg, idx) => (
                  <div key={idx} className="flex items-start gap-3 text-sm">
                    ...
                    <div>
                      <span className="text-white font-medium">{reg.topic}: </span>
      ...
      <Card variant="plain">
        <CardHeader className="p-0 pb-3">
          <div className="flex items-center gap-2">
            <CardTitle className="text-[15px] font-semibold tracking-tight text-white">
              {ietGuidanceNotes.title}
            </CardTitle>
          </div>
        </CardHeader>
        <CardContent className="space-y-4 p-0">
          <p className="text-sm text-white">{ietGuidanceNotes.description}</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {ietGuidanceNotes.notes.map((note, index) => (
              ...
              >
                ...
                <p className="text-xs text-white mb-2">{note.content}</p>
      ...
      <Card variant="plain">
        <CardHeader className="p-0 pb-3">
          <div className="flex items-center gap-2">
            <CardTitle className="text-[15px] font-semibold tracking-tight text-white">
              {partPRequirementsSummary.title}
            </CardTitle>
          </div>
        </CardHeader>
        <CardContent className="space-y-4 p-0">
      ...
      <Card variant="plain">
        <CardHeader className="p-0 pb-3">
          <div className="flex items-center gap-2">
            <CardTitle className="text-[15px] font-semibold tracking-tight text-white">
              {competentPersonSchemes.title}
            </CardTitle>
          </div>
        </CardHeader>
        <CardContent className="space-y-4 p-0">
          <p className="text-sm text-white">{competentPersonSchemes.description}</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {competentPersonSchemes.schemes.map((scheme, index) => (
              ...
              >
                ...
                <p className="text-xs text-white mb-2">{scheme.fullName}</p>
                <div className="mb-2">
        ...
        <CardContent className="space-y-4 p-0">
          {costEstimation.map((estimate, index) => (
            <div key={index} className="bg-white/[0.06] p-4 rounded-lg border border-white/[0.10]">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <h5 className="font-medium text-white mb-2">Cost Breakdown</h5>
                ...
                <div>
                  <h5 className="font-medium text-white mb-2">Cost Factors</h5>
                  <ul className="space-y-1">
          ...
          {regionalConsiderations.map((region, index) => (
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                <div>
                  <h5 className="font-medium text-elec-yellow mb-2">Regional Specifics</h5>
                  <ul className="space-y-1">
                ...
                <div>
                  <h5 className="font-medium text-elec-yellow mb-2">Key Contacts</h5>
                  <ul className="space-y-1">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              {usefulReferences.map((ref, idx) => (
                <div key={idx} className="flex items-start gap-2">
                  <Book className="h-4 w-4 text-white mt-0.5 flex-shrink-0" />
                  <div>
                    <span className="text-white text-sm font-medium">{ref.resource}</span>
        ...
        <CardContent className="space-y-4 p-0">
          <Alert className="border-white/[0.12] border-l-[3px] border-l-red-500 bg-white/[0.06]">
            ...
            <AlertDescription className="text-red-200">
              <strong>Critical Safety Points:</strong> These safety considerations can prevent
              serious injury or death. Never compromise on safety procedures.
            </AlertDescription>
          </Alert>
