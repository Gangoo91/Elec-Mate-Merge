  ...
  const detailedTests = [
    {
      ...
      testNumber: 1,
      purpose:
        'Verify earth continuity throughout installation and confirm R1+R2 values for Zs calculation',
      method: [
    ...
    },
    {
      ...
      expectedValues: [
        {
          measurement: 'End-to-end Line (r1)',
          typical: '0.3 - 0.8 ohm',
          note: 'Both legs same value',
        },
        {
          measurement: 'End-to-end Neutral (rn)',
          typical: '0.3 - 0.8 ohm',
          note: 'Same as r1 (tolerance 0.05)',
        },
        {
          measurement: 'End-to-end CPC (r2)',
          typical: '0.5 - 1.2 ohm',
          note: 'Higher due to smaller CPC',
        },
        {
          measurement: 'Cross-connect L-N (Step 2)',
          typical: '(r1+rn)/4 at mid-point',
          note: 'Constant around ring',
        },
        {
          measurement: 'Cross-connect L-E (R1+R2)',
          typical: '(r1+r2)/4 at mid-point',
          note: 'Record for Zs check',
        },
      ],
  ...
  const commonFaultsAndSolutions = [
    {
      ...
      symptoms: [
        'Zs exceeds maximum for protective device',
        "Calculated and measured Zs don't match",
      ],
      causes: [
    ...
    },
    {
      ...
      symptoms: [
        'RCD trips randomly',
        'RCD trips when specific appliances used',
        'Trip on startup',
      ],
      causes: [
    ...
    },
    {
      ...
      symptoms: [
        'Inconsistent end-to-end readings',
        'Cross-connect readings not constant',
    ...
    certificates: [
      {
        ...
        signatures:
          'Three signatures required: Designer, Constructor, Inspector/Tester (can be same person)',
      },
      {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {testEquipmentCalibration.equipment.map((equip, index) => (
              ...
              >
                ...
                {'voltage' in equip && (
                  <p className="text-xs text-white mb-1">
                    <strong>Voltage:</strong> {equip.voltage}
                  </p>
                )}
                {'accuracy' in equip && (
                  <p className="text-xs text-white mb-1">
                    <strong>Accuracy:</strong> {equip.accuracy}
                  </p>
                )}
                {'features' in equip && (
                  <p className="text-xs text-white mb-1">
                    <strong>Features:</strong> {equip.features}
                  </p>
                )}
