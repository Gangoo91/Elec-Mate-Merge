...
import { Zap, Calculator, Shield, Ruler, Info, AlertTriangle, Cable, Gauge } from 'lucide-react';
...
const DomesticCircuitGuide = () => {
  const circuitTypes = [
    {
      ...
      advantages: [
        'Lower voltage drop',
        'Continuity of supply if cable fault',
    ...
    },
    {
      ...
      disadvantages: [
        ...
        'Requires diversity calculation',
  ...
  const cableSizingTable = {
    ...
    description:
      'Current-carrying capacity for common domestic cable sizes installed using Reference Method C (clipped direct)',
    cables: [
      {
        size: '1.0mm²',
        method_c: '15A',
      ...
      },
      {
        ...
        method_c: '20A',
        method_a: '14.5A',
        typical_use: 'Lighting, small radials',
        vd_per_m: '29mV/A/m',
      },
      {
        size: '2.5mm²',
        method_c: '27A',
        method_a: '20A',
        typical_use: 'Ring circuits, radial sockets',
        vd_per_m: '18mV/A/m',
      },
      {
        size: '4mm²',
        method_c: '37A',
        method_a: '27A',
        typical_use: 'Showers up to 9kW, submains',
        vd_per_m: '11mV/A/m',
      },
      {
        size: '6mm²',
        method_c: '47A',
        method_a: '34A',
        typical_use: 'Cookers, large showers, EV',
        vd_per_m: '7.3mV/A/m',
      },
      {
        size: '10mm²',
        method_c: '65A',
        method_a: '46A',
        typical_use: 'High power cookers, submains',
        vd_per_m: '4.4mV/A/m',
      },
      {
        size: '16mm²',
    ...
    installationMethods: [
      ...
      {
        method: '100',
        description: 'Enclosed in thermal insulation (requires significant derating)',
      },
  ...
  const maxCableLengths = {
    ...
    description:
      'Maximum lengths based on voltage drop limits (3% lighting, 5% power) at full load',
    limits: [
      {
        circuit: 'Ring 32A (2.5mm²)',
        lighting: 'N/A',
        power: '106m total',
        notes: 'Both legs combined',
      },
      {
        circuit: 'Radial 20A (2.5mm²)',
        lighting: 'N/A',
        power: '56m',
        notes: 'Single run from CU',
      },
      {
        circuit: 'Radial 32A (4mm²)',
        lighting: 'N/A',
        power: '64m',
        notes: 'For high-load radials',
      },
      { circuit: 'Lighting 6A (1.0mm²)', lighting: '26m', power: 'N/A', notes: 'Per circuit leg' },
      {
        circuit: 'Lighting 6A (1.5mm²)',
        lighting: '38m',
        power: 'N/A',
        notes: 'Extended circuits',
      },
      ...
      <Card variant="plain">
        ...
        <CardContent className="space-y-4 p-0">
          ...
          <div className="bg-white/[0.06] p-4 rounded-lg border border-white/[0.10]">
            ...
            <Alert className="border-white/[0.12] border-l-[3px] border-l-red-500 bg-white/[0.06] mt-3">
        ...
        <CardContent className="space-y-4 p-0">
          ...
          <div className="bg-white/[0.06] p-4 rounded-lg border border-white/[0.10]">
            ...
            <p className="text-sm text-white mb-3">
              {earthingConsiderations.adiabatic.description}
            </p>
