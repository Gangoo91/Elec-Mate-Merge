import { AlertTriangle, Eye, MessageSquare, HelpCircle, ShieldX, Globe } from 'lucide-react';
...
export const cultureModules: CultureModule[] = [
  {
    ...
    content: {
      overview:
        'Every electrician has the right and responsibility to raise safety concerns. This module helps you develop the skills to address issues effectively without creating conflict.',
      keyPoints: [
      ...
      examples: [
        ...
        },
        {
          ...
          rightApproach:
            '"Hey mate, I\'ve got a spare harness in the van. The regs require fall protection above 2 meters - we could both get in trouble if someone sees this."',
          wrongApproach:
            '"You\'re breaking the rules and being stupid. You\'ll fall and hurt yourself."',
        },
        {
          ...
          wrongApproach:
            "Staying silent because you're new, or publicly criticizing the entire site's safety culture",
        },
      ],
      checklist: [
      ...
      questions: [
        {
          ...
          answer:
            "If your immediate supervisor ignores a legitimate safety concern, you should document the concern and follow your company's escalation procedure. This might involve speaking to a higher manager, safety officer, or union representative. In cases of serious and imminent danger, you have the legal right to refuse unsafe work.",
        },
        {
  ...
  },
  {
    ...
    content: {
      overview:
        "Worksite communication isn't just verbal. Understanding body language helps you navigate relationships and identify potential issues before they escalate.",
      keyPoints: [
      ...
      resources: [
        ...
        },
        {
          ...
          type: 'audio',
          description:
            'Audio guide for understanding non-verbal communication across different cultures',
        },
      ],
      questions: [
        {
        ...
        {
          question:
            "What body language should I use when I'm trying to assert myself as a new apprentice?",
          answer:
  ...
  },
  {
    ...
    content: {
      overview:
        "Banter is common on construction sites, but there's a line between friendly jokes and harassment. This module helps you navigate this balance and respond appropriately.",
      keyPoints: [
      ...
      examples: [
        ...
        {
          situation:
            "A colleague is being targeted with uncomfortable 'jokes' about their background",
          rightApproach:
        ...
        },
        {
          ...
          wrongApproach:
            "Participating despite your concerns because you fear being labeled as 'no fun'",
        },
      ],
      checklist: [
      ...
      resources: [
        ...
        },
        {
          ...
          type: 'audio',
          description:
            'Audio roleplay showing the difference between acceptable banter and bullying',
        },
      ],
      questions: [
        {
  ...
  },
  {
    ...
    content: {
      overview:
        'Everyone has knowledge gaps, especially apprentices. Learning how to ask for help effectively is a crucial skill that improves your learning and prevents mistakes.',
      keyPoints: [
      ...
      examples: [
        {
          ...
          wrongApproach:
            "Nodding and saying 'yes' despite confusion, then doing the task incorrectly",
        },
        {
        ...
        },
        {
          ...
          wrongApproach:
            'Proceeding without clarification and making assumptions about unclear parts',
        },
      ],
      resources: [
        {
  ...
  },
  {
    ...
    content: {
      overview:
        'All workers have the legal right to refuse unsafe work. This module covers how to exercise this right professionally while maintaining good workplace relationships.',
      keyPoints: [
      ...
      examples: [
        ...
        },
        {
          ...
          wrongApproach:
            "Attempting work you're not qualified for, or walking off without explanation",
        },
        {
          ...
          wrongApproach:
            'Using it anyway despite the risk, or refusing without offering any solution',
        },
        {
          situation: 'Told to skip important safety tests to save time',
          rightApproach:
            '"I understand we\'re under time pressure, but these tests are required by BS7671. If we skip them and something goes wrong, we could be legally liable. I can work through lunch to make up the time."',
          wrongApproach:
  ...
  },
  {
    ...
    content: {
      overview:
        'The electrical industry is increasingly diverse. Understanding cultural differences helps create a more respectful, inclusive, and effective workplace for everyone.',
      keyPoints: [
      ...
      examples: [
        {
          ...
          rightApproach:
            'Recognize this may be a sign of respect in their culture, not disinterest. Focus on their overall engagement and communication.',
          wrongApproach:
        ...
        },
        {
          ...
          rightApproach:
            '"Let me show you what I mean," then demonstrating the technique or drawing a diagram. Checking understanding with follow-up questions.',
          wrongApproach:
        ...
        },
        {
          ...
          rightApproach:
            'Explaining the chain of command clearly while still encouraging questions and input regardless of seniority',
          wrongApproach:
        ...
        },
        {
          ...
          rightApproach:
            'Learn to recognize different styles. Some cultures value direct communication while others prefer indirect approaches to avoid potential conflict or loss of face.',
          wrongApproach:
