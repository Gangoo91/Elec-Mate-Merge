...
const REAL_ASSESSMENTS = [
  {
    ...
    type: 'Written',
    description:
      'Knowledge test covering current UK wiring regulations and electrical safety requirements',
  },
  {
    ...
    type: 'Practical',
    description:
      'Practical assessment of inspection and testing procedures using calibrated test equipment',
  },
  {
    ...
    type: 'Written',
    description:
      'Written examination on initial verification procedures and certification requirements',
  },
  {
  ...
  },
  {
    ...
    type: 'Portfolio',
    description:
      'Portfolio assessment covering electrical installation principles and construction methods',
  },
  {
  ...
  },
  {
    ...
    type: 'Written',
    description:
      'Design project assessment covering electrical installation design and calculations',
  },
];
      ...
      <DialogContent className="sm:max-w-[600px] bg-white/5 border-elec-yellow/20">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            <Label htmlFor="template" className="text-elec-light">
              Quick Select (Common Electrical Assessments)
            </Label>
            <Select
                ...
                {REAL_ASSESSMENTS.map((assessment) => (
                  ...
                  >
                    <div className="flex flex-col">
                      ...
                      <span className="text-xs text-elec-light/70">
                        {assessment.unitCode} • {assessment.type}
                      </span>
                    </div>
                  </SelectItem>
                ))}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="unitCode" className="text-elec-light">
                Unit/Course Code
              </Label>
              <Input
                id="unitCode"
          ...
          <div className="space-y-2">
            <Label htmlFor="type" className="text-elec-light">
              Assessment Type *
            </Label>
          ...
          <div className="space-y-2">
            <Label htmlFor="description" className="text-elec-light">
              Description
            </Label>
            <Textarea
              id="description"
          ...
          <div className="space-y-2">
            ...
            <Popover>
              ...
              <PopoverContent
                className="w-auto p-0 bg-white/10 border-elec-yellow/20"
                align="start"
              >
                <Calendar
                  mode="single"
