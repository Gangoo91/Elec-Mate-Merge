      ...
      0: [
        {
          ...
          content:
            'Part 4 covers protection against electric shock, thermal effects, overcurrent, voltage disturbances, and electromagnetic influences. Chapter 41 (shock protection) is heavily tested - know the difference between basic protection and fault protection.',
          icon: BookOpen,
          difficulty: 'Developing',
          actionStep: 'Read Chapter 41 and list the 5 methods of fault protection',
          regulation: 'Part 4: Protection for Safety',
          proTip:
            "Create flashcards for each chapter's key requirements - they're gold dust for revision",
        },
        {
          id: 'sun2',
          category: 'Theory',
          ...
          content:
            'Resistance (R) opposes DC current. Impedance (Z) opposes AC current and includes resistance plus reactance. For most domestic work, the difference is negligible, but in larger installations with longer cable runs, inductance matters.',
          icon: Calculator,
          difficulty: 'Competent',
          actionStep: 'Calculate Ze + (R1+R2) for a circuit and compare with measured Zs',
          proTip:
            "When your calculated and measured Zs don't match, temperature correction is usually why",
        },
        {
          id: 'sun3',
          category: 'Exam Prep',
          ...
          content:
            'The 2391 requires you to understand not just HOW to test, but WHY. Know the purpose of each test, the expected results, and what faults each test identifies.',
          icon: Target,
          difficulty: 'Expert',
      ...
      1: [
        {
          ...
          content:
            'Your voltage indicator MUST meet GS38 requirements: fused probes (max 500mA), shrouded probes with max 4mm exposed tip, finger barriers, and insulated leads. Test on known live source before AND after isolation.',
          icon: AlertTriangle,
          difficulty: 'Foundation',
          actionStep:
            'Inspect your voltage indicator against GS38 checklist - replace if non-compliant',
          regulation: 'HSE GS38',
          proTip:
            "Proving units are brilliant - they let you prove your tester works even when you can't find a known live source",
        },
        {
          id: 'mon2',
          category: 'PPE',
          ...
          content:
            "For live working (which should be rare), use insulated gloves rated to the voltage you're working with. Class 00 for up to 500V AC. But here's the thing - if you need gloves, ask yourself if you should be working live at all.",
          icon: Shield,
          difficulty: 'Developing',
          actionStep:
            "Check your PPE kit - ensure you have Class 00 gloves and they're within test date",
        ...
        },
        {
          ...
          content:
            'Your written RA is just the start. On site, constantly reassess: Has anything changed? Are there new hazards? Is the isolation still secure? Never assume - verify.',
          icon: Brain,
          difficulty: 'Competent',
          actionStep:
            "Before each task today, spend 30 seconds identifying hazards that weren't on the original RA",
          proTip:
            "Take photos of isolation points - if someone questions your isolation, you've got evidence",
        },
      ],
      2: [
        {
          ...
          content:
            "Voltage drop = (mV/A/m × Ib × L) ÷ 1000. The mV/A/m value comes from Appendix 4. For 2.5mm² T&E it's 18mV/A/m. Keep total drop under 5% (11.5V) with max 3% (6.9V) on final circuits.",
          icon: Calculator,
          difficulty: 'Developing',
          actionStep: 'Calculate: 32A ring, 25m route, 2.5mm² T&E. Is it compliant?',
          regulation: 'Appendix 4, Table 4Ab',
          proTip:
            'Always calculate for the worst case - full design current, not what you expect in practice',
        },
        {
          id: 'tue2',
          category: 'Design',
          ...
          content:
            'It × Ca × Cg × Ci × Cc ≥ Ib. Thermal insulation (Ci) is the killer - cables enclosed in insulation can only carry 0.5 times their normal current. Check EVERY factor.',
          icon: Zap,
          difficulty: 'Competent',
          actionStep:
            'Find a job with grouped cables and calculate the correct Cg factor from Table 4C1',
        ...
        },
        {
          ...
          content:
            "For a 32A Type B MCB on a TN system, max Zs is 1.37Ω. But that's at operating temperature. If testing cold, apply 0.8 multiplier to your reading, or use 80% of table value as your limit.",
          icon: Calculator,
          difficulty: 'Competent',
      ...
      3: [
        {
          ...
          content:
            'Support cables every 300mm horizontally, 400mm vertically. At accessories, leave 150mm service loop. Label every cable at both ends. Your installation will be inspected for 20+ years.',
          icon: Wrench,
          difficulty: 'Foundation',
          actionStep:
            'Check your last installation against these standards - would it pass scrutiny?',
        ...
        },
        {
          ...
          content:
            "Strip outer sheath 50mm minimum. Use proper gland - indoor or outdoor rated as needed. Earth tag under gland locknut. Torque to spec, not just 'tight'.",
          icon: Wrench,
          difficulty: 'Developing',
          actionStep:
            'Practice SWA termination on scrap cable until you can do it cleanly in under 10 minutes',
        ...
        },
        {
          ...
          content:
            'Metal consumer units are now standard (Regulation 421.1.201). All circuits need RCD protection via RCBO or split-load. Keep Type A RCBOs for circuits with electronic equipment.',
          icon: Zap,
          difficulty: 'Developing',
      ...
      4: [
        {
          ...
          content:
            "Dead tests first (continuity, IR), then live tests (Zs, RCD). This isn't arbitrary - you need to verify insulation resistance before applying voltage, and earth continuity before checking Zs.",
          icon: Zap,
          difficulty: 'Foundation',
          actionStep: 'Write out the full testing sequence from memory, then check against GN3',
          regulation: 'GN3 - Inspection & Testing',
          proTip:
            "Create a laminated checklist for your toolbag - it's not cheating, it's professional",
        },
        {
          id: 'thu2',
          category: 'Continuity',
          ...
          content:
            "Three readings: L-L, N-N, CPC-CPC should be roughly equal. Then cross-connect and test at each socket. All readings should be virtually identical. If not, you've got a fault.",
          icon: Calculator,
          difficulty: 'Developing',
          actionStep:
            'Draw a ring circuit diagram showing the cross-connection method - understand WHY it works',
        ...
        },
        {
          ...
          content:
            'Test at 50%, 100%, and 5x rated current. 30mA RCD: 15mA should NOT trip, 30mA must trip <300ms, 150mA must trip <40ms. Document all readings.',
          icon: Zap,
          difficulty: 'Competent',
      ...
      5: [
        {
          ...
          content:
            'Quality over quantity. One well-documented job with before/during/after photos, sketches, and clear explanation of your decision-making beats ten quick snaps.',
          icon: Target,
          difficulty: 'Foundation',
          actionStep:
            'Review your last portfolio entry - does it show your thought process or just the result?',
        ...
        },
        {
          ...
          content:
            'After your apprenticeship: 2391 (Inspection & Testing), 2 years experience, then consider Qualified Supervisor route. Need to demonstrate design, installation, inspection AND supervision competence.',
          icon: Trophy,
          difficulty: 'Competent',
          actionStep:
            'Research the QS requirements for your preferred scheme (NICEIC/NAPIT/ELECSA)',
        ...
        },
        {
          ...
          content:
            'Domestic is steady but competitive. Commercial and industrial pay more but have longer travel. Specialist areas (fire alarm, data, EV charging, solar PV) can command premium rates.',
          icon: Brain,
          difficulty: 'Developing',
          actionStep:
            'Speak to three qualified electricians in different sectors about their career paths',
        },
      ],
      6: [
        {
          ...
          content:
            'EV charging is booming. Requirements: dedicated circuit, RCD Type A minimum, PME earthing considerations, max Zs 0.35Ω for TN systems. The 2919 qualification is specifically for EV installation.',
          icon: Zap,
          difficulty: 'Developing',
        ...
        },
        {
          ...
          content:
            'More clients want smart switches, automated lighting, and integrated systems. Understanding protocols (Zigbee, Z-Wave, WiFi), neutral requirements for smart switches, and basic networking makes you more valuable.',
          icon: Brain,
          difficulty: 'Competent',
          actionStep:
            'Install a smart switch in your own home - understand the neutral wire requirement',
        ...
        },
        {
          ...
          content:
            'Technical skill gets you hired once. Communication gets you rehired and recommended. Explain work in terms customers understand. Under-promise, over-deliver. Leave sites clean.',
          icon: Target,
          difficulty: 'Developing',
          actionStep:
            'Practice explaining earthing to a non-technical person using the water analogy',
        },
      ],
    };
