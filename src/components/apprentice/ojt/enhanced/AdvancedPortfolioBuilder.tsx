          ...
          {templates.map((template) => (
            ...
            >
              <CardContent className="p-4 text-center">
                ...
                <div className="text-xs">{template.sections.length} sections included</div>
              </CardContent>
            </Card>
          ))}
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <Select
                ...
                onValueChange={(value) =>
                  setPortfolioEntry((prev) => ({ ...prev, category: value }))
                }
              >
                <SelectTrigger>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <Select
                value={portfolioEntry.unit}
                onValueChange={(value) => setPortfolioEntry((prev) => ({ ...prev, unit: value }))}
              >
                <SelectTrigger>
                  <SelectValue placeholder="Select unit" />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="unit-301">
                    Unit 301 - Understanding electrical installation
                  </SelectItem>
                  <SelectItem value="unit-302">
                    Unit 302 - Understanding electrical science
                  </SelectItem>
                  <SelectItem value="unit-303">
                    Unit 303 - Understanding electrical safety
                  </SelectItem>
                  <SelectItem value="unit-304">
                    Unit 304 - Understanding electrical systems
                  </SelectItem>
                </SelectContent>
              </Select>
            </div>
            ...
            <div>
              ...
              <Select
                value={portfolioEntry.skillsArea}
                onValueChange={(value) =>
                  setPortfolioEntry((prev) => ({ ...prev, skillsArea: value }))
                }
              >
                <SelectTrigger>
          ...
          <div>
            ...
            <Textarea
              ...
              onChange={(e) =>
                setPortfolioEntry((prev) => ({ ...prev, description: e.target.value }))
              }
              rows={4}
              required
            />
          ...
          <div>
            ...
            <Textarea
              ...
              onChange={(e) =>
                setPortfolioEntry((prev) => ({ ...prev, learningOutcomes: e.target.value }))
              }
              rows={3}
            />
          </div>
          ...
          <div>
            ...
            <Textarea
              ...
              onChange={(e) =>
                setPortfolioEntry((prev) => ({ ...prev, reflection: e.target.value }))
              }
              rows={3}
            />
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  setPortfolioEntry((prev) => ({ ...prev, dateCompleted: e.target.value }))
                }
              />
            </div>
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  setPortfolioEntry((prev) => ({ ...prev, timeSpent: e.target.value }))
                }
              />
            </div>
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  setPortfolioEntry((prev) => ({ ...prev, witnesses: e.target.value }))
                }
              />
            </div>
          </div>
          ...
          <Card>
            <CardHeader>
              ...
              <p className="text-sm text-white">
                Choose from pre-built templates to ensure your portfolio meets qualification
                standards
              </p>
            </CardHeader>
            <CardContent>
