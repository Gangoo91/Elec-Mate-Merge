    ...
    <div className="space-y-3 animate-fade-in">
      <div className="p-3 rounded-lg bg-purple-500/10 border border-purple-500/20">
        <p className="text-sm text-white">
          <span className="font-semibold text-purple-300">Suppliers & Budget</span> — Where to buy
          your tools and materials at the best prices. Open trade accounts early — the savings add
          up fast over your career.
        </p>
      </div>
              ...
              <div className="pt-3 space-y-3">
                ...
                {section.id === 'buying-guide' &&
                  buyingGuides.map((guide) => (
                    ...
                    >
                      <h4 className="text-sm font-semibold text-white">{guide.category}</h4>
                      ...
                      <p className="text-xs text-white leading-relaxed">{guide.tip}</p>
                    </div>
                  ))}
