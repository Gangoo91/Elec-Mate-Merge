...
const resources: Resource[] = [
  // BS7671 Resources
  {
    ...
    title: 'BS 7671:2018+A4:2026 (18th Edition)',
  ...
  {
    id: 'on-site-guide',
    title: 'IET On-Site Guide (BS 7671:2018+A4:2026)',
  ...
  },
  {
    ...
    description:
      'Guide to personal protective equipment required for different types of electrical testing',
    type: 'document',
    category: 'Safety',
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-3">
            {Object.keys(groupedResources).map((category) => {
              ...
              return (
                <div
                  key={category}
                  className="p-4 rounded-xl bg-white/10 border border-white/10 text-center hover:border-white/20 transition-colors"
                >
                  <div
                    className={`p-2.5 rounded-lg ${config.bg} border ${config.border} inline-block mb-2`}
                  >
        ...
        return (
          <div key={category} className="space-y-4">
            <div className="flex items-center gap-3">
              <div
                className={`p-2.5 rounded-xl ${categoryConfig.bg} border ${categoryConfig.border}`}
              >
                  ...
                  >
                    ...
                    <CardHeader className="pb-3 relative">
                      <div className="flex items-start gap-3">
                        <div
                          className={`p-2.5 rounded-xl ${typeConfig.bg} border ${typeConfig.border} flex-shrink-0`}
                        >
