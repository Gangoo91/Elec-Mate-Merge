...
import { Book, Clock, AlertTriangle, Lightbulb, CheckCircle, ArrowRight, Target } from "lucide-react";
      ...
      <Card className="border-cyan-500/30 bg-gradient-to-br from-cyan-500/10 to-blue-500/10">
        <CardHeader>
          <CardTitle className="text-cyan-400 flex items-center gap-2">
            ...
            BS7671 Testing Guides
          </CardTitle>
        </CardHeader>
        <CardContent>
          <p className="text-muted-foreground mb-4">
            Comprehensive, step-by-step testing procedures following BS 7671 requirements. Each guide includes 
            detailed instructions, safety warnings, troubleshooting tips, and regulation references to ensure 
            compliant and safe testing practices.
          </p>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-3">
                ...
                {guide.testLimits.length > 0 && (
                  <div className="bg-green-500/10 rounded-lg p-3 border border-green-500/20">
                    ...
                    <div className="space-y-1">
                      {guide.testLimits.slice(0, 2).map((limit, index) => (
                ...
                <div className="bg-purple-500/10 rounded-lg p-3 border border-purple-500/20">
                  <h4 className="font-medium text-purple-300 mb-2">Guide Features</h4>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                ...
                <li>• Check environmental conditions are suitable</li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                ...
                <li>• Follow the testing sequence as specified in BS 7671</li>
              </ul>
            </div>
          </div>
        </CardContent>
