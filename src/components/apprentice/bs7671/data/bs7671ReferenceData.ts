...
export const bs7671ReferenceCards: BS7671ReferenceCard[] = [
  ...
  },
  {
    ...
    content: {
      ...
      groups: [
        ...
        {
          heading: 'Max Zs \u2014 Type B MCB at 0.4s (Table 41.3)',
          rows: [
            { label: '6A', value: '7.67 \u03A9 (measured: 6.13 \u03A9)' },
            { label: '10A', value: '4.60 \u03A9 (measured: 3.68 \u03A9)' },
            { label: '16A', value: '2.87 \u03A9 (measured: 2.30 \u03A9)' },
            { label: '20A', value: '2.30 \u03A9 (measured: 1.84 \u03A9)' },
            { label: '32A', value: '1.44 \u03A9 (measured: 1.15 \u03A9)' },
            { label: '40A', value: '1.15 \u03A9 (measured: 0.92 \u03A9)' },
            { label: '50A', value: '0.92 \u03A9 (measured: 0.73 \u03A9)' },
          ],
        },
      ],
    },
  ...
  },
  {
    ...
    content: {
      ...
      groups: [
        {
          heading: 'Type B MCB (BS EN 60898) \u2014 0.4s',
          rows: [
            { label: '6A', value: '7.67 \u03A9' },
            { label: '10A', value: '4.60 \u03A9' },
            { label: '16A', value: '2.87 \u03A9' },
            { label: '20A', value: '2.30 \u03A9' },
            { label: '32A', value: '1.44 \u03A9' },
            { label: '40A', value: '1.15 \u03A9' },
            { label: '50A', value: '0.92 \u03A9' },
          ],
        },
        {
          heading: 'Type C MCB (BS EN 60898) \u2014 0.4s',
          rows: [
            { label: '6A', value: '3.83 \u03A9' },
            { label: '10A', value: '2.30 \u03A9' },
            { label: '16A', value: '1.44 \u03A9' },
            { label: '20A', value: '1.15 \u03A9' },
            { label: '32A', value: '0.72 \u03A9' },
            { label: '40A', value: '0.57 \u03A9' },
            { label: '50A', value: '0.46 \u03A9' },
          ],
        },
        {
          heading: 'BS 3036 Fuse \u2014 0.4s',
          rows: [
            { label: '5A', value: '10.07 \u03A9' },
            { label: '15A', value: '2.67 \u03A9' },
            { label: '20A', value: '1.85 \u03A9' },
            { label: '30A', value: '1.14 \u03A9' },
            { label: '45A', value: '0.62 \u03A9' },
          ],
        },
      ],
    },
