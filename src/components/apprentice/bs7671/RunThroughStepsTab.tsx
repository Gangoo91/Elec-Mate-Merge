...
const RunThroughStepsTab = () => {
  ...
  const getDifficultyColor = (difficulty: string) => {
    switch (difficulty) {
      ...
      default:
        return 'bg-white/[0.06] text-blue-400 border-blue-500/20';
    }
  };
        ...
        {filteredTests.map((test) => (
          ...
          >
              ...
              <div className="flex items-start justify-between gap-4">
                <div className="space-y-3 flex-1">
                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    <Badge className="bg-white/[0.06] text-blue-400 border border-blue-500/30">
            ...
            <CardContent className="space-y-3 relative">
              ...
              <div className="p-3 rounded-xl bg-white/[0.06] border border-purple-500/20">
      ...
      {filteredTests.length === 0 && (
        <Card className="bg-gradient-to-br from-white/5 to-elec-card border-orange-500/20 overflow-hidden relative">
          ...
          <CardContent className="text-center py-12 relative">
            <div className="p-4 rounded-xl bg-white/[0.06] inline-block mb-4">
