      ...
      <div className="rounded-xl border border-white/[0.10] bg-white/[0.06] p-4 sm:p-5 space-y-3">
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between gap-2 flex-wrap">
            <span className="text-[14px] text-white leading-relaxed">Origin (consumer unit)</span>
            <Pill>Measure Ze</Pill>
          </div>
          <div className="flex items-center justify-between gap-2 flex-wrap">
            <span className="text-[14px] text-white leading-relaxed">Each socket outlet</span>
            <Pill>Measure Zs</Pill>
          </div>
          <div className="flex items-center justify-between gap-2 flex-wrap">
            <span className="text-[14px] text-white leading-relaxed">Fixed equipment</span>
            <Pill>Measure Zs</Pill>
          </div>
          <div className="flex items-center justify-between gap-2 flex-wrap">
            <span className="text-[14px] text-white leading-relaxed">Distribution boards</span>
            <Pill>Measure Zs</Pill>
          </div>
        </div>
      </div>
