        ...
        <CardContent className="relative">
          <div className="space-y-4">
            {progressionMilestones.map((milestone, index) => (
              <div
                key={index}
                className="p-5 rounded-xl bg-blue-500/5 border border-blue-500/20 hover:border-blue-500/40 transition-all"
              >
        ...
        <CardContent className="relative">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {maintenanceSchedule.map((item, index) => (
              <div
                key={index}
                className="p-4 rounded-xl bg-green-500/5 border border-green-500/20 hover:border-green-500/40 transition-all"
              >
