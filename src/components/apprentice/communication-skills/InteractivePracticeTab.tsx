        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-white">
            <div>
              ...
              <p>
                Set aside 15-20 minutes daily to practice communication scenarios. Consistency
                builds confidence and natural responses.
              </p>
            </div>
            <div>
              <h4 className="font-medium text-white mb-2">Record Yourself</h4>
              <p>
                Use your phone to record practice sessions. Listen back to identify areas for
                improvement in tone and clarity.
              </p>
            </div>
            <div>
              <h4 className="font-medium text-white mb-2">Get Feedback</h4>
              <p>
                Practice with colleagues, friends, or family. Ask for honest feedback on your
            ...
            <div>
              ...
              <p>
                Apply what you've practiced in real situations. Start with low-stakes conversations
                and build up to more complex interactions.
              </p>
            </div>
          </div>
        </CardContent>
