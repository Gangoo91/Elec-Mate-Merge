              ...
              return (
                ...
                >
                  <div className="flex items-start gap-3">
                    <div
                      className={`p-2 rounded-lg bg-gradient-to-br ${getColorConfig('green').iconBg} flex-shrink-0`}
                    >
                  ...
                  <Badge
                    className={`${priorityConfig.bg} ${priorityConfig.text} border ${priorityConfig.border}`}
                  >
                    {test.priority}
                  </Badge>
                </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-white/70">
                ...
                <span className="font-medium text-orange-300">BS 7671</span> and relevant building
                regulations.
              </p>
            </div>
          </div>
