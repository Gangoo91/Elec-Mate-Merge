...
const ElectricalSymbolsDisplay = ({ subsectionId }: ElectricalSymbolsDisplayProps) => {
  ...
  const symbols = [
    {
      ...
      category: 'switches',
      symbol: 'S₁',
      description: 'Controls a single circuit from one location',
    },
    {
      id: 2,
      name: 'Two-way Switch',
      category: 'switches',
      symbol: 'S₂',
      description: 'Controls a circuit from two locations',
    },
    {
      id: 3,
      ...
      category: 'switches',
      symbol: 'SI',
      description: 'Used with two-way switches for control from 3+ positions',
    },
    {
      id: 4,
      ...
      category: 'outlets',
      symbol: '⏣',
      description: 'BS 1363 13A socket outlet, unswitched',
    },
    {
      id: 5,
      name: 'Switched Socket Outlet',
      category: 'outlets',
      symbol: '⏣̷',
      description: 'BS 1363 13A socket outlet with switch',
    },
    {
      id: 6,
      ...
      category: 'outlets',
      symbol: '⌶',
      description: 'Fused connection unit for fixed appliances',
    },
    {
      id: 7,
      name: 'Ceiling Rose',
      category: 'lighting',
      symbol: '⊙',
      description: 'Connection point for pendant lighting',
    },
    {
      id: 8,
      name: 'Lighting Point',
      category: 'lighting',
      symbol: '⦻',
      description: 'General lighting outlet point',
    },
    {
      id: 9,
    ...
    },
    {
      ...
      symbol: '□',
      description: 'Consumer unit or distribution board',
    },
    {
      id: 11,
      name: 'Main Switch',
      category: 'distribution',
      symbol: '⊗',
      description: 'Main isolator or switch',
    },
    {
      id: 12,
    ...
    },
    {
      ...
      category: 'protection',
      symbol: '⏚',
      description: 'Earth connection point',
    },
    {
      id: 16,
      name: 'Pull Switch',
      category: 'switches',
      symbol: 'S↓',
      description: 'Ceiling mounted pull cord switch',
    },
  ];

  const filteredSymbols =
    selectedCategory === 'all' ? symbols : symbols.filter((s) => s.category === selectedCategory);

  // Helper function to render icon based on category
  const renderCategoryIcon = (category: string) => {
    switch (category) {
      case 'switches':
        return <Bolt className="h-5 w-5 mr-2" />;
      case 'outlets':
        return <Plug className="h-5 w-5 mr-2" />;
      case 'lighting':
        return <Lightbulb className="h-5 w-5 mr-2" />;
      case 'distribution':
        return <Cable className="h-5 w-5 mr-2" />;
      case 'protection':
        return <ShieldAlert className="h-5 w-5 mr-2" />;
      default:
        return <BellElectric className="h-5 w-5 mr-2" />;
    }
  };
  ...
  return (
    <div className="mt-8 border border-elec-yellow/30 rounded-lg p-4 md:p-6">
      ...
      <div className="mb-6">
        <p className="mb-3">
          Understanding standardized BS7671 electrical symbols is essential for correctly
          interpreting UK electrical installation drawings. This reference shows the common symbols
          used in accordance with British Standards.
        </p>
