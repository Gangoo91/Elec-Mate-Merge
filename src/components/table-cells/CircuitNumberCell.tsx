...
const CircuitNumberCellComponent: React.FC<CircuitNumberCellProps> = ({ result, onUpdate }) => {
  return (
    <EnhancedValidatedInput
      ...
      className="h-8 text-sm text-center px-0 w-full bg-transparent border-0 rounded-none focus-visible:ring-1 focus-visible:ring-inset focus-visible:ring-elec-yellow focus:shadow-none hover:bg-white/[0.04] focus:bg-transparent"
