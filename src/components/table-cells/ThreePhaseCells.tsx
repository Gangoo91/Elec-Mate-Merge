    ...
    <>
      ...
      <TableCell className="px-2 py-0 bg-purple-500/10 h-10 align-middle">
        <div className="flex items-center gap-1">
          ...
          >
            <SelectTrigger className="h-8 text-sm w-full px-1.5 gap-1 [&_svg]:h-3 [&_svg]:w-3 bg-transparent border border-transparent text-white rounded-md hover:bg-white/[0.04] focus:bg-transparent focus:ring-1 focus:ring-inset focus:ring-elec-yellow focus:shadow-none">
