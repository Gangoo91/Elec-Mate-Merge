...
import { BookOpen, Calculator, GraduationCap, School, Wrench } from "lucide-react";
    ...
    <div className="bg-elec-gray/70 border border-elec-yellow/20 rounded-lg p-6">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <QuickAccessCard
          ...
          description="HNC, HND and degree level courses"
          linkText="View Courses"
          linkTo="/apprentice/study/higher"
          icon={<School className="ml-1 h-4 w-4" />}
        />
      </div>
    </div>
  );
