          ...
          {isLoading ? (
            <div className="space-y-4">
              {[1, 2, 3, 4, 5, 6].map((i) => (
                <div
                  key={i}
                  className="flex justify-between items-center border-b border-elec-yellow/10 pb-2"
                >
            ...
            pricingData.map((item) => (
              ...
              >
                ...
                <div className="flex items-center">
                  ...
                  <span
                    className={`flex items-center text-xs px-1 py-0.5 rounded w-14 justify-end ${
                      item.trend === 'up'
                        ? 'text-green-500'
                        : item.trend === 'down'
                          ? 'text-red-500'
