...
interface MaterialSlideOutFiltersProps {
  isOpen: boolean;
  onClose: () => void;
...
const MaterialSlideOutFilters = ({
  ...
  onFiltersChange,
  materials,
}: MaterialSlideOutFiltersProps) => {
  // Extract unique brands and suppliers from materials
  const { brands, suppliers } = useMemo(() => {
    const brandSet = new Set<string>();
    const supplierSet = new Set<string>();

    materials.forEach((material) => {
      // Extract brand from first word of name or category
...
export default MaterialSlideOutFilters;
