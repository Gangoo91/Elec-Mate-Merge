    ...
    domestic: [
      {
        ...
        materials: [
          {
            name: '2.5mm² Twin & Earth Cable (50m)',
            priority: 'Critical',
            price: '£45-65',
            spec: 'Ring main circuits',
          },
          {
            name: '1.5mm² Twin & Earth Cable (50m)',
            priority: 'Critical',
            price: '£30-45',
            spec: 'Lighting circuits',
          },
          {
            name: '6mm² Twin & Earth Cable (10m)',
            priority: 'Essential',
            price: '£25-35',
            spec: 'Cooker circuits',
          },
          {
            name: '1.0mm² 3 Core & Earth (25m)',
            priority: 'Essential',
            price: '£35-50',
            spec: 'Two-way switching',
          },
          {
            name: '10mm² Earth Cable (10m)',
            priority: 'Critical',
            price: '£20-30',
            spec: 'Main bonding',
          },
      ...
      },
      {
        ...
        materials: [
          {
            name: '8-Way Dual RCD Consumer Unit',
            priority: 'Critical',
            price: '£80-120',
            spec: '18th Edition compliant',
          },
          {
            name: '32A Type B MCBs (x4)',
            priority: 'Critical',
            price: '£40-60',
            spec: 'Ring circuits',
          },
          {
            name: '6A Type B MCBs (x4)',
            priority: 'Critical',
            price: '£32-48',
            spec: 'Lighting circuits',
          },
    ...
    commercial: [
      {
        ...
        materials: [
          {
            name: '3-Phase Distribution Board (24-way)',
            priority: 'Critical',
            price: '£200-350',
            spec: 'TP&N system',
          },
          {
            name: 'RCBO Type B 20A (x12)',
            priority: 'Critical',
            price: '£180-240',
            spec: 'Individual protection',
          },
          {
            name: '100A 3-Phase MCCB',
            priority: 'Critical',
            price: '£150-250',
            spec: 'Main switch',
          },
      ...
      },
      {
        ...
        materials: [
          {
            name: '4mm² 3C+E SWA Cable (100m)',
            priority: 'Critical',
            price: '£180-280',
            spec: 'Submain feeds',
          },
          {
            name: '2.5mm² Fire Resistant Cable (100m)',
            priority: 'Essential',
            price: '£120-180',
            spec: 'Fire alarm circuits',
          },
          {
            name: '1.5mm² Data Cable Cat6 (500m)',
            priority: 'Recommended',
            price: '£80-120',
            spec: 'Network installation',
          },
          {
            name: '25mm² Single Core Cable (50m)',
            priority: 'Essential',
            price: '£100-150',
            spec: 'Main earthing',
          },
    ...
    industrial: [
      {
        ...
        materials: [
          {
            name: '400A 3-Phase Switch Disconnector',
            priority: 'Critical',
            price: '£400-600',
            spec: 'Main isolation',
          },
          {
            name: 'Industrial Distribution Panel (36-way)',
            priority: 'Critical',
            price: '£500-800',
            spec: 'IP65 rated',
          },
          {
            ...
            priority: 'Critical',
            price: '£300-450',
            spec: 'Feeder protection',
          },
          {
            name: 'Earth Monitoring Relay',
            priority: 'Essential',
            price: '£150-250',
            spec: 'IT system monitoring',
          },
        ],
      },
      {
        ...
        materials: [
          {
            name: '35mm² 4C SWA Cable (100m)',
            priority: 'Critical',
            price: '£400-600',
            spec: 'Motor feeds',
          },
          {
            name: '1.5mm² Instrumentation Cable (100m)',
            priority: 'Essential',
            price: '£120-180',
            spec: 'Control circuits',
          },
          {
            name: '70mm² Single Core XLPE (50m)',
            priority: 'Critical',
            price: '£250-350',
            spec: 'Main distribution',
          },
          {
            name: 'Fire Resistant Control Cable (200m)',
            priority: 'Essential',
            price: '£180-280',
            spec: 'Safety systems',
          },
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-foreground/80 text-sm">
              Essential materials for different types of electrical installations
            </p>
          </div>
        </div>
      </CardHeader>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-foreground/80">
                All recommended materials comply with current UK wiring regulations. Ensure proper
                installation practices and testing procedures are followed for full compliance.
              </p>
            </div>
          </div>
        </div>
