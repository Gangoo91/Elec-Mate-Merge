...
const MaterialPricingWidget = () => {
  const [pricingData, setPricingData] = useState<PricingItem[]>([
    {
      id: 1,
      name: "Twin & Earth Cable (per 100m)",
      currentPrice: "£89.50",
      change: "+2.1%",
      trending: "up"
    },
    ...
    <Card className="border-elec-yellow/20 bg-elec-gray h-full">
      ...
      <CardContent>
        <div className="space-y-4">
          ...
          <Link to="/electrician/materials-price-tracker" className="block mt-4">
            <Button variant="outline" size="sm" className="w-full">View Full Price Tracker</Button>
          </Link>
        </div>
      </CardContent>
    </Card>
