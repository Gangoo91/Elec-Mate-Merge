...
const PriceHistoryAlerts = ({
  categoryId,
  selectedProduct,
  currentUserId = 'demo-user',
}: PriceHistoryAlertsProps) => {
            ...
            <div className="bg-orange-500/10 border border-orange-500/30 rounded-lg p-3">
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="font-medium text-orange-300">
                  Current Season: {seasonalPatterns.currentSeason}
                </span>
              </div>
          ...
          {showCreateAlert && selectedProduct && (
            <div className="bg-elec-yellow/10 rounded-lg p-4 mb-4 space-y-3">
              <h4 className="font-medium text-elec-yellow">
                Create Price Alert for {selectedProduct.name}
              </h4>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setAlertForm((prev) => ({ ...prev, targetPrice: e.target.value }))
                    }
                ...
                <div>
                  ...
                  >
                    ...
                    <SelectContent className="bg-elec-dark border-elec-yellow/20 z-50">
                      <SelectItem value="below" className="text-foreground">
                        Price drops below
                      </SelectItem>
                      <SelectItem value="above" className="text-foreground">
                        Price rises above
                      </SelectItem>
                      <SelectItem value="change" className="text-foreground">
                        Any price change
                      </SelectItem>
                    </SelectContent>
                  </Select>
                ...
                <div>
                  ...
                  <Select
                    value={alertForm.supplier}
                    onValueChange={(value) =>
                      setAlertForm((prev) => ({ ...prev, supplier: value }))
                    }
                  >
                    <SelectTrigger className="bg-elec-dark border-elec-yellow/20 text-foreground">
                      <SelectValue />
                    ...
                    <SelectContent className="bg-elec-dark border-elec-yellow/20 z-50">
                      <SelectItem value="Any" className="text-foreground">
                        Any Supplier
                      </SelectItem>
                      <SelectItem value="Screwfix" className="text-foreground">
                        Screwfix
                      </SelectItem>
                      <SelectItem value="CEF" className="text-foreground">
                        CEF
                      </SelectItem>
                      <SelectItem value="RS Components" className="text-foreground">
                        RS Components
                      </SelectItem>
                      <SelectItem value="Toolstation" className="text-foreground">
                        Toolstation
                      </SelectItem>
                    </SelectContent>
                  </Select>
          ...
          <div className="space-y-2">
            {isLoadingAlerts ? (
              ...
              userAlerts.map((alert) => (
                <div
                  key={alert.id}
                  className="flex items-center justify-between p-3 rounded-lg border border-elec-yellow/20"
                >
                  <div>
