  ...
  const { data: stats, isLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      return {
        ...
        city_guilds_level_2: installationBySource['city-guilds-level-2'] || 0,
        city_guilds_level_3: installationBySource['city-guilds-level-3'] || 0,
        ...
        health_safety_management: installationBySource['health-safety-management'] || 0,
        nebosh_igc: installationBySource['nebosh-igc'] || 0,
      };
    },
