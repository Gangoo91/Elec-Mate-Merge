...
import { SmartDefault } from '@/constants/minorWorksOptions';
...
const SINGLE_PHASE_PRESETS = [
  ...
  { id: 'shower-10.5kw', label: 'Shower 10.5kW', desc: '40A RCBO A, 10mm²', values: { circuitDescription: 'Electric shower 10.5kW', protectiveDeviceType: 'rcbo-type-a', protectiveDeviceRating: '40', liveConductorSize: '10.0', cpcSize: '4.0', cableType: 'twin-earth', overcurrentDeviceBsEn: 'BS EN 61009', protectiveDeviceKaRating: '6', numberOfConductors: '3', circuitType: 'radial', rcdIdn: '30', rcdType: 'A', rcdBsEn: 'BS EN 61009', protectionRcbo: true, installationMethod: 'ceiling-void', referenceMethod: 'C' } },
  { id: 'ev-charger', label: 'EV Charger', desc: '32A RCBO A, 6.0mm²', values: { circuitDescription: 'EV charger', protectiveDeviceType: 'rcbo-type-a', protectiveDeviceRating: '32', liveConductorSize: '6.0', cpcSize: '2.5', cableType: 'swa-pvc', overcurrentDeviceBsEn: 'BS EN 61009', protectiveDeviceKaRating: '6', numberOfConductors: '3', circuitType: 'radial', rcdIdn: '30', rcdType: 'A', rcdBsEn: 'BS EN 61009', protectionRcbo: true, installationMethod: 'in-duct', referenceMethod: 'D' } },
  ...
  { id: 'towel-rail', label: 'Towel Rail', desc: '16A RCBO A, 2.5mm²', values: { circuitDescription: 'Heated towel rail', protectiveDeviceType: 'rcbo-type-a', protectiveDeviceRating: '16', liveConductorSize: '2.5', cpcSize: '1.5', cableType: 'twin-earth', overcurrentDeviceBsEn: 'BS EN 61009', protectiveDeviceKaRating: '6', numberOfConductors: '3', circuitType: 'radial', rcdIdn: '30', rcdType: 'A', rcdBsEn: 'BS EN 61009', protectionRcbo: true, installationMethod: 'under-plaster', referenceMethod: 'A' } },
  ...
  return (
    <div className={className}>
      <button
        ...
        className="w-full h-11 rounded-lg font-semibold text-xs bg-elec-yellow border border-elec-yellow text-black touch-manipulation active:scale-[0.98]"
      >
      ...
      >
        ...
        <div className="flex gap-1 mb-3">
          <button
            ...
            className={cn(
              'flex-1 h-11 rounded-lg font-semibold text-xs touch-manipulation active:scale-[0.98]',
              phase === 'single'
