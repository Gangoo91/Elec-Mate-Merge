      ...
      <CardContent className="p-3 md:p-8 relative">
        <div className="md:max-w-6xl mx-auto">
          ...
          <div className="flex flex-col items-center justify-center p-2 md:p-4 bg-elec-gray-dark rounded-lg border border-elec-gray-light min-h-[60px] md:min-h-[100px]">
            ...
            <span className="text-[10px] md:text-xs text-white/70 mt-0.5 md:mt-1 leading-tight">Quals</span>
          </div>
          ...
          {hasRegistration ? (
            <div className="flex flex-col items-center justify-center p-2 md:p-4 bg-elec-gray-dark rounded-lg border border-elec-gray-light min-h-[60px] md:min-h-[100px]">
              ...
              <span className="text-[10px] md:text-xs text-white/70 mt-0.5 md:mt-1 leading-tight">Registered</span>
            </div>
          ) : (
            <div className="flex flex-col items-center justify-center p-2 md:p-4 bg-elec-gray-dark/50 rounded-lg border border-elec-gray-light/50 min-h-[60px] md:min-h-[100px] opacity-50">
              ...
              <span className="text-[10px] md:text-xs text-white/60 mt-0.5 md:mt-1 leading-tight">Not Registered</span>
            </div>
          )}
          ...
          {hasInsurance ? (
            <div className="flex flex-col items-center justify-center p-2 md:p-4 bg-elec-gray-dark rounded-lg border border-elec-gray-light min-h-[60px] md:min-h-[100px]">
              ...
              <span className="text-lg md:text-2xl font-bold text-foreground">✓</span>
              <span className="text-[10px] md:text-xs text-white/70 mt-0.5 md:mt-1 leading-tight">Insured</span>
            </div>
          ) : (
            <div className="flex flex-col items-center justify-center p-2 md:p-4 bg-elec-gray-dark/50 rounded-lg border border-elec-gray-light/50 min-h-[60px] md:min-h-[100px] opacity-50">
              <Shield className="w-4 h-4 md:w-6 md:h-6 text-white/60 mb-0.5 md:mb-2" />
              <span className="text-lg md:text-2xl font-bold text-white/60">-</span>
              <span className="text-[10px] md:text-xs text-white/60 mt-0.5 md:mt-1 leading-tight">Not Insured</span>
            </div>
          )}
          ...
          {profile.signatureData ? (
            <div className="flex flex-col items-center justify-center p-2 md:p-4 bg-elec-gray-dark rounded-lg border border-elec-gray-light min-h-[60px] md:min-h-[100px]">
              ...
              <span className="text-lg md:text-2xl font-bold text-foreground">✓</span>
              <span className="text-[10px] md:text-xs text-white/70 mt-0.5 md:mt-1 leading-tight">Signature</span>
            </div>
          ) : (
            <div className="flex flex-col items-center justify-center p-2 md:p-4 bg-elec-gray-dark/50 rounded-lg border border-elec-gray-light/50 min-h-[60px] md:min-h-[100px] opacity-50">
              <PenTool className="w-4 h-4 md:w-6 md:h-6 text-white/60 mb-0.5 md:mb-2" />
              <span className="text-lg md:text-2xl font-bold text-white/60">-</span>
              <span className="text-[10px] md:text-xs text-white/60 mt-0.5 md:mt-1 leading-tight">No Signature</span>
            </div>
          )}
        </div>
          ...
          {hasRegistration && (
            <div>
              ...
              {profile.registrationNumber && (
                <p className="text-[10px] md:text-xs text-white/70 mt-0.5 md:mt-1">#{profile.registrationNumber}</p>
              )}
            </div>
          )}
          ...
          {hasInsurance && (
            <div>
              ...
              {profile.insuranceCoverage && (
                <p className="text-[10px] md:text-xs text-white/70 mt-0.5 md:mt-1">{profile.insuranceCoverage}</p>
              )}
            </div>
          )}
        </div>
