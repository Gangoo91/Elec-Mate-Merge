              ...
              <div className="space-y-1">
                {categoryItems.map(item => (
                  <button
                    ...
                    className={`w-full text-left flex items-center gap-2 px-3 py-2 rounded-md hover:bg-neutral-600 focus:bg-neutral-600 min-h-[40px] transition-colors ${
                      value === item.type ? 'bg-neutral-600' : 'bg-transparent'
                    }`}
                  >
