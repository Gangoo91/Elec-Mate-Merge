...
export const DropdownTabs = ({ 
  ...
  return (
    <Select value={value} onValueChange={onValueChange}>
      <SelectTrigger className={cn("w-full h-9 bg-muted text-foreground border-border focus:ring-1 focus:ring-elec-yellow focus:border-elec-yellow text-sm", className)}>
