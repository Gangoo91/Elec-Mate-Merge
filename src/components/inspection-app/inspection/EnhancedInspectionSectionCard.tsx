                    ...
                    <div className="flex-1 min-w-0 space-y-1.5 sm:space-y-2">
                      <div className="flex items-start justify-between gap-2 min-w-0">
                        <h3 className="font-bold text-sm sm:text-base text-foreground flex items-center gap-1.5 sm:gap-2 flex-nowrap min-w-0">
                          ...
                          {sectionPriority === 'critical' && (
                            <Badge variant="destructive" className="text-[10px] sm:text-[10px] px-1 sm:px-1.5 py-0 font-bold uppercase">
                              Critical
                            </Badge>
                          )}
                          {sectionPriority === 'important' && (
                            <Badge className="text-[10px] sm:text-[10px] px-1 sm:px-1.5 py-0 font-bold uppercase bg-blue-500/20 text-blue-400 border-blue-500/40">
                              Important
                            </Badge>
                          )}
                        </h3>
