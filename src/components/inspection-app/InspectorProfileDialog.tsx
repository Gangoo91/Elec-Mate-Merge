  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button variant="outline" size="sm" className="flex items-center gap-2 bg-card border-border text-white/80 hover:bg-muted hover:text-foreground">
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto bg-card border-border">
        ...
        <MobileTabs value={activeTab} onValueChange={setActiveTab}>
          <MobileTabsList className="grid w-full grid-cols-2 bg-muted border-border">
            <MobileTabsTrigger value="manage" className="text-white/80 data-[state=active]:bg-elec-yellow data-[state=active]:text-black">Manage Profiles</MobileTabsTrigger>
            <MobileTabsTrigger value="form" className="text-white/80 data-[state=active]:bg-elec-yellow data-[state=active]:text-black">
          ...
          <MobileTabsContent value="manage" className="space-y-4">
            ...
            <div className="grid gap-4">
                    ...
                    <div className="flex justify-between items-start">
                      ...
                      <div className="flex gap-2">
                        ...
                        <Button
                          ...
                          className="border-neutral-500 text-white/80 hover:bg-neutral-600 hover:text-foreground"
                        >
                          Edit
                        </Button>
                        <Button
                          ...
                          className="border-neutral-500 text-white/80 hover:bg-neutral-600 hover:text-foreground disabled:opacity-50"
                        >
                  ...
                  <CardContent>
                    <div className="flex flex-wrap gap-1 mb-2">
                      {profile.qualifications.map((qual) => (
                        <Badge key={qual} variant="secondary" className="text-xs bg-elec-yellow/20 text-white/80 border border-elec-yellow/30">
                          {qual}
                        </Badge>
                      ))}
                    </div>
              ...
              {profiles.length === 0 && (
                <div className="text-center py-8 text-white/70 bg-muted rounded-lg border border-border">
          ...
          <MobileTabsContent value="form" className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <Label htmlFor="profileName" className="text-white/80">Inspector Name *</Label>
                <Input
                  id="profileName"
                  value={formData.name}
              ...
              <div className="flex items-center space-x-2 pt-6">
                <Checkbox
                  ...
                  className="border-white/15 data-[state=checked]:bg-elec-yellow data-[state=checked]:border-elec-yellow"
                />
                <Label htmlFor="defaultProfile" className="text-white/80">Set as default profile</Label>
              </div>
            </div>

            <div>
              <Label className="text-white/80">Qualifications</Label>
                ...
                {qualificationOptions.map((qual) => (
                  <div key={qual} className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      className="border-white/15 data-[state=checked]:bg-elec-yellow data-[state=checked]:border-elec-yellow"
                    />
                    <Label htmlFor={qual} className="text-sm text-white/80 cursor-pointer">{qual}</Label>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <Label htmlFor="registrationNumber" className="text-white/80">Registration Number</Label>
                <Input
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <Label htmlFor="companyPhone" className="text-white/80">Phone Number</Label>
                <Input
                  id="companyPhone"
              ...
              <div>
                <Label htmlFor="companyEmail" className="text-white/80">Email Address</Label>
                <Input
                  id="companyEmail"
                  type="email"
            ...
            <div>
              <Label className="text-white/80">Registration Scheme</Label>
              <Input
                ...
                className="bg-muted border-border text-foreground placeholder:text-white/70 focus:border-elec-yellow focus:ring-elec-yellow mt-1"
              />
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <Label htmlFor="insuranceProvider" className="text-white/80">Insurance Provider</Label>
                <Input
            ...
            <div className="flex justify-end gap-2 pt-4">
              <Button variant="outline" onClick={() => {
                resetForm();
                setActiveTab('manage');
              }} className="border-border text-white/80 hover:bg-muted hover:text-foreground">
                Cancel
              </Button>
              <Button 
                onClick={handleSave}
