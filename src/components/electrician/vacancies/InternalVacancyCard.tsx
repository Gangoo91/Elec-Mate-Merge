          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-start justify-between gap-2 mb-2">
              <div className="min-w-0">
                <h3 className="font-semibold text-foreground line-clamp-1">{vacancy.title}</h3>
            ...
            <div className="flex flex-wrap gap-2 mb-3">
              <Badge
                variant="outline"
                className="bg-white/10 border-white/20 text-foreground/90 font-normal"
              >
              ...
              <Badge
                variant="outline"
                className="bg-white/10 border-white/20 text-foreground/70 font-normal"
              >
