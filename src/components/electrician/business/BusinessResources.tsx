...
const businessResources = [
  {
    ...
    description:
      'Templates and resources for establishing your electrical contracting business, including business plans and marketing strategies.',
    contents: [
  ...
  },
  {
    ...
    description:
      'Information on becoming NICEIC, NAPIT, or ELECSA approved, essential for gaining customer trust.',
    contents: [
  ...
  },
  {
    ...
    description:
      'Financial management resources specifically for electrical contractors and small businesses.',
    contents: [
