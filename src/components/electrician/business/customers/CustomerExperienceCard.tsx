      ...
      <CardHeader className="pb-3">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <CardDescription>
              Creating delighted customers who become advocates for your electrical business
            </CardDescription>
          </div>
        </div>
      </CardHeader>
            ...
            <AccordionContent className="text-slate-200 pt-4 space-y-4">
              <div className="space-y-3">
                ...
                <ul className="list-disc pl-6 space-y-2">
                  <li>
                    Set up automated appointment confirmation and reminder systems (24 hours and 2
                    hours before)
                  </li>
                  <li>Provide real-time updates if delays occur, with estimated arrival times</li>
                  <li>
                    Send job completion summaries with photos and explanations of work completed
                  </li>
                  <li>
                    Implement a customer portal for easy scheduling and access to service history
                  </li>
                ...
                <p>
                  2-4 weeks to implement basic systems, 2-3 months to optimise based on customer
                  feedback
                </p>
          ...
          >
            ...
            <AccordionContent className="text-slate-200 pt-4 space-y-4">
              <div className="space-y-3">
                ...
                <ul className="list-disc pl-6 space-y-2">
                  <li>
                    Train all technicians in customer service skills alongside technical
                    competencies
                  </li>
                  <li>
                    Implement protective measures: shoe covers, dust sheets, floor protection for
                    all jobs
                  </li>
                  <li>
                    Establish clear protocols for explaining work to customers in plain English
                  </li>
                ...
                <h4 className="font-medium text-foreground">Timeline:</h4>
                <p>
                  1-2 months for initial training and protocol implementation, ongoing refinement
                </p>
          ...
          <AccordionItem value="follow-up" className="border border-elec-yellow/20 rounded-lg px-4">
            ...
            <AccordionContent className="text-slate-200 pt-4 space-y-4">
              <div className="space-y-3">
                ...
                <p>
                  £200-500/month for CRM system and automation tools, staff time equivalent to 5-10
                  hours/week
                </p>
            ...
            <AccordionContent className="text-slate-200 pt-4 space-y-4">
              <div className="space-y-3">
                ...
                <ul className="list-disc pl-6 space-y-2">
                  ...
                  <li>
                    Branded promotional items: electrical safety checklists, emergency contact
                    magnets
                  </li>
