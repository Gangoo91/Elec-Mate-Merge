    ...
    <div className="space-y-4">
      <Alert className="border-yellow-400/50 bg-yellow-400/10">
        ...
        <AlertDescription className="text-yellow-400">
          Retaining customers costs 5-7 times less than acquiring new ones. A 5% increase in
            ...
            <div className="bg-elec-gray border border-elec-yellow/20 rounded-b-lg p-4 space-y-4">
              <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-4">
                ...
                <p className="text-sm text-slate-200">
                  Building lasting relationships with customers ensures repeat business and creates
                  sustainable growth. Retaining customers costs 5-7 times less than acquiring new
                  ones, making it the most profitable growth strategy.
                </p>
              </div>
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/20 rounded-lg p-4">
                ...
                <ul className="space-y-2 text-sm text-slate-200">
                  <li>
                    • Maintain detailed customer records with preferences, family details, and
                    service history
                  </li>
                  <li>
                    • Send personalised birthday and anniversary greetings with special offers
                  </li>
                  <li>
                    • Provide seasonal electrical safety tips and weather-related maintenance
                    reminders
                  </li>
                  ...
                  <li>
                    • Remember personal details like pet names, family members, and property quirks
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-amber-500/10 border border-amber-500/20 rounded-lg p-4">
                ...
                <ul className="space-y-2 text-sm text-slate-200">
                  ...
                  <li>
                    • Extended warranties (3-5 years) for repeat customers vs standard 1-2 years
                  </li>
                  <li>• 24/7 emergency call-out priority service with guaranteed response times</li>
                  <li>
                    • Progressive discount structure: 5% after 2 jobs, 10% after 5 jobs, 15% after
                    10 jobs
                  </li>
                  <li>• Free minor repairs and adjustments during routine service visits</li>
                  <li>
                    • Educational workshops on electrical safety, energy efficiency, and smart home
                    technology
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-purple-500/10 border border-purple-500/20 rounded-lg p-4">
                ...
                <ul className="space-y-2 text-sm text-slate-200">
                  ...
                  <li>
                    • Generates 65% of new business through referrals from satisfied customers
                  </li>
                  <li>• Reduces marketing costs by 60% through word-of-mouth promotion</li>
                  <li>
                    • Creates predictable revenue streams through maintenance contracts and repeat
                    work
                  </li>
                  <li>• Builds competitive moats that protect against price-based competition</li>
                  <li>
                    • Establishes premium positioning allowing 15-25% higher pricing than
                    competitors
                  </li>
                </ul>
              </div>
          ...
          <MobileAccordionContent>
            <div className="bg-elec-gray border border-elec-yellow/20 rounded-b-lg p-4 space-y-4">
              <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-4">
                ...
                <p className="text-sm text-slate-200">
                  Regular maintenance contracts provide predictable revenue while ensuring customer
                  electrical systems remain safe and efficient. This creates win-win relationships
                  that generate 40-60% of annual revenue.
                </p>
              </div>
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/20 rounded-lg p-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="p-3 bg-slate-800/50 rounded-lg border border-emerald-500/20">
                    ...
                    <div className="text-center mt-2 p-2 bg-emerald-500/10 rounded text-emerald-400 font-bold">
                      £120/year
                    </div>
                  </div>
          ...
          <MobileAccordionContent>
            <div className="bg-elec-gray border border-elec-yellow/20 rounded-b-lg p-4 space-y-4">
              <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-4">
                ...
                <p className="text-sm text-slate-200">
                  Regular, valuable communication keeps your business top-of-mind and demonstrates
                  ongoing care for customer safety and satisfaction. Strategic communication turns
                  one-time customers into lifetime advocates.
                </p>
              </div>
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/20 rounded-lg p-4">
                ...
                <ul className="space-y-2 text-sm text-slate-200">
                  <li>
                    • Monthly newsletter featuring electrical safety tips, energy saving advice, and
                    technology updates
                  </li>
                  <li>
                    • Seasonal maintenance reminders with weather-specific electrical safety
                    guidance
                  </li>
              ...
              <div className="bg-amber-500/10 border border-amber-500/20 rounded-lg p-4">
                ...
                <ul className="space-y-2 text-sm text-slate-200">
                  <li>
                    • 48 hours post-completion: Satisfaction call and immediate issue resolution
                  </li>
              ...
              <div className="bg-purple-500/10 border border-purple-500/20 rounded-lg p-4">
                ...
                <ul className="space-y-2 text-sm text-slate-200">
                  ...
                  <li>
                    • Reduces customer acquisition costs by maintaining existing relationships
                  </li>
          ...
          <MobileAccordionContent>
            <div className="bg-elec-gray border border-elec-yellow/20 rounded-b-lg p-4 space-y-4">
              <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-4">
                ...
                <p className="text-sm text-slate-200">
                  Reward loyal customers with incentives that encourage repeat business and
                  referrals while building long-term relationships. A structured loyalty program
                  increases customer lifetime value by 25-100%.
                </p>
              </div>
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/20 rounded-lg p-4">
                ...
                <ul className="space-y-2 text-sm text-slate-200">
                  <li>
                    • Points-based system: 1 point per £1 spent, with bonus multipliers for
                    referrals (50 points) and maintenance contracts (2x points)
                  </li>
                  <li>
                    • Birthday and anniversary bonus points (25-50 points) with personalised offers
                  </li>
                  <li>
                    • Redemption tiers: 100 points = £10 discount, 500 points = free safety
                    inspection, 1000 points = priority emergency service
                  </li>
                  ...
                  <li>
                    • Points never expire with annual activity, encouraging ongoing engagement
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-amber-500/10 border border-amber-500/20 rounded-lg p-4">
                ...
                <ul className="space-y-2 text-sm text-slate-200">
                  <li>
                    • Bronze (1+ years): 5% discount, priority booking, extended payment terms
                  </li>
                  <li>
                    • Silver (3+ years): 10% discount, free annual safety check, dedicated support
                    line
                  </li>
                  <li>
                    • Gold (5+ years): 15% discount, 24/7 emergency priority, complimentary minor
                    repairs
                  </li>
                  <li>
                    • Platinum (10+ years): 20% discount, personal account manager, exclusive
                    services
                  </li>
                  <li>
                    • Each tier includes progressively longer warranty periods and payment
                    flexibility
                  </li>
              ...
              <div className="bg-purple-500/10 border border-purple-500/20 rounded-lg p-4">
                ...
                <ul className="space-y-2 text-sm text-slate-200">
                  <li>
                    • Increases repeat purchase frequency by 35-50% through incentivised engagement
                  </li>
                  ...
                  <li>
                    • Provides valuable customer data for targeted marketing and service improvement
                  </li>
                  <li>
                    • Justifies premium pricing through exclusive benefits and status recognition
                  </li>
                </ul>
              </div>
            </div>
          ...
          <MobileAccordionContent>
            <div className="bg-elec-gray border border-elec-yellow/20 rounded-b-lg p-4 space-y-4">
              <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-4">
                ...
                <p className="text-sm text-slate-200">
                  Track key performance indicators to measure retention success and identify
                  opportunities for improvement. Data-driven decisions ensure sustainable growth and
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/20 rounded-lg p-4">
                ...
                <ul className="space-y-2 text-sm text-slate-200">
                  <li>
                    • Customer retention rate: Target 85%+ annual retention (industry average: 68%)
                  </li>
                  ...
                  <li>
                    • Average time between services: Track seasonal patterns and decline indicators
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-amber-500/10 border border-amber-500/20 rounded-lg p-4">
                ...
                <ul className="space-y-2 text-sm text-slate-200">
                  <li>
                    • Referral generation rate: Target 25%+ customers actively referring
                    (best-in-class: 35%+)
                  </li>
                  <li>
                    • Revenue per customer growth: Track increasing spend patterns and service
                    expansion
                  </li>
                  <li>
                    • Maintenance contract renewal rate: Target 90%+ renewal with price increases
                  </li>
                  <li>• Upselling success rate: Target 20%+ additional services per visit</li>
                  <li>
                    • Customer satisfaction scores: Maintain 95%+ satisfaction across all
                    touchpoints
                  </li>
                  <li>
                    • Online review ratings: Target 4.8+ stars across Google, Trustpilot,
                    Checkatrade
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-purple-500/10 border border-purple-500/20 rounded-lg p-4">
                ...
                <ul className="space-y-2 text-sm text-slate-200">
                  <li>
                    • Customer segmentation analysis: High-value, medium-value, at-risk customer
                    categories
                  </li>
                  <li>
                    • Seasonal demand forecasting: Predict busy periods and resource requirements
                  </li>
                  <li>
                    • Profitability analysis per customer: Identify most valuable customer segments
                  </li>
                  <li>
                    • Service quality correlation tracking: Link quality metrics to retention rates
                  </li>
                  <li>
                    • Communication effectiveness measurement: Track response rates to different
                    touchpoints
                  </li>
                  <li>
                    • Competitive positioning analysis: Monitor market share and pricing
                    effectiveness
                  </li>
                </ul>
              </div>
          ...
          <MobileAccordionContent>
            <div className="bg-elec-gray border border-elec-yellow/20 rounded-b-lg p-4 space-y-4">
              <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-4">
                ...
                <p className="text-sm text-slate-200">
                  Referrals are the highest-quality leads with 5x higher conversion rates and 25%
                  higher lifetime value. A systematic referral program can generate 40-70% of new
                  business.
                </p>
              </div>
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/20 rounded-lg p-4">
                ...
                <ul className="space-y-2 text-sm text-slate-200">
                  <li>
                    • Dual reward system: £50 credit for referrer, £25 discount for new customer
                  </li>
                  <li>
                    • Tiered bonuses: 3 referrals = £200 bonus, 5 referrals = free annual service
                  </li>
                  <li>
                    • Business referral premium: £100 credit for commercial customer referrals
                  </li>
                  <li>
                    • Seasonal multipliers: Double rewards during slow periods (January-February)
                  </li>
                  <li>• Family referral discounts: Special rates for extended family members</li>
                  <li>
                    • Tradesperson cross-referrals: Partnership programs with plumbers, builders,
                    decorators
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-amber-500/10 border border-amber-500/20 rounded-lg p-4">
                ...
                <ul className="space-y-2 text-sm text-slate-200">
                  <li>
                    • Ask for referrals at optimal moments: After successful project completion
                  </li>
                  <li>• Provide referral cards with QR codes linking to special booking pages</li>
                  <li>
                    • Follow up 48 hours post-job with referral request and incentive reminder
                  </li>
                  <li>• Social media sharing incentives: Bonus rewards for public testimonials</li>
                  <li>
                    • Neighbour targeting: Special offers for properties within 500m of completed
                    work
                  </li>
                  <li>
                    • Annual referral campaigns: Special events and higher rewards during peak
                    seasons
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-purple-500/10 border border-purple-500/20 rounded-lg p-4">
                ...
                <ul className="space-y-2 text-sm text-slate-200">
                  <li>
                    • Referred customers have 37% higher retention rates than other acquisition
                    channels
                  </li>
                  <li>
                    • Cost per acquisition through referrals: £25-50 vs £150-300 for advertising
                  </li>
