...
const MarketResearchTab = () => {
  ...
  const demographicAnalysis = [
    {
      ...
      businessImpact:
        'Target messaging and pricing strategies to match customer financial capacity',
    ...
    },
    {
      ...
      timeline: 'Week 1-2',
      description:
        'Understanding the electrical requirements of different property types in your area',
      components: [
      ...
      kpis: [
        'Job frequency by property type',
  ...
  const residentialProfiles = [
    ...
    },
    {
      ...
      businessImpact:
        'Highest value customers with potential for extensive projects and ongoing relationships',
    },
  ];
  ...
  const commercialAnalysis = [
    {
      ...
      description:
        'Shops, restaurants, pubs and customer-facing businesses requiring reliable electrical systems',
      requirements: [
    ...
    },
    {
      ...
      description:
        'Offices, clinics, professional services requiring minimal disruption electrical work',
      requirements: [
    ...
    },
    {
      ...
      description:
        'Workshops, light manufacturing and industrial units requiring specialist electrical services',
      requirements: [
  ...
  const segmentationStrategy = [
    {
      ...
      timeline: 'Week 1-2',
      description:
        'Divide your service area into manageable zones based on travel time and market density',
      components: [
    ...
    },
    {
      ...
      timeline: 'Week 2-3',
      description:
        'Categorise customers by the type and complexity of electrical services they require',
      components: [
      ...
      businessImpact:
        'Develop specific expertise areas and pricing models for different service types',
    ...
    },
    {
      ...
      businessImpact:
        'Allocate resources effectively and develop appropriate customer relationship strategies',
  ...
  const customerJourney = [
    {
      ...
      description:
        'Customer identifies an electrical need or problem requiring professional attention',
      touchpoints: [
    ...
    },
    {
      ...
      businessImpact:
        'Professional quote process and customer service directly impacts conversion rates',
    },
  ];
    ...
    <div className="space-y-4">
      <Alert className="border-blue-400/50 bg-blue-400/10">
        ...
        <AlertDescription className="text-blue-400">
          Thorough market research can increase customer acquisition efficiency by 200-300% and
          reduce marketing spend by up to 40%.
        </AlertDescription>
      </Alert>
              ...
              {residentialProfiles.map((profile, index) => (
                <div key={index} className="border border-green-500/20 rounded-lg p-3 space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="space-y-1 text-xs">
                        ...
                        <div className="text-green-200">
                          Property: {profile.demographics.propertyType}
                        </div>
                        <div className="text-green-200">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <div className="space-y-2">
                      <h5
                        className={`font-medium text-purple-300 ${isMobile ? 'text-xs' : 'text-sm'}`}
                      >
                        Electrical Needs
                      </h5>
                      <ul className="space-y-1">
                    ...
                    <div className="space-y-2">
                      ...
                      <ul className="space-y-1">
                        {profile.marketingApproach.map((approach, approachIndex) => (
                          <li
                            key={approachIndex}
                            className={`${isMobile ? 'text-xs' : 'text-sm'} text-orange-200 flex items-start gap-1`}
                          >
                            <CheckCircle className="h-3 w-3 text-green-400 flex-shrink-0 mt-0.5" />
                            {approach}
                          </li>
                    ...
                    <div className="flex flex-wrap gap-1">
                      {strategy.kpis.map((kpi, kpiIndex) => (
                        <Badge
                          key={kpiIndex}
                          variant="outline"
                          className={`text-amber-300 border-amber-400/30 ${isMobile ? 'text-xs' : 'text-sm'}`}
                        >
                          {kpi}
                        </Badge>
                      ))}
              ...
              {customerJourney.map((stage, index) => (
                <div key={index} className="border border-pink-500/20 rounded-lg p-3 space-y-3">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <div>
                      <h5
                        className={`font-medium text-pink-300 mb-2 ${isMobile ? 'text-xs' : 'text-sm'}`}
                      >
                      ...
                      <ul className="space-y-1">
                        {stage.touchpoints.map((touchpoint, touchIndex) => (
                          <li
                            key={touchIndex}
                            className={`${isMobile ? 'text-xs' : 'text-sm'} text-pink-200 flex items-start gap-1`}
                          >
                            <CheckCircle className="h-3 w-3 text-green-400 flex-shrink-0 mt-0.5" />
                            {touchpoint}
                          </li>
                  ...
                  <div>
                    ...
                    <ul className="space-y-1">
                      {stage.opportunities.map((opportunity, oppIndex) => (
                        <li
                          key={oppIndex}
                          className={`${isMobile ? 'text-xs' : 'text-sm'} text-green-200 flex items-start gap-1`}
                        >
                          <CheckCircle className="h-3 w-3 text-green-400 flex-shrink-0 mt-0.5" />
                          {opportunity}
                        </li>
