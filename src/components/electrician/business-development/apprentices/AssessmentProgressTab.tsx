  ...
  const assessmentFramework = [
    {
      ...
      components: [
        'Interactive knowledge assessment (BS 7671:2018+A4:2026)',
    ...
    <div className="space-y-4">
      <Alert className="border-blue-500/50 bg-blue-500/10">
        ...
        <AlertDescription className="text-blue-200">
          Effective assessment tracking increases apprentice completion rates by 19% and provides
          clear ROI visibility for employers.
        </AlertDescription>
      </Alert>
            ...
            <div className="bg-elec-gray border border-elec-yellow/20 rounded-b-lg p-4 space-y-4">
              {assessmentFramework.map((phase, index) => (
                <div key={index} className="border border-blue-500/20 rounded-lg p-3 space-y-3">
                  ...
                  <div>
                    <h5 className="font-medium text-blue-300 mb-2 text-xs">
                  ...
                  <div>
                    <h5 className="font-medium text-purple-300 mb-1 text-xs">
                        ...
                        <div className="flex flex-wrap gap-1">
                          {tool.features.map((feature, featureIndex) => (
                            <Badge
                              key={featureIndex}
                              variant="outline"
                              className="text-purple-200 border-purple-400/20 text-xs"
                            >
                              {feature}
                            </Badge>
                          ))}
            ...
            <div className="bg-elec-gray border border-elec-yellow/20 rounded-b-lg p-4 space-y-4">
              {collegePerformance.map((indicator, index) => (
                <div key={index} className="border border-green-500/20 rounded-lg p-3 space-y-3">
                  ...
                  <div>
                    <h5 className="font-medium text-green-300 mb-2 text-xs">
                    ...
                    <ul className="space-y-1">
                      {indicator.metrics.map((metric, metricIndex) => (
                        <li
                          key={metricIndex}
                          className="text-xs text-green-200 flex items-center gap-1"
                        >
            ...
            <div className="bg-elec-gray border border-elec-yellow/20 rounded-b-lg p-4 space-y-4">
                  ...
                  <div>
                    ...
                    <ul className="space-y-1">
                      {strategy.actions.map((action, actionIndex) => (
                        <li
                          key={actionIndex}
                          className="text-xs text-orange-200 flex items-center gap-1"
                        >
                          <CheckCircle className="h-3 w-3 text-green-400 flex-shrink-0" />
                          {action}
                        </li>
              ...
              <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-3">
                ...
                <p className="text-xs text-green-200">
                  Early intervention reduces dropout risk by 75% and improves overall completion
                  rates. Regular monitoring and prompt action are key to apprentice success.
                </p>
              </div>
            </div>
          </MobileAccordionContent>
            ...
            <div className="bg-elec-gray border border-elec-yellow/20 rounded-b-lg p-4 space-y-4">
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-3">
                ...
                <p className="text-xs text-blue-200">
                  Establish a regular review cycle with your training provider. Monthly progress
                  meetings and quarterly performance reviews ensure issues are identified and
                  addressed quickly.
                </p>
              </div>
            </div>
