  ...
  const supportCategoryFramework = [
    {
      ...
      services: [
        ...
        },
        {
          ...
          providers: [
            'Training Provider Support Teams',
            'Industry Skills Councils',
            'Employer Learning Coordinators',
          ],
      ...
      services: [
        {
          ...
          providers: [
            'NHS Psychological Wellbeing Services',
            'Industry Wellbeing Programmes',
      ...
      services: [
        ...
        },
        {
          ...
          providers: [
            ...
            'Ofsted',
            'Training Provider Student Services',
          ],
    ...
    <div className="space-y-4">
      <Alert className="border-green-500/50 bg-green-500/10">
        ...
        <AlertDescription className="text-green-200">
          Early support intervention prevents 75% of apprentice failures. Getting help quickly makes
          all the difference.
        </AlertDescription>
      </Alert>
              ...
              {emergencyContactsModern.map((contact, index) => (
                <div key={index} className="border border-red-500/20 rounded-lg p-3 space-y-3">
                  <div className="flex flex-col gap-2">
                    ...
                    <Badge
                      variant="outline"
                      className="text-red-300 border-red-400/30 w-fit text-xs"
                    >
                      {contact.contact}
                    </Badge>
                  </div>
                    ...
                    <div className="flex flex-wrap gap-1">
                      {contact.specialties.map((specialty, specialtyIndex) => (
                        <Badge
                          key={specialtyIndex}
                          variant="outline"
                          className="text-red-200 border-red-400/20 text-xs"
                        >
                          {specialty}
                        </Badge>
                      ))}
                ...
                <div key={index} className="space-y-3">
                  ...
                  {category.resources.map((resource, resourceIndex) => (
                    ...
                    >
                      ...
                      <div className="bg-blue-500/10 border border-blue-500/30 rounded p-2">
                        <h6 className="font-medium text-blue-300 mb-1 text-xs">Availability</h6>
                        <p className="text-xs text-blue-200">{resource.availability}</p>
                      </div>

                      <div className="bg-green-500/10 border border-green-500/30 rounded p-2">
                        <h6 className="font-medium text-green-300 mb-1 text-xs">Access URL</h6>
                        <p className="text-xs text-green-200 break-all">{resource.url}</p>
                      </div>
                    </div>
                  ))}
                </div>
