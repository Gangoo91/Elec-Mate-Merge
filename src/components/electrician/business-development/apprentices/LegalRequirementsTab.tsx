  ...
  const currentWageFramework = [
    {
      ...
      criticalPoints: [
        ...
        'Backdated payments required',
        'Public naming for violations',
      ],
    },
    {
    ...
    },
    {
      ...
      criticalPoints: [
        ...
        'Enhanced protection for under 18s',
                  ...
                  <div>
                    ...
                    <ul className="space-y-1">
                      {framework.components.map((component, compIndex) => (
                        <li
                          key={compIndex}
                          className="text-xs text-red-200 flex items-center gap-1"
                        >
                    ...
                    <div className="flex flex-wrap gap-1">
                      {framework.criticalPoints.map((point, pointIndex) => (
                        <Badge
                          key={pointIndex}
                          variant="outline"
                          className="text-red-300 border-red-400/30 text-xs"
                        >
                          {point}
                        </Badge>
                      ))}
