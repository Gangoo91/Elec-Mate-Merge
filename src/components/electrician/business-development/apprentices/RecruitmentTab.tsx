...
const RecruitmentTab = () => {
  ...
  const modernRecruitmentStrategy = [
    ...
    },
    {
      ...
      description:
        'Build strategic partnerships with education providers and community organisations',
      components: [
      ...
      employerBenefit:
        'Lower cost per hire and higher quality candidates through trusted referrals',
  ...
  const selectionFramework = [
    {
      ...
      employerView:
        'Filter 60-80% of applications efficiently, saving time on unsuitable candidates',
      successTips: [
        'Set clear pass marks',
    ...
    },
    {
      ...
      successTips: [
        'Use scoring matrix',
        'Include team members in process',
  ...
  const costInvestmentAnalysis = [
    {
      ...
      costs: [
        {
          item: 'Job advertising (multi-platform)',
          amount: '£800-1,500',
          timeframe: 'Per campaign',
        },
        {
          item: 'Assessment tools and platforms',
          amount: '£300-600',
          timeframe: 'Annual subscription',
        },
        {
          item: 'Interview time and resources',
          amount: '£400-800',
          timeframe: 'Per successful hire',
        },
    ...
    },
    {
      ...
      incentives: [
        {
          item: 'Apprentice hiring incentive (16-18)',
          amount: '£3,000',
          eligibility: 'Per apprentice (2025)',
        },
        {
          item: 'Small employer additional support',
          amount: '£1,000',
          eligibility: 'Companies <50 employees',
        },
        {
          item: 'Training cost coverage',
          amount: '95-100%',
          eligibility: 'Government co-investment',
        },
        {
          item: 'Apprenticeship levy offset',
          amount: '£15,000',
          eligibility: 'Annual levy credit',
        },
      ],
    ...
    <div className="space-y-4">
      <Alert className="border-green-500/50 bg-green-500/10">
        ...
        <AlertDescription className="text-green-200">
          Strategic recruitment reduces time-to-hire by 40% and increases apprentice completion
          rates to 85%+.
        </AlertDescription>
      </Alert>
            ...
            <div className="bg-elec-gray border border-elec-yellow/20 rounded-b-lg p-4 space-y-4">
              {digitalChannels.map((category, index) => (
                <div key={index} className="space-y-3">
                  <h4
                    className={`font-medium text-purple-300 ${isMobile ? 'text-sm' : 'text-base'} border-b border-purple-500/20 pb-1`}
                  >
                    {category.channel}
                  </h4>
                        ...
                        <div className="flex flex-wrap gap-1">
                          {platform.features.map((feature, featureIndex) => (
                            <Badge
                              key={featureIndex}
                              variant="outline"
                              className={`text-purple-200 border-purple-400/20 ${isMobile ? 'text-xs' : 'text-sm'}`}
                            >
                              {feature}
                            </Badge>
                          ))}
                  ...
                  {category.costs && (
                    <div>
                        ...
                        {category.costs.map((cost, costIndex) => (
                          ...
                          >
                            ...
                            <div className="text-right">
                              <div
                                className={`${isMobile ? 'text-xs' : 'text-sm'} font-medium text-orange-300`}
                              >
                                {cost.amount}
                              </div>
                      ...
                      <div className="mt-3 p-2 bg-orange-500/20 rounded">
                        <div
                          className={`${isMobile ? 'text-sm' : 'text-base'} font-medium text-orange-200`}
                        >
                  ...
                  {category.incentives && (
                    <div>
                      ...
                      <div className="space-y-2">
                        {category.incentives.map((incentive, incentiveIndex) => (
                          ...
                          >
                            ...
                            <div className="text-right">
                              <div
                                className={`${isMobile ? 'text-xs' : 'text-sm'} font-medium text-green-300`}
                              >
                                {incentive.amount}
                              </div>
                      ...
                      <div className="mt-3 p-2 bg-green-500/20 rounded">
                        <div
                          className={`${isMobile ? 'text-sm' : 'text-base'} font-medium text-green-200`}
                        >
                          {category.netBenefit}
                        </div>
                      </div>
            ...
            <div className="bg-elec-gray border border-elec-yellow/20 rounded-b-lg p-4 space-y-3">
              <div className="grid grid-cols-1 gap-2">
                <Button
                  ...
                  onClick={() =>
                    window.open('https://www.findapprenticeship.service.gov.uk/employers', '_blank')
                  }
                >
                  <Search className="h-4 w-4 mr-3 text-green-400 flex-shrink-0" />
                  <div className="text-left flex-1 min-w-0">
                    <div
                      className={`${isMobile ? 'text-sm' : 'text-base'} text-foreground truncate`}
                    >
                ...
                <Button
                  ...
                  onClick={() =>
                    window.open('https://www.apprenticeships.gov.uk/employers', '_blank')
                  }
                >
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 rounded-lg p-3">
                <h4
                  className={`font-medium text-amber-300 mb-2 ${isMobile ? 'text-sm' : 'text-base'}`}
                >
                  Next Steps
                </h4>
                <ul className={`space-y-1 ${isMobile ? 'text-xs' : 'text-sm'}`}>
                  <li className="flex items-center gap-2">
                    ...
                    <span className="text-amber-200">
                      Register on Find an Apprenticeship portal
                    </span>
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-3 w-3 text-amber-400" />
