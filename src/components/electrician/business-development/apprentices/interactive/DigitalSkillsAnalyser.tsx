...
const DigitalSkillsAnalyser = () => {
  ...
  const calculateResults = () => {
    ...
    if (percentage >= 85) {
      ...
      recommendation =
        'Excellent candidate ready for minimal supervision and accelerated progression.';
      ...
      <div className="space-y-6">
        <div className="border-blue-500/20 bg-blue-500/10 rounded-lg p-4">
          ...
          <div className="text-center mb-6">
            <div
              className={`inline-flex items-center gap-2 px-4 py-2 rounded-lg ${results.level.bg}`}
            >
          ...
          <div className="mb-6">
            ...
            <div className="space-y-3">
              {skillsQuestions.map((question, index) => (
                <div
                  key={index}
                  className="flex justify-between items-center p-3 bg-elec-dark/50 rounded"
                >
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="text-center text-blue-200 text-xs mt-4">
        This assessment helps identify training priorities and development needs for new
        apprentices.
      </div>
    </div>
  );
