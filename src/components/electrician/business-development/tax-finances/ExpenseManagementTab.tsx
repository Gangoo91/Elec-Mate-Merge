    ...
    <div className="space-y-6">
      <Alert className="border-green-500/50 bg-green-500/10">
        ...
        <AlertDescription className="text-green-300 font-medium">
          Proper expense management can significantly reduce your tax liability. Keep detailed
          records and understand what qualifies as a legitimate business expense for electrical
          contractors.
        </AlertDescription>
      </Alert>
