...
export const FinancialInsights = ({
  ...
  const electricianSpecificMetrics = [
    ...
    {
      title: 'VAT Planning',
      icon: <Calendar className="h-5 w-5 text-elec-yellow" />,
      value: 'Quarterly',
      ...
      <Card className="border-elec-yellow/20 bg-elec-card">
        ...
        <CardContent className="space-y-4">
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <div className="p-4 rounded-lg bg-white/[0.04] border border-white/[0.10]">
              <h4 className="font-medium text-elec-yellow mb-2">Cost Management</h4>
              <ul className="text-sm space-y-1 text-white">
                <li>• Negotiate bulk supplier discounts</li>
                <li>• Optimise vehicle routes and fuel costs</li>
            ...
            <div className="p-4 rounded-lg bg-white/[0.04] border border-white/[0.10]">
              <h4 className="font-medium text-elec-yellow mb-2">Cash Flow Improvement</h4>
              <ul className="text-sm space-y-1 text-white">
