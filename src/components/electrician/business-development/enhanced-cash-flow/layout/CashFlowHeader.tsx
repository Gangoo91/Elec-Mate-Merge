        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <button className="h-11 px-3 sm:px-4 flex items-center gap-2 rounded-xl bg-white/5 border border-white/10 text-white hover:bg-white/10 transition-colors touch-manipulation">
