      ...
      <CardContent>
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
          ...
          <div className="text-center p-3 sm:p-4 rounded-lg bg-elec-dark/50">
            <div
              className={`text-2xl sm:text-3xl font-bold ${netProfit >= 0 ? 'text-green-400' : 'text-red-400'}`}
            >
          ...
          <div className="text-center p-3 sm:p-4 rounded-lg bg-elec-dark/50">
            <div
              className={`text-2xl sm:text-3xl font-bold ${minBalance >= 0 ? 'text-green-400' : 'text-red-400'}`}
            >
          ...
          <div className="text-center p-3 sm:p-4 rounded-lg bg-elec-dark/50">
            {cashRunway === 0 ? (
              <>
                <div className="text-lg sm:text-xl text-elec-light/60 font-medium">
                  Not calculated
                </div>
        ...
        {minBalance < 0 && monthWithNegativeBalance && (
          <Alert variant="destructive" className="mt-4">
            ...
            <AlertDescription>
              <strong>Critical:</strong> Your cash balance goes negative in Month{' '}
              {monthWithNegativeBalance}. You need to secure additional funding or reduce expenses.
            </AlertDescription>
          </Alert>
        )}
      </CardContent>
