  ...
  const emergencyResponseProtocols = [
    {
      ...
      triggerSigns: [
        'Delayed payments beyond normal terms',
        'Reduction in order volume',
        'Changes in payment methods',
        'Difficulty contacting client',
      ],
      immediateActions: [
    ...
    },
    {
      ...
      triggerSigns: [
        ...
        'Certification standard updates',
      ],
      immediateActions: [
    ...
    <div className="space-y-4">
      <Alert className="border-yellow-500/50 bg-yellow-500/10">
        ...
        <AlertDescription className="text-yellow-200">
          Future protection strategies reduce repeat issues by 80% and build business resilience
          ...
          <MobileAccordionContent>
            {[
              ...
              },
              {
                ...
                effectiveness:
                  '90% retention rate and 95% payment compliance from relationship clients',
              },
            ].map((strategy, index) => (
              <div key={index} className="border border-green-500/20 rounded-lg p-3 space-y-3">
                <div className="flex flex-col gap-2">
            ...
            {emergencyResponseProtocols.map((protocol, index) => (
              <div key={index} className="border border-red-500/20 rounded-lg p-3 space-y-3">
                <div className="flex flex-col gap-2">
                  ...
                  <p className={`${isMobile ? 'text-xs' : 'text-sm'} text-red-300 italic`}>
                    Response Time: {protocol.timeframe}
                  </p>
                </div>
