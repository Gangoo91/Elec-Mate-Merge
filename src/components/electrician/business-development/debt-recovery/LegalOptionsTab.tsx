...
const LegalOptionsTab = () => {
  ...
  const postJudgmentRecovery = [
    ...
    },
    {
      ...
      description:
        'Court order requiring debtor to attend court and disclose their financial position',
      process: [
    ...
    <div className="space-y-4">
      <Alert className="border-purple-500/50 bg-purple-500/10">
        ...
        <AlertDescription className="text-purple-200">
          Legal action should be the last resort, but when used correctly, achieves 92% success
          rates in well-documented cases.
        </AlertDescription>
      </Alert>
            ...
            {legalPreparationRequirements.map((category, index) => (
              <div key={index} className="border border-blue-500/20 rounded-lg p-3 space-y-3">
                <div className="flex flex-col gap-2">
                  ...
                  <p className={`${isMobile ? 'text-xs' : 'text-sm'} text-blue-300 italic`}>
                    {category.importance}
                  </p>
                </div>
