  ...
  const financialSystems = [
    {
      ...
      description:
        'Systematic approach to managing cash flow, payments, and financial forecasting for business stability',
      components: [
    ...
    },
    {
      ...
      description:
        'Detailed analysis and improvement of profit margins across all services and customer segments',
      components: [
    ...
    },
    {
      ...
      description:
        'Comprehensive tax planning and compliance management to minimise tax liability and ensure regulatory compliance',
      components: [
    ...
    },
    {
      ...
      description:
        'Strategic approach to business funding, investment planning, and capital allocation for growth',
      components: [
  ...
  const financialBenchmarks = [
    {
      ...
      benchmarks: [
        ...
        { metric: 'Net Profit Margin', target: '15-25%', current: 'After all expenses' },
        {
          ...
          current: 'On major equipment purchases',
        },
        {
          metric: 'Revenue per Employee',
          target: '£80-120k annually',
          current: 'Including owner productivity',
        },
      ],
    },
    {
      ...
      benchmarks: [
        ...
        },
        {
          ...
          target: '30-60 days',
          current: 'Cash-to-cash cycle time',
        },
        {
          metric: 'Emergency Fund',
          target: '3-6 months expenses',
          current: 'Operating expense coverage',
        },
      ],
    },
  ];
    ...
    <div className="space-y-4">
      <Alert className="border-elec-yellow/50 bg-elec-yellow/10">
        ...
        <AlertDescription className="text-elec-yellow">
          Effective financial management can improve profit margins by 15-30% while ensuring
      ...
      <MobileAccordion type="single" collapsible className="space-y-2">
        {financialSystems.map((system) => (
          <MobileAccordionItem key={system.id} value={system.id}>
            <MobileAccordionTrigger
              icon={
                system.id === 'cash-flow-management' ? (
                  <CreditCard className="h-5 w-5 text-blue-400" />
                ) : system.id === 'profit-margin-optimisation' ? (
                  <TrendingUp className="h-5 w-5 text-green-400" />
                ) : system.id === 'tax-planning-compliance' ? (
            ...
            <div className="bg-elec-gray border border-elec-yellow/20 rounded-b-lg p-4 space-y-4">
              ...
              <div className="space-y-4">
                {riskManagement.map((category, index) => (
                  <div key={index}>
                    <h5
                      className={`font-medium text-red-300 mb-3 ${isMobile ? 'text-xs' : 'text-sm'}`}
                    >
                      {category.category}
                    </h5>
