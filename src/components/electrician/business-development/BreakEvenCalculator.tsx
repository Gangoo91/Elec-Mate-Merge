              ...
              >
                ...
                <div className="relative">
                  ...
                  <div className="flex items-center gap-2 mt-3">
                    ...
                    <span className={`text-ios-footnote text-${businessStatus.color}-400`}>
                      {businessStatus.text}
                    </span>
                  </div>
                </div>
              ...
              <section>
                ...
                <div className="bg-white/5 rounded-2xl overflow-hidden border border-white/10 divide-y divide-white/10">
                  <IOSInput
                    ...
                    onChange={(e) =>
                      updateBusinessInput('fixedCosts', parseFloat(e.target.value) || 0)
                    }
                  ...
                  <IOSInput
                    ...
                    onChange={(e) =>
                      updateBusinessInput('variableCostPercentage', parseFloat(e.target.value) || 0)
                    }
                  ...
                  <IOSInput
                    ...
                    onChange={(e) =>
                      updateBusinessInput('averageJobValue', parseFloat(e.target.value) || 0)
                    }
              ...
              <section>
                ...
                <div className="bg-white/5 rounded-2xl overflow-hidden border border-white/10 divide-y divide-white/10">
                  <IOSInput
                    ...
                    onChange={(e) =>
                      updateJobInput('materialCosts', parseFloat(e.target.value) || 0)
                    }
              ...
              <section>
                ...
                <div className="bg-white/5 rounded-2xl overflow-hidden border border-white/10">
                  <IOSInput
                    ...
                    onChange={(e) =>
                      updateJobInput('desiredProfit', parseFloat(e.target.value) || 0)
                    }
