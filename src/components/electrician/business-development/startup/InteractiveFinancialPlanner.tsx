...
const InteractiveFinancialPlanner = () => {
  ...
  const profitMargin =
    potentialAnnualRevenue > 0 ? (grossProfit / potentialAnnualRevenue) * 100 : 0;
                  ...
                  {breakEvenMonths > 0 && (
                    <div className="p-4 bg-emerald-500/20 rounded-lg text-center">
                      ...
                      <p className="text-emerald-100">
                        You'll break even in approximately{' '}
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex flex-col gap-2 p-4 bg-emerald-500/20 rounded">
                        ...
                        >
                          {startupCosts.workingCapital > 0
                            ? `${(startupCosts.workingCapital / totalMonthlyExpenses).toFixed(1)} months`
                            : 'Not set'}
                        </Badge>
