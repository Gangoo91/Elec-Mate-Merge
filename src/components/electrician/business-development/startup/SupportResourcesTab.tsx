...
import { Phone, Globe, Users, BookOpen, ExternalLink, FileText } from "lucide-react";
...
const SupportResourcesTab = () => {
  ...
  return (
    <div className="space-y-6">
      <MobileAccordion type="single" collapsible className="w-full space-y-4">
        ...
        {/* Industry Events */}
        <MobileAccordionItem value="events">
          <MobileAccordionTrigger 
        ...
        <MobileAccordionItem value="documentation">
          <MobileAccordionTrigger 
            ...
            className="border-elec-yellow/50 bg-elec-yellow/10 text-elec-yellow"
          >
