...
import { TrendingUp, MapPin, Users, PoundSterling, Zap, Home, Building, AlertTriangle } from "lucide-react";
            ...
            {regionalInsights.map((region, index) => (
              <Card key={index} className="bg-orange-500/20 border-orange-400/30">
                ...
                <CardContent className="pt-0 space-y-3">
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-orange-300">Daily Rate Range:</span>
