...
const LegalComplianceTab = () => {
  ...
  const businessRegistration = [
    ...
    },
    {
      ...
      businessImpact:
        'Professional credibility and liability protection with potential tax benefits',
      considerations: [
    ...
    <div className="space-y-4">
      <Alert className="border-red-500/50 bg-red-500/10">
        ...
        <AlertDescription className="text-red-200">
          Legal compliance is mandatory - 98% of electrical businesses face legal issues without
