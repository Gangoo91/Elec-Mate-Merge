...
const OnboardingTab = () => {
  ...
  const onboardingFramework = [
    ...
    },
    {
      ...
      kpis: [
        ...
        'Safety knowledge test scores',
        'System access setup time',
      ],
    },
    {
  ...
  const trainingAreas = [
    ...
    },
    {
      ...
      items: [
        'Company installation methods',
        'Preferred suppliers and materials',
    ...
    <div className="space-y-4">
      <Alert className="border-green-500/50 bg-green-500/10">
        ...
        <AlertDescription className="text-green-200">
          Structured onboarding increases employee retention by 82% and reduces time to productivity
          by 60%.
        </AlertDescription>
      </Alert>
                ...
                {successMetrics.map((metric, index) => (
                  <div key={index} className="border border-orange-500/20 rounded-lg p-3 space-y-2">
                    ...
                    <div className="flex justify-between items-center">
                      <div>
                        <div className={`${isMobile ? 'text-xs' : 'text-sm'} text-orange-100`}>
                    ...
                    <p className={`${isMobile ? 'text-xs' : 'text-sm'} text-orange-100`}>
                      {metric.description}
                    </p>
                  </div>
                ))}
