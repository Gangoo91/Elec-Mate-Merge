  ...
  const modernRecruitmentStrategy = [
    {
      ...
      employerBenefit:
        'Reduce recruitment costs by 40% as quality candidates approach you directly',
  ...
  const selectionFramework = [
    {
      ...
      successTips: [
        'Use standardised scoring criteria',
        'Verify all qualifications directly',
        'Check recent project experience',
      ],
    },
    {
      ...
      successTips: [
        'Include team members in assessment',
        'Use job-relevant scenarios',
  ...
  const costInvestmentAnalysis = [
    {
      ...
      costs: [
        {
          item: 'Professional job board advertising',
          amount: '£800-1,500',
          timeframe: 'Per campaign',
        },
        {
          item: 'Recruitment agency fees (if used)',
          amount: '£5,000-12,500',
          timeframe: 'Per successful hire',
        },
        {
          item: 'Assessment and interview resources',
          amount: '£300-600',
          timeframe: 'Per hire process',
        },
        {
          item: 'Background checks and verification',
          amount: '£200-400',
          timeframe: 'Per successful hire',
        },
      ],
    ...
    },
    {
      ...
      benefits: [
        {
          item: 'Reduced training time (qualified electrician)',
          amount: '£2,000-4,000',
          benefit: 'Immediate productivity',
        },
        {
          item: 'Lower supervision requirements',
          amount: '£1,500-3,000',
          benefit: 'Management time savings',
        },
        {
          item: 'Quality work reduces call-backs',
          amount: '£1,000-2,500',
          benefit: 'Reputation protection',
        },
        {
          item: 'Customer satisfaction and retention',
          amount: '£3,000-8,000',
          benefit: 'Ongoing revenue',
        },
      ],
    ...
    <div className="space-y-4">
      <Alert className="border-green-500/50 bg-green-500/10">
        ...
        <AlertDescription className="text-green-200">
          Quality electrician recruitment reduces project delays by 60% and increases customer
          satisfaction ratings significantly.
        </AlertDescription>
      </Alert>
            ...
            <div className="bg-elec-gray border border-elec-yellow/20 rounded-b-lg p-4 space-y-3">
              <div className="grid grid-cols-1 gap-2">
                <Button
                  ...
                  onClick={() => openExternalUrl('https://www.electricaljobs.com/')}
                >
                ...
                <Button
                  ...
                  onClick={() => openExternalUrl('https://www.linkedin.com/business/talent/')}
                >
                ...
                <ul className={`space-y-1 ${isMobile ? 'text-xs' : 'text-sm'}`}>
                  <li className="flex items-center gap-2">
                    ...
                    <span className="text-amber-200">
                      Define ideal candidate profile and requirements
                    </span>
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-3 w-3 text-amber-400" />
