              ...
              <div className="grid grid-cols-1 gap-2">
                ...
                >
                  ...
                  <div className="text-left flex-1 min-w-0">
                    <div className={`${isMobile ? 'text-sm' : 'text-base'} text-foreground truncate`}>ElectricalJobs.com</div>
                ...
                >
                  ...
                  <div className="text-left flex-1 min-w-0">
                    <div className={`${isMobile ? 'text-sm' : 'text-base'} text-foreground truncate`}>ECA Member Network</div>
                ...
                >
                  ...
                  <div className="text-left flex-1 min-w-0">
                    <div className={`${isMobile ? 'text-sm' : 'text-base'} text-foreground truncate`}>LinkedIn Talent Solutions</div>
