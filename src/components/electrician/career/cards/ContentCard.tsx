...
const ContentCard = ({
  ...
  return (
    ...
    >
      ...
      {/* Description */}
      <p className="text-xs text-white leading-relaxed line-clamp-2 mb-3">{description}</p>
        ...
        <div className="flex gap-3 pt-3 border-t border-white/10">
          {stats.slice(0, 3).map((stat, idx) => (
            <div key={idx} className="flex-1 min-w-0">
              <div className={cn('text-sm font-semibold truncate', colors.icon)}>{stat.value}</div>
