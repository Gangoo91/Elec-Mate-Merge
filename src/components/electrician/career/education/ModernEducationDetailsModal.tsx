...
const ModernEducationDetailsModal = ({
  programme,
  open,
  onOpenChange,
}: ModernEducationDetailsModalProps) => {
          ...
          <div className="relative -m-6 mb-6">
            <div className="relative h-48 sm:h-64 overflow-hidden">
              ...
              <div className="absolute bottom-4 left-4 right-4">
                ...
                <p className="text-elec-yellow text-lg font-semibold">{programme.institution}</p>
              </div>
            </div>
          </div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {programme.keyTopics.map((topic, index) => (
                      <Badge
                        key={index}
                        variant="outline"
                        className="text-foreground/80 border-white/20"
                      >
                        {topic}
                      </Badge>
                    ))}
