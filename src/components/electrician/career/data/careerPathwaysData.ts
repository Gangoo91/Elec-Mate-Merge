...
const careerOverviewItems: ContentItem[] = [
  {
    ...
    content: {
      overview:
        'The electrical industry offers a clear, structured career path with defined stages. Each stage builds on the previous, with increasing responsibility, skills, and earning potential.',
      sections: [
        {
  ...
  },
  {
    ...
    content: {
      overview:
        'The electrical industry offers diverse career pathways. Choose based on your interests, aptitudes, and market demand.',
      sections: [
        {
  ...
  },
  {
    ...
    content: {
      overview:
        'There are multiple pathways into the electrical industry, each suited to different circumstances and career goals.',
      sections: [
        {
  ...
  },
  {
    ...
    content: {
      overview:
        'Electricians work across virtually every sector of the economy. Each sector offers different challenges, pay scales, and career opportunities.',
      sections: [
        {
  ...
  },
  {
    ...
    content: {
      overview:
        'Many electricians progress to running their own business. With proper planning, you can build a profitable enterprise while maintaining work-life balance.',
      sections: [
        {
  ...
  },
  {
    ...
    content: {
      overview:
        'Success in the electrical industry requires more than technical skills. These proven strategies will help you advance faster and earn more.',
      sections: [
        {
  ...
  },
  {
    ...
    content: {
      overview:
        'The UK electrical industry is undergoing significant transformation driven by decarbonization, digitalization, and skills shortages.',
      sections: [
        {
  ...
  },
  {
    ...
    content: {
      overview:
        "Beyond trade qualifications, there's a professional pathway leading to Chartered Engineer status and industry leadership roles.",
      sections: [
        {
...
const skillsDevelopmentItems: ContentItem[] = [
  {
    ...
    content: {
      overview:
        'Foundation skills form the bedrock of your electrical career. Master these before progressing to more complex work.',
      sections: [
        {
  ...
  },
  {
    ...
    content: {
      overview:
        'Intermediate skills enable you to work more independently and take on complex installation work.',
      sections: [
        {
  ...
  },
  {
    ...
    content: {
      overview:
        'Digital skills are increasingly essential as buildings become smarter and work processes digitize.',
      sections: [
        {
          title: 'Digital Tools',
          icon: Laptop,
  ...
  },
  {
    ...
    content: {
      overview:
        'Technical skills get you the job, but soft skills drive career progression and business success.',
      sections: [
        {
          title: 'Communication',
          icon: Users,
  ...
  },
  {
    ...
    content: {
      overview:
        'Stay ahead of the curve by developing competence in technologies that will define the next decade.',
      sections: [
        {
  ...
  },
  {
    ...
    content: {
      overview:
        'A structured framework helps you plan development activities and track progress toward career goals.',
      sections: [
        {
          title: 'Assessment',
          icon: CheckCircle,
  ...
  },
  {
    ...
    content: {
      overview:
        'Skills demand varies significantly across UK regions. Understanding local needs helps target your development.',
      sections: [
        {
  ...
  },
  {
    ...
    content: {
      overview:
        'Certain skills command premium rates in the current market. Focus development on high-value competencies.',
      sections: [
        {
...
const professionalDevelopmentItems: ContentItem[] = [
  {
    ...
    content: {
      overview:
        'Continuing Professional Development (CPD) is essential for maintaining competence and progressing your career.',
      sections: [
        {
  ...
  },
  {
    ...
    content: {
      overview:
        'Your professional network is one of your most valuable career assets. Most opportunities come through connections.',
      sections: [
        {
  ...
  },
  {
    ...
    content: {
      overview:
        'Leadership skills unlock senior positions and significantly higher earning potential.',
      sections: [
        {
  ...
  },
  {
    ...
    content: {
      overview:
        'Your digital presence increasingly influences career opportunities and business success.',
      sections: [
        {
  ...
  },
  {
    ...
    content: {
      overview:
        'The electrical industry offers significant opportunities for innovation and business creation.',
      sections: [
        {
  ...
  },
  {
    ...
    content: {
      overview:
        'A sustainable career requires attention to physical and mental health. The industry is increasingly recognizing this.',
      sections: [
        {
  ...
  },
  {
    ...
    content: {
      overview:
        "Experienced electricians can influence the industry's future through leadership and advocacy.",
      sections: [
        {
  ...
  },
  {
    ...
    content: {
      overview:
        'UK electrical qualifications are respected globally, opening international career opportunities.',
      sections: [
        {
          title: 'Recognition',
          icon: CheckCircle,
  ...
  },
  {
    ...
    content: {
      overview:
        'A collection of practical tools and templates for managing your electrical career.',
      sections: [
        {
...
const industryInsightsItems: ContentItem[] = [
  {
    ...
    content: {
      overview:
        'The UK electrical industry is experiencing unprecedented transformation driven by decarbonization and digitalization.',
      sections: [
        {
  ...
  },
  {
    ...
    content: {
      overview:
        'Anticipating future skills demand helps you invest in the right development today.',
      sections: [
        {
...
const careerTimelineItems: ContentItem[] = [
  ...
  },
  {
    ...
    content: {
      overview:
        "The improver stage bridges the gap between apprentice and qualified status. You're building competence and working toward your AM2 assessment.",
      sections: [
        {
          title: 'Key Qualifications',
          icon: GraduationCap,
...
const jibGradesItems: ContentItem[] = [
  ...
  },
  {
    ...
    content: {
      overview:
        'The improver grade covers qualified electricians working toward their AM2 assessment and Gold Card status.',
      sections: [
        {
          title: 'Requirements',
          icon: CheckCircle,
  ...
  },
  {
    ...
    content: {
      overview:
        'The Gold Card represents full qualification as an electrician with UK-wide recognition and independent working authority.',
      sections: [
        {
          title: 'Requirements',
          icon: CheckCircle,
  ...
  },
  {
    ...
    content: {
      overview:
        'Supervisors combine technical competence with management skills to lead teams and deliver projects safely and effectively.',
      sections: [
        {
          title: 'Requirements',
          icon: CheckCircle,
...
const regionalMarketsItems: ContentItem[] = [
  {
    ...
    content: {
      overview:
        'The UK electrical job market varies significantly by region, with differences in pay, demand, and specialisations.',
      sections: [
        {
  ...
  },
  {
    ...
    content: {
      overview:
        'Job demand concentrates in major cities and regions with significant construction, industrial, or infrastructure activity.',
      sections: [
        {
          title: 'Top Cities',
          icon: Building,
  ...
  },
  {
    ...
    content: {
      overview:
        'Quality apprenticeship and training providers operate across all UK regions, with some specializing in particular sectors.',
      sections: [
        {
  ...
  },
  {
    ...
    content: {
      overview:
        'Higher pay in some regions is offset by higher living costs. Consider net disposable income when evaluating opportunities.',
      sections: [
        {
  ...
  },
  {
    ...
    content: {
      overview:
        'While national regulations apply, some regional variations and best practices exist across the UK.',
      sections: [
        {
  ...
  },
  {
    ...
    content: {
      overview:
        'Understanding key employers and projects helps you identify opportunities and target your job search.',
      sections: [
        {
  ...
  },
  {
    ...
    content: {
      overview:
        'The right agencies and job boards can help you find opportunities, whether permanent, contract, or temporary work.',
      sections: [
        {
