        ...
        <div>
          ...
          <div className="space-y-3">
            <FormField control={form.control} name="jobTitle" render={({ field }) => (
              <FormItem>
                <label className="text-white text-xs font-medium mb-1.5 block">Job Title *</label>
                <FormControl>
            ...
            <FormField control={form.control} name="workStartDate" render={({ field }) => (
              <FormItem>
                <label className="text-white text-xs font-medium mb-1.5 block">Work Completion Date</label>
                <FormControl>
