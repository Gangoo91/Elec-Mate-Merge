...
export const MaterialSearchEnhanced = ({
  onAddMaterial,
  currentQuoteItems = [],
}: MaterialSearchEnhancedProps) => {
        ...
        tabs={[
                      ...
                      <CardContent className="p-6">
                        <div className="space-y-4">
                          <div className="flex items-start justify-between gap-4">
                            <div className="flex items-center gap-2">
                              <h4
                                className={`text-lg font-semibold ${alreadyInQuote ? 'text-slate-400' : 'text-foreground'}`}
                              >
                                {material.name}
                                {alreadyInQuote && (
                                  <span className="text-xs ml-2 text-slate-500">(In Quote)</span>
                                )}
                              </h4>
                            ...
                            <div className="text-right">
                              ...
                              <div className="text-sm text-elec-light/60">per {material.unit}</div>
                            </div>
                          </div>
            ...
            content: (
              <div className="space-y-4">
                <p className="text-sm text-elec-light/80">
                  Most frequently used materials in quotes
                </p>
                <div className="grid gap-4">
                  {enhancedMaterials
                    .filter((m) =>
                      ['socket-13a-dp', 'cable-te-2.5', 'mcb-32a-b', 'led-downlight-fire'].includes(
                        m.id
                      )
                    )
                    .map((material) => (
          ...
          },
          {
            ...
            content: (
              <div className="space-y-4">
                <p className="text-sm text-elec-light/80">
                  Pre-configured material packages for common jobs
                </p>
                <div className="grid gap-4">
                  ...
                  <Card className="bg-card/50 border-elec-yellow/20">
                    ...
                    <CardContent>
                      <p className="text-sm text-elec-light/80 mb-3">
                        Complete materials for 3-bedroom house: sockets, lights, switches, cables,
                        consumer unit & shower
                      </p>
