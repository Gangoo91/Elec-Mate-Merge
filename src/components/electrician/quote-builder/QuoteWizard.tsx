  ...
  const handleVoiceFillField = useCallback(
    (fieldName: string, value: string) => {
      ...
      // Settings fields
        ...
        updateSettings({
          ...quote.settings,
          vatRegistered: value.toLowerCase() === 'yes' || value === 'true',
        });
      }
    },
    ...
    const stepFields: Record<number, FormField[]> = {
      0: [
        ...
        },
        {
          ...
          type: 'text',
          required: true,
          currentValue: quote.client?.address,
        },
        {
          ...
          type: 'text',
          required: true,
          currentValue: quote.client?.postcode,
        },
      ],
      1: [
        {
        ...
        },
        {
          ...
          label: 'Duration',
          type: 'select',
          options: ['Half day', '1 day', '2 days', '3 days', '1 week', '2 weeks'],
          currentValue: quote.jobDetails?.estimatedDuration,
        },
      ],
      2: [
        {
          ...
          type: 'select',
          options: ['Yes', 'No'],
          currentValue: quote.settings?.vatRegistered ? 'Yes' : 'No',
        },
      ],
    };
