...
const FinancialSnapshot: React.FC<FinancialSnapshotProps> = ({ isOpen, onClose, quotes }) => {
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {metrics.map((metric, index) => (
              <Card
                key={index}
                className="border-0 shadow-lg bg-gradient-to-br from-card to-card/50"
              >
                    ...
                    <div className="space-y-3">
                      <div className="flex justify-between items-center py-2 px-3 rounded-lg bg-gray-50 dark:bg-gray-800/50">
                        ...
                        <span className="font-mono text-sm font-semibold">
                          {formatCurrency(breakdown.totalRevenue - breakdown.vatTotal)}
                        </span>
                      </div>
                      <div className="flex justify-between items-center py-2 px-3 rounded-lg bg-gray-50 dark:bg-gray-800/50">
                        <span className="text-sm font-medium">VAT:</span>
                        <span className="font-mono text-sm font-semibold">
                          {formatCurrency(breakdown.vatTotal)}
                        </span>
                      </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex justify-between items-center py-2 px-3 rounded-lg bg-gray-50 dark:bg-gray-800/50">
                        ...
                        <span className="font-mono text-sm font-semibold">
                          {formatCurrency(breakdown.labourTotal)}
                        </span>
                      </div>
                      <div className="flex justify-between items-center py-2 px-3 rounded-lg bg-gray-50 dark:bg-gray-800/50">
                      ...
                      <div className="flex justify-between items-center py-3 px-3 rounded-lg bg-red-100 dark:bg-red-900/30 border border-red-200 dark:border-red-800">
                        ...
                        <span className="font-mono font-bold text-red-800 dark:text-red-200">
                          {formatCurrency(breakdown.totalCosts)}
                        </span>
                      </div>
                    </div>
                  </div>
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                  <div className="space-y-2">
                    <div className="flex items-center gap-2">
                      <TrendingUp
                        className={`h-5 w-5 ${breakdown.totalProfit >= 0 ? 'text-green-600' : 'text-red-600'}`}
                      />
                  ...
                  <div className="text-right">
                    <div
                      className={`text-2xl font-bold font-mono ${breakdown.totalProfit >= 0 ? 'text-green-600' : 'text-red-600'}`}
                    >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                ...
                <div className="p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
                  ...
                  <div className="text-blue-600 dark:text-blue-300">
                    {breakdown.profitMargin >= 20
                      ? 'Healthy margins'
                      : breakdown.profitMargin >= 10
                        ? 'Moderate margins'
                        : breakdown.profitMargin > 0
                          ? 'Low margins'
                          : 'Operating at loss'}
                  </div>
                </div>
                ...
                <div className="p-3 bg-purple-50 dark:bg-purple-900/20 rounded-lg border border-purple-200 dark:border-purple-800">
                  ...
                  <div className="text-purple-600 dark:text-purple-300">
                    {breakdown.averageQuoteValue > 1000
                      ? 'High-value projects'
                      : breakdown.averageQuoteValue > 500
