  ...
  const [resources] = useState<SafetyResource[]>([
    {
      ...
      description:
        'Comprehensive guide to safe isolation procedures for electrical work, including step-by-step instructions and safety checks.',
      type: 'guide',
    ...
    },
    {
      ...
      description:
        'Interactive video training module covering arc flash hazards, risk assessment, and protection measures.',
      type: 'video',
      category: 'Training',
      downloadCount: 1567,
      rating: 4.9,
    ...
    },
    {
      ...
      description:
        'Customisable daily safety checklist for electrical contractors and site supervisors.',
      type: 'template',
    ...
    },
    {
      ...
      description:
        'Monthly PPE inspection checklist to ensure all safety equipment meets required standards.',
      type: 'checklist',
      category: 'PPE',
      downloadCount: 1789,
      rating: 4.6,
    ...
    },
    {
      ...
      description:
        'Ready-to-use toolbox talk on electrical work at height, including ladder safety and access equipment.',
      type: 'toolbox-talk',
    ...
    },
    {
      ...
      description:
        'Step-by-step emergency response procedures for electrical incidents and first aid guidance.',
      type: 'guide',
      category: 'Emergency',
      downloadCount: 987,
      rating: 4.9,
