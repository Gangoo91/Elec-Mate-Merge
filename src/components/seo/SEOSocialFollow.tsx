...
interface SEOSocialFollowProps {
  className?: string;
}

export function SEOSocialFollow({ className = '' }: SEOSocialFollowProps) {
  return (
    <div className={`flex items-center gap-2 ${className}`}>
      <span className="text-xs font-medium text-white uppercase tracking-wider mr-1">Follow</span>
