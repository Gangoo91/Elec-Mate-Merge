      ...
      <DialogContent className="max-w-md p-0 overflow-hidden">
          ...
          <div className="relative">
            <DialogHeader className="space-y-3">
              <div className="flex items-center gap-3">
                ...
                <DialogTitle className="text-lg font-semibold">Draft Found</DialogTitle>
              </div>
        ...
        <div className="px-6 pb-2 space-y-4">
          <DialogDescription className="text-sm leading-relaxed">
            We found an existing EICR draft. Would you like to continue with your saved work or
            start a new report?
          </DialogDescription>
          ...
          <Card className="p-3 bg-elec-yellow/5 border-elec-yellow/20">
            <div className="flex items-start gap-2">
              ...
              <p className="text-xs text-muted-foreground">
                Starting a new report will preserve your draft in save points - nothing will be
                lost.
              </p>
            </div>
          </Card>
