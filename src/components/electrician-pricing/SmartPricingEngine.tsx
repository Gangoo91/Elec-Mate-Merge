  ...
  const calculatePricing = async () => {
    ...
    try {
      ...
      const locationMultiplier = Object.keys(locationMultipliers).find((key) =>
        ...
        ? locationMultipliers[
            Object.keys(locationMultipliers).find((key) => locationKey.includes(key))!
          ]
        : 1.0;
      ...
      const profitMargin =
        ((adjustedPrice - pricingFactors.materialsCost - basePrice) / adjustedPrice) * 100;
      ...
      const mockRecommendation: PricingRecommendation = {
        ...
        risks: [
          ...
          ...(adjustedPrice > competitiveRange.max
            ? ['Price above market range - may lose customers']
            : []),
          ...(pricingFactors.complexity === 'complex'
            ? ['Complex job - ensure adequate time allocation']
            : []),
        ],
      };
      ...
      <Card className="border-elec-yellow/20 bg-elec-gray">
        <CardHeader>
          ...
          <p className="text-sm text-muted-foreground">
            Get intelligent pricing recommendations based on job requirements, location, and market
            conditions
          </p>
        </CardHeader>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  handleInputChange('materialsCost', parseFloat(e.target.value) || 0)
                }
                className="bg-elec-gray border-elec-yellow/30"
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  handleInputChange('travelDistance', parseFloat(e.target.value) || 0)
                }
                className="bg-elec-gray border-elec-yellow/30"
              />
            </div>
              ...
              <div className="mt-4 grid grid-cols-3 gap-4 text-sm">
                <div>
                  ...
                  <div className="text-muted-foreground">
                    £{recommendation.basePrice.toFixed(0)}
                  </div>
                </div>
                <div>
                ...
                <div>
                  ...
                  <div className="text-muted-foreground">
                    £{recommendation.competitiveRange.min.toFixed(0)} - £
                    {recommendation.competitiveRange.max.toFixed(0)}
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                <div className="text-center p-3 bg-elec-gray/50 rounded-lg">
                  ...
                  <div className="text-xs text-muted-foreground">
                    +{((recommendation.factors.location - 1) * 100).toFixed(0)}%
                  </div>
                </div>
                <div className="text-center p-3 bg-elec-gray/50 rounded-lg">
                  ...
                  <div className="text-xs text-muted-foreground">
                    {recommendation.factors.complexity}x
                  </div>
                </div>
                <div className="text-center p-3 bg-elec-gray/50 rounded-lg">
                  ...
                  <div className="text-xs text-muted-foreground">
                    {recommendation.factors.urgency}x
                  </div>
                </div>
                <div className="text-center p-3 bg-elec-gray/50 rounded-lg">
                  ...
                  <div className="text-xs text-muted-foreground">
                    +{((recommendation.factors.market - 1) * 100).toFixed(0)}%
                  </div>
                </div>
              </div>
            </div>
