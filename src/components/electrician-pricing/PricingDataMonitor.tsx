  ...
  const getDataSourceBadge = (source: string) => {
    switch (source) {
      case 'market_research':
        return { variant: 'success' as const, label: 'Market Research' };
      case 'reed_api':
        return { variant: 'default' as const, label: 'Live API Data' };
      case 'mock_realistic':
        return { variant: 'warning' as const, label: 'Sample Data' };
      default:
        return { variant: 'outline' as const, label: 'Mixed Sources' };
    }
  };
      ...
      <Card className="border-elec-yellow/20 bg-elec-gray">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            {approximateCount > totalRecords * 0.3 && (
              <div className="flex items-center gap-2 text-sm text-orange-600">
                ...
                <span>
                  High proportion of estimated data - community submissions would improve accuracy
                </span>
              </div>
            )}
          </div>
          ...
          <div className="text-xs text-muted-foreground bg-elec-yellow/5 p-3 rounded-lg">
            <strong>Coverage Information:</strong> Our pricing data combines market research, live
            job boards, and community submissions from UK electricians. Prices are updated nightly
            with higher accuracy in metropolitan areas. Community-verified prices provide the most
