...
import { AlertTriangle, Database, RefreshCw, MessageSquare, CheckCircle, AlertCircle } from "lucide-react";
    ...
    <Card className="border-elec-yellow/20 bg-elec-gray">
      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          {approximateCount > totalRecords * 0.3 && (
            <div className="flex items-center gap-2 text-sm text-orange-600">
              ...
              <span>High proportion of estimated data - consider getting quotes for accurate pricing</span>
            </div>
          )}
        </div>
        ...
        <div className="text-xs text-muted-foreground bg-elec-yellow/5 p-3 rounded-lg">
          <strong>Coverage Information:</strong> Our pricing data covers major UK regions with higher accuracy in metropolitan areas. 
          Prices are updated nightly from multiple sources including job boards and market research. 
          For the most accurate quotes, always consult multiple local electricians.
        </div>
      </CardContent>
    </Card>
  );
