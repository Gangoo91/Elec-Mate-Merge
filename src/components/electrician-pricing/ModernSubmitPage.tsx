    ...
    const fetchRealStats = async () => {
      try {
        ...
        const approvedSubmissions =
          submissionsData?.filter((s) => s.verification_status === 'approved').length || 0;
  ...
  const benefits = [
    {
      ...
      description:
        'Share your real pricing data to help other electricians stay competitive and price jobs accurately across the UK.',
    },
    {
      icon: TrendingUp,
      title: 'Build Industry Database',
      description:
        'Contribute to the most comprehensive UK electrical pricing database, with regional accuracy and real-world data.',
    },
    {
      icon: Shield,
      title: 'Anonymous & Secure',
      description:
        'All submissions are completely anonymous. We protect your privacy while building valuable community resources.',
    },
    {
      icon: Award,
      title: 'BS7671 Compliant',
      description:
        'Our pricing database follows BS7671 18th Edition standards, ensuring accuracy for modern electrical work.',
    },
  ];
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-12">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-6 sm:mb-8">
            {communityStats.map((stat, index) => (
              <Card
                key={index}
                className="text-center border-primary/20 hover:border-primary/40 transition-all duration-300"
              >
