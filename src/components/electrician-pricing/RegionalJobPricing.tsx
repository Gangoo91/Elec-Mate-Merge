...
const RegionalJobPricing = ({ regionalData }: RegionalJobPricingProps) => {
  ...
  const categories = [
    'all',
    ...new Set(regionalData.map((item) => item?.job_category).filter(Boolean)),
  ];
      ...
      <CardContent>
                    ...
                    >
                      <div className="flex-1">
                        <div className="flex flex-wrap items-center gap-2 mb-2">
                          ...
                          <Badge variant="secondary">{item.job_category}</Badge>
                        </div>
        ...
        <div className="mt-6 p-4 border border-elec-yellow/20 rounded-lg bg-elec-yellow/5">
          ...
          <p className="text-sm text-muted-foreground">
            ...
            complexity, and local factors. Always obtain multiple quotes for accurate pricing. Data
            sourced from market research and industry reports.
          </p>
        </div>
      </CardContent>
    </Card>
