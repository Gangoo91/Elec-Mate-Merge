        ...
        <div className="bg-purple-500/10 border border-purple-500/20 rounded-lg p-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs">
            <div className="bg-card rounded p-3">
              ...
              <p className="text-white">Reading: 500MΩ</p>
              <p className="text-white">Factor: 2.105</p>
              <p className="text-foreground">Corrected: 238MΩ</p>
            </div>
            <div className="bg-card rounded p-3">
              <p className="font-medium text-green-400 mb-2">Standard (20°C)</p>
              <p className="text-white">Reading: 300MΩ</p>
              <p className="text-white">Factor: 1.000</p>
              <p className="text-foreground">Corrected: 300MΩ</p>
            </div>
            <div className="bg-card rounded p-3">
              <p className="font-medium text-red-400 mb-2">Hot Weather (35°C)</p>
              <p className="text-white">Reading: 150MΩ</p>
              <p className="text-white">Factor: 0.475</p>
