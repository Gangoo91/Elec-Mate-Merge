...
import { BookOpen, Zap, Shield, Clock, Wrench, Brain, ChevronRight } from 'lucide-react';
          ...
          return (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <h3 className="text-[15px] font-medium text-white leading-tight">{module.title}</h3>
                <p className="text-[13px] text-white/50 leading-tight mt-0.5">{module.subtitle}</p>
              </div>
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0 pt-1">
                  ...
                  <p className="text-sm text-white/50 leading-relaxed mt-1">{module.subtitle}</p>
