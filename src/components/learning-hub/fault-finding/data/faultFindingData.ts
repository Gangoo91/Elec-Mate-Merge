    ...
    diagnostics: [
      {
        ...
        searchKeywords: ['harmonics', 'THD', 'power quality', 'distortion', 'equipment malfunction']
      },
      {
...
export const getAllDiagnostics = (): (Diagnostic & { categoryId: string; categoryTitle: string })[] => {
...
export const searchDiagnostics = (query: string): (Diagnostic & { categoryId: string; categoryTitle: string })[] => {
