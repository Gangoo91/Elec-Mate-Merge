// Fault Finding Data - Extracted from FaultFindingSection.tsx
// All data with TypeScript interfaces for the redesigned component architecture
...
export interface RealWorldFaultCategory {
  id: string;
  title: string;
  category: string;
  description: string;
...
export interface CommonFaultCategory {
  id: string;
  title: string;
  category: string;
  description: string;
...
// ============================================================================
// DIAGNOSTIC SCENARIOS DATA (9 categories)
// ============================================================================
    ...
    diagnostics: [
      {
        ...
        searchKeywords: ['high resistance', 'R1+R2', 'cpc', 'earth', 'continuity'],
      },
      {
        ...
        searchKeywords: ['open circuit', 'ring', 'infinite', 'break', 'disconnected'],
      },
      {
        ...
        searchKeywords: ['inconsistent', 'intermittent', 'variable', 'readings'],
      },
    ],
  },
  {
    ...
    diagnostics: [
      {
        ...
        searchKeywords: ['no power', 'loss of supply', '0V', 'no voltage', 'power cut'],
      },
      {
        ...
        searchKeywords: ['lost neutral', 'dangerous', 'PME', 'voltage on earth', 'live earth'],
      },
      {
        ...
        searchKeywords: ['voltage drop', 'under load', 'dim lights', 'low voltage'],
      },
    ],
  },
  {
    ...
    diagnostics: [
      {
        ...
        searchKeywords: ['RCD', 'trip time', 'slow', 'not tripping', 'RCCB'],
      },
      {
        ...
        searchKeywords: ['nuisance tripping', 'keeps tripping', 'random trip', 'leakage'],
      },
    ],
  },
  {
    ...
    diagnostics: [
      {
        ...
        searchKeywords: ['low insulation', 'IR', 'megger', 'breakdown', 'wet'],
      },
      {
        ...
        searchKeywords: ['marginal', 'borderline', '1MΩ', 'monitoring', 'deteriorating'],
      },
    ],
  },
  {
    ...
    diagnostics: [
      {
        ...
        searchKeywords: ['Zs', 'loop impedance', 'high', 'earth', 'disconnection time'],
      },
    ],
  },
  {
    ...
    diagnostics: [
      ...
      },
      {
        ...
        searchKeywords: ['transients', 'surges', 'spikes', 'nuisance trip', 'switching'],
      },
    ],
  },
  {
    ...
    diagnostics: [
      {
        ...
        searchKeywords: ['MCB trip', 'breaker', 'overload', 'current', 'load'],
      },
      {
        ...
        searchKeywords: ['unbalanced', 'three-phase', '3-phase', 'neutral', 'phase'],
      },
    ],
  },
  {
    ...
    diagnostics: [
      {
        ...
        searchKeywords: ['hot spot', 'thermal', 'overheating', 'warm', 'temperature'],
      },
      {
        ...
        searchKeywords: ['cable hot', 'overheating cable', 'PVC', 'temperature', 'derating'],
      },
    ],
  },
  {
    ...
    diagnostics: [
      {
        ...
        regulation: 'BS 7671: 443 - Protection against overvoltages',
        searchKeywords: ['intermittent', 'random', 'reset', 'voltage dip', 'transient'],
      },
      {
        ...
        searchKeywords: ['intermittent earth', 'random RCD', 'weather', 'moisture'],
      },
    ],
  },
];
...
// ============================================================================
// COMMON FAULT CATEGORIES DATA (6 items)
// ============================================================================

export const commonFaultCategories: CommonFaultCategory[] = [
  {
...
// ============================================================================
// REAL-WORLD FAULT CATEGORIES DATA (6 categories with examples)
// ============================================================================

export const realWorldFaultCategories: RealWorldFaultCategory[] = [
  {
...
export const getCategoryColor = (category: string): string => {
  const colors: Record<string, string> = {
    ...
    overcurrent: 'bg-red-500',
    earth_leakage: 'bg-yellow-500',
    supply_issues: 'bg-blue-500',
    lighting: 'bg-purple-500',
    earthing: 'bg-green-500',
    insulation: 'bg-violet-500',
    continuity: 'bg-green-500',
    voltage: 'bg-yellow-500',
    rcd: 'bg-purple-500',
    'power-quality': 'bg-blue-500',
    load: 'bg-orange-500',
    thermal: 'bg-red-500',
    transient: 'bg-purple-500',
  };
...
// Flatten all diagnostics for search functionality
export const getAllDiagnostics = (): (Diagnostic & {
  categoryId: string;
...
export const searchDiagnostics = (
  query: string
): (Diagnostic & { categoryId: string; categoryTitle: string })[] => {
...
// Get unique diagnostic categories for filter pills
export const getDiagnosticCategories = (): { id: string; title: string }[] => {
  return diagnosticScenarios.map((s) => ({ id: s.id, title: s.title }));
};
