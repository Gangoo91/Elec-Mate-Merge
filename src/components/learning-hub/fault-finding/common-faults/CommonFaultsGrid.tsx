...
const getCategoryConfig = (category: string) => {
  switch (category) {
    ...
    default:
      return { icon: Target, iconBg: 'bg-slate-500' };
  }
};
      ...
      <div>
        ...
        <div className="rounded-2xl bg-white/[0.03] border border-white/[0.06] overflow-hidden divide-y divide-white/[0.06]">
          {commonFaultCategories.map((fault: CommonFaultCategory) => {
            const config = getCategoryConfig(fault.category);
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center gap-2 flex-shrink-0">
                  <span className="text-[13px] text-white/30">{fault.commonSymptoms.length} symptoms</span>
