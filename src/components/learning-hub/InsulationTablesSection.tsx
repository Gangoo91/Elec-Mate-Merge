    ...
    <div className="bg-purple-500/10 border border-purple-500/20 rounded-lg p-4">
      <div className="flex items-center gap-2 mb-3">
        ...
        <h4 className="font-medium text-purple-400">
          BS 7671 Minimum Insulation Resistance Values
        </h4>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          <div className="bg-card rounded p-3">
            <p className="font-medium text-purple-400 mb-2">
              Circuit Nominal Voltage vs Test Voltage:
            </p>
            <div className="space-y-1 text-xs">
              <div className="overflow-x-auto">
                <div className="grid grid-cols-3 gap-2 font-mono min-w-[300px]">
                  ...
                  <div className="text-xs">SELV (≤50V)</div>
                  <div className="text-xs">250V DC</div>
                  <div className="text-xs">0.5 MΩ</div>
                  <div className="text-xs">LV (50V-500V)</div>
                  <div className="text-xs">500V DC</div>
                  <div className="text-xs">1.0 MΩ</div>
                  <div className="text-xs">LV (500V-1000V)</div>
                  <div className="text-xs">1000V DC</div>
                  <div className="text-xs">1.0 MΩ</div>
                </div>
              </div>
              <div className="bg-red-500/10 border border-red-500/20 rounded p-2 mt-3">
                <p className="text-red-400 font-medium text-xs">
                  <strong>Important:</strong> These are absolute minimum values. Investigation is
                  required for readings below 2.0MΩ on new installations.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-1 text-xs">
              <div className="overflow-x-auto">
                <div className="grid grid-cols-2 gap-2 min-w-[250px]">
                  ...
                  <div className="text-xs">Standard Test</div>
                  <div className="text-xs">1 minute</div>
                  <div className="text-xs">Periodic Test</div>
                  <div className="text-xs">1 minute</div>
                  <div className="text-xs">Initial Verification</div>
                  <div className="text-xs">1 minute</div>
                  <div className="text-xs">Fault Investigation</div>
                  <div className="text-xs">As required</div>
                </div>
              </div>
            ...
            <div className="space-y-1 text-xs">
              <div className="overflow-x-auto">
                <div className="grid grid-cols-2 gap-2 font-mono min-w-[200px]">
                  ...
                  <div className="text-xs">4.438</div>
                  <div className="text-xs">5</div>
                  <div className="text-xs">2.105</div>
                  <div className="text-xs">10</div>
                  <div className="text-xs">1.403</div>
                  <div className="text-xs">15</div>
                  <div className="text-xs">1.184</div>
                  <div className="text-xs">20</div>
                  <div className="text-xs">1.000</div>
                  <div className="text-xs">25</div>
                  <div className="text-xs">0.847</div>
                  <div className="text-xs">30</div>
                  <div className="text-xs">0.718</div>
                  <div className="text-xs">35</div>
                  <div className="text-xs">0.609</div>
                  <div className="text-xs">40</div>
                  <div className="text-xs">0.516</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="space-y-3 text-sm text-white">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          <div className="bg-card rounded p-3">
            ...
            <div className="space-y-1 text-xs">
              <p>
                <strong>Expected readings:</strong>
              </p>
          ...
          <div className="bg-card rounded p-3">
            ...
            <div className="space-y-1 text-xs">
              <p>
                <strong>Acceptable ranges by age:</strong>
              </p>
          ...
          <div className="bg-card rounded p-3">
            ...
            <div className="space-y-1 text-xs">
              <p>
                <strong>Immediate investigation:</strong>
              </p>
    ...
    <div className="bg-amber-500/10 border border-amber-500/20 rounded-lg p-4">
      ...
      <div className="space-y-3 text-sm text-white">
        <div className="bg-card rounded p-3">
          ...
          <div className="space-y-2 text-xs">
            <p>
              • <strong>Minimum acceptable:</strong> 0.5MΩ (BS 7671 Table 61)
            </p>
            <p>
              • <strong>Test voltage:</strong> 250V DC
            </p>
            <p>
              • <strong>Typical applications:</strong> Doorbells, thermostats, low voltage lighting
            </p>
            <div className="bg-red-500/10 border border-red-500/20 rounded p-2 mt-2">
              <p className="text-red-400 font-medium">
                <strong>Warning:</strong> 0.5MΩ is NOT acceptable for standard LV circuits
                (230V/400V)
              </p>
            </div>
          </div>
      ...
      <div className="space-y-3 text-sm text-white">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <div className="space-y-1 text-xs">
              <div className="overflow-x-auto">
                <div className="grid grid-cols-2 gap-2 min-w-[280px]">
                  ...
                  <div className="text-xs">PVC</div>
                  <div className="text-xs">{'>'} 1000 MΩ</div>
                  <div className="text-xs">XLPE</div>
                  <div className="text-xs">{'>'} 5000 MΩ</div>
                  <div className="text-xs">Rubber</div>
                  <div className="text-xs">100-1000 MΩ</div>
                  <div className="text-xs">MICC</div>
                  <div className="text-xs">{'>'} 10000 MΩ</div>
                  <div className="text-xs">Paper (oil)</div>
                  <div className="text-xs">100-5000 MΩ</div>
                </div>
              </div>
            </div>
          </div>
          <div className="bg-card rounded p-3">
            ...
            <div className="space-y-1 text-xs">
              <p>
                • <strong>PVC:</strong> Gradual decline, moisture sensitive
              </p>
              <p>
                • <strong>XLPE:</strong> Excellent long-term stability
              </p>
              <p>
                • <strong>Rubber:</strong> Degrades faster, heat sensitive
              </p>
              <p>
                • <strong>MICC:</strong> Very stable, moisture resistant
              </p>
              <p>
                • <strong>Paper:</strong> Moisture critical, oil condition important
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="space-y-3 text-sm text-white">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          <div className="bg-card rounded p-3">
            ...
            <div className="space-y-1 text-xs">
              <p>
                • <strong>Voltage accuracy:</strong> ±5% of nominal
              </p>
              <p>
                • <strong>Current accuracy:</strong> ±10% of reading
              </p>
              <p>
                • <strong>Resistance accuracy:</strong> ±15% of reading
              </p>
              <p>
                • <strong>Calibration:</strong> Annual or as per manufacturer
              </p>
            </div>
          </div>
          <div className="bg-card rounded p-3">
            ...
            <div className="space-y-1 text-xs">
              <p>
                • <strong>250V test:</strong> 1 mA minimum
              </p>
              <p>
                • <strong>500V test:</strong> 1 mA minimum
              </p>
              <p>
                • <strong>1000V test:</strong> 1 mA minimum
              </p>
              <p>
                • <strong>Duration:</strong> Sustain for 60 seconds
              </p>
            </div>
          </div>
          <div className="bg-card rounded p-3">
            ...
            <div className="space-y-1 text-xs">
              <p>
                • <strong>Voltage detection:</strong> Before test application
              </p>
              <p>
                • <strong>Discharge circuit:</strong> After test completion
              </p>
              <p>
                • <strong>Overload protection:</strong> Current limiting
              </p>
              <p>
                • <strong>Visual/audible:</strong> Test in progress indication
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="bg-card rounded p-3">
            ...
            <div className="space-y-2 text-xs">
              <div className="space-y-1">
                <p>
                  <strong>≥ 2.0MΩ:</strong> Generally acceptable, document and proceed
                </p>
                <p>
                  <strong>1.0-2.0MΩ:</strong> Investigate further, consider:
                </p>
                ...
                <p>
                  <strong>{'<'} 1.0MΩ:</strong> Unacceptable, requires remedial action
                </p>
              </div>
            </div>
          </div>
