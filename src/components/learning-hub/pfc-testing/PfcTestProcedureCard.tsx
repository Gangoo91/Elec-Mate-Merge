  ...
  const steps = [
    {
      number: 1,
      icon: Target,
      title: 'Identify Test Location',
      description: 'Test at the origin of each circuit for accurate fault current measurement',
      color: 'text-orange-400',
    },
    {
      number: 2,
      icon: TestTube2,
      title: 'Measure Phase-Earth PFC',
      description: 'Primary measurement using PFC tester between phase and earth terminals',
      color: 'text-red-400',
    },
    {
      number: 3,
      icon: TestTube2,
      title: 'Measure Phase-Neutral PFC',
      description: 'Secondary check between phase and neutral to verify short-circuit values',
      color: 'text-amber-400',
    },
    {
      number: 4,
      icon: Calculator,
      title: 'Consider Parallel Paths',
      description: 'Account for all parallel earth paths and supply variations in calculations',
      color: 'text-yellow-400',
    },
    {
      number: 5,
      icon: AlertTriangle,
      title: 'Verify Minimum Values',
      description: 'Ensure PFC exceeds minimum required for protective device operation',
      ...
      <Card className="bg-card/50 border-border border-l-4 border-l-orange-500 hover:bg-card transition-all">
        <CardHeader className="p-4 sm:p-5 md:p-6">
          <div className="flex items-start justify-between gap-3 mb-2 flex-wrap">
            ...
            <Badge className="bg-orange-500/10 text-orange-400 border-orange-400/20 text-xs">
              Critical Test
            </Badge>
          </div>
        ...
        <CardContent className="p-4 sm:p-5 md:p-6 pt-0 space-y-4 sm:space-y-6">
          ...
          <div className="bg-orange-500/10 border border-orange-500/20 border-l-4 border-l-orange-500 rounded-lg p-4 sm:p-5">
            <div className="flex items-center gap-2 mb-3">
              ...
              <h4 className="font-semibold text-orange-400 text-sm sm:text-base">
                Why PFC Testing is Critical
              </h4>
            </div>
            <div className="space-y-2 text-xs sm:text-sm text-muted-foreground leading-relaxed">
              <p>
                <strong className="text-foreground">Purpose:</strong> Verify adequate fault current
                to ensure protective devices operate within required disconnection times
              </p>
              <p>
                <strong className="text-foreground">Risk:</strong> Insufficient PFC can prevent
                protective devices from operating, creating serious safety hazards
              </p>
            </div>
          </div>
            ...
            <div className="bg-background/50 border border-border rounded-lg p-4 sm:p-5">
              ...
              <ul className="space-y-2 text-xs sm:text-sm text-muted-foreground">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong className="text-foreground">Phase-Earth PFC:</strong> Primary
                    measurement
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-yellow-400 shrink-0">•</span>
                  <span>
                    <strong className="text-foreground">Phase-Neutral PFC:</strong> Secondary check
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-yellow-400 shrink-0">•</span>
                  <span>
                    <strong className="text-foreground">Direct measurement:</strong> Preferred
                    method
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-yellow-400 shrink-0">•</span>
                  <span>
                    <strong className="text-foreground">Calculated method:</strong> Alternative
                    approach
                  </span>
                </li>
              </ul>
          ...
          <div className="bg-red-500/10 border border-red-500/20 border-l-4 border-l-red-500 rounded-lg p-4 sm:p-5">
            ...
            <p className="text-xs sm:text-sm text-muted-foreground leading-relaxed">
              PFC testing involves high current measurements. Ensure proper test equipment is used
              and safety procedures are followed. Low PFC readings indicate potential safety hazards
              that require immediate investigation and remedial action.
            </p>
          </div>
