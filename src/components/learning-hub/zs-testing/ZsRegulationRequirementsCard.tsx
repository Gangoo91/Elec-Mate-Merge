  ...
  const requirements = [
    {
      icon: AlertTriangle,
      title: 'Test Location',
      description: 'Test at furthest point of each final circuit for worst-case measurement',
      color: 'text-yellow-400',
    },
    {
      icon: ThermometerSun,
      title: 'Temperature Correction',
      description: 'Apply correction to conductor operating temperature (typically 70°C)',
      color: 'text-orange-400',
    },
    {
      icon: Calculator,
      title: 'Maximum Values',
      description: 'Corrected Zs must not exceed maximum values in BS 7671 Appendix 3',
      color: 'text-red-400',
    },
    {
      icon: CheckCircle,
      title: 'Additional Factors',
      description: 'Consider voltage drop and thermal effects in calculations',
      color: 'text-blue-400',
    },
    {
      icon: BookOpen,
      title: 'RCD Protected Circuits',
      description: 'Zs may be higher but still requires verification per Regulation 411.5',
