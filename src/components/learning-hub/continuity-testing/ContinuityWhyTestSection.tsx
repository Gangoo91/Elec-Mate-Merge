      ...
      <div className="space-y-3 sm:space-y-4 text-xs sm:text-sm text-white leading-relaxed">
        <div className="flex items-start gap-2">
          ...
          <div>
            ...
            <p>
              Protective conductors must provide a continuous low-resistance path for fault
              currents. A broken or high-resistance protective conductor cannot safely carry fault
              currents to earth, potentially leaving metalwork at dangerous potentials during fault
              conditions.
            </p>
          </div>
        </div>
        <div className="flex items-start gap-2">
          ...
          <div>
            ...
            <p>
              For automatic disconnection of supply (ADS) to operate effectively, protective
              conductors must have sufficiently low resistance. High resistance prevents adequate
              fault current flow, potentially causing protective devices to fail to operate within
        ...
        <div className="flex items-start gap-2">
          ...
          <div>
            ...
            <p>
              Continuity testing verifies that exposed-conductive-parts are effectively connected to
              earth. Without proper continuity, these parts could remain at dangerous potentials
              during fault conditions, creating serious shock hazards for users.
            </p>
          </div>
        </div>
        <div className="flex items-start gap-2">
          ...
          <div>
            ...
            <p>
              Measured R1+R2 values are essential for verifying that calculated fault currents are
              achievable in practice. This ensures that protective device characteristics will
              provide adequate protection as designed.
            </p>
          </div>
        </div>
      </div>
    ...
    <div className="bg-blue-500/10 border border-blue-500/20 border-l-4 border-l-blue-500 rounded-lg p-4 sm:p-5 md:p-6">
      <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
        ...
        <h4 className="text-base sm:text-lg font-semibold text-blue-400">
          Understanding Fault Current Paths
        </h4>
      </div>
      <div className="space-y-3 text-sm text-white">
        <div>
          <p className="font-medium text-foreground">
            How protective conductors work in fault conditions:
          </p>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-2">
            <div className="space-y-2">
              <p>
                • <strong>Mechanical damage:</strong> Cables crushed, cut, or severed during
                installation
              </p>
              <p>
                • <strong>Corrosion:</strong> Damp conditions causing conductor deterioration
              </p>
              <p>
                • <strong>Loose connections:</strong> High resistance joints at terminals
              </p>
              <p>
                • <strong>Installation errors:</strong> Incorrect termination or routing
              </p>
            </div>
            <div className="space-y-2">
              <p>
                • <strong>Thermal damage:</strong> Overheating from poor connections
              </p>
              <p>
                • <strong>Rodent damage:</strong> Cables chewed by pests
              </p>
              <p>
                • <strong>Age-related failure:</strong> Insulation breakdown affecting conductor
              </p>
              <p>
                • <strong>Inadequate sizing:</strong> Undersized conductors with excessive
                resistance
              </p>
            </div>
          </div>
      ...
      <div className="space-y-3 text-sm text-white">
        <div className="bg-card rounded p-3">
          <p className="font-medium text-foreground mb-2">
            Case 1: Commercial Kitchen Equipment Fault
          </p>
          <p className="mb-2">
            A commercial kitchen's stainless steel worktop became live due to a faulty appliance
            connection:
          </p>
          <div className="ml-4 space-y-1">
            <p className="text-red-400">
              • <strong>Fault:</strong> Protective conductor broken in appliance plug
            </p>
            <p className="text-red-400">
              • <strong>Consequence:</strong> Kitchen staff received shocks from worktop
            </p>
            <p className="text-green-400">
              • <strong>Detection:</strong> Continuity testing revealed open circuit
            </p>
            <p className="text-blue-400">
              • <strong>Outcome:</strong> Immediate repair prevented serious injury
            </p>
          </div>
        </div>
        <div className="bg-card rounded p-3">
          ...
          <p className="mb-2">
            High-power motor installation with inadequate protective conductor sizing:
          </p>
          <div className="ml-4 space-y-1">
            <p className="text-red-400">
              • <strong>Fault:</strong> Undersized CPC with excessive resistance
            </p>
            <p className="text-red-400">
              • <strong>Consequence:</strong> Motor casing became live during earth fault
            </p>
            <p className="text-green-400">
              • <strong>Detection:</strong> R1+R2 measurement exceeded maximum values
            </p>
            <p className="text-blue-400">
              • <strong>Outcome:</strong> Protective conductor upgraded before energisation
            </p>
          </div>
        </div>
        <div className="bg-card rounded p-3">
          ...
          <div className="ml-4 space-y-1">
            <p className="text-red-400">
              • <strong>Fault:</strong> CPC severed during cavity wall insulation work
            </p>
            <p className="text-red-400">
              • <strong>Consequence:</strong> Socket outlets beyond break had no earth protection
            </p>
            <p className="text-green-400">
              • <strong>Detection:</strong> Continuity test revealed infinite resistance
            </p>
            <p className="text-blue-400">
              • <strong>Outcome:</strong> Cable replacement restored safety
            </p>
          </div>
        </div>
      </div>
    ...
    <div className="bg-green-500/10 border border-green-500/20 rounded-lg p-4">
      ...
      <div className="space-y-3 text-sm text-white">
        <div>
          ...
          <div className="ml-4 space-y-1">
            <p>
              • <strong>BS 7671:18+A3:2024:</strong> Regulation 612.2 - Continuity of protective
              conductors
            </p>
            <p>
              • <strong>Electricity at Work Regulations 1989:</strong> Regulation 4 - Systems to be
              safe
            </p>
            <p>
              • <strong>Building Regulations Part P:</strong> Electrical safety in dwellings
            </p>
            <p>
              • <strong>IET Guidance Note 3:</strong> Inspection & Testing procedures
            </p>
            <p>
              • <strong>Health and Safety at Work Act 1974:</strong> Duty of care requirements
            </p>
          </div>
        </div>
        <div>
          ...
          <div className="ml-4 space-y-1">
            <p>
              • <strong>Competent Person Schemes:</strong> NICEIC, NAPIT, ELECSA requirements
            </p>
            <p>
              • <strong>City & Guilds 2391:</strong> Inspection and testing qualification
            </p>
            <p>
              • <strong>IET Code of Practice:</strong> Professional competence standards
            </p>
            <p>
              • <strong>JIB Handbook:</strong> Industry recognised procedures
            </p>
          </div>
        </div>
