...
const ContinuityTestProcedureCard = () => {
  const r1r2Steps = [
    {
      number: 1,
      icon: Power,
      title: 'Ensure Safe Isolation',
      description: 'Verify circuit is safely isolated and proven dead before testing',
    },
    {
      number: 2,
      icon: Zap,
      title: 'Connect at Distribution Board',
      description: 'Connect test leads between phase and CPC terminals at the distribution board',
    },
    {
      number: 3,
      icon: TestTube2,
      title: 'Test at Furthest Point',
      description: 'Test at the furthest point of the circuit for maximum resistance',
    },
    {
      number: 4,
      icon: ClipboardList,
      title: 'Record R1+R2 Reading',
      description: 'Record the combined resistance reading (includes both conductors)',
    },
    {
      number: 5,
      icon: CheckCircle,
      title: 'Verify Requirements',
      description: 'Ensure result meets BS 7671 requirements for the circuit',
    },
  ];
  ...
  const r2Steps = [
    ...
    },
    {
      number: 2,
      icon: AlertCircle,
      title: 'Install Temporary Link',
      description: 'Connect temporary link between phase and CPC at board',
    },
    {
      number: 3,
      icon: TestTube2,
      title: 'Test at Circuit End',
      description: 'Test between phase and CPC at the end of the circuit',
    },
    {
      number: 4,
      icon: ClipboardList,
      title: 'Remove Link & Record',
      description: 'Remove temporary link and record R2 reading',
    },
    {
      number: 5,
      icon: CheckCircle,
      title: 'Calculate R1+R2',
      description: 'Calculate total R1+R2 if required for fault current verification',
    },
  ];
    ...
    <Card className="bg-card/50 border-border border-l-4 border-l-cyan-500 hover:bg-card transition-all">
      <CardHeader className="p-4 sm:p-5 md:p-6">
        ...
        <CardDescription className="text-xs sm:text-sm text-muted-foreground leading-relaxed">
          Step-by-step procedures for testing protective conductor continuity in accordance with BS
          7671
        </CardDescription>
      </CardHeader>
      ...
      <CardContent className="p-4 sm:p-5 md:p-6 pt-0 space-y-4 sm:space-y-6">
                ...
                >
                  <div className="flex items-start gap-2 sm:gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <h5 className="font-medium text-foreground text-xs sm:text-sm mb-0.5">
                        {step.title}
                      </h5>
        ...
        <div className="bg-yellow-500/10 border border-yellow-500/20 border-l-4 border-l-yellow-500 rounded-lg p-4 sm:p-5">
          <h4 className="font-semibold text-yellow-400 mb-3 text-sm sm:text-base">
