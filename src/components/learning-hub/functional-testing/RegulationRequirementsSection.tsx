              ...
              <div className="flex items-start gap-3 mb-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-white mb-3">
                    "Assemblies, including switchgear and controlgear assemblies, and components of
                    the electrical installation shall be subjected to a functional test to show that
                    they are properly mounted, adjusted and installed in accordance with the
              ...
              <Card className="bg-muted/30 border-border">
                ...
                <CardContent className="space-y-2">
                  <p className="text-xs text-white">
                    All switchgear and controlgear shall be operated to ensure correct functioning
                    including:
                  </p>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="p-3 bg-muted/50 rounded-lg border border-border">
                <div className="flex items-center justify-between mb-2">
                  <h6 className="font-medium text-foreground">
                    Regulation 132.16 - Emergency Switching
                  </h6>
                ...
                <p className="text-xs text-white">
                  Emergency switching devices must be clearly identified, readily accessible, and
                  capable of cutting off electrical energy to parts of an installation.
                </p>
              </div>
              ...
              <div className="p-3 bg-muted/50 rounded-lg border border-border">
                <div className="flex items-center justify-between mb-2">
                  <h6 className="font-medium text-foreground">
                    Regulation 411.3.3 - RCD Protection
                  </h6>
                  <Badge variant="outline" className="text-teal-400 border-teal-400 text-xs">
                    Protection Requirement
                  </Badge>
                </div>
                <p className="text-xs text-white">
                  RCDs used for additional protection must have rated residual operating current not
                  exceeding 30mA and operate within specified time limits.
                </p>
              </div>
              ...
              <div className="p-3 bg-muted/50 rounded-lg border border-border">
                <div className="flex items-center justify-between mb-2">
                  <h6 className="font-medium text-foreground">
                    Regulation 514.12 - Identification
                  </h6>
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2">
                  ...
                  <div className="p-2 bg-blue-500/10 border border-blue-500/20 rounded text-xs">
                    <strong className="text-blue-400">Defect Records:</strong>
                    <br />
                  ...
                  <div className="p-2 bg-purple-500/10 border border-purple-500/20 rounded text-xs">
                    <strong className="text-purple-400">Test Frequency:</strong>
                    <br />
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2">
                  <div className="p-2 bg-amber-500/10 border border-amber-500/20 rounded text-xs">
                    <strong className="text-amber-400">EIC Schedule:</strong>
                    <br />
                  ...
                  <div className="p-2 bg-red-500/10 border border-red-500/20 rounded text-xs">
                    <strong className="text-red-400">EICR Requirements:</strong>
                    <br />
                  ...
                  <div className="p-2 bg-cyan-500/10 border border-cyan-500/20 rounded text-xs">
                    <strong className="text-cyan-400">Competent Person:</strong>
                    <br />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
              <div>
                ...
                <ul className="space-y-1 text-xs">
                  <li>
                    • <strong>Electricity at Work Regulations 1989</strong> - Reg 4(2): Equipment
                    maintained to prevent danger
                  </li>
                  <li>
                    • <strong>Health & Safety at Work Act 1974</strong> - Duty of care to employees
                    and public
                  </li>
                  <li>
                    • <strong>Management of H&S at Work Regulations 1999</strong> - Risk assessment
                    requirements
                  </li>
                  <li>
              ...
              <div>
                ...
                <ul className="space-y-1 text-xs">
                  <li>
                    • <strong>HSE Enforcement:</strong> Improvement/prohibition notices possible
                  </li>
                  <li>
                    • <strong>Criminal Liability:</strong> Up to 2 years imprisonment for serious
                    breaches
                  </li>
                  <li>
                    • <strong>Civil Liability:</strong> Compensation claims for accidents
                  </li>
                  <li>
                    • <strong>Insurance Issues:</strong> Claims may be rejected for non-compliance
                  </li>
                </ul>
              </div>
            </div>
