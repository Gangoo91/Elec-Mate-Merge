  ...
  const steps = [
    {
      ...
      description: 'Visually inspect all controls, switches, and safety devices for damage or wear',
      color: 'text-green-400',
    },
    {
      number: 2,
      icon: TestTube2,
      title: 'Test RCD Push Button',
      description: 'Operate RCD test button to verify mechanical trip mechanism functionality',
    ...
    },
    {
      ...
      description: 'Test all emergency stop systems and verify they disconnect supply correctly',
      color: 'text-teal-400',
    },
    {
      number: 4,
      icon: Settings,
      title: 'Test Switchgear Operation',
      description: 'Operate all switches, isolators, and control equipment through full range',
      color: 'text-cyan-400',
    },
    {
      number: 5,
      ...
      description: 'Record all test results, observations, and any defects identified',
      color: 'text-blue-400',
    },
  ];
      ...
      <CardContent className="p-4 sm:p-5 md:p-6 pt-0 space-y-4 sm:space-y-6">
        ...
        <div className="bg-blue-500/10 border border-blue-500/20 border-l-4 border-l-blue-500 rounded-lg p-4 sm:p-5">
          ...
          <p className="text-xs sm:text-sm text-muted-foreground leading-relaxed">
            ...
            correctly and safely. This includes testing of switchgear, protective devices, RCDs,
            control equipment, and all safety systems to ensure they perform as intended under
