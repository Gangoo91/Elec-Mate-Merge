...
const SafetyComplianceSection = () => {
  ...
  const complianceChecklist = [
    {
      item: 'All circuits have appropriate overcurrent protection',
      regulation: '433.1',
      status: 'check',
    },
    {
      item: 'Socket outlets ≤20A have 30mA RCD protection',
      regulation: '411.3.3',
      status: 'check',
    },
    {
      item: 'All single-pole devices connected in line conductor',
      regulation: '132.14.1',
      status: 'check',
    },
    ...
    <div className="space-y-6">
      <div className="text-center px-2 sm:px-4">
        ...
        <p className="text-sm sm:text-base text-white">
          Essential safety requirements and compliance checks
        </p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <Alert className="border-yellow-500/50 bg-yellow-500/10">
          ...
          <AlertDescription className="text-yellow-300">
            <strong>RCD Protection:</strong> 30mA RCDs are mandatory for socket outlets ≤20A and
            cables buried less than 50mm in walls (522.6.202).
          </AlertDescription>
        </Alert>
