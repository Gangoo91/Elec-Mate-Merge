  ...
  const recentUpdates = [
    {
      ...
      description:
        'Major updates to EV charging, energy storage systems, prosumer installations and arc fault detection requirements. Effective from October 2024.',
      date: 'October 2024',
      type: 'critical',
      impact: 'High',
      icon: Zap,
    },
    {
      ...
      description:
        'New Regulation 722 requirements for electric vehicle charging installations including Mode 3 and Mode 4 chargers, PME earthing considerations.',
    ...
    },
    {
      ...
      description:
        'Enhanced requirements for prosumer electrical installations including solar PV systems with battery storage under Regulation 712.',
      date: 'Amendment 3:2024',
      type: 'important',
      impact: 'High',
      icon: Sun,
    },
    {
      ...
      description:
        'New comprehensive requirements for battery energy storage systems including lithium-ion installations in domestic and commercial premises.',
      date: 'Amendment 3:2024',
      type: 'important',
      impact: 'Medium',
      icon: Battery,
    },
    {
      ...
      description:
        'Clarified requirements for AFDD installation in specific locations including HMOs, student accommodation and buildings with sleeping risk.',
      date: 'Amendment 3:2024',
      type: 'update',
      impact: 'Medium',
      icon: Zap,
    ...
    <Card className="bg-gradient-to-br from-neutral-800 to-neutral-900 border-elec-yellow/20">
      <CardHeader>
        ...
        <CardDescription className="text-white text-sm sm:text-base">
          Latest regulatory changes affecting electrical installations - fully in force since
          October 2024
        </CardDescription>
      </CardHeader>
      <CardContent>
        <div className="space-y-4">
          {recentUpdates.map((update, index) => {
            ...
            return (
              <div
                key={index}
                className="flex items-start gap-4 p-4 sm:p-5 bg-muted/50 rounded-xl hover:bg-muted transition-colors border border-border/50"
              >
                <div
        ...
        <div className="mt-6 p-4 rounded-lg bg-elec-yellow/10 border border-elec-yellow/20">
          <p className="text-sm text-white">
            ...
            testing and certification procedures reflect the latest requirements.
          </p>
        </div>
