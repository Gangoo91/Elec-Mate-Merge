...
import {
  ...
  responsiveBody,
  responsivePadding,
} from '@/styles/typography-utilities';
    ...
    <div className="space-y-8">
      ...
      <div className="text-center space-y-3 sm:space-y-4 mb-6 sm:mb-8">
        ...
        <p className={responsiveBody.large + ' text-white max-w-3xl mx-auto px-4'}>
          Learn the essential principles of safe isolation specifically for electrical inspection
          and testing work. Understand BS 7671 requirements and practical application.
        </p>
      </div>
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div className="space-y-2">
                            ...
                            <p className="text-white text-sm">
                              <span className="font-medium text-red-400">Risk:</span>{' '}
                              {mistake.consequence}
                            </p>
                            <p className="text-white text-sm">
                              <span className="font-medium text-green-400">Prevention:</span>{' '}
                              {mistake.prevention}
                            </p>
                          </div>
                        </div>
                    ...
                    <div className="space-y-4">
                      <div className="p-4 bg-white/5 rounded-lg">
                        <h4 className="font-semibold text-purple-300 mb-2">
                          Scenario 1: Consumer Unit Testing
                        </h4>
                        <p className="text-white text-sm mb-2">
                          You need to test circuits in a domestic consumer unit. Multiple circuits
                          share the same neutral.
                        </p>
                      ...
                      <div className="p-4 bg-white/5 rounded-lg">
                        <h4 className="font-semibold text-purple-300 mb-2">
                          Scenario 2: Industrial Installation
                        </h4>
                        <p className="text-white text-sm mb-2">
                          Testing a motor circuit with multiple supply sources and emergency stop
                          circuits.
                        </p>
                        <p className="text-purple-400 text-sm font-medium">
            ...
            {['principles', 'procedure', 'mistakes', 'scenarios'].map((section) => (
              <div
                ...
                className={`h-2 flex-1 rounded ${
                  completedSections.includes(section) ? 'bg-elec-yellow' : 'bg-gray-600'
                }`}
              />
            ))}
          </div>
