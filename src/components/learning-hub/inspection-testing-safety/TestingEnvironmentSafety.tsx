...
const TestingEnvironmentSafety = ({ onBack }: TestingEnvironmentSafetyProps) => {
  ...
  const safetyChecklist = [
    ...
    {
      id: 'communication',
      task: 'Ensure reliable communication method',
      category: 'Communication',
    },
    {
      id: 'equipment-suitability',
      task: 'Verify equipment suitable for environment',
      category: 'Equipment',
    },
    {
      id: 'atmospheric-monitoring',
      task: 'Set up atmospheric monitoring if required',
      category: 'Environmental',
    },
    {
      id: 'lighting-adequacy',
      task: 'Ensure adequate lighting for safe work',
    ...
    <div className="space-y-8">
      ...
      <div className="text-center space-y-3 sm:space-y-4 mb-6 sm:mb-8">
        ...
        <p className={responsiveBody.large + ' text-white max-w-3xl mx-auto px-4'}>
          Learn to assess and manage environmental conditions that affect safety during electrical
          testing work.
        </p>
      </div>
                ...
                <Card className="border-green-500/20 bg-green-500/5">
                  <CardHeader>
                    <CardTitle className="text-foreground">
                      Pre-Testing Environmental Safety Checklist
                    </CardTitle>
                  </CardHeader>
                  <CardContent>
                  ...
                  <Card className="border-orange-500/20 bg-orange-500/5">
                    <CardHeader>
                      <CardTitle className="text-orange-300">
                        Case Study 1: Basement Testing in Winter
                      </CardTitle>
                    </CardHeader>
                    <CardContent>
                      <p className="text-white mb-4">
                        Electrical testing required in an unheated basement during winter months.
                        High humidity and condensation present.
                      </p>
                      <div className="space-y-3">
                        <div>
                          ...
                          <span className="text-white">
                            {' '}
                            Condensation on test equipment and electrical components
                          </span>
                        </div>
                        <div>
                          ...
                          <span className="text-white">
                            {' '}
                            Equipment acclimatisation, dehumidification, and extended test intervals
                          </span>
                        </div>
                        <div>
                          ...
                          <span className="text-white">
                            {' '}
                            Safe completion with accurate results and no equipment damage
                          </span>
                        </div>
                      </div>
                    </CardContent>
                  ...
                  <Card className="border-purple-500/20 bg-purple-500/5">
                    <CardHeader>
                      <CardTitle className="text-purple-300">
                        Case Study 2: Industrial Kitchen Testing
                      </CardTitle>
                    </CardHeader>
                    <CardContent>
                      <p className="text-white mb-4">
                        Testing electrical installation in commercial kitchen with high temperature
                      ...
                      <div className="space-y-3">
                        <div>
                          ...
                          <span className="text-white">
                            {' '}
                            High temperature, steam, and grease affecting safety and equipment
                          </span>
                        </div>
                        <div>
                          <span className="font-medium text-green-400">Solution:</span>
                          <span className="text-white">
                            {' '}
                            Testing during off-hours, increased PPE, equipment protection
                          </span>
                        </div>
                        <div>
                          <span className="font-medium text-blue-400">Outcome:</span>
                          <span className="text-white">
                            {' '}
                            Comprehensive testing completed safely with schedule coordination
                          </span>
                        </div>
                      </div>
                    </CardContent>
                  ...
                  <Card className="border-red-500/20 bg-red-500/5">
                    <CardHeader>
                      <CardTitle className="text-red-300">
                        Case Study 3: Outdoor Substation in Storm
                      </CardTitle>
                    </CardHeader>
                    <CardContent>
                      <p className="text-white mb-4">
                        Emergency testing required at outdoor substation during severe weather
                        conditions.
                      </p>
                      <div className="space-y-3">
                        <div>
                          ...
                          <span className="text-white">
                            {' '}
                            High winds, rain, and urgent timeframe
                          </span>
                        </div>
                        <div>
                          <span className="font-medium text-green-400">Solution:</span>
                          <span className="text-white">
                            {' '}
                            Risk assessment led to postponement until conditions improved
                          </span>
                        </div>
                        <div>
                          <span className="font-medium text-blue-400">Outcome:</span>
                          <span className="text-white">
                            {' '}
                            Safety prioritised over urgency, successful testing when safe
                          </span>
                        </div>
                      </div>
                    </CardContent>
