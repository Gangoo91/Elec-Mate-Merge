...
import { Thermometer, Cloud, Shield, AlertTriangle, Droplets, Wind, Zap, Map } from 'lucide-react';
...
const EnvironmentalSettings: React.FC<EnvironmentalSettingsProps> = ({
  ...
  const hazardousAreaOptions = [
    {
      value: 'safe-area',
      label: 'Safe Area (No hazard)',
      description: 'Normal industrial environment',
    },
  ...
  const installationZoneOptions = [
    {
      ...
      label: 'Indoor Controlled',
      description: 'Climate controlled indoor space',
    },
    {
      value: 'indoor-uncontrolled',
      label: 'Indoor Uncontrolled',
      description: 'Unheated indoor space',
    },
    ...
    <div className="space-y-6">
        ...
        <CardContent className="space-y-4">
          ...
          {(settings.uvExposure || settings.saltSprayExposure) && (
            <div className="bg-blue-500/10 border border-blue-500/20 rounded-md p-3">
              ...
              <p className="text-xs text-muted-foreground">
                Corrosion-resistant materials and enhanced sealing required. Consider marine-grade
      ...
      <Card className="border-red-500/20 bg-red-500/5">
        ...
        <CardContent className="space-y-4">
          ...
          {(settings.altitude > 2000 ||
            settings.humidity > 85 ||
            settings.minimumTemperature < -20 ||
            settings.maximumTemperature > 60) && (
            <div className="bg-red-500/10 border border-red-500/20 rounded-md p-3">
              ...
              <p className="text-xs text-muted-foreground">
                Special equipment and installation methods required. Consider derating factors and
          ...
          <CardContent className="space-y-4">
            {installationType === 'marine-offshore' && (
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground">
                  • Marine-grade cables and equipment required
                  <br />
                  • Enhanced corrosion protection
                  <br />
                  • Vibration-resistant installations
                  <br />• Emergency shutdown systems
                </p>
              </div>
            )}
            ...
            {installationType === 'mining' && (
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground">
                  • Flame-retardant cables required
                  <br />
                  • Enhanced mechanical protection
                  <br />
                  • Dust and moisture sealing
                  <br />• Emergency communication systems
                </p>
              </div>
            )}
            ...
            {installationType === 'hazardous-areas' && (
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground">
                  • ATEX/IECEx certified equipment only
                  <br />
                  • Intrinsically safe circuits where applicable
                  <br />
                  • Explosion-proof enclosures
                  <br />• Specialised cable glands and terminations
                </p>
              </div>
            )}
          </CardContent>
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between">
              ...
              <Badge variant="outline" className="border-green-400/30 text-green-400">
                {settings.hazardousAreaClassification !== 'safe-area'
                  ? 'High'
                  : settings.environmentalConditions === 'corrosive'
                    ? 'Medium'
                    : 'Standard'}
              </Badge>
            </div>
