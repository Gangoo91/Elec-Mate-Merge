  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <Badge
          variant="outline"
          className="border-elec-yellow/30 text-elec-yellow self-start sm:self-center"
        >
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <div className="flex flex-col gap-2 text-sm">
                          ...
                          <div className="bg-elec-gray rounded p-2 text-center border border-elec-yellow/20">
                            ...
                            <div className="font-medium text-elec-yellow text-xs">
                              {circuit.loadType
                                .replace('-', ' ')
                      ...
                      <div className="space-y-4">
                        ...
                        >
                          <MobileInputWrapper
                            ...
                            onChange={(value) =>
                              updateCircuit(circuit.id, { totalLoad: Number(value) })
                            }
                            type="number"
                            unit="W"
                          />
                          ...
                          <MobileInputWrapper
                            ...
                            onChange={(value) =>
                              updateCircuit(circuit.id, { cableLength: Number(value) })
                            }
                            type="number"
                            unit="m"
                          />
                        ...
                        {circuit.phases === 'three' && (
                          <MobileInputWrapper
                            ...
                            onChange={(value) =>
                              updateCircuit(circuit.id, { powerFactor: Number(value) })
                            }
                            type="number"
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="space-y-4">
                        <MobileSelectWrapper
                          ...
                          options={[
                            {
                              value: 'clips-direct-on-surface',
                              label: 'Clipped Direct on Surface',
                            },
                            {
                              value: 'in-conduit-in-insulated-wall',
                              label: 'In Conduit in Insulated Wall',
                            },
                            { value: 'in-trunking', label: 'In Trunking' },
                            { value: 'on-cable-tray', label: 'On Cable Tray' },
                            {
                              value: 'clipped-to-non-metallic-surface',
                              label: 'Clipped to Non-metallic Surface',
                            },
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                          <MobileSelectWrapper
                            ...
                            onValueChange={(value) =>
                              updateCircuit(circuit.id, { cableType: value })
                            }
                            options={[
