        ...
        <div className="space-y-3">
          ...
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-medium">Ib ≤ In (Design ≤ Protection)</span>
              </div>
            ...
            {protectionTooLow && (
              <p className="text-xs text-red-200/80 mt-2">
                <strong>CRITICAL:</strong> Protection device rating ({recommendedProtection}A) is
                below design current ({designCurrent.toFixed(1)}A). Device will trip immediately!
              </p>
            )}
          </div>
          ...
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-medium">In ≤ Iz (Protection ≤ Cable)</span>
              </div>
            ...
            {protectionTooHigh && (
              <p className="text-xs text-red-200/80 mt-2">
                <strong>CRITICAL:</strong> Protection device ({recommendedProtection}A) exceeds
                cable capacity ({cableCapacity}A). Cable overload risk!
              </p>
            )}
          </div>
          ...
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-medium">Zs ≤ Zs max (Earth Fault Loop)</span>
              </div>
            ...
            {zsNonCompliant && (
              <p className="text-xs text-amber-200/80 mt-2">
                Earth fault loop impedance too high. May not disconnect in required time. Consider
                larger cable or supplementary bonding.
              </p>
            )}
          </div>
          ...
          >
            <div className="flex items-center justify-between">
              ...
              <span
                className={`text-sm ${voltageDropExceeded ? 'text-amber-300' : 'text-green-300'}`}
              >
            ...
            {voltageDropExceeded && (
              <p className="text-xs text-amber-200/80 mt-2">
                Voltage drop exceeds BS 7671 limits. Equipment may not operate correctly. Consider
                larger cable size.
              </p>
            )}
          </div>
        ...
        {overallStatus === 'critical' && (
          <Alert className="bg-red-500/10 border-red-500/30">
            ...
            <AlertDescription className="text-red-200">
              <strong>
                This design contains critical safety errors and must not be installed.
              </strong>
        ...
        {overallStatus === 'warning' && (
          <Alert className="bg-amber-500/10 border-amber-500/30">
            ...
            <AlertDescription className="text-amber-200">
              This design has warnings that should be addressed for optimal performance and
              compliance.
            </AlertDescription>
          </Alert>
        )}
