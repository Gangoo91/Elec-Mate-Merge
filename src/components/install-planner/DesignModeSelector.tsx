...
const DesignModeSelector: React.FC<DesignModeSelectorProps> = ({ planData, updatePlanData }) => {
      ...
      <div className="text-center space-y-4">
        <div className="inline-flex items-center gap-2 px-4 py-2 bg-elec-yellow/10 border border-elec-yellow/20 rounded-full">
          ...
          <span className="text-xs font-medium text-elec-yellow">
            Step 1 of {currentMode === 'multi' ? '5' : '6'}
          </span>
        </div>
        ...
        <p className="text-foreground/80 text-sm sm:text-base max-w-2xl mx-auto leading-relaxed">
          Select your installation type to get started with professional electrical design and BS
          7671 compliance.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-3xl mx-auto">
        ...
        >
          <CardContent className="p-6 sm:p-8 text-center space-y-4">
            <div
              className={`relative transition-transform duration-300 ${currentMode === 'single' ? 'animate-pulse' : 'group-hover:rotate-6'}`}
            >
              <Cable
                className={`h-10 w-10 sm:h-12 sm:w-12 mx-auto transition-colors duration-300 ${
                  currentMode === 'single'
                    ? 'text-elec-yellow'
            ...
            <div className="space-y-3">
              ...
              <div
                className={`text-xs px-3 py-1 rounded-full border inline-block transition-all duration-300 ${
                  currentMode === 'single'
        ...
        >
          <CardContent className="p-6 sm:p-8 text-center space-y-4">
            <div
              className={`relative transition-transform duration-300 ${currentMode === 'multi' ? 'animate-pulse' : 'group-hover:scale-110'}`}
            >
              <Zap
                className={`h-10 w-10 sm:h-12 sm:w-12 mx-auto transition-colors duration-300 ${
                  currentMode === 'multi'
                  ...
                  {currentMode === 'single' ? (
                    <>
                      <div className="space-y-3">
                        ...
                        <p className="text-foreground/80 text-sm leading-relaxed pl-4">
                          Individual appliances, socket circuits, lighting circuits, or simple
                          upgrades.
                        </p>
                      </div>
                      <div className="space-y-3">
                        ...
                        <p className="text-foreground/80 text-sm leading-relaxed pl-4">
                          Fast cable sizing, protection calculations, and BS 7671 compliance
                          checking.
                        </p>
                      </div>
                    ...
                    <>
                      <div className="space-y-3">
                        ...
                        <p className="text-foreground/80 text-sm leading-relaxed pl-4">
                          New builds, rewires, commercial installations, or complex multi-zone
                          systems.
                        </p>
                      </div>
                      <div className="space-y-3">
                        ...
                        <p className="text-foreground/80 text-sm leading-relaxed pl-4">
                          System-wide analysis, diversity calculations, supply sizing, and
                      ...
                      <div className="space-y-3">
                        ...
                        <p className="text-foreground/80 text-sm leading-relaxed pl-4">
                          Optimised load balancing, consumer unit selection, and comprehensive
