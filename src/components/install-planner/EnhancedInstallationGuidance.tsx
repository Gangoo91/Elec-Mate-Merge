      ...
      <Card className="border-elec-green/30">
        ...
        <CardContent className="space-y-6">
          <div className="space-y-6">
            {/* Pre-Installation */}
            <div>
              <h4 className="font-semibold text-elec-green mb-4 flex items-center gap-2 text-foreground">
            ...
            {/* During Installation */}
            <div>
              <h4 className="font-semibold text-elec-yellow mb-4 flex items-center gap-2 text-foreground">
            ...
            {/* Post-Installation */}
            <div>
              <h4 className="font-semibold text-elec-blue mb-4 flex items-center gap-2 text-foreground">
