...
const MultiCircuitManager: React.FC<MultiCircuitManagerProps> = ({ planData, updatePlanData }) => {
  ...
  const addCircuitFromType = (circuitType: string) => {
    const template =
      SIMPLIFIED_CIRCUIT_TEMPLATES[circuitType as keyof typeof SIMPLIFIED_CIRCUIT_TEMPLATES];
