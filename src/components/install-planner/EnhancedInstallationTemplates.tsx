        ...
        return [
          {
            ...
            description:
              '4-bed house with solar PV, battery storage, heat pump and smart home automation',
        ...
        return [
          {
            ...
            description:
              '3-storey office with intelligent lighting, HVAC control and IT infrastructure',
        ...
        return [
          {
            ...
            description:
              'Resilient data centre with dual power feeds, N+1 UPS and advanced cooling',
        ...
        return [
          {
            ...
            description:
              'Complete secondary school with science labs, sports hall and IT facilities',
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-black/20 rounded-md p-3">
                ...
                <div className="font-medium">
                  {(selectedTemplateData.totalLoad / 1000).toFixed(0)} kW
                </div>
              </div>
              <div className="bg-black/20 rounded-md p-3">
              ...
              <div className="bg-black/20 rounded-md p-3">
                ...
                <Badge
                  variant="outline"
                  className={getComplexityColor(selectedTemplateData.complexity)}
                >
            ...
            <div className="bg-green-500/10 border border-green-500/20 rounded-md p-3">
              ...
              <div className="grid grid-cols-3 gap-2 text-xs">
                ...
                <div>
                  ...
                  <div className="font-medium">
                    {selectedTemplateData.projectTimeline.installation}
                  </div>
                </div>
                <div>
