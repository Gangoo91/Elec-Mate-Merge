...
export const CostBreakdownCard = ({ data }: CostBreakdownCardProps) => {
  ...
  return (
    <Card className="border-elec-yellow/20 bg-gradient-to-br from-green-500/5 to-transparent hover:border-elec-yellow/30 transition-all max-w-full overflow-hidden">
