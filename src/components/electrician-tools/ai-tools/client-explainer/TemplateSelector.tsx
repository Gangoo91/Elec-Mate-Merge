...
const templates: Template[] = [
  ...
  },
  {
    ...
    sample:
      'Good news! Your electrical installation has passed all tests. The wiring is in excellent condition and meets current safety standards. No urgent work is required.',
  },
  {
    id: 'circuit-fault',
