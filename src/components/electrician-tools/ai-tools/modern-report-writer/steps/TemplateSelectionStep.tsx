...
const TemplateSelectionStep: React.FC<TemplateStepProps> = ({
  ...
  const categories = [
    ...
    {
      id: 'installation',
      label: 'Installation Certificates',
      count: REPORT_TEMPLATES.filter((t) => t.category === 'installation').length,
    },
    {
      id: 'testing',
      label: 'Test Certificates',
      count: REPORT_TEMPLATES.filter((t) => t.category === 'testing').length,
    },
    {
      id: 'certification',
      label: 'General Certificates',
      count: REPORT_TEMPLATES.filter((t) => t.category === 'certification').length,
    },
  ];
      ...
      <Card className="bg-elec-gray border-elec-yellow/30 p-6 mb-6">
        <div className="text-center space-y-4">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Select from our collection of BS 7671:2018 compliant electrical certificates and
            condition reports.
          </p>
        </div>
        ...
        <div className="mt-6 flex flex-col sm:flex-row gap-3">
          ...
          <div className="relative flex-1">
            ...
            <Input
              ...
              className={cn(
                'bg-elec-dark border border-primary/30 text-foreground',
                !searchTerm && 'pl-10'
              )}
            />
          </div>
              ...
              >
                ...
                <div className="p-6 pt-12">
                  ...
                  <div className="flex items-start gap-3 mb-4">
                    ...
                    >
                      <Icon
                        className={`h-6 w-6 ${isSelected ? 'text-elec-yellow' : 'text-foreground'}`}
                      />
                    </div>
