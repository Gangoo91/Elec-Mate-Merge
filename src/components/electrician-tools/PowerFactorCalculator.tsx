        ...
        <div className="mt-4 text-sm">
          {parseFloat(powerFactor) > 0.95 ? (
            ...
            <span className="text-red-500">
              Poor power factor (&lt; 0.85), correction recommended
            </span>
          )}
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            {calculationMethod === 'power' ? (
              <>
                <div className="space-y-2">
                  ...
                  />
                  {errors.activePower && (
                    <p className="text-xs text-destructive">{errors.activePower}</p>
                  )}
                ...
                <div className="space-y-2">
                  ...
                  />
                  {errors.apparentPower && (
                    <p className="text-xs text-destructive">{errors.apparentPower}</p>
                  )}
          ...
          <div className="flex flex-col">
            ...
            <div className="mt-4 p-4 bg-elec-dark/50 rounded-md">
              ...
              <p className="text-xs text-muted-foreground">
                Power factor is the ratio of active power to apparent power in an electrical
                circuit. A higher power factor (closer to 1.0) indicates more efficient use of
                electrical power.
              </p>
            </div>
          </div>
