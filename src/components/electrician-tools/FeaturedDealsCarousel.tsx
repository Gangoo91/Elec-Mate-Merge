    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {featuredDeals.map((deal) => (
          <Card
            key={deal.id}
            className="border-elec-yellow/20 bg-gradient-to-br from-elec-gray to-elec-gray/70 hover:border-elec-yellow/50 transition-all duration-300 hover:scale-105"
          >
            <CardHeader className="pb-3">
              ...
              <CardTitle className="text-lg text-foreground leading-tight">{deal.title}</CardTitle>
