...
export const AIQualityConfidenceBadge = ({
  metrics,
  isGenerating,
}: AIQualityConfidenceBadgeProps) => {
  ...
  const showWarning =
    ...
    metrics.ragDataQuality === 'fair';

  return (
    <Card
      className={`border-2 transition-all duration-300 ${
        showWarning ? 'border-yellow-500/40 bg-yellow-500/10' : 'border-blue-500/30 bg-blue-500/10'
      }`}
    >
      <div className="p-4 space-y-3">
        ...
        <div className="grid grid-cols-2 gap-3 pt-2 border-t border-border/50">
          <div className="space-y-1">
            ...
            <div className="text-xl font-bold text-blue-400">{metrics.bs7671Coverage}</div>
          ...
          <div className="space-y-1">
            ...
            <div className="text-xl font-bold text-purple-400">{metrics.practicalWorkCoverage}</div>
              ...
              <div className="flex-1 min-w-0">
                <p className="text-xs font-semibold text-yellow-400">
                  {metrics.ragDataQuality === 'poor'
                    ...
                    : metrics.overallConfidence < 60
                      ? 'Lower Than Expected Confidence'
