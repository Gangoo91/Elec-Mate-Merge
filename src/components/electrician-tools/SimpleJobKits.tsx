...
const SimpleJobKits = () => {
  ...
  const jobKits = [
    ...
    },
    {
      ...
      tools: ['Voltage Tester', 'Socket Tester', 'Torch/Headlamp'],
    },
    {
      id: 'apprentice',
      icon: Briefcase,
      ...
      <CardContent className="space-y-3">
        ...
        <div className="p-3 rounded-lg bg-purple-600/10 border border-purple-500/20">
          <p className="text-sm text-foreground/80">
            <span className="font-medium text-purple-400">Pro Tip:</span> Start with the essential
            kit for your main work type, then expand based on specific job requirements.
          </p>
        </div>
      </CardContent>
    </Card>
