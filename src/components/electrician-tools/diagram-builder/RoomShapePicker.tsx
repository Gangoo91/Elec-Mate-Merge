...
const roomShapes: RoomShape[] = [
  ...
  },
  {
    ...
    name: 'Bay Window',
    walls: [
      { label: 'Bay left', defaultLength: 1.2, direction: 'right' },
      { label: 'Bay front', defaultLength: 1.6, direction: 'right' },
      { label: 'Bay right', defaultLength: 1.2, direction: 'right' },
      { label: 'Right', defaultLength: 3, direction: 'down' },
      { label: 'Bottom', defaultLength: 4, direction: 'left' },
      { label: 'Left', defaultLength: 3, direction: 'up' },
    ],
    previewPath: 'M 10 18 L 22 8 L 38 8 L 50 18 L 50 48 L 10 48 Z',
  },
  {
    id: 'corridor',
    name: 'Corridor',
