              ...
              >
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1">
                    ...
                    <p className="mobile-small-text text-elec-light leading-relaxed font-medium ml-6">
                      {phase.description}
                    </p>
                  </div>
                  <Badge
                    variant="outline"
                    className="border-elec-yellow/30 text-elec-yellow mobile-small-text font-bold shrink-0 tabular-nums"
                  >
                    {phase.days} days
                  </Badge>
                </div>
