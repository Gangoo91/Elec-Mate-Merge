...
const CostBreakdownCard = ({
  ...
  const marketRate =
    MARKET_RATES_2025.hourlyRates[expLevel] || MARKET_RATES_2025.hourlyRates.qualified;
    ...
    <div className="bg-gradient-to-br from-white/[0.08] to-white/[0.04] backdrop-blur-xl border border-white/10 rounded-2xl overflow-hidden shadow-xl">
      ...
      <div className="p-4 space-y-3">
              ...
              <div className="px-4 pb-4 space-y-3 text-sm">
                ...
                <div className="p-3 rounded-xl bg-white/5">
                  ...
                  <div className="space-y-2 text-xs sm:text-sm text-white text-left">
                    ...
                    <div>
                      Professional: <span className="text-white">15-25%</span>
                    </div>
                    <div>
                      Specialist: <span className="text-white">20-30%</span>
                    </div>
                    <div className="pt-2 border-t border-white/10">
                      Your setting:{' '}
                      <Badge className="bg-elec-yellow/20 text-elec-yellow border-elec-yellow/30 text-xs ml-1">
                        {markupPercentage}%
                      </Badge>
                    </div>
                  </div>
        ...
        <div className="rounded-xl bg-black/30 border border-white/10">
          ...
          <Collapsible
            open={expandedSections.has('labour')}
            ...
            <CollapsibleTrigger className="w-full px-4 pb-3 touch-manipulation min-h-11">
              <div className="flex items-center gap-2 text-xs text-elec-yellow transition-transform active:scale-95 touch-manipulation">
                ...
                <ChevronDown
                  className={cn(
                    'h-3 w-3 transition-transform',
                    expandedSections.has('labour') && 'rotate-180'
                  )}
                />
              </div>
            </CollapsibleTrigger>
              ...
              <div className="px-4 pb-4 space-y-3 text-sm">
                  ...
                  <div className="space-y-2 text-xs sm:text-sm text-white text-left">
                    <div>
                      ...
                      <span className="text-white">
                        £{marketRate.min}-{marketRate.max}/hr
                      </span>
                    </div>
                    <div>
                      Typical Rate: <span className="text-white">£{marketRate.typical}/hr</span>
                    </div>
                    <div>
                      Regional ({region}): <span className="text-white">{regionalMultiplier}x</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-3 rounded-xl bg-white/5">
                  ...
                  <ul className="space-y-1.5 text-xs sm:text-sm text-white text-left">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="text-orange-400">✓</span>
                      <span>NICEIC/NAPIT membership</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-orange-400">✓</span>
        ...
        {overheadTotal > 0 && (
          <div className="rounded-xl bg-black/30 border border-white/10">
            ...
            <Collapsible
              open={expandedSections.has('overheads')}
              onOpenChange={() => toggleSection('overheads')}
            >
              <CollapsibleTrigger className="w-full px-4 pb-3 touch-manipulation min-h-11">
                <div className="flex items-center gap-2 text-xs text-elec-yellow transition-transform active:scale-95 touch-manipulation">
                  <Info className="h-3 w-3" />
                  ...
                  <ChevronDown
                    className={cn(
                      'h-3 w-3 transition-transform',
                      expandedSections.has('overheads') && 'rotate-180'
                    )}
                  />
                </div>
              </CollapsibleTrigger>
                ...
                <div className="px-4 pb-4 space-y-3 text-sm">
                  <div className="p-3 rounded-xl bg-purple-500/10 border border-purple-500/20">
                    ...
                    <div className="space-y-2 text-xs sm:text-sm text-white text-left">
                      <div>
                        ...
                        <span className="text-white">
                          £
                          {(MARKET_RATES_2025.businessCosts.fuel +
                            MARKET_RATES_2025.businessCosts.commercialInsurance) /
                            12}
                          /mo
                        </span>
                      </div>
                      <div>
                        Tools:{' '}
                        <span className="text-white">
                          £{MARKET_RATES_2025.businessCosts.toolsReplacement / 12}/mo
                        </span>
                      </div>
                      <div>
                        Insurance:{' '}
                        <span className="text-white">
                          £
                          {(MARKET_RATES_2025.businessCosts.publicLiabilityInsurance / 12).toFixed(
                            0
                          )}
                          /mo
                        </span>
                      ...
                      <div className="pt-2 border-t border-white/10">
                        Total: <span className="text-white">£900-1,200/mo</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="p-3 rounded-xl bg-white/5">
                    ...
                    <div className="space-y-1 text-xs sm:text-sm text-white text-left">
                      ...
                      <div className="pt-2 border-t border-white/10">
                        Allocation:{' '}
                        <span className="text-white font-medium">£{overheadTotal.toFixed(2)}</span>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div className="rounded-xl bg-black/30 border border-white/10">
          ...
          <Collapsible
            open={expandedSections.has('contingency')}
            onOpenChange={() => toggleSection('contingency')}
          >
            <CollapsibleTrigger className="w-full px-4 pb-3 touch-manipulation min-h-11">
              <div className="flex items-center gap-2 text-xs text-elec-yellow transition-transform active:scale-95 touch-manipulation">
                <Info className="h-3 w-3" />
              ...
              <div className="px-4 pb-4 space-y-3 text-sm">
                <div className="p-3 rounded-xl bg-amber-500/10 border border-amber-500/20">
                  ...
                  <ul className="space-y-1.5 text-xs sm:text-sm text-white text-left">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="text-amber-400">✓</span>
                      <span>Additional materials needed</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-amber-400">✓</span>
                      <span>Unforeseen complications</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-amber-400">✓</span>
                ...
                <div className="p-3 rounded-xl bg-white/5">
                  ...
                  <div className="space-y-1 text-xs sm:text-sm text-white text-left">
                    ...
                    <div>
                      Standard domestic: <span className="text-white">5-10%</span>
                    </div>
                    <div>
                      Renovation: <span className="text-white">10-15%</span>
                    </div>
                    <div className="pt-2 border-t border-white/10">
                      Your setting:{' '}
        ...
        <div className="rounded-xl bg-elec-yellow/10 border-2 border-elec-yellow/30 mt-4">
          <div className="p-4">
            ...
            <div className="text-3xl font-bold text-elec-yellow mb-4">£{breakEven.toFixed(2)}</div>
