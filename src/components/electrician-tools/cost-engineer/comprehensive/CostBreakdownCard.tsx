      ...
      <CardContent className="p-0">
        ...
        <div className="p-4 border-b border-white/5">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-ios-headline text-white font-semibold">Cost Breakdown</h3>
              <p className="text-ios-caption-1 text-white/50">Tap sections for detailed justification</p>
            </div>
          </div>
        </div>
          ...
          <div className="rounded-xl bg-black/30 border border-white/10">
            <div className="flex items-center justify-between p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-ios-body font-medium text-white">Materials</div>
                  <div className="text-ios-caption-1 text-white/50">
                    Net: £{materialsNet.toFixed(2)} + {markupPercentage}%
                  </div>
                </div>
              </div>
              <div className="text-right">
                <div className="text-ios-body font-bold text-blue-400">£{materialsWithMarkup.toFixed(2)}</div>
              </div>
            </div>
            ...
            <Collapsible open={expandedSections.has('materials')} onOpenChange={() => toggleSection('materials')}>
              <CollapsibleTrigger className="w-full px-4 pb-3 touch-manipulation min-h-11">
                <div className="flex items-center gap-2 text-ios-footnote text-elec-yellow ios-pressable">
              ...
              <CollapsibleContent>
                <div className="px-4 pb-4 space-y-3 text-sm">
                  <div className="p-3 rounded-xl bg-blue-500/10 border border-blue-500/20">
                    <div className="text-ios-footnote font-medium mb-2 flex items-center gap-2 text-white">
                      <CheckCircle className="h-4 w-4 text-blue-400" />
                      Why This Markup is Necessary
                    </div>
                    <ul className="space-y-2 text-ios-caption-1 text-white/70 text-left">
                  ...
                  <div className="p-3 rounded-xl bg-white/5">
                    <div className="text-ios-footnote font-medium mb-2 text-white">Industry Standards</div>
                    <div className="space-y-2 text-ios-caption-1 text-white/60 text-left">
          ...
          <div className="rounded-xl bg-black/30 border border-white/10">
            <div className="flex items-center justify-between p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-ios-body font-medium text-white">Labour</div>
                  <div className="text-ios-caption-1 text-white/50">
              ...
              <div className="text-right">
                <div className="text-ios-body font-bold text-orange-400">£{labourTotal.toFixed(2)}</div>
              </div>
            </div>
              ...
              <CollapsibleContent>
                <div className="px-4 pb-4 space-y-3 text-sm">
                  <div className="p-3 rounded-xl bg-orange-500/10 border border-orange-500/20">
                    <div className="text-ios-footnote font-medium mb-2 text-white">Your Rate: £{calculatedLabourRate.toFixed(2)}/hr</div>
                    <div className="space-y-2 text-ios-caption-1 text-white/60 text-left">
                  ...
                  <div className="p-3 rounded-xl bg-white/5">
                    ...
                    <ul className="space-y-1.5 text-ios-caption-1 text-white/70 text-left">
                  ...
                  <p className="text-ios-caption-1 text-white/50 italic">
            ...
            <div className="rounded-xl bg-black/30 border border-white/10">
              <div className="flex items-center justify-between p-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-ios-body font-medium text-white">Business Overheads</div>
                    <div className="text-ios-caption-1 text-white/50">
                ...
                <div className="text-right">
                  <div className="text-ios-body font-bold text-purple-400">£{overheadTotal.toFixed(2)}</div>
                </div>
              </div>
                ...
                <CollapsibleContent>
                  <div className="px-4 pb-4 space-y-3 text-sm">
                    <div className="p-3 rounded-xl bg-purple-500/10 border border-purple-500/20">
                      <div className="text-ios-footnote font-medium mb-2 text-white">Monthly Business Costs</div>
                      <div className="space-y-2 text-ios-caption-1 text-white/60 text-left">
                    ...
                    <div className="p-3 rounded-xl bg-white/5">
                      <div className="text-ios-footnote font-medium mb-2 text-white">This Job's Share</div>
                      <div className="space-y-1 text-ios-caption-1 text-white/60 text-left">
          ...
          <div className="rounded-xl bg-black/30 border border-white/10">
            <div className="flex items-center justify-between p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-ios-body font-medium text-white">Contingency</div>
                  <div className="text-ios-caption-1 text-white/50">{contingencyPercent}% buffer</div>
                </div>
              </div>
              <div className="text-right">
                <div className="text-ios-body font-bold text-amber-400">£{contingencyAmount.toFixed(2)}</div>
              </div>
            </div>
            ...
            <div className="p-4">
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-ios-headline font-semibold text-white">Minimum Quote</span>
                </div>
              ...
              <div className="space-y-2 text-ios-footnote">
