        ...
        {confidence.materials && (
          <div>
            <div className="flex items-center justify-between mb-2">
              ...
              <span
                className={`text-lg sm:text-base font-bold ${getConfidenceColor(confidence.materials.level)}`}
              >
        ...
        {confidence.labour && (
          <div>
            <div className="flex items-center justify-between mb-2">
              ...
              <span
                className={`text-lg sm:text-base font-bold ${getConfidenceColor(confidence.labour.level)}`}
              >
                {confidence.labour.level}%
              </span>
            </div>
            <Progress value={confidence.labour.level} className="h-2" />
            <p className="text-base sm:text-sm text-foreground mt-1">{confidence.labour.reason}</p>
        ...
        {confidence.contingency && (
          <div className="p-4 sm:p-3 rounded-lg bg-background/50 border border-border/30">
            <div className="flex items-center justify-between">
              <span className="text-lg sm:text-base font-medium text-foreground">
                Contingency Buffer
              </span>
