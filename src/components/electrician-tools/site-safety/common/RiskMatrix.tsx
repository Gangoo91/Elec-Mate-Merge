    ...
    <Card className={`border-elec-yellow/20 bg-elec-gray/60 ${className}`}>
      ...
      <CardContent>
                ...
                {[1, 2, 3, 4, 5].map((severity) => {
                  ...
                  return (
                    <div
                      ...
                      className={`
                        p-1 sm:p-2 text-center text-foreground text-xs font-bold border-2 min-h-[40px] sm:min-h-[48px] flex flex-col justify-center
        ...
        <div className="mt-4 flex flex-wrap gap-2 justify-center">
          ...
          <Badge className="bg-orange-500 text-foreground">10-16 High</Badge>
          <Badge className="bg-red-500 text-foreground">17-25 Very High</Badge>
        </div>
