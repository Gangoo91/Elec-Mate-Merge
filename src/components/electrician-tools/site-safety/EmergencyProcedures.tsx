  ...
  return (
    <div className="space-y-6">
      <Card className="bg-red-500/10 border border-red-500/30 rounded-2xl">
        ...
        <CardContent>
          <p className="text-sm text-white">
            Critical emergency procedures and contact information for electrical work sites. Ensure
            all team members are familiar with these procedures before commencing work.
          </p>
        </CardContent>
      </Card>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 mb-6">
        ...
        >
          <Phone
            className={`h-6 w-6 mx-auto mb-2 ${activeTab === 'contacts' ? 'text-elec-yellow' : 'text-white'}`}
          />
          <h3
            className={`font-medium text-sm ${activeTab === 'contacts' ? 'text-white' : 'text-white'}`}
          >
            Emergency Contacts
          </h3>
        </button>
        ...
        >
          <MapPin
            className={`h-6 w-6 mx-auto mb-2 ${activeTab === 'evacuation' ? 'text-elec-yellow' : 'text-white'}`}
          />
          <h3
            className={`font-medium text-sm ${activeTab === 'evacuation' ? 'text-white' : 'text-white'}`}
          >
            Evacuation
          </h3>
        </button>
        ...
        >
          <Shield
            className={`h-6 w-6 mx-auto mb-2 ${activeTab === 'first-aid' ? 'text-elec-yellow' : 'text-white'}`}
          />
          <h3
            className={`font-medium text-sm ${activeTab === 'first-aid' ? 'text-white' : 'text-white'}`}
          >
            First Aid
          </h3>
        </button>
        ...
        >
          <FileText
            className={`h-6 w-6 mx-auto mb-2 ${activeTab === 'procedures' ? 'text-elec-yellow' : 'text-white'}`}
          />
          <h3
            className={`font-medium text-sm ${activeTab === 'procedures' ? 'text-white' : 'text-white'}`}
          >
            Procedures
          </h3>
        </button>
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {emergencyContacts.map((contact, index) => (
                  <div
                    key={index}
                    className="bg-[#1a1a1a] border border-white/10 rounded-xl p-5 hover:border-white/20 transition-all group"
                  >
                    <div className="text-center">
                      ...
                      <h4 className="font-semibold text-white text-base mb-3 group-hover:text-elec-yellow transition-colors">
                        {contact.service}
                      </h4>
                      <div className="bg-elec-yellow/10 border border-elec-yellow/30 rounded-xl p-4 mb-3">
                        <span className="text-2xl font-bold text-elec-yellow tracking-wider">
                          {contact.number}
                        </span>
                      </div>
                      ...
                      <a
                        ...
                        className="flex items-center justify-center gap-2 w-full h-11 bg-elec-yellow/10 border border-elec-yellow/30 text-elec-yellow hover:bg-elec-yellow hover:text-black rounded-xl transition-all duration-200 font-medium text-sm touch-manipulation active:scale-[0.98]"
                      >
