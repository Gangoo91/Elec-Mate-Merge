...
// Finite icon map for RAMS templates — avoids barrel import of entire lucide library
  ...
  const filteredTemplates = useMemo(() => {
    ...
    return ramsTemplates.filter(
      (template) =>
        ...
        template.detailedControls.some((control) =>
      ...
      <CardHeader className="pb-4">
        ...
        <div className="relative mt-3">
          ...
          <Input
            ...
            className={cn(
              'bg-green-500/10 border-white/20 text-foreground placeholder:text-foreground/50 focus:border-green-500/50 h-10',
              !searchTerm && 'pl-10'
            )}
          />
        </div>
        ...
        <div className="space-y-2 max-h-[600px] overflow-y-auto">
          {filteredTemplates.map((template) => {
            ...
            return (
              <Card
                key={template.id}
                className="bg-green-500/5 border-white/10 hover:border-green-500/30 transition-colors"
              >
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-2 mb-2">
                        <span
                          className={`text-xs px-2 py-1 rounded border ${getRiskLevelColor(template.likelihood, template.severity)}`}
                        >
                      ...
                      {isExpanded && (
                        <div className="mt-3 space-y-3 border-t border-white/10 pt-3">
                          {/* Detailed Controls */}
                          <div>
                            <h5 className="text-xs font-medium text-green-300 mb-2">
                              Control Measures:
                            </h5>
