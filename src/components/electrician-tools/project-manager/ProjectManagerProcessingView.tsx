...
import { Clipboard, Clock, XCircle, Loader2 } from 'lucide-react';
...
const ProjectManagerProcessingView = ({
  progress: agentProgress,
  startTime,
  onCancel,
  isCancelling = false
}: ProjectManagerProcessingViewProps) => {
  ...
  const progress = agentProgress ? STAGE_PERCENTAGES[agentProgress.stage] : 0;
  ...
  const getActivityMessage = () => {
    if (!agentProgress) return 'Initialising...';
    switch (agentProgress.stage) {
      case 'initializing': return 'Starting up...';
      case 'parsing': return 'Understanding project requirements...';
      case 'rag': return 'Searching BS 7671 requirements...';
      case 'ai': return 'Generating execution plan...';
      case 'validation': return 'Allocating resources...';
      case 'complete': return 'Finalising...';
    ...
    <div className="h-[100dvh] bg-gradient-to-b from-black via-[#0a0a0f] to-black flex flex-col overflow-hidden">
      ...
      <div className="relative z-10 flex-1 flex flex-col justify-evenly px-4 py-6 max-w-md mx-auto w-full">
        ...
        <div className="text-center space-y-3">
            ...
            <div className="relative">
              ...
              >
                <motion.div
                  ...
                  transition={{ duration: 2, repeat: Infinity }}
                >
                  <Clipboard className="h-8 w-8 text-elec-yellow drop-shadow-[0_0_10px_rgba(247,208,44,0.4)]" />
                </motion.div>
              </motion.div>
              <motion.div
          ...
          <div>
            <h2 className="text-xl font-bold text-white">AI Project Manager</h2>
            <p className="text-xs text-white/50 mt-1">Generating execution plan</p>
          </div>
        </div>
        ...
        {elapsedTime > ESTIMATED_TIME && (
          ...
          >
            <p className="text-[10px] text-amber-200 text-center">
              Taking longer than usual. Complex projects may take up to 5 minutes.
            </p>
          </motion.div>
        )}
