    ...
    <Card className="p-5 sm:p-4 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-950/20 dark:to-indigo-950/20 border-blue-200 dark:border-blue-800">
      ...
      <div className="space-y-4 sm:space-y-3">
        ...
        <div className="bg-white/80 dark:bg-elec-dark/80 p-4 sm:p-3 rounded border-2 sm:border border-blue-200 dark:border-blue-800">
          <p className="text-base sm:text-sm text-foreground mb-2 sm:mb-1 text-center sm:text-left">Formula:</p>
        ...
        {/* Components */}
        <div className="bg-white/80 dark:bg-elec-dark/80 p-4 sm:p-3 rounded border-2 sm:border border-blue-200 dark:border-blue-800">
          <p className="text-base sm:text-sm text-foreground mb-3 sm:mb-2 text-center sm:text-left font-semibold">Components:</p>
        ...
        {/* Expected Result */}
        <div className="bg-white/80 dark:bg-elec-dark/80 p-4 sm:p-3 rounded border-2 sm:border border-blue-200 dark:border-blue-800">
          <p className="text-base sm:text-sm text-foreground mb-2 sm:mb-1 text-center sm:text-left">Expected Result:</p>
