  ...
  const recentReviews = [
    {
      ...
      content:
        "Been using these for 6 months now. The insulation is top-notch and they've survived several drops. Comfortable grip even with gloves on. Worth every penny for safety-critical work.",
      helpful: 12,
      category: 'Hand Tools',
    ...
    },
    {
      ...
      content:
        'Does everything I need for periodic testing. Readings are consistent and the software is decent. Only downside is the weight - gets tiring carrying it around all day on site.',
      helpful: 8,
      category: 'Testing Equipment',
      userType: 'Trade',
    },
    {
      ...
      content:
        "Simple, effective, and has never let me down. Clear indication of live circuits. I always carry two - one as backup. Essential for any electrician's kit.",
      helpful: 15,
      category: 'Testing Equipment',
      userType: 'Professional',
    },
    ...
    <div className="space-y-6">
      <div className="text-center space-y-2">
        ...
        <p className="text-muted-foreground">
          Real reviews from UK electricians and tradespeople. Make informed decisions based on
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {topRatedTools.map((tool, index) => (
              <div
                key={index}
                className="p-4 bg-elec-dark/30 rounded-lg border border-amber-500/20"
              >
