              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div>
                  <h3 className="text-foreground font-medium mb-3">
                    Recommended Kit for {budget.label}
                  </h3>
                  <div className="space-y-3">
                  ...
                  <div className="p-4 bg-elec-yellow/10 rounded-lg border border-elec-yellow/20">
                    <div className="space-y-2">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span
                          className={budget.max - totalCost > 0 ? 'text-green-400' : 'text-red-400'}
                        >
                    ...
                    {handToolCategories
                      ...
                      .map((tool, index) => (
                        <tr key={index} className="border-b border-elec-yellow/10">
                          ...
                          <td className="p-2">
                            {tool.apprenticeChoice && (
                              <Badge className="bg-green-500/20 text-green-400 text-xs mr-1">
                                Apprentice
                              </Badge>
                            )}
                            {tool.professionalChoice && (
                ...
                {[
                  {
                    ...
                    review:
                      "Wiha screwdrivers are worth every penny. I've had the same set for 8 years and they're still perfect.",
                    rating: 5,
                    tool: 'Wiha VDE Set',
                  },
                  {
                    ...
                    review:
                      'Started with cheaper tools but quickly upgraded to Knipex cutters. The difference in quality is massive.',
                    rating: 5,
                  ...
                  },
                  {
                    ...
                    review:
                      'CK tools are brilliant. British made, reliable, and their customer service is excellent.',
                    rating: 4,
                    tool: 'CK Triton XLS',
                  },
                ].map((review, index) => (
                ...
                <div className="space-y-3">
                  <div className="p-3 bg-blue-500/10 rounded-lg border border-blue-500/20">
                    ...
                    <p className="text-xs text-muted-foreground">
                      Start with a basic VDE screwdriver set and quality side cutters. These are
                      your most-used tools. Upgrade other tools as you gain experience and know what
                      you prefer.
                    </p>
                  </div>
                  <div className="p-3 bg-purple-500/10 rounded-lg border border-purple-500/20">
                    ...
                    <p className="text-xs text-muted-foreground">
                      Invest in complete sets from one manufacturer for consistency. German tools
                      (Wiha, Knipex) offer exceptional build quality and lifetime warranties.
                    </p>
                  </div>
                  <div className="p-3 bg-green-500/10 rounded-lg border border-green-500/20">
                    <h4 className="text-green-300 font-medium text-sm mb-1">Business Owner Tip</h4>
                    <p className="text-xs text-muted-foreground">
                      Quality tools are a business investment. They last longer, work better, and
                      can be claimed as business expenses. Consider tool insurance for expensive
                      sets.
                    </p>
                  </div>
                </div>
