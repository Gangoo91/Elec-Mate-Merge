...
const GuideSelector = ({ onSelectGuide }: GuideSelectorProps) => {
  ...
  useEffect(() => {
    const fetchGuideMetadata = async () => {
      try {
        const { data, error } = await supabase.from('tool_guide_metadata').select('*');
  ...
  const guides: Guide[] = [
    {
      ...
      description:
        'Complete guide to choosing multifunction testers, PAT testers, and calibration requirements for compliance.',
    ...
    },
    {
      ...
      description:
        'Priority list for apprentices and new electricians - build your toolkit without breaking the bank.',
    ...
    },
    {
      ...
      description:
        'High-quality hand tools that will last a career. Investment pieces for experienced professionals.',
      category: 'Hand Tools',
      readTime: '15 min',
    ...
    },
    {
      ...
      description:
        'Navigate PPE standards, find comfortable protection, and understand compliance requirements.',
    ...
    },
    {
      ...
      description:
        'Comprehensive guide to cable stripping, crimping, and termination equipment for all cable types.',
    ...
    },
    {
      ...
      description:
        'Professional storage solutions from toolboxes to van organisation and workshop setups.',
    ...
    },
    {
      ...
      description:
        'Comprehensive guide to inspection cameras, thermal imaging, and testing equipment for fault finding.',
    ...
    },
    {
      ...
      description:
        'Next-generation tools with app connectivity, remote monitoring, and automated diagnostics.',
              ...
              >
                ...
                <CardHeader className="pb-3">
                      ...
                      <Badge
                        className={`${
                          guide.badge === 'Most Popular'
                            ...
                            : guide.badge === 'Beginner Guide'
                              ? 'bg-green-500/20 text-green-400'
                              : guide.badge === 'Professional Choice'
                                ? 'bg-purple-500/20 text-purple-400'
                                : guide.badge === 'Safety Focus'
                                  ? 'bg-red-500/20 text-red-400'
                                  : guide.badge === 'New Guide'
                                    ? 'bg-blue-500/20 text-blue-400'
                                    : guide.badge === 'In Development'
                                      ? 'bg-amber-500/20 text-amber-400'
                                      : guide.badge === 'Future Tech'
                                        ? 'bg-purple-500/20 text-purple-400'
                                        : 'bg-amber-500/20 text-amber-400'
                        }`}
                      >
                          ...
                          <TooltipContent>
                            <div className="text-center">
                              <p className="font-medium">
                                Guide Status:{' '}
                                {guide.metadata?.development_status || 'In Development'}
                              </p>
                              {estimatedDate && (
                                <p className="text-sm">Expected: {estimatedDate}</p>
                              )}
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    >
                      <guide.icon
                        className={`h-5 w-5 ${isComingSoon ? 'text-gray-400' : 'text-elec-yellow'}`}
                      />
                    </div>
                ...
                <CardContent className="space-y-4">
                  ...
                  {isComingSoon && guide.metadata && (
                    <div className="flex items-center gap-2 text-sm">
                      ...
                      <span
                        className={`font-medium capitalize ${getDevelopmentStatusColor(guide.metadata.development_status)}`}
                      >
