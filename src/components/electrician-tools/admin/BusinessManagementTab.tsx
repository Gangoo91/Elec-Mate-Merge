        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {coreBusinessTools.map((tool, index) => (
              <Card
                key={index}
                className="border-elec-yellow/20 bg-elec-gray hover:bg-elec-gray/80 transition-colors"
              >
            ...
            <div className="space-y-3">
              <div className="text-sm">
                ...
                <p className="text-muted-foreground text-xs">
                  Tools designed with electrical industry regulations and best practices in mind
                </p>
              </div>
              <div className="text-sm">
                <h4 className="font-medium text-foreground mb-1">Compliance Ready</h4>
                <p className="text-muted-foreground text-xs">
                  Built-in templates for BS 7671, Part P notifications, and certification
                  requirements
                </p>
              </div>
              <div className="text-sm">
                ...
                <p className="text-muted-foreground text-xs">
                  Reduce paperwork and administrative overhead with automated workflows
                </p>
              </div>
            </div>
          </CardContent>
