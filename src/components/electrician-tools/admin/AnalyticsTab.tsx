...
const AnalyticsTab = () => {
  ...
  const analyticsTools = [
    ...
    },
    {
      ...
      description: 'Track project performance and profitability',
              ...
              <Card key={index} className="border-elec-yellow/20 bg-elec-gray">
                <CardContent className="p-4">
                  <div className="flex items-center justify-between mb-2">
                    {metric.icon}
                    <div
                      className={`flex items-center gap-1 text-xs ${metric.trend === 'up' ? 'text-green-400' : 'text-red-400'}`}
                    >
                      {metric.trend === 'up' ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
            <div className="border border-orange-500/20 rounded-lg p-4">
              ...
              <p className="text-xs text-muted-foreground">
                Monitor job duration and improve efficiency
              </p>
            </div>
            <div className="border border-orange-500/20 rounded-lg p-4">
              ...
              <p className="text-xs text-muted-foreground">
                Track business growth and identify opportunities
              </p>
            </div>
            <div className="border border-orange-500/20 rounded-lg p-4">
