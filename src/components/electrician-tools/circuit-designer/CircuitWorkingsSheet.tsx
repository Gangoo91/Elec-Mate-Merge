          ...
          <div className="overflow-y-auto flex-1 p-6 space-y-6">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-sm font-semibold text-elec-light">Earth Fault Loop (BS 7671 Reg 411.4.4)</h3>
              </div>
              <div className="bg-elec-dark/60 rounded-lg p-4 border border-elec-yellow/20 space-y-3">
                <div className="text-xs font-mono text-elec-light/70">
                  Zs = Ze + (R1 + R2)
                ...
                <div className="space-y-2">
                  <div className="flex justify-between text-sm">
                    <span className="text-elec-light/60">External impedance (Ze)</span>
                    <span className="font-mono text-elec-light">{design.consumerUnit.incomingSupply.Ze}Ω</span>
                  </div>
                  {circuit.expectedTestResults?.r1r2 && (
                    <div className="flex justify-between text-sm">
                      <span className="text-elec-light/60">Cable impedance (R1+R2)</span>
                ...
                <div className="pt-2 border-t border-elec-yellow/10">
                  <div className="flex justify-between items-end mb-2">
                    <span className="text-xs text-elec-light/60">Calculated Zs</span>
                    <span className="text-lg font-bold text-elec-yellow">
                      {fmt(calculations?.zs, 2)}Ω
                    </span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-xs text-elec-light/60">Maximum Zs ({circuit.protectionDevice.rating}A Type {circuit.protectionDevice.curve})</span>
                    <div className="flex items-center gap-2">
                      <span className="text-sm text-elec-light/80">
                ...
                <div className="text-xs text-elec-light/60 leading-relaxed pt-2 border-t border-elec-yellow/10">
