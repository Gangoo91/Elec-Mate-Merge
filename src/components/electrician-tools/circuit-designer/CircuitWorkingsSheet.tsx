...
export const CircuitWorkingsSheet = ({
  circuit,
  design,
  isOpen,
  onClose,
}: CircuitWorkingsSheetProps) => {
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-elec-light/60">
                    Way {circuit.circuitNumber}: {circuit.name}
                  </p>
                </div>
              </div>
              <button
          ...
          <div className="overflow-y-auto flex-1 p-6 space-y-6">
            ...
            <div className="space-y-3">
              ...
              <div className="bg-elec-dark/60 rounded-lg p-4 border border-elec-yellow/20 space-y-2">
                <div className="text-xs font-mono text-elec-light/70">Ib = Power ÷ Voltage</div>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-sm font-semibold text-elec-light">
                  Cable Sizing (BS 7671 Reg 433.1.1)
                </h3>
              </div>
              <div className="bg-elec-dark/60 rounded-lg p-4 border border-elec-yellow/20 space-y-3">
                ...
                <div className="grid grid-cols-3 gap-2 text-center">
                  <div className="p-2 bg-elec-dark/80 rounded">
                    ...
                    <div className="text-sm font-bold text-elec-light">
                      {fmt(calculations?.Ib, 1)}A
                    </div>
                  </div>
                  <div className="p-2 bg-elec-yellow/20 rounded">
                    ...
                    <div className="text-sm font-bold text-elec-yellow">
                      {calculations?.In || circuit.protectionDevice?.rating || '—'}A
                    </div>
                  </div>
                  <div className="p-2 bg-elec-dark/80 rounded">
                    <div className="text-xs text-elec-light/60">Iz</div>
                    <div className="text-sm font-bold text-elec-light">
                      {fmt(calculations?.Iz, 1)}A
                    </div>
                  </div>
                </div>
                ...
                {circuit.deratingFactors && (
                  <>
                    <div className="pt-2 border-t border-elec-yellow/10">
                      ...
                      <div className="space-y-1">
                        <div className="flex justify-between text-xs">
                          ...
                          <span className="font-mono text-elec-light">
                            {circuit.deratingFactors.Ca}
                          </span>
                        </div>
                        <div className="flex justify-between text-xs">
                          <span className="text-elec-light/60">Grouping (Cg)</span>
                          <span className="font-mono text-elec-light">
                            {circuit.deratingFactors.Cg}
                          </span>
                        </div>
                        <div className="flex justify-between text-xs">
                          <span className="text-elec-light/60">Insulation (Ci)</span>
                          <span className="font-mono text-elec-light">
                            {circuit.deratingFactors.Ci}
                          </span>
                        </div>
                        <div className="flex justify-between text-xs pt-1 border-t border-elec-yellow/10">
                          ...
                          <span className="font-mono text-elec-yellow font-bold">
                            {circuit.deratingFactors.overall}
                          </span>
                        </div>
                      </div>
                    </div>
                    ...
                    <Badge
                      variant="outline"
                      className="text-xs border-elec-yellow/30 text-elec-light/70"
                    >
                ...
                <div className="pt-2 border-t border-elec-yellow/10">
                  <div className="flex justify-between items-end mb-2">
                    ...
                    <span className="text-lg font-bold text-elec-yellow">
                      {fmt(calculations?.voltageDrop?.volts, 1)}V (
                      {fmt(calculations?.voltageDrop?.percent, 2)}%)
                    </span>
                  </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-2 bg-elec-yellow/5 p-2 rounded-md -mx-2">
                ...
                <h3 className="text-base sm:text-lg font-semibold text-elec-light">
                  Earth Fault Loop (BS 7671 Reg 411.4.4)
                </h3>
              </div>
              <div className="bg-elec-dark/80 rounded-lg p-3 border border-elec-yellow/30 space-y-2">
                <div className="text-sm sm:text-base font-mono text-foreground/90 text-center">
              ...
              <div className="bg-elec-dark/60 rounded-lg p-4 border border-elec-yellow/20 space-y-3">
                  ...
                  {circuit.expectedTestResults?.r1r2 && (
                    <div className="flex justify-between text-sm">
                      <span className="text-foreground/80">
                        Cable impedance (R1+R2){circuit.loadType.includes('ring') ? ' ÷ 4' : ''}
                      </span>
                      <span className="font-mono text-elec-light">
                ...
                <div className="pt-2 border-t border-elec-yellow/10">
                  <div className="flex justify-between items-end mb-2">
                    <span className="text-sm text-foreground/90">Calculated Zs</span>
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-foreground/90">
                      Maximum Zs ({calculations?.In || circuit.protectionDevice?.rating || '—'}A
                ...
                {(calculations?.zs ?? 0) > (calculations?.maxZs ?? 999) && (
                  <div className="mt-3 p-3 bg-red-500/10 border border-red-500/30 rounded-lg">
                    <p className="text-xs text-red-200 leading-relaxed">
                      ⚠️ <strong>Non-Compliant:</strong> Zs exceeds maximum for safe disconnection
                      in 0.4s (socket circuits).
                      {circuit.loadType.includes('ring') && (
                        <span className="block mt-1">
                          For ring finals, check if calculation used divide-by-4 rule (parallel
                          paths).
                        </span>
                      )}
                    </p>
                ...
                <div className="text-xs text-foreground/80 leading-relaxed pt-2 border-t border-elec-yellow/10">
                  Maximum disconnection time: 0.4s for socket circuits, 5s for fixed equipment per
                  BS 7671 Table 41.1
                </div>
              </div>
            </div>
            ...
            <div className="space-y-2 pb-6">
              ...
              <div className="space-y-2">
                <Badge
                  variant="outline"
                  className="text-xs border-elec-yellow/30 text-elec-light/70 w-full justify-start"
                >
