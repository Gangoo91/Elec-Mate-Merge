  ...
  return (
    <>
      ...
      <Button
        ...
        className="bg-transparent border-elec-yellow/30 text-elec-light hover:bg-elec-yellow/10 hover:border-elec-yellow/50 transition-all duration-300 h-12 px-4 shrink-0"
      >
