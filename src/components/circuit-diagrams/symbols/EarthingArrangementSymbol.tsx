...
export const EarthingArrangementSymbol = ({
  x,
  y,
  type,
  label,
}: EarthingArrangementSymbolProps) => {
  return (
    <g transform={`translate(${x}, ${y})`}>
      {type === 'TT' && (
        <>
          ...
          <g transform="translate(-25, 0)">
            ...
            <text x="0" y="-25" fontSize="8" textAnchor="middle" fill="currentColor">
              E
            </text>
          </g>
          <g transform="translate(25, 0)">
      ...
      {type === 'TN-S' && (
        <>
          ...
          <text x="-20" y="-35" fontSize="8" textAnchor="middle" fill="currentColor">
            N
          </text>
          <text x="20" y="-35" fontSize="8" textAnchor="middle" fill="currentColor">
            PE
      ...
      {type === 'TN-C-S' && (
        <>
          ...
          <text x="25" y="-20" fontSize="7" textAnchor="start" fill="currentColor">
            PME
          </text>
        </>
      )}
