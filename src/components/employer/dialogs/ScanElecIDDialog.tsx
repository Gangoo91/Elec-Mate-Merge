        ...
        <div className="py-4">
          ...
          {scanState === 'input' && (
            <div className="space-y-4">
              ...
              <Button variant="outline" onClick={handleSimulateScan} className="w-full gap-2">
          ...
          {scanState === 'result' && result && (
            <div className="space-y-4">
              ...
              {/* Overall Status */}
              <Card
                className={`border ${overallStatus === 'compliant' ? 'border-success/30 bg-success/5' : overallStatus === 'expiring' ? 'border-warning/30 bg-warning/5' : 'border-destructive/30 bg-destructive/5'}`}
              >
                <CardContent className="p-4">
