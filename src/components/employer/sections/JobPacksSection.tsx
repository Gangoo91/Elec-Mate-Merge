...
const statusConfig = {
  Draft: { color: 'bg-muted text-white border-muted', icon: Clock, accent: 'muted' },
        ...
        {filteredJobPacks.length === 0 && (
          <Card className="border-dashed border-2">
            <CardContent className="py-12 text-center">
              ...
              <p className="text-white text-sm mb-4 max-w-sm mx-auto">
            ...
            >
              <CardContent className="p-4">
                ...
                <div className="flex items-center gap-3 mb-3 p-2.5 rounded-lg bg-muted/30">
                  ...
                  <span className="text-xs text-white ml-auto">{docProgress}/3</span>
                </div>
                ...
                {jobPack.estimated_value && (
                  <div className="flex items-center justify-end gap-1 mt-2 text-xs text-white">
