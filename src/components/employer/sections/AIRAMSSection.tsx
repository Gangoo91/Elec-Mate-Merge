                  ...
                  {result.ramsData && (
                    <div className="p-3 rounded-lg bg-elec-dark/50 border border-elec-yellow/10">
                      <div className="grid grid-cols-2 gap-2 text-sm">
                        <div>
                          <span className="text-white">Hazards: </span>
                          <span className="text-foreground font-medium">
                            {result.ramsData.risks?.length || 0}
                          </span>
                        </div>
                        <div>
                          <span className="text-white">PPE Items: </span>
                          <span className="text-foreground font-medium">
                            {result.ramsData.ppeDetails?.length || 0}
                          </span>
                        </div>
                        <div>
                          <span className="text-white">Emergency Procedures: </span>
                          <span className="text-foreground font-medium">
                            {result.ramsData.emergencyProcedures?.length || 0}
                          </span>
                        </div>
                        <div>
                          <span className="text-white">Regulations: </span>
                          <span className="text-foreground font-medium">
