...
// LTI Configuration values
const ltiConfig = {
  toolUrl: 'https://elecmate.app/lti/launch',
  jwksUrl: 'https://elecmate.app/lti/jwks',
  deepLinkUrl: 'https://elecmate.app/lti/deep-link',
  redirectUris: ['https://elecmate.app/lti/callback'],
  oidcInitUrl: 'https://elecmate.app/lti/oidc/init',
};
                ...
                <AccordionItem value="step2">
                  ...
                  <AccordionContent className="text-muted-foreground space-y-2 pl-9">
                    ...
                    <ul className="list-disc pl-4 space-y-1">
                      ...
                      <li><strong>Tool Provider Domain:</strong> elecmate.app</li>
                    </ul>
                  </AccordionContent>
                </AccordionItem>
                <AccordionItem value="step3">
