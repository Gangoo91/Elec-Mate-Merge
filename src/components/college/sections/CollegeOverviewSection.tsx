        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-px bg-white/[0.06] border border-white/[0.06] rounded-2xl overflow-hidden">
          {kpis.map((stat, i) => (
            ...
            >
              ...
              <span className="mt-3 text-[11px] text-white">{stat.sub}</span>
            </button>
          ))}
        </div>
      </motion.section>
          ...
          {hubs.map((hub) => (
            ...
            >
              ...
              <div className="mt-6 flex items-center justify-between pt-4 border-t border-white/[0.06]">
                <span className="text-[11px] text-white">{hub.meta}</span>
            ...
            {overdueILPReviews > 0 && (
              ...
              >
                ...
                <div className="flex items-center gap-4 sm:gap-6">
                  ...
                  <span className="text-white text-lg group-hover:text-elec-yellow group-hover:translate-x-0.5 transition-all">
                    →
                  </span>
                </div>
              </button>
            ...
            >
              <div className="flex items-start justify-between gap-2">
                <div className="min-w-0">
                  ...
                  <div className="mt-1 text-[12px] text-white">{action.desc}</div>
                </div>
      ...
      >
        ...
        <div className="space-y-5">
          ...
          {upcomingLessons.length > 0 ? (
            ...
            <div className="py-10 text-center text-[12px] text-white bg-[hsl(0_0%_12%)] border border-white/[0.06] rounded-2xl">
            ...
            {[
              ...
              >
                <div>
                  ...
                  <div className="mt-0.5 text-[11px] text-white">{row.sub}</div>
                </div>
                <span
                  className={cn(
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-px bg-white/[0.06] border border-white/[0.06] rounded-2xl overflow-hidden">
          {tools.map((tool) => (
            ...
            >
              ...
              <div className="mt-1.5 text-[12px] leading-relaxed text-white">{tool.desc}</div>
              <div className="flex-grow" />
              <div className="mt-4 text-[12px] font-medium text-elec-yellow/80 group-hover:text-elec-yellow group-hover:translate-x-0.5 transition-all">
                Open →
              </div>
