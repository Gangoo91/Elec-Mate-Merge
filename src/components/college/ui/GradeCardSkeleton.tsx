/**
 * Skeleton loading card that matches the grading section card layout exactly.
      ...
      <div className="p-4">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1 min-w-0 space-y-3">
            ...
            {/* Assessment type badge + grade badge */}
...
export function GradeCardSkeletonList({ count = 4 }: { count?: number }) {
  return (
