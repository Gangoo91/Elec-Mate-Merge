      ...
      <Collapsible open={isOpen} onOpenChange={onToggle}>
        ...
        <CollapsibleContent>
          <CardContent className="space-y-6 p-4 sm:p-6">
            ...
            {/* Distribution Board */}
            <div className="space-y-4">
              <h3 className="text-sm sm:text-base font-semibold text-foreground border-b border-elec-gray pb-2 pl-2.5 border-l-2 border-l-green-400">
                Distribution Board
              </h3>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  <Label htmlFor="boardSize" className="font-medium text-sm">
                    Number of Ways
                  </Label>
                  <Select
                ...
                <div>
                  <Label htmlFor="boardType" className="font-medium text-sm">
                    Board Type
                  </Label>
                  <Select
                ...
                <div>
                  <Label htmlFor="boardLocation" className="font-medium text-sm">
                    Board Location
                  </Label>
                  <Select
