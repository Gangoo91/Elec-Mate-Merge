          ...
          <CardContent className="space-y-6 p-4 sm:p-6">
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <Label className="font-medium text-sm">Earth Electrode</Label>
                <div className="flex items-center gap-2">
                  ...
                  />
                  <Label htmlFor="earthElectrodeNA" className="text-xs cursor-pointer">
                    N/A
                  </Label>
                </div>
              </div>
              {formData.earthElectrodeNA ? (
                <p className="text-xs text-white p-2">Earth electrode marked as not applicable</p>
              ) : (
              ...
              <div className="space-y-3 p-3 rounded-lg bg-white/[0.02] border border-white/[0.06]">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    />
                    <Label htmlFor="earthingConductorNA" className="text-xs cursor-pointer">
                      N/A
                    </Label>
                  </div>
                </div>
                {formData.earthingConductorNA ? (
                  <p className="text-xs text-white">Earthing conductor marked as not applicable</p>
                ) : (
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <div className="space-y-2">
                      ...
                      >
                        <SelectTrigger className="h-11 touch-manipulation bg-elec-gray border-elec-gray focus:border-purple-500 focus:ring-purple-500">
              ...
              <div className="space-y-3 p-3 rounded-lg bg-white/[0.02] border border-white/[0.06]">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    />
                    <Label htmlFor="mainBondingNA" className="text-xs cursor-pointer">
                      N/A
                    </Label>
                  </div>
                </div>
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                <div className="flex items-center space-x-2">
                  ...
                  />
                  <label htmlFor="bondingToWater" className="text-sm cursor-pointer">
                    Water pipes
                  </label>
                </div>
                <div className="flex items-center space-x-2">
                  ...
                  />
                  <label htmlFor="bondingToGas" className="text-sm cursor-pointer">
                    Gas pipes
                  </label>
                </div>
                <div className="flex items-center space-x-2">
                  ...
                  />
                  <label htmlFor="bondingToOil" className="text-sm cursor-pointer">
                    Oil pipes
                  </label>
                </div>
                <div className="flex items-center space-x-2">
                  ...
                  />
                  <label htmlFor="bondingToStructuralSteel" className="text-sm cursor-pointer">
                    Structural steel
                  </label>
                </div>
                <div className="flex items-center space-x-2">
                  ...
                  />
                  <label htmlFor="bondingToLightningProtection" className="text-sm cursor-pointer">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  />
                  <label htmlFor="bondingToOther" className="text-sm cursor-pointer">
                    Other
                  </label>
                </div>
              </div>
              {formData.bondingToOther && (
                <div className="space-y-2 mt-3">
                  <Label htmlFor="bondingOtherSpecify" className="text-sm font-normal">
                    Specify Other
                  </Label>
                  <Input
