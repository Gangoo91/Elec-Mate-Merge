...
const PATTestingResults: React.FC<PATTestingResultsProps> = ({ formData, onUpdate }) => {
  ...
  const updateElectricalTests = (id: string, testType: string, field: string, value: any) => {
    ...
    const currentTest =
      appliance.electricalTests[testType as keyof typeof appliance.electricalTests];
  ...
  const setAllPass = (id: string) => {
    ...
    updateAppliance(id, {
      ...
      electricalTests: {
        ...appliance.electricalTests,
        earthContinuity: {
          ...appliance.electricalTests.earthContinuity,
          result: appliance.applianceClass === 'II' ? 'na' : 'pass',
        },
  ...
  return (
    <div className="space-y-6">
      ...
      <div className={cn(isMobile ? '' : 'eicr-section-card')}>
        <div className={cn('p-4', isMobile ? 'border-b border-border/20' : '')}>
          <div className="flex items-center justify-between">
            ...
            <span className="text-sm font-normal text-muted-foreground">
              {appliances.filter((a: Appliance) => a.overallResult).length} / {appliances.length}{' '}
              complete
            </span>
          </div>
        </div>
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <p className="font-medium text-sm">
                              {appliance.assetNumber || 'No Asset No.'} -{' '}
                              {appliance.description || 'No Description'}
                            </p>
                            <p className="text-xs text-muted-foreground">
                              {appliance.location || 'No location'}
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                          {[
                            ...
                            <div key={key}>
                              ...
                              <Select
                                value={
                                  appliance.visualInspection?.[
                                    key as keyof typeof appliance.visualInspection
                                  ] || ''
                                }
                          ...
                          <div>
                            ...
                            <Input
                              ...
                              onChange={(e) =>
                                updateVisualInspection(appliance.id, 'fuseRating', e.target.value)
                              }
                          ...
                          <div>
                            ...
                            <div className="flex gap-1">
                              <Input
                                placeholder=">999"
                                value={
                                  appliance.electricalTests?.insulationResistance?.reading || ''
                                }
                                onChange={(e) =>
                                  updateElectricalTests(
                                    appliance.id,
                              ...
                              <Select
                                value={
                                  appliance.electricalTests?.insulationResistance?.result || ''
                                }
                                onValueChange={(v) =>
                                  updateElectricalTests(
                                    appliance.id,
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2 border-t border-border">
                        <div>
                          ...
                          <Select
                            ...
                            onValueChange={(v) =>
                              updateAppliance(appliance.id, { overallResult: v as any })
                            }
                          >
                        ...
                        <div>
                          ...
                          <Input
                            ...
                            onChange={(e) =>
                              updateAppliance(appliance.id, { nextTestDue: e.target.value })
                            }
        ...
        >
          <div className="flex items-center gap-3 mb-3">
            ...
            <span className="font-semibold text-lg text-red-500">
              Failed Appliances - Action Required
            </span>
          </div>
