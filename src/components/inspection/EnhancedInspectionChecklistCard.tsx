...
const EnhancedInspectionChecklistCard: React.FC<EnhancedInspectionChecklistCardProps> = ({
  ...
  return (
    <Card className="bs7671-clean-card">
      <CardHeader className="bs7671-mobile-spacing pb-4">
        <div className="flex items-start justify-between gap-4">
          <div className="flex items-center gap-3">
            <div className="bs7671-clean-card">
              <div className="p-2 bg-bs7671-earth/10 rounded-lg">
                <FileText className="h-6 w-6 text-bs7671-earth" />
              </div>
            </div>
            <div>
              <CardTitle className="bs7671-title text-elec-yellow flex items-center gap-2">
      ...
      <CardContent className="bs7671-mobile-spacing pt-0">
