...
const regulations: RegulationDetail[] = [
  {
    ...
    description:
      'The earth fault loop impedance must not exceed values specified in relevant tables to ensure automatic disconnection within required time limits.',
    keyPoints: [
    ...
    practicalApplication:
      'Measure Zs at each point using calibrated loop impedance tester. Compare measured values against tabulated maxima for the protective device installed.',
    commonIssues: [
  ...
  },
  {
    ...
    description:
      'RCD protection required for socket outlets rated up to 20A and mobile equipment, providing additional protection against direct contact.',
    keyPoints: [
    ...
    practicalApplication:
      'Install 30mA RCD upstream of socket outlet circuits. Test operation using RCD tester at rated current and 5× rated current.',
    commonIssues: [
  ...
  },
  {
    ...
    description:
      'The earthing conductor must be sized according to the cross-sectional area of the line conductor and material used.',
    keyPoints: [
    ...
    practicalApplication:
      'Size earthing conductor using Table 54.7. Ensure adequate protection and accessibility for inspection and testing.',
    commonIssues: [
  ...
  },
  {
    ...
    description:
      'Main protective bonding required to extraneous-conductive-parts including water, gas, oil pipes and structural steelwork.',
    keyPoints: [
    ...
    practicalApplication:
      'Install main bonding to all services entering building. Use proper bonding clamps with safety electrical connection labels.',
    commonIssues: [
