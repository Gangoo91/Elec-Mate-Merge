...
const EnhancedInspectionItemCard: React.FC<EnhancedInspectionItemCardProps> = ({
  ...
  return (
    <Card
      className={`border-l-4 ${getBorderColor()} shadow-sm hover:shadow-md transition-shadow mb-2 md:mb-3`}
    >
        ...
        <div className="space-y-3 md:space-y-4">
          ...
          <div>
            ...
            {sectionItem.clause ? (
              ...
              >
                {sectionItem.clause.includes('Visual') ||
                sectionItem.clause.includes('Reserved') ||
                sectionItem.clause.includes('Part') ||
                sectionItem.clause.includes('Chapter')
                  ? sectionItem.clause
              ...
              <Badge
                variant="secondary"
                className="mt-1 text-[10px] md:text-xs font-mono px-1.5 md:px-2 py-0.5 bg-gray-500/10 border-gray-500/30 text-gray-400"
              >
                No Specific Reg
              </Badge>
            )}
