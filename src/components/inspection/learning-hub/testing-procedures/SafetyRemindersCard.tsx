  ...
  const safetyReminders = [
    {
      ...
      description:
        'Always isolate circuits and prove dead before testing. Use a proving unit to verify your voltage indicator.',
      severity: 'critical',
    },
    {
      title: 'Equipment Calibration',
      description:
        'Ensure all test instruments are within calibration dates and operating correctly.',
      severity: 'essential',
    },
    {
    ...
    },
    {
      title: 'Test Sequence',
      description:
        'Follow the correct sequence: dead tests before live tests, lower voltages before higher voltages.',
      severity: 'important',
    },
    {
      title: 'Documentation',
      ...
      <CardContent>
        <div className="space-y-3">
          {safetyReminders.map((safety, index) => (
            <div
              key={index}
              className={`p-3 border rounded-lg ${getSeverityColor(safety.severity)}`}
            >
