      ...
      <CardContent className="space-y-6 text-gray-300">
        <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-4">
          ...
          <p className="text-sm mb-3">
            Electrical certificates are legal documents that verify the safety and compliance of
            electrical work. Proper completion is essential for regulatory compliance, insurance
            validity, and occupant safety. These documents provide a permanent record of the
            electrical work carried out and demonstrate that the installation meets the requirements
            of BS 7671.
          </p>
          ...
          <div className="mt-4 p-3 bg-amber-500/10 border border-amber-500/20 rounded">
            ...
            <p className="text-xs">
              Falsifying electrical certificates is a criminal offence. Only competent persons
              should complete certificates for work they have personally designed, installed,
              inspected, and tested. Certificates must be accurate, complete, and signed by the
              responsible person.
            </p>
          </div>
        </div>

        <SmartTabs tabs={smartTabs} defaultValue="eic-completion" className="w-full" />
      </CardContent>
    </Card>
  );
};
