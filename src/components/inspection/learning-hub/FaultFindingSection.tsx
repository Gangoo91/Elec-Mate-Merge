  ...
  const faultFindingSteps = [
    {
      ...
      description:
        'Comprehensive preparation and risk assessment before commencing fault finding activities',
      keyPoints: [
    ...
    },
    {
      ...
      category: 'testing',
      description:
        'Systematic MCB switching to identify which circuit is causing the main breaker to trip',
      keyPoints: [
      ...
      priority: 'high',
      safetyNote:
        'Only qualified electricians should perform this procedure. Ensure all safety protocols are followed and appropriate PPE is worn.',
      testingContext:
        'This is a diagnostic troubleshooting technique, not a formal BS 7671 Part 6 inspection and testing procedure. It is used during fault-finding to isolate problematic circuits. Formal testing follows the sequence in BS 7671 Section 612.',
    },
    {
      id: 'fault-analysis',
    ...
    <div className="space-y-3 sm:space-y-4">
      {faultFindingSteps.map((step, index) => (
        <Collapsible key={step.id}>
          <Card
            className={`transition-all duration-200 ${getStepColor(step.category)} hover:bg-card hover:border-border border-l-4 touch-manipulation active:scale-[0.99]`}
          >
                  ...
                  <ol className="space-y-2 sm:space-y-3">
                    {step.detailedSteps.map((detailStep, index) => (
                      ...
                      >
                        <Badge
                          variant="outline"
                          className="text-xs min-w-[28px] min-h-[24px] flex items-center justify-center shrink-0"
                        >
                          {index + 1}
                        </Badge>
                ...
                {(step as any).safetyNote && (
                  <div className="bg-orange-500/10 border border-orange-500/30 rounded-lg p-3 sm:p-4">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <h5 className="font-semibold text-orange-400 text-sm sm:text-base">
                        Safety Note
                      </h5>
                    </div>
  ...
  const TestEquipmentContent = () => (
    <div className="space-y-4 sm:space-y-5 md:space-y-6">
      {testEquipment.map((equipment, index) => (
        <Card
          key={index}
          className="border-l-4 border-l-purple-500 hover:bg-card hover:border-border transition-all touch-manipulation"
        >
          ...
          <CardContent className="p-4 sm:p-5 md:p-6 pt-0 space-y-4 sm:space-y-5 md:space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5 md:gap-6">
              <div>
                <h4 className="font-semibold text-purple-400 mb-2 text-sm sm:text-base">
                  Primary Uses:
                </h4>
                <ul className="space-y-2">
                  {equipment.uses.map((use, useIndex) => (
                    <li
                      key={useIndex}
                      className="text-gray-300 text-xs sm:text-sm flex items-start gap-2 leading-relaxed"
                    >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 sm:gap-4 pt-4 border-t border-purple-500/20">
              ...
              <div>
                <h5 className="font-medium text-yellow-400 mb-1 text-xs sm:text-sm">
                  Calibration:
                </h5>
                <Badge variant="outline" className="text-xs">
    ...
    const safetyTopics = [
      {
        ...
        category: 'safety',
        description:
          'Essential personal safety practices and work protocols for electrical fault finding',
        keyPoints: [
      ...
      <div className="space-y-3 sm:space-y-4">
          ...
          <CardContent className="p-4 sm:p-5 md:p-6 pt-0">
            <div className="bg-red-500/10 border border-red-500/20 p-4 sm:p-5 rounded-lg">
              <p className="text-red-300 font-medium text-sm sm:text-base leading-relaxed">
                ⚠️ Electrical fault finding involves working with potentially live systems. Always
                prioritise safety over speed of diagnosis.
              </p>
            </div>
          </CardContent>
        </Card>
        ...
        {safetyTopics.map((topic, index) => (
          <Collapsible key={topic.id}>
            <Card
              className={`transition-all duration-200 ${getStepColor(topic.category)} hover:bg-card hover:border-border border-l-4 touch-manipulation active:scale-[0.99]`}
            >
              <CollapsibleTrigger className="w-full min-h-[44px]">
                <CardHeader className="p-4 sm:p-5 md:p-6 cursor-pointer">
                  <div className="flex items-start justify-between gap-3 mb-2">
                  ...
                  <p className="text-left text-sm text-muted-foreground">{topic.description}</p>
                </CardHeader>
              </CollapsibleTrigger>
    ...
    const diagnosticScenarios = [
      {
        ...
        description:
          'Comprehensive continuity testing and analysis procedures for electrical circuits',
        diagnostics: [
          {
      ...
      <div className="space-y-4">
        {diagnosticScenarios.map((scenario, index) => (
          <Collapsible key={scenario.id}>
            <Card
              className={`transition-all duration-200 ${getStepColor(scenario.category)} hover:shadow-md`}
            >
              <CollapsibleTrigger className="w-full">
                <CardHeader className="cursor-pointer hover:bg-black/10 active:bg-black/15 transition-all touch-manipulation">
                  ...
                  <p className="text-left text-sm text-muted-foreground">{scenario.description}</p>
                </CardHeader>
              </CollapsibleTrigger>
              ...
              <CollapsibleContent>
                <CardContent className="space-y-4">
                  {scenario.diagnostics.map((diagnostic, diagIndex) => (
                    <div
                      key={diagIndex}
                      className={`rounded-lg p-4 border ${getSeverityColor(diagnostic.severity)}`}
                    >
                      <div className="space-y-4">
                          ...
                          <div className="space-y-2">
                            {diagnostic.diagnosticSteps.map((step, stepIndex) => (
                              <div key={stepIndex} className="flex items-start gap-3">
                                <Badge
                                  variant="outline"
                                  className="text-xs min-w-[28px] h-6 flex items-center justify-center bg-blue-500/10 border-blue-500/30 text-blue-400"
                                >
                                  {stepIndex + 1}
                                </Badge>
    ...
    const realWorldFaults = [
      {
        ...
        examples: [
          ...
          },
          {
            ...
            rectification:
              '1. Isolate supply and make safe. 2. Excavate to expose full damage. 3. Install new route if existing too shallow. 4. Use 70mm² SWA minimum for 40A supply. 5. Install warning tape 300mm above cable. 6. Backfill with sand and marker posts. 7. Update site drawings with new route. 8. Test loop impedance and insulation.',
          ...
          },
          {
            ...
            rectification:
              '1. Isolate main switch and test dead. 2. Remove affected MCB and inspect terminal damage. 3. Cut back damaged cable end by 50mm. 4. Clean and inspect busbar for damage. 5. Install new MCB with correct torque settings. 6. Apply thermal compound if busbar shows pitting. 7. Tighten all adjacent connections. 8. Monitor with thermal camera after energising.',
          ...
          },
          {
            ...
            rectification:
              '1. Isolate three-phase supply and prove dead. 2. Test each phase for continuity to identify failed phase. 3. Locate joint position using cable route drawings. 4. Excavate or access joint enclosure. 5. Cut out failed joint and remake with resin-filled connectors. 6. Apply heat-shrink sleeve and re-seal enclosure. 7. Test phase rotation and voltage balance. 8. Load test with motor starting.',
        ...
        examples: [
          {
            ...
            rectification:
              '1. Calculate actual load requirements for all appliances. 2. Install dedicated 32A circuit for oven using 6mm² cable. 3. Install 20A circuit for microwave and dishwasher. 4. Redistribute existing sockets across multiple circuits. 5. Update consumer unit with additional MCBs. 6. Test all circuits for compliance. 7. Provide load schedule to customer.',
          ...
          },
          {
            ...
            rectification:
              '1. Conduct comprehensive load survey using power analyser. 2. Install sub-distribution board for IT equipment. 3. Provide UPS-backed circuits for critical equipment. 4. Install 20A circuits for high-power equipment (servers, printers). 5. Separate lighting from power circuits. 6. Install monitoring equipment to track ongoing loads. 7. Provide expansion capacity for future growth.',
          ...
          },
          {
            ...
            rectification:
              '1. Contact DNO to assess supply capacity upgrade options. 2. Install smart load management system to prioritise EV charging. 3. Programme system to reduce EV charge rate when other loads active. 4. Consider time-of-use charging during off-peak periods. 5. Install energy monitoring to track consumption. 6. Upgrade to three-phase supply if required. 7. Test load management operation.',
      ...
      },
      {
        ...
        examples: [
          ...
          },
          {
            ...
            rectification:
              '1. Isolate and lock off pool electrical supply. 2. Remove pump motor and test windings. 3. Replace motor with IP55 rated equivalent. 4. Install motor in weatherproof enclosure. 5. Upgrade cable to H07RN-F type for wet areas. 6. Test RCD at 30mA and verify 300ms trip time. 7. Check earth bonding to pool metalwork. 8. Commission system with full operational test.',
          ...
          },
          {
            ...
            rectification:
              '1. Test each caravan supply post for earth leakage. 2. Install 30mA RCD at each pitch position. 3. Uprate main RCD to 100mA delayed type. 4. Test system selectivity under fault conditions. 5. Install earth leakage monitoring equipment. 6. Provide customer guidance on appliance maintenance. 7. Schedule monthly RCD testing programme.',
        ...
        examples: [
          {
            ...
            rectification:
              '1. Isolate circuit and test dead. 2. Remove socket faceplate and inspect terminals. 3. Check neutral terminal for damage or burning. 4. Cut back cable and re-terminate if damage extends to cable. 5. Replace socket if terminal damaged beyond repair. 6. Tighten all connections to manufacturer torque. 7. Test continuity of neutral path. 8. Energise and test operation.',
          ...
          },
          {
            ...
            rectification:
              '1. Use cable tracer to locate exact break position. 2. Assess damage extent and repair feasibility. 3. Install bypass cable if repair not viable. 4. Use junction boxes for permanent repairs. 5. Reroute cable if damage risk remains. 6. Update cable route drawings. 7. Test all affected circuits. 8. Provide cable route marking for future work.',
      ...
      },
      {
        ...
        examples: [
          ...
          },
          {
            ...
            rectification:
              '1. Measure power factor at various load conditions. 2. Calculate required reactive power compensation. 3. Install automatic PFC unit with contactors and capacitors. 4. Set target power factor to 0.95 lagging. 5. Include detuning reactors to prevent harmonic resonance. 6. Program automatic control system for load following. 7. Monitor power factor continuously. 8. Schedule regular capacitor testing and maintenance.',
          ...
          },
          {
            ...
            rectification:
              '1. Measure N-E voltage at multiple points in installation. 2. Check main neutral connection integrity at source. 3. Balance single-phase loads across three phases. 4. Install additional neutral conductors where required. 5. Upgrade main earthing conductor if undersized. 6. Install isolation transformers for sensitive equipment. 7. Test neutral-to-earth impedance. 8. Implement ongoing voltage monitoring system.',
      ...
      <div className="space-y-6">
        <div className="bg-blue-500/10 border border-blue-500/20 p-4 rounded-lg">
          ...
          <p className="text-sm text-blue-300">
            Detailed case studies from actual fault-finding scenarios, including symptoms, diagnosis
            methods, solutions, and prevention strategies drawn from real installations.
          </p>
        </div>
        ...
        {realWorldFaults.map((category, index) => (
          <Collapsible key={category.id}>
            <Card
              className={`transition-all duration-200 ${getStepColor(category.category)} hover:shadow-md`}
            >
              <CollapsibleTrigger className="w-full">
                <CardHeader className="cursor-pointer hover:bg-black/10 active:bg-black/15 transition-all touch-manipulation">
                  <div className="flex items-center justify-between">
                  ...
                  <p className="text-left text-sm text-muted-foreground">{category.description}</p>
                </CardHeader>
              </CollapsibleTrigger>
              ...
              <CollapsibleContent>
                <CardContent className="space-y-6">
                  {category.examples.map((example, exampleIndex) => (
                    <div
                      key={exampleIndex}
                      className="bg-background/50 border border-muted/20 rounded-lg p-4 space-y-4"
                    >
                      <div className="flex items-center justify-between">
                      ...
                      <div className="grid gap-4 md:grid-cols-2">
                        <div className="space-y-3">
                          <div>
                            <h5 className="font-medium text-sm text-orange-400 mb-1">
                              Symptoms Reported
                            </h5>
                            <p className="text-sm text-muted-foreground">{example.symptoms}</p>
                          </div>
                          <div>
                            <h5 className="font-medium text-sm text-blue-400 mb-1">
                              Diagnosis Method
                            </h5>
                            <p className="text-sm text-muted-foreground">{example.diagnosis}</p>
                          </div>
                          <div>
                            <h5 className="font-medium text-sm text-green-400 mb-1">
                              Solution Applied
                            </h5>
                          ...
                          {example.rectification && (
                            <div>
                              <h5 className="font-medium text-sm text-emerald-400 mb-1">
                                Rectification Steps
                              </h5>
                        ...
                        <div className="space-y-3">
                          ...
                          <div>
                            <h5 className="font-medium text-sm text-cyan-400 mb-1">
                              Prevention Strategy
                            </h5>
    ...
    const faultCategories = [
      {
        ...
        theory:
          'Short circuits occur when current flows along an unintended path with minimal resistance, causing excessive current flow that can damage equipment and create fire hazards.',
        detectionMethods: [
      ...
      },
      {
        ...
        theory:
          'Overloads occur when circuit current exceeds the design capacity but remains below short circuit levels, causing gradual heating that can damage insulation and create fire risks.',
        detectionMethods: [
      ...
      },
      {
        ...
        theory:
          'Earth faults occur when live conductors make contact with earthed parts, creating a fault current path that should be detected by protective devices to prevent dangerous touch voltages.',
        detectionMethods: [
      ...
      },
      {
        ...
        theory:
          'Open circuits represent breaks in the intended current path, preventing normal operation and potentially creating safety hazards if protective conductors are affected.',
        detectionMethods: [
      ...
      },
      {
        ...
        theory:
          'Insulation breakdown occurs when the dielectric properties of insulating materials deteriorate, allowing current to flow between conductors or to earth, creating shock and fire hazards.',
        detectionMethods: [
      ...
      },
      {
        ...
        theory:
          'Supply quality issues encompass voltage variations, frequency deviations, harmonics, and transients that can affect equipment operation and installation safety.',
        detectionMethods: [
        ...
        regulation:
          'BS 7671: 443 - Protection against overvoltages, BS EN 50160 - Voltage characteristics',
      },
    ];
      ...
      <div className="max-w-6xl mx-auto space-y-4 sm:space-y-6 md:space-y-8">
        ...
        <div className="text-center space-y-3 sm:space-y-4 mb-4 sm:mb-6 md:mb-8 px-2 sm:px-4">
          ...
          <p className="text-sm sm:text-base md:text-lg text-gray-300 max-w-3xl mx-auto">
            Learn systematic approaches to electrical fault diagnosis and resolution. Master the
            methodical process from initial symptoms to successful repair.
          </p>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-5 md:gap-6">
              <div className="text-center p-4 sm:p-5 bg-black/20 rounded-lg border border-elec-yellow/20 touch-manipulation active:scale-[0.99] transition-transform">
                ...
                <p className="text-gray-200 text-xs sm:text-sm leading-relaxed">
                  Follow logical sequence from information gathering to final testing
                </p>
              </div>
              <div className="text-center p-4 sm:p-5 bg-black/20 rounded-lg border border-red-500/20 touch-manipulation active:scale-[0.99] transition-transform">
                ...
                <p className="text-gray-200 text-xs sm:text-sm leading-relaxed">
                  Always ensure safe isolation before commencing fault location work
                </p>
              </div>
              <div className="text-center p-4 sm:p-5 bg-black/20 rounded-lg border border-green-500/20 touch-manipulation active:scale-[0.99] transition-transform">
                ...
                <h4 className="font-bold text-green-400 mb-2 text-base sm:text-lg">
                  Verify Repair
                </h4>
                <p className="text-gray-200 text-xs sm:text-sm leading-relaxed">
                  Always test thoroughly after repair to confirm fault has been resolved
                </p>
              </div>
            </div>
          </CardContent>
