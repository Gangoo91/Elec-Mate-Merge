...
const TestingSafetyModule = ({ module, onModuleClick }: TestingSafetyModuleProps) => {
  ...
  return (
    <Card
      className={`border transition-all duration-300 hover:scale-[1.02] hover:shadow-lg cursor-pointer ${module.color}`}
    >
      <CardContent className="p-6">
        ...
        <div className="mb-6">
          <p className="text-xs text-gray-400 mb-2 font-medium">Key Topics Covered:</p>
