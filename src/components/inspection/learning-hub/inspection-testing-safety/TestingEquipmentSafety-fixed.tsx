  ...
  const testInstruments = [
    {
      ...
      commonIssues: [
        'Incorrect test sequence',
        'Poor connection to test points',
        'Battery depletion during tests',
      ],
      bestPractices: [
        'Follow manufacturer sequence',
        'Clean test points before connection',
    ...
    },
    {
      ...
      commonIssues: [
        'Testing energised circuits',
        'Inadequate discharge time',
        'Poor surface preparation',
      ],
      bestPractices: [
        'Verify de-energised state',
        'Allow full discharge',
        'Clean and dry test surfaces',
      ],
    },
    {
      ...
      commonIssues: [
        'Testing without earthing check',
        'Incorrect test current selection',
        'Poor earth connection',
      ],
      bestPractices: [
        'Verify earth integrity first',
    ...
    },
    {
      ...
      safetyFeatures: [
        'GS38 compliant probes',
        'Audio and visual indication',
        'Self-test function',
        'Robust construction',
      ],
      commonIssues: [
        'Not testing before/after use',
        'Insufficient probe contact',
        'Ignoring battery warnings',
      ],
      bestPractices: [
        'Always test on known live source',
    ...
    <div className="space-y-6 sm:space-y-8">
      ...
      <div className="text-center space-y-3 sm:space-y-4 mb-6 sm:mb-8">
        ...
        <p className={responsiveBody.large + ' text-gray-300 max-w-3xl mx-auto px-4'}>
          Learn to select, inspect, and use electrical testing equipment safely in accordance with
          GS38 and BS 7671.
        </p>
      </div>
        ...
        tabs={[
          {
            ...
            content: (
              <div className="space-y-4 sm:space-y-6">
                {/* GS38 content - keeping existing implementation */}
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
                  {gs38Requirements.map((section, index) => (
                    <Card key={index} className="border-blue-500/20 bg-blue-500/5">
                      <CardHeader>
                        <CardTitle className="text-sm sm:text-base text-blue-300 flex items-center gap-2">
          ...
          },
          {
            ...
            content: (
              <Card className="border-green-500/20 bg-green-500/5">
                <CardHeader>
                  <CardTitle className="text-sm sm:text-base md:text-lg text-green-300">
