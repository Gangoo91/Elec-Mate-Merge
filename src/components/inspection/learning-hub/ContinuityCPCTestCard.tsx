                    ...
                    <CardContent className="p-4">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                          ...
                          <div className="text-sm text-gray-300">R1+R2: {test.r1r2Reading}Ω</div>
                          <div className="text-sm text-gray-300">Max: {test.maxPermissible}Ω</div>
                          <Badge
                      ...
                      {test.notes && (
                        <div className="mt-2 text-sm text-gray-400">Notes: {test.notes}</div>
                      )}
                    </CardContent>
                  </Card>
                ))}
