  ...
  return (
    <div>
      ...
      <motion.div variants={containerVariants} initial="hidden" animate="visible" className="space-y-5">
        ...
        <motion.div variants={itemVariants}>
          <div className="rounded-2xl bg-gradient-to-b from-white/[0.08] to-white/[0.04] border border-yellow-400/20 p-4 space-y-4">
            <div>
              <div className="flex items-center gap-2 mb-1">
                <span className="text-xs font-bold text-yellow-400 bg-gradient-to-b from-white/[0.08] to-white/[0.04] px-2 py-0.5 rounded-lg">Reg 643.6</span>
              </div>
              <p className="text-sm text-white leading-relaxed">
            ...
            <div className="border-t border-yellow-400/20 pt-3">
              <div className="flex items-center gap-2 mb-1">
                <span className="text-xs font-bold text-yellow-400 bg-gradient-to-b from-white/[0.08] to-white/[0.04] px-2 py-0.5 rounded-lg">Reg 133.2</span>
              </div>
              <p className="text-sm text-white leading-relaxed">
            ...
            <div className="border-t border-yellow-400/20 pt-3">
              <div className="flex items-center gap-2 mb-1">
                <span className="text-xs font-bold text-yellow-400 bg-gradient-to-b from-white/[0.08] to-white/[0.04] px-2 py-0.5 rounded-lg">Reg 463.1.2</span>
              </div>
              <p className="text-sm text-white leading-relaxed">
