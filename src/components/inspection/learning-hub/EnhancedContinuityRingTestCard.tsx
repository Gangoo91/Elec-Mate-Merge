      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-card p-4 rounded">
          ...
          <div className="border-2 border-blue-400 p-3 rounded text-center">
            ...
            <div className="text-xs text-gray-400">This tests one leg of the ring</div>
          </div>
        </div>
        <div className="bg-card p-4 rounded">
          ...
          <div className="border-2 border-purple-400 p-3 rounded text-center">
            ...
            <div className="text-yellow-400 mb-2">Test at Socket: L↔E</div>
            <div className="text-xs text-gray-400">This tests the other leg</div>
          </div>
        </div>
        <div className="bg-card p-4 rounded">
          ...
          <div className="border-2 border-green-400 p-3 rounded text-center">
            ...
            <div className="text-yellow-400 mb-2">Test at Socket: L↔E</div>
            <div className="text-xs text-gray-400">Verifies ring integrity</div>
          </div>
        </div>
      </div>
    </div>
          ...
          <div className="space-y-4">
            <div className="bg-purple-500/10 border border-purple-500/20 rounded-lg p-4">
              <div className="flex items-center gap-2 mb-3">
                ...
                <h4 className="font-medium text-purple-400">
                  Why Ring Circuit Testing is Essential
                </h4>
              </div>
              <div className="space-y-3 text-sm text-gray-300">
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p>
                      Ensures both legs of the ring are continuous and properly connected - a broken
                      ring becomes a dangerous radial circuit.
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p>
                      Confirms current can flow through both legs equally, preventing overloading
                      and overheating of cables.
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p>
                      Ring circuits carry higher loads (32A vs 20A radial) - broken rings create
            ...
            <div className="bg-red-500/10 border border-red-500/20 rounded-lg p-4">
              ...
              <div className="space-y-2 text-sm text-gray-300">
                <p>
                  <strong>Broken Ring (Undetected):</strong> Kitchen ring with one leg disconnected
                  - all load through single 2.5mm² cable, causing overheating and potential fire
                </p>
                <p>
                  <strong>Cross-Connected Ring:</strong> Legs wrongly connected - creates
                  figure-of-eight circuit with unequal load sharing and overloading
                </p>
                <p>
                  <strong>Multiple Breaks:</strong> Ring circuit with several poor connections -
                  creates multiple radial spurs exceeding safe loading limits
                </p>
              </div>
            </div>
            ...
            <div className="bg-yellow-500/10 border border-yellow-500/20 rounded-lg p-4">
              ...
              <div className="space-y-2 text-sm text-gray-300">
                <p>
                  • <strong>Legal Responsibility:</strong> Failure to properly test ring circuits is
                  professional negligence
                </p>
                <p>
                  • <strong>Insurance Claims:</strong> Improper testing can void insurance cover for
                  fire damage
                </p>
                <p>
                  • <strong>Building Regulations:</strong> Part P compliance requires proper testing
                  of all ring circuits
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-green-500/10 border border-green-500/20 rounded-lg p-4">
            ...
            <div className="space-y-4 text-sm text-gray-300">
              ...
              <div className="border-l-4 border-purple-400 pl-4">
                ...
                <div className="space-y-1">
                  <p>
                    • <strong>Leg 1:</strong> Link L1 to E1 at DB, test L-E at furthest socket
                  </p>
                  <p>
                    • <strong>Leg 2:</strong> Link L2 to E2 at DB, test L-E at same socket
                  </p>
            ...
            <div className="bg-orange-500/10 border border-orange-500/20 rounded-lg p-4">
              ...
              <div className="space-y-3 text-sm text-gray-300">
                <div className="flex gap-3">
                  <div className="bg-red-500 text-foreground rounded-full w-6 h-6 flex items-center justify-center text-xs font-bold flex-shrink-0">
                    !
                  </div>
                  <div>
                    <p className="font-medium text-foreground">Broken Ring (One Leg Open)</p>
                    <p>
                      Symptoms: One leg shows infinite resistance, other leg shows double expected
                      value
                    </p>
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p>
                      Action: Check connections at distribution board for correct leg identification
                    </p>
                  </div>
                </div>
                <div className="flex gap-3">
                  <div className="bg-yellow-500 text-foreground rounded-full w-6 h-6 flex items-center justify-center text-xs font-bold flex-shrink-0">
                    !
                  </div>
                  <div>
                    ...
                    <p>
                      Action: Inspect all connections and junction boxes for loose or corroded
                      terminals
                    </p>
                  </div>
                </div>
        ...
        <div className="space-y-6">
          <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-4">
            ...
            <p className="text-sm text-gray-300 mb-4">
              Enter your test readings below. The system will automatically calculate the final
              R1+R2 value and determine the pass/fail status.
            </p>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <Label htmlFor="circuitRef" className="text-foreground">
                  Circuit Reference
                </Label>
                <Input
                  id="circuitRef"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
              <div>
                <Label htmlFor="leg1Reading" className="text-foreground">
                  Leg 1 Reading (Ω)
                </Label>
                <Input
                  id="leg1Reading"
              ...
              <div>
                <Label htmlFor="leg2Reading" className="text-foreground">
                  Leg 2 Reading (Ω)
                </Label>
                <Input
                  id="leg2Reading"
              ...
              <div>
                <Label htmlFor="crossConnectReading" className="text-foreground">
                  Cross-Connect Reading (Ω)
                </Label>
                <Input
                  ...
                  onChange={(e) =>
                    setCurrentTest({ ...currentTest, crossConnectReading: e.target.value })
                  }
                  placeholder="0.000"
                  className="bg-card border-border text-foreground"
                />
            ...
            <Button
              ...
              disabled={
                !currentTest.circuitRef || !currentTest.leg1Reading || !currentTest.leg2Reading
              }
              ...
              <div className="space-y-3">
                {testResults.map((result, index) => (
                  <div key={index} className="bg-muted p-3 rounded border border-border">
                    ...
                    {result.notes && (
                      <div className="mt-2 text-sm text-gray-400">Notes: {result.notes}</div>
                    )}
                  </div>
                ))}
              </div>
          ...
          <div className="bg-yellow-500/10 border border-yellow-500/20 rounded-lg p-4">
            ...
            <div className="space-y-1 text-sm text-gray-300">
              ...
              <p>
                • Both legs should be within 20% of each other to ensure proper load distribution
              </p>
  ...
  return (
    <div className="space-y-6">
      <Card className="bg-gradient-to-br from-purple-500/10 to-blue-500/10 border-2 border-purple-500/20">
        ...
        <CardContent>
          <SmartTabs tabs={smartTabs} defaultValue="why" className="w-full" />
        </CardContent>
      </Card>
    </div>
  );
