    ...
    <div className="space-y-4 sm:space-y-6 md:space-y-8 px-3 sm:px-4">
      ...
      <div className="text-center space-y-3 sm:space-y-4 mb-6 sm:mb-8 md:mb-12 px-2 sm:px-4">
        <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-foreground">
          BS7671 Practical Reference
        </h1>
        <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
          The regulations that matter most to your daily work as an electrician. Quick access to
          testing standards, safety requirements, and compliance guidance.
        </p>
      </div>

      {/* Main Content Tabs */}
      <SmartTabs tabs={smartTabs} defaultValue="quick-ref" className="w-full" />
