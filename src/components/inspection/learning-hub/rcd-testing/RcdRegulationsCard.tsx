...
const coreRegulations = [
  ...
  { number: 'Reg 643.10', title: 'RCD Testing — Initial Verification', description: 'During initial verification, each RCD shall be tested to verify correct operation. Tests include verification at rated residual operating current and at the test current for additional protection.' },
