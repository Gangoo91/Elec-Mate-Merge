...
const ContinuityTestingStepsCard = ({ step, onToggle }: ContinuityTestingStepsCardProps) => {
  ...
  return (
    <Card
      className={`border-2 ${step.completed ? 'border-green-500/30 bg-green-500/5' : step.critical ? 'border-orange-500/30 bg-orange-500/5' : 'border-border bg-card'}`}
    >
      <CardHeader className="cursor-pointer" onClick={() => setIsExpanded(!isExpanded)}>
        <div className="flex items-start gap-3">
          ...
          <div className="flex-grow">
            ...
            <CardDescription className="text-gray-300 mb-2">{step.description}</CardDescription>
