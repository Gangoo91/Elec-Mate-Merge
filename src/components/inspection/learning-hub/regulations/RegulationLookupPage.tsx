...
const commonRegulations = [
  ...
  { number: '643.3', title: 'Insulation Resistance', summary: 'IR test between live conductors and earth. Min 1.0MΩ at 500V DC for LV circuits.' },
  { number: '643.6', title: 'Polarity Verification', summary: 'Polarity must be verified for every circuit. Single-pole devices in line conductor only.' },
  { number: '643.7.3.201', title: 'PFC Measurement', summary: 'Prospective fault current must be measured at origin. Record higher of L-E and L-N.' },
  { number: '643.10', title: 'Functional Testing', summary: 'All assemblies and components subjected to functional test for correct operation.' },
  ...
  // Testing specifics
  { number: '643.2', title: 'Continuity Testing', summary: 'Continuity of protective conductors including ring final circuits.' },
  { number: '643.4', title: 'SELV/PELV Separation', summary: 'Verification of separation between SELV/PELV and other circuits.' },
  { number: '643.7.3', title: 'Voltage Drop Check', summary: 'Verification of voltage drop by measurement or calculation.' },
  // A3 specific
