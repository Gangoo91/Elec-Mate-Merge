    ...
    <div className="bg-red-500/10 border-2 border-red-500/30 border-l-4 border-l-red-500 rounded-lg p-4 sm:p-5 md:p-6">
      <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
        ...
        <h4 className="text-base sm:text-lg font-semibold text-red-400">
          CRITICAL: Equipment Protection Warning
        </h4>
      </div>
      <div className="space-y-2 sm:space-y-3 text-xs sm:text-sm text-gray-300 leading-relaxed">
        <p className="font-medium text-foreground">
          The following MUST be disconnected before insulation testing or they WILL be destroyed by
          the 500V DC test voltage:
        </p>
        <ul className="list-disc list-inside space-y-1 ml-2">
          <li>
            <strong>Surge Protection Devices (SPDs)</strong> - disconnect or remove
          </li>
          <li>
            <strong>Electronic equipment</strong> - computers, TVs, appliances
          </li>
          <li>
            <strong>Dimmer switches</strong> - remove or isolate
          </li>
          <li>
            <strong>LED drivers and control gear</strong>
          </li>
          <li>
            <strong>Smart devices and IoT equipment</strong>
          </li>
          <li>
            <strong>Photocell switches and timers</strong>
          </li>
          <li>
            <strong>RCDs</strong> - can be bridged out during testing
          </li>
        </ul>
    ...
    <div className="bg-green-500/10 border border-green-500/20 border-l-4 border-l-green-500 rounded-lg p-4 sm:p-5 md:p-6">
      ...
      <div className="space-y-3 text-sm text-gray-300">
        <div className="flex gap-3">
          <div className="bg-purple-500 text-foreground rounded-full w-6 h-6 flex items-center justify-center text-xs font-bold flex-shrink-0">
            1
          </div>
          <div>
