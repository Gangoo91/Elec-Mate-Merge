      ...
      <div className="bg-card p-4 rounded">
        ...
        <div className="border-2 border-green-400 p-3 rounded">
          <div className="flex flex-col sm:flex-row justify-between items-center mb-2 gap-2">
            ...
            <span className="text-green-400 text-xs sm:text-sm text-center">
              Good Insulation (&gt;1MΩ)
            </span>
        ...
        <div className="text-xs text-gray-400 mt-2">High resistance prevents current flow</div>
      </div>
      <div className="bg-card p-4 rounded">
        ...
        <div className="border-2 border-red-400 p-3 rounded">
          <div className="flex flex-col sm:flex-row justify-between items-center mb-2 gap-2">
            <span className="text-red-400 text-sm font-medium">Live</span>
            <span className="text-red-400 text-xs sm:text-sm text-center">
              Poor Insulation (&lt;1MΩ)
            </span>
            <span className="text-blue-400 text-sm font-medium">Neutral</span>
          </div>
        ...
        <div className="text-xs text-red-400 mt-2">Low resistance allows leakage current</div>
      </div>
    </div>
  </div>
);
