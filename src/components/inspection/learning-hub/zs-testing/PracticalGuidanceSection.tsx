    ...
    <div className="bg-green-500/10 border border-green-500/20 border-l-4 border-l-green-500 rounded-lg p-4 sm:p-5 md:p-6">
      <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
        ...
        <h4 className="text-base sm:text-lg font-semibold text-green-400">
          Test Equipment Selection and Setup
        </h4>
      </div>
    ...
    <div className="bg-blue-500/10 border border-blue-500/20 border-l-4 border-l-blue-500 rounded-lg p-4 sm:p-5 md:p-6">
      ...
      <div className="space-y-3 text-sm text-gray-300">
        <div>
          ...
          <p className="ml-4">
            • <strong>Plug insertion:</strong> Ensure tester plug makes full contact in socket
          </p>
          <p className="ml-4">
            • <strong>Socket selection:</strong> Always test furthest socket from origin on each
            circuit
          </p>
          <p className="ml-4">
            • <strong>Ring circuits:</strong> Test multiple sockets to identify highest Zs reading
          </p>
          <p className="ml-4">
            • <strong>Spur identification:</strong> Test sockets on spurs separately - often highest
            readings
          </p>
          <p className="ml-4">
            • <strong>Double sockets:</strong> Test both outlets if accessible
          </p>
        </div>
        <div>
          <p className="font-medium text-foreground">Terminal testing for fixed circuits:</p>
          <p className="ml-4">
            • <strong>Clean connections:</strong> Ensure terminal surfaces are clean and tight
          </p>
          <p className="ml-4">
            • <strong>Probe contact:</strong> Maintain firm, stable contact during test
          </p>
          <p className="ml-4">
            • <strong>Safety isolation:</strong> Consider dead testing if live access is hazardous
          </p>
          <p className="ml-4">
            • <strong>Terminal identification:</strong> Verify phase and earth connections before
            testing
          </p>
        </div>
        <div>
          ...
          <p className="ml-4">
            • <strong>Stabilisation:</strong> Allow reading to stabilise before recording
          </p>
          <p className="ml-4">
            • <strong>Multiple tests:</strong> Take several readings if results seem inconsistent
          </p>
          <p className="ml-4">
            • <strong>Highest value:</strong> Always record the highest stable reading obtained
          </p>
          <p className="ml-4">
            • <strong>Temperature recording:</strong> Note ambient temperature at time of test
          </p>
          <p className="ml-4">
            • <strong>Conditions:</strong> Document any unusual test conditions or observations
          </p>
        </div>
      </div>
    </div>
      ...
      <div className="space-y-3 text-sm text-gray-300">
        <div>
          ...
          <div className="ml-4 space-y-2">
            <p>
              • <strong>Step 1:</strong> Verify test equipment calibration and function
            </p>
            <p>
              • <strong>Step 2:</strong> Check supply voltage is within normal range (207-253V)
            </p>
            <p>
              • <strong>Step 3:</strong> Inspect main earthing conductor at origin
            </p>
            <p>
              • <strong>Step 4:</strong> Check earth electrode condition and connections
            </p>
            <p>
              • <strong>Step 5:</strong> Verify CPC continuity throughout circuit
            </p>
            <p>
              • <strong>Step 6:</strong> Examine all earth connections at accessories
            </p>
            <p>
              • <strong>Step 7:</strong> Consider parallel earth paths that may be disconnected
            </p>
          </div>
        </div>
        <div>
          ...
          <p className="ml-4">
            • <strong>Connection issues:</strong> Poor contact between test probes and terminals
          </p>
          <p className="ml-4">
            • <strong>Supply variation:</strong> Voltage fluctuations during test period
          </p>
          <p className="ml-4">
            • <strong>Load effects:</strong> Other equipment operating during test
          </p>
          <p className="ml-4">
            • <strong>Temperature changes:</strong> Conductor temperature varying during test
          </p>
          <p className="ml-4">
            • <strong>Intermittent faults:</strong> Loose connections in the fault loop path
          </p>
        </div>
        <div>
          <p className="font-medium text-foreground">RCD tripping during test:</p>
          <p className="ml-4">
            • <strong>Tester incompatibility:</strong> Use tester with RCD hold facility
          </p>
          <p className="ml-4">
            • <strong>RCD sensitivity:</strong> Very sensitive RCDs (≤10mA) may always trip
          </p>
          <p className="ml-4">
            • <strong>Type AC vs Type A:</strong> Different RCD types respond differently
          </p>
          <p className="ml-4">
            • <strong>Alternative methods:</strong> Calculate Zs = Ze + (R1+R2) when necessary
          </p>
          <p className="ml-4">
            • <strong>Temporary measures:</strong> RCD bypass during testing (competent persons
            only)
          </p>
        </div>
      </div>
    ...
    <div className="bg-yellow-500/10 border border-yellow-500/20 rounded-lg p-4">
      ...
      <div className="space-y-3 text-sm text-gray-300">
        <div>
          ...
          <p className="ml-4">
            • <strong>Safety assessment:</strong> Determine if installation can remain energised
          </p>
          <p className="ml-4">
            • <strong>Circuit isolation:</strong> Isolate non-compliant circuits if safety risk
            exists
          </p>
          <p className="ml-4">
            • <strong>User notification:</strong> Inform responsible person of findings
          </p>
          <p className="ml-4">
            • <strong>Temporary measures:</strong> Consider RCD protection as interim solution
          </p>
          <p className="ml-4">
            • <strong>Documentation:</strong> Record all findings and actions taken
          </p>
        </div>
        <div>
        ...
        <div>
          ...
          <p className="ml-4">
            • <strong>RCD protection:</strong> 30mA RCDs for additional shock protection (not a
            substitute for ADS)
          </p>
          <p className="ml-4">
            • <strong>Protective device changes:</strong> Higher sensitivity MCBs or different
            characteristics
          </p>
          <p className="ml-4">
            • <strong>RCBO installation:</strong> Combined overcurrent and RCD protection
          </p>
          <p className="ml-4">
            • <strong>Voltage optimisation:</strong> Ensure supply voltage optimised for protection
          </p>
        </div>
      </div>
    </div>
    ...
    <div className="bg-cyan-500/10 border border-cyan-500/20 rounded-lg p-4">
      ...
      <div className="space-y-3 text-sm text-gray-300">
        <div>
          ...
          <p className="ml-4">
            • <strong>Circuit identification:</strong> Clear reference to tested circuit
          </p>
          <p className="ml-4">
            • <strong>Test location:</strong> Specific point where test was performed
          </p>
          <p className="ml-4">
            • <strong>Measured value:</strong> Raw Zs reading from test instrument
          </p>
          <p className="ml-4">
            • <strong>Ambient temperature:</strong> Temperature at time of test
          </p>
          <p className="ml-4">
            • <strong>Corrected value:</strong> Temperature-corrected Zs value
          </p>
          <p className="ml-4">
            • <strong>Maximum permitted:</strong> Relevant limit from BS 7671 Appendix 3
          </p>
          <p className="ml-4">
            • <strong>Compliance status:</strong> Pass/fail against requirements
          </p>
        </div>
        <div>
        ...
        <div className="bg-green-500/10 border border-green-500/20 rounded p-3">
          ...
          <p className="text-sm text-gray-300">
            Cross-reference Zs results with R1+R2 continuity tests and Ze measurements. The
            relationship Zs ≈ Ze + (R1+R2) should be approximately maintained, allowing for
            measurement tolerances and circuit conditions.
          </p>
        </div>
      </div>
    </div>
