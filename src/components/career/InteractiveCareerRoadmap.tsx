...
const roadmapStages: RoadmapStage[] = [
  {
    ...
    timeframe: '0-4 years',
    requirements: [
      'Enrol in apprenticeship programme',
      'Complete Level 3 NVQ',
      'Pass AM2 assessment',
    ],
  ...
  return (
    <Card className="border-elec-yellow/20 bg-elec-gray">
      <CardHeader>
        ...
        <p className="text-muted-foreground">Your journey from apprentice to master electrician</p>
      </CardHeader>
      <CardContent>
