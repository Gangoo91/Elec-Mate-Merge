      ...
      <CardContent>
        <Tabs value={activeCalc} onValueChange={setActiveCalc} className="space-y-4">
            ...
            <div className="bg-elec-dark p-4 rounded-md space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <Label htmlFor="ze" className="text-gray-300">
                ...
                <div className="space-y-2">
                  <Label htmlFor="r1r2" className="text-gray-300">
                    Circuit Resistance (R1+R2) - Ω
                  </Label>
                  <Input
                    id="r1r2"
                    type="number"
              ...
              {zsResult && (
                <div className="mt-4 p-3 bg-green-900/30 border border-green-600 rounded-md">
                  <p className="text-green-400 font-medium">Calculated Zs: {zsResult} Ω</p>
            ...
            <div className="bg-elec-dark p-4 rounded-md space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setCurrentValues((prev) => ({ ...prev, voltage: e.target.value }))
                    }
                    className="bg-gray-700 border-gray-600 text-foreground"
                  />
                </div>
                ...
                <div className="space-y-2">
                  <Label htmlFor="resistance" className="text-gray-300">
                    Total Impedance (Zs) - Ω
                  </Label>
                  <Input
                    id="resistance"
                    type="number"
                    ...
                    onChange={(e) =>
                      setCurrentValues((prev) => ({ ...prev, resistance: e.target.value }))
                    }
                    className="bg-gray-700 border-gray-600 text-foreground"
                  />
                </div>
              ...
              {currentResult && (
                <div className="mt-4 p-3 bg-blue-900/30 border border-blue-600 rounded-md">
                  <p className="text-blue-400 font-medium">Fault Current: {currentResult} A</p>
                  <p className="text-sm text-gray-400 mt-1">
                    This current must be sufficient to operate the protective device within required
                    disconnection times
                  </p>
                </div>
              )}
          ...
          <TabsContent value="voltage" className="space-y-4">
            <div className="bg-elec-dark p-4 rounded-md space-y-4">
              <h3 className="text-foreground font-medium mb-3">Voltage Drop Calculation</h3>

              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="space-y-2">
                  <Label htmlFor="current-vd" className="text-gray-300">
                    Current (A)
                  </Label>
                  <Input
                    id="current-vd"
                    ...
                    onChange={(e) =>
                      setVoltageDropValues((prev) => ({ ...prev, current: e.target.value }))
                    }
                    className="bg-gray-700 border-gray-600 text-foreground"
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setVoltageDropValues((prev) => ({ ...prev, length: e.target.value }))
                    }
                    className="bg-gray-700 border-gray-600 text-foreground"
                  />
                </div>
                ...
                <div className="space-y-2">
                  <Label htmlFor="resistance-vd" className="text-gray-300">
                    Resistance (Ω/m)
                  </Label>
                  <Input
                    id="resistance-vd"
                    ...
                    onChange={(e) =>
                      setVoltageDropValues((prev) => ({ ...prev, resistance: e.target.value }))
                    }
                    className="bg-gray-700 border-gray-600 text-foreground"
                  />
                </div>
              ...
              {voltageDropResult && (
                <div className="mt-4 p-3 bg-yellow-900/30 border border-yellow-600 rounded-md">
                  <p className="text-yellow-400 font-medium">Voltage Drop: {voltageDropResult} V</p>
                  <p className="text-sm text-gray-400 mt-1">
        ...
        <Alert className="mt-4 bg-blue-900/20 border-blue-600">
          ...
          <AlertDescription className="text-blue-300">
            These calculations are for educational purposes. Always verify results and consult
            BS7671 for specific requirements.
          </AlertDescription>
        </Alert>
      </CardContent>
    </Card>
