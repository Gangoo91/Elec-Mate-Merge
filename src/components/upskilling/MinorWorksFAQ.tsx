...
const MinorWorksFAQ = () => {
  ...
  const faqData = [
    ...
    },
    {
      ...
      answer:
        'Yes, a single MEIWC can cover multiple minor works completed at the same time, provided each individual item falls within minor works scope. However, be careful not to exceed the overall scope limitation. If the combined work significantly alters the installation or requires complex assessment, consider whether multiple MEIWCs or an EIC would be more appropriate.',
    },
    {
      id: 'customer-education',
      question: 'What information should I provide to customers with the Minor Works Certificate?',
      answer:
        'Provide the completed MEIWC, explain the work completed and any limitations, demonstrate operation of new installations, provide relevant user instructions or manufacturer information, explain any ongoing maintenance requirements, and advise on when future inspection might be needed. Ensure customers understand what work was covered and any restrictions or recommendations.',
    },
  ];
