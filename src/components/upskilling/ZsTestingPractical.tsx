        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
            <div className="bg-yellow-900/20 border border-yellow-600 p-3 sm:p-4 rounded-lg">
              <h4 className="text-yellow-400 font-semibold mb-2 text-sm sm:text-base">
                Access Issues
              </h4>
              <div className="text-xs sm:text-sm space-y-2">
                <p>
                  <strong>Problem:</strong> Inaccessible ceiling voids, buried junction boxes
                </p>
                <p>
            ...
            <div className="bg-blue-900/20 border border-blue-600 p-4 rounded-lg">
              ...
              <div className="text-sm space-y-2">
                <p>
                  <strong>Problem:</strong> RCD tripping, equipment damage concerns
                </p>
                <p>
                  <strong>Solution:</strong>
                </p>
            ...
            <div className="bg-red-900/20 border border-red-600 p-4 rounded-lg">
              ...
              <div className="text-sm space-y-2">
                <p>
                  <strong>Problem:</strong> Gas/water pipes, cable armour affecting readings
                </p>
                <p>
                  <strong>Solution:</strong>
                </p>
            ...
            <div className="bg-green-900/20 border border-green-600 p-4 rounded-lg">
              ...
              <div className="text-sm space-y-2">
                <p>
                  <strong>Problem:</strong> Zs exceeding maximum permitted values
                </p>
                <p>
                  <strong>Solution:</strong>
                </p>
