  ...
  const takeaways = [
    {
      ...
      description:
        "Always write actual numerical results with units, never subjective terms like 'OK' or 'Pass'",
    },
    {
      title: 'Compare against BS7671 and manufacturer specs',
      description:
        'Check all results against applicable standards and device ratings before certification',
    },
    {
      title: 'Document limitations and any test method variations',
      description:
        'Note any constraints or non-standard testing methods used during the inspection',
    },
    {
      title: 'Do not issue certification if test results fall outside acceptable limits',
      description:
        'Never certify an installation that fails to meet safety requirements—investigate and correct first',
    },
  ];
      ...
      <CardContent>
        ...
        <div className="mt-6 bg-elec-yellow/10 p-4 rounded-md border border-elec-yellow/30">
          ...
          <p className="text-foreground text-sm sm:text-base leading-relaxed">
            Accurate documentation is not just a regulatory requirement—it's your professional duty
            to ensure safety and protect yourself legally. Your signature on a certificate carries
