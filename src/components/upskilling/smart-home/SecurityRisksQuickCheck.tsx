          ...
          <div className="space-y-4">
            ...
            >
              ...
              <p className="text-gray-300 text-sm">
                <strong>Code sharing</strong> is the biggest security risk. When codes are shared
                carelessly, given to too many people, or not changed regularly, they can compromise
                the entire security system. Always use temporary codes and revoke access when no
                longer needed.
              </p>
            </div>

            <Button onClick={resetQuiz} variant="ghost" className="text-red-400 hover:text-red-300">
              Try Again
            </Button>
          </div>
        )}
