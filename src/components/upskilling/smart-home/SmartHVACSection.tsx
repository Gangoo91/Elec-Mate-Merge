              ...
              <div className="space-y-3">
                <div className="bg-elec-gray p-3 rounded">
                  ...
                  <p className="text-xs text-gray-400">
                    Smart thermostats track when you're home/away over 2-4 weeks. If you leave at 8
                    AM and return at 6 PM, it automatically reduces heating/cooling during the day.
                  </p>
                </div>
                <div className="bg-elec-gray p-3 rounded">
                ...
                <div className="bg-elec-gray p-3 rounded">
                  ...
                  <p className="text-xs text-gray-400">
                    Accesses weather forecasts to pre-cool before hot days or pre-heat before cold
                    snaps, maintaining comfort while avoiding peak energy demand periods.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-3">
                <div className="bg-elec-gray p-3 rounded">
                  ...
                  <p className="text-xs text-gray-400">
                    Dividing your home into areas with independent temperature control. Example:
                    bedrooms at 18°C for sleep, living room at 21°C for comfort.
                  </p>
                </div>
                <div className="bg-elec-gray p-3 rounded">
                ...
                <div className="bg-elec-gray p-3 rounded">
                  ...
                  <p className="text-xs text-gray-400">
                    Motion sensors detect which rooms are occupied. HVAC only heats/cools active
                    areas. Empty zones automatically enter energy-saving mode.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-elec-gray p-4 rounded-lg">
              <p className="text-foreground font-semibold text-sm mb-2">
                Q: How do smart thermostats learn your preferences?
              </p>
              ...
              {showAnswers && (
                <div className="text-xs text-green-400 bg-green-600/20 p-2 rounded">
                  ✓ Track occupancy patterns, temperature adjustments, and schedule preferences over
                  2-4 weeks
                </div>
              )}
            </div>
            ...
            <div className="bg-elec-gray p-4 rounded-lg">
              <p className="text-foreground font-semibold text-sm mb-2">
                Q: What is HVAC zoning and why does it save energy?
              </p>
              <p className="text-xs text-gray-400 mb-3">
                Think about heating only what you need...
              </p>
              {showAnswers && (
                <div className="text-xs text-green-400 bg-green-600/20 p-2 rounded">
                  ✓ Independent temperature control for different areas, only heating/cooling
                  occupied zones
                </div>
              )}
            </div>
            ...
            <div className="bg-elec-gray p-4 rounded-lg">
              <p className="text-foreground font-semibold text-sm mb-2">
                Q: How much energy can smart HVAC systems typically save?
              </p>
            ...
            <div className="bg-elec-gray p-4 rounded-lg">
              <p className="text-foreground font-semibold text-sm mb-2">
                Q: How do smart dampers work?
              </p>
              <p className="text-xs text-gray-400 mb-3">What happens when rooms are empty?</p>
              {showAnswers && (
                <div className="text-xs text-green-400 bg-green-600/20 p-2 rounded">
                  ✓ Motorised vents automatically close to redirect airflow away from unoccupied
                  areas
                </div>
              )}
            </div>
