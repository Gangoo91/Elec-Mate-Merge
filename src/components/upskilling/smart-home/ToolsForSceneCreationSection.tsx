          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              <tr className="border-b border-gray-700">
                <td className="p-3">
                  <strong className="text-blue-200">Philips Hue</strong>
                </td>
              ...
              <tr className="border-b border-gray-700">
                <td className="p-3">
                  <strong className="text-green-200">Home Assistant</strong>
                </td>
              ...
              <tr>
                <td className="p-3">
                  <strong className="text-purple-200">Lutron Caseta</strong>
                </td>
