  ...
  const questions = [
    ...
    },
    {
      ...
      options: [
        ...
        {
          id: 'b',
          text: 'Through centralised control that coordinates both systems based on occupancy',
          correct: true,
        },
    ...
    },
    {
      ...
      options: [
        ...
        {
          id: 'b',
          text: 'Occupancy-based control, scheduling, and HVAC-lighting coordination',
          correct: true,
        },
          ...
          <div className="space-y-2">
            ...
            {score < 6 && (
              <p className="text-red-400">
                Consider reviewing the section content before proceeding.
              </p>
            )}
          </div>
