        ...
        {showResult && (
          ...
          >
            ...
            <p className="text-foreground">
              Sudden bright illumination startles intruders and eliminates concealment, creating an
              effective psychological deterrent while improving camera visibility for identification
              purposes.
            </p>
          </div>
        )}
