          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="text-xl font-semibold text-foreground mb-2">
                London Flat: "Leaving Home" Routine
              </h3>
              <p className="text-foreground">
                In a London flat, an electrician set up a comprehensive departure routine for a busy
                couple. This case study shows how a single routine can integrate multiple systems
          ...
          <Card className="bg-elec-dark/50 border-elec-yellow/20">
            <CardContent className="p-5">
              ...
              <div className="grid md:grid-cols-2 gap-4 text-sm text-foreground">
                <div>
                  <strong>Situation:</strong> Young professional couple
                  <br />
                  <strong>Property:</strong> 2-bedroom London flat
                  <br />
                  <strong>Challenge:</strong> Often forget to secure home when rushing to work
                </div>
                <div>
                  <strong>Goals:</strong> Improve security and reduce energy waste
                  <br />
                  <strong>Budget:</strong> Moderate - wanted smart solution without full renovation
                  <br />
            ...
            <CardContent className="p-5">
              ...
              <div className="mb-4">
                <p className="text-foreground mb-3">
                  ...
                  <span className="bg-blue-500/20 text-blue-300 px-2 py-1 rounded font-mono">
              ...
              <div className="grid gap-3">
                <div className="flex items-center gap-3 p-3 bg-red-500/10 border border-red-500/30 rounded">
                  <span className="text-red-300 text-sm font-mono bg-red-500/20 px-2 py-1 rounded">
                    1
                  </span>
            ...
            <CardContent className="p-5">
              ...
              <div className="grid md:grid-cols-3 gap-4 text-sm">
                <div className="bg-green-500/10 border border-green-500/30 rounded p-3">
                  ...
                  <p className="text-foreground">
                    Reduced monthly bills by 15% through coordinated device control
                  </p>
                </div>
                <div className="bg-blue-500/10 border border-blue-500/30 rounded p-3">
                  <h5 className="text-blue-300 font-semibold mb-1">Security</h5>
                  <p className="text-foreground">
                    Never forgot to lock doors or activate security again
                  </p>
                </div>
                <div className="bg-purple-500/10 border border-purple-500/30 rounded p-3">
                  <h5 className="text-purple-300 font-semibold mb-1">Convenience</h5>
                  <p className="text-foreground">
                    Departure time reduced from 5+ minutes to 30 seconds
                  </p>
                </div>
              </div>
              ...
              <div className="mt-4 p-3 bg-amber-500/10 border border-amber-500/30 rounded">
                <p className="text-foreground text-sm">
                  <strong>Client Feedback:</strong> "This routine completely changed our morning
                  stress levels. We know everything is secure and efficient with just two words.
