        ...
        <div className="space-y-6">
          ...
          <div>
            <h3 className="text-xl font-semibold text-foreground mb-2">
              Manchester Home: Legacy Alarm System Integration
            </h3>
            <p className="text-foreground">
              A homeowner had a comprehensive wired alarm system installed in the early 2000s that
              was still functioning well. Rather than replacing the entire system, the electrician
              found a cost-effective bridging solution that extended its capabilities into the smart
              home era.
            </p>
          </div>
            ...
            <div className="space-y-4">
              <div className="bg-green-500/10 border border-green-500/30 rounded p-3">
                <h5 className="text-green-300 font-semibold mb-2">
                  Smart Relay Interface Installation
                </h5>
                <p className="text-foreground text-sm mb-2">
                  Electrician installed a Konnected Alarm Panel Interface connected to the existing
                  alarm system's control outputs.
                </p>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3 p-3 bg-blue-500/10 border border-blue-500/30 rounded">
                ...
                <span className="text-foreground text-sm">
                  When alarm is armed → Turn on "Away" lighting routine
                </span>
              </div>
              <div className="flex items-center gap-3 p-3 bg-green-500/10 border border-green-500/30 rounded">
                ...
                <span className="text-foreground text-sm">
                  Motion detected → Send smartphone notification with timestamp
                </span>
              </div>
              <div className="flex items-center gap-3 p-3 bg-purple-500/10 border border-purple-500/30 rounded">
                <span className="text-purple-300 text-sm font-mono bg-purple-500/20 px-2 py-1 rounded">
                  3
                </span>
                <span className="text-foreground text-sm">
                  Voice command "Alexa, goodnight" → Arms alarm and dims lights
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-elec-dark/50 border border-amber-500/30 rounded-lg p-5">
            ...
            <div className="grid md:grid-cols-3 gap-4 text-sm">
              <div className="bg-green-500/10 border border-green-500/30 rounded p-3">
                ...
                <p className="text-foreground text-xs">
                  £400 bridge vs. £2,500 new wireless system - saved 84% while gaining smart
                  features
                </p>
              </div>
              <div className="bg-blue-500/10 border border-blue-500/30 rounded p-3">
            ...
            <div className="mt-4 p-3 bg-amber-500/10 border border-amber-500/30 rounded">
              <p className="text-foreground text-sm">
                <strong>Client Feedback:</strong> "We got all the smart features we wanted while
                keeping our reliable alarm system. The notifications and voice control make it feel
                completely modern, but we didn't lose any security or spend a fortune."
              </p>
            </div>
          </div>
        </div>
