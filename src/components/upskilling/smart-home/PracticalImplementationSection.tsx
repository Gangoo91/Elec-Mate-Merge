    ...
    <Card className="bg-elec-gray border-gray-700">
      ...
      <CardContent className="space-y-6 text-foreground">
        <p className="text-foreground">
          Real-world implementation requires careful planning and execution. Here's how to
          successfully deploy both architectures.
        </p>
          ...
          {realWorldScenarios.map((scenario, index) => (
            ...
            >
              ...
              <div className="grid sm:grid-cols-2 gap-2 text-sm">
                <p className="text-foreground">
                  <span className="font-medium text-blue-400">Hub Option:</span>{' '}
                  {scenario.hubSolution}
                </p>
                <p className="text-foreground">
                  <span className="font-medium text-green-400">Hubless Option:</span>{' '}
                  {scenario.hublessSolution}
                </p>
              </div>
        ...
        <div className="bg-purple-600/10 border border-purple-600/20 rounded-lg p-4">
          <h4 className="text-purple-400 font-semibold mb-3">
            Migration Strategy: Hubless to Hub-Based
          </h4>
          <ol className="space-y-2">
        ...
        <div className="bg-elec-dark border border-gray-600 rounded-lg p-4">
          ...
          <p className="text-sm text-foreground">
            A family of 4 wants smart lighting in 12 rooms, 6 door sensors, automated heating, and
            security cameras. They have a £2000 budget and want the system to work during internet
            outages. Design your solution.
          </p>
        </div>
      </CardContent>
    </Card>
