        ...
        <CardContent className="p-6">
          ...
          <div className="space-y-4 mb-6">
            <div className="flex items-start gap-3">
              ...
              <p className="text-foreground">
                A routine is a <strong>pre-set sequence of actions</strong> triggered by a command,
                schedule, or event.
              </p>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-foreground mb-2">
                  <strong>Example:</strong> Saying "Good morning" could:
                </p>
            ...
            <div className="flex items-start gap-3">
              ...
              <p className="text-foreground">
                Routines save time, improve efficiency, and enhance convenience.
              </p>
            </div>
          </div>
          ...
          <div className="bg-elec-dark/50 p-4 rounded-lg border border-elec-yellow/20">
            ...
            <div className="grid md:grid-cols-3 gap-3 text-sm text-foreground">
              <div>
                • <strong>Time Saving:</strong> Multiple actions with one command
              </div>
              <div>
                • <strong>Convenience:</strong> Automated daily routines
              </div>
              <div>
                • <strong>Energy Efficiency:</strong> Coordinated device control
              </div>
            </div>
          </div>
        </CardContent>
