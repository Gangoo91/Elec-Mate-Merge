...
const quizQuestions: QuizQuestion[] = [
  {
    ...
    correctAnswer: 1,
    explanation:
      'A lighting scene is a pre-programmed setting that controls multiple lights simultaneously, allowing instant activation of specific lighting configurations for different activities or situations.',
  },
  {
    id: 2,
    ...
    correctAnswer: 1,
    explanation:
      "'Movie night' is a common scene that automatically adjusts multiple lights to create the ideal environment for watching films - dimming main lights while maintaining subtle accent lighting.",
  },
  {
    id: 3,
    ...
    correctAnswer: 2,
    explanation:
      'PIR sensors can automatically trigger security lighting when motion is detected, providing immediate illumination for deterrence and improved visibility for security cameras.',
  },
  {
    id: 4,
    ...
    correctAnswer: 1,
    explanation:
      'Interior lights may activate when outdoor motion is detected to simulate occupancy, making the property appear occupied and discouraging potential intruders from attempting entry.',
  },
  {
    id: 5,
    ...
    correctAnswer: 1,
    explanation:
      'Occupancy simulation uses random lighting patterns that replicate normal daily routines - lights in living areas during evening, bedroom lights at appropriate times, and bathroom lights for brief periods.',
  },
  {
    id: 6,
    ...
    correctAnswer: 1,
    explanation:
      'Smart lighting can flash red to indicate danger and automatically illuminate evacuation pathways to guide occupants safely to exits, even in smoke-filled conditions.',
  },
  {
    id: 7,
    ...
    correctAnswer: 2,
    explanation:
      'Red is universally recognised as a danger colour, making it the most appropriate choice for smart bulbs to indicate emergency situations and alert occupants to immediate threats.',
  },
  {
    id: 8,
    ...
    correctAnswer: 1,
    explanation:
      'Careful zone planning ensures reliable device communication, adequate coverage for all scenarios, proper emergency evacuation routes, and compliance with safety regulations.',
  },
  {
    id: 9,
    ...
    correctAnswer: 2,
    explanation:
      'Emergency lighting requires monthly functional testing and annual full-duration testing, with all tests properly documented to meet safety regulations and ensure reliable operation.',
  },
  {
    id: 10,
    ...
    correctAnswer: 1,
    explanation:
      'Proper training ensures homeowners can effectively use their system, understand emergency procedures, perform basic maintenance, and know how to override automatic functions when necessary.',
  },
];
