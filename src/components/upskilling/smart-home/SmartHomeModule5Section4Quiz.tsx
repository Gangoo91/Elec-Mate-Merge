...
const quizQuestions: QuizQuestion[] = [
  {
    ...
    options: [
      ...
      'Using voice commands while standing in the room',
      'Programming devices to work automatically',
    ],
    correctAnswer: 0,
    explanation:
      'Remote access specifically refers to controlling home devices via the internet from any location, not just local control or automation.',
  },
  {
    id: 2,
    ...
    correctAnswer: 1,
    explanation:
      'Smart thermostats and security cameras are common examples of devices with remote control capabilities through mobile apps.',
  },
  {
    id: 3,
    ...
    options: [
      ...
      'Just visual displays on the device itself',
      'Push notifications, emails, and SMS alerts',
      'Audio announcements played in the home only',
    ],
    correctAnswer: 2,
    explanation:
      'Smart devices can send various types of alerts including push notifications to mobile devices, emails, and SMS messages for different events.',
  },
  {
    id: 4,
    ...
    correctAnswer: 1,
    explanation:
      "A smart home push notification would be event-based, such as 'Front door opened while away from home' - providing immediate awareness of home activities.",
  },
  {
    id: 5,
    ...
    options: [
      ...
      'By storing the user’s photos and documents',
      'By providing the internet connection to the home',
      'By manufacturing the smart home hardware',
    ],
    correctAnswer: 0,
    explanation:
      'Cloud platforms act as secure intermediaries, enabling communication between mobile apps and home devices over the internet.',
  },
  {
    id: 6,
    question: 'What is one advantage of being able to check security cameras remotely?',
    options: [
      'It reduces the home’s electricity consumption',
      'It eliminates the need for door locks',
      'It increases the camera’s resolution quality',
      'It enables immediate verification of alerts and incidents',
    ],
    correctAnswer: 3,
    explanation:
      'Remote camera access allows immediate verification of security alerts, helping distinguish between genuine threats and false alarms.',
  },
  {
    id: 7,
    ...
    correctAnswer: 2,
    explanation:
      'Weak passwords create cybersecurity vulnerabilities that could allow unauthorised access to the smart home system.',
  },
  {
    id: 8,
    ...
    options: [
      ...
      'Automatic device updates happen more often',
      'Power consumption decreases significantly',
    ],
    correctAnswer: 0,
    explanation:
      'Poor internet connectivity can result in loss of remote control capabilities and delayed or missed notifications, reducing system effectiveness.',
  },
  {
    id: 9,
    ...
    correctAnswer: 2,
    explanation:
      'Regular firmware updates are essential for maintaining security patches, fixing bugs, and improving device performance.',
  },
  {
    id: 10,
    ...
    options: [
      ...
      'Because apps are too complicated for homeowners to ever learn',
      "Because it is a legal requirement in all installations",
      'To ensure proper system usage and customer satisfaction',
    ],
    correctAnswer: 3,
    explanation:
      'Proper customer training ensures they can effectively use the system, reducing support calls and increasing satisfaction with the installation.',
  },
];
      ...
      <Card className="bg-elec-gray border-transparent">
        ...
        <CardContent className="text-center space-y-4">
          ...
          <p className="text-foreground">
            ...
            {score >= 6 &&
              score < 8 &&
              'Good job! You understand the key concepts of smart home remote access.'}
            {score < 6 &&
              'Keep studying! Review the remote access and security concepts covered in this section.'}
          </p>
