        ...
        {showResult && (
          <div className="p-4 bg-[#1a1a1a] border border-gray-600 rounded-lg">
            <p className="text-gray-300 text-sm">
              <strong className="text-foreground">Explanation:</strong> In large properties with
              many radiators, the cost of smart TRVs can add up quickly since each radiator requires
              its own smart valve for individual zone control, potentially costing £50-100+ per
              radiator.
            </p>
            <Button
