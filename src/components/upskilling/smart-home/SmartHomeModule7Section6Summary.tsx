  ...
  return (
    <Card className="bg-elec-gray border-transparent">
      ...
      <CardContent className="text-foreground space-y-4">
        <p>
          This section demonstrated that documentation, warranty management, and aftercare are
          essential components of professional smart home installations that protect both installers
          and clients.
        </p>
        ...
        <p>
          The real-world example highlighted how proper documentation protected the installer from
          liability, enabled successful warranty claims, and ultimately strengthened client
          relationships.
        </p>

        <p>
          Professional electricians understand that the installation job is not complete until
          comprehensive documentation is provided and aftercare arrangements are established. This
          final step protects everyone involved and creates opportunities for ongoing professional
          success.
        </p>
      </CardContent>
    </Card>
