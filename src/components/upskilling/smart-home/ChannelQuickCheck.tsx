          ...
          <div className="space-y-3">
            ...
            >
              ...
              <p className="text-sm text-foreground mt-1">
                Channels 1, 6, and 11 are the only non-overlapping 2.4GHz channels. This prevents
                interference between neighbouring networks and ensures optimal performance.
              </p>
            </div>
            <Button
              onClick={handleReset}
