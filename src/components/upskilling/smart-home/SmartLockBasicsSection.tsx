    ...
    <Card className="bg-elec-gray border-gray-700">
      ...
      <CardContent className="text-gray-300 space-y-6">
        <div className="space-y-4">
          <p>
            <strong className="text-foreground">Smart locks</strong> are electronic locks controlled
            via app, keypad, biometrics, or key fob. They replace or retrofit traditional mechanical
            locks, offering enhanced security, convenience, and integration with smart home systems.
          </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="p-4 bg-[#1a1a1a] border border-gray-600 rounded-lg">
              ...
              <div className="space-y-2">
                <Badge variant="outline" className="border-blue-600 text-blue-300 mr-2">
                  Yale Linus
                </Badge>
                <Badge variant="outline" className="border-green-600 text-green-300 mr-2">
                  August Smart Lock
                </Badge>
                <Badge variant="outline" className="border-purple-600 text-purple-300 mr-2">
                  Nuki
                </Badge>
