...
export const ChoosingArchitectureSection = () => {
    ...
    },
    {
      ...
      factors: [
        ...
        { name: 'Building Type', local: 'Any', cloud: 'Permanent', hybrid: 'Any' },
        {
          ...
          local: 'Can be complex',
          cloud: 'Simple',
          hybrid: 'Medium',
        },
        {
          name: 'Future Expansion',
          local: 'Limited by hub',
          cloud: 'Unlimited',
          hybrid: 'Flexible',
        },
      ],
  ...
  const getColorClasses = (color: string) => {
    switch (color) {
      case 'blue':
        return 'from-blue-900/30 to-blue-800/30 border-blue-600 text-blue-100';
      case 'green':
        return 'from-green-900/30 to-green-800/30 border-green-600 text-green-100';
      case 'purple':
        return 'from-purple-900/30 to-purple-800/30 border-purple-600 text-purple-100';
      default:
        return 'from-gray-900/30 to-gray-800/30 border-gray-600 text-gray-100';
    }
  };
      ...
      <Card className="bg-elec-gray border-gray-700">
        ...
        <CardContent className="text-gray-300 space-y-6">
          <p className="text-lg font-medium text-foreground mb-6">
            Selecting the optimal architecture requires careful consideration of multiple factors
                ...
                <div className="hidden sm:block">
                  ...
                  <div className="space-y-3">
                    {category.factors.map((factor, idx) => (
                      <div
                        key={idx}
                        className="grid grid-cols-4 gap-4 p-3 bg-[#0f0f0f] border border-gray-700 rounded"
                      >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {recommendations.map((rec, index) => (
                <div key={index} className="p-4 bg-elec-gray border border-gray-600 rounded-lg">
                  <h5 className="font-semibold mb-3 text-base sm:text-lg text-foreground">
                    {rec.title}
                  </h5>
          ...
          <div className="p-3 sm:p-4 bg-elec-gray border border-gray-600 rounded-lg">
            ...
            <div className="space-y-3 text-sm">
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 p-3 bg-[#1a1a1a] rounded">
                <div className="w-8 h-8 bg-elec-yellow text-elec-dark rounded-full flex items-center justify-center font-bold text-xs flex-shrink-0">
                  1
                </div>
                <div className="flex-1">
                  ...
                  <span className="text-gray-300 text-xs">
                    YES → Local or Hybrid | NO → Continue
                  </span>
                </div>
              </div>
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 p-3 bg-[#1a1a1a] rounded">
                ...
                <div className="flex-1">
                  <span className="text-foreground font-medium block">
                    Is easy setup a priority?
                  </span>
                  <span className="text-gray-300 text-xs">
                    YES → Cloud or Hybrid | NO → Continue
                  </span>
                </div>
              </div>
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 p-3 bg-[#1a1a1a] rounded">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-4 bg-elec-gray border border-gray-600 rounded-lg">
              ...
              <p className="text-elec-yellow text-xs mt-3 font-medium">
                Best with: Cloud or Hybrid systems
              </p>
            </div>
          ...
          <div className="space-y-3">
            <div className="p-3 bg-[#1a1a1a] border border-gray-600 rounded-lg">
              <p className="font-medium text-foreground">
                Q1: What is the most important factor when choosing a smart home architecture?
              </p>
            </div>

            <div className="p-3 bg-[#1a1a1a] border border-gray-600 rounded-lg">
              <p className="font-medium text-foreground">
                Q2: Why might someone in a rural area prefer local architecture?
              </p>
            </div>

            <div className="p-3 bg-[#1a1a1a] border border-gray-600 rounded-lg">
              <p className="font-medium text-foreground">
                Q3: What type of user would benefit most from a hybrid system?
              </p>
            </div>

            <div className="p-3 bg-[#1a1a1a] border border-gray-600 rounded-lg">
              <p className="font-medium text-foreground">
                Q4: Name one scenario where cloud architecture is clearly the best choice.
              </p>
            </div>
          </div>
            ...
            <div className="space-y-3 pt-4 border-t border-gray-600">
              <div className="p-3 bg-[#0f0f0f] border border-gray-600 rounded-lg">
                ...
                <p className="text-gray-300">
                  The user's specific needs and priorities - there's no universally "best"
                  architecture, only the best fit for particular requirements like privacy, ease of
                  use, or reliability.
                </p>
              </div>
              ...
              <div className="p-3 bg-[#0f0f0f] border border-gray-600 rounded-lg">
                ...
                <p className="text-gray-300">
                  Rural areas often have unreliable or slow internet connections, making
                  cloud-dependent systems unreliable. Local architecture works completely offline.
                </p>
              </div>
              ...
              <div className="p-3 bg-[#0f0f0f] border border-gray-600 rounded-lg">
                ...
                <p className="text-gray-300">
                  Users with complex automation needs who want both reliability and advanced
                  features, typically in larger homes with professional installation and higher
                  budgets.
                </p>
              </div>
              ...
              <div className="p-3 bg-[#0f0f0f] border border-gray-600 rounded-lg">
                ...
                <p className="text-gray-300">
                  Renters wanting temporary installations, first-time users prioritising ease of
                  setup, or users heavily relying on voice assistants and online service
                  integrations.
                </p>
              </div>
            </div>
