      ...
      <CardContent className="text-gray-300 space-y-4">
        <div className="p-4 bg-[#1a1a1a] rounded-lg">
          ...
          <div className="space-y-3">
            <div className="flex items-start gap-3">
              <div className="w-6 h-6 bg-green-500 rounded-full flex items-center justify-center text-foreground text-sm font-bold mt-0.5">
                S
              </div>
              <div>
            ...
            <div className="flex items-start gap-3">
              <div className="w-6 h-6 bg-blue-500 rounded-full flex items-center justify-center text-foreground text-sm font-bold mt-0.5">
                C
              </div>
              <div>
                <h4 className="font-medium text-foreground">Controller</h4>
                <p className="text-sm">
                  Decides: "If room &lt; 20°C and occupied → turn on heating"
                </p>
              </div>
            </div>

            <div className="flex items-start gap-3">
              <div className="w-6 h-6 bg-orange-500 rounded-full flex items-center justify-center text-foreground text-sm font-bold mt-0.5">
                A
              </div>
              <div>
        ...
        <div className="p-4 bg-amber-900/30 border border-amber-600 rounded-lg">
          ...
          <p className="text-amber-100">
            What redundancy should be built in to prevent heating system failures?
          </p>
        </div>
      </CardContent>
    </Card>
