      ...
      <Card className="bg-elec-gray border-gray-700">
        ...
        <CardContent className="text-gray-300 space-y-6">
          <p className="text-lg font-medium text-foreground mb-6">
            Hybrid architectures combine local processing capabilities with cloud services to
            optimise performance and functionality:
          </p>
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <span className="text-gray-300 ml-2">
                    Critical functions (lighting, security, HVAC) process locally for immediate
                    response
                  </span>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <span className="text-gray-300 ml-2">
                    Advanced features (voice control, AI, remote access) utilise cloud services when
                    available
                  </span>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <span className="text-gray-300 ml-2">
                    System automatically determines optimal processing location based on function
          ...
          <div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
              {platforms.map((platform, index) => (
                <div
                  key={index}
                  className="p-4 bg-gradient-to-br from-purple-900/30 to-purple-800/30 border border-purple-600 rounded-lg"
                >
          ...
          <div className="space-y-3">
            <div className="p-3 bg-[#1a1a1a] border border-gray-600 rounded-lg">
              <p className="font-medium text-foreground">
                Q1: What is the main benefit of hybrid smart home architectures?
              </p>
            </div>

            <div className="p-3 bg-[#1a1a1a] border border-gray-600 rounded-lg">
              <p className="font-medium text-foreground">
                Q2: Which functions typically remain local in a hybrid system?
              </p>
            </div>

            <div className="p-3 bg-[#1a1a1a] border border-gray-600 rounded-lg">
              <p className="font-medium text-foreground">
                Q3: What happens during an internet outage in a well-designed hybrid system?
              </p>
            </div>

            <div className="p-3 bg-[#1a1a1a] border border-gray-600 rounded-lg">
              <p className="font-medium text-foreground">
                Q4: Why might hybrid systems be more complex to troubleshoot?
              </p>
            </div>
          </div>
            ...
            <div className="space-y-3 pt-4 border-t border-gray-600">
              <div className="p-3 bg-[#0f0f0f] border border-gray-600 rounded-lg">
                ...
                <p className="text-gray-300">
                  Combines the speed and reliability of local processing with the advanced features
                  and convenience of cloud services, providing balanced performance.
                </p>
              </div>
              ...
              <div className="p-3 bg-[#0f0f0f] border border-gray-600 rounded-lg">
                ...
                <p className="text-gray-300">
                  Critical functions like security systems, lighting control, HVAC, and basic
                  automation routines remain local for immediate response and reliability.
                </p>
              </div>
              ...
              <div className="p-3 bg-[#0f0f0f] border border-gray-600 rounded-lg">
                ...
                <p className="text-gray-300">
                  Essential functions continue operating locally while cloud-dependent features
                  (voice control, remote access) become unavailable until connectivity is restored.
                </p>
              </div>
              ...
              <div className="p-3 bg-[#0f0f0f] border border-gray-600 rounded-lg">
                ...
                <p className="text-gray-300">
                  Problems could originate from local components, cloud services, or the interaction
                  between them, requiring knowledge of multiple systems and potential conflicting
                  rules.
                </p>
              </div>
            </div>
