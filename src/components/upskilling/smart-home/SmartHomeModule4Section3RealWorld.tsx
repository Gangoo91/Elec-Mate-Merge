      ...
      <CardContent className="text-gray-300 space-y-4">
        <div className="p-4 bg-gradient-to-r from-blue-900/20 to-purple-900/20 border border-blue-600 rounded-lg">
          <h4 className="font-semibold text-foreground mb-4">
            The School Air Quality Transformation
          </h4>
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-gray-300 mb-4">
                A primary school installs CO₂ sensors in all 20 classrooms as part of a health and
                productivity improvement programme. The sensors are connected to the building
                management system (BMS) to automatically control ventilation based on real-time air
                quality data.
              </p>
              <p className="text-gray-300">
                Previously, the school used fixed ventilation schedules that operated at maximum
                capacity during school hours, regardless of actual occupancy or air quality
                conditions.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-300 mb-4">
                Within the first term of operation, teachers report significant improvements in
                classroom conditions. Student concentration appears better, and there are fewer
                complaints about stuffy air or headaches during afternoon lessons.
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-4">
                ...
                <div className="text-center p-3 bg-blue-600/10 border border-blue-600/30 rounded">
                  ...
                  <div className="text-xs text-blue-200">
                    Energy savings from optimised ventilation
                  </div>
                </div>
            ...
            <div>
              ...
              <p className="text-gray-300 mb-4">
                Six months after installation, some sensors begin showing unusual readings.
                Investigation reveals that several sensors have accumulated dust and require
                cleaning. One sensor in a particularly dusty classroom needs recalibration.
              </p>
            ...
            <div>
              ...
              <p className="text-gray-300 mb-4">
                After implementing a proper maintenance schedule including quarterly sensor cleaning
                and annual calibration, the system continues to deliver excellent results. The
                school reports improved attendance rates and better academic performance in
            ...
            <div className="space-y-3">
              <div>
                <p className="text-foreground font-medium text-sm">
                  What would happen if sensors were not calibrated regularly?
                </p>
                <p className="text-gray-400 text-xs mt-1">
                  Consider accuracy, system response, and long-term reliability implications.
                </p>
              </div>
              <div>
                <p className="text-foreground font-medium text-sm">
                  How does this system benefit both health and energy efficiency?
                </p>
                <p className="text-gray-400 text-xs mt-1">
                  Think about demand-controlled ventilation and its dual benefits.
                </p>
              </div>
              <div>
                <p className="text-foreground font-medium text-sm">
                  What other environmental sensors could enhance this installation?
                </p>
                <p className="text-gray-400 text-xs mt-1">
                  Consider humidity, particulates, and temperature monitoring.
                </p>
              </div>
            </div>
          </div>
