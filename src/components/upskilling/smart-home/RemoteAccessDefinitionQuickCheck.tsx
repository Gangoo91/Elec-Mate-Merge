        ...
        {showResult && (
          ...
          >
            ...
            <p className="text-foreground">
              Remote access specifically means controlling home devices via the internet from any
              location worldwide, not just local control within the home. This requires internet
