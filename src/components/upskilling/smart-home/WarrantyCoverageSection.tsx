    ...
    <Card className="bg-elec-gray border-transparent">
      ...
      <CardContent className="space-y-6">
        <p className="text-foreground">
          Clear warranty explanation protects both installer and client by setting realistic
          expectations about what is covered and what responsibilities each party has.
        </p>
          ...
          <div className="space-y-4">
            <div className="p-4 bg-[#1a1a1a] rounded-lg border-l-4 border-blue-500">
              ...
              <p className="text-gray-300 text-sm mb-2">
                Most devices come with manufacturer coverage:
              </p>
        ...
        <div className="bg-blue-600/10 border border-blue-600/30 rounded-lg p-4">
          <h4 className="font-semibold text-blue-200 mb-2">
            Warranty Communication Best Practices
          </h4>
