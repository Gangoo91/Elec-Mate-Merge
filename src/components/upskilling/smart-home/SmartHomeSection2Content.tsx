          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div className="bg-green-600/20 p-4 rounded-lg border border-green-600/40">
              ...
              <p className="text-xs text-gray-300 mb-2">
                Automating repetitive daily tasks such as lighting schedules, thermostat
                adjustments, and security routines, freeing users from manual intervention.
              </p>
            ...
            <div className="bg-red-600/20 p-4 rounded-lg border border-red-600/40">
              ...
              <p className="text-xs text-gray-300 mb-2">
                Integrated alarm systems, CCTV monitoring, and intelligent access control providing
                comprehensive property and personal protection.
              </p>
              <ul className="text-xs space-y-1">
              ...
              <div className="space-y-3">
                <div className="bg-elec-gray p-3 rounded">
                  ...
                  <p className="text-xs text-gray-400">
                    Lighting schedules that automatically adjust based on occupancy patterns, time
                    of day, and seasonal variations for optimal energy efficiency.
                  </p>
                </div>
                <div className="bg-elec-gray p-3 rounded">
                  <p className="text-yellow-400 font-semibold text-sm mb-1">
                    Dynamic Colour & Dimming
                  </p>
                  <p className="text-xs text-gray-400">
                    Adjustable colour temperature (2700K-6500K) and dimming capabilities supporting
                    circadian rhythms and task-specific lighting requirements.
                  </p>
                </div>
                <div className="bg-elec-gray p-3 rounded">
            ...
            <div>
              ...
              <div className="space-y-3">
                <div className="bg-elec-gray p-3 rounded">
                  ...
                  <p className="text-xs text-gray-400">
                    Motion sensors and presence detection automatically controlling lights, reducing
                ...
                <div className="bg-elec-gray p-3 rounded">
                  ...
                  <p className="text-xs text-gray-400">
                    Photosensors measuring ambient light levels and adjusting artificial lighting to
                    maintain consistent illumination while minimising energy use.
                  </p>
                </div>
                <div className="bg-elec-gray p-3 rounded">
                  <p className="text-yellow-400 font-semibold text-sm mb-1">Security Integration</p>
                  <p className="text-xs text-gray-400">
                    Lighting triggered by security events, simulating occupancy during absence, and
                    providing visual alerts for alarm conditions.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="text-center">
                ...
                <p className="text-xs text-gray-300">
                  Energy reduction through LED conversion and automation
                </p>
              </div>
              <div className="text-center">
                <p className="text-2xl font-bold text-yellow-400">15-25%</p>
                <p className="text-xs text-gray-300">
                  Additional savings from occupancy-based control
                </p>
              </div>
              <div className="text-center">
                <p className="text-2xl font-bold text-yellow-400">10-15%</p>
                <p className="text-xs text-gray-300">
                  Further reduction through daylight harvesting
                </p>
              </div>
            </div>
          </div>
            ...
            <div>
              ...
              <div className="space-y-3">
                <div className="bg-elec-gray p-3 rounded">
                  ...
                  <p className="text-xs text-gray-400">
                    AI-powered thermostats that learn household patterns, occupancy schedules, and
                    preferences to optimise comfort while minimising energy consumption.
                  </p>
                </div>
                <div className="bg-elec-gray p-3 rounded">
            ...
            <div>
              ...
              <div className="space-y-3">
                <div className="bg-elec-gray p-3 rounded">
                  ...
                  <p className="text-xs text-gray-400">
                    Mobile app control allowing pre-conditioning before arrival, emergency
                    adjustments, and energy monitoring from anywhere.
                  </p>
                </div>
                <div className="bg-elec-gray p-3 rounded">
                  <p className="text-blue-400 font-semibold text-sm mb-1">Energy Reporting</p>
                  <p className="text-xs text-gray-400">
                    Detailed usage analytics, efficiency recommendations, and cost tracking helping
                    users optimise system performance and reduce bills.
                  </p>
                </div>
                <div className="bg-elec-gray p-3 rounded">
                  <p className="text-blue-400 font-semibold text-sm mb-1">Maintenance Alerts</p>
                  <p className="text-xs text-gray-400">
                    Automated filter change reminders, system health monitoring, and predictive
                    maintenance alerts preventing costly breakdowns.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-3">
                <div className="bg-elec-gray p-3 rounded">
                  ...
                  <p className="text-xs text-gray-400">
                    Keyless entry with mobile app control, biometric access, temporary codes for
                    visitors, and activity logging for complete access management.
                  </p>
                </div>
                <div className="bg-elec-gray p-3 rounded">
                  <p className="text-red-400 font-semibold text-sm mb-1">Video Doorbells</p>
                  <p className="text-xs text-gray-400">
                    HD video streaming, two-way audio communication, motion detection, and cloud
                    recording for comprehensive visitor management.
                  </p>
                </div>
                <div className="bg-elec-gray p-3 rounded">
                  <p className="text-red-400 font-semibold text-sm mb-1">Access Monitoring</p>
                  <p className="text-xs text-gray-400">
                    Real-time notifications for entries, automated guest access, and integration
                    with family member tracking systems.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-3">
                <div className="bg-elec-gray p-3 rounded">
                  ...
                  <p className="text-xs text-gray-400">
                    High-definition cameras with night vision, motion detection, facial recognition,
                    and cloud storage for comprehensive monitoring.
                  </p>
                </div>
                <div className="bg-elec-gray p-3 rounded">
                  <p className="text-red-400 font-semibold text-sm mb-1">Integrated Alarms</p>
                  <p className="text-xs text-gray-400">
                    Multi-sensor alarm systems with door/window sensors, glass break detection, and
                    immediate emergency service notification capabilities.
                  </p>
                </div>
                <div className="bg-elec-gray p-3 rounded">
                  <p className="text-red-400 font-semibold text-sm mb-1">Security Automation</p>
                  <p className="text-xs text-gray-400">
                    Automated lighting responses to security events, simulated occupancy during
                    absence, and coordinated system responses to threats.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-3">
                <div className="bg-elec-gray p-3 rounded">
                  ...
                  <p className="text-xs text-gray-400">
                    Comprehensive voice control for lighting, heating, entertainment systems, and
                    appliances, reducing physical interaction requirements for users with mobility
                    limitations.
                  </p>
                </div>
                <div className="bg-elec-gray p-3 rounded">
                  ...
                  <p className="text-xs text-gray-400">
                    Automated doors, motorised window blinds, adjustable furniture controls, and
                    pathway lighting for users with physical disabilities.
                  </p>
                </div>
                <div className="bg-elec-gray p-3 rounded">
                  <p className="text-purple-400 font-semibold text-sm mb-1">Sensory Assistance</p>
                  <p className="text-xs text-gray-400">
                    Visual alerts for hearing-impaired users, audio descriptions for
                    visually-impaired users, and tactile feedback systems for enhanced
                    accessibility.
                  </p>
                </div>
              </div>
            ...
            <div>
              ...
              <div className="space-y-3">
                <div className="bg-elec-gray p-3 rounded">
                  ...
                  <p className="text-xs text-gray-400">
                    Integration with medical alert systems, medication reminders, and health
                    monitoring devices for comprehensive care support.
                  </p>
                </div>
                <div className="bg-elec-gray p-3 rounded">
                  <p className="text-purple-400 font-semibold text-sm mb-1">Remote Monitoring</p>
                  <p className="text-xs text-gray-400">
                    Activity monitoring for carers and family members, emergency detection, and
                    automated health status updates for peace of mind.
                  </p>
                </div>
                <div className="bg-elec-gray p-3 rounded">
