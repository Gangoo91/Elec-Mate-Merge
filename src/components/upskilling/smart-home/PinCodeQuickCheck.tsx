  ...
  return (
    <Card className="bg-gradient-to-br from-green-900/20 to-blue-900/20 border-green-600">
      ...
      <CardContent className="space-y-4">
        <p className="text-green-100 font-medium">Why might one-time PIN codes be useful?</p>
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <p className="text-gray-300 text-sm">
                One-time PIN codes are perfect for <strong>temporary access</strong> scenarios like
                guests, cleaners, or deliveries. They expire automatically, so you don't need to
                worry about changing permanent codes or collecting physical keys.
              </p>
            </div>
