...
export const SmartHomeFAQ = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        'No, most smart home devices can be retrofitted into existing homes using wireless protocols like Zigbee, Z-Wave, or Wi-Fi. Basic smart home functionality can be achieved without any rewiring. However, some advanced features like smart switches or integrated systems may require additional wiring, but this is typically minimal and focused on specific areas.',
    },
    {
