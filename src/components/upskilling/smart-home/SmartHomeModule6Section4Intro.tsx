      ...
      <Card className="bg-elec-gray border-transparent">
        <CardContent className="p-6">
          ...
          <p className="text-foreground leading-relaxed">
            Not every home starts with brand-new smart devices. Many clients already have older
            systems such as wired alarms, thermostats, or proprietary lighting controls. A big part
            of smart home installation is bridging these legacy systems with modern hubs and
            platforms so everything works together. For electricians, this means understanding how
            to integrate, adapt, or replace older technology while keeping costs manageable and
        ...
        <Card className="bg-elec-gray border-transparent hover:border-elec-yellow/20 transition-all duration-300">
          <CardContent className="p-4 text-center">
            ...
            <p className="text-foreground text-sm">
              Extend system lifespan while adding smart features
            </p>
          </CardContent>
        </Card>
      </div>
