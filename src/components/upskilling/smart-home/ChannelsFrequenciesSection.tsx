    ...
    <Card className="bg-elec-gray border-gray-700">
      ...
      <CardContent className="space-y-6 text-foreground">
        <p className="text-foreground">
          Wireless protocols divide frequency bands into channels - think of them as lanes on a
          motorway. Proper channel planning prevents devices from interfering with each other and
          ensures reliable communication across your smart home network.
        </p>
        ...
        <div className="space-y-4">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            {protocols.map((protocol, index) => (
              <div
                key={index}
                className={`border rounded-lg p-4 ${getColorClasses(protocol.color)}`}
              >
        ...
        <div className="bg-elec-dark border border-gray-600 rounded-lg p-4">
          ...
          <p className="text-sm text-foreground mb-2">
            For homes with both Wi-Fi and Zigbee networks, use this spacing to minimise
            interference:
          </p>
        ...
        <div className="bg-elec-dark border border-gray-600 rounded-lg p-4">
          ...
          <p className="text-sm text-foreground">
            Why does Z-Wave have better wall penetration than 2.4 GHz protocols?
          </p>
        </div>
      </CardContent>
    </Card>
