...
export const SmartHomeModule3Section1Quiz = () => {
  ...
  const questions = [
    ...
    {
      question: 'What type of system controls all bulbs on a lighting circuit at once?',
      options: ['Smart bulbs', 'Voice assistants', 'Smart switches', 'Motion sensors'],
      correct: 2,
      explanation:
        'Smart switches replace wall switches and control all lights on that circuit simultaneously.',
    },
    {
      question: 'Which system requires structured cabling to be run during installation?',
      options: ['Wi-Fi bulbs', 'Smart switches', 'Bluetooth bulbs', 'Centralised wired systems'],
      correct: 3,
      explanation:
    ...
    },
    {
      ...
      options: [
        ...
        'A solar-powered lighting setup',
        'Lights designed to work underwater',
        'Bulbs that physically change shape',
      ],
      correct: 0,
      explanation:
    ...
    {
      question: 'Give one advantage of centralised wired systems.',
      options: [
        "They are the cheapest option available",
        "They are highly reliable with no wireless interference",
        'They continue to work without any electricity',
        'They only ever need a single bulb',
      ],
      correct: 1,
      explanation:
    ...
    },
    {
      ...
      options: [
        'Lights that flash in repeating patterns',
        'Battery-backed emergency lighting only',
        'Lights controlled in time with music',
    ...
    },
    {
      ...
      options: [
        ...
        'A full KNX rewiring of the property',
        'Smart switches for the main circuits',
        'Voice assistants on their own',
      ],
      correct: 2,
      explanation:
