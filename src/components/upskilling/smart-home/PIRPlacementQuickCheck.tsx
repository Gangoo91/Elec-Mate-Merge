...
export const PIRPlacementQuickCheck = () => {
  ...
  const explanation =
    'PIR sensors work best in hallways and main traffic areas at 2-2.5m height, where they can detect cross-movement. Avoid windows, radiators, and direct sunlight.';
