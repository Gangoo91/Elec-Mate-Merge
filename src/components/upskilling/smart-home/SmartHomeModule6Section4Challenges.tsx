              ...
              <div className="bg-elec-dark/50 border border-red-500/30 rounded-lg p-5">
                <div>
                  ...
                  <p className="text-foreground mb-4">
                    Sometimes replacement is cheaper and more reliable than bridging.
                  </p>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="bg-red-500/10 border border-red-500/30 rounded p-3">
                      ...
                      <p className="text-foreground text-sm">
                        Factor in bridge hardware, installation time, ongoing maintenance, and
                ...
                <div className="bg-elec-dark/50 border border-amber-500/30 rounded-lg p-5">
                  <div>
                    ...
                    <p className="text-foreground mb-4">
                      Bridging adds complexity that can reduce system reliability.
                    </p>
                ...
                <div className="bg-elec-dark/50 border border-blue-500/30 rounded-lg p-5">
                  <div>
                    ...
                    <p className="text-foreground mb-4">
                      Bridged devices may only support basic features compared to native smart
                      devices.
                    </p>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="bg-blue-500/10 border border-blue-500/30 rounded p-3">
                        ...
                        <p className="text-foreground text-sm">
                          Old alarm system may only report "armed/disarmed" rather than individual
                          sensor status
                        </p>
                      </div>
                    </div>
                ...
                <div className="bg-elec-dark/50 border border-purple-500/30 rounded-lg p-5">
                  <div>
                    ...
                    <p className="text-foreground mb-4">
                      Multiple systems require more technical knowledge to maintain and
                      troubleshoot.
                    </p>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="bg-purple-500/10 border border-purple-500/30 rounded p-3">
                        ...
                        <p className="text-foreground text-sm">
                          Problems may require troubleshooting across multiple vendors and
                          technologies
                        </p>
                      </div>
                    </div>
