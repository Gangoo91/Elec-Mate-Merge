  ...
  return (
    <Card className="bg-elec-gray border-gray-700">
      ...
      <CardContent className="space-y-6 text-foreground">
        <p>
          Modern smart homes rely on a diverse ecosystem of communication protocols, each optimised
          for specific applications. Understanding these protocols enables installers to make
          informed decisions that balance performance, reliability, and future compatibility.
        </p>
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div className="bg-blue-600/10 border border-blue-600/20 rounded-lg p-4">
            ...
            <p className="text-sm text-foreground">
              Use Wi-Fi for bandwidth-intensive devices, Thread for efficient mesh networks,
              Bluetooth for personal devices, and ensure Matter compatibility for future-proofing.
            </p>
          </div>
          ...
          <div className="bg-green-600/10 border border-green-600/20 rounded-lg p-4">
            ...
            <p className="text-sm text-foreground">
              Proper protocol selection delivers reliable performance, simplified management,
              enhanced security, and compatibility with future devices and services.
            </p>
          </div>
        </div>
        ...
        <div className="bg-purple-600/10 border border-purple-600/20 rounded-lg p-4">
          ...
          <p className="text-sm text-foreground">
            The next section explores practical installation considerations, helping you apply this
            protocol knowledge to real-world smart home projects.
          </p>
        </div>
      </CardContent>
    </Card>
