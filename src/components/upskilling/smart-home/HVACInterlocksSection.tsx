    ...
    <Card className="bg-elec-gray border-gray-700">
      ...
      <CardContent className="text-gray-300 space-y-4">
        <p className="leading-relaxed">
          Interlocks are safety or efficiency features that prevent two systems from operating in
          conflict. They ensure that incompatible operations cannot run simultaneously, protecting
          equipment and preventing energy waste.
        </p>
        ...
        <div className="bg-[#1a1a1a] border border-gray-600 rounded-lg p-4">
          ...
          <p className="text-xs text-gray-400">
            This prevents the wasteful situation where heating and cooling systems fight against
            each other.
          </p>
        </div>
            ...
            <div className="space-y-3">
              <div className="bg-blue-950/30 border border-blue-600 rounded-lg p-3">
                ...
                <p className="text-sm text-blue-100">
                  Physical wiring connections that prevent simultaneous operation through electrical
                  circuits.
                </p>
              </div>
              ...
              <div className="bg-purple-950/30 border border-purple-600 rounded-lg p-3">
                ...
                <p className="text-sm text-purple-100">
                  Programmed rules in smart hubs, BMS, or thermostats that logically prevent
                  conflicts.
                </p>
              </div>
            </div>
