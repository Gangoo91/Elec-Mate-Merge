...
const RoutinesQuickCheck = () => {
  ...
  const correctAnswer = "A pre-set sequence of actions triggered by a command, schedule, or event";
  ...
  return (
    <Card className="bg-blue-500/10 border-blue-500/30">
      <CardContent className="p-5">
        ...
        <p className="text-foreground mb-4 font-medium">What is a smart home routine?</p>
        
        <div className="space-y-2 mb-4">
          {[
            "A manual process for controlling each device separately",
        ...
        {showFeedback && (
          <div className={`p-3 rounded border ${
            ...
            <p className="text-foreground text-sm">
              A routine is a pre-set sequence of actions that can be triggered by commands, schedules, or events, 
              allowing multiple devices to work together efficiently.
            </p>
          </div>
        )}
...
export default RoutinesQuickCheck;