        ...
        {showFeedback && (
          ...
          >
            ...
            <p className="text-foreground text-sm">
              A routine is a pre-set sequence of actions that can be triggered by commands,
              schedules, or events, allowing multiple devices to work together efficiently.
            </p>
          </div>
        )}
