...
export const ModernProtocolComparisonSection = () => {
  ...
  const getScoreColor = (value: string) => {
    if (
      ...
      value.includes('Very Simple') ||
      value === 'None (interoperable)'
    ) {
  ...
  return (
    <Card className="bg-elec-gray border-gray-700">
      ...
      <CardContent className="space-y-6 text-foreground">
        <p>
          Understanding the characteristics of each protocol helps in selecting the right solution
          for specific applications. Each has distinct advantages that make them suitable for
          different use cases in smart home installations.
        </p>
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div className="bg-blue-600/10 border border-blue-600/20 rounded-lg p-4">
            ...
            <ul className="space-y-2 text-sm text-foreground">
              <li>
                <strong className="text-foreground">Wi-Fi:</strong> Star topology (all devices
                connect to router)
              </li>
              <li>
                <strong className="text-foreground">Bluetooth:</strong> Point-to-point or small
                networks
              </li>
              <li>
                <strong className="text-foreground">Thread:</strong> Self-healing mesh network
              </li>
              <li>
                <strong className="text-foreground">Matter:</strong> Uses underlying protocol's
                topology
              </li>
            </ul>
          </div>
          ...
          <div className="bg-green-600/10 border border-green-600/20 rounded-lg p-4">
            ...
            <ul className="space-y-2 text-sm text-foreground">
              <li>
                <strong className="text-foreground">Wi-Fi:</strong> Limited by router capacity
                (~50-100 devices)
              </li>
              <li>
                <strong className="text-foreground">Bluetooth:</strong> 7-8 active connections per
                hub
              </li>
              <li>
                <strong className="text-foreground">Thread:</strong> Hundreds of devices per network
              </li>
              <li>
                <strong className="text-foreground">Matter:</strong> Inherits scalability of
        ...
        <div className="bg-elec-dark border border-gray-600 rounded-lg p-4">
          ...
          <p className="text-sm text-foreground">
            Which protocol would you choose for a high-resolution security camera, and which for a
            battery-powered door sensor? Explain your reasoning.
          </p>
        </div>
      </CardContent>
    </Card>
