        ...
        {showResult && (
          ...
          >
            ...
            <p className="text-foreground">
              The primary advantage of remote monitoring is peace of mind - homeowners can check on
              their property, verify security alerts, and control systems from anywhere, providing
              confidence and security when away from home.
            </p>
          </div>
        )}
