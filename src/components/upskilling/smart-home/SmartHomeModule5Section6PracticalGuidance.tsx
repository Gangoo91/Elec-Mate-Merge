  ...
  return (
    <Card className="bg-elec-gray border-gray-700">
      ...
      <CardContent className="space-y-4">
        <p className="text-foreground mb-4">When installing smart home systems:</p>

        <div className="space-y-3">
          {steps.map((step, index) => (
            <div
              key={index}
              className="flex items-start gap-3 p-3 bg-elec-dark rounded-lg border border-gray-600"
            >
        ...
        <div className="bg-yellow-950/20 p-4 rounded-lg border border-yellow-800/30 mt-6">
          ...
          <p className="text-gray-300 text-sm">
            Create a simple security handover checklist that you can use with every client. This
            ensures consistent security practices and demonstrates your professionalism. Include
            items like password changes, encryption verification, and basic security education.
          </p>
        </div>
      </CardContent>
    </Card>
