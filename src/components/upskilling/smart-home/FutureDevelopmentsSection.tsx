  ...
  return (
    <Card className="bg-elec-gray border-gray-700">
      ...
      <CardContent className="text-gray-300 space-y-4">
        <p>
          The smart heating industry continues to evolve with emerging technologies that promise
          even greater efficiency, convenience, and environmental benefits.
        </p>
        ...
        <div className="bg-elec-gray border border-gray-600 rounded-lg p-4">
          ...
          <p className="text-sm">
            Future smart heating systems will likely feature improved AI capabilities for predictive
            control, tighter integration with energy tariffs and smart grids, and carbon-aware
            operation that adjusts heating schedules based on renewable energy availability.
          </p>
        </div>
      </CardContent>
    </Card>
