      ...
      <CardContent className="space-y-6">
        <div className="p-4 bg-gradient-to-r from-blue-900/20 to-green-900/20 border border-gray-600 rounded-lg">
          <h4 className="font-semibold text-foreground mb-4">
            Decision Guide by Installation Size
          </h4>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="p-3 bg-blue-900/20 border border-blue-600/30 rounded-lg">
              ...
              <div className="text-blue-100 text-sm space-y-1">
                <p>
                  <strong>Recommendation:</strong> Hubless may be fine
                </p>
                <p>
                  <strong>Examples:</strong> Apartment, single room, basic lighting
                </p>
                <p>
                  <strong>Benefits:</strong> Low cost, simple setup
                </p>
              </div>
            </div>
            ...
            <div className="p-3 bg-yellow-900/20 border border-yellow-600/30 rounded-lg">
              ...
              <div className="text-yellow-100 text-sm space-y-1">
                <p>
                  <strong>Recommendation:</strong> Hub recommended
                </p>
                <p>
                  <strong>Examples:</strong> Family home, multi-room systems
                </p>
                <p>
                  <strong>Benefits:</strong> Better reliability, scalability
                </p>
              </div>
            </div>
            ...
            <div className="p-3 bg-green-900/20 border border-green-600/30 rounded-lg">
              ...
              <div className="text-green-100 text-sm space-y-1">
                <p>
                  <strong>Recommendation:</strong> Hub-based essential
                </p>
                <p>
                  <strong>Examples:</strong> Large homes, commercial spaces
                </p>
                <p>
                  <strong>Benefits:</strong> Multiple hubs, zone management
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="p-3 bg-purple-900/10 border border-purple-600/20 rounded-lg">
          ...
          <p className="text-purple-100 text-sm">
            Start with a hub-based system even for smaller installations if the client shows
            interest in expansion. It's easier to add devices to an existing hub than to migrate
            from hubless to hub-based later.
          </p>
        </div>
      </CardContent>
    </Card>
