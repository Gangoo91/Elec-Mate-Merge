      ...
      <CardContent className="text-foreground space-y-6">
        <div className="bg-elec-dark p-4 rounded-lg">
          <p className="text-lg leading-relaxed mb-4">
            Lighting schedules are automated triggers that activate scenes based on time,
            conditions, or events. They eliminate manual control whilst ensuring lighting matches
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                <tr className="border-b border-gray-700">
                  <td className="p-3">
                    <strong className="text-blue-200">Time-Based</strong>
                  </td>
                ...
                <tr className="border-b border-gray-700">
                  <td className="p-3">
                    <strong className="text-purple-200">Sunrise/Sunset</strong>
                  </td>
                ...
                <tr className="border-b border-gray-700">
                  <td className="p-3">
                    <strong className="text-green-200">Occupancy-Based</strong>
                  </td>
                ...
                <tr>
                  <td className="p-3">
                    <strong className="text-orange-200">Condition-Based</strong>
                  </td>
