    ...
    <Card className="bg-elec-gray border-gray-700">
      ...
      <CardContent className="space-y-4">
        <p className="text-foreground">
          Smart home systems rely on internet connectivity. While this makes them powerful and
          convenient, it also introduces risks. Weak security can expose homeowners to hacking, data
          theft, and privacy breaches. As an electrician working with smart home installations, you
          must understand the importance of securing networks and advising clients on best
          practices.
        </p>
