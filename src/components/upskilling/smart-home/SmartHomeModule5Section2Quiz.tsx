...
export const SmartHomeModule5Section2Quiz = () => {
  ...
  const questions = [
    {
      ...
      options: ['Dome + Bullet', 'Thermal + Webcam', 'Microphone + Speaker', 'Lidar + Radar'],
      correct: 0,
      explanation:
        'Dome and bullet are standard CCTV types used in domestic and commercial installs.',
    },
    {
      question: 'Which camera type can be remotely moved for wider coverage?',
      options: ['Dome', 'PTZ', 'Bullet', 'Turret'],
      correct: 1,
    ...
    },
    {
      ...
      options: ['1080p', '2K', '4K', "They're all the same"],
      correct: 2,
  ...
  const getScoreMessage = (score: number) => {
    if (score >= 8)
      return 'Excellent! You have a strong understanding of CCTV types, resolution, and storage options.';
