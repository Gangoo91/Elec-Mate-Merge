...
const quizQuestions: QuizQuestion[] = [
  {
    ...
    correctAnswer: 1,
    explanation:
      'A smart home hub acts as the central controller that connects different smart devices and allows them to communicate with each other, translating between different protocols.',
  },
  {
    id: 2,
    ...
    correctAnswer: 2,
    explanation:
      'Home Assistant is the most popular open-source smart home hub platform that can run on various hardware.',
  },
  {
    id: 3,
    ...
    correctAnswer: 1,
    explanation:
      'Home Assistant can run on Raspberry Pi, dedicated mini PCs, and even virtual machines, making it very flexible in terms of hardware requirements.',
  },
  {
    id: 4,
    ...
    correctAnswer: 2,
    explanation:
      "Home Assistant's main strength is its flexibility and support for thousands of integrations, allowing it to work with virtually any smart device.",
  },
  {
    id: 5,
    ...
    correctAnswer: 1,
    explanation:
      'Home Assistant requires significant technical knowledge for setup, configuration, and ongoing maintenance, which can be challenging for non-technical users.',
  },
  {
    id: 6,
    ...
    correctAnswer: 2,
    explanation:
      'SmartThings supports multiple protocols including Zigbee, Z-Wave, and Wi-Fi, making it compatible with a wide range of devices.',
  },
  {
    id: 7,
    ...
    correctAnswer: 1,
    explanation:
      'SmartThings is designed for beginners with its simple setup process, intuitive mobile app, and broad device compatibility without requiring technical expertise.',
  },
  {
    id: 8,
    ...
    correctAnswer: 1,
    explanation:
      'Philips Hue Bridge and Hive Hub are examples of proprietary hubs designed specifically for their respective brand ecosystems.',
  },
  {
    id: 9,
    ...
    correctAnswer: 1,
    explanation:
      'The main disadvantage of proprietary hubs is their limited compatibility outside their specific brand ecosystem, often requiring multiple hubs for different systems.',
  },
  {
    id: 10,
    question:
      'In the real-world example, why was SmartThings chosen over multiple proprietary hubs?',
    options: [
      'It was cheaper',
    ...
    correctAnswer: 1,
    explanation:
      'SmartThings was chosen because it could integrate all three separate systems (Hue, Hive, Ring) into one unified app, eliminating the frustration of managing multiple interfaces and enabling cross-system automation.',
  },
];
