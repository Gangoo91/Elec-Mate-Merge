...
export const PIRRadiatorQuickCheck = () => {
  ...
  const explanation =
    'PIR sensors detect infrared radiation changes. Radiators and heating vents create temperature fluctuations that can trigger false alarms by mimicking heat signatures.';
