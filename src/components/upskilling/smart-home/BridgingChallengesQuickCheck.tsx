    ...
    <Card className="bg-blue-500/10 border-blue-500/30">
      <CardContent className="p-5">
        ...
        <p className="text-foreground mb-4 font-medium">
          What is one limitation of bridging legacy devices?
        </p>
        ...
        {showFeedback && (
          ...
          >
            ...
            <p className="text-foreground text-sm">
              Bridging can create additional failure points and often provides limited functionality
              compared to native smart devices.
            </p>
          </div>
        )}
