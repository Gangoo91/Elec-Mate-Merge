      ...
      <CardContent className="text-gray-300 space-y-6">
        <div className="bg-green-900/10 border border-green-600/20 rounded-lg p-4">
          ...
          <p className="text-green-100">
            Researching device support before purchase or installation to ensure all components will
            work together seamlessly in the client's chosen ecosystem.
          </p>
        </div>
        ...
        <div className="bg-purple-900/10 border border-purple-600/20 rounded-lg p-4">
          ...
          <p className="text-purple-100 text-sm mb-2">
            Look for Matter certification logos on packaging and product specifications. Matter
            devices offer enhanced interoperability across ecosystems.
          </p>
          <div className="text-xs text-purple-200">
            <strong>Tip:</strong> Matter certification ensures future-proofing as the standard
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-amber-100 text-sm">
                Always maintain a compatibility checklist for clients. Document supported protocols,
                required hubs, and any limitations before finalising device selections.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-2 text-sm">
            <div className="flex items-center gap-2">
              ...
              <span className="text-blue-100">
                1. Identify client's preferred voice assistant/platform
              </span>
            </div>
            <div className="flex items-center gap-2">
              <CheckSquare className="h-4 w-4 text-blue-400" />
