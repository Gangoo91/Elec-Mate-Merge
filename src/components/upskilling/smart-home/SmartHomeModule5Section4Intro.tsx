  ...
  return (
    <Card className="bg-elec-gray border-transparent">
      ...
      <CardContent className="text-foreground space-y-4">
        <p>
          One of the biggest advantages of smart home technology is the ability to monitor and
          control devices from anywhere. Remote access allows homeowners to receive alerts, check
          system status, and even control lighting, heating, or security systems directly from a
          smartphone or tablet. For electricians, it's vital to understand how these systems
          connect, configure, and communicate with cloud platforms.
        </p>
