        ...
        <Accordion type="single" collapsible className="w-full space-y-4">
          ...
          >
            ...
            <AccordionContent className="text-foreground text-sm">
              <p className="mb-3">
                Check the device packaging or specifications for compatibility logos:
              </p>
              <ul className="space-y-1 ml-4">
                <li>
                  • <strong>Alexa:</strong> Look for "Works with Alexa" certification
                </li>
                <li>
                  • <strong>Google:</strong> Look for "Works with Google Assistant" or "Made for
                  Google" badges
                </li>
                <li>
                  • <strong>HomeKit:</strong> Look for "Works with Apple HomeKit" certification
                </li>
              </ul>
              <p className="mt-3">
                You can also check compatibility lists on each platform's official website or app
                before purchase.
              </p>
            </AccordionContent>
          </AccordionItem>
          ...
          >
            ...
            <AccordionContent className="text-foreground text-sm">
              ...
              <ul className="space-y-1 ml-4">
                ...
                <li>
                  • However, avoid confusion by designating primary assistants for specific rooms
                </li>
          ...
          >
            ...
            <AccordionContent className="text-foreground text-sm">
              ...
              <ul className="space-y-1 ml-4">
                <li>
                  • <strong>Alexa & Google:</strong> Most features stop working without internet
                </li>
                <li>
                  • <strong>HomeKit:</strong> Local commands continue working via Apple TV/HomePod
                  hubs
                </li>
                <li>
                  • <strong>Some hubs:</strong> SmartThings and Home Assistant can maintain local
                  automation
                </li>
                <li>
                  • <strong>Always inform clients</strong> about internet dependencies during setup
                </li>
              </ul>
            </AccordionContent>
          </AccordionItem>
          ...
          >
            ...
            <AccordionContent className="text-foreground text-sm">
              <div className="space-y-3">
                <p>
                  <strong>Be transparent about data collection:</strong>
                </p>
                <ul className="space-y-1 ml-4">
                ...
                <p>
                  <strong>Highlight privacy controls:</strong>
                </p>
                <ul className="space-y-1 ml-4">
          ...
          >
            ...
            <AccordionContent className="text-foreground text-sm">
              <div className="space-y-3">
                <p>
                  <strong>Follow these naming conventions:</strong>
                </p>
                <ul className="space-y-1 ml-4">
                ...
                <p className="mt-3">
                  <strong>Group devices by room</strong> in assistant apps for easier "turn off
                  bedroom" commands.
                </p>
              </div>
            </AccordionContent>
