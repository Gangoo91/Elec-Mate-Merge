    ...
    <Card className="bg-elec-gray border-gray-700">
      ...
      <CardContent className="text-gray-300 space-y-6">
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="p-3 bg-green-500/10 border border-green-500/20 rounded-lg">
                ...
                <p className="text-xs">
                  Optimised system coordination can reduce energy consumption by 20-40%
                </p>
              </div>
              ...
              <div className="p-3 bg-blue-500/10 border border-blue-500/20 rounded-lg">
                ...
                <p className="text-xs">
                  Consistent temperature, lighting, and air quality improve occupant productivity
                </p>
              </div>
              ...
              <div className="p-3 bg-purple-500/10 border border-purple-500/20 rounded-lg">
                ...
                <p className="text-xs">
                  Automated data collection for environmental regulations and energy audits
                </p>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="p-3 bg-orange-500/10 border border-orange-500/20 rounded-lg">
                ...
                <p className="text-xs">
                  Initial investment can be £50,000-£500,000+ depending on building size
                </p>
              </div>
              ...
              <div className="p-3 bg-red-500/10 border border-red-500/20 rounded-lg">
                ...
                <p className="text-xs">
                  Requires trained engineers for installation, commissioning, and maintenance
                </p>
              </div>
              ...
              <div className="p-3 bg-yellow-500/10 border border-yellow-500/20 rounded-lg">
                ...
                <p className="text-xs">
                  Connected systems require ongoing security updates and monitoring
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-4">
          ...
          <p className="text-sm">
            While BMS integration requires significant investment and expertise, the long-term
            benefits typically justify costs in buildings over 5,000m². Smaller sites may benefit
            from hybrid approaches using smart hubs with BMS-like capabilities.
          </p>
        </div>
      </CardContent>
    </Card>
