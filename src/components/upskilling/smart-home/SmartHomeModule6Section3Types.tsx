          ...
          <div className="space-y-6">
            <div className="grid gap-6">
              ...
              <Card className="bg-elec-dark/50 border-elec-yellow/20">
                <CardContent className="p-5">
                  ...
                  <p className="text-foreground mb-3">
                    Triggered by one phrase, can control multiple devices.
                  </p>
                  <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-3">
                    <p className="text-foreground text-sm">
                      <strong>Example:</strong> "Alexa, bedtime" → Turn off lights, lock doors, set
                      alarm, adjust thermostat
                    </p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="bg-elec-dark/50 border-elec-yellow/20">
                <CardContent className="p-5">
                  ...
                  <p className="text-foreground mb-3">
                    Triggered by sensors, schedules, or geofencing automatically.
                  </p>
              ...
              <Card className="bg-elec-dark/50 border-elec-yellow/20">
                <CardContent className="p-5">
                  ...
                  <p className="text-foreground mb-3">
                    More advanced logic with multiple conditions.
                  </p>
                  <div className="bg-amber-500/10 border border-amber-500/30 rounded-lg p-3">
                    <p className="text-foreground text-sm">
                      <strong>Example:</strong> "Only turn heating on if temperature &lt; 18°C AND
                      it's after 6pm AND someone is home"
                    </p>
                  </div>
                </CardContent>
              </Card>
            ...
            <div className="bg-elec-dark/30 p-4 rounded-lg border border-elec-yellow/20">
              ...
              <div className="grid md:grid-cols-3 gap-3 text-sm">
                ...
                <div className="text-foreground">
                  <strong className="text-amber-400">Intermediate:</strong> Multiple conditions,
                  timed delays
                </div>
                <div className="text-foreground">
                  <strong className="text-red-400">Advanced:</strong> Complex logic, multiple
                  integrations
                </div>
              </div>
            </div>
