        ...
        {showAnswer && (
          ...
          >
            ...
            <p className="text-gray-300 text-sm">
              Poor power supply and weak signal strength are among the most common causes of pairing
              failure. Always check power connections and verify the device is within range of the
              hub with adequate signal strength.
            </p>
          </div>
        )}
      </CardContent>
