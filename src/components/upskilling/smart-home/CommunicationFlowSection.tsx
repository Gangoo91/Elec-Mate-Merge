  ...
  const flowSteps = [
    {
      ...
      details:
        'Motion sensors, temperature sensors, door sensors etc. continuously monitor the environment and detect changes',
      icon: Activity,
    ...
    },
    {
      ...
      details:
        'Sensor data is transmitted via wireless protocols (Wi-Fi, Zigbee, Z-Wave) or wired connections to the central hub',
      icon: Zap,
    ...
    },
    {
      ...
      details:
        'The hub processes the sensor data using pre-programmed rules, AI algorithms, or user-defined automations',
      icon: Cpu,
    ...
    },
    {
      ...
      details:
        'Based on the logic, commands are sent to appropriate actuators to perform physical actions',
      icon: Zap,
    ...
    },
    {
      ...
      details:
        'System confirms action completion and sends status updates to user interfaces and logs events',
      icon: RefreshCw,
      ...
      <Card className="bg-elec-gray border-gray-700">
        ...
        <CardContent className="text-gray-300 space-y-6">
          <p className="text-lg font-medium text-foreground mb-6">
            Understanding how information flows through a smart home system from detection to
            action:
          </p>
          ...
          <div className="space-y-3">
            <div className="p-3 bg-orange-900/20 border border-orange-600/30 rounded-lg">
              <p className="font-medium text-orange-100">
                Q1: List the 5 main stages of smart home communication flow in order.
              </p>
            </div>

            <div className="p-3 bg-orange-900/20 border border-orange-600/30 rounded-lg">
              <p className="font-medium text-orange-100">
                Q2: What happens during the "Processing & Logic" stage?
              </p>
            </div>

            <div className="p-3 bg-orange-900/20 border border-orange-600/30 rounded-lg">
              <p className="font-medium text-orange-100">
                Q3: Name two wireless protocols commonly used for sensor communication.
              </p>
            </div>
          </div>
            ...
            <div className="space-y-3 pt-4 border-t border-orange-600/50">
              <div className="p-3 bg-orange-800/30 border border-orange-500/30 rounded-lg">
                ...
                <p className="text-orange-100">
                  1. Sensor Detection → 2. Signal Transmission → 3. Processing & Logic → 4. Command
                  Execution → 5. Status Feedback
                </p>
              </div>
              ...
              <div className="p-3 bg-orange-800/30 border border-orange-500/30 rounded-lg">
                ...
                <p className="text-orange-100">
                  The controller processes sensor data using pre-programmed rules, AI algorithms, or
                  user-defined automations to determine what action should be taken.
                </p>
              </div>
              ...
              <div className="p-3 bg-orange-800/30 border border-orange-500/30 rounded-lg">
                ...
                <p className="text-orange-100">
                  Wi-Fi, Zigbee, Z-Wave, and Bluetooth are common wireless protocols used for smart
