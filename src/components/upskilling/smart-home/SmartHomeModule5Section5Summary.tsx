      ...
      <CardContent className="space-y-4">
        ...
        <div className="bg-elec-yellow/10 p-4 rounded-lg border border-elec-yellow/30 mt-6">
          ...
          <p className="text-foreground text-sm">
            While smart lighting integration provides significant benefits for convenience,
            security, and emergency response, it must never compromise basic electrical safety
            standards or replace required emergency lighting systems. Always ensure compliance with
            building regulations and provide reliable manual overrides for critical safety
            functions.
          </p>
        </div>
      </CardContent>
