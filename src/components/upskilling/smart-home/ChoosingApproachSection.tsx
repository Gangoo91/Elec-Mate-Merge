      ...
      <Card className="bg-elec-gray border-gray-700">
        ...
        <CardContent className="text-gray-300 space-y-6">
          <p className="text-lg font-medium text-foreground mb-4">
            Selecting the optimal installation approach based on specific client needs and
            circumstances.
          </p>
          ...
          <div>
            <h4 className="font-semibold text-foreground mb-4 text-lg">
              Client Profile Recommendations
            </h4>
                ...
                <div key={index} className="p-4 bg-[#1a1a1a] border border-gray-600 rounded-lg">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
                    {Object.entries(item.answers).map(([key, value], answerIndex) => (
                      <div
                        key={answerIndex}
                        className="p-2 bg-[#0f0f0f] border border-gray-700 rounded"
                      >
          ...
          <div className="space-y-3">
            <div className="p-3 bg-[#1a1a1a] border border-gray-600 rounded-lg">
              <p className="font-medium text-foreground">
                Q1: What factors should be considered when advising a client on smart home approach?
              </p>
            </div>

            <div className="p-3 bg-[#1a1a1a] border border-gray-600 rounded-lg">
              <p className="font-medium text-foreground">
                Q2: Why might a growing family choose a hybrid approach?
              </p>
            </div>

            <div className="p-3 bg-[#1a1a1a] border border-gray-600 rounded-lg">
              <p className="font-medium text-foreground">
                Q3: What would you recommend for someone with limited budget but wanting immediate
                improvements?
              </p>
            </div>
          </div>
            ...
            <div className="space-y-3 pt-4 border-t border-gray-600">
              <div className="p-3 bg-[#0f0f0f] border border-gray-600 rounded-lg">
                ...
                <p className="text-gray-300">
                  Budget, property status (rent/own/new build), technical expertise, timeline needs,
                  lifestyle requirements, and long-term goals.
                </p>
              </div>
              ...
              <div className="p-3 bg-[#0f0f0f] border border-gray-600 rounded-lg">
                ...
                <p className="text-gray-300">
                  They need security and energy management but want flexibility to expand gradually
                  as children grow and needs change, without major upfront investment.
                </p>
              </div>
              ...
              <div className="p-3 bg-[#0f0f0f] border border-gray-600 rounded-lg">
                ...
                <p className="text-gray-300">
                  Retrofit approach starting with smart bulbs and plugs (£200-400) to provide
                  immediate convenience and energy savings whilst learning the technology.
                </p>
              </div>
            </div>
          )}
