  ...
  return (
    <Card className="bg-elec-gray border-gray-700">
      ...
      <CardContent className="space-y-4">
        <p className="text-foreground">Key takeaways from Network Security and User Privacy:</p>
        ...
        <div className="bg-yellow-950/20 p-4 rounded-lg border border-yellow-800/30 mt-6">
          ...
          <p className="text-gray-300 text-sm">
            As an electrician installing smart home systems, you have a duty of care to ensure that
            systems are not only functional but also secure. This includes changing default
            passwords, configuring security settings, educating clients about ongoing security
            maintenance, and staying informed about current threats and best practices. Never hand
            over a system with default security settings.
          </p>
        </div>
      </CardContent>
    </Card>
