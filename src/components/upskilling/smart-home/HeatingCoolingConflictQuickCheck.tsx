...
export const HeatingCoolingConflictQuickCheck = () => {
  ...
  const explanation =
    'When heating and cooling run simultaneously, they work against each other, wasting enormous amounts of energy and creating inefficient system conflicts that increase costs and reduce comfort.';
