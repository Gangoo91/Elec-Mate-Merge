...
export const ArchitectureComparisonsSection = () => {
  ...
  const comparisons = [
    ...
    },
    {
      ...
      cloud: {
        rating: 'Internet Dependent',
        description: 'Fails without connection',
        color: 'red',
      },
    ...
    },
    {
      ...
      hybrid: {
        rating: 'Medium-High',
        description: 'Multiple systems to configure',
        color: 'yellow',
      },
    },
    {
    ...
    },
    {
      ...
      cloud: {
        rating: 'Low-Medium',
        description: 'Low upfront, potential subscriptions',
        color: 'yellow',
      },
  ...
  const getColorClasses = (color: string) => {
    switch (color) {
      case 'green':
        return 'bg-green-900/30 border-green-500 text-green-100';
      case 'yellow':
        ...
        <CardContent className="text-gray-300 space-y-6">
          ...
          <div className="space-y-4">
            {comparisons.slice(0, 4).map((comparison, index) => (
              <div
                key={index}
                className="p-3 sm:p-4 bg-[#1a1a1a] border border-gray-600 rounded-lg"
              >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  <div
                    className={`p-3 border rounded-lg ${getColorClasses(comparison.local.color)}`}
                  >
                    <div className="flex justify-between items-center sm:block">
                      <h5 className="font-semibold mb-0 sm:mb-1">Local</h5>
                      <div className="font-medium text-sm">{comparison.local.rating}</div>
                    </div>
                    <div className="text-xs mt-1 opacity-75 hidden sm:block">
                      {comparison.local.description}
                    </div>
                  </div>

                  <div
                    className={`p-3 border rounded-lg ${getColorClasses(comparison.cloud.color)}`}
                  >
                    <div className="flex justify-between items-center sm:block">
                    ...
                    <div className="text-xs mt-1 opacity-75 hidden sm:block">
                      {comparison.cloud.description}
                    </div>
                  </div>

                  <div
                    className={`p-3 border rounded-lg ${getColorClasses(comparison.hybrid.color)}`}
                  >
                    <div className="flex justify-between items-center sm:block">
          ...
          <div className="space-y-3">
            <div className="p-3 bg-[#1a1a1a] border border-gray-600 rounded-lg">
              <p className="font-medium text-foreground">
                Q1: Which architecture typically has the lowest latency and why?
              </p>
            </div>

            <div className="p-3 bg-[#1a1a1a] border border-gray-600 rounded-lg">
              <p className="font-medium text-foreground">
                Q2: What is the main trade-off between local and cloud systems regarding ease of
                use?
              </p>
            </div>
            ...
            <div className="p-3 bg-[#1a1a1a] border border-gray-600 rounded-lg">
              <p className="font-medium text-foreground">
                Q3: Why might hybrid systems have higher overall costs?
              </p>
            </div>

            <div className="p-3 bg-[#1a1a1a] border border-gray-600 rounded-lg">
              <p className="font-medium text-foreground">
                Q4: Which architecture offers the best scalability and why?
              </p>
            </div>
          </div>
            ...
            <div className="space-y-3 pt-4 border-t border-gray-600">
              <div className="p-3 bg-[#0f0f0f] border border-gray-600 rounded-lg">
                ...
                <p className="text-gray-300">
                  Local architecture has the lowest latency (0-50ms) because all processing happens
                  within the home without internet communication delays.
                </p>
              </div>
              ...
              <div className="p-3 bg-[#0f0f0f] border border-gray-600 rounded-lg">
                ...
                <p className="text-gray-300">
                  Local systems require more technical expertise and complex setup but offer greater
                  control, while cloud systems are plug-and-play but offer less customisation
                  control.
                </p>
              </div>
              ...
              <div className="p-3 bg-[#0f0f0f] border border-gray-600 rounded-lg">
                ...
                <p className="text-gray-300">
                  Hybrid systems require investment in both local hardware (hubs, controllers) and
                  cloud services (subscriptions, integrations), combining the costs of both
                  approaches.
                </p>
              </div>
              ...
              <div className="p-3 bg-[#0f0f0f] border border-gray-600 rounded-lg">
                ...
                <p className="text-gray-300">
                  Cloud architecture offers the best scalability because it's not limited by local
                  hardware capacity and can leverage virtually unlimited cloud computing resources.
                </p>
              </div>
            </div>
          )}
