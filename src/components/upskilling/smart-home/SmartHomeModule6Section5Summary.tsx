  ...
  const summaryPoints = [
    {
      ...
      description:
        'Different protocols, proprietary ecosystems, and cloud dependencies create integration challenges',
    },
    {
      title: 'Symptoms include device unresponsiveness and partial routine failures',
      description:
        'Conflicts manifest as unreliable operation, duplicate app entries, and performance degradation',
    },
    {
      title: 'Systematic troubleshooting resolves most conflicts',
      description:
        'Five-step approach: check compatibility, test connections, simplify, reset, and update',
    },
    {
      title: 'Prevention through design is most effective',
      description:
        'Choose one primary ecosystem, use certified devices, minimise hubs, and document systems',
    },
  ];
      ...
      <CardContent className="p-6">
        ...
        <div className="mt-6 p-4 bg-elec-yellow/10 border border-elec-yellow/30 rounded-lg">
          ...
          <p className="text-foreground text-sm leading-relaxed">
            Successful ecosystem conflict resolution requires understanding the root causes,
            applying systematic troubleshooting methods, and designing systems for compatibility
            from the start. Electricians who master these skills can deliver reliable smart home
            installations that maintain client confidence and reduce long-term support requirements.
          </p>
        </div>
      </CardContent>
    </Card>
