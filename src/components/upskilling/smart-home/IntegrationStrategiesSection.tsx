    ...
    <Card className="bg-elec-gray border-gray-700">
      ...
      <CardContent className="text-gray-300 space-y-4">
        <p className="leading-relaxed">
          ...
          These approaches ensure optimal comfort whilst minimising energy consumption through
            ...
            <div className="space-y-3">
              <div className="bg-red-950/30 border border-red-600 rounded-lg p-4">
                ...
                <p className="text-sm text-red-100">
                  Thermostat prevents both systems operating simultaneously. Priority given to
                  heating in winter modes, cooling in summer modes.
                </p>
              </div>
              ...
              <div className="bg-blue-950/30 border border-blue-600 rounded-lg p-4">
                ...
                <p className="text-sm text-blue-100">
                  CO₂ sensors trigger fans and ventilation systems, not heating or cooling, when air
                  quality drops.
                </p>
              </div>
              ...
              <div className="bg-green-950/30 border border-green-600 rounded-lg p-4">
                ...
                <p className="text-sm text-green-100">
                  Smart blinds close automatically to reduce cooling demand during hot weather or
                  open to utilise solar heating.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-[#1a1a1a] border border-gray-600 rounded-lg p-4">
          ...
          <p className="text-sm text-gray-300">
            A smart home system detects rising CO₂ levels in the living room. Instead of turning on
            heating, it activates ventilation fans to bring in fresh air. If temperature drops due
            to ventilation, it intelligently balances air quality needs with comfort by modulating
            both systems appropriately.
          </p>
        </div>
      </CardContent>
    </Card>
