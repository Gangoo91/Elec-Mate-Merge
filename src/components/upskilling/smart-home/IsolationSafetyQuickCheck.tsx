...
const IsolationSafetyQuickCheck = () => {
  ...
  const options = [
    ...
    {
      id: 'b',
      text: 'To prevent accidental re-energisation and verify isolation is effective',
      correct: true,
    },
        ...
        {showAnswer && (
          <div className="p-4 bg-elec-yellow/10 border border-elec-yellow/30 rounded-lg">
            ...
            <p className="text-foreground text-sm">
              <strong>Explanation:</strong> Lock-off devices physically prevent breakers from being
              switched on accidentally, while proving units verify that isolation has been achieved
              and is maintained. This dual approach ensures maximum safety and compliance with BS
              7671 requirements.
            </p>
          </div>
        )}
