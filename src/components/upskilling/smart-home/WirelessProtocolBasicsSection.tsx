      ...
      <Card className="bg-elec-gray border-gray-700">
        ...
        <CardContent className="text-gray-300 space-y-6">
          <p className="text-lg font-medium text-foreground mb-4">
            A wireless protocol is a set of rules and standards that define how smart devices
          ...
          <div>
            <h4 className="font-semibold text-foreground mb-4">
              Key Functions of Wireless Protocols
            </h4>
          ...
          <div className="p-4 bg-elec-gray border border-gray-600 rounded-lg">
            ...
            <p className="text-gray-300 text-sm">
              Think of wireless protocols like languages. Just as people need to speak the same
              language to communicate effectively, smart devices need to use the same protocol to
              exchange information. Some "languages" (protocols) are better for certain situations -
              just like you might use text messages for quick updates but video calls for detailed
              conversations.
            </p>
          </div>
        </CardContent>
          ...
          <div className="space-y-3">
            <div className="p-3 bg-[#1a1a1a] border border-gray-600 rounded-lg">
              <p className="font-medium text-foreground">
                Q1: What does a wireless protocol do in smart homes?
              </p>
            </div>

            <div className="p-3 bg-[#1a1a1a] border border-gray-600 rounded-lg">
              <p className="font-medium text-foreground">
                Q2: Why is interoperability important in smart home systems?
              </p>
            </div>

            <div className="p-3 bg-[#1a1a1a] border border-gray-600 rounded-lg">
              <p className="font-medium text-foreground">
                Q3: Name three performance factors that protocols determine.
              </p>
            </div>
          </div>
            ...
            <div className="space-y-3 pt-4 border-t border-gray-600">
              <div className="p-3 bg-[#0f0f0f] border border-gray-600 rounded-lg">
                ...
                <p className="text-gray-300">
                  Wireless protocols define the rules and standards for how smart devices
                  communicate, ensuring they can exchange data reliably and work together
                  effectively.
                </p>
              </div>
              ...
              <div className="p-3 bg-[#0f0f0f] border border-gray-600 rounded-lg">
                ...
                <p className="text-gray-300">
                  ...
                  giving users more choice and preventing vendor lock-in.
                </p>
              </div>
              ...
              <div className="p-3 bg-[#0f0f0f] border border-gray-600 rounded-lg">
                ...
                <p className="text-gray-300">
                  Range, bandwidth, latency, power consumption, security level, and network topology
                  are all determined by the protocol choice.
                </p>
              </div>
            </div>
          )}
