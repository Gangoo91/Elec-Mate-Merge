    ...
    <Card className="bg-blue-500/10 border-blue-500/30">
      <CardContent className="p-5">
        ...
        <p className="text-foreground mb-4 font-medium">
          Name one method of bridging legacy devices with modern smart platforms:
        </p>
        ...
        {showFeedback && (
          ...
          >
            ...
            <p className="text-foreground text-sm">
              Hardware bridges are physical devices that translate between different protocols, like
              the Hue Bridge connecting Zigbee bulbs to Wi-Fi networks.
            </p>
          </div>
        )}
