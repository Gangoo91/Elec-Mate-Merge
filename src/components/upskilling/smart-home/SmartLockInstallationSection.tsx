  ...
  const installationSteps = [
    {
      ...
      details: [
        'Check door thickness and material',
        'Assess existing deadbolt compatibility',
        'Test Wi-Fi signal strength at door',
      ],
    },
    {
      step: '2',
      ...
      details: [
        ...
        'Feature requirements (keypad, biometric, etc.)',
      ],
    },
    {
      step: '3',
      ...
      details: [
        ...
        'Secure mounting and calibration',
  ...
  return (
    <Card className="bg-elec-gray border-gray-700">
      ...
      <CardContent className="text-gray-300 space-y-6">
        <p>
          Professional installation ensures optimal performance and security. The process varies by
          lock type but follows consistent best practices for assessment, installation, and testing.
        </p>
