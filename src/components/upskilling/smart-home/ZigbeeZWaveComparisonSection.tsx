  ...
  const comparisonData = [
    {
      ...
      icon: Signal,
      zigbee: {
        value: '10-20m per hop',
        rating: 3,
        description: 'Shorter range but extends via mesh',
      },
      zwave: {
        value: '30-100m per hop',
        rating: 5,
        description: 'Excellent range and wall penetration',
      },
    },
    {
            ...
            <div key={index} className="p-4 bg-[#1a1a1a] border border-gray-600 rounded-lg">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="p-3 bg-green-900/20 border border-green-600 rounded">
                  ...
                  <div className="text-xs text-green-100 opacity-75">
