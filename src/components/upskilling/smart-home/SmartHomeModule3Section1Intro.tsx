    ...
    <Card className="bg-elec-gray border-gray-700">
      ...
      <CardContent className="text-foreground space-y-4">
        <p className="text-lg leading-relaxed">
          Smart lighting represents the foundation of modern home automation, but choosing the wrong
          approach can cost thousands and create years of frustration. This section teaches you to
          evaluate four distinct lighting architectures through real-world scenarios and practical
          decision frameworks.
        </p>
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div className="p-4 bg-blue-600/10 border border-blue-600/20 rounded-lg">
            ...
            <p className="text-blue-100 text-sm">
              Each system is examined through practical scenarios, cost breakdowns, and installation
              challenges you'll encounter in real projects.
            </p>
          </div>
          <div className="p-4 bg-green-600/10 border border-green-600/20 rounded-lg">
            <h5 className="text-green-200 font-medium mb-2">Applied Knowledge</h5>
            <p className="text-green-100 text-sm">
              Interactive decision trees help you select optimal lighting solutions based on
              specific client requirements and constraints.
            </p>
          </div>
        </div>
      </CardContent>
