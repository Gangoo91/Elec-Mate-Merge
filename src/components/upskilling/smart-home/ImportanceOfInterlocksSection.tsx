    ...
    <Card className="bg-elec-gray border-gray-700">
      ...
      <CardContent className="text-gray-300 space-y-4">
        <p className="leading-relaxed">
          Interlocks are crucial for both energy efficiency and equipment protection. Without them,
          HVAC systems can work against each other, leading to significant energy waste, increased
          wear, and poor comfort levels.
        </p>
            ...
            <div className="space-y-3">
              <div className="bg-red-950/30 border border-red-600 rounded-lg p-3">
                ...
                <p className="text-sm text-red-100">
                  Stop heating and cooling from running together, which wastes enormous amounts of
                  energy.
                </p>
              </div>
              ...
              <div className="bg-blue-950/30 border border-blue-600 rounded-lg p-3">
                ...
                <p className="text-sm text-blue-100">
                  Disable HVAC when windows are open, preventing energy waste from conditioning
                  outdoor air.
                </p>
              </div>
              ...
              <div className="bg-green-950/30 border border-green-600 rounded-lg p-3">
                ...
                <p className="text-sm text-green-100">
                  Ensure ventilation runs only when needed based on CO₂ levels or occupancy, not
                  constantly.
                </p>
              </div>
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-[#1a1a1a] border border-gray-600 rounded-lg p-4">
              ...
              <p className="text-sm text-gray-300">
                Studies show that buildings without proper HVAC interlocks can waste 15-30% more
                energy than properly integrated systems.
              </p>
            </div>
          </div>
        </div>
