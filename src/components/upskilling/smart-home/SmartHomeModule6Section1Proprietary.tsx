        ...
        <CardContent className="space-y-6">
          <div className="flex items-start gap-4 p-4 bg-indigo-900/20 border border-indigo-500/30 rounded-lg">
            ...
            <div>
              ...
              <p className="text-foreground text-sm">
                Examples include Philips Hue Bridge, Hive Hub, and Tado Smart Thermostat Hub -
                designed specifically for their own ecosystems.
              </p>
            </div>
          </div>
          ...
          <div className="bg-green-900/20 border border-green-500/30 rounded-lg p-4">
            ...
            <ul className="space-y-2 text-foreground text-sm">
              <li>
                • <strong>Seamless brand integration</strong> - perfect compatibility within
                ecosystem
              </li>
              <li>
                • <strong>Very stable performance</strong> - thoroughly tested and optimised
              </li>
              <li>
                • <strong>Professional support</strong> - dedicated customer service
              </li>
              <li>
                • <strong>Plug-and-play setup</strong> - minimal configuration required
              </li>
              <li>
                • <strong>Regular updates</strong> - consistent firmware improvements
              </li>
            </ul>
          </div>
          ...
          <div className="bg-red-900/20 border border-red-500/30 rounded-lg p-4">
            ...
            <ul className="space-y-2 text-foreground text-sm">
              <li>
                • <strong>Limited compatibility</strong> - only works with same-brand devices
              </li>
              <li>
                • <strong>Multiple hubs needed</strong> - separate hub for each system
              </li>
              <li>
                • <strong>Vendor lock-in</strong> - difficult to switch brands later
              </li>
              <li>
                • <strong>Higher overall cost</strong> - premium pricing for ecosystem
              </li>
              <li>
                • <strong>Multiple apps</strong> - separate control for each system
              </li>
            </ul>
          </div>
          ...
          <div className="bg-purple-900/20 border border-purple-500/30 rounded-lg p-4">
            ...
            <ul className="space-y-2 text-foreground text-sm">
              <li>
                • <strong>Single-solution installs</strong> - lighting-only, heating-only systems
              </li>
              <li>
                • <strong>Premium brand preferences</strong> - clients wanting specific high-end
                products
              </li>
              <li>
                • <strong>Simple requirements</strong> - basic automation within one category
              </li>
              <li>
                • <strong>Phased installations</strong> - starting with one system, expanding later
              </li>
            </ul>
          </div>
          ...
          <div className="bg-elec-dark/50 border border-gray-600/30 rounded-lg p-4">
            ...
            <p className="text-foreground text-sm mb-2">
              While proprietary hubs excel within their ecosystems, they can often be integrated
