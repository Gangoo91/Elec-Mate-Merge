  ...
  const faqs = [
    {
      ...
      answer:
        'Not always — they provide clearer images but may reduce system performance if storage or bandwidth is inadequate. The key is balancing resolution with your specific needs and infrastructure capabilities. Higher resolution requires more storage space and bandwidth, so ensure your system can handle it before upgrading.',
    },
    {
      question: 'Can I mix wired and wireless cameras in the same system?',
      answer:
        'Yes, hybrid setups are very common and often recommended. Wired cameras (typically PoE) for main coverage areas provide reliability and consistent power, whilst wireless cameras offer flexibility for hard-to-reach locations or temporary installations. Most modern NVR systems support both connection types.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'NVR systems have higher upfront costs but lower ongoing expenses, whilst cloud storage has lower initial costs but recurring monthly/yearly fees. For long-term storage (30+ days), NVR is typically more cost-effective. Cloud storage offers remote access and offsite backup benefits that may justify the ongoing costs.',
    },
    {
      question: 'How long should I keep CCTV footage?',
      answer:
        'This depends on your purpose and legal requirements. For general security, 30 days is common. Commercial properties might need 90+ days. Always check local regulations and your insurance requirements. GDPR requires you to only keep footage as long as necessary for your stated purpose and delete it afterwards.',
    },
    {
      question: 'Do PTZ cameras need special installation considerations?',
      answer:
        'Yes, PTZ cameras require more power (often PoE+ or 12V), structured cable management for movement, and careful positioning to avoid obstacles in their rotation path. They also need proper configuration of preset positions and patrol patterns. Consider environmental factors like wind loading for outdoor installations.',
    },
  ];
