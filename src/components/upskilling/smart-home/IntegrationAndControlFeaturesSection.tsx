  ...
  return (
    <Card className="bg-elec-gray border-gray-700">
      ...
      <CardContent className="text-gray-300 space-y-4">
        <p>
          Modern smart heating systems offer extensive integration capabilities that enhance
          functionality and user experience through multiple control methods and intelligent
          features.
        </p>
