          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-gray-300 mb-4">
                A homeowner decides to upgrade their heating system with a smart thermostat that
                supports OpenTherm for modulating control. They purchase a Nest Learning Thermostat
                expecting significant energy savings through efficient boiler modulation.
              </p>
              <p className="text-gray-300 mb-4">
                However, after installation, they don't see the expected energy savings. The system
                works, but the boiler still seems to run at full output much of the time, similar to
                their old thermostat.
              </p>
              <p className="text-gray-300">
                Upon investigation, the installer discovers that whilst the Nest thermostat supports
                OpenTherm, the homeowner's 15-year-old combi boiler only accepts simple on/off
                switching via relay contacts.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-300 mb-4">
                The compatibility issue wasn't identified during the initial assessment. Key
                oversights included:
              </p>
            ...
            <div>
              ...
              <p className="text-gray-300 mb-4">
                The installer had several options to address the compatibility issue and still
              ...
              <div className="space-y-3">
                <div className="p-3 bg-elec-gray border border-blue-600/30 rounded">
                  ...
                  <p className="text-gray-300 text-sm">
                    Configure the Nest for relay-only operation and focus on smart scheduling,
                    geofencing, and remote control benefits. While modulation isn't available, these
                    features still provide energy savings.
                  </p>
                </div>
                ...
                <div className="p-3 bg-elec-gray border border-green-600/30 rounded">
                  ...
                  <p className="text-gray-300 text-sm">
                    Install smart TRVs on key radiators to create room-level zoning. This provides
                    the precise control that boiler modulation would have offered, just at the room
                    level instead.
                  </p>
                </div>
                ...
                <div className="p-3 bg-elec-gray border border-purple-600/30 rounded">
                  ...
                  <p className="text-gray-300 text-sm">
                    Recommend boiler replacement with OpenTherm-compatible model when due for
                    renewal, ensuring the smart thermostat can then deliver full modulating
                    benefits.
                  </p>
                </div>
              </div>
            ...
            <div>
              ...
              <p className="text-gray-300 mb-4">
                This scenario highlights the importance of thorough compatibility assessment before
                installation:
              </p>
            ...
            <div className="space-y-3">
              <div>
                <p className="text-foreground font-medium text-sm">
                  What should have been checked before installation?
                </p>
                <p className="text-gray-400 text-xs mt-1">
                  Consider compatibility verification steps and documentation review.
                </p>
              </div>
              <div>
                <p className="text-foreground font-medium text-sm">
                  How could the installer still provide value to the customer?
                </p>
                <p className="text-gray-400 text-xs mt-1">
                  Think about alternative smart features and zoning solutions.
                </p>
              </div>
              <div>
                <p className="text-foreground font-medium text-sm">
                ...
                <p className="text-gray-400 text-xs mt-1">
                  Consider assessment procedures and customer communication strategies.
                </p>
              </div>
            </div>
          </div>
