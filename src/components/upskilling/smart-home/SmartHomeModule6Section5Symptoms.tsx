      ...
      <Card className="bg-elec-gray border-transparent">
        <CardContent className="p-6">
          <h2 className="text-2xl font-bold text-foreground mb-6">
            2. Symptoms of Ecosystem Conflicts
          </h2>

          <div className="space-y-6">
            <p className="text-foreground text-lg">
              Recognising these symptoms early helps electricians diagnose ecosystem conflicts
            ...
            <div className="grid gap-6">
              ...
              <div className="bg-elec-dark/50 border border-red-500/30 rounded-lg p-5">
                <div>
                  <h3 className="text-xl font-semibold text-foreground mb-2">
                    Device Responsiveness Problems
                  </h3>
                  <p className="text-foreground mb-3">
                    Devices fail to respond consistently to commands from apps or voice assistants.
                  </p>
                  <div className="space-y-3">
                    ...
                    <div className="bg-red-500/10 border border-red-500/30 rounded p-3">
                      ...
                      <p className="text-foreground text-sm">
                        Usually points to communication protocol conflicts, network issues, or
                        competing hub control
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-elec-dark/50 border border-blue-500/30 rounded-lg p-5">
                <div>
                  ...
                  <p className="text-foreground mb-3">
                    Routines and scenes work inconsistently, with some devices responding while
                    others don't.
                  </p>
                  <div className="space-y-3">
                    ...
                    <div className="bg-blue-500/10 border border-blue-500/30 rounded p-3">
                      ...
                      <p className="text-foreground text-sm">
                        Different devices use different hubs or protocols, preventing unified
                        control in complex routines
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-elec-dark/50 border border-purple-500/30 rounded-lg p-5">
                <div>
                  ...
                  <p className="text-foreground mb-3">
                    Overall system becomes sluggish with noticeable delays in device response times.
                  </p>
                  <div className="space-y-3">
                    ...
                    <div className="bg-purple-500/10 border border-purple-500/30 rounded p-3">
                      ...
                      <p className="text-foreground text-sm">
                        Multiple hubs competing for bandwidth, cloud dependencies causing
                        bottlenecks
                      </p>
                    </div>
                  </div>
              ...
              <div className="bg-elec-dark/50 border border-green-500/30 rounded-lg p-5">
                <div>
                  <h3 className="text-xl font-semibold text-foreground mb-2">
                    App Duplication and Confusion
                  </h3>
                  <p className="text-foreground mb-3">
                    Devices appear multiple times across different apps, creating user confusion.
                  </p>
                  <div className="space-y-3">
                    ...
                    <div className="bg-green-500/10 border border-green-500/30 rounded p-3">
                      ...
                      <p className="text-foreground text-sm">
                        Users don't know which app to use for control, leading to frustration and
                        system abandonment
                      </p>
                    </div>
                  </div>
            ...
            <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
              ...
              <p className="text-foreground text-sm leading-relaxed">
                When clients report "the system is unreliable," ask specific questions about which
                devices fail, when failures occur, and which app they're using. This helps pinpoint
                whether it's a protocol, hub, or integration conflict.
              </p>
            </div>
          </div>
        </CardContent>
