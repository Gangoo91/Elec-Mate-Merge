  ...
  return (
    <Card className="bg-elec-gray border-gray-700">
      ...
      <CardContent className="space-y-6 text-foreground">
        <p>
          Thread represents the next generation of mesh networking, specifically designed for smart
          home and IoT applications. Unlike proprietary protocols, Thread is built on open standards
          and integrates seamlessly with existing IP networks, making it a compelling choice for
        ...
        <div className="bg-yellow-600/10 border border-yellow-600/20 rounded-lg p-4">
          ...
          <p className="text-sm text-foreground mb-2">
            Thread networks require a "border router" to connect to your Wi-Fi network and the
            internet. This functionality is increasingly built into smart speakers and hubs:
          </p>
        ...
        <div className="bg-elec-dark border border-gray-600 rounded-lg p-4">
          ...
          <p className="text-sm text-foreground">
            What type of network topology does Thread use, and how does it improve on traditional
            mesh protocols?
          </p>
        </div>
      </CardContent>
