    ...
    <Card className="bg-elec-gray border-transparent">
      ...
      <CardContent className="text-foreground space-y-6">
        <div className="bg-purple-600/10 p-4 rounded-lg border border-purple-600/30">
          ...
          <p className="text-sm">
            Contact sensors detect the initial breach at doors and windows, while PIR sensors catch
            movement inside the property, ensuring comprehensive coverage even if perimeter sensors
