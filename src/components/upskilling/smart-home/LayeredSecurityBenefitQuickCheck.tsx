...
export const LayeredSecurityBenefitQuickCheck = () => {
  ...
  const explanation =
    'Combining contact sensors (perimeter) with PIRs (interior) creates layered security. Contact sensors detect entry attempts while PIRs monitor movement inside, reducing blind spots and response gaps.';
