...
const SmartHomeModule6Section3Summary = () => {
  const summaryPoints = [
    ...
    },
    {
      ...
      description:
        'Command-based, event-based, and conditional routines serve different automation needs',
    },
    {
      icon: AlertCircle,
      title: 'Testing and documentation are key',
      description:
        'Thorough testing and client training ensure successful long-term implementation',
    },
  ];
      ...
      <CardContent className="p-6">
        ...
        <div className="mt-6 p-4 bg-elec-yellow/10 border border-elec-yellow/30 rounded-lg">
          ...
          <p className="text-foreground text-sm leading-relaxed">
            ...
            thorough testing, and providing ongoing support. Well-designed routines transform smart
            homes from complex systems into intuitive, automated environments that enhance daily
            life.
          </p>
        </div>
      </CardContent>
