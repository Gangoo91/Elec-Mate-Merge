    ...
    <Card className="bg-elec-gray border-transparent">
      ...
      <CardContent className="text-gray-300 space-y-6">
        <p className="text-base leading-relaxed">
          This section explored the practical benefits and applications of smart home technology
          across four key domains: lighting, HVAC, security, and accessibility. We examined how
          these systems create measurable improvements in energy efficiency, convenience, safety,
          and quality of life while supporting diverse user needs and capabilities.
        </p>
          ...
          <div className="bg-elec-gray p-4 rounded-lg">
            ...
            <ul className="text-sm space-y-2">
              <li className="flex items-start gap-2">
                ...
                <span>
                  Smart Lighting: Automated scheduling, energy efficiency, and ambience control
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-elec-yellow mt-1">•</span>
                <span>
                  HVAC Systems: Intelligent climate control, zoning, and energy optimisation
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-elec-yellow mt-1">•</span>
                <span>
                  Security Applications: Access control, monitoring, and integrated protection
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-elec-yellow mt-1">•</span>
                <span>
                  Accessibility Solutions: Assistive technology and independent living support
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-elec-yellow mt-1">•</span>
          ...
          <div className="bg-elec-gray p-4 rounded-lg">
            ...
            <ul className="text-sm space-y-2">
              ...
              <li className="flex items-start gap-2">
                <span className="text-elec-yellow mt-1">•</span>
                <span>
                  Security enhancement: Real-time monitoring and automated threat response
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-elec-yellow mt-1">•</span>
                <span>
                  Accessibility improvements: Voice control and automated assistance features
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-elec-yellow mt-1">•</span>
        ...
        <div className="bg-purple-600/10 p-4 rounded-lg border border-purple-600/30">
          ...
          <p className="text-sm text-gray-300 mb-3">
            Having mastered the benefits and applications of smart home technology, you're prepared
            to explore more advanced topics including system design principles, network
            architecture, and emerging technologies that will shape the future of intelligent
            buildings.
          </p>
          <p className="text-sm text-gray-300">
            The next section will delve into communication protocols and network design, providing
            the technical foundation necessary for designing robust, scalable smart home systems.
          </p>
        </div>
      </CardContent>
    </Card>
