...
export const TRVFunctionQuickCheck = () => {
  const [selectedAnswer, setSelectedAnswer] = useState<string | null>(null);
  const [showResult, setShowResult] = useState(false);

  const question = "What does a smart TRV do?";
  const options = [
    "Controls the central heating boiler",
    "Adjusts radiator water flow based on room temperature",
    "Monitors outdoor weather conditions",
    "Controls hot water temperature"
  ];
        ...
        {showResult && (
          <div className="p-4 bg-[#1a1a1a] border border-gray-600 rounded-lg">
            <p className="text-gray-300 text-sm">
              <strong className="text-foreground">Explanation:</strong> A smart TRV (Thermostatic Radiator Valve) adjusts the flow of hot water through individual radiators based on room temperature, allowing precise room-level heating control.
            </p>
            <Button
