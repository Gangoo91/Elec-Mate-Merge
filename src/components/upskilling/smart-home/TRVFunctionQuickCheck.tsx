        ...
        {showResult && (
          <div className="p-4 bg-[#1a1a1a] border border-gray-600 rounded-lg">
            <p className="text-gray-300 text-sm">
              <strong className="text-foreground">Explanation:</strong> A smart TRV (Thermostatic
              Radiator Valve) adjusts the flow of hot water through individual radiators based on
              room temperature, allowing precise room-level heating control.
            </p>
            <Button
