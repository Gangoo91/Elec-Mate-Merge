    ...
    <Card className="bg-blue-600/10 border-blue-600/30 border">
      ...
      <CardContent className="text-gray-300 space-y-4">
        ...
        <p className="text-sm mb-4">
          A working couple with two school-age children retrofit their 1990s detached house with
          smart technology across lighting, HVAC, and security systems. The implementation
          demonstrates practical benefits and integration challenges in real-world residential
          environments.
        </p>
        ...
        <div className="bg-yellow-600/20 border border-yellow-600/40 p-3 rounded mt-4">
          ...
          <ul className="text-xs text-gray-300 space-y-1">
            ...
            <li>
              • Garden irrigation system integration with weather data and water usage monitoring
            </li>
        ...
        <div className="bg-orange-600/20 border border-orange-600/40 p-3 rounded mt-4">
          <p className="text-orange-400 font-semibold text-sm mb-2">
            Critical Question for Learners:
          </p>
          <p className="text-sm text-gray-300">
            What further integrations could improve safety, efficiency, or quality of life for this
            family? Consider emerging technologies, seasonal requirements, and long-term
            adaptability needs.
          </p>
        </div>
      </CardContent>
