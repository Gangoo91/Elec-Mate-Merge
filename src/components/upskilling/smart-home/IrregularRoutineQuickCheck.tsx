...
export const IrregularRoutineQuickCheck = () => {
  const [selectedAnswer, setSelectedAnswer] = useState<string | null>(null);
  const [showResult, setShowResult] = useState(false);

  const question = "Which approach is better for households with irregular routines?";
  const options = [
    "Fixed scheduled control",
    "AI learning control",
        ...
        {showResult && (
          <div className="p-4 bg-[#1a1a1a] border border-gray-600 rounded-lg">
            <p className="text-gray-300 text-sm">
              <strong className="text-foreground">Explanation:</strong> AI learning control is better for irregular households because it adapts to changing patterns. Shift workers, flexible schedules, and unpredictable routines benefit from systems that learn and adjust automatically rather than rigid time-based schedules.
            </p>
            <Button
