      ...
      <Card className="bg-elec-gray border-transparent">
        ...
        <CardContent className="space-y-4">
          <p className="text-foreground text-sm sm:text-base leading-relaxed">
            Testing earth fault loop impedance (Zs) at various points throughout an electrical
            installation is a critical verification process that ensures automatic disconnection of
            supply under earth fault conditions. This comprehensive testing approach is required by
            BS 7671 to demonstrate that every point in the installation can achieve the required
            disconnection times for both shock protection and fire protection.
          </p>
          <p className="text-foreground text-sm sm:text-base leading-relaxed">
            Unlike testing at the origin of an installation, testing at various points reveals the
            true performance characteristics of individual circuits, accounting for cable impedance,
            connection quality, and the cumulative effects of distribution path lengths. This
            testing is essential for verifying that protective devices will operate correctly under
            fault conditions throughout the entire installation.
          </p>
          <div className="bg-blue-600/10 border border-blue-600/20 rounded-lg p-4">
            <h4 className="text-blue-200 font-medium mb-2">Why This Matters</h4>
            <p className="text-foreground text-xs sm:text-sm">
              Zs values increase with distance from the source due to additional cable impedance.
              The furthest points in circuits often represent the worst-case scenarios for fault
              clearance. Without proper testing at these critical points, potentially dangerous
              situations could exist where protective devices fail to operate within required time
              limits.
            </p>
          </div>
        </CardContent>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-3">
              <div className="flex items-start gap-3">
                ...
                <p className="text-foreground text-sm">
                  Explain why Zs testing must be conducted at multiple points throughout an
                  installation
                </p>
              </div>
              <div className="flex items-start gap-3">
                <CheckCircle className="h-5 w-5 text-green-400 mt-0.5 flex-shrink-0" />
                <p className="text-foreground text-sm">
                  Identify the most critical testing points for different types of circuits (ring,
                  radial, lighting)
                </p>
              </div>
              <div className="flex items-start gap-3">
              ...
              <div className="flex items-start gap-3">
                <CheckCircle className="h-5 w-5 text-green-400 mt-0.5 flex-shrink-0" />
                <p className="text-foreground text-sm">
                  Apply special considerations for testing in locations such as bathrooms and
                  outbuildings
                </p>
              </div>
            </div>
            <div className="space-y-3">
              ...
              <div className="flex items-start gap-3">
                <CheckCircle className="h-5 w-5 text-green-400 mt-0.5 flex-shrink-0" />
                <p className="text-foreground text-sm">
                  Document test results appropriately and recommend corrective actions where
                  necessary
                </p>
              </div>
            </div>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-4">
            <h3 className="text-xl font-semibold text-foreground">
              Why Test Zs at Various Points?
            </h3>
            <div className="bg-[#323232] rounded-lg p-4 space-y-3">
              <p className="text-foreground leading-relaxed text-sm sm:text-base">
                Testing Zs at different locations throughout an installation ensures that{' '}
                <strong>every point</strong>
                where equipment might be connected can achieve proper automatic disconnection under
                fault conditions.
              </p>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-[#323232] rounded-lg p-4 space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div className="space-y-3">
                  <p className="text-foreground leading-relaxed text-sm sm:text-base">
                    Zs testing <strong>must be carried out on live circuits</strong> to get accurate
                    readings. The test requires current to flow through the complete earth fault
                    loop path to measure its impedance correctly.
                  </p>
          ...
          <div className="space-y-4">
            <h3 className="text-xl font-semibold text-foreground">
              Testing RCD-Protected Circuits
            </h3>
            <div className="bg-[#323232] rounded-lg p-4 space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div className="space-y-3">
                  <p className="text-foreground leading-relaxed text-sm sm:text-base">
                    When testing circuits protected by RCDs, you must use the{' '}
                    <strong>non-trip loop test mode</strong>
                  ...
                  <div className="bg-red-600/10 border border-red-600/20 rounded p-3">
                    <div className="flex items-start gap-2">
                      ...
                      <p className="text-foreground text-xs sm:text-sm">
                        <strong>Note:</strong> Non-trip readings may be slightly higher than
                        standard loop tests due to the lower test current, but they still provide
                        valid Zs measurements.
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div className="space-y-4">
            <h3 className="text-xl font-semibold text-foreground">
              Systematic Testing Approach by Circuit Type
            </h3>
            ...
            <div className="space-y-3">
              ...
              <div className="bg-[#323232] rounded-lg p-4">
                <h4 className="text-green-200 font-medium mb-3">
                  Outdoor and Outbuilding Circuits
                </h4>
              ...
              <ol className="space-y-3">
                <li className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-foreground text-sm">
                      Check protective device type, rating, and RCD protection
                    </p>
                  </div>
                </li>
                <li className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-foreground text-sm">
                      Use non-trip mode for RCD circuits, standard mode for others
                    </p>
                  </div>
                </li>
                <li className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-foreground text-sm">
                      Line probe to live terminal, earth probe to earth terminal
                    </p>
                  </div>
                </li>
                <li className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-foreground text-sm">
                      Press test button and wait for stable reading
                    </p>
                  </div>
                </li>
                <li className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-foreground text-sm">
                      Note actual value and compare to BS7671 maximum for the protective device
                    </p>
                  </div>
                </li>
              </ol>
