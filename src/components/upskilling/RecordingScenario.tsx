    ...
    <Card className="bg-elec-gray border-transparent">
      ...
      <CardContent className="space-y-6">
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-foreground leading-relaxed">
                During a routine domestic EICR, you find that RCD protection is absent on a socket
                circuit near a sink in a kitchen. You notice the issue and make a mental note, but
                you don't mark it on the certificate because you're running late and plan to mention
                it verbally to the client. Six months later, a serious shock incident occurs at that
                socket.
              </p>
            </div>
            ...
            <div className="bg-red-600/20 border border-red-600/30 rounded-lg p-4">
              ...
              <p className="text-foreground text-sm leading-relaxed">
                <strong>You are at fault.</strong> Omissions in documentation can be as serious as
                testing errors. By failing to record this C1 observation (immediate danger), you
                have:
              </p>
            ...
            <div className="bg-yellow-600/10 border border-yellow-600/20 rounded-lg p-4">
              ...
              <p className="text-foreground text-sm leading-relaxed">
                <strong>
                  Documentation is not optional - it's a legal and professional requirement.
                </strong>
        ...
        <div className="bg-green-600/10 border border-green-600/20 rounded-lg p-4">
          ...
          <p className="text-foreground text-sm leading-relaxed">
            Time pressure never justifies cutting corners on documentation. If you don't have time
            to document properly, you don't have time to inspect properly. Schedule adequate time
            for complete and accurate record-keeping as an integral part of every inspection.
          </p>
        </div>
      </CardContent>
    </Card>
