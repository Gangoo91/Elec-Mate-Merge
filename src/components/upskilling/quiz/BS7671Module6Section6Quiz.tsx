...
const quizData: QuizQuestion[] = [
  {
    ...
    options: [
      'To define the scope and protect against liability for uninspected areas',
      "To reduce the inspector's overall workload",
      'To increase the perceived value of the certificate',
      'To demonstrate thoroughness to the client',
    ],
    correctAnswer: 0,
    explanation:
      'Limitations protect electricians from liability for defects in areas that could not be inspected due to practical constraints, while informing clients of inspection scope restrictions.',
  },
  {
    id: 2,
    ...
    correctAnswer: 2,
    explanation:
      'C1 indicates danger present with immediate action required. The installation or affected circuits should be isolated immediately until remedial action is completed.',
  },
  {
    id: 3,
    ...
    correctAnswer: 0,
    explanation:
      "C2 indicates potentially dangerous defects that don't pose immediate danger but could become dangerous under fault conditions, such as inadequate earthing arrangements.",
  },
  {
    id: 4,
    ...
    correctAnswer: 3,
    explanation:
      "When major portions of the installation (typically >25%) or critical safety systems cannot be inspected, the certificate's validity and usefulness may be compromised.",
  },
  {
    id: 5,
    ...
    correctAnswer: 1,
    explanation:
      'Complete observations require precise location, clear defect description, relevant regulation reference, risk assessment, recommended remedial action, and appropriate safety code classification.',
  },
  {
    id: 6,
    question: 'Which scenario would justify recording a limitation?',
    options: [
      "The inspector simply prefers not to inspect certain areas",
      'Areas that merely look difficult to access',
      'Circuits that appear to be working properly',
      'Locked rooms where keys are unavailable during inspection',
    ],
    correctAnswer: 3,
    explanation:
      "Legitimate limitations include physical access restrictions like locked rooms where keys are unavailable, safety restrictions, or operational constraints beyond the electrician's control.",
  },
  {
    id: 7,
    ...
    correctAnswer: 2,
    explanation:
      'FI (Further Investigation) indicates items requiring additional investigation to determine if they constitute a defect, often requiring specialist knowledge or additional testing.',
  },
  {
    id: 8,
    ...
    options: [
      ...
      'They should be addressed urgently within days',
      "They can be disregarded as unimportant",
    ],
    correctAnswer: 1,
    explanation:
      "C3 observations indicate installations that don't comply with current standards but aren't dangerous. Improvement would enhance safety but is not urgent.",
  },
  {
    id: 9,
    ...
    options: [
      ...
      'Complete the certificate as normal regardless',
      'Mention it only briefly within the limitations',
      'Disregard the limitation and continue',
    ],
    correctAnswer: 0,
    explanation:
      'When access to critical safety systems is limited, professional judgment is required to determine if sufficient inspection has been completed to provide meaningful certification.',
  },
  {
    id: 10,
    ...
    correctAnswer: 1,
    explanation:
      'Limitations record areas that could not be inspected due to constraints, while observations record actual defects or non-compliance issues found during inspection.',
  },
];
      ...
      <Card className="bg-gradient-to-r from-elec-yellow/10 to-elec-gray border-elec-yellow/30">
        ...
        <CardContent className="space-y-4">
          <p className="text-foreground">
            Test your understanding of limitations and observations in electrical certificates with
        ...
        <CardContent className="space-y-4">
          <div className="text-center">
            ...
            <p className="text-foreground mt-2">
              {score >= 8
                ? 'Excellent knowledge of limitations and observations!'
                : score >= 6
                  ? 'Good understanding!'
