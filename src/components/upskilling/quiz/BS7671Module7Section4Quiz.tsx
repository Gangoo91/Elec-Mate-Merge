...
const quizData: QuizQuestion[] = [
  {
    ...
    correctAnswer: 1,
    explanation:
      'A medical IT system uses an isolating transformer to provide electrical separation with continuous insulation monitoring to ensure patient safety in medical locations.',
  },
  {
    id: 2,
    ...
    correctAnswer: 1,
    explanation:
      'Hospital socket outlets in medical locations are typically supplied from medical IT systems with continuous insulation monitoring to prevent the first fault from causing disconnection.',
  },
  {
    id: 3,
    ...
    correctAnswer: 1,
    explanation:
      'Industrial power systems require high continuity of supply to avoid production losses while maintaining safety standards through proper design and protection.',
  },
  {
    id: 4,
    ...
    correctAnswer: 1,
    explanation:
      'Selectivity ensures that only the protective device closest to the fault operates, maintaining supply to healthy circuits and minimising disruption.',
  },
  {
    id: 5,
    ...
    correctAnswer: 1,
    explanation:
      'Safety circuits (fire alarms, emergency lighting) must be segregated from non-safety circuits to prevent non-safety circuit faults affecting critical safety systems.',
  },
];
