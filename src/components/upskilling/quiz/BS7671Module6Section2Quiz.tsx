...
const quizData: QuizQuestion[] = [
  {
    ...
    correctAnswer: 1,
    explanation:
      'Visual inspection ensures the installation is safe to test and identifies visible defects that could make testing unsafe or mask underlying issues before electrical testing begins.',
  },
  {
    id: 2,
    ...
    correctAnswer: 1,
    explanation:
      'Visual inspection identifies defects such as damaged cables, loose terminations, inadequate mechanical protection, incorrect protective devices, and non-compliance with regulations.',
  },
  {
    id: 3,
    ...
    correctAnswer: 2,
    explanation:
      'Equipment must have appropriate IP ratings for their environment - higher IP ratings are required for bathrooms, outdoor installations, and other locations with moisture or dust exposure.',
  },
  {
    id: 4,
    ...
    correctAnswer: 2,
    explanation:
      'BS 7671 requires testing in a specific sequence: continuity of protective conductors, insulation resistance, polarity, earth fault loop impedance, RCD performance, and functional tests.',
  },
  {
    id: 5,
    ...
    correctAnswer: 2,
    explanation:
      'If test results are unsatisfactory and fall outside BS 7671 limits, corrective work must be carried out before energising the installation to ensure safety and compliance.',
  },
  {
    id: 6,
    ...
    correctAnswer: 1,
    explanation:
      'Test instruments must be calibrated and traceable to ensure the accuracy of recorded results. The tester is responsible for both safety and accuracy of all recorded results.',
  },
  {
    id: 7,
    ...
    correctAnswer: 1,
    explanation:
      'Circuits must be clearly labelled, along with identification of isolation points, protective devices, and emergency switching arrangements for safety and maintenance purposes.',
  },
  {
    id: 8,
    ...
    correctAnswer: 2,
    explanation:
      'The electrician who signs the certificate is legally accountable for the accuracy of all inspection and test results, taking full responsibility for compliance and safety.',
  },
  {
    id: 9,
    ...
    correctAnswer: 1,
    explanation:
      "Electricians must verify everything during inspection and testing, never assuming previous work was done correctly, as they become legally responsible for the entire installation's safety.",
  },
  {
    id: 10,
    ...
    correctAnswer: 1,
    explanation:
      'In the retail unit example, several socket circuits were not labelled correctly on the distribution board, which would have caused confusion during testing and maintenance if not corrected.',
  },
];
