...
const quizData: QuizQuestion[] = [
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'A comprehensive handover package includes the installation certificate, test results, user manuals, warranty information, maintenance guidance, and emergency contact details.',
  },
  {
    id: 8,
        ...
        <CardContent className="space-y-6">
          <div className="text-center space-y-4">
            ...
            <p className="text-gray-300">
              {percentage >= 80
                ? 'Excellent understanding of certification and handover procedures!'
                : percentage >= 60
