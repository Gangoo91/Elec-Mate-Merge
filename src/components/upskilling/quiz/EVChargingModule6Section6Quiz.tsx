...
const quizData: QuizQuestion[] = [
  ...
  {
    id: 7,
    question: "Which of the following must be included in a comprehensive handover package?",
    options: [
      "Only the installation certificate",
      "Certificate, test results, and user manuals",
      "Certificate, test results, manuals, warranties, and maintenance guidance",
      "Just the warranty information"
    ],
    correctAnswer: 2,
    explanation: "A comprehensive handover package includes the installation certificate, test results, user manuals, warranty information, maintenance guidance, and emergency contact details."
  },
  {
    id: 8,
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation: "Charging point labels must include maximum charging current, voltage and phase information, emergency stop procedures, warning notices, and manufacturer details."
  },
  {
    id: 10,
...
export const EVChargingModule6Section6Quiz = () => {
        ...
        <CardContent className="space-y-6">
          <div className="text-center space-y-4">
            ...
            <p className="text-gray-300">
              {percentage >= 80 ? 'Excellent understanding of certification and handover procedures!' : 
               percentage >= 60 ? 'Good knowledge! Review the areas you missed.' : 
               'Keep studying certification and documentation requirements and try again.'}
            </p>
          </div>
...
export default EVChargingModule6Section6Quiz;