...
import { smartHomeModule6Section4QuizQuestions } from '@/data/upskilling/smartHomeModule6Section4QuizData';

const SmartHomeModule6Section4Quiz = () => {
  ...
  const handleNext = () => {
    if (currentQuestion < smartHomeModule6Section4QuizQuestions.length - 1) {
  ...
  const calculateScore = () => {
    return selectedAnswers.reduce((score, answer, index) => {
      return score + (answer === smartHomeModule6Section4QuizQuestions[index].correct ? 1 : 0);
    }, 0);
  };

  const currentQ = smartHomeModule6Section4QuizQuestions[currentQuestion];
  const score = calculateScore();
  const totalQuestions = smartHomeModule6Section4QuizQuestions.length;
      ...
      <Card className="bg-elec-gray border-transparent">
        <CardContent className="p-6">
          ...
          <div className="space-y-4 mb-6">
            {smartHomeModule6Section4QuizQuestions.map((question, index) => (
...
export default SmartHomeModule6Section4Quiz;