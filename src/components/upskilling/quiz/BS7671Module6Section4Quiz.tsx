...
const quizData: QuizQuestion[] = [
  {
    ...
    options: [
      ...
      'To record ongoing maintenance activities on the installation',
      'To provide the equipment warranty terms to the client',
      'To log the energy consumption of the installation',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Only the test results that failed verification',
      'Just the overall pass or fail outcome of the inspection',
      'Only the observations recorded during visual inspection',
      'All measured test results across the full BS 7671 sequence',
    ],
    correctAnswer: 3,
    explanation:
      'Test result schedules must include ALL measured results: continuity of protective conductors, insulation resistance, polarity, earth fault loop impedance, and RCD test results. Recording only failures or a single overall outcome is non-compliant.',
  },
  {
    id: 4,
    question: 'When should a Minor Electrical Installation Works Certificate (MEIWC) be used?',
    options: [
      'For all electrical work regardless of scale',
      'Only for emergency fault repairs',
      "For small additions and alterations that don't affect the main characteristics of the installation",
      'For major rewiring projects involving new circuits',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'To certify the design and construction of new installations',
      'To assess the condition of existing installations and identify defects',
      'To record small additions or alterations to a circuit',
      'To provide an energy efficiency rating for the property',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Pass, Fail and Unsatisfactory ratings',
      'Red, Amber and Green priority bands',
      'Class A, Class B and Class C grades',
      'C1 (danger), C2 (potentially dangerous), C3 (improvement)',
    ],
    correctAnswer: 3,
    explanation:
      'EICR uses C1 (danger present - immediate action required), C2 (potentially dangerous - urgent remedial action required), and C3 (improvement recommended). FI (further investigation) is also used where more information is needed.',
  },
  {
    id: 7,
    ...
    options: [
      ...
      'For a fixed period of one year only',
      'For a fixed period of five years only',
      'They can be discarded once the client has a copy',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Only the final earth fault loop impedance result is acceptable',
      'Just the visual inspection findings are complete',
      'Only that the client is satisfied with the finished work',
      'That all inspection and test results are accurate and within limits',
    ],
    correctAnswer: 3,
    explanation:
      'Before signing, all inspection and test results must be verified as accurate and within the acceptable limits defined in BS 7671, ensuring complete compliance — not just a single test or the client sign-off.',
  },
  {
    id: 9,
  ...
  },
  {
    ...
    options: [
      'The test equipment calibration certificate had expired',
      'Several voltage readings had been transposed on the schedule',
      'Several circuits were not properly identified on the schedule',
      'A cable size had been miscalculated for one final circuit',
    ],
    correctAnswer: 2,
    explanation:
