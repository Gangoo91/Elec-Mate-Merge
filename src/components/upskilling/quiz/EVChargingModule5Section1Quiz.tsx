...
const quizData = [
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'CT clamps or smart meters are essential for monitoring electrical current and demand in real-time, providing the data needed for effective DLM control algorithms.',
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'CT clamps should have accuracy class 1 or better (±1% error) for effective DLM operation, allowing closer operation to maximum capacity limits whilst maintaining safety.',
  },
  {
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Well-designed DLM systems include fail-safe modes where charge points revert to reduced power operation or predetermined limits to ensure continued safe operation.',
  },
  {
    question:
      'Which advanced feature can DLM systems integrate with for optimal energy management?',
    answers: [
    ...
    correctAnswer: 0,
    explanation:
      'Advanced DLM systems can integrate with solar PV and battery storage to optimise charging from renewable generation, store excess energy, and reduce grid import during peak periods.',
  },
];
