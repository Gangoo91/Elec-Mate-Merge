...
const quizData: QuizQuestion[] = [
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'The two main RCD tests are: 1) Operation test at rated tripping current (IΔn) to verify it trips, and 2) Time test to ensure it operates within specified time limits.',
  },
  {
    id: 3,
    ...
    correctAnswer: 3,
    explanation:
      'RCD testing involves multiple test currents: ½ IΔn (should NOT trip), IΔn (should trip), and 5 × IΔn for time testing. All are used in comprehensive RCD testing.',
  },
  {
    id: 4,
    question: 'What is the maximum tripping time for a 30mA RCD at 5 × IΔn (150mA)?',
    options: ['300ms', '150ms', '40ms', '30ms'],
    correctAnswer: 2,
    explanation:
      'For general purpose RCDs, the maximum tripping time at 5 × IΔn is 40ms. This fast operation is crucial for protection against electric shock.',
  },
  {
    id: 5,
    ...
    correctAnswer: 1,
    explanation:
      'The ½ IΔn test (e.g., 15mA for a 30mA RCD) ensures the device does NOT trip at currents below its rating, preventing nuisance tripping while maintaining proper protection levels.',
  },
  {
    id: 6,
    ...
    correctAnswer: 1,
    explanation:
      'Before RCD testing, ensure downstream circuits are isolated and equipment is disconnected to prevent damage to sensitive electronic equipment and obtain accurate test results.',
  },
  {
    id: 7,
    ...
    correctAnswer: 2,
    explanation:
      'All RCD test results must be recorded, including actual tripping current and time for each test phase. This provides evidence of compliance and helps identify deteriorating performance over time.',
  },
  {
    id: 8,
    ...
    correctAnswer: 1,
    explanation:
      "If an RCD fails testing (doesn't trip at IΔn, trips at ½ IΔn, or exceeds time limits), it must be replaced or repaired before the installation can be energised safely.",
  },
  {
    id: 9,
    ...
    correctAnswer: 1,
    explanation:
      'Each phase must be tested separately to identify any faults on specific phases and ensure all phases provide equal protection. This also verifies proper RCD wiring and connection integrity.',
  },
  {
    id: 10,
    ...
    correctAnswer: 1,
    explanation:
      'In the office building example, one RCD was taking 65ms to trip at 5 × IΔn, exceeding the 40ms maximum requirement. This indicated deteriorating performance requiring replacement before energising.',
  },
];
