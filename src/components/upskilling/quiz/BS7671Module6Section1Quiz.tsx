...
const quizData: QuizQuestion[] = [
  ...
  },
  {
    ...
    options: ['BS 7430', 'BS 7671', 'BS 7909', 'BS 7375'],
    correctAnswer: 1,
    explanation:
      'BS 7671 (Requirements for Electrical Installations) mandates initial verification for all new electrical installations under Chapter 61.',
  },
  {
    id: 3,
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Initial verification must be carried out before the system is energised to ensure safety and prevent potential hazards from defective installations.',
  },
  {
    id: 5,
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'The certificate must be signed by a competent person who possesses sufficient technical knowledge, experience, and skill to avoid danger, taking full responsibility for compliance.',
  },
  {
    id: 10,
    question:
