          ...
          <div className="space-y-4">
            ...
            {percentage >= 60 && percentage < 80 && (
              <div className="bg-yellow-600/20 border border-yellow-600/30 rounded-lg p-4">
                ...
                <p className="text-sm sm:text-base text-foreground">
                  You understand the key concepts. Review the BS 7671 requirements and RCD operating
                  principles.
                </p>
              </div>
            )}
            ...
            {percentage < 60 && (
              <div className="bg-red-600/20 border border-red-600/30 rounded-lg p-4">
                ...
                <p className="text-sm sm:text-base text-foreground">
                  Review the section content focusing on RCD operation, sensitivity ratings, and
                  safety requirements.
                </p>
              </div>
            )}
          ...
          <div className="space-x-2">
            ...
            {showResult && (
              <Button
                ...
                className="bg-elec-yellow text-elec-dark hover:bg-yellow-500"
              >
                {currentQuestion < rcdFundamentalsQuizData.length - 1
                  ? 'Next Question'
                  : 'Complete Quiz'}
              </Button>
            )}
