          ...
          <div className="space-y-4">
            {percentage >= 80 && (
              <div className="bg-green-600/20 border border-green-600/30 rounded-lg p-4">
                ...
                <p className="text-gray-300 text-sm">
                  You have a strong understanding of test equipment setup procedures and safety
                  requirements.
                </p>
              </div>
            )}
            ...
            {percentage >= 60 && percentage < 80 && (
              <div className="bg-yellow-600/20 border border-yellow-600/30 rounded-lg p-4">
                ...
                <p className="text-gray-300 text-sm">
                  You understand the key concepts. Review the equipment maintenance and safety
                  procedures you missed.
                </p>
              </div>
            )}
            ...
            {percentage < 60 && (
              <div className="bg-red-600/20 border border-red-600/30 rounded-lg p-4">
                ...
                <p className="text-gray-300 text-sm">
                  Review the section content focusing on calibration requirements and safety
                  procedures.
                </p>
              </div>
            )}
          ...
          <div className="space-x-2">
            ...
            {showResult && (
              <Button
                ...
                className="bg-elec-yellow text-elec-dark hover:bg-yellow-500"
              >
                {currentQuestion < testEquipmentQuizData.length - 1
                  ? 'Next Question'
                  : 'Complete Quiz'}
              </Button>
            )}
