...
const quizData: QuizQuestion[] = [
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Control Pilot signal testing verifies proper communication between the electric vehicle and charging point, including charge state signalling and safety interlocks.',
  },
  {
    id: 6,
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'Environmental factors including temperature, humidity, and exposure conditions can affect test results and equipment safety.',
  },
  {
    id: 10,
    ...
    correctAnswer: 1,
    explanation:
      'Loop impedance testing ensures that fault current will be sufficient to operate protective devices within the required disconnection times for safety.',
  },
];
        ...
        <CardContent className="space-y-6">
          <div className="text-center space-y-4">
            ...
            <p className="text-gray-300">
              {percentage >= 80
                ? 'Excellent understanding of BS 7671 testing procedures!'
                : percentage >= 60
