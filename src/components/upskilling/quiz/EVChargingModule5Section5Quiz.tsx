...
const quizQuestions: QuizQuestion[] = [
  ...
  },
  {
    ...
    options: ['70-80%', '85-95%', '95-98%', '98-99%'],
    correctAnswer: 1,
    explanation:
      'Current wireless charging systems achieve 85-95% efficiency, slightly lower than conductive charging (95-98%) but improving with technology advances.',
  },
  {
    question: 'Which communication standard is essential for Vehicle-to-Grid (V2G) implementation?',
    options: ['CAN Bus', 'Modbus TCP', 'ISO 15118', 'MQTT'],
    correctAnswer: 2,
    explanation:
      'ISO 15118 is the key communication standard for V2G, enabling bidirectional energy flow and smart grid integration.',
  },
  {
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'Dynamic wireless charging allows continuous charging while driving, potentially reducing battery size requirements and extending vehicle range.',
  },
  {
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Machine learning enables predictive analytics for demand forecasting, optimisation of charging schedules, and real-time system adaptation.',
  },
  {
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'AI enables dynamic pricing based on demand and grid conditions, plus real-time load optimisation to maximise efficiency and reduce costs.',
  },
];
