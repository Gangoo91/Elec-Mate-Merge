    ...
    <Card className="bg-elec-gray border-transparent">
      ...
      <CardContent className="space-y-4">
        <div className="bg-[#323232] rounded-lg p-4 sm:p-6">
          <h3 className="text-foreground font-semibold mb-4 text-sm sm:text-base">
          ...
          <div className="bg-orange-600/10 border border-orange-600/20 rounded p-4 sm:p-5 mb-4 sm:mb-6">
            <p className="text-foreground leading-relaxed text-xs sm:text-sm">
              You test CPC continuity on a ring final circuit and find{' '}
              <strong>2.5 ohms resistance</strong> between the DB and a socket CPC. What should you
              do next?
            </p>
          </div>
          ...
          <div className="space-y-4 sm:space-y-6">
            <div className="bg-red-600/10 border border-red-600/20 rounded p-4 sm:p-5">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="text-red-200 font-medium mb-2 sm:mb-3 text-sm sm:text-base">
                    Assessment
                  </h4>
                  <p className="text-foreground text-xs sm:text-sm leading-relaxed">
                    That's too high! A reading of 2.5 ohms indicates a significant problem with the
                    CPC continuity. Normal readings should be well below 1 ohm for most domestic
                    circuits.
                  </p>
                </div>
              </div>
            ...
            <div className="bg-green-600/10 border border-green-600/20 rounded p-4 sm:p-5">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="text-green-200 font-medium mb-3 text-sm sm:text-base">
                    Correct Action
                  </h4>
                  ...
                  <p className="text-foreground text-xs sm:text-sm mt-3 font-medium">
                    <strong>Critical:</strong> Do not proceed with further tests until this issue is
                    resolved.
                  </p>
                </div>
              </div>
        ...
        <div className="bg-blue-600/10 border border-blue-600/20 rounded-lg p-4 sm:p-5">
          ...
          <p className="text-foreground text-xs sm:text-sm leading-relaxed">
            High CPC resistance readings are a serious safety concern. They indicate that the
            protective conductor may not be able to carry sufficient fault current to operate
            protective devices quickly enough, potentially leaving metalwork at dangerous
            potentials.
          </p>
        </div>
      </CardContent>
