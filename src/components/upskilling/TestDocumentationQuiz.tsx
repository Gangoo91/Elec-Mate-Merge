...
const questions: Question[] = [
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'False. Installing a new consumer unit is considered major work and requires an Electrical Installation Certificate (EIC), not a Minor Electrical Installation Works Certificate (MEIWC).',
  },
  {
    id: 3,
    ...
    correctAnswer: 2,
    explanation:
      'The Electrical Installation Condition Report (EICR) includes observation codes such as C1 (Danger present), C2 (Potentially dangerous), C3 (Improvement recommended), and FI (Further investigation required).',
  },
  {
    id: 4,
  ...
  },
  {
    ...
    options: ['1 year', '5 years', '7 years', 'Life of the installation'],
    correctAnswer: 3,
    explanation:
      'Installation certificates should be retained for the life of the installation as they provide essential information for future maintenance, alterations, and periodic inspections.',
  },
  {
    id: 9,
