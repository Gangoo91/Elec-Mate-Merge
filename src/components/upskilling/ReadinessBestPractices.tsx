    ...
    <Card className="bg-elec-gray border-transparent">
      ...
      <CardContent className="space-y-6">
        <p className="text-foreground leading-relaxed">
          These practices have been developed from industry experience and help ensure consistent,
          thorough readiness confirmation across all types of electrical installations.
        </p>
        ...
        <div className="bg-green-600/10 border border-green-600/20 rounded-lg p-4">
          ...
          <p className="text-foreground text-sm leading-relaxed">
            Regularly review and update your readiness confirmation procedures. Stay informed about
            new equipment types, changing regulations, and industry best practices. Consider joining
            professional bodies and attending continuing professional development courses to
            maintain competency.
          </p>
        </div>
      </CardContent>
