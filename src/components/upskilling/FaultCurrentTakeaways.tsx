  ...
  const takeaways = [
    {
      ...
      description:
        'These values represent worst-case scenarios that protective devices must handle safely',
    },
    {
      title: 'Must be tested at supply origin and DBs',
      description:
        'Test at points where protective devices are installed to verify their suitability',
    },
    {
      title: 'Values must be within MCB breaking capacity',
      description:
        'Fault current must not exceed device ratings—typically 6kA or 10kA for domestic installations',
    },
    {
      title: 'Usually performed automatically during loop testing',
      description:
        'Modern testers calculate and display prospective fault current during Zs measurements',
    },
  ];
      ...
      <CardContent>
        ...
        <div className="mt-6 bg-elec-yellow/10 p-4 rounded-md border border-elec-yellow/30">
          ...
          <p className="text-foreground">
            Never assume protective device ratings are adequate. Always verify that fault current
            levels are within device capabilities. The consequences of inadequate breaking capacity
            can be catastrophic.
          </p>
        </div>
      </CardContent>
