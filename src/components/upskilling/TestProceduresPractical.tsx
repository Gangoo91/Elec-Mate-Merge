    ...
    <Card className="bg-elec-gray border-transparent">
      ...
      <CardContent className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="space-y-3">
                <h4 className="text-elec-yellow font-medium">
                  Common Cable Resistance (mΩ/m at 20°C):
                </h4>
                <div className="bg-blue-600/10 border border-blue-600/20 rounded-lg p-3">
                  <div className="text-foreground text-sm space-y-1">
                    <p>
                      <strong>1.0mm² copper:</strong> 18.1 mΩ/m
                    </p>
                    <p>
                      <strong>1.5mm² copper:</strong> 12.1 mΩ/m
                    </p>
                    <p>
                      <strong>2.5mm² copper:</strong> 7.3 mΩ/m
                    </p>
                    <p>
                      <strong>4.0mm² copper:</strong> 4.6 mΩ/m
                    </p>
                    <p>
                      <strong>6.0mm² copper:</strong> 3.1 mΩ/m
                    </p>
                    <p>
                      <strong>10mm² copper:</strong> 1.8 mΩ/m
                    </p>
                  </div>
                </div>
              </div>
              <div className="space-y-3">
                ...
                <div className="bg-green-600/10 border border-green-600/20 rounded-lg p-3">
                  <div className="text-foreground text-sm space-y-1">
                    <p>
                      <strong>2.5mm² CPC, 20m:</strong> ~0.15Ω
                    </p>
                    <p>
                      <strong>1.5mm² CPC, 30m:</strong> ~0.36Ω
                    </p>
                    <p>
                      <strong>4.0mm² CPC, 40m:</strong> ~0.18Ω
                    </p>
                    <p>
                      <strong>Bonding 6mm², 5m:</strong> ~0.015Ω
                    </p>
                    <p>
                      <strong>Main bonding 16mm², 10m:</strong> ~0.011Ω
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <ol className="text-foreground text-sm space-y-2 list-decimal list-inside">
                    <li>
                      <strong>Identify cable specifications:</strong> Cross-sectional area, material
                      (copper/aluminium), cable type
                    </li>
                    <li>
                      <strong>Measure circuit length:</strong> Use building plans or physical
                      measurement for accuracy
                    </li>
                    <li>
                      <strong>Find conductor resistance:</strong> From BS 7671 Appendix 4 tables or
                      manufacturer data
                    </li>
                    <li>
                      <strong>Calculate basic resistance:</strong> Resistance per metre × circuit
                      length
                    </li>
                    <li>
                      <strong>Add connection allowances:</strong> Typically 5-10% for terminations
                      and joints
                    </li>
                    <li>
                      <strong>Consider temperature effects:</strong> Adjust for testing temperature
                      if significantly different from 20°C
                    </li>
                  </ol>
                </div>
              </div>
        ...
        <div className="bg-[#323232] rounded-lg p-6">
          ...
          <div className="space-y-4">
            <p className="text-foreground">Ensure test equipment accuracy for reliable results:</p>
