        ...
        <div className="space-y-3 sm:space-y-4">
          ...
          <div className="bg-[#323232] rounded-lg p-3 sm:p-4 space-y-3">
            <p className="text-foreground leading-relaxed text-sm sm:text-base">
              Prospective fault currents represent the{' '}
              <strong>maximum current that would flow</strong> under different fault conditions.
              These values are critical for ensuring protective devices can safely interrupt fault
              currents without damage to the electrical system.
            </p>
            <div className="bg-blue-600/10 border border-blue-600/20 rounded p-3">
              <p className="text-foreground text-xs sm:text-sm">
                <strong>Why measure PFC?</strong> Every protective device has a maximum breaking
                capacity. If fault current exceeds this capacity, the device may fail
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="space-y-3">
                <p className="text-foreground leading-relaxed">
                  PSC represents the maximum current that would flow in a{' '}
                  <strong>line-to-neutral fault</strong>
                  (short circuit). This occurs when the line conductor comes into direct contact
                  with the neutral conductor, creating a very low impedance path.
                </p>
                ...
                <div className="bg-orange-600/10 border border-orange-600/20 rounded p-3">
                  <div className="flex items-start gap-2">
                    ...
                    <p className="text-foreground text-sm">
                      <strong>Important:</strong> PSC occurs when there's a direct connection
                      between live and neutral, bypassing all loads. This creates maximum current
                      flow limited only by the impedance of the supply and cables.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-[#323232] rounded-lg p-4 space-y-4">
            <div className="flex items-start gap-3">
              ...
              <div className="space-y-3">
                <p className="text-foreground leading-relaxed">
                  PEFC represents the maximum current that would flow in a{' '}
                  <strong>line-to-earth fault</strong>. This occurs when the line conductor comes
                  into contact with exposed metalwork, the protective conductor, or other earthed
                  parts.
                </p>
                ...
                <div className="bg-blue-600/10 border border-blue-600/20 rounded p-3">
                  <p className="text-foreground text-sm">
                    <strong>Remember:</strong> PEFC is inversely related to Zs. Lower Zs means
                    higher PEFC, which is generally good for protective device operation but must
                    not exceed device breaking capacity.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-4">
            <div className="bg-[#323232] rounded-lg p-4">
              ...
              <div className="space-y-3">
                ...
                <div className="bg-yellow-600/10 border border-yellow-600/20 rounded p-3">
                  <p className="text-foreground text-sm">
                    <strong>Note:</strong> Most modern MFTs measure PSC and PEFC automatically
                    during loop impedance testing, displaying both Zs and the corresponding fault
                    currents.
                  </p>
                </div>
              </div>
              ...
              <ol className="space-y-3">
                <li className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-foreground text-sm">
                      Connect between line and neutral at the test point
                    </p>
                  </div>
                </li>
                <li className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-foreground text-sm">
                      Connect between line and earth at the test point
                    </p>
                  </div>
                </li>
                <li className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-foreground text-sm">
                      Results usually displayed alongside Zs measurement
                    </p>
                  </div>
                </li>
                <li className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-foreground text-sm">
                      Document values and compare to device breaking capacity
                    </p>
                  </div>
                </li>
              </ol>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-[#323232] rounded-lg p-4 space-y-4">
            <p className="text-foreground leading-relaxed">
              ...
              <strong> do not exceed the breaking capacity</strong> of the protective devices
              installed.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="bg-green-600/10 border border-green-600/20 rounded p-4">
                ...
                <ul className="text-foreground text-sm space-y-1">
                  <li>
                    <strong>BS88 Fuses:</strong> Very high breaking capacity (up to 120kA)
                  </li>
                  <li>
                    <strong>RCBOs:</strong> Same as equivalent MCB rating
                  </li>
                  <li>
                    <strong>Main Switches:</strong> Must handle supply PFC
                  </li>
                  <li>
                    <strong>Contactors:</strong> Check AC-3 or AC-1 ratings
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="bg-[#323232] rounded-lg p-4 space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-blue-600/10 border border-blue-600/20 rounded p-4">
                ...
                <p className="text-foreground text-sm">Where U = 230V (line-neutral voltage)</p>
              </div>
              ...
              <div className="bg-green-600/10 border border-green-600/20 rounded p-4">
                ...
                <p className="text-foreground text-sm">Where U₀ = 230V (line-earth voltage)</p>
              </div>
            </div>

            <div className="bg-yellow-600/10 border border-yellow-600/20 rounded p-3">
              <p className="text-foreground text-sm">
                <strong>Note:</strong> Modern testers perform these calculations automatically based
                on measured impedances, but understanding the relationship helps interpret results.
              </p>
            </div>
          </div>
        </div>
