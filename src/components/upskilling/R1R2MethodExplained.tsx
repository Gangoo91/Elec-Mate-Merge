      ...
      <CardContent className="space-y-6">
        ...
        <div className="bg-[#323232] rounded-lg p-6">
          ...
          <p className="text-foreground">
            ...
            which is essential for calculating earth fault loop impedance (Zs). This measurement
            forms a critical part of electrical safety verification.
          </p>
          ...
          <div className="bg-yellow-600/10 border border-yellow-600/20 rounded-lg p-4">
            ...
            <p className="text-foreground text-sm">
              <strong>R1 =</strong> Resistance of the line conductor from origin to the point of
              measurement
              <br />
              <strong>R2 =</strong> Resistance of the CPC from origin to the same point
              <br />
        ...
        <div className="bg-[#323232] rounded-lg p-6">
          ...
          <div className="space-y-4">
            <p className="text-foreground">
              This value helps determine if protective devices will operate within required time
              limits during an earth fault condition, ensuring safety.
            </p>
          ...
          <div className="space-y-4">
            <div className="bg-purple-600/10 border border-purple-600/20 rounded-lg p-4">
              ...
              <ol className="text-foreground text-sm space-y-2 list-decimal list-inside">
                <li>
                  <strong>Isolate the circuit completely</strong> and ensure all loads are
                  disconnected
                </li>
                <li>
                  <strong>At the distribution board:</strong> Connect line conductor to CPC of the
                  same circuit
                </li>
                <li>
                  <strong>At each outlet:</strong> Measure resistance between line and CPC terminals
                </li>
                <li>
                  <strong>Record all readings</strong> systematically for each point on the circuit
                </li>
                <li>
                  <strong>Analyse results</strong> for consistency and compliance with expected
                  values
                </li>
                <li>
                  <strong>Compare with design calculations</strong> and previous test results if
                  available
                </li>
              </ol>
            </div>
        ...
        <div className="bg-[#323232] rounded-lg p-6">
          ...
          <div className="space-y-4">
            <p className="text-foreground">
              Readings should be consistent across all outlets. Significant variations indicate
              wiring faults that must be investigated and corrected.
            </p>
          ...
          <div className="space-y-4">
            <div className="bg-blue-600/10 border border-blue-600/20 rounded-lg p-4">
              ...
              <div className="text-foreground text-sm space-y-2">
                <p>
                  <strong>Circuit:</strong> 32A ring final, 2.5mm² + 1.5mm² CPC, 40m total ring
                  length
                </p>
                <p>
                  <strong>Expected R1:</strong> 40m × 7.3mΩ/m = 0.29Ω (for complete ring)
                </p>
                <p>
                  <strong>Expected R2:</strong> 40m × 12.1mΩ/m = 0.48Ω (for complete ring)
                </p>
                <p>
                  <strong>R1 + R2 at furthest point:</strong> Approximately 0.19Ω (quarter of ring
                  resistance)
                </p>
              </div>
            </div>
            ...
            <div className="bg-green-600/10 border border-green-600/20 rounded-lg p-4">
              ...
              <div className="text-foreground text-sm space-y-2">
                <p>
                  <strong>Circuit:</strong> 20A radial, 2.5mm² + 1.5mm² CPC, 25m length
                </p>
                <p>
                  <strong>R1:</strong> 25m × 7.3mΩ/m = 0.18Ω
                </p>
                <p>
                  <strong>R2:</strong> 25m × 12.1mΩ/m = 0.30Ω
                </p>
                <p>
                  <strong>R1 + R2:</strong> 0.18Ω + 0.30Ω = 0.48Ω
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-[#323232] rounded-lg p-6">
          ...
          <div className="space-y-4">
            <p className="text-foreground">
              The R1 + R2 values are used in the earth fault loop impedance calculation:{' '}
