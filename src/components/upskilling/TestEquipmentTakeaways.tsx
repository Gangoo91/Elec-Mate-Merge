  ...
  const takeaways = [
    {
      ...
      description:
        'Check calibration dates, lead condition, and test functionality on known sources',
    },
    {
      title: 'Follow safe test methods and wear PPE where needed',
      description:
        'Use appropriate personal protective equipment and maintain safe working practices',
    },
    {
      ...
      <CardContent>
        ...
        <div className="mt-6 bg-elec-yellow/10 p-4 rounded-md border border-elec-yellow/30">
          ...
          <p className="text-foreground text-sm sm:text-base leading-relaxed">
            Your safety depends on using proper test equipment correctly. Never take shortcuts with
            safety equipment or procedures—no test result is worth risking your life.
          </p>
        </div>
      </CardContent>
    </Card>
