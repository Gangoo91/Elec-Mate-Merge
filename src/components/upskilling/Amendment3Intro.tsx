    ...
    <Card className="bg-elec-gray border-transparent">
      ...
      <CardContent className="space-y-4">
        <p className="text-gray-300 text-lg leading-relaxed">
          Amendment 3 to BS 7671, effective from 31st July 2024, introduces critical requirements
          for bidirectional protection in electrical installations, particularly focusing on
          renewable energy systems and grid interaction safety.
        </p>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-300 text-sm">
                <li>
                  • <strong>Bidirectional Protection:</strong> Devices capable of isolating reverse
                  current flows
                </li>
                <li>
                  • <strong>Consumer Unit Enhancements:</strong> Requirements for renewable energy
                  integration
                </li>
                <li>
                  • <strong>Grid Interaction Safety:</strong> Protection against back-feed and
                  islanding conditions
                </li>
                <li>
                  • <strong>Testing Procedures:</strong> Updated commissioning and verification
                  methods
                </li>
              </ul>
            </div>
