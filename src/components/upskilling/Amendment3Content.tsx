  ...
  return (
    <div className="space-y-6">
      <Card className="bg-elec-gray border-transparent">
        ...
        <CardContent className="space-y-4">
          <p className="text-gray-300 mb-4">
            ...
            generate power that flows back into the supply system.
          </p>
                ...
                <div className="flex items-start gap-3 mb-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-blue-400 text-sm">
                      <strong>Solution:</strong> {req.device}
                    </p>
                  </div>
                </div>
              </div>
      ...
      <Card className="bg-elec-gray border-transparent">
        ...
        <CardContent className="space-y-4">
          <p className="text-gray-300 mb-4">
            Amendment 3 introduces specific testing requirements to verify bidirectional protection
            effectiveness and grid interaction safety.
          </p>
          <div className="space-y-4">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-gray-300 text-sm leading-relaxed">
                  ...
                  conditions, equipment damage, fire risks, and potential liability issues.
                  Insurance coverage may be affected for non-compliant installations.
                </p>
              </div>
            </div>
          </div>
