    ...
    <Card className="bg-elec-gray border-elec-gray">
      ...
      <CardContent className="text-elec-light space-y-4">
        <p>
          ...
          designed specifically to illuminate escape routes and exits to ensure safe evacuation
          during power failures or emergency situations.
        </p>
        <p>
          ...
          Understanding the proper application of escape lighting is fundamental to BS 5266
        ...
        <div className="bg-elec-yellow/10 border border-elec-yellow/30 rounded-lg p-4 mt-4">
          <p className="text-elec-yellow font-medium">
            <strong>Key Focus:</strong> This section covers the technical requirements, placement
            criteria, and design considerations for emergency escape lighting systems in various
            building types.
          </p>
        </div>
      </CardContent>
