    ...
    <Card className="bg-gradient-to-br from-green-600/20 to-green-800/10 border border-green-500/40 shadow-lg">
      ...
      <CardContent className="text-gray-300 space-y-4">
        <p className="text-green-200">
          This section covered the various types of emergency lighting systems available and their
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2 text-sm">
              <div className="flex items-start gap-2">
                ...
                <span>
                  <strong>Central Battery:</strong> Best for large installations, offering
                  centralised maintenance and longer battery life
                </span>
              </div>
              <div className="flex items-start gap-2">
                <ArrowRight className="h-3 w-3 text-green-400 mt-1 flex-shrink-0" />
                <span>
                  <strong>Self-Contained:</strong> Suitable for smaller installations with lower
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2 text-sm">
              <div className="flex items-start gap-2">
                <ArrowRight className="h-3 w-3 text-green-400 mt-1 flex-shrink-0" />
                <span>
                  <strong>Non-Maintained:</strong> Most common type, operating only during mains
                  failure
                </span>
              </div>
              <div className="flex items-start gap-2">
                <ArrowRight className="h-3 w-3 text-green-400 mt-1 flex-shrink-0" />
                <span>
                  <strong>Maintained:</strong> Continuous operation, required in entertainment
                  venues
                </span>
              </div>
            </div>
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2 text-sm">
              <div className="flex items-start gap-2">
                <ArrowRight className="h-3 w-3 text-green-400 mt-1 flex-shrink-0" />
                <span>
                  <strong>Lithium Iron Phosphate:</strong> Longest life (10-20 years),
              ...
              <div className="flex items-start gap-2">
                <ArrowRight className="h-3 w-3 text-green-400 mt-1 flex-shrink-0" />
                <span>
                  <strong>Nickel Cadmium:</strong> Reliable with good temperature range but toxic
                  materials
                </span>
              </div>
              <div className="flex items-start gap-2">
                <ArrowRight className="h-3 w-3 text-green-400 mt-1 flex-shrink-0" />
                <span>
                  <strong>Lead Acid:</strong> Lower initial cost but shorter life and higher
                  maintenance
                </span>
              </div>
            </div>
        ...
        <div className="mt-6 p-4 bg-green-500/10 border border-green-500/40 rounded-lg">
          ...
          <p className="text-sm">
            Understanding system types enables appropriate selection for specific applications. The
            next section will cover BS 5266 and related standards that govern the design,
