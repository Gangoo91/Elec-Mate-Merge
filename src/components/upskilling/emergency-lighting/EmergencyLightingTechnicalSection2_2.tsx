  ...
  const technicalSpecs = [
    {
      ...
      formula:
        'Average illuminance = (Σ Luminaire lumens × Utilisation factor × Maintenance factor) / Area',
    },
    {
      ...
      formula:
        'Battery capacity (Ah) = (Load current × Duration hours) / (Discharge factor × Temperature factor)',
    },
    {
      ...
      formula:
        'Light loss factor = Lamp lumen depreciation × Luminaire maintenance factor × Room surface depreciation',
    },
    {
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {technicalSpecs.map((spec, index) => (
          <Card
            key={index}
            className="bg-slate-200/20 border-elec-yellow/20 hover:border-elec-yellow/40 transition-all duration-300"
          >
            <CardHeader className="pb-4">
              <div className="flex items-center gap-3 mb-2">
                ...
                <Badge
                  variant="outline"
                  className="bg-elec-yellow/10 border-elec-yellow/30 text-elec-yellow font-semibold"
                >
                  Technical
                </Badge>
              </div>
              <CardTitle className="text-foreground text-lg">{spec.title}</CardTitle>
            </CardHeader>
