      ...
      <CardContent className="text-foreground space-y-8">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3 ml-4">
            <div className="bg-gray-800/50 rounded-lg p-3 border border-gray-600">
              <strong className="text-elec-yellow">Daily (visual check):</strong> Ensure central
              battery systems (if fitted) show no fault indicators.
            </div>
            <div className="bg-gray-800/50 rounded-lg p-3 border border-gray-600">
              <strong className="text-elec-yellow">Monthly (functional test):</strong> Simulate a
              mains failure and check each luminaire operates from the emergency supply.
            </div>
            <div className="bg-gray-800/50 rounded-lg p-3 border border-gray-600">
              <strong className="text-elec-yellow">Annual (full-duration test):</strong> Simulate a
              mains failure for the full rated period (usually 3 hours) to confirm battery capacity.
            </div>
          </div>

          <div className="bg-gradient-to-r from-green-500/10 to-teal-500/10 border border-green-500/20 rounded-lg p-4">
            <p className="text-foreground">
              ✅ <strong>Quick Check:</strong> How long must the annual full-duration test run for
              in most buildings?
            </p>
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <ul className="space-y-2 ml-4">
            <li>
              • Testing may be carried out by trained staff or contractors, but the duty holder
              (building owner, employer, or responsible person) is legally accountable
            </li>
          ...
          <div className="bg-gradient-to-r from-green-500/10 to-teal-500/10 border border-green-500/20 rounded-lg p-4">
            <p className="text-foreground">
              ✅ <strong>Quick Check:</strong> Who holds ultimate responsibility for ensuring tests
              are carried out?
            </p>
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <p className="mb-4">
            All testing and maintenance must be recorded in an emergency lighting logbook, which
            should be kept on-site for inspection. Each entry should include:
          </p>
          ...
          <div className="bg-gradient-to-r from-green-500/10 to-teal-500/10 border border-green-500/20 rounded-lg p-4">
            <p className="text-foreground">
              ✅ <strong>Quick Check:</strong> What five details must be recorded in the emergency
              lighting logbook?
            </p>
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <ul className="space-y-2 ml-4">
            <li>
              • Local authorities, insurers, and the fire service may request to see test records
              during inspections
            </li>
            ...
            <li>
              • Non-compliance may lead to fines or prosecution under the Fire Safety Order 2005
            </li>
          </ul>
