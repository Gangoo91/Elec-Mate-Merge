  ...
  return (
    <Card className="bg-gradient-to-br from-elec-gray to-[#1a1a1a] border border-gray-600 shadow-lg">
      ...
      <CardContent className="text-gray-300 space-y-4">
        <p>
          Emergency lighting systems come in various configurations, each designed for specific
          applications and building requirements. Understanding these different types is essential
          for selecting the most appropriate system for your installation.
        </p>
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div className="p-4 bg-gradient-to-br from-green-600/20 to-green-800/10 border border-green-500/40 rounded-lg shadow-md">
            ...
            <p className="text-gray-300 text-sm">
              Central battery systems vs self-contained units, each offering distinct advantages for
          ...
          <div className="p-4 bg-gradient-to-br from-purple-600/20 to-purple-800/10 border border-purple-500/40 rounded-lg shadow-md">
            ...
            <p className="text-gray-300 text-sm">
              Maintained, non-maintained, and sustained systems with different activation and
