      ...
      <CardContent className="text-foreground space-y-4">
        <div className="grid md:grid-cols-2 gap-4">
          <div className="space-y-4">
            ...
            <div className="p-4 bg-gradient-to-br from-purple-600/20 to-purple-800/10 border border-purple-500/40 rounded-lg">
              ...
              <ul className="text-foreground text-sm space-y-1">
                <li>
                  • In warehouses, check that luminaires are not obstructed by shelving or gantries
                </li>
          ...
          <div className="space-y-4">
            <div className="p-4 bg-gradient-to-br from-teal-600/20 to-teal-800/10 border border-teal-500/40 rounded-lg">
              ...
              <ul className="text-foreground text-sm space-y-1">
                <li>
                  • Remember that battery backup output may be lower than mains output — confirm
                  emergency mode performance
                </li>
                <li>
                  • Consider maintenance access — fittings mounted too high can increase costs of
            ...
            <div className="p-4 bg-gradient-to-br from-orange-600/20 to-orange-800/10 border border-orange-500/40 rounded-lg">
              ...
              <ul className="text-foreground text-sm space-y-1">
                <li>
                  • Document spacing and mounting heights on the lighting layout drawings for
                  verification
                </li>
        ...
        <div className="bg-amber-600/20 border border-amber-500/40 rounded-lg p-4">
          ...
          <p className="text-foreground text-sm">
            Always verify photometric performance during commissioning testing. Even correctly
            installed systems can fail to meet requirements due to unforeseen obstructions, surface
            finishes, or component variations. Early detection prevents costly remedial work.
          </p>
        </div>
      </CardContent>
    </Card>
