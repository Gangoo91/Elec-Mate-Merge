          ...
          <div className="flex items-start gap-3 mb-3">
            ...
            <div>
              <h4 className="font-semibold text-red-300 mb-2">
                Case Study: Liverpool Shopping Centre
              </h4>
              <p className="text-foreground mb-3">
                A shopping centre in Liverpool failed a fire safety audit because their emergency
                lighting logbook was incomplete. While most luminaires were operational, there was
                no written evidence of annual duration tests.
              </p>
