    ...
    <Card className="bg-slate-800/50 border-slate-600">
      ...
      <CardContent className="space-y-4">
        <p className="text-foreground leading-relaxed">
          ...
          Even a perfectly functioning system can fail an inspection if the required documentation
          is missing, incomplete, or inconsistent.
        </p>
        <p className="text-foreground leading-relaxed">
          The Regulatory Reform (Fire Safety) Order 2005 (RRO) and BS 5266-1 both require that
          accurate records, certificates, and test results are maintained and available to Fire and
          Rescue Authorities at any time.
        </p>
        <p className="text-foreground leading-relaxed">
          For electricians, building managers, and contractors, maintaining a complete and traceable
          record of all design, installation, and maintenance activity is essential for
          demonstrating compliance and protecting against legal and insurance liability.
        </p>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-foreground text-sm leading-relaxed">
                Without a complete paper trail, compliance cannot be demonstrated—regardless of
                system performance. Documentation serves as legal evidence that proves your
                emergency lighting system meets all regulatory requirements.
              </p>
            </div>
          </div>
        </div>
