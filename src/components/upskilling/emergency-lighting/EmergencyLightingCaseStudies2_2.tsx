  ...
  const caseStudies = [
    {
      ...
      challenge:
        'Complex layout with multiple levels, food stalls creating obstructions, and high occupancy density during peak hours. Original design created dark zones between seating areas.',
      solution:
        'Implemented distributed LED emergency luminaires at 8m centres with additional units around seating clusters. Added low-level wayfinding strips and integrated with fire alarm for instant activation.',
      results: [
    ...
    },
    {
      ...
      challenge:
        '24-hour operation with varying occupancy levels. High shelving units created corridors and blind spots. Students often work with headphones, reducing audio alarm effectiveness.',
      solution:
        'Zoned emergency lighting with occupancy sensors for energy efficiency. Combination of ceiling-mounted and shelf-integrated luminaires. Added visual strobe alerts synchronized with emergency lighting activation.',
      results: [
    ...
    },
    {
      ...
      challenge:
        'Critical 24/7 operation with vulnerable occupants including wheelchair users and patients on trolleys. Infection control requirements limiting fixture types. Multiple power supplies needed for redundancy.',
      solution:
        'Dual-supply emergency lighting with automatic changeover. IP65-rated luminaires for easy cleaning. Lower mounting height (2.8m) for better illumination of mobility aids. Integrated with hospital UPS system.',
      results: [
