      ...
      <CardContent className="text-foreground space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="bg-blue-900/20 border border-blue-600/30 rounded-lg p-4">
            ...
            <p className="text-sm">
              Always use manufacturer data for battery efficiency and expected life cycle. Generic
              calculations may not account for specific battery chemistry characteristics.
            </p>
          </div>
          ...
          <div className="bg-blue-900/20 border border-blue-600/30 rounded-lg p-4">
            ...
            <p className="text-sm">
              For LED luminaires, check emergency driver consumption—not just lamp wattage. Driver
              losses can add 10-20% to total load.
            </p>
          </div>
          ...
          <div className="bg-blue-900/20 border border-blue-600/30 rounded-lg p-4">
            ...
            <p className="text-sm">
              Select NiCd, NiMH, or Lithium-ion depending on environment, size, and maintenance
              requirements. Each has different characteristics for temperature tolerance and cycle
              life.
            </p>
          </div>
          ...
          <div className="bg-blue-900/20 border border-blue-600/30 rounded-lg p-4">
            ...
            <p className="text-sm">
              Ensure adequate ventilation and cooling in central battery rooms. High temperatures
              accelerate battery degradation and reduce capacity.
            </p>
          </div>
          ...
          <div className="bg-blue-900/20 border border-blue-600/30 rounded-lg p-4 md:col-span-2">
            ...
            <p className="text-sm">
              Test batteries regularly—even correctly sized batteries degrade with time. BS 5266-1
              requires monthly and annual duration tests to verify performance.
            </p>
          </div>
        </div>
        ...
        <div className="bg-elec-yellow/10 border border-elec-yellow/30 rounded-lg p-4">
          <p className="text-elec-yellow font-medium">
            <strong>Professional Tip:</strong> Always over-specify battery capacity slightly rather
            than under-sizing. The additional cost is minimal compared to the risk of system failure
            during an emergency.
          </p>
        </div>
      </CardContent>
