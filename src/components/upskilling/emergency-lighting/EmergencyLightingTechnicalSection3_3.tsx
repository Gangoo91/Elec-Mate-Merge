    ...
    <Card className="bg-slate-200/20 border-slate-600">
      ...
      <CardContent className="text-foreground space-y-8">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-4">
            <p>
              Mounting height directly impacts how light is distributed across the escape route or
              open area.
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="p-4 bg-gradient-to-br from-purple-600/20 to-purple-800/10 border border-purple-500/40 rounded-lg">
                ...
                <ul className="text-foreground text-sm space-y-1">
                  <li>
                    • Higher ceilings spread light over wider areas but reduce intensity at floor
                    level
                  </li>
            ...
            <div className="bg-amber-600/20 border border-amber-500/40 rounded-lg p-4">
              ...
              <p className="text-foreground text-sm">
                Always follow manufacturer's recommended mounting heights for each luminaire type.
                Each fitting is designed for a specific height range.
              </p>
            </div>
              ...
              {openChecks.includes(0) && (
                <div className="mt-3 p-3 bg-green-900/20 border border-green-600/30 rounded">
                  <p className="text-green-300">
                    <strong>Answer:</strong> Light intensity at floor level may be insufficient to
                    meet the required lux levels, leaving dark patches along escape routes.
                  </p>
                </div>
              )}
            </div>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-4">
            <p>
              Manufacturers provide photometric data showing how light is distributed from a
              luminaire. Key information includes:
            </p>
            ...
            <div className="grid gap-4">
              <div className="p-4 bg-gradient-to-br from-teal-600/20 to-teal-800/10 border border-teal-500/40 rounded-lg">
                ...
                <p className="text-foreground text-sm mb-2">
                  Show beam spread and intensity distribution in all directions around the
                  luminaire.
                </p>
                <ul className="text-foreground text-sm space-y-1">
              ...
              <div className="p-4 bg-gradient-to-br from-cyan-600/20 to-cyan-800/10 border border-cyan-500/40 rounded-lg">
                ...
                <p className="text-foreground text-sm mb-2">
                  Indicate maximum spacing between luminaires to achieve required lux levels.
                </p>
                <ul className="text-foreground text-sm space-y-1">
              ...
              <div className="p-4 bg-gradient-to-br from-blue-600/20 to-blue-800/10 border border-blue-500/40 rounded-lg">
                ...
                <p className="text-foreground text-sm mb-2">
                  Help estimate how much light reaches the working plane.
                </p>
                <ul className="text-foreground text-sm space-y-1">
            ...
            <div className="bg-elec-gray border border-gray-600 rounded-lg p-4">
              ...
              {openChecks.includes(1) && (
                <div className="mt-3 p-3 bg-green-900/20 border border-green-600/30 rounded">
                  <p className="text-green-300">
                    <strong>Answer:</strong> A polar curve diagram shows the beam spread and light
                    intensity distribution in all directions around a luminaire, helping designers
                    understand how light will be distributed at different angles.
                  </p>
                </div>
              )}
            </div>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-4">
            <p>
              When selecting and placing luminaires, electricians must consider several key factors:
            </p>
            ...
            <div className="bg-elec-gray border border-gray-600 rounded-lg p-4">
              ...
              >
                ✅ Quick Check: Why is luminaire spacing different in a wide open area compared to a
                corridor?
              </Button>
              {openChecks.includes(2) && (
                <div className="mt-3 p-3 bg-green-900/20 border border-green-600/30 rounded">
                  <p className="text-green-300">
                    <strong>Answer:</strong> Open areas require wider beam angles and different
                    spacing to provide uniform coverage across the larger space, while corridors
                    benefit from narrower beams that efficiently light the linear path without
                    waste.
                  </p>
                </div>
              )}
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-4">
            <p>
              Correct use of photometric data ensures systems are compliant without overspending on
            ...
            <div className="bg-elec-gray border border-gray-600 rounded-lg p-4">
              ...
              >
                ✅ Quick Check: Why is it important to document luminaire mounting heights on design
                drawings?
              </Button>
              {openChecks.includes(3) && (
                <div className="mt-3 p-3 bg-green-900/20 border border-green-600/30 rounded">
                  <p className="text-green-300">
                    <strong>Answer:</strong> Documentation ensures installers mount fittings at the
                    correct heights for optimal performance, enables inspectors to verify
                    compliance, and provides a reference for future maintenance and modifications.
                  </p>
                </div>
              )}
            </div>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-4">
            <p>
              Modern emergency lighting design requires understanding of advanced photometric
              concepts for complex installations.
            </p>
            ...
            <div className="bg-elec-gray border border-gray-600 rounded-lg p-4">
              ...
              >
                ✅ Quick Check: What factors affect the maintenance factor in emergency lighting
                calculations?
              </Button>
              {openChecks.includes(4) && (
                <div className="mt-3 p-3 bg-green-900/20 border border-green-600/30 rounded">
                  <p className="text-green-300">
                    <strong>Answer:</strong> LED light output degradation over time, dust
                    accumulation on luminaire surfaces, deterioration of room surface reflectances,
                    and battery capacity degradation all affect the maintenance factor.
                  </p>
                </div>
              )}
            </div>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-4">
            <p>
              Optimising installation height balances coverage, intensity, and practical
            ...
            <div className="bg-red-900/20 border border-red-600/30 p-4 rounded-lg">
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="text-foreground text-sm">
                    Never compromise on mounting height to save installation time. Incorrect heights
                    can create dangerous dark spots during emergencies.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-elec-gray border border-gray-600 rounded-lg p-4">
              ...
              >
                ✅ Quick Check: What should be the primary consideration when determining luminaire
                mounting height?
              </Button>
              {openChecks.includes(5) && (
                <div className="mt-3 p-3 bg-green-900/20 border border-green-600/30 rounded">
                  <p className="text-green-300">
                    <strong>Answer:</strong> The primary consideration should be achieving the
                    required illumination levels at floor level according to manufacturer's
                    photometric data, not installation convenience or cost-saving.
                  </p>
                </div>
              )}
            </div>
