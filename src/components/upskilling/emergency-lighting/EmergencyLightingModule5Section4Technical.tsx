        ...
        <div>
          ...
          <div className="ml-0 sm:ml-11 space-y-4">
            ...
            <div className="bg-gray-800 p-4 rounded-md border-l-4 border-green-500">
              <p className="font-semibold text-green-400 mb-3 text-sm sm:text-base">
            ...
            <div className="bg-gray-800 p-4 rounded-md border border-gray-600">
              <p className="font-semibold text-elec-yellow mb-3 text-sm sm:text-base">
                Requirements:
              </p>
            ...
            <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-md">
              <p className="font-semibold text-amber-400 mb-2 text-sm sm:text-base">
                💡 Professional Tip:
              </p>
              <p className="text-foreground text-sm sm:text-base lg:text-lg">
                Use engraved or industrial label printers rather than handwritten stickers.
                Handwritten labels fade, peel, and are unacceptable to fire inspectors.
              </p>
            </div>
        ...
        <div>
          ...
          <div className="ml-0 sm:ml-11 space-y-4">
            ...
            <div className="bg-gray-800 p-4 rounded-md border-l-4 border-blue-500">
              <p className="font-semibold text-blue-400 mb-3 text-sm sm:text-base">
                Component Labelling Standards
              </p>
              <p className="text-foreground text-sm sm:text-base lg:text-lg">
              ...
              <div className="bg-gray-800 p-4 rounded-md border border-gray-600">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-blue-400 mb-2 text-sm sm:text-base lg:text-lg">
                      Luminaires
                    </p>
                    <p className="text-foreground text-sm sm:text-base lg:text-lg">
            ...
            <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-md">
              <p className="font-semibold text-blue-400 mb-2 text-sm sm:text-base">
                💡 Professional Tip:
              </p>
              <p className="text-foreground text-sm sm:text-base lg:text-lg">
        ...
        <div>
          ...
          <div className="ml-0 sm:ml-11 space-y-4">
            ...
            <div className="bg-gray-800 p-4 rounded-md border-l-4 border-purple-500">
              <p className="font-semibold text-purple-400 mb-3 text-sm sm:text-base">
            ...
            <div className="bg-gray-800 p-4 rounded-md border border-gray-600">
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-foreground text-sm sm:text-base lg:text-lg">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-foreground text-sm sm:text-base lg:text-lg">
                      Repairs or remedial work carried out
                    </p>
                    <p className="text-foreground text-sm sm:text-base">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-foreground text-sm sm:text-base lg:text-lg">
                      Battery replacements and luminaire upgrades
                    </p>
                    <p className="text-foreground text-sm sm:text-base">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-foreground text-sm sm:text-base lg:text-lg">
                      Evidence of commissioning and certification
                    </p>
                    <p className="text-foreground text-sm sm:text-base">
            ...
            <div className="bg-gray-800 p-4 rounded-md border border-gray-600">
              <p className="font-semibold text-foreground mb-2 text-sm sm:text-base lg:text-lg">
        ...
        <div>
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-xl font-semibold text-foreground">
              Legal and Regulatory Role of Records
            </h3>
          </div>
          ...
          <div className="ml-0 sm:ml-11 space-y-4">
            ...
            <div className="bg-gray-800 p-4 rounded-md border-l-4 border-red-500">
              <p className="font-semibold text-red-400 mb-3 text-sm sm:text-base">
                Legal Framework
              </p>
              <p className="text-foreground text-sm sm:text-base lg:text-lg">
                Fire inspectors and insurers may request records at any time. Missing or incomplete
            ...
            <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-md">
              ...
              <ul className="space-y-2 text-foreground text-sm sm:text-base lg:text-lg">
                ...
                <li className="flex items-start gap-2">
                  <span className="text-red-400 mt-1 font-bold">⚠</span>
                  <span>
                    Criminal prosecution, unlimited fines, and up to 2 years' imprisonment
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-red-400 mt-1 font-bold">⚠</span>
                  <span>
                    Increased civil liability in the event of fire-related injury or death
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-gray-800 p-4 rounded-md border border-gray-600">
              ...
              <p className="text-foreground text-sm sm:text-base">
                The building's Responsible Person under the Fire Safety Order (usually the building
                owner, employer, or facilities manager) has legal accountability for maintaining
                life-safety systems and ensuring records are complete and accurate. While routine
                testing can be delegated to competent staff or contractors, the Responsible Person
                retains ultimate legal responsibility.
              </p>
            </div>
            ...
            <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-md">
              ...
              <p className="text-foreground text-sm sm:text-base lg:text-lg">
                Never hand over an emergency lighting installation without complete labelling and
                documentation. Educate clients on their legal responsibilities and ensure they
                understand the importance of ongoing record-keeping.
              </p>
            </div>
