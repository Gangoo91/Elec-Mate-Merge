        ...
        <div className="space-y-4">
          ...
          <div className="bg-gray-800 rounded-lg p-4 border-l-4 border-green-500">
            ...
            <p className="text-foreground text-sm sm:text-base">
              Formal certification provides written proof that the system meets all design and
              performance requirements under BS 5266-1, BS 7671, and BS EN 50172. It establishes
              professional accountability and is essential for legal compliance.
            </p>
          </div>
          ...
          <div className="bg-gray-800 rounded-lg p-4 border-l-4 border-blue-500">
            ...
            <p className="text-foreground text-sm sm:text-base">
              A complete certification package includes the Emergency Lighting Completion
              Certificate, Electrical Installation Certificate, Design Declaration Certificate,
              Commissioning Certificate, and (where applicable) Minor Works Certificates.
            </p>
          </div>

          <div className="bg-gray-800 rounded-lg p-4 border-l-4 border-purple-500">
            <h4 className="font-semibold text-purple-400 mb-2 text-sm sm:text-base">
              Commissioning Checklists Provide Structured Verification
            </h4>
            <p className="text-foreground text-sm sm:text-base">
              Commissioning checklists verify that every aspect of the system has been tested,
              labelled, and documented correctly. They must cover luminaire verification, battery
              testing, exit sign compliance, system labelling, documentation, and professional
              sign-off.
            </p>
          </div>
          ...
          <div className="bg-gray-800 rounded-lg p-4 border-l-4 border-red-500">
            ...
            <p className="text-foreground text-sm sm:text-base">
              Certification documents must be signed by the designer, installer, and
              verifier/commissioning engineer to establish clear accountability at every stage of
              the project. Never sign certificates for work you haven't personally verified.
            </p>
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="bg-gradient-to-br from-blue-500/20 to-blue-600/10 border border-blue-500/30 rounded-lg p-4">
              <h4 className="font-semibold text-blue-400 mb-3 text-sm sm:text-base">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-foreground text-sm sm:text-base lg:text-lg">
                Certification transforms a working system into a legally compliant installation.
                Without proper documentation, even a perfect installation is considered
                non-verified. Always complete and retain all certificates for professional
                protection and client confidence. Remember: a system without certification is
                legally non-existent from a compliance perspective.
              </p>
            </div>
          </div>
        </div>
