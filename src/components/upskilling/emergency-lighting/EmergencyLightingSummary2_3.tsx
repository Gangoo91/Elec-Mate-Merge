        ...
        <div className="bg-green-600/15 border border-green-400/30 rounded-lg p-4">
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="text-green-300 font-medium text-sm">
              High-Risk Task Area Lighting Essentials
            </span>
          </div>
        ...
        <div className="bg-red-600/15 border border-red-400/30 rounded-lg p-4">
          ...
          <div className="space-y-3">
            <p className="text-foreground text-sm">
              <strong>Remember:</strong> High-risk task area lighting is about enabling safe
              completion of dangerous processes, not just providing light for evacuation. The
              consequences of getting it wrong can include serious injury, equipment damage worth
              hundreds of thousands of pounds, and potential legal liability.
            </p>
