    ...
    () => [
      {
        ...
        correctAnswer: 1,
        explanation:
          'The RRO 2005 is the primary fire safety legislation placing duties on responsible persons for most non-domestic premises.',
      },
      {
        id: 2,
        question:
        ...
        correctAnswer: 1,
        explanation:
          'Buildings over 200m² floor area typically require emergency lighting, though this can vary based on risk assessment.',
      },
      {
        id: 3,
        question:
          'Which standard provides the primary technical guidance for emergency lighting in the UK?',
        options: ['BS EN 1838:2013', 'BS 5499-4:2013', 'BS 5266-1:2016', 'BS 7909:2013'],
        correctAnswer: 2,
        explanation:
          'BS 5266-1:2016 is the main British Standard code of practice for emergency lighting design and installation.',
      },
      {
        id: 4,
        ...
        correctAnswer: 2,
        explanation:
          'The RRO allows for unlimited fines and imprisonment up to 2 years for serious fire safety offences.',
      },
      {
        id: 5,
        question:
          'Which document references BS 5266-1 for emergency lighting requirements in new buildings?',
        options: [
          'Approved Document A',
          'Approved Document B',
          'Approved Document L',
        ...
        correctAnswer: 1,
        explanation:
          'Approved Document B (Fire Safety) of the Building Regulations references BS 5266-1 for emergency lighting.',
      },
      {
        id: 6,
        ...
        correctAnswer: 2,
        explanation:
          'BS 5266-1 requires daily visual checks, monthly brief functional tests, and annual full-duration tests.',
      },
      {
        id: 7,
        ...
        correctAnswer: 2,
        explanation:
          'The responsible person is usually the employer, building owner, or person with control over the premises.',
      },
      {
        id: 8,
        ...
        correctAnswer: 1,
        explanation:
          'Buildings with sleeping accommodation always require emergency lighting due to the vulnerability of sleeping occupants.',
      },
      {
        id: 9,
        ...
        correctAnswer: 1,
        explanation:
          'BS EN 1838:2013 sets out the photometric requirements and illumination levels for emergency lighting.',
      },
      {
        id: 10,
        ...
        correctAnswer: 1,
        explanation:
          'Comprehensive records including test results, maintenance activities, and fault reports must be maintained for compliance.',
      },
    ],
    []
  );
