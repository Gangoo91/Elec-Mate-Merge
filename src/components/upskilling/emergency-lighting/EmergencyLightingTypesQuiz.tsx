...
const quizQuestions: QuizQuestionType[] = [
  {
    ...
    correctAnswer: 1,
    explanation:
      'Escape route lighting is specifically designed to illuminate escape routes, exits, and any change of direction along the evacuation path to ensure safe evacuation during an emergency.',
  },
  {
    id: 2,
    ...
    correctAnswer: 3,
    explanation:
      'Fire safety sign lighting is specifically designed to illuminate safety signs and help occupants locate fire safety equipment such as fire extinguishers, alarm call points, and emergency exits.',
  },
  {
    id: 3,
    ...
    correctAnswer: 1,
    explanation:
      'A maintained emergency lighting system operates continuously, providing illumination at all times whether mains power is available or not. This ensures constant visibility of escape routes.',
  },
  {
    id: 4,
    ...
    correctAnswer: 2,
    explanation:
      'Non-maintained emergency lighting operates only when mains power fails. During normal operation with mains power available, these lights remain off to conserve energy.',
  },
  {
    id: 5,
    ...
    correctAnswer: 1,
    explanation:
      'Open area lighting (also known as anti-panic lighting) is designed to illuminate large open spaces to prevent panic and allow occupants to move safely to escape routes during an emergency.',
  },
  {
    id: 6,
    ...
    correctAnswer: 1,
    explanation:
      'High risk task area lighting is required in areas where the sudden loss of normal lighting could cause danger or injury, such as plant rooms, kitchens with cooking equipment, or areas with dangerous machinery.',
  },
  {
    id: 7,
    ...
    correctAnswer: 1,
    explanation:
      'The minimum illumination level for escape route lighting is typically 1 lux measured at floor level along the centre line of the escape route, as specified in BS 5266.',
  },
  {
    id: 8,
    ...
    correctAnswer: 1,
    explanation:
      'A central battery system allows emergency lights to be controlled and monitored from multiple locations, as all luminaires are supplied from a central battery source with control and monitoring capabilities.',
  },
  {
    id: 9,
    ...
    correctAnswer: 2,
    explanation:
      "Self-contained emergency lighting luminaires have their own battery backup, making them independent from central systems. This means failure of one unit doesn't affect others, providing greater reliability.",
  },
  {
    id: 10,
    question:
      'According to BS 5266, what is the minimum duration emergency lighting should operate?',
    options: ['30 minutes', '1 hour', '2 hours', '3 hours'],
    correctAnswer: 1,
    explanation:
      'BS 5266 requires emergency lighting to operate for a minimum of 1 hour during a power failure, though some applications may require longer duration depending on the building type and evacuation procedures.',
  },
];
