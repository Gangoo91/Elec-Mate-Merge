    ...
    <Card className="bg-gradient-to-br from-indigo-600/20 to-indigo-800/10 border border-indigo-500/40 shadow-lg">
      ...
      <CardContent>
        <p className="text-indigo-200 mb-4">
          This section has explored how to adapt emergency lighting design based on specific
          building risks and occupant needs. Risk-based adjustments ensure that lighting systems
          provide genuine safety benefits rather than just regulatory compliance.
        </p>
        ...
        <div className="mt-6 p-4 bg-gradient-to-br from-purple-600/20 to-purple-800/10 border border-purple-500/40 rounded-lg">
          <p className="text-purple-200 text-sm">
            <strong>Next Steps:</strong> Complete the quiz below to test your understanding of
            risk-based design principles. Then proceed to Section 5 to learn about system
            integration and control methods for complete emergency lighting solutions.
          </p>
        </div>
      </CardContent>
    </Card>
