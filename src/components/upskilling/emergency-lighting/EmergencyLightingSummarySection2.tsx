    ...
    <Card className="bg-elec-gray border-gray-600 shadow-lg">
      ...
      <CardContent className="text-gray-300 space-y-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-400">
                    All stairways, corridors, and exits forming evacuation paths
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-400">
                    Plant rooms, areas with flammable materials, critical equipment locations
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-400">
                    Operating theatres, treatment areas with enhanced duration requirements
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-400">
                    Large open areas, toilets &gt;8m², reception areas
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="p-4 bg-amber-600/10 border border-amber-600/30 rounded-lg">
          ...
          <p className="text-sm">
            Systematically review building layout against BS5266 requirements, considering escape
            routes, area classifications, and building-specific regulations to ensure complete
            compliance.
          </p>
        </div>
        ...
        <div className="p-4 bg-blue-600/10 border border-blue-600/30 rounded-lg">
          ...
          <p className="text-sm">
            Understanding location requirements enables accurate system design, including luminaire
            positioning, spacing calculations, and illumination level specifications covered in the
            next sections.
          </p>
        </div>
      </CardContent>
