  ...
  const questions = [
    {
      ...
      options: [
        'All corridors in a building',
        'Only fire escape routes',
        'All escape routes and high-risk areas',
        'Only external areas',
      ],
      correct: 2,
      explanation:
        'BS5266 requires emergency lighting in all escape routes, plus high-risk areas, plant rooms, toilets >8m², and other specified locations.',
    },
    {
      id: 2,
      ...
      correct: 1,
      explanation:
        'BS5266 requires minimum 1 lux along the centre line of escape routes, with 0.5 lux minimum anywhere on the route.',
    },
    {
      id: 3,
      ...
      correct: 2,
      explanation:
        'Critical healthcare areas like operating theatres require 3-hour emergency lighting duration for patient safety.',
    },
    {
      id: 4,
    ...
    },
    {
      ...
      options: [
        ...
        'Only electrical panels',
        'Windows',
      ],
      correct: 1,
      explanation:
        'Plant rooms need emergency lighting when they contain essential services, safety equipment, or require emergency procedures.',
    },
    {
      id: 7,
    ...
    },
    {
      ...
      correct: 2,
      explanation:
        'Disabled refuge areas require enhanced illumination of minimum 5 lux for clear communication and instruction visibility.',
    },
    {
      id: 9,
      ...
      options: [
        'Only at the top',
        'Only at the bottom',
        'On each flight and half-landing',
        'Every other flight',
      ],
      correct: 2,
      explanation:
        'BS5266 requires emergency lighting to illuminate each flight of stairs and every half-landing.',
    },
    {
      id: 10,
      ...
      options: [
        'All storage areas',
        'Areas with significant combustible materials',
        'All kitchens',
        'All basements',
      ],
      correct: 1,
      explanation:
        'Areas of special fire risk contain significant combustible materials, flammable substances, or processes that could rapidly develop fire.',
    },
  ];
