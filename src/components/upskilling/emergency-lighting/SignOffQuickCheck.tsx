      ...
      <CardContent>
        ...
        <div className="space-y-2">
          ...
          <ul className="list-disc list-inside text-foreground text-sm space-y-1 ml-2">
            <li>
              <strong>Designer</strong> – Confirms design meets required standards
            </li>
            <li>
              <strong>Installer</strong> – Confirms installation follows design and regulations
            </li>
            <li>
              <strong>Verifier / Commissioning Engineer</strong> – Confirms system performance and
              functionality
            </li>
          </ul>
