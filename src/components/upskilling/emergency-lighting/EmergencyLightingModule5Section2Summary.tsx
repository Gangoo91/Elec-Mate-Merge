    ...
    <Card className="bg-elec-gray border-gray-700">
      ...
      <CardContent className="space-y-4">
        <p className="text-foreground">
          This section covered the essential procedures for functional testing and 3-hour duration
          ...
          <div className="space-y-2 text-sm">
            <div className="flex items-start gap-2">
              ...
              <span className="text-foreground">
                Batteries fully charged for 24 hours before duration tests
              </span>
            </div>
            <div className="flex items-start gap-2">
              <span className="text-elec-yellow">☐</span>
              <span className="text-foreground">
                Calibrated lux meter available with current certificate
              </span>
            </div>
            <div className="flex items-start gap-2">
              <span className="text-elec-yellow">☐</span>
              <span className="text-foreground">
                Emergency lighting logbook prepared with luminaire reference numbers
              </span>
            </div>
            <div className="flex items-start gap-2">
              <span className="text-elec-yellow">☐</span>
              <span className="text-foreground">
                Building occupants notified minimum 7 days in advance
              </span>
            </div>
            <div className="flex items-start gap-2">
              <span className="text-elec-yellow">☐</span>
              <span className="text-foreground">
                Duration tests scheduled outside occupied hours
              </span>
            </div>
            <div className="flex items-start gap-2">
              <span className="text-elec-yellow">☐</span>
              <span className="text-foreground">
                Camera/phone ready for documenting test results and failures
              </span>
            </div>
            <div className="flex items-start gap-2">
              <span className="text-elec-yellow">☐</span>
              <span className="text-foreground">
                Accurate timer/stopwatch for 3-hour test monitoring
              </span>
            </div>
            <div className="flex items-start gap-2">
              <span className="text-elec-yellow">☐</span>
              <span className="text-foreground">
                Access equipment available for high-mounted luminaires
              </span>
            </div>
            <div className="flex items-start gap-2">
              <span className="text-elec-yellow">☐</span>
              <span className="text-foreground">
                Client report template prepared for test findings
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-green-900/20 border border-green-600/30 rounded-lg p-4">
          ...
          <div className="grid md:grid-cols-2 gap-3 text-sm">
            <div className="flex items-start gap-2">
              ...
              <span className="text-foreground">
                Verifies system readiness for real emergencies
              </span>
            </div>
            <div className="flex items-start gap-2">
              <span className="text-green-400">✓</span>
            ...
            <div className="flex items-start gap-2">
              <span className="text-green-400">✓</span>
              <span className="text-foreground">
                Identifies battery degradation before failures
              </span>
            </div>
            <div className="flex items-start gap-2">
              <span className="text-green-400">✓</span>
        ...
        <div className="bg-blue-900/20 border border-blue-600/30 rounded-lg p-4">
          ...
          <p className="text-foreground text-sm">
            ...
            functional tests provide quick verification of system operation, but annual 3-hour
            duration tests are the only way to prove battery capacity meets regulatory requirements.
            The Leeds care home case study demonstrates the life-safety consequences of relying
            solely on short tests without comprehensive annual verification. Proper testing
            schedules, calibrated equipment, and thorough documentation are non-negotiable
            requirements for emergency lighting compliance.
          </p>
        </div>
      </CardContent>
    </Card>
