    ...
    <Card className="bg-gradient-to-br from-green-600/20 to-green-800/10 border border-green-500/40 shadow-lg">
      ...
      <CardContent className="text-gray-300 space-y-4">
        <p className="text-green-200">
          This section provided a comprehensive overview of the standards and regulations governing
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2 text-sm">
              <div className="flex items-start gap-2">
                ...
                <span>
                  <strong>BS 5266-1:2016:</strong> Comprehensive code of practice for emergency
              ...
              <div className="flex items-start gap-2">
                <ArrowRight className="h-3 w-3 text-green-400 mt-1 flex-shrink-0" />
                <span>
                  <strong>BS EN 1838:2013:</strong> Photometric requirements and measurement methods
                </span>
              </div>
              <div className="flex items-start gap-2">
                <ArrowRight className="h-3 w-3 text-green-400 mt-1 flex-shrink-0" />
                <span>
                  <strong>BS 5266-8:2004:</strong> Testing and maintenance procedures
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2 text-sm">
              <div className="flex items-start gap-2">
                <ArrowRight className="h-3 w-3 text-green-400 mt-1 flex-shrink-0" />
                <span>
                  <strong>Fire Safety Order 2005:</strong> Creates legal duties for responsible
                  persons
                </span>
              </div>
              <div className="flex items-start gap-2">
                <ArrowRight className="h-3 w-3 text-green-400 mt-1 flex-shrink-0" />
                <span>
                  <strong>Building Regulations:</strong> Statutory requirements for new builds and
                  alterations
                </span>
              </div>
              <div className="flex items-start gap-2">
                <ArrowRight className="h-3 w-3 text-green-400 mt-1 flex-shrink-0" />
                <span>
                  <strong>Workplace Regulations:</strong> Emergency lighting requirements in places
                  of work
                </span>
              </div>
            </div>
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2 text-sm">
              <div className="flex items-start gap-2">
                <ArrowRight className="h-3 w-3 text-green-400 mt-1 flex-shrink-0" />
                <span>
                  <strong>Daily:</strong> Visual inspection of indicators and signage
                </span>
              </div>
              <div className="flex items-start gap-2">
                <ArrowRight className="h-3 w-3 text-green-400 mt-1 flex-shrink-0" />
                <span>
                  <strong>Monthly:</strong> Brief functional testing of all luminaires
                </span>
              </div>
              <div className="flex items-start gap-2">
                <ArrowRight className="h-3 w-3 text-green-400 mt-1 flex-shrink-0" />
        ...
        <div className="mt-6 p-4 bg-green-500/10 border border-green-500/40 rounded-lg">
          ...
          <p className="text-sm">
            You have now completed Module 1 of the Emergency Lighting course. This foundation
            knowledge of regulations, required locations, system types, and standards provides the
            essential background for more advanced topics in subsequent modules covering design
            calculations, installation practices, and maintenance procedures.
          </p>
        </div>
      </CardContent>
    </Card>
