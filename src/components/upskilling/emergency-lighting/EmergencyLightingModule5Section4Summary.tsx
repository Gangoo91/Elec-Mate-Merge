      ...
      <CardContent className="space-y-6">
          ...
          <div className="space-y-3">
            <div className="bg-gray-800 p-4 rounded-md border-l-4 border-green-500">
              <p className="font-semibold text-green-400 mb-2 text-sm sm:text-base">
                1. Labelling is Essential
              </p>
              <p className="text-foreground text-sm sm:text-base lg:text-lg">
                Clear, durable labelling ensures circuits can be safely isolated, test points
                quickly identified, and compliance verified efficiently during inspections.
              </p>
            </div>
            <div className="bg-gray-800 p-4 rounded-md border-l-4 border-blue-500">
              <p className="font-semibold text-blue-400 mb-2 text-sm sm:text-base">
                2. Component Labelling Requirements
              </p>
              <p className="text-foreground text-sm sm:text-base lg:text-lg">
                Luminaires, distribution boards, test points, cabling, and logbooks must all be
                clearly labelled with cross-referenced identification systems.
              </p>
            </div>
            <div className="bg-gray-800 p-4 rounded-md border-l-4 border-purple-500">
              <p className="font-semibold text-purple-400 mb-2 text-sm sm:text-base">
                3. Complete Documentation
              </p>
              <p className="text-foreground text-sm sm:text-base lg:text-lg">
                Maintenance logbooks must record all tests, faults, repairs, battery replacements,
                and commissioning evidence for the lifetime of the installation.
              </p>
            </div>
            <div className="bg-gray-800 p-4 rounded-md border-l-4 border-red-500">
              <p className="font-semibold text-red-400 mb-2 text-sm sm:text-base">
                4. Legal Compliance
              </p>
              <p className="text-foreground text-sm sm:text-base lg:text-lg">
                Missing records can result in enforcement notices, invalid insurance, prosecution,
                and increased civil liability — even if the physical system is perfect.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-yellow-500/20 to-amber-500/20 border border-yellow-500/30 p-4 rounded-md">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="font-semibold text-elec-yellow mb-2 text-sm sm:text-base lg:text-lg">
              ...
              <p className="text-foreground text-sm sm:text-base lg:text-lg leading-relaxed">
                ...
                documentation. A technically perfect system without proper records is legally
                non-compliant and can result in prosecution. Professional labelling, accurate
                logbooks, and clear cross-referencing are not optional extras — they are legal
                requirements that protect both you and your client.
              </p>
            </div>
          </div>
        </div>
