      ...
      <CardContent className="text-foreground space-y-8">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            <p>
              Emergency lighting drawings are critical communication tools that bridge the gap
              between design intent and practical implementation. They serve multiple essential
              functions in the emergency lighting installation process:
            </p>
            ...
            <ul className="space-y-2 ml-4">
              <li className="flex items-start gap-2">
                ...
                <span>
                  <strong>Installation Guidance:</strong> Provide installers with precise fitting
                  positions, mounting heights, and circuit arrangements
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-elec-yellow">•</span>
                <span>
                  <strong>Compliance Demonstration:</strong> Prove to inspectors and fire officers
                  that the installation meets BS 5266-1 requirements
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-elec-yellow">•</span>
                <span>
                  <strong>Permanent Records:</strong> Form part of the building's fire safety
              ...
              <li className="flex items-start gap-2">
                <span className="text-elec-yellow">•</span>
                <span>
                  <strong>Future Reference:</strong> Enable efficient modifications, testing, and
                  maintenance throughout the building's lifecycle
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-elec-yellow">•</span>
                <span>
                  <strong>Legal Protection:</strong> Provide evidence of due diligence in case of
            ...
            <div className="bg-blue-900/20 border border-blue-600/30 rounded-lg p-4">
              <h4 className="text-blue-300 font-semibold mb-2">
                ✅ Quick Check: Why are layout drawings an essential part of fire safety
                documentation?
              </h4>
              <div className="p-3 bg-green-900/20 border border-green-600/30 rounded">
                <p className="text-green-300">
                  <strong>Answer:</strong> Layout drawings form part of the building's permanent
                  fire safety records, demonstrating compliance to inspectors and providing
                  essential information for future maintenance, testing, and modifications. They
                  also serve as legal evidence of proper design and installation procedures.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            <p>
              A compliant emergency lighting layout drawing must include comprehensive information
              to ensure proper installation and ongoing maintenance. BS 5266-1 specifies the minimum
              requirements:
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-elec-gray/50 p-4 rounded-lg">
                ...
                <ul className="space-y-2 text-sm">
                  <li>
                    • <strong>Escape routes:</strong> Clearly marked with directional flow arrows
                  </li>
                  <li>
                    • <strong>Luminaire types:</strong> Maintained, non-maintained, exit signs,
                    bulkheads
                  </li>
                  <li>
                    • <strong>Mounting heights:</strong> Specified where critical for illumination
                    calculations
                  </li>
                  <li>
                    • <strong>Building layout:</strong> Walls, doors, windows, and structural
                    elements
                  </li>
                  <li>
                    • <strong>Scale and dimensions:</strong> Typically 1:100 or 1:50 for detailed
                    areas
                  </li>
                </ul>
              </div>
              <div className="bg-elec-gray/50 p-4 rounded-lg">
                ...
                <ul className="space-y-2 text-sm">
                  <li>
                    • <strong>Circuit references:</strong> Which fittings connect to which supply
                    circuits
                  </li>
                  <li>
                    • <strong>Testing points:</strong> Access locations for periodic testing
                    procedures
                  </li>
                  <li>
                    • <strong>Central battery locations:</strong> If applicable to the system design
                  </li>
                  <li>
                    • <strong>Legends and symbols:</strong> Clear interpretation keys for all
                    stakeholders
                  </li>
                  <li>
                    • <strong>Control panel positions:</strong> For monitored and addressable
                    systems
                  </li>
                </ul>
              </div>
            ...
            <div className="bg-blue-900/20 border border-blue-600/30 rounded-lg p-4">
              <h4 className="text-blue-300 font-semibold mb-2">
                ✅ Quick Check: Name five items of information that must appear on emergency
                lighting drawings.
              </h4>
              <div className="p-3 bg-green-900/20 border border-green-600/30 rounded">
                <p className="text-green-300">
                  <strong>Answer:</strong> Escape routes clearly marked, luminaire types and
                  positions, mounting heights, circuit references, and testing points. Additional
                  essential items include legends/symbols, building layout, scale/dimensions, and
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            <p>
              Modern emergency lighting drawings are typically produced using Computer-Aided Design
              (CAD) software, which offers precision, consistency, and easy revision management.
            ...
            <div className="bg-blue-900/20 border border-blue-600/30 rounded-lg p-4">
              <h4 className="text-blue-300 font-semibold mb-2">
                ✅ Quick Check: Why is CAD software preferred over hand-drawn sketches for emergency
                lighting drawings?
              </h4>
              <div className="p-3 bg-green-900/20 border border-green-600/30 rounded">
                <p className="text-green-300">
                  <strong>Answer:</strong> CAD software provides precision, consistency, easy
                  revisions, standardised symbols, proper scaling, layer organisation, and
                  professional presentation. It also enables integration with BIM systems and
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            <p>
              Accurate scaling and dimensioning are crucial for proper installation and compliance
              verification. Industry standards dictate specific requirements:
            </p>
            ...
            <div className="bg-elec-gray/50 p-4 rounded-lg">
              ...
              <ul className="space-y-2 ml-4">
                <li className="flex items-start gap-2">
                  <span className="text-elec-yellow">•</span>
                  <span>
                    <strong>1:100</strong> - General building layouts and large spaces
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-elec-yellow">•</span>
                  <span>
                    <strong>1:50</strong> - Detailed areas requiring precise positioning
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-elec-yellow">•</span>
                  <span>
                    <strong>1:20</strong> - Complex installations with multiple luminaire types
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-elec-yellow">•</span>
                  <span>
                    <strong>NTS (Not To Scale)</strong> - Schematic diagrams only, must be clearly
                    marked
                  </span>
                </li>
              </ul>
            ...
            <div className="bg-blue-900/20 border border-blue-600/30 rounded-lg p-4">
              <h4 className="text-blue-300 font-semibold mb-2">
                ✅ Quick Check: What is the most common scale used for emergency lighting layout
                drawings?
              </h4>
              <div className="p-3 bg-green-900/20 border border-green-600/30 rounded">
                <p className="text-green-300">
                  <strong>Answer:</strong> 1:100 is the most common scale for general building
                  layouts, with 1:50 used for detailed areas requiring precise positioning. The
                  scale must be clearly indicated on all drawings.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            <p>
              Standardised symbols ensure consistent interpretation across the industry. BS 5266-1
              and related standards specify exact requirements for graphical representation:
            </p>
            ...
            <div className="bg-elec-gray/50 p-4 rounded-lg">
              ...
              <ul className="space-y-2 ml-4">
                <li className="flex items-start gap-2">
                  <span className="text-elec-yellow">•</span>
                  <span>
                    <strong>BS 5266-1:</strong> Emergency lighting for premises - Code of practice
                    for the emergency lighting of premises
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-elec-yellow">•</span>
                  <span>
                    <strong>BS EN ISO 7010:</strong> Graphical symbols - Safety colours and safety
                    signs
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-elec-yellow">•</span>
                  <span>
                    <strong>BS 1192:</strong> Collaborative production of architectural, engineering
                ...
                <li className="flex items-start gap-2">
                  <span className="text-elec-yellow">•</span>
                  <span>
                    <strong>IET Wiring Regulations:</strong> For electrical installation symbols and
                    circuit references
                  </span>
                </li>
              </ul>
            ...
            <div className="bg-blue-900/20 border border-blue-600/30 rounded-lg p-4">
              <h4 className="text-blue-300 font-semibold mb-2">
                ✅ Quick Check: What pictogram must be used for exit signage on layout drawings and
                which standard defines it?
              </h4>
              <div className="p-3 bg-green-900/20 border border-green-600/30 rounded">
                <p className="text-green-300">
                  <strong>Answer:</strong> The running man pictogram with directional arrows must be
                  used for exit signage, as specified in BS EN ISO 7010 standards. This ensures
                  international consistency and recognition in emergency situations.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            <p>
              Emergency lighting drawings have legal implications under building regulations, fire
              safety legislation, and health and safety requirements. Proper handover procedures are
              mandatory:
            </p>
            ...
            <div className="bg-blue-900/20 border border-blue-600/30 rounded-lg p-4">
              <h4 className="text-blue-300 font-semibold mb-2">
                ✅ Quick Check: Who is legally responsible for ensuring emergency lighting drawings
                are handed over to the building owner?
              </h4>
              <div className="p-3 bg-green-900/20 border border-green-600/30 rounded">
                <p className="text-green-300">
                  <strong>Answer:</strong> The installing contractor has the primary legal
                  responsibility to provide as-built drawings to the building owner, though the
                  designer, principal contractor, and building owner all have specific duties under
                  current legislation.
                </p>
              </div>
            </div>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            <p>
              The distinction between design intent and final installation is critical for
              compliance and future maintenance. Professional management of drawing revisions
            ...
            <div className="bg-blue-900/20 border border-blue-600/30 rounded-lg p-4">
              <h4 className="text-blue-300 font-semibold mb-2">
                ✅ Quick Check: What is the key difference between design drawings and as-built
                drawings in terms of compliance?
              </h4>
              <div className="p-3 bg-green-900/20 border border-green-600/30 rounded">
                <p className="text-green-300">
                  <strong>Answer:</strong> Design drawings show intended compliance with standards,
                  while as-built drawings provide evidence of actual compliance achieved. Only
                  as-built drawings can be used to demonstrate final compliance to inspectors and
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            <p>
              Modern construction projects increasingly use BIM technology for coordinated design
              and construction. Emergency lighting drawings must integrate seamlessly with BIM
              workflows:
            </p>
            ...
            <div className="bg-elec-gray/50 p-4 rounded-lg">
              ...
              <ul className="space-y-2 ml-4">
                <li className="flex items-start gap-2">
                  <span className="text-elec-yellow">•</span>
                  <span>
                    <strong>3D Coordination:</strong> Clash detection with other building systems
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-elec-yellow">•</span>
                  <span>
                    <strong>Automatic Schedules:</strong> Generate luminaire schedules and
                    specifications
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-elec-yellow">•</span>
                  <span>
                    <strong>Lifecycle Management:</strong> Link to maintenance and testing schedules
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-elec-yellow">•</span>
                  <span>
                    <strong>Data Rich Models:</strong> Include product specifications and
                    performance data
                  </span>
                </li>
              </ul>
            ...
            <div className="bg-blue-900/20 border border-blue-600/30 rounded-lg p-4">
              <h4 className="text-blue-300 font-semibold mb-2">
                ✅ Quick Check: How does BIM technology improve emergency lighting design and
                documentation?
              </h4>
              <div className="p-3 bg-green-900/20 border border-green-600/30 rounded">
                <p className="text-green-300">
                  <strong>Answer:</strong> BIM provides 3D coordination with other systems,
                  automatic generation of schedules and documentation, clash detection, data-rich
                  models with specifications, and improved lifecycle management from design through
                  maintenance.
                </p>
              </div>
            </div>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            <p>
              Understanding and preventing common errors in emergency lighting drawings is essential
              for compliance and professional practice. These errors frequently cause installation
            ...
            <div className="bg-blue-900/20 border border-blue-600/30 rounded-lg p-4">
              <h4 className="text-blue-300 font-semibold mb-2">
                ✅ Quick Check: What is the most common cause of emergency lighting drawing
                compliance failures?
              </h4>
              <div className="p-3 bg-green-900/20 border border-green-600/30 rounded">
                <p className="text-green-300">
                  <strong>Answer:</strong> Missing or incorrectly marked escape routes are the most
                  common cause of compliance failures, followed by inconsistent symbol usage and
                  inadequate legends. These errors make it impossible to verify compliance with BS
                  5266-1 requirements.
                </p>
              </div>
            </div>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            <p>
              Emergency lighting drawings form the foundation for ongoing inspection, testing, and
              maintenance throughout the building's operational life. Proper documentation supports
            ...
            <div className="bg-elec-gray/50 p-4 rounded-lg">
              ...
              <ul className="space-y-2 ml-4">
                <li className="flex items-start gap-2">
                  <span className="text-elec-yellow">•</span>
                  <span>
                    <strong>Commissioning Records:</strong> Initial testing and verification against
                    drawings
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-elec-yellow">•</span>
                  <span>
                    <strong>Periodic Testing Logs:</strong> Monthly and annual testing results
                    linked to drawing locations
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-elec-yellow">•</span>
                  <span>
                    <strong>Maintenance Records:</strong> Repairs, replacements, and modifications
                ...
                <li className="flex items-start gap-2">
                  <span className="text-elec-yellow">•</span>
                  <span>
                    <strong>Compliance Certificates:</strong> Professional sign-offs and regulatory
                    approvals
                  </span>
                </li>
              </ul>
            ...
            <div className="bg-blue-900/20 border border-blue-600/30 rounded-lg p-4">
              <h4 className="text-blue-300 font-semibold mb-2">
                ✅ Quick Check: How often must emergency lighting drawings be reviewed and
                potentially updated?
              </h4>
              <div className="p-3 bg-green-900/20 border border-green-600/30 rounded">
                <p className="text-green-300">
                  <strong>Answer:</strong> Drawings should be reviewed annually during full testing
                  procedures and updated immediately following any modifications to the
                  installation. They must also be reviewed whenever building layouts change or new
                  escape routes are established.
                </p>
              </div>
            </div>
          </div>
