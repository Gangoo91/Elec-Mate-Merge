...
export const OpenAreaAntiPanicLightingQuiz = () => {
  ...
  const questions = [
    {
      ...
      correct: '60m²',
      explanation:
        'BS 5266 requires anti-panic lighting for open areas exceeding 60m² to prevent panic and enable safe movement toward escape routes.',
    },
    {
      ...
      correct: '0.5 lux',
      explanation:
        'Anti-panic lighting must provide a minimum of 0.5 lux at floor level anywhere within the open area to enable safe movement.',
    },
    {
      ...
      correct: '40:1',
      explanation:
        'The uniformity ratio between maximum and minimum illuminance levels must not exceed 40:1, the same as escape route lighting.',
    },
    {
      ...
      explanation:
        'Anti-panic luminaires should be spaced at maximum intervals of 4 times their mounting height to ensure adequate coverage.',
    },
    {
      ...
      correct: '2m x 2m',
      explanation:
        'A 2m x 2m calculation grid is typically used to verify illuminance levels and uniformity across large open areas.',
    },
    {
      ...
      explanation:
        'Large retail stores with sales floors exceeding 60m² are prime examples of spaces requiring anti-panic lighting provision.',
    },
    {
      ...
      options: [
        'Never allowed',
        'Only in emergencies',
        'Yes, using maintained systems',
        'Only in small areas',
      ],
      correct: 'Yes, using maintained systems',
      explanation:
        'Maintained emergency luminaires can serve as both normal and emergency lighting, providing cost-effective anti-panic coverage.',
    },
    {
      question: 'What is the primary purpose of anti-panic lighting?',
      options: [
        'Illuminate exits only',
      ...
      explanation:
        'Anti-panic lighting is specifically designed to reduce panic and provide general illumination to help occupants move safely toward escape routes.',
    },
    {
      ...
      options: [
        ...
        'At ceiling centre only',
        'Random placement',
      ],
      correct: 'Between shelving aisles',
      explanation:
        'In retail areas with shelving, luminaires should be positioned to avoid shadows and ensure coverage between aisles and around obstacles.',
    },
    {
      ...
      explanation:
        'Anti-panic lighting complements escape route lighting by providing area coverage while escape lighting specifically illuminates exit paths.',
    },
  ];
  ...
  const getScoreMessage = () => {
    const percentage = (score / questions.length) * 100;
    if (percentage >= 80)
      return 'Excellent! You understand anti-panic lighting requirements very well.';
    if (percentage >= 60)
      return 'Good progress! Review the missed topics to improve your knowledge.';
