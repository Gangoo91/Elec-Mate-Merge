  ...
  return (
    <Card className="bg-gradient-to-br from-elec-gray to-[#1a1a1a] border border-gray-600 shadow-lg">
      ...
      <CardContent className="text-gray-300 space-y-4">
        <p>
          BS5266 and Building Regulations specify mandatory locations where emergency lighting must
          be installed. Understanding these requirements ensures compliance and effective evacuation
          procedures.
        </p>
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div className="p-4 bg-gradient-to-br from-blue-600/20 to-blue-800/10 border border-blue-500/40 rounded-lg shadow-md">
            ...
            <p className="text-gray-300 text-sm">
              All escape routes, corridors, stairways, and final exits require adequate emergency
              lighting coverage.
            </p>
          </div>
          ...
          <div className="p-4 bg-gradient-to-br from-amber-600/20 to-orange-800/10 border border-amber-500/40 rounded-lg shadow-md">
            ...
            <p className="text-gray-300 text-sm">
              High-risk areas, plant rooms, toilets, and places of special fire risk need additional
              provisions.
            </p>
          </div>
        </div>
