  ...
  const faqs = [
    {
      ...
      answer:
        'Central battery systems are typically better for larger installations (>1000m²), buildings with high maintenance requirements, or where centralised monitoring is essential. They offer longer battery life (10-25 years vs 3-5 years), reduced maintenance visits, and better system oversight. However, they require higher initial capital investment and dedicated plant room space.',
    },
    {
      id: 2,
