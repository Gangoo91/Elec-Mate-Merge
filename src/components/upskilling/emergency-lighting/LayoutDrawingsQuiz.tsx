...
const questions: Question[] = [
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Inspectors and fire officers rely on layout drawings to verify compliance with fire safety regulations and building standards.',
  },
  {
    id: 3,
    ...
    correctAnswer: 1,
    explanation:
      'Escape routes must be clearly marked on drawings and shown in bold to make the evacuation paths immediately obvious to all users.',
  },
  {
    id: 4,
    ...
    correctAnswer: 2,
    explanation:
      'Luminaire types must be indicated to ensure correct installation of maintained, non-maintained, exit signs, and bulkheads according to design specifications.',
  },
  {
    id: 5,
    ...
    correctAnswer: 2,
    explanation:
      'BS EN ISO 7010 requires the running man pictogram with arrows for exit signage to ensure universal recognition and compliance.',
  },
  {
    id: 6,
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'PDF and DWG formats should be supplied as they are standard formats that ensure accessibility to clients and compliance with industry requirements.',
  },
];
