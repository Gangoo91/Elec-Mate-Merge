  ...
  const visualChecks = [
    {
      ...
      description:
        'Verify correct cable type (fire-resistant, LSZH, MICC where specified in design)',
    },
    {
      type: 'Physical Installation',
      description:
        'Check supports, fixings are non-combustible and compliant with BS 7671 Reg. 521.10.202',
    },
    {
    ...
    },
    {
      ...
      description:
        'All circuits, distribution boards, and luminaires correctly identified and labelled',
    },
  ];
    ...
    <Card className="bg-elec-gray border-gray-700">
      <CardContent className="p-6 sm:p-8">
        ...
        <div className="space-y-6 mb-8">
          ...
          <div className="bg-[#323232] rounded-lg p-4 space-y-3">
            <p className="text-foreground leading-relaxed text-sm sm:text-base">
              ...
              commissioning. This stage is mandatory before the system can be put into service.
            </p>
            <div className="flex items-start gap-3 bg-blue-600/10 border border-blue-600/20 rounded p-3 sm:p-4">
              <Shield className="h-5 w-5 text-blue-400 mt-0.5 flex-shrink-0" />
              <p className="text-foreground text-sm sm:text-base">
                <strong>Key Point:</strong> Without proper initial inspection, hidden faults may
                remain undetected, potentially causing system failure during an emergency
                evacuation.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="bg-green-600/10 border border-green-600/20 rounded-lg p-4 sm:p-5">
              ...
              <p className="text-foreground text-xs sm:text-sm leading-relaxed">
                Confirms the installation matches approved drawings and specifications in all
                respects
              </p>
            </div>
        ...
        <div className="space-y-6 mb-8">
          ...
          <div className="bg-[#323232] rounded-lg p-4 sm:p-6">
            <p className="text-foreground text-sm sm:text-base mb-4">
              Before any electrical testing or energisation, a comprehensive visual inspection must
              be carried out to verify physical compliance and identify any obvious defects:
            </p>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
              {visualChecks.map((check, index) => (
                <div
                  key={index}
                  className="bg-elec-dark rounded-lg p-4 sm:p-5 border-l-4 border-elec-yellow/50"
                >
          ...
          <div className="bg-[#323232] rounded-lg p-4 sm:p-6">
            <h4 className="text-foreground font-medium mb-3 text-sm sm:text-base">
              Escape Route Coverage Verification:
            </h4>
            <ul className="space-y-3 sm:space-y-4">
              <li className="flex items-start gap-3 text-foreground">
                <span className="w-2 h-2 bg-elec-yellow rounded-full mt-2 flex-shrink-0"></span>
                <span className="text-sm sm:text-base">
                  Luminaires positioned at all <strong>exit doors and emergency exits</strong>
                </span>
              </li>
              <li className="flex items-start gap-3 text-foreground">
                <span className="w-2 h-2 bg-elec-yellow rounded-full mt-2 flex-shrink-0"></span>
                <span className="text-sm sm:text-base">
                  Illumination provided at <strong>changes of direction and intersections</strong>
                </span>
              </li>
              <li className="flex items-start gap-3 text-foreground">
                <span className="w-2 h-2 bg-elec-yellow rounded-full mt-2 flex-shrink-0"></span>
                <span className="text-sm sm:text-base">
                  Coverage at <strong>stairways and level changes</strong> to prevent trip hazards
                </span>
              </li>
              <li className="flex items-start gap-3 text-foreground">
                <span className="w-2 h-2 bg-elec-yellow rounded-full mt-2 flex-shrink-0"></span>
                <span className="text-sm sm:text-base">
                  Lighting near <strong>fire alarm call points and firefighting equipment</strong>
                </span>
              </li>
            </ul>
          </div>
          ...
          <div className="bg-red-600/10 border border-red-600/20 rounded-lg p-4 sm:p-5">
            <div className="flex items-start gap-3">
              ...
              <p className="text-foreground text-sm sm:text-base leading-relaxed">
                <strong>Critical Requirement:</strong> BS 7671 Regulation 521.10.202 requires that
                fixings and supports for emergency lighting cables must be non-combustible. Plastic
                clips and cable ties are not acceptable for fire-resistant cable installations.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-6 mb-8">
          ...
          <div className="bg-[#323232] rounded-lg p-4 space-y-3">
            <p className="text-foreground leading-relaxed text-sm sm:text-base">
              ...
              calibrated test instruments in accordance with BS 7671 requirements.
            </p>
          </div>
            ...
            {electricalTests.map((test, index) => (
              <div key={index} className="bg-[#323232] rounded-lg p-4 sm:p-5">
                <div className="flex items-start justify-between gap-4 flex-col sm:flex-row">
                  <div className="flex-1">
                    <h4 className="text-elec-yellow font-medium mb-2 text-sm sm:text-base">
                      {test.test}
                    </h4>
          ...
          <div className="bg-blue-600/10 border border-blue-600/20 rounded-lg p-4 sm:p-5">
            <p className="text-foreground text-sm sm:text-base leading-relaxed">
              <strong>Additional Testing:</strong> For central battery systems or systems with
              monitoring panels, verify functional connection of all monitoring and control wiring.
              Test communication between luminaires and control equipment where applicable.
            </p>
          </div>
        </div>
        ...
        <div className="space-y-6 mb-8">
          ...
          <div className="bg-[#323232] rounded-lg p-4 sm:p-6">
            <p className="text-foreground text-sm sm:text-base mb-4">
              Each individual luminaire must be verified to ensure it is correctly installed,
              properly connected, and compliant with design specifications:
            </p>

            <div className="space-y-4">
              <div className="bg-elec-dark rounded-lg p-4">
                <h4 className="text-elec-yellow font-medium mb-3 text-sm sm:text-base">
                  Self-Contained Luminaires:
                </h4>
                <ul className="space-y-2 text-foreground text-xs sm:text-sm">
                  <li>
                    • Verify correct type (maintained or non-maintained as per design specification)
                  </li>
                  <li>
                    • Check battery connections are secure and charging indicator is functioning
                  </li>
              ...
              <div className="bg-elec-dark rounded-lg p-4">
                <h4 className="text-elec-yellow font-medium mb-3 text-sm sm:text-base">
                  Exit Signs and Directional Indicators:
                </h4>
                <ul className="space-y-2 text-foreground text-xs sm:text-sm">
                  ...
                  <li>
                    • Ensure mounting height complies with BS 5266-1 (typically 2m above floor
                    level)
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-elec-dark rounded-lg p-4">
                ...
                <ul className="space-y-2 text-foreground text-xs sm:text-sm">
                  <li>
                    • Verify sub-circuit wiring is correctly terminated at central battery panel
                  </li>
                  <li>• Check polarity of all connections to slave luminaires</li>
                  <li>
                    • Confirm monitoring connections are functioning (if system includes monitoring)
                  </li>
          ...
          <div className="bg-green-600/10 border border-green-600/20 rounded-lg p-4 sm:p-5">
            <div className="flex items-start gap-3">
              ...
              <p className="text-foreground text-sm sm:text-base leading-relaxed">
                <strong>Compliance Note:</strong> Exit signs must use the standardised ISO 7010
                green running man pictogram. Older "EXIT" text signs or non-standard symbols do not
                meet current UK regulatory requirements.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-6">
              ...
              {inspectionSequence.map((item, index) => (
                <div
                  ...
                  className={`flex items-center gap-4 p-3 rounded ${
                    item.status === 'Current step'
                      ? 'bg-elec-yellow/20 border border-elec-yellow/30'
                      : item.status === 'Complete before site work' ||
                          item.status === 'Before energising'
          ...
          <div className="bg-red-600/10 border border-red-600/20 rounded-lg p-4 sm:p-5">
            <div className="flex items-start gap-3">
              <AlertTriangle className="h-5 w-5 text-red-400 mt-0.5 flex-shrink-0" />
              <p className="text-foreground text-sm sm:text-base leading-relaxed">
                <strong>Critical:</strong> If any inspection or verification test fails, the defect
                must be rectified and re-tested before proceeding to the next stage. Never energise
                a system that has failed inspection.
              </p>
            </div>
          </div>
        </div>
