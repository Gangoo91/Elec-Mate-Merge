    ...
    <Card className="bg-elec-gray border-gray-700">
      ...
      <CardContent className="text-foreground space-y-4">
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-foreground">
                A large office refurbishment in central London involved installing a new emergency
                lighting system throughout a 6-storey building. The electrical contractor used
                existing cable tray infrastructure to minimise costs and installation time.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-1 text-foreground">
                <li>
                  Emergency lighting cables run in the same plastic trunking as data and general
                  power cables
                </li>
            ...
            <div className="bg-gray-800 border border-gray-700 rounded-lg p-4">
              ...
              <p className="text-foreground mb-2">
                The plastic trunking would fail under fire conditions, compromising circuit
                integrity. The installation violated:
              </p>
              <ul className="list-disc list-inside space-y-1 text-foreground">
                <li>
                  <strong className="text-foreground">BS 7671 Regulation 521.10.202:</strong> Escape
                  route circuits must be protected against premature collapse
                </li>
                <li>
                  <strong className="text-foreground">BS 5266-1:</strong> Emergency lighting
                  circuits must maintain integrity for full emergency duration
                </li>
                <li>
                  <strong className="text-foreground">
                    Building Regulations Approved Document B:
                  </strong>{' '}
                  Fire safety provisions for means of escape
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <p className="text-foreground mb-2">
                The installation had to be completely re-routed with dedicated fire-resistant
                containment:
              </p>
              <ul className="list-disc list-inside space-y-1 text-foreground">
            ...
            <div className="bg-yellow-600/20 border border-yellow-600/40 rounded-lg p-4">
              ...
              <div className="space-y-2.5 text-foreground text-sm sm:text-base">
                ...
                <div className="grid grid-cols-[1fr_auto] gap-x-4 gap-y-1 items-baseline border-t border-yellow-600/40 pt-2.5 mt-1">
                  ...
                  <span className="font-bold text-red-400 whitespace-nowrap text-right text-lg sm:text-xl">
                    £94,000
                  </span>
                </div>
              </div>
            ...
            <div className="bg-green-600/20 border border-green-600/40 rounded-lg p-4">
              ...
              <ul className="space-y-2 text-foreground">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong className="text-foreground">Plan segregation from the start:</strong>{' '}
                    Retrofitting costs far more than initial proper installation
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-1">✓</span>
                  <span>
                    <strong className="text-foreground">Use correct materials:</strong> LSZH
                    enhanced cables and metal fixings are mandatory, not optional
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-1">✓</span>
                  <span>
                    <strong className="text-foreground">Understand the regulations:</strong>{' '}
                    Emergency lighting has specific requirements beyond normal electrical
                    installation
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-1">✓</span>
                  <span>
                    <strong className="text-foreground">Budget appropriately:</strong> Cutting
                    corners on emergency lighting leads to expensive failures
                  </span>
                </li>
              </ul>
            </div>
        ...
        <p className="text-foreground italic">
          This case study demonstrates why segregation must be planned from the start. The
          contractor's attempt to save time and money by reusing existing infrastructure resulted in
          costs more than double the original installation price, plus significant project delays
