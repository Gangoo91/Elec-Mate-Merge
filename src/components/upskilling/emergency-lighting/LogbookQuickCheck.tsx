        ...
        <div className="flex items-start gap-3">
          ...
          <div className="space-y-2">
            ...
            <div className="text-foreground text-sm sm:text-base space-y-1">
              <p>
                <strong>1.</strong> Date of test
              </p>
              <p>
                <strong>2.</strong> Type of test (monthly or annual)
              </p>
              <p>
                <strong>3.</strong> Person carrying out the test
              </p>
              <p>
                <strong>4.</strong> Results (pass/fail)
              </p>
              <p>
                <strong>5.</strong> Any defects and remedial action taken
              </p>
            </div>
          </div>
        </div>
