      ...
      <CardContent className="space-y-6">
        {faqs.map((faq, index) => (
          <div key={index} className="space-y-2">
            ...
            <p className="text-gray-300 text-sm leading-relaxed ml-4">{faq.answer}</p>
          </div>
        ))}
      </CardContent>
    </Card>
