  ...
  return (
    <Card className="bg-gradient-to-br from-elec-gray to-[#1a1a1a] border border-gray-600 shadow-lg">
      ...
      <CardContent className="text-gray-300 space-y-4">
        <p>
          Emergency lighting is a critical life safety system required by law to ensure safe
          evacuation during power failures or emergencies. The legal framework in the UK establishes
          clear duties for building owners and operators.
        </p>
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div className="p-4 bg-gradient-to-br from-blue-600/20 to-blue-800/10 border border-blue-500/40 rounded-lg shadow-md">
            ...
            <p className="text-gray-300 text-sm">
              To enable safe evacuation of buildings when normal lighting fails, protecting lives
          ...
          <div className="p-4 bg-gradient-to-br from-amber-600/20 to-orange-800/10 border border-amber-500/40 rounded-lg shadow-md">
            ...
            <p className="text-gray-300 text-sm">
              Non-compliance can result in prosecution, unlimited fines, and criminal liability for
              responsible persons.
            </p>
          </div>
        </div>
