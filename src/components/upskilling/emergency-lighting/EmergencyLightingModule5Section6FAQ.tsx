    ...
    <Card className="bg-elec-gray border-gray-700">
      ...
      <CardContent className="text-foreground space-y-6">
        {faqs.map((faq, index) => (
          <div
            key={index}
            className="bg-gray-800 p-5 rounded-lg border-l-4 border-elec-yellow space-y-3"
          >
