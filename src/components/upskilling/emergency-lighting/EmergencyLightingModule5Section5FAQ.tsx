      ...
      <CardContent className="space-y-6">
        {faqs.map((faq, index) => (
          <div key={index} className="bg-gray-800 rounded-lg p-4 border-l-4 border-elec-yellow">
            ...
            <p className="text-foreground text-sm sm:text-base lg:text-lg">{faq.answer}</p>
          </div>
        ))}
      </CardContent>
    </Card>
