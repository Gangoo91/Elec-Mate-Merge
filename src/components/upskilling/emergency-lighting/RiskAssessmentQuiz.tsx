...
export const RiskAssessmentQuiz = () => {
  ...
  const [selectedAnswers, setSelectedAnswers] = useState<number[]>(
    new Array(riskAssessmentQuizQuestions.length).fill(-1)
  );
        ...
        <CardContent>
          <div className="text-center mb-6">
            ...
            <p className="text-gray-300">
              {percentage >= 80
                ? 'Excellent work! You understand how risk assessments drive emergency lighting design.'
                : percentage >= 60
      ...
      <CardContent>
        ...
        <div className="flex justify-between">
          ...
          <Button
            ...
            className="bg-elec-yellow text-elec-dark hover:bg-yellow-600"
          >
            {currentQuestion === riskAssessmentQuizQuestions.length - 1
              ? 'Finish Quiz'
              : 'Next Question'}
          </Button>
        </div>
