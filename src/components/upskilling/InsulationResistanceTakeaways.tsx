  ...
  const takeaways = [
    {
      ...
      description:
        'This test is fundamental to electrical safety—it reveals problems that could cause fire, shock, or equipment damage.',
    },
    {
      title: 'It must be done before energising and after continuity',
      description:
        'Follow the correct test sequence. Never energise circuits without confirming insulation integrity first.',
    },
    {
      title: 'Minimum readings are defined in BS7671—typically ≥1 MΩ',
      description:
        "Know the required values and don't accept readings below the minimum. Record actual values, not just pass/fail.",
    },
    {
      title: 'Never skip the test due to assumption or appearance',
      description:
        "Even new installations can have faults. Age, appearance, or reputation don't eliminate the need for proper testing.",
    },
  ];
