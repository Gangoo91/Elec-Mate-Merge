      ...
      <CardContent className="text-foreground space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-green-900/20 border border-green-700/30 rounded-lg p-4">
            <ul className="list-disc list-inside space-y-2 text-sm text-green-200">
              <li>
                <strong>Polarity testing ensures safety</strong> by verifying line and neutral
                conductors are correctly connected
              </li>
              <li>
                <strong>BS 7671 requires polarity testing</strong> before energisation of any new
                installation or circuit
              </li>
              <li>
                <strong>Incorrect polarity creates shock hazards</strong> from normally safe parts
                becoming live
              </li>
              <li>
                <strong>Switches must control line conductors</strong> to provide proper isolation
                when off
              </li>
              <li>
                <strong>Edison screw lampholders</strong> must have line connected to centre
                contact, neutral to thread
              </li>
              <li>
                <strong>Protective devices must operate on line</strong> to provide effective
                protection
              </li>
            </ul>
          </div>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-red-900/20 border border-red-700/30 rounded-lg p-4">
            <ul className="list-disc list-inside space-y-2 text-sm text-red-200">
              <li>
                Never energise circuits with incorrect polarity - always correct wiring errors first
              </li>
        ...
        <div className="bg-elec-dark/50 rounded-lg p-4">
          ...
          <p className="text-sm text-foreground">
            Now that you understand why polarity testing is essential, the next section will cover
            the practical methods and procedures for performing polarity tests on different circuit
            types. You'll learn the step-by-step testing procedures and how to interpret results
            correctly.
          </p>
        </div>
      </CardContent>
