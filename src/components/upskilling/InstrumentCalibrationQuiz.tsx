  ...
  const questions: QuizQuestion[] = [
    {
      ...
      options: ['Every 3 months', 'Every 6 months', 'Every 12 months', 'Every 2 years'],
      correctAnswer: 2,
      explanation:
        'Test instruments typically require calibration every 12 months to ensure accuracy and compliance with safety standards.',
    },
    {
      id: 2,
      question:
