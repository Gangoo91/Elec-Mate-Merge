    ...
    <div className="space-y-4">
      ...
      <div className="bg-purple-600/10 border border-purple-600/20 rounded-lg p-4">
        <p className="text-purple-200 font-medium">
          <strong>Legal Note:</strong> Failure to maintain proper compliance documentation can
          result in enforcement action, invalidate insurance claims, and create legal liability for
          duty holders.
        </p>
      </div>
    </div>
