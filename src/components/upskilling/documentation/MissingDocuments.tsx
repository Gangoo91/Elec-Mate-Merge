    ...
    <div className="space-y-4">
      ...
      <div className="space-y-4">
        {strategies.map((strategy, index) => (
          <div key={index} className="bg-[#323232] rounded-lg p-4">
            <h4 className="font-semibold text-foreground mb-3 text-red-300">
              {strategy.situation}
            </h4>
      ...
      <div className="bg-orange-600/10 border border-orange-600/20 rounded-lg p-4">
        <p className="text-orange-200 font-medium">
          <strong>Important:</strong> Missing documentation significantly increases inspection time
          and risk. Always inform the client of additional costs and limitations when documentation
          is inadequate.
        </p>
      </div>
    </div>
