    ...
    <div className="space-y-4">
      ...
      <div className="bg-yellow-600/10 border border-yellow-600/20 rounded-lg p-4">
        <p className="text-yellow-200 font-medium">
          <strong>Best Practice:</strong> Never proceed with visual inspection if critical
          documentation is missing. The time spent gathering proper documentation will be saved many
          times over during the inspection process.
        </p>
      </div>
    </div>
  );
