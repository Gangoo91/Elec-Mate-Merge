      ...
      <Card className="bg-elec-gray border-transparent">
        ...
        <CardContent className="text-gray-300 space-y-6">
          ...
          <div className="bg-elec-dark p-4 rounded-md border border-gray-600">
            ...
            <div className="space-y-3">
              <div className="flex gap-3">
                ...
                <div>
                  <strong>Requirements Analysis:</strong> Interview users, identify key performance
                  indicators, define operational workflows
                </div>
              </div>
              <div className="flex gap-3">
                <div className="w-6 h-6 bg-elec-yellow text-elec-dark rounded-full flex items-center justify-center text-sm font-bold">
                ...
                <div>
                  <strong>Information Architecture:</strong> Group related functions, establish
                  navigation hierarchy, plan screen layouts
                </div>
              </div>
              <div className="flex gap-3">
                <div className="w-6 h-6 bg-elec-yellow text-elec-dark rounded-full flex items-center justify-center text-sm font-bold">
                ...
                <div>
                  <strong>Prototype Development:</strong> Create wireframes, test with users,
              ...
              <div className="flex gap-3">
                ...
                <div>
                  <strong>Implementation:</strong> Configure graphics, establish data connections,
                  test functionality
                </div>
              </div>
              <div className="flex gap-3">
                ...
                <div>
                  <strong>Training & Deployment:</strong> User training sessions, phased rollout,
                  ongoing support
                </div>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="bg-elec-dark p-4 rounded-md border border-green-600/30">
              ...
              <p className="text-sm mb-2">
                <strong>Energy Dashboard for Office Building:</strong>
              </p>
            ...
            <div className="bg-elec-dark p-4 rounded-md border border-red-600/30">
              ...
              <p className="text-sm mb-2">
                <strong>Information Overload Dashboard:</strong>
              </p>
              <ul className="text-sm space-y-1">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div>
                ...
                <ul className="text-sm space-y-1">
                  ...
                  <li>
                    • Implement standard colour codes (red=alarm, amber=warning, green=normal)
                  </li>
          ...
          <div className="bg-elec-dark p-4 rounded-md border border-gray-600">
            ...
            <div className="space-y-3">
              <div>
                <strong>Functional Testing:</strong> Verify all data points update correctly, test
                alarm acknowledgment, check navigation links
              </div>
              <div>
                <strong>Usability Testing:</strong> Time common tasks, assess user satisfaction,
                identify training needs
              </div>
              <div>
                <strong>Performance Testing:</strong> Monitor response times, test with maximum
                concurrent users, verify mobile performance
              </div>
              <div>
                <strong>Integration Testing:</strong> Confirm data accuracy across systems, test
                during system startups/shutdowns
              </div>
            </div>
          </div>
        </CardContent>
