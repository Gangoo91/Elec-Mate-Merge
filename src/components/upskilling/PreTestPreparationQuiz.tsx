  ...
  const questions: QuizQuestion[] = [
    {
      ...
      correctAnswer: 1,
      explanation:
        'Damaged leads can give false readings or cause shock - this is the primary safety and accuracy concern when using test equipment.',
    },
    {
      id: 2,
      ...
      correctAnswer: 2,
      explanation:
        "Previous test records or EICRs provide essential information about the installation's history, previous faults, and testing requirements.",
    },
    {
      id: 3,
    ...
    },
    {
      ...
      correctAnswer: 2,
      explanation:
        'Guessing circuit layout instead of reviewing documents is NOT part of proper pre-test preparation - you should always review available documentation.',
    },
  ];
    ...
    <Card className="bg-gradient-to-br from-green-900/20 to-teal-900/20 border-green-500/30">
      ...
      <CardContent className="text-gray-300 space-y-6">
        <div className="bg-gradient-to-r from-gray-800/50 to-gray-900/50 p-4 rounded-lg border border-gray-700/30">
          <h4 className="font-semibold text-green-400 mb-3">Question {currentQuestion + 1}</h4>
