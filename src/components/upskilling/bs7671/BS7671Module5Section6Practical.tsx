    ...
    <div className="space-y-6">
      ...
      <Card className="bg-elec-gray border-transparent">
        ...
        <CardContent className="text-foreground space-y-6">
          <p>
            Follow this systematic approach to ensure proper environmental protection in accordance
      ...
      <Card className="bg-elec-gray border-transparent">
        ...
        <CardContent className="text-foreground space-y-4">
          <p>
            Select the appropriate IP rating based on the installation environment and BS7671
            requirements.
          </p>
            ...
            <div className="grid gap-3 min-w-full">
              {ipGuidance.map((ip, index) => (
                ...
                >
                  <Badge
                    variant="secondary"
                    className="bg-elec-yellow text-elec-dark font-bold w-fit"
                  >
                    {ip.rating}
                  </Badge>
          ...
          <div className="bg-blue-950/20 p-4 rounded-lg border border-blue-800/30 mt-6">
            ...
            <p className="text-gray-300 text-sm">
              ...
              its operation is not impaired by the environmental conditions to which it is likely to
              be exposed.
            </p>
          </div>
        </CardContent>
