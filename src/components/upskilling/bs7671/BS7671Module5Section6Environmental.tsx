...
const BS7671Module5Section6Environmental = () => {
  const environmentalCodes = [
    ...
    },
    {
      ...
      levels: [
        'AE1: Negligible',
        'AE2: Small objects (≥2.5mm)',
        'AE3: Very small objects (≥1mm)',
        'AE4: Light dust',
        'AE5: Moderate dust',
        'AE6: Heavy dust',
      ],
    ...
    <div className="space-y-6">
      ...
      <Card className="bg-elec-gray border-transparent">
        ...
        <CardContent className="text-foreground space-y-6">
          <p>
            BS7671 uses specific codes to classify environmental conditions. Understanding these
            codes is essential for selecting appropriate equipment and installation methods.
          </p>
      ...
      <Card className="bg-elec-gray border-transparent">
        ...
        <CardContent className="text-foreground space-y-4">
          <p>
            Temperature is a critical environmental factor affecting cable performance, insulation
            properties, and equipment operation. BS7671 defines specific temperature
            classifications.
          </p>
          ...
          <div className="grid gap-3">
            {temperatureCodes.map((temp, index) => (
              <div
                key={index}
                className="flex flex-col sm:flex-row sm:items-center gap-3 p-3 bg-elec-dark rounded-lg border border-gray-600"
              >
          ...
          <div className="bg-yellow-950/20 p-4 rounded-lg border border-yellow-800/30 mt-4">
            ...
            <p className="text-gray-300 text-sm">
              Cable current-carrying capacity must be derated for high ambient temperatures. Refer
              to BS7671 Appendix 4 for derating factors.
            </p>
          </div>
        </CardContent>
      </Card>
