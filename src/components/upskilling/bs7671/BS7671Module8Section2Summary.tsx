      ...
      <CardContent className="text-foreground space-y-6">
        <div className="bg-elec-dark p-4 rounded-md border border-gray-600">
          <h5 className="text-elec-yellow font-semibold mb-3">
            Key Documentation Competencies Mastered:
          </h5>
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              ...
              <ul className="text-sm space-y-1">
                ...
                <li>
                  • Digital integration maintaining legal compliance and professional standards
                </li>
              </ul>
            </div>
            <div>
        ...
        <div className="bg-elec-dark p-4 rounded-md border border-gray-600">
          ...
          <div className="grid md:grid-cols-4 gap-4">
            ...
            <div className="bg-gray-800 p-3 rounded text-center">
              ...
              <p className="text-xs">
                Precise calculations and comprehensive verification procedures
              </p>
            </div>
            <div className="bg-gray-800 p-3 rounded text-center">
              <Award className="h-8 w-8 text-elec-yellow mx-auto mb-2" />
            ...
            <div className="bg-gray-800 p-3 rounded text-center">
              ...
              <p className="text-xs">
                Systematic approach to error prevention and quality improvement
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-elec-dark p-4 rounded-md border border-gray-600">
          <h5 className="text-elec-yellow font-semibold mb-3">
            Reference Tools and Resources Mastery:
          </h5>
          <div className="space-y-3">
            <div className="bg-gray-800 p-3 rounded border-l-4 border-green-400">
              ...
              <p className="text-sm">
                Efficient use of derating factor charts, voltage drop calculators, and installation
                method references for rapid, accurate design verification
              </p>
            </div>
            <div className="bg-gray-800 p-3 rounded border-l-4 border-blue-400">
              ...
              <p className="text-sm">
                Seamless integration of modern technology with traditional documentation
                requirements, maintaining accuracy while improving efficiency
              </p>
            </div>
            <div className="bg-gray-800 p-3 rounded border-l-4 border-purple-400">
              ...
              <p className="text-sm">
                Commitment to continuous learning, staying current with regulatory changes, and
        ...
        <div className="bg-elec-dark p-4 rounded-md border border-gray-600">
          <h5 className="text-elec-yellow font-semibold mb-3">
            Implementation Roadmap for Professional Practice:
          </h5>
        ...
        <div className="bg-elec-dark p-4 rounded-md border border-gray-600">
          <h5 className="text-elec-yellow font-semibold mb-3">
            Professional Impact and Value Creation:
          </h5>
          <div className="grid md:grid-cols-2 gap-6">
            <div>
        ...
        <div className="bg-elec-dark p-4 rounded-md border border-gray-600">
          ...
          <div className="space-y-3">
            <div className="bg-gray-800 p-3 rounded border-l-4 border-yellow-400">
              ...
              <p className="text-sm">
                Maintain awareness of Amendment updates, new standards, and evolving industry
                requirements through continuous professional development activities
              </p>
            </div>
            <div className="bg-gray-800 p-3 rounded border-l-4 border-green-400">
              <h6 className="font-bold text-green-400 mb-1">Embrace Technology Evolution</h6>
              <p className="text-sm">
                Continuously evaluate and adopt new technologies that enhance documentation
                accuracy, efficiency, and client service while maintaining professional standards
              </p>
            </div>
            <div className="bg-gray-800 p-3 rounded border-l-4 border-blue-400">
              <h6 className="font-bold text-blue-400 mb-1">Share Knowledge and Experience</h6>
              <p className="text-sm">
                Contribute to professional development of colleagues and industry advancement
                through knowledge sharing, mentoring, and best practice dissemination
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-elec-dark p-4 rounded-md border border-gray-600">
          ...
          <div className="bg-gradient-to-r from-yellow-600/20 to-orange-600/20 p-4 rounded-md border border-yellow-600/30">
            ...
            <p className="text-center text-sm text-gray-300">
              You have demonstrated comprehensive understanding of BS 7671 documentation
              requirements, quality control procedures, and professional best practices. This
              achievement represents significant advancement in your electrical professional
              competence and positions you as a leader in industry excellence.
            </p>
          </div>
        </div>
      </CardContent>
