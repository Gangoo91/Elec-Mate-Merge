      ...
      <CardContent className="text-foreground">
        ...
        <ul className="space-y-3">
          <li className="flex items-start gap-3">
            ...
            <span>
              Navigate and effectively use Zs tables for protective device coordination and
          ...
          <li className="flex items-start gap-3">
            <div className="w-2 h-2 bg-elec-yellow rounded-full mt-2 flex-shrink-0"></div>
            <span>
              Apply conductor sizing methodologies including correction factors for ambient
              temperature, grouping, and thermal insulation
            </span>
          </li>
          <li className="flex items-start gap-3">
            <div className="w-2 h-2 bg-elec-yellow rounded-full mt-2 flex-shrink-0"></div>
            <span>
              Calculate voltage drop for both single-phase and three-phase circuits using tabulated
              data and formulae
            </span>
          </li>
          <li className="flex items-start gap-3">
            <div className="w-2 h-2 bg-elec-yellow rounded-full mt-2 flex-shrink-0"></div>
            <span>
              Determine appropriate derating factors for cables in various installation conditions
            </span>
          </li>
          <li className="flex items-start gap-3">
            <div className="w-2 h-2 bg-elec-yellow rounded-full mt-2 flex-shrink-0"></div>
