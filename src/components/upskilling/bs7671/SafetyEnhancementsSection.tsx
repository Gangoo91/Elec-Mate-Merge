          ...
          <div className="space-y-4">
            <div className="bg-gray-800 p-4 rounded border-l-4 border-red-400">
              <div className="flex justify-between items-center mb-3">
                <h6 className="font-bold text-red-400 text-sm sm:text-base">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <h6 className="text-yellow-400 font-medium mb-2">
                  Personal Protection Enhancements:
                </h6>
        ...
        <div className="bg-elec-dark p-4 rounded-md border border-gray-600">
          ...
          <div className="space-y-3">
            <div className="bg-gray-800 p-3 rounded border-l-4 border-purple-400">
              ...
              <p className="text-sm">
                Advanced requirements for emergency power including renewable energy backup, smart
                grid disconnection procedures, and automated emergency response protocols.
              </p>
            </div>
            <div className="bg-gray-800 p-3 rounded border-l-4 border-blue-400">
              <h6 className="font-bold text-blue-400 mb-1">Smart Emergency Lighting</h6>
              <p className="text-sm">
                Integration of emergency lighting with building management systems, self-testing
                capabilities, and adaptive lighting patterns based on occupancy and emergency type.
              </p>
            </div>
            <div className="bg-gray-800 p-3 rounded border-l-4 border-green-400">
              <h6 className="font-bold text-green-400 mb-1">Communication System Integration</h6>
              <p className="text-sm">
                Enhanced requirements for emergency communication systems integration with
                electrical installations, including public address, fire alarm, and security system
                coordination.
              </p>
            </div>
          </div>
