      ...
      <CardContent className="text-foreground space-y-6">
        <div className="bg-elec-dark p-4 rounded-md border border-gray-600">
          <h5 className="text-elec-yellow font-semibold mb-3">
            Systematic Conductor Selection Process:
          </h5>
          <div className="grid gap-4">
            <div className="bg-gray-800 p-3 rounded border-l-4 border-blue-400">
              ...
              <p className="text-sm mb-2">
                Determine the design current based on the load to be served, including diversity
            ...
            <div className="bg-gray-800 p-3 rounded border-l-4 border-green-400">
              ...
              <p className="text-sm mb-2">
                Select protective device such that In ≥ Ib and coordinate with circuit requirements.
              </p>
              <div className="text-xs bg-gray-900 p-2 rounded font-mono">
            ...
            <div className="bg-gray-800 p-3 rounded border-l-4 border-yellow-400">
              ...
              <p className="text-sm mb-2">
                Identify installation method from Table 4A2 based on cable route and support
                systems.
              </p>
            ...
            <div className="bg-gray-800 p-3 rounded border-l-4 border-purple-400">
              ...
              <p className="text-sm mb-2">
                Apply relevant correction factors for installation conditions.
              </p>
              <div className="text-xs bg-gray-900 p-2 rounded font-mono">
          ...
          <div className="grid gap-4 md:hidden">
            <div className="bg-gray-800 p-3 rounded border-l-4 border-red-400">
              ...
              <div className="text-sm space-y-1">
                <p>
                  <strong>20°C:</strong> 1.15 (cooler conditions)
                </p>
                <p>
                  <strong>30°C:</strong> 1.00 (standard reference)
                </p>
                <p>
                  <strong>40°C:</strong> 0.87 (warmer conditions)
                </p>
                <p>
                  <strong>50°C:</strong> 0.71 (hot environments)
                </p>
              </div>
            </div>
            ...
            <div className="bg-gray-800 p-3 rounded border-l-4 border-blue-400">
              ...
              <div className="text-sm space-y-1">
                <p>
                  <strong>2 circuits:</strong> 0.80
                </p>
                <p>
                  <strong>3 circuits:</strong> 0.70
                </p>
                <p>
                  <strong>4-5 circuits:</strong> 0.65
                </p>
                <p>
                  <strong>6-8 circuits:</strong> 0.60
                </p>
                <p>
                  <strong>9+ circuits:</strong> 0.50
                </p>
              </div>
            </div>
            ...
            <div className="bg-gray-800 p-3 rounded border-l-4 border-orange-400">
              ...
              <div className="text-sm space-y-1">
                <p>
                  <strong>100mm insulation:</strong> 0.88
                </p>
                <p>
                  <strong>200mm insulation:</strong> 0.78
                </p>
                <p>
                  <strong>300mm insulation:</strong> 0.70
                </p>
                <p>
                  <strong>400mm+ insulation:</strong> 0.63
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              ...
              <div className="bg-gray-800 p-3 rounded text-sm">
                <p>
                  <strong>Load:</strong> 32A ring final circuit
                </p>
                <p>
                  <strong>Protection:</strong> 32A Type B MCB
                </p>
                <p>
                  <strong>Installation:</strong> Method B1 (clipped direct)
                </p>
                <p>
                  <strong>Conditions:</strong> 35°C ambient, 2 circuits grouped
                </p>
                <p className="mt-2 text-elec-yellow">Calculation:</p>
                <p>It = 32 / (0.94 × 0.80) = 42.6A</p>
                <p>
                  <strong>Selected:</strong> 6mm² cable (46A capacity)
                </p>
              </div>
            </div>
            <div>
              ...
              <div className="bg-gray-800 p-3 rounded text-sm">
                <p>
                  <strong>Load:</strong> 8A lighting circuit
                </p>
                <p>
                  <strong>Protection:</strong> 10A Type B MCB
                </p>
                <p>
                  <strong>Installation:</strong> Method A1 (in conduit in wall)
                </p>
                <p>
                  <strong>Conditions:</strong> 30°C, 4 circuits, 200mm insulation
                </p>
                <p className="mt-2 text-elec-yellow">Calculation:</p>
                <p>It = 10 / (1.00 × 0.65 × 0.78) = 19.7A</p>
                <p>
                  <strong>Selected:</strong> 2.5mm² cable (23A capacity)
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-elec-dark p-4 rounded-md border border-gray-600">
          ...
          <div className="space-y-3">
            <div className="bg-gray-800 p-3 rounded border-l-4 border-purple-400">
              ...
              <p className="text-sm">
                For circuits feeding non-linear loads, consider harmonic currents and neutral
                conductor sizing requirements per Regulation 523.6.3.
              </p>
            </div>
            <div className="bg-gray-800 p-3 rounded border-l-4 border-green-400">
              <h6 className="font-bold text-green-400 mb-1">Motor Circuits</h6>
              <p className="text-sm">
                Account for starting currents, coordinate with motor protection, and consider
            ...
            <div className="bg-gray-800 p-3 rounded border-l-4 border-blue-400">
              ...
              <p className="text-sm">
                Consider spare capacity for future loads, especially in domestic installations for
                EV charging and heat pump additions.
              </p>
            </div>
          </div>
        </div>
