      ...
      <CardContent className="text-foreground space-y-6">
        <div className="bg-elec-dark p-4 rounded-md border border-gray-600">
          <h5 className="text-elec-yellow font-semibold mb-3">
            Voltage Drop Limits and Requirements:
          </h5>
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              ...
              <div className="bg-gray-800 p-3 rounded">
                <ul className="text-sm space-y-1">
                  <li>
                    • <strong>Maximum limit:</strong> 3% of nominal voltage
                  </li>
                  <li>
                    • <strong>At 230V:</strong> 6.9V maximum drop
                  </li>
                  <li>
                    • <strong>At 400V:</strong> 12V maximum drop (3-phase)
                  </li>
                  <li>
                    • <strong>Critical for:</strong> LED compatibility and dimming
                  </li>
                  <li>
                    • <strong>Emergency lighting:</strong> Enhanced requirements
                  </li>
                </ul>
              </div>
            </div>
            <div>
              ...
              <div className="bg-gray-800 p-3 rounded">
                <ul className="text-sm space-y-1">
                  <li>
                    • <strong>Maximum limit:</strong> 5% of nominal voltage
                  </li>
                  <li>
                    • <strong>At 230V:</strong> 11.5V maximum drop
                  </li>
                  <li>
                    • <strong>At 400V:</strong> 20V maximum drop (3-phase)
                  </li>
                  <li>
                    • <strong>Motor starting:</strong> Special considerations
                  </li>
                  <li>
                    • <strong>Combined circuits:</strong> Cumulative effects
                  </li>
                </ul>
              </div>
            </div>
        ...
        <div className="bg-elec-dark p-4 rounded-md border border-gray-600">
          ...
          <div className="grid gap-4 md:hidden">
            ...
            <div className="bg-gray-800 p-3 rounded border-l-4 border-green-400">
              ...
              <p className="text-sm">
                Balanced load: Line-to-line voltage drop. Unbalanced: Consider worst-case phase
                loading
              </p>
            </div>
            ...
            <div className="bg-gray-800 p-3 rounded border-l-4 border-yellow-400">
              ...
              <p className="text-sm">
                For reactive loads: R = resistance, X = reactance per metre, both from tables
              </p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              ...
              <div className="bg-gray-800 p-3 rounded text-sm">
                <p>
                  <strong>Circuit:</strong> 32A ring final, 2.5mm² T&E
                </p>
                <p>
                  <strong>Length:</strong> 50m total circuit length
                </p>
                <p>
                  <strong>Current:</strong> 20A design current
                </p>
                <p>
                  <strong>Cable data:</strong> 18 mV/A/m (from tables)
                </p>
                <p className="mt-2 text-elec-yellow">Calculation:</p>
                <p>Ring factor: Length/4 = 50/4 = 12.5m</p>
                <p>Vd = 18 × 20 × 12.5 / 1000 = 4.5V</p>
                <p>
                  <strong>Result:</strong> 4.5V &lt; 11.5V ✓ Compliant
                </p>
              </div>
            </div>
            <div>
              ...
              <div className="bg-gray-800 p-3 rounded text-sm">
                <p>
                  <strong>Circuit:</strong> 15kW motor, 400V 3-phase
                </p>
                <p>
                  <strong>Cable:</strong> 4mm² SWA, 80m length
                </p>
                <p>
                  <strong>Current:</strong> 28A full load
                </p>
                <p>
                  <strong>Cable data:</strong> 11 mV/A/m (from tables)
                </p>
                <p className="mt-2 text-elec-yellow">Calculation:</p>
                <p>Vd = √3 × 11 × 28 × 80 / 1000 = 13.4V</p>
                <p>
                  <strong>Result:</strong> 13.4V &lt; 20V ✓ Compliant
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-3">
            <div className="bg-gray-800 p-3 rounded border-l-4 border-red-400">
              ...
              <p className="text-sm mb-2">
                Starting currents can be 6-8 times full load current, causing temporary voltage
                dips:
              </p>
            ...
            <div className="bg-gray-800 p-3 rounded border-l-4 border-green-400">
              ...
              <p className="text-sm mb-2">
                LED lights are sensitive to voltage variations and require special attention:
              </p>
              <ul className="text-xs space-y-1">
        ...
        <div className="bg-elec-dark p-4 rounded-md border border-gray-600">
          ...
          <div className="overflow-x-auto">
            ...
            <p className="text-xs mt-2 text-gray-400">
              *Approximate maximum length for typical loading to stay within 5% voltage drop
            </p>
          </div>
        </div>
      </CardContent>
