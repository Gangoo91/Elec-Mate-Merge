    ...
    <div className="space-y-6">
      ...
      <Card className="bg-elec-gray border-transparent">
        ...
        <CardContent className="text-foreground space-y-4">
          <p>
            Environmental protection is a fundamental requirement of BS7671, ensuring electrical
            installations remain safe and functional throughout their operational life. Key
      ...
      <Card className="bg-elec-gray border-transparent">
        ...
        <CardContent className="text-foreground space-y-4">
          <p>
            These BS7671 regulations are particularly relevant to environmental protection
            requirements:
          </p>
          ...
          <div className="grid gap-3">
            {regulations.map((reg, index) => (
              <div
                key={index}
                className="flex items-center gap-3 p-3 bg-elec-dark rounded-lg border border-gray-600"
              >
