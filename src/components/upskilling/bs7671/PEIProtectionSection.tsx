      ...
      <CardContent className="text-foreground space-y-4">
        <div className="bg-elec-dark p-4 rounded-md border border-gray-600">
          <h5 className="text-elec-yellow font-semibold mb-3">
            Anti-Islanding Protection (G98/G99 Compliance):
          </h5>
          <div className="grid md:grid-cols-2 gap-4">
            <div>
              ...
              <ul className="text-sm space-y-1">
                <li>
                  • <strong>Voltage vector shift:</strong> 2.5° threshold detection
                </li>
                <li>
                  • <strong>Rate of change of frequency (ROCOF):</strong> 1Hz/s limit
                </li>
                <li>
                  • <strong>Under/over voltage:</strong> 207V-253V (1φ), 358V-437V (3φ)
                </li>
                <li>
                  • <strong>Under/over frequency:</strong> 47.5Hz - 51.5Hz operational range
                </li>
                <li>
                  • <strong>Loss of mains (LOM):</strong> Impedance measurement techniques
                </li>
                <li>
                  • <strong>Voltage unbalance:</strong> Maximum 3% deviation allowed
                </li>
              </ul>
            </div>
            <div>
              <h6 className="text-yellow-400 font-medium mb-2">
                Response & Recovery Requirements:
              </h6>
              <ul className="text-sm space-y-1">
                <li>
                  • <strong>Disconnection time:</strong> Maximum 0.5 seconds
                </li>
                <li>
                  • <strong>Reconnection delay:</strong> 20 seconds minimum post-restoration
                </li>
                <li>
                  • <strong>Automatic reconnection:</strong> After stable grid conditions
                </li>
                <li>
                  • <strong>Manual reset:</strong> Required for certain fault conditions
                </li>
                <li>
                  • <strong>Event logging:</strong> Fault recording and timestamping
                </li>
                <li>
                  • <strong>Remote monitoring:</strong> Real-time status communication
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="bg-elec-dark p-4 rounded-md border border-gray-600">
          <h5 className="text-elec-yellow font-semibold mb-3">
            Bi-directional Protection Systems:
          </h5>
          <div className="grid md:grid-cols-2 gap-4">
            <div>
          ...
          <div className="space-y-3">
            <div className="bg-gray-800 p-3 rounded">
              ...
              <ol className="text-sm space-y-1">
                <li>
                  1. <strong>Immediate isolation:</strong> DC and AC disconnectors operated
                </li>
                <li>
                  2. <strong>Battery isolation:</strong> BMS emergency shutdown activated
                </li>
                <li>
                  3. <strong>Grid disconnection:</strong> Generation meter isolation
                </li>
                <li>
                  4. <strong>Load shedding:</strong> Non-critical loads automatically disconnected
                </li>
                <li>
                  5. <strong>System safe state:</strong> All energy sources isolated and secured
                </li>
                <li>
                  6. <strong>Emergency services:</strong> Notification protocols activated
                </li>
              </ol>
            </div>
            <div className="bg-gray-800 p-3 rounded">
