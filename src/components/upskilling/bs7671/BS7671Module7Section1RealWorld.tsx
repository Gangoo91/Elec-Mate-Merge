      ...
      <CardContent className="text-foreground space-y-4">
        <div className="p-4 bg-gradient-to-r from-blue-900/20 to-purple-900/20 border border-blue-600 rounded-lg">
          <h4 className="font-semibold text-foreground mb-4">
            The Hotel Bathroom Refurbishment Challenge
          </h4>
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-foreground mb-4">
                A boutique hotel is refurbishing 50 en-suite bathrooms to meet modern standards
                whilst maintaining luxury appeal. Each bathroom features a large walk-in shower,
                standalone bathtub, and premium finishes. The electrical contractor must ensure full
                BS 7671 compliance whilst accommodating the client's design requirements.
              </p>
              <p className="text-foreground">
                The challenge: the original 1980s installation has numerous non-compliances, and the
                new design includes integrated LED lighting, heated towel rails, smart mirrors, and
            ...
            <div>
              ...
              <p className="text-foreground mb-4">
                The electrical team conducts detailed zone measurements for each bathroom layout.
                They discover that the walk-in shower configuration creates an extended Zone 1 area
                that affects the placement of several proposed fixtures.
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-4">
                <div className="text-center p-3 bg-green-600/10 border border-green-600/30 rounded">
                  ...
                  <div className="text-xs text-green-200">
                    Bathrooms requiring zone recalculation
                  </div>
                </div>
            ...
            <div>
              ...
              <p className="text-foreground mb-4">
                Several significant modifications are required to achieve compliance whilst
                maintaining the luxury aesthetic:
              </p>
            ...
            <div>
              <h5 className="font-medium text-red-200 mb-3">
                Unexpected Challenge: Historic Building Constraints
              </h5>
              <p className="text-foreground mb-4">
                During installation, the team discovers that the building's listed status restricts
                cable routing options. Creative solutions are required to achieve BS 7671 compliance
                without damaging historic features.
              </p>
            ...
            <div>
              ...
              <p className="text-foreground mb-4">
                Despite the challenges, the project achieves full compliance with BS 7671 whilst
                exceeding the client's aesthetic expectations. The systematic approach to zone
                analysis and creative problem-solving results in a successful installation.
              </p>
            ...
            <div className="space-y-3">
              <div>
                <p className="text-foreground font-medium text-sm">
                  How would you handle client requests that conflict with BS 7671 requirements?
                </p>
                <p className="text-gray-400 text-xs mt-1">
                  Consider professional obligations, safety responsibilities, and commercial
                  pressures.
                </p>
              </div>
              <div>
                <p className="text-foreground font-medium text-sm">
                  What additional considerations apply when working in listed buildings?
                </p>
                <p className="text-gray-400 text-xs mt-1">
                  Think about conservation requirements, alternative installation methods, and
                  documentation needs.
                </p>
              </div>
              <div>
                <p className="text-foreground font-medium text-sm">
                  How can zone analysis be communicated effectively to non-technical clients?
                </p>
                <p className="text-gray-400 text-xs mt-1">
                  Consider visual aids, practical examples, and the importance of explaining safety
                  benefits.
                </p>
              </div>
            </div>
