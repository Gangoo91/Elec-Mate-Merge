          ...
          <div className="space-y-3">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-foreground text-sm">
                  Classify medical locations into Groups 0, 1, and 2 based on risk levels and apply
                  appropriate electrical system requirements for each group.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-foreground text-sm">
                  Design and implement medical IT systems with isolating transformers, insulation
                  monitoring devices, and appropriate alarm systems for Group 2 locations.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-foreground text-sm">
                  Apply selective coordination principles to ensure that protective devices operate
                  in the correct sequence to minimise disruption during fault conditions.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-3">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-foreground text-sm">
                  Design robust industrial electrical systems with appropriate earthing, protection
                  coordination, and emergency supply arrangements.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-foreground text-sm">
                  Implement UPS systems, standby generators, and automatic changeover systems to
                  ensure continuity of critical electrical supplies.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-foreground text-sm">
                  Integrate fire safety systems, emergency lighting, access control, and energy
                  management within commercial electrical installations.
                </p>
              </div>
            </div>
          </div>
