      ...
      <CardContent className="text-foreground space-y-4">
          ...
          <div className="space-y-3">
            <div className="p-4 bg-elec-dark border border-green-600/50 rounded-lg">
              ...
              <ul className="text-sm space-y-1 text-foreground">
                <li>
                  • UV protection requires specialised cable materials and UV-stable conduit systems
                </li>
                <li>
                  • IP ratings must match specific environmental conditions (IP44 minimum outdoors,
                  IP65 for high-pressure areas)
                </li>
                <li>
                  • Temperature cycling and moisture ingress are critical design considerations
                </li>
                <li>
                  • Chemical resistance is essential in agricultural environments with ammonia
                  exposure
                </li>
              </ul>
            </div>
            ...
            <div className="p-4 bg-elec-dark border border-blue-600/50 rounded-lg">
              ...
              <ul className="text-sm space-y-1 text-foreground">
                ...
                <li>
                  • Regular inspection schedules (6-monthly minimum) vital for early problem
                  detection
                </li>
              </ul>
            </div>
          ...
          <div className="space-y-3">
            <div className="p-4 bg-elec-dark border border-amber-600/50 rounded-lg">
              ...
              <ul className="text-sm space-y-1 text-foreground">
                ...
                <li>
                  • Lower voltage thresholds apply due to animal sensitivity (25V touch, 10V step)
                </li>
        ...
        <div className="mt-6 p-4 bg-elec-dark border border-elec-yellow rounded-lg">
          ...
          <p className="text-foreground text-sm">
            Success in outdoor and agricultural installations depends on thorough environmental
            assessment, appropriate material selection, comprehensive protection systems, and
            regular maintenance. The higher initial cost of proper materials and protection is
            always justified by improved safety, reliability, and reduced long-term maintenance
            costs.
          </p>
        </div>
      </CardContent>
