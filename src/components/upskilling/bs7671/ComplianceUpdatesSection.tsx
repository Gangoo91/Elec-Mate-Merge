      ...
      <CardContent className="text-foreground space-y-6">
        <div className="bg-elec-dark p-4 rounded-md border border-gray-600">
          ...
          <div className="hidden lg:block">
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div>
                <h6 className="text-yellow-400 font-medium mb-2">
                  Certification and Assessment Updates:
                </h6>
                <ul className="text-sm space-y-1">
        ...
        <div className="bg-elec-dark p-4 rounded-md border border-gray-600">
          <h5 className="text-elec-yellow font-semibold mb-3">
            Updated Documentation and Certification Requirements:
          </h5>
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <h6 className="text-yellow-400 font-medium mb-2">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-gray-800 p-3 rounded border-l-4 border-green-400">
              <h6 className="font-bold text-green-400 mb-2">
                Local Authority Coordination Requirements
              </h6>
              <ul className="text-sm space-y-1">
        ...
        <div className="bg-elec-dark p-4 rounded-md border border-gray-600">
          ...
          <div className="space-y-3">
            <div className="bg-gray-800 p-3 rounded border-l-4 border-blue-400">
              ...
              <p className="text-sm">
                Requirement for ISO 9001 compliance with additional modules for smart system
                installation, cybersecurity management, and technology lifecycle management.
              </p>
            </div>
            <div className="bg-gray-800 p-3 rounded border-l-4 border-yellow-400">
              <h6 className="font-bold text-yellow-400 mb-1">
                Third-Party Verification Requirements
              </h6>
              <p className="text-sm">
                Mandatory independent verification for complex smart installations, renewable energy
                systems over 50kW, and critical infrastructure electrical installations.
              </p>
            </div>
            <div className="bg-gray-800 p-3 rounded border-l-4 border-green-400">
              <h6 className="font-bold text-green-400 mb-1">Continuous Monitoring and Reporting</h6>
              <p className="text-sm">
                Requirements for ongoing performance monitoring, annual compliance reporting, and
                proactive maintenance scheduling for smart and renewable energy systems.
              </p>
            </div>
          </div>
        </div>
