  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-gray-300 mb-3">
        Prioritise your visual inspection efforts on these key areas where defects are most commonly
        found:
      </p>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
        {focusAreas.map((area, index) => (
          <div
            key={index}
            className="flex items-center justify-between bg-[#323232] rounded-lg p-3"
          >
