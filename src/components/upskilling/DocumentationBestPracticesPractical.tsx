  ...
  const qualityTemplates = [
    {
      ...
      template: {
        ...
        validation:
          'Check units, verify against protective device rating, confirm within instrument accuracy',
      },
      commonErrors: [
        'Missing units',
    ...
    },
    {
      ...
      template: {
        ...
        example:
          'Kitchen RFC → Socket outlet cracked exposing live terminal → Risk of electric shock → C1 → Replace socket outlet immediately',
        validation:
          'Verify code appropriateness, check clarity of description, confirm actionable remedial instruction',
      },
      commonErrors: [
        'Vague locations',
    ...
    },
    {
      ...
      template: {
        ...
        example:
          'L1 → Ground floor lighting → 1.5mm² T&E, Method C → 6A Type B MCB → 3.2A → All tests satisfactory',
        validation:
          'Verify cable size matches protection, check load calculation, confirm test result consistency',
      },
      commonErrors: [
        'Mismatched cable/protection',
        'Missing load data',
    ...
    },
    {
      ...
      template: {
        ...
        example:
          'J. Smith → C&G 2391, 18th Edition → NICEIC 12345 → 01234 567890 → [Signature] → 15/08/2024',
        validation:
          'Check current registration status, verify qualification currency, ensure clear signature',
      },
      commonErrors: [
  ...
  const errorPrevention = [
    {
      ...
      causes: [
        'Copying between handwritten notes and certificates',
        'Reading instrument displays incorrectly',
        'Misunderstanding circuit references',
      ],
    ...
    },
    {
      ...
      causes: [
        ...
        'Forgotten documentation sections',
    ...
    },
    {
      ...
      causes: [
        'Multiple inspectors with different approaches',
        'Changing standards interpretation',
    ...
    <Card className="bg-elec-gray border-transparent">
      ...
      <CardContent className="space-y-6">
        <div className="space-y-4">
          ...
          <div className="bg-[#323232] rounded-lg p-6 space-y-4">
            <p className="text-foreground leading-relaxed mb-4">
              Systematic workflows ensure consistent documentation quality while optimizing
              efficiency. These proven approaches support professional electrical certification
        ...
        <div className="space-y-4">
          ...
          <div className="bg-[#323232] rounded-lg p-6 space-y-4">
            <p className="text-foreground leading-relaxed mb-4">
              Structured templates ensure consistency and completeness while reducing errors. These
              proven formats support accurate and professional documentation across all certificate
              types.
            </p>
            <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-1 gap-4 text-sm">
                    <div className="space-y-3">
                      <div>
                        ...
                        <p className="text-foreground bg-[#2a2a2a] p-2 rounded font-mono text-xs">
                          {template.template.structure}
                        </p>
                      </div>
                      <div>
                        <p className="text-green-300 font-medium mb-1">Example:</p>
                        <p className="text-foreground bg-[#2a2a2a] p-2 rounded text-xs">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-[#323232] rounded-lg p-6 space-y-4">
            <p className="text-foreground leading-relaxed mb-4">
              Systematic error prevention protects professional reputation and ensures client
              safety. These strategies address common error types with proven prevention and
              detection methods.
            </p>
            <div className="space-y-4">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-[#323232] rounded-lg p-6 space-y-4">
            <p className="text-gray-300 leading-relaxed mb-4">
              Clear client communication ensures understanding, supports decision-making, and
              maintains professional relationships. These approaches address different scenarios
        ...
        <div className="space-y-4">
          ...
          <div className="bg-[#323232] rounded-lg p-6 space-y-4">
            <p className="text-gray-300 leading-relaxed mb-4">
              Systematic continuous improvement maintains and enhances documentation quality while
              supporting professional development. This framework ensures ongoing excellence in
                    ...
                    <div className="space-y-3">
                      <div>
                        <p className="text-purple-300 font-medium mb-1">
                          Frequency: <span className="text-gray-300">{activity.frequency}</span>
                        </p>
                      </div>
                      <div>
