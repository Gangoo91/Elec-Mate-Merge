        ...
        <Accordion type="single" collapsible className="w-full space-y-2">
          <AccordionItem value="item-1" className="border-gray-600">
            ...
            <AccordionContent className="text-gray-300">
              <p className="mb-3">
                Maintenance frequency depends on system type, location, and environmental factors:
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                <div className="bg-blue-900/20 p-3 rounded border border-blue-500/30">
                  ...
                  <ul className="list-disc list-inside space-y-1">
                    <li>
                      <strong>Monthly:</strong> Performance monitoring review
                    </li>
                    <li>
                      <strong>Quarterly:</strong> Visual inspection
                    </li>
                    <li>
                      <strong>Bi-annually:</strong> Detailed electrical checks
                    </li>
                    <li>
                      <strong>Annually:</strong> Comprehensive testing and cleaning
                    </li>
                  </ul>
                </div>
                <div className="bg-green-900/20 p-3 rounded border border-green-500/30">
                  ...
                  <ul className="list-disc list-inside space-y-1">
                    <li>
                      <strong>Weekly:</strong> Monitoring system checks
                    </li>
                    <li>
                      <strong>Monthly:</strong> Visual inspection and cleaning assessment
                    </li>
                    <li>
                      <strong>Quarterly:</strong> Electrical testing and calibration
                    </li>
                    <li>
                      <strong>Annually:</strong> Full system commissioning re-test
                    </li>
                  </ul>
                </div>
              </div>
              <div className="mt-3 bg-yellow-900/20 p-3 rounded border border-yellow-500/30">
                ...
                <p className="text-gray-300 text-sm">
                  Increase frequency in dusty, coastal, or high-pollen areas. After severe weather
                  events, conduct immediate inspections.
                </p>
              </div>
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="item-2" className="border-gray-600">
            ...
            <AccordionContent className="text-gray-300">
              <p className="mb-3">
                Visual inspections form the foundation of preventive maintenance:
              </p>
              <div className="space-y-3 text-sm">
                <div className="bg-purple-900/20 p-3 rounded border border-purple-500/30">
                  <h5 className="text-purple-400 font-medium mb-2">
                    Panel and Mounting Assessment:
                  </h5>
                  <ul className="list-disc list-inside space-y-1">
          ...
          <AccordionItem value="item-3" className="border-gray-600">
            ...
            <AccordionContent className="text-gray-300">
              <p className="mb-3">
                Cleaning requirements vary significantly based on location and environmental
                conditions:
              </p>
              <div className="space-y-3 text-sm">
                <div className="bg-green-900/20 p-3 rounded border border-green-500/30">
                  ...
                  <ul className="list-disc list-inside space-y-1">
                    <li>
                      <strong>Output reduction:</strong> {'>'} 5% decrease compared to clean
                      reference
                    </li>
                    <li>
                      <strong>String imbalance:</strong> Significant current differences between
                      strings
                    </li>
                    <li>
                      <strong>Visual assessment:</strong> Obvious soiling, bird droppings, or dust
                      accumulation
                    </li>
                    <li>
                      <strong>Weather patterns:</strong> Extended dry periods in dusty areas
                    </li>
                  </ul>
                </div>
                <div className="bg-yellow-900/20 p-3 rounded border border-yellow-500/30">
                  ...
                  <ul className="list-disc list-inside space-y-1">
                    <li>
                      <strong>Coastal areas:</strong> Salt spray and seabird activity - monthly
                      assessment
                    </li>
                    <li>
                      <strong>Agricultural regions:</strong> Dust and pollen seasons - bi-monthly
                      checks
                    </li>
                    <li>
                      <strong>Industrial areas:</strong> Particulate pollution - monthly monitoring
                    </li>
                    <li>
                      <strong>Urban environments:</strong> General pollution and construction dust -
                      quarterly review
                    </li>
                  </ul>
                </div>
          ...
          <AccordionItem value="item-4" className="border-gray-600">
            ...
            <AccordionContent className="text-gray-300">
              <p className="mb-3">
                Early detection of degradation prevents major failures and optimises system
                lifespan:
              </p>
              <div className="space-y-3 text-sm">
                <div className="bg-red-900/20 p-3 rounded border border-red-500/30">
                  ...
                  <ul className="list-disc list-inside space-y-1">
                    <li>
                      <strong>Gradual output decline:</strong> {'>'} 0.8% per year suggests
                      premature degradation
                    </li>
                    <li>
                      <strong>String imbalance:</strong> {'>'} 5% variation between similar strings
                    </li>
                    <li>
                      <strong>Voltage reduction:</strong> Declining Voc measurements over time
                    </li>
                    <li>
                      <strong>Efficiency loss:</strong> Reducing performance ratio below 80%
                    </li>
                  </ul>
                </div>
                <div className="bg-orange-900/20 p-3 rounded border border-orange-500/30">
                  ...
                  <ul className="list-disc list-inside space-y-1">
                    <li>
                      <strong>Discolouration:</strong> Browning or darkening of cells
                    </li>
                    <li>
                      <strong>Delamination:</strong> Separation of layers, typically at edges
                    </li>
                    <li>
                      <strong>Hotspots:</strong> Thermal imaging showing localised heating
                    </li>
                    <li>
                      <strong>Corrosion:</strong> Frame oxidation, connection deterioration
                    </li>
                  </ul>
                </div>
                <div className="bg-purple-900/20 p-3 rounded border border-purple-500/30">
                  ...
                  <ul className="list-disc list-inside space-y-1">
                    <li>
                      <strong>Efficiency decline:</strong> Reducing conversion efficiency over time
                    </li>
                    <li>
                      <strong>Frequent errors:</strong> Increasing fault codes or restart cycles
                    </li>
                    <li>
                      <strong>Overheating:</strong> Thermal protection activation
                    </li>
                    <li>
                      <strong>Component failure:</strong> Capacitor swelling, fan noise, display
                      issues
                    </li>
                  </ul>
                </div>
          ...
          <AccordionItem value="item-5" className="border-gray-600">
            ...
            <AccordionContent className="text-gray-300">
              <p className="mb-3">
                Firmware updates are critical for security, performance, and regulatory compliance:
              </p>
              <div className="space-y-3 text-sm">
                <div className="bg-blue-900/20 p-3 rounded border border-blue-500/30">
                  ...
                  <ul className="list-disc list-inside space-y-1">
                    <li>
                      <strong>Grid compliance:</strong> New regulations (G99, G100) implementation
                    </li>
                    <li>
                      <strong>Performance optimisation:</strong> Improved MPPT algorithms and
                      efficiency
                    </li>
                    <li>
                      <strong>Security patches:</strong> Addressing cybersecurity vulnerabilities
                    </li>
                    <li>
                      <strong>Bug fixes:</strong> Resolving known operational issues
                    </li>
                    <li>
                      <strong>Feature additions:</strong> New functionality and communication
                      protocols
                    </li>
                  </ul>
                </div>
                <div className="bg-green-900/20 p-3 rounded border border-green-500/30">
                  ...
                  <ul className="list-disc list-inside space-y-1">
                    <li>
                      <strong>Inverters:</strong> Check for updates quarterly, apply annually
                    </li>
                    <li>
                      <strong>Optimisers:</strong> Update when inverter firmware is updated
                    </li>
                    <li>
                      <strong>Battery systems:</strong> Monitor monthly, update bi-annually
                    </li>
                    <li>
                      <strong>Monitoring systems:</strong> Enable automatic updates for non-critical
                      patches
                    </li>
                  </ul>
                </div>
          ...
          <AccordionItem value="item-6" className="border-gray-600">
            ...
            <AccordionContent className="text-gray-300">
              <p className="mb-3">
                Comprehensive record-keeping ensures warranty compliance, facilitates
                troubleshooting, and demonstrates due diligence:
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
              ...
              <div className="mt-3 bg-purple-900/20 p-3 rounded border border-purple-500/30">
                ...
                <p className="text-gray-300">
                  Use cloud-based CMMS (Computerised Maintenance Management Systems) for automated
                  scheduling, mobile access, and compliance reporting. Include photos, thermal
                  images, and GPS coordinates for field documentation.
                </p>
              </div>
            </AccordionContent>
          </AccordionItem>
