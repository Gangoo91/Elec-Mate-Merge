...
const SystemComparisonPractical = () => {
  ...
  const activeTab = searchParams.get('compare') || 'decision';
  const setActiveTab = (tab: string) => setSearchParams({ compare: tab }, { replace: false });
      ...
      <CardContent>
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            ...
            <div className="bg-elec-dark p-4 rounded-lg">
              ...
              <div className="space-y-3 text-sm text-gray-300">
                ...
                <div className="border-l-4 border-green-500 pl-4">
                  ...
                  <p>
                    Limited budget? If YES → Grid-tied. If NO → Consider hybrid for future-proofing
                  </p>
                </div>
          ...
          <TabsContent value="calculator" className="space-y-4">
            <div className="bg-elec-dark p-4 rounded-lg">
              <h3 className="text-elec-yellow font-semibold mb-3">
                System Cost Comparison Calculator
              </h3>
              <div className="grid grid-cols-3 gap-4 text-sm">
                <div className="bg-gray-800 p-3 rounded">
                  ...
                  <ul className="text-gray-300 space-y-1">
                    ...
                    <li>
                      <strong className="text-elec-yellow">Total: £6,200</strong>
                    </li>
                ...
                <div className="bg-gray-800 p-3 rounded">
                  ...
                  <ul className="text-gray-300 space-y-1">
                    ...
                    <li>
                      <strong className="text-elec-yellow">Total: £13,500</strong>
                    </li>
                    <li>ROI: Variable</li>
                  </ul>
                </div>
                <div className="bg-gray-800 p-3 rounded">
                  ...
                  <ul className="text-gray-300 space-y-1">
                    ...
                    <li>
                      <strong className="text-elec-yellow">Total: £12,200</strong>
                    </li>
            ...
            <div className="space-y-3">
              <div className="bg-elec-dark p-4 rounded-lg">
                ...
                <p className="text-gray-300 text-sm mb-2">
                  4-bed house, reliable grid, £4,000 annual electricity bill
                </p>
                <p className="text-foreground text-sm">
                  <strong>Recommendation:</strong> Grid-tied system. Fastest payback, minimal
                  maintenance, can add batteries later if needed.
                </p>
              </div>
              <div className="bg-elec-dark p-4 rounded-lg">
                <h4 className="text-elec-yellow font-medium mb-2">Scenario 2: Rural Property</h4>
                <p className="text-gray-300 text-sm mb-2">
                  Remote location, frequent outages, high connection costs
                </p>
                <p className="text-foreground text-sm">
                  <strong>Recommendation:</strong> Off-grid system with generator backup. Long-term
                  cost savings despite higher initial investment.
                </p>
              </div>
              <div className="bg-elec-dark p-4 rounded-lg">
                <h4 className="text-elec-yellow font-medium mb-2">Scenario 3: Home Office</h4>
                <p className="text-gray-300 text-sm mb-2">
                  Business operation, cannot afford power interruptions
                </p>
                <p className="text-foreground text-sm">
                  <strong>Recommendation:</strong> Hybrid system. Grid-tied benefits with guaranteed
