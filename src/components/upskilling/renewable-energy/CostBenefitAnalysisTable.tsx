    ...
    <Card className="bg-elec-gray border-transparent">
      <CardHeader>
        <CardTitle className="text-foreground">
          Capital Cost and Economy of Scale Analysis
        </CardTitle>
      </CardHeader>
      <CardContent className="text-gray-300 space-y-4">
        <div className="bg-blue-600/10 border border-blue-600/20 rounded-md p-4">
          ...
          <p className="text-sm">
            ...
            spread across more capacity, bulk purchasing power, and reduced installation complexity
            per kW.
          </p>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-green-900/20 p-4 rounded border border-green-500/30">
                ...
                <ul className="text-gray-300 space-y-2 text-sm">
                  <li>
                    • <strong>Typical cost:</strong> £1,200-£1,800 per kW installed
                  </li>
                  <li>
                    • <strong>4kW system:</strong> £5,000-£7,000 total
                  </li>
                  <li>
                    • <strong>Fixed costs:</strong> Higher proportion (scaffolding, design)
                  </li>
                  <li>
                    • <strong>VAT treatment:</strong> 0% VAT on systems ≤10kW (domestic)
                  </li>
                  <li>
                    • <strong>Financing:</strong> Personal loans, solar loans, cash
                  </li>
                  <li>
                    • <strong>Payback period:</strong> 7-12 years typically
                  </li>
                </ul>
              </div>
              <div className="bg-green-900/20 p-4 rounded border border-green-500/30">
                ...
                <ul className="text-gray-300 space-y-2 text-sm">
                  <li>
                    • <strong>Self-consumption:</strong> 40-70% typically
                  </li>
                  <li>
                    • <strong>Export income:</strong> SEG rates 4-15p/kWh
                  </li>
                  <li>
                    • <strong>Electricity offset:</strong> 28-35p/kWh domestic rates
                  </li>
                  <li>
                    • <strong>Annual savings:</strong> £400-£1,200 for 4kW system
                  </li>
                  <li>
                    • <strong>Maintenance:</strong> Minimal, mainly cleaning
                  </li>
                  <li>
                    • <strong>Monitoring:</strong> Basic app-based systems
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-orange-900/20 p-4 rounded border border-orange-500/30">
                ...
                <ul className="text-gray-300 space-y-2 text-sm">
                  <li>
                    • <strong>Reduced cost per kW:</strong> £800-£1,400 per kW installed
                  </li>
                  <li>
                    • <strong>50kW system:</strong> £40,000-£70,000 total
                  </li>
                  <li>
                    • <strong>Bulk purchasing:</strong> Better equipment prices
                  </li>
                  <li>
                    • <strong>VAT recovery:</strong> 20% reclaimable for VAT-registered businesses
                  </li>
                  <li>
                    • <strong>Capital allowances:</strong> 100% first-year allowance available
                  </li>
                  <li>
                    • <strong>Financing options:</strong> Asset finance, leasing, Power Purchase
                    Agreements
                  </li>
                </ul>
              </div>
              <div className="bg-orange-900/20 p-4 rounded border border-orange-500/30">
                ...
                <ul className="text-gray-300 space-y-2 text-sm">
                  <li>
                    • <strong>High self-consumption:</strong> 70-95% for well-matched systems
                  </li>
                  <li>
                    • <strong>Commercial electricity rates:</strong> 18-25p/kWh plus standing
                    charges
                  </li>
                  <li>
                    • <strong>Demand charge avoidance:</strong> Additional savings for larger users
                  </li>
                  <li>
                    • <strong>Grid services revenue:</strong> Frequency response, capacity markets
                  </li>
                  <li>
                    • <strong>Corporate PPA rates:</strong> Better than SEG for large export
                  </li>
                  <li>
                    • <strong>Tax benefits:</strong> Corporation tax relief on investments
                  </li>
                </ul>
              </div>
            </div>
