...
const RenewableEnergyFinancialCalculators = () => {
  ...
  const calculateROI = () => {
    const annualBenefit =
      roiValues.annualSavings + roiValues.segPayments - roiValues.maintenanceCosts;
  ...
  const calculateSystemSizing = () => {
    ...
    const annualSavings =
      annualGeneration * selfConsumption * 0.32 + annualGeneration * (1 - selfConsumption) * 0.12;
  ...
  const calculateNPV = () => {
    ...
    const irr =
      ((totalCashFlow / npvValues.initialInvestment) ** (1 / npvValues.systemLife) - 1) * 100;
  ...
  const calculateYield = () => {
    ...
    const locationMultiplier =
      yieldValues.location === 'north' ? 0.9 : yieldValues.location === 'south' ? 1.1 : 1.0;
    const orientationMultiplier =
      yieldValues.orientation === 'south'
        ? 1.0
        : yieldValues.orientation === 'southeast'
          ? 0.95
          : 0.85;
  ...
  const calculateIncentives = () => {
    ...
    const vatSavings =
      grantValues.propertyType === 'domestic'
        ? grantValues.baseSystemCost * 0.2 // 20% VAT saving on domestic
        : grantValues.vatRegistered && grantValues.propertyType === 'commercial'
          ? grantValues.baseSystemCost * 0.17
          : 0;
  ...
  return (
    <Card className="bg-elec-gray border-transparent">
      ...
      <CardContent>
        <div className="mb-6">
          <Label htmlFor="calculator-select" className="text-gray-300 mb-2 block">
            Select Calculator
          </Label>
          <Select value={activeCalculator} onValueChange={setActiveCalculator}>
            ...
            <SelectContent className="bg-elec-dark border-gray-600 z-50">
              <SelectItem
                value="roi"
                className="text-gray-300 focus:bg-elec-yellow focus:text-elec-dark"
              >
                ROI & Payback
              </SelectItem>
              <SelectItem
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="systemCost" className="text-gray-300">
                    System Cost (£)
                  </Label>
                  <Input
                    id="systemCost"
                    ...
                    onChange={(e) =>
                      setRoiValues({ ...roiValues, systemCost: Number(e.target.value) })
                    }
                ...
                <div className="space-y-2">
                  <Label htmlFor="annualSavings" className="text-gray-300">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setRoiValues({ ...roiValues, annualSavings: Number(e.target.value) })
                    }
                    className="bg-elec-dark border-gray-600 text-gray-300"
                  />
                </div>
                ...
                <div className="space-y-2">
                  <Label htmlFor="segPayments" className="text-gray-300">
                    Annual SEG Payments (£)
                  </Label>
                  <Input
                    id="segPayments"
                    ...
                    onChange={(e) =>
                      setRoiValues({ ...roiValues, segPayments: Number(e.target.value) })
                    }
                    className="bg-elec-dark border-gray-600 text-gray-300"
                  />
                </div>
                ...
                <div className="space-y-2">
                  <Label htmlFor="maintenanceCosts" className="text-gray-300">
                    Annual Maintenance (£)
                  </Label>
                  <Input
                    id="maintenanceCosts"
                    ...
                    onChange={(e) =>
                      setRoiValues({ ...roiValues, maintenanceCosts: Number(e.target.value) })
                    }
                    className="bg-elec-dark border-gray-600 text-gray-300"
                  />
                </div>
                ...
                <div className="space-y-2">
                  <Label htmlFor="discountRate" className="text-gray-300">
                    Discount Rate (%)
                  </Label>
                  <Input
                    id="discountRate"
                    ...
                    onChange={(e) =>
                      setRoiValues({ ...roiValues, discountRate: Number(e.target.value) })
                    }
                    className="bg-elec-dark border-gray-600 text-gray-300"
                  />
                </div>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-elec-dark p-4 rounded border border-gray-600 space-y-3">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-foreground font-semibold">
                      {roiResults.simplePayback} years
                    </span>
                  </div>
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-foreground font-semibold">
                      {roiResults.discountedPayback} years
                    </span>
                  </div>
                ...
                <div className="bg-blue-600/10 border border-blue-600/20 rounded-md p-3">
                  <p className="text-blue-400 text-sm">
                    <strong>2025/26 Update:</strong> Calculations reflect current SEG rates (12p/kWh
                    average), electricity prices (32p/kWh), and include 0.5% annual panel
                    degradation.
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setSizingValues({ ...sizingValues, propertyType: e.target.value })
                    }
                ...
                <div className="space-y-2">
                  <Label htmlFor="systemSize" className="text-gray-300">
                    System Size (kW)
                  </Label>
                  <Input
                    id="systemSize"
                    ...
                    onChange={(e) =>
                      setSizingValues({ ...sizingValues, systemSize: Number(e.target.value) })
                    }
                    className="bg-elec-dark border-gray-600 text-gray-300"
                  />
                </div>
                ...
                <div className="space-y-2">
                  <Label htmlFor="annualUsage" className="text-gray-300">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setSizingValues({ ...sizingValues, annualUsage: Number(e.target.value) })
                    }
                    className="bg-elec-dark border-gray-600 text-gray-300"
                  />
                </div>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-elec-dark p-4 rounded border border-gray-600 space-y-3">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-green-400 font-semibold">
                      {sizingResults.annualGeneration} kWh
                    </span>
                  </div>
          ...
          <div className="space-y-4 mt-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="initialInvestment" className="text-gray-300">
                    Initial Investment (£)
                  </Label>
                  <Input
                    ...
                    onChange={(e) =>
                      setNpvValues({ ...npvValues, initialInvestment: Number(e.target.value) })
                    }
                    className="bg-elec-dark border-gray-600 text-gray-300"
                  />
                </div>
                ...
                <div className="space-y-2">
                  <Label htmlFor="annualCashFlow" className="text-gray-300">
                    Annual Cash Flow (£)
                  </Label>
                  <Input
                    id="annualCashFlow"
                    ...
                    onChange={(e) =>
                      setNpvValues({ ...npvValues, annualCashFlow: Number(e.target.value) })
                    }
                    className="bg-elec-dark border-gray-600 text-gray-300"
                  />
                </div>
                ...
                <div className="space-y-2">
                  <Label htmlFor="npvDiscountRate" className="text-gray-300">
                    Discount Rate (%)
                  </Label>
                  <Input
                    id="npvDiscountRate"
                    ...
                    onChange={(e) =>
                      setNpvValues({ ...npvValues, discountRate: Number(e.target.value) })
                    }
                    className="bg-elec-dark border-gray-600 text-gray-300"
                  />
                </div>
                ...
                <div className="space-y-2">
                  <Label htmlFor="inverterReplacementYear" className="text-gray-300">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setNpvValues({
                        ...npvValues,
                        inverterReplacementYear: Number(e.target.value),
                      })
                    }
                    className="bg-elec-dark border-gray-600 text-gray-300"
                  />
                ...
                <div className="space-y-2">
                  <Label htmlFor="inverterCost" className="text-gray-300">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setNpvValues({ ...npvValues, inverterCost: Number(e.target.value) })
                    }
                    className="bg-elec-dark border-gray-600 text-gray-300"
                  />
                </div>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-elec-dark p-4 rounded border border-gray-600 space-y-3">
                  <div className="flex justify-between items-center">
                    ...
                    <span
                      className={`font-semibold text-lg ${Number(npvResults.npv) > 0 ? 'text-green-400' : 'text-red-400'}`}
                    >
                      £{npvResults.npv}
                    </span>
                  </div>
          ...
          <div className="space-y-4 mt-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="yieldSystemSize" className="text-gray-300">
                    System Size (kW)
                  </Label>
                  <Input
                    id="yieldSystemSize"
                    ...
                    onChange={(e) =>
                      setYieldValues({ ...yieldValues, systemSize: Number(e.target.value) })
                    }
                    className="bg-elec-dark border-gray-600 text-gray-300"
                  />
                </div>
                ...
                <div className="space-y-2">
                  <Label htmlFor="yieldLocation" className="text-gray-300">
                    Location
                  </Label>
                  <select
                    id="yieldLocation"
                ...
                <div className="space-y-2">
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setYieldValues({ ...yieldValues, orientation: e.target.value })
                    }
                    className="flex h-10 w-full rounded-md border border-gray-600 bg-elec-dark px-3 py-2 text-gray-300"
                  >
                ...
                <div className="space-y-2">
                  <Label htmlFor="tilt" className="text-gray-300">
                    Tilt Angle (degrees)
                  </Label>
                  <Input
                    id="tilt"
                    ...
                    onChange={(e) =>
                      setYieldValues({ ...yieldValues, tilt: Number(e.target.value) })
                    }
                    className="bg-elec-dark border-gray-600 text-gray-300"
                  />
                </div>
                ...
                <div className="space-y-2">
                  <Label htmlFor="shadingFactor" className="text-gray-300">
                    Shading Factor (%)
                  </Label>
                  <Input
                    id="shadingFactor"
                    ...
                    onChange={(e) =>
                      setYieldValues({ ...yieldValues, shadingFactor: Number(e.target.value) })
                    }
                    className="bg-elec-dark border-gray-600 text-gray-300"
                  />
                </div>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-elec-dark p-4 rounded border border-gray-600 space-y-3">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-green-400 font-semibold">
                      {yieldResults.co2Savings} kg/year
                    </span>
                  </div>
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-green-400 font-semibold">
                      {yieldResults.equivalentTrees} trees
                    </span>
                  </div>
                </div>
        ...
        {activeCalculator === 'incentives' && (
          <div className="space-y-4 mt-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-foreground mb-4">
                  Grant & Incentive Parameters
                </h3>

                <div className="space-y-2">
                  <Label htmlFor="baseSystemCost" className="text-gray-300">
                    Base System Cost (£)
                  </Label>
                  <Input
                    id="baseSystemCost"
                    ...
                    onChange={(e) =>
                      setGrantValues({ ...grantValues, baseSystemCost: Number(e.target.value) })
                    }
                    className="bg-elec-dark border-gray-600 text-gray-300"
                  />
                </div>
                ...
                <div className="space-y-2">
                  <Label htmlFor="grantPropertyType" className="text-gray-300">
                    Property Type
                  </Label>
                  <select
                    ...
                    onChange={(e) =>
                      setGrantValues({ ...grantValues, propertyType: e.target.value })
                    }
                    className="flex h-10 w-full rounded-md border border-gray-600 bg-elec-dark px-3 py-2 text-gray-300"
                  >
                    <option value="domestic">Domestic</option>
                ...
                <div className="space-y-2">
                  <Label htmlFor="availableGrants" className="text-gray-300">
                    Available Grants (£)
                  </Label>
                  <Input
                    id="availableGrants"
                    ...
                    onChange={(e) =>
                      setGrantValues({ ...grantValues, availableGrants: Number(e.target.value) })
                    }
                    className="bg-elec-dark border-gray-600 text-gray-300"
                  />
                </div>
                ...
                <div className="flex items-center space-x-2">
                  <input
                    ...
                    onChange={(e) =>
                      setGrantValues({ ...grantValues, vatRegistered: e.target.checked })
                    }
                    className="h-4 w-4 text-elec-yellow border-gray-600 bg-elec-dark"
                  />
                  <Label htmlFor="vatRegistered" className="text-gray-300">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-elec-dark p-4 rounded border border-gray-600 space-y-3">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-green-400 font-semibold">
                      -£{incentiveResults.grantReduction}
                    </span>
                  </div>
