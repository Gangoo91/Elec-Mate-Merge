  ...
  const commonMistakes = [
    {
      ...
      consequences:
        'Invalid certificates, inability to assess compliance trends, difficulty in fault diagnosis',
      prevention:
        'Use structured recording templates, implement peer review, maintain calibrated instruments',
    },
    {
      ...
      consequences:
        'Future electrical work based on incorrect information, safety risks from wrong assumptions',
      prevention:
        'Physical verification during inspection, cross-reference multiple information sources',
    },
    {
  ...
  const documentationStandards = [
    {
      ...
      benefits:
        'Reliable technical information, effective fault diagnosis, professional credibility',
    },
    {
      ...
      <CardContent className="space-y-8 pt-6">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-[#323232] rounded-lg p-6 space-y-4">
            <p className="text-foreground leading-relaxed mb-4">
              Develop comprehensive competency in professional electrical documentation through
              systematic learning and practical application. Each objective builds essential skills
              for maintaining documentation excellence and professional accountability.
            </p>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-[#323232] rounded-lg p-6 space-y-6">
            <p className="text-foreground leading-relaxed mb-4">
              Understanding and preventing common documentation mistakes is essential for
              maintaining professional standards and avoiding potential liability. These examples
              show typical errors and their serious consequences for safety and professional
              credibility.
            </p>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-[#323232] rounded-lg p-6 space-y-4">
            <p className="text-foreground leading-relaxed mb-4">
              Professional documentation standards ensure consistency, reliability, and
              effectiveness across all electrical certification activities. These standards form the
              foundation of quality electrical documentation practice.
            </p>
            <div className="space-y-4">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-[#323232] rounded-lg p-6 space-y-4">
            <p className="text-foreground leading-relaxed mb-4">
              ...
              improvement in professional standards. This framework supports excellence in
        ...
        <div className="space-y-4">
          ...
          <div className="bg-[#323232] rounded-lg p-6 space-y-4">
            <p className="text-gray-300 leading-relaxed mb-4">
              Digital documentation systems offer significant advantages for efficiency, accuracy,
              and quality management. Proper implementation and management of these systems enhances
            ...
            <div className="space-y-4">
              {digitalSystems.map((system, index) => (
                <div
                  key={index}
                  className="bg-cyan-600/10 border border-cyan-600/20 rounded-lg p-4"
                >
        ...
        <div className="space-y-4">
          ...
          <div className="bg-[#323232] rounded-lg p-6 space-y-4">
            <p className="text-foreground leading-relaxed mb-4">
              Professional electrical documentation carries significant legal and professional
              obligations. Understanding these implications is essential for risk management and
        ...
        <div className="space-y-4">
          ...
          <div className="bg-[#323232] rounded-lg p-6 space-y-4">
            <p className="text-foreground leading-relaxed">
              Professional electrical documentation excellence requires systematic approaches,
              quality assurance, and continuous improvement. These practices ensure electrical
              safety, legal compliance, and professional credibility while supporting effective
            ...
            <div className="bg-[#2a2a2a] border border-gray-600 rounded p-4 mt-6">
              <p className="text-gray-300 text-sm">
                <strong className="text-foreground">Next Steps:</strong> Implement systematic
                documentation procedures, develop quality assurance frameworks, and test knowledge
                with the comprehensive quiz. Remember that documentation quality directly reflects
                professional competency and commitment to electrical safety.
              </p>
            </div>
          </div>
        </div>
