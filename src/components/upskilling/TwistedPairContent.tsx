  ...
  const constructionFeatures = [
    {
      ...
      description:
        'Standard configuration with eight individual conductors arranged in four pairs, each twisted at different rates.',
    },
    {
      icon: Zap,
      title: 'Twist Rate Variation',
      description:
        'Each pair has a different twist rate (typically 3-12 twists per inch) to minimise crosstalk between pairs.',
    },
    {
      icon: BarChart,
      title: 'Electromagnetic Shielding',
      description:
        'Higher categories include additional shielding (STP/FTP) to reduce external interference and improve performance.',
    },
  ];
  ...
  const standards = [
    {
      ...
      standard: 'TIA-568-C',
      description:
        'American standard defining cable categories, performance requirements, and installation practices',
    },
    {
  ...
  return (
    <div className="space-y-6">
        ...
        <CardContent className="space-y-6">
          <div className="text-gray-300 space-y-4">
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              <li>
                <strong>Noise Cancellation:</strong> External electromagnetic interference affects
                both wires in a pair equally, creating common-mode noise that can be cancelled at
                the receiver
              </li>
              <li>
                <strong>Crosstalk Reduction:</strong> Different twist rates for each pair ensure
                that interference between pairs is minimised
              </li>
              <li>
                <strong>Signal Integrity:</strong> Maintains consistent impedance and reduces signal
                reflection
              </li>
              <li>
                <strong>Balanced Transmission:</strong> Enables differential signalling for improved
                noise immunity
              </li>
            </ul>
          </div>
      ...
      <Card className="bg-elec-gray border-transparent">
        ...
        <CardContent className="space-y-4">
          <p className="text-gray-300">
            ...
            performance, compatibility, and reliability across different manufacturers and
            installations.
          </p>
            ...
            {standards.map((standard, index) => (
              <div key={index} className="bg-slate-800/50 p-4 rounded-lg">
                <h4 className="font-semibold text-elec-yellow mb-2">
                  {standard.organisation} - {standard.standard}
                </h4>
            ...
            <div className="space-y-6">
              <div className="bg-slate-800/50 p-4 rounded-lg">
                <h4 className="font-semibold text-foreground mb-3 flex items-center gap-2">
                  <span className="w-6 h-6 bg-elec-yellow text-elec-dark rounded-full flex items-center justify-center text-sm font-bold">
                    1
                  </span>
                  Planning Your Route
                </h4>
                <ul className="space-y-2 text-sm">
                  <li>
                    <strong>Measure the distance:</strong> From the router/switch to each outlet
                    location
                  </li>
                  <li>
                    <strong>Add extra length:</strong> Always add 10-20% extra cable for routing and
                    connections
                  </li>
                  <li>
                    <strong>Avoid interference:</strong> Keep away from power cables, fluorescent
                    lights, and motors
                  </li>
                  <li>
                    <strong>Choose the path:</strong> Use walls, ceilings, or conduits - avoid sharp
                    bends
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-slate-800/50 p-4 rounded-lg">
                ...
                <ul className="space-y-2 text-sm">
                  <li>
                    <strong>Don't pull too hard:</strong> Maximum 25 pounds of force - cable should
                    glide, not stretch
                  </li>
                  <li>
                    <strong>Support every 1.5 metres:</strong> Use cable clips or ties to secure the
                    cable
                  </li>
                  <li>
                    <strong>Gentle bends only:</strong> Never bend tighter than 4 times the cable
                    diameter
                  </li>
                  <li>
                    <strong>Label as you go:</strong> Mark both ends of each cable run for easy
                    identification
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-slate-800/50 p-4 rounded-lg">
                ...
                <ul className="space-y-2 text-sm">
                  <li>
                    <strong>Continuity test:</strong> Use a simple cable tester to check all 8 wires
                    connect properly
                  </li>
                  <li>
                    <strong>Check for shorts:</strong> No wires should connect to the wrong pins
                  </li>
                  <li>
                    <strong>Test with devices:</strong> Plug in a computer and check for network
                    connectivity
                  </li>
                  <li>
                    <strong>Speed test:</strong> Verify you're getting expected speeds (100Mbps,
                    1Gbps, etc.)
                  </li>
                </ul>
              </div>
        ...
        <CardContent className="space-y-4 text-gray-300">
          <div>
            ...
            <ul className="space-y-2 list-disc list-inside">
              <li>
                <strong>Bend Radius:</strong> Never exceed 4 times the cable diameter to prevent
                damage to internal conductors
              </li>
              <li>
                <strong>Pulling Tension:</strong> Maximum 25 pounds (110N) pulling force to avoid
                stretching
              </li>
              <li>
                <strong>Untwisting:</strong> Minimise untwisting at terminations—maximum 13mm (0.5")
                for Cat6
              </li>
              <li>
                <strong>Cable Management:</strong> Use proper support and avoid compression in cable
                trays
              </li>
              <li>
                <strong>Separation:</strong> Maintain distance from power cables and fluorescent
                lighting
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 list-disc list-inside">
              <li>
                <strong>Temperature Rating:</strong> Ensure cables are rated for the installation
                environment
              </li>
              <li>
                <strong>Fire Rating:</strong> Use appropriate fire-rated cables (CMP, CMR, CM) as
                required
              </li>
              <li>
                <strong>Moisture Protection:</strong> Consider outdoor-rated or gel-filled cables
                for external use
              </li>
              <li>
                <strong>Chemical Resistance:</strong> Specify chemical-resistant jackets for
            ...
            <div>
              ...
              <div className="space-y-3">
                <div className="bg-red-900/20 border border-red-700/50 p-3 rounded-lg">
                  ...
                  <p className="text-sm">
                    Untwisting pairs more than 13mm at terminations reduces performance
                    significantly.
                  </p>
                </div>
                <div className="bg-red-900/20 border border-red-700/50 p-3 rounded-lg">
                  ...
                  <p className="text-sm">
                    Bending cable too tightly can break internal conductors or change electrical
                    properties.
                  </p>
                </div>
                <div className="bg-red-900/20 border border-red-700/50 p-3 rounded-lg">
                  ...
                  <p className="text-sm">
                    Cables bunched together or compressed can cause crosstalk and heat buildup.
                  </p>
                </div>
                <div className="bg-red-900/20 border border-red-700/50 p-3 rounded-lg">
                  <h4 className="font-semibold text-red-300 mb-1">Wrong Wiring Standard</h4>
                  <p className="text-sm">
                    Mixing T568A and T568B standards can cause connectivity issues.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-3">
                <div className="bg-green-900/20 border border-green-700/50 p-3 rounded-lg">
                  ...
                  <p className="text-sm">
                    Use a ruler to ensure you only untwist the minimum amount needed for
                    termination.
                  </p>
                </div>
                <div className="bg-green-900/20 border border-green-700/50 p-3 rounded-lg">
                  ...
                  <p className="text-sm">
                    Use corner protectors and cable guides to maintain proper bend radius.
                  </p>
                </div>
                <div className="bg-green-900/20 border border-green-700/50 p-3 rounded-lg">
                  <h4 className="font-semibold text-green-300 mb-1">Support Every 1.5m</h4>
                  <p className="text-sm">
                    Regular support prevents cable sag and maintains proper separation.
                  </p>
                </div>
                <div className="bg-green-900/20 border border-green-700/50 p-3 rounded-lg">
                  <h4 className="font-semibold text-green-300 mb-1">Stick to T568B</h4>
                  <p className="text-sm">
                    Use T568B standard throughout your installation for consistency.
                  </p>
                </div>
              </div>
            </div>
      ...
      <Card className="bg-elec-gray border-transparent">
        ...
        <CardContent className="space-y-6 text-gray-300">
          <div className="bg-blue-900/20 border border-blue-700/50 p-4 rounded-lg">
            ...
            <p className="text-sm">
              A twisted pair cable is like a highway with 8 lanes (wires) arranged in 4 pairs. The
              twisting is like having the lanes weave slightly - this prevents traffic from one lane
              interfering with traffic in other lanes (electromagnetic interference).
            </p>
          </div>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-slate-800/50 p-4 rounded-lg">
                ...
                <p className="text-sm">
                  ...
                  <br />• This includes patch cables at both ends (typically 90m permanent + 10m
                  patch)
          ...
          <div className="bg-yellow-900/20 border border-yellow-700/50 p-4 rounded-lg">
            ...
            <ul className="space-y-1 text-sm">
              <li>
                • Always test your work - a £20 cable tester can save hours of troubleshooting
              </li>
      ...
      <Card className="bg-elec-gray border-transparent">
        ...
        <CardContent className="space-y-4 text-gray-300">
          <p>
            Proper testing ensures that installed twisted pair cables meet performance
            specifications and will support the intended applications reliably.
          </p>
          ...
          <div className="bg-slate-800/50 p-4 rounded-lg">
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <strong>Level II (Basic):</strong> Qualification testing for basic connectivity
              </li>
              <li>
                <strong>Level IIE (Enhanced):</strong> Basic performance parameters
              </li>
              <li>
                <strong>Level III (Certification):</strong> Full performance testing to category
                standards
              </li>
              <li>
                <strong>Level IV (Extended):</strong> Advanced parameters including alien crosstalk
              </li>
            </ul>
          </div>
        </CardContent>
