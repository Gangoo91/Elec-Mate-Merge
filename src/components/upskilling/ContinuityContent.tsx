      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-[#323232] rounded-lg p-4 space-y-3">
            <p className="text-foreground leading-relaxed text-sm sm:text-base">
              Continuity testing confirms that conductors—particularly protective ones—are
              electrically continuous from end to end. It ensures there is a complete,
              low-resistance path for fault current to return to the supply and trigger
              disconnection.
            </p>
            <div className="flex items-start gap-3 bg-blue-600/10 border border-blue-600/20 rounded p-3 sm:p-4">
              ...
              <p className="text-foreground text-sm sm:text-base">
                <strong>Key Point:</strong> Without continuity, protective devices cannot detect
                faults and may not operate when needed, creating serious safety risks.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            <div className="bg-red-600/10 border border-red-600/20 rounded-lg p-4 sm:p-5">
              ...
              <p className="text-foreground text-xs sm:text-sm leading-relaxed">
                If CPCs or bonding conductors are broken, protective devices may not operate during
                a fault
              </p>
            </div>
            <div className="bg-orange-600/10 border border-orange-600/20 rounded-lg p-4 sm:p-5">
              ...
              <h4 className="text-orange-200 font-medium mb-2 text-sm sm:text-base">
                Live Metalwork
              </h4>
              <p className="text-foreground text-xs sm:text-sm leading-relaxed">
                A break in continuity could leave exposed conductive parts remaining live during
                fault conditions
              </p>
            </div>
            <div className="bg-green-600/10 border border-green-600/20 rounded-lg p-4 sm:p-5 sm:col-span-2 lg:col-span-1">
              ...
              <p className="text-foreground text-xs sm:text-sm leading-relaxed">
                It validates that protective measures (like ADS – automatic disconnection of supply)
                are effective
              </p>
            </div>
          </div>
        ...
        <div className="space-y-4">
          <h3 className="text-xl font-semibold text-foreground">
            When Is Continuity Testing Required?
          </h3>
            ...
            <ul className="space-y-3 sm:space-y-4">
              <li className="flex items-start gap-3 text-foreground">
                ...
                <span className="text-sm sm:text-base">
                  <strong>Initial verification</strong> of new circuits
                </span>
              </li>
              <li className="flex items-start gap-3 text-foreground">
                <span className="w-2 h-2 bg-elec-yellow rounded-full mt-2 flex-shrink-0"></span>
                <span className="text-sm sm:text-base">
                  <strong>After alterations or additions</strong> (especially if protective
                  conductors have been disturbed)
                </span>
              </li>
              <li className="flex items-start gap-3 text-foreground">
                <span className="w-2 h-2 bg-elec-yellow rounded-full mt-2 flex-shrink-0"></span>
                <span className="text-sm sm:text-base">
                  <strong>Not typically repeated during EICRs</strong> unless issues are suspected
                  or circuits have been modified
                </span>
              </li>
            </ul>
          </div>
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
            {conductorsToTest.map((conductor, index) => (
              <div
                key={index}
                className="bg-[#323232] rounded-lg p-4 sm:p-5 border-l-4 border-elec-yellow/50"
              >
          ...
          <div className="bg-blue-600/10 border border-blue-600/20 rounded-lg p-4 sm:p-5">
            <p className="text-foreground text-sm sm:text-base leading-relaxed">
              <strong>Important:</strong> Each must show a continuous, low-resistance connection
              between all relevant points (e.g., DB to accessory, accessory to accessory).
            </p>
          </div>
        </div>
        ...
        <div className="space-y-4">
                ...
                <div
                  ...
                  className={`flex items-center gap-4 p-3 rounded ${
                    item.status === 'Current step'
                      ...
                      : item.status === 'Complete before testing'
          ...
          <div className="bg-red-600/10 border border-red-600/20 rounded-lg p-4 sm:p-5">
            <div className="flex items-start gap-3">
              ...
              <p className="text-foreground text-sm sm:text-base leading-relaxed">
                <strong>Critical:</strong> If continuity fails, no further testing should be done
                until the issue is resolved. The installation is not safe to energise.
              </p>
            </div>
          </div>
        </div>
