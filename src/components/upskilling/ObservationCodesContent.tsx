...
const ObservationCodesContent = () => {
  const introductionContent = {
    overview:
      'Observation codes provide a standardised classification system for defects, non-compliance issues, and safety concerns identified during electrical inspections. This systematic approach ensures consistent risk assessment, appropriate prioritisation of remedial actions, and clear communication between electrical professionals and clients.',
    importance:
      'Correct application of observation codes is fundamental to electrical safety management and professional accountability. These codes directly influence remedial action timeframes, insurance compliance, legal obligations, and most importantly, the protection of persons and property from electrical hazards.',
    scope:
      'This section provides comprehensive coverage of the four observation codes (C1, C2, C3, FI), their definitions, application criteria, decision-making processes, and practical examples. Understanding these codes is essential for all electrical inspection and testing activities.',
  };
      ...
      <CardContent className="space-y-8 pt-6">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-[#323232] rounded-lg p-6 space-y-4">
            <p className="text-foreground leading-relaxed mb-4">
              Develop comprehensive competency in observation code application through systematic
              learning and practical scenarios. Each objective builds critical skills for
        ...
        <div className="space-y-4">
          ...
          <div className="bg-[#323232] rounded-lg p-6 space-y-6">
            <p className="text-foreground leading-relaxed mb-4">
              Each observation code represents a specific level of risk and required response
              timeframe. Understanding these distinctions is crucial for appropriate safety
        ...
        <div className="space-y-4">
          ...
          <div className="bg-[#323232] rounded-lg p-6 space-y-4">
            <p className="text-foreground leading-relaxed mb-4">
              Systematic decision-making ensures consistent and appropriate code application. This
              process should be followed for every observation to maintain professional standards
              and reliability.
            </p>
            <div className="space-y-4">
        ...
        <div className="space-y-4">
          <h3 className="text-xl font-semibold text-foreground">
            Professional Application Principles
          </h3>
          <div className="bg-[#323232] rounded-lg p-6 space-y-4">
            <p className="text-foreground leading-relaxed mb-4">
              Professional application of observation codes requires adherence to fundamental
              principles that ensure consistency, reliability, and appropriate risk management
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-green-300 text-xs font-medium">
                        Why it matters: {principle.importance}
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-[#323232] rounded-lg p-6 space-y-4">
            <p className="text-foreground leading-relaxed mb-4">
              ...
              Understanding these implications protects both the inspector and the client from
              potential liability.
            </p>
            <div className="space-y-4">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-[#323232] rounded-lg p-6 space-y-4">
            <p className="text-foreground leading-relaxed">
              Observation codes provide the foundation for effective electrical safety management
              through systematic risk assessment and clear communication. Professional competency in
              their application is essential for maintaining safety standards and meeting legal
              obligations.
            </p>
            ...
            <div className="bg-[#2a2a2a] border border-gray-600 rounded p-4 mt-6">
              <p className="text-foreground text-sm">
                <strong className="text-foreground">Next Steps:</strong> Practice code application
                through practical scenarios, develop decision-making workflows, and test knowledge
                with the comprehensive quiz. Remember that observation codes directly impact safety
                outcomes and professional credibility.
              </p>
            </div>
          </div>
        </div>
