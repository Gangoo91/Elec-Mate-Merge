...
const MinorWorksContent = () => {
  const introductionContent = {
    ...
    scope:
      "This section covers the complete Minor Works Certificate process, including when it's appropriate to use, how to complete it correctly, required testing procedures, and the legal obligations that accompany this form of certification.",
  };
  ...
  const minorWorksTypes = [
    {
      work: 'Additional socket outlet on existing circuit',
      certificate: 'MEIWC',
      limitations:
        'Circuit must have adequate capacity, existing protection suitable, no design changes required',
    },
    {
      work: 'Additional lighting point on existing circuit',
      certificate: 'MEIWC',
      limitations:
        'Within existing circuit design parameters, no additional load calculations needed',
    },
    {
      work: 'Replacement of accessories (sockets, switches)',
      certificate: 'MEIWC',
      limitations: 'Like-for-like replacement, no circuit modifications, same ratings and types',
    },
    {
      work: 'Single additional circuit from existing distribution board',
      certificate: 'MEIWC',
      limitations: 'Board has spare capacity, no main modifications, standard circuit requirements',
    },
    {
      work: 'Replacement of damaged cable section',
      certificate: 'MEIWC',
      limitations: 'Same cable type and rating, no route changes, maintains existing protection',
    },
    {
      work: 'Installation of additional light fitting',
      certificate: 'MEIWC',
      limitations:
        'Existing circuit adequate, no structural modifications, standard installation method',
    },
    {
      work: 'Replacement of single MCB or RCD',
      certificate: 'MEIWC',
      limitations:
        'Same rating and type, no discrimination issues, existing installation compatible',
    },
    {
      work: 'Addition of external socket for garden use',
      certificate: 'MEIWC',
      limitations:
        'Adequate RCD protection, suitable existing circuit, appropriate IP rating provided',
    },
  ];
  ...
  const certificateRequirements = [
    {
      ...
      requirements: [
        'Address and installation description',
        'Scope and extent of minor works',
        'Existing installation assessment',
        'Supply characteristics confirmation',
      ],
    },
    {
      section: 'Circuit Information',
      requirements: [
        'Circuit identification and designation',
        'Type and rating of protective device',
        'Cable details and installation method',
        'Circuit length and conductor sizes',
      ],
    },
    {
    ...
    },
    {
      ...
      requirements: [
        ...
        'Test date and instruments used',
  ...
  const testingRequirements = [
    {
      ...
      requirement: 'Verify all protective conductors continuous',
      method: 'Low resistance ohmmeter, test between points',
      limit: 'No specific limit, but continuity must be confirmed',
    },
    {
      test: 'Insulation Resistance',
      requirement: 'Between live conductors and earth',
      method: '500V DC insulation tester',
      limit: '≥1MΩ for circuits ≤500V',
    },
    {
      test: 'Polarity',
      requirement: 'Correct connection of conductors',
      method: 'Visual inspection and testing',
      limit: 'Single pole devices in line conductors only',
    },
    {
      test: 'Earth Fault Loop Impedance',
      requirement: 'Where new circuits added',
      method: 'Loop impedance tester',
      limit: '≤ maximum Zs for protective device',
    },
    {
      test: 'RCD Operation',
      requirement: 'Where RCD protection provided',
      method: 'RCD tester at required test currents',
      limit: '≤30ms at 5×IΔn, ≤300ms at 1×IΔn',
    },
    {
      test: 'Functional Testing',
      requirement: 'Operation of new accessories',
      method: 'Manual operation and visual check',
      limit: 'All devices operate as intended',
    },
  ];
      ...
      <CardContent className="space-y-8 pt-6">
        ...
        <div className="space-y-4">
          <h3 className="text-xl font-semibold text-foreground">
            When to Use Minor Works Certificate
          </h3>
          <div className="bg-[#323232] rounded-lg p-6 space-y-4">
            <p className="text-foreground leading-relaxed">
              Minor Works Certificates are appropriate for small additions and modifications to
              existing electrical installations where the work does not significantly alter the
              installation characteristics or require extensive design calculations.
            </p>
            <div className="bg-[#2a2a2a] border border-gray-600 rounded p-4">
              <Shield className="h-6 w-6 text-elec-yellow mb-3" />
              <p className="text-foreground text-sm">
                <strong className="text-foreground">Important:</strong> The person completing the
                MEIWC must be competent in both installation and testing work, as they take
                responsibility for all aspects of the minor works.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-[#323232] rounded-lg p-6 space-y-4">
            <p className="text-foreground leading-relaxed mb-4">
              By completing this section, you will develop the skills necessary to determine when
              minor works certification is appropriate and how to complete it correctly. Each
              objective builds practical competency in minor works procedures.
            </p>
        ...
        <div className="space-y-4">
          <h3 className="text-xl font-semibold text-foreground">
            Appropriate Minor Works Examples
          </h3>
          <div className="bg-[#323232] rounded-lg p-6 space-y-4">
            <p className="text-foreground leading-relaxed mb-4">
              Understanding the scope and limitations of minor works is essential for correct
              certification. Each example shows typical work that can be covered by MEIWC along with
        ...
        <div className="space-y-4">
          <h3 className="text-xl font-semibold text-foreground">
            Certificate Structure and Requirements
          </h3>
          <div className="bg-[#323232] rounded-lg p-6 space-y-4">
            <p className="text-foreground leading-relaxed mb-4">
              The Minor Works Certificate follows a logical structure designed to capture essential
              information while maintaining proportionality for small-scale work. Each section
        ...
        <div className="space-y-4">
          <h3 className="text-xl font-semibold text-foreground">
            Required Testing for Minor Works
          </h3>
          <div className="bg-[#323232] rounded-lg p-6 space-y-4">
            <p className="text-foreground leading-relaxed mb-4">
              Testing requirements for minor works are proportionate to the work undertaken. While
              not requiring the full testing regime of an EIC, essential safety tests must be
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
                        ...
                        <p className="text-yellow-300">
                          <strong>Limit:</strong> {test.limit}
                        </p>
                      </div>
                    </div>
                  </div>
        ...
        <div className="space-y-4">
          <h3 className="text-xl font-semibold text-foreground">
            Circuit Documentation Requirements
          </h3>
          <div className="bg-[#323232] rounded-lg p-6 space-y-4">
            <div className="bg-orange-600/10 border border-orange-600/20 rounded p-4">
              ...
              <p className="text-foreground text-sm mb-4">
                Accurate circuit documentation ensures future maintenance and modification work can
                be planned and executed safely. The following information must be recorded for each
                circuit affected by minor works.
              </p>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-[#323232] rounded-lg p-6 space-y-4">
            <p className="text-foreground leading-relaxed mb-4">
              Understanding the limitations of Minor Works Certificates is crucial for determining
              when more comprehensive certification is required. Exceeding these limitations may
        ...
        <div className="space-y-4">
          ...
          <div className="bg-[#323232] rounded-lg p-6 space-y-4">
            <p className="text-foreground leading-relaxed">
              The Minor Works Certificate provides an efficient certification method for small-scale
              electrical work while maintaining essential safety standards. Proper use of MEIWC
              ensures regulatory compliance and professional protection for appropriate minor
            ...
            <div className="bg-[#2a2a2a] border border-gray-600 rounded p-4 mt-6">
              <p className="text-foreground text-sm">
                <strong className="text-foreground">Next Steps:</strong> Practice determining minor
                works scope through practical scenarios, complete sample certificates, and test
                knowledge with the comprehensive quiz. Remember that minor works certification
                requires the same professional standards as any electrical certificate.
              </p>
            </div>
          </div>
        </div>
