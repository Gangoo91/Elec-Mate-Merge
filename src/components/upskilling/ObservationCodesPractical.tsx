    ...
    <Card className="bg-elec-gray border-transparent">
      ...
      <CardContent className="space-y-6">
        <div className="space-y-4">
          ...
          <div className="bg-[#323232] rounded-lg p-6 space-y-4">
            <p className="text-foreground leading-relaxed mb-4">
              These practical scenarios demonstrate systematic code application using real
              inspection situations. Each example shows the decision-making process from observation
              through to appropriate code selection.
            </p>
            <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                        <div className="space-y-2">
                          <p>
                            ...
                            <span className="text-foreground">{scenario.assessment}</span>
                          </p>
                          <p>
                            <strong className="text-foreground">Reasoning:</strong>{' '}
                            <span className="text-foreground">{scenario.reasoning}</span>
                          </p>
                        </div>
                        <div className="space-y-2">
                          <p>
                            <strong className="text-foreground">Action:</strong>{' '}
                            <span className="text-foreground">{scenario.action}</span>
                          </p>
                          <p>
                            <strong className="text-foreground">Documentation:</strong>{' '}
                            <span className="text-foreground">{scenario.documentation}</span>
                          </p>
                        </div>
                      </div>
                    </div>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-[#323232] rounded-lg p-6 space-y-4">
            <p className="text-foreground leading-relaxed mb-4">
              Effective documentation supports code classification decisions and enables appropriate
              remedial action. These standards ensure observations are clear, actionable, and
        ...
        <div className="space-y-4">
          ...
          <div className="bg-[#323232] rounded-lg p-6 space-y-4">
            <p className="text-foreground leading-relaxed mb-4">
              ...
              professional standards. These examples show typical errors and practical prevention
              strategies.
            </p>
            <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-1 gap-3 text-sm">
                        <div>
                          <p className="text-foreground mb-2">
                            <strong>Problem:</strong> {mistake.explanation}
                          </p>
                          <p className="text-foreground mb-2">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-[#323232] rounded-lg p-6 space-y-4">
            <p className="text-foreground leading-relaxed mb-4">
              Systematic quality assurance ensures consistent code application and continuous
              improvement in observation quality. This framework supports professional development
              ...
              <div className="space-y-3 text-sm">
                <div className="flex items-center gap-3 p-2 bg-[#2a2a2a] rounded">
                  ...
                  <span className="text-foreground">
                    Identify the defect or non-compliance clearly
                  </span>
                </div>
                <div className="flex items-center gap-3 p-2 bg-[#2a2a2a] rounded">
                  <span className="text-cyan-300 font-bold">2.</span>
                  <span className="text-foreground">
                    Assess immediate danger (accessible live parts, missing earth) → C1
                  </span>
                </div>
                <div className="flex items-center gap-3 p-2 bg-[#2a2a2a] rounded">
                  <span className="text-cyan-300 font-bold">3.</span>
                  <span className="text-foreground">
                    Evaluate potential danger in normal use (inadequate protection) → C2
                  </span>
                </div>
                <div className="flex items-center gap-3 p-2 bg-[#2a2a2a] rounded">
                  <span className="text-cyan-300 font-bold">4.</span>
                  <span className="text-foreground">
                    Consider safety improvement opportunities → C3
                  </span>
                </div>
                <div className="flex items-center gap-3 p-2 bg-[#2a2a2a] rounded">
                  <span className="text-cyan-300 font-bold">5.</span>
                  <span className="text-foreground">
                    Determine if investigation needed for classification → FI
                  </span>
                </div>
                <div className="flex items-center gap-3 p-2 bg-[#2a2a2a] rounded">
