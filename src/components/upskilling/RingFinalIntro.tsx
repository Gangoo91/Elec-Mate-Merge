    ...
    <Card className="bg-elec-gray border-transparent">
      ...
      <CardContent className="space-y-4">
        <p className="text-foreground text-lg leading-relaxed">
          Ring final circuits require a specific continuity testing method to confirm correct
          connections and compliance. This section explains how to test a ring properly and what the
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-foreground text-sm leading-relaxed">
                A break in either leg (line, neutral, or CPC) can lead to overloaded conductors, no
                earth protection at some outlets, and unsafe disconnection during a fault. That's
                why continuity testing is essential to confirm each conductor forms a complete loop.
              </p>
            </div>
          </div>
        </div>
