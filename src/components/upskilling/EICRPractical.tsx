...
const EICRPractical = () => {
  const inspectionSteps = [
    {
      ...
      details:
        'Examine existing certificates, assess installation age and type, identify any obvious defects or modifications',
    },
    {
      step: '2. Visual Inspection',
      action: 'Conduct thorough visual examination of accessible parts',
      details:
        'Check cable conditions, identify non-compliance with current standards, examine consumer units and distribution boards',
    },
    {
      step: '3. Dead Testing',
      action: 'Perform tests with installation isolated',
      details:
        'Test continuity of protective conductors, insulation resistance, and polarity verification',
    },
    {
      step: '4. Live Testing',
      action: 'Carry out tests with installation energised',
      details:
        'Measure earth fault loop impedance, test RCD operation, verify phase sequence where applicable',
    },
    {
      step: '5. Functional Testing',
      action: 'Test operation of protective devices and controls',
      details:
        'Check circuit breaker operation, test emergency lighting, verify isolator effectiveness',
    },
    {
      step: '6. Documentation Review',
      action: 'Complete EICR with accurate observations and recommendations',
      details:
        'Record all defects with appropriate classification, provide clear recommendations for remedial work',
    },
  ];
  ...
  const defectClassifications = [
    {
      ...
      examples:
        'Live parts accessible, missing earth connections, damaged cables with live conductors exposed',
    },
    {
    ...
    },
    {
      ...
      examples:
        'Concealed cables requiring investigation, inaccessible connections, incomplete testing',
    },
  ];
  ...
  const commonDefects = [
    ...
    },
    {
      ...
      classification: 'C1',
      remediation:
        'Upgrade earthing conductor, verify earth electrode resistance, check bonding continuity',
    },
    {
  ...
  const testingGuidelines = [
    ...
    },
    {
      ...
      notes:
        'Consider cable length, temperature correction factors, and protective device characteristics',
    },
    {
      test: 'RCD Operation',
        ...
        <div className="bg-[#323232] rounded-lg p-6">
          ...
          <div className="space-y-4">
            {defectClassifications.map((defect, index) => (
              <div key={index} className="border border-gray-600 rounded-lg p-4">
                <div className="flex items-start gap-3">
                  <div className="text-elec-yellow font-bold text-lg flex-shrink-0">
                    {defect.code.split(' - ')[0]}
                  </div>
                  <div className="flex-1">
              ...
              <div key={index} className="border border-gray-600 rounded-lg p-4">
                ...
                <div className="space-y-2 text-sm">
                  <p className="text-foreground">
                    <span className="text-elec-yellow font-medium">Location:</span> {item.location}
                  </p>
                  <p className="text-foreground">
                    <span className="text-elec-yellow font-medium">Classification:</span>{' '}
                    {item.classification}
                  </p>
                  <p className="text-foreground">
                    <span className="text-elec-yellow font-medium">Remediation:</span>{' '}
                    {item.remediation}
                  </p>
                </div>
              </div>
          ...
          <div className="space-y-4">
            {testingGuidelines.map((test, index) => (
              <div key={index} className="border border-gray-600 rounded-lg p-4">
                ...
                <div className="space-y-2 text-sm">
                  <p className="text-foreground">
                    <span className="text-elec-yellow font-medium">Method:</span> {test.method}
                  </p>
                  <p className="text-foreground">
                    <span className="text-elec-yellow font-medium">Acceptable Values:</span>{' '}
                    {test.acceptable}
                  </p>
                  <p className="text-foreground">
                    <span className="text-elec-yellow font-medium">Notes:</span> {test.notes}
                  </p>
                </div>
              </div>
            ))}
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-foreground text-sm leading-relaxed">
                EICR inspection and testing must only be carried out by competent persons with
                appropriate qualifications, experience, and insurance coverage. The inspector takes
                full responsibility for the accuracy of observations, test results, and
