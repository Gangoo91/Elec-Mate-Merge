...
import { polarityPurposeQuizQuestions } from '@/data/upskilling/polarityPurposeQuizData';
...
export const PolarityPurposeQuiz = () => {
  ...
  const handleNext = () => {
    if (currentQuestion < polarityPurposeQuizQuestions.length - 1) {
  ...
  const score = selectedAnswers.reduce((acc, answer, index) => {
    return acc + (answer === polarityPurposeQuizQuestions[index].correctAnswer ? 1 : 0);
  }, 0);
    ...
    <Card className="bg-elec-gray border-transparent">
      ...
      <CardContent className="space-y-6">
        ...
        <QuizNavigation
          ...
          onNext={handleNext}
          isLastQuestion={currentQuestion === polarityPurposeQuizQuestions.length - 1}
        />
      </CardContent>
    </Card>
  );
