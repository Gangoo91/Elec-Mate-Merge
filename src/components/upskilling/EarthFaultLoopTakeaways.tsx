  ...
  const takeaways = [
    {
      ...
      description:
        'Includes both external impedance (Ze) and circuit conductor resistance (R1 + R2)',
    },
    {
    ...
    },
    {
      ...
      description:
        'This gives the worst-case scenario and ensures protection throughout the circuit',
    },
    {
      ...
      <CardContent>
        ...
        <div className="mt-6 bg-elec-yellow/10 p-4 rounded-md border border-elec-yellow/30">
          ...
          <p className="text-foreground text-sm sm:text-base leading-relaxed">
            Earth fault loop impedance testing is one of the most critical safety tests in
            electrical installation work. It directly affects whether people will be protected from
            electric shock in fault conditions.
          </p>
        </div>
      </CardContent>
    </Card>
