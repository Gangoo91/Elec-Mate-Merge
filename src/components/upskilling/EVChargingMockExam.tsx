...
const EVChargingMockExam = () => {
  ...
  const [examQuestions, setExamQuestions] = useState<typeof evChargingQuestions>([]);
  ...
  const getGradeInfo = (score: number) => {
    ...
    if (percentage >= 80) {
      return {
        grade: "Distinction",
        message: "Outstanding! You've mastered EV charging principles.",
    ...
    if (percentage >= 70) {
      return {
        grade: "Merit",
        message: "Great work! Solid understanding of EV charging.",
        color: "text-blue-400",
        ...
        <div className="px-4 pb-8 pt-6 max-w-lg mx-auto">
          ...
          >
            ...
            <ul className="space-y-2">
              {[
                "30 questions covering all 7 EV modules",
      ...
      <div className="sticky top-0 z-50 bg-black/80 backdrop-blur-xl border-b border-white/10">
        <div className="flex items-center justify-between px-4 py-3">
          ...
          <div className={cn(
            ...
            <Clock className={cn("h-4 w-4", timeRemaining < 300 ? "text-red-400" : "text-green-400")} />
            <span className={cn(
