  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-gray-300 mb-3">
        Before starting visual inspection, ensure you have access to:
      </p>
      ...
      <div className="bg-yellow-600/10 border border-yellow-600/20 rounded-lg p-4 mt-4">
        <p className="text-yellow-200 font-medium">
          <strong>Documentation Rule:</strong> Without proper documentation, you cannot complete a
          thorough visual inspection or verify compliance with the original design intent. Poor
          documentation equals poor inspection.
        </p>
      </div>
    </div>
  );
