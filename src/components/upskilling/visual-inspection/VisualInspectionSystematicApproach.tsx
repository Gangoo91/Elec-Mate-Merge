    ...
    <div className="space-y-4">
      ...
      <div className="bg-blue-600/10 border border-blue-600/20 rounded-lg p-4 mt-4">
        <p className="text-blue-200 font-medium">
          <strong>Professional Tip:</strong> Use a methodical room-by-room, circuit-by-circuit
          approach. Don't jump around randomly as this leads to missed items and having to re-check
          areas.
        </p>
      </div>
    </div>
