  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-gray-300 mb-3">
        Visual inspection is mandated by several key regulations and standards:
      </p>
      ...
      <div className="bg-purple-600/10 border border-purple-600/20 rounded-lg p-4 mt-4">
        <p className="text-purple-200 font-medium">
          <strong>Legal Requirement:</strong> Under the Electricity at Work Regulations 1989,
          failure to carry out proper visual inspection could result in prosecution for breaches of
