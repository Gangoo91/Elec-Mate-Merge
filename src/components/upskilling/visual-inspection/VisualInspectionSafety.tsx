  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-gray-300 mb-3">
        Even though visual inspection doesn't involve live testing, safety remains paramount:
      </p>
      ...
      <div className="bg-orange-600/10 border border-orange-600/20 rounded-lg p-4 mt-4">
        <p className="text-orange-200 font-medium">
          <strong>Safety Alert:</strong> Remember that installations may still be energised during
          visual inspection. Always assume circuits are live unless proven otherwise through proper
