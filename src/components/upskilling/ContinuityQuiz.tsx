...
const quizQuestions: QuizQuestion[] = [
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'Continuity testing must be carried out on Circuit Protective Conductors (CPCs), main and supplementary bonding conductors, and all conductors in ring final circuits.',
  },
  {
    id: 3,
    question:
      'True or False: Continuity testing is optional if the wiring looks fine during inspection.',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'False. Continuity testing is mandatory regardless of visual appearance. Visual inspection cannot confirm electrical continuity, and this is a critical life safety test.',
  },
  {
    id: 4,
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'High CPC resistance indicates a fault that must be investigated and rectified before any further testing, as it represents a potential safety hazard.',
  },
  {
    id: 10,
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-3 pointer-events-none">
                    <span
                      className={`w-6 h-6 rounded-full border-2 flex items-center justify-center text-sm font-semibold flex-shrink-0 ${
                        isSelected
