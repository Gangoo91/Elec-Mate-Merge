...
const quizQuestions: QuizQuestionType[] = [
  {
    ...
    correctAnswer: 0,
    explanation:
      'Visual inspection must be completed before any electrical testing to identify potentially dangerous conditions that could pose risks during testing or normal operation.',
  },
  {
    id: 2,
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Evidence of overheating indicates a serious safety issue that must be investigated and resolved before any further work can proceed.',
  },
  {
    id: 5,
