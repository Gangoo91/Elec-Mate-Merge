...
export const InsulationTestMethodsFAQ = () => {
  const faqs = [
    ...
    },
    {
      ...
      answer:
        'Different test methods may give different results due to: parallel paths in L+N testing masking individual conductor problems, capacitive effects varying between test configurations, and equipment connections affecting specific conductor pairs. Always record all test methods used, explain any significant variations, and use the most conservative (lowest) acceptable reading for safety assessment.',
    },
  ];
