...
const faqData = [
  ...
  },
  {
    ...
    answer:
      "An EIC (Electrical Installation Certificate) is required for new installations, complete rewires, new consumer units, and addition of new circuits. A MEIWC (Minor Electrical Installation Works Certificate) is for minor additions like extra socket outlets, lighting points, or accessory replacements that don't require new circuits.",
  },
  {
    question: 'How long should electrical certificates be retained?',
    answer:
      'Certificates should be retained for the life of the electrical installation. Building owners must keep copies and provide them to subsequent owners, tenants, or their representatives. For rental properties, certificates must be provided to tenants and local authorities upon request.',
  },
  {
    question: 'Can electronic certificates be used instead of paper copies?',
    answer:
      'Yes, electronic certificates are acceptable provided they maintain security, authenticity, and accessibility. They must be completed using approved software, include digital signatures where appropriate, be stored securely with backup copies, and be easily printable when required.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Building Regulations Part P notification is required for most electrical work in dwellings unless performed by a registered competent person scheme member. Work in kitchens, bathrooms, outdoors, and new circuits always requires notification. Non-notifiable work still requires appropriate certification.',
  },
  {
    question: 'Can certificates be issued for work not witnessed during installation?',
    answer:
      "Certificates should only cover work that has been properly inspected and tested. If the certifier didn't witness installation, they must conduct thorough inspection to verify compliance. Any limitations in inspection scope must be clearly documented. Never sign certificates for work you cannot verify.",
  },
  {
    question: 'What should be done if a certificate contains errors after completion?',
    answer:
      'Minor errors can be corrected with clearly initialled amendments if discovered immediately. Significant errors require a new certificate to be issued. The original should be marked as superseded and withdrawn. Never alter certificates fraudulently or backdate corrections.',
  },
  {
    question: 'How does certification relate to insurance and warranties?',
    answer:
      'Proper certification is often essential for insurance validity and warranty claims. Insurers may require certificates for new installations or after electrical incidents. Product warranties frequently require certified installation by competent persons. Missing or incorrect certificates can void coverage and claims.',
  },
  {
    question: 'What are the requirements for competent person scheme membership?',
    answer:
      'Scheme membership requires relevant qualifications, insurance coverage, regular assessment visits, continuing professional development, adherence to scheme rules, and payment of fees. Members can self-certify compliance with Building Regulations Part P without local authority notification.',
  },
  {
