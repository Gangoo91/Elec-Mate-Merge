...
const quizQuestions: QuizQuestion[] = [
  {
    ...
    correctAnswer: 0,
    explanation:
      'The initial ring continuity test checks that each conductor (line, neutral, and CPC) forms a complete loop from the distribution board and back.',
  },
  {
    id: 2,
    ...
    correctAnswer: 1,
    explanation:
      'Cross-connections are used to check that conductors are correctly wired at each accessory and to identify interconnections or wiring faults.',
  },
  {
    id: 3,
    question:
      'True or False: If one leg of the CPC is disconnected, the ring will still function safely.',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'False. If one leg of the CPC is disconnected, earth protection is compromised, potentially leaving some outlets without proper earthing.',
  },
  {
    id: 4,
    question:
      'What would a significantly low resistance reading at one socket suggest during a cross-connection test?',
    options: [
      'Perfect continuity',
    ...
    correctAnswer: 3,
    explanation:
      'A significantly low resistance reading at one socket suggests a possible interconnection with another circuit or a wiring fault that creates a parallel path.',
  },
  {
    id: 5,
    ...
    correctAnswer: 0,
    explanation:
      'The CPC usually shows higher resistance due to its smaller cross-sectional area compared to line and neutral conductors in many cable types.',
  },
  {
    id: 6,
    question: 'What is the purpose of testing at both ends of the ring circuit?',
    options: [
      'To double-check the accuracy of the recorded readings',
      'To test a different set of socket outlets on the circuit',
      'To verify the ring is complete and identify each leg',
      'To reduce measurement errors caused by lead resistance',
    ],
    correctAnswer: 2,
    explanation:
      'Testing at both ends verifies the ring is complete and helps identify which conductors form the outgoing and return legs of the ring.',
  },
  {
    id: 7,
    ...
    correctAnswer: 1,
    explanation:
      'Infinite resistance indicates an open circuit that must be investigated and rectified before any further testing can proceed safely.',
  },
  {
    id: 8,
    question: 'During cross-connection testing, what should the resistance readings be?',
    options: [
      'All readings should be exactly identical at every socket outlet',
      'Readings should rise steadily with distance from the board',
      'Readings should be roughly equal, varying with cable length',
      'Readings should be infinite at every point on the circuit',
    ],
    correctAnswer: 2,
    explanation:
      'Cross-connection readings should be roughly equal with slight variations due to different cable lengths to each socket outlet on the ring.',
  },
  {
    id: 9,
    question: 'What indicates a successful ring final circuit test?',
    options: [
      'Every conductor reading measures below 1 ohm at the board',
      'No open circuits are detected on any of the conductors',
      'All socket outlets are working correctly once energised',
      'End-to-end continuity confirmed and cross-connections as expected',
    ],
    correctAnswer: 3,
    explanation:
      'A successful test requires confirmed end-to-end continuity on all conductors plus cross-connection readings showing expected values without anomalies.',
  },
  {
    id: 10,
