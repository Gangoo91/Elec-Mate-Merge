...
export const ScenarioBuilder = () => {
  ...
  const setSelectedScenario = (scenario: string) =>
    setSearchParams({ scenario }, { replace: false });
  ...
  const scenarios: Scenario[] = [
    {
      ...
      difficulty: 'Basic',
      context:
        'You are inspecting a recently renovated kitchen in a 1970s house. The homeowner has added new appliances and wants an EICR for insurance purposes.',
      steps: [
        {
          id: 'visual1',
          title: 'Initial Visual Assessment',
          description:
            'Upon entering the kitchen, you notice the consumer unit is located in a cupboard under the stairs. What is your first concern?',
          options: [
        ...
        },
        {
          ...
          description:
            'You find several socket outlets very close to the kitchen sink. What action should you take?',
          options: [
          ...
          correctOption: 1,
          consequence:
            'Zone requirements prevent water ingress risks and ensure electrical safety.',
        ...
        },
        {
          ...
          safetyNote:
            'Never skip visual inspection - it protects you and identifies obvious faults.',
        },
      ],
    },
    {
      ...
      context:
        'You are conducting a periodic inspection of a 3-story office building. The installation includes a complex distribution system with sub-mains to each floor.',
      steps: [
        {
          id: 'planning1',
          title: 'Inspection Planning',
          description:
            'The building manager wants minimal disruption. How do you plan your approach?',
          options: [
          ...
          safetyNote:
            'Plan testing to minimise business disruption while maintaining safety standards.',
        },
        {
          id: 'documentation1',
          title: 'Documentation Review',
          description:
            'Previous test certificates show some Zs values close to the maximum permitted limits. What should you do?',
          options: [
            'Accept the previous results provided they are recent',
            'Skip retesting because the values were still within limits',
            'Retest those circuits first as a priority',
            'Only retest them if the client specifically requests it',
          ],
          correctOption: 2,
          consequence: 'Values close to the limit require verification to confirm continued safety.',
          safetyNote: 'Marginal results from previous tests should be a priority for retesting.',
        },
      ],
    },
    {
      ...
      difficulty: 'Advanced',
      context:
        'You are inspecting a manufacturing facility with 3-phase supplies, motor circuits, and harsh environmental conditions.',
      steps: [
        {
          id: 'environment1',
          title: 'Environmental Assessment',
          description:
            'The factory has areas with metal dust and occasional water exposure. What specific concerns do you have?',
          options: [
            'Standard testing procedures apply with no extra checks',
            'Restrict all testing to dry conditions only',
            'Focus solely on the earth bonding arrangements',
            'Check IP ratings and the integrity of every enclosure',
          ],
          correctOption: 3,
          consequence: 'Environmental protection determines equipment suitability and safety.',
          safetyNote:
            'Environmental conditions directly affect safety requirements and equipment selection.',
        },
      ],
    },
  ];
  ...
  const calculateScore = () => {
    ...
    const correctAnswers = currentScenario.steps.filter(
      (step) => userChoices[step.id] === step.correctOption
    ).length;
      ...
      <Card className="bg-elec-gray border-transparent">
        ...
        <CardContent className="space-y-6">
          <div className="text-center">
            <div className="text-3xl font-bold text-elec-yellow mb-2">{score}%</div>
