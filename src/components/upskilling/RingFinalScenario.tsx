    ...
    <Card className="bg-elec-gray border-transparent">
      ...
      <CardContent className="space-y-4">
        <div className="bg-[#323232] rounded-lg p-4">
          ...
          <div className="bg-orange-600/10 border border-orange-600/20 rounded p-4 mb-4">
            <p className="text-foreground leading-relaxed">
              You perform cross-connection tests on a ring final circuit and get a{' '}
              <strong>much lower resistance</strong> at one socket compared to all others. The
              reading is 0.15Ω when all other sockets show 0.65-0.75Ω. What should you do next?
            </p>
          </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-foreground text-sm leading-relaxed">
                    This significantly low reading suggests a possible interconnection with another
                    circuit or a wiring fault. This creates a dangerous parallel path that could
                    overload conductors.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-foreground text-sm mt-3 font-medium">
                    ...
                    resolved and the circuit shows consistent readings.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="bg-blue-600/10 border border-blue-600/20 rounded-lg p-4">
          ...
          <div className="space-y-2 text-foreground text-sm">
            <div className="flex items-start gap-2">
              <span className="w-4 h-4 bg-blue-400 text-foreground rounded-full flex items-center justify-center text-xs mt-0.5">
                1
              </span>
        ...
        <div className="bg-yellow-600/10 border border-yellow-600/20 rounded-lg p-4">
          ...
          <p className="text-foreground text-sm leading-relaxed">
            Inconsistent readings in ring circuit testing often indicate serious wiring faults that
            can compromise both safety and circuit protection. Always investigate anomalies
