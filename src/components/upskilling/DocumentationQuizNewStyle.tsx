...
const questions: Question[] = [
  ...
  },
  {
    id: 3,
    question:
      'According to BS 7671, what information must be provided to enable proper inspection?',
    options: [
    ...
    correctAnswer: 2,
    explanation:
      'BS 7671 Regulation 514.9.1 requires diagrams, charts, or tables showing the type and composition of circuits, protective devices, and their characteristics.',
  },
  {
    id: 4,
  ...
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      'While some documentation is always preferable, you may proceed with creating as-built drawings during inspection, but this must be clearly noted as a limitation.',
  },
  {
    id: 6,
  ...
  },
  {
    ...
    options: ['6 months', '2 years', 'Life of the installation', 'Until next inspection'],
    correctAnswer: 2,
    explanation:
      'Minor Works Certificates must be retained for 2 years as they document important changes and additions to the electrical installation.',
  },
  {
    id: 8,
...
export const DocumentationQuizNewStyle = () => {
  ...
  const getScoreMessage = (percentage: number) => {
    if (percentage >= 80)
      return 'Excellent! You have a strong understanding of documentation requirements.';
  ...
  if (quizComplete) {
    ...
    return (
      <Card className="bg-elec-gray border-transparent">
        <CardHeader>
          <CardTitle className="text-foreground text-center text-xl sm:text-2xl">
            Quiz Complete!
          </CardTitle>
        </CardHeader>
      ...
      <Card className="bg-elec-gray border-transparent">
        ...
        <CardContent className="space-y-4">
          {currentQ.options.map((option, index) => {
            let buttonClass =
              'w-full text-left p-4 sm:p-5 rounded-lg border transition-all duration-200 ';
            ...
            if (showExplanation) {
              ...
              if (selectedAnswer === index) {
                ...
                buttonClass +=
                  'border-gray-600 bg-elec-gray text-foreground hover:border-gray-500 hover:bg-[#323232]';
              }
            }
