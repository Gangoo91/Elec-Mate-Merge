...
const questions: Question[] = [
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'False. You should never assume circuit layout if labels are missing. This creates safety risks and compliance issues.',
  },
  {
    id: 4,
  ...
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      'Any premises with escape lighting systems must have emergency lighting circuits clearly identified for maintenance and emergency purposes.',
  },
  {
    id: 8,
...
export const AccessibilityQuizNewStyle = () => {
  ...
  const getScoreMessage = (percentage: number) => {
    if (percentage >= 80)
      return 'Excellent! You have a strong understanding of accessibility and labelling requirements.';
