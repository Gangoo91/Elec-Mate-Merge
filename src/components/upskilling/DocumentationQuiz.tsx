...
export const DocumentationQuiz = () => {
  ...
  const isQuizComplete =
    answeredQuestions.length === questions.length && answeredQuestions.every(Boolean);
        ...
        {!isQuizComplete ? (
          <>
            <div className="space-y-4">
              <h3 className="text-foreground font-medium">{questions[currentQuestion].question}</h3>
            ...
            {showResult && (
              <div className="bg-blue-600/10 border border-blue-600/20 rounded-lg p-4">
                ...
                <p className="text-foreground text-sm">{questions[currentQuestion].explanation}</p>
              </div>
            )}
          ...
          <div className="text-center space-y-4">
            <div className="text-2xl font-bold text-foreground">Quiz Complete!</div>
