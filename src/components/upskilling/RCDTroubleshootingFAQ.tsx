...
const faqData = [
  ...
  },
  {
    ...
    answer:
      'Trip time degradation usually results from: contact oxidation reducing sensitivity, magnetic circuit deterioration, component aging in electronic RCDs, environmental contamination affecting mechanisms, and mechanical wear in the trip mechanism. Regular maintenance and testing can identify gradual deterioration before it becomes dangerous.',
  },
  {
