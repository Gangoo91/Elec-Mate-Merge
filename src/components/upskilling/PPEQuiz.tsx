...
const PPEQuiz = () => {
  const questions: QuizQuestion[] = [
    {
      id: 1,
      question: 'Which of the following is a standard PPE item for live electrical work?',
      options: [
        'Flame-resistant clothing rated for arc flash',
        'Open rubber sandals for insulation',
        'Foam earplugs to block dust',
    ...
    {
      id: 2,
      question: 'How does PPE relate to safe isolation in the hierarchy of control?',
      options: [
        'PPE removes the need to isolate, if it is rated correctly',
        'PPE and isolation are interchangeable alternatives',
        'PPE is a last line of defence and never replaces isolation',
        'PPE is only needed when isolation is impossible',
      ],
      correctAnswer: 2,
      explanation:
        'PPE sits at the bottom of the hierarchy of control as a last line of defence; it protects you if other controls fail but never replaces safe isolation.',
    },
    {
      id: 3,
      question: 'What does PPE primarily protect against during electrical testing?',
      options: [
        'Financial loss from a failed job',
        'Complaints about excessive noise',
        'Errors in the test documentation',
        'Electrical hazards if other procedures fail',
      ],
      correctAnswer: 3,
      explanation:
    ...
    {
      id: 4,
      question: 'Who is ultimately responsible for ensuring PPE is worn correctly at the point of use?',
      options: [
        'The electrician actually using it',
        'The site manager on the day',
