  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="bg-elec-gray border-transparent">
        ...
        <CardContent className="space-y-4 text-gray-300">
          <p className="leading-relaxed text-lg">
            Think of network components like the difference between pipes and pumps in a water
            system.
          </p>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div>
                ...
                <p className="text-gray-300 text-sm leading-relaxed">
                  Just like water pipes, cables and connectors simply carry signals from one place
                  to another. They don&apos;t need power and don&apos;t change the signal.
                </p>
              </div>
              <div>
      ...
      <Card className="bg-elec-gray border-transparent">
        ...
        <CardContent className="space-y-4 text-gray-300">
          <p className="leading-relaxed">
            Passive components do not require electrical power to function and simply provide
            physical pathways for signals to travel. They form the foundation of structured cabling
            systems.
          </p>
            ...
            <div className="space-y-4">
              <div className="bg-blue-600/20 border border-blue-600/30 rounded-lg p-4">
                ...
                <ul className="space-y-2 text-blue-100 text-sm">
                  <li>
                    • <strong>Copper cables:</strong> Cat 5e, Cat 6, Cat 6A, Cat 8
                  </li>
                  <li>
                    • <strong>Fibre optic cables:</strong> Single-mode, multi-mode
                  </li>
                  <li>
                    • <strong>Coaxial cables:</strong> For specific applications
                  </li>
                  <li>
                    • <strong>Backbone cables:</strong> High-capacity inter-building links
                  </li>
                </ul>
              </div>
      ...
      <Card className="bg-elec-gray border-transparent">
        ...
        <CardContent className="space-y-4 text-gray-300">
          <p className="leading-relaxed">
            ...
            amplification, switching, and routing capabilities. They enable network intelligence and
            management.
          </p>
            ...
            <div className="space-y-4">
              <div className="bg-red-600/20 border border-red-600/30 rounded-lg p-4">
                ...
                <ul className="space-y-2 text-red-100 text-sm">
                  <li>
                    • <strong>Unmanaged switches:</strong> Basic plug-and-play operation
                  </li>
                  <li>
                    • <strong>Managed switches:</strong> Advanced features and control
                  </li>
                  <li>
                    • <strong>PoE switches:</strong> Power over Ethernet capability
                  </li>
                  <li>
                    • <strong>Layer 3 switches:</strong> Routing capabilities
                  </li>
                </ul>
              </div>
      ...
      <Card className="bg-elec-gray border-transparent">
        ...
        <CardContent className="space-y-4 text-gray-300">
          <p className="leading-relaxed">
            Understanding the true cost of passive vs active components requires analysing both
            initial investment and ongoing operational expenses over the entire lifecycle of the
            infrastructure.
          </p>
          ...
          <div className="bg-slate-800/30 rounded-lg p-4">
            ...
            <p className="text-gray-300 text-sm mb-3">For a 100-port network installation:</p>
      ...
      <Card className="bg-elec-gray border-transparent">
        ...
        <CardContent className="space-y-4 text-gray-300">
          <p className="leading-relaxed">
            ...
            passive and active components, affecting both operational costs and network
            availability.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="space-y-4">
              <div className="bg-green-600/20 border border-green-600/30 rounded-lg p-4">
                ...
                <ul className="space-y-2 text-green-100 text-sm">
                  <li>
                    • <strong>Visual inspections:</strong> Annual cable tray and pathway checks
                  </li>
                  <li>
                    • <strong>Performance testing:</strong> 3-5 year certification testing
                  </li>
                  <li>
                    • <strong>Physical protection:</strong> Monitor for damage or degradation
                  </li>
                  <li>
                    • <strong>Documentation updates:</strong> Track any moves, adds, changes
                  </li>
                  <li>
                    • <strong>Cleaning:</strong> Fibre connector maintenance as needed
                  </li>
                </ul>
                <div className="mt-3 p-2 bg-green-700/20 rounded">
                  <p className="text-green-200 text-xs">
                    <strong>MTBF:</strong> 25+ years for quality copper cables
                    <br />
            ...
            <div className="space-y-4">
              <div className="bg-yellow-600/20 border border-yellow-600/30 rounded-lg p-4">
                ...
                <ul className="space-y-2 text-yellow-100 text-sm">
                  <li>
                    • <strong>Firmware updates:</strong> Quarterly security and feature updates
                  </li>
                  <li>
                    • <strong>Performance monitoring:</strong> Continuous traffic and health
                    monitoring
                  </li>
                  <li>
                    • <strong>Environmental control:</strong> Temperature and power monitoring
                  </li>
                  <li>
                    • <strong>Backup procedures:</strong> Configuration backup and recovery
                  </li>
                  <li>
                    • <strong>Preventive replacement:</strong> Fans, power supplies, batteries
                  </li>
                </ul>
                <div className="mt-3 p-2 bg-yellow-700/20 rounded">
                  <p className="text-yellow-200 text-xs">
                    <strong>MTBF:</strong> 5-8 years for enterprise switches
                    <br />
            ...
            <div className="space-y-4">
              ...
              <div className="bg-blue-600/20 border border-blue-600/30 rounded-lg p-4">
                <h4 className="font-semibold text-blue-300 mb-2">
                  Best Practices for Passive Design
                </h4>
                <ul className="space-y-1 text-blue-100 text-sm">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-orange-600/20 border border-orange-600/30 rounded-lg p-4">
                <h4 className="font-semibold text-orange-300 mb-2">
                  Best Practices for Active Design
                </h4>
                <ul className="space-y-1 text-orange-100 text-sm">
