  ...
  const questions = [
    {
      ...
      options: [
        'The supply transformer winding impedance',
        'The supply network earth electrode resistance',
        'The circuit wiring resistance (R1 + R2)',
        'The distributor’s supply cable impedance',
      ],
      correctAnswer: 2,
      explanation:
    ...
    },
    {
      ...
      options: [
        'A particularly good earthing arrangement',
        'A perfectly normal, expected test result',
        'A high-quality circuit design',
        'A poor fault path that may not operate protection in time',
      ],
      correctAnswer: 3,
      explanation:
    ...
    {
      id: 5,
      question: 'What must measured Zs values be compared against?',
      options: [
        'The maximum values in BS 7671 for the protective device',
        'Only the results from the previous inspection',
        'Typical industry average figures',
        'Informal manufacturer suggestions',
      ],
      correctAnswer: 0,
      explanation:
