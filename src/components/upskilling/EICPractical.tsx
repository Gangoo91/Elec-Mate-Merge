...
const EICPractical = () => {
  const completionSteps = [
    ...
    {
      step: 3,
      action: 'Record all circuit details in schedule including cable types and protection',
    },
            ...
            <div className="bg-yellow-600/10 border border-yellow-600/20 rounded-lg p-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-foreground text-sm">
                    Document all design criteria including cable calculations and protective device
                    selection.
                  </p>
                </div>
              </div>
