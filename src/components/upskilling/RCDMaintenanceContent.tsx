...
const RCDMaintenanceContent = () => {
  ...
  const maintenanceSchedule = [
    {
      frequency: 'Monthly',
      task: 'Test button operation by users',
      responsibility: 'Building users/occupants',
    },
    {
      frequency: '6 Monthly',
      task: 'Visual inspection and basic function check',
      responsibility: 'Competent person',
    },
    {
      frequency: 'Annually',
      task: 'Full electrical testing and calibration',
      responsibility: 'Qualified electrician',
    },
    {
      frequency: '5 Years',
      task: 'Comprehensive periodic inspection',
      responsibility: 'Qualified electrician',
    },
    {
      frequency: '10 Years',
      task: 'Replace or major overhaul consideration',
      responsibility: 'Qualified electrician',
    },
  ];
  ...
  return (
    <Card className="bg-elec-gray border-transparent">
      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-[#323232] rounded-lg p-4 space-y-3">
            <p className="text-foreground leading-relaxed text-sm sm:text-base">
              RCD maintenance is essential for ensuring continued protection and compliance with BS
              7671. Regular maintenance prevents deterioration, identifies potential failures, and
              maintains optimal performance throughout the RCD's service life.
            </p>
            <div className="flex items-start gap-3 bg-green-600/10 border border-green-600/20 rounded p-3">
              <Shield className="h-5 w-5 text-green-400 mt-0.5 flex-shrink-0" />
              <p className="text-foreground text-sm sm:text-base">
                <strong>Remember:</strong> Proper maintenance extends RCD life, reduces failure
                risk, and ensures continuous protection for users and installations.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-[#323232] rounded-lg p-4 space-y-3">
            <div className="bg-blue-600/10 border border-blue-600/20 rounded p-3">
              ...
              <p className="text-foreground text-sm sm:text-base">
                The effectiveness of all RCDs shall be verified during initial verification and at
                appropriate intervals thereafter as determined by the inspection schedule.
              </p>
            </div>
            <div className="bg-yellow-600/10 border border-yellow-600/20 rounded p-3">
              ...
              <p className="text-foreground text-sm sm:text-base">
                Provides detailed guidance on RCD testing frequencies, methods, and acceptance
                criteria for ongoing verification and maintenance activities.
              </p>
            </div>
            <div className="bg-red-600/10 border border-red-600/20 rounded p-3">
              ...
              <p className="text-foreground text-sm sm:text-base">
                Require duty holders to maintain safe electrical systems throughout the building's
                lifecycle, including proper RCD maintenance and testing regimes.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-[#323232] rounded-lg p-4">
            ...
            <div className="mt-4 bg-blue-600/10 border border-blue-600/20 rounded p-3">
              <p className="text-foreground text-sm sm:text-base">
                <strong>Purpose:</strong> To ensure RCD reliability through structured preventive
          ...
          <div className="bg-[#323232] rounded-lg p-4 space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {complianceRequirements.map((requirement, index) => (
                <div
                  key={index}
                  className="bg-yellow-600/10 border border-yellow-600/20 rounded p-3"
                >
                  <div className="flex items-start gap-3">
        ...
        <div className="space-y-4">
          <h3 className="text-xl font-semibold text-foreground">
            RCD Aging and Deterioration Factors
          </h3>
          <div className="bg-[#323232] rounded-lg p-4 space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="bg-blue-600/10 border border-blue-600/20 rounded-lg p-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-foreground text-sm sm:text-base">
                    Maintain comprehensive records of all maintenance activities, test results, and
                    observations for legal compliance and performance trending.
                  </p>
                </div>
              </div>
            </div>
            <div className="bg-red-600/10 border border-red-600/20 rounded-lg p-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-foreground text-sm sm:text-base">
                    Always follow safe isolation procedures and coordinate maintenance activities
                    with building operations to prevent service disruption.
                  </p>
                </div>
              </div>
            </div>
