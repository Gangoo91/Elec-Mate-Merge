  ...
  const takeaways = [
    {
      ...
      description:
        'Proper equipment setup is essential for accurate readings. Lead resistance must be removed from measurements.',
    },
    {
      title: 'Record actual values—not estimates',
      description:
        'Document precise readings for proper assessment and future reference. Estimates or tick marks are not acceptable.',
    },
    {
      title: 'Compare against cable length and expected resistance',
      description:
        'Readings should make sense for the circuit length and conductor size. Unexpectedly high values require investigation.',
    },
    {
      title: 'Abnormal values indicate real risks—stop and resolve before proceeding',
      description:
        "Don't continue with further testing if continuity values are outside expected ranges. Safety depends on proper continuity.",
    },
  ];
