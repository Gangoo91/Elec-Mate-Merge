  ...
  const takeaways = [
    {
      ...
      description:
        'Continuity testing confirms that protective conductors are properly connected and effective',
      details:
        'Without continuity, fault current cannot return to the source to operate protective devices, leaving metalwork dangerously live.',
    },
    {
      icon: Zap,
      ...
      details:
        'The entire protective system relies on continuous conductors to carry fault current back to the supply and trigger automatic disconnection.',
    },
    {
      icon: CheckCircle,
      ...
      details:
        "If continuity fails, there's no point in further testing. The installation isn't safe and must be corrected before proceeding.",
    },
    {
      icon: AlertTriangle,
      ...
      details:
        'Time pressure, neat appearance, or previous good results are never valid reasons to skip continuity testing. Lives depend on it.',
    },
  ];
      ...
      <CardContent className="space-y-6">
        ...
        <div className="bg-red-600/10 border border-red-600/20 rounded-lg p-4">
          ...
          <p className="text-foreground text-sm sm:text-base leading-relaxed">
            Every continuity test you perform could be the difference between someone going home
            safely or suffering a fatal electric shock. Protective conductors are the last line of
            defence when something goes wrong. Never compromise on this fundamental safety
            verification.
          </p>
        </div>
      </CardContent>
