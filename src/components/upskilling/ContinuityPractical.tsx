              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <ol className="text-foreground text-xs sm:text-sm space-y-2 sm:space-y-3 list-decimal list-inside leading-relaxed">
                    <li>
                      <strong>Start with protective conductors:</strong> Test CPCs first as these
                      are critical for safety
                    </li>
                    <li>
                      <strong>Progress to bonding:</strong> Test main bonding, then supplementary
                      bonding conductors
                    </li>
                    <li>
                      <strong>Ring circuit testing:</strong> Test ring continuity using appropriate
                      method (end-to-end)
                    </li>
                    <li>
                      <strong>Record all readings:</strong> Document resistance values and any
                      observations
                    </li>
                    <li>
                      <strong>Compare with expectations:</strong> Check readings align with cable
                      specifications
                    </li>
                    <li>
                      <strong>Investigate anomalies:</strong> Any unexpected readings require
                      investigation
                    </li>
                  </ol>
                </div>
            ...
            <div className="space-y-3 sm:space-y-4">
              <div className="bg-red-600/10 border border-red-600/20 rounded-lg p-4 sm:p-5">
                <h4 className="text-red-400 font-medium mb-2 sm:mb-3 text-sm sm:text-base">
                  Problem: High Resistance Readings
                </h4>
                <div className="text-foreground text-xs sm:text-sm space-y-1 sm:space-y-2 leading-relaxed">
                  <p>
                    <strong>Possible Causes:</strong> Poor connections, corroded terminals, damaged
                    conductors
                  </p>
                  <p>
                    <strong>Solutions:</strong> Clean connections, tighten terminals, check cable
                    integrity, verify correct cable size
                  </p>
                </div>
              </div>
              <div className="bg-yellow-600/10 border border-yellow-600/20 rounded-lg p-4 sm:p-5">
                ...
                <div className="text-foreground text-xs sm:text-sm space-y-1 sm:space-y-2 leading-relaxed">
                  <p>
                    <strong>Possible Causes:</strong> Loose connections, intermittent faults,
                    parallel paths
                  </p>
                  <p>
                    <strong>Solutions:</strong> Re-check connections, investigate for loose joints,
                    ensure all parallel paths are identified
                  </p>
                </div>
              </div>
              <div className="bg-orange-600/10 border border-orange-600/20 rounded-lg p-4 sm:p-5">
                <h4 className="text-orange-400 font-medium mb-2 sm:mb-3 text-sm sm:text-base">
                  Problem: Open Circuit Readings
                </h4>
                <div className="text-foreground text-xs sm:text-sm space-y-1 sm:space-y-2 leading-relaxed">
                  <p>
                    <strong>Possible Causes:</strong> Broken conductor, disconnected joint,
                    incorrect connection
                  </p>
                  <p>
                    <strong>Solutions:</strong> Trace circuit path, check all joints, verify
                    terminations, rectify before proceeding
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-red-600/10 border border-red-600/20 rounded-lg p-4 sm:p-5">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="text-red-400 font-medium mb-3 text-sm sm:text-base">
