...
import { recordingQuizQuestions } from '@/data/upskilling/recordingQuizData';

export const RecordingQuiz = () => {
  ...
  const handleNext = () => {
    if (currentQuestion < recordingQuizQuestions.length - 1) {
      ...
      <Card className="bg-elec-gray border-transparent">
        ...
        <CardContent>
          <TestProceduresQuizResults
            questions={recordingQuizQuestions}
    ...
    <Card className="bg-elec-gray border-transparent">
      ...
      <CardContent className="space-y-6">
        ...
        <QuizNavigation
          ...
          onNext={handleNext}
          isLastQuestion={currentQuestion === recordingQuizQuestions.length - 1}
        />
      </CardContent>
    </Card>
  );
