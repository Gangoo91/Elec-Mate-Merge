...
const quizQuestions: QuizQuestion[] = [
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Building Regulations Part P covers electrical safety in the design and installation of electrical installations in dwellings, ensuring they are designed and installed safely.',
  },
  {
    id: 3,
    question:
...
const LegalFrameworkQuiz = () => {
  ...
  const getScoreMessage = (score: number) => {
    ...
    if (percentage >= 80)
      return 'Excellent! You have a strong understanding of the legal and regulatory framework.';
    if (percentage >= 60)
      return 'Good work! You have a solid grasp of the legal requirements with room for improvement.';
    if (percentage >= 40)
      return 'Fair effort. Consider reviewing the legal framework material to strengthen your understanding.';
        ...
        <Card className="bg-[#323232] border-transparent">
          ...
          <CardContent className="space-y-4">
            <div className="text-center">
              ...
              <div className="text-gray-300 mb-4">{getScoreMessage(score)}</div>
            </div>
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="bg-[#323232] border-transparent">
        <CardHeader>
          <CardTitle className="text-foreground text-lg">{question.question}</CardTitle>
        </CardHeader>
