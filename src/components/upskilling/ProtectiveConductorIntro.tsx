    ...
    <Card className="bg-elec-gray border-transparent">
      ...
      <CardContent className="space-y-4">
        <p className="text-foreground text-base sm:text-lg leading-relaxed">
          This section focuses on verifying the continuity of protective conductors (CPCs), which
          are critical for ensuring the safety of any electrical installation during fault
          conditions.
        </p>
        ...
        <div className="bg-red-600/10 border border-red-600/20 rounded-lg p-4 sm:p-5">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="text-red-200 font-medium mb-2 text-sm sm:text-base">
                Critical Safety Function
              </h3>
              <p className="text-foreground text-xs sm:text-sm leading-relaxed">
                The CPC is your lifeline during fault conditions. Without proper continuity,
                protective devices cannot operate correctly, potentially leaving exposed metalwork
                at dangerous potentials and putting lives at risk.
              </p>
            </div>
          </div>
        </div>
