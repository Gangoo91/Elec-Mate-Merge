  ...
  const testPreparationSteps = [
    {
      ...
      description:
        'Check ambient conditions, temperature, and humidity that may affect test results',
    },
    {
      step: 'Circuit Analysis',
      description:
        'Review circuit design to determine appropriate test methods and expected results',
    },
    {
      step: 'Equipment Preparation',
      description:
        'Calibrate instruments, check battery levels, and prepare all necessary test leads',
    },
    {
      step: 'Communication',
      ...
      <CardContent className="space-y-8">
        <div>
          ...
          <div className="space-y-3">
            <p className="text-foreground leading-relaxed">
              Confirming readiness is the critical gateway between visual inspection and electrical
              testing. This stage determines whether it's safe and appropriate to proceed with
              applying test voltages to the installation.
            </p>
            <p className="text-foreground leading-relaxed">
              Failing to properly confirm readiness can result in personal injury, equipment damage,
              inaccurate test results, and potential legal liability. Under BS 7671, you have a duty
              of care to ensure all precautions are taken.
            </p>
          </div>
        </div>
        ...
        <div>
          <h3 className="text-lg font-semibold text-elec-yellow mb-4">
            Pre-Test Safety Considerations
          </h3>
        ...
        <div>
          <h3 className="text-lg font-semibold text-elec-yellow mb-4">
            Systematic Readiness Checklist
          </h3>
