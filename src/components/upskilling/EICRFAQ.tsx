  ...
  const faqData = [
    {
      ...
      answer:
        'An EICR provides a comprehensive assessment of the safety and condition of an existing electrical installation. It identifies defects, damage, deterioration, and non-compliance with current standards that may give rise to danger. The report includes observations with appropriate classification codes and recommendations for remedial action to ensure continued safe operation of the installation.',
    },
    {
    ...
    },
    {
      ...
      question:
        'What testing can be omitted if it would cause damage, and how should this be recorded?',
      answer:
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-foreground text-sm leading-relaxed">
                These FAQs provide general guidance on EICR procedures and requirements. Always
                refer to the current edition of BS 7671 and relevant guidance documents for
                definitive requirements. Seek professional advice for complex situations or where
                interpretation of standards is required.
              </p>
            </div>
          </div>
        </div>
