        ...
        <div className="space-y-3 sm:space-y-4">
          <div className="bg-red-900/20 border border-red-500/30 p-4 rounded-md">
            ...
            <p className="text-foreground text-sm sm:text-base leading-relaxed">
              You test Zs at a socket near the distribution board, and it passes comfortably at
              0.8Ω. Feeling confident, you skip testing at the end of the circuit to save time.
              Later, a fault occurs at the furthest socket—where the actual Zs is 2.5Ω—and the MCB
              fails to disconnect quickly enough.
            </p>
          </div>
          ...
          <div className="bg-green-900/20 border border-green-500/30 p-4 rounded-md">
            ...
            <p className="text-foreground text-sm sm:text-base leading-relaxed">
              Always test at the furthest point—not the easiest. The impedance increases with
              distance from the supply, so testing near the DB gives a false sense of security. Only
              by testing at the worst-case location can you ensure protection throughout the entire
              circuit.
            </p>
          </div>
