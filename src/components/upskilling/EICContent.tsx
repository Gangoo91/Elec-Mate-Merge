...
const EICContent = () => {
  const introductionContent = {
    overview:
      'The Electrical Installation Certificate (EIC) is the cornerstone document for demonstrating compliance with BS 7671 for new electrical installations and major alterations. This comprehensive certificate serves as both a design record and verification document, providing essential information for the safe operation and future maintenance of electrical installations.',
    importance:
      'Understanding when and how to complete an EIC correctly is fundamental to electrical installation work. The certificate not only demonstrates legal compliance but also protects both the installer and the client by providing documented evidence of proper design, installation, and testing procedures.',
    scope:
      'This section covers the complete EIC process from initial design considerations through to final certification, including practical completion techniques, common pitfalls to avoid, and the legal implications of certification.',
  };
  ...
  const eicRequirements = [
    {
      work: 'Complete new electrical installation',
      certificate: 'EIC',
      reason: 'New installation requiring full design verification and comprehensive testing',
    },
    {
      work: 'New consumer unit installation',
      certificate: 'EIC',
      reason: 'Major alteration affecting entire installation requiring design assessment',
    },
    {
      work: 'Addition of new circuits',
      certificate: 'EIC',
      reason: 'Significant alteration requiring design calculations and full testing regime',
    },
    {
      work: 'Complete house rewire',
      certificate: 'EIC',
      reason: 'New installation replacing existing system with full design responsibility',
    },
    {
      work: 'Extension with new circuits',
      certificate: 'EIC',
      reason: 'New circuits requiring design calculations and protective device coordination',
    },
    {
      work: 'Commercial fit-out installation',
      certificate: 'EIC',
      reason: 'New installation with complex load calculations and special requirements',
    },
    {
      work: 'Three-phase installation',
      certificate: 'EIC',
      reason: 'Complex installation requiring phase sequence verification and load balancing',
    },
    {
      work: 'Installation with special locations',
      certificate: 'EIC',
      reason: 'Design must consider enhanced protection requirements per BS 7671 Part 7',
    },
  ];
  ...
  const designResponsibilities = [
    {
      role: 'Designer',
      responsibilities: [
        'Load calculations and diversity assessment',
        'Cable sizing and protection coordination',
        'Earthing system design',
        'Compliance with BS 7671 and other standards',
      ],
    },
    {
      role: 'Installer',
  ...
  const testingSequence = [
    {
      ...
      requirement: 'All protective conductors verified continuous',
      standard: '≤ (R1 + R2) values',
    },
    {
      order: 2,
      test: 'Continuity of ring final circuits',
      requirement: 'Ring continuity and correct connections',
      standard: 'R1, R2, and r1+r2 measured',
    },
    {
      order: 3,
      test: 'Insulation resistance',
      requirement: 'Between live conductors and earth',
      standard: '≥1MΩ at 500V DC',
    },
    {
      order: 4,
      test: 'Protection by SELV/PELV/electrical separation',
      requirement: 'Where applicable',
      standard: 'Per BS 7671 requirements',
    },
    {
      order: 5,
      test: 'Protection by automatic disconnection',
      requirement: 'Zs measurements at all points',
      standard: '≤ maximum Zs values',
    },
    {
      order: 6,
      test: 'Additional protection (RCD)',
      requirement: 'RCD operation and effectiveness',
      standard: '≤30mA, ≤40ms at 5×IΔn',
    },
    {
      order: 7,
      test: 'Polarity',
      requirement: 'All connections correct polarity',
      standard: 'Single pole devices in line conductors',
    },
    {
      order: 8,
      test: 'Phase sequence',
      requirement: 'Three-phase installations only',
      standard: 'Correct phase rotation verified',
    },
    {
      order: 9,
      test: 'Functional testing',
      requirement: 'All protective devices and controls',
      standard: 'Operate as designed',
    },
  ];
    ...
    <Card className="bg-elec-gray border-transparent">
      ...
      <CardContent className="space-y-8">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-[#323232] rounded-lg p-4 space-y-3">
            <p className="text-foreground leading-relaxed">
              An Electrical Installation Certificate must be issued for all new electrical
              installations and major alterations. This includes complete rewiring, new consumer
              units, and addition of new circuits.
            </p>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-[#323232] rounded-lg p-6 space-y-4">
            <p className="text-foreground leading-relaxed mb-4">
              By the end of this section, you will have developed comprehensive skills in EIC
              completion and understand the critical importance of accurate certification. Each
              objective builds upon previous knowledge to create a complete understanding of the
        ...
        <div className="space-y-4">
          ...
          <div className="bg-[#323232] rounded-lg p-6 space-y-4">
            <p className="text-foreground leading-relaxed mb-4">
              Understanding when an EIC is required versus other certificate types is crucial for
              compliance. The following scenarios require EIC completion, each with specific
              technical and legal considerations that must be addressed during the certification
              process.
            </p>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-[#323232] rounded-lg p-6 space-y-4">
            <p className="text-foreground leading-relaxed mb-4">
              The EIC is structured into distinct sections, each serving a specific purpose in
              documenting the installation. Understanding these sections and their requirements
              ensures comprehensive and compliant certification.
            </p>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-[#323232] rounded-lg p-6 space-y-6">
            <p className="text-foreground leading-relaxed">
              Completing an EIC requires systematic approach and attention to detail. Each section
              must be completed accurately with supporting documentation and calculations where
              required.
            </p>
              ...
              <div className="space-y-3">
                <div className="bg-[#2a2a2a] border border-gray-600 rounded-lg p-4">
                  <h5 className="text-foreground font-medium mb-2">
                    1. Installation Description and Scope
                  </h5>
                  <p className="text-foreground text-sm mb-2">
                    Clearly define the installation work covered by the certificate, including any
                ...
                <div className="bg-[#2a2a2a] border border-gray-600 rounded-lg p-4">
                  <h5 className="text-foreground font-medium mb-2">
                    2. Supply System and Earthing Details
                  </h5>
                  <p className="text-foreground text-sm mb-2">
                    Document the supply characteristics and earthing arrangements that influence the
                    installation design.
                  </p>
                  <ul className="text-foreground text-sm space-y-1">
                ...
                <div className="bg-[#2a2a2a] border border-gray-600 rounded-lg p-4">
                  <h5 className="text-foreground font-medium mb-2">
                    3. Design Calculations and Assessments
                  </h5>
                  <p className="text-foreground text-sm mb-2">
                    Provide comprehensive design information demonstrating compliance with BS 7671
                    requirements.
                  </p>
                  <ul className="text-foreground text-sm space-y-1">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-[#323232] rounded-lg p-6 space-y-4">
            <p className="text-foreground leading-relaxed mb-4">
              The EIC requires three distinct signatures, each representing specific professional
              responsibilities. Understanding these roles ensures appropriate accountability and
        ...
        <div className="space-y-4">
          ...
          <div className="bg-[#323232] rounded-lg p-6 space-y-4">
            <p className="text-foreground leading-relaxed mb-4">
              Testing must be carried out in the correct sequence according to BS 7671 Part 6. Each
              test verifies specific safety parameters and must meet prescribed standards. The
              sequence is designed to ensure safety and prevent damage to equipment.
            </p>
            <div className="space-y-3">
          ...
          <div className="bg-[#323232] rounded-lg p-6 space-y-4">
            <div className="bg-[#2a2a2a] border border-gray-600 rounded p-4">
              ...
              <p className="text-foreground text-sm mb-4">
                Maximum demand assessment is critical for ensuring adequate supply capacity and
                protection coordination. This calculation must consider actual usage patterns, not
                just connected load totals.
              </p>
              <div className="space-y-3">
                <div>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-[#323232] rounded-lg p-6 space-y-4">
            <div className="bg-[#2a2a2a] border border-gray-600 rounded p-4">
              ...
              <p className="text-foreground text-sm mb-4">
                The circuit schedule provides a comprehensive record of all circuits within the
                installation. This information is essential for future maintenance, modification,
        ...
        <div className="space-y-4">
          ...
          <div className="bg-[#323232] rounded-lg p-6 space-y-4">
            <p className="text-foreground leading-relaxed mb-4">
              EIC completion carries significant legal obligations and must comply with multiple
              regulatory frameworks. Understanding these requirements protects both the certifier
              and the installation user.
            </p>
            <div className="space-y-4">
              <div className="bg-[#2a2a2a] border border-gray-600 rounded p-4">
              ...
              <div className="bg-[#2a2a2a] border border-gray-600 rounded p-4">
                ...
                <p className="text-foreground text-sm mb-3">
                  EICs must be retained for the life of the installation and made available to
                  authorised persons when required.
                </p>
                <ul className="text-foreground text-sm space-y-1">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-[#323232] rounded-lg p-6 space-y-4">
            <p className="text-foreground leading-relaxed">
              The Electrical Installation Certificate represents the culmination of professional
              electrical work, combining design expertise, skilled installation, and comprehensive
              verification. Mastery of EIC completion ensures regulatory compliance, professional
              protection, and most importantly, electrical safety.
            </p>
            ...
            <div className="bg-[#2a2a2a] border border-gray-600 rounded p-4 mt-6">
              <p className="text-foreground text-sm">
                <strong className="text-foreground">Next Steps:</strong> Apply this knowledge
                through practical exercises, review common certification scenarios, and test
                understanding with the comprehensive quiz. Remember that EIC completion is both a
                technical skill and a professional responsibility.
              </p>
            </div>
          </div>
        </div>
