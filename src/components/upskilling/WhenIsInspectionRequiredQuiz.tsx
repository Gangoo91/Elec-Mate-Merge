...
const quizQuestions: QuizQuestionType[] = [
  {
    id: 1,
    question:
      'What is the maximum recommended interval for periodic inspection and testing of commercial installations under normal conditions?',
    options: ['1 year', '3 years', '5 years', '10 years'],
    correctAnswer: 2,
    explanation:
      'BS 7671 recommends a maximum interval of 5 years for periodic inspection and testing of commercial installations under normal conditions, though this may be reduced based on the nature of the installation and environment.',
  },
  {
    id: 2,
  ...
  },
  {
    id: 3,
    question:
      'Which of the following would typically require more frequent inspection and testing?',
    options: [
    ...
    correctAnswer: 2,
    explanation:
      'Swimming pool installations require more frequent inspection due to the increased risk from water and the special requirements for electrical installations in wet locations.',
  },
  {
    id: 4,
    question:
  ...
  },
  {
    id: 5,
    question:
      'What is the typical maximum interval for periodic inspection of a domestic installation?',
    options: ['5 years', '10 years', '15 years', '20 years'],
    correctAnswer: 1,
    explanation:
      'The typical maximum interval for periodic inspection of domestic installations is 10 years, though this may be reduced in certain circumstances or high-risk environments.',
  },
  {
    id: 6,
    question:
