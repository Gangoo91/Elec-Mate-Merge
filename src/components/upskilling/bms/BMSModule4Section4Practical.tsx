            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3 p-3 bg-gray-800 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-300">
                    Confirm motors are rated for correct voltage and current. Use dedicated relays
                    or contactors for high-power installations.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3 bg-gray-800 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-300">
                    Keep motor cabling separate from control cabling to avoid electromagnetic
                    interference.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3 bg-gray-800 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-300">
                    Ensure motors stop automatically when blinds reach full open/close positions to
                    prevent damage.
                  </p>
                </div>
              </div>
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3 p-3 bg-gray-800 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-300">
                    Label each blind or façade zone clearly for commissioning and maintenance
                    access.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3 bg-gray-800 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-300">
                    Account for wind loading and motor inrush current when sizing protection
                    devices.
                  </p>
                </div>
              </div>
              ...
              <tbody>
                <tr>
                  <td className="border border-gray-600 px-4 py-2">
                    <strong>Solar Sensor Positioning</strong>
                  </td>
                  ...
                  <td className="border border-gray-600 px-4 py-2">
                    False readings from adjacent surfaces
                  </td>
                </tr>
                <tr className="bg-gray-800/50">
                  <td className="border border-gray-600 px-4 py-2">
                    <strong>Control Wiring</strong>
                  </td>
                  ...
                  <td className="border border-gray-600 px-4 py-2">
                    Signal interference from power cables
                  </td>
                </tr>
                <tr>
                  <td className="border border-gray-600 px-4 py-2">
                    <strong>Movement Programming</strong>
                  </td>
                  ...
                  <td className="border border-gray-600 px-4 py-2">
                    Jerky movement disturbs occupants
                  </td>
                </tr>
                <tr className="bg-gray-800/50">
                  <td className="border border-gray-600 px-4 py-2">
                    <strong>Lighting Coordination</strong>
                  </td>
                  <td className="border border-gray-600 px-4 py-2">
          ...
          <div className="grid gap-4 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
            <div className="bg-gray-800 rounded-lg p-4">
              ...
              <div className="space-y-2 text-sm text-gray-300">
                <p>
                  <strong>Power:</strong> 24V DC, 0.5-2A
                </p>
                <p>
                  <strong>Control:</strong> Up/Down/Stop signals
                </p>
                <p>
                  <strong>Feedback:</strong> Position monitoring available
                </p>
                <p>
                  <strong>Installation:</strong> Built into blind tube
                </p>
                <p>
                  <strong>Protection:</strong> Thermal overload, end-stops
                </p>
                <p>
                  <strong>Lifespan:</strong> 10,000+ cycles typical
                </p>
              </div>
            </div>
            ...
            <div className="bg-gray-800 rounded-lg p-4">
              ...
              <div className="space-y-2 text-sm text-gray-300">
                <p>
                  <strong>Power:</strong> 230V AC, 1-5A
                </p>
                <p>
                  <strong>Control:</strong> Variable speed drives
                </p>
                <p>
                  <strong>Weather Rating:</strong> IP65 minimum
                </p>
                <p>
                  <strong>Wind Loading:</strong> Designed for external forces
                </p>
                <p>
                  <strong>Emergency:</strong> Manual override capability
                </p>
                <p>
                  <strong>Maintenance:</strong> Annual lubrication required
                </p>
              </div>
            </div>
            ...
            <div className="bg-gray-800 rounded-lg p-4">
              ...
              <div className="space-y-2 text-sm text-gray-300">
                <p>
                  <strong>Power:</strong> 0-5V DC control
                </p>
                <p>
                  <strong>Response:</strong> 5-20 minute transitions
                </p>
                <p>
                  <strong>Control:</strong> Gradual transparency change
                </p>
                <p>
                  <strong>Power Consumption:</strong> Minimal when stable
                </p>
                <p>
                  <strong>Backup:</strong> Manual clear state on failure
                </p>
                <p>
                  <strong>Longevity:</strong> 15+ year design life
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3 p-4 bg-green-900/30 rounded-lg border border-green-600/40">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-300">
                    Provide local override switches for occupants, but integrate with BMS to prevent
                    permanent overrides that compromise energy strategies.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-4 bg-red-900/30 rounded-lg border border-red-600/40">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-300">
                    Blinds and louvers must integrate with fire alarms. Shading systems should move
                    to safe positions for evacuation or smoke extraction when required.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-4 bg-blue-900/30 rounded-lg border border-blue-600/40">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-300">
                    Keep access panels and control points clear for maintenance teams. Provide
                    service documentation and spare part specifications.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-4 bg-yellow-900/30 rounded-lg border border-yellow-600/40">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-300">
                    Install wind sensors and rain detection. Automatic storm positioning prevents
                    damage to external shading systems during severe weather.
                  </p>
                </div>
              </div>
            </div>
