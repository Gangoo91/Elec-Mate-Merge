      ...
      <CardContent className="text-foreground space-y-6">
        <div>
          <h4 className="text-elec-yellow font-semibold mb-3">
            Gateway Configuration & Protocol Bridging
          </h4>
          <p className="text-foreground mb-4">
            Modern BMS installations often require connecting devices using different communication
            protocols. Gateways bridge between protocols, requiring careful addressing coordination
            to prevent conflicts and ensure reliable data flow.
          </p>
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="bg-orange-500/10 border border-orange-500/20 rounded p-3">
                <p className="text-orange-400 font-semibold mb-1">
                  Gateway Addressing Considerations:
                </p>
                ...
                <ul className="ml-4 space-y-2">
                  <li>
                    ...
                    <p className="text-foreground text-xs mt-1">
                      Multiple devices respond to same address, causing data corruption and timeouts
                    </p>
                  </li>
                  <li>
                    <strong className="text-red-300">Address gaps:</strong>
                    <p className="text-foreground text-xs mt-1">
                      Missing device addresses cause polling delays and slow network performance
                    </p>
                  </li>
                  <li>
                    <strong className="text-red-300">Wrong subnets:</strong>
                    <p className="text-foreground text-xs mt-1">
                      IP devices on incorrect subnets cannot communicate with controllers
                    </p>
                  </li>
                  <li>
                    <strong className="text-red-300">Mapping errors:</strong>
                    <p className="text-foreground text-xs mt-1">
                      Physical points mapped to wrong software objects show incorrect data
                    </p>
                  </li>
                </ul>
              </div>
              ...
              <div className="space-y-2 text-sm">
                <ul className="ml-4 space-y-2">
                  <li>
                    ...
                    <p className="text-foreground text-xs mt-1">
                      Discover active devices and identify addressing conflicts or duplicates
                    </p>
                  </li>
                  <li>
                    <strong className="text-green-300">Protocol analysers:</strong>
                    <p className="text-foreground text-xs mt-1">
                      Monitor network traffic to identify communication errors and timing issues
                    </p>
                  </li>
                  <li>
                    <strong className="text-green-300">Ping/connectivity tests:</strong>
                    <p className="text-foreground text-xs mt-1">
                      Verify IP device reachability and basic network connectivity
                    </p>
                  </li>
                  <li>
                    <strong className="text-green-300">Data validation:</strong>
                    <p className="text-foreground text-xs mt-1">
                      Compare BMS readings with direct field measurements to verify mapping
                    </p>
                  </li>
                </ul>
              </div>
                ...
                <div className="grid md:grid-cols-2 gap-3">
                  <div className="bg-gray-700 rounded-lg p-3">
                    ...
                    <ul className="space-y-1 text-xs">
                      <li>
                        • <strong>Management VLAN:</strong> 192.168.10.0/24
                      </li>
                      <li>
                        • <strong>Controllers VLAN:</strong> 192.168.20.0/24
                      </li>
                      <li>
                        • <strong>Field devices VLAN:</strong> 192.168.30.0/24
                      </li>
                      <li>
                        • <strong>Client access VLAN:</strong> 192.168.40.0/24
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="bg-gray-700 rounded-lg p-3">
                    ...
                    <ul className="space-y-1 text-xs">
                      <li>
                        • <strong>BMS servers:</strong> .10-.19
                      </li>
                      <li>
                        • <strong>Main controllers:</strong> .20-.99
                      </li>
                      <li>
                        • <strong>Gateways:</strong> .100-.109
                      </li>
                      <li>
                        • <strong>Smart devices:</strong> .110-.199
                      </li>
                      <li>
                        • <strong>DHCP pool:</strong> .200-.250
                      </li>
                    </ul>
                  </div>
                </div>
        ...
        <div>
          <h4 className="text-elec-yellow font-semibold mb-3">
            Security Considerations for Device Addressing
          </h4>
            ...
            <div className="space-y-3 text-sm">
              <div className="grid md:grid-cols-2 gap-3">
                <div className="bg-gray-700 rounded-lg p-3">
                  ...
                  <ul className="space-y-1">
                    <li>
                      • <strong>Device authentication:</strong> Unique credentials per device
                    </li>
                    <li>
                      • <strong>Encrypted communications:</strong> Secure protocol variants
                    </li>
                    <li>
                      • <strong>Network segmentation:</strong> Isolate BMS from corporate networks
                    </li>
                    <li>
                      • <strong>Access control lists:</strong> Restrict device-to-device
                      communication
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-gray-700 rounded-lg p-3">
                  ...
                  <ul className="space-y-1">
                    <li>
                      • <strong>Avoid predictable patterns:</strong> Don't use sequential addressing
                    </li>
                    <li>
                      • <strong>Change default addresses:</strong> Never leave factory defaults
                    </li>
                    <li>
                      • <strong>Regular address audits:</strong> Verify only authorised devices
                    </li>
                    <li>
                      • <strong>Network monitoring:</strong> Detect unauthorised address usage
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="bg-black rounded p-3 mt-3">
                <p className="text-foreground text-xs">
                  <strong>Critical Security Note:</strong> Default device passwords and addresses
                  are major security vulnerabilities. All BMS devices must have unique, non-default
                  credentials and addresses before network connection. Document security settings
                  separately from technical addressing information.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-r from-cyan-500/10 to-blue-500/10 border border-cyan-500/20 rounded-lg p-4">
            ...
            <div className="space-y-3 text-sm">
              <div className="grid gap-3">
                ...
                <div className="bg-gray-700 rounded-lg p-3">
                  <p className="text-foreground font-semibold mb-2">
                    Phase 2: Network Integration Testing
                  </p>
                  <ul className="ml-4 space-y-1 text-xs">
                ...
                <div className="bg-gray-700 rounded-lg p-3">
                  <p className="text-foreground font-semibold mb-2">
                    Phase 3: System Performance Testing
                  </p>
                  <ul className="ml-4 space-y-1 text-xs">
              ...
              <div className="bg-green-500/10 border border-green-500/20 rounded p-3 mt-3">
                ...
                <p className="text-xs text-foreground">
                  Complete addressing documentation, verified network performance metrics,
                  successful 48-hour continuous operation test, and formal handover of addressing
                  register and network topology documentation.
                </p>
              </div>
            </div>
          </div>
