      ...
      <CardContent className="text-foreground space-y-6">
        <div>
          <h4 className="text-elec-yellow font-semibold mb-3">
            Real World Example: University Project Delay
          </h4>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h5 className="text-red-400 font-semibold mb-2">
                  The Problem: Missing CO₂ Sensors
                </h5>
                <div className="text-sm text-foreground space-y-3">
                  ...
                  <p>
                    <strong>Issue:</strong> On a university project, an incomplete IO list led to 15
                    CO₂ sensors being missed from the original design. Electricians installed the
                    cabling based on architectural drawings, but no controller points were allocated
                    for these sensors in the BMS design.
                  </p>
                  <p>
                    <strong>Discovery:</strong> The problem was only discovered during commissioning
                    when the controls engineer tried to configure the CO₂-based demand controlled
                    ventilation.
                  </p>
                </div>
              </div>
          ...
          <div className="bg-green-500/10 border border-green-500/20 rounded-lg p-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="text-sm text-foreground space-y-2">
                  <p>
                    <strong>Immediate fix:</strong> Emergency procurement of additional I/O capacity
                  </p>
                  <p className="mt-2">
                    <strong>Process improvement:</strong> The design team introduced a new rule:
                  </p>
                  <ul className="ml-4 space-y-1">
                    <li>
                      • IO lists must be signed off by both electrical and commissioning teams
                      before procurement
                    </li>
                    <li>
                      • Cross-referencing between architectural drawings and BMS schematics
                      mandatory
                    </li>
                  ...
                  <p className="mt-2">
                    <strong>Result:</strong> No similar issues on subsequent projects
                  </p>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="text-sm text-foreground space-y-2">
                ...
                <ul className="space-y-1 ml-4">
                  <li>
                    • <strong>Prevention is better than cure:</strong> Proper installation saves
                    costly remedial work
                  </li>
                  <li>
                    • <strong>Standards exist for good reasons:</strong> BS 7671 segregation
                    requirements prevent real problems
                  </li>
                  <li>
                    • <strong>Power quality matters:</strong> Undersized or poor-quality supplies
                    cause equipment failures
                  </li>
                  <li>
                    • <strong>Documentation is crucial:</strong> Good records enable effective
                    troubleshooting
                  </li>
                  <li>
                    • <strong>Consider the bigger picture:</strong> BMS failures can have serious
