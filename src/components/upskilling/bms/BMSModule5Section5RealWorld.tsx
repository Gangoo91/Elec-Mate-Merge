          ...
          <div className="space-y-3">
            <div className="bg-elec-dark p-3 rounded border border-gray-600">
              ...
              <p className="text-foreground text-sm">
                In a hospital, submeters reported via Modbus, but the BMS operated on BACnet. The
                facility management team needed to monitor real-time energy use for cost allocation.
              </p>
            </div>
            ...
            <div className="bg-elec-dark p-3 rounded border border-gray-600">
              ...
              <p className="text-foreground text-sm">
                A Modbus-to-BACnet gateway was installed so the BMS could monitor real-time energy
                use. The gateway converted the Modbus meter data into BACnet objects that appeared
                seamlessly in the existing BMS interface.
              </p>
            </div>
