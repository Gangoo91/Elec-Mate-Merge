  ...
  return (
    <Card className="bg-elec-gray border-gray-700">
      ...
      <CardContent className="text-foreground space-y-6">
        <p>
          Functional commissioning validates complete system operation under real conditions. This
          comprehensive testing ensures the BMS performs as designed and responds correctly to all
        ...
        <div className="bg-gradient-to-r from-green-600/20 to-blue-600/20 border border-green-500/30 rounded-lg p-4">
          ...
          <div className="grid grid-cols-2 gap-3 text-sm">
            <div className="space-y-1">
              <div>
                <strong>Temperature Control:</strong> ±1°C of setpoint
              </div>
              <div>
                <strong>Humidity Control:</strong> ±5% RH tolerance
              </div>
              <div>
                <strong>Pressure Control:</strong> ±10Pa accuracy
              </div>
            </div>
            <div className="space-y-1">
              <div>
                <strong>Response Time:</strong> &lt;2 minutes to setpoint
              </div>
              <div>
                <strong>Stability:</strong> No oscillation &gt;5 minutes
              </div>
              <div>
                <strong>Efficiency:</strong> Meet design energy targets
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="bg-gray-800/50 rounded-lg p-4 border border-gray-600">
            ...
            <div className="mt-3 p-3 bg-blue-500/10 border border-blue-500/20 rounded">
              <p className="text-xs text-foreground">
                <strong>Test Method:</strong> Gradually adjust room setpoint and monitor system
                response over 2-hour period.
              </p>
            </div>
          </div>
          ...
          <div className="bg-red-900/20 rounded-lg p-4 border border-red-500/30">
            <div className="flex items-start gap-3 mb-3">
              ...
              <h4 className="text-foreground font-semibold">
                Critical Alarm and Fail-Safe Testing
              </h4>
            </div>
            <p className="text-sm text-foreground mb-3">
            ...
            <div className="mt-3 p-3 bg-red-500/10 border border-red-500/20 rounded">
              <p className="text-xs text-foreground">
                <strong>Safety Note:</strong> Always have qualified gas engineer present for boiler
                safety testing.
              </p>
            </div>
          </div>
          ...
          <div className="bg-gray-800/50 rounded-lg p-4 border border-gray-600">
            ...
            <div className="grid grid-cols-2 gap-3 text-xs">
              <div className="p-2 bg-blue-900/30 rounded">
                <strong className="text-blue-300">Proportional Band:</strong> Start at manufacturer
                recommendation, adjust for minimal overshoot
              </div>
              <div className="p-2 bg-blue-900/30 rounded">
                <strong className="text-blue-300">Integral Time:</strong> Eliminate steady-state
                error, avoid wind-up
              </div>
              <div className="p-2 bg-blue-900/30 rounded">
                <strong className="text-blue-300">Derivative Time:</strong> Improve response speed,
                reduce oscillation
              </div>
              <div className="p-2 bg-blue-900/30 rounded">
                <strong className="text-blue-300">Output Limits:</strong> Set min/max values,
          ...
          <div className="bg-purple-900/20 rounded-lg p-4 border border-purple-500/30">
            ...
            <div className="space-y-2 text-xs">
              <div className="p-2 bg-purple-900/30 rounded">
                <strong>Lighting Integration:</strong> Occupancy sensors trigger HVAC modes,
                daylight harvesting adjusts artificial lighting
              </div>
              <div className="p-2 bg-purple-900/30 rounded">
                <strong>Access Control Link:</strong> First person in starts systems, last person
                out initiates shutdown
              </div>
              <div className="p-2 bg-purple-900/30 rounded">
                <strong>Fire System Interface:</strong> Smoke detection triggers extract fans,
                pressurisation systems activate
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-blue-900/20 border border-blue-500/30 rounded-lg p-4">
          ...
          <p className="text-sm text-foreground">
            A boiler plant is commissioned by lowering room temperature setpoints and observing
            whether boilers fire in sequence, pumps start, and standby units rotate as programmed.
            The commissioning engineer verifies lead/lag operation, safety shutdowns, and
            energy-efficient staging.
          </p>
        </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-300 mt-2">
                Consider: How does functional testing differ from just checking individual
                components?
              </p>
            </div>
          </div>
