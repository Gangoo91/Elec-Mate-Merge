      ...
      <CardContent className="space-y-4">
        ...
        <div className="bg-elec-yellow/10 border border-elec-yellow/30 rounded-lg p-4 mt-6">
          ...
          <p className="text-foreground text-sm">
            Gateways are the backbone of modern integrated building systems. Your role in proper
            installation, wiring, and documentation directly impacts the reliability and performance
            of the entire BMS. Remember: good electrical work at the gateway level enables seamless
            data flow throughout the building.
          </p>
        </div>
      </CardContent>
    </Card>
