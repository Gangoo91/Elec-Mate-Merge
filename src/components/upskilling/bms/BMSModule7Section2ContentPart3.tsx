      ...
      <CardContent className="text-foreground space-y-6">
        <div>
          ...
          <p className="text-foreground mb-4">
            PID (Proportional-Integral-Derivative) control is used to maintain stable control of
            variables such as temperature, pressure, and flow. It continuously calculates an error
            value as the difference between a setpoint and measured value, then applies corrections
        ...
        <div>
          ...
          <div className="grid md:grid-cols-3 gap-4">
            <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-4">
              ...
              <div className="space-y-2 text-sm">
                <p className="text-foreground">
                  <strong>Function:</strong> Reacts to the SIZE of the error
                </p>
            ...
            <div className="bg-green-500/10 border border-green-500/20 rounded-lg p-4">
              ...
              <div className="space-y-2 text-sm">
                <p className="text-foreground">
                  <strong>Function:</strong> Reacts to HOW LONG error exists
                </p>
                <ul className="ml-4 space-y-1">
                ...
                <div className="bg-gray-700 rounded p-2 mt-2">
                  <p className="text-xs text-foreground">
                    <strong>Example:</strong> Room consistently 0.5°C low → gradually increases
                    heating
                  </p>
                </div>
              </div>
            ...
            <div className="bg-purple-500/10 border border-purple-500/20 rounded-lg p-4">
              ...
              <div className="space-y-2 text-sm">
                <p className="text-foreground">
                  <strong>Function:</strong> Reacts to RATE OF CHANGE
                </p>
                <ul className="ml-4 space-y-1">
        ...
        <div>
          ...
          <div className="bg-gradient-to-r from-blue-500/10 to-green-500/10 border border-blue-500/20 rounded-lg p-4">
            <h5 className="text-blue-400 font-semibold mb-2">
              Hot Water Temperature Control Example
            </h5>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="bg-gray-700 rounded-lg p-3">
                  ...
                  <ul className="space-y-1">
                    <li>
                      • <strong>Setpoint:</strong> 21°C room temperature
                    </li>
                    <li>
                      • <strong>Sensor:</strong> Room temperature probe
                    </li>
                    <li>
                      • <strong>Controller:</strong> PID algorithm
                    </li>
                    <li>
                      • <strong>Output:</strong> Hot water valve (0-10V)
                    </li>
                  </ul>
                </div>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="bg-yellow-500/10 border border-yellow-500/20 rounded-lg p-4">
              ...
              <ul className="space-y-2 text-sm">
                <li>
                  • <strong>Kp (Proportional Gain):</strong> How aggressively to respond to current
                  error
                </li>
                <li>
                  • <strong>Ki (Integral Gain):</strong> How quickly to eliminate persistent error
                </li>
                <li>
                  • <strong>Kd (Derivative Gain):</strong> How much to dampen rapid changes
                </li>
                <li>
                  • <strong>Balance required:</strong> Stability vs. response speed
                </li>
              </ul>
            </div>
            ...
            <div className="bg-red-500/10 border border-red-500/20 rounded-lg p-4">
              ...
              <ul className="space-y-2 text-sm">
                <li>
                  • <strong>High P:</strong> Oscillation, overshoot
                </li>
                <li>
                  • <strong>High I:</strong> Instability, windup
                </li>
                <li>
                  • <strong>High D:</strong> Noise amplification
                </li>
                <li>
                  • <strong>Poor tuning:</strong> Hunting, poor efficiency
                </li>
              </ul>
            </div>
          </div>
        ...
        <div>
          ...
          <div className="space-y-4">
            <div className="bg-gradient-to-r from-green-500/10 to-blue-500/10 border border-green-500/20 rounded-lg p-4">
              ...
              <ul className="space-y-2 text-sm">
                <li>
                  • <strong>Sensor accuracy:</strong> Verify calibration and range
                </li>
                <li>
                  • <strong>Output scaling:</strong> Confirm 0-100% matches 0-10V or 4-20mA
                </li>
                <li>
                  • <strong>Signal quality:</strong> Check for noise, interference, stability
                </li>
                <li>
                  • <strong>Response testing:</strong> Manual output changes to verify actuator
                  movement
                </li>
              </ul>
            </div>
            ...
            <div className="bg-gradient-to-r from-orange-500/10 to-red-500/10 border border-orange-500/20 rounded-lg p-4">
              ...
              <ul className="space-y-2 text-sm">
                <li>
                  • <strong>Manual mode testing:</strong> Verify full range of control output
                </li>
                <li>
                  • <strong>Setpoint changes:</strong> Observe system response characteristics
                </li>
                <li>
                  • <strong>Load testing:</strong> Test control under various load conditions
                </li>
                <li>
                  • <strong>Documentation:</strong> Record final tuning parameters and performance
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-foreground">
                <strong>Answer:</strong> The Integral (I) component corrects long-term drift from
                setpoint. It accumulates error over time and gradually increases the control output
                to eliminate steady-state offset that the Proportional component alone cannot
                correct.
              </p>
            </div>
          </div>
