    ...
    <Card className="bg-elec-gray border-gray-700">
      ...
      <CardContent className="text-foreground space-y-4">
        <p>
          ...
          exactly as designed. It happens in two stages: pre-functional commissioning (basic
          verification of wiring, power, communication, and safety) and functional commissioning
          (testing full sequences of operations and confirming equipment responds correctly to
          programmed logic).
        </p>
        <p>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-foreground">
                Proper commissioning is the difference between a system that works as intended and
                one that creates ongoing operational problems. Thorough electrical preparation
                ensures smooth commissioning execution.
              </p>
            </div>
          </div>
        </div>
