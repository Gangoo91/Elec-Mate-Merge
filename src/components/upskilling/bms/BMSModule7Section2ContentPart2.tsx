      ...
      <CardContent className="text-foreground space-y-6">
        <div>
          ...
          <p className="text-foreground mb-4">
            Boolean logic is the foundation of all digital decision-making in BMS systems. It uses
            conditions of True (1) and False (0) to create logical decisions that control system
            behaviour. Every digital input, output, and control decision ultimately relies on
        ...
        <div>
          ...
          <div className="grid md:grid-cols-3 gap-4">
            <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-4">
              ...
              <div className="space-y-2 text-sm">
                <p className="text-foreground">
                  <strong>Rule:</strong> ALL conditions must be TRUE
                </p>
            ...
            <div className="bg-green-500/10 border border-green-500/20 rounded-lg p-4">
              ...
              <div className="space-y-2 text-sm">
                <p className="text-foreground">
                  <strong>Rule:</strong> ANY condition can be TRUE
                </p>
                <div className="bg-gray-700 rounded p-2 mt-2">
                  <p className="text-xs text-foreground mb-1">
                    <strong>Truth Table:</strong>
            ...
            <div className="bg-purple-500/10 border border-purple-500/20 rounded-lg p-4">
              ...
              <div className="space-y-2 text-sm">
                <p className="text-foreground">
                  <strong>Rule:</strong> INVERTS the input
                </p>
                <div className="bg-gray-700 rounded p-2 mt-2">
                  <p className="text-xs text-foreground mb-1">
                    <strong>Truth Table:</strong>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="bg-orange-500/10 border border-orange-500/20 rounded-lg p-4">
              ...
              <div className="space-y-2 text-sm">
                ...
                <p className="text-xs text-foreground">
                  Common in safety systems - output fails safe when all conditions are met
                </p>
                <div className="bg-gray-700 rounded p-2 mt-2">
                  <p className="text-xs">
                    <strong>Example:</strong> Safety relay deactivates only when all guards are
                    closed
                  </p>
                </div>
              </div>
            ...
            <div className="bg-cyan-500/10 border border-cyan-500/20 rounded-lg p-4">
              ...
              <div className="space-y-2 text-sm">
                ...
                <p className="text-xs text-foreground">
                  Useful for changeover operations and conflict detection
                </p>
                <div className="bg-gray-700 rounded p-2 mt-2">
                  <p className="text-xs">
                    <strong>Example:</strong> Heating OR cooling, but never both simultaneously
                  </p>
                </div>
              </div>
            </div>
        ...
        <div>
          ...
          <div className="space-y-4">
            <div className="bg-gradient-to-r from-blue-500/10 to-green-500/10 border border-blue-500/20 rounded-lg p-4">
              ...
              <div className="bg-gray-700 rounded-lg p-3 text-sm">
                <p className="text-foreground mb-2">
                  <strong>Requirement:</strong> Pump allowed to run if system ON AND level switch
                  safe
                </p>
                <div className="space-y-2">
                  <p>
                    <strong>Boolean Expression:</strong> Pump Run = (System ON) AND (Low Level
                    Switch Safe)
                  </p>
                  <div className="mt-2">
                    <p className="text-green-400">
                      <strong>Scenario 1:</strong> System=ON, Level=Safe → Pump=RUN
                    </p>
                    <p className="text-red-400">
                      <strong>Scenario 2:</strong> System=ON, Level=Low → Pump=STOP
                    </p>
                    <p className="text-red-400">
                      <strong>Scenario 3:</strong> System=OFF, Level=Safe → Pump=STOP
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-gradient-to-r from-yellow-500/10 to-red-500/10 border border-yellow-500/20 rounded-lg p-4">
              ...
              <div className="bg-gray-700 rounded-lg p-3 text-sm">
                <p className="text-foreground mb-2">
                  <strong>Requirement:</strong> Smoke extract fan runs if fire detected OR manual
                  activation
                </p>
                <div className="space-y-2">
                  <p>
                    <strong>Boolean Expression:</strong> Extract Fan = (Fire Alarm) OR (Manual
                    Start) AND NOT(Isolation Switch)
                  </p>
                  <div className="mt-2">
                    <p className="text-green-400">
                      <strong>Normal Operation:</strong> Manual or automatic activation possible
                    </p>
                    <p className="text-red-400">
                      <strong>Maintenance:</strong> Isolation switch overrides all other commands
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-foreground">
                <strong>Answer:</strong> Boolean logic provides the foundation for all digital
                decision-making in BMS systems. It allows complex control sequences to be broken
                down into simple True/False decisions that can be implemented reliably in digital
                controllers. Every input condition, safety interlock, and control decision
                ultimately uses Boolean logic principles.
              </p>
            </div>
          </div>
        </div>
