      ...
      <CardContent>
        <div className="space-y-4">
          <p className="text-foreground">
            This section covered the fundamentals of KNX systems from an electrical installation
            perspective:
          </p>
          ...
          <div className="bg-gradient-to-r from-blue-500/10 to-purple-500/10 border border-blue-500/20 rounded-lg p-4 mt-6">
            ...
            <p className="text-foreground text-sm">
              While KNX programming requires specialist knowledge, the foundation of any successful
              KNX system is proper electrical installation. Understanding topology rules, device
              requirements, and troubleshooting techniques ensures reliable system operation and
