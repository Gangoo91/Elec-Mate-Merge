  ...
  const troubleshootingGuide = [
    ...
    },
    {
      ...
      solutions: [
        ...
        'Verify load current <rated capacity',
        'Check field device power',
      ],
    },
    {
      ...
      solutions: [
        'Install 120Ω terminators at bus ends',
    ...
    <Card className="bg-elec-gray border-gray-700">
      ...
      <CardContent className="text-foreground space-y-6">
        <p>
          ...
          troubleshooting skills. These practices ensure smooth handover and long-term system
          reliability.
        </p>
        ...
        <div className="bg-gradient-to-r from-amber-600/20 to-red-600/20 border border-amber-500/30 rounded-lg p-4">
          <h4 className="text-foreground font-bold mb-3">
            ⚠️ Common Commissioning Mistakes to Avoid
          </h4>
        ...
        <div className="grid gap-4">
            ...
            <div className="space-y-4">
              {troubleshootingGuide.map((item, index) => (
                <div key={index} className="border border-gray-600 rounded-lg p-3">
                  <h5 className="text-foreground font-medium mb-2 text-sm">
          ...
          <div className="bg-gray-800/50 rounded-lg p-4 border border-gray-600">
            <div className="flex items-start gap-3 mb-3">
              ...
              <h4 className="text-foreground font-semibold">
                Commissioning Timeline Best Practices
              </h4>
            </div>
            ...
            <div className="space-y-3 text-sm">
              <div className="grid grid-cols-4 gap-2 p-2 bg-blue-900/20 rounded">
                ...
                <div className="col-span-3 text-foreground">
                  Pre-functional checks, power verification, I/O testing
                </div>
              </div>
              ...
              <div className="grid grid-cols-4 gap-2 p-2 bg-green-900/20 rounded">
                ...
                <div className="col-span-3 text-foreground">
                  Individual equipment commissioning, basic sequences
                </div>
              </div>
              ...
              <div className="grid grid-cols-4 gap-2 p-2 bg-purple-900/20 rounded">
                ...
                <div className="col-span-3 text-foreground">
                  System integration, complex sequences, optimisation
                </div>
              </div>
              ...
              <div className="grid grid-cols-4 gap-2 p-2 bg-amber-900/20 rounded">
                ...
                <div className="col-span-3 text-foreground">
                  Final testing, documentation, operator training
                </div>
              </div>
            </div>
            ...
            <div className="mt-4 p-3 bg-blue-500/10 border border-blue-500/20 rounded">
              <p className="text-xs text-foreground">
                <strong>Note:</strong> Allow 25% contingency time for unforeseen issues and rework.
                Complex systems may require longer timescales.
              </p>
            </div>
          </div>
          ...
          <div className="bg-gray-800/50 rounded-lg p-4 border border-gray-600">
            ...
            <div className="grid grid-cols-1 gap-2">
              {documentationChecklist.map((item, index) => (
                <div
                  key={index}
                  className="flex items-start gap-2 p-2 bg-green-900/10 border border-green-500/20 rounded"
                >
          ...
          <div className="bg-gradient-to-r from-cyan-600/20 to-blue-600/20 border border-cyan-500/30 rounded-lg p-4">
            <h4 className="text-foreground font-bold mb-3">
              💡 Pro Tips for Efficient Commissioning
            </h4>
            <div className="grid md:grid-cols-2 gap-3 text-sm">
              <div className="space-y-2">
                <div>
                  <strong>Preparation:</strong> Review all drawings before starting on site
                </div>
                <div>
                  <strong>Communication:</strong> Daily coordination meetings with all trades
                </div>
                <div>
                  <strong>Testing:</strong> Work through IO lists systematically
                </div>
              </div>
              <div className="space-y-2">
                <div>
                  <strong>Documentation:</strong> Record all changes immediately
                </div>
                <div>
                  <strong>Safety:</strong> Never bypass safety interlocks during testing
                </div>
                <div>
                  <strong>Training:</strong> Include operators in final commissioning stages
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-foreground">
                👉 You discover an AHU supply fan starts but the return fan doesn't. The control
                system shows both outputs are active. What systematic steps would you take to
                diagnose this problem?
              </p>
              <p className="text-xs text-gray-300 mt-2">
                Consider: Power supply, wiring continuity, motor protection, starter contacts, and
