      ...
      <CardContent className="text-foreground">
        ...
        <div className="mt-6 bg-gradient-to-r from-elec-yellow/10 to-orange-500/10 border border-elec-yellow/30 rounded-lg p-4">
          <p className="text-foreground font-medium">
            Remember: Proper addressing and mapping are the foundation of reliable BMS
            communication. Take time to get this right during installation to avoid costly
