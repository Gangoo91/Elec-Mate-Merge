      ...
      <CardContent className="text-foreground space-y-6">
            ...
            <div className="bg-green-500/10 border border-green-500/20 rounded-lg p-4">
              ...
              <ol className="space-y-2 text-sm ml-4">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong>Cable preparation:</strong> Strip to correct length, install ferrules on
                    all stranded conductors
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-1 font-semibold">2.</span>
                  <span>
                    <strong>Polarity verification:</strong> Mark positive/negative clearly before
                    installation
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong>Continuity testing:</strong> Test each conductor end-to-end before
                    connection
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong>Insulation testing:</strong> 500V test between conductors and to earth
                  </span>
                </li>
              </ol>
            </div>
            ...
            <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-4">
              ...
              <ol className="space-y-2 text-sm ml-4">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong>Device connections:</strong> Follow manufacturer diagrams exactly -
                    common vs. individual return paths
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-blue-400 mt-1 font-semibold">6.</span>
                  <span>
                    <strong>Terminal tightening:</strong> Use specified torque values to prevent
                    loose connections
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong>Service loops:</strong> Minimum 300mm in panels, coiled neatly and
                    secured
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong>Final labelling:</strong> Cable and terminal labels matching BMS
                    schedules
                  </span>
                </li>
              </ol>
        ...
        <div>
          <h4 className="text-elec-yellow font-semibold mb-3">
            Power Supply Installation Standards
          </h4>
