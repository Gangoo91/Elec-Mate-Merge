      ...
      <CardContent className="text-foreground space-y-6">
        <div>
          <h4 className="text-elec-yellow font-semibold mb-3">
            Hospital AHU Fire Safety Logic Error
          </h4>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h5 className="text-red-400 font-semibold mb-2">
                  The Problem: Fan Running During Fire Alarm
                </h5>
                <div className="text-sm text-foreground space-y-3">
                  <p>
                    <strong>Location:</strong> Hospital air handling unit serving critical care
                    areas
                  </p>
                  <p>
                    <strong>Issue:</strong> During fire alarm testing, the supply fan continued
                    running when it should have stopped. This could have spread smoke throughout the
                    hospital during a real fire emergency.
                  </p>
                  <p>
                    <strong>Discovery:</strong> The problem was identified during commissioning when
                    the electrician activated the fire alarm test and noticed the fan didn't stop as
                    expected.
                  </p>
                </div>
              </div>
          ...
          <div className="bg-yellow-500/10 border border-yellow-500/20 rounded-lg p-4 mb-4">
            ...
            <div className="text-sm text-foreground space-y-2">
              <p>
                <strong>Programming Error Found:</strong>
              </p>
              <div className="bg-gray-700 rounded-lg p-3 mt-2">
                <p className="text-red-400 mb-2">
                  <strong>Incorrect Logic (OR):</strong>
                </p>
                ...
                <p className="text-foreground text-xs mb-2">
                  This meant the fan would run if ANY condition was true. When fire alarm activated
                  (Fire Alarm Safe = FALSE), the fan still ran because Manual Start was TRUE.
                </p>

                <p className="text-green-400 mt-3 mb-2">
                  <strong>Correct Logic (AND/NOT):</strong>
                </p>
                ...
                <p className="text-foreground text-xs mt-2">
                  This ensures the fan only runs when BOTH a start command exists AND fire alarm is
                  safe.
                </p>
              </div>
            </div>
        ...
        <div>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-4">
              ...
              <div className="space-y-2 text-sm">
                <p className="text-foreground">
                  <strong>Problem:</strong> Office temperature hunting ±3°C
                </p>
                <p className="text-gray-300">
                  <strong>Cause:</strong> PID integral gain set too high
                </p>
                <p className="text-green-400">
                  <strong>Solution:</strong> Reduced Ki parameter by 50%
                </p>
                <p className="text-foreground">
                  <strong>Lesson:</strong> Poor tuning wastes energy and causes complaints
                </p>
              </div>
            </div>
            ...
            <div className="bg-purple-500/10 border border-purple-500/20 rounded-lg p-4">
              ...
              <div className="space-y-2 text-sm">
                <p className="text-foreground">
                  <strong>Problem:</strong> Boiler cycling every 30 seconds
                </p>
                <p className="text-gray-300">
                  <strong>Cause:</strong> No anti-short-cycle timer programmed
                </p>
                <p className="text-green-400">
                  <strong>Solution:</strong> Added 5-minute minimum run timer
                </p>
                <p className="text-foreground">
                  <strong>Lesson:</strong> Equipment protection requires proper timing
                </p>
              </div>
            </div>
          </div>
        ...
        <div>
          ...
          <div className="bg-gradient-to-r from-green-500/10 to-blue-500/10 border border-green-500/20 rounded-lg p-4">
            <h5 className="text-green-400 font-semibold mb-2">
              How Electricians Catch Programming Errors
            </h5>
            <div className="space-y-3 text-sm">
              ...
              <div className="bg-gray-700 rounded-lg p-3 mt-3">
                <p className="text-foreground text-xs">
                  <strong>Key Point:</strong> In the hospital example, the electrician's systematic
                  testing during commissioning caught a potentially dangerous programming error that
                  could have compromised life safety. This demonstrates why electricians must
                  understand and verify logic functions, not just physical connections.
                </p>
              </div>
            </div>
          </div>
            ...
            <div>
              ...
              <div className="text-sm text-foreground space-y-2">
                ...
                <ul className="space-y-1 ml-4">
                  <li>
                    • <strong>Logic errors can be life-threatening:</strong> Programming mistakes in
                    safety systems have serious consequences
                  </li>
                  <li>
                    • <strong>Testing saves lives:</strong> Systematic commissioning testing catches
                    dangerous errors
                  </li>
                  <li>
                    • <strong>Electricians are safety advocates:</strong> Understanding logic helps
                    identify potential problems
                  </li>
                  <li>
                    • <strong>Boolean logic matters:</strong> The difference between OR and AND
                    logic can be critical
                  </li>
                  <li>
                    • <strong>Documentation is essential:</strong> Clear logic diagrams prevent
                    misunderstandings
                  </li>
                </ul>
              </div>
