    ...
    <Card className="bg-elec-gray border-gray-700">
      ...
      <CardContent className="text-gray-300 space-y-4">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-300">
                  Once termination resistors were added and polarity was double-checked, the network
                  stabilised immediately. All devices began communicating reliably.
                </p>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-green-500/10 to-blue-500/10 border border-green-500/20 rounded-lg p-3">
              ...
              <p className="text-sm text-gray-300">
                This simple fix saved days of troubleshooting and prevented project delays. It
                highlighted the critical importance of following RS-485 wiring standards for
        ...
        <div className="bg-gradient-to-r from-orange-500/10 to-red-500/10 border border-orange-500/20 rounded-lg p-4">
          ...
          <p className="text-sm text-gray-300">
            Small electrical details like termination resistors can make or break entire BMS
            networks. Always follow protocol-specific wiring requirements to avoid costly
