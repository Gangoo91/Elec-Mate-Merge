      ...
      <CardContent className="text-foreground space-y-6">
        <div>
          ...
          <p className="text-foreground mb-4">
            An IO list is the master document that records every input and output the BMS must
            manage. It serves as the foundation for system design, procurement, installation, and
            commissioning. Without a complete and accurate IO list, projects inevitably encounter
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-4">
              ...
              <ul className="space-y-2 text-sm">
                <li>
                  • <strong>Flow switches:</strong> Water/air flow detection
                </li>
                <li>
                  • <strong>Fire alarm signals:</strong> Interface with fire panel
                </li>
                <li>
                  • <strong>Door contacts:</strong> Plant room security monitoring
                </li>
                <li>
                  • <strong>Status feedback:</strong> Pump/fan run confirmation
                </li>
                <li>
                  • <strong>Alarms:</strong> High/low pressure switches
                </li>
              </ul>
            </div>
            ...
            <div className="bg-green-500/10 border border-green-500/20 rounded-lg p-4">
              ...
              <ul className="space-y-2 text-sm">
                <li>
                  • <strong>Temperature sensors:</strong> 0–10V or 4–20mA signals
                </li>
                <li>
                  • <strong>Pressure sensors:</strong> Duct and pipe monitoring
                </li>
                <li>
                  • <strong>CO₂ sensors:</strong> Indoor air quality measurement
                </li>
                <li>
                  • <strong>Humidity sensors:</strong> RH% monitoring
                </li>
                <li>
                  • <strong>Energy meters:</strong> kWh consumption tracking
                </li>
              </ul>
            </div>
          </div>
        ...
        <div>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="bg-orange-500/10 border border-orange-500/20 rounded-lg p-4">
              ...
              <ul className="space-y-2 text-sm">
                <li>
                  • <strong>Relays:</strong> Switching pumps, fans, valves
                </li>
                <li>
                  • <strong>Solenoids:</strong> On/off valve control
                </li>
                <li>
                  • <strong>Dampers:</strong> Open/close actuator control
                </li>
                <li>
                  • <strong>Alarms:</strong> Beacon lights, sounders
                </li>
                <li>
                  • <strong>Interlocks:</strong> Safety system integration
                </li>
              </ul>
            </div>
            ...
            <div className="bg-purple-500/10 border border-purple-500/20 rounded-lg p-4">
              ...
              <ul className="space-y-2 text-sm">
                <li>
                  • <strong>Modulating valves:</strong> 0–10V or 4–20mA control
                </li>
                <li>
                  • <strong>VSDs:</strong> Variable speed drive signals
                </li>
                <li>
                  • <strong>Dampers:</strong> Positioning control signals
                </li>
                <li>
                  • <strong>Lighting:</strong> 0–10V dimming control
                </li>
                <li>
                  • <strong>Setpoints:</strong> Room controller references
                </li>
              </ul>
            </div>
          </div>
        ...
        <div>
          ...
          <p className="text-foreground mb-4">
            Each point in the IO list should be described with complete information to avoid
            confusion during installation and commissioning:
          </p>
          ...
          <div className="space-y-4">
            <div className="bg-gradient-to-r from-yellow-500/10 to-orange-500/10 border border-yellow-500/20 rounded-lg p-4">
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li>
                  • <strong>Device/equipment name:</strong> Clear description
                </li>
                <li>
                ...
                <li>
                  • <strong>Alarm/status information:</strong> Critical limits
                </li>
              </ul>
            </div>
            ...
            <div className="bg-gradient-to-r from-green-500/10 to-blue-500/10 border border-green-500/20 rounded-lg p-4">
              ...
              <ul className="space-y-2 text-sm">
                <li>
                  • <strong>Location:</strong> Plant room, floor, zone reference
                </li>
                <li>
                  • <strong>Priority:</strong> Critical, normal, or advisory
                </li>
                <li>
                  • <strong>Cable type:</strong> Screened, fire-rated requirements
                </li>
                <li>
                  • <strong>Power requirements:</strong> 24V AC/DC, 230V AC
                </li>
                <li>
                  • <strong>Interface notes:</strong> Special wiring considerations
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-foreground">
                <strong>Answer:</strong> The IO list ensures all required signals are identified,
                prevents missing devices, guides cable routing and panel design, supports
                procurement decisions, and provides the foundation for commissioning documentation.
                Without it, costly site changes and delays are inevitable.
              </p>
            </div>
          </div>
        </div>
