      ...
      <CardContent className="text-foreground space-y-6">
        <div>
          <h4 className="text-elec-yellow font-semibold mb-3">
            Electrician's Role in Programming Support
          </h4>
          <p className="text-foreground mb-4">
            While electricians don't write BMS programs, they play a crucial role in verifying that
            programmed logic matches physical installation and performs as intended during
            commissioning.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-4">
              ...
              <ul className="space-y-2 text-sm">
                <li>
                  • <strong>Signal matching:</strong> Ensure wired sensors match programmed points
                </li>
                <li>
                  • <strong>I/O verification:</strong> Confirm inputs/outputs correspond to IO list
                </li>
                <li>
                  • <strong>Polarity checks:</strong> Verify analog signals have correct polarity
                </li>
                <li>
                  • <strong>Range testing:</strong> Check sensor ranges match programming
                </li>
                <li>
                  • <strong>Address verification:</strong> Confirm network device addresses
                </li>
              </ul>
            </div>
            ...
            <div className="bg-green-500/10 border border-green-500/20 rounded-lg p-4">
              ...
              <ul className="space-y-2 text-sm">
                <li>
                  • <strong>Manual operation:</strong> Operate switches, dampers, relays during
                  testing
                </li>
                <li>
                  • <strong>Load simulation:</strong> Create test conditions for programming
                  verification
                </li>
                <li>
                  • <strong>Response monitoring:</strong> Observe physical responses to programmed
                  commands
                </li>
                <li>
                  • <strong>Timing verification:</strong> Confirm delays and sequences operate
                  correctly
                </li>
                <li>
                  • <strong>Override testing:</strong> Test manual override and emergency functions
                </li>
              </ul>
            </div>
          </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-foreground mb-2">
                  Electricians must verify that programmed safety interlocks and fail-safes operate
                  correctly:
                </p>
        ...
        <div>
          <h4 className="text-elec-yellow font-semibold mb-3">
            Best Practices During Programming & Testing
          </h4>
