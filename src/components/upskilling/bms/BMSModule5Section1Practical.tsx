            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-gradient-to-br from-green-500/10 to-green-600/5 border border-green-500/20 rounded-lg p-4">
                ...
                <p className="text-sm text-gray-300">
                  Use the recommended cable type for each protocol (e.g., shielded twisted pair for
              ...
              <div className="bg-gradient-to-br from-blue-500/10 to-blue-600/5 border border-blue-500/20 rounded-lg p-4">
                ...
                <p className="text-sm text-gray-300">
                  Many serial protocols (RS-485) are polarity-sensitive; reversing wires stops
                  communication.
                </p>
              </div>
              <div className="bg-gradient-to-br from-purple-500/10 to-purple-600/5 border border-purple-500/20 rounded-lg p-4">
                ...
                <p className="text-sm text-gray-300">
                  Fit terminating resistors at both ends of RS-485 networks to prevent signal
                  reflections.
                </p>
              </div>
              <div className="bg-gradient-to-br from-orange-500/10 to-orange-600/5 border border-orange-500/20 rounded-lg p-4">
                ...
                <p className="text-sm text-gray-300">
                  Keep communication cabling away from mains power to avoid electromagnetic
                  interference.
                </p>
              </div>
            </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <span className="text-foreground font-medium">
                    Label all comms cables clearly
                  </span>
                  <p className="text-sm text-gray-400">
                    Include protocol type and device address if known
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3">
