      ...
      <CardContent className="text-foreground space-y-6">
        <div>
          ...
          <p className="text-foreground mb-4">
            ...
            references, and validating all operational parameters.
          </p>
        </div>
          ...
          <div className="bg-gradient-to-r from-cyan-500/10 to-blue-500/10 border border-cyan-500/20 rounded-lg p-4">
            ...
            <div className="space-y-3 text-sm">
              <div className="grid md:grid-cols-2 gap-4">
                <div className="bg-gray-700 rounded-lg p-3">
                  ...
                  <ul className="space-y-1 ml-4">
                    ...
                    <li>
                      • <strong>DNS Servers:</strong> For name resolution (optional)
                    </li>
                  </ul>
                </div>
              ...
              <div className="bg-yellow-500/10 border border-yellow-500/20 rounded p-3 mt-3">
                ...
                <p className="text-xs text-foreground">
                  All IP addresses must be coordinated with IT department to avoid conflicts. Static
                  IP addresses are preferred for BMS controllers to ensure consistent addressing and
                  network stability.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-3 text-sm">
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div className="bg-gray-700 rounded-lg p-3">
                  ...
                  <ul className="space-y-1 ml-4">
                    <li>
                      • <strong>NTP Server:</strong> Network Time Protocol
                    </li>
                    <li>
                      • <strong>BMS Master:</strong> Central time reference
                    </li>
                    <li>
                      • <strong>Manual Setting:</strong> Individual configuration
                    </li>
                    <li>
                      • <strong>GPS Reference:</strong> High-precision timing
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="bg-blue-500/10 border border-blue-500/20 rounded p-3 mt-3">
                ...
                <p className="text-xs text-foreground">
                  All controllers synchronise to BMS server every 24 hours. Server maintains NTP
                  connection to ensure system-wide time accuracy within ±2 seconds. Daylight saving
                  time changes handled automatically.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="bg-gradient-to-r from-orange-500/10 to-red-500/10 border border-orange-500/20 rounded-lg p-4">
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="bg-red-500/10 border border-red-500/20 rounded p-3 mt-3">
                  ...
                  <p className="text-xs text-foreground">
                    Verify all default parameters against design specifications before enabling
                    automatic control. Incorrect setpoints can cause equipment damage, energy waste,
                    or comfort problems.
                  </p>
                </div>
              </div>
        ...
        <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-foreground">
                <strong>Answer:</strong> Time synchronisation ensures accurate data logging,
                coordinated equipment scheduling, proper alarm sequencing, and reliable energy
                monitoring. Without synchronisation, trend data becomes unreliable, scheduled
                operations may not coordinate properly, and troubleshooting becomes difficult due to
