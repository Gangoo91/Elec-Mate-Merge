      ...
      <CardContent className="text-foreground space-y-6">
        <div>
          ...
          <p className="text-foreground mb-4">
            Network topology defines how BMS devices are connected to share data. The chosen
            topology affects system reliability, cable requirements, device addressing, and
            troubleshooting methods. Understanding topology is essential for successful BMS network
        ...
        <div>
          ...
          <p className="text-foreground mb-4">
            Different BMS protocols use different network topologies, each with specific advantages,
            limitations, and installation requirements. Understanding these helps in selecting the
            right approach for each project.
          </p>
          ...
          <div className="space-y-4">
            <div className="bg-gradient-to-r from-yellow-500/10 to-orange-500/10 border border-yellow-500/20 rounded-lg p-4">
              ...
              <ul className="space-y-2 text-sm">
                <li>
                  • <strong>Segment limits:</strong> Plan device distribution to avoid overloading
                  networks
                </li>
                <li>
                  • <strong>Cable routing:</strong> Keep communications cables segregated from power
                </li>
                <li>
                  • <strong>Future expansion:</strong> Allow spare capacity on each segment
                </li>
                <li>
                  • <strong>Redundancy:</strong> Consider backup routes for critical devices
                </li>
              </ul>
            </div>
            ...
            <div className="bg-gradient-to-r from-green-500/10 to-blue-500/10 border border-green-500/20 rounded-lg p-4">
              ...
              <ul className="space-y-2 text-sm">
                <li>
                  • <strong>Device addressing:</strong> Label every device with its network address
                  during installation
                </li>
                <li>
                  • <strong>Cable quality:</strong> Use specified cable types (e.g., Cat5e for
                  Ethernet, screened twisted pair for RS-485)
                </li>
                <li>
                  • <strong>Terminations:</strong> Install and test termination resistors where
                  required
                </li>
                <li>
                  • <strong>Testing:</strong> Verify network integrity before commissioning software
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-foreground">
                <strong>Answer:</strong> Star topology is typically used for BACnet/IP networks
                because they run over Ethernet infrastructure, where devices connect back to a
                central switch or router. This provides better reliability and easier fault
