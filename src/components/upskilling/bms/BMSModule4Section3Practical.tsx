            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3 p-3 bg-gray-800 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-300">
                    Confirm whether the door requires fail-safe or fail-secure operation.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3 bg-gray-800 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-300">
                    Use relays rated for the lock's voltage/current. Keep control wiring separate
                    from power feeds.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3 bg-gray-800 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-300">
                    Ensure locks release immediately when a valid card is presented or fire alarm is
                    triggered.
                  </p>
                </div>
              </div>
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3 p-3 bg-gray-800 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-300">
                    Fit break-glass units or emergency release buttons near locked doors.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3 bg-gray-800 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-300">
                    Clearly mark lock circuits, especially if multiple locks are fed from one
                    controller.
                  </p>
                </div>
              </div>
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3 p-4 bg-red-900/30 rounded-lg border border-red-600/40">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-300">
                    Fire doors must always default to safe egress. Never install a lock that
                    prevents exit during a fire alarm.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-4 bg-blue-900/30 rounded-lg border border-blue-600/40">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-300">
                    Ensure power supplies for access systems are backed up (UPS or battery) so locks
              ...
              <div className="flex items-start gap-3 p-4 bg-green-900/30 rounded-lg border border-green-600/40">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-300">
                    Document which locks are fail-safe vs fail-secure in as-built drawings.
                  </p>
                </div>
              </div>
            </div>
