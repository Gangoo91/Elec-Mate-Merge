      ...
      <CardContent className="text-foreground space-y-6">
        <div>
          ...
          <p className="text-foreground mb-4">
            Advanced BMS applications often require sequential control where equipment follows
            specific startup/shutdown sequences. State machines manage these complex operational
            modes and transitions between different system states.
          </p>

          <div className="bg-gradient-to-r from-blue-500/10 to-purple-500/10 border border-blue-500/20 rounded-lg p-4">
            <h5 className="text-blue-400 font-semibold mb-2">
              Chiller Plant Startup Sequence Example
            </h5>
            <div className="space-y-3 text-sm">
              <div className="bg-gray-700 rounded-lg p-3">
                ...
                <ol className="space-y-1 ml-4">
                  <li>
                    1. <strong>Pre-checks:</strong> Verify all safety conditions (30s)
                  </li>
                  <li>
                    2. <strong>Condenser pumps:</strong> Start primary pumps (60s delay)
                  </li>
                  <li>
                    3. <strong>Cooling tower:</strong> Start fans if ambient &gt; 10°C (30s delay)
                  </li>
                  <li>
                    4. <strong>Chilled water pumps:</strong> Start distribution pumps (45s delay)
                  </li>
                  <li>
                    5. <strong>Chiller preparation:</strong> Oil heating if required (300s)
                  </li>
                  <li>
                    6. <strong>Chiller start:</strong> Enable main chiller control
                  </li>
                  <li>
                    7. <strong>System ready:</strong> Normal PID control active
                  </li>
                </ol>
              </div>
              <div className="text-xs text-foreground bg-blue-500/10 rounded p-2">
                <strong>Failure Action:</strong> Any step failure stops sequence and runs shutdown
                procedure
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="bg-red-500/10 border border-red-500/20 rounded-lg p-4">
              ...
              <div className="space-y-2 text-sm">
                <p className="text-foreground mb-2">
                  Critical safety functions that override normal control:
                </p>
                ...
                <div className="bg-gray-700 rounded p-2 mt-2">
                  <p className="text-xs text-foreground">
                    <strong>Priority:</strong> Safety interlocks have highest priority - they cannot
                    be overridden
                  </p>
                </div>
              </div>
            ...
            <div className="bg-orange-500/10 border border-orange-500/20 rounded-lg p-4">
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="bg-gray-700 rounded p-2 mt-2">
                  <p className="text-xs text-foreground">
                    <strong>Feature:</strong> Can be overridden by qualified personnel with valid
                    reason
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="bg-gray-700 rounded-lg p-3 mt-3">
                  ...
                  <ul className="space-y-1 ml-4">
                    <li>
                      • <strong>Delay timers:</strong> Prevent nuisance alarms during startup
                    </li>
                    <li>
                      • <strong>Deadband:</strong> Prevent alarm chattering at threshold
                    </li>
                    <li>
                      • <strong>Acknowledgment:</strong> Confirm alarm received by operator
                    </li>
                    <li>
                      • <strong>Auto-clear:</strong> Alarm clears when condition resolves
                    </li>
                    <li>
                      • <strong>Escalation:</strong> Forward unacknowledged critical alarms
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="bg-black rounded p-3 mt-3">
                <p className="text-foreground text-xs">
                  <strong>Example Logic:</strong> Office HVAC optimum start calculates required
                  pre-heating time based on outside temperature, building thermal mass, and desired
                  occupancy temperature, automatically starting heating systems at the optimal time
                  to reach comfort conditions exactly at occupancy time.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="bg-purple-500/10 border border-purple-500/20 rounded-lg p-4">
              ...
              <div className="space-y-2 text-sm">
                <ul className="ml-4 space-y-1">
                  <li>
                    • <strong>Change of value (COV):</strong> Log when values change significantly
                  </li>
                  <li>
                    • <strong>Periodic sampling:</strong> Regular interval data capture
                  </li>
                  <li>
                    • <strong>Event logging:</strong> Record alarms, overrides, mode changes
                  </li>
                  <li>
                    • <strong>Energy totalization:</strong> kWh, thermal energy accumulation
                  </li>
                  <li>
                    • <strong>Runtime totalizers:</strong> Equipment operating hours
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="bg-cyan-500/10 border border-cyan-500/20 rounded-lg p-4">
              ...
              <div className="space-y-2 text-sm">
                <ul className="ml-4 space-y-1">
                  <li>
                    • <strong>Min/max recording:</strong> Peak demand tracking
                  </li>
                  <li>
                    • <strong>Averaging calculations:</strong> Daily, weekly, monthly means
                  </li>
                  <li>
                    • <strong>Degree day calculations:</strong> Weather compensation
                  </li>
                  <li>
                    • <strong>Performance ratios:</strong> Efficiency monitoring
                  </li>
                  <li>
                    • <strong>Fault detection:</strong> Anomaly identification algorithms
                  </li>
                </ul>
              </div>
            </div>
        ...
        <div>
          ...
          <div className="bg-gradient-to-r from-orange-500/10 to-red-500/10 border border-orange-500/20 rounded-lg p-4">
            <h5 className="text-orange-400 font-semibold mb-2">
              Electrician's Advanced Testing Role
            </h5>
            <div className="space-y-3 text-sm">
              ...
              <div className="bg-gray-700 rounded p-3 mt-3">
                <p className="text-xs text-foreground">
                  <strong>Critical:</strong> Advanced programming requires systematic testing with
                  detailed documentation. Each function must be proven under both normal and fault
                  conditions before system handover.
                </p>
              </div>
            </div>
          </div>
