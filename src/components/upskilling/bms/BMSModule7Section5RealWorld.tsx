          ...
          <div className="space-y-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-foreground">
                  During functional commissioning of an AHU, fire alarm simulation revealed that
                  dampers failed to close during emergency shutdown. The system appeared to function
                  normally during pre-functional testing, but failed the critical safety sequence.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-foreground">
                  ...
                  worked correctly during individual testing. The commissioning engineer began
                  reviewing control logic and sequence programming.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-foreground">
                  Further testing with multimeters showed the actuator had been wired to the wrong
                  digital output. During normal operation, this output happened to provide the
                  correct signal, but during fire alarm sequences, the emergency logic used a
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-foreground">
                  Once the wiring was corrected to match the IO schedule, the damper responded
                  correctly to all sequences including emergency shutdowns. This highlighted the
                  critical importance of thorough pre-functional I/O checks and accurate wiring
                  verification before sequence testing.
                </p>
              </div>
            </div>
          </div>
