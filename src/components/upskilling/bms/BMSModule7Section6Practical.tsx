            ...
            <div className="space-y-3">
              <div className="bg-gray-800/50 rounded-lg p-4 border border-gray-600">
                ...
                <p className="text-sm text-foreground">
                  Don't leave IO list updates until the last day. Begin documenting changes as they
                  occur during installation and commissioning.
                </p>
              </div>
              ...
              <div className="p-3 bg-[#1a1a1a] rounded-lg">
                ...
                <p className="text-sm text-gray-300">
                  Walk through the system with the client, showing real examples. Trigger an alarm,
                  change a setpoint, demonstrate actual system responses.
                </p>
              </div>
              ...
              <div className="p-3 bg-[#1a1a1a] rounded-lg">
                ...
                <p className="text-sm text-gray-300">
                  Provide both digital and hard copies of all documentation. Digital for easy
                  searching and sharing, hard copies for emergency reference.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="p-3 bg-[#1a1a1a] rounded-lg">
                ...
                <p className="text-sm text-gray-300">
                  Focus on what the client actually needs: checking alarms, adjusting schedules,
                  generating reports. Avoid overwhelming with technical details.
                </p>
              </div>
              ...
              <div className="p-3 bg-[#1a1a1a] rounded-lg">
                ...
                <p className="text-sm text-gray-300">
                  Let operators practice common tasks during training. Create realistic scenarios
                  they'll encounter in daily operations.
                </p>
              </div>
              ...
              <div className="p-3 bg-[#1a1a1a] rounded-lg">
                ...
                <p className="text-sm text-gray-300">
                  Provide clear contact details for warranty support, emergency assistance, and
