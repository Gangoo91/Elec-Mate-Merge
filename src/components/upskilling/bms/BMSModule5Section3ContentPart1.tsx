    ...
    <Card className="bg-elec-gray border-gray-700">
      ...
      <CardContent className="text-foreground space-y-4">
        <p>
          ...
          (slaves) for information. Created in the 1970s for industrial automation, it has proven
          its reliability and simplicity over decades of use.
        </p>
        ...
        <div className="bg-gradient-to-r from-indigo-500/10 to-purple-500/10 border border-indigo-500/20 rounded-lg p-4">
          <h4 className="text-foreground font-semibold mb-2">
            Modbus Function Codes (Key Learning)
          </h4>
          <div className="space-y-2 text-sm">
            <p className="text-foreground font-medium">
              Essential function codes electricians should know:
            </p>
            <div className="grid md:grid-cols-2 gap-3">
              <div>
                <p className="text-foreground">
                  • <span className="text-elec-yellow">01</span> - Read Coils (digital outputs)
                </p>
                <p className="text-foreground">
                  • <span className="text-elec-yellow">02</span> - Read Discrete Inputs
                </p>
                <p className="text-foreground">
                  • <span className="text-elec-yellow">03</span> - Read Holding Registers
                </p>
              </div>
              <div>
                <p className="text-foreground">
                  • <span className="text-elec-yellow">04</span> - Read Input Registers
                </p>
                <p className="text-foreground">
                  • <span className="text-elec-yellow">05</span> - Write Single Coil
                </p>
                <p className="text-foreground">
                  • <span className="text-elec-yellow">06</span> - Write Single Register
                </p>
              </div>
            </div>
