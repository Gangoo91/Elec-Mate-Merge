  ...
  const equipmentTypes = [
    {
      ...
      requirements: [
        ...
        'Variable test current capability',
        ...
        <div className="space-y-4">
          ...
          <div className="bg-[#323232] rounded-lg p-4 space-y-3">
            <p className="text-foreground text-sm sm:text-base leading-relaxed">
              Residual Current Devices (RCDs) are life-saving protective devices that detect earth
              leakage currents and automatically disconnect the supply. Regular testing ensures
              these devices operate correctly when needed.
            </p>
            <div className="flex items-start gap-3 bg-green-600/10 border border-green-600/20 rounded p-3">
              <Shield className="h-5 w-5 text-green-400 mt-0.5 flex-shrink-0" />
              <p className="text-foreground text-sm sm:text-base">
                <strong>Remember:</strong> RCDs provide additional protection against electric shock
                and can prevent fires caused by earth faults.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-[#323232] rounded-lg p-4 space-y-3">
            <div className="bg-blue-600/10 border border-blue-600/20 rounded p-3">
              ...
              <p className="text-foreground text-sm sm:text-base">
                The effectiveness of all RCDs shall be verified by means of test instruments which
            ...
            <div className="bg-yellow-600/10 border border-yellow-600/20 rounded p-3">
              ...
              <p className="text-foreground text-sm sm:text-base">
                Initial verification, after alterations, during periodic inspections, and as
                specified in maintenance schedules.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {equipmentTypes.map((equipment, index) => (
              <div
                key={index}
                className={`bg-${equipment.color}-600/10 border border-${equipment.color}-600/20 rounded-lg p-4`}
              >
        ...
        <div className="space-y-4">
          ...
          <div className="bg-[#323232] rounded-lg p-4">
            ...
            <div className="mt-4 bg-blue-600/10 border border-blue-600/20 rounded p-3">
              <p className="text-foreground text-sm sm:text-base">
                <strong>Purpose:</strong> To verify RCD operates within specified parameters for
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="bg-blue-600/10 border border-blue-600/20 rounded-lg p-4">
              ...
              <p className="text-foreground text-sm sm:text-base">
                ...
                <br />
                <strong>Note:</strong> Only mandatory for socket outlets ≤20A providing additional
                protection.
              </p>
            </div>
          </div>
            ...
            <div className="bg-orange-600/10 border border-orange-600/20 rounded-lg p-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-foreground text-sm sm:text-base">
                    Some sensitive equipment may be affected by RCD testing. Consider disconnection
                    where necessary.
                  </p>
                </div>
              </div>
            ...
            <div className="bg-blue-600/10 border border-blue-600/20 rounded-lg p-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-foreground text-sm sm:text-base">
                    Record all test results including trip times, test currents used, and any
                    observations.
                  </p>
                </div>
              </div>
