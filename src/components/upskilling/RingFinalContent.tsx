...
export const RingFinalContent = () => {
  const whyRingMatters = [
    {
      issue: 'Overloaded conductors',
      description: 'If one leg breaks, full load flows through remaining conductor',
    },
    {
      issue: 'No earth protection at some outlets',
      description: 'CPC break leaves sockets without proper earthing',
    },
    {
      issue: 'Unsafe disconnection during a fault',
      description: 'Protective devices may not operate correctly',
    },
  ];
  ...
  const expectedReadings = [
    ...
    {
      test: 'Cross-connected socket readings',
      reading:
        'Similar values at each point, forming a slight curve from middle sockets to outer ones',
    },
    {
      test: 'Fault indication',
      reading: 'Drastically different readings or no continuity = fault that must be fixed',
    },
  ];
        ...
        <div className="space-y-4">
          ...
          <div className="bg-[#323232] rounded-lg p-4 space-y-3">
            <p className="text-foreground leading-relaxed">
              In a ring final circuit, current flows in both directions. A break in either leg
              (line, neutral, or CPC) can lead to:
            </p>
            ...
            <div className="bg-yellow-600/10 border border-yellow-600/20 rounded p-3 mt-4">
              <p className="text-foreground text-sm">
                <strong>That's why continuity testing is essential</strong> to confirm each
                conductor forms a complete loop.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="bg-green-600/10 border border-green-600/20 rounded p-4">
              ...
              <div className="space-y-3">
                <div className="bg-[#404040] rounded p-3">
                  ...
                  <p className="text-foreground text-sm">
                    Test resistance between L1-L2, N1-N2, and E1-E2. Line and neutral should give
                    similar readings. Earth may be slightly higher if reduced CPC is used.
                  </p>
                </div>
                <div className="bg-[#404040] rounded p-3">
                  <h5 className="text-foreground font-medium mb-2">
                    Stage 2: Cross-Connection L-N
                  </h5>
                  <p className="text-foreground text-sm">
                    Join L1 to N2 and L2 to N1. Test at each socket outlet. Readings should be
                    consistent, showing the combined resistance of line and neutral conductors.
                  </p>
                </div>
                <div className="bg-[#404040] rounded p-3">
                  <h5 className="text-foreground font-medium mb-2">
                    Stage 3: Cross-Connection L-E
                  </h5>
                  <p className="text-foreground text-sm">
                    Join L1 to E2 and L2 to E1. Test at each socket outlet. This gives the (R1+R2)
                    value used for Zs calculations.
                  </p>
                </div>
              </div>
            </div>
