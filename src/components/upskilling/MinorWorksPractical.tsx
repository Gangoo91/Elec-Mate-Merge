  ...
  const practicalSteps = [
    {
      ...
      details:
        'Check against exclusions list, verify no design calculations needed, confirm existing installation adequacy',
    },
    {
      step: '2. Verify Existing Installation',
      action: 'Inspect and test existing circuits to be modified',
      details:
        'Check circuit condition, verify protective device ratings, test RCD operation if applicable',
    },
    {
      step: '3. Complete Installation Work',
      action: 'Perform installation following BS 7671 requirements',
      details:
        'Use appropriate materials, follow safe working practices, ensure proper terminations',
    },
    {
    ...
    <Card className="bg-elec-gray border-transparent">
      ...
      <CardContent className="space-y-6">
        <div className="space-y-4">
          ...
          <div className="bg-[#323232] rounded-lg p-6 space-y-4">
            <p className="text-foreground leading-relaxed mb-4">
              Following a systematic approach ensures all aspects of minor works are properly
              addressed. Each step builds upon the previous to create a comprehensive and compliant
        ...
        <div className="space-y-4">
          ...
          <div className="bg-[#323232] rounded-lg p-6 space-y-4">
            <p className="text-foreground leading-relaxed mb-4">
              Beyond basic compliance, these practical considerations help ensure successful minor
              works completion and long-term installation performance.
            </p>
          ...
          <div className="bg-[#323232] rounded-lg p-6 space-y-4">
            <div className="bg-[#2a2a2a] border border-gray-600 rounded p-4">
              ...
              <p className="text-foreground text-sm mb-4">
                Minor works certification requires ongoing professional development to maintain
                competency and stay current with regulation changes.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
