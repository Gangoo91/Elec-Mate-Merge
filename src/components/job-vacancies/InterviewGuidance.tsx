  ...
  const interviewGuides = [
    {
      ...
      content: {
        overview:
          'Proper preparation is crucial for interview success. Research the company, understand the role, and prepare your responses.',
        keyPoints: [
    ...
    },
    {
      ...
      content: {
        overview:
          'Electrical interviews often include technical questions to assess your knowledge and problem-solving abilities.',
        keyPoints: [
    ...
    },
    {
      ...
      content: {
        overview:
          'Behavioural questions assess how you handle situations, work with others, and approach challenges.',
        keyPoints: [
    ...
    },
    {
      ...
      content: {
        overview:
          'Safety is paramount in electrical work. Demonstrate your commitment to safe working practices.',
        keyPoints: [
    ...
    },
    {
      ...
      content: {
        overview:
          'Strong communication skills are essential for explaining work to clients and colleagues.',
        keyPoints: [
    ...
    },
    {
      ...
      content: {
        overview:
          'Asking thoughtful questions shows your interest and helps you evaluate if the role is right for you.',
        keyPoints: [
      ...
      <Card className="border-elec-yellow/20 bg-elec-gray/30">
        ...
        <CardContent>
          <p className="text-muted-foreground text-sm leading-relaxed">
            Comprehensive guidance to help you excel in electrical industry interviews. From
            technical questions to behavioural scenarios, this guide covers everything you need to
            make a strong impression and secure your ideal electrical role.
          </p>
          ...
          <MobileAccordion type="single" collapsible className="w-full">
            {interviewGuides.map((guide) => (
              <MobileAccordionItem key={guide.id} value={guide.id}>
                <MobileAccordionTrigger icon={guide.icon} className="text-left px-6 py-4">
                ...
                <MobileAccordionContent className="px-6 py-4 bg-elec-gray/20 border-t border-elec-yellow/10">
                  <div className="space-y-4">
                    ...
                    {guide.content.commonQuestions && (
                      <div>
                        <h4 className="font-medium text-sm mb-2 text-elec-yellow">
                          Common Questions:
                        </h4>
                        <ul className="space-y-1">
                    ...
                    {guide.content.goodQuestions && (
                      <div>
                        <h4 className="font-medium text-sm mb-2 text-green-400">
                    ...
                    {guide.content.questionsToAvoid && (
                      <div>
                        <h4 className="font-medium text-sm mb-2 text-red-400">
                          Questions to Avoid:
                        </h4>
                        <ul className="space-y-1">
        ...
        <CardContent>
          <div className="space-y-3">
            <p className="text-sm text-muted-foreground">
              Remember: Confidence comes from preparation. Practice your responses, but keep them
