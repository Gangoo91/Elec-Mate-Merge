    ...
    <div className="border p-6 rounded-lg bg-elec-gray border-elec-yellow/20 mb-6 shadow-sm">
      <div className="mb-6">
        <h2 className="text-xl font-semibold mb-3 text-foreground">
          Looking for qualified electricians
        </h2>
        <p className="text-muted-foreground leading-relaxed">
          Browse our curated list of electrical jobs from trusted employers across the UK. New
          positions are added daily, so check back often for the latest opportunities.
        </p>
      </div>
