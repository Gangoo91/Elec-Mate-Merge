...
import { MessageCircle, CheckCircle, Clock, Lightbulb, Target, Star, XCircle } from 'lucide-react';
...
const InterviewGuidanceTab = () => {
  ...
  const categoryStyle: Record<
    string,
    { iconBg: string; icon: string; badgeBg: string; badgeText: string }
  > = {
    indigo: {
  ...
  const interviewGuides = [
    {
      ...
      overviewDescription:
        'Research projects, sectors, clients, and role expectations to tailor answers and show genuine interest.',
      steps: [
    ...
    },
    {
      ...
      overviewDescription:
        'Quick revision of the 18th Edition highlights most likely to be probed.',
      steps: [
    ...
    },
    {
      ...
      overviewDescription:
        'Prepare 3–4 concise STAR examples that prove judgement, safety, and teamwork.',
      steps: [
    ...
    },
    {
      ...
      bs7671: ['Safe isolation sequence', 'Disconnection times and RCD application'],
      checklist: [
    ...
    },
    {
      ...
      overviewDescription:
        'Demonstrate solid fundamentals and the ability to apply BS 7671 in practical scenarios.',
      steps: [
    ...
    },
    {
      ...
      overviewDescription:
        'Be ready for technical, safety, behavioural, and client-facing scenarios.',
      steps: [
    ...
    },
    {
      ...
      overviewDescription:
        'Prepare for salary, overtime, travel and contract terms typical in UK electrical roles.',
      steps: [
    ...
    <Card className="bg-elec-dark border-none shadow-none">
      <CardHeader className="text-center space-y-2 pt-2">
        ...
        <p className="text-muted-foreground max-w-prose mx-auto">
          Professional step-by-step guides for electrical job interviews
        </p>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          {[
            {
              title: 'Preparation Success',
              sub: 'Candidates ready in 3–5 days',
              icon: <CheckCircle className="h-4 w-4 text-green-400" />,
            },
            {
              title: 'Time to Offer',
              sub: '7–14 days typical',
              icon: <Clock className="h-4 w-4 text-elec-yellow" />,
            },
            {
              title: 'Technical Pass Rate',
              sub: '↑ with focused revision',
              icon: <Lightbulb className="h-4 w-4 text-blue-400" />,
            },
            {
              title: 'Interview ROI',
              sub: 'Higher offer & salary outcomes',
          ...
          {interviewGuides.map((guide, index) => {
            ...
            return (
              <MobileAccordionItem key={index} value={`guide-${index}`} className="rounded-lg mb-4">
                ...
                >
                  <div className="text-[13px] sm:text-sm font-semibold text-elec-light">
                    {guide.title}
                  </div>
                </MobileAccordionTrigger>
                <MobileAccordionContent className="bg-elec-gray border border-elec-yellow/20 border-t-0 rounded-b-lg px-4 py-3 text-[12px]">
                  {'overviewTitle' in guide && (
                    <div className="mb-2">
                      ...
                      <p className="text-xs text-muted-foreground">
                        {(guide as any).overviewDescription}
                      </p>
                    </div>
                  )}
                  ...
                  <div className="rounded-lg border border-green-500/20 bg-green-500/5 p-2.5 mt-3">
                    ...
                    <p className="text-xs text-muted-foreground">
                      Following this guidance typically improves interview performance and offer
                      rates while demonstrating BS 7671 awareness.
                    </p>
                  </div>
                </MobileAccordionContent>
              </MobileAccordionItem>
