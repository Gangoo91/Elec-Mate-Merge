...
const CVBuilder = () => {
  ...
  const handleDownload = async (format: CVFormat = 'full') => {
    ...
    try {
      ...
      const formatLabel =
        format === 'ats' ? 'ATS-Friendly' : format === 'summary' ? '1-Page Summary' : 'Full';
      toast({
        title: 'CV Downloaded',
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div className="flex items-center gap-2 min-w-0">
              ...
              <div className="min-w-0">
                <CardTitle className="text-lg md:text-xl text-foreground truncate">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent
                  align="end"
                  className="bg-elec-gray border-elec-gray text-foreground"
                >
                  <DropdownMenuItem
