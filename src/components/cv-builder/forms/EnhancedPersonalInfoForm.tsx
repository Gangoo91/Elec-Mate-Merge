...
export const EnhancedPersonalInfoForm: React.FC<EnhancedPersonalInfoFormProps> = ({
  cvData,
  onChange,
}) => {
      ...
      <div>
        ...
        <div className="space-y-6">
          <div className="space-y-3">
            <label className="text-sm font-semibold text-elec-light">Full Name *</label>
            <input
              type="text"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-3">
              <label className="text-sm font-semibold text-elec-light">Email Address *</label>
              <input
                type="email"
            ...
            <div className="space-y-3">
              <label className="text-sm font-semibold text-elec-light">Phone Number *</label>
              <input
                type="tel"
          ...
          <div className="space-y-3">
            <label className="text-sm font-semibold text-elec-light">Address</label>
            <input
              type="text"
          ...
          <div className="space-y-3">
            <label className="text-sm font-semibold text-elec-light">Postcode</label>
            <input
              type="text"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-3">
              <label className="text-sm font-semibold text-elec-light">LinkedIn Profile</label>
              <input
                type="url"
            ...
            <div className="space-y-3">
              <label className="text-sm font-semibold text-elec-light">Portfolio Website</label>
              <input
                type="url"
          ...
          <div className="space-y-4">
            <div className="space-y-3">
              <label className="text-sm font-semibold text-elec-light">Professional Summary</label>
              <textarea
                value={cvData.personalInfo.professionalSummary}
                onChange={(e) => updatePersonalInfo('professionalSummary', e.target.value)}
                className="flex min-h-[80px] w-full rounded-md border border-input bg-card px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 resize-none mt-2"
