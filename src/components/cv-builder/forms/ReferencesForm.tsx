    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-elec-light/60 mb-6">
          Add 2-3 professional references. Always get permission before listing someone as a
          reference.
        </p>
              ...
              {expandedRef === ref.id && (
                <div className="p-4 pt-0 space-y-4 border-t border-elec-light/10">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-3">
                      <label className="text-sm font-semibold text-elec-light">Job Title *</label>
                      <input
                        type="text"
                        value={ref.jobTitle}
                    ...
                    <div className="space-y-3">
                      <label className="text-sm font-semibold text-elec-light">Company *</label>
                      <input
                        type="text"
                        value={ref.company}
                  ...
                  <div className="space-y-3">
                    <label className="text-sm font-semibold text-elec-light">Relationship</label>
                    <select
                  ...
                  <div className="p-3 bg-amber-500/10 border border-amber-500/20 rounded-lg">
                    <p className="text-xs text-amber-300">
                      <strong>Tip:</strong> Contact details are optional on your CV. Many employers
                      prefer "References available on request" - you can include contact info when
                      specifically asked.
                    </p>
                  </div>
                </div>
          ...
          {cvData.references.length === 0 && (
            <div className="p-4 bg-elec-gray/50 rounded-lg border border-elec-light/10">
              ...
              <p className="text-xs text-elec-light/60">
                It's common to write "References available on request" on your CV. Add references
                here only if you want them to appear on your CV, or leave this section empty.
              </p>
            </div>
          )}
        </div>
