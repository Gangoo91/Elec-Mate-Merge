...
import { User, AtSign, Mail, FileText, Shield } from 'lucide-react';
        ...
        {fields.map((field, index) => {
          ...
          return (
            <div key={index} className="space-y-2">
              ...
              <p
                className={`text-sm sm:text-base pl-5 ${field.value === 'Not set' || field.value === 'No bio added yet.' ? 'italic text-muted-foreground' : ''}`}
              >
                {field.value}
              </p>
            </div>
