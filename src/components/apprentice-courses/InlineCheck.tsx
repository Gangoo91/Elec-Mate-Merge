    ...
    return (
      <section aria-labelledby={`${id}-label`} className="my-6 sm:my-8">
        <div className="flex items-center gap-2 text-elec-yellow mb-3 sm:mb-4">
          ...
          <h3 id={`${id}-label`} className="text-base sm:text-lg font-semibold">
            Quick Check
          </h3>
        </div>
      ...
      <div className="space-y-4">
            ...
            return (
              ...
              >
                <div className="flex items-center justify-between gap-3">
                  ...
                  {wrongThis && (
                    <XCircle className="h-5 w-5 text-red-400 flex-shrink-0" aria-hidden />
                  )}
                </div>
              </button>
            );
        ...
        {submitted && (
          ...
          >
            ...
            {explanation && (
              <p className="text-white text-sm sm:text-base leading-relaxed">{explanation}</p>
            )}
          </div>
        )}
      </div>
