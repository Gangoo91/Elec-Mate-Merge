  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        ...
        />
        <p id="value-help" className="text-xs text-muted-foreground">
          Use decimals or scientific notation (e.g. 1e-3).
        </p>
      </div>
      ...
      <div className="rounded-md border border-border/30 bg-card p-4">
        ...
        <p className="text-2xl font-semibold text-elec-yellow">
          {formatNumber(result)} {toP === 'base' ? '' : toP}
          {qty}
        </p>
      </div>

      <div className="text-xs text-muted-foreground">
        BS 7671 reminder: Always verify manufacturer data and instrument scales before converting or
        applying values.
      </div>
    </div>
  );
