    ...
    <div className={cn('space-y-3', className)}>
      ...
      <div className="relative">
        <canvas
          ...
          className={cn(
            ...
            isDark ? 'border-slate-600 bg-slate-800/80' : 'border-border bg-muted/30'
          )}
        ...
        {!hasSignature && (
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
            <span className={cn('text-sm', isDark ? 'text-slate-500' : 'text-foreground/30')}>
      ...
      {showActions && (
        <div className="flex gap-3">
          ...
          <Button className="flex-1 h-12" onClick={handleConfirm} disabled={!hasSignature}>
