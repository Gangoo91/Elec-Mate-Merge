...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-12 items-center justify-center rounded-lg bg-elec-dark p-1 text-muted-foreground overflow-x-auto",
      className
    )}
    {...props}
  />
