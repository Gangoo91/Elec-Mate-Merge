...
import { ArrowLeft, FileText, Check, ChevronRight, ArrowRight } from 'lucide-react';
    ...
    <div className="flex flex-col h-full bg-background">
      ...
      <div className="mx-3 mt-1 shrink-0">
        {lastReading && !readingRecorded ? (
          ...
          <div className="flex items-center gap-2 rounded-lg px-3 py-1.5 border border-cyan-400/15 bg-cyan-500/[0.04]">
            <div className="w-5 h-5 rounded-full bg-cyan-500/20 flex items-center justify-center shrink-0">
              <span className="text-[9px] font-bold text-cyan-400">{currentTestNumber + 1}</span>
            </div>
            <div className="flex-1 min-w-0">
              <p className="text-[10px] text-white/70 truncate">{nextTest.description}</p>
              <div className="flex items-center gap-1.5 mt-0.5">
                ...
                <span className="text-[9px] text-white/25">at</span>
