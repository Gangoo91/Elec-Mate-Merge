...
const RcdTestingTab = () => {
  const testingProcedures = [
    {
      test: 'Test Button Check',
      frequency: 'Monthly',
      procedure: 'Press test button - RCD should trip',
      acceptance: 'RCD trips immediately',
    },
    {
      test: '½ × In Test',
      frequency: 'Periodic',
      procedure: 'Apply half rated current',
      acceptance: 'Should NOT trip',
    },
    {
      test: '1 × In Test',
      frequency: 'Periodic',
      procedure: 'Apply rated current',
      acceptance: '≤300ms trip time',
    },
    {
      test: '5 × In Test',
      frequency: 'Periodic',
      procedure: 'Apply 5× rated current',
      acceptance: '≤40ms trip time',
    },
    {
      test: 'Ramp Test',
      frequency: 'Installation',
      procedure: 'Gradually increase current',
      acceptance: 'Trip between 50-100% In',
    },
  ];
  ...
  return (
    <Card className="bg-card border-border">
      <CardHeader>
        ...
        <CardDescription>Comprehensive testing methods and acceptance criteria</CardDescription>
      </CardHeader>
              ...
              <div className="space-y-2">
                ...
                <div className="p-3 bg-blue-500/10 rounded border border-blue-500/30">
                  ...
                  <p className="text-xs text-gray-300">
                    High humidity can affect insulation resistance
                  </p>
                </div>
                <div className="p-3 bg-red-500/10 rounded border border-red-500/30">
                  <h4 className="font-semibold text-red-400 text-sm">Harmonics</h4>
                  <p className="text-xs text-gray-300">
                    Electronic loads may cause nuisance tripping
                  </p>
                </div>
              </div>
            </CardContent>
