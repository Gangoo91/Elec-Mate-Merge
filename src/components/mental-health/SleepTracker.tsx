    ...
    return (
      <div className="space-y-4">
        ...
        <div className="flex items-center justify-between">
          ...
          <span className="text-sm text-muted-foreground">Sleep History</span>
          <div className="w-16" />
        </div>
        ...
        <div className="grid grid-cols-2 gap-3">
          <Card className="border-indigo-500/20 bg-indigo-500/5">
            <CardContent className="p-3 text-center">
              ...
              <div className="text-[10px] text-muted-foreground">Weekly Average</div>
            </CardContent>
          </Card>
          <Card className="border-purple-500/20 bg-purple-500/5">
            <CardContent className="p-3 text-center">
              ...
              <div className="text-[10px] text-muted-foreground">Quality Trend</div>
            </CardContent>
          </Card>
        </div>
          ...
          {entries.length > 0 ? (
            ...
            <Card className="border-white/10 bg-white/5">
              <CardContent className="text-center py-8">
                <Moon className="h-10 w-10 text-muted-foreground mx-auto mb-3" />
        ...
        <Card className="border-green-500/20 bg-green-500/5">
          <CardContent className="p-3 flex items-center gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-muted-foreground">You can update your entry below</p>
            </div>
          </CardContent>
        </Card>
      )}
