      ...
      <DialogContent className="max-w-[380px] rounded-2xl">
        {isSubmitted ? (
          <div className="py-8 text-center">
            <div className="mx-auto mb-4 p-4 rounded-full bg-emerald-500/10 border border-emerald-500/30 w-fit">
          ...
          <>
            <DialogHeader>
              <div className="mx-auto mb-2 p-3 rounded-full bg-amber-500/10 border border-amber-500/30">
                  ...
                  {reportReasons.map((option) => (
                    ...
                    >
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-xs text-white mt-0.5">{option.description}</p>
                      </div>
                    </div>
                  ))}
                </RadioGroup>
