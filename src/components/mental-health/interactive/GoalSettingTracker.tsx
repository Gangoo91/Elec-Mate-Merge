    ...
    <div className="space-y-4 pt-3">
      ...
      {activeGoals.length > 0 && (
        <div className="space-y-2">
          ...
          <p className="text-[10px] text-white text-center">Tap the percentage to add progress</p>
        </div>
      )}
      ...
      {showAdd ? (
        <div className="space-y-3">
          <input
            ...
            className="w-full h-11 px-3 rounded-xl bg-white/[0.04] border border-white/[0.08] text-white text-sm placeholder:text-white focus:border-white/20 focus:outline-none touch-manipulation"
            style={{ fontSize: '16px' }}
            autoFocus
          />
        ...
        <button
          ...
          className="w-full h-11 rounded-xl border-2 border-dashed border-white/[0.1] text-white text-xs font-medium touch-manipulation active:scale-[0.98] flex items-center justify-center gap-1.5"
        >
