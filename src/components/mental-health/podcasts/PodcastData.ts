...
export const podcasts: Podcast[] = [
  ...
  // ============================================
  {
    ...
    description:
      "Real people sharing their mental health journeys. Personal stories of struggle, recovery, and hope that remind us we're never alone. A supportive space for honest conversations about mental health.",
  ...
  // ============================================
  {
    ...
    host: 'Mates in Mind',
    description:
      'Mental health awareness specifically for the construction and related industries. Toolbox talks, expert interviews, and practical guidance for improving workplace mental health support.',
  ...
  },
  {
    ...
    description:
      "Stories from the construction industry charity supporting workers and their families. Real experiences from tradespeople who've faced mental health challenges and found support.",
  ...
  },
  {
    ...
    description:
      "Men talking openly about mental health. Andy's Man Club runs free peer support groups across the UK where men can speak openly about their struggles.",
  ...
  // ============================================
  {
    ...
    host: 'Fearne Cotton',
    description:
      "One of the UK's most popular wellbeing podcasts. Honest conversations about mental health, happiness, and living a more balanced life with celebrity and expert guests.",
  ...
  },
  {
    ...
    description:
      'Dr Chatterjee explores the four pillars of health: relaxation, food, movement, and sleep. Practical advice backed by science to help you feel better every day.',
    topics: ['Health', 'Sleep', 'Stress', 'Lifestyle', 'Science-Based'],
    category: 'general-mental-health',
    links: {
      spotify: 'https://open.spotify.com/show/6NyPQfcSR9nj0DPDr2ixrK',
      apple:
        'https://podcasts.apple.com/gb/podcast/feel-better-live-more-with-dr-rangan-chatterjee/id1333552422',
    },
  },
  {
    ...
    description:
      "Evidence-based mental health content from the UK's leading charity. Research, campaigns, and practical tips for maintaining good mental health.",
  ...
  },
  {
    ...
    host: 'Mind Charity',
    description:
      "Official podcast from Mind, the UK's leading mental health charity. Expert advice, personal stories, and guidance on getting support when you need it.",
  ...
  // ============================================
  {
    ...
    host: 'Metro.co.uk',
    description:
      'Real people sharing their mental health stories without filter. From anxiety to addiction, depression to eating disorders - honest conversations that break the stigma.',
  ...
  },
  {
    ...
    host: 'Bryony Gordon',
    description:
      'Telegraph columnist Bryony Gordon talks honestly about mental health with a range of guests including royalty and celebrities. Vulnerable, real conversations.',
  ...
  },
  {
    ...
    description:
      'University professors strip back their professional personas to discuss mental health, imposter syndrome, and the pressures of modern life with refreshing honesty.',
  ...
  // ============================================
  {
    ...
    host: 'Otis Gray',
    description:
      "Bedtime stories for grown-ups. Calm, slow readings of classic literature designed to help you drift off to sleep. Perfect for those nights when your mind won't switch off.",
  ...
  },
  {
    ...
    description:
      'Bedtime stories for adults where nothing much happens. Gentle, calming narratives specifically designed to help you fall asleep peacefully.',
    topics: ['Sleep Stories', 'Calm', 'Relaxation', 'Bedtime'],
    category: 'sleep-anxiety',
    links: {
      spotify: 'https://open.spotify.com/show/6wegpF4BHu5dQG7sTg1Cz9',
      apple:
        'https://podcasts.apple.com/gb/podcast/nothing-much-happens-bedtime-stories-to-help-you-sleep/id1378040733',
    },
  },
  {
    id: 'the-anxiety-guy',
    ...
    host: 'Dennis Simsek',
    description:
      "Practical strategies for overcoming anxiety from someone who's been there. Evidence-based techniques, success stories, and daily tips for managing anxiety.",
