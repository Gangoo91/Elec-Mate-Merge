...
const scenarios: Scenario[] = [
  {
    ...
    situation:
      "You're on your first week at a new site. Everything seems complicated, you don't know anyone, and your supervisor keeps giving you tasks you've never done before.",
    ...
    outcome:
      'By asking questions and taking notes, you build confidence and relationships. Your supervisor appreciates your eagerness to learn properly rather than guessing.',
  ...
  },
  {
    ...
    situation:
      "You have a major assignment due next week, but this week at work has been particularly demanding with overtime. You're exhausted and haven't started the coursework.",
    ...
    outcome:
      'Your tutor provides a 3-day extension and offers additional support. You complete the work in smaller sessions and feel more confident about future assignments.',
  ...
  },
  {
    ...
    situation:
      "You've wired a circuit incorrectly, and it's only discovered when testing begins. This delays the project and requires rewiring. Your supervisor is frustrated, and you feel like you've let everyone down.",
    stressors: [
      'Guilt and shame',
    ...
    outcome:
      'Your honest approach is appreciated. Your supervisor uses it as a teaching moment for the whole team, and you gain valuable knowledge about common wiring errors.',
  ...
  },
  {
    ...
    situation:
      "An experienced tradesman constantly criticises your work and makes sarcastic comments. Other apprentices have noticed, and you're starting to dread coming to work.",
    ...
    outcome:
      'After reporting to your training provider, they intervene with the employer. The behaviour stops, and you learn valuable skills about workplace rights and conflict resolution.',
