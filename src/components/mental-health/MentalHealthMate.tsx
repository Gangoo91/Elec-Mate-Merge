        ...
        <CardContent className="p-0">
          ...
          <div className="p-3 border-b border-purple-500/20 flex items-center justify-between bg-purple-500/5">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs text-muted-foreground">AI Mate is online</span>
            </div>
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div className="text-left">
              ...
              <p className="text-xs text-muted-foreground">Connect with trained peer supporters</p>
            </div>
          </div>
          <div className="flex items-center gap-2">
            ...
            <ChevronDown className={`h-5 w-5 text-muted-foreground transition-transform ${showPeers ? 'rotate-180' : ''}`} />
          </div>
        </button>
            ...
            {!isVolunteer ? (
              ...
              <div className="p-4 rounded-lg bg-green-500/10 border border-green-500/20 text-center">
                <div className="flex flex-col items-center gap-2">
                  ...
                  <span className="text-xs text-muted-foreground">Thank you for supporting others</span>
                </div>
              </div>
            )}
          </CardContent>
