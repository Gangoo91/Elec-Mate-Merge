      ...
      circuits: [
        {
          ...
          protectiveDeviceRating: '32A MCB',
        ...
        },
        {
          ...
          cableSize: '2.5mm',
          cableType: 'pvc-twin-earth',
          protectiveDeviceRating: '20A MCB',
    ...
    },
    {
      ...
      circuits: [
        ...
        },
        {
          ...
          cableSize: '10mm',
          cableType: 'pvc-twin-earth',
          protectiveDeviceRating: '40A MCB',
        ...
        },
        {
          ...
          cableSize: '2.5mm',
          cableType: 'pvc-twin-earth',
          protectiveDeviceRating: '16A MCB',
          circuitDescription: 'Central Heating',
        },
      ],
    },
    {
      ...
      circuits: [
        {
          ...
          cableType: 'pvc-twin-earth',
          protectiveDeviceRating: '32A MCB',
          circuitDescription: 'General Sockets - Zone 1',
        },
        {
          circuitNumber: '2',
          cableSize: '2.5mm',
          cableType: 'pvc-twin-earth',
          protectiveDeviceRating: '32A MCB',
          circuitDescription: 'General Sockets - Zone 2',
        },
        {
          circuitNumber: '3',
          cableSize: '1.5mm',
          cableType: 'pvc-twin-earth',
          protectiveDeviceRating: '10A MCB',
          circuitDescription: 'Lighting - General',
        },
        {
          circuitNumber: '4',
          cableSize: '1.5mm',
          cableType: 'pvc-twin-earth',
          protectiveDeviceRating: '6A MCB',
          circuitDescription: 'Emergency Lighting',
        },
        {
          circuitNumber: '5',
          cableSize: '4.0mm',
          cableType: 'pvc-twin-earth',
          protectiveDeviceRating: '20A MCB',
          circuitDescription: 'Air Conditioning',
        },
        {
          circuitNumber: '6',
          cableSize: '1.5mm',
          cableType: 'pvc-twin-earth',
          protectiveDeviceRating: '6A MCB',
          circuitDescription: 'Fire Alarm System',
        },
      ],
    },
    {
      ...
      circuits: [
        {
          ...
          cableType: 'pvc-twin-earth',
          protectiveDeviceRating: '32A MCB',
          circuitDescription: 'Commercial Oven',
        },
        {
          circuitNumber: '2',
          cableSize: '4.0mm',
          cableType: 'pvc-twin-earth',
          protectiveDeviceRating: '25A MCB',
          circuitDescription: 'Extraction Fan',
        },
        {
          circuitNumber: '3',
          cableSize: '2.5mm',
        ...
        },
        {
          ...
          cableType: 'pvc-twin-earth',
          protectiveDeviceRating: '16A MCB',
          circuitDescription: 'Refrigeration',
        },
        {
          circuitNumber: '5',
          cableSize: '2.5mm',
          cableType: 'pvc-twin-earth',
          protectiveDeviceRating: '32A MCB',
          circuitDescription: 'General Sockets',
        },
        {
          circuitNumber: '6',
          cableSize: '1.5mm',
              ...
              <div className="space-y-1">
                {template.circuits.slice(0, 3).map((circuit, index) => (
                  <div key={index} className="text-xs text-muted-foreground">
                    {circuit.circuitNumber}. {circuit.circuitDescription} -{' '}
