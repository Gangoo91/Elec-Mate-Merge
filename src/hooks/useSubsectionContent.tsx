...
export function useSubsectionContent({
  ...
  console.log('useSubsectionContent called with:', {
    courseSlug,
    unitSlug,
    sectionId,
    subsectionId,
  ...
  const navigateToSubsection = (subsection: Subsection | string) => {
    ...
    navigate(
      `/apprentice/study/eal/${effectiveCourseSlug}/unit/${effectiveUnitSlug}/section/${sectionId}/subsection/${subsectionToNavigate}`
    );
  };
