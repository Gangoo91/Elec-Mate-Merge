...
const jobTypeConfigs: JobTypeConfig[] = [
  ...
  },
  {
    ...
    attributes: [
      ...
      {
        key: 'cable_length',
        label: 'Approximate cable length',
        type: 'number',
        unit: 'metres',
        min: 10,
        max: 100,
  ...
  },
  {
    ...
    attributes: [
      {
        key: 'neutral_required',
        label: 'Neutral wire present?',
        type: 'select',
        options: [
  ...
  // Emergency & Call-outs
  {
    job_type: 'Emergency Call-out (first hour)',
  ...
  {
    job_type: 'RCD Tripping Investigation',
    job_category: 'Emergency & Call-outs',
    unit: 'per job',
  },
  ...
  {
    job_type: 'Burning Smell Investigation',
    job_category: 'Emergency & Call-outs',
    unit: 'per job',
  },
  ...
  {
    job_type: 'Additional Circuit Installation',
    job_category: 'Consumer Units & Boards',
    unit: 'per circuit',
  },
  ...
  {
    job_type: 'Main Bonding Installation',
    job_category: 'Earthing & Bonding',
    unit: 'per service',
  },
  {
    job_type: 'Supplementary Bonding (Bathroom)',
    job_category: 'Earthing & Bonding',
    unit: 'per job',
  },
  {
    job_type: 'Supplementary Bonding (Kitchen)',
    job_category: 'Earthing & Bonding',
    unit: 'per job',
  },
  ...
  {
    job_type: 'Circuit Breaker Replacement',
    job_category: 'Repairs & Maintenance',
    unit: 'per breaker',
  },
  ...
  {
    job_type: 'Three-Phase Supply Installation',
    job_category: 'Commercial & Industrial',
    unit: 'per job',
  },
  {
    job_type: 'Motor Control Installation',
    job_category: 'Commercial & Industrial',
    unit: 'per motor',
  },
  {
    job_type: 'Distribution Board Installation',
    job_category: 'Commercial & Industrial',
    unit: 'per board',
  },
  ...
  {
    job_type: 'Electrical Installation Certificate',
    job_category: 'Testing & Certification',
    unit: 'per certificate',
  },
  {
    job_type: 'Minor Works Certificate',
    job_category: 'Testing & Certification',
    unit: 'per certificate',
  },
  {
    job_type: 'Landlord Safety Check',
    job_category: 'Testing & Certification',
    unit: 'per property',
  },
];
  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      const grouped = finalData.reduce((acc: Record<string, JobTypeConfig[]>, item) => {
        ...
        const exists = acc[item.job_category].find(
          (existing) => existing.job_type === item.job_type
        );
