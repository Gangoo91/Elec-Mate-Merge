...
export const useQuoteMaterialIntegration = (
  ...
  const addMaterialToQuote = useCallback(
    (material: MaterialToQuoteItem, quantity: number = 1) => {
  ...
  const addMultipleMaterialsToQuote = useCallback(
    (materials: MaterialToQuoteItem[]) => {
      let successCount = 0;
