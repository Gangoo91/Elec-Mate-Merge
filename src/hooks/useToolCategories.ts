...
const getCategoryIcon = (category: string) => {
  switch (category) {
    ...
    case 'Safety Tools':
      return Shield;
    case 'Access Tools & Equipment':
      return ArrowUp;
    case 'Tool Storage':
      return Package;
    case 'Specialist Tools':
      return Settings;
    default:
      return Wrench;
  }
...
const getCategoryDescription = (category: string): string => {
  switch (category) {
    case 'Hand Tools':
      return 'Essential hand tools for electrical work including screwdrivers, pliers, and spanners';
    case 'Power Tools':
      return 'Electric and cordless power tools for drilling, cutting, and installation work';
    case 'Test Equipment':
      return 'Testing and measurement equipment for electrical safety and compliance';
    case 'PPE':
      return 'Personal protective equipment for safe working practices';
    case 'Safety Tools':
      return 'Safety tools and equipment for hazard identification and protection';
    case 'Access Tools & Equipment':
      return 'Ladders, scaffolding and access equipment for working at height';
    case 'Tool Storage':
      return 'Tool bags, boxes and storage solutions for organisation';
    case 'Specialist Tools':
      return 'Specialist electrical tools for specific installation tasks';
    default:
      return 'Essential hand tools for electrical work';
  }
};
...
const getDefaultCategories = (): ToolCategory[] => [
  {
    ...
    icon: Wrench,
    description:
      'Essential hand tools for electrical work including screwdrivers, pliers, and spanners',
    count: 0,
  },
  {
    name: 'Power Tools',
  ...
  },
  {
    ...
    icon: Settings,
    description: 'Specialist electrical tools for specific installation tasks',
    count: 0,
  },
];
