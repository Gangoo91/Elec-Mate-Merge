...
const FALLBACK_EDUCATION_DATA: LiveEducationData[] = [
  {
    ...
    description:
      'A nationally recognised Level 4 qualification providing advanced knowledge in electrical engineering, circuit design, and systems analysis. Ideal for electricians seeking to progress into senior technical or managerial roles.',
    level: 'Level 4',
    duration: '2 years',
  ...
  },
  {
    ...
    description:
      'Level 5 Higher National Diploma providing comprehensive training in electrical systems, renewable energy, and building automation. Equivalent to the first two years of an engineering degree.',
    level: 'Level 5',
    duration: '2 years',
    category: 'Higher Education',
    ...
    progressionOptions: [
      'BSc Electrical Engineering (Top-up)',
      'Design Engineer',
      'Project Manager',
    ],
  ...
  },
  {
    ...
    description:
      'Accredited degree programme offering comprehensive study of electrical engineering principles, power distribution, and modern electrical systems. Study while working with flexible delivery options.',
    level: 'Level 6',
  ...
  },
  {
    ...
    description:
      'Advanced qualification covering electrical installation design, verification procedures, and compliance with BS 7671. Essential for electricians moving into design roles.',
    level: 'Level 4',
  ...
  },
  {
    ...
    institution: 'NEBOSH',
    description:
      'Industry-leading health and safety qualification highly valued in the electrical sector. Covers risk assessment, workplace hazards, and safety management systems.',
    level: 'Level 3',
  ...
  },
  {
    ...
    description:
      'Comprehensive qualification for solar photovoltaic installation, including system design, installation methods, and commissioning procedures. Essential for renewable energy work.',
    level: 'Level 3',
    duration: '5 days',
  ...
  },
  {
    ...
    description:
      'Official qualification for electric vehicle charging point installation, covering domestic and commercial systems, smart charging, and load management.',
    level: 'Level 3',
    duration: '2-3 days',
    category: 'Renewable Energy',
    studyMode: 'Classroom with practical',
  ...
  },
  {
    ...
    description:
      'Essential update training for the 18th Edition Wiring Regulations. Mandatory for all practising electricians to maintain competence and compliance.',
    level: 'Level 3',
    duration: '3 days',
  ...
  },
  {
    ...
    description:
      'Industry-standard qualification for electrical inspection and testing. Covers initial verification and periodic inspection with practical assessments.',
    level: 'Level 3',
    duration: '5-10 days',
    category: 'Testing & Inspection',
    studyMode: 'Classroom with practical',
  ...
  },
  {
    ...
    description:
      'Comprehensive training on fire alarm system design, installation, and commissioning to BS 5839 standards. Essential for commercial electrical work.',
    level: 'Level 3',
    duration: '5 days',
  ...
  },
  {
    ...
    description:
      'Comprehensive 4-year apprenticeship combining practical work experience with formal qualifications. Leads to fully qualified electrician status with JIB card.',
    level: 'Level 3',
    duration: '4 years',
  ...
  },
  {
    ...
    description:
      'Specialist qualification covering emergency lighting system design, installation, testing and maintenance to BS 5266 standards.',
    level: 'Level 3',
    duration: '2-3 days',
    category: 'Fire & Security',
    studyMode: 'Classroom',
  ...
  const fetchEducationData = async (forceRefresh: boolean = false) => {
    try {
        ...
        if (!cacheError && cachedData?.education_data && cachedData?.analytics_data) {
          ...
          setCacheInfo({
            ...
            daysUntilRefresh: Math.ceil(
              (new Date(cachedData.next_refresh_date).getTime() - Date.now()) /
                (1000 * 60 * 60 * 24)
            ),
          });
          setLoading(false);
      ...
      if (expiredCache?.education_data) {
        ...
        console.log(
          `⚡ Showing cached data (${cachedArray.length} programmes) while refreshing...`
        );
      ...
      try {
        ...
        if (fallbackData?.education_data) {
          ...
          console.log(
            `🔄 Using fallback cached data after error (${errorFallbackArray.length} programmes)`
          );
