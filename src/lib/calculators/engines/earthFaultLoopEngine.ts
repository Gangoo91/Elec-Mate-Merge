...
// BS 7671 Table 41.3 / Table 41.2 — Maximum Zs values for protective devices
// Values based on Uo(min) = 0.95 × 230V = 218.5V per BS 7671 tabulated values.
// IMPORTANT: Keep in sync with src/lib/calculators/bs7671-data/protectiveDevices.ts
// TODO: Refactor to import directly from protectiveDevices.ts to avoid future drift.
const maxZsValues = {
  'mcb-b': {
    3: 14.57,
    6: 7.28,
