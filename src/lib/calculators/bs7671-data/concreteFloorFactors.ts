...
export const concreteFloorGroupingFactors: ConcreteFloorGroupingFactor[] = [
  {
    conductorSize: 4,
    method118: { 2: 0.93, 3: 0.9, 4: 0.87, 5: 0.82, 6: 0.86, 7: 0.83, 8: 0.76, 9: 0.81, 10: 0.74 },
    method119: { 2: 0.94, 3: 0.91, 4: 0.88, 5: 0.84, 6: 0.88, 7: 0.85, 8: 0.79, 9: 0.84, 10: 0.77 },
    method120: { 2: 0.95, 3: 0.92, 4: 0.89, 5: 0.86, 6: 0.9, 7: 0.87, 8: 0.82, 9: 0.86, 10: 0.8 },
  },
  {
    conductorSize: 6,
    method118: { 2: 0.92, 3: 0.89, 4: 0.86, 5: 0.8, 6: 0.84, 7: 0.81, 8: 0.73, 9: 0.79, 10: 0.72 },
    method119: { 2: 0.93, 3: 0.9, 4: 0.87, 5: 0.83, 6: 0.87, 7: 0.84, 8: 0.77, 9: 0.82, 10: 0.75 },
    method120: { 2: 0.94, 3: 0.91, 4: 0.88, 5: 0.85, 6: 0.89, 7: 0.86, 8: 0.8, 9: 0.85, 10: 0.78 },
  },
  {
    conductorSize: 10,
    method118: { 2: 0.9, 3: 0.87, 4: 0.84, 5: 0.77, 6: 0.81, 7: 0.78, 8: 0.7, 9: 0.76, 10: 0.69 },
    method119: { 2: 0.92, 3: 0.89, 4: 0.86, 5: 0.81, 6: 0.85, 7: 0.82, 8: 0.74, 9: 0.8, 10: 0.73 },
    method120: { 2: 0.93, 3: 0.9, 4: 0.87, 5: 0.83, 6: 0.87, 7: 0.84, 8: 0.78, 9: 0.83, 10: 0.76 },
  },
  {
    conductorSize: 16,
    method118: { 2: 0.88, 3: 0.84, 4: 0.81, 5: 0.74, 6: 0.78, 7: 0.74, 8: 0.66, 9: 0.72, 10: 0.65 },
    method119: { 2: 0.9, 3: 0.87, 4: 0.84, 5: 0.78, 6: 0.82, 7: 0.79, 8: 0.71, 9: 0.77, 10: 0.7 },
  ...
  },
  {
    ...
    method119: { 2: 0.89, 3: 0.85, 4: 0.82, 5: 0.76, 6: 0.8, 7: 0.76, 8: 0.68, 9: 0.74, 10: 0.67 },
    method120: { 2: 0.91, 3: 0.88, 4: 0.84, 5: 0.79, 6: 0.83, 7: 0.8, 8: 0.72, 9: 0.78, 10: 0.71 },
  },
  {
    conductorSize: 35,
    method118: { 2: 0.84, 3: 0.79, 4: 0.76, 5: 0.68, 6: 0.71, 7: 0.68, 8: 0.59, 9: 0.65, 10: 0.59 },
    method119: { 2: 0.87, 3: 0.83, 4: 0.8, 5: 0.73, 6: 0.77, 7: 0.73, 8: 0.65, 9: 0.71, 10: 0.64 },
    method120: { 2: 0.9, 3: 0.86, 4: 0.83, 5: 0.77, 6: 0.81, 7: 0.77, 8: 0.7, 9: 0.76, 10: 0.69 },
  },
  {
    conductorSize: 50,
    method118: { 2: 0.82, 3: 0.77, 4: 0.73, 5: 0.65, 6: 0.68, 7: 0.64, 8: 0.56, 9: 0.61, 10: 0.55 },
    method119: { 2: 0.86, 3: 0.81, 4: 0.77, 5: 0.7, 6: 0.74, 7: 0.7, 8: 0.62, 9: 0.67, 10: 0.61 },
    method120: { 2: 0.89, 3: 0.84, 4: 0.81, 5: 0.74, 6: 0.78, 7: 0.74, 8: 0.67, 9: 0.73, 10: 0.66 },
  },
  {
    conductorSize: 70,
    method118: { 2: 0.8, 3: 0.74, 4: 0.71, 5: 0.63, 6: 0.65, 7: 0.61, 8: 0.53, 9: 0.58, 10: 0.52 },
    method119: { 2: 0.84, 3: 0.79, 4: 0.75, 5: 0.68, 6: 0.71, 7: 0.67, 8: 0.59, 9: 0.64, 10: 0.58 },
    method120: { 2: 0.87, 3: 0.83, 4: 0.79, 5: 0.72, 6: 0.76, 7: 0.72, 8: 0.64, 9: 0.7, 10: 0.63 },
  },
  {
    conductorSize: 95,
    method118: { 2: 0.78, 3: 0.72, 4: 0.68, 5: 0.6, 6: 0.62, 7: 0.58, 8: 0.5, 9: 0.55, 10: 0.49 },
    method119: { 2: 0.83, 3: 0.77, 4: 0.73, 5: 0.65, 6: 0.68, 7: 0.64, 8: 0.56, 9: 0.61, 10: 0.55 },
    method120: { 2: 0.86, 3: 0.81, 4: 0.77, 5: 0.7, 6: 0.73, 7: 0.69, 8: 0.61, 9: 0.67, 10: 0.6 },
  },
  {
    conductorSize: 120,
    method118: { 2: 0.76, 3: 0.7, 4: 0.66, 5: 0.58, 6: 0.6, 7: 0.56, 8: 0.47, 9: 0.52, 10: 0.47 },
    method119: { 2: 0.81, 3: 0.76, 4: 0.71, 5: 0.63, 6: 0.66, 7: 0.62, 8: 0.53, 9: 0.58, 10: 0.53 },
    method120: { 2: 0.85, 3: 0.8, 4: 0.75, 5: 0.68, 6: 0.71, 7: 0.67, 8: 0.59, 9: 0.64, 10: 0.58 },
  },
  {
    conductorSize: 150,
    method118: { 2: 0.75, 3: 0.68, 4: 0.64, 5: 0.56, 6: 0.58, 7: 0.53, 8: 0.45, 9: 0.5, 10: 0.44 },
    method119: { 2: 0.8, 3: 0.74, 4: 0.69, 5: 0.61, 6: 0.64, 7: 0.59, 8: 0.51, 9: 0.56, 10: 0.5 },
  ...
  },
  {
    ...
    method120: { 2: 0.83, 3: 0.77, 4: 0.72, 5: 0.64, 6: 0.67, 7: 0.63, 8: 0.54, 9: 0.6, 10: 0.54 },
  },
  {
    conductorSize: 240,
    method118: { 2: 0.71, 3: 0.64, 4: 0.6, 5: 0.51, 6: 0.53, 7: 0.49, 8: 0.4, 9: 0.45, 10: 0.39 },
    method119: { 2: 0.77, 3: 0.7, 4: 0.66, 5: 0.57, 6: 0.6, 7: 0.55, 8: 0.46, 9: 0.51, 10: 0.46 },
  ...
  },
  {
    ...
    method120: { 2: 0.81, 3: 0.74, 4: 0.69, 5: 0.6, 6: 0.63, 7: 0.59, 8: 0.5, 9: 0.55, 10: 0.49 },
  },
  {
    conductorSize: 400,
    method118: { 2: 0.67, 3: 0.6, 4: 0.55, 5: 0.47, 6: 0.48, 7: 0.44, 8: 0.36, 9: 0.4, 10: 0.35 },
...
export const getConcreteFloorGroupingFactor = (
  ...
  const sizeData =
    concreteFloorGroupingFactors.find((f) => f.conductorSize >= conductorSize) ||
    concreteFloorGroupingFactors[concreteFloorGroupingFactors.length - 1];

  // Get the correct method factors
  const methodFactors =
    method === 118 ? sizeData.method118 : method === 119 ? sizeData.method119 : sizeData.method120;
