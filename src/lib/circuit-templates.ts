  ...
  },
  {
    ...
    circuits: [
      ...
      },
      {
        ...
        phases: 'single',
        specialLocation: 'kitchen',
        notes: 'Dishwasher, washing machine',
      },
    ],
  },
  {
...
export const COMMERCIAL_TEMPLATES: CircuitPreset[] = [
  {
    ...
    circuits: [
      {
        name: 'Styling Station Sockets Zone 1',
        loadType: 'office-sockets',
        loadPower: 2000,
        cableLength: 20,
        phases: 'single',
        specialLocation: 'none',
      ...
      {
        name: 'Styling Station Sockets Zone 2',
        loadType: 'office-sockets',
        loadPower: 2000,
        cableLength: 20,
        phases: 'single',
      ...
      {
        name: 'Styling Station Sockets Zone 3',
        loadType: 'office-sockets',
        loadPower: 2000,
        cableLength: 20,
        phases: 'single',
      ...
      {
        name: 'Basin Water Heaters',
        loadType: 'kitchen-equipment',
        loadPower: 3000,
        cableLength: 15,
        phases: 'single',
        specialLocation: 'bathroom',
        notes: 'Instantaneous heaters',
      },
      {
        name: 'LED Mirror/Lighting',
        loadType: 'lighting',
        loadPower: 1500,
        cableLength: 25,
        phases: 'single',
  ...
  },
  {
    ...
    circuits: [
      {
        name: 'Treadmill Zone (Dedicated)',
        loadType: 'office-sockets',
        loadPower: 8000,
        cableLength: 25,
        phases: 'single',
        specialLocation: 'none',
        notes: 'Multiple machines',
      },
      {
        name: 'Spin Bike/Cardio Area',
        loadType: 'office-sockets',
        loadPower: 3000,
        cableLength: 30,
        phases: 'single',
      ...
      },
      {
        ...
        phases: 'three',
        specialLocation: 'bathroom',
        notes: '3-phase, special location',
      },
      {
        name: 'Changing Room Lighting',
        loadType: 'lighting',
        loadPower: 1500,
        cableLength: 20,
        phases: 'single',
      ...
      {
        name: 'Sound System/AV',
        loadType: 'office-sockets',
        loadPower: 1500,
        cableLength: 35,
        phases: 'single',
        specialLocation: 'none',
        notes: 'Amplifiers & speakers',
      },
      {
        name: 'Reception Sockets',
        loadType: 'office-sockets',
        loadPower: 2000,
        cableLength: 15,
        phases: 'single',
    ...
    circuits: [
      {
        ...
        phases: 'single',
        specialLocation: 'kitchen',
        notes: 'Bottle warmers, sterilisers',
      },
      {
        name: 'Playroom Sockets Zone 1',
        loadType: 'office-sockets',
        loadPower: 2000,
        cableLength: 20,
        phases: 'single',
      ...
      },
      {
        ...
        phases: 'single',
        specialLocation: 'bathroom',
        notes: 'With hand dryer',
      },
      {
        name: 'Outdoor Play Lighting',
        loadType: 'lighting',
        loadPower: 800,
        cableLength: 30,
        phases: 'single',
  ...
  },
  {
    ...
    circuits: [
      {
        name: 'X-Ray Suite',
        loadType: 'server-room',
        loadPower: 8000,
        cableLength: 20,
        phases: 'single',
        specialLocation: 'none',
        notes: 'Dedicated, shielded room',
      },
      {
        name: 'Operating Theatre Sockets',
        loadType: 'office-sockets',
        loadPower: 3000,
        cableLength: 18,
        phases: 'single',
        specialLocation: 'none',
        notes: 'Critical circuit',
      },
      {
        name: 'Sterilisation Equipment',
        loadType: 'kitchen-equipment',
        loadPower: 4000,
        cableLength: 15,
        phases: 'single',
      ...
      {
        name: 'Drug Storage (Refrigeration)',
        loadType: 'kitchen-equipment',
        loadPower: 500,
        cableLength: 12,
        phases: 'single',
  ...
  },
  {
    ...
    circuits: [
      ...
      {
        name: 'AV/Video Conference',
        loadType: 'office-sockets',
        loadPower: 1500,
        cableLength: 28,
        phases: 'single',
        specialLocation: 'none',
        notes: 'Dedicated circuit',
      },
      {
        name: 'Phone Booth Sockets',
        loadType: 'office-sockets',
        loadPower: 1000,
        cableLength: 20,
        phases: 'single',
  ...
  },
  {
    ...
    circuits: [
      ...
      {
        name: 'External ATM Supply',
        loadType: 'office-sockets',
        loadPower: 2000,
        cableLength: 15,
        phases: 'single',
        specialLocation: 'outdoor',
        notes: 'Dedicated, metered',
      },
      {
...
export const INDUSTRIAL_TEMPLATES: CircuitPreset[] = [
  {
    ...
    circuits: [
      {
        name: 'Mash Tun Heating Elements',
        loadType: 'three-phase-motor',
        loadPower: 18000,
        cableLength: 35,
        phases: 'three',
        specialLocation: 'none',
        notes: '3-phase heating',
      },
      {
        name: 'Fermentation Vessel Controls',
        loadType: 'control-panel',
        loadPower: 3000,
        cableLength: 30,
        phases: 'single',
        specialLocation: 'none',
      ...
      {
        name: 'Bottling/Canning Line',
        loadType: 'production-line',
        loadPower: 5500,
        cableLength: 35,
        phases: 'three',
        specialLocation: 'none',
      ...
      {
        name: 'Washdown Sockets (IP65)',
        loadType: 'workshop-sockets',
        loadPower: 3000,
        cableLength: 30,
        phases: 'single',
        specialLocation: 'none',
  ...
  },
  {
    ...
    circuits: [
      ...
      {
        name: 'Industrial Tumble Dryer 1',
        loadType: 'three-phase-motor',
        loadPower: 18000,
        cableLength: 32,
        phases: 'three',
        specialLocation: 'none',
        notes: 'Gas or electric',
      },
      {
        name: 'Industrial Tumble Dryer 2',
        loadType: 'three-phase-motor',
        loadPower: 18000,
        cableLength: 34,
        phases: 'three',
