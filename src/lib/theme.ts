...
export const card = {
  ...
  interactive:
    'bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20 transition-all duration-200 active:scale-[0.98] rounded-lg',

  /** Highlighted/featured card */
  featured:
    'bg-gradient-to-br from-elec-yellow/10 to-elec-yellow/5 border border-elec-yellow/20 rounded-lg',
...
export const composed = {
  ...
  /** Sticky header */
  stickyHeader:
    'sticky top-0 z-50 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 border-b border-white/10',
} as const;
