...
export const DOMESTIC_TEMPLATES: InstallationTemplate[] = [
  {
    ...
    isPopular: true,
    prefilledPrompt:
      'Step-by-step installation method for 18th Edition dual RCD consumer unit with SPD in domestic property, including isolation, testing, and certification requirements. Cover safe isolation, board mounting, busbar installation, RCD and MCB installation, labelling, and commissioning tests.',
  },
  {
    ...
    isPopular: true,
    prefilledPrompt:
      'Provide step-by-step installation method for 25mm 3-core SWA cable underground to garage, including trench depth (600mm minimum), warning tape placement, sand bedding, gland termination at both ends, earthing arrangements, and testing procedures (continuity, insulation resistance, earth fault loop impedance).',
  },
  {
  ...
  },
  {
    ...
    complexity: 'intermediate',
    prefilledPrompt:
      'Step-by-step method for installing 7kW EV charger (Type 2 tethered). Include dedicated circuit from consumer unit, 10mm² cable sizing, RCBO protection requirements (Section 722), outdoor mounting considerations, IP rating requirements, earthing arrangements, and OZEV compliance checks.',
  },
  {
    ...
    complexity: 'advanced',
    prefilledPrompt:
      'Complete installation method for kitchen extension electrical work: new socket ring main (2.5mm²), lighting circuit (1.5mm²), dedicated circuits for oven (6mm²), hob (6mm²), dishwasher, and washing machine. Include first fix cable routing, notching/drilling requirements, accessory heights, and second fix terminations.',
  },
  {
  ...
  },
  {
    ...
    complexity: 'intermediate',
    prefilledPrompt:
      'Installation method for garage sub-main: 10mm² SWA underground (or overhead if applicable), 40A MCB at origin, small consumer unit in garage with RCD protection, socket circuits, lighting circuit, and optional circuits for vehicle charging point. Include earthing arrangements, bonding, and testing.',
  },
  {
    ...
    complexity: 'advanced',
    prefilledPrompt:
      'Installation method for solar PV system integration with battery storage. Include AC/DC isolator positioning, battery inverter installation, G98/G99 requirements, DNO notification process, generation meter, integration with consumer unit, earthing and bonding for PV, and commissioning procedures.',
  },
];
...
export const COMMERCIAL_TEMPLATES: InstallationTemplate[] = [
  ...
  },
  {
    ...
    isPopular: true,
    prefilledPrompt:
      'Server room/comms cabinet installation method: dedicated UPS-backed circuits, redundant power feeds, PDU installation, cooling/HVAC circuits, cable management (raised floor or overhead tray), earthing requirements for data equipment, surge protection, and environmental monitoring circuits. Include testing and commissioning procedures.',
  },
  {
...
export const INDUSTRIAL_TEMPLATES: InstallationTemplate[] = [
  ...
  },
  {
    ...
    isPopular: true,
    prefilledPrompt:
      'Machine tool electrical connection method: dedicated three-phase supply, local isolator (lockable), equipment earthing (protective and functional), coolant pump circuits, extraction system integration, machine safety circuit verification, and testing procedures. Include voltage tolerance checks and electrical safety documentation.',
  },
  {
  ...
  },
  {
    ...
    complexity: 'advanced',
    prefilledPrompt:
      'Conveyor system electrical installation: main drive motor circuits, photo-electric sensor wiring, emergency stop pull-cord circuits, VFD installation (if variable speed), control panel integration, zone isolation points, and safety interlock systems. Include sequential starting requirements and testing procedures.',
  },
  {
    ...
    isPopular: true,
    prefilledPrompt:
      'Air compressor electrical installation: three-phase motor circuit sizing (account for starting current), pressure switch wiring, auto-drain solenoid circuits, control panel connection, local isolator (lockable), thermal overload settings, and commissioning checks. Include pressure vessel certification liaison.',
  },
  {
    ...
    isPopular: true,
    prefilledPrompt:
      'Workshop power distribution installation: 32A and 63A commando socket circuits (three-phase), radial circuits with RCD protection, overhead cable reel drop-down points, bench-mounted sockets, cable protection (impact resistance), and testing. Include diversity calculations for multiple high-load tools.',
  },
  {
    ...
    complexity: 'advanced',
    prefilledPrompt:
      'Control panel installation and wiring: incoming power supply isolation, PLC power supply and I/O wiring, contactor circuits, safety relay systems, indicator lamps, push-button stations, cable numbering/labelling, functional earthing, and commissioning tests. Include wiring diagrams, terminal schedules, and safety certification.',
  },
];
