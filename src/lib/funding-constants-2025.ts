...
export const COURSE_FUNDING_CATEGORIES = {
  electrical: {
    ...
    level3: { funding: 0.9, apprenticeshipRate: 0.9, skillsBank: true },
    level4: { funding: 0.8, apprenticeshipRate: 0.85, skillsBank: true, advancedLoan: true },
    level5: { funding: 0.75, apprenticeshipRate: 0.8, skillsBank: true, advancedLoan: true },
    level6: { funding: 0.6, apprenticeshipRate: 0.75, studentFinance: true },
    level7: { funding: 0.4, apprenticeshipRate: 0.6, postgraduateLoan: true },
  },
  management: {
    level4: { funding: 0.7, apprenticeshipRate: 0.8, managementLevy: true },
    level5: { funding: 0.65, apprenticeshipRate: 0.75, managementLevy: true },
    level6: { funding: 0.5, apprenticeshipRate: 0.7, studentFinance: true },
    level7: { funding: 0.3, apprenticeshipRate: 0.5, postgraduateLoan: true, mba: true },
  },
  renewable: {
    level3: { funding: 0.95, apprenticeshipRate: 0.95, greenSkills: 500 },
    level4: { funding: 0.85, apprenticeshipRate: 0.9, greenSkills: 1000 },
    level5: { funding: 0.8, apprenticeshipRate: 0.85, greenSkills: 1500 },
    level6: { funding: 0.7, apprenticeshipRate: 0.8, greenSkills: 2000 },
  },
};
...
export function calculateFundingGap(totalCost: number, availableFunding: number): number {
...
export function getEligibleFunding(
  ...
  if (
    age >= AGE_ELIGIBILITY.advancedLearnerLoan.minimum &&
