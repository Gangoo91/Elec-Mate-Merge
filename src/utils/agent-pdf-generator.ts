...
export function generateRAMSFromAgents(
  ...
  if (risks.length === 0) {
    risks.push({
      ...
      riskRating: 20,
      controls:
        'Isolate and lock-off power supply; Use voltage tester; Wear insulated gloves and safety boots; Competent person supervision',
      residualRisk: 6,
    });
  }
...
export function generateSafetyBriefPDF(
  ...
  pdf.text(`Reference: HSE Guidance HSG85 - Electricity at Work`, pageWidth / 2, 285, {
    align: 'center',
  });
