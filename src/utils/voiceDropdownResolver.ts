...
export const DROPDOWN_VALUE_MAPS: Record<string, Record<string, string>> = {
  ...
  // ========== Type of Wiring (BS 7671 Installation Methods) ==========
  typeOfWiring: {
    // Letter codes
    'a': 'A',
    'b': 'B',
    ...
    'h': 'H',
    'o': 'O',
    // Natural language mappings - Method A (enclosed in insulation)
    'thermally insulated': 'A',
    'in insulation': 'A',
    'insulated wall': 'A',
    'in thermal insulation': 'A',
    'loft': 'A',
    'attic': 'A',
    // Method B (conduit/trunking)
    'conduit': 'B',
    'trunking': 'B',
    'conduit on wall': 'B',
    'in conduit': 'B',
