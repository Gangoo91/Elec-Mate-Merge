...
function mapHazardToRisk(hazard: string, installerOutput: InstallerAgentOutput): RiskAssessment {
  ...
  const hazardMap: Record<string, RiskAssessment> = {
    'electrical shock': {
      ...
      severity: 5,
      controls:
        'Isolate supply, lock off, test dead before work, use voltage indicator, appropriate PPE (insulated gloves, safety footwear), competent person only',
    },
    'work at height': {
      ...
      severity: 4,
      controls:
        'Use appropriate access equipment (scaffold/MEWP), edge protection, harness if required, inspection before use, 3-point contact on ladders',
    },
    'manual handling': {
      ...
      severity: 2,
      controls:
        'Assess load before lifting, team lift for heavy items, use cable drums/reels, mechanical aids where possible, proper lifting technique',
    },
    'confined space': {
      ...
      severity: 5,
      controls:
        'Confined space risk assessment, atmosphere testing, forced ventilation, emergency rescue plan, communication system, trained personnel',
    },
    'dust and debris': {
      ...
      severity: 2,
      controls:
        'Dust extraction equipment, RPE (respiratory protective equipment), safety glasses, wet cutting where possible, clean as you go',
    },
  };
  ...
  return {
    ...
    severity: 3,
    controls:
      'Follow safe working procedures, appropriate PPE, competent person, risk assessment before work',
  };
}
