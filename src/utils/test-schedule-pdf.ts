...
export function generateTestSchedulePDF(data: TestScheduleData): jsPDF {
  ...
  doc.text(
    'Complete all tests in accordance with BS 7671 Section 61. Record actual readings and tick Pass/Fail.',
    15,
    yPos
  );
  yPos += 12;
  ...
  doc.text('Test Schedule - BS 7671 Chapter 61 Compliance', pageWidth / 2, footerY, {
    align: 'center',
  });
