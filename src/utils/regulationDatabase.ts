...
export const REGULATIONS_DATABASE: RegulationData[] = [
  ...
  // Part 2 - Definitions (Amendment 3:2024)
  {
    ...
    apprenticeNote:
      'New in Amendment 3:2024. Essential for solar PV and battery storage installations where power flows both ways.',
  ...
  },
  {
    ...
    apprenticeNote:
      'New in Amendment 3:2024. Most traditional MCBs/RCBOs are unidirectional - check markings (line/load, in/out, arrows).',
    difficulty: 'intermediate',
    frequency: 'common',
    category: 'equipment',
  },
  ...
  },
  {
    ...
    section: 'Protection for Safety',
    content:
      'The earth fault loop impedance at every point of utilisation shall not exceed the values given in the relevant tables, taking account of conductor temperature.',
    keywords: [
      'earth fault',
      'loop impedance',
      'Zs',
  ...
  },
  {
    ...
    testMethod:
      'Test with RCD tester: ½×IΔn should NOT trip, 1×IΔn must trip ≤300ms, 5×IΔn must trip ≤40ms.',
  ...
  },
  {
    ...
    content:
      'TN systems: 230V final circuits = 0.4s, distribution = 5s. 400V = 0.2s. TT systems: all voltages = 0.2s (achieved by RCD).',
    keywords: ['disconnection times', 'TN system', 'TT system', 'fault clearance', '0.4s', '0.2s'],
    relatedRegs: ['411.3.2', '411.5.1', 'Table 41.3'],
    apprenticeNote:
      'TN systems use MCBs/fuses (need low Zs). TT systems use RCDs (high earth electrode resistance makes MCBs too slow).',
  ...
  },
  {
    ...
    testMethod:
      'Measure Zs and compare directly with Table 41.3 values. Measured Zs must not exceed the tabulated maximum.',
  ...
  },
  {
    ...
    testMethod:
      'Test L-N, L-E, N-E. Minimum 1MΩ for most circuits (0.25MΩ for SELV/electronic equipment)',
    safetyTip:
  ...
  },
  {
    ...
    testMethod:
      'Use continuity tester or bell set. Test with supply isolated. Check at each outlet.',
  ...
  },
  {
    ...
    testMethod:
      'Test at consumer unit and furthest outlets. Ensure measured values ≤ (Table 41.3 × 0.8).',
  ...
  },
  {
    ...
    apprenticeNote:
      'Test RCDs at ½×IΔn (should NOT trip), 1×IΔn, and 5×IΔn. Check trip times and ramp test.',
    testMethod:
      'Use RCD tester: ½×IΔn = no trip, 1×IΔn ≤300ms, 5×IΔn ≤40ms. Ramp test to check trip threshold.',
  ...
  },
  {
    ...
    apprenticeNote:
      "New Amendment 3:2024. CRITICAL for solar PV/battery installations! Wrong device orientation = device won't protect during faults.",
    testMethod:
      'Check device markings (in/out, line/load, arrows). Verify correct orientation for power flow direction.',
    safetyTip:
      'Unidirectional device installed backwards = NO PROTECTION during reverse fault! Always check manufacturer markings.',
    difficulty: 'intermediate',
    frequency: 'occasional',
    category: 'protection',
  },
  ...
  // Additional Part 1 regulations
  {
    ...
    section: 'Fundamental Principles',
    content:
      'Electrical installations shall be designed and erected to avoid the risk of fire or harmful thermal effects.',
  ...
  },
  {
    ...
    section: 'Fundamental Principles',
    content:
      'Live conductors shall be protected against overcurrent caused by overload and fault current.',
  ...
  },
  {
    ...
    section: 'Fundamental Principles',
    content:
      'Protection against undervoltage shall be provided where automatic reconnection could cause danger.',
  ...
  },
  {
    ...
    section: 'Fundamental Principles',
    content:
      'Electrical installations shall be designed to protect against overvoltage caused by atmospheric origin or switching.',
    keywords: ['overvoltage', 'atmospheric', 'switching', 'surge protection'],
    relatedRegs: ['443.1', '534.1'],
    apprenticeNote:
      'Lightning and switching can cause voltage spikes - surge protection devices help.',
    difficulty: 'intermediate',
    frequency: 'frequent',
    category: 'protection',
  },
  ...
  },
  {
    ...
    section: 'Protection for Safety',
    content:
      'In TN systems, exposed conductive parts shall be connected to the main earthing terminal.',
  ...
  },
  {
    ...
    section: 'Protection for Safety',
    content:
      'SELV and PELV circuits shall be supplied at nominal voltages not exceeding 50V AC or 120V DC.',
  ...
  },
  {
    ...
    section: 'Selection and Erection',
    content:
      'Electrical installations shall be arranged to avoid harmful effects between electrical and non-electrical services.',
  ...
  },
  {
    ...
    section: 'Inspection and Testing',
    content:
      'Verification shall confirm the correct installation of SELV, PELV and electrical separation.',
  ...
  },
  {
    ...
    section: 'Inspection and Testing',
    content:
      'Where protection is provided by non-conducting location, floors and walls shall be tested.',
  ...
  // Additional Part 7 regulations
  {
    ...
    content:
      'RCD protection with IΔn ≤ 30mA shall be provided for all circuits in zones 0, 1 and 2.',
  ...
  },
  {
    ...
    testMethod:
      'Measure Zs at the furthest point and compare with the Table 41.3 value for the protective device (no 0.8 factor).',
  ...
  },
  {
    ...
    section: 'Protection for Safety - Tables',
    content:
      'Example BS 88-2 gG Zs limits at 5s (Cmin=0.95): 6A=12.0Ω, 10A=6.8Ω, 16A=4.0Ω, 20A=2.8Ω, 32A=1.7Ω, 40A=1.3Ω, 50A=0.99Ω, 63A=0.78Ω (see BS 7671 Table 41.4 for the full list).',
    keywords: ['Zs', 'fuse', 'BS 88', 'maximum', 'earth fault', 'loop impedance'],
    relatedRegs: ['Table 41.4', '533.1'],
    apprenticeNote:
      'These 5s values apply mainly to distribution circuits using fuses. Always check you are using the correct table for the protective device and circuit type.',
    testMethod:
      'Identify the fuse type and rating, then compare measured Zs with the corresponding Table 41.4 value.',
    difficulty: 'intermediate',
    frequency: 'frequent',
    category: 'testing',
  },
  ...
  },
  {
    ...
    section: 'Selection and Erection - Tables',
    content:
      'CPC sizing: If line ≤16mm² then CPC = line size. If 16mm² < line ≤35mm² then CPC = 16mm². If line >35mm² then CPC = line/2.',
    keywords: [
  ...
  },
  {
    ...
    section: 'Selection and Erection - Tables',
    content:
      'Main bonding conductor minimum size: 6mm² for TN systems, 10mm² for TT systems unless calculation proves smaller acceptable.',
    keywords: [
      'main bonding',
      'protective bonding',
      'minimum',
  ...
  },
  {
    ...
    content:
      'Complete tables showing relationship between fault current, disconnection time, and maximum Zs for all protective devices.',
    keywords: [
      'time current',
      'characteristics',
      'maximum Zs',
    ...
    apprenticeNote:
      'The source for all Zs calculations - shows how fault current relates to trip time.',
  ...
  },
  {
    ...
    section: 'Reference Tables',
    content:
      'Tables for cable current ratings, voltage drop calculations, and installation methods.',
    keywords: [
