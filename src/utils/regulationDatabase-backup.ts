...
export const REGULATIONS_DATABASE: RegulationData[] = [
  ...
  },
  {
    ...
    section: 'Fundamental Principles',
    content:
      'Persons, livestock and property shall be protected against harmful effects of heat or thermal radiation.',
  ...
  },
  {
    ...
    section: 'Fundamental Principles',
    content:
      'Persons and property shall be protected against injury and damage due to excessive current.',
  ...
  // Part 4 - Protection for Safety (Expanded)
  {
    ...
    content:
      'Protection against electric shock shall be provided by basic protection and fault protection.',
    keywords: ['electric shock', 'basic protection', 'fault protection'],
    relatedRegs: ['411.2', '411.3'],
    apprenticeNote:
      'Two layers of protection: basic (prevent touching live parts) and fault (protection when things go wrong).',
    difficulty: 'beginner',
    frequency: 'common',
    category: 'protection',
  },
  {
    ...
    section: 'Protection for Safety',
    content:
      'Live parts shall be completely covered with insulation which can be removed only by destruction.',
    keywords: ['basic protection', 'insulation', 'live parts', 'covering'],
    relatedRegs: ['416.1', '416.2'],
    apprenticeNote:
      'Cable insulation prevents you touching live conductors - first line of defence.',
    difficulty: 'beginner',
    frequency: 'common',
    category: 'protection',
  },
  ...
  },
  {
    ...
    section: 'Protection for Safety',
    content:
      'For socket-outlets with a rated current not exceeding 20 A and for mobile equipment outdoors, additional protection by RCD (30mA) shall be provided.',
  ...
  },
  {
    ...
    section: 'Protection for Safety',
    content:
      'The earth fault loop impedance at every point of utilisation shall not exceed the values given in the relevant tables.',
    keywords: ['earth fault', 'loop impedance', 'Zs', 'maximum values', 'tables'],
    relatedRegs: ['Table 41.3', '643.7.3'],
    apprenticeNote:
      'Zs must be low enough for protective device to operate in time. Critical safety requirement!',
  ...
  },
  {
    ...
    section: 'Protection for Safety',
    content:
      'In TT systems, the sum of resistances of earth electrode and protective conductor shall be such that automatic disconnection occurs.',
    keywords: ['TT system', 'earth electrode', 'resistance', 'automatic disconnection'],
    relatedRegs: ['542.1.2', '643.7.2'],
    apprenticeNote:
      'TT systems (rod in ground) need low earth electrode resistance for RCD to work properly.',
  ...
  // Protection Devices
  {
    ...
    apprenticeNote:
      '30mA max current, 40ms max trip time at 150mA test current. Learn these limits!',
  ...
  // Overcurrent Protection (Part 4)
  {
    ...
    section: 'Protection for Safety',
    content:
      'Every conductor shall be protected against overcurrent by one or more automatic disconnection devices.',
    keywords: ['overcurrent', 'protection', 'conductors', 'automatic disconnection', 'MCB', 'fuse'],
    relatedRegs: ['433.1.204', '434.1'],
    apprenticeNote:
      'Every cable needs overcurrent protection (MCB/fuse) rated correctly for cable size.',
    testMethod: 'Check MCB/fuse rating matches cable current carrying capacity.',
    safetyTip:
      'Wrong protection rating = fire risk! Undersized = nuisance tripping, oversized = cable fire!',
    difficulty: 'intermediate',
    frequency: 'common',
    category: 'protection',
  },
  {
    ...
    section: 'Protection for Safety',
    content:
      'Ring final circuits shall be protected by a single overcurrent protective device, the rating of which shall not exceed 32A.',
  ...
  // Part 5 - Selection and Erection (Expanded)
  {
    ...
    content:
      'Every installation shall be divided into circuits to avoid danger and minimise inconvenience in case of fault.',
    keywords: ['division', 'circuits', 'danger', 'inconvenience', 'fault'],
    relatedRegs: ['314.2', '537.2'],
    apprenticeNote:
      'Separate circuits by function - lighting, sockets, cooker, etc. Makes fault finding easier.',
    difficulty: 'beginner',
    frequency: 'common',
    category: 'installation',
  },
  {
    ...
    apprenticeNote:
      "Fire alarms, emergency lighting need their own circuits - can't share with normal power.",
    difficulty: 'intermediate',
    frequency: 'occasional',
    category: 'installation',
  },
  ...
  // Cable Selection and Installation
  {
    ...
    section: 'Selection and Erection',
    content:
      'The cross-sectional area of line and neutral conductors shall be not less than the values specified in Table 52.1.',
  ...
  },
  {
    ...
    section: 'Selection and Erection',
    content:
      'A cable concealed in a wall shall be installed in such a way that it is not liable to be damaged by nails, screws, or similar.',
    keywords: ['cables', 'walls', 'concealed', 'damage', 'nails', 'screws'],
    relatedRegs: ['522.6.204', '522.6.202'],
    apprenticeNote:
      'Cables in walls must be protected from mechanical damage - run in safe zones or use protection.',
    difficulty: 'intermediate',
    frequency: 'common',
    category: 'cables',
  },
  {
    ...
    section: 'Selection and Erection',
    content:
      'Cables shall be run in the permitted zones shown in Figure 52.1, or be provided with additional protection.',
    keywords: ['safe zones', 'cables', 'walls', 'Figure 52.1', 'additional protection'],
    relatedRegs: ['522.6.201', '522.6.204'],
    apprenticeNote:
      'Run cables in safe zones (top/bottom 150mm, sides 150mm from corners) or use RCD protection.',
  ...
  },
  {
    ...
    section: 'Selection and Erection',
    content:
      'A cable concealed in a wall at depth <50mm shall be protected against mechanical damage or protected by 30mA RCD.',
    keywords: ['cables', 'concealed', 'walls', '50mm', 'mechanical protection', 'RCD'],
    relatedRegs: ['522.6.201', '411.3.3'],
    apprenticeNote:
      'Cables in walls need protection: >50mm deep, or metal protection, or 30mA RCD.',
  ...
  },
  {
    ...
    section: 'Selection and Erection',
    content:
      'The current-carrying capacity of conductors shall be such that the design current does not exceed the rated current.',
    keywords: ['current-carrying capacity', 'conductors', 'design current', 'rated current'],
    relatedRegs: ['Appendix 4', '525.1'],
    apprenticeNote:
      'Cable must be big enough to carry the load current safely without overheating.',
  ...
  // Connections and Joints
  {
    ...
    section: 'Selection and Erection',
    content:
      'Every electrical connection shall provide durable electrical continuity and adequate mechanical strength.',
  ...
  },
  {
    ...
    section: 'Selection and Erection',
    content:
      'Every connection and joint shall be accessible for inspection, testing and maintenance, except for specific permitted cases.',
    keywords: ['connections', 'joints', 'accessible', 'inspection', 'testing', 'maintenance'],
    relatedRegs: ['526.1', '526.8'],
    apprenticeNote:
      'All connections must be accessible - no joints buried in walls! Use proper enclosures.',
    testMethod: 'Visual inspection - check all connections can be accessed for testing.',
    safetyTip:
      'Hidden connections = fire/failure risk! Always use maintenance-free connections if inaccessible.',
    difficulty: 'intermediate',
    frequency: 'common',
    category: 'installation',
  },
  {
    ...
    section: 'Selection and Erection',
    content:
      'Connections may be buried or concealed only if they are maintenance-free and suitably enclosed.',
    keywords: ['maintenance-free', 'connections', 'buried', 'concealed', 'enclosed'],
    relatedRegs: ['526.3', '526.1'],
    apprenticeNote:
      'Only certain connection types can be hidden - compression joints, welded joints, etc.',
    difficulty: 'advanced',
    frequency: 'occasional',
    category: 'installation',
  },
  ...
  // Isolation and Switching
  {
    ...
    section: 'Selection and Erection',
    content:
      'Means of isolation shall be provided to enable every circuit to be isolated from all sources of electrical energy.',
    keywords: ['isolation', 'circuit', 'electrical energy', 'sources'],
    relatedRegs: ['537.2.1.1', '462.1'],
    apprenticeNote:
      'Every circuit needs isolation for safe working - main switch, MCBs, local isolators.',
    difficulty: 'beginner',
    frequency: 'common',
    category: 'installation',
  },
  {
    ...
    section: 'Selection and Erection',
    content:
      'Every circuit shall be provided with means of isolation such that it may be cut off from every source of electrical energy.',
    keywords: ['isolation', 'circuit', 'isolator', 'electrical energy', 'safety'],
    relatedRegs: ['537.1.4', '462.1'],
    apprenticeNote:
      'Every circuit needs an isolator for safe maintenance. Main switch isolates whole installation.',
  ...
  // Earthing and Protective Conductors
  {
    ...
    section: 'Selection and Erection',
    content:
      'A main earthing terminal shall be provided for the connection of protective conductors, functional earthing conductors and bonding conductors.',
    keywords: ['main earthing terminal', 'protective conductors', 'bonding', 'connection'],
    relatedRegs: ['542.1.2', '544.1'],
    apprenticeNote:
      'Central point where all earth connections come together - usually at the consumer unit.',
    difficulty: 'intermediate',
    frequency: 'common',
    category: 'earthing',
  },
  {
    ...
    apprenticeNote:
      'Lower earth electrode resistance = better protection. Target less than 200Ω where possible.',
  ...
  },
  {
    ...
    section: 'Selection and Erection',
    content:
      'Main equipotential bonding conductors shall connect extraneous-conductive-parts to the main earthing terminal.',
    keywords: [
      'main bonding',
      'equipotential',
    ...
    apprenticeNote:
      'Bond metal pipes, structural steel to earth - prevents dangerous voltages between metal parts.',
  ...
  // Part 6 - Inspection and Testing (Expanded with more detail)
  {
    ...
    content:
      'Every installation shall be inspected before being put into service to verify compliance with these Regulations.',
    keywords: ['inspection', 'installation', 'service', 'compliance', 'verification'],
    relatedRegs: ['641.4', '643.1'],
    apprenticeNote:
      'Visual inspection comes first - check everything looks right before any testing.',
    difficulty: 'beginner',
    frequency: 'common',
    category: 'testing',
  },
  {
    ...
    section: 'Inspection and Testing',
    content:
      'The inspection shall include verification of connection of conductors, identification of conductors, routing of cables, selection of equipment.',
    keywords: [
    ...
    relatedRegs: ['641.1', 'Appendix 6'],
    apprenticeNote:
      'Systematic visual check - connections, cable routes, equipment suitability, labelling.',
    difficulty: 'intermediate',
    frequency: 'common',
    category: 'testing',
  },
  {
    ...
    section: 'Inspection and Testing',
    content:
      'Every installation shall be inspected and tested during erection and on completion before being put into service to verify that the requirements of the regulations have been met.',
  ...
  },
  {
    ...
    apprenticeNote:
      'First test to perform! Use low resistance ohmmeter with test current 200mA minimum.',
    testMethod:
      'Test between earth terminal at DB and all earth points. Reading should be very low (typically <0.5Ω)',
  ...
  },
  {
    ...
    testMethod:
      'Test L-N, L-E, N-E. Minimum 1MΩ for most circuits (0.5MΩ for SELV/electronic equipment)',
    safetyTip:
      'Remove/isolate electronic equipment before testing - high voltage will damage sensitive components!',
    difficulty: 'intermediate',
    frequency: 'frequent',
    category: 'testing',
  },
  {
    ...
    section: 'Inspection and Testing',
    content:
      'Minimum insulation resistance values: SELV circuits 0.25MΩ, up to 500V 1MΩ, above 500V 1MΩ.',
    keywords: ['minimum', 'insulation resistance', 'values', 'MΩ', 'SELV'],
    relatedRegs: ['643.3.1', 'Table 61'],
    apprenticeNote: 'Learn these values by heart! Most common circuits need minimum 1MΩ.',
    testMethod:
      'If reading is below minimum, investigate: dampness, damaged cables, or poor terminations.',
  ...
  },
  {
    ...
    section: 'Inspection and Testing',
    content:
      'For SELV circuits, insulation resistance between SELV circuit and other circuits shall be verified.',
    keywords: ['SELV', 'testing', 'insulation', 'separation', 'isolation'],
    relatedRegs: ['414.1', '643.3.1'],
  ...
  },
  {
    ...
    section: 'Inspection and Testing',
    content:
      'For circuits with electrical separation, insulation resistance shall be measured between separated circuits.',
    keywords: ['electrical separation', 'testing', 'insulation', 'isolated circuits'],
    relatedRegs: ['413.1', '643.3.1'],
    apprenticeNote:
      'Electrically separated circuits (isolation transformers) need testing between primary and secondary.',
    difficulty: 'advanced',
    frequency: 'occasional',
    category: 'testing',
  },
  ...
  },
  {
    ...
    apprenticeNote:
      'Critical test! Zs must be low enough for MCB/fuse to operate within required time.',
    testMethod:
      'Test at consumer unit and furthest outlets. Compare with maximum values in Table 41.3.',
  ...
  },
  {
    ...
    section: 'Inspection and Testing',
    content:
      'The effectiveness of any RCD shall be verified by a test simulating an appropriate fault condition.',
    keywords: ['functional testing', 'RCD', 'test', 'fault condition', 'trip'],
    relatedRegs: ['415.1.1', '531.2.4'],
    apprenticeNote:
      'Test RCDs at rated current (30mA) and 5x rated current. Must trip within time limits.',
    testMethod:
      'Use RCD tester. Test trip time at 1x, 5x rated current. Check trip/no-trip thresholds.',
  ...
  },
  {
    ...
    section: 'Inspection and Testing',
    content:
      'Where the phase sequence is important for the operation of equipment, it shall be verified.',
    keywords: ['phase sequence', 'testing', 'three-phase', 'motor rotation'],
    relatedRegs: ['643.1', '551.1'],
    apprenticeNote: 'Three-phase motors need correct phase sequence to rotate the right direction.',
    testMethod:
      'Use phase sequence indicator before connecting motors or other phase-sensitive equipment.',
    difficulty: 'advanced',
    frequency: 'occasional',
    category: 'testing',
  },
  ...
  // Part 7 - Special Locations (Expanded)
  {
    ...
    content:
      'Special locations require additional measures due to increased risk of electric shock, fire, or explosion.',
  ...
  },
  {
    ...
    section: 'Special Locations - Bathrooms',
    content:
      'Additional protection by RCD with IΔn ≤30mA shall be provided for all circuits in the location.',
  ...
  },
  {
    ...
    section: 'Special Locations - Bathrooms',
    content:
      'Socket outlets are not permitted in zones 0, 1 and 2. Shaver sockets to BS EN 61558-2-5 are permitted in zone 2.',
    keywords: ['socket outlets', 'bathrooms', 'zones', 'prohibited', 'shaver sockets'],
    relatedRegs: ['701.32', '701.411.3.3'],
    apprenticeNote:
      'No normal sockets near baths/showers! Only special shaver sockets allowed in zone 2.',
    difficulty: 'intermediate',
    frequency: 'common',
    category: 'special-locations',
  },
  ...
  // Agricultural Locations
  {
    ...
    content:
      'All circuits in agricultural locations shall have additional protection by RCD with IΔn ≤30mA.',
    keywords: ['agricultural', 'RCD', '30mA', 'all circuits', 'livestock'],
    relatedRegs: ['705.32', '415.1.1'],
    apprenticeNote:
      'Farms need RCD protection on everything - animals are more sensitive to electric shock.',
    difficulty: 'advanced',
    frequency: 'occasional',
    category: 'special-locations',
  },
  ...
  // Tables and Reference Data
  {
    ...
    content:
      'Maximum Zs values for MCBs: 6A Type B = 7.67Ω, 10A = 4.60Ω, 16A = 2.87Ω, 20A = 2.30Ω, 32A = 1.44Ω',
  ...
  },
  {
    ...
    content:
      'Minimum conductor sizes: Power circuits 2.5mm², Lighting circuits 1.5mm², Control circuits 1.5mm²',
    keywords: ['minimum', 'cross-sectional area', 'conductors', 'power', 'lighting'],
    relatedRegs: ['521.5.1', '523.1'],
    apprenticeNote:
      'Standard minimums: 2.5mm² for sockets, 1.5mm² for lights in domestic installations.',
    difficulty: 'beginner',
    frequency: 'common',
    category: 'cables',
  },
  {
    ...
    section: 'Selection and Erection - Tables',
    content:
      'CPC sizes: Line ≤16mm² CPC = Line, 16mm² < Line ≤35mm² CPC = 16mm², Line >35mm² CPC = Line/2',
  ...
  },
  {
    ...
    content:
      'Test voltages: SELV/PELV circuits = 250V DC, Circuits up to 500V = 500V DC, Above 500V = 1000V DC',
    keywords: ['test voltage', 'insulation resistance', 'SELV', '500V', '1000V', 'DC'],
    relatedRegs: ['643.3.1', '643.3.2'],
    apprenticeNote:
      'Use correct test voltage for insulation testing - wrong voltage gives false results!',
  ...
  // Appendices
  {
    ...
    section: 'Appendices',
    content:
      'Ring circuits require specific design and testing methods to ensure proper load sharing.',
    keywords: ['ring circuit', 'design', 'testing', 'load sharing', 'continuity'],
    relatedRegs: ['643.2.1', '433.1.204'],
    apprenticeNote:
      'Ring circuits are unique to UK. Must test properly to ensure both legs share load.',
  ...
  // Emergency Systems
  {
    ...
    section: 'Selection and Erection',
    content:
      'Emergency lighting shall be supplied from a source independent of the normal lighting supply.',
  ...
  // Medical Locations
  {
    ...
    content:
      'RCD protection may not be suitable in medical locations where loss of supply could endanger life.',
    keywords: ['medical locations', 'RCD', 'life support', 'supply continuity'],
    relatedRegs: ['710.1', '411.3.3'],
    apprenticeNote:
      'Hospitals/medical areas may avoid RCDs where equipment must not trip unexpectedly.',
    difficulty: 'advanced',
    frequency: 'occasional',
    category: 'special-locations',
  },
  ...
  // Equipment specific regulations
  {
    ...
    section: 'Selection and Erection',
    content:
      'RCDs shall be selected according to their intended use and the characteristics of the circuits they protect.',
    keywords: ['RCD', 'selection', 'application', 'characteristics', 'circuits'],
    relatedRegs: ['415.1.1', '643.10'],
  ...
  // Low voltage systems
  {
    ...
    section: 'Protection for Safety',
    content:
      'SELV systems shall not exceed 50V AC or 120V ripple-free DC and shall be separated from other circuits.',
    keywords: ['SELV', 'low voltage', '50V', 'separation', 'isolation'],
    relatedRegs: ['414.2', '643.4.1'],
    apprenticeNote:
      'SELV = Safety Extra Low Voltage. Used for bathroom lights, garden lighting etc.',
    difficulty: 'advanced',
    frequency: 'occasional',
    category: 'protection',
  },
  ...
  // Additional critical regulations for comprehensive coverage
  {
    ...
    section: 'Fundamental Principles',
    content:
      'Electrical work shall be carried out only by skilled persons or by ordinary persons under the supervision of skilled persons.',
  ...
  },
  {
    ...
    section: 'Fundamental Principles',
    content:
      'Adequate precautions shall be taken to prevent electrical equipment from being inadvertently or unintentionally energised.',
  ...
  },
  {
    ...
    apprenticeNote:
      'IT systems (isolated neutral) used in hospitals and industry for supply continuity.',
    difficulty: 'advanced',
    frequency: 'occasional',
    category: 'protection',
  },
  {
    ...
    section: 'Protection for Safety',
    content:
      'Protection by electrical separation requires a source with at least simple separation.',
    keywords: ['electrical separation', 'isolation transformer', 'simple separation'],
    relatedRegs: ['413.2', '643.5'],
    apprenticeNote:
      'Isolation transformers provide electrical separation - used for safety in special situations.',
    difficulty: 'advanced',
    frequency: 'occasional',
    category: 'protection',
  },
  ...
  },
  {
    ...
    section: 'Protection for Safety',
    content:
      'Equipment producing heat shall be installed to prevent fire risk to surrounding materials.',
    keywords: ['heat-producing equipment', 'fire risk', 'thermal protection'],
    relatedRegs: ['421.1.201', '559.4.1'],
    apprenticeNote:
      'Keep heat sources away from combustible materials - use proper spacing and barriers.',
    difficulty: 'intermediate',
    frequency: 'common',
    category: 'equipment',
  },
  {
    ...
    apprenticeNote:
      'Always check equipment ratings match the supply - voltage, frequency, and power.',
    difficulty: 'beginner',
    frequency: 'common',
    category: 'equipment',
  },
  ...
  },
  {
    ...
    section: 'Selection and Erection',
    content:
      'Electrical cables and other services shall be adequately separated or barriers provided.',
    keywords: ['proximity', 'services', 'separation', 'barriers', 'gas pipes'],
    relatedRegs: ['515.3', '528.3'],
    apprenticeNote:
      'Maintain safe distances from gas pipes, water services - use barriers if needed.',
  ...
  },
  {
    ...
    relatedRegs: ['434.1', '643.7.3'],
    apprenticeNote:
      'MCBs must have sufficient breaking capacity for the prospective fault current.',
  ...
  },
  {
    ...
    section: 'Selection and Erection',
    content:
      'Generating sets shall not operate in parallel with the public supply unless specifically approved.',
    keywords: ['generating sets', 'parallel operation', 'public supply', 'generators'],
    relatedRegs: ['551.1', '551.7'],
    apprenticeNote:
      'Generators must not feed back into the grid without proper protection and approval.',
  ...
  },
  {
    ...
    apprenticeNote:
      'Street lighting and highway electrical supplies need RCD protection for public safety.',
    difficulty: 'advanced',
    frequency: 'occasional',
    category: 'special-locations',
  },
  {
    ...
    content:
      'Hand-held equipment on construction sites shall be supplied at reduced voltage (110V CTE).',
  ...
  },
  {
    ...
    section: 'Protection for Safety - Tables',
    content:
      'TN systems: 230V = 0.4s, 400V = 0.2s. TT systems: all voltages = 0.2s (RCD required).',
    keywords: ['disconnection times', 'TN system', 'TT system', 'fault clearance'],
    relatedRegs: ['411.3.2', '411.5.1'],
    apprenticeNote:
      'Faults must be cleared quickly! TT systems need RCDs because earth loop impedance is high.',
  ...
  },
  {
    ...
    section: 'Selection and Erection - Tables',
    content:
      'Apply correction factors for ambient temperature, grouping, thermal insulation, and soil thermal resistivity.',
    keywords: [
      'correction factors',
    ...
    apprenticeNote:
      'Cable ratings must be corrected for installation conditions - very important for cable sizing!',
    testMethod:
      'Calculate corrected cable rating = tabulated rating × all applicable correction factors.',
  ...
  },
  {
    ...
    section: 'Inspection and Testing',
    content:
      'Domestic installations: 10 years. Commercial: 5 years. Industrial: 3 years or as required.',
    keywords: ['periodic inspection', 'frequency', 'domestic', 'commercial', 'industrial'],
    relatedRegs: ['643.1', '643.7'],
    apprenticeNote:
      'Regular electrical safety checks prevent dangerous faults developing over time.',
    difficulty: 'beginner',
    frequency: 'common',
    category: 'testing',
  },
